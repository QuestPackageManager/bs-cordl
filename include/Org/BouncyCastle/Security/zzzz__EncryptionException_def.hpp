...
public:
  ...
  /// @brief Method .ctor, addr 0x123feec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x123fef4, size 0x8, virtual false, abstract: false, final false
