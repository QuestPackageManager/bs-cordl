...
public:
  ...
  /// @brief Method .ctor, addr 0x254fb2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x254fb34, size 0x8, virtual false, abstract: false, final false
