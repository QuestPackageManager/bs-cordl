...
public:
  ...
  /// @brief Method .ctor, addr 0x254e130, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x254e138, size 0x8, virtual false, abstract: false, final false
