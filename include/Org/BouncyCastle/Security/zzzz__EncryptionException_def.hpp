...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncryptionException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncryptionException(EncryptionException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncryptionException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncryptionException(EncryptionExceptionconst&) = delete;
