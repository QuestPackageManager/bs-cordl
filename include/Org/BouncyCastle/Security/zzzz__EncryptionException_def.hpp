...
public:
  ...
  /// @brief Method .ctor, addr 0x1140c64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1140c6c, size 0x8, virtual false, abstract: false, final false
