...
public:
  ...
  /// @brief Method .ctor, addr 0x1166368, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1166370, size 0x8, virtual false, abstract: false, final false
