...
public:
  ...
  /// @brief Method CreatePrng, addr 0x341ecc0, size 0x1c0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator* CreatePrng(::StringW digestName, bool autoSeed);

  /// @brief Method GenerateSeed, addr 0x341f21c, size 0xa4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSeed(int32_t length);

  /// @brief Method GetInstance, addr 0x341ee80, size 0x5c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Security::SecureRandom* GetInstance(::StringW algorithm);

  /// @brief Method GetInstance, addr 0x341eedc, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method Next, addr 0x341f44c, size 0xe4, virtual true, abstract: false, final false
  inline int32_t Next(int32_t maxValue);

  /// @brief Method Next, addr 0x341f530, size 0xc0, virtual true, abstract: false, final false
  inline int32_t Next(int32_t minValue, int32_t maxValue);

  /// @brief Method NextBytes, addr 0x341f5f0, size 0xb8, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> buf);

  /// @brief Method NextBytes, addr 0x341f6a8, size 0xd0, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method NextCounterValue, addr 0x341ebfc, size 0x68, virtual false, abstract: false, final false
  static inline int64_t NextCounterValue();

  /// @brief Method NextDouble, addr 0x341f778, size 0xb0, virtual true, abstract: false, final false
  inline double_t NextDouble();

  /// @brief Method NextInt, addr 0x341f828, size 0x70, virtual true, abstract: false, final false
  inline int32_t NextInt();

  /// @brief Method NextLong, addr 0x341f898, size 0x88, virtual true, abstract: false, final false
  inline int64_t NextLong();

  /// @brief Method SetSeed, addr 0x341f2c0, size 0xb4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t> seed);

  /// @brief Method SetSeed, addr 0x341f374, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3415278, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Master, addr 0x341ec64, size 0x5c, virtual false, abstract: false, final false
