...
/// @brief Method CreatePrng, addr 0x33230a0, size 0x1c0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator* CreatePrng(::StringW  digestName, bool  autoSeed) ;

/// @brief Method GenerateSeed, addr 0x33235fc, size 0xa4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSeed(int32_t  length) ;

/// @brief Method GetInstance, addr 0x3323260, size 0x5c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Security::SecureRandom* GetInstance(::StringW  algorithm) ;

/// @brief Method GetInstance, addr 0x33232bc, size 0x188, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Security::SecureRandom* GetInstance(::StringW  algorithm, bool  autoSeed) ;

/// @brief Method GetNextBytes, addr 0x3321da0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetSeed, addr 0x33234b8, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method Next, addr 0x332380c, size 0x20, virtual true, abstract: false, final false
inline int32_t Next() ;

/// @brief Method Next, addr 0x332382c, size 0xe4, virtual true, abstract: false, final false
inline int32_t Next(int32_t  maxValue) ;

/// @brief Method Next, addr 0x3323910, size 0xc0, virtual true, abstract: false, final false
inline int32_t Next(int32_t  minValue, int32_t  maxValue) ;

/// @brief Method NextBytes, addr 0x33239d0, size 0xb8, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method NextBytes, addr 0x3323a88, size 0xd0, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method NextCounterValue, addr 0x3322fdc, size 0x68, virtual false, abstract: false, final false
static inline int64_t NextCounterValue() ;

/// @brief Method NextDouble, addr 0x3323b58, size 0xb0, virtual true, abstract: false, final false
inline double_t NextDouble() ;

/// @brief Method NextInt, addr 0x3323c08, size 0x70, virtual true, abstract: false, final false
inline int32_t NextInt() ;

/// @brief Method NextLong, addr 0x3323c78, size 0x88, virtual true, abstract: false, final false
inline int64_t NextLong() ;

/// @brief Method SetSeed, addr 0x33236a0, size 0xb4, virtual true, abstract: false, final false
inline void SetSeed(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method SetSeed, addr 0x3323754, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3319658, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3323444, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*  generator) ;

/// @brief Method .ctor, addr 0x332355c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_Master, addr 0x3323044, size 0x5c, virtual false, abstract: false, final false
