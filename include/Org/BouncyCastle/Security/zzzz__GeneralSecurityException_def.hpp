...
public:
  ...
  /// @brief Method .ctor, addr 0x2571d68, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2571dc0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2571e28, size 0x70, virtual false, abstract: false, final false
