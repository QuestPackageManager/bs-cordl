...
public:
  ...
  /// @brief Method .ctor, addr 0x253c72c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x253c784, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x253c7ec, size 0x70, virtual false, abstract: false, final false
