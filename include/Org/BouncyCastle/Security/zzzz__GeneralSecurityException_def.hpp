...
public:
  ...
  /// @brief Method .ctor addr 0x1082c20 size 0x58 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::GeneralSecurityException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x1082c78 size 0x68 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1082ce0 size 0x70 virtual false final false
