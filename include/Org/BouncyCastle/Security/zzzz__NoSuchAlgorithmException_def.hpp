...
public:
  ...
  /// @brief Method .ctor, addr 0x34dc7d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34dc7e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34dc7e8, size 0x8, virtual false, abstract: false, final false
