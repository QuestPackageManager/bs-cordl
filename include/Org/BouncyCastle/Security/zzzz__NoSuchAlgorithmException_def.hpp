...
public:
  ...
  /// @brief Method .ctor, addr 0x256d0f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x256d100, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x256d108, size 0x8, virtual false, abstract: false, final false
