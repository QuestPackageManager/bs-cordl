...
public:
  ...
  /// @brief Method .ctor addr 0x10c08ec size 0x8 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::NoSuchAlgorithmException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x10c08f4 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10c08fc size 0x8 virtual false final false
