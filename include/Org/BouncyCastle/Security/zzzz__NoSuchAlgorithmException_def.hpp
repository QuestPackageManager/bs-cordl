...
public:
  ...
  /// @brief Method .ctor, addr 0x25b1bdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25b1be4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25b1bec, size 0x8, virtual false, abstract: false, final false
