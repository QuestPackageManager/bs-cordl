...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoSuchAlgorithmException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoSuchAlgorithmException(NoSuchAlgorithmException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoSuchAlgorithmException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoSuchAlgorithmException(NoSuchAlgorithmExceptionconst&) = delete;
