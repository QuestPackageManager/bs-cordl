...
public:
  ...
  /// @brief Method .ctor, addr 0x25adea4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25adeac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25adeb4, size 0x8, virtual false, abstract: false, final false
