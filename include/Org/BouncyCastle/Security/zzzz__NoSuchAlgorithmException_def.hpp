...
public:
  ...
  /// @brief Method .ctor, addr 0x25ad7dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25ad7e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25ad7ec, size 0x8, virtual false, abstract: false, final false
