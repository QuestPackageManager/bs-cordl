...
public:
  ...
  /// @brief Method .ctor, addr 0x25a9d6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25a9d74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25a9d7c, size 0x8, virtual false, abstract: false, final false
