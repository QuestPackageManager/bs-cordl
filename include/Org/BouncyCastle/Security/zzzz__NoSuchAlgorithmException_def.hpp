...
public:
  ...
  /// @brief Method .ctor, addr 0x3600804, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x360080c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3600814, size 0x8, virtual false, abstract: false, final false
