...
public:
  ...
  /// @brief Method .ctor, addr 0x25ad81c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25ad824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25ad82c, size 0x8, virtual false, abstract: false, final false
