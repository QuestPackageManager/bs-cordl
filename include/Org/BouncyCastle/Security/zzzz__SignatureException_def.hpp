...
public:
  ...
  /// @brief Method .ctor, addr 0x12b10b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12b10bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x12b10c4, size 0x8, virtual false, abstract: false, final false
