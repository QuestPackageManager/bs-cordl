...
public:
  ...
  /// @brief Method .ctor, addr 0x25ba614, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25ba61c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25ba624, size 0x8, virtual false, abstract: false, final false
