...
public:
  ...
  /// @brief Method .ctor, addr 0x3551934, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x355193c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3551944, size 0x8, virtual false, abstract: false, final false
