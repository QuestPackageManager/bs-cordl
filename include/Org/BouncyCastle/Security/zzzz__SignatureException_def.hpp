...
public:
  ...
  /// @brief Method .ctor, addr 0x13b3340, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13b3348, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13b3350, size 0x8, virtual false, abstract: false, final false
