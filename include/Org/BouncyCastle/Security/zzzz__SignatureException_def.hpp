...
public:
  ...
  /// @brief Method .ctor, addr 0x11d7530, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11d7538, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11d7540, size 0x8, virtual false, abstract: false, final false
