...
public:
  ...
  /// @brief Method .ctor, addr 0x25bb988, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25bb990, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25bb998, size 0x8, virtual false, abstract: false, final false
