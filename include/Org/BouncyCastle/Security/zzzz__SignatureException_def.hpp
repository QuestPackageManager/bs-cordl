...
public:
  ...
  /// @brief Method .ctor, addr 0x25bfd48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25bfd50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25bfd58, size 0x8, virtual false, abstract: false, final false
