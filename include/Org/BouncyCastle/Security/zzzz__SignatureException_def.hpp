...
public:
  ...
  /// @brief Method .ctor, addr 0x13aa048, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13aa050, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13aa058, size 0x8, virtual false, abstract: false, final false
