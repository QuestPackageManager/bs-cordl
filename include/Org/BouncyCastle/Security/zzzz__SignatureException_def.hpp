...
public:
  ...
  /// @brief Method .ctor, addr 0x35153a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35153a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35153b0, size 0x8, virtual false, abstract: false, final false
