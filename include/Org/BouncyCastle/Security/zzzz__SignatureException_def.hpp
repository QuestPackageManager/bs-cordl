...
public:
  ...
  /// @brief Method .ctor, addr 0x25bc010, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25bc018, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25bc020, size 0x8, virtual false, abstract: false, final false
