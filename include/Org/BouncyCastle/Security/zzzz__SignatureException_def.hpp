...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::SignatureException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::SignatureException*, "Org.BouncyCastle.Security", "SignatureException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3610f10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3610f18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3610f20, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignatureException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignatureException(SignatureException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignatureException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignatureException(SignatureExceptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Security::SignatureException) == 0x90, "Size mismatch!");
