...
public:
  ...
  /// @brief Method .ctor, addr 0x34eab5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34eab64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34eab6c, size 0x8, virtual false, abstract: false, final false
