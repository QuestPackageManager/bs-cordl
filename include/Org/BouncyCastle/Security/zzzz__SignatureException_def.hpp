...
public:
  ...
  /// @brief Method .ctor, addr 0x25b7ed8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25b7ee0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25b7ee8, size 0x8, virtual false, abstract: false, final false
