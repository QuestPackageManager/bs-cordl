...
public:
  ...
  /// @brief Method .ctor, addr 0x257b264, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x257b26c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x257b274, size 0x8, virtual false, abstract: false, final false
