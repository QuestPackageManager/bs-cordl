...
public:
  ...
  /// @brief Method .ctor, addr 0x2550bd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2550bd8, size 0x8, virtual false, abstract: false, final false
