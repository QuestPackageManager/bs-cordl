...
public:
  ...
  /// @brief Method .ctor, addr 0x133b610, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x133b618, size 0x8, virtual false, abstract: false, final false
