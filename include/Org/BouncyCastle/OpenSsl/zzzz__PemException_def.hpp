...
public:
  ...
  /// @brief Method .ctor, addr 0x2551258, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2551260, size 0x8, virtual false, abstract: false, final false
