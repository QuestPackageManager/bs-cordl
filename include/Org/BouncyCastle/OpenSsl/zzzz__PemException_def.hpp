...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PemException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PemException(PemException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PemException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PemException(PemExceptionconst&) = delete;
