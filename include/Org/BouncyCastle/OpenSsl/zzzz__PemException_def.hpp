...
public:
  ...
  /// @brief Method .ctor, addr 0x34e78d4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34e78f8, size 0x24, virtual false, abstract: false, final false
