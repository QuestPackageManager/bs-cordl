...
public:
  ...
  /// @brief Method .ctor, addr 0x10ff424, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  static inline ::Org::BouncyCastle::OpenSsl::PemException* New_ctor(::StringW message, ::System::Exception* exception);

  /// @brief Method .ctor, addr 0x10ff42c, size 0x8, virtual false, abstract: false, final false
