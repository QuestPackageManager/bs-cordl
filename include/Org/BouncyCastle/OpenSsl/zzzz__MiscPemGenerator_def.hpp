...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MiscPemGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MiscPemGenerator(MiscPemGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MiscPemGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MiscPemGenerator(MiscPemGeneratorconst&) = delete;
