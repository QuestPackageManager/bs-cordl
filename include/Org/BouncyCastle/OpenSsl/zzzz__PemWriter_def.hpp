...
public:
  ...
  /// @brief Method WriteObject, addr 0x116b320, size 0x170, virtual false, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method WriteObject, addr 0x116b490, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x116b31c, size 0x4, virtual false, abstract: false, final false
