...
public:
  ...
  /// @brief Method WriteObject, addr 0x133ee38, size 0x170, virtual false, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method WriteObject, addr 0x133efa8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133ee34, size 0x4, virtual false, abstract: false, final false
