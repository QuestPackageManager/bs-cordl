...
public:
  ...
  /// @brief Method .ctor, addr 0x1102c48, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextWriter* writer);

  /// @brief Method WriteObject, addr 0x1102c4c, size 0x170, virtual false, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method WriteObject, addr 0x1102dbc, size 0x8c, virtual false, abstract: false, final false
