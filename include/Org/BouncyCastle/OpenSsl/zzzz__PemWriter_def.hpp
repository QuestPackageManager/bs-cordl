...
public:
  ...
  /// @brief Method WriteObject, addr 0x25542b0, size 0x164, virtual false, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method WriteObject, addr 0x2554414, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25542ac, size 0x4, virtual false, abstract: false, final false
