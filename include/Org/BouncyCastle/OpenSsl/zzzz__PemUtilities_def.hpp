...
public:
  ...
  /// @brief Method Crypt, addr 0x25505a0, size 0x4f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCipherParameters, addr 0x2553434, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDekAlgName, addr 0x25530e4, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2553574, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
