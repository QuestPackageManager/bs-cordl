...
MARK_REF_T(::Org::BouncyCastle::OpenSsl::PemUtilities*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::OpenSsl::PemUtilities_PemBaseAlg, "Org.BouncyCastle.OpenSsl", "PemUtilities/PemBaseAlg");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::OpenSsl::PemUtilities_PemMode, "Org.BouncyCastle.OpenSsl", "PemUtilities/PemMode");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::OpenSsl::PemUtilities*, "Org.BouncyCastle.OpenSsl", "PemUtilities");
// Dependencies
namespace Org::BouncyCastle::OpenSsl {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::OpenSsl::PemUtilities_PemBaseAlg) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::Org::BouncyCastle::OpenSsl::PemUtilities_PemMode) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method Crypt, addr 0x35a44a0, size 0x54c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCipherParameters, addr 0x35a7544, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDekAlgName, addr 0x35a71f0, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a76c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::OpenSsl::PemUtilities) == 0x10, "Size mismatch!");
