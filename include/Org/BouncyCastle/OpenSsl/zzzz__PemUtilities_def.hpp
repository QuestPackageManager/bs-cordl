...
public:
  ...
  /// @brief Method Crypt, addr 0x34e724c, size 0x54c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCipherParameters, addr 0x34ea2f0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDekAlgName, addr 0x34e9f9c, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34ea474, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
