...
public:
  ...
  /// @brief Method GetCurveParameters, addr 0x34e9d94, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAttributeCertificate, addr 0x34e9c84, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCertificate, addr 0x34e98cc, size 0x154, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadCertificateRequest, addr 0x34e9780, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCrl, addr 0x34e9b38, size 0x14c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Crl* ReadCrl(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadObject, addr 0x34e7f08, size 0x570, virtual false, abstract: false, final false
  inline ::System::Object* ReadObject();

  /// @brief Method ReadPkcs7, addr 0x34e9a20, size 0x118, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* ReadPkcs7(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadPrivateKey, addr 0x34e8478, size 0x1264, virtual false, abstract: false, final false
  inline ::System::Object* ReadPrivateKey(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadPublicKey, addr 0x34e96dc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadRsaPublicKey, addr 0x34e96f4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34e7ecc, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextReader* reader);

  /// @brief Method .ctor, addr 0x34e7ee4, size 0x24, virtual false, abstract: false, final false
