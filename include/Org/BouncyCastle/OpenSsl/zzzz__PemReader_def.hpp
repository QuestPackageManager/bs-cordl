...
public:
  ...
  /// @brief Method GetCurveParameters, addr 0x35a6fe8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAttributeCertificate, addr 0x35a6ed8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCertificate, addr 0x35a6b20, size 0x154, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadCertificateRequest, addr 0x35a69d4, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCrl, addr 0x35a6d8c, size 0x14c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Crl* ReadCrl(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadObject, addr 0x35a515c, size 0x570, virtual false, abstract: false, final false
  inline ::System::Object* ReadObject();

  /// @brief Method ReadPkcs7, addr 0x35a6c74, size 0x118, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* ReadPkcs7(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadPrivateKey, addr 0x35a56cc, size 0x1264, virtual false, abstract: false, final false
  inline ::System::Object* ReadPrivateKey(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadPublicKey, addr 0x35a6930, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadRsaPublicKey, addr 0x35a6948, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a5120, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextReader* reader);

  /// @brief Method .ctor, addr 0x35a5138, size 0x24, virtual false, abstract: false, final false
