...
public:
  ...
  /// @brief Method .ctor addr 0x1060900 size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1060918 size 0x24 virtual false final false
  inline void _ctor(::System::IO::TextReader* reader, ::Org::BouncyCastle::OpenSsl::IPasswordFinder* pFinder);

  /// @brief Method ReadObject addr 0x106093c size 0x4e4 virtual false final false
  inline ::System::Object* ReadObject();

  /// @brief Method ReadRsaPublicKey addr 0x10620ac size 0x8c virtual false final false
  ...
  /// @brief Method ReadPublicKey addr 0x1062090 size 0x1c virtual false final false
  ...
  /// @brief Method ReadCertificate addr 0x1062290 size 0x164 virtual false final false
  inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadCrl addr 0x1062510 size 0x164 virtual false final false
  inline ::Org::BouncyCastle::X509::X509Crl* ReadCrl(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadCertificateRequest addr 0x1062138 size 0x158 virtual false final false
  ...
  /// @brief Method ReadAttributeCertificate addr 0x1062674 size 0x6c virtual false final false
  ...
  /// @brief Method ReadPkcs7 addr 0x10623f4 size 0x11c virtual false final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* ReadPkcs7(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method ReadPrivateKey addr 0x1060e20 size 0x1270 virtual false final false
  inline ::System::Object* ReadPrivateKey(::Org::BouncyCastle::Utilities::IO::Pem::PemObject* pemObject);

  /// @brief Method GetCurveParameters addr 0x1062778 size 0xcc virtual false final false
