...
/// @brief Method GetCurveParameters, addr 0x34eab30, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method ReadAttributeCertificate, addr 0x34eaa20, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method ReadCertificate, addr 0x34ea668, size 0x154, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*  pemObject) ;

/// @brief Method ReadCertificateRequest, addr 0x34ea51c, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method ReadCrl, addr 0x34ea8d4, size 0x14c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Crl* ReadCrl(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*  pemObject) ;

/// @brief Method ReadObject, addr 0x34e8ca4, size 0x570, virtual false, abstract: false, final false
inline ::System::Object* ReadObject() ;

/// @brief Method ReadPkcs7, addr 0x34ea7bc, size 0x118, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* ReadPkcs7(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*  pemObject) ;

/// @brief Method ReadPrivateKey, addr 0x34e9214, size 0x1264, virtual false, abstract: false, final false
inline ::System::Object* ReadPrivateKey(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*  pemObject) ;

/// @brief Method ReadPublicKey, addr 0x34ea478, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method ReadRsaPublicKey, addr 0x34ea490, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34e8c68, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::System::IO::TextReader*  reader) ;

/// @brief Method .ctor, addr 0x34e8c80, size 0x24, virtual false, abstract: false, final false
