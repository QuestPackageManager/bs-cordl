...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::OpenSsl::MiscPemGenerator::*)(::System::Object*)>(&::Org::BouncyCastle::OpenSsl::MiscPemGenerator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x35a32e4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(), { ".ctor", {}, { ::i2c::type_of<::System::Object*>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::OpenSsl::MiscPemGenerator::*)(
  ...
  constexpr static std::size_t addrs = 0x35a32ec;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Org::BouncyCastle::Utilities::IO::Pem::PemObject* (*)(::System::Object*)>(&::Org::BouncyCastle::OpenSsl::MiscPemGenerator::CreatePemObject)> {
  ...
  constexpr static std::size_t addrs = 0x35a32f8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(), { "CreatePemObject", {}, { ::i2c::type_of<::System::Object*>() } })));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::Org::BouncyCastle::OpenSsl::MiscPemGenerator.CreatePemObject
...
struct CORDL_HIDDEN ::i2c::metadata_getter<
  ...
  constexpr static std::size_t addrs = 0x35a3ed4;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::ArrayW<uint8_t> (*)(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*, ::by_ref<::StringW>)>(
  ...
  constexpr static std::size_t addrs = 0x35a39a8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(),
                                                { "EncodePrivateKey", {}, { ::i2c::type_of<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*>(), ::i2c::type_of<::by_ref<::StringW>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Org::BouncyCastle::Utilities::IO::Pem::PemObject* (::Org::BouncyCastle::OpenSsl::MiscPemGenerator::*)()>(
  ...
  constexpr static std::size_t addrs = 0x35a49ec;
...
constexpr ::ArrayW<char16_t>& Org::BouncyCastle::OpenSsl::MiscPemGenerator::__cordl_internal_get_password() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___password;
}
constexpr ::ArrayW<char16_t> const& Org::BouncyCastle::OpenSsl::MiscPemGenerator::__cordl_internal_get_password() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___password;
}
constexpr void Org::BouncyCastle::OpenSsl::MiscPemGenerator::__cordl_internal_set_password(::ArrayW<char16_t> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void Org::BouncyCastle::OpenSsl::MiscPemGenerator::_ctor(::System::Object* obj, ::StringW algorithm, ::ArrayW<char16_t> password, ::Org::BouncyCastle::Security::SecureRandom* random) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(),
                                                                                         { ".ctor",
                                                                                           {},
                                                                                           { ::i2c::type_of<::System::Object*>(), ::i2c::type_of<::StringW>(), ::i2c::type_of<::ArrayW<char16_t>>(),
...
inline ::Org::BouncyCastle::Utilities::IO::Pem::PemObject* Org::BouncyCastle::OpenSsl::MiscPemGenerator::CreatePemObject(::System::Object* obj) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(), { "CreatePemObject", {}, { ::i2c::type_of<::System::Object*>() } })));
  return ::cordl_internals::RunMethodRethrow<::Org::BouncyCastle::Utilities::IO::Pem::PemObject*>(nullptr, ___internal_method, obj);
}
inline ::Org::BouncyCastle::Utilities::IO::Pem::PemObject* Org::BouncyCastle::OpenSsl::MiscPemGenerator::CreatePemObject(::System::Object* obj, ::StringW algorithm, ::ArrayW<char16_t> password,
  ...
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(),
                                                                                         { "CreatePemObject",
                                                                                           ...
                                                                                           { ::i2c::type_of<::System::Object*>(), ::i2c::type_of<::StringW>(), ::i2c::type_of<::ArrayW<char16_t>>(),
                                                                                             ::i2c::type_of<::Org::BouncyCastle::Security::SecureRandom*>() } })));
  return ::cordl_internals::RunMethodRethrow<::Org::BouncyCastle::Utilities::IO::Pem::PemObject*>(nullptr, ___internal_method, obj, algorithm, password, random);
}
inline ::ArrayW<uint8_t> Org::BouncyCastle::OpenSsl::MiscPemGenerator::EncodePrivateKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* akp, ::by_ref<::StringW> keyType) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(),
                                              { "EncodePrivateKey", {}, { ::i2c::type_of<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*>(), ::i2c::type_of<::by_ref<::StringW>>() } })));
  return ::cordl_internals::RunMethodRethrow<::ArrayW<uint8_t>>(nullptr, ___internal_method, akp, keyType);
}
...
inline ::Org::BouncyCastle::OpenSsl::MiscPemGenerator* Org::BouncyCastle::OpenSsl::MiscPemGenerator::New_ctor(::System::Object* obj) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(obj));
}
inline ::Org::BouncyCastle::OpenSsl::MiscPemGenerator* Org::BouncyCastle::OpenSsl::MiscPemGenerator::New_ctor(::System::Object* obj, ::StringW algorithm, ::ArrayW<char16_t> password,
                                                                                                              ::Org::BouncyCastle::Security::SecureRandom* random) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::OpenSsl::MiscPemGenerator*>(obj, algorithm, password, random));
}
