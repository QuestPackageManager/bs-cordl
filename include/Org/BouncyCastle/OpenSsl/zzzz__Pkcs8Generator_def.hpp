...
public:
  ...
  /// @brief Method Generate, addr 0x35a85b8, size 0x270, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35a8584, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privKey);

  /// @brief Method .ctor, addr 0x35a858c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IterationCount, addr 0x35a85b0, size 0x8, virtual false, abstract: false, final false
  inline void set_IterationCount(int32_t value);

  /// @brief Method set_Password, addr 0x35a85a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Password(::ArrayW<char16_t> value);

  /// @brief Method set_SecureRandom, addr 0x35a85a0, size 0x8, virtual false, abstract: false, final false
