...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::SecretKeyPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::SecretKeyPacket*, "Org.BouncyCastle.Bcpg", "SecretKeyPacket");
...
public:
  ...
  /// @brief Method Encode, addr 0x369de90, size 0x2c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncodedContents, addr 0x369dd28, size 0x168, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncodedContents();

  /// @brief Method GetIV, addr 0x369dcb0, size 0x60, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetIV();

  /// @brief Method GetSecretKeyData, addr 0x369dd20, size 0x8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_secKeyData() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_secKeyData();
  ...
  /// @brief Method .ctor, addr 0x3698f0c, size 0x1f0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369db50, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369dbfc, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EncAlgorithm, addr 0x369dca0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag get_EncAlgorithm();

  /// @brief Method get_PublicKeyPacket, addr 0x369dd18, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyPacket* get_PublicKeyPacket();

  /// @brief Method get_S2k, addr 0x369dd10, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::S2k* get_S2k();

  /// @brief Method get_S2kUsage, addr 0x369dca8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::SecretKeyPacket) == 0x38, "Size mismatch!");
