...
public:
  ...
  /// @brief Method Encode, addr 0x12446d4, size 0x2c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncodedContents, addr 0x1244574, size 0x160, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncodedContents();

  /// @brief Method GetIV, addr 0x1244500, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetSecretKeyData, addr 0x124456c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x123f474, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x1244390, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1244444, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EncAlgorithm, addr 0x12444f0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag get_EncAlgorithm();

  /// @brief Method get_PublicKeyPacket, addr 0x1244564, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyPacket* get_PublicKeyPacket();

  /// @brief Method get_S2k, addr 0x124455c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::S2k* get_S2k();

  /// @brief Method get_S2kUsage, addr 0x12444f8, size 0x8, virtual false, abstract: false, final false
