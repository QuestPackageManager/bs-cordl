...
public:
  ...
  /// @brief Method Wrap addr 0x115e508 size 0x90 virtual false final false
  ...
  /// @brief Method .ctor addr 0x115e460 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x115e598 size 0x90 virtual false final false
  ...
  /// @brief Method .ctor addr 0x115e79c size 0x130 virtual false final false
  ...
  /// @brief Method .ctor addr 0x115e8cc size 0x9c virtual false final false
  ...
  /// @brief Method .ctor addr 0x115e968 size 0x128 virtual false final false
  inline void _ctor(::System::IO::Stream* outStr, ::Org::BouncyCastle::Bcpg::PacketTag tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method WriteNewPacketLength addr 0x115ea90 size 0xe0 virtual false final false
  inline void WriteNewPacketLength(int64_t bodyLen);

  /// @brief Method WriteHeader addr 0x115e628 size 0x174 virtual false final false
  inline void WriteHeader(::Org::BouncyCastle::Bcpg::PacketTag tag, bool oldPackets, bool partial, int64_t bodyLen);

  /// @brief Method PartialFlush addr 0x115eb70 size 0x80 virtual false final false
  inline void PartialFlush(bool isLast);

  /// @brief Method WritePartial addr 0x115ebf0 size 0x68 virtual false final false
  inline void WritePartial(uint8_t b);

  /// @brief Method WritePartial addr 0x115ec58 size 0xec virtual false final false
  inline void WritePartial(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t off, int32_t len);

  /// @brief Method WriteByte addr 0x115ed44 size 0x34 virtual true final false
  inline void WriteByte(uint8_t value);

  /// @brief Method Write addr 0x115ed78 size 0x34 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteShort addr 0x115edac size 0x94 virtual true final false
  inline void WriteShort(int16_t n);

  /// @brief Method WriteInt addr 0x115ee40 size 0xb4 virtual true final false
  inline void WriteInt(int32_t n);

  /// @brief Method WriteLong addr 0x115eef4 size 0xf4 virtual true final false
  inline void WriteLong(int64_t n);

  /// @brief Method WritePacket addr 0x115efe8 size 0x28 virtual false final false
  inline void WritePacket(::Org::BouncyCastle::Bcpg::ContainedPacket* p);

  /// @brief Method WritePacket addr 0x115f010 size 0x48 virtual false final false
  inline void WritePacket(::Org::BouncyCastle::Bcpg::PacketTag tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> body, bool oldFormat);

  /// @brief Method WriteObject addr 0x115e4d8 size 0x28 virtual false final false
  inline void WriteObject(::Org::BouncyCastle::Bcpg::BcpgObject* bcpgObject);

  /// @brief Method WriteObjects addr 0x115f058 size 0x6c virtual false final false
  inline void WriteObjects(::ArrayW<::Org::BouncyCastle::Bcpg::BcpgObject*, ::Array<::Org::BouncyCastle::Bcpg::BcpgObject*>*> v);

  /// @brief Method Flush addr 0x115f0c4 size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method Finish addr 0x115f0e8 size 0x40 virtual false final false
  inline void Finish();

  /// @brief Method Close addr 0x115f128 size 0x8c virtual true final false
  inline void Close();
