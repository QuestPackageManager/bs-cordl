...
public:
  ...
  /// @brief Method Encode, addr 0x35df168, size 0x24, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetContents, addr 0x35df0f0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35dc8e4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::PacketTag tag, ::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_Tag, addr 0x35df0e8, size 0x8, virtual false, abstract: false, final false
