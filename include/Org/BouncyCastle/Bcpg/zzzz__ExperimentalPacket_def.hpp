...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExperimentalPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExperimentalPacket(ExperimentalPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExperimentalPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExperimentalPacket(ExperimentalPacketconst&) = delete;
