...
public:
  ...
  /// @brief Method Encode, addr 0x35e1e00, size 0x168, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetSecKeyData, addr 0x35e1df0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35dba74, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35e1dd0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EncAlgorithm, addr 0x35e1de0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag get_EncAlgorithm();

  /// @brief Method get_S2k, addr 0x35e1de8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::S2k* get_S2k();

  /// @brief Method get_Version, addr 0x35e1df8, size 0x8, virtual false, abstract: false, final false
