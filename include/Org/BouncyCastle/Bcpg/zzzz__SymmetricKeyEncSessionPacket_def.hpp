...
public:
  ...
  /// @brief Method Encode, addr 0x264b9b0, size 0x164, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetSecKeyData, addr 0x264b9a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26452b4, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x264b950, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EncAlgorithm, addr 0x264b990, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag get_EncAlgorithm();

  /// @brief Method get_S2k, addr 0x264b998, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::S2k* get_S2k();

  /// @brief Method get_Version, addr 0x264b9a8, size 0x8, virtual false, abstract: false, final false
