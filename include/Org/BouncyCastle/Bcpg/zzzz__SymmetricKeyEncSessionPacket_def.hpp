...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::SymmetricKeyEncSessionPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::SymmetricKeyEncSessionPacket*, "Org.BouncyCastle.Bcpg", "SymmetricKeyEncSessionPacket");
...
public:
  ...
  /// @brief Method Encode, addr 0x369f054, size 0x168, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetSecKeyData, addr 0x369f044, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3698cc8, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369f024, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EncAlgorithm, addr 0x369f034, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag get_EncAlgorithm();

  /// @brief Method get_S2k, addr 0x369f03c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::S2k* get_S2k();

  /// @brief Method get_Version, addr 0x369f04c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::SymmetricKeyEncSessionPacket) == 0x28, "Size mismatch!");
