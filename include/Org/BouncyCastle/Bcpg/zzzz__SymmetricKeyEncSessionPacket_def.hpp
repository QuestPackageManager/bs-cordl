...
public:
  ...
  /// @brief Method Encode, addr 0x143dce4, size 0x15c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetSecKeyData, addr 0x143dcd4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1437444, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x143dc84, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EncAlgorithm, addr 0x143dcc4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag get_EncAlgorithm();

  /// @brief Method get_S2k, addr 0x143dccc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::S2k* get_S2k();

  /// @brief Method get_Version, addr 0x143dcdc, size 0x8, virtual false, abstract: false, final false
