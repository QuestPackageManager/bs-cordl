...
public:
  ...
  /// @brief Method .ctor, addr 0x11d3144, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d32dc, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d330c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d3348, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag algorithm, ::ArrayW<uint8_t, ::Array<uint8_t>*> iv, int32_t itCount);

  /// @brief Method get_Type, addr 0x11d3394, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_HashAlgorithm, addr 0x11d339c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method GetIV, addr 0x11d33a4, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetIterationCount, addr 0x11d3400, size 0xc, virtual false, abstract: false, final false
  inline int64_t GetIterationCount();

  /// @brief Method get_IterationCount, addr 0x11d340c, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_IterationCount();

  /// @brief Method get_ProtectionMode, addr 0x11d342c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ProtectionMode();

  /// @brief Method Encode, addr 0x11d3434, size 0xfc, virtual true, abstract: false, final false
