...
/// @brief Method Encode, addr 0x35e159c, size 0xfc, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream*  bcpgOut) ;

/// @brief Method GetIV, addr 0x35e1508, size 0x60, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetIV() ;

/// @brief Method GetIterationCount, addr 0x35e1568, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35e14b8, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag  algorithm) ;

/// @brief Method .ctor, addr 0x35e14c8, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag  algorithm, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv) ;

/// @brief Method .ctor, addr 0x35e14e0, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag  algorithm, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv, int32_t  itCount) ;

/// @brief Method .ctor, addr 0x35e12f4, size 0x1c4, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStr) ;

/// @brief Method get_HashAlgorithm, addr 0x35e1500, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method get_IterationCount, addr 0x35e1574, size 0x20, virtual true, abstract: false, final false
inline int64_t get_IterationCount() ;

/// @brief Method get_ProtectionMode, addr 0x35e1594, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ProtectionMode() ;

/// @brief Method get_Type, addr 0x35e14f8, size 0x8, virtual true, abstract: false, final false
