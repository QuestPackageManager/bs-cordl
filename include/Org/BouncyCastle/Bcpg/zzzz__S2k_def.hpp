...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::S2k*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::S2k*, "Org.BouncyCastle.Bcpg", "S2k");
// Dependencies Org.BouncyCastle.Bcpg.BcpgObject, Org.BouncyCastle.Bcpg.HashAlgorithmTag
namespace Org::BouncyCastle::Bcpg {
// Is value type: false
...
public:
  ...
  /// @brief Method Encode, addr 0x369da54, size 0xfc, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetIV, addr 0x369d9c0, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetIV();

  /// @brief Method GetIterationCount, addr 0x369da20, size 0xc, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Bcpg::S2k* New_ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag algorithm, ::ArrayW<uint8_t> iv);

  static inline ::Org::BouncyCastle::Bcpg::S2k* New_ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag algorithm, ::ArrayW<uint8_t> iv, int32_t itCount);
  ...
  /// @brief Method .ctor, addr 0x369d970, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag algorithm);

  /// @brief Method .ctor, addr 0x369d980, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag algorithm, ::ArrayW<uint8_t> iv);

  /// @brief Method .ctor, addr 0x369d998, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag algorithm, ::ArrayW<uint8_t> iv, int32_t itCount);

  /// @brief Method .ctor, addr 0x369d7ac, size 0x1c4, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStr);

  /// @brief Method get_HashAlgorithm, addr 0x369d9b8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_IterationCount, addr 0x369da2c, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_IterationCount();

  /// @brief Method get_ProtectionMode, addr 0x369da4c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ProtectionMode();

  /// @brief Method get_Type, addr 0x369d9b0, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::S2k) == 0x28, "Size mismatch!");
