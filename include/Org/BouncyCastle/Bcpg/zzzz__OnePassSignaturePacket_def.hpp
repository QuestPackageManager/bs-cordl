...
public:
  ...
  /// @brief Method Encode, addr 0x369c71c, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3698d7c, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369c6dc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x369c70c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x369c704, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x369c714, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x369c6fc, size 0x8, virtual false, abstract: false, final false
