...
public:
  ...
  /// @brief Method Encode, addr 0x35df4c8, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35dbb28, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35df488, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x35df4b8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x35df4b0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x35df4c0, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x35df4a8, size 0x8, virtual false, abstract: false, final false
