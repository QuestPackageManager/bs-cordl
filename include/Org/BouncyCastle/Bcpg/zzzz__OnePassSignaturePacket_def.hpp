...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OnePassSignaturePacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OnePassSignaturePacket(OnePassSignaturePacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OnePassSignaturePacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OnePassSignaturePacket(OnePassSignaturePacketconst&) = delete;
