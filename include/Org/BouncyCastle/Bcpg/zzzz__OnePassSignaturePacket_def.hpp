...
public:
  ...
  /// @brief Method Encode, addr 0x35786f0, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3574d50, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35786b0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x35786e0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x35786d8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x35786e8, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x35786d0, size 0x8, virtual false, abstract: false, final false
