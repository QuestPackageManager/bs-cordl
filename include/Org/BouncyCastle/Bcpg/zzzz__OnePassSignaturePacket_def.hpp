...
public:
  ...
  /// @brief Method Encode, addr 0x1341120, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133d564, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x1341098, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x1341110, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x1341108, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x1341118, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x1341100, size 0x8, virtual false, abstract: false, final false
