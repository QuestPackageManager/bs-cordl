...
public:
  ...
  /// @brief Method Encode, addr 0x2647ac4, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2643ff0, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x2647a44, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x2647ab4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x2647aac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x2647abc, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x2647aa4, size 0x8, virtual false, abstract: false, final false
