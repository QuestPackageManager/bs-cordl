...
public:
  ...
  /// @brief Method Encode, addr 0x2648e38, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2645364, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x2648db8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x2648e28, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x2648e20, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x2648e30, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x2648e18, size 0x8, virtual false, abstract: false, final false
