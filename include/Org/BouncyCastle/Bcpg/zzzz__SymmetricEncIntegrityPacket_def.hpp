...
public:
  ...
  /// @brief Method .ctor, addr 0x369bdd4, size 0x38, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SymmetricEncIntegrityPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SymmetricEncIntegrityPacket(SymmetricEncIntegrityPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SymmetricEncIntegrityPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SymmetricEncIntegrityPacket(SymmetricEncIntegrityPacketconst&) = delete;
