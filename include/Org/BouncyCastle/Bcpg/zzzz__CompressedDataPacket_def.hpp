...
public:
  ...
  /// @brief Method .ctor, addr 0x123f8f0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_Algorithm, addr 0x1241274, size 0x8, virtual false, abstract: false, final false
