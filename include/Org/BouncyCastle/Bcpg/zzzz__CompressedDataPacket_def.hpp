...
public:
  ...
  /// @brief Method .ctor, addr 0x2645914, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_Algorithm, addr 0x264727c, size 0x8, virtual false, abstract: false, final false
