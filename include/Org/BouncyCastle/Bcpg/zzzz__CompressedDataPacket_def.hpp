...
/// @brief Method .ctor, addr 0x359fb00, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgIn) ;

/// @brief Method get_Algorithm, addr 0x35a1404, size 0x8, virtual false, abstract: false, final false
