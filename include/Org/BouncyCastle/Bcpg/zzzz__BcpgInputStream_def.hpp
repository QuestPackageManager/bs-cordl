...
public:
  ...
  /// @brief Method Read, addr 0x2646a68, size 0xdc, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x2646890, size 0xa8, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method ReadPartialDataLength, addr 0x2646938, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2644854, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Close, addr 0x2646828, size 0x68, virtual true, abstract: false, final false
  inline void Close();

  static inline ::Org::BouncyCastle::Bcpg::BcpgInputStream* New_ctor(::System::IO::Stream* inputStream);

  /// @brief Method NextPacketTag, addr 0x26440dc, size 0xe0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PacketTag NextPacketTag();

  /// @brief Method Read, addr 0x2643fb4, size 0xb0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadAll, addr 0x2644064, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadAll();

  /// @brief Method ReadByte, addr 0x2643f74, size 0x40, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method ReadFully, addr 0x26440c0, size 0x1c, virtual false, abstract: false, final false
  inline void ReadFully(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method ReadFully, addr 0x264406c, size 0x54, virtual false, abstract: false, final false
  inline void ReadFully(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t off, int32_t len);

  /// @brief Method ReadPacket, addr 0x26441bc, size 0x698, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::Packet* ReadPacket();

  /// @brief Method Wrap, addr 0x2643eb4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2643f48, size 0x2c, virtual false, abstract: false, final false
