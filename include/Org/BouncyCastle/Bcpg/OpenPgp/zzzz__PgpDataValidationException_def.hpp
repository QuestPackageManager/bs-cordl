...
public:
  ...
  /// @brief Method .ctor, addr 0x34bff18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34bff1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34bff20, size 0x4, virtual false, abstract: false, final false
