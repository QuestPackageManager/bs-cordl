...
public:
  ...
  /// @brief Method .ctor, addr 0x3483984, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3483988, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x348398c, size 0x4, virtual false, abstract: false, final false
