...
public:
  ...
  /// @brief Method .ctor, addr 0x252d720, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x252d724, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x252d728, size 0x4, virtual false, abstract: false, final false
