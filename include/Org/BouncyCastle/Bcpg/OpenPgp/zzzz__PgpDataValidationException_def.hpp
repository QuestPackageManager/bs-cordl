...
public:
  ...
  /// @brief Method .ctor, addr 0x1219698, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x121969c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x12196a0, size 0x4, virtual false, abstract: false, final false
