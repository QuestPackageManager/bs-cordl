...
public:
  ...
  /// @brief Method .ctor, addr 0x357d16c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x357d170, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x357d174, size 0x4, virtual false, abstract: false, final false
