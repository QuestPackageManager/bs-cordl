...
public:
  ...
  /// @brief Method .ctor, addr 0x10d6440, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpDataValidationException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x10d6444, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d6448, size 0x4, virtual false, abstract: false, final false
