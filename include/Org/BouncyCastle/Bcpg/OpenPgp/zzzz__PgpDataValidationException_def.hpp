...
public:
  ...
  /// @brief Method .ctor, addr 0x25258b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25258b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25258b8, size 0x4, virtual false, abstract: false, final false
