...
public:
  ...
  /// @brief Method .ctor, addr 0x1309dbc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1309dc0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1309dc4, size 0x4, virtual false, abstract: false, final false
