...
public:
  ...
  /// @brief Method .ctor, addr 0x1140b74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddSessionInfo, addr 0x1140b84, size 0x2a0, virtual true, abstract: false, final false
  inline void AddSessionInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> si, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method Encode, addr 0x1140e24, size 0x98, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut);

  /// @brief Method GetKey, addr 0x1140b7c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x113f600, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddSessionInfo, addr 0x1140ebc, size 0x24, virtual true, abstract: false, final false
  inline void AddSessionInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method ConvertToEncodedMpi, addr 0x1142174, size 0x1a0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertToEncodedMpi(::ArrayW<uint8_t, ::Array<uint8_t>*> encryptedSessionInfo);

  /// @brief Method Encode, addr 0x1142314, size 0xb0, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut);

  /// @brief Method EncryptSessionInfo, addr 0x1140ee0, size 0x94c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSessionInfo, addr 0x114182c, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x113f7e4, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddCheckSum, addr 0x113f814, size 0x90, virtual false, abstract: false, final false
  inline void AddCheckSum(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo);

  /// @brief Method AddMethod, addr 0x113f63c, size 0x8, virtual false, abstract: false, final false
  inline void AddMethod(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* key);

  /// @brief Method AddMethod, addr 0x113f644, size 0x14c, virtual false, abstract: false, final false
  inline void AddMethod(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* key, bool sessionKeyObfuscation);

  /// @brief Method AddMethod, addr 0x113f414, size 0x30, virtual false, abstract: false, final false
  inline void AddMethod(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase);

  /// @brief Method AddMethod, addr 0x113f444, size 0x3c, virtual false, abstract: false, final false
  inline void AddMethod(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method AddMethodRaw, addr 0x113f5f4, size 0xc, virtual false, abstract: false, final false
  inline void AddMethodRaw(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPassPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method AddMethodUtf8, addr 0x113f5b4, size 0x40, virtual false, abstract: false, final false
  inline void AddMethodUtf8(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method Close, addr 0x11408b0, size 0x2c4, virtual true, abstract: false, final true
  inline void Close();

  /// @brief Method CreateSessionInfo, addr 0x113f8a4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method DoAddMethod, addr 0x113f480, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x11408a4, size 0xc, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method Open, addr 0x114089c, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, int64_t length);

  /// @brief Method Open, addr 0x113f94c, size 0xf50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x113f114, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm);

  /// @brief Method .ctor, addr 0x113f274, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x113f384, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x113f1c0, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm, bool withIntegrityPacket);

  /// @brief Method .ctor, addr 0x113f2f4, size 0x90, virtual false, abstract: false, final false
