...
public:
  ...
  /// @brief Method .ctor, addr 0x34c1eb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddSessionInfo, addr 0x34c1ec0, size 0x2ac, virtual true, abstract: false, final false
  inline void AddSessionInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> si, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method Encode, addr 0x34c216c, size 0x84, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut);

  /// @brief Method GetKey, addr 0x34c1eb8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34c099c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddSessionInfo, addr 0x34c21f0, size 0x24, virtual true, abstract: false, final false
  inline void AddSessionInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method ConvertToEncodedMpi, addr 0x34c3454, size 0x194, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertToEncodedMpi(::ArrayW<uint8_t, ::Array<uint8_t>*> encryptedSessionInfo);

  /// @brief Method Encode, addr 0x34c35e8, size 0xb8, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut);

  /// @brief Method EncryptSessionInfo, addr 0x34c2214, size 0x968, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSessionInfo, addr 0x34c2b7c, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34c0b48, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddCheckSum, addr 0x34c0b54, size 0x90, virtual false, abstract: false, final false
  inline void AddCheckSum(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo);

  /// @brief Method AddMethod, addr 0x34c09a8, size 0x8, virtual false, abstract: false, final false
  inline void AddMethod(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* key);

  /// @brief Method AddMethod, addr 0x34c09b0, size 0x144, virtual false, abstract: false, final false
  inline void AddMethod(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* key, bool sessionKeyObfuscation);

  /// @brief Method AddMethod, addr 0x34c07b8, size 0x30, virtual false, abstract: false, final false
  inline void AddMethod(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase);

  /// @brief Method AddMethod, addr 0x34c07e8, size 0x3c, virtual false, abstract: false, final false
  inline void AddMethod(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method AddMethodRaw, addr 0x34c0990, size 0xc, virtual false, abstract: false, final false
  inline void AddMethodRaw(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPassPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method AddMethodUtf8, addr 0x34c0954, size 0x3c, virtual false, abstract: false, final false
  inline void AddMethodUtf8(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method Close, addr 0x34c1bdc, size 0x2d8, virtual true, abstract: false, final true
  inline void Close();

  /// @brief Method CreateSessionInfo, addr 0x34c0be4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoAddMethod, addr 0x34c0824, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x34c1bd0, size 0xc, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method Open, addr 0x34c1bc8, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, int64_t length);

  /// @brief Method Open, addr 0x34c0c98, size 0xf30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34c04dc, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm);

  /// @brief Method .ctor, addr 0x34c0628, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34c072c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34c057c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm, bool withIntegrityPacket);

  /// @brief Method .ctor, addr 0x34c06a0, size 0x8c, virtual false, abstract: false, final false
