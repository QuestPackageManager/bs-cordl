...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator*);
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_EncMethod*);
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_PbeMethod*);
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_PubMethod*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpEncryptedDataGenerator");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_EncMethod*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpEncryptedDataGenerator/EncMethod");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_PbeMethod*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpEncryptedDataGenerator/PbeMethod");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_PubMethod*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpEncryptedDataGenerator/PubMethod");
...
public:
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_sessionInfo() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_sessionInfo();
  ...
  constexpr void __cordl_internal_set_sessionInfo(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x357f108, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_EncMethod) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddSessionInfo, addr 0x357f114, size 0x2ac, virtual true, abstract: false, final false
  inline void AddSessionInfo(::ArrayW<uint8_t> si, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method Encode, addr 0x357f3c0, size 0x84, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut);

  /// @brief Method GetKey, addr 0x357f10c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x357dbf0, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_PbeMethod) == 0x30, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_data, put = __cordl_internal_set_data)) ::ArrayW<::ArrayW<uint8_t>> data;
  ...
  /// @brief Method AddSessionInfo, addr 0x357f444, size 0x24, virtual true, abstract: false, final false
  inline void AddSessionInfo(::ArrayW<uint8_t> sessionInfo, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method ConvertToEncodedMpi, addr 0x35806a8, size 0x194, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ConvertToEncodedMpi(::ArrayW<uint8_t> encryptedSessionInfo);

  /// @brief Method Encode, addr 0x358083c, size 0xb8, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut);

  /// @brief Method EncryptSessionInfo, addr 0x357f468, size 0x968, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> EncryptSessionInfo(::ArrayW<uint8_t> sessionInfo, ::Org::BouncyCastle::Security::SecureRandom* random);
  ...
  /// @brief Method ProcessSessionInfo, addr 0x357fdd0, size 0x23c, virtual false, abstract: false, final false
  inline ::ArrayW<::ArrayW<uint8_t>> ProcessSessionInfo(::ArrayW<uint8_t> encryptedSessionInfo);

  constexpr ::ArrayW<::ArrayW<uint8_t>> const& __cordl_internal_get_data() const;

  constexpr ::ArrayW<::ArrayW<uint8_t>>& __cordl_internal_get_data();
  ...
  constexpr void __cordl_internal_set_data(::ArrayW<::ArrayW<uint8_t>> value);
  ...
  /// @brief Method .ctor, addr 0x357dd9c, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator_PubMethod) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddCheckSum, addr 0x357dda8, size 0x90, virtual false, abstract: false, final false
  inline void AddCheckSum(::ArrayW<uint8_t> sessionInfo);

  /// @brief Method AddMethod, addr 0x357dbfc, size 0x8, virtual false, abstract: false, final false
  inline void AddMethod(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* key);

  /// @brief Method AddMethod, addr 0x357dc04, size 0x144, virtual false, abstract: false, final false
  inline void AddMethod(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* key, bool sessionKeyObfuscation);

  /// @brief Method AddMethod, addr 0x357da0c, size 0x30, virtual false, abstract: false, final false
  inline void AddMethod(::ArrayW<char16_t> passPhrase);

  /// @brief Method AddMethod, addr 0x357da3c, size 0x3c, virtual false, abstract: false, final false
  inline void AddMethod(::ArrayW<char16_t> passPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method AddMethodRaw, addr 0x357dbe4, size 0xc, virtual false, abstract: false, final false
  inline void AddMethodRaw(::ArrayW<uint8_t> rawPassPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method AddMethodUtf8, addr 0x357dba8, size 0x3c, virtual false, abstract: false, final false
  inline void AddMethodUtf8(::ArrayW<char16_t> passPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method Close, addr 0x357ee30, size 0x2d8, virtual true, abstract: false, final true
  inline void Close();

  /// @brief Method CreateSessionInfo, addr 0x357de38, size 0xb4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> CreateSessionInfo(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algorithm, ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* key);

  /// @brief Method DoAddMethod, addr 0x357da78, size 0x130, virtual false, abstract: false, final false
  inline void DoAddMethod(::ArrayW<uint8_t> rawPassPhrase, bool clearPassPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);
  ...
  /// @brief Method Open, addr 0x357ee24, size 0xc, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::ArrayW<uint8_t> buffer);

  /// @brief Method Open, addr 0x357ee1c, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, int64_t length);

  /// @brief Method Open, addr 0x357deec, size 0xf30, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, int64_t length, ::ArrayW<uint8_t> buffer);
  ...
  /// @brief Method .ctor, addr 0x357d730, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm);

  /// @brief Method .ctor, addr 0x357d87c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x357d980, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x357d7d0, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm, bool withIntegrityPacket);

  /// @brief Method .ctor, addr 0x357d8f4, size 0x8c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataGenerator) == 0x50, "Size mismatch!");
