...
public:
  ...
  /// @brief Method .ctor, addr 0x25278ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddSessionInfo, addr 0x25278bc, size 0x294, virtual true, abstract: false, final false
  inline void AddSessionInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> si, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method Encode, addr 0x2527b50, size 0x94, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut);

  /// @brief Method GetKey, addr 0x25278b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2526388, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddSessionInfo, addr 0x2527be4, size 0x24, virtual true, abstract: false, final false
  inline void AddSessionInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method ConvertToEncodedMpi, addr 0x2528dd8, size 0x188, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertToEncodedMpi(::ArrayW<uint8_t, ::Array<uint8_t>*> encryptedSessionInfo);

  /// @brief Method Encode, addr 0x2528f60, size 0xac, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut);

  /// @brief Method EncryptSessionInfo, addr 0x2527c08, size 0x928, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSessionInfo, addr 0x2528530, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2526560, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddCheckSum, addr 0x2526590, size 0xc4, virtual false, abstract: false, final false
  inline void AddCheckSum(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo);

  /// @brief Method AddMethod, addr 0x25263c4, size 0x8, virtual false, abstract: false, final false
  inline void AddMethod(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* key);

  /// @brief Method AddMethod, addr 0x25263cc, size 0x144, virtual false, abstract: false, final false
  inline void AddMethod(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* key, bool sessionKeyObfuscation);

  /// @brief Method AddMethod, addr 0x25261a0, size 0x30, virtual false, abstract: false, final false
  inline void AddMethod(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase);

  /// @brief Method AddMethod, addr 0x25261d0, size 0x3c, virtual false, abstract: false, final false
  inline void AddMethod(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method AddMethodRaw, addr 0x252637c, size 0xc, virtual false, abstract: false, final false
  inline void AddMethodRaw(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPassPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method AddMethodUtf8, addr 0x252633c, size 0x40, virtual false, abstract: false, final false
  inline void AddMethodUtf8(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest);

  /// @brief Method Close, addr 0x25275f0, size 0x2bc, virtual true, abstract: false, final true
  inline void Close();

  /// @brief Method CreateSessionInfo, addr 0x2526654, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method DoAddMethod, addr 0x252620c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x25275e4, size 0xc, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method Open, addr 0x25275dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, int64_t length);

  /// @brief Method Open, addr 0x25266fc, size 0xee0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2525ea4, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm);

  /// @brief Method .ctor, addr 0x2525ff8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252610c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2525f48, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm, bool withIntegrityPacket);

  /// @brief Method .ctor, addr 0x2526078, size 0x94, virtual false, abstract: false, final false
