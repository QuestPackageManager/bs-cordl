...
public:
  ...
  /// @brief Method FillBuffer, addr 0x2528458, size 0x58, virtual false, abstract: false, final false
  inline int32_t FillBuffer();

  /// @brief Method GetLookAhead, addr 0x2528314, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2528514, size 0xcc, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ReadByte, addr 0x25284b0, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2528388, size 0xd0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetInputStream, addr 0x2528020, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IO::Stream* GetInputStream();

  /// @brief Method IsIntegrityProtected, addr 0x252803c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Verify, addr 0x25280b8, size 0x25c, virtual false, abstract: false, final false
  inline bool Verify();
  ...
  /// @brief Method .ctor, addr 0x2527ff8, size 0x28, virtual false, abstract: false, final false
