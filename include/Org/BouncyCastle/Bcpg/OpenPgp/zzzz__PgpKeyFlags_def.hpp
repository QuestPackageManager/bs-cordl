...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyFlags*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyFlags*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpKeyFlags");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35812e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyFlags) == 0x10, "Size mismatch!");
