...
public:
  ...
  /// @brief Method .ctor, addr 0x1309cec, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1305d88, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1309d44, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* exception);

  /// @brief Method get_UnderlyingException, addr 0x1309db4, size 0x8, virtual false, abstract: false, final false
