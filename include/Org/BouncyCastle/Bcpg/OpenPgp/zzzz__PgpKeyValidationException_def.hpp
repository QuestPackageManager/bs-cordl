...
public:
  ...
  /// @brief Method .ctor, addr 0x252fb1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x252fb20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x252fb24, size 0x4, virtual false, abstract: false, final false
