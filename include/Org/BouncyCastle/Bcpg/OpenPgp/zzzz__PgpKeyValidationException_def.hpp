...
public:
  ...
  /// @brief Method .ctor, addr 0x34c6738, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34c673c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34c6740, size 0x4, virtual false, abstract: false, final false
