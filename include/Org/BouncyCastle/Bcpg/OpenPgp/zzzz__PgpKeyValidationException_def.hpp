...
public:
  ...
  /// @brief Method .ctor addr 0x103eccc size 0x4 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x103ecd0 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x103ecd4 size 0x4 virtual false final false
