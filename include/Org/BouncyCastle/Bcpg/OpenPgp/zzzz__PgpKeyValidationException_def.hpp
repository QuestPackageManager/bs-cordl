...
public:
  ...
  /// @brief Method .ctor, addr 0x2533e8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2533e90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2533e94, size 0x4, virtual false, abstract: false, final false
