...
public:
  ...
  /// @brief Method .ctor, addr 0x348a1a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x348a1a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x348a1ac, size 0x4, virtual false, abstract: false, final false
