...
public:
  ...
  /// @brief Method .ctor, addr 0x252c01c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x252c020, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x252c024, size 0x4, virtual false, abstract: false, final false
