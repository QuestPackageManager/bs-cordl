...
public:
  ...
  /// @brief Method .ctor, addr 0x1120d7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1120d80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1120d84, size 0x4, virtual false, abstract: false, final false
