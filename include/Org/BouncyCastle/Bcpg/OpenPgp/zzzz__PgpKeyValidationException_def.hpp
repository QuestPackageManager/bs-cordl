...
public:
  ...
  /// @brief Method .ctor, addr 0x10dcdac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x10dcdb0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10dcdb4, size 0x4, virtual false, abstract: false, final false
