...
public:
  ...
  /// @brief Method .ctor, addr 0x2530154, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2530158, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x253015c, size 0x4, virtual false, abstract: false, final false
