...
public:
  ...
  /// @brief Method .ctor, addr 0x1145480, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1145484, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1145488, size 0x4, virtual false, abstract: false, final false
