...
public:
  ...
  /// @brief Method .ctor, addr 0x1220004, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1220008, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x122000c, size 0x4, virtual false, abstract: false, final false
