...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException::*)(::StringW, ::System::Exception*)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException* Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException*>());
}
...
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException* Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException::New_ctor(::StringW message) {
  return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException*>(message));
}
...
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException* Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException::New_ctor(::StringW message, ::System::Exception* exception) {
  return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyValidationException*>(message, exception));
}
