...
/// @brief Method AddSecretKeyRing, addr 0x34a15b8, size 0x2c8, virtual false, abstract: false, final false
...
/// @brief Method Contains, addr 0x34a1118, size 0x18, virtual false, abstract: false, final false
inline bool Contains(int64_t  keyID) ;

/// @brief Method Encode, addr 0x34a11ac, size 0x40c, virtual false, abstract: false, final false
inline void Encode(::System::IO::Stream*  outStr) ;

/// @brief Method GetEncoded, addr 0x34a1130, size 0x7c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetKeyRings, addr 0x34a003c, size 0xe8, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerable* GetKeyRings() ;

/// @brief Method GetKeyRings, addr 0x34a0124, size 0xc, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerable* GetKeyRings(::StringW  userId) ;

/// @brief Method GetKeyRings, addr 0x34a0948, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerable* GetKeyRings(::StringW  userId, bool  matchPartial) ;

/// @brief Method GetKeyRings, addr 0x34a0130, size 0x818, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerable* GetKeyRings(::StringW  userId, bool  matchPartial, bool  ignoreCase) ;

/// @brief Method GetSecretKey, addr 0x34a0950, size 0x330, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKey* GetSecretKey(int64_t  keyId) ;

/// @brief Method GetSecretKeyRing, addr 0x34a0c80, size 0x498, virtual false, abstract: false, final false
...
/// @brief Method RemoveSecretKeyRing, addr 0x34a1880, size 0x2c4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x349f98c, size 0x560, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::IEnumerable*  e) ;

/// @brief Method .ctor, addr 0x349f898, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  encoding) ;

/// @brief Method .ctor, addr 0x349f90c, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inputStream) ;

/// @brief Method .ctor, addr 0x349f890, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::IDictionary*  secretRings, ::System::Collections::IList*  order) ;

/// @brief Method get_Count, addr 0x349ff94, size 0xa8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Size, addr 0x349feec, size 0xa8, virtual false, abstract: false, final false
