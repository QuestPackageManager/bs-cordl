...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyRingGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyRingGenerator*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpKeyRingGenerator");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_rawPassPhrase, put = __cordl_internal_set_rawPassPhrase)) ::ArrayW<uint8_t> rawPassPhrase;
  ...
  /// @brief Method AddSubKey, addr 0x3582610, size 0x8, virtual false, abstract: false, final false
  inline void AddSubKey(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyPair* keyPair);

  /// @brief Method AddSubKey, addr 0x3582a3c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSubKey, addr 0x3582618, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSubKey, addr 0x3582a4c, size 0x418, virtual false, abstract: false, final false
  inline void AddSubKey(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyPair* keyPair, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* hashedPackets,
  ...
  /// @brief Method GeneratePublicKeyRing, addr 0x3582f90, size 0x4d0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKeyRing* GeneratePublicKeyRing();

  /// @brief Method GenerateSecretKeyRing, addr 0x3582f2c, size 0x64, virtual false, abstract: false, final false
  ...
  New_ctor(int32_t certificationLevel, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyPair* masterKey, ::StringW id, ::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm,
           ::Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm, ::ArrayW<char16_t> passPhrase, bool useSha1, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* hashedPackets,
  ...
  static inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyRingGenerator* New_ctor(int32_t certificationLevel, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyPair* masterKey, ::StringW id,
                                                                                  ...
                                                                                  ::Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm, bool utf8PassPhrase, ::ArrayW<char16_t> passPhrase,
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_rawPassPhrase() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_rawPassPhrase();
  ...
  constexpr void __cordl_internal_set_rawPassPhrase(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x3582348, size 0x90, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___rawPassPhrase;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyRingGenerator) == 0x60, "Size mismatch!");
