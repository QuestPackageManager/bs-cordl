...
public:
  ...
  /// @brief Method ConfirmCheckSum, addr 0x2538294, size 0xa0, virtual false, abstract: false, final false
  inline bool ConfirmCheckSum(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo);

  /// @brief Method GetDataStream, addr 0x2538b30, size 0x740, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* privKey);

  /// @brief Method GetKeyCipher, addr 0x253805c, size 0x238, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetKeyCipher(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm);

  /// @brief Method GetSymmetricAlgorithm, addr 0x2538350, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessEncodedMpi, addr 0x253975c, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method RecoverSessionData, addr 0x2538378, size 0x7b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2538030, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyId, addr 0x2538334, size 0x1c, virtual false, abstract: false, final false
