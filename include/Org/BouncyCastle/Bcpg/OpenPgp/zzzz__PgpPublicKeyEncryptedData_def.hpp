...
public:
  ...
  /// @brief Method ConfirmCheckSum, addr 0x34680c8, size 0xa4, virtual false, abstract: false, final false
  inline bool ConfirmCheckSum(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo);

  /// @brief Method GetDataStream, addr 0x3468984, size 0x7b8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* privKey);

  /// @brief Method GetKeyCipher, addr 0x3467e60, size 0x268, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetKeyCipher(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm);

  /// @brief Method GetSymmetricAlgorithm, addr 0x3468184, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessEncodedMpi, addr 0x34696c8, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecoverSessionData, addr 0x34681ac, size 0x7d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3467e54, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyId, addr 0x346816c, size 0x18, virtual false, abstract: false, final false
