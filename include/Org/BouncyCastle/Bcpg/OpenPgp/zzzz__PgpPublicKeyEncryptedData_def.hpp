...
public:
  ...
  /// @brief Method ConfirmCheckSum, addr 0x349290c, size 0xa4, virtual false, abstract: false, final false
  inline bool ConfirmCheckSum(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo);

  /// @brief Method GetDataStream, addr 0x34931c8, size 0x7b8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* privKey);

  /// @brief Method GetKeyCipher, addr 0x34926a4, size 0x268, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetKeyCipher(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm);

  /// @brief Method GetSymmetricAlgorithm, addr 0x34929c8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessEncodedMpi, addr 0x3493f0c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecoverSessionData, addr 0x34929f0, size 0x7d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3492698, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyId, addr 0x34929b0, size 0x18, virtual false, abstract: false, final false
