...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PgpPublicKeyEncryptedData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PgpPublicKeyEncryptedData(PgpPublicKeyEncryptedData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PgpPublicKeyEncryptedData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PgpPublicKeyEncryptedData(PgpPublicKeyEncryptedDataconst&) = delete;
