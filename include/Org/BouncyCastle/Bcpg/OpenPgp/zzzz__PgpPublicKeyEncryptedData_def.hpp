...
public:
  ...
  /// @brief Method ConfirmCheckSum, addr 0x34ceea0, size 0xa4, virtual false, abstract: false, final false
  inline bool ConfirmCheckSum(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo);

  /// @brief Method GetDataStream, addr 0x34cf75c, size 0x7b8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* privKey);

  /// @brief Method GetKeyCipher, addr 0x34cec38, size 0x268, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetKeyCipher(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm);

  /// @brief Method GetSymmetricAlgorithm, addr 0x34cef5c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessEncodedMpi, addr 0x34d04a0, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecoverSessionData, addr 0x34cef84, size 0x7d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyId, addr 0x34cef44, size 0x18, virtual false, abstract: false, final false
