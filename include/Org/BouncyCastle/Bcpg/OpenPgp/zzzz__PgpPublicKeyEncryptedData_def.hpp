...
public:
  ...
  /// @brief Method ConfirmCheckSum, addr 0x253895c, size 0xa0, virtual false, abstract: false, final false
  inline bool ConfirmCheckSum(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionInfo);

  /// @brief Method GetDataStream, addr 0x25391f8, size 0x740, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* privKey);

  /// @brief Method GetKeyCipher, addr 0x2538724, size 0x238, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetKeyCipher(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm);

  /// @brief Method GetSymmetricAlgorithm, addr 0x2538a18, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessEncodedMpi, addr 0x2539e24, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method RecoverSessionData, addr 0x2538a40, size 0x7b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25386f8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyId, addr 0x25389fc, size 0x1c, virtual false, abstract: false, final false
