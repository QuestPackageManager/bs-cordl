...
public:
  ...
  /// @brief Method GetDataStream, addr 0x252fcc8, size 0x1c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream();

  /// @brief Method GetInputStream, addr 0x252fcac, size 0x1c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetInputStream();

  /// @brief Method GetRawFileName, addr 0x252fc28, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252fad8, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgInput);

  /// @brief Method get_FileName, addr 0x252fc0c, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_Format, addr 0x252fbf0, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_Format();

  /// @brief Method get_ModificationTime, addr 0x252fc44, size 0x68, virtual false, abstract: false, final false
