...
/// @brief Field packets, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_packets, put=__cordl_internal_set_packets)) ::ArrayW<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*,::Array<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*>*>  packets;

/// @brief Method Equals, addr 0x34e4598, size 0x124, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x34e46bc, size 0x74, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetImageAttribute, addr 0x34e450c, size 0x84, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::Attr::ImageAttrib* GetImageAttribute() ;

/// @brief Method GetSubpacket, addr 0x34e446c, size 0xa0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::UserAttributeSubpacket* GetSubpacket(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag  type) ;

static inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpUserAttributeSubpacketVector* New_ctor(::ArrayW<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*,::Array<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*>*>  packets) ;

/// @brief Method ToSubpacketArray, addr 0x34e4590, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34e4464, size 0x8, virtual false, abstract: false, final false
