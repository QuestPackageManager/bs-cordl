...
public:
  ...
  /// @brief Method Equals, addr 0x123d6b8, size 0x124, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x123d7dc, size 0x78, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetImageAttribute, addr 0x123d630, size 0x80, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::Attr::ImageAttrib* GetImageAttribute();

  /// @brief Method GetSubpacket, addr 0x123d590, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToSubpacketArray, addr 0x123d6b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x123d568, size 0x28, virtual false, abstract: false, final false
