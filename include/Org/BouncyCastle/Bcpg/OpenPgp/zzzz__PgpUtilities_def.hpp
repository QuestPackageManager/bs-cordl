...
public:
  ...
  /// @brief Method .ctor addr 0x105c998 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method DsaSigToMpi addr 0x10596b4 size 0x260 virtual false final false
  ...
  /// @brief Method RsaSigToMpi addr 0x1059914 size 0xfc virtual false final false
  ...
  /// @brief Method GetDigestName addr 0x10487b0 size 0x12c virtual false final false
  static inline ::StringW GetDigestName(::Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm);

  /// @brief Method GetSignatureName addr 0x10570bc size 0x180 virtual false final false
  ...
  /// @brief Method GetSymmetricCipherName addr 0x104860c size 0x1a4 virtual false final false
  static inline ::StringW GetSymmetricCipherName(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algorithm);

  /// @brief Method GetKeySize addr 0x105c9a0 size 0xa4 virtual false final false
  static inline int32_t GetKeySize(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algorithm);

  /// @brief Method MakeKey addr 0x105ca44 size 0x78 virtual false final false
  ...
  /// @brief Method MakeRandomKey addr 0x105cabc size 0x9c virtual false final false
  ...
  /// @brief Method EncodePassPhrase addr 0x104d370 size 0x50 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodePassPhrase(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, bool utf8);

  /// @brief Method MakeKeyFromPassPhrase addr 0x105cb58 size 0x3c virtual false final false
  ...
  /// @brief Method MakeKeyFromPassPhraseUtf8 addr 0x105cb94 size 0x38 virtual false final false
  ...
  /// @brief Method MakeKeyFromPassPhraseRaw addr 0x105cbcc size 0x8 virtual false final false
  ...
  /// @brief Method DoMakeKeyFromPassPhrase addr 0x104e9c8 size 0x970 virtual false final false
  ...
  /// @brief Method WriteFileToLiteralData addr 0x105cbd4 size 0xd4 virtual false final false
  static inline void WriteFileToLiteralData(::System::IO::Stream* output, char16_t fileType, ::System::IO::FileInfo* file);

  /// @brief Method WriteFileToLiteralData addr 0x105ce88 size 0xcc virtual false final false
  ...
  /// @brief Method PipeFileContents addr 0x105cca8 size 0x1e0 virtual false final false
  static inline void PipeFileContents(::System::IO::FileInfo* file, ::System::IO::Stream* pOut, int32_t bufSize);

  /// @brief Method IsPossiblyBase64 addr 0x105cf54 size 0x48 virtual false final false
  static inline bool IsPossiblyBase64(int32_t ch);

  /// @brief Method GetDecoderStream addr 0x105cf9c size 0x410 virtual false final false
  static inline ::System::IO::Stream* GetDecoderStream(::System::IO::Stream* inputStream);

  /// @brief Method CreateWrapper addr 0x10489e4 size 0x124 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::IWrapper* CreateWrapper(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm);

  /// @brief Method GenerateIV addr 0x10516d4 size 0x7c virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateIV(int32_t length, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method GenerateS2k addr 0x1051644 size 0x90 virtual false final false
