...
public:
  // Declarations
  /// @brief Method CreateWrapper, addr 0x2535bc8, size 0x124, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IWrapper* CreateWrapper(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm);

  /// @brief Method DoMakeKeyFromPassPhrase, addr 0x253ba84, size 0x960, virtual false, abstract: false, final false
  ...
  /// @brief Method DsaSigToMpi, addr 0x25465b8, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method EncodePassPhrase, addr 0x253a484, size 0x50, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodePassPhrase(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, bool utf8);

  /// @brief Method GenerateIV, addr 0x253e6e4, size 0x7c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateIV(int32_t length, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method GenerateS2k, addr 0x253e65c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDecoderStream, addr 0x2549e18, size 0x400, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* GetDecoderStream(::System::IO::Stream* inputStream);

  /// @brief Method GetDigestName, addr 0x253599c, size 0x124, virtual false, abstract: false, final false
  static inline ::StringW GetDigestName(::Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm);

  /// @brief Method GetKeySize, addr 0x2549824, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t GetKeySize(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algorithm);

  /// @brief Method GetSignatureName, addr 0x254400c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSymmetricCipherName, addr 0x2535800, size 0x19c, virtual false, abstract: false, final false
  static inline ::StringW GetSymmetricCipherName(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algorithm);

  /// @brief Method IsPossiblyBase64, addr 0x2549dcc, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsPossiblyBase64(int32_t ch);

  /// @brief Method MakeKey, addr 0x25498c0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeKeyFromPassPhrase, addr 0x25499d4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeKeyFromPassPhraseRaw, addr 0x2549a48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeKeyFromPassPhraseUtf8, addr 0x2549a10, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeRandomKey, addr 0x2549938, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method PipeFileContents, addr 0x2549b24, size 0x1dc, virtual false, abstract: false, final false
  static inline void PipeFileContents(::System::IO::FileInfo* file, ::System::IO::Stream* pOut, int32_t bufSize);

  /// @brief Method RsaSigToMpi, addr 0x2546814, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteFileToLiteralData, addr 0x2549a50, size 0xd4, virtual false, abstract: false, final false
  static inline void WriteFileToLiteralData(::System::IO::Stream* output, char16_t fileType, ::System::IO::FileInfo* file);

  /// @brief Method WriteFileToLiteralData, addr 0x2549d00, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x254981c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
