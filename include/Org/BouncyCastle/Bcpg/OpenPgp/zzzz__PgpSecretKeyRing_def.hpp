...
public:
  ...
  /// @brief Method .ctor addr 0x10525cc size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1052644 size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x1052670 size 0x74 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10526e4 size 0x538 virtual false final false
  inline void _ctor(::System::IO::Stream* inputStream);

  /// @brief Method GetPublicKey addr 0x1052c1c size 0xf4 virtual false final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* GetPublicKey();

  /// @brief Method GetSecretKey addr 0x1052d10 size 0xf0 virtual false final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKey* GetSecretKey();

  /// @brief Method GetSecretKeys addr 0x1052e00 size 0x68 virtual false final false
  inline ::System::Collections::IEnumerable* GetSecretKeys();

  /// @brief Method GetSecretKey addr 0x1052e68 size 0x374 virtual false final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKey* GetSecretKey(int64_t keyId);

  /// @brief Method GetExtraPublicKeys addr 0x10531dc size 0x68 virtual false final false
  inline ::System::Collections::IEnumerable* GetExtraPublicKeys();

  /// @brief Method GetEncoded addr 0x1053244 size 0x78 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method Encode addr 0x10532bc size 0x658 virtual false final false
  inline void Encode(::System::IO::Stream* outStr);

  /// @brief Method ReplacePublicKeys addr 0x1053914 size 0x4ec virtual false final false
  ...
  /// @brief Method CopyWithNewPassword addr 0x1053e00 size 0x5a4 virtual false final false
  ...
  /// @brief Method InsertSecretKey addr 0x10543a4 size 0x3ec virtual false final false
  ...
  /// @brief Method RemoveSecretKey addr 0x1054790 size 0x298 virtual false final false
