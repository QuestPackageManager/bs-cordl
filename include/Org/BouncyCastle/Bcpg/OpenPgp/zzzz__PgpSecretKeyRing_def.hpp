...
public:
  ...
  /// @brief Method CopyWithNewPassword, addr 0x1135eb0, size 0x5a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x113536c, size 0x658, virtual false, abstract: false, final false
  inline void Encode(::System::IO::Stream* outStr);

  /// @brief Method GetEncoded, addr 0x11352f4, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetExtraPublicKeys, addr 0x113528c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* GetExtraPublicKeys();

  /// @brief Method GetPublicKey, addr 0x1134ccc, size 0xf4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* GetPublicKey();

  /// @brief Method GetSecretKey, addr 0x1134dc0, size 0xf0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKey* GetSecretKey();

  /// @brief Method GetSecretKey, addr 0x1134f18, size 0x374, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKey* GetSecretKey(int64_t keyId);

  /// @brief Method GetSecretKeys, addr 0x1134eb0, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* GetSecretKeys();

  /// @brief Method InsertSecretKey, addr 0x1136454, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveSecretKey, addr 0x1136840, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplacePublicKeys, addr 0x11359c4, size 0x4ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1134720, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> encoding);

  /// @brief Method .ctor, addr 0x1134794, size 0x538, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inputStream);

  /// @brief Method .ctor, addr 0x113467c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* keys);

  /// @brief Method .ctor, addr 0x11346f4, size 0x2c, virtual false, abstract: false, final false
