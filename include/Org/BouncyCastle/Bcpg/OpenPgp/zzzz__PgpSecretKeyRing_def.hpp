...
public:
  ...
  /// @brief Method .ctor addr 0x10c381c size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10c3894 size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x10c38c0 size 0x74 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10c3934 size 0x538 virtual false final false
  inline void _ctor(::System::IO::Stream* inputStream);

  /// @brief Method GetPublicKey addr 0x10c3e6c size 0xf4 virtual false final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* GetPublicKey();

  /// @brief Method GetSecretKey addr 0x10c3f60 size 0xf0 virtual false final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKey* GetSecretKey();

  /// @brief Method GetSecretKeys addr 0x10c4050 size 0x68 virtual false final false
  inline ::System::Collections::IEnumerable* GetSecretKeys();

  /// @brief Method GetSecretKey addr 0x10c40b8 size 0x374 virtual false final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKey* GetSecretKey(int64_t keyId);

  /// @brief Method GetExtraPublicKeys addr 0x10c442c size 0x68 virtual false final false
  inline ::System::Collections::IEnumerable* GetExtraPublicKeys();

  /// @brief Method GetEncoded addr 0x10c4494 size 0x78 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method Encode addr 0x10c450c size 0x658 virtual false final false
  inline void Encode(::System::IO::Stream* outStr);

  /// @brief Method ReplacePublicKeys addr 0x10c4b64 size 0x4ec virtual false final false
  ...
  /// @brief Method CopyWithNewPassword addr 0x10c5050 size 0x5a4 virtual false final false
  ...
  /// @brief Method InsertSecretKey addr 0x10c55f4 size 0x3ec virtual false final false
  ...
  /// @brief Method RemoveSecretKey addr 0x10c59e0 size 0x298 virtual false final false
