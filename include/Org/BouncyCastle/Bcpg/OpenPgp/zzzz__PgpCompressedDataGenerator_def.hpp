...
public:
  // Declarations
  /// @brief Method Close, addr 0x34bc53c, size 0x4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x34bc470, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Close, addr 0x34bc5a0, size 0x30, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x34bc468, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Close, addr 0x34bc478, size 0xbc, virtual true, abstract: false, final true
  inline void Close();
  ...
  /// @brief Method Open, addr 0x34bc054, size 0x150, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr);

  /// @brief Method Open, addr 0x34bc300, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34bbf58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm);

  /// @brief Method .ctor, addr 0x34bbf60, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm, int32_t compression);

  /// @brief Method doOpen, addr 0x34bc1a4, size 0x15c, virtual false, abstract: false, final false
  inline void doOpen();
