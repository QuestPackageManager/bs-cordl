...
public:
  // Declarations
  /// @brief Method Close, addr 0x130fc74, size 0x4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x130fbc0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Close, addr 0x130fcdc, size 0x30, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x130fbb4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Close, addr 0x130fbc8, size 0xa4, virtual true, abstract: false, final true
  inline void Close();
  ...
  /// @brief Method Open, addr 0x130f78c, size 0x148, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr);

  /// @brief Method Open, addr 0x130fa3c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x130f660, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm);

  /// @brief Method .ctor, addr 0x130f668, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm, int32_t compression);

  /// @brief Method doOpen, addr 0x130f8d4, size 0x168, virtual false, abstract: false, final false
  inline void doOpen();
