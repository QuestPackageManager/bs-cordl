...
public:
  // Declarations
  /// @brief Method Close, addr 0x1215ce0, size 0x4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x1215c2c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Close, addr 0x1215d48, size 0x30, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x1215c20, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Close, addr 0x1215c34, size 0xa4, virtual true, abstract: false, final true
  inline void Close();
  ...
  /// @brief Method Open, addr 0x12157f8, size 0x148, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr);

  /// @brief Method Open, addr 0x1215aa8, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12156cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm);

  /// @brief Method .ctor, addr 0x12156d4, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm, int32_t compression);

  /// @brief Method doOpen, addr 0x1215940, size 0x168, virtual false, abstract: false, final false
  inline void doOpen();
