...
public:
  // Declarations
  /// @brief Method Close, addr 0x2525ffc, size 0x4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x2525f48, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Close, addr 0x2526064, size 0x30, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x2525f3c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Close, addr 0x2525f50, size 0xa4, virtual true, abstract: false, final true
  inline void Close();
  ...
  /// @brief Method Open, addr 0x2525b4c, size 0x134, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr);

  /// @brief Method Open, addr 0x2525ddc, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2525a30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm);

  /// @brief Method .ctor, addr 0x2525a38, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm, int32_t compression);

  /// @brief Method doOpen, addr 0x2525c80, size 0x15c, virtual false, abstract: false, final false
  inline void doOpen();
