...
public:
  ...
  /// @brief Method ReadOptionalTrustPacket, addr 0x34c4724, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Bcpg::TrustPacket* ReadOptionalTrustPacket(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgInput);

  /// @brief Method ReadSignaturesAndTrust, addr 0x34c47c8, size 0x2c8, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* ReadSignaturesAndTrust(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgInput);

  /// @brief Method ReadUserIDs, addr 0x34c4a90, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34c4720, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
