...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpMarker*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpMarker*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpMarker");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35864c0, size 0x11c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PgpMarker", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PgpMarker(PgpMarker&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PgpMarker", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PgpMarker(PgpMarkerconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpMarker) == 0x18, "Size mismatch!");
