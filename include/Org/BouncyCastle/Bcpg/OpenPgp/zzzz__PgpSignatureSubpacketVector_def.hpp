...
public:
  ...
  /// @brief Method GetNotationDataOccurrences addr 0x105b8e8 size 0x164 virtual false final false
  ...
  /// @brief Method GetNotationDataOccurences addr 0x105ba4c size 0x4 virtual false final false
  ...
  /// @brief Method GetIssuerKeyId addr 0x105ba50 size 0x90 virtual false final false
  inline int64_t GetIssuerKeyId();

  /// @brief Method HasSignatureCreationTime addr 0x105bae0 size 0x1c virtual false final false
  inline bool HasSignatureCreationTime();

  /// @brief Method GetSignatureCreationTime addr 0x105bafc size 0xd0 virtual false final false
  inline ::System::DateTime GetSignatureCreationTime();

  /// @brief Method GetSignatureExpirationTime addr 0x105bbcc size 0x90 virtual false final false
  inline int64_t GetSignatureExpirationTime();

  /// @brief Method GetKeyExpirationTime addr 0x105bc5c size 0x90 virtual false final false
  inline int64_t GetKeyExpirationTime();

  /// @brief Method GetPreferredHashAlgorithms addr 0x105bcec size 0x90 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredHashAlgorithms();

  /// @brief Method GetPreferredSymmetricAlgorithms addr 0x105bd7c size 0x90 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredSymmetricAlgorithms();

  /// @brief Method GetPreferredCompressionAlgorithms addr 0x105be0c size 0x90 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredCompressionAlgorithms();

  /// @brief Method GetKeyFlags addr 0x105be9c size 0x90 virtual false final false
  inline int32_t GetKeyFlags();

  /// @brief Method GetSignerUserId addr 0x105bf2c size 0x90 virtual false final false
  inline ::StringW GetSignerUserId();

  /// @brief Method IsPrimaryUserId addr 0x105bfbc size 0x90 virtual false final false
  inline bool IsPrimaryUserId();

  /// @brief Method GetCriticalTags addr 0x105c04c size 0xf8 virtual false final false
  ...
  /// @brief Method GetFeatures addr 0x105c144 size 0xac virtual false final false
  inline ::Org::BouncyCastle::Bcpg::Sig::Features* GetFeatures();

  /// @brief Method get_Size addr 0x105c1f0 size 0x1c virtual false final false
  inline int32_t get_Size();

  /// @brief Method get_Count addr 0x105c20c size 0x1c virtual false final false
  inline int32_t get_Count();

  /// @brief Method ToSubpacketArray addr 0x105c228 size 0x8 virtual false final false
