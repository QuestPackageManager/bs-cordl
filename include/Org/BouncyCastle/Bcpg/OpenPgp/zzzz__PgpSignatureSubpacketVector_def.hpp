...
public:
  ...
  /// @brief Method .ctor, addr 0x10f7738, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*, ::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*> packets);

  /// @brief Method GetSubpacket, addr 0x10fa818, size 0x58, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::SignatureSubpacket* GetSubpacket(::Org::BouncyCastle::Bcpg::SignatureSubpacketTag type);

  /// @brief Method HasSubpacket, addr 0x10fa870, size 0x18, virtual false, abstract: false, final false
  inline bool HasSubpacket(::Org::BouncyCastle::Bcpg::SignatureSubpacketTag type);

  /// @brief Method GetSubpackets, addr 0x10fa888, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNotationDataOccurrences, addr 0x10fa9c8, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNotationDataOccurences, addr 0x10fab2c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIssuerKeyId, addr 0x10fab30, size 0x90, virtual false, abstract: false, final false
  inline int64_t GetIssuerKeyId();

  /// @brief Method HasSignatureCreationTime, addr 0x10fabc0, size 0x1c, virtual false, abstract: false, final false
  inline bool HasSignatureCreationTime();

  /// @brief Method GetSignatureCreationTime, addr 0x10fabdc, size 0xd0, virtual false, abstract: false, final false
  inline ::System::DateTime GetSignatureCreationTime();

  /// @brief Method GetSignatureExpirationTime, addr 0x10facac, size 0x90, virtual false, abstract: false, final false
  inline int64_t GetSignatureExpirationTime();

  /// @brief Method GetKeyExpirationTime, addr 0x10fad3c, size 0x90, virtual false, abstract: false, final false
  inline int64_t GetKeyExpirationTime();

  /// @brief Method GetPreferredHashAlgorithms, addr 0x10fadcc, size 0x90, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredHashAlgorithms();

  /// @brief Method GetPreferredSymmetricAlgorithms, addr 0x10fae5c, size 0x90, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredSymmetricAlgorithms();

  /// @brief Method GetPreferredCompressionAlgorithms, addr 0x10faeec, size 0x90, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredCompressionAlgorithms();

  /// @brief Method GetKeyFlags, addr 0x10faf7c, size 0x90, virtual false, abstract: false, final false
  inline int32_t GetKeyFlags();

  /// @brief Method GetSignerUserId, addr 0x10fb00c, size 0x90, virtual false, abstract: false, final false
  inline ::StringW GetSignerUserId();

  /// @brief Method IsPrimaryUserId, addr 0x10fb09c, size 0x90, virtual false, abstract: false, final false
  inline bool IsPrimaryUserId();

  /// @brief Method GetCriticalTags, addr 0x10fb12c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x10fb224, size 0xac, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::Sig::Features* GetFeatures();

  /// @brief Method get_Size, addr 0x10fb2d0, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_Size();

  /// @brief Method get_Count, addr 0x10fb2ec, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method ToSubpacketArray, addr 0x10fb308, size 0x8, virtual false, abstract: false, final false
