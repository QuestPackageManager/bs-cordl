...
public:
  ...
  /// @brief Method GetNotationDataOccurrences addr 0x10ccb38 size 0x164 virtual false final false
  ...
  /// @brief Method GetNotationDataOccurences addr 0x10ccc9c size 0x4 virtual false final false
  ...
  /// @brief Method GetIssuerKeyId addr 0x10ccca0 size 0x90 virtual false final false
  inline int64_t GetIssuerKeyId();

  /// @brief Method HasSignatureCreationTime addr 0x10ccd30 size 0x1c virtual false final false
  inline bool HasSignatureCreationTime();

  /// @brief Method GetSignatureCreationTime addr 0x10ccd4c size 0xd0 virtual false final false
  inline ::System::DateTime GetSignatureCreationTime();

  /// @brief Method GetSignatureExpirationTime addr 0x10cce1c size 0x90 virtual false final false
  inline int64_t GetSignatureExpirationTime();

  /// @brief Method GetKeyExpirationTime addr 0x10cceac size 0x90 virtual false final false
  inline int64_t GetKeyExpirationTime();

  /// @brief Method GetPreferredHashAlgorithms addr 0x10ccf3c size 0x90 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredHashAlgorithms();

  /// @brief Method GetPreferredSymmetricAlgorithms addr 0x10ccfcc size 0x90 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredSymmetricAlgorithms();

  /// @brief Method GetPreferredCompressionAlgorithms addr 0x10cd05c size 0x90 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredCompressionAlgorithms();

  /// @brief Method GetKeyFlags addr 0x10cd0ec size 0x90 virtual false final false
  inline int32_t GetKeyFlags();

  /// @brief Method GetSignerUserId addr 0x10cd17c size 0x90 virtual false final false
  inline ::StringW GetSignerUserId();

  /// @brief Method IsPrimaryUserId addr 0x10cd20c size 0x90 virtual false final false
  inline bool IsPrimaryUserId();

  /// @brief Method GetCriticalTags addr 0x10cd29c size 0xf8 virtual false final false
  ...
  /// @brief Method GetFeatures addr 0x10cd394 size 0xac virtual false final false
  inline ::Org::BouncyCastle::Bcpg::Sig::Features* GetFeatures();

  /// @brief Method get_Size addr 0x10cd440 size 0x1c virtual false final false
  inline int32_t get_Size();

  /// @brief Method get_Count addr 0x10cd45c size 0x1c virtual false final false
  inline int32_t get_Count();

  /// @brief Method ToSubpacketArray addr 0x10cd478 size 0x8 virtual false final false
