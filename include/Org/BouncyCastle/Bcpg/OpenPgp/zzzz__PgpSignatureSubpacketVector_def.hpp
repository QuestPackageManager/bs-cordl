...
public:
  ...
  /// @brief Method GetCriticalTags, addr 0x34a6f90, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x34a707c, size 0x80, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::Sig::Features* GetFeatures();

  /// @brief Method GetIssuerKeyId, addr 0x34a6970, size 0x94, virtual false, abstract: false, final false
  inline int64_t GetIssuerKeyId();

  /// @brief Method GetKeyExpirationTime, addr 0x34a6b84, size 0x94, virtual false, abstract: false, final false
  inline int64_t GetKeyExpirationTime();

  /// @brief Method GetKeyFlags, addr 0x34a6dd4, size 0x94, virtual false, abstract: false, final false
  inline int32_t GetKeyFlags();

  /// @brief Method GetNotationDataOccurences, addr 0x34a696c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNotationDataOccurrences, addr 0x34a67fc, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreferredCompressionAlgorithms, addr 0x34a6d40, size 0x94, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredCompressionAlgorithms();

  /// @brief Method GetPreferredHashAlgorithms, addr 0x34a6c18, size 0x94, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredHashAlgorithms();

  /// @brief Method GetPreferredSymmetricAlgorithms, addr 0x34a6cac, size 0x94, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferredSymmetricAlgorithms();

  /// @brief Method GetSignatureCreationTime, addr 0x34a6a20, size 0xd0, virtual false, abstract: false, final false
  inline ::System::DateTime GetSignatureCreationTime();

  /// @brief Method GetSignatureExpirationTime, addr 0x34a6af0, size 0x94, virtual false, abstract: false, final false
  inline int64_t GetSignatureExpirationTime();

  /// @brief Method GetSignerUserId, addr 0x34a6e68, size 0x94, virtual false, abstract: false, final false
  inline ::StringW GetSignerUserId();

  /// @brief Method GetSubpacket, addr 0x34a6660, size 0x4c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::SignatureSubpacket* GetSubpacket(::Org::BouncyCastle::Bcpg::SignatureSubpacketTag type);

  /// @brief Method GetSubpackets, addr 0x34a66c4, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method HasSignatureCreationTime, addr 0x34a6a04, size 0x1c, virtual false, abstract: false, final false
  inline bool HasSignatureCreationTime();

  /// @brief Method HasSubpacket, addr 0x34a66ac, size 0x18, virtual false, abstract: false, final false
  inline bool HasSubpacket(::Org::BouncyCastle::Bcpg::SignatureSubpacketTag type);

  /// @brief Method IsPrimaryUserId, addr 0x34a6efc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ToSubpacketArray, addr 0x34a712c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34a3420, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*, ::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*> packets);

  /// @brief Method get_Count, addr 0x34a7114, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Size, addr 0x34a70fc, size 0x18, virtual false, abstract: false, final false
