...
public:
  ...
  /// @brief Method .ctor, addr 0x252d410, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252d430, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252da70, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* pub, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* priv);

  /// @brief Method get_KeyId, addr 0x252da9c, size 0x1c, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_PrivateKey, addr 0x252dac0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* get_PrivateKey();

  /// @brief Method get_PublicKey, addr 0x252dab8, size 0x8, virtual false, abstract: false, final false
