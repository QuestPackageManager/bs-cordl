...
public:
  ...
  /// @brief Method AllPgpObjects, addr 0x2530fa0, size 0x104, virtual false, abstract: false, final false
  inline ::System::Collections::IList* AllPgpObjects();

  /// @brief Method FilterPgpObjects, addr 0x25310a4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method NextObject, addr 0x2530f9c, size 0x4, virtual false, abstract: false, final false
  inline ::System::Object* NextObject();

  /// @brief Method NextPgpObject, addr 0x25304a8, size 0xa0c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2530424, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x25303f0, size 0x34, virtual false, abstract: false, final false
