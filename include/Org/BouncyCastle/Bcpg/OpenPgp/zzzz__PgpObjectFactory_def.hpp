...
public:
  ...
  /// @brief Method AllPgpObjects, addr 0x1311c28, size 0x104, virtual false, abstract: false, final false
  inline ::System::Collections::IList* AllPgpObjects();

  /// @brief Method FilterPgpObjects, addr 0x1311d2c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method NextObject, addr 0x1311c24, size 0x4, virtual false, abstract: false, final false
  inline ::System::Object* NextObject();

  /// @brief Method NextPgpObject, addr 0x13110f4, size 0xa48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1311068, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x1311034, size 0x34, virtual false, abstract: false, final false
