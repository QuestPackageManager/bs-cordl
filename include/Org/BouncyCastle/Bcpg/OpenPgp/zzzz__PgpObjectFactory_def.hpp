...
public:
  ...
  /// @brief Method AllPgpObjects, addr 0x112227c, size 0x104, virtual false, abstract: false, final false
  inline ::System::Collections::IList* AllPgpObjects();

  /// @brief Method FilterPgpObjects, addr 0x1122380, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method NextObject, addr 0x1122278, size 0x4, virtual false, abstract: false, final false
  inline ::System::Object* NextObject();

  /// @brief Method NextPgpObject, addr 0x1121748, size 0xa48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11216bc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x1121688, size 0x34, virtual false, abstract: false, final false
