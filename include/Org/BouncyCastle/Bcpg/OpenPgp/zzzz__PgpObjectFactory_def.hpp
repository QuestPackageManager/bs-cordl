...
public:
  ...
  /// @brief Method AllPgpObjects, addr 0x348b690, size 0x10c, virtual false, abstract: false, final false
  inline ::System::Collections::IList* AllPgpObjects();

  /// @brief Method FilterPgpObjects, addr 0x348b79c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method NextObject, addr 0x348b68c, size 0x4, virtual false, abstract: false, final false
  inline ::System::Object* NextObject();

  /// @brief Method NextPgpObject, addr 0x348ab08, size 0xaac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x348aa8c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x348aa6c, size 0x20, virtual false, abstract: false, final false
