...
public:
  ...
  /// @brief Method AllPgpObjects, addr 0x34c7c24, size 0x10c, virtual false, abstract: false, final false
  inline ::System::Collections::IList* AllPgpObjects();

  /// @brief Method FilterPgpObjects, addr 0x34c7d30, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method NextObject, addr 0x34c7c20, size 0x4, virtual false, abstract: false, final false
  inline ::System::Object* NextObject();

  /// @brief Method NextPgpObject, addr 0x34c709c, size 0xaac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34c7020, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x34c7000, size 0x20, virtual false, abstract: false, final false
