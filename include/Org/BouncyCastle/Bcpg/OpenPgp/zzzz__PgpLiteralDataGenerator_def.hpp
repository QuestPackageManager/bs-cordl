...
public:
  ...
  /// @brief Method Close, addr 0x24fabcc, size 0x40, virtual true, abstract: false, final true
  inline void Close();
  ...
  /// @brief Method Open, addr 0x24fab48, size 0x84, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, char16_t format, ::System::IO::FileInfo* file);

  /// @brief Method Open, addr 0x24fa7dc, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x24fa99c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteHeader, addr 0x24fa698, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24fa668, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x24fa670, size 0x28, virtual false, abstract: false, final false
