...
public:
  ...
  /// @brief Method CreateKey, addr 0x3493cd4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUserKeyingMaterial, addr 0x34a92bc, size 0x26c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CreateUserKeyingMaterial(::Org::BouncyCastle::Bcpg::PublicKeyPacket* pubKeyData);

  /// @brief Method GetAgreementAlgorithm, addr 0x34a8f6c, size 0x184, virtual false, abstract: false, final false
  static inline ::StringW GetAgreementAlgorithm(::Org::BouncyCastle::Bcpg::PublicKeyPacket* pubKeyData);

  /// @brief Method GetKeyEncryptionOID, addr 0x34a90f0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKeyLength, addr 0x34a922c, size 0x90, virtual false, abstract: false, final false
  static inline int32_t GetKeyLength(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algID);

  /// @brief Method Kdf, addr 0x34a9528, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34a8f68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
