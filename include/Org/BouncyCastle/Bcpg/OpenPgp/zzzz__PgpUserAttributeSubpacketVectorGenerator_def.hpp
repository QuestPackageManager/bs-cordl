...
public:
  ...
  /// @brief Method Generate, addr 0x25494f4, size 0x2c4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetImageAttribute, addr 0x25493ac, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25497b8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
