...
public:
  ...
  /// @brief Method Generate, addr 0x35a30c0, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method SetImageAttribute, addr 0x35a2f70, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a3380, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PgpUserAttributeSubpacketVectorGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PgpUserAttributeSubpacketVectorGenerator(PgpUserAttributeSubpacketVectorGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PgpUserAttributeSubpacketVectorGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PgpUserAttributeSubpacketVectorGenerator(PgpUserAttributeSubpacketVectorGeneratorconst&) = delete;
