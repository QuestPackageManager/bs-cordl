...
public:
  ...
  /// @brief Method Generate, addr 0x347cd0c, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method SetImageAttribute, addr 0x347cbbc, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x347cfcc, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
