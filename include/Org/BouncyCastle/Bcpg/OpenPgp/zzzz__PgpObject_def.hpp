...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpObject*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpObject*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpObject");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PgpObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PgpObject(PgpObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PgpObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PgpObject(PgpObjectconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpObject) == 0x10, "Size mismatch!");
