...
public:
  ...
  /// @brief Method .ctor, addr 0x34e5f54, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IterationCount, addr 0x34e5f70, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method ParseS2k, addr 0x34d9ac4, size 0xf0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Bcpg::S2k* ParseS2k(::System::IO::Stream* input);

  /// @brief Method ReadBytes, addr 0x34d92d4, size 0x84, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBytes(::System::IO::Stream* input, int32_t ch);

  /// @brief Method ReadLength, addr 0x34e5ee0, size 0x74, virtual false, abstract: false, final false
  static inline int32_t ReadLength(::System::IO::Stream* input, int32_t ch);

  /// @brief Method ReadString, addr 0x34d919c, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW ReadString(::System::IO::Stream* input, int32_t ch);

  /// @brief Method SkipCloseParenthesis, addr 0x34d9260, size 0x74, virtual false, abstract: false, final false
  static inline void SkipCloseParenthesis(::System::IO::Stream* input);

  /// @brief Method SkipOpenParenthesis, addr 0x34d9128, size 0x74, virtual false, abstract: false, final false
  static inline void SkipOpenParenthesis(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x34e5edc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
