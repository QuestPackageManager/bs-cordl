...
/// @brief Method GetDataStream, addr 0x34bcb0c, size 0x17c, virtual false, abstract: false, final false
inline ::System::IO::Stream* GetDataStream() ;

/// @brief Method GetInputStream, addr 0x34bcaf4, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34bc9c0, size 0x11c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgInput) ;

/// @brief Method get_Algorithm, addr 0x34bcadc, size 0x18, virtual false, abstract: false, final false
