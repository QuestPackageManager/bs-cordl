...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedData*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedData*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpCompressedData");
...
public:
  ...
  /// @brief Method GetDataStream, addr 0x3578fc4, size 0x17c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream();

  /// @brief Method GetInputStream, addr 0x3578fac, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3578e78, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgInput);

  /// @brief Method get_Algorithm, addr 0x3578f94, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedData) == 0x18, "Size mismatch!");
