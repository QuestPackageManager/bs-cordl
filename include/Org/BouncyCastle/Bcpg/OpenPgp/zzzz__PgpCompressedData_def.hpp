...
public:
  ...
  /// @brief Method GetDataStream, addr 0x34bbd70, size 0x17c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream();

  /// @brief Method GetInputStream, addr 0x34bbd58, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34bbc24, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgInput);

  /// @brief Method get_Algorithm, addr 0x34bbd40, size 0x18, virtual false, abstract: false, final false
