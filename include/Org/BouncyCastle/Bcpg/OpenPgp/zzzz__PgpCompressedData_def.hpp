...
public:
  ...
  /// @brief Method GetDataStream, addr 0x3454f98, size 0x17c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream();

  /// @brief Method GetInputStream, addr 0x3454f80, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3454e4c, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgInput);

  /// @brief Method get_Algorithm, addr 0x3454f68, size 0x18, virtual false, abstract: false, final false
