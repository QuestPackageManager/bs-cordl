...
public:
  ...
  /// @brief Method Get, addr 0x348c4a8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x348c3d8, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* sig);

  /// @brief Method .ctor, addr 0x348b5ec, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x348c4c4, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsEmpty, addr 0x348c4dc, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Item, addr 0x348c478, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* get_Item(int32_t index);

  /// @brief Method get_Size, addr 0x348c4ac, size 0x18, virtual false, abstract: false, final false
