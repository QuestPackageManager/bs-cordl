...
/// @brief Method Get, addr 0x348c3f8, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x348c328, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*  sig) ;

/// @brief Method .ctor, addr 0x348b53c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x348c414, size 0x18, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsEmpty, addr 0x348c42c, size 0x20, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Item, addr 0x348c3c8, size 0x30, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* get_Item(int32_t  index) ;

/// @brief Method get_Size, addr 0x348c3fc, size 0x18, virtual false, abstract: false, final false
