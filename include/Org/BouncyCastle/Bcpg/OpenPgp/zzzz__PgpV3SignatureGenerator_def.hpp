...
public:
  ...
  /// @brief Method Generate, addr 0x34a8b94, size 0x3d4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature* Generate();

  /// @brief Method GenerateOnePassVersion, addr 0x34a8acc, size 0xc8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* GenerateOnePassVersion(bool isNested);

  /// @brief Method InitSign, addr 0x34a8330, size 0x8, virtual false, abstract: false, final false
  inline void InitSign(int32_t sigType, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* key);

  /// @brief Method InitSign, addr 0x34a8338, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x34a8774, size 0x1ac, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method Update, addr 0x34a8920, size 0x1ac, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t off, int32_t len);

  /// @brief Method Update, addr 0x34a85a4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34a825c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method doCanonicalUpdateByte, addr 0x34a85b8, size 0x64, virtual false, abstract: false, final false
  inline void doCanonicalUpdateByte(uint8_t b);

  /// @brief Method doUpdateByte, addr 0x34a861c, size 0x138, virtual false, abstract: false, final false
  inline void doUpdateByte(uint8_t b);

  /// @brief Method doUpdateCRLF, addr 0x34a8754, size 0x20, virtual false, abstract: false, final false
