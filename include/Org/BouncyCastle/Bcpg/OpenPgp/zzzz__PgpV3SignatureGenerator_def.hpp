...
public:
  ...
  /// @brief Method .ctor, addr 0x10fc490, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitSign, addr 0x10fc568, size 0x8, virtual false, abstract: false, final false
  inline void InitSign(int32_t sigType, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* key);

  /// @brief Method InitSign, addr 0x10fc570, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x10fc7d8, size 0x14, virtual false, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method doCanonicalUpdateByte, addr 0x10fc7ec, size 0x64, virtual false, abstract: false, final false
  inline void doCanonicalUpdateByte(uint8_t b);

  /// @brief Method doUpdateCRLF, addr 0x10fc978, size 0x20, virtual false, abstract: false, final false
  inline void doUpdateCRLF();

  /// @brief Method doUpdateByte, addr 0x10fc850, size 0x128, virtual false, abstract: false, final false
  inline void doUpdateByte(uint8_t b);

  /// @brief Method Update, addr 0x10fc998, size 0x1a4, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method Update, addr 0x10fcb3c, size 0x198, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t off, int32_t len);

  /// @brief Method GenerateOnePassVersion, addr 0x10fccd4, size 0xcc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* GenerateOnePassVersion(bool isNested);

  /// @brief Method Generate, addr 0x10fcda0, size 0x3d0, virtual false, abstract: false, final false
