...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpV3SignatureGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpV3SignatureGenerator*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpV3SignatureGenerator");
...
public:
  ...
  /// @brief Method Generate, addr 0x35a4704, size 0x3d4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature* Generate();

  /// @brief Method GenerateOnePassVersion, addr 0x35a463c, size 0xc8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* GenerateOnePassVersion(bool isNested);

  /// @brief Method InitSign, addr 0x35a3ea0, size 0x8, virtual false, abstract: false, final false
  inline void InitSign(int32_t sigType, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* key);

  /// @brief Method InitSign, addr 0x35a3ea8, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x35a42e4, size 0x1ac, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t> b);

  /// @brief Method Update, addr 0x35a4490, size 0x1ac, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t> b, int32_t off, int32_t len);

  /// @brief Method Update, addr 0x35a4114, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a3dcc, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method doCanonicalUpdateByte, addr 0x35a4128, size 0x64, virtual false, abstract: false, final false
  inline void doCanonicalUpdateByte(uint8_t b);

  /// @brief Method doUpdateByte, addr 0x35a418c, size 0x138, virtual false, abstract: false, final false
  inline void doUpdateByte(uint8_t b);

  /// @brief Method doUpdateCRLF, addr 0x35a42c4, size 0x20, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PgpV3SignatureGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PgpV3SignatureGenerator(PgpV3SignatureGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PgpV3SignatureGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PgpV3SignatureGenerator(PgpV3SignatureGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpV3SignatureGenerator) == 0x38, "Size mismatch!");
