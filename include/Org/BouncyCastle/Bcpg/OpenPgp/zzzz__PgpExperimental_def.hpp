...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental*, "Org.BouncyCastle.Bcpg.OpenPgp", "PgpExperimental");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PgpExperimental", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PgpExperimental(PgpExperimental&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PgpExperimental", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PgpExperimental(PgpExperimentalconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental) == 0x18, "Size mismatch!");
