...
public:
  ...
  /// @brief Method CreateStreamCipher, addr 0x3462760, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method DoGetDataStream, addr 0x3461e3c, size 0x8f0, virtual false, abstract: false, final false
  inline ::System::IO::Stream* DoGetDataStream(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPassPhrase, bool clearPassPhrase);

  /// @brief Method GetDataStream, addr 0x3461e10, size 0x2c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase);

  /// @brief Method GetDataStreamRaw, addr 0x3462758, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStreamRaw(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPassPhrase);

  /// @brief Method GetDataStreamUtf8, addr 0x346272c, size 0x2c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStreamUtf8(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase);

  /// @brief Method GetInputStream, addr 0x3461df8, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345ce7c, size 0xc, virtual false, abstract: false, final false
