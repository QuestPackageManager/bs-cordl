...
/// @brief Method CreateStreamCipher, addr 0x34ca2d4, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method DoGetDataStream, addr 0x34c99b0, size 0x8f0, virtual false, abstract: false, final false
inline ::System::IO::Stream* DoGetDataStream(::ArrayW<uint8_t,::Array<uint8_t>*>  rawPassPhrase, bool  clearPassPhrase) ;

/// @brief Method GetDataStream, addr 0x34c9984, size 0x2c, virtual false, abstract: false, final false
inline ::System::IO::Stream* GetDataStream(::ArrayW<char16_t,::Array<char16_t>*>  passPhrase) ;

/// @brief Method GetDataStreamRaw, addr 0x34ca2cc, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::Stream* GetDataStreamRaw(::ArrayW<uint8_t,::Array<uint8_t>*>  rawPassPhrase) ;

/// @brief Method GetDataStreamUtf8, addr 0x34ca2a0, size 0x2c, virtual false, abstract: false, final false
inline ::System::IO::Stream* GetDataStreamUtf8(::ArrayW<char16_t,::Array<char16_t>*>  passPhrase) ;

/// @brief Method GetInputStream, addr 0x34c996c, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34c49f0, size 0xc, virtual false, abstract: false, final false
