...
public:
  ...
  /// @brief Method CreateStreamCipher, addr 0x252ed00, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method DoGetDataStream, addr 0x252e450, size 0x878, virtual false, abstract: false, final false
  inline ::System::IO::Stream* DoGetDataStream(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPassPhrase, bool clearPassPhrase);

  /// @brief Method GetDataStream, addr 0x252e424, size 0x2c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStream(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase);

  /// @brief Method GetDataStreamRaw, addr 0x252ecf8, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStreamRaw(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPassPhrase);

  /// @brief Method GetDataStreamUtf8, addr 0x252ecc8, size 0x30, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetDataStreamUtf8(::ArrayW<char16_t, ::Array<char16_t>*> passPhrase);

  /// @brief Method GetInputStream, addr 0x252e408, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2529558, size 0x30, virtual false, abstract: false, final false
