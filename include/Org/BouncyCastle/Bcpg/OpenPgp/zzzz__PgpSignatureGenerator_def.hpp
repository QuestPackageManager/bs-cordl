...
public:
  ...
  /// @brief Method Generate, addr 0x359d354, size 0x82c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature* Generate();

  /// @brief Method GenerateCertification, addr 0x35927a0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertification, addr 0x359e378, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertification, addr 0x359e3a8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertification, addr 0x359e1a8, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateOnePassVersion, addr 0x359d28c, size 0xc8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* GenerateOnePassVersion(bool isNested);

  /// @brief Method GetEncodedPublicKey, addr 0x359e3c0, size 0xfc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncodedPublicKey(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey* pubKey);

  /// @brief Method InitSign, addr 0x3592690, size 0x8, virtual false, abstract: false, final false
  inline void InitSign(int32_t sigType, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey* key);

  /// @brief Method InitSign, addr 0x359cc8c, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHashedSubpackets, addr 0x3592698, size 0x84, virtual false, abstract: false, final false
  inline void SetHashedSubpackets(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* hashedPackets);

  /// @brief Method SetUnhashedSubpackets, addr 0x359271c, size 0x84, virtual false, abstract: false, final false
  inline void SetUnhashedSubpackets(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* unhashedPackets);

  /// @brief Method Update, addr 0x359d0c8, size 0x18, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t> b);

  /// @brief Method Update, addr 0x359d0e0, size 0x1ac, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t> b, int32_t off, int32_t len);

  /// @brief Method Update, addr 0x359cef8, size 0x14, virtual false, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method UpdateWithIdData, addr 0x359e0c0, size 0xe8, virtual false, abstract: false, final false
  inline void UpdateWithIdData(int32_t header, ::ArrayW<uint8_t> idBytes);

  /// @brief Method UpdateWithPublicKey, addr 0x359dff0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3592584, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method doCanonicalUpdateByte, addr 0x359cf0c, size 0x64, virtual false, abstract: false, final false
  inline void doCanonicalUpdateByte(uint8_t b);

  /// @brief Method doUpdateByte, addr 0x359cf70, size 0x138, virtual false, abstract: false, final false
  inline void doUpdateByte(uint8_t b);

  /// @brief Method doUpdateCRLF, addr 0x359d0a8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method insertSubpacket, addr 0x359dbd0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method packetPresent, addr 0x359db80, size 0x50, virtual false, abstract: false, final false
