...
public:
  ...
  /// @brief Method .ctor, addr 0x121ded8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Key, addr 0x1222f18, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Key();

  /// @brief Method get_KeyId, addr 0x1222f08, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_PublicKeyPacket, addr 0x1222f10, size 0x8, virtual false, abstract: false, final false
