...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PgpPrivateKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PgpPrivateKey(PgpPrivateKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PgpPrivateKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PgpPrivateKey(PgpPrivateKeyconst&) = delete;
