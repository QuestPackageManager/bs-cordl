...
public:
  ...
  /// @brief Method .ctor, addr 0x1143354, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Key, addr 0x1148394, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Key();

  /// @brief Method get_KeyId, addr 0x1148384, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_PublicKeyPacket, addr 0x114838c, size 0x8, virtual false, abstract: false, final false
