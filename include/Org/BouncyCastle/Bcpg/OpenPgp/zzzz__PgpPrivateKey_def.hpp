...
public:
  ...
  /// @brief Method .ctor, addr 0x111ec50, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Key, addr 0x1123c90, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Key();

  /// @brief Method get_KeyId, addr 0x1123c80, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_PublicKeyPacket, addr 0x1123c88, size 0x8, virtual false, abstract: false, final false
