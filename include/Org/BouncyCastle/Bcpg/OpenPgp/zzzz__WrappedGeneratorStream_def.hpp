...
public:
  ...
  /// @brief Method Close, addr 0x254fa8c, size 0xa0, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x254fa60, size 0x2c, virtual false, abstract: false, final false
