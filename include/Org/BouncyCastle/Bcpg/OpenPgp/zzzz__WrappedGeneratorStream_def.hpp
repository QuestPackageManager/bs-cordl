...
public:
  ...
  /// @brief Method Close, addr 0x35a31f8, size 0xa4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x35a31cc, size 0x2c, virtual false, abstract: false, final false
