...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WrappedGeneratorStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WrappedGeneratorStream(WrappedGeneratorStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WrappedGeneratorStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WrappedGeneratorStream(WrappedGeneratorStreamconst&) = delete;
