...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECPublicBcpgKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECPublicBcpgKey(ECPublicBcpgKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECPublicBcpgKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECPublicBcpgKey(ECPublicBcpgKeyconst&) = delete;
