...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::OutputStreamPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::OutputStreamPacket*, "Org.BouncyCastle.Bcpg", "OutputStreamPacket");
...
public:
  ...
  /// @brief Method .ctor, addr 0x369c894, size 0x58, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::OutputStreamPacket) == 0x18, "Size mismatch!");
