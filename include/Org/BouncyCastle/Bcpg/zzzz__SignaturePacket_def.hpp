...
public:
  ...
  /// @brief Method Encode, addr 0x260ad18, size 0x328, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method EncodeLengthAndData, addr 0x260b0f0, size 0x54, virtual false, abstract: false, final false
  static inline void EncodeLengthAndData(::Org::BouncyCastle::Bcpg::BcpgOutputStream* pOut, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method GetEncodedSubpackets, addr 0x260b040, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashedSubPackets, addr 0x260ad00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x260aae0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Bcpg::MPInteger*, ::Array<::Org::BouncyCastle::Bcpg::MPInteger*>*> GetSignature();

  /// @brief Method GetSignatureBytes, addr 0x260aae8, size 0x218, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSignatureBytes();

  /// @brief Method GetSignatureTrailer, addr 0x260a7dc, size 0x2f4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSignatureTrailer();

  /// @brief Method GetUnhashedSubPackets, addr 0x260ad08, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2603e28, size 0xd68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x260a590, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260a668, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260a5d0, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(int32_t version, int32_t signatureType, int64_t keyId, ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag keyAlgorithm, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm,
                    ::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*, ::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*> hashedData,
                    ::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*, ::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*> unhashedData, ::ArrayW<uint8_t, ::Array<uint8_t>*> fingerprint,
                    ::ArrayW<::Org::BouncyCastle::Bcpg::MPInteger*, ::Array<::Org::BouncyCastle::Bcpg::MPInteger*>*> signature);

  /// @brief Method get_CreationTime, addr 0x260ad10, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_CreationTime();

  /// @brief Method get_HashAlgorithm, addr 0x260aad8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_KeyAlgorithm, addr 0x260aad0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm();

  /// @brief Method get_KeyId, addr 0x260a7d4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_SignatureType, addr 0x260a7cc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_SignatureType();

  /// @brief Method get_Version, addr 0x260a7c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Version();

  /// @brief Method setCreationTime, addr 0x260a6d4, size 0xf0, virtual false, abstract: false, final false
