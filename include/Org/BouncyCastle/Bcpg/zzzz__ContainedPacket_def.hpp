...
public:
  // Declarations
  /// @brief Method GetEncoded, addr 0x11fe2ac, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11fe35c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
