...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::ContainedPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::ContainedPacket*, "Org.BouncyCastle.Bcpg", "ContainedPacket");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ContainedPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ContainedPacket(ContainedPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ContainedPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ContainedPacket(ContainedPacketconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::ContainedPacket) == 0x10, "Size mismatch!");
