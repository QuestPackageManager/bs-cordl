...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserIdPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserIdPacket(UserIdPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserIdPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserIdPacket(UserIdPacketconst&) = delete;
