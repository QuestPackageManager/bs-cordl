...
public:
  // Declarations
  /// @brief Method Encode, addr 0x369f294, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369f290, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369bdd0, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PublicSubkeyPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PublicSubkeyPacket(PublicSubkeyPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PublicSubkeyPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PublicSubkeyPacket(PublicSubkeyPacketconst&) = delete;
