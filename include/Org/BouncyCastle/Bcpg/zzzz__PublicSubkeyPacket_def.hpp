...
public:
  // Declarations
  /// @brief Method Encode, addr 0x264da00, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264d9fc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264a41c, size 0x4, virtual false, abstract: false, final false
