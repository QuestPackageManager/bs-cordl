...
public:
  ...
  /// @brief Method Encode, addr 0x369bba0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyHashAlgorithm, addr 0x369ba8c, size 0x60, virtual false, abstract: false, final false
  inline void VerifyHashAlgorithm();

  /// @brief Method VerifySymmetricKeyAlgorithm, addr 0x369baec, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369b954, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369bb4c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x369bb90, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_Reserved, addr 0x369bb88, size 0x8, virtual true, abstract: false, final false
  inline uint8_t get_Reserved();

  /// @brief Method get_SymmetricKeyAlgorithm, addr 0x369bb98, size 0x8, virtual true, abstract: false, final false
