...
public:
  ...
  /// @brief Method Encode, addr 0x26481c8, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyHashAlgorithm, addr 0x26480ac, size 0x64, virtual false, abstract: false, final false
  inline void VerifyHashAlgorithm();

  /// @brief Method VerifySymmetricKeyAlgorithm, addr 0x2648110, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2647f88, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x2648174, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x26481b8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm();

  /// @brief Method get_Reserved, addr 0x26481b0, size 0x8, virtual true, abstract: false, final false
  inline uint8_t get_Reserved();

  /// @brief Method get_SymmetricKeyAlgorithm, addr 0x26481c0, size 0x8, virtual true, abstract: false, final false
