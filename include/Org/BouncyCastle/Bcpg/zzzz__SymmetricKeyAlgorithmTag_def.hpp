...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag, "Org.BouncyCastle.Bcpg", "SymmetricKeyAlgorithmTag");
// Dependencies
namespace Org::BouncyCastle::Bcpg {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag) == 0x4, "Size mismatch!");
