...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserAttributePacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserAttributePacket(UserAttributePacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserAttributePacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserAttributePacket(UserAttributePacketconst&) = delete;
