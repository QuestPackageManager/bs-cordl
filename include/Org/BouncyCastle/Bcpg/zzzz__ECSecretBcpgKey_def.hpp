...
public:
  ...
  /// @brief Method Encode, addr 0x35a25e8, size 0x24, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x35a2560, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a244c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35a24b4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method get_Format, addr 0x35a251c, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_X, addr 0x35a260c, size 0x18, virtual true, abstract: false, final false
