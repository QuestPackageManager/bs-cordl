...
public:
  ...
  /// @brief Method Encode, addr 0x3693d38, size 0x120, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* os);

  /// @brief Method Equals, addr 0x3693e58, size 0xf0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetData, addr 0x3693d30, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetData();

  /// @brief Method GetHashCode, addr 0x3693f48, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3693d08, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag type, ::ArrayW<uint8_t> data);

  /// @brief Method .ctor, addr 0x3693d18, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag type, bool forceLongLength, ::ArrayW<uint8_t> data);

  /// @brief Method get_SubpacketType, addr 0x3693d28, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserAttributeSubpacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserAttributeSubpacket(UserAttributeSubpacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserAttributeSubpacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserAttributeSubpacket(UserAttributeSubpacketconst&) = delete;
