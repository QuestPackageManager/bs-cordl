...
public:
  ...
  /// @brief Method Encode, addr 0x356d984, size 0x120, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* os);

  /// @brief Method Equals, addr 0x356daa4, size 0xf0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetData, addr 0x356d97c, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetData();

  /// @brief Method GetHashCode, addr 0x356db94, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356d954, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag type, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x356d964, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SubpacketType, addr 0x356d974, size 0x8, virtual true, abstract: false, final false
