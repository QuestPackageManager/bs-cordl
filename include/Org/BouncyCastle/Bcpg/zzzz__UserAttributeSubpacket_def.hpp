...
public:
  ...
  /// @brief Method Encode, addr 0x263dbb0, size 0x138, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* os);

  /// @brief Method Equals, addr 0x263dce8, size 0xe8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetData, addr 0x263dba8, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetData();

  /// @brief Method GetHashCode, addr 0x263ddd0, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263db2c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag type, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x263db60, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SubpacketType, addr 0x263dba0, size 0x8, virtual true, abstract: false, final false
