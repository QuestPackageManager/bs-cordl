...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::ArmoredInputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::ArmoredInputStream*, "Org.BouncyCastle.Bcpg", "ArmoredInputStream");
...
public:
  ...
  __declspec(property(get = getStaticF_decodingTable, put = setStaticF_decodingTable)) ::ArrayW<uint8_t> decodingTable;
  ...
  __declspec(property(get = __cordl_internal_get_outBuf, put = __cordl_internal_set_outBuf)) ::ArrayW<int32_t> outBuf;
  ...
  constexpr ::ArrayW<int32_t> const& __cordl_internal_get_outBuf() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get_outBuf();
  ...
  constexpr void __cordl_internal_set_outBuf(::ArrayW<int32_t> value);
  ...
  static inline void setStaticF_decodingTable(::ArrayW<uint8_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::ArmoredInputStream) == 0x80, "Size mismatch!");
