...
public:
  ...
  /// @brief Method Close, addr 0x142dea4, size 0x68, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Decode, addr 0x142cc98, size 0x208, virtual false, abstract: false, final false
  inline int32_t Decode(int32_t in0, int32_t in1, int32_t in2, int32_t in3, ::ArrayW<int32_t, ::Array<int32_t>*> result);

  /// @brief Method DoReadByte, addr 0x142d95c, size 0x298, virtual false, abstract: false, final false
  inline int32_t DoReadByte();

  /// @brief Method GetArmorHeaderLine, addr 0x142d424, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetArmorHeaderLine();

  /// @brief Method GetArmorHeaders, addr 0x142d42c, size 0x26c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetArmorHeaders();

  /// @brief Method IsClearText, addr 0x142d414, size 0x8, virtual false, abstract: false, final false
  inline bool IsClearText();

  /// @brief Method IsEndOfStream, addr 0x142d41c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseHeaders, addr 0x142cfe0, size 0x434, virtual false, abstract: false, final false
  inline bool ParseHeaders();

  /// @brief Method Read, addr 0x142dcd8, size 0x1cc, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x142dbf4, size 0x9c, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method ReadByteClearText, addr 0x142d73c, size 0xd8, virtual false, abstract: false, final false
  inline int32_t ReadByteClearText();

  /// @brief Method ReadClearText, addr 0x142d814, size 0x148, virtual false, abstract: false, final false
  inline int32_t ReadClearText(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadIgnoreSpace, addr 0x142d698, size 0x44, virtual false, abstract: false, final false
  inline int32_t ReadIgnoreSpace();

  /// @brief Method ReadIgnoreWhitespace, addr 0x142d6dc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x142cea0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x142cea8, size 0x124, virtual false, abstract: false, final false
