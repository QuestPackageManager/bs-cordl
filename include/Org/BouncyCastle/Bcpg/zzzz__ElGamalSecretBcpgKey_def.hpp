...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::ElGamalSecretBcpgKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::ElGamalSecretBcpgKey*, "Org.BouncyCastle.Bcpg", "ElGamalSecretBcpgKey");
...
public:
  ...
  /// @brief Method Encode, addr 0x369e6a0, size 0x24, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x369e618, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369e4ec, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369e554, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method get_Format, addr 0x369e5bc, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_X, addr 0x369e600, size 0x18, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ElGamalSecretBcpgKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ElGamalSecretBcpgKey(ElGamalSecretBcpgKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ElGamalSecretBcpgKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ElGamalSecretBcpgKey(ElGamalSecretBcpgKeyconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::ElGamalSecretBcpgKey) == 0x18, "Size mismatch!");
