...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::SignatureSubpacketsParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::SignatureSubpacketsParser*, "Org.BouncyCastle.Bcpg", "SignatureSubpacketsParser");
...
public:
  ...
  /// @brief Method CheckData, addr 0x36a12b8, size 0xf4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> CheckData(::ArrayW<uint8_t> data, int32_t expected, int32_t bytesRead, ::StringW name);

  static inline ::Org::BouncyCastle::Bcpg::SignatureSubpacketsParser* New_ctor(::System::IO::Stream* input);

  /// @brief Method ReadPacket, addr 0x36a0280, size 0x544, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a0278, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignatureSubpacketsParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignatureSubpacketsParser(SignatureSubpacketsParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignatureSubpacketsParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignatureSubpacketsParser(SignatureSubpacketsParserconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::SignatureSubpacketsParser) == 0x18, "Size mismatch!");
