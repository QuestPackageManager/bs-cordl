...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserAttributeSubpacketsParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserAttributeSubpacketsParser(UserAttributeSubpacketsParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserAttributeSubpacketsParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserAttributeSubpacketsParser(UserAttributeSubpacketsParserconst&) = delete;
