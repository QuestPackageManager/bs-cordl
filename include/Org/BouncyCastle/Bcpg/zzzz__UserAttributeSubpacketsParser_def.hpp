...
public:
  ...
  /// @brief Method ReadPacket, addr 0x2650124, size 0x2ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264fff4, size 0x28, virtual false, abstract: false, final false
