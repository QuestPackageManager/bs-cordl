...
public:
  ...
  /// @brief Method ReadPacket, addr 0x35e216c, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e2078, size 0x8, virtual false, abstract: false, final false
