...
public:
  ...
  /// @brief Method ReadPacket, addr 0x35a5bd8, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a5ae4, size 0x8, virtual false, abstract: false, final false
