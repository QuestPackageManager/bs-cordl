...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RevocationKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RevocationKey(RevocationKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RevocationKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RevocationKey(RevocationKeyconst&) = delete;
