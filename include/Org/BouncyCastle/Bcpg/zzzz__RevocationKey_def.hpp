...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::RevocationKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::RevocationKey*, "Org.BouncyCastle.Bcpg", "RevocationKey");
...
public:
  ...
  /// @brief Method CreateData, addr 0x36932f0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFingerprint, addr 0x36933f4, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3693298, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool isCritical, bool isLongLength, ::ArrayW<uint8_t> data);

  /// @brief Method .ctor, addr 0x36932b0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Algorithm, addr 0x36933c8, size 0x2c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_SignatureClass, addr 0x36933a0, size 0x28, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::RevocationKey) == 0x20, "Size mismatch!");
