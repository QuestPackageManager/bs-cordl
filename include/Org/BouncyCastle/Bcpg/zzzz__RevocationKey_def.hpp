...
public:
  ...
  /// @brief Method CreateData, addr 0x263bda4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFingerprint, addr 0x263bea4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263bd08, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool isCritical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x263bd50, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Algorithm, addr 0x263be78, size 0x2c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_SignatureClass, addr 0x263be50, size 0x28, virtual true, abstract: false, final false
