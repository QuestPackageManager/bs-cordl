...
public:
  ...
  /// @brief Method CreateData, addr 0x3599b08, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFingerprint, addr 0x3599c0c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3599ab0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool isCritical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x3599ac8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Algorithm, addr 0x3599be0, size 0x2c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_SignatureClass, addr 0x3599bb8, size 0x28, virtual true, abstract: false, final false
