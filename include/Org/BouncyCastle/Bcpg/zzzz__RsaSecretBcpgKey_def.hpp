...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RsaSecretBcpgKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RsaSecretBcpgKey(RsaSecretBcpgKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RsaSecretBcpgKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RsaSecretBcpgKey(RsaSecretBcpgKeyconst&) = delete;
