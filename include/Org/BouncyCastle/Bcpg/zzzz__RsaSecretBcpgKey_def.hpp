...
/// @brief Method Encode, addr 0x35a3de4, size 0x130, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream*  bcpgOut) ;

/// @brief Method GetEncoded, addr 0x35a3d5c, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35a3904, size 0x198, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgIn) ;

/// @brief Method .ctor, addr 0x35a3a9c, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method get_CrtCoefficient, addr 0x35a3d10, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_CrtCoefficient() ;

/// @brief Method get_Format, addr 0x35a3d18, size 0x44, virtual true, abstract: false, final true
inline ::StringW get_Format() ;

/// @brief Method get_Modulus, addr 0x35a3c88, size 0x30, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Modulus() ;

/// @brief Method get_PrimeExponentP, addr 0x35a3d00, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_PrimeExponentP() ;

/// @brief Method get_PrimeExponentQ, addr 0x35a3d08, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_PrimeExponentQ() ;

/// @brief Method get_PrimeP, addr 0x35a3cd0, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_PrimeP() ;

/// @brief Method get_PrimeQ, addr 0x35a3ce8, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_PrimeQ() ;

/// @brief Method get_PrivateExponent, addr 0x35a3cb8, size 0x18, virtual false, abstract: false, final false
