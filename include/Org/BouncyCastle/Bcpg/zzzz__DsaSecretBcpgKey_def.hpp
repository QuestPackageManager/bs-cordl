...
public:
  ...
  /// @brief Method Encode, addr 0x35de26c, size 0x24, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x35de1e4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35de0d0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35de138, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method get_Format, addr 0x35de1a0, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_X, addr 0x35de290, size 0x18, virtual false, abstract: false, final false
