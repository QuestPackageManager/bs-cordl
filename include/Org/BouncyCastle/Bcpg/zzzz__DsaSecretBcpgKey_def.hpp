...
public:
  ...
  /// @brief Method Encode, addr 0x2647b64, size 0x24, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x2647ae0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26479c0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x2647a30, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method get_Format, addr 0x2647aa0, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_X, addr 0x2647b88, size 0x1c, virtual false, abstract: false, final false
