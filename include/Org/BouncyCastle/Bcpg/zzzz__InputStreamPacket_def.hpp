...
public:
  ...
  /// @brief Method GetInputStream, addr 0x133f4f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133c3a8, size 0x28, virtual false, abstract: false, final false
