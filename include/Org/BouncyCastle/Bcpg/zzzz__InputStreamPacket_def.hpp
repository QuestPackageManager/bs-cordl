...
public:
  ...
  /// @brief Method GetInputStream, addr 0x369d01c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3699fbc, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InputStreamPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InputStreamPacket(InputStreamPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InputStreamPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InputStreamPacket(InputStreamPacketconst&) = delete;
