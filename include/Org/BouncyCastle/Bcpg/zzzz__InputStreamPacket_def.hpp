...
public:
  ...
  /// @brief Method GetInputStream, addr 0x264b674, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26485cc, size 0x28, virtual false, abstract: false, final false
