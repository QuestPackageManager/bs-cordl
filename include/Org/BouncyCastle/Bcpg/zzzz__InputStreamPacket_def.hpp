...
public:
  ...
  /// @brief Method GetInputStream, addr 0x35a14ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x359e44c, size 0x8, virtual false, abstract: false, final false
