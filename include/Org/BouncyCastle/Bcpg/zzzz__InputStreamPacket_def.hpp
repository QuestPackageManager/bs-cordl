...
public:
  ...
  /// @brief Method GetInputStream, addr 0x35dda40, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35da9e0, size 0x8, virtual false, abstract: false, final false
