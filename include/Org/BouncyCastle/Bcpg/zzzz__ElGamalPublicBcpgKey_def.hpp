...
public:
  ...
  /// @brief Method Encode, addr 0x3578034, size 0x104, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x3577f64, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3577de0, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x3577e78, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x3577f20, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_G, addr 0x3578004, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_P, addr 0x3577fec, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_Y, addr 0x357801c, size 0x18, virtual false, abstract: false, final false
