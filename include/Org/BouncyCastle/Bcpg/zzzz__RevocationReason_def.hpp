...
public:
  // Declarations
  /// @brief Method CreateData, addr 0x2640100, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRevocationDescription, addr 0x26401cc, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW GetRevocationDescription();

  /// @brief Method GetRevocationReason, addr 0x26401a4, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2640068, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool isCritical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x26400b0, size 0x50, virtual false, abstract: false, final false
