...
public:
  ...
  /// @brief Method .ctor addr 0x11577b8 size 0x48 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1157800 size 0x50 virtual false final false
  inline void _ctor(bool isCritical, ::Org::BouncyCastle::Bcpg::RevocationReasonTag reason, ::StringW description);

  /// @brief Method CreateData addr 0x1157850 size 0xa4 virtual false final false
  ...
  /// @brief Method GetRevocationReason addr 0x11578f4 size 0x28 virtual true final false
  inline ::Org::BouncyCastle::Bcpg::RevocationReasonTag GetRevocationReason();

  /// @brief Method GetRevocationDescription addr 0x115791c size 0xc0 virtual true final false
