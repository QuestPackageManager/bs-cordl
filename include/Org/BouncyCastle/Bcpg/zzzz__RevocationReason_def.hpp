...
public:
  // Declarations
  /// @brief Method CreateData, addr 0x35d6284, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRevocationDescription, addr 0x35d635c, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW GetRevocationDescription();

  /// @brief Method GetRevocationReason, addr 0x35d6334, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d6230, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool isCritical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x35d6248, size 0x3c, virtual false, abstract: false, final false
