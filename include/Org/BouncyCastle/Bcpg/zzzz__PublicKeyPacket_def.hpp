...
public:
  ...
  /// @brief Method Encode, addr 0x3578ea4, size 0x38, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncodedContents, addr 0x3578d3c, size 0x168, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncodedContents();

  /// @brief Method GetTime, addr 0x3578cd0, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3578c0c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35750d0, size 0x298, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_Algorithm, addr 0x3578cc0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_Key, addr 0x3578d34, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::IBcpgKey* get_Key();

  /// @brief Method get_ValidDays, addr 0x3578cc8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ValidDays();

  /// @brief Method get_Version, addr 0x3578cb8, size 0x8, virtual true, abstract: false, final false
