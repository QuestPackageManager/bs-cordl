...
public:
  ...
  /// @brief Method Encode, addr 0x2649654, size 0x38, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncodedContents, addr 0x26494f0, size 0x164, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncodedContents();

  /// @brief Method GetTime, addr 0x2649488, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26493bc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2645720, size 0x280, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_Algorithm, addr 0x2649478, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_Key, addr 0x26494e8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::IBcpgKey* get_Key();

  /// @brief Method get_ValidDays, addr 0x2649480, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ValidDays();

  /// @brief Method get_Version, addr 0x2649470, size 0x8, virtual true, abstract: false, final false
