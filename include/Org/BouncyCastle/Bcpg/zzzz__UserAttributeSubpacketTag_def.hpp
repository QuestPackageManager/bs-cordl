...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag, "Org.BouncyCastle.Bcpg", "UserAttributeSubpacketTag");
// Dependencies
namespace Org::BouncyCastle::Bcpg {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag) == 0x4, "Size mismatch!");
