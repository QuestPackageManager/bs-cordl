...
public:
  ...
  /// @brief Method Encode, addr 0x369c600, size 0x70, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method Encode, addr 0x369c670, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369ae20, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369b014, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* val);

  /// @brief Method get_Value, addr 0x369c5f8, size 0x8, virtual false, abstract: false, final false
