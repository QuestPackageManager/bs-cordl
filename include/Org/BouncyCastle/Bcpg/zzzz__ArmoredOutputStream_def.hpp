...
public:
  ...
  /// @brief Method AddHeader, addr 0x263e830, size 0x218, virtual false, abstract: false, final false
  inline void AddHeader(::StringW name, ::StringW val);

  /// @brief Method BeginClearText, addr 0x263ec70, size 0x1d4, virtual false, abstract: false, final false
  inline void BeginClearText(::Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm);

  /// @brief Method Close, addr 0x263f9ec, size 0x38, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method DoClose, addr 0x263fa24, size 0x1ac, virtual false, abstract: false, final false
  inline void DoClose();

  /// @brief Method DoWrite, addr 0x263ee44, size 0x44, virtual false, abstract: false, final false
  inline void DoWrite(::StringW s);

  /// @brief Method Encode, addr 0x263dc04, size 0x2f4, virtual false, abstract: false, final false
  static inline void Encode(::System::IO::Stream* outStream, ::ArrayW<int32_t, ::Array<int32_t>*> data, int32_t len);

  /// @brief Method EndClearText, addr 0x263ee88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetHeaders, addr 0x263ea48, size 0x228, virtual false, abstract: false, final false
  inline void ResetHeaders();

  /// @brief Method SetHeader, addr 0x263e024, size 0x2b4, virtual false, abstract: false, final false
  inline void SetHeader(::StringW name, ::StringW val);

  /// @brief Method WriteByte, addr 0x263ee90, size 0xac0, virtual true, abstract: false, final false
  inline void WriteByte(uint8_t b);

  /// @brief Method WriteHeaderEntry, addr 0x263f950, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263def8, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x263e2d8, size 0x558, virtual false, abstract: false, final false
