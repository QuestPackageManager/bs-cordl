...
/// @brief Method AddHeader, addr 0x359c420, size 0x224, virtual false, abstract: false, final false
inline void AddHeader(::StringW  name, ::StringW  val) ;

/// @brief Method BeginClearText, addr 0x359c878, size 0x210, virtual false, abstract: false, final false
inline void BeginClearText(::Org::BouncyCastle::Bcpg::HashAlgorithmTag  hashAlgorithm) ;

/// @brief Method Close, addr 0x359d5cc, size 0x38, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method DoClose, addr 0x359d604, size 0x19c, virtual false, abstract: false, final false
inline void DoClose() ;

/// @brief Method DoWrite, addr 0x359ca88, size 0x44, virtual false, abstract: false, final false
inline void DoWrite(::StringW  s) ;

/// @brief Method Encode, addr 0x359b810, size 0x2f8, virtual false, abstract: false, final false
static inline void Encode(::System::IO::Stream*  outStream, ::ArrayW<int32_t,::Array<int32_t>*>  data, int32_t  len) ;

/// @brief Method EndClearText, addr 0x359cacc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ResetHeaders, addr 0x359c644, size 0x234, virtual false, abstract: false, final false
inline void ResetHeaders() ;

/// @brief Method SetHeader, addr 0x359bc34, size 0x2d4, virtual false, abstract: false, final false
inline void SetHeader(::StringW  name, ::StringW  val) ;

/// @brief Method WriteByte, addr 0x359cad4, size 0xa54, virtual true, abstract: false, final false
inline void WriteByte(uint8_t  b) ;

/// @brief Method WriteHeaderEntry, addr 0x359d528, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x359bb08, size 0x12c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStream) ;

/// @brief Method .ctor, addr 0x359bf08, size 0x518, virtual false, abstract: false, final false
