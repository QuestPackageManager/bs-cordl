...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArmoredOutputStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArmoredOutputStream(ArmoredOutputStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArmoredOutputStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArmoredOutputStream(ArmoredOutputStreamconst&) = delete;
