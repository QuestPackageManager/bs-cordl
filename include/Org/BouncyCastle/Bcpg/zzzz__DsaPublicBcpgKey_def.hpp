...
public:
  ...
  /// @brief Method Encode, addr 0x2643d24, size 0x12c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x2643ca0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26438e4, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x2643ad0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x2643c60, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_G, addr 0x2643e50, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_P, addr 0x2643e6c, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_Q, addr 0x2643e88, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  /// @brief Method get_Y, addr 0x2643ea4, size 0x1c, virtual false, abstract: false, final false
