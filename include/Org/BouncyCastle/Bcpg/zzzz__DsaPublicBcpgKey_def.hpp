...
public:
  ...
  /// @brief Method Encode, addr 0x26477d4, size 0x12c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x2647750, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2647394, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x2647580, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x2647710, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_G, addr 0x2647900, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_P, addr 0x264791c, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_Q, addr 0x2647938, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  /// @brief Method get_Y, addr 0x2647954, size 0x1c, virtual false, abstract: false, final false
