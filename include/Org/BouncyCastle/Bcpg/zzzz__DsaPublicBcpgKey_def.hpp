...
public:
  ...
  /// @brief Method Encode, addr 0x35ddf40, size 0x130, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncoded, addr 0x35ddeb8, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ddb1c, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x35ddcfc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x35dde74, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_Format();

  /// @brief Method get_G, addr 0x35de070, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_P, addr 0x35de088, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_Q, addr 0x35de0a0, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  /// @brief Method get_Y, addr 0x35de0b8, size 0x18, virtual false, abstract: false, final false
