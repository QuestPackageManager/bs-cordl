...
public:
  ...
  /// @brief Method GetValue, addr 0x2647344, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetValue();

  static inline ::Org::BouncyCastle::Bcpg::Crc24* New_ctor();

  /// @brief Method Reset, addr 0x26413f0, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x2641400, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2640764, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Value, addr 0x264734c, size 0x8, virtual false, abstract: false, final false
