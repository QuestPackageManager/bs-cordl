...
public:
  ...
  /// @brief Method GetValue, addr 0x1266a38, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetValue();

  static inline ::Org::BouncyCastle::Bcpg::Crc24* New_ctor();

  /// @brief Method Reset, addr 0x12609e8, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x12609f8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x125fd24, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Value, addr 0x1266a40, size 0x8, virtual false, abstract: false, final false
