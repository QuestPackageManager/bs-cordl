...
public:
  ...
  /// @brief Method GetValue, addr 0x133f5bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetValue();

  static inline ::Org::BouncyCastle::Bcpg::Crc24* New_ctor();

  /// @brief Method Reset, addr 0x133956c, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x133957c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13388a8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Value, addr 0x133f5c4, size 0x8, virtual false, abstract: false, final false
