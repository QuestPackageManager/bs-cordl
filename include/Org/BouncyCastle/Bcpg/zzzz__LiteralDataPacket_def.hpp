...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LiteralDataPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LiteralDataPacket(LiteralDataPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LiteralDataPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LiteralDataPacket(LiteralDataPacketconst&) = delete;
