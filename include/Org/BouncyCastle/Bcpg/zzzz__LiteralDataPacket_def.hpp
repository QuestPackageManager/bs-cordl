...
public:
  ...
  /// @brief Method GetRawFileName, addr 0x143ad24, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1437c18, size 0x1bc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_FileName, addr 0x143ad18, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_Format, addr 0x143ad08, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Format();

  /// @brief Method get_ModificationTime, addr 0x143ad10, size 0x8, virtual false, abstract: false, final false
