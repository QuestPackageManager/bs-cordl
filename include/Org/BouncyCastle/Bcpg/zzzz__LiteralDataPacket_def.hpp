...
public:
  ...
  /// @brief Method GetRawFileName, addr 0x35a2c14, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x359fc88, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method get_FileName, addr 0x35a2c08, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_Format, addr 0x35a2bf8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Format();

  /// @brief Method get_ModificationTime, addr 0x35a2c00, size 0x8, virtual false, abstract: false, final false
