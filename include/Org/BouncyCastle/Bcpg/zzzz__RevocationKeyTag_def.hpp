...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::RevocationKeyTag, "Org.BouncyCastle.Bcpg", "RevocationKeyTag");
// Dependencies
namespace Org::BouncyCastle::Bcpg {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::RevocationKeyTag) == 0x1, "Size mismatch!");
