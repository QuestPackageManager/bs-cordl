...
public:
  ...
  /// @brief Method Encode, addr 0x1435510, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x143230c, size 0x9c, virtual false, abstract: false, final false
