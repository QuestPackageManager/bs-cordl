...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECDsaPublicBcpgKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECDsaPublicBcpgKey(ECDsaPublicBcpgKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECDsaPublicBcpgKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECDsaPublicBcpgKey(ECDsaPublicBcpgKeyconst&) = delete;
