...
public:
  ...
  /// @brief Method .ctor, addr 0x369bc24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369bc2c, size 0x8, virtual false, abstract: false, final false
