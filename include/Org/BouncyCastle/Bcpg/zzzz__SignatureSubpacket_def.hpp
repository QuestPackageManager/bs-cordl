...
public:
  ...
  /// @brief Method Encode, addr 0x356e018, size 0x128, virtual false, abstract: false, final false
  inline void Encode(::System::IO::Stream* os);

  /// @brief Method GetData, addr 0x356dfa0, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetData();

  /// @brief Method IsCritical, addr 0x356df90, size 0x8, virtual false, abstract: false, final false
  inline bool IsCritical();

  /// @brief Method IsLongLength, addr 0x356df98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356df74, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SubpacketType, addr 0x356df88, size 0x8, virtual false, abstract: false, final false
