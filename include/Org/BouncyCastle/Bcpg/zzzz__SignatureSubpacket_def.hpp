...
public:
  ...
  /// @brief Method Encode, addr 0x263a800, size 0x144, virtual false, abstract: false, final false
  inline void Encode(::System::IO::Stream* os);

  /// @brief Method GetData, addr 0x263a788, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetData();

  /// @brief Method IsCritical, addr 0x263a778, size 0x8, virtual false, abstract: false, final false
  inline bool IsCritical();

  /// @brief Method IsLongLength, addr 0x263a780, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263a728, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SubpacketType, addr 0x263a770, size 0x8, virtual false, abstract: false, final false
