...
public:
  ...
  /// @brief Method Encode, addr 0x2642670, size 0x144, virtual false, abstract: false, final false
  inline void Encode(::System::IO::Stream* os);

  /// @brief Method GetData, addr 0x26425f8, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetData();

  /// @brief Method IsCritical, addr 0x26425e8, size 0x8, virtual false, abstract: false, final false
  inline bool IsCritical();

  /// @brief Method IsLongLength, addr 0x26425f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2642598, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SubpacketType, addr 0x26425e0, size 0x8, virtual false, abstract: false, final false
