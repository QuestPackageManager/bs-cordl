...
public:
  ...
  /// @brief Method Encode, addr 0x3692044, size 0x128, virtual false, abstract: false, final false
  inline void Encode(::System::IO::Stream* os);

  /// @brief Method GetData, addr 0x3691fcc, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetData();

  /// @brief Method IsCritical, addr 0x3691fbc, size 0x8, virtual false, abstract: false, final false
  inline bool IsCritical();

  /// @brief Method IsLongLength, addr 0x3691fc4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3691fa0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::SignatureSubpacketTag type, bool critical, bool isLongLength, ::ArrayW<uint8_t> data);

  /// @brief Method get_SubpacketType, addr 0x3691fb4, size 0x8, virtual false, abstract: false, final false
