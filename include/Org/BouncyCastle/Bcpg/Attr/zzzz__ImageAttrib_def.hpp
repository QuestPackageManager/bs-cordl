...
public:
  ...
  /// @brief Method GetImageData, addr 0x35d4cd4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToByteArray, addr 0x35d4b70, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d4a14, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x35d4a20, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(bool forceLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x35d4af4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Encoding, addr 0x35d4ccc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Encoding();

  /// @brief Method get_Version, addr 0x35d4cc4, size 0x8, virtual true, abstract: false, final false
