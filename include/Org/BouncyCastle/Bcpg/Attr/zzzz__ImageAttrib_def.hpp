...
public:
  ...
  /// @brief Method GetImageData, addr 0x263cdf4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToByteArray, addr 0x263cc98, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263cb40, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x263cb4c, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(bool forceLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x263cc20, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Encoding, addr 0x263cdec, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Encoding();

  /// @brief Method get_Version, addr 0x263cde4, size 0x8, virtual true, abstract: false, final false
