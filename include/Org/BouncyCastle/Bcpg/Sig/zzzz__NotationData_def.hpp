...
public:
  ...
  /// @brief Method CreateData, addr 0x125e4f0, size 0x220, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CreateData(bool humanReadable, ::StringW notationName, ::StringW notationValue);

  /// @brief Method GetNotationName, addr 0x125e740, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW GetNotationName();

  /// @brief Method GetNotationValue, addr 0x125e7ac, size 0x90, virtual false, abstract: false, final false
  inline ::StringW GetNotationValue();

  /// @brief Method GetNotationValueBytes, addr 0x125e83c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x125e49c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool humanReadable, ::StringW notationName, ::StringW notationValue);

  /// @brief Method .ctor, addr 0x125e454, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method get_IsHumanReadable, addr 0x125e710, size 0x30, virtual false, abstract: false, final false
