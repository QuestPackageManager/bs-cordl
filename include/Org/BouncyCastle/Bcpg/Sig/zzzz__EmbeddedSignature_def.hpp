...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EmbeddedSignature", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EmbeddedSignature(EmbeddedSignature&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EmbeddedSignature", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EmbeddedSignature(EmbeddedSignatureconst&) = delete;
