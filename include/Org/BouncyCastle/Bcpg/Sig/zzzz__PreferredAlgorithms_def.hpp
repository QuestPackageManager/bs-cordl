...
public:
  // Declarations
  /// @brief Method GetPreferences, addr 0x2643870, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferences();

  /// @brief Method IntToByteArray, addr 0x2643734, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26437d4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264381c, size 0x54, virtual false, abstract: false, final false
