...
public:
  // Declarations
  /// @brief Method GetPreferences, addr 0x35d5dc4, size 0xa0, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferences();

  /// @brief Method IntToByteArray, addr 0x35d5cd4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d5d78, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d5d8c, size 0x38, virtual false, abstract: false, final false
