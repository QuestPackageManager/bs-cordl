...
public:
  // Declarations
  /// @brief Method GetPreferences, addr 0x263f500, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferences();

  /// @brief Method IntToByteArray, addr 0x263f3c4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263f464, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263f4ac, size 0x54, virtual false, abstract: false, final false
