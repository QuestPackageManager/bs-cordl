...
public:
  // Declarations
  /// @brief Method GetPreferences, addr 0x356efec, size 0xa0, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetPreferences();

  /// @brief Method IntToByteArray, addr 0x356eefc, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356efa0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356efb4, size 0x38, virtual false, abstract: false, final false
