...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Bcpg::Sig::EmbeddedSignature::*)(bool, bool, ::ArrayW<uint8_t, ::Array<uint8_t>*>)>(
  ...
  constexpr static std::size_t addrs = 0x11561c8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Bcpg::Sig::EmbeddedSignature*>::get(), ".ctor", std::vector<Il2CppClass*>{},
