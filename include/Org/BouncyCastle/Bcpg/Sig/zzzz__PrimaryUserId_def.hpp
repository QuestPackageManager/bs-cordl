...
public:
// Declarations
/// @brief Method BooleanToByteArray, addr 0x3599820, size 0x70, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> BooleanToByteArray(bool  val) ;

/// @brief Method IsPrimaryUserId, addr 0x35998e0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3599890, size 0x18, virtual false, abstract: false, final false
inline void _ctor(bool  critical, bool  isLongLength, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x35998a8, size 0x38, virtual false, abstract: false, final false
