...
public:
  // Declarations
  /// @brief Method BooleanToByteArray addr 0x1157330 size 0x6c virtual false final false
  ...
  /// @brief Method .ctor addr 0x115739c size 0x48 virtual false final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Bcpg::Sig::PrimaryUserId* New_ctor(bool critical, bool isPrimaryUserId);

  /// @brief Method .ctor addr 0x11573e4 size 0x4c virtual false final false
  inline void _ctor(bool critical, bool isPrimaryUserId);

  /// @brief Method IsPrimaryUserId addr 0x1157430 size 0x30 virtual false final false
