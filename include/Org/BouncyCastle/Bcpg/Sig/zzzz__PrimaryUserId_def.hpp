...
public:
  // Declarations
  /// @brief Method BooleanToByteArray, addr 0x356f08c, size 0x70, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> BooleanToByteArray(bool val);

  /// @brief Method IsPrimaryUserId, addr 0x356f14c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356f0fc, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x356f114, size 0x38, virtual false, abstract: false, final false
