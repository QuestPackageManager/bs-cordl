...
public:
  ...
  /// @brief Method IntToByteArray, addr 0x11f7054, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f70d0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f7118, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(bool critical, int32_t depth, int32_t trustAmount);

  /// @brief Method get_Depth, addr 0x11f7168, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_TrustAmount, addr 0x11f7190, size 0x2c, virtual false, abstract: false, final false
