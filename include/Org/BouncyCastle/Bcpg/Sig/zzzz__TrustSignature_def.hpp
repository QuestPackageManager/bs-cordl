...
public:
  ...
  /// @brief Method IntToByteArray, addr 0x356fb10, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356fba8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(bool critical, int32_t depth, int32_t trustAmount);

  /// @brief Method .ctor, addr 0x356fb90, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method get_Depth, addr 0x356fbe4, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_TrustAmount, addr 0x356fc0c, size 0x2c, virtual false, abstract: false, final false
