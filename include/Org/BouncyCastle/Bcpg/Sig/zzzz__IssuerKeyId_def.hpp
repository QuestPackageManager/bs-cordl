...
public:
  ...
  /// @brief Method KeyIdToBytes, addr 0x2609300, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26093d4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x260941c, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(bool critical, int64_t keyId);

  /// @brief Method get_KeyId, addr 0x2609468, size 0x9c, virtual false, abstract: false, final false
