...
public:
  ...
  /// @brief Method KeyIdToBytes addr 0x1156754 size 0xd4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1156828 size 0x48 virtual false final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Bcpg::Sig::IssuerKeyId* New_ctor(bool critical, int64_t keyId);

  /// @brief Method .ctor addr 0x1156870 size 0x4c virtual false final false
  inline void _ctor(bool critical, int64_t keyId);

  /// @brief Method get_KeyId addr 0x11568bc size 0x9c virtual false final false
