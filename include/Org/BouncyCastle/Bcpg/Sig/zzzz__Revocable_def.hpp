...
public:
  // Declarations
  /// @brief Method BooleanToByteArray addr 0x1157460 size 0x6c virtual false final false
  ...
  /// @brief Method .ctor addr 0x11574cc size 0x48 virtual false final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Bcpg::Sig::Revocable* New_ctor(bool critical, bool isRevocable);

  /// @brief Method .ctor addr 0x1157514 size 0x4c virtual false final false
  inline void _ctor(bool critical, bool isRevocable);

  /// @brief Method IsRevocable addr 0x1157560 size 0x30 virtual false final false
