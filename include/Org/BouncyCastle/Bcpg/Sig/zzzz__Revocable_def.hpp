...
public:
  // Declarations
  /// @brief Method BooleanToByteArray, addr 0x263fd10, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> BooleanToByteArray(bool value);

  /// @brief Method IsRevocable, addr 0x263fe10, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263fd7c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x263fdc4, size 0x4c, virtual false, abstract: false, final false
