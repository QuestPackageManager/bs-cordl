...
public:
  ...
  /// @brief Method FeatureToByteArray, addr 0x356e248, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSupportsFeature, addr 0x356e428, size 0x1ac, virtual false, abstract: false, final false
  inline void SetSupportsFeature(uint8_t feature, bool support);

  /// @brief Method SupportsFeature, addr 0x356e3e4, size 0x44, virtual false, abstract: false, final false
  inline bool SupportsFeature(uint8_t feature);

  /// @brief Method .ctor, addr 0x356e2c8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(bool critical, uint8_t feature);

  /// @brief Method .ctor, addr 0x356e2b0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline uint8_t getStaticF_FEATURE_MODIFICATION_DETECTION();

  /// @brief Method get_SupportsModificationDetection, addr 0x356e34c, size 0x98, virtual false, abstract: false, final false
