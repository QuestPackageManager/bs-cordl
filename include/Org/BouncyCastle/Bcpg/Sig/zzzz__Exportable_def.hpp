...
public:
  // Declarations
  /// @brief Method BooleanToByteArray, addr 0x14304dc, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> BooleanToByteArray(bool val);

  /// @brief Method IsExportable, addr 0x14305dc, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1430590, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isExportable);

  /// @brief Method .ctor, addr 0x1430548, size 0x48, virtual false, abstract: false, final false
