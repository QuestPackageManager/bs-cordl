...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::Sig::Exportable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::Sig::Exportable*, "Org.BouncyCastle.Bcpg.Sig", "Exportable");
...
public:
  // Declarations
  /// @brief Method BooleanToByteArray, addr 0x3692184, size 0x70, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> BooleanToByteArray(bool val);

  /// @brief Method IsExportable, addr 0x3692244, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369220c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isExportable);

  /// @brief Method .ctor, addr 0x36921f4, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::Sig::Exportable) == 0x20, "Size mismatch!");
