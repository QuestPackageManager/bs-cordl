...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Exportable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Exportable(Exportable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Exportable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Exportable(Exportableconst&) = delete;
