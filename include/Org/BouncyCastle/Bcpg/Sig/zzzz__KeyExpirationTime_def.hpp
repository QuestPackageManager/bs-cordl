...
public:
  ...
  /// @brief Method TimeToBytes addr 0x1156958 size 0x94 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11569ec size 0x48 virtual false final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Bcpg::Sig::KeyExpirationTime* New_ctor(bool critical, int64_t seconds);

  /// @brief Method .ctor addr 0x1156a34 size 0x4c virtual false final false
  inline void _ctor(bool critical, int64_t seconds);

  /// @brief Method get_Time addr 0x1156a80 size 0x5c virtual false final false
