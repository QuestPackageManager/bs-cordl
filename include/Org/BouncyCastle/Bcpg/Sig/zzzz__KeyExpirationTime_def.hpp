...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyExpirationTime", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyExpirationTime(KeyExpirationTime&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyExpirationTime", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyExpirationTime(KeyExpirationTimeconst&) = delete;
