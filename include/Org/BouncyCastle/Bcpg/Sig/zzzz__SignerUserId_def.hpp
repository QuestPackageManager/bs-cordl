...
public:
  // Declarations
  /// @brief Method GetId, addr 0x125f674, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method UserIdToBytes, addr 0x125f53c, size 0xa4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> UserIdToBytes(::StringW id);

  /// @brief Method .ctor, addr 0x125f5e0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x125f628, size 0x4c, virtual false, abstract: false, final false
