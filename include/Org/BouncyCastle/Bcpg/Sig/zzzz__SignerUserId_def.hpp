...
public:
  // Declarations
  /// @brief Method GetId, addr 0x35d6848, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method UserIdToBytes, addr 0x35d6750, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> UserIdToBytes(::StringW id);

  /// @brief Method .ctor, addr 0x35d67f8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x35d6810, size 0x38, virtual false, abstract: false, final false
