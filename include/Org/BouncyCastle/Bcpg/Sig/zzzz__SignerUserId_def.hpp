...
public:
  // Declarations
  /// @brief Method GetId, addr 0x263ed7c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method UserIdToBytes, addr 0x263ec44, size 0xa4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> UserIdToBytes(::StringW id);

  /// @brief Method .ctor, addr 0x263ece8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x263ed30, size 0x4c, virtual false, abstract: false, final false
