...
public:
  ...
  /// @brief Method IntToByteArray, addr 0x11c7d2c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11c7df8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Bcpg::Sig::KeyFlags* New_ctor(bool critical, int32_t flags);

  /// @brief Method .ctor, addr 0x11c7e40, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(bool critical, int32_t flags);

  /// @brief Method get_Flags, addr 0x11c7e8c, size 0x64, virtual false, abstract: false, final false
