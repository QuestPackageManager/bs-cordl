...
public:
  ...
  /// @brief Method IntToByteArray, addr 0x1336e14, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1336f28, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(bool critical, int32_t flags);

  /// @brief Method .ctor, addr 0x1336ee0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method get_Flags, addr 0x1336f74, size 0x64, virtual false, abstract: false, final false
