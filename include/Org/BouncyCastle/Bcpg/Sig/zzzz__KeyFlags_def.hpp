...
public:
  ...
  /// @brief Method IntToByteArray addr 0x1156adc size 0xcc virtual false final false
  ...
  /// @brief Method .ctor addr 0x1156ba8 size 0x48 virtual false final false
  inline void _ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Bcpg::Sig::KeyFlags* New_ctor(bool critical, int32_t flags);

  /// @brief Method .ctor addr 0x1156bf0 size 0x4c virtual false final false
  inline void _ctor(bool critical, int32_t flags);

  /// @brief Method get_Flags addr 0x1156c3c size 0x64 virtual false final false
