...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket*, "Org.BouncyCastle.Bcpg", "PublicKeyEncSessionPacket");
...
public:
  ...
  /// @brief Method Encode, addr 0x369ca24, size 0x194, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncSessionKey, addr 0x369ca1c, size 0x8, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket* New_ctor(int64_t keyId, ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm, ::ArrayW<::ArrayW<uint8_t>> data);
  ...
  /// @brief Method .ctor, addr 0x3697c3c, size 0x308, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x369c8ec, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(int64_t keyId, ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm, ::ArrayW<::ArrayW<uint8_t>> data);

  /// @brief Method get_Algorithm, addr 0x369ca14, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_KeyId, addr 0x369ca0c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_Version, addr 0x369ca04, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket) == 0x30, "Size mismatch!");
