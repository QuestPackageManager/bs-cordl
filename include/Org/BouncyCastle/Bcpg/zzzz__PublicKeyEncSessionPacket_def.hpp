...
public:
  ...
  /// @brief Method Encode, addr 0x26497e4, size 0x188, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncSessionKey, addr 0x26497dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26448bc, size 0x318, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x26496a8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Algorithm, addr 0x26497d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_KeyId, addr 0x26497cc, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_Version, addr 0x26497c4, size 0x8, virtual false, abstract: false, final false
