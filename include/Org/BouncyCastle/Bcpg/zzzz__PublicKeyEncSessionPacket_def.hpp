...
public:
  ...
  /// @brief Method Encode, addr 0x1341468, size 0x188, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream* bcpgOut);

  /// @brief Method GetEncSessionKey, addr 0x1341460, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133c3d0, size 0x364, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream* bcpgIn);

  /// @brief Method .ctor, addr 0x1341304, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Algorithm, addr 0x1341458, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm();

  /// @brief Method get_KeyId, addr 0x1341450, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_KeyId();

  /// @brief Method get_Version, addr 0x1341448, size 0x8, virtual false, abstract: false, final false
