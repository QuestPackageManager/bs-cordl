...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PublicKeyEncSessionPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PublicKeyEncSessionPacket(PublicKeyEncSessionPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PublicKeyEncSessionPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PublicKeyEncSessionPacket(PublicKeyEncSessionPacketconst&) = delete;
