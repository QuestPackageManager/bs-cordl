...
public:
  ...
  /// @brief Method Build, addr 0x2564f48, size 0x3e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2564ee8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> privateKeyInfo);

  /// @brief Method .ctor, addr 0x2564f20, size 0x28, virtual false, abstract: false, final false
