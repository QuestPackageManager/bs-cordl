...
public:
  ...
  /// @brief Method Build, addr 0x34fb860, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34fb838, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> privateKeyInfo);

  /// @brief Method .ctor, addr 0x34fb858, size 0x8, virtual false, abstract: false, final false
