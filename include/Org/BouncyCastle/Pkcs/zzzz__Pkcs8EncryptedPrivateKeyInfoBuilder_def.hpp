...
public:
  ...
  /// @brief Method Build, addr 0x1350eac, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1350e4c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> privateKeyInfo);

  /// @brief Method .ctor, addr 0x1350e84, size 0x28, virtual false, abstract: false, final false
