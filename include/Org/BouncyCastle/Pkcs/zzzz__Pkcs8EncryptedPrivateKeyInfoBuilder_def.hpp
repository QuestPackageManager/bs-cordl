...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder*, "Org.BouncyCastle.Pkcs", "Pkcs8EncryptedPrivateKeyInfoBuilder");
...
public:
  ...
  /// @brief Method Build, addr 0x35bae3c, size 0x3fc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfo* Build(::Org::BouncyCastle::Crypto::ICipherBuilder* encryptor);

  static inline ::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder* New_ctor(::ArrayW<uint8_t> privateKeyInfo);
  ...
  /// @brief Method .ctor, addr 0x35bae14, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> privateKeyInfo);

  /// @brief Method .ctor, addr 0x35bae34, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Pkcs8EncryptedPrivateKeyInfoBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Pkcs8EncryptedPrivateKeyInfoBuilder(Pkcs8EncryptedPrivateKeyInfoBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Pkcs8EncryptedPrivateKeyInfoBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Pkcs8EncryptedPrivateKeyInfoBuilder(Pkcs8EncryptedPrivateKeyInfoBuilderconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder) == 0x18, "Size mismatch!");
