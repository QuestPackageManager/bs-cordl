...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Pkcs12Utilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Pkcs12Utilities(Pkcs12Utilities&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Pkcs12Utilities", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Pkcs12Utilities(Pkcs12Utilitiesconst&) = delete;
