...
public:
  ...
  /// @brief Method Equals, addr 0x34bdb78, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x34bdb18, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34bdb08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> id);

  /// @brief Method .ctor, addr 0x34bdad8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* pubKey);

  /// @brief Method get_Id, addr 0x34bdb10, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x34bdc58, size 0x10c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetEnumerator, addr 0x34bdd64, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  static inline ::Org::BouncyCastle::Pkcs::Pkcs12Store_IgnoresCaseHashtable* New_ctor();

  /// @brief Method Remove, addr 0x34bdeb4, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34be63c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x34be594, size 0xa8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x34be10c, size 0x184, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(::StringW alias);

  /// @brief Method get_Keys, addr 0x34bde0c, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Keys();

  /// @brief Method get_Values, addr 0x34be4ec, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Values();

  /// @brief Convert to "::System::Collections::IEnumerable"
  constexpr ::System::Collections::IEnumerable* i___System__Collections__IEnumerable() noexcept;

  /// @brief Method set_Item, addr 0x34be290, size 0x25c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalculatePbeMac, addr 0x34b78c8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method ContainsAlias, addr 0x34b86a4, size 0x58, virtual false, abstract: false, final false
  inline bool ContainsAlias(::StringW alias);

  /// @brief Method CreateSubjectKeyID, addr 0x34b53ac, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CryptPbeData, addr 0x34b7a58, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteEntry, addr 0x34b9f6c, size 0x560, virtual false, abstract: false, final false
  inline void DeleteEntry(::StringW alias);

  /// @brief Method GetAliasesTable, addr 0x34b7ea4, size 0x710, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetAliasesTable();

  /// @brief Method GetCertificate, addr 0x34b86fc, size 0x254, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::X509CertificateEntry* GetCertificate(::StringW alias);

  /// @brief Method GetCertificateAlias, addr 0x34b8950, size 0x6e0, virtual false, abstract: false, final false
  inline ::StringW GetCertificateAlias(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method GetCertificateChain, addr 0x34b9030, size 0xa9c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKey, addr 0x34b7cac, size 0xe8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry* GetKey(::StringW alias);

  /// @brief Method IsCertificateEntry, addr 0x34b7d94, size 0x9c, virtual false, abstract: false, final false
  inline bool IsCertificateEntry(::StringW alias);

  /// @brief Method IsEntryOfType, addr 0x34ba4cc, size 0x104, virtual false, abstract: false, final false
  inline bool IsEntryOfType(::StringW alias, ::System::Type* entryType);

  /// @brief Method IsKeyEntry, addr 0x34b7e30, size 0x74, virtual false, abstract: false, final false
  inline bool IsKeyEntry(::StringW alias);

  /// @brief Method Load, addr 0x34b56b8, size 0x1958, virtual false, abstract: false, final false
  inline void Load(::System::IO::Stream* input, ::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method LoadKeyBag, addr 0x34b7010, size 0x86c, virtual true, abstract: false, final false
  inline void LoadKeyBag(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo, ::Org::BouncyCastle::Asn1::Asn1Set* bagAttributes);

  /// @brief Method LoadPkcs8ShroudedKeyBag, addr 0x34b787c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Save, addr 0x34ba684, size 0x3454, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCertificateEntry, addr 0x34b9acc, size 0x21c, virtual false, abstract: false, final false
  inline void SetCertificateEntry(::StringW alias, ::Org::BouncyCastle::Pkcs::X509CertificateEntry* certEntry);

  /// @brief Method SetKeyEntry, addr 0x34b9ce8, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method Size, addr 0x34ba5d0, size 0x4, virtual false, abstract: false, final false
  inline int32_t Size();
  ...
  /// @brief Method .ctor, addr 0x34b561c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34b5688, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, ::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method .ctor, addr 0x34b5424, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34b5518, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aliases, addr 0x34b85b4, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* get_Aliases();

  /// @brief Method get_Count, addr 0x34ba5d4, size 0xb0, virtual false, abstract: false, final false
  inline int32_t get_Count();
