...
public:
  ...
  /// @brief Method Equals, addr 0x2567bcc, size 0xd8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2567b70, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2567b40, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> id);

  /// @brief Method .ctor, addr 0x2567afc, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* pubKey);

  /// @brief Method get_Id, addr 0x2567b68, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x2567ca4, size 0x108, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetEnumerator, addr 0x2567dac, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  static inline ::Org::BouncyCastle::Pkcs::Pkcs12Store_IgnoresCaseHashtable* New_ctor();

  /// @brief Method Remove, addr 0x2567ef4, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x256868c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x25685e8, size 0xa4, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x2568154, size 0x18c, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(::StringW alias);

  /// @brief Method get_Keys, addr 0x2567e50, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Keys();

  /// @brief Method get_Values, addr 0x2568544, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Values();

  /// @brief Convert to "::System::Collections::IEnumerable"
  constexpr ::System::Collections::IEnumerable* i___System__Collections__IEnumerable() noexcept;

  /// @brief Method set_Item, addr 0x25682e0, size 0x264, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalculatePbeMac, addr 0x25613d0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ContainsAlias, addr 0x2562200, size 0x58, virtual false, abstract: false, final false
  inline bool ContainsAlias(::StringW alias);

  /// @brief Method CreateSubjectKeyID, addr 0x255ede4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method CryptPbeData, addr 0x2561554, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteEntry, addr 0x2563b54, size 0x55c, virtual false, abstract: false, final false
  inline void DeleteEntry(::StringW alias);

  /// @brief Method GetAliasesTable, addr 0x256198c, size 0x78c, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetAliasesTable();

  /// @brief Method GetCertificate, addr 0x2562258, size 0x25c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::X509CertificateEntry* GetCertificate(::StringW alias);

  /// @brief Method GetCertificateAlias, addr 0x25624b4, size 0x764, virtual false, abstract: false, final false
  inline ::StringW GetCertificateAlias(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method GetCertificateChain, addr 0x2562c18, size 0xaac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKey, addr 0x25617a0, size 0xdc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry* GetKey(::StringW alias);

  /// @brief Method IsCertificateEntry, addr 0x256187c, size 0x9c, virtual false, abstract: false, final false
  inline bool IsCertificateEntry(::StringW alias);

  /// @brief Method IsEntryOfType, addr 0x25640b0, size 0x118, virtual false, abstract: false, final false
  inline bool IsEntryOfType(::StringW alias, ::System::Type* entryType);

  /// @brief Method IsKeyEntry, addr 0x2561918, size 0x74, virtual false, abstract: false, final false
  inline bool IsKeyEntry(::StringW alias);

  /// @brief Method Load, addr 0x255f0e4, size 0x19e0, virtual false, abstract: false, final false
  inline void Load(::System::IO::Stream* input, ::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method LoadKeyBag, addr 0x2560ac4, size 0x8c0, virtual true, abstract: false, final false
  inline void LoadKeyBag(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo, ::Org::BouncyCastle::Asn1::Asn1Set* bagAttributes);

  /// @brief Method LoadPkcs8ShroudedKeyBag, addr 0x2561384, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Save, addr 0x2564278, size 0x3884, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCertificateEntry, addr 0x25636c4, size 0x214, virtual false, abstract: false, final false
  inline void SetCertificateEntry(::StringW alias, ::Org::BouncyCastle::Pkcs::X509CertificateEntry* certEntry);

  /// @brief Method SetKeyEntry, addr 0x25638d8, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method Size, addr 0x25641c8, size 0x4, virtual false, abstract: false, final false
  inline int32_t Size();
  ...
  /// @brief Method .ctor, addr 0x255f04c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x255f0b4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input, ::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method .ctor, addr 0x255ee54, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x255ef48, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aliases, addr 0x2562118, size 0xe8, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* get_Aliases();

  /// @brief Method get_Count, addr 0x25641cc, size 0xac, virtual false, abstract: false, final false
  inline int32_t get_Count();
