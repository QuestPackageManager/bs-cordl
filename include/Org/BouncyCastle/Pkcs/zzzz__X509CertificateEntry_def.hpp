...
public:
  ...
  /// @brief Method Equals, addr 0x34962ac, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x3496358, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34961d0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x349624c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert, ::System::Collections::Hashtable* attributes);

  /// @brief Method .ctor, addr 0x3496278, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert, ::System::Collections::IDictionary* attributes);

  /// @brief Method get_Certificate, addr 0x34962a4, size 0x8, virtual false, abstract: false, final false
