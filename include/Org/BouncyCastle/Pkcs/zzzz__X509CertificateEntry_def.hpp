...
public:
  ...
  /// @brief Method Equals, addr 0x25667dc, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2566880, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2566704, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x256677c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert, ::System::Collections::Hashtable* attributes);

  /// @brief Method .ctor, addr 0x25667a8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* cert, ::System::Collections::IDictionary* attributes);

  /// @brief Method get_Certificate, addr 0x25667d4, size 0x8, virtual false, abstract: false, final false
