...
public:
  // Declarations
  /// @brief Method CreateEncryptedPrivateKeyInfo, addr 0x2554220, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateEncryptedPrivateKeyInfo, addr 0x2553438, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateEncryptedPrivateKeyInfo, addr 0x2554274, size 0x294, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* CreateEncryptedPrivateKeyInfo(::StringW algorithm, ::ArrayW<char16_t, ::Array<char16_t>*> passPhrase,
                                                                                                        ::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterationCount,
                                                                                                        ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* keyInfo);

  /// @brief Method CreateEncryptedPrivateKeyInfo, addr 0x2554508, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateEncryptedPrivateKeyInfo, addr 0x255456c, size 0x2e4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* CreateEncryptedPrivateKeyInfo(::Org::BouncyCastle::Asn1::DerObjectIdentifier* cipherAlgorithm,
                                                                                                        ::Org::BouncyCastle::Asn1::DerObjectIdentifier* prfAlgorithm,
                                                                                                        ::ArrayW<char16_t, ::Array<char16_t>*> passPhrase, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt,
                                                                                                        int32_t iterationCount, ::Org::BouncyCastle::Security::SecureRandom* random,
  ...
  /// @brief Method .ctor, addr 0x2554218, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
