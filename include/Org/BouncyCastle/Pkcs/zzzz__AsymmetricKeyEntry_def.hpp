...
public:
  ...
  /// @brief Method Equals, addr 0x2551a10, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2551ab4, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2551944, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* key);

  /// @brief Method .ctor, addr 0x25519b8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* key, ::System::Collections::Hashtable* attributes);

  /// @brief Method .ctor, addr 0x25519e0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* key, ::System::Collections::IDictionary* attributes);

  /// @brief Method get_Key, addr 0x2551a08, size 0x8, virtual false, abstract: false, final false
