...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfo*, "Org.BouncyCastle.Pkcs", "Pkcs8EncryptedPrivateKeyInfo");
...
public:
  ...
  /// @brief Method DecryptPrivateKeyInfo, addr 0x35ba9ac, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEncoded, addr 0x35ba994, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  /// @brief Method GetEncryptedData, addr 0x35ba96c, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncryptedData();

  static inline ::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfo* New_ctor(::ArrayW<uint8_t> encryptedPrivateKeyInfo);
  ...
  /// @brief Method ToAsn1Structure, addr 0x35ba964, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ba948, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> encryptedPrivateKeyInfo);

  /// @brief Method .ctor, addr 0x35ba940, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* encryptedPrivateKeyInfo);

  /// @brief Method parseBytes, addr 0x35ba7fc, size 0x120, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* parseBytes(::ArrayW<uint8_t> pkcs8Encoding);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Pkcs8EncryptedPrivateKeyInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Pkcs8EncryptedPrivateKeyInfo(Pkcs8EncryptedPrivateKeyInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Pkcs8EncryptedPrivateKeyInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Pkcs8EncryptedPrivateKeyInfo(Pkcs8EncryptedPrivateKeyInfoconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfo) == 0x18, "Size mismatch!");
