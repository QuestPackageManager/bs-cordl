...
public:
  ...
  /// @brief Method DecryptPrivateKeyInfo, addr 0x2564ac8, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEncoded, addr 0x2564aac, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetEncryptedData, addr 0x2564a90, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x2564a88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2564a54, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> encryptedPrivateKeyInfo);

  /// @brief Method .ctor, addr 0x2564a2c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* encryptedPrivateKeyInfo);

  /// @brief Method parseBytes, addr 0x256490c, size 0x118, virtual false, abstract: false, final false
