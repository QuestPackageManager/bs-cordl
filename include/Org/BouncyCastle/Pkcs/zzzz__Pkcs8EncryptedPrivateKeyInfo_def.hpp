...
public:
  ...
  /// @brief Method DecryptPrivateKeyInfo, addr 0x35b8624, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEncoded, addr 0x35b860c, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  /// @brief Method GetEncryptedData, addr 0x35b85e4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x35b85dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b85c0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> encryptedPrivateKeyInfo);

  /// @brief Method .ctor, addr 0x35b85b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo* encryptedPrivateKeyInfo);

  /// @brief Method parseBytes, addr 0x35b8474, size 0x120, virtual false, abstract: false, final false
