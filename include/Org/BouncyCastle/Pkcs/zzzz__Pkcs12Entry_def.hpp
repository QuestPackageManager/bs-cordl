...
/// @brief Method GetBagAttribute, addr 0x34ec9b8, size 0x10c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetBagAttribute(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetBagAttribute, addr 0x34ecac4, size 0x104, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetBagAttribute(::StringW  oid) ;

/// @brief Method GetBagAttributeKeys, addr 0x34ecbc8, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34ec4a8, size 0x510, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::IDictionary*  attributes) ;

/// @brief Method get_BagAttributeKeys, addr 0x34ecef8, size 0xe8, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerable* get_BagAttributeKeys() ;

/// @brief Method get_Item, addr 0x34ecce8, size 0x10c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Item(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method get_Item, addr 0x34ecdf4, size 0x104, virtual false, abstract: false, final false
