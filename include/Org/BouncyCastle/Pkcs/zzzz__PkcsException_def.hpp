...
public:
  ...
  /// @brief Method .ctor, addr 0x1257318, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1256e48, size 0x70, virtual false, abstract: false, final false
