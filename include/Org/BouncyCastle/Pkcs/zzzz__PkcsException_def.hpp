...
public:
  ...
  /// @brief Method .ctor, addr 0x2524c4c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2524794, size 0x70, virtual false, abstract: false, final false
