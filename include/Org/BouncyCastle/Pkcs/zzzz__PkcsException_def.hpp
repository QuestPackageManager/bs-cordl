...
public:
  ...
  /// @brief Method .ctor, addr 0x2565370, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2564eb8, size 0x70, virtual false, abstract: false, final false
