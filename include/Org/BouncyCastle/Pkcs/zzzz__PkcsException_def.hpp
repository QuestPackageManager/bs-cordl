...
public:
  ...
  /// @brief Method .ctor, addr 0x13512ac, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1350ddc, size 0x70, virtual false, abstract: false, final false
