...
public:
  ...
  /// @brief Method .ctor, addr 0x3494ef0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3494568, size 0x24, virtual false, abstract: false, final false
