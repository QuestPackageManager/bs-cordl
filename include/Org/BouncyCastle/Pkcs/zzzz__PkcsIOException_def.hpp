...
public:
  ...
  /// @brief Method .ctor, addr 0x34bf734, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34bedac, size 0x24, virtual false, abstract: false, final false
