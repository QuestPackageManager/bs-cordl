...
public:
  ...
  /// @brief Method .ctor, addr 0x2565428, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2564ab4, size 0x8, virtual false, abstract: false, final false
