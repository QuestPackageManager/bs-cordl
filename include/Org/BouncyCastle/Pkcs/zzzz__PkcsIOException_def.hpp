...
public:
  ...
  /// @brief Method .ctor, addr 0x2564064, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25636f0, size 0x8, virtual false, abstract: false, final false
