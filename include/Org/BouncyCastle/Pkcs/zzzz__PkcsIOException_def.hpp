...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkcs::PkcsIOException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkcs::PkcsIOException*, "Org.BouncyCastle.Pkcs", "PkcsIOException");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkcsIOException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkcsIOException(PkcsIOException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkcsIOException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkcsIOException(PkcsIOExceptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Pkcs::PkcsIOException) == 0x90, "Size mismatch!");
