...
public:
  ...
  /// @brief Method .ctor, addr 0x117d7fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x117ce5c, size 0x8, virtual false, abstract: false, final false
