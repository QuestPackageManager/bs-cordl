...
public:
  ...
  /// @brief Method .ctor, addr 0x2565a60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25650ec, size 0x8, virtual false, abstract: false, final false
