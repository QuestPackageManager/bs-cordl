...
public:
  ...
  /// @brief Method .ctor, addr 0x1351314, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1350974, size 0x8, virtual false, abstract: false, final false
