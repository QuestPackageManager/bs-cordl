...
public:
  ...
  /// @brief Method .ctor, addr 0x35b8f1c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35b8594, size 0x24, virtual false, abstract: false, final false
