...
public:
  ...
  /// @brief Method .ctor, addr 0x2565398, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2564a24, size 0x8, virtual false, abstract: false, final false
