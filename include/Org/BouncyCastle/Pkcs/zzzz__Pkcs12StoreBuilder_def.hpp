...
public:
  ...
  /// @brief Method Build, addr 0x35b7f00, size 0x8c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::Pkcs12Store* Build();

  static inline ::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder* New_ctor();

  /// @brief Method SetCertAlgorithm, addr 0x35b7f8c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder* SetCertAlgorithm(::Org::BouncyCastle::Asn1::DerObjectIdentifier* certAlgorithm);

  /// @brief Method SetKeyAlgorithm, addr 0x35b7f94, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder* SetKeyAlgorithm(::Org::BouncyCastle::Asn1::DerObjectIdentifier* keyAlgorithm);

  /// @brief Method SetKeyAlgorithm, addr 0x35b7f9c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUseDerEncoding, addr 0x35b7fa8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b7e90, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
