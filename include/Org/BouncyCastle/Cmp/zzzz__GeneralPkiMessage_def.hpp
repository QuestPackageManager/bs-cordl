...
public:
  ...
  /// @brief Method ParseBytes, addr 0x1345100, size 0x18, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::PkiMessage* ParseBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> encoding);

  /// @brief Method ToAsn1Structure, addr 0x13451ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1345140, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> encoding);

  /// @brief Method .ctor, addr 0x1345118, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiMessage* pkiMessage);

  /// @brief Method get_Body, addr 0x13451a0, size 0x20, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiBody* get_Body();

  /// @brief Method get_HasProtection, addr 0x13451c0, size 0x2c, virtual false, abstract: false, final false
  inline bool get_HasProtection();

  /// @brief Method get_Header, addr 0x1345180, size 0x20, virtual false, abstract: false, final false
