...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cmp::RevocationDetails*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cmp::RevocationDetails*, "Org.BouncyCastle.Cmp", "RevocationDetails");
...
public:
  ...
  /// @brief Method ToASN1Structure, addr 0x36a45d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a452c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::RevDetails* revDetails);

  /// @brief Method get_Issuer, addr 0x36a4564, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Issuer();

  /// @brief Method get_SerialNumber, addr 0x36a4594, size 0x3c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber();

  /// @brief Method get_Subject, addr 0x36a4534, size 0x30, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RevocationDetails", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RevocationDetails(RevocationDetails&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RevocationDetails", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RevocationDetails(RevocationDetailsconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cmp::RevocationDetails) == 0x18, "Size mismatch!");
