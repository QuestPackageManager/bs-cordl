...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder* (::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::*)(::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo*)>(&::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::SetPublicKey)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x35e5d98;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder* (::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::*)(::Org::BouncyCastle::Asn1::X509::X509Name*)>(&::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::SetIssuer)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x35e5dc8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder* (::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::*)(::Org::BouncyCastle::Math::BigInteger*)>(&::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::SetSerialNumber)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x35e5df8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder* (::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::*)(::Org::BouncyCastle::Asn1::X509::X509Name*)>(&::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::SetSubject)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x35e5e90;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Cmp::RevocationDetails* (::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::*)()>(&::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::Build)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x35e5ec0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::*)()>(&::Org::BouncyCastle::Cmp::RevocationDetailsBuilder::_ctor)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x35e5f5c;
...
return ::cordl_internals::RunMethodRethrow<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder*, false>(this, ___internal_method, publicKey);
}
...
return ::cordl_internals::RunMethodRethrow<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder*, false>(this, ___internal_method, issuer);
}
...
return ::cordl_internals::RunMethodRethrow<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder*, false>(this, ___internal_method, serialNumber);
}
...
return ::cordl_internals::RunMethodRethrow<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder*, false>(this, ___internal_method, subject);
}
...
return ::cordl_internals::RunMethodRethrow<::Org::BouncyCastle::Cmp::RevocationDetails*, false>(this, ___internal_method);
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Org::BouncyCastle::Cmp::RevocationDetailsBuilder*>());
}
// Ctor Parameters []
