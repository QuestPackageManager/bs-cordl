...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cmp::RevocationDetailsBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cmp::RevocationDetailsBuilder*, "Org.BouncyCastle.Cmp", "RevocationDetailsBuilder");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RevocationDetailsBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RevocationDetailsBuilder(RevocationDetailsBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RevocationDetailsBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RevocationDetailsBuilder(RevocationDetailsBuilderconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cmp::RevocationDetailsBuilder) == 0x18, "Size mismatch!");
