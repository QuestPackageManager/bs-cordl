...
public:
  ...
  /// @brief Method IsVerified, addr 0x357bfb8, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x357b820, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CertRequestId, addr 0x357bf8c, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_CertRequestId();

  /// @brief Method get_PkiStatusInfo, addr 0x357bf70, size 0x1c, virtual false, abstract: false, final false
