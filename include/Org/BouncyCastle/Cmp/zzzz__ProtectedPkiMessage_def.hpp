...
public:
  ...
  /// @brief Method GetCertificates, addr 0x2649580, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method Process, addr 0x2649868, size 0x2d8, virtual false, abstract: false, final false
  inline ::System::Object* Process(::Org::BouncyCastle::Crypto::IStreamCalculator* streamCalculator);

  /// @brief Method ToAsn1Message, addr 0x26494d0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiMessage* ToAsn1Message();

  /// @brief Method Verify, addr 0x2649b40, size 0x2e4, virtual false, abstract: false, final false
  inline bool Verify(::Org::BouncyCastle::Crmf::PKMacBuilder* pkMacBuilder, ::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method Verify, addr 0x26496e8, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26493f4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiMessage* pkiMessage);

  /// @brief Method .ctor, addr 0x2649360, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Cmp::GeneralPkiMessage* pkiMessage);

  /// @brief Method get_Body, addr 0x26494b0, size 0x20, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiBody* get_Body();

  /// @brief Method get_HasPasswordBasedMacProtected, addr 0x26494d8, size 0xa8, virtual false, abstract: false, final false
  inline bool get_HasPasswordBasedMacProtected();

  /// @brief Method get_Header, addr 0x2649490, size 0x20, virtual false, abstract: false, final false
