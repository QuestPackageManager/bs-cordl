...
public:
  ...
  /// @brief Method GetStatusMessages, addr 0x13444cc, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x13444c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1344470, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::CertConfirmContent* content);

  /// @brief Method .ctor, addr 0x1344498, size 0x2c, virtual false, abstract: false, final false
