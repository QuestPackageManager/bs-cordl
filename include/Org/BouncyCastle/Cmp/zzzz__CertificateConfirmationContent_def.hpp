...
public:
  ...
  /// @brief Method GetStatusMessages, addr 0x143e460, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x143e458, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x143e404, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::CertConfirmContent* content);

  /// @brief Method .ctor, addr 0x143e42c, size 0x2c, virtual false, abstract: false, final false
