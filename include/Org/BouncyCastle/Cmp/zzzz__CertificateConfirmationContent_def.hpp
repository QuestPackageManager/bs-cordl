...
/// @brief Method GetStatusMessages, addr 0x35a5e90, size 0x124, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Cmp::CertificateConfirmationContent* New_ctor(::Org::BouncyCastle::Asn1::Cmp::CertConfirmContent*  content, ::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder*  digestAlgFinder) ;

/// @brief Method ToAsn1Structure, addr 0x35a5e88, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35a5e78, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::CertConfirmContent*  content) ;

/// @brief Method .ctor, addr 0x35a5e80, size 0x8, virtual false, abstract: false, final false
