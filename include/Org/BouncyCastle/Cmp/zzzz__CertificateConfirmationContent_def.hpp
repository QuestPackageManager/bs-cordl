...
public:
  ...
  /// @brief Method GetStatusMessages, addr 0x264c16c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x264c164, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264c110, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::CertConfirmContent* content);

  /// @brief Method .ctor, addr 0x264c138, size 0x2c, virtual false, abstract: false, final false
