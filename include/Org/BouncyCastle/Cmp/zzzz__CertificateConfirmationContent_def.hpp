...
public:
  ...
  /// @brief Method GetStatusMessages, addr 0x264c7a4, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x264c79c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264c748, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::CertConfirmContent* content);

  /// @brief Method .ctor, addr 0x264c770, size 0x2c, virtual false, abstract: false, final false
