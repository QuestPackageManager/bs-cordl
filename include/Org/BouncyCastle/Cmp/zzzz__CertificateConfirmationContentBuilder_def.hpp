...
public:
  ...
  /// @brief Method AddAcceptedCertificate, addr 0x264c310, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x264c438, size 0x460, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264c230, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264c28c, size 0x84, virtual false, abstract: false, final false
