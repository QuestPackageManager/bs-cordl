...
public:
  ...
  /// @brief Method AddAcceptedCertificate, addr 0x1246484, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x12465ac, size 0x470, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x124639c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1246400, size 0x84, virtual false, abstract: false, final false
