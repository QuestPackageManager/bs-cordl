...
public:
  ...
  /// @brief Method AddAcceptedCertificate, addr 0x264c9d8, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x264cb00, size 0x460, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264c8f8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264c954, size 0x84, virtual false, abstract: false, final false
