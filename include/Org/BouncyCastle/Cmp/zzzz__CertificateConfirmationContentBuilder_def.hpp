...
public:
  ...
  /// @brief Method AddAcceptedCertificate, addr 0x36a1cac, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x36a1dd8, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a1bdc, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36a1c30, size 0x7c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificateConfirmationContentBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificateConfirmationContentBuilder(CertificateConfirmationContentBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificateConfirmationContentBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificateConfirmationContentBuilder(CertificateConfirmationContentBuilderconst&) = delete;
