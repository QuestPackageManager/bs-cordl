...
public:
  ...
  /// @brief Method .ctor, addr 0x35e2fe8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35e2c70, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35e3040, size 0x74, virtual false, abstract: false, final false
