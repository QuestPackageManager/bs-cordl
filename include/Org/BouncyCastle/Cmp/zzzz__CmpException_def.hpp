...
public:
  ...
  /// @brief Method .ctor, addr 0x264cc14, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264c898, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x264cc6c, size 0x70, virtual false, abstract: false, final false
