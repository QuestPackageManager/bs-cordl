...
public:
  // Declarations
  /// @brief Method AsUnsignedByteArray, addr 0x116d244, size 0x14, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray, addr 0x116d258, size 0x10c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(int32_t length, ::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray, addr 0x116d364, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRandomBigInteger, addr 0x116d4b0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRandomInRange, addr 0x116d524, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnsignedByteLength, addr 0x116d738, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x116d768, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
