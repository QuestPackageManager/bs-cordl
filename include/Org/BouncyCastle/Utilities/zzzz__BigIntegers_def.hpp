...
public:
  // Declarations
  /// @brief Method AsUnsignedByteArray, addr 0x3541928, size 0x114, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(int32_t length, ::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray, addr 0x3541914, size 0x14, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray, addr 0x3541a3c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRandomBigInteger, addr 0x3541b80, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRandomInRange, addr 0x3541bf0, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnsignedByteLength, addr 0x3541e08, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3541e38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
