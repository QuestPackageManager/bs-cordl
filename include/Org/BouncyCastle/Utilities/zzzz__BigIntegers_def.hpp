...
public:
  // Declarations
  /// @brief Method AsUnsignedByteArray addr 0x10fcffc size 0x14 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray addr 0x10fd010 size 0x10c virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(int32_t length, ::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray addr 0x10fd11c size 0x14c virtual false final false
  ...
  /// @brief Method CreateRandomBigInteger addr 0x10fd268 size 0x74 virtual false final false
  ...
  /// @brief Method CreateRandomInRange addr 0x10fd2dc size 0x214 virtual false final false
  ...
  /// @brief Method GetUnsignedByteLength addr 0x10fd4f0 size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10fd520 size 0x8 virtual false final false
  inline void _ctor();
