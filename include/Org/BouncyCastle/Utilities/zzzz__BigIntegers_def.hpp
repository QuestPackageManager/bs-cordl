...
public:
  // Declarations
  /// @brief Method AsUnsignedByteArray, addr 0x35170e4, size 0x114, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(int32_t length, ::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray, addr 0x35170d0, size 0x14, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray, addr 0x35171f8, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRandomBigInteger, addr 0x351733c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRandomInRange, addr 0x35173ac, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnsignedByteLength, addr 0x35175c4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35175f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
