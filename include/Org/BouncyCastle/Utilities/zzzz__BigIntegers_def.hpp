...
public:
  // Declarations
  /// @brief Method AsUnsignedByteArray, addr 0x25e7b04, size 0x108, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(int32_t length, ::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray, addr 0x25e7af0, size 0x14, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> AsUnsignedByteArray(::Org::BouncyCastle::Math::BigInteger* n);

  /// @brief Method AsUnsignedByteArray, addr 0x25e7c0c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRandomBigInteger, addr 0x25e7d54, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRandomInRange, addr 0x25e7dc0, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnsignedByteLength, addr 0x25e7fd8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25e8008, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
