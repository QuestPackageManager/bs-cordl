...
public:
  ...
  /// @brief Method LoadObject, addr 0x2550db0, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPemObject, addr 0x2550c5c, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2550be0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextReader* reader);

  /// @brief Method get_Reader, addr 0x2550c54, size 0x8, virtual false, abstract: false, final false
