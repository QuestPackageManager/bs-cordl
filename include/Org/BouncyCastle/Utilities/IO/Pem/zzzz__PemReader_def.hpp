...
public:
  ...
  /// @brief Method LoadObject, addr 0x34ab554, size 0x3e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPemObject, addr 0x34ab3e8, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34ab388, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextReader* reader);

  /// @brief Method get_Reader, addr 0x34ab3e0, size 0x8, virtual false, abstract: false, final false
