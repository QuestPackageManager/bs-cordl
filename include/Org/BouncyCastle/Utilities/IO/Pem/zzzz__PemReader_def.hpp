...
public:
  ...
  /// @brief Method LoadObject, addr 0x2551438, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPemObject, addr 0x25512e4, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2551268, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextReader* reader);

  /// @brief Method get_Reader, addr 0x25512dc, size 0x8, virtual false, abstract: false, final false
