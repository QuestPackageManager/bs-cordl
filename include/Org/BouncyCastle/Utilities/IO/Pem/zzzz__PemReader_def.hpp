...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::Pem::PemReader*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::Pem::PemReader*, "Org.BouncyCastle.Utilities.IO.Pem", "PemReader");
...
public:
  ...
  /// @brief Method LoadObject, addr 0x35a70c4, size 0x3e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPemObject, addr 0x35a6f58, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a6ef8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextReader* reader);

  /// @brief Method get_Reader, addr 0x35a6f50, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::Pem::PemReader) == 0x18, "Size mismatch!");
