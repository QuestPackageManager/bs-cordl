...
public:
  ...
  /// @brief Method GetOutputSize, addr 0x1335998, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEncoded, addr 0x1336450, size 0xe0, virtual false, abstract: false, final false
  inline void WriteEncoded(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteObject, addr 0x1335e70, size 0x54c, virtual false, abstract: false, final false
  inline void WriteObject(::Org::BouncyCastle::Utilities::IO::Pem::PemObjectGenerator* objGen);

  /// @brief Method WritePostEncapsulationBoundary, addr 0x1336530, size 0x94, virtual false, abstract: false, final false
  inline void WritePostEncapsulationBoundary(::StringW type);

  /// @brief Method WritePreEncapsulationBoundary, addr 0x13363bc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1335894, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextWriter* writer);

  /// @brief Method get_Writer, addr 0x1335990, size 0x8, virtual false, abstract: false, final false
