...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::Pem::PemWriter*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::Pem::PemWriter*, "Org.BouncyCastle.Utilities.IO.Pem", "PemWriter");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_buf, put = __cordl_internal_set_buf)) ::ArrayW<char16_t> buf;
  ...
  /// @brief Method GetOutputSize, addr 0x35a77c8, size 0x4b0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEncoded, addr 0x35a822c, size 0xe0, virtual false, abstract: false, final false
  inline void WriteEncoded(::ArrayW<uint8_t> bytes);

  /// @brief Method WriteObject, addr 0x35a7c78, size 0x518, virtual false, abstract: false, final false
  inline void WriteObject(::Org::BouncyCastle::Utilities::IO::Pem::PemObjectGenerator* objGen);

  /// @brief Method WritePostEncapsulationBoundary, addr 0x35a830c, size 0x9c, virtual false, abstract: false, final false
  inline void WritePostEncapsulationBoundary(::StringW type);

  /// @brief Method WritePreEncapsulationBoundary, addr 0x35a8190, size 0x9c, virtual false, abstract: false, final false
  inline void WritePreEncapsulationBoundary(::StringW type);

  constexpr ::ArrayW<char16_t> const& __cordl_internal_get_buf() const;

  constexpr ::ArrayW<char16_t>& __cordl_internal_get_buf();
  ...
  constexpr void __cordl_internal_set_buf(::ArrayW<char16_t> value);
  ...
  /// @brief Method .ctor, addr 0x35a76cc, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextWriter* writer);

  /// @brief Method get_Writer, addr 0x35a77c0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::Pem::PemWriter) == 0x28, "Size mismatch!");
