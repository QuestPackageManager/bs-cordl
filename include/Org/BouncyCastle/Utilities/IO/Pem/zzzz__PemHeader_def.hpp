...
public:
  ...
  /// @brief Method Equals, addr 0x25de234, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x25de1c4, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x25de21c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25de188, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW val);

  /// @brief Method get_Name, addr 0x25de1b4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x25de1bc, size 0x8, virtual true, abstract: false, final false
