...
public:
  ...
  /// @brief Method Equals, addr 0x362f940, size 0xfc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x362f8dc, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x362f92c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x362f8c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW val);

  /// @brief Method get_Name, addr 0x362f8cc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x362f8d4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PemHeader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PemHeader(PemHeader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PemHeader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PemHeader(PemHeaderconst&) = delete;
