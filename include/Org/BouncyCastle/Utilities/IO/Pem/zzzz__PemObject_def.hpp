...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*, "Org.BouncyCastle.Utilities.IO.Pem", "PemObject");
...
public:
  // Declarations
  __declspec(property(get = get_Content)) ::ArrayW<uint8_t> Content;
  ...
  __declspec(property(get = __cordl_internal_get_content, put = __cordl_internal_set_content)) ::ArrayW<uint8_t> content;
  ...
  /// @brief Method Generate, addr 0x362fb54, size 0x4, virtual true, abstract: false, final true
  ...
  static inline ::Org::BouncyCastle::Utilities::IO::Pem::PemObject* New_ctor(::StringW type, ::System::Collections::IList* headers, ::ArrayW<uint8_t> content);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_content() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_content();

  constexpr ::System::Collections::IList* const& __cordl_internal_get_headers() const;
  ...
  constexpr void __cordl_internal_set_content(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x362fa3c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW type, ::ArrayW<uint8_t> content);

  /// @brief Method .ctor, addr 0x362fab8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW type, ::System::Collections::IList* headers, ::ArrayW<uint8_t> content);

  /// @brief Method get_Content, addr 0x362fb4c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Content();

  /// @brief Method get_Headers, addr 0x362fb44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* get_Headers();

  /// @brief Method get_Type, addr 0x362fb3c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PemObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PemObject(PemObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PemObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PemObject(PemObjectconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::Pem::PemObject) == 0x28, "Size mismatch!");
