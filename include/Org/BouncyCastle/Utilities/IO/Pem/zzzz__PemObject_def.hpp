...
public:
  ...
  /// @brief Method Generate, addr 0x25d8cd0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25d8bb4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW type, ::ArrayW<uint8_t, ::Array<uint8_t>*> content);

  /// @brief Method .ctor, addr 0x25d8c2c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW type, ::System::Collections::IList* headers, ::ArrayW<uint8_t, ::Array<uint8_t>*> content);

  /// @brief Method get_Content, addr 0x25d8cc8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Content();

  /// @brief Method get_Headers, addr 0x25d8cc0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* get_Headers();

  /// @brief Method get_Type, addr 0x25d8cb8, size 0x8, virtual false, abstract: false, final false
