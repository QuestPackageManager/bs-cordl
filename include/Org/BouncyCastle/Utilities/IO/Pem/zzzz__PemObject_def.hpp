...
public:
  ...
  /// @brief Method Generate, addr 0x3570578, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3570460, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW type, ::ArrayW<uint8_t, ::Array<uint8_t>*> content);

  /// @brief Method .ctor, addr 0x35704dc, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW type, ::System::Collections::IList* headers, ::ArrayW<uint8_t, ::Array<uint8_t>*> content);

  /// @brief Method get_Content, addr 0x3570570, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Content();

  /// @brief Method get_Headers, addr 0x3570568, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* get_Headers();

  /// @brief Method get_Type, addr 0x3570560, size 0x8, virtual false, abstract: false, final false
