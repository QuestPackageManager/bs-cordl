...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::Pem::PemObjectParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::Pem::PemObjectParser*, "Org.BouncyCastle.Utilities.IO.Pem", "PemObjectParser");
// Dependencies
namespace Org::BouncyCastle::Utilities::IO::Pem {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "PemObjectParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PemObjectParser(PemObjectParserconst&) = delete;
