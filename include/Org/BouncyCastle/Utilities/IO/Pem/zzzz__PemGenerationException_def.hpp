...
public:
  ...
  /// @brief Method .ctor, addr 0x35701b0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3570208, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3570274, size 0x74, virtual false, abstract: false, final false
