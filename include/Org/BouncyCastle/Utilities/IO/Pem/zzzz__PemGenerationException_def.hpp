...
public:
  ...
  /// @brief Method .ctor, addr 0x25d9ce8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25d9d40, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25d9da8, size 0x70, virtual false, abstract: false, final false
