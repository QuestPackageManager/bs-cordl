...
public:
  ...
  /// @brief Method .ctor, addr 0x11f5d30, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11f5d88, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11f5df0, size 0x70, virtual false, abstract: false, final false
