...
public:
  ...
  /// @brief Method .ctor, addr 0x25d9c58, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25d9cb0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25d9d18, size 0x70, virtual false, abstract: false, final false
