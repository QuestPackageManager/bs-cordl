...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Utilities::IO::PushbackStream::*)(::System::IO::Stream*)>(
  ...
  constexpr static std::size_t addrs = 0x362d804;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), { ".ctor", {}, { ::i2c::type_of<::System::IO::Stream*>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::Org::BouncyCastle::Utilities::IO::PushbackStream::*)()>(&::Org::BouncyCastle::Utilities::IO::PushbackStream::ReadByte)> {
  ...
  constexpr static std::size_t addrs = 0x362d814;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), { ::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), 37 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::Org::BouncyCastle::Utilities::IO::PushbackStream::*)(::ArrayW<uint8_t>, int32_t, int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x362d850;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), { ::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), 35 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Utilities::IO::PushbackStream::*)(int32_t)>(&::Org::BouncyCastle::Utilities::IO::PushbackStream::Unread)> {
  ...
  constexpr static std::size_t addrs = 0x362d8bc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), { ::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), 42 }));
    return ___internal_method;
  }
};
...
inline int32_t Org::BouncyCastle::Utilities::IO::PushbackStream::ReadByte() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), 37 })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method);
}
inline int32_t Org::BouncyCastle::Utilities::IO::PushbackStream::Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), 35 })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method, buffer, offset, count);
}
inline void Org::BouncyCastle::Utilities::IO::PushbackStream::Unread(int32_t b) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(), 42 })));
...
inline ::Org::BouncyCastle::Utilities::IO::PushbackStream* Org::BouncyCastle::Utilities::IO::PushbackStream::New_ctor(::System::IO::Stream* s) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Utilities::IO::PushbackStream*>(s));
}
// Ctor Parameters []
