...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::IO::TeeOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::IO::TeeOutputStream*, "Org.BouncyCastle.Utilities.IO", "TeeOutputStream");
...
public:
  ...
  /// @brief Method Close, addr 0x36304b0, size 0x9c, virtual true, abstract: false, final false
  inline void Close();

  static inline ::Org::BouncyCastle::Utilities::IO::TeeOutputStream* New_ctor(::System::IO::Stream* output, ::System::IO::Stream* tee);

  /// @brief Method Write, addr 0x363054c, size 0x68, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte, addr 0x36305b4, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3630484, size 0x2c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TeeOutputStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TeeOutputStream(TeeOutputStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TeeOutputStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TeeOutputStream(TeeOutputStreamconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::IO::TeeOutputStream) == 0x40, "Size mismatch!");
