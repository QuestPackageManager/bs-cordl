...
public:
  ...
  /// @brief Method Close, addr 0x3630314, size 0x9c, virtual true, abstract: false, final false
  inline void Close();

  static inline ::Org::BouncyCastle::Utilities::IO::TeeInputStream* New_ctor(::System::IO::Stream* input, ::System::IO::Stream* tee);

  /// @brief Method Read, addr 0x36303b0, size 0x78, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method ReadByte, addr 0x3630428, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36302e8, size 0x2c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TeeInputStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TeeInputStream(TeeInputStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TeeInputStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TeeInputStream(TeeInputStreamconst&) = delete;
