...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullOutputStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullOutputStream(NullOutputStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullOutputStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullOutputStream(NullOutputStreamconst&) = delete;
