...
public:
  ...
  /// @brief Method Write, addr 0x35705a4, size 0x4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte, addr 0x35705a0, size 0x4, virtual true, abstract: false, final false
  inline void WriteByte(uint8_t b);

  /// @brief Method .ctor, addr 0x35705a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
