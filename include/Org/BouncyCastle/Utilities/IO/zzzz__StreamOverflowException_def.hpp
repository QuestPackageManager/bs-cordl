...
public:
  ...
  /// @brief Method .ctor, addr 0x35706cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35706d4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35706f8, size 0x24, virtual false, abstract: false, final false
