...
public:
  ...
  /// @brief Method .ctor, addr 0x25da1c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25da1d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25da1d8, size 0x8, virtual false, abstract: false, final false
