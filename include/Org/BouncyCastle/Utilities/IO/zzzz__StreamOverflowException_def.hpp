...
public:
  ...
  /// @brief Method .ctor addr 0x10eea68 size 0x8 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Utilities::IO::StreamOverflowException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x10eea70 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10eea78 size 0x8 virtual false final false
