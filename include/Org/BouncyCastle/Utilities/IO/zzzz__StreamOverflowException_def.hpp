...
public:
  ...
  /// @brief Method .ctor, addr 0x11f6214, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11f621c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11f6224, size 0x8, virtual false, abstract: false, final false
