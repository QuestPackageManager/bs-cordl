...
public:
  ...
  /// @brief Method .ctor, addr 0x11cfb10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11cfb18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11cfb20, size 0x8, virtual false, abstract: false, final false
