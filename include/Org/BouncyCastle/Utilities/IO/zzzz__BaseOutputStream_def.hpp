...
public:
  ...
  /// @brief Method get_CanRead addr 0x114c2e4 size 0x8 virtual true final true
  inline bool get_CanRead();

  /// @brief Method get_CanSeek addr 0x114c2ec size 0x8 virtual true final true
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite addr 0x114c2f4 size 0x10 virtual true final true
  inline bool get_CanWrite();

  /// @brief Method Close addr 0x114c2d4 size 0x10 virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0x114c304 size 0x4 virtual true final false
  inline void Flush();

  /// @brief Method get_Length addr 0x114c308 size 0x40 virtual true final true
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0x114c348 size 0x40 virtual true final true
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0x114c388 size 0x40 virtual true final true
  inline void set_Position(int64_t value);

  /// @brief Method Read addr 0x114c3c8 size 0x40 virtual true final true
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method Seek addr 0x114c408 size 0x40 virtual true final true
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0x114c448 size 0x40 virtual true final true
  inline void SetLength(int64_t value);

  /// @brief Method Write addr 0x114c488 size 0x80 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method Write addr 0x114c508 size 0x28 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method WriteByte addr 0x114c530 size 0x8c virtual true final false
  inline void WriteByte(uint8_t b);

  static inline ::Org::BouncyCastle::Utilities::IO::BaseOutputStream* New_ctor();

  /// @brief Method .ctor addr 0x114c0ac size 0x58 virtual false final false
  inline void _ctor();
