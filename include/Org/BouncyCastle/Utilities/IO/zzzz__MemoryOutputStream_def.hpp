...
public:
  ...
  /// @brief Method .ctor, addr 0x25d65b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CanRead, addr 0x25d65ac, size 0x8, virtual true, abstract: false, final true
