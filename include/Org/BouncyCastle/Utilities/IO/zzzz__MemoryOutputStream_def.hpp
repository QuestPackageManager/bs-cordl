...
public:
  ...
  /// @brief Method .ctor, addr 0x25da064, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CanRead, addr 0x25da05c, size 0x8, virtual true, abstract: false, final true
