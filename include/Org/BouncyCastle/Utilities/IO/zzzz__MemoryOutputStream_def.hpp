...
/// @brief Method .ctor, addr 0x3533f54, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CanRead, addr 0x3533f4c, size 0x8, virtual true, abstract: false, final true
