...
public:
  ...
  /// @brief Method get_CanRead, addr 0x115fb90, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanRead();

  static inline ::Org::BouncyCastle::Utilities::IO::MemoryOutputStream* New_ctor();

  /// @brief Method .ctor, addr 0x115fb98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
