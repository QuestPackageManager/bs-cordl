...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryOutputStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryOutputStream(MemoryOutputStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryOutputStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryOutputStream(MemoryOutputStreamconst&) = delete;
