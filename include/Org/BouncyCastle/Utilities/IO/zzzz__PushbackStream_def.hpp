...
public:
  ...
  /// @brief Method Read, addr 0x3534068, size 0x6c, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x353402c, size 0x3c, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Unread, addr 0x35340d4, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x353401c, size 0x10, virtual false, abstract: false, final false
