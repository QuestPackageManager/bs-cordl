...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PushbackStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PushbackStream(PushbackStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PushbackStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PushbackStream(PushbackStreamconst&) = delete;
