...
public:
  ...
  /// @brief Method Read, addr 0x13d1f58, size 0x60, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x13d1f34, size 0x24, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Unread, addr 0x13d1fb8, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13d1f24, size 0x10, virtual false, abstract: false, final false
