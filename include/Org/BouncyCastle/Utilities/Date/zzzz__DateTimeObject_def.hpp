...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DateTimeObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DateTimeObject(DateTimeObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DateTimeObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DateTimeObject(DateTimeObjectconst&) = delete;
