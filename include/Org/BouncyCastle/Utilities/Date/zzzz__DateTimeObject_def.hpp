...
public:
  ...
  /// @brief Method ToString, addr 0x11f1c80, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e7a5c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dt);

  /// @brief Method get_Value, addr 0x11f1c78, size 0x8, virtual false, abstract: false, final false
