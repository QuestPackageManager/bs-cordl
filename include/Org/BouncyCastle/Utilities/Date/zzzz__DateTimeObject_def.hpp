...
public:
  ...
  /// @brief Method ToString, addr 0x25d9f60, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d0134, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dt);

  /// @brief Method get_Value, addr 0x25d9f58, size 0x8, virtual false, abstract: false, final false
