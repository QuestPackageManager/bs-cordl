...
public:
  ...
  /// @brief Method ToString, addr 0x25d20f0, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c82c4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dt);

  /// @brief Method get_Value, addr 0x25d20e8, size 0x8, virtual false, abstract: false, final false
