...
public:
  ...
  /// @brief Method CurrentUnixMs, addr 0x11f1e98, size 0x84, virtual false, abstract: false, final false
  static inline int64_t CurrentUnixMs();

  /// @brief Method DateTimeToUnixMs, addr 0x11f1ca8, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnixMsToDateTime, addr 0x11f1e04, size 0x94, virtual false, abstract: false, final false
  static inline ::System::DateTime UnixMsToDateTime(int64_t unixMs);

  /// @brief Method .ctor, addr 0x11f1ca0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
