...
public:
  ...
  /// @brief Method CurrentUnixMs, addr 0x352fcd0, size 0x8c, virtual false, abstract: false, final false
  static inline int64_t CurrentUnixMs();

  /// @brief Method DateTimeToUnixMs, addr 0x352fa84, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnixMsToDateTime, addr 0x352fc10, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::DateTime UnixMsToDateTime(int64_t unixMs);

  /// @brief Method .ctor, addr 0x352fa80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
