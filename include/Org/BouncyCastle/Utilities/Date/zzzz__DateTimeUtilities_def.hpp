...
public:
  ...
  /// @brief Method CurrentUnixMs, addr 0x350548c, size 0x8c, virtual false, abstract: false, final false
  static inline int64_t CurrentUnixMs();

  /// @brief Method DateTimeToUnixMs, addr 0x3505240, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnixMsToDateTime, addr 0x35053cc, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::DateTime UnixMsToDateTime(int64_t unixMs);

  /// @brief Method .ctor, addr 0x350523c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
