...
/// @brief Method CurrentUnixMs, addr 0x352fc20, size 0x8c, virtual false, abstract: false, final false
static inline int64_t CurrentUnixMs() ;

/// @brief Method DateTimeToUnixMs, addr 0x352f9d4, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method UnixMsToDateTime, addr 0x352fb60, size 0xc0, virtual false, abstract: false, final false
static inline ::System::DateTime UnixMsToDateTime(int64_t  unixMs) ;

/// @brief Method .ctor, addr 0x352f9d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
