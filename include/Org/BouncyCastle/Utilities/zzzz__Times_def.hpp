...
public:
  ...
  /// @brief Method NanoTime, addr 0x25e7a4c, size 0xa0, virtual false, abstract: false, final false
  static inline int64_t NanoTime();

  static inline ::Org::BouncyCastle::Utilities::Times* New_ctor();

  /// @brief Method .ctor, addr 0x25e7b38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
