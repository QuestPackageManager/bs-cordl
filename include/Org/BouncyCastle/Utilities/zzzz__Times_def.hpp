...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Times", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Times(Times&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Times", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Times(Timesconst&) = delete;
