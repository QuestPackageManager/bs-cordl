...
public:
  ...
  /// @brief Method NanoTime, addr 0x3518a30, size 0xa8, virtual false, abstract: false, final false
  static inline int64_t NanoTime();

  static inline ::Org::BouncyCastle::Utilities::Times* New_ctor();

  /// @brief Method .ctor, addr 0x3518b28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
