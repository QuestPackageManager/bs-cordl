...
public:
  // Declarations
  /// @brief Method AddRange, addr 0x11c6cb8, size 0x35c, virtual false, abstract: false, final false
  static inline void AddRange(::System::Collections::IList* to, ::System::Collections::IEnumerable* range);

  /// @brief Method CheckElementsAreOfType, addr 0x11c7014, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadOnly, addr 0x11c5bf8, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Utilities::Collections::ISet* ReadOnly(::Org::BouncyCastle::Utilities::Collections::ISet* s);

  /// @brief Method ReadOnly, addr 0x11c7328, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Collections::IDictionary* ReadOnly(::System::Collections::IDictionary* d);

  /// @brief Method ReadOnly, addr 0x11c5c5c, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* ReadOnly(::System::Collections::IList* l);

  /// @brief Method RequireNext, addr 0x11c7404, size 0x138, virtual false, abstract: false, final false
  static inline ::System::Object* RequireNext(::System::Collections::IEnumerator* e);

  /// @brief Method ToString, addr 0x11c753c, size 0x30c, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::Collections::IEnumerable* c);

  /// @brief Method .ctor, addr 0x11c7848, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
