...
public:
  // Declarations
  /// @brief Method AddRange, addr 0x1184ce8, size 0x35c, virtual false, abstract: false, final false
  static inline void AddRange(::System::Collections::IList* to, ::System::Collections::IEnumerable* range);

  /// @brief Method CheckElementsAreOfType, addr 0x1185044, size 0x314, virtual false, abstract: false, final false
  static inline bool CheckElementsAreOfType(::System::Collections::IEnumerable* e, ::System::Type* t);

  /// @brief Method ReadOnly, addr 0x1185358, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Collections::IDictionary* ReadOnly(::System::Collections::IDictionary* d);

  /// @brief Method ReadOnly, addr 0x1183c8c, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* ReadOnly(::System::Collections::IList* l);

  /// @brief Method ReadOnly, addr 0x1183c28, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Utilities::Collections::ISet* ReadOnly(::Org::BouncyCastle::Utilities::Collections::ISet* s);

  /// @brief Method RequireNext, addr 0x1185434, size 0x138, virtual false, abstract: false, final false
  static inline ::System::Object* RequireNext(::System::Collections::IEnumerator* e);

  /// @brief Method ToString, addr 0x118556c, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1185878, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
