...
public:
  ...
  /// @brief Method Add, addr 0x25d5540, size 0x38, virtual true, abstract: false, final false
  inline void Add(::System::Object* o);

  /// @brief Method AddAll, addr 0x25d5578, size 0x38, virtual true, abstract: false, final false
  inline void AddAll(::System::Collections::IEnumerable* e);

  /// @brief Method Clear, addr 0x25d55b0, size 0x38, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Remove, addr 0x25d55f0, size 0x38, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAll, addr 0x25d5628, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method get_IsReadOnly, addr 0x25d55e8, size 0x8, virtual true, abstract: false, final false
