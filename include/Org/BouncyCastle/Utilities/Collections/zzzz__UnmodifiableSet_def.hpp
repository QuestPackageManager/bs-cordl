...
public:
  ...
  /// @brief Method Add, addr 0x13cd408, size 0x40, virtual true, abstract: false, final false
  inline void Add(::System::Object* o);

  /// @brief Method AddAll, addr 0x13cd448, size 0x40, virtual true, abstract: false, final false
  inline void AddAll(::System::Collections::IEnumerable* e);

  /// @brief Method Clear, addr 0x13cd488, size 0x40, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Remove, addr 0x13cd4d0, size 0x40, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAll, addr 0x13cd510, size 0x40, virtual true, abstract: false, final false
  inline void RemoveAll(::System::Collections::IEnumerable* e);

  /// @brief Method .ctor, addr 0x13cd400, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x13cd4c8, size 0x8, virtual true, abstract: false, final false
