...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnmodifiableSet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnmodifiableSet(UnmodifiableSet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnmodifiableSet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnmodifiableSet(UnmodifiableSetconst&) = delete;
