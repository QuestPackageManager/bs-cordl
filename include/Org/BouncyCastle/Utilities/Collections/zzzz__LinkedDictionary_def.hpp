...
public:
  ...
  /// @brief Method Add, addr 0x11ef110, size 0x138, virtual true, abstract: false, final false
  inline void Add(::System::Object* k, ::System::Object* v);

  /// @brief Method Clear, addr 0x11ef248, size 0x11c, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x11ef364, size 0xac, virtual true, abstract: false, final false
  inline bool Contains(::System::Object* k);

  /// @brief Method CopyTo, addr 0x11ef410, size 0x39c, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x11ef860, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  static inline ::Org::BouncyCastle::Utilities::Collections::LinkedDictionary* New_ctor();

  /// @brief Method Remove, addr 0x11ef8fc, size 0x128, virtual true, abstract: false, final false
  inline void Remove(::System::Object* k);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x11ef850, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x11ef0a0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x11ef7ac, size 0xa4, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsFixedSize, addr 0x11efa24, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x11efa2c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x11efa34, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x11eff88, size 0xa8, virtual true, abstract: false, final false
  inline ::System::Object* get_Item(::System::Object* k);

  /// @brief Method get_Keys, addr 0x11efa88, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Collections::ICollection* get_Keys();

  /// @brief Method get_SyncRoot, addr 0x11efa3c, size 0x4c, virtual true, abstract: false, final false
  inline ::System::Object* get_SyncRoot();

  /// @brief Method get_Values, addr 0x11efae4, size 0x4a4, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x11f0030, size 0x1a4, virtual true, abstract: false, final false
