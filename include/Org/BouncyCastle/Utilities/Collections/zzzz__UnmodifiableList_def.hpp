...
public:
  ...
  /// @brief Method Add, addr 0x25d91a8, size 0x38, virtual true, abstract: false, final false
  inline int32_t Add(::System::Object* o);

  /// @brief Method Clear, addr 0x25d91e0, size 0x38, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Insert, addr 0x25d9218, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x25d9258, size 0x38, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAt, addr 0x25d9290, size 0x38, virtual true, abstract: false, final false
  inline void RemoveAt(int32_t i);

  /// @brief Method .ctor, addr 0x25d91a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x25d9250, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x25d92c8, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x25d92d8, size 0x38, virtual true, abstract: false, final false
