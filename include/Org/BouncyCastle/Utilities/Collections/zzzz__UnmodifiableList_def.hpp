...
public:
  ...
  /// @brief Method Add, addr 0x356b18c, size 0x38, virtual true, abstract: false, final false
  inline int32_t Add(::System::Object* o);

  /// @brief Method Clear, addr 0x356b1c4, size 0x38, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Insert, addr 0x356b1fc, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x356b23c, size 0x38, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAt, addr 0x356b274, size 0x38, virtual true, abstract: false, final false
  inline void RemoveAt(int32_t i);

  /// @brief Method .ctor, addr 0x356b188, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x356b234, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x356b2ac, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x356b2bc, size 0x38, virtual true, abstract: false, final false
