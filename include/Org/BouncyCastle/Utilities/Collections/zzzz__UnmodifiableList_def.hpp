...
public:
  ...
  /// @brief Method Add, addr 0x11f0e70, size 0x40, virtual true, abstract: false, final false
  inline int32_t Add(::System::Object* o);

  /// @brief Method Clear, addr 0x11f0eb0, size 0x40, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Insert, addr 0x11f0ef0, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x11f0f38, size 0x40, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAt, addr 0x11f0f78, size 0x40, virtual true, abstract: false, final false
  inline void RemoveAt(int32_t i);

  /// @brief Method .ctor, addr 0x11f0e68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x11f0f30, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x11f0fb8, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x11f0fc8, size 0x40, virtual true, abstract: false, final false
