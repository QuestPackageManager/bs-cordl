...
public:
  ...
  /// @brief Method Add, addr 0x25d4da8, size 0x38, virtual true, abstract: false, final false
  inline int32_t Add(::System::Object* o);

  /// @brief Method Clear, addr 0x25d4de0, size 0x38, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Insert, addr 0x25d4e18, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x25d4e58, size 0x38, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAt, addr 0x25d4e90, size 0x38, virtual true, abstract: false, final false
  inline void RemoveAt(int32_t i);

  /// @brief Method .ctor, addr 0x25d4da0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x25d4e50, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x25d4ec8, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x25d4ed8, size 0x38, virtual true, abstract: false, final false
