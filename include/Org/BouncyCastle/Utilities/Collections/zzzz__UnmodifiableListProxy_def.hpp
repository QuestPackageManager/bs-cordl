...
public:
  ...
  /// @brief Method Contains, addr 0x25d14a0, size 0xac, virtual true, abstract: false, final false
  inline bool Contains(::System::Object* o);

  /// @brief Method CopyTo, addr 0x25d154c, size 0xb8, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x25d16a8, size 0xa0, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetValue, addr 0x25d19e0, size 0xa8, virtual true, abstract: false, final false
  inline ::System::Object* GetValue(int32_t i);

  /// @brief Method IndexOf, addr 0x25d1748, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25cdfc8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* l);

  /// @brief Method get_Count, addr 0x25d1604, size 0xa4, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsFixedSize, addr 0x25d17f4, size 0xa4, virtual true, abstract: false, final false
  inline bool get_IsFixedSize();

  /// @brief Method get_IsSynchronized, addr 0x25d1898, size 0xa4, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x25d193c, size 0xa4, virtual true, abstract: false, final false
