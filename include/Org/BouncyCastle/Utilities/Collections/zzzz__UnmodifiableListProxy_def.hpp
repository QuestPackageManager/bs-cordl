...
public:
  ...
  /// @brief Method Contains, addr 0x352ed60, size 0xb8, virtual true, abstract: false, final false
  inline bool Contains(::System::Object* o);

  /// @brief Method CopyTo, addr 0x352ee18, size 0xbc, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x352ef7c, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetValue, addr 0x352f2d0, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Object* GetValue(int32_t i);

  /// @brief Method IndexOf, addr 0x352f020, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x352b8f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* l);

  /// @brief Method get_Count, addr 0x352eed4, size 0xa8, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsFixedSize, addr 0x352f0d8, size 0xa8, virtual true, abstract: false, final false
  inline bool get_IsFixedSize();

  /// @brief Method get_IsSynchronized, addr 0x352f180, size 0xa8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x352f228, size 0xa8, virtual true, abstract: false, final false
