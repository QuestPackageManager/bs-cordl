...
public:
  ...
  /// @brief Method MoveNext, addr 0x25d43f8, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x25d4544, size 0xc, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x25d382c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Utilities::Collections::LinkedDictionary* parent);

  /// @brief Method get_Current, addr 0x25d4134, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Object* get_Current();

  /// @brief Method get_CurrentKey, addr 0x25d4280, size 0x174, virtual false, abstract: false, final false
  inline ::System::Object* get_CurrentKey();

  /// @brief Method get_Entry, addr 0x25d41a0, size 0xe0, virtual true, abstract: false, final false
  inline ::System::Collections::DictionaryEntry get_Entry();

  /// @brief Method get_Key, addr 0x25d43f4, size 0x4, virtual true, abstract: false, final false
  inline ::System::Object* get_Key();

  /// @brief Method get_Value, addr 0x25d4550, size 0xb8, virtual true, abstract: false, final false
