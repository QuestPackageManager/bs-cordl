...
public:
  ...
  /// @brief Method MoveNext, addr 0x25d87f8, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x25d8944, size 0xc, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x25d7c2c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Utilities::Collections::LinkedDictionary* parent);

  /// @brief Method get_Current, addr 0x25d8534, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Object* get_Current();

  /// @brief Method get_CurrentKey, addr 0x25d8680, size 0x174, virtual false, abstract: false, final false
  inline ::System::Object* get_CurrentKey();

  /// @brief Method get_Entry, addr 0x25d85a0, size 0xe0, virtual true, abstract: false, final false
  inline ::System::Collections::DictionaryEntry get_Entry();

  /// @brief Method get_Key, addr 0x25d87f4, size 0x4, virtual true, abstract: false, final false
  inline ::System::Object* get_Key();

  /// @brief Method get_Value, addr 0x25d8950, size 0xb8, virtual true, abstract: false, final false
