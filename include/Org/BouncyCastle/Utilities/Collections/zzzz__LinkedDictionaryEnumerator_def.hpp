...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LinkedDictionaryEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LinkedDictionaryEnumerator(LinkedDictionaryEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LinkedDictionaryEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LinkedDictionaryEnumerator(LinkedDictionaryEnumeratorconst&) = delete;
