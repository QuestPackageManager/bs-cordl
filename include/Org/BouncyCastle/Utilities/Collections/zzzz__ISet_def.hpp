...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Collections::ISet*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Collections::ISet*, "Org.BouncyCastle.Utilities.Collections", "ISet");
// Dependencies
namespace Org::BouncyCastle::Utilities::Collections {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISet(ISetconst&) = delete;
