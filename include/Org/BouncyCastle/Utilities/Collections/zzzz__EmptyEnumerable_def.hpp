...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable*, "Org.BouncyCastle.Utilities.Collections", "EmptyEnumerable");
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x36278ec, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  static inline ::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable* New_ctor();

  /// @brief Method .ctor, addr 0x36278e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EmptyEnumerable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EmptyEnumerable(EmptyEnumerable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EmptyEnumerable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EmptyEnumerable(EmptyEnumerableconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable) == 0x10, "Size mismatch!");
