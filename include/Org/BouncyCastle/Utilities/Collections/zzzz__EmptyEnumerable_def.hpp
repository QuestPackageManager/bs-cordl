...
/// @brief Method GetEnumerator, addr 0x352bccc, size 0x5c, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* GetEnumerator() ;

static inline ::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable* New_ctor() ;

/// @brief Method .ctor, addr 0x352bcc8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
