...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x12c7cdc, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12c7c64, size 0x78, virtual false, abstract: false, final false
