...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x13c0c70, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x13c0bf8, size 0x78, virtual false, abstract: false, final false
