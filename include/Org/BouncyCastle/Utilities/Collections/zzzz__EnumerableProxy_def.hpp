...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x11ee158, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x11ee0e0, size 0x78, virtual false, abstract: false, final false
