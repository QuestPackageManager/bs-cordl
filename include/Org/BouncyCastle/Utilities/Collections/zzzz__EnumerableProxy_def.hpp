...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x25d0d8c, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25d0d18, size 0x74, virtual false, abstract: false, final false
