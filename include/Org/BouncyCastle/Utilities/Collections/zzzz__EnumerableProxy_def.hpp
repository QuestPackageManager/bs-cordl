...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Collections::EnumerableProxy*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Collections::EnumerableProxy*, "Org.BouncyCastle.Utilities.Collections", "EnumerableProxy");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnumerableProxy", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnumerableProxy(EnumerableProxy&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnumerableProxy", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnumerableProxy(EnumerableProxyconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Collections::EnumerableProxy) == 0x18, "Size mismatch!");
