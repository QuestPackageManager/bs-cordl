...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x352bf34, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x352bedc, size 0x58, virtual false, abstract: false, final false
