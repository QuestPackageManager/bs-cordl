...
/// @brief Method GetEnumerator, addr 0x3569264, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x356920c, size 0x58, virtual false, abstract: false, final false
