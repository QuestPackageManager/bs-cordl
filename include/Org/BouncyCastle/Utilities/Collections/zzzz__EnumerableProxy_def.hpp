...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x259ca84, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x259ca10, size 0x74, virtual false, abstract: false, final false
