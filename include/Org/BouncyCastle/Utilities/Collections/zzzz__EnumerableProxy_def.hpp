...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x362571c, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36256c4, size 0x58, virtual false, abstract: false, final false
