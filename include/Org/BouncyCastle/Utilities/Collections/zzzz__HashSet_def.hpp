...
public:
  ...
  /// @brief Method Add, addr 0x11c7af4, size 0xb0, virtual true, abstract: false, final false
  inline void Add(::System::Object* o);

  /// @brief Method AddAll, addr 0x11c7ba4, size 0x2e8, virtual true, abstract: false, final false
  inline void AddAll(::System::Collections::IEnumerable* e);

  /// @brief Method Clear, addr 0x11c7e8c, size 0xa4, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x11c7f30, size 0xac, virtual true, abstract: false, final false
  inline bool Contains(::System::Object* o);

  /// @brief Method CopyTo, addr 0x11c7fdc, size 0x130, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x11c81b0, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x11c8564, size 0xac, virtual true, abstract: false, final false
  inline void Remove(::System::Object* o);

  /// @brief Method RemoveAll, addr 0x11c8610, size 0x2e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11c5b94, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11c68d0, size 0x324, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* s);

  /// @brief Method get_Count, addr 0x11c810c, size 0xa4, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsEmpty, addr 0x11c82c8, size 0xb0, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_IsFixedSize, addr 0x11c8378, size 0xa4, virtual true, abstract: false, final false
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x11c841c, size 0xa4, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x11c84c0, size 0xa4, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x11c88f8, size 0xa4, virtual true, abstract: false, final false
