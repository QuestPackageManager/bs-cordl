...
/// @brief Method Add, addr 0x352bf28, size 0xbc, virtual true, abstract: false, final false
inline void Add(::System::Object*  o) ;

/// @brief Method AddAll, addr 0x352bfe4, size 0x2c4, virtual true, abstract: false, final false
inline void AddAll(::System::Collections::IEnumerable*  e) ;

/// @brief Method Clear, addr 0x352c2a8, size 0xa8, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x352c350, size 0xb8, virtual true, abstract: false, final false
inline bool Contains(::System::Object*  o) ;

/// @brief Method CopyTo, addr 0x352c408, size 0x138, virtual true, abstract: false, final false
inline void CopyTo(::System::Array*  array, int32_t  index) ;

/// @brief Method GetEnumerator, addr 0x352c5e8, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method Remove, addr 0x352c9b4, size 0xb8, virtual true, abstract: false, final false
inline void Remove(::System::Object*  o) ;

/// @brief Method RemoveAll, addr 0x352ca6c, size 0x2c4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x352a160, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x352ae1c, size 0x2f8, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::IEnumerable*  s) ;

/// @brief Method get_Count, addr 0x352c540, size 0xa8, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsEmpty, addr 0x352c708, size 0xb4, virtual true, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_IsFixedSize, addr 0x352c7bc, size 0xa8, virtual true, abstract: false, final false
inline bool get_IsFixedSize() ;

/// @brief Method get_IsReadOnly, addr 0x352c864, size 0xa8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_IsSynchronized, addr 0x352c90c, size 0xa8, virtual true, abstract: false, final false
inline bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot, addr 0x352cd30, size 0xa8, virtual true, abstract: false, final false
