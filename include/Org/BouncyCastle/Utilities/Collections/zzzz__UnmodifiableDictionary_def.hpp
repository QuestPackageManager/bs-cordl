...
public:
  ...
  /// @brief Method Add, addr 0x356a9c0, size 0x38, virtual true, abstract: false, final false
  inline void Add(::System::Object* k, ::System::Object* v);

  /// @brief Method Clear, addr 0x356a9f8, size 0x38, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method Remove, addr 0x356aa40, size 0x38, virtual true, abstract: false, final false
  inline void Remove(::System::Object* k);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x356aa30, size 0x10, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x356a9bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsReadOnly, addr 0x356aa78, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x356aa80, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x356aa90, size 0x38, virtual true, abstract: false, final false
