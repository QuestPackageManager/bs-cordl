...
public:
  ...
  /// @brief Method NumberOfLeadingZeros, addr 0x25e7cfc, size 0x78, virtual false, abstract: false, final false
  static inline int32_t NumberOfLeadingZeros(int32_t i);

  /// @brief Method NumberOfTrailingZeros, addr 0x25e7d74, size 0x34, virtual false, abstract: false, final false
  static inline int32_t NumberOfTrailingZeros(int32_t i);

  /// @brief Method RotateLeft, addr 0x25e7da8, size 0x14, virtual false, abstract: false, final false
  static inline int32_t RotateLeft(int32_t i, int32_t distance);

  /// @brief Method RotateLeft, addr 0x25e7dbc, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t RotateLeft(uint32_t i, int32_t distance);

  /// @brief Method RotateRight, addr 0x25e7dd0, size 0x14, virtual false, abstract: false, final false
  static inline int32_t RotateRight(int32_t i, int32_t distance);

  /// @brief Method RotateRight, addr 0x25e7de4, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t RotateRight(uint32_t i, int32_t distance);

  /// @brief Method .ctor, addr 0x25e7df8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
