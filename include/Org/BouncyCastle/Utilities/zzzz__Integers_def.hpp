...
public:
  ...
  /// @brief Method NumberOfLeadingZeros, addr 0x363dd04, size 0x78, virtual false, abstract: false, final false
  static inline int32_t NumberOfLeadingZeros(int32_t i);

  /// @brief Method NumberOfTrailingZeros, addr 0x363dd7c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x363de00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
