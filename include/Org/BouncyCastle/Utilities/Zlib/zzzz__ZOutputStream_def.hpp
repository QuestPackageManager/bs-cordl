...
public:
  ...
  /// @brief Method GetDefaultZStream addr 0xfa3218 size 0x70 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfa3288 size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfa32b8 size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfa3100 size 0x114 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfa32e8 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfa32f0 size 0x100 virtual false final false
  inline void _ctor(::System::IO::Stream* output, int32_t level, bool nowrap);

  /// @brief Method get_CanRead addr 0xfa33f0 size 0x8 virtual true final true
  inline bool get_CanRead();

  /// @brief Method get_CanSeek addr 0xfa33f8 size 0x8 virtual true final true
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite addr 0xfa3400 size 0x10 virtual true final true
  inline bool get_CanWrite();

  /// @brief Method Close addr 0xfa3410 size 0x2c virtual true final false
  inline void Close();

  /// @brief Method DoClose addr 0xfa343c size 0x1a8 virtual false final false
  inline void DoClose();

  /// @brief Method End addr 0xfa35e4 size 0x4c virtual true final false
  inline void End();

  /// @brief Method Finish addr 0xfa3630 size 0x16c virtual true final false
  inline void Finish();

  /// @brief Method Flush addr 0xfa379c size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method get_FlushMode addr 0xfa37c0 size 0x8 virtual true final false
  inline int32_t get_FlushMode();

  /// @brief Method set_FlushMode addr 0xfa37c8 size 0x8 virtual true final false
  inline void set_FlushMode(int32_t value);

  /// @brief Method get_Length addr 0xfa37d0 size 0x40 virtual true final true
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0xfa3810 size 0x40 virtual true final true
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0xfa3850 size 0x40 virtual true final true
  inline void set_Position(int64_t value);

  /// @brief Method Read addr 0xfa3890 size 0x40 virtual true final true
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method Seek addr 0xfa38d0 size 0x40 virtual true final true
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0xfa3910 size 0x40 virtual true final true
  inline void SetLength(int64_t value);

  /// @brief Method get_TotalIn addr 0xfa3950 size 0x1c virtual true final false
  inline int64_t get_TotalIn();

  /// @brief Method get_TotalOut addr 0xfa396c size 0x1c virtual true final false
  inline int64_t get_TotalOut();

  /// @brief Method Write addr 0xfa3988 size 0x168 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t off, int32_t len);

  /// @brief Method WriteByte addr 0xfa3af0 size 0x40 virtual true final false
