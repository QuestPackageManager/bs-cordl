...
public:
  ...
  /// @brief Method .ctor, addr 0x11f73a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method adler32, addr 0x11f7078, size 0x32c, virtual false, abstract: false, final false
