...
public:
  ...
  /// @brief Method .ctor, addr 0x25db2c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method adler32, addr 0x25dafa0, size 0x320, virtual false, abstract: false, final false
