...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Zlib::Adler32*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Zlib::Adler32*, "Org.BouncyCastle.Utilities.Zlib", "Adler32");
...
public:
  ...
  /// @brief Method .ctor, addr 0x362eb30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method adler32, addr 0x362e834, size 0x2fc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Zlib::Adler32) == 0x10, "Size mismatch!");
