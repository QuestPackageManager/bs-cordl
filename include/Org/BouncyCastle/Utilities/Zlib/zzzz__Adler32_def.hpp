...
public:
  ...
  /// @brief Method .ctor, addr 0x350ab04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method adler32, addr 0x350a808, size 0x2fc, virtual false, abstract: false, final false
