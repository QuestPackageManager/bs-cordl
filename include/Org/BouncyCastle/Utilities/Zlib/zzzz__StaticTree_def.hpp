...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Zlib::StaticTree*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Zlib::StaticTree*, "Org.BouncyCastle.Utilities.Zlib", "StaticTree");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_extra_bits, put = __cordl_internal_set_extra_bits)) ::ArrayW<int32_t> extra_bits;
  ...
  __declspec(property(get = getStaticF_static_dtree, put = setStaticF_static_dtree)) ::ArrayW<int16_t> static_dtree;
  ...
  __declspec(property(get = getStaticF_static_ltree, put = setStaticF_static_ltree)) ::ArrayW<int16_t> static_ltree;

  /// @brief Field static_tree, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get_static_tree, put = __cordl_internal_set_static_tree)) ::ArrayW<int16_t> static_tree;

  static inline ::Org::BouncyCastle::Utilities::Zlib::StaticTree* New_ctor(::ArrayW<int16_t> static_tree, ::ArrayW<int32_t> extra_bits, int32_t extra_base, int32_t elems, int32_t max_length);
  ...
  constexpr ::ArrayW<int32_t> const& __cordl_internal_get_extra_bits() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get_extra_bits();

  constexpr int32_t const& __cordl_internal_get_max_length() const;

  constexpr int32_t& __cordl_internal_get_max_length();

  constexpr ::ArrayW<int16_t> const& __cordl_internal_get_static_tree() const;

  constexpr ::ArrayW<int16_t>& __cordl_internal_get_static_tree();

  constexpr void __cordl_internal_set_elems(int32_t value);

  constexpr void __cordl_internal_set_extra_base(int32_t value);

  constexpr void __cordl_internal_set_extra_bits(::ArrayW<int32_t> value);

  constexpr void __cordl_internal_set_max_length(int32_t value);

  constexpr void __cordl_internal_set_static_tree(::ArrayW<int16_t> value);

  /// @brief Method .ctor, addr 0x3638984, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int16_t> static_tree, ::ArrayW<int32_t> extra_bits, int32_t extra_base, int32_t elems, int32_t max_length);
  ...
  static inline ::ArrayW<int16_t> getStaticF_static_dtree();

  static inline ::Org::BouncyCastle::Utilities::Zlib::StaticTree* getStaticF_static_l_desc();

  static inline ::ArrayW<int16_t> getStaticF_static_ltree();
  ...
  static inline void setStaticF_static_dtree(::ArrayW<int16_t> value);

  static inline void setStaticF_static_l_desc(::Org::BouncyCastle::Utilities::Zlib::StaticTree* value);

  static inline void setStaticF_static_ltree(::ArrayW<int16_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Zlib::StaticTree) == 0x30, "Size mismatch!");
