...
static inline ::Org::BouncyCastle::Utilities::Zlib::StaticTree* New_ctor(::ArrayW<int16_t,::Array<int16_t>*>  static_tree, ::ArrayW<int32_t,::Array<int32_t>*>  extra_bits, int32_t  extra_base, int32_t  elems, int32_t  max_length) ;
...
/// @brief Method .ctor, addr 0x357a144, size 0x10, virtual false, abstract: false, final false
