...
public:
  ...
  /// @brief Method inflateReset addr 0x116720c size 0x54 virtual false final false
  inline int32_t inflateReset(::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  /// @brief Method inflateEnd addr 0x1167260 size 0x38 virtual false final false
  inline int32_t inflateEnd(::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  /// @brief Method inflateInit addr 0x1167298 size 0xd8 virtual false final false
  inline int32_t inflateInit(::Org::BouncyCastle::Utilities::Zlib::ZStream* z, int32_t w);

  /// @brief Method inflate addr 0x1167370 size 0x670 virtual false final false
  inline int32_t inflate(::Org::BouncyCastle::Utilities::Zlib::ZStream* z, int32_t f);

  /// @brief Method inflateSetDictionary addr 0x11679e0 size 0x104 virtual false final false
  ...
  /// @brief Method inflateSync addr 0x1167ae4 size 0x1c0 virtual false final false
  inline int32_t inflateSync(::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  /// @brief Method inflateSyncPoint addr 0x1167ca4 size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x1167d64 size 0x58 virtual false final false
  inline void _ctor();
