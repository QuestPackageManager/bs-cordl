...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Zlib::Inflate*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Zlib::Inflate*, "Org.BouncyCastle.Utilities.Zlib", "Inflate");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_was, put = __cordl_internal_set_was)) ::ArrayW<int64_t> was;
  ...
  constexpr ::ArrayW<int64_t> const& __cordl_internal_get_was() const;

  constexpr ::ArrayW<int64_t>& __cordl_internal_get_was();
  ...
  constexpr void __cordl_internal_set_was(::ArrayW<int64_t> value);

  constexpr void __cordl_internal_set_wbits(int32_t value);

  /// @brief Method .ctor, addr 0x3637dbc, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t> getStaticF_mark();

  /// @brief Method inflate, addr 0x36373e8, size 0x654, virtual false, abstract: false, final false
  inline int32_t inflate(::Org::BouncyCastle::Utilities::Zlib::ZStream* z, int32_t f);

  /// @brief Method inflateEnd, addr 0x36372e0, size 0x38, virtual false, abstract: false, final false
  inline int32_t inflateEnd(::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  /// @brief Method inflateInit, addr 0x3637318, size 0xd0, virtual false, abstract: false, final false
  inline int32_t inflateInit(::Org::BouncyCastle::Utilities::Zlib::ZStream* z, int32_t w);

  /// @brief Method inflateReset, addr 0x363728c, size 0x54, virtual false, abstract: false, final false
  inline int32_t inflateReset(::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  /// @brief Method inflateSetDictionary, addr 0x3637a3c, size 0x100, virtual false, abstract: false, final false
  inline int32_t inflateSetDictionary(::Org::BouncyCastle::Utilities::Zlib::ZStream* z, ::ArrayW<uint8_t> dictionary, int32_t dictLength);

  /// @brief Method inflateSync, addr 0x3637b3c, size 0x1b8, virtual false, abstract: false, final false
  inline int32_t inflateSync(::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  /// @brief Method inflateSyncPoint, addr 0x3637cf4, size 0x2c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Inflate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Inflate(Inflate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Inflate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Inflate(Inflateconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Zlib::Inflate) == 0x40, "Size mismatch!");
