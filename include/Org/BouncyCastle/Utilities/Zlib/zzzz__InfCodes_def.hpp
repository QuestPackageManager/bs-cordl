...
public:
  ...
  /// @brief Method .ctor, addr 0x25dd6d0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method free, addr 0x25dd780, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method inflate_fast, addr 0x25df85c, size 0x860, virtual false, abstract: false, final false
  ...
  /// @brief Method init, addr 0x25de948, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method proc, addr 0x25deccc, size 0xa54, virtual false, abstract: false, final false
