...
public:
  ...
  /// @brief Method .ctor, addr 0x36321ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method free, addr 0x3632294, size 0x4, virtual false, abstract: false, final false
  inline void free(::Org::BouncyCastle::Utilities::Zlib::ZStream* z);

  static inline ::ArrayW<int32_t> getStaticF_inflate_mask();

  /// @brief Method inflate_fast, addr 0x3634570, size 0x8fc, virtual false, abstract: false, final false
  ...
  /// @brief Method init, addr 0x36335fc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method proc, addr 0x36339c8, size 0xa64, virtual false, abstract: false, final false
