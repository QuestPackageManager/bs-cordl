...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Utilities::Zlib::Tree*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Utilities::Zlib::Tree*, "Org.BouncyCastle.Utilities.Zlib", "Tree");
...
public:
  ...
  __declspec(property(get = getStaticF__dist_code, put = setStaticF__dist_code)) ::ArrayW<uint8_t> _dist_code;

  /// @brief Field _length_code, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF__length_code, put = setStaticF__length_code)) ::ArrayW<uint8_t> _length_code;

  /// @brief Field base_dist, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_base_dist, put = setStaticF_base_dist)) ::ArrayW<int32_t> base_dist;

  /// @brief Field base_length, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_base_length, put = setStaticF_base_length)) ::ArrayW<int32_t> base_length;

  /// @brief Field bl_order, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_bl_order, put = setStaticF_bl_order)) ::ArrayW<uint8_t> bl_order;
  ...
  __declspec(property(get = getStaticF_extra_dbits, put = setStaticF_extra_dbits)) ::ArrayW<int32_t> extra_dbits;

  /// @brief Field extra_lbits, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_extra_lbits, put = setStaticF_extra_lbits)) ::ArrayW<int32_t> extra_lbits;
  ...
  constexpr ::Org::BouncyCastle::Utilities::Zlib::StaticTree* const& __cordl_internal_get_stat_desc() const;
  ...
  static inline ::ArrayW<uint8_t> getStaticF__length_code();

  static inline ::ArrayW<int32_t> getStaticF_base_dist();

  static inline ::ArrayW<int32_t> getStaticF_base_length();

  static inline ::ArrayW<uint8_t> getStaticF_bl_order();

  static inline ::ArrayW<int32_t> getStaticF_extra_blbits();

  static inline ::ArrayW<int32_t> getStaticF_extra_dbits();

  static inline ::ArrayW<int32_t> getStaticF_extra_lbits();

  static inline void setStaticF__dist_code(::ArrayW<uint8_t> value);

  static inline void setStaticF__length_code(::ArrayW<uint8_t> value);

  static inline void setStaticF_base_dist(::ArrayW<int32_t> value);

  static inline void setStaticF_base_length(::ArrayW<int32_t> value);

  static inline void setStaticF_bl_order(::ArrayW<uint8_t> value);

  static inline void setStaticF_extra_blbits(::ArrayW<int32_t> value);

  static inline void setStaticF_extra_dbits(::ArrayW<int32_t> value);

  static inline void setStaticF_extra_lbits(::ArrayW<int32_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Utilities::Zlib::Tree) == 0x28, "Size mismatch!");
