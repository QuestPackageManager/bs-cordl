...
/// @brief Method .ctor, addr 0x353db34, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method bi_reverse, addr 0x353d894, size 0x28, virtual false, abstract: false, final false
static inline int32_t bi_reverse(int32_t  code, int32_t  len) ;

/// @brief Method build_tree, addr 0x353d298, size 0x470, virtual false, abstract: false, final false
inline void build_tree(::Org::BouncyCastle::Utilities::Zlib::Deflate*  s) ;

/// @brief Method d_code, addr 0x353cf2c, size 0xbc, virtual false, abstract: false, final false
static inline int32_t d_code(int32_t  dist) ;

/// @brief Method gen_bitlen, addr 0x353cfe8, size 0x2b0, virtual false, abstract: false, final false
inline void gen_bitlen(::Org::BouncyCastle::Utilities::Zlib::Deflate*  s) ;

/// @brief Method gen_codes, addr 0x353d708, size 0x18c, virtual false, abstract: false, final false
