...
public:
  ...
  /// @brief Method .ctor, addr 0x25e2c08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method version, addr 0x25e2bc8, size 0x40, virtual false, abstract: false, final false
