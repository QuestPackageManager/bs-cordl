...
public:
  ...
  /// @brief Method .ctor, addr 0x11ffe14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method version, addr 0x11ffdd4, size 0x40, virtual false, abstract: false, final false
