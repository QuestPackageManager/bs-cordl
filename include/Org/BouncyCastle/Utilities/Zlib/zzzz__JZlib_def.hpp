...
public:
  ...
  /// @brief Method .ctor, addr 0x13d292c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method version, addr 0x13d28ec, size 0x40, virtual false, abstract: false, final false
