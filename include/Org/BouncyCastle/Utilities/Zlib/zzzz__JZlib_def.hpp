...
public:
  ...
  /// @brief Method .ctor, addr 0x35793a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method version, addr 0x3579360, size 0x44, virtual false, abstract: false, final false
