...
/// @brief Method .ctor, addr 0x353cd60, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method version, addr 0x353cd1c, size 0x44, virtual false, abstract: false, final false
