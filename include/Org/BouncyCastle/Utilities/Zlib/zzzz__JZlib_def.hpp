...
public:
  ...
  /// @brief Method .ctor, addr 0x25e6f78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method version, addr 0x25e6f38, size 0x40, virtual false, abstract: false, final false
