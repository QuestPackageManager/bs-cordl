...
public:
  ...
  /// @brief Method .ctor, addr 0x11d9710, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method version, addr 0x11d96d0, size 0x40, virtual false, abstract: false, final false
