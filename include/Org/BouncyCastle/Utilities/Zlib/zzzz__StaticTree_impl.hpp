...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Utilities::Zlib::StaticTree::*)(::ArrayW<int16_t,::Array<int16_t>*>, ::ArrayW<int32_t,::Array<int32_t>*>, int32_t, int32_t, int32_t)>(&::Org::BouncyCastle::Utilities::Zlib::StaticTree::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x357a144;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 5>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<int16_t,::Array<int16_t>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<int32_t,::Array<int32_t>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                    )));
...
::cordl_internals::setStaticField<::ArrayW<int16_t,::Array<int16_t>*>, "static_ltree", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>(std::forward<::ArrayW<int16_t,::Array<int16_t>*>>(value));
}
inline ::ArrayW<int16_t,::Array<int16_t>*> Org::BouncyCastle::Utilities::Zlib::StaticTree::getStaticF_static_ltree()  {
return ::cordl_internals::getStaticField<::ArrayW<int16_t,::Array<int16_t>*>, "static_ltree", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>();
}
inline void Org::BouncyCastle::Utilities::Zlib::StaticTree::setStaticF_static_dtree(::ArrayW<int16_t,::Array<int16_t>*>  value)  {
::cordl_internals::setStaticField<::ArrayW<int16_t,::Array<int16_t>*>, "static_dtree", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>(std::forward<::ArrayW<int16_t,::Array<int16_t>*>>(value));
}
inline ::ArrayW<int16_t,::Array<int16_t>*> Org::BouncyCastle::Utilities::Zlib::StaticTree::getStaticF_static_dtree()  {
return ::cordl_internals::getStaticField<::ArrayW<int16_t,::Array<int16_t>*>, "static_dtree", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>();
}
...
::cordl_internals::setStaticField<::Org::BouncyCastle::Utilities::Zlib::StaticTree*, "static_l_desc", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>(std::forward<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>(value));
}
inline ::Org::BouncyCastle::Utilities::Zlib::StaticTree* Org::BouncyCastle::Utilities::Zlib::StaticTree::getStaticF_static_l_desc()  {
return ::cordl_internals::getStaticField<::Org::BouncyCastle::Utilities::Zlib::StaticTree*, "static_l_desc", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>();
}
...
::cordl_internals::setStaticField<::Org::BouncyCastle::Utilities::Zlib::StaticTree*, "static_d_desc", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>(std::forward<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>(value));
}
inline ::Org::BouncyCastle::Utilities::Zlib::StaticTree* Org::BouncyCastle::Utilities::Zlib::StaticTree::getStaticF_static_d_desc()  {
return ::cordl_internals::getStaticField<::Org::BouncyCastle::Utilities::Zlib::StaticTree*, "static_d_desc", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>();
}
...
::cordl_internals::setStaticField<::Org::BouncyCastle::Utilities::Zlib::StaticTree*, "static_bl_desc", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>(std::forward<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>(value));
}
inline ::Org::BouncyCastle::Utilities::Zlib::StaticTree* Org::BouncyCastle::Utilities::Zlib::StaticTree::getStaticF_static_bl_desc()  {
return ::cordl_internals::getStaticField<::Org::BouncyCastle::Utilities::Zlib::StaticTree*, "static_bl_desc", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get>();
}
inline void Org::BouncyCastle::Utilities::Zlib::StaticTree::_ctor(::ArrayW<int16_t,::Array<int16_t>*>  static_tree, ::ArrayW<int32_t,::Array<int32_t>*>  extra_bits, int32_t  extra_base, int32_t  elems, int32_t  max_length)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Utilities::Zlib::StaticTree*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
inline ::Org::BouncyCastle::Utilities::Zlib::StaticTree* Org::BouncyCastle::Utilities::Zlib::StaticTree::New_ctor(::ArrayW<int16_t,::Array<int16_t>*>  static_tree, ::ArrayW<int32_t,::Array<int32_t>*>  extra_bits, int32_t  extra_base, int32_t  elems, int32_t  max_length)  {
