...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Utilities::IMemoable* (::Org::BouncyCastle::Utilities::IMemoable::*)()>(&::Org::BouncyCastle::Utilities::IMemoable::Copy)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Utilities::IMemoable::*)(::Org::BouncyCastle::Utilities::IMemoable*)>(&::Org::BouncyCastle::Utilities::IMemoable::Reset)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
