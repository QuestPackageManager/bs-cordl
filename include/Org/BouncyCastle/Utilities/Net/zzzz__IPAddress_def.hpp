...
public:
  // Declarations
  /// @brief Method IsValid addr 0x10ef320 size 0x28 virtual false final false
  static inline bool IsValid(::StringW address);

  /// @brief Method IsValidWithNetMask addr 0x10ef490 size 0x28 virtual false final false
  static inline bool IsValidWithNetMask(::StringW address);

  /// @brief Method IsValidIPv4 addr 0x10ef348 size 0xa4 virtual false final false
  static inline bool IsValidIPv4(::StringW address);

  /// @brief Method unsafeIsValidIPv4 addr 0x10ef5f8 size 0xf8 virtual false final false
  static inline bool unsafeIsValidIPv4(::StringW address);

  /// @brief Method IsValidIPv4WithNetmask addr 0x10ef4b8 size 0xa0 virtual false final false
  static inline bool IsValidIPv4WithNetmask(::StringW address);

  /// @brief Method IsValidIPv6WithNetmask addr 0x10ef558 size 0xa0 virtual false final false
  static inline bool IsValidIPv6WithNetmask(::StringW address);

  /// @brief Method IsMaskValue addr 0x10ef6f0 size 0x2c virtual false final false
  static inline bool IsMaskValue(::StringW component, int32_t size);

  /// @brief Method IsValidIPv6 addr 0x10ef3ec size 0xa4 virtual false final false
  static inline bool IsValidIPv6(::StringW address);

  /// @brief Method unsafeIsValidIPv6 addr 0x10ef71c size 0x1a8 virtual false final false
  static inline bool unsafeIsValidIPv6(::StringW address);

  static inline ::Org::BouncyCastle::Utilities::Net::IPAddress* New_ctor();

  /// @brief Method .ctor addr 0x10ef8c4 size 0x8 virtual false final false
  inline void _ctor();
