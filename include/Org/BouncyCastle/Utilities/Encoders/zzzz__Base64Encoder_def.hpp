...
public:
  ...
  /// @brief Method Decode, addr 0x11cc1e8, size 0x3f8, virtual true, abstract: false, final true
  inline int32_t Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t off, int32_t length, ::System::IO::Stream* outStream);

  /// @brief Method DecodeString, addr 0x11cc858, size 0x408, virtual true, abstract: false, final true
  inline int32_t DecodeString(::StringW data, ::System::IO::Stream* outStream);

  /// @brief Method Encode, addr 0x11cc084, size 0x12c, virtual true, abstract: false, final true
  inline int32_t Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len, ::System::IO::Stream* outStream);

  /// @brief Method Encode, addr 0x11cbcf4, size 0x390, virtual false, abstract: false, final false
  ...
  /// @brief Method InitialiseDecodingTable, addr 0x11cbb94, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11cbc50, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method decodeLastBlock, addr 0x11cc654, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method ignore, addr 0x11cc1b0, size 0x38, virtual false, abstract: false, final false
  inline bool ignore(char16_t c);

  /// @brief Method nextI, addr 0x11cc5e0, size 0x74, virtual false, abstract: false, final false
  inline int32_t nextI(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t i, int32_t finish);

  /// @brief Method nextI, addr 0x11ccc60, size 0x84, virtual false, abstract: false, final false
