...
public:
  ...
  /// @brief Method .ctor, addr 0x115bdf0, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Encode, addr 0x115be94, size 0x390, virtual false, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x115c224, size 0x12c, virtual true, abstract: false, final true
  inline int32_t Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len, ::System::IO::Stream* outStream);

  /// @brief Method ignore, addr 0x115c350, size 0x38, virtual false, abstract: false, final false
  inline bool ignore(char16_t c);

  /// @brief Method Decode, addr 0x115c388, size 0x3f8, virtual true, abstract: false, final true
  inline int32_t Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t off, int32_t length, ::System::IO::Stream* outStream);

  /// @brief Method nextI, addr 0x115c780, size 0x74, virtual false, abstract: false, final false
  inline int32_t nextI(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t i, int32_t finish);

  /// @brief Method DecodeString, addr 0x115c9f8, size 0x408, virtual true, abstract: false, final true
  inline int32_t DecodeString(::StringW data, ::System::IO::Stream* outStream);

  /// @brief Method decodeLastBlock, addr 0x115c7f4, size 0x204, virtual false, abstract: false, final false
  inline int32_t decodeLastBlock(::System::IO::Stream* outStream, char16_t c1, char16_t c2, char16_t c3, char16_t c4);

  /// @brief Method nextI, addr 0x115ce00, size 0x84, virtual false, abstract: false, final false
