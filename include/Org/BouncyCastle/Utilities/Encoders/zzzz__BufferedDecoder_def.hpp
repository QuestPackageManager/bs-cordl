...
public:
  ...
  /// @brief Method ProcessByte, addr 0x13cf334, size 0x128, virtual false, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x13cf45c, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13cf1f8, size 0x13c, virtual false, abstract: false, final false
