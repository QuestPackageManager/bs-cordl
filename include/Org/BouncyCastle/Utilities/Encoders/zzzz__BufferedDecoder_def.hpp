...
public:
  ...
  /// @brief Method ProcessByte, addr 0x13c603c, size 0x128, virtual false, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x13c6164, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13c5f00, size 0x13c, virtual false, abstract: false, final false
