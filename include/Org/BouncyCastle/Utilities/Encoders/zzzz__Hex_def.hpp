...
public:
  ...
  /// @brief Method .ctor addr 0x10ec5cc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method ToHexString addr 0x10ec5d4 size 0x64 virtual false final false
  static inline ::StringW ToHexString(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method ToHexString addr 0x10ec638 size 0x74 virtual false final false
  static inline ::StringW ToHexString(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t off, int32_t length);

  /// @brief Method Encode addr 0x10ec774 size 0x64 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Encode addr 0x10ec6ac size 0xc8 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t off, int32_t length);

  /// @brief Method Encode addr 0x10ec8e8 size 0x84 virtual false final false
  static inline int32_t Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::System::IO::Stream* outStream);

  /// @brief Method Encode addr 0x10ec96c size 0x90 virtual false final false
  static inline int32_t Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t off, int32_t length, ::System::IO::Stream* outStream);

  /// @brief Method Decode addr 0x10ec9fc size 0xd0 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Decode addr 0x10ecdb0 size 0xd0 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Decode(::StringW data);

  /// @brief Method Decode addr 0x10ed17c size 0x78 virtual false final false
  static inline int32_t Decode(::StringW data, ::System::IO::Stream* outStream);

  /// @brief Method DecodeStrict addr 0x10ed1f4 size 0x74 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeStrict(::StringW str);

  /// @brief Method DecodeStrict addr 0x10ed4b0 size 0x80 virtual false final false
