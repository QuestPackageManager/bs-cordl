...
public:
  ...
  /// @brief Method ProcessByte, addr 0x356de0c, size 0x12c, virtual false, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x356df38, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x356dcd8, size 0x134, virtual false, abstract: false, final false
