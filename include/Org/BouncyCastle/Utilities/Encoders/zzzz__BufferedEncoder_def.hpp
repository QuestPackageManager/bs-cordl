...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BufferedEncoder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BufferedEncoder(BufferedEncoder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BufferedEncoder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BufferedEncoder(BufferedEncoderconst&) = delete;
