...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UrlBase64Encoder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UrlBase64Encoder(UrlBase64Encoder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UrlBase64Encoder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UrlBase64Encoder(UrlBase64Encoderconst&) = delete;
