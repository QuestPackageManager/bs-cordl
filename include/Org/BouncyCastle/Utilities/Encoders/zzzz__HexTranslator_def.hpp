...
/// @brief Method Decode, addr 0x3532fb0, size 0xd8, virtual true, abstract: false, final true
...
/// @brief Method Encode, addr 0x3532e64, size 0x144, virtual true, abstract: false, final true
...
/// @brief Method GetDecodedBlockSize, addr 0x3532fa8, size 0x8, virtual true, abstract: false, final true
inline int32_t GetDecodedBlockSize() ;

/// @brief Method GetEncodedBlockSize, addr 0x3532e5c, size 0x8, virtual true, abstract: false, final true
inline int32_t GetEncodedBlockSize() ;

static inline ::Org::BouncyCastle::Utilities::Encoders::HexTranslator* New_ctor() ;

/// @brief Method .ctor, addr 0x3533120, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
