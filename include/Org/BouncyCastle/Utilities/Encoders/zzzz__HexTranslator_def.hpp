...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HexTranslator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HexTranslator(HexTranslator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HexTranslator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HexTranslator(HexTranslatorconst&) = delete;
