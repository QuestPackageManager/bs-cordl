...
public:
  // Declarations
  /// @brief Method ToUpperCase addr 0x10fe4a0 size 0x7c virtual false final false
  static inline ::StringW ToUpperCase(::StringW original);

  /// @brief Method IsOneOf addr 0x10fe51c size 0x80 virtual false final false
  static inline bool IsOneOf(::StringW s, ::ArrayW<::StringW, ::Array<::StringW>*> candidates);

  /// @brief Method FromByteArray addr 0x10fe59c size 0xf0 virtual false final false
  static inline ::StringW FromByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> bs);

  /// @brief Method ToByteArray addr 0x10fe68c size 0xe8 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToByteArray(::ArrayW<char16_t, ::Array<char16_t>*> cs);

  /// @brief Method ToByteArray addr 0x10fe774 size 0xec virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToByteArray(::StringW s);

  /// @brief Method FromAsciiByteArray addr 0x10fe860 size 0x3c virtual false final false
  static inline ::StringW FromAsciiByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method ToAsciiByteArray addr 0x10fe89c size 0x30 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToAsciiByteArray(::ArrayW<char16_t, ::Array<char16_t>*> cs);

  /// @brief Method ToAsciiByteArray addr 0x10fe8cc size 0x30 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToAsciiByteArray(::StringW s);

  /// @brief Method FromUtf8ByteArray addr 0x10fe8fc size 0x3c virtual false final false
  static inline ::StringW FromUtf8ByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method ToUtf8ByteArray addr 0x10fe938 size 0x30 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToUtf8ByteArray(::ArrayW<char16_t, ::Array<char16_t>*> cs);

  /// @brief Method ToUtf8ByteArray addr 0x10fe968 size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10fe998 size 0x8 virtual false final false
  inline void _ctor();
