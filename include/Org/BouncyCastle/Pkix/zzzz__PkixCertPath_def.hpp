...
public:
  ...
  /// @brief Method Equals, addr 0x256f688, size 0x420, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetEncoded, addr 0x256fad0, size 0x330, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetEncoded, addr 0x256fe00, size 0x88c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded(::StringW encoding);

  /// @brief Method GetHashCode, addr 0x256faa8, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method SortCerts, addr 0x256e048, size 0xd1c, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* SortCerts(::System::Collections::IList* certs);

  /// @brief Method ToAsn1Object, addr 0x257068c, size 0x100, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method ToDerEncoded, addr 0x257078c, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2569444, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ICollection* certificates);

  /// @brief Method .ctor, addr 0x256ed64, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStream);

  /// @brief Method .ctor, addr 0x256edbc, size 0x844, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificates, addr 0x25708a4, size 0xc, virtual true, abstract: false, final false
  inline ::System::Collections::IList* get_Certificates();

  /// @brief Method get_Encodings, addr 0x256f600, size 0x88, virtual true, abstract: false, final false
