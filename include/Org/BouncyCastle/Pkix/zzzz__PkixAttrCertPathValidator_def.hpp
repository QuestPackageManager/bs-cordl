...
public:
  ...
  /// @brief Method Validate, addr 0x1355c80, size 0x3cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1355320, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
