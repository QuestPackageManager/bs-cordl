...
public:
  ...
  /// @brief Method Validate, addr 0x2569cec, size 0x3c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2569394, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
