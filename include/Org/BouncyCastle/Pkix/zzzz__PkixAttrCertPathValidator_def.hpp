...
public:
  ...
  /// @brief Method Validate, addr 0x115ca64, size 0x3cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x115c104, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
