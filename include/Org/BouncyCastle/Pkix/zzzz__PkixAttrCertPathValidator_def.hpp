...
public:
  ...
  /// @brief Method Validate, addr 0x25295c8, size 0x3c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2528c70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
