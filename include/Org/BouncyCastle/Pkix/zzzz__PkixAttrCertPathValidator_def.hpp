...
public:
  ...
  /// @brief Method Validate, addr 0x2568978, size 0x3c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2568020, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
