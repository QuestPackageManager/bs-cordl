...
public:
  ...
  /// @brief Method ToString, addr 0x2572180, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2569530, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CertPath, addr 0x2572178, size 0x8, virtual false, abstract: false, final false
