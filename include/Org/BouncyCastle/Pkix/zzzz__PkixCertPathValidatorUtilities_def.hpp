...
public:
  ...
  /// @brief Method FindTrustAnchor addr 0x108524c size 0x588 virtual false final false
  ...
  /// @brief Method IsIssuerTrustAnchor addr 0x107a058 size 0xe8 virtual false final false
  ...
  /// @brief Method AddAdditionalStoresFromAltNames addr 0x107a26c size 0x378 virtual false final false
  ...
  /// @brief Method GetValidDate addr 0x108f878 size 0x84 virtual false final false
  static inline ::System::DateTime GetValidDate(::Org::BouncyCastle::Pkix::PkixParameters* paramsPKIX);

  /// @brief Method GetIssuerPrincipal addr 0x108f4cc size 0x160 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetIssuerPrincipal(::System::Object* cert);

  /// @brief Method IsSelfIssued addr 0x107a94c size 0x5c virtual false final false
  static inline bool IsSelfIssued(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method GetAlgorithmIdentifier addr 0x1085aa0 size 0xe8 virtual false final false
  ...
  /// @brief Method IsAnyPolicy addr 0x108f8fc size 0x158 virtual false final false
  static inline bool IsAnyPolicy(::Org::BouncyCastle::Utilities::Collections::ISet* policySet);

  /// @brief Method AddAdditionalStoreFromLocation addr 0x108f62c size 0x24c virtual false final false
  static inline void AddAdditionalStoreFromLocation(::StringW location, ::Org::BouncyCastle::Pkix::PkixParameters* pkixParams);

  /// @brief Method GetSerialNumber addr 0x108fa54 size 0xf4 virtual false final false
  static inline ::Org::BouncyCastle::Math::BigInteger* GetSerialNumber(::System::Object* cert);

  /// @brief Method GetQualifierSet addr 0x108fb48 size 0x45c virtual false final false
  static inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetQualifierSet(::Org::BouncyCastle::Asn1::Asn1Sequence* qualifiers);

  /// @brief Method RemovePolicyNode addr 0x108ffa4 size 0x13c virtual false final false
  ...
  /// @brief Method RemovePolicyNodeRecurse addr 0x10900e0 size 0x430 virtual false final false
  ...
  /// @brief Method PrepareNextCertB1 addr 0x1090510 size 0xb40 virtual false final false
  ...
  /// @brief Method PrepareNextCertB2 addr 0x1091110 size 0x6d0 virtual false final false
  ...
  /// @brief Method GetCertStatus addr 0x10917e0 size 0x45c virtual false final false
  ...
  /// @brief Method GetNextWorkingKey addr 0x108d1f8 size 0x3f4 virtual false final false
  ...
  /// @brief Method GetValidCertDateFromValidityModel addr 0x107ad7c size 0x474 virtual false final false
  ...
  /// @brief Method FindCertificates addr 0x1078c08 size 0x808 virtual false final false
  ...
  /// @brief Method GetCrlIssuersFromDistributionPoint addr 0x1091c3c size 0x4c8 virtual false final false
  ...
  /// @brief Method GetCompleteCrls addr 0x1092104 size 0x5a0 virtual false final false
  ...
  /// @brief Method GetDeltaCrls addr 0x10926a4 size 0x898 virtual false final false
  ...
  /// @brief Method isDeltaCrl addr 0x1092f3c size 0xf8 virtual false final false
  static inline bool isDeltaCrl(::Org::BouncyCastle::X509::X509Crl* crl);

  /// @brief Method FindCertificates addr 0x10783fc size 0x808 virtual false final false
  ...
  /// @brief Method AddAdditionalStoresFromCrlDistributionPoint addr 0x1093034 size 0x218 virtual false final false
  ...
  /// @brief Method ProcessCertD1i addr 0x109324c size 0x3fc virtual false final false
  ...
  /// @brief Method ProcessCertD1ii addr 0x1093648 size 0x3e0 virtual false final false
  ...
  /// @brief Method FindIssuerCerts addr 0x107a5e4 size 0x368 virtual false final false
  ...
  /// @brief Method GetExtensionValue addr 0x1091050 size 0xc0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1093e24 size 0x8 virtual false final false
  inline void _ctor();
