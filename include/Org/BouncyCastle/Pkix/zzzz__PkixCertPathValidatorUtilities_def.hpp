...
public:
  ...
  /// @brief Method AddAdditionalStoreFromLocation, addr 0x257e5fc, size 0x248, virtual false, abstract: false, final false
  static inline void AddAdditionalStoreFromLocation(::StringW location, ::Org::BouncyCastle::Pkix::PkixParameters* pkixParams);

  /// @brief Method AddAdditionalStoresFromAltNames, addr 0x256956c, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAdditionalStoresFromCrlDistributionPoint, addr 0x2581ffc, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method FindCertificates, addr 0x2567718, size 0x81c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindCertificates, addr 0x2567f38, size 0x81c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindIssuerCerts, addr 0x25698e4, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method FindTrustAnchor, addr 0x2574318, size 0x56c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAlgorithmIdentifier, addr 0x2574b30, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCertStatus, addr 0x2580790, size 0x470, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCompleteCrls, addr 0x25810cc, size 0x5a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCrlIssuersFromDistributionPoint, addr 0x2580c00, size 0x4cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeltaCrls, addr 0x2581670, size 0x894, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExtensionValue, addr 0x2580000, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIssuerPrincipal, addr 0x257e49c, size 0x160, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetIssuerPrincipal(::System::Object* cert);

  /// @brief Method GetNextWorkingKey, addr 0x257c1b4, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQualifierSet, addr 0x257eaec, size 0x468, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetQualifierSet(::Org::BouncyCastle::Asn1::Asn1Sequence* qualifiers);

  /// @brief Method GetSerialNumber, addr 0x257ea20, size 0xcc, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* GetSerialNumber(::System::Object* cert);

  /// @brief Method GetValidCertDateFromValidityModel, addr 0x256a070, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method GetValidDate, addr 0x257e844, size 0x84, virtual false, abstract: false, final false
  static inline ::System::DateTime GetValidDate(::Org::BouncyCastle::Pkix::PkixParameters* paramsPKIX);

  /// @brief Method IsAnyPolicy, addr 0x257e8c8, size 0x158, virtual false, abstract: false, final false
  static inline bool IsAnyPolicy(::Org::BouncyCastle::Utilities::Collections::ISet* policySet);

  /// @brief Method IsIssuerTrustAnchor, addr 0x256935c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSelfIssued, addr 0x2569c48, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareNextCertB1, addr 0x257f4c8, size 0xb38, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareNextCertB2, addr 0x25800c0, size 0x6d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessCertD1i, addr 0x2582210, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessCertD1ii, addr 0x2582614, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePolicyNode, addr 0x257ef54, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePolicyNodeRecurse, addr 0x257f090, size 0x438, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2582ca8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method isDeltaCrl, addr 0x2581f04, size 0xf8, virtual false, abstract: false, final false
