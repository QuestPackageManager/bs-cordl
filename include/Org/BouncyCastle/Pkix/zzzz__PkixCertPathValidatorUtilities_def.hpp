...
public:
  ...
  /// @brief Method AddAdditionalStoreFromLocation, addr 0x1196de4, size 0x24c, virtual false, abstract: false, final false
  static inline void AddAdditionalStoreFromLocation(::StringW location, ::Org::BouncyCastle::Pkix::PkixParameters* pkixParams);

  /// @brief Method AddAdditionalStoresFromAltNames, addr 0x1181a24, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAdditionalStoresFromCrlDistributionPoint, addr 0x119a7ec, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method FindCertificates, addr 0x117fbb4, size 0x808, virtual false, abstract: false, final false
  ...
  /// @brief Method FindCertificates, addr 0x11803c0, size 0x808, virtual false, abstract: false, final false
  ...
  /// @brief Method FindIssuerCerts, addr 0x1181d9c, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method FindTrustAnchor, addr 0x118ca04, size 0x588, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAlgorithmIdentifier, addr 0x118d258, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCertStatus, addr 0x1198f98, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCompleteCrls, addr 0x11998bc, size 0x5a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCrlIssuersFromDistributionPoint, addr 0x11993f4, size 0x4c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeltaCrls, addr 0x1199e5c, size 0x898, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExtensionValue, addr 0x1198808, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIssuerPrincipal, addr 0x1196c84, size 0x160, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetIssuerPrincipal(::System::Object* cert);

  /// @brief Method GetNextWorkingKey, addr 0x11949b0, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQualifierSet, addr 0x1197300, size 0x45c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetQualifierSet(::Org::BouncyCastle::Asn1::Asn1Sequence* qualifiers);

  /// @brief Method GetSerialNumber, addr 0x119720c, size 0xf4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* GetSerialNumber(::System::Object* cert);

  /// @brief Method GetValidCertDateFromValidityModel, addr 0x1182534, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method GetValidDate, addr 0x1197030, size 0x84, virtual false, abstract: false, final false
  static inline ::System::DateTime GetValidDate(::Org::BouncyCastle::Pkix::PkixParameters* paramsPKIX);

  /// @brief Method IsAnyPolicy, addr 0x11970b4, size 0x158, virtual false, abstract: false, final false
  static inline bool IsAnyPolicy(::Org::BouncyCastle::Utilities::Collections::ISet* policySet);

  /// @brief Method IsIssuerTrustAnchor, addr 0x1181810, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSelfIssued, addr 0x1182104, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareNextCertB1, addr 0x1197cc8, size 0xb40, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareNextCertB2, addr 0x11988c8, size 0x6d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessCertD1i, addr 0x119aa04, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessCertD1ii, addr 0x119ae00, size 0x3e0, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePolicyNode, addr 0x119775c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePolicyNodeRecurse, addr 0x1197898, size 0x430, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x119b5dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method isDeltaCrl, addr 0x119a6f4, size 0xf8, virtual false, abstract: false, final false
