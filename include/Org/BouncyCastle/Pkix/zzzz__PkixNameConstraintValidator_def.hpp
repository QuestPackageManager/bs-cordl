...
public:
  ...
  /// @brief Method AddExcludedSubtree, addr 0x258e180, size 0x188, virtual false, abstract: false, final false
  inline void AddExcludedSubtree(::Org::BouncyCastle::Asn1::X509::GeneralSubtree* subtree);

  /// @brief Method CheckExcludedDN, addr 0x2584108, size 0x10, virtual false, abstract: false, final false
  inline void CheckExcludedDN(::Org::BouncyCastle::Asn1::Asn1Sequence* dn);

  /// @brief Method CheckExcludedDirectory, addr 0x2584118, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckExcludedDns, addr 0x2589a5c, size 0x58, virtual false, abstract: false, final false
  inline void CheckExcludedDns(::Org::BouncyCastle::Utilities::Collections::ISet* excluded, ::StringW dns);

  /// @brief Method CheckExcludedEmail, addr 0x258954c, size 0x58, virtual false, abstract: false, final false
  inline void CheckExcludedEmail(::Org::BouncyCastle::Utilities::Collections::ISet* excluded, ::StringW email);

  /// @brief Method CheckExcludedIP, addr 0x258ab10, size 0x58, virtual false, abstract: false, final false
  inline void CheckExcludedIP(::Org::BouncyCastle::Utilities::Collections::ISet* excluded, ::ArrayW<uint8_t, ::Array<uint8_t>*> ip);

  /// @brief Method CheckExcludedOtherName, addr 0x2588d30, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckExcludedUri, addr 0x258a4a8, size 0x58, virtual false, abstract: false, final false
  inline void CheckExcludedUri(::Org::BouncyCastle::Utilities::Collections::ISet* excluded, ::StringW uri);

  /// @brief Method CheckPermittedDN, addr 0x2583fdc, size 0x10, virtual false, abstract: false, final false
  inline void CheckPermittedDN(::Org::BouncyCastle::Asn1::Asn1Sequence* dn);

  /// @brief Method CheckPermittedDirectory, addr 0x2583fec, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckPermittedDns, addr 0x2589950, size 0x10c, virtual false, abstract: false, final false
  inline void CheckPermittedDns(::Org::BouncyCastle::Utilities::Collections::ISet* permitted, ::StringW dns);

  /// @brief Method CheckPermittedEmail, addr 0x2589430, size 0x11c, virtual false, abstract: false, final false
  inline void CheckPermittedEmail(::Org::BouncyCastle::Utilities::Collections::ISet* permitted, ::StringW email);

  /// @brief Method CheckPermittedIP, addr 0x258aa04, size 0x10c, virtual false, abstract: false, final false
  inline void CheckPermittedIP(::Org::BouncyCastle::Utilities::Collections::ISet* permitted, ::ArrayW<uint8_t, ::Array<uint8_t>*> ip);

  /// @brief Method CheckPermittedOtherName, addr 0x2588c6c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckPermittedUri, addr 0x258a39c, size 0x10c, virtual false, abstract: false, final false
  inline void CheckPermittedUri(::Org::BouncyCastle::Utilities::Collections::ISet* permitted, ::StringW uri);

  /// @brief Method CollectionsAreEqual, addr 0x258e904, size 0x6a8, virtual false, abstract: false, final false
  inline bool CollectionsAreEqual(::System::Collections::ICollection* coll1, ::System::Collections::ICollection* coll2);

  /// @brief Method CompareTo, addr 0x2588700, size 0xdc, virtual false, abstract: false, final false
  static inline int32_t CompareTo(::ArrayW<uint8_t, ::Array<uint8_t>*> ip1, ::ArrayW<uint8_t, ::Array<uint8_t>*> ip2);

  /// @brief Method Equals, addr 0x258e798, size 0x16c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method ExtractHostFromURL, addr 0x2589ed4, size 0x19c, virtual false, abstract: false, final false
  static inline ::StringW ExtractHostFromURL(::StringW url);

  /// @brief Method ExtractIPsAndSubnetMasks, addr 0x2588260, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractNameAsString, addr 0x2585ea0, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW ExtractNameAsString(::Org::BouncyCastle::Asn1::X509::GeneralName* name);

  /// @brief Method GetHashCode, addr 0x258e314, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method HashCode, addr 0x258e308, size 0xc, virtual false, abstract: false, final false
  inline int32_t HashCode();

  /// @brief Method HashCollection, addr 0x258e404, size 0x394, virtual false, abstract: false, final false
  inline int32_t HashCollection(::System::Collections::ICollection* c);

  /// @brief Method IntersectDN, addr 0x2584170, size 0x804, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectDns, addr 0x258b4ec, size 0x7e0, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectEmail, addr 0x25857e0, size 0x6c0, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectEmail, addr 0x2585ecc, size 0x5c8, virtual false, abstract: false, final false
  inline void IntersectEmail(::StringW email1, ::StringW email2, ::Org::BouncyCastle::Utilities::Collections::ISet* intersect);

  /// @brief Method IntersectEmptyPermittedSubtree, addr 0x258e04c, size 0x134, virtual false, abstract: false, final false
  inline void IntersectEmptyPermittedSubtree(int32_t nameType);

  /// @brief Method IntersectIP, addr 0x2587254, size 0x7a0, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectIPRange, addr 0x25879f4, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectOtherName, addr 0x2584f7c, size 0x69c, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectOtherName, addr 0x2585618, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectPermittedSubtree, addr 0x258d5a4, size 0xaa8, virtual false, abstract: false, final false
  inline void IntersectPermittedSubtree(::Org::BouncyCastle::Asn1::Asn1Sequence* permitted);

  /// @brief Method IntersectUri, addr 0x258c2bc, size 0x6ac, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectUri, addr 0x258c968, size 0x5c8, virtual false, abstract: false, final false
  inline void IntersectUri(::StringW email1, ::StringW email2, ::Org::BouncyCastle::Utilities::Collections::ISet* intersect);

  /// @brief Method IpWithSubnetMask, addr 0x25888a0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDirectoryConstrained, addr 0x2589ab4, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDnsConstrained, addr 0x25895a4, size 0x80, virtual false, abstract: false, final false
  inline bool IsDnsConstrained(::StringW constraint, ::StringW dns);

  /// @brief Method IsDnsConstrained, addr 0x2589624, size 0x32c, virtual false, abstract: false, final false
  inline bool IsDnsConstrained(::Org::BouncyCastle::Utilities::Collections::ISet* constraints, ::StringW dns);

  /// @brief Method IsEmailConstrained, addr 0x2588d88, size 0x178, virtual false, abstract: false, final false
  inline bool IsEmailConstrained(::StringW constraint, ::StringW email);

  /// @brief Method IsEmailConstrained, addr 0x25890f4, size 0x33c, virtual false, abstract: false, final false
  inline bool IsEmailConstrained(::Org::BouncyCastle::Utilities::Collections::ISet* constraints, ::StringW email);

  /// @brief Method IsIPConstrained, addr 0x258a500, size 0x1b8, virtual false, abstract: false, final false
  inline bool IsIPConstrained(::ArrayW<uint8_t, ::Array<uint8_t>*> constraint, ::ArrayW<uint8_t, ::Array<uint8_t>*> ip);

  /// @brief Method IsIPConstrained, addr 0x258a6b8, size 0x34c, virtual false, abstract: false, final false
  inline bool IsIPConstrained(::Org::BouncyCastle::Utilities::Collections::ISet* constraints, ::ArrayW<uint8_t, ::Array<uint8_t>*> ip);

  /// @brief Method IsOtherNameConstrained, addr 0x2588944, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOtherNameConstrained, addr 0x2588960, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsUriConstrained, addr 0x2589de8, size 0xec, virtual false, abstract: false, final false
  inline bool IsUriConstrained(::StringW constraint, ::StringW uri);

  /// @brief Method IsUriConstrained, addr 0x258a070, size 0x32c, virtual false, abstract: false, final false
  inline bool IsUriConstrained(::Org::BouncyCastle::Utilities::Collections::ISet* constraints, ::StringW uri);

  /// @brief Method Max, addr 0x258868c, size 0x74, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Max(::ArrayW<uint8_t, ::Array<uint8_t>*> ip1, ::ArrayW<uint8_t, ::Array<uint8_t>*> ip2);

  /// @brief Method Min, addr 0x2588618, size 0x74, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Min(::ArrayW<uint8_t, ::Array<uint8_t>*> ip1, ::ArrayW<uint8_t, ::Array<uint8_t>*> ip2);

  /// @brief Method MinMaxIPs, addr 0x25883dc, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Or, addr 0x25887dc, size 0xc4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Or(::ArrayW<uint8_t, ::Array<uint8_t>*> ip1, ::ArrayW<uint8_t, ::Array<uint8_t>*> ip2);

  /// @brief Method SpecialEquals, addr 0x258efac, size 0x128, virtual false, abstract: false, final false
  inline bool SpecialEquals(::System::Object* o1, ::System::Object* o2);

  /// @brief Method StringifyIP, addr 0x258f0d4, size 0x1c4, virtual false, abstract: false, final false
  inline ::StringW StringifyIP(::ArrayW<uint8_t, ::Array<uint8_t>*> ip);

  /// @brief Method StringifyIPCollection, addr 0x258f298, size 0x3f0, virtual false, abstract: false, final false
  inline ::StringW StringifyIPCollection(::Org::BouncyCastle::Utilities::Collections::ISet* ips);

  /// @brief Method StringifyOtherNameCollection, addr 0x258f688, size 0x594, virtual false, abstract: false, final false
  inline ::StringW StringifyOtherNameCollection(::Org::BouncyCastle::Utilities::Collections::ISet* otherNames);

  /// @brief Method ToString, addr 0x258fc1c, size 0x6bc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnionDN, addr 0x2584974, size 0x608, virtual false, abstract: false, final false
  ...
  /// @brief Method UnionDns, addr 0x258bccc, size 0x5f0, virtual false, abstract: false, final false
  ...
  /// @brief Method UnionEmail, addr 0x2586494, size 0x43c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnionEmail, addr 0x25868d0, size 0x984, virtual false, abstract: false, final false
  inline void UnionEmail(::StringW email1, ::StringW email2, ::Org::BouncyCastle::Utilities::Collections::ISet* _cordl_union);

  /// @brief Method UnionIP, addr 0x2587c38, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnionIPRange, addr 0x25880ec, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method UnionOtherName, addr 0x25856f0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method UnionUri, addr 0x258cf30, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method WithinDNSubtree, addr 0x2583c20, size 0x3bc, virtual false, abstract: false, final false
  static inline bool WithinDNSubtree(::Org::BouncyCastle::Asn1::Asn1Sequence* dns, ::Org::BouncyCastle::Asn1::Asn1Sequence* subtree);

  /// @brief Method WithinDomain, addr 0x2588f00, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2574ae8, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method checkExcluded, addr 0x258d47c, size 0x128, virtual false, abstract: false, final false
  inline void checkExcluded(::Org::BouncyCastle::Asn1::X509::GeneralName* name);

  /// @brief Method checkPermitted, addr 0x258d354, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method unionURI, addr 0x258ab68, size 0x984, virtual false, abstract: false, final false
