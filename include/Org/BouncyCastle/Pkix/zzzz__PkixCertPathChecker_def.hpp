...
public:
  ...
  /// @brief Method Clone, addr 0x12644fc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12644f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
