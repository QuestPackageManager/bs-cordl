...
public:
  ...
  /// @brief Method Clone, addr 0x34a1bf4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34a1bf0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
