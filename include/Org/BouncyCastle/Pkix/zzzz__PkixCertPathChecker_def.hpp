...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkixCertPathChecker", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkixCertPathChecker(PkixCertPathChecker&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkixCertPathChecker", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkixCertPathChecker(PkixCertPathCheckerconst&) = delete;
