...
public:
  // Declarations
  /// @brief Method FindCrls, addr 0x2583a00, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method FindCrls, addr 0x2582cf0, size 0x798, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* FindCrls(::Org::BouncyCastle::X509::Store::X509CrlStoreSelector* crlselect, ::Org::BouncyCastle::Pkix::PkixParameters* paramsPkix,
                                                                     ::System::DateTime currentDate);

  /// @brief Method FindCrls, addr 0x2583488, size 0x578, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2582ce0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
