...
public:
  // Declarations
  /// @brief Method FindCrls, addr 0x1132f10, size 0x764, virtual true, abstract: false, final false
  ...
  /// @brief Method FindCrls, addr 0x1133bec, size 0x1d4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* FindCrls(::Org::BouncyCastle::X509::Store::X509CrlStoreSelector* crlselect, ::Org::BouncyCastle::Pkix::PkixParameters* paramsPkix);

  /// @brief Method FindCrls, addr 0x1133674, size 0x578, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1132f00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
