...
public:
  ...
  /// @brief Method Clone, addr 0x34cc05c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x34cc0d0, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34cbfd8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PolicyTree, addr 0x34cbfc0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkix::PkixPolicyNode* get_PolicyTree();

  /// @brief Method get_SubjectPublicKey, addr 0x34cbfd0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_SubjectPublicKey();

  /// @brief Method get_TrustAnchor, addr 0x34cbfc8, size 0x8, virtual false, abstract: false, final false
