...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TrustAnchor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TrustAnchor(TrustAnchor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TrustAnchor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TrustAnchor(TrustAnchorconst&) = delete;
