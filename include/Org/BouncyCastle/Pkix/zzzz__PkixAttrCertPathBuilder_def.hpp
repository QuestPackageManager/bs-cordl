...
public:
  ...
  /// @brief Method Build, addr 0x34fef14, size 0xc40, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x34fd18c, size 0xdf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35004a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
