...
public:
  ...
  /// @brief Method Build, addr 0x35bc168, size 0xc40, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x35ba3e0, size 0xdf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35bd6f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
