...
public:
  ...
  /// @brief Method Build, addr 0x135c9d8, size 0xc40, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x135aae0, size 0xee0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x135df70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
