...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder*, "Org.BouncyCastle.Pkix", "PkixAttrCertPathBuilder");
...
public:
  ...
  /// @brief Method Build, addr 0x35be4f0, size 0xc40, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x35bc768, size 0xdf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35bfa80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkixAttrCertPathBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkixAttrCertPathBuilder(PkixAttrCertPathBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkixAttrCertPathBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkixAttrCertPathBuilder(PkixAttrCertPathBuilderconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder) == 0x18, "Size mismatch!");
