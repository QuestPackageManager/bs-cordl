...
public:
  ...
  /// @brief Method ProcessCrlB2 addr 0x10a23ec size 0xe10 virtual false final false
  ...
  /// @brief Method ProcessCertBC addr 0x1086210 size 0xa84 virtual false final false
  ...
  /// @brief Method PrepareNextCertA addr 0x1088d44 size 0x4dc virtual false final false
  static inline void PrepareNextCertA(::Org::BouncyCastle::Pkix::PkixCertPath* certPath, int32_t index);

  /// @brief Method ProcessCertD addr 0x1086c94 size 0x1dd8 virtual false final false
  ...
  /// @brief Method ProcessCrlB1 addr 0x10a31fc size 0x39c virtual false final false
  ...
  /// @brief Method ProcessCrlD addr 0x10a3598 size 0x318 virtual false final false
  ...
  /// @brief Method ProcessCrlF addr 0x10a38b0 size 0xe0c virtual false final false
  ...
  /// @brief Method ProcessCrlG addr 0x10a46bc size 0x46c virtual false final false
  ...
  /// @brief Method ProcessCrlH addr 0x10a4b28 size 0x46c virtual false final false
  ...
  /// @brief Method CheckCrl addr 0x10a4f94 size 0xbb8 virtual false final false
  ...
  /// @brief Method CheckCrls addr 0x10a6224 size 0xa08 virtual false final false
  ...
  /// @brief Method PrepareCertB addr 0x1089220 size 0x1e94 virtual false final false
  ...
  /// @brief Method ProcessCrlA1ii addr 0x10a6c2c size 0x4cc virtual false final false
  ...
  /// @brief Method ProcessCrlA1i addr 0x10a70f8 size 0x4a0 virtual false final false
  ...
  /// @brief Method ProcessCertF addr 0x1088ccc size 0x78 virtual false final false
  ...
  /// @brief Method ProcessCertA addr 0x1085b88 size 0x688 virtual false final false
  ...
  /// @brief Method PrepareNextCertI1 addr 0x108b9c8 size 0x424 virtual false final false
  static inline int32_t PrepareNextCertI1(::Org::BouncyCastle::Pkix::PkixCertPath* certPath, int32_t index, int32_t explicitPolicy);

  /// @brief Method PrepareNextCertI2 addr 0x108bdec size 0x428 virtual false final false
  static inline int32_t PrepareNextCertI2(::Org::BouncyCastle::Pkix::PkixCertPath* certPath, int32_t index, int32_t policyMapping);

  /// @brief Method PrepareNextCertG addr 0x108b0b4 size 0x4f4 virtual false final false
  ...
  /// @brief Method PrepareNextCertJ addr 0x108c214 size 0x270 virtual false final false
  ...
  /// @brief Method PrepareNextCertH1 addr 0x108b5a8 size 0x160 virtual false final false
  static inline int32_t PrepareNextCertH1(::Org::BouncyCastle::Pkix::PkixCertPath* certPath, int32_t index, int32_t explicitPolicy);

  /// @brief Method PrepareNextCertH2 addr 0x108b708 size 0x160 virtual false final false
  static inline int32_t PrepareNextCertH2(::Org::BouncyCastle::Pkix::PkixCertPath* certPath, int32_t index, int32_t policyMapping);

  /// @brief Method PrepareNextCertH3 addr 0x108b868 size 0x160 virtual false final false
  ...
  /// @brief Method WrapupCertA addr 0x108d5ec size 0x7c virtual false final false
  static inline int32_t WrapupCertA(int32_t explicitPolicy, ::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method WrapupCertB addr 0x108d668 size 0x450 virtual false final false
  static inline int32_t WrapupCertB(::Org::BouncyCastle::Pkix::PkixCertPath* certPath, int32_t index, int32_t explicitPolicy);

  /// @brief Method WrapupCertF addr 0x108dab8 size 0x498 virtual false final false
  ...
  /// @brief Method WrapupCertG addr 0x108df50 size 0x1520 virtual false final false
  ...
  /// @brief Method ProcessCrlC addr 0x10a5b4c size 0x588 virtual false final false
  ...
  /// @brief Method ProcessCrlI addr 0x10a60d4 size 0xb8 virtual false final false
  ...
  /// @brief Method ProcessCrlJ addr 0x10a618c size 0x98 virtual false final false
  ...
  /// @brief Method ProcessCertE addr 0x1088a6c size 0x260 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10a7948 size 0x1008 virtual false final false
  inline void _ctor();
