...
public:
  ...
  /// @brief Method Build, addr 0x2574cb0, size 0x860, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Pkix::PkixCertPathBuilderResult* Build(::Org::BouncyCastle::Pkix::PkixBuilderParameters* pkixParams);

  /// @brief Method Build, addr 0x2575510, size 0xc48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2576160, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
