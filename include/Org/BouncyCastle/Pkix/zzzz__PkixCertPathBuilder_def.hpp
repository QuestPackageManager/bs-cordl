...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::PkixCertPathBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::PkixCertPathBuilder*, "Org.BouncyCastle.Pkix", "PkixCertPathBuilder");
...
public:
  ...
  /// @brief Method Build, addr 0x35c4298, size 0x81c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Pkix::PkixCertPathBuilderResult* Build(::Org::BouncyCastle::Pkix::PkixBuilderParameters* pkixParams);

  /// @brief Method Build, addr 0x35c4ab4, size 0xbb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c5668, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::PkixCertPathBuilder) == 0x18, "Size mismatch!");
