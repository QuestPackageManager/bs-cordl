...
public:
  // Declarations
  /// @brief Method CheckCertificate, addr 0x25748c4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x2572330, size 0x1e98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2571d98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
