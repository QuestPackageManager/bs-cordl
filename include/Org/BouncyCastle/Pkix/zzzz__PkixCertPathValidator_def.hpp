...
public:
  // Declarations
  /// @brief Method CheckCertificate, addr 0x35c8180, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x35c5c24, size 0x1e04, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c5664, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
