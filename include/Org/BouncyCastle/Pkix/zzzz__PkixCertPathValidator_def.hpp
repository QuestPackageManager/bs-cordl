...
public:
  // Declarations
  /// @brief Method CheckCertificate, addr 0x2570e14, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x256e880, size 0x1e98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x256e2e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
