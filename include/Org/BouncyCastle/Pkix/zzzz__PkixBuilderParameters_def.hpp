...
public:
  ...
  /// @brief Method Clone, addr 0x1359cf0, size 0xb8, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method GetExcludedCerts, addr 0x1359b44, size 0x68, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetExcludedCerts();

  /// @brief Method GetInstance, addr 0x1359954, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetExcludedCerts, addr 0x1359bac, size 0x80, virtual true, abstract: false, final false
  inline void SetExcludedCerts(::Org::BouncyCastle::Utilities::Collections::ISet* excludedCerts);

  /// @brief Method SetParams, addr 0x1359c2c, size 0xc4, virtual true, abstract: false, final false
  inline void SetParams(::Org::BouncyCastle::Pkix::PkixParameters* parameters);

  /// @brief Method ToString, addr 0x1359da8, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1359a40, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MaxPathLength, addr 0x1359ad8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_MaxPathLength();

  /// @brief Method set_MaxPathLength, addr 0x1359ae0, size 0x64, virtual true, abstract: false, final false
