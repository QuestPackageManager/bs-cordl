...
public:
  ...
  /// @brief Method AddReasons, addr 0x3526cd4, size 0x48, virtual false, abstract: false, final false
  inline void AddReasons(::Org::BouncyCastle::Pkix::ReasonsMask* mask);

  /// @brief Method HasNewReasons, addr 0x3526ea8, size 0x54, virtual false, abstract: false, final false
  inline bool HasNewReasons(::Org::BouncyCastle::Pkix::ReasonsMask* mask);

  /// @brief Method Intersect, addr 0x3526df8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3526ccc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3526cc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t reasons);

  static inline ::Org::BouncyCastle::Pkix::ReasonsMask* getStaticF_AllReasons();

  /// @brief Method get_IsAllReasons, addr 0x3526d80, size 0x78, virtual false, abstract: false, final false
  inline bool get_IsAllReasons();

  /// @brief Method get_Reasons, addr 0x3526d1c, size 0x64, virtual false, abstract: false, final false
