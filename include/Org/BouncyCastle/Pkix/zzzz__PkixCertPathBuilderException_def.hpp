...
public:
  ...
  /// @brief Method .ctor, addr 0x2576298, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x256bb14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x256c334, size 0x4, virtual false, abstract: false, final false
