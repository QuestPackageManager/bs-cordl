...
public:
  ...
  /// @brief Method .ctor, addr 0x2571e98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2567714, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2567f34, size 0x4, virtual false, abstract: false, final false
