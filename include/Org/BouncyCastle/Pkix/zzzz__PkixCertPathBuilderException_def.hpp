...
public:
  ...
  /// @brief Method .ctor, addr 0x118a508, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x117fbb0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11803bc, size 0x4, virtual false, abstract: false, final false
