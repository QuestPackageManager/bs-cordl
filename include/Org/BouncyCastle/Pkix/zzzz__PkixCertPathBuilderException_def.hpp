...
public:
  ...
  /// @brief Method .ctor, addr 0x256e428, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2563ca4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25644c4, size 0x4, virtual false, abstract: false, final false
