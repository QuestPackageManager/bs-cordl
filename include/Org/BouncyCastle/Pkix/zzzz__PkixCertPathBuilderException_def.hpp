...
public:
  ...
  /// @brief Method .ctor, addr 0x135e020, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13536c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1353ed4, size 0x4, virtual false, abstract: false, final false
