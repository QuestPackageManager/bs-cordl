...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Pkix::PkixCertPathBuilderException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Pkix::PkixCertPathBuilderException*, "Org.BouncyCastle.Pkix", "PkixCertPathBuilderException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35c7b2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35bd558, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35bdd24, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkixCertPathBuilderException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkixCertPathBuilderException(PkixCertPathBuilderException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkixCertPathBuilderException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkixCertPathBuilderException(PkixCertPathBuilderExceptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Pkix::PkixCertPathBuilderException) == 0x90, "Size mismatch!");
