...
public:
  ...
  /// @brief Method .ctor, addr 0x1121e34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Pkix::PkixCertPathBuilderException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11174dc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1117ce8, size 0x4, virtual false, abstract: false, final false
