...
public:
  ...
  /// @brief Method .ctor, addr 0x2571ed8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2567754, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2567f74, size 0x4, virtual false, abstract: false, final false
