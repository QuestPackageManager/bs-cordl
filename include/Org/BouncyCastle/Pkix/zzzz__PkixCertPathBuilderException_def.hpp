...
public:
  ...
  /// @brief Method .ctor, addr 0x1164e04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x115a4ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x115acb8, size 0x4, virtual false, abstract: false, final false
