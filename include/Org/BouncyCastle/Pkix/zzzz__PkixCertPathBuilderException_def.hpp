...
public:
  ...
  /// @brief Method .ctor, addr 0x2572560, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2567ddc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25685fc, size 0x4, virtual false, abstract: false, final false
