...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkixCertPathValidatorException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkixCertPathValidatorException(PkixCertPathValidatorException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkixCertPathValidatorException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkixCertPathValidatorException(PkixCertPathValidatorExceptionconst&) = delete;
