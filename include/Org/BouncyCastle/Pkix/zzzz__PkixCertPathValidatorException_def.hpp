...
public:
  ...
  /// @brief Method .ctor, addr 0x257d10c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x257d118, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2569180, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* cause);

  /// @brief Method .ctor, addr 0x2572e54, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* cause, ::Org::BouncyCastle::Pkix::PkixCertPath* certPath, int32_t index);

  /// @brief Method get_CertPath, addr 0x257d158, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Pkix::PkixCertPath* get_CertPath();

  /// @brief Method get_Index, addr 0x257d160, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Index();

  /// @brief Method get_Message, addr 0x257d124, size 0x34, virtual true, abstract: false, final false
