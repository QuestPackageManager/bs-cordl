...
public:
  ...
  /// @brief Method Generate, addr 0x2600c3c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* Generate(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey);

  /// @brief Method Generate, addr 0x2600c44, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x2600cc0, size 0x46c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateJcaObject, addr 0x260112c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x2600774, size 0x58, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetIssuerDN, addr 0x26008a4, size 0x1c, virtual false, abstract: false, final false
  inline void SetIssuerDN(::Org::BouncyCastle::Asn1::X509::X509Name* issuer);

  /// @brief Method SetNotAfter, addr 0x2600934, size 0x74, virtual false, abstract: false, final false
  inline void SetNotAfter(::System::DateTime date);

  /// @brief Method SetNotBefore, addr 0x26008c0, size 0x74, virtual false, abstract: false, final false
  inline void SetNotBefore(::System::DateTime date);

  /// @brief Method SetPublicKey, addr 0x26009c4, size 0x10c, virtual false, abstract: false, final false
  inline void SetPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method SetSerialNumber, addr 0x26007cc, size 0xd8, virtual false, abstract: false, final false
  inline void SetSerialNumber(::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method SetSignatureAlgorithm, addr 0x2600ad0, size 0x16c, virtual false, abstract: false, final false
  inline void SetSignatureAlgorithm(::StringW signatureAlgorithm);

  /// @brief Method SetSubjectDN, addr 0x26009a8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SignatureAlgNames, addr 0x26011fc, size 0x4c, virtual false, abstract: false, final false
