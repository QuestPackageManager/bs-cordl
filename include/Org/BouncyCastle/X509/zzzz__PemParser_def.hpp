...
public:
  ...
  /// @brief Method ReadLine, addr 0x120c104, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW ReadLine(::System::IO::Stream* inStream);

  /// @brief Method ReadPemObject, addr 0x120c1d4, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x120bfec, size 0x118, virtual false, abstract: false, final false
