...
public:
  ...
  /// @brief Method ReadLine, addr 0x351e9a8, size 0xe4, virtual false, abstract: false, final false
  inline ::StringW ReadLine(::System::IO::Stream* inStream);

  /// @brief Method ReadPemObject, addr 0x351ea8c, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x351e88c, size 0x11c, virtual false, abstract: false, final false
