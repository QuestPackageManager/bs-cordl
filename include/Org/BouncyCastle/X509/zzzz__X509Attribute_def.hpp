...
public:
  ...
  /// @brief Method GetValues, addr 0x25f5418, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x25f5528, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f5208, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* at);

  /// @brief Method .ctor, addr 0x25f523c, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method .ctor, addr 0x25f5318, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::Org::BouncyCastle::Asn1::Asn1EncodableVector* value);

  /// @brief Method get_Oid, addr 0x25f53f4, size 0x24, virtual false, abstract: false, final false
