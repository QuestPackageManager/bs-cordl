...
public:
  ...
  /// @brief Method ReadCertPair, addr 0x13de460, size 0x244, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509CertificatePair* ReadCertPair(::System::IO::Stream* inStream);

  /// @brief Method ReadCertPair, addr 0x13de3e8, size 0x78, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509CertificatePair* ReadCertPair(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ReadCertPairs, addr 0x13de71c, size 0x110, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* ReadCertPairs(::System::IO::Stream* inStream);

  /// @brief Method ReadCertPairs, addr 0x13de6a4, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* ReadCertPairs(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ReadDerCrossCertificatePair, addr 0x13de2f4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13de82c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
