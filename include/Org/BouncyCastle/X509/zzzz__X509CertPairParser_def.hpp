...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509CertPairParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509CertPairParser(X509CertPairParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509CertPairParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509CertPairParser(X509CertPairParserconst&) = delete;
