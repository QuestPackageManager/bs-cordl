...
public:
  ...
  /// @brief Method ReadDerCrossCertificatePair addr 0x110a8a0 size 0xf4 virtual false final false
  inline ::Org::BouncyCastle::X509::X509CertificatePair* ReadDerCrossCertificatePair(::System::IO::Stream* inStream);

  /// @brief Method ReadCertPair addr 0x110a994 size 0x78 virtual false final false
  inline ::Org::BouncyCastle::X509::X509CertificatePair* ReadCertPair(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ReadCertPairs addr 0x110ac50 size 0x78 virtual false final false
  inline ::System::Collections::ICollection* ReadCertPairs(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ReadCertPair addr 0x110aa0c size 0x244 virtual false final false
  inline ::Org::BouncyCastle::X509::X509CertificatePair* ReadCertPair(::System::IO::Stream* inStream);

  /// @brief Method ReadCertPairs addr 0x110acc8 size 0x110 virtual false final false
  ...
  /// @brief Method .ctor addr 0x110add8 size 0x8 virtual false final false
  inline void _ctor();
