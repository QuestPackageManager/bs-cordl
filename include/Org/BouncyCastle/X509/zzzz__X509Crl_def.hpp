...
public:
  ...
  /// @brief Method CheckSignature, addr 0x358c138, size 0x400, virtual true, abstract: false, final false
  inline void CheckSignature(::Org::BouncyCastle::Crypto::IVerifierFactory* verifier);

  /// @brief Method Equals, addr 0x358d114, size 0x114, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetEncoded, addr 0x358bf00, size 0xf4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetHashCode, addr 0x358d228, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetRevokedCertificate, addr 0x358caa0, size 0x3f0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509CrlEntry* GetRevokedCertificate(::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method GetRevokedCertificates, addr 0x358ce90, size 0xbc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetRevokedCertificates();

  /// @brief Method GetSigAlgParams, addr 0x358d0b4, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSigAlgParams();

  /// @brief Method GetSignature, addr 0x358d050, size 0x28, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSignature();

  /// @brief Method GetTbsCertList, addr 0x358cf4c, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetTbsCertList();

  /// @brief Method GetX509Extensions, addr 0x358beb4, size 0x4c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* GetX509Extensions();

  /// @brief Method IsRevoked, addr 0x358e20c, size 0xd0, virtual true, abstract: false, final false
  inline bool IsRevoked(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method LoadCrlEntries, addr 0x358c628, size 0x454, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x358d274, size 0xf98, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Verify, addr 0x358bff4, size 0x70, virtual true, abstract: false, final false
  inline void Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method Verify, addr 0x358c064, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x358bcf4, size 0x1c0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::CertificateList* c);

  /// @brief Method get_IsIndirectCrl, addr 0x358e2dc, size 0x170, virtual true, abstract: false, final false
  inline bool get_IsIndirectCrl();

  /// @brief Method get_IssuerDN, addr 0x358c55c, size 0x24, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_IssuerDN();

  /// @brief Method get_NextUpdate, addr 0x358c5ac, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_NextUpdate();

  /// @brief Method get_SigAlgName, addr 0x358d078, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_SigAlgName();

  /// @brief Method get_SigAlgOid, addr 0x358d080, size 0x34, virtual true, abstract: false, final false
  inline ::StringW get_SigAlgOid();

  /// @brief Method get_ThisUpdate, addr 0x358c580, size 0x2c, virtual true, abstract: false, final false
  inline ::System::DateTime get_ThisUpdate();

  /// @brief Method get_Version, addr 0x358c538, size 0x24, virtual true, abstract: false, final false
