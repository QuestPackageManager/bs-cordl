...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AttributeCertificateIssuer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AttributeCertificateIssuer(AttributeCertificateIssuer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AttributeCertificateIssuer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AttributeCertificateIssuer(AttributeCertificateIssuerconst&) = delete;
