...
public:
  ...
  /// @brief Method Clone, addr 0x3582a4c, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method Match, addr 0x3582c10, size 0x718, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3582924, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3582928, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::Store::X509CrlStoreSelector* o);

  /// @brief Method get_AttrCertChecking, addr 0x3582b54, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::IX509AttributeCertificate* get_AttrCertChecking();

  /// @brief Method get_CertificateChecking, addr 0x3582aa8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* get_CertificateChecking();

  /// @brief Method get_CompleteCrlEnabled, addr 0x3582b64, size 0x8, virtual false, abstract: false, final false
  inline bool get_CompleteCrlEnabled();

  /// @brief Method get_DateAndTime, addr 0x3582ab8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_DateAndTime();

  /// @brief Method get_DeltaCrlIndicatorEnabled, addr 0x3582b74, size 0x8, virtual false, abstract: false, final false
  inline bool get_DeltaCrlIndicatorEnabled();

  /// @brief Method get_Issuers, addr 0x3582994, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Issuers();

  /// @brief Method get_IssuingDistributionPoint, addr 0x35829f0, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_IssuingDistributionPoint();

  /// @brief Method get_IssuingDistributionPointEnabled, addr 0x3582bf0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IssuingDistributionPointEnabled();

  /// @brief Method get_MaxBaseCrlNumber, addr 0x3582c00, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_MaxBaseCrlNumber();

  /// @brief Method get_MaxCrlNumber, addr 0x3582b34, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_MaxCrlNumber();

  /// @brief Method get_MinCrlNumber, addr 0x3582b44, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AttrCertChecking, addr 0x3582b5c, size 0x8, virtual false, abstract: false, final false
  inline void set_AttrCertChecking(::Org::BouncyCastle::X509::IX509AttributeCertificate* value);

  /// @brief Method set_CertificateChecking, addr 0x3582ab0, size 0x8, virtual false, abstract: false, final false
  inline void set_CertificateChecking(::Org::BouncyCastle::X509::X509Certificate* value);

  /// @brief Method set_CompleteCrlEnabled, addr 0x3582b6c, size 0x8, virtual false, abstract: false, final false
  inline void set_CompleteCrlEnabled(bool value);

  /// @brief Method set_DateAndTime, addr 0x3582ac0, size 0x8, virtual false, abstract: false, final false
  inline void set_DateAndTime(::Org::BouncyCastle::Utilities::Date::DateTimeObject* value);

  /// @brief Method set_DeltaCrlIndicatorEnabled, addr 0x3582b7c, size 0x8, virtual false, abstract: false, final false
  inline void set_DeltaCrlIndicatorEnabled(bool value);

  /// @brief Method set_Issuers, addr 0x3582ac8, size 0x6c, virtual false, abstract: false, final false
  inline void set_Issuers(::System::Collections::ICollection* value);

  /// @brief Method set_IssuingDistributionPoint, addr 0x3582b84, size 0x6c, virtual false, abstract: false, final false
  inline void set_IssuingDistributionPoint(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_IssuingDistributionPointEnabled, addr 0x3582bf8, size 0x8, virtual false, abstract: false, final false
  inline void set_IssuingDistributionPointEnabled(bool value);

  /// @brief Method set_MaxBaseCrlNumber, addr 0x3582c08, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxBaseCrlNumber(::Org::BouncyCastle::Math::BigInteger* value);

  /// @brief Method set_MaxCrlNumber, addr 0x3582b3c, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxCrlNumber(::Org::BouncyCastle::Math::BigInteger* value);

  /// @brief Method set_MinCrlNumber, addr 0x3582b4c, size 0x8, virtual false, abstract: false, final false
