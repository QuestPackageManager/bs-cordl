...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509CrlStoreSelector", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509CrlStoreSelector(X509CrlStoreSelector&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509CrlStoreSelector", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509CrlStoreSelector(X509CrlStoreSelectorconst&) = delete;
