...
/// @brief Method Clone, addr 0x3546408, size 0x5c, virtual true, abstract: false, final false
inline ::System::Object* Clone() ;

/// @brief Method Match, addr 0x35465cc, size 0x718, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35462e0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x35462e4, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::X509::Store::X509CrlStoreSelector*  o) ;

/// @brief Method get_AttrCertChecking, addr 0x3546510, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::IX509AttributeCertificate* get_AttrCertChecking() ;

/// @brief Method get_CertificateChecking, addr 0x3546464, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* get_CertificateChecking() ;

/// @brief Method get_CompleteCrlEnabled, addr 0x3546520, size 0x8, virtual false, abstract: false, final false
inline bool get_CompleteCrlEnabled() ;

/// @brief Method get_DateAndTime, addr 0x3546474, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_DateAndTime() ;

/// @brief Method get_DeltaCrlIndicatorEnabled, addr 0x3546530, size 0x8, virtual false, abstract: false, final false
inline bool get_DeltaCrlIndicatorEnabled() ;

/// @brief Method get_Issuers, addr 0x3546350, size 0x5c, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* get_Issuers() ;

/// @brief Method get_IssuingDistributionPoint, addr 0x35463ac, size 0x5c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_IssuingDistributionPoint() ;

/// @brief Method get_IssuingDistributionPointEnabled, addr 0x35465ac, size 0x8, virtual false, abstract: false, final false
inline bool get_IssuingDistributionPointEnabled() ;

/// @brief Method get_MaxBaseCrlNumber, addr 0x35465bc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_MaxBaseCrlNumber() ;

/// @brief Method get_MaxCrlNumber, addr 0x35464f0, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_MaxCrlNumber() ;

/// @brief Method get_MinCrlNumber, addr 0x3546500, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_AttrCertChecking, addr 0x3546518, size 0x8, virtual false, abstract: false, final false
inline void set_AttrCertChecking(::Org::BouncyCastle::X509::IX509AttributeCertificate*  value) ;

/// @brief Method set_CertificateChecking, addr 0x354646c, size 0x8, virtual false, abstract: false, final false
inline void set_CertificateChecking(::Org::BouncyCastle::X509::X509Certificate*  value) ;

/// @brief Method set_CompleteCrlEnabled, addr 0x3546528, size 0x8, virtual false, abstract: false, final false
inline void set_CompleteCrlEnabled(bool  value) ;

/// @brief Method set_DateAndTime, addr 0x354647c, size 0x8, virtual false, abstract: false, final false
inline void set_DateAndTime(::Org::BouncyCastle::Utilities::Date::DateTimeObject*  value) ;

/// @brief Method set_DeltaCrlIndicatorEnabled, addr 0x3546538, size 0x8, virtual false, abstract: false, final false
inline void set_DeltaCrlIndicatorEnabled(bool  value) ;

/// @brief Method set_Issuers, addr 0x3546484, size 0x6c, virtual false, abstract: false, final false
inline void set_Issuers(::System::Collections::ICollection*  value) ;

/// @brief Method set_IssuingDistributionPoint, addr 0x3546540, size 0x6c, virtual false, abstract: false, final false
inline void set_IssuingDistributionPoint(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method set_IssuingDistributionPointEnabled, addr 0x35465b4, size 0x8, virtual false, abstract: false, final false
inline void set_IssuingDistributionPointEnabled(bool  value) ;

/// @brief Method set_MaxBaseCrlNumber, addr 0x35465c4, size 0x8, virtual false, abstract: false, final false
inline void set_MaxBaseCrlNumber(::Org::BouncyCastle::Math::BigInteger*  value) ;

/// @brief Method set_MaxCrlNumber, addr 0x35464f8, size 0x8, virtual false, abstract: false, final false
inline void set_MaxCrlNumber(::Org::BouncyCastle::Math::BigInteger*  value) ;

/// @brief Method set_MinCrlNumber, addr 0x3546508, size 0x8, virtual false, abstract: false, final false
