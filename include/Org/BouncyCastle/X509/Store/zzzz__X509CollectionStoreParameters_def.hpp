...
public:
  ...
  /// @brief Method GetCollection, addr 0x12e2cb0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x12e2d08, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12e2bf4, size 0xbc, virtual false, abstract: false, final false
