...
public:
  ...
  /// @brief Method GetCollection, addr 0x13dbc44, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x13dbc9c, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13dbb88, size 0xbc, virtual false, abstract: false, final false
