...
public:
  ...
  /// @brief Method GetCollection, addr 0x25ebce8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x25ebd40, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ebc30, size 0xb8, virtual false, abstract: false, final false
