...
public:
  ...
  /// @brief Method GetCollection, addr 0x25ea9b4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x25eaa0c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ea8fc, size 0xb8, virtual false, abstract: false, final false
