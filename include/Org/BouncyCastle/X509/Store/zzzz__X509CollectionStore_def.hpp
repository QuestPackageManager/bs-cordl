...
public:
  ...
  /// @brief Method GetMatches, addr 0x25eb828, size 0x448, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25eb7b4, size 0x74, virtual false, abstract: false, final false
