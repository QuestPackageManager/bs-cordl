...
public:
  ...
  /// @brief Method GetMatches, addr 0x11e2524, size 0x448, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x11e24b0, size 0x74, virtual false, abstract: false, final false
