...
public:
  ...
  /// @brief Method GetMatches, addr 0x3545d4c, size 0x42c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3545ce0, size 0x6c, virtual false, abstract: false, final false
