...
public:
  ...
  /// @brief Method GetMatches, addr 0x25ebeb0, size 0x448, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25ebe3c, size 0x74, virtual false, abstract: false, final false
