...
public:
  ...
  /// @brief Method GetMatches, addr 0x25efbe8, size 0x448, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25efb74, size 0x74, virtual false, abstract: false, final false
