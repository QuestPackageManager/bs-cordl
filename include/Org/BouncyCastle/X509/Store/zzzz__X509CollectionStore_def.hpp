...
public:
  ...
  /// @brief Method GetMatches, addr 0x25ea4b4, size 0x448, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25ea440, size 0x74, virtual false, abstract: false, final false
