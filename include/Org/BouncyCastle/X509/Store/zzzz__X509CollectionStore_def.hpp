...
public:
  ...
  /// @brief Method GetMatches, addr 0x25eb7e8, size 0x448, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25eb774, size 0x74, virtual false, abstract: false, final false
