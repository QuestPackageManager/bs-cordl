...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::Store::X509CollectionStore*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::Store::X509CollectionStore*, "Org.BouncyCastle.X509.Store", "X509CollectionStore");
...
public:
  ...
  /// @brief Method GetMatches, addr 0x36418bc, size 0x42c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3641850, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509CollectionStore", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509CollectionStore(X509CollectionStore&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509CollectionStore", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509CollectionStore(X509CollectionStoreconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::X509::Store::X509CollectionStore) == 0x18, "Size mismatch!");
