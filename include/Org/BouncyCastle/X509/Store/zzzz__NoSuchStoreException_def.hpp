...
public:
  ...
  /// @brief Method .ctor, addr 0x25a9c64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25a9c68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25a9c6c, size 0x4, virtual false, abstract: false, final false
