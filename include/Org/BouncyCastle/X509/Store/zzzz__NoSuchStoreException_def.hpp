...
public:
  ...
  /// @brief Method .ctor, addr 0x13da284, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13da288, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13da28c, size 0x4, virtual false, abstract: false, final false
