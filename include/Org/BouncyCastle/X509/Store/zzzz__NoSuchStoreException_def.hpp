...
public:
  ...
  /// @brief Method .ctor, addr 0x25e9014, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25e9018, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25e901c, size 0x4, virtual false, abstract: false, final false
