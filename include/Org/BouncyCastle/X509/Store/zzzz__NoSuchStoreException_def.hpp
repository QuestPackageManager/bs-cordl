...
public:
  ...
  /// @brief Method .ctor, addr 0x13e257c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13e2580, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13e2584, size 0x4, virtual false, abstract: false, final false
