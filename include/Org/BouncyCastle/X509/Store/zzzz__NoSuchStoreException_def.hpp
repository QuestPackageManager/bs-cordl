...
public:
  ...
  /// @brief Method .ctor, addr 0x11e1068, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11e106c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11e1070, size 0x4, virtual false, abstract: false, final false
