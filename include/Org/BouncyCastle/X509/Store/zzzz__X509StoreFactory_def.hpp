...
public:
  ...
  /// @brief Method .ctor addr 0x11726f8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Create addr 0x1172700 size 0x3b8 virtual false final false
  ...
  /// @brief Method checkCorrectType addr 0x1172ab8 size 0x380 virtual false final false
