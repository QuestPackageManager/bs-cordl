...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::Store::X509StoreFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::Store::X509StoreFactory*, "Org.BouncyCastle.X509.Store", "X509StoreFactory");
...
public:
  // Declarations
  /// @brief Method Create, addr 0x3640580, size 0x3d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x364057c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method checkCorrectType, addr 0x3640958, size 0x364, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::X509::Store::X509StoreFactory) == 0x10, "Size mismatch!");
