...
public:
  // Declarations
  /// @brief Method Create, addr 0x1209c64, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1209c5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method checkCorrectType, addr 0x120a01c, size 0x380, virtual false, abstract: false, final false
