...
public:
// Declarations
/// @brief Method Create, addr 0x35840c8, size 0x3d8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35840c4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method checkCorrectType, addr 0x35844a0, size 0x364, virtual false, abstract: false, final false
