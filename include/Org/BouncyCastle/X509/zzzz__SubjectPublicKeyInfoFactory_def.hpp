...
public:
  // Declarations
  /// @brief Method CreateSubjectPublicKeyInfo, addr 0x364302c, size 0xdf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractBytes, addr 0x3643f30, size 0xc0, virtual false, abstract: false, final false
  static inline void ExtractBytes(::ArrayW<uint8_t> encKey, int32_t offset, ::Org::BouncyCastle::Math::BigInteger* bI);

  /// @brief Method ExtractBytes, addr 0x3643e1c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3643028, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
