...
public:
// Declarations
/// @brief Method CreateSubjectPublicKeyInfo, addr 0x3586b74, size 0xdf0, virtual false, abstract: false, final false
...
/// @brief Method ExtractBytes, addr 0x3587a78, size 0xc0, virtual false, abstract: false, final false
static inline void ExtractBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  encKey, int32_t  offset, ::Org::BouncyCastle::Math::BigInteger*  bI) ;

/// @brief Method ExtractBytes, addr 0x3587964, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3586b70, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
