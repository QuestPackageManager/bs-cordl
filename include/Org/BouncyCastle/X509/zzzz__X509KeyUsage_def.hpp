...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x25f7bc8, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f7ba0, size 0x28, virtual false, abstract: false, final false
