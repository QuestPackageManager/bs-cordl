...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x3553540, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3553538, size 0x8, virtual false, abstract: false, final false
