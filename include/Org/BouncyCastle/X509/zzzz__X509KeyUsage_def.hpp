...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::X509KeyUsage*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::X509KeyUsage*, "Org.BouncyCastle.X509", "X509KeyUsage");
...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x364f0b0, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x364f0a8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509KeyUsage", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::Org::BouncyCastle::X509::X509KeyUsage) == 0x18, "Size mismatch!");
