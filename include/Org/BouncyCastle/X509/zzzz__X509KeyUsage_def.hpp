...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x13e8f60, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13e8f38, size 0x28, virtual false, abstract: false, final false
