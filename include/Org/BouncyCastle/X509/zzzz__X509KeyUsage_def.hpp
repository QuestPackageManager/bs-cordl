...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x25f8efc, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f8ed4, size 0x28, virtual false, abstract: false, final false
