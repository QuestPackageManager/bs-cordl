...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrincipalUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrincipalUtilities(PrincipalUtilities&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrincipalUtilities", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrincipalUtilities(PrincipalUtilitiesconst&) = delete;
