...
public:
  // Declarations
  /// @brief Method GetIssuerX509Principal, addr 0x25ef050, size 0x114, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetIssuerX509Principal(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method GetIssuerX509Principal, addr 0x25ef278, size 0x114, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetIssuerX509Principal(::Org::BouncyCastle::X509::X509Crl* crl);

  /// @brief Method GetSubjectX509Principal, addr 0x25ef164, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ef38c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
