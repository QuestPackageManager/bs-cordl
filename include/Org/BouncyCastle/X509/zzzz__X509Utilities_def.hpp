...
/// @brief Method CreatePssParams, addr 0x3555f24, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method GetAlgNames, addr 0x355655c, size 0x114, virtual false, abstract: false, final false
static inline ::System::Collections::IEnumerable* GetAlgNames() ;

/// @brief Method GetAlgorithmOid, addr 0x3556028, size 0x21c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW  algorithmName) ;

/// @brief Method GetSigAlgID, addr 0x3556244, size 0x318, virtual false, abstract: false, final false
...
/// @brief Method GetSignatureForObject, addr 0x3556670, size 0x2c8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3556938, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
