...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure*, "Org.BouncyCastle.X509.Extension", "SubjectKeyIdentifierStructure");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubjectKeyIdentifierStructure", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubjectKeyIdentifierStructure(SubjectKeyIdentifierStructure&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubjectKeyIdentifierStructure", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubjectKeyIdentifierStructure(SubjectKeyIdentifierStructureconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure) == 0x18, "Size mismatch!");
