...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure::*)(::Org::BouncyCastle::Asn1::Asn1OctetString*)>(&::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure::_ctor)> {
  constexpr static std::size_t size = 0xa0;
  constexpr static std::size_t addrs = 0x3580d54;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Org::BouncyCastle::Asn1::Asn1OctetString*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::Asn1OctetString* (*)(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*)>(&::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure::FromPublicKey)> {
  constexpr static std::size_t size = 0x1b4;
  constexpr static std::size_t addrs = 0x3580df4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure::*)(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*)>(&::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure::_ctor)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x3580fa8;
...
inline ::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure* Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure::New_ctor(::Org::BouncyCastle::Asn1::Asn1OctetString*  encodedValue)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure*>(encodedValue));
}
inline ::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure* Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure::New_ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  pubKey)  {
