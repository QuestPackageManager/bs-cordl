...
public:
  ...
  /// @brief Method .ctor addr 0x1109abc size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x1109ae8 size 0xa8 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::CertificatePair* pair);

  /// @brief Method GetEncoded addr 0x1109b90 size 0x270 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method get_Forward addr 0x1109e00 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::X509::X509Certificate* get_Forward();

  /// @brief Method get_Reverse addr 0x1109e08 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::X509::X509Certificate* get_Reverse();

  /// @brief Method Equals addr 0x1109e10 size 0xc0 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x1109ed0 size 0x50 virtual true final false
