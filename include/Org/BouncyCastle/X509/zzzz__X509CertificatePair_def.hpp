...
public:
  ...
  /// @brief Method Equals, addr 0x25f4210, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetEncoded, addr 0x25f3fac, size 0x254, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetHashCode, addr 0x25f42d0, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f3ee0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* forward, ::Org::BouncyCastle::X509::X509Certificate* reverse);

  /// @brief Method .ctor, addr 0x25f3f0c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::CertificatePair* pair);

  /// @brief Method get_Forward, addr 0x25f4200, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* get_Forward();

  /// @brief Method get_Reverse, addr 0x25f4208, size 0x8, virtual false, abstract: false, final false
