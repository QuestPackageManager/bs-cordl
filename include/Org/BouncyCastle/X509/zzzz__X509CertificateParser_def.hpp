...
public:
  ...
  /// @brief Method CreateX509Certificate, addr 0x358b1d4, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* CreateX509Certificate(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* c);

  /// @brief Method GetCertificate, addr 0x358b040, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCertificate, addr 0x358b2a4, size 0x2e4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::System::IO::Stream* inStream);

  /// @brief Method ReadCertificate, addr 0x358b230, size 0x74, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ReadCertificates, addr 0x358b5fc, size 0x118, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* ReadCertificates(::System::IO::Stream* inStream);

  /// @brief Method ReadCertificates, addr 0x358b588, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* ReadCertificates(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ReadDerCertificate, addr 0x358ae1c, size 0x224, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* ReadDerCertificate(::Org::BouncyCastle::Asn1::Asn1InputStream* dIn);

  /// @brief Method ReadPemCertificate, addr 0x358b128, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x358b7a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
