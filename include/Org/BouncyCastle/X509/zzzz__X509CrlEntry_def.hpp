...
public:
  ...
  /// @brief Method Equals, addr 0x11ee9fc, size 0xf4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetCertificateIssuer, addr 0x11ee870, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetCertificateIssuer();

  /// @brief Method GetEncoded, addr 0x11ee894, size 0xf8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetHashCode, addr 0x11eeaf0, size 0x5c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetX509Extensions, addr 0x11ee878, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x11eeb4c, size 0x7f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ee698, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::CrlEntry* c);

  /// @brief Method .ctor, addr 0x11ecc24, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HasExtensions, addr 0x11ee9d4, size 0x28, virtual false, abstract: false, final false
  inline bool get_HasExtensions();

  /// @brief Method get_RevocationDate, addr 0x11ee9b0, size 0x24, virtual false, abstract: false, final false
  inline ::System::DateTime get_RevocationDate();

  /// @brief Method get_SerialNumber, addr 0x11ee98c, size 0x24, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber();

  /// @brief Method loadCertificateIssuer, addr 0x11ee6cc, size 0x1a4, virtual false, abstract: false, final false
