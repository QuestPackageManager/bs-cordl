...
/// @brief Method Equals, addr 0x3552168, size 0xe8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetCertificateIssuer, addr 0x3551fe4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetCertificateIssuer() ;

/// @brief Method GetEncoded, addr 0x3552004, size 0xf4, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetHashCode, addr 0x3552250, size 0x4c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetX509Extensions, addr 0x3551fec, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x355229c, size 0x834, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3551e08, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::CrlEntry*  c) ;

/// @brief Method .ctor, addr 0x3550438, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get_HasExtensions, addr 0x3552140, size 0x28, virtual false, abstract: false, final false
inline bool get_HasExtensions() ;

/// @brief Method get_RevocationDate, addr 0x355211c, size 0x24, virtual false, abstract: false, final false
inline ::System::DateTime get_RevocationDate() ;

/// @brief Method get_SerialNumber, addr 0x35520f8, size 0x24, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber() ;

/// @brief Method loadCertificateIssuer, addr 0x3551e24, size 0x1c0, virtual false, abstract: false, final false
