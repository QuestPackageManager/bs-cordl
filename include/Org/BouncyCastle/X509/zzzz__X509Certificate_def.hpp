...
/// @brief Method CheckSignature, addr 0x354de10, size 0x3f8, virtual true, abstract: false, final false
inline void CheckSignature(::Org::BouncyCastle::Crypto::IVerifierFactory*  verifier) ;

/// @brief Method CheckValidity, addr 0x354bf70, size 0x70, virtual true, abstract: false, final false
inline void CheckValidity() ;

/// @brief Method CheckValidity, addr 0x354bfe0, size 0x1f0, virtual true, abstract: false, final false
inline void CheckValidity(::System::DateTime  time) ;

/// @brief Method Equals, addr 0x354cdd4, size 0x114, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetAlternativeNames, addr 0x354ca0c, size 0x2dc, virtual true, abstract: false, final false
inline ::System::Collections::ICollection* GetAlternativeNames(::StringW  oid) ;

/// @brief Method GetBasicConstraints, addr 0x354c8e8, size 0x74, virtual true, abstract: false, final false
inline int32_t GetBasicConstraints() ;

/// @brief Method GetEncoded, addr 0x354cdbc, size 0x18, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetExtendedKeyUsage, addr 0x354c44c, size 0x49c, virtual true, abstract: false, final false
inline ::System::Collections::IList* GetExtendedKeyUsage() ;

/// @brief Method GetHashCode, addr 0x354cee8, size 0x4c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetIssuerAlternativeNames, addr 0x354c9b4, size 0x58, virtual true, abstract: false, final false
inline ::System::Collections::ICollection* GetIssuerAlternativeNames() ;

/// @brief Method GetKeyUsage, addr 0x354c3ec, size 0x60, virtual true, abstract: false, final false
inline ::ArrayW<bool,::Array<bool>*> GetKeyUsage() ;

/// @brief Method GetPublicKey, addr 0x354cd34, size 0x88, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* GetPublicKey() ;

/// @brief Method GetSigAlgParams, addr 0x354c344, size 0x60, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSigAlgParams() ;

/// @brief Method GetSignature, addr 0x354c2e0, size 0x28, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignature() ;

/// @brief Method GetSubjectAlternativeNames, addr 0x354c95c, size 0x58, virtual true, abstract: false, final false
inline ::System::Collections::ICollection* GetSubjectAlternativeNames() ;

/// @brief Method GetTbsCertificate, addr 0x354c2bc, size 0x24, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetTbsCertificate() ;

/// @brief Method GetX509Extensions, addr 0x354cce8, size 0x4c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* GetX509Extensions() ;

/// @brief Method IsAlgIDEqual, addr 0x354e208, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x354be6c, size 0x104, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x354cf34, size 0xd88, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Verify, addr 0x354dcbc, size 0x80, virtual true, abstract: false, final false
inline void Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  key) ;

/// @brief Method Verify, addr 0x354dd3c, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x354b568, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x354b5b8, size 0x52c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*  c) ;

/// @brief Method get_CertificateStructure, addr 0x354bdf4, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* get_CertificateStructure() ;

/// @brief Method get_IsValidNow, addr 0x354bdfc, size 0x70, virtual true, abstract: false, final false
inline bool get_IsValidNow() ;

/// @brief Method get_IssuerDN, addr 0x354c21c, size 0x24, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_IssuerDN() ;

/// @brief Method get_IssuerUniqueID, addr 0x354c3a4, size 0x24, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_IssuerUniqueID() ;

/// @brief Method get_NotAfter, addr 0x354c290, size 0x2c, virtual true, abstract: false, final false
inline ::System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore, addr 0x354c264, size 0x2c, virtual true, abstract: false, final false
inline ::System::DateTime get_NotBefore() ;

/// @brief Method get_SerialNumber, addr 0x354c1f0, size 0x2c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber() ;

/// @brief Method get_SigAlgName, addr 0x354c308, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_SigAlgName() ;

/// @brief Method get_SigAlgOid, addr 0x354c310, size 0x34, virtual true, abstract: false, final false
inline ::StringW get_SigAlgOid() ;

/// @brief Method get_SubjectDN, addr 0x354c240, size 0x24, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_SubjectDN() ;

/// @brief Method get_SubjectUniqueID, addr 0x354c3c8, size 0x24, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_SubjectUniqueID() ;

/// @brief Method get_Version, addr 0x354c1d0, size 0x20, virtual true, abstract: false, final false
