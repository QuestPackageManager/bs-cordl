...
public:
  ...
  /// @brief Method GetCertificate, addr 0x25ef240, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAttrCert, addr 0x25ef5ec, size 0x2d0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::IX509AttributeCertificate* ReadAttrCert(::System::IO::Stream* inStream);

  /// @brief Method ReadAttrCert, addr 0x25ef57c, size 0x70, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::IX509AttributeCertificate* ReadAttrCert(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ReadAttrCerts, addr 0x25ef92c, size 0x110, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* ReadAttrCerts(::System::IO::Stream* inStream);

  /// @brief Method ReadAttrCerts, addr 0x25ef8bc, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* ReadAttrCerts(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ReadDerCertificate, addr 0x25ef004, size 0x23c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::IX509AttributeCertificate* ReadDerCertificate(::Org::BouncyCastle::Asn1::Asn1InputStream* dIn);

  /// @brief Method ReadPemCertificate, addr 0x25ef4c4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25efacc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
