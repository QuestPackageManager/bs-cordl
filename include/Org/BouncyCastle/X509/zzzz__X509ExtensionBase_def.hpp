...
public:
  ...
  /// @brief Method GetExtensionOids addr 0x102a5a4 size 0x3f0 virtual true final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetExtensionOids(bool critical);

  /// @brief Method GetNonCriticalExtensionOids addr 0x102a994 size 0x10 virtual true final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetNonCriticalExtensionOids();

  /// @brief Method GetCriticalExtensionOids addr 0x102a9a4 size 0x10 virtual true final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetCriticalExtensionOids();

  /// @brief Method GetExtensionValue addr 0x102a9b4 size 0x7c virtual true final true
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetExtensionValue(::StringW oid);

  /// @brief Method GetExtensionValue addr 0x102aa30 size 0x38 virtual true final false
  ...
  /// @brief Method .ctor addr 0x102aa68 size 0x8 virtual false final false
  inline void _ctor();
