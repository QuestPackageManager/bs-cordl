...
/// @brief Method GetCriticalExtensionOids, addr 0x34b355c, size 0x10, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetCriticalExtensionOids() ;

/// @brief Method GetExtensionOids, addr 0x34b3174, size 0x3d8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetExtensionOids(bool  critical) ;

/// @brief Method GetExtensionValue, addr 0x34b35e4, size 0x38, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetExtensionValue(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetExtensionValue, addr 0x34b356c, size 0x78, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetExtensionValue(::StringW  oid) ;

/// @brief Method GetNonCriticalExtensionOids, addr 0x34b354c, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34b361c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
