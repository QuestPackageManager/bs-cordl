...
public:
  ...
  /// @brief Method AddAttribute, addr 0x2602b68, size 0x44, virtual false, abstract: false, final false
  inline void AddAttribute(::Org::BouncyCastle::X509::X509Attribute* attribute);

  /// @brief Method AddExtension, addr 0x2602c84, size 0x94, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t, ::Array<uint8_t>*> extensionValue);

  /// @brief Method AddExtension, addr 0x2602bf0, size 0x94, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::Org::BouncyCastle::Asn1::Asn1Encodable* extensionValue);

  /// @brief Method Generate, addr 0x2602d18, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x2602d20, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x2602d9c, size 0x554, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x26027fc, size 0x68, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetHolder, addr 0x2602864, size 0x24, virtual false, abstract: false, final false
  inline void SetHolder(::Org::BouncyCastle::X509::AttributeCertificateHolder* holder);

  /// @brief Method SetIssuer, addr 0x2602888, size 0x2c, virtual false, abstract: false, final false
  inline void SetIssuer(::Org::BouncyCastle::X509::AttributeCertificateIssuer* issuer);

  /// @brief Method SetIssuerUniqueId, addr 0x2602bac, size 0x44, virtual false, abstract: false, final false
  inline void SetIssuerUniqueId(::ArrayW<bool, ::Array<bool>*> iui);

  /// @brief Method SetNotAfter, addr 0x260299c, size 0x74, virtual false, abstract: false, final false
  inline void SetNotAfter(::System::DateTime date);

  /// @brief Method SetNotBefore, addr 0x2602928, size 0x74, virtual false, abstract: false, final false
  inline void SetNotBefore(::System::DateTime date);

  /// @brief Method SetSerialNumber, addr 0x26028b4, size 0x74, virtual false, abstract: false, final false
  inline void SetSerialNumber(::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method SetSignatureAlgorithm, addr 0x2602a10, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2602764, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAlgNames, addr 0x26032f0, size 0x4c, virtual false, abstract: false, final false
