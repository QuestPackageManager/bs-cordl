...
public:
  ...
  /// @brief Method .ctor, addr 0x11863b4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Reset, addr 0x1186450, size 0x6c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetSerialNumber, addr 0x11864bc, size 0xe0, virtual false, abstract: false, final false
  inline void SetSerialNumber(::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method SetIssuerDN, addr 0x118659c, size 0x1c, virtual false, abstract: false, final false
  inline void SetIssuerDN(::Org::BouncyCastle::Asn1::X509::X509Name* issuer);

  /// @brief Method SetNotBefore, addr 0x11865b8, size 0x78, virtual false, abstract: false, final false
  inline void SetNotBefore(::System::DateTime date);

  /// @brief Method SetNotAfter, addr 0x1186630, size 0x78, virtual false, abstract: false, final false
  inline void SetNotAfter(::System::DateTime date);

  /// @brief Method SetSubjectDN, addr 0x11866a8, size 0x1c, virtual false, abstract: false, final false
  inline void SetSubjectDN(::Org::BouncyCastle::Asn1::X509::X509Name* subject);

  /// @brief Method SetPublicKey, addr 0x11866c4, size 0x24, virtual false, abstract: false, final false
  inline void SetPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method SetSignatureAlgorithm, addr 0x11866e8, size 0x16c, virtual false, abstract: false, final false
  inline void SetSignatureAlgorithm(::StringW signatureAlgorithm);

  /// @brief Method SetSubjectUniqueID, addr 0x1186854, size 0x20, virtual false, abstract: false, final false
  inline void SetSubjectUniqueID(::ArrayW<bool, ::Array<bool>*> uniqueID);

  /// @brief Method SetIssuerUniqueID, addr 0x11869cc, size 0x20, virtual false, abstract: false, final false
  inline void SetIssuerUniqueID(::ArrayW<bool, ::Array<bool>*> uniqueID);

  /// @brief Method booleanToBitString, addr 0x1186874, size 0x158, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* booleanToBitString(::ArrayW<bool, ::Array<bool>*> id);

  /// @brief Method AddExtension, addr 0x11869ec, size 0x98, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::Org::BouncyCastle::Asn1::Asn1Encodable* extensionValue);

  /// @brief Method AddExtension, addr 0x1186a84, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method AddExtension, addr 0x1186aa4, size 0xc8, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t, ::Array<uint8_t>*> extensionValue);

  /// @brief Method AddExtension, addr 0x1186b6c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyAndAddExtension, addr 0x1186c04, size 0x8c, virtual false, abstract: false, final false
  inline void CopyAndAddExtension(::StringW oid, bool critical, ::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method CopyAndAddExtension, addr 0x1186c90, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x1186e3c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::X509Certificate* Generate(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey);

  /// @brief Method Generate, addr 0x1186e44, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x1186ec8, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateJcaObject, addr 0x1187370, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SignatureAlgNames, addr 0x1187448, size 0x4c, virtual false, abstract: false, final false
