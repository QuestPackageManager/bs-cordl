...
public:
  ...
  /// @brief Method .ctor addr 0x111616c size 0x9c virtual false final false
  inline void _ctor();

  /// @brief Method Reset addr 0x1116208 size 0x6c virtual false final false
  inline void Reset();

  /// @brief Method SetSerialNumber addr 0x1116274 size 0xe0 virtual false final false
  inline void SetSerialNumber(::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method SetIssuerDN addr 0x1116354 size 0x1c virtual false final false
  inline void SetIssuerDN(::Org::BouncyCastle::Asn1::X509::X509Name* issuer);

  /// @brief Method SetNotBefore addr 0x1116370 size 0x78 virtual false final false
  inline void SetNotBefore(::System::DateTime date);

  /// @brief Method SetNotAfter addr 0x11163e8 size 0x78 virtual false final false
  inline void SetNotAfter(::System::DateTime date);

  /// @brief Method SetSubjectDN addr 0x1116460 size 0x1c virtual false final false
  inline void SetSubjectDN(::Org::BouncyCastle::Asn1::X509::X509Name* subject);

  /// @brief Method SetPublicKey addr 0x111647c size 0x24 virtual false final false
  inline void SetPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method SetSignatureAlgorithm addr 0x11164a0 size 0x16c virtual false final false
  inline void SetSignatureAlgorithm(::StringW signatureAlgorithm);

  /// @brief Method SetSubjectUniqueID addr 0x111660c size 0x20 virtual false final false
  inline void SetSubjectUniqueID(::ArrayW<bool, ::Array<bool>*> uniqueID);

  /// @brief Method SetIssuerUniqueID addr 0x1116784 size 0x20 virtual false final false
  inline void SetIssuerUniqueID(::ArrayW<bool, ::Array<bool>*> uniqueID);

  /// @brief Method booleanToBitString addr 0x111662c size 0x158 virtual false final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* booleanToBitString(::ArrayW<bool, ::Array<bool>*> id);

  /// @brief Method AddExtension addr 0x11167a4 size 0x98 virtual false final false
  inline void AddExtension(::StringW oid, bool critical, ::Org::BouncyCastle::Asn1::Asn1Encodable* extensionValue);

  /// @brief Method AddExtension addr 0x111683c size 0x20 virtual false final false
  ...
  /// @brief Method AddExtension addr 0x111685c size 0xc8 virtual false final false
  inline void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t, ::Array<uint8_t>*> extensionValue);

  /// @brief Method AddExtension addr 0x1116924 size 0x98 virtual false final false
  ...
  /// @brief Method CopyAndAddExtension addr 0x11169bc size 0x8c virtual false final false
  inline void CopyAndAddExtension(::StringW oid, bool critical, ::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method CopyAndAddExtension addr 0x1116a48 size 0x1ac virtual false final false
  ...
  /// @brief Method Generate addr 0x1116bf4 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::X509::X509Certificate* Generate(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey);

  /// @brief Method Generate addr 0x1116bfc size 0x84 virtual false final false
  ...
  /// @brief Method Generate addr 0x1116c80 size 0x4a8 virtual false final false
  ...
  /// @brief Method GenerateJcaObject addr 0x1117128 size 0xd8 virtual false final false
  ...
  /// @brief Method get_SignatureAlgNames addr 0x1117200 size 0x4c virtual false final false
