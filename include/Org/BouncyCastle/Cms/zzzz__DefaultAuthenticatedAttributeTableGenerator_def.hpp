...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::DefaultAuthenticatedAttributeTableGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::DefaultAuthenticatedAttributeTableGenerator*, "Org.BouncyCastle.Cms", "DefaultAuthenticatedAttributeTableGenerator");
...
public:
  ...
  /// @brief Method CreateStandardAttributeTable, addr 0x36c90c4, size 0x510, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* CreateStandardAttributeTable(::System::Collections::IDictionary* parameters);

  /// @brief Method GetAttributes, addr 0x36c95d4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36c8fe4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36c9044, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::DefaultAuthenticatedAttributeTableGenerator) == 0x18, "Size mismatch!");
