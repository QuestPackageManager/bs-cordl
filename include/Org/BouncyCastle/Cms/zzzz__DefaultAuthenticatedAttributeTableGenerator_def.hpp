...
public:
  ...
  /// @brief Method CreateStandardAttributeTable, addr 0x2673770, size 0x52c, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* CreateStandardAttributeTable(::System::Collections::IDictionary* parameters);

  /// @brief Method GetAttributes, addr 0x2673c9c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2673688, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26736f0, size 0x80, virtual false, abstract: false, final false
