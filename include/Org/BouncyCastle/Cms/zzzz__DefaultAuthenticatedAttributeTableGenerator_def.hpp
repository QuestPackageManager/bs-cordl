...
public:
  ...
  /// @brief Method CreateStandardAttributeTable, addr 0x2640484, size 0x52c, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* CreateStandardAttributeTable(::System::Collections::IDictionary* parameters);

  /// @brief Method GetAttributes, addr 0x26409b0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264039c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2640404, size 0x80, virtual false, abstract: false, final false
