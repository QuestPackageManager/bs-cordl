...
public:
  ...
  /// @brief Method CreateStandardAttributeTable, addr 0x360be70, size 0x510, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* CreateStandardAttributeTable(::System::Collections::IDictionary* parameters);

  /// @brief Method GetAttributes, addr 0x360c380, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x360bd90, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x360bdf0, size 0x80, virtual false, abstract: false, final false
