...
public:
  ...
  /// @brief Method .ctor, addr 0x126e8c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x126e8c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x126e8cc, size 0x4, virtual false, abstract: false, final false
