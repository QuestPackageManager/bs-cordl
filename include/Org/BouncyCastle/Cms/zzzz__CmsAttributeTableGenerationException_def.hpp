...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAttributeTableGenerationException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAttributeTableGenerationException*, "Org.BouncyCastle.Cms", "CmsAttributeTableGenerationException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36a498c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36a4990, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x36a4994, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsAttributeTableGenerationException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsAttributeTableGenerationException(CmsAttributeTableGenerationException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsAttributeTableGenerationException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsAttributeTableGenerationException(CmsAttributeTableGenerationExceptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAttributeTableGenerationException) == 0x90, "Size mismatch!");
