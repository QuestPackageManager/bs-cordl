...
public:
  ...
  /// @brief Method .ctor, addr 0x264efc0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264efc4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x264efc8, size 0x4, virtual false, abstract: false, final false
