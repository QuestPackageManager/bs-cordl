...
public:
  ...
  /// @brief Method CreateContentCipher, addr 0x35d0c84, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x35d0d8c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x35d0cf8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d0d9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
