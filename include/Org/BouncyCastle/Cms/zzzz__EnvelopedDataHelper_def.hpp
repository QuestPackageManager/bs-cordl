...
public:
  ...
  /// @brief Method CreateContentCipher, addr 0x36ca46c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x36ca574, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x36ca4e0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36ca584, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
