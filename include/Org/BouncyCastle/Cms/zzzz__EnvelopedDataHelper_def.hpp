...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnvelopedDataHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnvelopedDataHelper(EnvelopedDataHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnvelopedDataHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnvelopedDataHelper(EnvelopedDataHelperconst&) = delete;
