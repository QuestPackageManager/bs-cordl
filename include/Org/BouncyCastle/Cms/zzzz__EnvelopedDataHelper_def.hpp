...
public:
  ...
  /// @brief Method CreateContentCipher, addr 0x267b27c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x267b37c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x267b2ec, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267b38c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
