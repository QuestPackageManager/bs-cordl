...
public:
  ...
  /// @brief Method Close, addr 0x144f594, size 0x138, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x144f570, size 0x24, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x144f54c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x144f340, size 0x50, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Open, addr 0x144f390, size 0xdc, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::StringW encryptionOid);

  /// @brief Method Open, addr 0x144f46c, size 0xe0, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::StringW encryptionOid, int32_t keySize);

  /// @brief Method Open, addr 0x144ea94, size 0x8ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x144e49c, size 0x5f8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStr, ::StringW macOid, ::Org::BouncyCastle::Crypto::CipherKeyGenerator* keyGen);

  /// @brief Method SetBerEncodeRecipients, addr 0x144e490, size 0xc, virtual false, abstract: false, final false
  inline void SetBerEncodeRecipients(bool berEncodeRecipientSet);

  /// @brief Method SetBufferSize, addr 0x144e488, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x144e480, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x144e484, size 0x4, virtual false, abstract: false, final false
