...
/// @brief Method Close, addr 0x35acbd0, size 0x150, virtual true, abstract: false, final false
inline void Close() ;

static inline ::Org::BouncyCastle::Cms::CmsAuthenticatedDataStreamGenerator_CmsAuthenticatedDataOutputStream* New_ctor(::System::IO::Stream*  macStream, ::Org::BouncyCastle::Crypto::IMac*  mac, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  cGen, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  authGen, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  eiGen) ;

/// @brief Method Write, addr 0x35acbb0, size 0x20, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x35acb90, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35ac97c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x35ac9cc, size 0xe0, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStr, ::StringW  encryptionOid) ;

/// @brief Method Open, addr 0x35acaac, size 0xe4, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStr, ::StringW  encryptionOid, int32_t  keySize) ;

/// @brief Method Open, addr 0x35ac140, size 0x83c, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x35abb44, size 0x5fc, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStr, ::StringW  macOid, ::Org::BouncyCastle::Crypto::CipherKeyGenerator*  keyGen) ;

/// @brief Method SetBerEncodeRecipients, addr 0x35abb3c, size 0x8, virtual false, abstract: false, final false
inline void SetBerEncodeRecipients(bool  berEncodeRecipientSet) ;

/// @brief Method SetBufferSize, addr 0x35abb34, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35abb2c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x35abb30, size 0x4, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Cms::CmsAuthenticatedDataStreamGenerator_CmsAuthenticatedDataOutputStream*, "Org.BouncyCastle.Cms", "CmsAuthenticatedDataStreamGenerator/CmsAuthenticatedDataOutputStream");
