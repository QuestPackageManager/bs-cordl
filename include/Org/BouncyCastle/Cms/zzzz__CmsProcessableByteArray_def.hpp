...
public:
  ...
  /// @brief Method GetContent, addr 0x135325c, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Object* GetContent();

  /// @brief Method GetInputStream, addr 0x13531b8, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x1353224, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x135310c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x1353184, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* type, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method get_Type, addr 0x13531b0, size 0x8, virtual false, abstract: false, final false
