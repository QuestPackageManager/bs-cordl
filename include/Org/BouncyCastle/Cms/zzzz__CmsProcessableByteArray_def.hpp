...
public:
  ...
  /// @brief Method GetContent, addr 0x35f0f1c, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* GetContent();

  /// @brief Method GetInputStream, addr 0x35f0e7c, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x35f0ee4, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35f0dfc, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x35f0e6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* type, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method get_Type, addr 0x35f0e74, size 0x8, virtual false, abstract: false, final false
