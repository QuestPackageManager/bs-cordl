...
/// @brief Method GetContent, addr 0x360ecfc, size 0x100, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetContent(::Org::BouncyCastle::Crypto::ICipherParameters*  key) ;

/// @brief Method GetContentAlgorithmName, addr 0x360e994, size 0xc0, virtual false, abstract: false, final false
inline ::StringW GetContentAlgorithmName() ;

/// @brief Method GetContentFromSessionKey, addr 0x360eac8, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method GetMac, addr 0x360edfc, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x360e91c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method get_KeyEncryptionAlgOid, addr 0x360ea64, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_KeyEncryptionAlgOid() ;

/// @brief Method get_KeyEncryptionAlgParams, addr 0x360ea90, size 0x38, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* get_KeyEncryptionAlgParams() ;

/// @brief Method get_KeyEncryptionAlgorithmID, addr 0x360ea5c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyEncryptionAlgorithmID() ;

/// @brief Method get_RecipientID, addr 0x360ea54, size 0x8, virtual false, abstract: false, final false
