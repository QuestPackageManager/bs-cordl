...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::RecipientInformation*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::RecipientInformation*, "Org.BouncyCastle.Cms", "RecipientInformation");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_resultMac, put = __cordl_internal_set_resultMac)) ::ArrayW<uint8_t> resultMac;
  ...
  /// @brief Method GetContent, addr 0x36cb1b4, size 0x100, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetContent(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetContentAlgorithmName, addr 0x36cae4c, size 0xc0, virtual false, abstract: false, final false
  inline ::StringW GetContentAlgorithmName();

  /// @brief Method GetContentFromSessionKey, addr 0x36caf80, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMac, addr 0x36cb2b4, size 0x178, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_resultMac() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_resultMac();
  ...
  constexpr void __cordl_internal_set_resultMac(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x36cadd4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyEncryptionAlgOid, addr 0x36caf1c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_KeyEncryptionAlgOid();

  /// @brief Method get_KeyEncryptionAlgParams, addr 0x36caf48, size 0x38, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_KeyEncryptionAlgParams();

  /// @brief Method get_KeyEncryptionAlgorithmID, addr 0x36caf14, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyEncryptionAlgorithmID();

  /// @brief Method get_RecipientID, addr 0x36caf0c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::RecipientInformation) == 0x30, "Size mismatch!");
