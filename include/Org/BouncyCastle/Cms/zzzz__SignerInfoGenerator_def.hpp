...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::SignerInfoGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::SignerInfoGenerator*, "Org.BouncyCastle.Cms", "SignerInfoGenerator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36d3bdc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d3b48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d3b50, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method setAssociatedCertificate, addr 0x36d3bec, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignerInfoGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignerInfoGenerator(SignerInfoGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignerInfoGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignerInfoGenerator(SignerInfoGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cms::SignerInfoGenerator) == 0x40, "Size mismatch!");
