...
public:
  ...
  /// @brief Method Equals, addr 0x267dab0, size 0x160, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x267da04, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267787c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_KeyIdentifier, addr 0x267d9a8, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyIdentifier();

  /// @brief Method set_KeyIdentifier, addr 0x2677e3c, size 0x6c, virtual false, abstract: false, final false
