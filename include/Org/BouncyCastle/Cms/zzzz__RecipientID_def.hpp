...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecipientID", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecipientID(RecipientID&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecipientID", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecipientID(RecipientIDconst&) = delete;
