...
public:
  ...
  /// @brief Method Equals, addr 0x36d1058, size 0x178, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x36d0fa8, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36cae40, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_KeyIdentifier, addr 0x36d0f48, size 0x60, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_KeyIdentifier();

  /// @brief Method set_KeyIdentifier, addr 0x36cb42c, size 0x70, virtual false, abstract: false, final false
