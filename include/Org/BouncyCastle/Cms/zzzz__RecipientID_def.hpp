...
public:
  ...
  /// @brief Method Equals, addr 0x35ad02c, size 0x178, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x35acf7c, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a6e14, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_KeyIdentifier, addr 0x35acf1c, size 0x60, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyIdentifier();

  /// @brief Method set_KeyIdentifier, addr 0x35a7400, size 0x70, virtual false, abstract: false, final false
