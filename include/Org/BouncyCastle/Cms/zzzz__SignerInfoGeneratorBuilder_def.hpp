...
public:
  ...
  /// @brief Method Build, addr 0x267cf48, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x267d16c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGenerator, addr 0x267d070, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDirectSignature, addr 0x267cf2c, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::SignerInfoGeneratorBuilder* SetDirectSignature(bool hasNoSignedAttributes);

  /// @brief Method WithSignedAttributeGenerator, addr 0x267cf38, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method WithUnsignedAttributeGenerator, addr 0x267cf40, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267cf24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
