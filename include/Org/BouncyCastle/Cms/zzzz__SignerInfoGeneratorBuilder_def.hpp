...
public:
  ...
  /// @brief Method Build, addr 0x267a80c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x267aa30, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGenerator, addr 0x267a934, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDirectSignature, addr 0x267a7f0, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::SignerInfoGeneratorBuilder* SetDirectSignature(bool hasNoSignedAttributes);

  /// @brief Method WithSignedAttributeGenerator, addr 0x267a7fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method WithUnsignedAttributeGenerator, addr 0x267a804, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267a7e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
