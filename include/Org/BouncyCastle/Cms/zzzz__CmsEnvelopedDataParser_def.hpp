...
public:
  ...
  /// @brief Method GetRecipientInfos, addr 0x36a9be8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos();

  /// @brief Method GetUnprotectedAttributes, addr 0x36a9bf0, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a9810, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> envelopedData);

  /// @brief Method .ctor, addr 0x36a9884, size 0x2f8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* envelopedData);

  /// @brief Method get_EncryptionAlgOid, addr 0x36a9b84, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_EncryptionAlgOid();

  /// @brief Method get_EncryptionAlgParams, addr 0x36a9bb0, size 0x38, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_EncryptionAlgParams();

  /// @brief Method get_EncryptionAlgorithmID, addr 0x36a9b7c, size 0x8, virtual false, abstract: false, final false
