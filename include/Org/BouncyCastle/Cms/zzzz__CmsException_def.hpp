...
public:
  ...
  /// @brief Method .ctor, addr 0x2653290, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26532e8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x2653350, size 0x70, virtual false, abstract: false, final false
