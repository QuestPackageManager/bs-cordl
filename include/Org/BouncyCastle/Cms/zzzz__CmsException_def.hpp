...
public:
  ...
  /// @brief Method .ctor, addr 0x264b420, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264b478, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x264b4e0, size 0x70, virtual false, abstract: false, final false
