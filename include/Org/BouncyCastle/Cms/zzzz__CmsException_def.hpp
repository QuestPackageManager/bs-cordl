...
public:
  ...
  /// @brief Method .ctor, addr 0x144b5a4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x144b5fc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x144b664, size 0x70, virtual false, abstract: false, final false
