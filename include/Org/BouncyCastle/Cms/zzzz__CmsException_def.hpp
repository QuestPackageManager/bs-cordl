...
public:
  ...
  /// @brief Method .ctor, addr 0x264db5c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264dbb4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x264dc1c, size 0x70, virtual false, abstract: false, final false
