...
public:
  ...
  /// @brief Method .ctor, addr 0x264eed0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264ef28, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x264ef90, size 0x70, virtual false, abstract: false, final false
