...
public:
  ...
  /// @brief Method .ctor, addr 0x35e5278, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35e52d0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x35e533c, size 0x74, virtual false, abstract: false, final false
