...
public:
  ...
  /// @brief Method .ctor, addr 0x264f558, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264f5b0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x264f618, size 0x70, virtual false, abstract: false, final false
