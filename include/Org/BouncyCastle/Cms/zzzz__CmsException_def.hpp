...
public:
  ...
  /// @brief Method .ctor addr 0x1166fe0 size 0x58 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Cms::CmsException* New_ctor(::StringW msg);

  /// @brief Method .ctor addr 0x1167038 size 0x68 virtual false final false
  inline void _ctor(::StringW msg);

  static inline ::Org::BouncyCastle::Cms::CmsException* New_ctor(::StringW msg, ::System::Exception* e);

  /// @brief Method .ctor addr 0x11670a0 size 0x70 virtual false final false
