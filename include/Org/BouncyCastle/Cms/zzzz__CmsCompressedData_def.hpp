...
public:
  ...
  /// @brief Method GetContent, addr 0x35e9654, size 0x2a4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetContent();

  /// @brief Method GetContent, addr 0x35e98f8, size 0x1f8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetContent(int32_t limit);

  /// @brief Method GetEncoded, addr 0x35e9af8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e960c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> compressedData);

  /// @brief Method .ctor, addr 0x35e9634, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* compressedDataStream);

  /// @brief Method .ctor, addr 0x35e962c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* contentInfo);

  /// @brief Method get_ContentInfo, addr 0x35e9af0, size 0x8, virtual false, abstract: false, final false
