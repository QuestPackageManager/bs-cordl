...
public:
  ...
  /// @brief Method .ctor addr 0x11dc634 size 0x38 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11dc694 size 0x38 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11dc66c size 0x28 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* contentInfo);

  /// @brief Method GetContent addr 0x11dc6cc size 0x26c virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetContent();

  /// @brief Method GetContent addr 0x11dc938 size 0x1e8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetContent(int32_t limit);

  /// @brief Method get_ContentInfo addr 0x11dcb20 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_ContentInfo();

  /// @brief Method GetEncoded addr 0x11dcb28 size 0x1c virtual false final false
