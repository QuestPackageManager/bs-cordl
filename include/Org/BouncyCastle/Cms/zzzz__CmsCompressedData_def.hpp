...
public:
  ...
  /// @brief Method GetContent, addr 0x26532e0, size 0x260, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetContent();

  /// @brief Method GetContent, addr 0x2653540, size 0x1dc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetContent(int32_t limit);

  /// @brief Method GetEncoded, addr 0x2653724, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2653248, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> compressedData);

  /// @brief Method .ctor, addr 0x26532a8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* compressedDataStream);

  /// @brief Method .ctor, addr 0x2653280, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* contentInfo);

  /// @brief Method get_ContentInfo, addr 0x265371c, size 0x8, virtual false, abstract: false, final false
