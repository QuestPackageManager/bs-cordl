...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsCompressedData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsCompressedData(CmsCompressedData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsCompressedData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsCompressedData(CmsCompressedDataconst&) = delete;
