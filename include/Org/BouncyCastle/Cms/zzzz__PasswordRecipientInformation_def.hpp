...
public:
  ...
  /// @brief Method GetContentStream, addr 0x267d160, size 0x530, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2659a64, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyDerivationAlgorithm, addr 0x267d144, size 0x1c, virtual true, abstract: false, final false
