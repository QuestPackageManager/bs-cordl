...
public:
  ...
  /// @brief Method GetContentStream, addr 0x35ac644, size 0x558, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3589030, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyDerivationAlgorithm, addr 0x35ac62c, size 0x18, virtual true, abstract: false, final false
