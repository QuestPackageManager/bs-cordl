...
public:
  ...
  /// @brief Method GetContentStream, addr 0x267d798, size 0x530, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265a09c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyDerivationAlgorithm, addr 0x267d77c, size 0x1c, virtual true, abstract: false, final false
