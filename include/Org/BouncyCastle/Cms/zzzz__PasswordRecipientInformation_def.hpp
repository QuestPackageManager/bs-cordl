...
public:
  ...
  /// @brief Method GetContentStream, addr 0x361341c, size 0x558, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35efe08, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyDerivationAlgorithm, addr 0x3613404, size 0x18, virtual true, abstract: false, final false
