...
public:
  ...
  /// @brief Method GetContentStream, addr 0x1375be4, size 0x574, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1352034, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyDerivationAlgorithm, addr 0x1375bc8, size 0x1c, virtual true, abstract: false, final false
