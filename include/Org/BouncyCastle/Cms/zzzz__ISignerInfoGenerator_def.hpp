...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::ISignerInfoGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::ISignerInfoGenerator*, "Org.BouncyCastle.Cms", "ISignerInfoGenerator");
// Dependencies
namespace Org::BouncyCastle::Cms {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISignerInfoGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISignerInfoGenerator(ISignerInfoGeneratorconst&) = delete;
