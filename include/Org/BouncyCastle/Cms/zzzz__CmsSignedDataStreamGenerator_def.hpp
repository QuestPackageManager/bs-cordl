...
/// @brief Method .ctor, addr 0x35c00f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::ISignerInfoGenerator*  signerInf, ::StringW  digestOID) ;

/// @brief Method get_DigestAlgorithm, addr 0x35c1d80, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x35c1e94, size 0x8c4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x35bfdc8, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method Close, addr 0x35c27bc, size 0x24, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method DoClose, addr 0x35c27e0, size 0xf08, virtual false, abstract: false, final false
inline void DoClose() ;

static inline ::Org::BouncyCastle::Cms::CmsSignedDataStreamGenerator_CmsSignedDataOutputStream* New_ctor(::Org::BouncyCastle::Cms::CmsSignedDataStreamGenerator*  outer, ::System::IO::Stream*  outStream, ::StringW  contentOID, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  sGen, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  sigGen, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  eiGen) ;

/// @brief Method Write, addr 0x35c279c, size 0x20, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x35c277c, size 0x20, virtual true, abstract: false, final false
inline void WriteByte(uint8_t  b) ;

/// @brief Method WriteToGenerator, addr 0x35c36e8, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35c1780, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method AddDigests, addr 0x35bf2f0, size 0x4, virtual false, abstract: false, final false
inline void AddDigests(::ArrayW<::StringW,::Array<::StringW>*>  digestOids) ;

/// @brief Method AddDigests, addr 0x35bee9c, size 0x2e0, virtual false, abstract: false, final false
inline void AddDigests(::System::Collections::IEnumerable*  digestOids) ;

/// @brief Method AddSigner, addr 0x35bf52c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bf7a8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bf5b4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bf670, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bf868, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bf700, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bfa8c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bfd08, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bfb14, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bfbd0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35bfc60, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method AddSignerCallback, addr 0x35c00f8, size 0x38, virtual true, abstract: false, final false
inline void AddSignerCallback(::Org::BouncyCastle::Cms::SignerInformation*  si) ;

/// @brief Method AttachDigestsToOutputStream, addr 0x35c13fc, size 0x384, virtual false, abstract: false, final false
static inline ::System::IO::Stream* AttachDigestsToOutputStream(::System::Collections::ICollection*  digests, ::System::IO::Stream*  s) ;

/// @brief Method CalculateVersion, addr 0x35c0bac, size 0x6c4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerInteger* CalculateVersion(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  contentOid) ;

/// @brief Method CheckForVersion3, addr 0x35c1950, size 0x350, virtual false, abstract: false, final false
inline bool CheckForVersion3(::System::Collections::IList*  signerInfos) ;

/// @brief Method ConfigureDigest, addr 0x35bf2f4, size 0x238, virtual false, abstract: false, final false
inline void ConfigureDigest(::StringW  digestOid) ;

/// @brief Method DoAddSigner, addr 0x35bf930, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x35c1824, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method GetSafeOutputStream, addr 0x35c1ca0, size 0x60, virtual false, abstract: false, final false
static inline ::System::IO::Stream* GetSafeOutputStream(::System::IO::Stream*  s) ;

/// @brief Method GetSafeTeeOutputStream, addr 0x35c1308, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x35c02b0, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream) ;

/// @brief Method Open, addr 0x35c02b8, size 0x80, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream, bool  encapsulate) ;

/// @brief Method Open, addr 0x35c0338, size 0x8c, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream, bool  encapsulate, ::System::IO::Stream*  dataOutputStream) ;

/// @brief Method Open, addr 0x35becd8, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream, ::StringW  signedContentType, bool  encapsulate) ;

/// @brief Method Open, addr 0x35c03c4, size 0x7e8, virtual false, abstract: false, final false
...
/// @brief Method RegisterDigestOid, addr 0x35c0130, size 0x180, virtual false, abstract: false, final false
inline void RegisterDigestOid(::StringW  digestOid) ;

/// @brief Method SetBufferSize, addr 0x35bf2e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35bebfc, size 0xdc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x35bf1fc, size 0xec, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Cms::CmsSignedDataStreamGenerator_DigestAndSignerInfoGeneratorHolder*, "Org.BouncyCastle.Cms", "CmsSignedDataStreamGenerator/DigestAndSignerInfoGeneratorHolder");
