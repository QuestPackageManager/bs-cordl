...
public:
  ...
  /// @brief Method Close, addr 0x144af00, size 0x1e4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x144aedc, size 0x24, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x144aeb8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x144ae68, size 0x50, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Open, addr 0x144942c, size 0x880, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x1449cac, size 0xdc, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW encryptionOid);

  /// @brief Method Open, addr 0x1448e2c, size 0x600, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x1449d88, size 0x10e0, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW encryptionOid, int32_t keySize);

  /// @brief Method SetBerEncodeRecipients, addr 0x1448da0, size 0xc, virtual false, abstract: false, final false
  inline void SetBerEncodeRecipients(bool berEncodeRecipientSet);

  /// @brief Method SetBufferSize, addr 0x1448d98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1448cd8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1448d30, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* rand);

  /// @brief Method get_Version, addr 0x1448dac, size 0x80, virtual false, abstract: false, final false
