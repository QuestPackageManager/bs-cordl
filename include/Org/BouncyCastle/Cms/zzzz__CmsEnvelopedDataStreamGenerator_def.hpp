...
public:
  ...
  /// @brief Method Close, addr 0x1445690, size 0x1e4, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x144566c, size 0x24, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x1445648, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14455f8, size 0x50, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Open, addr 0x1443bbc, size 0x880, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x144443c, size 0xdc, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW encryptionOid);

  /// @brief Method Open, addr 0x14435bc, size 0x600, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x1444518, size 0x10e0, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW encryptionOid, int32_t keySize);

  /// @brief Method SetBerEncodeRecipients, addr 0x1443530, size 0xc, virtual false, abstract: false, final false
  inline void SetBerEncodeRecipients(bool berEncodeRecipientSet);

  /// @brief Method SetBufferSize, addr 0x1443528, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1443468, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x14434c0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* rand);

  /// @brief Method get_Version, addr 0x144353c, size 0x80, virtual false, abstract: false, final false
