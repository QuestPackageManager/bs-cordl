...
public:
  ...
  /// @brief Method GetDigest, addr 0x36cb2bc, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36cb2b4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CounterSignatureDigestCalculator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CounterSignatureDigestCalculator(CounterSignatureDigestCalculator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CounterSignatureDigestCalculator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CounterSignatureDigestCalculator(CounterSignatureDigestCalculatorconst&) = delete;
