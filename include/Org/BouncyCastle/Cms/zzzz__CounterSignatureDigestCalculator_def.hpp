...
public:
  ...
  /// @brief Method GetDigest, addr 0x36c8f34, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36c8f2c, size 0x8, virtual false, abstract: false, final false
