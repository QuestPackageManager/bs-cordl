...
public:
  ...
  /// @brief Method GetDigest, addr 0x2675930, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2675904, size 0x2c, virtual false, abstract: false, final false
