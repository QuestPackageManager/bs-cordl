...
public:
  // Declarations
  /// @brief Method GetEncoded, addr 0x267d6c8, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267d6c4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267d688, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* keyDerivationAlgorithm);

  /// @brief Method .ctor, addr 0x267d640, size 0x44, virtual false, abstract: false, final false
