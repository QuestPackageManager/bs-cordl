...
public:
  ...
  /// @brief Method AddCounterSigners, addr 0x26811c0, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method DerDecode, addr 0x2680d60, size 0xf0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::DigestInfo* DerDecode(::ArrayW<uint8_t, ::Array<uint8_t>*> encoding);

  /// @brief Method DoVerify, addr 0x267f1a4, size 0x12b0, virtual false, abstract: false, final false
  inline bool DoVerify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* key);

  /// @brief Method GetContentDigest, addr 0x267e6d0, size 0xbc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetContentDigest();

  /// @brief Method GetCounterSignatures, addr 0x267e8d8, size 0x870, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::SignerInformationStore* GetCounterSignatures();

  /// @brief Method GetEncodedSignedAttributes, addr 0x267f148, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncodedSignedAttributes();

  /// @brief Method GetSignature, addr 0x26629e0, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSignature();

  /// @brief Method GetSigningTime, addr 0x2680ee4, size 0x13c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::Time* GetSigningTime();

  /// @brief Method GetSingleValuedSignedAttribute, addr 0x2680454, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNull, addr 0x2680cdc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceUnsignedAttributes, addr 0x2681098, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToSignerInfo, addr 0x2681090, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::SignerInfo* ToSignerInfo();

  /// @brief Method Verify, addr 0x2681020, size 0x70, virtual false, abstract: false, final false
  inline bool Verify(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method Verify, addr 0x2680e50, size 0x94, virtual false, abstract: false, final false
  inline bool Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* pubKey);

  /// @brief Method VerifyDigest, addr 0x268064c, size 0x690, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267e588, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Cms::SignerInformation* baseInfo);

  /// @brief Method .ctor, addr 0x265b9a4, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ContentType, addr 0x267e630, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_DigestAlgOid, addr 0x267e66c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_DigestAlgOid();

  /// @brief Method get_DigestAlgParams, addr 0x267e698, size 0x38, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_DigestAlgParams();

  /// @brief Method get_DigestAlgorithmID, addr 0x267e664, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithmID();

  /// @brief Method get_EncryptionAlgOid, addr 0x267e794, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_EncryptionAlgOid();

  /// @brief Method get_EncryptionAlgParams, addr 0x267e7c0, size 0x38, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_EncryptionAlgParams();

  /// @brief Method get_EncryptionAlgorithmID, addr 0x267e78c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_EncryptionAlgorithmID();

  /// @brief Method get_IsCounterSignature, addr 0x267e628, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCounterSignature();

  /// @brief Method get_SignedAttributes, addr 0x267e7f8, size 0x70, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* get_SignedAttributes();

  /// @brief Method get_SignerID, addr 0x267e638, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::SignerID* get_SignerID();

  /// @brief Method get_UnsignedAttributes, addr 0x267e868, size 0x70, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* get_UnsignedAttributes();

  /// @brief Method get_Version, addr 0x267e640, size 0x24, virtual false, abstract: false, final false
