...
public:
  // Declarations
  /// @brief Method Generate, addr 0x12730b0, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12730a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
