...
public:
  // Declarations
  /// @brief Method Generate, addr 0x36a6d68, size 0x3b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a6d64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
