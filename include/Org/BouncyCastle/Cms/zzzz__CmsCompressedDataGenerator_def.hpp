...
public:
  // Declarations
  /// @brief Method Generate, addr 0x26536f8, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26536f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
