...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x1206758, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Equals, addr 0x12067fc, size 0x12c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  static inline ::Org::BouncyCastle::Cms::OriginatorID* New_ctor();

  /// @brief Method .ctor, addr 0x12040d0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
