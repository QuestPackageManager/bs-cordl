...
public:
  // Declarations
  /// @brief Method Equals, addr 0x36d1740, size 0x144, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x36d1698, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::Org::BouncyCastle::Cms::OriginatorID* New_ctor();

  /// @brief Method .ctor, addr 0x36cf128, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OriginatorID", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OriginatorID(OriginatorID&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OriginatorID", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OriginatorID(OriginatorIDconst&) = delete;
