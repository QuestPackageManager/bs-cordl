...
public:
  ...
  /// @brief Method .ctor addr 0x11ea238 size 0x68 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x11ea720 size 0x80 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::AttributeTable* attributeTable);

  /// @brief Method createStandardAttributeTable addr 0x1200934 size 0x80 virtual true final false
  inline ::System::Collections::Hashtable* createStandardAttributeTable(::System::Collections::IDictionary* parameters);

  /// @brief Method DoCreateStandardAttributeTable addr 0x12009b4 size 0x710 virtual false final false
  inline void DoCreateStandardAttributeTable(::System::Collections::IDictionary* parameters, ::System::Collections::IDictionary* std);

  /// @brief Method GetAttributes addr 0x12010c4 size 0x8c virtual true final false
