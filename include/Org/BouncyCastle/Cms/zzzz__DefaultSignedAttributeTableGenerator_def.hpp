...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::DefaultSignedAttributeTableGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::DefaultSignedAttributeTableGenerator*, "Org.BouncyCastle.Cms", "DefaultSignedAttributeTableGenerator");
...
public:
  ...
  /// @brief Method DoCreateStandardAttributeTable, addr 0x36cba64, size 0x6e0, virtual false, abstract: false, final false
  inline void DoCreateStandardAttributeTable(::System::Collections::IDictionary* parameters, ::System::Collections::IDictionary* std);

  /// @brief Method GetAttributes, addr 0x36cc144, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b54a4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36b5984, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::AttributeTable* attributeTable);

  /// @brief Method createStandardAttributeTable, addr 0x36cb9e4, size 0x80, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultSignedAttributeTableGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultSignedAttributeTableGenerator(DefaultSignedAttributeTableGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultSignedAttributeTableGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultSignedAttributeTableGenerator(DefaultSignedAttributeTableGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cms::DefaultSignedAttributeTableGenerator) == 0x18, "Size mismatch!");
