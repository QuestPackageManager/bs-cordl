...
public:
  ...
  /// @brief Method DoCreateStandardAttributeTable, addr 0x1296f18, size 0x710, virtual false, abstract: false, final false
  inline void DoCreateStandardAttributeTable(::System::Collections::IDictionary* parameters, ::System::Collections::IDictionary* std);

  /// @brief Method GetAttributes, addr 0x1297628, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x128079c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1280c84, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::AttributeTable* attributeTable);

  /// @brief Method createStandardAttributeTable, addr 0x1296e98, size 0x80, virtual true, abstract: false, final false
