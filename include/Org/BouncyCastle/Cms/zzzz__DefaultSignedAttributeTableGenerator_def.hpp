...
public:
  ...
  /// @brief Method DoCreateStandardAttributeTable, addr 0x26767b0, size 0x714, virtual false, abstract: false, final false
  inline void DoCreateStandardAttributeTable(::System::Collections::IDictionary* parameters, ::System::Collections::IDictionary* std);

  /// @brief Method GetAttributes, addr 0x2676ec4, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2660228, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26606f8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::AttributeTable* attributeTable);

  /// @brief Method createStandardAttributeTable, addr 0x2676738, size 0x78, virtual true, abstract: false, final false
