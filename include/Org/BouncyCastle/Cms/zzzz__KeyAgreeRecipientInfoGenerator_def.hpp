...
public:
  ...
  /// @brief Method CreateOriginatorPublicKey, addr 0x35d31d8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x35d2084, size 0x1154, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35d1ff8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KeyAgreementOID, addr 0x35d1ffc, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyAgreementOID(::Org::BouncyCastle::Asn1::DerObjectIdentifier* value);

  /// @brief Method set_KeyEncryptionOID, addr 0x35d2004, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyEncryptionOID(::Org::BouncyCastle::Asn1::DerObjectIdentifier* value);

  /// @brief Method set_RecipientCerts, addr 0x35d200c, size 0x70, virtual false, abstract: false, final false
  inline void set_RecipientCerts(::System::Collections::ICollection* value);

  /// @brief Method set_SenderKeyPair, addr 0x35d207c, size 0x8, virtual false, abstract: false, final false
