...
public:
  ...
  /// @brief Method CreateOriginatorPublicKey, addr 0x146cd74, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x146bb7c, size 0x11f8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x146baf0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KeyAgreementOID, addr 0x146baf8, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyAgreementOID(::Org::BouncyCastle::Asn1::DerObjectIdentifier* value);

  /// @brief Method set_KeyEncryptionOID, addr 0x146bb00, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyEncryptionOID(::Org::BouncyCastle::Asn1::DerObjectIdentifier* value);

  /// @brief Method set_RecipientCerts, addr 0x146bb08, size 0x6c, virtual false, abstract: false, final false
  inline void set_RecipientCerts(::System::Collections::ICollection* value);

  /// @brief Method set_SenderKeyPair, addr 0x146bb74, size 0x8, virtual false, abstract: false, final false
