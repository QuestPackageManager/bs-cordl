...
public:
  ...
  /// @brief Method DetermineKeyEncAlg, addr 0x14650f4, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x146557c, size 0x288, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1465070, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KekIdentifier, addr 0x1465078, size 0x8, virtual false, abstract: false, final false
  inline void set_KekIdentifier(::Org::BouncyCastle::Asn1::Cms::KekIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x1465080, size 0x74, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x1465574, size 0x8, virtual false, abstract: false, final false
