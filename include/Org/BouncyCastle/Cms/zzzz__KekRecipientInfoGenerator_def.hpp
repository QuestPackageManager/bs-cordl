...
public:
  ...
  /// @brief Method DetermineKeyEncAlg, addr 0x36cc994, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x36cce50, size 0x28c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36cc910, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KekIdentifier, addr 0x36cc914, size 0x8, virtual false, abstract: false, final false
  inline void set_KekIdentifier(::Org::BouncyCastle::Asn1::Cms::KekIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x36cc91c, size 0x78, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x36cce48, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KekRecipientInfoGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KekRecipientInfoGenerator(KekRecipientInfoGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KekRecipientInfoGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KekRecipientInfoGenerator(KekRecipientInfoGeneratorconst&) = delete;
