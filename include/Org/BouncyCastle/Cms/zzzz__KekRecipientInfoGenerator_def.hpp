...
public:
  ...
  /// @brief Method DetermineKeyEncAlg, addr 0x1272748, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x1272bd0, size 0x288, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12726c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KekIdentifier, addr 0x12726cc, size 0x8, virtual false, abstract: false, final false
  inline void set_KekIdentifier(::Org::BouncyCastle::Asn1::Cms::KekIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x12726d4, size 0x74, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x1272bc8, size 0x8, virtual false, abstract: false, final false
