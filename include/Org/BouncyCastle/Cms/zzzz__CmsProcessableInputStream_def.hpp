...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsProcessableInputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsProcessableInputStream*, "Org.BouncyCastle.Cms", "CmsProcessableInputStream");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsProcessableInputStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsProcessableInputStream(CmsProcessableInputStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsProcessableInputStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsProcessableInputStream(CmsProcessableInputStreamconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsProcessableInputStream) == 0x20, "Size mismatch!");
