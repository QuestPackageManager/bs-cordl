...
public:
  ...
  /// @brief Method CheckSingleUsage, addr 0x35b4bc0, size 0xf0, virtual true, abstract: false, final false
  inline void CheckSingleUsage();

  /// @brief Method GetContent, addr 0x35b4bb4, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* GetContent();

  /// @brief Method GetInputStream, addr 0x35b4af8, size 0x20, virtual true, abstract: false, final false
  inline ::System::IO::Stream* GetInputStream();

  static inline ::Org::BouncyCastle::Cms::CmsProcessableInputStream* New_ctor(::System::IO::Stream* input);

  /// @brief Method Write, addr 0x35b4b18, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b3d2c, size 0xc, virtual false, abstract: false, final false
