...
public:
  ...
  /// @brief Method CheckSingleUsage, addr 0x265b490, size 0xf0, virtual true, abstract: false, final false
  inline void CheckSingleUsage();

  /// @brief Method GetContent, addr 0x265b484, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* GetContent();

  /// @brief Method GetInputStream, addr 0x265b3dc, size 0x20, virtual true, abstract: false, final false
  inline ::System::IO::Stream* GetInputStream();

  static inline ::Org::BouncyCastle::Cms::CmsProcessableInputStream* New_ctor(::System::IO::Stream* input);

  /// @brief Method Write, addr 0x265b3fc, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265a564, size 0x2c, virtual false, abstract: false, final false
