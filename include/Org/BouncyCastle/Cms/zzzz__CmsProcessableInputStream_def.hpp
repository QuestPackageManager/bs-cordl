...
public:
  ...
  /// @brief Method CheckSingleUsage, addr 0x2657358, size 0xf0, virtual true, abstract: false, final false
  inline void CheckSingleUsage();

  /// @brief Method GetContent, addr 0x265734c, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* GetContent();

  /// @brief Method GetInputStream, addr 0x26572a4, size 0x20, virtual true, abstract: false, final false
  inline ::System::IO::Stream* GetInputStream();

  static inline ::Org::BouncyCastle::Cms::CmsProcessableInputStream* New_ctor(::System::IO::Stream* input);

  /// @brief Method Write, addr 0x26572c4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265642c, size 0x2c, virtual false, abstract: false, final false
