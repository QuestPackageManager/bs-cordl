...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsAuthEnvelopedGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsAuthEnvelopedGenerator(CmsAuthEnvelopedGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsAuthEnvelopedGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsAuthEnvelopedGenerator(CmsAuthEnvelopedGeneratorconst&) = delete;
