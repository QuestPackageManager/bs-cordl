...
public:
  ...
  /// @brief Method Generate, addr 0x129d018, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129ce8c, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* origCert);

  /// @brief Method .ctor, addr 0x129cf9c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::Store::IX509Store* origCerts);

  /// @brief Method .ctor, addr 0x129cfcc, size 0x4c, virtual false, abstract: false, final false
