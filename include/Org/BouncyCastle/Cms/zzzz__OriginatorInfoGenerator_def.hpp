...
public:
  ...
  /// @brief Method Generate, addr 0x267c104, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267bf78, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* origCert);

  /// @brief Method .ctor, addr 0x267c088, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::Store::IX509Store* origCerts);

  /// @brief Method .ctor, addr 0x267c0b8, size 0x4c, virtual false, abstract: false, final false
