...
public:
  ...
  /// @brief Method Generate, addr 0x35d5e7c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d5d14, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* origCert);

  /// @brief Method .ctor, addr 0x35d5e20, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::Store::IX509Store* origCerts);

  /// @brief Method .ctor, addr 0x35d5e3c, size 0x40, virtual false, abstract: false, final false
