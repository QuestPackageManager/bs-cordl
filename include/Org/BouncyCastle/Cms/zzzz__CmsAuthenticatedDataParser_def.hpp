...
/// @brief Method GetAuthAttrs, addr 0x35ab67c, size 0x258, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* GetAuthAttrs() ;

/// @brief Method GetMac, addr 0x35ab5e4, size 0x98, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetMac() ;

/// @brief Method GetRecipientInfos, addr 0x35ab5dc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos() ;

/// @brief Method GetUnauthAttrs, addr 0x35ab8d4, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35ab1f4, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  envelopedData) ;

/// @brief Method .ctor, addr 0x35ab268, size 0x308, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  envelopedData) ;

/// @brief Method get_MacAlgOid, addr 0x35ab578, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_MacAlgOid() ;

/// @brief Method get_MacAlgParams, addr 0x35ab5a4, size 0x38, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* get_MacAlgParams() ;

/// @brief Method get_MacAlgorithmID, addr 0x35ab570, size 0x8, virtual false, abstract: false, final false
