...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAuthenticatedDataParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAuthenticatedDataParser*, "Org.BouncyCastle.Cms", "CmsAuthenticatedDataParser");
...
public:
  ...
  /// @brief Method GetAuthAttrs, addr 0x36a729c, size 0x258, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* GetAuthAttrs();

  /// @brief Method GetMac, addr 0x36a7204, size 0x98, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetMac();

  /// @brief Method GetRecipientInfos, addr 0x36a71fc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos();

  /// @brief Method GetUnauthAttrs, addr 0x36a74f4, size 0x258, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* GetUnauthAttrs();

  static inline ::Org::BouncyCastle::Cms::CmsAuthenticatedDataParser* New_ctor(::ArrayW<uint8_t> envelopedData);
  ...
  /// @brief Method .ctor, addr 0x36a6e14, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> envelopedData);

  /// @brief Method .ctor, addr 0x36a6e88, size 0x308, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* envelopedData);

  /// @brief Method get_MacAlgOid, addr 0x36a7198, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_MacAlgOid();

  /// @brief Method get_MacAlgParams, addr 0x36a71c4, size 0x38, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_MacAlgParams();

  /// @brief Method get_MacAlgorithmID, addr 0x36a7190, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsAuthenticatedDataParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsAuthenticatedDataParser(CmsAuthenticatedDataParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsAuthenticatedDataParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsAuthenticatedDataParser(CmsAuthenticatedDataParserconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAuthenticatedDataParser) == 0x58, "Size mismatch!");
