...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*, "Org.BouncyCastle.Cms", "CmsAttributeTableGenerator");
// Dependencies
namespace Org::BouncyCastle::Cms {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "CmsAttributeTableGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsAttributeTableGenerator(CmsAttributeTableGeneratorconst&) = delete;
