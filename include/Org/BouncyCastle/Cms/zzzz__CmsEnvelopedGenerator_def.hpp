...
public:
  ...
  /// @brief Method AddKekRecipient, addr 0x261a05c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKekRecipient, addr 0x2619fd0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKeyAgreementRecipient, addr 0x261a320, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKeyAgreementRecipients, addr 0x261a440, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKeyTransRecipient, addr 0x2619dbc, size 0xf0, virtual false, abstract: false, final false
  inline void AddKeyTransRecipient(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method AddKeyTransRecipient, addr 0x2619eac, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method AddPasswordRecipient, addr 0x261a160, size 0x1c0, virtual false, abstract: false, final false
  inline void AddPasswordRecipient(::Org::BouncyCastle::Cms::CmsPbeKey* pbeKey, ::StringW kekAlgorithmOid);

  /// @brief Method AddRecipientInfoGenerator, addr 0x261a674, size 0xac, virtual false, abstract: false, final false
  inline void AddRecipientInfoGenerator(::Org::BouncyCastle::Cms::RecipientInfoGenerator* recipientInfoGenerator);

  /// @brief Method GenerateAsn1Parameters, addr 0x261a858, size 0x22c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAlgorithmIdentifier, addr 0x261a720, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2619cd4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2619d30, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_UnprotectedAttributeGenerator, addr 0x2619dac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_UnprotectedAttributeGenerator, addr 0x2619db4, size 0x8, virtual false, abstract: false, final false
