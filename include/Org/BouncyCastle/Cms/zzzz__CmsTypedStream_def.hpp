...
public:
  ...
  /// @brief Method Read, addr 0x35a4d4c, size 0xc, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method .ctor, addr 0x35a4d34, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Drain, addr 0x3593000, size 0x7c, virtual false, abstract: false, final false
  inline void Drain();
  ...
  /// @brief Method .ctor, addr 0x35a4bfc, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStream);

  /// @brief Method .ctor, addr 0x3592ff8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::System::IO::Stream* inStream);

  /// @brief Method .ctor, addr 0x35a4c80, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::System::IO::Stream* inStream, int32_t bufSize);

  /// @brief Method get_ContentStream, addr 0x35a4d44, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* get_ContentStream();

  /// @brief Method get_ContentType, addr 0x35a4d3c, size 0x8, virtual false, abstract: false, final false
