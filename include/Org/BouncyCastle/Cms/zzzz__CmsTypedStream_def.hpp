...
public:
  ...
  /// @brief Method Read, addr 0x2673408, size 0xc, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method .ctor, addr 0x26733f0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Drain, addr 0x2661754, size 0x68, virtual false, abstract: false, final false
  inline void Drain();
  ...
  /// @brief Method .ctor, addr 0x26732b8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2673338, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::System::IO::Stream* inStream, int32_t bufSize);

  /// @brief Method get_ContentStream, addr 0x2673400, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* get_ContentStream();

  /// @brief Method get_ContentType, addr 0x26733f8, size 0x8, virtual false, abstract: false, final false
