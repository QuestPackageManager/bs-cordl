...
public:
  ...
  /// @brief Method Read, addr 0x360bb24, size 0xc, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method .ctor, addr 0x360bb0c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Drain, addr 0x35f9dd8, size 0x7c, virtual false, abstract: false, final false
  inline void Drain();
  ...
  /// @brief Method .ctor, addr 0x360b9d4, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStream);

  /// @brief Method .ctor, addr 0x35f9dd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::System::IO::Stream* inStream);

  /// @brief Method .ctor, addr 0x360ba58, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::System::IO::Stream* inStream, int32_t bufSize);

  /// @brief Method get_ContentStream, addr 0x360bb1c, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* get_ContentStream();

  /// @brief Method get_ContentType, addr 0x360bb14, size 0x8, virtual false, abstract: false, final false
