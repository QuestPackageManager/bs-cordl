...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsTypedStream*);
MARK_REF_T(::Org::BouncyCastle::Cms::CmsTypedStream_FullReaderStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsTypedStream*, "Org.BouncyCastle.Cms", "CmsTypedStream");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsTypedStream_FullReaderStream*, "Org.BouncyCastle.Cms", "CmsTypedStream/FullReaderStream");
...
public:
  ...
  /// @brief Method Read, addr 0x36c8d78, size 0xc, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method .ctor, addr 0x36c8d60, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsTypedStream_FullReaderStream) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method Drain, addr 0x36b702c, size 0x7c, virtual false, abstract: false, final false
  inline void Drain();
  ...
  /// @brief Method .ctor, addr 0x36c8c28, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStream);

  /// @brief Method .ctor, addr 0x36b7024, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::System::IO::Stream* inStream);

  /// @brief Method .ctor, addr 0x36c8cac, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::System::IO::Stream* inStream, int32_t bufSize);

  /// @brief Method get_ContentStream, addr 0x36c8d70, size 0x8, virtual false, abstract: false, final false
  inline ::System::IO::Stream* get_ContentStream();

  /// @brief Method get_ContentType, addr 0x36c8d68, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsTypedStream) == 0x20, "Size mismatch!");
