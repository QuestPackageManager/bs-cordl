...
public:
  ...
  /// @brief Method Close, addr 0x3583834, size 0xc0, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x3583814, size 0x20, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x35837f4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35837b4, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Open, addr 0x3583480, size 0x80, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW compressionOID);

  /// @brief Method Open, addr 0x3583500, size 0x2b4, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW contentOID, ::StringW compressionOID);

  /// @brief Method SetBufferSize, addr 0x3583478, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3583474, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
