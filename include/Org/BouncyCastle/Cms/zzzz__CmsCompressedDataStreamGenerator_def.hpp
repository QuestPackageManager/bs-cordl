...
/// @brief Method Close, addr 0x35adfc8, size 0xc0, virtual true, abstract: false, final false
inline void Close() ;

static inline ::Org::BouncyCastle::Cms::CmsCompressedDataStreamGenerator_CmsCompressedOutputStream* New_ctor(::Org::BouncyCastle::Utilities::Zlib::ZOutputStream*  outStream, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  sGen, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  cGen, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  eiGen) ;

/// @brief Method Write, addr 0x35adfa8, size 0x20, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x35adf88, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35adf48, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x35adc14, size 0x80, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream, ::StringW  compressionOID) ;

/// @brief Method Open, addr 0x35adc94, size 0x2b4, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream, ::StringW  contentOID, ::StringW  compressionOID) ;

/// @brief Method SetBufferSize, addr 0x35adc0c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35adc08, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
