...
public:
  ...
  /// @brief Method Close, addr 0x35ea60c, size 0xc0, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x35ea5ec, size 0x20, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x35ea5cc, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ea58c, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Open, addr 0x35ea258, size 0x80, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW compressionOID);

  /// @brief Method Open, addr 0x35ea2d8, size 0x2b4, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW contentOID, ::StringW compressionOID);

  /// @brief Method SetBufferSize, addr 0x35ea250, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ea24c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
