...
public:
  ...
  /// @brief Method Close, addr 0x2650710, size 0xa8, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x26506ec, size 0x24, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x26506c8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2650688, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Open, addr 0x2650360, size 0x7c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW compressionOID);

  /// @brief Method Open, addr 0x26503dc, size 0x2ac, virtual false, abstract: false, final false
  inline ::System::IO::Stream* Open(::System::IO::Stream* outStream, ::StringW contentOID, ::StringW compressionOID);

  /// @brief Method SetBufferSize, addr 0x2650358, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2650350, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
