...
/// @brief Method GetFirstSigner, addr 0x3618f94, size 0x19c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::SignerInformation* GetFirstSigner(::Org::BouncyCastle::Cms::SignerID*  selector) ;

/// @brief Method GetSigners, addr 0x36191d8, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* GetSigners() ;

/// @brief Method GetSigners, addr 0x3619238, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3618898, size 0x18c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::SignerInformation*  signerInfo) ;

/// @brief Method .ctor, addr 0x3618a24, size 0x570, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::ICollection*  signerInfos) ;

/// @brief Method get_Count, addr 0x3619130, size 0xa8, virtual false, abstract: false, final false
