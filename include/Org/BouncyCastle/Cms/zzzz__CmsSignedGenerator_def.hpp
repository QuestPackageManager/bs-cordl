...
public:
  ...
  /// @brief Method AddAttributeCertificates, addr 0x1451c94, size 0x5cc, virtual false, abstract: false, final false
  inline void AddAttributeCertificates(::Org::BouncyCastle::X509::Store::IX509Store* store);

  /// @brief Method AddCertificates, addr 0x1451c4c, size 0x24, virtual false, abstract: false, final false
  inline void AddCertificates(::Org::BouncyCastle::X509::Store::IX509Store* certStore);

  /// @brief Method AddCrls, addr 0x1451c70, size 0x24, virtual false, abstract: false, final false
  inline void AddCrls(::Org::BouncyCastle::X509::Store::IX509Store* crlStore);

  /// @brief Method AddSignerCallback, addr 0x14526c8, size 0x4, virtual true, abstract: false, final false
  inline void AddSignerCallback(::Org::BouncyCastle::Cms::SignerInformation* si);

  /// @brief Method AddSigners, addr 0x1452260, size 0x3e4, virtual false, abstract: false, final false
  inline void AddSigners(::Org::BouncyCastle::Cms::SignerInformationStore* signerStore);

  /// @brief Method GetAttributeSet, addr 0x1451bd0, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* GetAttributeSet(::Org::BouncyCastle::Asn1::Cms::AttributeTable* attr);

  /// @brief Method GetBaseParameters, addr 0x1451994, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGeneratedDigests, addr 0x1452644, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetGeneratedDigests();

  /// @brief Method GetSignerIdentifier, addr 0x14526cc, size 0x74, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* GetSignerIdentifier(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method GetSignerIdentifier, addr 0x14527d4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1451890, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x14518f4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_UseDerForCerts, addr 0x14526a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseDerForCerts();

  /// @brief Method get_UseDerForCrls, addr 0x14526b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_UseDerForCerts, addr 0x14526a8, size 0xc, virtual false, abstract: false, final false
  inline void set_UseDerForCerts(bool value);

  /// @brief Method set_UseDerForCrls, addr 0x14526bc, size 0xc, virtual false, abstract: false, final false
