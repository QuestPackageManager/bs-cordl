...
public:
  ...
  /// @brief Method .ctor addr 0x11e54bc size 0x44 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11e5500 size 0x80 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11e5700 size 0x88 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11e5818 size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11e593c size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11e596c size 0x20 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11e5788 size 0x90 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11e58ac size 0x90 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11e55e8 size 0x118 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* sigData);

  /// @brief Method get_Version addr 0x11e598c size 0x24 virtual false final false
  inline int32_t get_Version();

  /// @brief Method GetSignerInfos addr 0x11e59b0 size 0x600 virtual false final false
  inline ::Org::BouncyCastle::Cms::SignerInformationStore* GetSignerInfos();

  /// @brief Method GetAttributeCertificates addr 0x11e6224 size 0x88 virtual false final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetAttributeCertificates(::StringW type);

  /// @brief Method GetCertificates addr 0x11e6900 size 0x88 virtual false final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates(::StringW type);

  /// @brief Method GetCrls addr 0x11e6b38 size 0x88 virtual false final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCrls(::StringW type);

  /// @brief Method get_SignedContentTypeOid addr 0x11e6d70 size 0x2c virtual false final false
  inline ::StringW get_SignedContentTypeOid();

  /// @brief Method get_SignedContentType addr 0x11e6d9c size 0x24 virtual false final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_SignedContentType();

  /// @brief Method get_SignedContent addr 0x11e6dc0 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Cms::CmsProcessable* get_SignedContent();

  /// @brief Method get_ContentInfo addr 0x11e6dc8 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_ContentInfo();

  /// @brief Method GetEncoded addr 0x11e6dd0 size 0x1c virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetEncoded addr 0x11e6dec size 0x1c virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded(::StringW encoding);

  /// @brief Method ReplaceSigners addr 0x11e6e08 size 0x6c8 virtual false final false
  ...
  /// @brief Method ReplaceCertificatesAndCrls addr 0x11e75a0 size 0x324 virtual false final false
