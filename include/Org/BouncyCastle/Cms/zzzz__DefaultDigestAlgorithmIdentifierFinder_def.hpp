...
public:
  ...
  /// @brief Method .ctor, addr 0x2663368, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method find, addr 0x267321c, size 0x198, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* find(::StringW digAlgName);

  /// @brief Method find, addr 0x2663370, size 0x258, virtual false, abstract: false, final false
