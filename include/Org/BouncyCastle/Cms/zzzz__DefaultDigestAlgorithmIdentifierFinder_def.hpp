...
public:
  ...
  /// @brief Method .ctor, addr 0x36b856c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method find, addr 0x36c84d0, size 0x18c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* find(::StringW digAlgName);

  /// @brief Method find, addr 0x36b8570, size 0x25c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultDigestAlgorithmIdentifierFinder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultDigestAlgorithmIdentifierFinder(DefaultDigestAlgorithmIdentifierFinder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultDigestAlgorithmIdentifierFinder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultDigestAlgorithmIdentifierFinder(DefaultDigestAlgorithmIdentifierFinderconst&) = delete;
