...
public:
  ...
  /// @brief Method .ctor, addr 0x2662ce0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method find, addr 0x2672b94, size 0x198, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* find(::StringW digAlgName);

  /// @brief Method find, addr 0x2662ce8, size 0x258, virtual false, abstract: false, final false
