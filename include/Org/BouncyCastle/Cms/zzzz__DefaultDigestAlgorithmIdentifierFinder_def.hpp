...
public:
  ...
  /// @brief Method .ctor, addr 0x35921b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method find, addr 0x35a211c, size 0x18c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* find(::StringW digAlgName);

  /// @brief Method find, addr 0x35921bc, size 0x25c, virtual false, abstract: false, final false
