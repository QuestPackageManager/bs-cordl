...
public:
  ...
  /// @brief Method GetAsn1Set, addr 0x2664818, size 0xb0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Set* GetAsn1Set(::Org::BouncyCastle::Asn1::Asn1SetParser* asn1SetParser);

  /// @brief Method GetAttributeCertificates, addr 0x2664680, size 0x88, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetAttributeCertificates(::StringW type);

  /// @brief Method GetCertificates, addr 0x2664708, size 0x88, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates(::StringW type);

  /// @brief Method GetCrls, addr 0x2664790, size 0x88, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCrls(::StringW type);

  /// @brief Method GetSignedContent, addr 0x26648d0, size 0x44c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetSignedContent();

  /// @brief Method GetSignerInfos, addr 0x2663b90, size 0x97c, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateCertCrlSets, addr 0x266450c, size 0x174, virtual false, abstract: false, final false
  inline void PopulateCertCrlSets();

  /// @brief Method ReplaceCertificatesAndCrls, addr 0x2664f8c, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceSigners, addr 0x2664d1c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2663244, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> sigBlock);

  /// @brief Method .ctor, addr 0x26632b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* sigData);

  /// @brief Method .ctor, addr 0x26632c4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Cms::CmsTypedStream* signedContent, ::ArrayW<uint8_t, ::Array<uint8_t>*> sigBlock);

  /// @brief Method .ctor, addr 0x266333c, size 0x760, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DigestOids, addr 0x2663b30, size 0x60, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* get_DigestOids();

  /// @brief Method get_SignedContentType, addr 0x26648c8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_SignedContentType();

  /// @brief Method get_Version, addr 0x2663b0c, size 0x24, virtual false, abstract: false, final false
