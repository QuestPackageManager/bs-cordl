...
public:
  ...
  /// @brief Method GetAsn1Set, addr 0x35fab98, size 0xb4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Set* GetAsn1Set(::Org::BouncyCastle::Asn1::Asn1SetParser* asn1SetParser);

  /// @brief Method GetAttributeCertificates, addr 0x35fa9dc, size 0x94, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetAttributeCertificates(::StringW type);

  /// @brief Method GetCertificates, addr 0x35faa70, size 0x94, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates(::StringW type);

  /// @brief Method GetCrls, addr 0x35fab04, size 0x94, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCrls(::StringW type);

  /// @brief Method GetSignedContent, addr 0x35fac54, size 0x434, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetSignedContent();

  /// @brief Method GetSignerInfos, addr 0x35f9edc, size 0x984, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateCertCrlSets, addr 0x35fa860, size 0x17c, virtual false, abstract: false, final false
  inline void PopulateCertCrlSets();

  /// @brief Method ReplaceCertificatesAndCrls, addr 0x35fb324, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceSigners, addr 0x35fb088, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35f9534, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> sigBlock);

  /// @brief Method .ctor, addr 0x35f95ac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* sigData);

  /// @brief Method .ctor, addr 0x35f95b8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Cms::CmsTypedStream* signedContent, ::ArrayW<uint8_t, ::Array<uint8_t>*> sigBlock);

  /// @brief Method .ctor, addr 0x35f9634, size 0x79c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DigestOids, addr 0x35f9e78, size 0x64, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::Collections::ISet* get_DigestOids();

  /// @brief Method get_SignedContentType, addr 0x35fac4c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_SignedContentType();

  /// @brief Method get_Version, addr 0x35f9e54, size 0x24, virtual false, abstract: false, final false
