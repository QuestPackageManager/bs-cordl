...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecipientInformationStore", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecipientInformationStore(RecipientInformationStore&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecipientInformationStore", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecipientInformationStore(RecipientInformationStoreconst&) = delete;
