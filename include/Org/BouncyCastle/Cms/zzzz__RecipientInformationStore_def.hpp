...
/// @brief Method GetFirstRecipient, addr 0x35d793c, size 0x19c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::RecipientInformation* GetFirstRecipient(::Org::BouncyCastle::Cms::RecipientID*  selector) ;

/// @brief Method GetRecipients, addr 0x35d7b80, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* GetRecipients() ;

/// @brief Method GetRecipients, addr 0x35d7be0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35b2a6c, size 0x570, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::ICollection*  recipientInfos) ;

/// @brief Method get_Count, addr 0x35d7ad8, size 0xa8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x35d7938, size 0x4, virtual false, abstract: false, final false
