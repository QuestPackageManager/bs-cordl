...
public:
  // Declarations
  /// @brief Method Generate, addr 0x35aae1c, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x35aa2f4, size 0xb28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35aa2ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35aa2f0, size 0x4, virtual false, abstract: false, final false
