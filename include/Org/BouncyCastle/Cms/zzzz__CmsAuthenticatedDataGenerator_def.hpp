...
public:
  // Declarations
  /// @brief Method Generate, addr 0x2650ffc, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x2650464, size 0xb98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265045c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2650460, size 0x4, virtual false, abstract: false, final false
