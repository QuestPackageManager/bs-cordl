...
public:
  ...
  /// @brief Method .ctor, addr 0x122cd34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Cms::CmsStreamException* New_ctor(::StringW name);

  /// @brief Method .ctor, addr 0x122cd3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  static inline ::Org::BouncyCastle::Cms::CmsStreamException* New_ctor(::StringW name, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x12200f4, size 0x8, virtual false, abstract: false, final false
