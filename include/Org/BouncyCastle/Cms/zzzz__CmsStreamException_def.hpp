...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsStreamException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsStreamException(CmsStreamException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsStreamException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsStreamException(CmsStreamExceptionconst&) = delete;
