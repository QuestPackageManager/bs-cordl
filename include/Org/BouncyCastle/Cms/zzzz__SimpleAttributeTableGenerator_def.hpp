...
public:
  ...
  /// @brief Method GetAttributes, addr 0x137be64, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x137be3c, size 0x28, virtual false, abstract: false, final false
