...
public:
  ...
  /// @brief Method GetAttributes, addr 0x12a42e0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a42b8, size 0x28, virtual false, abstract: false, final false
