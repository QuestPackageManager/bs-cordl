...
public:
  ...
  /// @brief Method GetAttributes, addr 0x2680f04, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2680edc, size 0x28, virtual false, abstract: false, final false
