...
public:
  ...
  /// @brief Method GetAttributes, addr 0x36d7bd0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d7bc8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SimpleAttributeTableGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SimpleAttributeTableGenerator(SimpleAttributeTableGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SimpleAttributeTableGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SimpleAttributeTableGenerator(SimpleAttributeTableGeneratorconst&) = delete;
