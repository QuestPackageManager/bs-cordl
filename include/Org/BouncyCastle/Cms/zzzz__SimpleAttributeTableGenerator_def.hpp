...
public:
  ...
  /// @brief Method GetAttributes, addr 0x36185f4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36185ec, size 0x8, virtual false, abstract: false, final false
