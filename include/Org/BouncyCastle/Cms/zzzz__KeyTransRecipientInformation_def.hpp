...
public:
  ...
  /// @brief Method GetContentStream, addr 0x35d4a7c, size 0x1c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetExchangeEncryptionAlgorithmName, addr 0x35d450c, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnwrapKey, addr 0x35d46e8, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b308c, size 0x20c, virtual false, abstract: false, final false
