...
public:
  ...
  /// @brief Method GetContentStream, addr 0x3611010, size 0x1c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetExchangeEncryptionAlgorithmName, addr 0x3610aa0, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnwrapKey, addr 0x3610c7c, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ef620, size 0x20c, virtual false, abstract: false, final false
