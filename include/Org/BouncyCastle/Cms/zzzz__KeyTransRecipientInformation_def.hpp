...
public:
  ...
  /// @brief Method GetContentStream, addr 0x129baf8, size 0x1c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetExchangeEncryptionAlgorithmName, addr 0x129b5ac, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnwrapKey, addr 0x129b770, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1279c64, size 0x21c, virtual false, abstract: false, final false
