...
public:
  ...
  /// @brief Method GetContentStream, addr 0x137367c, size 0x1c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetExchangeEncryptionAlgorithmName, addr 0x1373130, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnwrapKey, addr 0x13732f4, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13517e8, size 0x21c, virtual false, abstract: false, final false
