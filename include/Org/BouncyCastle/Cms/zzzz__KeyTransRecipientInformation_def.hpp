...
public:
  ...
  /// @brief Method GetContentStream, addr 0x267efa4, size 0x1c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetExchangeEncryptionAlgorithmName, addr 0x267ea68, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnwrapKey, addr 0x267ec2c, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265d5a8, size 0x214, virtual false, abstract: false, final false
