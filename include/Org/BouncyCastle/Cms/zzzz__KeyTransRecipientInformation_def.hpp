...
public:
  ...
  /// @brief Method GetContentStream, addr 0x2679870, size 0x1c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetExchangeEncryptionAlgorithmName, addr 0x2679334, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnwrapKey, addr 0x26794f8, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2657e74, size 0x214, virtual false, abstract: false, final false
