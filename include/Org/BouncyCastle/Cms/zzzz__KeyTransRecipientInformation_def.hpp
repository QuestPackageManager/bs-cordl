...
public:
  ...
  /// @brief Method GetContentStream, addr 0x35aa238, size 0x1c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters* key);

  /// @brief Method GetExchangeEncryptionAlgorithmName, addr 0x35a9cc8, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnwrapKey, addr 0x35a9ea4, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3588848, size 0x20c, virtual false, abstract: false, final false
