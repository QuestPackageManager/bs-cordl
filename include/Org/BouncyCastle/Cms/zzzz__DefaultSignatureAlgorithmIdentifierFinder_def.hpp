...
public:
  ...
  /// @brief Method CreatePssParams, addr 0x266f1c4, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Find, addr 0x266f9b0, size 0x54, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* Find(::StringW sigAlgName);

  /// @brief Method Generate, addr 0x266f2e4, size 0x6cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x266fa04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
