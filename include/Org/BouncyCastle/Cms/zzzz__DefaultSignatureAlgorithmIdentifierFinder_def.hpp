...
public:
  ...
  /// @brief Method CreatePssParams, addr 0x36c5e30, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Find, addr 0x36c65e0, size 0x58, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* Find(::StringW sigAlgName);

  /// @brief Method Generate, addr 0x36c5f34, size 0x6ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36c6638, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultSignatureAlgorithmIdentifierFinder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultSignatureAlgorithmIdentifierFinder(DefaultSignatureAlgorithmIdentifierFinder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultSignatureAlgorithmIdentifierFinder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultSignatureAlgorithmIdentifierFinder(DefaultSignatureAlgorithmIdentifierFinderconst&) = delete;
