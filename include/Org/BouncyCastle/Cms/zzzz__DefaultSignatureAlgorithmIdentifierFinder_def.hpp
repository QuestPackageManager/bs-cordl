...
public:
  ...
  /// @brief Method CreatePssParams, addr 0x2670588, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Find, addr 0x2670d74, size 0x54, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* Find(::StringW sigAlgName);

  /// @brief Method Generate, addr 0x26706a8, size 0x6cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2670dc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
