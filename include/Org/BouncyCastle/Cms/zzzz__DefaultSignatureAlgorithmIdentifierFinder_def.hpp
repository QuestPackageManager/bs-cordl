...
/// @brief Method CreatePssParams, addr 0x35ca210, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method Find, addr 0x35ca9c0, size 0x58, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* Find(::StringW  sigAlgName) ;

/// @brief Method Generate, addr 0x35ca314, size 0x6ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35caa18, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
