...
public:
  ...
  /// @brief Method CreatePssParams, addr 0x1463d80, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method Find, addr 0x146456c, size 0x54, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* Find(::StringW sigAlgName);

  /// @brief Method Generate, addr 0x1463eac, size 0x6c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14645c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
