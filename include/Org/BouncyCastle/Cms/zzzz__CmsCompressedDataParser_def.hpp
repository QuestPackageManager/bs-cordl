...
public:
  // Declarations
  /// @brief Method GetContent, addr 0x2653b68, size 0x2e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2653af4, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> compressedData);

  /// @brief Method .ctor, addr 0x2653b64, size 0x4, virtual false, abstract: false, final false
