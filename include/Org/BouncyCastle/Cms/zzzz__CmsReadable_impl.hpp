...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IO::Stream* (::Org::BouncyCastle::Cms::CmsReadable::*)()>(&::Org::BouncyCastle::Cms::CmsReadable::GetInputStream)> {
