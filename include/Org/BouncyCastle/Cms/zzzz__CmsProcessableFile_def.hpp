...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsProcessableFile*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsProcessableFile*, "Org.BouncyCastle.Cms", "CmsProcessableFile");
...
public:
  ...
  /// @brief Method GetContent, addr 0x36ae2d8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* GetContent();

  /// @brief Method GetInputStream, addr 0x36ae1a0, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x36ae240, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36ae184, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::FileInfo* file);

  /// @brief Method .ctor, addr 0x36ae194, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsProcessableFile) == 0x20, "Size mismatch!");
