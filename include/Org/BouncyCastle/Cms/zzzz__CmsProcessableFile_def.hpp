...
public:
  ...
  /// @brief Method GetContent, addr 0x13533f0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* GetContent();

  /// @brief Method GetInputStream, addr 0x13532d8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x135336c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1353278, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::FileInfo* file);

  /// @brief Method .ctor, addr 0x13532a8, size 0x30, virtual false, abstract: false, final false
