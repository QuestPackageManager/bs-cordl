...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsEnvelopedData*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsEnvelopedData*, "Org.BouncyCastle.Cms", "CmsEnvelopedData");
...
public:
  ...
  /// @brief Method GetEncoded, addr 0x36a9ed4, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncoded();

  /// @brief Method GetRecipientInfos, addr 0x36a9e54, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos();

  /// @brief Method GetUnprotectedAttributes, addr 0x36a9e64, size 0x70, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Cms::CmsEnvelopedData* New_ctor(::ArrayW<uint8_t> envelopedData);
  ...
  /// @brief Method .ctor, addr 0x36a9ccc, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* contentInfo);

  /// @brief Method .ctor, addr 0x36a9ca8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> envelopedData);

  /// @brief Method .ctor, addr 0x36a9dfc, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* envelopedData);

  /// @brief Method get_ContentInfo, addr 0x36a9e5c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_ContentInfo();

  /// @brief Method get_EncryptionAlgOid, addr 0x36a9e28, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_EncryptionAlgOid();

  /// @brief Method get_EncryptionAlgorithmID, addr 0x36a9e20, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsEnvelopedData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsEnvelopedData(CmsEnvelopedData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsEnvelopedData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsEnvelopedData(CmsEnvelopedDataconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsEnvelopedData) == 0x30, "Size mismatch!");
