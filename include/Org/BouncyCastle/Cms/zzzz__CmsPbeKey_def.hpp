...
/// @brief Method Finalize, addr 0x35b4658, size 0x5c, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetEncoded, addr 0x35b47b0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetSalt, addr 0x35b471c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35b4444, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35b431c, size 0xec, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t,::Array<char16_t>*>  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount) ;

/// @brief Method .ctor, addr 0x35b4408, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  keyDerivationAlgorithm) ;

/// @brief Method .ctor, addr 0x35b42d8, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount) ;

/// @brief Method get_Algorithm, addr 0x35b4728, size 0x44, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_Format, addr 0x35b476c, size 0x44, virtual false, abstract: false, final false
inline ::StringW get_Format() ;

/// @brief Method get_IterationCount, addr 0x35b4720, size 0x8, virtual false, abstract: false, final false
inline int32_t get_IterationCount() ;

/// @brief Method get_Password, addr 0x35b46b4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Password() ;

/// @brief Method get_Salt, addr 0x35b46bc, size 0x60, virtual false, abstract: false, final false
