...
public:
  ...
  /// @brief Method Close, addr 0x144380c, size 0x5c, virtual false, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x14435c4, size 0x248, virtual false, abstract: false, final false
