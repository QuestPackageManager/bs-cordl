...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::CmsContentInfoParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsContentInfoParser*, "Org.BouncyCastle.Cms", "CmsContentInfoParser");
...
public:
  ...
  /// @brief Method Close, addr 0x36a6da4, size 0x70, virtual false, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x36a6b3c, size 0x268, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsContentInfoParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsContentInfoParser(CmsContentInfoParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsContentInfoParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsContentInfoParser(CmsContentInfoParserconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsContentInfoParser) == 0x20, "Size mismatch!");
