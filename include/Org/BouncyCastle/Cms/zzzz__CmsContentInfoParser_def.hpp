...
public:
  ...
  /// @brief Method Close, addr 0x265140c, size 0x5c, virtual false, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x26511e0, size 0x22c, virtual false, abstract: false, final false
