...
public:
  ...
  /// @brief Method Close, addr 0x36a4a1c, size 0x70, virtual false, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x36a47b4, size 0x268, virtual false, abstract: false, final false
