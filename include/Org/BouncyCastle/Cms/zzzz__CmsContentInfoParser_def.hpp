...
public:
  ...
  /// @brief Method Close, addr 0x2650098, size 0x5c, virtual false, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method .ctor, addr 0x264fe6c, size 0x22c, virtual false, abstract: false, final false
