...
public:
  ...
  /// @brief Method Generate, addr 0x129db10, size 0x4bc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x129daf0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KeyDerivationAlgorithm, addr 0x129daf8, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyDerivationAlgorithm(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x129db00, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x129db08, size 0x8, virtual false, abstract: false, final false
