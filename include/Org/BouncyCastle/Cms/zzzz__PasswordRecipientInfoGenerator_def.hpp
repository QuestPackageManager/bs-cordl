...
public:
  ...
  /// @brief Method Generate, addr 0x267cb9c, size 0x4a0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x267cb7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KeyDerivationAlgorithm, addr 0x267cb84, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyDerivationAlgorithm(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x267cb8c, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x267cb94, size 0x8, virtual false, abstract: false, final false
