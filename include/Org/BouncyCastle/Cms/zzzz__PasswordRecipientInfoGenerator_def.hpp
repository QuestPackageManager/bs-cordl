...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::PasswordRecipientInfoGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::PasswordRecipientInfoGenerator*, "Org.BouncyCastle.Cms", "PasswordRecipientInfoGenerator");
...
public:
  ...
  /// @brief Method Generate, addr 0x36d24a0, size 0x4c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36d2484, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KeyDerivationAlgorithm, addr 0x36d2488, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyDerivationAlgorithm(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x36d2490, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x36d2498, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PasswordRecipientInfoGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PasswordRecipientInfoGenerator(PasswordRecipientInfoGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PasswordRecipientInfoGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PasswordRecipientInfoGenerator(PasswordRecipientInfoGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Cms::PasswordRecipientInfoGenerator) == 0x28, "Size mismatch!");
