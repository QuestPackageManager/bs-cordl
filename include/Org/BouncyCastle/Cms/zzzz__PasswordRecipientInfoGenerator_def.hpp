...
public:
  ...
  /// @brief Method Generate, addr 0x3612ec4, size 0x4c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3612ea8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_KeyDerivationAlgorithm, addr 0x3612eac, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyDerivationAlgorithm(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* value);

  /// @brief Method set_KeyEncryptionKey, addr 0x3612eb4, size 0x8, virtual false, abstract: false, final false
  inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* value);

  /// @brief Method set_KeyEncryptionKeyOID, addr 0x3612ebc, size 0x8, virtual false, abstract: false, final false
