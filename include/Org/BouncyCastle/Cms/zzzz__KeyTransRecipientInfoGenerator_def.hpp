...
public:
  ...
  /// @brief Method Generate, addr 0x3610688, size 0x19c, virtual true, abstract: false, final true
  ...
  /// @brief Method GenerateWrappedKey, addr 0x361083c, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36104d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36104dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* issuerAndSerialNumber);

  /// @brief Method .ctor, addr 0x36104e4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x3610824, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method set_RecipientCert, addr 0x361054c, size 0x58, virtual false, abstract: false, final false
  inline void set_RecipientCert(::Org::BouncyCastle::X509::X509Certificate* value);

  /// @brief Method set_RecipientPublicKey, addr 0x36105a4, size 0xdc, virtual false, abstract: false, final false
  inline void set_RecipientPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* value);

  /// @brief Method set_SubjectKeyIdentifier, addr 0x3610680, size 0x8, virtual false, abstract: false, final false
