...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey*, "Org.BouncyCastle.Cms", "Pkcs5Scheme2Utf8PbeKey");
...
public:
  // Declarations
  /// @brief Method GetEncoded, addr 0x36d0e10, size 0x138, virtual true, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey* New_ctor(::ArrayW<char16_t> password, ::ArrayW<uint8_t> salt, int32_t iterationCount);
  ...
  /// @brief Method .ctor, addr 0x36d0e0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t> password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* keyDerivationAlgorithm);

  /// @brief Method .ctor, addr 0x36d0dcc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t> password, ::ArrayW<uint8_t> salt, int32_t iterationCount);

  /// @brief Method .ctor, addr 0x36d0dd0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* keyDerivationAlgorithm);

  /// @brief Method .ctor, addr 0x36d0d88, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey) == 0x28, "Size mismatch!");
