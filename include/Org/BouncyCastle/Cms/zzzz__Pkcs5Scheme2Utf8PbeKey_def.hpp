...
public:
// Declarations
/// @brief Method GetEncoded, addr 0x3614958, size 0x138, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* GetEncoded(::StringW  algorithmOid) ;

static inline ::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey* New_ctor(::ArrayW<char16_t,::Array<char16_t>*>  password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  keyDerivationAlgorithm) ;
...
/// @brief Method .ctor, addr 0x3614954, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3614914, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t,::Array<char16_t>*>  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount) ;

/// @brief Method .ctor, addr 0x3614918, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  keyDerivationAlgorithm) ;

/// @brief Method .ctor, addr 0x36148d0, size 0x44, virtual false, abstract: false, final false
