...
public:
  // Declarations
  /// @brief Method GetEncoded, addr 0x35d7628, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d7624, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d75e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t, ::Array<char16_t>*> password, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterationCount);

  /// @brief Method .ctor, addr 0x35d75e8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* keyDerivationAlgorithm);

  /// @brief Method .ctor, addr 0x35d75a0, size 0x44, virtual false, abstract: false, final false
