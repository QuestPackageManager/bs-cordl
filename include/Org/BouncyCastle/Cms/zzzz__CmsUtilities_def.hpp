...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsUtilities(CmsUtilities&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsUtilities", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsUtilities(CmsUtilitiesconst&) = delete;
