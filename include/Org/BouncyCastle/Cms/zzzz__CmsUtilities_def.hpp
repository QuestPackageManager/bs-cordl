...
public:
  ...
  /// @brief Method GetTbsCertificateStructure addr 0x118ef3c size 0x30 virtual false final false
  ...
  /// @brief Method GetIssuerAndSerialNumber addr 0x1178474 size 0x94 virtual false final false
  ...
  /// @brief Method .ctor addr 0x118ef6c size 0x8 virtual false final false
  inline void _ctor();
