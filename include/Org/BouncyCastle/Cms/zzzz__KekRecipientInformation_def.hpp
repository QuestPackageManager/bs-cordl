...
public:
  ...
  /// @brief Method GetContentStream, addr 0x2677ea8, size 0x330, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26593fc, size 0xb0, virtual false, abstract: false, final false
