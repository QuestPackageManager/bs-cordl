...
public:
  ...
  /// @brief Method GetContentStream, addr 0x264282c, size 0x330, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2623d80, size 0xb0, virtual false, abstract: false, final false
