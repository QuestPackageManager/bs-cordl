...
public:
  ...
  /// @brief Method GetContentStream, addr 0x146b7b8, size 0x338, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x144c998, size 0xb4, virtual false, abstract: false, final false
