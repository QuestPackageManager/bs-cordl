...
public:
  ...
  /// @brief Method GetContentStream, addr 0x35d1cb4, size 0x344, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b3298, size 0xac, virtual false, abstract: false, final false
