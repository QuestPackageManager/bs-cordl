...
public:
  ...
  /// @brief Method GetContentStream, addr 0x36cb49c, size 0x344, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36aca80, size 0xac, virtual false, abstract: false, final false
