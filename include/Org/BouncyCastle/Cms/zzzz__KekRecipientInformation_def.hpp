...
public:
  ...
  /// @brief Method GetContentStream, addr 0x267c268, size 0x330, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265d7bc, size 0xb0, virtual false, abstract: false, final false
