...
public:
  ...
  /// @brief Method GetContentStream, addr 0x36cd824, size 0x344, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36aee08, size 0xac, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KekRecipientInformation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KekRecipientInformation(KekRecipientInformation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KekRecipientInformation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KekRecipientInformation(KekRecipientInformationconst&) = delete;
