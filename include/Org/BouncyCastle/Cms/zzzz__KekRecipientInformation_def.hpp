...
public:
  ...
  /// @brief Method GetContentStream, addr 0x1370824, size 0x338, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1351a04, size 0xb4, virtual false, abstract: false, final false
