...
public:
  ...
  /// @brief Method GetContentStream, addr 0x2677ef8, size 0x330, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265944c, size 0xb0, virtual false, abstract: false, final false
