...
public:
  ...
  /// @brief Method GetContentStream, addr 0x2676b34, size 0x330, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2658088, size 0xb0, virtual false, abstract: false, final false
