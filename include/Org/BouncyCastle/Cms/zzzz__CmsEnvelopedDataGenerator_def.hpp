...
public:
  // Declarations
  /// @brief Method Generate, addr 0x1447878, size 0xc80, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x14476c4, size 0x1b4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsEnvelopedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable* content, ::StringW encryptionOid);

  /// @brief Method Generate, addr 0x1446ac8, size 0xbfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x14484f8, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1446a10, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1446a64, size 0x64, virtual false, abstract: false, final false
