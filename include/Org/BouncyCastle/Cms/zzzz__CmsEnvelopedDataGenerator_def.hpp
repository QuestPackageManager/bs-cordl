...
public:
  // Declarations
  /// @brief Method Generate, addr 0x2614c54, size 0xc94, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x2614ab0, size 0x1a4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsEnvelopedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable* content, ::StringW encryptionOid);

  /// @brief Method Generate, addr 0x2613e54, size 0xc5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x26158e8, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2613d9c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2613df0, size 0x64, virtual false, abstract: false, final false
