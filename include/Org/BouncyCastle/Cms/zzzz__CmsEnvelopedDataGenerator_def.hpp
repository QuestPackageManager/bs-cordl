...
public:
  // Declarations
  /// @brief Method Generate, addr 0x35eb778, size 0xc98, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x35eb5c8, size 0x1b0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Cms::CmsEnvelopedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable* content, ::StringW encryptionOid);

  /// @brief Method Generate, addr 0x35ea9d0, size 0xbf8, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x35ec410, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ea910, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ea968, size 0x68, virtual false, abstract: false, final false
