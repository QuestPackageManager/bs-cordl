...
public:
  ...
  /// @brief Method GetCertificates, addr 0x267c244, size 0x4e0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates();

  /// @brief Method GetCrls, addr 0x267c724, size 0x4e0, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x267cc04, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267c21c, size 0x28, virtual false, abstract: false, final false
