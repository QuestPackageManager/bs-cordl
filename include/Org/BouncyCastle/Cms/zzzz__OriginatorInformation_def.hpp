...
public:
  ...
  /// @brief Method GetCertificates, addr 0x26805b4, size 0x4e0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates();

  /// @brief Method GetCrls, addr 0x2680a94, size 0x4e0, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x2680f74, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268058c, size 0x28, virtual false, abstract: false, final false
