...
public:
  ...
  /// @brief Method GetCertificates, addr 0x129d0d0, size 0x50c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates();

  /// @brief Method GetCrls, addr 0x129d5dc, size 0x50c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x129dae8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129d0a8, size 0x28, virtual false, abstract: false, final false
