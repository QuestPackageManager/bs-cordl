...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OriginatorInformation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OriginatorInformation(OriginatorInformation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OriginatorInformation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OriginatorInformation(OriginatorInformationconst&) = delete;
