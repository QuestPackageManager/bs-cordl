...
public:
  ...
  /// @brief Method GetCertificates, addr 0x267c87c, size 0x4e0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates();

  /// @brief Method GetCrls, addr 0x267cd5c, size 0x4e0, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Structure, addr 0x267d23c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267c854, size 0x28, virtual false, abstract: false, final false
