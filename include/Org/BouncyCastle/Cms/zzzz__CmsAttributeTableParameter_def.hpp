...
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Cms::CmsAttributeTableParameter, "Org.BouncyCastle.Cms", "CmsAttributeTableParameter");
// Dependencies
namespace Org::BouncyCastle::Cms {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Cms::CmsAttributeTableParameter) == 0x4, "Size mismatch!");
