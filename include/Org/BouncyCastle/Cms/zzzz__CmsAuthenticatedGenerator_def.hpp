...
public:
  ...
  /// @brief Method .ctor, addr 0x126fcf8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x126fd4c, size 0x64, virtual false, abstract: false, final false
