...
public:
  ...
  /// @brief Method .ctor, addr 0x264f070, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264f0c4, size 0x64, virtual false, abstract: false, final false
