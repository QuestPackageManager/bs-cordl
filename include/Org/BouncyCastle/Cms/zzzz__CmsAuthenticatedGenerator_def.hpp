...
public:
  ...
  /// @brief Method .ctor, addr 0x26503a4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26503f8, size 0x64, virtual false, abstract: false, final false
