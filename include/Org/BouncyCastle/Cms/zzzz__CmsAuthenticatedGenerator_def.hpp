...
public:
  ...
  /// @brief Method .ctor, addr 0x357f9e8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x357fa40, size 0x68, virtual false, abstract: false, final false
