...
public:
  ...
  /// @brief Method .ctor, addr 0x35aa22c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35aa284, size 0x68, virtual false, abstract: false, final false
