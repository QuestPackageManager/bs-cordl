...
public:
  ...
  /// @brief Method .ctor, addr 0x124a5f4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x124a648, size 0x64, virtual false, abstract: false, final false
