...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignerID", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignerID(SignerID&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignerID", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignerID(SignerIDconst&) = delete;
