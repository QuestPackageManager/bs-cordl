...
public:
  // Declarations
  /// @brief Method Equals, addr 0x35ad644, size 0x144, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x35ad59c, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::Org::BouncyCastle::Cms::SignerID* New_ctor();

  /// @brief Method .ctor, addr 0x35ad788, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
