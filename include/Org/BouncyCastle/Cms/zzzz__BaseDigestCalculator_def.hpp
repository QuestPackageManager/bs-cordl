...
public:
  ...
  /// @brief Method GetDigest, addr 0x1249034, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x124900c, size 0x28, virtual false, abstract: false, final false
