...
public:
  ...
  /// @brief Method GetDigest, addr 0x35a8c84, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35a8c7c, size 0x8, virtual false, abstract: false, final false
