...
/// @brief Method GetDigest, addr 0x35a8bd4, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x35a8bcc, size 0x8, virtual false, abstract: false, final false
