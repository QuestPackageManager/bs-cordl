...
public:
  ...
  /// @brief Method .ctor addr 0x1179d44 size 0x14c virtual false final false
  ...
  /// @brief Method .ctor addr 0x1179b04 size 0x240 virtual false final false
  ...
  /// @brief Method get_DigestAlgorithmID addr 0x117ad88 size 0xd4 virtual false final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithmID();

  /// @brief Method get_SignedAttributes addr 0x117c33c size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* get_SignedAttributes();

  /// @brief Method get_UnsignedAttributes addr 0x117c344 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* get_UnsignedAttributes();

  /// @brief Method ToSignerInfo addr 0x117ae5c size 0xb58 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x1178878 size 0x84 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Cms::CmsSignedDataGenerator* New_ctor(::Org::BouncyCastle::Security::SecureRandom* rand);

  /// @brief Method .ctor addr 0x11788fc size 0x94 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* rand);

  /// @brief Method AddSigner addr 0x1178990 size 0xa0 virtual false final false
  ...
  /// @brief Method AddSigner addr 0x1178f10 size 0xd8 virtual false final false
  ...
  /// @brief Method AddSigner addr 0x1179184 size 0xa0 virtual false final false
  ...
  /// @brief Method AddSigner addr 0x1179224 size 0xd8 virtual false final false
  ...
  /// @brief Method AddSigner addr 0x11792fc size 0xb8 virtual false final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW digestOID,
                        ::Org::BouncyCastle::Asn1::Cms::AttributeTable* signedAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable* unsignedAttr);

  /// @brief Method AddSigner addr 0x11793b4 size 0x11c virtual false final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW encryptionOID, ::StringW digestOID,
                        ::Org::BouncyCastle::Asn1::Cms::AttributeTable* signedAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable* unsignedAttr);

  /// @brief Method AddSigner addr 0x1179550 size 0xb8 virtual false final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t, ::Array<uint8_t>*> subjectKeyID, ::StringW digestOID,
                        ::Org::BouncyCastle::Asn1::Cms::AttributeTable* signedAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable* unsignedAttr);

  /// @brief Method AddSigner addr 0x1179608 size 0x11c virtual false final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t, ::Array<uint8_t>*> subjectKeyID, ::StringW encryptionOID, ::StringW digestOID,
                        ::Org::BouncyCastle::Asn1::Cms::AttributeTable* signedAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable* unsignedAttr);

  /// @brief Method AddSigner addr 0x1179724 size 0xb8 virtual false final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW digestOID,
  ...
  /// @brief Method AddSigner addr 0x11797dc size 0xb4 virtual false final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW encryptionOID, ::StringW digestOID,
                        ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* signedAttrGen, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* unsignedAttrGen);

  /// @brief Method AddSigner addr 0x1179890 size 0xb8 virtual false final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t, ::Array<uint8_t>*> subjectKeyID, ::StringW digestOID,
                        ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* signedAttrGen, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* unsignedAttrGen);

  /// @brief Method AddSigner addr 0x1179948 size 0xb4 virtual false final false
  inline void AddSigner(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey, ::ArrayW<uint8_t, ::Array<uint8_t>*> subjectKeyID, ::StringW encryptionOID, ::StringW digestOID,
                        ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* signedAttrGen, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* unsignedAttrGen);

  /// @brief Method AddSignerInfoGenerator addr 0x11799fc size 0x108 virtual false final false
  inline void AddSignerInfoGenerator(::Org::BouncyCastle::Cms::SignerInfoGenerator* signerInfoGenerator);

  /// @brief Method doAddSigner addr 0x1179050 size 0x134 virtual false final false
  ...
  /// @brief Method Generate addr 0x1179e90 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Cms::CmsSignedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable* content);

  /// @brief Method Generate addr 0x1179f10 size 0xe78 virtual false final false
  ...
  /// @brief Method Generate addr 0x1179e98 size 0x78 virtual false final false
  inline ::Org::BouncyCastle::Cms::CmsSignedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable* content, bool encapsulate);

  /// @brief Method GenerateCounterSigners addr 0x117bd44 size 0x8c virtual false final false
