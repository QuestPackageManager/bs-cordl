...
static inline ::Org::BouncyCastle::Cms::CmsSignedDataGenerator_SignerInf* New_ctor(::Org::BouncyCastle::Cms::CmsSignedGenerator*  outer, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  key, ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier*  signerIdentifier, ::StringW  digestOID, ::StringW  encOID, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*  sAttr, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*  unsAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable*  baseSignedTable) ;

static inline ::Org::BouncyCastle::Cms::CmsSignedDataGenerator_SignerInf* New_ctor(::Org::BouncyCastle::Cms::CmsSignedGenerator*  outer, ::Org::BouncyCastle::Crypto::ISignatureFactory*  sigCalc, ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier*  signerIdentifier, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*  sAttr, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*  unsAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable*  baseSignedTable) ;

/// @brief Method ToSignerInfo, addr 0x35bb68c, size 0xbb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35ba5b8, size 0x144, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::CmsSignedGenerator*  outer, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  key, ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier*  signerIdentifier, ::StringW  digestOID, ::StringW  encOID, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*  sAttr, ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*  unsAttr, ::Org::BouncyCastle::Asn1::Cms::AttributeTable*  baseSignedTable) ;

/// @brief Method .ctor, addr 0x35ba3a4, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method get_DigestAlgorithmID, addr 0x35bb5d4, size 0xb8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithmID() ;

/// @brief Method get_SignedAttributes, addr 0x35bcbac, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* get_SignedAttributes() ;

/// @brief Method get_UnsignedAttributes, addr 0x35bcbb4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b91fc, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b9b98, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b9fb0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b97ac, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b9c54, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35ba06c, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b9a1c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b9de4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35ba124, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b9ac0, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35b9ea0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method AddSigner, addr 0x35ba1e0, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method AddSignerInfoGenerator, addr 0x35ba298, size 0x10c, virtual false, abstract: false, final false
inline void AddSignerInfoGenerator(::Org::BouncyCastle::Cms::SignerInfoGenerator*  signerInfoGenerator) ;

/// @brief Method Generate, addr 0x35ba6fc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::CmsSignedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable*  content) ;

/// @brief Method Generate, addr 0x35ba704, size 0x7c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::CmsSignedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable*  content, bool  encapsulate) ;

/// @brief Method Generate, addr 0x35ba780, size 0xe54, virtual false, abstract: false, final false
...
/// @brief Method GenerateCounterSigners, addr 0x35bc5c0, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35b90cc, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x35b915c, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Security::SecureRandom*  rand) ;

/// @brief Method doAddSigner, addr 0x35b98e4, size 0x138, virtual false, abstract: false, final false
