...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IVerifierFactoryProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IVerifierFactoryProvider(IVerifierFactoryProviderconst&) = delete;
