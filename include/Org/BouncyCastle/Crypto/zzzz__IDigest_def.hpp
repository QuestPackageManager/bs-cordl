...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IDigest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IDigest*, "Org.BouncyCastle.Crypto", "IDigest");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDigest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDigest(IDigestconst&) = delete;
