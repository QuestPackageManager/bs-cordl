...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CipherKeyGeneratorFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CipherKeyGeneratorFactory(CipherKeyGeneratorFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CipherKeyGeneratorFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CipherKeyGeneratorFactory(CipherKeyGeneratorFactoryconst&) = delete;
