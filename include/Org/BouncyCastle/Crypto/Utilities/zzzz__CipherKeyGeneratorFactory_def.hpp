...
public:
  // Declarations
  /// @brief Method CreateCipherKeyGenerator, addr 0x10325d8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x10321a4, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103219c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
