...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Utilities::CipherKeyGeneratorFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Utilities::CipherKeyGeneratorFactory*, "Org.BouncyCastle.Crypto.Utilities", "CipherKeyGeneratorFactory");
...
public:
  // Declarations
  /// @brief Method CreateCipherKeyGenerator, addr 0x3498a9c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x3498650, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x349864c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Utilities::CipherKeyGeneratorFactory) == 0x10, "Size mismatch!");
