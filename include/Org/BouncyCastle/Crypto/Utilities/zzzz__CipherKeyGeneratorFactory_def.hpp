...
public:
  // Declarations
  /// @brief Method CreateCipherKeyGenerator, addr 0x1220f84, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x1220b50, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1220b48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
