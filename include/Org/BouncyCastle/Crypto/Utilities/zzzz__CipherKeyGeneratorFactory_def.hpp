...
public:
  // Declarations
  /// @brief Method CreateCipherKeyGenerator, addr 0x244a4b8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x244a094, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x244a08c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
