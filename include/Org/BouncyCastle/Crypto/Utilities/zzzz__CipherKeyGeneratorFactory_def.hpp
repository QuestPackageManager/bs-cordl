...
public:
  // Declarations
  /// @brief Method CreateCipherKeyGenerator, addr 0x33db848, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x33db3fc, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33db3f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
