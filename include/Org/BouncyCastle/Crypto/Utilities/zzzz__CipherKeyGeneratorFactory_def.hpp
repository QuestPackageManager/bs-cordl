...
public:
  // Declarations
  /// @brief Method CreateCipherKeyGenerator, addr 0x12277f4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyGenerator, addr 0x12273c0, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12273b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
