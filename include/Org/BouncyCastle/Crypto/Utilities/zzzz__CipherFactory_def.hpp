...
public:
  ...
  /// @brief Method .ctor addr 0xfc0790 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method CreateContentCipher addr 0xfc0798 size 0x758 virtual false final false
  ...
  /// @brief Method CreateCipher addr 0xfc0ef0 size 0x3b8 virtual false final false
