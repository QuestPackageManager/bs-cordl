...
public:
  ...
  /// @brief Method CreateCipher, addr 0x2441dfc, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateContentCipher, addr 0x24416b0, size 0x74c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24416a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
