...
public:
  ...
  /// @brief Method CreateCipher, addr 0x339ea38, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateContentCipher, addr 0x339e2e0, size 0x758, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x339e2dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
