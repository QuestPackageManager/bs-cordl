...
public:
  ...
  /// @brief Method CreateCipher, addr 0x33dafcc, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateContentCipher, addr 0x33da874, size 0x758, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33da870, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
