...
public:
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x3497468, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3497ac0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
