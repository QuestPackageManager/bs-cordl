...
public:
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x121f914, size 0x55c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x121ff94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
