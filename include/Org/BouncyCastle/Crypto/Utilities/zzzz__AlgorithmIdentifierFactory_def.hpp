...
public:
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x2444b48, size 0x538, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24451a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
