...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AlgorithmIdentifierFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AlgorithmIdentifierFactory(AlgorithmIdentifierFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AlgorithmIdentifierFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AlgorithmIdentifierFactory(AlgorithmIdentifierFactoryconst&) = delete;
