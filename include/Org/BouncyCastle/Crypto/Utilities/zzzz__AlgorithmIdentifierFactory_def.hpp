...
public:
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x337343c, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3373a94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
