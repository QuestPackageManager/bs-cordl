...
public:
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x105266c, size 0x55c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1052cec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
