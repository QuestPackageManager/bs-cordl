...
public:
  ...
  /// @brief Method GenerateEncryptionAlgID, addr 0x33da214, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33da86c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
