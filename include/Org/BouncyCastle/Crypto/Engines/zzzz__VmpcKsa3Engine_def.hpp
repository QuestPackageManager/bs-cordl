...
public:
  ...
  /// @brief Method InitKey, addr 0x1152fe8, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x115328c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x1152fa8, size 0x40, virtual true, abstract: false, final false
