...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VmpcKsa3Engine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VmpcKsa3Engine(VmpcKsa3Engine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VmpcKsa3Engine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VmpcKsa3Engine(VmpcKsa3Engineconst&) = delete;
