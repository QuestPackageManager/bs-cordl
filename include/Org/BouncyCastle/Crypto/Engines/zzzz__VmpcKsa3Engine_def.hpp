...
public:
  ...
  /// @brief Method InitKey, addr 0x105f8c4, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x105fb68, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x105f884, size 0x40, virtual true, abstract: false, final false
