...
public:
  ...
  /// @brief Method CalculateCmsKeyChecksum, addr 0x1139564, size 0x180, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CalculateCmsKeyChecksum(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method CheckCmsKeyChecksum, addr 0x1139ca4, size 0x80, virtual false, abstract: false, final false
  inline bool CheckCmsKeyChecksum(::ArrayW<uint8_t, ::Array<uint8_t>*> key, ::ArrayW<uint8_t, ::Array<uint8_t>*> checksum);

  /// @brief Method Init, addr 0x1138dec, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0x11396e4, size 0x5c0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Wrap, addr 0x11390ec, size 0x478, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1139db8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_IV2();

  /// @brief Method get_AlgorithmName, addr 0x11390ac, size 0x40, virtual true, abstract: false, final false
