...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::Salsa20Engine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::Salsa20Engine*, "Org.BouncyCastle.Crypto.Engines", "Salsa20Engine");
...
public:
  ...
  __declspec(property(get = getStaticF_DEFAULT_ROUNDS, put = setStaticF_DEFAULT_ROUNDS)) int32_t DEFAULT_ROUNDS;

  __declspec(property(get = get_NonceSize)) int32_t NonceSize;

  /// @brief Field TAU_SIGMA, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_TAU_SIGMA, put = setStaticF_TAU_SIGMA)) ::ArrayW<uint32_t> TAU_SIGMA;
  ...
  __declspec(property(get = __cordl_internal_get_engineState, put = __cordl_internal_set_engineState)) ::ArrayW<uint32_t> engineState;
  ...
  __declspec(property(get = __cordl_internal_get_keyStream, put = __cordl_internal_set_keyStream)) ::ArrayW<uint8_t> keyStream;
  ...
  __declspec(property(get = getStaticF_sigma, put = setStaticF_sigma)) ::ArrayW<uint8_t> sigma;

  /// @brief Field tau, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_tau, put = setStaticF_tau)) ::ArrayW<uint8_t> tau;
  ...
  /// @brief Method AdvanceCounter, addr 0x33a6dd4, size 0x4c, virtual true, abstract: false, final false
  inline void AdvanceCounter();

  /// @brief Method GenerateKeyStream, addr 0x33a7324, size 0x88, virtual true, abstract: false, final false
  inline void GenerateKeyStream(::ArrayW<uint8_t> output);

  /// @brief Method Init, addr 0x33a681c, size 0x38c, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method LimitExceeded, addr 0x33a6d94, size 0x40, virtual false, abstract: false, final false
  inline bool LimitExceeded();

  /// @brief Method LimitExceeded, addr 0x33a709c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method PackTauOrSigma, addr 0x33a6580, size 0x138, virtual false, abstract: false, final false
  inline void PackTauOrSigma(int32_t keyLength, ::ArrayW<uint32_t> state, int32_t stateOffset);

  /// @brief Method ProcessBytes, addr 0x33a6e20, size 0x27c, virtual true, abstract: false, final false
  inline void ProcessBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method Reset, addr 0x33a70dc, size 0x1c, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ResetCounter, addr 0x33a7104, size 0x2c, virtual true, abstract: false, final false
  inline void ResetCounter();

  /// @brief Method ResetLimitCounter, addr 0x33a70f8, size 0xc, virtual false, abstract: false, final false
  inline void ResetLimitCounter();

  /// @brief Method ReturnByte, addr 0x33a6c94, size 0x100, virtual true, abstract: false, final false
  inline uint8_t ReturnByte(uint8_t input);

  /// @brief Method SalsaCore, addr 0x33a73ac, size 0x2ac, virtual false, abstract: false, final false
  static inline void SalsaCore(int32_t rounds, ::ArrayW<uint32_t> input, ::ArrayW<uint32_t> x);

  /// @brief Method SetKey, addr 0x33a7130, size 0x1f4, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_engineState() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_engineState();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_keyStream() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_keyStream();
  ...
  constexpr void __cordl_internal_set_engineState(::ArrayW<uint32_t> value);

  constexpr void __cordl_internal_set_index(int32_t value);

  constexpr void __cordl_internal_set_initialised(bool value);

  constexpr void __cordl_internal_set_keyStream(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_rounds(int32_t value);

  constexpr void __cordl_internal_set_x(::ArrayW<uint32_t> value);

  /// @brief Method .ctor, addr 0x33a66b8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33a671c, size 0x100, virtual false, abstract: false, final false
  inline void _ctor(int32_t rounds);

  static inline int32_t getStaticF_DEFAULT_ROUNDS();

  static inline ::ArrayW<uint32_t> getStaticF_TAU_SIGMA();

  static inline ::ArrayW<uint8_t> getStaticF_sigma();

  static inline ::ArrayW<uint8_t> getStaticF_tau();

  /// @brief Method get_AlgorithmName, addr 0x33a6bb0, size 0xe4, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_NonceSize, addr 0x33a6ba8, size 0x8, virtual true, abstract: false, final false
  ...
  static inline void setStaticF_TAU_SIGMA(::ArrayW<uint32_t> value);

  static inline void setStaticF_sigma(::ArrayW<uint8_t> value);

  static inline void setStaticF_tau(::ArrayW<uint8_t> value);
...
public:
  ...
  ::ArrayW<uint32_t> ___engineState;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::Salsa20Engine) == 0x40, "Size mismatch!");
