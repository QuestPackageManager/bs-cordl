...
public:
  ...
  __declspec(property(get = getStaticF_TAU_SIGMA, put = setStaticF_TAU_SIGMA)) ::ArrayW<uint32_t, ::Array<uint32_t>*> TAU_SIGMA;
  ...
  __declspec(property(get = getStaticF_sigma, put = setStaticF_sigma)) ::ArrayW<uint8_t, ::Array<uint8_t>*> sigma;

  /// @brief Field tau, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_tau, put = setStaticF_tau)) ::ArrayW<uint8_t, ::Array<uint8_t>*> tau;
  ...
  /// @brief Method AdvanceCounter, addr 0x3282da8, size 0x4c, virtual true, abstract: false, final false
  inline void AdvanceCounter();

  /// @brief Method GenerateKeyStream, addr 0x32832f8, size 0x88, virtual true, abstract: false, final false
  inline void GenerateKeyStream(::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Init, addr 0x32827f0, size 0x38c, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method LimitExceeded, addr 0x3282d68, size 0x40, virtual false, abstract: false, final false
  inline bool LimitExceeded();

  /// @brief Method LimitExceeded, addr 0x3283070, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method PackTauOrSigma, addr 0x3282554, size 0x138, virtual false, abstract: false, final false
  inline void PackTauOrSigma(int32_t keyLength, ::ArrayW<uint32_t, ::Array<uint32_t>*> state, int32_t stateOffset);

  /// @brief Method ProcessBytes, addr 0x3282df4, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x32830b0, size 0x1c, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ResetCounter, addr 0x32830d8, size 0x2c, virtual true, abstract: false, final false
  inline void ResetCounter();

  /// @brief Method ResetLimitCounter, addr 0x32830cc, size 0xc, virtual false, abstract: false, final false
  inline void ResetLimitCounter();

  /// @brief Method ReturnByte, addr 0x3282c68, size 0x100, virtual true, abstract: false, final false
  inline uint8_t ReturnByte(uint8_t input);

  /// @brief Method SalsaCore, addr 0x3283380, size 0x2ac, virtual false, abstract: false, final false
  static inline void SalsaCore(int32_t rounds, ::ArrayW<uint32_t, ::Array<uint32_t>*> input, ::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method SetKey, addr 0x3283104, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328268c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32826f0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x3282b84, size 0xe4, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_NonceSize, addr 0x3282b7c, size 0x8, virtual true, abstract: false, final false
