...
public:
  ...
  /// @brief Method .ctor, addr 0x339db30, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AesWrapEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AesWrapEngine(AesWrapEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AesWrapEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AesWrapEngine(AesWrapEngineconst&) = delete;
