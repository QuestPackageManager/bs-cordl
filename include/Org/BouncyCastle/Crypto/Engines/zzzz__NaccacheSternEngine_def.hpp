...
public:
  ...
  /// @brief Method AddCryptedBlocks, addr 0x32bb8d8, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method Encrypt, addr 0x32bb7f8, size 0xe0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encrypt(::Org::BouncyCastle::Math::BigInteger* plain);

  /// @brief Method GetInputBlockSize, addr 0x32baaa0, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x32baaf8, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x32ba51c, size 0x580, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::NaccacheSternEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x32bab50, size 0x8b8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t length);

  /// @brief Method ProcessData, addr 0x32bbae8, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32bbcf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method chineseRemainder, addr 0x32bb408, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x32ba4d8, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Debug, addr 0x32baa9c, size 0x4, virtual true, abstract: false, final false
