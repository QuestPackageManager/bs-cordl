...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::NaccacheSternEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::NaccacheSternEngine*, "Org.BouncyCastle.Crypto.Engines", "NaccacheSternEngine");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_lookup, put = __cordl_internal_set_lookup)) ::ArrayW<::System::Collections::IList*> lookup;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher"
  constexpr operator ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*() noexcept;

  /// @brief Method AddCryptedBlocks, addr 0x33b50c0, size 0x210, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> AddCryptedBlocks(::ArrayW<uint8_t> block1, ::ArrayW<uint8_t> block2);

  /// @brief Method Encrypt, addr 0x33b4fe0, size 0xe0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> Encrypt(::Org::BouncyCastle::Math::BigInteger* plain);

  /// @brief Method GetInputBlockSize, addr 0x33b4288, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x33b42e0, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x33b3d04, size 0x580, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::NaccacheSternEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x33b4338, size 0x8b8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t length);

  /// @brief Method ProcessData, addr 0x33b52d0, size 0x20c, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::System::Collections::IList*> const& __cordl_internal_get_lookup() const;

  constexpr ::ArrayW<::System::Collections::IList*>& __cordl_internal_get_lookup();
  ...
  /// @brief Method .ctor, addr 0x33b54dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method chineseRemainder, addr 0x33b4bf0, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x33b3cc0, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Debug, addr 0x33b4284, size 0x4, virtual true, abstract: false, final false
...
public:
  ...
  ::ArrayW<::System::Collections::IList*> ___lookup;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::NaccacheSternEngine) == 0x28, "Size mismatch!");
