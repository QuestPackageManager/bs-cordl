...
public:
  ...
  /// @brief Method Init, addr 0xed6158, size 0x58c, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method set_Debug, addr 0xed66e4, size 0x4, virtual true, abstract: false, final false
  inline void set_Debug(bool value);

  /// @brief Method GetInputBlockSize, addr 0xed66e8, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0xed673c, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method ProcessBlock, addr 0xed6790, size 0x8fc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t length);

  /// @brief Method Encrypt, addr 0xed7470, size 0xd8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encrypt(::Org::BouncyCastle::Math::BigInteger* plain);

  /// @brief Method AddCryptedBlocks, addr 0xed7548, size 0x204, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessData, addr 0xed774c, size 0x218, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method chineseRemainder, addr 0xed708c, size 0x3e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed7964, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
