...
public:
  ...
  /// @brief Method get_AlgorithmName, addr 0xf01fa8, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xf01fe8, size 0x58c, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method set_Debug, addr 0xf02574, size 0x4, virtual true, abstract: false, final false
  inline void set_Debug(bool value);

  /// @brief Method GetInputBlockSize, addr 0xf02578, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0xf025cc, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method ProcessBlock, addr 0xf02620, size 0x8fc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t length);

  /// @brief Method Encrypt, addr 0xf03300, size 0xd8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encrypt(::Org::BouncyCastle::Math::BigInteger* plain);

  /// @brief Method AddCryptedBlocks, addr 0xf033d8, size 0x204, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessData, addr 0xf035dc, size 0x218, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method chineseRemainder, addr 0xf02f1c, size 0x3e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf037f4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
