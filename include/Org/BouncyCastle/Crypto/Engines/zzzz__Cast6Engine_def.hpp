...
public:
  ...
  /// @brief Method CAST_Decipher, addr 0x32e8fe0, size 0x34c, virtual false, abstract: false, final false
  inline void CAST_Decipher(uint32_t A, uint32_t B, uint32_t C, uint32_t D, ::ArrayW<uint32_t, ::Array<uint32_t>*> result);

  /// @brief Method CAST_Encipher, addr 0x32e8b20, size 0x348, virtual false, abstract: false, final false
  inline void CAST_Encipher(uint32_t A, uint32_t B, uint32_t C, uint32_t D, ::ArrayW<uint32_t, ::Array<uint32_t>*> result);

  /// @brief Method DecryptBlock, addr 0x32e8e68, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x32e89a8, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBlockSize, addr 0x32e7fe0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  static inline ::Org::BouncyCastle::Crypto::Engines::Cast6Engine* New_ctor();

  /// @brief Method Reset, addr 0x32e7fdc, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SetKey, addr 0x32e7fe8, size 0x9c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32e7eac, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x32e7f98, size 0x44, virtual true, abstract: false, final false
