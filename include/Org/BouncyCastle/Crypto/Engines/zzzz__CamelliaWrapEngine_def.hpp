...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::CamelliaWrapEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::CamelliaWrapEngine*, "Org.BouncyCastle.Crypto.Engines", "CamelliaWrapEngine");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33a313c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CamelliaWrapEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CamelliaWrapEngine(CamelliaWrapEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CamelliaWrapEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CamelliaWrapEngine(CamelliaWrapEngineconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::CamelliaWrapEngine) == 0x30, "Size mismatch!");
