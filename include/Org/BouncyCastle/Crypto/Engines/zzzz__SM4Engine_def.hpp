...
public:
  ...
  /// @brief Method tau addr 0xe743fc size 0xc8 virtual false final false
  static inline uint32_t tau(uint32_t A);

  /// @brief Method L_ap addr 0xe744c4 size 0x40 virtual false final false
  static inline uint32_t L_ap(uint32_t B);

  /// @brief Method T_ap addr 0xe74504 size 0x84 virtual false final false
  inline uint32_t T_ap(uint32_t Z);

  /// @brief Method ExpandKey addr 0xe74588 size 0x568 virtual false final false
  inline void ExpandKey(bool forEncryption, ::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method L addr 0xe74af0 size 0x78 virtual false final false
  static inline uint32_t L(uint32_t B);

  /// @brief Method T addr 0xe74b68 size 0x58 virtual false final false
  static inline uint32_t T(uint32_t Z);

  /// @brief Method Init addr 0xe74bc0 size 0x1c8 virtual true final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName addr 0xe74d88 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay addr 0xe74dc8 size 0x8 virtual true final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize addr 0xe74dd0 size 0x8 virtual true final false
  inline int32_t GetBlockSize();

  /// @brief Method ProcessBlock addr 0xe74dd8 size 0x2b0 virtual true final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xe75088 size 0x4 virtual true final false
  inline void Reset();

  static inline ::Org::BouncyCastle::Crypto::Engines::SM4Engine* New_ctor();

  /// @brief Method .ctor addr 0xe751b4 size 0x8 virtual false final false
  inline void _ctor();
