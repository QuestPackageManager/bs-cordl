...
public:
  ...
  /// @brief Method ExpandKey, addr 0x3308bac, size 0x590, virtual false, abstract: false, final false
  inline void ExpandKey(bool forEncryption, ::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method GetBlockSize, addr 0x33093d8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x33091c4, size 0x1c8, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method L, addr 0x330913c, size 0x18, virtual false, abstract: false, final false
  static inline uint32_t L(uint32_t B);

  /// @brief Method L_ap, addr 0x3308b34, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t L_ap(uint32_t B);

  static inline ::Org::BouncyCastle::Crypto::Engines::SM4Engine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x33093e0, size 0x2c0, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33096a0, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method T, addr 0x3309154, size 0x70, virtual false, abstract: false, final false
  static inline uint32_t T(uint32_t Z);

  /// @brief Method T_ap, addr 0x3308b44, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33097d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x330938c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x33093d0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method tau, addr 0x3308a68, size 0xcc, virtual false, abstract: false, final false
