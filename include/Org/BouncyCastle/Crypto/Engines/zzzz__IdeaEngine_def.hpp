...
public:
  ...
  /// @brief Method .ctor, addr 0xed35e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Init, addr 0xed35e8, size 0x120, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName, addr 0xed3730, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0xed3770, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize, addr 0xed3778, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method ProcessBlock, addr 0xed3780, size 0x118, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0xed3b30, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method BytesToWord, addr 0xed3b34, size 0x40, virtual false, abstract: false, final false
  inline int32_t BytesToWord(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method WordToBytes, addr 0xed3b74, size 0x48, virtual false, abstract: false, final false
  inline void WordToBytes(int32_t word, ::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method Mul, addr 0xed3bbc, size 0xdc, virtual false, abstract: false, final false
  inline int32_t Mul(int32_t x, int32_t y);

  /// @brief Method IdeaFunc, addr 0xed3898, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandKey, addr 0xed3c98, size 0x1f8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> ExpandKey(::ArrayW<uint8_t, ::Array<uint8_t>*> uKey);

  /// @brief Method MulInv, addr 0xed3e90, size 0x118, virtual false, abstract: false, final false
  inline int32_t MulInv(int32_t x);

  /// @brief Method AddInv, addr 0xed3fa8, size 0x64, virtual false, abstract: false, final false
  inline int32_t AddInv(int32_t x);

  /// @brief Method InvertKey, addr 0xed400c, size 0x288, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> InvertKey(::ArrayW<int32_t, ::Array<int32_t>*> inKey);

  /// @brief Method GenerateWorkingKey, addr 0xed3708, size 0x28, virtual false, abstract: false, final false
