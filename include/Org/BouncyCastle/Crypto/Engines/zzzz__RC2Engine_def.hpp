...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x3292af4, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x3292520, size 0x5d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateWorkingKey, addr 0x3291f38, size 0x2e0, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GenerateWorkingKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key, int32_t bits);

  /// @brief Method GetBlockSize, addr 0x32923dc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x3292218, size 0x174, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::RC2Engine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x32923e4, size 0x13c, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x329238c, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method RotateWordLeft, addr 0x3292f14, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3292fc8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_piTable();

  /// @brief Method get_AlgorithmName, addr 0x3292390, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x32923d4, size 0x8, virtual true, abstract: false, final false
