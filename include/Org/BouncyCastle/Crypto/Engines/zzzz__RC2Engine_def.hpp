...
public:
  ...
  /// @brief Method GenerateWorkingKey, addr 0xed8610, size 0x2e0, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GenerateWorkingKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key, int32_t bits);

  /// @brief Method Init, addr 0xed88f0, size 0x174, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Reset, addr 0xed8a64, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method get_AlgorithmName, addr 0xed8a68, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0xed8aa8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize, addr 0xed8ab0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method ProcessBlock, addr 0xed8ab8, size 0x138, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method RotateWordLeft, addr 0xed9528, size 0x1c, virtual false, abstract: false, final false
  inline int32_t RotateWordLeft(int32_t x, int32_t y);

  /// @brief Method EncryptBlock, addr 0xed8bf0, size 0x4e0, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptBlock, addr 0xed90d0, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed95d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
