...
public:
  ...
  /// @brief Method AddSBox addr 0xe5bcfc size 0x11c virtual false final false
  ...
  /// @brief Method .ctor addr 0xe5be18 size 0x6c virtual false final false
  inline void _ctor();

  /// @brief Method Init addr 0xe5be84 size 0x264 virtual true final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName addr 0xe5c21c size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay addr 0xe5c25c size 0x8 virtual true final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize addr 0xe5c264 size 0x8 virtual true final false
  inline int32_t GetBlockSize();

  /// @brief Method ProcessBlock addr 0xe5c26c size 0x118 virtual true final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xe5c5c8 size 0x4 virtual true final false
  inline void Reset();

  /// @brief Method generateWorkingKey addr 0xe5c0e8 size 0x134 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> generateWorkingKey(bool forEncryption, ::ArrayW<uint8_t, ::Array<uint8_t>*> userKey);

  /// @brief Method Gost28147_mainStep addr 0xe5c640 size 0xe8 virtual false final false
  inline int32_t Gost28147_mainStep(int32_t n1, int32_t key);

  /// @brief Method Gost28147Func addr 0xe5c384 size 0x244 virtual false final false
  ...
  /// @brief Method bytesToint addr 0xe5c5cc size 0x74 virtual false final false
  static inline int32_t bytesToint(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff);

  /// @brief Method intTobytes addr 0xe5c728 size 0x80 virtual false final false
  static inline void intTobytes(int32_t num, ::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method GetSBox addr 0xe5c7a8 size 0x1c0 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSBox(::StringW sBoxName);

  /// @brief Method GetSBoxName addr 0xe5c968 size 0x55c virtual false final false
