...
public:
  ...
  /// @brief Method Init, addr 0x232bdcc, size 0x110, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::IsaacEngine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x232c4b4, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x232c6d8, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x232c2c4, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x232c82c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x232c698, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method isaac, addr 0x232c33c, size 0x178, virtual false, abstract: false, final false
  inline void isaac();

  /// @brief Method mix, addr 0x232c6e0, size 0xfc, virtual false, abstract: false, final false
  inline void mix(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method setKey, addr 0x232bedc, size 0x3e8, virtual false, abstract: false, final false
