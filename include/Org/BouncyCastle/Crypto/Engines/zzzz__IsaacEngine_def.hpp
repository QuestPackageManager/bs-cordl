...
public:
  ...
  /// @brief Method Init, addr 0x2320d24, size 0x110, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::IsaacEngine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x232140c, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x2321630, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x232121c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2321784, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x23215f0, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method isaac, addr 0x2321294, size 0x178, virtual false, abstract: false, final false
  inline void isaac();

  /// @brief Method mix, addr 0x2321638, size 0xfc, virtual false, abstract: false, final false
  inline void mix(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method setKey, addr 0x2320e34, size 0x3e8, virtual false, abstract: false, final false
