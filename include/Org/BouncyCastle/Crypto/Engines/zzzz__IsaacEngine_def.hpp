...
public:
  ...
  /// @brief Method Init, addr 0x2361408, size 0x110, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::IsaacEngine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x2361af0, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x2361d14, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x2361900, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2361e68, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x2361cd4, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method isaac, addr 0x2361978, size 0x178, virtual false, abstract: false, final false
  inline void isaac();

  /// @brief Method mix, addr 0x2361d1c, size 0xfc, virtual false, abstract: false, final false
  inline void mix(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method setKey, addr 0x2361518, size 0x3e8, virtual false, abstract: false, final false
