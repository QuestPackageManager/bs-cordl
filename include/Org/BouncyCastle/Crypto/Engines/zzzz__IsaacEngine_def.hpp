...
public:
  ...
  /// @brief Method Init, addr 0x32b99bc, size 0x11c, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::IsaacEngine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x32ba0b0, size 0x1f8, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x32ba2ec, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x32b9ed0, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ba444, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x32ba2a8, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method isaac, addr 0x32b9f48, size 0x168, virtual false, abstract: false, final false
  inline void isaac();

  /// @brief Method mix, addr 0x32ba2f4, size 0xfc, virtual false, abstract: false, final false
  inline void mix(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method setKey, addr 0x32b9ad8, size 0x3f8, virtual false, abstract: false, final false
