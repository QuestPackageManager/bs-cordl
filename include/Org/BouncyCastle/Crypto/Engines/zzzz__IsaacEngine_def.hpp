...
public:
  ...
  /// @brief Method Init, addr 0xf66b78, size 0x114, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::IsaacEngine* New_ctor();

  /// @brief Method ProcessBytes, addr 0xf67268, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xf67494, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0xf67074, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf675e8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0xf67454, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method isaac, addr 0xf670ec, size 0x17c, virtual false, abstract: false, final false
  inline void isaac();

  /// @brief Method mix, addr 0xf6749c, size 0xfc, virtual false, abstract: false, final false
  inline void mix(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method setKey, addr 0xf66c8c, size 0x3e8, virtual false, abstract: false, final false
