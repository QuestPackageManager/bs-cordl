...
public:
  ...
  /// @brief Method Init, addr 0x113b690, size 0x114, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::IsaacEngine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x113bd80, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x113bfac, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x113bb8c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x113c100, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x113bf6c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method isaac, addr 0x113bc04, size 0x17c, virtual false, abstract: false, final false
  inline void isaac();

  /// @brief Method mix, addr 0x113bfb4, size 0xfc, virtual false, abstract: false, final false
  inline void mix(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method setKey, addr 0x113b7a4, size 0x3e8, virtual false, abstract: false, final false
