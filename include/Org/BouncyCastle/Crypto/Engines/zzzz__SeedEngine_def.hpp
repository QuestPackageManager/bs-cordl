...
public:
  ...
  /// @brief Method Init, addr 0xf0d01c, size 0xac, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName, addr 0xf0d270, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0xf0d2b0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize, addr 0xf0d2b8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method ProcessBlock, addr 0xf0d2c0, size 0x1f8, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xf0d5d0, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method createWorkingKey, addr 0xf0d0c8, size 0x1a8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> createWorkingKey(::ArrayW<uint8_t, ::Array<uint8_t>*> inKey);

  /// @brief Method extractW1, addr 0xf0d5dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t extractW1(int64_t lVal);

  /// @brief Method extractW0, addr 0xf0d5d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t extractW0(int64_t lVal);

  /// @brief Method rotateLeft8, addr 0xf0d6d8, size 0x8, virtual false, abstract: false, final false
  inline int64_t rotateLeft8(int64_t x);

  /// @brief Method rotateRight8, addr 0xf0d6d0, size 0x8, virtual false, abstract: false, final false
  inline int64_t rotateRight8(int64_t x);

  /// @brief Method bytesToLong, addr 0xf0d4b8, size 0x5c, virtual false, abstract: false, final false
  inline int64_t bytesToLong(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t srcOff);

  /// @brief Method longToBytes, addr 0xf0d578, size 0x58, virtual false, abstract: false, final false
  inline void longToBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> dest, int32_t destOff, int64_t value);

  /// @brief Method G, addr 0xf0d5e4, size 0xec, virtual false, abstract: false, final false
  inline int32_t G(int32_t x);

  /// @brief Method F, addr 0xf0d514, size 0x64, virtual false, abstract: false, final false
  inline int64_t F(int32_t ki0, int32_t ki1, int64_t r);

  /// @brief Method phaseCalc1, addr 0xf0d720, size 0x20, virtual false, abstract: false, final false
  inline int32_t phaseCalc1(int32_t r0, int32_t ki0, int32_t r1, int32_t ki1);

  /// @brief Method phaseCalc2, addr 0xf0d6e0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0d8d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
