...
public:
  ...
  /// @brief Method Init, addr 0xf4c498, size 0x108, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::RC4Engine* New_ctor();

  /// @brief Method ProcessBytes, addr 0xf4c85c, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xf4ca30, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0xf4c788, size 0xd4, virtual true, abstract: false, final false
  inline uint8_t ReturnByte(uint8_t input);

  /// @brief Method SetKey, addr 0xf4c5a0, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf4ca84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int32_t getStaticF_STATE_LENGTH();

  /// @brief Method get_AlgorithmName, addr 0xf4c748, size 0x40, virtual true, abstract: false, final false
