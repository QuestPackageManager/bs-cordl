...
public:
  ...
  /// @brief Method Init, addr 0x236a75c, size 0x100, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::RC4Engine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x236ab18, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x236acec, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x236aa44, size 0xd4, virtual true, abstract: false, final false
  inline uint8_t ReturnByte(uint8_t input);

  /// @brief Method SetKey, addr 0x236a85c, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x236ad40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int32_t getStaticF_STATE_LENGTH();

  /// @brief Method get_AlgorithmName, addr 0x236aa04, size 0x40, virtual true, abstract: false, final false
