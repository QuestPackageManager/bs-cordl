...
public:
  ...
  /// @brief Method Dim, addr 0x1138218, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t Dim(uint32_t x, uint32_t y);

  /// @brief Method F1, addr 0x1138114, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t F1(uint32_t x);

  /// @brief Method F2, addr 0x113812c, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t F2(uint32_t x);

  /// @brief Method G1, addr 0x113813c, size 0x14, virtual false, abstract: false, final false
  inline uint32_t G1(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method G2, addr 0x1138150, size 0x14, virtual false, abstract: false, final false
  inline uint32_t G2(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method GetByte, addr 0x11388e0, size 0x60, virtual false, abstract: false, final false
  inline uint8_t GetByte();

  /// @brief Method H1, addr 0x1138170, size 0x4c, virtual false, abstract: false, final false
  inline uint32_t H1(uint32_t x);

  /// @brief Method H2, addr 0x11381bc, size 0x4c, virtual false, abstract: false, final false
  inline uint32_t H2(uint32_t x);

  /// @brief Method Init, addr 0x11383cc, size 0x300, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method Init, addr 0x113870c, size 0x1d4, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Mod1024, addr 0x1138208, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Mod1024(uint32_t x);

  /// @brief Method Mod512, addr 0x1138210, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Mod512(uint32_t x);

  static inline ::Org::BouncyCastle::Crypto::Engines::HC128Engine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x1138940, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x1138adc, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x1138ae0, size 0x18, virtual true, abstract: false, final false
  inline uint8_t ReturnByte(uint8_t input);

  /// @brief Method RotateLeft, addr 0x1138164, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t RotateLeft(uint32_t x, int32_t bits);

  /// @brief Method RotateRight, addr 0x1138124, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t RotateRight(uint32_t x, int32_t bits);

  /// @brief Method Step, addr 0x1138224, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1138af8, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x11386cc, size 0x40, virtual true, abstract: false, final false
