...
public:
  ...
  /// @brief Method GetByte, addr 0x235f194, size 0x60, virtual false, abstract: false, final false
  inline uint8_t GetByte();

  /// @brief Method Init, addr 0x235ec28, size 0x35c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method Init, addr 0x235efc4, size 0x1d0, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::HC256Engine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x235f1f4, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x235f388, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x235f38c, size 0x18, virtual true, abstract: false, final false
  inline uint8_t ReturnByte(uint8_t input);

  /// @brief Method RotateRight, addr 0x235ec20, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t RotateRight(uint32_t x, int32_t bits);

  /// @brief Method Step, addr 0x235e9ac, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x235f3a4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x235ef84, size 0x40, virtual true, abstract: false, final false
