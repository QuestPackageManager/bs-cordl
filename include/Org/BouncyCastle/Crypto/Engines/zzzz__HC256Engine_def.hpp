...
public:
  ...
  /// @brief Method GetByte, addr 0x32b767c, size 0x60, virtual false, abstract: false, final false
  inline uint8_t GetByte();

  /// @brief Method Init, addr 0x32b70d0, size 0x380, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method Init, addr 0x32b7494, size 0x1e8, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::HC256Engine* New_ctor();

  /// @brief Method ProcessBytes, addr 0x32b76dc, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x32b788c, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x32b7890, size 0x18, virtual true, abstract: false, final false
  inline uint8_t ReturnByte(uint8_t input);

  /// @brief Method RotateRight, addr 0x32b70c8, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t RotateRight(uint32_t x, int32_t bits);

  /// @brief Method Step, addr 0x32b6eb0, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b78a8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x32b7450, size 0x44, virtual true, abstract: false, final false
