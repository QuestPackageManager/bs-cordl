...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x3271660, size 0x8c8, virtual false, abstract: false, final false
  inline void DecryptBlock(::ArrayW<::ArrayW<uint32_t, ::Array<uint32_t>*>, ::Array<::ArrayW<uint32_t, ::Array<uint32_t>*>>*> KW);

  /// @brief Method EncryptBlock, addr 0x3270d6c, size 0x8f4, virtual false, abstract: false, final false
  inline void EncryptBlock(::ArrayW<::ArrayW<uint32_t, ::Array<uint32_t>*>, ::Array<::ArrayW<uint32_t, ::Array<uint32_t>*>>*> KW);

  /// @brief Method FFmulX, addr 0x326fd04, size 0x20, virtual false, abstract: false, final false
  static inline uint32_t FFmulX(uint32_t x);

  /// @brief Method FFmulX2, addr 0x326fd24, size 0x1c, virtual false, abstract: false, final false
  static inline uint32_t FFmulX2(uint32_t x);

  /// @brief Method GenerateWorkingKey, addr 0x326fea4, size 0xb18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBlockSize, addr 0x3270bb8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x32709c0, size 0x1ac, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Inv_Mcol, addr 0x326fd40, size 0x9c, virtual false, abstract: false, final false
  static inline uint32_t Inv_Mcol(uint32_t x);

  static inline ::Org::BouncyCastle::Crypto::Engines::AesEngine* New_ctor();

  /// @brief Method PackBlock, addr 0x3271f28, size 0x64, virtual false, abstract: false, final false
  inline void PackBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off);

  /// @brief Method ProcessBlock, addr 0x3270bc0, size 0x13c, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3271f8c, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Shift, addr 0x326fcfc, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Shift(uint32_t r, int32_t shift);

  /// @brief Method SubWord, addr 0x326fddc, size 0xc8, virtual false, abstract: false, final false
  static inline uint32_t SubWord(uint32_t x);

  /// @brief Method UnPackBlock, addr 0x3270cfc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32709bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x3270b6c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x3270bb0, size 0x8, virtual true, abstract: false, final false
