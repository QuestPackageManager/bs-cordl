...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::SeedWrapEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::SeedWrapEngine*, "Org.BouncyCastle.Crypto.Engines", "SeedWrapEngine");
...
public:
  ...
  /// @brief Method .ctor, addr 0x33c16bc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SeedWrapEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SeedWrapEngine(SeedWrapEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SeedWrapEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SeedWrapEngine(SeedWrapEngineconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::SeedWrapEngine) == 0x30, "Size mismatch!");
