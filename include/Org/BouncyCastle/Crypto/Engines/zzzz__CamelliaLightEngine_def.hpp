...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x33a0a8c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x33a0a94, size 0xf0, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::CamelliaLightEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x33a0b84, size 0x13c, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33a0cc0, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x33a09ac, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method bytes2uint, addr 0x339ee14, size 0x58, virtual false, abstract: false, final false
  static inline uint32_t bytes2uint(::ArrayW<uint8_t> src, int32_t offset);

  /// @brief Method camelliaF2, addr 0x339f070, size 0x2dc, virtual false, abstract: false, final false
  inline void camelliaF2(::ArrayW<uint32_t> s, ::ArrayW<uint32_t> skey, int32_t keyoff);

  /// @brief Method camelliaFLs, addr 0x339f34c, size 0x134, virtual false, abstract: false, final false
  inline void camelliaFLs(::ArrayW<uint32_t> s, ::ArrayW<uint32_t> fkey, int32_t keyoff);

  /// @brief Method decroldq, addr 0x339eaa8, size 0x124, virtual false, abstract: false, final false
  static inline void decroldq(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff);

  /// @brief Method decroldqo32, addr 0x339ecf0, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x33a0a40, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x33a0a84, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  /// @brief Method lRot8, addr 0x339eeb4, size 0x1c, virtual false, abstract: false, final false
  inline uint8_t lRot8(uint8_t v, int32_t rot);

  /// @brief Method leftRotate, addr 0x339e970, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t leftRotate(uint32_t x, int32_t s);

  /// @brief Method processBlock128, addr 0x33a0408, size 0x2b4, virtual false, abstract: false, final false
  inline int32_t processBlock128(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method processBlock192or256, addr 0x33a06bc, size 0x2f0, virtual false, abstract: false, final false
  inline int32_t processBlock192or256(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method rightRotate, addr 0x339e95c, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t rightRotate(uint32_t x, int32_t s);

  /// @brief Method roldq, addr 0x339e984, size 0x124, virtual false, abstract: false, final false
  static inline void roldq(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff);

  /// @brief Method roldqo32, addr 0x339ebcc, size 0x124, virtual false, abstract: false, final false
  static inline void roldqo32(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff);

  /// @brief Method sbox2, addr 0x339eed0, size 0x8c, virtual false, abstract: false, final false
  inline uint32_t sbox2(int32_t x);

  /// @brief Method sbox3, addr 0x339ef5c, size 0x8c, virtual false, abstract: false, final false
  inline uint32_t sbox3(int32_t x);

  /// @brief Method sbox4, addr 0x339efe8, size 0x88, virtual false, abstract: false, final false
  inline uint32_t sbox4(int32_t x);

  /// @brief Method setKey, addr 0x339f480, size 0xf88, virtual false, abstract: false, final false
  ...
  /// @brief Method uint2bytes, addr 0x339ee6c, size 0x48, virtual false, abstract: false, final false
