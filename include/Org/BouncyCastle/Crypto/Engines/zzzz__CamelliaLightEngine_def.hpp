...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::CamelliaLightEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::CamelliaLightEngine*, "Org.BouncyCastle.Crypto.Engines", "CamelliaLightEngine");
...
public:
  ...
  __declspec(property(get = getStaticF_SBOX1, put = setStaticF_SBOX1)) ::ArrayW<uint8_t> SBOX1;

  /// @brief Field SIGMA, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_SIGMA, put = setStaticF_SIGMA)) ::ArrayW<uint32_t> SIGMA;
  ...
  __declspec(property(get = __cordl_internal_get_ke, put = __cordl_internal_set_ke)) ::ArrayW<uint32_t> ke;

  /// @brief Field kw, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get_kw, put = __cordl_internal_set_kw)) ::ArrayW<uint32_t> kw;
  ...
  __declspec(property(get = __cordl_internal_get_subkey, put = __cordl_internal_set_subkey)) ::ArrayW<uint32_t> subkey;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr operator ::Org::BouncyCastle::Crypto::IBlockCipher*() noexcept;

  /// @brief Method GetBlockSize, addr 0x33a2e14, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x33a2e1c, size 0xf0, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::CamelliaLightEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x33a2f0c, size 0x13c, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33a3048, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_ke() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_ke();

  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_kw() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_kw();

  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_state() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_state();

  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_subkey() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_subkey();

  constexpr void __cordl_internal_set__keyis128(bool value);

  constexpr void __cordl_internal_set_initialised(bool value);

  constexpr void __cordl_internal_set_ke(::ArrayW<uint32_t> value);

  constexpr void __cordl_internal_set_kw(::ArrayW<uint32_t> value);
  ...
  /// @brief Method .ctor, addr 0x33a2d34, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method bytes2uint, addr 0x33a119c, size 0x58, virtual false, abstract: false, final false
  static inline uint32_t bytes2uint(::ArrayW<uint8_t> src, int32_t offset);

  /// @brief Method camelliaF2, addr 0x33a13f8, size 0x2dc, virtual false, abstract: false, final false
  inline void camelliaF2(::ArrayW<uint32_t> s, ::ArrayW<uint32_t> skey, int32_t keyoff);

  /// @brief Method camelliaFLs, addr 0x33a16d4, size 0x134, virtual false, abstract: false, final false
  inline void camelliaFLs(::ArrayW<uint32_t> s, ::ArrayW<uint32_t> fkey, int32_t keyoff);

  /// @brief Method decroldq, addr 0x33a0e30, size 0x124, virtual false, abstract: false, final false
  static inline void decroldq(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff);

  /// @brief Method decroldqo32, addr 0x33a1078, size 0x124, virtual false, abstract: false, final false
  static inline void decroldqo32(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff);

  static inline ::ArrayW<uint8_t> getStaticF_SBOX1();

  static inline ::ArrayW<uint32_t> getStaticF_SIGMA();

  /// @brief Method get_AlgorithmName, addr 0x33a2dc8, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x33a2e0c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  /// @brief Method lRot8, addr 0x33a123c, size 0x1c, virtual false, abstract: false, final false
  inline uint8_t lRot8(uint8_t v, int32_t rot);

  /// @brief Method leftRotate, addr 0x33a0cf8, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t leftRotate(uint32_t x, int32_t s);

  /// @brief Method processBlock128, addr 0x33a2790, size 0x2b4, virtual false, abstract: false, final false
  inline int32_t processBlock128(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method processBlock192or256, addr 0x33a2a44, size 0x2f0, virtual false, abstract: false, final false
  inline int32_t processBlock192or256(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method rightRotate, addr 0x33a0ce4, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t rightRotate(uint32_t x, int32_t s);

  /// @brief Method roldq, addr 0x33a0d0c, size 0x124, virtual false, abstract: false, final false
  static inline void roldq(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff);

  /// @brief Method roldqo32, addr 0x33a0f54, size 0x124, virtual false, abstract: false, final false
  static inline void roldqo32(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff);

  /// @brief Method sbox2, addr 0x33a1258, size 0x8c, virtual false, abstract: false, final false
  inline uint32_t sbox2(int32_t x);

  /// @brief Method sbox3, addr 0x33a12e4, size 0x8c, virtual false, abstract: false, final false
  inline uint32_t sbox3(int32_t x);

  /// @brief Method sbox4, addr 0x33a1370, size 0x88, virtual false, abstract: false, final false
  inline uint32_t sbox4(int32_t x);

  /// @brief Method setKey, addr 0x33a1808, size 0xf88, virtual false, abstract: false, final false
  inline void setKey(bool forEncryption, ::ArrayW<uint8_t> key);

  static inline void setStaticF_SBOX1(::ArrayW<uint8_t> value);

  static inline void setStaticF_SIGMA(::ArrayW<uint32_t> value);

  /// @brief Method uint2bytes, addr 0x33a11f4, size 0x48, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CamelliaLightEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CamelliaLightEngine(CamelliaLightEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CamelliaLightEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CamelliaLightEngine(CamelliaLightEngineconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::CamelliaLightEngine) == 0x38, "Size mismatch!");
