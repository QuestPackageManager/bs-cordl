...
public:
  ...
  /// @brief Method .ctor, addr 0xee8688, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Init, addr 0xee8770, size 0x144, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName, addr 0xee8bbc, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0xee8bfc, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsPartialBlockOkay();

  /// @brief Method ProcessBlock, addr 0xee8c04, size 0x138, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0xee9070, size 0x4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method GetBlockSize, addr 0xee9074, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method F, addr 0xee907c, size 0xa0, virtual false, abstract: false, final false
  inline uint32_t F(uint32_t x);

  /// @brief Method ProcessTable, addr 0xee911c, size 0x1a8, virtual false, abstract: false, final false
  inline void ProcessTable(uint32_t xl, uint32_t xr, ::ArrayW<uint32_t, ::Array<uint32_t>*> table);

  /// @brief Method SetKey, addr 0xee88b4, size 0x308, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method EncryptBlock, addr 0xee8d3c, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptBlock, addr 0xee8ee0, size 0x190, virtual false, abstract: false, final false
