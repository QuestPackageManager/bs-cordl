...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RijndaelEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RijndaelEngine(RijndaelEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RijndaelEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RijndaelEngine(RijndaelEngineconst&) = delete;
