...
public:
  ...
  /// @brief Method CalculateCmsKeyChecksum, addr 0xf5d6f0, size 0x180, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CalculateCmsKeyChecksum(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method CheckCmsKeyChecksum, addr 0xf5dd48, size 0x80, virtual false, abstract: false, final false
  inline bool CheckCmsKeyChecksum(::ArrayW<uint8_t, ::Array<uint8_t>*> key, ::ArrayW<uint8_t, ::Array<uint8_t>*> checksum);

  /// @brief Method Init, addr 0xf5cfdc, size 0x39c, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0xf5d918, size 0x430, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Wrap, addr 0xf5d3b8, size 0x338, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf5de5c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_IV2();

  /// @brief Method get_AlgorithmName, addr 0xf5d378, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method reverse, addr 0xf5d870, size 0xa8, virtual false, abstract: false, final false
