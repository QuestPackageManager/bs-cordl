...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DesEdeWrapEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DesEdeWrapEngine(DesEdeWrapEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DesEdeWrapEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DesEdeWrapEngine(DesEdeWrapEngineconst&) = delete;
