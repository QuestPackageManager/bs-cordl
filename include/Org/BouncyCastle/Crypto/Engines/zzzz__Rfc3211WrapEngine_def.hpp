...
public:
  ...
  /// @brief Method Init, addr 0x33ba908, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0x33badd8, size 0x3dc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> Unwrap(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method Wrap, addr 0x33bab58, size 0x280, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ba89c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* engine);

  /// @brief Method get_AlgorithmName, addr 0x33baa88, size 0xd0, virtual true, abstract: false, final false
