...
public:
  ...
  /// @brief Method Init, addr 0xf4ed6c, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0xf4f270, size 0x3c0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method Wrap, addr 0xf4efec, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf4ecf0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* engine);

  /// @brief Method get_AlgorithmName, addr 0xf4ef24, size 0xc8, virtual true, abstract: false, final false
