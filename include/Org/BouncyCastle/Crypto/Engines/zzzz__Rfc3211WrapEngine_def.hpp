...
public:
  ...
  /// @brief Method Init, addr 0x2366870, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0x2366d60, size 0x3d0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method Wrap, addr 0x2366ae4, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23667fc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* engine);

  /// @brief Method get_AlgorithmName, addr 0x2366a1c, size 0xc8, virtual true, abstract: false, final false
