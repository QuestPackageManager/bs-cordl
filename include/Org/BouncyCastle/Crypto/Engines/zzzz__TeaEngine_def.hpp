...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x2374de0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x2374de8, size 0x140, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::TeaEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x2374f94, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x23752b4, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2374d7c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method decryptBlock, addr 0x23750ec, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method encryptBlock, addr 0x23751d0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x2374d98, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x2374dd8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  /// @brief Method setKey, addr 0x2374f28, size 0x6c, virtual false, abstract: false, final false
