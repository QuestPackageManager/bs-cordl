...
public:
  ...
  /// @brief Method .ctor, addr 0x23727dc, size 0x2c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x2372be8, size 0x430, virtual true, abstract: false, final false
  inline void DecryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> state);

  /// @brief Method EncryptBlock, addr 0x2372808, size 0x3e0, virtual true, abstract: false, final false
  inline void EncryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> outWords);
  ...
  /// @brief Method .ctor, addr 0x2371b90, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint64_t, ::Array<uint64_t>*> kw, ::ArrayW<uint64_t, ::Array<uint64_t>*> t);
...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x23735a4, size 0x694, virtual true, abstract: false, final false
  inline void DecryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> state);

  /// @brief Method EncryptBlock, addr 0x2373018, size 0x58c, virtual true, abstract: false, final false
  inline void EncryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> outWords);
  ...
  /// @brief Method .ctor, addr 0x2371bbc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint64_t, ::Array<uint64_t>*> kw, ::ArrayW<uint64_t, ::Array<uint64_t>*> t);
...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x23745a4, size 0xc00, virtual true, abstract: false, final false
  inline void DecryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> state);

  /// @brief Method EncryptBlock, addr 0x2373c38, size 0x96c, virtual true, abstract: false, final false
  inline void EncryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> outWords);
  ...
  /// @brief Method .ctor, addr 0x2371be8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint64_t, ::Array<uint64_t>*> kw, ::ArrayW<uint64_t, ::Array<uint64_t>*> t);
...
public:
  ...
  /// @brief Method BytesToWord, addr 0x2371f4c, size 0xf8, virtual false, abstract: false, final false
  static inline uint64_t BytesToWord(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off);

  /// @brief Method GetBlockSize, addr 0x2372394, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x2372044, size 0x4c, virtual false, abstract: false, final false
  inline void Init(bool forEncryption, ::ArrayW<uint64_t, ::Array<uint64_t>*> key, ::ArrayW<uint64_t, ::Array<uint64_t>*> tweak);

  /// @brief Method Init, addr 0x2371c14, size 0x338, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::ThreefishEngine* New_ctor(int32_t blocksizeBits);

  /// @brief Method ProcessBlock, addr 0x23723a0, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x2372570, size 0x120, virtual false, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> inWords, ::ArrayW<uint64_t, ::Array<uint64_t>*> outWords);

  /// @brief Method Reset, addr 0x237239c, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method RotlXor, addr 0x23727c0, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t RotlXor(uint64_t x, int32_t n, uint64_t _cordl_xor);

  /// @brief Method SetKey, addr 0x2372090, size 0x160, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint64_t, ::Array<uint64_t>*> key);

  /// @brief Method SetTweak, addr 0x23721f0, size 0x114, virtual false, abstract: false, final false
  inline void SetTweak(::ArrayW<uint64_t, ::Array<uint64_t>*> tweak);

  /// @brief Method WordToBytes, addr 0x2372690, size 0x130, virtual false, abstract: false, final false
  static inline void WordToBytes(uint64_t word, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off);

  /// @brief Method XorRotr, addr 0x23727d0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2371a1c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x2372304, size 0x88, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x237238c, size 0x8, virtual true, abstract: false, final false
