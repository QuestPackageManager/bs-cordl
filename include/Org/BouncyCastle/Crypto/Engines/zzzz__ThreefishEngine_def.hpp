...
/// @brief Method .ctor, addr 0x330b9ec, size 0x8, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method DecryptBlock, addr 0x330bda0, size 0x438, virtual true, abstract: false, final false
inline void DecryptBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  block, ::ArrayW<uint64_t,::Array<uint64_t>*>  state) ;

/// @brief Method EncryptBlock, addr 0x330b9f4, size 0x3ac, virtual true, abstract: false, final false
inline void EncryptBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  block, ::ArrayW<uint64_t,::Array<uint64_t>*>  outWords) ;
...
/// @brief Method .ctor, addr 0x330ae08, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint64_t,::Array<uint64_t>*>  kw, ::ArrayW<uint64_t,::Array<uint64_t>*>  t) ;
...
public:
// Declarations
/// @brief Method DecryptBlock, addr 0x330c748, size 0x6a8, virtual true, abstract: false, final false
inline void DecryptBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  block, ::ArrayW<uint64_t,::Array<uint64_t>*>  state) ;

/// @brief Method EncryptBlock, addr 0x330c1d8, size 0x570, virtual true, abstract: false, final false
inline void EncryptBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  block, ::ArrayW<uint64_t,::Array<uint64_t>*>  outWords) ;
...
/// @brief Method .ctor, addr 0x330ae10, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint64_t,::Array<uint64_t>*>  kw, ::ArrayW<uint64_t,::Array<uint64_t>*>  t) ;
...
public:
// Declarations
/// @brief Method DecryptBlock, addr 0x330d764, size 0xc0c, virtual true, abstract: false, final false
inline void DecryptBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  block, ::ArrayW<uint64_t,::Array<uint64_t>*>  state) ;

/// @brief Method EncryptBlock, addr 0x330cdf0, size 0x974, virtual true, abstract: false, final false
inline void EncryptBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  block, ::ArrayW<uint64_t,::Array<uint64_t>*>  outWords) ;
...
/// @brief Method .ctor, addr 0x330ae18, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint64_t,::Array<uint64_t>*>  kw, ::ArrayW<uint64_t,::Array<uint64_t>*>  t) ;
...
/// @brief Method BytesToWord, addr 0x330b160, size 0xf8, virtual false, abstract: false, final false
static inline uint64_t BytesToWord(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off) ;

/// @brief Method GetBlockSize, addr 0x330b58c, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x330b258, size 0x48, virtual false, abstract: false, final false
inline void Init(bool  forEncryption, ::ArrayW<uint64_t,::Array<uint64_t>*>  key, ::ArrayW<uint64_t,::Array<uint64_t>*>  tweak) ;

/// @brief Method Init, addr 0x330ae20, size 0x340, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::ThreefishEngine* New_ctor(int32_t  blocksizeBits) ;

/// @brief Method ProcessBlock, addr 0x330b598, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x330b768, size 0x138, virtual false, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  inWords, ::ArrayW<uint64_t,::Array<uint64_t>*>  outWords) ;

/// @brief Method Reset, addr 0x330b594, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method RotlXor, addr 0x330b9d0, size 0x10, virtual false, abstract: false, final false
static inline uint64_t RotlXor(uint64_t  x, int32_t  n, uint64_t  _cordl_xor) ;

/// @brief Method SetKey, addr 0x330b2a0, size 0x15c, virtual false, abstract: false, final false
inline void SetKey(::ArrayW<uint64_t,::Array<uint64_t>*>  key) ;

/// @brief Method SetTweak, addr 0x330b3fc, size 0x110, virtual false, abstract: false, final false
inline void SetTweak(::ArrayW<uint64_t,::Array<uint64_t>*>  tweak) ;

/// @brief Method WordToBytes, addr 0x330b8a0, size 0x130, virtual false, abstract: false, final false
static inline void WordToBytes(uint64_t  word, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off) ;

/// @brief Method XorRotr, addr 0x330b9e0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x330ac8c, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x330b50c, size 0x78, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x330b584, size 0x8, virtual true, abstract: false, final false
