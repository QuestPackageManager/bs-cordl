...
public:
  ...
  /// @brief Method .ctor, addr 0x105599c, size 0x2c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x1055d9c, size 0x434, virtual true, abstract: false, final false
  inline void DecryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> state);

  /// @brief Method EncryptBlock, addr 0x10559c8, size 0x3d4, virtual true, abstract: false, final false
  inline void EncryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> outWords);
  ...
  /// @brief Method .ctor, addr 0x1054d18, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint64_t, ::Array<uint64_t>*> kw, ::ArrayW<uint64_t, ::Array<uint64_t>*> t);
...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x1056754, size 0x6b0, virtual true, abstract: false, final false
  inline void DecryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> state);

  /// @brief Method EncryptBlock, addr 0x10561d0, size 0x584, virtual true, abstract: false, final false
  inline void EncryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> outWords);
  ...
  /// @brief Method .ctor, addr 0x1054d44, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint64_t, ::Array<uint64_t>*> kw, ::ArrayW<uint64_t, ::Array<uint64_t>*> t);
...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x10577a0, size 0xbe4, virtual true, abstract: false, final false
  inline void DecryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> state);

  /// @brief Method EncryptBlock, addr 0x1056e04, size 0x99c, virtual true, abstract: false, final false
  inline void EncryptBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> block, ::ArrayW<uint64_t, ::Array<uint64_t>*> outWords);
  ...
  /// @brief Method .ctor, addr 0x1054d70, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint64_t, ::Array<uint64_t>*> kw, ::ArrayW<uint64_t, ::Array<uint64_t>*> t);
...
public:
  ...
  /// @brief Method BytesToWord, addr 0x10550dc, size 0x100, virtual false, abstract: false, final false
  static inline uint64_t BytesToWord(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off);

  /// @brief Method GetBlockSize, addr 0x1055538, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x10551dc, size 0x4c, virtual false, abstract: false, final false
  inline void Init(bool forEncryption, ::ArrayW<uint64_t, ::Array<uint64_t>*> key, ::ArrayW<uint64_t, ::Array<uint64_t>*> tweak);

  /// @brief Method Init, addr 0x1054d9c, size 0x340, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::ThreefishEngine* New_ctor(int32_t blocksizeBits);

  /// @brief Method ProcessBlock, addr 0x1055544, size 0x1d8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x105571c, size 0x12c, virtual false, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> inWords, ::ArrayW<uint64_t, ::Array<uint64_t>*> outWords);

  /// @brief Method Reset, addr 0x1055540, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method RotlXor, addr 0x1055980, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t RotlXor(uint64_t x, int32_t n, uint64_t _cordl_xor);

  /// @brief Method SetKey, addr 0x1055228, size 0x164, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint64_t, ::Array<uint64_t>*> key);

  /// @brief Method SetTweak, addr 0x105538c, size 0x11c, virtual false, abstract: false, final false
  inline void SetTweak(::ArrayW<uint64_t, ::Array<uint64_t>*> tweak);

  /// @brief Method WordToBytes, addr 0x1055848, size 0x138, virtual false, abstract: false, final false
  static inline void WordToBytes(uint64_t word, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t off);

  /// @brief Method XorRotr, addr 0x1055990, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1054b98, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x10554a8, size 0x88, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x1055530, size 0x8, virtual true, abstract: false, final false
