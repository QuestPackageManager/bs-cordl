...
public:
  ...
  __declspec(property(get = getStaticF_S, put = setStaticF_S)) ::ArrayW<uint8_t> S;

  /// @brief Field Si, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Si, put = setStaticF_Si)) ::ArrayW<uint8_t> Si;

  /// @brief Field T0, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_T0, put = setStaticF_T0)) ::ArrayW<uint32_t> T0;

  /// @brief Field T1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_T1, put = setStaticF_T1)) ::ArrayW<uint32_t> T1;

  /// @brief Field T2, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_T2, put = setStaticF_T2)) ::ArrayW<uint32_t> T2;

  /// @brief Field T3, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_T3, put = setStaticF_T3)) ::ArrayW<uint32_t> T3;

  /// @brief Field Tinv0, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Tinv0, put = setStaticF_Tinv0)) ::ArrayW<uint32_t> Tinv0;

  /// @brief Field Tinv1, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Tinv1, put = setStaticF_Tinv1)) ::ArrayW<uint32_t> Tinv1;

  /// @brief Field Tinv2, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Tinv2, put = setStaticF_Tinv2)) ::ArrayW<uint32_t> Tinv2;

  /// @brief Field Tinv3, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Tinv3, put = setStaticF_Tinv3)) ::ArrayW<uint32_t> Tinv3;

  /// @brief Field WorkingKey, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_WorkingKey, put = __cordl_internal_set_WorkingKey)) ::ArrayW<::ArrayW<uint32_t>> WorkingKey;

  /// @brief Field forEncryption, offset 0x30, size 0x1
  __declspec(property(get = __cordl_internal_get_forEncryption, put = __cordl_internal_set_forEncryption)) bool forEncryption;

  /// @brief Field rcon, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_rcon, put = setStaticF_rcon)) ::ArrayW<uint8_t> rcon;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr operator ::Org::BouncyCastle::Crypto::IBlockCipher*() noexcept;

  /// @brief Method DecryptBlock, addr 0x3397a40, size 0x8d0, virtual false, abstract: false, final false
  inline void DecryptBlock(::ArrayW<::ArrayW<uint32_t>> KW);

  /// @brief Method EncryptBlock, addr 0x3397150, size 0x8f0, virtual false, abstract: false, final false
  inline void EncryptBlock(::ArrayW<::ArrayW<uint32_t>> KW);

  /// @brief Method FFmulX, addr 0x3396174, size 0x20, virtual false, abstract: false, final false
  static inline uint32_t FFmulX(uint32_t x);

  /// @brief Method FFmulX2, addr 0x3396194, size 0x1c, virtual false, abstract: false, final false
  static inline uint32_t FFmulX2(uint32_t x);

  /// @brief Method GenerateWorkingKey, addr 0x3396314, size 0xb18, virtual false, abstract: false, final false
  inline ::ArrayW<::ArrayW<uint32_t>> GenerateWorkingKey(::ArrayW<uint8_t> key, bool forEncryption);

  /// @brief Method GetBlockSize, addr 0x3396f9c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x3396e30, size 0x120, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Inv_Mcol, addr 0x33961b0, size 0x9c, virtual false, abstract: false, final false
  static inline uint32_t Inv_Mcol(uint32_t x);

  static inline ::Org::BouncyCastle::Crypto::Engines::AesFastEngine* New_ctor();

  /// @brief Method PackBlock, addr 0x3398310, size 0x64, virtual false, abstract: false, final false
  inline void PackBlock(::ArrayW<uint8_t> bytes, int32_t off);

  /// @brief Method ProcessBlock, addr 0x3396fa4, size 0x13c, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3398374, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Shift, addr 0x339616c, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Shift(uint32_t r, int32_t shift);

  /// @brief Method SubWord, addr 0x339624c, size 0xc8, virtual false, abstract: false, final false
  static inline uint32_t SubWord(uint32_t x);

  /// @brief Method UnPackBlock, addr 0x33970e0, size 0x70, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::ArrayW<uint32_t>> const& __cordl_internal_get_WorkingKey() const;

  constexpr ::ArrayW<::ArrayW<uint32_t>>& __cordl_internal_get_WorkingKey();
  ...
  constexpr void __cordl_internal_set_WorkingKey(::ArrayW<::ArrayW<uint32_t>> value);

  constexpr void __cordl_internal_set_forEncryption(bool value);

  /// @brief Method .ctor, addr 0x3396e2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t> getStaticF_S();

  static inline ::ArrayW<uint8_t> getStaticF_Si();

  static inline ::ArrayW<uint32_t> getStaticF_T0();

  static inline ::ArrayW<uint32_t> getStaticF_T1();

  static inline ::ArrayW<uint32_t> getStaticF_T2();

  static inline ::ArrayW<uint32_t> getStaticF_T3();

  static inline ::ArrayW<uint32_t> getStaticF_Tinv0();

  static inline ::ArrayW<uint32_t> getStaticF_Tinv1();

  static inline ::ArrayW<uint32_t> getStaticF_Tinv2();

  static inline ::ArrayW<uint32_t> getStaticF_Tinv3();

  static inline ::ArrayW<uint8_t> getStaticF_rcon();

  /// @brief Method get_AlgorithmName, addr 0x3396f50, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x3396f94, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  static inline void setStaticF_S(::ArrayW<uint8_t> value);

  static inline void setStaticF_Si(::ArrayW<uint8_t> value);

  static inline void setStaticF_T0(::ArrayW<uint32_t> value);

  static inline void setStaticF_T1(::ArrayW<uint32_t> value);

  static inline void setStaticF_T2(::ArrayW<uint32_t> value);

  static inline void setStaticF_T3(::ArrayW<uint32_t> value);

  static inline void setStaticF_Tinv0(::ArrayW<uint32_t> value);

  static inline void setStaticF_Tinv1(::ArrayW<uint32_t> value);

  static inline void setStaticF_Tinv2(::ArrayW<uint32_t> value);

  static inline void setStaticF_Tinv3(::ArrayW<uint32_t> value);

  static inline void setStaticF_rcon(::ArrayW<uint8_t> value);
...
public:
  ...
  ::ArrayW<::ArrayW<uint32_t>> ___WorkingKey;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::AesFastEngine) == 0x38, "Size mismatch!");
