...
public:
  ...
  /// @brief Method .ctor, addr 0xef47e0, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0xef4834, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_NonceSize, addr 0xef4874, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_NonceSize();

  /// @brief Method AdvanceCounter, addr 0xef487c, size 0x84, virtual true, abstract: false, final false
  inline void AdvanceCounter();

  /// @brief Method ResetCounter, addr 0xef4900, size 0x2c, virtual true, abstract: false, final false
  inline void ResetCounter();

  /// @brief Method SetKey, addr 0xef492c, size 0xe8, virtual true, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyBytes, ::ArrayW<uint8_t, ::Array<uint8_t>*> ivBytes);

  /// @brief Method GenerateKeyStream, addr 0xef4a14, size 0x3c, virtual true, abstract: false, final false
