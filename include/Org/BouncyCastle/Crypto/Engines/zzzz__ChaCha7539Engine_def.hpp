...
public:
  ...
  /// @brief Method AdvanceCounter, addr 0x2351f0c, size 0x80, virtual true, abstract: false, final false
  inline void AdvanceCounter();

  /// @brief Method GenerateKeyStream, addr 0x2352098, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetCounter, addr 0x2351f8c, size 0x2c, virtual true, abstract: false, final false
  inline void ResetCounter();

  /// @brief Method SetKey, addr 0x2351fb8, size 0xe0, virtual true, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyBytes, ::ArrayW<uint8_t, ::Array<uint8_t>*> ivBytes);

  /// @brief Method .ctor, addr 0x2351e70, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x2351ec4, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_NonceSize, addr 0x2351f04, size 0x8, virtual true, abstract: false, final false
