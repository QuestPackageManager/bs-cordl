...
public:
  ...
  /// @brief Method .ctor addr 0xe5477c size 0x54 virtual false final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName addr 0xe547d0 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_NonceSize addr 0xe54810 size 0x8 virtual true final false
  inline int32_t get_NonceSize();

  /// @brief Method AdvanceCounter addr 0xe54818 size 0x84 virtual true final false
  inline void AdvanceCounter();

  /// @brief Method ResetCounter addr 0xe5489c size 0x2c virtual true final false
  inline void ResetCounter();

  /// @brief Method SetKey addr 0xe548c8 size 0xe8 virtual true final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyBytes, ::ArrayW<uint8_t, ::Array<uint8_t>*> ivBytes);

  /// @brief Method GenerateKeyStream addr 0xe549b0 size 0x3c virtual true final false
