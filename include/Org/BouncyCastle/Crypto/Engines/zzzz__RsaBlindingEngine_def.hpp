...
public:
  ...
  /// @brief Method BlindMessage, addr 0x3300dac, size 0x64, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* BlindMessage(::Org::BouncyCastle::Math::BigInteger* msg);

  /// @brief Method GetInputBlockSize, addr 0x3300b04, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x3300bac, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x3300974, size 0x190, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x3300c54, size 0x158, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBuf, int32_t inOff, int32_t inLen);

  /// @brief Method UnblindMessage, addr 0x3300e10, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33008d8, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3300928, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x3300930, size 0x44, virtual true, abstract: false, final false
