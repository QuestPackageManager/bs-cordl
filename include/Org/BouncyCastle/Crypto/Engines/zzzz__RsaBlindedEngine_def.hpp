...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0xf51af8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0xf51b9c, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0xf5189c, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0xf51c40, size 0x41c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf517c0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xf51834, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0xf5185c, size 0x40, virtual true, abstract: false, final false
