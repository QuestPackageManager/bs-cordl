...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x1145d14, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x1145db8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x1145ab8, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x1145e5c, size 0x41c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11459dc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1145a50, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x1145a78, size 0x40, virtual true, abstract: false, final false
