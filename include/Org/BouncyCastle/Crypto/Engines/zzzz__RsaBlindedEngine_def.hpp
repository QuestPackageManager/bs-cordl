...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x33bd5bc, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x33bd664, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x33bd33c, size 0x280, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x33bd70c, size 0x420, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bd29c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33bd2f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x33bd2f8, size 0x44, virtual true, abstract: false, final false
