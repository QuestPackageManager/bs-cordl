...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::RsaBlindedEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::RsaBlindedEngine*, "Org.BouncyCastle.Crypto.Engines", "RsaBlindedEngine");
...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x33bf944, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x33bf9ec, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x33bf6c4, size 0x280, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x33bfa94, size 0x420, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bf624, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33bf678, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x33bf680, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RsaBlindedEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RsaBlindedEngine(RsaBlindedEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RsaBlindedEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RsaBlindedEngine(RsaBlindedEngineconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::RsaBlindedEngine) == 0x28, "Size mismatch!");
