...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x104ad80, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x104ae24, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x104ab24, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x104aec8, size 0x41c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x104aa48, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x104aabc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x104aae4, size 0x40, virtual true, abstract: false, final false
