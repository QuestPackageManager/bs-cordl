...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x236ca5c, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x236cb00, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x236c9a4, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x236cba4, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x236c8d8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x236c93c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x236c964, size 0x40, virtual true, abstract: false, final false
