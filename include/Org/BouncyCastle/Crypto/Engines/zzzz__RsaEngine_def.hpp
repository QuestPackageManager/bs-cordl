...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x2370e1c, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x2370ec0, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x2370d64, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x2370f64, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2370c98, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2370cfc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x2370d24, size 0x40, virtual true, abstract: false, final false
