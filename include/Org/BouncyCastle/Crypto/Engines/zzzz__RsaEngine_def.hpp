...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x1152214, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x11522b8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x115215c, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x115235c, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1152088, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11520f4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x115211c, size 0x40, virtual true, abstract: false, final false
