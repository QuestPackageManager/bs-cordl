...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0xf72404, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0xf724a8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0xf7234c, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0xf7254c, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf72278, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xf722e4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0xf7230c, size 0x40, virtual true, abstract: false, final false
