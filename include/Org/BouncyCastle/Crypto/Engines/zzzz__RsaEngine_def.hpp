...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::RsaEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::RsaEngine*, "Org.BouncyCastle.Crypto.Engines", "RsaEngine");
...
public:
  ...
  /// @brief Method GetInputBlockSize, addr 0x33c0b30, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x33c0bd8, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method Init, addr 0x33c0a74, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x33c0c80, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33c09d8, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33c0a28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IRsa* rsa);

  /// @brief Method get_AlgorithmName, addr 0x33c0a30, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RsaEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RsaEngine(RsaEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RsaEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RsaEngine(RsaEngineconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::RsaEngine) == 0x18, "Size mismatch!");
