...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x32d39c0, size 0x171c, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x32d2554, size 0x146c, virtual true, abstract: false, final false
  ...
  /// @brief Method MakeWorkingKey, addr 0x32d1084, size 0x14d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32d50dc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x32d1040, size 0x44, virtual true, abstract: false, final false
