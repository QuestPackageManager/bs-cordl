...
public:
  ...
  /// @brief Method get_AlgorithmName, addr 0xf1912c, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method MakeWorkingKey, addr 0xf1916c, size 0x15e0, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> MakeWorkingKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method EncryptBlock, addr 0xf1a74c, size 0x1540, virtual true, abstract: false, final false
  ...
  /// @brief Method DecryptBlock, addr 0xf1bc8c, size 0x1738, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf1d3c4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
