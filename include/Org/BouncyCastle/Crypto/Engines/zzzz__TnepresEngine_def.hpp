...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x237b704, size 0x1724, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x237a220, size 0x14e4, virtual true, abstract: false, final false
  ...
  /// @brief Method MakeWorkingKey, addr 0x2378c54, size 0x15cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x237ce28, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x2378c14, size 0x40, virtual true, abstract: false, final false
