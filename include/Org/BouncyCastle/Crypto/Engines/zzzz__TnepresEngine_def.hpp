...
public:
  ...
  /// @brief Method DecryptBlock, addr 0xf61c5c, size 0x1738, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0xf6071c, size 0x1540, virtual true, abstract: false, final false
  ...
  /// @brief Method MakeWorkingKey, addr 0xf5f13c, size 0x15e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf63394, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0xf5f0fc, size 0x40, virtual true, abstract: false, final false
