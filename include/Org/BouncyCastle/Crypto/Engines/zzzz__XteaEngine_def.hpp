...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x115366c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x1153674, size 0x148, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::XteaEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x11538c4, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x1153c28, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x11535a4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method decryptBlock, addr 0x1153a24, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method encryptBlock, addr 0x1153b24, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x1153624, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x1153664, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  /// @brief Method setKey, addr 0x11537bc, size 0x108, virtual false, abstract: false, final false
