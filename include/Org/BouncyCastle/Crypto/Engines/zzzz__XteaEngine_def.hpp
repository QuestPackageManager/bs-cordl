...
public:
  ...
  /// @brief Method .ctor addr 0xe7fbc4 size 0x80 virtual false final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName addr 0xe7fc44 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay addr 0xe7fc84 size 0x8 virtual true final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize addr 0xe7fc8c size 0x8 virtual true final false
  inline int32_t GetBlockSize();

  /// @brief Method Init addr 0xe7fc94 size 0x148 virtual true final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method ProcessBlock addr 0xe7fee4 size 0x160 virtual true final false
  ...
  /// @brief Method Reset addr 0xe80248 size 0x4 virtual true final false
  inline void Reset();

  /// @brief Method setKey addr 0xe7fddc size 0x108 virtual false final false
  inline void setKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method encryptBlock addr 0xe80144 size 0x104 virtual false final false
  ...
  /// @brief Method decryptBlock addr 0xe80044 size 0x100 virtual false final false
