...
public:
  ...
  __declspec(property(get = getStaticF_SBOX1_1110, put = setStaticF_SBOX1_1110)) ::ArrayW<uint32_t, ::Array<uint32_t>*> SBOX1_1110;

  /// @brief Field SBOX2_0222, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_SBOX2_0222, put = setStaticF_SBOX2_0222)) ::ArrayW<uint32_t, ::Array<uint32_t>*> SBOX2_0222;

  /// @brief Field SBOX3_3033, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_SBOX3_3033, put = setStaticF_SBOX3_3033)) ::ArrayW<uint32_t, ::Array<uint32_t>*> SBOX3_3033;

  /// @brief Field SBOX4_4404, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_SBOX4_4404, put = setStaticF_SBOX4_4404)) ::ArrayW<uint32_t, ::Array<uint32_t>*> SBOX4_4404;
  ...
  /// @brief Method GetBlockSize, addr 0x2348ba8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x2348a74, size 0xec, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::CamelliaEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x2348bb0, size 0x134, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x2348ce4, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x23489e8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method bytes2uint, addr 0x2347080, size 0x60, virtual false, abstract: false, final false
  static inline uint32_t bytes2uint(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t offset);

  /// @brief Method camelliaF2, addr 0x2347128, size 0x2e8, virtual false, abstract: false, final false
  static inline void camelliaF2(::ArrayW<uint32_t, ::Array<uint32_t>*> s, ::ArrayW<uint32_t, ::Array<uint32_t>*> skey, int32_t keyoff);

  /// @brief Method camelliaFLs, addr 0x2347410, size 0x134, virtual false, abstract: false, final false
  static inline void camelliaFLs(::ArrayW<uint32_t, ::Array<uint32_t>*> s, ::ArrayW<uint32_t, ::Array<uint32_t>*> fkey, int32_t keyoff);

  /// @brief Method decroldq, addr 0x2346d08, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method decroldqo32, addr 0x2346f58, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x2348b60, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x2348ba0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  /// @brief Method leftRotate, addr 0x2346bcc, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t leftRotate(uint32_t x, int32_t s);

  /// @brief Method processBlock128, addr 0x234844c, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method processBlock192or256, addr 0x23486fc, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method rightRotate, addr 0x2346bb8, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t rightRotate(uint32_t x, int32_t s);

  /// @brief Method roldq, addr 0x2346be0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method roldqo32, addr 0x2346e30, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method setKey, addr 0x2347544, size 0xf08, virtual false, abstract: false, final false
  ...
  /// @brief Method uint2bytes, addr 0x23470e0, size 0x48, virtual false, abstract: false, final false
