...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x234a2c8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x234a194, size 0xec, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::CamelliaEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x234a2d0, size 0x134, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x234a404, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x234a108, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method bytes2uint, addr 0x23487a0, size 0x60, virtual false, abstract: false, final false
  static inline uint32_t bytes2uint(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t offset);

  /// @brief Method camelliaF2, addr 0x2348848, size 0x2e8, virtual false, abstract: false, final false
  static inline void camelliaF2(::ArrayW<uint32_t, ::Array<uint32_t>*> s, ::ArrayW<uint32_t, ::Array<uint32_t>*> skey, int32_t keyoff);

  /// @brief Method camelliaFLs, addr 0x2348b30, size 0x134, virtual false, abstract: false, final false
  static inline void camelliaFLs(::ArrayW<uint32_t, ::Array<uint32_t>*> s, ::ArrayW<uint32_t, ::Array<uint32_t>*> fkey, int32_t keyoff);

  /// @brief Method decroldq, addr 0x2348428, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method decroldqo32, addr 0x2348678, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x234a280, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x234a2c0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  /// @brief Method leftRotate, addr 0x23482ec, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t leftRotate(uint32_t x, int32_t s);

  /// @brief Method processBlock128, addr 0x2349b6c, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method processBlock192or256, addr 0x2349e1c, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method rightRotate, addr 0x23482d8, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t rightRotate(uint32_t x, int32_t s);

  /// @brief Method roldq, addr 0x2348300, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method roldqo32, addr 0x2348550, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method setKey, addr 0x2348c64, size 0xf08, virtual false, abstract: false, final false
  ...
  /// @brief Method uint2bytes, addr 0x2348800, size 0x48, virtual false, abstract: false, final false
