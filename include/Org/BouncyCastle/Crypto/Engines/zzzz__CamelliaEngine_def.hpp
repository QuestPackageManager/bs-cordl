...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x234c658, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x234c524, size 0xec, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::CamelliaEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x234c660, size 0x134, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x234c794, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x234c498, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method bytes2uint, addr 0x234ab30, size 0x60, virtual false, abstract: false, final false
  static inline uint32_t bytes2uint(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t offset);

  /// @brief Method camelliaF2, addr 0x234abd8, size 0x2e8, virtual false, abstract: false, final false
  static inline void camelliaF2(::ArrayW<uint32_t, ::Array<uint32_t>*> s, ::ArrayW<uint32_t, ::Array<uint32_t>*> skey, int32_t keyoff);

  /// @brief Method camelliaFLs, addr 0x234aec0, size 0x134, virtual false, abstract: false, final false
  static inline void camelliaFLs(::ArrayW<uint32_t, ::Array<uint32_t>*> s, ::ArrayW<uint32_t, ::Array<uint32_t>*> fkey, int32_t keyoff);

  /// @brief Method decroldq, addr 0x234a7b8, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method decroldqo32, addr 0x234aa08, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x234c610, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x234c650, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  /// @brief Method leftRotate, addr 0x234a67c, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t leftRotate(uint32_t x, int32_t s);

  /// @brief Method processBlock128, addr 0x234befc, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method processBlock192or256, addr 0x234c1ac, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method rightRotate, addr 0x234a668, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t rightRotate(uint32_t x, int32_t s);

  /// @brief Method roldq, addr 0x234a690, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method roldqo32, addr 0x234a8e0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method setKey, addr 0x234aff4, size 0xf08, virtual false, abstract: false, final false
  ...
  /// @brief Method uint2bytes, addr 0x234ab90, size 0x48, virtual false, abstract: false, final false
