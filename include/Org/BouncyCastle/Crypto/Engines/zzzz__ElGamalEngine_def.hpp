...
public:
  ...
  /// @brief Method get_AlgorithmName, addr 0xefc0fc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xefc13c, size 0x2b4, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method GetInputBlockSize, addr 0xefc3f0, size 0x40, virtual true, abstract: false, final false
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0xefc430, size 0x40, virtual true, abstract: false, final false
  inline int32_t GetOutputBlockSize();

  /// @brief Method ProcessBlock, addr 0xefc470, size 0x52c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xefc99c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
