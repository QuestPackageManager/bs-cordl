...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x330754c, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x3307198, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method G, addr 0x3307038, size 0x160, virtual false, abstract: false, final false
  inline int32_t G(int32_t k, int32_t w);

  /// @brief Method GetBlockSize, addr 0x3306ee8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method H, addr 0x33073ec, size 0x160, virtual false, abstract: false, final false
  inline int32_t H(int32_t k, int32_t w);

  /// @brief Method Init, addr 0x3306b88, size 0x314, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::SkipjackEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x3306ef0, size 0x144, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3307034, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3307844, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<int16_t, ::Array<int16_t>*> getStaticF_ftable();

  /// @brief Method get_AlgorithmName, addr 0x3306e9c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x3306ee0, size 0x8, virtual true, abstract: false, final false
