...
public:
  ...
  /// @brief Method Init, addr 0x32b34b4, size 0x128, virtual true, abstract: false, final true
  ...
  /// @brief Method Unwrap, addr 0x32b3d84, size 0x878, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Wrap, addr 0x32b35dc, size 0x7a8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32b33f0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(int32_t blockSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x32b3470, size 0x44, virtual true, abstract: false, final true
