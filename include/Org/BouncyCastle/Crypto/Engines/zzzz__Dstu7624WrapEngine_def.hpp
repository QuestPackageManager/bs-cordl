...
public:
  ...
  /// @brief Method Init, addr 0x32efa48, size 0x128, virtual true, abstract: false, final true
  ...
  /// @brief Method Unwrap, addr 0x32f0318, size 0x878, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Wrap, addr 0x32efb70, size 0x7a8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32ef984, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(int32_t blockSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x32efa04, size 0x44, virtual true, abstract: false, final true
