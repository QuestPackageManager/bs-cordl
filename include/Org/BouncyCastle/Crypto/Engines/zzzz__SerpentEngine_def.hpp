...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x3305414, size 0x171c, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x3303fa8, size 0x146c, virtual true, abstract: false, final false
  ...
  /// @brief Method MakeWorkingKey, addr 0x3302b14, size 0x1494, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3306b30, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
