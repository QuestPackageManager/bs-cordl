...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0xf56da4, size 0x1734, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0xf55860, size 0x1544, virtual true, abstract: false, final false
  ...
  /// @brief Method MakeWorkingKey, addr 0xf542d0, size 0x1590, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf584d8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
