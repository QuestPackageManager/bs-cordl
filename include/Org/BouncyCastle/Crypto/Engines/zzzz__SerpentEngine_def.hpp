...
public:
  // Declarations
  /// @brief Method MakeWorkingKey addr 0xe6e29c size 0x1590 virtual true final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> MakeWorkingKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method EncryptBlock addr 0xe6f82c size 0x1544 virtual true final false
  ...
  /// @brief Method DecryptBlock addr 0xe70d70 size 0x1734 virtual true final false
  ...
  /// @brief Method .ctor addr 0xe724a4 size 0x58 virtual false final false
  inline void _ctor();
