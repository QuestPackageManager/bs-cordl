...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x329e63c, size 0x171c, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x329d1d0, size 0x146c, virtual true, abstract: false, final false
  ...
  /// @brief Method MakeWorkingKey, addr 0x329bd3c, size 0x1494, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x329fd58, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
