...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x236cf98, size 0x1720, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x236bab0, size 0x14e8, virtual true, abstract: false, final false
  ...
  /// @brief Method MakeWorkingKey, addr 0x236a534, size 0x157c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x236e6b8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
