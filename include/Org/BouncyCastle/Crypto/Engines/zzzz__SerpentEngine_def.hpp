...
public:
  // Declarations
  /// @brief Method DecryptBlock, addr 0x1144750, size 0x1734, virtual true, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x114320c, size 0x1544, virtual true, abstract: false, final false
  ...
  /// @brief Method MakeWorkingKey, addr 0x1141c7c, size 0x1590, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1145e84, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
