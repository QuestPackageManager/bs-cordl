...
public:
  ...
  /// @brief Method Init, addr 0x32dda7c, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0x32de10c, size 0x448, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method Wrap, addr 0x32ddd48, size 0x3c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32dd9f0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* engine);

  /// @brief Method get_AlgorithmName, addr 0x32ddca4, size 0xa4, virtual true, abstract: false, final false
