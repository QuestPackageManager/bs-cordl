...
public:
  ...
  /// @brief Method Init, addr 0x112c078, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0x112c6cc, size 0x1438, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method Wrap, addr 0x112c32c, size 0x3a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x112bfe8, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* engine);

  /// @brief Method get_AlgorithmName, addr 0x112c28c, size 0xa0, virtual true, abstract: false, final false
