...
/// @brief Method AddRoundKey, addr 0x32b1efc, size 0x88, virtual false, abstract: false, final false
inline void AddRoundKey(int32_t  round) ;

/// @brief Method DecryptBlock_128, addr 0x32b200c, size 0x3b0, virtual false, abstract: false, final false
...
/// @brief Method DecryptionRound, addr 0x32b2444, size 0x20, virtual false, abstract: false, final false
inline void DecryptionRound() ;

/// @brief Method EncryptBlock_128, addr 0x32b1b50, size 0x3ac, virtual false, abstract: false, final false
...
/// @brief Method EncryptionRound, addr 0x32b16d8, size 0x20, virtual false, abstract: false, final false
inline void EncryptionRound() ;

/// @brief Method GetBlockSize, addr 0x32b30b4, size 0xc, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x32b0c9c, size 0x2e8, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method InvShiftRows, addr 0x32b29f4, size 0x250, virtual false, abstract: false, final false
inline void InvShiftRows() ;

/// @brief Method InvSubBytes, addr 0x32b2c44, size 0x1c0, virtual false, abstract: false, final false
inline void InvSubBytes() ;

/// @brief Method MixColumn, addr 0x32b2f60, size 0xbc, virtual false, abstract: false, final false
static inline uint64_t MixColumn(uint64_t  c) ;

/// @brief Method MixColumnInv, addr 0x32b2e04, size 0x15c, virtual false, abstract: false, final false
static inline uint64_t MixColumnInv(uint64_t  c) ;

/// @brief Method MixColumns, addr 0x32b2874, size 0xc0, virtual false, abstract: false, final false
inline void MixColumns() ;

/// @brief Method MixColumnsInv, addr 0x32b2934, size 0xc0, virtual false, abstract: false, final false
inline void MixColumnsInv() ;

/// @brief Method MulX, addr 0x32b301c, size 0x20, virtual false, abstract: false, final false
static inline uint64_t MulX(uint64_t  n) ;

/// @brief Method MulX2, addr 0x32b3044, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x32b1900, size 0x250, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x32b30c8, size 0x20, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Rotate, addr 0x32b303c, size 0x8, virtual false, abstract: false, final false
static inline uint64_t Rotate(int32_t  n, uint64_t  x) ;

/// @brief Method RotateLeft, addr 0x32b16f8, size 0x208, virtual false, abstract: false, final false
inline void RotateLeft(::ArrayW<uint64_t,::Array<uint64_t>*>  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  z) ;

/// @brief Method ShiftRows, addr 0x32b2624, size 0x250, virtual false, abstract: false, final false
inline void ShiftRows() ;

/// @brief Method SubBytes, addr 0x32b2464, size 0x1c0, virtual false, abstract: false, final false
inline void SubBytes() ;

/// @brief Method SubRoundKey, addr 0x32b23bc, size 0x88, virtual false, abstract: false, final false
inline void SubRoundKey(int32_t  round) ;

/// @brief Method WorkingKeyExpandEven, addr 0x32b11f8, size 0x46c, virtual false, abstract: false, final false
inline void WorkingKeyExpandEven(::ArrayW<uint64_t,::Array<uint64_t>*>  workingKey, ::ArrayW<uint64_t,::Array<uint64_t>*>  tempKey) ;

/// @brief Method WorkingKeyExpandKT, addr 0x32b0f84, size 0x274, virtual false, abstract: false, final false
inline void WorkingKeyExpandKT(::ArrayW<uint64_t,::Array<uint64_t>*>  workingKey, ::ArrayW<uint64_t,::Array<uint64_t>*>  tempKeys) ;

/// @brief Method WorkingKeyExpandOdd, addr 0x32b1664, size 0x74, virtual false, abstract: false, final false
inline void WorkingKeyExpandOdd() ;

/// @brief Method XorRoundKey, addr 0x32b1f84, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32b0bd8, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x32b3070, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x32b30c0, size 0x8, virtual true, abstract: false, final false
