...
public:
  ...
  /// @brief Method .ctor addr 0xec1cf0 size 0xb8 virtual false final false
  inline void _ctor();

  /// @brief Method Init addr 0xec1da8 size 0x180 virtual true final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName addr 0xec1f28 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay addr 0xec1f68 size 0x8 virtual true final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method ProcessBlock addr 0xec1f70 size 0x16c virtual true final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xec20dc size 0x4 virtual true final false
  inline void Reset();

  /// @brief Method GetBlockSize addr 0xec20e0 size 0x8 virtual true final false
  inline int32_t GetBlockSize();

  /// @brief Method SetKey addr 0xec20e8 size 0x3234 virtual true final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method EncryptBlock addr 0xec540c size 0xfc virtual true final false
  ...
  /// @brief Method DecryptBlock addr 0xec5724 size 0xfc virtual true final false
  ...
  /// @brief Method F1 addr 0xec5a64 size 0x108 virtual false final false
  static inline uint32_t F1(uint32_t D, uint32_t Kmi, int32_t Kri);

  /// @brief Method F2 addr 0xec5b6c size 0x108 virtual false final false
  static inline uint32_t F2(uint32_t D, uint32_t Kmi, int32_t Kri);

  /// @brief Method F3 addr 0xec5c74 size 0x108 virtual false final false
  static inline uint32_t F3(uint32_t D, uint32_t Kmi, int32_t Kri);

  /// @brief Method CAST_Encipher addr 0xec5508 size 0x21c virtual false final false
  inline void CAST_Encipher(uint32_t L0, uint32_t R0, ::ArrayW<uint32_t, ::Array<uint32_t>*> result);

  /// @brief Method CAST_Decipher addr 0xec5820 size 0x244 virtual false final false
  inline void CAST_Decipher(uint32_t L16, uint32_t R16, ::ArrayW<uint32_t, ::Array<uint32_t>*> result);

  /// @brief Method Bits32ToInts addr 0xec5394 size 0x78 virtual false final false
  static inline void Bits32ToInts(uint32_t inData, ::ArrayW<int32_t, ::Array<int32_t>*> b, int32_t offset);

  /// @brief Method IntsTo32bits addr 0xec531c size 0x78 virtual false final false
