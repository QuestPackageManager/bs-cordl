...
public:
  ...
  /// @brief Method BytesToWord, addr 0x32fc558, size 0xb8, virtual false, abstract: false, final false
  inline int64_t BytesToWord(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t srcOff);

  /// @brief Method DecryptBlock, addr 0x32fc174, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x32fc320, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBlockSize, addr 0x32fbcb4, size 0x60, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x32fbd14, size 0x188, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::RC564Engine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x32fc164, size 0x10, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x32fc4d0, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method RotateLeft, addr 0x32fc4d4, size 0x84, virtual false, abstract: false, final false
  inline int64_t RotateLeft(int64_t x, int64_t y);

  /// @brief Method RotateRight, addr 0x32fc6d4, size 0x84, virtual false, abstract: false, final false
  inline int64_t RotateRight(int64_t x, int64_t y);

  /// @brief Method SetKey, addr 0x32fbe9c, size 0x2c8, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method WordToBytes, addr 0x32fc610, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32fbc5c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x32fbc68, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x32fbcac, size 0x8, virtual true, abstract: false, final false
