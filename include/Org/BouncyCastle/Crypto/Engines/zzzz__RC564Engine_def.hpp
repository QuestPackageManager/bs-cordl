...
public:
  ...
  /// @brief Method .ctor, addr 0xf07348, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0xf07368, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0xf073a8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize, addr 0xf073b0, size 0x5c, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0xf0740c, size 0x1a0, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method ProcessBlock, addr 0xf0787c, size 0x10, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0xf07bdc, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SetKey, addr 0xf075ac, size 0x2d0, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method EncryptBlock, addr 0xf07a30, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptBlock, addr 0xf0788c, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method RotateLeft, addr 0xf07be0, size 0x80, virtual false, abstract: false, final false
  inline int64_t RotateLeft(int64_t x, int64_t y);

  /// @brief Method RotateRight, addr 0xf07dd0, size 0x80, virtual false, abstract: false, final false
  inline int64_t RotateRight(int64_t x, int64_t y);

  /// @brief Method BytesToWord, addr 0xf07c60, size 0xb0, virtual false, abstract: false, final false
  inline int64_t BytesToWord(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t srcOff);

  /// @brief Method WordToBytes, addr 0xf07d10, size 0xc0, virtual false, abstract: false, final false
