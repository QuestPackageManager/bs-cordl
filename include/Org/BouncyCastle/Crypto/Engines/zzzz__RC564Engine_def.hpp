...
public:
  ...
  /// @brief Method BytesToWord, addr 0x2364054, size 0xb0, virtual false, abstract: false, final false
  inline int64_t BytesToWord(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t srcOff);

  /// @brief Method DecryptBlock, addr 0x2363c80, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x2363e24, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBlockSize, addr 0x23637bc, size 0x5c, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x2363818, size 0x198, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::RC564Engine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x2363c70, size 0x10, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x2363fd0, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method RotateLeft, addr 0x2363fd4, size 0x80, virtual false, abstract: false, final false
  inline int64_t RotateLeft(int64_t x, int64_t y);

  /// @brief Method RotateRight, addr 0x23641c4, size 0x80, virtual false, abstract: false, final false
  inline int64_t RotateRight(int64_t x, int64_t y);

  /// @brief Method SetKey, addr 0x23639b0, size 0x2c0, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method WordToBytes, addr 0x2364104, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2363754, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgorithmName, addr 0x2363774, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x23637b4, size 0x8, virtual true, abstract: false, final false
