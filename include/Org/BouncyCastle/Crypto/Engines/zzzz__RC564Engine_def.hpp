...
public:
  ...
  /// @brief Method .ctor addr 0xedb4b8 size 0x20 virtual false final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName addr 0xedb4d8 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay addr 0xedb518 size 0x8 virtual true final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize addr 0xedb520 size 0x5c virtual true final false
  inline int32_t GetBlockSize();

  /// @brief Method Init addr 0xedb57c size 0x1a0 virtual true final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method ProcessBlock addr 0xedb9ec size 0x10 virtual true final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xedbd4c size 0x4 virtual true final false
  inline void Reset();

  /// @brief Method SetKey addr 0xedb71c size 0x2d0 virtual false final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method EncryptBlock addr 0xedbba0 size 0x1ac virtual false final false
  ...
  /// @brief Method DecryptBlock addr 0xedb9fc size 0x1a4 virtual false final false
  ...
  /// @brief Method RotateLeft addr 0xedbd50 size 0x80 virtual false final false
  inline int64_t RotateLeft(int64_t x, int64_t y);

  /// @brief Method RotateRight addr 0xedbf40 size 0x80 virtual false final false
  inline int64_t RotateRight(int64_t x, int64_t y);

  /// @brief Method BytesToWord addr 0xedbdd0 size 0xb0 virtual false final false
  inline int64_t BytesToWord(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t srcOff);

  /// @brief Method WordToBytes addr 0xedbe80 size 0xc0 virtual false final false
