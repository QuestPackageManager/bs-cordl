...
public:
  ...
  /// @brief Method .ctor addr 0xe55034 size 0x54 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Crypto::Engines::ChaChaEngine* New_ctor(int32_t rounds);

  /// @brief Method .ctor addr 0xe55088 size 0x64 virtual false final false
  inline void _ctor(int32_t rounds);

  /// @brief Method get_AlgorithmName addr 0xe550ec size 0x84 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method AdvanceCounter addr 0xe55170 size 0x4c virtual true final false
  inline void AdvanceCounter();

  /// @brief Method ResetCounter addr 0xe551bc size 0x2c virtual true final false
  inline void ResetCounter();

  /// @brief Method SetKey addr 0xe551e8 size 0x10c virtual true final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyBytes, ::ArrayW<uint8_t, ::Array<uint8_t>*> ivBytes);

  /// @brief Method GenerateKeyStream addr 0xe552f4 size 0x3c virtual true final false
  inline void GenerateKeyStream(::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method ChachaCore addr 0xe549ec size 0x648 virtual false final false
