...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChaChaEngine", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChaChaEngine(ChaChaEngine&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChaChaEngine", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChaChaEngine(ChaChaEngineconst&) = delete;
