...
public:
  ...
  /// @brief Method .ctor addr 0xec9208 size 0x54 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Crypto::Engines::ChaChaEngine* New_ctor(int32_t rounds);

  /// @brief Method .ctor addr 0xec925c size 0x64 virtual false final false
  inline void _ctor(int32_t rounds);

  /// @brief Method get_AlgorithmName addr 0xec92c0 size 0x84 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method AdvanceCounter addr 0xec9344 size 0x4c virtual true final false
  inline void AdvanceCounter();

  /// @brief Method ResetCounter addr 0xec9390 size 0x2c virtual true final false
  inline void ResetCounter();

  /// @brief Method SetKey addr 0xec93bc size 0x10c virtual true final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyBytes, ::ArrayW<uint8_t, ::Array<uint8_t>*> ivBytes);

  /// @brief Method GenerateKeyStream addr 0xec94c8 size 0x3c virtual true final false
  inline void GenerateKeyStream(::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method ChachaCore addr 0xec8bc0 size 0x648 virtual false final false
