...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Engines::NoekeonEngine*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Engines::NoekeonEngine*, "Org.BouncyCastle.Crypto.Engines", "NoekeonEngine");
...
public:
  ...
  __declspec(property(get = getStaticF_RoundConstants, put = setStaticF_RoundConstants)) ::ArrayW<uint8_t> RoundConstants;
  ...
  __declspec(property(get = __cordl_internal_get_k, put = __cordl_internal_set_k)) ::ArrayW<uint32_t> k;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr operator ::Org::BouncyCastle::Crypto::IBlockCipher*() noexcept;

  /// @brief Method DecryptBlock, addr 0x33b58d0, size 0x22c, virtual false, abstract: false, final false
  inline int32_t DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method EncryptBlock, addr 0x33b5afc, size 0x22c, virtual false, abstract: false, final false
  inline int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x33b5588, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Init, addr 0x33b5590, size 0x1e0, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Engines::NoekeonEngine* New_ctor();

  /// @brief Method ProcessBlock, addr 0x33b5770, size 0x160, virtual true, abstract: false, final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33b5d28, size 0x4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_k() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_k();
  ...
  /// @brief Method .ctor, addr 0x33b54e4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t> getStaticF_RoundConstants();

  /// @brief Method get_AlgorithmName, addr 0x33b553c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x33b5580, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  static inline void setStaticF_RoundConstants(::ArrayW<uint8_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Engines::NoekeonEngine) == 0x20, "Size mismatch!");
