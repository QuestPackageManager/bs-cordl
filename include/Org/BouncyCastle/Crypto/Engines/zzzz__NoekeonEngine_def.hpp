...
public:
  ...
  /// @brief Method .ctor addr 0xe6279c size 0x60 virtual false final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName addr 0xe627fc size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay addr 0xe6283c size 0x8 virtual true final false
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize addr 0xe62844 size 0x8 virtual true final false
  inline int32_t GetBlockSize();

  /// @brief Method Init addr 0xe6284c size 0x268 virtual true final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method ProcessBlock addr 0xe62ab4 size 0x160 virtual true final false
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xe63204 size 0x4 virtual true final false
  inline void Reset();

  /// @brief Method EncryptBlock addr 0xe62f2c size 0x2d8 virtual false final false
  ...
  /// @brief Method DecryptBlock addr 0xe62c14 size 0x318 virtual false final false
