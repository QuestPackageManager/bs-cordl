...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x1148d04, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method Ib0, addr 0x1148f64, size 0x44, virtual false, abstract: false, final false
  inline void Ib0(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Ib1, addr 0x1148fe8, size 0x40, virtual false, abstract: false, final false
  inline void Ib1(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Ib2, addr 0x1149070, size 0x44, virtual false, abstract: false, final false
  inline void Ib2(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Ib3, addr 0x1149100, size 0x48, virtual false, abstract: false, final false
  inline void Ib3(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Ib4, addr 0x114918c, size 0x44, virtual false, abstract: false, final false
  inline void Ib4(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Ib5, addr 0x1149218, size 0x48, virtual false, abstract: false, final false
  inline void Ib5(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Ib6, addr 0x11492a0, size 0x44, virtual false, abstract: false, final false
  inline void Ib6(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Ib7, addr 0x114932c, size 0x4c, virtual false, abstract: false, final false
  inline void Ib7(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Init, addr 0x1148b38, size 0x184, virtual true, abstract: false, final false
  inline void Init(bool encrypting, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InverseLT, addr 0x1149414, size 0x8c, virtual false, abstract: false, final false
  inline void InverseLT();

  /// @brief Method LT, addr 0x1149378, size 0x9c, virtual false, abstract: false, final false
  inline void LT();
  ...
  /// @brief Method ProcessBlock, addr 0x1148d5c, size 0x1b0, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x1148f0c, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method RotateLeft, addr 0x1148f10, size 0xc, virtual false, abstract: false, final false
  static inline int32_t RotateLeft(int32_t x, int32_t bits);

  /// @brief Method RotateRight, addr 0x1148f1c, size 0x8, virtual false, abstract: false, final false
  static inline int32_t RotateRight(int32_t x, int32_t bits);

  /// @brief Method Sb0, addr 0x1148f24, size 0x40, virtual false, abstract: false, final false
  inline void Sb0(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Sb1, addr 0x1148fa8, size 0x40, virtual false, abstract: false, final false
  inline void Sb1(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Sb2, addr 0x1149028, size 0x48, virtual false, abstract: false, final false
  inline void Sb2(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Sb3, addr 0x11490b4, size 0x4c, virtual false, abstract: false, final false
  inline void Sb3(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Sb4, addr 0x1149148, size 0x44, virtual false, abstract: false, final false
  inline void Sb4(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Sb5, addr 0x11491d0, size 0x48, virtual false, abstract: false, final false
  inline void Sb5(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Sb6, addr 0x1149260, size 0x40, virtual false, abstract: false, final false
  inline void Sb6(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method Sb7, addr 0x11492e4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1148b30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int32_t getStaticF_BlockSize();

  /// @brief Method get_AlgorithmName, addr 0x1148cbc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x1148cfc, size 0x8, virtual true, abstract: false, final false
