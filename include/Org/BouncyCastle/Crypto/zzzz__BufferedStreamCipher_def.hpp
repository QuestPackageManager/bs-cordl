...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BufferedStreamCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BufferedStreamCipher(BufferedStreamCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BufferedStreamCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BufferedStreamCipher(BufferedStreamCipherconst&) = delete;
