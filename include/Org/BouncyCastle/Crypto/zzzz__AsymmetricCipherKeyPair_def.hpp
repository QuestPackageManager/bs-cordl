...
public:
  ...
  /// @brief Method .ctor, addr 0x112ec50, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Private, addr 0x112ed34, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Private();

  /// @brief Method get_Public, addr 0x112ed2c, size 0x8, virtual false, abstract: false, final false
