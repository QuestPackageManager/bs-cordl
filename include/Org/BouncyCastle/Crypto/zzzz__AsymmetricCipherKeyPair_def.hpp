...
/// @brief Method .ctor, addr 0x33a060c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_Private, addr 0x33a06d4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Private() ;

/// @brief Method get_Public, addr 0x33a06cc, size 0x8, virtual false, abstract: false, final false
