...
public:
  ...
  /// @brief Method .ctor, addr 0x24474e4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Private, addr 0x24475c0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Private();

  /// @brief Method get_Public, addr 0x24475b8, size 0x8, virtual false, abstract: false, final false
