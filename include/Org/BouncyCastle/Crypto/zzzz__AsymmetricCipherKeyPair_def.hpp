...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair*, "Org.BouncyCastle.Crypto", "AsymmetricCipherKeyPair");
...
public:
  ...
  /// @brief Method .ctor, addr 0x349c22c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Private, addr 0x349c2f4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Private();

  /// @brief Method get_Public, addr 0x349c2ec, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsymmetricCipherKeyPair", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsymmetricCipherKeyPair(AsymmetricCipherKeyPair&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsymmetricCipherKeyPair", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsymmetricCipherKeyPair(AsymmetricCipherKeyPairconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair) == 0x20, "Size mismatch!");
