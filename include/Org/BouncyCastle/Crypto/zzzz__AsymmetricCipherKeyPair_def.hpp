...
/// @brief Method .ctor, addr 0x33dd9ec, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_Private, addr 0x33ddab4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Private() ;

/// @brief Method get_Public, addr 0x33ddaac, size 0x8, virtual false, abstract: false, final false
