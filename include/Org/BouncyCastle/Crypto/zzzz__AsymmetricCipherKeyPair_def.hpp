...
public:
  ...
  /// @brief Method .ctor, addr 0x3499ea4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Private, addr 0x3499f6c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Private();

  /// @brief Method get_Public, addr 0x3499f64, size 0x8, virtual false, abstract: false, final false
