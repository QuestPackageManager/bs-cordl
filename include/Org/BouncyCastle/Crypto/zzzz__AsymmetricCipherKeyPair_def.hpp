...
public:
  ...
  /// @brief Method .ctor, addr 0x2447b6c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Private, addr 0x2447c48, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Private();

  /// @brief Method get_Public, addr 0x2447c40, size 0x8, virtual false, abstract: false, final false
