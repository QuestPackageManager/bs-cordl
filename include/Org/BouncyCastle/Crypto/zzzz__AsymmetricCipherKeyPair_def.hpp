...
public:
  ...
  /// @brief Method .ctor, addr 0x33dcc50, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Private, addr 0x33dcd18, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Private();

  /// @brief Method get_Public, addr 0x33dcd10, size 0x8, virtual false, abstract: false, final false
