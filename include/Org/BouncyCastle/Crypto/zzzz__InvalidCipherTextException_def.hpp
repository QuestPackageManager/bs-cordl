...
public:
  ...
  /// @brief Method .ctor, addr 0x1236d04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1236d08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1236d0c, size 0x4, virtual false, abstract: false, final false
