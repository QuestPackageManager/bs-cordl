...
public:
  ...
  /// @brief Method .ctor, addr 0x244a270, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x244a274, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x244a278, size 0x4, virtual false, abstract: false, final false
