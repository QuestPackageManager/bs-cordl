...
public:
  ...
  /// @brief Method .ctor, addr 0x2446800, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2446804, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2446808, size 0x4, virtual false, abstract: false, final false
