...
public:
  ...
  /// @brief Method .ctor addr 0xf50744 size 0x4 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Crypto::InvalidCipherTextException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0xf50748 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf5074c size 0x4 virtual false final false
