...
public:
  ...
  /// @brief Method .ctor, addr 0x244a2b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x244a2b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x244a2b8, size 0x4, virtual false, abstract: false, final false
