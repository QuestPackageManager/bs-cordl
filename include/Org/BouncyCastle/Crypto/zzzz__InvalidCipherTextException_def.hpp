...
public:
  ...
  /// @brief Method .ctor, addr 0x33dfaec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33dfaf0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x33dfaf4, size 0x4, virtual false, abstract: false, final false
