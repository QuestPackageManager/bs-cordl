...
public:
  ...
  /// @brief Method .ctor, addr 0x122ca0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x122ca10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x122ca14, size 0x4, virtual false, abstract: false, final false
