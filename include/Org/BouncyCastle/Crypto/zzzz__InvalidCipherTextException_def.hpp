...
public:
  ...
  /// @brief Method .ctor, addr 0x33a3558, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33a355c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x33a3560, size 0x4, virtual false, abstract: false, final false
