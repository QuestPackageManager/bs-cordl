...
public:
  ...
  /// @brief Method .ctor, addr 0x244a300, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x244a304, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x244a308, size 0x4, virtual false, abstract: false, final false
