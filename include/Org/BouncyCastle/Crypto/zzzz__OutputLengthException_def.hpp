...
public:
  ...
  /// @brief Method .ctor, addr 0x244a288, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x244a12c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x244a28c, size 0x4, virtual false, abstract: false, final false
