...
public:
  ...
  /// @brief Method .ctor, addr 0x244a2c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x244a16c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x244a2cc, size 0x4, virtual false, abstract: false, final false
