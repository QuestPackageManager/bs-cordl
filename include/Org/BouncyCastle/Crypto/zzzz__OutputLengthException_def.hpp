...
public:
  ...
  /// @brief Method .ctor, addr 0x2409ba4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2409a48, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2409ba8, size 0x4, virtual false, abstract: false, final false
