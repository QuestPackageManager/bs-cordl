...
public:
  ...
  /// @brief Method .ctor, addr 0x349cd58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x349cbf8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x349cd5c, size 0x4, virtual false, abstract: false, final false
