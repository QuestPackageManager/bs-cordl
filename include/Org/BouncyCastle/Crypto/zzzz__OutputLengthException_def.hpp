...
public:
  ...
  /// @brief Method .ctor, addr 0x33a3570, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33a3410, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x33a3574, size 0x4, virtual false, abstract: false, final false
