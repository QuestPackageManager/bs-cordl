...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*, "Org.BouncyCastle.Crypto", "AsymmetricKeyParameter");
...
public:
  ...
  /// @brief Method Equals, addr 0x340d83c, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x340d8d4, size 0x20, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* other);

  /// @brief Method GetHashCode, addr 0x340d8f4, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340d82c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool privateKey);

  /// @brief Method get_IsPrivate, addr 0x340d834, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsymmetricKeyParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsymmetricKeyParameter(AsymmetricKeyParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsymmetricKeyParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsymmetricKeyParameter(AsymmetricKeyParameterconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter) == 0x18, "Size mismatch!");
