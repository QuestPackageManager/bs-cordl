...
public:
  ...
  /// @brief Method Equals, addr 0x23b5774, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23b580c, size 0x24, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* other);

  /// @brief Method GetHashCode, addr 0x23b5830, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b5744, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool privateKey);

  /// @brief Method get_IsPrivate, addr 0x23b576c, size 0x8, virtual false, abstract: false, final false
