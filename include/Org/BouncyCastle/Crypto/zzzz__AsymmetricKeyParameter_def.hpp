...
public:
  ...
  /// @brief Method Equals, addr 0x23b91e4, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23b927c, size 0x24, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* other);

  /// @brief Method GetHashCode, addr 0x23b92a0, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b91b4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool privateKey);

  /// @brief Method get_IsPrivate, addr 0x23b91dc, size 0x8, virtual false, abstract: false, final false
