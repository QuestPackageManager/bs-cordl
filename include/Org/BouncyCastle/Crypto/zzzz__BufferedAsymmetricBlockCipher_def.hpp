...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BufferedAsymmetricBlockCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BufferedAsymmetricBlockCipher(BufferedAsymmetricBlockCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BufferedAsymmetricBlockCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BufferedAsymmetricBlockCipher(BufferedAsymmetricBlockCipherconst&) = delete;
