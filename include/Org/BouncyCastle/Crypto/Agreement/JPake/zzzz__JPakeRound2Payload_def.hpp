...
public:
  ...
  /// @brief Method .ctor, addr 0x147c514, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_A, addr 0x147dc10, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_A();

  /// @brief Method get_KnowledgeProofForX2s, addr 0x147dc18, size 0x7c, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*, ::Array<::Org::BouncyCastle::Math::BigInteger*>*> get_KnowledgeProofForX2s();

  /// @brief Method get_ParticipantId, addr 0x147dc08, size 0x8, virtual true, abstract: false, final false
