...
public:
  // Ctor Parameters [CppParam { name: "", ty: "JPakeRound2Payload", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  JPakeRound2Payload(JPakeRound2Payload&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "JPakeRound2Payload", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  JPakeRound2Payload(JPakeRound2Payloadconst&) = delete;
