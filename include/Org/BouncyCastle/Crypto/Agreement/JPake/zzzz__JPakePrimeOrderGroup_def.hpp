...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroup*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroup*, "Org.BouncyCastle.Crypto.Agreement.JPake", "JPakePrimeOrderGroup");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36deeb8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36deec0, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_G, addr 0x36df1ec, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_P, addr 0x36df1dc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_Q, addr 0x36df1e4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "JPakePrimeOrderGroup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  JPakePrimeOrderGroup(JPakePrimeOrderGroup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "JPakePrimeOrderGroup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  JPakePrimeOrderGroup(JPakePrimeOrderGroupconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroup) == 0x28, "Size mismatch!");
