...
public:
  ...
  /// @brief Method .ctor, addr 0x36df4cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "JPakePrimeOrderGroups", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  JPakePrimeOrderGroups(JPakePrimeOrderGroups&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "JPakePrimeOrderGroups", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  JPakePrimeOrderGroups(JPakePrimeOrderGroupsconst&) = delete;
