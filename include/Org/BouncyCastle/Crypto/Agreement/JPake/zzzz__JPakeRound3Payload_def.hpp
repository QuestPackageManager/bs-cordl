...
public:
  ...
  /// @brief Method .ctor, addr 0x361f53c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::Org::BouncyCastle::Math::BigInteger* magTag);

  /// @brief Method get_MacTag, addr 0x36200a4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_MacTag();

  /// @brief Method get_ParticipantId, addr 0x362009c, size 0x8, virtual true, abstract: false, final false
