...
public:
  ...
  /// @brief Method CalculateA, addr 0x35e2424, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateGA, addr 0x35e2314, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateGx, addr 0x35e17cc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateHashForZeroKnowledgeProof, addr 0x35e3b18, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKeyingMaterial, addr 0x35e2afc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMacKey, addr 0x35e3dc0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMacTag, addr 0x35e2d70, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateS, addr 0x35e2364, size 0x8c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* CalculateS(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method CalculateX2s, addr 0x35e23f0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateZeroKnowledgeProof, addr 0x35e17f0, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateX1, addr 0x35e16a8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateX2, addr 0x35e1738, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method IntToByteArray, addr 0x35e440c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDigest, addr 0x35e4014, size 0x84, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::BigInteger* bigInteger);

  /// @brief Method UpdateDigest, addr 0x35e412c, size 0x120, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateDigest, addr 0x35e4098, size 0x94, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::StringW str);

  /// @brief Method UpdateDigestIncludingSize, addr 0x35e3ca8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDigestIncludingSize, addr 0x35e424c, size 0x1c0, virtual false, abstract: false, final false
  static inline void UpdateDigestIncludingSize(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateDigestIncludingSize, addr 0x35e3d2c, size 0x94, virtual false, abstract: false, final false
  static inline void UpdateDigestIncludingSize(::Org::BouncyCastle::Crypto::IDigest* digest, ::StringW str);

  /// @brief Method UpdateMac, addr 0x35e3f90, size 0x84, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::Org::BouncyCastle::Math::BigInteger* bigInteger);

  /// @brief Method UpdateMac, addr 0x35e4414, size 0x120, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateMac, addr 0x35e3efc, size 0x94, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::StringW str);

  /// @brief Method ValidateGa, addr 0x35e28a0, size 0xc4, virtual false, abstract: false, final false
  static inline void ValidateGa(::Org::BouncyCastle::Math::BigInteger* ga);

  /// @brief Method ValidateGx4, addr 0x35e1e34, size 0xc4, virtual false, abstract: false, final false
  static inline void ValidateGx4(::Org::BouncyCastle::Math::BigInteger* gx4);

  /// @brief Method ValidateMacTag, addr 0x35e31cc, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateNotNull, addr 0x35e142c, size 0x4c, virtual false, abstract: false, final false
  static inline void ValidateNotNull(::System::Object* obj, ::StringW description);

  /// @brief Method ValidateParticipantIdsDiffer, addr 0x35e1d9c, size 0x98, virtual false, abstract: false, final false
  static inline void ValidateParticipantIdsDiffer(::StringW participantId1, ::StringW participantId2);

  /// @brief Method ValidateParticipantIdsEqual, addr 0x35e2798, size 0x108, virtual false, abstract: false, final false
  static inline void ValidateParticipantIdsEqual(::StringW expectedParticipantId, ::StringW actualParticipantId);

  /// @brief Method ValidateZeroKnowledgeProof, addr 0x35e1ef8, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e45cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
