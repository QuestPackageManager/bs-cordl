...
public:
  ...
  /// @brief Method CalculateA, addr 0x268647c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateGA, addr 0x2686370, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateGx, addr 0x2685854, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateHashForZeroKnowledgeProof, addr 0x2687b58, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKeyingMaterial, addr 0x2686b64, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMacKey, addr 0x2687dd8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMacTag, addr 0x2686ddc, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateS, addr 0x26863c0, size 0x88, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* CalculateS(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method CalculateX2s, addr 0x2686448, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateZeroKnowledgeProof, addr 0x2685878, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateX1, addr 0x2685738, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateX2, addr 0x26857c4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method IntToByteArray, addr 0x2688388, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDigest, addr 0x2688004, size 0x78, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::BigInteger* bigInteger);

  /// @brief Method UpdateDigest, addr 0x2688104, size 0xf4, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateDigest, addr 0x268807c, size 0x88, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::StringW str);

  /// @brief Method UpdateDigestIncludingSize, addr 0x2687cd8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDigestIncludingSize, addr 0x26881f8, size 0x190, virtual false, abstract: false, final false
  static inline void UpdateDigestIncludingSize(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateDigestIncludingSize, addr 0x2687d50, size 0x88, virtual false, abstract: false, final false
  static inline void UpdateDigestIncludingSize(::Org::BouncyCastle::Crypto::IDigest* digest, ::StringW str);

  /// @brief Method UpdateMac, addr 0x2687f8c, size 0x78, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::Org::BouncyCastle::Math::BigInteger* bigInteger);

  /// @brief Method UpdateMac, addr 0x2688390, size 0xf4, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateMac, addr 0x2687f04, size 0x88, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::StringW str);

  /// @brief Method ValidateGa, addr 0x2686910, size 0xc0, virtual false, abstract: false, final false
  static inline void ValidateGa(::Org::BouncyCastle::Math::BigInteger* ga);

  /// @brief Method ValidateGx4, addr 0x2685ea4, size 0xc0, virtual false, abstract: false, final false
  static inline void ValidateGx4(::Org::BouncyCastle::Math::BigInteger* gx4);

  /// @brief Method ValidateMacTag, addr 0x268723c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateNotNull, addr 0x26854c8, size 0x4c, virtual false, abstract: false, final false
  static inline void ValidateNotNull(::System::Object* obj, ::StringW description);

  /// @brief Method ValidateParticipantIdsDiffer, addr 0x2685e0c, size 0x98, virtual false, abstract: false, final false
  static inline void ValidateParticipantIdsDiffer(::StringW participantId1, ::StringW participantId2);

  /// @brief Method ValidateParticipantIdsEqual, addr 0x26867e8, size 0x128, virtual false, abstract: false, final false
  static inline void ValidateParticipantIdsEqual(::StringW expectedParticipantId, ::StringW actualParticipantId);

  /// @brief Method ValidateZeroKnowledgeProof, addr 0x2685f64, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2688514, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
