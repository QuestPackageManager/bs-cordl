...
public:
  ...
  /// @brief Method GenerateX1 addr 0x11a24b8 size 0x8c virtual false final false
  ...
  /// @brief Method GenerateX2 addr 0x11a2544 size 0x90 virtual false final false
  ...
  /// @brief Method CalculateS addr 0x11a3164 size 0x8c virtual false final false
  static inline ::Org::BouncyCastle::Math::BigInteger* CalculateS(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method CalculateGx addr 0x11a25d4 size 0x24 virtual false final false
  ...
  /// @brief Method CalculateGA addr 0x11a3114 size 0x50 virtual false final false
  ...
  /// @brief Method CalculateX2s addr 0x11a31f0 size 0x34 virtual false final false
  ...
  /// @brief Method CalculateA addr 0x11a3224 size 0x24 virtual false final false
  ...
  /// @brief Method CalculateZeroKnowledgeProof addr 0x11a25f8 size 0x1c4 virtual false final false
  ...
  /// @brief Method CalculateHashForZeroKnowledgeProof addr 0x11a49d8 size 0x184 virtual false final false
  ...
  /// @brief Method ValidateGx4 addr 0x11a2c34 size 0xc4 virtual false final false
  static inline void ValidateGx4(::Org::BouncyCastle::Math::BigInteger* gx4);

  /// @brief Method ValidateGa addr 0x11a3730 size 0xc4 virtual false final false
  static inline void ValidateGa(::Org::BouncyCastle::Math::BigInteger* ga);

  /// @brief Method ValidateZeroKnowledgeProof addr 0x11a2cf8 size 0x1f8 virtual false final false
  ...
  /// @brief Method CalculateKeyingMaterial addr 0x11a3990 size 0x9c virtual false final false
  ...
  /// @brief Method ValidateParticipantIdsDiffer addr 0x11a2b94 size 0xa0 virtual false final false
  static inline void ValidateParticipantIdsDiffer(::StringW participantId1, ::StringW participantId2);

  /// @brief Method ValidateParticipantIdsEqual addr 0x11a3598 size 0x198 virtual false final false
  static inline void ValidateParticipantIdsEqual(::StringW expectedParticipantId, ::StringW actualParticipantId);

  /// @brief Method ValidateNotNull addr 0x11a2234 size 0x54 virtual false final false
  static inline void ValidateNotNull(::System::Object* obj, ::StringW description);

  /// @brief Method CalculateMacTag addr 0x11a3c18 size 0x224 virtual false final false
  ...
  /// @brief Method CalculateMacKey addr 0x11a4c5c size 0x12c virtual false final false
  ...
  /// @brief Method ValidateMacTag addr 0x11a4080 size 0x120 virtual false final false
  ...
  /// @brief Method UpdateDigest addr 0x11a4e88 size 0x78 virtual false final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::BigInteger* bigInteger);

  /// @brief Method UpdateDigest addr 0x11a4f00 size 0x88 virtual false final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::StringW str);

  /// @brief Method UpdateDigest addr 0x11a4f88 size 0xf4 virtual false final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateDigestIncludingSize addr 0x11a4b5c size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11a5398 size 0x8 virtual false final false
  inline void _ctor();
