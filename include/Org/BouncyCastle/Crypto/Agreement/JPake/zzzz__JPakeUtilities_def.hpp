...
public:
  ...
  /// @brief Method CalculateA, addr 0x12852d4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateGA, addr 0x12851c4, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateGx, addr 0x1284684, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateHashForZeroKnowledgeProof, addr 0x1286a88, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKeyingMaterial, addr 0x1285a40, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMacKey, addr 0x1286d0c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMacTag, addr 0x1285cc8, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateS, addr 0x1285214, size 0x8c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* CalculateS(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method CalculateX2s, addr 0x12852a0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateZeroKnowledgeProof, addr 0x12846a8, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateX1, addr 0x1284568, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateX2, addr 0x12845f4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method IntToByteArray, addr 0x12872bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDigest, addr 0x1286f38, size 0x78, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::BigInteger* bigInteger);

  /// @brief Method UpdateDigest, addr 0x1287038, size 0xf4, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateDigest, addr 0x1286fb0, size 0x88, virtual false, abstract: false, final false
  static inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* digest, ::StringW str);

  /// @brief Method UpdateDigestIncludingSize, addr 0x1286c0c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDigestIncludingSize, addr 0x128712c, size 0x190, virtual false, abstract: false, final false
  static inline void UpdateDigestIncludingSize(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateDigestIncludingSize, addr 0x1286c84, size 0x88, virtual false, abstract: false, final false
  static inline void UpdateDigestIncludingSize(::Org::BouncyCastle::Crypto::IDigest* digest, ::StringW str);

  /// @brief Method UpdateMac, addr 0x1286ec0, size 0x78, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::Org::BouncyCastle::Math::BigInteger* bigInteger);

  /// @brief Method UpdateMac, addr 0x12872c4, size 0xf4, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method UpdateMac, addr 0x1286e38, size 0x88, virtual false, abstract: false, final false
  static inline void UpdateMac(::Org::BouncyCastle::Crypto::IMac* mac, ::StringW str);

  /// @brief Method ValidateGa, addr 0x12857e0, size 0xc4, virtual false, abstract: false, final false
  static inline void ValidateGa(::Org::BouncyCastle::Math::BigInteger* ga);

  /// @brief Method ValidateGx4, addr 0x1284ce4, size 0xc4, virtual false, abstract: false, final false
  static inline void ValidateGx4(::Org::BouncyCastle::Math::BigInteger* gx4);

  /// @brief Method ValidateMacTag, addr 0x1286130, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateNotNull, addr 0x12842e4, size 0x54, virtual false, abstract: false, final false
  static inline void ValidateNotNull(::System::Object* obj, ::StringW description);

  /// @brief Method ValidateParticipantIdsDiffer, addr 0x1284c44, size 0xa0, virtual false, abstract: false, final false
  static inline void ValidateParticipantIdsDiffer(::StringW participantId1, ::StringW participantId2);

  /// @brief Method ValidateParticipantIdsEqual, addr 0x1285648, size 0x198, virtual false, abstract: false, final false
  static inline void ValidateParticipantIdsEqual(::StringW expectedParticipantId, ::StringW actualParticipantId);

  /// @brief Method ValidateZeroKnowledgeProof, addr 0x1284da8, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1287448, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
