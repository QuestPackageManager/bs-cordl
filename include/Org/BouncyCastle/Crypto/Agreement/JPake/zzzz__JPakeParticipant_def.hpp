...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeParticipant*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeParticipant*, "Org.BouncyCastle.Crypto.Agreement.JPake", "JPakeParticipant");
...
public:
  ...
  __declspec(property(get = getStaticF_STATE_INITIALIZED, put = setStaticF_STATE_INITIALIZED)) int32_t STATE_INITIALIZED;

  /// @brief Field STATE_KEY_CALCULATED, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF_STATE_KEY_CALCULATED, put = setStaticF_STATE_KEY_CALCULATED)) int32_t STATE_KEY_CALCULATED;

  /// @brief Field STATE_ROUND_1_CREATED, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF_STATE_ROUND_1_CREATED, put = setStaticF_STATE_ROUND_1_CREATED)) int32_t STATE_ROUND_1_CREATED;

  /// @brief Field STATE_ROUND_1_VALIDATED, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF_STATE_ROUND_1_VALIDATED, put = setStaticF_STATE_ROUND_1_VALIDATED)) int32_t STATE_ROUND_1_VALIDATED;

  /// @brief Field STATE_ROUND_2_CREATED, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF_STATE_ROUND_2_CREATED, put = setStaticF_STATE_ROUND_2_CREATED)) int32_t STATE_ROUND_2_CREATED;

  /// @brief Field STATE_ROUND_2_VALIDATED, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF_STATE_ROUND_2_VALIDATED, put = setStaticF_STATE_ROUND_2_VALIDATED)) int32_t STATE_ROUND_2_VALIDATED;

  /// @brief Field STATE_ROUND_3_CREATED, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF_STATE_ROUND_3_CREATED, put = setStaticF_STATE_ROUND_3_CREATED)) int32_t STATE_ROUND_3_CREATED;

  /// @brief Field STATE_ROUND_3_VALIDATED, offset 0xffffffff, size 0x4
  __declspec(property(get = getStaticF_STATE_ROUND_3_VALIDATED, put = setStaticF_STATE_ROUND_3_VALIDATED)) int32_t STATE_ROUND_3_VALIDATED;
  ...
  __declspec(property(get = __cordl_internal_get_password, put = __cordl_internal_set_password)) ::ArrayW<char16_t> password;
  ...
  /// @brief Method CalculateKeyingMaterial, addr 0x36de4d4, size 0x198, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateKeyingMaterial();

  /// @brief Method CreateRound1PayloadToSend, addr 0x36dcff0, size 0x228, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound1Payload* CreateRound1PayloadToSend();

  /// @brief Method CreateRound2PayloadToSend, addr 0x36ddc60, size 0x224, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload* CreateRound2PayloadToSend();

  /// @brief Method CreateRound3PayloadToSend, addr 0x36de708, size 0x1d8, virtual true, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeParticipant* New_ctor(::StringW participantId, ::ArrayW<char16_t> password);
  ...
  /// @brief Method ValidateRound1PayloadReceived, addr 0x36dd6d0, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateRound2PayloadReceived, addr 0x36de0d8, size 0x230, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateRound3PayloadReceived, addr 0x36deb20, size 0x21c, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Math::BigInteger* const& __cordl_internal_get_gx3() const;

  constexpr ::Org::BouncyCastle::Math::BigInteger*& __cordl_internal_get_gx3();

  constexpr ::Org::BouncyCastle::Math::BigInteger* const& __cordl_internal_get_gx4() const;
  ...
  constexpr ::ArrayW<char16_t> const& __cordl_internal_get_password() const;

  constexpr ::ArrayW<char16_t>& __cordl_internal_get_password();
  ...
  constexpr ::Org::BouncyCastle::Math::BigInteger* const& __cordl_internal_get_x1() const;

  constexpr ::Org::BouncyCastle::Math::BigInteger*& __cordl_internal_get_x1();

  constexpr ::Org::BouncyCastle::Math::BigInteger* const& __cordl_internal_get_x2() const;
  ...
  constexpr void __cordl_internal_set_password(::ArrayW<char16_t> value);
  ...
  /// @brief Method .ctor, addr 0x36dcc20, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::ArrayW<char16_t> password);

  /// @brief Method .ctor, addr 0x36dcc9c, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::ArrayW<char16_t> password, ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroup* group);

  /// @brief Method .ctor, addr 0x36dcd54, size 0x248, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::ArrayW<char16_t> password, ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroup* group, ::Org::BouncyCastle::Crypto::IDigest* digest,
  ...
  /// @brief Method get_State, addr 0x36dcfe8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "JPakeParticipant", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  JPakeParticipant(JPakeParticipant&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "JPakeParticipant", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  JPakeParticipant(JPakeParticipantconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeParticipant) == 0x90, "Size mismatch!");
