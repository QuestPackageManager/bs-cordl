...
public:
  ...
  /// @brief Method CalculateKeyingMaterial, addr 0x361eef8, size 0x198, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateKeyingMaterial();

  /// @brief Method CreateRound1PayloadToSend, addr 0x361da14, size 0x228, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound1Payload* CreateRound1PayloadToSend();

  /// @brief Method CreateRound2PayloadToSend, addr 0x361e684, size 0x224, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload* CreateRound2PayloadToSend();

  /// @brief Method CreateRound3PayloadToSend, addr 0x361f12c, size 0x1d8, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateRound1PayloadReceived, addr 0x361e0f4, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateRound2PayloadReceived, addr 0x361eafc, size 0x230, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateRound3PayloadReceived, addr 0x361f544, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x361d644, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method .ctor, addr 0x361d6c0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x361d778, size 0x248, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::ArrayW<char16_t, ::Array<char16_t>*> password, ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroup* group,
                    ::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Security::SecureRandom* random);
  ...
  /// @brief Method get_State, addr 0x361da0c, size 0x8, virtual true, abstract: false, final false
