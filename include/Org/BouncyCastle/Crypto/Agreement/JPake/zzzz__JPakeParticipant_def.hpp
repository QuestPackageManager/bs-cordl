...
public:
  ...
  /// @brief Method CalculateKeyingMaterial, addr 0x12858a4, size 0x19c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateKeyingMaterial();

  /// @brief Method CreateRound1PayloadToSend, addr 0x1284340, size 0x228, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound1Payload* CreateRound1PayloadToSend();

  /// @brief Method CreateRound2PayloadToSend, addr 0x1284fa0, size 0x224, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload* CreateRound2PayloadToSend();

  /// @brief Method CreateRound3PayloadToSend, addr 0x1285adc, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateRound1PayloadReceived, addr 0x1284a08, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateRound2PayloadReceived, addr 0x1285418, size 0x230, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateRound3PayloadReceived, addr 0x1285f18, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1283f74, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method .ctor, addr 0x1283fec, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12840a8, size 0x23c, virtual false, abstract: false, final false
  inline void _ctor(::StringW participantId, ::ArrayW<char16_t, ::Array<char16_t>*> password, ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakePrimeOrderGroup* group,
                    ::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Security::SecureRandom* random);
  ...
  /// @brief Method get_State, addr 0x1284338, size 0x8, virtual true, abstract: false, final false
