...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x35eb2e4, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method Init, addr 0x35eb208, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35eb37c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AgreementSize, addr 0x35eb288, size 0x5c, virtual true, abstract: false, final true
