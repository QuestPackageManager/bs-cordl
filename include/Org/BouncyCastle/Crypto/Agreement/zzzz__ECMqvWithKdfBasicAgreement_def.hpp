...
public:
  ...
  /// @brief Method BigIntToBytes, addr 0x12b1ca8, size 0x4c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> BigIntToBytes(::Org::BouncyCastle::Math::BigInteger* r);

  /// @brief Method CalculateAgreement, addr 0x12b1a3c, size 0x26c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12b1998, size 0xa4, virtual false, abstract: false, final false
