...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::ECMqvWithKdfBasicAgreement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::ECMqvWithKdfBasicAgreement*, "Org.BouncyCastle.Crypto.Agreement", "ECMqvWithKdfBasicAgreement");
...
public:
  ...
  /// @brief Method BigIntToBytes, addr 0x36e2e1c, size 0x68, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> BigIntToBytes(::Org::BouncyCastle::Math::BigInteger* r);

  /// @brief Method CalculateAgreement, addr 0x36e2ba8, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36e2b28, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::ECMqvWithKdfBasicAgreement) == 0x28, "Size mismatch!");
