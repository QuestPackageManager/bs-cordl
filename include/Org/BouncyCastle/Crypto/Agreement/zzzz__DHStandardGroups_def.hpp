...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHStandardGroups", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHStandardGroups(DHStandardGroups&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHStandardGroups", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHStandardGroups(DHStandardGroupsconst&) = delete;
