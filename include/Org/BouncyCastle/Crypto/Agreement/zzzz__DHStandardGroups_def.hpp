...
public:
  ...
  /// @brief Method FromHex, addr 0x3624280, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method FromPG, addr 0x3624320, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method SafePrimeGen2, addr 0x36243d4, size 0x5c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* SafePrimeGen2(::StringW hexP);

  /// @brief Method SafePrimeGen2, addr 0x3624430, size 0xf0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* SafePrimeGen2(::StringW hexP, int32_t l);

  /// @brief Method .ctor, addr 0x36248dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
