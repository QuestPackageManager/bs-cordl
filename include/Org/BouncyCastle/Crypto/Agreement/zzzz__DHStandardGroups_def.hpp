...
/// @brief Method FromHex, addr 0x35e7c3c, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW  hex) ;

/// @brief Method FromPG, addr 0x35e7cdc, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method SafePrimeGen2, addr 0x35e7d90, size 0x5c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* SafePrimeGen2(::StringW  hexP) ;

/// @brief Method SafePrimeGen2, addr 0x35e7dec, size 0xf0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* SafePrimeGen2(::StringW  hexP, int32_t  l) ;

/// @brief Method .ctor, addr 0x35e8298, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
