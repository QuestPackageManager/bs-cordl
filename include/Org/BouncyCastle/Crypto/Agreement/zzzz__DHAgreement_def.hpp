...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x268d8bc, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMessage, addr 0x268d754, size 0x168, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateMessage();

  /// @brief Method Init, addr 0x268d5a8, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268db40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
