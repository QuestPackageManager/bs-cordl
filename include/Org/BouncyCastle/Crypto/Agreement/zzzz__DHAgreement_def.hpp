...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x268d87c, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateMessage, addr 0x268d714, size 0x168, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateMessage();

  /// @brief Method Init, addr 0x268d568, size 0x1ac, virtual false, abstract: false, final false
