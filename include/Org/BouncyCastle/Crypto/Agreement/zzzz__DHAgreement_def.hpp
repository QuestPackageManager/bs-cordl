...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHAgreement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHAgreement(DHAgreement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHAgreement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHAgreement(DHAgreementconst&) = delete;
