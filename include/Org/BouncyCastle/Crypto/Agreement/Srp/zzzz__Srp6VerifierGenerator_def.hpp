...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::Srp::Srp6VerifierGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::Srp::Srp6VerifierGenerator*, "Org.BouncyCastle.Crypto.Agreement.Srp", "Srp6VerifierGenerator");
...
public:
  ...
  /// @brief Method GenerateVerifier, addr 0x36e2e4c, size 0x40, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* GenerateVerifier(::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> identity, ::ArrayW<uint8_t> password);

  /// @brief Method Init, addr 0x36e2e1c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x36e2e28, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36e2e18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Srp6VerifierGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Srp6VerifierGenerator(Srp6VerifierGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Srp6VerifierGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Srp6VerifierGenerator(Srp6VerifierGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::Srp::Srp6VerifierGenerator) == 0x28, "Size mismatch!");
