...
public:
  ...
  /// @brief Method GenerateVerifier, addr 0x147cb2c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x147caf8, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x147cb04, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x147caf0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
