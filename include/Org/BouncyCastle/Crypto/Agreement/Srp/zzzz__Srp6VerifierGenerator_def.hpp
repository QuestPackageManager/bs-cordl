...
public:
  ...
  /// @brief Method GenerateVerifier, addr 0x268dbf0, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x268dbbc, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x268dbc8, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268dbb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
