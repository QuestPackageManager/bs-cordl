...
public:
  ...
  /// @brief Method CalculateS, addr 0x2690d58, size 0x5c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateS();

  /// @brief Method CalculateSecret, addr 0x2690d14, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateSecret(::Org::BouncyCastle::Math::BigInteger* clientA);

  /// @brief Method CalculateServerEvidenceMessage, addr 0x2690e6c, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateServerEvidenceMessage();

  /// @brief Method CalculateSessionKey, addr 0x2690eec, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateSessionKey();

  /// @brief Method GenerateServerCredentials, addr 0x2690c64, size 0xb0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* GenerateServerCredentials();

  /// @brief Method Init, addr 0x2690c24, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x2690c34, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectPrivateValue, addr 0x2690db4, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* SelectPrivateValue();

  /// @brief Method VerifyClientEvidenceMessage, addr 0x2690dc0, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2690c1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
