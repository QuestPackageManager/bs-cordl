...
public:
  // Declarations
  /// @brief Method CalculateK, addr 0x268cb10, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKey, addr 0x268ccd0, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateM1, addr 0x268cb9c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateM2, addr 0x268cc4c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateU, addr 0x268c92c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateX, addr 0x268c400, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePrivateValue, addr 0x268ca0c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPadded, addr 0x268db10, size 0x9c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPadded(::Org::BouncyCastle::Math::BigInteger* n, int32_t length);

  /// @brief Method HashPaddedPair, addr 0x268d54c, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method HashPaddedTriplet, addr 0x268d7e8, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePublicValue, addr 0x268c848, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268dbac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
