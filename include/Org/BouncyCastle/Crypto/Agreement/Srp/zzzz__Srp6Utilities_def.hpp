...
public:
  // Declarations
  /// @brief Method CalculateK, addr 0x13862e4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKey, addr 0x13864b8, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateM1, addr 0x1386374, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateM2, addr 0x1386430, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateU, addr 0x1386100, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateX, addr 0x1385bcc, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePrivateValue, addr 0x13861e0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPadded, addr 0x1387328, size 0x9c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPadded(::Org::BouncyCastle::Math::BigInteger* n, int32_t length);

  /// @brief Method HashPaddedPair, addr 0x1386d5c, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method HashPaddedTriplet, addr 0x1386ffc, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePublicValue, addr 0x1386018, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13873c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
