...
public:
  // Declarations
  /// @brief Method CalculateK, addr 0x35e61c0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKey, addr 0x35e6380, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateM1, addr 0x35e624c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateM2, addr 0x35e62fc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateU, addr 0x35e5fdc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateX, addr 0x35e5a98, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePrivateValue, addr 0x35e60bc, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPadded, addr 0x35e71f8, size 0xac, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPadded(::Org::BouncyCastle::Math::BigInteger* n, int32_t length);

  /// @brief Method HashPaddedPair, addr 0x35e6c14, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method HashPaddedTriplet, addr 0x35e6ec4, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePublicValue, addr 0x35e5eec, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e72a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
