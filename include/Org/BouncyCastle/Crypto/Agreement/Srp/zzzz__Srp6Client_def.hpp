...
public:
  ...
  /// @brief Method CalculateClientEvidenceMessage, addr 0x268c454, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateClientEvidenceMessage();

  /// @brief Method CalculateS, addr 0x268c268, size 0xd0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateS();

  /// @brief Method CalculateSecret, addr 0x268c13c, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateSecret(::Org::BouncyCastle::Math::BigInteger* serverB);

  /// @brief Method CalculateSessionKey, addr 0x268c588, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateSessionKey();

  /// @brief Method GenerateClientCredentials, addr 0x268bcd8, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x268bca0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x268bcac, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectPrivateValue, addr 0x268c338, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* SelectPrivateValue();

  /// @brief Method VerifyServerEvidenceMessage, addr 0x268c4d8, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268bc98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
