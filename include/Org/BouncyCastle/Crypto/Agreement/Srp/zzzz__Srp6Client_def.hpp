...
public:
  ...
  /// @brief Method CalculateClientEvidenceMessage, addr 0x35e61cc, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateClientEvidenceMessage();

  /// @brief Method CalculateS, addr 0x35e5fe0, size 0xd0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateS();

  /// @brief Method CalculateSecret, addr 0x35e5eac, size 0x40, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateSecret(::Org::BouncyCastle::Math::BigInteger* serverB);

  /// @brief Method CalculateSessionKey, addr 0x35e6300, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateSessionKey();

  /// @brief Method GenerateClientCredentials, addr 0x35e5a38, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x35e5a04, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x35e5a10, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectPrivateValue, addr 0x35e60b0, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* SelectPrivateValue();

  /// @brief Method VerifyServerEvidenceMessage, addr 0x35e6250, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e5a00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
