...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x36e6cdc, size 0x98, virtual true, abstract: false, final true
  inline void CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* publicKey, ::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method Init, addr 0x36e6c00, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36e6d74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AgreementSize, addr 0x36e6c80, size 0x5c, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X25519Agreement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X25519Agreement(X25519Agreement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X25519Agreement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X25519Agreement(X25519Agreementconst&) = delete;
