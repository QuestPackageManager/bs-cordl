...
public:
  ...
  /// @brief Method Init, addr 0x124a080, size 0x74, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AgreementSize, addr 0x124a0f4, size 0x58, virtual true, abstract: false, final true
  inline int32_t get_AgreementSize();

  /// @brief Method CalculateAgreement, addr 0x124a14c, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x124a1d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
