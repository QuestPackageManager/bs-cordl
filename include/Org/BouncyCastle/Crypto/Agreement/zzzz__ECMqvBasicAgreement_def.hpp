...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x128be2c, size 0x20c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method CalculateMqvAgreement, addr 0x128c038, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldSize, addr 0x128bdd4, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x128bce8, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x128c28c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
