...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x269353c, size 0x204, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method CalculateMqvAgreement, addr 0x2693740, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldSize, addr 0x26934e4, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x26933f8, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2693994, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
