...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x3625474, size 0x204, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method CalculateMqvAgreement, addr 0x3625678, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldSize, addr 0x362541c, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x362531c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36258d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
