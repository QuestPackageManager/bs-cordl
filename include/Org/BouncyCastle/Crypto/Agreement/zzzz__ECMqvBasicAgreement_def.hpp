...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x35e8ee0, size 0x204, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method CalculateMqvAgreement, addr 0x35e90e4, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldSize, addr 0x35e8e88, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x35e8d88, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e933c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
