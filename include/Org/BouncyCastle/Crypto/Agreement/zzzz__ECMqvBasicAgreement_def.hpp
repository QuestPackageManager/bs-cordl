...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x148e340, size 0x20c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method CalculateMqvAgreement, addr 0x148e54c, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldSize, addr 0x148e2e8, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x148e1fc, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x148e7a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
