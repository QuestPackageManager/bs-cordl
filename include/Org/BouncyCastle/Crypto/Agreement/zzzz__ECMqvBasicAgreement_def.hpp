...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::ECMqvBasicAgreement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::ECMqvBasicAgreement*, "Org.BouncyCastle.Crypto.Agreement", "ECMqvBasicAgreement");
...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x36e4a50, size 0x204, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method CalculateMqvAgreement, addr 0x36e4c54, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldSize, addr 0x36e49f8, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x36e48f8, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36e4eac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECMqvBasicAgreement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECMqvBasicAgreement(ECMqvBasicAgreement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECMqvBasicAgreement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECMqvBasicAgreement(ECMqvBasicAgreementconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::ECMqvBasicAgreement) == 0x18, "Size mismatch!");
