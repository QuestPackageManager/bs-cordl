...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHBasicAgreement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHBasicAgreement(DHBasicAgreement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHBasicAgreement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHBasicAgreement(DHBasicAgreementconst&) = delete;
