...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECDHCBasicAgreement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECDHCBasicAgreement(ECDHCBasicAgreement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECDHCBasicAgreement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECDHCBasicAgreement(ECDHCBasicAgreementconst&) = delete;
