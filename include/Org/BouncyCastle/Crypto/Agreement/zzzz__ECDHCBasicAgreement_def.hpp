...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x268d798, size 0x1ec, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method GetFieldSize, addr 0x268d750, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x268d664, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268d984, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
