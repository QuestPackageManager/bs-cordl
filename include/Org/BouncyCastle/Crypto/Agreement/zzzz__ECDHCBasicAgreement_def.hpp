...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x3624ddc, size 0x1f0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method GetFieldSize, addr 0x3624d94, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x3624c94, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3624fcc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
