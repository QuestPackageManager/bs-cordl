...
public:
  ...
  /// @brief Method AddFieldElement, addr 0x36e6994, size 0xe0, virtual false, abstract: false, final false
  inline void AddFieldElement(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::EC::ECFieldElement* v);

  /// @brief Method AddUserID, addr 0x36e6a74, size 0x18c, virtual false, abstract: false, final false
  inline void AddUserID(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t> userID);

  /// @brief Method CalculateInnerHash, addr 0x36e5ba8, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKey, addr 0x36e5458, size 0x1d4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> CalculateKey(int32_t kLen, ::Org::BouncyCastle::Crypto::ICipherParameters* pubParam);

  /// @brief Method CalculateKeyWithConfirmation, addr 0x36e5798, size 0x410, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateU, addr 0x36e60c0, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetZ, addr 0x36e562c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x36e5270, size 0x1e8, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* privParam);

  /// @brief Method Kdf, addr 0x36e6344, size 0x650, virtual true, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x36e628c, size 0xb8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* Reduce(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method S1, addr 0x36e5dc8, size 0x17c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> S1(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::EC::ECPoint* u, ::ArrayW<uint8_t> inner);

  /// @brief Method S2, addr 0x36e5f44, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36e520c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36e5268, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SM2KeyExchange", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SM2KeyExchange(SM2KeyExchange&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SM2KeyExchange", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SM2KeyExchange(SM2KeyExchangeconst&) = delete;
