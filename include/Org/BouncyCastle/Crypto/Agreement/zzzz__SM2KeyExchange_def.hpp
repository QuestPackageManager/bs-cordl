...
public:
  ...
  /// @brief Method AddFieldElement, addr 0x35eae24, size 0xe0, virtual false, abstract: false, final false
  inline void AddFieldElement(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::EC::ECFieldElement* v);

  /// @brief Method AddUserID, addr 0x35eaf04, size 0x18c, virtual false, abstract: false, final false
  inline void AddUserID(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> userID);

  /// @brief Method CalculateInnerHash, addr 0x35ea038, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKey, addr 0x35e98e8, size 0x1d4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CalculateKey(int32_t kLen, ::Org::BouncyCastle::Crypto::ICipherParameters* pubParam);

  /// @brief Method CalculateKeyWithConfirmation, addr 0x35e9c28, size 0x410, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateU, addr 0x35ea550, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetZ, addr 0x35e9abc, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x35e9700, size 0x1e8, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* privParam);

  /// @brief Method Kdf, addr 0x35ea7d4, size 0x650, virtual true, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x35ea71c, size 0xb8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* Reduce(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method S1, addr 0x35ea258, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method S2, addr 0x35ea3d4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e969c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35e96f8, size 0x8, virtual false, abstract: false, final false
