...
public:
  ...
  /// @brief Method AddFieldElement, addr 0x268d5d4, size 0xd4, virtual false, abstract: false, final false
  inline void AddFieldElement(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Math::EC::ECFieldElement* v);

  /// @brief Method AddUserID, addr 0x268d6a8, size 0x18c, virtual false, abstract: false, final false
  inline void AddUserID(::Org::BouncyCastle::Crypto::IDigest* digest, ::ArrayW<uint8_t, ::Array<uint8_t>*> userID);

  /// @brief Method CalculateInnerHash, addr 0x268c810, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateKey, addr 0x268c0d4, size 0x1c4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CalculateKey(int32_t kLen, ::Org::BouncyCastle::Crypto::ICipherParameters* pubParam);

  /// @brief Method CalculateKeyWithConfirmation, addr 0x268c3f8, size 0x418, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateU, addr 0x268cd08, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetZ, addr 0x268c298, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x268bf00, size 0x1d4, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* privParam);

  /// @brief Method Kdf, addr 0x268cf88, size 0x64c, virtual true, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x268ced4, size 0xb4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* Reduce(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method S1, addr 0x268ca20, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method S2, addr 0x268cb94, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268be74, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x268bed8, size 0x28, virtual false, abstract: false, final false
