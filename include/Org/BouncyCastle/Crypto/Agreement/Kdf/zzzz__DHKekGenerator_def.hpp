...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x36de620, size 0x6e8, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x36de574, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36de56c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x36de618, size 0x8, virtual true, abstract: false, final false
