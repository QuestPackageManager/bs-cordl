...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x268b800, size 0x6a0, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x268b760, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268b738, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x268b7f8, size 0x8, virtual true, abstract: false, final false
