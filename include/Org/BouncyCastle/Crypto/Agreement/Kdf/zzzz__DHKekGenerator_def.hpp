...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x12ad428, size 0x6b0, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x12ad388, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ad360, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x12ad420, size 0x8, virtual true, abstract: false, final false
