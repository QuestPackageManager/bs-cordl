...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x1385814, size 0x318, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x13856d8, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x138565c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x1385770, size 0xa4, virtual true, abstract: false, final false
