...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x268b9c8, size 0x310, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x268b88c, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x268b818, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x268b924, size 0xa4, virtual true, abstract: false, final false
