...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator*, "Org.BouncyCastle.Crypto.Agreement.Kdf", "ECDHKekGenerator");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_z, put = __cordl_internal_set_z)) ::ArrayW<uint8_t> z;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IDerivationFunction"
  constexpr operator ::Org::BouncyCastle::Crypto::IDerivationFunction*() noexcept;

  /// @brief Method GenerateBytes, addr 0x36e1244, size 0x32c, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x36e10f8, size 0xa4, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_z() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_z();
  ...
  /// @brief Method .ctor, addr 0x36e1090, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x36e119c, size 0xa8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECDHKekGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECDHKekGenerator(ECDHKekGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECDHKekGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECDHKekGenerator(ECDHKekGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator) == 0x30, "Size mismatch!");
