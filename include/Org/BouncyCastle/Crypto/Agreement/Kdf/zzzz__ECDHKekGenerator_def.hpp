...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x35bae90, size 0x32c, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff, int32_t len);

  /// @brief Method Init, addr 0x35bad44, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35bacdc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x35bade8, size 0xa8, virtual true, abstract: false, final false
