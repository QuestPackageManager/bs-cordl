...
public:
  ...
  /// @brief Method GetExtraInfo, addr 0x3621310, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetExtraInfo();

  /// @brief Method GetZ, addr 0x3621308, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36212d8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithm, int32_t keySize, ::ArrayW<uint8_t, ::Array<uint8_t>*> z);

  /// @brief Method .ctor, addr 0x36212e8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Algorithm, addr 0x36212f8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Algorithm();

  /// @brief Method get_KeySize, addr 0x3621300, size 0x8, virtual false, abstract: false, final false
