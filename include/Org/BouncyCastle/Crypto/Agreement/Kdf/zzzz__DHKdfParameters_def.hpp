...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHKdfParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHKdfParameters(DHKdfParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHKdfParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHKdfParameters(DHKdfParametersconst&) = delete;
