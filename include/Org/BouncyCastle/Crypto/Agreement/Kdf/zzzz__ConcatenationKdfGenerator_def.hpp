...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConcatenationKdfGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConcatenationKdfGenerator(ConcatenationKdfGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConcatenationKdfGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConcatenationKdfGenerator(ConcatenationKdfGeneratorconst&) = delete;
