...
public:
  ...
  /// @brief Method CalculateAgreement, addr 0x3624a28, size 0x268, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method GetFieldSize, addr 0x36249e0, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetFieldSize();

  /// @brief Method Init, addr 0x36248e0, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3624c90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
