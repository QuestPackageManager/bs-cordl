...
/// @brief Method CalculateAgreement, addr 0x36257c4, size 0x268, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters*  pubKey) ;

/// @brief Method GetFieldSize, addr 0x362577c, size 0x48, virtual true, abstract: false, final false
inline int32_t GetFieldSize() ;

/// @brief Method Init, addr 0x362567c, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3625a2c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
