...
public:
  ...
  /// @brief Method BigIntToBytes, addr 0x36252c4, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> BigIntToBytes(::Org::BouncyCastle::Math::BigInteger* r);

  /// @brief Method CalculateAgreement, addr 0x3625050, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3624fd0, size 0x80, virtual false, abstract: false, final false
