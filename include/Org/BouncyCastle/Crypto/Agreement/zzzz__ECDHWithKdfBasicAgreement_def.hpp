...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Agreement::ECDHWithKdfBasicAgreement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Agreement::ECDHWithKdfBasicAgreement*, "Org.BouncyCastle.Crypto.Agreement", "ECDHWithKdfBasicAgreement");
...
public:
  ...
  /// @brief Method BigIntToBytes, addr 0x36e48a0, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> BigIntToBytes(::Org::BouncyCastle::Math::BigInteger* r);

  /// @brief Method CalculateAgreement, addr 0x36e462c, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36e45ac, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECDHWithKdfBasicAgreement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECDHWithKdfBasicAgreement(ECDHWithKdfBasicAgreement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECDHWithKdfBasicAgreement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECDHWithKdfBasicAgreement(ECDHWithKdfBasicAgreementconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Agreement::ECDHWithKdfBasicAgreement) == 0x28, "Size mismatch!");
