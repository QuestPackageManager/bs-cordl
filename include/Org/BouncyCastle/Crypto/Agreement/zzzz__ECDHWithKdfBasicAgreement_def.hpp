...
public:
  ...
  /// @brief Method BigIntToBytes, addr 0x147e658, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> BigIntToBytes(::Org::BouncyCastle::Math::BigInteger* r);

  /// @brief Method CalculateAgreement, addr 0x147e3ec, size 0x26c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x147e348, size 0xa4, virtual false, abstract: false, final false
