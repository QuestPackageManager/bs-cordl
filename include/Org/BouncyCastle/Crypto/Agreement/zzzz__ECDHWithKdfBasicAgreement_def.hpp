...
public:
  ...
  /// @brief Method BigIntToBytes, addr 0x35e8d30, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> BigIntToBytes(::Org::BouncyCastle::Math::BigInteger* r);

  /// @brief Method CalculateAgreement, addr 0x35e8abc, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e8a3c, size 0x80, virtual false, abstract: false, final false
