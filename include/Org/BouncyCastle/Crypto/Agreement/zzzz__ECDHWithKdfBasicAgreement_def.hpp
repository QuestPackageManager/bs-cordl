...
public:
  ...
  /// @brief Method .ctor addr 0x121ab3c size 0xa4 virtual false final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::Crypto::IDerivationFunction* kdf);

  /// @brief Method CalculateAgreement addr 0x121abe0 size 0x26c virtual true final false
  inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters* pubKey);

  /// @brief Method BigIntToBytes addr 0x121ae4c size 0x3c virtual false final false
