...
public:
  ...
  /// @brief Method DoFinal, addr 0x23a3e50, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method DoFinal, addr 0x23a3f5c, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method DoFinal, addr 0x23a3f2c, size 0x30, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method DoFinal, addr 0x23a3e78, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x23a3c98, size 0xb0, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x23a3d48, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBytes, addr 0x23a3da0, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBytes, addr 0x23a3d70, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23a4020, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
