...
public:
  ...
  /// @brief Method DoFinal, addr 0x23a3e10, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method DoFinal, addr 0x23a3f1c, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method DoFinal, addr 0x23a3eec, size 0x30, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method DoFinal, addr 0x23a3e38, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x23a3c58, size 0xb0, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x23a3d08, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBytes, addr 0x23a3d60, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBytes, addr 0x23a3d30, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23a3fe0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
