...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::ISignatureFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::ISignatureFactory*, "Org.BouncyCastle.Crypto", "ISignatureFactory");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
