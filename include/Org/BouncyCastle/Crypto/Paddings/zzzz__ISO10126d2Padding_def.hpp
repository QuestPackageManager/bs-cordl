...
public:
  ...
  /// @brief Method AddPadding, addr 0x334c094, size 0xb0, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Init, addr 0x334bfd4, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x334c144, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x334c1c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x334c050, size 0x44, virtual true, abstract: false, final true
