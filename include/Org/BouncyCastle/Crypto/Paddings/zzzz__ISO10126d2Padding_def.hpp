...
public:
  ...
  /// @brief Method AddPadding, addr 0x340b670, size 0xb0, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Init, addr 0x340b5b0, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x340b720, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x340b79c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x340b62c, size 0x44, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ISO10126d2Padding", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ISO10126d2Padding(ISO10126d2Padding&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ISO10126d2Padding", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISO10126d2Padding(ISO10126d2Paddingconst&) = delete;
