...
public:
  ...
  /// @brief Method AddPadding, addr 0x334cfcc, size 0x4c, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Init, addr 0x334cf84, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x334d018, size 0xbc, virtual true, abstract: false, final true
  inline int32_t PadCount(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method .ctor, addr 0x334c48c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x334cf88, size 0x44, virtual true, abstract: false, final true
