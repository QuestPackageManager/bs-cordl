...
public:
  ...
  /// @brief Method AddPadding, addr 0x340c5a8, size 0x4c, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Init, addr 0x340c560, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x340c5f4, size 0xbc, virtual true, abstract: false, final true
  inline int32_t PadCount(::ArrayW<uint8_t> input);

  /// @brief Method .ctor, addr 0x340ba68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x340c564, size 0x44, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Pkcs7Padding", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Pkcs7Padding(Pkcs7Padding&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Pkcs7Padding", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Pkcs7Padding(Pkcs7Paddingconst&) = delete;
