...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Paddings::IBlockCipherPadding*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Paddings::IBlockCipherPadding*, "Org.BouncyCastle.Crypto.Paddings", "IBlockCipherPadding");
// Dependencies
namespace Org::BouncyCastle::Crypto::Paddings {
// Is value type: false
