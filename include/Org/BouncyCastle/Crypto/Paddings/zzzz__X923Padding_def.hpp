...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Paddings::X923Padding*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Paddings::X923Padding*, "Org.BouncyCastle.Crypto.Paddings", "X923Padding");
...
public:
  ...
  /// @brief Method AddPadding, addr 0x340a4a8, size 0xc8, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Init, addr 0x340a45c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x340a570, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x340a5ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x340a464, size 0x44, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Paddings::X923Padding) == 0x18, "Size mismatch!");
