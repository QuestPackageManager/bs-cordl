...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X923Padding", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X923Padding(X923Padding&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X923Padding", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X923Padding(X923Paddingconst&) = delete;
