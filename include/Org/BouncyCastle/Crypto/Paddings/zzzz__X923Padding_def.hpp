...
public:
  ...
  /// @brief Method AddPadding, addr 0x23b81f8, size 0xc8, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Init, addr 0x23b81b0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x23b82c0, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23b833c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x23b81b8, size 0x40, virtual true, abstract: false, final true
