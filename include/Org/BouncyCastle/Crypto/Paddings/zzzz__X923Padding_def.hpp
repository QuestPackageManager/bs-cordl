...
public:
  ...
  /// @brief Method Init addr 0xeba148 size 0x8 virtual true final true
  inline void Init(::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method get_PaddingName addr 0xeba150 size 0x40 virtual true final true
  inline ::StringW get_PaddingName();

  /// @brief Method AddPadding addr 0xeba190 size 0xcc virtual true final true
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method PadCount addr 0xeba25c size 0x84 virtual true final true
  ...
  /// @brief Method .ctor addr 0xeba2e0 size 0x8 virtual false final false
  inline void _ctor();
