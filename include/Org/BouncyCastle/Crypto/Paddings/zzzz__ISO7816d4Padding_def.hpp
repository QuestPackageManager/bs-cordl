...
public:
  ...
  /// @brief Method AddPadding, addr 0xfbf8a8, size 0x64, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Init, addr 0xfbf864, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0xfbf90c, size 0xb0, virtual true, abstract: false, final true
  inline int32_t PadCount(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method .ctor, addr 0xfbf9bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0xfbf868, size 0x40, virtual true, abstract: false, final true
