...
public:
  ...
  /// @brief Method AddPadding, addr 0x23bb590, size 0x64, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Init, addr 0x23bb54c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x23bb5f4, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method get_PaddingName, addr 0x23bb550, size 0x40, virtual true, abstract: false, final true
