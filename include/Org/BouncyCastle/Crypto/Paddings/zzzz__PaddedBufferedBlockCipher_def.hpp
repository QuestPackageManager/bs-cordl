...
public:
  ...
  /// @brief Method DoFinal, addr 0x119ff44, size 0x4e4, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetOutputSize, addr 0x119fae4, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t length);

  /// @brief Method GetUpdateOutputSize, addr 0x119fb30, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t length);

  /// @brief Method Init, addr 0x119f940, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x119fb68, size 0x128, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x119fc90, size 0x2b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x119f8c4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x119f7d4, size 0xf0, virtual false, abstract: false, final false
