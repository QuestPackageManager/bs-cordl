...
public:
  ...
  /// @brief Method DoFinal, addr 0x334caa0, size 0x4e4, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetOutputSize, addr 0x334c644, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t length);

  /// @brief Method GetUpdateOutputSize, addr 0x334c68c, size 0x34, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t length);

  /// @brief Method Init, addr 0x334c490, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x334c6c0, size 0x12c, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x334c7ec, size 0x2b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334c428, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x334c330, size 0xf8, virtual false, abstract: false, final false
