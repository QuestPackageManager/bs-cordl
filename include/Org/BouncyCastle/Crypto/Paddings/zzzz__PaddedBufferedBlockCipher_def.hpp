...
public:
  ...
  /// @brief Method DoFinal, addr 0x23b66d8, size 0x4dc, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetOutputSize, addr 0x23b6280, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t length);

  /// @brief Method GetUpdateOutputSize, addr 0x23b62cc, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t length);

  /// @brief Method Init, addr 0x23b60e0, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x23b6304, size 0x128, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x23b642c, size 0x2ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b606c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x23b5f7c, size 0xf0, virtual false, abstract: false, final false
