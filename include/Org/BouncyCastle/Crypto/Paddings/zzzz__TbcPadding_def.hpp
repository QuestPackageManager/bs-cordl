...
public:
  ...
  /// @brief Method get_PaddingName, addr 0xf5a094, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_PaddingName();

  /// @brief Method Init, addr 0xf5a0d4, size 0x4, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method AddPadding, addr 0xf5a0d8, size 0x88, virtual true, abstract: false, final false
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method PadCount, addr 0xf5a160, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf5a1bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
