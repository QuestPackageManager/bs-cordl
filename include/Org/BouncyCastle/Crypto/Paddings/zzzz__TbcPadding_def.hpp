...
/// @brief Method AddPadding, addr 0x3310ad8, size 0x78, virtual true, abstract: false, final false
inline int32_t AddPadding(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method Init, addr 0x3310ad4, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method PadCount, addr 0x3310b50, size 0x70, virtual true, abstract: false, final false
inline int32_t PadCount(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method .ctor, addr 0x3310bc0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_PaddingName, addr 0x3310a90, size 0x44, virtual true, abstract: false, final true
