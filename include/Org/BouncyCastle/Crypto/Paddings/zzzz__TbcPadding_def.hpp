...
public:
  ...
  /// @brief Method AddPadding, addr 0x334d11c, size 0x78, virtual true, abstract: false, final false
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Init, addr 0x334d118, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method PadCount, addr 0x334d194, size 0x70, virtual true, abstract: false, final false
  inline int32_t PadCount(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method .ctor, addr 0x334d204, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x334d0d4, size 0x44, virtual true, abstract: false, final true
