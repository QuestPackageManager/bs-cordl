...
public:
  ...
  /// @brief Method AddPadding, addr 0x23b807c, size 0x7c, virtual true, abstract: false, final false
  inline int32_t AddPadding(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Init, addr 0x23b8078, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method PadCount, addr 0x23b80f8, size 0x70, virtual true, abstract: false, final false
  inline int32_t PadCount(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method .ctor, addr 0x23b8168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x23b8038, size 0x40, virtual true, abstract: false, final true
