...
public:
  ...
  /// @brief Method AddPadding, addr 0x340c9c0, size 0x48, virtual true, abstract: false, final true
  inline int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Init, addr 0x340c9bc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method PadCount, addr 0x340ca08, size 0x58, virtual true, abstract: false, final true
  inline int32_t PadCount(::ArrayW<uint8_t> input);

  /// @brief Method .ctor, addr 0x340ca60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PaddingName, addr 0x340c978, size 0x44, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ZeroBytePadding", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ZeroBytePadding(ZeroBytePadding&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ZeroBytePadding", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ZeroBytePadding(ZeroBytePaddingconst&) = delete;
