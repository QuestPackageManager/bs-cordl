...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IDsa*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IDsa*, "Org.BouncyCastle.Crypto", "IDsa");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDsa", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDsa(IDsaconst&) = delete;
