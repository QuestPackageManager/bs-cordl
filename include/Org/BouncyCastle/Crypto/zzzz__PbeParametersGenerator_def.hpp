...
public:
  ...
  /// @brief Method GetPassword, addr 0x33deae4, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetPassword();

  /// @brief Method GetSalt, addr 0x33deb50, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetSalt();

  /// @brief Method Init, addr 0x33de980, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method Pkcs12PasswordToBytes, addr 0x33ded24, size 0x8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Pkcs12PasswordToBytes(::ArrayW<char16_t> password);

  /// @brief Method Pkcs12PasswordToBytes, addr 0x33ded2c, size 0xd0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Pkcs12PasswordToBytes(::ArrayW<char16_t> password, bool wrongPkcs12Zero);

  /// @brief Method Pkcs5PasswordToBytes, addr 0x33deb64, size 0x64, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Pkcs5PasswordToBytes(::ArrayW<char16_t> password);

  /// @brief Method Pkcs5PasswordToBytes, addr 0x33debc8, size 0x64, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Pkcs5PasswordToBytes(::StringW password);

  /// @brief Method Pkcs5PasswordToUtf8Bytes, addr 0x33dec2c, size 0x7c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Pkcs5PasswordToUtf8Bytes(::ArrayW<char16_t> password);

  /// @brief Method Pkcs5PasswordToUtf8Bytes, addr 0x33deca8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33de97c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IterationCount, addr 0x33deb5c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_IterationCount();

  /// @brief Method get_Password, addr 0x33dea84, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Password();

  /// @brief Method get_Salt, addr 0x33deaf0, size 0x60, virtual true, abstract: false, final false
