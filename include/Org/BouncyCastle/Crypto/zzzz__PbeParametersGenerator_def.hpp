...
public:
  ...
  /// @brief Method .ctor addr 0xe8d684 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Init addr 0xe8d68c size 0x100 virtual true final false
  inline void Init(::ArrayW<uint8_t, ::Array<uint8_t>*> password, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterationCount);

  /// @brief Method get_Password addr 0xe8d78c size 0x5c virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Password();

  /// @brief Method GetPassword addr 0xe8d7e8 size 0xc virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPassword();

  /// @brief Method get_Salt addr 0xe8d7f4 size 0x5c virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Salt();

  /// @brief Method GetSalt addr 0xe8d850 size 0xc virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSalt();

  /// @brief Method get_IterationCount addr 0xe8d85c size 0x8 virtual true final false
  ...
  /// @brief Method Pkcs5PasswordToBytes addr 0xe8d864 size 0x60 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Pkcs5PasswordToBytes(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method Pkcs5PasswordToBytes addr 0xe8d8c4 size 0x60 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Pkcs5PasswordToBytes(::StringW password);

  /// @brief Method Pkcs5PasswordToUtf8Bytes addr 0xe8d924 size 0x78 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Pkcs5PasswordToUtf8Bytes(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method Pkcs5PasswordToUtf8Bytes addr 0xe8d99c size 0x78 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Pkcs5PasswordToUtf8Bytes(::StringW password);

  /// @brief Method Pkcs12PasswordToBytes addr 0xe8da14 size 0x8 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Pkcs12PasswordToBytes(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method Pkcs12PasswordToBytes addr 0xe8da1c size 0xbc virtual false final false
