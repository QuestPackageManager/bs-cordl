...
public:
  ...
  /// @brief Method .ctor addr 0xed5248 size 0xa8 virtual false final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> context);

  /// @brief Method get_AlgorithmName addr 0xed52f0 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xed5330 size 0xd4 virtual true final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Update addr 0xed54a8 size 0xac virtual true final false
  inline void Update(uint8_t b);

  /// @brief Method BlockUpdate addr 0xed5554 size 0xc4 virtual true final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature addr 0xed5618 size 0x23c virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method VerifySignature addr 0xed5854 size 0x1ac virtual true final false
  inline bool VerifySignature(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method Reset addr 0xed5404 size 0xa4 virtual true final true
  inline void Reset();
