...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ed448phSigner", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Ed448phSigner(Ed448phSigner&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Ed448phSigner", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Ed448phSigner(Ed448phSignerconst&) = delete;
