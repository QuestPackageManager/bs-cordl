...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DsaDigestSigner", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DsaDigestSigner(DsaDigestSigner&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DsaDigestSigner", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DsaDigestSigner(DsaDigestSignerconst&) = delete;
