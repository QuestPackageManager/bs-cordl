...
/// @brief Method BlockUpdate, addr 0x332693c, size 0xd0, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method GenerateSignature, addr 0x3326a0c, size 0x388, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method GetOrder, addr 0x33271bc, size 0x104, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* GetOrder() ;

/// @brief Method Init, addr 0x332664c, size 0x238, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x3327114, size 0xa8, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x3326884, size 0xb8, virtual true, abstract: false, final false
inline void Update(uint8_t  input) ;

/// @brief Method VerifySignature, addr 0x3326d94, size 0x380, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x332647c, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDsa*  dsa, ::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method .ctor, addr 0x33264f4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x3326500, size 0x14c, virtual true, abstract: false, final false
