...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x23cbf50, size 0xc4, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method GenerateSignature, addr 0x23cc014, size 0x374, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method GetOrder, addr 0x23cc798, size 0x100, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* GetOrder();

  /// @brief Method Init, addr 0x23cbc84, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x23cc6f4, size 0xa4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x23cbea4, size 0xac, virtual true, abstract: false, final false
  inline void Update(uint8_t input);

  /// @brief Method VerifySignature, addr 0x23cc388, size 0x36c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23cba88, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDsa* dsa, ::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0x23cbb08, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x23cbb44, size 0x140, virtual true, abstract: false, final false
