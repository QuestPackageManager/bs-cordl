...
public:
// Declarations
/// @brief Method GenerateSignature, addr 0x332be70, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x332c248, size 0xe0, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method VerifySignature, addr 0x332c07c, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x332bc7c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method BlockUpdate, addr 0x332bdd8, size 0x20, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method GenerateSignature, addr 0x332bdf8, size 0x78, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method Init, addr 0x332bcc8, size 0xf0, virtual true, abstract: false, final false
inline void Init(bool  forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Signers::Ed448Signer* New_ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  context) ;

/// @brief Method Reset, addr 0x332c234, size 0x14, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x332bdb8, size 0x20, virtual true, abstract: false, final false
inline void Update(uint8_t  b) ;

/// @brief Method VerifySignature, addr 0x332c000, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x332bbdc, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  context) ;

/// @brief Method get_AlgorithmName, addr 0x332bc84, size 0x44, virtual true, abstract: false, final false
