...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0x34238f0, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3423cc8, size 0xe0, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifySignature, addr 0x3423afc, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34236fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x3423858, size 0x20, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0x3423878, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature();

  /// @brief Method Init, addr 0x3423748, size 0xf0, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner* New_ctor(::ArrayW<uint8_t> context);

  /// @brief Method Reset, addr 0x3423cb4, size 0x14, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x3423838, size 0x20, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x3423a80, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x342365c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> context);

  /// @brief Method get_AlgorithmName, addr 0x3423704, size 0x44, virtual true, abstract: false, final false
