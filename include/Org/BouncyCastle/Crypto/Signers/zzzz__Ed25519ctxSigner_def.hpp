...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0xfb9f04, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xfba2f4, size 0xf4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifySignature, addr 0xfba118, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb9d18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0xfb9e64, size 0x24, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0xfb9e88, size 0x7c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0xfb9d60, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xfba2dc, size 0x18, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0xfb9e40, size 0x24, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0xfba098, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb9c6c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> context);

  /// @brief Method get_AlgorithmName, addr 0xfb9d20, size 0x40, virtual true, abstract: false, final false
