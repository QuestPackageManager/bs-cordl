...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0x336669c, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3366a74, size 0xe0, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifySignature, addr 0x33668a8, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33664a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x3366604, size 0x20, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0x3366624, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0x33664f4, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3366a60, size 0x14, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x33665e4, size 0x20, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x336682c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3366408, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> context);

  /// @brief Method get_AlgorithmName, addr 0x33664b0, size 0x44, virtual true, abstract: false, final false
