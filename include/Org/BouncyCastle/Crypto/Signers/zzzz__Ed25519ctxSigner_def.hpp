...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0xfdb608, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xfdb9f8, size 0xf4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifySignature, addr 0xfdb81c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfdb41c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0xfdb568, size 0x24, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0xfdb58c, size 0x7c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0xfdb464, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xfdb9e0, size 0x18, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0xfdb544, size 0x24, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0xfdb79c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfdb370, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> context);

  /// @brief Method get_AlgorithmName, addr 0xfdb424, size 0x40, virtual true, abstract: false, final false
