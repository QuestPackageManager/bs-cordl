...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0x11ae120, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x11ae510, size 0xf4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifySignature, addr 0x11ae334, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11adf34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x11ae080, size 0x24, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0x11ae0a4, size 0x7c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0x11adf7c, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x11ae4f8, size 0x18, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x11ae05c, size 0x24, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x11ae2b4, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ade88, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> context);

  /// @brief Method get_AlgorithmName, addr 0x11adf3c, size 0x40, virtual true, abstract: false, final false
