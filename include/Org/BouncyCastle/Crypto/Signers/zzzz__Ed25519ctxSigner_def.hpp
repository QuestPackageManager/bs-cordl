...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0xf74f34, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method VerifySignature, addr 0xf75148, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xf75324, size 0xf4, virtual false, abstract: false, final false
  inline void Reset();

  static inline ::Org::BouncyCastle::Crypto::Signers::__Ed25519ctxSigner__Buffer* New_ctor();

  /// @brief Method .ctor, addr 0xf74d48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0xf74c9c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> context);

  /// @brief Method get_AlgorithmName, addr 0xf74d50, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xf74d90, size 0xe0, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Update, addr 0xf74e70, size 0x24, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method BlockUpdate, addr 0xf74e94, size 0x24, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0xf74eb8, size 0x7c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method VerifySignature, addr 0xf750c8, size 0x80, virtual true, abstract: false, final false
  inline bool VerifySignature(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method Reset, addr 0xf7530c, size 0x18, virtual true, abstract: false, final false
  inline void Reset();
