...
public:
  ...
  /// @brief Method BitsToInt, addr 0x11b2a8c, size 0xc8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* BitsToInt(::ArrayW<uint8_t, ::Array<uint8_t>*> t);

  /// @brief Method Init, addr 0x11b2668, size 0x424, virtual true, abstract: false, final true
  ...
  /// @brief Method Init, addr 0x11b2618, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0x11b2b54, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11b2528, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_IsDeterministic, addr 0x11b2610, size 0x8, virtual true, abstract: false, final false
