...
public:
  ...
  /// @brief Method BitsToInt, addr 0x23da54c, size 0xc8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* BitsToInt(::ArrayW<uint8_t, ::Array<uint8_t>*> t);

  /// @brief Method Init, addr 0x23da134, size 0x418, virtual true, abstract: false, final true
  ...
  /// @brief Method Init, addr 0x23da0e8, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0x23da614, size 0x278, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d9ff8, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_IsDeterministic, addr 0x23da0e0, size 0x8, virtual true, abstract: false, final false
