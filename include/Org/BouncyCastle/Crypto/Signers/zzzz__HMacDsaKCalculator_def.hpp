...
public:
  ...
  /// @brief Method BitsToInt, addr 0x342a5b0, size 0xcc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* BitsToInt(::ArrayW<uint8_t> t);

  /// @brief Method Init, addr 0x342a184, size 0x42c, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* d, ::ArrayW<uint8_t> message);

  /// @brief Method Init, addr 0x342a138, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0x342a67c, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x342a04c, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_IsDeterministic, addr 0x342a130, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HMacDsaKCalculator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HMacDsaKCalculator(HMacDsaKCalculator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HMacDsaKCalculator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HMacDsaKCalculator(HMacDsaKCalculatorconst&) = delete;
