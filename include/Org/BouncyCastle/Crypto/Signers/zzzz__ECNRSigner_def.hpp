...
public:
  ...
  /// @brief Method GenerateSignature, addr 0xfb95bc, size 0x3d0, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0xfb93a4, size 0x1f4, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::ECNRSigner* New_ctor();

  /// @brief Method VerifySignature, addr 0xfb998c, size 0x2d8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb9c64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0xfb9364, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0xfb9598, size 0x24, virtual true, abstract: false, final false
