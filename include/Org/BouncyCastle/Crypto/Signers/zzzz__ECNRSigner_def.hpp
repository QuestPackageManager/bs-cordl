...
public:
  ...
  /// @brief Method GenerateSignature, addr 0x32fef80, size 0x3d8, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x32fed60, size 0x1fc, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::ECNRSigner* New_ctor();

  /// @brief Method VerifySignature, addr 0x32ff358, size 0x2d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ff62c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x32fed1c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x32fef5c, size 0x24, virtual true, abstract: false, final false
