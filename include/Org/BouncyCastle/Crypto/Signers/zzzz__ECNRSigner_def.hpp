...
public:
  ...
  /// @brief Method GenerateSignature, addr 0x23d1038, size 0x3c4, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x23d0e30, size 0x1e4, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::ECNRSigner* New_ctor();

  /// @brief Method VerifySignature, addr 0x23d13fc, size 0x2d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d16cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x23d0df0, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x23d1014, size 0x24, virtual true, abstract: false, final false
