...
public:
  ...
  /// @brief Method BlockUpdate, addr 0xfe84fc, size 0xc4, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method DerEncode, addr 0xfe87f0, size 0x88, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DerEncode(::ArrayW<uint8_t, ::Array<uint8_t>*> hash);

  /// @brief Method GenerateSignature, addr 0xfe85c0, size 0x230, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0xfe8228, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xfe8ca0, size 0xa4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0xfe8450, size 0xac, virtual true, abstract: false, final false
  inline void Update(uint8_t input);

  /// @brief Method VerifySignature, addr 0xfe8878, size 0x428, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe7cb4, size 0x1ac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0xfe7f10, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algId);

  /// @brief Method .ctor, addr 0xfe7e60, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* digestOid);

  /// @brief Method .ctor, addr 0xfe7f8c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe8018, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe80d8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0xfe8168, size 0xc0, virtual true, abstract: false, final false
