...
public:
  ...
  /// @brief Method .ctor addr 0xee0540 size 0x1ac virtual false final false
  ...
  /// @brief Method .ctor addr 0xee06ec size 0xb0 virtual false final false
  ...
  /// @brief Method .ctor addr 0xee079c size 0x7c virtual false final false
  ...
  /// @brief Method .ctor addr 0xee08a4 size 0xc0 virtual false final false
  ...
  /// @brief Method .ctor addr 0xee0818 size 0x8c virtual false final false
  ...
  /// @brief Method .ctor addr 0xee0964 size 0x90 virtual false final false
  ...
  /// @brief Method get_AlgorithmName addr 0xee09f4 size 0xc0 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xee0ab4 size 0x228 virtual true final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Update addr 0xee0cdc size 0xac virtual true final false
  inline void Update(uint8_t input);

  /// @brief Method BlockUpdate addr 0xee0d88 size 0xc4 virtual true final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method GenerateSignature addr 0xee0e4c size 0x230 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method VerifySignature addr 0xee1104 size 0x428 virtual true final false
  inline bool VerifySignature(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method Reset addr 0xee152c size 0xa4 virtual true final false
  inline void Reset();

  /// @brief Method DerEncode addr 0xee107c size 0x88 virtual false final false
