...
public:
  ...
  /// @brief Method CreateTrailerMap, addr 0x10bca40, size 0x674, virtual false, abstract: false, final false
  static inline ::System::Collections::IDictionary* CreateTrailerMap();

  /// @brief Method GetTrailer, addr 0x10b912c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method NoTrailerAvailable, addr 0x10b8fd8, size 0x154, virtual false, abstract: false, final false
  static inline bool NoTrailerAvailable(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0x10bd100, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
