...
public:
  ...
  /// @brief Method CreateTrailerMap, addr 0x336f150, size 0x688, virtual false, abstract: false, final false
  static inline ::System::Collections::IDictionary* CreateTrailerMap();

  /// @brief Method GetTrailer, addr 0x336b618, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method NoTrailerAvailable, addr 0x336b4b8, size 0x160, virtual false, abstract: false, final false
  static inline bool NoTrailerAvailable(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0x336f828, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
