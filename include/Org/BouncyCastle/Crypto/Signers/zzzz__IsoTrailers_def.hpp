...
public:
  ...
  /// @brief Method CreateTrailerMap, addr 0x11b0164, size 0x674, virtual false, abstract: false, final false
  static inline ::System::Collections::IDictionary* CreateTrailerMap();

  /// @brief Method GetTrailer, addr 0x11ac850, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method NoTrailerAvailable, addr 0x11ac6fc, size 0x154, virtual false, abstract: false, final false
  static inline bool NoTrailerAvailable(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0x11b0824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
