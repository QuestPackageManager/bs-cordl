...
public:
  ...
  /// @brief Method CreateTrailerMap, addr 0x23d6624, size 0x674, virtual false, abstract: false, final false
  static inline ::System::Collections::IDictionary* CreateTrailerMap();

  /// @brief Method GetTrailer, addr 0x23d2d08, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method NoTrailerAvailable, addr 0x23d2bb4, size 0x154, virtual false, abstract: false, final false
  static inline bool NoTrailerAvailable(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0x23d6ce4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
