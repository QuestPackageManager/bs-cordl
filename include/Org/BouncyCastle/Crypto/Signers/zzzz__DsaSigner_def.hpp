...
public:
  ...
  /// @brief Method CalculateE, addr 0x238ee54, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateSignature, addr 0x238e880, size 0x3b8, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x238e5d8, size 0x284, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InitSecureRandom, addr 0x238ef30, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifySignature, addr 0x238ec38, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x238e504, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x238e56c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator* kCalculator);

  /// @brief Method get_AlgorithmName, addr 0x238e598, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x238e85c, size 0x24, virtual true, abstract: false, final false
