...
public:
  ...
  /// @brief Method CalculateE, addr 0xfd91ac, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateSignature, addr 0xfd8bd8, size 0x3b8, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0xfd8928, size 0x28c, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InitSecureRandom, addr 0xfd928c, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifySignature, addr 0xfd8f90, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd884c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xfd88bc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator* kCalculator);

  /// @brief Method get_AlgorithmName, addr 0xfd88e8, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0xfd8bb4, size 0x24, virtual true, abstract: false, final false
