...
public:
  ...
  /// @brief Method CalculateE, addr 0x32fd474, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateSignature, addr 0x32fce90, size 0x3c4, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x32fcbd0, size 0x29c, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InitSecureRandom, addr 0x32fd550, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifySignature, addr 0x32fd254, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32fcb2c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32fcb80, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator* kCalculator);

  /// @brief Method get_AlgorithmName, addr 0x32fcb8c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x32fce6c, size 0x24, virtual true, abstract: false, final false
