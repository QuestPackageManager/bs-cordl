...
public:
  ...
  /// @brief Method CalculateE, addr 0x10b2a14, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateBasePointMultiplier, addr 0x10b2ad4, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method GenerateSignature, addr 0x10b220c, size 0x480, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDenominator, addr 0x10b2b30, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x10b1f5c, size 0x28c, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InitSecureRandom, addr 0x10b2bc4, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifySignature, addr 0x10b268c, size 0x388, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10b1e80, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x10b1ef0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x10b1f1c, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x10b21e8, size 0x24, virtual true, abstract: false, final false
