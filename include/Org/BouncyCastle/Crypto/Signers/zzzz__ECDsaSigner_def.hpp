...
public:
  ...
  /// @brief Method .ctor addr 0xed1bac size 0x70 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0xed1c1c size 0x2c virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator* kCalculator);

  /// @brief Method get_AlgorithmName addr 0xed1c48 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xed1c88 size 0x28c virtual true final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_Order addr 0xed1f14 size 0x24 virtual true final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Order();

  /// @brief Method GenerateSignature addr 0xed1f38 size 0x480 virtual true final false
  ...
  /// @brief Method VerifySignature addr 0xed23b8 size 0x388 virtual true final false
  ...
  /// @brief Method CalculateE addr 0xed2740 size 0xc0 virtual true final false
  ...
  /// @brief Method CreateBasePointMultiplier addr 0xed2800 size 0x5c virtual true final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method GetDenominator addr 0xed285c size 0x94 virtual true final false
  ...
  /// @brief Method InitSecureRandom addr 0xed28f0 size 0x70 virtual true final false
