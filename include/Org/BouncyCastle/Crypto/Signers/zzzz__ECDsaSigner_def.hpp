...
public:
  ...
  /// @brief Method .ctor, addr 0xf47d98, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method .ctor, addr 0xf47e08, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator* kCalculator);

  /// @brief Method get_AlgorithmName, addr 0xf47e34, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xf47e74, size 0x28c, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_Order, addr 0xf48100, size 0x24, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Order();

  /// @brief Method GenerateSignature, addr 0xf48124, size 0x480, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifySignature, addr 0xf485a4, size 0x388, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateE, addr 0xf4892c, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateBasePointMultiplier, addr 0xf489ec, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method GetDenominator, addr 0xf48a48, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method InitSecureRandom, addr 0xf48adc, size 0x70, virtual true, abstract: false, final false
