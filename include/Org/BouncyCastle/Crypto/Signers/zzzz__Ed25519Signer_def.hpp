...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::Ed25519Signer*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::Ed25519Signer_Buffer*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::Ed25519Signer*, "Org.BouncyCastle.Crypto.Signers", "Ed25519Signer");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::Ed25519Signer_Buffer*, "Org.BouncyCastle.Crypto.Signers", "Ed25519Signer/Buffer");
...
public:
  // Declarations
  /// @brief Method GenerateSignature, addr 0x3426b6c, size 0x184, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature(::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters* privateKey);

  static inline ::Org::BouncyCastle::Crypto::Signers::Ed25519Signer_Buffer* New_ctor();

  /// @brief Method Reset, addr 0x3426f28, size 0xe0, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifySignature, addr 0x3426d64, size 0x1b0, virtual false, abstract: false, final false
  inline bool VerifySignature(::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters* publicKey, ::ArrayW<uint8_t> signature);

  /// @brief Method .ctor, addr 0x3426980, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::Ed25519Signer_Buffer) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x3426adc, size 0x20, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0x3426afc, size 0x70, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature();

  /// @brief Method Init, addr 0x34269cc, size 0xf0, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::Ed25519Signer* New_ctor();

  /// @brief Method Reset, addr 0x3426f14, size 0x14, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x3426abc, size 0x20, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x3426cf0, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3426924, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x3426988, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::Ed25519Signer) == 0x30, "Size mismatch!");
