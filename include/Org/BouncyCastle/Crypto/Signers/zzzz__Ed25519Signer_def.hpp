...
public:
  // Declarations
  /// @brief Method GenerateSignature addr 0xf4af8c size 0x188 virtual false final false
  ...
  /// @brief Method VerifySignature addr 0xf4b18c size 0x1b4 virtual false final false
  ...
  /// @brief Method Reset addr 0xf4b358 size 0xf4 virtual false final false
  inline void Reset();

  static inline ::Org::BouncyCastle::Crypto::Signers::__Ed25519Signer__Buffer* New_ctor();

  /// @brief Method .ctor addr 0xf4ada8 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0xf4ad40 size 0x68 virtual false final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName addr 0xf4adb0 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xf4adf0 size 0xe0 virtual true final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Update addr 0xf4aed0 size 0x24 virtual true final false
  inline void Update(uint8_t b);

  /// @brief Method BlockUpdate addr 0xf4aef4 size 0x24 virtual true final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature addr 0xf4af18 size 0x74 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method VerifySignature addr 0xf4b114 size 0x78 virtual true final false
  inline bool VerifySignature(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method Reset addr 0xf4b340 size 0x18 virtual true final false
  inline void Reset();
