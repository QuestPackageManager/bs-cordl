...
public:
  // Declarations
  /// @brief Method GenerateSignature addr 0xed4d94 size 0x184 virtual false final false
  ...
  /// @brief Method VerifySignature addr 0xed4f90 size 0x1b0 virtual false final false
  ...
  /// @brief Method Reset addr 0xed5158 size 0xf0 virtual false final false
  inline void Reset();

  static inline ::Org::BouncyCastle::Crypto::Signers::__Ed25519Signer__Buffer* New_ctor();

  /// @brief Method .ctor addr 0xed4bb0 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0xed4b48 size 0x68 virtual false final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName addr 0xed4bb8 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xed4bf8 size 0xe0 virtual true final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Update addr 0xed4cd8 size 0x24 virtual true final false
  inline void Update(uint8_t b);

  /// @brief Method BlockUpdate addr 0xed4cfc size 0x24 virtual true final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature addr 0xed4d20 size 0x74 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method VerifySignature addr 0xed4f18 size 0x78 virtual true final false
  inline bool VerifySignature(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method Reset addr 0xed5140 size 0x18 virtual true final false
  inline void Reset();
