...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x3338ec4, size 0xd0, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t off, int32_t len);

  /// @brief Method ClearBlock, addr 0x3338dec, size 0x20, virtual false, abstract: false, final false
  inline void ClearBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> block);

  /// @brief Method CreateSignatureBlock, addr 0x33391a8, size 0x28c, virtual false, abstract: false, final false
  inline void CreateSignatureBlock();

  /// @brief Method GenerateSignature, addr 0x333903c, size 0x16c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0x3338c38, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3338f94, size 0xa8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x3338e0c, size 0xb8, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x3339434, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3338c30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0x33389bc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x3338ac8, size 0x168, virtual true, abstract: false, final false
