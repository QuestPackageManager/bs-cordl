...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x23e0264, size 0xc4, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t off, int32_t len);

  /// @brief Method ClearBlock, addr 0x23e0194, size 0x24, virtual false, abstract: false, final false
  inline void ClearBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> block);

  /// @brief Method CreateSignatureBlock, addr 0x23e052c, size 0x278, virtual false, abstract: false, final false
  inline void CreateSignatureBlock();

  /// @brief Method GenerateSignature, addr 0x23e03cc, size 0x160, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0x23dfff4, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x23e0328, size 0xa4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x23e01b8, size 0xac, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x23e07a4, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23dffec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method .ctor, addr 0x23dfd80, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x23dfe8c, size 0x160, virtual true, abstract: false, final false
