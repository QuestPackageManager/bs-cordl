...
public:
  ...
  /// @brief Method CheckValue, addr 0x11c9798, size 0xa0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0x11c93fc, size 0x244, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodeValue, addr 0x11c9838, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x11c9640, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0x11c98f8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11c99f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
