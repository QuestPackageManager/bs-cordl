...
public:
  ...
  /// @brief Method CheckValue, addr 0xfea988, size 0xa0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0xfea5ec, size 0x244, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodeValue, addr 0xfeaa28, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0xfea830, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0xfeaae8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfeabe0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
