...
public:
  ...
  /// @brief Method CheckValue, addr 0x3431f54, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0x3431bb4, size 0x240, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> Decode(::Org::BouncyCastle::Math::BigInteger* n, ::ArrayW<uint8_t> encoding);

  /// @brief Method DecodeValue, addr 0x3431ff0, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x3431df4, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0x34320bc, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34321a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
