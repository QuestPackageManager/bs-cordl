...
public:
  ...
  /// @brief Method CheckValue, addr 0x23e3ea4, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0x23e3b0c, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodeValue, addr 0x23e3f40, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x23e3d4c, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0x23e4000, size 0x8c, virtual true, abstract: false, final false
