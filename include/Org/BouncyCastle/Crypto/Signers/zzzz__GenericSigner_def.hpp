...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x23d40d0, size 0xc4, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method GenerateSignature, addr 0x23d4194, size 0x21c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0x23d3e04, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x23d470c, size 0xa4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x23d4024, size 0xac, virtual true, abstract: false, final false
  inline void Update(uint8_t input);

  /// @brief Method VerifySignature, addr 0x23d43b0, size 0x35c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d3c00, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* engine, ::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_AlgorithmName, addr 0x23d3c2c, size 0x1d8, virtual true, abstract: false, final false
