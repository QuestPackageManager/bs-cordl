...
public:
  ...
  /// @brief Method BlockUpdate, addr 0xfbc754, size 0xc4, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method GenerateSignature, addr 0xfbc818, size 0x220, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method Init, addr 0xfbc480, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0xfbcd98, size 0xa4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0xfbc6a8, size 0xac, virtual true, abstract: false, final false
  inline void Update(uint8_t input);

  /// @brief Method VerifySignature, addr 0xfbca38, size 0x360, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfbc1e0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* engine, ::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_AlgorithmName, addr 0xfbc20c, size 0x274, virtual true, abstract: false, final false
