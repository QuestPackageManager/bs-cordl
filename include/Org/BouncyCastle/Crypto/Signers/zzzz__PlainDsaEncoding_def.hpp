...
public:
  ...
  /// @brief Method CheckValue, addr 0x342cce4, size 0x98, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0x342ca80, size 0x198, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> Decode(::Org::BouncyCastle::Math::BigInteger* n, ::ArrayW<uint8_t> encoding);

  /// @brief Method DecodeValue, addr 0x342cd7c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x342cc18, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0x342ce18, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x342cf88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
