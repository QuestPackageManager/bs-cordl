...
/// @brief Method CheckValue, addr 0x337082c, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger*  n, ::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method Decode, addr 0x33705c8, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method DecodeValue, addr 0x33708c4, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method Encode, addr 0x3370760, size 0xcc, virtual true, abstract: false, final false
...
/// @brief Method EncodeValue, addr 0x3370960, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3370ad0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
