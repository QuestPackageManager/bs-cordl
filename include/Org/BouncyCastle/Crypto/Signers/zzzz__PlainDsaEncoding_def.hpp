...
public:
  ...
  /// @brief Method Decode addr 0xedce10 size 0x198 virtual true final false
  ...
  /// @brief Method Encode addr 0xedcfa8 size 0xcc virtual true final false
  ...
  /// @brief Method CheckValue addr 0xedd074 size 0x9c virtual true final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method DecodeValue addr 0xedd110 size 0xa0 virtual true final false
  ...
  /// @brief Method EncodeValue addr 0xedd1b0 size 0x124 virtual true final false
  ...
  /// @brief Method .ctor addr 0xedd338 size 0x8 virtual false final false
  inline void _ctor();
