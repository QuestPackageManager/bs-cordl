...
public:
  ...
  /// @brief Method CheckValue, addr 0x23dedbc, size 0x98, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0x23deb5c, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodeValue, addr 0x23dee54, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x23decf0, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0x23deeec, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23df06c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
