...
public:
  ...
  /// @brief Method CheckValue, addr 0x23db084, size 0x98, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0x23dae24, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodeValue, addr 0x23db11c, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x23dafb8, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0x23db1b4, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23db334, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
