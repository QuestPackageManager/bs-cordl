...
public:
  ...
  /// @brief Method CheckValue, addr 0x23d9688, size 0x98, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Decode, addr 0x23d9428, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodeValue, addr 0x23d9720, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x23d95bc, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodeValue, addr 0x23d97b8, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d9938, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
