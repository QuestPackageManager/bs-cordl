...
/// @brief Method BlockUpdate, addr 0x332d424, size 0xd0, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method GenerateSignature, addr 0x332d4f4, size 0x3bc, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method Init, addr 0x332d134, size 0x238, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x332dc08, size 0xa8, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x332d36c, size 0xb8, virtual true, abstract: false, final false
inline void Update(uint8_t  input) ;

/// @brief Method VerifySignature, addr 0x332d8b0, size 0x358, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x332cf24, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDsa*  signer, ::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method get_AlgorithmName, addr 0x332cfe8, size 0x14c, virtual true, abstract: false, final false
