...
/// @brief Method CreateBasePointMultiplier, addr 0x3329468, size 0x44, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier() ;

/// @brief Method GenerateSignature, addr 0x3328da4, size 0x3bc, virtual true, abstract: false, final false
...
/// @brief Method Init, addr 0x3328b84, size 0x1fc, virtual true, abstract: false, final false
inline void Init(bool  forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer* New_ctor() ;

/// @brief Method VerifySignature, addr 0x3329160, size 0x308, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33294ac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AlgorithmName, addr 0x3328b6c, size 0x18, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_Order, addr 0x3328d80, size 0x24, virtual true, abstract: false, final false
