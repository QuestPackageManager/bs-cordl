...
public:
  ...
  /// @brief Method get_AlgorithmName addr 0xed29d8 size 0x1c virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xed29f4 size 0x1f4 virtual true final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_Order addr 0xed2be8 size 0x24 virtual true final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Order();

  /// @brief Method GenerateSignature addr 0xed2c0c size 0x3a4 virtual true final false
  ...
  /// @brief Method VerifySignature addr 0xed2fb0 size 0x304 virtual true final false
  ...
  /// @brief Method CreateBasePointMultiplier addr 0xed32b4 size 0x5c virtual true final false
  ...
  /// @brief Method .ctor addr 0xed3310 size 0x8 virtual false final false
  inline void _ctor();
