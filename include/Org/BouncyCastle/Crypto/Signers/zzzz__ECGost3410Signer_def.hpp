...
public:
  ...
  /// @brief Method CreateBasePointMultiplier, addr 0x3425088, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method GenerateSignature, addr 0x34249c4, size 0x3bc, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> GenerateSignature(::ArrayW<uint8_t> message);

  /// @brief Method Init, addr 0x34247a4, size 0x1fc, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer* New_ctor();

  /// @brief Method VerifySignature, addr 0x3424d80, size 0x308, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34250cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x342478c, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x34249a0, size 0x24, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECGost3410Signer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECGost3410Signer(ECGost3410Signer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECGost3410Signer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECGost3410Signer(ECGost3410Signerconst&) = delete;
