...
public:
  ...
  /// @brief Method CreateBasePointMultiplier, addr 0x23d0d94, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method GenerateSignature, addr 0x23d06ec, size 0x3a8, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x23d04e4, size 0x1e4, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer* New_ctor();

  /// @brief Method VerifySignature, addr 0x23d0a94, size 0x300, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d0de8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x23d04c8, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x23d06c8, size 0x24, virtual true, abstract: false, final false
