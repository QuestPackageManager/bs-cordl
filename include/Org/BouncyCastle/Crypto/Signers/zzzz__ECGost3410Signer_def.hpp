...
public:
  ...
  /// @brief Method CreateBasePointMultiplier, addr 0xfb9300, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method GenerateSignature, addr 0xfb8c58, size 0x3a4, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0xfb8a40, size 0x1f4, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer* New_ctor();

  /// @brief Method VerifySignature, addr 0xfb8ffc, size 0x304, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb935c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0xfb8a24, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0xfb8c34, size 0x24, virtual true, abstract: false, final false
