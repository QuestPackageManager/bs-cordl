...
public:
  ...
  /// @brief Method CreateBasePointMultiplier, addr 0x3365aac, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method GenerateSignature, addr 0x33653e8, size 0x3bc, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x33651c8, size 0x1fc, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::ECGost3410Signer* New_ctor();

  /// @brief Method VerifySignature, addr 0x33657a4, size 0x308, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3365af0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x33651b0, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x33653c4, size 0x24, virtual true, abstract: false, final false
