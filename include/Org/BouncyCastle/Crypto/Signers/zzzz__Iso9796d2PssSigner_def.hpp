...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x342bd58, size 0x154, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method ClearBlock, addr 0x342b348, size 0x20, virtual false, abstract: false, final false
  inline void ClearBlock(::ArrayW<uint8_t> block);

  /// @brief Method GenerateSignature, addr 0x342bfac, size 0x6dc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature();

  /// @brief Method GetRecoveredMessage, addr 0x342a900, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> GetRecoveredMessage();

  /// @brief Method HasFullMessage, addr 0x342cdc4, size 0x8, virtual true, abstract: false, final false
  inline bool HasFullMessage();

  /// @brief Method Init, addr 0x342ae40, size 0x488, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method IsSameAs, addr 0x342b2c8, size 0x80, virtual false, abstract: false, final false
  inline bool IsSameAs(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b);

  /// @brief Method ItoOSP, addr 0x342cdcc, size 0x54, virtual false, abstract: false, final false
  inline void ItoOSP(int32_t i, ::ArrayW<uint8_t> sp);

  /// @brief Method LtoOSP, addr 0x342c688, size 0x94, virtual false, abstract: false, final false
  inline void LtoOSP(int64_t l, ::ArrayW<uint8_t> sp);

  /// @brief Method MaskGeneratorFunction1, addr 0x342b7f8, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x342beac, size 0x100, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x342bc54, size 0x104, virtual true, abstract: false, final false
  inline void Update(uint8_t input);

  /// @brief Method UpdateWithRecoveredMessage, addr 0x342b368, size 0x490, virtual true, abstract: false, final false
  inline void UpdateWithRecoveredMessage(::ArrayW<uint8_t> signature);

  /// @brief Method VerifySignature, addr 0x342c71c, size 0x6a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x342ad70, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x342a908, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x342ad78, size 0xc8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Iso9796d2PssSigner", modifiers: "&&", def_value: None, comment: None }]
