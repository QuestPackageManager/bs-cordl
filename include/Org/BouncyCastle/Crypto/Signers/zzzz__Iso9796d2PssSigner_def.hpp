...
public:
  ...
  /// @brief Method GetRecoveredMessage, addr 0xf79be4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf79bec, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf7a058, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0xf7a060, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xf7a120, size 0x404, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method IsSameAs, addr 0xf7a524, size 0x80, virtual false, abstract: false, final false
  inline bool IsSameAs(::ArrayW<uint8_t, ::Array<uint8_t>*> a, ::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method ClearBlock, addr 0xf7a5a4, size 0x24, virtual false, abstract: false, final false
  inline void ClearBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> block);

  /// @brief Method UpdateWithRecoveredMessage, addr 0xf7a5c8, size 0x474, virtual true, abstract: false, final false
  inline void UpdateWithRecoveredMessage(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method Update, addr 0xf7ae90, size 0xf4, virtual true, abstract: false, final false
  inline void Update(uint8_t input);

  /// @brief Method BlockUpdate, addr 0xf7af84, size 0x148, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Reset, addr 0xf7b0cc, size 0xe4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method GenerateSignature, addr 0xf7b1b0, size 0x6d0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSignature();

  /// @brief Method VerifySignature, addr 0xf7b914, size 0x66c, virtual true, abstract: false, final false
  inline bool VerifySignature(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method HasFullMessage, addr 0xf7bf80, size 0x8, virtual true, abstract: false, final false
  inline bool HasFullMessage();

  /// @brief Method ItoOSP, addr 0xf7bf88, size 0x54, virtual false, abstract: false, final false
  inline void ItoOSP(int32_t i, ::ArrayW<uint8_t, ::Array<uint8_t>*> sp);

  /// @brief Method LtoOSP, addr 0xf7b880, size 0x94, virtual false, abstract: false, final false
  inline void LtoOSP(int64_t l, ::ArrayW<uint8_t, ::Array<uint8_t>*> sp);

  /// @brief Method MaskGeneratorFunction1, addr 0xf7aa3c, size 0x454, virtual false, abstract: false, final false
