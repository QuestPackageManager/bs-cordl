...
/// @brief Method BlockUpdate, addr 0x3331cd8, size 0x144, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method ClearBlock, addr 0x333173c, size 0x20, virtual false, abstract: false, final false
inline void ClearBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  block) ;

/// @brief Method GenerateSignature, addr 0x3331f0c, size 0x3f4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method GetRecoveredMessage, addr 0x3331200, size 0x8, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetRecoveredMessage() ;

/// @brief Method HasFullMessage, addr 0x3332b04, size 0x8, virtual true, abstract: false, final false
inline bool HasFullMessage() ;

/// @brief Method Init, addr 0x33313dc, size 0x298, virtual true, abstract: false, final false
inline void Init(bool  forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method IsSameAs, addr 0x3331674, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x3331e1c, size 0xf0, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ReturnFalse, addr 0x3332adc, size 0x28, virtual false, abstract: false, final false
inline bool ReturnFalse(::ArrayW<uint8_t,::Array<uint8_t>*>  block) ;

/// @brief Method Update, addr 0x3331be4, size 0xf4, virtual true, abstract: false, final false
inline void Update(uint8_t  input) ;

/// @brief Method UpdateWithRecoveredMessage, addr 0x333175c, size 0x488, virtual true, abstract: false, final false
inline void UpdateWithRecoveredMessage(::ArrayW<uint8_t,::Array<uint8_t>*>  signature) ;

/// @brief Method VerifySignature, addr 0x3332300, size 0x7dc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x333130c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*  cipher, ::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method .ctor, addr 0x3331208, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x3331314, size 0xc8, virtual true, abstract: false, final false
