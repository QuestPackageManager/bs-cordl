...
public:
  ...
  /// @brief Method GenerateSignature, addr 0x23d1c70, size 0x26c, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x23d1a70, size 0x1dc, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::Gost3410Signer* New_ctor();

  /// @brief Method VerifySignature, addr 0x23d1edc, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d2180, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x23d1a30, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x23d1c4c, size 0x24, virtual true, abstract: false, final false
