...
public:
  ...
  /// @brief Method GenerateSignature, addr 0x336a548, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x336a338, size 0x1ec, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::Gost3410Signer* New_ctor();

  /// @brief Method VerifySignature, addr 0x336a7bc, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336aa6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0x336a2f4, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0x336a524, size 0x24, virtual true, abstract: false, final false
