...
public:
  ...
  /// @brief Method get_AlgorithmName, addr 0xf4dd40, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xf4dd80, size 0x1ec, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_Order, addr 0xf4df6c, size 0x24, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Order();

  /// @brief Method GenerateSignature, addr 0xf4df90, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifySignature, addr 0xf4e200, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf4e4a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
