...
public:
  ...
  /// @brief Method GenerateSignature, addr 0xfbddf0, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0xfbdbe0, size 0x1ec, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::Gost3410Signer* New_ctor();

  /// @brief Method VerifySignature, addr 0xfbe060, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfbe304, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AlgorithmName, addr 0xfbdba0, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_Order, addr 0xfbddcc, size 0x24, virtual true, abstract: false, final false
