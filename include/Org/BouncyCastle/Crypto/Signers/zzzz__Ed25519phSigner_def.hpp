...
/// @brief Method BlockUpdate, addr 0x332a840, size 0xd0, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method GenerateSignature, addr 0x332a910, size 0x244, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method Init, addr 0x332a5fc, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x332a6e0, size 0xa8, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method Update, addr 0x332a788, size 0xb8, virtual true, abstract: false, final false
inline void Update(uint8_t  b) ;

/// @brief Method VerifySignature, addr 0x332ab54, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x332a510, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  context) ;

/// @brief Method get_AlgorithmName, addr 0x332a5b8, size 0x44, virtual true, abstract: false, final false
