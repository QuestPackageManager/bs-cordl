...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::Ed25519phSigner*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::Ed25519phSigner*, "Org.BouncyCastle.Crypto.Signers", "Ed25519phSigner");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_context, put = __cordl_internal_set_context)) ::ArrayW<uint8_t> context;
  ...
  /// @brief Method BlockUpdate, addr 0x3426460, size 0xd0, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSignature, addr 0x3426530, size 0x244, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSignature();

  /// @brief Method Init, addr 0x342621c, size 0xe4, virtual true, abstract: false, final false
  inline void Init(bool forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Signers::Ed25519phSigner* New_ctor(::ArrayW<uint8_t> context);

  /// @brief Method Reset, addr 0x3426300, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x34263a8, size 0xb8, virtual true, abstract: false, final false
  inline void Update(uint8_t b);

  /// @brief Method VerifySignature, addr 0x3426774, size 0x1b0, virtual true, abstract: false, final false
  inline bool VerifySignature(::ArrayW<uint8_t> signature);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_context() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_context();

  constexpr bool const& __cordl_internal_get_forSigning() const;

  constexpr bool& __cordl_internal_get_forSigning();

  constexpr ::Org::BouncyCastle::Crypto::IDigest* const& __cordl_internal_get_prehash() const;
  ...
  constexpr void __cordl_internal_set_context(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x3426130, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> context);

  /// @brief Method get_AlgorithmName, addr 0x34261d8, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ed25519phSigner", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Ed25519phSigner(Ed25519phSigner&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Ed25519phSigner", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Ed25519phSigner(Ed25519phSignerconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Signers::Ed25519phSigner) == 0x38, "Size mismatch!");
