...
public:
  ...
  /// @brief Method Init, addr 0x23dc5cc, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x23dc5c4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0x23dc618, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23dc6d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDeterministic, addr 0x23dc5bc, size 0x8, virtual true, abstract: false, final false
