...
public:
  ...
  /// @brief Method Init, addr 0xfe73e8, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0xfe73e0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0xfe7438, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe74fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDeterministic, addr 0xfe73d8, size 0x8, virtual true, abstract: false, final false
