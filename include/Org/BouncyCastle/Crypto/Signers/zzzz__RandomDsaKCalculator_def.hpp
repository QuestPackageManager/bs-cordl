...
public:
  ...
  /// @brief Method Init, addr 0x23da23c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x23da234, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0x23da288, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23da340, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDeterministic, addr 0x23da22c, size 0x8, virtual true, abstract: false, final false
