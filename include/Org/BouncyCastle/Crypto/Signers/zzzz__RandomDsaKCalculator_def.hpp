...
public:
  ...
  /// @brief Method Init, addr 0x23d8b1c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x23d8b14, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0x23d8b68, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d8c20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDeterministic, addr 0x23d8b0c, size 0x8, virtual true, abstract: false, final false
