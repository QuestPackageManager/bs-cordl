...
public:
  ...
  /// @brief Method Init, addr 0x23db258, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x23db250, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0x23db2a4, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23db35c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDeterministic, addr 0x23db248, size 0x8, virtual true, abstract: false, final false
