...
public:
  ...
  /// @brief Method Init, addr 0xfc5ce4, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0xfc5cdc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextK, addr 0xfc5d34, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc5df8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDeterministic, addr 0xfc5cd4, size 0x8, virtual true, abstract: false, final false
