...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Signers::IDsaEncoding*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Signers::IDsaEncoding*, "Org.BouncyCastle.Crypto.Signers", "IDsaEncoding");
// Dependencies
namespace Org::BouncyCastle::Crypto::Signers {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDsaEncoding", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDsaEncoding(IDsaEncodingconst&) = delete;
