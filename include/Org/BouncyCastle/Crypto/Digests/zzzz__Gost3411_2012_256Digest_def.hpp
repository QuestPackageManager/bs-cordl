...
public:
  ...
  /// @brief Method Copy, addr 0x12bc5d0, size 0x60, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x12bc540, size 0x90, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetDigestSize, addr 0x12bc538, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bc408, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12bc494, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x12bc3c8, size 0x40, virtual true, abstract: false, final false
