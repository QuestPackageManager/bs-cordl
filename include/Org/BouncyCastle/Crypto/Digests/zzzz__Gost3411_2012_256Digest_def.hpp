...
public:
  ...
  /// @brief Method get_AlgorithmName addr 0x11b4c14 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  static inline ::Org::BouncyCastle::Crypto::Digests::Gost3411_2012_256Digest* New_ctor();

  /// @brief Method .ctor addr 0x11b4c54 size 0x8c virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x11b4ce0 size 0xa4 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Gost3411_2012_256Digest* other);

  /// @brief Method GetDigestSize addr 0x11b4d84 size 0x8 virtual true final false
  inline int32_t GetDigestSize();

  /// @brief Method DoFinal addr 0x11b4d8c size 0x90 virtual true final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Copy addr 0x11b4e1c size 0x60 virtual true final false
