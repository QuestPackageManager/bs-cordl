...
public:
  ...
  /// @brief Method Copy, addr 0x269d2c4, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x269d234, size 0x90, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetDigestSize, addr 0x269d22c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x269d0fc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x269d188, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x269d0bc, size 0x40, virtual true, abstract: false, final false
