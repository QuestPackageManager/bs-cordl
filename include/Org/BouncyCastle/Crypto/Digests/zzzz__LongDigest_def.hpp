...
public:
  ...
  /// @brief Method AdjustByteCounts, addr 0x36ee33c, size 0x24, virtual false, abstract: false, final false
  inline void AdjustByteCounts();

  /// @brief Method BlockUpdate, addr 0x36ee1c4, size 0x110, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method Ch, addr 0x36ee974, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyIn, addr 0x36ee00c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Finish, addr 0x36ee2d4, size 0x68, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method GetByteLength, addr 0x36ee9a8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Maj, addr 0x36ee994, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x36ee3c0, size 0x518, virtual false, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x36ee360, size 0x60, virtual false, abstract: false, final false
  inline void ProcessLength(int64_t lowW, int64_t hiW);

  /// @brief Method ProcessWord, addr 0x36ee11c, size 0xa8, virtual false, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff);

  /// @brief Method Reset, addr 0x36ee8d8, size 0x6c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method Sigma0, addr 0x36ee954, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Sigma0(uint64_t x);

  /// @brief Method Sigma1, addr 0x36ee944, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Sigma1(uint64_t x);

  /// @brief Method Sum0, addr 0x36ee984, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Sum0(uint64_t x);

  /// @brief Method Sum1, addr 0x36ee964, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Sum1(uint64_t x);

  /// @brief Method Update, addr 0x36ee0a8, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36edec4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36edf60, size 0xac, virtual false, abstract: false, final false
