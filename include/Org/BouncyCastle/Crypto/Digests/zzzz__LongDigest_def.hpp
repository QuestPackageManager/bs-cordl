...
public:
  ...
  /// @brief Method AdjustByteCounts, addr 0x1395c60, size 0x24, virtual false, abstract: false, final false
  inline void AdjustByteCounts();

  /// @brief Method BlockUpdate, addr 0x1395ae4, size 0x110, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Ch, addr 0x139630c, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Ch(uint64_t x, uint64_t y, uint64_t z);

  /// @brief Method Copy, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x1395960, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Finish, addr 0x1395bf4, size 0x6c, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method GetByteLength, addr 0x1396340, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline int32_t GetDigestSize();

  /// @brief Method Maj, addr 0x139632c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x1395ce4, size 0x58c, virtual false, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x1395c84, size 0x60, virtual false, abstract: false, final false
  inline void ProcessLength(int64_t lowW, int64_t hiW);

  /// @brief Method ProcessWord, addr 0x1395a70, size 0x74, virtual false, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Reset, addr 0x1396270, size 0x6c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method Sigma0, addr 0x13962ec, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Sigma0(uint64_t x);

  /// @brief Method Sigma1, addr 0x13962dc, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Sigma1(uint64_t x);

  /// @brief Method Sum0, addr 0x139631c, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Sum0(uint64_t x);

  /// @brief Method Sum1, addr 0x13962fc, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Sum1(uint64_t x);

  /// @brief Method Update, addr 0x13959fc, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1395814, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13958b4, size 0xac, virtual false, abstract: false, final false
