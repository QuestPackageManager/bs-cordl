...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ShortenedDigest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ShortenedDigest(ShortenedDigest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ShortenedDigest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ShortenedDigest(ShortenedDigestconst&) = delete;
