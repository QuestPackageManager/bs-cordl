...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x32c7158, size 0xd0, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method DoFinal, addr 0x32c7228, size 0x17c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x32c744c, size 0xa8, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x32c7098, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x32c73a4, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x32c70a0, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32c6d6c, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* baseDigest, int32_t length);

  /// @brief Method get_AlgorithmName, addr 0x32c6eac, size 0x1ec, virtual true, abstract: false, final true
