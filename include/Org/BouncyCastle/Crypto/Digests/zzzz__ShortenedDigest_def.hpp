...
public:
  ...
  /// @brief Method BlockUpdate, addr 0xf17b50, size 0xc4, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method DoFinal, addr 0xf17c14, size 0x174, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0xf17e2c, size 0xa4, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0xf17a9c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0xf17d88, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0xf17aa4, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf1775c, size 0x150, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* baseDigest, int32_t length);

  /// @brief Method get_AlgorithmName, addr 0xf178ac, size 0x1f0, virtual true, abstract: false, final true
