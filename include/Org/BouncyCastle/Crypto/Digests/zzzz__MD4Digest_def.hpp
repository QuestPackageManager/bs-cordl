...
public:
  ...
  /// @brief Method Copy, addr 0x2666e4c, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x266649c, size 0x5c, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::MD4Digest* t);

  /// @brief Method DoFinal, addr 0x26666e8, size 0x80, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method F, addr 0x26667d4, size 0x10, virtual false, abstract: false, final false
  inline int32_t F(int32_t u, int32_t v, int32_t w);

  /// @brief Method G, addr 0x26667e4, size 0x14, virtual false, abstract: false, final false
  inline int32_t G(int32_t u, int32_t v, int32_t w);

  /// @brief Method GetDigestSize, addr 0x2666538, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method H, addr 0x26667f8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x2666804, size 0x648, virtual true, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x26665fc, size 0x6c, virtual true, abstract: false, final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method ProcessWord, addr 0x2666540, size 0xbc, virtual true, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Reset, addr 0x2666768, size 0x60, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x2666ea4, size 0x84, virtual true, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method RotateLeft, addr 0x26667c8, size 0xc, virtual false, abstract: false, final false
  inline int32_t RotateLeft(int32_t x, int32_t n);

  /// @brief Method UnpackWord, addr 0x2666668, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26663bc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2666428, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::MD4Digest* t);

  /// @brief Method get_AlgorithmName, addr 0x26664f8, size 0x40, virtual true, abstract: false, final false
