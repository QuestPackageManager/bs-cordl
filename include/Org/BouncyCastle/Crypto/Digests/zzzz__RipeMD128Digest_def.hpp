...
public:
  ...
  /// @brief Method Copy, addr 0x12c293c, size 0x60, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x12c15b8, size 0x5c, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::RipeMD128Digest* t);

  /// @brief Method DoFinal, addr 0x12c1804, size 0x80, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method F1, addr 0x12c1928, size 0x1c, virtual false, abstract: false, final false
  inline int32_t F1(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s);

  /// @brief Method F1, addr 0x12c18f0, size 0xc, virtual false, abstract: false, final false
  inline int32_t F1(int32_t x, int32_t y, int32_t z);

  /// @brief Method F2, addr 0x12c1944, size 0x2c, virtual false, abstract: false, final false
  inline int32_t F2(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s);

  /// @brief Method F2, addr 0x12c18fc, size 0x10, virtual false, abstract: false, final false
  inline int32_t F2(int32_t x, int32_t y, int32_t z);

  /// @brief Method F3, addr 0x12c1970, size 0x28, virtual false, abstract: false, final false
  inline int32_t F3(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s);

  /// @brief Method F3, addr 0x12c190c, size 0xc, virtual false, abstract: false, final false
  inline int32_t F3(int32_t x, int32_t y, int32_t z);

  /// @brief Method F4, addr 0x12c1998, size 0x2c, virtual false, abstract: false, final false
  inline int32_t F4(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s);

  /// @brief Method F4, addr 0x12c1918, size 0x10, virtual false, abstract: false, final false
  inline int32_t F4(int32_t x, int32_t y, int32_t z);

  /// @brief Method FF1, addr 0x12c19c4, size 0x1c, virtual false, abstract: false, final false
  inline int32_t FF1(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s);

  /// @brief Method FF2, addr 0x12c19e0, size 0x2c, virtual false, abstract: false, final false
  inline int32_t FF2(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s);

  /// @brief Method FF3, addr 0x12c1a0c, size 0x28, virtual false, abstract: false, final false
  inline int32_t FF3(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s);

  /// @brief Method FF4, addr 0x12c1a34, size 0x2c, virtual false, abstract: false, final false
  inline int32_t FF4(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s);

  /// @brief Method GetDigestSize, addr 0x12c1654, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x12c1a60, size 0xedc, virtual true, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x12c1718, size 0x6c, virtual true, abstract: false, final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method ProcessWord, addr 0x12c165c, size 0xbc, virtual true, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method RL, addr 0x12c18e4, size 0xc, virtual false, abstract: false, final false
  inline int32_t RL(int32_t x, int32_t n);

  /// @brief Method Reset, addr 0x12c1884, size 0x60, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x12c299c, size 0x84, virtual true, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method UnpackWord, addr 0x12c1784, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c14d8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12c1544, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::RipeMD128Digest* t);

  /// @brief Method get_AlgorithmName, addr 0x12c1614, size 0x40, virtual true, abstract: false, final false
