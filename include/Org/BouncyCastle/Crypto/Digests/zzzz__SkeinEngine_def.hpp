...
/// @brief Method .ctor, addr 0x328ca90, size 0x140, virtual false, abstract: false, final false
inline void _ctor(int64_t  outputSizeBits) ;

/// @brief Method get_Bytes, addr 0x328d064, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x328ca34, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method get_Type, addr 0x328d06c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Type() ;

/// @brief Method get_Value, addr 0x328d074, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AdvancePosition, addr 0x328d314, size 0x174, virtual false, abstract: false, final false
inline void AdvancePosition(int32_t  advance) ;

/// @brief Method GetWords, addr 0x328d488, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x328d0d8, size 0x3c, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x328d114, size 0x8c, virtual false, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Crypto::Digests::SkeinEngine_UbiTweak*  tweak) ;

/// @brief Method ToString, addr 0x328d490, size 0x1ec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x328d07c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Final, addr 0x328d290, size 0x30, virtual false, abstract: false, final false
inline bool get_Final() ;

/// @brief Method get_First, addr 0x328d260, size 0x30, virtual false, abstract: false, final false
inline bool get_First() ;

/// @brief Method get_Type, addr 0x328d1f4, size 0x30, virtual false, abstract: false, final false
inline uint32_t get_Type() ;

/// @brief Method set_Final, addr 0x328d2c0, size 0x54, virtual false, abstract: false, final false
inline void set_Final(bool  value) ;

/// @brief Method set_First, addr 0x328d1a0, size 0x54, virtual false, abstract: false, final false
inline void set_First(bool  value) ;

/// @brief Method set_Type, addr 0x328d224, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method DoFinal, addr 0x328cd5c, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x328d67c, size 0x16c, virtual false, abstract: false, final false
inline void ProcessBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  output) ;

/// @brief Method Reset, addr 0x328cd1c, size 0x40, virtual false, abstract: false, final false
inline void Reset(int32_t  type) ;

/// @brief Method Reset, addr 0x328bf40, size 0xb0, virtual false, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Crypto::Digests::SkeinEngine_UBI*  ubi) ;

/// @brief Method Update, addr 0x328cbd0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x328bd54, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method CheckInitialised, addr 0x328cdcc, size 0x58, virtual false, abstract: false, final false
inline void CheckInitialised() ;

/// @brief Method Clone, addr 0x328bff0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method Copy, addr 0x328c0a0, size 0x5c, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x328be24, size 0x11c, virtual false, abstract: false, final false
inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::SkeinEngine*  engine) ;

/// @brief Method CreateInitialState, addr 0x328c77c, size 0x2a4, virtual false, abstract: false, final false
inline void CreateInitialState() ;

/// @brief Method DoFinal, addr 0x328b77c, size 0x1a8, virtual false, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method Init, addr 0x328b5b8, size 0xb4, virtual false, abstract: false, final false
inline void Init(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters*  parameters) ;

/// @brief Method InitParams, addr 0x328c104, size 0x678, virtual false, abstract: false, final false
inline void InitParams(::System::Collections::IDictionary*  parameters) ;

/// @brief Method InitialState, addr 0x328bc18, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method Output, addr 0x328ce24, size 0x240, virtual false, abstract: false, final false
inline void Output(uint64_t  outputSequence, ::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff, int32_t  outputBytes) ;

/// @brief Method Reset, addr 0x328b680, size 0x40, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x328b21c, size 0x12c, virtual true, abstract: false, final true
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method UbiComplete, addr 0x328ca40, size 0x50, virtual false, abstract: false, final false
inline void UbiComplete(int32_t  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method UbiFinal, addr 0x328cd00, size 0x1c, virtual false, abstract: false, final false
inline void UbiFinal() ;

/// @brief Method UbiInit, addr 0x328ca20, size 0x14, virtual false, abstract: false, final false
inline void UbiInit(int32_t  type) ;

/// @brief Method Update, addr 0x328b6d4, size 0x34, virtual false, abstract: false, final false
inline void Update(uint8_t  inByte) ;

/// @brief Method Update, addr 0x328b71c, size 0x4c, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  len) ;

/// @brief Method VariantIdentifier, addr 0x328bd4c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x328af30, size 0x174, virtual false, abstract: false, final false
inline void _ctor(int32_t  blockSizeBits, int32_t  outputSizeBits) ;

/// @brief Method .ctor, addr 0x328b12c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_BlockSize, addr 0x328b554, size 0x20, virtual false, abstract: false, final false
inline int32_t get_BlockSize() ;

/// @brief Method get_OutputSize, addr 0x328c0fc, size 0x8, virtual false, abstract: false, final false
