...
public:
  ...
  /// @brief Method .ctor, addr 0x23357ac, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(int64_t outputSizeBits);

  /// @brief Method get_Bytes, addr 0x2335d58, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x233572c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_Type, addr 0x2335d60, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x2335d68, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AdvancePosition, addr 0x2335fe4, size 0x160, virtual false, abstract: false, final false
  inline void AdvancePosition(int32_t advance);

  /// @brief Method GetWords, addr 0x2336144, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x2335dd0, size 0x3c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x2335e0c, size 0x88, virtual false, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Crypto::Digests::SkeinEngine_UbiTweak* tweak);

  /// @brief Method ToString, addr 0x233614c, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2335d70, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Final, addr 0x2335f74, size 0x30, virtual false, abstract: false, final false
  inline bool get_Final();

  /// @brief Method get_First, addr 0x2335f44, size 0x30, virtual false, abstract: false, final false
  inline bool get_First();

  /// @brief Method get_Type, addr 0x2335ed8, size 0x30, virtual false, abstract: false, final false
  inline uint32_t get_Type();

  /// @brief Method set_Final, addr 0x2335fa4, size 0x40, virtual false, abstract: false, final false
  inline void set_Final(bool value);

  /// @brief Method set_First, addr 0x2335e94, size 0x44, virtual false, abstract: false, final false
  inline void set_First(bool value);

  /// @brief Method set_Type, addr 0x2335f08, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DoFinal, addr 0x2335a7c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x2336354, size 0x170, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> output);

  /// @brief Method Reset, addr 0x2335a3c, size 0x40, virtual false, abstract: false, final false
  inline void Reset(int32_t type);

  /// @brief Method Reset, addr 0x2334c3c, size 0xac, virtual false, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Crypto::Digests::SkeinEngine_UBI* ubi);

  /// @brief Method Update, addr 0x23358f4, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2334a5c, size 0xdc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckInitialised, addr 0x2335aec, size 0x5c, virtual false, abstract: false, final false
  inline void CheckInitialised();

  /// @brief Method Clone, addr 0x2334ce8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x2334d88, size 0x58, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x2334b38, size 0x104, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::SkeinEngine* engine);

  /// @brief Method CreateInitialState, addr 0x233545c, size 0x2b8, virtual false, abstract: false, final false
  inline void CreateInitialState();

  /// @brief Method DoFinal, addr 0x233446c, size 0x1c4, virtual false, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method Init, addr 0x2334298, size 0xb4, virtual false, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters* parameters);

  /// @brief Method InitParams, addr 0x2334de8, size 0x674, virtual false, abstract: false, final false
  inline void InitParams(::System::Collections::IDictionary* parameters);

  /// @brief Method InitialState, addr 0x2334914, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Output, addr 0x2335b48, size 0x210, virtual false, abstract: false, final false
  inline void Output(uint64_t outputSequence, ::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff, int32_t outputBytes);

  /// @brief Method Reset, addr 0x2334364, size 0x40, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x2333ef0, size 0x120, virtual true, abstract: false, final true
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method UbiComplete, addr 0x233575c, size 0x50, virtual false, abstract: false, final false
  inline void UbiComplete(int32_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method UbiFinal, addr 0x2335a1c, size 0x20, virtual false, abstract: false, final false
  inline void UbiFinal();

  /// @brief Method UbiInit, addr 0x2335714, size 0x18, virtual false, abstract: false, final false
  inline void UbiInit(int32_t type);

  /// @brief Method Update, addr 0x23343bc, size 0x34, virtual false, abstract: false, final false
  inline void Update(uint8_t inByte);

  /// @brief Method Update, addr 0x2334408, size 0x4c, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t len);

  /// @brief Method VariantIdentifier, addr 0x2334a54, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2333bfc, size 0x184, virtual false, abstract: false, final false
  inline void _ctor(int32_t blockSizeBits, int32_t outputSizeBits);

  /// @brief Method .ctor, addr 0x2333e0c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0x233422c, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_BlockSize();

  /// @brief Method get_OutputSize, addr 0x2334de0, size 0x8, virtual false, abstract: false, final false
