...
public:
  ...
  /// @brief Method .ctor addr 0xea7cd4 size 0x148 virtual false final false
  inline void _ctor(int64_t outputSizeBits);

  /// @brief Method get_Bytes addr 0xea8284 size 0x8 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xea7c54 size 0x30 virtual false final false
  inline void _ctor(int32_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_Type addr 0xea828c size 0x8 virtual false final false
  inline int32_t get_Type();

  /// @brief Method get_Value addr 0xea8294 size 0x8 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xea829c size 0x60 virtual false final false
  inline void _ctor();

  /// @brief Method Reset addr 0xea8338 size 0x88 virtual false final false
  inline void Reset(::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__UbiTweak* tweak);

  /// @brief Method Reset addr 0xea82fc size 0x3c virtual false final false
  inline void Reset();

  /// @brief Method get_Type addr 0xea8400 size 0x30 virtual false final false
  inline uint32_t get_Type();

  /// @brief Method set_Type addr 0xea8430 size 0x3c virtual false final false
  inline void set_Type(uint32_t value);

  /// @brief Method get_First addr 0xea846c size 0x30 virtual false final false
  inline bool get_First();

  /// @brief Method set_First addr 0xea83c0 size 0x40 virtual false final false
  inline void set_First(bool value);

  /// @brief Method get_Final addr 0xea849c size 0x30 virtual false final false
  inline bool get_Final();

  /// @brief Method set_Final addr 0xea84cc size 0x40 virtual false final false
  inline void set_Final(bool value);

  /// @brief Method AdvancePosition addr 0xea850c size 0x160 virtual false final false
  inline void AdvancePosition(int32_t advance);

  /// @brief Method GetWords addr 0xea866c size 0x8 virtual false final false
  inline ::ArrayW<uint64_t, ::Array<uint64_t>*> GetWords();

  /// @brief Method ToString addr 0xea8674 size 0x208 virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0xea6f7c size 0xd8 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::SkeinEngine* engine, int32_t blockSize);

  /// @brief Method Reset addr 0xea7158 size 0xac virtual false final false
  inline void Reset(::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__UBI* ubi);

  /// @brief Method Reset addr 0xea7f64 size 0x40 virtual false final false
  inline void Reset(int32_t type);

  /// @brief Method Update addr 0xea7e1c size 0x128 virtual false final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> value, int32_t offset, int32_t len, ::ArrayW<uint64_t, ::Array<uint64_t>*> output);

  /// @brief Method ProcessBlock addr 0xea887c size 0x170 virtual false final false
  inline void ProcessBlock(::ArrayW<uint64_t, ::Array<uint64_t>*> output);

  /// @brief Method DoFinal addr 0xea7fa4 size 0x70 virtual false final false
...
public:
  ...
  /// @brief Method InitialState addr 0xea6e34 size 0x140 virtual false final false
  static inline void InitialState(int32_t blockSize, int32_t outputSize, ::ArrayW<uint64_t, ::Array<uint64_t>*> state);

  /// @brief Method VariantIdentifier addr 0xea6f74 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xea60f8 size 0x190 virtual false final false
  ...
  /// @brief Method .ctor addr 0xea6318 size 0x58 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::SkeinEngine* engine);

  /// @brief Method CopyIn addr 0xea7054 size 0x104 virtual false final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::SkeinEngine* engine);

  /// @brief Method Clone addr 0xea7204 size 0xa0 virtual false final false
  ...
  /// @brief Method Copy addr 0xea72a4 size 0x60 virtual true final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method Reset addr 0xea63fc size 0x124 virtual true final true
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method get_OutputSize addr 0xea7304 size 0x8 virtual false final false
  inline int32_t get_OutputSize();

  /// @brief Method get_BlockSize addr 0xea6744 size 0x24 virtual false final false
  inline int32_t get_BlockSize();

  /// @brief Method Init addr 0xea67b0 size 0xb8 virtual false final false
  inline void Init(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters* parameters);

  /// @brief Method InitParams addr 0xea730c size 0x678 virtual false final false
  inline void InitParams(::System::Collections::IDictionary* parameters);

  /// @brief Method CreateInitialState addr 0xea7984 size 0x2b8 virtual false final false
  inline void CreateInitialState();

  /// @brief Method Reset addr 0xea6880 size 0x40 virtual false final false
  inline void Reset();

  /// @brief Method UbiComplete addr 0xea7c84 size 0x50 virtual false final false
  inline void UbiComplete(int32_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method UbiInit addr 0xea7c3c size 0x18 virtual false final false
  inline void UbiInit(int32_t type);

  /// @brief Method UbiFinal addr 0xea7f44 size 0x20 virtual false final false
  inline void UbiFinal();

  /// @brief Method CheckInitialised addr 0xea8014 size 0x60 virtual false final false
  inline void CheckInitialised();

  /// @brief Method Update addr 0xea68d8 size 0x34 virtual false final false
  inline void Update(uint8_t inByte);

  /// @brief Method Update addr 0xea6924 size 0x4c virtual false final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t len);

  /// @brief Method DoFinal addr 0xea6988 size 0x1c8 virtual false final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method Output addr 0xea8074 size 0x210 virtual false final false
