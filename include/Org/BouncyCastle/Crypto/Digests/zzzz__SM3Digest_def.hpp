...
public:
  ...
  /// @brief Method Copy, addr 0x1014d94, size 0x60, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x1014ce0, size 0x6c, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::SM3Digest* t);

  /// @brief Method DoFinal, addr 0x1014f54, size 0x54, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method FF0, addr 0x101512c, size 0xc, virtual false, abstract: false, final false
  inline uint32_t FF0(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method FF1, addr 0x1015138, size 0x14, virtual false, abstract: false, final false
  inline uint32_t FF1(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method GG0, addr 0x101514c, size 0xc, virtual false, abstract: false, final false
  inline uint32_t GG0(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method GG1, addr 0x1015158, size 0x10, virtual false, abstract: false, final false
  inline uint32_t GG1(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method GetDigestSize, addr 0x1014d8c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method P0, addr 0x1015114, size 0xc, virtual false, abstract: false, final false
  inline uint32_t P0(uint32_t x);

  /// @brief Method P1, addr 0x1015120, size 0xc, virtual false, abstract: false, final false
  inline uint32_t P1(uint32_t x);

  /// @brief Method ProcessBlock, addr 0x1015168, size 0x414, virtual true, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x101501c, size 0xf8, virtual true, abstract: false, final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method ProcessWord, addr 0x1014fa8, size 0x74, virtual true, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Reset, addr 0x1014e88, size 0xcc, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x1014df4, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1014bc0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1014c4c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::SM3Digest* t);

  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> getStaticF_T();

  /// @brief Method get_AlgorithmName, addr 0x1014d4c, size 0x40, virtual true, abstract: false, final false
