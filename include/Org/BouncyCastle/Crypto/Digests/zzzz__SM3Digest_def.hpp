...
public:
  ...
  /// @brief Method .ctor addr 0xe34904 size 0x8c virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Crypto::Digests::SM3Digest* New_ctor(::Org::BouncyCastle::Crypto::Digests::SM3Digest* t);

  /// @brief Method .ctor addr 0xe34990 size 0x94 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::SM3Digest* t);

  /// @brief Method CopyIn addr 0xe34a24 size 0x6c virtual false final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::SM3Digest* t);

  /// @brief Method get_AlgorithmName addr 0xe34a90 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method GetDigestSize addr 0xe34ad0 size 0x8 virtual true final false
  inline int32_t GetDigestSize();

  /// @brief Method Copy addr 0xe34ad8 size 0x60 virtual true final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method Reset addr 0xe34b38 size 0x94 virtual true final false
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method Reset addr 0xe34bcc size 0xcc virtual true final false
  inline void Reset();

  /// @brief Method DoFinal addr 0xe34c98 size 0x54 virtual true final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessWord addr 0xe34cec size 0x74 virtual true final false
  inline void ProcessWord(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method ProcessLength addr 0xe34d60 size 0xf8 virtual true final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method P0 addr 0xe34e58 size 0xc virtual false final false
  inline uint32_t P0(uint32_t x);

  /// @brief Method P1 addr 0xe34e64 size 0xc virtual false final false
  inline uint32_t P1(uint32_t x);

  /// @brief Method FF0 addr 0xe34e70 size 0xc virtual false final false
  inline uint32_t FF0(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method FF1 addr 0xe34e7c size 0x14 virtual false final false
  inline uint32_t FF1(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method GG0 addr 0xe34e90 size 0xc virtual false final false
  inline uint32_t GG0(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method GG1 addr 0xe34e9c size 0x10 virtual false final false
  inline uint32_t GG1(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method ProcessBlock addr 0xe34eac size 0x414 virtual true final false
