...
public:
  ...
  /// @brief Method Copy, addr 0x325f94c, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x325f6e8, size 0xfc, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetDigestSize, addr 0x325f6e0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x325f848, size 0x38, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x325f9a8, size 0x114, virtual true, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method UInt32_To_BE, addr 0x325f880, size 0xcc, virtual false, abstract: false, final false
  static inline void UInt32_To_BE(uint32_t n, ::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off, int32_t max);

  /// @brief Method UInt64_To_BE, addr 0x325f7e4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325f2fc, size 0x154, virtual false, abstract: false, final false
  inline void _ctor(int32_t bitLength);

  /// @brief Method .ctor, addr 0x325f5d4, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Sha512tDigest* t);

  /// @brief Method get_AlgorithmName, addr 0x325f668, size 0x78, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method tIvGenerate, addr 0x325f450, size 0x184, virtual false, abstract: false, final false
