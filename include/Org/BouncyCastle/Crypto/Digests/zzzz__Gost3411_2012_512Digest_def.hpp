...
public:
  ...
  /// @brief Method Copy, addr 0x35f31fc, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method GetDigestSize, addr 0x35f31f4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35f30b4, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35f3148, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x35f3070, size 0x44, virtual true, abstract: false, final false
