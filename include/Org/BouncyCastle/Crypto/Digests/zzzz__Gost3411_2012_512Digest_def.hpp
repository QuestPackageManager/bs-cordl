...
public:
  ...
  /// @brief Method Copy, addr 0x2697df4, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method GetDigestSize, addr 0x2697dec, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2697cbc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2697d48, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x2697c7c, size 0x40, virtual true, abstract: false, final false
