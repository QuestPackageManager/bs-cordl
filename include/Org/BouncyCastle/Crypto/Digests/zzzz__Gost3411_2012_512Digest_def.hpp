...
public:
  ...
  /// @brief Method Copy, addr 0x2699128, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method GetDigestSize, addr 0x2699120, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2698ff0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x269907c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x2698fb0, size 0x40, virtual true, abstract: false, final false
