...
public:
  ...
  /// @brief Method Copy, addr 0x35c89b8, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method GetDigestSize, addr 0x35c89b0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c8870, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35c8904, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x35c882c, size 0x44, virtual true, abstract: false, final false
