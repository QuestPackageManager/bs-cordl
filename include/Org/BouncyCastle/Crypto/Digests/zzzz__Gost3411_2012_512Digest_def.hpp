...
public:
  ...
  /// @brief Method Copy, addr 0x149864c, size 0x60, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method GetDigestSize, addr 0x1498644, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1498514, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x14985a0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x14984d4, size 0x40, virtual true, abstract: false, final false
