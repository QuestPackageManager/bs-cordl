...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x1491880, size 0x140, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> message, int32_t offset, int32_t len);

  /// @brief Method ClearKey, addr 0x1491dd4, size 0x48, virtual true, abstract: false, final false
  inline void ClearKey();

  /// @brief Method ClearSalt, addr 0x1491e1c, size 0x1c, virtual true, abstract: false, final false
  inline void ClearSalt();

  /// @brief Method Compress, addr 0x14912f4, size 0x58c, virtual false, abstract: false, final false
  inline void Compress(::ArrayW<uint8_t, ::Array<uint8_t>*> message, int32_t messagePos);

  /// @brief Method DoFinal, addr 0x14919c0, size 0x14c, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOffset);

  /// @brief Method G, addr 0x1491b74, size 0x208, virtual false, abstract: false, final false
  inline void G(uint64_t m1, uint64_t m2, int32_t posA, int32_t posB, int32_t posC, int32_t posD);

  /// @brief Method GetByteLength, addr 0x1491dcc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x1491dc4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method Init, addr 0x1490a7c, size 0x2ac, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InitializeInternalState, addr 0x14910f4, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x1491b0c, size 0x68, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Rotr64, addr 0x1491d7c, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Rotr64(uint64_t x, int32_t rot);

  /// @brief Method Update, addr 0x149123c, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1490824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1490948, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Blake2bDigest* digest);

  /// @brief Method .ctor, addr 0x149082c, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor(int32_t digestSize);

  /// @brief Method .ctor, addr 0x1490d28, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method .ctor, addr 0x1490e8c, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x1491d84, size 0x40, virtual true, abstract: false, final false
