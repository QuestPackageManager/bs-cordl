...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Digests::Blake2bDigest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Digests::Blake2bDigest*, "Org.BouncyCastle.Crypto.Digests", "Blake2bDigest");
...
public:
  ...
  __declspec(property(get = getStaticF_blake2b_IV, put = setStaticF_blake2b_IV)) ::ArrayW<uint64_t> blake2b_IV;
  ...
  __declspec(property(get = __cordl_internal_get_chainValue, put = __cordl_internal_set_chainValue)) ::ArrayW<uint64_t> chainValue;
  ...
  __declspec(property(get = __cordl_internal_get_internalState, put = __cordl_internal_set_internalState)) ::ArrayW<uint64_t> internalState;
  ...
  __declspec(property(get = __cordl_internal_get_personalization, put = __cordl_internal_set_personalization)) ::ArrayW<uint8_t> personalization;

  /// @brief Field salt, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_salt, put = __cordl_internal_set_salt)) ::ArrayW<uint8_t> salt;
  ...
  /// @brief Method BlockUpdate, addr 0x36e5c38, size 0x140, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> message, int32_t offset, int32_t len);

  /// @brief Method ClearKey, addr 0x36e6198, size 0x48, virtual true, abstract: false, final false
  inline void ClearKey();

  /// @brief Method ClearSalt, addr 0x36e61e0, size 0x1c, virtual true, abstract: false, final false
  inline void ClearSalt();

  /// @brief Method Compress, addr 0x36e5694, size 0x5a4, virtual false, abstract: false, final false
  inline void Compress(::ArrayW<uint8_t> message, int32_t messagePos);

  /// @brief Method DoFinal, addr 0x36e5d78, size 0x14c, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOffset);

  /// @brief Method G, addr 0x36e5f2c, size 0x210, virtual false, abstract: false, final false
  inline void G(uint64_t m1, uint64_t m2, int32_t posA, int32_t posB, int32_t posC, int32_t posD);

  /// @brief Method GetByteLength, addr 0x36e6190, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x36e6188, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method Init, addr 0x36e4dbc, size 0x320, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InitializeInternalState, addr 0x36e5490, size 0x14c, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Crypto::Digests::Blake2bDigest* New_ctor(::ArrayW<uint8_t> key);

  static inline ::Org::BouncyCastle::Crypto::Digests::Blake2bDigest* New_ctor(::ArrayW<uint8_t> key, int32_t digestLength, ::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> personalization);

  /// @brief Method Reset, addr 0x36e5ec4, size 0x68, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Rotr64, addr 0x36e613c, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Rotr64(uint64_t x, int32_t rot);

  /// @brief Method Update, addr 0x36e55dc, size 0xb8, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint64_t> const& __cordl_internal_get_chainValue() const;

  constexpr ::ArrayW<uint64_t>& __cordl_internal_get_chainValue();
  ...
  constexpr ::ArrayW<uint64_t> const& __cordl_internal_get_internalState() const;

  constexpr ::ArrayW<uint64_t>& __cordl_internal_get_internalState();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_personalization() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_personalization();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_salt() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_salt();
  ...
  /// @brief Method .ctor, addr 0x36e4b68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36e4c84, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Blake2bDigest* digest);

  /// @brief Method .ctor, addr 0x36e4b70, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(int32_t digestSize);

  /// @brief Method .ctor, addr 0x36e50dc, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> key);

  /// @brief Method .ctor, addr 0x36e5238, size 0x258, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> key, int32_t digestLength, ::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> personalization);

  static inline ::ArrayW<uint64_t> getStaticF_blake2b_IV();

  static inline ::System::Object* getStaticF_blake2b_sigma();

  /// @brief Method get_AlgorithmName, addr 0x36e6144, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IDigest"
  constexpr ::Org::BouncyCastle::Crypto::IDigest* i___Org__BouncyCastle__Crypto__IDigest() noexcept;

  static inline void setStaticF_blake2b_IV(::ArrayW<uint64_t> value);
...
public:
  ...
  ::ArrayW<uint64_t> ___internalState;

  /// @brief Field chainValue, offset: 0x48, size: 0x8, def value: None
  ::ArrayW<uint64_t> ___chainValue;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Digests::Blake2bDigest) == 0x68, "Size mismatch!");
