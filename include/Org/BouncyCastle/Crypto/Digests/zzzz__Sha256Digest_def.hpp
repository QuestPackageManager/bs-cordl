...
public:
  ...
  /// @brief Method Copy, addr 0x110290c, size 0x60, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x1102078, size 0x64, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::Sha256Digest* t);

  /// @brief Method DoFinal, addr 0x1102210, size 0xe0, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetDigestSize, addr 0x110211c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x110233c, size 0x56c, virtual true, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x11021a4, size 0x6c, virtual true, abstract: false, final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method ProcessWord, addr 0x1102124, size 0x80, virtual true, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Reset, addr 0x11022f0, size 0x4c, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x110296c, size 0x84, virtual true, abstract: false, final false
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method Sum0Maj, addr 0x11028e8, size 0x24, virtual false, abstract: false, final false
  static inline uint32_t Sum0Maj(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method Sum1Ch, addr 0x11028c8, size 0x20, virtual false, abstract: false, final false
  static inline uint32_t Sum1Ch(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method Theta0, addr 0x11028b8, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t Theta0(uint32_t x);

  /// @brief Method Theta1, addr 0x11028a8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1101f74, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1102004, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x11020dc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method initHs, addr 0x1101fe8, size 0x1c, virtual false, abstract: false, final false
  inline void initHs();
