...
/// @brief Method Copy, addr 0x3288e64, size 0x5c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x3288648, size 0x64, virtual false, abstract: false, final false
inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::Sha256Digest*  t) ;

/// @brief Method DoFinal, addr 0x32887e4, size 0xe0, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetDigestSize, addr 0x32886f0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x3288910, size 0x4f0, virtual true, abstract: false, final false
inline void ProcessBlock() ;

/// @brief Method ProcessLength, addr 0x3288778, size 0x6c, virtual true, abstract: false, final false
inline void ProcessLength(int64_t  bitLength) ;

/// @brief Method ProcessWord, addr 0x32886f8, size 0x80, virtual true, abstract: false, final false
inline void ProcessWord(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method Reset, addr 0x32888c4, size 0x4c, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x3288ec0, size 0x90, virtual true, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method Sum0Maj, addr 0x3288e40, size 0x24, virtual false, abstract: false, final false
static inline uint32_t Sum0Maj(uint32_t  x, uint32_t  y, uint32_t  z) ;

/// @brief Method Sum1Ch, addr 0x3288e20, size 0x20, virtual false, abstract: false, final false
static inline uint32_t Sum1Ch(uint32_t  x, uint32_t  y, uint32_t  z) ;

/// @brief Method Theta0, addr 0x3288e10, size 0x10, virtual false, abstract: false, final false
static inline uint32_t Theta0(uint32_t  x) ;

/// @brief Method Theta1, addr 0x3288e00, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x328853c, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x32885d0, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x32886ac, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method initHs, addr 0x32885b4, size 0x1c, virtual false, abstract: false, final false
inline void initHs() ;
