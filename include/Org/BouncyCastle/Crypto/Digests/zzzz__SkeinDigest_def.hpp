...
/// @brief Method BlockUpdate, addr 0x328b708, size 0x14, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  len) ;

/// @brief Method Copy, addr 0x328b348, size 0x5c, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method DoFinal, addr 0x328b768, size 0x14, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method GetByteLength, addr 0x328b58c, size 0x2c, virtual true, abstract: false, final true
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x328b574, size 0x18, virtual true, abstract: false, final true
inline int32_t GetDigestSize() ;

/// @brief Method Init, addr 0x328b0a4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x328b66c, size 0x14, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method Reset, addr 0x328b184, size 0x98, virtual true, abstract: false, final true
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method Update, addr 0x328b6c0, size 0x14, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x328b0b8, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Digests::SkeinDigest*  digest) ;

/// @brief Method .ctor, addr 0x328aeb0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(int32_t  stateSizeBits, int32_t  digestSizeBits) ;

/// @brief Method get_AlgorithmName, addr 0x328b3a4, size 0x1b0, virtual true, abstract: false, final true
