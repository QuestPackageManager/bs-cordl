...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Digests::TigerDigest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Digests::TigerDigest*, "Org.BouncyCastle.Crypto.Digests", "TigerDigest");
...
public:
  ...
  __declspec(property(get = getStaticF_t1, put = setStaticF_t1)) ::ArrayW<int64_t> t1;

  /// @brief Field t2, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_t2, put = setStaticF_t2)) ::ArrayW<int64_t> t2;

  /// @brief Field t3, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_t3, put = setStaticF_t3)) ::ArrayW<int64_t> t3;

  /// @brief Field t4, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_t4, put = setStaticF_t4)) ::ArrayW<int64_t> t4;

  /// @brief Field x, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get_x, put = __cordl_internal_set_x)) ::ArrayW<int64_t> x;
  ...
  /// @brief Method BlockUpdate, addr 0x33883e8, size 0x104, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method Copy, addr 0x3388c0c, size 0x5c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x3388bac, size 0x60, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Finish, addr 0x3388b64, size 0x48, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method GetByteLength, addr 0x3387e70, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x3387e68, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetDigestSize();

  /// @brief Method KeySchedule, addr 0x338897c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x3387f94, size 0x3e4, virtual false, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x3388b38, size 0x2c, virtual false, abstract: false, final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method ProcessWord, addr 0x3387e78, size 0x11c, virtual false, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t> b, int32_t off);

  /// @brief Method Reset, addr 0x3387bf4, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Reset, addr 0x3387d30, size 0xf4, virtual true, abstract: false, final true
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method RoundABC, addr 0x33884ec, size 0x188, virtual false, abstract: false, final false
  inline void RoundABC(int64_t x, int64_t mul);

  /// @brief Method RoundBCA, addr 0x3388674, size 0x184, virtual false, abstract: false, final false
  inline void RoundBCA(int64_t x, int64_t mul);

  /// @brief Method RoundCAB, addr 0x33887f8, size 0x184, virtual false, abstract: false, final false
  inline void RoundCAB(int64_t x, int64_t mul);

  /// @brief Method UnpackWord, addr 0x3388a48, size 0xf0, virtual false, abstract: false, final false
  inline void UnpackWord(int64_t r, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Update, addr 0x3388378, size 0x70, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<int64_t> const& __cordl_internal_get_x() const;

  constexpr ::ArrayW<int64_t>& __cordl_internal_get_x();
  ...
  constexpr void __cordl_internal_set_x(::ArrayW<int64_t> value);

  constexpr void __cordl_internal_set_xOff(int32_t value);

  /// @brief Method .ctor, addr 0x3387b6c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3387c98, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::TigerDigest* t);

  static inline ::ArrayW<int64_t> getStaticF_t1();

  static inline ::ArrayW<int64_t> getStaticF_t2();

  static inline ::ArrayW<int64_t> getStaticF_t3();

  static inline ::ArrayW<int64_t> getStaticF_t4();

  /// @brief Method get_AlgorithmName, addr 0x3387e24, size 0x44, virtual true, abstract: false, final true
  ...
  static inline void setStaticF_t1(::ArrayW<int64_t> value);

  static inline void setStaticF_t2(::ArrayW<int64_t> value);

  static inline void setStaticF_t3(::ArrayW<int64_t> value);

  static inline void setStaticF_t4(::ArrayW<int64_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Digests::TigerDigest) == 0x50, "Size mismatch!");
