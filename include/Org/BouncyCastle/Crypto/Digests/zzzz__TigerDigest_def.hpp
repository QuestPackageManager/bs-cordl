...
public:
  ...
  /// @brief Method .ctor addr 0xe352c0 size 0x8c virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Crypto::Digests::TigerDigest* New_ctor(::Org::BouncyCastle::Crypto::Digests::TigerDigest* t);

  /// @brief Method .ctor addr 0xe353f0 size 0x94 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::TigerDigest* t);

  /// @brief Method get_AlgorithmName addr 0xe3556c size 0x40 virtual true final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method GetDigestSize addr 0xe355ac size 0x8 virtual true final true
  inline int32_t GetDigestSize();

  /// @brief Method GetByteLength addr 0xe355b4 size 0x8 virtual true final true
  inline int32_t GetByteLength();

  /// @brief Method ProcessWord addr 0xe355bc size 0x11c virtual false final false
  inline void ProcessWord(::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t off);

  /// @brief Method Update addr 0xe35abc size 0x70 virtual true final true
  inline void Update(uint8_t input);

  /// @brief Method BlockUpdate addr 0xe35b2c size 0x110 virtual true final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method RoundABC addr 0xe35c3c size 0x184 virtual false final false
  inline void RoundABC(int64_t x, int64_t mul);

  /// @brief Method RoundBCA addr 0xe35dc0 size 0x180 virtual false final false
  inline void RoundBCA(int64_t x, int64_t mul);

  /// @brief Method RoundCAB addr 0xe35f40 size 0x180 virtual false final false
  inline void RoundCAB(int64_t x, int64_t mul);

  /// @brief Method KeySchedule addr 0xe360c0 size 0xdc virtual false final false
  inline void KeySchedule();

  /// @brief Method ProcessBlock addr 0xe356d8 size 0x3e4 virtual false final false
  inline void ProcessBlock();

  /// @brief Method UnpackWord addr 0xe3619c size 0xf0 virtual false final false
  inline void UnpackWord(int64_t r, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessLength addr 0xe3628c size 0x2c virtual false final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method Finish addr 0xe362b8 size 0x4c virtual false final false
  inline void Finish();

  /// @brief Method DoFinal addr 0xe36304 size 0x60 virtual true final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xe3534c size 0xa4 virtual true final true
  inline void Reset();

  /// @brief Method Copy addr 0xe36364 size 0x60 virtual true final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method Reset addr 0xe35484 size 0xe8 virtual true final true
