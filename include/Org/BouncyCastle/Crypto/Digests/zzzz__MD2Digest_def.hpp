...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x269a438, size 0x11c, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Copy, addr 0x269a554, size 0x58, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x2699f74, size 0x9c, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::MD2Digest* t);

  /// @brief Method DoFinal, addr 0x269a060, size 0xb8, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x269a058, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x269a050, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x269a23c, size 0x194, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> m);

  /// @brief Method ProcessChecksum, addr 0x269a118, size 0x124, virtual false, abstract: false, final false
  inline void ProcessChecksum(::ArrayW<uint8_t, ::Array<uint8_t>*> m);

  /// @brief Method Reset, addr 0x2699e2c, size 0xb8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Reset, addr 0x269a5ac, size 0x84, virtual true, abstract: false, final true
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method Update, addr 0x269a3d0, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2699dac, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2699ee4, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::MD2Digest* t);

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_S();

  /// @brief Method get_AlgorithmName, addr 0x269a010, size 0x40, virtual true, abstract: false, final true
