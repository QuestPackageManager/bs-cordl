...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeccakDigest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeccakDigest(KeccakDigest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeccakDigest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeccakDigest(KeccakDigestconst&) = delete;
