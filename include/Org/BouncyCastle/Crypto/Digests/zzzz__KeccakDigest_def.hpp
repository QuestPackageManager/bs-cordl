...
/// @brief Method Absorb, addr 0x35f35dc, size 0x16c, virtual false, abstract: false, final false
inline void Absorb(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  off, int32_t  len) ;

/// @brief Method Absorb, addr 0x35f34fc, size 0xdc, virtual false, abstract: false, final false
inline void Absorb(uint8_t  data) ;

/// @brief Method AbsorbBits, addr 0x35f393c, size 0x124, virtual false, abstract: false, final false
inline void AbsorbBits(int32_t  data, int32_t  bits) ;

/// @brief Method BlockUpdate, addr 0x35f35d8, size 0x4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method Copy, addr 0x35f44a8, size 0x5c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x35f33fc, size 0x7c, virtual false, abstract: false, final false
inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::KeccakDigest*  source) ;

/// @brief Method DoFinal, addr 0x35f3748, size 0x3c, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method DoFinal, addr 0x35f38cc, size 0x70, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, uint8_t  partialByte, int32_t  partialBits) ;

/// @brief Method GetByteLength, addr 0x35f3a68, size 0xc, virtual true, abstract: false, final false
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x35f34ec, size 0xc, virtual true, abstract: false, final false
inline int32_t GetDigestSize() ;

/// @brief Method Init, addr 0x35f32b8, size 0xac, virtual false, abstract: false, final false
inline void Init(int32_t  bitLength) ;

/// @brief Method InitSponge, addr 0x35f3a74, size 0x104, virtual false, abstract: false, final false
inline void InitSponge(int32_t  rate) ;

/// @brief Method KeccakAbsorb, addr 0x35f3b78, size 0xc0, virtual false, abstract: false, final false
inline void KeccakAbsorb(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  off) ;

/// @brief Method KeccakExtract, addr 0x35f3e28, size 0x38, virtual false, abstract: false, final false
inline void KeccakExtract() ;

/// @brief Method KeccakPermutation, addr 0x35f3e60, size 0x648, virtual false, abstract: false, final false
...
/// @brief Method PadAndSwitchToSqueezingPhase, addr 0x35f3c38, size 0x1f0, virtual false, abstract: false, final false
inline void PadAndSwitchToSqueezingPhase() ;

/// @brief Method Reset, addr 0x35f3a60, size 0x8, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x35f4504, size 0x90, virtual true, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method Squeeze, addr 0x35f3784, size 0x148, virtual false, abstract: false, final false
inline void Squeeze(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  offset, int64_t  outputLength) ;

/// @brief Method Update, addr 0x35f34f8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35f3218, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x35f3220, size 0x98, virtual false, abstract: false, final false
inline void _ctor(int32_t  bitLength) ;

/// @brief Method .ctor, addr 0x35f3364, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x35f3478, size 0x74, virtual true, abstract: false, final false
