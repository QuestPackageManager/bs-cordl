...
public:
  ...
  /// @brief Method CheckBitLength, addr 0x2331a84, size 0xc0, virtual false, abstract: false, final false
  static inline int32_t CheckBitLength(int32_t bitLength);

  /// @brief Method Copy, addr 0x2331dcc, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x2331ca8, size 0x40, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method DoFinal, addr 0x2331ce8, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2331b44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2331b4c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(int32_t bitLength);

  /// @brief Method .ctor, addr 0x2331bbc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Sha3Digest* source);

  /// @brief Method get_AlgorithmName, addr 0x2331c24, size 0x84, virtual true, abstract: false, final false
