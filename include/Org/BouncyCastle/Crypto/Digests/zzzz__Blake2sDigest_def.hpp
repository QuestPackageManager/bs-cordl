...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x265e614, size 0x140, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> message, int32_t offset, int32_t len);

  /// @brief Method ClearKey, addr 0x265ea0c, size 0x48, virtual true, abstract: false, final false
  inline void ClearKey();

  /// @brief Method ClearSalt, addr 0x265ea54, size 0x1c, virtual true, abstract: false, final false
  inline void ClearSalt();

  /// @brief Method Compress, addr 0x265e088, size 0x58c, virtual false, abstract: false, final false
  inline void Compress(::ArrayW<uint8_t, ::Array<uint8_t>*> message, int32_t messagePos);

  /// @brief Method DoFinal, addr 0x265e754, size 0x130, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOffset);

  /// @brief Method G, addr 0x265e8e8, size 0xcc, virtual false, abstract: false, final false
  inline void G(uint32_t m1, uint32_t m2, int32_t posA, int32_t posB, int32_t posC, int32_t posD);

  /// @brief Method GetByteLength, addr 0x265ea04, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x265e9fc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method Init, addr 0x265d854, size 0x290, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InitializeInternalState, addr 0x265de94, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x265e884, size 0x64, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x265dfd0, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265d628, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x265d744, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Blake2sDigest* digest);

  /// @brief Method .ctor, addr 0x265d630, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(int32_t digestBits);

  /// @brief Method .ctor, addr 0x265dae4, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method .ctor, addr 0x265dc40, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x265e9bc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_AlgorithmName();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IDigest"
  constexpr ::Org::BouncyCastle::Crypto::IDigest* i___Org__BouncyCastle__Crypto__IDigest() noexcept;

  /// @brief Method rotr32, addr 0x265e9b4, size 0x8, virtual false, abstract: false, final false
