...
public:
  ...
  /// @brief Method .ctor addr 0x11ad978 size 0x8 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x11ada98 size 0x110 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11ad980 size 0x118 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11ade38 size 0x160 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11adf98 size 0x264 virtual false final false
  ...
  /// @brief Method Init addr 0x11adba8 size 0x290 virtual false final false
  inline void Init();

  /// @brief Method InitializeInternalState addr 0x11ae1fc size 0x13c virtual false final false
  inline void InitializeInternalState();

  /// @brief Method Update addr 0x11ae338 size 0xb8 virtual true final false
  inline void Update(uint8_t b);

  /// @brief Method BlockUpdate addr 0x11ae97c size 0x140 virtual true final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> message, int32_t offset, int32_t len);

  /// @brief Method DoFinal addr 0x11aeabc size 0x130 virtual true final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOffset);

  /// @brief Method Reset addr 0x11aebec size 0x64 virtual true final false
  inline void Reset();

  /// @brief Method Compress addr 0x11ae3f0 size 0x58c virtual false final false
  inline void Compress(::ArrayW<uint8_t, ::Array<uint8_t>*> message, int32_t messagePos);

  /// @brief Method G addr 0x11aec50 size 0xcc virtual false final false
  inline void G(uint32_t m1, uint32_t m2, int32_t posA, int32_t posB, int32_t posC, int32_t posD);

  /// @brief Method rotr32 addr 0x11aed1c size 0x8 virtual false final false
  inline uint32_t rotr32(uint32_t x, int32_t rot);

  /// @brief Method get_AlgorithmName addr 0x11aed24 size 0x40 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method GetDigestSize addr 0x11aed64 size 0x8 virtual true final false
  inline int32_t GetDigestSize();

  /// @brief Method GetByteLength addr 0x11aed6c size 0x8 virtual true final false
  inline int32_t GetByteLength();

  /// @brief Method ClearKey addr 0x11aed74 size 0x48 virtual true final false
  inline void ClearKey();

  /// @brief Method ClearSalt addr 0x11aedbc size 0x1c virtual true final false
