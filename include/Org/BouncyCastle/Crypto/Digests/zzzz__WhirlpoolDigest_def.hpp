...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x23390d4, size 0x6c, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Copy, addr 0x23391f0, size 0x58, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x233847c, size 0xc4, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x23391e8, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x2338474, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x233866c, size 0xbc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Reset, addr 0x23382cc, size 0x168, virtual true, abstract: false, final true
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method Update, addr 0x2338f8c, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2337f0c, size 0x2b0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23381bc, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::WhirlpoolDigest* originalDigest);

  /// @brief Method bytesToLongFromBuffer, addr 0x2338808, size 0xd4, virtual false, abstract: false, final false
  static inline int64_t bytesToLongFromBuffer(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t startPos);

  /// @brief Method convertLongToByteArray, addr 0x2338618, size 0x54, virtual false, abstract: false, final false
  static inline void convertLongToByteArray(int64_t inputLong, ::ArrayW<uint8_t, ::Array<uint8_t>*> outputArray, int32_t offSet);

  /// @brief Method copyBitLength, addr 0x2339140, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> copyBitLength();

  /// @brief Method finish, addr 0x2338540, size 0xd8, virtual false, abstract: false, final false
  inline void finish();
  ...
  /// @brief Method get_AlgorithmName, addr 0x2338434, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method increment, addr 0x2338ff0, size 0xe4, virtual false, abstract: false, final false
  inline void increment();

  /// @brief Method maskWithReductionPolynomial, addr 0x2337ec4, size 0x14, virtual false, abstract: false, final false
  static inline int32_t maskWithReductionPolynomial(int32_t input);

  /// @brief Method packIntoLong, addr 0x2337ed8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method processBlock, addr 0x23388dc, size 0x6b0, virtual false, abstract: false, final false
  inline void processBlock();

  /// @brief Method processFilledBuffer, addr 0x2338728, size 0xe0, virtual false, abstract: false, final false
