...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x1111dac, size 0x6c, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Copy, addr 0x1111ec8, size 0x60, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method DoFinal, addr 0x1111144, size 0xc4, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetByteLength, addr 0x1111ec0, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x111113c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x1111334, size 0xbc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Reset, addr 0x1110f94, size 0x168, virtual true, abstract: false, final true
  inline void Reset(::Org::BouncyCastle::Utilities::IMemoable* other);

  /// @brief Method Update, addr 0x1111c54, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1110bd4, size 0x2b0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1110e84, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::WhirlpoolDigest* originalDigest);

  /// @brief Method bytesToLongFromBuffer, addr 0x11114d0, size 0xd4, virtual false, abstract: false, final false
  static inline int64_t bytesToLongFromBuffer(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t startPos);

  /// @brief Method convertLongToByteArray, addr 0x11112dc, size 0x58, virtual false, abstract: false, final false
  static inline void convertLongToByteArray(int64_t inputLong, ::ArrayW<uint8_t, ::Array<uint8_t>*> outputArray, int32_t offSet);

  /// @brief Method copyBitLength, addr 0x1111e18, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> copyBitLength();

  /// @brief Method finish, addr 0x1111208, size 0xd4, virtual false, abstract: false, final false
  inline void finish();
  ...
  /// @brief Method get_AlgorithmName, addr 0x11110fc, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method increment, addr 0x1111cb8, size 0xf4, virtual false, abstract: false, final false
  inline void increment();

  /// @brief Method maskWithReductionPolynomial, addr 0x1110b8c, size 0x14, virtual false, abstract: false, final false
  static inline int32_t maskWithReductionPolynomial(int32_t input);

  /// @brief Method packIntoLong, addr 0x1110ba0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method processBlock, addr 0x11115a4, size 0x6b0, virtual false, abstract: false, final false
  inline void processBlock();

  /// @brief Method processFilledBuffer, addr 0x11113f0, size 0xe0, virtual false, abstract: false, final false
