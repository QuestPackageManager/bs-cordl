...
public:
  ...
  /// @brief Method Copy, addr 0x32c4020, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Utilities::IMemoable* Copy();

  /// @brief Method CopyIn, addr 0x32c34d8, size 0x64, virtual false, abstract: false, final false
  inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::Sha1Digest* t);

  /// @brief Method DoFinal, addr 0x32c3674, size 0xa4, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method F, addr 0x32c3764, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t F(uint32_t u, uint32_t v, uint32_t w);

  /// @brief Method G, addr 0x32c3780, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t G(uint32_t u, uint32_t v, uint32_t w);

  /// @brief Method GetDigestSize, addr 0x32c3580, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method H, addr 0x32c3774, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x32c3794, size 0x88c, virtual true, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method ProcessLength, addr 0x32c3608, size 0x6c, virtual true, abstract: false, final false
  inline void ProcessLength(int64_t bitLength);

  /// @brief Method ProcessWord, addr 0x32c3588, size 0x80, virtual true, abstract: false, final false
  inline void ProcessWord(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method Reset, addr 0x32c3718, size 0x4c, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x32c407c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32c33f0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32c3460, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Sha1Digest* t);

  /// @brief Method get_AlgorithmName, addr 0x32c353c, size 0x44, virtual true, abstract: false, final false
