...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyGenerationParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyGenerationParameters(KeyGenerationParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyGenerationParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyGenerationParameters(KeyGenerationParametersconst&) = delete;
