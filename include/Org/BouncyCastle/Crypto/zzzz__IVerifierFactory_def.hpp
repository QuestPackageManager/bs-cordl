...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IVerifierFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IVerifierFactory*, "Org.BouncyCastle.Crypto", "IVerifierFactory");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IVerifierFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IVerifierFactory(IVerifierFactoryconst&) = delete;
