...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ECBasisType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ECBasisType*, "Org.BouncyCastle.Crypto.Tls", "ECBasisType");
...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x346b35c, size 0x14, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t ecBasisType);

  static inline ::Org::BouncyCastle::Crypto::Tls::ECBasisType* New_ctor();

  /// @brief Method .ctor, addr 0x346b370, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECBasisType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECBasisType(ECBasisType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECBasisType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECBasisType(ECBasisTypeconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ECBasisType) == 0x10, "Size mismatch!");
