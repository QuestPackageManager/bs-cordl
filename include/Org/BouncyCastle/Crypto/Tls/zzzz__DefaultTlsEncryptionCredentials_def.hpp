...
public:
  ...
  /// @brief Method DecryptPreMasterSecret, addr 0x33443a8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3344180, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x33443a0, size 0x8, virtual true, abstract: false, final false
