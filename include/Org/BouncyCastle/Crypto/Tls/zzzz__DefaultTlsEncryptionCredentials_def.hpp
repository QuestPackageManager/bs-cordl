...
public:
  ...
  /// @brief Method DecryptPreMasterSecret, addr 0x3319b64, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331993c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x3319b5c, size 0x8, virtual true, abstract: false, final false
