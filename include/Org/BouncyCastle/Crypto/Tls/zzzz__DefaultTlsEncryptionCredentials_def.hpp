...
public:
  ...
  /// @brief Method DecryptPreMasterSecret, addr 0x23ebc70, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23eba48, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x23ebc68, size 0x8, virtual true, abstract: false, final false
