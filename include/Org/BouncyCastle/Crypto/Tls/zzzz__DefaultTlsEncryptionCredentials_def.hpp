...
public:
  ...
  /// @brief Method DecryptPreMasterSecret, addr 0x343ff18, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x343fcf0, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x343ff10, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsEncryptionCredentials", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultTlsEncryptionCredentials(DefaultTlsEncryptionCredentials&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsEncryptionCredentials", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultTlsEncryptionCredentials(DefaultTlsEncryptionCredentialsconst&) = delete;
