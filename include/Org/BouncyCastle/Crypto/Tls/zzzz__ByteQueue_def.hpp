...
public:
  ...
  /// @brief Method AddData, addr 0x3436004, size 0x174, virtual false, abstract: false, final false
  inline void AddData(::ArrayW<uint8_t> data, int32_t offset, int32_t len);

  /// @brief Method CopyTo, addr 0x3436180, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method NextTwoPow, addr 0x3435f28, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t NextTwoPow(int32_t i);

  /// @brief Method Read, addr 0x3436318, size 0x220, virtual false, abstract: false, final false
  inline void Read(::ArrayW<uint8_t> buf, int32_t offset, int32_t len, int32_t skip);

  /// @brief Method ReadFrom, addr 0x3436538, size 0x1d4, virtual false, abstract: false, final false
  inline ::System::IO::MemoryStream* ReadFrom(int32_t length);

  /// @brief Method RemoveData, addr 0x34368a4, size 0x8c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> RemoveData(int32_t len, int32_t skip);

  /// @brief Method RemoveData, addr 0x3436878, size 0x2c, virtual false, abstract: false, final false
  inline void RemoveData(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t skip);

  /// @brief Method RemoveData, addr 0x343670c, size 0x16c, virtual false, abstract: false, final false
  inline void RemoveData(int32_t i);

  /// @brief Method Shrink, addr 0x3436930, size 0xf0, virtual false, abstract: false, final false
  inline void Shrink();
  ...
  /// @brief Method .ctor, addr 0x3435f44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3435ff0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method .ctor, addr 0x3435f4c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method get_Available, addr 0x3436178, size 0x8, virtual false, abstract: false, final false
