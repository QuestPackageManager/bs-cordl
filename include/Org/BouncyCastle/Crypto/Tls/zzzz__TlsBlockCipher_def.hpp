...
public:
  ...
  /// @brief Method CheckPaddingConstantTime, addr 0x33b5be4, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method ChooseExtraPadBlocks, addr 0x33b5d94, size 0xa8, virtual true, abstract: false, final false
  inline int32_t ChooseExtraPadBlocks(::Org::BouncyCastle::Security::SecureRandom* r, int32_t max);

  /// @brief Method DecodeCiphertext, addr 0x33b5738, size 0x4ac, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodePlaintext, addr 0x33b50d4, size 0x664, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPlaintextLimit, addr 0x33b4fc4, size 0x110, virtual true, abstract: false, final false
  inline int32_t GetPlaintextLimit(int32_t ciphertextLimit);

  /// @brief Method LowestBitSet, addr 0x33b5e3c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33b4418, size 0xbac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReadMac, addr 0x33b4410, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsMac* get_ReadMac();

  /// @brief Method get_WriteMac, addr 0x33b4408, size 0x8, virtual true, abstract: false, final false
