...
public:
  ...
  /// @brief Method CheckPaddingConstantTime, addr 0x3472e38, size 0x1b0, virtual true, abstract: false, final false
  inline int32_t CheckPaddingConstantTime(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t blockSize, int32_t macSize);

  /// @brief Method ChooseExtraPadBlocks, addr 0x3472fe8, size 0xa8, virtual true, abstract: false, final false
  inline int32_t ChooseExtraPadBlocks(::Org::BouncyCastle::Security::SecureRandom* r, int32_t max);

  /// @brief Method DecodeCiphertext, addr 0x347298c, size 0x4ac, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeCiphertext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> ciphertext, int32_t offset, int32_t len);

  /// @brief Method EncodePlaintext, addr 0x3472328, size 0x664, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len);

  /// @brief Method GetPlaintextLimit, addr 0x3472218, size 0x110, virtual true, abstract: false, final false
  inline int32_t GetPlaintextLimit(int32_t ciphertextLimit);

  /// @brief Method LowestBitSet, addr 0x3473090, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x347166c, size 0xbac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReadMac, addr 0x3471664, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsMac* get_ReadMac();

  /// @brief Method get_WriteMac, addr 0x347165c, size 0x8, virtual true, abstract: false, final false
