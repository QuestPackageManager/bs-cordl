...
public:
  ...
  /// @brief Method CheckPaddingConstantTime, addr 0x11fad0c, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method ChooseExtraPadBlocks, addr 0x11fae78, size 0xa8, virtual true, abstract: false, final false
  inline int32_t ChooseExtraPadBlocks(::Org::BouncyCastle::Security::SecureRandom* r, int32_t max);

  /// @brief Method DecodeCiphertext, addr 0x11fa85c, size 0x4b0, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodePlaintext, addr 0x11fa208, size 0x654, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPlaintextLimit, addr 0x11fa108, size 0x100, virtual true, abstract: false, final false
  inline int32_t GetPlaintextLimit(int32_t ciphertextLimit);

  /// @brief Method LowestBitSet, addr 0x11faf20, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f956c, size 0xb9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReadMac, addr 0x11f9564, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsMac* get_ReadMac();

  /// @brief Method get_WriteMac, addr 0x11f955c, size 0x8, virtual true, abstract: false, final false
