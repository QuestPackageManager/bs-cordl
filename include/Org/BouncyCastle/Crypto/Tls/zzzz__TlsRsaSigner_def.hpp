...
public:
  // Declarations
  /// @brief Method CreateRsaImpl, addr 0x121838c, size 0x8c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* CreateRsaImpl();

  /// @brief Method CreateSigner, addr 0x1217ca4, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x1217db8, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x1217940, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidPublicKey, addr 0x1217dd4, size 0x84, virtual true, abstract: false, final false
  inline bool IsValidPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method MakeSigner, addr 0x1217e58, size 0x2c4, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x1217b48, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12100d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
