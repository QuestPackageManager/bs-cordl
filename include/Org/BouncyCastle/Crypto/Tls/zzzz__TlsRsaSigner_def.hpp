...
public:
  // Declarations
  /// @brief Method CreateRsaImpl, addr 0x336572c, size 0x88, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* CreateRsaImpl();

  /// @brief Method CreateSigner, addr 0x3365004, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x336511c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x3364c94, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidPublicKey, addr 0x3365138, size 0x88, virtual true, abstract: false, final false
  inline bool IsValidPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method MakeSigner, addr 0x33651c0, size 0x2b8, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x3364ea4, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335d490, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
