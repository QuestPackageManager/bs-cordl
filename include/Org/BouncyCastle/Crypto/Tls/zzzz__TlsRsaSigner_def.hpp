...
public:
  // Declarations
  /// @brief Method CreateRsaImpl, addr 0x1023170, size 0x8c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* CreateRsaImpl();

  /// @brief Method CreateSigner, addr 0x1022a88, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x1022b9c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x1022724, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidPublicKey, addr 0x1022bb8, size 0x84, virtual true, abstract: false, final false
  inline bool IsValidPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method MakeSigner, addr 0x1022c3c, size 0x2c4, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x102292c, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x101aebc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
