...
public:
  // Declarations
  /// @brief Method CreateRsaImpl, addr 0x1044874, size 0x8c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* CreateRsaImpl();

  /// @brief Method CreateSigner, addr 0x104418c, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x10442a0, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x1043e28, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidPublicKey, addr 0x10442bc, size 0x84, virtual true, abstract: false, final false
  inline bool IsValidPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method MakeSigner, addr 0x1044340, size 0x2c4, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x1044030, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103c5c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
