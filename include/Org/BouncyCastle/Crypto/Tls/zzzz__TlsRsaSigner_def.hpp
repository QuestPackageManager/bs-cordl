...
public:
  // Declarations
  /// @brief Method CreateRsaImpl, addr 0x338ff70, size 0x88, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* CreateRsaImpl();

  /// @brief Method CreateSigner, addr 0x338f848, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x338f960, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x338f4d8, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidPublicKey, addr 0x338f97c, size 0x88, virtual true, abstract: false, final false
  inline bool IsValidPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method MakeSigner, addr 0x338fa04, size 0x2b8, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x338f6e8, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3387cd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
