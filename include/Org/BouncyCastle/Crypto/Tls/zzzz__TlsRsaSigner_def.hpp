...
public:
  // Declarations
  /// @brief Method CreateRsaImpl, addr 0x243701c, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* CreateRsaImpl();

  /// @brief Method CreateSigner, addr 0x2436938, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x2436a48, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x24365d8, size 0x204, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidPublicKey, addr 0x2436a64, size 0x84, virtual true, abstract: false, final false
  inline bool IsValidPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method MakeSigner, addr 0x2436ae8, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x24367dc, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x242ef44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
