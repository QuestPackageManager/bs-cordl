...
public:
  // Declarations
  /// @brief Method CreateRsaImpl, addr 0x2436fdc, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* CreateRsaImpl();

  /// @brief Method CreateSigner, addr 0x24368f8, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x2436a08, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x2436598, size 0x204, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidPublicKey, addr 0x2436a24, size 0x84, virtual true, abstract: false, final false
  inline bool IsValidPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method MakeSigner, addr 0x2436aa8, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x243679c, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x242ef04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
