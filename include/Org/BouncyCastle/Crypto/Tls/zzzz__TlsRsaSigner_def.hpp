...
public:
  // Declarations
  /// @brief Method CreateRsaImpl, addr 0x111e3f8, size 0x8c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* CreateRsaImpl();

  /// @brief Method CreateSigner, addr 0x111dd10, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateVerifyer, addr 0x111de24, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRawSignature, addr 0x111d9ac, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidPublicKey, addr 0x111de40, size 0x84, virtual true, abstract: false, final false
  inline bool IsValidPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method MakeSigner, addr 0x111dec4, size 0x2c4, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyRawSignature, addr 0x111dbb4, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1116144, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
