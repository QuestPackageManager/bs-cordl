...
public:
  ...
  /// @brief Method .ctor addr 0xf20074 size 0x28 virtual false final false
  inline void _ctor();

  /// @brief Method Build addr 0xf2009c size 0x13c virtual false final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters* Build();

  /// @brief Method SetCipherSuite addr 0xf20260 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Crypto::Tls::__SessionParameters__Builder* SetCipherSuite(int32_t cipherSuite);

  /// @brief Method SetCompressionAlgorithm addr 0xf20268 size 0xc virtual false final false
  inline ::Org::BouncyCastle::Crypto::Tls::__SessionParameters__Builder* SetCompressionAlgorithm(uint8_t compressionAlgorithm);

  /// @brief Method SetExtendedMasterSecret addr 0xf20274 size 0xc virtual false final false
  inline ::Org::BouncyCastle::Crypto::Tls::__SessionParameters__Builder* SetExtendedMasterSecret(bool extendedMasterSecret);

  /// @brief Method SetMasterSecret addr 0xf20280 size 0x8 virtual false final false
  ...
  /// @brief Method SetPeerCertificate addr 0xf20288 size 0x8 virtual false final false
  ...
  /// @brief Method Validate addr 0xf201d8 size 0x88 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xf1faa4 size 0xdc virtual false final false
  ...
  /// @brief Method Clear addr 0xf1fb80 size 0x70 virtual false final false
  inline void Clear();

  /// @brief Method Copy addr 0xf1fbf0 size 0xc4 virtual false final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters* Copy();

  /// @brief Method get_CipherSuite addr 0xf1fcb4 size 0x8 virtual false final false
  inline int32_t get_CipherSuite();

  /// @brief Method get_CompressionAlgorithm addr 0xf1fcbc size 0x8 virtual false final false
  inline uint8_t get_CompressionAlgorithm();

  /// @brief Method get_IsExtendedMasterSecret addr 0xf1fcc4 size 0x8 virtual false final false
  inline bool get_IsExtendedMasterSecret();

  /// @brief Method get_MasterSecret addr 0xf1fccc size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_MasterSecret();

  /// @brief Method get_PeerCertificate addr 0xf1fcd4 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Crypto::Tls::Certificate* get_PeerCertificate();

  /// @brief Method get_PskIdentity addr 0xf1fcdc size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_PskIdentity();

  /// @brief Method get_SrpIdentity addr 0xf1fce4 size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_SrpIdentity();

  /// @brief Method ReadServerExtensions addr 0xf1fcec size 0x80 virtual false final false
