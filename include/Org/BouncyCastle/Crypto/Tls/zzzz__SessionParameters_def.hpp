...
public:
  ...
  /// @brief Method Build, addr 0x241a5c0, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCipherSuite, addr 0x241a764, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetCipherSuite(int32_t cipherSuite);

  /// @brief Method SetCompressionAlgorithm, addr 0x241a76c, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetCompressionAlgorithm(uint8_t compressionAlgorithm);

  /// @brief Method SetExtendedMasterSecret, addr 0x241a778, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetExtendedMasterSecret(bool extendedMasterSecret);

  /// @brief Method SetMasterSecret, addr 0x241a784, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetMasterSecret(::ArrayW<uint8_t, ::Array<uint8_t>*> masterSecret);

  /// @brief Method SetPeerCertificate, addr 0x241a78c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPskIdentity, addr 0x241a794, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetPskIdentity(::ArrayW<uint8_t, ::Array<uint8_t>*> pskIdentity);

  /// @brief Method SetServerExtensions, addr 0x241a7a4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSrpIdentity, addr 0x241a79c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters_Builder* SetSrpIdentity(::ArrayW<uint8_t, ::Array<uint8_t>*> srpIdentity);

  /// @brief Method Validate, addr 0x241a6e4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241a598, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Clear, addr 0x241a0c0, size 0x70, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Copy, addr 0x241a130, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadServerExtensions, addr 0x241a214, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2419fe4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherSuite, addr 0x241a1dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CipherSuite();

  /// @brief Method get_CompressionAlgorithm, addr 0x241a1e4, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_CompressionAlgorithm();

  /// @brief Method get_IsExtendedMasterSecret, addr 0x241a1ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsExtendedMasterSecret();

  /// @brief Method get_MasterSecret, addr 0x241a1f4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_MasterSecret();

  /// @brief Method get_PeerCertificate, addr 0x241a1fc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::Certificate* get_PeerCertificate();

  /// @brief Method get_PskIdentity, addr 0x241a204, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_PskIdentity();

  /// @brief Method get_SrpIdentity, addr 0x241a20c, size 0x8, virtual false, abstract: false, final false
