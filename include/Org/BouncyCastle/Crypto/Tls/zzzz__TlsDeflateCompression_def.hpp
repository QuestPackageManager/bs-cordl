...
public:
  // Declarations
  /// @brief Method Flush, addr 0x110f2fc, size 0x4, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method .ctor, addr 0x110f120, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compress, addr 0x110f08c, size 0x94, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x110f158, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x110efe0, size 0xac, virtual false, abstract: false, final false
