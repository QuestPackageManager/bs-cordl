...
public:
  // Declarations
  /// @brief Method Flush, addr 0x1034778, size 0x4, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method .ctor, addr 0x103459c, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compress, addr 0x1034508, size 0x94, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x10345d4, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1034454, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x103445c, size 0xac, virtual false, abstract: false, final false
