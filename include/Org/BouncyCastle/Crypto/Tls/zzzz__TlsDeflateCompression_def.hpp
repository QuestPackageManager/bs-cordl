...
public:
  // Declarations
  /// @brief Method Flush, addr 0x2426254, size 0x4, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method .ctor, addr 0x2426080, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compress, addr 0x2425ff4, size 0x8c, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x24260b8, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2425f40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2425f48, size 0xac, virtual false, abstract: false, final false
