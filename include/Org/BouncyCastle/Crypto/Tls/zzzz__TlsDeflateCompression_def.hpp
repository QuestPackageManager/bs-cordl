...
public:
  // Declarations
  /// @brief Method Flush, addr 0x1202a20, size 0x4, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method .ctor, addr 0x1202844, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compress, addr 0x12027b0, size 0x94, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x120287c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12026fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1202704, size 0xac, virtual false, abstract: false, final false
