...
public:
  // Declarations
  /// @brief Method Flush, addr 0x33bd580, size 0x4, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method .ctor, addr 0x33bd38c, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compress, addr 0x33bd2fc, size 0x90, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x33bd3c4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bd248, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33bd250, size 0xac, virtual false, abstract: false, final false
