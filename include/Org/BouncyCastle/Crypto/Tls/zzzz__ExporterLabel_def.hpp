...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ExporterLabel*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ExporterLabel*, "Org.BouncyCastle.Crypto.Tls", "ExporterLabel");
...
public:
  ...
  __declspec(property(get = getStaticF_extended_master_secret, put = setStaticF_extended_master_secret)) ::StringW extended_master_secret;

  static inline ::Org::BouncyCastle::Crypto::Tls::ExporterLabel* New_ctor();

  /// @brief Method .ctor, addr 0x346b3e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExporterLabel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExporterLabel(ExporterLabel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExporterLabel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExporterLabel(ExporterLabelconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ExporterLabel) == 0x10, "Size mismatch!");
