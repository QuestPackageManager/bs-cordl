...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory*, "Org.BouncyCastle.Crypto.Tls", "TlsCipherFactory");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
