...
public:
  ...
  /// @brief Method .ctor, addr 0x3487780, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t alertDescription);

  /// @brief Method get_AlertDescription, addr 0x34877cc, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsFatalAlertReceived", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsFatalAlertReceived(TlsFatalAlertReceived&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsFatalAlertReceived", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsFatalAlertReceived(TlsFatalAlertReceivedconst&) = delete;
