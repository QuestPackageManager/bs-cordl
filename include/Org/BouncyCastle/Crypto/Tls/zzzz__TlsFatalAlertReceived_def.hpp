...
public:
  ...
  /// @brief Method .ctor, addr 0x33c81a4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t alertDescription);

  /// @brief Method get_AlertDescription, addr 0x33c81f0, size 0x8, virtual true, abstract: false, final false
