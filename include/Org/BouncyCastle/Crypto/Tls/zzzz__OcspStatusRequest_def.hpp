...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OcspStatusRequest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OcspStatusRequest(OcspStatusRequest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OcspStatusRequest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OcspStatusRequest(OcspStatusRequestconst&) = delete;
