...
public:
  ...
  /// @brief Method Encode, addr 0x3345c94, size 0x3dc, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3346070, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3345c7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* responderIDList, ::Org::BouncyCastle::Asn1::X509::X509Extensions* requestExtensions);

  /// @brief Method get_RequestExtensions, addr 0x3345c8c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions();

  /// @brief Method get_ResponderIDList, addr 0x3345c84, size 0x8, virtual true, abstract: false, final false
