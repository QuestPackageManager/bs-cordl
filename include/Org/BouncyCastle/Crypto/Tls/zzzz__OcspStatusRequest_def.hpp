...
public:
  ...
  /// @brief Method Encode, addr 0x2413d94, size 0x3c0, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x2414154, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2413d58, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* responderIDList, ::Org::BouncyCastle::Asn1::X509::X509Extensions* requestExtensions);

  /// @brief Method get_RequestExtensions, addr 0x2413d8c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions();

  /// @brief Method get_ResponderIDList, addr 0x2413d84, size 0x8, virtual true, abstract: false, final false
