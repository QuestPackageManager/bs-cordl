...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest*, "Org.BouncyCastle.Crypto.Tls", "OcspStatusRequest");
...
public:
  ...
  /// @brief Method Encode, addr 0x3469cc0, size 0x3dc, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x346a09c, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3469ca8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* responderIDList, ::Org::BouncyCastle::Asn1::X509::X509Extensions* requestExtensions);

  /// @brief Method get_RequestExtensions, addr 0x3469cb8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions();

  /// @brief Method get_ResponderIDList, addr 0x3469cb0, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest) == 0x20, "Size mismatch!");
