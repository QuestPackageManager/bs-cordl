...
public:
  ...
  /// @brief Method Encode, addr 0x2417ecc, size 0x3c0, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x241828c, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2417e90, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* responderIDList, ::Org::BouncyCastle::Asn1::X509::X509Extensions* requestExtensions);

  /// @brief Method get_RequestExtensions, addr 0x2417ec4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions();

  /// @brief Method get_ResponderIDList, addr 0x2417ebc, size 0x8, virtual true, abstract: false, final false
