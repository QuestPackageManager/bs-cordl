...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsNullCompression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsNullCompression(TlsNullCompression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsNullCompression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsNullCompression(TlsNullCompressionconst&) = delete;
