...
public:
  ...
  /// @brief Method Compress, addr 0x12156d4, size 0x8, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x12156dc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12156e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
