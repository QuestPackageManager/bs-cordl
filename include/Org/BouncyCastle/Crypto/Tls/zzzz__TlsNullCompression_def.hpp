...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsNullCompression*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsNullCompression*, "Org.BouncyCastle.Crypto.Tls", "TlsNullCompression");
...
public:
  ...
  /// @brief Method Compress, addr 0x3486a70, size 0x8, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x3486a78, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3486a80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsNullCompression) == 0x10, "Size mismatch!");
