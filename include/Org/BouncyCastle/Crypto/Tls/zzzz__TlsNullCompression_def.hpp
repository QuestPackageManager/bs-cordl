...
public:
  ...
  /// @brief Method Compress, addr 0x33c981c, size 0x8, virtual true, abstract: false, final false
  inline ::System::IO::Stream* Compress(::System::IO::Stream* output);

  /// @brief Method Decompress, addr 0x33c9824, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33c982c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
