...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::AlertDescription*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::AlertDescription*, "Org.BouncyCastle.Crypto.Tls", "AlertDescription");
...
public:
  // Declarations
  /// @brief Method GetName, addr 0x3437860, size 0x524, virtual false, abstract: false, final false
  static inline ::StringW GetName(uint8_t alertDescription);

  /// @brief Method GetText, addr 0x3437d84, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3437ef8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AlertDescription", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AlertDescription(AlertDescription&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AlertDescription", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AlertDescription(AlertDescriptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::AlertDescription) == 0x10, "Size mismatch!");
