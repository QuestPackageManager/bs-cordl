...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificateRequest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificateRequest(CertificateRequest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificateRequest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificateRequest(CertificateRequestconst&) = delete;
