...
public:
  ...
  /// @brief Method Encode, addr 0xff0550, size 0x920, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0xff0e70, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff04fc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CertificateAuthorities, addr 0xff0548, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IList* get_CertificateAuthorities();

  /// @brief Method get_CertificateTypes, addr 0xff0538, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_CertificateTypes();

  /// @brief Method get_SupportedSignatureAlgorithms, addr 0xff0540, size 0x8, virtual true, abstract: false, final false
