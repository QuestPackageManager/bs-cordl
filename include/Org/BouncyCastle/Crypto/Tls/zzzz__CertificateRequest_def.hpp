...
public:
  ...
  /// @brief Method Encode, addr 0x23e9904, size 0x900, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x23ea204, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e98b0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CertificateAuthorities, addr 0x23e98fc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IList* get_CertificateAuthorities();

  /// @brief Method get_CertificateTypes, addr 0x23e98ec, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_CertificateTypes();

  /// @brief Method get_SupportedSignatureAlgorithms, addr 0x23e98f4, size 0x8, virtual true, abstract: false, final false
