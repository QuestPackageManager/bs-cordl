...
public:
  ...
  /// @brief Method .ctor, addr 0x346be98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyExchangeAlgorithm", modifiers: "&&", def_value: None, comment: None }]
