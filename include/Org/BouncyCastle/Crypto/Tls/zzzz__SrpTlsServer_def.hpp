...
public:
  ...
  /// @brief Method .ctor addr 0xf215f4 size 0x80 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf21674 size 0x2c virtual false final false
  ...
  /// @brief Method GetDsaSignerCredentials addr 0xf216a0 size 0x44 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials* GetDsaSignerCredentials();

  /// @brief Method GetRsaSignerCredentials addr 0xf216e4 size 0x44 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials* GetRsaSignerCredentials();

  /// @brief Method GetCipherSuites addr 0xf21728 size 0x70 virtual true final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCipherSuites();

  /// @brief Method ProcessClientExtensions addr 0xf21798 size 0x34 virtual true final false
  inline void ProcessClientExtensions(::System::Collections::IDictionary* clientExtensions);

  /// @brief Method GetSelectedCipherSuite addr 0xf217cc size 0x12c virtual true final false
  inline int32_t GetSelectedCipherSuite();

  /// @brief Method GetCredentials addr 0xf218f8 size 0xe8 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCredentials* GetCredentials();

  /// @brief Method GetKeyExchange addr 0xf219e0 size 0xc0 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* GetKeyExchange();

  /// @brief Method CreateSrpKeyExchange addr 0xf21aa0 size 0x84 virtual true final false
