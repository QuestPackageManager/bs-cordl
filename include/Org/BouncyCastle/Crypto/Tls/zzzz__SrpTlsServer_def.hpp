...
public:
  ...
  /// @brief Method CreateSrpKeyExchange, addr 0x241d250, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateSrpKeyExchange(int32_t keyExchange);

  /// @brief Method GetCipherSuites, addr 0x241cef4, size 0x70, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCipherSuites();

  /// @brief Method GetCredentials, addr 0x241d0b8, size 0xe0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCredentials* GetCredentials();

  /// @brief Method GetDsaSignerCredentials, addr 0x241ce7c, size 0x3c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials* GetDsaSignerCredentials();

  /// @brief Method GetKeyExchange, addr 0x241d198, size 0xb8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* GetKeyExchange();

  /// @brief Method GetRsaSignerCredentials, addr 0x241ceb8, size 0x3c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials* GetRsaSignerCredentials();

  /// @brief Method GetSelectedCipherSuite, addr 0x241cf98, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessClientExtensions, addr 0x241cf64, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241ce50, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241cdd8, size 0x78, virtual false, abstract: false, final false
