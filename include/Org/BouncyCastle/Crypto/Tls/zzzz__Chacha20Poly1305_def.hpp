...
public:
  ...
  /// @brief Method CalculateNonce, addr 0x23e4010, size 0xec, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CalculateNonce(int64_t seqNo, ::ArrayW<uint8_t, ::Array<uint8_t>*> iv);

  /// @brief Method CalculateRecordMac, addr 0x23e4254, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodeCiphertext, addr 0x23e3d00, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodePlaintext, addr 0x23e3bc4, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateRecordMacKey, addr 0x23e40fc, size 0x158, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* GenerateRecordMacKey(::Org::BouncyCastle::Crypto::IStreamCipher* cipher);

  /// @brief Method GetAdditionalData, addr 0x23e464c, size 0x160, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetAdditionalData(int64_t seqNo, uint8_t type, int32_t len);

  /// @brief Method GetPlaintextLimit, addr 0x23e3bbc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetPlaintextLimit(int32_t ciphertextLimit);

  /// @brief Method InitRecord, addr 0x23e3ee4, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method UpdateRecordMacLength, addr 0x23e43fc, size 0xc8, virtual true, abstract: false, final false
  inline void UpdateRecordMacLength(::Org::BouncyCastle::Crypto::IMac* mac, int32_t len);

  /// @brief Method UpdateRecordMacText, addr 0x23e44c4, size 0x188, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e38b8, size 0x304, virtual false, abstract: false, final false
