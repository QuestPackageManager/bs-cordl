...
public:
  ...
  /// @brief Method GetLoginParameters, addr 0x3470b40, size 0x4b4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters* GetLoginParameters(::ArrayW<uint8_t> identity);

  /// @brief Method GetRfc5054Default, addr 0x34709c8, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3470b34, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SimulatedTlsSrpIdentityManager", modifiers: "&&", def_value: None, comment: None }]
