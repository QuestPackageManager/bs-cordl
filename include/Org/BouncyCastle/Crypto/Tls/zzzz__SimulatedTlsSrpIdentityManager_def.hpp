...
public:
  ...
  /// @brief Method GetLoginParameters, addr 0x241b090, size 0x4b8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters* GetLoginParameters(::ArrayW<uint8_t, ::Array<uint8_t>*> identity);

  /// @brief Method GetRfc5054Default, addr 0x241aee0, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241b054, size 0x3c, virtual false, abstract: false, final false
