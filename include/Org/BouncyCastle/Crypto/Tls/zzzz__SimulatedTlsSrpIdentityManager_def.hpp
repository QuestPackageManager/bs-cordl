...
/// @brief Method GetLoginParameters, addr 0x3374f20, size 0x4b4, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters* GetLoginParameters(::ArrayW<uint8_t,::Array<uint8_t>*>  identity) ;

/// @brief Method GetRfc5054Default, addr 0x3374da8, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3374f14, size 0xc, virtual false, abstract: false, final false
