...
public:
  ...
  /// @brief Method CreatePskKeyExchange, addr 0x11f866c, size 0xd0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreatePskKeyExchange(int32_t keyExchange);

  /// @brief Method GetCipherSuites, addr 0x11f8458, size 0x70, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCipherSuites();

  /// @brief Method GetCredentials, addr 0x11f84c8, size 0xdc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCredentials* GetCredentials();

  /// @brief Method GetDHParameters, addr 0x11f8400, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GetDHParameters();

  /// @brief Method GetKeyExchange, addr 0x11f85a4, size 0xc8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* GetKeyExchange();

  /// @brief Method GetRsaEncryptionCredentials, addr 0x11f83bc, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f8394, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f8318, size 0x7c, virtual false, abstract: false, final false
