...
/// @brief Method CreatePskKeyExchange, addr 0x33718cc, size 0xcc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreatePskKeyExchange(int32_t  keyExchange) ;

/// @brief Method GetCipherSuites, addr 0x33716b8, size 0x78, virtual true, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> GetCipherSuites() ;

/// @brief Method GetCredentials, addr 0x3371730, size 0xd8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsCredentials* GetCredentials() ;

/// @brief Method GetDHParameters, addr 0x337165c, size 0x5c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GetDHParameters() ;

/// @brief Method GetKeyExchange, addr 0x3371808, size 0xc4, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* GetKeyExchange() ;

/// @brief Method GetRsaEncryptionCredentials, addr 0x3371620, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3371614, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33715b4, size 0x60, virtual false, abstract: false, final false
