...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::AbstractTlsAgreementCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::AbstractTlsAgreementCredentials*, "Org.BouncyCastle.Crypto.Tls", "AbstractTlsAgreementCredentials");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3435200, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AbstractTlsAgreementCredentials", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AbstractTlsAgreementCredentials(AbstractTlsAgreementCredentials&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AbstractTlsAgreementCredentials", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AbstractTlsAgreementCredentials(AbstractTlsAgreementCredentialsconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsAgreementCredentials) == 0x10, "Size mismatch!");
