...
public:
  ...
  /// @brief Method CreateCipher, addr 0xfca170, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfca1b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
