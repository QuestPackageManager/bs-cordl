...
public:
  ...
  /// @brief Method CreateCipher, addr 0x11be38c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11be3d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
