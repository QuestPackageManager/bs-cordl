...
public:
  ...
  /// @brief Method CreateCipher, addr 0x23e4d70, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e4dac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
