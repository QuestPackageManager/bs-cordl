...
public:
  ...
  /// @brief Method CreateCipher, addr 0x23e1038, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e1074, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
