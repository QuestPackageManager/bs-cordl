...
public:
  ...
  /// @brief Method CreateCipher, addr 0x3432e7c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3432eb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
