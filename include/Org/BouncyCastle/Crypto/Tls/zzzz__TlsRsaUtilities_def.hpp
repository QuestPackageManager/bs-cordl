...
public:
  // Declarations
  /// @brief Method GenerateEncryptedPreMasterSecret, addr 0x2435468, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeDecryptPreMasterSecret, addr 0x243705c, size 0x40c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2437468, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
