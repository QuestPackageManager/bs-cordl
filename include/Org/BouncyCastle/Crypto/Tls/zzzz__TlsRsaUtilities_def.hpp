...
public:
// Declarations
/// @brief Method GenerateEncryptedPreMasterSecret, addr 0x33cb684, size 0x3fc, virtual false, abstract: false, final false
...
/// @brief Method SafeDecryptPreMasterSecret, addr 0x33cd328, size 0x410, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33cd738, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
