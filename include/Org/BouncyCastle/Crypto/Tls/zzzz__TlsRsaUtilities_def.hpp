...
public:
  // Declarations
  /// @brief Method GenerateEncryptedPreMasterSecret, addr 0x12167c0, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeDecryptPreMasterSecret, addr 0x1218418, size 0x428, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1218840, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
