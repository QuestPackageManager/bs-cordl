...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::MaxFragmentLength*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::MaxFragmentLength*, "Org.BouncyCastle.Crypto.Tls", "MaxFragmentLength");
...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x346bea0, size 0x14, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t maxFragmentLength);

  static inline ::Org::BouncyCastle::Crypto::Tls::MaxFragmentLength* New_ctor();

  /// @brief Method .ctor, addr 0x346beb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MaxFragmentLength", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MaxFragmentLength(MaxFragmentLength&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MaxFragmentLength", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MaxFragmentLength(MaxFragmentLengthconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::MaxFragmentLength) == 0x10, "Size mismatch!");
