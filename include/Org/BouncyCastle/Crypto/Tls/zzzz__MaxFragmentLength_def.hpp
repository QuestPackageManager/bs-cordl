...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x33ac8c4, size 0x14, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t maxFragmentLength);

  static inline ::Org::BouncyCastle::Crypto::Tls::MaxFragmentLength* New_ctor();

  /// @brief Method .ctor, addr 0x33ac8d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
