...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::BulkCipherAlgorithm*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::BulkCipherAlgorithm*, "Org.BouncyCastle.Crypto.Tls", "BulkCipherAlgorithm");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34382ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BulkCipherAlgorithm", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BulkCipherAlgorithm(BulkCipherAlgorithm&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BulkCipherAlgorithm", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BulkCipherAlgorithm(BulkCipherAlgorithmconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::BulkCipherAlgorithm) == 0x10, "Size mismatch!");
