...
public:
  ...
  /// @brief Method get_SignatureAndHashAlgorithm addr 0xee67c8 size 0x50 virtual true final false
  ...
  /// @brief Method .ctor addr 0xee6818 size 0x8 virtual false final false
  inline void _ctor();
