...
/// @brief Method .ctor, addr 0x333bc3c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_SignatureAndHashAlgorithm, addr 0x333bbf0, size 0x4c, virtual true, abstract: false, final false
