...
public:
  ...
  /// @brief Method .ctor, addr 0x23e1c84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAndHashAlgorithm, addr 0x23e1c38, size 0x4c, virtual true, abstract: false, final false
