...
public:
  ...
  /// @brief Method .ctor, addr 0x3378280, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAndHashAlgorithm, addr 0x3378234, size 0x4c, virtual true, abstract: false, final false
