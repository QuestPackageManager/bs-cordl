...
public:
  ...
  /// @brief Method .ctor, addr 0x11ba234, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAndHashAlgorithm, addr 0x11ba1e4, size 0x50, virtual true, abstract: false, final false
