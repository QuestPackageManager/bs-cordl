...
public:
  ...
  /// @brief Method .ctor, addr 0x34354d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAndHashAlgorithm, addr 0x3435488, size 0x4c, virtual true, abstract: false, final false
