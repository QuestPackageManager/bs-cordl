...
public:
  ...
  /// @brief Method .ctor, addr 0xfcc888, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAndHashAlgorithm, addr 0xfcc838, size 0x50, virtual true, abstract: false, final false
