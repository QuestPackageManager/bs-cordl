...
public:
  ...
  /// @brief Method CreateDsaImpl, addr 0x242c28c, size 0xc0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IDsa* CreateDsaImpl(uint8_t hashAlgorithm);

  /// @brief Method IsValidPublicKey, addr 0x242c214, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x242906c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAlgorithm, addr 0x242c34c, size 0x8, virtual true, abstract: false, final false
