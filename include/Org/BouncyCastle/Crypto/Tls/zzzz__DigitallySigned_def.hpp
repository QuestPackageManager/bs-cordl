...
public:
  ...
  /// @brief Method Encode, addr 0x23eb178, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x23de1d4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23eb0f0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm* algorithm, ::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method get_Algorithm, addr 0x23eb168, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm* get_Algorithm();

  /// @brief Method get_Signature, addr 0x23eb170, size 0x8, virtual true, abstract: false, final false
