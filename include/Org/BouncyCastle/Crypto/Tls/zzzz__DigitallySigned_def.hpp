...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DigitallySigned*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DigitallySigned*, "Org.BouncyCastle.Crypto.Tls", "DigitallySigned");
...
public:
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mSignature() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mSignature();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DigitallySigned) == 0x20, "Size mismatch!");
