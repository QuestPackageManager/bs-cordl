...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x3439294, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t certChainType);

  static inline ::Org::BouncyCastle::Crypto::Tls::CertChainType* New_ctor();

  /// @brief Method .ctor, addr 0x34392a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertChainType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertChainType(CertChainType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertChainType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertChainType(CertChainTypeconst&) = delete;
