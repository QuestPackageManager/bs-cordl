...
public:
  ...
  /// @brief Method Write, addr 0xff9d9c, size 0xc4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0xff9cf0, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff9cc8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method UpdateDigest, addr 0xff8244, size 0x78, virtual false, abstract: false, final false
  inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* d);

  /// @brief Method .ctor, addr 0xff7f7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
