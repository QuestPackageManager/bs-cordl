...
public:
  ...
  /// @brief Method .ctor addr 0xef2540 size 0x28 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* d);

  /// @brief Method WriteByte addr 0xef2568 size 0xac virtual true final false
  inline void WriteByte(uint8_t b);

  /// @brief Method Write addr 0xef2614 size 0xc4 virtual true final false
...
public:
  ...
  /// @brief Method UpdateDigest addr 0xef0abc size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0xef07f4 size 0x8 virtual false final false
  inline void _ctor();
