...
public:
  ...
  /// @brief Method Write, addr 0xfd8698, size 0xc4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0xfd85ec, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd85c4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method UpdateDigest, addr 0xfd6b40, size 0x78, virtual false, abstract: false, final false
  inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest* d);

  /// @brief Method .ctor, addr 0xfd6878, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
