...
/// @brief Method Write, addr 0x3347764, size 0xd0, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x33476ac, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3347684, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method UpdateDigest, addr 0x3345cac, size 0x84, virtual false, abstract: false, final false
inline void UpdateDigest(::Org::BouncyCastle::Crypto::IDigest*  d) ;

/// @brief Method .ctor, addr 0x33459f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
