...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Crypto::Tls::AbstractTlsAgreementCredentials::*)(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*)>(&::Org::BouncyCastle::Crypto::Tls::AbstractTlsAgreementCredentials::GenerateAgreement)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::AbstractTlsAgreementCredentials::*)()>(&::Org::BouncyCastle::Crypto::Tls::AbstractTlsAgreementCredentials::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x33769c0;
...
constexpr ::Org::BouncyCastle::Crypto::Tls::TlsAgreementCredentials* Org::BouncyCastle::Crypto::Tls::AbstractTlsAgreementCredentials::i___Org__BouncyCastle__Crypto__Tls__TlsAgreementCredentials() noexcept {
return static_cast<::Org::BouncyCastle::Crypto::Tls::TlsAgreementCredentials*>(static_cast<void*>(this));
}
