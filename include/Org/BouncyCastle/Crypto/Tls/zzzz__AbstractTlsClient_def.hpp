...
/// @brief Method AllowUnexpectedServerExtension, addr 0x33397a8, size 0xc8, virtual true, abstract: false, final false
inline bool AllowUnexpectedServerExtension(int32_t  extensionType, ::ArrayW<uint8_t,::Array<uint8_t>*>  extensionData) ;

/// @brief Method CheckForUnexpectedServerExtension, addr 0x3339870, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method GetCipher, addr 0x3339fb8, size 0x10c, virtual true, abstract: false, final false
...
/// @brief Method GetClientExtensions, addr 0x33399c4, size 0x274, virtual true, abstract: false, final false
inline ::System::Collections::IDictionary* GetClientExtensions() ;

/// @brief Method GetClientSupplementalData, addr 0x3339ec4, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::IList* GetClientSupplementalData() ;

/// @brief Method GetCompression, addr 0x3339ecc, size 0xec, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsCompression* GetCompression() ;

/// @brief Method GetCompressionMethods, addr 0x3339d08, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method GetSessionToResume, addr 0x3339948, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsSession* GetSessionToResume() ;

/// @brief Method Init, addr 0x3339940, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method NotifyNewSessionTicket, addr 0x333a0c4, size 0x4, virtual true, abstract: false, final false
inline void NotifyNewSessionTicket(::Org::BouncyCastle::Crypto::Tls::NewSessionTicket*  newSessionTicket) ;

/// @brief Method NotifySelectedCipherSuite, addr 0x3339d54, size 0x8, virtual true, abstract: false, final false
inline void NotifySelectedCipherSuite(int32_t  selectedCipherSuite) ;

/// @brief Method NotifySelectedCompressionMethod, addr 0x3339d5c, size 0xc, virtual true, abstract: false, final false
inline void NotifySelectedCompressionMethod(uint8_t  selectedCompressionMethod) ;

/// @brief Method NotifyServerVersion, addr 0x3339c94, size 0x74, virtual true, abstract: false, final false
inline void NotifyServerVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion*  serverVersion) ;

/// @brief Method NotifySessionID, addr 0x3339d50, size 0x4, virtual true, abstract: false, final false
inline void NotifySessionID(::ArrayW<uint8_t,::Array<uint8_t>*>  sessionID) ;

/// @brief Method ProcessServerExtensions, addr 0x3339d68, size 0x118, virtual true, abstract: false, final false
inline void ProcessServerExtensions(::System::Collections::IDictionary*  serverExtensions) ;

/// @brief Method ProcessServerSupplementalData, addr 0x3339e80, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x333974c, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x33397a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory*  cipherFactory) ;

/// @brief Method get_ClientHelloRecordLayerVersion, addr 0x3339950, size 0x10, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ClientHelloRecordLayerVersion() ;

/// @brief Method get_ClientVersion, addr 0x3339960, size 0x5c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ClientVersion() ;

/// @brief Method get_IsFallback, addr 0x33399bc, size 0x8, virtual true, abstract: false, final false
inline bool get_IsFallback() ;

/// @brief Method get_MinimumVersion, addr 0x3339c38, size 0x5c, virtual true, abstract: false, final false
