...
public:
  ...
  /// @brief Method .ctor addr 0xee4294 size 0x6c virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0xee4308 size 0x28 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory* cipherFactory);

  /// @brief Method AllowUnexpectedServerExtension addr 0xee4330 size 0xb8 virtual true final false
  inline bool AllowUnexpectedServerExtension(int32_t extensionType, ::ArrayW<uint8_t, ::Array<uint8_t>*> extensionData);

  /// @brief Method CheckForUnexpectedServerExtension addr 0xee43e8 size 0xd4 virtual true final false
  inline void CheckForUnexpectedServerExtension(::System::Collections::IDictionary* serverExtensions, int32_t extensionType);

  /// @brief Method Init addr 0xee44bc size 0x8 virtual true final false
  inline void Init(::Org::BouncyCastle::Crypto::Tls::TlsClientContext* context);

  /// @brief Method GetSessionToResume addr 0xee44c4 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSession* GetSessionToResume();

  /// @brief Method get_ClientHelloRecordLayerVersion addr 0xee44cc size 0x10 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ClientHelloRecordLayerVersion();

  /// @brief Method get_ClientVersion addr 0xee44dc size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ClientVersion();

  /// @brief Method get_IsFallback addr 0xee4534 size 0x8 virtual true final false
  inline bool get_IsFallback();

  /// @brief Method GetClientExtensions addr 0xee453c size 0x25c virtual true final false
  inline ::System::Collections::IDictionary* GetClientExtensions();

  /// @brief Method get_MinimumVersion addr 0xee4798 size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_MinimumVersion();

  /// @brief Method NotifyServerVersion addr 0xee47f0 size 0x7c virtual true final false
  ...
  /// @brief Method GetCompressionMethods addr 0xee486c size 0x44 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetCompressionMethods();

  /// @brief Method NotifySessionID addr 0xee48b0 size 0x4 virtual true final false
  inline void NotifySessionID(::ArrayW<uint8_t, ::Array<uint8_t>*> sessionID);

  /// @brief Method NotifySelectedCipherSuite addr 0xee48b4 size 0x8 virtual true final false
  inline void NotifySelectedCipherSuite(int32_t selectedCipherSuite);

  /// @brief Method NotifySelectedCompressionMethod addr 0xee48bc size 0xc virtual true final false
  inline void NotifySelectedCompressionMethod(uint8_t selectedCompressionMethod);

  /// @brief Method ProcessServerExtensions addr 0xee48c8 size 0x114 virtual true final false
  inline void ProcessServerExtensions(::System::Collections::IDictionary* serverExtensions);

  /// @brief Method ProcessServerSupplementalData addr 0xee49dc size 0x4c virtual true final false
  ...
  /// @brief Method GetClientSupplementalData addr 0xee4a28 size 0x8 virtual true final false
  inline ::System::Collections::IList* GetClientSupplementalData();

  /// @brief Method GetCompression addr 0xee4a30 size 0x100 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCompression* GetCompression();

  /// @brief Method GetCipher addr 0xee4b30 size 0x104 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCipher* GetCipher();

  /// @brief Method NotifyNewSessionTicket addr 0xee4c34 size 0x4 virtual true final false
