...
public:
  ...
  /// @brief Method Encode, addr 0x3314d74, size 0x120, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetOcspStatusRequest, addr 0x3314ca0, size 0xd4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest* GetOcspStatusRequest();

  /// @brief Method IsCorrectType, addr 0x3314ba0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3314e94, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3314b0c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(uint8_t statusType, ::System::Object* request);

  /// @brief Method get_Request, addr 0x3314c98, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Request();

  /// @brief Method get_StatusType, addr 0x3314c90, size 0x8, virtual true, abstract: false, final false
