...
public:
  ...
  /// @brief Method Encode, addr 0x23e2dc8, size 0x10c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetOcspStatusRequest, addr 0x23e2cf8, size 0xd0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest* GetOcspStatusRequest();

  /// @brief Method IsCorrectType, addr 0x23e2c04, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x23e2ed4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e2b68, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t statusType, ::System::Object* request);

  /// @brief Method get_Request, addr 0x23e2cf0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Request();

  /// @brief Method get_StatusType, addr 0x23e2ce8, size 0x8, virtual true, abstract: false, final false
