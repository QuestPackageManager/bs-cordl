...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificateStatusRequest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificateStatusRequest(CertificateStatusRequest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificateStatusRequest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificateStatusRequest(CertificateStatusRequestconst&) = delete;
