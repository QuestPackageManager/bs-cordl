...
public:
  ...
  /// @brief Method Encode, addr 0x11d06c4, size 0x13c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetOcspStatusRequest, addr 0x11d05f0, size 0xd4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest* GetOcspStatusRequest();

  /// @brief Method IsCorrectType, addr 0x11d04f8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x11d0800, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d0458, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(uint8_t statusType, ::System::Object* request);

  /// @brief Method get_Request, addr 0x11d05e8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Request();

  /// @brief Method get_StatusType, addr 0x11d05e0, size 0x8, virtual true, abstract: false, final false
