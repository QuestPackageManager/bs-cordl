...
public:
  ...
  /// @brief Method Encode, addr 0x23eac38, size 0x10c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetOcspStatusRequest, addr 0x23eab68, size 0xd0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest* GetOcspStatusRequest();

  /// @brief Method IsCorrectType, addr 0x23eaa74, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x23ead44, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ea9d8, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t statusType, ::System::Object* request);

  /// @brief Method get_Request, addr 0x23eab60, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Request();

  /// @brief Method get_StatusType, addr 0x23eab58, size 0x8, virtual true, abstract: false, final false
