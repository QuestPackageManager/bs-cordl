...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::PrfAlgorithm*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::PrfAlgorithm*, "Org.BouncyCastle.Crypto.Tls", "PrfAlgorithm");
...
public:
  ...
  /// @brief Method .ctor, addr 0x346c6d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrfAlgorithm", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrfAlgorithm(PrfAlgorithm&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrfAlgorithm", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrfAlgorithm(PrfAlgorithmconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::PrfAlgorithm) == 0x10, "Size mismatch!");
