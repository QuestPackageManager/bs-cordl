...
/// @brief Method .ctor, addr 0x334e918, size 0x10, virtual false, abstract: false, final false
inline void _ctor(int32_t  message_seq, uint8_t  msg_type, ::ArrayW<uint8_t,::Array<uint8_t>*>  body) ;

/// @brief Method get_Body, addr 0x334fe30, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Body() ;

/// @brief Method get_Seq, addr 0x334fe20, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Seq() ;

/// @brief Method get_Type, addr 0x334fe28, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method SendToRecordLayer, addr 0x334fd60, size 0xc0, virtual false, abstract: false, final false
inline void SendToRecordLayer(::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*  recordLayer) ;

/// @brief Method .ctor, addr 0x334fd58, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ReceivedHandshakeRecord, addr 0x334fe38, size 0x28, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x334f4a0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method BackOff, addr 0x334f4a8, size 0x64, virtual false, abstract: false, final false
inline int32_t BackOff(int32_t  timeoutMillis) ;

/// @brief Method CheckAll, addr 0x334f890, size 0x390, virtual false, abstract: false, final false
static inline bool CheckAll(::System::Collections::IDictionary*  inboundFlight) ;

/// @brief Method CheckInboundFlight, addr 0x334e5c8, size 0x350, virtual false, abstract: false, final false
inline void CheckInboundFlight() ;

/// @brief Method Finish, addr 0x334a24c, size 0x98, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method GetPendingMessage, addr 0x334ec74, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method NotifyHelloComplete, addr 0x334a140, size 0xb0, virtual false, abstract: false, final false
inline void NotifyHelloComplete() ;

/// @brief Method PrepareInboundFlight, addr 0x334ec48, size 0x2c, virtual false, abstract: false, final false
inline void PrepareInboundFlight(::System::Collections::IDictionary*  nextFlight) ;

/// @brief Method PrepareToFinish, addr 0x334a2e4, size 0xb8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* PrepareToFinish() ;

/// @brief Method ProcessRecord, addr 0x334f018, size 0x488, virtual false, abstract: false, final false
inline void ProcessRecord(int32_t  windowSize, int32_t  epoch, ::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method ReceiveMessage, addr 0x3349c50, size 0x318, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::DtlsReliableHandshake_Message* ReceiveMessage() ;

/// @brief Method ReceiveMessageBody, addr 0x334a1f0, size 0x5c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReceiveMessageBody(uint8_t  msg_type) ;

/// @brief Method ResendOutboundFlight, addr 0x334ee0c, size 0x20c, virtual false, abstract: false, final false
inline void ResendOutboundFlight() ;

/// @brief Method ResetAll, addr 0x334f50c, size 0x384, virtual false, abstract: false, final false
static inline void ResetAll(::System::Collections::IDictionary*  inboundFlight) ;

/// @brief Method ResetHandshakeMessagesDigest, addr 0x334a098, size 0xa8, virtual false, abstract: false, final false
inline void ResetHandshakeMessagesDigest() ;

/// @brief Method SendMessage, addr 0x3349a80, size 0x1d0, virtual false, abstract: false, final false
inline void SendMessage(uint8_t  msg_type, ::ArrayW<uint8_t,::Array<uint8_t>*>  body) ;

/// @brief Method UpdateHandshakeMessagesDigest, addr 0x334ea30, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method WriteHandshakeFragment, addr 0x334fc20, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method WriteMessage, addr 0x334e928, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3349930, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_HandshakeHash, addr 0x334e5c0, size 0x8, virtual false, abstract: false, final false
