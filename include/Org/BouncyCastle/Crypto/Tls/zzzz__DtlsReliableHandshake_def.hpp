...
public:
  ...
  /// @brief Method .ctor, addr 0x338af5c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(int32_t message_seq, uint8_t msg_type, ::ArrayW<uint8_t, ::Array<uint8_t>*> body);

  /// @brief Method get_Body, addr 0x338c474, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Body();

  /// @brief Method get_Seq, addr 0x338c464, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Seq();

  /// @brief Method get_Type, addr 0x338c46c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SendToRecordLayer, addr 0x338c3a4, size 0xc0, virtual false, abstract: false, final false
  inline void SendToRecordLayer(::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer* recordLayer);

  /// @brief Method .ctor, addr 0x338c39c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ReceivedHandshakeRecord, addr 0x338c47c, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x338bae4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BackOff, addr 0x338baec, size 0x64, virtual false, abstract: false, final false
  inline int32_t BackOff(int32_t timeoutMillis);

  /// @brief Method CheckAll, addr 0x338bed4, size 0x390, virtual false, abstract: false, final false
  static inline bool CheckAll(::System::Collections::IDictionary* inboundFlight);

  /// @brief Method CheckInboundFlight, addr 0x338ac0c, size 0x350, virtual false, abstract: false, final false
  inline void CheckInboundFlight();

  /// @brief Method Finish, addr 0x3386890, size 0x98, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method GetPendingMessage, addr 0x338b2b8, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyHelloComplete, addr 0x3386784, size 0xb0, virtual false, abstract: false, final false
  inline void NotifyHelloComplete();

  /// @brief Method PrepareInboundFlight, addr 0x338b28c, size 0x2c, virtual false, abstract: false, final false
  inline void PrepareInboundFlight(::System::Collections::IDictionary* nextFlight);

  /// @brief Method PrepareToFinish, addr 0x3386928, size 0xb8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* PrepareToFinish();

  /// @brief Method ProcessRecord, addr 0x338b65c, size 0x488, virtual false, abstract: false, final false
  inline void ProcessRecord(int32_t windowSize, int32_t epoch, ::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ReceiveMessage, addr 0x3386294, size 0x318, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::DtlsReliableHandshake_Message* ReceiveMessage();

  /// @brief Method ReceiveMessageBody, addr 0x3386834, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReceiveMessageBody(uint8_t msg_type);

  /// @brief Method ResendOutboundFlight, addr 0x338b450, size 0x20c, virtual false, abstract: false, final false
  inline void ResendOutboundFlight();

  /// @brief Method ResetAll, addr 0x338bb50, size 0x384, virtual false, abstract: false, final false
  static inline void ResetAll(::System::Collections::IDictionary* inboundFlight);

  /// @brief Method ResetHandshakeMessagesDigest, addr 0x33866dc, size 0xa8, virtual false, abstract: false, final false
  inline void ResetHandshakeMessagesDigest();

  /// @brief Method SendMessage, addr 0x33860c4, size 0x1d0, virtual false, abstract: false, final false
  inline void SendMessage(uint8_t msg_type, ::ArrayW<uint8_t, ::Array<uint8_t>*> body);

  /// @brief Method UpdateHandshakeMessagesDigest, addr 0x338b074, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteHandshakeFragment, addr 0x338c264, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteMessage, addr 0x338af6c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3385f74, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HandshakeHash, addr 0x338ac04, size 0x8, virtual false, abstract: false, final false
