...
public:
  // Declarations
  /// @brief Method EncodeTo, addr 0xfd0978, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd0910, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Encode, addr 0xfd056c, size 0x3a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd03f0, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t type, ::System::Collections::IList* urlAndHashList);

  /// @brief Method get_Type, addr 0xfd055c, size 0x8, virtual true, abstract: false, final false
  inline uint8_t get_Type();

  /// @brief Method get_UrlAndHashList, addr 0xfd0564, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IList* get_UrlAndHashList();

  /// @brief Method parse, addr 0xfd0a5c, size 0x298, virtual false, abstract: false, final false
