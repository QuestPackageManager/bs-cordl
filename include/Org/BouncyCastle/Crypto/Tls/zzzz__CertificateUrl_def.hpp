...
public:
  // Declarations
  /// @brief Method EncodeTo, addr 0x343952c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34394c0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Encode, addr 0x3439120, size 0x3a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3438fb4, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t type, ::System::Collections::IList* urlAndHashList);

  /// @brief Method get_Type, addr 0x3439110, size 0x8, virtual true, abstract: false, final false
  inline uint8_t get_Type();

  /// @brief Method get_UrlAndHashList, addr 0x3439118, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IList* get_UrlAndHashList();

  /// @brief Method parse, addr 0x3439648, size 0x2a0, virtual false, abstract: false, final false
