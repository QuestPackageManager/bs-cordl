...
public:
  // Declarations
  /// @brief Method CreateAESCipher, addr 0x343e140, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateAeadBlockCipher_Aes_Ccm, addr 0x343eb5c, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher* CreateAeadBlockCipher_Aes_Ccm();

  /// @brief Method CreateAeadBlockCipher_Aes_Gcm, addr 0x343ebd8, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher* CreateAeadBlockCipher_Aes_Gcm();

  /// @brief Method CreateAeadBlockCipher_Aes_Ocb, addr 0x343ec54, size 0x98, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher* CreateAeadBlockCipher_Aes_Ocb();

  /// @brief Method CreateAeadBlockCipher_Camellia_Gcm, addr 0x343ecec, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher* CreateAeadBlockCipher_Camellia_Gcm();

  /// @brief Method CreateAesBlockCipher, addr 0x343eae0, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* CreateAesBlockCipher();

  /// @brief Method CreateAesEngine, addr 0x343ea44, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* CreateAesEngine();

  /// @brief Method CreateCamelliaBlockCipher, addr 0x343ed68, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* CreateCamelliaBlockCipher();

  /// @brief Method CreateCamelliaCipher, addr 0x343e23c, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateCamelliaEngine, addr 0x343ea88, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* CreateCamelliaEngine();

  /// @brief Method CreateChaCha20Poly1305, addr 0x343e338, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCipher* CreateChaCha20Poly1305(::Org::BouncyCastle::Crypto::Tls::TlsContext* context);

  /// @brief Method CreateCipher, addr 0x343df88, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateCipher_Aes_Ccm, addr 0x343e394, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateCipher_Aes_Gcm, addr 0x343e454, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateCipher_Aes_Ocb, addr 0x343e514, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateCipher_Camellia_Gcm, addr 0x343e5d8, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateDesEdeBlockCipher, addr 0x343ede4, size 0x88, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* CreateDesEdeBlockCipher();

  /// @brief Method CreateDesEdeCipher, addr 0x343e698, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateHMacDigest, addr 0x343ef34, size 0xfc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IDigest* CreateHMacDigest(int32_t macAlgorithm);

  /// @brief Method CreateNullCipher, addr 0x343e790, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRC4Cipher, addr 0x343e844, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRC4StreamCipher, addr 0x343ee6c, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IStreamCipher* CreateRC4StreamCipher();

  /// @brief Method CreateSeedBlockCipher, addr 0x343eeb0, size 0x84, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* CreateSeedBlockCipher();

  /// @brief Method CreateSeedCipher, addr 0x343e94c, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34353bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsCipherFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultTlsCipherFactory(DefaultTlsCipherFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsCipherFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultTlsCipherFactory(DefaultTlsCipherFactoryconst&) = delete;
