...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x33abe68, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t group);

  static inline ::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup* New_ctor();

  /// @brief Method .ctor, addr 0x33abe78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
