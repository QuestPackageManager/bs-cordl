...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x346b444, size 0x10, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t group);

  static inline ::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup* New_ctor();

  /// @brief Method .ctor, addr 0x346b454, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FiniteFieldDheGroup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FiniteFieldDheGroup(FiniteFieldDheGroup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FiniteFieldDheGroup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FiniteFieldDheGroup(FiniteFieldDheGroupconst&) = delete;
