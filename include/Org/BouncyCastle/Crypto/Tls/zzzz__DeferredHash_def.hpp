...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DeferredHash*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DeferredHash*, "Org.BouncyCastle.Crypto.Tls", "DeferredHash");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x34400c0, size 0x43c, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method CheckStopBuffering, addr 0x3440948, size 0x43c, virtual true, abstract: false, final false
  inline void CheckStopBuffering();

  /// @brief Method CheckTrackingHash, addr 0x3440d84, size 0x198, virtual true, abstract: false, final false
  inline void CheckTrackingHash(uint8_t hashAlgorithm);

  /// @brief Method DoFinal, addr 0x34404fc, size 0x4c, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ForkPrfHash, addr 0x343f7f8, size 0x1b8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IDigest* ForkPrfHash();

  /// @brief Method GetByteLength, addr 0x343fc10, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetByteLength();

  /// @brief Method GetDigestSize, addr 0x343fc5c, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetDigestSize();

  /// @brief Method GetFinalHash, addr 0x343f9b0, size 0x214, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetFinalHash(uint8_t hashAlgorithm);

  /// @brief Method Init, addr 0x343f3b0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NotifyPrfDetermined, addr 0x343f3b8, size 0x18c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* NotifyPrfDetermined();

  /// @brief Method Reset, addr 0x3440548, size 0x400, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SealHashAlgorithms, addr 0x343f62c, size 0x10, virtual true, abstract: false, final false
  inline void SealHashAlgorithms();

  /// @brief Method StopTracking, addr 0x343f63c, size 0x1bc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* StopTracking();

  /// @brief Method TrackHashAlgorithm, addr 0x343f5c8, size 0x64, virtual true, abstract: false, final false
  inline void TrackHashAlgorithm(uint8_t hashAlgorithm);

  /// @brief Method Update, addr 0x343fca8, size 0x418, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x343f1f0, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x343f290, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(uint8_t prfHashAlgorithm, ::Org::BouncyCastle::Crypto::IDigest* prfHash);

  /// @brief Method get_AlgorithmName, addr 0x343fbc4, size 0x4c, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DeferredHash) == 0x30, "Size mismatch!");
