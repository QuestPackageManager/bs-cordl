...
public:
  ...
  /// @brief Method Encode, addr 0x2413490, size 0x6c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  static inline ::Org::BouncyCastle::Crypto::Tls::HeartbeatExtension* New_ctor(uint8_t mode);

  /// @brief Method Parse, addr 0x24134fc, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24133e0, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(uint8_t mode);

  /// @brief Method get_Mode, addr 0x2413488, size 0x8, virtual true, abstract: false, final false
