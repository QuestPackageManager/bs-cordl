...
public:
  ...
  /// @brief Method Encode, addr 0x11f6808, size 0x6c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  static inline ::Org::BouncyCastle::Crypto::Tls::HeartbeatExtension* New_ctor(uint8_t mode);

  /// @brief Method Parse, addr 0x11f6874, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f6754, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(uint8_t mode);

  /// @brief Method get_Mode, addr 0x11f6800, size 0x8, virtual true, abstract: false, final false
