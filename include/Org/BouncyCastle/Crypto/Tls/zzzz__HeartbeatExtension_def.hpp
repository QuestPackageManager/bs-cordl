...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::HeartbeatExtension*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::HeartbeatExtension*, "Org.BouncyCastle.Crypto.Tls", "HeartbeatExtension");
...
public:
  ...
  /// @brief Method Encode, addr 0x346b788, size 0x80, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  static inline ::Org::BouncyCastle::Crypto::Tls::HeartbeatExtension* New_ctor(uint8_t mode);

  /// @brief Method Parse, addr 0x346b808, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x346b6f0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t mode);

  /// @brief Method get_Mode, addr 0x346b780, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HeartbeatExtension", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HeartbeatExtension(HeartbeatExtension&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HeartbeatExtension", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HeartbeatExtension(HeartbeatExtensionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::HeartbeatExtension) == 0x18, "Size mismatch!");
