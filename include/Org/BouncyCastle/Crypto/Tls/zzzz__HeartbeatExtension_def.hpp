...
/// @brief Method Encode, addr 0x336fb68, size 0x80, virtual true, abstract: false, final false
inline void Encode(::System::IO::Stream*  output) ;

static inline ::Org::BouncyCastle::Crypto::Tls::HeartbeatExtension* New_ctor(uint8_t  mode) ;

/// @brief Method Parse, addr 0x336fbe8, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x336fad0, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(uint8_t  mode) ;

/// @brief Method get_Mode, addr 0x336fb60, size 0x8, virtual true, abstract: false, final false
