...
public:
  ...
  /// @brief Method GetPsk, addr 0x333c6dc, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPsk();

  /// @brief Method GetPskIdentity, addr 0x333c6d4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NotifyIdentityHint, addr 0x333c6d0, size 0x4, virtual true, abstract: false, final false
  inline void NotifyIdentityHint(::ArrayW<uint8_t, ::Array<uint8_t>*> psk_identity_hint);

  /// @brief Method SkipIdentityHint, addr 0x333c6cc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x333c5c0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> identity, ::ArrayW<uint8_t, ::Array<uint8_t>*> psk);

  /// @brief Method .ctor, addr 0x333c644, size 0x88, virtual false, abstract: false, final false
