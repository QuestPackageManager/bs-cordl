...
public:
  ...
  /// @brief Method CreateSigner, addr 0x348e404, size 0xdc, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Tls::TlsSigner* CreateSigner(int32_t keyExchange);

  /// @brief Method GenerateClientKeyExchange, addr 0x348f6d0, size 0x124, virtual true, abstract: false, final false
  inline void GenerateClientKeyExchange(::System::IO::Stream* output);

  /// @brief Method GeneratePremasterSecret, addr 0x348faf4, size 0x11c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GeneratePremasterSecret();

  /// @brief Method GenerateServerKeyExchange, addr 0x348ebdc, size 0x558, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateServerKeyExchange();

  /// @brief Method Init, addr 0x348e6f8, size 0xd0, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::Tls::TlsContext* context);

  /// @brief Method InitVerifyer, addr 0x348fc10, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessClientCredentials, addr 0x348f698, size 0x38, virtual true, abstract: false, final false
  inline void ProcessClientCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* clientCredentials);

  /// @brief Method ProcessClientKeyExchange, addr 0x348f878, size 0x1e0, virtual true, abstract: false, final false
  inline void ProcessClientKeyExchange(::System::IO::Stream* input);

  /// @brief Method ProcessServerCertificate, addr 0x348e80c, size 0x260, virtual true, abstract: false, final false
  inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* serverCertificate);

  /// @brief Method ProcessServerCredentials, addr 0x348ea6c, size 0x168, virtual true, abstract: false, final false
  inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* serverCredentials);

  /// @brief Method ProcessServerKeyExchange, addr 0x348f134, size 0x52c, virtual true, abstract: false, final false
  inline void ProcessServerKeyExchange(::System::IO::Stream* input);

  /// @brief Method SkipServerCredentials, addr 0x348e7c8, size 0x44, virtual true, abstract: false, final false
  inline void SkipServerCredentials();

  /// @brief Method ValidateCertificateRequest, addr 0x348f660, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x348e570, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x348e618, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(int32_t keyExchange, ::System::Collections::IList* supportedSignatureAlgorithms, ::ArrayW<uint8_t> identity,
                    ::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters* loginParameters);

  /// @brief Method .ctor, addr 0x348e4e0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_RequiresServerKeyExchange, addr 0x348ebd4, size 0x8, virtual true, abstract: false, final false
