...
public:
  ...
  /// @brief Method CloneCertificateList, addr 0x3439cc0, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*> CloneCertificateList();

  /// @brief Method Encode, addr 0x3439374, size 0x4b0, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetCertificateAt, addr 0x343930c, size 0x30, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* GetCertificateAt(int32_t index);

  /// @brief Method GetCertificateList, addr 0x3439300, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3439824, size 0x49c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34392a8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEmpty, addr 0x3439354, size 0x20, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Length, addr 0x343933c, size 0x18, virtual true, abstract: false, final false
...
public:
  ...
  Certificate(Certificateconst&) = delete;
