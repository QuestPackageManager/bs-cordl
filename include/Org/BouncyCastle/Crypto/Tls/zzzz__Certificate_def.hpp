...
public:
  ...
  /// @brief Method CloneCertificateList, addr 0x333e150, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x333d804, size 0x4b0, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetCertificateAt, addr 0x333d79c, size 0x30, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* GetCertificateAt(int32_t index);

  /// @brief Method GetCertificateList, addr 0x333d790, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x333dcb4, size 0x49c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x333d738, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEmpty, addr 0x333d7e4, size 0x20, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Length, addr 0x333d7cc, size 0x18, virtual true, abstract: false, final false
