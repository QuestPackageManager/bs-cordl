...
public:
  ...
  /// @brief Method CloneCertificateList, addr 0x337a6e4, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x3379d98, size 0x4b0, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetCertificateAt, addr 0x3379d30, size 0x30, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* GetCertificateAt(int32_t index);

  /// @brief Method GetCertificateList, addr 0x3379d24, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x337a248, size 0x49c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3379ccc, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEmpty, addr 0x3379d78, size 0x20, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Length, addr 0x3379d60, size 0x18, virtual true, abstract: false, final false
