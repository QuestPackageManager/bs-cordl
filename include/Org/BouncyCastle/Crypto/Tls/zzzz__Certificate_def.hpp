...
public:
  ...
  /// @brief Method CloneCertificateList, addr 0x23afd78, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Encode, addr 0x23af454, size 0x4c4, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetCertificateAt, addr 0x23af3e4, size 0x30, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* GetCertificateAt(int32_t index);

  /// @brief Method GetCertificateList, addr 0x23af3d8, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x23af918, size 0x460, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23af364, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEmpty, addr 0x23af430, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Length, addr 0x23af414, size 0x1c, virtual true, abstract: false, final false
