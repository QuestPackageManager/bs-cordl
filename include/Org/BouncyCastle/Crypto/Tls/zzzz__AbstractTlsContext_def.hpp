...
public:
  ...
  /// @brief Method ExportKeyingMaterial, addr 0xfcb07c, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method NextCounterValue, addr 0xfcaca8, size 0x58, virtual false, abstract: false, final false
  static inline int64_t NextCounterValue();

  /// @brief Method SetClientVersion, addr 0xfcb044, size 0x8, virtual true, abstract: false, final false
  inline void SetClientVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* clientVersion);

  /// @brief Method SetResumableSession, addr 0xfcb064, size 0x8, virtual true, abstract: false, final false
  inline void SetResumableSession(::Org::BouncyCastle::Crypto::Tls::TlsSession* session);

  /// @brief Method SetServerVersion, addr 0xfcb054, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfcad00, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ClientVersion, addr 0xfcb03c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_NonceRandomGenerator, addr 0xfcb024, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Prng::IRandomGenerator* get_NonceRandomGenerator();

  /// @brief Method get_ResumableSession, addr 0xfcb05c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsSession* get_ResumableSession();

  /// @brief Method get_SecureRandom, addr 0xfcb02c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Security::SecureRandom* get_SecureRandom();

  /// @brief Method get_SecurityParameters, addr 0xfcb034, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::SecurityParameters* get_SecurityParameters();

  /// @brief Method get_ServerVersion, addr 0xfcb04c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ServerVersion();

  /// @brief Method get_UserObject, addr 0xfcb06c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_UserObject, addr 0xfcb074, size 0x8, virtual true, abstract: false, final false
