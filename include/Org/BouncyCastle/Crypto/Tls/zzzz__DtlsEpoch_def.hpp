...
public:
  ...
  /// @brief Method AllocateSequenceNumber, addr 0xfdd3a0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfdd258, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(int32_t epoch, ::Org::BouncyCastle::Crypto::Tls::TlsCipher* cipher);

  /// @brief Method get_Cipher, addr 0xfdd494, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCipher* get_Cipher();

  /// @brief Method get_Epoch, addr 0xfdd49c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Epoch();

  /// @brief Method get_ReplayWindow, addr 0xfdd4a4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::DtlsReplayWindow* get_ReplayWindow();

  /// @brief Method get_SequenceNumber, addr 0xfdd4ac, size 0x34, virtual false, abstract: false, final false
