...
public:
  ...
  /// @brief Method AllocateSequenceNumber, addr 0xffeaa4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xffe95c, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(int32_t epoch, ::Org::BouncyCastle::Crypto::Tls::TlsCipher* cipher);

  /// @brief Method get_Cipher, addr 0xffeb98, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCipher* get_Cipher();

  /// @brief Method get_Epoch, addr 0xffeba0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Epoch();

  /// @brief Method get_ReplayWindow, addr 0xffeba8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::DtlsReplayWindow* get_ReplayWindow();

  /// @brief Method get_SequenceNumber, addr 0xffebb0, size 0x34, virtual false, abstract: false, final false
