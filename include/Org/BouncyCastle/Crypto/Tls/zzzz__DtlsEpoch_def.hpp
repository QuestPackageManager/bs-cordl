...
public:
  ...
  /// @brief Method AllocateSequenceNumber, addr 0x3445c54, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3445b34, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(int32_t epoch, ::Org::BouncyCastle::Crypto::Tls::TlsCipher* cipher);

  /// @brief Method get_Cipher, addr 0x3445d3c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsCipher* get_Cipher();

  /// @brief Method get_Epoch, addr 0x3445d44, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Epoch();

  /// @brief Method get_ReplayWindow, addr 0x3445d4c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::DtlsReplayWindow* get_ReplayWindow();

  /// @brief Method get_SequenceNumber, addr 0x3445d54, size 0x2c, virtual false, abstract: false, final false
