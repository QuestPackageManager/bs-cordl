...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsAuthentication*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsAuthentication*, "Org.BouncyCastle.Crypto.Tls", "TlsAuthentication");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "TlsAuthentication", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsAuthentication(TlsAuthenticationconst&) = delete;
