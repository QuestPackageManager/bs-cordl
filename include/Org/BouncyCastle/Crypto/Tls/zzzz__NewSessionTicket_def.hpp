...
/// @brief Method Encode, addr 0x33702f4, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method Parse, addr 0x3370374, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33702dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int64_t  ticketLifetimeHint, ::ArrayW<uint8_t,::Array<uint8_t>*>  ticket) ;

/// @brief Method get_Ticket, addr 0x33702ec, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Ticket() ;

/// @brief Method get_TicketLifetimeHint, addr 0x33702e4, size 0x8, virtual true, abstract: false, final false
