...
public:
  ...
  /// @brief Method Encode, addr 0x3469b8c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3469c0c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3469b74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int64_t ticketLifetimeHint, ::ArrayW<uint8_t> ticket);

  /// @brief Method get_Ticket, addr 0x3469b84, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Ticket();

  /// @brief Method get_TicketLifetimeHint, addr 0x3469b7c, size 0x8, virtual true, abstract: false, final false
