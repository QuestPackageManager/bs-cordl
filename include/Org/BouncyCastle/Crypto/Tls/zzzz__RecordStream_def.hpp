...
public:
  ...
  /// @brief Method Write, addr 0x33af4a0, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ae128, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method NextValue, addr 0x33aecd8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ae11c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckLength, addr 0x33ae628, size 0x50, virtual false, abstract: false, final false
  static inline void CheckLength(int32_t length, int32_t limit, uint8_t alertDescription);

  /// @brief Method CheckRecordHeader, addr 0x33ae48c, size 0x148, virtual true, abstract: false, final false
  inline void CheckRecordHeader(::ArrayW<uint8_t, ::Array<uint8_t>*> recordHeader);

  /// @brief Method CheckType, addr 0x33ae5d4, size 0x54, virtual false, abstract: false, final false
  static inline void CheckType(uint8_t type, uint8_t alertDescription);

  /// @brief Method DecodeAndVerify, addr 0x33aea48, size 0x290, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeAndVerify(uint8_t type, ::System::IO::Stream* input, int32_t len);

  /// @brief Method FinaliseHandshake, addr 0x33ae414, size 0x78, virtual true, abstract: false, final false
  inline void FinaliseHandshake();

  /// @brief Method Flush, addr 0x33af480, size 0x20, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method GetBufferContents, addr 0x33aed44, size 0x54, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBufferContents();

  /// @brief Method GetPlaintextLimit, addr 0x33ae274, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetPlaintextLimit();

  /// @brief Method Init, addr 0x33ae150, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method NotifyHelloComplete, addr 0x33af17c, size 0xb0, virtual true, abstract: false, final false
  inline void NotifyHelloComplete();

  /// @brief Method PrepareToFinish, addr 0x33af23c, size 0xb8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* PrepareToFinish();

  /// @brief Method ReadRecord, addr 0x33ae678, size 0x1c8, virtual true, abstract: false, final false
  inline bool ReadRecord();

  /// @brief Method ReceivedReadCipherSpec, addr 0x33ae36c, size 0xa8, virtual true, abstract: false, final false
  inline void ReceivedReadCipherSpec();

  /// @brief Method SafeClose, addr 0x33af2f4, size 0x18c, virtual true, abstract: false, final false
  inline void SafeClose();

  /// @brief Method SentWriteCipherSpec, addr 0x33ae2c4, size 0xa8, virtual true, abstract: false, final false
  inline void SentWriteCipherSpec();

  /// @brief Method SetPendingConnectionState, addr 0x33ae2b8, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetPlaintextLimit, addr 0x33ae27c, size 0x1c, virtual true, abstract: false, final false
  inline void SetPlaintextLimit(int32_t plaintextLimit);

  /// @brief Method SetRestrictReadVersion, addr 0x33ae2b0, size 0x8, virtual true, abstract: false, final false
  inline void SetRestrictReadVersion(bool enabled);

  /// @brief Method SetWriteVersion, addr 0x33ae2a8, size 0x8, virtual true, abstract: false, final false
  inline void SetWriteVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* writeVersion);

  /// @brief Method WriteRecord, addr 0x33aed98, size 0x3e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33adfdc, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsProtocol* handler, ::System::IO::Stream* input, ::System::IO::Stream* output);

  /// @brief Method get_HandshakeHash, addr 0x33af22c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* get_HandshakeHash();

  /// @brief Method get_HandshakeHashUpdater, addr 0x33af234, size 0x8, virtual true, abstract: false, final false
  inline ::System::IO::Stream* get_HandshakeHashUpdater();

  /// @brief Method get_ReadVersion, addr 0x33ae298, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ReadVersion();

  /// @brief Method set_ReadVersion, addr 0x33ae2a0, size 0x8, virtual true, abstract: false, final false
