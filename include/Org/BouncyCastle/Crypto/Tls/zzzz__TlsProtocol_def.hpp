...
public:
  ...
  /// @brief Method .ctor addr 0xf28314 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf28608 size 0x8c virtual false final false
  inline void _ctor(uint8_t handshakeType, int32_t length);

  /// @brief Method Write addr 0xf29bf8 size 0x28 virtual false final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method WriteToRecordStream addr 0xf2831c size 0x124 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xf25578 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0xf25584 size 0x154 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf256d8 size 0x1a0 virtual false final false
  ...
  /// @brief Method HandleAlertMessage addr 0xf25878 size 0x13c virtual true final false
  inline void HandleAlertMessage(uint8_t alertLevel, uint8_t alertDescription);

  /// @brief Method HandleAlertWarningMessage addr 0xf259b4 size 0x88 virtual true final false
  inline void HandleAlertWarningMessage(uint8_t alertDescription);

  /// @brief Method HandleChangeCipherSpecMessage addr 0xf25a3c size 0x4 virtual true final false
  inline void HandleChangeCipherSpecMessage();

  /// @brief Method HandleClose addr 0xf25a40 size 0xfc virtual true final false
  inline void HandleClose(bool user_canceled);

  /// @brief Method HandleException addr 0xf25b3c size 0x78 virtual true final false
  inline void HandleException(uint8_t alertDescription, ::StringW message, ::System::Exception* cause);

  /// @brief Method HandleFailure addr 0xf25bb4 size 0x84 virtual true final false
  ...
  /// @brief Method ApplyMaxFragmentLengthExtension addr 0xf25c38 size 0x98 virtual true final false
  inline void ApplyMaxFragmentLengthExtension();

  /// @brief Method CheckReceivedChangeCipherSpec addr 0xf25cd0 size 0x5c virtual true final false
  inline void CheckReceivedChangeCipherSpec(bool expected);

  /// @brief Method CleanupHandshake addr 0xf25d2c size 0x9c virtual true final false
  inline void CleanupHandshake();

  /// @brief Method BlockForHandshake addr 0xf25dc8 size 0x90 virtual true final false
  inline void BlockForHandshake();

  /// @brief Method CompleteHandshake addr 0xf25e58 size 0x52c virtual true final false
  inline void CompleteHandshake();

  /// @brief Method ProcessRecord addr 0xf1dd50 size 0x214 virtual false final false
  inline void ProcessRecord(uint8_t protocol, ::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ProcessHandshakeQueue addr 0xf26558 size 0x2dc virtual false final false
  inline void ProcessHandshakeQueue(::Org::BouncyCastle::Crypto::Tls::ByteQueue* queue);

  /// @brief Method ProcessApplicationDataQueue addr 0xf263f4 size 0x4 virtual false final false
  inline void ProcessApplicationDataQueue();

  /// @brief Method ProcessAlertQueue addr 0xf26384 size 0x70 virtual false final false
  inline void ProcessAlertQueue();

  /// @brief Method ProcessChangeCipherSpec addr 0xf263f8 size 0x160 virtual false final false
  inline void ProcessChangeCipherSpec(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ApplicationDataAvailable addr 0xf26834 size 0x1c virtual true final false
  inline int32_t ApplicationDataAvailable();

  /// @brief Method ReadApplicationData addr 0xf26850 size 0x190 virtual true final false
  inline int32_t ReadApplicationData(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t offset, int32_t len);

  /// @brief Method SafeCheckRecordHeader addr 0xf269e0 size 0x1d4 virtual true final false
  inline void SafeCheckRecordHeader(::ArrayW<uint8_t, ::Array<uint8_t>*> recordHeader);

  /// @brief Method SafeReadRecord addr 0xf26bb4 size 0x298 virtual true final false
  inline void SafeReadRecord();

  /// @brief Method SafeWriteRecord addr 0xf26e4c size 0x1d4 virtual true final false
  inline void SafeWriteRecord(uint8_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t offset, int32_t len);

  /// @brief Method WriteData addr 0xf27020 size 0x1e8 virtual true final false
  inline void WriteData(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t offset, int32_t len);

  /// @brief Method SetAppDataSplitMode addr 0xf27208 size 0xb4 virtual true final false
  inline void SetAppDataSplitMode(int32_t appDataSplitMode);

  /// @brief Method WriteHandshakeMessage addr 0xf272bc size 0x190 virtual true final false
  inline void WriteHandshakeMessage(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method get_Stream addr 0xf2744c size 0x64 virtual true final false
  inline ::System::IO::Stream* get_Stream();

  /// @brief Method CloseInput addr 0xf274b0 size 0x124 virtual true final false
  inline void CloseInput();

  /// @brief Method OfferInput addr 0xf275d4 size 0x28 virtual true final false
  inline void OfferInput(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method OfferInput addr 0xf275fc size 0x244 virtual true final false
  inline void OfferInput(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inputOff, int32_t inputLen);

  /// @brief Method GetAvailableInputBytes addr 0xf27840 size 0x6c virtual true final false
  inline int32_t GetAvailableInputBytes();

  /// @brief Method ReadInput addr 0xf278ac size 0x100 virtual true final false
  inline int32_t ReadInput(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t length);

  /// @brief Method OfferOutput addr 0xf279ac size 0xe0 virtual true final false
  inline void OfferOutput(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t length);

  /// @brief Method GetAvailableOutputBytes addr 0xf27a8c size 0x78 virtual true final false
  inline int32_t GetAvailableOutputBytes();

  /// @brief Method ReadOutput addr 0xf27b04 size 0x78 virtual true final false
  inline int32_t ReadOutput(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t length);

  /// @brief Method InvalidateSession addr 0xf27b7c size 0xb8 virtual true final false
  inline void InvalidateSession();

  /// @brief Method ProcessFinishedMessage addr 0xf27c34 size 0x11c virtual true final false
  inline void ProcessFinishedMessage(::System::IO::MemoryStream* buf);

  /// @brief Method RaiseAlertFatal addr 0xf27dd8 size 0x1d0 virtual true final false
  inline void RaiseAlertFatal(uint8_t alertDescription, ::StringW message, ::System::Exception* cause);

  /// @brief Method RaiseAlertWarning addr 0xf27fa8 size 0x13c virtual true final false
  inline void RaiseAlertWarning(uint8_t alertDescription, ::StringW message);

  /// @brief Method SendCertificateMessage addr 0xf280e4 size 0x230 virtual true final false
  inline void SendCertificateMessage(::Org::BouncyCastle::Crypto::Tls::Certificate* certificate);

  /// @brief Method SendChangeCipherSpecMessage addr 0xf28440 size 0x98 virtual true final false
  inline void SendChangeCipherSpecMessage();

  /// @brief Method SendFinishedMessage addr 0xf284d8 size 0x130 virtual true final false
  inline void SendFinishedMessage();

  /// @brief Method SendSupplementalDataMessage addr 0xf28694 size 0x80 virtual true final false
  inline void SendSupplementalDataMessage(::System::Collections::IList* supplementalData);

  /// @brief Method CreateVerifyData addr 0xf28b34 size 0x120 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CreateVerifyData(bool isServer);

  /// @brief Method Close addr 0xf28df4 size 0x10 virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0xf28e04 size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method get_IsClosed addr 0xf28e28 size 0x18 virtual true final false
  inline bool get_IsClosed();

  /// @brief Method ProcessMaxFragmentLengthExtension addr 0xf28e40 size 0xb0 virtual true final false
  ...
  /// @brief Method RefuseRenegotiation addr 0xf28ef0 size 0xe4 virtual true final false
  inline void RefuseRenegotiation();

  /// @brief Method AssertEmpty addr 0xf27d50 size 0x88 virtual false final false
  static inline void AssertEmpty(::System::IO::MemoryStream* buf);

  /// @brief Method CreateRandomBlock addr 0xf28fd4 size 0x114 virtual false final false
  ...
  /// @brief Method CreateRenegotiationInfo addr 0xf290e8 size 0x58 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CreateRenegotiationInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> renegotiated_connection);

  /// @brief Method EstablishMasterSecret addr 0xf29140 size 0x230 virtual false final false
  ...
  /// @brief Method GetCurrentPrfHash addr 0xf28c54 size 0x1a0 virtual false final false
  ...
  /// @brief Method ReadExtensions addr 0xf1fd6c size 0x308 virtual false final false
  static inline ::System::Collections::IDictionary* ReadExtensions(::System::IO::MemoryStream* input);

  /// @brief Method ReadSupplementalDataMessage addr 0xf29370 size 0x224 virtual false final false
  static inline ::System::Collections::IList* ReadSupplementalDataMessage(::System::IO::MemoryStream* input);

  /// @brief Method WriteExtensions addr 0xf20334 size 0xd4 virtual false final false
  static inline void WriteExtensions(::System::IO::Stream* output, ::System::Collections::IDictionary* extensions);

  /// @brief Method WriteSelectedExtensions addr 0xf29594 size 0x4fc virtual false final false
  ...
  /// @brief Method WriteSupplementalData addr 0xf28714 size 0x420 virtual false final false
  static inline void WriteSupplementalData(::System::IO::Stream* output, ::System::Collections::IList* supplementalData);

  /// @brief Method GetPrfAlgorithm addr 0xf29a90 size 0x168 virtual false final false
