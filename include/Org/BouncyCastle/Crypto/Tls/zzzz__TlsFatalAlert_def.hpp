...
public:
  ...
  /// @brief Method .ctor, addr 0x33c4388, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t alertDescription);

  /// @brief Method .ctor, addr 0x33c4754, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(uint8_t alertDescription, ::System::Exception* alertCause);

  /// @brief Method get_AlertDescription, addr 0x33c819c, size 0x8, virtual true, abstract: false, final false
