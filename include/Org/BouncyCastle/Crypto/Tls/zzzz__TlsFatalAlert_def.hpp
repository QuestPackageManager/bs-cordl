...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert*, "Org.BouncyCastle.Crypto.Tls", "TlsFatalAlert");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsFatalAlert", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsFatalAlert(TlsFatalAlert&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsFatalAlert", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsFatalAlert(TlsFatalAlertconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert) == 0x90, "Size mismatch!");
