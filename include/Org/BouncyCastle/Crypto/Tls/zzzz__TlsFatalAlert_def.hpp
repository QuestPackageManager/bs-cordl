...
/// @brief Method .ctor, addr 0x3387d44, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(uint8_t  alertDescription) ;

/// @brief Method .ctor, addr 0x3388110, size 0x50, virtual false, abstract: false, final false
inline void _ctor(uint8_t  alertDescription, ::System::Exception*  alertCause) ;

/// @brief Method get_AlertDescription, addr 0x338bb58, size 0x8, virtual true, abstract: false, final false
