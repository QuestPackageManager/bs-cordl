...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ServerSrpParams*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ServerSrpParams*, "Org.BouncyCastle.Crypto.Tls", "ServerSrpParams");
...
public:
  ...
  __declspec(property(get = get_S)) ::ArrayW<uint8_t> S;
  ...
  /// @brief Method Encode, addr 0x346d5ac, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x346d64c, size 0xe0, virtual false, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Math::BigInteger* const& __cordl_internal_get_m_N() const;

  constexpr ::Org::BouncyCastle::Math::BigInteger*& __cordl_internal_get_m_N();

  constexpr ::Org::BouncyCastle::Math::BigInteger* const& __cordl_internal_get_m_g() const;

  constexpr ::Org::BouncyCastle::Math::BigInteger*& __cordl_internal_get_m_g();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_s() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_s();
  ...
  /// @brief Method .ctor, addr 0x346d504, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_B, addr 0x346d58c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_B();

  /// @brief Method get_G, addr 0x346d594, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_N, addr 0x346d59c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_N();

  /// @brief Method get_S, addr 0x346d5a4, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ServerSrpParams) == 0x30, "Size mismatch!");
