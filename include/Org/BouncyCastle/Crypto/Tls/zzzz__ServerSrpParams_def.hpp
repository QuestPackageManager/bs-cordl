...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ServerSrpParams", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ServerSrpParams(ServerSrpParams&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ServerSrpParams", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ServerSrpParams(ServerSrpParamsconst&) = delete;
