...
public:
  ...
  /// @brief Method .ctor, addr 0x343cc70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClientAuthenticationType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClientAuthenticationType(ClientAuthenticationType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClientAuthenticationType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClientAuthenticationType(ClientAuthenticationTypeconst&) = delete;
