...
public:
  ...
  /// @brief Method GenerateServerKeyExchange, addr 0x33bf3b4, size 0x468, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateServerKeyExchange();

  /// @brief Method InitVerifyer, addr 0x33bfb04, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessServerCredentials, addr 0x33bf254, size 0x160, virtual true, abstract: false, final false
  inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* serverCredentials);

  /// @brief Method ProcessServerKeyExchange, addr 0x33bf81c, size 0x2e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bf1c0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33bf24c, size 0x8, virtual false, abstract: false, final false
