...
public:
  ...
  /// @brief Method GenerateServerKeyExchange, addr 0x347c608, size 0x468, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateServerKeyExchange();

  /// @brief Method InitVerifyer, addr 0x347cd58, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessServerCredentials, addr 0x347c4a8, size 0x160, virtual true, abstract: false, final false
  inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* serverCredentials);

  /// @brief Method ProcessServerKeyExchange, addr 0x347ca70, size 0x2e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x347c414, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x347c4a0, size 0x8, virtual false, abstract: false, final false
