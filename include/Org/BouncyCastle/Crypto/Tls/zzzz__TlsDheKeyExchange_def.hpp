...
public:
  ...
  /// @brief Method GenerateServerKeyExchange, addr 0x2427fc4, size 0x444, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateServerKeyExchange();

  /// @brief Method InitVerifyer, addr 0x24286d0, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessServerCredentials, addr 0x2427e60, size 0x164, virtual true, abstract: false, final false
  inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* serverCredentials);

  /// @brief Method ProcessServerKeyExchange, addr 0x2428408, size 0x2c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2427dd0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2427e58, size 0x8, virtual false, abstract: false, final false
