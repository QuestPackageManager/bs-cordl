...
public:
  ...
  /// @brief Method .ctor, addr 0xfd0cdc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd0d6c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessServerCredentials, addr 0xfd0d74, size 0x16c, virtual true, abstract: false, final false
  inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* serverCredentials);

  /// @brief Method GenerateServerKeyExchange, addr 0xfd0ee0, size 0x44c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateServerKeyExchange();

  /// @brief Method ProcessServerKeyExchange, addr 0xfd132c, size 0x2d8, virtual true, abstract: false, final false
  inline void ProcessServerKeyExchange(::System::IO::Stream* input);

  /// @brief Method InitVerifyer, addr 0xfd1604, size 0x1d0, virtual true, abstract: false, final false
