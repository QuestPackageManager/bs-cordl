...
public:
  ...
  /// @brief Method Encode, addr 0x33b1048, size 0xbc, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method Equals, addr 0x33b0f2c, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x33b1008, size 0x40, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm* New_ctor(uint8_t hash, uint8_t signature);

  /// @brief Method Parse, addr 0x33b1104, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33b0e3c, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(uint8_t hash, uint8_t signature);

  /// @brief Method get_Hash, addr 0x33b0f1c, size 0x8, virtual true, abstract: false, final false
  inline uint8_t get_Hash();

  /// @brief Method get_Signature, addr 0x33b0f24, size 0x8, virtual true, abstract: false, final false
