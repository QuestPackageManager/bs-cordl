...
public:
  ...
  /// @brief Method .ctor, addr 0x121f308, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int32_t, ::Array<int32_t>*> protectionProfiles, ::ArrayW<uint8_t, ::Array<uint8_t>*> mki);

  /// @brief Method get_Mki, addr 0x122617c, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Mki();

  /// @brief Method get_ProtectionProfiles, addr 0x1226174, size 0x8, virtual true, abstract: false, final false
