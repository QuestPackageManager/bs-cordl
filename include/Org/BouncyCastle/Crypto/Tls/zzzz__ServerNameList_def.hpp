...
public:
  ...
  /// @brief Method CheckNameType, addr 0x33aff50, size 0xac, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CheckNameType(::ArrayW<uint8_t, ::Array<uint8_t>*> nameTypesSeen, uint8_t nameType);

  /// @brief Method Encode, addr 0x33afabc, size 0x494, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  static inline ::Org::BouncyCastle::Crypto::Tls::ServerNameList* New_ctor(::System::Collections::IList* serverNameList);

  /// @brief Method Parse, addr 0x33afffc, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33afa5c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* serverNameList);

  /// @brief Method get_ServerNames, addr 0x33afab4, size 0x8, virtual true, abstract: false, final false
