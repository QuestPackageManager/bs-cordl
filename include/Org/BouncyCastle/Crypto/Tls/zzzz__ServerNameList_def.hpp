...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ServerNameList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ServerNameList(ServerNameList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ServerNameList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ServerNameList(ServerNameListconst&) = delete;
