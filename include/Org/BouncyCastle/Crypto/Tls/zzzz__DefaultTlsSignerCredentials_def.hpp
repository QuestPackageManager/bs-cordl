...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsSignerCredentials", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultTlsSignerCredentials(DefaultTlsSignerCredentials&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsSignerCredentials", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultTlsSignerCredentials(DefaultTlsSignerCredentialsconst&) = delete;
