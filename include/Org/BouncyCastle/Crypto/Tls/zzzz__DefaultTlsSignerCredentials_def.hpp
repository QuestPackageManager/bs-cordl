...
public:
  ...
  /// @brief Method GenerateCertificateSignature, addr 0x23e86a4, size 0x238, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e8294, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e829c, size 0x400, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext* context, ::Org::BouncyCastle::Crypto::Tls::Certificate* certificate, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey,
                    ::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm* signatureAndHashAlgorithm);

  /// @brief Method get_Certificate, addr 0x23e869c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::Certificate* get_Certificate();

  /// @brief Method get_SignatureAndHashAlgorithm, addr 0x23e88dc, size 0x8, virtual true, abstract: false, final false
