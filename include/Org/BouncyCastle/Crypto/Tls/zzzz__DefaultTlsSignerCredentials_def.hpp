...
public:
  ...
  /// @brief Method GenerateCertificateSignature, addr 0x33814f4, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33810f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33810fc, size 0x3f0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext* context, ::Org::BouncyCastle::Crypto::Tls::Certificate* certificate, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey,
                    ::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm* signatureAndHashAlgorithm);

  /// @brief Method get_Certificate, addr 0x33814ec, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::Certificate* get_Certificate();

  /// @brief Method get_SignatureAndHashAlgorithm, addr 0x3381734, size 0x8, virtual true, abstract: false, final false
