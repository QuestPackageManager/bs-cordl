...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SupplementalDataEntry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SupplementalDataEntry(SupplementalDataEntry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SupplementalDataEntry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SupplementalDataEntry(SupplementalDataEntryconst&) = delete;
