...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::HeartbeatMode*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::HeartbeatMode*, "Org.BouncyCastle.Crypto.Tls", "HeartbeatMode");
...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x346b76c, size 0x14, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t heartbeatMode);

  static inline ::Org::BouncyCastle::Crypto::Tls::HeartbeatMode* New_ctor();

  /// @brief Method .ctor, addr 0x346be94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HeartbeatMode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HeartbeatMode(HeartbeatMode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HeartbeatMode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HeartbeatMode(HeartbeatModeconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::HeartbeatMode) == 0x10, "Size mismatch!");
