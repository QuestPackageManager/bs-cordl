...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(uint8_t)>(&::Org::BouncyCastle::Crypto::Tls::ECBasisType::IsValid)> {
  ...
  constexpr static std::size_t addrs = 0x11f0b70;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Tls::ECBasisType*>::get(), "IsValid", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::ECBasisType::*)()>(&::Org::BouncyCastle::Crypto::Tls::ECBasisType::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x11f0b84;
...
inline bool Org::BouncyCastle::Crypto::Tls::ECBasisType::IsValid(uint8_t ecBasisType) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Tls::ECBasisType*>::get(), "IsValid",
