...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ExtensionType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ExtensionType*, "Org.BouncyCastle.Crypto.Tls", "ExtensionType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x346b440, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ExtensionType) == 0x10, "Size mismatch!");
