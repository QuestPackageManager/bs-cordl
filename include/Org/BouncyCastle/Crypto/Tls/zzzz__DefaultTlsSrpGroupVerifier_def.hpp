...
public:
  ...
  /// @brief Method Accept, addr 0xff7acc, size 0x358, virtual true, abstract: false, final false
  inline bool Accept(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters* group);

  /// @brief Method AreGroupsEqual, addr 0xff7e24, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method AreParametersEqual, addr 0xff7e9c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff7a38, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xff7aa4, size 0x28, virtual false, abstract: false, final false
