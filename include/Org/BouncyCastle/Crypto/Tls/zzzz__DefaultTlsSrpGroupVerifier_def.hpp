...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::DefaultTlsSrpGroupVerifier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::DefaultTlsSrpGroupVerifier*, "Org.BouncyCastle.Crypto.Tls", "DefaultTlsSrpGroupVerifier");
...
public:
  ...
  /// @brief Method Accept, addr 0x34411ac, size 0x320, virtual true, abstract: false, final false
  inline bool Accept(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters* group);

  /// @brief Method AreGroupsEqual, addr 0x34414cc, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method AreParametersEqual, addr 0x3441544, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3441140, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34411a4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsSrpGroupVerifier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultTlsSrpGroupVerifier(DefaultTlsSrpGroupVerifier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsSrpGroupVerifier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultTlsSrpGroupVerifier(DefaultTlsSrpGroupVerifierconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::DefaultTlsSrpGroupVerifier) == 0x18, "Size mismatch!");
