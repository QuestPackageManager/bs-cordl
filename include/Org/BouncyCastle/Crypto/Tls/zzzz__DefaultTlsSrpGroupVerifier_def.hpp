...
public:
  ...
  /// @brief Method Accept, addr 0x23b71c4, size 0x340, virtual true, abstract: false, final false
  inline bool Accept(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters* group);

  /// @brief Method AreGroupsEqual, addr 0x23b7504, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method AreParametersEqual, addr 0x23b757c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b7130, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23b719c, size 0x28, virtual false, abstract: false, final false
