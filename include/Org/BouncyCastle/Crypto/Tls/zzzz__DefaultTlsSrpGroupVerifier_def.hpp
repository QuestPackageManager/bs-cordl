...
public:
  ...
  /// @brief Method Accept, addr 0x11ca5e4, size 0x358, virtual true, abstract: false, final false
  inline bool Accept(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters* group);

  /// @brief Method AreGroupsEqual, addr 0x11ca93c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method AreParametersEqual, addr 0x11ca9b4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ca550, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11ca5bc, size 0x28, virtual false, abstract: false, final false
