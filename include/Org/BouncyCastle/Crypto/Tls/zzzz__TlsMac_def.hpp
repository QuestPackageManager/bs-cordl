...
public:
  ...
  /// @brief Method CalculateMac, addr 0x2431f78, size 0x2f4, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateMacConstantTime, addr 0x2432440, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDigestBlockCount, addr 0x24326c4, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method Truncate, addr 0x24326d4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2431ac0, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MacSecret, addr 0x2431f68, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_MacSecret();

  /// @brief Method get_Size, addr 0x2431f70, size 0x8, virtual true, abstract: false, final false
