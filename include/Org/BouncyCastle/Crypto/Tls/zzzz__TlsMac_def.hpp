...
public:
  ...
  /// @brief Method CalculateMac, addr 0x338c138, size 0x308, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateMacConstantTime, addr 0x338c5f8, size 0x290, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDigestBlockCount, addr 0x338c888, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method Truncate, addr 0x338c898, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x338bc64, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MacSecret, addr 0x338c128, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_MacSecret();

  /// @brief Method get_Size, addr 0x338c130, size 0x8, virtual true, abstract: false, final false
