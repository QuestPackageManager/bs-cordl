...
public:
  ...
  /// @brief Method CalculateMac, addr 0x2433974, size 0x2f4, virtual true, abstract: false, final false
  ...
  /// @brief Method CalculateMacConstantTime, addr 0x2433e3c, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDigestBlockCount, addr 0x24340c0, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method Truncate, addr 0x24340d0, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24334bc, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MacSecret, addr 0x2433964, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_MacSecret();

  /// @brief Method get_Size, addr 0x243396c, size 0x8, virtual true, abstract: false, final false
