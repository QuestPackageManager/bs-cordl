...
/// @brief Method Write, addr 0x3374cd8, size 0xd0, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x3374c20, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3374bf0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method UpdateSigner, addr 0x3374b6c, size 0x84, virtual false, abstract: false, final false
inline void UpdateSigner(::Org::BouncyCastle::Crypto::ISigner*  s) ;

/// @brief Method .ctor, addr 0x3374c18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
