...
public:
  ...
  /// @brief Method .ctor, addr 0x343db1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompressionMethod", modifiers: "&&", def_value: None, comment: None }]
