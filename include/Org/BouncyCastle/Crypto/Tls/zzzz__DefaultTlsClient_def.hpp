...
public:
  ...
  /// @brief Method .ctor addr 0xeee10c size 0x64 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0xeee170 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0xeee248 size 0x30 virtual false final false
  ...
  /// @brief Method GetCipherSuites addr 0xeee278 size 0x70 virtual true final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCipherSuites();

  /// @brief Method GetKeyExchange addr 0xeee2e8 size 0x124 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* GetKeyExchange();

  /// @brief Method CreateDHKeyExchange addr 0xeee40c size 0x84 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateDHKeyExchange(int32_t keyExchange);

  /// @brief Method CreateDheKeyExchange addr 0xeee490 size 0x84 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateDheKeyExchange(int32_t keyExchange);

  /// @brief Method CreateECDHKeyExchange addr 0xeee514 size 0x90 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateECDHKeyExchange(int32_t keyExchange);

  /// @brief Method CreateECDheKeyExchange addr 0xeee5a4 size 0x90 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateECDheKeyExchange(int32_t keyExchange);

  /// @brief Method CreateRsaKeyExchange addr 0xeee634 size 0x68 virtual true final false
