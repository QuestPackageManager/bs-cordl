...
public:
  ...
  /// @brief Method .ctor addr 0xf64330 size 0x64 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0xf64394 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf6446c size 0x30 virtual false final false
  ...
  /// @brief Method GetCipherSuites addr 0xf6449c size 0x70 virtual true final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCipherSuites();

  /// @brief Method GetKeyExchange addr 0xf6450c size 0x124 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* GetKeyExchange();

  /// @brief Method CreateDHKeyExchange addr 0xf64630 size 0x84 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateDHKeyExchange(int32_t keyExchange);

  /// @brief Method CreateDheKeyExchange addr 0xf646b4 size 0x84 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateDheKeyExchange(int32_t keyExchange);

  /// @brief Method CreateECDHKeyExchange addr 0xf64738 size 0x90 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateECDHKeyExchange(int32_t keyExchange);

  /// @brief Method CreateECDheKeyExchange addr 0xf647c8 size 0x90 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateECDheKeyExchange(int32_t keyExchange);

  /// @brief Method CreateRsaKeyExchange addr 0xf64858 size 0x68 virtual true final false
