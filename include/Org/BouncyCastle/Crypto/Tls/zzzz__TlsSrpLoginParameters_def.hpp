...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsSrpLoginParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsSrpLoginParameters(TlsSrpLoginParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsSrpLoginParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsSrpLoginParameters(TlsSrpLoginParametersconst&) = delete;
