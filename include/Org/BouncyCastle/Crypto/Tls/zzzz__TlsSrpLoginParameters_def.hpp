...
public:
  ...
  /// @brief Method .ctor, addr 0x33d2b9c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Group, addr 0x33d2ba8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters* get_Group();

  /// @brief Method get_Salt, addr 0x33d2bb0, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Salt();

  /// @brief Method get_Verifier, addr 0x33d2bb8, size 0x8, virtual true, abstract: false, final false
