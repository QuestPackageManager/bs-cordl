...
public:
  ...
  /// @brief Method DecodeCiphertext, addr 0x3470f98, size 0x554, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeCiphertext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> ciphertext, int32_t offset, int32_t len);

  /// @brief Method EncodePlaintext, addr 0x3470a48, size 0x550, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len);

  /// @brief Method GetAdditionalData, addr 0x34714ec, size 0x170, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetAdditionalData(int64_t seqNo, uint8_t type, int32_t len);

  /// @brief Method GetPlaintextLimit, addr 0x3470a38, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3470578, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3470580, size 0x4b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext* context, ::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher* clientWriteCipher,
