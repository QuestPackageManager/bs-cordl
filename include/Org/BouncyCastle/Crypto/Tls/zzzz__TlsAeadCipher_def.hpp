...
public:
  ...
  /// @brief Method DecodeCiphertext, addr 0x241ec00, size 0x550, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodePlaintext, addr 0x241e6ac, size 0x554, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAdditionalData, addr 0x241f150, size 0x160, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetAdditionalData(int64_t seqNo, uint8_t type, int32_t len);

  /// @brief Method GetPlaintextLimit, addr 0x241e69c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241e1dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241e1e4, size 0x4b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext* context, ::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher* clientWriteCipher,
