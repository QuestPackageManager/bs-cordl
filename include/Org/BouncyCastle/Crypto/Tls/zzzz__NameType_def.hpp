...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x1002d74, size 0xc, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t nameType);

  static inline ::Org::BouncyCastle::Crypto::Tls::NameType* New_ctor();

  /// @brief Method .ctor, addr 0x1002d80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
