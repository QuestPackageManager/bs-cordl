...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x33ac910, size 0xc, virtual false, abstract: false, final false
  static inline bool IsValid(uint8_t nameType);

  static inline ::Org::BouncyCastle::Crypto::Tls::NameType* New_ctor();

  /// @brief Method .ctor, addr 0x33ac91c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
