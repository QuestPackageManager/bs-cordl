...
public:
  ...
  /// @brief Method Cancel, addr 0x23e4db4, size 0xac, virtual true, abstract: false, final false
  inline void Cancel();
  ...
  /// @brief Method GetHandshakeTimeoutMillis, addr 0x23e4e84, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHandshakeTimeoutMillis();

  static inline ::Org::BouncyCastle::Crypto::Tls::AbstractTlsPeer* New_ctor();

  /// @brief Method NotifyAlertRaised, addr 0x23e4ee0, size 0x4, virtual true, abstract: false, final false
  inline void NotifyAlertRaised(uint8_t alertLevel, uint8_t alertDescription, ::StringW message, ::System::Exception* cause);

  /// @brief Method NotifyAlertReceived, addr 0x23e4ee4, size 0x4, virtual true, abstract: false, final false
  inline void NotifyAlertReceived(uint8_t alertLevel, uint8_t alertDescription);

  /// @brief Method NotifyCloseHandle, addr 0x23e4e60, size 0x24, virtual true, abstract: false, final false
  inline void NotifyCloseHandle(::Org::BouncyCastle::Crypto::Tls::TlsCloseable* closeHandle);

  /// @brief Method NotifyHandshakeComplete, addr 0x23e4ee8, size 0x4, virtual true, abstract: false, final false
  inline void NotifyHandshakeComplete();

  /// @brief Method NotifySecureRenegotiation, addr 0x23e4e9c, size 0x44, virtual true, abstract: false, final false
  inline void NotifySecureRenegotiation(bool secureRenegotiation);

  /// @brief Method RequiresExtendedMasterSecret, addr 0x23e4e8c, size 0x8, virtual true, abstract: false, final false
  inline bool RequiresExtendedMasterSecret();

  /// @brief Method ShouldUseGmtUnixTime, addr 0x23e4e94, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e4eec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
