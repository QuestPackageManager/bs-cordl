...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage*);
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage_PayloadBuffer*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage*, "Org.BouncyCastle.Crypto.Tls", "HeartbeatMessage");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage_PayloadBuffer*, "Org.BouncyCastle.Crypto.Tls", "HeartbeatMessage/PayloadBuffer");
...
public:
  ...
  /// @brief Method ToTruncatedByteArray, addr 0x3469a50, size 0xb8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ToTruncatedByteArray(int32_t payloadLength);

  /// @brief Method .ctor, addr 0x3469a48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage_PayloadBuffer) == 0x50, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_mPayload, put = __cordl_internal_set_mPayload)) ::ArrayW<uint8_t> mPayload;
  ...
  /// @brief Method Encode, addr 0x3469674, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3469888, size 0x1c0, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mPayload() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mPayload();
  ...
  constexpr void __cordl_internal_set_mPayload(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_mType(uint8_t value);

  /// @brief Method .ctor, addr 0x346955c, size 0x104, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage) == 0x28, "Size mismatch!");
