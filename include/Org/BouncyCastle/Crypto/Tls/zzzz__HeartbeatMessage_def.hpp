...
/// @brief Method ToTruncatedByteArray, addr 0x33ad598, size 0xb8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ToTruncatedByteArray(int32_t  payloadLength) ;

/// @brief Method .ctor, addr 0x33ad590, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Encode, addr 0x33ad1bc, size 0x214, virtual true, abstract: false, final false
...
/// @brief Method Parse, addr 0x33ad3d0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33ad0a4, size 0x104, virtual false, abstract: false, final false
