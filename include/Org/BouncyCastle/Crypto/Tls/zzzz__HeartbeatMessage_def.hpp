...
public:
  ...
  /// @brief Method ToTruncatedByteArray, addr 0x33ac7fc, size 0xb8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToTruncatedByteArray(int32_t payloadLength);

  /// @brief Method .ctor, addr 0x33ac7f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Encode, addr 0x33ac420, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x33ac634, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ac308, size 0x104, virtual false, abstract: false, final false
