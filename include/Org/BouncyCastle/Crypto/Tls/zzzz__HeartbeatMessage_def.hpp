...
public:
  ...
  /// @brief Method ToTruncatedByteArray, addr 0x1023350, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToTruncatedByteArray(int32_t payloadLength);

  /// @brief Method .ctor, addr 0x1023348, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Encode, addr 0x1022f84, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x1023180, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1022e40, size 0x130, virtual false, abstract: false, final false
