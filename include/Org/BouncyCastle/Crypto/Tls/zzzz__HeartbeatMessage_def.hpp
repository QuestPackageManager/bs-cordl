...
public:
  ...
  /// @brief Method ToTruncatedByteArray, addr 0x23d6e4c, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToTruncatedByteArray(int32_t payloadLength);

  /// @brief Method .ctor, addr 0x23d6e44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Encode, addr 0x23d6a94, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x23d6c90, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d695c, size 0x124, virtual false, abstract: false, final false
