...
public:
  // Declarations
  /// @brief Method ToTruncatedByteArray addr 0xf1bbc8 size 0xa8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf1bbc0 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0xf1b6b8 size 0x130 virtual false final false
  inline void _ctor(uint8_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> payload, int32_t paddingLength);

  /// @brief Method Encode addr 0xf1b7fc size 0x1fc virtual true final false
  inline void Encode(::Org::BouncyCastle::Crypto::Tls::TlsContext* context, ::System::IO::Stream* output);

  /// @brief Method Parse addr 0xf1b9f8 size 0x1c8 virtual false final false
