...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x346b9e8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x346be90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HeartbeatMessageType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HeartbeatMessageType(HeartbeatMessageType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HeartbeatMessageType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HeartbeatMessageType(HeartbeatMessageTypeconst&) = delete;
