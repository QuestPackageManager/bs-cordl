...
public:
// Declarations
/// @brief Method IsValid, addr 0x336fdc8, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3370270, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
