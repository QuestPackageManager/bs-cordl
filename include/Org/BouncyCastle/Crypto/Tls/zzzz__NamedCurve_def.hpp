...
public:
  // Declarations
  /// @brief Method IsValid, addr 0xfbdd60, size 0x28, virtual false, abstract: false, final false
  static inline bool IsValid(int32_t namedCurve);

  /// @brief Method RefersToASpecificNamedCurve, addr 0xfbdd88, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfbdd9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
