...
public:
// Declarations
/// @brief Method IsValid, addr 0x3370298, size 0x1c, virtual false, abstract: false, final false
static inline bool IsValid(int32_t  namedCurve) ;

static inline ::Org::BouncyCastle::Crypto::Tls::NamedCurve* New_ctor() ;

/// @brief Method RefersToASpecificNamedCurve, addr 0x33702b4, size 0x14, virtual false, abstract: false, final false
static inline bool RefersToASpecificNamedCurve(int32_t  namedCurve) ;

/// @brief Method .ctor, addr 0x33702c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
