...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsClientContextImpl*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsClientContextImpl*, "Org.BouncyCastle.Crypto.Tls", "TlsClientContextImpl");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3475440, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x34754b4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsClientContextImpl", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsClientContextImpl(TlsClientContextImpl&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsClientContextImpl", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsClientContextImpl(TlsClientContextImplconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsClientContextImpl) == 0x48, "Size mismatch!");
