...
public:
  ...
  /// @brief Method .ctor, addr 0x241d1dc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x241d24c, size 0x8, virtual true, abstract: false, final false
