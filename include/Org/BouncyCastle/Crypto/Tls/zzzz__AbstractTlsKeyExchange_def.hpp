...
public:
  ...
  /// @brief Method .ctor addr 0xee5354 size 0x30 virtual false final false
  inline void _ctor(int32_t keyExchange, ::System::Collections::IList* supportedSignatureAlgorithms);

  /// @brief Method ParseSignature addr 0xee5384 size 0x98 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Tls::DigitallySigned* ParseSignature(::System::IO::Stream* input);

  /// @brief Method Init addr 0xee54f8 size 0x218 virtual true final false
  ...
  /// @brief Method ProcessServerCertificate addr 0xee5710 size 0x4 virtual true final false
  inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* serverCertificate);

  /// @brief Method ProcessServerCredentials addr 0xee5714 size 0xb8 virtual true final false
  inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* serverCredentials);

  /// @brief Method get_RequiresServerKeyExchange addr 0xee57cc size 0x8 virtual true final false
  inline bool get_RequiresServerKeyExchange();

  /// @brief Method GenerateServerKeyExchange addr 0xee57d4 size 0x64 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateServerKeyExchange();

  /// @brief Method SkipServerKeyExchange addr 0xee5838 size 0x60 virtual true final false
  inline void SkipServerKeyExchange();

  /// @brief Method ProcessServerKeyExchange addr 0xee5898 size 0x60 virtual true final false
  ...
  /// @brief Method SkipClientCredentials addr 0xee58f8 size 0x4 virtual true final false
  ...
  /// @brief Method ProcessClientCertificate addr 0xee58fc size 0x4 virtual true final false
  ...
  /// @brief Method ProcessClientKeyExchange addr 0xee5900 size 0x44 virtual true final false
