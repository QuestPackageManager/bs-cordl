...
public:
  ...
  /// @brief Method ApplyMaxFragmentLengthExtension, addr 0x3347b5c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateMaxFragmentLengthExtension, addr 0x3347bd8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertificate, addr 0x3347c7c, size 0x88, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* certificate);

  /// @brief Method GenerateSupplementalData, addr 0x3347d04, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessFinished, addr 0x3347a2c, size 0x130, virtual true, abstract: false, final false
  inline void ProcessFinished(::ArrayW<uint8_t, ::Array<uint8_t>*> body, ::ArrayW<uint8_t, ::Array<uint8_t>*> expected_verify_data);

  /// @brief Method ValidateSelectedCipherSuite, addr 0x3347d84, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33479d4, size 0x58, virtual false, abstract: false, final false
