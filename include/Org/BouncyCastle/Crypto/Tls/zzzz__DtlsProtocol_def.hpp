...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DtlsProtocol", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DtlsProtocol(DtlsProtocol&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DtlsProtocol", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DtlsProtocol(DtlsProtocolconst&) = delete;
