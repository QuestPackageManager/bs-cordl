...
/// @brief Method ApplyMaxFragmentLengthExtension, addr 0x3347aac, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method EvaluateMaxFragmentLengthExtension, addr 0x3347b28, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method GenerateCertificate, addr 0x3347bcc, size 0x88, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  certificate) ;

/// @brief Method GenerateSupplementalData, addr 0x3347c54, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ProcessFinished, addr 0x334797c, size 0x130, virtual true, abstract: false, final false
inline void ProcessFinished(::ArrayW<uint8_t,::Array<uint8_t>*>  body, ::ArrayW<uint8_t,::Array<uint8_t>*>  expected_verify_data) ;

/// @brief Method ValidateSelectedCipherSuite, addr 0x3347cd4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3347924, size 0x58, virtual false, abstract: false, final false
