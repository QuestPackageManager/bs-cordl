...
public:
  ...
  /// @brief Method .ctor addr 0xef27e0 size 0x78 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* secureRandom);

  /// @brief Method ProcessFinished addr 0xef2858 size 0x130 virtual true final false
  inline void ProcessFinished(::ArrayW<uint8_t, ::Array<uint8_t>*> body, ::ArrayW<uint8_t, ::Array<uint8_t>*> expected_verify_data);

  /// @brief Method ApplyMaxFragmentLengthExtension addr 0xef2988 size 0xa0 virtual false final false
  ...
  /// @brief Method EvaluateMaxFragmentLengthExtension addr 0xef2a28 size 0xac virtual false final false
  ...
  /// @brief Method GenerateCertificate addr 0xef2ad4 size 0x84 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* certificate);

  /// @brief Method GenerateSupplementalData addr 0xef2b58 size 0x7c virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSupplementalData(::System::Collections::IList* supplementalData);

  /// @brief Method ValidateSelectedCipherSuite addr 0xef2bd4 size 0xb4 virtual false final false
