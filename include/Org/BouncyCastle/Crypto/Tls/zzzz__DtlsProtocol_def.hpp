...
public:
  ...
  /// @brief Method ApplyMaxFragmentLengthExtension, addr 0x331d318, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateMaxFragmentLengthExtension, addr 0x331d394, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertificate, addr 0x331d438, size 0x88, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* certificate);

  /// @brief Method GenerateSupplementalData, addr 0x331d4c0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessFinished, addr 0x331d1e8, size 0x130, virtual true, abstract: false, final false
  inline void ProcessFinished(::ArrayW<uint8_t, ::Array<uint8_t>*> body, ::ArrayW<uint8_t, ::Array<uint8_t>*> expected_verify_data);

  /// @brief Method ValidateSelectedCipherSuite, addr 0x331d540, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331d190, size 0x58, virtual false, abstract: false, final false
