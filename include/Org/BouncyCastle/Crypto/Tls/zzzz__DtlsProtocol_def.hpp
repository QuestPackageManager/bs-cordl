...
public:
  ...
  /// @brief Method ApplyMaxFragmentLengthExtension, addr 0x11c63b8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateMaxFragmentLengthExtension, addr 0x11c6458, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCertificate, addr 0x11c6504, size 0x84, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* certificate);

  /// @brief Method GenerateSupplementalData, addr 0x11c6588, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessFinished, addr 0x11c6288, size 0x130, virtual true, abstract: false, final false
  inline void ProcessFinished(::ArrayW<uint8_t, ::Array<uint8_t>*> body, ::ArrayW<uint8_t, ::Array<uint8_t>*> expected_verify_data);

  /// @brief Method ValidateSelectedCipherSuite, addr 0x11c6604, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11c6210, size 0x78, virtual false, abstract: false, final false
