...
public:
  ...
  /// @brief Method GenerateServerKeyExchange, addr 0x3388cd4, size 0x428, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateServerKeyExchange();

  /// @brief Method InitVerifyer, addr 0x33896fc, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessClientCredentials, addr 0x3389674, size 0x88, virtual true, abstract: false, final false
  inline void ProcessClientCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* clientCredentials);

  /// @brief Method ProcessServerCredentials, addr 0x3388b78, size 0x15c, virtual true, abstract: false, final false
  inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* serverCredentials);

  /// @brief Method ProcessServerKeyExchange, addr 0x33892d4, size 0x304, virtual true, abstract: false, final false
  inline void ProcessServerKeyExchange(::System::IO::Stream* input);

  /// @brief Method ValidateCertificateRequest, addr 0x33895d8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3388b70, size 0x8, virtual false, abstract: false, final false
