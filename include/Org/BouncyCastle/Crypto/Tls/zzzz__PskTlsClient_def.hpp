...
public:
  ...
  /// @brief Method CreatePskKeyExchange, addr 0x33adb4c, size 0xac, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreatePskKeyExchange(int32_t keyExchange);

  /// @brief Method GetAuthentication, addr 0x33adb10, size 0x3c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsAuthentication* GetAuthentication();

  /// @brief Method GetCipherSuites, addr 0x33ad9d4, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCipherSuites();

  /// @brief Method GetKeyExchange, addr 0x33ada4c, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ad9c8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ad958, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ad8f4, size 0x64, virtual false, abstract: false, final false
