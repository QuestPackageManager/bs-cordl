...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ContentType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ContentType*, "Org.BouncyCastle.Crypto.Tls", "ContentType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x343b79c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ContentType) == 0x10, "Size mismatch!");
