...
public:
  ...
  /// @brief Method .ctor, addr 0x343cc74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClientCertificateType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClientCertificateType(ClientCertificateType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClientCertificateType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClientCertificateType(ClientCertificateTypeconst&) = delete;
