...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsPskIdentityManager*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsPskIdentityManager*, "Org.BouncyCastle.Crypto.Tls", "TlsPskIdentityManager");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
...
public:
  ...
  inline ::ArrayW<uint8_t> GetHint();

  /// @brief Method GetPsk, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::ArrayW<uint8_t> GetPsk(::ArrayW<uint8_t> identity);

  // Ctor Parameters [CppParam { name: "", ty: "TlsPskIdentityManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsPskIdentityManager(TlsPskIdentityManagerconst&) = delete;
