...
public:
  ...
  /// @brief Method .ctor, addr 0xfdb500, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfdb510, size 0x8, virtual false, abstract: false, final false
