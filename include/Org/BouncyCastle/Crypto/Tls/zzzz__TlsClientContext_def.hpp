...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsClientContext*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsClientContext*, "Org.BouncyCastle.Crypto.Tls", "TlsClientContext");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
