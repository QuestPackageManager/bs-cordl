...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsCompression*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsCompression*, "Org.BouncyCastle.Crypto.Tls", "TlsCompression");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "TlsCompression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsCompression(TlsCompressionconst&) = delete;
