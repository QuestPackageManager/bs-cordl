...
/// @brief Method CheckMac, addr 0x3397cdc, size 0x120, virtual true, abstract: false, final false
inline void CheckMac(int64_t  seqNo, uint8_t  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  recBuf, int32_t  recStart, int32_t  recEnd, ::ArrayW<uint8_t,::Array<uint8_t>*>  calcBuf, int32_t  calcOff, int32_t  calcLen) ;

/// @brief Method DecodeCiphertext, addr 0x3397ae0, size 0x1fc, virtual true, abstract: false, final false
...
/// @brief Method EncodePlaintext, addr 0x33978e0, size 0x200, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3397248, size 0x66c, virtual false, abstract: false, final false
