...
public:
  ...
  /// @brief Method CheckMac, addr 0x3491574, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodeCiphertext, addr 0x3491378, size 0x1fc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeCiphertext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> ciphertext, int32_t offset, int32_t len);

  /// @brief Method EncodePlaintext, addr 0x3491178, size 0x200, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len);

  /// @brief Method GetPlaintextLimit, addr 0x349114c, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method UpdateIV, addr 0x3491694, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3490ae0, size 0x66c, virtual false, abstract: false, final false
