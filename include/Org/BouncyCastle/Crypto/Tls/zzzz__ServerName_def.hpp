...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ServerName", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ServerName(ServerName&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ServerName", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ServerName(ServerNameconst&) = delete;
