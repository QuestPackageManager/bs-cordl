...
public:
  ...
  /// @brief Method Encode, addr 0x3373298, size 0x11c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetHostName, addr 0x337322c, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW GetHostName();

  /// @brief Method IsCorrectType, addr 0x337318c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x33733b4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33730f8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(uint8_t nameType, ::System::Object* name);

  /// @brief Method get_Name, addr 0x3373224, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Name();

  /// @brief Method get_NameType, addr 0x337321c, size 0x8, virtual true, abstract: false, final false
