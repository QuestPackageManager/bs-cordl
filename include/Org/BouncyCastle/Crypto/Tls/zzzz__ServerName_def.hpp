...
public:
  ...
  /// @brief Method Encode, addr 0x11f47ec, size 0x124, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetHostName, addr 0x11f4710, size 0xdc, virtual true, abstract: false, final false
  inline ::StringW GetHostName();

  /// @brief Method IsCorrectType, addr 0x11f4638, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x11f4910, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f4598, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(uint8_t nameType, ::System::Object* name);

  /// @brief Method get_Name, addr 0x11f4708, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Name();

  /// @brief Method get_NameType, addr 0x11f4700, size 0x8, virtual true, abstract: false, final false
