...
public:
  ...
  /// @brief Method Encode, addr 0x241a6a0, size 0x11c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetHostName, addr 0x241a5c8, size 0xd8, virtual true, abstract: false, final false
  inline ::StringW GetHostName();

  /// @brief Method IsCorrectType, addr 0x241a4f4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x241a7bc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241a458, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t nameType, ::System::Object* name);

  /// @brief Method get_Name, addr 0x241a5c0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Name();

  /// @brief Method get_NameType, addr 0x241a5b8, size 0x8, virtual true, abstract: false, final false
