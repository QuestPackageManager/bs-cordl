...
public:
  ...
  /// @brief Method Encode, addr 0x241ea60, size 0x11c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetHostName, addr 0x241e988, size 0xd8, virtual true, abstract: false, final false
  inline ::StringW GetHostName();

  /// @brief Method IsCorrectType, addr 0x241e8b4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x241eb7c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241e818, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t nameType, ::System::Object* name);

  /// @brief Method get_Name, addr 0x241e980, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Name();

  /// @brief Method get_NameType, addr 0x241e978, size 0x8, virtual true, abstract: false, final false
