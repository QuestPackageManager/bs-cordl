...
public:
  ...
  /// @brief Method Encode, addr 0x3348a54, size 0x11c, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetHostName, addr 0x33489e8, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW GetHostName();

  /// @brief Method IsCorrectType, addr 0x3348948, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3348b70, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33488b4, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(uint8_t nameType, ::System::Object* name);

  /// @brief Method get_Name, addr 0x33489e0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Name();

  /// @brief Method get_NameType, addr 0x33489d8, size 0x8, virtual true, abstract: false, final false
