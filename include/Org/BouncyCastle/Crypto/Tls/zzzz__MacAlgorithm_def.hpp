...
public:
  ...
  /// @brief Method .ctor, addr 0x346be9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MacAlgorithm", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MacAlgorithm(MacAlgorithm&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MacAlgorithm", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MacAlgorithm(MacAlgorithmconst&) = delete;
