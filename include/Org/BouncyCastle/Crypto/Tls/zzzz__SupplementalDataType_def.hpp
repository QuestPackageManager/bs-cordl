...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SupplementalDataType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SupplementalDataType*, "Org.BouncyCastle.Crypto.Tls", "SupplementalDataType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3472580, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SupplementalDataType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SupplementalDataType(SupplementalDataType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SupplementalDataType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SupplementalDataType(SupplementalDataTypeconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SupplementalDataType) == 0x10, "Size mismatch!");
