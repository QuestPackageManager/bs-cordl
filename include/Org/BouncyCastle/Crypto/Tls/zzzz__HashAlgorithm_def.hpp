...
public:
  // Declarations
  /// @brief Method GetName, addr 0x33abe80, size 0xf8, virtual false, abstract: false, final false
  static inline ::StringW GetName(uint8_t hashAlgorithm);

  /// @brief Method GetText, addr 0x33abf78, size 0x174, virtual false, abstract: false, final false
  static inline ::StringW GetText(uint8_t hashAlgorithm);

  /// @brief Method IsPrivate, addr 0x33ac0ec, size 0x10, virtual false, abstract: false, final false
  static inline bool IsPrivate(uint8_t hashAlgorithm);

  /// @brief Method IsRecognized, addr 0x33ac0fc, size 0x14, virtual false, abstract: false, final false
  static inline bool IsRecognized(uint8_t hashAlgorithm);

  static inline ::Org::BouncyCastle::Crypto::Tls::HashAlgorithm* New_ctor();

  /// @brief Method .ctor, addr 0x33ac110, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
