...
public:
  ...
  /// @brief Method ReportAuthenticated, addr 0x23f59d4, size 0xc8, virtual false, abstract: false, final false
  inline void ReportAuthenticated(int64_t seq);

  /// @brief Method Reset, addr 0x23f73d4, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ShouldDiscard, addr 0x23f5994, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f36ac, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
