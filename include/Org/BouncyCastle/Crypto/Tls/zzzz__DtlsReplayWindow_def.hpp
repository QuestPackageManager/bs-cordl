...
public:
  ...
  /// @brief Method ReportAuthenticated, addr 0x338ab44, size 0xc0, virtual false, abstract: false, final false
  inline void ReportAuthenticated(int64_t seq);

  /// @brief Method Reset, addr 0x338c4a4, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ShouldDiscard, addr 0x338ab04, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33889f0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
