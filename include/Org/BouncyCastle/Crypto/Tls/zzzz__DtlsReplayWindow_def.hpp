...
public:
  ...
  /// @brief Method ReportAuthenticated, addr 0x23f5a64, size 0xc8, virtual false, abstract: false, final false
  inline void ReportAuthenticated(int64_t seq);

  /// @brief Method Reset, addr 0x23f7464, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ShouldDiscard, addr 0x23f5a24, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f373c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
