...
public:
  ...
  /// @brief Method GenerateClientKeyExchange, addr 0x3482008, size 0x118, virtual true, abstract: false, final false
  inline void GenerateClientKeyExchange(::System::IO::Stream* output);

  /// @brief Method GeneratePremasterSecret, addr 0x3482230, size 0x128, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GeneratePremasterSecret();

  /// @brief Method GenerateServerKeyExchange, addr 0x3481b10, size 0x170, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateServerKeyExchange();

  /// @brief Method Init, addr 0x34814c4, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessClientCertificate, addr 0x3482120, size 0x48, virtual true, abstract: false, final false
  inline void ProcessClientCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* clientCertificate);

  /// @brief Method ProcessClientCredentials, addr 0x3481f00, size 0x108, virtual true, abstract: false, final false
  inline void ProcessClientCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials* clientCredentials);

  /// @brief Method ProcessClientKeyExchange, addr 0x3482168, size 0xc8, virtual true, abstract: false, final false
  inline void ProcessClientKeyExchange(::System::IO::Stream* input);

  /// @brief Method ProcessServerCertificate, addr 0x3481628, size 0x380, virtual true, abstract: false, final false
  inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate* serverCertificate);

  /// @brief Method ProcessServerKeyExchange, addr 0x3481c80, size 0x118, virtual true, abstract: false, final false
  inline void ProcessServerKeyExchange(::System::IO::Stream* input);

  /// @brief Method SkipServerCredentials, addr 0x3481594, size 0x48, virtual true, abstract: false, final false
  inline void SkipServerCredentials();

  /// @brief Method ValidateCertificateRequest, addr 0x3481e2c, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3481390, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_RequiresServerKeyExchange, addr 0x3481af4, size 0x1c, virtual true, abstract: false, final false
