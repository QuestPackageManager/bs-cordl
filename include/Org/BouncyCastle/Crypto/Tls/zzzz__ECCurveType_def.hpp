...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ECCurveType*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ECCurveType*, "Org.BouncyCastle.Crypto.Tls", "ECCurveType");
...
public:
  ...
  /// @brief Method .ctor, addr 0x346b374, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECCurveType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECCurveType(ECCurveType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECCurveType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECCurveType(ECCurveTypeconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ECCurveType) == 0x10, "Size mismatch!");
