...
public:
  ...
  /// @brief Method Close, addr 0x33abd60, size 0x20, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetReceiveLimit, addr 0x33ab628, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetReceiveLimit();

  /// @brief Method GetSendLimit, addr 0x33ab648, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Receive, addr 0x33ab668, size 0x3a4, virtual true, abstract: false, final false
  inline int32_t Receive(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method Send, addr 0x33aba0c, size 0x354, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ab620, size 0x8, virtual false, abstract: false, final false
