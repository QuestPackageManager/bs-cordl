...
/// @brief Method Close, addr 0x336f71c, size 0x20, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetReceiveLimit, addr 0x336efe4, size 0x20, virtual true, abstract: false, final false
inline int32_t GetReceiveLimit() ;

/// @brief Method GetSendLimit, addr 0x336f004, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method Receive, addr 0x336f024, size 0x3a4, virtual true, abstract: false, final false
inline int32_t Receive(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len, int32_t  waitMillis) ;

/// @brief Method Send, addr 0x336f3c8, size 0x354, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x336efdc, size 0x8, virtual false, abstract: false, final false
