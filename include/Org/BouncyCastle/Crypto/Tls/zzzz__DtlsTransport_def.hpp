...
public:
  ...
  /// @brief Method Close, addr 0x2416af8, size 0x24, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetReceiveLimit, addr 0x24163f8, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetReceiveLimit();

  /// @brief Method GetSendLimit, addr 0x241641c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method Receive, addr 0x2416440, size 0x384, virtual true, abstract: false, final false
  inline int32_t Receive(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method Send, addr 0x24167c4, size 0x334, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24163d0, size 0x28, virtual false, abstract: false, final false
