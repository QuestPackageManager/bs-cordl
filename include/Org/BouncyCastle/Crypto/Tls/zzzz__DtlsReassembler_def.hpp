...
public:
  ...
  /// @brief Method .ctor, addr 0x10d78b4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t start, int32_t end);

  /// @brief Method get_End, addr 0x10d80b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_End();

  /// @brief Method get_Start, addr 0x10d80a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Start();

  /// @brief Method set_End, addr 0x10d80bc, size 0x8, virtual false, abstract: false, final false
  inline void set_End(int32_t value);

  /// @brief Method set_Start, addr 0x10d80ac, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ContributeFragment, addr 0x10d79a0, size 0x5b4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBodyIfComplete, addr 0x10d78e8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x10d7f54, size 0x150, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x10d7768, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t msg_type, int32_t length);

  /// @brief Method get_MsgType, addr 0x10d78e0, size 0x8, virtual false, abstract: false, final false
