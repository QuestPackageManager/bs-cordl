...
public:
  ...
  /// @brief Method .ctor, addr 0x23efecc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t start, int32_t end);

  /// @brief Method get_End, addr 0x23f0690, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_End();

  /// @brief Method get_Start, addr 0x23f0680, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Start();

  /// @brief Method set_End, addr 0x23f0698, size 0x8, virtual false, abstract: false, final false
  inline void set_End(int32_t value);

  /// @brief Method set_Start, addr 0x23f0688, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ContributeFragment, addr 0x23effb8, size 0x57c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBodyIfComplete, addr 0x23eff00, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x23f0534, size 0x14c, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x23efd84, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(uint8_t msg_type, int32_t length);

  /// @brief Method get_MsgType, addr 0x23efef8, size 0x8, virtual false, abstract: false, final false
