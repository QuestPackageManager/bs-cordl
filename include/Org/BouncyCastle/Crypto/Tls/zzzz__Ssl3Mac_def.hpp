...
public:
  ...
  /// @brief Method .ctor addr 0xf97d68 size 0xcc virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_AlgorithmName addr 0xf97e34 size 0xc0 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xf97ef4 size 0xd8 virtual true final false
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method GetMacSize addr 0xf97fcc size 0xa4 virtual true final false
  inline int32_t GetMacSize();

  /// @brief Method Update addr 0xf98070 size 0xac virtual true final false
  inline void Update(uint8_t input);

  /// @brief Method BlockUpdate addr 0xf9811c size 0xc4 virtual true final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal addr 0xf981e0 size 0x37c virtual true final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xf9855c size 0x1d4 virtual true final false
  inline void Reset();

  /// @brief Method GenPad addr 0xf98730 size 0x98 virtual false final false
