...
public:
  ...
  /// @brief Method GetClientCredentials, addr 0x241b0e4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x241b0ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
