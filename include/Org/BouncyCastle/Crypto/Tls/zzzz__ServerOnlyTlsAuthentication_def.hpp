...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::ServerOnlyTlsAuthentication*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::ServerOnlyTlsAuthentication*, "Org.BouncyCastle.Crypto.Tls", "ServerOnlyTlsAuthentication");
...
public:
  ...
  /// @brief Method GetClientCredentials, addr 0x346d4f8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x346d500, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::ServerOnlyTlsAuthentication) == 0x10, "Size mismatch!");
