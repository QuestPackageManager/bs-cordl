...
public:
  ...
  /// @brief Method GetClientCredentials, addr 0x1026ffc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1027004, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
