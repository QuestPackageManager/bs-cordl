...
/// @brief Method GetClientCredentials, addr 0x33b1040, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x33b1048, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
