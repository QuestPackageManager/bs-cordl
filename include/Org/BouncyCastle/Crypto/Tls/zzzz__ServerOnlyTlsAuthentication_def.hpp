...
/// @brief Method GetClientCredentials, addr 0x3373c60, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3373c68, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
