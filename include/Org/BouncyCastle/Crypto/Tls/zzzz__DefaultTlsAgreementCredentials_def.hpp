...
public:
  ...
  /// @brief Method GenerateAgreement, addr 0xfd2e58, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd2b7c, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0xfd2e50, size 0x8, virtual true, abstract: false, final false
