...
public:
  ...
  /// @brief Method GenerateAgreement, addr 0x23ed81c, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ed560, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x23ed814, size 0x8, virtual true, abstract: false, final false
