...
public:
  ...
  /// @brief Method GenerateAgreement, addr 0x11c0804, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11c0528, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x11c07fc, size 0x8, virtual true, abstract: false, final false
