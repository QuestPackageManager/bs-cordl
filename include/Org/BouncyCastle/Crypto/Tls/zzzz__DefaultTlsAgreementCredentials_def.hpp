...
public:
  ...
  /// @brief Method GenerateAgreement, addr 0x343ddd0, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x343db28, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x343ddc8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsAgreementCredentials", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultTlsAgreementCredentials(DefaultTlsAgreementCredentials&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultTlsAgreementCredentials", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultTlsAgreementCredentials(DefaultTlsAgreementCredentialsconst&) = delete;
