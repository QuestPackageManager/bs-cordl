...
public:
  ...
  /// @brief Method GenerateAgreement, addr 0x23e59ac, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e56f0, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x23e59a4, size 0x8, virtual true, abstract: false, final false
