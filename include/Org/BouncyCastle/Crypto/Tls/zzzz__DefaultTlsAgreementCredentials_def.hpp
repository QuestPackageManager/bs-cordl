...
public:
  ...
  /// @brief Method GenerateAgreement, addr 0x3342260, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3341fb8, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x3342258, size 0x8, virtual true, abstract: false, final false
