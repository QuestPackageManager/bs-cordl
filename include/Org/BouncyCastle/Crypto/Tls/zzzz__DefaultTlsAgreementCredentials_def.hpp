...
public:
  ...
  /// @brief Method GenerateAgreement, addr 0x3317a1c, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3317774, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificate, addr 0x3317a14, size 0x8, virtual true, abstract: false, final false
