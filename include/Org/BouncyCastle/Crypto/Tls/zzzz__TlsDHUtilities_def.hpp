...
/// @brief Method AddNegotiatedDheGroupsClientExtension, addr 0x33c0bec, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method AddNegotiatedDheGroupsServerExtension, addr 0x33c0dd0, size 0x13c, virtual false, abstract: false, final false
static inline void AddNegotiatedDheGroupsServerExtension(::System::Collections::IDictionary*  extensions, uint8_t  dheGroup) ;

/// @brief Method AreCompatibleParameters, addr 0x33c1544, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method CalculateDHBasicAgreement, addr 0x33bfecc, size 0x90, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> CalculateDHBasicAgreement(::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters*  publicKey, ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*  privateKey) ;

/// @brief Method ContainsDheCipherSuites, addr 0x33c1354, size 0xb4, virtual false, abstract: false, final false
static inline bool ContainsDheCipherSuites(::ArrayW<int32_t,::Array<int32_t>*>  cipherSuites) ;

/// @brief Method CreateNegotiatedDheGroupsClientExtension, addr 0x33c0d28, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method CreateNegotiatedDheGroupsServerExtension, addr 0x33c0f0c, size 0x5c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> CreateNegotiatedDheGroupsServerExtension(uint8_t  dheGroup) ;

/// @brief Method FromHex, addr 0x33c0a80, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW  hex) ;

/// @brief Method FromSafeP, addr 0x33c0b20, size 0xcc, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* FromSafeP(::StringW  hexP) ;

/// @brief Method GenerateDHKeyPair, addr 0x33c15d4, size 0xc8, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateDHKeyPair(::Org::BouncyCastle::Security::SecureRandom*  random, ::Org::BouncyCastle::Crypto::Parameters::DHParameters*  dhParams) ;

/// @brief Method GenerateEphemeralClientKeyExchange, addr 0x33bfb70, size 0x128, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* GenerateEphemeralClientKeyExchange(::Org::BouncyCastle::Security::SecureRandom*  random, ::Org::BouncyCastle::Crypto::Parameters::DHParameters*  dhParams, ::System::IO::Stream*  output) ;

/// @brief Method GenerateEphemeralServerKeyExchange, addr 0x33bf460, size 0x150, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* GenerateEphemeralServerKeyExchange(::Org::BouncyCastle::Security::SecureRandom*  random, ::Org::BouncyCastle::Crypto::Parameters::DHParameters*  dhParams, ::System::IO::Stream*  output) ;

/// @brief Method GetNegotiatedDheGroupsClientExtension, addr 0x33c0f68, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method GetNegotiatedDheGroupsServerExtension, addr 0x33c10f0, size 0xe0, virtual false, abstract: false, final false
static inline int16_t GetNegotiatedDheGroupsServerExtension(::System::Collections::IDictionary*  extensions) ;

/// @brief Method GetParametersForDHEGroup, addr 0x33c122c, size 0x128, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GetParametersForDHEGroup(int16_t  dheGroup) ;

/// @brief Method IsDheCipherSuite, addr 0x33c1408, size 0x13c, virtual false, abstract: false, final false
static inline bool IsDheCipherSuite(int32_t  cipherSuite) ;

static inline ::Org::BouncyCastle::Crypto::Tls::TlsDHUtilities* New_ctor() ;

/// @brief Method ReadDHParameter, addr 0x33bf7f4, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::BigInteger* ReadDHParameter(::System::IO::Stream*  input) ;

/// @brief Method ReadDHParameters, addr 0x33c17a4, size 0xa8, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* ReadDHParameters(::System::IO::Stream*  input) ;

/// @brief Method ReadNegotiatedDheGroupsClientExtension, addr 0x33c1044, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method ReadNegotiatedDheGroupsServerExtension, addr 0x33c11d0, size 0x5c, virtual false, abstract: false, final false
static inline uint8_t ReadNegotiatedDheGroupsServerExtension(::ArrayW<uint8_t,::Array<uint8_t>*>  extensionData) ;

/// @brief Method ReceiveDHParameters, addr 0x33bf6cc, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method WriteDHParameter, addr 0x33c169c, size 0x88, virtual false, abstract: false, final false
static inline void WriteDHParameter(::Org::BouncyCastle::Math::BigInteger*  x, ::System::IO::Stream*  output) ;

/// @brief Method WriteDHParameters, addr 0x33c1724, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33c19c4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
