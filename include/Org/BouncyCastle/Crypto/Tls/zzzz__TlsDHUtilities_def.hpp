...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsDHUtilities*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsDHUtilities*, "Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities");
...
public:
  ...
  /// @brief Method AddNegotiatedDheGroupsClientExtension, addr 0x347f42c, size 0x13c, virtual false, abstract: false, final false
  static inline void AddNegotiatedDheGroupsClientExtension(::System::Collections::IDictionary* extensions, ::ArrayW<uint8_t> dheGroups);

  /// @brief Method AddNegotiatedDheGroupsServerExtension, addr 0x347f610, size 0x13c, virtual false, abstract: false, final false
  static inline void AddNegotiatedDheGroupsServerExtension(::System::Collections::IDictionary* extensions, uint8_t dheGroup);

  /// @brief Method AreCompatibleParameters, addr 0x347fd84, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateDHBasicAgreement, addr 0x347e70c, size 0x90, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CalculateDHBasicAgreement(::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters* publicKey,
                                                            ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* privateKey);

  /// @brief Method ContainsDheCipherSuites, addr 0x347fb94, size 0xb4, virtual false, abstract: false, final false
  static inline bool ContainsDheCipherSuites(::ArrayW<int32_t> cipherSuites);

  /// @brief Method CreateNegotiatedDheGroupsClientExtension, addr 0x347f568, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CreateNegotiatedDheGroupsClientExtension(::ArrayW<uint8_t> dheGroups);

  /// @brief Method CreateNegotiatedDheGroupsServerExtension, addr 0x347f74c, size 0x5c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CreateNegotiatedDheGroupsServerExtension(uint8_t dheGroup);

  /// @brief Method FromHex, addr 0x347f2c0, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method FromSafeP, addr 0x347f360, size 0xcc, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* FromSafeP(::StringW hexP);

  /// @brief Method GenerateDHKeyPair, addr 0x347fe14, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateEphemeralClientKeyExchange, addr 0x347e3b0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateEphemeralServerKeyExchange, addr 0x347dca0, size 0x150, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*
  ...
  /// @brief Method GetNegotiatedDheGroupsClientExtension, addr 0x347f7a8, size 0xdc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GetNegotiatedDheGroupsClientExtension(::System::Collections::IDictionary* extensions);

  /// @brief Method GetNegotiatedDheGroupsServerExtension, addr 0x347f930, size 0xe0, virtual false, abstract: false, final false
  static inline int16_t GetNegotiatedDheGroupsServerExtension(::System::Collections::IDictionary* extensions);

  /// @brief Method GetParametersForDHEGroup, addr 0x347fa6c, size 0x128, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GetParametersForDHEGroup(int16_t dheGroup);

  /// @brief Method IsDheCipherSuite, addr 0x347fc48, size 0x13c, virtual false, abstract: false, final false
  static inline bool IsDheCipherSuite(int32_t cipherSuite);

  static inline ::Org::BouncyCastle::Crypto::Tls::TlsDHUtilities* New_ctor();

  /// @brief Method ReadDHParameter, addr 0x347e034, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* ReadDHParameter(::System::IO::Stream* input);

  /// @brief Method ReadDHParameters, addr 0x347ffe4, size 0xa8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* ReadDHParameters(::System::IO::Stream* input);

  /// @brief Method ReadNegotiatedDheGroupsClientExtension, addr 0x347f884, size 0xac, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ReadNegotiatedDheGroupsClientExtension(::ArrayW<uint8_t> extensionData);

  /// @brief Method ReadNegotiatedDheGroupsServerExtension, addr 0x347fa10, size 0x5c, virtual false, abstract: false, final false
  static inline uint8_t ReadNegotiatedDheGroupsServerExtension(::ArrayW<uint8_t> extensionData);

  /// @brief Method ReceiveDHParameters, addr 0x347df0c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDHParameter, addr 0x347fedc, size 0x88, virtual false, abstract: false, final false
  static inline void WriteDHParameter(::Org::BouncyCastle::Math::BigInteger* x, ::System::IO::Stream* output);

  /// @brief Method WriteDHParameters, addr 0x347ff64, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3480204, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsDHUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsDHUtilities(TlsDHUtilities&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsDHUtilities", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsDHUtilities(TlsDHUtilitiesconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsDHUtilities) == 0x10, "Size mismatch!");
