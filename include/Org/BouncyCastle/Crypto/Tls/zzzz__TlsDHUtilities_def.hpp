...
public:
  ...
  /// @brief Method AddNegotiatedDheGroupsClientExtension, addr 0x347d0a4, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddNegotiatedDheGroupsServerExtension, addr 0x347d288, size 0x13c, virtual false, abstract: false, final false
  static inline void AddNegotiatedDheGroupsServerExtension(::System::Collections::IDictionary* extensions, uint8_t dheGroup);

  /// @brief Method AreCompatibleParameters, addr 0x347d9fc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateDHBasicAgreement, addr 0x347c384, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ContainsDheCipherSuites, addr 0x347d80c, size 0xb4, virtual false, abstract: false, final false
  static inline bool ContainsDheCipherSuites(::ArrayW<int32_t> cipherSuites);

  /// @brief Method CreateNegotiatedDheGroupsClientExtension, addr 0x347d1e0, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CreateNegotiatedDheGroupsClientExtension(::ArrayW<uint8_t> dheGroups);

  /// @brief Method CreateNegotiatedDheGroupsServerExtension, addr 0x347d3c4, size 0x5c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CreateNegotiatedDheGroupsServerExtension(uint8_t dheGroup);

  /// @brief Method FromHex, addr 0x347cf38, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method FromSafeP, addr 0x347cfd8, size 0xcc, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* FromSafeP(::StringW hexP);

  /// @brief Method GenerateDHKeyPair, addr 0x347da8c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateEphemeralClientKeyExchange, addr 0x347c028, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateEphemeralServerKeyExchange, addr 0x347b918, size 0x150, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*
  ...
  /// @brief Method GetNegotiatedDheGroupsClientExtension, addr 0x347d420, size 0xdc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GetNegotiatedDheGroupsClientExtension(::System::Collections::IDictionary* extensions);

  /// @brief Method GetNegotiatedDheGroupsServerExtension, addr 0x347d5a8, size 0xe0, virtual false, abstract: false, final false
  static inline int16_t GetNegotiatedDheGroupsServerExtension(::System::Collections::IDictionary* extensions);

  /// @brief Method GetParametersForDHEGroup, addr 0x347d6e4, size 0x128, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GetParametersForDHEGroup(int16_t dheGroup);

  /// @brief Method IsDheCipherSuite, addr 0x347d8c0, size 0x13c, virtual false, abstract: false, final false
  static inline bool IsDheCipherSuite(int32_t cipherSuite);

  static inline ::Org::BouncyCastle::Crypto::Tls::TlsDHUtilities* New_ctor();

  /// @brief Method ReadDHParameter, addr 0x347bcac, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* ReadDHParameter(::System::IO::Stream* input);

  /// @brief Method ReadDHParameters, addr 0x347dc5c, size 0xa8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* ReadDHParameters(::System::IO::Stream* input);

  /// @brief Method ReadNegotiatedDheGroupsClientExtension, addr 0x347d4fc, size 0xac, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ReadNegotiatedDheGroupsClientExtension(::ArrayW<uint8_t> extensionData);

  /// @brief Method ReadNegotiatedDheGroupsServerExtension, addr 0x347d688, size 0x5c, virtual false, abstract: false, final false
  static inline uint8_t ReadNegotiatedDheGroupsServerExtension(::ArrayW<uint8_t> extensionData);

  /// @brief Method ReceiveDHParameters, addr 0x347bb84, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDHParameter, addr 0x347db54, size 0x88, virtual false, abstract: false, final false
  static inline void WriteDHParameter(::Org::BouncyCastle::Math::BigInteger* x, ::System::IO::Stream* output);

  /// @brief Method WriteDHParameters, addr 0x347dbdc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x347de7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
