...
public:
  ...
  /// @brief Method FromHex addr 0xf2f6fc size 0xa0 virtual false final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method FromSafeP addr 0xf2f79c size 0xc8 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* FromSafeP(::StringW hexP);

  /// @brief Method AddNegotiatedDheGroupsClientExtension addr 0xf2f864 size 0x14c virtual false final false
  ...
  /// @brief Method AddNegotiatedDheGroupsServerExtension addr 0xf2fa5c size 0x14c virtual false final false
  static inline void AddNegotiatedDheGroupsServerExtension(::System::Collections::IDictionary* extensions, uint8_t dheGroup);

  /// @brief Method GetNegotiatedDheGroupsClientExtension addr 0xf2fc00 size 0xd0 virtual false final false
  ...
  /// @brief Method GetNegotiatedDheGroupsServerExtension addr 0xf2fd80 size 0xd4 virtual false final false
  static inline int16_t GetNegotiatedDheGroupsServerExtension(::System::Collections::IDictionary* extensions);

  /// @brief Method CreateNegotiatedDheGroupsClientExtension addr 0xf2f9b0 size 0xac virtual false final false
  ...
  /// @brief Method CreateNegotiatedDheGroupsServerExtension addr 0xf2fba8 size 0x58 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CreateNegotiatedDheGroupsServerExtension(uint8_t dheGroup);

  /// @brief Method ReadNegotiatedDheGroupsClientExtension addr 0xf2fcd0 size 0xb0 virtual false final false
  ...
  /// @brief Method ReadNegotiatedDheGroupsServerExtension addr 0xf2fe54 size 0x58 virtual false final false
  static inline uint8_t ReadNegotiatedDheGroupsServerExtension(::ArrayW<uint8_t, ::Array<uint8_t>*> extensionData);

  /// @brief Method GetParametersForDHEGroup addr 0xf2feac size 0xfc virtual false final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GetParametersForDHEGroup(int16_t dheGroup);

  /// @brief Method ContainsDheCipherSuites addr 0xf2ffa8 size 0xb0 virtual false final false
  static inline bool ContainsDheCipherSuites(::ArrayW<int32_t, ::Array<int32_t>*> cipherSuites);

  /// @brief Method IsDheCipherSuite addr 0xf30058 size 0x13c virtual false final false
  static inline bool IsDheCipherSuite(int32_t cipherSuite);

  /// @brief Method AreCompatibleParameters addr 0xf30194 size 0x90 virtual false final false
  ...
  /// @brief Method CalculateDHBasicAgreement addr 0xf2eb70 size 0x94 virtual false final false
  ...
  /// @brief Method GenerateDHKeyPair addr 0xf30224 size 0xbc virtual false final false
  ...
  /// @brief Method GenerateEphemeralClientKeyExchange addr 0xf2e820 size 0x11c virtual false final false
  ...
  /// @brief Method GenerateEphemeralServerKeyExchange addr 0xf2e118 size 0x144 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*
  ...
  /// @brief Method ReadDHParameter addr 0xf2e49c size 0xa0 virtual false final false
  static inline ::Org::BouncyCastle::Math::BigInteger* ReadDHParameter(::System::IO::Stream* input);

  /// @brief Method ReadDHParameters addr 0xf303d0 size 0xa8 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* ReadDHParameters(::System::IO::Stream* input);

  /// @brief Method ReceiveDHParameters addr 0xf2e374 size 0x128 virtual false final false
  ...
  /// @brief Method WriteDHParameter addr 0xf302e0 size 0x7c virtual false final false
  static inline void WriteDHParameter(::Org::BouncyCastle::Math::BigInteger* x, ::System::IO::Stream* output);

  /// @brief Method WriteDHParameters addr 0xf3035c size 0x74 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf305e4 size 0x8 virtual false final false
  inline void _ctor();
