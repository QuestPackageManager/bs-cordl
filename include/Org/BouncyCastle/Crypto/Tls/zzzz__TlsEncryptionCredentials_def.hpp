...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials*, "Org.BouncyCastle.Crypto.Tls", "TlsEncryptionCredentials");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "TlsEncryptionCredentials", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsEncryptionCredentials(TlsEncryptionCredentialsconst&) = delete;
