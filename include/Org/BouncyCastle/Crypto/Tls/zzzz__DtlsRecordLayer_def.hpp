...
public:
  ...
  /// @brief Method Close, addr 0x344778c, size 0x88, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method CloseTransport, addr 0x3447814, size 0x160, virtual false, abstract: false, final false
  inline void CloseTransport();

  /// @brief Method Fail, addr 0x3447994, size 0xc8, virtual true, abstract: false, final false
  inline void Fail(uint8_t alertDescription);

  /// @brief Method Failed, addr 0x3447974, size 0x20, virtual true, abstract: false, final false
  inline void Failed();

  /// @brief Method GetMacSequenceNumber, addr 0x3447d90, size 0x8, virtual false, abstract: false, final false
  static inline int64_t GetMacSequenceNumber(int32_t epoch, int64_t sequence_number);

  /// @brief Method GetReceiveLimit, addr 0x34468b4, size 0x170, virtual true, abstract: false, final false
  inline int32_t GetReceiveLimit();

  /// @brief Method GetSendLimit, addr 0x3446a24, size 0x174, virtual true, abstract: false, final false
  inline int32_t GetSendLimit();

  /// @brief Method HandshakeSuccessful, addr 0x34467c8, size 0xd8, virtual true, abstract: false, final false
  inline void HandshakeSuccessful(::Org::BouncyCastle::Crypto::Tls::DtlsHandshakeRetransmit* retransmit);

  /// @brief Method InitPendingEpoch, addr 0x3446710, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessRecord, addr 0x3446f50, size 0x440, virtual false, abstract: false, final false
  inline int32_t ProcessRecord(int32_t received, ::ArrayW<uint8_t> record, ::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method RaiseAlert, addr 0x3447a5c, size 0x134, virtual false, abstract: false, final false
  inline void RaiseAlert(uint8_t alertLevel, uint8_t alertDescription, ::StringW message, ::System::Exception* cause);

  /// @brief Method Receive, addr 0x3446b98, size 0x1e4, virtual true, abstract: false, final false
  inline int32_t Receive(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method ReceiveDatagram, addr 0x3447ba4, size 0x1b4, virtual false, abstract: false, final false
  inline int32_t ReceiveDatagram(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method ReceiveRecord, addr 0x3446d7c, size 0x1d4, virtual false, abstract: false, final false
  inline int32_t ReceiveRecord(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method ResetWriteEpoch, addr 0x34468a0, size 0x14, virtual true, abstract: false, final false
  inline void ResetWriteEpoch();

  /// @brief Method Send, addr 0x3447390, size 0x180, virtual true, abstract: false, final false
  inline void Send(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method SendDatagram, addr 0x34465f0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method SendRecord, addr 0x3447510, size 0x27c, virtual false, abstract: false, final false
  inline void SendRecord(uint8_t contentType, ::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method SetPlaintextLimit, addr 0x34466c8, size 0xc, virtual true, abstract: false, final false
  inline void SetPlaintextLimit(int32_t plaintextLimit);

  /// @brief Method SetWriteVersion, addr 0x3446704, size 0xc, virtual true, abstract: false, final false
  inline void SetWriteVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* writeVersion);

  /// @brief Method Warn, addr 0x3447b90, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3441d78, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsClosed, addr 0x34466bc, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsClosed();

  /// @brief Method get_ReadEpoch, addr 0x34466d4, size 0x18, virtual true, abstract: false, final false
  inline int32_t get_ReadEpoch();

  /// @brief Method get_ReadVersion, addr 0x34466ec, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method set_ReadVersion, addr 0x34466f8, size 0xc, virtual true, abstract: false, final false
