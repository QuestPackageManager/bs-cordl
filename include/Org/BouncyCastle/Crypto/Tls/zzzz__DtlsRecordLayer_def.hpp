...
public:
  ...
  /// @brief Method Close, addr 0x1000838, size 0x84, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method CloseTransport, addr 0x10008bc, size 0x15c, virtual false, abstract: false, final false
  inline void CloseTransport();

  /// @brief Method Fail, addr 0x1000a58, size 0xcc, virtual true, abstract: false, final false
  inline void Fail(uint8_t alertDescription);

  /// @brief Method Failed, addr 0x1000a18, size 0x40, virtual true, abstract: false, final false
  inline void Failed();

  /// @brief Method GetMacSequenceNumber, addr 0x1000e3c, size 0x8, virtual false, abstract: false, final false
  static inline int64_t GetMacSequenceNumber(int32_t epoch, int64_t sequence_number);

  /// @brief Method GetReceiveLimit, addr 0xfff868, size 0x170, virtual true, abstract: false, final false
  inline int32_t GetReceiveLimit();

  /// @brief Method GetSendLimit, addr 0xfff9d8, size 0x174, virtual true, abstract: false, final false
  inline int32_t GetSendLimit();

  /// @brief Method HandshakeSuccessful, addr 0xfff778, size 0xdc, virtual true, abstract: false, final false
  inline void HandshakeSuccessful(::Org::BouncyCastle::Crypto::Tls::DtlsHandshakeRetransmit* retransmit);

  /// @brief Method InitPendingEpoch, addr 0xfff6b8, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessRecord, addr 0xfffee0, size 0x560, virtual false, abstract: false, final false
  ...
  /// @brief Method RaiseAlert, addr 0x1000b24, size 0x12c, virtual false, abstract: false, final false
  inline void RaiseAlert(uint8_t alertLevel, uint8_t alertDescription, ::StringW message, ::System::Exception* cause);

  /// @brief Method Receive, addr 0xfffb4c, size 0x1c4, virtual true, abstract: false, final false
  inline int32_t Receive(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method ReceiveDatagram, addr 0x1000c64, size 0x194, virtual false, abstract: false, final false
  inline int32_t ReceiveDatagram(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method ReceiveRecord, addr 0xfffd10, size 0x1d0, virtual false, abstract: false, final false
  inline int32_t ReceiveRecord(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len, int32_t waitMillis);

  /// @brief Method ResetWriteEpoch, addr 0xfff854, size 0x14, virtual true, abstract: false, final false
  inline void ResetWriteEpoch();

  /// @brief Method Send, addr 0x1000440, size 0x178, virtual true, abstract: false, final false
  inline void Send(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method SendDatagram, addr 0xfff540, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SendRecord, addr 0x10005b8, size 0x280, virtual false, abstract: false, final false
  inline void SendRecord(uint8_t contentType, ::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method SetPlaintextLimit, addr 0xfff618, size 0x24, virtual true, abstract: false, final false
  inline void SetPlaintextLimit(int32_t plaintextLimit);

  /// @brief Method SetWriteVersion, addr 0xfff694, size 0x24, virtual true, abstract: false, final false
  inline void SetWriteVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* writeVersion);

  /// @brief Method Warn, addr 0x1000c50, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xffab34, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsClosed, addr 0xfff600, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsClosed();

  /// @brief Method get_ReadEpoch, addr 0xfff63c, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_ReadEpoch();

  /// @brief Method get_ReadVersion, addr 0xfff658, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method set_ReadVersion, addr 0xfff670, size 0x24, virtual true, abstract: false, final false
