...
public:
  ...
  /// @brief Method .ctor addr 0xf22640 size 0x70 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf226b0 size 0x94 virtual false final false
  inline void _ctor(int64_t durationMillis, int64_t currentTimeMillis);

  /// @brief Method RemainingMillis addr 0xf22744 size 0x64 virtual false final false
  inline int64_t RemainingMillis(int64_t currentTimeMillis);

  /// @brief Method ConstrainWaitMillis addr 0xf227a8 size 0xc8 virtual false final false
  ...
  /// @brief Method ForWaitMillis addr 0xf228a4 size 0x60 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::Tls::Timeout* ForWaitMillis(int32_t waitMillis);

  /// @brief Method ForWaitMillis addr 0xf22904 size 0xd8 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::Tls::Timeout* ForWaitMillis(int32_t waitMillis, int64_t currentTimeMillis);

  /// @brief Method GetWaitMillis addr 0xf22870 size 0x34 virtual false final false
  static inline int32_t GetWaitMillis(::Org::BouncyCastle::Crypto::Tls::Timeout* timeout, int64_t currentTimeMillis);

  /// @brief Method HasExpired addr 0xf229dc size 0x1c virtual false final false
