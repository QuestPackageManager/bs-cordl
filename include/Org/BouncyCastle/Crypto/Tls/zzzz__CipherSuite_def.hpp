...
public:
// Declarations
/// @brief Method IsScsv, addr 0x3341034, size 0x14, virtual false, abstract: false, final false
static inline bool IsScsv(int32_t  cipherSuite) ;

static inline ::Org::BouncyCastle::Crypto::Tls::CipherSuite* New_ctor() ;

/// @brief Method .ctor, addr 0x3341048, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
