...
public:
  ...
  /// @brief Method Encode, addr 0x23e641c, size 0x148, virtual true, abstract: false, final false
  inline void Encode(::System::IO::Stream* output);

  /// @brief Method GetOcspResponse, addr 0x23e634c, size 0xd0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::OcspResponse* GetOcspResponse();

  /// @brief Method IsCorrectType, addr 0x23e6258, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x23e6564, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e61bc, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(uint8_t statusType, ::System::Object* response);

  /// @brief Method get_Response, addr 0x23e6344, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_Response();

  /// @brief Method get_StatusType, addr 0x23e633c, size 0x8, virtual true, abstract: false, final false
