...
public:
  ...
  /// @brief Method CreateSrpKeyExchange, addr 0x11fc818, size 0x94, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateSrpKeyExchange(int32_t keyExchange);

  /// @brief Method GetAuthentication, addr 0x11fc7d4, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsAuthentication* GetAuthentication();

  /// @brief Method GetCipherSuites, addr 0x11fc5a4, size 0x64, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCipherSuites();

  /// @brief Method GetClientExtensions, addr 0x11fc608, size 0x34, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* GetClientExtensions();

  /// @brief Method GetKeyExchange, addr 0x11fc714, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessServerExtensions, addr 0x11fc63c, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11fc46c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11fc510, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11fc3c0, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> identity, ::ArrayW<uint8_t, ::Array<uint8_t>*> password);

  /// @brief Method get_RequireSrpServerExtension, addr 0x11fc59c, size 0x8, virtual true, abstract: false, final false
