...
public:
  ...
  /// @brief Method CreateSrpKeyExchange, addr 0x34714cc, size 0x90, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateSrpKeyExchange(int32_t keyExchange);

  /// @brief Method GetAuthentication, addr 0x3471490, size 0x3c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Tls::TlsAuthentication* GetAuthentication();

  /// @brief Method GetCipherSuites, addr 0x3471264, size 0x68, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t> GetCipherSuites();

  /// @brief Method GetClientExtensions, addr 0x34712cc, size 0x34, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* GetClientExtensions();

  /// @brief Method GetKeyExchange, addr 0x34713d4, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessServerExtensions, addr 0x3471300, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3471138, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34711d4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3471094, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> identity, ::ArrayW<uint8_t> password);

  /// @brief Method get_RequireSrpServerExtension, addr 0x347125c, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SrpTlsClient", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SrpTlsClient(SrpTlsClient&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SrpTlsClient", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SrpTlsClient(SrpTlsClientconst&) = delete;
