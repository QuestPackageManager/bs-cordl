...
/// @brief Method CreateSrpKeyExchange, addr 0x33758ac, size 0x90, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateSrpKeyExchange(int32_t  keyExchange) ;

/// @brief Method GetAuthentication, addr 0x3375870, size 0x3c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsAuthentication* GetAuthentication() ;

/// @brief Method GetCipherSuites, addr 0x3375644, size 0x68, virtual true, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> GetCipherSuites() ;

/// @brief Method GetClientExtensions, addr 0x33756ac, size 0x34, virtual true, abstract: false, final false
inline ::System::Collections::IDictionary* GetClientExtensions() ;

/// @brief Method GetKeyExchange, addr 0x33757b4, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method ProcessServerExtensions, addr 0x33756e0, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3375518, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33755b4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3375474, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  identity, ::ArrayW<uint8_t,::Array<uint8_t>*>  password) ;

/// @brief Method get_RequireSrpServerExtension, addr 0x337563c, size 0x8, virtual true, abstract: false, final false
