...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::ExtensionType::*)()>(
    &::Org::BouncyCastle::Crypto::Tls::ExtensionType::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x10022b0;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Tls::ExtensionType*>::get(), ".ctor",
                                                                               std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
inline void Org::BouncyCastle::Crypto::Tls::ExtensionType::setStaticF_DRAFT_token_binding(int32_t value) {
  ::cordl_internals::setStaticField<int32_t, "DRAFT_token_binding", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Tls::ExtensionType*>::get>(
...
inline void Org::BouncyCastle::Crypto::Tls::ExtensionType::setStaticF_negotiated_ff_dhe_groups(int32_t value) {
  ::cordl_internals::setStaticField<int32_t, "negotiated_ff_dhe_groups", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Tls::ExtensionType*>::get>(
      std::forward<int32_t>(value));
}
