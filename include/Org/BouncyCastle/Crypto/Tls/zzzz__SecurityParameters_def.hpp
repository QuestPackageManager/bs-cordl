...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SecurityParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SecurityParameters*, "Org.BouncyCastle.Crypto.Tls", "SecurityParameters");
...
public:
  ...
  __declspec(property(get = get_ClientRandom)) ::ArrayW<uint8_t> ClientRandom;
  ...
  __declspec(property(get = get_MasterSecret)) ::ArrayW<uint8_t> MasterSecret;

  __declspec(property(get = get_PrfAlgorithm)) int32_t PrfAlgorithm;

  __declspec(property(get = get_PskIdentity)) ::ArrayW<uint8_t> PskIdentity;

  __declspec(property(get = get_ServerRandom)) ::ArrayW<uint8_t> ServerRandom;

  __declspec(property(get = get_SessionHash)) ::ArrayW<uint8_t> SessionHash;

  __declspec(property(get = get_SrpIdentity)) ::ArrayW<uint8_t> SrpIdentity;
  ...
  __declspec(property(get = __cordl_internal_get_clientRandom, put = __cordl_internal_set_clientRandom)) ::ArrayW<uint8_t> clientRandom;
  ...
  __declspec(property(get = __cordl_internal_get_masterSecret, put = __cordl_internal_set_masterSecret)) ::ArrayW<uint8_t> masterSecret;
  ...
  __declspec(property(get = __cordl_internal_get_pskIdentity, put = __cordl_internal_set_pskIdentity)) ::ArrayW<uint8_t> pskIdentity;

  /// @brief Field serverRandom, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get_serverRandom, put = __cordl_internal_set_serverRandom)) ::ArrayW<uint8_t> serverRandom;

  /// @brief Field sessionHash, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get_sessionHash, put = __cordl_internal_set_sessionHash)) ::ArrayW<uint8_t> sessionHash;

  /// @brief Field srpIdentity, offset 0x50, size 0x8
  __declspec(property(get = __cordl_internal_get_srpIdentity, put = __cordl_internal_set_srpIdentity)) ::ArrayW<uint8_t> srpIdentity;
  ...
  /// @brief Method Clear, addr 0x346eb54, size 0x84, virtual true, abstract: false, final false
  inline void Clear();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_clientRandom() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_clientRandom();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_masterSecret() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_masterSecret();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_pskIdentity() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_pskIdentity();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_serverRandom() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_serverRandom();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_sessionHash() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_sessionHash();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_srpIdentity() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_srpIdentity();
  ...
  constexpr void __cordl_internal_set_clientRandom(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set_masterSecret(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set_pskIdentity(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_serverRandom(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_sessionHash(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_srpIdentity(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x346ec38, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CipherSuite, addr 0x346ebe0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_CipherSuite();

  /// @brief Method get_ClientRandom, addr 0x346ec08, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_ClientRandom();

  /// @brief Method get_CompressionAlgorithm, addr 0x346ebe8, size 0x8, virtual true, abstract: false, final false
  inline uint8_t get_CompressionAlgorithm();

  /// @brief Method get_Entity, addr 0x346ebd8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Entity();

  /// @brief Method get_IsExtendedMasterSecret, addr 0x346ec30, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsExtendedMasterSecret();

  /// @brief Method get_MasterSecret, addr 0x346ec00, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_MasterSecret();

  /// @brief Method get_PrfAlgorithm, addr 0x346ebf0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_PrfAlgorithm();

  /// @brief Method get_PskIdentity, addr 0x346ec20, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_PskIdentity();

  /// @brief Method get_ServerRandom, addr 0x346ec10, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_ServerRandom();

  /// @brief Method get_SessionHash, addr 0x346ec18, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_SessionHash();

  /// @brief Method get_SrpIdentity, addr 0x346ec28, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_SrpIdentity();

  /// @brief Method get_VerifyDataLength, addr 0x346ebf8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecurityParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecurityParameters(SecurityParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecurityParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecurityParameters(SecurityParametersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SecurityParameters) == 0x60, "Size mismatch!");
