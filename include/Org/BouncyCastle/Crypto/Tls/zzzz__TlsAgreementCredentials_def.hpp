...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsAgreementCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsAgreementCredentials*, "Org.BouncyCastle.Crypto.Tls", "TlsAgreementCredentials");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
...
public:
  ...
  inline ::ArrayW<uint8_t> GenerateAgreement(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* peerPublicKey);
