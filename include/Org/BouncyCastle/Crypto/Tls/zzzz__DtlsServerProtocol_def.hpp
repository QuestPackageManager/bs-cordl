...
/// @brief Method .ctor, addr 0x336efb4, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AbortServerHandshake, addr 0x335047c, size 0x50, virtual true, abstract: false, final false
inline void AbortServerHandshake(::Org::BouncyCastle::Crypto::Tls::DtlsServerProtocol_ServerHandshakeState*  state, ::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*  recordLayer, uint8_t  alertDescription) ;

/// @brief Method Accept, addr 0x334fe8c, size 0x5f0, virtual true, abstract: false, final false
...
/// @brief Method ExpectCertificateVerifyMessage, addr 0x3352e50, size 0x84, virtual true, abstract: false, final false
inline bool ExpectCertificateVerifyMessage(::Org::BouncyCastle::Crypto::Tls::DtlsServerProtocol_ServerHandshakeState*  state) ;

/// @brief Method GenerateCertificateRequest, addr 0x33513a8, size 0x88, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateCertificateRequest(::Org::BouncyCastle::Crypto::Tls::DtlsServerProtocol_ServerHandshakeState*  state, ::Org::BouncyCastle::Crypto::Tls::CertificateRequest*  certificateRequest) ;

/// @brief Method GenerateCertificateStatus, addr 0x3351430, size 0x88, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateCertificateStatus(::Org::BouncyCastle::Crypto::Tls::DtlsServerProtocol_ServerHandshakeState*  state, ::Org::BouncyCastle::Crypto::Tls::CertificateStatus*  certificateStatus) ;

/// @brief Method GenerateNewSessionTicket, addr 0x33514b8, size 0x88, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateNewSessionTicket(::Org::BouncyCastle::Crypto::Tls::DtlsServerProtocol_ServerHandshakeState*  state, ::Org::BouncyCastle::Crypto::Tls::NewSessionTicket*  newSessionTicket) ;

/// @brief Method GenerateServerHello, addr 0x3351540, size 0x790, virtual true, abstract: false, final false
...
/// @brief Method InvalidateSession, addr 0x33512e0, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Method NotifyClientCertificate, addr 0x3351cd0, size 0x2e8, virtual true, abstract: false, final false
...
/// @brief Method ProcessCertificateVerify, addr 0x3352080, size 0x520, virtual true, abstract: false, final false
inline void ProcessCertificateVerify(::Org::BouncyCastle::Crypto::Tls::DtlsServerProtocol_ServerHandshakeState*  state, ::ArrayW<uint8_t,::Array<uint8_t>*>  body, ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash*  prepareFinishHash) ;

/// @brief Method ProcessClientCertificate, addr 0x3351fb8, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Method ProcessClientHello, addr 0x33525a0, size 0x6b4, virtual true, abstract: false, final false
...
/// @brief Method ProcessClientKeyExchange, addr 0x3352c54, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method ProcessClientSupplementalData, addr 0x3352d50, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method ServerHandshake, addr 0x33504cc, size 0xe14, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::DtlsTransport* ServerHandshake(::Org::BouncyCastle::Crypto::Tls::DtlsServerProtocol_ServerHandshakeState*  state, ::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*  recordLayer) ;
...
/// @brief Method .ctor, addr 0x334fe70, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Security::SecureRandom*  secureRandom) ;

/// @brief Method get_VerifyRequests, addr 0x334fe7c, size 0x8, virtual true, abstract: false, final false
inline bool get_VerifyRequests() ;

/// @brief Method set_VerifyRequests, addr 0x334fe84, size 0x8, virtual true, abstract: false, final false
