...
public:
  ...
  /// @brief Method .ctor, addr 0x346b378, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECPointFormat", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECPointFormat(ECPointFormat&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECPointFormat", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECPointFormat(ECPointFormatconst&) = delete;
