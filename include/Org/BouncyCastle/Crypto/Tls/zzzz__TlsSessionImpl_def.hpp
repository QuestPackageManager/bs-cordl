...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsSessionImpl", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsSessionImpl(TlsSessionImpl&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsSessionImpl", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsSessionImpl(TlsSessionImplconst&) = delete;
