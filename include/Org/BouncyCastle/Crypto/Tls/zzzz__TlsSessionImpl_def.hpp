...
/// @brief Method ExportSessionParameters, addr 0x3394a48, size 0xb0, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters* ExportSessionParameters() ;

/// @brief Method Invalidate, addr 0x3394b24, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3394910, size 0x138, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  sessionID, ::Org::BouncyCastle::Crypto::Tls::SessionParameters*  sessionParameters) ;

/// @brief Method get_IsResumable, addr 0x3394b40, size 0x2c, virtual true, abstract: false, final false
inline bool get_IsResumable() ;

/// @brief Method get_SessionID, addr 0x3394af8, size 0x2c, virtual true, abstract: false, final false
