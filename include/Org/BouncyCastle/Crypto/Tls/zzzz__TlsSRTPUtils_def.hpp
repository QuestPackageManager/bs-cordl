...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsSRTPUtils", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsSRTPUtils(TlsSRTPUtils&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsSRTPUtils", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsSRTPUtils(TlsSRTPUtilsconst&) = delete;
