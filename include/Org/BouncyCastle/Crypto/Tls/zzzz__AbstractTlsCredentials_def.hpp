...
public:
  ...
  /// @brief Method .ctor, addr 0x34351fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AbstractTlsCredentials", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AbstractTlsCredentials(AbstractTlsCredentials&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AbstractTlsCredentials", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AbstractTlsCredentials(AbstractTlsCredentialsconst&) = delete;
