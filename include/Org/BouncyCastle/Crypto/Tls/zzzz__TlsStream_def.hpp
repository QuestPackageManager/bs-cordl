...
public:
  ...
  /// @brief Method .ctor addr 0xfb93cc size 0x6c virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsProtocol* handler);

  /// @brief Method get_CanRead addr 0xfb9438 size 0x30 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek addr 0xfb9468 size 0x8 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite addr 0xfb9470 size 0x30 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method Close addr 0xfb94a0 size 0x34 virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0xfb94d4 size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method get_Length addr 0xfb94f8 size 0x40 virtual true final false
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0xfb9538 size 0x40 virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0xfb9578 size 0x40 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method Read addr 0xfb95b8 size 0x24 virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ReadByte addr 0xfb95dc size 0x98 virtual true final false
  inline int32_t ReadByte();

  /// @brief Method Seek addr 0xfb9674 size 0x40 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0xfb96b4 size 0x40 virtual true final false
  inline void SetLength(int64_t value);

  /// @brief Method Write addr 0xfb96f4 size 0x24 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte addr 0xfb9718 size 0x94 virtual true final false
