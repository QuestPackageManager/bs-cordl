...
/// @brief Method CreateDsaImpl, addr 0x33c6c88, size 0xbc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IDsa* CreateDsaImpl(uint8_t  hashAlgorithm) ;

/// @brief Method IsValidPublicKey, addr 0x33c6c0c, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33c5008, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_SignatureAlgorithm, addr 0x33c6f28, size 0x8, virtual true, abstract: false, final false
