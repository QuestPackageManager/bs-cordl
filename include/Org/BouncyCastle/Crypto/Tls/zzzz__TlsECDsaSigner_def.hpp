...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsECDsaSigner*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsECDsaSigner*, "Org.BouncyCastle.Crypto.Tls", "TlsECDsaSigner");
...
public:
  ...
  /// @brief Method CreateDsaImpl, addr 0x34854c8, size 0xbc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IDsa* CreateDsaImpl(uint8_t hashAlgorithm);

  /// @brief Method IsValidPublicKey, addr 0x348544c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3483848, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAlgorithm, addr 0x3485768, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsECDsaSigner", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsECDsaSigner(TlsECDsaSigner&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsECDsaSigner", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsECDsaSigner(TlsECDsaSignerconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsECDsaSigner) == 0x18, "Size mismatch!");
