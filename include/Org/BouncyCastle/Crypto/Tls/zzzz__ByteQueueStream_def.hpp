...
public:
  ...
  /// @brief Method .ctor addr 0xee7d2c size 0x90 virtual false final false
  inline void _ctor();

  /// @brief Method get_Available addr 0xee7dbc size 0x1c virtual true final false
  inline int32_t get_Available();

  /// @brief Method get_CanRead addr 0xee7dd8 size 0x8 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek addr 0xee7de0 size 0x8 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite addr 0xee7de8 size 0x8 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method Flush addr 0xee7df0 size 0x4 virtual true final false
  inline void Flush();

  /// @brief Method get_Length addr 0xee7df4 size 0x40 virtual true final false
  inline int64_t get_Length();

  /// @brief Method Peek addr 0xee7e34 size 0xa0 virtual true final false
  inline int32_t Peek(::ArrayW<uint8_t, ::Array<uint8_t>*> buf);

  /// @brief Method get_Position addr 0xee7ed4 size 0x40 virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0xee7f14 size 0x40 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method Read addr 0xee7f54 size 0x28 virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf);

  /// @brief Method Read addr 0xee7f7c size 0xb8 virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ReadByte addr 0xee8034 size 0x48 virtual true final false
  inline int32_t ReadByte();

  /// @brief Method Seek addr 0xee807c size 0x40 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0xee80bc size 0x40 virtual true final false
  inline void SetLength(int64_t value);

  /// @brief Method Skip addr 0xee80fc size 0x90 virtual true final false
  inline int32_t Skip(int32_t n);

  /// @brief Method Write addr 0xee818c size 0x24 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf);

  /// @brief Method Write addr 0xee81b0 size 0x18 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte addr 0xee81c8 size 0x88 virtual true final false
