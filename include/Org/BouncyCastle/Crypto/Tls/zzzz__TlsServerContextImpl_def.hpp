...
public:
  ...
  /// @brief Method .ctor, addr 0x111e8b4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x111e924, size 0x8, virtual true, abstract: false, final false
