...
public:
  ...
  /// @brief Method .ctor, addr 0x23f6d8c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x23f6dfc, size 0x8, virtual true, abstract: false, final false
