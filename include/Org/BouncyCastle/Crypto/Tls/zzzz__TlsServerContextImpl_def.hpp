...
public:
  ...
  /// @brief Method .ctor, addr 0x2401e34, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x2401ea4, size 0x8, virtual true, abstract: false, final false
