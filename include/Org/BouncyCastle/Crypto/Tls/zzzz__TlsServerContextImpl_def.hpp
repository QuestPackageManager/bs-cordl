...
public:
  ...
  /// @brief Method .ctor, addr 0x1044d30, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x1044da0, size 0x8, virtual true, abstract: false, final false
