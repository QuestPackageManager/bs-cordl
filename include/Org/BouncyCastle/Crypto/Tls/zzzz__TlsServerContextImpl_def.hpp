...
public:
  ...
  /// @brief Method .ctor, addr 0x339040c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x3390480, size 0x8, virtual true, abstract: false, final false
