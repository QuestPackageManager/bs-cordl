...
public:
  ...
  /// @brief Method .ctor, addr 0x2433a00, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x2433a70, size 0x8, virtual true, abstract: false, final false
