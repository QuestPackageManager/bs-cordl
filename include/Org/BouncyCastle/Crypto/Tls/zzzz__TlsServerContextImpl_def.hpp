...
public:
  ...
  /// @brief Method .ctor, addr 0x1211fd8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x1212048, size 0x8, virtual true, abstract: false, final false
