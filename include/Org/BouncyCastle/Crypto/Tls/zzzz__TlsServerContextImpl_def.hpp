...
public:
  ...
  /// @brief Method .ctor, addr 0x243b870, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x243b8e0, size 0x8, virtual true, abstract: false, final false
