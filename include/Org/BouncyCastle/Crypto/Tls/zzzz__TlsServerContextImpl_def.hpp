...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl*, "Org.BouncyCastle.Crypto.Tls", "TlsServerContextImpl");
...
public:
  ...
  /// @brief Method .ctor, addr 0x348bf7c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x348bff0, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TlsServerContextImpl", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TlsServerContextImpl(TlsServerContextImpl&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TlsServerContextImpl", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsServerContextImpl(TlsServerContextImplconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl) == 0x48, "Size mismatch!");
