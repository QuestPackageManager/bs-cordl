...
public:
  ...
  /// @brief Method .ctor, addr 0x33cc9a0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x33cca14, size 0x8, virtual true, abstract: false, final false
