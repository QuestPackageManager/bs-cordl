...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials*, "Org.BouncyCastle.Crypto.Tls", "TlsSignerCredentials");
// Dependencies
namespace Org::BouncyCastle::Crypto::Tls {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "TlsSignerCredentials", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TlsSignerCredentials(TlsSignerCredentialsconst&) = delete;
