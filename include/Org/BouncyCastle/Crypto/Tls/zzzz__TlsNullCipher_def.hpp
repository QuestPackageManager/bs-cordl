...
public:
  ...
  /// @brief Method DecodeCiphertext, addr 0x34868e8, size 0x188, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeCiphertext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> ciphertext, int32_t offset, int32_t len);

  /// @brief Method EncodePlaintext, addr 0x34867a4, size 0x144, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len);

  /// @brief Method GetPlaintextLimit, addr 0x3486778, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3486178, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext* context);

  /// @brief Method .ctor, addr 0x3486184, size 0x448, virtual false, abstract: false, final false
