...
public:
  ...
  /// @brief Method DecodeCiphertext, addr 0x33c9694, size 0x188, virtual true, abstract: false, final false
  ...
  /// @brief Method EncodePlaintext, addr 0x33c9550, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPlaintextLimit, addr 0x33c9524, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33c8f24, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext* context);

  /// @brief Method .ctor, addr 0x33c8f30, size 0x448, virtual false, abstract: false, final false
