...
/// @brief Method AddSupportedEllipticCurvesExtension, addr 0x3384e30, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method AddSupportedPointFormatsExtension, addr 0x3384fe0, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method AreOnSameCurve, addr 0x3385954, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method CalculateECDHBasicAgreement, addr 0x3385ee8, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method CheckNamedCurve, addr 0x33872ec, size 0xb0, virtual false, abstract: false, final false
static inline void CheckNamedCurve(::ArrayW<int32_t,::Array<int32_t>*>  namedCurves, int32_t  namedCurve) ;

/// @brief Method ContainsEccCipherSuites, addr 0x33857e8, size 0xb4, virtual false, abstract: false, final false
static inline bool ContainsEccCipherSuites(::ArrayW<int32_t,::Array<int32_t>*>  cipherSuites) ;

/// @brief Method CreateSupportedEllipticCurvesExtension, addr 0x3384f3c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method CreateSupportedPointFormatsExtension, addr 0x33850ec, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method DeserializeECFieldElement, addr 0x3385b78, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method DeserializeECPoint, addr 0x3385c48, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method DeserializeECPublicKey, addr 0x3385d70, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method GenerateECKeyPair, addr 0x3385f8c, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method GenerateEphemeralClientKeyExchange, addr 0x3386044, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method GenerateEphemeralServerKeyExchange, addr 0x3386224, size 0x228, virtual false, abstract: false, final false
...
/// @brief Method GetNameOfNamedCurve, addr 0x3385518, size 0xa8, virtual false, abstract: false, final false
static inline ::StringW GetNameOfNamedCurve(int32_t  namedCurve) ;

/// @brief Method GetParametersForNamedCurve, addr 0x3385644, size 0x134, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* GetParametersForNamedCurve(int32_t  namedCurve) ;

/// @brief Method GetSupportedEllipticCurvesExtension, addr 0x33851ac, size 0xa4, virtual false, abstract: false, final false
static inline ::ArrayW<int32_t,::Array<int32_t>*> GetSupportedEllipticCurvesExtension(::System::Collections::IDictionary*  extensions) ;

/// @brief Method GetSupportedPointFormatsExtension, addr 0x3385394, size 0xa4, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSupportedPointFormatsExtension(::System::Collections::IDictionary*  extensions) ;

/// @brief Method HasAnySupportedNamedCurves, addr 0x3385778, size 0x70, virtual false, abstract: false, final false
static inline bool HasAnySupportedNamedCurves() ;

/// @brief Method IsCompressionPreferred, addr 0x3385968, size 0x44, virtual false, abstract: false, final false
static inline bool IsCompressionPreferred(::ArrayW<uint8_t,::Array<uint8_t>*>  ecPointFormats, uint8_t  compressionFormat) ;

/// @brief Method IsEccCipherSuite, addr 0x338589c, size 0xb8, virtual false, abstract: false, final false
static inline bool IsEccCipherSuite(int32_t  cipherSuite) ;

/// @brief Method IsSupportedNamedCurve, addr 0x33855c0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method ReadECExponent, addr 0x3386a50, size 0xd8, virtual false, abstract: false, final false
static inline int32_t ReadECExponent(int32_t  fieldSize, ::System::IO::Stream*  input) ;

/// @brief Method ReadECFieldElement, addr 0x3386bc8, size 0xa4, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::BigInteger* ReadECFieldElement(int32_t  fieldSize, ::System::IO::Stream*  input) ;

/// @brief Method ReadECParameter, addr 0x3386b28, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::BigInteger* ReadECParameter(::System::IO::Stream*  input) ;

/// @brief Method ReadECParameters, addr 0x3386c6c, size 0x680, virtual false, abstract: false, final false
...
/// @brief Method ReadSupportedEllipticCurvesExtension, addr 0x3385250, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method ReadSupportedPointFormatsExtension, addr 0x3385438, size 0xe0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadSupportedPointFormatsExtension(::ArrayW<uint8_t,::Array<uint8_t>*>  extensionData) ;

/// @brief Method SerializeECFieldElement, addr 0x33859ac, size 0x1c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> SerializeECFieldElement(int32_t  fieldSize, ::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method SerializeECPoint, addr 0x33859c8, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method SerializeECPublicKey, addr 0x3385b04, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method ValidateECPublicKey, addr 0x3386a4c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method WriteECExponent, addr 0x338739c, size 0xa4, virtual false, abstract: false, final false
static inline void WriteECExponent(int32_t  k, ::System::IO::Stream*  output) ;

/// @brief Method WriteECFieldElement, addr 0x3387558, size 0xc0, virtual false, abstract: false, final false
static inline void WriteECFieldElement(int32_t  fieldSize, ::Org::BouncyCastle::Math::BigInteger*  x, ::System::IO::Stream*  output) ;

/// @brief Method WriteECFieldElement, addr 0x33874c8, size 0x90, virtual false, abstract: false, final false
static inline void WriteECFieldElement(::Org::BouncyCastle::Math::EC::ECFieldElement*  x, ::System::IO::Stream*  output) ;

/// @brief Method WriteECParameter, addr 0x3387440, size 0x88, virtual false, abstract: false, final false
static inline void WriteECParameter(::Org::BouncyCastle::Math::BigInteger*  x, ::System::IO::Stream*  output) ;

/// @brief Method WriteECPoint, addr 0x3386178, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method WriteExplicitECParameters, addr 0x338644c, size 0x520, virtual false, abstract: false, final false
...
/// @brief Method WriteNamedECParameters, addr 0x338696c, size 0xe0, virtual false, abstract: false, final false
static inline void WriteNamedECParameters(int32_t  namedCurve, ::System::IO::Stream*  output) ;

/// @brief Method .ctor, addr 0x3387af4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
