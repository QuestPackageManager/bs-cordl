...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Tls::SignatureAlgorithm*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Tls::SignatureAlgorithm*, "Org.BouncyCastle.Crypto.Tls", "SignatureAlgorithm");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3470414, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignatureAlgorithm", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignatureAlgorithm(SignatureAlgorithm&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignatureAlgorithm", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignatureAlgorithm(SignatureAlgorithmconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Tls::SignatureAlgorithm) == 0x10, "Size mismatch!");
