...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IEntropySourceProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IEntropySourceProvider(IEntropySourceProviderconst&) = delete;
