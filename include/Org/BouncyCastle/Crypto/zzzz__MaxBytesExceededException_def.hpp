...
public:
  ...
  /// @brief Method .ctor, addr 0x3378d20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3378d24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3378d28, size 0x4, virtual false, abstract: false, final false
