...
public:
  ...
  /// @brief Method .ctor, addr 0x244a2bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x244a2c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x244a2c4, size 0x4, virtual false, abstract: false, final false
