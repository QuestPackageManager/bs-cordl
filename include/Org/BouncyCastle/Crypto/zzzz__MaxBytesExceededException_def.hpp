...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::MaxBytesExceededException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::MaxBytesExceededException*, "Org.BouncyCastle.Crypto", "MaxBytesExceededException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x349f0d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x349f0d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x349f0dc, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MaxBytesExceededException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MaxBytesExceededException(MaxBytesExceededException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MaxBytesExceededException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MaxBytesExceededException(MaxBytesExceededExceptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::MaxBytesExceededException) == 0x90, "Size mismatch!");
