...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::ISignerWithRecovery*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::ISignerWithRecovery*, "Org.BouncyCastle.Crypto", "ISignerWithRecovery");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
