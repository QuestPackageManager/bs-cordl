...
public:
  ...
  /// @brief Method GenerateSeed, addr 0x3326124, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method NextBytes, addr 0x3326088, size 0x9c, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method NextBytes, addr 0x3325fac, size 0xdc, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method SetSeed, addr 0x3325e64, size 0xa4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method SetSeed, addr 0x3325f08, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3325ddc, size 0x88, virtual false, abstract: false, final false
