...
public:
  ...
  /// @brief Method .ctor, addr 0xf70bc4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSeed, addr 0xf70c44, size 0xb4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method SetSeed, addr 0xf70cf8, size 0xb4, virtual true, abstract: false, final false
  inline void SetSeed(int64_t seed);

  /// @brief Method NextBytes, addr 0xf70dac, size 0xf0, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method NextBytes, addr 0xf70e9c, size 0x98, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method GenerateSeed, addr 0xf70f34, size 0x1c, virtual true, abstract: false, final false
