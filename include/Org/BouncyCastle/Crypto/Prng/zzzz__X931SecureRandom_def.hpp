...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::X931SecureRandom*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::X931SecureRandom*, "Org.BouncyCastle.Crypto.Prng", "X931SecureRandom");
...
public:
  ...
  /// @brief Method GenerateSeed, addr 0x3421c94, size 0x18, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSeed(int32_t numBytes);
  ...
  /// @brief Method NextBytes, addr 0x3421bf8, size 0x9c, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method NextBytes, addr 0x3421b1c, size 0xdc, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> bytes);

  /// @brief Method SetSeed, addr 0x34219d4, size 0xa4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t> seed);

  /// @brief Method SetSeed, addr 0x3421a78, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x342194c, size 0x88, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X931SecureRandom", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X931SecureRandom(X931SecureRandom&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X931SecureRandom", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X931SecureRandom(X931SecureRandomconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::X931SecureRandom) == 0x40, "Size mismatch!");
