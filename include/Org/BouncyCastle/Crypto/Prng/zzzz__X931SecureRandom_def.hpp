...
public:
  ...
  /// @brief Method GenerateSeed, addr 0xfb5f04, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method NextBytes, addr 0xfb5e6c, size 0x98, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method NextBytes, addr 0xfb5d7c, size 0xf0, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method SetSeed, addr 0xfb5c14, size 0xb4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method SetSeed, addr 0xfb5cc8, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb5b94, size 0x80, virtual false, abstract: false, final false
