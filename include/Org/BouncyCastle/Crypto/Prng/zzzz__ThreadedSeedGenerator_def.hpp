...
public:
  ...
  /// @brief Method DoGenerateSeed, addr 0x23cc730, size 0x200, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DoGenerateSeed(int32_t numBytes, bool fast);

  /// @brief Method GenerateSeed, addr 0x23cc5dc, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x23cc6ec, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23cc5b4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GenerateSeed, addr 0x23cc534, size 0x80, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateSeed(int32_t numBytes, bool fast);

  static inline ::Org::BouncyCastle::Crypto::Prng::ThreadedSeedGenerator* New_ctor();

  /// @brief Method .ctor, addr 0x23cc6e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
