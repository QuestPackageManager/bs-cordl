...
public:
  ...
  /// @brief Method DoGenerateSeed, addr 0x3420a08, size 0x208, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> DoGenerateSeed(int32_t numBytes, bool fast);

  /// @brief Method GenerateSeed, addr 0x34208b4, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x34209dc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34208a0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GenerateSeed, addr 0x3420830, size 0x70, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateSeed(int32_t numBytes, bool fast);

  static inline ::Org::BouncyCastle::Crypto::Prng::ThreadedSeedGenerator* New_ctor();

  /// @brief Method .ctor, addr 0x34209d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
