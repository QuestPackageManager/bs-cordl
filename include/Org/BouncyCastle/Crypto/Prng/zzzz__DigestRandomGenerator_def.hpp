...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator*, "Org.BouncyCastle.Crypto.Prng", "DigestRandomGenerator");
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator) == 0x38, "Size mismatch!");
