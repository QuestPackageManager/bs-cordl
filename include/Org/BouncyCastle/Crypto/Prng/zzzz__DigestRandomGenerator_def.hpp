...
/// @brief Method AddSeedMaterial, addr 0x33222e8, size 0xb4, virtual true, abstract: false, final true
inline void AddSeedMaterial(::ArrayW<uint8_t,::Array<uint8_t>*>  inSeed) ;

/// @brief Method AddSeedMaterial, addr 0x3322520, size 0xb4, virtual true, abstract: false, final true
inline void AddSeedMaterial(int64_t  rSeed) ;

/// @brief Method CycleSeed, addr 0x33228bc, size 0x34, virtual false, abstract: false, final false
inline void CycleSeed() ;

/// @brief Method DigestAddCounter, addr 0x33225d4, size 0x10c, virtual false, abstract: false, final false
inline void DigestAddCounter(int64_t  seedVal) ;

/// @brief Method DigestDoFinal, addr 0x3322464, size 0xbc, virtual false, abstract: false, final false
inline void DigestDoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  result) ;

/// @brief Method DigestUpdate, addr 0x332239c, size 0xc8, virtual false, abstract: false, final false
inline void DigestUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  inSeed) ;

/// @brief Method GenerateState, addr 0x3322848, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method NextBytes, addr 0x33226e0, size 0x18, virtual true, abstract: false, final true
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method NextBytes, addr 0x33226f8, size 0x150, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3322184, size 0x164, virtual false, abstract: false, final false
