...
public:
  ...
  /// @brief Method Generate, addr 0x332562c, size 0x480, virtual false, abstract: false, final false
  inline int32_t Generate(::ArrayW<uint8_t, ::Array<uint8_t>*> output, bool predictionResistant);

  /// @brief Method Increment, addr 0x3325c00, size 0x44, virtual false, abstract: false, final false
  inline void Increment(::ArrayW<uint8_t, ::Array<uint8_t>*> val);

  /// @brief Method IsTooLarge, addr 0x3325aac, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Process, addr 0x3325ac0, size 0x140, virtual false, abstract: false, final false
  inline void Process(::ArrayW<uint8_t, ::Array<uint8_t>*> res, ::ArrayW<uint8_t, ::Array<uint8_t>*> a, ::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method Reseed, addr 0x3325c44, size 0x190, virtual false, abstract: false, final false
  inline void Reseed();
  ...
  /// @brief Method .ctor, addr 0x3325430, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EntropySource, addr 0x3325dd4, size 0x8, virtual false, abstract: false, final false
