...
public:
  // Declarations
  /// @brief Method GenerateSeed, addr 0x23c66cc, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c6828, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
