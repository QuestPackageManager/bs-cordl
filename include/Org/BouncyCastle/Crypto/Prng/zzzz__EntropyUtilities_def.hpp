...
public:
  // Declarations
  /// @brief Method GenerateSeed, addr 0x23ca17c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ca2d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
