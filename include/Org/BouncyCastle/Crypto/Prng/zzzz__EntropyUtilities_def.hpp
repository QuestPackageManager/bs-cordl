...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EntropyUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EntropyUtilities(EntropyUtilities&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EntropyUtilities", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EntropyUtilities(EntropyUtilitiesconst&) = delete;
