...
public:
  // Declarations
  /// @brief Method GenerateSeed, addr 0x32f815c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32f82c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
