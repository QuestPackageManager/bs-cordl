...
public:
  ...
  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy, addr 0x23c9ba4, size 0x70, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize, addr 0x23c9c90, size 0x8, virtual true, abstract: false, final true
  inline int32_t Org_BouncyCastle_Crypto_IEntropySource_get_EntropySize();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant, addr 0x23c9b9c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23c9b5c, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Get, addr 0x23c9ae4, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23c9ab4, size 0x30, virtual false, abstract: false, final false
