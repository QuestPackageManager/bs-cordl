...
public:
  ...
  /// @brief Method Build, addr 0xfd7744, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDateTimeVector, addr 0xfd773c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd7624, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xfd7688, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* entropySource, bool predictionResistant);

  /// @brief Method .ctor, addr 0xfd7714, size 0x28, virtual false, abstract: false, final false
