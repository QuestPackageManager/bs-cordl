...
public:
  ...
  /// @brief Method Build, addr 0x341fa04, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDateTimeVector, addr 0x341f9fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x341f924, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x341f984, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* entropySource, bool predictionResistant);

  /// @brief Method .ctor, addr 0x341f9f4, size 0x8, virtual false, abstract: false, final false
