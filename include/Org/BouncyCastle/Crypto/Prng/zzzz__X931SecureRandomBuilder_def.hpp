...
public:
  ...
  /// @brief Method Build, addr 0x23984b8, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDateTimeVector, addr 0x23984b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23983a8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2398404, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* entropySource, bool predictionResistant);

  /// @brief Method .ctor, addr 0x2398488, size 0x28, virtual false, abstract: false, final false
