...
public:
  ...
  /// @brief Method Build, addr 0x33627b0, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDateTimeVector, addr 0x33627a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33626d0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3362730, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* entropySource, bool predictionResistant);

  /// @brief Method .ctor, addr 0x33627a0, size 0x8, virtual false, abstract: false, final false
