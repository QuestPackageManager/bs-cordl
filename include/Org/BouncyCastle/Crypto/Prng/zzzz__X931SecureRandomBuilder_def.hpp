...
public:
  ...
  /// @brief Method Build, addr 0x11a39ec, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDateTimeVector, addr 0x11a39e4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a38cc, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11a3930, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* entropySource, bool predictionResistant);

  /// @brief Method .ctor, addr 0x11a39bc, size 0x28, virtual false, abstract: false, final false
