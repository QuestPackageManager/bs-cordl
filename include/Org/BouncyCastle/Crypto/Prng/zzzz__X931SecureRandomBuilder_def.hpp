...
public:
  ...
  /// @brief Method Build, addr 0x11aa25c, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDateTimeVector, addr 0x11aa254, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11aa13c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11aa1a0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* entropySource, bool predictionResistant);

  /// @brief Method .ctor, addr 0x11aa22c, size 0x28, virtual false, abstract: false, final false
