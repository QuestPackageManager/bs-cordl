...
public:
  ...
  /// @brief Method Build, addr 0xfb6040, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDateTimeVector, addr 0xfb6038, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb5f20, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xfb5f84, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Security::SecureRandom* entropySource, bool predictionResistant);

  /// @brief Method .ctor, addr 0xfb6010, size 0x28, virtual false, abstract: false, final false
