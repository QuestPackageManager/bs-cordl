...
public:
  ...
  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy, addr 0xfb1c10, size 0x88, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize, addr 0xfb1c98, size 0x8, virtual true, abstract: false, final true
  inline int32_t Org_BouncyCastle_Crypto_IEntropySource_get_EntropySize();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant, addr 0xfb1c08, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfb1bc8, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Get, addr 0xfb1b48, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfb1aa0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xfb1ac4, size 0x84, virtual false, abstract: false, final false
