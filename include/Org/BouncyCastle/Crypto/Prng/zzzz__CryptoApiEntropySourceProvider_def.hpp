...
public:
  ...
  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy, addr 0x335e574, size 0x8c, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize, addr 0x335e600, size 0x8, virtual true, abstract: false, final true
  inline int32_t Org_BouncyCastle_Crypto_IEntropySource_get_EntropySize();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant, addr 0x335e56c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x335e55c, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Get, addr 0x335e4f0, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x335e46c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x335e490, size 0x60, virtual false, abstract: false, final false
