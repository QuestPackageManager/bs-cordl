...
public:
  ...
  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy, addr 0xfd3314, size 0x88, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize, addr 0xfd339c, size 0x8, virtual true, abstract: false, final true
  inline int32_t Org_BouncyCastle_Crypto_IEntropySource_get_EntropySize();

  /// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant, addr 0xfd330c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfd32cc, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Get, addr 0xfd324c, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfd31a4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xfd31c8, size 0x84, virtual false, abstract: false, final false
