...
static inline ::Org::BouncyCastle::Crypto::Prng::CryptoApiEntropySourceProvider_CryptoApiEntropySource* New_ctor(::System::Security::Cryptography::RandomNumberGenerator*  rng, bool  predictionResistant, int32_t  entropySize) ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy, addr 0x3321f30, size 0x8c, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize, addr 0x3321fbc, size 0x8, virtual true, abstract: false, final true
inline int32_t Org_BouncyCastle_Crypto_IEntropySource_get_EntropySize() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant, addr 0x3321f28, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3321f18, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Get, addr 0x3321eac, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3321e28, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3321e4c, size 0x60, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Crypto::Prng::CryptoApiEntropySourceProvider_CryptoApiEntropySource*, "Org.BouncyCastle.Crypto.Prng", "CryptoApiEntropySourceProvider/CryptoApiEntropySource");
