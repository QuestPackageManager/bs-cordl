...
public:
  ...
  /// @brief Method GetMaxSecurityStrength, addr 0x23c6e24, size 0x184, virtual false, abstract: false, final false
  static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IDigest* d);

  /// @brief Method GetMaxSecurityStrength, addr 0x23c6fa8, size 0x1cc, virtual false, abstract: false, final false
  static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IMac* m);

  /// @brief Method HashDF, addr 0x23c7174, size 0x510, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTooLarge, addr 0x23c659c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c7684, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
