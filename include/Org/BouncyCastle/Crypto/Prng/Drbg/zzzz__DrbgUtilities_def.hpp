...
/// @brief Method GetMaxSecurityStrength, addr 0x335c374, size 0x17c, virtual false, abstract: false, final false
static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IDigest*  d) ;

/// @brief Method GetMaxSecurityStrength, addr 0x335c4f0, size 0x1d0, virtual false, abstract: false, final false
static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IMac*  m) ;

/// @brief Method HashDF, addr 0x335c6c0, size 0x51c, virtual false, abstract: false, final false
...
/// @brief Method IsTooLarge, addr 0x335bac4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x335cbdc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
