...
public:
  ...
  /// @brief Method GetMaxSecurityStrength, addr 0x23cab5c, size 0x184, virtual false, abstract: false, final false
  static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IDigest* d);

  /// @brief Method GetMaxSecurityStrength, addr 0x23cace0, size 0x1cc, virtual false, abstract: false, final false
  static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IMac* m);

  /// @brief Method HashDF, addr 0x23caeac, size 0x510, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTooLarge, addr 0x23ca2d4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23cb3bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
