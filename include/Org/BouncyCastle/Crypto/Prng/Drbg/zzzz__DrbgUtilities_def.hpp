...
public:
  ...
  /// @brief Method GetMaxSecurityStrength, addr 0xfaeac8, size 0x184, virtual false, abstract: false, final false
  static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IDigest* d);

  /// @brief Method GetMaxSecurityStrength, addr 0xfaec4c, size 0x1cc, virtual false, abstract: false, final false
  static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IMac* m);

  /// @brief Method HashDF, addr 0xfaee18, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTooLarge, addr 0xfae240, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfaf32c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
