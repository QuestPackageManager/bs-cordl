...
public:
  ...
  /// @brief Method GetMaxSecurityStrength, addr 0x23c675c, size 0x184, virtual false, abstract: false, final false
  static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IDigest* d);

  /// @brief Method GetMaxSecurityStrength, addr 0x23c68e0, size 0x1cc, virtual false, abstract: false, final false
  static inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IMac* m);

  /// @brief Method HashDF, addr 0x23c6aac, size 0x510, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTooLarge, addr 0x23c5ed4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c6fbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
