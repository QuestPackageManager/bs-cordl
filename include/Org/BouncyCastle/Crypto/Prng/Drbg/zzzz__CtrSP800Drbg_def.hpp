...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::Drbg::CtrSP800Drbg*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::Drbg::CtrSP800Drbg*, "Org.BouncyCastle.Crypto.Prng.Drbg", "CtrSP800Drbg");
...
public:
  ...
  __declspec(property(get = getStaticF_K_BITS, put = setStaticF_K_BITS)) ::ArrayW<uint8_t> K_BITS;
  ...
  __declspec(property(get = __cordl_internal_get_mKey, put = __cordl_internal_set_mKey)) ::ArrayW<uint8_t> mKey;
  ...
  __declspec(property(get = __cordl_internal_get_mV, put = __cordl_internal_set_mV)) ::ArrayW<uint8_t> mV;
  ...
  /// @brief Method AddOneTo, addr 0x3419914, size 0x54, virtual false, abstract: false, final false
  inline void AddOneTo(::ArrayW<uint8_t> longer);

  /// @brief Method BCC, addr 0x3419b14, size 0x314, virtual false, abstract: false, final false
  inline void BCC(::ArrayW<uint8_t> bccOut, ::ArrayW<uint8_t> k, ::ArrayW<uint8_t> iV, ::ArrayW<uint8_t> data);

  /// @brief Method Block_Cipher_df, addr 0x3419034, size 0x4e4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> Block_Cipher_df(::ArrayW<uint8_t> inputString, int32_t bitLength);

  /// @brief Method CTR_DRBG_Instantiate_algorithm, addr 0x3418e5c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CTR_DRBG_Reseed_algorithm, addr 0x34199ec, size 0xa8, virtual false, abstract: false, final false
  inline void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t> additionalInput);

  /// @brief Method CTR_DRBG_Update, addr 0x3419518, size 0x350, virtual false, abstract: false, final false
  inline void CTR_DRBG_Update(::ArrayW<uint8_t> seed, ::ArrayW<uint8_t> key, ::ArrayW<uint8_t> v);

  /// @brief Method ExpandKey, addr 0x3419868, size 0xac, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ExpandKey(::ArrayW<uint8_t> key);

  /// @brief Method Generate, addr 0x3419e44, size 0x4c0, virtual true, abstract: false, final true
  inline int32_t Generate(::ArrayW<uint8_t> output, ::ArrayW<uint8_t> additionalInput, bool predictionResistant);

  /// @brief Method GetEntropy, addr 0x3418d44, size 0x118, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEntropy();

  /// @brief Method GetMaxSecurityStrength, addr 0x3418aec, size 0xfc, virtual false, abstract: false, final false
  inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t keySizeInBits);

  /// @brief Method IsTdea, addr 0x3418be8, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method PadKey, addr 0x341a31c, size 0x298, virtual false, abstract: false, final false
  inline void PadKey(::ArrayW<uint8_t> keyMaster, int32_t keyOff, ::ArrayW<uint8_t> tmp, int32_t tmpOff);

  /// @brief Method Reseed, addr 0x341a318, size 0x4, virtual true, abstract: false, final true
  inline void Reseed(::ArrayW<uint8_t> additionalInput);

  /// @brief Method XOR, addr 0x3419968, size 0x84, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mKey() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mKey();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mV();
  ...
  constexpr void __cordl_internal_set_mKey(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x34188ac, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method copyIntToByteArray, addr 0x3419a94, size 0x80, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<uint8_t> getStaticF_K_BITS();

  static inline int32_t getStaticF_TDEA_MAX_BITS_REQUEST();

  static inline int64_t getStaticF_TDEA_RESEED_MAX();

  /// @brief Method get_BlockSize, addr 0x3419e28, size 0x1c, virtual true, abstract: false, final true
  ...
  static inline void setStaticF_K_BITS(::ArrayW<uint8_t> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CtrSP800Drbg", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CtrSP800Drbg(CtrSP800Drbg&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CtrSP800Drbg", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CtrSP800Drbg(CtrSP800Drbgconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::Drbg::CtrSP800Drbg) == 0x50, "Size mismatch!");
