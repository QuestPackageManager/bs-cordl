...
public:
  ...
  /// @brief Method AddOneTo, addr 0x335a338, size 0x54, virtual false, abstract: false, final false
  inline void AddOneTo(::ArrayW<uint8_t, ::Array<uint8_t>*> longer);

  /// @brief Method BCC, addr 0x335a538, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method Block_Cipher_df, addr 0x3359a58, size 0x4e4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Block_Cipher_df(::ArrayW<uint8_t, ::Array<uint8_t>*> inputString, int32_t bitLength);

  /// @brief Method CTR_DRBG_Instantiate_algorithm, addr 0x3359880, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CTR_DRBG_Reseed_algorithm, addr 0x335a410, size 0xa8, virtual false, abstract: false, final false
  inline void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method CTR_DRBG_Update, addr 0x3359f3c, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandKey, addr 0x335a28c, size 0xac, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ExpandKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method Generate, addr 0x335a868, size 0x4c0, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEntropy, addr 0x3359768, size 0x118, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEntropy();

  /// @brief Method GetMaxSecurityStrength, addr 0x3359510, size 0xfc, virtual false, abstract: false, final false
  inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t keySizeInBits);

  /// @brief Method IsTdea, addr 0x335960c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method PadKey, addr 0x335ad40, size 0x298, virtual false, abstract: false, final false
  inline void PadKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyMaster, int32_t keyOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> tmp, int32_t tmpOff);

  /// @brief Method Reseed, addr 0x335ad3c, size 0x4, virtual true, abstract: false, final true
  inline void Reseed(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method XOR, addr 0x335a38c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33592d0, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method copyIntToByteArray, addr 0x335a4b8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0x335a84c, size 0x1c, virtual true, abstract: false, final true
