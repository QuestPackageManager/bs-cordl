...
public:
  ...
  /// @brief Method AddOneTo, addr 0xfad850, size 0x68, virtual false, abstract: false, final false
  inline void AddOneTo(::ArrayW<uint8_t, ::Array<uint8_t>*> longer);

  /// @brief Method BCC, addr 0xfada70, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method Block_Cipher_df, addr 0xfacf8c, size 0x4d8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Block_Cipher_df(::ArrayW<uint8_t, ::Array<uint8_t>*> inputString, int32_t bitLength);

  /// @brief Method CTR_DRBG_Instantiate_algorithm, addr 0xfacd70, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method CTR_DRBG_Reseed_algorithm, addr 0xfad94c, size 0xa4, virtual false, abstract: false, final false
  inline void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method CTR_DRBG_Update, addr 0xfad464, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandKey, addr 0xfad7ac, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ExpandKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method Generate, addr 0xfadd9c, size 0x4a4, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEntropy, addr 0xfacc58, size 0x118, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEntropy();

  /// @brief Method GetMaxSecurityStrength, addr 0xfaca1c, size 0xec, virtual false, abstract: false, final false
  inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t keySizeInBits);

  /// @brief Method IsTdea, addr 0xfacb08, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method PadKey, addr 0xfae258, size 0x290, virtual false, abstract: false, final false
  inline void PadKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyMaster, int32_t keyOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> tmp, int32_t tmpOff);

  /// @brief Method Reseed, addr 0xfae254, size 0x4, virtual true, abstract: false, final true
  inline void Reseed(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method XOR, addr 0xfad8b8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfac7c8, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method copyIntToByteArray, addr 0xfad9f0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0xfadd7c, size 0x20, virtual true, abstract: false, final true
