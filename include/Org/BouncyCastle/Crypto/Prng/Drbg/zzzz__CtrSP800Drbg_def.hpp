...
public:
  ...
  /// @brief Method .ctor addr 0xec677c size 0x254 virtual false final false
  ...
  /// @brief Method CTR_DRBG_Instantiate_algorithm addr 0xec6d24 size 0x21c virtual false final false
  ...
  /// @brief Method CTR_DRBG_Update addr 0xec7418 size 0x348 virtual false final false
  ...
  /// @brief Method CTR_DRBG_Reseed_algorithm addr 0xec7900 size 0xa4 virtual false final false
  inline void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method XOR addr 0xec786c size 0x94 virtual false final false
  ...
  /// @brief Method AddOneTo addr 0xec7804 size 0x68 virtual false final false
  inline void AddOneTo(::ArrayW<uint8_t, ::Array<uint8_t>*> longer);

  /// @brief Method GetEntropy addr 0xec6c0c size 0x118 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEntropy();

  /// @brief Method Block_Cipher_df addr 0xec6f40 size 0x4d8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Block_Cipher_df(::ArrayW<uint8_t, ::Array<uint8_t>*> inputString, int32_t bitLength);

  /// @brief Method BCC addr 0xec7a24 size 0x30c virtual false final false
  ...
  /// @brief Method copyIntToByteArray addr 0xec79a4 size 0x80 virtual false final false
  inline void copyIntToByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t value, int32_t offSet);

  /// @brief Method get_BlockSize addr 0xec7d30 size 0x20 virtual true final true
  inline int32_t get_BlockSize();

  /// @brief Method Generate addr 0xec7d50 size 0x4a4 virtual true final true
  ...
  /// @brief Method Reseed addr 0xec8208 size 0x4 virtual true final true
  inline void Reseed(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method IsTdea addr 0xec6abc size 0x150 virtual false final false
  inline bool IsTdea(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method GetMaxSecurityStrength addr 0xec69d0 size 0xec virtual false final false
  inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t keySizeInBits);

  /// @brief Method ExpandKey addr 0xec7760 size 0xa4 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ExpandKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method PadKey addr 0xec820c size 0x290 virtual false final false
