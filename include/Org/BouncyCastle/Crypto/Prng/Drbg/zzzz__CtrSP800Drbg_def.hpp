...
public:
  ...
  /// @brief Method AddOneTo, addr 0x11aed64, size 0x68, virtual false, abstract: false, final false
  inline void AddOneTo(::ArrayW<uint8_t, ::Array<uint8_t>*> longer);

  /// @brief Method BCC, addr 0x11aef84, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method Block_Cipher_df, addr 0x11ae4a0, size 0x4d8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Block_Cipher_df(::ArrayW<uint8_t, ::Array<uint8_t>*> inputString, int32_t bitLength);

  /// @brief Method CTR_DRBG_Instantiate_algorithm, addr 0x11ae284, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method CTR_DRBG_Reseed_algorithm, addr 0x11aee60, size 0xa4, virtual false, abstract: false, final false
  inline void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method CTR_DRBG_Update, addr 0x11ae978, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandKey, addr 0x11aecc0, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ExpandKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method Generate, addr 0x11af2b0, size 0x4a4, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEntropy, addr 0x11ae16c, size 0x118, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEntropy();

  /// @brief Method GetMaxSecurityStrength, addr 0x11adf30, size 0xec, virtual false, abstract: false, final false
  inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t keySizeInBits);

  /// @brief Method IsTdea, addr 0x11ae01c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method PadKey, addr 0x11af76c, size 0x290, virtual false, abstract: false, final false
  inline void PadKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyMaster, int32_t keyOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> tmp, int32_t tmpOff);

  /// @brief Method Reseed, addr 0x11af768, size 0x4, virtual true, abstract: false, final true
  inline void Reseed(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method XOR, addr 0x11aedcc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11adcdc, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method copyIntToByteArray, addr 0x11aef04, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0x11af290, size 0x20, virtual true, abstract: false, final true
