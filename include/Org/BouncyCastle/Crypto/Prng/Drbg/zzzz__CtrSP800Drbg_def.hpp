...
public:
  ...
  /// @brief Method AddOneTo, addr 0x23c41cc, size 0x48, virtual false, abstract: false, final false
  inline void AddOneTo(::ArrayW<uint8_t, ::Array<uint8_t>*> longer);

  /// @brief Method BCC, addr 0x23c43cc, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method Block_Cipher_df, addr 0x23c3910, size 0x4d4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Block_Cipher_df(::ArrayW<uint8_t, ::Array<uint8_t>*> inputString, int32_t bitLength);

  /// @brief Method CTR_DRBG_Instantiate_algorithm, addr 0x23c3750, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method CTR_DRBG_Reseed_algorithm, addr 0x23c42a8, size 0xa4, virtual false, abstract: false, final false
  inline void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method CTR_DRBG_Update, addr 0x23c3de4, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandKey, addr 0x23c4128, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ExpandKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method Generate, addr 0x23c46f4, size 0x4ac, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEntropy, addr 0x23c363c, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEntropy();

  /// @brief Method GetMaxSecurityStrength, addr 0x23c3400, size 0xec, virtual false, abstract: false, final false
  inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t keySizeInBits);

  /// @brief Method IsTdea, addr 0x23c34ec, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method PadKey, addr 0x23c4bb8, size 0x290, virtual false, abstract: false, final false
  inline void PadKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyMaster, int32_t keyOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> tmp, int32_t tmpOff);

  /// @brief Method Reseed, addr 0x23c4bb4, size 0x4, virtual true, abstract: false, final true
  inline void Reseed(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method XOR, addr 0x23c4214, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c31b8, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method copyIntToByteArray, addr 0x23c434c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0x23c46d4, size 0x20, virtual true, abstract: false, final true
