...
public:
  ...
  /// @brief Method AddOneTo, addr 0x23c31b0, size 0x48, virtual false, abstract: false, final false
  inline void AddOneTo(::ArrayW<uint8_t, ::Array<uint8_t>*> longer);

  /// @brief Method BCC, addr 0x23c33b0, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method Block_Cipher_df, addr 0x23c28f4, size 0x4d4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Block_Cipher_df(::ArrayW<uint8_t, ::Array<uint8_t>*> inputString, int32_t bitLength);

  /// @brief Method CTR_DRBG_Instantiate_algorithm, addr 0x23c2734, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method CTR_DRBG_Reseed_algorithm, addr 0x23c328c, size 0xa4, virtual false, abstract: false, final false
  inline void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method CTR_DRBG_Update, addr 0x23c2dc8, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandKey, addr 0x23c310c, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ExpandKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method Generate, addr 0x23c36d8, size 0x4ac, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEntropy, addr 0x23c2620, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEntropy();

  /// @brief Method GetMaxSecurityStrength, addr 0x23c23e4, size 0xec, virtual false, abstract: false, final false
  inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t keySizeInBits);

  /// @brief Method IsTdea, addr 0x23c24d0, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method PadKey, addr 0x23c3b9c, size 0x290, virtual false, abstract: false, final false
  inline void PadKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyMaster, int32_t keyOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> tmp, int32_t tmpOff);

  /// @brief Method Reseed, addr 0x23c3b98, size 0x4, virtual true, abstract: false, final true
  inline void Reseed(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method XOR, addr 0x23c31f8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c219c, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method copyIntToByteArray, addr 0x23c3330, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0x23c36b8, size 0x20, virtual true, abstract: false, final true
