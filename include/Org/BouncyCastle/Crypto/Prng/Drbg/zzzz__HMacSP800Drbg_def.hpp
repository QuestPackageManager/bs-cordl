...
public:
  ...
  /// @brief Method Generate, addr 0x335dccc, size 0x528, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEntropy, addr 0x335d724, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Reseed, addr 0x335e1f4, size 0x94, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x335d428, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0x335dcb0, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_BlockSize();

  /// @brief Method hmac_DRBG_Update, addr 0x335d83c, size 0x40, virtual false, abstract: false, final false
  inline void hmac_DRBG_Update(::ArrayW<uint8_t, ::Array<uint8_t>*> seedMaterial);

  /// @brief Method hmac_DRBG_Update_Func, addr 0x335d87c, size 0x434, virtual false, abstract: false, final false
