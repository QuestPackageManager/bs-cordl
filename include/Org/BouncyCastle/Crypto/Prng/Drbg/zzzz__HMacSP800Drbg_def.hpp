...
public:
  ...
  /// @brief Method Generate, addr 0x11a54dc, size 0x510, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEntropy, addr 0x11a4f30, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Reseed, addr 0x11a59ec, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x11a4bdc, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0x11a54bc, size 0x20, virtual true, abstract: false, final true
  inline int32_t get_BlockSize();

  /// @brief Method hmac_DRBG_Update, addr 0x11a5048, size 0x40, virtual false, abstract: false, final false
  inline void hmac_DRBG_Update(::ArrayW<uint8_t, ::Array<uint8_t>*> seedMaterial);

  /// @brief Method hmac_DRBG_Update_Func, addr 0x11a5088, size 0x434, virtual false, abstract: false, final false
