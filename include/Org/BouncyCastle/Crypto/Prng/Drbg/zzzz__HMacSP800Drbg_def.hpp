...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Prng::Drbg::HMacSP800Drbg*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Prng::Drbg::HMacSP800Drbg*, "Org.BouncyCastle.Crypto.Prng.Drbg", "HMacSP800Drbg");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_mK, put = __cordl_internal_set_mK)) ::ArrayW<uint8_t> mK;
  ...
  /// @brief Method Generate, addr 0x341d2a8, size 0x528, virtual true, abstract: false, final true
  inline int32_t Generate(::ArrayW<uint8_t> output, ::ArrayW<uint8_t> additionalInput, bool predictionResistant);

  /// @brief Method GetEntropy, addr 0x341cd00, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Reseed, addr 0x341d7d0, size 0x94, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mK() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mK();
  ...
  constexpr void __cordl_internal_set_mK(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x341ca04, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlockSize, addr 0x341d28c, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_BlockSize();

  /// @brief Method hmac_DRBG_Update, addr 0x341ce18, size 0x40, virtual false, abstract: false, final false
  inline void hmac_DRBG_Update(::ArrayW<uint8_t> seedMaterial);

  /// @brief Method hmac_DRBG_Update_Func, addr 0x341ce58, size 0x434, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HMacSP800Drbg", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HMacSP800Drbg(HMacSP800Drbg&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HMacSP800Drbg", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HMacSP800Drbg(HMacSP800Drbgconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 1098 };

  /// @brief Field mK, offset: 0x10, size: 0x8, def value: None
  ::ArrayW<uint8_t> ___mK;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Prng::Drbg::HMacSP800Drbg) == 0x40, "Size mismatch!");
