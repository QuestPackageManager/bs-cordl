...
public:
  ...
  /// @brief Method GenerateSeed, addr 0x3360998, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextBytes, addr 0x33608fc, size 0x9c, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method NextBytes, addr 0x3360628, size 0x2d4, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method Reseed, addr 0x33609a0, size 0x1c8, virtual true, abstract: false, final false
  inline void Reseed(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method SetSeed, addr 0x33604e0, size 0xa4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method SetSeed, addr 0x3360584, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3360450, size 0x90, virtual false, abstract: false, final false
