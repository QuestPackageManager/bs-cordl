...
public:
  ...
  /// @brief Method GenerateSeed, addr 0x23c9804, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextBytes, addr 0x23c976c, size 0x98, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method NextBytes, addr 0x23c948c, size 0x2e0, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method Reseed, addr 0x23c980c, size 0x1d4, virtual true, abstract: false, final false
  inline void Reseed(::ArrayW<uint8_t, ::Array<uint8_t>*> additionalInput);

  /// @brief Method SetSeed, addr 0x23c9324, size 0xb4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method SetSeed, addr 0x23c93d8, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c9298, size 0x8c, virtual false, abstract: false, final false
