...
public:
  ...
  /// @brief Method GenerateSeed, addr 0x341dbec, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method NextBytes, addr 0x341db50, size 0x9c, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> buf, int32_t off, int32_t len);

  /// @brief Method NextBytes, addr 0x341d87c, size 0x2d4, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t> bytes);

  /// @brief Method Reseed, addr 0x341dbf4, size 0x1c8, virtual true, abstract: false, final false
  inline void Reseed(::ArrayW<uint8_t> additionalInput);

  /// @brief Method SetSeed, addr 0x341d734, size 0xa4, virtual true, abstract: false, final false
  inline void SetSeed(::ArrayW<uint8_t> seed);

  /// @brief Method SetSeed, addr 0x341d7d8, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x341d6a4, size 0x90, virtual false, abstract: false, final false
