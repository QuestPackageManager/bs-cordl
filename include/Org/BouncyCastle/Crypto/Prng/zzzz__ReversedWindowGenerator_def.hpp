...
public:
  ...
  /// @brief Method AddSeedMaterial, addr 0x23ca43c, size 0x134, virtual true, abstract: false, final false
  inline void AddSeedMaterial(::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method AddSeedMaterial, addr 0x23ca570, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method NextBytes, addr 0x23ca6a8, size 0x1c, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method NextBytes, addr 0x23ca8e4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ca330, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Prng::IRandomGenerator* generator, int32_t windowSize);

  /// @brief Method doNextBytes, addr 0x23ca6c4, size 0x220, virtual false, abstract: false, final false
