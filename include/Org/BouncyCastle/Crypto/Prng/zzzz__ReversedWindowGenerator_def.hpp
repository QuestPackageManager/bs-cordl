...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReversedWindowGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReversedWindowGenerator(ReversedWindowGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReversedWindowGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReversedWindowGenerator(ReversedWindowGeneratorconst&) = delete;
