...
public:
  ...
  /// @brief Method AddSeedMaterial, addr 0xfd3400, size 0x4, virtual true, abstract: false, final false
  inline void AddSeedMaterial(::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method AddSeedMaterial, addr 0xfd3404, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method NextBytes, addr 0xfd3408, size 0x20, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method NextBytes, addr 0xfd3428, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd33a4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xfd33d8, size 0x28, virtual false, abstract: false, final false
