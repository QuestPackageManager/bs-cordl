...
/// @brief Method AddSeedMaterial, addr 0x3321fe8, size 0x4, virtual true, abstract: false, final false
inline void AddSeedMaterial(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method AddSeedMaterial, addr 0x3321fec, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method NextBytes, addr 0x3321ff0, size 0x1c, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method NextBytes, addr 0x332200c, size 0x178, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3321fc4, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3321fe0, size 0x8, virtual false, abstract: false, final false
