...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VmpcRandomGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VmpcRandomGenerator(VmpcRandomGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VmpcRandomGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VmpcRandomGenerator(VmpcRandomGeneratorconst&) = delete;
