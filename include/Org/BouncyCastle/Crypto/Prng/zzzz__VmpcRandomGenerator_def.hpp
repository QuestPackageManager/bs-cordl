...
/// @brief Method AddSeedMaterial, addr 0x3325078, size 0xc4, virtual true, abstract: false, final false
inline void AddSeedMaterial(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method AddSeedMaterial, addr 0x332513c, size 0x2c, virtual true, abstract: false, final false
inline void AddSeedMaterial(int64_t  seed) ;

static inline ::Org::BouncyCastle::Crypto::Prng::VmpcRandomGenerator* New_ctor() ;

/// @brief Method NextBytes, addr 0x3325168, size 0x20, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method NextBytes, addr 0x3325188, size 0x1f8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3324ff0, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
