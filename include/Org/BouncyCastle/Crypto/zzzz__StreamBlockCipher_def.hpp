...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StreamBlockCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StreamBlockCipher(StreamBlockCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StreamBlockCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StreamBlockCipher(StreamBlockCipherconst&) = delete;
