...
public:
  ...
  /// @brief Method DecodeBlock, addr 0x33910ec, size 0x4c8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0x3390da4, size 0x348, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method GetInputBlockSize, addr 0x3390ba0, size 0xc8, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x3390c68, size 0xc8, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetPadBits, addr 0x3390d8c, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetPadBits();

  /// @brief Method GetUnderlyingCipher, addr 0x33909dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x33909e4, size 0x1bc, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x3390d94, size 0x10, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method SetPadBits, addr 0x3390d30, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3390908, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x3390914, size 0xc8, virtual true, abstract: false, final true
