...
public:
  ...
  /// @brief Method DecodeBlock, addr 0x233bf40, size 0x4d0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0x233bbfc, size 0x344, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method GetInputBlockSize, addr 0x233b9fc, size 0xc4, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x233bac0, size 0xc4, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetPadBits, addr 0x233bbe4, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetPadBits();

  /// @brief Method GetUnderlyingCipher, addr 0x233b848, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x233b850, size 0x1ac, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x233bbec, size 0x10, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method SetPadBits, addr 0x233bb84, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x233b75c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x233b788, size 0xc0, virtual true, abstract: false, final true
