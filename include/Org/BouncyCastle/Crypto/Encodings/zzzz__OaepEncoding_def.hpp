...
public:
  ...
  /// @brief Method DecodeBlock, addr 0x1111fa8, size 0x450, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0x1111c84, size 0x324, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method GetInputBlockSize, addr 0x1111ae4, size 0xc8, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x1111bac, size 0xc8, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x11118d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x111199c, size 0x148, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* param);

  /// @brief Method ItoOSP, addr 0x11128d0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x1111c74, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1111614, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x111169c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* hash);

  /// @brief Method .ctor, addr 0x1111690, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11116a8, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x11118dc, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method maskGeneratorFunction1, addr 0x11123f8, size 0x4d8, virtual false, abstract: false, final false
