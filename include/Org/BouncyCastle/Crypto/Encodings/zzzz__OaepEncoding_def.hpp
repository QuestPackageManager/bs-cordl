...
public:
  ...
  /// @brief Method DecodeBlock, addr 0x32d4e3c, size 0x444, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0x32d4b10, size 0x32c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method GetInputBlockSize, addr 0x32d4968, size 0xcc, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x32d4a34, size 0xcc, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x32d474c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x32d481c, size 0x14c, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* param);

  /// @brief Method ItoOSP, addr 0x32d5760, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x32d4b00, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32d4494, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x32d4518, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* hash);

  /// @brief Method .ctor, addr 0x32d450c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32d4524, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x32d4754, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method maskGeneratorFunction1, addr 0x32d5280, size 0x4e0, virtual false, abstract: false, final false
