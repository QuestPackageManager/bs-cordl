...
public:
  ...
  /// @brief Method .ctor addr 0xeb2e08 size 0x7c virtual false final false
  ...
  /// @brief Method .ctor addr 0xeb2e90 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0xeb2e84 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0xeb2e9c size 0x22c virtual false final false
  ...
  /// @brief Method GetUnderlyingCipher addr 0xeb30c8 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method get_AlgorithmName addr 0xeb30d0 size 0xc0 virtual true final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xeb3190 size 0x148 virtual true final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* param);

  /// @brief Method GetInputBlockSize addr 0xeb32d8 size 0xc8 virtual true final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize addr 0xeb33a0 size 0xc8 virtual true final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method ProcessBlock addr 0xeb3468 size 0x10 virtual true final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock addr 0xeb3478 size 0x324 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method DecodeBlock addr 0xeb379c size 0x450 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method ItoOSP addr 0xeb40c4 size 0x54 virtual false final false
  inline void ItoOSP(int32_t i, ::ArrayW<uint8_t, ::Array<uint8_t>*> sp);

  /// @brief Method maskGeneratorFunction1 addr 0xeb3bec size 0x4d8 virtual false final false
