...
public:
  ...
  /// @brief Method DecodeBlock, addr 0xf255fc, size 0x450, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0xf252d8, size 0x324, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method GetInputBlockSize, addr 0xf25138, size 0xc8, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0xf25200, size 0xc8, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0xf24f28, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0xf24ff0, size 0x148, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* param);

  /// @brief Method ItoOSP, addr 0xf25f24, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0xf252c8, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf24c68, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher);

  /// @brief Method .ctor, addr 0xf24cf0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* hash);

  /// @brief Method .ctor, addr 0xf24ce4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf24cfc, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0xf24f30, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method maskGeneratorFunction1, addr 0xf25a4c, size 0x4d8, virtual false, abstract: false, final false
