...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Encodings::OaepEncoding*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Encodings::OaepEncoding*, "Org.BouncyCastle.Crypto.Encodings", "OaepEncoding");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_defHash, put = __cordl_internal_set_defHash)) ::ArrayW<uint8_t> defHash;
  ...
  /// @brief Method DecodeBlock, addr 0x3394418, size 0x444, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeBlock(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0x33940ec, size 0x32c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodeBlock(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t inLen);

  /// @brief Method GetInputBlockSize, addr 0x3393f44, size 0xcc, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x3394010, size 0xcc, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x3393d28, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x3393df8, size 0x14c, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* param);

  /// @brief Method ItoOSP, addr 0x3394d3c, size 0x54, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Crypto::Encodings::OaepEncoding* New_ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* hash,
                                                                               ::ArrayW<uint8_t> encodingParams);

  static inline ::Org::BouncyCastle::Crypto::Encodings::OaepEncoding* New_ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* hash,
                                                                               ::Org::BouncyCastle::Crypto::IDigest* mgf1Hash, ::ArrayW<uint8_t> encodingParams);

  /// @brief Method ProcessBlock, addr 0x33940dc, size 0x10, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t inLen);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_defHash() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_defHash();
  ...
  constexpr void __cordl_internal_set_defHash(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x3393a70, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x3393af4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* hash);

  /// @brief Method .ctor, addr 0x3393ae8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::Org::BouncyCastle::Crypto::IDigest* hash, ::ArrayW<uint8_t> encodingParams);

  /// @brief Method .ctor, addr 0x3393b00, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x3393d30, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method maskGeneratorFunction1, addr 0x339485c, size 0x4e0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OaepEncoding", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OaepEncoding(OaepEncoding&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OaepEncoding", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OaepEncoding(OaepEncodingconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Encodings::OaepEncoding) == 0x38, "Size mismatch!");
