...
public:
  ...
  /// @brief Method CheckPkcs1Encoding, addr 0x2342820, size 0xa4, virtual false, abstract: false, final false
  static inline int32_t CheckPkcs1Encoding(::ArrayW<uint8_t, ::Array<uint8_t>*> encoded, int32_t pLen);

  /// @brief Method DecodeBlock, addr 0x2342234, size 0x2e8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method DecodeBlockOrRandom, addr 0x23428c4, size 0x2f8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlockOrRandom(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0x234251c, size 0x304, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method FindStart, addr 0x2342bbc, size 0x9c, virtual false, abstract: false, final false
  inline int32_t FindStart(uint8_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> block);

  /// @brief Method GetInputBlockSize, addr 0x23420b4, size 0xb8, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x234216c, size 0xb8, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x2341d18, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x2341de0, size 0x2d4, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x2342224, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2341b6c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x2341c7c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::ArrayW<uint8_t, ::Array<uint8_t>*> fallback);

  /// @brief Method .ctor, addr 0x2341bf0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x2341d20, size 0xc0, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_StrictLengthEnabled, addr 0x2341968, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method set_StrictLengthEnabled, addr 0x23419d8, size 0x78, virtual false, abstract: false, final false
