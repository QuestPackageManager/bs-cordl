...
public:
  ...
  /// @brief Method CheckPkcs1Encoding, addr 0x3395c7c, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t CheckPkcs1Encoding(::ArrayW<uint8_t> encoded, int32_t pLen);

  /// @brief Method DecodeBlock, addr 0x3395684, size 0x2f0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method DecodeBlockOrRandom, addr 0x3395d1c, size 0x304, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> DecodeBlockOrRandom(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method EncodeBlock, addr 0x3395974, size 0x308, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> EncodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen);

  /// @brief Method FindStart, addr 0x3396020, size 0x90, virtual false, abstract: false, final false
  inline int32_t FindStart(uint8_t type, ::ArrayW<uint8_t> block);

  /// @brief Method GetInputBlockSize, addr 0x33954fc, size 0xbc, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0x33955b8, size 0xbc, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x3395144, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x3395214, size 0x2e8, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x3395674, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3394fb0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x33950b0, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::ArrayW<uint8_t> fallback);

  /// @brief Method .ctor, addr 0x339502c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x339514c, size 0xc8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_StrictLengthEnabled, addr 0x3394d90, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_StrictLengthEnabled, addr 0x3394e04, size 0x7c, virtual false, abstract: false, final false
