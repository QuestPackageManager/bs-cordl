...
public:
  ...
  /// @brief Method get_StrictLengthEnabled, addr 0xedefa8, size 0x70, virtual false, abstract: false, final false
  static inline bool get_StrictLengthEnabled();

  /// @brief Method set_StrictLengthEnabled, addr 0xedf018, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xedf1a8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xedf22c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xedf2b8, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* cipher, ::ArrayW<uint8_t, ::Array<uint8_t>*> fallback);

  /// @brief Method GetUnderlyingCipher, addr 0xedf354, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher();

  /// @brief Method get_AlgorithmName, addr 0xedf35c, size 0xc0, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xedf41c, size 0x2dc, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method GetInputBlockSize, addr 0xedf6f8, size 0xb8, virtual true, abstract: false, final true
  inline int32_t GetInputBlockSize();

  /// @brief Method GetOutputBlockSize, addr 0xedf7b0, size 0xb8, virtual true, abstract: false, final true
  inline int32_t GetOutputBlockSize();

  /// @brief Method ProcessBlock, addr 0xedf868, size 0x10, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method EncodeBlock, addr 0xedfb68, size 0x308, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method CheckPkcs1Encoding, addr 0xedfe70, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t CheckPkcs1Encoding(::ArrayW<uint8_t, ::Array<uint8_t>*> encoded, int32_t pLen);

  /// @brief Method DecodeBlockOrRandom, addr 0xedff10, size 0x2fc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlockOrRandom(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method DecodeBlock, addr 0xedf878, size 0x2f0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method FindStart, addr 0xee020c, size 0x98, virtual false, abstract: false, final false
