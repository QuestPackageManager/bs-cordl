...
public:
  ...
  /// @brief Method .ctor, addr 0x33a3550, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33a23dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x33a3554, size 0x4, virtual false, abstract: false, final false
