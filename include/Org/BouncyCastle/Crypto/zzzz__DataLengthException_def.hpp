...
public:
  ...
  /// @brief Method .ctor, addr 0x244a268, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2449144, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x244a26c, size 0x4, virtual false, abstract: false, final false
