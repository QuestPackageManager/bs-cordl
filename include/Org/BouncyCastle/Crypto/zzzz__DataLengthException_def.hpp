...
public:
  ...
  /// @brief Method .ctor, addr 0x122ca04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x122b898, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x122ca08, size 0x4, virtual false, abstract: false, final false
