...
public:
  ...
  /// @brief Method .ctor, addr 0x1236cfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1235b90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1236d00, size 0x4, virtual false, abstract: false, final false
