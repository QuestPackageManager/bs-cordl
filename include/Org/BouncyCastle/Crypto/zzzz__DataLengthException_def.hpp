...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataLengthException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataLengthException(DataLengthException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataLengthException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataLengthException(DataLengthExceptionconst&) = delete;
