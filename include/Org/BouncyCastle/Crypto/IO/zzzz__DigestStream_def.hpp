...
public:
  ...
  /// @brief Method .ctor addr 0xe92aec size 0x80 virtual false final false
  ...
  /// @brief Method ReadDigest addr 0xe92b6c size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Crypto::IDigest* ReadDigest();

  /// @brief Method WriteDigest addr 0xe92b74 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Crypto::IDigest* WriteDigest();

  /// @brief Method Read addr 0xe92b7c size 0xfc virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte addr 0xe92c78 size 0xd0 virtual true final false
  inline int32_t ReadByte();

  /// @brief Method Write addr 0xe92d48 size 0xf0 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte addr 0xe92e38 size 0xc8 virtual true final false
  inline void WriteByte(uint8_t b);

  /// @brief Method get_CanRead addr 0xe92f00 size 0x20 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanWrite addr 0xe92f20 size 0x20 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method get_CanSeek addr 0xe92f40 size 0x20 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_Length addr 0xe92f60 size 0x20 virtual true final false
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0xe92f80 size 0x20 virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0xe92fa0 size 0x24 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method Close addr 0xe92fc4 size 0x68 virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0xe9302c size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method Seek addr 0xe93050 size 0x24 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0xe93074 size 0x24 virtual true final false
