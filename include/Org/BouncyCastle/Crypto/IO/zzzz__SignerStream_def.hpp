...
public:
  ...
  /// @brief Method .ctor addr 0xe939b4 size 0x80 virtual false final false
  ...
  /// @brief Method ReadSigner addr 0xe93a34 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Crypto::ISigner* ReadSigner();

  /// @brief Method WriteSigner addr 0xe93a3c size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Crypto::ISigner* WriteSigner();

  /// @brief Method Read addr 0xe93a44 size 0xfc virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte addr 0xe93b40 size 0xd0 virtual true final false
  inline int32_t ReadByte();

  /// @brief Method Write addr 0xe93c10 size 0xf0 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte addr 0xe93d00 size 0xc8 virtual true final false
  inline void WriteByte(uint8_t b);

  /// @brief Method get_CanRead addr 0xe93dc8 size 0x20 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanWrite addr 0xe93de8 size 0x20 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method get_CanSeek addr 0xe93e08 size 0x20 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_Length addr 0xe93e28 size 0x20 virtual true final false
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0xe93e48 size 0x20 virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0xe93e68 size 0x24 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method Close addr 0xe93e8c size 0x68 virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0xe93ef4 size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method Seek addr 0xe93f18 size 0x24 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0xe93f3c size 0x24 virtual true final false
