...
public:
  ...
  /// @brief Method Write, addr 0x238f4e8, size 0xdc, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x238f43c, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x238f40c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ISigner* signer);

  /// @brief Method get_Signer, addr 0x238f434, size 0x8, virtual true, abstract: false, final false
