...
public:
  ...
  /// @brief Method Write, addr 0x2352874, size 0xdc, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x23527c8, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2352798, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ISigner* signer);

  /// @brief Method get_Signer, addr 0x23527c0, size 0x8, virtual true, abstract: false, final false
