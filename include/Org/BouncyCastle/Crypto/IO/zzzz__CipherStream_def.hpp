...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IO::CipherStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IO::CipherStream*, "Org.BouncyCastle.Crypto.IO", "CipherStream");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_mInBuf, put = __cordl_internal_set_mInBuf)) ::ArrayW<uint8_t> mInBuf;
  ...
  /// @brief Method Close, addr 0x33e5dcc, size 0x138, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method FillInBuf, addr 0x33e5690, size 0x44, virtual false, abstract: false, final false
  inline bool FillInBuf();

  /// @brief Method Flush, addr 0x33e5f04, size 0x20, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Read, addr 0x33e56d4, size 0x158, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadAndProcessBlock, addr 0x33e582c, size 0x230, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ReadAndProcessBlock();

  /// @brief Method ReadByte, addr 0x33e55f4, size 0x9c, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x33e5f24, size 0x38, virtual true, abstract: false, final true
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x33e5f5c, size 0x38, virtual true, abstract: false, final true
  inline void SetLength(int64_t length);

  /// @brief Method Write, addr 0x33e5a5c, size 0x128, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte, addr 0x33e5b84, size 0x118, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mInBuf() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mInBuf();
  ...
  constexpr void __cordl_internal_set_mInBuf(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x33e555c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanRead, addr 0x33e5c9c, size 0x40, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x33e5d1c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x33e5cdc, size 0x40, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x33e5d24, size 0x38, virtual true, abstract: false, final true
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x33e5d5c, size 0x38, virtual true, abstract: false, final true
  inline int64_t get_Position();

  /// @brief Method get_ReadCipher, addr 0x33e55e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBufferedCipher* get_ReadCipher();

  /// @brief Method get_WriteCipher, addr 0x33e55ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBufferedCipher* get_WriteCipher();

  /// @brief Method set_Position, addr 0x33e5d94, size 0x38, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CipherStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CipherStream(CipherStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CipherStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CipherStream(CipherStreamconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::IO::CipherStream) == 0x50, "Size mismatch!");
