...
public:
  ...
  /// @brief Method .ctor, addr 0xf34100, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* mac);

  /// @brief Method get_Mac, addr 0xf34128, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IMac* get_Mac();

  /// @brief Method WriteByte, addr 0xf34130, size 0xac, virtual true, abstract: false, final false
  inline void WriteByte(uint8_t b);

  /// @brief Method Write, addr 0xf341dc, size 0xdc, virtual true, abstract: false, final false
