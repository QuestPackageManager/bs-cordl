...
/// @brief Method Write, addr 0x32ea45c, size 0xec, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x32ea3a4, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32ea374, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method get_Digest, addr 0x32ea39c, size 0x8, virtual true, abstract: false, final false
