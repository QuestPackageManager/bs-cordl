...
public:
  ...
  /// @brief Method Write, addr 0x32bfcc8, size 0xec, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method WriteByte, addr 0x32bfc10, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32bfbe0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x32bfc08, size 0x8, virtual true, abstract: false, final false
