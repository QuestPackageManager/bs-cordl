...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DigestSink", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DigestSink(DigestSink&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DigestSink", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DigestSink(DigestSinkconst&) = delete;
