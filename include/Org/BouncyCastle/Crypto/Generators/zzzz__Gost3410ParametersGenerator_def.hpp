...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x32df394, size 0x2e0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* GenerateParameters();

  /// @brief Method Init, addr 0x32dd4e4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32df674, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method procedure_A, addr 0x32dd4f0, size 0x8e4, virtual false, abstract: false, final false
  ...
  /// @brief Method procedure_Aa, addr 0x32dddd4, size 0x8d0, virtual false, abstract: false, final false
  ...
  /// @brief Method procedure_B, addr 0x32de6a4, size 0x5c8, virtual false, abstract: false, final false
  ...
  /// @brief Method procedure_Bb, addr 0x32dec6c, size 0x5b0, virtual false, abstract: false, final false
  ...
  /// @brief Method procedure_C, addr 0x32df21c, size 0x178, virtual false, abstract: false, final false
