...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x10679b0, size 0x2fc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* GenerateParameters();

  /// @brief Method Init, addr 0x1065abc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1067cac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method procedure_A, addr 0x1065ac8, size 0x8f8, virtual false, abstract: false, final false
  ...
  /// @brief Method procedure_Aa, addr 0x10663c0, size 0x8d0, virtual false, abstract: false, final false
  ...
  /// @brief Method procedure_B, addr 0x1066c90, size 0x5d4, virtual false, abstract: false, final false
  ...
  /// @brief Method procedure_Bb, addr 0x1067264, size 0x5ac, virtual false, abstract: false, final false
  ...
  /// @brief Method procedure_C, addr 0x1067810, size 0x1a0, virtual false, abstract: false, final false
