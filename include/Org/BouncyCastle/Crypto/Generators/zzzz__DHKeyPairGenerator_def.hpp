...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::DHKeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::DHKeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "DHKeyPairGenerator");
...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x33d5d98, size 0x14c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x33d5ce4, size 0xb4, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters* const& __cordl_internal_get_param() const;
  ...
  /// @brief Method .ctor, addr 0x33d5ee4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHKeyPairGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHKeyPairGenerator(DHKeyPairGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHKeyPairGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHKeyPairGenerator(DHKeyPairGeneratorconst&) = delete;
...
static_assert(offsetof(::Org::BouncyCastle::Crypto::Generators::DHKeyPairGenerator, ___param) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::DHKeyPairGenerator) == 0x18, "Size mismatch!");
