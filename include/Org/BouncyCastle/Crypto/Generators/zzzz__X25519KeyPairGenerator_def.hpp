...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x33e53d4, size 0xb4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x33e53bc, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33e5488, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X25519KeyPairGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X25519KeyPairGenerator(X25519KeyPairGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X25519KeyPairGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X25519KeyPairGenerator(X25519KeyPairGeneratorconst&) = delete;
