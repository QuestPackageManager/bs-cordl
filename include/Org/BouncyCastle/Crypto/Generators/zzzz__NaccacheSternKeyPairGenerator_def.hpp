...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x238a1a8, size 0xf5c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x238a104, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x238b834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method findFirstPrimes, addr 0x238b104, size 0x184, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* findFirstPrimes(int32_t count);

  /// @brief Method generatePrime, addr 0x238b72c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method permuteList, addr 0x238b288, size 0x4a4, virtual false, abstract: false, final false
