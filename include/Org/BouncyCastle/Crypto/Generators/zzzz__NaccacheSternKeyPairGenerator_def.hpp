...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x23866f8, size 0xf5c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x2386654, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2387d84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method findFirstPrimes, addr 0x2387654, size 0x184, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* findFirstPrimes(int32_t count);

  /// @brief Method generatePrime, addr 0x2387c7c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method permuteList, addr 0x23877d8, size 0x4a4, virtual false, abstract: false, final false
