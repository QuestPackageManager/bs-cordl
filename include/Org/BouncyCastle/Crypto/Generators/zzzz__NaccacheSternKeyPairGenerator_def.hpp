...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x106abe4, size 0xf74, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x106ab40, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x106c290, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method findFirstPrimes, addr 0x106bb58, size 0x184, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* findFirstPrimes(int32_t count);

  /// @brief Method generatePrime, addr 0x106c180, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method permuteList, addr 0x106bcdc, size 0x4a4, virtual false, abstract: false, final false
