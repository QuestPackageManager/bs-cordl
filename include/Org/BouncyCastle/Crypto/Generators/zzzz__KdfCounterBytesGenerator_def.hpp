...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x331c720, size 0x1e0, virtual true, abstract: false, final true
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff, int32_t length);

  /// @brief Method GetMac, addr 0x331c68c, size 0x8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IMac* GetMac();

  /// @brief Method Init, addr 0x331c3d8, size 0x2b4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x331c2f0, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* prf);

  /// @brief Method generateNext, addr 0x331c900, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Digest, addr 0x331c694, size 0x8c, virtual true, abstract: false, final true
