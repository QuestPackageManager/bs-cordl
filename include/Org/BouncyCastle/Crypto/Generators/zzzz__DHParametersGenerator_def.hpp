...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x3316918, size 0x124, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters();

  /// @brief Method Init, addr 0x331690c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3316ff8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
