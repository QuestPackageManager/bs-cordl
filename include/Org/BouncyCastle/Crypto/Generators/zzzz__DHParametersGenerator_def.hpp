...
public:
  ...
  /// @brief Method GenerateParameters, addr 0xf686ec, size 0x118, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters();

  /// @brief Method Init, addr 0xf686e0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf68dd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
