...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x23827cc, size 0x114, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters();

  /// @brief Method Init, addr 0x23827c0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2382e8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
