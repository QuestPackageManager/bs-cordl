...
/// @brief Method GenerateParameters, addr 0x32da2d4, size 0x124, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters() ;

/// @brief Method Init, addr 0x32da2c8, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32da9b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
