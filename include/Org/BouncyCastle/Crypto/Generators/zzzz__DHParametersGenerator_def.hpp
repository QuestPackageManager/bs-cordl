...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x1156098, size 0x118, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters();

  /// @brief Method Init, addr 0x115608c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x115677c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
