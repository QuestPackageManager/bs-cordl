...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x32da384, size 0x124, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters();

  /// @brief Method Init, addr 0x32da378, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32daa64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
