...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x2380dd0, size 0x114, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters();

  /// @brief Method Init, addr 0x2380dc4, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2381490, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
