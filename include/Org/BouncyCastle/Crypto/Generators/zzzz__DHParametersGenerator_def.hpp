...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::DHParametersGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::DHParametersGenerator*, "Org.BouncyCastle.Crypto.Generators", "DHParametersGenerator");
...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x33d5ef4, size 0x124, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters();

  /// @brief Method Init, addr 0x33d5ee8, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33d65d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::DHParametersGenerator) == 0x20, "Size mismatch!");
