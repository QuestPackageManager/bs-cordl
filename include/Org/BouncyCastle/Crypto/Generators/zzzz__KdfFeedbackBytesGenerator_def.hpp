...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x115d518, size 0x208, virtual true, abstract: false, final true
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff, int32_t length);

  /// @brief Method GetMac, addr 0x115daac, size 0x8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IMac* GetMac();

  /// @brief Method Init, addr 0x115d1d4, size 0x2bc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x115d0f4, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* prf);

  /// @brief Method generateNext, addr 0x115d720, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Digest, addr 0x115d490, size 0x88, virtual true, abstract: false, final true
