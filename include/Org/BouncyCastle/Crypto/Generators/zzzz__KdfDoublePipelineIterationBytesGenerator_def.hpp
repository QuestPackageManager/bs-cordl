...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x331d618, size 0x1e0, virtual true, abstract: false, final true
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff, int32_t length);

  /// @brief Method GetMac, addr 0x331d7f8, size 0x8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IMac* GetMac();

  /// @brief Method Init, addr 0x331cdc8, size 0x2dc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x331cccc, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* prf);

  /// @brief Method generateNext, addr 0x331d0a4, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Digest, addr 0x331d58c, size 0x8c, virtual true, abstract: false, final true
