...
public:
  ...
  /// @brief Method GenerateDerivedKey, addr 0x33dee68, size 0x388, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateDerivedKey(int32_t bytesNeeded);

  /// @brief Method GenerateDerivedMacParameters, addr 0x33df484, size 0x98, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x33df1fc, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW algorithm, int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x33df380, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateDerivedParameters, addr 0x33df1f0, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x33df298, size 0xe8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t keySize, int32_t ivSize);

  /// @brief Method Init, addr 0x33dee60, size 0x8, virtual true, abstract: false, final false
  inline void Init(::ArrayW<uint8_t> password, ::ArrayW<uint8_t> salt);

  /// @brief Method Init, addr 0x33dee58, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33dedfc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
