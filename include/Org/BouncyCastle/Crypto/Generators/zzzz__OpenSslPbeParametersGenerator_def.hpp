...
/// @brief Method GenerateDerivedKey, addr 0x32e55d0, size 0x388, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateDerivedKey(int32_t  bytesNeeded) ;

/// @brief Method GenerateDerivedMacParameters, addr 0x32e5bec, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x32e5964, size 0x9c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW  algorithm, int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x32e5ae8, size 0x104, virtual true, abstract: false, final false
...
/// @brief Method GenerateDerivedParameters, addr 0x32e5958, size 0xc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x32e5a00, size 0xe8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t  keySize, int32_t  ivSize) ;

/// @brief Method Init, addr 0x32e55c8, size 0x8, virtual true, abstract: false, final false
inline void Init(::ArrayW<uint8_t,::Array<uint8_t>*>  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt) ;

/// @brief Method Init, addr 0x32e55c0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32e5564, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
