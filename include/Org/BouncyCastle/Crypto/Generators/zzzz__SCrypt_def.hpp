...
public:
  // Declarations
  /// @brief Method BlockMix, addr 0x3325ba8, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x3325d50, size 0x30, virtual false, abstract: false, final false
  static inline void Clear(::System::Array* array);

  /// @brief Method ClearAll, addr 0x3325d80, size 0x5c, virtual false, abstract: false, final false
  static inline void ClearAll(::ArrayW<::System::Array*, ::Array<::System::Array*>*> arrays);

  /// @brief Method Generate, addr 0x33251c8, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPowerOf2, addr 0x33254b8, size 0x10, virtual false, abstract: false, final false
  static inline bool IsPowerOf2(int32_t x);

  /// @brief Method MFcrypt, addr 0x33254c8, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method SMix, addr 0x33257d8, size 0x3d0, virtual false, abstract: false, final false
  static inline void SMix(::ArrayW<uint32_t, ::Array<uint32_t>*> B, int32_t BOff, int32_t N, int32_t d, int32_t r);

  /// @brief Method SingleIterationPBKDF2, addr 0x33256bc, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Xor, addr 0x3325cc8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3325ddc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
