...
public:
  ...
  /// @brief Method GenerateBlindingFactor, addr 0x238eb90, size 0x174, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* GenerateBlindingFactor();

  /// @brief Method Init, addr 0x238e9c0, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x238ed04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
