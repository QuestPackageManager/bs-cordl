...
public:
  ...
  /// @brief Method GenerateBlindingFactor, addr 0x116ba18, size 0x188, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* GenerateBlindingFactor();

  /// @brief Method Init, addr 0x116b840, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x116bba0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
