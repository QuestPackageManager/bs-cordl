...
public:
  ...
  /// @brief Method GenerateBlindingFactor, addr 0x32bda60, size 0x178, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* GenerateBlindingFactor();

  /// @brief Method Init, addr 0x32bd870, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32bdbd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
