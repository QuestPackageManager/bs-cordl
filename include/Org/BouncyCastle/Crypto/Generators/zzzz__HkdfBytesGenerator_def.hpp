...
/// @brief Method ExpandNext, addr 0x32df9d0, size 0x100, virtual false, abstract: false, final false
inline void ExpandNext() ;

/// @brief Method Extract, addr 0x32df888, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method GenerateBytes, addr 0x32dfaec, size 0x1a4, virtual true, abstract: false, final false
inline int32_t GenerateBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, int32_t  len) ;

/// @brief Method Init, addr 0x32df6b4, size 0x1d4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32df5c8, size 0xec, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  hash) ;

/// @brief Method get_Digest, addr 0x32dfad0, size 0x1c, virtual true, abstract: false, final false
