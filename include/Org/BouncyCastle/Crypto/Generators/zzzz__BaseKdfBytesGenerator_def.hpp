...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x237fe48, size 0x52c, virtual true, abstract: false, final false
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff, int32_t length);

  /// @brief Method Init, addr 0x237fd2c, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x237fcfc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t counterStart, ::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x237fe40, size 0x8, virtual true, abstract: false, final false
