...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BaseKdfBytesGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BaseKdfBytesGenerator(BaseKdfBytesGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BaseKdfBytesGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BaseKdfBytesGenerator(BaseKdfBytesGeneratorconst&) = delete;
