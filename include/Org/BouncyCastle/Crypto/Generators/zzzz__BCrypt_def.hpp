...
public:
  ...
  /// @brief Method CyclicXorKey, addr 0x32ae0b4, size 0x84, virtual false, abstract: false, final false
  inline void CyclicXorKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method DeriveRawKey, addr 0x32ae670, size 0x320, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptMagicString, addr 0x32ae138, size 0x2dc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncryptMagicString();

  /// @brief Method F, addr 0x32addf8, size 0x84, virtual false, abstract: false, final false
  inline uint32_t F(uint32_t x);

  /// @brief Method Generate, addr 0x32aea04, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitState, addr 0x32adfb0, size 0x104, virtual false, abstract: false, final false
  inline void InitState();

  static inline ::Org::BouncyCastle::Crypto::Generators::BCrypt* New_ctor();

  /// @brief Method PasswordToByteArray, addr 0x32ae990, size 0x74, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PasswordToByteArray(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method ProcessTable, addr 0x32ade7c, size 0x134, virtual false, abstract: false, final false
  inline void ProcessTable(uint32_t xl, uint32_t xr, ::ArrayW<uint32_t, ::Array<uint32_t>*> table);

  /// @brief Method ProcessTableWithSalt, addr 0x32ae414, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32add90, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
