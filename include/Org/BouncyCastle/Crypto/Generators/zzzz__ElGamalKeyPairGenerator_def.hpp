...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::ElGamalKeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::ElGamalKeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "ElGamalKeyPairGenerator");
...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x33d8a5c, size 0x1a8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x33d89a8, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33d8c04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ElGamalKeyPairGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ElGamalKeyPairGenerator(ElGamalKeyPairGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ElGamalKeyPairGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ElGamalKeyPairGenerator(ElGamalKeyPairGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::ElGamalKeyPairGenerator) == 0x18, "Size mismatch!");
