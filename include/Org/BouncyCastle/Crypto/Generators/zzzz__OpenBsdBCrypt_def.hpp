...
public:
  ...
  /// @brief Method CheckPassword, addr 0x3320e98, size 0x4d8, virtual false, abstract: false, final false
  static inline bool CheckPassword(::StringW bcryptString, ::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method CreateBcryptString, addr 0x3320460, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeSaltString, addr 0x3321370, size 0x3b8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeSaltString(::StringW saltString);

  /// @brief Method EncodeData, addr 0x3320730, size 0x350, virtual false, abstract: false, final false
  static inline ::StringW EncodeData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Generate, addr 0x3320a80, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW Generate(::ArrayW<char16_t, ::Array<char16_t>*> password, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t cost);

  /// @brief Method Generate, addr 0x3320afc, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x332045c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
