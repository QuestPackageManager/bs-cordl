...
public:
  ...
  /// @brief Method GenerateDerivedKey, addr 0x238e584, size 0x34c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateDerivedKey();

  /// @brief Method GenerateDerivedMacParameters, addr 0x238ee78, size 0x19c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x238e8dc, size 0x1a0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW algorithm, int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x238ec70, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateDerivedParameters, addr 0x238e8d0, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x238ea7c, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x238e55c, size 0x28, virtual false, abstract: false, final false
