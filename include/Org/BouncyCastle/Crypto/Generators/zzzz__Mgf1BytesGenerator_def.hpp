...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Mgf1BytesGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Mgf1BytesGenerator(Mgf1BytesGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Mgf1BytesGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Mgf1BytesGenerator(Mgf1BytesGeneratorconst&) = delete;
