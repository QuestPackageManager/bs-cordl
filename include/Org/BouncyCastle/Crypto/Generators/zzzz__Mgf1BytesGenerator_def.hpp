...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x331e538, size 0x4c4, virtual true, abstract: false, final true
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff, int32_t length);

  /// @brief Method Init, addr 0x331e3a0, size 0x13c, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::IDerivationParameters* parameters);

  /// @brief Method ItoOSP, addr 0x331e4e4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331e2e4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x331e4dc, size 0x8, virtual true, abstract: false, final true
