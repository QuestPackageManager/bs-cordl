...
public:
  ...
  /// @brief Method GenerateBytes, addr 0x2389c48, size 0x4bc, virtual true, abstract: false, final true
  inline int32_t GenerateBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff, int32_t length);

  /// @brief Method Init, addr 0x2389aa8, size 0x144, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::IDerivationParameters* parameters);

  /// @brief Method ItoOSP, addr 0x2389bf4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23899ec, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_Digest, addr 0x2389bec, size 0x8, virtual true, abstract: false, final true
