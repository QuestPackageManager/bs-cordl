...
public:
  ...
  /// @brief Method Init, addr 0xefa280, size 0x1c, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::KeyGenerationParameters* parameters);

  /// @brief Method GenerateKeyPair, addr 0xefa29c, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xefa34c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
