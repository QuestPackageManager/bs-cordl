...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::Ed448KeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::Ed448KeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "Ed448KeyPairGenerator");
...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x33d88f0, size 0xb4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x33d88d8, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33d89a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ed448KeyPairGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Ed448KeyPairGenerator(Ed448KeyPairGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Ed448KeyPairGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Ed448KeyPairGenerator(Ed448KeyPairGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::Ed448KeyPairGenerator) == 0x18, "Size mismatch!");
