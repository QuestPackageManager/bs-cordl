...
public:
  ...
  /// @brief Method ConstructBigPrimeProducts, addr 0x115dff4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateSafePrimes, addr 0x115da20, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectGenerator, addr 0x115defc, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x115e1ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
