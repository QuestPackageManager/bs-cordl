...
/// @brief Field BigPrimeProducts, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_BigPrimeProducts, put=setStaticF_BigPrimeProducts)) ::ArrayW<::Org::BouncyCastle::Math::BigInteger*,::Array<::Org::BouncyCastle::Math::BigInteger*>*>  BigPrimeProducts;
...
/// @brief Method ConstructBigPrimeProducts, addr 0x32da9b8, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method GenerateSafePrimes, addr 0x32da3f8, size 0x4c8, virtual false, abstract: false, final false
...
/// @brief Method SelectGenerator, addr 0x32da8c0, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32dab78, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
