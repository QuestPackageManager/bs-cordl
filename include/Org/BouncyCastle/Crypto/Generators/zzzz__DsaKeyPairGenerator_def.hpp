...
public:
  ...
  /// @brief Method CalculatePublicKey, addr 0x2383370, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyPair, addr 0x238313c, size 0x144, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method GeneratePrivateKey, addr 0x2383280, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x2383054, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x238340c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
