...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::DsaKeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::DsaKeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "DsaKeyPairGenerator");
...
public:
  ...
  /// @brief Method CalculatePublicKey, addr 0x33d4750, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyPair, addr 0x33d450c, size 0x14c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method GeneratePrivateKey, addr 0x33d4658, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x33d4414, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33d47f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::DsaKeyPairGenerator) == 0x18, "Size mismatch!");
