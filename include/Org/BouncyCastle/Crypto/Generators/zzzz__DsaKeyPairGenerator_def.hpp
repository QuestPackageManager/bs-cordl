...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DsaKeyPairGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DsaKeyPairGenerator(DsaKeyPairGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DsaKeyPairGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DsaKeyPairGenerator(DsaKeyPairGeneratorconst&) = delete;
