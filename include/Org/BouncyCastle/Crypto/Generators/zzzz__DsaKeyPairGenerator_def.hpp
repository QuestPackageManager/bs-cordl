...
public:
  ...
  /// @brief Method CalculatePublicKey, addr 0xf692bc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyPair, addr 0xf69084, size 0x148, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method GeneratePrivateKey, addr 0xf691cc, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0xf68f98, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf69358, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
