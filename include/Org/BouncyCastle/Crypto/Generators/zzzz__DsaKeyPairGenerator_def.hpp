...
public:
  ...
  /// @brief Method CalculatePublicKey, addr 0xf899c0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyPair, addr 0xf89788, size 0x148, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method GeneratePrivateKey, addr 0xf898d0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0xf8969c, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf89a5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
