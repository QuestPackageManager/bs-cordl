...
public:
  ...
  /// @brief Method CalculatePublicKey, addr 0x2382ce8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyPair, addr 0x2382ab4, size 0x144, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method GeneratePrivateKey, addr 0x2382bf8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x23829cc, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2382d84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
