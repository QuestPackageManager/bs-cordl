...
public:
  ...
  /// @brief Method .ctor addr 0xe84748 size 0x48 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator* New_ctor(::StringW algorithm);

  /// @brief Method .ctor addr 0xe84790 size 0xc0 virtual false final false
  inline void _ctor(::StringW algorithm);

  /// @brief Method Init addr 0xe84850 size 0x2a8 virtual true final true
  inline void Init(::Org::BouncyCastle::Crypto::KeyGenerationParameters* parameters);

  /// @brief Method GenerateKeyPair addr 0xe84b6c size 0x314 virtual true final true
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method CreateBasePointMultiplier addr 0xe84e80 size 0x5c virtual true final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier();

  /// @brief Method FindECCurveByOid addr 0xe84af8 size 0x74 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* FindECCurveByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetCorrespondingPublicKey addr 0xe84edc size 0xfc virtual false final false
