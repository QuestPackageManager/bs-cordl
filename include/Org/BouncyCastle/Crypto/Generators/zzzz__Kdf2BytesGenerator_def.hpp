...
public:
  ...
  /// @brief Method .ctor, addr 0x33db8bc, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Kdf2BytesGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Kdf2BytesGenerator(Kdf2BytesGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Kdf2BytesGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Kdf2BytesGenerator(Kdf2BytesGeneratorconst&) = delete;
