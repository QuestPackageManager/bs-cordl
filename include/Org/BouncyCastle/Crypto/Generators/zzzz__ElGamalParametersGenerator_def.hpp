...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ElGamalParametersGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ElGamalParametersGenerator(ElGamalParametersGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ElGamalParametersGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ElGamalParametersGenerator(ElGamalParametersGeneratorconst&) = delete;
