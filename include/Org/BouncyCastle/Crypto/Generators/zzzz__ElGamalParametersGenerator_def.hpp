...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x33d688c, size 0xd8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* GenerateParameters();

  /// @brief Method Init, addr 0x33d6880, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33d6964, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
