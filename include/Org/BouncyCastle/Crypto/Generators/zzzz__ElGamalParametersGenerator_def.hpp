...
public:
  ...
  /// @brief Method GenerateParameters, addr 0x2381308, size 0xd8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* GenerateParameters();

  /// @brief Method Init, addr 0x23812fc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23813e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
