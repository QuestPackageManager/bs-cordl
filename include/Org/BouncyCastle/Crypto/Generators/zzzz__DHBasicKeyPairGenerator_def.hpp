...
/// @brief Method GenerateKeyPair, addr 0x33170fc, size 0x14c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair() ;

/// @brief Method Init, addr 0x3317048, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3317448, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
