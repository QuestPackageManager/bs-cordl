...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "DHBasicKeyPairGenerator");
...
public:
  ...
  /// @brief Method GenerateKeyPair, addr 0x33d593c, size 0x14c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x33d5888, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33d5c88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHBasicKeyPairGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHBasicKeyPairGenerator(DHBasicKeyPairGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHBasicKeyPairGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHBasicKeyPairGenerator(DHBasicKeyPairGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator) == 0x18, "Size mismatch!");
