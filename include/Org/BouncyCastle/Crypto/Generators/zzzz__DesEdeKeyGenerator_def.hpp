...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DesEdeKeyGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DesEdeKeyGenerator(DesEdeKeyGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DesEdeKeyGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DesEdeKeyGenerator(DesEdeKeyGeneratorconst&) = delete;
