...
public:
  ...
  /// @brief Method .ctor addr 0xe8e20c size 0x11c virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method Adjust addr 0xe8e328 size 0xd4 virtual false final false
  inline void Adjust(::ArrayW<uint8_t, ::Array<uint8_t>*> a, int32_t aOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method GenerateDerivedKey addr 0xe8e3fc size 0x5f0 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateDerivedKey(int32_t idByte, int32_t n);

  /// @brief Method GenerateDerivedParameters addr 0xe8e9ec size 0xa0 virtual true final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters addr 0xe8ea8c size 0x9c virtual true final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW algorithm, int32_t keySize);

  /// @brief Method GenerateDerivedParameters addr 0xe8eb28 size 0x10c virtual true final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t keySize, int32_t ivSize);

  /// @brief Method GenerateDerivedParameters addr 0xe8ec34 size 0x11c virtual true final false
  ...
  /// @brief Method GenerateDerivedMacParameters addr 0xe8ed50 size 0xa0 virtual true final false
