...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::Pkcs12ParametersGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::Pkcs12ParametersGenerator*, "Org.BouncyCastle.Crypto.Generators", "Pkcs12ParametersGenerator");
...
public:
  ...
  /// @brief Method Adjust, addr 0x33df638, size 0xb0, virtual false, abstract: false, final false
  inline void Adjust(::ArrayW<uint8_t> a, int32_t aOff, ::ArrayW<uint8_t> b);

  /// @brief Method GenerateDerivedKey, addr 0x33df6e8, size 0x5fc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateDerivedKey(int32_t idByte, int32_t n);

  /// @brief Method GenerateDerivedMacParameters, addr 0x33e003c, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x33dfd80, size 0xa0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW algorithm, int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x33dff20, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateDerivedParameters, addr 0x33dfce4, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x33dfe20, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33df51c, size 0x11c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::Pkcs12ParametersGenerator) == 0x38, "Size mismatch!");
