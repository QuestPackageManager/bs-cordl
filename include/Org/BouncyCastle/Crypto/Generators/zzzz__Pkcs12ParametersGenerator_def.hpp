...
public:
  ...
  /// @brief Method Adjust, addr 0x238db64, size 0xb8, virtual false, abstract: false, final false
  inline void Adjust(::ArrayW<uint8_t, ::Array<uint8_t>*> a, int32_t aOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method GenerateDerivedKey, addr 0x238dc1c, size 0x5f0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateDerivedKey(int32_t idByte, int32_t n);

  /// @brief Method GenerateDerivedMacParameters, addr 0x238e554, size 0x98, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x238e2a4, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW algorithm, int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x238e440, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateDerivedParameters, addr 0x238e20c, size 0x98, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t keySize);

  /// @brief Method GenerateDerivedParameters, addr 0x238e340, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x238da48, size 0x11c, virtual false, abstract: false, final false
