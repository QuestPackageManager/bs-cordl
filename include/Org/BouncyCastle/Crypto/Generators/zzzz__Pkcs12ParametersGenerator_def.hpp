...
/// @brief Method Adjust, addr 0x32e5da0, size 0xb0, virtual false, abstract: false, final false
inline void Adjust(::ArrayW<uint8_t,::Array<uint8_t>*>  a, int32_t  aOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  b) ;

/// @brief Method GenerateDerivedKey, addr 0x32e5e50, size 0x5fc, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateDerivedKey(int32_t  idByte, int32_t  n) ;

/// @brief Method GenerateDerivedMacParameters, addr 0x32e67a4, size 0x9c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x32e64e8, size 0xa0, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW  algorithm, int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x32e6688, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method GenerateDerivedParameters, addr 0x32e644c, size 0x9c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x32e6588, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32e5c84, size 0x11c, virtual false, abstract: false, final false
