...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Kdf1BytesGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Kdf1BytesGenerator(Kdf1BytesGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Kdf1BytesGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Kdf1BytesGenerator(Kdf1BytesGeneratorconst&) = delete;
