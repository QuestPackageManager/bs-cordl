...
public:
  ...
  /// @brief Method ChooseRandomPrime, addr 0xf97510, size 0x230, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* ChooseRandomPrime(int32_t bitlength, ::Org::BouncyCastle::Math::BigInteger* e);

  /// @brief Method GenerateKeyPair, addr 0xf971a4, size 0x36c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0xf97090, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf97878, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
