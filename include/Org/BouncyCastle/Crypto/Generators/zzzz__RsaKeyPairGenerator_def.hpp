...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Generators::RsaKeyPairGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Generators::RsaKeyPairGenerator*, "Org.BouncyCastle.Crypto.Generators", "RsaKeyPairGenerator");
...
public:
  ...
  __declspec(property(get = getStaticF_SPECIAL_E_VALUES, put = setStaticF_SPECIAL_E_VALUES)) ::ArrayW<int32_t> SPECIAL_E_VALUES;
  ...
  /// @brief Method ChooseRandomPrime, addr 0x33e20a4, size 0x234, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* ChooseRandomPrime(int32_t bitlength, ::Org::BouncyCastle::Math::BigInteger* e);

  /// @brief Method GenerateKeyPair, addr 0x33e1d28, size 0x37c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair();

  /// @brief Method Init, addr 0x33e1c08, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33e2418, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  static inline ::ArrayW<int32_t> getStaticF_SPECIAL_E_VALUES();
  ...
  static inline void setStaticF_SPECIAL_E_VALUES(::ArrayW<int32_t> value);
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Generators::RsaKeyPairGenerator) == 0x18, "Size mismatch!");
