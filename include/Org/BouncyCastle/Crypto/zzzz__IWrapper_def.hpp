...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IWrapper*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IWrapper*, "Org.BouncyCastle.Crypto", "IWrapper");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IWrapper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IWrapper(IWrapperconst&) = delete;
