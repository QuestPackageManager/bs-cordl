...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::CipherKeyGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::CipherKeyGenerator*, "Org.BouncyCastle.Crypto", "CipherKeyGenerator");
...
public:
  ...
  /// @brief Method GenerateKey, addr 0x33d526c, size 0x118, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GenerateKey();

  /// @brief Method Init, addr 0x33d51d8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33d5148, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33d5154, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(int32_t defaultStrength);

  /// @brief Method engineGenerateKey, addr 0x33d5384, size 0x68, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> engineGenerateKey();

  /// @brief Method engineInit, addr 0x33d5238, size 0x34, virtual true, abstract: false, final false
  inline void engineInit(::Org::BouncyCastle::Crypto::KeyGenerationParameters* parameters);

  /// @brief Method get_DefaultStrength, addr 0x33d51d0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CipherKeyGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CipherKeyGenerator(CipherKeyGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CipherKeyGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CipherKeyGenerator(CipherKeyGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::CipherKeyGenerator) == 0x28, "Size mismatch!");
