...
/// @brief Method GenerateKey, addr 0x32d964c, size 0x118, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateKey() ;

/// @brief Method Init, addr 0x32d95b8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32d9528, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x32d9534, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(int32_t  defaultStrength) ;

/// @brief Method engineGenerateKey, addr 0x32d9764, size 0x68, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> engineGenerateKey() ;

/// @brief Method engineInit, addr 0x32d9618, size 0x34, virtual true, abstract: false, final false
inline void engineInit(::Org::BouncyCastle::Crypto::KeyGenerationParameters*  parameters) ;

/// @brief Method get_DefaultStrength, addr 0x32d95b0, size 0x8, virtual false, abstract: false, final false
