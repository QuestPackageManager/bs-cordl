...
public:
  ...
  /// @brief Method CalculateByte, addr 0x23a9290, size 0x14c, virtual false, abstract: false, final false
  inline uint8_t CalculateByte(uint8_t b);

  /// @brief Method GetBlockSize, addr 0x23a91e8, size 0xa4, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x23a8e34, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x23a8e3c, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x23a9558, size 0xf8, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x23a93dc, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x23a8fec, size 0x134, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method ReturnByte, addr 0x23a928c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23a8c0c, size 0x228, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method checkCounter, addr 0x23a9554, size 0x4, virtual false, abstract: false, final false
  inline void checkCounter();

  /// @brief Method get_AlgorithmName, addr 0x23a9120, size 0xc0, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x23a91e0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method incrementCounterAt, addr 0x23a9508, size 0x4c, virtual false, abstract: false, final false
