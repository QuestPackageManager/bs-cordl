...
public:
  ...
  /// @brief Method CalculateByte, addr 0xf93bec, size 0x150, virtual false, abstract: false, final false
  inline uint8_t CalculateByte(uint8_t b);

  /// @brief Method GetBlockSize, addr 0xf93b44, size 0xa4, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0xf9378c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0xf93794, size 0x1b4, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0xf93ec4, size 0x100, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0xf93d3c, size 0x140, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0xf93948, size 0x134, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method ReturnByte, addr 0xf93be8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf93564, size 0x228, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method checkCounter, addr 0xf93ec0, size 0x4, virtual false, abstract: false, final false
  inline void checkCounter();

  /// @brief Method get_AlgorithmName, addr 0xf93a7c, size 0xc0, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0xf93b3c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method incrementCounterAt, addr 0xf93e7c, size 0x44, virtual false, abstract: false, final false
