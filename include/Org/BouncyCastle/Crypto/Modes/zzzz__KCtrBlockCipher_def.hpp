...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KCtrBlockCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KCtrBlockCipher(KCtrBlockCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KCtrBlockCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KCtrBlockCipher(KCtrBlockCipherconst&) = delete;
