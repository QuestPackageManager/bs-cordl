...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::OcbBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::OcbBlockCipher*, "Org.BouncyCastle.Crypto.Modes", "OcbBlockCipher");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_KtopInput, put = __cordl_internal_set_KtopInput)) ::ArrayW<uint8_t> KtopInput;
  ...
  __declspec(property(get = __cordl_internal_get_L_Asterisk, put = __cordl_internal_set_L_Asterisk)) ::ArrayW<uint8_t> L_Asterisk;

  /// @brief Field L_Dollar, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get_L_Dollar, put = __cordl_internal_set_L_Dollar)) ::ArrayW<uint8_t> L_Dollar;

  /// @brief Field OffsetHASH, offset 0x88, size 0x8
  __declspec(property(get = __cordl_internal_get_OffsetHASH, put = __cordl_internal_set_OffsetHASH)) ::ArrayW<uint8_t> OffsetHASH;

  /// @brief Field OffsetMAIN, offset 0x98, size 0x8
  __declspec(property(get = __cordl_internal_get_OffsetMAIN, put = __cordl_internal_set_OffsetMAIN)) ::ArrayW<uint8_t> OffsetMAIN;

  /// @brief Field OffsetMAIN_0, offset 0x58, size 0x8
  __declspec(property(get = __cordl_internal_get_OffsetMAIN_0, put = __cordl_internal_set_OffsetMAIN_0)) ::ArrayW<uint8_t> OffsetMAIN_0;

  /// @brief Field Stretch, offset 0x50, size 0x8
  __declspec(property(get = __cordl_internal_get_Stretch, put = __cordl_internal_set_Stretch)) ::ArrayW<uint8_t> Stretch;
  ...
  __declspec(property(get = __cordl_internal_get_hashBlock, put = __cordl_internal_set_hashBlock)) ::ArrayW<uint8_t> hashBlock;
  ...
  __declspec(property(get = __cordl_internal_get_mainBlock, put = __cordl_internal_set_mainBlock)) ::ArrayW<uint8_t> mainBlock;
  ...
  /// @brief Method Clear, addr 0x3400948, size 0x1c, virtual true, abstract: false, final false
  inline void Clear(::ArrayW<uint8_t> bs);

  /// @brief Method DoFinal, addr 0x3400468, size 0x414, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x34000cc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetLSub, addr 0x3400964, size 0x2dc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetLSub(int32_t n);

  /// @brief Method GetMac, addr 0x34000d4, size 0x90, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetMac();

  /// @brief Method GetOutputSize, addr 0x3400164, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method GetUnderlyingCipher, addr 0x33ff640, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method GetUpdateOutputSize, addr 0x340018c, size 0x3c, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method Init, addr 0x33ff710, size 0x6e0, virtual true, abstract: false, final false
  ...
  /// @brief Method OCB_double, addr 0x33ffdf0, size 0x98, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> OCB_double(::ArrayW<uint8_t> block);

  /// @brief Method OCB_extend, addr 0x340087c, size 0x60, virtual false, abstract: false, final false
  static inline void OCB_extend(::ArrayW<uint8_t> block, int32_t pos);

  /// @brief Method OCB_ntz, addr 0x3400cb4, size 0x38, virtual false, abstract: false, final false
  static inline int32_t OCB_ntz(int64_t x);

  /// @brief Method ProcessAadByte, addr 0x34001c8, size 0x68, virtual true, abstract: false, final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes, addr 0x3400230, size 0xc8, virtual true, abstract: false, final false
  inline void ProcessAadBytes(::ArrayW<uint8_t> input, int32_t off, int32_t len);

  /// @brief Method ProcessByte, addr 0x34002f8, size 0x7c, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x3400374, size 0xf4, virtual true, abstract: false, final false
  inline int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ProcessHashBlock, addr 0x3400c40, size 0x74, virtual true, abstract: false, final false
  inline void ProcessHashBlock();

  /// @brief Method ProcessMainBlock, addr 0x3400cec, size 0x1dc, virtual true, abstract: false, final false
  inline void ProcessMainBlock(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ProcessNonce, addr 0x33ffe88, size 0x244, virtual true, abstract: false, final false
  inline int32_t ProcessNonce(::ArrayW<uint8_t> N);

  /// @brief Method Reset, addr 0x3400934, size 0x14, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x3400ec8, size 0x1f0, virtual true, abstract: false, final false
  inline void Reset(bool clearMac);

  /// @brief Method ShiftLeft, addr 0x34011a4, size 0x60, virtual false, abstract: false, final false
  static inline int32_t ShiftLeft(::ArrayW<uint8_t> block, ::ArrayW<uint8_t> output);

  /// @brief Method UpdateHASH, addr 0x34010b8, size 0xec, virtual true, abstract: false, final false
  inline void UpdateHASH(::ArrayW<uint8_t> LSub);

  /// @brief Method Xor, addr 0x34008dc, size 0x58, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_KtopInput() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_KtopInput();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_L_Asterisk() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_L_Asterisk();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_L_Dollar() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_L_Dollar();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_OffsetHASH() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_OffsetHASH();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_OffsetMAIN() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_OffsetMAIN();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_OffsetMAIN_0() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_OffsetMAIN_0();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_Stretch() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_Stretch();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_hashBlock() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_hashBlock();
  ...
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* const& __cordl_internal_get_hashCipher() const;
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_mainBlock() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_mainBlock();
  ...
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* const& __cordl_internal_get_mainCipher() const;
  ...
  constexpr void __cordl_internal_set_KtopInput(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_L(::System::Collections::IList* value);

  constexpr void __cordl_internal_set_L_Asterisk(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_L_Dollar(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_OffsetHASH(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_OffsetMAIN(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_OffsetMAIN_0(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_Stretch(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_Sum(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_forEncryption(bool value);

  constexpr void __cordl_internal_set_hashBlock(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set_mainBlock(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x33ff274, size 0x3cc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* hashCipher, ::Org::BouncyCastle::Crypto::IBlockCipher* mainCipher);

  /// @brief Method get_AlgorithmName, addr 0x33ff648, size 0xc8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::OcbBlockCipher) == 0xb0, "Size mismatch!");
