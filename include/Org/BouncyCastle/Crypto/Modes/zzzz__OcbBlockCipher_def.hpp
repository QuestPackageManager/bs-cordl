...
public:
  ...
  /// @brief Method Clear, addr 0x1184008, size 0x1c, virtual true, abstract: false, final false
  inline void Clear(::ArrayW<uint8_t, ::Array<uint8_t>*> bs);

  /// @brief Method DoFinal, addr 0x1183b30, size 0x40c, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x11837c8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetLSub, addr 0x1184024, size 0x2cc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetLSub(int32_t n);

  /// @brief Method GetMac, addr 0x11837d0, size 0x88, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetMac();

  /// @brief Method GetOutputSize, addr 0x1183858, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method GetUnderlyingCipher, addr 0x1182d54, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method GetUpdateOutputSize, addr 0x1183880, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method Init, addr 0x1182e1c, size 0x6dc, virtual true, abstract: false, final false
  ...
  /// @brief Method OCB_double, addr 0x11834f8, size 0x98, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> OCB_double(::ArrayW<uint8_t, ::Array<uint8_t>*> block);

  /// @brief Method OCB_extend, addr 0x1183f3c, size 0x60, virtual false, abstract: false, final false
  static inline void OCB_extend(::ArrayW<uint8_t, ::Array<uint8_t>*> block, int32_t pos);

  /// @brief Method OCB_ntz, addr 0x1184360, size 0x34, virtual false, abstract: false, final false
  static inline int32_t OCB_ntz(int64_t x);

  /// @brief Method ProcessAadByte, addr 0x11838b8, size 0x68, virtual true, abstract: false, final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes, addr 0x1183920, size 0xb4, virtual true, abstract: false, final false
  inline void ProcessAadBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t off, int32_t len);

  /// @brief Method ProcessByte, addr 0x11839d4, size 0x7c, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x1183a50, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessHashBlock, addr 0x11842f0, size 0x70, virtual true, abstract: false, final false
  inline void ProcessHashBlock();

  /// @brief Method ProcessMainBlock, addr 0x1184394, size 0x1d0, virtual true, abstract: false, final false
  inline void ProcessMainBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessNonce, addr 0x1183590, size 0x238, virtual true, abstract: false, final false
  inline int32_t ProcessNonce(::ArrayW<uint8_t, ::Array<uint8_t>*> N);

  /// @brief Method Reset, addr 0x1183ff4, size 0x14, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x1184564, size 0x1ec, virtual true, abstract: false, final false
  inline void Reset(bool clearMac);

  /// @brief Method ShiftLeft, addr 0x1184830, size 0x60, virtual false, abstract: false, final false
  static inline int32_t ShiftLeft(::ArrayW<uint8_t, ::Array<uint8_t>*> block, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method UpdateHASH, addr 0x1184750, size 0xe0, virtual true, abstract: false, final false
  inline void UpdateHASH(::ArrayW<uint8_t, ::Array<uint8_t>*> LSub);

  /// @brief Method Xor, addr 0x1183f9c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1182970, size 0x3e4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* hashCipher, ::Org::BouncyCastle::Crypto::IBlockCipher* mainCipher);

  /// @brief Method get_AlgorithmName, addr 0x1182d5c, size 0xc0, virtual true, abstract: false, final false
