...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CtsBlockCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CtsBlockCipher(CtsBlockCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CtsBlockCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CtsBlockCipher(CtsBlockCipherconst&) = delete;
