...
public:
  ...
  /// @brief Method DoFinal, addr 0x333a498, size 0x5a4, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetOutputSize, addr 0x333a018, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t length);

  /// @brief Method GetUpdateOutputSize, addr 0x3339fe4, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x333a024, size 0x150, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x333a174, size 0x324, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3339e28, size 0x1bc, virtual false, abstract: false, final false
