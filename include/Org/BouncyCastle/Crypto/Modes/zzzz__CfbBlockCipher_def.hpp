...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x32cf618, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x32cf86c, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBlockSize, addr 0x32cf600, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x32cf2a0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x32cf2a8, size 0x190, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x32cf608, size 0x10, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x32cf438, size 0xc8, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x32cf020, size 0x280, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t bitBlockSize);

  /// @brief Method get_AlgorithmName, addr 0x32cf500, size 0xf8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x32cf5f8, size 0x8, virtual true, abstract: false, final true
