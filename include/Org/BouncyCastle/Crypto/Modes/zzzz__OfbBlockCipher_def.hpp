...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::OfbBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::OfbBlockCipher*, "Org.BouncyCastle.Crypto.Modes", "OfbBlockCipher");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_ofbOutV, put = __cordl_internal_set_ofbOutV)) ::ArrayW<uint8_t> ofbOutV;

  /// @brief Field ofbV, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_ofbV, put = __cordl_internal_set_ofbV)) ::ArrayW<uint8_t> ofbV;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr operator ::Org::BouncyCastle::Crypto::IBlockCipher*() noexcept;

  /// @brief Method GetBlockSize, addr 0x3403b0c, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x3403768, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x3403770, size 0x1d4, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x3403b14, size 0x254, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3403944, size 0xc8, virtual true, abstract: false, final true
  inline void Reset();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_ofbOutV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_ofbOutV();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_ofbV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_ofbV();
  ...
  constexpr void __cordl_internal_set_ofbOutV(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_ofbV(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x340358c, size 0x1dc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t blockSize);

  /// @brief Method get_AlgorithmName, addr 0x3403a0c, size 0xf8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x3403b04, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OfbBlockCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OfbBlockCipher(OfbBlockCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OfbBlockCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OfbBlockCipher(OfbBlockCipherconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::OfbBlockCipher) == 0x38, "Size mismatch!");
