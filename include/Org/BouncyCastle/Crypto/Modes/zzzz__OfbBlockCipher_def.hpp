...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x3307f9c, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x3307bf8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x3307c00, size 0x1d4, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x3307fa4, size 0x254, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3307dd4, size 0xc8, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3307a1c, size 0x1dc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t blockSize);

  /// @brief Method get_AlgorithmName, addr 0x3307e9c, size 0xf8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x3307f94, size 0x8, virtual true, abstract: false, final true
