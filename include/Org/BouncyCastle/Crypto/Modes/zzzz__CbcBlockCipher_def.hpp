...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CbcBlockCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CbcBlockCipher(CbcBlockCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CbcBlockCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CbcBlockCipher(CbcBlockCipherconst&) = delete;
