...
public:
  ...
  /// @brief Method CheckStatus, addr 0x23a8094, size 0x78, virtual false, abstract: false, final false
  inline void CheckStatus();

  /// @brief Method DoFinal, addr 0x23a87f8, size 0x52c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x23a766c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetMac, addr 0x23a7f30, size 0x88, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetMac();

  /// @brief Method GetNextCtrBlock, addr 0x23a9048, size 0x1a0, virtual false, abstract: false, final false
  inline void GetNextCtrBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> block);

  /// @brief Method GetOutputSize, addr 0x23a7fb8, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method GetUnderlyingCipher, addr 0x23a7664, size 0x8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method GetUpdateOutputSize, addr 0x23a7fe0, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method Init, addr 0x23a7674, size 0x6a4, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InitCipher, addr 0x23a81cc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAadByte, addr 0x23a8018, size 0x7c, virtual true, abstract: false, final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes, addr 0x23a810c, size 0xc0, virtual true, abstract: false, final false
  inline void ProcessAadBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t len);

  /// @brief Method ProcessBlock, addr 0x23a842c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessByte, addr 0x23a8364, size 0xc8, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x23a85a4, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessPartial, addr 0x23a8d24, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x23a9040, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x23a8e7c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23a7418, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* c);

  /// @brief Method .ctor, addr 0x23a7420, size 0x184, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* c, ::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier* m);

  /// @brief Method gHASH, addr 0x23a7d90, size 0xb4, virtual false, abstract: false, final false
  inline void gHASH(::ArrayW<uint8_t, ::Array<uint8_t>*> Y, ::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t len);

  /// @brief Method gHASHBlock, addr 0x23a7e44, size 0xec, virtual false, abstract: false, final false
  inline void gHASHBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> Y, ::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method gHASHBlock, addr 0x23a91e8, size 0xfc, virtual false, abstract: false, final false
  inline void gHASHBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> Y, ::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t off);

  /// @brief Method gHASHPartial, addr 0x23a8260, size 0x104, virtual false, abstract: false, final false
  inline void gHASHPartial(::ArrayW<uint8_t, ::Array<uint8_t>*> Y, ::ArrayW<uint8_t, ::Array<uint8_t>*> b, int32_t off, int32_t len);

  /// @brief Method get_AlgorithmName, addr 0x23a75a4, size 0xc0, virtual true, abstract: false, final false
