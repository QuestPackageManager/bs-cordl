...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher*, "Org.BouncyCastle.Crypto.Modes", "GcmBlockCipher");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_J0, put = __cordl_internal_set_J0)) ::ArrayW<uint8_t> J0;
  ...
  __declspec(property(get = __cordl_internal_get_S_at, put = __cordl_internal_set_S_at)) ::ArrayW<uint8_t> S_at;

  /// @brief Field S_atPre, offset 0x78, size 0x8
  __declspec(property(get = __cordl_internal_get_S_atPre, put = __cordl_internal_set_S_atPre)) ::ArrayW<uint8_t> S_atPre;

  /// @brief Field atBlock, offset 0x98, size 0x8
  __declspec(property(get = __cordl_internal_get_atBlock, put = __cordl_internal_set_atBlock)) ::ArrayW<uint8_t> atBlock;
  ...
  __declspec(property(get = __cordl_internal_get_bufBlock, put = __cordl_internal_set_bufBlock)) ::ArrayW<uint8_t> bufBlock;
  ...
  __declspec(property(get = __cordl_internal_get_counter, put = __cordl_internal_set_counter)) ::ArrayW<uint8_t> counter;
  ...
  __declspec(property(get = __cordl_internal_get_initialAssociatedText, put = __cordl_internal_set_initialAssociatedText)) ::ArrayW<uint8_t> initialAssociatedText;
  ...
  __declspec(property(get = __cordl_internal_get_lastKey, put = __cordl_internal_set_lastKey)) ::ArrayW<uint8_t> lastKey;

  /// @brief Field macBlock, offset 0x60, size 0x8
  __declspec(property(get = __cordl_internal_get_macBlock, put = __cordl_internal_set_macBlock)) ::ArrayW<uint8_t> macBlock;
  ...
  __declspec(property(get = __cordl_internal_get_nonce, put = __cordl_internal_set_nonce)) ::ArrayW<uint8_t> nonce;
  ...
  /// @brief Method CheckStatus, addr 0x33fc410, size 0x7c, virtual false, abstract: false, final false
  inline void CheckStatus();

  /// @brief Method DoFinal, addr 0x33fcbb4, size 0x554, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x33fb98c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetMac, addr 0x33fc2a0, size 0x90, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetMac();

  /// @brief Method GetNextCtrBlock, addr 0x33fd468, size 0x1ac, virtual false, abstract: false, final false
  inline void GetNextCtrBlock(::ArrayW<uint8_t> block);

  /// @brief Method GetOutputSize, addr 0x33fc330, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method GetUnderlyingCipher, addr 0x33fb984, size 0x8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method GetUpdateOutputSize, addr 0x33fc358, size 0x3c, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method Init, addr 0x33fb994, size 0x6e8, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InitCipher, addr 0x33fc564, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAadByte, addr 0x33fc394, size 0x7c, virtual true, abstract: false, final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes, addr 0x33fc48c, size 0xd8, virtual true, abstract: false, final false
  inline void ProcessAadBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len);

  /// @brief Method ProcessBlock, addr 0x33fc7cc, size 0x188, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t> buf, int32_t bufOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ProcessByte, addr 0x33fc704, size 0xc8, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x33fc954, size 0x260, virtual true, abstract: false, final false
  inline int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method ProcessPartial, addr 0x33fd108, size 0x164, virtual false, abstract: false, final false
  inline void ProcessPartial(::ArrayW<uint8_t> buf, int32_t off, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33fd460, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x33fd26c, size 0x1f4, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_J0() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_J0();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_S() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_S();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_S_at() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_S_at();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_S_atPre() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_S_atPre();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_atBlock() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_atBlock();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_bufBlock() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_bufBlock();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_counter() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_counter();

  constexpr ::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator* const& __cordl_internal_get_exp() const;
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_initialAssociatedText() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_initialAssociatedText();

  constexpr bool const& __cordl_internal_get_initialised() const;

  constexpr bool& __cordl_internal_get_initialised();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_lastKey() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_lastKey();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_macBlock() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_macBlock();

  constexpr int32_t const& __cordl_internal_get_macSize() const;

  constexpr int32_t& __cordl_internal_get_macSize();

  constexpr ::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier* const& __cordl_internal_get_multiplier() const;

  constexpr ::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier*& __cordl_internal_get_multiplier();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_nonce() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_nonce();
  ...
  constexpr void __cordl_internal_set_J0(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_S(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_S_at(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_S_atPre(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_atBlock(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set_bufBlock(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set_counter(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_exp(::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator* value);

  constexpr void __cordl_internal_set_forEncryption(bool value);

  constexpr void __cordl_internal_set_initialAssociatedText(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_initialised(bool value);

  constexpr void __cordl_internal_set_lastKey(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_macBlock(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set_nonce(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_totalLength(uint64_t value);

  /// @brief Method .ctor, addr 0x33fb738, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* c);

  /// @brief Method .ctor, addr 0x33fb740, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* c, ::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier* m);

  /// @brief Method gHASH, addr 0x33fc0f4, size 0xb8, virtual false, abstract: false, final false
  inline void gHASH(::ArrayW<uint8_t> Y, ::ArrayW<uint8_t> b, int32_t len);

  /// @brief Method gHASHBlock, addr 0x33fc1ac, size 0xf4, virtual false, abstract: false, final false
  inline void gHASHBlock(::ArrayW<uint8_t> Y, ::ArrayW<uint8_t> b);

  /// @brief Method gHASHBlock, addr 0x33fd614, size 0x104, virtual false, abstract: false, final false
  inline void gHASHBlock(::ArrayW<uint8_t> Y, ::ArrayW<uint8_t> b, int32_t off);

  /// @brief Method gHASHPartial, addr 0x33fc5f8, size 0x10c, virtual false, abstract: false, final false
  inline void gHASHPartial(::ArrayW<uint8_t> Y, ::ArrayW<uint8_t> b, int32_t off, int32_t len);

  /// @brief Method get_AlgorithmName, addr 0x33fb8bc, size 0xc8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GcmBlockCipher", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher) == 0xb8, "Size mismatch!");
