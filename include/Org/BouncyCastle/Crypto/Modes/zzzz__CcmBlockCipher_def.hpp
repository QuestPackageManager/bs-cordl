...
public:
  ...
  /// @brief Method .ctor addr 0xea031c size 0x22c virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method GetUnderlyingCipher addr 0xea0548 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init addr 0xea0550 size 0x1d8 virtual true final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName addr 0xea0798 size 0xc0 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method GetBlockSize addr 0xea0858 size 0xa4 virtual true final false
  inline int32_t GetBlockSize();

  /// @brief Method ProcessAadByte addr 0xea08fc size 0x24 virtual true final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes addr 0xea0920 size 0x24 virtual true final false
  inline void ProcessAadBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t len);

  /// @brief Method ProcessByte addr 0xea0944 size 0x2c virtual true final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method ProcessBytes addr 0xea0970 size 0xa0 virtual true final false
  ...
  /// @brief Method DoFinal addr 0xea0a10 size 0xa4 virtual true final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method Reset addr 0xea0ab4 size 0xdc virtual true final false
  inline void Reset();

  /// @brief Method GetMac addr 0xea0b90 size 0x68 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetMac();

  /// @brief Method GetUpdateOutputSize addr 0xea0bf8 size 0x8 virtual true final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method GetOutputSize addr 0xea0c00 size 0x54 virtual true final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method ProcessPacket addr 0xea0c54 size 0xfc virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessPacket(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method ProcessPacket addr 0xea0d50 size 0x8cc virtual true final false
  ...
  /// @brief Method CalculateMac addr 0xea161c size 0x88c virtual false final false
  ...
  /// @brief Method GetMacSize addr 0xea0728 size 0x70 virtual false final false
  inline int32_t GetMacSize(bool forEncryption, int32_t requestedMacBits);

  /// @brief Method GetAssociatedTextLength addr 0xea1ec0 size 0x38 virtual false final false
  inline int32_t GetAssociatedTextLength();

  /// @brief Method HasAssociatedText addr 0xea1ea8 size 0x18 virtual false final false
