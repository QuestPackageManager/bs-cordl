...
public:
  ...
  /// @brief Method CalculateMac, addr 0x117c87c, size 0x894, virtual false, abstract: false, final false
  ...
  /// @brief Method DoFinal, addr 0x117bc6c, size 0xa8, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method GetAssociatedTextLength, addr 0x117d128, size 0x38, virtual false, abstract: false, final false
  inline int32_t GetAssociatedTextLength();

  /// @brief Method GetBlockSize, addr 0x117bab4, size 0xa4, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetMac, addr 0x117bdf0, size 0x68, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetMac();

  /// @brief Method GetMacSize, addr 0x117b984, size 0x70, virtual false, abstract: false, final false
  inline int32_t GetMacSize(bool forEncryption, int32_t requestedMacBits);

  /// @brief Method GetOutputSize, addr 0x117be60, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method GetUnderlyingCipher, addr 0x117b7a4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method GetUpdateOutputSize, addr 0x117be58, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method HasAssociatedText, addr 0x117d110, size 0x18, virtual false, abstract: false, final false
  inline bool HasAssociatedText();

  /// @brief Method Init, addr 0x117b7ac, size 0x1d8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessAadByte, addr 0x117bb58, size 0x24, virtual true, abstract: false, final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes, addr 0x117bb7c, size 0x24, virtual true, abstract: false, final false
  inline void ProcessAadBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t len);

  /// @brief Method ProcessByte, addr 0x117bba0, size 0x2c, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x117bbcc, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessPacket, addr 0x117beb4, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ProcessPacket(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t inLen);

  /// @brief Method ProcessPacket, addr 0x117bfb0, size 0x8cc, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x117bd14, size 0xdc, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x117b578, size 0x22c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  static inline int32_t getStaticF_BlockSize();

  /// @brief Method get_AlgorithmName, addr 0x117b9f4, size 0xc0, virtual true, abstract: false, final false
