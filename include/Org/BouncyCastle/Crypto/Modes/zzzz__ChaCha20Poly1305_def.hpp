...
public:
  ...
  /// @brief Method CheckAad, addr 0x23a2718, size 0xac, virtual false, abstract: false, final false
  inline void CheckAad();

  /// @brief Method CheckData, addr 0x23a2c9c, size 0xc8, virtual false, abstract: false, final false
  inline void CheckData();

  /// @brief Method DoFinal, addr 0x23a333c, size 0x3c8, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method FinishAad, addr 0x23a38fc, size 0x2c, virtual false, abstract: false, final false
  inline void FinishAad(::Org::BouncyCastle::Crypto::Modes::ChaCha20Poly1305_State nextState);

  /// @brief Method FinishData, addr 0x23a3704, size 0x190, virtual false, abstract: false, final false
  inline void FinishData(::Org::BouncyCastle::Crypto::Modes::ChaCha20Poly1305_State nextState);

  /// @brief Method GetMac, addr 0x23a3894, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetMac();

  /// @brief Method GetOutputSize, addr 0x23a246c, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method GetUpdateOutputSize, addr 0x23a255c, size 0xf4, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method IncrementCount, addr 0x23a27c4, size 0x64, virtual false, abstract: false, final false
  inline uint64_t IncrementCount(uint64_t count, uint32_t increment, uint64_t limit);

  /// @brief Method Init, addr 0x23a1ef4, size 0x444, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InitMac, addr 0x23a3a28, size 0x1c8, virtual false, abstract: false, final false
  inline void InitMac();
  ...
  /// @brief Method PadMac, addr 0x23a3928, size 0x100, virtual false, abstract: false, final false
  inline void PadMac(uint64_t count);

  /// @brief Method ProcessAadByte, addr 0x23a2650, size 0xc8, virtual true, abstract: false, final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes, addr 0x23a2828, size 0x1ec, virtual true, abstract: false, final false
  inline void ProcessAadBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t len);

  /// @brief Method ProcessByte, addr 0x23a2a14, size 0x288, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x23a2e2c, size 0x510, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessData, addr 0x23a2d64, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x23a38f0, size 0xc, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x23a2338, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23a1c88, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23a1ce0, size 0x1d4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* poly1305);

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_Zeroes();

  /// @brief Method get_AlgorithmName, addr 0x23a1eb4, size 0x40, virtual true, abstract: false, final false
