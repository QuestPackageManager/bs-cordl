...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x33fdd14, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x33fd994, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x33fd99c, size 0x1e0, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x33fdd1c, size 0x344, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x33fdb7c, size 0xc8, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x33fd718, size 0x27c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method bytesToint, addr 0x33fe060, size 0x74, virtual false, abstract: false, final false
  inline int32_t bytesToint(::ArrayW<uint8_t> inBytes, int32_t inOff);

  /// @brief Method get_AlgorithmName, addr 0x33fdc44, size 0xc8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x33fdd0c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsPartialBlockOkay();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
  constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

  /// @brief Method intTobytes, addr 0x33fe0d4, size 0x80, virtual false, abstract: false, final false
