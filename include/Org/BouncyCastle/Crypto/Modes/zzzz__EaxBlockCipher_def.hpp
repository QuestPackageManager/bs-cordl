...
public:
  ...
  /// @brief Method CalculateMac, addr 0x33fa9b0, size 0x160, virtual false, abstract: false, final false
  inline void CalculateMac();

  /// @brief Method DoFinal, addr 0x33fb27c, size 0x35c, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method GetBlockSize, addr 0x33fa350, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetBlockSize();

  /// @brief Method GetMac, addr 0x33fb664, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetMac();

  /// @brief Method GetOutputSize, addr 0x33fb710, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetOutputSize(int32_t len);

  /// @brief Method GetUnderlyingCipher, addr 0x33fa348, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method GetUpdateOutputSize, addr 0x33fb6dc, size 0x34, virtual true, abstract: false, final false
  inline int32_t GetUpdateOutputSize(int32_t len);

  /// @brief Method Init, addr 0x33fa370, size 0x4a0, virtual true, abstract: false, final false
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method InitCipher, addr 0x33fa810, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method Process, addr 0x33faf80, size 0x268, virtual false, abstract: false, final false
  inline int32_t Process(uint8_t b, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method ProcessAadByte, addr 0x33fad18, size 0x108, virtual true, abstract: false, final false
  inline void ProcessAadByte(uint8_t input);

  /// @brief Method ProcessAadBytes, addr 0x33fae20, size 0x120, virtual true, abstract: false, final false
  inline void ProcessAadBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len);

  /// @brief Method ProcessByte, addr 0x33faf40, size 0x40, virtual true, abstract: false, final false
  inline int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method ProcessBytes, addr 0x33fb1e8, size 0x94, virtual true, abstract: false, final false
  inline int32_t ProcessBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method Reset, addr 0x33fab10, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x33fab18, size 0x200, virtual false, abstract: false, final false
  inline void Reset(bool clearMac);

  /// @brief Method VerifyMac, addr 0x33fb5d8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33fa018, size 0x254, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x33fa26c, size 0xdc, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EaxBlockCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EaxBlockCipher(EaxBlockCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EaxBlockCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EaxBlockCipher(EaxBlockCipherconst&) = delete;
