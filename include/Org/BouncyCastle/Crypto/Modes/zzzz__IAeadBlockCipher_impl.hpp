...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher::*)()>(&::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher::GetBlockSize)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Crypto::IBlockCipher* (::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher::*)()>(&::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher::GetUnderlyingCipher)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
