...
public:
  ...
  /// @brief Method DecryptBlock, addr 0x32ddc54, size 0x64c, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptBlock, addr 0x32de2a0, size 0x620, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptByte, addr 0x32deb3c, size 0x34, virtual false, abstract: false, final false
  inline uint8_t EncryptByte(uint8_t data, int32_t blockOff);

  /// @brief Method GetBlockSize, addr 0x32ddb9c, size 0xa8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x32ddac4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x32de98c, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x32ddc44, size 0x10, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0x32de8c0, size 0xcc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x32dd9b4, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x32ddacc, size 0xc8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x32ddb94, size 0x8, virtual true, abstract: false, final true
