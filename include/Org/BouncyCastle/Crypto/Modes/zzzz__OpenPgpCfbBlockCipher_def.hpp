...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::OpenPgpCfbBlockCipher*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::OpenPgpCfbBlockCipher*, "Org.BouncyCastle.Crypto.Modes", "OpenPgpCfbBlockCipher");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_FR, put = __cordl_internal_set_FR)) ::ArrayW<uint8_t> FR;

  /// @brief Field FRE, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get_FRE, put = __cordl_internal_set_FRE)) ::ArrayW<uint8_t> FRE;

  /// @brief Field IV, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get_IV, put = __cordl_internal_set_IV)) ::ArrayW<uint8_t> IV;
  ...
  /// @brief Method DecryptBlock, addr 0x3404008, size 0x64c, virtual false, abstract: false, final false
  inline int32_t DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method EncryptBlock, addr 0x3404654, size 0x620, virtual false, abstract: false, final false
  inline int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff);

  /// @brief Method EncryptByte, addr 0x3404ef0, size 0x34, virtual false, abstract: false, final false
  inline uint8_t EncryptByte(uint8_t data, int32_t blockOff);

  /// @brief Method GetBlockSize, addr 0x3403f50, size 0xa8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetUnderlyingCipher, addr 0x3403e78, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method Init, addr 0x3404d40, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x3403ff8, size 0x10, virtual true, abstract: false, final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method Reset, addr 0x3404c74, size 0xcc, virtual true, abstract: false, final true
  inline void Reset();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_FR() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_FR();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_FRE() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_FRE();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_IV() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_IV();
  ...
  constexpr void __cordl_internal_set_FR(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_FRE(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_IV(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x3403d68, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x3403e80, size 0xc8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x3403f48, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OpenPgpCfbBlockCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OpenPgpCfbBlockCipher(OpenPgpCfbBlockCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OpenPgpCfbBlockCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OpenPgpCfbBlockCipher(OpenPgpCfbBlockCipherconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 976 };

  /// @brief Field IV, offset: 0x10, size: 0x8, def value: None
  ::ArrayW<uint8_t> ___IV;

  /// @brief Field FR, offset: 0x18, size: 0x8, def value: None
  ::ArrayW<uint8_t> ___FR;

  /// @brief Field FRE, offset: 0x20, size: 0x8, def value: None
  ::ArrayW<uint8_t> ___FRE;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::OpenPgpCfbBlockCipher) == 0x40, "Size mismatch!");
