...
public:
  ...
  /// @brief Method .ctor addr 0xeb166c size 0x100 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method GetUnderlyingCipher addr 0xeb176c size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher();

  /// @brief Method get_AlgorithmName addr 0xeb1774 size 0xc0 virtual true final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay addr 0xeb1834 size 0x8 virtual true final true
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize addr 0xeb183c size 0xa4 virtual true final true
  inline int32_t GetBlockSize();

  /// @brief Method ProcessBlock addr 0xeb18e0 size 0x10 virtual true final true
  inline int32_t ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xeb253c size 0xc8 virtual true final true
  inline void Reset();

  /// @brief Method Init addr 0xeb2604 size 0x1a8 virtual true final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method EncryptByte addr 0xeb27ac size 0x34 virtual false final false
  inline uint8_t EncryptByte(uint8_t data, int32_t blockOff);

  /// @brief Method EncryptBlock addr 0xeb1f3c size 0x600 virtual false final false
  ...
  /// @brief Method DecryptBlock addr 0xeb18f0 size 0x64c virtual false final false
