...
public:
  ...
  /// @brief Method Init, addr 0x33f2700, size 0x6b8, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t> H);

  /// @brief Method MultiplyH, addr 0x33f2db8, size 0x1e8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33f2fa0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Tables8kGcmMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Tables8kGcmMultiplier(Tables8kGcmMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Tables8kGcmMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Tables8kGcmMultiplier(Tables8kGcmMultiplierconst&) = delete;
