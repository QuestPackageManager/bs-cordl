...
public:
  ...
  /// @brief Method Init, addr 0x239aae0, size 0x6ec, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t, ::Array<uint8_t>*> H);

  /// @brief Method MultiplyH, addr 0x239b1cc, size 0x1e4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x239b3b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
