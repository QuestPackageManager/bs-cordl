...
public:
  ...
  /// @brief Method Init, addr 0x107f3ac, size 0x85c, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t, ::Array<uint8_t>*> H);

  /// @brief Method MultiplyH, addr 0x107fc08, size 0x1e4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x107fdec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
