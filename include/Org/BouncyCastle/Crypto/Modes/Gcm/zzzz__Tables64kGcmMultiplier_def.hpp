...
public:
  ...
  /// @brief Method Init, addr 0x32f6544, size 0x4f4, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t, ::Array<uint8_t>*> H);

  /// @brief Method MultiplyH, addr 0x32f6a38, size 0x154, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32f6b8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
