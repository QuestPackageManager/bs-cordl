...
public:
  ...
  /// @brief Method Init, addr 0x33f20b4, size 0x4f4, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t> H);

  /// @brief Method MultiplyH, addr 0x33f25a8, size 0x154, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33f26fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Tables64kGcmMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Tables64kGcmMultiplier(Tables64kGcmMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Tables64kGcmMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Tables64kGcmMultiplier(Tables64kGcmMultiplierconst&) = delete;
