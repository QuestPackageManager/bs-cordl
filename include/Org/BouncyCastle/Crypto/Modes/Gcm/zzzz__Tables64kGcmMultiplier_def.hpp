...
public:
  ...
  /// @brief Method Init, addr 0x239a46c, size 0x51c, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t, ::Array<uint8_t>*> H);

  /// @brief Method MultiplyH, addr 0x239a988, size 0x150, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x239aad8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
