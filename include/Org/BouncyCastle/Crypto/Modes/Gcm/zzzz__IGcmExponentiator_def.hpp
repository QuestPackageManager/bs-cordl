...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator*, "Org.BouncyCastle.Crypto.Modes.Gcm", "IGcmExponentiator");
// Dependencies
namespace Org::BouncyCastle::Crypto::Modes::Gcm {
// Is value type: false
