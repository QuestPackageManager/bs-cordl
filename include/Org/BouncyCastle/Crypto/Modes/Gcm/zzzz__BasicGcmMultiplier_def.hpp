...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmMultiplier*, "Org.BouncyCastle.Crypto.Modes.Gcm", "BasicGcmMultiplier");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_H, put = __cordl_internal_set_H)) ::ArrayW<uint32_t> H;
  ...
  /// @brief Method Init, addr 0x33f0890, size 0x6c, virtual true, abstract: false, final true
  inline void Init(::ArrayW<uint8_t> H);

  /// @brief Method MultiplyH, addr 0x33f08fc, size 0x84, virtual true, abstract: false, final true
  inline void MultiplyH(::ArrayW<uint8_t> x);

  static inline ::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmMultiplier* New_ctor();

  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_H() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_H();

  constexpr void __cordl_internal_set_H(::ArrayW<uint32_t> value);

  /// @brief Method .ctor, addr 0x33f0980, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BasicGcmMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BasicGcmMultiplier(BasicGcmMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BasicGcmMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BasicGcmMultiplier(BasicGcmMultiplierconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 952 };

  /// @brief Field H, offset: 0x10, size: 0x8, def value: None
  ::ArrayW<uint32_t> ___H;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmMultiplier) == 0x18, "Size mismatch!");
