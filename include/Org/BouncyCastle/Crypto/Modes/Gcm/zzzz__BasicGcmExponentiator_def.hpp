...
public:
  ...
  /// @brief Method ExponentiateX, addr 0x3331054, size 0x11c, virtual true, abstract: false, final true
  inline void ExponentiateX(int64_t pow, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Init, addr 0x3330f7c, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33312b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
