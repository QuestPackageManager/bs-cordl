...
public:
  ...
  /// @brief Method ExponentiateX, addr 0x33f0630, size 0x11c, virtual true, abstract: false, final true
  inline void ExponentiateX(int64_t pow, ::ArrayW<uint8_t> output);

  /// @brief Method Init, addr 0x33f0558, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33f088c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BasicGcmExponentiator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BasicGcmExponentiator(BasicGcmExponentiator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BasicGcmExponentiator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BasicGcmExponentiator(BasicGcmExponentiatorconst&) = delete;
