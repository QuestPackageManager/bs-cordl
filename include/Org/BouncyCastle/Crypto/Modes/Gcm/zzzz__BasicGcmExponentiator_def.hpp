...
public:
  ...
  /// @brief Method ExponentiateX, addr 0x23a08c4, size 0x110, virtual true, abstract: false, final true
  inline void ExponentiateX(int64_t pow, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Init, addr 0x23a07f4, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23a0b1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
