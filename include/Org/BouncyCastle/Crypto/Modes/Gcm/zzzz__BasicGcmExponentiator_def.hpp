...
/// @brief Method ExponentiateX, addr 0x32f4a10, size 0x11c, virtual true, abstract: false, final true
inline void ExponentiateX(int64_t  pow, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Init, addr 0x32f4938, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x32f4c6c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
