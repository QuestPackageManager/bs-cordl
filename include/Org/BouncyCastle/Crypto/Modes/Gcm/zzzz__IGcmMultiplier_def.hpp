...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier*, "Org.BouncyCastle.Crypto.Modes.Gcm", "IGcmMultiplier");
// Dependencies
namespace Org::BouncyCastle::Crypto::Modes::Gcm {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IGcmMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IGcmMultiplier(IGcmMultiplierconst&) = delete;
