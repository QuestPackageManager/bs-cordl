...
public:
  ...
  /// @brief Method EnsureAvailable, addr 0x107e9d0, size 0x268, virtual false, abstract: false, final false
  inline void EnsureAvailable(int32_t bit);

  /// @brief Method ExponentiateX, addr 0x107e820, size 0x1b0, virtual true, abstract: false, final true
  inline void ExponentiateX(int64_t pow, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Init, addr 0x107e614, size 0x20c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x107ec38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
