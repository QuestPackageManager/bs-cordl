...
/// @brief Method EnsureAvailable, addr 0x32f6214, size 0x27c, virtual false, abstract: false, final false
inline void EnsureAvailable(int32_t  bit) ;

/// @brief Method ExponentiateX, addr 0x32f6054, size 0x1c0, virtual true, abstract: false, final true
inline void ExponentiateX(int64_t  pow, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Init, addr 0x32f5e34, size 0x220, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x32f6490, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
