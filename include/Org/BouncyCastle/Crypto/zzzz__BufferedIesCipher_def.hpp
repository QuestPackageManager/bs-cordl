...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BufferedIesCipher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BufferedIesCipher(BufferedIesCipher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BufferedIesCipher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BufferedIesCipher(BufferedIesCipherconst&) = delete;
