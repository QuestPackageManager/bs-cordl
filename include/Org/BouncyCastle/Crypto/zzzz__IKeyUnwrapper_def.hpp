...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IKeyUnwrapper*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IKeyUnwrapper*, "Org.BouncyCastle.Crypto", "IKeyUnwrapper");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IKeyUnwrapper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IKeyUnwrapper(IKeyUnwrapperconst&) = delete;
