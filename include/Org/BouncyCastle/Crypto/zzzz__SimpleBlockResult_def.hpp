...
public:
  ...
  /// @brief Method Collect, addr 0x33e0188, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Collect();

  /// @brief Method Collect, addr 0x33e0190, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33e0168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> result);

  /// @brief Method get_Length, addr 0x33e0170, size 0x18, virtual false, abstract: false, final false
