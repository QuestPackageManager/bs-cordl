...
public:
  ...
  /// @brief Method Collect, addr 0x1036ea0, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Collect();

  /// @brief Method Collect, addr 0x1036ea8, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1036e5c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> result);

  /// @brief Method get_Length, addr 0x1036e84, size 0x1c, virtual false, abstract: false, final false
