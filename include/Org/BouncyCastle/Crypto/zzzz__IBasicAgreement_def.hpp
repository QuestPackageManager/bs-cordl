...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IBasicAgreement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IBasicAgreement*, "Org.BouncyCastle.Crypto", "IBasicAgreement");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IBasicAgreement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IBasicAgreement(IBasicAgreementconst&) = delete;
