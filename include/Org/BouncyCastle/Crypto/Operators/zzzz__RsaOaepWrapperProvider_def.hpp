...
public:
  ...
  /// @brief Method Org.BouncyCastle.Crypto.Operators.WrapperProvider.CreateWrapper, addr 0xfbacf0, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfba5d8, size 0x28, virtual false, abstract: false, final false
