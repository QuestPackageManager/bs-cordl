...
public:
  ...
  /// @brief Method Org.BouncyCastle.Crypto.Operators.WrapperProvider.CreateWrapper, addr 0x23b2664, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23b1f5c, size 0x28, virtual false, abstract: false, final false
