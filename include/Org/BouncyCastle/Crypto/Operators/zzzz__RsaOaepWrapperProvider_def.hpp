...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::RsaOaepWrapperProvider*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::RsaOaepWrapperProvider*, "Org.BouncyCastle.Crypto.Operators", "RsaOaepWrapperProvider");
...
public:
  ...
  /// @brief Method Org.BouncyCastle.Crypto.Operators.WrapperProvider.CreateWrapper, addr 0x3406cd0, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3406610, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RsaOaepWrapperProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RsaOaepWrapperProvider(RsaOaepWrapperProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RsaOaepWrapperProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RsaOaepWrapperProvider(RsaOaepWrapperProviderconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::RsaOaepWrapperProvider) == 0x18, "Size mismatch!");
