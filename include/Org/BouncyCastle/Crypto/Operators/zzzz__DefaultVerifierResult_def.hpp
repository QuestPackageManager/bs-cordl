...
public:
  ...
  /// @brief Method IsVerified, addr 0xf9de5c, size 0x88, virtual true, abstract: false, final true
  inline bool IsVerified(::ArrayW<uint8_t, ::Array<uint8_t>*> sig, int32_t sigOff, int32_t sigLen);

  /// @brief Method IsVerified, addr 0xf9ddb0, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf9dd88, size 0x28, virtual false, abstract: false, final false
