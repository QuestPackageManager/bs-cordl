...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::DefaultSignatureResult*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::DefaultSignatureResult*, "Org.BouncyCastle.Crypto.Operators", "DefaultSignatureResult");
...
public:
  ...
  /// @brief Method Collect, addr 0x340b2d8, size 0xa8, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> Collect();

  /// @brief Method Collect, addr 0x340b380, size 0x40, virtual true, abstract: false, final true
  inline int32_t Collect(::ArrayW<uint8_t> sig, int32_t sigOff);
  ...
  /// @brief Method .ctor, addr 0x340b2d0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultSignatureResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultSignatureResult(DefaultSignatureResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultSignatureResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultSignatureResult(DefaultSignatureResultconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::DefaultSignatureResult) == 0x18, "Size mismatch!");
