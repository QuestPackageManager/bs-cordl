...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::RsaOaepWrapper*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::RsaOaepWrapper*, "Org.BouncyCastle.Crypto.Operators", "RsaOaepWrapper");
...
public:
  ...
  /// @brief Method Unwrap, addr 0x3406ad8, size 0x100, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IBlockResult* Unwrap(::ArrayW<uint8_t> cipherText, int32_t offset, int32_t length);

  /// @brief Method Wrap, addr 0x3406bd8, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x340685c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x3406ad0, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RsaOaepWrapper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RsaOaepWrapper(RsaOaepWrapper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RsaOaepWrapper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RsaOaepWrapper(RsaOaepWrapperconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::RsaOaepWrapper) == 0x20, "Size mismatch!");
