...
public:
  ...
  /// @brief Method Unwrap, addr 0x33474fc, size 0x100, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IBlockResult* Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> cipherText, int32_t offset, int32_t length);

  /// @brief Method Wrap, addr 0x33475fc, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3347280, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x33474f4, size 0x8, virtual true, abstract: false, final true
