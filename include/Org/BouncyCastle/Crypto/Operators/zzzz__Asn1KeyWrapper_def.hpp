...
public:
  ...
  /// @brief Method Wrap, addr 0x23af6fc, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23af388, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method get_AlgorithmDetails, addr 0x23af65c, size 0xa0, virtual true, abstract: false, final true
