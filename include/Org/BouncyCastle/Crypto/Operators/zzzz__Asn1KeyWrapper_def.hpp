...
public:
  ...
  /// @brief Method Wrap, addr 0x118dbcc, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x118d850, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method get_AlgorithmDetails, addr 0x118db2c, size 0xa0, virtual true, abstract: false, final true
