...
public:
  ...
  /// @brief Method UnwrapperForName, addr 0xfba600, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method WrapperForName, addr 0xfb9ddc, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfba838, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
