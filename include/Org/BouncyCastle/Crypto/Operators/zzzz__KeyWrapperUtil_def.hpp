...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil*, "Org.BouncyCastle.Crypto.Operators", "KeyWrapperUtil");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyWrapperUtil", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyWrapperUtil(KeyWrapperUtil&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyWrapperUtil", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyWrapperUtil(KeyWrapperUtilconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil) == 0x10, "Size mismatch!");
