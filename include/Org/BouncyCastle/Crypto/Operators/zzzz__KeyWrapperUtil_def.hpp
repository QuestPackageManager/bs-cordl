...
public:
  ...
  /// @brief Method WrapperForName addr 0xeb368c size 0x238 virtual false final false
  ...
  /// @brief Method UnwrapperForName addr 0xeb3eb0 size 0x238 virtual false final false
  ...
  /// @brief Method .ctor addr 0xeb40e8 size 0x8 virtual false final false
  inline void _ctor();
