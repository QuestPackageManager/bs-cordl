...
public:
  ...
  /// @brief Method UnwrapperForName, addr 0x23b1fc4, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method WrapperForName, addr 0x23b17bc, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b21f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
