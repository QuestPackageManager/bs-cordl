...
public:
  ...
  /// @brief Method UnwrapperForName, addr 0x23ae514, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method WrapperForName, addr 0x23add0c, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ae744, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
