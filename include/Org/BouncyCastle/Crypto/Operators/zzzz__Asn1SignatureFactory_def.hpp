...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::Asn1SignatureFactory*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::Asn1SignatureFactory*, "Org.BouncyCastle.Crypto.Operators", "Asn1SignatureFactory");
...
public:
  ...
  /// @brief Method CreateCalculator, addr 0x340a1fc, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x340a0a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey);

  /// @brief Method .ctor, addr 0x340a0a8, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x340a1f4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AlgorithmDetails();

  /// @brief Method get_SignatureAlgNames, addr 0x340a314, size 0x50, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Asn1SignatureFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Asn1SignatureFactory(Asn1SignatureFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Asn1SignatureFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Asn1SignatureFactory(Asn1SignatureFactoryconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::Asn1SignatureFactory) == 0x30, "Size mismatch!");
