...
public:
  ...
  /// @brief Method CreateCalculator, addr 0x23b6164, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23b6008, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey);

  /// @brief Method .ctor, addr 0x23b6010, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x23b615c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AlgorithmDetails();

  /// @brief Method get_SignatureAlgNames, addr 0x23b6284, size 0x4c, virtual false, abstract: false, final false
