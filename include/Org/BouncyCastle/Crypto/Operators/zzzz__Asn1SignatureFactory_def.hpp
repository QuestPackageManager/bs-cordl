...
public:
  ...
  /// @brief Method .ctor addr 0xeb78a8 size 0x8 virtual false final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey);

  static inline ::Org::BouncyCastle::Crypto::Operators::Asn1SignatureFactory* New_ctor(::StringW algorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey,
                                                                                       ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method .ctor addr 0xeb78b0 size 0x158 virtual false final false
  ...
  /// @brief Method get_AlgorithmDetails addr 0xeb7a08 size 0x8 virtual true final true
  inline ::System::Object* get_AlgorithmDetails();

  /// @brief Method CreateCalculator addr 0xeb7a10 size 0xb4 virtual true final true
  inline ::Org::BouncyCastle::Crypto::IStreamCalculator* CreateCalculator();

  /// @brief Method get_SignatureAlgNames addr 0xeb7b40 size 0x4c virtual false final false
