...
public:
  ...
  /// @brief Method GetMaxOutputSize, addr 0x334661c, size 0xb8, virtual true, abstract: false, final true
  inline int32_t GetMaxOutputSize(int32_t inputLen);

  /// @brief Method GetUpdateOutputSize, addr 0x33466d4, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3346598, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBufferedCipher* bufferedCipher, ::System::IO::Stream* source);

  /// @brief Method get_Stream, addr 0x334678c, size 0x8, virtual true, abstract: false, final true
