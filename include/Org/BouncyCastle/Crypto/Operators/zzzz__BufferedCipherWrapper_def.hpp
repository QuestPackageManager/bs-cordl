...
public:
  ...
  /// @brief Method GetMaxOutputSize, addr 0x118d6f0, size 0xac, virtual true, abstract: false, final true
  inline int32_t GetMaxOutputSize(int32_t inputLen);

  /// @brief Method GetUpdateOutputSize, addr 0x118d79c, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x118d65c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBufferedCipher* bufferedCipher, ::System::IO::Stream* source);

  /// @brief Method get_Stream, addr 0x118d848, size 0x8, virtual true, abstract: false, final true
