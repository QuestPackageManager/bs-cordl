...
public:
  ...
  /// @brief Method GetMaxOutputSize, addr 0x11999e8, size 0xac, virtual true, abstract: false, final true
  inline int32_t GetMaxOutputSize(int32_t inputLen);

  /// @brief Method GetUpdateOutputSize, addr 0x1199a94, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1199954, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBufferedCipher* bufferedCipher, ::System::IO::Stream* source);

  /// @brief Method get_Stream, addr 0x1199b40, size 0x8, virtual true, abstract: false, final true
