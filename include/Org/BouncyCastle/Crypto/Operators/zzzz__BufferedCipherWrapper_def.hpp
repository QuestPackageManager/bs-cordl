...
public:
  ...
  /// @brief Method GetMaxOutputSize, addr 0x23af228, size 0xac, virtual true, abstract: false, final true
  inline int32_t GetMaxOutputSize(int32_t inputLen);

  /// @brief Method GetUpdateOutputSize, addr 0x23af2d4, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23af19c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBufferedCipher* bufferedCipher, ::System::IO::Stream* source);

  /// @brief Method get_Stream, addr 0x23af380, size 0x8, virtual true, abstract: false, final true
