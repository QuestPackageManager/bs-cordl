...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GenericKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GenericKey(GenericKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GenericKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GenericKey(GenericKeyconst&) = delete;
