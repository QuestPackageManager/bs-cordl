...
public:
  ...
  /// @brief Method .ctor, addr 0x23b6f40, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b6f6c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algorithmIdentifier, ::System::Object* representation);

  /// @brief Method .ctor, addr 0x23b6f18, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* representation);

  /// @brief Method get_AlgorithmIdentifier, addr 0x23b6f98, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgorithmIdentifier();

  /// @brief Method get_Representation, addr 0x23b6fa0, size 0x8, virtual false, abstract: false, final false
