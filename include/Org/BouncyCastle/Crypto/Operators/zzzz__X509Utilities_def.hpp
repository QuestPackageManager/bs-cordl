...
public:
  ...
  /// @brief Method CreatePssParams, addr 0x3406f34, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAlgNames, addr 0x3407c00, size 0x114, virtual false, abstract: false, final false
  static inline ::System::Collections::IEnumerable* GetAlgNames();

  /// @brief Method GetAlgorithmOid, addr 0x34076cc, size 0x21c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW algorithmName);

  /// @brief Method GetDigestAlgName, addr 0x3407038, size 0x3d4, virtual false, abstract: false, final false
  static inline ::StringW GetDigestAlgName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* digestAlgOID);

  /// @brief Method GetSigAlgID, addr 0x34078e8, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignatureName, addr 0x340740c, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3407d14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
