...
public:
  ...
  /// @brief Method GetDigestAlgName addr 0xeb6c50 size 0x370 virtual false final false
  static inline ::StringW GetDigestAlgName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* digestAlgOID);

  /// @brief Method GetSignatureName addr 0xeb6fc0 size 0x298 virtual false final false
  static inline ::StringW GetSignatureName(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* sigAlgId);

  /// @brief Method CreatePssParams addr 0xeb6b24 size 0x12c virtual false final false
  ...
  /// @brief Method GetAlgorithmOid addr 0xeb7258 size 0x20c virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW algorithmName);

  /// @brief Method GetSigAlgID addr 0xeb7464 size 0x330 virtual false final false
  ...
  /// @brief Method GetAlgNames addr 0xeb7794 size 0x10c virtual false final false
  ...
  /// @brief Method .ctor addr 0xeb78a0 size 0x8 virtual false final false
  inline void _ctor();
