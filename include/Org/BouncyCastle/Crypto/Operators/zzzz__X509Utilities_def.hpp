...
public:
  ...
  /// @brief Method CreatePssParams, addr 0xfbd274, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAlgNames, addr 0xfbdee4, size 0x10c, virtual false, abstract: false, final false
  static inline ::System::Collections::IEnumerable* GetAlgNames();

  /// @brief Method GetAlgorithmOid, addr 0xfbd9a8, size 0x20c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW algorithmName);

  /// @brief Method GetDigestAlgName, addr 0xfbd3a0, size 0x370, virtual false, abstract: false, final false
  static inline ::StringW GetDigestAlgName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* digestAlgOID);

  /// @brief Method GetSigAlgID, addr 0xfbdbb4, size 0x330, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignatureName, addr 0xfbd710, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfbdff0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
