...
public:
  ...
  /// @brief Method GetResult, addr 0x340b25c, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x340a2a8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ISigner* signer);

  /// @brief Method get_Stream, addr 0x340b254, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultSignatureCalculator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultSignatureCalculator(DefaultSignatureCalculator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultSignatureCalculator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultSignatureCalculator(DefaultSignatureCalculatorconst&) = delete;
