...
public:
  ...
  /// @brief Method CreateVerifierFactory, addr 0xf9cee8, size 0xc4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf9cec0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method get_SignatureAlgNames, addr 0xf9cfac, size 0x4c, virtual false, abstract: false, final false
