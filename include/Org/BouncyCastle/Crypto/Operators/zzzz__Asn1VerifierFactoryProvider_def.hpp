...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::Asn1VerifierFactoryProvider*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::Asn1VerifierFactoryProvider*, "Org.BouncyCastle.Crypto.Operators", "Asn1VerifierFactoryProvider");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Asn1VerifierFactoryProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Asn1VerifierFactoryProvider(Asn1VerifierFactoryProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Asn1VerifierFactoryProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Asn1VerifierFactoryProvider(Asn1VerifierFactoryProviderconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::Asn1VerifierFactoryProvider) == 0x18, "Size mismatch!");
