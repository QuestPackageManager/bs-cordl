...
public:
  ...
  /// @brief Method .ctor addr 0xf2d060 size 0x28 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method CreateVerifierFactory addr 0xf2d088 size 0xc4 virtual true final true
  inline ::Org::BouncyCastle::Crypto::IVerifierFactory* CreateVerifierFactory(::System::Object* algorithmDetails);

  /// @brief Method get_SignatureAlgNames addr 0xf2d14c size 0x4c virtual false final false
