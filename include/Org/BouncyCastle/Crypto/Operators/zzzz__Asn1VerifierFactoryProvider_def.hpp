...
public:
  ...
  /// @brief Method CreateVerifierFactory, addr 0x23ba2fc, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23ba2d4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method get_SignatureAlgNames, addr 0x23ba3b8, size 0x4c, virtual false, abstract: false, final false
