...
public:
  ...
  /// @brief Method CreateVerifierFactory, addr 0x1192104, size 0xc4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x11920dc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method get_SignatureAlgNames, addr 0x11921c8, size 0x4c, virtual false, abstract: false, final false
