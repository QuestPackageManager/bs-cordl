...
public:
  ...
  /// @brief Method BuildCipher, addr 0x23b5764, size 0x188, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::ICipher* BuildCipher(::System::IO::Stream* stream);

  /// @brief Method GetMaxOutputSize, addr 0x23b572c, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23b550c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x23b5724, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AlgorithmDetails();

  /// @brief Method get_Key, addr 0x23b5970, size 0x8, virtual true, abstract: false, final true
