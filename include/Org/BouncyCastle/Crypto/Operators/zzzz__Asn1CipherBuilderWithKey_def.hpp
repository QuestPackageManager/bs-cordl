...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::Asn1CipherBuilderWithKey*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::Asn1CipherBuilderWithKey*, "Org.BouncyCastle.Crypto.Operators", "Asn1CipherBuilderWithKey");
...
public:
  ...
  /// @brief Method BuildCipher, addr 0x34059d4, size 0x1a0, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::ICipher* BuildCipher(::System::IO::Stream* stream);

  /// @brief Method GetMaxOutputSize, addr 0x340599c, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3405794, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmDetails, addr 0x3405994, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AlgorithmDetails();

  /// @brief Method get_Key, addr 0x3405bf0, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Asn1CipherBuilderWithKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Asn1CipherBuilderWithKey(Asn1CipherBuilderWithKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Asn1CipherBuilderWithKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Asn1CipherBuilderWithKey(Asn1CipherBuilderWithKeyconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::Asn1CipherBuilderWithKey) == 0x20, "Size mismatch!");
