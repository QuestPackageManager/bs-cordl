...
public:
  ...
  /// @brief Method CreateCalculator, addr 0x330e940, size 0xe4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x330e930, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x330e7f4, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method get_AlgorithmDetails, addr 0x330e938, size 0x8, virtual true, abstract: false, final true
