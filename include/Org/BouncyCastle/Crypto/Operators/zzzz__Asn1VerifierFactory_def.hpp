...
public:
  ...
  /// @brief Method CreateCalculator, addr 0x118b708, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x118b6d4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x118b584, size 0x150, virtual false, abstract: false, final false
  inline void _ctor(::StringW algorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method get_AlgorithmDetails, addr 0x118b700, size 0x8, virtual true, abstract: false, final true
