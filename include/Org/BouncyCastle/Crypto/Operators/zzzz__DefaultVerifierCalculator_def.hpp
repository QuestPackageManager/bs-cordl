...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Operators::DefaultVerifierCalculator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Operators::DefaultVerifierCalculator*, "Org.BouncyCastle.Crypto.Operators", "DefaultVerifierCalculator");
...
public:
  ...
  /// @brief Method GetResult, addr 0x340b3c8, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x340a594, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ISigner* signer);

  /// @brief Method get_Stream, addr 0x340b3c0, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultVerifierCalculator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultVerifierCalculator(DefaultVerifierCalculator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultVerifierCalculator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultVerifierCalculator(DefaultVerifierCalculatorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Operators::DefaultVerifierCalculator) == 0x18, "Size mismatch!");
