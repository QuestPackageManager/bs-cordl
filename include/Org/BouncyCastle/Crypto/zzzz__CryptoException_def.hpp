...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::CryptoException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::CryptoException*, "Org.BouncyCastle.Crypto", "CryptoException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x349cc00, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x349cc58, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x349ccc4, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::CryptoException) == 0x90, "Size mismatch!");
