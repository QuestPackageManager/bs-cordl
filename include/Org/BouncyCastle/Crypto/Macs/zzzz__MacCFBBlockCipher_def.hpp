...
public:
  ...
  /// @brief Method .ctor, addr 0xf35c74, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t bitBlockSize);

  /// @brief Method Init, addr 0xf35e54, size 0x13c, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName, addr 0xf3604c, size 0x104, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0xf36150, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize, addr 0xf36158, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method ProcessBlock, addr 0xf36160, size 0x258, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0xf35f90, size 0xbc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method GetMacBlock, addr 0xf363b8, size 0xbc, virtual false, abstract: false, final false
