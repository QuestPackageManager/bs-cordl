...
public:
  ...
  /// @brief Method GetBlockSize, addr 0x2394760, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method GetMacBlock, addr 0x23949b8, size 0xbc, virtual false, abstract: false, final false
  inline void GetMacBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> mac);

  /// @brief Method Init, addr 0x239445c, size 0x13c, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x2394768, size 0x250, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x2394598, size 0xbc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x239427c, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t bitBlockSize);

  /// @brief Method get_AlgorithmName, addr 0x2394654, size 0x104, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0x2394758, size 0x8, virtual true, abstract: false, final true
