...
/// @brief Method GetBlockSize, addr 0x32ecbcc, size 0x8, virtual true, abstract: false, final true
inline int32_t GetBlockSize() ;

/// @brief Method GetMacBlock, addr 0x32ece28, size 0xc8, virtual false, abstract: false, final false
inline void GetMacBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  mac) ;

/// @brief Method Init, addr 0x32ec8c0, size 0x14c, virtual true, abstract: false, final true
...
/// @brief Method ProcessBlock, addr 0x32ecbd4, size 0x254, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x32eca0c, size 0xc0, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x32ec6e4, size 0x1dc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher, int32_t  bitBlockSize) ;

/// @brief Method get_AlgorithmName, addr 0x32ecacc, size 0xf8, virtual true, abstract: false, final true
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x32ecbc4, size 0x8, virtual true, abstract: false, final true
