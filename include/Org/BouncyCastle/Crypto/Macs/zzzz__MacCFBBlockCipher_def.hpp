...
public:
  ...
  /// @brief Method .ctor, addr 0xf09de4, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t bitBlockSize);

  /// @brief Method Init, addr 0xf09fc4, size 0x13c, virtual true, abstract: false, final true
  inline void Init(bool forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName, addr 0xf0a1bc, size 0x104, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method get_IsPartialBlockOkay, addr 0xf0a2c0, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsPartialBlockOkay();

  /// @brief Method GetBlockSize, addr 0xf0a2c8, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetBlockSize();

  /// @brief Method ProcessBlock, addr 0xf0a2d0, size 0x258, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0xf0a100, size 0xbc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method GetMacBlock, addr 0xf0a528, size 0xbc, virtual false, abstract: false, final false
