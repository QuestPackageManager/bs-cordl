...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x116aff0, size 0x294, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> inBytes, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x116b284, size 0x220, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> outBytes, int32_t outOff);

  /// @brief Method DoubleLu, addr 0x116ab38, size 0xb8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DoubleLu(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method GetMacSize, addr 0x116aed0, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x116abf0, size 0x220, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x116ae10, size 0xc0, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method ShiftLeft, addr 0x116aab4, size 0x84, virtual false, abstract: false, final false
  static inline int32_t ShiftLeft(::ArrayW<uint8_t, ::Array<uint8_t>*> block, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Update, addr 0x116aed8, size 0x118, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x116a50c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x116a5c0, size 0x454, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t macSizeInBits);

  /// @brief Method get_AlgorithmName, addr 0x116aa14, size 0xa0, virtual true, abstract: false, final true
