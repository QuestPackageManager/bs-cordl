...
/// @brief Method BlockUpdate, addr 0x32ee0bc, size 0x298, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x32ee354, size 0x214, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method DoubleLu, addr 0x32edbf4, size 0xb8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DoubleLu(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method GetMacSize, addr 0x32edf98, size 0x8, virtual true, abstract: false, final true
inline int32_t GetMacSize() ;

/// @brief Method Init, addr 0x32edcac, size 0x228, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x32eded4, size 0xc4, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method ShiftLeft, addr 0x32edb7c, size 0x78, virtual false, abstract: false, final false
static inline int32_t ShiftLeft(::ArrayW<uint8_t,::Array<uint8_t>*>  block, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Update, addr 0x32edfa0, size 0x11c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x32ed5e8, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher) ;

/// @brief Method .ctor, addr 0x32ed6a8, size 0x430, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher, int32_t  macSizeInBits) ;

/// @brief Method get_AlgorithmName, addr 0x32edad8, size 0xa4, virtual true, abstract: false, final true
