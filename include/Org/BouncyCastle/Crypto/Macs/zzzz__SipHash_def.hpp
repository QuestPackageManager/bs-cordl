...
public:
  ...
  /// @brief Method .ctor addr 0xe9b600 size 0x28 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Crypto::Macs::SipHash* New_ctor(int32_t c, int32_t d);

  /// @brief Method .ctor addr 0xe9b628 size 0x30 virtual false final false
  inline void _ctor(int32_t c, int32_t d);

  /// @brief Method get_AlgorithmName addr 0xe9b658 size 0x194 virtual true final false
  inline ::StringW get_AlgorithmName();

  /// @brief Method GetMacSize addr 0xe9b7ec size 0x8 virtual true final false
  inline int32_t GetMacSize();

  /// @brief Method Init addr 0xe9b7f4 size 0x154 virtual true final false
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method Update addr 0xe9b948 size 0x44 virtual true final false
  inline void Update(uint8_t input);

  /// @brief Method BlockUpdate addr 0xe9b98c size 0x1ac virtual true final false
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t offset, int32_t length);

  /// @brief Method DoFinal addr 0xe9bb38 size 0x9c virtual true final false
  inline int64_t DoFinal();

  /// @brief Method DoFinal addr 0xe9bbd4 size 0x44 virtual true final false
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset addr 0xe9bc18 size 0x64 virtual true final false
  inline void Reset();

  /// @brief Method ProcessMessageWord addr 0xe9bc7c size 0x4c virtual true final false
  inline void ProcessMessageWord();

  /// @brief Method ApplySipRounds addr 0xe9bcc8 size 0x4c virtual true final false
  inline void ApplySipRounds(int32_t n);

  /// @brief Method RotateLeft addr 0xe9bd14 size 0xc virtual false final false
