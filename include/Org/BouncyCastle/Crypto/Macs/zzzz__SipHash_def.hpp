...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SipHash", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SipHash(SipHash&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SipHash", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SipHash(SipHashconst&) = delete;
