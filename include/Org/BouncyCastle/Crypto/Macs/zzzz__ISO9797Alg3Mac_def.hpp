...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Macs::ISO9797Alg3Mac*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Macs::ISO9797Alg3Mac*, "Org.BouncyCastle.Crypto.Macs", "ISO9797Alg3Mac");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x33eb6b4, size 0x298, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x33eb94c, size 0x354, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x33eb590, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33eb0fc, size 0x3d0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x33eb4cc, size 0xc4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x33eb598, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33eacd8, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x33eb0b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t macSizeInBits);

  /// @brief Method .ctor, addr 0x33ead9c, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33eafe8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x33eb0b8, size 0x44, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Macs::ISO9797Alg3Mac) == 0x50, "Size mismatch!");
