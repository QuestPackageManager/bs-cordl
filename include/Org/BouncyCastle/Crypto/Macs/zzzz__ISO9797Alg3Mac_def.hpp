...
public:
  ...
  /// @brief Method BlockUpdate, addr 0xfa1aa0, size 0x294, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0xfa1d34, size 0x354, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0xfa1980, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0xfa14e0, size 0x3e0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0xfa18c0, size 0xc0, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0xfa1988, size 0x118, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfa10b8, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method .ctor, addr 0xfa1498, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t macSizeInBits);

  /// @brief Method .ctor, addr 0xfa1170, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa13d4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0xfa14a0, size 0x40, virtual true, abstract: false, final true
