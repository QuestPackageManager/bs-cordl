...
public:
  ...
  /// @brief Method .ctor, addr 0xf38e60, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method GenerateWorkingKey, addr 0xf38f18, size 0xfc, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GenerateWorkingKey(::ArrayW<uint8_t, ::Array<uint8_t>*> userKey);

  /// @brief Method Init, addr 0xf39088, size 0x278, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method get_AlgorithmName, addr 0xf39338, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method GetMacSize, addr 0xf39378, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method gost28147_mainStep, addr 0xf39380, size 0xe8, virtual false, abstract: false, final false
  inline int32_t gost28147_mainStep(int32_t n1, int32_t key);

  /// @brief Method gost28147MacFunc, addr 0xf39468, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method bytesToint, addr 0xf39014, size 0x74, virtual false, abstract: false, final false
  static inline int32_t bytesToint(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method intTobytes, addr 0xf3954c, size 0x80, virtual false, abstract: false, final false
  static inline void intTobytes(int32_t num, ::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method CM5func, addr 0xf395cc, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0xf396b0, size 0x110, virtual true, abstract: false, final true
  inline void Update(uint8_t input);

  /// @brief Method BlockUpdate, addr 0xf397c0, size 0x200, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0xf399c0, size 0x148, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0xf39300, size 0x38, virtual true, abstract: false, final true
  inline void Reset();
