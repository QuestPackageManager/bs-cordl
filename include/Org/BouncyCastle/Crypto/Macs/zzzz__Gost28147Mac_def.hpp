...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x332c830, size 0x1f8, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method CM5func, addr 0x332c62c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method DoFinal, addr 0x332ca28, size 0x14c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GenerateWorkingKey, addr 0x332bf68, size 0xfc, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GenerateWorkingKey(::ArrayW<uint8_t, ::Array<uint8_t>*> userKey);

  /// @brief Method GetMacSize, addr 0x332c3d8, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x332c0d8, size 0x284, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Macs::Gost28147Mac* New_ctor();

  /// @brief Method Reset, addr 0x332c35c, size 0x38, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x332c714, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x332beb8, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method bytesToint, addr 0x332c064, size 0x74, virtual false, abstract: false, final false
  static inline int32_t bytesToint(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff);

  /// @brief Method get_AlgorithmName, addr 0x332c394, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method gost28147MacFunc, addr 0x332c4c8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method gost28147_mainStep, addr 0x332c3e0, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method intTobytes, addr 0x332c5ac, size 0x80, virtual false, abstract: false, final false
