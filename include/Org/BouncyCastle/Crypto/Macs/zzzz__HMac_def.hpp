...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x33ea634, size 0xd0, virtual true, abstract: false, final false
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x33ea704, size 0x4b0, virtual true, abstract: false, final false
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x33ea574, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetMacSize();

  /// @brief Method GetUnderlyingDigest, addr 0x33e9ff0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IDigest* GetUnderlyingDigest();

  /// @brief Method Init, addr 0x33e9ff8, size 0x534, virtual true, abstract: false, final false
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Macs::HMac* New_ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method Reset, addr 0x33eabb4, size 0x124, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x33ea57c, size 0xb8, virtual true, abstract: false, final false
  inline void Update(uint8_t input);

  /// @brief Method XorPad, addr 0x33ea52c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33e9dc8, size 0x160, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method get_AlgorithmName, addr 0x33e9f28, size 0xc8, virtual true, abstract: false, final false
