...
public:
  ...
  /// @brief Method BlockUpdate, addr 0xf9f3f4, size 0x24, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0xf9f418, size 0xf8, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0xf9f3b8, size 0x18, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0xf9f168, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0xf9f510, size 0x24, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0xf9f3d0, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf9f108, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher* cipher);

  /// @brief Method .ctor, addr 0xf9f138, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher* cipher, int32_t macSizeBits);

  /// @brief Method get_AlgorithmName, addr 0xf9f2f0, size 0xc8, virtual true, abstract: false, final true
