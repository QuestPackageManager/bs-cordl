...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Macs::GMac*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Macs::GMac*, "Org.BouncyCastle.Crypto.Macs", "GMac");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x33eb360, size 0x20, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x33eb380, size 0xf4, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x33eb328, size 0x18, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33eb0d8, size 0x180, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x33eb474, size 0x20, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x33eb340, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33eb0bc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x33eb0cc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher* cipher, int32_t macSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x33eb258, size 0xd0, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GMac", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GMac(GMac&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GMac", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GMac(GMacconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Macs::GMac) == 0x20, "Size mismatch!");
