...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x32ef7f0, size 0x20, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x32ef810, size 0xf4, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x32ef7b8, size 0x18, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x32ef568, size 0x180, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x32ef904, size 0x20, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x32ef7d0, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32ef54c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x32ef55c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher* cipher, int32_t macSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x32ef6e8, size 0xd0, virtual true, abstract: false, final true
