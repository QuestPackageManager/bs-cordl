...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x32eea20, size 0x114, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x32eeb6c, size 0x128, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x32eea18, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x32ee6dc, size 0x188, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Macs::Dstu7564Mac* New_ctor(int32_t macSizeBits);

  /// @brief Method Pad, addr 0x32eec94, size 0x130, virtual false, abstract: false, final false
  inline void Pad();

  /// @brief Method PadKey, addr 0x32ee864, size 0x1b4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PadKey(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method Reset, addr 0x32eedc4, size 0x5c, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x32eeb34, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32ee65c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(int32_t macSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x32ee618, size 0x44, virtual true, abstract: false, final true
