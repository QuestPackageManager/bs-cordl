...
public:
  ...
  /// @brief Method .ctor, addr 0xf0a5e4, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0a85c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0a938, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0a6b4, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0xf0a940, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xf0a958, size 0x34, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method GetMacSize, addr 0xf0a9c4, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Update, addr 0xf0a9cc, size 0x8c, virtual true, abstract: false, final true
  inline void Update(uint8_t input);

  /// @brief Method BlockUpdate, addr 0xf0aa58, size 0x144, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0xf0ab9c, size 0x164, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method Reset, addr 0xf0a98c, size 0x38, virtual true, abstract: false, final true
  inline void Reset();
