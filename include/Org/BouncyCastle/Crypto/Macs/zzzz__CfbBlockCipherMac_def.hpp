...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac*, "Org.BouncyCastle.Crypto.Macs", "CfbBlockCipherMac");
...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x33e8f5c, size 0x144, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x33e90a0, size 0x168, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x33e8ec8, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33e8e5c, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x33e8e90, size 0x38, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x33e8ed0, size 0x8c, virtual true, abstract: false, final true
  ...
  constexpr ::Org::BouncyCastle::Crypto::Macs::MacCFBBlockCipher* const& __cordl_internal_get_cipher() const;
  ...
  /// @brief Method .ctor, addr 0x33e8b10, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method .ctor, addr 0x33e8e40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher, int32_t cfbBitSize, int32_t macSizeInBits);

  /// @brief Method .ctor, addr 0x33e8bd8, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33e8d74, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AlgorithmName, addr 0x33e8e48, size 0x14, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CfbBlockCipherMac", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CfbBlockCipherMac(CfbBlockCipherMac&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CfbBlockCipherMac", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CfbBlockCipherMac(CfbBlockCipherMacconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac) == 0x40, "Size mismatch!");
