...
public:
  ...
  /// @brief Method BlockUpdate, addr 0xfa2858, size 0xe8, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0xfa2b64, size 0x1e0, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0xfa281c, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0xfa2248, size 0x19c, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0xfa2940, size 0x21c, virtual false, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method Reset, addr 0xfa2728, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method SetKey, addr 0xfa23e4, size 0x344, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key, ::ArrayW<uint8_t, ::Array<uint8_t>*> nonce);

  /// @brief Method Update, addr 0xfa2824, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfa2088, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xfa20fc, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0xfa2734, size 0xe8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IMac"
  constexpr ::Org::BouncyCastle::Crypto::IMac* i___Org__BouncyCastle__Crypto__IMac() noexcept;

  /// @brief Method mul32x32_64, addr 0xfa2b5c, size 0x8, virtual false, abstract: false, final false
