...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Macs::Poly1305*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Macs::Poly1305*, "Org.BouncyCastle.Crypto.Macs", "Poly1305");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_currentBlock, put = __cordl_internal_set_currentBlock)) ::ArrayW<uint8_t> currentBlock;
  ...
  __declspec(property(get = __cordl_internal_get_singleByte, put = __cordl_internal_set_singleByte)) ::ArrayW<uint8_t> singleByte;

  /// @brief Convert operator to "::Org::BouncyCastle::Crypto::IMac"
  constexpr operator ::Org::BouncyCastle::Crypto::IMac*() noexcept;

  /// @brief Method BlockUpdate, addr 0x33ec470, size 0xec, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x33ec764, size 0x214, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x33ec434, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33ebe58, size 0x1a4, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x33ec55c, size 0x200, virtual false, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method Reset, addr 0x33ec334, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method SetKey, addr 0x33ebffc, size 0x338, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> nonce);

  /// @brief Method Update, addr 0x33ec43c, size 0x34, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_currentBlock() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_currentBlock();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_singleByte() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_singleByte();

  constexpr void __cordl_internal_set_cipher(::Org::BouncyCastle::Crypto::IBlockCipher* value);

  constexpr void __cordl_internal_set_currentBlock(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x33ebca0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33ebd10, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x33ec340, size 0xf4, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IMac"
  constexpr ::Org::BouncyCastle::Crypto::IMac* i___Org__BouncyCastle__Crypto__IMac() noexcept;

  /// @brief Method mul32x32_64, addr 0x33ec75c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___currentBlock;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Macs::Poly1305) == 0x78, "Size mismatch!");
