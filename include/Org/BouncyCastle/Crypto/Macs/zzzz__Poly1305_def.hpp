...
/// @brief Method BlockUpdate, addr 0x332ffb8, size 0xec, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x33302ac, size 0x214, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetMacSize, addr 0x332ff7c, size 0x8, virtual true, abstract: false, final true
inline int32_t GetMacSize() ;

/// @brief Method Init, addr 0x332f9a0, size 0x1a4, virtual true, abstract: false, final true
...
/// @brief Method ProcessBlock, addr 0x33300a4, size 0x200, virtual false, abstract: false, final false
inline void ProcessBlock() ;

/// @brief Method Reset, addr 0x332fe7c, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method SetKey, addr 0x332fb44, size 0x338, virtual false, abstract: false, final false
inline void SetKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key, ::ArrayW<uint8_t,::Array<uint8_t>*>  nonce) ;

/// @brief Method Update, addr 0x332ff84, size 0x34, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x332f7e8, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x332f858, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher) ;

/// @brief Method get_AlgorithmName, addr 0x332fe88, size 0xf4, virtual true, abstract: false, final true
inline ::StringW get_AlgorithmName() ;

/// @brief Convert to "::Org::BouncyCastle::Crypto::IMac"
constexpr ::Org::BouncyCastle::Crypto::IMac* i___Org__BouncyCastle__Crypto__IMac() noexcept;

/// @brief Method mul32x32_64, addr 0x33302a4, size 0x8, virtual false, abstract: false, final false
