...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x2399370, size 0xe8, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x2399658, size 0x1e0, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x2399334, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x2398d74, size 0x194, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessBlock, addr 0x2399458, size 0x1f8, virtual false, abstract: false, final false
  inline void ProcessBlock();

  /// @brief Method Reset, addr 0x2399240, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method SetKey, addr 0x2398f08, size 0x338, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key, ::ArrayW<uint8_t, ::Array<uint8_t>*> nonce);

  /// @brief Method Update, addr 0x239933c, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2398bb8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2398c2c, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x239924c, size 0xe8, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IMac"
  constexpr ::Org::BouncyCastle::Crypto::IMac* i___Org__BouncyCastle__Crypto__IMac() noexcept;

  /// @brief Method mul32x32_64, addr 0x2399650, size 0x8, virtual false, abstract: false, final false
