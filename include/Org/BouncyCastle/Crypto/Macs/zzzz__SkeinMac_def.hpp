...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x11774b4, size 0x1c, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x11774d0, size 0x1c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x1177460, size 0x1c, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x1177230, size 0x230, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x117747c, size 0x1c, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x1177498, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1177000, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Macs::SkeinMac* mac);

  /// @brief Method .ctor, addr 0x1176f7c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(int32_t stateSizeBits, int32_t digestSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x117707c, size 0x1b4, virtual true, abstract: false, final true
