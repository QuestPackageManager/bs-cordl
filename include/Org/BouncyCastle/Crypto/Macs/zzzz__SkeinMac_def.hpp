...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x239be6c, size 0x1c, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x239be88, size 0x1c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x239be18, size 0x1c, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x239bbf4, size 0x224, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x239be34, size 0x1c, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x239be50, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x239b9c8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Macs::SkeinMac* mac);

  /// @brief Method .ctor, addr 0x239b94c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(int32_t stateSizeBits, int32_t digestSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x239ba40, size 0x1b4, virtual true, abstract: false, final true
