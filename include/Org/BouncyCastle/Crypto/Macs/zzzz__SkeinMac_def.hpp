...
public:
  ...
  /// @brief Method BlockUpdate, addr 0x3330354, size 0x18, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x333036c, size 0x18, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t, ::Array<uint8_t>*> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x333030c, size 0x18, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33300e0, size 0x22c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x3330324, size 0x18, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x333033c, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x332feb8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Macs::SkeinMac* mac);

  /// @brief Method .ctor, addr 0x332fe44, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(int32_t stateSizeBits, int32_t digestSizeBits);

  /// @brief Method get_AlgorithmName, addr 0x332ff30, size 0x1b0, virtual true, abstract: false, final true
