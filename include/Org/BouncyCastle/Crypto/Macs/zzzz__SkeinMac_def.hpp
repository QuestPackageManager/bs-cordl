...
public:
  ...
  /// @brief Method .ctor addr 0xe9bd20 size 0x84 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe9bda4 size 0x7c virtual false final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Macs::SkeinMac* mac);

  /// @brief Method get_AlgorithmName addr 0xe9be20 size 0x1b4 virtual true final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init addr 0xe9bfd4 size 0x230 virtual true final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method GetMacSize addr 0xe9c204 size 0x1c virtual true final true
  inline int32_t GetMacSize();

  /// @brief Method Reset addr 0xe9c220 size 0x1c virtual true final true
  inline void Reset();

  /// @brief Method Update addr 0xe9c23c size 0x1c virtual true final true
  inline void Update(uint8_t inByte);

  /// @brief Method BlockUpdate addr 0xe9c258 size 0x1c virtual true final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal addr 0xe9c274 size 0x1c virtual true final true
