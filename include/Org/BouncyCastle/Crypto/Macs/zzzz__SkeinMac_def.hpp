...
public:
  ...
  /// @brief Method .ctor, addr 0xf3cd90, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf3ce14, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Macs::SkeinMac* mac);

  /// @brief Method get_AlgorithmName, addr 0xf3ce90, size 0x1b4, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Method Init, addr 0xf3d044, size 0x230, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method GetMacSize, addr 0xf3d274, size 0x1c, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Reset, addr 0xf3d290, size 0x1c, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0xf3d2ac, size 0x1c, virtual true, abstract: false, final true
  inline void Update(uint8_t inByte);

  /// @brief Method BlockUpdate, addr 0xf3d2c8, size 0x1c, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0xf3d2e4, size 0x1c, virtual true, abstract: false, final true
