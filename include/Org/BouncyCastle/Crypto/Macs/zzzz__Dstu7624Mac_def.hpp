...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Macs::Dstu7624Mac*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Macs::Dstu7624Mac*, "Org.BouncyCastle.Crypto.Macs", "Dstu7624Mac");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_c, put = __cordl_internal_set_c)) ::ArrayW<uint8_t> c;

  /// @brief Field cTemp, offset 0x30, size 0x8
  __declspec(property(get = __cordl_internal_get_cTemp, put = __cordl_internal_set_cTemp)) ::ArrayW<uint8_t> cTemp;
  ...
  __declspec(property(get = __cordl_internal_get_kDelta, put = __cordl_internal_set_kDelta)) ::ArrayW<uint8_t> kDelta;
  ...
  /// @brief Method BlockUpdate, addr 0x33eacd0, size 0x140, virtual true, abstract: false, final true
  inline void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len);

  /// @brief Method DoFinal, addr 0x33eaeb4, size 0x12c, virtual true, abstract: false, final true
  inline int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff);

  /// @brief Method GetMacSize, addr 0x33eac00, size 0x8, virtual true, abstract: false, final true
  inline int32_t GetMacSize();

  /// @brief Method Init, addr 0x33eaa88, size 0x134, virtual true, abstract: false, final true
  inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  static inline ::Org::BouncyCastle::Crypto::Macs::Dstu7624Mac* New_ctor(int32_t blockSizeBits, int32_t q);

  /// @brief Method Reset, addr 0x33eafe0, size 0xdc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Update, addr 0x33eac08, size 0x80, virtual true, abstract: false, final true
  inline void Update(uint8_t input);

  /// @brief Method Xor, addr 0x33eae10, size 0xa4, virtual false, abstract: false, final false
  inline void Xor(::ArrayW<uint8_t> c, int32_t cOff, ::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> xorResult);
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_c() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_c();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_cTemp() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_cTemp();
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_kDelta() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_kDelta();
  ...
  constexpr void __cordl_internal_set_c(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_cTemp(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_engine(::Org::BouncyCastle::Crypto::Engines::Dstu7624Engine* value);

  constexpr void __cordl_internal_set_kDelta(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_macSize(int32_t value);

  /// @brief Method .ctor, addr 0x33ea990, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(int32_t blockSizeBits, int32_t q);

  /// @brief Method get_AlgorithmName, addr 0x33eabbc, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_AlgorithmName();

  /// @brief Convert to "::Org::BouncyCastle::Crypto::IMac"
  constexpr ::Org::BouncyCastle::Crypto::IMac* i___Org__BouncyCastle__Crypto__IMac() noexcept;

  /// @brief Method processBlock, addr 0x33eac88, size 0x48, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Dstu7624Mac", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Dstu7624Mac(Dstu7624Mac&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Dstu7624Mac", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Dstu7624Mac(Dstu7624Macconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Macs::Dstu7624Mac) == 0x50, "Size mismatch!");
