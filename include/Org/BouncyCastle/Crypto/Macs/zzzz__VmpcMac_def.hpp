...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VmpcMac", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VmpcMac(VmpcMac&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VmpcMac", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VmpcMac(VmpcMacconst&) = delete;
