...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::IMacDerivationFunction*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::IMacDerivationFunction*, "Org.BouncyCastle.Crypto", "IMacDerivationFunction");
// Dependencies
namespace Org::BouncyCastle::Crypto {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IMacDerivationFunction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IMacDerivationFunction(IMacDerivationFunctionconst&) = delete;
