...
public:
  ...
  /// @brief Method .ctor addr 0xec1730 size 0x160 virtual false final false
  ...
  /// @brief Method .ctor addr 0xec1890 size 0x10 virtual false final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> ikm, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt, ::ArrayW<uint8_t, ::Array<uint8_t>*> info);

  /// @brief Method SkipExtractParameters addr 0xec18a0 size 0x78 virtual false final false
  ...
  /// @brief Method DefaultParameters addr 0xec1918 size 0x6c virtual false final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::HkdfParameters* DefaultParameters(::ArrayW<uint8_t, ::Array<uint8_t>*> ikm);

  /// @brief Method GetIkm addr 0xec1984 size 0x5c virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIkm();

  /// @brief Method get_SkipExtract addr 0xec19e0 size 0x8 virtual true final false
  inline bool get_SkipExtract();

  /// @brief Method GetSalt addr 0xec19e8 size 0x5c virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSalt();

  /// @brief Method GetInfo addr 0xec1a44 size 0x5c virtual true final false
