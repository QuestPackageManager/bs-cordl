...
public:
  ...
  /// @brief Method DefaultParameters, addr 0x3354768, size 0x68, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::HkdfParameters* DefaultParameters(::ArrayW<uint8_t, ::Array<uint8_t>*> ikm);

  /// @brief Method GetIkm, addr 0x33547d0, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIkm();

  /// @brief Method GetInfo, addr 0x3354898, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetInfo();

  /// @brief Method GetSalt, addr 0x3354838, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method SkipExtractParameters, addr 0x33546f4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33546e4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> ikm, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt, ::ArrayW<uint8_t, ::Array<uint8_t>*> info);

  /// @brief Method .ctor, addr 0x335458c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SkipExtract, addr 0x3354830, size 0x8, virtual true, abstract: false, final false
