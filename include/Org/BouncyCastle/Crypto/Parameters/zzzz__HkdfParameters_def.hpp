...
public:
  ...
  /// @brief Method DefaultParameters, addr 0x23bbcc0, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::HkdfParameters* DefaultParameters(::ArrayW<uint8_t, ::Array<uint8_t>*> ikm);

  /// @brief Method GetIkm, addr 0x23bbd24, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIkm();

  /// @brief Method GetInfo, addr 0x23bbde4, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetInfo();

  /// @brief Method GetSalt, addr 0x23bbd88, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method SkipExtractParameters, addr 0x23bbc50, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bbc40, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> ikm, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt, ::ArrayW<uint8_t, ::Array<uint8_t>*> info);

  /// @brief Method .ctor, addr 0x23bbae4, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SkipExtract, addr 0x23bbd80, size 0x8, virtual true, abstract: false, final false
