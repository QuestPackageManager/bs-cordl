...
public:
  ...
  /// @brief Method DefaultParameters, addr 0x10a1bec, size 0x6c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::HkdfParameters* DefaultParameters(::ArrayW<uint8_t, ::Array<uint8_t>*> ikm);

  /// @brief Method GetIkm, addr 0x10a1c58, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIkm();

  /// @brief Method GetInfo, addr 0x10a1d18, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetInfo();

  /// @brief Method GetSalt, addr 0x10a1cbc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method SkipExtractParameters, addr 0x10a1b74, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10a1b64, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> ikm, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt, ::ArrayW<uint8_t, ::Array<uint8_t>*> info);

  /// @brief Method .ctor, addr 0x10a1a04, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SkipExtract, addr 0x10a1cb4, size 0x8, virtual true, abstract: false, final false
