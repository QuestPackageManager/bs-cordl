...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt*, "Org.BouncyCastle.Crypto.Parameters", "ParametersWithSalt");
...
public:
  ...
  /// @brief Method GetSalt, addr 0x341302c, size 0x8, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt* New_ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayW<uint8_t> salt, int32_t saltOff,
                                                                                      int32_t saltLen);
  ...
  /// @brief Method .ctor, addr 0x3412f88, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayW<uint8_t> salt);

  /// @brief Method .ctor, addr 0x3412fa0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x3413034, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt) == 0x20, "Size mismatch!");
