...
public:
  ...
  /// @brief Method GetSalt, addr 0x238082c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x238077c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayW<uint8_t, ::Array<uint8_t>*> salt);

  /// @brief Method .ctor, addr 0x2380798, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x2380834, size 0x8, virtual false, abstract: false, final false
