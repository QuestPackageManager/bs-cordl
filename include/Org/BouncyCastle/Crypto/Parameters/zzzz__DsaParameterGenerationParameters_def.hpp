...
public:
  ...
  /// @brief Method .ctor, addr 0x23b9548, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(int32_t L, int32_t N, int32_t certainty, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method .ctor, addr 0x23b9594, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(int32_t L, int32_t N, int32_t certainty, ::Org::BouncyCastle::Security::SecureRandom* random, int32_t usageIndex);

  /// @brief Method get_Certainty, addr 0x23b9600, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Certainty();

  /// @brief Method get_L, addr 0x23b95e8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_L();

  /// @brief Method get_N, addr 0x23b95f0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_N();

  /// @brief Method get_Random, addr 0x23b9608, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Security::SecureRandom* get_Random();

  /// @brief Method get_UsageIndex, addr 0x23b95f8, size 0x8, virtual true, abstract: false, final false
