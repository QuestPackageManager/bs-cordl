...
public:
  ...
  /// @brief Method Encode, addr 0x335881c, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x33589f4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3358670, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x33588f4, size 0x100, virtual false, abstract: false, final false
