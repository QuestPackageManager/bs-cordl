...
/// @brief Method Encode, addr 0x331c1d8, size 0x88, virtual false, abstract: false, final false
inline void Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off) ;

/// @brief Method GetEncoded, addr 0x331c3b0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x331c02c, size 0xb8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off) ;

/// @brief Method .ctor, addr 0x331c2b0, size 0x100, virtual false, abstract: false, final false
