...
public:
  ...
  /// @brief Method .ctor addr 0xec2648 size 0x1c virtual false final false
  ...
  /// @brief Method .ctor addr 0xec2664 size 0x90 virtual false final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t off, int32_t len);

  /// @brief Method GetSeed addr 0xec26f4 size 0x78 virtual false final false
