...
public:
  ...
  /// @brief Method GetSeed, addr 0x335549c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33553fc, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method .ctor, addr 0x3355414, size 0x88, virtual false, abstract: false, final false
