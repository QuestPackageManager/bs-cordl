...
/// @brief Method GetSeed, addr 0x3356238, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3356198, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method .ctor, addr 0x33561b0, size 0x88, virtual false, abstract: false, final false
