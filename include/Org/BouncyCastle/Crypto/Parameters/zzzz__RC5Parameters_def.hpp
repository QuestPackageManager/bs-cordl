...
public:
  ...
  /// @brief Method .ctor, addr 0xfa92d8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key, int32_t rounds);

  /// @brief Method get_Rounds, addr 0xfa9364, size 0x8, virtual false, abstract: false, final false
