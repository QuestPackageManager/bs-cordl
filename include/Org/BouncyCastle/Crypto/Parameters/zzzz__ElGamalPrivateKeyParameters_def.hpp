...
public:
  ...
  /// @brief Method Equals, addr 0x23bd3d8, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23bd474, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ElGamalPrivateKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x23bd4cc, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bd34c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x, ::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* parameters);

  /// @brief Method get_X, addr 0x23bd3d0, size 0x8, virtual false, abstract: false, final false
