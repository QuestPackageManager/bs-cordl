...
public:
  ...
  /// @brief Method Equals, addr 0x3353814, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x33538c0, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ElGamalPrivateKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x3353918, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33537a8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x, ::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* parameters);

  /// @brief Method get_X, addr 0x335380c, size 0x8, virtual false, abstract: false, final false
