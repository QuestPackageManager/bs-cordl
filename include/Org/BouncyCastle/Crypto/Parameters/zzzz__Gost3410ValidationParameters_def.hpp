...
public:
  ...
  /// @brief Method Equals, addr 0x23c3824, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x23c38ec, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c37ac, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t x0, int32_t c);

  /// @brief Method .ctor, addr 0x23c37d8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int64_t x0L, int64_t cL);

  /// @brief Method get_C, addr 0x23c3804, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_C();

  /// @brief Method get_CL, addr 0x23c3814, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_CL();

  /// @brief Method get_X0, addr 0x23c380c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_X0();

  /// @brief Method get_X0L, addr 0x23c381c, size 0x8, virtual false, abstract: false, final false
