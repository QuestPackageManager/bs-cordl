...
public:
  ...
  /// @brief Method Equals, addr 0xfa3d00, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0xfa3d9c, size 0x5c, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* other);

  /// @brief Method GetHashCode, addr 0xfa3df8, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa3b1c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa3c5c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa3abc, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECPoint* q, ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* parameters);

  /// @brief Method .ctor, addr 0xfa3bb8, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECPoint* q, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* publicKeyParamSet);

  /// @brief Method get_Q, addr 0xfa3cf8, size 0x8, virtual false, abstract: false, final false
