...
public:
  ...
  /// @brief Method .ctor, addr 0x3350ddc, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3350e28, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DomainParameters, addr 0x3350fac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* get_DomainParameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x3350fb4, size 0x8, virtual false, abstract: false, final false
