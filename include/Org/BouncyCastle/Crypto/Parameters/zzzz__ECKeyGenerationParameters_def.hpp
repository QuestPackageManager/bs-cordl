...
public:
  ...
  /// @brief Method .ctor, addr 0xf5de7c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf5dec8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DomainParameters, addr 0xf5e054, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* get_DomainParameters();

  /// @brief Method get_PublicKeyParamSet, addr 0xf5e05c, size 0x8, virtual false, abstract: false, final false
