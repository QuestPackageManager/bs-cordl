...
public:
  ...
  /// @brief Method .ctor, addr 0x1198068, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11980b4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DomainParameters, addr 0x1198240, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* get_DomainParameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x1198248, size 0x8, virtual false, abstract: false, final false
