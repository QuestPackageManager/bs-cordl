...
public:
  ...
  /// @brief Method .ctor, addr 0x23c01b0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c01fc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DomainParameters, addr 0x23c0378, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* get_DomainParameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x23c0380, size 0x8, virtual false, abstract: false, final false
