...
public:
  ...
  /// @brief Method Encode, addr 0x119fbf8, size 0x84, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0x119fcd8, size 0xac, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GenerateSecret, addr 0x119fe40, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEncoded, addr 0x119fc7c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x119fa34, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x119faf0, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x119f990, size 0xa4, virtual false, abstract: false, final false
