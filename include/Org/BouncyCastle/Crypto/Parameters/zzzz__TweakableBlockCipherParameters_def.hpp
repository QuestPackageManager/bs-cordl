...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TweakableBlockCipherParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TweakableBlockCipherParameters(TweakableBlockCipherParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TweakableBlockCipherParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TweakableBlockCipherParameters(TweakableBlockCipherParametersconst&) = delete;
