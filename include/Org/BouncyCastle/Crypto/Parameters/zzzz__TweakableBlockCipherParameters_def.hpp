...
public:
  ...
  /// @brief Method .ctor, addr 0x23c10d4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::KeyParameter* key, ::ArrayW<uint8_t, ::Array<uint8_t>*> tweak);

  /// @brief Method get_Key, addr 0x23c1154, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* get_Key();

  /// @brief Method get_Tweak, addr 0x23c115c, size 0x8, virtual false, abstract: false, final false
