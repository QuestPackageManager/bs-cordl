...
public:
  ...
  /// @brief Method GetKey, addr 0x333caa0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33462d4, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method .ctor, addr 0x334d4d8, size 0x144, virtual false, abstract: false, final false
