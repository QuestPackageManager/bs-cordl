...
public:
  ...
  /// @brief Method .ctor addr 0xf28300 size 0x100 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf2f6a4 size 0x150 virtual false final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key, int32_t keyOff, int32_t keyLen);

  /// @brief Method GetKey addr 0xf1ed68 size 0x78 virtual false final false
