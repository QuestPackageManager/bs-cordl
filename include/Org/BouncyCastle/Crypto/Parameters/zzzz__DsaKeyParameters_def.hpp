...
public:
  ...
  /// @brief Method Equals, addr 0x340ca0c, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x340cab8, size 0x6c, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x340cb24, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340c9f8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool isPrivate, ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* parameters);

  /// @brief Method get_Parameters, addr 0x340ca04, size 0x8, virtual false, abstract: false, final false
