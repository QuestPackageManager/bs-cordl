...
public:
  ...
  /// @brief Method .ctor, addr 0x238b334, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x238b388, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PhiN, addr 0x238b3dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PhiN();

  /// @brief Method get_SmallPrimes, addr 0x238b3e4, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_SmallPrimes();

  /// @brief Method get_SmallPrimesList, addr 0x238b444, size 0x8, virtual false, abstract: false, final false
