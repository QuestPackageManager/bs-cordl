...
public:
  ...
  /// @brief Method .ctor, addr 0x23be620, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23be674, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PhiN, addr 0x23be6c8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PhiN();

  /// @brief Method get_SmallPrimes, addr 0x23be6d0, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_SmallPrimes();

  /// @brief Method get_SmallPrimesList, addr 0x23be730, size 0x8, virtual false, abstract: false, final false
