...
public:
  ...
  /// @brief Method .ctor, addr 0x23c4d70, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c4dc4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PhiN, addr 0x23c4e18, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PhiN();

  /// @brief Method get_SmallPrimes, addr 0x23c4e20, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_SmallPrimes();

  /// @brief Method get_SmallPrimesList, addr 0x23c4e80, size 0x8, virtual false, abstract: false, final false
