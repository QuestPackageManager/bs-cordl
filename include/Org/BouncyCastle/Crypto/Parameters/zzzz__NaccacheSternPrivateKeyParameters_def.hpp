...
public:
  ...
  /// @brief Method .ctor, addr 0x23c0a00, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c0a54, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PhiN, addr 0x23c0aa8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PhiN();

  /// @brief Method get_SmallPrimes, addr 0x23c0ab0, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_SmallPrimes();

  /// @brief Method get_SmallPrimesList, addr 0x23c0b10, size 0x8, virtual false, abstract: false, final false
