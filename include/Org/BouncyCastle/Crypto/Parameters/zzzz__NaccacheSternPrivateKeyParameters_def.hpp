...
public:
  ...
  /// @brief Method .ctor, addr 0xfa8c04, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa8c58, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PhiN, addr 0xfa8cac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PhiN();

  /// @brief Method get_SmallPrimes, addr 0xfa8cb4, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_SmallPrimes();

  /// @brief Method get_SmallPrimesList, addr 0xfa8d1c, size 0x8, virtual false, abstract: false, final false
