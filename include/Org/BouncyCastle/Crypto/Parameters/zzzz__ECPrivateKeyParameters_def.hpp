...
public:
  ...
  /// @brief Method Equals, addr 0x23bcec8, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23bcf64, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x23bcfbc, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bccf0, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bce28, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bcc90, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* d, ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* parameters);

  /// @brief Method .ctor, addr 0x23bcd88, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* d, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* publicKeyParamSet);

  /// @brief Method get_D, addr 0x23bcec0, size 0x8, virtual false, abstract: false, final false
