...
public:
  ...
  /// @brief Method Equals, addr 0xfc508c, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0xfc5128, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters* other);

  /// @brief Method GetHashCode, addr 0xfc5180, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc4eb4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc4fec, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc4e54, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* d, ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* parameters);

  /// @brief Method .ctor, addr 0xfc4f4c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* d, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* publicKeyParamSet);

  /// @brief Method get_D, addr 0xfc5084, size 0x8, virtual false, abstract: false, final false
