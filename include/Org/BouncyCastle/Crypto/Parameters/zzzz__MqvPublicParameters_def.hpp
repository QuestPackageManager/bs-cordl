...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::MqvPublicParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::MqvPublicParameters*, "Org.BouncyCastle.Crypto.Parameters", "MqvPublicParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3412950, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EphemeralPublicKey, addr 0x3412a40, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_EphemeralPublicKey();

  /// @brief Method get_StaticPublicKey, addr 0x3412a38, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::MqvPublicParameters) == 0x20, "Size mismatch!");
