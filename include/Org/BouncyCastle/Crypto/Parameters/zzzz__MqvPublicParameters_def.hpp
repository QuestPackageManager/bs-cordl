...
public:
  ...
  /// @brief Method .ctor, addr 0x119cbe4, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EphemeralPublicKey, addr 0x119cce8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_EphemeralPublicKey();

  /// @brief Method get_StaticPublicKey, addr 0x119cce0, size 0x8, virtual true, abstract: false, final false
