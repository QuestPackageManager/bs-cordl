...
/// @brief Method .ctor, addr 0x33190b8, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method get_EphemeralPublicKey, addr 0x33191a8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_EphemeralPublicKey() ;

/// @brief Method get_StaticPublicKey, addr 0x33191a0, size 0x8, virtual true, abstract: false, final false
