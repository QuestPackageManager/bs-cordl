...
public:
  ...
  /// @brief Method Equals, addr 0x33136b4, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3313760, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaPrivateKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x33137b8, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3313648, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x, ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* parameters);

  /// @brief Method get_X, addr 0x33136ac, size 0x8, virtual false, abstract: false, final false
