...
public:
  ...
  /// @brief Method GetStrength, addr 0x23be2b4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23be278, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x23be2e8, size 0x8, virtual false, abstract: false, final false
