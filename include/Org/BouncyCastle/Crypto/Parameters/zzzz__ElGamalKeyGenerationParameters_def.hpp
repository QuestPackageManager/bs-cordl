...
public:
  ...
  /// @brief Method GetStrength, addr 0x23be97c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23be940, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x23be9b0, size 0x8, virtual false, abstract: false, final false
