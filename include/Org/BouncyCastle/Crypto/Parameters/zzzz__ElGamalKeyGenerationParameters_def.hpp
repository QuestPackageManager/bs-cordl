...
public:
  ...
  /// @brief Method GetStrength, addr 0x34129b4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3412978, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x34129e8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ElGamalKeyGenerationParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ElGamalKeyGenerationParameters(ElGamalKeyGenerationParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ElGamalKeyGenerationParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ElGamalKeyGenerationParameters(ElGamalKeyGenerationParametersconst&) = delete;
