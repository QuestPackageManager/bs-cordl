...
public:
  ...
  /// @brief Method .ctor, addr 0x119bd5c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0x119bd9c, size 0x8, virtual false, abstract: false, final false
