...
public:
  ...
  /// @brief Method .ctor, addr 0xfa6b40, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0xfa6b80, size 0x8, virtual false, abstract: false, final false
