...
public:
  ...
  /// @brief Method .ctor, addr 0x23bf944, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0x23bf984, size 0x8, virtual false, abstract: false, final false
