...
public:
  ...
  /// @brief Method .ctor, addr 0xfc8244, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0xfc8284, size 0x8, virtual false, abstract: false, final false
