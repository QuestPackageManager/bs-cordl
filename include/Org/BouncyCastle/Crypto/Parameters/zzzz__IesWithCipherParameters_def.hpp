...
public:
  ...
  /// @brief Method .ctor, addr 0xf61b70, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0xf61bb0, size 0x8, virtual false, abstract: false, final false
