...
public:
  ...
  /// @brief Method .ctor, addr 0x32edb44, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0x32edb50, size 0x8, virtual false, abstract: false, final false
