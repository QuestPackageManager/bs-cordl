...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IesWithCipherParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IesWithCipherParameters(IesWithCipherParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IesWithCipherParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IesWithCipherParameters(IesWithCipherParametersconst&) = delete;
