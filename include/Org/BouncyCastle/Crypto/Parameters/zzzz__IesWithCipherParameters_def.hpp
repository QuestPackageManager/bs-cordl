...
public:
  ...
  /// @brief Method .ctor, addr 0x23bbe94, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0x23bbed4, size 0x8, virtual false, abstract: false, final false
