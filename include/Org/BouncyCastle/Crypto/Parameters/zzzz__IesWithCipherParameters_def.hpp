...
public:
  ...
  /// @brief Method .ctor, addr 0x335491c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0x3354928, size 0x8, virtual false, abstract: false, final false
