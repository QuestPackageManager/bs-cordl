...
public:
  ...
  /// @brief Method .ctor, addr 0x23bd5b4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CipherKeySize, addr 0x23bd5f4, size 0x8, virtual false, abstract: false, final false
