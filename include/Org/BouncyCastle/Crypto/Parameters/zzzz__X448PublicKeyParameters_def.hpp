...
public:
  ...
  /// @brief Method Encode, addr 0x3418624, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x34187fc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3418478, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method .ctor, addr 0x34186fc, size 0x100, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X448PublicKeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X448PublicKeyParameters(X448PublicKeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X448PublicKeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X448PublicKeyParameters(X448PublicKeyParametersconst&) = delete;
