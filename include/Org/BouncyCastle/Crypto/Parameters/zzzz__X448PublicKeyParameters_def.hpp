...
public:
  ...
  /// @brief Method Encode, addr 0x23c4270, size 0x84, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x23c4444, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c40c4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x23c4340, size 0x104, virtual false, abstract: false, final false
