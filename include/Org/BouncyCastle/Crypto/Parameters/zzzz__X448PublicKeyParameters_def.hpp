...
public:
  ...
  /// @brief Method Encode, addr 0x10a67d0, size 0x84, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x10a69a8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10a6620, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x10a68a0, size 0x108, virtual false, abstract: false, final false
