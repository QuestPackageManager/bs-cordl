...
public:
  ...
  /// @brief Method Equals, addr 0x23bf384, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23bf420, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x23bf478, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x23bf18c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bf2f0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* y, ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* parameters);

  /// @brief Method get_Y, addr 0x23bf37c, size 0x8, virtual false, abstract: false, final false
