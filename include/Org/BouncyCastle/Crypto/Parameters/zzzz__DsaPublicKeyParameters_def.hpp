...
public:
  ...
  /// @brief Method Equals, addr 0x32e91a4, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x32e9250, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x32e92a8, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x32e8fb4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32e911c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* y, ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* parameters);

  /// @brief Method get_Y, addr 0x32e919c, size 0x8, virtual false, abstract: false, final false
