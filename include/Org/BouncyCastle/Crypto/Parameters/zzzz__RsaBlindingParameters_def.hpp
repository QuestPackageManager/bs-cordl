...
/// @brief Method .ctor, addr 0x3319918, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method get_BlindingFactor, addr 0x3319988, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_BlindingFactor() ;

/// @brief Method get_PublicKey, addr 0x3319980, size 0x8, virtual false, abstract: false, final false
