...
public:
  ...
  /// @brief Method .ctor, addr 0x23bd648, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlindingFactor, addr 0x23bd6d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_BlindingFactor();

  /// @brief Method get_PublicKey, addr 0x23bd6cc, size 0x8, virtual false, abstract: false, final false
