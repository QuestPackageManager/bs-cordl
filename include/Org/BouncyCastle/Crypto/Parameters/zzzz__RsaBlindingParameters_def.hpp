...
public:
  ...
  /// @brief Method .ctor, addr 0x119d588, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BlindingFactor, addr 0x119d618, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_BlindingFactor();

  /// @brief Method get_PublicKey, addr 0x119d610, size 0x8, virtual false, abstract: false, final false
