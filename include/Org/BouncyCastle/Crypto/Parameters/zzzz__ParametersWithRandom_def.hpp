...
public:
  ...
  /// @brief Method GetRandom, addr 0x23c0e88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c0da8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method .ctor, addr 0x23c0d0c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method get_Parameters, addr 0x23c0e98, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* get_Parameters();

  /// @brief Method get_Random, addr 0x23c0e90, size 0x8, virtual false, abstract: false, final false
