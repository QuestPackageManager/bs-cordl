...
public:
  ...
  /// @brief Method GetRandom, addr 0xfa90f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa9010, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters);

  /// @brief Method .ctor, addr 0xfa8f6c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method get_Parameters, addr 0xfa9108, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherParameters* get_Parameters();

  /// @brief Method get_Random, addr 0xfa9100, size 0x8, virtual false, abstract: false, final false
