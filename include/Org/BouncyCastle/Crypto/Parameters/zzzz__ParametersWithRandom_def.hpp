...
/// @brief Method GetRandom, addr 0x33196d8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33195ec, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method .ctor, addr 0x331956c, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

/// @brief Method get_Parameters, addr 0x33196e8, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* get_Parameters() ;

/// @brief Method get_Random, addr 0x33196e0, size 0x8, virtual false, abstract: false, final false
