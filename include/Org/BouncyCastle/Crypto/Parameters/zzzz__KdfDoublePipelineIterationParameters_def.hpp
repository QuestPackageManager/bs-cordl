...
public:
  ...
  /// @brief Method CreateWithCounter, addr 0x119c1fc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWithoutCounter, addr 0x119c278, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x119c098, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FixedInputData, addr 0x119c374, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_FixedInputData();

  /// @brief Method get_Ki, addr 0x119c308, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Ki();

  /// @brief Method get_R, addr 0x119c36c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_R();

  /// @brief Method get_UseCounter, addr 0x119c364, size 0x8, virtual false, abstract: false, final false
