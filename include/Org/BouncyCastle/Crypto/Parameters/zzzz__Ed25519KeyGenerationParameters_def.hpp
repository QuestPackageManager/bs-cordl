...
public:
  ...
  /// @brief Method .ctor, addr 0x3411360, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ed25519KeyGenerationParameters", modifiers: "&&", def_value: None, comment: None }]
