...
public:
  ...
  /// @brief Method Encode, addr 0x23bc728, size 0x84, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0x23bc808, size 0x168, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GetEncoded, addr 0x23bc7ac, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x23bca4c, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x23bca2c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bc560, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x23bc620, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x23bc490, size 0xd0, virtual false, abstract: false, final false
