...
public:
  ...
  /// @brief Method Encode, addr 0xfa4c08, size 0x84, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0xfa4ce8, size 0x174, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GetEncoded, addr 0xfa4c8c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0xfa4f38, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0xfa4f18, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa4a3c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0xfa4afc, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0xfa496c, size 0xd0, virtual false, abstract: false, final false
