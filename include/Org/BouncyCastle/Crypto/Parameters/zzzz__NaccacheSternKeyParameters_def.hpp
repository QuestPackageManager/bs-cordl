...
public:
  ...
  /// @brief Method .ctor, addr 0x23c0fe0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_G, addr 0x23c1020, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_LowerSigmaBound, addr 0x23c1028, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LowerSigmaBound();

  /// @brief Method get_Modulus, addr 0x23c1030, size 0x8, virtual false, abstract: false, final false
