...
public:
  ...
  /// @brief Method .ctor addr 0xec2b60 size 0x40 virtual false final false
  ...
  /// @brief Method get_G addr 0xec2ba0 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_LowerSigmaBound addr 0xec2ba8 size 0x8 virtual false final false
  inline int32_t get_LowerSigmaBound();

  /// @brief Method get_Modulus addr 0xec2bb0 size 0x8 virtual false final false
