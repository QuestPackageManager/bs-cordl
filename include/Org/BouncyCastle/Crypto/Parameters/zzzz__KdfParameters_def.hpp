...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KdfParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KdfParameters(KdfParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KdfParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KdfParameters(KdfParametersconst&) = delete;
