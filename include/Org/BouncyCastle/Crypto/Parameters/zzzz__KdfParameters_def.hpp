...
public:
  ...
  /// @brief Method GetIV, addr 0xfa868c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetSharedSecret, addr 0xfa8684, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa8658, size 0x2c, virtual false, abstract: false, final false
