...
/// @brief Method GetIV, addr 0x3356190, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetIV() ;

/// @brief Method GetSharedSecret, addr 0x3356188, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3356180, size 0x8, virtual false, abstract: false, final false
