...
public:
  ...
  /// @brief Method GetIV, addr 0xfc9d90, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetSharedSecret, addr 0xfc9d88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc9d5c, size 0x2c, virtual false, abstract: false, final false
