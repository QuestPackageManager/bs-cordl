...
public:
  ...
  /// @brief Method Equals, addr 0x11974e4, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1197588, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaValidationParameters* other);

  /// @brief Method GetHashCode, addr 0x1197618, size 0x88, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSeed, addr 0x119745c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x119734c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t counter);

  /// @brief Method .ctor, addr 0x1197354, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t counter, int32_t usageIndex);

  /// @brief Method get_Counter, addr 0x11974d4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Counter();

  /// @brief Method get_UsageIndex, addr 0x11974dc, size 0x8, virtual true, abstract: false, final false
