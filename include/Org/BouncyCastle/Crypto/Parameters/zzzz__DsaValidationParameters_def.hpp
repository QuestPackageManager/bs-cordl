...
public:
  ...
  /// @brief Method Equals, addr 0x3313cb4, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3313d68, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaValidationParameters* other);

  /// @brief Method GetHashCode, addr 0x3313e08, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSeed, addr 0x3313c2c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3313b2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t counter);

  /// @brief Method .ctor, addr 0x3313b34, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t counter, int32_t usageIndex);

  /// @brief Method get_Counter, addr 0x3313ca4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Counter();

  /// @brief Method get_UsageIndex, addr 0x3313cac, size 0x8, virtual true, abstract: false, final false
