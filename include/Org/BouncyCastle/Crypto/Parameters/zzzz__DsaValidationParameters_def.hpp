...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DsaValidationParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DsaValidationParameters(DsaValidationParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DsaValidationParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DsaValidationParameters(DsaValidationParametersconst&) = delete;
