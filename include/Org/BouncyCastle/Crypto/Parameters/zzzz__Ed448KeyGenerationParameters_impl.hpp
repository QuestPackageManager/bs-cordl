...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters::*)(
  ...
  constexpr static std::size_t addrs = 0xebf918;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters::New_ctor(::Org::BouncyCastle::Security::SecureRandom* random) {
  return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters*>(random));
}
