...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyParameters*, "Org.BouncyCastle.Crypto.Parameters", "Gost3410KeyParameters");
...
public:
  ...
  /// @brief Method LookupParameters, addr 0x3413338, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3413300, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool isPrivate, ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* parameters);

  /// @brief Method .ctor, addr 0x341330c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(bool isPrivate, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* publicKeyParamSet);

  /// @brief Method get_Parameters, addr 0x34134b8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x34134c0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Gost3410KeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Gost3410KeyParameters(Gost3410KeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Gost3410KeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Gost3410KeyParameters(Gost3410KeyParametersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyParameters) == 0x28, "Size mismatch!");
