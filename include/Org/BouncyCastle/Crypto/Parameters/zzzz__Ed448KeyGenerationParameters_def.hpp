...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters*, "Org.BouncyCastle.Crypto.Parameters", "Ed448KeyGenerationParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3411e94, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ed448KeyGenerationParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Ed448KeyGenerationParameters(Ed448KeyGenerationParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Ed448KeyGenerationParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Ed448KeyGenerationParameters(Ed448KeyGenerationParametersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters) == 0x20, "Size mismatch!");
