...
public:
  ...
  /// @brief Method GetStrength, addr 0x340d7f0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340d7b4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x340d824, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHKeyGenerationParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHKeyGenerationParameters(DHKeyGenerationParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHKeyGenerationParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHKeyGenerationParameters(DHKeyGenerationParametersconst&) = delete;
