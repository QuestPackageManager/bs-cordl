...
public:
  ...
  /// @brief Method GetStrength, addr 0x23bd578, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bd53c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x23bd5ac, size 0x8, virtual false, abstract: false, final false
