...
public:
  ...
  /// @brief Method GetStrength, addr 0x23b6e28, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b6dec, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x23b6e5c, size 0x8, virtual false, abstract: false, final false
