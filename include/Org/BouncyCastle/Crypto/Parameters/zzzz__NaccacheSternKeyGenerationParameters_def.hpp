...
public:
  ...
  /// @brief Method .ctor, addr 0xfa8ad4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa8b90, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certainty, addr 0xfa8b94, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Certainty();

  /// @brief Method get_CountSmallPrimes, addr 0xfa8b9c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CountSmallPrimes();

  /// @brief Method get_IsDebug, addr 0xfa8ba4, size 0x8, virtual false, abstract: false, final false
