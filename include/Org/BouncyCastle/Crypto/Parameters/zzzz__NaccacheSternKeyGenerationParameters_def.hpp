...
public:
  ...
  /// @brief Method .ctor, addr 0xfca1d8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfca294, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certainty, addr 0xfca298, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Certainty();

  /// @brief Method get_CountSmallPrimes, addr 0xfca2a0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CountSmallPrimes();

  /// @brief Method get_IsDebug, addr 0xfca2a8, size 0x8, virtual false, abstract: false, final false
