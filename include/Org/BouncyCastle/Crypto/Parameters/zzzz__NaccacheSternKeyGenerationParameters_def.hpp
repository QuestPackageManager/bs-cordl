...
public:
  ...
  /// @brief Method .ctor, addr 0x23c0f10, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c0fc4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certainty, addr 0x23c0fc8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Certainty();

  /// @brief Method get_CountSmallPrimes, addr 0x23c0fd0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CountSmallPrimes();

  /// @brief Method get_IsDebug, addr 0x23c0fd8, size 0x8, virtual false, abstract: false, final false
