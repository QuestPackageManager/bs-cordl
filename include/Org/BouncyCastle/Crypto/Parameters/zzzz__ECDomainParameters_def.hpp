...
public:
  ...
  /// @brief Method Equals, addr 0x23bfc84, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23bfd28, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* other);

  /// @brief Method GetHashCode, addr 0x23bfdb0, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSeed, addr 0x23bfc28, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePrivateScalar, addr 0x23bfe2c, size 0x130, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* ValidatePrivateScalar(::Org::BouncyCastle::Math::BigInteger* d);

  /// @brief Method ValidatePublicPoint, addr 0x23bfa20, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePublicPoint, addr 0x23bff5c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bf98c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bfa18, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bf850, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Math::EC::ECPoint* g, ::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* h,
                    ::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method .ctor, addr 0x23bf808, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X9::X9ECParameters* x9);

  /// @brief Method get_Curve, addr 0x23bfb44, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* get_Curve();

  /// @brief Method get_G, addr 0x23bfb4c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_G();

  /// @brief Method get_H, addr 0x23bfb5c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_H();

  /// @brief Method get_HInv, addr 0x23bfb64, size 0xc4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_HInv();

  /// @brief Method get_N, addr 0x23bfb54, size 0x8, virtual false, abstract: false, final false
