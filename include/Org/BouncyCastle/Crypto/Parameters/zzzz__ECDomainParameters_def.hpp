...
public:
  ...
  /// @brief Method Equals, addr 0x3350894, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3350948, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* other);

  /// @brief Method GetHashCode, addr 0x33509d0, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSeed, addr 0x3350834, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePrivateScalar, addr 0x3350a4c, size 0x13c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* ValidatePrivateScalar(::Org::BouncyCastle::Math::BigInteger* d);

  /// @brief Method ValidatePublicPoint, addr 0x3350628, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePublicPoint, addr 0x3350b88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3350590, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3350620, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3350450, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Math::EC::ECPoint* g, ::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* h,
                    ::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method .ctor, addr 0x3350408, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X9::X9ECParameters* x9);

  /// @brief Method get_Curve, addr 0x3350754, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* get_Curve();

  /// @brief Method get_G, addr 0x335075c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_G();

  /// @brief Method get_H, addr 0x335076c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_H();

  /// @brief Method get_HInv, addr 0x3350774, size 0xc0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_HInv();

  /// @brief Method get_N, addr 0x3350764, size 0x8, virtual false, abstract: false, final false
