...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RsaPrivateCrtKeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RsaPrivateCrtKeyParameters(RsaPrivateCrtKeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RsaPrivateCrtKeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RsaPrivateCrtKeyParameters(RsaPrivateCrtKeyParametersconst&) = delete;
