...
public:
  ...
  /// @brief Method Equals, addr 0x23c0804, size 0x178, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x23c097c, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateValue, addr 0x23c06dc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c04b0, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c079c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::RsaPrivateKeyStructure* rsaPrivateKey);

  /// @brief Method get_DP, addr 0x23c07ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_DP();

  /// @brief Method get_DQ, addr 0x23c07f4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_DQ();

  /// @brief Method get_P, addr 0x23c07dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_PublicExponent, addr 0x23c07d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PublicExponent();

  /// @brief Method get_Q, addr 0x23c07e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  /// @brief Method get_QInv, addr 0x23c07fc, size 0x8, virtual false, abstract: false, final false
