...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ed25519PublicKeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Ed25519PublicKeyParameters(Ed25519PublicKeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Ed25519PublicKeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Ed25519PublicKeyParameters(Ed25519PublicKeyParametersconst&) = delete;
