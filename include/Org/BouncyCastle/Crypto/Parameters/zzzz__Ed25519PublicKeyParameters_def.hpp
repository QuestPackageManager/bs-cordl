...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters*, "Org.BouncyCastle.Crypto.Parameters", "Ed25519PublicKeyParameters");
...
public:
  ...
  /// @brief Method Encode, addr 0x340f824, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x340fa2c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340f4d0, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method .ctor, addr 0x340f92c, size 0x100, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters) == 0x20, "Size mismatch!");
