...
public:
  ...
  /// @brief Method Encode, addr 0x2387eac, size 0x84, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x23880ac, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2387b5c, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x2387fa8, size 0x104, virtual false, abstract: false, final false
