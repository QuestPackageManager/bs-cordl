...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ParametersWithSBox", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ParametersWithSBox(ParametersWithSBox&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ParametersWithSBox", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ParametersWithSBox(ParametersWithSBoxconst&) = delete;
