...
public:
  ...
  /// @brief Method GetSBox, addr 0x1196ba8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1196b7c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayW<uint8_t, ::Array<uint8_t>*> sBox);

  /// @brief Method get_Parameters, addr 0x1196bb0, size 0x8, virtual false, abstract: false, final false
