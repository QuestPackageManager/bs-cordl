...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ElGamalPublicKeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ElGamalPublicKeyParameters(ElGamalPublicKeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ElGamalPublicKeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ElGamalPublicKeyParameters(ElGamalPublicKeyParametersconst&) = delete;
