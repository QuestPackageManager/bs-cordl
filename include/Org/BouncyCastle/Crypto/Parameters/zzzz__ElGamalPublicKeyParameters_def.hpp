...
public:
  ...
  /// @brief Method Equals, addr 0x32ecbe8, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x32ecc94, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ElGamalPublicKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x32eccec, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ecb80, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* y, ::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* parameters);

  /// @brief Method get_Y, addr 0x32ecbe0, size 0x8, virtual false, abstract: false, final false
