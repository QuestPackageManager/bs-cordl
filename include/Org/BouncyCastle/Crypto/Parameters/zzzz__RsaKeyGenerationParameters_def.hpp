...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters*, "Org.BouncyCastle.Crypto.Parameters", "RsaKeyGenerationParameters");
...
public:
  ...
  /// @brief Method Equals, addr 0x3413270, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x341332c, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3413228, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certainty, addr 0x3413268, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Certainty();

  /// @brief Method get_PublicExponent, addr 0x3413260, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters) == 0x30, "Size mismatch!");
