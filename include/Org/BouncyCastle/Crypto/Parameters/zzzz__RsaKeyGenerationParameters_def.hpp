...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RsaKeyGenerationParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RsaKeyGenerationParameters(RsaKeyGenerationParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RsaKeyGenerationParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RsaKeyGenerationParameters(RsaKeyGenerationParametersconst&) = delete;
