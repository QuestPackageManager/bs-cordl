...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ParametersWithID", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ParametersWithID(ParametersWithID&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ParametersWithID", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ParametersWithID(ParametersWithIDconst&) = delete;
