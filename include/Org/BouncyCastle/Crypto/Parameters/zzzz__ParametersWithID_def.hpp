...
public:
  ...
  /// @brief Method GetID, addr 0x3319498, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33193f0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayW<uint8_t, ::Array<uint8_t>*> id);

  /// @brief Method .ctor, addr 0x3319408, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x33194a0, size 0x8, virtual false, abstract: false, final false
