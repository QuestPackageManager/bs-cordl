...
public:
  ...
  /// @brief Method GetID, addr 0x3355a2c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3355984, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayW<uint8_t, ::Array<uint8_t>*> id);

  /// @brief Method .ctor, addr 0x335599c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x3355a34, size 0x8, virtual false, abstract: false, final false
