...
public:
  ...
  /// @brief Method Equals, addr 0x32e8510, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x32e85bc, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x32e8614, size 0x40, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Legendre, addr 0x32e82b8, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x32e8068, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32e849c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* y, ::Org::BouncyCastle::Crypto::Parameters::DHParameters* parameters);

  /// @brief Method .ctor, addr 0x32e84d4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Y, addr 0x32e8508, size 0x8, virtual true, abstract: false, final false
