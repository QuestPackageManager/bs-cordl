...
public:
  ...
  /// @brief Method Validate addr 0xebbdc8 size 0x258 virtual false final false
  ...
  /// @brief Method .ctor addr 0xebc1d8 size 0x38 virtual false final false
  ...
  /// @brief Method .ctor addr 0xebc210 size 0x4c virtual false final false
  ...
  /// @brief Method get_Y addr 0xebc25c size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Y();

  /// @brief Method Equals addr 0xebc264 size 0x9c virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0xebc300 size 0x58 virtual false final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters* other);

  /// @brief Method GetHashCode addr 0xebc358 size 0x40 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Legendre addr 0xebc020 size 0x1b8 virtual false final false
