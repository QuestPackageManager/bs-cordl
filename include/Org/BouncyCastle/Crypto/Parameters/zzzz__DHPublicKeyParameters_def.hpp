...
public:
  ...
  /// @brief Method Equals, addr 0x334f2e8, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x334f394, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x334f3ec, size 0x40, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Legendre, addr 0x334f090, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x334ee40, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334f274, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* y, ::Org::BouncyCastle::Crypto::Parameters::DHParameters* parameters);

  /// @brief Method .ctor, addr 0x334f2ac, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Y, addr 0x334f2e0, size 0x8, virtual true, abstract: false, final false
