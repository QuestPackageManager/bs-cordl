...
public:
  ...
  /// @brief Method Equals, addr 0x23b8f38, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23b8fd4, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x23b902c, size 0x40, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Legendre, addr 0x23b8cf8, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x23b8aac, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b8eac, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* y, ::Org::BouncyCastle::Crypto::Parameters::DHParameters* parameters);

  /// @brief Method .ctor, addr 0x23b8ee4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Y, addr 0x23b8f30, size 0x8, virtual true, abstract: false, final false
