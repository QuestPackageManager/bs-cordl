...
public:
  ...
  /// @brief Method Encode, addr 0x3412690, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x3412898, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x341238c, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method .ctor, addr 0x3412798, size 0x100, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ed448PublicKeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Ed448PublicKeyParameters(Ed448PublicKeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Ed448PublicKeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Ed448PublicKeyParameters(Ed448PublicKeyParametersconst&) = delete;
