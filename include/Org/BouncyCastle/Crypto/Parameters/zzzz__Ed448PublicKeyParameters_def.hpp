...
public:
  ...
  /// @brief Method Encode, addr 0x32ec2dc, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x32ec4e4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ebfd8, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x32ec3e4, size 0x100, virtual false, abstract: false, final false
