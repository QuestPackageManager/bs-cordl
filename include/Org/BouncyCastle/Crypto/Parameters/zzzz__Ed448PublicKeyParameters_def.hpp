...
public:
  ...
  /// @brief Method Encode, addr 0x3410308, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method GetEncoded, addr 0x3410510, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3410004, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buf, int32_t off);

  /// @brief Method .ctor, addr 0x3410410, size 0x100, virtual false, abstract: false, final false
