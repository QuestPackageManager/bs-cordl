...
public:
  ...
  /// @brief Method Encode, addr 0x23c1350, size 0x84, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0x23c1430, size 0x168, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GetEncoded, addr 0x23c13d4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x23c1674, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x23c1654, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c1188, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x23c1248, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x23c10b8, size 0xd0, virtual false, abstract: false, final false
