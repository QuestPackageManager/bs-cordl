...
public:
  ...
  /// @brief Method Encode, addr 0x3315a94, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0x3315b7c, size 0x16c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GetEncoded, addr 0x3315b1c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x3315dc0, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x3315da0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33158d4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x3315990, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x33157f8, size 0xdc, virtual false, abstract: false, final false
