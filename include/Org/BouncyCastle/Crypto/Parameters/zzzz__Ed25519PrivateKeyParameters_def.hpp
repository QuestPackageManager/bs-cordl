...
public:
  ...
  /// @brief Method Encode, addr 0x32eb250, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0x32eb338, size 0x16c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GetEncoded, addr 0x32eb2d8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x32eb57c, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x32eb55c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32eb090, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x32eb14c, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x32eafb4, size 0xdc, virtual false, abstract: false, final false
