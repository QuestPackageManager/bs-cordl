...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters*, "Org.BouncyCastle.Crypto.Parameters", "Srp6GroupParameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34177b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* N, ::Org::BouncyCastle::Math::BigInteger* g);

  /// @brief Method get_G, addr 0x34177bc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_N, addr 0x34177c4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Srp6GroupParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Srp6GroupParameters(Srp6GroupParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Srp6GroupParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Srp6GroupParameters(Srp6GroupParametersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters) == 0x20, "Size mismatch!");
