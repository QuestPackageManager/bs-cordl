...
public:
  ...
  /// @brief Method .ctor, addr 0x3417854, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X25519KeyGenerationParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X25519KeyGenerationParameters(X25519KeyGenerationParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X25519KeyGenerationParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X25519KeyGenerationParameters(X25519KeyGenerationParametersconst&) = delete;
