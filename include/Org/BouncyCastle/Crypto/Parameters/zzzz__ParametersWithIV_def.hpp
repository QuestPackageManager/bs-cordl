...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ParametersWithIV", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ParametersWithIV(ParametersWithIV&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ParametersWithIV", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ParametersWithIV(ParametersWithIVconst&) = delete;
