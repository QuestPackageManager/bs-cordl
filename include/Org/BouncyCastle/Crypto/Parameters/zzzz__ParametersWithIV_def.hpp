...
public:
  ...
  /// @brief Method GetIV, addr 0x331959c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33194a8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayW<uint8_t, ::Array<uint8_t>*> iv);

  /// @brief Method .ctor, addr 0x33194c0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x3319614, size 0x8, virtual false, abstract: false, final false
