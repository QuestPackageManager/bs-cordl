...
public:
  ...
  /// @brief Method LookupParameters, addr 0x23bea84, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23be9fc, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bea48, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x23bebec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x23bebf4, size 0x8, virtual false, abstract: false, final false
