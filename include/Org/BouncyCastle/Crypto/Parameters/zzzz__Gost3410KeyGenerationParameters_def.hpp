...
public:
  ...
  /// @brief Method LookupParameters, addr 0x33175f8, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3317570, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33175bc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x3317778, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x3317780, size 0x8, virtual false, abstract: false, final false
