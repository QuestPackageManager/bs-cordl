...
public:
  ...
  /// @brief Method LookupParameters, addr 0x32ecdb4, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ecd2c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ecd78, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x32ecf34, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x32ecf3c, size 0x8, virtual false, abstract: false, final false
