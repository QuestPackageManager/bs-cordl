...
public:
  ...
  /// @brief Method LookupParameters, addr 0x2389448, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23893c0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x238940c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x23895b0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters();

  /// @brief Method get_PublicKeyParamSet, addr 0x23895b8, size 0x8, virtual false, abstract: false, final false
