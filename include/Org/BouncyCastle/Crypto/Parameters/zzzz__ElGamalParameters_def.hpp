...
public:
  ...
  /// @brief Method Equals, addr 0x23bebe0, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23bec7c, size 0x74, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* other);

  /// @brief Method GetHashCode, addr 0x23becf0, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23beb14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* p, ::Org::BouncyCastle::Math::BigInteger* g);

  /// @brief Method .ctor, addr 0x23beb1c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* p, ::Org::BouncyCastle::Math::BigInteger* g, int32_t l);

  /// @brief Method get_G, addr 0x23bebd0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_L, addr 0x23bebd8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_L();

  /// @brief Method get_P, addr 0x23bebc8, size 0x8, virtual false, abstract: false, final false
