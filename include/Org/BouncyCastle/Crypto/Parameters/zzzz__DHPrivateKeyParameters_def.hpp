...
public:
  ...
  /// @brief Method Equals, addr 0x340e2d8, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x340e384, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x340e3dc, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340e294, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x, ::Org::BouncyCastle::Crypto::Parameters::DHParameters* parameters);

  /// @brief Method .ctor, addr 0x340e2bc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_X, addr 0x340e2d0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHPrivateKeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHPrivateKeyParameters(DHPrivateKeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHPrivateKeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHPrivateKeyParameters(DHPrivateKeyParametersconst&) = delete;
