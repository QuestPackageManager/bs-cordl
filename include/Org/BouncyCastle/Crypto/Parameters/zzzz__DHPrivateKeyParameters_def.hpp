...
public:
  ...
  /// @brief Method Equals, addr 0x334ecfc, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x334eda8, size 0x58, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* other);

  /// @brief Method GetHashCode, addr 0x334ee00, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334ecb8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x, ::Org::BouncyCastle::Crypto::Parameters::DHParameters* parameters);

  /// @brief Method .ctor, addr 0x334ece0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_X, addr 0x334ecf4, size 0x8, virtual false, abstract: false, final false
