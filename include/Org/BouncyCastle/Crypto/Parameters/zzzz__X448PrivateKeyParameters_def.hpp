...
public:
  ...
  /// @brief Method Encode, addr 0x331c780, size 0x88, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method GeneratePublicKey, addr 0x331c868, size 0xa0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::X448PublicKeyParameters* GeneratePublicKey();

  /// @brief Method GenerateSecret, addr 0x331c9c0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEncoded, addr 0x331c808, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331c5c0, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off);

  /// @brief Method .ctor, addr 0x331c67c, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x331c51c, size 0xa4, virtual false, abstract: false, final false
