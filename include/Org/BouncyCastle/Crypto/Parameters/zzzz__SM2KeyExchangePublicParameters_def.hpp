...
public:
  ...
  /// @brief Method .ctor, addr 0x10a5818, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EphemeralPublicKey, addr 0x10a591c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_EphemeralPublicKey();

  /// @brief Method get_StaticPublicKey, addr 0x10a5914, size 0x8, virtual true, abstract: false, final false
