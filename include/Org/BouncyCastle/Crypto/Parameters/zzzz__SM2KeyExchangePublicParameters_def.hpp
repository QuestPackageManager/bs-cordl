...
public:
  ...
  /// @brief Method .ctor addr 0xec5544 size 0xfc virtual false final false
  ...
  /// @brief Method get_StaticPublicKey addr 0xec5640 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_StaticPublicKey();

  /// @brief Method get_EphemeralPublicKey addr 0xec5648 size 0x8 virtual true final false
