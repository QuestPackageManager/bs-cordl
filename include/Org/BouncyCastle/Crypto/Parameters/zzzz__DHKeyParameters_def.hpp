...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DHKeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DHKeyParameters(DHKeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DHKeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DHKeyParameters(DHKeyParametersconst&) = delete;
