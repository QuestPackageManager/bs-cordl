...
public:
  ...
  /// @brief Method .ctor, addr 0x23b6c5c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x23b6ca8, size 0x8, virtual false, abstract: false, final false
