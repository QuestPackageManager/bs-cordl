...
public:
  ...
  /// @brief Method .ctor, addr 0x23bad94, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0x23bade0, size 0x8, virtual false, abstract: false, final false
