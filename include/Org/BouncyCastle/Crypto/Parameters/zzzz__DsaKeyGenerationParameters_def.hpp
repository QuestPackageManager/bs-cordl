...
public:
  ...
  /// @brief Method .ctor, addr 0xfa1714, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0xfa1760, size 0x8, virtual false, abstract: false, final false
