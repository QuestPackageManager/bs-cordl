...
public:
  ...
  /// @brief Method .ctor, addr 0xf5c744, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parameters, addr 0xf5c790, size 0x8, virtual false, abstract: false, final false
