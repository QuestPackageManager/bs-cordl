...
public:
  ...
  /// @brief Method .ctor, addr 0x341033c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34102bc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DigestParamSet, addr 0x34102ac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_DigestParamSet();

  /// @brief Method get_EncryptionParamSet, addr 0x34102b4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_EncryptionParamSet();

  /// @brief Method get_PublicKeyParamSet, addr 0x34102a4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECGost3410Parameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECGost3410Parameters(ECGost3410Parameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECGost3410Parameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECGost3410Parameters(ECGost3410Parametersconst&) = delete;
