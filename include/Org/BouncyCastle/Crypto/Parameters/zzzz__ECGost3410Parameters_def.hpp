...
public:
  ...
  /// @brief Method .ctor, addr 0x3350d60, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3350ce0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DigestParamSet, addr 0x3350cd0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_DigestParamSet();

  /// @brief Method get_EncryptionParamSet, addr 0x3350cd8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_EncryptionParamSet();

  /// @brief Method get_PublicKeyParamSet, addr 0x3350cc8, size 0x8, virtual false, abstract: false, final false
