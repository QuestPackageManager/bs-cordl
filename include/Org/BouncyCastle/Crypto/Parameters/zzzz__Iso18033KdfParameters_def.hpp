...
public:
  ...
  /// @brief Method GetSeed, addr 0x23bd624, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bd5fc, size 0x28, virtual false, abstract: false, final false
