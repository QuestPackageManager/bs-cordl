...
public:
  ...
  /// @brief Method GetSeed, addr 0x119bdcc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x119bda4, size 0x28, virtual false, abstract: false, final false
