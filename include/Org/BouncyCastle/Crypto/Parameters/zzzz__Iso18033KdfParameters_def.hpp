...
public:
  ...
  /// @brief Method GetSeed, addr 0x23bf974, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bf94c, size 0x28, virtual false, abstract: false, final false
