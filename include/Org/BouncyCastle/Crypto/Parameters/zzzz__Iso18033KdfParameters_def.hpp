...
public:
  ...
  /// @brief Method GetSeed, addr 0x23c3d74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c3d4c, size 0x28, virtual false, abstract: false, final false
