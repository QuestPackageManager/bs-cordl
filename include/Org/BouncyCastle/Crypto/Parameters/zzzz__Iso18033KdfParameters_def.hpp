...
public:
  ...
  /// @brief Method GetSeed, addr 0x32edb60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32edb58, size 0x8, virtual false, abstract: false, final false
