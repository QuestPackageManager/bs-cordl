...
public:
  ...
  /// @brief Method GetSeed, addr 0xfc82b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfc828c, size 0x28, virtual false, abstract: false, final false
