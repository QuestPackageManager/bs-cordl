...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Iso18033KdfParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Iso18033KdfParameters*, "Org.BouncyCastle.Crypto.Parameters", "Iso18033KdfParameters");
...
public:
  ...
  /// @brief Method GetSeed, addr 0x3413f14, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetSeed();

  static inline ::Org::BouncyCastle::Crypto::Parameters::Iso18033KdfParameters* New_ctor(::ArrayW<uint8_t> seed);
  ...
  /// @brief Method .ctor, addr 0x3413f0c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Iso18033KdfParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Iso18033KdfParameters(Iso18033KdfParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Iso18033KdfParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Iso18033KdfParameters(Iso18033KdfParametersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Iso18033KdfParameters) == 0x18, "Size mismatch!");
