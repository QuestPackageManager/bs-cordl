...
public:
  ...
  /// @brief Method Equals, addr 0x23b6aa8, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x23b6b44, size 0x90, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHValidationParameters* other);

  /// @brief Method GetHashCode, addr 0x23b6bd4, size 0x88, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSeed, addr 0x23b6a28, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b6930, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t counter);

  /// @brief Method get_Counter, addr 0x23b6aa0, size 0x8, virtual false, abstract: false, final false
