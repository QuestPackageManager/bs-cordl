...
public:
  ...
  /// @brief Method Equals, addr 0x334f598, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x334f644, size 0xa0, virtual false, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHValidationParameters* other);

  /// @brief Method GetHashCode, addr 0x334f6e4, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSeed, addr 0x334f518, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334f42c, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t counter);

  /// @brief Method get_Counter, addr 0x334f590, size 0x8, virtual false, abstract: false, final false
