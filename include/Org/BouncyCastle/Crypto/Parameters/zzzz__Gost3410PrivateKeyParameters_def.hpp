...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crypto::Parameters::Gost3410PrivateKeyParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crypto::Parameters::Gost3410PrivateKeyParameters*, "Org.BouncyCastle.Crypto.Parameters", "Gost3410PrivateKeyParameters");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Gost3410PrivateKeyParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Gost3410PrivateKeyParameters(Gost3410PrivateKeyParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Gost3410PrivateKeyParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Gost3410PrivateKeyParameters(Gost3410PrivateKeyParametersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crypto::Parameters::Gost3410PrivateKeyParameters) == 0x30, "Size mismatch!");
