...
public:
  ...
  /// @brief Method Build, addr 0x10a5514, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x10a5074, size 0x178, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::__SkeinParameters__Builder* Set(int32_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method SetKey, addr 0x10a51ec, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::__SkeinParameters__Builder* SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method SetKeyIdentifier, addr 0x10a54fc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNonce, addr 0x10a5508, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::__SkeinParameters__Builder* SetNonce(::ArrayW<uint8_t, ::Array<uint8_t>*> nonce);

  /// @brief Method SetPersonalisation, addr 0x10a5204, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPersonalisation, addr 0x10a51f8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPublicKey, addr 0x10a54f0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10a4900, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x10a4ce4, size 0x390, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters* parameters);

  /// @brief Method .ctor, addr 0x10a4964, size 0x380, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetKey, addr 0x10a43a0, size 0x110, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetKey();

  /// @brief Method GetKeyIdentifier, addr 0x10a46d8, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetKeyIdentifier();

  /// @brief Method GetNonce, addr 0x10a47ec, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetNonce();

  /// @brief Method GetParameters, addr 0x10a4398, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetParameters();

  /// @brief Method GetPersonalisation, addr 0x10a44b0, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPersonalisation();

  /// @brief Method GetPublicKey, addr 0x10a45c4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10a4304, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x10a4370, size 0x28, virtual false, abstract: false, final false
