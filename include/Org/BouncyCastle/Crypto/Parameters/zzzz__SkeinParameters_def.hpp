...
/// @brief Method Build, addr 0x331b7c4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x331b2e8, size 0x16c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* Set(int32_t  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method SetKey, addr 0x331b454, size 0xc, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* SetKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method SetKeyIdentifier, addr 0x331b7ac, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method SetNonce, addr 0x331b7b8, size 0xc, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* SetNonce(::ArrayW<uint8_t,::Array<uint8_t>*>  nonce) ;

/// @brief Method SetPersonalisation, addr 0x331b46c, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method SetPersonalisation, addr 0x331b460, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method SetPublicKey, addr 0x331b7a0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x331ab90, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x331af64, size 0x384, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters*  parameters) ;

/// @brief Method .ctor, addr 0x331abf0, size 0x374, virtual false, abstract: false, final false
...
/// @brief Method GetKey, addr 0x331a658, size 0x108, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetKey() ;

/// @brief Method GetKeyIdentifier, addr 0x331a978, size 0x10c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetKeyIdentifier() ;

/// @brief Method GetNonce, addr 0x331aa84, size 0x10c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetNonce() ;

/// @brief Method GetParameters, addr 0x331a650, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::IDictionary* GetParameters() ;

/// @brief Method GetPersonalisation, addr 0x331a760, size 0x10c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPersonalisation() ;

/// @brief Method GetPublicKey, addr 0x331a86c, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x331a5e8, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x331a648, size 0x8, virtual false, abstract: false, final false
