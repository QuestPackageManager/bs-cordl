...
public:
  ...
  /// @brief Method Build, addr 0x23c36c0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x23c3208, size 0x170, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* Set(int32_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method SetKey, addr 0x23c3378, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method SetKeyIdentifier, addr 0x23c36a8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNonce, addr 0x23c36b4, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* SetNonce(::ArrayW<uint8_t, ::Array<uint8_t>*> nonce);

  /// @brief Method SetPersonalisation, addr 0x23c3390, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPersonalisation, addr 0x23c3384, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPublicKey, addr 0x23c369c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c2a94, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23c2e78, size 0x390, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters* parameters);

  /// @brief Method .ctor, addr 0x23c2af8, size 0x380, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetKey, addr 0x23c2534, size 0x110, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetKey();

  /// @brief Method GetKeyIdentifier, addr 0x23c286c, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetKeyIdentifier();

  /// @brief Method GetNonce, addr 0x23c2980, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetNonce();

  /// @brief Method GetParameters, addr 0x23c252c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetParameters();

  /// @brief Method GetPersonalisation, addr 0x23c2644, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPersonalisation();

  /// @brief Method GetPublicKey, addr 0x23c2758, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c2498, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23c2504, size 0x28, virtual false, abstract: false, final false
