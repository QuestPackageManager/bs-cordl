...
public:
  ...
  /// @brief Method Build, addr 0x23c0ca8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x23c07f0, size 0x170, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* Set(int32_t type, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method SetKey, addr 0x23c0960, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method SetKeyIdentifier, addr 0x23c0c90, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNonce, addr 0x23c0c9c, size 0xc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder* SetNonce(::ArrayW<uint8_t, ::Array<uint8_t>*> nonce);

  /// @brief Method SetPersonalisation, addr 0x23c0978, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPersonalisation, addr 0x23c096c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPublicKey, addr 0x23c0c84, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c007c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23c0460, size 0x390, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters* parameters);

  /// @brief Method .ctor, addr 0x23c00e0, size 0x380, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetKey, addr 0x23bfb1c, size 0x110, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetKey();

  /// @brief Method GetKeyIdentifier, addr 0x23bfe54, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetKeyIdentifier();

  /// @brief Method GetNonce, addr 0x23bff68, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetNonce();

  /// @brief Method GetParameters, addr 0x23bfb14, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetParameters();

  /// @brief Method GetPersonalisation, addr 0x23bfc2c, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPersonalisation();

  /// @brief Method GetPublicKey, addr 0x23bfd40, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bfa80, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x23bfaec, size 0x28, virtual false, abstract: false, final false
