...
public:
  ...
  /// @brief Method CreateWithCounter, addr 0x11a8884, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWithoutCounter, addr 0x11a8964, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a8714, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FixedInputData, addr 0x11a8ac4, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_FixedInputData();

  /// @brief Method get_Iv, addr 0x11a8a58, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Iv();

  /// @brief Method get_Ki, addr 0x11a89fc, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Ki();

  /// @brief Method get_R, addr 0x11a8abc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_R();

  /// @brief Method get_UseCounter, addr 0x11a8ab4, size 0x8, virtual false, abstract: false, final false
