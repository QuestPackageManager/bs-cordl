...
public:
  ...
  /// @brief Method CreateWithCounter, addr 0xfa7370, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWithoutCounter, addr 0xfa7450, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa7200, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FixedInputData, addr 0xfa75b0, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_FixedInputData();

  /// @brief Method get_Iv, addr 0xfa7544, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Iv();

  /// @brief Method get_Ki, addr 0xfa74e8, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Ki();

  /// @brief Method get_R, addr 0xfa75a8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_R();

  /// @brief Method get_UseCounter, addr 0xfa75a0, size 0x8, virtual false, abstract: false, final false
