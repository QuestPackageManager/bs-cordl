...
public:
  ...
  /// @brief Method GetDerivationV, addr 0x10a1db0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetDerivationV();

  /// @brief Method GetEncodingV, addr 0x10a1db8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10a1d74, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> derivation, ::ArrayW<uint8_t, ::Array<uint8_t>*> encoding, int32_t macKeySize);

  /// @brief Method get_MacKeySize, addr 0x10a1dc0, size 0x8, virtual false, abstract: false, final false
