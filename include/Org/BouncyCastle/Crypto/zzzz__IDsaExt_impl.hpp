...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::BigInteger* (::Org::BouncyCastle::Crypto::IDsaExt::*)()>(&::Org::BouncyCastle::Crypto::IDsaExt::get_Order)> {
