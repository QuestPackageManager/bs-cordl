...
public:
  ...
  /// @brief Method GetEnvelopedData, addr 0x36db578, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36d80a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArchiveType, addr 0x36db518, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_ArchiveType();

  /// @brief Method get_EnvelopedData, addr 0x36db534, size 0x44, virtual false, abstract: false, final false
  inline bool get_EnvelopedData();

  /// @brief Method get_Type, addr 0x36db4b4, size 0x5c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Type();

  /// @brief Method get_Value, addr 0x36db510, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkiArchiveControl", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkiArchiveControl(PkiArchiveControl&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkiArchiveControl", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkiArchiveControl(PkiArchiveControlconst&) = delete;
