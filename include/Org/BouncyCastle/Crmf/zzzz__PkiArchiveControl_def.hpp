...
public:
  ...
  /// @brief Method GetEnvelopedData, addr 0x2685cfc, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2682768, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArchiveType, addr 0x2685c98, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_ArchiveType();

  /// @brief Method get_EnvelopedData, addr 0x2685cb8, size 0x44, virtual false, abstract: false, final false
  inline bool get_EnvelopedData();

  /// @brief Method get_Type, addr 0x2685c38, size 0x58, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Type();

  /// @brief Method get_Value, addr 0x2685c90, size 0x8, virtual true, abstract: false, final true
