...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::ProofOfPossessionSigningKeyBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::ProofOfPossessionSigningKeyBuilder*, "Org.BouncyCastle.Crmf", "ProofOfPossessionSigningKeyBuilder");
...
public:
  ...
  /// @brief Method Build, addr 0x36d7a4c, size 0x5cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPublicKeyMac, addr 0x36d7590, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSender, addr 0x36d7588, size 0x8, virtual false, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Asn1::X509::GeneralName* const& __cordl_internal_get__name() const;

  constexpr ::Org::BouncyCastle::Asn1::X509::GeneralName*& __cordl_internal_get__name();

  constexpr ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* const& __cordl_internal_get__pubKeyInfo() const;

  constexpr ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo*& __cordl_internal_get__pubKeyInfo();

  constexpr ::Org::BouncyCastle::Asn1::Crmf::PKMacValue* const& __cordl_internal_get__publicKeyMAC() const;
  ...
  /// @brief Method .ctor, addr 0x36d8018, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::CertRequest* certRequest);

  /// @brief Method .ctor, addr 0x36d7580, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Crmf::ProofOfPossessionSigningKeyBuilder) == 0x30, "Size mismatch!");
