...
/// @brief Method .ctor, addr 0x35dbfb8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String*  token) ;

/// @brief Method .ctor, addr 0x35dbfc0, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::StringW  token) ;

static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* getStaticF_type() ;

/// @brief Method get_Type, addr 0x35dc02c, size 0x5c, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Type() ;

/// @brief Method get_Value, addr 0x35dc088, size 0x8, virtual true, abstract: false, final true
