...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::AuthenticatorControl*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::AuthenticatorControl*, "Org.BouncyCastle.Crmf", "AuthenticatorControl");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36d7bd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String* token);

  /// @brief Method .ctor, addr 0x36d7be0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW token);

  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* getStaticF_type();

  /// @brief Method get_Type, addr 0x36d7c4c, size 0x5c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Type();

  /// @brief Method get_Value, addr 0x36d7ca8, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AuthenticatorControl", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AuthenticatorControl(AuthenticatorControl&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AuthenticatorControl", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AuthenticatorControl(AuthenticatorControlconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crmf::AuthenticatorControl) == 0x18, "Size mismatch!");
