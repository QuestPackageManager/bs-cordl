...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::PkiArchiveControlBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::PkiArchiveControlBuilder*, "Org.BouncyCastle.Crmf", "PkiArchiveControlBuilder");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkiArchiveControlBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkiArchiveControlBuilder(PkiArchiveControlBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkiArchiveControlBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkiArchiveControlBuilder(PkiArchiveControlBuilderconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crmf::PkiArchiveControlBuilder) == 0x20, "Size mismatch!");
