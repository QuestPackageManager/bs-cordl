...
public:
  ...
  /// @brief Method Collect, addr 0x36d9b14, size 0x148, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> Collect();

  /// @brief Method Collect, addr 0x36d9c5c, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36d989c, size 0x8, virtual false, abstract: false, final false
