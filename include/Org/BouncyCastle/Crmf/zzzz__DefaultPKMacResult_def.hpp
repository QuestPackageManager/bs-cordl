...
public:
  ...
  /// @brief Method Collect, addr 0x265100c, size 0x148, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Collect();

  /// @brief Method Collect, addr 0x2651154, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2650d68, size 0x28, virtual false, abstract: false, final false
