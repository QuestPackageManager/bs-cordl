...
public:
  ...
  /// @brief Method Collect, addr 0x361c8c0, size 0x148, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Collect();

  /// @brief Method Collect, addr 0x361ca08, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x361c648, size 0x8, virtual false, abstract: false, final false
