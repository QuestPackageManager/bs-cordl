...
public:
  ...
  /// @brief Method Collect, addr 0x2682bd8, size 0x148, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Collect();

  /// @brief Method Collect, addr 0x2682d20, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2682934, size 0x28, virtual false, abstract: false, final false
