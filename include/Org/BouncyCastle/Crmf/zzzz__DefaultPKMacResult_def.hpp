...
public:
  ...
  /// @brief Method Collect, addr 0x36dbe9c, size 0x148, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> Collect();

  /// @brief Method Collect, addr 0x36dbfe4, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36dbc24, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultPKMacResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultPKMacResult(DefaultPKMacResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultPKMacResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultPKMacResult(DefaultPKMacResultconst&) = delete;
