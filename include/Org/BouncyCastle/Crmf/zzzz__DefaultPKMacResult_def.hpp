...
public:
  ...
  /// @brief Method Collect, addr 0x268aa48, size 0x148, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Collect();

  /// @brief Method Collect, addr 0x268ab90, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x268a7a4, size 0x28, virtual false, abstract: false, final false
