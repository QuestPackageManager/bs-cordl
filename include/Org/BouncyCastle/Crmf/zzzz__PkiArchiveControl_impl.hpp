...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crmf::PkiArchiveControl::*)(::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions*)>(&::Org::BouncyCastle::Crmf::PkiArchiveControl::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3619860;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::DerObjectIdentifier* (::Org::BouncyCastle::Crmf::PkiArchiveControl::*)()>(&::Org::BouncyCastle::Crmf::PkiArchiveControl::get_Type)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x361cc74;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::Asn1Encodable* (::Org::BouncyCastle::Crmf::PkiArchiveControl::*)()>(&::Org::BouncyCastle::Crmf::PkiArchiveControl::get_Value)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x361ccd0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Crmf::PkiArchiveControl::*)()>(&::Org::BouncyCastle::Crmf::PkiArchiveControl::get_ArchiveType)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x361ccd8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Org::BouncyCastle::Crmf::PkiArchiveControl::*)()>(&::Org::BouncyCastle::Crmf::PkiArchiveControl::get_EnvelopedData)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x361ccf4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Cms::CmsEnvelopedData* (::Org::BouncyCastle::Crmf::PkiArchiveControl::*)()>(&::Org::BouncyCastle::Crmf::PkiArchiveControl::GetEnvelopedData)> {
  constexpr static std::size_t size = 0x24c;
  constexpr static std::size_t addrs = 0x361cd38;
...
::cordl_internals::setStaticField<int32_t, "encryptedPrivKey", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crmf::PkiArchiveControl*>::get>(std::forward<int32_t>(value));
}
inline int32_t Org::BouncyCastle::Crmf::PkiArchiveControl::getStaticF_encryptedPrivKey()  {
return ::cordl_internals::getStaticField<int32_t, "encryptedPrivKey", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crmf::PkiArchiveControl*>::get>();
}
inline void Org::BouncyCastle::Crmf::PkiArchiveControl::setStaticF_keyGenParameters(int32_t  value)  {
::cordl_internals::setStaticField<int32_t, "keyGenParameters", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crmf::PkiArchiveControl*>::get>(std::forward<int32_t>(value));
}
inline int32_t Org::BouncyCastle::Crmf::PkiArchiveControl::getStaticF_keyGenParameters()  {
return ::cordl_internals::getStaticField<int32_t, "keyGenParameters", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crmf::PkiArchiveControl*>::get>();
}
inline void Org::BouncyCastle::Crmf::PkiArchiveControl::setStaticF_archiveRemGenPrivKey(int32_t  value)  {
::cordl_internals::setStaticField<int32_t, "archiveRemGenPrivKey", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crmf::PkiArchiveControl*>::get>(std::forward<int32_t>(value));
}
inline int32_t Org::BouncyCastle::Crmf::PkiArchiveControl::getStaticF_archiveRemGenPrivKey()  {
return ::cordl_internals::getStaticField<int32_t, "archiveRemGenPrivKey", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crmf::PkiArchiveControl*>::get>();
}
inline void Org::BouncyCastle::Crmf::PkiArchiveControl::setStaticF_type(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  value)  {
::cordl_internals::setStaticField<::Org::BouncyCastle::Asn1::DerObjectIdentifier*, "type", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crmf::PkiArchiveControl*>::get>(std::forward<::Org::BouncyCastle::Asn1::DerObjectIdentifier*>(value));
}
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Org::BouncyCastle::Crmf::PkiArchiveControl::getStaticF_type()  {
return ::cordl_internals::getStaticField<::Org::BouncyCastle::Asn1::DerObjectIdentifier*, "type", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crmf::PkiArchiveControl*>::get>();
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, pkiArchiveOptions);
}
