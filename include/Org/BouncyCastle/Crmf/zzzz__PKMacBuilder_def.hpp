...
public:
  ...
  /// @brief Method Build, addr 0x12a8ff8, size 0x114, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IMacFactory* Build(::ArrayW<char16_t, ::Array<char16_t>*> password);

  /// @brief Method CheckIterationCountCeiling, addr 0x12a8dc4, size 0x1d8, virtual false, abstract: false, final false
  inline void CheckIterationCountCeiling(int32_t iterationCount);

  /// @brief Method GenCalculator, addr 0x12a910c, size 0x418, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIterationCount, addr 0x12a8d48, size 0x7c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetIterationCount(int32_t iterationCount);

  /// @brief Method SetParameters, addr 0x12a8f9c, size 0x54, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetParameters(::Org::BouncyCastle::Asn1::Cmp::PbmParameter* parameters);

  /// @brief Method SetSaltLength, addr 0x12a8ce4, size 0x64, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetSaltLength(int32_t saltLength);

  /// @brief Method SetSecureRandom, addr 0x12a8ff0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a8954, size 0x174, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12a8ac8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a8b14, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crmf::IPKMacPrimitivesProvider* provider);

  /// @brief Method .ctor, addr 0x12a8c60, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a8cac, size 0x38, virtual false, abstract: false, final false
