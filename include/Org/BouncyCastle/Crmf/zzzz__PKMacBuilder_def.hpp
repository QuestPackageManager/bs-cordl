...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::PKMacBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::PKMacBuilder*, "Org.BouncyCastle.Crmf", "PKMacBuilder");
...
public:
  ...
  /// @brief Method Build, addr 0x36dc594, size 0x11c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IMacFactory* Build(::ArrayW<char16_t> password);

  /// @brief Method CheckIterationCountCeiling, addr 0x36dc39c, size 0x19c, virtual false, abstract: false, final false
  inline void CheckIterationCountCeiling(int32_t iterationCount);

  /// @brief Method GenCalculator, addr 0x36dc6b0, size 0x420, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::IMacFactory* GenCalculator(::Org::BouncyCastle::Asn1::Cmp::PbmParameter* parameters, ::ArrayW<char16_t> password);
  ...
  /// @brief Method SetIterationCount, addr 0x36dc324, size 0x78, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetIterationCount(int32_t iterationCount);

  /// @brief Method SetParameters, addr 0x36dc538, size 0x54, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetParameters(::Org::BouncyCastle::Asn1::Cmp::PbmParameter* parameters);

  /// @brief Method SetSaltLength, addr 0x36dc2c8, size 0x5c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetSaltLength(int32_t saltLength);

  /// @brief Method SetSecureRandom, addr 0x36dc58c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36dc024, size 0x140, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36dc164, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36dc178, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crmf::IPKMacPrimitivesProvider* provider);

  /// @brief Method .ctor, addr 0x36dc2a0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36dc2b8, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PKMacBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PKMacBuilder(PKMacBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PKMacBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PKMacBuilder(PKMacBuilderconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Crmf::PKMacBuilder) == 0x48, "Size mismatch!");
