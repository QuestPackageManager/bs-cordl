...
public:
  ...
  /// @brief Method CreateCalculator, addr 0x147a170, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x147a058, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key, ::Org::BouncyCastle::Asn1::Cmp::PbmParameter* parameters);

  /// @brief Method get_AlgorithmDetails, addr 0x147a0d4, size 0x9c, virtual true, abstract: false, final false
