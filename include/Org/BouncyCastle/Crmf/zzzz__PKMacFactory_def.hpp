...
public:
  ...
  /// @brief Method CreateCalculator, addr 0x35e01b8, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35e00bc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key, ::Org::BouncyCastle::Asn1::Cmp::PbmParameter* parameters);

  /// @brief Method get_AlgorithmDetails, addr 0x35e0130, size 0x88, virtual true, abstract: false, final false
