...
public:
  ...
  /// @brief Method CreateDigest, addr 0x361ae90, size 0x7c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IDigest* CreateDigest(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* digestAlg);

  /// @brief Method CreateMac, addr 0x361af0c, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x361af88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
