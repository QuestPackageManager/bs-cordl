...
public:
  ...
  /// @brief Method CreateDigest, addr 0x36da46c, size 0x7c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Crypto::IDigest* CreateDigest(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* digestAlg);

  /// @brief Method CreateMac, addr 0x36da4e8, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36da564, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultPKMacPrimitivesProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultPKMacPrimitivesProvider(DefaultPKMacPrimitivesProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultPKMacPrimitivesProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultPKMacPrimitivesProvider(DefaultPKMacPrimitivesProviderconst&) = delete;
