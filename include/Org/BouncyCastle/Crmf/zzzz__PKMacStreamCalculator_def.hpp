...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PKMacStreamCalculator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PKMacStreamCalculator(PKMacStreamCalculator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PKMacStreamCalculator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PKMacStreamCalculator(PKMacStreamCalculatorconst&) = delete;
