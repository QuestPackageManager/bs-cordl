...
public:
  ...
  /// @brief Method GetResult, addr 0x361c5d4, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x361c560, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* mac);

  /// @brief Method get_Stream, addr 0x361c5cc, size 0x8, virtual true, abstract: false, final true
