...
public:
  ...
  /// @brief Method GetResult, addr 0x2686364, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26862e8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* mac);

  /// @brief Method get_Stream, addr 0x268635c, size 0x8, virtual true, abstract: false, final true
