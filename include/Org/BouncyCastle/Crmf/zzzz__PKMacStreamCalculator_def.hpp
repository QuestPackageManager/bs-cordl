...
public:
  ...
  /// @brief Method GetResult, addr 0x26869ec, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2686970, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IMac* mac);

  /// @brief Method get_Stream, addr 0x26869e4, size 0x8, virtual true, abstract: false, final true
