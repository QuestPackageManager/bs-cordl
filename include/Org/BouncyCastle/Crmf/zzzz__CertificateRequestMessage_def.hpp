...
/// @brief Method FindControl, addr 0x36195c0, size 0xa8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue* FindControl(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  type) ;

/// @brief Method GetCertTemplate, addr 0x3619568, size 0x30, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Crmf::CertTemplate* GetCertTemplate() ;

/// @brief Method GetControl, addr 0x3619668, size 0x1f8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crmf::IControl* GetControl(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  type) ;

/// @brief Method GetEncoded, addr 0x3619fe0, size 0x18, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method HasControl, addr 0x36195a8, size 0x18, virtual false, abstract: false, final false
inline bool HasControl(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  objectIdentifier) ;

/// @brief Method IsValidSigningKeyPop, addr 0x36199b0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method ParseBytes, addr 0x36194f0, size 0x8, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Crmf::CertReqMsg* ParseBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  encoding) ;

/// @brief Method ToAsn1Structure, addr 0x3619560, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x361951c, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::CertReqMsg*  certReqMsg) ;

/// @brief Method .ctor, addr 0x36194f8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get_HasControls, addr 0x3619598, size 0x10, virtual false, abstract: false, final false
inline bool get_HasControls() ;

/// @brief Method get_HasProofOfPossession, addr 0x3619870, size 0x2c, virtual false, abstract: false, final false
inline bool get_HasProofOfPossession() ;

/// @brief Method get_HasSigningKeyProofOfPossessionWithPkMac, addr 0x36198cc, size 0xe4, virtual false, abstract: false, final false
inline bool get_HasSigningKeyProofOfPossessionWithPkMac() ;

/// @brief Method get_ProofOfPossession, addr 0x361989c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method verifySignature, addr 0x3619b20, size 0x44c, virtual false, abstract: false, final false
