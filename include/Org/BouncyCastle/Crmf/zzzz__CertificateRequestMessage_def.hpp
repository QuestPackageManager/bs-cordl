...
public:
  ...
  /// @brief Method ParseBytes addr 0x119ccb0 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x119ccb8 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x119ccdc size 0x54 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::CertReqMsg* certReqMsg);

  /// @brief Method ToAsn1Structure addr 0x119cd30 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertReqMsg* ToAsn1Structure();

  /// @brief Method GetCertTemplate addr 0x119cd38 size 0x30 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertTemplate* GetCertTemplate();

  /// @brief Method get_HasControls addr 0x119cd68 size 0x10 virtual false final false
  inline bool get_HasControls();

  /// @brief Method HasControl addr 0x119cd78 size 0x18 virtual false final false
  inline bool HasControl(::Org::BouncyCastle::Asn1::DerObjectIdentifier* objectIdentifier);

  /// @brief Method GetControl addr 0x119ce40 size 0x1d8 virtual false final false
  inline ::Org::BouncyCastle::Crmf::IControl* GetControl(::Org::BouncyCastle::Asn1::DerObjectIdentifier* type);

  /// @brief Method FindControl addr 0x119cd90 size 0xb0 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue* FindControl(::Org::BouncyCastle::Asn1::DerObjectIdentifier* type);

  /// @brief Method get_HasProofOfPossession addr 0x119d068 size 0x2c virtual false final false
  inline bool get_HasProofOfPossession();

  /// @brief Method get_ProofOfPossession addr 0x119d094 size 0x30 virtual false final false
  inline int32_t get_ProofOfPossession();

  /// @brief Method get_HasSigningKeyProofOfPossessionWithPkMac addr 0x119d0c4 size 0xe0 virtual false final false
  inline bool get_HasSigningKeyProofOfPossessionWithPkMac();

  /// @brief Method IsValidSigningKeyPop addr 0x119d1a4 size 0x174 virtual false final false
  inline bool IsValidSigningKeyPop(::Org::BouncyCastle::Crypto::IVerifierFactoryProvider* verifierProvider);

  /// @brief Method verifySignature addr 0x119d318 size 0x440 virtual false final false
  ...
  /// @brief Method GetEncoded addr 0x119d7c8 size 0x1c virtual false final false
