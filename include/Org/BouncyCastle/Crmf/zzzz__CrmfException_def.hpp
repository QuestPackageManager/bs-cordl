...
public:
  ...
  /// @brief Method .ctor addr 0x119f44c size 0x58 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Crmf::CrmfException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x119f4a4 size 0x68 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::Org::BouncyCastle::Crmf::CrmfException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor addr 0x119d758 size 0x70 virtual false final false
