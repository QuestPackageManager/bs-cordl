...
public:
  ...
  /// @brief Method .ctor, addr 0x26851d4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x268522c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2683520, size 0x70, virtual false, abstract: false, final false
