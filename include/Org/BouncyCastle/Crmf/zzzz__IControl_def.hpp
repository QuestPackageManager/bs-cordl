...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Crmf::IControl*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Crmf::IControl*, "Org.BouncyCastle.Crmf", "IControl");
// Dependencies
namespace Org::BouncyCastle::Crmf {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IControl", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IControl(IControlconst&) = delete;
