...
public:
  ...
  /// @brief Method Build, addr 0x14748e4, size 0x144, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* Build(::Org::BouncyCastle::X509::X509Certificate* holder);

  /// @brief Method Build, addr 0x1474a28, size 0x5b4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* Build(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privateKeyInfo);

  /// @brief Method Build, addr 0x14740cc, size 0x30, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* Build(::ArrayW<char16_t, ::Array<char16_t>*> revocationPassphrase);

  /// @brief Method EncryptData, addr 0x14741b0, size 0x734, virtual false, abstract: false, final false
  ...
  /// @brief Method PadData, addr 0x14740fc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1474060, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IKeyWrapper* wrapper, ::Org::BouncyCastle::Crypto::ICipherBuilderWithKey* encryptor);

  /// @brief Method .ctor, addr 0x1474090, size 0x3c, virtual false, abstract: false, final false
