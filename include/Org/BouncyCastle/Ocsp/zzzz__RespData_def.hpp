...
/// @brief Method GetResponderId, addr 0x347ef00, size 0x60, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Ocsp::RespID* GetResponderId() ;

/// @brief Method GetResponses, addr 0x347ef84, size 0x130, virtual false, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Ocsp::SingleResp*,::Array<::Org::BouncyCastle::Ocsp::SingleResp*>*> GetResponses() ;

/// @brief Method GetX509Extensions, addr 0x347f0cc, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3476870, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::ResponseData*  data) ;

/// @brief Method get_ProducedAt, addr 0x347ef60, size 0x24, virtual false, abstract: false, final false
inline ::System::DateTime get_ProducedAt() ;

/// @brief Method get_ResponseExtensions, addr 0x347f0b4, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_ResponseExtensions() ;

/// @brief Method get_Version, addr 0x347eed4, size 0x2c, virtual false, abstract: false, final false
