...
public:
  ...
  /// @brief Method GetResponderId, addr 0x1305374, size 0x70, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::RespID* GetResponderId();

  /// @brief Method GetResponses, addr 0x1305408, size 0x138, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Ocsp::SingleResp*, ::Array<::Org::BouncyCastle::Ocsp::SingleResp*>*> GetResponses();

  /// @brief Method GetX509Extensions, addr 0x130555c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12fcb8c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::ResponseData* data);

  /// @brief Method get_ProducedAt, addr 0x13053e4, size 0x24, virtual false, abstract: false, final false
  inline ::System::DateTime get_ProducedAt();

  /// @brief Method get_ResponseExtensions, addr 0x1305540, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_ResponseExtensions();

  /// @brief Method get_Version, addr 0x1305348, size 0x2c, virtual false, abstract: false, final false
