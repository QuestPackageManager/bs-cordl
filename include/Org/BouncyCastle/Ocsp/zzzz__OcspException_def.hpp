...
public:
  ...
  /// @brief Method .ctor, addr 0x251b9a8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x251ba00, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2518328, size 0x70, virtual false, abstract: false, final false
