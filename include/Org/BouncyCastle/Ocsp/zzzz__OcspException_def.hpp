...
public:
  ...
  /// @brief Method .ctor addr 0x102e334 size 0x58 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Ocsp::OcspException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x102e38c size 0x68 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::Org::BouncyCastle::Ocsp::OcspException* New_ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor addr 0x102ab90 size 0x70 virtual false final false
