...
public:
  ...
  /// @brief Method .ctor, addr 0x251f418, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x251f470, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x251bd98, size 0x70, virtual false, abstract: false, final false
