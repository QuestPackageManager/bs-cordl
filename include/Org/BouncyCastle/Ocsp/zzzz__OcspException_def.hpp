...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OcspException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OcspException(OcspException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OcspException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OcspException(OcspExceptionconst&) = delete;
