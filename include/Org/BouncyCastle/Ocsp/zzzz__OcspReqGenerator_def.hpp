...
public:
  ...
  /// @brief Method ToRequest, addr 0x345142c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345061c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddRequest, addr 0x345053c, size 0xe0, virtual false, abstract: false, final false
  inline void AddRequest(::Org::BouncyCastle::Ocsp::CertificateID* certId);

  /// @brief Method AddRequest, addr 0x3450624, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x34514a4, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::OcspReq* Generate();

  /// @brief Method Generate, addr 0x34514b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x34514c0, size 0x1ac, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::OcspReq* Generate(::StringW signingAlgorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey,
                                                      ::ArrayW<::Org::BouncyCastle::X509::X509Certificate*, ::Array<::Org::BouncyCastle::X509::X509Certificate*>*> chain,
                                                      ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method GenerateRequest, addr 0x3450840, size 0xbec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRequestExtensions, addr 0x3450838, size 0x8, virtual false, abstract: false, final false
  inline void SetRequestExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions* requestExtensions);

  /// @brief Method SetRequestorName, addr 0x3450830, size 0x8, virtual false, abstract: false, final false
  inline void SetRequestorName(::Org::BouncyCastle::Asn1::X509::GeneralName* requestorName);

  /// @brief Method SetRequestorName, addr 0x3450708, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34518d8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAlgNames, addr 0x3451888, size 0x50, virtual false, abstract: false, final false
