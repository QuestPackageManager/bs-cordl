...
public:
  ...
  /// @brief Method ToRequest, addr 0x1302028, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13011c0, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddRequest, addr 0x13010dc, size 0xe4, virtual false, abstract: false, final false
  inline void AddRequest(::Org::BouncyCastle::Ocsp::CertificateID* certId);

  /// @brief Method AddRequest, addr 0x13011ec, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x13020a0, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::OcspReq* Generate();

  /// @brief Method Generate, addr 0x13020b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x13020bc, size 0x1b0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::OcspReq* Generate(::StringW signingAlgorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* privateKey,
                                                      ::ArrayW<::Org::BouncyCastle::X509::X509Certificate*, ::Array<::Org::BouncyCastle::X509::X509Certificate*>*> chain,
                                                      ::Org::BouncyCastle::Security::SecureRandom* random);

  /// @brief Method GenerateRequest, addr 0x130141c, size 0xc0c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRequestExtensions, addr 0x1301414, size 0x8, virtual false, abstract: false, final false
  inline void SetRequestExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions* requestExtensions);

  /// @brief Method SetRequestorName, addr 0x130140c, size 0x8, virtual false, abstract: false, final false
  inline void SetRequestorName(::Org::BouncyCastle::Asn1::X509::GeneralName* requestorName);

  /// @brief Method SetRequestorName, addr 0x13012d4, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13024c4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SignatureAlgNames, addr 0x1302478, size 0x4c, virtual false, abstract: false, final false
