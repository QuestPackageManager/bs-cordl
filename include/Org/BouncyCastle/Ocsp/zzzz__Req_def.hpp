...
public:
  ...
  /// @brief Method GetCertID, addr 0x35786d0, size 0x6c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::CertificateID* GetCertID();

  /// @brief Method GetX509Extensions, addr 0x3578754, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35737e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::Request* req);

  /// @brief Method get_SingleRequestExtensions, addr 0x357873c, size 0x18, virtual false, abstract: false, final false
