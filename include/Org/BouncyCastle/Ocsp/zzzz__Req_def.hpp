...
public:
  ...
  /// @brief Method GetCertID, addr 0x25248a4, size 0x68, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::CertificateID* GetCertID();

  /// @brief Method GetX509Extensions, addr 0x2524928, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x251f9ec, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::Request* req);

  /// @brief Method get_SingleRequestExtensions, addr 0x252490c, size 0x1c, virtual false, abstract: false, final false
