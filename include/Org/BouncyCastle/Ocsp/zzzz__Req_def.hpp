...
public:
  ...
  /// @brief Method GetCertID, addr 0x24e4180, size 0x68, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Ocsp::CertificateID* GetCertID();

  /// @brief Method GetX509Extensions, addr 0x24e4204, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24df2c8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::Request* req);

  /// @brief Method get_SingleRequestExtensions, addr 0x24e41e8, size 0x1c, virtual false, abstract: false, final false
