...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Req", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Req(Req&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Req", modifiers: "const&", def_value: None, comment: None }]
