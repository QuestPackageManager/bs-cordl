...
public:
// Declarations
/// @brief Method Generate, addr 0x347c5c8, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x347c8b8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
