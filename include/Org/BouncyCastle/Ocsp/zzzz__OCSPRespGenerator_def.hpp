...
public:
  // Declarations
  /// @brief Method Generate, addr 0x11377ac, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1137ac4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
