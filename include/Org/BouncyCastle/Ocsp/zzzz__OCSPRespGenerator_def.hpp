...
public:
  // Declarations
  /// @brief Method Generate, addr 0x25220dc, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25223c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
