...
public:
  // Declarations
  /// @brief Method Generate, addr 0x11130a8, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11133c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
