...
public:
  ...
  /// @brief Method .ctor, addr 0x10cc4d4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cc4fc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cc6c0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cc570, size 0x150, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1InputStream* aIn);

  /// @brief Method GetTbsRequest, addr 0x10cc734, size 0xf8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetTbsRequest();

  /// @brief Method get_Version, addr 0x10cc82c, size 0x34, virtual false, abstract: false, final false
  inline int32_t get_Version();

  /// @brief Method get_RequestorName, addr 0x10cc860, size 0x28, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_RequestorName();

  /// @brief Method GetRequestList, addr 0x10cc888, size 0x140, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Ocsp::Req*, ::Array<::Org::BouncyCastle::Ocsp::Req*>*> GetRequestList();

  /// @brief Method get_RequestExtensions, addr 0x10cc9f0, size 0x70, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions();

  /// @brief Method GetX509Extensions, addr 0x10cca60, size 0x4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* GetX509Extensions();

  /// @brief Method get_SignatureAlgOid, addr 0x10cca64, size 0x44, virtual false, abstract: false, final false
  inline ::StringW get_SignatureAlgOid();

  /// @brief Method GetSignature, addr 0x10ccacc, size 0x2c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSignature();

  /// @brief Method GetCertList, addr 0x10ccaf8, size 0x4d8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetCertList();

  /// @brief Method GetCerts, addr 0x10ccfd0, size 0x29c, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::X509::X509Certificate*, ::Array<::Org::BouncyCastle::X509::X509Certificate*>*> GetCerts();

  /// @brief Method GetCertificates, addr 0x10cd26c, size 0x190, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates(::StringW type);

  /// @brief Method get_IsSigned, addr 0x10ccaa8, size 0x24, virtual false, abstract: false, final false
  inline bool get_IsSigned();

  /// @brief Method Verify, addr 0x10cd3fc, size 0x348, virtual false, abstract: false, final false
  inline bool Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* publicKey);

  /// @brief Method GetEncoded, addr 0x10cd744, size 0x1c, virtual false, abstract: false, final false
