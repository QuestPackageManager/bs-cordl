...
public:
  ...
  /// @brief Method GetCertList, addr 0x120fd50, size 0x4d8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetCertList();

  /// @brief Method GetCertificates, addr 0x12104c4, size 0x190, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates(::StringW type);

  /// @brief Method GetCerts, addr 0x1210228, size 0x29c, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::X509::X509Certificate*, ::Array<::Org::BouncyCastle::X509::X509Certificate*>*> GetCerts();

  /// @brief Method GetEncoded, addr 0x121099c, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetRequestList, addr 0x120fae0, size 0x140, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Ocsp::Req*, ::Array<::Org::BouncyCastle::Ocsp::Req*>*> GetRequestList();

  /// @brief Method GetSignature, addr 0x120fd24, size 0x2c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSignature();

  /// @brief Method GetTbsRequest, addr 0x120f98c, size 0xf8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetTbsRequest();

  /// @brief Method GetX509Extensions, addr 0x120fcb8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method Verify, addr 0x1210654, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x120f7c8, size 0x150, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1InputStream* aIn);

  /// @brief Method .ctor, addr 0x120f918, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStr);

  /// @brief Method .ctor, addr 0x120f754, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> req);

  /// @brief Method .ctor, addr 0x120f72c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::OcspRequest* req);

  /// @brief Method get_IsSigned, addr 0x120fd00, size 0x24, virtual false, abstract: false, final false
  inline bool get_IsSigned();

  /// @brief Method get_RequestExtensions, addr 0x120fc48, size 0x70, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions();

  /// @brief Method get_RequestorName, addr 0x120fab8, size 0x28, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_RequestorName();

  /// @brief Method get_SignatureAlgOid, addr 0x120fcbc, size 0x44, virtual false, abstract: false, final false
  inline ::StringW get_SignatureAlgOid();

  /// @brief Method get_Version, addr 0x120fa84, size 0x34, virtual false, abstract: false, final false
