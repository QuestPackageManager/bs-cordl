...
public:
  ...
  /// @brief Method GetAlgorithmName, addr 0x25204fc, size 0x198, virtual false, abstract: false, final false
  static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetAlgorithmOid, addr 0x2525c94, size 0x208, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW algorithmName);

  /// @brief Method GetSigAlgID, addr 0x25229c0, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2528c5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AlgNames, addr 0x2522cb0, size 0x108, virtual false, abstract: false, final false
