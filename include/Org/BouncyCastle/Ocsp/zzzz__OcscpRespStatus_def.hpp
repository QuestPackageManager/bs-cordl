...
public:
  ...
  /// @brief Method .ctor, addr 0x35784e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OcscpRespStatus", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OcscpRespStatus(OcscpRespStatus&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OcscpRespStatus", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OcscpRespStatus(OcscpRespStatusconst&) = delete;
