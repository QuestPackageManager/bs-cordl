...
/// @brief Method GetCertID, addr 0x347f388, size 0x6c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Ocsp::CertificateID* GetCertID() ;

/// @brief Method GetCertStatus, addr 0x347f3f4, size 0xc8, virtual false, abstract: false, final false
inline ::System::Object* GetCertStatus() ;

/// @brief Method GetX509Extensions, addr 0x347f5c4, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34765a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::SingleResponse*  resp) ;

/// @brief Method get_NextUpdate, addr 0x347f538, size 0x74, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_NextUpdate() ;

/// @brief Method get_SingleExtensions, addr 0x347f5ac, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_SingleExtensions() ;

/// @brief Method get_ThisUpdate, addr 0x347f514, size 0x24, virtual false, abstract: false, final false
