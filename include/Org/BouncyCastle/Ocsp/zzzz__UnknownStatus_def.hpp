...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::UnknownStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::UnknownStatus*, "Org.BouncyCastle.Ocsp", "UnknownStatus");
...
public:
  ...
  /// @brief Method .ctor, addr 0x357b0dc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnknownStatus", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnknownStatus(UnknownStatus&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnknownStatus", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnknownStatus(UnknownStatusconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::UnknownStatus) == 0x10, "Size mismatch!");
