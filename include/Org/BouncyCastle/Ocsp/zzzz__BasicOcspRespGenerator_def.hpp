...
static inline ::Org::BouncyCastle::Ocsp::BasicOcspRespGenerator_ResponseObject* New_ctor(::Org::BouncyCastle::Ocsp::CertificateID*  certId, ::Org::BouncyCastle::Ocsp::CertificateStatus*  certStatus, ::Org::BouncyCastle::Asn1::DerGeneralizedTime*  thisUpdate, ::Org::BouncyCastle::Asn1::DerGeneralizedTime*  nextUpdate, ::Org::BouncyCastle::Asn1::X509::X509Extensions*  extensions) ;

static inline ::Org::BouncyCastle::Ocsp::BasicOcspRespGenerator_ResponseObject* New_ctor(::Org::BouncyCastle::Ocsp::CertificateID*  certId, ::Org::BouncyCastle::Ocsp::CertificateStatus*  certStatus, ::System::DateTime  thisUpdate, ::Org::BouncyCastle::Asn1::X509::X509Extensions*  extensions) ;

static inline ::Org::BouncyCastle::Ocsp::BasicOcspRespGenerator_ResponseObject* New_ctor(::Org::BouncyCastle::Ocsp::CertificateID*  certId, ::Org::BouncyCastle::Ocsp::CertificateStatus*  certStatus, ::System::DateTime  thisUpdate, ::System::DateTime  nextUpdate, ::Org::BouncyCastle::Asn1::X509::X509Extensions*  extensions) ;

/// @brief Method ToResponse, addr 0x3478b14, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3478f90, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3477a04, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3477d10, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method AddResponse, addr 0x34778d8, size 0x12c, virtual false, abstract: false, final false
inline void AddResponse(::Org::BouncyCastle::Ocsp::CertificateID*  certID, ::Org::BouncyCastle::Ocsp::CertificateStatus*  certStatus) ;

/// @brief Method AddResponse, addr 0x3477bd0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method AddResponse, addr 0x3477a98, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method AddResponse, addr 0x3477dc8, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x3478dd8, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x3478cec, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x3478ce4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GenerateResponse, addr 0x3477ee4, size 0xc30, virtual false, abstract: false, final false
...
/// @brief Method SetResponseExtensions, addr 0x3477edc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x347763c, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey) ;

/// @brief Method .ctor, addr 0x34775cc, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Ocsp::RespID*  responderID) ;

/// @brief Method get_SignatureAlgNames, addr 0x3478e2c, size 0x50, virtual false, abstract: false, final false
