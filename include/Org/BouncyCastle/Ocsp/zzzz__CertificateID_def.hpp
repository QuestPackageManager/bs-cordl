...
public:
  ...
  /// @brief Method CreateCertID, addr 0x24de778, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method DeriveCertificateID, addr 0x24debfc, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x24deaf4, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x24debd0, size 0x2c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetIssuerKeyHash, addr 0x24dea6c, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIssuerKeyHash();

  /// @brief Method GetIssuerNameHash, addr 0x24dea44, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIssuerNameHash();

  /// @brief Method MatchesIssuer, addr 0x24deab8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24deaec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24de650, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24de5dc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::CertID* id);

  /// @brief Method get_HashAlgOid, addr 0x24dea10, size 0x34, virtual false, abstract: false, final false
  inline ::StringW get_HashAlgOid();

  /// @brief Method get_SerialNumber, addr 0x24dea94, size 0x24, virtual false, abstract: false, final false
