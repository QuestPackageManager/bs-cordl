...
public:
  ...
  /// @brief Method CreateCertID, addr 0x34794bc, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method DeriveCertificateID, addr 0x347993c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x3479828, size 0xe8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x3479910, size 0x2c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetIssuerKeyHash, addr 0x34797a0, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIssuerKeyHash();

  /// @brief Method GetIssuerNameHash, addr 0x3479778, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIssuerNameHash();

  /// @brief Method MatchesIssuer, addr 0x34797ec, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3479820, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34793a4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x347934c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::CertID* id);

  /// @brief Method get_HashAlgOid, addr 0x3479744, size 0x34, virtual false, abstract: false, final false
  inline ::StringW get_HashAlgOid();

  /// @brief Method get_SerialNumber, addr 0x34797c8, size 0x24, virtual false, abstract: false, final false
