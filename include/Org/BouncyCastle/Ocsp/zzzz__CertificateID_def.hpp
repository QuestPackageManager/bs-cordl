...
public:
  ...
  /// @brief Method .ctor addr 0x102db98 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x102dc10 size 0x130 virtual false final false
  ...
  /// @brief Method get_HashAlgOid addr 0x102e004 size 0x34 virtual false final false
  inline ::StringW get_HashAlgOid();

  /// @brief Method GetIssuerNameHash addr 0x102e038 size 0x28 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIssuerNameHash();

  /// @brief Method GetIssuerKeyHash addr 0x102e060 size 0x28 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIssuerKeyHash();

  /// @brief Method get_SerialNumber addr 0x102e088 size 0x24 virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber();

  /// @brief Method MatchesIssuer addr 0x102e0ac size 0x34 virtual false final false
  inline bool MatchesIssuer(::Org::BouncyCastle::X509::X509Certificate* issuerCert);

  /// @brief Method ToAsn1Object addr 0x102e0e0 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::CertID* ToAsn1Object();

  /// @brief Method Equals addr 0x102e0e8 size 0xdc virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x102e1c4 size 0x2c virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method DeriveCertificateID addr 0x102e1f0 size 0xf4 virtual false final false
  ...
  /// @brief Method CreateCertID addr 0x102dd40 size 0x2c4 virtual false final false
