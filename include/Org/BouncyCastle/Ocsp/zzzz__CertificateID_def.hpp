...
public:
  ...
  /// @brief Method CreateCertID, addr 0x24e9820, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method DeriveCertificateID, addr 0x24e9ca4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x24e9b9c, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x24e9c78, size 0x2c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetIssuerKeyHash, addr 0x24e9b14, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIssuerKeyHash();

  /// @brief Method GetIssuerNameHash, addr 0x24e9aec, size 0x28, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIssuerNameHash();

  /// @brief Method MatchesIssuer, addr 0x24e9b60, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24e9b94, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24e96f8, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24e9684, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::CertID* id);

  /// @brief Method get_HashAlgOid, addr 0x24e9ab8, size 0x34, virtual false, abstract: false, final false
  inline ::StringW get_HashAlgOid();

  /// @brief Method get_SerialNumber, addr 0x24e9b3c, size 0x24, virtual false, abstract: false, final false
