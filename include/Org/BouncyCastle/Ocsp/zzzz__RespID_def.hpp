...
public:
  ...
  /// @brief Method Equals, addr 0x2524be8, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2524c98, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2524be0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x251bee0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::ResponderID* id);

  /// @brief Method .ctor, addr 0x2524b6c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* name);

  /// @brief Method .ctor, addr 0x251d1c0, size 0x1f0, virtual false, abstract: false, final false
