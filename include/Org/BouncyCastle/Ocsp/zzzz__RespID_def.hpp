...
public:
  ...
  /// @brief Method Equals, addr 0x347f208, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x347f2c0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x347f200, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34764f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::ResponderID* id);

  /// @brief Method .ctor, addr 0x347f194, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* name);

  /// @brief Method .ctor, addr 0x347778c, size 0x1fc, virtual false, abstract: false, final false
