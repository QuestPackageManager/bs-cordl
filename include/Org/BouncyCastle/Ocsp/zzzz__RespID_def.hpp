...
public:
  ...
  /// @brief Method Equals, addr 0x34549c4, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x3454a7c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x34549bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344bcb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::ResponderID* id);

  /// @brief Method .ctor, addr 0x3454950, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* name);

  /// @brief Method .ctor, addr 0x344cf48, size 0x1fc, virtual false, abstract: false, final false
