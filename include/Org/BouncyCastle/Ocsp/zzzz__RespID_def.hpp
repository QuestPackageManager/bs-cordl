...
public:
  ...
  /// @brief Method Equals, addr 0x2522858, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2522908, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2522850, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2519b50, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::ResponderID* id);

  /// @brief Method .ctor, addr 0x25227dc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* name);

  /// @brief Method .ctor, addr 0x251ae30, size 0x1f0, virtual false, abstract: false, final false
