...
public:
  ...
  /// @brief Method .ctor, addr 0x10d1d4c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d1db8, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime revocationDate, int32_t reason);

  /// @brief Method get_RevocationTime, addr 0x10cbc54, size 0x24, virtual false, abstract: false, final false
  inline ::System::DateTime get_RevocationTime();

  /// @brief Method get_HasRevocationReason, addr 0x10cbbc0, size 0x24, virtual false, abstract: false, final false
  inline bool get_HasRevocationReason();

  /// @brief Method get_RevocationReason, addr 0x10cbbe4, size 0x70, virtual false, abstract: false, final false
