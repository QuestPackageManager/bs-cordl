...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Ocsp::RevokedStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Ocsp::RevokedStatus*, "Org.BouncyCastle.Ocsp", "RevokedStatus");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RevokedStatus", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RevokedStatus(RevokedStatus&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RevokedStatus", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RevokedStatus(RevokedStatusconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Ocsp::RevokedStatus) == 0x18, "Size mismatch!");
