...
template <typename TItem, typename TPriority>
  requires(::cordl_internals::type_constraint<TPriority, ::System::IComparable_1<TPriority>*>)
inline void Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::AddToNodeCache(/* [Nullable(new[] { 1, 0, 0 })] */ ::Priority_Queue::SimplePriorityQueue_2_SimpleNode<TItem, TPriority>* node) {
  static auto* ___internal_method =
...
template <typename TItem, typename TPriority>
  requires(::cordl_internals::type_constraint<TPriority, ::System::IComparable_1<TPriority>*>)
inline void
Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::RemoveFromNodeCache(/* [Nullable(new[] { 1, 0, 0 })] */ ::Priority_Queue::SimplePriorityQueue_2_SimpleNode<TItem, TPriority>* node) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>*>(),
...
template <typename TItem, typename TPriority>
  requires(::cordl_internals::type_constraint<TPriority, ::System::IComparable_1<TPriority>*>)
inline bool Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::TryFirst(::by_ref<TItem> first) {
  static auto* ___internal_method =
...
template <typename TItem, typename TPriority>
  requires(::cordl_internals::type_constraint<TPriority, ::System::IComparable_1<TPriority>*>)
inline bool Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::TryDequeue(::by_ref<TItem> first) {
...
template <typename TItem, typename TPriority>
  requires(::cordl_internals::type_constraint<TPriority, ::System::IComparable_1<TPriority>*>)
inline bool Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::TryGetPriority(TItem item, /* [Nullable(2)] [NotNullWhen(true)] */ ::by_ref<TPriority> priority) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>*>(),
