...
public:
  ...
  /// @brief Method .ctor, addr 0x330d610, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Priority, addr 0x330d5f0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Priority();

  /// @brief Method get_QueueIndex, addr 0x330d600, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_QueueIndex();

  /// @brief Method set_Priority, addr 0x330d5f8, size 0x8, virtual false, abstract: false, final false
  inline void set_Priority(float_t value);

  /// @brief Method set_QueueIndex, addr 0x330d608, size 0x8, virtual false, abstract: false, final false
