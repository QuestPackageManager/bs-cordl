...
template <typename T> constexpr ::System::Collections::IEnumerator* Priority_Queue::__FastPriorityQueue_1___GetEnumerator_d__22<T>::i___System__Collections__IEnumerator() noexcept {
  return static_cast<::System::Collections::IEnumerator*>(static_cast<void*>(this));
}
