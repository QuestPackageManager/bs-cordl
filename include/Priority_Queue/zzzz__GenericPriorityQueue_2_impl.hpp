...
template <typename TItem, typename TPriority>
  requires(::cordl_internals::type_constraint<TItem, ::Priority_Queue::GenericPriorityQueueNode_1<TPriority>*> && ::cordl_internals::type_constraint<TPriority, ::System::IComparable_1<TPriority>*>)
constexpr ::ArrayW<TItem>& Priority_Queue::GenericPriorityQueue_2<TItem, TPriority>::__cordl_internal_get__nodes() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____nodes;
}
template <typename TItem, typename TPriority>
  requires(::cordl_internals::type_constraint<TItem, ::Priority_Queue::GenericPriorityQueueNode_1<TPriority>*> && ::cordl_internals::type_constraint<TPriority, ::System::IComparable_1<TPriority>*>)
constexpr ::ArrayW<TItem> const& Priority_Queue::GenericPriorityQueue_2<TItem, TPriority>::__cordl_internal_get__nodes() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____nodes;
}
template <typename TItem, typename TPriority>
  requires(::cordl_internals::type_constraint<TItem, ::Priority_Queue::GenericPriorityQueueNode_1<TPriority>*> && ::cordl_internals::type_constraint<TPriority, ::System::IComparable_1<TPriority>*>)
constexpr void Priority_Queue::GenericPriorityQueue_2<TItem, TPriority>::__cordl_internal_set__nodes(::ArrayW<TItem> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
