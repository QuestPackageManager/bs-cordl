...
template <typename TItem, typename TPriority> inline void Priority_Queue::GenericPriorityQueue_2__GetEnumerator_d__25<TItem, TPriority>::_ctor(int32_t __1__state) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Priority_Queue::GenericPriorityQueue_2__GetEnumerator_d__25<TItem, TPriority>*>::get(), ".ctor",
...
template <typename TItem, typename TPriority> inline void Priority_Queue::GenericPriorityQueue_2__GetEnumerator_d__25<TItem, TPriority>::System_IDisposable_Dispose() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Priority_Queue::GenericPriorityQueue_2__GetEnumerator_d__25<TItem, TPriority>*>::get(),
