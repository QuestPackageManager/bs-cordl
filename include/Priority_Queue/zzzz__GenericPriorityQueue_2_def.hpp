...
public:
  ...
  __declspec(property(get = __cordl_internal_get__nodes, put = __cordl_internal_set__nodes)) ::ArrayW<TItem> _nodes;
  ...
  constexpr ::ArrayW<TItem> const& __cordl_internal_get__nodes() const;

  constexpr ::ArrayW<TItem>& __cordl_internal_get__nodes();
  ...
  constexpr void __cordl_internal_set__nodes(::ArrayW<TItem> value);
