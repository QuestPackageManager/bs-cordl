...
public:
  ...
  /// @brief Method .ctor, addr 0x31e724c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InsertionIndex, addr 0x31e723c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_InsertionIndex();

  /// @brief Method set_InsertionIndex, addr 0x31e7244, size 0x8, virtual false, abstract: false, final false
