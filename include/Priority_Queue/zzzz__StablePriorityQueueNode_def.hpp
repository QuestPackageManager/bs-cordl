...
public:
  ...
  /// @brief Method .ctor, addr 0xf83574, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InsertionIndex, addr 0xf83564, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_InsertionIndex();

  /// @brief Method set_InsertionIndex, addr 0xf8356c, size 0x8, virtual false, abstract: false, final false
