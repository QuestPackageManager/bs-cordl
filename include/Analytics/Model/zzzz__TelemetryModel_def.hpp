...
/// @brief Field _analyticsEventDispatcher, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__analyticsEventDispatcher, put=__cordl_internal_set__analyticsEventDispatcher)) ::BeatGames::Analytics::AnalyticsEventsDispatcher*  _analyticsEventDispatcher;

/// @brief Field _queuedEvents, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__queuedEvents, put=__cordl_internal_set__queuedEvents)) ::System::Collections::Generic::List_1<::System::ValueTuple_2<::StringW,int32_t>>*  _queuedEvents;
...
/// @brief Method SendAppLoadingEvent, addr 0x31906ec, size 0x13c, virtual false, abstract: false, final false
inline void SendAppLoadingEvent(::StringW  eventName, int32_t  msDuration) ;

/// @brief Method SendLevelLoadingEvent, addr 0x3190828, size 0x144, virtual false, abstract: false, final false
inline void SendLevelLoadingEvent(::StringW  eventName, ::StringW  levelKey, int32_t  msDuration, int32_t  intValue) ;

/// @brief Method SendPromoEvent, addr 0x319096c, size 0x140, virtual false, abstract: false, final false
inline void SendPromoEvent(::StringW  eventName, ::StringW  promoId, int32_t  count) ;

/// @brief Method SetEventDispatcher, addr 0x3190528, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3190aac, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_analyticsEventsDispatcher, addr 0x3190520, size 0x8, virtual false, abstract: false, final false
...
} // namespace end def Analytics::Model
