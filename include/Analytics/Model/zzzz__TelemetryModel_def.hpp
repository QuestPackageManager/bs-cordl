...
public:
  ...
  /// @brief Method SendAppLoadingEvent, addr 0x31c2ef4, size 0x13c, virtual false, abstract: false, final false
  inline void SendAppLoadingEvent(::StringW eventName, int32_t msDuration);

  /// @brief Method SendLevelLoadingEvent, addr 0x31c3030, size 0x144, virtual false, abstract: false, final false
  inline void SendLevelLoadingEvent(::StringW eventName, ::StringW levelKey, int32_t msDuration, int32_t intValue);

  /// @brief Method SendPromoEvent, addr 0x31c3174, size 0x140, virtual false, abstract: false, final false
  inline void SendPromoEvent(::StringW eventName, ::StringW promoId, int32_t count);

  /// @brief Method SetEventDispatcher, addr 0x31c2d30, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c32b4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_analyticsEventsDispatcher, addr 0x31c2d28, size 0x8, virtual false, abstract: false, final false
