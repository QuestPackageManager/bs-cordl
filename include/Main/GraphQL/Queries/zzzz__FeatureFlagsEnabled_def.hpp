...
public:
  ...
  /// @brief Method .ctor, addr 0x328b6cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Features, addr 0x328b5f8, size 0xc0, virtual false, abstract: false, final false
