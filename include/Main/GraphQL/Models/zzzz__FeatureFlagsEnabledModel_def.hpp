...
// Write type traits
MARK_REF_T(::Main::GraphQL::Models::FeatureFlagsEnabledModel*);
MARK_REF_T(::Main::GraphQL::Models::FeatureFlagsEnabledModel_XocBeatGamesFeaturesEnabledForViewerModel*);
...
static_assert(sizeof(::Main::GraphQL::Models::FeatureFlagsEnabledModel) == 0x18, "Size mismatch!");
