...
} // namespace end def Main::GraphQL::Models
...
using XocBeatGamesFeaturesEnabledForViewerModel = ::Main::GraphQL::Models::FeatureFlagsEnabledModel_XocBeatGamesFeaturesEnabledForViewerModel;
 ...
 __declspec(property(get=get_XocBeatGamesFeaturesEnabledForViewer, put=set_XocBeatGamesFeaturesEnabledForViewer)) ::System::Collections::Generic::List_1<::Main::GraphQL::Models::FeatureFlagsEnabledModel_XocBeatGamesFeaturesEnabledForViewerModel*>*  XocBeatGamesFeaturesEnabledForViewer;

/// @brief Field <XocBeatGamesFeaturesEnabledForViewer>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__XocBeatGamesFeaturesEnabledForViewer_k__BackingField, put=__cordl_internal_set__XocBeatGamesFeaturesEnabledForViewer_k__BackingField)) ::System::Collections::Generic::List_1<::Main::GraphQL::Models::FeatureFlagsEnabledModel_XocBeatGamesFeaturesEnabledForViewerModel*>*  _XocBeatGamesFeaturesEnabledForViewer_k__BackingField;

static inline ::Main::GraphQL::Models::FeatureFlagsEnabledModel* New_ctor() ;

constexpr ::System::Collections::Generic::List_1<::Main::GraphQL::Models::FeatureFlagsEnabledModel_XocBeatGamesFeaturesEnabledForViewerModel*>* const& __cordl_internal_get__XocBeatGamesFeaturesEnabledForViewer_k__BackingField() const;

constexpr ::System::Collections::Generic::List_1<::Main::GraphQL::Models::FeatureFlagsEnabledModel_XocBeatGamesFeaturesEnabledForViewerModel*>*& __cordl_internal_get__XocBeatGamesFeaturesEnabledForViewer_k__BackingField() ;

constexpr void __cordl_internal_set__XocBeatGamesFeaturesEnabledForViewer_k__BackingField(::System::Collections::Generic::List_1<::Main::GraphQL::Models::FeatureFlagsEnabledModel_XocBeatGamesFeaturesEnabledForViewerModel*>*  value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::Main::GraphQL::Models::FeatureFlagsEnabledModel_XocBeatGamesFeaturesEnabledForViewerModel*, "Main.GraphQL.Models", "FeatureFlagsEnabledModel/XocBeatGamesFeaturesEnabledForViewerModel");
