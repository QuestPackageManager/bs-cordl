...
DEFINE_IL2CPP_GEN_CLASS(::IntervalTree::RangeValuePair_2, "IntervalTree", "RangeValuePair`2");
// [NullableContext(1)]
// [Nullable(0)]
// [IsReadOnly]
// Dependencies
...
public:
  ...
  inline bool Equals(/* [Nullable(new[] { 0, 1, 1 })] */ ::IntervalTree::RangeValuePair_2<TKey, TValue> other);
  ...
  static inline bool op_Equality(/* [Nullable(new[] { 0, 1, 1 })] */ ::IntervalTree::RangeValuePair_2<TKey, TValue> left,
  ...
  static inline bool op_Inequality(/* [Nullable(new[] { 0, 1, 1 })] */ ::IntervalTree::RangeValuePair_2<TKey, TValue> left,
                                   /* [Nullable(new[] { 0, 1, 1 })] */ ::IntervalTree::RangeValuePair_2<TKey, TValue> right);
  ...
  // Ctor Parameters [CppParam { name: "_From_k__BackingField", ty: "TKey", modifiers: "", def_value: None, comment: None }, CppParam { name: "_To_k__BackingField", ty: "TKey", modifiers: "",
  // def_value: None, comment: None }, CppParam { name: "_Value_k__BackingField", ty: "TValue", modifiers: "", def_value: None, comment: None }]
