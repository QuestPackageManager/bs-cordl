...
public:
  ...
  /// @brief Method GetValue, addr 0x44dc7d0, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44dc6e4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44dc72c, size 0xa4, virtual false, abstract: false, final false
