...
public:
  ...
  /// @brief Method GetValue, addr 0x44df428, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44df33c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44df384, size 0xa4, virtual false, abstract: false, final false
