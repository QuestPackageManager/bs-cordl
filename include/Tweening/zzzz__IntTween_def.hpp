...
/// @brief Method GetValue, addr 0x62922d4, size 0x28c, virtual true, abstract: false, final false
inline int32_t GetValue(float_t  t) ;

static inline ::Tweening::IntTween* New_ctor() ;

static inline ::Tweening::IntTween* New_ctor(int32_t  fromValue, int32_t  toValue, ::System::Action_1<int32_t>*  onUpdate, float_t  duration, ::GlobalNamespace::EaseType  easeType, ::Tweening::IntTween_RoundingType  roundingType, float_t  delay) ;
...
/// @brief Method .ctor, addr 0x62921e8, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x629223c, size 0x98, virtual false, abstract: false, final false
inline void _ctor(int32_t  fromValue, int32_t  toValue, ::System::Action_1<int32_t>*  onUpdate, float_t  duration, ::GlobalNamespace::EaseType  easeType, ::Tweening::IntTween_RoundingType  roundingType, float_t  delay) ;
