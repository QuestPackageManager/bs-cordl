...
public:
  ...
  /// @brief Method GetValue, addr 0x63042e0, size 0x28c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63041f4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6304248, size 0x98, virtual false, abstract: false, final false
