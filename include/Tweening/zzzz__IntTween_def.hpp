...
public:
  ...
  /// @brief Method GetValue, addr 0x6291c14, size 0x28c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6291b28, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6291b7c, size 0x98, virtual false, abstract: false, final false
