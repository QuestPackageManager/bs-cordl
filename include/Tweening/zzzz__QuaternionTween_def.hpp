...
public:
  ...
  /// @brief Method GetValue, addr 0x44d6aa4, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44d698c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44d69d4, size 0xd0, virtual false, abstract: false, final false
