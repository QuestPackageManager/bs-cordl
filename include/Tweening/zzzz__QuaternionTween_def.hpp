...
// Write type traits
MARK_REF_T(::Tweening::QuaternionTween*);
DEFINE_IL2CPP_CLASS(::Tweening::QuaternionTween*, "Tweening", "QuaternionTween");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QuaternionTween", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QuaternionTween(QuaternionTween&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QuaternionTween", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QuaternionTween(QuaternionTweenconst&) = delete;
