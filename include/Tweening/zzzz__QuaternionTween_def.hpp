...
public:
  ...
  /// @brief Method GetValue, addr 0x6292744, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x629261c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x629267c, size 0xc8, virtual false, abstract: false, final false
