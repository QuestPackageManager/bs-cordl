...
public:
  ...
  /// @brief Method GetValue, addr 0x44645ac, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4464494, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44644dc, size 0xd0, virtual false, abstract: false, final false
