...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Tween_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Tween_1(Tween_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Tween_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Tween_1(Tween_1const&) = delete;
