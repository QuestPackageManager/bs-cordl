...
public:
  ...
  /// @brief Method Start, addr 0x2a111b4, size 0x64, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method LateUpdate, addr 0x2a11218, size 0x1ec, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method GetTime, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline float_t GetTime();

  /// @brief Method AddTween, addr 0x2a115c8, size 0x4c, virtual false, abstract: false, final false
  inline ::Tweening::Tween* AddTween(::Tweening::Tween* tween, ::System::Object* owner);

  /// @brief Method RestartTween, addr 0x2a11748, size 0x58, virtual false, abstract: false, final false
  inline ::Tweening::Tween* RestartTween(::Tweening::Tween* tween, ::System::Object* owner);

  /// @brief Method ResumeTween, addr 0x2a117a0, size 0x24, virtual false, abstract: false, final false
  inline ::Tweening::Tween* ResumeTween(::Tweening::Tween* tween, ::System::Object* owner);

  /// @brief Method KillAllTweens, addr 0x2a117c4, size 0x17c, virtual false, abstract: false, final false
  inline void KillAllTweens(::System::Object* owner);

  /// @brief Method RemoveTweenFromOwnerDictionary, addr 0x2a11404, size 0x1c4, virtual false, abstract: false, final false
  inline void RemoveTweenFromOwnerDictionary(::Tweening::Tween* tween);

  /// @brief Method AddTweenToDataStructures, addr 0x2a11614, size 0x134, virtual false, abstract: false, final false
  inline bool AddTweenToDataStructures(::Tweening::Tween* tween, ::System::Object* owner);

  /// @brief Method AddTweenToOwnerDictionary, addr 0x2a11940, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a10f40, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor();
