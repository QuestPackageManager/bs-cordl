...
public:
  ...
  /// @brief Method AddTween, addr 0x44650b0, size 0x50, virtual false, abstract: false, final false
  inline ::Tweening::Tween* AddTween(::Tweening::Tween* tween, ::System::Object* owner, bool updateEveryOtherFrame);

  /// @brief Method AddTweenToDataStructures, addr 0x4465100, size 0x168, virtual false, abstract: false, final false
  inline bool AddTweenToDataStructures(::Tweening::Tween* tween, ::System::Object* owner, bool updateEveryOtherFrame);

  /// @brief Method AddTweenToOwnerDictionary, addr 0x44654d0, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method KillAllTweens, addr 0x4465354, size 0x17c, virtual false, abstract: false, final false
  inline void KillAllTweens(::System::Object* owner);

  /// @brief Method LateUpdate, addr 0x4464cc0, size 0x220, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::Tweening::TweeningManager* New_ctor();

  /// @brief Method RemoveTweenFromOwnerDictionary, addr 0x4464ee0, size 0x1d0, virtual false, abstract: false, final false
  inline void RemoveTweenFromOwnerDictionary(::Tweening::Tween* tween);

  /// @brief Method RestartTween, addr 0x4465268, size 0xc4, virtual false, abstract: false, final false
  inline ::Tweening::Tween* RestartTween(::Tweening::Tween* tween, ::System::Object* owner, bool updateEveryOtherFrame);

  /// @brief Method ResumeTween, addr 0x446532c, size 0x28, virtual false, abstract: false, final false
  inline ::Tweening::Tween* ResumeTween(::Tweening::Tween* tween, ::System::Object* owner, bool updateEveryOtherFrame);

  /// @brief Method Start, addr 0x4464c5c, size 0x64, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x44649b0, size 0x19c, virtual false, abstract: false, final false
  inline void _ctor();
