...
public:
  ...
  /// @brief Method AddTween, addr 0x6305a00, size 0x4c, virtual false, abstract: false, final false
  inline ::Tweening::Tween* AddTween(::Tweening::Tween* tween, ::System::Object* owner, bool updateEveryOtherFrame);

  /// @brief Method AddTweenToDataStructures, addr 0x6305a4c, size 0x18c, virtual false, abstract: false, final false
  inline bool AddTweenToDataStructures(::Tweening::Tween* tween, ::System::Object* owner, bool updateEveryOtherFrame);

  /// @brief Method AddTweenToOwnerDictionary, addr 0x6305e10, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method KillAllTweens, addr 0x6305cc8, size 0x148, virtual false, abstract: false, final false
  inline void KillAllTweens(::System::Object* owner);

  /// @brief Method LateUpdate, addr 0x63055e4, size 0x208, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::Tweening::TweeningManager* New_ctor();

  /// @brief Method RemoveTweenFromOwnerDictionary, addr 0x63057ec, size 0x214, virtual false, abstract: false, final false
  inline void RemoveTweenFromOwnerDictionary(::Tweening::Tween* tween);

  /// @brief Method RestartTween, addr 0x6305bd8, size 0xc8, virtual false, abstract: false, final false
  inline ::Tweening::Tween* RestartTween(::Tweening::Tween* tween, ::System::Object* owner, bool updateEveryOtherFrame);

  /// @brief Method ResumeTween, addr 0x6305ca0, size 0x28, virtual false, abstract: false, final false
  inline ::Tweening::Tween* ResumeTween(::Tweening::Tween* tween, ::System::Object* owner, bool updateEveryOtherFrame);

  /// @brief Method Start, addr 0x6305578, size 0x6c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x6305288, size 0x1e8, virtual false, abstract: false, final false
  inline void _ctor();
