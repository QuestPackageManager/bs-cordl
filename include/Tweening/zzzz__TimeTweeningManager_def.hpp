...
public:
  // Declarations
  /// @brief Method GetTime, addr 0x622b004, size 0x28, virtual true, abstract: false, final false
  inline float_t GetTime();

  static inline ::Tweening::TimeTweeningManager* New_ctor();

  /// @brief Method .ctor, addr 0x622b02c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
