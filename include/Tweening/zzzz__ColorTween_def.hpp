...
public:
  ...
  /// @brief Method GetValue, addr 0x2b586cc, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b585b4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2b585fc, size 0xd0, virtual false, abstract: false, final false
