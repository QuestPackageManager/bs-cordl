...
public:
  ...
  /// @brief Method GetValue, addr 0x2f3db7c, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f3da64, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f3daac, size 0xd0, virtual false, abstract: false, final false
