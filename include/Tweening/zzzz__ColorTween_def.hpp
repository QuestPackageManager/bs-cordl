...
public:
  ...
  /// @brief Method GetValue, addr 0x6292a04, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62928dc, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x629293c, size 0xc8, virtual false, abstract: false, final false
