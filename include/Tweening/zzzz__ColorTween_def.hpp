...
public:
  ...
  /// @brief Method GetValue, addr 0x44dbc24, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44dbb0c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44dbb54, size 0xd0, virtual false, abstract: false, final false
