...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Tweening::FrameParity (*)(::Tweening::FrameParity)>(&::Tweening::FrameParityExtensions::GetSwitchedParity)> {
  ...
  constexpr static std::size_t addrs = 0x6293554;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Tweening::FrameParityExtensions*>::get(),
                        "GetSwitchedParity",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Tweening::FrameParity>::get()}
                    )));
