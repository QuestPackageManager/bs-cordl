...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tweening::IntTween::*)()>(&::Tweening::IntTween::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x62921e8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tweening::IntTween::*)(int32_t, int32_t, ::System::Action_1<int32_t>*, float_t, ::GlobalNamespace::EaseType, ::Tweening::IntTween_RoundingType, float_t)>(&::Tweening::IntTween::_ctor)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x629223c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Tweening::IntTween::*)(float_t)>(&::Tweening::IntTween::GetValue)> {
  ...
  constexpr static std::size_t addrs = 0x62922d4;
...
inline void Tweening::IntTween::_ctor(int32_t  fromValue, int32_t  toValue, ::System::Action_1<int32_t>*  onUpdate, float_t  duration, ::GlobalNamespace::EaseType  easeType, ::Tweening::IntTween_RoundingType  roundingType, float_t  delay)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Tweening::IntTween*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
inline ::Tweening::IntTween* Tweening::IntTween::New_ctor(int32_t  fromValue, int32_t  toValue, ::System::Action_1<int32_t>*  onUpdate, float_t  duration, ::GlobalNamespace::EaseType  easeType, ::Tweening::IntTween_RoundingType  roundingType, float_t  delay)  {
