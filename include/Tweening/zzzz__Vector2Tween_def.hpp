...
public:
  ...
  /// @brief Method GetValue, addr 0x2b581d0, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b580e0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2b58128, size 0xa8, virtual false, abstract: false, final false
