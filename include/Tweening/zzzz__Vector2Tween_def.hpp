...
public:
  ...
  /// @brief Method GetValue, addr 0x2f4267c, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f4258c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f425d4, size 0xa8, virtual false, abstract: false, final false
