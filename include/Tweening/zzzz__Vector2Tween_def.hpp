...
public:
  ...
  /// @brief Method GetValue, addr 0x3043f7c, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3043e8c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3043ed4, size 0xa8, virtual false, abstract: false, final false
