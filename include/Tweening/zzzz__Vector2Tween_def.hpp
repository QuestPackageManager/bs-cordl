...
public:
  ...
  /// @brief Method GetValue, addr 0x62921f0, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62920fc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6292154, size 0x9c, virtual false, abstract: false, final false
