...
public:
  ...
  /// @brief Method GetValue, addr 0x44db4a8, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44db3b8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44db400, size 0xa8, virtual false, abstract: false, final false
