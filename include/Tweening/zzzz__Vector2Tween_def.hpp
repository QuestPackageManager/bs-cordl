...
public:
  ...
  /// @brief Method GetValue, addr 0x306066c, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x306057c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x30605c4, size 0xa8, virtual false, abstract: false, final false
