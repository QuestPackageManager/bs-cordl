...
public:
  ...
  /// @brief Method GetValue, addr 0x63048bc, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63047c8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6304820, size 0x9c, virtual false, abstract: false, final false
