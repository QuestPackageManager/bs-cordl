...
/// @brief Field Pool, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Pool, put=setStaticF_Pool)) ::Zenject::StaticMemoryPool_7<::UnityEngine::Vector2,::UnityEngine::Vector2,::System::Action_1<::UnityEngine::Vector2>*,float_t,::GlobalNamespace::EaseType,float_t,::Tweening::Vector2Tween*>*  Pool;

/// @brief Method GetValue, addr 0x62928b0, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62927bc, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6292814, size 0x9c, virtual false, abstract: false, final false
