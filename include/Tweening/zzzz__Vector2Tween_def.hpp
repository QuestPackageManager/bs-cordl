...
public:
  ...
  /// @brief Method GetValue, addr 0x44df99c, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44df8ac, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44df8f4, size 0xa8, virtual false, abstract: false, final false
