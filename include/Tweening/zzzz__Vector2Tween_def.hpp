...
public:
  ...
  /// @brief Method GetValue, addr 0x622a664, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x622a570, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x622a5c8, size 0x9c, virtual false, abstract: false, final false
