...
public:
  ...
  /// @brief Method GetValue, addr 0x2f3d680, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f3d590, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f3d5d8, size 0xa8, virtual false, abstract: false, final false
