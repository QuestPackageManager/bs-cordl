...
public:
  ...
  /// @brief Method GetTime, addr 0x5835eb0, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5835f54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
