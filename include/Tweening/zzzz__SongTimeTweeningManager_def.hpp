...
public:
  ...
  /// @brief Method GetTime, addr 0x5975c78, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5975d1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SongTimeTweeningManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SongTimeTweeningManager(SongTimeTweeningManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SongTimeTweeningManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SongTimeTweeningManager(SongTimeTweeningManagerconst&) = delete;
