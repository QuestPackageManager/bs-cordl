...
public:
  ...
  /// @brief Method GetTime, addr 0x234e194, size 0xa0, virtual true, abstract: false, final false
  inline float_t GetTime();

  static inline ::Tweening::SongTimeTweeningManager* New_ctor();

  /// @brief Method .ctor, addr 0x234e234, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
