...
public:
  ...
  /// @brief Method GetTime, addr 0x575eb74, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x575ec18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
