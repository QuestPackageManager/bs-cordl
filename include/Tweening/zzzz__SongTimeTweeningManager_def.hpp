...
public:
  ...
  /// @brief Method GetTime, addr 0x26d7510, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d75b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::Tweening::SongTimeTweeningManager, 0x50>, "Size mismatch!");
