...
/// @brief Field Pool, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Pool, put=setStaticF_Pool)) ::Zenject::StaticMemoryPool_7<float_t,float_t,::System::Action_1<float_t>*,float_t,::GlobalNamespace::EaseType,float_t,::Tweening::FloatTween*>*  Pool;

/// @brief Method GetValue, addr 0x629263c, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6292560, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x62925b4, size 0x88, virtual false, abstract: false, final false
