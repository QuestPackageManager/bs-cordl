...
public:
  ...
  /// @brief Method GetValue, addr 0x44db2d8, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44db200, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44db248, size 0x90, virtual false, abstract: false, final false
