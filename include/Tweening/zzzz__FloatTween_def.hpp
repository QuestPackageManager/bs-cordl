...
public:
  ...
  /// @brief Method GetValue, addr 0x622a3f0, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x622a314, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x622a368, size 0x88, virtual false, abstract: false, final false
