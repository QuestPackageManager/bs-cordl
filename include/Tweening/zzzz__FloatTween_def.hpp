...
public:
  ...
  /// @brief Method GetValue, addr 0x2b57f88, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b57eb0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2b57ef8, size 0x90, virtual false, abstract: false, final false
