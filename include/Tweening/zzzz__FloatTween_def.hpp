...
public:
  ...
  /// @brief Method GetValue, addr 0x6304648, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x630456c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63045c0, size 0x88, virtual false, abstract: false, final false
