...
public:
  ...
  /// @brief Method GetValue, addr 0x3060424, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x306034c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3060394, size 0x90, virtual false, abstract: false, final false
