...
public:
  ...
  /// @brief Method GetValue, addr 0x44e8c30, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44e8b28, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44e8b70, size 0xc0, virtual false, abstract: false, final false
