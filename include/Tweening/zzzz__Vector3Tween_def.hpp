...
public:
  ...
  /// @brief Method GetValue, addr 0x6304b48, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6304a3c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6304a98, size 0xb0, virtual false, abstract: false, final false
