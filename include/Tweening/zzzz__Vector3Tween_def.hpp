...
/// @brief Field Pool, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Pool, put=setStaticF_Pool)) ::Zenject::StaticMemoryPool_7<::UnityEngine::Vector3,::UnityEngine::Vector3,::System::Action_1<::UnityEngine::Vector3>*,float_t,::GlobalNamespace::EaseType,float_t,::Tweening::Vector3Tween*>*  Pool;

/// @brief Method GetValue, addr 0x6292b3c, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6292a30, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6292a8c, size 0xb0, virtual false, abstract: false, final false
