...
// Write type traits
MARK_REF_T(::Tweening::Vector3Tween*);
DEFINE_IL2CPP_CLASS(::Tweening::Vector3Tween*, "Tweening", "Vector3Tween");
...
public:
  ...
  /// @brief Method GetValue, addr 0x6448948, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x644877c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6448890, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64487dc, size 0xb4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Vector3Tween", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Vector3Tween(Vector3Tween&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Vector3Tween", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Vector3Tween(Vector3Tweenconst&) = delete;
