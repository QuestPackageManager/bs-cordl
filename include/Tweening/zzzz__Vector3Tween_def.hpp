...
public:
  ...
  /// @brief Method GetValue, addr 0x4478a30, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4478928, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4478970, size 0xc0, virtual false, abstract: false, final false
