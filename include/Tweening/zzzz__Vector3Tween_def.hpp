...
public:
  ...
  /// @brief Method GetValue, addr 0x44dfc00, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44dfaf8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44dfb40, size 0xc0, virtual false, abstract: false, final false
