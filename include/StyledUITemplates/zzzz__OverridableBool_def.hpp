...
public:
  ...
  /// @brief Method .ctor, addr 0x5f3f5d8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OverridableBool", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OverridableBool(OverridableBool&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OverridableBool", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OverridableBool(OverridableBoolconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23650 };
