...
public:
  ...
  /// @brief Method .ctor, addr 0x5f3f614, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OverridableFloat", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OverridableFloat(OverridableFloat&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OverridableFloat", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OverridableFloat(OverridableFloatconst&) = delete;
