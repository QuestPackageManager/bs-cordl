...
// Write type traits
MARK_REF_T(::StyledUITemplates::OverridableInt*);
DEFINE_IL2CPP_CLASS(::StyledUITemplates::OverridableInt*, "StyledUITemplates", "OverridableInt");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f3f650, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OverridableInt", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OverridableInt(OverridableInt&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OverridableInt", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OverridableInt(OverridableIntconst&) = delete;
...
static_assert(sizeof(::StyledUITemplates::OverridableInt) == 0x18, "Size mismatch!");
