...
public:
  ...
  /// @brief Method get_Tag, addr 0x27dc3f0, size 0x8, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::JSONNodeType get_Tag();

  /// @brief Method get_IsNumber, addr 0x27dc3f8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsNumber();

  /// @brief Method GetEnumerator, addr 0x27dc400, size 0x14, virtual true, abstract: false, final false
  inline ::OVRSimpleJSON::__JSONNode__Enumerator GetEnumerator();

  /// @brief Method get_Value, addr 0x27dc414, size 0x68, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x27dc47c, size 0x8c, virtual true, abstract: false, final false
  inline void set_Value(::StringW value);

  /// @brief Method get_AsDouble, addr 0x27dc508, size 0x8, virtual true, abstract: false, final false
  inline double_t get_AsDouble();

  /// @brief Method set_AsDouble, addr 0x27dc510, size 0x8, virtual true, abstract: false, final false
  inline void set_AsDouble(double_t value);

  /// @brief Method get_AsLong, addr 0x27dc518, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_AsLong();

  /// @brief Method set_AsLong, addr 0x27dc538, size 0xc, virtual true, abstract: false, final false
  inline void set_AsLong(int64_t value);

  static inline ::OVRSimpleJSON::JSONNumber* New_ctor(double_t aData);

  /// @brief Method .ctor, addr 0x27dc544, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(double_t aData);

  static inline ::OVRSimpleJSON::JSONNumber* New_ctor(::StringW aData);

  /// @brief Method .ctor, addr 0x27dc56c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::StringW aData);

  /// @brief Method WriteToStringBuilder, addr 0x27dc5a0, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method IsNumeric, addr 0x27dc5d4, size 0x1a0, virtual false, abstract: false, final false
  static inline bool IsNumeric(::System::Object* value);

  /// @brief Method Equals, addr 0x27dc774, size 0x110, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x27dc884, size 0x70, virtual true, abstract: false, final false
