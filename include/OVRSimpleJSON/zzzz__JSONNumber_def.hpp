...
public:
  ...
  /// @brief Method get_Tag addr 0x27cdc9c size 0x8 virtual true final false
  inline ::OVRSimpleJSON::JSONNodeType get_Tag();

  /// @brief Method get_IsNumber addr 0x27cdca4 size 0x8 virtual true final false
  inline bool get_IsNumber();

  /// @brief Method GetEnumerator addr 0x27cdcac size 0x14 virtual true final false
  inline ::OVRSimpleJSON::__JSONNode__Enumerator GetEnumerator();

  /// @brief Method get_Value addr 0x27cdcc0 size 0x68 virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x27cdd28 size 0x8c virtual true final false
  inline void set_Value(::StringW value);

  /// @brief Method get_AsDouble addr 0x27cddb4 size 0x8 virtual true final false
  inline double_t get_AsDouble();

  /// @brief Method set_AsDouble addr 0x27cddbc size 0x8 virtual true final false
  inline void set_AsDouble(double_t value);

  /// @brief Method get_AsLong addr 0x27cddc4 size 0x20 virtual true final false
  inline int64_t get_AsLong();

  /// @brief Method set_AsLong addr 0x27cdde4 size 0xc virtual true final false
  inline void set_AsLong(int64_t value);

  static inline ::OVRSimpleJSON::JSONNumber* New_ctor(double_t aData);

  /// @brief Method .ctor addr 0x27c2cb0 size 0x28 virtual false final false
  inline void _ctor(double_t aData);

  static inline ::OVRSimpleJSON::JSONNumber* New_ctor(::StringW aData);

  /// @brief Method .ctor addr 0x27cddf0 size 0x34 virtual false final false
  inline void _ctor(::StringW aData);

  /// @brief Method WriteToStringBuilder addr 0x27cde24 size 0x34 virtual true final false
  ...
  /// @brief Method IsNumeric addr 0x27cde58 size 0x1a0 virtual false final false
  static inline bool IsNumeric(::System::Object* value);

  /// @brief Method Equals addr 0x27cdff8 size 0x100 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x27ce0f8 size 0x70 virtual true final false
