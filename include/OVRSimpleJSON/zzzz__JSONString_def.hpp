...
public:
  ...
  /// @brief Method get_Tag addr 0x2656adc size 0x8 virtual true final false
  inline ::OVRSimpleJSON::JSONNodeType get_Tag();

  /// @brief Method get_IsString addr 0x2656ae4 size 0x8 virtual true final false
  inline bool get_IsString();

  /// @brief Method GetEnumerator addr 0x2656aec size 0x14 virtual true final false
  inline ::OVRSimpleJSON::__JSONNode__Enumerator GetEnumerator();

  /// @brief Method get_Value addr 0x2656b00 size 0x8 virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x2656b08 size 0x8 virtual true final false
  inline void set_Value(::StringW value);

  static inline ::OVRSimpleJSON::JSONString* New_ctor(::StringW aData);

  /// @brief Method .ctor addr 0x2656b10 size 0x28 virtual false final false
  inline void _ctor(::StringW aData);

  /// @brief Method WriteToStringBuilder addr 0x2656b38 size 0x60 virtual true final false
  ...
  /// @brief Method Equals addr 0x2656b98 size 0xfc virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2656c94 size 0x20 virtual true final false
