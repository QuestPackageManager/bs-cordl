...
public:
  ...
  /// @brief Method get_Tag addr 0x26575a8 size 0x8 virtual true final false
  inline ::OVRSimpleJSON::JSONNodeType get_Tag();

  /// @brief Method GetEnumerator addr 0x26575b0 size 0x14 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2654ec8 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2655b54 size 0x2c virtual false final false
  ...
  /// @brief Method get_Item addr 0x26575c4 size 0x64 virtual true final false
  inline ::OVRSimpleJSON::JSONNode* get_Item(int32_t aIndex);

  /// @brief Method set_Item addr 0x2657628 size 0x9c virtual true final false
  inline void set_Item(int32_t aIndex, ::OVRSimpleJSON::JSONNode* value);

  /// @brief Method get_Item addr 0x26576c4 size 0x70 virtual true final false
  inline ::OVRSimpleJSON::JSONNode* get_Item(::StringW aKey);

  /// @brief Method set_Item addr 0x2657734 size 0xa4 virtual true final false
  inline void set_Item(::StringW aKey, ::OVRSimpleJSON::JSONNode* value);

  /// @brief Method Add addr 0x26577d8 size 0x9c virtual true final false
  inline void Add(::OVRSimpleJSON::JSONNode* aItem);

  /// @brief Method Add addr 0x2657874 size 0xa4 virtual true final false
  inline void Add(::StringW aKey, ::OVRSimpleJSON::JSONNode* aItem);

  /// @brief Method op_Equality addr 0x2657918 size 0x18 virtual false final false
  static inline bool op_Equality(::OVRSimpleJSON::JSONLazyCreator* a, ::System::Object* b);

  /// @brief Method op_Inequality addr 0x2657930 size 0x18 virtual false final false
  static inline bool op_Inequality(::OVRSimpleJSON::JSONLazyCreator* a, ::System::Object* b);

  /// @brief Method Equals addr 0x2657948 size 0x18 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2657960 size 0x8 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method get_AsInt addr 0x2657968 size 0x88 virtual true final false
  inline int32_t get_AsInt();

  /// @brief Method set_AsInt addr 0x26579f0 size 0x98 virtual true final false
  inline void set_AsInt(int32_t value);

  /// @brief Method get_AsFloat addr 0x2657a88 size 0x88 virtual true final false
  inline float_t get_AsFloat();

  /// @brief Method set_AsFloat addr 0x2657b10 size 0x90 virtual true final false
  inline void set_AsFloat(float_t value);

  /// @brief Method get_AsDouble addr 0x2657ba0 size 0x88 virtual true final false
  inline double_t get_AsDouble();

  /// @brief Method set_AsDouble addr 0x2657c28 size 0x8c virtual true final false
  inline void set_AsDouble(double_t value);

  /// @brief Method get_AsLong addr 0x2657cb4 size 0x10c virtual true final false
  inline int64_t get_AsLong();

  /// @brief Method set_AsLong addr 0x2657dc0 size 0x148 virtual true final false
  inline void set_AsLong(int64_t value);

  /// @brief Method get_AsBool addr 0x2657f08 size 0x88 virtual true final false
  inline bool get_AsBool();

  /// @brief Method set_AsBool addr 0x2657f90 size 0x90 virtual true final false
  inline void set_AsBool(bool value);

  /// @brief Method get_AsArray addr 0x2658020 size 0x78 virtual true final false
  inline ::OVRSimpleJSON::JSONArray* get_AsArray();

  /// @brief Method get_AsObject addr 0x2658098 size 0x78 virtual true final false
  inline ::OVRSimpleJSON::JSONObject* get_AsObject();

  /// @brief Method WriteToStringBuilder addr 0x2658110 size 0x54 virtual true final false
