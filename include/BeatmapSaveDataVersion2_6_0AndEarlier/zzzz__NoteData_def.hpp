...
public:
  ...
  /// @brief Method .ctor, addr 0x270b094, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cutDirection, addr 0x270b08c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteCutDirection get_cutDirection();

  /// @brief Method get_lineIndex, addr 0x270b074, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_lineLayer, addr 0x270b07c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_type, addr 0x270b084, size 0x8, virtual false, abstract: false, final false
