...
public:
  ...
  /// @brief Method .ctor, addr 0x27091d4, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cutDirection, addr 0x27091cc, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteCutDirection get_cutDirection();

  /// @brief Method get_lineIndex, addr 0x27091b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_lineLayer, addr 0x27091bc, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteLineLayer get_lineLayer();

  /// @brief Method get_time, addr 0x27091ac, size 0x8, virtual true, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_type, addr 0x27091c4, size 0x8, virtual false, abstract: false, final false
