...
/// @brief Method .ctor, addr 0x369f41c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beat, addr 0x369f550, size 0xc, virtual true, abstract: false, final true
