...
public:
  ...
  /// @brief Method .ctor, addr 0x369e088, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x369e1bc, size 0xc, virtual true, abstract: false, final true
