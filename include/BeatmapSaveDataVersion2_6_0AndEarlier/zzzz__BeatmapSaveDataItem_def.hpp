...
public:
  ...
  /// @brief Method .ctor, addr 0x270eee4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x270f148, size 0xc, virtual true, abstract: false, final true
