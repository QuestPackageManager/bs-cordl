...
public:
  ...
  /// @brief Method .ctor, addr 0x27091a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x2709408, size 0xc, virtual true, abstract: false, final true
