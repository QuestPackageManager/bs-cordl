...
public:
  ...
  /// @brief Method .ctor, addr 0x2707528, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x270778c, size 0xc, virtual true, abstract: false, final true
