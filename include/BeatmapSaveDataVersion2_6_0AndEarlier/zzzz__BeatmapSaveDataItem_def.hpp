...
/// @brief Method .ctor, addr 0x36620d8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beat, addr 0x366220c, size 0xc, virtual true, abstract: false, final true
