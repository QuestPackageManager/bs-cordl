...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveDataItem*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveDataItem*, "BeatmapSaveDataVersion2_6_0AndEarlier", "BeatmapSaveDataItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375b474, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x375b5a8, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveDataItem) == 0x10, "Size mismatch!");
