...
public:
  ...
  /// @brief Method .ctor, addr 0x369e0e4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_lineIndex, addr 0x369e0cc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_lineLayer, addr 0x369e0d4, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteLineLayer get_lineLayer();

  /// @brief Method get_offsetDirection, addr 0x369e0dc, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::OffsetDirection get_offsetDirection();

  /// @brief Method get_time, addr 0x369e0c4, size 0x8, virtual true, abstract: false, final false
