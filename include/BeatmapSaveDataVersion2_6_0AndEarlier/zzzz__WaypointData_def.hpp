...
namespace BeatmapSaveDataVersion2_6_0AndEarlier {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11199)), TypeDefinitionIndex(TypeDefinitionIndex(11217)), TypeDefinitionIndex(TypeDefinitionIndex(11218))]
...
public:
  ...
  /// @brief Method get_time, addr 0x12bca00, size 0x8, virtual true, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_lineIndex, addr 0x12bca08, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_lineLayer, addr 0x12bca10, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteLineLayer get_lineLayer();

  /// @brief Method get_offsetDirection, addr 0x12bca18, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bca20, size 0x4c, virtual false, abstract: false, final false
