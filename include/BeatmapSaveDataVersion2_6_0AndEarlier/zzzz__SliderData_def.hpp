...
public:
  ...
  /// @brief Method .ctor, addr 0x375fcd0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorType, addr 0x375fc78, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ColorType get_colorType();

  /// @brief Method get_headControlPointLengthMultiplier, addr 0x375fc90, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headControlPointLengthMultiplier();

  /// @brief Method get_headCutDirection, addr 0x375fc98, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteCutDirection get_headCutDirection();

  /// @brief Method get_headLineIndex, addr 0x375fc80, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_headLineIndex();

  /// @brief Method get_headLineLayer, addr 0x375fc88, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteLineLayer get_headLineLayer();

  /// @brief Method get_sliderMidAnchorMode, addr 0x375fcc8, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::SliderMidAnchorMode get_sliderMidAnchorMode();

  /// @brief Method get_tailControlPointLengthMultiplier, addr 0x375fcb8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailControlPointLengthMultiplier();

  /// @brief Method get_tailCutDirection, addr 0x375fcc0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteCutDirection get_tailCutDirection();

  /// @brief Method get_tailLineIndex, addr 0x375fca8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_tailLineIndex();

  /// @brief Method get_tailLineLayer, addr 0x375fcb0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteLineLayer get_tailLineLayer();

  /// @brief Method get_tailTime, addr 0x375fca0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailTime();

  /// @brief Method get_time, addr 0x375fc70, size 0x8, virtual true, abstract: false, final false
