...
namespace BeatmapSaveDataVersion2_6_0AndEarlier {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11192)), TypeDefinitionIndex(TypeDefinitionIndex(11199)), TypeDefinitionIndex(TypeDefinitionIndex(11216)),
// TypeDefinitionIndex(TypeDefinitionIndex(11217)), TypeDefinitionIndex(TypeDefinitionIndex(11220))] Self: TypeDefinitionIndex(TypeDefinitionIndex(11197)) CS Name:
...
public:
  ...
  /// @brief Method get_time, addr 0x12bca6c, size 0x8, virtual true, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_colorType, addr 0x12bca74, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ColorType get_colorType();

  /// @brief Method get_headLineIndex, addr 0x12bca7c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_headLineIndex();

  /// @brief Method get_headLineLayer, addr 0x12bca84, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteLineLayer get_headLineLayer();

  /// @brief Method get_headControlPointLengthMultiplier, addr 0x12bca8c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headControlPointLengthMultiplier();

  /// @brief Method get_headCutDirection, addr 0x12bca94, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteCutDirection get_headCutDirection();

  /// @brief Method get_tailTime, addr 0x12bca9c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailTime();

  /// @brief Method get_tailLineIndex, addr 0x12bcaa4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_tailLineIndex();

  /// @brief Method get_tailLineLayer, addr 0x12bcaac, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteLineLayer get_tailLineLayer();

  /// @brief Method get_tailControlPointLengthMultiplier, addr 0x12bcab4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailControlPointLengthMultiplier();

  /// @brief Method get_tailCutDirection, addr 0x12bcabc, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteCutDirection get_tailCutDirection();

  /// @brief Method get_sliderMidAnchorMode, addr 0x12bcac4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bcacc, size 0x9c, virtual false, abstract: false, final false
