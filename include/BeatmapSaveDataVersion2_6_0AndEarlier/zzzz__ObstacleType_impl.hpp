...
constexpr ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType::ObstacleType(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType::ObstacleType() {}
