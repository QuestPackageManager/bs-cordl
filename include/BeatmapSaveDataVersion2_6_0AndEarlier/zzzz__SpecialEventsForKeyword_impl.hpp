...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::*)()>(&::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::get_keyword)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3662228;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword*>::get(),
                        "get_keyword",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* (::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::*)()>(&::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::get_specialEvents)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3662230;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::*)(::StringW, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*)>(&::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3662238;
...
constexpr ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* const& BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::__cordl_internal_get__specialEvents() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____specialEvents;
}
constexpr void BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::__cordl_internal_set__specialEvents(::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword* BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword::New_ctor(::StringW  keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  specialEvents)  {
