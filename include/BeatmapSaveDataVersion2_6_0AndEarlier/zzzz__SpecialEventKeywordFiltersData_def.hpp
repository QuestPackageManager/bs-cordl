...
public:
  ...
  /// @brief Method get_keywords, addr 0x12bcbf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bcbf8, size 0x28, virtual false, abstract: false, final false
