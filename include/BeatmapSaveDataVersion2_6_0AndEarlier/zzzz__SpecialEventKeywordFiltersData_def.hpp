...
/// @brief Field _keywords, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__keywords, put=__cordl_internal_set__keywords)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword*>*  _keywords;
...
static inline ::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData* New_ctor(::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword*>*  keywords) ;
...
/// @brief Method .ctor, addr 0x369f564, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_keywords, addr 0x369f55c, size 0x8, virtual false, abstract: false, final false
