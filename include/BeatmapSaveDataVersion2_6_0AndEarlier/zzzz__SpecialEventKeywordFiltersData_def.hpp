...
public:
  ...
  /// @brief Method .ctor, addr 0x375b5bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_keywords, addr 0x375b5b4, size 0x8, virtual false, abstract: false, final false
