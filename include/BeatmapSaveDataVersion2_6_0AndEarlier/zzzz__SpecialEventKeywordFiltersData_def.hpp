...
public:
  ...
  /// @brief Method .ctor, addr 0x369e1d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_keywords, addr 0x369e1c8, size 0x8, virtual false, abstract: false, final false
