...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData*, "BeatmapSaveDataVersion2_6_0AndEarlier", "SpecialEventKeywordFiltersData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375fd4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_keywords, addr 0x375fd44, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SpecialEventKeywordFiltersData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SpecialEventKeywordFiltersData(SpecialEventKeywordFiltersData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SpecialEventKeywordFiltersData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SpecialEventKeywordFiltersData(SpecialEventKeywordFiltersDataconst&) = delete;
...
static_assert(sizeof(::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData) == 0x18, "Size mismatch!");
