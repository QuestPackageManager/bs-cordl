...
public:
  ...
  /// @brief Method ConvertBeatmapSaveDataPreV2_5_0Inline, addr 0x1401818, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1401788, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_events, addr 0x1401758, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::EventData*>* get_events();

  /// @brief Method get_notes, addr 0x1401760, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::NoteData*>* get_notes();

  /// @brief Method get_obstacles, addr 0x1401778, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData*>* get_obstacles();

  /// @brief Method get_sliders, addr 0x1401768, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::SliderData*>* get_sliders();

  /// @brief Method get_specialEventsKeywordFilters, addr 0x1401780, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData* get_specialEventsKeywordFilters();

  /// @brief Method get_version, addr 0x1401750, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_version();

  /// @brief Method get_waypoints, addr 0x1401770, size 0x8, virtual false, abstract: false, final false
