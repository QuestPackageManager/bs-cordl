...
namespace BeatmapSaveDataVersion2_6_0AndEarlier {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11194)), TypeDefinitionIndex(TypeDefinitionIndex(11199))]
...
public:
  ...
  /// @brief Method get_time, addr 0x12bcb68, size 0x8, virtual true, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_lineIndex, addr 0x12bcb70, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_type, addr 0x12bcb78, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType get_type();

  /// @brief Method get_duration, addr 0x12bcb80, size 0x8, virtual false, abstract: false, final false
  inline float_t get_duration();

  /// @brief Method get_width, addr 0x12bcb88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bcb90, size 0x54, virtual false, abstract: false, final false
