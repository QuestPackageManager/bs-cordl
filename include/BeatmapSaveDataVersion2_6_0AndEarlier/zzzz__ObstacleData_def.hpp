...
static inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData* New_ctor(float_t  time, int32_t  lineIndex, ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType  type, float_t  duration, int32_t  width) ;
...
/// @brief Method .ctor, addr 0x36621f8, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_duration, addr 0x36621e8, size 0x8, virtual false, abstract: false, final false
inline float_t get_duration() ;

/// @brief Method get_lineIndex, addr 0x36621d8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_lineIndex() ;

/// @brief Method get_time, addr 0x36621d0, size 0x8, virtual true, abstract: false, final false
inline float_t get_time() ;

/// @brief Method get_type, addr 0x36621e0, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType get_type() ;

/// @brief Method get_width, addr 0x36621f0, size 0x8, virtual false, abstract: false, final false
