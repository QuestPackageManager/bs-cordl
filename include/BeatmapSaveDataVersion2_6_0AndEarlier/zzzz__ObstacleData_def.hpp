...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData*, "BeatmapSaveDataVersion2_6_0AndEarlier", "ObstacleData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375b594, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_duration, addr 0x375b584, size 0x8, virtual false, abstract: false, final false
  inline float_t get_duration();

  /// @brief Method get_lineIndex, addr 0x375b574, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_time, addr 0x375b56c, size 0x8, virtual true, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_type, addr 0x375b57c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType get_type();

  /// @brief Method get_width, addr 0x375b58c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData) == 0x28, "Size mismatch!");
