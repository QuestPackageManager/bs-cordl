...
public:
  ...
  /// @brief Method .ctor, addr 0x1401df4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_duration, addr 0x1401de4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_duration();

  /// @brief Method get_lineIndex, addr 0x1401dd4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_time, addr 0x1401dcc, size 0x8, virtual true, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_type, addr 0x1401ddc, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType get_type();

  /// @brief Method get_width, addr 0x1401dec, size 0x8, virtual false, abstract: false, final false
