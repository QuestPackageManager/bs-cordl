...
public:
  ...
  /// @brief Method .ctor, addr 0x270b33c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* specialEvents);

  /// @brief Method get_keyword, addr 0x270b32c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_keyword();

  /// @brief Method get_specialEvents, addr 0x270b334, size 0x8, virtual false, abstract: false, final false
