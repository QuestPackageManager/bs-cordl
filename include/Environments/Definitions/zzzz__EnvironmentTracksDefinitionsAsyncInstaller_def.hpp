...
public:
  ...
  /// @brief Method InstallBindings, addr 0x3232168, size 0xc8, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x32320f4, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32323dc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x32320b0, size 0x44, virtual true, abstract: false, final false
