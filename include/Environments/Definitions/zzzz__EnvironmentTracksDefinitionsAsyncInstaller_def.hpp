...
/// @brief Method InstallBindings, addr 0x31f6438, size 0xc8, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method LoadResourcesBeforeInstall, addr 0x31f63c4, size 0x74, virtual true, abstract: false, final false
inline void LoadResourcesBeforeInstall(::System::Collections::Generic::IList_1<::UnityW<::BeatSaber::TrackDefinitions::EnvironmentTracksDefinitionSO>>*  tracksDefinitions, ::BGLib::AppFlow::Initialization::AsyncInstaller_IInstallerRegistry*  registry) ;
...
/// @brief Method .ctor, addr 0x31f66ac, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_assetLabelRuntimeKey, addr 0x31f6380, size 0x44, virtual true, abstract: false, final false
