...
public:
  ...
  /// @brief Method InstallBindings, addr 0x22829a4, size 0xac, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x228294c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2282bf0, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x228290c, size 0x40, virtual true, abstract: false, final false
