...
public:
  // Declarations
  /// @brief Field _environmentTracksDefinitionLabel, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__environmentTracksDefinitionLabel,
                      put = __cordl_internal_set__environmentTracksDefinitionLabel))::UnityEngine::AddressableAssets::AssetLabelReference* _environmentTracksDefinitionLabel;
...
static_assert(offsetof(::Environments::Definitions::EnvironmentTracksDefinitionsAsyncInstaller, ____environmentTracksDefinitionLabel) == 0x40, "Offset mismatch!");
