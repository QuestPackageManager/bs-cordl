...
public:
  ...
  __declspec(property(get = __cordl_internal_get__environmentTracksDefinitions, put = __cordl_internal_set__environmentTracksDefinitions))::System::Collections::Generic::List_1<
      ::UnityW<::BeatSaber::TrackDefinitions::EnvironmentTracksDefinitionSO>>* _environmentTracksDefinitions;

  __declspec(property(get = get_assetLabelRuntimeKey))::StringW assetLabelRuntimeKey;

  /// @brief Method InstallBindings, addr 0x106f8e8, size 0xb0, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x106f890, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x106fb40, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x106f850, size 0x40, virtual true, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::Environments::Definitions::EnvironmentTracksDefinitionsAsyncInstaller, 0x48>, "Size mismatch!");
