...
public:
  ...
  /// @brief Method InstallBindings, addr 0x1076584, size 0xb0, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x107652c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10767dc, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x10764ec, size 0x40, virtual true, abstract: false, final false
