...
public:
  ...
  /// @brief Method <LoadResourcesBeforeInstall>b__3_0, addr 0x271b680, size 0x18, virtual false, abstract: false, final false
  inline int32_t _LoadResourcesBeforeInstall_b__3_0(::GlobalNamespace::EnvironmentInfoSO* environmentInfo);

  /// @brief Method .ctor, addr 0x271b678, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x271b458, size 0xb0, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadEnvironmentInfoListAsync, addr 0x271b508, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadResourcesBeforeInstall, addr 0x271b334, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x271b58c, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x271b2f4, size 0x40, virtual true, abstract: false, final false
