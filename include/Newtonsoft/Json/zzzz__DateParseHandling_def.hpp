...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::DateParseHandling, "Newtonsoft.Json", "DateParseHandling");
// Dependencies
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::DateParseHandling) == 0x4, "Size mismatch!");
