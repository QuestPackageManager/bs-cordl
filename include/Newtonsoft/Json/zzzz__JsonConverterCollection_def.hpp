...
namespace Newtonsoft::Json {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(3813)), TypeDefinitionIndex(TypeDefinitionIndex(11728)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3813), inst:
// 1017 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(11729)) CS Name: ::Newtonsoft.Json::JsonConverterCollection*
...
public:
  ...
  /// @brief Method .ctor, addr 0x266e6e8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
