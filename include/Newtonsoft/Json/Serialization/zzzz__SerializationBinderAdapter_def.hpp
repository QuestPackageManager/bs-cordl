...
public:
  ...
  /// @brief Method BindToName, addr 0x5d583dc, size 0x1c, virtual true, abstract: false, final true
  inline void BindToName(::System::Type* serializedType, ::by_ref<::StringW> assemblyName, ::by_ref<::StringW> typeName);

  /// @brief Method BindToType, addr 0x5d583c0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5d583b8, size 0x8, virtual false, abstract: false, final false
