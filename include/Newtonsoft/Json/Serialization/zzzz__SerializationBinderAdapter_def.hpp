...
public:
  ...
  /// @brief Method BindToName, addr 0x3ef9ef0, size 0x20, virtual true, abstract: false, final true
  inline void BindToName(::System::Type* serializedType, ::ByRef<::StringW> assemblyName, ::ByRef<::StringW> typeName);

  /// @brief Method BindToType, addr 0x3ef9ed0, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ef9ea8, size 0x28, virtual false, abstract: false, final false
