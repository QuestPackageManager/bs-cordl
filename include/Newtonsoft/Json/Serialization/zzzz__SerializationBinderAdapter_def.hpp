...
public:
  ...
  /// @brief Method BindToName, addr 0x5c1e63c, size 0x1c, virtual true, abstract: false, final true
  inline void BindToName(::System::Type* serializedType, ::ByRef<::StringW> assemblyName, ::ByRef<::StringW> typeName);

  /// @brief Method BindToType, addr 0x5c1e620, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5c1e618, size 0x8, virtual false, abstract: false, final false
