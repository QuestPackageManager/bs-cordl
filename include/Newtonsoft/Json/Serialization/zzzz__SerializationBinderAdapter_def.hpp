...
/// @brief Method BindToName, addr 0x5bac654, size 0x1c, virtual true, abstract: false, final true
inline void BindToName(::System::Type*  serializedType, ::ByRef<::StringW>  assemblyName, ::ByRef<::StringW>  typeName) ;

/// @brief Method BindToType, addr 0x5bac638, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5bac630, size 0x8, virtual false, abstract: false, final false
