...
public:
  ...
  /// @brief Method GetAttributes, addr 0x27bdaec, size 0x70, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::System::Attribute*>* GetAttributes(::System::Type* attributeType, bool inherit);

  /// @brief Method GetAttributes, addr 0x27bda80, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27bda18, size 0x68, virtual false, abstract: false, final false
