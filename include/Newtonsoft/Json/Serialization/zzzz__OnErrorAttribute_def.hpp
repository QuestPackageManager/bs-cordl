...
public:
  ...
  /// @brief Method .ctor, addr 0x5d59fbc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OnErrorAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OnErrorAttribute(OnErrorAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OnErrorAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OnErrorAttribute(OnErrorAttributeconst&) = delete;
