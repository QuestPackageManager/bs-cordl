...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver::*)()>(&::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver::_ctor)> {
  constexpr static std::size_t size = 0x94;
  constexpr static std::size_t addrs = 0x5b8700c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Newtonsoft::Json::Serialization::JsonContract* (::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver::*)(::System::Type*)>(&::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver::ResolveContract)> {
  constexpr static std::size_t size = 0x358;
  constexpr static std::size_t addrs = 0x5b87190;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Newtonsoft::Json::DefaultJsonNameTable* (::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver::*)()>(&::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver::GetNameTable)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x5b874e8;
...
::cordl_internals::setStaticField<::System::Object*, "TypeContractCacheLock", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver*>::get>(std::forward<::System::Object*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Object*, "TypeContractCacheLock", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver*>::get>();
}
...
::cordl_internals::setStaticField<::Newtonsoft::Json::DefaultJsonNameTable*, "NameTable", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver*>::get>(std::forward<::Newtonsoft::Json::DefaultJsonNameTable*>(value));
}
...
return ::cordl_internals::getStaticField<::Newtonsoft::Json::DefaultJsonNameTable*, "NameTable", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver*>::get>();
}
...
::cordl_internals::setStaticField<::System::Collections::Generic::Dictionary_2<::Newtonsoft::Json::Utilities::StructMultiKey_2<::System::Type*,::System::Type*>,::Newtonsoft::Json::Serialization::JsonContract*>*, "_contractCache", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver*>::get>(std::forward<::System::Collections::Generic::Dictionary_2<::Newtonsoft::Json::Utilities::StructMultiKey_2<::System::Type*,::System::Type*>,::Newtonsoft::Json::Serialization::JsonContract*>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::Dictionary_2<::Newtonsoft::Json::Utilities::StructMultiKey_2<::System::Type*,::System::Type*>,::Newtonsoft::Json::Serialization::JsonContract*>*, "_contractCache", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver*>::get>();
}
