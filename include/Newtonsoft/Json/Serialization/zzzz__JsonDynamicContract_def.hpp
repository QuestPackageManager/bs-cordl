...
public:
  ...
  /// @brief Method CreateCallSiteGetter, addr 0x292f410, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCallSiteSetter, addr 0x292f544, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetMember, addr 0x292f678, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method TrySetMember, addr 0x292f778, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2929910, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* underlyingType);

  /// @brief Method get_Properties, addr 0x292f3f8, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_Properties();

  /// @brief Method get_PropertyNameResolver, addr 0x292f400, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::StringW, ::StringW>* get_PropertyNameResolver();

  /// @brief Method set_PropertyNameResolver, addr 0x292f408, size 0x8, virtual false, abstract: false, final false
