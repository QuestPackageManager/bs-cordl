...
public:
  ...
  /// @brief Method .ctor addr 0x268e878 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetJsonConverterCreator>b__0 addr 0x268f088 size 0x49c virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x268f588 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetJsonConverterCreator>b__18_1 addr 0x268f590 size 0x18 virtual false final false
...
public:
  ...
  /// @brief Method GetDataContractAttribute addr 0x268e1bc size 0x94 virtual false final false
  static inline ::System::Runtime::Serialization::DataContractAttribute* GetDataContractAttribute(::System::Type* type);

  /// @brief Method GetDataMemberAttribute addr 0x268e250 size 0x240 virtual false final false
  ...
  /// @brief Method GetObjectMemberSerialization addr 0x268e490 size 0xf0 virtual false final false
  ...
  /// @brief Method GetJsonConverter addr 0x268e580 size 0xe4 virtual false final false
  static inline ::Newtonsoft::Json::JsonConverter* GetJsonConverter(::System::Object* attributeProvider);

  /// @brief Method CreateJsonConverterInstance addr 0x268e664 size 0xa8 virtual false final false
  ...
  /// @brief Method GetJsonConverterCreator addr 0x268e70c size 0x16c virtual false final false
  ...
  /// @brief Method GetTypeConverter addr 0x268e908 size 0x58 virtual false final false
  static inline ::System::ComponentModel::TypeConverter* GetTypeConverter(::System::Type* type);

  /// @brief Method GetAssociatedMetadataType addr 0x268e960 size 0x80 virtual false final false
  static inline ::System::Type* GetAssociatedMetadataType(::System::Type* type);

  /// @brief Method GetAssociateMetadataTypeFromAttribute addr 0x268e9e0 size 0x268 virtual false final false
  ...
  /// @brief Method get_DynamicCodeGeneration addr 0x268ec48 size 0x2c8 virtual false final false
  static inline bool get_DynamicCodeGeneration();

  /// @brief Method get_FullyTrusted addr 0x268d598 size 0x1dc virtual false final false
  static inline bool get_FullyTrusted();

  /// @brief Method get_ReflectionDelegateFactory addr 0x268e880 size 0x88 virtual false final false
