...
public:
  ...
  /// @brief Method <GetCreator>b__22_1, addr 0x5baad90, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Type* _GetCreator_b__22_1(::System::Object* param);

  /// @brief Method .ctor, addr 0x5baad8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetCreator>b__0, addr 0x5baadec, size 0x470, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5baa70c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanTypeDescriptorConvertString, addr 0x5ba73a4, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJsonConverterInstance, addr 0x5baa2f8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNamingStrategyInstance, addr 0x5baa3f8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAssociateMetadataTypeFromAttribute, addr 0x5baa82c, size 0x234, virtual false, abstract: false, final false
  static inline ::System::Type* GetAssociateMetadataTypeFromAttribute(::System::Type* type);

  /// @brief Method GetAssociatedMetadataType, addr 0x5baa7a4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method GetContainerNamingStrategy, addr 0x5baa4f8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCreator, addr 0x5baa598, size 0x174, virtual false, abstract: false, final false
  static inline ::System::Func_2<::ArrayW<::System::Object*, ::Array<::System::Object*>*>, ::System::Object*>* GetCreator(::System::Type* type);

  /// @brief Method GetDataContractAttribute, addr 0x5ba9d3c, size 0xb4, virtual false, abstract: false, final false
  static inline ::System::Runtime::Serialization::DataContractAttribute* GetDataContractAttribute(::System::Type* type);

  /// @brief Method GetDataMemberAttribute, addr 0x5ba9df0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method GetJsonConverter, addr 0x5baa1c8, size 0x130, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::JsonConverter* GetJsonConverter(::System::Object* attributeProvider);

  /// @brief Method GetObjectMemberSerialization, addr 0x5baa064, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNonSerializable, addr 0x5baaa60, size 0x84, virtual false, abstract: false, final false
  static inline bool IsNonSerializable(::System::Object* provider);

  /// @brief Method IsSerializable, addr 0x5baa144, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DynamicCodeGeneration, addr 0x5baaae4, size 0xd4, virtual false, abstract: false, final false
  static inline bool get_DynamicCodeGeneration();

  /// @brief Method get_FullyTrusted, addr 0x5ba925c, size 0xe4, virtual false, abstract: false, final false
  static inline bool get_FullyTrusted();

  /// @brief Method get_ReflectionDelegateFactory, addr 0x5baa710, size 0x94, virtual false, abstract: false, final false
