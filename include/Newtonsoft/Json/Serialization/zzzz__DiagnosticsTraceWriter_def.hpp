...
public:
  ...
  /// @brief Method GetTraceEventType, addr 0x2a49d6c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x2a49ddc, size 0x490, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a4a26c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LevelFilter, addr 0x2a49d5c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LevelFilter, addr 0x2a49d64, size 0x8, virtual false, abstract: false, final false
