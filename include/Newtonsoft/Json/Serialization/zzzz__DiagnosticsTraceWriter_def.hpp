...
public:
  ...
  /// @brief Method GetTraceEventType, addr 0x5d3e744, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x5d3e7ac, size 0x460, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5d3ec0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LevelFilter, addr 0x5d3e734, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LevelFilter, addr 0x5d3e73c, size 0x8, virtual false, abstract: false, final false
