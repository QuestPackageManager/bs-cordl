...
public:
  ...
  /// @brief Method GetTraceEventType, addr 0x2a2b6e0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x2a2b750, size 0x490, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a2bbe0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LevelFilter, addr 0x2a2b6d0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LevelFilter, addr 0x2a2b6d8, size 0x8, virtual false, abstract: false, final false
