...
public:
  ...
  /// @brief Method GetTraceEventType, addr 0x3ef1f58, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x3ef1fc4, size 0x478, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ef243c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LevelFilter, addr 0x3ef1f48, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LevelFilter, addr 0x3ef1f50, size 0x8, virtual false, abstract: false, final false
