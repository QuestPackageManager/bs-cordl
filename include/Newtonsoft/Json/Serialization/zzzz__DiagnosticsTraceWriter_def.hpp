...
public:
  ...
  /// @brief Method GetTraceEventType, addr 0x3ee4a0c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x3ee4a78, size 0x478, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ee4ef0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LevelFilter, addr 0x3ee49fc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LevelFilter, addr 0x3ee4a04, size 0x8, virtual false, abstract: false, final false
