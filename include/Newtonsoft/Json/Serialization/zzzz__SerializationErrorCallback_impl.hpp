...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Serialization::SerializationErrorCallback::*)(::System::Object*, ::System::IntPtr)>(
  ...
  constexpr static std::size_t addrs = 0x5d3fa08;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Serialization::SerializationErrorCallback::*)(
  ...
  constexpr static std::size_t addrs = 0x5d3fb50;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::IAsyncResult* (
  ...
  constexpr static std::size_t addrs = 0x5d3fb64;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Serialization::SerializationErrorCallback*>(),
                                                                                          { ::i2c::class_of<::Newtonsoft::Json::Serialization::SerializationErrorCallback*>(), 14 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Serialization::SerializationErrorCallback::*)(::System::IAsyncResult*)>(
  ...
  constexpr static std::size_t addrs = 0x5d3fc00;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Serialization::SerializationErrorCallback*>(),
                                                                                          { ::i2c::class_of<::Newtonsoft::Json::Serialization::SerializationErrorCallback*>(), 15 }));
    return ___internal_method;
  }
};
...
inline ::System::IAsyncResult* Newtonsoft::Json::Serialization::SerializationErrorCallback::BeginInvoke(::System::Object* o, ::System::Runtime::Serialization::StreamingContext context,
  ...
  return ::cordl_internals::RunMethodRethrow<::System::IAsyncResult*>(this, ___internal_method, o, context, errorContext, callback, object);
}
inline void Newtonsoft::Json::Serialization::SerializationErrorCallback::EndInvoke(::System::IAsyncResult* result) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Serialization::SerializationErrorCallback*>(), 15 })));
