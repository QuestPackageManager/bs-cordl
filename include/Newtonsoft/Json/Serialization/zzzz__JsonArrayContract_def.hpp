...
public:
  ...
  /// @brief Method CreateTemporaryCollection, addr 0x3ef2d74, size 0x258, virtual false, abstract: false, final false
  inline ::System::Collections::IList* CreateTemporaryCollection();

  /// @brief Method CreateWrapper, addr 0x3ef29b0, size 0x3c4, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreFSharpListCreatorIfNecessary, addr 0x3ef289c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3eed790, size 0xd18, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* underlyingType);

  /// @brief Method get_CanDeserialize, addr 0x3ef256c, size 0x8, virtual false, abstract: false, final false
  inline bool get_CanDeserialize();

  /// @brief Method get_CollectionItemType, addr 0x3ef254c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_CollectionItemType();

  /// @brief Method get_HasParameterizedCreator, addr 0x3ef2648, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasParameterizedCreator();

  /// @brief Method get_HasParameterizedCreatorInternal, addr 0x3ef265c, size 0x80, virtual false, abstract: false, final false
  inline bool get_HasParameterizedCreatorInternal();

  /// @brief Method get_IsArray, addr 0x3ef255c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsArray();

  /// @brief Method get_IsMultidimensionalArray, addr 0x3ef2554, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsMultidimensionalArray();

  /// @brief Method get_OverrideCreator, addr 0x3ef2640, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_OverrideCreator();

  /// @brief Method get_ParameterizedCreator, addr 0x3ef2580, size 0xc0, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator();

  /// @brief Method get_ShouldCreateWrapper, addr 0x3ef2564, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldCreateWrapper();

  /// @brief Method set_CanDeserialize, addr 0x3ef2574, size 0xc, virtual false, abstract: false, final false
  inline void set_CanDeserialize(bool value);

  /// @brief Method set_HasParameterizedCreator, addr 0x3ef2650, size 0xc, virtual false, abstract: false, final false
  inline void set_HasParameterizedCreator(bool value);

  /// @brief Method set_OverrideCreator, addr 0x3eee4a8, size 0x10, virtual false, abstract: false, final false
