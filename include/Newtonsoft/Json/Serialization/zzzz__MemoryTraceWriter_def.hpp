...
public:
  ...
  /// @brief Method GetTraceMessages, addr 0x5d59ad4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5d59adc, size 0x27c, virtual true, abstract: false, final false
