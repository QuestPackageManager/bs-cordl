...
public:
  ...
  /// @brief Method GetTraceMessages, addr 0x5d578ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5d578b4, size 0x27c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Trace, addr 0x5d575d0, size 0x2dc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5d57530, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LevelFilter, addr 0x5d57520, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LevelFilter, addr 0x5d57528, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::MemoryTraceWriter) == 0x28, "Size mismatch!");
