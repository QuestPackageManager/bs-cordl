...
public:
  ...
  /// @brief Method ResolvePropertyName, addr 0x5d3d990, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ResolvePropertyName(::StringW name);

  /// @brief Method .ctor, addr 0x5d3d998, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
