...
public:
  ...
  /// @brief Method GetUninitializedObject, addr 0x3ee9be8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3edc650, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* underlyingType);

  /// @brief Method get_CreatorParameters, addr 0x3edce08, size 0x68, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_CreatorParameters();

  /// @brief Method get_ExtensionDataGetter, addr 0x3ee976c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ExtensionDataGetter* get_ExtensionDataGetter();

  /// @brief Method get_ExtensionDataNameResolver, addr 0x3ee9784, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::StringW, ::StringW>* get_ExtensionDataNameResolver();

  /// @brief Method get_ExtensionDataSetter, addr 0x3ee975c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ExtensionDataSetter* get_ExtensionDataSetter();

  /// @brief Method get_ExtensionDataValueType, addr 0x3ee977c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ExtensionDataValueType();

  /// @brief Method get_HasRequiredOrDefaultValueProperties, addr 0x3ee9794, size 0x418, virtual false, abstract: false, final false
  inline bool get_HasRequiredOrDefaultValueProperties();

  /// @brief Method get_ItemNullValueHandling, addr 0x3ee9724, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::Newtonsoft::Json::NullValueHandling> get_ItemNullValueHandling();

  /// @brief Method get_ItemRequired, addr 0x3ee9714, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::Newtonsoft::Json::Required> get_ItemRequired();

  /// @brief Method get_MemberSerialization, addr 0x3ee96f4, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::MemberSerialization get_MemberSerialization();

  /// @brief Method get_MissingMemberHandling, addr 0x3ee9704, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ParameterizedCreator, addr 0x3ee974c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator();

  /// @brief Method get_Properties, addr 0x3ee9734, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_Properties();

  /// @brief Method set_ExtensionDataGetter, addr 0x3ee9774, size 0x8, virtual false, abstract: false, final false
  inline void set_ExtensionDataGetter(::Newtonsoft::Json::Serialization::ExtensionDataGetter* value);

  /// @brief Method set_ExtensionDataNameResolver, addr 0x3ee978c, size 0x8, virtual false, abstract: false, final false
  inline void set_ExtensionDataNameResolver(::System::Func_2<::StringW, ::StringW>* value);

  /// @brief Method set_ExtensionDataSetter, addr 0x3ee9764, size 0x8, virtual false, abstract: false, final false
  inline void set_ExtensionDataSetter(::Newtonsoft::Json::Serialization::ExtensionDataSetter* value);

  /// @brief Method set_ExtensionDataValueType, addr 0x3ede0b8, size 0xd4, virtual false, abstract: false, final false
  inline void set_ExtensionDataValueType(::System::Type* value);

  /// @brief Method set_ItemNullValueHandling, addr 0x3ee972c, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemNullValueHandling(::System::Nullable_1<::Newtonsoft::Json::NullValueHandling> value);

  /// @brief Method set_ItemRequired, addr 0x3ee971c, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemRequired(::System::Nullable_1<::Newtonsoft::Json::Required> value);

  /// @brief Method set_MemberSerialization, addr 0x3ee96fc, size 0x8, virtual false, abstract: false, final false
  inline void set_MemberSerialization(::Newtonsoft::Json::MemberSerialization value);

  /// @brief Method set_MissingMemberHandling, addr 0x3ee970c, size 0x8, virtual false, abstract: false, final false
  inline void set_MissingMemberHandling(::System::Nullable_1<::Newtonsoft::Json::MissingMemberHandling> value);

  /// @brief Method set_OverrideCreator, addr 0x3ee9744, size 0x8, virtual false, abstract: false, final false
  inline void set_OverrideCreator(::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* value);

  /// @brief Method set_ParameterizedCreator, addr 0x3ee9754, size 0x8, virtual false, abstract: false, final false
