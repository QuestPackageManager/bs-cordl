...
public:
  ...
  /// @brief Method .ctor, addr 0x3ee95d8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* currentObject, ::Newtonsoft::Json::Serialization::ErrorContext* errorContext);

  /// @brief Method get_CurrentObject, addr 0x3ee95c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_CurrentObject();

  /// @brief Method get_ErrorContext, addr 0x3ee95d0, size 0x8, virtual false, abstract: false, final false
