...
public:
  ...
  /// @brief Method System.Collections.Generic.IEqualityComparer<System.Object>.Equals, addr 0x29316d8, size 0xc, virtual true, abstract: false, final true
  inline bool System_Collections_Generic_IEqualityComparer_System_Object__Equals(::System::Object* x, ::System::Object* y);

  /// @brief Method System.Collections.Generic.IEqualityComparer<System.Object>.GetHashCode, addr 0x29316e4, size 0xc, virtual true, abstract: false, final true
  inline int32_t System_Collections_Generic_IEqualityComparer_System_Object__GetHashCode(::System::Object* obj);

  /// @brief Method .ctor, addr 0x293111c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClearErrorContext, addr 0x293129c, size 0x64, virtual false, abstract: false, final false
  inline void ClearErrorContext();

  /// @brief Method GetErrorContext, addr 0x29311b0, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method IsErrorHandled, addr 0x2931300, size 0x3d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolvedNullValueHandling, addr 0x2931124, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2931098, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method get_DefaultReferenceMappings, addr 0x292c188, size 0x110, virtual false, abstract: false, final false
