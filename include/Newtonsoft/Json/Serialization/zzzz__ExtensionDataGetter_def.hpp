...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3ef348c, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::Object* o, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x3ef34ac, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x3ef3478, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ee9b14, size 0x100, virtual false, abstract: false, final false
