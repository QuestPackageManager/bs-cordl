...
public:
  ...
  /// @brief Method CalculatePropertyValues, addr 0x277ca04, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForCircularReference, addr 0x277bba4, size 0x55c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetContractSafe, addr 0x27785b0, size 0xd4, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContractSafe(::System::Object* value);

  /// @brief Method GetInternalSerializer, addr 0x27790f8, size 0x6c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonSerializerProxy* GetInternalSerializer();

  /// @brief Method GetPropertyName, addr 0x277cdf8, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method GetReference, addr 0x277c100, size 0x1ec, virtual false, abstract: false, final false
  inline ::StringW GetReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method HandleError, addr 0x2779080, size 0x78, virtual false, abstract: false, final false
  inline void HandleError(::Newtonsoft::Json::JsonWriter* writer, int32_t initialDepth);

  /// @brief Method HasFlag, addr 0x277bb98, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::DefaultValueHandling value, ::Newtonsoft::Json::DefaultValueHandling flag);

  /// @brief Method HasFlag, addr 0x277ba94, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::PreserveReferencesHandling value, ::Newtonsoft::Json::PreserveReferencesHandling flag);

  /// @brief Method HasFlag, addr 0x277d88c, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::TypeNameHandling value, ::Newtonsoft::Json::TypeNameHandling flag);

  /// @brief Method IsSpecified, addr 0x277d3c8, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSerialized, addr 0x277c6c8, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSerializing, addr 0x277c4c0, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveIsReference, addr 0x277b9e4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x2778350, size 0x260, virtual false, abstract: false, final false
  inline void Serialize(::Newtonsoft::Json::JsonWriter* jsonWriter, ::System::Object* value, ::System::Type* objectType);

  /// @brief Method SerializeConvertable, addr 0x2779798, size 0x524, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDictionary, addr 0x277ad10, size 0x870, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeISerializable, addr 0x277b580, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeList, addr 0x277a3e0, size 0x6f4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeMultidimensionalArray, addr 0x277aad4, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeMultidimensionalArray, addr 0x277db34, size 0x36c, virtual false, abstract: false, final false
  inline void SerializeMultidimensionalArray(::Newtonsoft::Json::JsonWriter* writer, ::System::Array* values, ::Newtonsoft::Json::Serialization::JsonArrayContract* contract,
                                             ::Newtonsoft::Json::Serialization::JsonProperty* member, int32_t initialDepth, ::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method SerializeObject, addr 0x2779cbc, size 0x724, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializePrimitive, addr 0x27791e0, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeString, addr 0x277ac90, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeValue, addr 0x2778aa0, size 0x5e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldSerialize, addr 0x277d158, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteDynamicProperty, addr 0x277e07c, size 0xbc, virtual false, abstract: false, final false
  inline bool ShouldWriteDynamicProperty(::System::Object* memberValue);

  /// @brief Method ShouldWriteProperty, addr 0x277baa0, size 0xf8, virtual false, abstract: false, final false
  inline bool ShouldWriteProperty(::System::Object* memberValue, ::Newtonsoft::Json::Serialization::JsonProperty* property);

  /// @brief Method ShouldWriteReference, addr 0x2778684, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteType, addr 0x2779348, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertToString, addr 0x277c2ec, size 0x1d4, virtual false, abstract: false, final false
  static inline bool TryConvertToString(::System::Object* value, ::System::Type* type, ByRef<::StringW> s);

  /// @brief Method WriteObjectStart, addr 0x277c8d0, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteReference, addr 0x277881c, size 0x284, virtual false, abstract: false, final false
  inline void WriteReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method WriteReferenceIdProperty, addr 0x277d638, size 0x254, virtual false, abstract: false, final false
  inline void WriteReferenceIdProperty(::Newtonsoft::Json::JsonWriter* writer, ::System::Type* type, ::System::Object* value);

  /// @brief Method WriteStartArray, addr 0x277d898, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteTypeProperty, addr 0x2779510, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27782c4, size 0x8c, virtual false, abstract: false, final false
