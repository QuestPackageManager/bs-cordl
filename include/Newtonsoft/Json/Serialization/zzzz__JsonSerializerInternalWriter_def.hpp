...
namespace Newtonsoft::Json::Serialization {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11878))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2524278 size 0x8c virtual false final false
  inline void _ctor(::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method Serialize addr 0x2524304 size 0x260 virtual false final false
  inline void Serialize(::Newtonsoft::Json::JsonWriter* jsonWriter, ::System::Object* value, ::System::Type* objectType);

  /// @brief Method GetInternalSerializer addr 0x25250ac size 0x6c virtual false final false
  inline ::Newtonsoft::Json::Serialization::JsonSerializerProxy* GetInternalSerializer();

  /// @brief Method GetContractSafe addr 0x2524564 size 0xd4 virtual false final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContractSafe(::System::Object* value);

  /// @brief Method SerializePrimitive addr 0x2525194 size 0x168 virtual false final false
  ...
  /// @brief Method SerializeValue addr 0x2524a54 size 0x5e0 virtual false final false
  ...
  /// @brief Method ResolveIsReference addr 0x2527998 size 0xb0 virtual false final false
  ...
  /// @brief Method ShouldWriteReference addr 0x2524638 size 0x198 virtual false final false
  ...
  /// @brief Method ShouldWriteProperty addr 0x2527a54 size 0xf8 virtual false final false
  inline bool ShouldWriteProperty(::System::Object* memberValue, ::Newtonsoft::Json::Serialization::JsonProperty* property);

  /// @brief Method CheckForCircularReference addr 0x2527b58 size 0x55c virtual false final false
  ...
  /// @brief Method WriteReference addr 0x25247d0 size 0x284 virtual false final false
  inline void WriteReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method GetReference addr 0x25280b4 size 0x1ec virtual false final false
  inline ::StringW GetReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method TryConvertToString addr 0x25282a0 size 0x1d4 virtual false final false
  static inline bool TryConvertToString(::System::Object* value, ::System::Type* type, ByRef<::StringW> s);

  /// @brief Method SerializeString addr 0x2526c44 size 0x80 virtual false final false
  ...
  /// @brief Method OnSerializing addr 0x2528474 size 0x208 virtual false final false
  ...
  /// @brief Method OnSerialized addr 0x252867c size 0x208 virtual false final false
  ...
  /// @brief Method SerializeObject addr 0x2525c70 size 0x724 virtual false final false
  ...
  /// @brief Method CalculatePropertyValues addr 0x25289b8 size 0x3f4 virtual false final false
  ...
  /// @brief Method WriteObjectStart addr 0x2528884 size 0x134 virtual false final false
  ...
  /// @brief Method SerializeList addr 0x2526394 size 0x6f4 virtual false final false
  ...
  /// @brief Method SerializeMultidimensionalArray addr 0x2526a88 size 0x1bc virtual false final false
  ...
  /// @brief Method SerializeMultidimensionalArray addr 0x2529ae8 size 0x36c virtual false final false
  inline void SerializeMultidimensionalArray(::Newtonsoft::Json::JsonWriter* writer, ::System::Array* values, ::Newtonsoft::Json::Serialization::JsonArrayContract* contract,
                                             ::Newtonsoft::Json::Serialization::JsonProperty* member, int32_t initialDepth, ::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method WriteStartArray addr 0x252984c size 0x29c virtual false final false
  ...
  /// @brief Method SerializeISerializable addr 0x2527534 size 0x464 virtual false final false
  ...
  /// @brief Method ShouldWriteDynamicProperty addr 0x252a030 size 0xbc virtual false final false
  inline bool ShouldWriteDynamicProperty(::System::Object* memberValue);

  /// @brief Method ShouldWriteType addr 0x25252fc size 0x1c8 virtual false final false
  ...
  /// @brief Method SerializeDictionary addr 0x2526cc4 size 0x870 virtual false final false
  ...
  /// @brief Method GetPropertyName addr 0x2528dac size 0x360 virtual false final false
  ...
  /// @brief Method HandleError addr 0x2525034 size 0x78 virtual false final false
  inline void HandleError(::Newtonsoft::Json::JsonWriter* writer, int32_t initialDepth);

  /// @brief Method ShouldSerialize addr 0x252910c size 0x270 virtual false final false
  ...
  /// @brief Method IsSpecified addr 0x252937c size 0x270 virtual false final false
