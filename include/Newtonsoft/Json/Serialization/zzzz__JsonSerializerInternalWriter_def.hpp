...
public:
  ...
  /// @brief Method .ctor addr 0x26879bc size 0x8c virtual false final false
  inline void _ctor(::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method Serialize addr 0x2687a48 size 0x260 virtual false final false
  inline void Serialize(::Newtonsoft::Json::JsonWriter* jsonWriter, ::System::Object* value, ::System::Type* objectType);

  /// @brief Method GetInternalSerializer addr 0x26887f0 size 0x6c virtual false final false
  inline ::Newtonsoft::Json::Serialization::JsonSerializerProxy* GetInternalSerializer();

  /// @brief Method GetContractSafe addr 0x2687ca8 size 0xd4 virtual false final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContractSafe(::System::Object* value);

  /// @brief Method SerializePrimitive addr 0x26888d8 size 0x168 virtual false final false
  ...
  /// @brief Method SerializeValue addr 0x2688198 size 0x5e0 virtual false final false
  ...
  /// @brief Method ResolveIsReference addr 0x268b0dc size 0xb0 virtual false final false
  ...
  /// @brief Method ShouldWriteReference addr 0x2687d7c size 0x198 virtual false final false
  ...
  /// @brief Method ShouldWriteProperty addr 0x268b198 size 0xf8 virtual false final false
  inline bool ShouldWriteProperty(::System::Object* memberValue, ::Newtonsoft::Json::Serialization::JsonProperty* property);

  /// @brief Method CheckForCircularReference addr 0x268b29c size 0x55c virtual false final false
  ...
  /// @brief Method WriteReference addr 0x2687f14 size 0x284 virtual false final false
  inline void WriteReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method GetReference addr 0x268b7f8 size 0x1ec virtual false final false
  inline ::StringW GetReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method TryConvertToString addr 0x268b9e4 size 0x1d4 virtual false final false
  static inline bool TryConvertToString(::System::Object* value, ::System::Type* type, ByRef<::StringW> s);

  /// @brief Method SerializeString addr 0x268a388 size 0x80 virtual false final false
  ...
  /// @brief Method OnSerializing addr 0x268bbb8 size 0x208 virtual false final false
  ...
  /// @brief Method OnSerialized addr 0x268bdc0 size 0x208 virtual false final false
  ...
  /// @brief Method SerializeObject addr 0x26893b4 size 0x724 virtual false final false
  ...
  /// @brief Method CalculatePropertyValues addr 0x268c0fc size 0x3f4 virtual false final false
  ...
  /// @brief Method WriteObjectStart addr 0x268bfc8 size 0x134 virtual false final false
  ...
  /// @brief Method SerializeList addr 0x2689ad8 size 0x6f4 virtual false final false
  ...
  /// @brief Method SerializeMultidimensionalArray addr 0x268a1cc size 0x1bc virtual false final false
  ...
  /// @brief Method SerializeMultidimensionalArray addr 0x268d22c size 0x36c virtual false final false
  inline void SerializeMultidimensionalArray(::Newtonsoft::Json::JsonWriter* writer, ::System::Array* values, ::Newtonsoft::Json::Serialization::JsonArrayContract* contract,
                                             ::Newtonsoft::Json::Serialization::JsonProperty* member, int32_t initialDepth, ::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method WriteStartArray addr 0x268cf90 size 0x29c virtual false final false
  ...
  /// @brief Method SerializeISerializable addr 0x268ac78 size 0x464 virtual false final false
  ...
  /// @brief Method ShouldWriteDynamicProperty addr 0x268d774 size 0xbc virtual false final false
  inline bool ShouldWriteDynamicProperty(::System::Object* memberValue);

  /// @brief Method ShouldWriteType addr 0x2688a40 size 0x1c8 virtual false final false
  ...
  /// @brief Method SerializeDictionary addr 0x268a408 size 0x870 virtual false final false
  ...
  /// @brief Method GetPropertyName addr 0x268c4f0 size 0x360 virtual false final false
  ...
  /// @brief Method HandleError addr 0x2688778 size 0x78 virtual false final false
  inline void HandleError(::Newtonsoft::Json::JsonWriter* writer, int32_t initialDepth);

  /// @brief Method ShouldSerialize addr 0x268c850 size 0x270 virtual false final false
  ...
  /// @brief Method IsSpecified addr 0x268cac0 size 0x270 virtual false final false
