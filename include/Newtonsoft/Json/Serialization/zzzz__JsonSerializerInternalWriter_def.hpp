...
public:
  ...
  /// @brief Method CalculatePropertyValues, addr 0x5b41030, size 0x438, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForCircularReference, addr 0x5b400e8, size 0x4f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetContract, addr 0x5b3cd94, size 0xd0, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContract(::System::Object* value);

  /// @brief Method GetContractSafe, addr 0x5b3c120, size 0x10, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContractSafe(::System::Object* value);

  /// @brief Method GetInternalSerializer, addr 0x5b3ccac, size 0x68, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonSerializerProxy* GetInternalSerializer();

  /// @brief Method GetPropertyName, addr 0x5b41468, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetReference, addr 0x5b405d8, size 0x1f4, virtual false, abstract: false, final false
  inline ::StringW GetReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method HandleError, addr 0x5b3cc34, size 0x78, virtual false, abstract: false, final false
  inline void HandleError(::Newtonsoft::Json::JsonWriter* writer, int32_t initialDepth);

  /// @brief Method HasCreatorParameter, addr 0x5b41e1c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasFlag, addr 0x5b400dc, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::DefaultValueHandling value, ::Newtonsoft::Json::DefaultValueHandling flag);

  /// @brief Method HasFlag, addr 0x5b40000, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::PreserveReferencesHandling value, ::Newtonsoft::Json::PreserveReferencesHandling flag);

  /// @brief Method HasFlag, addr 0x5b42148, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::TypeNameHandling value, ::Newtonsoft::Json::TypeNameHandling flag);

  /// @brief Method IsSpecified, addr 0x5b41bbc, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSerialized, addr 0x5b40cc0, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSerializing, addr 0x5b40aa8, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveIsReference, addr 0x5b3ff40, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x5b3bea4, size 0x27c, virtual false, abstract: false, final false
  inline void Serialize(::Newtonsoft::Json::JsonWriter* jsonWriter, ::System::Object* value, ::System::Type* objectType);

  /// @brief Method SerializeConvertable, addr 0x5b3d448, size 0x52c, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDictionary, addr 0x5b3ea48, size 0x880, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDynamic, addr 0x5b3f2c8, size 0x7d4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeISerializable, addr 0x5b3fa9c, size 0x4a4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeList, addr 0x5b3e0bc, size 0x6f8, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeMultidimensionalArray, addr 0x5b3e7b4, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeMultidimensionalArray, addr 0x5b423f4, size 0x388, virtual false, abstract: false, final false
  inline void SerializeMultidimensionalArray(::Newtonsoft::Json::JsonWriter* writer, ::System::Array* values, ::Newtonsoft::Json::Serialization::JsonArrayContract* contract,
                                             ::Newtonsoft::Json::Serialization::JsonProperty* member, int32_t initialDepth, ::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method SerializeObject, addr 0x5b3d974, size 0x748, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializePrimitive, addr 0x5b3ce64, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeString, addr 0x5b3e9c8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeValue, addr 0x5b3c57c, size 0x6b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldSerialize, addr 0x5b4195c, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteDynamicProperty, addr 0x5b42860, size 0xc8, virtual false, abstract: false, final false
  inline bool ShouldWriteDynamicProperty(::System::Object* memberValue);

  /// @brief Method ShouldWriteProperty, addr 0x5b4000c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteReference, addr 0x5b3c130, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteType, addr 0x5b3cfe0, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertToString, addr 0x5b407cc, size 0xf8, virtual false, abstract: false, final false
  static inline bool TryConvertToString(::System::Object* value, ::System::Type* type, ::ByRef<::StringW> s);

  /// @brief Method WriteObjectStart, addr 0x5b40ed8, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteReference, addr 0x5b3c2e4, size 0x298, virtual false, abstract: false, final false
  inline void WriteReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method WriteReferenceIdProperty, addr 0x5b41ee8, size 0x260, virtual false, abstract: false, final false
  inline void WriteReferenceIdProperty(::Newtonsoft::Json::JsonWriter* writer, ::System::Type* type, ::System::Object* value);

  /// @brief Method WriteStartArray, addr 0x5b42154, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteTypeProperty, addr 0x5b3d1b0, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b3be18, size 0x8c, virtual false, abstract: false, final false
