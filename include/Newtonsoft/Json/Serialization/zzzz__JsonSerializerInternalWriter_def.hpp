...
public:
  ...
  /// @brief Method CalculatePropertyValues, addr 0x3efa5fc, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForCircularReference, addr 0x3ef965c, size 0x570, virtual false, abstract: false, final false
  ...
  /// @brief Method GetContract, addr 0x3ef6360, size 0xc4, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContract(::System::Object* value);

  /// @brief Method GetContractSafe, addr 0x3ef5780, size 0x10, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContractSafe(::System::Object* value);

  /// @brief Method GetInternalSerializer, addr 0x3ef6280, size 0x64, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonSerializerProxy* GetInternalSerializer();

  /// @brief Method GetPropertyName, addr 0x3efaa28, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetReference, addr 0x3ef9bcc, size 0x1ec, virtual false, abstract: false, final false
  inline ::StringW GetReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method HandleError, addr 0x3ef6208, size 0x78, virtual false, abstract: false, final false
  inline void HandleError(::Newtonsoft::Json::JsonWriter* writer, int32_t initialDepth);

  /// @brief Method HasCreatorParameter, addr 0x3efb3dc, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasFlag, addr 0x3ef9650, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::DefaultValueHandling value, ::Newtonsoft::Json::DefaultValueHandling flag);

  /// @brief Method HasFlag, addr 0x3ef9570, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::PreserveReferencesHandling value, ::Newtonsoft::Json::PreserveReferencesHandling flag);

  /// @brief Method HasFlag, addr 0x3efb6e0, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::TypeNameHandling value, ::Newtonsoft::Json::TypeNameHandling flag);

  /// @brief Method IsSpecified, addr 0x3efb17c, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSerialized, addr 0x3efa2b0, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSerializing, addr 0x3efa0a8, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveIsReference, addr 0x3ef94c0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x3ef5518, size 0x268, virtual false, abstract: false, final false
  inline void Serialize(::Newtonsoft::Json::JsonWriter* jsonWriter, ::System::Object* value, ::System::Type* objectType);

  /// @brief Method SerializeConvertable, addr 0x3ef6a40, size 0x518, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDictionary, addr 0x3ef8018, size 0x898, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDynamic, addr 0x3ef88b0, size 0x7a4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeISerializable, addr 0x3ef9054, size 0x46c, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeList, addr 0x3ef76a8, size 0x6f8, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeMultidimensionalArray, addr 0x3ef7da0, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeMultidimensionalArray, addr 0x3efb9a0, size 0x378, virtual false, abstract: false, final false
  inline void SerializeMultidimensionalArray(::Newtonsoft::Json::JsonWriter* writer, ::System::Array* values, ::Newtonsoft::Json::Serialization::JsonArrayContract* contract,
                                             ::Newtonsoft::Json::Serialization::JsonProperty* member, int32_t initialDepth, ::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method SerializeObject, addr 0x3ef6f58, size 0x750, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializePrimitive, addr 0x3ef6424, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeString, addr 0x3ef7f98, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeValue, addr 0x3ef5ba8, size 0x660, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldSerialize, addr 0x3efaf1c, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteDynamicProperty, addr 0x3efbe24, size 0xbc, virtual false, abstract: false, final false
  inline bool ShouldWriteDynamicProperty(::System::Object* memberValue);

  /// @brief Method ShouldWriteProperty, addr 0x3ef957c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteReference, addr 0x3ef5790, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldWriteType, addr 0x3ef6594, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertToString, addr 0x3ef9db8, size 0x104, virtual false, abstract: false, final false
  static inline bool TryConvertToString(::System::Object* value, ::System::Type* type, ::ByRef<::StringW> s);

  /// @brief Method WriteObjectStart, addr 0x3efa4b8, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteReference, addr 0x3ef5924, size 0x284, virtual false, abstract: false, final false
  inline void WriteReference(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value);

  /// @brief Method WriteReferenceIdProperty, addr 0x3efb494, size 0x24c, virtual false, abstract: false, final false
  inline void WriteReferenceIdProperty(::Newtonsoft::Json::JsonWriter* writer, ::System::Type* type, ::System::Object* value);

  /// @brief Method WriteStartArray, addr 0x3efb6ec, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteTypeProperty, addr 0x3ef67c0, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ef5494, size 0x84, virtual false, abstract: false, final false
