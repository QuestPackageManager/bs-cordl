...
public:
  ...
  /// @brief Method GetValue, addr 0x3efeb84, size 0x298, virtual true, abstract: false, final true
  ...
  /// @brief Method SetValue, addr 0x3efe9e8, size 0x19c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3efe97c, size 0x6c, virtual false, abstract: false, final false
