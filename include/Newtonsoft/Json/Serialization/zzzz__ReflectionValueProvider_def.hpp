...
public:
  ...
  /// @brief Method GetValue, addr 0x3e9d1ec, size 0x298, virtual true, abstract: false, final true
  ...
  /// @brief Method SetValue, addr 0x3e9d050, size 0x19c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3e9cfe4, size 0x6c, virtual false, abstract: false, final false
