...
public:
  ...
  /// @brief Method AddProperty, addr 0x27632cc, size 0x234, virtual false, abstract: false, final false
  inline void AddProperty(::Newtonsoft::Json::Serialization::JsonProperty* property);

  /// @brief Method GetClosestMatchProperty, addr 0x276328c, size 0x40, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonProperty* GetClosestMatchProperty(::StringW propertyName);

  /// @brief Method GetKeyForItem, addr 0x276c420, size 0x18, virtual true, abstract: false, final false
  inline ::StringW GetKeyForItem(::Newtonsoft::Json::Serialization::JsonProperty* item);

  /// @brief Method GetProperty, addr 0x276c438, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetValue, addr 0x276c524, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x276312c, size 0x160, virtual false, abstract: false, final false
