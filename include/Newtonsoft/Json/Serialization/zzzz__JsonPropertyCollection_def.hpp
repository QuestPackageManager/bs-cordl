...
public:
  ...
  /// @brief Method AddProperty, addr 0x2a41d08, size 0x2bc, virtual false, abstract: false, final false
  inline void AddProperty(::Newtonsoft::Json::Serialization::JsonProperty* property);

  /// @brief Method GetClosestMatchProperty, addr 0x2a41fc4, size 0x40, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonProperty* GetClosestMatchProperty(::StringW propertyName);

  /// @brief Method GetKeyForItem, addr 0x2a4ddf4, size 0x18, virtual true, abstract: false, final false
  inline ::StringW GetKeyForItem(::Newtonsoft::Json::Serialization::JsonProperty* item);

  /// @brief Method GetProperty, addr 0x2a4de0c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetProperty, addr 0x2a4def8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a41bac, size 0x15c, virtual false, abstract: false, final false
