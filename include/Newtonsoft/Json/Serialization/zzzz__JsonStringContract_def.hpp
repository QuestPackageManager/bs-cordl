...
public:
  ...
  /// @brief Method .ctor, addr 0x5d55f58, size 0x78, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::JsonStringContract) == 0x90, "Size mismatch!");
