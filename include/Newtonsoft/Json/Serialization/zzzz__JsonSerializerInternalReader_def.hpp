...
public:
  ...
  /// @brief Method .ctor, addr 0x3ef5414, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <CreateObjectUsingCreatorWithParameters>b__38_0, addr 0x3ef54a0, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _CreateObjectUsingCreatorWithParameters_b__38_0(::Newtonsoft::Json::Serialization::JsonProperty* p);

  /// @brief Method <CreateObjectUsingCreatorWithParameters>b__38_2, addr 0x3ef54b8, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _CreateObjectUsingCreatorWithParameters_b__38_2(::Newtonsoft::Json::Serialization::JsonProperty* p);

  /// @brief Method <PopulateObject>b__42_0, addr 0x3ef54d0, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonProperty* _PopulateObject_b__42_0(::Newtonsoft::Json::Serialization::JsonProperty* m);

  /// @brief Method <PopulateObject>b__42_1, addr 0x3ef54d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ef5498, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CreateObjectUsingCreatorWithParameters>b__1, addr 0x3ef54e8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ef54e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddReference, addr 0x3ef1dac, size 0x3c0, virtual false, abstract: false, final false
  inline void AddReference(::Newtonsoft::Json::JsonReader* reader, ::StringW id, ::System::Object* value);

  /// @brief Method CalculatePropertyDetails, addr 0x3ef172c, size 0x57c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckPropertyName, addr 0x3eec778, size 0x11c, virtual false, abstract: false, final false
  inline bool CheckPropertyName(::Newtonsoft::Json::JsonReader* reader, ::StringW memberName);

  /// @brief Method CoerceEmptyStringToNull, addr 0x3eedf84, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDynamic, addr 0x3eef4a0, size 0x658, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateISerializable, addr 0x3eefaf8, size 0x698, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateISerializableItem, addr 0x3ee7618, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJObject, addr 0x3eec41c, size 0x35c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* CreateJObject(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method CreateJToken, addr 0x3eec004, size 0x418, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateList, addr 0x3eed390, size 0x634, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewDictionary, addr 0x3eef25c, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewList, addr 0x3ef08f4, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewObject, addr 0x3eef03c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObject, addr 0x3eec894, size 0xafc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObjectUsingCreatorWithParameters, addr 0x3ef26fc, size 0x1c80, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateValueInternal, addr 0x3eeba6c, size 0x4c0, virtual false, abstract: false, final false
  ...
  /// @brief Method Deserialize, addr 0x3eeb2b0, size 0x33c, virtual false, abstract: false, final false
  inline ::System::Object* Deserialize(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, bool checkAdditionalContent);

  /// @brief Method DeserializeConvertable, addr 0x3eeb658, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method EndProcessProperty, addr 0x3ef49e8, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureArrayContract, addr 0x3ef077c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureType, addr 0x3eed9c4, size 0x5c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetContract, addr 0x3eeb200, size 0xb0, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContract(::System::Type* type);

  /// @brief Method GetContractSafe, addr 0x3eeb174, size 0x8c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* GetContractSafe(::System::Type* type);

  /// @brief Method GetConverter, addr 0x3eeb5ec, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExpectedDescription, addr 0x3eee0b8, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW GetExpectedDescription(::Newtonsoft::Json::Serialization::JsonContract* contract);

  /// @brief Method GetInternalSerializer, addr 0x3eebf9c, size 0x68, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonSerializerProxy* GetInternalSerializer();

  /// @brief Method HandleError, addr 0x3eebf2c, size 0x70, virtual false, abstract: false, final false
  inline void HandleError(::Newtonsoft::Json::JsonReader* reader, bool readPastError, int32_t initialDepth);

  /// @brief Method HasFlag, addr 0x3ef1da0, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::Newtonsoft::Json::DefaultValueHandling value, ::Newtonsoft::Json::DefaultValueHandling flag);

  /// @brief Method HasNoDefinedType, addr 0x3eeef40, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x3ef2398, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserializing, addr 0x3ef216c, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate, addr 0x3ee92cc, size 0x530, virtual false, abstract: false, final false
  inline void Populate(::Newtonsoft::Json::JsonReader* reader, ::System::Object* target);

  /// @brief Method PopulateDictionary, addr 0x3ee9d30, size 0x9c8, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateList, addr 0x3ee97fc, size 0x534, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateMultidimensionalArray, addr 0x3ef0b78, size 0x6dc, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateObject, addr 0x3eea6f8, size 0xa7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadExtensionDataValue, addr 0x3ef4e74, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadMetadataProperties, addr 0x3eee8a4, size 0x69c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadMetadataPropertiesToken, addr 0x3eee170, size 0x734, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolvePropertyAndCreatorValues, addr 0x3ef437c, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveTypeName, addr 0x3ef0190, size 0x5ec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetExtensionData, addr 0x3ef4f30, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPropertyPresence, addr 0x3ef5304, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPropertyValue, addr 0x3ef1254, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldDeserialize, addr 0x3ef50a0, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldSetPropertyValue, addr 0x3ef1ca8, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowUnexpectedEndException, addr 0x3ef25c4, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ee92c8, size 0x4, virtual false, abstract: false, final false
