...
public:
  ...
  /// @brief Method GetMappings addr 0x250b078 size 0x110 virtual false final false
  inline ::Newtonsoft::Json::Utilities::BidirectionalDictionary_2<::StringW, ::System::Object*>* GetMappings(::System::Object* context);

  /// @brief Method ResolveReference addr 0x250b298 size 0x74 virtual true final true
  inline ::System::Object* ResolveReference(::System::Object* context, ::StringW reference);

  /// @brief Method GetReference addr 0x250b30c size 0xf4 virtual true final true
  inline ::StringW GetReference(::System::Object* context, ::System::Object* value);

  /// @brief Method AddReference addr 0x250b400 size 0x6c virtual true final true
  inline void AddReference(::System::Object* context, ::StringW reference, ::System::Object* value);

  /// @brief Method IsReferenced addr 0x250b46c size 0x74 virtual true final true
  ...
  /// @brief Method .ctor addr 0x250b4e0 size 0x8 virtual false final false
  inline void _ctor();
