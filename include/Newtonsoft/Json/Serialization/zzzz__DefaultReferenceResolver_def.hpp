...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Serialization::DefaultReferenceResolver*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Serialization::DefaultReferenceResolver*, "Newtonsoft.Json.Serialization", "DefaultReferenceResolver");
// [NullableContext(1)]
// [Nullable(0)]
...
public:
  ...
  /// @brief Method AddReference, addr 0x5d3ff78, size 0x70, virtual true, abstract: false, final true
  inline void AddReference(::System::Object* context, ::StringW reference, ::System::Object* value);

  /// @brief Method GetMappings, addr 0x5d3fbc4, size 0x11c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Utilities::BidirectionalDictionary_2<::StringW, ::System::Object*>* GetMappings(::System::Object* context);

  /// @brief Method GetReference, addr 0x5d3fe70, size 0x108, virtual true, abstract: false, final true
  inline ::StringW GetReference(::System::Object* context, ::System::Object* value);

  /// @brief Method IsReferenced, addr 0x5d3ffe8, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method ResolveReference, addr 0x5d3fdf8, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5d40060, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultReferenceResolver", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultReferenceResolver(DefaultReferenceResolver&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultReferenceResolver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultReferenceResolver(DefaultReferenceResolverconst&) = delete;
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::DefaultReferenceResolver) == 0x18, "Size mismatch!");
