...
public:
  ...
  /// @brief Method AddReference, addr 0x3ee3ff0, size 0x6c, virtual true, abstract: false, final true
  inline void AddReference(::System::Object* context, ::StringW reference, ::System::Object* value);

  /// @brief Method GetMappings, addr 0x3ee3c78, size 0x10c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Utilities::BidirectionalDictionary_2<::StringW, ::System::Object*>* GetMappings(::System::Object* context);

  /// @brief Method GetReference, addr 0x3ee3efc, size 0xf4, virtual true, abstract: false, final true
  inline ::StringW GetReference(::System::Object* context, ::System::Object* value);

  /// @brief Method IsReferenced, addr 0x3ee405c, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method ResolveReference, addr 0x3ee3e88, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ee40d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
