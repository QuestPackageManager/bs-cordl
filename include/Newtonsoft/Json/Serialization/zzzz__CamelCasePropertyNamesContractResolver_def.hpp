...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver*, "Newtonsoft.Json.Serialization", "CamelCasePropertyNamesContractResolver");
// [NullableContext(1)]
// [Nullable(0)]
...
public:
  ...
  /// @brief Method GetNameTable, addr 0x5d35498, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveContract, addr 0x5d35140, size 0x358, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* ResolveContract(::System::Type* type);

  /// @brief Method .ctor, addr 0x5d34fbc, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CamelCasePropertyNamesContractResolver", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CamelCasePropertyNamesContractResolver(CamelCasePropertyNamesContractResolver&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CamelCasePropertyNamesContractResolver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CamelCasePropertyNamesContractResolver(CamelCasePropertyNamesContractResolverconst&) = delete;
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::CamelCasePropertyNamesContractResolver) == 0x38, "Size mismatch!");
