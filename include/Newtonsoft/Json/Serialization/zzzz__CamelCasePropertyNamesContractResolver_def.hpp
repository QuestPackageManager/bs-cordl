...
public:
  ...
  /// @brief Method GetNameTable, addr 0x5b86fdc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveContract, addr 0x5b86c84, size 0x358, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* ResolveContract(::System::Type* type);

  /// @brief Method .ctor, addr 0x5b86b00, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
