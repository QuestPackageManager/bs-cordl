...
public:
  ...
  /// @brief Method GetNameTable, addr 0x3ed9474, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveContract, addr 0x3ed9150, size 0x324, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* ResolveContract(::System::Type* type);

  /// @brief Method .ctor, addr 0x3ed8fbc, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
