...
public:
  ...
  /// @brief Method GetNameTable, addr 0x2a3e5d8, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveContract, addr 0x2a3e2a0, size 0x338, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Serialization::JsonContract* ResolveContract(::System::Type* type);

  /// @brief Method .ctor, addr 0x2a3e10c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
