...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Newtonsoft::Json::Serialization::JsonContract* (::Newtonsoft::Json::Serialization::IContractResolver::*)(::System::Type*)>(&::Newtonsoft::Json::Serialization::IContractResolver::ResolveContract)> {
