...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::TypeNameAssemblyFormatHandling, "Newtonsoft.Json", "TypeNameAssemblyFormatHandling");
// Dependencies
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::TypeNameAssemblyFormatHandling) == 0x4, "Size mismatch!");
