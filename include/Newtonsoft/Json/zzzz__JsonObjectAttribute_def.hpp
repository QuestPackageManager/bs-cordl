...
/// @brief Method .ctor, addr 0x5b296fc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5b29708, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  id) ;

/// @brief Method .ctor, addr 0x5b29700, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::MemberSerialization  memberSerialization) ;

/// @brief Method get_ItemNullValueHandling, addr 0x5b295c4, size 0x44, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::NullValueHandling get_ItemNullValueHandling() ;

/// @brief Method get_ItemRequired, addr 0x5b29660, size 0x44, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Required get_ItemRequired() ;

/// @brief Method get_MemberSerialization, addr 0x5b29518, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::MemberSerialization get_MemberSerialization() ;

/// @brief Method get_MissingMemberHandling, addr 0x5b29528, size 0x44, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::MissingMemberHandling get_MissingMemberHandling() ;

/// @brief Method set_ItemNullValueHandling, addr 0x5b29608, size 0x58, virtual false, abstract: false, final false
inline void set_ItemNullValueHandling(::Newtonsoft::Json::NullValueHandling  value) ;

/// @brief Method set_ItemRequired, addr 0x5b296a4, size 0x58, virtual false, abstract: false, final false
inline void set_ItemRequired(::Newtonsoft::Json::Required  value) ;

/// @brief Method set_MemberSerialization, addr 0x5b29520, size 0x8, virtual false, abstract: false, final false
inline void set_MemberSerialization(::Newtonsoft::Json::MemberSerialization  value) ;

/// @brief Method set_MissingMemberHandling, addr 0x5b2956c, size 0x58, virtual false, abstract: false, final false
