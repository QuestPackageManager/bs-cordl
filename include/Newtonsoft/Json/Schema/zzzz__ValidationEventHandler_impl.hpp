...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Schema::ValidationEventHandler::*)(::System::Object*, ::System::IntPtr)>(
  ...
  constexpr static std::size_t addrs = 0x5d5ac58;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Schema::ValidationEventHandler::*)(::System::Object*, ::Newtonsoft::Json::Schema::ValidationEventArgs*)>(
  ...
  constexpr static std::size_t addrs = 0x5d662b8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), { ::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), 13 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::IAsyncResult* (
  ...
  constexpr static std::size_t addrs = 0x5d662cc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), { ::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), 14 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Schema::ValidationEventHandler::*)(::System::IAsyncResult*)>(
  ...
  constexpr static std::size_t addrs = 0x5d662f4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), { ::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), 15 }));
    return ___internal_method;
  }
};
...
inline void Newtonsoft::Json::Schema::ValidationEventHandler::Invoke(::System::Object* sender, ::Newtonsoft::Json::Schema::ValidationEventArgs* e) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), 13 })));
...
inline ::System::IAsyncResult* Newtonsoft::Json::Schema::ValidationEventHandler::BeginInvoke(::System::Object* sender, ::Newtonsoft::Json::Schema::ValidationEventArgs* e,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), 14 })));
...
inline void Newtonsoft::Json::Schema::ValidationEventHandler::EndInvoke(::System::IAsyncResult* result) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Schema::ValidationEventHandler*>(), 15 })));
