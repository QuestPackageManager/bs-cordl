...
public:
  ...
  /// @brief Method <GetSchema>b__0, addr 0x5d674cc, size 0x24, virtual false, abstract: false, final false
  inline bool _GetSchema_b__0(::Newtonsoft::Json::Schema::JsonSchema* s);

  /// @brief Method <GetSchema>b__1, addr 0x5d674f0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d674c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetSchema, addr 0x5d67384, size 0x144, virtual true, abstract: false, final false
