...
public:
  ...
  /// @brief Method .ctor, addr 0x5c2c46c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Schema::JsonSchemaException* ex);

  /// @brief Method get_Exception, addr 0x5c2c4f8, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchemaException* get_Exception();

  /// @brief Method get_Message, addr 0x5c21490, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_Path, addr 0x5c2c500, size 0x18, virtual false, abstract: false, final false
