...
/// @brief Method .ctor, addr 0x5bba484, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Schema::JsonSchemaException*  ex) ;

/// @brief Method get_Exception, addr 0x5bba510, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaException* get_Exception() ;

/// @brief Method get_Message, addr 0x5baf4a8, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_Message() ;

/// @brief Method get_Path, addr 0x5bba518, size 0x18, virtual false, abstract: false, final false
