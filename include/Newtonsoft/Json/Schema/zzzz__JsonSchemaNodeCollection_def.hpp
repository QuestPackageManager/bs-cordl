...
public:
  // Declarations
  /// @brief Method GetKeyForItem, addr 0x5b523c4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b507fc, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
