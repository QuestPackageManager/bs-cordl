...
/// @brief Method <WriteType>b__7_0, addr 0x5bba478, size 0xc, virtual false, abstract: false, final false
inline bool _WriteType_b__7_0(::Newtonsoft::Json::Schema::JsonSchemaType  v) ;

/// @brief Method .ctor, addr 0x5bba474, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ReferenceOrWriteSchema, addr 0x5bb9564, size 0xf4, virtual false, abstract: false, final false
inline void ReferenceOrWriteSchema(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method WriteItems, addr 0x5bb9f80, size 0x4a0, virtual false, abstract: false, final false
inline void WriteItems(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method WritePropertyIfNotNull, addr 0x5bb9658, size 0x64, virtual false, abstract: false, final false
inline void WritePropertyIfNotNull(::Newtonsoft::Json::JsonWriter*  writer, ::StringW  propertyName, ::System::Object*  value) ;

/// @brief Method WriteSchema, addr 0x5bafea0, size 0x1050, virtual false, abstract: false, final false
inline void WriteSchema(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method WriteSchemaDictionaryIfNotNull, addr 0x5bb9c20, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method WriteType, addr 0x5bb96bc, size 0x564, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5bafe38, size 0x68, virtual false, abstract: false, final false
