...
public:
  ...
  /// @brief Method <MapType>b__0, addr 0x294dc8c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x294dc84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildSchema, addr 0x2949e58, size 0x3a4, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* BuildSchema(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method MapType, addr 0x294da0c, size 0x16c, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Schema::JsonSchemaType MapType(::StringW type);

  /// @brief Method MapType, addr 0x294db78, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x2949d00, size 0x150, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* Pop();

  /// @brief Method ProcessAdditionalItems, addr 0x294d008, size 0xac, virtual false, abstract: false, final false
  inline void ProcessAdditionalItems(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessAdditionalProperties, addr 0x294cf5c, size 0xac, virtual false, abstract: false, final false
  inline void ProcessAdditionalProperties(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessEnum, addr 0x294d0b4, size 0x4a8, virtual false, abstract: false, final false
  inline void ProcessEnum(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessExtends, addr 0x294d55c, size 0x4b0, virtual false, abstract: false, final false
  inline void ProcessExtends(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessItems, addr 0x294ca00, size 0x55c, virtual false, abstract: false, final false
  inline void ProcessItems(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method ProcessProperties, addr 0x294c414, size 0x5ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSchemaProperties, addr 0x294abf8, size 0x1248, virtual false, abstract: false, final false
  inline void ProcessSchemaProperties(::Newtonsoft::Json::Linq::JObject* schemaObject);

  /// @brief Method ProcessType, addr 0x294be40, size 0x5d4, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::Newtonsoft::Json::Schema::JsonSchemaType> ProcessType(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method Push, addr 0x2949b50, size 0x1b0, virtual false, abstract: false, final false
  inline void Push(::Newtonsoft::Json::Schema::JsonSchema* value);

  /// @brief Method Read, addr 0x2948570, size 0xd8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* Read(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method ResolveReferences, addr 0x294a1fc, size 0x92c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Schema::JsonSchema* ResolveReferences(::Newtonsoft::Json::Schema::JsonSchema* schema);

  /// @brief Method UnescapeReference, addr 0x294ab28, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29484a0, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Schema::JsonSchemaResolver* resolver);

  /// @brief Method get_CurrentSchema, addr 0x2949e50, size 0x8, virtual false, abstract: false, final false
