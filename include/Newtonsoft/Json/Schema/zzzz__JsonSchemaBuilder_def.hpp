...
/// @brief Method <MapType>b__0, addr 0x5c28a20, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c28a1c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _documentSchemas, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__documentSchemas, put=__cordl_internal_set__documentSchemas)) ::System::Collections::Generic::IDictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchema*>*  _documentSchemas;
...
/// @brief Method BuildSchema, addr 0x5c24e60, size 0x3b8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* BuildSchema(::Newtonsoft::Json::Linq::JToken*  token) ;

/// @brief Method MapType, addr 0x5c28764, size 0x16c, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::Schema::JsonSchemaType MapType(::StringW  type) ;

/// @brief Method MapType, addr 0x5c288d0, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x5c24cf8, size 0x160, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* Pop() ;

/// @brief Method ProcessAdditionalItems, addr 0x5c27d94, size 0xb8, virtual false, abstract: false, final false
inline void ProcessAdditionalItems(::Newtonsoft::Json::Linq::JToken*  token) ;

/// @brief Method ProcessAdditionalProperties, addr 0x5c27cdc, size 0xb8, virtual false, abstract: false, final false
inline void ProcessAdditionalProperties(::Newtonsoft::Json::Linq::JToken*  token) ;

/// @brief Method ProcessEnum, addr 0x5c27e4c, size 0x47c, virtual false, abstract: false, final false
inline void ProcessEnum(::Newtonsoft::Json::Linq::JToken*  token) ;

/// @brief Method ProcessExtends, addr 0x5c282c8, size 0x49c, virtual false, abstract: false, final false
inline void ProcessExtends(::Newtonsoft::Json::Linq::JToken*  token) ;

/// @brief Method ProcessItems, addr 0x5c277bc, size 0x520, virtual false, abstract: false, final false
inline void ProcessItems(::Newtonsoft::Json::Linq::JToken*  token) ;

/// @brief Method ProcessProperties, addr 0x5c271c0, size 0x5fc, virtual false, abstract: false, final false
...
/// @brief Method ProcessSchemaProperties, addr 0x5c25bc0, size 0x1070, virtual false, abstract: false, final false
inline void ProcessSchemaProperties(::Newtonsoft::Json::Linq::JObject*  schemaObject) ;

/// @brief Method ProcessType, addr 0x5c26c30, size 0x590, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Newtonsoft::Json::Schema::JsonSchemaType> ProcessType(::Newtonsoft::Json::Linq::JToken*  token) ;

/// @brief Method Push, addr 0x5c24b40, size 0x1b8, virtual false, abstract: false, final false
inline void Push(::Newtonsoft::Json::Schema::JsonSchema*  value) ;

/// @brief Method Read, addr 0x5c23570, size 0xe0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* Read(::Newtonsoft::Json::JsonReader*  reader) ;

/// @brief Method ResolveReferences, addr 0x5c25218, size 0x8c0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* ResolveReferences(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method UnescapeReference, addr 0x5c25ad8, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c23484, size 0xec, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Schema::JsonSchemaResolver*  resolver) ;

/// @brief Method get_CurrentSchema, addr 0x5c24e58, size 0x8, virtual false, abstract: false, final false
