...
public:
  ...
  /// @brief Method .ctor addr 0x24dbcd8 size 0x58 virtual false final false
  inline void _ctor();

  static inline ::Newtonsoft::Json::JsonException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x24dbd30 size 0x68 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::Newtonsoft::Json::JsonException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor addr 0x24dbd98 size 0x70 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24dbe08 size 0x80 virtual false final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method Create addr 0x24dbe88 size 0xac virtual false final false
