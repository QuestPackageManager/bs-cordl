...
public:
// Declarations
/// @brief Method CanConvert, addr 0x5beabc4, size 0x138, virtual true, abstract: false, final false
inline bool CanConvert(::System::Type*  objectType) ;

static inline ::Newtonsoft::Json::Converters::DateTimeConverterBase* New_ctor() ;

/// @brief Method .ctor, addr 0x5beacfc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
