...
public:
  ...
  /// @brief Method .ctor, addr 0x5d9bc18, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_DateTimeStyles, addr 0x5d9b444, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DateTimeStyles, addr 0x5d9b44c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Converters::IsoDateTimeConverter) == 0x28, "Size mismatch!");
