...
public:
  ...
  /// @brief Method .ctor, addr 0x5d9e140, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDocumentType* documentType);

  /// @brief Method get_InternalSubset, addr 0x5d9e190, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_InternalSubset();

  /// @brief Method get_LocalName, addr 0x5d9e1a8, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x5d9e148, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_Name();

  /// @brief Method get_Public, addr 0x5d9e178, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_Public();

  /// @brief Method get_System, addr 0x5d9e160, size 0x18, virtual true, abstract: false, final true
