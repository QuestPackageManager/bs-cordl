...
public:
  ...
  /// @brief Method .ctor addr 0x2556838 size 0x6c virtual false final false
  inline void _ctor(::System::Xml::Linq::XDocumentType* documentType);

  /// @brief Method get_Name addr 0x25568a4 size 0x1c virtual true final true
  inline ::StringW get_Name();

  /// @brief Method get_System addr 0x25568c0 size 0x1c virtual true final true
  inline ::StringW get_System();

  /// @brief Method get_Public addr 0x25568dc size 0x1c virtual true final true
  inline ::StringW get_Public();

  /// @brief Method get_InternalSubset addr 0x25568f8 size 0x1c virtual true final true
  inline ::StringW get_InternalSubset();

  /// @brief Method get_LocalName addr 0x2556914 size 0x40 virtual true final false
