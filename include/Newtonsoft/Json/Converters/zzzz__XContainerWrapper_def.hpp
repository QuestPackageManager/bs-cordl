...
public:
  ...
  /// @brief Method AppendChild, addr 0x2a8e668, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method WrapNode, addr 0x2a8e8a4, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a8d6c4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* container);

  /// @brief Method get_ChildNodes, addr 0x2a8d868, size 0x408, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes();

  /// @brief Method get_Container, addr 0x2a8ee40, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XContainer* get_Container();

  /// @brief Method get_HasChildNodes, addr 0x2a8dcac, size 0x28, virtual true, abstract: false, final false
  inline bool get_HasChildNodes();

  /// @brief Method get_ParentNode, addr 0x2a8eeb8, size 0x44, virtual true, abstract: false, final false
