...
public:
  ...
  /// @brief Method AppendChild, addr 0x5d9f080, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method WrapNode, addr 0x5d9f278, size 0x34c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d9e270, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* container);

  /// @brief Method get_ChildNodes, addr 0x5d9e3f4, size 0x3e4, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes();

  /// @brief Method get_Container, addr 0x5d9f7cc, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XContainer* get_Container();

  /// @brief Method get_HasChildNodes, addr 0x5d9e814, size 0x28, virtual true, abstract: false, final false
  inline bool get_HasChildNodes();

  /// @brief Method get_ParentNode, addr 0x5d9f848, size 0x44, virtual true, abstract: false, final false
