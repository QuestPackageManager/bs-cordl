...
public:
  ...
  /// @brief Method AppendChild, addr 0x2aaecf4, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method WrapNode, addr 0x2aaef30, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2aadd50, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* container);

  /// @brief Method get_ChildNodes, addr 0x2aadef4, size 0x408, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes();

  /// @brief Method get_Container, addr 0x2aaf4cc, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XContainer* get_Container();

  /// @brief Method get_HasChildNodes, addr 0x2aae338, size 0x28, virtual true, abstract: false, final false
  inline bool get_HasChildNodes();

  /// @brief Method get_ParentNode, addr 0x2aaf544, size 0x44, virtual true, abstract: false, final false
