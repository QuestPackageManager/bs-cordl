...
public:
  ...
  /// @brief Method AppendChild, addr 0x5c652e0, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method WrapNode, addr 0x5c654d8, size 0x34c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c644d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* container);

  /// @brief Method get_ChildNodes, addr 0x5c64654, size 0x3e4, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes();

  /// @brief Method get_Container, addr 0x5c65a2c, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XContainer* get_Container();

  /// @brief Method get_HasChildNodes, addr 0x5c64a74, size 0x28, virtual true, abstract: false, final false
  inline bool get_HasChildNodes();

  /// @brief Method get_ParentNode, addr 0x5c65aa8, size 0x44, virtual true, abstract: false, final false
