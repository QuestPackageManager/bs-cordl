...
public:
  ...
  /// @brief Method .ctor, addr 0x5c64310, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDeclaration* declaration);

  /// @brief Method get_Declaration, addr 0x5c64308, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XDeclaration* get_Declaration();

  /// @brief Method get_Encoding, addr 0x5c64340, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_Encoding();

  /// @brief Method get_NodeType, addr 0x5c64320, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Standalone, addr 0x5c64370, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0x5c64328, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Encoding, addr 0x5c64358, size 0x18, virtual true, abstract: false, final true
  inline void set_Encoding(::StringW value);

  /// @brief Method set_Standalone, addr 0x5c64388, size 0x18, virtual true, abstract: false, final true
