...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Converters::DataTableConverter::*)(
  ...
  constexpr static std::size_t addrs = 0x5d9795c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), { ::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), 4 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<
  ...
  constexpr static std::size_t addrs = 0x5d980f4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), { ::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), 5 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::Newtonsoft::Json::JsonReader*, ::System::Data::DataTable*, ::Newtonsoft::Json::JsonSerializer*)>(
    &::Newtonsoft::Json::Converters::DataTableConverter::CreateRow)> {
  constexpr static std::size_t size = 0x558;
  constexpr static std::size_t addrs = 0x5d983d0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Type* (*)(::Newtonsoft::Json::JsonReader*)>(&::Newtonsoft::Json::Converters::DataTableConverter::GetColumnDataType)> {
  ...
  constexpr static std::size_t addrs = 0x5d98928;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), { "GetColumnDataType", {}, { ::i2c::type_of<::Newtonsoft::Json::JsonReader*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Newtonsoft::Json::Converters::DataTableConverter::*)(::System::Type*)>(
    &::Newtonsoft::Json::Converters::DataTableConverter::CanConvert)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x5d98af4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), { ::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), 6 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Newtonsoft::Json::Converters::DataTableConverter::*)()>(&::Newtonsoft::Json::Converters::DataTableConverter::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5d97600;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
inline void Newtonsoft::Json::Converters::DataTableConverter::WriteJson(::Newtonsoft::Json::JsonWriter* writer, /* [Nullable(2)] */ ::System::Object* value,
                                                                        ::Newtonsoft::Json::JsonSerializer* serializer) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), 4 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, writer, value, serializer);
}
inline ::System::Object* Newtonsoft::Json::Converters::DataTableConverter::ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType,
                                                                                    /* [Nullable(2)] */ ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), 5 })));
...
inline bool Newtonsoft::Json::Converters::DataTableConverter::CanConvert(::System::Type* valueType) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Converters::DataTableConverter*>(), 6 })));
