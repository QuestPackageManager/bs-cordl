...
public:
  ...
  /// @brief Method ReadJson, addr 0x298bb70, size 0x400, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WriteJson, addr 0x298b920, size 0x250, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x298b8d8, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x298b8f4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(bool allowPreEpoch);

  static inline ::System::DateTime getStaticF_UnixEpoch();

  /// @brief Method get_AllowPreEpoch, addr 0x298b8c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowPreEpoch();

  static inline void setStaticF_UnixEpoch(::System::DateTime value);

  /// @brief Method set_AllowPreEpoch, addr 0x298b8cc, size 0xc, virtual false, abstract: false, final false
