...
public:
  ...
  /// @brief Method .ctor, addr 0x5d9e200, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5d9e208, size 0x8, virtual false, abstract: false, final false
