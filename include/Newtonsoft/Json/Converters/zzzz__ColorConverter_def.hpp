...
public:
  ...
  /// @brief Method WriteJson, addr 0x26d590c, size 0x1d4, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method CanConvert, addr 0x26d5ae0, size 0xc8, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* objectType);

  /// @brief Method ReadJson, addr 0x26d5ba8, size 0x2a8, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method get_CanRead, addr 0x26d5e50, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  static inline ::Newtonsoft::Json::Converters::ColorConverter* New_ctor();

  /// @brief Method .ctor, addr 0x26d5e58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
