...
public:
  // Declarations
  /// @brief Method WriteJson, addr 0x26d8514, size 0xf8, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method HasFlag, addr 0x26d8900, size 0xc, virtual false, abstract: false, final false
  inline bool HasFlag(::System::Text::RegularExpressions::RegexOptions options, ::System::Text::RegularExpressions::RegexOptions flag);

  /// @brief Method WriteBson, addr 0x26d860c, size 0x138, virtual false, abstract: false, final false
  inline void WriteBson(::Newtonsoft::Json::Bson::BsonWriter* writer, ::System::Text::RegularExpressions::Regex* regex);

  /// @brief Method WriteJson, addr 0x26d8744, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadJson, addr 0x26d890c, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method ReadRegexString, addr 0x26d8c34, size 0x180, virtual false, abstract: false, final false
  inline ::System::Object* ReadRegexString(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method ReadRegexObject, addr 0x26d89b0, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method CanConvert, addr 0x26d8db4, size 0x84, virtual true, abstract: false, final false
