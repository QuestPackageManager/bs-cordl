...
public:
  ...
  /// @brief Method .ctor, addr 0x298e7c0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDeclaration* declaration);

  /// @brief Method get_Encoding, addr 0x298ee04, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW get_Encoding();

  /// @brief Method get_Standalone, addr 0x298ee3c, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0x298ede8, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Encoding, addr 0x298ee20, size 0x1c, virtual true, abstract: false, final true
  inline void set_Encoding(::StringW value);

  /// @brief Method set_Standalone, addr 0x298ee58, size 0x1c, virtual true, abstract: false, final true
