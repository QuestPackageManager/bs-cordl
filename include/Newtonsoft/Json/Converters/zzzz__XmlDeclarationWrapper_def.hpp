...
public:
  ...
  /// @brief Method .ctor, addr 0x5c6301c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDeclaration* declaration);

  /// @brief Method get_Encoding, addr 0x5c635b8, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_Encoding();

  /// @brief Method get_Standalone, addr 0x5c635fc, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0x5c635a0, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Encoding, addr 0x5c635d0, size 0x2c, virtual true, abstract: false, final true
  inline void set_Encoding(::StringW value);

  /// @brief Method set_Standalone, addr 0x5c63614, size 0x18, virtual true, abstract: false, final true
