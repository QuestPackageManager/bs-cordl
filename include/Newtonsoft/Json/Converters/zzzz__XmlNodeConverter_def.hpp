...
public:
  ...
  /// @brief Method set_DeserializeRootElementName, addr 0x26bd754, size 0x8, virtual false, abstract: false, final false
  inline void set_DeserializeRootElementName(::StringW value);

  /// @brief Method get_WriteArrayAttribute, addr 0x26bd75c, size 0x8, virtual false, abstract: false, final false
  inline bool get_WriteArrayAttribute();

  /// @brief Method set_WriteArrayAttribute, addr 0x26bd764, size 0xc, virtual false, abstract: false, final false
  inline void set_WriteArrayAttribute(bool value);

  /// @brief Method get_OmitRootObject, addr 0x26bd770, size 0x8, virtual false, abstract: false, final false
  inline bool get_OmitRootObject();

  /// @brief Method set_OmitRootObject, addr 0x26bd778, size 0xc, virtual false, abstract: false, final false
  inline void set_OmitRootObject(bool value);

  /// @brief Method WriteJson, addr 0x26bd784, size 0x124, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WrapXml, addr 0x26bd8a8, size 0x11c, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* WrapXml(::System::Object* value);

  /// @brief Method PushParentNamespaces, addr 0x26bd9c4, size 0x668, virtual false, abstract: false, final false
  inline void PushParentNamespaces(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method ResolveFullName, addr 0x26bf714, size 0x31c, virtual false, abstract: false, final false
  inline ::StringW ResolveFullName(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method GetPropertyName, addr 0x26bfa30, size 0x428, virtual false, abstract: false, final false
  inline ::StringW GetPropertyName(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method IsArray, addr 0x26bfe58, size 0x3ec, virtual false, abstract: false, final false
  inline bool IsArray(::Newtonsoft::Json::Converters::IXmlNode* node);

  /// @brief Method SerializeGroupedNodes, addr 0x26c0244, size 0x578, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeNode, addr 0x26be02c, size 0x16e8, virtual false, abstract: false, final false
  ...
  /// @brief Method AllSameName, addr 0x26c07bc, size 0x2ac, virtual false, abstract: false, final false
  static inline bool AllSameName(::Newtonsoft::Json::Converters::IXmlNode* node);

  /// @brief Method ReadJson, addr 0x26c0c7c, size 0x658, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method DeserializeValue, addr 0x26c1c70, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadElement, addr 0x26c12d4, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateElement, addr 0x26c367c, size 0x680, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAttribute, addr 0x26c33f0, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertTokenToXmlValue, addr 0x26c3ea4, size 0x5d8, virtual false, abstract: false, final false
  inline ::StringW ConvertTokenToXmlValue(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method ReadArrayElements, addr 0x26c29f4, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddJsonArrayAttribute, addr 0x26c447c, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAttributeElements, addr 0x26c2d80, size 0x670, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInstruction, addr 0x26c2200, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDocumentType, addr 0x26c264c, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateElement, addr 0x26c3cfc, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeNode, addr 0x26c15ac, size 0x6c4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNamespaceAttribute, addr 0x26c47bc, size 0xe4, virtual false, abstract: false, final false
  inline bool IsNamespaceAttribute(::StringW attributeName, ByRef<::StringW> prefix);

  /// @brief Method ValueAttributes, addr 0x26c0a68, size 0x214, virtual false, abstract: false, final false
  inline bool ValueAttributes(::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* c);

  /// @brief Method CanConvert, addr 0x26c48a0, size 0xf8, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* valueType);

  static inline ::Newtonsoft::Json::Converters::XmlNodeConverter* New_ctor();

  /// @brief Method .ctor, addr 0x26c4998, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
