...
public:
  ...
  /// @brief Method AddAttribute, addr 0x5b94860, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method AddJsonArrayAttribute, addr 0x5b95500, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method AllSameName, addr 0x5b910d4, size 0x260, virtual false, abstract: false, final false
  static inline bool AllSameName(::Newtonsoft::Json::Converters::IXmlNode* node);

  /// @brief Method CanConvert, addr 0x5b95934, size 0xc0, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* valueType);

  /// @brief Method ConvertTokenToXmlValue, addr 0x5b92e30, size 0x734, virtual false, abstract: false, final false
  static inline ::StringW ConvertTokenToXmlValue(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method CreateDocumentType, addr 0x5b93a14, size 0x3f8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateElement, addr 0x5b95314, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateElement, addr 0x5b94be8, size 0x72c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInstruction, addr 0x5b93564, size 0x4b0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeNode, addr 0x5b92124, size 0x760, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeValue, addr 0x5b92884, size 0x5ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPropertyName, addr 0x5b8fcac, size 0x4d0, virtual false, abstract: false, final false
  inline ::StringW GetPropertyName(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method IsArray, addr 0x5b9017c, size 0x344, virtual false, abstract: false, final false
  inline bool IsArray(::Newtonsoft::Json::Converters::IXmlNode* node);

  /// @brief Method IsNamespaceAttribute, addr 0x5b95860, size 0xd4, virtual false, abstract: false, final false
  inline bool IsNamespaceAttribute(::StringW attributeName, ::ByRef<::StringW> prefix);

  /// @brief Method IsXObject, addr 0x5b959f4, size 0x80, virtual false, abstract: false, final false
  inline bool IsXObject(::System::Type* valueType);

  /// @brief Method IsXmlNode, addr 0x5b95a74, size 0x80, virtual false, abstract: false, final false
  inline bool IsXmlNode(::System::Type* valueType);

  static inline ::Newtonsoft::Json::Converters::XmlNodeConverter* New_ctor();

  /// @brief Method PushParentNamespaces, addr 0x5b8dc90, size 0x5c4, virtual false, abstract: false, final false
  inline void PushParentNamespaces(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method ReadArrayElements, addr 0x5b93e0c, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAttributeElements, addr 0x5b941bc, size 0x6a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadElement, addr 0x5b91dcc, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadJson, addr 0x5b915e0, size 0x7ec, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method ResolveFullName, addr 0x5b8f91c, size 0x390, virtual false, abstract: false, final false
  inline ::StringW ResolveFullName(::Newtonsoft::Json::Converters::IXmlNode* node, ::System::Xml::XmlNamespaceManager* manager);

  /// @brief Method SerializeGroupedNodes, addr 0x5b904c0, size 0x9b4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeNode, addr 0x5b8e254, size 0x16c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldReadInto, addr 0x5b94178, size 0x44, virtual false, abstract: false, final false
  inline bool ShouldReadInto(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method ValueAttributes, addr 0x5b91334, size 0x2ac, virtual false, abstract: false, final false
  inline bool ValueAttributes(::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* c);

  /// @brief Method WrapXml, addr 0x5b8db70, size 0x120, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* WrapXml(::System::Object* value);

  /// @brief Method WriteGroupedNodes, addr 0x5b90e74, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteGroupedNodes, addr 0x5b90ffc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x5b8da24, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b95af4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* getStaticF_EmptyChildNodes();

  /// @brief Method get_DeserializeRootElementName, addr 0x5b8d9e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DeserializeRootElementName();

  /// @brief Method get_EncodeSpecialCharacters, addr 0x5b8da14, size 0x8, virtual false, abstract: false, final false
  inline bool get_EncodeSpecialCharacters();

  /// @brief Method get_OmitRootObject, addr 0x5b8da04, size 0x8, virtual false, abstract: false, final false
  inline bool get_OmitRootObject();

  /// @brief Method get_WriteArrayAttribute, addr 0x5b8d9f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DeserializeRootElementName, addr 0x5b8d9ec, size 0x8, virtual false, abstract: false, final false
  inline void set_DeserializeRootElementName(::StringW value);

  /// @brief Method set_EncodeSpecialCharacters, addr 0x5b8da1c, size 0x8, virtual false, abstract: false, final false
  inline void set_EncodeSpecialCharacters(bool value);

  /// @brief Method set_OmitRootObject, addr 0x5b8da0c, size 0x8, virtual false, abstract: false, final false
  inline void set_OmitRootObject(bool value);

  /// @brief Method set_WriteArrayAttribute, addr 0x5b8d9fc, size 0x8, virtual false, abstract: false, final false
