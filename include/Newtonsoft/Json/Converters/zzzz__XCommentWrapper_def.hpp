...
public:
  ...
  /// @brief Method get_Text addr 0x2557ff8 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2558070 size 0x6c virtual false final false
  inline void _ctor(::System::Xml::Linq::XComment* text);

  /// @brief Method get_Value addr 0x25580dc size 0x1c virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x25580f8 size 0x24 virtual true final false
  inline void set_Value(::StringW value);

  /// @brief Method get_ParentNode addr 0x255811c size 0x44 virtual true final false
