...
public:
  ...
  /// @brief Method .ctor, addr 0x5b8c8cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XComment* text);

  /// @brief Method get_ParentNode, addr 0x5b8c928, size 0x44, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode();

  /// @brief Method get_Text, addr 0x5b8c850, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XComment* get_Text();

  /// @brief Method get_Value, addr 0x5b8c8d4, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x5b8c8f0, size 0x38, virtual true, abstract: false, final false
