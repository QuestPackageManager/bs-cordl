...
public:
  ...
  /// @brief Method get_Text addr 0x26bc144 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26bc1bc size 0x6c virtual false final false
  inline void _ctor(::System::Xml::Linq::XText* text);

  /// @brief Method get_Value addr 0x26bc228 size 0x1c virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x26bc244 size 0x24 virtual true final false
  inline void set_Value(::StringW value);

  /// @brief Method get_ParentNode addr 0x26bc268 size 0x44 virtual true final false
