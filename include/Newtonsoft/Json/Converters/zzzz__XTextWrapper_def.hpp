...
public:
  ...
  /// @brief Method get_Text, addr 0x26de300, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26de378, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XText* text);

  /// @brief Method get_Value, addr 0x26de3e4, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x26de400, size 0x24, virtual true, abstract: false, final false
  inline void set_Value(::StringW value);

  /// @brief Method get_ParentNode, addr 0x26de424, size 0x44, virtual true, abstract: false, final false
