...
public:
  ...
  /// @brief Method get_CamelCaseText, addr 0x26d91ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_CamelCaseText();

  /// @brief Method set_CamelCaseText, addr 0x26d91f4, size 0xc, virtual false, abstract: false, final false
  inline void set_CamelCaseText(bool value);

  /// @brief Method get_AllowIntegerValues, addr 0x26d9200, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowIntegerValues();

  /// @brief Method set_AllowIntegerValues, addr 0x26d9208, size 0xc, virtual false, abstract: false, final false
  inline void set_AllowIntegerValues(bool value);

  static inline ::Newtonsoft::Json::Converters::StringEnumConverter* New_ctor();

  /// @brief Method .ctor, addr 0x26d9214, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Newtonsoft::Json::Converters::StringEnumConverter* New_ctor(bool camelCaseText);

  /// @brief Method .ctor, addr 0x26d9234, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(bool camelCaseText);

  /// @brief Method WriteJson, addr 0x26d9268, size 0x1c8, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method ReadJson, addr 0x26d9430, size 0x444, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method CanConvert, addr 0x26d9874, size 0x78, virtual true, abstract: false, final false
