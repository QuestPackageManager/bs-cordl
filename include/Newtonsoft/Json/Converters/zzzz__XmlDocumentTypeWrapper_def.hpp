...
public:
  ...
  /// @brief Method .ctor, addr 0x26b9c5c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDocumentType* documentType);

  /// @brief Method get_Name, addr 0x26ba238, size 0x20, virtual true, abstract: false, final true
  inline ::StringW get_Name();

  /// @brief Method get_System, addr 0x26ba258, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW get_System();

  /// @brief Method get_Public, addr 0x26ba274, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW get_Public();

  /// @brief Method get_InternalSubset, addr 0x26ba290, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW get_InternalSubset();

  /// @brief Method get_LocalName, addr 0x26ba2ac, size 0x40, virtual true, abstract: false, final false
