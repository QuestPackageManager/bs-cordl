...
public:
  ...
  /// @brief Method WriteJson, addr 0x26b6c84, size 0x1ac, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method CanConvert, addr 0x26b6e30, size 0x84, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* objectType);

  /// @brief Method ReadJson, addr 0x26b6eb4, size 0x16c, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method get_CanRead, addr 0x26b7020, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  static inline ::Newtonsoft::Json::Converters::ResolutionConverter* New_ctor();

  /// @brief Method .ctor, addr 0x26b7028, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
