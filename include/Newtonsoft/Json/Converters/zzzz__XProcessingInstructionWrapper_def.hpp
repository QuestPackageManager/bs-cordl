...
public:
  ...
  /// @brief Method .ctor, addr 0x3f457d8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XProcessingInstruction* processingInstruction);

  /// @brief Method get_LocalName, addr 0x3f4637c, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_ProcessingInstruction, addr 0x3f46304, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XProcessingInstruction* get_ProcessingInstruction();

  /// @brief Method get_Value, addr 0x3f46398, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x3f463b4, size 0x6c, virtual true, abstract: false, final false
