...
public:
  ...
  /// @brief Method get_ProcessingInstruction, addr 0x26bc8a4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26bbb80, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XProcessingInstruction* processingInstruction);

  /// @brief Method get_LocalName, addr 0x26bc91c, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Value, addr 0x26bc938, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x26bc954, size 0x24, virtual true, abstract: false, final false
