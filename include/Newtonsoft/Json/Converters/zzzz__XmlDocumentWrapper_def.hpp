...
public:
  ...
  /// @brief Method .ctor addr 0x2555088 size 0x2c virtual false final false
  inline void _ctor(::System::Xml::XmlDocument* document);

  /// @brief Method CreateComment addr 0x25550dc size 0x8c virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateComment(::StringW data);

  /// @brief Method CreateTextNode addr 0x2555168 size 0x8c virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateTextNode(::StringW text);

  /// @brief Method CreateCDataSection addr 0x25551f4 size 0x8c virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateCDataSection(::StringW data);

  /// @brief Method CreateWhitespace addr 0x2555280 size 0x8c virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateWhitespace(::StringW text);

  /// @brief Method CreateSignificantWhitespace addr 0x255530c size 0x8c virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateSignificantWhitespace(::StringW text);

  /// @brief Method CreateXmlDeclaration addr 0x2555398 size 0xa8 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateXmlDeclaration(::StringW version, ::StringW encoding, ::StringW standalone);

  /// @brief Method CreateXmlDocumentType addr 0x255546c size 0xac virtual true final true
