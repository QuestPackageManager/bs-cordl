...
namespace Newtonsoft::Json::Converters {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11992))}
...
public:
  ...
  /// @brief Method get_Element addr 0x25585e8 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x255754c size 0x4 virtual false final false
  inline void _ctor(::System::Xml::Linq::XElement* element);

  /// @brief Method SetAttributeNode addr 0x2558660 size 0xa4 virtual true final true
  inline void SetAttributeNode(::Newtonsoft::Json::Converters::IXmlNode* attribute);

  /// @brief Method get_Attributes addr 0x2558704 size 0x808 virtual true final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_Attributes();

  /// @brief Method AppendChild addr 0x2558f4c size 0x18 virtual true final false
  inline ::Newtonsoft::Json::Converters::IXmlNode* AppendChild(::Newtonsoft::Json::Converters::IXmlNode* newChild);

  /// @brief Method get_Value addr 0x2558f64 size 0x1c virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x2558f80 size 0x24 virtual true final false
  inline void set_Value(::StringW value);

  /// @brief Method get_LocalName addr 0x2558fa4 size 0x24 virtual true final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri addr 0x2558fc8 size 0x24 virtual true final false
  inline ::StringW get_NamespaceUri();

  /// @brief Method GetPrefixOfNamespace addr 0x2558f0c size 0x40 virtual true final true
  inline ::StringW GetPrefixOfNamespace(::StringW namespaceUri);

  /// @brief Method get_IsEmpty addr 0x2558fec size 0x1c virtual true final true
