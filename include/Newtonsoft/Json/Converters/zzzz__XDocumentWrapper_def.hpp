...
public:
  ...
  /// @brief Method get_Document addr 0x2556954 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x25569cc size 0x4 virtual false final false
  inline void _ctor(::System::Xml::Linq::XDocument* document);

  /// @brief Method get_ChildNodes addr 0x2556a3c size 0x164 virtual true final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes();

  /// @brief Method CreateComment addr 0x2556f58 size 0x94 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateComment(::StringW text);

  /// @brief Method CreateTextNode addr 0x2556fec size 0x94 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateTextNode(::StringW text);

  /// @brief Method CreateCDataSection addr 0x2557080 size 0x94 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateCDataSection(::StringW data);

  /// @brief Method CreateWhitespace addr 0x2557114 size 0x94 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateWhitespace(::StringW text);

  /// @brief Method CreateSignificantWhitespace addr 0x25571a8 size 0x94 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateSignificantWhitespace(::StringW text);

  /// @brief Method CreateXmlDeclaration addr 0x255723c size 0xa8 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateXmlDeclaration(::StringW version, ::StringW encoding, ::StringW standalone);

  /// @brief Method CreateXmlDocumentType addr 0x25572e4 size 0xb8 virtual true final true
  ...
  /// @brief Method CreateProcessingInstruction addr 0x255739c size 0xa0 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateProcessingInstruction(::StringW target, ::StringW data);

  /// @brief Method CreateElement addr 0x25574a8 size 0xa4 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlElement* CreateElement(::StringW elementName);

  /// @brief Method CreateElement addr 0x2557550 size 0xbc virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlElement* CreateElement(::StringW qualifiedName, ::StringW namespaceUri);

  /// @brief Method CreateAttribute addr 0x255760c size 0xb4 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateAttribute(::StringW name, ::StringW value);

  /// @brief Method CreateAttribute addr 0x255772c size 0xc4 virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlNode* CreateAttribute(::StringW qualifiedName, ::StringW namespaceUri, ::StringW value);

  /// @brief Method get_DocumentElement addr 0x25577f0 size 0x9c virtual true final true
  inline ::Newtonsoft::Json::Converters::IXmlElement* get_DocumentElement();

  /// @brief Method AppendChild addr 0x255788c size 0xa4 virtual true final false
