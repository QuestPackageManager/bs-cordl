...
public:
  ...
  /// @brief Method .ctor addr 0x2640884 size 0x9c virtual false final false
  inline void _ctor(::System::IO::TextReader* reader);

  /// @brief Method get_ArrayPool addr 0x2640958 size 0x8 virtual false final false
  inline ::Newtonsoft::Json::IArrayPool_1<char16_t>* get_ArrayPool();

  /// @brief Method set_ArrayPool addr 0x2640960 size 0x60 virtual false final false
  inline void set_ArrayPool(::Newtonsoft::Json::IArrayPool_1<char16_t>* value);

  /// @brief Method EnsureBufferNotEmpty addr 0x26409c0 size 0x54 virtual false final false
  inline void EnsureBufferNotEmpty();

  /// @brief Method OnNewLine addr 0x2640a14 size 0x10 virtual false final false
  inline void OnNewLine(int32_t pos);

  /// @brief Method ParseString addr 0x2640a24 size 0x3b8 virtual false final false
  inline void ParseString(char16_t quote, ::Newtonsoft::Json::ReadType readType);

  /// @brief Method BlockCopyChars addr 0x264151c size 0x14 virtual false final false
  ...
  /// @brief Method ShiftBufferIfNeeded addr 0x2640ddc size 0xa8 virtual false final false
  inline void ShiftBufferIfNeeded();

  /// @brief Method ReadData addr 0x2641530 size 0xc virtual false final false
  inline int32_t ReadData(bool append);

  /// @brief Method ReadData addr 0x264153c size 0x20c virtual false final false
  inline int32_t ReadData(bool append, int32_t charsRequired);

  /// @brief Method EnsureChars addr 0x2641748 size 0x20 virtual false final false
  inline bool EnsureChars(int32_t relativePosition, bool append);

  /// @brief Method ReadChars addr 0x2641768 size 0x70 virtual false final false
  inline bool ReadChars(int32_t relativePosition, bool append);

  /// @brief Method Read addr 0x26417d8 size 0x218 virtual true final false
  inline bool Read();

  /// @brief Method ReadAsInt32 addr 0x2642620 size 0x90 virtual true final false
  inline ::System::Nullable_1<int32_t> ReadAsInt32();

  /// @brief Method ReadAsDateTime addr 0x2642b68 size 0x90 virtual true final false
  inline ::System::Nullable_1<::System::DateTime> ReadAsDateTime();

  /// @brief Method ReadAsString addr 0x2643308 size 0x64 virtual true final false
  inline ::StringW ReadAsString();

  /// @brief Method ReadAsBytes addr 0x264336c size 0x480 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadAsBytes();

  /// @brief Method ReadStringValue addr 0x2642bf8 size 0x710 virtual false final false
  inline ::System::Object* ReadStringValue(::Newtonsoft::Json::ReadType readType);

  /// @brief Method CreateUnexpectedCharacterException addr 0x2643dfc size 0xd0 virtual false final false
  inline ::Newtonsoft::Json::JsonReaderException* CreateUnexpectedCharacterException(char16_t c);

  /// @brief Method ReadAsBoolean addr 0x2645854 size 0x4e0 virtual true final false
  inline ::System::Nullable_1<bool> ReadAsBoolean();

  /// @brief Method ProcessValueComma addr 0x2643da4 size 0x58 virtual false final false
  inline void ProcessValueComma();

  /// @brief Method ReadNumberValue addr 0x26426b0 size 0x4b8 virtual false final false
  inline ::System::Object* ReadNumberValue(::Newtonsoft::Json::ReadType readType);

  /// @brief Method ReadAsDateTimeOffset addr 0x26465fc size 0xcc virtual true final false
  inline ::System::Nullable_1<::System::DateTimeOffset> ReadAsDateTimeOffset();

  /// @brief Method ReadAsDecimal addr 0x26466c8 size 0xcc virtual true final false
  inline ::System::Nullable_1<::System::Decimal> ReadAsDecimal();

  /// @brief Method ReadAsDouble addr 0x2646794 size 0xb4 virtual true final false
  inline ::System::Nullable_1<double_t> ReadAsDouble();

  /// @brief Method HandleNull addr 0x2643cd4 size 0xd0 virtual false final false
  inline void HandleNull();

  /// @brief Method ReadFinished addr 0x2643f68 size 0x150 virtual false final false
  inline void ReadFinished();

  /// @brief Method ReadNullChar addr 0x26437ec size 0x50 virtual false final false
  inline bool ReadNullChar();

  /// @brief Method EnsureBuffer addr 0x26419f0 size 0x44 virtual false final false
  inline void EnsureBuffer();

  /// @brief Method ReadStringIntoBuffer addr 0x2640e84 size 0x498 virtual false final false
  inline void ReadStringIntoBuffer(char16_t quote);

  /// @brief Method WriteCharToBuffer addr 0x2646a50 size 0x50 virtual false final false
  inline void WriteCharToBuffer(char16_t writeChar, int32_t lastWritePosition, int32_t writeToPosition);

  /// @brief Method ParseUnicode addr 0x2646940 size 0x110 virtual false final false
  inline char16_t ParseUnicode();

  /// @brief Method ReadNumberIntoBuffer addr 0x2646aa0 size 0x1d0 virtual false final false
  inline void ReadNumberIntoBuffer();

  /// @brief Method ClearRecentString addr 0x2646c70 size 0xc virtual false final false
  inline void ClearRecentString();

  /// @brief Method ParsePostValue addr 0x2641fe0 size 0x270 virtual false final false
  inline bool ParsePostValue();

  /// @brief Method ParseObject addr 0x2641e50 size 0x190 virtual false final false
  inline bool ParseObject();

  /// @brief Method ParseProperty addr 0x2646c7c size 0x224 virtual false final false
  inline bool ParseProperty();

  /// @brief Method ValidIdentifierChar addr 0x2646ea0 size 0x80 virtual false final false
  inline bool ValidIdentifierChar(char16_t value);

  /// @brief Method ParseUnquotedProperty addr 0x2646f20 size 0x1b4 virtual false final false
  inline void ParseUnquotedProperty();

  /// @brief Method ParseValue addr 0x2641a34 size 0x41c virtual false final false
  inline bool ParseValue();

  /// @brief Method ProcessLineFeed addr 0x2643f4c size 0x1c virtual false final false
  inline void ProcessLineFeed();

  /// @brief Method ProcessCarriageReturn addr 0x2643ecc size 0x80 virtual false final false
  inline void ProcessCarriageReturn(bool append);

  /// @brief Method EatWhitespace addr 0x2642250 size 0x130 virtual false final false
  inline bool EatWhitespace(bool oneOrMore);

  /// @brief Method ParseConstructor addr 0x2647290 size 0x328 virtual false final false
  inline void ParseConstructor();

  /// @brief Method ParseNumber addr 0x2644708 size 0xde0 virtual false final false
  inline void ParseNumber(::Newtonsoft::Json::ReadType readType);

  /// @brief Method ParseComment addr 0x264238c size 0x28c virtual false final false
  inline void ParseComment(bool setToken);

  /// @brief Method EndComment addr 0x26476e8 size 0x60 virtual false final false
  inline void EndComment(bool setToken, int32_t initialPosition, int32_t endPosition);

  /// @brief Method MatchValue addr 0x2647748 size 0x104 virtual false final false
  inline bool MatchValue(::StringW value);

  /// @brief Method MatchValueWithTrailingSeparator addr 0x26454e8 size 0xa4 virtual false final false
  inline bool MatchValueWithTrailingSeparator(::StringW value);

  /// @brief Method IsSeparator addr 0x264784c size 0x158 virtual false final false
  inline bool IsSeparator(char16_t c);

  /// @brief Method ParseTrue addr 0x26470d4 size 0xe0 virtual false final false
  inline void ParseTrue();

  /// @brief Method ParseNull addr 0x2646848 size 0xac virtual false final false
  inline void ParseNull();

  /// @brief Method ParseUndefined addr 0x26475b8 size 0xac virtual false final false
  inline void ParseUndefined();

  /// @brief Method ParseFalse addr 0x26471b4 size 0xdc virtual false final false
  inline void ParseFalse();

  /// @brief Method ParseNumberNegativeInfinity addr 0x26445a8 size 0x160 virtual false final false
  inline ::System::Object* ParseNumberNegativeInfinity(::Newtonsoft::Json::ReadType readType);

  /// @brief Method ParseNumberPositiveInfinity addr 0x2645594 size 0x160 virtual false final false
  inline ::System::Object* ParseNumberPositiveInfinity(::Newtonsoft::Json::ReadType readType);

  /// @brief Method ParseNumberNaN addr 0x26456f4 size 0x160 virtual false final false
  inline ::System::Object* ParseNumberNaN(::Newtonsoft::Json::ReadType readType);

  /// @brief Method Close addr 0x26479a4 size 0x60 virtual true final false
  inline void Close();

  /// @brief Method HasLineInfo addr 0x2647a18 size 0x8 virtual true final true
  inline bool HasLineInfo();

  /// @brief Method get_LineNumber addr 0x2647a20 size 0x48 virtual true final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition addr 0x2647a68 size 0xc virtual true final true
