...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::MetadataPropertyHandling, "Newtonsoft.Json", "MetadataPropertyHandling");
// Dependencies
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::MetadataPropertyHandling) == 0x4, "Size mismatch!");
