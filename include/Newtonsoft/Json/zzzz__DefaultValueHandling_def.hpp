...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::DefaultValueHandling, "Newtonsoft.Json", "DefaultValueHandling");
// Dependencies
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::DefaultValueHandling) == 0x4, "Size mismatch!");
