...
public:
  ...
  /// @brief Method .ctor, addr 0x5bfe13c, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_Value, addr 0x5bfe134, size 0x8, virtual false, abstract: false, final false
