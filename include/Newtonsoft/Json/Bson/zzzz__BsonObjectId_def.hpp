...
public:
  ...
  /// @brief Method .ctor, addr 0x2aba164, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_Value, addr 0x2aba15c, size 0x8, virtual false, abstract: false, final false
