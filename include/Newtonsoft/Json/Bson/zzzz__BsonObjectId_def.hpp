...
public:
  ...
  __declspec(property(get = __cordl_internal_get__Value_k__BackingField, put = __cordl_internal_set__Value_k__BackingField)) ::ArrayW<uint8_t> _Value_k__BackingField;

  static inline ::Newtonsoft::Json::Bson::BsonObjectId* New_ctor(::ArrayW<uint8_t> value);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__Value_k__BackingField() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get__Value_k__BackingField();
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonObjectId) == 0x18, "Size mismatch!");
