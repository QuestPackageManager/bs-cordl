...
public:
  ...
  /// @brief Method .ctor, addr 0x5dac69c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW pattern, ::StringW options);

  /// @brief Method get_Options, addr 0x5dac68c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Options();

  /// @brief Method get_Pattern, addr 0x5dac67c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Pattern();

  /// @brief Method get_Type, addr 0x5dac728, size 0x8, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Bson::BsonType get_Type();

  /// @brief Method set_Options, addr 0x5dac694, size 0x8, virtual false, abstract: false, final false
  inline void set_Options(::Newtonsoft::Json::Bson::BsonString* value);

  /// @brief Method set_Pattern, addr 0x5dac684, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonRegex) == 0x30, "Size mismatch!");
