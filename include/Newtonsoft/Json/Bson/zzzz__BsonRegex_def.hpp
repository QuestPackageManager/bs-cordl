...
public:
  ...
  /// @brief Method get_Pattern addr 0x26c8474 size 0x8 virtual false final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Pattern();

  /// @brief Method set_Pattern addr 0x26c847c size 0x8 virtual false final false
  inline void set_Pattern(::Newtonsoft::Json::Bson::BsonString* value);

  /// @brief Method get_Options addr 0x26c8484 size 0x8 virtual false final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Options();

  /// @brief Method set_Options addr 0x26c848c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26c8494 size 0xbc virtual false final false
  inline void _ctor(::StringW pattern, ::StringW options);

  /// @brief Method get_Type addr 0x26c8550 size 0x8 virtual true final false
