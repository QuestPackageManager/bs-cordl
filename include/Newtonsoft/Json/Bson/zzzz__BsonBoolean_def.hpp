...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BsonBoolean", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BsonBoolean(BsonBoolean&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BsonBoolean", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BsonBoolean(BsonBooleanconst&) = delete;
