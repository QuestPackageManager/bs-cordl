...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Bson::BsonToken*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonToken*, "Newtonsoft.Json.Bson", "BsonToken");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dac1c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CalculatedSize, addr 0x5dac1b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CalculatedSize();

  /// @brief Method get_Parent, addr 0x5dac1a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CalculatedSize, addr 0x5dac1b8, size 0x8, virtual false, abstract: false, final false
  inline void set_CalculatedSize(int32_t value);

  /// @brief Method set_Parent, addr 0x5dac1a8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonToken) == 0x20, "Size mismatch!");
