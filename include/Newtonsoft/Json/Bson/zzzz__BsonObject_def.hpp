...
public:
  ...
  /// @brief Method Add, addr 0x5dae3ec, size 0x11c, virtual false, abstract: false, final false
  inline void Add(::StringW name, ::Newtonsoft::Json::Bson::BsonToken* token);

  /// @brief Method GetEnumerator, addr 0x5dac210, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5dae528, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5dae52c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Type, addr 0x5dae520, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  BsonObject(BsonObjectconst&) = delete;
