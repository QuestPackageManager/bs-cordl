...
public:
  ...
  /// @brief Method get_Name addr 0x2564e08 size 0x8 virtual false final false
  inline ::Newtonsoft::Json::Bson::BsonString* get_Name();

  /// @brief Method set_Name addr 0x2564e10 size 0x8 virtual false final false
  inline void set_Name(::Newtonsoft::Json::Bson::BsonString* value);

  /// @brief Method get_Value addr 0x2564e18 size 0x8 virtual false final false
  inline ::Newtonsoft::Json::Bson::BsonToken* get_Value();

  /// @brief Method set_Value addr 0x2564e20 size 0x8 virtual false final false
  inline void set_Value(::Newtonsoft::Json::Bson::BsonToken* value);

  static inline ::Newtonsoft::Json::Bson::BsonProperty* New_ctor();

  /// @brief Method .ctor addr 0x2564a74 size 0x8 virtual false final false
  inline void _ctor();
