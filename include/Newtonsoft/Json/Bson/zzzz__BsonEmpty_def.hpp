...
public:
  ...
  /// @brief Method .ctor, addr 0x5c00218, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x5c00220, size 0x8, virtual true, abstract: false, final false
