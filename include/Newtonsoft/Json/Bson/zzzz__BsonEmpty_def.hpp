...
public:
  ...
  /// @brief Method .ctor, addr 0x5dac4ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x5dac4b4, size 0x8, virtual true, abstract: false, final false
