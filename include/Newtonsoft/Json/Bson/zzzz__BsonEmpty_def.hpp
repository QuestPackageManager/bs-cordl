...
public:
  ...
  /// @brief Method .ctor, addr 0x3f52ea0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x3f52ec8, size 0x8, virtual true, abstract: false, final false
