...
public:
  ...
  /// @brief Method .ctor, addr 0x3f53280, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x3f532a8, size 0x8, virtual true, abstract: false, final false
