...
public:
  ...
  /// @brief Method Add, addr 0x3f530d8, size 0xa8, virtual false, abstract: false, final false
  inline void Add(::Newtonsoft::Json::Bson::BsonToken* token);

  /// @brief Method GetEnumerator, addr 0x3f50f88, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3f53188, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3f5318c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Type, addr 0x3f53180, size 0x8, virtual true, abstract: false, final false
