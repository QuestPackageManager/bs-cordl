...
public:
  ...
  /// @brief Method Add, addr 0x2a9b980, size 0xb0, virtual false, abstract: false, final false
  inline void Add(::Newtonsoft::Json::Bson::BsonToken* token);

  /// @brief Method GetEnumerator, addr 0x2a99848, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2a9ba38, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a9ba3c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Type, addr 0x2a9ba30, size 0x8, virtual true, abstract: false, final false
