...
public:
  ...
  /// @brief Method Add, addr 0x3f4e1dc, size 0xa8, virtual false, abstract: false, final false
  inline void Add(::Newtonsoft::Json::Bson::BsonToken* token);

  /// @brief Method GetEnumerator, addr 0x3f4c08c, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3f4e28c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3f4e290, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Type, addr 0x3f4e284, size 0x8, virtual true, abstract: false, final false
