...
namespace Newtonsoft::Json::Bson {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12005)), TypeDefinitionIndex(TypeDefinitionIndex(11997))}
...
public:
  ...
  /// @brief Method get_BinaryType addr 0x2564cdc size 0x8 virtual false final false
  inline ::Newtonsoft::Json::Bson::BsonBinaryType get_BinaryType();

  /// @brief Method set_BinaryType addr 0x2564ce4 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2564cec size 0x38 virtual false final false
