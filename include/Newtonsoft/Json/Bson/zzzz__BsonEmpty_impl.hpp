...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonEmpty::*)(::Newtonsoft::Json::Bson::BsonType)>(
  ...
  constexpr static std::size_t addrs = 0x2abc144;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Newtonsoft::Json::Bson::BsonType (::Newtonsoft::Json::Bson::BsonEmpty::*)()>(
  ...
  constexpr static std::size_t addrs = 0x2abc16c;

  inline static const ::MethodInfo* methodInfo() {

    static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonEmpty*>::get(),
...
inline void Newtonsoft::Json::Bson::BsonEmpty::setStaticF_Null(::Newtonsoft::Json::Bson::BsonToken* value) {
  ::cordl_internals::setStaticField<::Newtonsoft::Json::Bson::BsonToken*, "Null", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonEmpty*>::get>(
      std::forward<::Newtonsoft::Json::Bson::BsonToken*>(value));
}
...
inline void Newtonsoft::Json::Bson::BsonEmpty::setStaticF_Undefined(::Newtonsoft::Json::Bson::BsonToken* value) {
  ::cordl_internals::setStaticField<::Newtonsoft::Json::Bson::BsonToken*, "Undefined", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonEmpty*>::get>(
      std::forward<::Newtonsoft::Json::Bson::BsonToken*>(value));
}
