...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::StringEscapeHandling, "Newtonsoft.Json", "StringEscapeHandling");
// Dependencies
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::StringEscapeHandling) == 0x4, "Size mismatch!");
