...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::LineInfoHandling, "Newtonsoft.Json.Linq", "LineInfoHandling");
// Dependencies
namespace Newtonsoft::Json::Linq {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::Linq::LineInfoHandling) == 0x4, "Size mismatch!");
