...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Linq::JTokenEqualityComparer*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JTokenEqualityComparer*, "Newtonsoft.Json.Linq", "JTokenEqualityComparer");
...
public:
  ...
  /// @brief Method Equals, addr 0x5d83c10, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::Newtonsoft::Json::Linq::JToken* x, ::Newtonsoft::Json::Linq::JToken* y);

  /// @brief Method GetHashCode, addr 0x5d83cac, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5d83cd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JTokenEqualityComparer) == 0x10, "Size mismatch!");
