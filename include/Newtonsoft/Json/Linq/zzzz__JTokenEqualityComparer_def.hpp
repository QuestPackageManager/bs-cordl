...
/// @brief Method Equals, addr 0x5bd7e88, size 0x9c, virtual true, abstract: false, final true
inline bool Equals(::Newtonsoft::Json::Linq::JToken*  x, ::Newtonsoft::Json::Linq::JToken*  y) ;

/// @brief Method GetHashCode, addr 0x5bd7f24, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5bd7f48, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
