...
public:
  ...
  /// @brief Method Equals addr 0x2691410 size 0x94 virtual true final true
  inline bool Equals(::Newtonsoft::Json::Linq::JToken* x, ::Newtonsoft::Json::Linq::JToken* y);

  /// @brief Method GetHashCode addr 0x26914d0 size 0x24 virtual true final true
  ...
  /// @brief Method .ctor addr 0x26914f4 size 0x8 virtual false final false
  inline void _ctor();
