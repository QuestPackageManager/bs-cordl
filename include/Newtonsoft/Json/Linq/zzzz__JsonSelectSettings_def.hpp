...
/// @brief Field <RegexMatchTimeout>k__BackingField, offset 0x10, size 0x10 
 __declspec(property(get=__cordl_internal_get__RegexMatchTimeout_k__BackingField, put=__cordl_internal_set__RegexMatchTimeout_k__BackingField)) ::System::Nullable_1<::System::TimeSpan>  _RegexMatchTimeout_k__BackingField;
...
/// @brief Method .ctor, addr 0x5c40bd4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ErrorWhenNoMatch, addr 0x5c40bc4, size 0x8, virtual false, abstract: false, final false
inline bool get_ErrorWhenNoMatch() ;

/// @brief Method get_RegexMatchTimeout, addr 0x5c40bb0, size 0xc, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::TimeSpan> get_RegexMatchTimeout() ;

/// @brief Method set_ErrorWhenNoMatch, addr 0x5c40bcc, size 0x8, virtual false, abstract: false, final false
inline void set_ErrorWhenNoMatch(bool  value) ;

/// @brief Method set_RegexMatchTimeout, addr 0x5c40bbc, size 0x8, virtual false, abstract: false, final false
