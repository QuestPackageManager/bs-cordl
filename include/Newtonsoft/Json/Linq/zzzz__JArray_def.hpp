...
public:
  ...
  /// @brief Method get_ChildrenTokens addr 0x269af08 size 0x8 virtual true final false
  inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Linq::JToken*>* get_ChildrenTokens();

  /// @brief Method get_Type addr 0x269af10 size 0x8 virtual true final false
  inline ::Newtonsoft::Json::Linq::JTokenType get_Type();

  static inline ::Newtonsoft::Json::Linq::JArray* New_ctor();

  /// @brief Method .ctor addr 0x2696cb0 size 0x78 virtual false final false
  inline void _ctor();

  static inline ::Newtonsoft::Json::Linq::JArray* New_ctor(::Newtonsoft::Json::Linq::JArray* other);

  /// @brief Method .ctor addr 0x269af18 size 0x88 virtual false final false
  ...
  /// @brief Method .ctor addr 0x269afa0 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x269afa4 size 0x9c virtual false final false
  inline void _ctor(::System::Object* content);

  /// @brief Method DeepEquals addr 0x269b040 size 0x8c virtual true final false
  inline bool DeepEquals(::Newtonsoft::Json::Linq::JToken* node);

  /// @brief Method CloneToken addr 0x269b0cc size 0x60 virtual true final false
  inline ::Newtonsoft::Json::Linq::JToken* CloneToken();

  /// @brief Method Load addr 0x269b12c size 0x8 virtual false final false
  static inline ::Newtonsoft::Json::Linq::JArray* Load(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method Load addr 0x269b134 size 0x1a0 virtual false final false
  ...
  /// @brief Method Parse addr 0x269b2d4 size 0x8 virtual false final false
  static inline ::Newtonsoft::Json::Linq::JArray* Parse(::StringW json);

  /// @brief Method Parse addr 0x269b2dc size 0x23c virtual false final false
  static inline ::Newtonsoft::Json::Linq::JArray* Parse(::StringW json, ::Newtonsoft::Json::Linq::JsonLoadSettings* settings);

  /// @brief Method FromObject addr 0x269b518 size 0x20 virtual false final false
  static inline ::Newtonsoft::Json::Linq::JArray* FromObject(::System::Object* o);

  /// @brief Method FromObject addr 0x269b538 size 0x18c virtual false final false
  static inline ::Newtonsoft::Json::Linq::JArray* FromObject(::System::Object* o, ::Newtonsoft::Json::JsonSerializer* jsonSerializer);

  /// @brief Method WriteTo addr 0x269b6c4 size 0xcc virtual true final false
  ...
  /// @brief Method get_Item addr 0x269b790 size 0x12c virtual true final false
  inline ::Newtonsoft::Json::Linq::JToken* get_Item(::System::Object* key);

  /// @brief Method set_Item addr 0x269b8bc size 0x134 virtual true final false
  inline void set_Item(::System::Object* key, ::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method get_Item addr 0x269b9f0 size 0x10 virtual true final true
  inline ::Newtonsoft::Json::Linq::JToken* get_Item(int32_t index);

  /// @brief Method set_Item addr 0x269ba00 size 0x10 virtual true final true
  inline void set_Item(int32_t index, ::Newtonsoft::Json::Linq::JToken* value);

  /// @brief Method IndexOfItem addr 0x269ba10 size 0x58 virtual true final false
  inline int32_t IndexOfItem(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method MergeItem addr 0x269ba68 size 0xe0 virtual true final false
  inline void MergeItem(::System::Object* content, ::Newtonsoft::Json::Linq::JsonMergeSettings* settings);

  /// @brief Method IndexOf addr 0x269bb48 size 0x10 virtual true final true
  inline int32_t IndexOf(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method Insert addr 0x269bb58 size 0x14 virtual true final true
  inline void Insert(int32_t index, ::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method RemoveAt addr 0x269bb6c size 0x10 virtual true final true
  inline void RemoveAt(int32_t index);

  /// @brief Method GetEnumerator addr 0x269bb7c size 0x70 virtual true final true
  inline ::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* GetEnumerator();

  /// @brief Method Add addr 0x269bbec size 0x10 virtual true final true
  inline void Add(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method Clear addr 0x269bbfc size 0x10 virtual true final true
  inline void Clear();

  /// @brief Method Contains addr 0x269bc0c size 0x10 virtual true final true
  inline bool Contains(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method CopyTo addr 0x269bc1c size 0x10 virtual true final true
  inline void CopyTo(::ArrayW<::Newtonsoft::Json::Linq::JToken*, ::Array<::Newtonsoft::Json::Linq::JToken*>*> array, int32_t arrayIndex);

  /// @brief Method get_IsReadOnly addr 0x269bc2c size 0x8 virtual true final true
  inline bool get_IsReadOnly();

  /// @brief Method Remove addr 0x269bc34 size 0x10 virtual true final true
  inline bool Remove(::Newtonsoft::Json::Linq::JToken* item);

  /// @brief Method GetDeepHashCode addr 0x269bc44 size 0x4 virtual true final false
