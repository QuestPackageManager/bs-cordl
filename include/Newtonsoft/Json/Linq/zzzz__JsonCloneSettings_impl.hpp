...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Linq::JsonCloneSettings::*)()>(&::Newtonsoft::Json::Linq::JsonCloneSettings::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5c408c4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Newtonsoft::Json::Linq::JsonCloneSettings::*)()>(&::Newtonsoft::Json::Linq::JsonCloneSettings::get_CopyAnnotations)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5c408d0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Linq::JsonCloneSettings::*)(bool)>(&::Newtonsoft::Json::Linq::JsonCloneSettings::set_CopyAnnotations)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5c408d8;
...
::cordl_internals::setStaticField<::Newtonsoft::Json::Linq::JsonCloneSettings*, "SkipCopyAnnotations", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Linq::JsonCloneSettings*>::get>(std::forward<::Newtonsoft::Json::Linq::JsonCloneSettings*>(value));
}
inline ::Newtonsoft::Json::Linq::JsonCloneSettings* Newtonsoft::Json::Linq::JsonCloneSettings::getStaticF_SkipCopyAnnotations()  {
return ::cordl_internals::getStaticField<::Newtonsoft::Json::Linq::JsonCloneSettings*, "SkipCopyAnnotations", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Linq::JsonCloneSettings*>::get>();
}
