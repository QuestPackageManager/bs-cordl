...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QueryFilter__ExecuteFilter_d__2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QueryFilter__ExecuteFilter_d__2(QueryFilter__ExecuteFilter_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QueryFilter__ExecuteFilter_d__2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QueryFilter__ExecuteFilter_d__2(QueryFilter__ExecuteFilter_d__2const&) = delete;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QueryFilter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QueryFilter(QueryFilter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QueryFilter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QueryFilter(QueryFilterconst&) = delete;
