...
public:
  ...
  /// @brief Method EqualsWithStrictMatch, addr 0x5be5d0c, size 0x114, virtual false, abstract: false, final false
  static inline bool EqualsWithStrictMatch(::Newtonsoft::Json::Linq::JValue* value, ::Newtonsoft::Json::Linq::JValue* queryValue);

  /// @brief Method EqualsWithStringCoercion, addr 0x5be57cc, size 0x540, virtual false, abstract: false, final false
  static inline bool EqualsWithStringCoercion(::Newtonsoft::Json::Linq::JValue* value, ::Newtonsoft::Json::Linq::JValue* queryValue);

  /// @brief Method GetResult, addr 0x5be4b54, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMatch, addr 0x5be4d34, size 0x67c, virtual true, abstract: false, final false
  ...
  /// @brief Method MatchTokens, addr 0x5be53b0, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegexEquals, addr 0x5be55ec, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5be409c, size 0xc, virtual false, abstract: false, final false
