...
public:
  ...
  /// @brief Method EqualsWithStrictMatch, addr 0x5d941c8, size 0x114, virtual false, abstract: false, final false
  static inline bool EqualsWithStrictMatch(::Newtonsoft::Json::Linq::JValue* value, ::Newtonsoft::Json::Linq::JValue* queryValue);

  /// @brief Method EqualsWithStringCoercion, addr 0x5d93c88, size 0x540, virtual false, abstract: false, final false
  static inline bool EqualsWithStringCoercion(::Newtonsoft::Json::Linq::JValue* value, ::Newtonsoft::Json::Linq::JValue* queryValue);

  /// @brief Method GetResult, addr 0x5d93010, size 0x1e0, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* GetResult(::Newtonsoft::Json::Linq::JToken* root, ::Newtonsoft::Json::Linq::JToken* t,
                                                                                                     /* [Nullable(2)] */ ::System::Object* o);

  /// @brief Method IsMatch, addr 0x5d931f0, size 0x67c, virtual true, abstract: false, final false
  ...
  /// @brief Method MatchTokens, addr 0x5d9386c, size 0x23c, virtual false, abstract: false, final false
  inline bool MatchTokens(::Newtonsoft::Json::Linq::JToken* leftResult, ::Newtonsoft::Json::Linq::JToken* rightResult, /* [Nullable(2)] */ ::Newtonsoft::Json::Linq::JsonSelectSettings* settings);
  ...
  /// @brief Method RegexEquals, addr 0x5d93aa8, size 0x1e0, virtual false, abstract: false, final false
  static inline bool RegexEquals(::Newtonsoft::Json::Linq::JValue* input, ::Newtonsoft::Json::Linq::JValue* pattern, /* [Nullable(2)] */ ::Newtonsoft::Json::Linq::JsonSelectSettings* settings);
  ...
  /// @brief Method .ctor, addr 0x5d92558, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JsonPath::QueryOperator _cordl_operator, ::System::Object* left, /* [Nullable(2)] */ ::System::Object* right);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BooleanQueryExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BooleanQueryExpression(BooleanQueryExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BooleanQueryExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BooleanQueryExpression(BooleanQueryExpressionconst&) = delete;
