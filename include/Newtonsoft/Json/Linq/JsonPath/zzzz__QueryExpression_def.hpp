...
public:
  ...
  /// @brief Method IsMatch, addr 0x3ed58a4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ed587c, size 0x28, virtual false, abstract: false, final false
