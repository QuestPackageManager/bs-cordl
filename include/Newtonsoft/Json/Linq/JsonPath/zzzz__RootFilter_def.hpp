...
public:
  ...
  /// @brief Method ExecuteFilter, addr 0x3f39878, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f39870, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
