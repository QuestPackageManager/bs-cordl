...
class ArrayIndexFilter__ExecuteFilter_d__4;
}
...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter*);
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter*, "Newtonsoft.Json.Linq.JsonPath", "ArrayIndexFilter");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4*, "Newtonsoft.Json.Linq.JsonPath", "ArrayIndexFilter/<ExecuteFilter>d__4");
// Dependencies System.Object
namespace Newtonsoft::Json::Linq::JsonPath {
// Is value type: false
// CS Name: Newtonsoft.Json.Linq.JsonPath.ArrayIndexFilter/<ExecuteFilter>d__4
class CORDL_TYPE ArrayIndexFilter__ExecuteFilter_d__4 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method MoveNext, addr 0x5d8a9c4, size 0x5fc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x5d8b440, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x5d8b3f8, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5d8b4e8, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5d8b400, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5d8b438, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5d8a914, size 0xb0, virtual true, abstract: false, final true
  ...
  constexpr ::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter* const& __cordl_internal_get___4__this() const;
  ...
  /// @brief Method <>m__Finally1, addr 0x5d8b344, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x5d8b290, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x5d8a8ec, size 0x20, virtual false, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr ArrayIndexFilter__ExecuteFilter_d__4();

public:
  // Ctor Parameters [CppParam { name: "", ty: "ArrayIndexFilter__ExecuteFilter_d__4", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArrayIndexFilter__ExecuteFilter_d__4(ArrayIndexFilter__ExecuteFilter_d__4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArrayIndexFilter__ExecuteFilter_d__4", modifiers: "const&", def_value: None }]
...
static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, _____l__initialThreadId) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, ___current) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, _____3__current) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, _____4__this) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, ___settings) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, _____3__settings) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, _____7__wrap1) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4, _____7__wrap2) == 0x58, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4) == 0x60, "Size mismatch!");
...
public:
  // Declarations
  using _ExecuteFilter_d__4 = ::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter__ExecuteFilter_d__4;
  ...
  /// @brief Method ExecuteFilter, addr 0x5d8a86c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d8a90c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Index, addr 0x5d8a85c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_Index();

  /// @brief Method set_Index, addr 0x5d8a864, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter) == 0x18, "Size mismatch!");
