...
public:
  ...
  /// @brief Method .ctor addr 0x2549968 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ExecuteFilter>b__4_0 addr 0x2549970 size 0x50 virtual false final false
...
namespace Newtonsoft::Json::Linq::JsonPath {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3830)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3830), inst: 393 }),
// TypeDefinitionIndex(TypeDefinitionIndex(2611))} Self: TypeDefinitionIndex(TypeDefinitionIndex(11945)) CS Name: ::FieldMultipleFilter::<ExecuteFilter>d__4*
...
public:
  ...
  /// @brief Method .ctor addr 0x25498b8 size 0x44 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x25499c0 size 0xb0 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x2549a70 size 0x6d8 virtual true final true
  inline bool MoveNext();

  /// @brief Method <>m__Finally1 addr 0x254a198 size 0xb0 virtual false final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2 addr 0x254a148 size 0x50 virtual false final false
  inline void __m__Finally2();

  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current addr 0x254a248 size 0x8 virtual true final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x254a250 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x254a290 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator addr 0x254a298 size 0xb0 virtual true final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x254a348 size 0x4 virtual true final true
...
public:
  ...
  /// @brief Method get_Names addr 0x254982c size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Names();

  /// @brief Method set_Names addr 0x2549834 size 0x8 virtual false final false
  inline void set_Names(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method ExecuteFilter addr 0x254983c size 0x7c virtual true final false
  ...
  /// @brief Method .ctor addr 0x25498fc size 0x8 virtual false final false
  inline void _ctor();
