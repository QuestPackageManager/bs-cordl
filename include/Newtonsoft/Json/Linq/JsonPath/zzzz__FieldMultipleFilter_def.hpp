...
public:
  ...
  /// @brief Method <ExecuteFilter>b__2_0, addr 0x5b7a538, size 0x54, virtual false, abstract: false, final false
  inline ::StringW _ExecuteFilter_b__2_0(::StringW n);

  /// @brief Method .ctor, addr 0x5b7a534, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5b7a670, size 0x718, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Newtonsoft::Json::Linq::JsonPath::FieldMultipleFilter__ExecuteFilter_d__2* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x5b7aecc, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current, addr 0x5b7ae84, size 0x8, virtual true, abstract: false, final true
  inline ::Newtonsoft::Json::Linq::JToken* System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5b7af74, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5b7ae8c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5b7aec4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5b7a58c, size 0xe4, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x5b7add0, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x5b7ad88, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x5b7a4c0, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ExecuteFilter, addr 0x5b7a440, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b7a438, size 0x8, virtual false, abstract: false, final false
