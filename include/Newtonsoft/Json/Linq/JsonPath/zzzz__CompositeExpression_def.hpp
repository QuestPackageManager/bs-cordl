...
public:
  ...
  /// @brief Method IsMatch, addr 0x3f3b82c, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f3afc0, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JsonPath::QueryOperator _cordl_operator);

  /// @brief Method get_Expressions, addr 0x3f3b81c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::QueryExpression*>* get_Expressions();

  /// @brief Method set_Expressions, addr 0x3f3b824, size 0x8, virtual false, abstract: false, final false
