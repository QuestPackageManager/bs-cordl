...
public:
  ...
  /// @brief Method IsMatch, addr 0x3f322e8, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f31a7c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JsonPath::QueryOperator _cordl_operator);

  /// @brief Method get_Expressions, addr 0x3f322d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::QueryExpression*>* get_Expressions();

  /// @brief Method set_Expressions, addr 0x3f322e0, size 0x8, virtual false, abstract: false, final false
