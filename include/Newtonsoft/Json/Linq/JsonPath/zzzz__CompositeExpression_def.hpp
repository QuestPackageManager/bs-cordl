...
public:
  ...
  /// @brief Method IsMatch, addr 0x5be4930, size 0x224, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5be4164, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JsonPath::QueryOperator _cordl_operator);

  /// @brief Method get_Expressions, addr 0x5be4920, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::QueryExpression*>* get_Expressions();

  /// @brief Method set_Expressions, addr 0x5be4928, size 0x8, virtual false, abstract: false, final false
