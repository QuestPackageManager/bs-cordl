...
public:
  ...
  /// @brief Method MoveNext, addr 0x5c3e758, size 0x574, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5c3eccc, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CloneToken, addr 0x5c3e6e8, size 0x70, virtual true, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* CloneToken(::Newtonsoft::Json::Linq::JsonCloneSettings* settings);

  /// @brief Method Create, addr 0x5c3e3f4, size 0x2f4, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Linq::JRaw* Create(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method CreateAsync, addr 0x5c3e2e4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c3e3d4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JRaw* other);

  /// @brief Method .ctor, addr 0x5c3e3e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JRaw* other, ::Newtonsoft::Json::Linq::JsonCloneSettings* settings);

  /// @brief Method .ctor, addr 0x5c3e3e8, size 0xc, virtual false, abstract: false, final false
