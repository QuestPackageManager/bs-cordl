...
namespace Newtonsoft::Json::Linq {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11935))}
...
public:
  ...
  /// @brief Method .ctor addr 0x252d8dc size 0x8 virtual false final false
  inline void _ctor(::Newtonsoft::Json::Linq::JRaw* other);

  static inline ::Newtonsoft::Json::Linq::JRaw* New_ctor(::System::Object* rawJson);

  /// @brief Method .ctor addr 0x252d8e4 size 0xc virtual false final false
  inline void _ctor(::System::Object* rawJson);

  /// @brief Method Create addr 0x252d8f0 size 0x378 virtual false final false
  static inline ::Newtonsoft::Json::Linq::JRaw* Create(::Newtonsoft::Json::JsonReader* reader);

  /// @brief Method CloneToken addr 0x252dc68 size 0x64 virtual true final false
