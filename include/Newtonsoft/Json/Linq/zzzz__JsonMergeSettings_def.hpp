...
/// @brief Method .ctor, addr 0x5bccf18, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_MergeArrayHandling, addr 0x5bccf24, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::MergeArrayHandling get_MergeArrayHandling() ;

/// @brief Method get_MergeNullValueHandling, addr 0x5bccf88, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::MergeNullValueHandling get_MergeNullValueHandling() ;

/// @brief Method get_PropertyNameComparison, addr 0x5bccfec, size 0x8, virtual false, abstract: false, final false
inline ::System::StringComparison get_PropertyNameComparison() ;

/// @brief Method set_MergeArrayHandling, addr 0x5bccf2c, size 0x5c, virtual false, abstract: false, final false
inline void set_MergeArrayHandling(::Newtonsoft::Json::Linq::MergeArrayHandling  value) ;

/// @brief Method set_MergeNullValueHandling, addr 0x5bccf90, size 0x5c, virtual false, abstract: false, final false
inline void set_MergeNullValueHandling(::Newtonsoft::Json::Linq::MergeNullValueHandling  value) ;

/// @brief Method set_PropertyNameComparison, addr 0x5bccff4, size 0x5c, virtual false, abstract: false, final false
