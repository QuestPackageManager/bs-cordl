...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::CommentHandling, "Newtonsoft.Json.Linq", "CommentHandling");
// Dependencies
namespace Newtonsoft::Json::Linq {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::Linq::CommentHandling) == 0x4, "Size mismatch!");
