...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::MergeArrayHandling, "Newtonsoft.Json.Linq", "MergeArrayHandling");
// Dependencies
namespace Newtonsoft::Json::Linq {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::Linq::MergeArrayHandling) == 0x4, "Size mismatch!");
