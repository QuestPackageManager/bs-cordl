...
public:
  ...
  /// @brief Method GetEndToken, addr 0x3f29560, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method Newtonsoft.Json.IJsonLineInfo.HasLineInfo, addr 0x3f296d8, size 0xb4, virtual true, abstract: false, final true
  inline bool Newtonsoft_Json_IJsonLineInfo_HasLineInfo();

  /// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LineNumber, addr 0x3f2978c, size 0xb8, virtual true, abstract: false, final true
  inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LineNumber();

  /// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LinePosition, addr 0x3f29844, size 0xb8, virtual true, abstract: false, final true
  inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LinePosition();

  /// @brief Method Read, addr 0x3f28cd4, size 0xd0, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadInto, addr 0x3f28da4, size 0x68, virtual false, abstract: false, final false
  inline bool ReadInto(::Newtonsoft::Json::Linq::JContainer* c);

  /// @brief Method ReadOver, addr 0x3f28e0c, size 0xb4, virtual false, abstract: false, final false
  inline bool ReadOver(::Newtonsoft::Json::Linq::JToken* t);

  /// @brief Method ReadToEnd, addr 0x3f294bc, size 0x20, virtual false, abstract: false, final false
  inline bool ReadToEnd();

  /// @brief Method SafeToString, addr 0x3f296b8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW SafeToString(::System::Object* value);

  /// @brief Method SetEnd, addr 0x3f294dc, size 0x84, virtual false, abstract: false, final false
  inline bool SetEnd(::Newtonsoft::Json::Linq::JContainer* c);

  /// @brief Method SetToken, addr 0x3f28ec0, size 0x5fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f28c44, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JToken* token);

  /// @brief Method .ctor, addr 0x3f28cb0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::Newtonsoft::Json::Linq::JToken* token, ::StringW initialPath);

  /// @brief Method get_CurrentToken, addr 0x3f28c3c, size 0x8, virtual false, abstract: false, final false
  inline ::Newtonsoft::Json::Linq::JToken* get_CurrentToken();

  /// @brief Method get_Path, addr 0x3f298fc, size 0xe8, virtual true, abstract: false, final false
