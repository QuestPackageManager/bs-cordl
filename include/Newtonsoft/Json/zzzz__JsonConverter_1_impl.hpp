...
template <typename T>
inline void Newtonsoft::Json::JsonConverter_1<T>::WriteJson(::Newtonsoft::Json::JsonWriter* writer, /* [Nullable(2)] */ ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer) {
...
template <typename T> inline void Newtonsoft::Json::JsonConverter_1<T>::WriteJson(::Newtonsoft::Json::JsonWriter* writer, /* [Nullable(2)] */ T value, ::Newtonsoft::Json::JsonSerializer* serializer) {
...
template <typename T>
inline ::System::Object* Newtonsoft::Json::JsonConverter_1<T>::ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, /* [Nullable(2)] */ ::System::Object* existingValue,
...
template <typename T>
inline T Newtonsoft::Json::JsonConverter_1<T>::ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, /* [Nullable(2)] */ T existingValue, bool hasExistingValue,
                                                        ::Newtonsoft::Json::JsonSerializer* serializer) {
