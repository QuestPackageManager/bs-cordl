...
public:
  ...
  /// @brief Method .ctor, addr 0x5ac1f60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5ac1f64, size 0x8, virtual false, abstract: false, final false
