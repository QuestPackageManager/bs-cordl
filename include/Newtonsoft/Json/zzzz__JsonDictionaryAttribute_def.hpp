...
public:
  ...
  /// @brief Method .ctor, addr 0x3e8031c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e80324, size 0x28, virtual false, abstract: false, final false
