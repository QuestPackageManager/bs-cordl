...
/// @brief Method BuildPath, addr 0x5b29a64, size 0x2d4, virtual false, abstract: false, final false
...
/// @brief Method CalculateLength, addr 0x5b297a0, size 0x94, virtual false, abstract: false, final false
inline int32_t CalculateLength() ;

/// @brief Method FormatMessage, addr 0x5b291c0, size 0x328, virtual false, abstract: false, final false
static inline ::StringW FormatMessage(::Newtonsoft::Json::IJsonLineInfo*  lineInfo, ::StringW  path, ::StringW  message) ;

/// @brief Method TypeHasIndex, addr 0x5b29790, size 0x10, virtual false, abstract: false, final false
static inline bool TypeHasIndex(::Newtonsoft::Json::JsonContainerType  type) ;

/// @brief Method WriteTo, addr 0x5b29834, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b29710, size 0x80, virtual false, abstract: false, final false
