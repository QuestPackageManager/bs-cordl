...
public:
  ...
  /// @brief Method BuildPath, addr 0x5cd57ec, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateLength, addr 0x5cd5528, size 0x94, virtual false, abstract: false, final false
  inline int32_t CalculateLength();

  /// @brief Method FormatMessage, addr 0x5cd4f48, size 0x328, virtual false, abstract: false, final false
  static inline ::StringW FormatMessage(::Newtonsoft::Json::IJsonLineInfo* lineInfo, ::StringW path, ::StringW message);

  /// @brief Method TypeHasIndex, addr 0x5cd5518, size 0x10, virtual false, abstract: false, final false
  static inline bool TypeHasIndex(::Newtonsoft::Json::JsonContainerType type);

  /// @brief Method WriteTo, addr 0x5cd55bc, size 0x230, virtual false, abstract: false, final false
  inline void WriteTo(::System::Text::StringBuilder* sb, ::by_ref<::System::IO::StringWriter*> writer, ::by_ref<::ArrayW<char16_t>> buffer);

  /// @brief Method .ctor, addr 0x5cd5498, size 0x80, virtual false, abstract: false, final false
