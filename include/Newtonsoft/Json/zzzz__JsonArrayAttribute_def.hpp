...
public:
  ...
  /// @brief Method .ctor, addr 0x3e7c304, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e7c314, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool allowNullItems);

  /// @brief Method .ctor, addr 0x3e7c33c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW id);

  /// @brief Method get_AllowNullItems, addr 0x3e7c2f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowNullItems();

  /// @brief Method set_AllowNullItems, addr 0x3e7c2f8, size 0xc, virtual false, abstract: false, final false
