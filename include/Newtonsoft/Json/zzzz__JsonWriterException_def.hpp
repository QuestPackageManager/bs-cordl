...
public:
  ...
  /// @brief Method get_Path addr 0x24e7a60 size 0x8 virtual false final false
  inline ::StringW get_Path();

  /// @brief Method set_Path addr 0x24e7a68 size 0x8 virtual false final false
  inline void set_Path(::StringW value);

  static inline ::Newtonsoft::Json::JsonWriterException* New_ctor();

  /// @brief Method .ctor addr 0x24e7a70 size 0x4 virtual false final false
  inline void _ctor();

  static inline ::Newtonsoft::Json::JsonWriterException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x24e7a74 size 0x4 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::Newtonsoft::Json::JsonWriterException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor addr 0x24e7a78 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24e7a7c size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24e7a80 size 0x24 virtual false final false
  inline void _ctor(::StringW message, ::System::Exception* innerException, ::StringW path);

  /// @brief Method Create addr 0x24e6140 size 0x34 virtual false final false
  ...
  /// @brief Method Create addr 0x24e7aa4 size 0xb4 virtual false final false
