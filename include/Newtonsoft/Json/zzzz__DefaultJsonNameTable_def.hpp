...
/// @brief Method .ctor, addr 0x5b25040, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field _entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::ArrayW<::Newtonsoft::Json::DefaultJsonNameTable_Entry*,::Array<::Newtonsoft::Json::DefaultJsonNameTable_Entry*>*>  _entries;
...
/// @brief Method Add, addr 0x5b24da4, size 0x194, virtual false, abstract: false, final false
inline ::StringW Add(::StringW  key) ;

/// @brief Method AddEntry, addr 0x5b24f38, size 0x108, virtual false, abstract: false, final false
inline ::StringW AddEntry(::StringW  str, int32_t  hashCode) ;

/// @brief Method Get, addr 0x5b24b6c, size 0x188, virtual true, abstract: false, final false
inline ::StringW Get(::ArrayW<char16_t,::Array<char16_t>*>  key, int32_t  start, int32_t  length) ;

/// @brief Method Grow, addr 0x5b25050, size 0x130, virtual false, abstract: false, final false
inline void Grow() ;

static inline ::Newtonsoft::Json::DefaultJsonNameTable* New_ctor() ;

/// @brief Method TextEquals, addr 0x5b24cf4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b24b0c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
