...
public:
  ...
  /// @brief Method .ctor, addr 0x29de770, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x29de4ac, size 0x1b8, virtual false, abstract: false, final false
  inline ::StringW Add(::StringW key);

  /// @brief Method AddEntry, addr 0x29de664, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW AddEntry(::StringW str, int32_t hashCode);

  /// @brief Method Get, addr 0x29de270, size 0x18c, virtual true, abstract: false, final false
  inline ::StringW Get(::ArrayW<char16_t, ::Array<char16_t>*> key, int32_t start, int32_t length);

  /// @brief Method Grow, addr 0x29de7b0, size 0x128, virtual false, abstract: false, final false
  inline void Grow();

  static inline ::Newtonsoft::Json::DefaultJsonNameTable* New_ctor();

  /// @brief Method TextEquals, addr 0x29de3fc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29de200, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
