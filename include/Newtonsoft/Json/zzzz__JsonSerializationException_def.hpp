...
public:
  ...
  /// @brief Method Create, addr 0x5cdc6a8, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x5cd40ac, size 0x8, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::JsonSerializationException* Create(::Newtonsoft::Json::JsonReader* reader, ::StringW message);

  /// @brief Method Create, addr 0x5cdc61c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cdc5d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5cdc5dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5cdc5d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5cdc5d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x5cdc5e0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::StringW path, int32_t lineNumber, int32_t linePosition, ::System::Exception* innerException);

  /// @brief Method get_LineNumber, addr 0x5cdc5b8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x5cdc5c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_Path, addr 0x5cdc5c8, size 0x8, virtual false, abstract: false, final false
