...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::DateTimeZoneHandling, "Newtonsoft.Json", "DateTimeZoneHandling");
// Dependencies
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::DateTimeZoneHandling) == 0x4, "Size mismatch!");
