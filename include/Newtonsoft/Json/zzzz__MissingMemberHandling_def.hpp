...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::MissingMemberHandling, "Newtonsoft.Json", "MissingMemberHandling");
// Dependencies
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::MissingMemberHandling) == 0x4, "Size mismatch!");
