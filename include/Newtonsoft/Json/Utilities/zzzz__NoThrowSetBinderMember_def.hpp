...
public:
  ...
  /// @brief Method FallbackSetMember, addr 0x3ec4c20, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ec4be8, size 0x38, virtual false, abstract: false, final false
