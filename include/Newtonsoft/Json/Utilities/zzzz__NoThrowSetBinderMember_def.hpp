...
public:
  ...
  /// @brief Method FallbackSetMember, addr 0x5b77c00, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b77bc8, size 0x38, virtual false, abstract: false, final false
