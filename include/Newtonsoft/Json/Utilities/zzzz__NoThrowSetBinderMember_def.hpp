...
public:
  ...
  /// @brief Method FallbackSetMember, addr 0x5bea0f4, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bea0bc, size 0x38, virtual false, abstract: false, final false
