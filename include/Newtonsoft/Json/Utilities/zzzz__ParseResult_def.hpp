...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::ParseResult, "Newtonsoft.Json.Utilities", "ParseResult");
// Dependencies
namespace Newtonsoft::Json::Utilities {
// Is value type: true
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::ParseResult) == 0x4, "Size mismatch!");
