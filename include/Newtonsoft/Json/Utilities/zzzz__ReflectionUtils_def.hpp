...
public:
  ...
  /// @brief Method <GetChildPrivateFields>b__41_0, addr 0x5b1e2dc, size 0x38, virtual false, abstract: false, final false
  inline bool _GetChildPrivateFields_b__41_0(::System::Reflection::FieldInfo* f);

  /// @brief Method <GetDefaultConstructor>b__11_0, addr 0x5b1e22c, size 0x70, virtual false, abstract: false, final false
  inline bool _GetDefaultConstructor_b__11_0(::System::Reflection::ConstructorInfo* c);

  /// @brief Method <GetFieldsAndProperties>b__31_0, addr 0x5b1e29c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _GetFieldsAndProperties_b__31_0(::System::Reflection::MemberInfo* m);

  /// @brief Method <GetMemberInfoFromType>b__39_0, addr 0x5b1e2bc, size 0x20, virtual false, abstract: false, final false
  inline ::System::Type* _GetMemberInfoFromType_b__39_0(::System::Reflection::ParameterInfo* p);

  /// @brief Method .ctor, addr 0x5b1e228, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetFieldsAndProperties>b__1, addr 0x5b1e318, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1e314, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetChildPrivateProperties>b__0, addr 0x5b1e390, size 0x50, virtual false, abstract: false, final false
  inline bool _GetChildPrivateProperties_b__0(::System::Reflection::PropertyInfo* p);

  /// @brief Method <GetChildPrivateProperties>b__1, addr 0x5b1e3e0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1e38c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetChildPrivateProperties>b__2, addr 0x5b1e49c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1e498, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <IsMethodOverridden>b__0, addr 0x5b1e5c0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1e5bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanReadMemberValue, addr 0x5b19e28, size 0x160, virtual false, abstract: false, final false
  static inline bool CanReadMemberValue(::System::Reflection::MemberInfo* member, bool nonPublic);

  /// @brief Method CanSetMemberValue, addr 0x5b19f88, size 0x19c, virtual false, abstract: false, final false
  static inline bool CanSetMemberValue(::System::Reflection::MemberInfo* member, bool nonPublic, bool canSetReadOnly);

  /// @brief Method EnsureNotByRefType, addr 0x5b1ad0c, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Type* EnsureNotByRefType(::System::Type* t);

  /// @brief Method EnsureNotNullableType, addr 0x5b1ac94, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Type* EnsureNotNullableType(::System::Type* t);

  /// @brief Method GetAssemblyDelimiterIndex, addr 0x5b1d448, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributes, addr 0x5b1b858, size 0x4e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBaseDefinition, addr 0x5b1a640, size 0xac, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodInfo* GetBaseDefinition(::System::Reflection::PropertyInfo* propertyInfo);

  /// @brief Method GetChildPrivateFields, addr 0x5b1d76c, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildPrivateProperties, addr 0x5b1d958, size 0x524, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCollectionItemType, addr 0x5b1b2e4, size 0x238, virtual false, abstract: false, final false
  static inline ::System::Type* GetCollectionItemType(::System::Type* type);

  /// @brief Method GetDefaultConstructor, addr 0x5b1ac38, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Reflection::ConstructorInfo* GetDefaultConstructor(::System::Type* t);

  /// @brief Method GetDefaultConstructor, addr 0x5b1aafc, size 0x13c, virtual false, abstract: false, final false
  static inline ::System::Reflection::ConstructorInfo* GetDefaultConstructor(::System::Type* t, bool nonPublic);

  /// @brief Method GetDefaultValue, addr 0x5b1df7c, size 0x258, virtual false, abstract: false, final false
  static inline ::System::Object* GetDefaultValue(::System::Type* type);

  /// @brief Method GetDictionaryKeyValueTypes, addr 0x5b1b51c, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFields, addr 0x5b1cd60, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldsAndProperties, addr 0x5b1c308, size 0xa58, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFullyQualifiedTypeName, addr 0x5b1a858, size 0x158, virtual false, abstract: false, final false
  static inline ::StringW GetFullyQualifiedTypeName(::System::Type* t, ::Newtonsoft::Json::Serialization::ISerializationBinder* binder);

  /// @brief Method GetMemberInfoFromType, addr 0x5b1d4ec, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMemberUnderlyingType, addr 0x5b1a12c, size 0x240, virtual false, abstract: false, final false
  static inline ::System::Type* GetMemberUnderlyingType(::System::Reflection::MemberInfo* member);

  /// @brief Method GetMemberValue, addr 0x5b1bdb8, size 0x330, virtual false, abstract: false, final false
  static inline ::System::Object* GetMemberValue(::System::Reflection::MemberInfo* member, ::System::Object* target);

  /// @brief Method GetObjectType, addr 0x5b0a248, size 0x14, virtual false, abstract: false, final false
  static inline ::System::Type* GetObjectType(::System::Object* v);

  /// @brief Method GetProperties, addr 0x5b1ce88, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeName, addr 0x5b1a77c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasDefaultConstructor, addr 0x5b19d20, size 0x104, virtual false, abstract: false, final false
  static inline bool HasDefaultConstructor(::System::Type* t, bool nonPublic);

  /// @brief Method ImplementsGenericDefinition, addr 0x5b073d4, size 0x74, virtual false, abstract: false, final false
  static inline bool ImplementsGenericDefinition(::System::Type* type, ::System::Type* genericInterfaceDefinition);

  /// @brief Method ImplementsGenericDefinition, addr 0x5b1ade4, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method InheritsGenericDefinition, addr 0x5b1b044, size 0x74, virtual false, abstract: false, final false
  static inline bool InheritsGenericDefinition(::System::Type* type, ::System::Type* genericClassDefinition);

  /// @brief Method InheritsGenericDefinition, addr 0x5b1b0b8, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method InheritsGenericDefinitionInternal, addr 0x5b1b21c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsByRefLikeType, addr 0x5b1b740, size 0x118, virtual false, abstract: false, final false
  static inline bool IsByRefLikeType(::System::Type* type);

  /// @brief Method IsGenericDefinition, addr 0x5b1ad6c, size 0x78, virtual false, abstract: false, final false
  static inline bool IsGenericDefinition(::System::Type* type, ::System::Type* genericInterfaceDefinition);

  /// @brief Method IsIndexedProperty, addr 0x5b1bd38, size 0x80, virtual false, abstract: false, final false
  static inline bool IsIndexedProperty(::System::Reflection::PropertyInfo* property);

  /// @brief Method IsMethodOverridden, addr 0x5b1de7c, size 0x100, virtual false, abstract: false, final false
  static inline bool IsMethodOverridden(::System::Type* currentType, ::System::Type* methodDeclaringType, ::StringW method);

  /// @brief Method IsNullable, addr 0x5b09e2c, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsNullable(::System::Type* t);

  /// @brief Method IsNullableType, addr 0x5b08464, size 0xdc, virtual false, abstract: false, final false
  static inline bool IsNullableType(::System::Type* t);

  /// @brief Method IsOverridenGenericMember, addr 0x5b1d19c, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPublic, addr 0x5b1a6ec, size 0x90, virtual false, abstract: false, final false
  static inline bool IsPublic(::System::Reflection::PropertyInfo* property);

  /// @brief Method IsVirtual, addr 0x5b1a578, size 0xc8, virtual false, abstract: false, final false
  static inline bool IsVirtual(::System::Reflection::PropertyInfo* propertyInfo);

  /// @brief Method RemoveAssemblyDetails, addr 0x5b1a9b0, size 0x14c, virtual false, abstract: false, final false
  static inline ::StringW RemoveAssemblyDetails(::StringW fullyQualifiedTypeName);

  /// @brief Method RemoveFlag, addr 0x5b1d948, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMemberValue, addr 0x5b1c0e8, size 0x220, virtual false, abstract: false, final false
  static inline void SetMemberValue(::System::Reflection::MemberInfo* member, ::System::Object* target, ::System::Object* value);

  /// @brief Method SplitFullyQualifiedTypeName, addr 0x5b1d358, size 0xf0, virtual false, abstract: false, final false
