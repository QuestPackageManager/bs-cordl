...
public:
  ...
  /// @brief Method <GetChildPrivateFields>b__39_0, addr 0x275c07c, size 0x18, virtual false, abstract: false, final false
  inline bool _GetChildPrivateFields_b__39_0(::System::Reflection::FieldInfo* f);

  /// @brief Method <GetDefaultConstructor>b__10_0, addr 0x275bfd0, size 0x6c, virtual false, abstract: false, final false
  inline bool _GetDefaultConstructor_b__10_0(::System::Reflection::ConstructorInfo* c);

  /// @brief Method <GetFieldsAndProperties>b__29_0, addr 0x275c03c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _GetFieldsAndProperties_b__29_0(::System::Reflection::MemberInfo* m);

  /// @brief Method <GetMemberInfoFromType>b__37_0, addr 0x275c05c, size 0x20, virtual false, abstract: false, final false
  inline ::System::Type* _GetMemberInfoFromType_b__37_0(::System::Reflection::ParameterInfo* p);

  /// @brief Method .ctor, addr 0x275bfc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetChildPrivateProperties>b__0, addr 0x275c094, size 0x54, virtual false, abstract: false, final false
  inline bool _GetChildPrivateProperties_b__0(::System::Reflection::PropertyInfo* p);

  /// @brief Method <GetChildPrivateProperties>b__1, addr 0x275c0e8, size 0xa0, virtual false, abstract: false, final false
  inline bool _GetChildPrivateProperties_b__1(::System::Reflection::PropertyInfo* p);

  /// @brief Method <GetChildPrivateProperties>b__2, addr 0x275c188, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x275bc30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <IsMethodOverridden>b__0, addr 0x275c2bc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x275bd34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanReadMemberValue, addr 0x274dcd8, size 0x144, virtual false, abstract: false, final false
  static inline bool CanReadMemberValue(::System::Reflection::MemberInfo* member, bool nonPublic);

  /// @brief Method CanSetMemberValue, addr 0x274de1c, size 0x17c, virtual false, abstract: false, final false
  static inline bool CanSetMemberValue(::System::Reflection::MemberInfo* member, bool nonPublic, bool canSetReadOnly);

  /// @brief Method EnsureNotNullableType, addr 0x2758be4, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Type* EnsureNotNullableType(::System::Type* t);

  /// @brief Method GetAssemblyDelimiterIndex, addr 0x275b264, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributes, addr 0x275ac80, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBaseDefinition, addr 0x2758724, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodInfo* GetBaseDefinition(::System::Reflection::PropertyInfo* propertyInfo);

  /// @brief Method GetChildPrivateFields, addr 0x275b5a4, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildPrivateProperties, addr 0x275b79c, size 0x494, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCollectionItemType, addr 0x27591b0, size 0x228, virtual false, abstract: false, final false
  static inline ::System::Type* GetCollectionItemType(::System::Type* type);

  /// @brief Method GetDefaultConstructor, addr 0x2758b6c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Reflection::ConstructorInfo* GetDefaultConstructor(::System::Type* t);

  /// @brief Method GetDefaultConstructor, addr 0x2758a3c, size 0x130, virtual false, abstract: false, final false
  static inline ::System::Reflection::ConstructorInfo* GetDefaultConstructor(::System::Type* t, bool nonPublic);

  /// @brief Method GetDefaultValue, addr 0x275bd3c, size 0x228, virtual false, abstract: false, final false
  static inline ::System::Object* GetDefaultValue(::System::Type* type);

  /// @brief Method GetDictionaryKeyValueTypes, addr 0x27593d8, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFields, addr 0x275a70c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldsAndProperties, addr 0x2759c84, size 0xa88, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMemberInfoFromType, addr 0x275b33c, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMemberUnderlyingType, addr 0x274dfa8, size 0x224, virtual false, abstract: false, final false
  static inline ::System::Type* GetMemberUnderlyingType(::System::Reflection::MemberInfo* member);

  /// @brief Method GetMemberValue, addr 0x2759748, size 0x328, virtual false, abstract: false, final false
  static inline ::System::Object* GetMemberValue(::System::Reflection::MemberInfo* member, ::System::Object* target);

  /// @brief Method GetObjectType, addr 0x274feec, size 0x10, virtual false, abstract: false, final false
  static inline ::System::Type* GetObjectType(::System::Object* v);

  /// @brief Method GetProperties, addr 0x275a828, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeName, addr 0x2758828, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method HasDefaultConstructor, addr 0x274dc04, size 0xb0, virtual false, abstract: false, final false
  static inline bool HasDefaultConstructor(::System::Type* t, bool nonPublic);

  /// @brief Method ImplementsGenericDefinition, addr 0x2756e70, size 0x74, virtual false, abstract: false, final false
  static inline bool ImplementsGenericDefinition(::System::Type* type, ::System::Type* genericInterfaceDefinition);

  /// @brief Method ImplementsGenericDefinition, addr 0x2758cb4, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method InheritsGenericDefinition, addr 0x2758ec4, size 0x74, virtual false, abstract: false, final false
  static inline bool InheritsGenericDefinition(::System::Type* type, ::System::Type* genericClassDefinition);

  /// @brief Method InheritsGenericDefinition, addr 0x2758f38, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method InheritsGenericDefinitionInternal, addr 0x27590a8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsGenericDefinition, addr 0x2758c58, size 0x5c, virtual false, abstract: false, final false
  static inline bool IsGenericDefinition(::System::Type* type, ::System::Type* genericInterfaceDefinition);

  /// @brief Method IsIndexedProperty, addr 0x2759604, size 0xcc, virtual false, abstract: false, final false
  static inline bool IsIndexedProperty(::System::Reflection::MemberInfo* member);

  /// @brief Method IsIndexedProperty, addr 0x27596d0, size 0x78, virtual false, abstract: false, final false
  static inline bool IsIndexedProperty(::System::Reflection::PropertyInfo* property);

  /// @brief Method IsMethodOverridden, addr 0x275bc38, size 0xfc, virtual false, abstract: false, final false
  static inline bool IsMethodOverridden(::System::Type* currentType, ::System::Type* methodDeclaringType, ::StringW method);

  /// @brief Method IsNullable, addr 0x274faac, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsNullable(::System::Type* t);

  /// @brief Method IsNullableType, addr 0x274e840, size 0xe0, virtual false, abstract: false, final false
  static inline bool IsNullableType(::System::Type* t);

  /// @brief Method IsOverridenGenericMember, addr 0x275aae4, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPublic, addr 0x27587b0, size 0x78, virtual false, abstract: false, final false
  static inline bool IsPublic(::System::Reflection::PropertyInfo* property);

  /// @brief Method IsVirtual, addr 0x275868c, size 0x98, virtual false, abstract: false, final false
  static inline bool IsVirtual(::System::Reflection::PropertyInfo* propertyInfo);

  /// @brief Method RemoveAssemblyDetails, addr 0x27588f8, size 0x130, virtual false, abstract: false, final false
  static inline ::StringW RemoveAssemblyDetails(::StringW fullyQualifiedTypeName);

  /// @brief Method RemoveFlag, addr 0x275b78c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMemberValue, addr 0x2759a70, size 0x214, virtual false, abstract: false, final false
  static inline void SetMemberValue(::System::Reflection::MemberInfo* member, ::System::Object* target, ::System::Object* value);

  /// @brief Method SplitFullyQualifiedTypeName, addr 0x275b174, size 0xf0, virtual false, abstract: false, final false
