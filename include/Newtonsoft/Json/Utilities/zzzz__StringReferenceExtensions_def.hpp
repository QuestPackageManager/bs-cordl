...
public:
// Declarations
/// @brief Method EndsWith, addr 0x5bf9574, size 0xa4, virtual false, abstract: false, final false
static inline bool EndsWith(::Newtonsoft::Json::Utilities::StringReference  s, ::StringW  text) ;

/// @brief Method IndexOf, addr 0x5bf944c, size 0x88, virtual false, abstract: false, final false
static inline int32_t IndexOf(::Newtonsoft::Json::Utilities::StringReference  s, char16_t  c, int32_t  startIndex, int32_t  length) ;

/// @brief Method StartsWith, addr 0x5bf94d4, size 0xa0, virtual false, abstract: false, final false
