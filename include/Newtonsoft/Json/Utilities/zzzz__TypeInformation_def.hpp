...
public:
  ...
  /// @brief Method .ctor, addr 0x5be1144, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::Newtonsoft::Json::Utilities::PrimitiveTypeCode typeCode);

  /// @brief Method get_Type, addr 0x5be1134, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_Type();

  /// @brief Method get_TypeCode, addr 0x5be113c, size 0x8, virtual false, abstract: false, final false
