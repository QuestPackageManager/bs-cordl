...
public:
  ...
  inline ::System::IAsyncResult* BeginInvoke(/* [Nullable(1)] */ T target, /* [Nullable(new[] { 1, 2 })] */ ::ArrayW<::System::Object*> args, ::System::AsyncCallback* callback,
  ...
  inline TResult Invoke(T target, /* [ParamArray] [Nullable(new[] { 1, 2 })] */ ::ArrayW<::System::Object*> args);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodCall_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodCall_2(MethodCall_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodCall_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodCall_2(MethodCall_2const&) = delete;
