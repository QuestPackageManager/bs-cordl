...
public:
  ...
  /// @brief Method FallbackGetMember, addr 0x3ecdfdc, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ecdfa4, size 0x38, virtual false, abstract: false, final false
