...
public:
  ...
  /// @brief Method FallbackGetMember, addr 0x3ec9a0c, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ec99d4, size 0x38, virtual false, abstract: false, final false
