...
public:
  ...
  /// @brief Method FallbackGetMember, addr 0x5b10f98, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b10f60, size 0x38, virtual false, abstract: false, final false
