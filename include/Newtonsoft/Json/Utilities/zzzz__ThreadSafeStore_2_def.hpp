...
/// @brief Field _concurrentStore, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__concurrentStore, put=__cordl_internal_set__concurrentStore)) ::System::Collections::Concurrent::ConcurrentDictionary_2<TKey,TValue>*  _concurrentStore;
