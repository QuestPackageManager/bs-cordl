...
public:
  ...
  /// @brief Method .ctor, addr 0x5bed97c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW contractTypeName, ::StringW createdTypeName, ::StringW builderTypeName);

  /// @brief Method get_BuilderTypeName, addr 0x5bed9a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_BuilderTypeName();

  /// @brief Method get_ContractTypeName, addr 0x5bed988, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ContractTypeName();

  /// @brief Method get_CreatedTypeName, addr 0x5bed998, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CreatedTypeName();

  /// @brief Method set_BuilderTypeName, addr 0x5bed9b0, size 0x8, virtual false, abstract: false, final false
  inline void set_BuilderTypeName(::StringW value);

  /// @brief Method set_ContractTypeName, addr 0x5bed990, size 0x8, virtual false, abstract: false, final false
  inline void set_ContractTypeName(::StringW value);

  /// @brief Method set_CreatedTypeName, addr 0x5bed9a0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <TryBuildImmutableForArrayContract>b__24_1, addr 0x5beda10, size 0x94, virtual false, abstract: false, final false
  inline bool _TryBuildImmutableForArrayContract_b__24_1(::System::Reflection::MethodInfo* m);

  /// @brief Method <TryBuildImmutableForDictionaryContract>b__25_1, addr 0x5bedaa4, size 0x144, virtual false, abstract: false, final false
  inline bool _TryBuildImmutableForDictionaryContract_b__25_1(::System::Reflection::MethodInfo* m);

  /// @brief Method .ctor, addr 0x5beda0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <TryBuildImmutableForArrayContract>b__0, addr 0x5bedbe8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5becc50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <TryBuildImmutableForDictionaryContract>b__0, addr 0x5bedc04, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bed0f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method TryBuildImmutableForArrayContract, addr 0x5bec804, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryBuildImmutableForDictionaryContract, addr 0x5becc54, size 0x4a0, virtual false, abstract: false, final false
