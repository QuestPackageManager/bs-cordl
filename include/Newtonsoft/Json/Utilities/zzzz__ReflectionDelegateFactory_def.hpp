...
public:
  ...
  /// @brief Method .ctor, addr 0x5d2d5bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::ReflectionDelegateFactory) == 0x10, "Size mismatch!");
