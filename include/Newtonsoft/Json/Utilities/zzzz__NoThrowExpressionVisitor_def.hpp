...
/// @brief Method VisitConditional, addr 0x5b78250, size 0x104, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* VisitConditional(::System::Linq::Expressions::ConditionalExpression*  node) ;

/// @brief Method .ctor, addr 0x5b780d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
