...
public:
  ...
  /// @brief Method <FromCanceled>b__5_0, addr 0x3ec2abc, size 0x4, virtual false, abstract: false, final false
  inline void _FromCanceled_b__5_0();

  /// @brief Method .ctor, addr 0x3ec2ab4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CancelIfRequestedAsync, addr 0x3ec2484, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method FromCanceled, addr 0x3ec251c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method IsCompletedSuccessfully, addr 0x3ec2978, size 0x24, virtual false, abstract: false, final false
  static inline bool IsCompletedSuccessfully(::System::Threading::Tasks::Task* task);

  /// @brief Method ReadAsync, addr 0x3ec2884, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsync, addr 0x3ec241c, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task_1<bool>* ToAsync(bool value);

  /// @brief Method WriteAsync, addr 0x3ec27a8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteAsync, addr 0x3ec26e4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteAsync, addr 0x3ec2620, size 0xc4, virtual false, abstract: false, final false
