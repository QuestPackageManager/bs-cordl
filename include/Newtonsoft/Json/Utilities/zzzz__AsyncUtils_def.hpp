...
/// @brief Method <FromCanceled>b__5_0, addr 0x5be0638, size 0x4, virtual false, abstract: false, final false
inline void _FromCanceled_b__5_0() ;

/// @brief Method .ctor, addr 0x5be0634, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CancelIfRequestedAsync, addr 0x5bdff68, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method FromCanceled, addr 0x5be0014, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method IsCompletedSuccessfully, addr 0x5be04f4, size 0x24, virtual false, abstract: false, final false
static inline bool IsCompletedSuccessfully(::System::Threading::Tasks::Task*  task) ;

/// @brief Method ReadAsync, addr 0x5be03e4, size 0x110, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::System::IO::TextReader*  reader, ::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method ToAsync, addr 0x5bdfeec, size 0x7c, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<bool>* ToAsync(bool  value) ;

/// @brief Method WriteAsync, addr 0x5be02f0, size 0xf4, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* WriteAsync(::System::IO::TextWriter*  writer, ::ArrayW<char16_t,::Array<char16_t>*>  value, int32_t  start, int32_t  count, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method WriteAsync, addr 0x5be0218, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method WriteAsync, addr 0x5be0140, size 0xd8, virtual false, abstract: false, final false
