...
public:
// Declarations
/// @brief Method IsEndToken, addr 0x5b6ba60, size 0x10, virtual false, abstract: false, final false
static inline bool IsEndToken(::Newtonsoft::Json::JsonToken  token) ;

/// @brief Method IsPrimitiveToken, addr 0x5b7f444, size 0x18, virtual false, abstract: false, final false
static inline bool IsPrimitiveToken(::Newtonsoft::Json::JsonToken  token) ;

/// @brief Method IsStartToken, addr 0x5b7f434, size 0x10, virtual false, abstract: false, final false
