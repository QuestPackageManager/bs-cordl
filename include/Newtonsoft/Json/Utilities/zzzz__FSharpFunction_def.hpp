...
public:
  ...
  /// @brief Method Invoke, addr 0x5beba64, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5beba5c, size 0x8, virtual false, abstract: false, final false
