...
public:
  ...
  /// @brief Method Invoke, addr 0x2a2f78c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a2f760, size 0x2c, virtual false, abstract: false, final false
