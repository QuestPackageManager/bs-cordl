...
public:
  ...
  /// @brief Method Invoke, addr 0x3ecb644, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ecb618, size 0x2c, virtual false, abstract: false, final false
