...
public:
  ...
  /// @brief Method Invoke, addr 0x3ed8b18, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ed8aec, size 0x2c, virtual false, abstract: false, final false
