...
public:
  ...
  /// @brief Method Invoke, addr 0x3e69cac, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e69c80, size 0x2c, virtual false, abstract: false, final false
