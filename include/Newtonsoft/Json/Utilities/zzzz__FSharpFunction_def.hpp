...
public:
  ...
  /// @brief Method Invoke, addr 0x3ec66d0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ec66a4, size 0x2c, virtual false, abstract: false, final false
