...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Utilities::FSharpFunction*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::FSharpFunction*, "Newtonsoft.Json.Utilities", "FSharpFunction");
// [NullableContext(2)]
// [Nullable(0)]
...
public:
  ...
  static inline ::Newtonsoft::Json::Utilities::FSharpFunction* New_ctor(::System::Object* instance,
                                                                        /* [Nullable(new[] { 1, 2, 1 })] */ ::Newtonsoft::Json::Utilities::MethodCall_2<::System::Object*, ::System::Object*>* invoker);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FSharpFunction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FSharpFunction(FSharpFunction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FSharpFunction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FSharpFunction(FSharpFunctionconst&) = delete;
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::FSharpFunction) == 0x20, "Size mismatch!");
