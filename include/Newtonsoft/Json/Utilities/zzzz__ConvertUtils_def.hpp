...
public:
  ...
  /// @brief Method <CreateCastConverter>b__0, addr 0x5be50a0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5be1980, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Convert, addr 0x5be20d4, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertOrCast, addr 0x5be30b8, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCastConverter, addr 0x5be1720, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method DecimalTryParse, addr 0x5be3538, size 0x7dc, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureTypeAssignable, addr 0x5be2eb0, size 0x208, virtual false, abstract: false, final false
  static inline ::System::Object* EnsureTypeAssignable(::System::Object* value, ::System::Type* initialType, ::System::Type* targetType);

  /// @brief Method FromBigInteger, addr 0x5be1c58, size 0x47c, virtual false, abstract: false, final false
  static inline ::System::Object* FromBigInteger(::System::Numerics::BigInteger i, ::System::Type* targetType);

  /// @brief Method GetTypeCode, addr 0x5be1150, size 0x68, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Utilities::PrimitiveTypeCode GetTypeCode(::System::Type* t);

  /// @brief Method GetTypeCode, addr 0x5be11b8, size 0x280, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Utilities::PrimitiveTypeCode GetTypeCode(::System::Type* t, ::ByRef<bool> isEnum);

  /// @brief Method GetTypeInformation, addr 0x5be1514, size 0xf4, virtual false, abstract: false, final false
  static inline ::Newtonsoft::Json::Utilities::TypeInformation* GetTypeInformation(::System::IConvertible* convertable);

  /// @brief Method Int32TryParse, addr 0x5be3230, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method Int64TryParse, addr 0x5be33c8, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method IsConvertible, addr 0x5be1608, size 0x80, virtual false, abstract: false, final false
  static inline bool IsConvertible(::System::Type* t);

  /// @brief Method IsInteger, addr 0x5be2d68, size 0x90, virtual false, abstract: false, final false
  static inline bool IsInteger(::System::Object* value);

  /// @brief Method ParseTimeSpan, addr 0x5be1688, size 0x98, virtual false, abstract: false, final false
  static inline ::System::TimeSpan ParseTimeSpan(::StringW input);

  /// @brief Method ToBigInteger, addr 0x5be1984, size 0x2d4, virtual false, abstract: false, final false
  static inline ::System::Numerics::BigInteger ToBigInteger(::System::Object* value);

  /// @brief Method TryConvert, addr 0x5be2c60, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertGuid, addr 0x5be3d14, size 0x60, virtual false, abstract: false, final false
  static inline bool TryConvertGuid(::StringW s, ::ByRef<::System::Guid> g);

  /// @brief Method TryConvertInternal, addr 0x5be22f0, size 0x970, virtual false, abstract: false, final false
  ...
  /// @brief Method TryHexTextToInt, addr 0x5be3d74, size 0xd0, virtual false, abstract: false, final false
  static inline bool TryHexTextToInt(::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t start, int32_t end, ::ByRef<int32_t> value);

  /// @brief Method VersionTryParse, addr 0x5be2df8, size 0x8, virtual false, abstract: false, final false
