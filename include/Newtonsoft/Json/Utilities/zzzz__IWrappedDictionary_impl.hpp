...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Object* (::Newtonsoft::Json::Utilities::IWrappedDictionary::*)()>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Newtonsoft::Json::Utilities::IWrappedDictionary*>(), { ::i2c::class_of<::Newtonsoft::Json::Utilities::IWrappedDictionary*>(), 0 }));
    return ___internal_method;
  }
};
inline ::System::Object* Newtonsoft::Json::Utilities::IWrappedDictionary::get_UnderlyingDictionary() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Newtonsoft::Json::Utilities::IWrappedDictionary*>(), 0 })));
