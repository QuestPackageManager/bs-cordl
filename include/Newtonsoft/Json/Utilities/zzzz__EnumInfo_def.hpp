...
static inline ::Newtonsoft::Json::Utilities::EnumInfo* New_ctor(bool  isFlags, ::ArrayW<uint64_t,::Array<uint64_t>*>  values, ::ArrayW<::StringW,::Array<::StringW>*>  names, ::ArrayW<::StringW,::Array<::StringW>*>  resolvedNames) ;
...
/// @brief Method .ctor, addr 0x5bebf20, size 0x10, virtual false, abstract: false, final false
