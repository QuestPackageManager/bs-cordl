...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnumInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnumInfo(EnumInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnumInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnumInfo(EnumInfoconst&) = delete;
