...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Creator_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Creator_1(Creator_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Creator_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Creator_1(Creator_1const&) = delete;
