...
template <typename T, typename TResult>
inline ::System::IAsyncResult* Newtonsoft::Json::Utilities::MethodCall_2<T, TResult>::BeginInvoke(/* [Nullable(1)] */ T target, /* [Nullable(new[] { 1, 2 })] */ ::ArrayW<::System::Object*> args,
