...
public:
  // Declarations
  /// @brief Method EnsureBufferSize, addr 0x5beddbc, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method RentBuffer, addr 0x5bedc20, size 0xdc, virtual false, abstract: false, final false
  static inline ::ArrayW<char16_t, ::Array<char16_t>*> RentBuffer(::Newtonsoft::Json::IArrayPool_1<char16_t>* bufferPool, int32_t minSize);

  /// @brief Method ReturnBuffer, addr 0x5bedcfc, size 0xc0, virtual false, abstract: false, final false
