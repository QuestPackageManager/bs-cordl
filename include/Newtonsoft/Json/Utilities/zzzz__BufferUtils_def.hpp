...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BufferUtils", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BufferUtils(BufferUtils&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BufferUtils", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BufferUtils(BufferUtilsconst&) = delete;
