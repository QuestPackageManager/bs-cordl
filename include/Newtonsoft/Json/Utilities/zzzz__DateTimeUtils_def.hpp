...
public:
  ...
  /// @brief Method ConvertDateTimeToJavaScriptTicks, addr 0x5d20478, size 0x5c, virtual false, abstract: false, final false
  static inline int64_t ConvertDateTimeToJavaScriptTicks(::System::DateTime dateTime);

  /// @brief Method ConvertDateTimeToJavaScriptTicks, addr 0x5d204d4, size 0xc0, virtual false, abstract: false, final false
  static inline int64_t ConvertDateTimeToJavaScriptTicks(::System::DateTime dateTime, bool convertToUtc);

  /// @brief Method ConvertDateTimeToJavaScriptTicks, addr 0x5d2038c, size 0x6c, virtual false, abstract: false, final false
  static inline int64_t ConvertDateTimeToJavaScriptTicks(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method ConvertJavaScriptTicksToDateTime, addr 0x5d170cc, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::DateTime ConvertJavaScriptTicksToDateTime(int64_t javaScriptTicks);

  /// @brief Method CopyIntToCharArray, addr 0x5d22c4c, size 0x68, virtual false, abstract: false, final false
  static inline void CopyIntToCharArray(::ArrayW<char16_t> chars, int32_t start, int32_t value, int32_t digits);

  /// @brief Method CreateDateTime, addr 0x5d209c4, size 0xfc, virtual false, abstract: false, final false
  static inline ::System::DateTime CreateDateTime(::Newtonsoft::Json::Utilities::DateTimeParser dateTimeParser);

  /// @brief Method EnsureDateTime, addr 0x5d1fe58, size 0x15c, virtual false, abstract: false, final false
  static inline ::System::DateTime EnsureDateTime(::System::DateTime value, ::Newtonsoft::Json::DateTimeZoneHandling timeZone);

  /// @brief Method GetDateValues, addr 0x5d22a04, size 0x248, virtual false, abstract: false, final false
  static inline void GetDateValues(::System::DateTime td, ::by_ref<int32_t> year, ::by_ref<int32_t> month, ::by_ref<int32_t> day);

  /// @brief Method GetUtcOffset, addr 0x5d1fc60, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::TimeSpan GetUtcOffset(::System::DateTime d);

  /// @brief Method SwitchToLocalTime, addr 0x5d1ffb4, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::DateTime SwitchToLocalTime(::System::DateTime value);

  /// @brief Method SwitchToUtcTime, addr 0x5d2008c, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::DateTime SwitchToUtcTime(::System::DateTime value);

  /// @brief Method ToSerializationMode, addr 0x5d1fccc, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlDateTimeSerializationMode ToSerializationMode(::System::DateTimeKind kind);

  /// @brief Method ToUniversalTicks, addr 0x5d20164, size 0xcc, virtual false, abstract: false, final false
  static inline int64_t ToUniversalTicks(::System::DateTime dateTime);

  /// @brief Method ToUniversalTicks, addr 0x5d20230, size 0x15c, virtual false, abstract: false, final false
  static inline int64_t ToUniversalTicks(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method TryParseDateTime, addr 0x5d20d34, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTime, addr 0x5d211c4, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeExact, addr 0x5d210d8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeIso, addr 0x5d20594, size 0x430, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeMicrosoft, addr 0x5d20f68, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffset, addr 0x5d21460, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffset, addr 0x5d2188c, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffsetExact, addr 0x5d217dc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffsetIso, addr 0x5d20ac0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDateTimeOffsetMicrosoft, addr 0x5d2167c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseMicrosoftDate, addr 0x5d21b2c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method TryReadOffset, addr 0x5d21cb4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method UniversalTicksToJavaScriptTicks, addr 0x5d203f8, size 0x80, virtual false, abstract: false, final false
  static inline int64_t UniversalTicksToJavaScriptTicks(int64_t universalTicks);

  /// @brief Method WriteDateTimeOffset, addr 0x5d2231c, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDateTimeOffsetString, addr 0x5d22cb4, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDateTimeString, addr 0x5d21fd8, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDateTimeString, addr 0x5d21e48, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDefaultIsoDate, addr 0x5d22594, size 0x470, virtual false, abstract: false, final false
