...
public:
  ...
  /// @brief Method MoveNext, addr 0x3ebed34, size 0x3e8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3ebf11c, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Encode, addr 0x3ebe644, size 0x1a0, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method EncodeAsync, addr 0x3ebea80, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Flush, addr 0x3ebe9c8, size 0xb8, virtual false, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x3ebebfc, size 0x138, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method FulfillFromLeftover, addr 0x3ebe7e4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreLeftOverBytes, addr 0x3ebe8a4, size 0x124, virtual false, abstract: false, final false
  inline void StoreLeftOverBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, ::ByRef<int32_t> count);

  /// @brief Method ValidateEncode, addr 0x3ebe580, size 0xc4, virtual false, abstract: false, final false
  inline void ValidateEncode(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteChars, addr 0x3ebe880, size 0x24, virtual false, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method WriteCharsAsync, addr 0x3ebeb74, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ebe4f0, size 0x90, virtual false, abstract: false, final false
