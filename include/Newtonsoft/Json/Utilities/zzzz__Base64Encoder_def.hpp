...
public:
  ...
  /// @brief Method MoveNext, addr 0x3ebecbc, size 0x3e8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3ebf0a4, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Encode, addr 0x3ebe5cc, size 0x1a0, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method EncodeAsync, addr 0x3ebea08, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Flush, addr 0x3ebe950, size 0xb8, virtual false, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x3ebeb84, size 0x138, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method FulfillFromLeftover, addr 0x3ebe76c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreLeftOverBytes, addr 0x3ebe82c, size 0x124, virtual false, abstract: false, final false
  inline void StoreLeftOverBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, ::ByRef<int32_t> count);

  /// @brief Method ValidateEncode, addr 0x3ebe508, size 0xc4, virtual false, abstract: false, final false
  inline void ValidateEncode(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteChars, addr 0x3ebe808, size 0x24, virtual false, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method WriteCharsAsync, addr 0x3ebeafc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ebe478, size 0x90, virtual false, abstract: false, final false
