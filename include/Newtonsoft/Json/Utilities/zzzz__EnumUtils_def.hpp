...
public:
  ...
  /// @brief Method <InitializeValuesAndNames>b__3_0, addr 0x5beba48, size 0x14, virtual false, abstract: false, final false
  inline ::StringW _InitializeValuesAndNames_b__3_0(::System::Runtime::Serialization::EnumMemberAttribute* a);

  /// @brief Method .ctor, addr 0x5beba44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FindIndexByName, addr 0x5beb70c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumValuesAndNames, addr 0x5beaecc, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeValuesAndNames, addr 0x5bea3b8, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalFlagsFormat, addr 0x5bead20, size 0x1ac, virtual false, abstract: false, final false
  static inline ::StringW InternalFlagsFormat(::Newtonsoft::Json::Utilities::EnumInfo* entry, uint64_t result);

  /// @brief Method MatchName, addr 0x5beb7f4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseEnum, addr 0x5beaf6c, size 0x7a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToUInt64, addr 0x5bea894, size 0x280, virtual false, abstract: false, final false
  static inline uint64_t ToUInt64(::System::Object* value);

  /// @brief Method TryToString, addr 0x5beab14, size 0xa4, virtual false, abstract: false, final false
  static inline bool TryToString(::System::Type* enumType, ::System::Object* value, bool camelCase, ::ByRef<::StringW> name);

  /// @brief Method TryToString, addr 0x5beabb8, size 0x168, virtual false, abstract: false, final false
