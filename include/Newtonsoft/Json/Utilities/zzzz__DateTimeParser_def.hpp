...
public:
  ...
  /// @brief Method Parse, addr 0x5be5404, size 0xf4, virtual false, abstract: false, final false
  inline bool Parse(::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t startIndex, int32_t length);

  /// @brief Method Parse2Digit, addr 0x5be5870, size 0x98, virtual false, abstract: false, final false
  inline bool Parse2Digit(int32_t start, ::ByRef<int32_t> num);

  /// @brief Method Parse4Digit, addr 0x5be578c, size 0xe4, virtual false, abstract: false, final false
  inline bool Parse4Digit(int32_t start, ::ByRef<int32_t> num);

  /// @brief Method ParseChar, addr 0x5be56a0, size 0x4c, virtual false, abstract: false, final false
  inline bool ParseChar(int32_t start, char16_t ch);

  /// @brief Method ParseDate, addr 0x5be54f8, size 0x1a8, virtual false, abstract: false, final false
  inline bool ParseDate(int32_t start);

  /// @brief Method ParseTime, addr 0x5be5908, size 0x2c8, virtual false, abstract: false, final false
  inline bool ParseTime(::ByRef<int32_t> start);

  /// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x5be56ec, size 0xa0, virtual false, abstract: false, final false
  inline bool ParseTimeAndZoneAndWhitespace(int32_t start);

  /// @brief Method ParseZone, addr 0x5be5bd0, size 0x1fc, virtual false, abstract: false, final false
