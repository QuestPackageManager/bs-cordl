...
// None }, CppParam { name: "Fraction", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "ZoneHour", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "ZoneMinute", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Zone", ty: "::Newtonsoft::Json::Utilities::ParserTimeZone", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "_text", ty: "::ArrayW<char16_t>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_end", ty: "int32_t",
