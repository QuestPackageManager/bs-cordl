...
template <> CORDL_HIDDEN void* ExtractValue<nullptr_t>(nullptr_t&) noexcept {
  return nullptr;
}
template <> CORDL_HIDDEN void* ExtractValue<void*>(void*& arg) noexcept {
  return arg;
}

template <> CORDL_HIDDEN constexpr void* ExtractValue<Il2CppType*>(Il2CppType*&) noexcept {
  return nullptr;
}

template <> CORDL_HIDDEN constexpr void* ExtractValue<Il2CppClass*>(Il2CppClass*&) noexcept {
  return nullptr;
}

template <> CORDL_HIDDEN constexpr void* ExtractValue<Il2CppObject*>(Il2CppObject*& arg) noexcept {
  if (arg) {
...
template <typename T, typename... TArgs> CORDL_HIDDEN std::vector<void*> ExtractValues(T&& arg, TArgs&&... args) {
...
template <typename T> CORDL_HIDDEN void* ExtractTypeValue(T& arg) {
  return const_cast<void*>(static_cast<void const*>(&arg));
}
...
template <> CORDL_HIDDEN constexpr void* ExtractTypeValue<std::nullptr_t>(std::nullptr_t&) {
  return nullptr;
}
...
template <> CORDL_HIDDEN void* ExtractTypeValue<::bs_hook::Il2CppWrapperType>(::bs_hook::Il2CppWrapperType& arg) {
...
template <typename T> CORDL_HIDDEN Il2CppType const* ExtractType() {
  return ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T>::get().value_or(nullptr);
}

template <typename T> CORDL_HIDDEN Il2CppType const* ExtractType(T&& arg) {
  return ::il2cpp_utils::il2cpp_type_check::il2cpp_arg_type<T>::get(arg).value_or(nullptr);
}
...
template <typename T, typename... TArgs> CORDL_HIDDEN std::vector<Il2CppType const*> ExtractTypes(T&& arg, TArgs&&... args) {
