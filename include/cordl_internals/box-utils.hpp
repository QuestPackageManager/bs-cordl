...
template <typename T> CORDL_HIDDEN Il2CppObject* Box(T);

template <typename T> CORDL_HIDDEN Il2CppObject* Box(T*);

template <> CORDL_HIDDEN constexpr Il2CppObject* Box<Il2CppObject*>(Il2CppObject* t) {
  return t;
}
...
template <typename T> CORDL_HIDDEN T Unbox(Il2CppObject* t) {
  return *static_cast<T*>(il2cpp_functions::object_unbox(t));
}

template <::il2cpp_utils::il2cpp_reference_type_wrapper T> CORDL_HIDDEN T Unbox(Il2CppObject* t) {
  return T(t);
}

template <::il2cpp_utils::il2cpp_reference_type_pointer T> CORDL_HIDDEN T Unbox(Il2CppObject* t) {
