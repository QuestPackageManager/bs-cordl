...
// Ctor Parameters [CppParam { name: "mTrackingToComponentRenderModel", ty: "::OVR::OpenVR::HmdMatrix34_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "mTrackingToComponentLocal", ty: "::OVR::OpenVR::HmdMatrix34_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "uProperties", ty: "uint32_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
