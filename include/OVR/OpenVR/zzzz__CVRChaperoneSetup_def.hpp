...
public:
  ...
  /// @brief Method CommitWorkingCopy, addr 0x2aca380, size 0x24, virtual false, abstract: false, final false
  inline bool CommitWorkingCopy(::OVR::OpenVR::EChaperoneConfigFile configFile);

  /// @brief Method ExportLiveToBuffer, addr 0x2aca838, size 0x28, virtual false, abstract: false, final false
  inline bool ExportLiveToBuffer(::System::Text::StringBuilder* pBuffer, ByRef<uint32_t> pnBufferLength);

  /// @brief Method GetLiveCollisionBoundsInfo, addr 0x2aca4c0, size 0xa8, virtual false, abstract: false, final false
  inline bool GetLiveCollisionBoundsInfo(ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*>> pQuadsBuffer);

  /// @brief Method GetLiveCollisionBoundsTagsInfo, addr 0x2aca6bc, size 0xa8, virtual false, abstract: false, final false
  inline bool GetLiveCollisionBoundsTagsInfo(ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> pTagsBuffer);

  /// @brief Method GetLivePhysicalBoundsInfo, addr 0x2aca790, size 0xa8, virtual false, abstract: false, final false
  inline bool GetLivePhysicalBoundsInfo(ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*>> pQuadsBuffer);

  /// @brief Method GetLiveSeatedZeroPoseToRawTrackingPose, addr 0x2aca66c, size 0x24, virtual false, abstract: false, final false
  inline bool GetLiveSeatedZeroPoseToRawTrackingPose(ByRef<::OVR::OpenVR::HmdMatrix34_t> pmatSeatedZeroPoseToRawTrackingPose);

  /// @brief Method GetWorkingCollisionBoundsInfo, addr 0x2aca418, size 0xa8, virtual false, abstract: false, final false
  inline bool GetWorkingCollisionBoundsInfo(ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*>> pQuadsBuffer);

  /// @brief Method GetWorkingPlayAreaRect, addr 0x2aca3f4, size 0x24, virtual false, abstract: false, final false
  inline bool GetWorkingPlayAreaRect(ByRef<::OVR::OpenVR::HmdQuad_t> rect);

  /// @brief Method GetWorkingPlayAreaSize, addr 0x2aca3c8, size 0x2c, virtual false, abstract: false, final false
  inline bool GetWorkingPlayAreaSize(ByRef<float_t> pSizeX, ByRef<float_t> pSizeZ);

  /// @brief Method GetWorkingSeatedZeroPoseToRawTrackingPose, addr 0x2aca568, size 0x24, virtual false, abstract: false, final false
  inline bool GetWorkingSeatedZeroPoseToRawTrackingPose(ByRef<::OVR::OpenVR::HmdMatrix34_t> pmatSeatedZeroPoseToRawTrackingPose);

  /// @brief Method GetWorkingStandingZeroPoseToRawTrackingPose, addr 0x2aca58c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportFromBufferToWorking, addr 0x2aca860, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadFromDisk, addr 0x2aca648, size 0x24, virtual false, abstract: false, final false
  inline void ReloadFromDisk(::OVR::OpenVR::EChaperoneConfigFile configFile);

  /// @brief Method RevertWorkingCopy, addr 0x2aca3a4, size 0x24, virtual false, abstract: false, final false
  inline void RevertWorkingCopy();

  /// @brief Method SetWorkingCollisionBoundsInfo, addr 0x2aca5d4, size 0x2c, virtual false, abstract: false, final false
  inline void SetWorkingCollisionBoundsInfo(::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*> pQuadsBuffer);

  /// @brief Method SetWorkingCollisionBoundsTagsInfo, addr 0x2aca690, size 0x2c, virtual false, abstract: false, final false
  inline void SetWorkingCollisionBoundsTagsInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> pTagsBuffer);

  /// @brief Method SetWorkingPhysicalBoundsInfo, addr 0x2aca764, size 0x2c, virtual false, abstract: false, final false
  inline bool SetWorkingPhysicalBoundsInfo(::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*> pQuadsBuffer);

  /// @brief Method SetWorkingPlayAreaSize, addr 0x2aca5b0, size 0x24, virtual false, abstract: false, final false
  inline void SetWorkingPlayAreaSize(float_t sizeX, float_t sizeZ);

  /// @brief Method SetWorkingSeatedZeroPoseToRawTrackingPose, addr 0x2aca600, size 0x24, virtual false, abstract: false, final false
  inline void SetWorkingSeatedZeroPoseToRawTrackingPose(ByRef<::OVR::OpenVR::HmdMatrix34_t> pMatSeatedZeroPoseToRawTrackingPose);

  /// @brief Method SetWorkingStandingZeroPoseToRawTrackingPose, addr 0x2aca624, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2aca26c, size 0x114, virtual false, abstract: false, final false
