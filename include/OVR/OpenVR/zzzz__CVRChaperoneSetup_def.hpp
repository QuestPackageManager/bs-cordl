...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9112)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method .ctor addr 0x267bbc0 size 0x114 virtual false final false
  inline void _ctor(void* pInterface);

  /// @brief Method CommitWorkingCopy addr 0x267bcd4 size 0x24 virtual false final false
  inline bool CommitWorkingCopy(::OVR::OpenVR::EChaperoneConfigFile configFile);

  /// @brief Method RevertWorkingCopy addr 0x267bcf8 size 0x24 virtual false final false
  inline void RevertWorkingCopy();

  /// @brief Method GetWorkingPlayAreaSize addr 0x267bd1c size 0x2c virtual false final false
  inline bool GetWorkingPlayAreaSize(ByRef<float_t> pSizeX, ByRef<float_t> pSizeZ);

  /// @brief Method GetWorkingPlayAreaRect addr 0x267bd48 size 0x24 virtual false final false
  inline bool GetWorkingPlayAreaRect(ByRef<::OVR::OpenVR::HmdQuad_t> rect);

  /// @brief Method GetWorkingCollisionBoundsInfo addr 0x267bd6c size 0xa8 virtual false final false
  inline bool GetWorkingCollisionBoundsInfo(ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*>> pQuadsBuffer);

  /// @brief Method GetLiveCollisionBoundsInfo addr 0x267be14 size 0xa8 virtual false final false
  inline bool GetLiveCollisionBoundsInfo(ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*>> pQuadsBuffer);

  /// @brief Method GetWorkingSeatedZeroPoseToRawTrackingPose addr 0x267bebc size 0x24 virtual false final false
  inline bool GetWorkingSeatedZeroPoseToRawTrackingPose(ByRef<::OVR::OpenVR::HmdMatrix34_t> pmatSeatedZeroPoseToRawTrackingPose);

  /// @brief Method GetWorkingStandingZeroPoseToRawTrackingPose addr 0x267bee0 size 0x24 virtual false final false
  ...
  /// @brief Method SetWorkingPlayAreaSize addr 0x267bf04 size 0x24 virtual false final false
  inline void SetWorkingPlayAreaSize(float_t sizeX, float_t sizeZ);

  /// @brief Method SetWorkingCollisionBoundsInfo addr 0x267bf28 size 0x2c virtual false final false
  inline void SetWorkingCollisionBoundsInfo(::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*> pQuadsBuffer);

  /// @brief Method SetWorkingSeatedZeroPoseToRawTrackingPose addr 0x267bf54 size 0x24 virtual false final false
  inline void SetWorkingSeatedZeroPoseToRawTrackingPose(ByRef<::OVR::OpenVR::HmdMatrix34_t> pMatSeatedZeroPoseToRawTrackingPose);

  /// @brief Method SetWorkingStandingZeroPoseToRawTrackingPose addr 0x267bf78 size 0x24 virtual false final false
  ...
  /// @brief Method ReloadFromDisk addr 0x267bf9c size 0x24 virtual false final false
  inline void ReloadFromDisk(::OVR::OpenVR::EChaperoneConfigFile configFile);

  /// @brief Method GetLiveSeatedZeroPoseToRawTrackingPose addr 0x267bfc0 size 0x24 virtual false final false
  inline bool GetLiveSeatedZeroPoseToRawTrackingPose(ByRef<::OVR::OpenVR::HmdMatrix34_t> pmatSeatedZeroPoseToRawTrackingPose);

  /// @brief Method SetWorkingCollisionBoundsTagsInfo addr 0x267bfe4 size 0x2c virtual false final false
  inline void SetWorkingCollisionBoundsTagsInfo(::ArrayW<uint8_t, ::Array<uint8_t>*> pTagsBuffer);

  /// @brief Method GetLiveCollisionBoundsTagsInfo addr 0x267c010 size 0xa8 virtual false final false
  inline bool GetLiveCollisionBoundsTagsInfo(ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> pTagsBuffer);

  /// @brief Method SetWorkingPhysicalBoundsInfo addr 0x267c0b8 size 0x2c virtual false final false
  inline bool SetWorkingPhysicalBoundsInfo(::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*> pQuadsBuffer);

  /// @brief Method GetLivePhysicalBoundsInfo addr 0x267c0e4 size 0xa8 virtual false final false
  inline bool GetLivePhysicalBoundsInfo(ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t, ::Array<::OVR::OpenVR::HmdQuad_t>*>> pQuadsBuffer);

  /// @brief Method ExportLiveToBuffer addr 0x267c18c size 0x28 virtual false final false
  inline bool ExportLiveToBuffer(::System::Text::StringBuilder* pBuffer, ByRef<uint32_t> pnBufferLength);

  /// @brief Method ImportFromBufferToWorking addr 0x267c1b4 size 0x24 virtual false final false
