...
// Ctor Parameters [CppParam { name: "mDeviceToAbsoluteTracking", ty: "::OVR::OpenVR::HmdMatrix34_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vVelocity", ty:
// "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vAngularVelocity", ty: "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "eTrackingResult", ty: "::OVR::OpenVR::ETrackingResult", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "bPoseIsValid", ty: "bool",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "bDeviceIsConnected", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }]
