...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRControllerAxisType, "OVR.OpenVR", "EVRControllerAxisType");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRControllerAxisType) == 0x4, "Size mismatch!");
