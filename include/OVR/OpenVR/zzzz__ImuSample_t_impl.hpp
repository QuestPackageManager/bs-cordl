...
// Ctor Parameters [CppParam { name: "fSampleTime", ty: "double_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vAccel", ty: "::OVR::OpenVR::HmdVector3d_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "vGyro", ty: "::OVR::OpenVR::HmdVector3d_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "unOffScaleFlags", ty:
