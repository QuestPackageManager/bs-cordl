...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::ECollisionBoundsStyle, "OVR.OpenVR", "ECollisionBoundsStyle");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::ECollisionBoundsStyle) == 0x4, "Size mismatch!");
