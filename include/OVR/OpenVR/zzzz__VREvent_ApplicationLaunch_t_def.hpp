...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_ApplicationLaunch_t, "OVR.OpenVR", "VREvent_ApplicationLaunch_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
public:
  ...
  // Ctor Parameters [CppParam { name: "pid", ty: "uint32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "unArgsHandle", ty: "uint32_t", modifiers: "", def_value: None, comment:
  // None }]
...
static_assert(sizeof(::OVR::OpenVR::VREvent_ApplicationLaunch_t) == 0x8, "Size mismatch!");
