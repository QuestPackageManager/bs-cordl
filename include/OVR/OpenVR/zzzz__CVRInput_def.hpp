...
/// @brief Method DecompressSkeletalBoneData, addr 0x5d0d310, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method GetActionHandle, addr 0x5d0d1c0, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError GetActionHandle(::StringW  pchActionName, ::ByRef<uint64_t>  pHandle) ;

/// @brief Method GetActionOrigins, addr 0x5d0d35c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method GetActionSetHandle, addr 0x5d0d19c, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError GetActionSetHandle(::StringW  pchActionSetName, ::ByRef<uint64_t>  pHandle) ;

/// @brief Method GetAnalogActionData, addr 0x5d0d254, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetDigitalActionData, addr 0x5d0d234, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetInputSourceHandle, addr 0x5d0d1e4, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError GetInputSourceHandle(::StringW  pchInputSourcePath, ::ByRef<uint64_t>  pHandle) ;

/// @brief Method GetOriginLocalizedName, addr 0x5d0d388, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetOriginTrackedDeviceInfo, addr 0x5d0d3a8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetPoseActionData, addr 0x5d0d274, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetSkeletalActionData, addr 0x5d0d294, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetSkeletalBoneData, addr 0x5d0d2b4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetSkeletalBoneDataCompressed, addr 0x5d0d2e4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method SetActionManifestPath, addr 0x5d0d17c, size 0x20, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError SetActionManifestPath(::StringW  pchActionManifestPath) ;

/// @brief Method ShowActionOrigins, addr 0x5d0d3c8, size 0x20, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError ShowActionOrigins(uint64_t  actionSetHandle, uint64_t  ulActionHandle) ;

/// @brief Method ShowBindingsForActionSet, addr 0x5d0d3e8, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method TriggerHapticVibrationAction, addr 0x5d0d33c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method UpdateActionState, addr 0x5d0d208, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d0d07c, size 0x100, virtual false, abstract: false, final false
