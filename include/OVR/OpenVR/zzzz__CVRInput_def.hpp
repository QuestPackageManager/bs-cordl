...
public:
  ...
  /// @brief Method DecompressSkeletalBoneData, addr 0x4014d48, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActionHandle, addr 0x4014be0, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetActionHandle(::StringW pchActionName, ByRef<uint64_t> pHandle);

  /// @brief Method GetActionOrigins, addr 0x4014d98, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActionSetHandle, addr 0x4014bb8, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetActionSetHandle(::StringW pchActionSetName, ByRef<uint64_t> pHandle);

  /// @brief Method GetAnalogActionData, addr 0x4014c80, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDigitalActionData, addr 0x4014c5c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInputSourceHandle, addr 0x4014c08, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetInputSourceHandle(::StringW pchInputSourcePath, ByRef<uint64_t> pHandle);

  /// @brief Method GetOriginLocalizedName, addr 0x4014dc4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOriginTrackedDeviceInfo, addr 0x4014de8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoseActionData, addr 0x4014ca4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalActionData, addr 0x4014cc8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalBoneData, addr 0x4014cec, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalBoneDataCompressed, addr 0x4014d1c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActionManifestPath, addr 0x4014b94, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError SetActionManifestPath(::StringW pchActionManifestPath);

  /// @brief Method ShowActionOrigins, addr 0x4014e0c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError ShowActionOrigins(uint64_t actionSetHandle, uint64_t ulActionHandle);

  /// @brief Method ShowBindingsForActionSet, addr 0x4014e30, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method TriggerHapticVibrationAction, addr 0x4014d74, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateActionState, addr 0x4014c30, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4014a80, size 0x114, virtual false, abstract: false, final false
