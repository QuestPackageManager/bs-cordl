...
public:
  ...
  /// @brief Method .ctor, addr 0x27f5a70, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method SetActionManifestPath, addr 0x27f5b84, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError SetActionManifestPath(::StringW pchActionManifestPath);

  /// @brief Method GetActionSetHandle, addr 0x27f5ba8, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetActionSetHandle(::StringW pchActionSetName, ByRef<uint64_t> pHandle);

  /// @brief Method GetActionHandle, addr 0x27f5bd0, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetActionHandle(::StringW pchActionName, ByRef<uint64_t> pHandle);

  /// @brief Method GetInputSourceHandle, addr 0x27f5bf8, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetInputSourceHandle(::StringW pchInputSourcePath, ByRef<uint64_t> pHandle);

  /// @brief Method UpdateActionState, addr 0x27f5c20, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDigitalActionData, addr 0x27f5c4c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAnalogActionData, addr 0x27f5c70, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoseActionData, addr 0x27f5c94, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalActionData, addr 0x27f5cb8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalBoneData, addr 0x27f5cdc, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalBoneDataCompressed, addr 0x27f5d0c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method DecompressSkeletalBoneData, addr 0x27f5d38, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method TriggerHapticVibrationAction, addr 0x27f5d64, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActionOrigins, addr 0x27f5d88, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOriginLocalizedName, addr 0x27f5db4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOriginTrackedDeviceInfo, addr 0x27f5dd8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowActionOrigins, addr 0x27f5dfc, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError ShowActionOrigins(uint64_t actionSetHandle, uint64_t ulActionHandle);

  /// @brief Method ShowBindingsForActionSet, addr 0x27f5e20, size 0x30, virtual false, abstract: false, final false
