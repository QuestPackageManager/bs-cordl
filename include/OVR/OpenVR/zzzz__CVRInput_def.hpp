...
public:
  ...
  /// @brief Method DecompressSkeletalBoneData, addr 0x2beb39c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActionHandle, addr 0x2beb234, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetActionHandle(::StringW pchActionName, ByRef<uint64_t> pHandle);

  /// @brief Method GetActionOrigins, addr 0x2beb3ec, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActionSetHandle, addr 0x2beb20c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetActionSetHandle(::StringW pchActionSetName, ByRef<uint64_t> pHandle);

  /// @brief Method GetAnalogActionData, addr 0x2beb2d4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDigitalActionData, addr 0x2beb2b0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInputSourceHandle, addr 0x2beb25c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetInputSourceHandle(::StringW pchInputSourcePath, ByRef<uint64_t> pHandle);

  /// @brief Method GetOriginLocalizedName, addr 0x2beb418, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOriginTrackedDeviceInfo, addr 0x2beb43c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoseActionData, addr 0x2beb2f8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalActionData, addr 0x2beb31c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalBoneData, addr 0x2beb340, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalBoneDataCompressed, addr 0x2beb370, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActionManifestPath, addr 0x2beb1e8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError SetActionManifestPath(::StringW pchActionManifestPath);

  /// @brief Method ShowActionOrigins, addr 0x2beb460, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError ShowActionOrigins(uint64_t actionSetHandle, uint64_t ulActionHandle);

  /// @brief Method ShowBindingsForActionSet, addr 0x2beb484, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method TriggerHapticVibrationAction, addr 0x2beb3c8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateActionState, addr 0x2beb284, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2beb0d4, size 0x114, virtual false, abstract: false, final false
