...
public:
  ...
  /// @brief Method DecompressSkeletalBoneData, addr 0x40767dc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActionHandle, addr 0x4076674, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetActionHandle(::StringW pchActionName, ::ByRef<uint64_t> pHandle);

  /// @brief Method GetActionOrigins, addr 0x407682c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActionSetHandle, addr 0x407664c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetActionSetHandle(::StringW pchActionSetName, ::ByRef<uint64_t> pHandle);

  /// @brief Method GetAnalogActionData, addr 0x4076714, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDigitalActionData, addr 0x40766f0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInputSourceHandle, addr 0x407669c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError GetInputSourceHandle(::StringW pchInputSourcePath, ::ByRef<uint64_t> pHandle);

  /// @brief Method GetOriginLocalizedName, addr 0x4076858, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOriginTrackedDeviceInfo, addr 0x407687c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoseActionData, addr 0x4076738, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalActionData, addr 0x407675c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalBoneData, addr 0x4076780, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSkeletalBoneDataCompressed, addr 0x40767b0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActionManifestPath, addr 0x4076628, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError SetActionManifestPath(::StringW pchActionManifestPath);

  /// @brief Method ShowActionOrigins, addr 0x40768a0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRInputError ShowActionOrigins(uint64_t actionSetHandle, uint64_t ulActionHandle);

  /// @brief Method ShowBindingsForActionSet, addr 0x40768c4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method TriggerHapticVibrationAction, addr 0x4076808, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateActionState, addr 0x40766c4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4076514, size 0x114, virtual false, abstract: false, final false
