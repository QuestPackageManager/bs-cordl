...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(9309))}
...
public:
  ...
  /// @brief Method .ctor addr 0x267eaec size 0x114 virtual false final false
  inline void _ctor(void* pInterface);

  /// @brief Method SetActionManifestPath addr 0x267ec00 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRInputError SetActionManifestPath(::StringW pchActionManifestPath);

  /// @brief Method GetActionSetHandle addr 0x267ec24 size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRInputError GetActionSetHandle(::StringW pchActionSetName, ByRef<uint64_t> pHandle);

  /// @brief Method GetActionHandle addr 0x267ec4c size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRInputError GetActionHandle(::StringW pchActionName, ByRef<uint64_t> pHandle);

  /// @brief Method GetInputSourceHandle addr 0x267ec74 size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRInputError GetInputSourceHandle(::StringW pchInputSourcePath, ByRef<uint64_t> pHandle);

  /// @brief Method UpdateActionState addr 0x267ec9c size 0x2c virtual false final false
  ...
  /// @brief Method GetDigitalActionData addr 0x267ecc8 size 0x24 virtual false final false
  ...
  /// @brief Method GetAnalogActionData addr 0x267ecec size 0x24 virtual false final false
  ...
  /// @brief Method GetPoseActionData addr 0x267ed10 size 0x24 virtual false final false
  ...
  /// @brief Method GetSkeletalActionData addr 0x267ed34 size 0x24 virtual false final false
  ...
  /// @brief Method GetSkeletalBoneData addr 0x267ed58 size 0x30 virtual false final false
  ...
  /// @brief Method GetSkeletalBoneDataCompressed addr 0x267ed88 size 0x2c virtual false final false
  ...
  /// @brief Method DecompressSkeletalBoneData addr 0x267edb4 size 0x2c virtual false final false
  ...
  /// @brief Method TriggerHapticVibrationAction addr 0x267ede0 size 0x24 virtual false final false
  ...
  /// @brief Method GetActionOrigins addr 0x267ee04 size 0x2c virtual false final false
  ...
  /// @brief Method GetOriginLocalizedName addr 0x267ee30 size 0x24 virtual false final false
  ...
  /// @brief Method GetOriginTrackedDeviceInfo addr 0x267ee54 size 0x24 virtual false final false
  ...
  /// @brief Method ShowActionOrigins addr 0x267ee78 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRInputError ShowActionOrigins(uint64_t actionSetHandle, uint64_t ulActionHandle);

  /// @brief Method ShowBindingsForActionSet addr 0x267ee9c size 0x30 virtual false final false
