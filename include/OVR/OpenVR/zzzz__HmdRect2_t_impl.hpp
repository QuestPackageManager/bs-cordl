...
// Ctor Parameters [CppParam { name: "vTopLeft", ty: "::OVR::OpenVR::HmdVector2_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vBottomRight", ty:
// "::OVR::OpenVR::HmdVector2_t", modifiers: "", def_value: Some("{}"), comment: None }]
