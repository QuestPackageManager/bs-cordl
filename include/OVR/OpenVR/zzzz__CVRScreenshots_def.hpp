...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(8458))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2802d2c, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method RequestScreenshot, addr 0x2802e48, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method HookScreenshot, addr 0x2802e70, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScreenshotPropertyType, addr 0x2802e9c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScreenshotPropertyFilename, addr 0x2802ec0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateScreenshotProgress, addr 0x2802ee4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRScreenshotError UpdateScreenshotProgress(uint32_t screenshotHandle, float_t flProgress);

  /// @brief Method TakeStereoScreenshot, addr 0x2802f08, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SubmitScreenshot, addr 0x2802f30, size 0x24, virtual false, abstract: false, final false
