...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EHiddenAreaMeshType, "OVR.OpenVR", "EHiddenAreaMeshType");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EHiddenAreaMeshType) == 0x4, "Size mismatch!");
