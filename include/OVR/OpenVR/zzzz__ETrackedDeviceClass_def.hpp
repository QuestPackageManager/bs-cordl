...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::ETrackedDeviceClass, "OVR.OpenVR", "ETrackedDeviceClass");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::ETrackedDeviceClass) == 0x4, "Size mismatch!");
