...
public:
  // Declarations
  /// @brief Method Unpack, addr 0x407b75c, size 0x24, virtual false, abstract: false, final false
  inline void Unpack(::ByRef<::OVR::OpenVR::RenderModel_t> unpacked);

  /// @brief Method .ctor, addr 0x407b730, size 0x2c, virtual false, abstract: false, final false
