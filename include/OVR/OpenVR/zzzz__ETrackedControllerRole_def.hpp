...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::ETrackedControllerRole, "OVR.OpenVR", "ETrackedControllerRole");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::ETrackedControllerRole) == 0x4, "Size mismatch!");
