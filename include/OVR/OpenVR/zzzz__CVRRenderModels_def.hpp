...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2aca6e4, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2aca7e4, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x2aca6d0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2aca5f8, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FreeRenderModel, addr 0x2aca1fc, size 0x24, virtual false, abstract: false, final false
  inline void FreeRenderModel(void* pRenderModel);

  /// @brief Method FreeTexture, addr 0x2aca244, size 0x24, virtual false, abstract: false, final false
  inline void FreeTexture(void* pTexture);

  /// @brief Method FreeTextureD3D11, addr 0x2aca2b0, size 0x24, virtual false, abstract: false, final false
  inline void FreeTextureD3D11(void* pD3D11Texture2D);

  /// @brief Method GetComponentButtonMask, addr 0x2aca364, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetComponentButtonMask(::StringW pchRenderModelName, ::StringW pchComponentName);

  /// @brief Method GetComponentCount, addr 0x2aca31c, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetComponentCount(::StringW pchRenderModelName);

  /// @brief Method GetComponentName, addr 0x2aca340, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentRenderModelName, addr 0x2aca388, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentState, addr 0x2aca3d0, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentStateForDevicePath, addr 0x2aca3ac, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelCount, addr 0x2aca2f8, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetRenderModelCount();

  /// @brief Method GetRenderModelErrorNameFromEnum, addr 0x2aca574, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetRenderModelErrorNameFromEnum(::OVR::OpenVR::EVRRenderModelError error);

  /// @brief Method GetRenderModelName, addr 0x2aca2d4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelOriginalPath, addr 0x2aca550, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelThumbnailURL, addr 0x2aca52c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadIntoTextureD3D11_Async, addr 0x2aca28c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t textureId, void* pDstTexture);

  /// @brief Method LoadRenderModel_Async, addr 0x2aca1d8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadRenderModel_Async(::StringW pchRenderModelName, ByRef<void*> ppRenderModel);

  /// @brief Method LoadTextureD3D11_Async, addr 0x2aca268, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadTexture_Async, addr 0x2aca220, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderModelHasComponent, addr 0x2aca508, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2aca0c4, size 0x114, virtual false, abstract: false, final false
