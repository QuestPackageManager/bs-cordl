...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5c98618, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x5c98724, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x5c98604, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c98584, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FreeRenderModel, addr 0x5c981c4, size 0x20, virtual false, abstract: false, final false
  inline void FreeRenderModel(::System::IntPtr pRenderModel);

  /// @brief Method FreeTexture, addr 0x5c98204, size 0x20, virtual false, abstract: false, final false
  inline void FreeTexture(::System::IntPtr pTexture);

  /// @brief Method FreeTextureD3D11, addr 0x5c98264, size 0x20, virtual false, abstract: false, final false
  inline void FreeTextureD3D11(::System::IntPtr pD3D11Texture2D);

  /// @brief Method GetComponentButtonMask, addr 0x5c98304, size 0x20, virtual false, abstract: false, final false
  inline uint64_t GetComponentButtonMask(::StringW pchRenderModelName, ::StringW pchComponentName);

  /// @brief Method GetComponentCount, addr 0x5c982c4, size 0x20, virtual false, abstract: false, final false
  inline uint32_t GetComponentCount(::StringW pchRenderModelName);

  /// @brief Method GetComponentName, addr 0x5c982e4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentRenderModelName, addr 0x5c98324, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentState, addr 0x5c98364, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentStateForDevicePath, addr 0x5c98344, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelCount, addr 0x5c982a4, size 0x20, virtual false, abstract: false, final false
  inline uint32_t GetRenderModelCount();

  /// @brief Method GetRenderModelErrorNameFromEnum, addr 0x5c984f8, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW GetRenderModelErrorNameFromEnum(::OVR::OpenVR::EVRRenderModelError error);

  /// @brief Method GetRenderModelName, addr 0x5c98284, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelOriginalPath, addr 0x5c984d8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelThumbnailURL, addr 0x5c984b8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadIntoTextureD3D11_Async, addr 0x5c98244, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t textureId, ::System::IntPtr pDstTexture);

  /// @brief Method LoadRenderModel_Async, addr 0x5c981a4, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadRenderModel_Async(::StringW pchRenderModelName, ::ByRef<::System::IntPtr> ppRenderModel);

  /// @brief Method LoadTextureD3D11_Async, addr 0x5c98224, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadTexture_Async, addr 0x5c981e4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderModelHasComponent, addr 0x5c98498, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c980a4, size 0x100, virtual false, abstract: false, final false
