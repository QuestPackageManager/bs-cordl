...
public:
  ...
  /// @brief Method .ctor addr 0x267df48 size 0xd8 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x267e020 size 0x14 virtual true final false
  ...
  /// @brief Method BeginInvoke addr 0x267e034 size 0x100 virtual true final false
  ...
  /// @brief Method EndInvoke addr 0x267e134 size 0x34 virtual true final false
...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(9259))}
...
public:
  ...
  /// @brief Method .ctor addr 0x267da14 size 0x114 virtual false final false
  inline void _ctor(void* pInterface);

  /// @brief Method LoadRenderModel_Async addr 0x267db28 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadRenderModel_Async(::StringW pchRenderModelName, ByRef<void*> ppRenderModel);

  /// @brief Method FreeRenderModel addr 0x267db4c size 0x24 virtual false final false
  inline void FreeRenderModel(void* pRenderModel);

  /// @brief Method LoadTexture_Async addr 0x267db70 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadTexture_Async(int32_t textureId, ByRef<void*> ppTexture);

  /// @brief Method FreeTexture addr 0x267db94 size 0x24 virtual false final false
  inline void FreeTexture(void* pTexture);

  /// @brief Method LoadTextureD3D11_Async addr 0x267dbb8 size 0x24 virtual false final false
  ...
  /// @brief Method LoadIntoTextureD3D11_Async addr 0x267dbdc size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t textureId, void* pDstTexture);

  /// @brief Method FreeTextureD3D11 addr 0x267dc00 size 0x24 virtual false final false
  inline void FreeTextureD3D11(void* pD3D11Texture2D);

  /// @brief Method GetRenderModelName addr 0x267dc24 size 0x24 virtual false final false
  ...
  /// @brief Method GetRenderModelCount addr 0x267dc48 size 0x24 virtual false final false
  inline uint32_t GetRenderModelCount();

  /// @brief Method GetComponentCount addr 0x267dc6c size 0x24 virtual false final false
  inline uint32_t GetComponentCount(::StringW pchRenderModelName);

  /// @brief Method GetComponentName addr 0x267dc90 size 0x24 virtual false final false
  ...
  /// @brief Method GetComponentButtonMask addr 0x267dcb4 size 0x24 virtual false final false
  inline uint64_t GetComponentButtonMask(::StringW pchRenderModelName, ::StringW pchComponentName);

  /// @brief Method GetComponentRenderModelName addr 0x267dcd8 size 0x24 virtual false final false
  ...
  /// @brief Method GetComponentStateForDevicePath addr 0x267dcfc size 0x24 virtual false final false
  ...
  /// @brief Method GetComponentState addr 0x267dd20 size 0x138 virtual false final false
  ...
  /// @brief Method RenderModelHasComponent addr 0x267de58 size 0x24 virtual false final false
  inline bool RenderModelHasComponent(::StringW pchRenderModelName, ::StringW pchComponentName);

  /// @brief Method GetRenderModelThumbnailURL addr 0x267de7c size 0x24 virtual false final false
  ...
  /// @brief Method GetRenderModelOriginalPath addr 0x267dea0 size 0x24 virtual false final false
  ...
  /// @brief Method GetRenderModelErrorNameFromEnum addr 0x267dec4 size 0x84 virtual false final false
