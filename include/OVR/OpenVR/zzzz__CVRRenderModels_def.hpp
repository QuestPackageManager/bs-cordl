...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x4079f30, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x407a030, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x4079f1c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4079e7c, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FreeRenderModel, addr 0x4079a80, size 0x24, virtual false, abstract: false, final false
  inline void FreeRenderModel(::System::IntPtr pRenderModel);

  /// @brief Method FreeTexture, addr 0x4079ac8, size 0x24, virtual false, abstract: false, final false
  inline void FreeTexture(::System::IntPtr pTexture);

  /// @brief Method FreeTextureD3D11, addr 0x4079b34, size 0x24, virtual false, abstract: false, final false
  inline void FreeTextureD3D11(::System::IntPtr pD3D11Texture2D);

  /// @brief Method GetComponentButtonMask, addr 0x4079be8, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetComponentButtonMask(::StringW pchRenderModelName, ::StringW pchComponentName);

  /// @brief Method GetComponentCount, addr 0x4079ba0, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetComponentCount(::StringW pchRenderModelName);

  /// @brief Method GetComponentName, addr 0x4079bc4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentRenderModelName, addr 0x4079c0c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentState, addr 0x4079c54, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentStateForDevicePath, addr 0x4079c30, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelCount, addr 0x4079b7c, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetRenderModelCount();

  /// @brief Method GetRenderModelErrorNameFromEnum, addr 0x4079df8, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetRenderModelErrorNameFromEnum(::OVR::OpenVR::EVRRenderModelError error);

  /// @brief Method GetRenderModelName, addr 0x4079b58, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelOriginalPath, addr 0x4079dd4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderModelThumbnailURL, addr 0x4079db0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadIntoTextureD3D11_Async, addr 0x4079b10, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t textureId, ::System::IntPtr pDstTexture);

  /// @brief Method LoadRenderModel_Async, addr 0x4079a5c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRRenderModelError LoadRenderModel_Async(::StringW pchRenderModelName, ::ByRef<::System::IntPtr> ppRenderModel);

  /// @brief Method LoadTextureD3D11_Async, addr 0x4079aec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadTexture_Async, addr 0x4079aa4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderModelHasComponent, addr 0x4079d8c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4079948, size 0x114, virtual false, abstract: false, final false
