...
public:
  ...
  /// @brief Method .ctor addr 0x267a874 size 0xd8 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x267a94c size 0x14 virtual true final false
  inline bool Invoke(ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, uint32_t uncbVREvent);

  /// @brief Method BeginInvoke addr 0x267a960 size 0xb8 virtual true final false
  ...
  /// @brief Method EndInvoke addr 0x267aa18 size 0x2c virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0x267aa44 size 0xc4 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x267ab08 size 0x14 virtual true final false
  ...
  /// @brief Method BeginInvoke addr 0x267ab1c size 0xcc virtual true final false
  ...
  /// @brief Method EndInvoke addr 0x267abe8 size 0x2c virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0x267ac14 size 0xc4 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x267acd8 size 0x14 virtual true final false
  ...
  /// @brief Method BeginInvoke addr 0x267acec size 0x134 virtual true final false
  ...
  /// @brief Method EndInvoke addr 0x267ae20 size 0x34 virtual true final false
...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9033)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2679930 size 0x114 virtual false final false
  inline void _ctor(void* pInterface);

  /// @brief Method GetRecommendedRenderTargetSize addr 0x2679a44 size 0x2c virtual false final false
  inline void GetRecommendedRenderTargetSize(ByRef<uint32_t> pnWidth, ByRef<uint32_t> pnHeight);

  /// @brief Method GetProjectionMatrix addr 0x2679a70 size 0x48 virtual false final false
  inline ::OVR::OpenVR::HmdMatrix44_t GetProjectionMatrix(::OVR::OpenVR::EVREye eEye, float_t fNearZ, float_t fFarZ);

  /// @brief Method GetProjectionRaw addr 0x2679ab8 size 0x34 virtual false final false
  ...
  /// @brief Method ComputeDistortion addr 0x2679aec size 0x24 virtual false final false
  ...
  /// @brief Method GetEyeToHeadTransform addr 0x2679b10 size 0x48 virtual false final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetEyeToHeadTransform(::OVR::OpenVR::EVREye eEye);

  /// @brief Method GetTimeSinceLastVsync addr 0x2679b58 size 0x2c virtual false final false
  inline bool GetTimeSinceLastVsync(ByRef<float_t> pfSecondsSinceLastVsync, ByRef<uint64_t> pulFrameCounter);

  /// @brief Method GetD3D9AdapterIndex addr 0x2679b84 size 0x24 virtual false final false
  inline int32_t GetD3D9AdapterIndex();

  /// @brief Method GetDXGIOutputInfo addr 0x2679ba8 size 0x28 virtual false final false
  inline void GetDXGIOutputInfo(ByRef<int32_t> pnAdapterIndex);

  /// @brief Method GetOutputDevice addr 0x2679bd0 size 0x28 virtual false final false
  inline void GetOutputDevice(ByRef<uint64_t> pnDevice, ::OVR::OpenVR::ETextureType textureType, void* pInstance);

  /// @brief Method IsDisplayOnDesktop addr 0x2679bf8 size 0x24 virtual false final false
  inline bool IsDisplayOnDesktop();

  /// @brief Method SetDisplayVisibility addr 0x2679c1c size 0x28 virtual false final false
  inline bool SetDisplayVisibility(bool bIsVisibleOnDesktop);

  /// @brief Method GetDeviceToAbsoluteTrackingPose addr 0x2679c44 size 0x2c virtual false final false
  ...
  /// @brief Method ResetSeatedZeroPose addr 0x2679c70 size 0x24 virtual false final false
  inline void ResetSeatedZeroPose();

  /// @brief Method GetSeatedZeroPoseToStandingAbsoluteTrackingPose addr 0x2679c94 size 0x48 virtual false final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetSeatedZeroPoseToStandingAbsoluteTrackingPose();

  /// @brief Method GetRawZeroPoseToStandingAbsoluteTrackingPose addr 0x2679cdc size 0x48 virtual false final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetRawZeroPoseToStandingAbsoluteTrackingPose();

  /// @brief Method GetSortedTrackedDeviceIndicesOfClass addr 0x2679d24 size 0x30 virtual false final false
  ...
  /// @brief Method GetTrackedDeviceActivityLevel addr 0x2679d54 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EDeviceActivityLevel GetTrackedDeviceActivityLevel(uint32_t unDeviceId);

  /// @brief Method ApplyTransform addr 0x2679d78 size 0x24 virtual false final false
  ...
  /// @brief Method GetTrackedDeviceIndexForControllerRole addr 0x2679d9c size 0x24 virtual false final false
  inline uint32_t GetTrackedDeviceIndexForControllerRole(::OVR::OpenVR::ETrackedControllerRole unDeviceType);

  /// @brief Method GetControllerRoleForTrackedDeviceIndex addr 0x2679dc0 size 0x24 virtual false final false
  inline ::OVR::OpenVR::ETrackedControllerRole GetControllerRoleForTrackedDeviceIndex(uint32_t unDeviceIndex);

  /// @brief Method GetTrackedDeviceClass addr 0x2679de4 size 0x24 virtual false final false
  inline ::OVR::OpenVR::ETrackedDeviceClass GetTrackedDeviceClass(uint32_t unDeviceIndex);

  /// @brief Method IsTrackedDeviceConnected addr 0x2679e08 size 0x24 virtual false final false
  inline bool IsTrackedDeviceConnected(uint32_t unDeviceIndex);

  /// @brief Method GetBoolTrackedDeviceProperty addr 0x2679e2c size 0x24 virtual false final false
  ...
  /// @brief Method GetFloatTrackedDeviceProperty addr 0x2679e50 size 0x24 virtual false final false
  ...
  /// @brief Method GetInt32TrackedDeviceProperty addr 0x2679e74 size 0x24 virtual false final false
  ...
  /// @brief Method GetUint64TrackedDeviceProperty addr 0x2679e98 size 0x24 virtual false final false
  ...
  /// @brief Method GetMatrix34TrackedDeviceProperty addr 0x2679ebc size 0x48 virtual false final false
  ...
  /// @brief Method GetArrayTrackedDeviceProperty addr 0x2679f04 size 0x24 virtual false final false
  ...
  /// @brief Method GetStringTrackedDeviceProperty addr 0x2679f28 size 0x24 virtual false final false
  ...
  /// @brief Method GetPropErrorNameFromEnum addr 0x2679f4c size 0x84 virtual false final false
  inline ::StringW GetPropErrorNameFromEnum(::OVR::OpenVR::ETrackedPropertyError error);

  /// @brief Method PollNextEvent addr 0x2679fd0 size 0x174 virtual false final false
  inline bool PollNextEvent(ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method PollNextEventWithPose addr 0x267a164 size 0x24 virtual false final false
  ...
  /// @brief Method GetEventTypeNameFromEnum addr 0x267a188 size 0x84 virtual false final false
  inline ::StringW GetEventTypeNameFromEnum(::OVR::OpenVR::EVREventType eType);

  /// @brief Method GetHiddenAreaMesh addr 0x267a20c size 0x24 virtual false final false
  inline ::OVR::OpenVR::HiddenAreaMesh_t GetHiddenAreaMesh(::OVR::OpenVR::EVREye eEye, ::OVR::OpenVR::EHiddenAreaMeshType type);

  /// @brief Method GetControllerState addr 0x267a230 size 0x1ac virtual false final false
  ...
  /// @brief Method GetControllerStateWithPose addr 0x267a45c size 0x1cc virtual false final false
  ...
  /// @brief Method TriggerHapticPulse addr 0x267a628 size 0x24 virtual false final false
  inline void TriggerHapticPulse(uint32_t unControllerDeviceIndex, uint32_t unAxisId, uint16_t usDurationMicroSec);

  /// @brief Method GetButtonIdNameFromEnum addr 0x267a64c size 0x84 virtual false final false
  inline ::StringW GetButtonIdNameFromEnum(::OVR::OpenVR::EVRButtonId eButtonId);

  /// @brief Method GetControllerAxisTypeNameFromEnum addr 0x267a6d0 size 0x84 virtual false final false
  inline ::StringW GetControllerAxisTypeNameFromEnum(::OVR::OpenVR::EVRControllerAxisType eAxisType);

  /// @brief Method IsInputAvailable addr 0x267a754 size 0x24 virtual false final false
  inline bool IsInputAvailable();

  /// @brief Method IsSteamVRDrawingControllers addr 0x267a778 size 0x24 virtual false final false
  inline bool IsSteamVRDrawingControllers();

  /// @brief Method ShouldApplicationPause addr 0x267a79c size 0x24 virtual false final false
  inline bool ShouldApplicationPause();

  /// @brief Method ShouldApplicationReduceRenderingWork addr 0x267a7c0 size 0x24 virtual false final false
  inline bool ShouldApplicationReduceRenderingWork();

  /// @brief Method DriverDebugRequest addr 0x267a7e4 size 0x24 virtual false final false
  ...
  /// @brief Method PerformFirmwareUpdate addr 0x267a808 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRFirmwareError PerformFirmwareUpdate(uint32_t unDeviceIndex);

  /// @brief Method AcknowledgeQuit_Exiting addr 0x267a82c size 0x24 virtual false final false
  inline void AcknowledgeQuit_Exiting();

  /// @brief Method AcknowledgeQuit_UserPrompt addr 0x267a850 size 0x24 virtual false final false
