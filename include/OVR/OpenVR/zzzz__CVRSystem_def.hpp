...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2be6f48, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2be7000, size 0x2c, virtual true, abstract: false, final false
  inline bool EndInvoke(ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x2be6f34, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2be6e5c, size 0xd8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2be7104, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2be71d0, size 0x2c, virtual true, abstract: false, final false
  inline bool EndInvoke(ByRef<::OVR::OpenVR::VRControllerState_t_Packed> pControllerState, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x2be70f0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2be702c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2be72d4, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2be7408, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x2be72c0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2be71fc, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method AcknowledgeQuit_Exiting, addr 0x2be6e14, size 0x24, virtual false, abstract: false, final false
  inline void AcknowledgeQuit_Exiting();

  /// @brief Method AcknowledgeQuit_UserPrompt, addr 0x2be6e38, size 0x24, virtual false, abstract: false, final false
  inline void AcknowledgeQuit_UserPrompt();

  /// @brief Method ApplyTransform, addr 0x2be6360, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeDistortion, addr 0x2be60d4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method DriverDebugRequest, addr 0x2be6dcc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArrayTrackedDeviceProperty, addr 0x2be64ec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBoolTrackedDeviceProperty, addr 0x2be6414, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetButtonIdNameFromEnum, addr 0x2be6c34, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetButtonIdNameFromEnum(::OVR::OpenVR::EVRButtonId eButtonId);

  /// @brief Method GetControllerAxisTypeNameFromEnum, addr 0x2be6cb8, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetControllerAxisTypeNameFromEnum(::OVR::OpenVR::EVRControllerAxisType eAxisType);

  /// @brief Method GetControllerRoleForTrackedDeviceIndex, addr 0x2be63a8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ETrackedControllerRole GetControllerRoleForTrackedDeviceIndex(uint32_t unDeviceIndex);

  /// @brief Method GetControllerState, addr 0x2be6818, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetControllerStateWithPose, addr 0x2be6a44, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetD3D9AdapterIndex, addr 0x2be616c, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetD3D9AdapterIndex();

  /// @brief Method GetDXGIOutputInfo, addr 0x2be6190, size 0x28, virtual false, abstract: false, final false
  inline void GetDXGIOutputInfo(ByRef<int32_t> pnAdapterIndex);

  /// @brief Method GetDeviceToAbsoluteTrackingPose, addr 0x2be622c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEventTypeNameFromEnum, addr 0x2be6770, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetEventTypeNameFromEnum(::OVR::OpenVR::EVREventType eType);

  /// @brief Method GetEyeToHeadTransform, addr 0x2be60f8, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetEyeToHeadTransform(::OVR::OpenVR::EVREye eEye);

  /// @brief Method GetFloatTrackedDeviceProperty, addr 0x2be6438, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHiddenAreaMesh, addr 0x2be67f4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HiddenAreaMesh_t GetHiddenAreaMesh(::OVR::OpenVR::EVREye eEye, ::OVR::OpenVR::EHiddenAreaMeshType type);

  /// @brief Method GetInt32TrackedDeviceProperty, addr 0x2be645c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMatrix34TrackedDeviceProperty, addr 0x2be64a4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOutputDevice, addr 0x2be61b8, size 0x28, virtual false, abstract: false, final false
  inline void GetOutputDevice(ByRef<uint64_t> pnDevice, ::OVR::OpenVR::ETextureType textureType, ::System::IntPtr pInstance);

  /// @brief Method GetProjectionMatrix, addr 0x2be6058, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix44_t GetProjectionMatrix(::OVR::OpenVR::EVREye eEye, float_t fNearZ, float_t fFarZ);

  /// @brief Method GetProjectionRaw, addr 0x2be60a0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPropErrorNameFromEnum, addr 0x2be6534, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetPropErrorNameFromEnum(::OVR::OpenVR::ETrackedPropertyError error);

  /// @brief Method GetRawZeroPoseToStandingAbsoluteTrackingPose, addr 0x2be62c4, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetRawZeroPoseToStandingAbsoluteTrackingPose();

  /// @brief Method GetRecommendedRenderTargetSize, addr 0x2be602c, size 0x2c, virtual false, abstract: false, final false
  inline void GetRecommendedRenderTargetSize(ByRef<uint32_t> pnWidth, ByRef<uint32_t> pnHeight);

  /// @brief Method GetSeatedZeroPoseToStandingAbsoluteTrackingPose, addr 0x2be627c, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetSeatedZeroPoseToStandingAbsoluteTrackingPose();

  /// @brief Method GetSortedTrackedDeviceIndicesOfClass, addr 0x2be630c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStringTrackedDeviceProperty, addr 0x2be6510, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTimeSinceLastVsync, addr 0x2be6140, size 0x2c, virtual false, abstract: false, final false
  inline bool GetTimeSinceLastVsync(ByRef<float_t> pfSecondsSinceLastVsync, ByRef<uint64_t> pulFrameCounter);

  /// @brief Method GetTrackedDeviceActivityLevel, addr 0x2be633c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EDeviceActivityLevel GetTrackedDeviceActivityLevel(uint32_t unDeviceId);

  /// @brief Method GetTrackedDeviceClass, addr 0x2be63cc, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ETrackedDeviceClass GetTrackedDeviceClass(uint32_t unDeviceIndex);

  /// @brief Method GetTrackedDeviceIndexForControllerRole, addr 0x2be6384, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetTrackedDeviceIndexForControllerRole(::OVR::OpenVR::ETrackedControllerRole unDeviceType);

  /// @brief Method GetUint64TrackedDeviceProperty, addr 0x2be6480, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDisplayOnDesktop, addr 0x2be61e0, size 0x24, virtual false, abstract: false, final false
  inline bool IsDisplayOnDesktop();

  /// @brief Method IsInputAvailable, addr 0x2be6d3c, size 0x24, virtual false, abstract: false, final false
  inline bool IsInputAvailable();

  /// @brief Method IsSteamVRDrawingControllers, addr 0x2be6d60, size 0x24, virtual false, abstract: false, final false
  inline bool IsSteamVRDrawingControllers();

  /// @brief Method IsTrackedDeviceConnected, addr 0x2be63f0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformFirmwareUpdate, addr 0x2be6df0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRFirmwareError PerformFirmwareUpdate(uint32_t unDeviceIndex);

  /// @brief Method PollNextEvent, addr 0x2be65b8, size 0x174, virtual false, abstract: false, final false
  inline bool PollNextEvent(ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method PollNextEventWithPose, addr 0x2be674c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetSeatedZeroPose, addr 0x2be6258, size 0x24, virtual false, abstract: false, final false
  inline void ResetSeatedZeroPose();

  /// @brief Method SetDisplayVisibility, addr 0x2be6204, size 0x28, virtual false, abstract: false, final false
  inline bool SetDisplayVisibility(bool bIsVisibleOnDesktop);

  /// @brief Method ShouldApplicationPause, addr 0x2be6d84, size 0x24, virtual false, abstract: false, final false
  inline bool ShouldApplicationPause();

  /// @brief Method ShouldApplicationReduceRenderingWork, addr 0x2be6da8, size 0x24, virtual false, abstract: false, final false
  inline bool ShouldApplicationReduceRenderingWork();

  /// @brief Method TriggerHapticPulse, addr 0x2be6c10, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2be5f18, size 0x114, virtual false, abstract: false, final false
