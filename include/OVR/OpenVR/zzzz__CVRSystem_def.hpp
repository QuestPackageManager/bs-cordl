...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5c95498, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x5c95544, size 0x24, virtual true, abstract: false, final false
  inline bool EndInvoke(::ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5c95484, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c95404, size 0x80, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5c955e8, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x5c956a8, size 0x24, virtual true, abstract: false, final false
  inline bool EndInvoke(::ByRef<::OVR::OpenVR::VRControllerState_t_Packed> pControllerState, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5c955d4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c95568, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5c9574c, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x5c9586c, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x5c95738, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c956cc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method AcknowledgeQuit_Exiting, addr 0x5c953c4, size 0x20, virtual false, abstract: false, final false
  inline void AcknowledgeQuit_Exiting();

  /// @brief Method AcknowledgeQuit_UserPrompt, addr 0x5c953e4, size 0x20, virtual false, abstract: false, final false
  inline void AcknowledgeQuit_UserPrompt();

  /// @brief Method ApplyTransform, addr 0x5c94958, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeDistortion, addr 0x5c946f0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method DriverDebugRequest, addr 0x5c95384, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArrayTrackedDeviceProperty, addr 0x5c94ac0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBoolTrackedDeviceProperty, addr 0x5c949f8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetButtonIdNameFromEnum, addr 0x5c951ec, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW GetButtonIdNameFromEnum(::OVR::OpenVR::EVRButtonId eButtonId);

  /// @brief Method GetControllerAxisTypeNameFromEnum, addr 0x5c95278, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW GetControllerAxisTypeNameFromEnum(::OVR::OpenVR::EVRControllerAxisType eAxisType);

  /// @brief Method GetControllerRoleForTrackedDeviceIndex, addr 0x5c94998, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ETrackedControllerRole GetControllerRoleForTrackedDeviceIndex(uint32_t unDeviceIndex);

  /// @brief Method GetControllerState, addr 0x5c94de0, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetControllerStateWithPose, addr 0x5c95004, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetD3D9AdapterIndex, addr 0x5c94780, size 0x20, virtual false, abstract: false, final false
  inline int32_t GetD3D9AdapterIndex();

  /// @brief Method GetDXGIOutputInfo, addr 0x5c947a0, size 0x24, virtual false, abstract: false, final false
  inline void GetDXGIOutputInfo(::ByRef<int32_t> pnAdapterIndex);

  /// @brief Method GetDeviceToAbsoluteTrackingPose, addr 0x5c9482c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEventTypeNameFromEnum, addr 0x5c94d34, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW GetEventTypeNameFromEnum(::OVR::OpenVR::EVREventType eType);

  /// @brief Method GetEyeToHeadTransform, addr 0x5c94710, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetEyeToHeadTransform(::OVR::OpenVR::EVREye eEye);

  /// @brief Method GetFloatTrackedDeviceProperty, addr 0x5c94a18, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHiddenAreaMesh, addr 0x5c94dc0, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HiddenAreaMesh_t GetHiddenAreaMesh(::OVR::OpenVR::EVREye eEye, ::OVR::OpenVR::EHiddenAreaMeshType type);

  /// @brief Method GetInt32TrackedDeviceProperty, addr 0x5c94a38, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMatrix34TrackedDeviceProperty, addr 0x5c94a78, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOutputDevice, addr 0x5c947c4, size 0x24, virtual false, abstract: false, final false
  inline void GetOutputDevice(::ByRef<uint64_t> pnDevice, ::OVR::OpenVR::ETextureType textureType, ::System::IntPtr pInstance);

  /// @brief Method GetProjectionMatrix, addr 0x5c94678, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix44_t GetProjectionMatrix(::OVR::OpenVR::EVREye eEye, float_t fNearZ, float_t fFarZ);

  /// @brief Method GetProjectionRaw, addr 0x5c946c0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPropErrorNameFromEnum, addr 0x5c94b00, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW GetPropErrorNameFromEnum(::OVR::OpenVR::ETrackedPropertyError error);

  /// @brief Method GetRawZeroPoseToStandingAbsoluteTrackingPose, addr 0x5c948c0, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetRawZeroPoseToStandingAbsoluteTrackingPose();

  /// @brief Method GetRecommendedRenderTargetSize, addr 0x5c94650, size 0x28, virtual false, abstract: false, final false
  inline void GetRecommendedRenderTargetSize(::ByRef<uint32_t> pnWidth, ::ByRef<uint32_t> pnHeight);

  /// @brief Method GetSeatedZeroPoseToStandingAbsoluteTrackingPose, addr 0x5c94878, size 0x48, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::HmdMatrix34_t GetSeatedZeroPoseToStandingAbsoluteTrackingPose();

  /// @brief Method GetSortedTrackedDeviceIndicesOfClass, addr 0x5c94908, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStringTrackedDeviceProperty, addr 0x5c94ae0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTimeSinceLastVsync, addr 0x5c94758, size 0x28, virtual false, abstract: false, final false
  inline bool GetTimeSinceLastVsync(::ByRef<float_t> pfSecondsSinceLastVsync, ::ByRef<uint64_t> pulFrameCounter);

  /// @brief Method GetTrackedDeviceActivityLevel, addr 0x5c94938, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EDeviceActivityLevel GetTrackedDeviceActivityLevel(uint32_t unDeviceId);

  /// @brief Method GetTrackedDeviceClass, addr 0x5c949b8, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ETrackedDeviceClass GetTrackedDeviceClass(uint32_t unDeviceIndex);

  /// @brief Method GetTrackedDeviceIndexForControllerRole, addr 0x5c94978, size 0x20, virtual false, abstract: false, final false
  inline uint32_t GetTrackedDeviceIndexForControllerRole(::OVR::OpenVR::ETrackedControllerRole unDeviceType);

  /// @brief Method GetUint64TrackedDeviceProperty, addr 0x5c94a58, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDisplayOnDesktop, addr 0x5c947e8, size 0x20, virtual false, abstract: false, final false
  inline bool IsDisplayOnDesktop();

  /// @brief Method IsInputAvailable, addr 0x5c95304, size 0x20, virtual false, abstract: false, final false
  inline bool IsInputAvailable();

  /// @brief Method IsSteamVRDrawingControllers, addr 0x5c95324, size 0x20, virtual false, abstract: false, final false
  inline bool IsSteamVRDrawingControllers();

  /// @brief Method IsTrackedDeviceConnected, addr 0x5c949d8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformFirmwareUpdate, addr 0x5c953a4, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRFirmwareError PerformFirmwareUpdate(uint32_t unDeviceIndex);

  /// @brief Method PollNextEvent, addr 0x5c94b8c, size 0x168, virtual false, abstract: false, final false
  inline bool PollNextEvent(::ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method PollNextEventWithPose, addr 0x5c94d14, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetSeatedZeroPose, addr 0x5c94858, size 0x20, virtual false, abstract: false, final false
  inline void ResetSeatedZeroPose();

  /// @brief Method SetDisplayVisibility, addr 0x5c94808, size 0x24, virtual false, abstract: false, final false
  inline bool SetDisplayVisibility(bool bIsVisibleOnDesktop);

  /// @brief Method ShouldApplicationPause, addr 0x5c95344, size 0x20, virtual false, abstract: false, final false
  inline bool ShouldApplicationPause();

  /// @brief Method ShouldApplicationReduceRenderingWork, addr 0x5c95364, size 0x20, virtual false, abstract: false, final false
  inline bool ShouldApplicationReduceRenderingWork();

  /// @brief Method TriggerHapticPulse, addr 0x5c951cc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c94550, size 0x100, virtual false, abstract: false, final false
