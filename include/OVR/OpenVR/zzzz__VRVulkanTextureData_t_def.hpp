...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VRVulkanTextureData_t, "OVR.OpenVR", "VRVulkanTextureData_t");
...
static_assert(sizeof(::OVR::OpenVR::VRVulkanTextureData_t) == 0x40, "Size mismatch!");
