...
public:
  ...
  /// @brief Method .ctor, addr 0x27f2904, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method GetCalibrationState, addr 0x27f2a18, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ChaperoneCalibrationState GetCalibrationState();

  /// @brief Method GetPlayAreaSize, addr 0x27f2a3c, size 0x2c, virtual false, abstract: false, final false
  inline bool GetPlayAreaSize(ByRef<float_t> pSizeX, ByRef<float_t> pSizeZ);

  /// @brief Method GetPlayAreaRect, addr 0x27f2a68, size 0x24, virtual false, abstract: false, final false
  inline bool GetPlayAreaRect(ByRef<::OVR::OpenVR::HmdQuad_t> rect);

  /// @brief Method ReloadInfo, addr 0x27f2a8c, size 0x24, virtual false, abstract: false, final false
  inline void ReloadInfo();

  /// @brief Method SetSceneColor, addr 0x27f2ab0, size 0x24, virtual false, abstract: false, final false
  inline void SetSceneColor(::OVR::OpenVR::HmdColor_t color);

  /// @brief Method GetBoundsColor, addr 0x27f2ad4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method AreBoundsVisible, addr 0x27f2af8, size 0x24, virtual false, abstract: false, final false
  inline bool AreBoundsVisible();

  /// @brief Method ForceBoundsVisible, addr 0x27f2b1c, size 0x28, virtual false, abstract: false, final false
