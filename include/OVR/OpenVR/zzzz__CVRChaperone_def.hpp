...
public:
  ...
  /// @brief Method AreBoundsVisible, addr 0x2ac8224, size 0x24, virtual false, abstract: false, final false
  inline bool AreBoundsVisible();

  /// @brief Method ForceBoundsVisible, addr 0x2ac8248, size 0x28, virtual false, abstract: false, final false
  inline void ForceBoundsVisible(bool bForce);

  /// @brief Method GetBoundsColor, addr 0x2ac8200, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCalibrationState, addr 0x2ac8144, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ChaperoneCalibrationState GetCalibrationState();

  /// @brief Method GetPlayAreaRect, addr 0x2ac8194, size 0x24, virtual false, abstract: false, final false
  inline bool GetPlayAreaRect(ByRef<::OVR::OpenVR::HmdQuad_t> rect);

  /// @brief Method GetPlayAreaSize, addr 0x2ac8168, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadInfo, addr 0x2ac81b8, size 0x24, virtual false, abstract: false, final false
  inline void ReloadInfo();

  /// @brief Method SetSceneColor, addr 0x2ac81dc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ac8030, size 0x114, virtual false, abstract: false, final false
