...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(8266))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x28000bc, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method GetCalibrationState, addr 0x28001d0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::ChaperoneCalibrationState GetCalibrationState();

  /// @brief Method GetPlayAreaSize, addr 0x28001f4, size 0x2c, virtual false, abstract: false, final false
  inline bool GetPlayAreaSize(ByRef<float_t> pSizeX, ByRef<float_t> pSizeZ);

  /// @brief Method GetPlayAreaRect, addr 0x2800220, size 0x24, virtual false, abstract: false, final false
  inline bool GetPlayAreaRect(ByRef<::OVR::OpenVR::HmdQuad_t> rect);

  /// @brief Method ReloadInfo, addr 0x2800244, size 0x24, virtual false, abstract: false, final false
  inline void ReloadInfo();

  /// @brief Method SetSceneColor, addr 0x2800268, size 0x24, virtual false, abstract: false, final false
  inline void SetSceneColor(::OVR::OpenVR::HmdColor_t color);

  /// @brief Method GetBoundsColor, addr 0x280028c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method AreBoundsVisible, addr 0x28002b0, size 0x24, virtual false, abstract: false, final false
  inline bool AreBoundsVisible();

  /// @brief Method ForceBoundsVisible, addr 0x28002d4, size 0x28, virtual false, abstract: false, final false
