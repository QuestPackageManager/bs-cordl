...
public:
  ...
  /// @brief Method CheckClear, addr 0x5c9b380, size 0xb4, virtual false, abstract: false, final false
  inline void CheckClear();

  /// @brief Method Clear, addr 0x5c9b360, size 0x18, virtual false, abstract: false, final false
  inline void Clear();

  static inline ::OVR::OpenVR::OpenVR_COpenVRContext* New_ctor();

  /// @brief Method VRApplications, addr 0x5c9add0, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRApplications* VRApplications();

  /// @brief Method VRChaperone, addr 0x5c9a820, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRChaperone* VRChaperone();

  /// @brief Method VRChaperoneSetup, addr 0x5c9a8f0, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRChaperoneSetup* VRChaperoneSetup();

  /// @brief Method VRCompositor, addr 0x5c9a9c0, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRCompositor* VRCompositor();

  /// @brief Method VRExtendedDisplay, addr 0x5c9ac30, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRExtendedDisplay* VRExtendedDisplay();

  /// @brief Method VRInput, addr 0x5c9b040, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRInput* VRInput();

  /// @brief Method VROverlay, addr 0x5c9aa90, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVROverlay* VROverlay();

  /// @brief Method VRRenderModels, addr 0x5c9ab60, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRRenderModels* VRRenderModels();

  /// @brief Method VRScreenshots, addr 0x5c9aea0, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRScreenshots* VRScreenshots();

  /// @brief Method VRSettings, addr 0x5c9ad00, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRSettings* VRSettings();

  /// @brief Method VRSpatialAnchors, addr 0x5c9b110, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRSpatialAnchors* VRSpatialAnchors();

  /// @brief Method VRSystem, addr 0x5c9a750, size 0xb8, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::CVRSystem* VRSystem();

  /// @brief Method VRTrackedCamera, addr 0x5c9af70, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9a720, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetGenericInterface, addr 0x5c9a5e8, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetGenericInterface(::StringW pchInterfaceVersion, ::ByRef<::OVR::OpenVR::EVRInitError> peError);

  /// @brief Method GetInitToken, addr 0x5c9a5f0, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetInitToken();

  /// @brief Method GetStringForHmdError, addr 0x5c9a580, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW GetStringForHmdError(::OVR::OpenVR::EVRInitError error);

  /// @brief Method Init, addr 0x5c9b1c8, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method InitInternal, addr 0x5c9a56c, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t InitInternal(::ByRef<::OVR::OpenVR::EVRInitError> peError, ::OVR::OpenVR::EVRApplicationType eApplicationType);

  /// @brief Method InitInternal2, addr 0x5c9a570, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsHmdPresent, addr 0x5c9a578, size 0x4, virtual false, abstract: false, final false
  static inline bool IsHmdPresent();

  /// @brief Method IsInterfaceVersionValid, addr 0x5c9a5ec, size 0x4, virtual false, abstract: false, final false
  static inline bool IsInterfaceVersionValid(::StringW pchInterfaceVersion);

  /// @brief Method IsRuntimeInstalled, addr 0x5c9a57c, size 0x4, virtual false, abstract: false, final false
  static inline bool IsRuntimeInstalled();

  static inline ::OVR::OpenVR::OpenVR* New_ctor();

  /// @brief Method Shutdown, addr 0x5c9b378, size 0x4, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method ShutdownInternal, addr 0x5c9a574, size 0x4, virtual false, abstract: false, final false
  static inline void ShutdownInternal();

  /// @brief Method .ctor, addr 0x5c9b37c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Applications, addr 0x5c9adb8, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRApplications* get_Applications();

  /// @brief Method get_Chaperone, addr 0x5c9a808, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRChaperone* get_Chaperone();

  /// @brief Method get_ChaperoneSetup, addr 0x5c9a8d8, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRChaperoneSetup* get_ChaperoneSetup();

  /// @brief Method get_Compositor, addr 0x5c9a9a8, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRCompositor* get_Compositor();

  /// @brief Method get_ExtendedDisplay, addr 0x5c9ac18, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRExtendedDisplay* get_ExtendedDisplay();

  /// @brief Method get_Input, addr 0x5c9b028, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRInput* get_Input();

  /// @brief Method get_OpenVRInternal_ModuleContext, addr 0x5c9a690, size 0x90, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::OpenVR_COpenVRContext* get_OpenVRInternal_ModuleContext();

  /// @brief Method get_Overlay, addr 0x5c9aa78, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVROverlay* get_Overlay();

  /// @brief Method get_RenderModels, addr 0x5c9ab48, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRRenderModels* get_RenderModels();

  /// @brief Method get_Screenshots, addr 0x5c9ae88, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRScreenshots* get_Screenshots();

  /// @brief Method get_Settings, addr 0x5c9ace8, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRSettings* get_Settings();

  /// @brief Method get_SpatialAnchors, addr 0x5c9b0f8, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRSpatialAnchors* get_SpatialAnchors();

  /// @brief Method get_System, addr 0x5c9a738, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRSystem* get_System();

  /// @brief Method get_TrackedCamera, addr 0x5c9af58, size 0x18, virtual false, abstract: false, final false
  static inline ::OVR::OpenVR::CVRTrackedCamera* get_TrackedCamera();

  /// @brief Method get_VRToken, addr 0x5c9a5f4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_VRToken, addr 0x5c9a640, size 0x50, virtual false, abstract: false, final false
