...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(8495))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x28037d8, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method CreateSpatialAnchorFromDescriptor, addr 0x28038e4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpatialAnchorFromPose, addr 0x280390c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSpatialAnchorPose, addr 0x2803934, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSpatialAnchorDescriptor, addr 0x2803958, size 0x28, virtual false, abstract: false, final false
