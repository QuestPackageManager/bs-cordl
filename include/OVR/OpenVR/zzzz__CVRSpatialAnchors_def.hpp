...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(9320))}
...
public:
  ...
  /// @brief Method .ctor addr 0x267f09c size 0x10c virtual false final false
  inline void _ctor(void* pInterface);

  /// @brief Method CreateSpatialAnchorFromDescriptor addr 0x267f1a8 size 0x28 virtual false final false
  ...
  /// @brief Method CreateSpatialAnchorFromPose addr 0x267f1d0 size 0x28 virtual false final false
  ...
  /// @brief Method GetSpatialAnchorPose addr 0x267f1f8 size 0x24 virtual false final false
  ...
  /// @brief Method GetSpatialAnchorDescriptor addr 0x267f21c size 0x28 virtual false final false
