...
public:
  ...
  /// @brief Method CreateSpatialAnchorFromDescriptor, addr 0x5e47b00, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpatialAnchorFromPose, addr 0x5e47b24, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSpatialAnchorDescriptor, addr 0x5e47b68, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSpatialAnchorPose, addr 0x5e47b48, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e47a0c, size 0xf4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CVRSpatialAnchors", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CVRSpatialAnchors(CVRSpatialAnchors&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CVRSpatialAnchors", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CVRSpatialAnchors(CVRSpatialAnchorsconst&) = delete;
