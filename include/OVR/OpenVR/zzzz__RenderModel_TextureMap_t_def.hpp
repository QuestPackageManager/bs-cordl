...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::RenderModel_TextureMap_t, "OVR.OpenVR", "RenderModel_TextureMap_t");
...
static_assert(sizeof(::OVR::OpenVR::RenderModel_TextureMap_t) == 0x10, "Size mismatch!");
