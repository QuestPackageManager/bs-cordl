...
// Ctor Parameters [CppParam { name: "reserved0", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "reserved1", ty: "uint64_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "reserved2", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "reserved3", ty: "uint64_t", modifiers: "",
