...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VRTextureDepthInfo_t, "OVR.OpenVR", "VRTextureDepthInfo_t");
...
static_assert(sizeof(::OVR::OpenVR::VRTextureDepthInfo_t) == 0x50, "Size mismatch!");
