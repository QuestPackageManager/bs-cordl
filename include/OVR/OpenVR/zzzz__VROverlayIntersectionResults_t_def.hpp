...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VROverlayIntersectionResults_t, "OVR.OpenVR", "VROverlayIntersectionResults_t");
...
static_assert(sizeof(::OVR::OpenVR::VROverlayIntersectionResults_t) == 0x24, "Size mismatch!");
