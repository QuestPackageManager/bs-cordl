...
public:
  // Declarations
  /// @brief Method Unpack, addr 0x5e48154, size 0x14, virtual false, abstract: false, final false
  inline void Unpack(::by_ref<::OVR::OpenVR::RenderModel_TextureMap_t> unpacked);

  /// @brief Method .ctor, addr 0x5e48140, size 0x14, virtual false, abstract: false, final false
