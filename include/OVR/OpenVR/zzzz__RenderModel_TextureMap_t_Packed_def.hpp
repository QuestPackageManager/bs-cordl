...
public:
  // Declarations
  /// @brief Method Unpack, addr 0x5c99c98, size 0x14, virtual false, abstract: false, final false
  inline void Unpack(::ByRef<::OVR::OpenVR::RenderModel_TextureMap_t> unpacked);

  /// @brief Method .ctor, addr 0x5c99c84, size 0x14, virtual false, abstract: false, final false
