...
public:
  ...
  /// @brief Method .ctor, addr 0x27f47ac, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke, addr 0x27f4870, size 0x14, virtual true, abstract: false, final false
  inline bool Invoke(uint64_t ulOverlayHandle, ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, uint32_t uncbVREvent);

  /// @brief Method BeginInvoke, addr 0x27f4884, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x27f496c, size 0x2c, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x27f38c4, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method FindOverlay, addr 0x27f39d8, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError FindOverlay(::StringW pchOverlayKey, ByRef<uint64_t> pOverlayHandle);

  /// @brief Method CreateOverlay, addr 0x27f3a00, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyOverlay, addr 0x27f3a28, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError DestroyOverlay(uint64_t ulOverlayHandle);

  /// @brief Method SetHighQualityOverlay, addr 0x27f3a4c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetHighQualityOverlay(uint64_t ulOverlayHandle);

  /// @brief Method GetHighQualityOverlay, addr 0x27f3a70, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetHighQualityOverlay();

  /// @brief Method GetOverlayKey, addr 0x27f3a94, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayName, addr 0x27f3ab8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayName, addr 0x27f3adc, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayName(uint64_t ulOverlayHandle, ::StringW pchName);

  /// @brief Method GetOverlayImageData, addr 0x27f3b00, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayErrorNameFromEnum, addr 0x27f3b2c, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetOverlayErrorNameFromEnum(::OVR::OpenVR::EVROverlayError error);

  /// @brief Method SetOverlayRenderingPid, addr 0x27f3bb0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayRenderingPid(uint64_t ulOverlayHandle, uint32_t unPID);

  /// @brief Method GetOverlayRenderingPid, addr 0x27f3bd4, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetOverlayRenderingPid(uint64_t ulOverlayHandle);

  /// @brief Method SetOverlayFlag, addr 0x27f3bf8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayFlag, addr 0x27f3c20, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayColor, addr 0x27f3c48, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayColor(uint64_t ulOverlayHandle, float_t fRed, float_t fGreen, float_t fBlue);

  /// @brief Method GetOverlayColor, addr 0x27f3c6c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayAlpha, addr 0x27f3c9c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayAlpha(uint64_t ulOverlayHandle, float_t fAlpha);

  /// @brief Method GetOverlayAlpha, addr 0x27f3cc0, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayAlpha(uint64_t ulOverlayHandle, ByRef<float_t> pfAlpha);

  /// @brief Method SetOverlayTexelAspect, addr 0x27f3ce8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexelAspect(uint64_t ulOverlayHandle, float_t fTexelAspect);

  /// @brief Method GetOverlayTexelAspect, addr 0x27f3d0c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayTexelAspect(uint64_t ulOverlayHandle, ByRef<float_t> pfTexelAspect);

  /// @brief Method SetOverlaySortOrder, addr 0x27f3d34, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlaySortOrder(uint64_t ulOverlayHandle, uint32_t unSortOrder);

  /// @brief Method GetOverlaySortOrder, addr 0x27f3d58, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlaySortOrder(uint64_t ulOverlayHandle, ByRef<uint32_t> punSortOrder);

  /// @brief Method SetOverlayWidthInMeters, addr 0x27f3d80, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayWidthInMeters(uint64_t ulOverlayHandle, float_t fWidthInMeters);

  /// @brief Method GetOverlayWidthInMeters, addr 0x27f3da4, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayWidthInMeters(uint64_t ulOverlayHandle, ByRef<float_t> pfWidthInMeters);

  /// @brief Method SetOverlayAutoCurveDistanceRangeInMeters, addr 0x27f3dcc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayAutoCurveDistanceRangeInMeters, addr 0x27f3df0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTextureColorSpace, addr 0x27f3e1c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureColorSpace, addr 0x27f3e40, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTextureBounds, addr 0x27f3e64, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureBounds, addr 0x27f3e88, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderModel, addr 0x27f3eac, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderModel, addr 0x27f3ed0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformType, addr 0x27f3ef4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformAbsolute, addr 0x27f3f18, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformAbsolute, addr 0x27f3f3c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceRelative, addr 0x27f3f60, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceRelative, addr 0x27f3f84, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceComponent, addr 0x27f3fac, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceComponent, addr 0x27f3fd0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformOverlayRelative, addr 0x27f3ff8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformOverlayRelative, addr 0x27f4020, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowOverlay, addr 0x27f4044, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ShowOverlay(uint64_t ulOverlayHandle);

  /// @brief Method HideOverlay, addr 0x27f4068, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError HideOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsOverlayVisible, addr 0x27f408c, size 0x24, virtual false, abstract: false, final false
  inline bool IsOverlayVisible(uint64_t ulOverlayHandle);

  /// @brief Method GetTransformForOverlayCoordinates, addr 0x27f40b0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PollNextOverlayEvent, addr 0x27f40d4, size 0x180, virtual false, abstract: false, final false
  inline bool PollNextOverlayEvent(uint64_t ulOverlayHandle, ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method GetOverlayInputMethod, addr 0x27f4254, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayInputMethod, addr 0x27f4278, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayMouseScale, addr 0x27f429c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayMouseScale, addr 0x27f42c0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeOverlayIntersection, addr 0x27f42e4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method IsHoverTargetOverlay, addr 0x27f4308, size 0x24, virtual false, abstract: false, final false
  inline bool IsHoverTargetOverlay(uint64_t ulOverlayHandle);

  /// @brief Method GetGamepadFocusOverlay, addr 0x27f432c, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetGamepadFocusOverlay();

  /// @brief Method SetGamepadFocusOverlay, addr 0x27f4350, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetGamepadFocusOverlay(uint64_t ulNewFocusOverlay);

  /// @brief Method SetOverlayNeighbor, addr 0x27f4374, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveGamepadFocusToNeighbor, addr 0x27f4398, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError MoveGamepadFocusToNeighbor(::OVR::OpenVR::EOverlayDirection eDirection, uint64_t ulFrom);

  /// @brief Method SetOverlayDualAnalogTransform, addr 0x27f43bc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayDualAnalogTransform, addr 0x27f43e0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTexture, addr 0x27f4408, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexture(uint64_t ulOverlayHandle, ByRef<::OVR::OpenVR::Texture_t> pTexture);

  /// @brief Method ClearOverlayTexture, addr 0x27f442c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ClearOverlayTexture(uint64_t ulOverlayHandle);

  /// @brief Method SetOverlayRaw, addr 0x27f4450, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFromFile, addr 0x27f4474, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayFromFile(uint64_t ulOverlayHandle, ::StringW pchFilePath);

  /// @brief Method GetOverlayTexture, addr 0x27f4498, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseNativeOverlayHandle, addr 0x27f44d4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ReleaseNativeOverlayHandle(uint64_t ulOverlayHandle, void* pNativeTextureHandle);

  /// @brief Method GetOverlayTextureSize, addr 0x27f44f8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDashboardOverlay, addr 0x27f4524, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDashboardVisible, addr 0x27f4550, size 0x24, virtual false, abstract: false, final false
  inline bool IsDashboardVisible();

  /// @brief Method IsActiveDashboardOverlay, addr 0x27f4574, size 0x24, virtual false, abstract: false, final false
  inline bool IsActiveDashboardOverlay(uint64_t ulOverlayHandle);

  /// @brief Method SetDashboardOverlaySceneProcess, addr 0x27f4598, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, uint32_t unProcessId);

  /// @brief Method GetDashboardOverlaySceneProcess, addr 0x27f45bc, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, ByRef<uint32_t> punProcessId);

  /// @brief Method ShowDashboard, addr 0x27f45e4, size 0x24, virtual false, abstract: false, final false
  inline void ShowDashboard(::StringW pchOverlayToShow);

  /// @brief Method GetPrimaryDashboardDevice, addr 0x27f4608, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetPrimaryDashboardDevice();

  /// @brief Method ShowKeyboard, addr 0x27f462c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowKeyboardForOverlay, addr 0x27f4658, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKeyboardText, addr 0x27f4688, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetKeyboardText(::System::Text::StringBuilder* pchText, uint32_t cchText);

  /// @brief Method HideKeyboard, addr 0x27f46ac, size 0x24, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method SetKeyboardTransformAbsolute, addr 0x27f46d0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetKeyboardPositionForOverlay, addr 0x27f46f4, size 0x24, virtual false, abstract: false, final false
  inline void SetKeyboardPositionForOverlay(uint64_t ulOverlayHandle, ::OVR::OpenVR::HmdRect2_t avoidRect);

  /// @brief Method SetOverlayIntersectionMask, addr 0x27f4718, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayFlags, addr 0x27f473c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayFlags(uint64_t ulOverlayHandle, ByRef<uint32_t> pFlags);

  /// @brief Method ShowMessageOverlay, addr 0x27f4764, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CloseMessageOverlay, addr 0x27f4788, size 0x24, virtual false, abstract: false, final false
