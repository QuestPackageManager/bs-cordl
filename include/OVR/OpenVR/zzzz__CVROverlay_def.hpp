...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x40752e4, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x40753d0, size 0x2c, virtual true, abstract: false, final false
  inline bool EndInvoke(::ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x40752d0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4075244, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearOverlayTexture, addr 0x4074ec4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ClearOverlayTexture(uint64_t ulOverlayHandle);

  /// @brief Method CloseMessageOverlay, addr 0x4075220, size 0x24, virtual false, abstract: false, final false
  inline void CloseMessageOverlay();

  /// @brief Method ComputeOverlayIntersection, addr 0x4074d7c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDashboardOverlay, addr 0x4074fbc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOverlay, addr 0x4074498, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyOverlay, addr 0x40744c0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError DestroyOverlay(uint64_t ulOverlayHandle);

  /// @brief Method FindOverlay, addr 0x4074470, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError FindOverlay(::StringW pchOverlayKey, ::ByRef<uint64_t> pOverlayHandle);

  /// @brief Method GetDashboardOverlaySceneProcess, addr 0x4075054, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, ::ByRef<uint32_t> punProcessId);

  /// @brief Method GetGamepadFocusOverlay, addr 0x4074dc4, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetGamepadFocusOverlay();

  /// @brief Method GetHighQualityOverlay, addr 0x4074508, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetHighQualityOverlay();

  /// @brief Method GetKeyboardText, addr 0x4075120, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetKeyboardText(::System::Text::StringBuilder* pchText, uint32_t cchText);

  /// @brief Method GetOverlayAlpha, addr 0x4074758, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayAlpha(uint64_t ulOverlayHandle, ::ByRef<float_t> pfAlpha);

  /// @brief Method GetOverlayAutoCurveDistanceRangeInMeters, addr 0x4074888, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayColor, addr 0x4074704, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayDualAnalogTransform, addr 0x4074e78, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayErrorNameFromEnum, addr 0x40745c4, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetOverlayErrorNameFromEnum(::OVR::OpenVR::EVROverlayError error);

  /// @brief Method GetOverlayFlag, addr 0x40746b8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayFlags, addr 0x40751d4, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayFlags(uint64_t ulOverlayHandle, ::ByRef<uint32_t> pFlags);

  /// @brief Method GetOverlayImageData, addr 0x4074598, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayInputMethod, addr 0x4074cec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayKey, addr 0x407452c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayMouseScale, addr 0x4074d34, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayName, addr 0x4074550, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderModel, addr 0x4074944, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderingPid, addr 0x407466c, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetOverlayRenderingPid(uint64_t ulOverlayHandle);

  /// @brief Method GetOverlaySortOrder, addr 0x40747f0, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlaySortOrder(uint64_t ulOverlayHandle, ::ByRef<uint32_t> punSortOrder);

  /// @brief Method GetOverlayTexelAspect, addr 0x40747a4, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayTexelAspect(uint64_t ulOverlayHandle, ::ByRef<float_t> pfTexelAspect);

  /// @brief Method GetOverlayTexture, addr 0x4074f30, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureBounds, addr 0x4074920, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureColorSpace, addr 0x40748d8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureSize, addr 0x4074f90, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformAbsolute, addr 0x40749d4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformOverlayRelative, addr 0x4074a90, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceComponent, addr 0x4074a68, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceRelative, addr 0x4074a1c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformType, addr 0x407498c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayWidthInMeters, addr 0x407483c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayWidthInMeters(uint64_t ulOverlayHandle, ::ByRef<float_t> pfWidthInMeters);

  /// @brief Method GetPrimaryDashboardDevice, addr 0x40750a0, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetPrimaryDashboardDevice();

  /// @brief Method GetTransformForOverlayCoordinates, addr 0x4074b48, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HideKeyboard, addr 0x4075144, size 0x24, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method HideOverlay, addr 0x4074b00, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError HideOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsActiveDashboardOverlay, addr 0x407500c, size 0x24, virtual false, abstract: false, final false
  inline bool IsActiveDashboardOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsDashboardVisible, addr 0x4074fe8, size 0x24, virtual false, abstract: false, final false
  inline bool IsDashboardVisible();

  /// @brief Method IsHoverTargetOverlay, addr 0x4074da0, size 0x24, virtual false, abstract: false, final false
  inline bool IsHoverTargetOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsOverlayVisible, addr 0x4074b24, size 0x24, virtual false, abstract: false, final false
  inline bool IsOverlayVisible(uint64_t ulOverlayHandle);

  /// @brief Method MoveGamepadFocusToNeighbor, addr 0x4074e30, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PollNextOverlayEvent, addr 0x4074b6c, size 0x180, virtual false, abstract: false, final false
  inline bool PollNextOverlayEvent(uint64_t ulOverlayHandle, ::ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method ReleaseNativeOverlayHandle, addr 0x4074f6c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ReleaseNativeOverlayHandle(uint64_t ulOverlayHandle, ::System::IntPtr pNativeTextureHandle);

  /// @brief Method SetDashboardOverlaySceneProcess, addr 0x4075030, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, uint32_t unProcessId);

  /// @brief Method SetGamepadFocusOverlay, addr 0x4074de8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetGamepadFocusOverlay(uint64_t ulNewFocusOverlay);

  /// @brief Method SetHighQualityOverlay, addr 0x40744e4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetHighQualityOverlay(uint64_t ulOverlayHandle);

  /// @brief Method SetKeyboardPositionForOverlay, addr 0x407518c, size 0x24, virtual false, abstract: false, final false
  inline void SetKeyboardPositionForOverlay(uint64_t ulOverlayHandle, ::OVR::OpenVR::HmdRect2_t avoidRect);

  /// @brief Method SetKeyboardTransformAbsolute, addr 0x4075168, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayAlpha, addr 0x4074734, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayAlpha(uint64_t ulOverlayHandle, float_t fAlpha);

  /// @brief Method SetOverlayAutoCurveDistanceRangeInMeters, addr 0x4074864, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayColor, addr 0x40746e0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayColor(uint64_t ulOverlayHandle, float_t fRed, float_t fGreen, float_t fBlue);

  /// @brief Method SetOverlayDualAnalogTransform, addr 0x4074e54, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFlag, addr 0x4074690, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFromFile, addr 0x4074f0c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayFromFile(uint64_t ulOverlayHandle, ::StringW pchFilePath);

  /// @brief Method SetOverlayInputMethod, addr 0x4074d10, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayIntersectionMask, addr 0x40751b0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayMouseScale, addr 0x4074d58, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayName, addr 0x4074574, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayName(uint64_t ulOverlayHandle, ::StringW pchName);

  /// @brief Method SetOverlayNeighbor, addr 0x4074e0c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRaw, addr 0x4074ee8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderModel, addr 0x4074968, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderingPid, addr 0x4074648, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayRenderingPid(uint64_t ulOverlayHandle, uint32_t unPID);

  /// @brief Method SetOverlaySortOrder, addr 0x40747cc, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlaySortOrder(uint64_t ulOverlayHandle, uint32_t unSortOrder);

  /// @brief Method SetOverlayTexelAspect, addr 0x4074780, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexelAspect(uint64_t ulOverlayHandle, float_t fTexelAspect);

  /// @brief Method SetOverlayTexture, addr 0x4074ea0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexture(uint64_t ulOverlayHandle, ::ByRef<::OVR::OpenVR::Texture_t> pTexture);

  /// @brief Method SetOverlayTextureBounds, addr 0x40748fc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTextureColorSpace, addr 0x40748b4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformAbsolute, addr 0x40749b0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformOverlayRelative, addr 0x4074ab8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceComponent, addr 0x4074a44, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceRelative, addr 0x40749f8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayWidthInMeters, addr 0x4074818, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayWidthInMeters(uint64_t ulOverlayHandle, float_t fWidthInMeters);

  /// @brief Method ShowDashboard, addr 0x407507c, size 0x24, virtual false, abstract: false, final false
  inline void ShowDashboard(::StringW pchOverlayToShow);

  /// @brief Method ShowKeyboard, addr 0x40750c4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowKeyboardForOverlay, addr 0x40750f0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowMessageOverlay, addr 0x40751fc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowOverlay, addr 0x4074adc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x407435c, size 0x114, virtual false, abstract: false, final false
