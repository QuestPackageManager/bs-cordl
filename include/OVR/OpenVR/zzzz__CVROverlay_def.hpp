...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2bfd8fc, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2bfd9e4, size 0x2c, virtual true, abstract: false, final false
  inline bool EndInvoke(ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x2bfd8e8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bfd824, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearOverlayTexture, addr 0x2bfd4a4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ClearOverlayTexture(uint64_t ulOverlayHandle);

  /// @brief Method CloseMessageOverlay, addr 0x2bfd800, size 0x24, virtual false, abstract: false, final false
  inline void CloseMessageOverlay();

  /// @brief Method ComputeOverlayIntersection, addr 0x2bfd35c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDashboardOverlay, addr 0x2bfd59c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOverlay, addr 0x2bfca78, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyOverlay, addr 0x2bfcaa0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError DestroyOverlay(uint64_t ulOverlayHandle);

  /// @brief Method FindOverlay, addr 0x2bfca50, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError FindOverlay(::StringW pchOverlayKey, ByRef<uint64_t> pOverlayHandle);

  /// @brief Method GetDashboardOverlaySceneProcess, addr 0x2bfd634, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, ByRef<uint32_t> punProcessId);

  /// @brief Method GetGamepadFocusOverlay, addr 0x2bfd3a4, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetGamepadFocusOverlay();

  /// @brief Method GetHighQualityOverlay, addr 0x2bfcae8, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetHighQualityOverlay();

  /// @brief Method GetKeyboardText, addr 0x2bfd700, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetKeyboardText(::System::Text::StringBuilder* pchText, uint32_t cchText);

  /// @brief Method GetOverlayAlpha, addr 0x2bfcd38, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayAlpha(uint64_t ulOverlayHandle, ByRef<float_t> pfAlpha);

  /// @brief Method GetOverlayAutoCurveDistanceRangeInMeters, addr 0x2bfce68, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayColor, addr 0x2bfcce4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayDualAnalogTransform, addr 0x2bfd458, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayErrorNameFromEnum, addr 0x2bfcba4, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetOverlayErrorNameFromEnum(::OVR::OpenVR::EVROverlayError error);

  /// @brief Method GetOverlayFlag, addr 0x2bfcc98, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayFlags, addr 0x2bfd7b4, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayFlags(uint64_t ulOverlayHandle, ByRef<uint32_t> pFlags);

  /// @brief Method GetOverlayImageData, addr 0x2bfcb78, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayInputMethod, addr 0x2bfd2cc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayKey, addr 0x2bfcb0c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayMouseScale, addr 0x2bfd314, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayName, addr 0x2bfcb30, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderModel, addr 0x2bfcf24, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderingPid, addr 0x2bfcc4c, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetOverlayRenderingPid(uint64_t ulOverlayHandle);

  /// @brief Method GetOverlaySortOrder, addr 0x2bfcdd0, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlaySortOrder(uint64_t ulOverlayHandle, ByRef<uint32_t> punSortOrder);

  /// @brief Method GetOverlayTexelAspect, addr 0x2bfcd84, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayTexelAspect(uint64_t ulOverlayHandle, ByRef<float_t> pfTexelAspect);

  /// @brief Method GetOverlayTexture, addr 0x2bfd510, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureBounds, addr 0x2bfcf00, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureColorSpace, addr 0x2bfceb8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureSize, addr 0x2bfd570, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformAbsolute, addr 0x2bfcfb4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformOverlayRelative, addr 0x2bfd070, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceComponent, addr 0x2bfd048, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceRelative, addr 0x2bfcffc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformType, addr 0x2bfcf6c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayWidthInMeters, addr 0x2bfce1c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayWidthInMeters(uint64_t ulOverlayHandle, ByRef<float_t> pfWidthInMeters);

  /// @brief Method GetPrimaryDashboardDevice, addr 0x2bfd680, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetPrimaryDashboardDevice();

  /// @brief Method GetTransformForOverlayCoordinates, addr 0x2bfd128, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HideKeyboard, addr 0x2bfd724, size 0x24, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method HideOverlay, addr 0x2bfd0e0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError HideOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsActiveDashboardOverlay, addr 0x2bfd5ec, size 0x24, virtual false, abstract: false, final false
  inline bool IsActiveDashboardOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsDashboardVisible, addr 0x2bfd5c8, size 0x24, virtual false, abstract: false, final false
  inline bool IsDashboardVisible();

  /// @brief Method IsHoverTargetOverlay, addr 0x2bfd380, size 0x24, virtual false, abstract: false, final false
  inline bool IsHoverTargetOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsOverlayVisible, addr 0x2bfd104, size 0x24, virtual false, abstract: false, final false
  inline bool IsOverlayVisible(uint64_t ulOverlayHandle);

  /// @brief Method MoveGamepadFocusToNeighbor, addr 0x2bfd410, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PollNextOverlayEvent, addr 0x2bfd14c, size 0x180, virtual false, abstract: false, final false
  inline bool PollNextOverlayEvent(uint64_t ulOverlayHandle, ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method ReleaseNativeOverlayHandle, addr 0x2bfd54c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ReleaseNativeOverlayHandle(uint64_t ulOverlayHandle, ::System::IntPtr pNativeTextureHandle);

  /// @brief Method SetDashboardOverlaySceneProcess, addr 0x2bfd610, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, uint32_t unProcessId);

  /// @brief Method SetGamepadFocusOverlay, addr 0x2bfd3c8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetGamepadFocusOverlay(uint64_t ulNewFocusOverlay);

  /// @brief Method SetHighQualityOverlay, addr 0x2bfcac4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetHighQualityOverlay(uint64_t ulOverlayHandle);

  /// @brief Method SetKeyboardPositionForOverlay, addr 0x2bfd76c, size 0x24, virtual false, abstract: false, final false
  inline void SetKeyboardPositionForOverlay(uint64_t ulOverlayHandle, ::OVR::OpenVR::HmdRect2_t avoidRect);

  /// @brief Method SetKeyboardTransformAbsolute, addr 0x2bfd748, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayAlpha, addr 0x2bfcd14, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayAlpha(uint64_t ulOverlayHandle, float_t fAlpha);

  /// @brief Method SetOverlayAutoCurveDistanceRangeInMeters, addr 0x2bfce44, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayColor, addr 0x2bfccc0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayColor(uint64_t ulOverlayHandle, float_t fRed, float_t fGreen, float_t fBlue);

  /// @brief Method SetOverlayDualAnalogTransform, addr 0x2bfd434, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFlag, addr 0x2bfcc70, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFromFile, addr 0x2bfd4ec, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayFromFile(uint64_t ulOverlayHandle, ::StringW pchFilePath);

  /// @brief Method SetOverlayInputMethod, addr 0x2bfd2f0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayIntersectionMask, addr 0x2bfd790, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayMouseScale, addr 0x2bfd338, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayName, addr 0x2bfcb54, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayName(uint64_t ulOverlayHandle, ::StringW pchName);

  /// @brief Method SetOverlayNeighbor, addr 0x2bfd3ec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRaw, addr 0x2bfd4c8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderModel, addr 0x2bfcf48, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderingPid, addr 0x2bfcc28, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayRenderingPid(uint64_t ulOverlayHandle, uint32_t unPID);

  /// @brief Method SetOverlaySortOrder, addr 0x2bfcdac, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlaySortOrder(uint64_t ulOverlayHandle, uint32_t unSortOrder);

  /// @brief Method SetOverlayTexelAspect, addr 0x2bfcd60, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexelAspect(uint64_t ulOverlayHandle, float_t fTexelAspect);

  /// @brief Method SetOverlayTexture, addr 0x2bfd480, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexture(uint64_t ulOverlayHandle, ByRef<::OVR::OpenVR::Texture_t> pTexture);

  /// @brief Method SetOverlayTextureBounds, addr 0x2bfcedc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTextureColorSpace, addr 0x2bfce94, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformAbsolute, addr 0x2bfcf90, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformOverlayRelative, addr 0x2bfd098, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceComponent, addr 0x2bfd024, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceRelative, addr 0x2bfcfd8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayWidthInMeters, addr 0x2bfcdf8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayWidthInMeters(uint64_t ulOverlayHandle, float_t fWidthInMeters);

  /// @brief Method ShowDashboard, addr 0x2bfd65c, size 0x24, virtual false, abstract: false, final false
  inline void ShowDashboard(::StringW pchOverlayToShow);

  /// @brief Method ShowKeyboard, addr 0x2bfd6a4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowKeyboardForOverlay, addr 0x2bfd6d0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowMessageOverlay, addr 0x2bfd7dc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowOverlay, addr 0x2bfd0bc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bfc93c, size 0x114, virtual false, abstract: false, final false
