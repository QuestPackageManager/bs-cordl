...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x4073974, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x4073a60, size 0x2c, virtual true, abstract: false, final false
  inline bool EndInvoke(::ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x4073960, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40738d4, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearOverlayTexture, addr 0x4073554, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ClearOverlayTexture(uint64_t ulOverlayHandle);

  /// @brief Method CloseMessageOverlay, addr 0x40738b0, size 0x24, virtual false, abstract: false, final false
  inline void CloseMessageOverlay();

  /// @brief Method ComputeOverlayIntersection, addr 0x407340c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDashboardOverlay, addr 0x407364c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOverlay, addr 0x4072b28, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyOverlay, addr 0x4072b50, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError DestroyOverlay(uint64_t ulOverlayHandle);

  /// @brief Method FindOverlay, addr 0x4072b00, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError FindOverlay(::StringW pchOverlayKey, ::ByRef<uint64_t> pOverlayHandle);

  /// @brief Method GetDashboardOverlaySceneProcess, addr 0x40736e4, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, ::ByRef<uint32_t> punProcessId);

  /// @brief Method GetGamepadFocusOverlay, addr 0x4073454, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetGamepadFocusOverlay();

  /// @brief Method GetHighQualityOverlay, addr 0x4072b98, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetHighQualityOverlay();

  /// @brief Method GetKeyboardText, addr 0x40737b0, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetKeyboardText(::System::Text::StringBuilder* pchText, uint32_t cchText);

  /// @brief Method GetOverlayAlpha, addr 0x4072de8, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayAlpha(uint64_t ulOverlayHandle, ::ByRef<float_t> pfAlpha);

  /// @brief Method GetOverlayAutoCurveDistanceRangeInMeters, addr 0x4072f18, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayColor, addr 0x4072d94, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayDualAnalogTransform, addr 0x4073508, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayErrorNameFromEnum, addr 0x4072c54, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetOverlayErrorNameFromEnum(::OVR::OpenVR::EVROverlayError error);

  /// @brief Method GetOverlayFlag, addr 0x4072d48, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayFlags, addr 0x4073864, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayFlags(uint64_t ulOverlayHandle, ::ByRef<uint32_t> pFlags);

  /// @brief Method GetOverlayImageData, addr 0x4072c28, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayInputMethod, addr 0x407337c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayKey, addr 0x4072bbc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayMouseScale, addr 0x40733c4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayName, addr 0x4072be0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderModel, addr 0x4072fd4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderingPid, addr 0x4072cfc, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetOverlayRenderingPid(uint64_t ulOverlayHandle);

  /// @brief Method GetOverlaySortOrder, addr 0x4072e80, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlaySortOrder(uint64_t ulOverlayHandle, ::ByRef<uint32_t> punSortOrder);

  /// @brief Method GetOverlayTexelAspect, addr 0x4072e34, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayTexelAspect(uint64_t ulOverlayHandle, ::ByRef<float_t> pfTexelAspect);

  /// @brief Method GetOverlayTexture, addr 0x40735c0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureBounds, addr 0x4072fb0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureColorSpace, addr 0x4072f68, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureSize, addr 0x4073620, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformAbsolute, addr 0x4073064, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformOverlayRelative, addr 0x4073120, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceComponent, addr 0x40730f8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceRelative, addr 0x40730ac, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformType, addr 0x407301c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayWidthInMeters, addr 0x4072ecc, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayWidthInMeters(uint64_t ulOverlayHandle, ::ByRef<float_t> pfWidthInMeters);

  /// @brief Method GetPrimaryDashboardDevice, addr 0x4073730, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetPrimaryDashboardDevice();

  /// @brief Method GetTransformForOverlayCoordinates, addr 0x40731d8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HideKeyboard, addr 0x40737d4, size 0x24, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method HideOverlay, addr 0x4073190, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError HideOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsActiveDashboardOverlay, addr 0x407369c, size 0x24, virtual false, abstract: false, final false
  inline bool IsActiveDashboardOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsDashboardVisible, addr 0x4073678, size 0x24, virtual false, abstract: false, final false
  inline bool IsDashboardVisible();

  /// @brief Method IsHoverTargetOverlay, addr 0x4073430, size 0x24, virtual false, abstract: false, final false
  inline bool IsHoverTargetOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsOverlayVisible, addr 0x40731b4, size 0x24, virtual false, abstract: false, final false
  inline bool IsOverlayVisible(uint64_t ulOverlayHandle);

  /// @brief Method MoveGamepadFocusToNeighbor, addr 0x40734c0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PollNextOverlayEvent, addr 0x40731fc, size 0x180, virtual false, abstract: false, final false
  inline bool PollNextOverlayEvent(uint64_t ulOverlayHandle, ::ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method ReleaseNativeOverlayHandle, addr 0x40735fc, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ReleaseNativeOverlayHandle(uint64_t ulOverlayHandle, ::System::IntPtr pNativeTextureHandle);

  /// @brief Method SetDashboardOverlaySceneProcess, addr 0x40736c0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, uint32_t unProcessId);

  /// @brief Method SetGamepadFocusOverlay, addr 0x4073478, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetGamepadFocusOverlay(uint64_t ulNewFocusOverlay);

  /// @brief Method SetHighQualityOverlay, addr 0x4072b74, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetHighQualityOverlay(uint64_t ulOverlayHandle);

  /// @brief Method SetKeyboardPositionForOverlay, addr 0x407381c, size 0x24, virtual false, abstract: false, final false
  inline void SetKeyboardPositionForOverlay(uint64_t ulOverlayHandle, ::OVR::OpenVR::HmdRect2_t avoidRect);

  /// @brief Method SetKeyboardTransformAbsolute, addr 0x40737f8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayAlpha, addr 0x4072dc4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayAlpha(uint64_t ulOverlayHandle, float_t fAlpha);

  /// @brief Method SetOverlayAutoCurveDistanceRangeInMeters, addr 0x4072ef4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayColor, addr 0x4072d70, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayColor(uint64_t ulOverlayHandle, float_t fRed, float_t fGreen, float_t fBlue);

  /// @brief Method SetOverlayDualAnalogTransform, addr 0x40734e4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFlag, addr 0x4072d20, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFromFile, addr 0x407359c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayFromFile(uint64_t ulOverlayHandle, ::StringW pchFilePath);

  /// @brief Method SetOverlayInputMethod, addr 0x40733a0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayIntersectionMask, addr 0x4073840, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayMouseScale, addr 0x40733e8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayName, addr 0x4072c04, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayName(uint64_t ulOverlayHandle, ::StringW pchName);

  /// @brief Method SetOverlayNeighbor, addr 0x407349c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRaw, addr 0x4073578, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderModel, addr 0x4072ff8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderingPid, addr 0x4072cd8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayRenderingPid(uint64_t ulOverlayHandle, uint32_t unPID);

  /// @brief Method SetOverlaySortOrder, addr 0x4072e5c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlaySortOrder(uint64_t ulOverlayHandle, uint32_t unSortOrder);

  /// @brief Method SetOverlayTexelAspect, addr 0x4072e10, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexelAspect(uint64_t ulOverlayHandle, float_t fTexelAspect);

  /// @brief Method SetOverlayTexture, addr 0x4073530, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexture(uint64_t ulOverlayHandle, ::ByRef<::OVR::OpenVR::Texture_t> pTexture);

  /// @brief Method SetOverlayTextureBounds, addr 0x4072f8c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTextureColorSpace, addr 0x4072f44, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformAbsolute, addr 0x4073040, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformOverlayRelative, addr 0x4073148, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceComponent, addr 0x40730d4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceRelative, addr 0x4073088, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayWidthInMeters, addr 0x4072ea8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayWidthInMeters(uint64_t ulOverlayHandle, float_t fWidthInMeters);

  /// @brief Method ShowDashboard, addr 0x407370c, size 0x24, virtual false, abstract: false, final false
  inline void ShowDashboard(::StringW pchOverlayToShow);

  /// @brief Method ShowKeyboard, addr 0x4073754, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowKeyboardForOverlay, addr 0x4073780, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowMessageOverlay, addr 0x407388c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowOverlay, addr 0x407316c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40729ec, size 0x114, virtual false, abstract: false, final false
