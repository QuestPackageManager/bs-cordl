...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x4076bd8, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x4076cc4, size 0x2c, virtual true, abstract: false, final false
  inline bool EndInvoke(::ByRef<::OVR::OpenVR::VREvent_t_Packed> pEvent, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x4076bc4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4076b38, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearOverlayTexture, addr 0x40767b8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ClearOverlayTexture(uint64_t ulOverlayHandle);

  /// @brief Method CloseMessageOverlay, addr 0x4076b14, size 0x24, virtual false, abstract: false, final false
  inline void CloseMessageOverlay();

  /// @brief Method ComputeOverlayIntersection, addr 0x4076670, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDashboardOverlay, addr 0x40768b0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOverlay, addr 0x4075d8c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyOverlay, addr 0x4075db4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError DestroyOverlay(uint64_t ulOverlayHandle);

  /// @brief Method FindOverlay, addr 0x4075d64, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError FindOverlay(::StringW pchOverlayKey, ::ByRef<uint64_t> pOverlayHandle);

  /// @brief Method GetDashboardOverlaySceneProcess, addr 0x4076948, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, ::ByRef<uint32_t> punProcessId);

  /// @brief Method GetGamepadFocusOverlay, addr 0x40766b8, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetGamepadFocusOverlay();

  /// @brief Method GetHighQualityOverlay, addr 0x4075dfc, size 0x24, virtual false, abstract: false, final false
  inline uint64_t GetHighQualityOverlay();

  /// @brief Method GetKeyboardText, addr 0x4076a14, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetKeyboardText(::System::Text::StringBuilder* pchText, uint32_t cchText);

  /// @brief Method GetOverlayAlpha, addr 0x407604c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayAlpha(uint64_t ulOverlayHandle, ::ByRef<float_t> pfAlpha);

  /// @brief Method GetOverlayAutoCurveDistanceRangeInMeters, addr 0x407617c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayColor, addr 0x4075ff8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayDualAnalogTransform, addr 0x407676c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayErrorNameFromEnum, addr 0x4075eb8, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetOverlayErrorNameFromEnum(::OVR::OpenVR::EVROverlayError error);

  /// @brief Method GetOverlayFlag, addr 0x4075fac, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayFlags, addr 0x4076ac8, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayFlags(uint64_t ulOverlayHandle, ::ByRef<uint32_t> pFlags);

  /// @brief Method GetOverlayImageData, addr 0x4075e8c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayInputMethod, addr 0x40765e0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayKey, addr 0x4075e20, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayMouseScale, addr 0x4076628, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayName, addr 0x4075e44, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderModel, addr 0x4076238, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayRenderingPid, addr 0x4075f60, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetOverlayRenderingPid(uint64_t ulOverlayHandle);

  /// @brief Method GetOverlaySortOrder, addr 0x40760e4, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlaySortOrder(uint64_t ulOverlayHandle, ::ByRef<uint32_t> punSortOrder);

  /// @brief Method GetOverlayTexelAspect, addr 0x4076098, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayTexelAspect(uint64_t ulOverlayHandle, ::ByRef<float_t> pfTexelAspect);

  /// @brief Method GetOverlayTexture, addr 0x4076824, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureBounds, addr 0x4076214, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureColorSpace, addr 0x40761cc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTextureSize, addr 0x4076884, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformAbsolute, addr 0x40762c8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformOverlayRelative, addr 0x4076384, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceComponent, addr 0x407635c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformTrackedDeviceRelative, addr 0x4076310, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayTransformType, addr 0x4076280, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOverlayWidthInMeters, addr 0x4076130, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError GetOverlayWidthInMeters(uint64_t ulOverlayHandle, ::ByRef<float_t> pfWidthInMeters);

  /// @brief Method GetPrimaryDashboardDevice, addr 0x4076994, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetPrimaryDashboardDevice();

  /// @brief Method GetTransformForOverlayCoordinates, addr 0x407643c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HideKeyboard, addr 0x4076a38, size 0x24, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method HideOverlay, addr 0x40763f4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError HideOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsActiveDashboardOverlay, addr 0x4076900, size 0x24, virtual false, abstract: false, final false
  inline bool IsActiveDashboardOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsDashboardVisible, addr 0x40768dc, size 0x24, virtual false, abstract: false, final false
  inline bool IsDashboardVisible();

  /// @brief Method IsHoverTargetOverlay, addr 0x4076694, size 0x24, virtual false, abstract: false, final false
  inline bool IsHoverTargetOverlay(uint64_t ulOverlayHandle);

  /// @brief Method IsOverlayVisible, addr 0x4076418, size 0x24, virtual false, abstract: false, final false
  inline bool IsOverlayVisible(uint64_t ulOverlayHandle);

  /// @brief Method MoveGamepadFocusToNeighbor, addr 0x4076724, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PollNextOverlayEvent, addr 0x4076460, size 0x180, virtual false, abstract: false, final false
  inline bool PollNextOverlayEvent(uint64_t ulOverlayHandle, ::ByRef<::OVR::OpenVR::VREvent_t> pEvent, uint32_t uncbVREvent);

  /// @brief Method ReleaseNativeOverlayHandle, addr 0x4076860, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError ReleaseNativeOverlayHandle(uint64_t ulOverlayHandle, ::System::IntPtr pNativeTextureHandle);

  /// @brief Method SetDashboardOverlaySceneProcess, addr 0x4076924, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetDashboardOverlaySceneProcess(uint64_t ulOverlayHandle, uint32_t unProcessId);

  /// @brief Method SetGamepadFocusOverlay, addr 0x40766dc, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetGamepadFocusOverlay(uint64_t ulNewFocusOverlay);

  /// @brief Method SetHighQualityOverlay, addr 0x4075dd8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetHighQualityOverlay(uint64_t ulOverlayHandle);

  /// @brief Method SetKeyboardPositionForOverlay, addr 0x4076a80, size 0x24, virtual false, abstract: false, final false
  inline void SetKeyboardPositionForOverlay(uint64_t ulOverlayHandle, ::OVR::OpenVR::HmdRect2_t avoidRect);

  /// @brief Method SetKeyboardTransformAbsolute, addr 0x4076a5c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayAlpha, addr 0x4076028, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayAlpha(uint64_t ulOverlayHandle, float_t fAlpha);

  /// @brief Method SetOverlayAutoCurveDistanceRangeInMeters, addr 0x4076158, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayColor, addr 0x4075fd4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayColor(uint64_t ulOverlayHandle, float_t fRed, float_t fGreen, float_t fBlue);

  /// @brief Method SetOverlayDualAnalogTransform, addr 0x4076748, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFlag, addr 0x4075f84, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayFromFile, addr 0x4076800, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayFromFile(uint64_t ulOverlayHandle, ::StringW pchFilePath);

  /// @brief Method SetOverlayInputMethod, addr 0x4076604, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayIntersectionMask, addr 0x4076aa4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayMouseScale, addr 0x407664c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayName, addr 0x4075e68, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayName(uint64_t ulOverlayHandle, ::StringW pchName);

  /// @brief Method SetOverlayNeighbor, addr 0x4076700, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRaw, addr 0x40767dc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderModel, addr 0x407625c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayRenderingPid, addr 0x4075f3c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayRenderingPid(uint64_t ulOverlayHandle, uint32_t unPID);

  /// @brief Method SetOverlaySortOrder, addr 0x40760c0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlaySortOrder(uint64_t ulOverlayHandle, uint32_t unSortOrder);

  /// @brief Method SetOverlayTexelAspect, addr 0x4076074, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexelAspect(uint64_t ulOverlayHandle, float_t fTexelAspect);

  /// @brief Method SetOverlayTexture, addr 0x4076794, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayTexture(uint64_t ulOverlayHandle, ::ByRef<::OVR::OpenVR::Texture_t> pTexture);

  /// @brief Method SetOverlayTextureBounds, addr 0x40761f0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTextureColorSpace, addr 0x40761a8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformAbsolute, addr 0x40762a4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformOverlayRelative, addr 0x40763ac, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceComponent, addr 0x4076338, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayTransformTrackedDeviceRelative, addr 0x40762ec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOverlayWidthInMeters, addr 0x407610c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVROverlayError SetOverlayWidthInMeters(uint64_t ulOverlayHandle, float_t fWidthInMeters);

  /// @brief Method ShowDashboard, addr 0x4076970, size 0x24, virtual false, abstract: false, final false
  inline void ShowDashboard(::StringW pchOverlayToShow);

  /// @brief Method ShowKeyboard, addr 0x40769b8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowKeyboardForOverlay, addr 0x40769e4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowMessageOverlay, addr 0x4076af0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowOverlay, addr 0x40763d0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4075c50, size 0x114, virtual false, abstract: false, final false
