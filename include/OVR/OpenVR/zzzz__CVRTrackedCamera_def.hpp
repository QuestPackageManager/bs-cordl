...
public:
  ...
  /// @brief Method AcquireVideoStreamingService, addr 0x5c2f15c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRTrackedCameraError AcquireVideoStreamingService(uint32_t nDeviceIndex, ::ByRef<uint64_t> pHandle);

  /// @brief Method GetCameraErrorNameFromEnum, addr 0x5c2f040, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW GetCameraErrorNameFromEnum(::OVR::OpenVR::EVRTrackedCameraError eCameraError);

  /// @brief Method GetCameraFrameSize, addr 0x5c2f0f0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCameraIntrinsics, addr 0x5c2f11c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCameraProjection, addr 0x5c2f13c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVideoStreamFrameBuffer, addr 0x5c2f1a0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVideoStreamTextureD3D11, addr 0x5c2f1e8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVideoStreamTextureGL, addr 0x5c2f208, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVideoStreamTextureSize, addr 0x5c2f1c0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method HasCamera, addr 0x5c2f0cc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseVideoStreamTextureGL, addr 0x5c2f22c, size 0x20, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRTrackedCameraError ReleaseVideoStreamTextureGL(uint64_t hTrackedCamera, uint32_t glTextureId);

  /// @brief Method ReleaseVideoStreamingService, addr 0x5c2f180, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c2ef40, size 0x100, virtual false, abstract: false, final false
