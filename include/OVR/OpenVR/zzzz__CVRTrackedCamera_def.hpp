...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(9050))}
...
public:
  ...
  /// @brief Method .ctor addr 0x267affc size 0x114 virtual false final false
  inline void _ctor(void* pInterface);

  /// @brief Method GetCameraErrorNameFromEnum addr 0x267b110 size 0x84 virtual false final false
  inline ::StringW GetCameraErrorNameFromEnum(::OVR::OpenVR::EVRTrackedCameraError eCameraError);

  /// @brief Method HasCamera addr 0x267b194 size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRTrackedCameraError HasCamera(uint32_t nDeviceIndex, ByRef<bool> pHasCamera);

  /// @brief Method GetCameraFrameSize addr 0x267b1bc size 0x30 virtual false final false
  ...
  /// @brief Method GetCameraIntrinsics addr 0x267b1ec size 0x24 virtual false final false
  ...
  /// @brief Method GetCameraProjection addr 0x267b210 size 0x24 virtual false final false
  ...
  /// @brief Method AcquireVideoStreamingService addr 0x267b234 size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRTrackedCameraError AcquireVideoStreamingService(uint32_t nDeviceIndex, ByRef<uint64_t> pHandle);

  /// @brief Method ReleaseVideoStreamingService addr 0x267b25c size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRTrackedCameraError ReleaseVideoStreamingService(uint64_t hTrackedCamera);

  /// @brief Method GetVideoStreamFrameBuffer addr 0x267b280 size 0x24 virtual false final false
  ...
  /// @brief Method GetVideoStreamTextureSize addr 0x267b2a4 size 0x2c virtual false final false
  ...
  /// @brief Method GetVideoStreamTextureD3D11 addr 0x267b2d0 size 0x24 virtual false final false
  ...
  /// @brief Method GetVideoStreamTextureGL addr 0x267b2f4 size 0x28 virtual false final false
  ...
  /// @brief Method ReleaseVideoStreamTextureGL addr 0x267b31c size 0x24 virtual false final false
