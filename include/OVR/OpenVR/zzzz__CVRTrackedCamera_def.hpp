...
public:
  ...
  /// @brief Method AcquireVideoStreamingService, addr 0x408019c, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRTrackedCameraError AcquireVideoStreamingService(uint32_t nDeviceIndex, ::ByRef<uint64_t> pHandle);

  /// @brief Method GetCameraErrorNameFromEnum, addr 0x4080078, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetCameraErrorNameFromEnum(::OVR::OpenVR::EVRTrackedCameraError eCameraError);

  /// @brief Method GetCameraFrameSize, addr 0x4080124, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCameraIntrinsics, addr 0x4080154, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCameraProjection, addr 0x4080178, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVideoStreamFrameBuffer, addr 0x40801e8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVideoStreamTextureD3D11, addr 0x4080238, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVideoStreamTextureGL, addr 0x408025c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVideoStreamTextureSize, addr 0x408020c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method HasCamera, addr 0x40800fc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseVideoStreamTextureGL, addr 0x4080284, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRTrackedCameraError ReleaseVideoStreamTextureGL(uint64_t hTrackedCamera, uint32_t glTextureId);

  /// @brief Method ReleaseVideoStreamingService, addr 0x40801c4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x407ff64, size 0x114, virtual false, abstract: false, final false
