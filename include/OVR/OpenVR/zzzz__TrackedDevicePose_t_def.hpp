...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::TrackedDevicePose_t, "OVR.OpenVR", "TrackedDevicePose_t");
...
static_assert(sizeof(::OVR::OpenVR::TrackedDevicePose_t) == 0x50, "Size mismatch!");
