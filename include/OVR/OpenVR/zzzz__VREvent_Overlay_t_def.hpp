...
public:
  ...
  // Ctor Parameters [CppParam { name: "overlayHandle", ty: "uint64_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "devicePath", ty: "uint64_t", modifiers: "", def_value: None,
  // comment: None }]
