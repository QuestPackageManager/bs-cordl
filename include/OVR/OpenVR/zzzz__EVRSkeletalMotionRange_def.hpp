...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRSkeletalMotionRange, "OVR.OpenVR", "EVRSkeletalMotionRange");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRSkeletalMotionRange) == 0x4, "Size mismatch!");
