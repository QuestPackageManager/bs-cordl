...
// Ctor Parameters [CppParam { name: "vPosition", ty: "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vNormal", ty:
// "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "rfTextureCoord0", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "rfTextureCoord1", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }]
