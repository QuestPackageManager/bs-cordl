...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRScreenshotPropertyFilenames, "OVR.OpenVR", "EVRScreenshotPropertyFilenames");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRScreenshotPropertyFilenames) == 0x4, "Size mismatch!");
