...
// Ctor Parameters [CppParam { name: "containerHandle", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "componentHandle", ty: "uint64_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "fDurationSeconds", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "fFrequency", ty: "float_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "fAmplitude", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }]
