...
// Ctor Parameters [CppParam { name: "m_pSettings", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }]
constexpr ::OVR::OpenVR::CVRSettingHelper::CVRSettingHelper(::System::IntPtr m_pSettings) noexcept {
