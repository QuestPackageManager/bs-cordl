...
// Ctor Parameters [CppParam { name: "m_nPreviousUniverse", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_nCurrentUniverse", ty: "uint64_t", modifiers: "",
