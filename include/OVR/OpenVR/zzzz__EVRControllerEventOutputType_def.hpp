...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRControllerEventOutputType, "OVR.OpenVR", "EVRControllerEventOutputType");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
public:
  ...
  /// @brief Field ControllerEventOutput_OSEvents value: I32(0)
  static ::OVR::OpenVR::EVRControllerEventOutputType const ControllerEventOutput_OSEvents;

  /// @brief Field ControllerEventOutput_VREvents value: I32(1)
...
static_assert(sizeof(::OVR::OpenVR::EVRControllerEventOutputType) == 0x4, "Size mismatch!");
