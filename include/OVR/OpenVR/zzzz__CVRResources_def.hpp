...
public:
  ...
  /// @brief Method .ctor, addr 0x27f579c, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method LoadSharedResource, addr 0x27f58a8, size 0x24, virtual false, abstract: false, final false
  inline uint32_t LoadSharedResource(::StringW pchResourceName, ::StringW pchBuffer, uint32_t unBufferLen);

  /// @brief Method GetResourceFullPath, addr 0x27f58cc, size 0x24, virtual false, abstract: false, final false
