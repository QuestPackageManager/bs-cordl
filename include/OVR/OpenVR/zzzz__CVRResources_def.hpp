...
// Write type traits
MARK_REF_T(::OVR::OpenVR::CVRResources*);
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::CVRResources*, "OVR.OpenVR", "CVRResources");
...
public:
  ...
  /// @brief Method GetResourceFullPath, addr 0x5e47350, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSharedResource, addr 0x5e47330, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4723c, size 0xf4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CVRResources", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CVRResources(CVRResources&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CVRResources", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CVRResources(CVRResourcesconst&) = delete;
...
static_assert(sizeof(::OVR::OpenVR::CVRResources) == 0x20, "Size mismatch!");
