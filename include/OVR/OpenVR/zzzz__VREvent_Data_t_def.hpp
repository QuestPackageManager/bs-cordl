...
// Dependencies OVR.OpenVR.VREvent_ApplicationLaunch_t, OVR.OpenVR.VREvent_Chaperone_t, OVR.OpenVR.VREvent_Controller_t, OVR.OpenVR.VREvent_DualAnalog_t, OVR.OpenVR.VREvent_EditingCameraSurface_t, OVR.OpenVR.VREvent_HapticVibration_t, OVR.OpenVR.VREvent_InputBindingLoad_t, OVR.OpenVR.VREvent_Ipd_t, OVR.OpenVR.VREvent_Keyboard_t, OVR.OpenVR.VREvent_MessageOverlay_t, OVR.OpenVR.VREvent_Mouse_t, OVR.OpenVR.VREvent_Notification_t, OVR.OpenVR.VREvent_Overlay_t, OVR.OpenVR.VREvent_PerformanceTest_t, OVR.OpenVR.VREvent_Process_t, OVR.OpenVR.VREvent_Property_t, OVR.OpenVR.VREvent_Reserved_t, OVR.OpenVR.VREvent_ScreenshotProgress_t, OVR.OpenVR.VREvent_Screenshot_t, OVR.OpenVR.VREvent_Scroll_t, OVR.OpenVR.VREvent_SeatedZeroPoseReset_t, OVR.OpenVR.VREvent_SpatialAnchor_t, OVR.OpenVR.VREvent_Status_t, OVR.OpenVR.VREvent_TouchPadMove_t, OVR.OpenVR.VREvent_WebConsole_t
namespace OVR::OpenVR {
// Is value type: true
