...
public:
  ...
  // Ctor Parameters [CppParam { name: "reserved", ty: "::OVR::OpenVR::VREvent_Reserved_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "controller", ty:
  // "::OVR::OpenVR::VREvent_Controller_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "mouse", ty: "::OVR::OpenVR::VREvent_Mouse_t", modifiers: "", def_value: None, comment:
  // None }, CppParam { name: "scroll", ty: "::OVR::OpenVR::VREvent_Scroll_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "process", ty: "::OVR::OpenVR::VREvent_Process_t",
  // modifiers: "", def_value: None, comment: None }, CppParam { name: "notification", ty: "::OVR::OpenVR::VREvent_Notification_t", modifiers: "", def_value: None, comment: None }, CppParam { name:
  // "overlay", ty: "::OVR::OpenVR::VREvent_Overlay_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "status", ty: "::OVR::OpenVR::VREvent_Status_t", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "ipd", ty: "::OVR::OpenVR::VREvent_Ipd_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "chaperone", ty:
  // "::OVR::OpenVR::VREvent_Chaperone_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "performanceTest", ty: "::OVR::OpenVR::VREvent_PerformanceTest_t", modifiers: "",
  // def_value: None, comment: None }, CppParam { name: "touchPadMove", ty: "::OVR::OpenVR::VREvent_TouchPadMove_t", modifiers: "", def_value: None, comment: None }, CppParam { name:
  // "seatedZeroPoseReset", ty: "::OVR::OpenVR::VREvent_SeatedZeroPoseReset_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "screenshot", ty:
  // "::OVR::OpenVR::VREvent_Screenshot_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "screenshotProgress", ty: "::OVR::OpenVR::VREvent_ScreenshotProgress_t", modifiers: "",
  // def_value: None, comment: None }, CppParam { name: "applicationLaunch", ty: "::OVR::OpenVR::VREvent_ApplicationLaunch_t", modifiers: "", def_value: None, comment: None }, CppParam { name:
  // "cameraSurface", ty: "::OVR::OpenVR::VREvent_EditingCameraSurface_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "messageOverlay", ty:
  // "::OVR::OpenVR::VREvent_MessageOverlay_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "property", ty: "::OVR::OpenVR::VREvent_Property_t", modifiers: "", def_value: None,
  // comment: None }, CppParam { name: "dualAnalog", ty: "::OVR::OpenVR::VREvent_DualAnalog_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "hapticVibration", ty:
  // "::OVR::OpenVR::VREvent_HapticVibration_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "webConsole", ty: "::OVR::OpenVR::VREvent_WebConsole_t", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "inputBinding", ty: "::OVR::OpenVR::VREvent_InputBindingLoad_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "spatialAnchor", ty:
  // "::OVR::OpenVR::VREvent_SpatialAnchor_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "keyboard", ty: "::OVR::OpenVR::VREvent_Keyboard_t", modifiers: "", def_value: None,
  // comment: None }]
