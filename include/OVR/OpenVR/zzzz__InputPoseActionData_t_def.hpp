...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::InputPoseActionData_t, "OVR.OpenVR", "InputPoseActionData_t");
...
static_assert(sizeof(::OVR::OpenVR::InputPoseActionData_t) == 0x60, "Size mismatch!");
