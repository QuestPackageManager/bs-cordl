...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::ETrackedPropertyError, "OVR.OpenVR", "ETrackedPropertyError");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::ETrackedPropertyError) == 0x4, "Size mismatch!");
