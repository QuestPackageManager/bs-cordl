...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VRTextureWithPose_t, "OVR.OpenVR", "VRTextureWithPose_t");
...
public:
  ...
  // Ctor Parameters [CppParam { name: "mDeviceToAbsoluteTracking", ty: "::OVR::OpenVR::HmdMatrix34_t", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::OVR::OpenVR::VRTextureWithPose_t) == 0x30, "Size mismatch!");
