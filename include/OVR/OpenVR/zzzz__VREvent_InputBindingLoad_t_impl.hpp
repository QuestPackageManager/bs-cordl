...
// Ctor Parameters [CppParam { name: "ulAppContainer", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "pathMessage", ty: "uint64_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "pathUrl", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "pathControllerType", ty: "uint64_t", modifiers: "",
