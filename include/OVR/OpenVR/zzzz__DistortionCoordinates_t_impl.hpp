...
// Ctor Parameters [CppParam { name: "rfRed0", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "rfRed1", ty: "float_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "rfGreen0", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "rfGreen1", ty: "float_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "rfBlue0", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "rfBlue1", ty: "float_t", modifiers: "", def_value: Some("{}"),
// comment: None }]
