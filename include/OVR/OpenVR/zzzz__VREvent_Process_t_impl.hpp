...
// Ctor Parameters [CppParam { name: "pid", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "oldPid", ty: "uint32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "bForced", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }]
