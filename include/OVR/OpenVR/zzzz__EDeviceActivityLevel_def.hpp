...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EDeviceActivityLevel, "OVR.OpenVR", "EDeviceActivityLevel");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EDeviceActivityLevel) == 0x4, "Size mismatch!");
