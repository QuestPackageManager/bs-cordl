...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VROverlayIntersectionMaskPrimitive_Data_t, "OVR.OpenVR", "VROverlayIntersectionMaskPrimitive_Data_t");
...
static_assert(sizeof(::OVR::OpenVR::VROverlayIntersectionMaskPrimitive_Data_t) == 0x10, "Size mismatch!");
