...
// Ctor Parameters [CppParam { name: "overlayHandle", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "devicePath", ty: "uint64_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
