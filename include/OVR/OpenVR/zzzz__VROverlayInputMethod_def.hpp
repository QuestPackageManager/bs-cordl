...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VROverlayInputMethod, "OVR.OpenVR", "VROverlayInputMethod");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VROverlayInputMethod) == 0x4, "Size mismatch!");
