...
// Ctor Parameters [CppParam { name: "ulUserValue", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "notificationId", ty: "uint32_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
