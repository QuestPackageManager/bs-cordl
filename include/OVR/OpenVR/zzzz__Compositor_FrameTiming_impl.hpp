...
// Ctor Parameters [CppParam { name: "m_nSize", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_nFrameIndex", ty: "uint32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "m_nNumFramePresents", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_nNumMisPresented", ty: "uint32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_nNumDroppedFrames", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "m_nReprojectionFlags", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flSystemTimeInSeconds", ty: "double_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "m_flPreSubmitGpuMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flPostSubmitGpuMs", ty: "float_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "m_flTotalRenderGpuMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flCompositorRenderGpuMs",
// ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flCompositorRenderCpuMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "m_flCompositorIdleCpuMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flClientFrameIntervalMs", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "m_flPresentCallCpuMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flWaitForPresentCpuMs", ty:
// "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flSubmitFrameMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "m_flWaitGetPosesCalledMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flNewPosesReadyMs", ty: "float_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "m_flNewFrameReadyMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flCompositorUpdateStartMs", ty: "float_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_flCompositorUpdateEndMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "m_flCompositorRenderStartMs", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_HmdPose", ty: "::OVR::OpenVR::TrackedDevicePose_t", modifiers: "",
