...
// Ctor Parameters [CppParam { name: "position", ty: "::OVR::OpenVR::HmdVector4_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "orientation", ty:
// "::OVR::OpenVR::HmdQuaternionf_t", modifiers: "", def_value: Some("{}"), comment: None }]
