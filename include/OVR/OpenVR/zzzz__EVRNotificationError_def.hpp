...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EVRNotificationError, "OVR.OpenVR", "EVRNotificationError");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EVRNotificationError) == 0x4, "Size mismatch!");
