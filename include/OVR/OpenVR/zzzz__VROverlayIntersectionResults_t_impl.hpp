...
// Ctor Parameters [CppParam { name: "vPoint", ty: "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vNormal", ty: "::OVR::OpenVR::HmdVector3_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vUVs", ty: "::OVR::OpenVR::HmdVector2_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "fDistance", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }]
