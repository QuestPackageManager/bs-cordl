...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::InputDigitalActionData_t, "OVR.OpenVR", "InputDigitalActionData_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::InputDigitalActionData_t) == 0x18, "Size mismatch!");
