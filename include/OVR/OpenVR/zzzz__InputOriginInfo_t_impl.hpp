...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::OVR::OpenVR::InputOriginInfo_t::*)()>(
  ...
  constexpr static std::size_t addrs = 0x28e8114;
...
inline ::StringW OVR::OpenVR::InputOriginInfo_t::get_rchRenderModelComponentName() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::InputOriginInfo_t>::get(),
                                                                             "get_rchRenderModelComponentName", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
