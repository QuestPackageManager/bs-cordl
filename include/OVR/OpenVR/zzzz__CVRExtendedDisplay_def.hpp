...
public:
  ...
  /// @brief Method GetDXGIOutputInfo, addr 0x5c2ef18, size 0x28, virtual false, abstract: false, final false
  inline void GetDXGIOutputInfo(::ByRef<int32_t> pnAdapterIndex, ::ByRef<int32_t> pnAdapterOutputIndex);

  /// @brief Method GetEyeOutputViewport, addr 0x5c2eee8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindowBounds, addr 0x5c2eeb8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c2edbc, size 0xfc, virtual false, abstract: false, final false
