...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(8212))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x27ff590, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method GetWindowBounds, addr 0x27ff6a4, size 0x34, virtual false, abstract: false, final false
  inline void GetWindowBounds(ByRef<int32_t> pnX, ByRef<int32_t> pnY, ByRef<uint32_t> pnWidth, ByRef<uint32_t> pnHeight);

  /// @brief Method GetEyeOutputViewport, addr 0x27ff6d8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDXGIOutputInfo, addr 0x27ff70c, size 0x2c, virtual false, abstract: false, final false
