...
public:
  ...
  /// @brief Method GetDXGIOutputInfo, addr 0x28e3864, size 0x2c, virtual false, abstract: false, final false
  inline void GetDXGIOutputInfo(ByRef<int32_t> pnAdapterIndex, ByRef<int32_t> pnAdapterOutputIndex);

  /// @brief Method GetEyeOutputViewport, addr 0x28e3830, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindowBounds, addr 0x28e37fc, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28e36e8, size 0x114, virtual false, abstract: false, final false
