...
public:
  ...
  /// @brief Method GetDXGIOutputInfo, addr 0x5c959f8, size 0x28, virtual false, abstract: false, final false
  inline void GetDXGIOutputInfo(::ByRef<int32_t> pnAdapterIndex, ::ByRef<int32_t> pnAdapterOutputIndex);

  /// @brief Method GetEyeOutputViewport, addr 0x5c959c8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindowBounds, addr 0x5c95998, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9589c, size 0xfc, virtual false, abstract: false, final false
