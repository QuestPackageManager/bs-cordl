...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8313)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
...
public:
  ...
  /// @brief Method .ctor addr 0x27f22c4 size 0x114 virtual false final false
  inline void _ctor(void* pInterface);

  /// @brief Method AddApplicationManifest addr 0x27f23d8 size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError AddApplicationManifest(::StringW pchApplicationManifestFullPath, bool bTemporary);

  /// @brief Method RemoveApplicationManifest addr 0x27f2400 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError RemoveApplicationManifest(::StringW pchApplicationManifestFullPath);

  /// @brief Method IsApplicationInstalled addr 0x27f2424 size 0x24 virtual false final false
  inline bool IsApplicationInstalled(::StringW pchAppKey);

  /// @brief Method GetApplicationCount addr 0x27f2448 size 0x24 virtual false final false
  inline uint32_t GetApplicationCount();

  /// @brief Method GetApplicationKeyByIndex addr 0x27f246c size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationKeyByProcessId addr 0x27f2490 size 0x24 virtual false final false
  ...
  /// @brief Method LaunchApplication addr 0x27f24b4 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchApplication(::StringW pchAppKey);

  /// @brief Method LaunchTemplateApplication addr 0x27f24d8 size 0x2c virtual false final false
  ...
  /// @brief Method LaunchApplicationFromMimeType addr 0x27f2504 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchApplicationFromMimeType(::StringW pchMimeType, ::StringW pchArgs);

  /// @brief Method LaunchDashboardOverlay addr 0x27f2528 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchDashboardOverlay(::StringW pchAppKey);

  /// @brief Method CancelApplicationLaunch addr 0x27f254c size 0x24 virtual false final false
  inline bool CancelApplicationLaunch(::StringW pchAppKey);

  /// @brief Method IdentifyApplication addr 0x27f2570 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError IdentifyApplication(uint32_t unProcessId, ::StringW pchAppKey);

  /// @brief Method GetApplicationProcessId addr 0x27f2594 size 0x24 virtual false final false
  inline uint32_t GetApplicationProcessId(::StringW pchAppKey);

  /// @brief Method GetApplicationsErrorNameFromEnum addr 0x27f25b8 size 0x84 virtual false final false
  inline ::StringW GetApplicationsErrorNameFromEnum(::OVR::OpenVR::EVRApplicationError error);

  /// @brief Method GetApplicationPropertyString addr 0x27f263c size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationPropertyBool addr 0x27f2660 size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationPropertyUint64 addr 0x27f2684 size 0x24 virtual false final false
  ...
  /// @brief Method SetApplicationAutoLaunch addr 0x27f26a8 size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError SetApplicationAutoLaunch(::StringW pchAppKey, bool bAutoLaunch);

  /// @brief Method GetApplicationAutoLaunch addr 0x27f26d0 size 0x24 virtual false final false
  inline bool GetApplicationAutoLaunch(::StringW pchAppKey);

  /// @brief Method SetDefaultApplicationForMimeType addr 0x27f26f4 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError SetDefaultApplicationForMimeType(::StringW pchAppKey, ::StringW pchMimeType);

  /// @brief Method GetDefaultApplicationForMimeType addr 0x27f2718 size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationSupportedMimeTypes addr 0x27f273c size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationsThatSupportMimeType addr 0x27f2760 size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationLaunchArguments addr 0x27f2784 size 0x24 virtual false final false
  inline uint32_t GetApplicationLaunchArguments(uint32_t unHandle, ::System::Text::StringBuilder* pchArgs, uint32_t unArgs);

  /// @brief Method GetStartingApplication addr 0x27f27a8 size 0x24 virtual false final false
  ...
  /// @brief Method GetTransitionState addr 0x27f27cc size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationTransitionState GetTransitionState();

  /// @brief Method PerformApplicationPrelaunchCheck addr 0x27f27f0 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError PerformApplicationPrelaunchCheck(::StringW pchAppKey);

  /// @brief Method GetApplicationsTransitionStateNameFromEnum addr 0x27f2814 size 0x84 virtual false final false
  inline ::StringW GetApplicationsTransitionStateNameFromEnum(::OVR::OpenVR::EVRApplicationTransitionState state);

  /// @brief Method IsQuitUserPromptRequested addr 0x27f2898 size 0x24 virtual false final false
  inline bool IsQuitUserPromptRequested();

  /// @brief Method LaunchInternalProcess addr 0x27f28bc size 0x24 virtual false final false
  ...
  /// @brief Method GetCurrentSceneProcessId addr 0x27f28e0 size 0x24 virtual false final false
