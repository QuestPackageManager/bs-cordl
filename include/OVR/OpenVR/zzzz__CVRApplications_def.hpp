...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9082)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method .ctor addr 0x267b340 size 0x114 virtual false final false
  inline void _ctor(void* pInterface);

  /// @brief Method AddApplicationManifest addr 0x267b454 size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError AddApplicationManifest(::StringW pchApplicationManifestFullPath, bool bTemporary);

  /// @brief Method RemoveApplicationManifest addr 0x267b47c size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError RemoveApplicationManifest(::StringW pchApplicationManifestFullPath);

  /// @brief Method IsApplicationInstalled addr 0x267b4a0 size 0x24 virtual false final false
  inline bool IsApplicationInstalled(::StringW pchAppKey);

  /// @brief Method GetApplicationCount addr 0x267b4c4 size 0x24 virtual false final false
  inline uint32_t GetApplicationCount();

  /// @brief Method GetApplicationKeyByIndex addr 0x267b4e8 size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationKeyByProcessId addr 0x267b50c size 0x24 virtual false final false
  ...
  /// @brief Method LaunchApplication addr 0x267b530 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchApplication(::StringW pchAppKey);

  /// @brief Method LaunchTemplateApplication addr 0x267b554 size 0x2c virtual false final false
  ...
  /// @brief Method LaunchApplicationFromMimeType addr 0x267b580 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchApplicationFromMimeType(::StringW pchMimeType, ::StringW pchArgs);

  /// @brief Method LaunchDashboardOverlay addr 0x267b5a4 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchDashboardOverlay(::StringW pchAppKey);

  /// @brief Method CancelApplicationLaunch addr 0x267b5c8 size 0x24 virtual false final false
  inline bool CancelApplicationLaunch(::StringW pchAppKey);

  /// @brief Method IdentifyApplication addr 0x267b5ec size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError IdentifyApplication(uint32_t unProcessId, ::StringW pchAppKey);

  /// @brief Method GetApplicationProcessId addr 0x267b610 size 0x24 virtual false final false
  inline uint32_t GetApplicationProcessId(::StringW pchAppKey);

  /// @brief Method GetApplicationsErrorNameFromEnum addr 0x267b634 size 0x84 virtual false final false
  inline ::StringW GetApplicationsErrorNameFromEnum(::OVR::OpenVR::EVRApplicationError error);

  /// @brief Method GetApplicationPropertyString addr 0x267b6b8 size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationPropertyBool addr 0x267b6dc size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationPropertyUint64 addr 0x267b700 size 0x24 virtual false final false
  ...
  /// @brief Method SetApplicationAutoLaunch addr 0x267b724 size 0x28 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError SetApplicationAutoLaunch(::StringW pchAppKey, bool bAutoLaunch);

  /// @brief Method GetApplicationAutoLaunch addr 0x267b74c size 0x24 virtual false final false
  inline bool GetApplicationAutoLaunch(::StringW pchAppKey);

  /// @brief Method SetDefaultApplicationForMimeType addr 0x267b770 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError SetDefaultApplicationForMimeType(::StringW pchAppKey, ::StringW pchMimeType);

  /// @brief Method GetDefaultApplicationForMimeType addr 0x267b794 size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationSupportedMimeTypes addr 0x267b7b8 size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationsThatSupportMimeType addr 0x267b7dc size 0x24 virtual false final false
  ...
  /// @brief Method GetApplicationLaunchArguments addr 0x267b800 size 0x24 virtual false final false
  inline uint32_t GetApplicationLaunchArguments(uint32_t unHandle, ::System::Text::StringBuilder* pchArgs, uint32_t unArgs);

  /// @brief Method GetStartingApplication addr 0x267b824 size 0x24 virtual false final false
  ...
  /// @brief Method GetTransitionState addr 0x267b848 size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationTransitionState GetTransitionState();

  /// @brief Method PerformApplicationPrelaunchCheck addr 0x267b86c size 0x24 virtual false final false
  inline ::OVR::OpenVR::EVRApplicationError PerformApplicationPrelaunchCheck(::StringW pchAppKey);

  /// @brief Method GetApplicationsTransitionStateNameFromEnum addr 0x267b890 size 0x84 virtual false final false
  inline ::StringW GetApplicationsTransitionStateNameFromEnum(::OVR::OpenVR::EVRApplicationTransitionState state);

  /// @brief Method IsQuitUserPromptRequested addr 0x267b914 size 0x24 virtual false final false
  inline bool IsQuitUserPromptRequested();

  /// @brief Method LaunchInternalProcess addr 0x267b938 size 0x24 virtual false final false
  ...
  /// @brief Method GetCurrentSceneProcessId addr 0x267b95c size 0x24 virtual false final false
