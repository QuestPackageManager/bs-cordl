...
public:
  ...
  /// @brief Method AddApplicationManifest, addr 0x28e3ce8, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError AddApplicationManifest(::StringW pchApplicationManifestFullPath, bool bTemporary);

  /// @brief Method CancelApplicationLaunch, addr 0x28e3e5c, size 0x24, virtual false, abstract: false, final false
  inline bool CancelApplicationLaunch(::StringW pchAppKey);

  /// @brief Method GetApplicationAutoLaunch, addr 0x28e3fe0, size 0x24, virtual false, abstract: false, final false
  inline bool GetApplicationAutoLaunch(::StringW pchAppKey);

  /// @brief Method GetApplicationCount, addr 0x28e3d58, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetApplicationCount();

  /// @brief Method GetApplicationKeyByIndex, addr 0x28e3d7c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationKeyByProcessId, addr 0x28e3da0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationLaunchArguments, addr 0x28e4094, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetApplicationLaunchArguments(uint32_t unHandle, ::System::Text::StringBuilder* pchArgs, uint32_t unArgs);

  /// @brief Method GetApplicationProcessId, addr 0x28e3ea4, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetApplicationProcessId(::StringW pchAppKey);

  /// @brief Method GetApplicationPropertyBool, addr 0x28e3f70, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationPropertyString, addr 0x28e3f4c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationPropertyUint64, addr 0x28e3f94, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationSupportedMimeTypes, addr 0x28e404c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationsErrorNameFromEnum, addr 0x28e3ec8, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetApplicationsErrorNameFromEnum(::OVR::OpenVR::EVRApplicationError error);

  /// @brief Method GetApplicationsThatSupportMimeType, addr 0x28e4070, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationsTransitionStateNameFromEnum, addr 0x28e4124, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetApplicationsTransitionStateNameFromEnum(::OVR::OpenVR::EVRApplicationTransitionState state);

  /// @brief Method GetCurrentSceneProcessId, addr 0x28e41f0, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetCurrentSceneProcessId();

  /// @brief Method GetDefaultApplicationForMimeType, addr 0x28e4028, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStartingApplication, addr 0x28e40b8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTransitionState, addr 0x28e40dc, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationTransitionState GetTransitionState();

  /// @brief Method IdentifyApplication, addr 0x28e3e80, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError IdentifyApplication(uint32_t unProcessId, ::StringW pchAppKey);

  /// @brief Method IsApplicationInstalled, addr 0x28e3d34, size 0x24, virtual false, abstract: false, final false
  inline bool IsApplicationInstalled(::StringW pchAppKey);

  /// @brief Method IsQuitUserPromptRequested, addr 0x28e41a8, size 0x24, virtual false, abstract: false, final false
  inline bool IsQuitUserPromptRequested();

  /// @brief Method LaunchApplication, addr 0x28e3dc4, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchApplication(::StringW pchAppKey);

  /// @brief Method LaunchApplicationFromMimeType, addr 0x28e3e14, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchApplicationFromMimeType(::StringW pchMimeType, ::StringW pchArgs);

  /// @brief Method LaunchDashboardOverlay, addr 0x28e3e38, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchDashboardOverlay(::StringW pchAppKey);

  /// @brief Method LaunchInternalProcess, addr 0x28e41cc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LaunchTemplateApplication, addr 0x28e3de8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformApplicationPrelaunchCheck, addr 0x28e4100, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError PerformApplicationPrelaunchCheck(::StringW pchAppKey);

  /// @brief Method RemoveApplicationManifest, addr 0x28e3d10, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError RemoveApplicationManifest(::StringW pchApplicationManifestFullPath);

  /// @brief Method SetApplicationAutoLaunch, addr 0x28e3fb8, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError SetApplicationAutoLaunch(::StringW pchAppKey, bool bAutoLaunch);

  /// @brief Method SetDefaultApplicationForMimeType, addr 0x28e4004, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28e3bd4, size 0x114, virtual false, abstract: false, final false
