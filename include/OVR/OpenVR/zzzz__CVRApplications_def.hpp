...
public:
  ...
  /// @brief Method AddApplicationManifest, addr 0x2bfb450, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError AddApplicationManifest(::StringW pchApplicationManifestFullPath, bool bTemporary);

  /// @brief Method CancelApplicationLaunch, addr 0x2bfb5c4, size 0x24, virtual false, abstract: false, final false
  inline bool CancelApplicationLaunch(::StringW pchAppKey);

  /// @brief Method GetApplicationAutoLaunch, addr 0x2bfb748, size 0x24, virtual false, abstract: false, final false
  inline bool GetApplicationAutoLaunch(::StringW pchAppKey);

  /// @brief Method GetApplicationCount, addr 0x2bfb4c0, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetApplicationCount();

  /// @brief Method GetApplicationKeyByIndex, addr 0x2bfb4e4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationKeyByProcessId, addr 0x2bfb508, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationLaunchArguments, addr 0x2bfb7fc, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetApplicationLaunchArguments(uint32_t unHandle, ::System::Text::StringBuilder* pchArgs, uint32_t unArgs);

  /// @brief Method GetApplicationProcessId, addr 0x2bfb60c, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetApplicationProcessId(::StringW pchAppKey);

  /// @brief Method GetApplicationPropertyBool, addr 0x2bfb6d8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationPropertyString, addr 0x2bfb6b4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationPropertyUint64, addr 0x2bfb6fc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationSupportedMimeTypes, addr 0x2bfb7b4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationsErrorNameFromEnum, addr 0x2bfb630, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetApplicationsErrorNameFromEnum(::OVR::OpenVR::EVRApplicationError error);

  /// @brief Method GetApplicationsThatSupportMimeType, addr 0x2bfb7d8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApplicationsTransitionStateNameFromEnum, addr 0x2bfb88c, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetApplicationsTransitionStateNameFromEnum(::OVR::OpenVR::EVRApplicationTransitionState state);

  /// @brief Method GetCurrentSceneProcessId, addr 0x2bfb958, size 0x24, virtual false, abstract: false, final false
  inline uint32_t GetCurrentSceneProcessId();

  /// @brief Method GetDefaultApplicationForMimeType, addr 0x2bfb790, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStartingApplication, addr 0x2bfb820, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTransitionState, addr 0x2bfb844, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationTransitionState GetTransitionState();

  /// @brief Method IdentifyApplication, addr 0x2bfb5e8, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError IdentifyApplication(uint32_t unProcessId, ::StringW pchAppKey);

  /// @brief Method IsApplicationInstalled, addr 0x2bfb49c, size 0x24, virtual false, abstract: false, final false
  inline bool IsApplicationInstalled(::StringW pchAppKey);

  /// @brief Method IsQuitUserPromptRequested, addr 0x2bfb910, size 0x24, virtual false, abstract: false, final false
  inline bool IsQuitUserPromptRequested();

  /// @brief Method LaunchApplication, addr 0x2bfb52c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchApplication(::StringW pchAppKey);

  /// @brief Method LaunchApplicationFromMimeType, addr 0x2bfb57c, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchApplicationFromMimeType(::StringW pchMimeType, ::StringW pchArgs);

  /// @brief Method LaunchDashboardOverlay, addr 0x2bfb5a0, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError LaunchDashboardOverlay(::StringW pchAppKey);

  /// @brief Method LaunchInternalProcess, addr 0x2bfb934, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LaunchTemplateApplication, addr 0x2bfb550, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformApplicationPrelaunchCheck, addr 0x2bfb868, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError PerformApplicationPrelaunchCheck(::StringW pchAppKey);

  /// @brief Method RemoveApplicationManifest, addr 0x2bfb478, size 0x24, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError RemoveApplicationManifest(::StringW pchApplicationManifestFullPath);

  /// @brief Method SetApplicationAutoLaunch, addr 0x2bfb720, size 0x28, virtual false, abstract: false, final false
  inline ::OVR::OpenVR::EVRApplicationError SetApplicationAutoLaunch(::StringW pchAppKey, bool bAutoLaunch);

  /// @brief Method SetDefaultApplicationForMimeType, addr 0x2bfb76c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bfb33c, size 0x114, virtual false, abstract: false, final false
