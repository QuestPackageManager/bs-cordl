...
// Ctor Parameters [CppParam { name: "pathAppKey", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "pathMessage", ty: "uint64_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "pathMessageParam", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "pathManifestPath", ty: "uint64_t",
