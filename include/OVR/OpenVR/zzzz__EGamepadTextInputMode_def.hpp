...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EGamepadTextInputMode, "OVR.OpenVR", "EGamepadTextInputMode");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EGamepadTextInputMode) == 0x4, "Size mismatch!");
