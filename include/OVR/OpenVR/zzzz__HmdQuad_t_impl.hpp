...
// Ctor Parameters [CppParam { name: "vCorners0", ty: "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vCorners1", ty:
// "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vCorners2", ty: "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "vCorners3", ty: "::OVR::OpenVR::HmdVector3_t", modifiers: "", def_value: Some("{}"), comment: None }]
