...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_EditingCameraSurface_t, "OVR.OpenVR", "VREvent_EditingCameraSurface_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VREvent_EditingCameraSurface_t) == 0x10, "Size mismatch!");
