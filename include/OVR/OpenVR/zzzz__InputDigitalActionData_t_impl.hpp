...
// Some("{}"), comment: None }, CppParam { name: "bState", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "bChanged", ty: "bool", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "fUpdateTime", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }]
