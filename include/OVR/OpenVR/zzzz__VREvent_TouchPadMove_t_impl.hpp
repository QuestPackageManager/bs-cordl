...
// Ctor Parameters [CppParam { name: "bFingerDown", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "flSecondsFingerDown", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "fValueXFirst", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "fValueYFirst", ty: "float_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "fValueXRaw", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "fValueYRaw", ty: "float_t", modifiers:
