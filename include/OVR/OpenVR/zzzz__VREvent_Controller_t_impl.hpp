...
// Ctor Parameters [CppParam { name: "button", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }]
constexpr ::OVR::OpenVR::VREvent_Controller_t::VREvent_Controller_t(uint32_t button) noexcept {
  this->button = button;
}
// Ctor Parameters []
