#pragma once
// IWYU pragma private; include "OVR\OpenVR\EChaperoneImportFlags.hpp"
...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::EChaperoneImportFlags, "OVR.OpenVR", "EChaperoneImportFlags");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::EChaperoneImportFlags) == 0x4, "Size mismatch!");
