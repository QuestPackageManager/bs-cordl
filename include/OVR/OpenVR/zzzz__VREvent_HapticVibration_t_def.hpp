...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_HapticVibration_t, "OVR.OpenVR", "VREvent_HapticVibration_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VREvent_HapticVibration_t) == 0x20, "Size mismatch!");
