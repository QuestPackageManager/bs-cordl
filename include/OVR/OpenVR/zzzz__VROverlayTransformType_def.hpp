...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VROverlayTransformType, "OVR.OpenVR", "VROverlayTransformType");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::VROverlayTransformType) == 0x4, "Size mismatch!");
