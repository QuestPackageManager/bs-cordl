...
// Ctor Parameters [CppParam { name: "m_pResource", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_pCommandQueue", ty: "::System::IntPtr",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_nNodeMask", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }]
