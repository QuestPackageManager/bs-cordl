...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x5c9066c, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x5c907ac, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x5c90654, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c905e8, size 0x6c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x5c9085c, size 0x58, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(uint32_t  notificationId, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x5c908b4, size 0x24, virtual true, abstract: false, final false
inline ::OVR::OpenVR::EVRNotificationError EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x5c90848, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c907dc, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  object, ::System::IntPtr  method) ;
