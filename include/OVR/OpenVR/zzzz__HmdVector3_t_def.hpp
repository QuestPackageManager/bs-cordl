...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::HmdVector3_t, "OVR.OpenVR", "HmdVector3_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
public:
  ...
  // CppParam { name: "v2", ty: "float_t", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::OVR::OpenVR::HmdVector3_t) == 0xc, "Size mismatch!");
