...
namespace OVR::OpenVR {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(8450))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2802a00, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(void* pInterface);

  /// @brief Method GetSettingsErrorNameFromEnum, addr 0x2802b14, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetSettingsErrorNameFromEnum(::OVR::OpenVR::EVRSettingsError eError);

  /// @brief Method Sync, addr 0x2802b98, size 0x28, virtual false, abstract: false, final false
  inline bool Sync(bool bForce, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method SetBool, addr 0x2802bc0, size 0x28, virtual false, abstract: false, final false
  inline void SetBool(::StringW pchSection, ::StringW pchSettingsKey, bool bValue, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method SetInt32, addr 0x2802be8, size 0x24, virtual false, abstract: false, final false
  inline void SetInt32(::StringW pchSection, ::StringW pchSettingsKey, int32_t nValue, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method SetFloat, addr 0x2802c0c, size 0x24, virtual false, abstract: false, final false
  inline void SetFloat(::StringW pchSection, ::StringW pchSettingsKey, float_t flValue, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method SetString, addr 0x2802c30, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBool, addr 0x2802c54, size 0x24, virtual false, abstract: false, final false
  inline bool GetBool(::StringW pchSection, ::StringW pchSettingsKey, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetInt32, addr 0x2802c78, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetInt32(::StringW pchSection, ::StringW pchSettingsKey, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetFloat, addr 0x2802c9c, size 0x24, virtual false, abstract: false, final false
  inline float_t GetFloat(::StringW pchSection, ::StringW pchSettingsKey, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method GetString, addr 0x2802cc0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveSection, addr 0x2802ce4, size 0x24, virtual false, abstract: false, final false
  inline void RemoveSection(::StringW pchSection, ByRef<::OVR::OpenVR::EVRSettingsError> peError);

  /// @brief Method RemoveKeyInSection, addr 0x2802d08, size 0x24, virtual false, abstract: false, final false
