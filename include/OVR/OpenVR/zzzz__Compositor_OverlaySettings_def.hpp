...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::Compositor_OverlaySettings, "OVR.OpenVR", "Compositor_OverlaySettings");
...
static_assert(sizeof(::OVR::OpenVR::Compositor_OverlaySettings) == 0x70, "Size mismatch!");
