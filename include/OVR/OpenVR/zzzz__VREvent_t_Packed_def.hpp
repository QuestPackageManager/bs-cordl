...
public:
  // Declarations
  /// @brief Method Unpack, addr 0x5c94cf4, size 0x20, virtual false, abstract: false, final false
  inline void Unpack(::ByRef<::OVR::OpenVR::VREvent_t> unpacked);

  /// @brief Method .ctor, addr 0x5c99c54, size 0x30, virtual false, abstract: false, final false
