...
public:
  ...
  // Ctor Parameters [CppParam { name: "pchKey", ty: "::System::IntPtr", modifiers: "", def_value: None, comment: None }, CppParam { name: "pchValue", ty: "::System::IntPtr", modifiers: "", def_value:
  // None, comment: None }]
