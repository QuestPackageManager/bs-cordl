...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::VREvent_Chaperone_t, "OVR.OpenVR", "VREvent_Chaperone_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
public:
  ...
  // Ctor Parameters [CppParam { name: "m_nPreviousUniverse", ty: "uint64_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_nCurrentUniverse", ty: "uint64_t", modifiers: "",
...
static_assert(sizeof(::OVR::OpenVR::VREvent_Chaperone_t) == 0x10, "Size mismatch!");
