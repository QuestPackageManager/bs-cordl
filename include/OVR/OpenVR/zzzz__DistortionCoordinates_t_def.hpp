...
DEFINE_IL2CPP_CLASS(::OVR::OpenVR::DistortionCoordinates_t, "OVR.OpenVR", "DistortionCoordinates_t");
// Dependencies
namespace OVR::OpenVR {
// Is value type: true
...
static_assert(sizeof(::OVR::OpenVR::DistortionCoordinates_t) == 0x18, "Size mismatch!");
