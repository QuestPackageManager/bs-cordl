...
// Write type traits
MARK_REF_T(::OVR::Input::UIButtonSquishHelper*);
DEFINE_IL2CPP_CLASS(::OVR::Input::UIButtonSquishHelper*, "OVR.Input", "UIButtonSquishHelper");
...
public:
  ...
  /// @brief Method OnPointerDown, addr 0x5e49a2c, size 0xc4, virtual true, abstract: false, final true
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerEnter, addr 0x5e49968, size 0xc4, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x5e49af0, size 0xa4, virtual true, abstract: false, final true
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerUp, addr 0x5e49b94, size 0xa4, virtual true, abstract: false, final true
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method Start, addr 0x5e498f0, size 0x78, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5e49c38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UIButtonSquishHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UIButtonSquishHelper(UIButtonSquishHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UIButtonSquishHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UIButtonSquishHelper(UIButtonSquishHelperconst&) = delete;
...
static_assert(sizeof(::OVR::Input::UIButtonSquishHelper) == 0x38, "Size mismatch!");
