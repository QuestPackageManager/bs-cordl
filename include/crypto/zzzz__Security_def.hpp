...
public:
// Declarations
/// @brief Method ComputeHash, addr 0x33a34c8, size 0x170, virtual false, abstract: false, final false
static inline ::StringW ComputeHash(::StringW  text, ::StringW  salt) ;

/// @brief Method CreateCipher, addr 0x33a3740, size 0x224, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* CreateCipher(bool  isEncryption, ::StringW  key, ::StringW  iv) ;

/// @brief Method Decrypt, addr 0x33a3638, size 0x108, virtual false, abstract: false, final false
static inline ::StringW Decrypt(::StringW  cipherText, ::StringW  key, ::StringW  iv) ;

/// @brief Method Encrypt, addr 0x33a3964, size 0xf4, virtual false, abstract: false, final false
static inline ::StringW Encrypt(::StringW  plainText, ::StringW  key, ::StringW  iv) ;

/// @brief Method GenerateText, addr 0x33a3a58, size 0xc8, virtual false, abstract: false, final false
static inline ::StringW GenerateText(int32_t  size) ;

static inline ::crypto::Security* New_ctor() ;

/// @brief Method .ctor, addr 0x33a3b20, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
