...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Security", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Security(Security&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Security", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Security(Securityconst&) = delete;
