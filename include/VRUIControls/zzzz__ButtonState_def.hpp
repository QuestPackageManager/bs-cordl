...
public:
  ...
  /// @brief Method get_eventData addr 0x2eb4170 size 0x8 virtual false final false
  inline ::VRUIControls::MouseButtonEventData* get_eventData();

  /// @brief Method set_eventData addr 0x2eb4178 size 0x8 virtual false final false
  inline void set_eventData(::VRUIControls::MouseButtonEventData* value);

  /// @brief Method get_button addr 0x2eb4180 size 0x8 virtual false final false
  inline ::UnityEngine::EventSystems::__PointerEventData__InputButton get_button();

  /// @brief Method set_button addr 0x2eb4188 size 0x8 virtual false final false
  inline void set_button(::UnityEngine::EventSystems::__PointerEventData__InputButton value);

  /// @brief Method get_pressedValue addr 0x2eb4190 size 0x8 virtual false final false
  inline float_t get_pressedValue();

  /// @brief Method set_pressedValue addr 0x2eb4198 size 0x8 virtual false final false
  inline void set_pressedValue(float_t value);

  static inline ::VRUIControls::ButtonState* New_ctor();

  /// @brief Method .ctor addr 0x2eb41a0 size 0x8 virtual false final false
  inline void _ctor();
