...
// Write type traits
MARK_REF_T(::VRUIControls::ButtonState*);
DEFINE_IL2CPP_CLASS(::VRUIControls::ButtonState*, "VRUIControls", "ButtonState");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ButtonState", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ButtonState(ButtonState&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ButtonState", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ButtonState(ButtonStateconst&) = delete;
...
static_assert(sizeof(::VRUIControls::ButtonState) == 0x28, "Size mismatch!");
