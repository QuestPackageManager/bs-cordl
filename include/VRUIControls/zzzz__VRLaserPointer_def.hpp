...
public:
  ...
  /// @brief Method SetFadeDistance, addr 0x6e3c3ec, size 0x12c, virtual false, abstract: false, final false
  inline void SetFadeDistance(float_t distance);

  /// @brief Method SetLocalPosition, addr 0x6e3c35c, size 0x48, virtual false, abstract: false, final false
  inline void SetLocalPosition(::UnityEngine::Vector3 position);

  /// @brief Method SetLocalScale, addr 0x6e3c3a4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e3c518, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
