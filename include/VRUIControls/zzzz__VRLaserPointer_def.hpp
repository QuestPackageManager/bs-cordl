...
public:
  ...
  /// @brief Method SetFadeDistance, addr 0x6c07930, size 0x12c, virtual false, abstract: false, final false
  inline void SetFadeDistance(float_t distance);

  /// @brief Method SetLocalPosition, addr 0x6c078a0, size 0x48, virtual false, abstract: false, final false
  inline void SetLocalPosition(::UnityEngine::Vector3 position);

  /// @brief Method SetLocalScale, addr 0x6c078e8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c07a5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
