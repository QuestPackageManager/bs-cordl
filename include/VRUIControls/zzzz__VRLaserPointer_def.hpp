...
public:
  ...
  /// @brief Method SetFadeDistance, addr 0x340580c, size 0xfc, virtual false, abstract: false, final false
  inline void SetFadeDistance(float_t distance);

  /// @brief Method SetLocalPosition, addr 0x340577c, size 0x48, virtual false, abstract: false, final false
  inline void SetLocalPosition(::UnityEngine::Vector3 position);

  /// @brief Method SetLocalScale, addr 0x34057c4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3405908, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
