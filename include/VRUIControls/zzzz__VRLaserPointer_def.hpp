...
/// @brief Method SetFadeDistance, addr 0x6c70e74, size 0x12c, virtual false, abstract: false, final false
inline void SetFadeDistance(float_t  distance) ;

/// @brief Method SetLocalPosition, addr 0x6c70de4, size 0x48, virtual false, abstract: false, final false
inline void SetLocalPosition(::UnityEngine::Vector3  position) ;

/// @brief Method SetLocalScale, addr 0x6c70e2c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c70fa0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
