...
public:
  ...
  /// @brief Method SetFadeDistance, addr 0x6ce3094, size 0x12c, virtual false, abstract: false, final false
  inline void SetFadeDistance(float_t distance);

  /// @brief Method SetLocalPosition, addr 0x6ce3004, size 0x48, virtual false, abstract: false, final false
  inline void SetLocalPosition(::UnityEngine::Vector3 position);

  /// @brief Method SetLocalScale, addr 0x6ce304c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ce31c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
