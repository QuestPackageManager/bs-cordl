...
public:
  ...
  /// @brief Method Awake, addr 0x360d7a8, size 0xb4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateCursors, addr 0x360d960, size 0x134, virtual false, abstract: false, final false
  inline bool CreateCursors();

  /// @brief Method CreateLaserPointers, addr 0x360d85c, size 0x104, virtual false, abstract: false, final false
  inline bool CreateLaserPointers();

  /// @brief Method EnabledLastSelectedPointer, addr 0x360dcd4, size 0x54, virtual false, abstract: false, final false
  inline void EnabledLastSelectedPointer();

  /// @brief Method HideCursors, addr 0x360dfe0, size 0x60, virtual false, abstract: false, final false
  inline void HideCursors();

  /// @brief Method HideLaserPointers, addr 0x360e040, size 0x60, virtual false, abstract: false, final false
  inline void HideLaserPointers();

  /// @brief Method HideLaserPointersAndCursors, addr 0x360dad0, size 0x18, virtual false, abstract: false, final false
  inline void HideLaserPointersAndCursors();

  /// @brief Method IsLeftControllerDown, addr 0x360dc34, size 0x50, virtual false, abstract: false, final false
  inline bool IsLeftControllerDown();

  /// @brief Method IsRightControllerDown, addr 0x360dc84, size 0x50, virtual false, abstract: false, final false
  inline bool IsRightControllerDown();

  /// @brief Method LateUpdate, addr 0x360dae8, size 0x14c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::VRUIControls::VRPointer* New_ctor();

  /// @brief Method OnApplicationFocus, addr 0x360dfd4, size 0xc, virtual false, abstract: false, final false
  inline void OnApplicationFocus(bool hasFocus);

  /// @brief Method OnDisable, addr 0x360dab8, size 0x18, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Process, addr 0x360cd9c, size 0x68, virtual false, abstract: false, final false
  inline void Process(::UnityEngine::EventSystems::PointerEventData* pointerEventData);

  /// @brief Method RefreshLaserPointerAndLaserHit, addr 0x360dd9c, size 0x238, virtual false, abstract: false, final false
  inline void RefreshLaserPointerAndLaserHit(::UnityEngine::EventSystems::PointerEventData* pointerData);

  /// @brief Method SelectLeftController, addr 0x360daa8, size 0x10, virtual false, abstract: false, final false
  inline void SelectLeftController();

  /// @brief Method SelectRightController, addr 0x360da94, size 0x14, virtual false, abstract: false, final false
  inline void SelectRightController();

  /// @brief Method SetupLaserPointer, addr 0x360dd28, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x360e394, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cursorPosition, addr 0x360d6b8, size 0xf0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_cursorPosition();

  /// @brief Method get_lastSelectedVrController, addr 0x360d6b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::VRController> get_lastSelectedVrController();

  /// @brief Method get_state, addr 0x360e0a0, size 0x2f4, virtual false, abstract: false, final false
