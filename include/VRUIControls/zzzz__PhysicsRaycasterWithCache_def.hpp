...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x4af0d08, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Raycast, addr 0x4af0834, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4af0d48, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
