...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x4aee0b0, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Raycast, addr 0x4aedbdc, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4aee0f0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
