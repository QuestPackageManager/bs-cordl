...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x4aeae4c, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Raycast, addr 0x4aea978, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4aeae8c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
