...
public:
// Declarations
/// @brief Method .ctor, addr 0x6c6cb68, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Field _cachedRaycasts, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__cachedRaycasts, put=__cordl_internal_set__cachedRaycasts)) ::System::Collections::Generic::List_1<::VRUIControls::PhysicsRaycasterWithCache_CachedRaycast>*  _cachedRaycasts;
...
/// @brief Method Raycast, addr 0x6c6c69c, size 0x4cc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c6cba4, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
