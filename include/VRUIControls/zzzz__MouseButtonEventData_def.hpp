...
public:
  ...
  /// @brief Method PressedThisFrame, addr 0x4ae707c, size 0x10, virtual false, abstract: false, final false
  inline bool PressedThisFrame();

  /// @brief Method ReleasedThisFrame, addr 0x4ae708c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4ae70a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
