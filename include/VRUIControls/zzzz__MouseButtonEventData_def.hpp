...
public:
  ...
  /// @brief Method PressedThisFrame, addr 0x4aed0dc, size 0x10, virtual false, abstract: false, final false
  inline bool PressedThisFrame();

  /// @brief Method ReleasedThisFrame, addr 0x4aed0ec, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4aed100, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
