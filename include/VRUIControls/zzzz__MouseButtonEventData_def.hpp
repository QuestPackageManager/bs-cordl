...
public:
  ...
  /// @brief Method PressedThisFrame, addr 0x6cde518, size 0x10, virtual false, abstract: false, final false
  inline bool PressedThisFrame();

  /// @brief Method ReleasedThisFrame, addr 0x6cde528, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cde53c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
