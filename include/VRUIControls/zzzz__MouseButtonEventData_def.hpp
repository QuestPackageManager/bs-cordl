...
public:
  ...
  /// @brief Method PressedThisFrame, addr 0x6c02d8c, size 0x10, virtual false, abstract: false, final false
  inline bool PressedThisFrame();

  /// @brief Method ReleasedThisFrame, addr 0x6c02d9c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c02db0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
