...
public:
  ...
  /// @brief Method AnyPressesThisFrame, addr 0x3608e3c, size 0xa4, virtual false, abstract: false, final false
  inline bool AnyPressesThisFrame();

  /// @brief Method AnyReleasesThisFrame, addr 0x3608ee0, size 0xa8, virtual false, abstract: false, final false
  inline bool AnyReleasesThisFrame();

  /// @brief Method GetButtonState, addr 0x3608f88, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetButtonState, addr 0x3609124, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x360915c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
