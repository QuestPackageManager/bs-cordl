...
// Write type traits
MARK_REF_T(::VRUIControls::MouseState*);
DEFINE_IL2CPP_CLASS(::VRUIControls::MouseState*, "VRUIControls", "MouseState");
...
public:
  ...
  /// @brief Method AnyPressesThisFrame, addr 0x6e3a5fc, size 0xb4, virtual false, abstract: false, final false
  inline bool AnyPressesThisFrame();

  /// @brief Method AnyReleasesThisFrame, addr 0x6e3a6b0, size 0xb8, virtual false, abstract: false, final false
  inline bool AnyReleasesThisFrame();

  /// @brief Method GetButtonState, addr 0x6e3a768, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method SetButtonState, addr 0x6e3a8f8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e3a92c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MouseState", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MouseState(MouseState&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MouseState", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MouseState(MouseStateconst&) = delete;
...
static_assert(sizeof(::VRUIControls::MouseState) == 0x18, "Size mismatch!");
