...
public:
  ...
  /// @brief Method AnyPressesThisFrame, addr 0x4aea5dc, size 0xa8, virtual false, abstract: false, final false
  inline bool AnyPressesThisFrame();

  /// @brief Method AnyReleasesThisFrame, addr 0x4aea684, size 0xac, virtual false, abstract: false, final false
  inline bool AnyReleasesThisFrame();

  /// @brief Method GetButtonState, addr 0x4aea730, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method SetButtonState, addr 0x4aea8c4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4aea8fc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
