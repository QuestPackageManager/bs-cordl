...
public:
  ...
  /// @brief Method AnyPressesThisFrame, addr 0x301c278, size 0xa4, virtual false, abstract: false, final false
  inline bool AnyPressesThisFrame();

  /// @brief Method AnyReleasesThisFrame, addr 0x301c31c, size 0xa8, virtual false, abstract: false, final false
  inline bool AnyReleasesThisFrame();

  /// @brief Method GetButtonState, addr 0x301c3c4, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetButtonState, addr 0x301c560, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x301c598, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
