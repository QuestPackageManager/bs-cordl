...
public:
  ...
  /// @brief Method CompareTo, addr 0x69024a8, size 0x14, virtual true, abstract: false, final true
  inline int32_t CompareTo(::Unity::IntegerTime::DiscreteTime other);

  /// @brief Method Equals, addr 0x69022e8, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x69022d8, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::Unity::IntegerTime::DiscreteTime rhs);

  /// @brief Method FromTicks, addr 0x69021bc, size 0x4, virtual false, abstract: false, final false
  static inline ::Unity::IntegerTime::DiscreteTime FromTicks(int64_t v);

  /// @brief Method GetHashCode, addr 0x6902384, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x6902390, size 0x80, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x6902410, size 0x98, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method .ctor, addr 0x69020c4, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(double_t v);

  /// @brief Method .ctor, addr 0x6901fd0, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(float_t v);

  /// @brief Method .ctor, addr 0x69021b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x6902210, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x69021d8, size 0x14, virtual false, abstract: false, final false
  static inline double_t op_Explicit_double_t(::Unity::IntegerTime::DiscreteTime d);

  /// @brief Method op_Explicit, addr 0x69021c0, size 0x18, virtual false, abstract: false, final false
  static inline float_t op_Explicit_float_t(::Unity::IntegerTime::DiscreteTime d);

  /// @brief Method op_GreaterThan, addr 0x69021f8, size 0xc, virtual false, abstract: false, final false
  static inline bool op_GreaterThan(::Unity::IntegerTime::DiscreteTime lhs, ::Unity::IntegerTime::DiscreteTime rhs);

  /// @brief Method op_GreaterThanOrEqual, addr 0x6902204, size 0xc, virtual false, abstract: false, final false
  static inline bool op_GreaterThanOrEqual(::Unity::IntegerTime::DiscreteTime lhs, ::Unity::IntegerTime::DiscreteTime rhs);

  /// @brief Method op_Inequality, addr 0x69021ec, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Inequality(::Unity::IntegerTime::DiscreteTime lhs, ::Unity::IntegerTime::DiscreteTime rhs);

  /// @brief Method op_Subtraction, addr 0x6902274, size 0x64, virtual false, abstract: false, final false
