...
/// @brief Method Equals, addr 0x689085c, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  rhs) ;

/// @brief Method Equals, addr 0x6890834, size 0x28, virtual true, abstract: false, final true
inline bool Equals(::Unity::IntegerTime::RationalTime_TicksPerSecond  rhs) ;

/// @brief Method Gcd, addr 0x6890970, size 0x30, virtual false, abstract: false, final false
static inline uint32_t Gcd(uint32_t  a, uint32_t  b) ;

/// @brief Method GetHashCode, addr 0x68908f4, size 0x7c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Simplify, addr 0x6890788, size 0xac, virtual false, abstract: false, final false
static inline void Simplify(::ByRef<uint32_t>  num, ::ByRef<uint32_t>  den) ;

/// @brief Method .ctor, addr 0x6890710, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x6890608, size 0x8, virtual false, abstract: false, final false
inline int64_t get_Count() ;

/// @brief Method op_Explicit, addr 0x6890610, size 0xac, virtual false, abstract: false, final false
