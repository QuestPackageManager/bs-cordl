...
DEFINE_IL2CPP_CLASS(::Unity::Burst::BurstExecutionEnvironment, "Unity.Burst", "BurstExecutionEnvironment");
// Dependencies
namespace Unity::Burst {
// Is value type: true
...
static_assert(sizeof(::Unity::Burst::BurstExecutionEnvironment) == 0x4, "Size mismatch!");
