...
DEFINE_IL2CPP_CLASS(::Unity::Burst::GlobalSafetyChecksSettingKind, "Unity.Burst", "GlobalSafetyChecksSettingKind");
// Dependencies
namespace Unity::Burst {
// Is value type: true
...
public:
  ...
  /// @brief Field ForceOn value: I32(2)
...
static_assert(sizeof(::Unity::Burst::GlobalSafetyChecksSettingKind) == 0x4, "Size mismatch!");
