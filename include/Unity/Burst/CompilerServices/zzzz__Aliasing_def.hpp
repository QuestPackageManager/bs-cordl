...
/// @brief Method ExpectAliased, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename A>
static inline void ExpectAliased(::ByRef<A>  a, void*  b) ;

/// @brief Method ExpectAliased, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename B>
static inline void ExpectAliased(void*  a, ::ByRef<B>  b) ;

/// @brief Method ExpectAliased, addr 0x62f163c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ExpectNotAliased, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename A>
static inline void ExpectNotAliased(::ByRef<A>  a, void*  b) ;

/// @brief Method ExpectNotAliased, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename B>
static inline void ExpectNotAliased(void*  a, ::ByRef<B>  b) ;

/// @brief Method ExpectNotAliased, addr 0x62f1640, size 0x4, virtual false, abstract: false, final false
