...
// Write type traits
MARK_REF_T(::Unity::Burst::CompilerServices::Aliasing*);
DEFINE_IL2CPP_CLASS(::Unity::Burst::CompilerServices::Aliasing*, "Unity.Burst.CompilerServices", "Aliasing");
...
static_assert(sizeof(::Unity::Burst::CompilerServices::Aliasing) == 0x10, "Size mismatch!");
