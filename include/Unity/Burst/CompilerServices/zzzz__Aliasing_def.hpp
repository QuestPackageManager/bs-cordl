...
public:
  ...
  /// @brief Method ExpectAliased, addr 0x453fe44, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpectNotAliased, addr 0x453fe48, size 0x4, virtual false, abstract: false, final false
