...
public:
  ...
  /// @brief Method ExpectAliased, addr 0x6363648, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpectNotAliased, addr 0x636364c, size 0x4, virtual false, abstract: false, final false
