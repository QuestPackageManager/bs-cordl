...
public:
  ...
  /// @brief Method ExpectAliased, addr 0x453d1ec, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpectNotAliased, addr 0x453d1f0, size 0x4, virtual false, abstract: false, final false
