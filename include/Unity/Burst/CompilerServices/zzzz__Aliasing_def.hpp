...
public:
  ...
  /// @brief Method ExpectAliased, addr 0x4539f88, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpectNotAliased, addr 0x4539f8c, size 0x4, virtual false, abstract: false, final false
