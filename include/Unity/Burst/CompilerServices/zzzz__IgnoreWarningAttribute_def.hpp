...
public:
  ...
  /// @brief Method .ctor, addr 0x64a1e0c, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Burst::CompilerServices::IgnoreWarningAttribute) == 0x10, "Size mismatch!");
