...
public:
  // Declarations
  /// @brief Method Assume, addr 0x453b9f8, size 0x4, virtual false, abstract: false, final false
  static inline void Assume(bool condition);

  /// @brief Method Likely, addr 0x453b9e8, size 0x8, virtual false, abstract: false, final false
  static inline bool Likely(bool condition);

  /// @brief Method Unlikely, addr 0x453b9f0, size 0x8, virtual false, abstract: false, final false
