...
public:
  // Declarations
  /// @brief Method Assume, addr 0x6363670, size 0x4, virtual false, abstract: false, final false
  static inline void Assume(bool condition);

  /// @brief Method Likely, addr 0x6363660, size 0x8, virtual false, abstract: false, final false
  static inline bool Likely(bool condition);

  /// @brief Method Unlikely, addr 0x6363668, size 0x8, virtual false, abstract: false, final false
