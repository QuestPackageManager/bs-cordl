...
public:
  ...
  /// @brief Method .ctor, addr 0x453b9d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int64_t min, int64_t max);

  /// @brief Method .ctor, addr 0x453b9d8, size 0x8, virtual false, abstract: false, final false
