...
public:
  ...
  /// @brief Method .ctor, addr 0x62893f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(int64_t min, int64_t max);

  /// @brief Method .ctor, addr 0x62893fc, size 0x4, virtual false, abstract: false, final false
