...
/// @brief Method CopyBlock, addr 0x62dd854, size 0x8, virtual false, abstract: false, final false
static inline void CopyBlock(::ByRef<uint8_t>  destination, ::ByRef<uint8_t>  source, uint32_t  byteCount) ;

/// @brief Method CopyBlock, addr 0x62dd84c, size 0x8, virtual false, abstract: false, final false
static inline void CopyBlock(void*  destination, void*  source, uint32_t  byteCount) ;

/// @brief Method CopyBlockUnaligned, addr 0x62dd864, size 0x8, virtual false, abstract: false, final false
static inline void CopyBlockUnaligned(::ByRef<uint8_t>  destination, ::ByRef<uint8_t>  source, uint32_t  byteCount) ;

/// @brief Method CopyBlockUnaligned, addr 0x62dd85c, size 0x8, virtual false, abstract: false, final false
static inline void CopyBlockUnaligned(void*  destination, void*  source, uint32_t  byteCount) ;

/// @brief Method InitBlock, addr 0x62dd874, size 0x8, virtual false, abstract: false, final false
static inline void InitBlock(::ByRef<uint8_t>  startAddress, uint8_t  value, uint32_t  byteCount) ;

/// @brief Method InitBlock, addr 0x62dd86c, size 0x8, virtual false, abstract: false, final false
static inline void InitBlock(void*  startAddress, uint8_t  value, uint32_t  byteCount) ;

/// @brief Method InitBlockUnaligned, addr 0x62dd884, size 0x8, virtual false, abstract: false, final false
static inline void InitBlockUnaligned(::ByRef<uint8_t>  startAddress, uint8_t  value, uint32_t  byteCount) ;

/// @brief Method InitBlockUnaligned, addr 0x62dd87c, size 0x8, virtual false, abstract: false, final false
