...
template<typename T>
static inline ::ByRef<T> Add(::ByRef<T>  source, ::System::IntPtr  elementOffset) ;

/// @brief Method Add, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ByRef<T> Add(::ByRef<T>  source, int32_t  elementOffset) ;
...
template<typename T>
static inline void* AsPointer(::ByRef<T>  value) ;

/// @brief Method AsRef, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ByRef<T> AsRef(::ByRef<T>  source) ;

/// @brief Method AsRef, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ByRef<T> AsRef(void*  source) ;

/// @brief Method ByteOffset, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::IntPtr ByteOffset(::ByRef<T>  origin, ::ByRef<T>  target) ;

/// @brief Method Copy, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void Copy(::ByRef<T>  destination, void*  source) ;

/// @brief Method Copy, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void Copy(void*  destination, ::ByRef<T>  source) ;

/// @brief Method CopyBlock, addr 0x63513d8, size 0x8, virtual false, abstract: false, final false
static inline void CopyBlock(::ByRef<uint8_t>  destination, ::ByRef<uint8_t>  source, uint32_t  byteCount) ;

/// @brief Method CopyBlock, addr 0x63513d0, size 0x8, virtual false, abstract: false, final false
static inline void CopyBlock(void*  destination, void*  source, uint32_t  byteCount) ;

/// @brief Method CopyBlockUnaligned, addr 0x63513e8, size 0x8, virtual false, abstract: false, final false
static inline void CopyBlockUnaligned(::ByRef<uint8_t>  destination, ::ByRef<uint8_t>  source, uint32_t  byteCount) ;

/// @brief Method CopyBlockUnaligned, addr 0x63513e0, size 0x8, virtual false, abstract: false, final false
static inline void CopyBlockUnaligned(void*  destination, void*  source, uint32_t  byteCount) ;

/// @brief Method InitBlock, addr 0x63513f8, size 0x8, virtual false, abstract: false, final false
static inline void InitBlock(::ByRef<uint8_t>  startAddress, uint8_t  value, uint32_t  byteCount) ;

/// @brief Method InitBlock, addr 0x63513f0, size 0x8, virtual false, abstract: false, final false
static inline void InitBlock(void*  startAddress, uint8_t  value, uint32_t  byteCount) ;

/// @brief Method InitBlockUnaligned, addr 0x6351408, size 0x8, virtual false, abstract: false, final false
static inline void InitBlockUnaligned(::ByRef<uint8_t>  startAddress, uint8_t  value, uint32_t  byteCount) ;

/// @brief Method InitBlockUnaligned, addr 0x6351400, size 0x8, virtual false, abstract: false, final false
...
template<typename T>
static inline bool IsAddressGreaterThan(::ByRef<T>  left, ::ByRef<T>  right) ;

/// @brief Method IsAddressLessThan, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool IsAddressLessThan(::ByRef<T>  left, ::ByRef<T>  right) ;
...
template<typename T>
static inline T ReadUnaligned(::ByRef<uint8_t>  source) ;
...
template<typename T>
static inline ::ByRef<T> Subtract(::ByRef<T>  source, ::System::IntPtr  elementOffset) ;

/// @brief Method Subtract, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ByRef<T> Subtract(::ByRef<T>  source, int32_t  elementOffset) ;
...
template<typename T>
static inline ::ByRef<T> SubtractByteOffset(::ByRef<T>  source, ::System::IntPtr  byteOffset) ;

/// @brief Method Unbox, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ByRef<T> Unbox(::System::Object*  box) ;
...
template<typename T>
static inline void WriteUnaligned(::ByRef<uint8_t>  destination, T  value) ;
