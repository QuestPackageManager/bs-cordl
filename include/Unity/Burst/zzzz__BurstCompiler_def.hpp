...
public:
  ...
  /// @brief Method And, addr 0x45001c0, size 0x28, virtual false, abstract: false, final false
  inline ::Unity::Burst::BurstCompiler_CommandBuilder* And(char16_t sep);

  /// @brief Method Begin, addr 0x44fead8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToCompiler, addr 0x44fff20, size 0x74, virtual false, abstract: false, final false
  inline ::StringW SendToCompiler();

  /// @brief Method With, addr 0x44ffec4, size 0x5c, virtual false, abstract: false, final false
  inline ::Unity::Burst::BurstCompiler_CommandBuilder* With(::StringW arg);

  /// @brief Method With, addr 0x45000f8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44fea70, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x45001e8, size 0x28, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x450041c, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x450043c, size 0x28, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x4500408, size 0x14, virtual true, abstract: false, final false
  inline bool Invoke();
  ...
  /// @brief Method .ctor, addr 0x4500380, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DiscardedMethod, addr 0x4500260, size 0x8, virtual false, abstract: false, final false
  static inline void DiscardedMethod(::ByRef<bool> value);

  /// @brief Method IsBurstEnabled, addr 0x4500210, size 0x50, virtual false, abstract: false, final false
  static inline bool IsBurstEnabled();

  /// @brief Method IsCompiledByBurst, addr 0x4500268, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x44fed84, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method get_Method, addr 0x4500464, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Compile>b__22_0, addr 0x45004d0, size 0x6c, virtual false, abstract: false, final false
  inline bool _Compile_b__22_0(::System::Attribute* s);

  /// @brief Method <TriggerUnsafeStaticMethodRecompilation>b__29_0, addr 0x450053c, size 0x70, virtual false, abstract: false, final false
  inline bool _TriggerUnsafeStaticMethodRecompilation_b__29_0(::System::Attribute* x);

  /// @brief Method .ctor, addr 0x45004c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AotCompilation, addr 0x44ffdd0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginCompilerCommand, addr 0x44fe9a0, size 0xd0, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstCompiler_CommandBuilder* BeginCompilerCommand(::StringW cmd);

  /// @brief Method Cancel, addr 0x44ff51c, size 0x4, virtual false, abstract: false, final false
  static inline void Cancel();

  /// @brief Method Compile, addr 0x44ff340, size 0x118, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> Compile(::System::Object* delegateObj, bool isFunctionPointer);

  /// @brief Method Compile, addr 0x44fedac, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileILPPMethod, addr 0x44febd0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileILPPMethod2, addr 0x44fec08, size 0x17c, virtual false, abstract: false, final false
  static inline ::System::IntPtr CompileILPPMethod2(::System::RuntimeMethodHandle burstMethodHandle);

  /// @brief Method CompileUnsafeStaticMethod, addr 0x44ff308, size 0x38, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> CompileUnsafeStaticMethod(::System::RuntimeMethodHandle handle);

  /// @brief Method Disable, addr 0x44ff52c, size 0x4, virtual false, abstract: false, final false
  static inline void Disable();

  /// @brief Method DummyMethod, addr 0x44fff94, size 0x4, virtual false, abstract: false, final false
  static inline void DummyMethod();

  /// @brief Method Enable, addr 0x44ff528, size 0x4, virtual false, abstract: false, final false
  static inline void Enable();

  /// @brief Method GetExecutionMode, addr 0x44febc8, size 0x8, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstExecutionEnvironment GetExecutionMode();

  /// @brief Method GetILPPMethodFunctionPointer, addr 0x44ff1ec, size 0x38, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> GetILPPMethodFunctionPointer(::System::IntPtr ilppMethod);

  /// @brief Method GetILPPMethodFunctionPointer2, addr 0x44ff224, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method InitialiseDebuggerHooks, addr 0x44ffb7c, size 0xd8, virtual false, abstract: false, final false
  static inline void InitialiseDebuggerHooks();

  /// @brief Method Initialize, addr 0x44ffdbc, size 0x4, virtual false, abstract: false, final false
  static inline void Initialize(::ArrayW<::StringW, ::Array<::StringW>*> assemblyFolders, ::ArrayW<::StringW, ::Array<::StringW>*> ignoreAssemblies);

  /// @brief Method IsApiAvailable, addr 0x44fe914, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsApiAvailable(::StringW apiName);

  /// @brief Method IsCurrentCompilationDone, addr 0x44ff520, size 0x8, virtual false, abstract: false, final false
  static inline bool IsCurrentCompilationDone();

  /// @brief Method IsHostEditorArm, addr 0x44ff530, size 0x8, virtual false, abstract: false, final false
  static inline bool IsHostEditorArm();

  /// @brief Method IsLoadAdditionalLibrarySupported, addr 0x44fe8b0, size 0x64, virtual false, abstract: false, final false
  static inline bool IsLoadAdditionalLibrarySupported();

  /// @brief Method NotifyAssemblyCompilationFinished, addr 0x44ffdc8, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyAssemblyCompilationFinished(::StringW assemblyName, ::ArrayW<::StringW, ::Array<::StringW>*> defines);

  /// @brief Method NotifyAssemblyCompilationNotRequired, addr 0x44ffdc4, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyAssemblyCompilationNotRequired(::StringW assemblyName);

  /// @brief Method NotifyCompilationFinished, addr 0x44ffdcc, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyCompilationFinished();

  /// @brief Method NotifyCompilationStarted, addr 0x44ffdc0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestSetProtocolVersion, addr 0x44ffc54, size 0x168, virtual false, abstract: false, final false
  static inline int32_t RequestSetProtocolVersion(int32_t version);

  /// @brief Method SendCommandToCompiler, addr 0x44ffab4, size 0xc8, virtual false, abstract: false, final false
  static inline ::StringW SendCommandToCompiler(::StringW commandName, ::StringW commandArgs);

  /// @brief Method SendRawCommandToCompiler, addr 0x44ffe14, size 0xb0, virtual false, abstract: false, final false
  static inline ::StringW SendRawCommandToCompiler(::StringW command);

  /// @brief Method SetExecutionMode, addr 0x44febc0, size 0x8, virtual false, abstract: false, final false
  static inline void SetExecutionMode(::Unity::Burst::BurstExecutionEnvironment mode);

  /// @brief Method SetProfilerCallbacks, addr 0x44ffe10, size 0x4, virtual false, abstract: false, final false
  static inline void SetProfilerCallbacks();

  /// @brief Method Shutdown, addr 0x44ff518, size 0x4, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method TriggerRecompilation, addr 0x44ffa48, size 0x4, virtual false, abstract: false, final false
  static inline void TriggerRecompilation();

  /// @brief Method TriggerUnsafeStaticMethodRecompilation, addr 0x44ff538, size 0x510, virtual false, abstract: false, final false
  static inline void TriggerUnsafeStaticMethodRecompilation();

  /// @brief Method UnloadAdditionalLibraries, addr 0x44ffa4c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEnabled, addr 0x44feb24, size 0x9c, virtual false, abstract: false, final false
