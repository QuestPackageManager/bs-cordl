...
public:
  ...
  /// @brief Method And, addr 0x632d750, size 0x28, virtual false, abstract: false, final false
  inline ::Unity::Burst::BurstCompiler_CommandBuilder* And(char16_t sep);

  /// @brief Method Begin, addr 0x632bfa4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToCompiler, addr 0x632d4b8, size 0x78, virtual false, abstract: false, final false
  inline ::StringW SendToCompiler();

  /// @brief Method With, addr 0x632d45c, size 0x5c, virtual false, abstract: false, final false
  inline ::Unity::Burst::BurstCompiler_CommandBuilder* With(::StringW arg);

  /// @brief Method With, addr 0x632d678, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x632bf44, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x632d778, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x632d9b0, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x632d9cc, size 0x24, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x632d99c, size 0x14, virtual true, abstract: false, final false
  inline bool Invoke();
  ...
  /// @brief Method .ctor, addr 0x632d934, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DiscardedMethod, addr 0x632d7d4, size 0x8, virtual false, abstract: false, final false
  static inline void DiscardedMethod(::ByRef<bool> value);

  /// @brief Method IsBurstEnabled, addr 0x632d780, size 0x54, virtual false, abstract: false, final false
  static inline bool IsBurstEnabled();

  /// @brief Method IsCompiledByBurst, addr 0x632d7dc, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x632c29c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method get_Method, addr 0x632d9f0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Compile>b__22_0, addr 0x632da50, size 0x78, virtual false, abstract: false, final false
  inline bool _Compile_b__22_0(::System::Attribute* s);

  /// @brief Method <TriggerUnsafeStaticMethodRecompilation>b__29_0, addr 0x632dac8, size 0x70, virtual false, abstract: false, final false
  inline bool _TriggerUnsafeStaticMethodRecompilation_b__29_0(::System::Attribute* x);

  /// @brief Method .ctor, addr 0x632da4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AotCompilation, addr 0x632d35c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginCompilerCommand, addr 0x632bdf4, size 0x150, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstCompiler_CommandBuilder* BeginCompilerCommand(::StringW cmd);

  /// @brief Method Cancel, addr 0x632ca50, size 0x4, virtual false, abstract: false, final false
  static inline void Cancel();

  /// @brief Method Compile, addr 0x632c85c, size 0x128, virtual false, abstract: false, final false
  static inline void* Compile(::System::Object* delegateObj, bool isFunctionPointer);

  /// @brief Method Compile, addr 0x632c2a4, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileILPPMethod, addr 0x632c0f8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileILPPMethod2, addr 0x632c130, size 0x16c, virtual false, abstract: false, final false
  static inline ::System::IntPtr CompileILPPMethod2(::System::RuntimeMethodHandle burstMethodHandle);

  /// @brief Method CompileUnsafeStaticMethod, addr 0x632c824, size 0x38, virtual false, abstract: false, final false
  static inline void* CompileUnsafeStaticMethod(::System::RuntimeMethodHandle handle);

  /// @brief Method Disable, addr 0x632ca60, size 0x4, virtual false, abstract: false, final false
  static inline void Disable();

  /// @brief Method DummyMethod, addr 0x632d530, size 0x4, virtual false, abstract: false, final false
  static inline void DummyMethod();

  /// @brief Method Enable, addr 0x632ca5c, size 0x4, virtual false, abstract: false, final false
  static inline void Enable();

  /// @brief Method GetExecutionMode, addr 0x632c0d0, size 0x28, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstExecutionEnvironment GetExecutionMode();

  /// @brief Method GetILPPMethodFunctionPointer, addr 0x632c74c, size 0x38, virtual false, abstract: false, final false
  static inline void* GetILPPMethodFunctionPointer(::System::IntPtr ilppMethod);

  /// @brief Method GetILPPMethodFunctionPointer2, addr 0x632c784, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method InitialiseDebuggerHooks, addr 0x632d0c4, size 0xe4, virtual false, abstract: false, final false
  static inline void InitialiseDebuggerHooks();

  /// @brief Method Initialize, addr 0x632d348, size 0x4, virtual false, abstract: false, final false
  static inline void Initialize(::ArrayW<::StringW, ::Array<::StringW>*> assemblyFolders, ::ArrayW<::StringW, ::Array<::StringW>*> ignoreAssemblies);

  /// @brief Method IsApiAvailable, addr 0x632bd60, size 0x94, virtual false, abstract: false, final false
  static inline bool IsApiAvailable(::StringW apiName);

  /// @brief Method IsCurrentCompilationDone, addr 0x632ca54, size 0x8, virtual false, abstract: false, final false
  static inline bool IsCurrentCompilationDone();

  /// @brief Method IsHostEditorArm, addr 0x632ca64, size 0x8, virtual false, abstract: false, final false
  static inline bool IsHostEditorArm();

  /// @brief Method IsLoadAdditionalLibrarySupported, addr 0x632bcf4, size 0x6c, virtual false, abstract: false, final false
  static inline bool IsLoadAdditionalLibrarySupported();

  /// @brief Method NotifyAssemblyCompilationFinished, addr 0x632d354, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyAssemblyCompilationFinished(::StringW assemblyName, ::ArrayW<::StringW, ::Array<::StringW>*> defines);

  /// @brief Method NotifyAssemblyCompilationNotRequired, addr 0x632d350, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyAssemblyCompilationNotRequired(::StringW assemblyName);

  /// @brief Method NotifyCompilationFinished, addr 0x632d358, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyCompilationFinished();

  /// @brief Method NotifyCompilationStarted, addr 0x632d34c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestSetProtocolVersion, addr 0x632d1a8, size 0x1a0, virtual false, abstract: false, final false
  static inline int32_t RequestSetProtocolVersion(int32_t version);

  /// @brief Method SendCommandToCompiler, addr 0x632cfe8, size 0xdc, virtual false, abstract: false, final false
  static inline ::StringW SendCommandToCompiler(::StringW commandName, ::StringW commandArgs);

  /// @brief Method SendRawCommandToCompiler, addr 0x632d3a4, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW SendRawCommandToCompiler(::StringW command);

  /// @brief Method SetExecutionMode, addr 0x632c094, size 0x3c, virtual false, abstract: false, final false
  static inline void SetExecutionMode(::Unity::Burst::BurstExecutionEnvironment mode);

  /// @brief Method SetProfilerCallbacks, addr 0x632d3a0, size 0x4, virtual false, abstract: false, final false
  static inline void SetProfilerCallbacks();

  /// @brief Method Shutdown, addr 0x632ca4c, size 0x4, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method TriggerRecompilation, addr 0x632cf74, size 0x4, virtual false, abstract: false, final false
  static inline void TriggerRecompilation();

  /// @brief Method TriggerUnsafeStaticMethodRecompilation, addr 0x632ca6c, size 0x508, virtual false, abstract: false, final false
  static inline void TriggerUnsafeStaticMethodRecompilation();

  /// @brief Method UnloadAdditionalLibraries, addr 0x632cf78, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEnabled, addr 0x632bff0, size 0xa4, virtual false, abstract: false, final false
