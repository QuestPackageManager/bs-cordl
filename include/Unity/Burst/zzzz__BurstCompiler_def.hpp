...
public:
  ...
  /// @brief Method And, addr 0x44a23e0, size 0x28, virtual false, abstract: false, final false
  inline ::Unity::Burst::__BurstCompiler__CommandBuilder* And(char16_t sep);

  /// @brief Method Begin, addr 0x44a0cf8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToCompiler, addr 0x44a2140, size 0x74, virtual false, abstract: false, final false
  inline ::StringW SendToCompiler();

  /// @brief Method With, addr 0x44a20e4, size 0x5c, virtual false, abstract: false, final false
  inline ::Unity::Burst::__BurstCompiler__CommandBuilder* With(::StringW arg);

  /// @brief Method With, addr 0x44a2318, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44a0c90, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x44a2408, size 0x28, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x44a263c, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x44a265c, size 0x28, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x44a2628, size 0x14, virtual true, abstract: false, final false
  inline bool Invoke();
  ...
  /// @brief Method .ctor, addr 0x44a25a0, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DiscardedMethod, addr 0x44a2480, size 0x8, virtual false, abstract: false, final false
  static inline void DiscardedMethod(ByRef<bool> value);

  /// @brief Method IsBurstEnabled, addr 0x44a2430, size 0x50, virtual false, abstract: false, final false
  static inline bool IsBurstEnabled();

  /// @brief Method IsCompiledByBurst, addr 0x44a2488, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x44a0fa4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method get_Method, addr 0x44a2684, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Compile>b__22_0, addr 0x44a26f0, size 0x6c, virtual false, abstract: false, final false
  inline bool _Compile_b__22_0(::System::Attribute* s);

  /// @brief Method <TriggerUnsafeStaticMethodRecompilation>b__29_0, addr 0x44a275c, size 0x70, virtual false, abstract: false, final false
  inline bool _TriggerUnsafeStaticMethodRecompilation_b__29_0(::System::Attribute* x);

  /// @brief Method .ctor, addr 0x44a26e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AotCompilation, addr 0x44a1ff0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginCompilerCommand, addr 0x44a0bc0, size 0xd0, virtual false, abstract: false, final false
  static inline ::Unity::Burst::__BurstCompiler__CommandBuilder* BeginCompilerCommand(::StringW cmd);

  /// @brief Method Cancel, addr 0x44a173c, size 0x4, virtual false, abstract: false, final false
  static inline void Cancel();

  /// @brief Method Compile, addr 0x44a1560, size 0x118, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> Compile(::System::Object* delegateObj, bool isFunctionPointer);

  /// @brief Method Compile, addr 0x44a0fcc, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileILPPMethod, addr 0x44a0df0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileILPPMethod2, addr 0x44a0e28, size 0x17c, virtual false, abstract: false, final false
  static inline ::System::IntPtr CompileILPPMethod2(::System::RuntimeMethodHandle burstMethodHandle);

  /// @brief Method CompileUnsafeStaticMethod, addr 0x44a1528, size 0x38, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> CompileUnsafeStaticMethod(::System::RuntimeMethodHandle handle);

  /// @brief Method Disable, addr 0x44a174c, size 0x4, virtual false, abstract: false, final false
  static inline void Disable();

  /// @brief Method DummyMethod, addr 0x44a21b4, size 0x4, virtual false, abstract: false, final false
  static inline void DummyMethod();

  /// @brief Method Enable, addr 0x44a1748, size 0x4, virtual false, abstract: false, final false
  static inline void Enable();

  /// @brief Method GetExecutionMode, addr 0x44a0de8, size 0x8, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstExecutionEnvironment GetExecutionMode();

  /// @brief Method GetILPPMethodFunctionPointer, addr 0x44a140c, size 0x38, virtual false, abstract: false, final false
  static inline ::cordl_internals::Ptr<void> GetILPPMethodFunctionPointer(::System::IntPtr ilppMethod);

  /// @brief Method GetILPPMethodFunctionPointer2, addr 0x44a1444, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method InitialiseDebuggerHooks, addr 0x44a1d9c, size 0xd8, virtual false, abstract: false, final false
  static inline void InitialiseDebuggerHooks();

  /// @brief Method Initialize, addr 0x44a1fdc, size 0x4, virtual false, abstract: false, final false
  static inline void Initialize(::ArrayW<::StringW, ::Array<::StringW>*> assemblyFolders, ::ArrayW<::StringW, ::Array<::StringW>*> ignoreAssemblies);

  /// @brief Method IsApiAvailable, addr 0x44a0b34, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsApiAvailable(::StringW apiName);

  /// @brief Method IsCurrentCompilationDone, addr 0x44a1740, size 0x8, virtual false, abstract: false, final false
  static inline bool IsCurrentCompilationDone();

  /// @brief Method IsHostEditorArm, addr 0x44a1750, size 0x8, virtual false, abstract: false, final false
  static inline bool IsHostEditorArm();

  /// @brief Method IsLoadAdditionalLibrarySupported, addr 0x44a0ad0, size 0x64, virtual false, abstract: false, final false
  static inline bool IsLoadAdditionalLibrarySupported();

  /// @brief Method NotifyAssemblyCompilationFinished, addr 0x44a1fe8, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyAssemblyCompilationFinished(::StringW assemblyName, ::ArrayW<::StringW, ::Array<::StringW>*> defines);

  /// @brief Method NotifyAssemblyCompilationNotRequired, addr 0x44a1fe4, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyAssemblyCompilationNotRequired(::StringW assemblyName);

  /// @brief Method NotifyCompilationFinished, addr 0x44a1fec, size 0x4, virtual false, abstract: false, final false
  static inline void NotifyCompilationFinished();

  /// @brief Method NotifyCompilationStarted, addr 0x44a1fe0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestSetProtocolVersion, addr 0x44a1e74, size 0x168, virtual false, abstract: false, final false
  static inline int32_t RequestSetProtocolVersion(int32_t version);

  /// @brief Method SendCommandToCompiler, addr 0x44a1cd4, size 0xc8, virtual false, abstract: false, final false
  static inline ::StringW SendCommandToCompiler(::StringW commandName, ::StringW commandArgs);

  /// @brief Method SendRawCommandToCompiler, addr 0x44a2034, size 0xb0, virtual false, abstract: false, final false
  static inline ::StringW SendRawCommandToCompiler(::StringW command);

  /// @brief Method SetExecutionMode, addr 0x44a0de0, size 0x8, virtual false, abstract: false, final false
  static inline void SetExecutionMode(::Unity::Burst::BurstExecutionEnvironment mode);

  /// @brief Method SetProfilerCallbacks, addr 0x44a2030, size 0x4, virtual false, abstract: false, final false
  static inline void SetProfilerCallbacks();

  /// @brief Method Shutdown, addr 0x44a1738, size 0x4, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method TriggerRecompilation, addr 0x44a1c68, size 0x4, virtual false, abstract: false, final false
  static inline void TriggerRecompilation();

  /// @brief Method TriggerUnsafeStaticMethodRecompilation, addr 0x44a1758, size 0x510, virtual false, abstract: false, final false
  static inline void TriggerUnsafeStaticMethodRecompilation();

  /// @brief Method UnloadAdditionalLibraries, addr 0x44a1c6c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEnabled, addr 0x44a0d44, size 0x9c, virtual false, abstract: false, final false
