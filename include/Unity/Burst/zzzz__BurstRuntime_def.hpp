...
public:
  ...
  /// @brief Method .ctor, addr 0x646e2b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetHashCode32, addr 0x646ddf0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode64, addr 0x646de6c, size 0x24, virtual false, abstract: false, final false
  static inline int64_t GetHashCode64(::System::Type* type);

  /// @brief Method GetUTF8LiteralPointer, addr 0x646e264, size 0x4c, virtual false, abstract: false, final false
  static inline uint8_t* GetUTF8LiteralPointer(::StringW str, ::by_ref<int32_t> byteCount);

  /// @brief Method HashStringWithFNV1A32, addr 0x646de14, size 0x58, virtual false, abstract: false, final false
  static inline int32_t HashStringWithFNV1A32(::StringW text);

  /// @brief Method HashStringWithFNV1A64, addr 0x646de90, size 0x60, virtual false, abstract: false, final false
  static inline int64_t HashStringWithFNV1A64(::StringW text);

  /// @brief Method Initialize, addr 0x646e110, size 0x4, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method LoadAdditionalLibrary, addr 0x646def0, size 0x70, virtual false, abstract: false, final false
  static inline bool LoadAdditionalLibrary(::StringW pathToLibBurstGenerated);

  /// @brief Method LoadAdditionalLibraryInternal, addr 0x646df60, size 0x150, virtual false, abstract: false, final false
  static inline bool LoadAdditionalLibraryInternal(::StringW pathToLibBurstGenerated);

  /// @brief Method Log, addr 0x646e208, size 0x5c, virtual false, abstract: false, final false
  static inline void Log(uint8_t* message, int32_t logType, uint8_t* fileName, int32_t lineNumber);

  /// @brief Method PreventRequiredAttributeStrip, addr 0x646e114, size 0xf4, virtual false, abstract: false, final false
  static inline void PreventRequiredAttributeStrip();

  /// @brief Method RuntimeLog, addr 0x646e0b0, size 0x60, virtual false, abstract: false, final false
