...
public:
  ...
  /// @brief Method .ctor, addr 0x6a605ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BurstDiscardAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BurstDiscardAttribute(BurstDiscardAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BurstDiscardAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BurstDiscardAttribute(BurstDiscardAttributeconst&) = delete;
