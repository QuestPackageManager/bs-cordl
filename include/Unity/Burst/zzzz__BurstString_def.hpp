...
public:
  ...
  /// @brief Method .ctor, addr 0x450b5fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method GetDigitsPointer, addr 0x450b604, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<uint8_t> GetDigitsPointer();

  /// @brief Method .ctor, addr 0x45088d0, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method EncodeToRaw, addr 0x450b60c, size 0x8, virtual false, abstract: false, final false
  inline int32_t EncodeToRaw();

  /// @brief Method GetBase, addr 0x4508864, size 0x18, virtual false, abstract: false, final false
  inline int32_t GetBase();

  /// @brief Method ToString, addr 0x450b614, size 0x2ec, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x45095c4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Burst::BurstString_NumberFormatKind kind, int8_t alignAndSize, uint8_t specifier, bool lowercase);

  /// @brief Method get_Uppercase, addr 0x450887c, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetBlock, addr 0x450ac38, size 0xc, virtual false, abstract: false, final false
  inline uint32_t GetBlock(int32_t idx);

  /// @brief Method GetLength, addr 0x450b900, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetLength();

  /// @brief Method GetU32, addr 0x450b910, size 0x18, virtual false, abstract: false, final false
  inline uint32_t GetU32();

  /// @brief Method IsZero, addr 0x450ac44, size 0x10, virtual false, abstract: false, final false
  inline bool IsZero();

  /// @brief Method SetU32, addr 0x4509f50, size 0x1c, virtual false, abstract: false, final false
  inline void SetU32(uint32_t val);

  /// @brief Method SetU64, addr 0x450ac08, size 0x30, virtual false, abstract: false, final false
  inline void SetU64(uint64_t val);

  /// @brief Method SetZero, addr 0x450b908, size 0x8, virtual false, abstract: false, final false
  inline void SetZero();
...
public:
  ...
  /// @brief Method GetExponent, addr 0x450b408, size 0xc, virtual false, abstract: false, final false
  inline uint32_t GetExponent();

  /// @brief Method GetMantissa, addr 0x450b414, size 0xc, virtual false, abstract: false, final false
  inline uint32_t GetMantissa();

  /// @brief Method IsNegative, addr 0x450b420, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetExponent, addr 0x450b42c, size 0xc, virtual false, abstract: false, final false
  inline uint32_t GetExponent();

  /// @brief Method GetMantissa, addr 0x450b438, size 0xc, virtual false, abstract: false, final false
  inline uint64_t GetMantissa();

  /// @brief Method IsNegative, addr 0x450b444, size 0xc, virtual false, abstract: false, final false
  inline bool IsNegative();
...
public:
  ...
  /// @brief Method AlignLeft, addr 0x4507540, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method AlignRight, addr 0x450758c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_Add, addr 0x4509774, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_Add_internal, addr 0x45097fc, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_Compare, addr 0x4509724, size 0x50, virtual false, abstract: false, final false
  static inline int32_t BigInt_Compare(::ByRef<::Unity::Burst::BurstString_tBigInt> lhs, ::ByRef<::Unity::Burst::BurstString_tBigInt> rhs);

  /// @brief Method BigInt_DivideWithRemainder_MaxQuotient9, addr 0x450a154, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_Multiply, addr 0x45098a4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_Multiply, addr 0x4509a20, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_Multiply10, addr 0x4509b38, size 0x5c, virtual false, abstract: false, final false
  static inline void BigInt_Multiply10(::ByRef<::Unity::Burst::BurstString_tBigInt> pResult);

  /// @brief Method BigInt_Multiply2, addr 0x4509adc, size 0x5c, virtual false, abstract: false, final false
  static inline void BigInt_Multiply2(::ByRef<::Unity::Burst::BurstString_tBigInt> pResult);

  /// @brief Method BigInt_Multiply2, addr 0x4509a80, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_MultiplyPow10, addr 0x4509f6c, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_Multiply_internal, addr 0x450992c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method BigInt_Pow10, addr 0x4509ddc, size 0x174, virtual false, abstract: false, final false
  static inline void BigInt_Pow10(::ByRef<::Unity::Burst::BurstString_tBigInt> pResult, uint32_t exponent);

  /// @brief Method BigInt_Pow2, addr 0x450a0f8, size 0x5c, virtual false, abstract: false, final false
  static inline void BigInt_Pow2(::ByRef<::Unity::Burst::BurstString_tBigInt> pResult, uint32_t exponent);

  /// @brief Method BigInt_ShiftLeft, addr 0x450a31c, size 0x114, virtual false, abstract: false, final false
  static inline void BigInt_ShiftLeft(::ByRef<::Unity::Burst::BurstString_tBigInt> pResult, uint32_t shift);

  /// @brief Method ConvertDoubleToString, addr 0x45079ec, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertFloatToString, addr 0x45076e0, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertIntegerToString, addr 0x450849c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertUnsignedIntegerToString, addr 0x4508240, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyFixedString, addr 0x45073ec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Dragon4, addr 0x450a430, size 0x7d8, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4507410, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4507c68, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4507e38, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4507960, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4507654, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4508650, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4508708, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x45087c0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x45083e4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4508138, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x45081bc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x45080b4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x4508030, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatDecimalOrHexadecimal, addr 0x4508b88, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatGeneral, addr 0x4508ea8, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatInfinityNaN, addr 0x450b20c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatNumber, addr 0x45088e8, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatPositional, addr 0x450ac54, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatScientific, addr 0x450af8c, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLengthForFormatGeneral, addr 0x4508d60, size 0x148, virtual false, abstract: false, final false
  static inline int32_t GetLengthForFormatGeneral(::ByRef<::Unity::Burst::BurstString_NumberBuffer> number, int32_t nMaxDigits);

  /// @brief Method GetLengthIntegerToString, addr 0x4508b5c, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t GetLengthIntegerToString(int64_t value, int32_t basis, int32_t zeroPadding);

  /// @brief Method LogBase2, addr 0x4509600, size 0x124, virtual false, abstract: false, final false
  static inline uint32_t LogBase2(uint32_t val);

  /// @brief Method OptsSplit, addr 0x450909c, size 0x170, virtual false, abstract: false, final false
  static inline void OptsSplit(::StringW fullFormat, ::ByRef<::StringW> padding, ::ByRef<::StringW> format);

  /// @brief Method ParseFormatToFormatOptions, addr 0x450920c, size 0x3b8, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstString_FormatOptions ParseFormatToFormatOptions(::StringW fullFormat);

  /// @brief Method RoundNumber, addr 0x4508c28, size 0x138, virtual false, abstract: false, final false
  static inline void RoundNumber(::ByRef<::Unity::Burst::BurstString_NumberBuffer> number, int32_t pos, bool isCorrectlyRounded);

  /// @brief Method ShouldRoundUp, addr 0x45095dc, size 0x24, virtual false, abstract: false, final false
  static inline bool ShouldRoundUp(::cordl_internals::Ptr<uint8_t> dig, int32_t i, bool isCorrectlyRounded);

  /// @brief Method ValueToIntegerChar, addr 0x450888c, size 0x44, virtual false, abstract: false, final false
  static inline uint8_t ValueToIntegerChar(int32_t value, bool uppercase);

  /// @brief Method g_PowerOf10_Big, addr 0x4509b94, size 0x248, virtual false, abstract: false, final false
