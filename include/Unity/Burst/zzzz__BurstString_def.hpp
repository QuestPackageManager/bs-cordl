...
/// @brief Method .ctor, addr 0x62c21dc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
public:
// Declarations
/// @brief Method GetDigitsPointer, addr 0x62c21e0, size 0x8, virtual false, abstract: false, final false
inline uint8_t* GetDigitsPointer() ;

/// @brief Method .ctor, addr 0x62bf0b8, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method EncodeToRaw, addr 0x62c21e8, size 0x8, virtual false, abstract: false, final false
inline int32_t EncodeToRaw() ;

/// @brief Method GetBase, addr 0x62bf054, size 0x18, virtual false, abstract: false, final false
inline int32_t GetBase() ;

/// @brief Method ToString, addr 0x62c21f0, size 0x2cc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x62bfd50, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::Unity::Burst::BurstString_NumberFormatKind  kind, int8_t  alignAndSize, uint8_t  specifier, bool  lowercase) ;

/// @brief Method get_Uppercase, addr 0x62bf06c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method GetBlock, addr 0x62c18e4, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetBlock(int32_t  idx) ;

/// @brief Method GetLength, addr 0x62c24bc, size 0x8, virtual false, abstract: false, final false
inline int32_t GetLength() ;

/// @brief Method GetU32, addr 0x62c24cc, size 0x18, virtual false, abstract: false, final false
inline uint32_t GetU32() ;

/// @brief Method IsZero, addr 0x62c18f0, size 0x10, virtual false, abstract: false, final false
inline bool IsZero() ;

/// @brief Method SetU32, addr 0x62c0784, size 0x1c, virtual false, abstract: false, final false
inline void SetU32(uint32_t  val) ;

/// @brief Method SetU64, addr 0x62c18b4, size 0x30, virtual false, abstract: false, final false
inline void SetU64(uint64_t  val) ;

/// @brief Method SetZero, addr 0x62c24c4, size 0x8, virtual false, abstract: false, final false
inline void SetZero() ;
...
/// @brief Method GetExponent, addr 0x62c1fd4, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetExponent() ;

/// @brief Method GetMantissa, addr 0x62c1fe0, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetMantissa() ;

/// @brief Method IsNegative, addr 0x62c1fec, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method GetExponent, addr 0x62c1ff8, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetExponent() ;

/// @brief Method GetMantissa, addr 0x62c2004, size 0xc, virtual false, abstract: false, final false
inline uint64_t GetMantissa() ;

/// @brief Method IsNegative, addr 0x62c2010, size 0xc, virtual false, abstract: false, final false
inline bool IsNegative() ;
...
/// @brief Method AlignLeft, addr 0x62bdcc8, size 0x44, virtual false, abstract: false, final false
static inline bool AlignLeft(uint8_t*  dest, ::ByRef<int32_t>  destIndex, int32_t  destLength, int32_t  align, int32_t  length) ;

/// @brief Method AlignRight, addr 0x62bdd0c, size 0xc8, virtual false, abstract: false, final false
static inline bool AlignRight(uint8_t*  dest, ::ByRef<int32_t>  destIndex, int32_t  destLength, int32_t  align, int32_t  length) ;

/// @brief Method BigInt_Add, addr 0x62bff2c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Add_internal, addr 0x62bffc4, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Compare, addr 0x62bfed0, size 0x5c, virtual false, abstract: false, final false
static inline int32_t BigInt_Compare(::ByRef<::Unity::Burst::BurstString_tBigInt>  lhs, ::ByRef<::Unity::Burst::BurstString_tBigInt>  rhs) ;

/// @brief Method BigInt_DivideWithRemainder_MaxQuotient9, addr 0x62c0a2c, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply, addr 0x62c0064, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply, addr 0x62c022c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply10, addr 0x62c0340, size 0x58, virtual false, abstract: false, final false
static inline void BigInt_Multiply10(::ByRef<::Unity::Burst::BurstString_tBigInt>  pResult) ;

/// @brief Method BigInt_Multiply2, addr 0x62c02e8, size 0x58, virtual false, abstract: false, final false
static inline void BigInt_Multiply2(::ByRef<::Unity::Burst::BurstString_tBigInt>  pResult) ;

/// @brief Method BigInt_Multiply2, addr 0x62c028c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method BigInt_MultiplyPow10, addr 0x62c07a0, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply_internal, addr 0x62c00fc, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Pow10, addr 0x62c05dc, size 0x1a8, virtual false, abstract: false, final false
static inline void BigInt_Pow10(::ByRef<::Unity::Burst::BurstString_tBigInt>  pResult, uint32_t  exponent) ;

/// @brief Method BigInt_Pow2, addr 0x62c095c, size 0xd0, virtual false, abstract: false, final false
static inline void BigInt_Pow2(::ByRef<::Unity::Burst::BurstString_tBigInt>  pResult, uint32_t  exponent) ;

/// @brief Method BigInt_ShiftLeft, addr 0x62c0b94, size 0x21c, virtual false, abstract: false, final false
static inline void BigInt_ShiftLeft(::ByRef<::Unity::Burst::BurstString_tBigInt>  pResult, uint32_t  shift) ;

/// @brief Method ConvertDoubleToString, addr 0x62be184, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method ConvertFloatToString, addr 0x62bde64, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method ConvertIntegerToString, addr 0x62bec68, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method ConvertUnsignedIntegerToString, addr 0x62bea04, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method CopyFixedString, addr 0x62bdb10, size 0x64, virtual false, abstract: false, final false
static inline void CopyFixedString(uint8_t*  dest, int32_t  destLength, uint8_t*  src, int32_t  srcLength) ;

/// @brief Method Dragon4, addr 0x62c0db0, size 0xb04, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x62bdb74, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x62be418, size 0x1cc, virtual false, abstract: false, final false
static inline void Format(uint8_t*  dest, ::ByRef<int32_t>  destIndex, int32_t  destLength, bool  value, int32_t  formatOptionsRaw) ;

/// @brief Method Format, addr 0x62be5e4, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x62be0f4, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x62be97c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x62be86c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x62be7e4, size 0x88, virtual false, abstract: false, final false
static inline void Format(uint8_t*  dest, ::ByRef<int32_t>  destIndex, int32_t  destLength, uint8_t  value, int32_t  formatOptionsRaw) ;

/// @brief Method FormatDecimalOrHexadecimal, addr 0x62bf358, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method FormatGeneral, addr 0x62bf694, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method FormatInfinityNaN, addr 0x62c1de0, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method FormatNumber, addr 0x62bf0cc, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method FormatPositional, addr 0x62c1900, size 0x268, virtual false, abstract: false, final false
...
/// @brief Method FormatScientific, addr 0x62c1b68, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method GetLengthForFormatGeneral, addr 0x62bf534, size 0x160, virtual false, abstract: false, final false
static inline int32_t GetLengthForFormatGeneral(::ByRef<::Unity::Burst::BurstString_NumberBuffer>  number, int32_t  nMaxDigits) ;

/// @brief Method GetLengthIntegerToString, addr 0x62bf32c, size 0x2c, virtual false, abstract: false, final false
static inline int32_t GetLengthIntegerToString(int64_t  value, int32_t  basis, int32_t  zeroPadding) ;

/// @brief Method LogBase2, addr 0x62bfd80, size 0x150, virtual false, abstract: false, final false
static inline uint32_t LogBase2(uint32_t  val) ;

/// @brief Method OptsSplit, addr 0x62bf894, size 0x170, virtual false, abstract: false, final false
static inline void OptsSplit(::StringW  fullFormat, ::ByRef<::StringW>  padding, ::ByRef<::StringW>  format) ;

/// @brief Method ParseFormatToFormatOptions, addr 0x62bfa04, size 0x34c, virtual false, abstract: false, final false
static inline ::Unity::Burst::BurstString_FormatOptions ParseFormatToFormatOptions(::StringW  fullFormat) ;

/// @brief Method RoundNumber, addr 0x62bf3f8, size 0x13c, virtual false, abstract: false, final false
static inline void RoundNumber(::ByRef<::Unity::Burst::BurstString_NumberBuffer>  number, int32_t  pos, bool  isCorrectlyRounded) ;

/// @brief Method ShouldRoundUp, addr 0x62bfd64, size 0x1c, virtual false, abstract: false, final false
static inline bool ShouldRoundUp(uint8_t*  dig, int32_t  i, bool  isCorrectlyRounded) ;

/// @brief Method ValueToIntegerChar, addr 0x62bf07c, size 0x3c, virtual false, abstract: false, final false
static inline uint8_t ValueToIntegerChar(int32_t  value, bool  uppercase) ;

/// @brief Method g_PowerOf10_Big, addr 0x62c0398, size 0x244, virtual false, abstract: false, final false
