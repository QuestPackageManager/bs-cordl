...
public:
  ...
  /// @brief Method .ctor, addr 0x632bce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x632bce4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Burst::FloatPrecision floatPrecision, ::Unity::Burst::FloatMode floatMode);

  /// @brief Method .ctor, addr 0x632bcec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::StringW, ::Array<::StringW>*> options);

  /// @brief Method get_CompileSynchronously, addr 0x632b990, size 0x70, virtual false, abstract: false, final false
  inline bool get_CompileSynchronously();

  /// @brief Method get_Debug, addr 0x632ba5c, size 0x70, virtual false, abstract: false, final false
  inline bool get_Debug();

  /// @brief Method get_DisableDirectCall, addr 0x632bbf4, size 0x70, virtual false, abstract: false, final false
  inline bool get_DisableDirectCall();

  /// @brief Method get_DisableSafetyChecks, addr 0x632bb28, size 0x70, virtual false, abstract: false, final false
  inline bool get_DisableSafetyChecks();

  /// @brief Method get_FloatMode, addr 0x632b970, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Burst::FloatMode get_FloatMode();

  /// @brief Method get_FloatPrecision, addr 0x632b980, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Burst::FloatPrecision get_FloatPrecision();

  /// @brief Method get_OptimizeFor, addr 0x632bcc0, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Burst::OptimizeFor get_OptimizeFor();

  /// @brief Method get_Options, addr 0x632bcd0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Options();

  /// @brief Method set_CompileSynchronously, addr 0x632ba00, size 0x5c, virtual false, abstract: false, final false
  inline void set_CompileSynchronously(bool value);

  /// @brief Method set_Debug, addr 0x632bacc, size 0x5c, virtual false, abstract: false, final false
  inline void set_Debug(bool value);

  /// @brief Method set_DisableDirectCall, addr 0x632bc64, size 0x5c, virtual false, abstract: false, final false
  inline void set_DisableDirectCall(bool value);

  /// @brief Method set_DisableSafetyChecks, addr 0x632bb98, size 0x5c, virtual false, abstract: false, final false
  inline void set_DisableSafetyChecks(bool value);

  /// @brief Method set_FloatMode, addr 0x632b978, size 0x8, virtual false, abstract: false, final false
  inline void set_FloatMode(::Unity::Burst::FloatMode value);

  /// @brief Method set_FloatPrecision, addr 0x632b988, size 0x8, virtual false, abstract: false, final false
  inline void set_FloatPrecision(::Unity::Burst::FloatPrecision value);

  /// @brief Method set_OptimizeFor, addr 0x632bcc8, size 0x8, virtual false, abstract: false, final false
  inline void set_OptimizeFor(::Unity::Burst::OptimizeFor value);

  /// @brief Method set_Options, addr 0x632bcd8, size 0x8, virtual false, abstract: false, final false
