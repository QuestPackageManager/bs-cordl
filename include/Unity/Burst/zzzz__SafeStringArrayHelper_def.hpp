...
public:
  // Declarations
  /// @brief Method DeserialiseStringArraySafe, addr 0x4512c70, size 0x28c, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> DeserialiseStringArraySafe(::StringW input);

  /// @brief Method SerialiseStringArraySafe, addr 0x4512a74, size 0x150, virtual false, abstract: false, final false
