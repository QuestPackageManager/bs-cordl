...
public:
// Declarations
/// @brief Method DeserialiseStringArraySafe, addr 0x62bbdec, size 0x290, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> DeserialiseStringArraySafe(::StringW  input) ;

/// @brief Method SerialiseStringArraySafe, addr 0x62bbbd8, size 0x170, virtual false, abstract: false, final false
