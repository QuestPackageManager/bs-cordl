...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SafeStringArrayHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SafeStringArrayHelper(SafeStringArrayHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SafeStringArrayHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SafeStringArrayHelper(SafeStringArrayHelperconst&) = delete;
