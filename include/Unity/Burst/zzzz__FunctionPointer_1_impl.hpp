...
template <typename T> inline void Unity::Burst::FunctionPointer_1<T>::_ctor(void* ptr) {
...
template <typename T> inline void* Unity::Burst::FunctionPointer_1<T>::get_Value() {
...
template <typename T> inline ::Unity::Burst::IFunctionPointer* Unity::Burst::FunctionPointer_1<T>::Unity_Burst_IFunctionPointer_FromIntPtr(void* ptr) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Burst::FunctionPointer_1<T>>::get(), "Unity.Burst.IFunctionPointer.FromIntPtr",
...
// Ctor Parameters [CppParam { name: "_ptr", ty: "void*", modifiers: "", def_value: Some("{}") }]
template <typename T> constexpr ::Unity::Burst::FunctionPointer_1<T>::FunctionPointer_1(void* _ptr) noexcept {
  this->_ptr = _ptr;
}
// Ctor Parameters []
