...
public:
  ...
  /// @brief Method AddOption, addr 0x45085f8, size 0x4c, virtual false, abstract: false, final false
  static inline void AddOption(::System::Text::StringBuilder* builder, ::StringW option);

  /// @brief Method CheckIsSecondaryUnityProcess, addr 0x4508754, size 0x8, virtual false, abstract: false, final false
  static inline bool CheckIsSecondaryUnityProcess();

  /// @brief Method Clone, addr 0x45075fc, size 0x148, virtual false, abstract: false, final false
  inline ::Unity::Burst::BurstCompilerOptions* Clone();

  /// @brief Method DeserialiseCompilationOptionsSafe, addr 0x4506f3c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBurstCompileAttribute, addr 0x45077d0, size 0x420, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstCompileAttribute* GetBurstCompileAttribute(::System::Reflection::MemberInfo* memberInfo);

  /// @brief Method GetOption, addr 0x4508514, size 0xe4, virtual false, abstract: false, final false
  static inline ::StringW GetOption(::StringW optionName, ::System::Object* value);

  /// @brief Method GetOptions, addr 0x4507eb0, size 0x664, virtual false, abstract: false, final false
  inline ::StringW GetOptions(::Unity::Burst::BurstCompileAttribute* attr, bool isForILPostProcessing, bool isForCompilerClient);

  /// @brief Method HasBurstCompileAttribute, addr 0x4505bf0, size 0xc0, virtual false, abstract: false, final false
  static inline bool HasBurstCompileAttribute(::System::Reflection::MemberInfo* member);

  /// @brief Method MaybeTriggerRecompilation, addr 0x45074b4, size 0x4, virtual false, abstract: false, final false
  inline void MaybeTriggerRecompilation();

  /// @brief Method MergeAttributes, addr 0x4507c6c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnOptionsChanged, addr 0x4507458, size 0x1c, virtual false, abstract: false, final false
  inline void OnOptionsChanged();

  /// @brief Method SerialiseCompilationOptionsSafe, addr 0x4506d44, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetAttribute, addr 0x4507bf0, size 0x7c, virtual false, abstract: false, final false
  static inline bool TryGetAttribute(::System::Reflection::Assembly* assembly, ::ByRef<::Unity::Burst::BurstCompileAttribute*> attribute);

  /// @brief Method TryGetAttribute, addr 0x4507744, size 0x8c, virtual false, abstract: false, final false
  static inline bool TryGetAttribute(::System::Reflection::MemberInfo* member, ::ByRef<::Unity::Burst::BurstCompileAttribute*> attribute);

  /// @brief Method TryGetOptions, addr 0x4507d94, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4507274, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4506828, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DisableOptimizations, addr 0x4507528, size 0x8, virtual false, abstract: false, final false
  inline bool get_DisableOptimizations();

  /// @brief Method get_EnableBurstCompilation, addr 0x4507450, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstCompilation();

  /// @brief Method get_EnableBurstCompileSynchronously, addr 0x4507474, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstCompileSynchronously();

  /// @brief Method get_EnableBurstDebug, addr 0x45074f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstDebug();

  /// @brief Method get_EnableBurstSafetyChecks, addr 0x45074ac, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstSafetyChecks();

  /// @brief Method get_EnableBurstTimings, addr 0x4507540, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstTimings();

  /// @brief Method get_EnableFastMath, addr 0x4507534, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableFastMath();

  /// @brief Method get_ForceEnableBurstSafetyChecks, addr 0x45074b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_ForceEnableBurstSafetyChecks();

  /// @brief Method get_IsEnabled, addr 0x45073dc, size 0x74, virtual false, abstract: false, final false
  inline bool get_IsEnabled();

  /// @brief Method get_IsGlobal, addr 0x45073d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsGlobal();

  /// @brief Method get_OptionsChanged, addr 0x45075ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action* get_OptionsChanged();

  /// @brief Method get_RequiresSynchronousCompilation, addr 0x4507578, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DisableOptimizations, addr 0x4507530, size 0x4, virtual false, abstract: false, final false
  inline void set_DisableOptimizations(bool value);

  /// @brief Method set_EnableBurstCompilation, addr 0x450727c, size 0x128, virtual false, abstract: false, final false
  inline void set_EnableBurstCompilation(bool value);

  /// @brief Method set_EnableBurstCompileSynchronously, addr 0x450747c, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstCompileSynchronously(bool value);

  /// @brief Method set_EnableBurstDebug, addr 0x45074f8, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstDebug(bool value);

  /// @brief Method set_EnableBurstSafetyChecks, addr 0x45073a4, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstSafetyChecks(bool value);

  /// @brief Method set_EnableBurstTimings, addr 0x4507548, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstTimings(bool value);

  /// @brief Method set_EnableFastMath, addr 0x450753c, size 0x4, virtual false, abstract: false, final false
  inline void set_EnableFastMath(bool value);

  /// @brief Method set_ForceEnableBurstSafetyChecks, addr 0x45074c0, size 0x30, virtual false, abstract: false, final false
  inline void set_ForceEnableBurstSafetyChecks(bool value);

  /// @brief Method set_OptionsChanged, addr 0x45075f4, size 0x8, virtual false, abstract: false, final false
