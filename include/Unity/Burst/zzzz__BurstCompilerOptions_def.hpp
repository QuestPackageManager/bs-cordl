...
public:
  ...
  /// @brief Method AddOption, addr 0x4514280, size 0x4c, virtual false, abstract: false, final false
  static inline void AddOption(::System::Text::StringBuilder* builder, ::StringW option);

  /// @brief Method CheckIsSecondaryUnityProcess, addr 0x45143dc, size 0x8, virtual false, abstract: false, final false
  static inline bool CheckIsSecondaryUnityProcess();

  /// @brief Method Clone, addr 0x4513284, size 0x148, virtual false, abstract: false, final false
  inline ::Unity::Burst::BurstCompilerOptions* Clone();

  /// @brief Method DeserialiseCompilationOptionsSafe, addr 0x4512bc4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBurstCompileAttribute, addr 0x4513458, size 0x420, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstCompileAttribute* GetBurstCompileAttribute(::System::Reflection::MemberInfo* memberInfo);

  /// @brief Method GetOption, addr 0x451419c, size 0xe4, virtual false, abstract: false, final false
  static inline ::StringW GetOption(::StringW optionName, ::System::Object* value);

  /// @brief Method GetOptions, addr 0x4513b38, size 0x664, virtual false, abstract: false, final false
  inline ::StringW GetOptions(::Unity::Burst::BurstCompileAttribute* attr, bool isForILPostProcessing, bool isForCompilerClient);

  /// @brief Method HasBurstCompileAttribute, addr 0x4511878, size 0xc0, virtual false, abstract: false, final false
  static inline bool HasBurstCompileAttribute(::System::Reflection::MemberInfo* member);

  /// @brief Method MaybeTriggerRecompilation, addr 0x451313c, size 0x4, virtual false, abstract: false, final false
  inline void MaybeTriggerRecompilation();

  /// @brief Method MergeAttributes, addr 0x45138f4, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnOptionsChanged, addr 0x45130e0, size 0x1c, virtual false, abstract: false, final false
  inline void OnOptionsChanged();

  /// @brief Method SerialiseCompilationOptionsSafe, addr 0x45129cc, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetAttribute, addr 0x4513878, size 0x7c, virtual false, abstract: false, final false
  static inline bool TryGetAttribute(::System::Reflection::Assembly* assembly, ::ByRef<::Unity::Burst::BurstCompileAttribute*> attribute);

  /// @brief Method TryGetAttribute, addr 0x45133cc, size 0x8c, virtual false, abstract: false, final false
  static inline bool TryGetAttribute(::System::Reflection::MemberInfo* member, ::ByRef<::Unity::Burst::BurstCompileAttribute*> attribute);

  /// @brief Method TryGetOptions, addr 0x4513a1c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4512efc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x45124b0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DisableOptimizations, addr 0x45131b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_DisableOptimizations();

  /// @brief Method get_EnableBurstCompilation, addr 0x45130d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstCompilation();

  /// @brief Method get_EnableBurstCompileSynchronously, addr 0x45130fc, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstCompileSynchronously();

  /// @brief Method get_EnableBurstDebug, addr 0x4513178, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstDebug();

  /// @brief Method get_EnableBurstSafetyChecks, addr 0x4513134, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstSafetyChecks();

  /// @brief Method get_EnableBurstTimings, addr 0x45131c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstTimings();

  /// @brief Method get_EnableFastMath, addr 0x45131bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableFastMath();

  /// @brief Method get_ForceEnableBurstSafetyChecks, addr 0x4513140, size 0x8, virtual false, abstract: false, final false
  inline bool get_ForceEnableBurstSafetyChecks();

  /// @brief Method get_IsEnabled, addr 0x4513064, size 0x74, virtual false, abstract: false, final false
  inline bool get_IsEnabled();

  /// @brief Method get_IsGlobal, addr 0x451305c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsGlobal();

  /// @brief Method get_OptionsChanged, addr 0x4513274, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action* get_OptionsChanged();

  /// @brief Method get_RequiresSynchronousCompilation, addr 0x4513200, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DisableOptimizations, addr 0x45131b8, size 0x4, virtual false, abstract: false, final false
  inline void set_DisableOptimizations(bool value);

  /// @brief Method set_EnableBurstCompilation, addr 0x4512f04, size 0x128, virtual false, abstract: false, final false
  inline void set_EnableBurstCompilation(bool value);

  /// @brief Method set_EnableBurstCompileSynchronously, addr 0x4513104, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstCompileSynchronously(bool value);

  /// @brief Method set_EnableBurstDebug, addr 0x4513180, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstDebug(bool value);

  /// @brief Method set_EnableBurstSafetyChecks, addr 0x451302c, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstSafetyChecks(bool value);

  /// @brief Method set_EnableBurstTimings, addr 0x45131d0, size 0x30, virtual false, abstract: false, final false
  inline void set_EnableBurstTimings(bool value);

  /// @brief Method set_EnableFastMath, addr 0x45131c4, size 0x4, virtual false, abstract: false, final false
  inline void set_EnableFastMath(bool value);

  /// @brief Method set_ForceEnableBurstSafetyChecks, addr 0x4513148, size 0x30, virtual false, abstract: false, final false
  inline void set_ForceEnableBurstSafetyChecks(bool value);

  /// @brief Method set_OptionsChanged, addr 0x451327c, size 0x8, virtual false, abstract: false, final false
