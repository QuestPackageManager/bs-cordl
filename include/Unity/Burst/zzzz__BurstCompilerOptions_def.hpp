...
public:
  ...
  /// @brief Method AddOption, addr 0x306ca68, size 0x4c, virtual false, abstract: false, final false
  static inline void AddOption(::System::Text::StringBuilder* builder, ::StringW option);

  /// @brief Method CheckIsSecondaryUnityProcess, addr 0x306cbc4, size 0x8, virtual false, abstract: false, final false
  static inline bool CheckIsSecondaryUnityProcess();

  /// @brief Method Clone, addr 0x306ba30, size 0x170, virtual false, abstract: false, final false
  inline ::Unity::Burst::BurstCompilerOptions* Clone();

  /// @brief Method DeserialiseCompilationOptionsSafe, addr 0x306b374, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBurstCompileAttribute, addr 0x306bc2c, size 0x44c, virtual false, abstract: false, final false
  static inline ::Unity::Burst::BurstCompileAttribute* GetBurstCompileAttribute(::System::Reflection::MemberInfo* memberInfo);

  /// @brief Method GetOption, addr 0x306c980, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW GetOption(::StringW optionName, ::System::Object* value);

  /// @brief Method GetOptions, addr 0x306c33c, size 0x644, virtual false, abstract: false, final false
  inline ::StringW GetOptions(::Unity::Burst::BurstCompileAttribute* attr, bool isForILPostProcessing, bool isForCompilerClient);

  /// @brief Method HasBurstCompileAttribute, addr 0x3069fa4, size 0xc4, virtual false, abstract: false, final false
  static inline bool HasBurstCompileAttribute(::System::Reflection::MemberInfo* member);

  /// @brief Method MaybeTriggerRecompilation, addr 0x306b8dc, size 0x4, virtual false, abstract: false, final false
  inline void MaybeTriggerRecompilation();

  /// @brief Method MergeAttributes, addr 0x306c0f4, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnOptionsChanged, addr 0x306b87c, size 0x1c, virtual false, abstract: false, final false
  inline void OnOptionsChanged();

  /// @brief Method SerialiseCompilationOptionsSafe, addr 0x306b120, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetAttribute, addr 0x306c078, size 0x7c, virtual false, abstract: false, final false
  static inline bool TryGetAttribute(::System::Reflection::Assembly* assembly, ByRef<::Unity::Burst::BurstCompileAttribute*> attribute);

  /// @brief Method TryGetAttribute, addr 0x306bba0, size 0x8c, virtual false, abstract: false, final false
  static inline bool TryGetAttribute(::System::Reflection::MemberInfo* member, ByRef<::Unity::Burst::BurstCompileAttribute*> attribute);

  /// @brief Method TryGetOptions, addr 0x306c21c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x306b6a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x306abcc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DisableOptimizations, addr 0x306b958, size 0x8, virtual false, abstract: false, final false
  inline bool get_DisableOptimizations();

  /// @brief Method get_EnableBurstCompilation, addr 0x306b874, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstCompilation();

  /// @brief Method get_EnableBurstCompileSynchronously, addr 0x306b898, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstCompileSynchronously();

  /// @brief Method get_EnableBurstDebug, addr 0x306b91c, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstDebug();

  /// @brief Method get_EnableBurstSafetyChecks, addr 0x306b8d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstSafetyChecks();

  /// @brief Method get_EnableBurstTimings, addr 0x306b970, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableBurstTimings();

  /// @brief Method get_EnableFastMath, addr 0x306b964, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableFastMath();

  /// @brief Method get_ForceEnableBurstSafetyChecks, addr 0x306b8e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_ForceEnableBurstSafetyChecks();

  /// @brief Method get_IsEnabled, addr 0x306b800, size 0x74, virtual false, abstract: false, final false
  inline bool get_IsEnabled();

  /// @brief Method get_IsGlobal, addr 0x306b7f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsGlobal();

  /// @brief Method get_OptionsChanged, addr 0x306ba20, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action* get_OptionsChanged();

  /// @brief Method get_RequiresSynchronousCompilation, addr 0x306b9ac, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DisableOptimizations, addr 0x306b960, size 0x4, virtual false, abstract: false, final false
  inline void set_DisableOptimizations(bool value);

  /// @brief Method set_EnableBurstCompilation, addr 0x306b6b0, size 0x114, virtual false, abstract: false, final false
  inline void set_EnableBurstCompilation(bool value);

  /// @brief Method set_EnableBurstCompileSynchronously, addr 0x306b8a0, size 0x34, virtual false, abstract: false, final false
  inline void set_EnableBurstCompileSynchronously(bool value);

  /// @brief Method set_EnableBurstDebug, addr 0x306b924, size 0x34, virtual false, abstract: false, final false
  inline void set_EnableBurstDebug(bool value);

  /// @brief Method set_EnableBurstSafetyChecks, addr 0x306b7c4, size 0x34, virtual false, abstract: false, final false
  inline void set_EnableBurstSafetyChecks(bool value);

  /// @brief Method set_EnableBurstTimings, addr 0x306b978, size 0x34, virtual false, abstract: false, final false
  inline void set_EnableBurstTimings(bool value);

  /// @brief Method set_EnableFastMath, addr 0x306b96c, size 0x4, virtual false, abstract: false, final false
  inline void set_EnableFastMath(bool value);

  /// @brief Method set_ForceEnableBurstSafetyChecks, addr 0x306b8e8, size 0x34, virtual false, abstract: false, final false
  inline void set_ForceEnableBurstSafetyChecks(bool value);

  /// @brief Method set_OptionsChanged, addr 0x306ba28, size 0x8, virtual false, abstract: false, final false
