...
public:
  // Declarations
  /// @brief Method Pause, addr 0x634f8a0, size 0x4, virtual false, abstract: false, final false
  static inline void Pause();

  /// @brief Method umul128, addr 0x634f8a4, size 0x3c, virtual false, abstract: false, final false
