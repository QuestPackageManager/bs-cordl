...
public:
  ...
  /// @brief Method .ctor, addr 0x648e630, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Burst::Intrinsics::v128 value);

  /// @brief Method get_Byte, addr 0x648e638, size 0x15c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Byte();

  /// @brief Method get_Double, addr 0x648ed74, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<double_t> get_Double();

  /// @brief Method get_Float, addr 0x648ebe0, size 0x9c, virtual false, abstract: false, final false
  inline ::ArrayW<float_t> get_Float();

  /// @brief Method get_SByte, addr 0x648e794, size 0x15c, virtual false, abstract: false, final false
  inline ::ArrayW<int8_t> get_SByte();

  /// @brief Method get_SInt, addr 0x648eb44, size 0x9c, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t> get_SInt();

  /// @brief Method get_SLong, addr 0x648ec7c, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<int64_t> get_SLong();

  /// @brief Method get_SShort, addr 0x648e9cc, size 0xdc, virtual false, abstract: false, final false
  inline ::ArrayW<int16_t> get_SShort();

  /// @brief Method get_UInt, addr 0x648eaa8, size 0x9c, virtual false, abstract: false, final false
  inline ::ArrayW<uint32_t> get_UInt();

  /// @brief Method get_ULong, addr 0x648ecf8, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<uint64_t> get_ULong();

  /// @brief Method get_UShort, addr 0x648e8f0, size 0xdc, virtual false, abstract: false, final false
