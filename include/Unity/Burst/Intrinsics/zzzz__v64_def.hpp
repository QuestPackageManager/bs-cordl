...
public:
  ...
  /// @brief Method .ctor, addr 0x452b4f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(double_t a);

  /// @brief Method .ctor, addr 0x452b4f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t a, float_t b);

  /// @brief Method .ctor, addr 0x452b494, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int16_t a, int16_t b, int16_t c, int16_t d);

  /// @brief Method .ctor, addr 0x452b4d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t a, int32_t b);

  /// @brief Method .ctor, addr 0x452b500, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int64_t a);

  /// @brief Method .ctor, addr 0x452b460, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int8_t a, int8_t b, int8_t c, int8_t d, int8_t e, int8_t f, int8_t g, int8_t h);

  /// @brief Method .ctor, addr 0x452b4b4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(uint16_t a, uint16_t b, uint16_t c, uint16_t d);

  /// @brief Method .ctor, addr 0x452b4e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t a, uint32_t b);

  /// @brief Method .ctor, addr 0x452b508, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint64_t a);

  /// @brief Method .ctor, addr 0x452b42c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(uint8_t a, uint8_t b, uint8_t c, uint8_t d, uint8_t e, uint8_t f, uint8_t g, uint8_t h);

  /// @brief Method .ctor, addr 0x452b454, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int8_t b);

  /// @brief Method .ctor, addr 0x452b420, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint8_t b);

  /// @brief Method .ctor, addr 0x452b4e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t f);

  /// @brief Method .ctor, addr 0x452b488, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int16_t v);

  /// @brief Method .ctor, addr 0x452b4c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t v);

  /// @brief Method .ctor, addr 0x452b4a8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint16_t v);

  /// @brief Method .ctor, addr 0x452b4d8, size 0x8, virtual false, abstract: false, final false
