...
public:
  ...
  /// @brief Method Dispose, addr 0x649e484, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x649e47c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetBit, addr 0x64a6d00, size 0x10, virtual false, abstract: false, final false
  inline bool GetBit(int32_t aindex, int32_t bindex);

  /// @brief Method SetBit, addr 0x64a6cdc, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_IsSse42Supported, addr 0x64a5850, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BurstIntrinsicGetCSRFromManaged, addr 0x64958f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenericCSharpLoad, addr 0x6495858, size 0xc, virtual false, abstract: false, final false
  static inline ::Unity::Burst::Intrinsics::v128 GenericCSharpLoad(void* ptr);

  /// @brief Method GenericCSharpStore, addr 0x6495864, size 0x8, virtual false, abstract: false, final false
  static inline void GenericCSharpStore(void* ptr, ::Unity::Burst::Intrinsics::v128 val);

  /// @brief Method IsNaN, addr 0x64958c8, size 0x14, virtual false, abstract: false, final false
  static inline bool IsNaN(uint32_t v);

  /// @brief Method IsNaN, addr 0x64958dc, size 0x14, virtual false, abstract: false, final false
  static inline bool IsNaN(uint64_t v);

  /// @brief Method Saturate_To_Int16, addr 0x6495898, size 0x20, virtual false, abstract: false, final false
  static inline int16_t Saturate_To_Int16(int32_t val);

  /// @brief Method Saturate_To_Int8, addr 0x649586c, size 0x1c, virtual false, abstract: false, final false
  static inline int8_t Saturate_To_Int8(int32_t val);

  /// @brief Method Saturate_To_UnsignedInt16, addr 0x64958b8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method setcsr_raw, addr 0x649590c, size 0x4, virtual false, abstract: false, final false
