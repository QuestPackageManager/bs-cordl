...
// Ctor Parameters [CppParam { name: "Ptr", ty: "::Unity::Hierarchy::HierarchyNode*", modifiers: "", def_value: Some("{}") }, CppParam { name: "Size", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Capacity", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "RemovedCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Reserved", ty: "::Unity::Hierarchy::HierarchyNodeChildrenAlloc__Reserved_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr ::Unity::Hierarchy::HierarchyNodeChildrenAlloc::HierarchyNodeChildrenAlloc(::Unity::Hierarchy::HierarchyNode*  Ptr, int32_t  Size, int32_t  Capacity, int32_t  RemovedCount, ::Unity::Hierarchy::HierarchyNodeChildrenAlloc__Reserved_e__FixedBuffer  Reserved) noexcept  {
this->Ptr = Ptr;
this->Size = Size;
