...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x69dd094, size 0x24, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchyFlattenedNodeChildren_Enumerator GetEnumerator();

  /// @brief Method ThrowIfVersionChanged, addr 0x69dd0e0, size 0x70, virtual false, abstract: false, final false
  inline void ThrowIfVersionChanged();

  /// @brief Method .ctor, addr 0x69dcdc0, size 0x1b0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x69dd228, size 0x1dc, virtual false, abstract: false, final false
  inline bool MoveNext();

  /// @brief Method .ctor, addr 0x69dd0b8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Hierarchy::HierarchyFlattenedNodeChildren enumerable, ::Unity::Hierarchy::HierarchyNode node);

  /// @brief Method get_Current, addr 0x69dd150, size 0xd8, virtual false, abstract: false, final false
