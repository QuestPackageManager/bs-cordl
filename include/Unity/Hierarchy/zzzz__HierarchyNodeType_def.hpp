...
public:
  ...
  /// @brief Method Equals, addr 0x69e1afc, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69e19d4, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Hierarchy::HierarchyNodeType other);

  /// @brief Method GetHashCode, addr 0x69e1b78, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x69e19e4, size 0x118, virtual true, abstract: false, final false
  inline ::StringW ToString();

  static inline ::Unity::Hierarchy::HierarchyNodeType getStaticF_s_Null();

  /// @brief Method get_Id, addr 0x69e19b8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_Null, addr 0x69e1970, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x69e19c0, size 0x14, virtual false, abstract: false, final false
