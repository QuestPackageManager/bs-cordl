...
public:
  ...
  /// @brief Method Equals, addr 0x69e1614, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69e149c, size 0x14, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Hierarchy::HierarchyFlattenedNode other);

  /// @brief Method GetHashCode, addr 0x69e1690, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetNodeByRef, addr 0x69e1724, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x69e14b0, size 0x164, virtual true, abstract: false, final false
  inline ::StringW ToString();

  static inline ::Unity::Hierarchy::HierarchyFlattenedNode getStaticF_s_Null();

  /// @brief Method get_ChildrenCount, addr 0x69e1494, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ChildrenCount();

  /// @brief Method get_NextSiblingOffset, addr 0x69e148c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NextSiblingOffset();

  /// @brief Method get_Node, addr 0x69e1484, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchyNode get_Node();

  /// @brief Method get_Null, addr 0x69dd45c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x69dd4a4, size 0x14, virtual false, abstract: false, final false
