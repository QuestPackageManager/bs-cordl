...
/// @brief Method Equals, addr 0x696f3cc, size 0x7c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x696f254, size 0x14, virtual true, abstract: false, final true
inline bool Equals(::Unity::Hierarchy::HierarchyFlattenedNode  other) ;

/// @brief Method GetHashCode, addr 0x696f448, size 0x18, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetNodeByRef, addr 0x696f4dc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x696f268, size 0x164, virtual true, abstract: false, final false
inline ::StringW ToString() ;

static inline ::Unity::Hierarchy::HierarchyFlattenedNode getStaticF_s_Null() ;

/// @brief Method get_ChildrenCount, addr 0x696f24c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ChildrenCount() ;

/// @brief Method get_NextSiblingOffset, addr 0x696f244, size 0x8, virtual false, abstract: false, final false
inline int32_t get_NextSiblingOffset() ;

/// @brief Method get_Node, addr 0x696f23c, size 0x8, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::HierarchyNode get_Node() ;

/// @brief Method get_Null, addr 0x696b214, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x696b25c, size 0x14, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Node", ty: "::Unity::Hierarchy::HierarchyNode", modifiers: "", def_value: None }, CppParam { name: "m_Type", ty: "::Unity::Hierarchy::HierarchyNodeType", modifiers: "", def_value: None }, CppParam { name: "m_ParentOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_NextSiblingOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ChildrenCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Depth", ty: "int32_t", modifiers: "", def_value: None }]
constexpr HierarchyFlattenedNode(::Unity::Hierarchy::HierarchyNode  m_Node, ::Unity::Hierarchy::HierarchyNodeType  m_Type, int32_t  m_ParentOffset, int32_t  m_NextSiblingOffset, int32_t  m_ChildrenCount, int32_t  m_Depth) noexcept;
