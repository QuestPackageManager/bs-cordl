...
public:
// Declarations
/// @brief Method ConvertToNative, addr 0x696f184, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x696f21c, size 0x20, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method .ctor, addr 0x696eecc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::Unity::Hierarchy::HierarchyFlattened*  hierarchyFlattened) ;

/// @brief Method get_Current, addr 0x696f198, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Contains, addr 0x696ad9c, size 0x58, virtual false, abstract: false, final false
inline bool Contains(::ByRef<::Unity::Hierarchy::HierarchyNode>  node) ;

/// @brief Method Contains_Injected, addr 0x696ed70, size 0x44, virtual false, abstract: false, final false
static inline bool Contains_Injected(::System::IntPtr  _unity_self, ::ByRef<::Unity::Hierarchy::HierarchyNode>  node) ;

/// @brief Method Create, addr 0x696eaf0, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method CreateHierarchyFlattened, addr 0x696efec, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method Create_Injected, addr 0x696ef80, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method Destroy, addr 0x696ec80, size 0x3c, virtual false, abstract: false, final false
static inline void Destroy(::System::IntPtr  nativePtr) ;

/// @brief Method Dispose, addr 0x696ec18, size 0x68, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x696ebc4, size 0x54, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnumerateChildren, addr 0x696edb4, size 0x18, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::HierarchyFlattenedNodeChildren EnumerateChildren(::ByRef<::Unity::Hierarchy::HierarchyNode>  node) ;

/// @brief Method Finalize, addr 0x696eb7c, size 0x48, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method FromIntPtr, addr 0x696eef8, size 0x88, virtual false, abstract: false, final false
static inline ::Unity::Hierarchy::HierarchyFlattened* FromIntPtr(::System::IntPtr  handlePtr) ;

/// @brief Method GetChildrenCount, addr 0x696adf4, size 0x58, virtual false, abstract: false, final false
inline int32_t GetChildrenCount(::ByRef<::Unity::Hierarchy::HierarchyNode>  node) ;

/// @brief Method GetChildrenCount_Injected, addr 0x696edcc, size 0x44, virtual false, abstract: false, final false
static inline int32_t GetChildrenCount_Injected(::System::IntPtr  _unity_self, ::ByRef<::Unity::Hierarchy::HierarchyNode>  node) ;

/// @brief Method GetEnumerator, addr 0x696ee9c, size 0x30, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::HierarchyFlattened_Enumerator GetEnumerator() ;

/// @brief Method IndexOf, addr 0x696b1bc, size 0x58, virtual false, abstract: false, final false
inline int32_t IndexOf(::ByRef<::Unity::Hierarchy::HierarchyNode>  node) ;

/// @brief Method IndexOf_Injected, addr 0x696ed2c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x696ee10, size 0x50, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateHierarchyFlattened, addr 0x696f0e0, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method Update_Injected, addr 0x696ee60, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x696ea4c, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::Unity::Hierarchy::Hierarchy*  hierarchy) ;

/// @brief Method .ctor, addr 0x696eb68, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x696e9a8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Hierarchy, addr 0x696ea3c, size 0x8, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::Hierarchy* get_Hierarchy() ;

/// @brief Method get_IsCreated, addr 0x696e998, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCreated() ;

/// @brief Method get_Item, addr 0x696ecbc, size 0x70, virtual false, abstract: false, final false
inline ::ByRef<::Unity::Hierarchy::HierarchyFlattenedNode> get_Item(int32_t  index) ;

/// @brief Method get_NodesPtr, addr 0x696d5a4, size 0x8, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::HierarchyFlattenedNode* get_NodesPtr() ;

/// @brief Method get_UpdateNeeded, addr 0x696e9b0, size 0x50, virtual false, abstract: false, final false
inline bool get_UpdateNeeded() ;

/// @brief Method get_UpdateNeeded_Injected, addr 0x696ea00, size 0x3c, virtual false, abstract: false, final false
static inline bool get_UpdateNeeded_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_Version, addr 0x696ea44, size 0x8, virtual false, abstract: false, final false
