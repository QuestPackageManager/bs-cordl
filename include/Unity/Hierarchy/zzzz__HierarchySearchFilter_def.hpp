...
public:
  ...
  /// @brief Method QuoteStringIfNeeded, addr 0x6b37744, size 0xe4, virtual false, abstract: false, final false
  static inline ::StringW QuoteStringIfNeeded(::StringW s);

  /// @brief Method ToString, addr 0x6b37644, size 0x100, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x6b374e8, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Invalid, addr 0x6b373fc, size 0x5c, virtual false, abstract: false, final false
  static inline ::by_ref<::Unity::Hierarchy::HierarchySearchFilter> get_Invalid();

  /// @brief Method get_IsValid, addr 0x6b37458, size 0x70, virtual false, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_Name, addr 0x6b374c8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NumValue, addr 0x6b374d8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_NumValue();

  /// @brief Method get_Op, addr 0x6b374e0, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchySearchFilterOperator get_Op();

  /// @brief Method get_Value, addr 0x6b374d0, size 0x8, virtual false, abstract: false, final false
