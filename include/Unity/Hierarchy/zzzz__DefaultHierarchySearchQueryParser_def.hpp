...
public:
  ...
  /// @brief Method .ctor, addr 0x6b3818c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultHierarchySearchQueryParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultHierarchySearchQueryParser(DefaultHierarchySearchQueryParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultHierarchySearchQueryParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultHierarchySearchQueryParser(DefaultHierarchySearchQueryParserconst&) = delete;
