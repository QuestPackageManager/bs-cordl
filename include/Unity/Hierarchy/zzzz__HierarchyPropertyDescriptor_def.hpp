...
public:
  ...
  /// @brief Method set_Size, addr 0x69e1b80, size 0x8, virtual false, abstract: false, final false
  inline void set_Size(int32_t value);

  /// @brief Method set_Type, addr 0x69e1b88, size 0x8, virtual false, abstract: false, final false
