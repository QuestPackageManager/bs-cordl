...
/// @brief Method set_Size, addr 0x696f938, size 0x8, virtual false, abstract: false, final false
inline void set_Size(int32_t  value) ;

/// @brief Method set_Type, addr 0x696f940, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Size", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Type", ty: "::Unity::Hierarchy::HierarchyPropertyStorageType", modifiers: "", def_value: None }]
