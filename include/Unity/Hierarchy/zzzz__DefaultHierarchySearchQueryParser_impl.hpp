...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::Hierarchy::DefaultHierarchySearchQueryParser::*)()>(&::Unity::Hierarchy::DefaultHierarchySearchQueryParser::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x696d368;
...
::cordl_internals::setStaticField<::System::Text::RegularExpressions::Regex*, "s_Filter", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Hierarchy::DefaultHierarchySearchQueryParser*>::get>(std::forward<::System::Text::RegularExpressions::Regex*>(value));
}
inline ::System::Text::RegularExpressions::Regex* Unity::Hierarchy::DefaultHierarchySearchQueryParser::getStaticF_s_Filter()  {
return ::cordl_internals::getStaticField<::System::Text::RegularExpressions::Regex*, "s_Filter", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Hierarchy::DefaultHierarchySearchQueryParser*>::get>();
}
