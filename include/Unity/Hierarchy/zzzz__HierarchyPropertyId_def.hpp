...
/// @brief Method Equals, addr 0x696fadc, size 0x7c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x696f9b4, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::Unity::Hierarchy::HierarchyPropertyId  other) ;

/// @brief Method GetHashCode, addr 0x696fb58, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x696f9c4, size 0x118, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x696f998, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::Unity::Hierarchy::HierarchyPropertyId getStaticF_s_Null() ;

/// @brief Method get_Id, addr 0x696f990, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Id() ;

/// @brief Method get_Null, addr 0x696f948, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x696f9a0, size 0x14, virtual false, abstract: false, final false
