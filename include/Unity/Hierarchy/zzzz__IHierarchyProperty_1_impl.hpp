...
template <typename T> inline T Unity::Hierarchy::IHierarchyProperty_1<T>::GetValue(/* [IsReadOnly] */ ::by_ref<::Unity::Hierarchy::HierarchyNode> node) {
...
template <typename T> inline void Unity::Hierarchy::IHierarchyProperty_1<T>::SetValue(/* [IsReadOnly] */ ::by_ref<::Unity::Hierarchy::HierarchyNode> node, T value) {
  auto* ___internal_method =
