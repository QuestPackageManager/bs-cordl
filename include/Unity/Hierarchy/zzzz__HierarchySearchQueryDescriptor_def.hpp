...
public:
  ...
  /// @brief Method <.ctor>b__33_0, addr 0x69e2b64, size 0xc4, virtual false, abstract: false, final false
  inline bool __ctor_b__33_0(::Unity::Hierarchy::HierarchySearchFilter f);

  /// @brief Method <.ctor>b__33_1, addr 0x69e2c28, size 0xb8, virtual false, abstract: false, final false
  inline bool __ctor_b__33_1(::Unity::Hierarchy::HierarchySearchFilter f);

  /// @brief Method .ctor, addr 0x69e2b60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildFilterQuery, addr 0x69e2790, size 0x68, virtual false, abstract: false, final false
  inline ::StringW BuildFilterQuery();

  /// @brief Method BuildQuery, addr 0x69e2654, size 0x13c, virtual false, abstract: false, final false
  inline ::StringW BuildQuery();

  /// @brief Method BuildSystemFilterQuery, addr 0x69e27f8, size 0x68, virtual false, abstract: false, final false
  inline ::StringW BuildSystemFilterQuery();

  /// @brief Method BuildTextQuery, addr 0x69e2860, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x69e2650, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69e22ac, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Filters, addr 0x69e227c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::Unity::Hierarchy::HierarchySearchFilter, ::Array<::Unity::Hierarchy::HierarchySearchFilter>*> get_Filters();

  /// @brief Method get_SystemFilters, addr 0x69e226c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::Unity::Hierarchy::HierarchySearchFilter, ::Array<::Unity::Hierarchy::HierarchySearchFilter>*> get_SystemFilters();

  /// @brief Method get_TextValues, addr 0x69e228c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Filters, addr 0x69e2284, size 0x8, virtual false, abstract: false, final false
  inline void set_Filters(::ArrayW<::Unity::Hierarchy::HierarchySearchFilter, ::Array<::Unity::Hierarchy::HierarchySearchFilter>*> value);

  /// @brief Method set_Invalid, addr 0x69e22a4, size 0x8, virtual false, abstract: false, final false
  inline void set_Invalid(bool value);

  /// @brief Method set_Strict, addr 0x69e229c, size 0x8, virtual false, abstract: false, final false
  inline void set_Strict(bool value);

  /// @brief Method set_SystemFilters, addr 0x69e2274, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_TextValues, addr 0x69e2294, size 0x8, virtual false, abstract: false, final false
