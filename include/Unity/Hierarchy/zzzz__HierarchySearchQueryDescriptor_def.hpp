...
/// @brief Method <.ctor>b__33_0, addr 0x697091c, size 0xc4, virtual false, abstract: false, final false
inline bool __ctor_b__33_0(::Unity::Hierarchy::HierarchySearchFilter  f) ;

/// @brief Method <.ctor>b__33_1, addr 0x69709e0, size 0xb8, virtual false, abstract: false, final false
inline bool __ctor_b__33_1(::Unity::Hierarchy::HierarchySearchFilter  f) ;

/// @brief Method .ctor, addr 0x6970918, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <Filters>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__Filters_k__BackingField, put=__cordl_internal_set__Filters_k__BackingField)) ::ArrayW<::Unity::Hierarchy::HierarchySearchFilter,::Array<::Unity::Hierarchy::HierarchySearchFilter>*>  _Filters_k__BackingField;
...
/// @brief Field <SystemFilters>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__SystemFilters_k__BackingField, put=__cordl_internal_set__SystemFilters_k__BackingField)) ::ArrayW<::Unity::Hierarchy::HierarchySearchFilter,::Array<::Unity::Hierarchy::HierarchySearchFilter>*>  _SystemFilters_k__BackingField;

/// @brief Field <TextValues>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__TextValues_k__BackingField, put=__cordl_internal_set__TextValues_k__BackingField)) ::ArrayW<::StringW,::Array<::StringW>*>  _TextValues_k__BackingField;
...
/// @brief Method BuildFilterQuery, addr 0x6970548, size 0x68, virtual false, abstract: false, final false
inline ::StringW BuildFilterQuery() ;

/// @brief Method BuildQuery, addr 0x697040c, size 0x13c, virtual false, abstract: false, final false
inline ::StringW BuildQuery() ;

/// @brief Method BuildSystemFilterQuery, addr 0x69705b0, size 0x68, virtual false, abstract: false, final false
inline ::StringW BuildSystemFilterQuery() ;

/// @brief Method BuildTextQuery, addr 0x6970618, size 0x11c, virtual false, abstract: false, final false
inline ::StringW BuildTextQuery() ;

static inline ::Unity::Hierarchy::HierarchySearchQueryDescriptor* New_ctor(::ArrayW<::Unity::Hierarchy::HierarchySearchFilter,::Array<::Unity::Hierarchy::HierarchySearchFilter>*>  filters, ::ArrayW<::StringW,::Array<::StringW>*>  textValues) ;

/// @brief Method ToString, addr 0x6970408, size 0x4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Where, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ArrayW<T,::Array<T>*> Where(::System::Collections::Generic::IEnumerable_1<T>*  src, ::System::Func_2<T,bool>*  pred) ;
...
/// @brief Method .ctor, addr 0x6970064, size 0x3a4, virtual false, abstract: false, final false
...
/// @brief Method get_Filters, addr 0x6970034, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::Unity::Hierarchy::HierarchySearchFilter,::Array<::Unity::Hierarchy::HierarchySearchFilter>*> get_Filters() ;

/// @brief Method get_SystemFilters, addr 0x6970024, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::Unity::Hierarchy::HierarchySearchFilter,::Array<::Unity::Hierarchy::HierarchySearchFilter>*> get_SystemFilters() ;

/// @brief Method get_TextValues, addr 0x6970044, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Filters, addr 0x697003c, size 0x8, virtual false, abstract: false, final false
inline void set_Filters(::ArrayW<::Unity::Hierarchy::HierarchySearchFilter,::Array<::Unity::Hierarchy::HierarchySearchFilter>*>  value) ;

/// @brief Method set_Invalid, addr 0x697005c, size 0x8, virtual false, abstract: false, final false
inline void set_Invalid(bool  value) ;

/// @brief Method set_Strict, addr 0x6970054, size 0x8, virtual false, abstract: false, final false
inline void set_Strict(bool  value) ;

/// @brief Method set_SystemFilters, addr 0x697002c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_TextValues, addr 0x697004c, size 0x8, virtual false, abstract: false, final false
