...
public:
  ...
  /// @brief Method Equals, addr 0x69e18e4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69e1740, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Hierarchy::HierarchyNode other);

  /// @brief Method GetHashCode, addr 0x69e16a8, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x69e1768, size 0x17c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x69e1738, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Unity::Hierarchy::HierarchyNode getStaticF_s_Null();

  /// @brief Method get_Id, addr 0x69e1728, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_Null, addr 0x69dcf70, size 0x48, virtual false, abstract: false, final false
  static inline ::ByRef<::Unity::Hierarchy::HierarchyNode> get_Null();

  /// @brief Method get_Version, addr 0x69e1730, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x69dcfb8, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Equality(::ByRef<::Unity::Hierarchy::HierarchyNode> lhs, ::ByRef<::Unity::Hierarchy::HierarchyNode> rhs);

  /// @brief Method op_Inequality, addr 0x69dd604, size 0x2c, virtual false, abstract: false, final false
