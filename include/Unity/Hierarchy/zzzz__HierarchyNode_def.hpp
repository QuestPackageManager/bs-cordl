...
public:
  ...
  /// @brief Method Equals, addr 0x6906158, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6905fb4, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Hierarchy::HierarchyNode other);

  /// @brief Method GetHashCode, addr 0x6905f1c, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x6905fdc, size 0x17c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6905fac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Unity::Hierarchy::HierarchyNode getStaticF_s_Null();

  /// @brief Method get_Id, addr 0x6905f9c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_Null, addr 0x69017e4, size 0x48, virtual false, abstract: false, final false
  static inline ::ByRef<::Unity::Hierarchy::HierarchyNode> get_Null();

  /// @brief Method get_Version, addr 0x6905fa4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x690182c, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Equality(::ByRef<::Unity::Hierarchy::HierarchyNode> lhs, ::ByRef<::Unity::Hierarchy::HierarchyNode> rhs);

  /// @brief Method op_Inequality, addr 0x6901e78, size 0x2c, virtual false, abstract: false, final false
