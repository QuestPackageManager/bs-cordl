...
public:
  ...
  /// @brief Method Equals, addr 0x6b36f38, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b36d94, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Hierarchy::HierarchyNode other);

  /// @brief Method GetHashCode, addr 0x6b36cfc, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x6b36dbc, size 0x17c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b36d8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Unity::Hierarchy::HierarchyNode getStaticF_s_Null();

  /// @brief Method get_Id, addr 0x6b36d7c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_Null, addr 0x6b325c4, size 0x48, virtual false, abstract: false, final false
  static inline ::by_ref<::Unity::Hierarchy::HierarchyNode> get_Null();

  /// @brief Method get_Version, addr 0x6b36d84, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b3260c, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Equality(::by_ref<::Unity::Hierarchy::HierarchyNode> lhs, ::by_ref<::Unity::Hierarchy::HierarchyNode> rhs);

  /// @brief Method op_Inequality, addr 0x6b32c58, size 0x2c, virtual false, abstract: false, final false
