...
public:
  ...
  /// @brief Method Dispose, addr 0x69df344, size 0xa4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x69df594, size 0x1c, virtual false, abstract: false, final false
  inline bool MoveNext();

  /// @brief Method .ctor, addr 0x69df048, size 0x1e4, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Hierarchy::Hierarchy* hierarchy);

  /// @brief Method get_Current, addr 0x69df3e8, size 0x1ac, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x69df020, size 0x28, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchyNodeTypeHandlerBaseEnumerable_Enumerator GetEnumerator();

  /// @brief Method .ctor, addr 0x69df018, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Hierarchy::Hierarchy* hierarchy);
