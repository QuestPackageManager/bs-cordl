...
/// @brief Method Dispose, addr 0x696d0fc, size 0xa4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MoveNext, addr 0x696d34c, size 0x1c, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method .ctor, addr 0x696ce00, size 0x1e4, virtual false, abstract: false, final false
inline void _ctor(::Unity::Hierarchy::Hierarchy*  hierarchy) ;

/// @brief Method get_Current, addr 0x696d1a0, size 0x1ac, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Handlers", ty: "::System::Buffers::IMemoryOwner_1<::System::IntPtr>*", modifiers: "", def_value: None }, CppParam { name: "m_Count", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Index", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method GetEnumerator, addr 0x696cdd8, size 0x28, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::HierarchyNodeTypeHandlerBaseEnumerable_Enumerator GetEnumerator() ;

/// @brief Method .ctor, addr 0x696cdd0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Unity::Hierarchy::Hierarchy*  hierarchy) ;
