...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x69e3c20, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x69e3d14, size 0x5c4, virtual false, abstract: false, final false
  inline bool MoveNext();

  /// @brief Method .ctor, addr 0x69e36e4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Hierarchy::HierarchyViewModel* hierarchyViewModel);

  /// @brief Method get_Current, addr 0x69e3c34, size 0xe0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearFlags, addr 0x69e3510, size 0x4, virtual false, abstract: false, final false
  inline void ClearFlags(::ByRef<::Unity::Hierarchy::HierarchyNode> node, ::Unity::Hierarchy::HierarchyNodeFlags flags, bool recurse);

  /// @brief Method ClearFlagsNode, addr 0x69e3514, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearFlagsNode_Injected, addr 0x69e38bc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x69e32f8, size 0x58, virtual false, abstract: false, final false
  inline bool Contains(::ByRef<::Unity::Hierarchy::HierarchyNode> node);

  /// @brief Method Contains_Injected, addr 0x69e3350, size 0x44, virtual false, abstract: false, final false
  static inline bool Contains_Injected(::System::IntPtr _unity_self, ::ByRef<::Unity::Hierarchy::HierarchyNode> node);

  /// @brief Method Create, addr 0x69e2f2c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHierarchyViewModel, addr 0x69e3918, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Create_Injected, addr 0x69e3798, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Destroy, addr 0x69e314c, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy(::System::IntPtr nativePtr);

  /// @brief Method Dispose, addr 0x69e30e4, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x69e3090, size 0x54, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnumerateNodesWithAllFlags, addr 0x69e3584, size 0x9c, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchyViewNodesEnumerable EnumerateNodesWithAllFlags(::Unity::Hierarchy::HierarchyNodeFlags flags);

  /// @brief Method Finalize, addr 0x69e3048, size 0x48, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method FromIntPtr, addr 0x69e3710, size 0x88, virtual false, abstract: false, final false
  static inline ::Unity::Hierarchy::HierarchyViewModel* FromIntPtr(::System::IntPtr handlePtr);

  /// @brief Method GetChildrenCount, addr 0x69e3394, size 0x58, virtual false, abstract: false, final false
  inline int32_t GetChildrenCount(::ByRef<::Unity::Hierarchy::HierarchyNode> node);

  /// @brief Method GetChildrenCount_Injected, addr 0x69e33ec, size 0x44, virtual false, abstract: false, final false
  static inline int32_t GetChildrenCount_Injected(::System::IntPtr _unity_self, ::ByRef<::Unity::Hierarchy::HierarchyNode> node);

  /// @brief Method GetEnumerator, addr 0x69e36ac, size 0x38, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchyViewModel_Enumerator GetEnumerator();

  /// @brief Method HasAllFlags, addr 0x69e34a4, size 0x4, virtual false, abstract: false, final false
  inline bool HasAllFlags(::ByRef<::Unity::Hierarchy::HierarchyNode> node, ::Unity::Hierarchy::HierarchyNodeFlags flags);

  /// @brief Method HasAllFlagsNode, addr 0x69e34a8, size 0x68, virtual false, abstract: false, final false
  inline bool HasAllFlagsNode(::ByRef<::Unity::Hierarchy::HierarchyNode> node, ::Unity::Hierarchy::HierarchyNodeFlags flags);

  /// @brief Method HasAllFlagsNode_Injected, addr 0x69e3868, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x69e325c, size 0x58, virtual false, abstract: false, final false
  inline int32_t IndexOf(::ByRef<::Unity::Hierarchy::HierarchyNode> node);

  /// @brief Method IndexOf_Injected, addr 0x69e32b4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SearchBegin, addr 0x69e3ac0, size 0x160, virtual false, abstract: false, final false
  static inline void SearchBegin(::System::IntPtr handlePtr);

  /// @brief Method SetFlags, addr 0x69e3430, size 0x4, virtual false, abstract: false, final false
  inline void SetFlags(::ByRef<::Unity::Hierarchy::HierarchyNode> node, ::Unity::Hierarchy::HierarchyNodeFlags flags, bool recurse);

  /// @brief Method SetFlagsNode, addr 0x69e3434, size 0x70, virtual false, abstract: false, final false
  inline void SetFlagsNode(::ByRef<::Unity::Hierarchy::HierarchyNode> node, ::Unity::Hierarchy::HierarchyNodeFlags flags, bool recurse);

  /// @brief Method SetFlagsNode_Injected, addr 0x69e380c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x69e3620, size 0x50, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateHierarchyViewModel, addr 0x69e3a1c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method Update_Injected, addr 0x69e3670, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69e2e28, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Hierarchy::HierarchyFlattened* hierarchyFlattened, ::Unity::Hierarchy::HierarchyNodeFlags defaultFlags);

  /// @brief Method .ctor, addr 0x69e2fac, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x69e2cf0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_HierarchyFlattened, addr 0x69e2d84, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchyFlattened* get_HierarchyFlattened();

  /// @brief Method get_IsCreated, addr 0x69e2ce0, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCreated();

  /// @brief Method get_Item, addr 0x69e3188, size 0xd4, virtual false, abstract: false, final false
  inline ::ByRef<::Unity::Hierarchy::HierarchyNode> get_Item(int32_t index);

  /// @brief Method get_Query, addr 0x69e2d9c, size 0x50, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchySearchQueryDescriptor* get_Query();

  /// @brief Method get_Query_Injected, addr 0x69e2dec, size 0x3c, virtual false, abstract: false, final false
  static inline ::Unity::Hierarchy::HierarchySearchQueryDescriptor* get_Query_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_UpdateNeeded, addr 0x69e2cf8, size 0x50, virtual false, abstract: false, final false
  inline bool get_UpdateNeeded();

  /// @brief Method get_UpdateNeeded_Injected, addr 0x69e2d48, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_UpdateNeeded_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_Version, addr 0x69e2d8c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Version();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_QueryParser, addr 0x69e2d94, size 0x8, virtual false, abstract: false, final false
