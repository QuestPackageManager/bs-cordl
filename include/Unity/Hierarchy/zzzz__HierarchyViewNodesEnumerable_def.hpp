...
public:
// Declarations
/// @brief Method Invoke, addr 0x696d590, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x696d510, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x696d630, size 0xd4, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method ThrowIfVersionChanged, addr 0x696d704, size 0x70, virtual false, abstract: false, final false
inline void ThrowIfVersionChanged() ;

/// @brief Method .ctor, addr 0x696d4c8, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::Unity::Hierarchy::HierarchyViewNodesEnumerable  enumerable) ;

/// @brief Method get_Current, addr 0x696d5ac, size 0x84, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_HierarchyFlattened", ty: "::Unity::Hierarchy::HierarchyFlattened*", modifiers: "", def_value: None }, CppParam { name: "m_Predicate", ty: "::Unity::Hierarchy::HierarchyViewNodesEnumerable_Predicate*", modifiers: "", def_value: None }, CppParam { name: "m_Flags", ty: "::Unity::Hierarchy::HierarchyNodeFlags", modifiers: "", def_value: None }, CppParam { name: "m_NodesPtr", ty: "::Unity::Hierarchy::HierarchyFlattenedNode*", modifiers: "", def_value: None }, CppParam { name: "m_NodesCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Version", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Index", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method GetEnumerator, addr 0x696d48c, size 0x3c, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::HierarchyViewNodesEnumerable_Enumerator GetEnumerator() ;

/// @brief Method .ctor, addr 0x696d404, size 0x88, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_HierarchyViewModel", ty: "::Unity::Hierarchy::HierarchyViewModel*", modifiers: "", def_value: None }, CppParam { name: "m_Predicate", ty: "::Unity::Hierarchy::HierarchyViewNodesEnumerable_Predicate*", modifiers: "", def_value: None }, CppParam { name: "m_Flags", ty: "::Unity::Hierarchy::HierarchyNodeFlags", modifiers: "", def_value: None }]
