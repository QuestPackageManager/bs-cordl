...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x69df7d8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69df758, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x69df878, size 0xd4, virtual false, abstract: false, final false
  inline bool MoveNext();

  /// @brief Method ThrowIfVersionChanged, addr 0x69df94c, size 0x70, virtual false, abstract: false, final false
  inline void ThrowIfVersionChanged();

  /// @brief Method .ctor, addr 0x69df710, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Hierarchy::HierarchyViewNodesEnumerable enumerable);

  /// @brief Method get_Current, addr 0x69df7f4, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x69df6d4, size 0x3c, virtual false, abstract: false, final false
  inline ::Unity::Hierarchy::HierarchyViewNodesEnumerable_Enumerator GetEnumerator();

  /// @brief Method .ctor, addr 0x69df64c, size 0x88, virtual false, abstract: false, final false
