...
template <typename T> inline void Unity::Jobs::__IJobParallelForExtensions__ParallelForJobStruct_1<T>::setStaticF_jobReflectionData(::System::IntPtr value) {
  ::cordl_internals::setStaticField<::System::IntPtr, "jobReflectionData",
...
template <typename T> inline ::System::IntPtr Unity::Jobs::__IJobParallelForExtensions__ParallelForJobStruct_1<T>::getStaticF_jobReflectionData() {
