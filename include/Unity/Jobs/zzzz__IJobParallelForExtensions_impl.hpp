...
GlobalNamespace::__IJobParallelForExtensions__ParallelForJobStruct_1__ExecuteJobFunction<T>::New_ctor(::System::Object* object, ::System::IntPtr method) {
...
template <typename T> inline void GlobalNamespace::__IJobParallelForExtensions__ParallelForJobStruct_1__ExecuteJobFunction<T>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__IJobParallelForExtensions__ParallelForJobStruct_1__ExecuteJobFunction<T>*>::get(),
...
template <typename T>
inline void GlobalNamespace::__IJobParallelForExtensions__ParallelForJobStruct_1__ExecuteJobFunction<T>::Invoke(ByRef<T> data, ::System::IntPtr additionalPtr, ::System::IntPtr bufferRangePatchData,
...
template <typename T>
inline void
Unity::Jobs::__IJobParallelForExtensions__ParallelForJobStruct_1<T>::setStaticF_jobReflectionData(::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<::System::IntPtr> value) {
...
template <typename T> inline void Unity::Jobs::__IJobParallelForExtensions__ParallelForJobStruct_1<T>::Initialize() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Jobs::__IJobParallelForExtensions__ParallelForJobStruct_1<T>>::get(), "Initialize",
                                               std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(nullptr, ___internal_method);
}
template <typename T>
inline void Unity::Jobs::__IJobParallelForExtensions__ParallelForJobStruct_1<T>::Execute(ByRef<T> jobData, ::System::IntPtr additionalPtr, ::System::IntPtr bufferRangePatchData,
                                                                                         ByRef<::Unity::Jobs::LowLevel::Unsafe::JobRanges> ranges, int32_t jobIndex) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Jobs::__IJobParallelForExtensions__ParallelForJobStruct_1<T>>::get(), "Execute", std::span<Il2CppClass const* const, 0>(),
