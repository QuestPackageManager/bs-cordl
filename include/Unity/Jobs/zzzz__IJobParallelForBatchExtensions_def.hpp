...
template<typename T>
static inline void RunBatchByRef(::ByRef<T>  jobData, int32_t  arrayLength) ;

/// @brief Method RunByRef, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void RunByRef(::ByRef<T>  jobData, int32_t  arrayLength, int32_t  indicesPerJobCount) ;
...
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleBatchByRef(::ByRef<T>  jobData, int32_t  arrayLength, int32_t  indicesPerJobCount, ::Unity::Jobs::JobHandle  dependsOn) ;

/// @brief Method ScheduleByRef, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleByRef(::ByRef<T>  jobData, int32_t  arrayLength, int32_t  indicesPerJobCount, ::Unity::Jobs::JobHandle  dependsOn) ;
...
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleParallelByRef(::ByRef<T>  jobData, int32_t  arrayLength, int32_t  indicesPerJobCount, ::Unity::Jobs::JobHandle  dependsOn) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Unity::Jobs::JobParallelForBatchProducer_1_IJobParallelForBatchExtensions_ExecuteJobFunction, "Unity.Jobs", "IJobParallelForBatchExtensions/JobParallelForBatchProducer`1/ExecuteJobFunction");
