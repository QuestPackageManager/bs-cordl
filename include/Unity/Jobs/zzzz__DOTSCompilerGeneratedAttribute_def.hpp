...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DOTSCompilerGeneratedAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DOTSCompilerGeneratedAttribute(DOTSCompilerGeneratedAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DOTSCompilerGeneratedAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DOTSCompilerGeneratedAttribute(DOTSCompilerGeneratedAttributeconst&) = delete;
