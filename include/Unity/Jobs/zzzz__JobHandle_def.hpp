...
public:
  ...
  /// @brief Method CombineDependencies, addr 0x485d518, size 0x28, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle CombineDependencies(::Unity::Jobs::JobHandle job0, ::Unity::Jobs::JobHandle job1);

  /// @brief Method CombineDependencies, addr 0x485d59c, size 0x60, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle CombineDependencies(::Unity::Collections::NativeArray_1<::Unity::Jobs::JobHandle> jobs);

  /// @brief Method CombineDependencies, addr 0x485d658, size 0x98, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle CombineDependencies(::Unity::Collections::NativeSlice_1<::Unity::Jobs::JobHandle> jobs);

  /// @brief Method CombineDependenciesInternal2, addr 0x485d540, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CombineDependenciesInternal2_Injected, addr 0x485d6f0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CombineDependenciesInternalPtr, addr 0x485d5fc, size 0x5c, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle CombineDependenciesInternalPtr(::cordl_internals::Ptr<void> jobs, int32_t count);

  /// @brief Method CombineDependenciesInternalPtr_Injected, addr 0x485d744, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Complete, addr 0x485d3ec, size 0x50, virtual false, abstract: false, final false
  inline void Complete();

  /// @brief Method Equals, addr 0x485d798, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Jobs::JobHandle other);

  /// @brief Method ScheduleBatchedJobs, addr 0x485d4f0, size 0x28, virtual false, abstract: false, final false
  static inline void ScheduleBatchedJobs();

  /// @brief Method ScheduleBatchedJobsAndComplete, addr 0x485d43c, size 0x3c, virtual false, abstract: false, final false
  static inline void ScheduleBatchedJobsAndComplete(::ByRef<::Unity::Jobs::JobHandle> job);

  /// @brief Method ScheduleBatchedJobsAndIsCompleted, addr 0x485d4b4, size 0x3c, virtual false, abstract: false, final false
  static inline bool ScheduleBatchedJobsAndIsCompleted(::ByRef<::Unity::Jobs::JobHandle> job);

  /// @brief Method get_IsCompleted, addr 0x485d478, size 0x3c, virtual false, abstract: false, final false
