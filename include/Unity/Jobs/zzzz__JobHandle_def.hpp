...
public:
  ...
  /// @brief Method Complete addr 0x2b38c10 size 0x8c virtual false final false
  inline void Complete();

  /// @brief Method get_IsCompleted addr 0x2b38cd8 size 0x3c virtual false final false
  inline bool get_IsCompleted();

  /// @brief Method ScheduleBatchedJobs addr 0x2b38d50 size 0x28 virtual false final false
  static inline void ScheduleBatchedJobs();

  /// @brief Method ScheduleBatchedJobsAndComplete addr 0x2b38c9c size 0x3c virtual false final false
  static inline void ScheduleBatchedJobsAndComplete(ByRef<::Unity::Jobs::JobHandle> job);

  /// @brief Method ScheduleBatchedJobsAndIsCompleted addr 0x2b38d14 size 0x3c virtual false final false
  static inline bool ScheduleBatchedJobsAndIsCompleted(ByRef<::Unity::Jobs::JobHandle> job);

  /// @brief Method CombineDependencies addr 0x2b38d78 size 0x28 virtual false final false
  static inline ::Unity::Jobs::JobHandle CombineDependencies(::Unity::Jobs::JobHandle job0, ::Unity::Jobs::JobHandle job1);

  /// @brief Method CombineDependenciesInternal2 addr 0x2b38da0 size 0x5c virtual false final false
  ...
  /// @brief Method CombineDependenciesInternal2_Injected addr 0x2b38dfc size 0x54 virtual false final false
