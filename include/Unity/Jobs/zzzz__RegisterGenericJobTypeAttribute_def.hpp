...
public:
  ...
  /// @brief Method .ctor, addr 0x64a7b28, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RegisterGenericJobTypeAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RegisterGenericJobTypeAttribute(RegisterGenericJobTypeAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RegisterGenericJobTypeAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RegisterGenericJobTypeAttribute(RegisterGenericJobTypeAttributeconst&) = delete;
