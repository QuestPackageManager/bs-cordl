...
inline void GlobalNamespace::__IJobExtensions__JobStruct_1__ExecuteJobFunction<T>::Invoke(ByRef<T> data, void* additionalPtr, void* bufferRangePatchData,
  ...
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__IJobExtensions__JobStruct_1__ExecuteJobFunction<T>*>::get(), "Invoke", std::vector<Il2CppClass*>{},
