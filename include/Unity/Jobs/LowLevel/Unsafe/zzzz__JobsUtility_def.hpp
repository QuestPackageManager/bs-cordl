...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x688f878, size 0x10, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x688f8f0, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::Unity::Jobs::LowLevel::Unsafe::JobsUtility_PanicFunction_* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x688f888, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateJobReflectionData, addr 0x688f650, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJobReflectionData, addr 0x688f6b0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJobReflectionData, addr 0x688f5e4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetJobQueueWorkerThreadCount, addr 0x688f770, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetJobQueueWorkerThreadCount();

  /// @brief Method GetJobRange, addr 0x688f274, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWorkStealingRange, addr 0x688f298, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokePanicFunction, addr 0x688f810, size 0x68, virtual false, abstract: false, final false
  static inline void InvokePanicFunction();

  /// @brief Method Schedule, addr 0x688f2f4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor, addr 0x688f38c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForDeferArraySize, addr 0x688f454, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForDeferArraySize_Injected, addr 0x688f4c8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForTransform, addr 0x688f534, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForTransform_Injected, addr 0x688f590, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor_Injected, addr 0x688f3f8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Schedule_Injected, addr 0x688f348, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsExecutingJob, addr 0x688f70c, size 0x28, virtual false, abstract: false, final false
  static inline bool get_IsExecutingJob();

  /// @brief Method get_JobWorkerCount, addr 0x688f798, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_JobWorkerCount();

  /// @brief Method get_ThreadIndex, addr 0x688f7c0, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_ThreadIndex();

  /// @brief Method get_ThreadIndexCount, addr 0x688f7e8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method set_JobCompilerEnabled, addr 0x688f734, size 0x3c, virtual false, abstract: false, final false
