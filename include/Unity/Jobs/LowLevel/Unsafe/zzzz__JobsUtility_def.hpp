...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x4860244, size 0x38, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x4860304, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::Unity::Jobs::LowLevel::Unsafe::JobsUtility_PanicFunction_* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x486027c, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateJobReflectionData, addr 0x4860144, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJobReflectionData, addr 0x48600d8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWorkStealingRange, addr 0x485ff1c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokePanicFunction, addr 0x48601e0, size 0x64, virtual false, abstract: false, final false
  static inline void InvokePanicFunction();

  /// @brief Method Schedule, addr 0x485ff78, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor, addr 0x4860010, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor_Injected, addr 0x486007c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Schedule_Injected, addr 0x485ffcc, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_JobCompilerEnabled, addr 0x48601a4, size 0x3c, virtual false, abstract: false, final false
