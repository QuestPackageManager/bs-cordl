...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6901f44, size 0x10, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6901fbc, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::Unity::Jobs::LowLevel::Unsafe::JobsUtility_PanicFunction_* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x6901f54, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateJobReflectionData, addr 0x6901d1c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJobReflectionData, addr 0x6901d7c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJobReflectionData, addr 0x6901cb0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetJobQueueWorkerThreadCount, addr 0x6901e3c, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetJobQueueWorkerThreadCount();

  /// @brief Method GetJobRange, addr 0x6901940, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWorkStealingRange, addr 0x6901964, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokePanicFunction, addr 0x6901edc, size 0x68, virtual false, abstract: false, final false
  static inline void InvokePanicFunction();

  /// @brief Method Schedule, addr 0x69019c0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor, addr 0x6901a58, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForDeferArraySize, addr 0x6901b20, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForDeferArraySize_Injected, addr 0x6901b94, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForTransform, addr 0x6901c00, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelForTransform_Injected, addr 0x6901c5c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor_Injected, addr 0x6901ac4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Schedule_Injected, addr 0x6901a14, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsExecutingJob, addr 0x6901dd8, size 0x28, virtual false, abstract: false, final false
  static inline bool get_IsExecutingJob();

  /// @brief Method get_JobWorkerCount, addr 0x6901e64, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_JobWorkerCount();

  /// @brief Method get_ThreadIndex, addr 0x6901e8c, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_ThreadIndex();

  /// @brief Method get_ThreadIndexCount, addr 0x6901eb4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method set_JobCompilerEnabled, addr 0x6901e00, size 0x3c, virtual false, abstract: false, final false
