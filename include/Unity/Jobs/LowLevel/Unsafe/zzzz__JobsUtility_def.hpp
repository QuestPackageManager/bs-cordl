...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x31cbb1c, size 0x38, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x31cbc10, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::Unity::Jobs::LowLevel::Unsafe::__JobsUtility__PanicFunction_* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x31cbb54, size 0xbc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateJobReflectionData, addr 0x31cba58, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJobReflectionData, addr 0x31cb9ec, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWorkStealingRange, addr 0x31cb830, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokePanicFunction, addr 0x31cbab8, size 0x64, virtual false, abstract: false, final false
  static inline void InvokePanicFunction();

  /// @brief Method Schedule, addr 0x31cb88c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor, addr 0x31cb924, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleParallelFor_Injected, addr 0x31cb990, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Schedule_Injected, addr 0x31cb8e0, size 0x44, virtual false, abstract: false, final false
