...
public:
// Declarations
/// @brief Method .ctor, addr 0x688ff38, size 0x10, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Invoke, addr 0x688ffb0, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::Unity::Jobs::LowLevel::Unsafe::JobsUtility_PanicFunction_* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x688ff48, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method CreateJobReflectionData, addr 0x688fd10, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method CreateJobReflectionData, addr 0x688fd70, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method CreateJobReflectionData, addr 0x688fca4, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method GetJobQueueWorkerThreadCount, addr 0x688fe30, size 0x28, virtual false, abstract: false, final false
static inline int32_t GetJobQueueWorkerThreadCount() ;

/// @brief Method GetJobRange, addr 0x688f934, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetWorkStealingRange, addr 0x688f958, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method InvokePanicFunction, addr 0x688fed0, size 0x68, virtual false, abstract: false, final false
static inline void InvokePanicFunction() ;

/// @brief Method Schedule, addr 0x688f9b4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method ScheduleParallelFor, addr 0x688fa4c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method ScheduleParallelForDeferArraySize, addr 0x688fb14, size 0x74, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleParallelForDeferArraySize(::ByRef<::Unity::Jobs::LowLevel::Unsafe::JobsUtility_JobScheduleParameters>  parameters, int32_t  innerloopBatchCount, void*  listData, void*  listDataAtomicSafetyHandle) ;

/// @brief Method ScheduleParallelForDeferArraySize_Injected, addr 0x688fb88, size 0x6c, virtual false, abstract: false, final false
static inline void ScheduleParallelForDeferArraySize_Injected(::ByRef<::Unity::Jobs::LowLevel::Unsafe::JobsUtility_JobScheduleParameters>  parameters, int32_t  innerloopBatchCount, void*  listData, void*  listDataAtomicSafetyHandle, ::ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method ScheduleParallelForTransform, addr 0x688fbf4, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method ScheduleParallelForTransform_Injected, addr 0x688fc50, size 0x54, virtual false, abstract: false, final false
static inline void ScheduleParallelForTransform_Injected(::ByRef<::Unity::Jobs::LowLevel::Unsafe::JobsUtility_JobScheduleParameters>  parameters, ::System::IntPtr  transfromAccesssArray, ::ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method ScheduleParallelFor_Injected, addr 0x688fab8, size 0x5c, virtual false, abstract: false, final false
static inline void ScheduleParallelFor_Injected(::ByRef<::Unity::Jobs::LowLevel::Unsafe::JobsUtility_JobScheduleParameters>  parameters, int32_t  arrayLength, int32_t  innerloopBatchCount, ::ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method Schedule_Injected, addr 0x688fa08, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method get_IsExecutingJob, addr 0x688fdcc, size 0x28, virtual false, abstract: false, final false
static inline bool get_IsExecutingJob() ;

/// @brief Method get_JobWorkerCount, addr 0x688fe58, size 0x28, virtual false, abstract: false, final false
static inline int32_t get_JobWorkerCount() ;

/// @brief Method get_ThreadIndex, addr 0x688fe80, size 0x28, virtual false, abstract: false, final false
static inline int32_t get_ThreadIndex() ;

/// @brief Method get_ThreadIndexCount, addr 0x688fea8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method set_JobCompilerEnabled, addr 0x688fdf4, size 0x3c, virtual false, abstract: false, final false
