...
// Ctor Parameters [CppParam { name: "BatchSize", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "NumJobs", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "TotalIterationCount", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "StartEndIndex", ty: "::System::IntPtr", modifiers:
