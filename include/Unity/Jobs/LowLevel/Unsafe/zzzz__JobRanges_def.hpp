...
// Ctor Parameters [CppParam { name: "BatchSize", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "NumJobs", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "TotalIterationCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "StartEndIndex", ty: "::System::IntPtr", modifiers: "", def_value: None }]
