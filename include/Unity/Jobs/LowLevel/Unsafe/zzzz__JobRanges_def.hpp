...
DEFINE_IL2CPP_CLASS(::Unity::Jobs::LowLevel::Unsafe::JobRanges, "Unity.Jobs.LowLevel.Unsafe", "JobRanges");
...
static_assert(sizeof(::Unity::Jobs::LowLevel::Unsafe::JobRanges) == 0x18, "Size mismatch!");
