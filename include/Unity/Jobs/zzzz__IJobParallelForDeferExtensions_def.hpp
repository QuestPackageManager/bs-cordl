...
inline ::System::IAsyncResult* BeginInvoke(::ByRef<T>  jobData, ::System::IntPtr  additionalPtr, ::System::IntPtr  bufferRangePatchData, ::ByRef<::Unity::Jobs::LowLevel::Unsafe::JobRanges>  ranges, int32_t  jobIndex, ::System::AsyncCallback*  callback, ::System::Object*  object) ;
...
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleByRef(::ByRef<T>  jobData, int32_t*  forEachCount, int32_t  innerloopBatchCount, ::Unity::Jobs::JobHandle  dependsOn) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Unity::Jobs::JobParallelForDeferProducer_1_IJobParallelForDeferExtensions_ExecuteJobFunction, "Unity.Jobs", "IJobParallelForDeferExtensions/JobParallelForDeferProducer`1/ExecuteJobFunction");
