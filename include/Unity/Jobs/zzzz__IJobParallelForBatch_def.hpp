...
// [JobProducerType(typeof(Unity.Jobs.IJobParallelForBatchExtensions::JobParallelForBatchProducer`1<T>))]
// Dependencies
namespace Unity::Jobs {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IJobParallelForBatch", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IJobParallelForBatch(IJobParallelForBatchconst&) = delete;
