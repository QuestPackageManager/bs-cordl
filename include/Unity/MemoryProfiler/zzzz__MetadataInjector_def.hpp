...
public:
  ...
  /// @brief Method InitializeMetadataCollection, addr 0x6691c74, size 0x74, virtual false, abstract: false, final false
  static inline void InitializeMetadataCollection();

  /// [RuntimeInitializeOnLoadMethod((UnityEngine.RuntimeInitializeLoadType)3)]
  /// @brief Method PlayerInitMetadata, addr 0x6691acc, size 0x98, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetadataInjector", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MetadataInjector(MetadataInjector&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MetadataInjector", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetadataInjector(MetadataInjectorconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23670 };
