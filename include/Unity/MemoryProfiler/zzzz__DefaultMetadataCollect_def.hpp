...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultMetadataCollect", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultMetadataCollect(DefaultMetadataCollect&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultMetadataCollect", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultMetadataCollect(DefaultMetadataCollectconst&) = delete;
