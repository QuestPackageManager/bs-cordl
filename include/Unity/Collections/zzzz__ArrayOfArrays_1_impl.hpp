...
// Ctor Parameters [CppParam { name: "m_backingAllocatorHandle", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "m_lengthInElements", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_capacityInElements", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "m_log2BlockSizeInElements", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_blocks", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "m_block", ty: "::System::IntPtr*", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
