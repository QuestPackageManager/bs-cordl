...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Unity::Collections::NativeStreamDisposeJob::*)()>(&::Unity::Collections::NativeStreamDisposeJob::Execute)> {
  ...
  constexpr static std::size_t addrs = 0x64c3c94;
...
// Ctor Parameters [CppParam { name: "Data", ty: "::Unity::Collections::NativeStreamDispose", modifiers: "", def_value: Some("{}"), comment: None }]
