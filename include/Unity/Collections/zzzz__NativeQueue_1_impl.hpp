...
// Ctor Parameters [CppParam { name: "m_Enumerator", ty: "::Unity::Collections::UnsafeQueue_1_Enumerator<T>", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
...
// Ctor Parameters [CppParam { name: "m_ReadOnly", ty: "::Unity::Collections::UnsafeQueue_1_ReadOnly<T>", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
...
// Ctor Parameters [CppParam { name: "unsafeWriter", ty: "::Unity::Collections::UnsafeQueue_1_ParallelWriter<T>", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
