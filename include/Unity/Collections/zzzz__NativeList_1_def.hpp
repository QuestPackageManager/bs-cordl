...
template<typename U>
inline void Dispose(::ByRef<U>  allocator) ;
...
template<typename U>
inline void Initialize(int32_t  initialCapacity, ::ByRef<U>  allocator) ;
...
template<typename U>
static inline ::Unity::Collections::NativeList_1<T> New(int32_t  initialCapacity, ::ByRef<U>  allocator) ;
