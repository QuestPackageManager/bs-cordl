...
/// @brief Method Base10ToBase2, addr 0x630be34, size 0xe4, virtual false, abstract: false, final false
static inline ::Unity::Collections::ParseError Base10ToBase2(::ByRef<float_t>  output, uint64_t  mantissa10, int32_t  exponent10) ;

/// @brief Method Base2ToBase10, addr 0x630bf18, size 0x170, virtual false, abstract: false, final false
