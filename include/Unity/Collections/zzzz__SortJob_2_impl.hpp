...
// Ctor Parameters [CppParam { name: "Data", ty: "T*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Comp", ty: "U", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "Length", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "SegmentWidth", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None
// }]
...
// Ctor Parameters [CppParam { name: "Data", ty: "T*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Comp", ty: "U", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "Length", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
