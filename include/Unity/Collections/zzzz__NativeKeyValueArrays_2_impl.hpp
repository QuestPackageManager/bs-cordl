...
// Ctor Parameters [CppParam { name: "Keys", ty: "::Unity::Collections::NativeArray_1<TKey>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Values", ty:
// "::Unity::Collections::NativeArray_1<TValue>", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename TKey, typename TValue>
  requires(::cordl_internals::value_type_constraint<TKey> && ::cordl_internals::default_constructor_constraint<TKey> && ::cordl_internals::value_type_constraint<TValue> &&
           ::cordl_internals::default_constructor_constraint<TValue>)
