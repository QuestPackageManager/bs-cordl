...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Unity::Collections::NativeHashMapDispose::*)()>(&::Unity::Collections::NativeHashMapDispose::Dispose)> {
  ...
  constexpr static std::size_t addrs = 0x64c314c;
...
// Ctor Parameters [CppParam { name: "m_HashMapData", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2<int32_t,int32_t>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "m_Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: Some("{}"), comment: None }]
