...
template <typename T> inline void Unity::Collections::NativeParallelHashSetDebuggerTypeProxy_1<T>::_ctor(::Unity::Collections::NativeParallelHashSet_1<T> data) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::NativeParallelHashSetDebuggerTypeProxy_1<T>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
template <typename T> inline ::System::Collections::Generic::List_1<T>* Unity::Collections::NativeParallelHashSetDebuggerTypeProxy_1<T>::get_Items() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::NativeParallelHashSetDebuggerTypeProxy_1<T>*>::get(), "get_Items",
...
Unity::Collections::NativeParallelHashSetDebuggerTypeProxy_1<T>::New_ctor(::Unity::Collections::NativeParallelHashSet_1<T> data) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Unity::Collections::NativeParallelHashSetDebuggerTypeProxy_1<T>*>(data));
}
// Ctor Parameters []
