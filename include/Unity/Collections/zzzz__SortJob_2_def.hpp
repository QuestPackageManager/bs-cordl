...
// Ctor Parameters [CppParam { name: "Data", ty: "T*", modifiers: "", def_value: None }, CppParam { name: "Comp", ty: "U", modifiers: "", def_value: None }, CppParam { name: "Length", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "SegmentWidth", ty: "int32_t", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "Data", ty: "T*", modifiers: "", def_value: None }, CppParam { name: "Comp", ty: "U", modifiers: "", def_value: None }, CppParam { name: "Length", ty: "int32_t", modifiers: "", def_value: None }]
