...
// Ctor Parameters [CppParam { name: "m_Buffer", ty: "::Unity::Collections::UnsafeQueueData*", modifiers: "", def_value: None }, CppParam { name: "m_QueuePool", ty: "::Unity::Collections::UnsafeQueueBlockPoolData*", modifiers: "", def_value: None }, CppParam { name: "m_ThreadIndex", ty: "int32_t", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "m_Buffer", ty: "::Unity::Collections::UnsafeQueueData*", modifiers: "", def_value: None }, CppParam { name: "m_QueuePool", ty: "::Unity::Collections::UnsafeQueueBlockPoolData*", modifiers: "", def_value: None }, CppParam { name: "m_AllocatorLabel", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }]
constexpr UnsafeQueue_1(::Unity::Collections::UnsafeQueueData*  m_Buffer, ::Unity::Collections::UnsafeQueueBlockPoolData*  m_QueuePool, ::Unity::Collections::AllocatorManager_AllocatorHandle  m_AllocatorLabel) noexcept;
