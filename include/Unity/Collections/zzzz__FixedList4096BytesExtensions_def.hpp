...
public:
  ...
  template <typename T, typename U> static inline bool Contains(::by_ref<::Unity::Collections::FixedList4096Bytes_1<T>> list, U value);

  /// @brief Method IndexOf, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T, typename U> static inline int32_t IndexOf(::by_ref<::Unity::Collections::FixedList4096Bytes_1<T>> list, U value);

  /// @brief Method Remove, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T, typename U> static inline bool Remove(::by_ref<::Unity::Collections::FixedList4096Bytes_1<T>> list, U value);

  /// @brief Method RemoveSwapBack, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T, typename U> static inline bool RemoveSwapBack(::by_ref<::Unity::Collections::FixedList4096Bytes_1<T>> list, U value);
