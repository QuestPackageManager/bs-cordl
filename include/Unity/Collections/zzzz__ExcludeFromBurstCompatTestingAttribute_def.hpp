...
public:
  ...
  /// @brief Method .ctor, addr 0x637e0bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW _reason);

  /// @brief Method get_Reason, addr 0x637e0ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Reason();

  /// @brief Method set_Reason, addr 0x637e0b4, size 0x8, virtual false, abstract: false, final false
