...
/// @brief Method .ctor, addr 0x630c0b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  _reason) ;

/// @brief Method get_Reason, addr 0x630c0a0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Reason() ;

/// @brief Method set_Reason, addr 0x630c0a8, size 0x8, virtual false, abstract: false, final false
