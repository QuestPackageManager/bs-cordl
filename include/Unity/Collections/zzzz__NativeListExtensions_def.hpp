...
template<typename T>
static inline bool ArraysEqual(::Unity::Collections::NativeArray_1<T>  container, ::ByRef<::Unity::Collections::NativeList_1<T>>  other) ;

/// @brief Method ArraysEqual, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool ArraysEqual(::Unity::Collections::NativeList_1<T>  container, ::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>>  other) ;

/// @brief Method ArraysEqual, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool ArraysEqual(::Unity::Collections::NativeList_1<T>  container, ::ByRef<::Unity::Collections::NativeArray_1<T>>  other) ;

/// @brief Method ArraysEqual, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool ArraysEqual(::Unity::Collections::NativeList_1<T>  container, ::ByRef<::Unity::Collections::NativeList_1<T>>  other) ;
