...
public:
// Declarations
/// @brief Method Acquire, addr 0x62f1b78, size 0x40, virtual false, abstract: false, final false
inline void Acquire() ;

/// @brief Method Release, addr 0x62f1c98, size 0xc, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method TryAcquire, addr 0x62f1bb8, size 0x3c, virtual false, abstract: false, final false
inline bool TryAcquire() ;

/// @brief Method TryAcquire, addr 0x62f1bf4, size 0xa4, virtual false, abstract: false, final false
