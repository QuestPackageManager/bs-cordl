...
// Ctor Parameters [CppParam { name: "DataRO", ty: "::Unity::Collections::NativeList_1<T>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Data", ty:
// "::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Comp", ty: "U", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "SegmentWidth", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T, typename U>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T> &&
           ::cordl_internals::type_constraint<U, ::System::Collections::Generic::IComparer_1<T>*>)
...
// Ctor Parameters [CppParam { name: "Data", ty: "::Unity::Collections::NativeList_1<T>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Comp", ty: "U", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "SegmentWidth", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T, typename U>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T> &&
           ::cordl_internals::type_constraint<U, ::System::Collections::Generic::IComparer_1<T>*>)
