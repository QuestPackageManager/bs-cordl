...
public:
  ...
  /// @brief Method AppDomainOnDomainUnload, addr 0x6385404, size 0x94, virtual false, abstract: false, final false
  static inline void AppDomainOnDomainUnload();

  /// @brief Method GetQueueBlockPool, addr 0x63852d8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDomainUnload, addr 0x6385498, size 0xf0, virtual false, abstract: false, final false
  static inline void OnDomainUnload(::System::Object* sender, ::System::EventArgs* e);

  /// @brief Method .ctor, addr 0x6385588, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
