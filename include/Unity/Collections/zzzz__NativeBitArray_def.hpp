...
public:
  ...
  /// @brief Method CheckRead, addr 0x637f178, size 0x4, virtual false, abstract: false, final false
  inline void CheckRead();

  /// @brief Method CountBits, addr 0x637f138, size 0x20, virtual false, abstract: false, final false
  inline int32_t CountBits(int32_t pos, int32_t numBits);

  /// @brief Method Find, addr 0x637f080, size 0xc, virtual false, abstract: false, final false
  inline int32_t Find(int32_t pos, int32_t count, int32_t numBits);

  /// @brief Method Find, addr 0x637f058, size 0x14, virtual false, abstract: false, final false
  inline int32_t Find(int32_t pos, int32_t numBits);

  /// @brief Method GetBits, addr 0x637efe8, size 0x20, virtual false, abstract: false, final false
  inline uint64_t GetBits(int32_t pos, int32_t numBits);

  /// @brief Method IsSet, addr 0x637f028, size 0x18, virtual false, abstract: false, final false
  inline bool IsSet(int32_t pos);

  /// @brief Method TestAll, addr 0x637f0f8, size 0x20, virtual false, abstract: false, final false
  inline bool TestAll(int32_t pos, int32_t numBits);

  /// @brief Method TestAny, addr 0x637f0b8, size 0x20, virtual false, abstract: false, final false
  inline bool TestAny(int32_t pos, int32_t numBits);

  /// @brief Method TestNone, addr 0x637f098, size 0x10, virtual false, abstract: false, final false
  inline bool TestNone(int32_t pos, int32_t numBits);

  /// @brief Method .ctor, addr 0x637ef54, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::Unity::Collections::NativeBitArray> data);

  /// @brief Method get_IsCreated, addr 0x637ef70, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCreated();

  /// @brief Method get_IsEmpty, addr 0x637ef90, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Length, addr 0x637efe0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AsReadOnly, addr 0x637ef44, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeBitArray_ReadOnly AsReadOnly();

  /// @brief Method CheckRead, addr 0x637ef68, size 0x4, virtual false, abstract: false, final false
  inline void CheckRead();
  ...
  /// @brief Method CheckWrite, addr 0x637ef6c, size 0x4, virtual false, abstract: false, final false
  inline void CheckWrite();

  /// @brief Method Clear, addr 0x637e830, size 0x58, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Copy, addr 0x637eb48, size 0xc, virtual false, abstract: false, final false
  inline void Copy(int32_t dstPos, ::ByRef<::Unity::Collections::NativeBitArray> srcBitArray, int32_t srcPos, int32_t numBits);

  /// @brief Method Copy, addr 0x637eb0c, size 0x20, virtual false, abstract: false, final false
  inline void Copy(int32_t dstPos, int32_t srcPos, int32_t numBits);

  /// @brief Method CountBits, addr 0x637ef04, size 0x20, virtual false, abstract: false, final false
  inline int32_t CountBits(int32_t pos, int32_t numBits);

  /// @brief Method Dispose, addr 0x637e73c, size 0xc4, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x637e60c, size 0x80, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Find, addr 0x637ee28, size 0x10, virtual false, abstract: false, final false
  inline int32_t Find(int32_t pos, int32_t count, int32_t numBits);

  /// @brief Method Find, addr 0x637ee00, size 0x14, virtual false, abstract: false, final false
  inline int32_t Find(int32_t pos, int32_t numBits);

  /// @brief Method GetBits, addr 0x637ea98, size 0x20, virtual false, abstract: false, final false
  inline uint64_t GetBits(int32_t pos, int32_t numBits);

  /// @brief Method IsSet, addr 0x637ead8, size 0x1c, virtual false, abstract: false, final false
  inline bool IsSet(int32_t pos);

  /// @brief Method Resize, addr 0x637e544, size 0x8, virtual false, abstract: false, final false
  inline void Resize(int32_t numBits, ::Unity::Collections::NativeArrayOptions options);

  /// @brief Method Set, addr 0x637e8dc, size 0x30, virtual false, abstract: false, final false
  inline void Set(int32_t pos, bool value);

  /// @brief Method SetBits, addr 0x637e938, size 0x8, virtual false, abstract: false, final false
  inline void SetBits(int32_t pos, bool value, int32_t numBits);

  /// @brief Method SetBits, addr 0x637e9ec, size 0x8, virtual false, abstract: false, final false
  inline void SetBits(int32_t pos, uint64_t value, int32_t numBits);

  /// @brief Method SetCapacity, addr 0x637e5b4, size 0x18, virtual false, abstract: false, final false
  inline void SetCapacity(int32_t capacityInBits);

  /// @brief Method TestAll, addr 0x637eec4, size 0x20, virtual false, abstract: false, final false
  inline bool TestAll(int32_t pos, int32_t numBits);

  /// @brief Method TestAny, addr 0x637ee84, size 0x20, virtual false, abstract: false, final false
  inline bool TestAny(int32_t pos, int32_t numBits);

  /// @brief Method TestNone, addr 0x637ee44, size 0x20, virtual false, abstract: false, final false
  inline bool TestNone(int32_t pos, int32_t numBits);

  /// @brief Method TrimExcess, addr 0x637e5e0, size 0x18, virtual false, abstract: false, final false
  inline void TrimExcess();

  /// @brief Method .ctor, addr 0x637e3fc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Capacity, addr 0x637e818, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Capacity();

  /// @brief Method get_IsCreated, addr 0x637e4ec, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsCreated();

  /// @brief Method get_IsEmpty, addr 0x637e51c, size 0x28, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Length, addr 0x637e800, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Length();
