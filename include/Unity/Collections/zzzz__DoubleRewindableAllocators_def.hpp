...
/// @brief Method CheckIsCreated, addr 0x62f89d0, size 0x58, virtual false, abstract: false, final false
inline void CheckIsCreated() ;

/// @brief Method Dispose, addr 0x62f8b70, size 0xe4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Initialize, addr 0x62f8a4c, size 0x124, virtual false, abstract: false, final false
inline void Initialize(::Unity::Collections::AllocatorManager_AllocatorHandle  backingAllocator, int32_t  initialSizeInBytes) ;

/// @brief Method Update, addr 0x62f88c8, size 0xc4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method .ctor, addr 0x62f8a38, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::AllocatorManager_AllocatorHandle  backingAllocator, int32_t  initialSizeInBytes) ;

/// @brief Method get_Allocator, addr 0x62f898c, size 0x44, virtual false, abstract: false, final false
inline ::ByRef<::Unity::Collections::RewindableAllocator> get_Allocator() ;

/// @brief Method get_EnableBlockFree, addr 0x62f8c54, size 0x6c, virtual false, abstract: false, final false
inline bool get_EnableBlockFree() ;

/// @brief Method get_IsCreated, addr 0x62f8a28, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCreated() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() ;

/// @brief Method set_EnableBlockFree, addr 0x62f8cc0, size 0x94, virtual false, abstract: false, final false
