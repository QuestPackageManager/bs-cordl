...
template<typename TKey,typename TValue>
static inline ::System::ValueTuple_2<::Unity::Collections::NativeArray_1<TKey>,int32_t> GetUniqueKeyArray(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<TKey,TValue>  container, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method GetUniqueKeyArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TKey,typename TValue>
static inline ::System::ValueTuple_2<::Unity::Collections::NativeArray_1<TKey>,int32_t> GetUniqueKeyArray(::Unity::Collections::NativeParallelMultiHashMap_2<TKey,TValue>  container, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
