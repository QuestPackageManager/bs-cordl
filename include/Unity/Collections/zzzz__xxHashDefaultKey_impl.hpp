...
::cordl_internals::setStaticField<::ArrayW<uint8_t,::Array<uint8_t>*>, "kSecret", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::xxHashDefaultKey*>::get>(std::forward<::ArrayW<uint8_t,::Array<uint8_t>*>>(value));
}
