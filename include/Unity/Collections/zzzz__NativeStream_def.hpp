...
/// @brief Method AllocateBlock, addr 0x630d34c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AllocateForEach, addr 0x630d8a8, size 0x4, virtual false, abstract: false, final false
inline void AllocateForEach(int32_t  forEachCount) ;

/// @brief Method AsReader, addr 0x630d58c, size 0x24, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeStream_Reader AsReader() ;

/// @brief Method AsWriter, addr 0x630d5d4, size 0x38, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeStream_Writer AsWriter() ;

/// @brief Method CheckForEachCountGreaterThanZero, addr 0x630d8ac, size 0x70, virtual false, abstract: false, final false
static inline void CheckForEachCountGreaterThanZero(int32_t  forEachCount) ;

/// @brief Method CheckRead, addr 0x630d91c, size 0x4, virtual false, abstract: false, final false
inline void CheckRead() ;

/// @brief Method Count, addr 0x630d64c, size 0x4, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method Dispose, addr 0x630d6c4, size 0x98, virtual true, abstract: false, final true
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x630d6a4, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method IsEmpty, addr 0x630d4ec, size 0x4, virtual false, abstract: false, final false
inline bool IsEmpty() ;

/// @brief Method ScheduleConstruct, addr 0x630d448, size 0xa4, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleConstruct(::ByRef<::Unity::Collections::NativeStream>  stream, ::Unity::Collections::NativeArray_1<int32_t>  bufferCount, ::Unity::Jobs::JobHandle  dependency, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method ScheduleConstruct, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleConstruct(::ByRef<::Unity::Collections::NativeStream>  stream, ::Unity::Collections::NativeList_1<T>  bufferCount, ::Unity::Jobs::JobHandle  dependency, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
...
/// @brief Method .ctor, addr 0x630d320, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(int32_t  bufferCount, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method get_ForEachCount, addr 0x630d55c, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;

/// @brief Method get_IsCreated, addr 0x630d54c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x630d920, size 0x18, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "Container", ty: "::Unity::Collections::NativeStream", modifiers: "", def_value: None }, CppParam { name: "List", ty: "::Unity::Collections::LowLevel::Unsafe::UntypedUnsafeList*", modifiers: "", def_value: None }]
...
/// @brief Method Execute, addr 0x630d938, size 0xc, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "Container", ty: "::Unity::Collections::NativeStream", modifiers: "", def_value: None }, CppParam { name: "Length", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }]
...
template<typename T>
inline ::ByRef<T> Allocate() ;

/// @brief Method Allocate, addr 0x630da34, size 0x4, virtual false, abstract: false, final false
inline uint8_t* Allocate(int32_t  size) ;

/// @brief Method BeginForEachIndex, addr 0x630d9a4, size 0x1c, virtual false, abstract: false, final false
inline void BeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method CheckAllocateSize, addr 0x630dacc, size 0x4, virtual false, abstract: false, final false
inline void CheckAllocateSize(int32_t  size) ;

/// @brief Method CheckBeginForEachIndex, addr 0x630dac4, size 0x4, virtual false, abstract: false, final false
inline void CheckBeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method CheckEndForEachIndex, addr 0x630dac8, size 0x4, virtual false, abstract: false, final false
inline void CheckEndForEachIndex() ;

/// @brief Method EndForEachIndex, addr 0x630d9dc, size 0x4, virtual false, abstract: false, final false
inline void EndForEachIndex() ;

/// @brief Method PatchMinMaxRange, addr 0x630d9a0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x630d60c, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::Unity::Collections::NativeStream>  stream) ;

/// @brief Method get_ForEachCount, addr 0x630d970, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;
...
/// @brief Method BeginForEachIndex, addr 0x630dae4, size 0x4, virtual false, abstract: false, final false
inline int32_t BeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method CheckBeginForEachIndex, addr 0x630dc3c, size 0x4, virtual false, abstract: false, final false
inline void CheckBeginForEachIndex(int32_t  forEachIndex) ;

/// @brief Method CheckEndForEachIndex, addr 0x630dc40, size 0x88, virtual false, abstract: false, final false
inline void CheckEndForEachIndex() ;

/// @brief Method CheckNotReadingOutOfBounds, addr 0x630dc30, size 0x4, virtual false, abstract: false, final false
inline void CheckNotReadingOutOfBounds(int32_t  size) ;

/// @brief Method CheckRead, addr 0x630dc34, size 0x4, virtual false, abstract: false, final false
inline void CheckRead() ;

/// @brief Method CheckReadSize, addr 0x630dc38, size 0x4, virtual false, abstract: false, final false
inline void CheckReadSize(int32_t  size) ;

/// @brief Method Count, addr 0x630dbd8, size 0x4, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method EndForEachIndex, addr 0x630db3c, size 0x4, virtual false, abstract: false, final false
inline void EndForEachIndex() ;
...
/// @brief Method ReadUnsafePtr, addr 0x630db7c, size 0x5c, virtual false, abstract: false, final false
inline uint8_t* ReadUnsafePtr(int32_t  size) ;

/// @brief Method .ctor, addr 0x630d5b0, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::Unity::Collections::NativeStream>  stream) ;

/// @brief Method get_ForEachCount, addr 0x630db44, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;

/// @brief Method get_RemainingItemCount, addr 0x630db74, size 0x8, virtual false, abstract: false, final false
