...
DEFINE_IL2CPP_CLASS(::Unity::Collections::NativeStream_ConstructJob, "Unity.Collections", "NativeStream/ConstructJob");
...
public:
  ...
  /// @brief Method AllocateBlock, addr 0x64bdaf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocateForEach, addr 0x64be04c, size 0x4, virtual false, abstract: false, final false
  inline void AllocateForEach(int32_t forEachCount);

  /// @brief Method AsReader, addr 0x64bdd30, size 0x24, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeStream_Reader AsReader();

  /// @brief Method AsWriter, addr 0x64bdd78, size 0x38, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeStream_Writer AsWriter();

  /// @brief Method CheckForEachCountGreaterThanZero, addr 0x64be050, size 0x70, virtual false, abstract: false, final false
  static inline void CheckForEachCountGreaterThanZero(int32_t forEachCount);

  /// @brief Method CheckRead, addr 0x64be0c0, size 0x4, virtual false, abstract: false, final false
  inline void CheckRead();

  /// @brief Method Count, addr 0x64bddf0, size 0x4, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method Dispose, addr 0x64bde68, size 0x98, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x64bde48, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method IsEmpty, addr 0x64bdc90, size 0x4, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method ScheduleConstruct, addr 0x64bdbec, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64bdac4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t bufferCount, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method get_ForEachCount, addr 0x64bdd00, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();

  /// @brief Method get_IsCreated, addr 0x64bdcf0, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x64be0c4, size 0x18, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x64be0dc, size 0xc, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Allocate, addr 0x64be1d8, size 0x4, virtual false, abstract: false, final false
  inline uint8_t* Allocate(int32_t size);

  /// @brief Method BeginForEachIndex, addr 0x64be148, size 0x1c, virtual false, abstract: false, final false
  inline void BeginForEachIndex(int32_t foreachIndex);

  /// @brief Method CheckAllocateSize, addr 0x64be270, size 0x4, virtual false, abstract: false, final false
  inline void CheckAllocateSize(int32_t size);

  /// @brief Method CheckBeginForEachIndex, addr 0x64be268, size 0x4, virtual false, abstract: false, final false
  inline void CheckBeginForEachIndex(int32_t foreachIndex);

  /// @brief Method CheckEndForEachIndex, addr 0x64be26c, size 0x4, virtual false, abstract: false, final false
  inline void CheckEndForEachIndex();

  /// @brief Method EndForEachIndex, addr 0x64be180, size 0x4, virtual false, abstract: false, final false
  inline void EndForEachIndex();

  /// @brief Method PatchMinMaxRange, addr 0x64be144, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64bddb0, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::Unity::Collections::NativeStream> stream);

  /// @brief Method get_ForEachCount, addr 0x64be114, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();
...
public:
  ...
  /// @brief Method BeginForEachIndex, addr 0x64be288, size 0x4, virtual false, abstract: false, final false
  inline int32_t BeginForEachIndex(int32_t foreachIndex);

  /// @brief Method CheckBeginForEachIndex, addr 0x64be3e0, size 0x4, virtual false, abstract: false, final false
  inline void CheckBeginForEachIndex(int32_t forEachIndex);

  /// @brief Method CheckEndForEachIndex, addr 0x64be3e4, size 0x88, virtual false, abstract: false, final false
  inline void CheckEndForEachIndex();

  /// @brief Method CheckNotReadingOutOfBounds, addr 0x64be3d4, size 0x4, virtual false, abstract: false, final false
  inline void CheckNotReadingOutOfBounds(int32_t size);

  /// @brief Method CheckRead, addr 0x64be3d8, size 0x4, virtual false, abstract: false, final false
  inline void CheckRead();

  /// @brief Method CheckReadSize, addr 0x64be3dc, size 0x4, virtual false, abstract: false, final false
  inline void CheckReadSize(int32_t size);

  /// @brief Method Count, addr 0x64be37c, size 0x4, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method EndForEachIndex, addr 0x64be2e0, size 0x4, virtual false, abstract: false, final false
  inline void EndForEachIndex();
  ...
  /// @brief Method ReadUnsafePtr, addr 0x64be320, size 0x5c, virtual false, abstract: false, final false
  inline uint8_t* ReadUnsafePtr(int32_t size);

  /// @brief Method .ctor, addr 0x64bdd54, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::Unity::Collections::NativeStream> stream);

  /// @brief Method get_ForEachCount, addr 0x64be2e8, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();

  /// @brief Method get_RemainingItemCount, addr 0x64be318, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Collections::NativeStream_Reader) == 0x40, "Size mismatch!");
