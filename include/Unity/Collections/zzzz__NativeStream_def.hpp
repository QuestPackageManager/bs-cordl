...
/// @brief Method AllocateBlock, addr 0x6380ed0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AllocateForEach, addr 0x638142c, size 0x4, virtual false, abstract: false, final false
inline void AllocateForEach(int32_t  forEachCount) ;

/// @brief Method AsReader, addr 0x6381110, size 0x24, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeStream_Reader AsReader() ;

/// @brief Method AsWriter, addr 0x6381158, size 0x38, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeStream_Writer AsWriter() ;

/// @brief Method CheckForEachCountGreaterThanZero, addr 0x6381430, size 0x70, virtual false, abstract: false, final false
static inline void CheckForEachCountGreaterThanZero(int32_t  forEachCount) ;

/// @brief Method CheckRead, addr 0x63814a0, size 0x4, virtual false, abstract: false, final false
inline void CheckRead() ;

/// @brief Method Count, addr 0x63811d0, size 0x4, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method Dispose, addr 0x6381248, size 0x98, virtual true, abstract: false, final true
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x6381228, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method IsEmpty, addr 0x6381070, size 0x4, virtual false, abstract: false, final false
inline bool IsEmpty() ;

/// @brief Method ScheduleConstruct, addr 0x6380fcc, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6380ea4, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(int32_t  bufferCount, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method get_ForEachCount, addr 0x63810e0, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;

/// @brief Method get_IsCreated, addr 0x63810d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x63814a4, size 0x18, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Execute, addr 0x63814bc, size 0xc, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Allocate, addr 0x63815b8, size 0x4, virtual false, abstract: false, final false
inline uint8_t* Allocate(int32_t  size) ;

/// @brief Method BeginForEachIndex, addr 0x6381528, size 0x1c, virtual false, abstract: false, final false
inline void BeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method CheckAllocateSize, addr 0x6381650, size 0x4, virtual false, abstract: false, final false
inline void CheckAllocateSize(int32_t  size) ;

/// @brief Method CheckBeginForEachIndex, addr 0x6381648, size 0x4, virtual false, abstract: false, final false
inline void CheckBeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method CheckEndForEachIndex, addr 0x638164c, size 0x4, virtual false, abstract: false, final false
inline void CheckEndForEachIndex() ;

/// @brief Method EndForEachIndex, addr 0x6381560, size 0x4, virtual false, abstract: false, final false
inline void EndForEachIndex() ;

/// @brief Method PatchMinMaxRange, addr 0x6381524, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6381190, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::Unity::Collections::NativeStream>  stream) ;

/// @brief Method get_ForEachCount, addr 0x63814f4, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;
...
/// @brief Method BeginForEachIndex, addr 0x6381668, size 0x4, virtual false, abstract: false, final false
inline int32_t BeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method CheckBeginForEachIndex, addr 0x63817c0, size 0x4, virtual false, abstract: false, final false
inline void CheckBeginForEachIndex(int32_t  forEachIndex) ;

/// @brief Method CheckEndForEachIndex, addr 0x63817c4, size 0x88, virtual false, abstract: false, final false
inline void CheckEndForEachIndex() ;

/// @brief Method CheckNotReadingOutOfBounds, addr 0x63817b4, size 0x4, virtual false, abstract: false, final false
inline void CheckNotReadingOutOfBounds(int32_t  size) ;

/// @brief Method CheckRead, addr 0x63817b8, size 0x4, virtual false, abstract: false, final false
inline void CheckRead() ;

/// @brief Method CheckReadSize, addr 0x63817bc, size 0x4, virtual false, abstract: false, final false
inline void CheckReadSize(int32_t  size) ;

/// @brief Method Count, addr 0x638175c, size 0x4, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method EndForEachIndex, addr 0x63816c0, size 0x4, virtual false, abstract: false, final false
inline void EndForEachIndex() ;
...
/// @brief Method ReadUnsafePtr, addr 0x6381700, size 0x5c, virtual false, abstract: false, final false
inline uint8_t* ReadUnsafePtr(int32_t  size) ;

/// @brief Method .ctor, addr 0x6381134, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::Unity::Collections::NativeStream>  stream) ;

/// @brief Method get_ForEachCount, addr 0x63816c8, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;

/// @brief Method get_RemainingItemCount, addr 0x63816f8, size 0x8, virtual false, abstract: false, final false
