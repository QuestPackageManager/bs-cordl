...
public:
// Declarations
/// @brief Method AtomicAnd, addr 0x636a17c, size 0x4c, virtual false, abstract: false, final false
static inline int64_t AtomicAnd(::ByRef<int64_t>  destination, int64_t  source) ;

/// @brief Method AtomicOr, addr 0x636a130, size 0x4c, virtual false, abstract: false, final false
static inline int64_t AtomicOr(::ByRef<int64_t>  destination, int64_t  source) ;

/// @brief Method MakeMask, addr 0x636a2ec, size 0x14, virtual false, abstract: false, final false
static inline int64_t MakeMask(int32_t  offset, int32_t  bits) ;

static inline ::Unity::Collections::ConcurrentMask* New_ctor() ;

/// @brief Method Succeeded, addr 0x6366140, size 0xc, virtual false, abstract: false, final false
static inline bool Succeeded(int32_t  error) ;

/// @brief Method TryAllocate, addr 0x636a400, size 0xa8, virtual false, abstract: false, final false
static inline int32_t TryAllocate(::ByRef<int64_t>  l, ::ByRef<int32_t>  offset, int32_t  bits) ;

/// @brief Method TryAllocate, addr 0x636a300, size 0x74, virtual false, abstract: false, final false
...
template<typename T>
static inline int32_t TryAllocate(::ByRef<T>  t, ::ByRef<int32_t>  offset, int32_t  begin, int32_t  bits) ;

/// @brief Method TryAllocate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline int32_t TryAllocate(::ByRef<T>  t, ::ByRef<int32_t>  offset, int32_t  begin, int32_t  end, int32_t  bits) ;

/// @brief Method TryAllocate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline int32_t TryAllocate(::ByRef<T>  t, ::ByRef<int32_t>  offset, int32_t  bits) ;

/// @brief Method TryAllocate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline int32_t TryAllocate(::ByRef<T>  t, int32_t  offset, int32_t  bits) ;

/// @brief Method TryFree, addr 0x636a374, size 0x8c, virtual false, abstract: false, final false
...
template<typename T>
static inline int32_t TryFree(::ByRef<T>  t, int32_t  offset, int32_t  bits) ;

/// @brief Method .ctor, addr 0x636a4a8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method foundAtLeastThisManyConsecutiveOnes, addr 0x636a23c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method foundAtLeastThisManyConsecutiveZeroes, addr 0x636a2e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method longestConsecutiveOnes, addr 0x636a1c8, size 0x74, virtual false, abstract: false, final false
