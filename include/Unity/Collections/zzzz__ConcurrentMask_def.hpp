...
public:
  // Declarations
  /// @brief Method AtomicAnd, addr 0x6368604, size 0x4c, virtual false, abstract: false, final false
  static inline int64_t AtomicAnd(::ByRef<int64_t> destination, int64_t source);

  /// @brief Method AtomicOr, addr 0x63685b8, size 0x4c, virtual false, abstract: false, final false
  static inline int64_t AtomicOr(::ByRef<int64_t> destination, int64_t source);

  /// @brief Method MakeMask, addr 0x6368774, size 0x14, virtual false, abstract: false, final false
  static inline int64_t MakeMask(int32_t offset, int32_t bits);

  static inline ::Unity::Collections::ConcurrentMask* New_ctor();

  /// @brief Method Succeeded, addr 0x63645c8, size 0xc, virtual false, abstract: false, final false
  static inline bool Succeeded(int32_t error);

  /// @brief Method TryAllocate, addr 0x6368888, size 0xa8, virtual false, abstract: false, final false
  static inline int32_t TryAllocate(::ByRef<int64_t> l, ::ByRef<int32_t> offset, int32_t bits);

  /// @brief Method TryAllocate, addr 0x6368788, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFree, addr 0x63687fc, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6368930, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method foundAtLeastThisManyConsecutiveOnes, addr 0x63686c4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method foundAtLeastThisManyConsecutiveZeroes, addr 0x636876c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method longestConsecutiveOnes, addr 0x6368650, size 0x74, virtual false, abstract: false, final false
