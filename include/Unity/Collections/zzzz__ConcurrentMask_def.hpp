...
public:
// Declarations
/// @brief Method AtomicAnd, addr 0x62f65f8, size 0x4c, virtual false, abstract: false, final false
static inline int64_t AtomicAnd(::ByRef<int64_t>  destination, int64_t  source) ;

/// @brief Method AtomicOr, addr 0x62f65ac, size 0x4c, virtual false, abstract: false, final false
static inline int64_t AtomicOr(::ByRef<int64_t>  destination, int64_t  source) ;

/// @brief Method MakeMask, addr 0x62f6768, size 0x14, virtual false, abstract: false, final false
static inline int64_t MakeMask(int32_t  offset, int32_t  bits) ;

static inline ::Unity::Collections::ConcurrentMask* New_ctor() ;

/// @brief Method Succeeded, addr 0x62f25bc, size 0xc, virtual false, abstract: false, final false
static inline bool Succeeded(int32_t  error) ;

/// @brief Method TryAllocate, addr 0x62f687c, size 0xa8, virtual false, abstract: false, final false
static inline int32_t TryAllocate(::ByRef<int64_t>  l, ::ByRef<int32_t>  offset, int32_t  bits) ;

/// @brief Method TryAllocate, addr 0x62f677c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method TryFree, addr 0x62f67f0, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62f6924, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method foundAtLeastThisManyConsecutiveOnes, addr 0x62f66b8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method foundAtLeastThisManyConsecutiveZeroes, addr 0x62f6760, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method longestConsecutiveOnes, addr 0x62f6644, size 0x74, virtual false, abstract: false, final false
