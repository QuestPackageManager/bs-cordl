...
public:
  ...
  /// @brief Method DeallocateQueue, addr 0x6385630, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentWriteBlockTLS, addr 0x6385610, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Collections::UnsafeQueueBlockHeader* GetCurrentWriteBlockTLS(int32_t threadIndex);

  /// @brief Method SetCurrentWriteBlockTLS, addr 0x6385620, size 0x10, virtual false, abstract: false, final false
