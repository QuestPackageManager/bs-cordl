...
template<typename T>
static inline void AllocateQueue(::Unity::Collections::AllocatorManager_AllocatorHandle  label, ::ByRef<::Unity::Collections::UnsafeQueueData*>  outBuf) ;

/// @brief Method AllocateWriteBlockMT, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Collections::UnsafeQueueBlockHeader* AllocateWriteBlockMT(::Unity::Collections::UnsafeQueueData*  data, ::Unity::Collections::UnsafeQueueBlockPoolData*  pool, int32_t  threadIndex) ;

/// @brief Method DeallocateQueue, addr 0x6313624, size 0x84, virtual false, abstract: false, final false
static inline void DeallocateQueue(::Unity::Collections::UnsafeQueueData*  data, ::Unity::Collections::UnsafeQueueBlockPoolData*  pool, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocation) ;

/// @brief Method GetCurrentWriteBlockTLS, addr 0x6313604, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::UnsafeQueueBlockHeader* GetCurrentWriteBlockTLS(int32_t  threadIndex) ;

/// @brief Method SetCurrentWriteBlockTLS, addr 0x6313614, size 0x10, virtual false, abstract: false, final false
