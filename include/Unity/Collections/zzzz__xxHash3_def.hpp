...
public:
// Declarations
/// @brief Method .ctor, addr 0x6315628, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CheckKeySize, addr 0x6316d48, size 0xa4, virtual false, abstract: false, final false
inline void CheckKeySize(int32_t  isHash64) ;

/// @brief Method ConsumeStripes, addr 0x6316634, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method DigestHash128, addr 0x63167ac, size 0x1a4, virtual false, abstract: false, final false
inline ::Unity::Mathematics::uint4 DigestHash128() ;

/// @brief Method DigestHash64, addr 0x6316bf4, size 0x154, virtual false, abstract: false, final false
inline ::Unity::Mathematics::uint2 DigestHash64() ;

/// @brief Method DigestLong, addr 0x6316950, size 0x2a4, virtual false, abstract: false, final false
inline void DigestLong(uint64_t*  acc, uint8_t*  secret, int32_t  isHash64) ;

/// @brief Method Reset, addr 0x6316178, size 0x204, virtual false, abstract: false, final false
...
template<typename T>
inline void Update(::ByRef<T>  input) ;

/// @brief Method Update, addr 0x6316388, size 0x2a4, virtual false, abstract: false, final false
inline void Update(void*  input, int32_t  length) ;

/// @brief Method .ctor, addr 0x63160f8, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_Acc, addr 0x631637c, size 0x4, virtual false, abstract: false, final false
inline uint64_t* get_Acc() ;

/// @brief Method get_Buffer, addr 0x631662c, size 0x8, virtual false, abstract: false, final false
inline uint8_t* get_Buffer() ;

/// @brief Method get_SecretKey, addr 0x6316380, size 0x8, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x6316ed4, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x6316f38, size 0x24, virtual true, abstract: false, final false
inline uint64_t EndInvoke(::System::IAsyncResult*  _cordl_fixed_empty_name_whitespace) ;

/// @brief Method Invoke, addr 0x6316ec0, size 0x14, virtual true, abstract: false, final false
inline uint64_t Invoke(uint8_t*  input, uint8_t*  dest, int64_t  length, uint8_t*  secret) ;

static inline ::Unity::Collections::xxHash3_Hash64Long_00000A73$PostfixBurstDelegate* New_ctor(::System::Object*  _cordl_fixed_empty_name_whitespace, ::System::IntPtr  _cordl_fixed_empty_name_whitespace_param_1) ;

/// @brief Method .ctor, addr 0x6316e40, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetFunctionPointer, addr 0x6317068, size 0x18, virtual false, abstract: false, final false
static inline ::System::IntPtr GetFunctionPointer() ;

/// @brief Method GetFunctionPointerDiscard, addr 0x6316f5c, size 0x10c, virtual false, abstract: false, final false
static inline void GetFunctionPointerDiscard(::ByRef<::System::IntPtr>  _cordl_fixed_empty_name_whitespace) ;

/// @brief Method Invoke, addr 0x6315200, size 0x1b4, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x6317114, size 0xc4, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(uint8_t*  input, uint8_t*  dest, int64_t  length, uint8_t*  secret, ::ByRef<::Unity::Mathematics::uint4>  result, ::System::AsyncCallback*  _cordl_fixed_empty_name_whitespace, ::System::Object*  _cordl_fixed_empty_name_whitespace_param_6) ;

/// @brief Method EndInvoke, addr 0x63171d8, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  _cordl_fixed_empty_name_whitespace) ;

/// @brief Method Invoke, addr 0x6317100, size 0x14, virtual true, abstract: false, final false
inline void Invoke(uint8_t*  input, uint8_t*  dest, int64_t  length, uint8_t*  secret, ::ByRef<::Unity::Mathematics::uint4>  result) ;

static inline ::Unity::Collections::xxHash3_Hash128Long_00000A7A$PostfixBurstDelegate* New_ctor(::System::Object*  _cordl_fixed_empty_name_whitespace, ::System::IntPtr  _cordl_fixed_empty_name_whitespace_param_1) ;

/// @brief Method .ctor, addr 0x6317080, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  _cordl_fixed_empty_name_whitespace, ::System::IntPtr  _cordl_fixed_empty_name_whitespace_param_1) ;
...
/// @brief Method GetFunctionPointer, addr 0x63172f0, size 0x18, virtual false, abstract: false, final false
static inline ::System::IntPtr GetFunctionPointer() ;

/// @brief Method GetFunctionPointerDiscard, addr 0x63171e4, size 0x10c, virtual false, abstract: false, final false
static inline void GetFunctionPointerDiscard(::ByRef<::System::IntPtr>  _cordl_fixed_empty_name_whitespace) ;

/// @brief Method Invoke, addr 0x6315630, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method Avalanche, addr 0x63159bc, size 0x20, virtual false, abstract: false, final false
static inline uint64_t Avalanche(uint64_t  h64) ;

/// @brief Method AvalancheH64, addr 0x63159dc, size 0x38, virtual false, abstract: false, final false
static inline uint64_t AvalancheH64(uint64_t  h64) ;

/// @brief Method Avx2Accumulate, addr 0x6313c0c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Avx2Accumulate512, addr 0x6313c14, size 0x4, virtual false, abstract: false, final false
static inline void Avx2Accumulate512(uint64_t*  acc, uint8_t*  input, uint8_t*  dest, uint8_t*  secret) ;

/// @brief Method Avx2HashLongInternalLoop, addr 0x6313c08, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Avx2ScrambleAcc, addr 0x6313c10, size 0x4, virtual false, abstract: false, final false
static inline void Avx2ScrambleAcc(uint64_t*  acc, uint8_t*  secret) ;

/// @brief Method DefaultAccumulate, addr 0x6315da4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method DefaultAccumulate512, addr 0x6315e60, size 0x50, virtual false, abstract: false, final false
static inline void DefaultAccumulate512(uint64_t*  acc, uint8_t*  input, uint8_t*  dest, uint8_t*  secret, int32_t  isHash64) ;

/// @brief Method DefaultHashLongInternalLoop, addr 0x6315bf0, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method DefaultScrambleAcc, addr 0x6315e2c, size 0x34, virtual false, abstract: false, final false
static inline void DefaultScrambleAcc(uint64_t*  acc, uint8_t*  secret) ;

/// @brief Method EncodeSecretKey, addr 0x63148d4, size 0x34, virtual false, abstract: false, final false
...
template<typename T>
static inline ::Unity::Mathematics::uint4 Hash128(::ByRef<T>  input) ;

/// @brief Method Hash128, addr 0x63141b8, size 0xb4, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::uint4 Hash128(void*  input, void*  destination, int64_t  length) ;

/// @brief Method Hash128, addr 0x6314320, size 0xc0, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::uint4 Hash128(void*  input, void*  destination, int64_t  length, uint64_t  seed) ;

/// @brief Method Hash128, addr 0x6313edc, size 0xb0, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::uint4 Hash128(void*  input, int64_t  length) ;

/// @brief Method Hash128, addr 0x631426c, size 0xb4, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::uint4 Hash128(void*  input, int64_t  length, uint64_t  seed) ;

/// @brief Method Hash128Internal, addr 0x6313f8c, size 0x22c, virtual false, abstract: false, final false
...
/// @brief Method Hash128Len0To16, addr 0x6314908, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Hash128Len129To240, addr 0x6314d50, size 0x354, virtual false, abstract: false, final false
...
/// @brief Method Hash128Len17To128, addr 0x6314994, size 0x3bc, virtual false, abstract: false, final false
...
/// @brief Method Hash128Len1To3, addr 0x63153b4, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method Hash128Len4To8, addr 0x6315454, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Hash128Len9To16, addr 0x631550c, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method Hash128Long, addr 0x6313c04, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Hash128Long$BurstManaged, addr 0x6315fc0, size 0x138, virtual false, abstract: false, final false
...
template<typename T>
static inline ::Unity::Mathematics::uint2 Hash64(::ByRef<T>  input) ;

/// @brief Method Hash64, addr 0x6313c18, size 0x98, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::uint2 Hash64(void*  input, int64_t  length) ;

/// @brief Method Hash64, addr 0x6313e40, size 0x9c, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::uint2 Hash64(void*  input, int64_t  length, uint64_t  seed) ;

/// @brief Method Hash64Internal, addr 0x6313cb0, size 0x18c, virtual false, abstract: false, final false
static inline uint64_t Hash64Internal(uint8_t*  input, uint8_t*  dest, int64_t  length, uint8_t*  secret, uint64_t  seed) ;

/// @brief Method Hash64Len0To16, addr 0x63143e0, size 0x68, virtual false, abstract: false, final false
static inline uint64_t Hash64Len0To16(uint8_t*  input, int64_t  length, uint8_t*  secret, uint64_t  seed) ;

/// @brief Method Hash64Len129To240, addr 0x6314750, size 0x184, virtual false, abstract: false, final false
static inline uint64_t Hash64Len129To240(uint8_t*  input, int64_t  length, uint8_t*  secret, uint64_t  seed) ;

/// @brief Method Hash64Len17To128, addr 0x6314448, size 0x308, virtual false, abstract: false, final false
static inline uint64_t Hash64Len17To128(uint8_t*  input, int64_t  length, uint8_t*  secret, uint64_t  seed) ;

/// @brief Method Hash64Len1To3, addr 0x63150a4, size 0x6c, virtual false, abstract: false, final false
static inline uint64_t Hash64Len1To3(uint8_t*  input, int64_t  len, uint8_t*  secret, uint64_t  seed) ;

/// @brief Method Hash64Len4To8, addr 0x6315110, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t Hash64Len4To8(uint8_t*  input, int64_t  length, uint8_t*  secret, uint64_t  seed) ;

/// @brief Method Hash64Len9To16, addr 0x631516c, size 0x94, virtual false, abstract: false, final false
static inline uint64_t Hash64Len9To16(uint8_t*  input, int64_t  length, uint8_t*  secret, uint64_t  seed) ;

/// @brief Method Hash64Long, addr 0x6313c00, size 0x4, virtual false, abstract: false, final false
static inline uint64_t Hash64Long(uint8_t*  input, uint8_t*  dest, int64_t  length, uint8_t*  secret) ;

/// @brief Method Hash64Long$BurstManaged, addr 0x6315eb0, size 0x110, virtual false, abstract: false, final false
static inline uint64_t Hash64Long$BurstManaged(uint8_t*  input, uint8_t*  dest, int64_t  length, uint8_t*  secret) ;

/// @brief Method MergeAcc, addr 0x6315a90, size 0x160, virtual false, abstract: false, final false
static inline uint64_t MergeAcc(uint64_t*  acc, uint8_t*  secret, uint64_t  start) ;

/// @brief Method Mix16, addr 0x63158ac, size 0x54, virtual false, abstract: false, final false
static inline uint64_t Mix16(uint8_t*  input, uint8_t*  secret, uint64_t  seed) ;

/// @brief Method Mix2Acc, addr 0x6315a48, size 0x48, virtual false, abstract: false, final false
static inline uint64_t Mix2Acc(uint64_t  acc0, uint64_t  acc1, uint8_t*  secret) ;

/// @brief Method Mix32, addr 0x6315900, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method Mul128Fold64, addr 0x6315870, size 0x3c, virtual false, abstract: false, final false
static inline uint64_t Mul128Fold64(uint64_t  lhs, uint64_t  rhs) ;

/// @brief Method Mul32To64, addr 0x6315834, size 0x8, virtual false, abstract: false, final false
static inline uint64_t Mul32To64(uint32_t  x, uint32_t  y) ;

/// @brief Method Read32LE, addr 0x631581c, size 0x8, virtual false, abstract: false, final false
static inline uint32_t Read32LE(void*  addr) ;

/// @brief Method Read32LE, addr 0x631582c, size 0x8, virtual false, abstract: false, final false
static inline void Read32LE(void*  addr, uint32_t  value) ;

/// @brief Method Read64LE, addr 0x6315814, size 0x8, virtual false, abstract: false, final false
static inline uint64_t Read64LE(void*  addr) ;

/// @brief Method RotL32, addr 0x631584c, size 0xc, virtual false, abstract: false, final false
static inline uint32_t RotL32(uint32_t  x, int32_t  r) ;

/// @brief Method RotL64, addr 0x6315858, size 0xc, virtual false, abstract: false, final false
static inline uint64_t RotL64(uint64_t  x, int32_t  r) ;

/// @brief Method Swap32, addr 0x6315844, size 0x8, virtual false, abstract: false, final false
static inline uint32_t Swap32(uint32_t  x) ;

/// @brief Method Swap64, addr 0x631583c, size 0x8, virtual false, abstract: false, final false
static inline uint64_t Swap64(uint64_t  x) ;

/// @brief Method ToUint2, addr 0x6313e3c, size 0x4, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::uint2 ToUint2(uint64_t  u) ;

/// @brief Method ToUint4, addr 0x6315450, size 0x4, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::uint4 ToUint4(uint64_t  ul0, uint64_t  ul1) ;

/// @brief Method Write64LE, addr 0x6315824, size 0x8, virtual false, abstract: false, final false
static inline void Write64LE(void*  addr, uint64_t  value) ;

/// @brief Method XorShift64, addr 0x6315864, size 0xc, virtual false, abstract: false, final false
static inline uint64_t XorShift64(uint64_t  v64, int32_t  shift) ;

/// @brief Method rrmxmx, addr 0x6315a14, size 0x34, virtual false, abstract: false, final false
