...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6387634, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckKeySize, addr 0x6388d54, size 0xa4, virtual false, abstract: false, final false
  inline void CheckKeySize(int32_t isHash64);

  /// @brief Method ConsumeStripes, addr 0x6388640, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method DigestHash128, addr 0x63887b8, size 0x1a4, virtual false, abstract: false, final false
  inline ::Unity::Mathematics::uint4 DigestHash128();

  /// @brief Method DigestHash64, addr 0x6388c00, size 0x154, virtual false, abstract: false, final false
  inline ::Unity::Mathematics::uint2 DigestHash64();

  /// @brief Method DigestLong, addr 0x638895c, size 0x2a4, virtual false, abstract: false, final false
  inline void DigestLong(uint64_t* acc, uint8_t* secret, int32_t isHash64);

  /// @brief Method Reset, addr 0x6388184, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x6388394, size 0x2a4, virtual false, abstract: false, final false
  inline void Update(void* input, int32_t length);

  /// @brief Method .ctor, addr 0x6388104, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Acc, addr 0x6388388, size 0x4, virtual false, abstract: false, final false
  inline uint64_t* get_Acc();

  /// @brief Method get_Buffer, addr 0x6388638, size 0x8, virtual false, abstract: false, final false
  inline uint8_t* get_Buffer();

  /// @brief Method get_SecretKey, addr 0x638838c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6388ee0, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x6388f44, size 0x24, virtual true, abstract: false, final false
  inline uint64_t EndInvoke(::System::IAsyncResult* _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x6388ecc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6388e4c, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetFunctionPointer, addr 0x6389074, size 0x18, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetFunctionPointer();

  /// @brief Method GetFunctionPointerDiscard, addr 0x6388f68, size 0x10c, virtual false, abstract: false, final false
  static inline void GetFunctionPointerDiscard(::ByRef<::System::IntPtr> _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x638720c, size 0x1b4, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6389120, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x63891e4, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x638910c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x638908c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* _cordl_fixed_empty_name_whitespace, ::System::IntPtr _cordl_fixed_empty_name_whitespace_param_1);
...
public:
  ...
  /// @brief Method GetFunctionPointer, addr 0x63892fc, size 0x18, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetFunctionPointer();

  /// @brief Method GetFunctionPointerDiscard, addr 0x63891f0, size 0x10c, virtual false, abstract: false, final false
  static inline void GetFunctionPointerDiscard(::ByRef<::System::IntPtr> _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x638763c, size 0x1e4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Avalanche, addr 0x63879c8, size 0x20, virtual false, abstract: false, final false
  static inline uint64_t Avalanche(uint64_t h64);

  /// @brief Method AvalancheH64, addr 0x63879e8, size 0x38, virtual false, abstract: false, final false
  static inline uint64_t AvalancheH64(uint64_t h64);

  /// @brief Method Avx2Accumulate, addr 0x6385c18, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Avx2Accumulate512, addr 0x6385c20, size 0x4, virtual false, abstract: false, final false
  static inline void Avx2Accumulate512(uint64_t* acc, uint8_t* input, uint8_t* dest, uint8_t* secret);

  /// @brief Method Avx2HashLongInternalLoop, addr 0x6385c14, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Avx2ScrambleAcc, addr 0x6385c1c, size 0x4, virtual false, abstract: false, final false
  static inline void Avx2ScrambleAcc(uint64_t* acc, uint8_t* secret);

  /// @brief Method DefaultAccumulate, addr 0x6387db0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DefaultAccumulate512, addr 0x6387e6c, size 0x50, virtual false, abstract: false, final false
  static inline void DefaultAccumulate512(uint64_t* acc, uint8_t* input, uint8_t* dest, uint8_t* secret, int32_t isHash64);

  /// @brief Method DefaultHashLongInternalLoop, addr 0x6387bfc, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DefaultScrambleAcc, addr 0x6387e38, size 0x34, virtual false, abstract: false, final false
  static inline void DefaultScrambleAcc(uint64_t* acc, uint8_t* secret);

  /// @brief Method EncodeSecretKey, addr 0x63868e0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128, addr 0x63861c4, size 0xb4, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 Hash128(void* input, void* destination, int64_t length);

  /// @brief Method Hash128, addr 0x638632c, size 0xc0, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 Hash128(void* input, void* destination, int64_t length, uint64_t seed);

  /// @brief Method Hash128, addr 0x6385ee8, size 0xb0, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 Hash128(void* input, int64_t length);

  /// @brief Method Hash128, addr 0x6386278, size 0xb4, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 Hash128(void* input, int64_t length, uint64_t seed);

  /// @brief Method Hash128Internal, addr 0x6385f98, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len0To16, addr 0x6386914, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len129To240, addr 0x6386d5c, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len17To128, addr 0x63869a0, size 0x3bc, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len1To3, addr 0x63873c0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len4To8, addr 0x6387460, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Len9To16, addr 0x6387518, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Long, addr 0x6385c10, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash128Long$BurstManaged, addr 0x6387fcc, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash64, addr 0x6385c24, size 0x98, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint2 Hash64(void* input, int64_t length);

  /// @brief Method Hash64, addr 0x6385e4c, size 0x9c, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint2 Hash64(void* input, int64_t length, uint64_t seed);

  /// @brief Method Hash64Internal, addr 0x6385cbc, size 0x18c, virtual false, abstract: false, final false
  static inline uint64_t Hash64Internal(uint8_t* input, uint8_t* dest, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len0To16, addr 0x63863ec, size 0x68, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len0To16(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len129To240, addr 0x638675c, size 0x184, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len129To240(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len17To128, addr 0x6386454, size 0x308, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len17To128(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len1To3, addr 0x63870b0, size 0x6c, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len1To3(uint8_t* input, int64_t len, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len4To8, addr 0x638711c, size 0x5c, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len4To8(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Len9To16, addr 0x6387178, size 0x94, virtual false, abstract: false, final false
  static inline uint64_t Hash64Len9To16(uint8_t* input, int64_t length, uint8_t* secret, uint64_t seed);

  /// @brief Method Hash64Long, addr 0x6385c0c, size 0x4, virtual false, abstract: false, final false
  static inline uint64_t Hash64Long(uint8_t* input, uint8_t* dest, int64_t length, uint8_t* secret);

  /// @brief Method Hash64Long$BurstManaged, addr 0x6387ebc, size 0x110, virtual false, abstract: false, final false
  static inline uint64_t Hash64Long$BurstManaged(uint8_t* input, uint8_t* dest, int64_t length, uint8_t* secret);

  /// @brief Method MergeAcc, addr 0x6387a9c, size 0x160, virtual false, abstract: false, final false
  static inline uint64_t MergeAcc(uint64_t* acc, uint8_t* secret, uint64_t start);

  /// @brief Method Mix16, addr 0x63878b8, size 0x54, virtual false, abstract: false, final false
  static inline uint64_t Mix16(uint8_t* input, uint8_t* secret, uint64_t seed);

  /// @brief Method Mix2Acc, addr 0x6387a54, size 0x48, virtual false, abstract: false, final false
  static inline uint64_t Mix2Acc(uint64_t acc0, uint64_t acc1, uint8_t* secret);

  /// @brief Method Mix32, addr 0x638790c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Mul128Fold64, addr 0x638787c, size 0x3c, virtual false, abstract: false, final false
  static inline uint64_t Mul128Fold64(uint64_t lhs, uint64_t rhs);

  /// @brief Method Mul32To64, addr 0x6387840, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Mul32To64(uint32_t x, uint32_t y);

  /// @brief Method Read32LE, addr 0x6387828, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Read32LE(void* addr);

  /// @brief Method Read32LE, addr 0x6387838, size 0x8, virtual false, abstract: false, final false
  static inline void Read32LE(void* addr, uint32_t value);

  /// @brief Method Read64LE, addr 0x6387820, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Read64LE(void* addr);

  /// @brief Method RotL32, addr 0x6387858, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t RotL32(uint32_t x, int32_t r);

  /// @brief Method RotL64, addr 0x6387864, size 0xc, virtual false, abstract: false, final false
  static inline uint64_t RotL64(uint64_t x, int32_t r);

  /// @brief Method Swap32, addr 0x6387850, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t Swap32(uint32_t x);

  /// @brief Method Swap64, addr 0x6387848, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Swap64(uint64_t x);

  /// @brief Method ToUint2, addr 0x6385e48, size 0x4, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint2 ToUint2(uint64_t u);

  /// @brief Method ToUint4, addr 0x638745c, size 0x4, virtual false, abstract: false, final false
  static inline ::Unity::Mathematics::uint4 ToUint4(uint64_t ul0, uint64_t ul1);

  /// @brief Method Write64LE, addr 0x6387830, size 0x8, virtual false, abstract: false, final false
  static inline void Write64LE(void* addr, uint64_t value);

  /// @brief Method XorShift64, addr 0x6387870, size 0xc, virtual false, abstract: false, final false
  static inline uint64_t XorShift64(uint64_t v64, int32_t shift);

  /// @brief Method rrmxmx, addr 0x6387a20, size 0x34, virtual false, abstract: false, final false
