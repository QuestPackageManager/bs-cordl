...
DEFINE_IL2CPP_CLASS(::Unity::Collections::Long1024, "Unity.Collections", "Long1024");
...
public:
  ...
  /// @brief Method ElementAt, addr 0x64a8e28, size 0x50, virtual true, abstract: false, final true
  inline ::by_ref<int64_t> ElementAt(int32_t index);

  /// @brief Method get_Length, addr 0x64ac55c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Length, addr 0x64ac564, size 0x4, virtual true, abstract: false, final true
...
static_assert(sizeof(::Unity::Collections::Long1024) == 0x2000, "Size mismatch!");
