...
/// @brief Method ElementAt, addr 0x62f2e6c, size 0x50, virtual true, abstract: false, final true
inline ::ByRef<int64_t> ElementAt(int32_t  index) ;

/// @brief Method get_Length, addr 0x62f65a0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_Length, addr 0x62f65a8, size 0x4, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "f0", ty: "::Unity::Collections::Long512", modifiers: "", def_value: None }, CppParam { name: "f1", ty: "::Unity::Collections::Long512", modifiers: "", def_value: None }]
