...
public:
  ...
  /// @brief Method ElementAt, addr 0x6364e78, size 0x50, virtual true, abstract: false, final true
  inline ::ByRef<int64_t> ElementAt(int32_t index);

  /// @brief Method get_Length, addr 0x63685ac, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Length, addr 0x63685b4, size 0x4, virtual true, abstract: false, final true
