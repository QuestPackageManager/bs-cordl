...
// Ctor Parameters [CppParam { name: "m_NextBlock", ty: "::Unity::Collections::UnsafeQueueBlockHeader*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_NumItems", ty:
