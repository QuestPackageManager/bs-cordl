...
public:
  ...
  /// @brief Method .ctor, addr 0x6367e54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Collections::BitField64 data);

  /// @brief Method get_Bits, addr 0x6367e5c, size 0x8c, virtual false, abstract: false, final false
