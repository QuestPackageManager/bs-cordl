...
public:
  ...
  /// @brief Method .ctor, addr 0x64abe04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Collections::BitField64 data);

  /// @brief Method get_Bits, addr 0x64abe0c, size 0x8c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BitField64DebugView", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BitField64DebugView(BitField64DebugView&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BitField64DebugView", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BitField64DebugView(BitField64DebugViewconst&) = delete;
