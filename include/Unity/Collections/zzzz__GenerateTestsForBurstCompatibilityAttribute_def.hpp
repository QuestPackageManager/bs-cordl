...
public:
  ...
  /// @brief Method .ctor, addr 0x637e0a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GenericTypeArguments, addr 0x637e098, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> get_GenericTypeArguments();

  /// @brief Method set_GenericTypeArguments, addr 0x637e0a0, size 0x8, virtual false, abstract: false, final false
