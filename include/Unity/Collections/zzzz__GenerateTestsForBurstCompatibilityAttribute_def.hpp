...
/// @brief Field <GenericTypeArguments>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__GenericTypeArguments_k__BackingField, put=__cordl_internal_set__GenericTypeArguments_k__BackingField)) ::ArrayW<::System::Type*,::Array<::System::Type*>*>  _GenericTypeArguments_k__BackingField;
...
/// @brief Method .ctor, addr 0x630c09c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_GenericTypeArguments, addr 0x630c08c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Type*,::Array<::System::Type*>*> get_GenericTypeArguments() ;

/// @brief Method set_GenericTypeArguments, addr 0x630c094, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::Unity::Collections::GenerateTestsForBurstCompatibilityAttribute_BurstCompatibleCompileTarget, "Unity.Collections", "GenerateTestsForBurstCompatibilityAttribute/BurstCompatibleCompileTarget");
