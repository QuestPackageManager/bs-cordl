...
DEFINE_IL2CPP_CLASS(::Unity::Collections::GenerateTestsForBurstCompatibilityAttribute_BurstCompatibleCompileTarget, "Unity.Collections",
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__GenericTypeArguments_k__BackingField, put = __cordl_internal_set__GenericTypeArguments_k__BackingField)) ::ArrayW<::System::Type*>
