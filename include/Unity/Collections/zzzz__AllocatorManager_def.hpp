...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6364cc8, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x6364d70, size 0x24, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::ByRef<::Unity::Collections::AllocatorManager_Block> block, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6364cb4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6364c48, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckAllocatedSuccessfully, addr 0x6364ed8, size 0x80, virtual false, abstract: false, final false
  static inline void CheckAllocatedSuccessfully(int32_t error);

  /// @brief Method CompareTo, addr 0x6365218, size 0xc, virtual true, abstract: false, final true
  inline int32_t CompareTo(::Unity::Collections::AllocatorManager_AllocatorHandle other);

  /// @brief Method Dispose, addr 0x63650d0, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Equals, addr 0x63650e4, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x63651a0, size 0x10, virtual false, abstract: false, final false
  inline bool Equals(::Unity::Collections::Allocator other);

  /// @brief Method Equals, addr 0x6365190, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Collections::AllocatorManager_AllocatorHandle other);

  /// @brief Method GetHashCode, addr 0x63651b0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IncrementVersion, addr 0x6364ec8, size 0x4, virtual false, abstract: false, final false
  inline void IncrementVersion();

  /// @brief Method Install, addr 0x63645d4, size 0x24, virtual false, abstract: false, final false
  inline void Install(::Unity::Collections::AllocatorManager_TableEntry tableEntry);

  /// @brief Method Rewind, addr 0x6364ecc, size 0x4, virtual false, abstract: false, final false
  inline void Rewind();

  /// @brief Method Try, addr 0x6364f60, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Function, addr 0x6364f58, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Collections::AllocatorManager_TryFunction* get_Function();

  /// @brief Method get_Handle, addr 0x6364160, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Collections::AllocatorManager_AllocatorHandle get_Handle();

  /// @brief Method get_IsAutoDispose, addr 0x6364fec, size 0xe4, virtual true, abstract: false, final true
  inline bool get_IsAutoDispose();

  /// @brief Method get_IsCustomAllocator, addr 0x6364fdc, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsCustomAllocator();

  /// @brief Method get_IsInstalled, addr 0x6364d94, size 0xe4, virtual false, abstract: false, final false
  inline bool get_IsInstalled();

  /// @brief Method get_TableEntry, addr 0x6363f84, size 0xcc, virtual false, abstract: false, final false
  inline ::ByRef<::Unity::Collections::AllocatorManager_TableEntry> get_TableEntry();

  /// @brief Method get_ToAllocator, addr 0x6364fd4, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Collections::Allocator get_ToAllocator();

  /// @brief Method get_Value, addr 0x6364ed0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x63651b8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method op_GreaterThan, addr 0x63651e8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method op_GreaterThanOrEqual, addr 0x6365208, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x63642d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x63651c8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method op_LessThan, addr 0x63651d8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method op_LessThanOrEqual, addr 0x63651f8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Handle, addr 0x6364fcc, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x6365224, size 0x3c, virtual true, abstract: false, final true
  inline void Dispose();
...
public:
  ...
  /// @brief Method Allocate, addr 0x6365364, size 0x4, virtual false, abstract: false, final false
  inline void Allocate();

  /// @brief Method CheckFailedToAllocate, addr 0x636536c, size 0xac, virtual false, abstract: false, final false
  inline void CheckFailedToAllocate(int32_t error);

  /// @brief Method CheckFailedToFree, addr 0x6365418, size 0xac, virtual false, abstract: false, final false
  inline void CheckFailedToFree(int32_t error);

  /// @brief Method Dispose, addr 0x6365260, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Free, addr 0x6365368, size 0x4, virtual false, abstract: false, final false
  inline void Free();

  /// @brief Method TryAllocate, addr 0x6365308, size 0x5c, virtual false, abstract: false, final false
  inline int32_t TryAllocate();

  /// @brief Method TryFree, addr 0x63652ac, size 0x5c, virtual false, abstract: false, final false
  inline int32_t TryFree();

  /// @brief Method get_Alignment, addr 0x63642c0, size 0x10, virtual false, abstract: false, final false
  inline int32_t get_Alignment();

  /// @brief Method get_AllocatedBytes, addr 0x6365264, size 0xc, virtual false, abstract: false, final false
  inline int64_t get_AllocatedBytes();

  /// @brief Method get_Bytes, addr 0x63642b0, size 0x10, virtual false, abstract: false, final false
  inline int64_t get_Bytes();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable();

  /// @brief Method set_Alignment, addr 0x6365270, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_IsAutoDispose, addr 0x63654c4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsAutoDispose();
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6365744, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x63657ec, size 0x24, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::System::IAsyncResult* _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x6365730, size 0x14, virtual true, abstract: false, final false
  inline int32_t Invoke(::System::IntPtr allocatorState, ::ByRef<::Unity::Collections::AllocatorManager_Block> block);
  ...
  /// @brief Method .ctor, addr 0x63656c4, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetFunctionPointer, addr 0x636591c, size 0x18, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetFunctionPointer();

  /// @brief Method GetFunctionPointerDiscard, addr 0x6365810, size 0x10c, virtual false, abstract: false, final false
  static inline void GetFunctionPointerDiscard(::ByRef<::System::IntPtr> _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x63655a8, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x63656bc, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Initialize, addr 0x63654f8, size 0x14, virtual false, abstract: false, final false
  inline void Initialize(::Unity::Collections::AllocatorManager_Block storage);

  /// @brief Method Try, addr 0x63654cc, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Try(::System::IntPtr allocatorState, ::ByRef<::Unity::Collections::AllocatorManager_Block> block);

  /// @brief Method Try, addr 0x636550c, size 0x9c, virtual true, abstract: false, final true
  inline int32_t Try(::ByRef<::Unity::Collections::AllocatorManager_Block> block);

  /// @brief Method Try$BurstManaged, addr 0x63656c0, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Try$BurstManaged(::System::IntPtr allocatorState, ::ByRef<::Unity::Collections::AllocatorManager_Block> block);

  /// @brief Method get_Function, addr 0x6365648, size 0x74, virtual true, abstract: false, final true
  inline ::Unity::Collections::AllocatorManager_TryFunction* get_Function();

  /// @brief Method get_Handle, addr 0x63654d0, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Collections::AllocatorManager_AllocatorHandle get_Handle();

  /// @brief Method get_IsCustomAllocator, addr 0x63654e8, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsCustomAllocator();

  /// @brief Method get_ToAllocator, addr 0x63654e0, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Collections::Allocator get_ToAllocator();
  ...
  /// @brief Method set_Handle, addr 0x63654d8, size 0x8, virtual true, abstract: false, final true
  inline void set_Handle(::Unity::Collections::AllocatorManager_AllocatorHandle value);
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6365ea4, size 0xa8, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::IntPtr allocatorState, ::ByRef<::Unity::Collections::AllocatorManager_Block> block, ::System::AsyncCallback* _cordl_fixed_empty_name_whitespace,
                                             ::System::Object* _cordl_fixed_empty_name_whitespace_param_3);

  /// @brief Method EndInvoke, addr 0x6365f4c, size 0x24, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::System::IAsyncResult* _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x6365e90, size 0x14, virtual true, abstract: false, final false
  inline int32_t Invoke(::System::IntPtr allocatorState, ::ByRef<::Unity::Collections::AllocatorManager_Block> block);
  ...
  /// @brief Method .ctor, addr 0x6365e24, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* _cordl_fixed_empty_name_whitespace, ::System::IntPtr _cordl_fixed_empty_name_whitespace_param_1);
...
public:
  ...
  /// @brief Method GetFunctionPointer, addr 0x636607c, size 0x18, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetFunctionPointer();

  /// @brief Method GetFunctionPointerDiscard, addr 0x6365f70, size 0x10c, virtual false, abstract: false, final false
  static inline void GetFunctionPointerDiscard(::ByRef<::System::IntPtr> _cordl_fixed_empty_name_whitespace);

  /// @brief Method Invoke, addr 0x6365d08, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t Invoke(::System::IntPtr allocatorState, ::ByRef<::Unity::Collections::AllocatorManager_Block> block);
...
public:
  ...
  /// @brief Method Dispose, addr 0x6365e1c, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Initialize, addr 0x63659d8, size 0x108, virtual false, abstract: false, final false
  inline void Initialize(::Unity::Collections::AllocatorManager_Block storage, int32_t slabSizeInBytes, int64_t budget);

  /// @brief Method Try, addr 0x6365934, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Try(::System::IntPtr allocatorState, ::ByRef<::Unity::Collections::AllocatorManager_Block> block);

  /// @brief Method Try, addr 0x6365ae0, size 0x228, virtual true, abstract: false, final true
  inline int32_t Try(::ByRef<::Unity::Collections::AllocatorManager_Block> block);

  /// @brief Method Try$BurstManaged, addr 0x6365e20, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Try$BurstManaged(::System::IntPtr allocatorState, ::ByRef<::Unity::Collections::AllocatorManager_Block> block);

  /// @brief Method get_AllocatedBytes, addr 0x6365968, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_AllocatedBytes();

  /// @brief Method get_BudgetInBytes, addr 0x6365960, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_BudgetInBytes();

  /// @brief Method get_Function, addr 0x6365da8, size 0x74, virtual true, abstract: false, final true
  inline ::Unity::Collections::AllocatorManager_TryFunction* get_Function();

  /// @brief Method get_Handle, addr 0x6365938, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Collections::AllocatorManager_AllocatorHandle get_Handle();

  /// @brief Method get_IsCustomAllocator, addr 0x6365950, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsCustomAllocator();

  /// @brief Method get_SlabSizeInBytes, addr 0x6365970, size 0x10, virtual false, abstract: false, final false
  inline int32_t get_SlabSizeInBytes();

  /// @brief Method get_Slabs, addr 0x63659c0, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Slabs();

  /// @brief Method get_ToAllocator, addr 0x6365948, size 0x8, virtual true, abstract: false, final true
  inline ::Unity::Collections::Allocator get_ToAllocator();
  ...
  /// @brief Method set_Handle, addr 0x6365940, size 0x8, virtual true, abstract: false, final true
  inline void set_Handle(::Unity::Collections::AllocatorManager_AllocatorHandle value);

  /// @brief Method set_SlabSizeInBytes, addr 0x6365980, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6366098, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6366120, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x63661a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6366094, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method RegisterDelegate, addr 0x63645f8, size 0xdc, virtual false, abstract: false, final false
  static inline void RegisterDelegate(int32_t index, ::Unity::Collections::AllocatorManager_TryFunction* function);

  /// @brief Method UnregisterDelegate, addr 0x6366230, size 0xd0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Allocate, addr 0x6363cb0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckDelegate, addr 0x6363e88, size 0xc, virtual false, abstract: false, final false
  static inline void CheckDelegate(::ByRef<bool> useDelegate);

  /// @brief Method CheckFailedToAllocate, addr 0x6364aa8, size 0x54, virtual false, abstract: false, final false
  static inline void CheckFailedToAllocate(int32_t error);

  /// @brief Method CheckFailedToFree, addr 0x6364afc, size 0x54, virtual false, abstract: false, final false
  static inline void CheckFailedToFree(int32_t error);

  /// @brief Method CheckValid, addr 0x6364b50, size 0x4, virtual false, abstract: false, final false
  static inline void CheckValid(::Unity::Collections::AllocatorManager_AllocatorHandle handle);

  /// @brief Method ConvertToAllocatorHandle, addr 0x6363e84, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Free, addr 0x6363df8, size 0x8c, virtual false, abstract: false, final false
  static inline void Free(::Unity::Collections::AllocatorManager_AllocatorHandle handle, void* pointer);

  /// @brief Method Free, addr 0x6363d50, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x63643ac, size 0x4, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method Install, addr 0x63646d4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Install, addr 0x63643b0, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method IsCustomAllocator, addr 0x6364a9c, size 0xc, virtual false, abstract: false, final false
  static inline bool IsCustomAllocator(::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method LegacyOf, addr 0x6364168, size 0x14, virtual false, abstract: false, final false
  static inline ::Unity::Collections::Allocator LegacyOf(::Unity::Collections::AllocatorManager_AllocatorHandle handle);

  /// @brief Method Register, addr 0x63647bc, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method Shutdown, addr 0x6364a98, size 0x4, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method Try, addr 0x63642d8, size 0xd4, virtual false, abstract: false, final false
  static inline int32_t Try(::ByRef<::Unity::Collections::AllocatorManager_Block> block);

  /// @brief Method TryLegacy, addr 0x636417c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method UseDelegate, addr 0x6363e94, size 0x54, virtual false, abstract: false, final false
  static inline bool UseDelegate();

  /// @brief Method allocate_block, addr 0x6363ee8, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t allocate_block(::ByRef<::Unity::Collections::AllocatorManager_Block> block);

  /// @brief Method forward_mono_allocate_block, addr 0x6364050, size 0x110, virtual false, abstract: false, final false
