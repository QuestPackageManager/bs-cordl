...
DEFINE_IL2CPP_CLASS(::Unity::Collections::UnsafeQueueBlockHeader, "Unity.Collections", "UnsafeQueueBlockHeader");
// Dependencies
namespace Unity::Collections {
// Is value type: true
...
public:
  ...
  // Ctor Parameters [CppParam { name: "m_NextBlock", ty: "::Unity::Collections::UnsafeQueueBlockHeader*", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_NumItems", ty:
...
static_assert(sizeof(::Unity::Collections::UnsafeQueueBlockHeader) == 0x10, "Size mismatch!");
