...
template <typename T> inline void Unity::Collections::NativeListDebugView_1<T>::_ctor(::Unity::Collections::NativeList_1<T> array) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::NativeListDebugView_1<T>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
template <typename T> inline ::ArrayW<T, ::Array<T>*> Unity::Collections::NativeListDebugView_1<T>::get_Items() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::NativeListDebugView_1<T>*>::get(),
...
template <typename T> inline ::Unity::Collections::NativeListDebugView_1<T>* Unity::Collections::NativeListDebugView_1<T>::New_ctor(::Unity::Collections::NativeList_1<T> array) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Unity::Collections::NativeListDebugView_1<T>*>(array));
}
// Ctor Parameters []
