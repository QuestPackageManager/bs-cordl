...
// Write type traits
MARK_REF_T(::Unity::Collections::INativeDisposable*);
DEFINE_IL2CPP_CLASS(::Unity::Collections::INativeDisposable*, "Unity.Collections", "INativeDisposable");
// Dependencies
namespace Unity::Collections {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "INativeDisposable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INativeDisposable(INativeDisposableconst&) = delete;
