...
public:
  ...
  /// @brief Method AsNativeArray, addr 0x6369c78, size 0x58, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> AsNativeArray();

  /// @brief Method ByteSwap, addr 0x6369d20, size 0xc, virtual false, abstract: false, final false
  static inline int16_t ByteSwap(int16_t val);

  /// @brief Method ByteSwap, addr 0x6369d2c, size 0x8, virtual false, abstract: false, final false
  static inline int32_t ByteSwap(int32_t val);

  /// @brief Method CheckAllocator, addr 0x636a760, size 0x58, virtual false, abstract: false, final false
  static inline void CheckAllocator(::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method CheckBits, addr 0x636a7b8, size 0x11c, virtual false, abstract: false, final false
  static inline void CheckBits(uint32_t value, int32_t numBits);

  /// @brief Method CheckRead, addr 0x636a758, size 0x4, virtual false, abstract: false, final false
  inline void CheckRead();

  /// @brief Method CheckWrite, addr 0x636a75c, size 0x4, virtual false, abstract: false, final false
  inline void CheckWrite();

  /// @brief Method Clear, addr 0x636a74c, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Flush, addr 0x6369de8, size 0x4c, virtual false, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushBits, addr 0x636a174, size 0x48, virtual false, abstract: false, final false
  inline void FlushBits();

  /// @brief Method Initialize, addr 0x6369b30, size 0x60, virtual false, abstract: false, final false
  static inline void Initialize(::ByRef<::Unity::Collections::DataStreamWriter> self, ::Unity::Collections::NativeArray_1<uint8_t> data);

  /// @brief Method SyncBitData, addr 0x6369d5c, size 0x40, virtual false, abstract: false, final false
  inline void SyncBitData();

  /// @brief Method WriteByte, addr 0x6369ef4, size 0x20, virtual false, abstract: false, final false
  inline bool WriteByte(uint8_t value);

  /// @brief Method WriteBytes, addr 0x6369f70, size 0x74, virtual false, abstract: false, final false
  inline bool WriteBytes(::System::Span_1<uint8_t> value);

  /// @brief Method WriteBytes, addr 0x6369f14, size 0x5c, virtual false, abstract: false, final false
  inline bool WriteBytes(::Unity::Collections::NativeArray_1<uint8_t> value);

  /// @brief Method WriteBytesInternal, addr 0x6369e34, size 0xc0, virtual false, abstract: false, final false
  inline bool WriteBytesInternal(uint8_t* data, int32_t bytes);

  /// @brief Method WriteDouble, addr 0x636a154, size 0x20, virtual false, abstract: false, final false
  inline bool WriteDouble(double_t value);

  /// @brief Method WriteFixedString128, addr 0x636a564, size 0xc, virtual false, abstract: false, final false
  inline bool WriteFixedString128(::Unity::Collections::FixedString128Bytes str);

  /// @brief Method WriteFixedString32, addr 0x636a54c, size 0xc, virtual false, abstract: false, final false
  inline bool WriteFixedString32(::Unity::Collections::FixedString32Bytes str);

  /// @brief Method WriteFixedString4096, addr 0x636a57c, size 0xc, virtual false, abstract: false, final false
  inline bool WriteFixedString4096(::Unity::Collections::FixedString4096Bytes str);

  /// @brief Method WriteFixedString512, addr 0x636a570, size 0xc, virtual false, abstract: false, final false
  inline bool WriteFixedString512(::Unity::Collections::FixedString512Bytes str);

  /// @brief Method WriteFixedString64, addr 0x636a558, size 0xc, virtual false, abstract: false, final false
  inline bool WriteFixedString64(::Unity::Collections::FixedString64Bytes str);

  /// @brief Method WriteFloat, addr 0x636a134, size 0x20, virtual false, abstract: false, final false
  inline bool WriteFloat(float_t value);

  /// @brief Method WriteInt, addr 0x636a024, size 0x20, virtual false, abstract: false, final false
  inline bool WriteInt(int32_t value);

  /// @brief Method WriteIntNetworkByteOrder, addr 0x636a0ec, size 0x24, virtual false, abstract: false, final false
  inline bool WriteIntNetworkByteOrder(int32_t value);

  /// @brief Method WriteLong, addr 0x636a064, size 0x1c, virtual false, abstract: false, final false
  inline bool WriteLong(int64_t value);

  /// @brief Method WritePackedDouble, addr 0x636a428, size 0x8, virtual false, abstract: false, final false
  inline bool WritePackedDouble(double_t value, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedDoubleDelta, addr 0x636a430, size 0xcc, virtual false, abstract: false, final false
  inline bool WritePackedDoubleDelta(double_t value, double_t baseline, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedFixedString128Delta, addr 0x636a710, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePackedFixedString32Delta, addr 0x636a588, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePackedFixedString4096Delta, addr 0x636a738, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePackedFixedString512Delta, addr 0x636a724, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePackedFixedString64Delta, addr 0x636a6fc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePackedFixedStringDelta, addr 0x636a59c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePackedFloat, addr 0x636a398, size 0x8, virtual false, abstract: false, final false
  inline bool WritePackedFloat(float_t value, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedFloatDelta, addr 0x636a3a0, size 0x88, virtual false, abstract: false, final false
  inline bool WritePackedFloatDelta(float_t value, float_t baseline, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedInt, addr 0x636a380, size 0xc, virtual false, abstract: false, final false
  inline bool WritePackedInt(int32_t value, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedIntDelta, addr 0x636a510, size 0x14, virtual false, abstract: false, final false
  inline bool WritePackedIntDelta(int32_t value, int32_t baseline, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedLong, addr 0x636a38c, size 0xc, virtual false, abstract: false, final false
  inline bool WritePackedLong(int64_t value, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedLongDelta, addr 0x636a524, size 0x14, virtual false, abstract: false, final false
  inline bool WritePackedLongDelta(int64_t value, int64_t baseline, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedUInt, addr 0x636a244, size 0xf4, virtual false, abstract: false, final false
  inline bool WritePackedUInt(uint32_t value, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedUIntDelta, addr 0x636a4fc, size 0x14, virtual false, abstract: false, final false
  inline bool WritePackedUIntDelta(uint32_t value, uint32_t baseline, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedULong, addr 0x636a338, size 0x48, virtual false, abstract: false, final false
  inline bool WritePackedULong(uint64_t value, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WritePackedULongDelta, addr 0x636a538, size 0x14, virtual false, abstract: false, final false
  inline bool WritePackedULongDelta(uint64_t value, uint64_t baseline, ::ByRef<::Unity::Collections::StreamCompressionModel> model);

  /// @brief Method WriteRawBits, addr 0x636a1e0, size 0x64, virtual false, abstract: false, final false
  inline bool WriteRawBits(uint32_t value, int32_t numbits);

  /// @brief Method WriteRawBitsInternal, addr 0x636a1bc, size 0x24, virtual false, abstract: false, final false
  inline void WriteRawBitsInternal(uint32_t value, int32_t numbits);

  /// @brief Method WriteShort, addr 0x6369fe4, size 0x20, virtual false, abstract: false, final false
  inline bool WriteShort(int16_t value);

  /// @brief Method WriteShortNetworkByteOrder, addr 0x636a09c, size 0x28, virtual false, abstract: false, final false
  inline bool WriteShortNetworkByteOrder(int16_t value);

  /// @brief Method WriteUInt, addr 0x636a044, size 0x20, virtual false, abstract: false, final false
  inline bool WriteUInt(uint32_t value);

  /// @brief Method WriteUIntNetworkByteOrder, addr 0x636a110, size 0x24, virtual false, abstract: false, final false
  inline bool WriteUIntNetworkByteOrder(uint32_t value);

  /// @brief Method WriteULong, addr 0x636a080, size 0x1c, virtual false, abstract: false, final false
  inline bool WriteULong(uint64_t value);

  /// @brief Method WriteUShort, addr 0x636a004, size 0x20, virtual false, abstract: false, final false
  inline bool WriteUShort(uint16_t value);

  /// @brief Method WriteUShortNetworkByteOrder, addr 0x636a0c4, size 0x28, virtual false, abstract: false, final false
  inline bool WriteUShortNetworkByteOrder(uint16_t value);

  /// @brief Method .ctor, addr 0x6369b90, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Collections::NativeArray_1<uint8_t> data);

  /// @brief Method .ctor, addr 0x6369bf0, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(uint8_t* data, int32_t length);

  /// @brief Method .ctor, addr 0x6369a88, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(int32_t length, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method get_Capacity, addr 0x6369d54, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Capacity();

  /// @brief Method get_HasFailedWrites, addr 0x6369d44, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasFailedWrites();

  /// @brief Method get_IsCreated, addr 0x6369d34, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCreated();

  /// @brief Method get_IsLittleEndian, addr 0x63689f4, size 0x8, virtual false, abstract: false, final false
  static inline bool get_IsLittleEndian();

  /// @brief Method get_Length, addr 0x6369cd0, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Method get_LengthInBits, addr 0x6369d9c, size 0x4c, virtual false, abstract: false, final false
