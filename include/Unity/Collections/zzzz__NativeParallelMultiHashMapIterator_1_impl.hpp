...
// Ctor Parameters [CppParam { name: "key", ty: "TKey", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "NextEntryIndex", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "EntryIndex", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
