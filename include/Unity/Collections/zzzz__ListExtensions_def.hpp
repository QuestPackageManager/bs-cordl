...
// Write type traits
MARK_REF_PTR_T(::Unity::Collections::ListExtensions);
...
template<typename T>
static inline bool RemoveSwapBack(::System::Collections::Generic::List_1<T>*  list, ::System::Predicate_1<T>*  matcher) ;

/// @brief Method RemoveSwapBack, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool RemoveSwapBack(::System::Collections::Generic::List_1<T>*  list, T  value) ;
...
static_assert(::cordl_internals::size_check_v<::Unity::Collections::ListExtensions, 0x10>, "Size mismatch!");

} // namespace end def Unity::Collections
NEED_NO_BOX(::Unity::Collections::ListExtensions);
DEFINE_IL2CPP_ARG_TYPE(::Unity::Collections::ListExtensions*, "Unity.Collections", "ListExtensions");
