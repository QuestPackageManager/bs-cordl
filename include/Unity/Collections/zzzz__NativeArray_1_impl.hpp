...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::NativeArray_1<T>::Allocate(int32_t length, ::Unity::Collections::Allocator allocator, ::by_ref<::Unity::Collections::NativeArray_1<T>> array) {
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::NativeArray_1<T>::Copy(::Unity::Collections::NativeArray_1_ReadOnly<T> src, ::ArrayW<T> dst, int32_t length) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::NativeArray_1<T>>(),
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline ::System::Span_1<T> Unity::Collections::NativeArray_1<T>::op_Implicit___System__Span_1_T_(/* [IsReadOnly] */ ::by_ref<::Unity::Collections::NativeArray_1<T>> source) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
...
// Ctor Parameters [CppParam { name: "m_Buffer", ty: "void*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Length", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "m_AllocatorLabel", ty: "::Unity::Collections::Allocator", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
...
// Ctor Parameters [CppParam { name: "m_Array", ty: "::Unity::Collections::NativeArray_1<T>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Index", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "value", ty: "T", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline ::ArrayW<T> Unity::Collections::NativeArray_1_ReadOnly<T>::ToArray() {
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::ReadOnly_NativeArray_1_Enumerator<T>::_ctor(/* [IsReadOnly] */ ::by_ref<::Unity::Collections::NativeArray_1_ReadOnly<T>> array) {
...
// Ctor Parameters [CppParam { name: "m_Array", ty: "::Unity::Collections::NativeArray_1_ReadOnly<T>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Index", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "value", ty: "T", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
