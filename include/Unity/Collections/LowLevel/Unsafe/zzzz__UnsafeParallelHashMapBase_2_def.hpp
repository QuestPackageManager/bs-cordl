...
static inline bool SetValue(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  data, ::ByRef<::Unity::Collections::NativeParallelMultiHashMapIterator_1<TKey>>  it, ::ByRef<TValue>  item) ;
...
static inline bool TryAdd(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  data, TKey  key, TValue  item, bool  isMultiHashMap, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocation) ;
...
static inline bool TryGetFirstValueAtomic(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  data, TKey  key, ::ByRef<TValue>  item, ::ByRef<::Unity::Collections::NativeParallelMultiHashMapIterator_1<TKey>>  it) ;

/// @brief Method TryGetNextValueAtomic, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline bool TryGetNextValueAtomic(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  data, ::ByRef<TValue>  item, ::ByRef<::Unity::Collections::NativeParallelMultiHashMapIterator_1<TKey>>  it) ;
