...
public:
  // Declarations
  /// @brief Method Allocate, addr 0x638b15c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Free, addr 0x638b1c8, size 0x1c, virtual false, abstract: false, final false
