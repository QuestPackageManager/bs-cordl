...
public:
  // Declarations
  /// @brief Method Allocate, addr 0x64c98f4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Free, addr 0x64c9960, size 0x1c, virtual false, abstract: false, final false
