...
public:
  ...
  /// @brief Method CheckBounds, addr 0x64c8310, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadNext, addr 0x64c82f4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64c8238, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeAppendBuffer> buffer);

  /// @brief Method .ctor, addr 0x64c82d8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(void* ptr, int32_t length);

  /// @brief Method get_EndOfBuffer, addr 0x64c82e4, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x64c8130, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method AsReader, addr 0x64c8228, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Collections::LowLevel::Unsafe::UnsafeAppendBuffer_Reader AsReader();

  /// @brief Method CheckAlignment, addr 0x64c824c, size 0x8c, virtual false, abstract: false, final false
  static inline void CheckAlignment(int32_t alignment);

  /// @brief Method Dispose, addr 0x64c8038, size 0xcc, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x64c7f9c, size 0x9c, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method Pop, addr 0x64c81b0, size 0x78, virtual false, abstract: false, final false
  inline void Pop(void* ptr, int32_t structSize);

  /// @brief Method Reset, addr 0x64c8104, size 0x8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ResizeUninitialized, addr 0x64c810c, size 0x24, virtual false, abstract: false, final false
  inline void ResizeUninitialized(int32_t length);

  /// @brief Method SetCapacity, addr 0x64c7e00, size 0xfc, virtual false, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method .ctor, addr 0x64c7dec, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity, int32_t alignment, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method .ctor, addr 0x64c7efc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(void* ptr, int32_t length);

  /// @brief Method get_IsCreated, addr 0x64c7f8c, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCreated();

  /// @brief Method get_IsEmpty, addr 0x64c7f7c, size 0x10, virtual false, abstract: false, final false
