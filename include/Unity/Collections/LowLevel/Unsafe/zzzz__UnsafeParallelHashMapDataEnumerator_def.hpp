...
public:
  ...
  /// @brief Method MoveNext, addr 0x638afdc, size 0x48, virtual false, abstract: false, final false
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x638b024, size 0x14, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method .ctor, addr 0x638afc4, size 0x18, virtual false, abstract: false, final false
