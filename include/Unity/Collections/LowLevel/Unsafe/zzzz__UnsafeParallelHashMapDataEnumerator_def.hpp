...
public:
  ...
  /// @brief Method MoveNext, addr 0x64c9774, size 0x48, virtual false, abstract: false, final false
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x64c97bc, size 0x14, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method .ctor, addr 0x64c975c, size 0x18, virtual false, abstract: false, final false
