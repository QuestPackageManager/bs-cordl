...
public:
  ...
  // "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_BucketIndex", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_NextIndex", ty:
...
public:
  ...
  // Ctor Parameters [CppParam { name: "Ptr", ty: "uint8_t*", modifiers: "", def_value: None, comment: None }, CppParam { name: "Keys", ty: "TKey*", modifiers: "", def_value: None, comment: None },
  // CppParam { name: "Next", ty: "int32_t*", modifiers: "", def_value: None, comment: None }, CppParam { name: "Buckets", ty: "int32_t*", modifiers: "", def_value: None, comment: None }, CppParam {
  // name: "Count", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "Capacity", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name:
  // "Log2MinGrowth", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "BucketCapacity", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam {
  // name: "AllocatedIndex", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "FirstFreeIdx", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam {
  // name: "SizeOfTValue", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "",
