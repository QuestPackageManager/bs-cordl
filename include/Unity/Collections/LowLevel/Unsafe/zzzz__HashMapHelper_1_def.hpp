...
// Ctor Parameters [CppParam { name: "m_Data", ty: "::Unity::Collections::LowLevel::Unsafe::HashMapHelper_1<TKey>*", modifiers: "", def_value: None }, CppParam { name: "m_Index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_BucketIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_NextIndex", ty: "int32_t", modifiers: "", def_value: None }]
...
static inline ::Unity::Collections::LowLevel::Unsafe::HashMapHelper_1<TKey>* Alloc(int32_t  capacity, int32_t  sizeOfValueT, int32_t  minGrowth, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
...
static inline int32_t CalculateDataSize(int32_t  capacity, int32_t  bucketCapacity, int32_t  sizeOfTValue, ::ByRef<int32_t>  outKeyOffset, ::ByRef<int32_t>  outNextOffset, ::ByRef<int32_t>  outBucketOffset) ;
...
// Ctor Parameters [CppParam { name: "Ptr", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "Keys", ty: "TKey*", modifiers: "", def_value: None }, CppParam { name: "Next", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "Buckets", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "Count", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Capacity", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Log2MinGrowth", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "BucketCapacity", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "AllocatedIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "FirstFreeIdx", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "SizeOfTValue", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }]
constexpr HashMapHelper_1(uint8_t*  Ptr, TKey*  Keys, int32_t*  Next, int32_t*  Buckets, int32_t  Count, int32_t  Capacity, int32_t  Log2MinGrowth, int32_t  BucketCapacity, int32_t  AllocatedIndex, int32_t  FirstFreeIdx, int32_t  SizeOfTValue, ::Unity::Collections::AllocatorManager_AllocatorHandle  Allocator) noexcept;
