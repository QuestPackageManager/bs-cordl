...
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::NativeContainerSupportsDeallocateOnJobCompletionAttribute*, "Unity.Collections.LowLevel.Unsafe",
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5fe60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NativeContainerSupportsDeallocateOnJobCompletionAttribute", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "NativeContainerSupportsDeallocateOnJobCompletionAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NativeContainerSupportsDeallocateOnJobCompletionAttribute(NativeContainerSupportsDeallocateOnJobCompletionAttributeconst&) = delete;
