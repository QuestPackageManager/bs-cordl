...
template<typename T>
static inline void* AddressOf(::ByRef<T>  value) ;

/// @brief Method AsRef, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ByRef<T> AsRef(::ByRef<T>  value) ;

/// @brief Method CheckIndexRange, addr 0x6319dd0, size 0xcc, virtual false, abstract: false, final false
static inline void CheckIndexRange(int32_t  index, int32_t  capacity) ;

/// @brief Method CheckMemSwapOverlap, addr 0x6319d68, size 0x68, virtual false, abstract: false, final false
static inline void CheckMemSwapOverlap(uint8_t*  dst, uint8_t*  src, int64_t  size) ;

/// @brief Method MemSwap, addr 0x6319c50, size 0x118, virtual false, abstract: false, final false
