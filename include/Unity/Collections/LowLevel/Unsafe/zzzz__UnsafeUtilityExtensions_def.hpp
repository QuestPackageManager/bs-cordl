...
public:
  ...
  /// @brief Method CheckIndexRange, addr 0x638bddc, size 0xcc, virtual false, abstract: false, final false
  static inline void CheckIndexRange(int32_t index, int32_t capacity);

  /// @brief Method CheckMemSwapOverlap, addr 0x638bd74, size 0x68, virtual false, abstract: false, final false
  static inline void CheckMemSwapOverlap(uint8_t* dst, uint8_t* src, int64_t size);

  /// @brief Method MemSwap, addr 0x638bc5c, size 0x118, virtual false, abstract: false, final false
