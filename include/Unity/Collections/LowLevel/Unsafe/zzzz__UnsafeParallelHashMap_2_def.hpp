...
namespace Unity::Collections::LowLevel::Unsafe {
template<typename TKey,typename TValue>
struct UnsafeParallelHashMap_2_Enumerator;
}
namespace Unity::Collections::LowLevel::Unsafe {
template<typename TKey,typename TValue>
...
namespace Unity::Collections::LowLevel::Unsafe {
template<typename TKey,typename TValue>
struct UnsafeParallelHashMap_2_ReadOnly;
}
...
MARK_GEN_VAL_T(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_Enumerator);
MARK_GEN_VAL_T(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ParallelWriter);
MARK_GEN_VAL_T(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ReadOnly);
...
public:
// Declarations
using Enumerator = ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_Enumerator<TKey, TValue>;

using ParallelWriter = ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ParallelWriter<TKey, TValue>;

using ReadOnly = ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ReadOnly<TKey, TValue>;
...
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ParallelWriter<TKey,TValue> AsParallelWriter() ;

/// @brief Method AsReadOnly, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ReadOnly<TKey,TValue> AsReadOnly() ;
...
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_Enumerator<TKey,TValue> GetEnumerator() ;
...
// Ctor Parameters [CppParam { name: "m_Buffer", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*", modifiers: "", def_value: None }, CppParam { name: "m_AllocatorLabel", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }]
...
template<typename TKey,typename TValue>
// Is value type: true
// CS Name: Unity.Collections.LowLevel.Unsafe.UnsafeParallelHashMap`2/ReadOnly<TKey,TValue>
struct CORDL_TYPE UnsafeParallelHashMap_2_ReadOnly {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr UnsafeParallelHashMap_2_ReadOnly() ;
...
template<typename TKey,typename TValue>
// Is value type: true
// CS Name: Unity.Collections.LowLevel.Unsafe.UnsafeParallelHashMap`2/ParallelWriter<TKey,TValue>
struct CORDL_TYPE UnsafeParallelHashMap_2_ParallelWriter {
public:
// Declarations
 __declspec(property(get=get_Capacity)) int32_t  Capacity;
...
// Ctor Parameters []
// @brief default ctor
constexpr UnsafeParallelHashMap_2_ParallelWriter() ;

// Ctor Parameters [CppParam { name: "m_Buffer", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*", modifiers: "", def_value: None }, CppParam { name: "m_ThreadIndex", ty: "int32_t", modifiers: "", def_value: None }]
...
template<typename TKey,typename TValue>
// Is value type: true
// CS Name: Unity.Collections.LowLevel.Unsafe.UnsafeParallelHashMap`2/Enumerator<TKey,TValue>
struct CORDL_TYPE UnsafeParallelHashMap_2_Enumerator {
public:
// Declarations
...
constexpr ::System::Collections::Generic::IEnumerator_1<::Unity::Collections::LowLevel::Unsafe::KeyValue_2<TKey,TValue>>* i___System__Collections__Generic__IEnumerator_1___Unity__Collections__LowLevel__Unsafe__KeyValue_2_TKey_TValue__() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr UnsafeParallelHashMap_2_Enumerator() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelHashMap`2");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_Enumerator, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelHashMap`2/Enumerator");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ParallelWriter, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelHashMap`2/ParallelWriter");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ReadOnly, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelHashMap`2/ReadOnly");
