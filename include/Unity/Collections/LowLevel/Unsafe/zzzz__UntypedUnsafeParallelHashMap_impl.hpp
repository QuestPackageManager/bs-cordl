...
constexpr ::Unity::Collections::LowLevel::Unsafe::UntypedUnsafeParallelHashMap::UntypedUnsafeParallelHashMap(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  m_Buffer, ::Unity::Collections::AllocatorManager_AllocatorHandle  m_AllocatorLabel) noexcept  {
