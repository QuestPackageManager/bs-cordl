...
/// @brief Method Alloc, addr 0x630df30, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method CheckCapacityInRange, addr 0x6319b64, size 0xec, virtual false, abstract: false, final false
static inline void CheckCapacityInRange(int32_t  value, int32_t  length) ;

/// @brief Method CheckIndexInRange, addr 0x631998c, size 0x158, virtual false, abstract: false, final false
inline void CheckIndexInRange(int32_t  index) ;

/// @brief Method Clear, addr 0x63197d0, size 0x8, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Dispose, addr 0x63195b8, size 0x8c, virtual true, abstract: false, final true
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x630debc, size 0x74, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method ElementAt, addr 0x630e9f8, size 0x54, virtual true, abstract: false, final true
inline ::ByRef<uint8_t> ElementAt(int32_t  index) ;

/// @brief Method Free, addr 0x630ed5c, size 0xa8, virtual false, abstract: false, final false
static inline void Free(::Unity::Collections::LowLevel::Unsafe::UnsafeText*  data) ;

/// @brief Method GetUnsafePtr, addr 0x630e270, size 0x8, virtual true, abstract: false, final true
inline uint8_t* GetUnsafePtr() ;

/// @brief Method ThrowCopyError, addr 0x6319ae4, size 0x80, virtual false, abstract: false, final false
inline void ThrowCopyError(::Unity::Collections::CopyError  error, ::StringW  source) ;

/// @brief Method ToString, addr 0x6310334, size 0xdc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryResize, addr 0x63197d8, size 0xd4, virtual true, abstract: false, final true
inline bool TryResize(int32_t  newLength, ::Unity::Collections::NativeArrayOptions  clearOptions) ;

/// @brief Method .ctor, addr 0x630e000, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method get_Capacity, addr 0x63198ac, size 0x70, virtual true, abstract: false, final true
inline int32_t get_Capacity() ;

/// @brief Method get_IsCreated, addr 0x6319544, size 0x74, virtual false, abstract: false, final false
inline bool get_IsCreated() ;

/// @brief Method get_IsEmpty, addr 0x6319644, size 0xe0, virtual true, abstract: false, final true
inline bool get_IsEmpty() ;

/// @brief Method get_Item, addr 0x6319724, size 0x54, virtual true, abstract: false, final true
inline uint8_t get_Item(int32_t  index) ;

/// @brief Method get_Length, addr 0x631991c, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method set_Capacity, addr 0x630e814, size 0x84, virtual true, abstract: false, final true
inline void set_Capacity(int32_t  value) ;

/// @brief Method set_Item, addr 0x6319778, size 0x58, virtual true, abstract: false, final true
inline void set_Item(int32_t  index, uint8_t  value) ;

/// @brief Method set_Length, addr 0x630e6d0, size 0xcc, virtual true, abstract: false, final true
