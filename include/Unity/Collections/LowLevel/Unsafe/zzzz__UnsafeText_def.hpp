...
public:
  ...
  /// @brief Method Clear, addr 0x64cf78c, size 0x8, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Dispose, addr 0x64cf574, size 0x8c, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x64c3e78, size 0x74, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method ElementAt, addr 0x64c49b4, size 0x54, virtual true, abstract: false, final true
  inline ::by_ref<uint8_t> ElementAt(int32_t index);

  /// @brief Method Free, addr 0x64c4d18, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryResize, addr 0x64cf794, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Capacity, addr 0x64c47d0, size 0x84, virtual true, abstract: false, final true
  inline void set_Capacity(int32_t value);

  /// @brief Method set_Item, addr 0x64cf734, size 0x58, virtual true, abstract: false, final true
  inline void set_Item(int32_t index, uint8_t value);

  /// @brief Method set_Length, addr 0x64c468c, size 0xcc, virtual true, abstract: false, final true
