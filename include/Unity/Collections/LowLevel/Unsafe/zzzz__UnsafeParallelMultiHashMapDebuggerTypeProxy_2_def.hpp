...
static inline ::System::ValueTuple_2<::Unity::Collections::NativeArray_1<TKey>,int32_t> GetUniqueKeyArray(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<TKey,TValue>>  hashMap, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMapDebuggerTypeProxy_2, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelMultiHashMapDebuggerTypeProxy`2");
