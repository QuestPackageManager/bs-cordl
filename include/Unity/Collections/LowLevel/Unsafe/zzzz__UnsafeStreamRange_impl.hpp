...
// Ctor Parameters [CppParam { name: "Block", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "OffsetInFirstBlock", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "ElementCount", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "LastOffset", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "NumberOfBlocks", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment:
// None }]
