...
public:
// Declarations
/// @brief Method Add, addr 0x6317e18, size 0x5c, virtual false, abstract: false, final false
inline int64_t Add(int64_t  value) ;

/// @brief Method AddSat, addr 0x6317ed0, size 0x90, virtual false, abstract: false, final false
inline int64_t AddSat(int64_t  value, int64_t  max) ;

/// @brief Method Reset, addr 0x6317e0c, size 0xc, virtual false, abstract: false, final false
inline void Reset(int64_t  value) ;

/// @brief Method Sub, addr 0x6317e74, size 0x5c, virtual false, abstract: false, final false
inline int64_t Sub(int64_t  value) ;

/// @brief Method SubSat, addr 0x6317f60, size 0x90, virtual false, abstract: false, final false
inline int64_t SubSat(int64_t  value, int64_t  min) ;

/// @brief Method .ctor, addr 0x6317e04, size 0x8, virtual false, abstract: false, final false
