...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2_KeyValueEnumerator, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelMultiHashMap`2/KeyValueEnumerator");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2_ParallelWriter, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelMultiHashMap`2/ParallelWriter");
