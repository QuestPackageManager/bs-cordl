...
// Ctor Parameters [CppParam { name: "m_Data", ty: "::Unity::Collections::LowLevel::Unsafe::HashMapHelper_1<TKey>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Index",
// ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_BucketIndex", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "m_NextIndex", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename TKey>
...
// None }, CppParam { name: "Count", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Capacity", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "Log2MinGrowth", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "BucketCapacity", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "AllocatedIndex", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "FirstFreeIdx", ty: "int32_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "SizeOfTValue", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Allocator", ty:
