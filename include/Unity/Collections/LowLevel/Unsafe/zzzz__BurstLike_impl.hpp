...
#include "Unity/Collections/LowLevel/Unsafe/zzzz__BurstLike_def.hpp"
template <typename T> inline void Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>::_ctor(::cordl_internals::Ptr<void> buffer) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
template <typename T> inline ByRef<T> Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>::get_Data() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>>::get(), "get_Data",
...
inline ::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T> Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>::GetOrCreate(uint32_t alignment) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>>::get(), "GetOrCreate",
...
template <typename T> constexpr ::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>::__BurstLike__SharedStatic_1(::cordl_internals::Ptr<void> _buffer) noexcept {
  this->_buffer = _buffer;
}
// Ctor Parameters []
template <typename T> constexpr ::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>::__BurstLike__SharedStatic_1() {}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::cordl_internals::Ptr<void> (*)(int64_t, int64_t, uint32_t, uint32_t)>(
    &::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic::GetOrCreateSharedStaticInternal)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x47e8ed4;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic*>::get(), "GetOrCreateSharedStaticInternal",
...
inline ::cordl_internals::Ptr<void> Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic::GetOrCreateSharedStaticInternal(int64_t getHashCode64, int64_t getSubHashCode64, uint32_t sizeOf,
                                                                                                                                     uint32_t alignment) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic*>::get(), "GetOrCreateSharedStaticInternal",
      std::span<Il2CppClass const* const, 0>(),
