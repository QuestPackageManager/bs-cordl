...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute::*)()>(
  ...
  constexpr static std::size_t addrs = 0x6a5a654;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute*>(), { ".ctor", {}, {} })));
...
inline ::Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute* Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute*>());
}
// Ctor Parameters []
