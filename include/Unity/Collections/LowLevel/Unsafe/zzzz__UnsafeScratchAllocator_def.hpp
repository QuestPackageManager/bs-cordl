...
public:
  ...
  /// @brief Method Allocate, addr 0x638b120, size 0x3c, virtual false, abstract: false, final false
  inline void* Allocate(int32_t sizeInBytes, int32_t alignmentInBytes);

  /// @brief Method CheckAllocationDoesNotExceedCapacity, addr 0x638b054, size 0xcc, virtual false, abstract: false, final false
  inline void CheckAllocationDoesNotExceedCapacity(uint64_t requestedSize);

  /// @brief Method .ctor, addr 0x638b048, size 0xc, virtual false, abstract: false, final false
