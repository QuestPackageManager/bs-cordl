...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock* (
  ...
  constexpr static std::size_t addrs = 0x64cf10c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlockData::*)(::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*)>(
  ...
  constexpr static std::size_t addrs = 0x64cf178;
...
// Ctor Parameters [CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Blocks", ty:
// "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "BlockCount", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "Ranges", ty: "::Unity::Collections::AllocatorManager_Block", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "RangeCount", ty:
