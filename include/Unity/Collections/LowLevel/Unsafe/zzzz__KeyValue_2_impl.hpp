...
template <typename TKey, typename TValue>
  requires(::cordl_internals::type_constraint<TKey, ::System::IEquatable_1<TKey>*> && ::cordl_internals::value_type_constraint<TKey> && ::cordl_internals::default_constructor_constraint<TKey> &&
           ::cordl_internals::value_type_constraint<TValue> && ::cordl_internals::default_constructor_constraint<TValue>)
inline ::by_ref<TValue> Unity::Collections::LowLevel::Unsafe::KeyValue_2<TKey, TValue>::get_Value() {
...
template <typename TKey, typename TValue>
  requires(::cordl_internals::type_constraint<TKey, ::System::IEquatable_1<TKey>*> && ::cordl_internals::value_type_constraint<TKey> && ::cordl_internals::default_constructor_constraint<TKey> &&
           ::cordl_internals::value_type_constraint<TValue> && ::cordl_internals::default_constructor_constraint<TValue>)
inline bool Unity::Collections::LowLevel::Unsafe::KeyValue_2<TKey, TValue>::GetKeyValue(::by_ref<TKey> key, ::by_ref<TValue> value) {
...
// "m_Index", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Next", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename TKey, typename TValue>
  requires(::cordl_internals::type_constraint<TKey, ::System::IEquatable_1<TKey>*> && ::cordl_internals::value_type_constraint<TKey> && ::cordl_internals::default_constructor_constraint<TKey> &&
           ::cordl_internals::value_type_constraint<TValue> && ::cordl_internals::default_constructor_constraint<TValue>)
