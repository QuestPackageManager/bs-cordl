...
public:
  ...
  /// @brief Method Free, addr 0x6905888, size 0x44, virtual false, abstract: false, final false
  static inline void Free(void* memory, ::Unity::Collections::Allocator allocator);

  /// @brief Method FreeTracked, addr 0x6905538, size 0x44, virtual false, abstract: false, final false
  static inline void FreeTracked(void* memory, ::Unity::Collections::Allocator allocator);

  /// @brief Method GetReasonForArrayNonBlittable, addr 0x6905e60, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method GetReasonForTypeNonBlittableImpl, addr 0x6905bfc, size 0x230, virtual false, abstract: false, final false
  static inline ::StringW GetReasonForTypeNonBlittableImpl(::System::Type* t, ::StringW name);

  /// @brief Method GetScriptingTypeFlags, addr 0x6905b58, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsArrayBlittable, addr 0x6905e2c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBlittable, addr 0x6905b1c, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsBlittable(::System::Type* type);

  /// @brief Method IsBlittableValueType, addr 0x6905b94, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method LeakErase, addr 0x6905794, size 0x44, virtual false, abstract: false, final false
  static inline int32_t LeakErase(::System::IntPtr handle, ::Unity::Collections::LeakCategory category);

  /// @brief Method LeakRecord, addr 0x6905740, size 0x54, virtual false, abstract: false, final false
  static inline int32_t LeakRecord(::System::IntPtr handle, ::Unity::Collections::LeakCategory category, int32_t callstacksToSkip);

  /// @brief Method Malloc, addr 0x6905834, size 0x54, virtual false, abstract: false, final false
  static inline void* Malloc(int64_t size, int32_t alignment, ::Unity::Collections::Allocator allocator);

  /// @brief Method MallocTracked, addr 0x69057d8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method MemClear, addr 0x6905a44, size 0x48, virtual false, abstract: false, final false
  static inline void MemClear(void* destination, int64_t size);

  /// @brief Method MemCmp, addr 0x6905a8c, size 0x54, virtual false, abstract: false, final false
  static inline int32_t MemCmp(void* ptr1, void* ptr2, int64_t size);

  /// @brief Method MemCpy, addr 0x6904500, size 0x54, virtual false, abstract: false, final false
  static inline void MemCpy(void* destination, void* source, int64_t size);

  /// @brief Method MemCpyReplicate, addr 0x69058cc, size 0x5c, virtual false, abstract: false, final false
  static inline void MemCpyReplicate(void* destination, void* source, int32_t size, int32_t count);

  /// @brief Method MemCpyStride, addr 0x6905928, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method MemMove, addr 0x690599c, size 0x54, virtual false, abstract: false, final false
  static inline void MemMove(void* destination, void* source, int64_t size);

  /// @brief Method MemSet, addr 0x69059f0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SizeOf, addr 0x6905ae0, size 0x3c, virtual false, abstract: false, final false
