...
template<typename T>
static inline void* AddressOf(::ByRef<T>  output) ;
...
template<typename T>
static inline ::ByRef<T> ArrayElementAsRef(void*  ptr, int32_t  index) ;
...
/// @brief Method Free, addr 0x689387c, size 0x44, virtual false, abstract: false, final false
static inline void Free(void*  memory, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method FreeTracked, addr 0x689352c, size 0x44, virtual false, abstract: false, final false
static inline void FreeTracked(void*  memory, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method GetReasonForArrayNonBlittable, addr 0x6893e54, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method GetReasonForTypeNonBlittableImpl, addr 0x6893bf0, size 0x230, virtual false, abstract: false, final false
static inline ::StringW GetReasonForTypeNonBlittableImpl(::System::Type*  t, ::StringW  name) ;

/// @brief Method GetScriptingTypeFlags, addr 0x6893b4c, size 0x3c, virtual false, abstract: false, final false
...
template<typename T>
static inline void InternalCopyPtrToStructure(void*  ptr, ::ByRef<T>  output) ;

/// @brief Method InternalCopyStructureToPtr, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void InternalCopyStructureToPtr(::ByRef<T>  input, void*  ptr) ;
...
/// @brief Method IsArrayBlittable, addr 0x6893e20, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method IsBlittable, addr 0x6893b10, size 0x3c, virtual false, abstract: false, final false
static inline bool IsBlittable(::System::Type*  type) ;

/// @brief Method IsBlittableValueType, addr 0x6893b88, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method LeakErase, addr 0x6893788, size 0x44, virtual false, abstract: false, final false
static inline int32_t LeakErase(::System::IntPtr  handle, ::Unity::Collections::LeakCategory  category) ;

/// @brief Method LeakRecord, addr 0x6893734, size 0x54, virtual false, abstract: false, final false
static inline int32_t LeakRecord(::System::IntPtr  handle, ::Unity::Collections::LeakCategory  category, int32_t  callstacksToSkip) ;

/// @brief Method Malloc, addr 0x6893828, size 0x54, virtual false, abstract: false, final false
static inline void* Malloc(int64_t  size, int32_t  alignment, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method MallocTracked, addr 0x68937cc, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method MemClear, addr 0x6893a38, size 0x48, virtual false, abstract: false, final false
static inline void MemClear(void*  destination, int64_t  size) ;

/// @brief Method MemCmp, addr 0x6893a80, size 0x54, virtual false, abstract: false, final false
static inline int32_t MemCmp(void*  ptr1, void*  ptr2, int64_t  size) ;

/// @brief Method MemCpy, addr 0x68924f4, size 0x54, virtual false, abstract: false, final false
static inline void MemCpy(void*  destination, void*  source, int64_t  size) ;

/// @brief Method MemCpyReplicate, addr 0x68938c0, size 0x5c, virtual false, abstract: false, final false
static inline void MemCpyReplicate(void*  destination, void*  source, int32_t  size, int32_t  count) ;

/// @brief Method MemCpyStride, addr 0x689391c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method MemMove, addr 0x6893990, size 0x54, virtual false, abstract: false, final false
static inline void MemMove(void*  destination, void*  source, int64_t  size) ;

/// @brief Method MemSet, addr 0x68939e4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SizeOf, addr 0x6893ad4, size 0x3c, virtual false, abstract: false, final false
