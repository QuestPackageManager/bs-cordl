...
// Ctor Parameters [CppParam { name: "Ptr", ty: "T*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "ListData", ty:
// "::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<::System::IntPtr>*", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1<T>::Add(/* [IsReadOnly] */ ::by_ref<::System::IntPtr> value) {
  static auto* ___internal_method = THROW_UNLESS(
