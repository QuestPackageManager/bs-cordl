...
public:
  ...
  /// @brief Method AllocateBlock, addr 0x64bdf00, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocateForEach, addr 0x64bdaf8, size 0xf4, virtual false, abstract: false, final false
  inline void AllocateForEach(int32_t forEachCount);

  /// @brief Method AsReader, addr 0x64be274, size 0x14, virtual false, abstract: false, final false
  inline ::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Reader AsReader();

  /// @brief Method AsWriter, addr 0x64be0e8, size 0x2c, virtual false, abstract: false, final false
  inline ::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Writer AsWriter();

  /// @brief Method Count, addr 0x64bddf4, size 0x54, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method Deallocate, addr 0x64c9a98, size 0x8c, virtual false, abstract: false, final false
  inline void Deallocate();

  /// @brief Method Dispose, addr 0x64c9b24, size 0x98, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x64bde58, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method IsEmpty, addr 0x64bdc94, size 0x5c, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method ScheduleConstruct, addr 0x64c99a8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64c997c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t bufferCount, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method get_ForEachCount, addr 0x64bdd18, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();

  /// @brief Method get_IsCreated, addr 0x64c9a4c, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x64c9bbc, size 0x4, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x64c9bc0, size 0x18, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x64c9bd8, size 0xc, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Allocate, addr 0x64be1dc, size 0x8c, virtual false, abstract: false, final false
  inline uint8_t* Allocate(int32_t size);

  /// @brief Method BeginForEachIndex, addr 0x64be164, size 0x1c, virtual false, abstract: false, final false
  inline void BeginForEachIndex(int32_t foreachIndex);

  /// @brief Method EndForEachIndex, addr 0x64be184, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64c9a70, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeStream> stream);

  /// @brief Method get_ForEachCount, addr 0x64be12c, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();
...
public:
  ...
  /// @brief Method BeginForEachIndex, addr 0x64be28c, size 0x54, virtual false, abstract: false, final false
  inline int32_t BeginForEachIndex(int32_t foreachIndex);

  /// @brief Method Count, addr 0x64be380, size 0x54, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method EndForEachIndex, addr 0x64be2e4, size 0x4, virtual false, abstract: false, final false
  inline void EndForEachIndex();
  ...
  /// @brief Method ReadUnsafePtr, addr 0x64c9bec, size 0x5c, virtual false, abstract: false, final false
  inline uint8_t* ReadUnsafePtr(int32_t size);

  /// @brief Method .ctor, addr 0x64c9a5c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeStream> stream);

  /// @brief Method get_ForEachCount, addr 0x64be300, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();

  /// @brief Method get_RemainingItemCount, addr 0x64c9be4, size 0x8, virtual false, abstract: false, final false
