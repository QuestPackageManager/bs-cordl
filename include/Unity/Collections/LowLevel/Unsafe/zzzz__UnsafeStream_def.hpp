...
public:
  ...
  /// @brief Method AllocateBlock, addr 0x637f768, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocateForEach, addr 0x637f360, size 0xf4, virtual false, abstract: false, final false
  inline void AllocateForEach(int32_t forEachCount);

  /// @brief Method AsReader, addr 0x637fadc, size 0x14, virtual false, abstract: false, final false
  inline ::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Reader AsReader();

  /// @brief Method AsWriter, addr 0x637f950, size 0x2c, virtual false, abstract: false, final false
  inline ::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Writer AsWriter();

  /// @brief Method Count, addr 0x637f65c, size 0x54, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method Deallocate, addr 0x638b300, size 0x8c, virtual false, abstract: false, final false
  inline void Deallocate();

  /// @brief Method Dispose, addr 0x638b38c, size 0x98, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x637f6c0, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method IsEmpty, addr 0x637f4fc, size 0x5c, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method ScheduleConstruct, addr 0x638b210, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x638b1e4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t bufferCount, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method get_ForEachCount, addr 0x637f580, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();

  /// @brief Method get_IsCreated, addr 0x638b2b4, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x638b424, size 0x4, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x638b428, size 0x18, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x638b440, size 0xc, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Allocate, addr 0x637fa44, size 0x8c, virtual false, abstract: false, final false
  inline uint8_t* Allocate(int32_t size);

  /// @brief Method BeginForEachIndex, addr 0x637f9cc, size 0x1c, virtual false, abstract: false, final false
  inline void BeginForEachIndex(int32_t foreachIndex);

  /// @brief Method EndForEachIndex, addr 0x637f9ec, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x638b2d8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeStream> stream);

  /// @brief Method get_ForEachCount, addr 0x637f994, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();
...
public:
  ...
  /// @brief Method BeginForEachIndex, addr 0x637faf4, size 0x54, virtual false, abstract: false, final false
  inline int32_t BeginForEachIndex(int32_t foreachIndex);

  /// @brief Method Count, addr 0x637fbe8, size 0x54, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method EndForEachIndex, addr 0x637fb4c, size 0x4, virtual false, abstract: false, final false
  inline void EndForEachIndex();
  ...
  /// @brief Method ReadUnsafePtr, addr 0x638b454, size 0x5c, virtual false, abstract: false, final false
  inline uint8_t* ReadUnsafePtr(int32_t size);

  /// @brief Method .ctor, addr 0x638b2c4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeStream> stream);

  /// @brief Method get_ForEachCount, addr 0x637fb68, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ForEachCount();

  /// @brief Method get_RemainingItemCount, addr 0x638b44c, size 0x8, virtual false, abstract: false, final false
