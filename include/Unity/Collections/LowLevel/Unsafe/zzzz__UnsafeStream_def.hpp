...
/// @brief Method AllocateBlock, addr 0x630d75c, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method AllocateForEach, addr 0x630d354, size 0xf4, virtual false, abstract: false, final false
inline void AllocateForEach(int32_t  forEachCount) ;

/// @brief Method AsReader, addr 0x630dad0, size 0x14, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Reader AsReader() ;

/// @brief Method AsWriter, addr 0x630d944, size 0x2c, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Writer AsWriter() ;

/// @brief Method Count, addr 0x630d650, size 0x54, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method Deallocate, addr 0x63192f4, size 0x8c, virtual false, abstract: false, final false
inline void Deallocate() ;

/// @brief Method Dispose, addr 0x6319380, size 0x98, virtual true, abstract: false, final true
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x630d6b4, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method IsEmpty, addr 0x630d4f0, size 0x5c, virtual false, abstract: false, final false
inline bool IsEmpty() ;

/// @brief Method ScheduleConstruct, addr 0x6319204, size 0xa4, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleConstruct(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeStream>  stream, ::Unity::Collections::NativeArray_1<int32_t>  bufferCount, ::Unity::Jobs::JobHandle  dependency, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method ScheduleConstruct, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleConstruct(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeStream>  stream, ::Unity::Collections::NativeList_1<T>  bufferCount, ::Unity::Jobs::JobHandle  dependency, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
...
/// @brief Method .ctor, addr 0x63191d8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(int32_t  bufferCount, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method get_ForEachCount, addr 0x630d574, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;

/// @brief Method get_IsCreated, addr 0x63192a8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x6319418, size 0x4, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Execute, addr 0x631941c, size 0x18, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Execute, addr 0x6319434, size 0xc, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Allocate, addr 0x630da38, size 0x8c, virtual false, abstract: false, final false
inline uint8_t* Allocate(int32_t  size) ;

/// @brief Method BeginForEachIndex, addr 0x630d9c0, size 0x1c, virtual false, abstract: false, final false
inline void BeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method EndForEachIndex, addr 0x630d9e0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63192cc, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeStream>  stream) ;

/// @brief Method get_ForEachCount, addr 0x630d988, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;
...
/// @brief Method BeginForEachIndex, addr 0x630dae8, size 0x54, virtual false, abstract: false, final false
inline int32_t BeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method Count, addr 0x630dbdc, size 0x54, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method EndForEachIndex, addr 0x630db40, size 0x4, virtual false, abstract: false, final false
inline void EndForEachIndex() ;
...
/// @brief Method ReadUnsafePtr, addr 0x6319448, size 0x5c, virtual false, abstract: false, final false
inline uint8_t* ReadUnsafePtr(int32_t  size) ;

/// @brief Method .ctor, addr 0x63192b8, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeStream>  stream) ;

/// @brief Method get_ForEachCount, addr 0x630db5c, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;

/// @brief Method get_RemainingItemCount, addr 0x6319440, size 0x8, virtual false, abstract: false, final false
