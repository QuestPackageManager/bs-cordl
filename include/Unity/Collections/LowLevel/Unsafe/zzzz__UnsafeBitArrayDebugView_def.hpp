...
/// @brief Method .ctor, addr 0x6318b88, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::LowLevel::Unsafe::UnsafeBitArray  data) ;

/// @brief Method get_Bits, addr 0x6318b9c, size 0xa0, virtual false, abstract: false, final false
