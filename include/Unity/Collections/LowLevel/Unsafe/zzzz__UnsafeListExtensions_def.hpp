...
template<typename T>
static inline bool ArraysEqual(::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>  container, ::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>>  other) ;
