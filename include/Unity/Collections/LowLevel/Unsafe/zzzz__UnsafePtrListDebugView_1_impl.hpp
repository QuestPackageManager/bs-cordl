...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::UnsafePtrListDebugView_1<T>*>::get(),
                        ".ctor",
...
template<typename T>
inline ::ArrayW<T*,::Array<T*>*> Unity::Collections::LowLevel::Unsafe::UnsafePtrListDebugView_1<T>::get_Items()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::UnsafePtrListDebugView_1<T>*>::get(),
                        "get_Items",
                        std::span<const Il2CppClass* const, 0>(),
