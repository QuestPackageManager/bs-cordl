...
template <typename T> inline void Unity::Collections::LowLevel::Unsafe::UnsafePtrListDebugView_1<T>::_ctor(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1<T> data) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::LowLevel::Unsafe::UnsafePtrListDebugView_1<T>*>(),
                                                                                         { ".ctor", {}, { ::i2c::type_of<::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1<T>>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, data);
}
template <typename T> inline ::ArrayW<T*> Unity::Collections::LowLevel::Unsafe::UnsafePtrListDebugView_1<T>::get_Items() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::LowLevel::Unsafe::UnsafePtrListDebugView_1<T>*>(), { "get_Items", {}, {} })));
