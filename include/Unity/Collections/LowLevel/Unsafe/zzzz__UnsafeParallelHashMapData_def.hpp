...
public:
  ...
  /// @brief Method CheckHashMapReallocateDoesNotShrink, addr 0x638af3c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method DeallocateHashMap, addr 0x638ace0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBucketData, addr 0x638af24, size 0x18, virtual false, abstract: false, final false
  inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapBucketData GetBucketData();

  /// @brief Method GetBucketSize, addr 0x638acc8, size 0x8, virtual false, abstract: false, final false
  static inline int32_t GetBucketSize(int32_t capacity);

  /// @brief Method GetCount, addr 0x638adc8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GrowCapacity, addr 0x638acd0, size 0x10, virtual false, abstract: false, final false
  static inline int32_t GrowCapacity(int32_t capacity);

  /// @brief Method IsEmpty, addr 0x638ad6c, size 0x5c, virtual false, abstract: false, final false
  static inline bool IsEmpty(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData* data);

  /// @brief Method MoveNext, addr 0x638aeec, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveNextSearch, addr 0x638ae78, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_firstFreeTLS, addr 0x638acc0, size 0x8, virtual false, abstract: false, final false
