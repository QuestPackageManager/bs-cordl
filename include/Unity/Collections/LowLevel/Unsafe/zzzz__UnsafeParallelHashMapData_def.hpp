...
template<typename TKey,typename TValue>
static inline void AllocateHashMap(int32_t  length, int32_t  bucketLength, ::Unity::Collections::AllocatorManager_AllocatorHandle  label, ::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*>  outBuf) ;
...
/// @brief Method CheckHashMapReallocateDoesNotShrink, addr 0x6318f30, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method DeallocateHashMap, addr 0x6318cd4, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method GetBucketData, addr 0x6318f18, size 0x18, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapBucketData GetBucketData() ;

/// @brief Method GetBucketSize, addr 0x6318cbc, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetBucketSize(int32_t  capacity) ;

/// @brief Method GetCount, addr 0x6318dbc, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method GrowCapacity, addr 0x6318cc4, size 0x10, virtual false, abstract: false, final false
static inline int32_t GrowCapacity(int32_t  capacity) ;

/// @brief Method IsEmpty, addr 0x6318d60, size 0x5c, virtual false, abstract: false, final false
static inline bool IsEmpty(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  data) ;

/// @brief Method MoveNext, addr 0x6318ee0, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method MoveNextSearch, addr 0x6318e6c, size 0x74, virtual false, abstract: false, final false
...
template<typename TKey,typename TValue>
static inline void ReallocateHashMap(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  data, int32_t  newCapacity, int32_t  newBucketCapacity, ::Unity::Collections::AllocatorManager_AllocatorHandle  label) ;
...
/// @brief Method get_firstFreeTLS, addr 0x6318cb4, size 0x8, virtual false, abstract: false, final false
