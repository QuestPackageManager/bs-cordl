...
template<typename U>
static inline ::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>* Create(int32_t  initialCapacity, ::ByRef<U>  allocator, ::Unity::Collections::NativeArrayOptions  options) ;
...
/// @brief Method Destroy, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename U>
static inline void Destroy(::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>*  listData, ::ByRef<U>  allocator) ;
...
template<typename U>
inline void ResizeExact(::ByRef<U>  allocator, int32_t  newCapacity) ;
...
template<typename U>
inline void SetCapacity(::ByRef<U>  allocator, int32_t  capacity) ;
