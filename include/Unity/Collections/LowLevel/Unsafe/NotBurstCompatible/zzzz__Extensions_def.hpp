...
public:
// Declarations
/// @brief Method AddNBC, addr 0x638da20, size 0x90, virtual false, abstract: false, final false
static inline void AddNBC(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeAppendBuffer>  buffer, ::StringW  value) ;

/// @brief Method ReadNextNBC, addr 0x638db64, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method ToBytesNBC, addr 0x638dab0, size 0xb4, virtual false, abstract: false, final false
