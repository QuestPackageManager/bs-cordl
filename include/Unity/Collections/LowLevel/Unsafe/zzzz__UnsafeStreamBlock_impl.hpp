...
// Ctor Parameters [CppParam { name: "Next", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Data", ty:
// "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock__Data_e__FixedBuffer", modifiers: "", def_value: Some("{}"), comment: None }]
