...
// Ctor Parameters [CppParam { name: "Next", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: Some("{}") }, CppParam { name: "Data", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock__Data_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr ::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock::UnsafeStreamBlock(::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*  Next, ::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock__Data_e__FixedBuffer  Data) noexcept  {
this->Next = Next;
this->Data = Data;
}
// Ctor Parameters []
