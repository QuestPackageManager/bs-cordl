...
public:
  // Declarations
  template <typename T> using HashCode64_1 = ::Unity::Collections::LowLevel::Unsafe::__BurstRuntime__HashCode64_1<T>;
  ...
  /// @brief Method HashStringWithFNV1A64, addr 0x47fd6b4, size 0x8c, virtual false, abstract: false, final false
