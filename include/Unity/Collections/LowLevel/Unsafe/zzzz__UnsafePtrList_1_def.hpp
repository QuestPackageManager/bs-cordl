...
public:
  ...
  inline void Add(::ByRef<::System::IntPtr> value);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1, "Unity.Collections.LowLevel.Unsafe", "UnsafePtrList`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelReader, "Unity.Collections.LowLevel.Unsafe", "UnsafePtrList`1/ParallelReader");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelWriter, "Unity.Collections.LowLevel.Unsafe", "UnsafePtrList`1/ParallelWriter");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ReadOnly, "Unity.Collections.LowLevel.Unsafe", "UnsafePtrList`1/ReadOnly");
