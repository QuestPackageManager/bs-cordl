...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnsafeHashSetDebuggerTypeProxy_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnsafeHashSetDebuggerTypeProxy_1(UnsafeHashSetDebuggerTypeProxy_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnsafeHashSetDebuggerTypeProxy_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnsafeHashSetDebuggerTypeProxy_1(UnsafeHashSetDebuggerTypeProxy_1const&) = delete;
