...
public:
  // Declarations
  /// @brief Method AsUnsafeListOfBytes, addr 0x638b4b0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method AsUnsafeListOfBytesRO, addr 0x638b4f4, size 0x5c, virtual false, abstract: false, final false
