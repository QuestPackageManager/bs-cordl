...
template<typename T>
inline void* Unity::Collections::LowLevel::Unsafe::ILSupport::AddressOf(::ByRef<T>  thing)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::ILSupport*>::get(),
                    "AddressOf",
...
template<typename T>
inline ::ByRef<T> Unity::Collections::LowLevel::Unsafe::ILSupport::AsRef(::ByRef<T>  thing)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::ILSupport*>::get(),
                    "AsRef",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
