...
/// @brief Method CheckArgs, addr 0x6318838, size 0xdc, virtual false, abstract: false, final false
inline void CheckArgs(int32_t  pos, int32_t  numBits) ;

/// @brief Method CheckArgsPosCount, addr 0x6318914, size 0x154, virtual false, abstract: false, final false
inline void CheckArgsPosCount(int32_t  begin, int32_t  count, int32_t  numBits) ;

/// @brief Method CheckArgsUlong, addr 0x6318a68, size 0x120, virtual false, abstract: false, final false
inline void CheckArgsUlong(int32_t  pos, int32_t  numBits) ;

/// @brief Method CountBits, addr 0x630d14c, size 0x20, virtual false, abstract: false, final false
inline int32_t CountBits(int32_t  pos, int32_t  numBits) ;

/// @brief Method Find, addr 0x630d080, size 0xc, virtual false, abstract: false, final false
inline int32_t Find(int32_t  pos, int32_t  count, int32_t  numBits) ;

/// @brief Method Find, addr 0x630d060, size 0x14, virtual false, abstract: false, final false
inline int32_t Find(int32_t  pos, int32_t  numBits) ;

/// @brief Method GetBits, addr 0x630cffc, size 0x20, virtual false, abstract: false, final false
inline uint64_t GetBits(int32_t  pos, int32_t  numBits) ;

/// @brief Method IsSet, addr 0x630d034, size 0x18, virtual false, abstract: false, final false
inline bool IsSet(int32_t  pos) ;

/// @brief Method TestAll, addr 0x630d10c, size 0x20, virtual false, abstract: false, final false
inline bool TestAll(int32_t  pos, int32_t  numBits) ;

/// @brief Method TestAny, addr 0x630d0cc, size 0x20, virtual false, abstract: false, final false
inline bool TestAny(int32_t  pos, int32_t  numBits) ;

/// @brief Method TestNone, addr 0x630d09c, size 0x10, virtual false, abstract: false, final false
inline bool TestNone(int32_t  pos, int32_t  numBits) ;

/// @brief Method .ctor, addr 0x63182f0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(uint64_t*  ptr, int32_t  length) ;

/// @brief Method get_IsCreated, addr 0x630cf74, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCreated() ;

/// @brief Method get_IsEmpty, addr 0x630cfa4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Alloc, addr 0x630c464, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method AsReadOnly, addr 0x630cfc4, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeBitArray_ReadOnly AsReadOnly() ;

/// @brief Method CheckArgs, addr 0x63183a0, size 0xdc, virtual false, abstract: false, final false
inline void CheckArgs(int32_t  pos, int32_t  numBits) ;

/// @brief Method CheckArgsCopy, addr 0x63186f0, size 0x148, virtual false, abstract: false, final false
static inline void CheckArgsCopy(::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeBitArray>  dstBitArray, int32_t  dstPos, ::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeBitArray>  srcBitArray, int32_t  srcPos, int32_t  numBits) ;

/// @brief Method CheckArgsPosCount, addr 0x631847c, size 0x154, virtual false, abstract: false, final false
inline void CheckArgsPosCount(int32_t  begin, int32_t  count, int32_t  numBits) ;

/// @brief Method CheckArgsUlong, addr 0x63185d0, size 0x120, virtual false, abstract: false, final false
inline void CheckArgsUlong(int32_t  pos, int32_t  numBits) ;

/// @brief Method CheckSizeMultipleOf8, addr 0x63182fc, size 0xa4, virtual false, abstract: false, final false
static inline void CheckSizeMultipleOf8(int32_t  sizeInBytes) ;

/// @brief Method Clear, addr 0x630c87c, size 0x54, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Copy, addr 0x630cb48, size 0x2ac, virtual false, abstract: false, final false
...
/// @brief Method Copy, addr 0x630cb20, size 0x1c, virtual false, abstract: false, final false
inline void Copy(int32_t  dstPos, int32_t  srcPos, int32_t  numBits) ;

/// @brief Method CopyUlong, addr 0x63182a4, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method CountBits, addr 0x630cf18, size 0x20, virtual false, abstract: false, final false
inline int32_t CountBits(int32_t  pos, int32_t  numBits) ;

/// @brief Method Dispose, addr 0x63181b0, size 0xcc, virtual true, abstract: false, final true
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x6317ff0, size 0xa0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Find, addr 0x630ce2c, size 0xc, virtual false, abstract: false, final false
inline int32_t Find(int32_t  pos, int32_t  count, int32_t  numBits) ;

/// @brief Method Find, addr 0x630ce08, size 0x14, virtual false, abstract: false, final false
inline int32_t Find(int32_t  pos, int32_t  numBits) ;

/// @brief Method Free, addr 0x630c680, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method GetBits, addr 0x630caac, size 0x20, virtual false, abstract: false, final false
inline uint64_t GetBits(int32_t  pos, int32_t  numBits) ;

/// @brief Method IsSet, addr 0x630cae8, size 0x18, virtual false, abstract: false, final false
inline bool IsSet(int32_t  pos) ;

/// @brief Method Realloc, addr 0x63180b0, size 0x100, virtual false, abstract: false, final false
inline void Realloc(int32_t  capacityInBits) ;

/// @brief Method Resize, addr 0x630c540, size 0x68, virtual false, abstract: false, final false
inline void Resize(int32_t  numBits, ::Unity::Collections::NativeArrayOptions  options) ;

/// @brief Method Set, addr 0x630c900, size 0x2c, virtual false, abstract: false, final false
inline void Set(int32_t  pos, bool  value) ;

/// @brief Method Set, addr 0x631827c, size 0x28, virtual false, abstract: false, final false
static inline void Set(uint64_t*  ptr, int32_t  pos, bool  value) ;

/// @brief Method SetBits, addr 0x630c934, size 0xac, virtual false, abstract: false, final false
inline void SetBits(int32_t  pos, bool  value, int32_t  numBits) ;

/// @brief Method SetBits, addr 0x630c9e8, size 0xa4, virtual false, abstract: false, final false
inline void SetBits(int32_t  pos, uint64_t  value, int32_t  numBits) ;

/// @brief Method SetCapacity, addr 0x630c5c0, size 0x14, virtual false, abstract: false, final false
inline void SetCapacity(int32_t  capacityInBits) ;

/// @brief Method TestAll, addr 0x630ced8, size 0x20, virtual false, abstract: false, final false
inline bool TestAll(int32_t  pos, int32_t  numBits) ;

/// @brief Method TestAny, addr 0x630ce98, size 0x20, virtual false, abstract: false, final false
inline bool TestAny(int32_t  pos, int32_t  numBits) ;

/// @brief Method TestNone, addr 0x630ce58, size 0x20, virtual false, abstract: false, final false
inline bool TestNone(int32_t  pos, int32_t  numBits) ;

/// @brief Method TrimExcess, addr 0x630c5ec, size 0x14, virtual false, abstract: false, final false
inline void TrimExcess() ;

/// @brief Method .ctor, addr 0x630c4d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6317634, size 0x14, virtual false, abstract: false, final false
inline void _ctor(void*  ptr, int32_t  sizeInBytes, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method get_IsCreated, addr 0x630c500, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCreated() ;

/// @brief Method get_IsEmpty, addr 0x6318090, size 0x20, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;
