...
public:
  ...
  /// @brief Method CheckArgs, addr 0x638a844, size 0xdc, virtual false, abstract: false, final false
  inline void CheckArgs(int32_t pos, int32_t numBits);

  /// @brief Method CheckArgsPosCount, addr 0x638a920, size 0x154, virtual false, abstract: false, final false
  inline void CheckArgsPosCount(int32_t begin, int32_t count, int32_t numBits);

  /// @brief Method CheckArgsUlong, addr 0x638aa74, size 0x120, virtual false, abstract: false, final false
  inline void CheckArgsUlong(int32_t pos, int32_t numBits);

  /// @brief Method CountBits, addr 0x637f158, size 0x20, virtual false, abstract: false, final false
  inline int32_t CountBits(int32_t pos, int32_t numBits);

  /// @brief Method Find, addr 0x637f08c, size 0xc, virtual false, abstract: false, final false
  inline int32_t Find(int32_t pos, int32_t count, int32_t numBits);

  /// @brief Method Find, addr 0x637f06c, size 0x14, virtual false, abstract: false, final false
  inline int32_t Find(int32_t pos, int32_t numBits);

  /// @brief Method GetBits, addr 0x637f008, size 0x20, virtual false, abstract: false, final false
  inline uint64_t GetBits(int32_t pos, int32_t numBits);

  /// @brief Method IsSet, addr 0x637f040, size 0x18, virtual false, abstract: false, final false
  inline bool IsSet(int32_t pos);

  /// @brief Method TestAll, addr 0x637f118, size 0x20, virtual false, abstract: false, final false
  inline bool TestAll(int32_t pos, int32_t numBits);

  /// @brief Method TestAny, addr 0x637f0d8, size 0x20, virtual false, abstract: false, final false
  inline bool TestAny(int32_t pos, int32_t numBits);

  /// @brief Method TestNone, addr 0x637f0a8, size 0x10, virtual false, abstract: false, final false
  inline bool TestNone(int32_t pos, int32_t numBits);

  /// @brief Method .ctor, addr 0x638a2fc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint64_t* ptr, int32_t length);

  /// @brief Method get_IsCreated, addr 0x637ef80, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCreated();

  /// @brief Method get_IsEmpty, addr 0x637efb0, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Alloc, addr 0x637e470, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method AsReadOnly, addr 0x637efd0, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Collections::LowLevel::Unsafe::UnsafeBitArray_ReadOnly AsReadOnly();

  /// @brief Method CheckArgs, addr 0x638a3ac, size 0xdc, virtual false, abstract: false, final false
  inline void CheckArgs(int32_t pos, int32_t numBits);

  /// @brief Method CheckArgsCopy, addr 0x638a6fc, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckArgsPosCount, addr 0x638a488, size 0x154, virtual false, abstract: false, final false
  inline void CheckArgsPosCount(int32_t begin, int32_t count, int32_t numBits);

  /// @brief Method CheckArgsUlong, addr 0x638a5dc, size 0x120, virtual false, abstract: false, final false
  inline void CheckArgsUlong(int32_t pos, int32_t numBits);

  /// @brief Method CheckSizeMultipleOf8, addr 0x638a308, size 0xa4, virtual false, abstract: false, final false
  static inline void CheckSizeMultipleOf8(int32_t sizeInBytes);

  /// @brief Method Clear, addr 0x637e888, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Copy, addr 0x637eb54, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x637eb2c, size 0x1c, virtual false, abstract: false, final false
  inline void Copy(int32_t dstPos, int32_t srcPos, int32_t numBits);

  /// @brief Method CopyUlong, addr 0x638a2b0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method CountBits, addr 0x637ef24, size 0x20, virtual false, abstract: false, final false
  inline int32_t CountBits(int32_t pos, int32_t numBits);

  /// @brief Method Dispose, addr 0x638a1bc, size 0xcc, virtual true, abstract: false, final true
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x6389ffc, size 0xa0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Find, addr 0x637ee38, size 0xc, virtual false, abstract: false, final false
  inline int32_t Find(int32_t pos, int32_t count, int32_t numBits);

  /// @brief Method Find, addr 0x637ee14, size 0x14, virtual false, abstract: false, final false
  inline int32_t Find(int32_t pos, int32_t numBits);

  /// @brief Method Free, addr 0x637e68c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBits, addr 0x637eab8, size 0x20, virtual false, abstract: false, final false
  inline uint64_t GetBits(int32_t pos, int32_t numBits);

  /// @brief Method IsSet, addr 0x637eaf4, size 0x18, virtual false, abstract: false, final false
  inline bool IsSet(int32_t pos);

  /// @brief Method Realloc, addr 0x638a0bc, size 0x100, virtual false, abstract: false, final false
  inline void Realloc(int32_t capacityInBits);

  /// @brief Method Resize, addr 0x637e54c, size 0x68, virtual false, abstract: false, final false
  inline void Resize(int32_t numBits, ::Unity::Collections::NativeArrayOptions options);

  /// @brief Method Set, addr 0x637e90c, size 0x2c, virtual false, abstract: false, final false
  inline void Set(int32_t pos, bool value);

  /// @brief Method Set, addr 0x638a288, size 0x28, virtual false, abstract: false, final false
  static inline void Set(uint64_t* ptr, int32_t pos, bool value);

  /// @brief Method SetBits, addr 0x637e940, size 0xac, virtual false, abstract: false, final false
  inline void SetBits(int32_t pos, bool value, int32_t numBits);

  /// @brief Method SetBits, addr 0x637e9f4, size 0xa4, virtual false, abstract: false, final false
  inline void SetBits(int32_t pos, uint64_t value, int32_t numBits);

  /// @brief Method SetCapacity, addr 0x637e5cc, size 0x14, virtual false, abstract: false, final false
  inline void SetCapacity(int32_t capacityInBits);

  /// @brief Method TestAll, addr 0x637eee4, size 0x20, virtual false, abstract: false, final false
  inline bool TestAll(int32_t pos, int32_t numBits);

  /// @brief Method TestAny, addr 0x637eea4, size 0x20, virtual false, abstract: false, final false
  inline bool TestAny(int32_t pos, int32_t numBits);

  /// @brief Method TestNone, addr 0x637ee64, size 0x20, virtual false, abstract: false, final false
  inline bool TestNone(int32_t pos, int32_t numBits);

  /// @brief Method TrimExcess, addr 0x637e5f8, size 0x14, virtual false, abstract: false, final false
  inline void TrimExcess();

  /// @brief Method .ctor, addr 0x637e4dc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6389640, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(void* ptr, int32_t sizeInBytes, ::Unity::Collections::AllocatorManager_AllocatorHandle allocator);

  /// @brief Method get_IsCreated, addr 0x637e50c, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCreated();

  /// @brief Method get_IsEmpty, addr 0x638a09c, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsEmpty();
