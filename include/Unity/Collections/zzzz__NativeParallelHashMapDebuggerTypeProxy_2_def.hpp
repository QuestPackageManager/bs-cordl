...
// Write type traits
MARK_GEN_REF_PTR_T(::Unity::Collections::NativeParallelHashMapDebuggerTypeProxy_2);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Unity::Collections::NativeParallelHashMapDebuggerTypeProxy_2, "Unity.Collections", "NativeParallelHashMapDebuggerTypeProxy`2");
