...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::UnmanagedArray_1<T>>::get(),
                        "get_Length",
...
template<typename T>
inline ::ByRef<T> Unity::Collections::UnmanagedArray_1<T>::get_Item(int32_t  index)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::UnmanagedArray_1<T>>::get(),
                        "get_Item",
                        std::span<const Il2CppClass* const, 0>(),
