...
#include <cstddef>
CORDL_MODULE_EXPORT(FixedBytes32Align8)
// Forward declare root types
namespace Unity::Collections {
struct FixedBytes32Align8;
}
// Write type traits
MARK_VAL_T(::Unity::Collections::FixedBytes32Align8);
// Dependencies Unity.Collections.FixedBytes16Align8
namespace Unity::Collections {
// Is value type: true
// CS Name: Unity.Collections.FixedBytes32Align8
#pragma pack(push, 0)
struct CORDL_TYPE FixedBytes32Align8 {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr FixedBytes32Align8() ;

// Ctor Parameters [CppParam { name: "offset0000", ty: "::Unity::Collections::FixedBytes16Align8", modifiers: "", def_value: None }, CppParam { name: "offset0016", ty: "::Unity::Collections::FixedBytes16Align8", modifiers: "", def_value: None }]
constexpr FixedBytes32Align8(::Unity::Collections::FixedBytes16Align8  offset0000, ::Unity::Collections::FixedBytes16Align8  offset0016) noexcept;
...
static_assert(::cordl_internals::size_check_v<::Unity::Collections::FixedBytes32Align8, 0x20>, "Size mismatch!");
