...
public:
  ...
  // Ctor Parameters [CppParam { name: "f0", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None, comment: None }, CppParam { name: "f1", ty: "::Unity::Collections::Long64", modifiers:
  // "", def_value: None, comment: None }, CppParam { name: "f2", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None, comment: None }, CppParam { name: "f3", ty:
  // "::Unity::Collections::Long64", modifiers: "", def_value: None, comment: None }, CppParam { name: "f4", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None, comment: None },
  // CppParam { name: "f5", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None, comment: None }, CppParam { name: "f6", ty: "::Unity::Collections::Long64", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "f7", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None, comment: None }]
