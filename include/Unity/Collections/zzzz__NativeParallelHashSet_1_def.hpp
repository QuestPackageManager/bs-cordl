...
public:
  ...
  inline void _ctor(::ByRef<::Unity::Collections::NativeParallelHashSet_1<T>> data);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::NativeParallelHashSet_1, "Unity.Collections", "NativeParallelHashSet`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::NativeParallelHashSet_1_Enumerator, "Unity.Collections", "NativeParallelHashSet`1/Enumerator");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::NativeParallelHashSet_1_ParallelWriter, "Unity.Collections", "NativeParallelHashSet`1/ParallelWriter");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::NativeParallelHashSet_1_ReadOnly, "Unity.Collections", "NativeParallelHashSet`1/ReadOnly");
