...
template <typename T> inline void Unity::Collections::NativeHashSetDebuggerTypeProxy_1<T>::_ctor(::Unity::Collections::NativeHashSet_1<T> data) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::NativeHashSetDebuggerTypeProxy_1<T>*>(),
...
template <typename T> inline ::System::Collections::Generic::List_1<T>* Unity::Collections::NativeHashSetDebuggerTypeProxy_1<T>::get_Items() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Unity::Collections::NativeHashSetDebuggerTypeProxy_1<T>*>(), { "get_Items", {}, {} })));
