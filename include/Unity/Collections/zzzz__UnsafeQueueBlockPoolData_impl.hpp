...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Unity::Collections::UnsafeQueueBlockHeader* (::Unity::Collections::UnsafeQueueBlockPoolData::*)()>(&::Unity::Collections::UnsafeQueueBlockPoolData::AllocateBlock)> {
  constexpr static std::size_t size = 0xac;
  constexpr static std::size_t addrs = 0x631314c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::UnsafeQueueBlockPoolData>::get(),
                        "AllocateBlock",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::Collections::UnsafeQueueBlockPoolData::*)(::Unity::Collections::UnsafeQueueBlockHeader*)>(&::Unity::Collections::UnsafeQueueBlockPoolData::FreeBlock)> {
  constexpr static std::size_t size = 0xd4;
  constexpr static std::size_t addrs = 0x63131f8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "FreeBlock",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Unity::Collections::UnsafeQueueBlockHeader*>::get()}
                    )));
    return ___internal_method;
  }
};
...
// Ctor Parameters [CppParam { name: "m_FirstBlock", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_NumBlocks", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_MaxBlocks", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_AllocLock", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
