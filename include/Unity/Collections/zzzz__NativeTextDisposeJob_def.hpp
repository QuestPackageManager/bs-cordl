...
public:
  ...
  /// @brief Method Execute, addr 0x62a8e20, size 0x8, virtual true, abstract: false, final true
  inline void Execute();
...
static_assert(::cordl_internals::size_check_v<::Unity::Collections::NativeTextDisposeJob, 0x8>, "Size mismatch!");
