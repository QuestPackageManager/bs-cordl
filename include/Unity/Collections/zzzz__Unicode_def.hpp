...
public:
  // Declarations
  /// @brief Method Equals, addr 0x62aad24, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x62aada0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsAscii, addr 0x62aadd8, size 0x10, virtual false, abstract: false, final false
  inline bool IsAscii();

  /// @brief Method IsDigit, addr 0x62aadc4, size 0x14, virtual false, abstract: false, final false
  inline bool IsDigit();

  /// @brief Method IsDigit, addr 0x62aadb4, size 0x10, virtual false, abstract: false, final false
  static inline bool IsDigit(::Unity::Collections::Unicode_Rune r);

  /// @brief Method IsLatin1, addr 0x62aade8, size 0x10, virtual false, abstract: false, final false
  inline bool IsLatin1();

  /// @brief Method IsWhiteSpace, addr 0x62aadf8, size 0x90, virtual false, abstract: false, final false
  inline bool IsWhiteSpace();

  /// @brief Method LengthInUtf8Bytes, addr 0x62aaebc, size 0x44, virtual false, abstract: false, final false
  inline int32_t LengthInUtf8Bytes();

  /// @brief Method ToLowerAscii, addr 0x62aae88, size 0x18, virtual false, abstract: false, final false
  inline ::Unity::Collections::Unicode_Rune ToLowerAscii();

  /// @brief Method ToUpperAscii, addr 0x62aaea0, size 0x1c, virtual false, abstract: false, final false
  inline ::Unity::Collections::Unicode_Rune ToUpperAscii();

  /// @brief Method .ctor, addr 0x62aad08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t codepoint);

  /// @brief Method op_Equality, addr 0x62aad18, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::Unity::Collections::Unicode_Rune lhs, ::Unity::Collections::Unicode_Rune rhs);

  /// @brief Method op_Implicit, addr 0x62aad10, size 0x8, virtual false, abstract: false, final false
  static inline ::Unity::Collections::Unicode_Rune op_Implicit___Unity__Collections__Unicode_Rune(char16_t codepoint);

  /// @brief Method op_Inequality, addr 0x62aada8, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CountRunes, addr 0x62aacb8, size 0x50, virtual false, abstract: false, final false
  static inline int32_t CountRunes(uint8_t* utf8Buffer, int32_t utf8Length, int32_t maxRunes);

  /// @brief Method FindUtf8CharStartInReverse, addr 0x62aa7dc, size 0x38, virtual false, abstract: false, final false
  static inline int32_t FindUtf8CharStartInReverse(uint8_t* ptr, ::ByRef<int32_t> index);

  /// @brief Method IsLeadingSurrogate, addr 0x62aa87c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsLeadingSurrogate(char16_t c);

  /// @brief Method IsTrailingSurrogate, addr 0x62aa88c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsTrailingSurrogate(char16_t c);

  /// @brief Method IsValidCodePoint, addr 0x62aa7b0, size 0xc, virtual false, abstract: false, final false
  static inline bool IsValidCodePoint(int32_t codepoint);

  /// @brief Method NotTrailer, addr 0x62aa7bc, size 0x10, virtual false, abstract: false, final false
  static inline bool NotTrailer(uint8_t b);

  /// @brief Method UcsToUcs, addr 0x62aa924, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method UcsToUtf16, addr 0x62aaa64, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method UcsToUtf8, addr 0x62aa964, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf16ToUcs, addr 0x62aa89c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf16ToUtf8, addr 0x62aaae0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToUcs, addr 0x62a7ba0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToUcsReverse, addr 0x62aa814, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToUtf16, addr 0x62aac34, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToUtf8, addr 0x62aab64, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BadRune, addr 0x62aa7d4, size 0x8, virtual false, abstract: false, final false
  static inline ::Unity::Collections::Unicode_Rune get_BadRune();

  /// @brief Method get_ReplacementCharacter, addr 0x62aa7cc, size 0x8, virtual false, abstract: false, final false
