...
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Collections::NativeRingQueueDebugView_1, "Unity.Collections", "NativeRingQueueDebugView`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NativeRingQueueDebugView_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NativeRingQueueDebugView_1(NativeRingQueueDebugView_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NativeRingQueueDebugView_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NativeRingQueueDebugView_1(NativeRingQueueDebugView_1const&) = delete;
