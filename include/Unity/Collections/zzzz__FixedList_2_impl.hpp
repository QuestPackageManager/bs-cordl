...
template <typename T, typename U>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T> && ::cordl_internals::value_type_constraint<U> &&
           ::cordl_internals::default_constructor_constraint<U>)
inline void Unity::Collections::FixedList_2<T, U>::Add(/* [IsReadOnly] */ ::by_ref<T> item) {
  static auto* ___internal_method =
...
template <typename T, typename U>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T> && ::cordl_internals::value_type_constraint<U> &&
           ::cordl_internals::default_constructor_constraint<U>)
inline void Unity::Collections::FixedList_2<T, U>::AddNoResize(/* [IsReadOnly] */ ::by_ref<T> item) {
  static auto* ___internal_method =
...
template <typename T, typename U>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T> && ::cordl_internals::value_type_constraint<U> &&
           ::cordl_internals::default_constructor_constraint<U>)
inline void Unity::Collections::FixedList_2<T, U>::AddReplicate(/* [IsReadOnly] */ ::by_ref<T> value, int32_t count) {
  static auto* ___internal_method = THROW_UNLESS(
...
template <typename T, typename U>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T> && ::cordl_internals::value_type_constraint<U> &&
           ::cordl_internals::default_constructor_constraint<U>)
inline void Unity::Collections::FixedList_2<T, U>::Insert(int32_t index, /* [IsReadOnly] */ ::by_ref<T> item) {
  static auto* ___internal_method = THROW_UNLESS(
...
// Ctor Parameters [CppParam { name: "data", ty: "U", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T, typename U>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T> && ::cordl_internals::value_type_constraint<U> &&
           ::cordl_internals::default_constructor_constraint<U>)
