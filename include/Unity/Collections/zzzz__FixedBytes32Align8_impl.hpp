...
// Ctor Parameters [CppParam { name: "offset0000", ty: "::Unity::Collections::FixedBytes16Align8", modifiers: "", def_value: Some("{}") }, CppParam { name: "offset0016", ty: "::Unity::Collections::FixedBytes16Align8", modifiers: "", def_value: Some("{}") }]
