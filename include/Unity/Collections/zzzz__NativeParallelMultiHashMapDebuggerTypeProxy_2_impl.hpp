...
inline void Unity::Collections::NativeParallelMultiHashMapDebuggerTypeProxy_2<TKey, TValue>::_ctor(::Unity::Collections::NativeParallelMultiHashMap_2<TKey, TValue> target) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::NativeParallelMultiHashMapDebuggerTypeProxy_2<TKey, TValue>*>::get(), ".ctor",
...
Unity::Collections::NativeParallelMultiHashMapDebuggerTypeProxy_2<TKey, TValue>::get_Items() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::NativeParallelMultiHashMapDebuggerTypeProxy_2<TKey, TValue>*>::get(),
...
Unity::Collections::NativeParallelMultiHashMapDebuggerTypeProxy_2<TKey, TValue>::New_ctor(::Unity::Collections::NativeParallelMultiHashMap_2<TKey, TValue> target) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Unity::Collections::NativeParallelMultiHashMapDebuggerTypeProxy_2<TKey, TValue>*>(target));
}
// Ctor Parameters []
