...
public:
  ...
  /// @brief Method Execute, addr 0x64be47c, size 0x10, virtual true, abstract: false, final true
  inline void Execute();
...
static_assert(sizeof(::Unity::Collections::NativeStreamDisposeJob) == 0x20, "Size mismatch!");
