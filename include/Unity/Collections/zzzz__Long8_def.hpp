...
// Ctor Parameters [CppParam { name: "f0", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "f1", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "f2", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "f3", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "f4", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "f5", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "f6", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "f7", ty: "int64_t", modifiers: "", def_value: None }]
