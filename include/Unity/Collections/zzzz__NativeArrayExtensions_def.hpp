...
public:
  ...
  template <typename T, typename U> static inline void CheckReinterpretSize(::by_ref<::Unity::Collections::NativeArray_1<T>> array);
  ...
  template <typename T> static inline void CopyFrom(::by_ref<::Unity::Collections::NativeArray_1<T>> container, ::Unity::Collections::NativeList_1<T> other);

  /// @brief Method CopyFrom, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline void CopyFrom(::by_ref<::Unity::Collections::NativeArray_1<T>> container, ::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeHashSet_1<T>> other);

  /// @brief Method CopyFrom, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline void CopyFrom(::by_ref<::Unity::Collections::NativeArray_1<T>> container, ::by_ref<::Unity::Collections::NativeHashSet_1<T>> other);

  /// @brief Method DisposeCheckAllocator, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline void DisposeCheckAllocator(::by_ref<::Unity::Collections::NativeArray_1<T>> array);
