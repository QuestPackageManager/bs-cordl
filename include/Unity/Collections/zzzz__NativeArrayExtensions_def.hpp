...
static inline void CheckReinterpretSize(::ByRef<::Unity::Collections::NativeArray_1<T>>  array) ;
...
template<typename T>
static inline void CopyFrom(::ByRef<::Unity::Collections::NativeArray_1<T>>  container, ::ByRef<::Unity::Collections::LowLevel::Unsafe::UnsafeHashSet_1<T>>  other) ;

/// @brief Method CopyFrom, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void CopyFrom(::ByRef<::Unity::Collections::NativeArray_1<T>>  container, ::ByRef<::Unity::Collections::NativeHashSet_1<T>>  other) ;

/// @brief Method CopyFrom, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void CopyFrom(::ByRef<::Unity::Collections::NativeArray_1<T>>  container, ::Unity::Collections::NativeList_1<T>  other) ;

/// @brief Method DisposeCheckAllocator, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void DisposeCheckAllocator(::ByRef<::Unity::Collections::NativeArray_1<T>>  array) ;
...
/// @brief Method Initialize, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void Initialize(::ByRef<::Unity::Collections::NativeArray_1<T>>  array, int32_t  length, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator, ::Unity::Collections::NativeArrayOptions  options) ;
