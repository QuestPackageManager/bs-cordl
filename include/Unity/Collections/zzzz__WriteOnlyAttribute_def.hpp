...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5a408, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Unity::Collections::WriteOnlyAttribute) == 0x10, "Size mismatch!");
