...
/// @brief Method Execute, addr 0x62f659c, size 0x4, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Align, addr 0x62f5fdc, size 0x1c, virtual false, abstract: false, final false
static inline int32_t Align(int32_t  size, int32_t  alignmentPowerOfTwo) ;

/// @brief Method Align, addr 0x62f5ff8, size 0x1c, virtual false, abstract: false, final false
static inline uint64_t Align(uint64_t  size, uint64_t  alignmentPowerOfTwo) ;

/// @brief Method AssumePositive, addr 0x62f62e8, size 0x4, virtual false, abstract: false, final false
static inline int32_t AssumePositive(int32_t  value) ;

/// @brief Method CheckAllocator, addr 0x62f5edc, size 0x84, virtual false, abstract: false, final false
static inline void CheckAllocator(::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method CheckCapacityInRange, addr 0x62f64b0, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method CheckIndexInRange, addr 0x62f640c, size 0xa4, virtual false, abstract: false, final false
static inline void CheckIndexInRange(int32_t  index, int32_t  length) ;

/// @brief Method CheckIntPositivePowerOfTwo, addr 0x62f62ec, size 0x94, virtual false, abstract: false, final false
...
template<typename T>
static inline void CheckReflectionDataCorrectInternal(::System::IntPtr  reflectionData, ::ByRef<bool>  burstCompiled) ;

/// @brief Method CheckUlongPositivePowerOfTwo, addr 0x62f6380, size 0x8c, virtual false, abstract: false, final false
...
template<typename T>
static inline ::Unity::Collections::NativeArray_1<T> ConvertExistingNativeListToNativeArray(::ByRef<::Unity::Collections::NativeList_1<T>>  nativeList, int32_t  length, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method CreateNativeArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T,typename U>
static inline ::Unity::Collections::NativeArray_1<T> CreateNativeArray(::ArrayW<T,::Array<T>*>  array, ::ByRef<U>  allocator) ;

/// @brief Method CreateNativeArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Collections::NativeArray_1<T> CreateNativeArray(::ArrayW<T,::Array<T>*>  array, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
...
/// @brief Method CreateNativeArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T,typename U>
static inline ::Unity::Collections::NativeArray_1<T> CreateNativeArray(int32_t  length, ::ByRef<U>  allocator, ::Unity::Collections::NativeArrayOptions  options) ;
...
/// @brief Method Hash, addr 0x62f604c, size 0x40, virtual false, abstract: false, final false
static inline uint32_t Hash(void*  ptr, int32_t  bytes) ;

/// @brief Method IsAligned, addr 0x62f6028, size 0x14, virtual false, abstract: false, final false
static inline bool IsAligned(uint64_t  offset, int32_t  alignmentPowerOfTwo) ;

/// @brief Method IsAligned, addr 0x62f6014, size 0x14, virtual false, abstract: false, final false
static inline bool IsAligned(void*  p, int32_t  alignmentPowerOfTwo) ;

/// @brief Method IsPowerOfTwo, addr 0x62f603c, size 0x10, virtual false, abstract: false, final false
static inline bool IsPowerOfTwo(int32_t  value) ;

/// @brief Method Log2Ceil, addr 0x62f5fa4, size 0x38, virtual false, abstract: false, final false
static inline int32_t Log2Ceil(int32_t  value) ;

/// @brief Method Log2Floor, addr 0x62f5f6c, size 0x38, virtual false, abstract: false, final false
static inline int32_t Log2Floor(int32_t  value) ;

/// @brief Method ShouldDeallocate, addr 0x62f5f60, size 0xc, virtual false, abstract: false, final false
static inline bool ShouldDeallocate(::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method WriteLayout, addr 0x62f608c, size 0x25c, virtual false, abstract: false, final false
