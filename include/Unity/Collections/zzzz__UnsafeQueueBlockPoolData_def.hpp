...
public:
// Declarations
/// @brief Method AllocateBlock, addr 0x631314c, size 0xac, virtual false, abstract: false, final false
inline ::Unity::Collections::UnsafeQueueBlockHeader* AllocateBlock() ;

/// @brief Method FreeBlock, addr 0x63131f8, size 0xd4, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_FirstBlock", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "m_NumBlocks", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_MaxBlocks", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_AllocLock", ty: "int32_t", modifiers: "", def_value: None }]
