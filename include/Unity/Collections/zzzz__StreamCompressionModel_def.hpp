...
/// @brief Method CalculateBucket, addr 0x63124f8, size 0xe0, virtual false, abstract: false, final false
inline int32_t CalculateBucket(uint32_t  value) ;

/// @brief Method CheckAlphabetAndMaxCodeLength, addr 0x6312738, size 0x60, virtual false, abstract: false, final false
static inline void CheckAlphabetAndMaxCodeLength(int32_t  alphabetSize, int32_t  maxCodeLength) ;

/// @brief Method CheckAlphabetSize, addr 0x6312658, size 0x80, virtual false, abstract: false, final false
static inline void CheckAlphabetSize(int32_t  alphabetSize) ;

/// @brief Method CheckExceedMaxCodeLength, addr 0x6312798, size 0x58, virtual false, abstract: false, final false
static inline void CheckExceedMaxCodeLength(int32_t  length, int32_t  maxCodeLength) ;

/// @brief Method CheckSymbolLength, addr 0x63126d8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GenerateHuffmanCodes, addr 0x63122e8, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method GenerateHuffmanDecodeTable, addr 0x6312490, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method GetCompressedSizeInBits, addr 0x63125d8, size 0x80, virtual false, abstract: false, final false
inline int32_t GetCompressedSizeInBits(uint32_t  value) ;

/// @brief Method Initialize, addr 0x6311e70, size 0x478, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method ReverseBits, addr 0x63124e8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Default, addr 0x6311d10, size 0x160, virtual false, abstract: false, final false
