...
public:
  ...
  /// @brief Method CalculateBucket, addr 0x6384504, size 0xe0, virtual false, abstract: false, final false
  inline int32_t CalculateBucket(uint32_t value);

  /// @brief Method CheckAlphabetAndMaxCodeLength, addr 0x6384744, size 0x60, virtual false, abstract: false, final false
  static inline void CheckAlphabetAndMaxCodeLength(int32_t alphabetSize, int32_t maxCodeLength);

  /// @brief Method CheckAlphabetSize, addr 0x6384664, size 0x80, virtual false, abstract: false, final false
  static inline void CheckAlphabetSize(int32_t alphabetSize);

  /// @brief Method CheckExceedMaxCodeLength, addr 0x63847a4, size 0x58, virtual false, abstract: false, final false
  static inline void CheckExceedMaxCodeLength(int32_t length, int32_t maxCodeLength);

  /// @brief Method CheckSymbolLength, addr 0x63846e4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateHuffmanCodes, addr 0x63842f4, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateHuffmanDecodeTable, addr 0x638449c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCompressedSizeInBits, addr 0x63845e4, size 0x80, virtual false, abstract: false, final false
  inline int32_t GetCompressedSizeInBits(uint32_t value);

  /// @brief Method Initialize, addr 0x6383e7c, size 0x478, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method ReverseBits, addr 0x63844f4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Default, addr 0x6383d1c, size 0x160, virtual false, abstract: false, final false
