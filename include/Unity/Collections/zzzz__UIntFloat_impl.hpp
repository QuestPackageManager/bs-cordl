...
// Ctor Parameters [CppParam { name: "floatValue", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "intValue", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "doubleValue", ty: "double_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "longValue", ty: "uint64_t", modifiers: "", def_value: Some("{}") }]
