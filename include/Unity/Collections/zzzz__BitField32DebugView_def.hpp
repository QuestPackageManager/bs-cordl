...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BitField32DebugView", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BitField32DebugView(BitField32DebugView&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BitField32DebugView", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BitField32DebugView(BitField32DebugViewconst&) = delete;
