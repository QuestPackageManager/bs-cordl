...
public:
  ...
  /// @brief Method .ctor, addr 0x6367b60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Collections::BitField32 bitfield);

  /// @brief Method get_Bits, addr 0x6367b68, size 0x8c, virtual false, abstract: false, final false
