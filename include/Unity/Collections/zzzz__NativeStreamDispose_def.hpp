...
public:
  // Declarations
  /// @brief Method Dispose, addr 0x64be46c, size 0x10, virtual false, abstract: false, final false
  inline void Dispose();
...
static_assert(sizeof(::Unity::Collections::NativeStreamDispose) == 0x20, "Size mismatch!");
