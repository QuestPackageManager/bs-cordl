...
public:
  // Declarations
  /// @brief Method CheckArgs, addr 0x62f53d8, size 0xbc, virtual false, abstract: false, final false
  static inline void CheckArgs(int32_t pos, int32_t numBits);

  /// @brief Method Clear, addr 0x62f5264, size 0x8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CountBits, addr 0x62f5344, size 0x18, virtual false, abstract: false, final false
  inline int32_t CountBits();

  /// @brief Method CountLeadingZeros, addr 0x62f535c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t CountLeadingZeros();

  /// @brief Method CountTrailingZeros, addr 0x62f5398, size 0x40, virtual false, abstract: false, final false
  inline int32_t CountTrailingZeros();

  /// @brief Method GetBits, addr 0x62f52c0, size 0x1c, virtual false, abstract: false, final false
  inline uint32_t GetBits(int32_t pos, int32_t numBits);

  /// @brief Method IsSet, addr 0x62f52dc, size 0x10, virtual false, abstract: false, final false
  inline bool IsSet(int32_t pos);

  /// @brief Method SetBits, addr 0x62f526c, size 0x24, virtual false, abstract: false, final false
  inline void SetBits(int32_t pos, bool value);

  /// @brief Method SetBits, addr 0x62f5290, size 0x30, virtual false, abstract: false, final false
  inline void SetBits(int32_t pos, bool value, int32_t numBits);

  /// @brief Method TestAll, addr 0x62f5324, size 0x20, virtual false, abstract: false, final false
  inline bool TestAll(int32_t pos, int32_t numBits);

  /// @brief Method TestAny, addr 0x62f5308, size 0x1c, virtual false, abstract: false, final false
  inline bool TestAny(int32_t pos, int32_t numBits);

  /// @brief Method TestNone, addr 0x62f52ec, size 0x1c, virtual false, abstract: false, final false
  inline bool TestNone(int32_t pos, int32_t numBits);

  /// @brief Method .ctor, addr 0x62f525c, size 0x8, virtual false, abstract: false, final false
