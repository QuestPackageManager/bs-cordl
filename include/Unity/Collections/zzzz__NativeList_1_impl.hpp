...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::NativeList_1<T>::Add(/* [IsReadOnly] */ ::by_ref<T> value) {
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::NativeList_1<T>::AddReplicate(/* [IsReadOnly] */ ::by_ref<T> value, int32_t count) {
  static auto* ___internal_method = THROW_UNLESS(
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::NativeList_1<T>::CopyFrom(/* [IsReadOnly] */ ::by_ref<::Unity::Collections::NativeArray_1<T>> other) {
  static auto* ___internal_method = THROW_UNLESS(
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::NativeList_1<T>::CopyFrom(/* [IsReadOnly] */ ::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>> other) {
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void Unity::Collections::NativeList_1<T>::CopyFrom(/* [IsReadOnly] */ ::by_ref<::Unity::Collections::NativeList_1<T>> other) {
  static auto* ___internal_method = THROW_UNLESS(
...
// Ctor Parameters [CppParam { name: "m_ListData", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>*", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
