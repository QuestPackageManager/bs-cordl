...
public:
  ...
  inline void _ctor(::ByRef<::Unity::Collections::NativeHashSet_1<T>> data);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::NativeHashSet_1, "Unity.Collections", "NativeHashSet`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::NativeHashSet_1_Enumerator, "Unity.Collections", "NativeHashSet`1/Enumerator");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Collections::NativeHashSet_1_ReadOnly, "Unity.Collections", "NativeHashSet`1/ReadOnly");
