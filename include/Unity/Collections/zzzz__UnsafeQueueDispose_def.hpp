...
public:
// Declarations
/// @brief Method Dispose, addr 0x63136a8, size 0x10, virtual false, abstract: false, final false
inline void Dispose() ;
...
constexpr UnsafeQueueDispose(::Unity::Collections::UnsafeQueueData*  m_Buffer, ::Unity::Collections::UnsafeQueueBlockPoolData*  m_QueuePool, ::Unity::Collections::AllocatorManager_AllocatorHandle  m_AllocatorLabel) noexcept;
