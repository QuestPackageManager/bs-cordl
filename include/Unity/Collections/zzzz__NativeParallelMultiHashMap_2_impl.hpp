...
template <typename TKey, typename TValue> template <typename U> inline void Unity::Collections::NativeParallelMultiHashMap_2<TKey, TValue>::Initialize(int32_t capacity, ::by_ref<U> allocator) {
