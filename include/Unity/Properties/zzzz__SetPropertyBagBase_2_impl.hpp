...
template <typename TSet, typename TElement> inline TElement Unity::Properties::SetPropertyBagBase_2_SetElementProperty<TSet, TElement>::GetValue(::by_ref<TSet> container) {
  auto* ___internal_method = THROW_UNLESS(
...
template <typename TSet, typename TElement> inline void Unity::Properties::SetPropertyBagBase_2_SetElementProperty<TSet, TElement>::SetValue(::by_ref<TSet> container, TElement value) {
  auto* ___internal_method = THROW_UNLESS(
...
template <typename TSet, typename TElement> inline ::Unity::Properties::PropertyCollection_1<TSet> Unity::Properties::SetPropertyBagBase_2<TSet, TElement>::GetProperties(::by_ref<TSet> container) {
  auto* ___internal_method =
