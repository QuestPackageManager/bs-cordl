...
public:
  ...
  /// @brief Method Equals, addr 0x6b9ee74, size 0x68, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Properties::ConversionRegistry_ConverterKey x, ::Unity::Properties::ConversionRegistry_ConverterKey y);

  /// @brief Method GetHashCode, addr 0x6b9eedc, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6b9ee70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6b9ecb4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x6b9eb10, size 0xcc, virtual false, abstract: false, final false
  static inline ::Unity::Properties::ConversionRegistry Create();

  /// @brief Method Equals, addr 0x6b9edd8, size 0xc, virtual true, abstract: false, final true
  inline bool Equals(::Unity::Properties::ConversionRegistry x, ::Unity::Properties::ConversionRegistry y);

  /// @brief Method GetConverter, addr 0x6b9ecbc, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Delegate* GetConverter(::System::Type* source, ::System::Type* destination);

  /// @brief Method GetHashCode, addr 0x6b9ede4, size 0x20, virtual true, abstract: false, final true
  inline int32_t GetHashCode(::Unity::Properties::ConversionRegistry obj);

  /// @brief Method Register, addr 0x6b9ebdc, size 0xd8, virtual false, abstract: false, final false
  inline void Register(::System::Type* source, ::System::Type* destination, ::System::Delegate* converter);

  /// @brief Method TryGetConverter, addr 0x6b9ed48, size 0x90, virtual false, abstract: false, final false
  inline bool TryGetConverter(::System::Type* source, ::System::Type* destination, ::by_ref<::System::Delegate*> converter);

  /// @brief Method .ctor, addr 0x6b9eb08, size 0x8, virtual false, abstract: false, final false
