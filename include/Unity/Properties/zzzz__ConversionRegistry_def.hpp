...
/// @brief Method Equals, addr 0x69d75d8, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::Unity::Properties::ConversionRegistry_ConverterKey  x, ::Unity::Properties::ConversionRegistry_ConverterKey  y) ;

/// @brief Method GetHashCode, addr 0x69d7640, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x69d75d4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Convert to "::System::Collections::Generic::IEqualityComparer_1<::Unity::Properties::ConversionRegistry_ConverterKey>"
constexpr ::System::Collections::Generic::IEqualityComparer_1<::Unity::Properties::ConversionRegistry_ConverterKey>* i___System__Collections__Generic__IEqualityComparer_1___Unity__Properties__ConversionRegistry_ConverterKey_() noexcept;
...
public:
// Declarations
/// @brief Method .ctor, addr 0x69d7418, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x69d7274, size 0xcc, virtual false, abstract: false, final false
static inline ::Unity::Properties::ConversionRegistry Create() ;

/// @brief Method Equals, addr 0x69d753c, size 0xc, virtual true, abstract: false, final true
inline bool Equals(::Unity::Properties::ConversionRegistry  x, ::Unity::Properties::ConversionRegistry  y) ;

/// @brief Method GetConverter, addr 0x69d7420, size 0x8c, virtual false, abstract: false, final false
inline ::System::Delegate* GetConverter(::System::Type*  source, ::System::Type*  destination) ;

/// @brief Method GetHashCode, addr 0x69d7548, size 0x20, virtual true, abstract: false, final true
inline int32_t GetHashCode(::Unity::Properties::ConversionRegistry  obj) ;

/// @brief Method Register, addr 0x69d7340, size 0xd8, virtual false, abstract: false, final false
inline void Register(::System::Type*  source, ::System::Type*  destination, ::System::Delegate*  converter) ;

/// @brief Method TryGetConverter, addr 0x69d74ac, size 0x90, virtual false, abstract: false, final false
inline bool TryGetConverter(::System::Type*  source, ::System::Type*  destination, ::ByRef<::System::Delegate*>  converter) ;

/// @brief Method .ctor, addr 0x69d726c, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Converters", ty: "::System::Collections::Generic::Dictionary_2<::Unity::Properties::ConversionRegistry_ConverterKey,::System::Delegate*>*", modifiers: "", def_value: None }]
