...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Object* (::Unity::Properties::IDictionaryElementProperty::*)()>(&::Unity::Properties::IDictionaryElementProperty::get_ObjectKey)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Unity::Properties::IDictionaryElementProperty*>(), { ::i2c::class_of<::Unity::Properties::IDictionaryElementProperty*>(), 0 }));
    return ___internal_method;
  }
};
inline ::System::Object* Unity::Properties::IDictionaryElementProperty::get_ObjectKey() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Unity::Properties::IDictionaryElementProperty*>(), 0 })));
