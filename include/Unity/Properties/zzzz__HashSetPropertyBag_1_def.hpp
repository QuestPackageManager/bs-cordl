...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::HashSetPropertyBag_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::HashSetPropertyBag_1, "Unity.Properties", "HashSetPropertyBag`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HashSetPropertyBag_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HashSetPropertyBag_1(HashSetPropertyBag_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HashSetPropertyBag_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HashSetPropertyBag_1(HashSetPropertyBag_1const&) = delete;
