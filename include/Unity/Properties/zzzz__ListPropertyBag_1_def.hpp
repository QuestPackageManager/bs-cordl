...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ListPropertyBag_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ListPropertyBag_1(ListPropertyBag_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ListPropertyBag_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ListPropertyBag_1(ListPropertyBag_1const&) = delete;
