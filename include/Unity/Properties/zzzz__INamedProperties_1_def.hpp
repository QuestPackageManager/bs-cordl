...
// Write type traits
MARK_GEN_REF_PTR_T(::Unity::Properties::INamedProperties_1);
// Dependencies
namespace Unity::Properties {
// cpp template
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Unity::Properties::INamedProperties_1, "Unity.Properties", "INamedProperties`1");
