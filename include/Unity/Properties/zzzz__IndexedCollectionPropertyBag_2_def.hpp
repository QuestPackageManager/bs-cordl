...
namespace Unity::Properties {
template <typename TList, typename TElement> class __IndexedCollectionPropertyBag_2__ListElementProperty;
}
...
MARK_GEN_REF_PTR_T(::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty);
// Type: ::ListElementProperty
...
// Is value type: false
// CS Name: ::IndexedCollectionPropertyBag`2::ListElementProperty<TList,TElement>*
class CORDL_TYPE __IndexedCollectionPropertyBag_2__ListElementProperty : public ::Unity::Properties::Property_2<TList, TElement> {
public:
  // Declarations
  ...
  static inline ::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty<TList, TElement>* New_ctor();
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __IndexedCollectionPropertyBag_2__ListElementProperty();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__IndexedCollectionPropertyBag_2__ListElementProperty", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __IndexedCollectionPropertyBag_2__ListElementProperty(__IndexedCollectionPropertyBag_2__ListElementProperty&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__IndexedCollectionPropertyBag_2__ListElementProperty", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __IndexedCollectionPropertyBag_2__ListElementProperty(__IndexedCollectionPropertyBag_2__ListElementProperty const&) = delete;
...
// Type: Unity.Properties::IndexedCollectionPropertyBag`2
...
public:
  // Declarations
  using ListElementProperty = ::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty<TList, TElement>;

  /// @brief Field m_Property, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_m_Property,
                      put = __cordl_internal_set_m_Property)) ::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty<TList, TElement>* m_Property;
  ...
  constexpr ::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty<TList, TElement>*& __cordl_internal_get_m_Property();

  constexpr ::cordl_internals::to_const_pointer<::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty<TList, TElement>*> const& __cordl_internal_get_m_Property() const;

  constexpr void __cordl_internal_set_m_Property(::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty<TList, TElement>* value);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty, "Unity.Properties", "IndexedCollectionPropertyBag`2/ListElementProperty");
