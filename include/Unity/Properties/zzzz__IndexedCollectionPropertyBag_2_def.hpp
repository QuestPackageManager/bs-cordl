...
namespace Unity::Properties {
template<typename TContainer>
class IIndexedCollectionPropertyBagEnumerator_1;
}
namespace Unity::Properties {
template<typename TContainer>
class IIndexedProperties_1;
}
namespace Unity::Properties {
...
namespace Unity::Properties {
template<typename TContainer>
class IListPropertyBagAccept_1;
}
namespace Unity::Properties {
...
/// @brief Field m_Property, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Property, put=__cordl_internal_set_m_Property)) ::Unity::Properties::IndexedCollectionPropertyBag_2_ListElementProperty<TList,TElement>*  m_Property;
...
template<typename TContainer>
inline void Unity_Properties_IListPropertyAccept_TList__Accept(::Unity::Properties::IListPropertyVisitor*  visitor, ::Unity::Properties::Property_2<TContainer,TList>*  property, ::ByRef<TContainer>  container, ::ByRef<TList>  list) ;
