...
public:
  ...
  inline TElement GetValue(::by_ref<TList> container);
  ...
  inline void SetValue(::by_ref<TList> container, TElement value);
...
public:
  ...
  /// @brief Method GetProperties, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline ::Unity::Properties::PropertyCollection_1<TList> GetProperties(::by_ref<TList> container);
  ...
  inline bool TryGetProperty(::by_ref<TList> container, int32_t index, ::by_ref<::Unity::Properties::IProperty_1<TList>*> property);
  ...
  inline void Unity_Properties_ICollectionPropertyBagAccept_TList__Accept(::Unity::Properties::ICollectionPropertyBagVisitor* visitor, ::by_ref<TList> container);
  ...
  inline int32_t Unity_Properties_IIndexedCollectionPropertyBagEnumerator_TList__GetCount(::by_ref<TList> container);
  ...
  inline void Unity_Properties_IListPropertyBagAccept_TList__Accept(::Unity::Properties::IListPropertyBagVisitor* visitor, ::by_ref<TList> list);
