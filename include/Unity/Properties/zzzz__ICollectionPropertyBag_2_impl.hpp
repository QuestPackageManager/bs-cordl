...
constexpr  Unity::Properties::ICollectionPropertyBag_2<TCollection,TElement>::operator ::Unity::Properties::IPropertyBag_1<TCollection>*() noexcept {
...
template<typename TCollection,typename TElement>
constexpr  Unity::Properties::ICollectionPropertyBag_2<TCollection,TElement>::operator ::Unity::Properties::IPropertyBag*() noexcept {
...
template<typename TCollection,typename TElement>
constexpr ::Unity::Properties::ICollectionPropertyBagAccept_1<TCollection>* Unity::Properties::ICollectionPropertyBag_2<TCollection,TElement>::i___Unity__Properties__ICollectionPropertyBagAccept_1_TCollection_() noexcept {
return static_cast<::Unity::Properties::ICollectionPropertyBagAccept_1<TCollection>*>(static_cast<void*>(this));
}
