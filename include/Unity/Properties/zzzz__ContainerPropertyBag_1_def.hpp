...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ContainerPropertyBag_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ContainerPropertyBag_1(ContainerPropertyBag_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ContainerPropertyBag_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ContainerPropertyBag_1(ContainerPropertyBag_1const&) = delete;
