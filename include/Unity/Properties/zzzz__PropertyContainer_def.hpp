...
/// @brief Method <.cctor>b__5_0, addr 0x69d3658, size 0x44, virtual false, abstract: false, final false
inline ::Unity::Properties::PropertyContainer_GetPropertyVisitor* __cctor_b__5_0() ;

/// @brief Method <.cctor>b__5_1, addr 0x69d369c, size 0x20, virtual false, abstract: false, final false
inline void __cctor_b__5_1(::Unity::Properties::PropertyContainer_GetPropertyVisitor*  v) ;

/// @brief Method .ctor, addr 0x69d3654, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Reset, addr 0x69d3408, size 0x34, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x69d3468, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline void Accept(::Unity::Properties::IPropertyBagVisitor*  visitor, ::ByRef<TContainer>  container, ::Unity::Properties::VisitParameters  parameters) ;

/// @brief Method TryAccept, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer>
static inline bool TryAccept(::Unity::Properties::IPropertyBagVisitor*  visitor, ::ByRef<TContainer>  container, ::Unity::Properties::VisitParameters  parameters) ;

/// @brief Method TryAccept, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer>
static inline bool TryAccept(::Unity::Properties::IPropertyBagVisitor*  visitor, ::ByRef<TContainer>  container, ::ByRef<::Unity::Properties::VisitReturnCode>  returnCode, ::Unity::Properties::VisitParameters  parameters) ;
...
/// @brief Method TryGetProperty, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer>
static inline bool TryGetProperty(::ByRef<TContainer>  container, ::ByRef<::Unity::Properties::PropertyPath>  path, ::ByRef<::Unity::Properties::IProperty*>  property, ::ByRef<::Unity::Properties::VisitReturnCode>  returnCode) ;

/// @brief Method TryGetValue, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer,typename TValue>
static inline bool TryGetValue(::ByRef<TContainer>  container, ::StringW  name, ::ByRef<TValue>  value) ;
