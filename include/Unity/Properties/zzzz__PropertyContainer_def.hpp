...
public:
  ...
  /// @brief Method <.cctor>b__5_0, addr 0x6a458a0, size 0x44, virtual false, abstract: false, final false
  inline ::Unity::Properties::PropertyContainer_GetPropertyVisitor* __cctor_b__5_0();

  /// @brief Method <.cctor>b__5_1, addr 0x6a458e4, size 0x20, virtual false, abstract: false, final false
  inline void __cctor_b__5_1(::Unity::Properties::PropertyContainer_GetPropertyVisitor* v);

  /// @brief Method .ctor, addr 0x6a4589c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Reset, addr 0x6a45650, size 0x34, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6a456b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
