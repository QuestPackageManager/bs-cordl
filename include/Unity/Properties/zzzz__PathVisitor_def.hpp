...
public:
  ...
  /// @brief Method Dispose, addr 0x6a49498, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x6a49478, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Reset, addr 0x6a45684, size 0x2c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6a456b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Path, addr 0x6a4942c, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Properties::PropertyPath get_Path();

  /// @brief Method get_Property, addr 0x6a49448, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Properties::IProperty* get_Property();

  /// @brief Method get_ReadonlyVisit, addr 0x6a49458, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReadonlyVisit();

  /// @brief Method get_ReturnCode, addr 0x6a49468, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Path, addr 0x6a4943c, size 0xc, virtual false, abstract: false, final false
  inline void set_Path(::Unity::Properties::PropertyPath value);

  /// @brief Method set_Property, addr 0x6a49450, size 0x8, virtual false, abstract: false, final false
  inline void set_Property(::Unity::Properties::IProperty* value);

  /// @brief Method set_ReadonlyVisit, addr 0x6a49460, size 0x8, virtual false, abstract: false, final false
  inline void set_ReadonlyVisit(bool value);

  /// @brief Method set_ReturnCode, addr 0x6a49470, size 0x8, virtual false, abstract: false, final false
