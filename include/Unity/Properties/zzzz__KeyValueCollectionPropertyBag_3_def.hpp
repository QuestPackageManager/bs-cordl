...
inline bool Unity_Properties_IKeyedProperties_TDictionary_System_Object__TryGetProperty(::ByRef<TDictionary>  container, ::System::Object*  key, ::ByRef<::Unity::Properties::IProperty_1<TDictionary>*>  property) ;
