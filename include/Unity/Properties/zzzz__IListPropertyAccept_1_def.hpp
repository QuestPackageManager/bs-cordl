...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IListPropertyAccept_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IListPropertyAccept_1(IListPropertyAccept_1const&) = delete;
