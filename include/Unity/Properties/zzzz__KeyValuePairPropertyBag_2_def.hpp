...
namespace Unity::Properties {
template <typename TKey, typename TValue> class __KeyValuePairPropertyBag_2____c;
}
...
public:
  ...
  static __declspec(property(get = getStaticF_s_KeyProperty,
  ...
  static __declspec(property(get = getStaticF_s_ValueProperty,
