...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IIndexedProperties_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IIndexedProperties_1(IIndexedProperties_1const&) = delete;
