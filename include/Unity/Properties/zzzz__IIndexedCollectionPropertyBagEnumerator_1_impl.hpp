...
inline int32_t Unity::Properties::IIndexedCollectionPropertyBagEnumerator_1<TContainer>::GetCount(::ByRef<TContainer>  container)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                            il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::IIndexedCollectionPropertyBagEnumerator_1<TContainer>*>::get(),
                            0
                        )));
