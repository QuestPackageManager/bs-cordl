...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::IndexedCollectionPropertyBagEnumerable_1<TContainer>>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Unity::Properties::IIndexedCollectionPropertyBagEnumerator_1<TContainer>*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TContainer>::get()}
                    )));
