...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::PropertySetter_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::PropertySetter_2, "Unity.Properties", "PropertySetter`2");
...
public:
  ...
  inline void Invoke(::by_ref<TContainer> container, TValue value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PropertySetter_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PropertySetter_2(PropertySetter_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PropertySetter_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PropertySetter_2(PropertySetter_2const&) = delete;
