...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DictionaryPropertyBag_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DictionaryPropertyBag_2(DictionaryPropertyBag_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DictionaryPropertyBag_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DictionaryPropertyBag_2(DictionaryPropertyBag_2const&) = delete;
