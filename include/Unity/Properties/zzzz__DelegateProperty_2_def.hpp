...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::DelegateProperty_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::DelegateProperty_2, "Unity.Properties", "DelegateProperty`2");
