...
static inline ::Unity::Properties::DelegateProperty_2<TContainer,TValue>* New_ctor(::StringW  name, ::Unity::Properties::PropertyGetter_2<TContainer,TValue>*  getter, ::Unity::Properties::PropertySetter_2<TContainer,TValue>*  setter) ;
