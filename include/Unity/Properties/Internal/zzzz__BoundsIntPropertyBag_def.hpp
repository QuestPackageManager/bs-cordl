...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b938, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6a5b944, size 0xc, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::BoundsInt> container, ::UnityEngine::Vector3Int value);

  /// @brief Method .ctor, addr 0x6a5b874, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b930, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5b8ec, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b99c, size 0xc, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3Int GetValue(::ByRef<::UnityEngine::BoundsInt> container);

  static inline ::Unity::Properties::Internal::BoundsIntPropertyBag_SizeProperty* New_ctor();

  /// @brief Method SetValue, addr 0x6a5b9a8, size 0xc, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::BoundsInt> container, ::UnityEngine::Vector3Int value);

  /// @brief Method .ctor, addr 0x6a5b8b0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b994, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5b950, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5a50c, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
