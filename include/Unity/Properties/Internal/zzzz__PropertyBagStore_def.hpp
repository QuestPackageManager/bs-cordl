...
public:
  ...
  /// @brief Method CreatePropertyBagProvider, addr 0x6a59544, size 0x84, virtual false, abstract: false, final false
  static inline void CreatePropertyBagProvider();

  /// @brief Method GetPropertyBag, addr 0x6a49230, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReflectedPropertyBagProvider, addr 0x6a5bd84, size 0xa8, virtual false, abstract: false, final false
