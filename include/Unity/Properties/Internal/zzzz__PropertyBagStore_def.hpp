...
// Declarations
template<typename TContainer>
using TypedStore_1 = ::Unity::Properties::Internal::PropertyBagStore_TypedStore_1<TContainer>;
...
/// @brief Method CreatePropertyBagProvider, addr 0x6a5b0bc, size 0x84, virtual false, abstract: false, final false
static inline void CreatePropertyBagProvider() ;

/// @brief Method GetPropertyBag, addr 0x6a4ada8, size 0x1f8, virtual false, abstract: false, final false
...
static inline bool TryGetPropertyBagForValue(::ByRef<TValue>  value, ::ByRef<::Unity::Properties::IPropertyBag*>  propertyBag) ;
...
/// @brief Method get_ReflectedPropertyBagProvider, addr 0x6a5d8fc, size 0xa8, virtual false, abstract: false, final false
