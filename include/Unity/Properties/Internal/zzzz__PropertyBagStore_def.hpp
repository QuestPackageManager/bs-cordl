...
namespace Unity::Properties::Internal {
template <typename TContainer> struct __PropertyBagStore__TypedStore_1;
}
...
MARK_GEN_VAL_T(::Unity::Properties::Internal::__PropertyBagStore__TypedStore_1);
// Type: ::TypedStore`1
...
// Is value type: true
// CS Name: ::PropertyBagStore::TypedStore`1<TContainer>
#pragma pack(push, 0)
struct CORDL_TYPE __PropertyBagStore__TypedStore_1 {
public:
  // Declarations
  /// @brief Field PropertyBag, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_PropertyBag, put = setStaticF_PropertyBag)) ::Unity::Properties::IPropertyBag_1<TContainer>* PropertyBag;
...
public:
  // Declarations
  template <typename TContainer> using TypedStore_1 = ::Unity::Properties::Internal::__PropertyBagStore__TypedStore_1<TContainer>;

  /// @brief Field NewTypeRegistered, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_NewTypeRegistered, put = setStaticF_NewTypeRegistered)) ::System::Action_2<::System::Type*, ::Unity::Properties::IPropertyBag*>* NewTypeRegistered;

  /// @brief Field s_PropertyBagProvider, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_s_PropertyBagProvider, put = setStaticF_s_PropertyBagProvider)) ::Unity::Properties::Internal::ReflectedPropertyBagProvider* s_PropertyBagProvider;

  /// @brief Field s_PropertyBags, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_s_PropertyBags,
  ...
  static __declspec(property(get = getStaticF_s_RegisteredTypes, put = setStaticF_s_RegisteredTypes)) ::System::Collections::Generic::List_1<::System::Type*>* s_RegisteredTypes;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Unity::Properties::Internal::__PropertyBagStore__TypedStore_1, "Unity.Properties.Internal", "PropertyBagStore/TypedStore`1");
