...
::cordl_internals::setStaticField<::Unity::Properties::IPropertyBag_1<TContainer>*, "PropertyBag", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore_TypedStore_1<TContainer>>::get>(std::forward<::Unity::Properties::IPropertyBag_1<TContainer>*>(value));
}
template<typename TContainer>
...
return ::cordl_internals::getStaticField<::Unity::Properties::IPropertyBag_1<TContainer>*, "PropertyBag", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore_TypedStore_1<TContainer>>::get>();
}
// Ctor Parameters []
template<typename TContainer>
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Unity::Properties::Internal::ReflectedPropertyBagProvider* (*)()>(&::Unity::Properties::Internal::PropertyBagStore::get_ReflectedPropertyBagProvider)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::Unity::Properties::Internal::PropertyBagStore::CreatePropertyBagProvider)> {
  ...
  constexpr static std::size_t addrs = 0x69e72fc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Unity::Properties::IPropertyBag* (*)(::System::Type*)>(&::Unity::Properties::Internal::PropertyBagStore::GetPropertyBag)> {
  constexpr static std::size_t size = 0x1f8;
  constexpr static std::size_t addrs = 0x69d6fe8;
...
::cordl_internals::setStaticField<::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::Unity::Properties::IPropertyBag*>*, "s_PropertyBags", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore*>::get>(std::forward<::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::Unity::Properties::IPropertyBag*>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::Unity::Properties::IPropertyBag*>*, "s_PropertyBags", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore*>::get>();
}
...
::cordl_internals::setStaticField<::System::Collections::Generic::List_1<::System::Type*>*, "s_RegisteredTypes", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore*>::get>(std::forward<::System::Collections::Generic::List_1<::System::Type*>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::List_1<::System::Type*>*, "s_RegisteredTypes", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore*>::get>();
}
...
::cordl_internals::setStaticField<::Unity::Properties::Internal::ReflectedPropertyBagProvider*, "s_PropertyBagProvider", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore*>::get>(std::forward<::Unity::Properties::Internal::ReflectedPropertyBagProvider*>(value));
}
...
return ::cordl_internals::getStaticField<::Unity::Properties::Internal::ReflectedPropertyBagProvider*, "s_PropertyBagProvider", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore*>::get>();
}
...
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ...
                    ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Unity::Properties::IPropertyBag_1<TContainer>*>::get()}
                )));
...
inline bool Unity::Properties::Internal::PropertyBagStore::TryGetPropertyBagForValue(::ByRef<TValue>  value, ::ByRef<::Unity::Properties::IPropertyBag*>  propertyBag)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::Internal::PropertyBagStore*>::get(),
                    "TryGetPropertyBagForValue",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TValue>::get()},
                    ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<TValue>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::Unity::Properties::IPropertyBag*>>::get()}
                )));
static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(
                    ___internal_method_base,
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TValue>::get()}
