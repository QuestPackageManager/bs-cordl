...
/// @brief Method GetValue, addr 0x6a5cbb8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method SetValue, addr 0x6a5cbc0, size 0x8, virtual true, abstract: false, final false
inline void SetValue(::ByRef<::UnityEngine::Vector2Int>  container, int32_t  value) ;

/// @brief Method .ctor, addr 0x6a5caf4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsReadOnly, addr 0x6a5cbb0, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_Name, addr 0x6a5cb6c, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method GetValue, addr 0x6a5cc14, size 0x8, virtual true, abstract: false, final false
inline int32_t GetValue(::ByRef<::UnityEngine::Vector2Int>  container) ;

static inline ::Unity::Properties::Internal::Vector2IntPropertyBag_YProperty* New_ctor() ;

/// @brief Method SetValue, addr 0x6a5cc1c, size 0x8, virtual true, abstract: false, final false
inline void SetValue(::ByRef<::UnityEngine::Vector2Int>  container, int32_t  value) ;

/// @brief Method .ctor, addr 0x6a5cb30, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsReadOnly, addr 0x6a5cc0c, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_Name, addr 0x6a5cbc8, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_Name() ;
...
/// @brief Method .ctor, addr 0x6a5b83c, size 0x14c, virtual false, abstract: false, final false
inline void _ctor() ;
