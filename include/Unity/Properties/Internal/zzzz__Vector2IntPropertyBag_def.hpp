...
/// @brief Method GetValue, addr 0x69e8df8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method SetValue, addr 0x69e8e00, size 0x8, virtual true, abstract: false, final false
inline void SetValue(::ByRef<::UnityEngine::Vector2Int>  container, int32_t  value) ;

/// @brief Method .ctor, addr 0x69e8d34, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsReadOnly, addr 0x69e8df0, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_Name, addr 0x69e8dac, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method GetValue, addr 0x69e8e54, size 0x8, virtual true, abstract: false, final false
inline int32_t GetValue(::ByRef<::UnityEngine::Vector2Int>  container) ;

static inline ::Unity::Properties::Internal::Vector2IntPropertyBag_YProperty* New_ctor() ;

/// @brief Method SetValue, addr 0x69e8e5c, size 0x8, virtual true, abstract: false, final false
inline void SetValue(::ByRef<::UnityEngine::Vector2Int>  container, int32_t  value) ;

/// @brief Method .ctor, addr 0x69e8d70, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsReadOnly, addr 0x69e8e4c, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_Name, addr 0x69e8e08, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_Name() ;
...
/// @brief Method .ctor, addr 0x69e7a7c, size 0x14c, virtual false, abstract: false, final false
inline void _ctor() ;
