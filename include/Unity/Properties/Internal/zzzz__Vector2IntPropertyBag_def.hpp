...
public:
  ...
  /// @brief Method GetValue, addr 0x6bb0694, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6bb069c, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::by_ref<::UnityEngine::Vector2Int> container, int32_t value);

  /// @brief Method .ctor, addr 0x6bb05d0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6bb068c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6bb0648, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6bb06f0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetValue(::by_ref<::UnityEngine::Vector2Int> container);

  static inline ::Unity::Properties::Internal::Vector2IntPropertyBag_YProperty* New_ctor();

  /// @brief Method SetValue, addr 0x6bb06f8, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::by_ref<::UnityEngine::Vector2Int> container, int32_t value);

  /// @brief Method .ctor, addr 0x6bb060c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6bb06e8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6bb06a4, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6baf318, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
