...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b040, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6a5b048, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::Vector2Int> container, int32_t value);

  /// @brief Method .ctor, addr 0x6a5af7c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b038, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5aff4, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b09c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetValue(::ByRef<::UnityEngine::Vector2Int> container);

  static inline ::Unity::Properties::Internal::Vector2IntPropertyBag_YProperty* New_ctor();

  /// @brief Method SetValue, addr 0x6a5b0a4, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::Vector2Int> container, int32_t value);

  /// @brief Method .ctor, addr 0x6a5afb8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b094, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5b050, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a59cc4, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
