...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b1ac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6a5b1b4, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::Vector3Int> container, int32_t value);

  /// @brief Method .ctor, addr 0x6a5b0ac, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b1a4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5b160, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b208, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetValue(::ByRef<::UnityEngine::Vector3Int> container);

  static inline ::Unity::Properties::Internal::Vector3IntPropertyBag_YProperty* New_ctor();

  /// @brief Method SetValue, addr 0x6a5b210, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::Vector3Int> container, int32_t value);

  /// @brief Method .ctor, addr 0x6a5b0e8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b200, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5b1bc, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b264, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetValue(::ByRef<::UnityEngine::Vector3Int> container);

  static inline ::Unity::Properties::Internal::Vector3IntPropertyBag_ZProperty* New_ctor();

  /// @brief Method SetValue, addr 0x6a5b26c, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::Vector3Int> container, int32_t value);

  /// @brief Method .ctor, addr 0x6a5b124, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b25c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5b218, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a59e10, size 0x1a8, virtual false, abstract: false, final false
  inline void _ctor();
