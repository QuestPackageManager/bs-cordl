...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b7f8, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6a5b804, size 0xc, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::Bounds> container, ::UnityEngine::Vector3 value);

  /// @brief Method .ctor, addr 0x6a5b734, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b7f0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5b7ac, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6a5b85c, size 0xc, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 GetValue(::ByRef<::UnityEngine::Bounds> container);

  static inline ::Unity::Properties::Internal::BoundsPropertyBag_ExtentsProperty* New_ctor();

  /// @brief Method SetValue, addr 0x6a5b868, size 0xc, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::Bounds> container, ::UnityEngine::Vector3 value);

  /// @brief Method .ctor, addr 0x6a5b770, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6a5b854, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6a5b810, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5a3c0, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
