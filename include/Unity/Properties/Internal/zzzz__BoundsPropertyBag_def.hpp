...
/// @brief Method GetValue, addr 0x6a5d370, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method SetValue, addr 0x6a5d37c, size 0xc, virtual true, abstract: false, final false
inline void SetValue(::ByRef<::UnityEngine::Bounds>  container, ::UnityEngine::Vector3  value) ;

/// @brief Method .ctor, addr 0x6a5d2ac, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsReadOnly, addr 0x6a5d368, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_Name, addr 0x6a5d324, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method GetValue, addr 0x6a5d3d4, size 0xc, virtual true, abstract: false, final false
inline ::UnityEngine::Vector3 GetValue(::ByRef<::UnityEngine::Bounds>  container) ;

static inline ::Unity::Properties::Internal::BoundsPropertyBag_ExtentsProperty* New_ctor() ;

/// @brief Method SetValue, addr 0x6a5d3e0, size 0xc, virtual true, abstract: false, final false
inline void SetValue(::ByRef<::UnityEngine::Bounds>  container, ::UnityEngine::Vector3  value) ;

/// @brief Method .ctor, addr 0x6a5d2e8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsReadOnly, addr 0x6a5d3cc, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_Name, addr 0x6a5d388, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_Name() ;
...
/// @brief Method .ctor, addr 0x6a5bf38, size 0x14c, virtual false, abstract: false, final false
inline void _ctor() ;
