...
public:
  ...
  /// @brief Method .ctor, addr 0x4916d90, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_Name, addr 0x4916f70, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x4916098, size 0x160, virtual false, abstract: false, final false
  inline void _ctor();
