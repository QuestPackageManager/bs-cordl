...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReflectionUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReflectionUtilities(ReflectionUtilities&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReflectionUtilities", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReflectionUtilities(ReflectionUtilitiesconst&) = delete;
