...
public:
  ...
  /// @brief Method .ctor, addr 0x6bb4ff0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReflectedPropertyBagAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReflectedPropertyBagAttribute(ReflectedPropertyBagAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReflectedPropertyBagAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReflectedPropertyBagAttribute(ReflectedPropertyBagAttributeconst&) = delete;
