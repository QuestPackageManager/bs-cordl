...
public:
  ...
  /// @brief Method Instantiate, addr 0x6a59088, size 0x4c, virtual true, abstract: false, final true
  inline ::System::Object* Instantiate();

  static inline ::Unity::Properties::TypeUtility_NonConstructable* New_ctor();

  /// @brief Method Unity.Properties.TypeUtility.ITypeConstructor.get_CanBeInstantiated, addr 0x6a59080, size 0x8, virtual true, abstract: false, final true
  inline bool Unity_Properties_TypeUtility_ITypeConstructor_get_CanBeInstantiated();

  /// @brief Method .ctor, addr 0x6a58c6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a58c68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <.cctor>b__11_0, addr 0x6a5912c, size 0x58, virtual false, abstract: false, final false
  inline ::System::Text::StringBuilder* __cctor_b__11_0();

  /// @brief Method <.cctor>b__11_1, addr 0x6a59184, size 0x18, virtual false, abstract: false, final false
  inline void __cctor_b__11_1(::System::Text::StringBuilder* sb);

  /// @brief Method <.cctor>b__11_2, addr 0x6a5919c, size 0x14, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__11_2();

  /// @brief Method .ctor, addr 0x6a59128, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanBeInstantiated, addr 0x6a58d38, size 0xd4, virtual false, abstract: false, final false
  static inline bool CanBeInstantiated(::System::Type* type);

  /// @brief Method CheckCanBeInstantiated, addr 0x6a58f44, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckIsAssignableFrom, addr 0x6a58e0c, size 0x138, virtual false, abstract: false, final false
  static inline void CheckIsAssignableFrom(::System::Type* type, ::System::Type* derivedType);

  /// @brief Method CreateTypeConstructor, addr 0x6a589cc, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRootType, addr 0x6a588e4, size 0xe8, virtual false, abstract: false, final false
  static inline ::System::Type* GetRootType(::System::Type* type);

  /// @brief Method GetTypeConstructor, addr 0x6a58c70, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeDisplayName, addr 0x6a57f98, size 0x130, virtual false, abstract: false, final false
  static inline ::StringW GetTypeDisplayName(::System::Type* type);

  /// @brief Method GetTypeDisplayName, addr 0x6a580c8, size 0x81c, virtual false, abstract: false, final false
