...
inline bool Unity::Properties::INamedProperties_1<TContainer>::TryGetProperty(::ByRef<TContainer> container, ::StringW name, ::ByRef<::Unity::Properties::IProperty_1<TContainer>*> property) {
  auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                                                                             ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::INamedProperties_1<TContainer>*>::get(), 0)));
