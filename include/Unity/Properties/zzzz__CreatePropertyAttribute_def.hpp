...
public:
  ...
  /// @brief Method .ctor, addr 0x6b9af68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadOnly, addr 0x6b9af58, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReadOnly();

  /// @brief Method set_ReadOnly, addr 0x6b9af60, size 0x8, virtual false, abstract: false, final false
