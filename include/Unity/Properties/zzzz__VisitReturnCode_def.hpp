...
DEFINE_IL2CPP_CLASS(::Unity::Properties::VisitReturnCode, "Unity.Properties", "VisitReturnCode");
// Dependencies
namespace Unity::Properties {
// Is value type: true
...
static_assert(sizeof(::Unity::Properties::VisitReturnCode) == 0x4, "Size mismatch!");
