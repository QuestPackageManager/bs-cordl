...
DEFINE_IL2CPP_CLASS(::Unity::Properties::PropertyPathPartKind, "Unity.Properties", "PropertyPathPartKind");
// Dependencies
namespace Unity::Properties {
// Is value type: true
...
static_assert(sizeof(::Unity::Properties::PropertyPathPartKind) == 0x4, "Size mismatch!");
