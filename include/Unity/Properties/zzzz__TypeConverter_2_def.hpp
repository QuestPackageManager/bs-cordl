...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TypeConverter_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TypeConverter_2(TypeConverter_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TypeConverter_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TypeConverter_2(TypeConverter_2const&) = delete;
