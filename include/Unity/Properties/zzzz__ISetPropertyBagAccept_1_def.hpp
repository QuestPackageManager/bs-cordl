...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISetPropertyBagAccept_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISetPropertyBagAccept_1(ISetPropertyBagAccept_1const&) = delete;
