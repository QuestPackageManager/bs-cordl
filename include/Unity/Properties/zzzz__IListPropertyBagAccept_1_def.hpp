...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::IListPropertyBagAccept_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::IListPropertyBagAccept_1, "Unity.Properties", "IListPropertyBagAccept`1");
// Dependencies
namespace Unity::Properties {
// cpp template
...
public:
  ...
  inline void Accept(::Unity::Properties::IListPropertyBagVisitor* visitor, ::by_ref<TContainer> container);

  // Ctor Parameters [CppParam { name: "", ty: "IListPropertyBagAccept_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IListPropertyBagAccept_1(IListPropertyBagAccept_1const&) = delete;
