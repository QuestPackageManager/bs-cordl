...
public:
  ...
  /// @brief Method GetMessageForType, addr 0x6a45a5c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a459dc, size 0x80, virtual false, abstract: false, final false
