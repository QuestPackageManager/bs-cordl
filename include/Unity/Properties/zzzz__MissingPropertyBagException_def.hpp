...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissingPropertyBagException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MissingPropertyBagException(MissingPropertyBagException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MissingPropertyBagException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MissingPropertyBagException(MissingPropertyBagExceptionconst&) = delete;
