...
// Write type traits
MARK_GEN_REF_PTR_T(::Unity::Properties::IKeyedProperties_2);
// Dependencies
namespace Unity::Properties {
// cpp template
...
public:
  ...
  inline bool TryGetProperty(::ByRef<TContainer> container, TKey key, ::ByRef<::Unity::Properties::IProperty_1<TContainer>*> property);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Unity::Properties::IKeyedProperties_2, "Unity.Properties", "IKeyedProperties`2");
