...
MARK_GEN_REF_T_PTR(::Unity::Properties::SetPropertyBagBase_2_SetElementProperty);
MARK_GEN_REF_T_PTR(::Unity::Properties::SetPropertyBagBase_2__GetPropertiesEnumerable_d__4);
...
public:
  ...
  inline TElement GetValue(::by_ref<TSet> container);
  ...
  inline void SetValue(::by_ref<TSet> container, TElement value);
...
public:
  ...
  inline bool TryGetProperty(::by_ref<TSet> container, ::System::Object* key, ::by_ref<::Unity::Properties::IProperty_1<TSet>*> property);
  ...
  inline void Unity_Properties_ICollectionPropertyBagAccept_TSet__Accept(::Unity::Properties::ICollectionPropertyBagVisitor* visitor, ::by_ref<TSet> container);
  ...
  inline void Unity_Properties_ISetPropertyBagAccept_TSet__Accept(::Unity::Properties::ISetPropertyBagVisitor* visitor, ::by_ref<TSet> container);
