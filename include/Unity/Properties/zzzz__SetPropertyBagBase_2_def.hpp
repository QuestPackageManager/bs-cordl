...
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator_Unity_Properties_IProperty_TSet___get_Current)) ::Unity::Properties::IProperty_1<TSet>*  System_Collections_Generic_IEnumerator_Unity_Properties_IProperty_TSet___Current;
