...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ICollectionPropertyBagAccept_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ICollectionPropertyBagAccept_1(ICollectionPropertyBagAccept_1const&) = delete;
