...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDictionaryPropertyBagAccept_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDictionaryPropertyBagAccept_1(IDictionaryPropertyBagAccept_1const&) = delete;
