...
public:
  // Declarations
  /// @brief Method GetCachedCaptureActionsEnumerator, addr 0x67554a0, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23699 };
