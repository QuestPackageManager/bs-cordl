...
public:
  ...
  /// @brief [InputControl(aliases = new[] { "Alternate" })]
  ...
  /// @brief [InputControl(aliases = new[] { "primary2DAxisClicked" })]
  ...
  /// @brief [InputControl(aliases = new[] { "primary2DAxisTouch" })]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OpenVROculusTouchController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OpenVROculusTouchController(OpenVROculusTouchController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OpenVROculusTouchController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OpenVROculusTouchController(OpenVROculusTouchControllerconst&) = delete;
