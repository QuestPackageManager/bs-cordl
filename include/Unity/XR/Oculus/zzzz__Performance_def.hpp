...
public:
  ...
  /// @brief Method TrySetCPULevel addr 0x2af5c8c size 0x18 virtual false final false
  static inline bool TrySetCPULevel(int32_t level);

  /// @brief Method TrySetGPULevel addr 0x2af5ca8 size 0x18 virtual false final false
  static inline bool TrySetGPULevel(int32_t level);

  /// @brief Method TryGetAvailableDisplayRefreshRates addr 0x2af5cc4 size 0x1b8 virtual false final false
  static inline bool TryGetAvailableDisplayRefreshRates(ByRef<::ArrayW<float_t, ::Array<float_t>*>> refreshRates);

  /// @brief Method TrySetDisplayRefreshRate addr 0x2af5e80 size 0x4 virtual false final false
  static inline bool TrySetDisplayRefreshRate(float_t refreshRate);

  /// @brief Method TryGetDisplayRefreshRate addr 0x2af5e88 size 0x4 virtual false final false
