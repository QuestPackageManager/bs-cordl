...
namespace Unity::XR::Oculus {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15577), inst: 112 }), TypeDefinitionIndex(TypeDefinitionIndex(15577)),
// TypeDefinitionIndex(TypeDefinitionIndex(2611))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15292)) CS Name: ::Unity.XR.Oculus::OculusUsages*
