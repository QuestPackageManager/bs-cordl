...
namespace Unity::XR::Oculus {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(15620)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15620), inst:
// 105 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(15151)) CS Name: ::Unity.XR.Oculus::OculusUsages*
