...
public:
  ...
  /// @brief Method add_InputFocusAcquired addr 0x2af4594 size 0xb8 virtual false final false
  static inline void add_InputFocusAcquired(::System::Action* value);

  /// @brief Method remove_InputFocusAcquired addr 0x2af464c size 0xb8 virtual false final false
  static inline void remove_InputFocusAcquired(::System::Action* value);

  /// @brief Method add_InputFocusLost addr 0x2af4704 size 0xbc virtual false final false
  static inline void add_InputFocusLost(::System::Action* value);

  /// @brief Method remove_InputFocusLost addr 0x2af47c0 size 0xbc virtual false final false
  static inline void remove_InputFocusLost(::System::Action* value);

  /// @brief Method get_hasInputFocus addr 0x2af487c size 0x4 virtual false final false
  static inline bool get_hasInputFocus();

  /// @brief Method Update addr 0x2af4884 size 0xa0 virtual false final false
  static inline void Update();

  static inline ::Unity::XR::Oculus::InputFocus* New_ctor();

  /// @brief Method .ctor addr 0x2af4924 size 0x8 virtual false final false
  inline void _ctor();
