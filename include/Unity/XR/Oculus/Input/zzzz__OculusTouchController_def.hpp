...
public:
  ...
  /// @brief [InputControl(noisy = true, aliases = new[] { "controllerAcceleration" })]
  ...
  /// @brief [InputControl(noisy = true, aliases = new[] { "controllerAngularAcceleration" })]
  ...
  /// @brief [InputControl(noisy = true, aliases = new[] { "controllerAngularVelocity" })]
  ...
  /// @brief [InputControl(noisy = true, aliases = new[] { "controllerVelocity" })]
  ...
  /// @brief [InputControl(aliases = new[] { "A", "X", "Alternate" })]
  ...
  /// @brief [InputControl(aliases = new[] { "ATouched", "XTouched", "ATouch", "XTouch" })]
  ...
  /// @brief [InputControl(aliases = new[] { "B", "Y", "Primary" })]
  ...
  /// @brief [InputControl(aliases = new[] { "BTouched", "YTouched", "BTouch", "YTouch" })]
  ...
  /// @brief [InputControl(aliases = new[] { "Primary2DAxis", "Joystick" })]
  __declspec(property(get = get_thumbstick, put = set_thumbstick)) ::UnityEngine::InputSystem::Controls::Vector2Control* thumbstick;

  /// @brief [InputControl(aliases = new[] { "JoystickOrPadPressed", "thumbstickClick" })]
  ...
  /// @brief [InputControl(name = "deviceRotation", layout = "Quaternion", aliases = new[] { "controllerRotation" })]
  ...
  /// @brief [InputControl(aliases = new[] { "indexButton", "indexTouched" })]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OculusTouchController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OculusTouchController(OculusTouchController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OculusTouchController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OculusTouchController(OculusTouchControllerconst&) = delete;
