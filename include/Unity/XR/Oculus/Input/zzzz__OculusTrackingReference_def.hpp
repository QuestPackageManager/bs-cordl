...
public:
  ...
  /// @brief Method FinishSetup, addr 0x638decc, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x638df8c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isTracked, addr 0x638debc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_isTracked();

  /// @brief Method get_trackingState, addr 0x638deac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_trackingState();

  /// @brief Method set_isTracked, addr 0x638dec4, size 0x8, virtual false, abstract: false, final false
  inline void set_isTracked(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_trackingState, addr 0x638deb4, size 0x8, virtual false, abstract: false, final false
