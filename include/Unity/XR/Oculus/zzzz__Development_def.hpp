...
public:
  ...
  /// @brief Method OverrideDeveloperModeStart, addr 0x4831b5c, size 0xd4, virtual false, abstract: false, final false
  static inline void OverrideDeveloperModeStart();

  /// @brief Method OverrideDeveloperModeStop, addr 0x4831c38, size 0x74, virtual false, abstract: false, final false
  static inline void OverrideDeveloperModeStop();

  /// @brief Method TrySetDeveloperMode, addr 0x4831b04, size 0x58, virtual false, abstract: false, final false
