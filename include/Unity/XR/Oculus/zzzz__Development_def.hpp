...
public:
  ...
  /// @brief Method OverrideDeveloperModeStart, addr 0x4834dc0, size 0xd4, virtual false, abstract: false, final false
  static inline void OverrideDeveloperModeStart();

  /// @brief Method OverrideDeveloperModeStop, addr 0x4834e9c, size 0x74, virtual false, abstract: false, final false
  static inline void OverrideDeveloperModeStop();

  /// @brief Method TrySetDeveloperMode, addr 0x4834d68, size 0x58, virtual false, abstract: false, final false
