...
public:
  ...
  /// @brief Method OverrideDeveloperModeStart, addr 0x4837a18, size 0xd4, virtual false, abstract: false, final false
  static inline void OverrideDeveloperModeStart();

  /// @brief Method OverrideDeveloperModeStop, addr 0x4837af4, size 0x74, virtual false, abstract: false, final false
  static inline void OverrideDeveloperModeStop();

  /// @brief Method TrySetDeveloperMode, addr 0x48379c0, size 0x58, virtual false, abstract: false, final false
