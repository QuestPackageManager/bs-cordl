...
public:
  ...
  /// @brief Method GetBoundaryConfigured, addr 0x483313c, size 0x4, virtual false, abstract: false, final false
  static inline bool GetBoundaryConfigured();

  /// @brief Method GetBoundaryDimensions, addr 0x4833144, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBoundaryVisible, addr 0x483314c, size 0x4, virtual false, abstract: false, final false
  static inline bool GetBoundaryVisible();

  /// @brief Method SetBoundaryVisible, addr 0x4833154, size 0x8, virtual false, abstract: false, final false
