...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IgnoredByDeepProfilerAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IgnoredByDeepProfilerAttribute(IgnoredByDeepProfilerAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IgnoredByDeepProfilerAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IgnoredByDeepProfilerAttribute(IgnoredByDeepProfilerAttributeconst&) = delete;
