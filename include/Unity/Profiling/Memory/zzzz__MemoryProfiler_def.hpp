...
public:
  ...
  /// @brief Method FinalizeSnapshot, addr 0x47fd348, size 0x84, virtual false, abstract: false, final false
  static inline void FinalizeSnapshot(::StringW path, bool result);

  /// @brief Method PrepareMetadata, addr 0x47fcfd0, size 0x1fc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PrepareMetadata();

  /// @brief Method SaveScreenshotToDisk, addr 0x47fd3cc, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteIntToByteArray, addr 0x47fd1cc, size 0x8c, virtual false, abstract: false, final false
  static inline int32_t WriteIntToByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t value);

  /// @brief Method WriteStringToByteArray, addr 0x47fd258, size 0x9c, virtual false, abstract: false, final false
