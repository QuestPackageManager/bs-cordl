...
public:
  ...
  /// @brief Method WriteIntToByteArray, addr 0x6a5eb38, size 0x88, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Profiling::Memory::MemoryProfiler) == 0x10, "Size mismatch!");
