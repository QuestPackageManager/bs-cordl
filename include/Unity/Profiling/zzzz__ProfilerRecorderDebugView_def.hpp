...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProfilerRecorderDebugView", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProfilerRecorderDebugView(ProfilerRecorderDebugView&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProfilerRecorderDebugView", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProfilerRecorderDebugView(ProfilerRecorderDebugViewconst&) = delete;
