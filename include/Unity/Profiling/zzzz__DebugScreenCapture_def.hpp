...
public:
  ...
  /// @brief Method set_Height, addr 0x4864470, size 0x8, virtual false, abstract: false, final false
  inline void set_Height(int32_t value);

  /// @brief Method set_ImageFormat, addr 0x4864460, size 0x8, virtual false, abstract: false, final false
  inline void set_ImageFormat(::UnityEngine::TextureFormat value);

  /// @brief Method set_RawImageDataReference, addr 0x4864458, size 0x8, virtual false, abstract: false, final false
  inline void set_RawImageDataReference(::Unity::Collections::NativeArray_1<uint8_t> value);

  /// @brief Method set_Width, addr 0x4864468, size 0x8, virtual false, abstract: false, final false
