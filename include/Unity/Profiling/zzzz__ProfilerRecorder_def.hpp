...
/// @brief Method CheckInitializedAndThrow, addr 0x6891338, size 0x58, virtual false, abstract: false, final false
inline void CheckInitializedAndThrow() ;

/// @brief Method Control, addr 0x6891420, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method Control_Injected, addr 0x6891784, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x6891194, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Create_Injected, addr 0x6891728, size 0x5c, virtual false, abstract: false, final false
static inline void Create_Injected(::ByRef<::Unity::Profiling::LowLevel::Unsafe::ProfilerRecorderHandle>  statHandle, int32_t  maxSampleCount, ::Unity::Profiling::ProfilerRecorderOptions  options, ::ByRef<::Unity::Profiling::ProfilerRecorder>  ret) ;

/// @brief Method Dispose, addr 0x6891950, size 0x54, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetCount, addr 0x6891594, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method GetCount_Injected, addr 0x6891840, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method GetLastValue, addr 0x6891504, size 0x40, virtual false, abstract: false, final false
static inline int64_t GetLastValue(::Unity::Profiling::ProfilerRecorder  handle) ;

/// @brief Method GetLastValue_Injected, addr 0x6891804, size 0x3c, virtual false, abstract: false, final false
static inline int64_t GetLastValue_Injected(::ByRef<::Unity::Profiling::ProfilerRecorder>  handle) ;

/// @brief Method GetRunning, addr 0x689162c, size 0x44, virtual false, abstract: false, final false
static inline bool GetRunning(::Unity::Profiling::ProfilerRecorder  handle) ;

/// @brief Method GetRunning_Injected, addr 0x68918c0, size 0x3c, virtual false, abstract: false, final false
static inline bool GetRunning_Injected(::ByRef<::Unity::Profiling::ProfilerRecorder>  handle) ;

/// @brief Method GetSample, addr 0x6891670, size 0x4c, virtual false, abstract: false, final false
inline ::Unity::Profiling::ProfilerRecorderSample GetSample(int32_t  index) ;

/// @brief Method GetSampleInternal, addr 0x68916bc, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method GetSampleInternal_Injected, addr 0x68918fc, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetValid, addr 0x68912a8, size 0x44, virtual false, abstract: false, final false
static inline bool GetValid(::Unity::Profiling::ProfilerRecorder  handle) ;

/// @brief Method GetValid_Injected, addr 0x6891884, size 0x3c, virtual false, abstract: false, final false
static inline bool GetValid_Injected(::ByRef<::Unity::Profiling::ProfilerRecorder>  handle) ;

/// @brief Method GetValueUnitType, addr 0x6891390, size 0x40, virtual false, abstract: false, final false
static inline ::Unity::Profiling::ProfilerMarkerDataUnit GetValueUnitType(::Unity::Profiling::ProfilerRecorder  handle) ;

/// @brief Method GetValueUnitType_Injected, addr 0x68917c8, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x68913d0, size 0x50, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartNew, addr 0x6891218, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method Stop, addr 0x6891468, size 0x50, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method .ctor, addr 0x6891154, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x68911f4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x6891544, size 0x50, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsRunning, addr 0x68915dc, size 0x50, virtual false, abstract: false, final false
inline bool get_IsRunning() ;

/// @brief Method get_LastValue, addr 0x68914b8, size 0x4c, virtual false, abstract: false, final false
inline int64_t get_LastValue() ;

/// @brief Method get_UnitType, addr 0x68912ec, size 0x4c, virtual false, abstract: false, final false
inline ::Unity::Profiling::ProfilerMarkerDataUnit get_UnitType() ;

/// @brief Method get_Valid, addr 0x6891254, size 0x54, virtual false, abstract: false, final false
