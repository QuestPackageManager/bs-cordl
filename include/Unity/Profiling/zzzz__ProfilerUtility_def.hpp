...
DEFINE_IL2CPP_CLASS(::Unity::Profiling::ProfilerUtility, "Unity.Profiling", "ProfilerUtility");
// Dependencies
namespace Unity::Profiling {
// Is value type: true
...
static_assert(sizeof(::Unity::Profiling::ProfilerUtility) == 0x1, "Size mismatch!");
