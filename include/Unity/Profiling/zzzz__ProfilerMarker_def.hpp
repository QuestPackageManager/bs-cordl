...
public:
  ...
  /// @brief Method Dispose, addr 0x69030d0, size 0x4c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x690304c, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Auto, addr 0x6903004, size 0x48, virtual false, abstract: false, final false
  inline ::Unity::Profiling::ProfilerMarker_AutoScope Auto();

  /// @brief Method .ctor, addr 0x6902fe0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Profiling::ProfilerCategory category, ::StringW name);

  /// @brief Method .ctor, addr 0x6902e64, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Handle, addr 0x6902e5c, size 0x8, virtual false, abstract: false, final false
