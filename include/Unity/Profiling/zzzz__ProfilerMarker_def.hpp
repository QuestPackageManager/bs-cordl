...
public:
  ...
  /// @brief Method Dispose, addr 0x485e00c, size 0x60, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x485df70, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Auto, addr 0x485df18, size 0x58, virtual false, abstract: false, final false
  inline ::Unity::Profiling::ProfilerMarker_AutoScope Auto();

  /// @brief Method .ctor, addr 0x485deb8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Profiling::ProfilerCategory category, ::StringW name);

  /// @brief Method .ctor, addr 0x485de08, size 0x54, virtual false, abstract: false, final false
