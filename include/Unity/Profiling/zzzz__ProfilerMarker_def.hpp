...
/// @brief Method Dispose, addr 0x68910c4, size 0x4c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x6891040, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method Auto, addr 0x6890ff8, size 0x48, virtual false, abstract: false, final false
inline ::Unity::Profiling::ProfilerMarker_AutoScope Auto() ;

/// @brief Method .ctor, addr 0x6890fd4, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::Unity::Profiling::ProfilerCategory  category, ::StringW  name) ;

/// @brief Method .ctor, addr 0x6890e58, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_Handle, addr 0x6890e50, size 0x8, virtual false, abstract: false, final false
