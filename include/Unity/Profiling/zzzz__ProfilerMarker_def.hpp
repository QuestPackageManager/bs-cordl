...
public:
  ...
  /// @brief Method Dispose, addr 0x4860ac0, size 0x60, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x4860a24, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Auto, addr 0x48609cc, size 0x58, virtual false, abstract: false, final false
  inline ::Unity::Profiling::ProfilerMarker_AutoScope Auto();

  /// @brief Method .ctor, addr 0x486096c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Profiling::ProfilerCategory category, ::StringW name);

  /// @brief Method .ctor, addr 0x48608bc, size 0x54, virtual false, abstract: false, final false
