...
/// @brief Method GetAvailable, addr 0x6891b60, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method GetAvailable_Injected, addr 0x6891d14, size 0x3c, virtual false, abstract: false, final false
static inline void GetAvailable_Injected(::ByRef<::UnityEngine::Bindings::BlittableListWrapper>  outRecorderHandleList) ;

/// @brief Method GetByName, addr 0x6891e10, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetByName_Unsafe, addr 0x6891e18, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method GetByName_Unsafe_Injected, addr 0x6891e7c, size 0x5c, virtual false, abstract: false, final false
static inline void GetByName_Unsafe_Injected(::ByRef<::Unity::Profiling::ProfilerCategory>  category, char16_t*  name, int32_t  nameLen, ::ByRef<::Unity::Profiling::LowLevel::Unsafe::ProfilerRecorderHandle>  ret) ;

/// @brief Method GetByName__Unmanaged, addr 0x6891d50, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method GetByName__Unmanaged_Injected, addr 0x6891db4, size 0x5c, virtual false, abstract: false, final false
static inline void GetByName__Unmanaged_Injected(::ByRef<::Unity::Profiling::ProfilerCategory>  category, uint8_t*  name, int32_t  nameLen, ::ByRef<::Unity::Profiling::LowLevel::Unsafe::ProfilerRecorderHandle>  ret) ;

/// @brief Method GetDescription, addr 0x6891a00, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method GetDescriptionInternal, addr 0x6891adc, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method GetDescriptionInternal_Injected, addr 0x6891ed8, size 0x44, virtual false, abstract: false, final false
static inline void GetDescriptionInternal_Injected(::ByRef<::Unity::Profiling::LowLevel::Unsafe::ProfilerRecorderHandle>  handle, ::ByRef<::Unity::Profiling::LowLevel::Unsafe::ProfilerRecorderDescription>  ret) ;
...
/// @brief Method .ctor, addr 0x68919e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint64_t  handle) ;

/// @brief Method get_Valid, addr 0x68919ec, size 0x14, virtual false, abstract: false, final false
