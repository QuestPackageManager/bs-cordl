...
public:
  // Declarations
  /// @brief Method BeginSample, addr 0x4861234, size 0x3c, virtual false, abstract: false, final false
  static inline void BeginSample(::System::IntPtr markerPtr);

  /// @brief Method CreateCategory__Unmanaged, addr 0x4861ba0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCounterValue__Unmanaged, addr 0x4861d18, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMarker, addr 0x48610c0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMarker__Unmanaged, addr 0x4861c38, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndSample, addr 0x48612d0, size 0x3c, virtual false, abstract: false, final false
  static inline void EndSample(::System::IntPtr markerPtr);

  /// @brief Method GetCategoryDescription, addr 0x4860ec8, size 0x90, virtual false, abstract: false, final false
  static inline ::Unity::Profiling::LowLevel::Unsafe::ProfilerCategoryDescription GetCategoryDescription(uint16_t categoryId);

  /// @brief Method GetCategoryDescription_Injected, addr 0x4861bf4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMarkerMetadata__Unmanaged, addr 0x4861ca4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToString, addr 0x4860f58, size 0xec, virtual false, abstract: false, final false
