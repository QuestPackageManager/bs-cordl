...
public:
  // Declarations
  /// @brief Method BeginSample, addr 0x68909c8, size 0x3c, virtual false, abstract: false, final false
  static inline void BeginSample(::System::IntPtr markerPtr);

  /// @brief Method BeginSampleWithMetadata, addr 0x6891a30, size 0x54, virtual false, abstract: false, final false
  static inline void BeginSampleWithMetadata(::System::IntPtr markerPtr, int32_t metadataCount, void* metadata);

  /// @brief Method CreateCategory__Unmanaged, addr 0x689185c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCounterValue__Unmanaged, addr 0x6891a84, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMarker, addr 0x68907c0, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMarker_Injected, addr 0x68918f4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMarker__Unmanaged, addr 0x6891950, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndSample, addr 0x6890a50, size 0x3c, virtual false, abstract: false, final false
  static inline void EndSample(::System::IntPtr markerPtr);

  /// @brief Method GetCategoryDescription, addr 0x68905ec, size 0x90, virtual false, abstract: false, final false
  static inline ::Unity::Profiling::LowLevel::Unsafe::ProfilerCategoryDescription GetCategoryDescription(uint16_t categoryId);

  /// @brief Method GetCategoryDescription_Injected, addr 0x68918b0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMarkerMetadata__Unmanaged, addr 0x68919bc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Utf8ToString, addr 0x689067c, size 0xe4, virtual false, abstract: false, final false
