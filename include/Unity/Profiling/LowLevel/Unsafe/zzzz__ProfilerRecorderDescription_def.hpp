...
public:
  ...
  /// @brief Method get_Category, addr 0x4864478, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Profiling::ProfilerCategory get_Category();

  /// @brief Method get_Name, addr 0x4864480, size 0x10, virtual false, abstract: false, final false
