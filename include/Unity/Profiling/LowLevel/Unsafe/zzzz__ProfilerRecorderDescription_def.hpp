...
public:
  ...
  /// @brief Method get_Category, addr 0x486d4a8, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Profiling::ProfilerCategory get_Category();

  /// @brief Method get_Name, addr 0x486d4b0, size 0x10, virtual false, abstract: false, final false
