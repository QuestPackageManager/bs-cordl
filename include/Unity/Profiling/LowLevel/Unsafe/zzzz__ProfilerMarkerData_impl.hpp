...
// Ctor Parameters [CppParam { name: "Type", ty: "uint8_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "reserved0", ty: "uint8_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "reserved1", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Size", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Ptr", ty: "void*", modifiers: "", def_value: Some("{}") }]
