...
// Ctor Parameters [CppParam { name: "FileSize", ty: "int64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "FileState", ty: "::Unity::IO::LowLevel::Unsafe::FileState", modifiers: "", def_value: Some("{}") }]
