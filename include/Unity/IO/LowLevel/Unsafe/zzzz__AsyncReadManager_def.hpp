...
public:
// Declarations
/// @brief Method CloseFileAsync, addr 0x68928c4, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method CloseFileAsync_Injected, addr 0x6893484, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetFileInfo, addr 0x6893100, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetFileInfoInternal, addr 0x6892f68, size 0x144, virtual false, abstract: false, final false
static inline ::Unity::IO::LowLevel::Unsafe::ReadHandle GetFileInfoInternal(::StringW  filename, void*  cmd) ;

/// @brief Method GetFileInfoInternal_Injected, addr 0x68930ac, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method OpenFileAsync, addr 0x6893420, size 0x64, virtual false, abstract: false, final false
static inline ::Unity::IO::LowLevel::Unsafe::FileHandle OpenFileAsync(::StringW  fileName) ;

/// @brief Method OpenFileAsync_Internal, addr 0x68932a8, size 0x134, virtual false, abstract: false, final false
static inline ::Unity::IO::LowLevel::Unsafe::FileHandle OpenFileAsync_Internal(::StringW  fileName) ;

/// @brief Method OpenFileAsync_Internal_Injected, addr 0x68933dc, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x6893204, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method ReadWithHandlesInternal_NativeCopy, addr 0x6893154, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method ReadWithHandlesInternal_NativeCopy_Injected, addr 0x68931b0, size 0x54, virtual false, abstract: false, final false
static inline void ReadWithHandlesInternal_NativeCopy_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::FileHandle>  fileHandle, void*  readCmdArray, ::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle>  ret) ;
