...
DEFINE_IL2CPP_CLASS(::Unity::IO::LowLevel::Unsafe::ReadCommandArray, "Unity.IO.LowLevel.Unsafe", "ReadCommandArray");
// Dependencies
namespace Unity::IO::LowLevel::Unsafe {
// Is value type: true
...
public:
  ...
  // Ctor Parameters [CppParam { name: "ReadCommands", ty: "::Unity::IO::LowLevel::Unsafe::ReadCommand*", modifiers: "", def_value: None, comment: None }, CppParam { name: "CommandCount", ty:
...
static_assert(sizeof(::Unity::IO::LowLevel::Unsafe::ReadCommandArray) == 0x10, "Size mismatch!");
