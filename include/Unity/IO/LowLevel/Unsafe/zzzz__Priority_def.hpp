...
DEFINE_IL2CPP_CLASS(::Unity::IO::LowLevel::Unsafe::Priority, "Unity.IO.LowLevel.Unsafe", "Priority");
// Dependencies
namespace Unity::IO::LowLevel::Unsafe {
// Is value type: true
...
static_assert(sizeof(::Unity::IO::LowLevel::Unsafe::Priority) == 0x4, "Size mismatch!");
