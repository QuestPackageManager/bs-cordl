...
// Ctor Parameters [CppParam { name: "Buffer", ty: "void*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Offset", ty: "int64_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "Size", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }]
