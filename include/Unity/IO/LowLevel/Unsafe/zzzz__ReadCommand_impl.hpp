...
// Ctor Parameters [CppParam { name: "Buffer", ty: "void*", modifiers: "", def_value: Some("{}") }, CppParam { name: "Offset", ty: "int64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Size", ty: "int64_t", modifiers: "", def_value: Some("{}") }]
