...
public:
  ...
  /// @brief Method Close, addr 0x6904828, size 0xa8, virtual false, abstract: false, final false
  inline ::Unity::Jobs::JobHandle Close(::Unity::Jobs::JobHandle dependency);

  /// @brief Method GetJobHandle_Internal, addr 0x6904798, size 0x54, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle GetJobHandle_Internal(::ByRef<::Unity::IO::LowLevel::Unsafe::FileHandle> handle);

  /// @brief Method GetJobHandle_Internal_Injected, addr 0x690492c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFileHandleValid, addr 0x690475c, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsFileHandleValid(::ByRef<::Unity::IO::LowLevel::Unsafe::FileHandle> handle);

  /// @brief Method IsValid, addr 0x69047ec, size 0x3c, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method get_JobHandle, addr 0x69046cc, size 0x90, virtual false, abstract: false, final false
