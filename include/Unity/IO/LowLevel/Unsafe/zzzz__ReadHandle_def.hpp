...
public:
  ...
  /// @brief Method Cancel, addr 0x6892538, size 0xcc, virtual false, abstract: false, final false
  inline void Cancel();

  /// @brief Method CancelInternal, addr 0x6892604, size 0x40, virtual false, abstract: false, final false
  static inline void CancelInternal(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method CancelInternal_Injected, addr 0x6892644, size 0x3c, virtual false, abstract: false, final false
  static inline void CancelInternal_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle> handle);

  /// @brief Method Dispose, addr 0x6892330, size 0xfc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetJobHandle, addr 0x6892724, size 0x4c, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle GetJobHandle(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method GetJobHandle_Injected, addr 0x6892864, size 0x44, virtual false, abstract: false, final false
  static inline void GetJobHandle_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle> handle, ::ByRef<::Unity::Jobs::JobHandle> ret);

  /// @brief Method GetReadStatus, addr 0x6892770, size 0x40, virtual false, abstract: false, final false
  static inline ::Unity::IO::LowLevel::Unsafe::ReadStatus GetReadStatus(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method GetReadStatus_Injected, addr 0x68927b0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsReadHandleValid, addr 0x68922ec, size 0x44, virtual false, abstract: false, final false
  static inline bool IsReadHandleValid(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method IsReadHandleValid_Injected, addr 0x6892828, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsReadHandleValid_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle> handle);

  /// @brief Method IsValid, addr 0x68922a4, size 0x48, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method ReleaseReadHandle, addr 0x68924f8, size 0x40, virtual false, abstract: false, final false
  static inline void ReleaseReadHandle(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method ReleaseReadHandle_Injected, addr 0x68927ec, size 0x3c, virtual false, abstract: false, final false
  static inline void ReleaseReadHandle_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle> handle);

  /// @brief Method get_JobHandle, addr 0x6892680, size 0xa4, virtual false, abstract: false, final false
  inline ::Unity::Jobs::JobHandle get_JobHandle();

  /// @brief Method get_Status, addr 0x689242c, size 0xcc, virtual false, abstract: false, final false
