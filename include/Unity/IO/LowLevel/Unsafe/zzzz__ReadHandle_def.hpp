...
/// @brief Method Cancel, addr 0x6892bf8, size 0xcc, virtual false, abstract: false, final false
inline void Cancel() ;

/// @brief Method CancelInternal, addr 0x6892cc4, size 0x40, virtual false, abstract: false, final false
static inline void CancelInternal(::Unity::IO::LowLevel::Unsafe::ReadHandle  handle) ;

/// @brief Method CancelInternal_Injected, addr 0x6892d04, size 0x3c, virtual false, abstract: false, final false
static inline void CancelInternal_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle>  handle) ;

/// @brief Method Dispose, addr 0x68929f0, size 0xfc, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetJobHandle, addr 0x6892de4, size 0x4c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle GetJobHandle(::Unity::IO::LowLevel::Unsafe::ReadHandle  handle) ;

/// @brief Method GetJobHandle_Injected, addr 0x6892f24, size 0x44, virtual false, abstract: false, final false
static inline void GetJobHandle_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle>  handle, ::ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method GetReadStatus, addr 0x6892e30, size 0x40, virtual false, abstract: false, final false
static inline ::Unity::IO::LowLevel::Unsafe::ReadStatus GetReadStatus(::Unity::IO::LowLevel::Unsafe::ReadHandle  handle) ;

/// @brief Method GetReadStatus_Injected, addr 0x6892e70, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method IsReadHandleValid, addr 0x68929ac, size 0x44, virtual false, abstract: false, final false
static inline bool IsReadHandleValid(::Unity::IO::LowLevel::Unsafe::ReadHandle  handle) ;

/// @brief Method IsReadHandleValid_Injected, addr 0x6892ee8, size 0x3c, virtual false, abstract: false, final false
static inline bool IsReadHandleValid_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle>  handle) ;

/// @brief Method IsValid, addr 0x6892964, size 0x48, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method ReleaseReadHandle, addr 0x6892bb8, size 0x40, virtual false, abstract: false, final false
static inline void ReleaseReadHandle(::Unity::IO::LowLevel::Unsafe::ReadHandle  handle) ;

/// @brief Method ReleaseReadHandle_Injected, addr 0x6892eac, size 0x3c, virtual false, abstract: false, final false
static inline void ReleaseReadHandle_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle>  handle) ;

/// @brief Method get_JobHandle, addr 0x6892d40, size 0xa4, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle get_JobHandle() ;

/// @brief Method get_Status, addr 0x6892aec, size 0xcc, virtual false, abstract: false, final false
