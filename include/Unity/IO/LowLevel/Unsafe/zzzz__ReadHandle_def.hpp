...
public:
  ...
  /// @brief Method Cancel, addr 0x6904c04, size 0xcc, virtual false, abstract: false, final false
  inline void Cancel();

  /// @brief Method CancelInternal, addr 0x6904cd0, size 0x40, virtual false, abstract: false, final false
  static inline void CancelInternal(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method CancelInternal_Injected, addr 0x6904d10, size 0x3c, virtual false, abstract: false, final false
  static inline void CancelInternal_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle> handle);

  /// @brief Method Dispose, addr 0x69049fc, size 0xfc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetJobHandle, addr 0x6904df0, size 0x4c, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle GetJobHandle(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method GetJobHandle_Injected, addr 0x6904f30, size 0x44, virtual false, abstract: false, final false
  static inline void GetJobHandle_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle> handle, ::ByRef<::Unity::Jobs::JobHandle> ret);

  /// @brief Method GetReadStatus, addr 0x6904e3c, size 0x40, virtual false, abstract: false, final false
  static inline ::Unity::IO::LowLevel::Unsafe::ReadStatus GetReadStatus(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method GetReadStatus_Injected, addr 0x6904e7c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsReadHandleValid, addr 0x69049b8, size 0x44, virtual false, abstract: false, final false
  static inline bool IsReadHandleValid(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method IsReadHandleValid_Injected, addr 0x6904ef4, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsReadHandleValid_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle> handle);

  /// @brief Method IsValid, addr 0x6904970, size 0x48, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method ReleaseReadHandle, addr 0x6904bc4, size 0x40, virtual false, abstract: false, final false
  static inline void ReleaseReadHandle(::Unity::IO::LowLevel::Unsafe::ReadHandle handle);

  /// @brief Method ReleaseReadHandle_Injected, addr 0x6904eb8, size 0x3c, virtual false, abstract: false, final false
  static inline void ReleaseReadHandle_Injected(::ByRef<::Unity::IO::LowLevel::Unsafe::ReadHandle> handle);

  /// @brief Method get_JobHandle, addr 0x6904d4c, size 0xa4, virtual false, abstract: false, final false
  inline ::Unity::Jobs::JobHandle get_JobHandle();

  /// @brief Method get_Status, addr 0x6904af8, size 0xcc, virtual false, abstract: false, final false
