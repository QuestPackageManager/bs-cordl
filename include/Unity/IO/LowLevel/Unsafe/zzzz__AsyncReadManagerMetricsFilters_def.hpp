...
/// @brief Field PriorityLevels, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_PriorityLevels, put=__cordl_internal_set_PriorityLevels)) ::ArrayW<::Unity::IO::LowLevel::Unsafe::Priority,::Array<::Unity::IO::LowLevel::Unsafe::Priority>*>  PriorityLevels;

/// @brief Field ReadTypes, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_ReadTypes, put=__cordl_internal_set_ReadTypes)) ::ArrayW<::Unity::IO::LowLevel::Unsafe::FileReadType,::Array<::Unity::IO::LowLevel::Unsafe::FileReadType>*>  ReadTypes;

/// @brief Field States, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_States, put=__cordl_internal_set_States)) ::ArrayW<::Unity::IO::LowLevel::Unsafe::ProcessingState,::Array<::Unity::IO::LowLevel::Unsafe::ProcessingState>*>  States;

/// @brief Field Subsystems, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_Subsystems, put=__cordl_internal_set_Subsystems)) ::ArrayW<::Unity::IO::LowLevel::Unsafe::AssetLoadingSubsystem,::Array<::Unity::IO::LowLevel::Unsafe::AssetLoadingSubsystem>*>  Subsystems;
