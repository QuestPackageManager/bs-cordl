...
// Ctor Parameters [CppParam { name: "ReadCommands", ty: "::Unity::IO::LowLevel::Unsafe::ReadCommand*", modifiers: "", def_value: Some("{}") }, CppParam { name: "CommandCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
