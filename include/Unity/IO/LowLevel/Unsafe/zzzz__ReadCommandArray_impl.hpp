...
// Ctor Parameters [CppParam { name: "ReadCommands", ty: "::Unity::IO::LowLevel::Unsafe::ReadCommand*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "CommandCount", ty:
