...
DEFINE_IL2CPP_CLASS(::Unity::IO::LowLevel::Unsafe::ReadStatus, "Unity.IO.LowLevel.Unsafe", "ReadStatus");
// Dependencies
namespace Unity::IO::LowLevel::Unsafe {
// Is value type: true
...
static_assert(sizeof(::Unity::IO::LowLevel::Unsafe::ReadStatus) == 0x4, "Size mismatch!");
