...
public:
  ...
  /// @brief Method .ctor, addr 0x66820f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PostNormalizeAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PostNormalizeAttribute(PostNormalizeAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PostNormalizeAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PostNormalizeAttribute(PostNormalizeAttributeconst&) = delete;
