...
public:
  ...
  // def_value: None, comment: None }, CppParam { name: "c2", ty: "::Unity::Mathematics::int2", modifiers: "", def_value: None, comment: None }, CppParam { name: "c3", ty:
  // "::Unity::Mathematics::int2", modifiers: "", def_value: None, comment: None }]
