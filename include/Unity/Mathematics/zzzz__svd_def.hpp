...
public:
  // Ctor Parameters [CppParam { name: "", ty: "svd", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  svd(svd&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "svd", modifiers: "const&", def_value: None, comment: None }]
