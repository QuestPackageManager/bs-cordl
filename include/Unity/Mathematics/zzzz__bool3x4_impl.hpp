...
// Ctor Parameters [CppParam { name: "c0", ty: "::Unity::Mathematics::bool3", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "c1", ty: "::Unity::Mathematics::bool3",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "c2", ty: "::Unity::Mathematics::bool3", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "c3", ty:
// "::Unity::Mathematics::bool3", modifiers: "", def_value: Some("{}"), comment: None }]
