...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatGames::Analytics::Events::BasePlatformSessionAnalyticsEvent::*)(::OSCE::Analytics::AnalyticsManager*, int32_t)>(&::BeatGames::Analytics::Events::BasePlatformSessionAnalyticsEvent::ApplyTime)> {
