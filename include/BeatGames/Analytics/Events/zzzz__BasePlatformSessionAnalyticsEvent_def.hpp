...
// Write type traits
MARK_REF_T(::BeatGames::Analytics::Events::BasePlatformSessionAnalyticsEvent*);
DEFINE_IL2CPP_CLASS(::BeatGames::Analytics::Events::BasePlatformSessionAnalyticsEvent*, "BeatGames.Analytics.Events", "BasePlatformSessionAnalyticsEvent");
...
public:
  ...
  /// @brief Method ApplyBasicFields, addr 0x32577f4, size 0xb8, virtual true, abstract: false, final false
  inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager* manager);

  /// @brief Method ApplyTime, addr 0x32577b4, size 0x40, virtual true, abstract: false, final false
  inline void ApplyTime(::OSCE::Analytics::AnalyticsManager* manager, int32_t timestamp);

  /// @brief Method EventRequiresAnalyticsID, addr 0x3257790, size 0x8, virtual true, abstract: false, final false
  inline bool EventRequiresAnalyticsID();

  /// @brief Method GetIDType, addr 0x3257788, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ReturnedToPool, addr 0x3257798, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3257cdc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatGames::Analytics::Events::BasePlatformSessionAnalyticsEvent) == 0x78, "Size mismatch!");
