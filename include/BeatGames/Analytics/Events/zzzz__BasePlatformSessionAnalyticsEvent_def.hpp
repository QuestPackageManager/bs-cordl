...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BasePlatformSessionAnalyticsEvent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BasePlatformSessionAnalyticsEvent(BasePlatformSessionAnalyticsEvent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BasePlatformSessionAnalyticsEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BasePlatformSessionAnalyticsEvent(BasePlatformSessionAnalyticsEventconst&) = delete;
