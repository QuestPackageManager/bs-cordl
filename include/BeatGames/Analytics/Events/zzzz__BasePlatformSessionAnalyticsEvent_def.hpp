...
public:
  ...
  /// @brief Method ApplyBasicFields, addr 0x31c3a9c, size 0xb8, virtual true, abstract: false, final false
  inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager* manager);

  /// @brief Method ApplyTime, addr 0x31c3a5c, size 0x40, virtual true, abstract: false, final false
  inline void ApplyTime(::OSCE::Analytics::AnalyticsManager* manager, int32_t timestamp);

  /// @brief Method EventRequiresAnalyticsID, addr 0x31c3a38, size 0x8, virtual true, abstract: false, final false
  inline bool EventRequiresAnalyticsID();

  /// @brief Method GetIDType, addr 0x31c3a30, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ReturnedToPool, addr 0x31c3a40, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c3f84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
