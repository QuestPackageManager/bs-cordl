...
/// @brief Method ApplyBasicFields, addr 0x3191288, size 0xb8, virtual true, abstract: false, final false
inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method ApplyTime, addr 0x319124c, size 0x3c, virtual true, abstract: false, final false
inline void ApplyTime(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method EventRequiresAnalyticsID, addr 0x3191228, size 0x8, virtual true, abstract: false, final false
inline bool EventRequiresAnalyticsID() ;

/// @brief Method GetIDType, addr 0x3191220, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ReturnedToPool, addr 0x3191230, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3191770, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static constexpr uint32_t  __IL2CPP_TYPE_DEFINITION_INDEX{22981};
