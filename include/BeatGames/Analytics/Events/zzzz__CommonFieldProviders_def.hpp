...
/// @brief Method get_DeviceType, addr 0x31916f8, size 0x78, virtual false, abstract: false, final false
static inline ::StringW get_DeviceType() ;

/// @brief Method get_RuntimePlatform, addr 0x3191340, size 0xd0, virtual false, abstract: false, final false
static inline ::StringW get_RuntimePlatform() ;

/// @brief Method get_VROSMajorVersion, addr 0x3191410, size 0x2e8, virtual false, abstract: false, final false
