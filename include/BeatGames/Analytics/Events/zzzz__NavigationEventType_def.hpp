...
/// @brief Method ToString, addr 0x31c5214, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31c512c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  value) ;

/// @brief Method get_CancelDrag, addr 0x31c51ac, size 0x68, virtual false, abstract: false, final false
static inline ::BeatGames::Analytics::Events::NavigationEventType* get_CancelDrag() ;

/// @brief Method get_Click, addr 0x31c46e8, size 0x68, virtual false, abstract: false, final false
static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Click() ;

/// @brief Method get_Drag, addr 0x31c5144, size 0x68, virtual false, abstract: false, final false
static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Drag() ;

/// @brief Method get_Impression, addr 0x31c4580, size 0x68, virtual false, abstract: false, final false
static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Impression() ;

/// @brief Method get_Value, addr 0x31c5134, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x31c513c, size 0x8, virtual false, abstract: false, final false
