...
// Write type traits
MARK_REF_T(::BeatGames::Analytics::Events::NavigationEventType*);
DEFINE_IL2CPP_CLASS(::BeatGames::Analytics::Events::NavigationEventType*, "BeatGames.Analytics.Events", "NavigationEventType");
...
public:
  ...
  /// @brief Method ToString, addr 0x325824c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3258164, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_CancelDrag, addr 0x32581e4, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_CancelDrag();

  /// @brief Method get_Click, addr 0x3257720, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Click();

  /// @brief Method get_Drag, addr 0x325817c, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Drag();

  /// @brief Method get_Impression, addr 0x32575b8, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Impression();

  /// @brief Method get_Value, addr 0x325816c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x3258174, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatGames::Analytics::Events::NavigationEventType) == 0x18, "Size mismatch!");
