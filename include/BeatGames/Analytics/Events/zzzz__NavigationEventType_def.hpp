...
public:
  ...
  /// @brief Method ToString, addr 0x316208c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3161fa4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_CancelDrag, addr 0x3162024, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_CancelDrag();

  /// @brief Method get_Click, addr 0x3161570, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Click();

  /// @brief Method get_Drag, addr 0x3161fbc, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Drag();

  /// @brief Method get_Impression, addr 0x316140c, size 0x68, virtual false, abstract: false, final false
  static inline ::BeatGames::Analytics::Events::NavigationEventType* get_Impression();

  /// @brief Method get_Value, addr 0x3161fac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x3161fb4, size 0x8, virtual false, abstract: false, final false
