...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatGames::Analytics::Events::NavigationEvent::*)(::StringW, ::StringW, ::StringW, ::StringW)>(&::BeatGames::Analytics::Events::NavigationEvent::SetEventData)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x31910bc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatGames::Analytics::Events::NavigationEvent*>::get(),
                        "SetEventData",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatGames::Analytics::Events::NavigationEvent::*)()>(&::BeatGames::Analytics::Events::NavigationEvent::_ctor)> {
  constexpr static std::size_t size = 0x88;
  constexpr static std::size_t addrs = 0x3191aa0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatGames::Analytics::Events::NavigationEvent::*)()>(&::BeatGames::Analytics::Events::NavigationEvent::ReturnedToPool)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x3191b28;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatGames::Analytics::Events::NavigationEvent::*)()>(&::BeatGames::Analytics::Events::NavigationEvent::ReturnEventToPool)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x3191b78;
