...
public:
  ...
  /// @brief Method ApplyBasicFields, addr 0x31c46b0, size 0xf0, virtual true, abstract: false, final false
  inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager* manager);

  /// @brief Method ApplyTime, addr 0x31c4640, size 0x70, virtual true, abstract: false, final false
  inline void ApplyTime(::OSCE::Analytics::AnalyticsManager* manager, int32_t timestamp);

  /// @brief Method GetIDType, addr 0x31c4638, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IDType GetIDType();

  static inline ::BeatGames::Analytics::Events::TelemetryEvent* New_ctor();

  /// @brief Method ReturnEventToPool, addr 0x31c47a0, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c4814, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
