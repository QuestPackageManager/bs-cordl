...
/// @brief Method ApplyBasicFields, addr 0x3191e8c, size 0xf0, virtual true, abstract: false, final false
inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method ApplyTime, addr 0x3191e20, size 0x6c, virtual true, abstract: false, final false
inline void ApplyTime(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method GetIDType, addr 0x3191e18, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::IDType GetIDType() ;

static inline ::BeatGames::Analytics::Events::TelemetryEvent* New_ctor() ;

/// @brief Method ReturnEventToPool, addr 0x3191f7c, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3191ff0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
