...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TelemetryEventSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TelemetryEventSender(TelemetryEventSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TelemetryEventSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TelemetryEventSender(TelemetryEventSenderconst&) = delete;
