...
public:
  ...
  /// @brief Method SendTelemetryEvent, addr 0x31c4120, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c3768, size 0x8, virtual false, abstract: false, final false
