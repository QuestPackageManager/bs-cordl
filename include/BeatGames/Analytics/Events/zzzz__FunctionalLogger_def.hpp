...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FunctionalLogger", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FunctionalLogger(FunctionalLogger&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FunctionalLogger", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FunctionalLogger(FunctionalLoggerconst&) = delete;
