...
public:
  ...
  /// @brief Method GetIDType, addr 0x31c4560, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IDType GetIDType();

  static inline ::BeatGames::Analytics::Events::SessionEvent* New_ctor();

  /// @brief Method ReturnEventToPool, addr 0x31c4568, size 0x74, virtual true, abstract: false, final false
  inline void ReturnEventToPool();

  /// @brief Method ReturnedToPool, addr 0x31c45dc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c44fc, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
