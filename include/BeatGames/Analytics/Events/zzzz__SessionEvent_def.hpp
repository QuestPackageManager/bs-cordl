...
public:
  ...
  /// @brief Method GetIDType, addr 0x3258878, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IDType GetIDType();

  static inline ::BeatGames::Analytics::Events::SessionEvent* New_ctor();

  /// @brief Method ReturnEventToPool, addr 0x3258880, size 0x74, virtual true, abstract: false, final false
  inline void ReturnEventToPool();

  /// @brief Method ReturnedToPool, addr 0x32588f4, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3258814, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SessionEvent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SessionEvent(SessionEvent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SessionEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SessionEvent(SessionEventconst&) = delete;
