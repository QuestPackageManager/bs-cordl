...
/// @brief Method SendButtonClick, addr 0x31910c8, size 0xf0, virtual false, abstract: false, final false
inline void SendButtonClick(::StringW  buttonID, ::StringW  screenID) ;

/// @brief Method SendScreenImpression, addr 0x3190f68, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3190f50, size 0x8, virtual false, abstract: false, final false
...
} // namespace end def BeatGames::Analytics
