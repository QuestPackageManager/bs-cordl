...
public:
  ...
  /// @brief Method SendButtonClick, addr 0x31c38d4, size 0xf4, virtual false, abstract: false, final false
  inline void SendButtonClick(::StringW buttonID, ::StringW screenID);

  /// @brief Method SendScreenImpression, addr 0x31c3770, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c3758, size 0x8, virtual false, abstract: false, final false
