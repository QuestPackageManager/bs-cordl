...
// Write type traits
MARK_REF_T(::BeatGames::Analytics::NavigationEventSender*);
DEFINE_IL2CPP_CLASS(::BeatGames::Analytics::NavigationEventSender*, "BeatGames.Analytics", "NavigationEventSender");
...
public:
  ...
  /// @brief Method SendButtonClick, addr 0x3257bec, size 0xf4, virtual false, abstract: false, final false
  inline void SendButtonClick(::StringW buttonID, ::StringW screenID);

  /// @brief Method SendScreenImpression, addr 0x3257a88, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3257a70, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NavigationEventSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NavigationEventSender(NavigationEventSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NavigationEventSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NavigationEventSender(NavigationEventSenderconst&) = delete;
...
static_assert(sizeof(::BeatGames::Analytics::NavigationEventSender) == 0x18, "Size mismatch!");
