...
public:
  ...
  /// @brief Method .ctor, addr 0x31c35e0, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::OSCE::Analytics::AnalyticsManager* analyticsManager, ::StringW oculusAuthToken);

  /// @brief Method get_Navigation, addr 0x31c35c8, size 0x8, virtual false, abstract: false, final false
  inline ::BeatGames::Analytics::NavigationEventSender* get_Navigation();

  /// @brief Method get_Session, addr 0x31c35d0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatGames::Analytics::Events::SessionEventSender* get_Session();

  /// @brief Method get_Telemetry, addr 0x31c35d8, size 0x8, virtual false, abstract: false, final false
