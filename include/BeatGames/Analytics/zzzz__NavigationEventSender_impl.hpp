...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatGames::Analytics::NavigationEventSender::*)(::OSCE::Analytics::AnalyticsManager*)>(&::BeatGames::Analytics::NavigationEventSender::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3190f50;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatGames::Analytics::NavigationEventSender*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatGames::Analytics::NavigationEventSender::*)(::StringW)>(&::BeatGames::Analytics::NavigationEventSender::SendScreenImpression)> {
  constexpr static std::size_t size = 0xec;
  constexpr static std::size_t addrs = 0x3190f68;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatGames::Analytics::NavigationEventSender*>::get(),
                        "SendScreenImpression",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatGames::Analytics::NavigationEventSender::*)(::StringW, ::StringW)>(&::BeatGames::Analytics::NavigationEventSender::SendButtonClick)> {
  constexpr static std::size_t size = 0xf0;
  constexpr static std::size_t addrs = 0x31910c8;
