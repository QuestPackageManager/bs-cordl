...
public:
  ...
  /// @brief Method GetSecondsSinceEpoch, addr 0x5f34d00, size 0x10c, virtual false, abstract: false, final false
  static inline int32_t GetSecondsSinceEpoch();

  /// @brief Method UnixTimestampToUniversalDateTime, addr 0x5f34e0c, size 0xa0, virtual false, abstract: false, final false
