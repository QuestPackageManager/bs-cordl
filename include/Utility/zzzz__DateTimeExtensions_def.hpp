...
public:
  ...
  /// @brief Method GetSecondsSinceEpoch, addr 0x5dfae64, size 0x10c, virtual false, abstract: false, final false
  static inline int32_t GetSecondsSinceEpoch();

  /// @brief Method UnixTimestampToUniversalDateTime, addr 0x5dfaf70, size 0xa0, virtual false, abstract: false, final false
