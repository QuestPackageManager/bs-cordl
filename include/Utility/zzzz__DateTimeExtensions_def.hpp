...
/// @brief Method GetSecondsSinceEpoch, addr 0x5d88e7c, size 0x10c, virtual false, abstract: false, final false
static inline int32_t GetSecondsSinceEpoch() ;

/// @brief Method UnixTimestampToUniversalDateTime, addr 0x5d88f88, size 0xa0, virtual false, abstract: false, final false
