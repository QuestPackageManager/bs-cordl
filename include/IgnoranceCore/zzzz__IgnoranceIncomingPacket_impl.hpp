...
// Ctor Parameters [CppParam { name: "Channel", ty: "uint8_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "NativePeerId", ty: "uint32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "Payload", ty: "::ENet::Packet", modifiers: "", def_value: Some("{}"), comment: None }]
