...
// Write type traits
MARK_REF_T(::IgnoranceCore::IgnoranceClient*);
MARK_VAL_T(::IgnoranceCore::IgnoranceClient_ThreadParamInfo);
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceClient*, "IgnoranceCore", "IgnoranceClient");
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceClient_ThreadParamInfo, "IgnoranceCore", "IgnoranceClient/ThreadParamInfo");
// Dependencies
namespace IgnoranceCore {
// Is value type: true
...
static_assert(sizeof(::IgnoranceCore::IgnoranceClient_ThreadParamInfo) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method SetupRingBuffersIfNull, addr 0x58986c4, size 0x258, virtual false, abstract: false, final false
  inline void SetupRingBuffersIfNull();

  /// @brief Method Start, addr 0x58982f4, size 0x3d0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Stop, addr 0x589891c, size 0x98, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method ThreadWorker, addr 0x58989b4, size 0xfcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5899980, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsAlive, addr 0x58982e0, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::IgnoranceCore::IgnoranceClient) == 0x88, "Size mismatch!");
