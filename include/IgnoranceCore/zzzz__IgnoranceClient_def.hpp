...
constexpr IgnoranceClient_ThreadParamInfo(int32_t  Channels, int32_t  PollTime, int32_t  Port, int32_t  PacketSizeLimit, int32_t  Verbosity, ::StringW  Address, bool  UseSsl, bool  ValidateCertificate, ::StringW  RootCertificatePath, ::StringW  RootCertificate) noexcept;
...
/// @brief Field ConnectionEvents, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_ConnectionEvents, put=__cordl_internal_set_ConnectionEvents)) ::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceConnectionEvent>*  ConnectionEvents;

/// @brief Field DisconnectionEvents, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_DisconnectionEvents, put=__cordl_internal_set_DisconnectionEvents)) ::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceConnectionEvent>*  DisconnectionEvents;
...
/// @brief Method SetupRingBuffersIfNull, addr 0x5750dc4, size 0x258, virtual false, abstract: false, final false
inline void SetupRingBuffersIfNull() ;

/// @brief Method Start, addr 0x57509f4, size 0x3d0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x575101c, size 0x98, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method ThreadWorker, addr 0x57510b4, size 0xfcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5752080, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsAlive, addr 0x57509e0, size 0x14, virtual false, abstract: false, final false
...
/// @brief IL2CPP Metadata Type Index
static constexpr uint32_t  __IL2CPP_TYPE_DEFINITION_INDEX{21564};
