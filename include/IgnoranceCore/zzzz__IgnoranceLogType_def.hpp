...
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceLogType, "IgnoranceCore", "IgnoranceLogType");
// Dependencies
namespace IgnoranceCore {
// Is value type: true
...
static_assert(sizeof(::IgnoranceCore::IgnoranceLogType) == 0x4, "Size mismatch!");
