...
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceCommandType, "IgnoranceCore", "IgnoranceCommandType");
// Dependencies
namespace IgnoranceCore {
// Is value type: true
...
static_assert(sizeof(::IgnoranceCore::IgnoranceCommandType) == 0x4, "Size mismatch!");
