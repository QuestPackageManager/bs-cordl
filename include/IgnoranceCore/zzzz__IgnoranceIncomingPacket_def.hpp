...
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceIncomingPacket, "IgnoranceCore", "IgnoranceIncomingPacket");
// Dependencies ENet.Packet
namespace IgnoranceCore {
// Is value type: true
...
static_assert(sizeof(::IgnoranceCore::IgnoranceIncomingPacket) == 0x10, "Size mismatch!");
