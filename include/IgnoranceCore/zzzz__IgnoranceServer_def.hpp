...
constexpr IgnoranceServer_ThreadParamInfo(bool  IsFruityDevice, bool  BindAllInterfaces, int32_t  Channels, int32_t  Peers, int32_t  PollTime, int32_t  Port, int32_t  PacketSizeLimit, int32_t  Verbosity, ::StringW  Address, bool  UseSsl, ::StringW  CertificatePath, ::StringW  Certificate, ::StringW  PrivateKeyPath, ::StringW  PrivateKey) noexcept;
...
/// @brief Method SetupRingBuffersIfNull, addr 0x56e2da4, size 0x258, virtual false, abstract: false, final false
inline void SetupRingBuffersIfNull() ;

/// @brief Method Start, addr 0x56e29b4, size 0x3f0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x56e2ffc, size 0xa4, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method ThreadWorker, addr 0x56e30a0, size 0x1494, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56e4534, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsAlive, addr 0x56e29a0, size 0x14, virtual false, abstract: false, final false
