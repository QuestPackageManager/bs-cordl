...
DEFINE_IL2CPP_CLASS(::IgnoranceCore::PeerConnectionData, "IgnoranceCore", "PeerConnectionData");
// Dependencies
namespace IgnoranceCore {
// Is value type: true
...
static_assert(sizeof(::IgnoranceCore::PeerConnectionData) == 0x10, "Size mismatch!");
