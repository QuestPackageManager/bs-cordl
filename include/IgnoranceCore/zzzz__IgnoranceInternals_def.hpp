...
// Write type traits
MARK_REF_T(::IgnoranceCore::IgnoranceInternals*);
DEFINE_IL2CPP_CLASS(::IgnoranceCore::IgnoranceInternals*, "IgnoranceCore", "IgnoranceInternals");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58994ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::IgnoranceCore::IgnoranceInternals) == 0x10, "Size mismatch!");
