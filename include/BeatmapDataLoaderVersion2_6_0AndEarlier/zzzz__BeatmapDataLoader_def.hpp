...
public:
  // Declarations
  /// @brief Method Convert, addr 0x14ff394, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ff374, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Convert, addr 0x14ff490, size 0x10c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ObstacleData* Convert(::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData* o);

  /// @brief Method GetHeightForObstacleType, addr 0x14ffd68, size 0x14, virtual false, abstract: false, final false
  static inline int32_t GetHeightForObstacleType(::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType obstacleType);

  /// @brief Method GetLayerForObstacleType, addr 0x14ffd58, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ff37c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IBeatToTimeConverter* bpmTimeProcessor);
...
public:
  // Declarations
  /// @brief Method Convert, addr 0x14ff59c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ff384, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IBeatToTimeConverter* bpmTimeProcessor);
...
public:
  // Declarations
  /// @brief Method Convert, addr 0x14ff66c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ff38c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IBeatToTimeConverter* bpmTimeProcessor);
...
public:
  ...
  /// @brief Method Convert, addr 0x14ffae8, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnRotationForEventValue, addr 0x14ffde0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ffab8, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IsEventValid, addr 0x14ffd7c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ff7cc, size 0x2ec, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GetBeatmapDataFromSaveDataJsonAsync>b__0, addr 0x14fff2c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fe124, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetBeatmapDataBasicInfoFromSaveDataJsonAsync>b__0, addr 0x14fff48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fe21c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetBeatmapDataBasicInfoFromSaveDataJson>b__3_0, addr 0x14fffbc, size 0x20, virtual false, abstract: false, final false
  inline bool _GetBeatmapDataBasicInfoFromSaveDataJson_b__3_0(::BeatmapSaveDataVersion2_6_0AndEarlier::NoteData* note);

  /// @brief Method .ctor, addr 0x14fffb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BeatmapSaveDataAreSorted, addr 0x14ff1ac, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertBeatmapSaveDataPreV2_5_0Inline, addr 0x14ff19c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBeatmapDataBasicInfoFromSaveDataJson, addr 0x14fe224, size 0x1b8, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::BeatmapDataBasicInfo* GetBeatmapDataBasicInfoFromSaveDataJson(::StringW beatmapSaveDataJson);

  /// @brief Method GetBeatmapDataBasicInfoFromSaveDataJsonAsync, addr 0x14fe12c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBeatmapDataFromSaveData, addr 0x14fe6b4, size 0xae8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBeatmapDataFromSaveDataJson, addr 0x14fe3dc, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBeatmapDataFromSaveDataJsonAsync, addr 0x14fdff0, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ffd50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
