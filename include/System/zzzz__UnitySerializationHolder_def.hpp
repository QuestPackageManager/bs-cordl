...
// Write type traits
MARK_REF_T(::System::UnitySerializationHolder*);
DEFINE_IL2CPP_CLASS(::System::UnitySerializationHolder*, "System", "UnitySerializationHolder");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_elementTypes, put = __cordl_internal_set_m_elementTypes)) ::ArrayW<int32_t> m_elementTypes;
  ...
  __declspec(property(get = __cordl_internal_get_m_instantiation, put = __cordl_internal_set_m_instantiation)) ::ArrayW<::System::Type*> m_instantiation;
  ...
  /// @brief Method AddElementTypes, addr 0x5c8ad00, size 0x3f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObjectData, addr 0x5c8bd08, size 0x50, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetRealObject, addr 0x5c8bd58, size 0x544, virtual true, abstract: false, final false
  inline ::System::Object* GetRealObject(::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetUnitySerializationInfo, addr 0x5c8b314, size 0x384, virtual false, abstract: false, final false
  static inline void GetUnitySerializationInfo(::System::Runtime::Serialization::SerializationInfo* info, ::System::RuntimeType* type);

  /// @brief Method GetUnitySerializationInfo, addr 0x5c8b1e8, size 0x12c, virtual false, abstract: false, final false
  static inline void GetUnitySerializationInfo(::System::Runtime::Serialization::SerializationInfo* info, int32_t unityType);

  /// @brief Method GetUnitySerializationInfo, addr 0x5c8b698, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeElementTypes, addr 0x5c8b0f8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowInsufficientInformation, addr 0x5c8bc00, size 0x94, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_elementTypes() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_elementTypes();
  ...
  constexpr ::ArrayW<::System::Type*> const& __cordl_internal_get_m_instantiation() const;

  constexpr ::ArrayW<::System::Type*>& __cordl_internal_get_m_instantiation();
  ...
  constexpr void __cordl_internal_set_m_elementTypes(::ArrayW<int32_t> value);

  constexpr void __cordl_internal_set_m_genericParameterPosition(int32_t value);

  constexpr void __cordl_internal_set_m_instantiation(::ArrayW<::System::Type*> value);

  constexpr void __cordl_internal_set_m_unityType(int32_t value);

  /// @brief Method .ctor, addr 0x5c8b804, size 0x3fc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnitySerializationHolder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnitySerializationHolder(UnitySerializationHolder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnitySerializationHolder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnitySerializationHolder(UnitySerializationHolderconst&) = delete;
  ...
  ::ArrayW<::System::Type*> ___m_instantiation;

  /// @brief Field m_elementTypes, offset: 0x18, size: 0x8, def value: None
  ::ArrayW<int32_t> ___m_elementTypes;
...
static_assert(sizeof(::System::UnitySerializationHolder) == 0x50, "Size mismatch!");
