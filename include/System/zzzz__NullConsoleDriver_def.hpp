...
public:
  ...
  /// @brief Method ReadKey, addr 0x5b59cb4, size 0x60, virtual true, abstract: false, final true
  inline ::System::ConsoleKeyInfo ReadKey(bool intercept);

  /// @brief Method .ctor, addr 0x5b52908, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
