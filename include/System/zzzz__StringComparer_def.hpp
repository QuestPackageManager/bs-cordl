...
public:
  ...
  /// @brief Method Compare, addr 0x3d8afc0, size 0x18c, virtual true, abstract: false, final true
  inline int32_t Compare(::System::Object* x, ::System::Object* y);

  /// @brief Method Create, addr 0x3d8aecc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x3d8b14c, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x3d8b214, size 0xc4, virtual true, abstract: false, final true
  inline int32_t GetHashCode(::System::Object* obj);

  static inline ::System::StringComparer* New_ctor();

  /// @brief Method .ctor, addr 0x3d8b2d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_InvariantCultureIgnoreCase, addr 0x3d8adc4, size 0x58, virtual false, abstract: false, final false
  static inline ::System::StringComparer* get_InvariantCultureIgnoreCase();

  /// @brief Method get_Ordinal, addr 0x3d8ae1c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::StringComparer* get_Ordinal();

  /// @brief Method get_OrdinalIgnoreCase, addr 0x3d8ae74, size 0x58, virtual false, abstract: false, final false
