...
public:
  ...
  /// @brief Method Compare, addr 0x5b20054, size 0x180, virtual true, abstract: false, final true
  inline int32_t Compare(::System::Object* x, ::System::Object* y);

  /// @brief Method Create, addr 0x5b1ff44, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x5b201d4, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x5b20234, size 0x80, virtual true, abstract: false, final true
  inline int32_t GetHashCode(::System::Object* obj);

  static inline ::System::StringComparer* New_ctor();

  /// @brief Method .ctor, addr 0x5b202b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_InvariantCultureIgnoreCase, addr 0x5b1fe30, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::StringComparer* get_InvariantCultureIgnoreCase();

  /// @brief Method get_Ordinal, addr 0x5b1fe8c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::StringComparer* get_Ordinal();

  /// @brief Method get_OrdinalIgnoreCase, addr 0x5b1fee8, size 0x5c, virtual false, abstract: false, final false
