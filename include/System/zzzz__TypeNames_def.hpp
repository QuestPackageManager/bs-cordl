...
public:
  ...
  /// @brief Method Equals addr 0x24ab7a0 size 0xd0 virtual true final true
  inline bool Equals(::System::TypeName* other);

  /// @brief Method GetHashCode addr 0x24ab870 size 0x28 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x24ab898 size 0x60 virtual true final false
  inline bool Equals(::System::Object* other);

  static inline ::System::__TypeNames__ATypeName* New_ctor();

  /// @brief Method .ctor addr 0x24ab8f8 size 0x4 virtual false final false
  inline void _ctor();
