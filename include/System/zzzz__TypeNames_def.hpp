...
public:
  ...
  /// @brief Method Equals, addr 0x5a87dc8, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x5a87cc4, size 0xdc, virtual true, abstract: false, final true
  inline bool Equals(::System::TypeName* other);

  /// @brief Method GetHashCode, addr 0x5a87da0, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::TypeNames_ATypeName* New_ctor();

  /// @brief Method .ctor, addr 0x5a87e2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
