...
public:
  ...
  /// @brief Method Equals, addr 0x3e42b08, size 0x60, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x3e42a10, size 0xd0, virtual true, abstract: false, final true
  inline bool Equals(::System::TypeName* other);

  /// @brief Method GetHashCode, addr 0x3e42ae0, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::TypeNames_ATypeName* New_ctor();

  /// @brief Method .ctor, addr 0x3e42b68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
