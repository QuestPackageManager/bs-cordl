...
template <typename T1, typename T2, typename TResult> inline void System::Func_3<T1, T2, TResult>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Func_3<T1, T2, TResult>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
