...
public:
  // Declarations
  /// @brief Method AddNumber, addr 0x26f91dc, size 0x18, virtual false, abstract: false, final false
  inline void AddNumber(int32_t value);

  /// @brief Method GetNumber, addr 0x26f91f4, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetNumber(int32_t index);

  /// @brief Method Init, addr 0x26f91bc, size 0x20, virtual false, abstract: false, final false
