...
public:
  // Declarations
  /// @brief Method AddNumber, addr 0x2826af0, size 0x18, virtual false, abstract: false, final false
  inline void AddNumber(int32_t value);

  /// @brief Method GetNumber, addr 0x2826b08, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetNumber(int32_t index);

  /// @brief Method Init, addr 0x2826ad0, size 0x20, virtual false, abstract: false, final false
