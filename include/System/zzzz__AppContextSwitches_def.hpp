...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AppContextSwitches", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AppContextSwitches(AppContextSwitches&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AppContextSwitches", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AppContextSwitches(AppContextSwitchesconst&) = delete;
