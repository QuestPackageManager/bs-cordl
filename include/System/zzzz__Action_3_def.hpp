...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Action_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Action_3, "System", "Action`3");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Action_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Action_3(Action_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Action_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Action_3(Action_3const&) = delete;
