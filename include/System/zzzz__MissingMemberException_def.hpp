...
public:
  ...
  /// @brief Method FormatSignature, addr 0x3e1b360, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW FormatSignature(::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method GetObjectData, addr 0x3e1b204, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e1ade4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e1ae44, size 0x184, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x3e1ad74, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_Message, addr 0x3e1b0dc, size 0x128, virtual true, abstract: false, final false
