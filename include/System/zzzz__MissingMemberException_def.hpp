...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissingMemberException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MissingMemberException(MissingMemberException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MissingMemberException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MissingMemberException(MissingMemberExceptionconst&) = delete;
