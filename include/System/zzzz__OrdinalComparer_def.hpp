...
/// @brief Method Compare, addr 0x5aaea68, size 0x64, virtual true, abstract: false, final false
inline int32_t Compare(::StringW  x, ::StringW  y) ;

/// @brief Method Equals, addr 0x5aaebe8, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x5aaeacc, size 0x84, virtual true, abstract: false, final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x5aaec80, size 0x68, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHashCode, addr 0x5aaeb50, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5aaea00, size 0x68, virtual false, abstract: false, final false
