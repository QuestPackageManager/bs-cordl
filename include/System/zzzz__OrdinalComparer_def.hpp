...
public:
  ...
  /// @brief Method Compare, addr 0x3e06064, size 0x58, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW x, ::StringW y);

  /// @brief Method Equals, addr 0x3e061c4, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3e060bc, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x3e0625c, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x3e0613c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e05ff4, size 0x70, virtual false, abstract: false, final false
