...
public:
  ...
  /// @brief Method Compare, addr 0x3e0ef68, size 0x58, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW x, ::StringW y);

  /// @brief Method Equals, addr 0x3e0f0c8, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3e0efc0, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x3e0f160, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x3e0f040, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e0eef8, size 0x70, virtual false, abstract: false, final false
