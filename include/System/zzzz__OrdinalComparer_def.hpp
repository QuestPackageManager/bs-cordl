...
public:
  ...
  /// @brief Method Compare, addr 0x5b20a50, size 0x64, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW x, ::StringW y);

  /// @brief Method Equals, addr 0x5b20bd0, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5b20ab4, size 0x84, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x5b20c68, size 0x68, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x5b20b38, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b209e8, size 0x68, virtual false, abstract: false, final false
