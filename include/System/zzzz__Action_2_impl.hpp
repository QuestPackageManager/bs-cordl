...
template <typename T1, typename T2> inline void System::Action_2<T1, T2>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Action_2<T1, T2>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
