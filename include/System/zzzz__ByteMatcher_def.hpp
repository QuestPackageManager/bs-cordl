...
public:
  ...
  /// @brief Method AddMapping, addr 0x288b5a4, size 0x120, virtual false, abstract: false, final false
  inline void AddMapping(::System::TermInfoStrings key, ::ArrayW<uint8_t, ::Array<uint8_t>*> val);

  /// @brief Method Match, addr 0x2888650, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sort, addr 0x288b6c4, size 0x4, virtual false, abstract: false, final false
  inline void Sort();

  /// @brief Method StartsWith, addr 0x28885c8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x288b4dc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
