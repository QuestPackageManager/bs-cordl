...
public:
  ...
  /// @brief Method AddMapping, addr 0x5b5f554, size 0x104, virtual false, abstract: false, final false
  inline void AddMapping(::System::TermInfoStrings key, ::ArrayW<uint8_t, ::Array<uint8_t>*> val);

  /// @brief Method Match, addr 0x5b5cf04, size 0x46c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sort, addr 0x5b5f658, size 0x4, virtual false, abstract: false, final false
  inline void Sort();

  /// @brief Method StartsWith, addr 0x5b5ceb0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b5f48c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
