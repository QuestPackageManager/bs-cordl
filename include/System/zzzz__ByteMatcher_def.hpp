...
public:
  ...
  /// @brief Method AddMapping, addr 0x5c9ada4, size 0x104, virtual false, abstract: false, final false
  inline void AddMapping(::System::TermInfoStrings key, ::ArrayW<uint8_t> val);

  /// @brief Method Match, addr 0x5c98754, size 0x46c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sort, addr 0x5c9aea8, size 0x4, virtual false, abstract: false, final false
  inline void Sort();

  /// @brief Method StartsWith, addr 0x5c98700, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9acdc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
