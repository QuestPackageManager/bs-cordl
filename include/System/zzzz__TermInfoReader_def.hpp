...
/// @brief Method DetermineVersion, addr 0x5aee8fc, size 0x9c, virtual false, abstract: false, final false
inline void DetermineVersion(int16_t  magic) ;

/// @brief Method Get, addr 0x5aea098, size 0x84, virtual false, abstract: false, final false
inline ::StringW Get(::System::TermInfoStrings  tstr) ;

/// @brief Method Get, addr 0x5aea11c, size 0x50, virtual false, abstract: false, final false
inline int32_t Get(::System::TermInfoNumbers  number) ;

/// @brief Method GetInt16, addr 0x5aee998, size 0x4c, virtual false, abstract: false, final false
inline int16_t GetInt16(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method GetString, addr 0x5aee9e4, size 0x7c, virtual false, abstract: false, final false
inline ::StringW GetString(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method GetStringBytes, addr 0x5aeea60, size 0xbc, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetStringBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method GetStringBytes, addr 0x5aed674, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method ReadHeader, addr 0x5aee808, size 0xc0, virtual false, abstract: false, final false
inline void ReadHeader(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, ::ByRef<int32_t>  position) ;

/// @brief Method ReadNames, addr 0x5aee8c8, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ae9814, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  term, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method .ctor, addr 0x5ae9580, size 0x294, virtual false, abstract: false, final false
