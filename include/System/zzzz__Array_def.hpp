...
public:
  ...
  /// @brief Method .ctor addr 0x25d5cc8 size 0x48 virtual false final false
  inline void _ctor(::System::Array* array);

  /// @brief Method MoveNext addr 0x25d5d10 size 0x28 virtual true final true
  inline bool MoveNext();

  /// @brief Method Reset addr 0x25d5d38 size 0xc virtual true final true
  inline void Reset();

  /// @brief Method Clone addr 0x25d5d44 size 0x8 virtual true final true
  inline ::System::Object* Clone();

  /// @brief Method get_Current addr 0x25d5d4c size 0x118 virtual true final true
...
public:
  // Declarations
  /// @brief Method .ctor addr 0x25d5e64 size 0x7c virtual false final false
  ...
  /// @brief Method SwapIfGreaterWithItems addr 0x25d5ee0 size 0x230 virtual false final false
  inline void SwapIfGreaterWithItems(int32_t a, int32_t b);

  /// @brief Method Swap addr 0x25d6110 size 0x164 virtual false final false
  inline void Swap(int32_t i, int32_t j);

  /// @brief Method Sort addr 0x25d6274 size 0x4 virtual false final false
  inline void Sort(int32_t left, int32_t length);

  /// @brief Method IntrospectiveSort addr 0x25d6278 size 0x150 virtual false final false
  inline void IntrospectiveSort(int32_t left, int32_t length);

  /// @brief Method IntroSort addr 0x25d63c8 size 0x114 virtual false final false
  inline void IntroSort(int32_t lo, int32_t hi, int32_t depthLimit);

  /// @brief Method PickPivotAndPartition addr 0x25d6818 size 0x22c virtual false final false
  inline int32_t PickPivotAndPartition(int32_t lo, int32_t hi);

  /// @brief Method Heapsort addr 0x25d6778 size 0xa0 virtual false final false
  inline void Heapsort(int32_t lo, int32_t hi);

  /// @brief Method DownHeap addr 0x25d6a44 size 0x35c virtual false final false
  inline void DownHeap(int32_t i, int32_t n, int32_t lo);

  /// @brief Method InsertionSort addr 0x25d64dc size 0x29c virtual false final false
...
public:
  // Declarations
  /// @brief Method .ctor addr 0x25d6da0 size 0x7c virtual false final false
  inline void _ctor(::System::Array* keys, ::System::Array* items, ::System::Collections::IComparer* comparer);

  /// @brief Method SwapIfGreaterWithItems addr 0x25d6e1c size 0x1d0 virtual false final false
  inline void SwapIfGreaterWithItems(int32_t a, int32_t b);

  /// @brief Method Swap addr 0x25d6fec size 0xec virtual false final false
  inline void Swap(int32_t i, int32_t j);

  /// @brief Method Sort addr 0x25d70d8 size 0x4 virtual false final false
  inline void Sort(int32_t left, int32_t length);

  /// @brief Method IntrospectiveSort addr 0x25d70dc size 0x158 virtual false final false
  inline void IntrospectiveSort(int32_t left, int32_t length);

  /// @brief Method IntroSort addr 0x25d7234 size 0x114 virtual false final false
  inline void IntroSort(int32_t lo, int32_t hi, int32_t depthLimit);

  /// @brief Method PickPivotAndPartition addr 0x25d75d0 size 0x21c virtual false final false
  inline int32_t PickPivotAndPartition(int32_t lo, int32_t hi);

  /// @brief Method Heapsort addr 0x25d7530 size 0xa0 virtual false final false
  inline void Heapsort(int32_t lo, int32_t hi);

  /// @brief Method DownHeap addr 0x25d77ec size 0x2d0 virtual false final false
  inline void DownHeap(int32_t i, int32_t n, int32_t lo);

  /// @brief Method InsertionSort addr 0x25d7348 size 0x1e8 virtual false final false
  inline void InsertionSort(int32_t lo, int32_t hi);
...
public:
  ...
  /// @brief Method CreateInstance addr 0x25d1e5c size 0x184 virtual false final false
  ...
  /// @brief Method System.Collections.ICollection.get_Count addr 0x25d2274 size 0x4 virtual true final true
  inline int32_t System_Collections_ICollection_get_Count();

  /// @brief Method System.Collections.IList.get_IsReadOnly addr 0x25d2278 size 0x8 virtual true final true
  inline bool System_Collections_IList_get_IsReadOnly();

  /// @brief Method System.Collections.IList.get_Item addr 0x25d2280 size 0x4 virtual true final true
  inline ::System::Object* System_Collections_IList_get_Item(int32_t index);

  /// @brief Method System.Collections.IList.set_Item addr 0x25d2284 size 0x10 virtual true final true
  inline void System_Collections_IList_set_Item(int32_t index, ::System::Object* value);

  /// @brief Method System.Collections.IList.Add addr 0x25d2410 size 0x50 virtual true final true
  inline int32_t System_Collections_IList_Add(::System::Object* value);

  /// @brief Method System.Collections.IList.Contains addr 0x25d2460 size 0x18 virtual true final true
  inline bool System_Collections_IList_Contains(::System::Object* value);

  /// @brief Method System.Collections.IList.Clear addr 0x25d2508 size 0x38 virtual true final true
  inline void System_Collections_IList_Clear();

  /// @brief Method System.Collections.IList.IndexOf addr 0x25d266c size 0x4 virtual true final true
  inline int32_t System_Collections_IList_IndexOf(::System::Object* value);

  /// @brief Method System.Collections.IList.Insert addr 0x25d2670 size 0x50 virtual true final true
  inline void System_Collections_IList_Insert(int32_t index, ::System::Object* value);

  /// @brief Method System.Collections.IList.Remove addr 0x25d26c0 size 0x50 virtual true final true
  inline void System_Collections_IList_Remove(::System::Object* value);

  /// @brief Method System.Collections.IList.RemoveAt addr 0x25d2710 size 0x50 virtual true final true
  inline void System_Collections_IList_RemoveAt(int32_t index);

  /// @brief Method CopyTo addr 0x25d2760 size 0xb4 virtual true final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method Clone addr 0x25d2d4c size 0x8 virtual true final true
  inline ::System::Object* Clone();

  /// @brief Method System.Collections.IStructuralComparable.CompareTo addr 0x25d2d54 size 0x1e4 virtual true final true
  ...
  /// @brief Method System.Collections.IStructuralEquatable.Equals addr 0x25d2f38 size 0x190 virtual true final true
  ...
  /// @brief Method CombineHashCodes addr 0x25d30c8 size 0xc virtual false final false
  static inline int32_t CombineHashCodes(int32_t h1, int32_t h2);

  /// @brief Method System.Collections.IStructuralEquatable.GetHashCode addr 0x25d30d4 size 0x174 virtual true final true
  inline int32_t System_Collections_IStructuralEquatable_GetHashCode(::System::Collections::IEqualityComparer* comparer);

  /// @brief Method BinarySearch addr 0x25d3248 size 0x94 virtual false final false
  ...
  /// @brief Method Copy addr 0x25d3784 size 0x74 virtual false final false
  static inline void Copy(::System::Array* sourceArray, ::System::Array* destinationArray, int64_t length);

  /// @brief Method Copy addr 0x25d38c4 size 0xd4 virtual false final false
  ...
  /// @brief Method CopyTo addr 0x25d3998 size 0x74 virtual false final false
  ...
  /// @brief Method get_LongLength addr 0x25d3a0c size 0x64 virtual false final false
  inline int64_t get_LongLength();

  /// @brief Method GetLongLength addr 0x25d3a74 size 0x14 virtual false final false
  inline int64_t GetLongLength(int32_t dimension);

  /// @brief Method GetValue addr 0x25d3a88 size 0x74 virtual false final false
  inline ::System::Object* GetValue(int64_t index);

  /// @brief Method GetValue addr 0x25d3afc size 0xa8 virtual false final false
  inline ::System::Object* GetValue(int64_t index1, int64_t index2);

  /// @brief Method GetValue addr 0x25d3c2c size 0xd4 virtual false final false
  inline ::System::Object* GetValue(int64_t index1, int64_t index2, int64_t index3);

  /// @brief Method GetValue addr 0x25d3da0 size 0x194 virtual false final false
  inline ::System::Object* GetValue(::ArrayW<int64_t, ::Array<int64_t>*> indices);

  /// @brief Method get_IsFixedSize addr 0x25d3f38 size 0x8 virtual true final true
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly addr 0x25d3f40 size 0x8 virtual true final true
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized addr 0x25d3f48 size 0x8 virtual true final true
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot addr 0x25d3f50 size 0x4 virtual true final true
  inline ::System::Object* get_SyncRoot();

  /// @brief Method BinarySearch addr 0x25d3f54 size 0x8 virtual false final false
  static inline int32_t BinarySearch(::System::Array* array, int32_t index, int32_t length, ::System::Object* value);

  /// @brief Method BinarySearch addr 0x25d3f5c size 0xa0 virtual false final false
  static inline int32_t BinarySearch(::System::Array* array, ::System::Object* value, ::System::Collections::IComparer* comparer);

  /// @brief Method BinarySearch addr 0x25d32dc size 0x4a8 virtual false final false
  ...
  /// @brief Method GetMedian addr 0x25d3ffc size 0xc virtual false final false
  ...
  /// @brief Method IndexOf addr 0x25d2478 size 0x90 virtual false final false
  static inline int32_t IndexOf(::System::Array* array, ::System::Object* value);

  /// @brief Method IndexOf addr 0x25d42a8 size 0xa0 virtual false final false
  static inline int32_t IndexOf(::System::Array* array, ::System::Object* value, int32_t startIndex);

  /// @brief Method IndexOf addr 0x25d4008 size 0x2a0 virtual false final false
  ...
  /// @brief Method LastIndexOf addr 0x25d4348 size 0x8c virtual false final false
  static inline int32_t LastIndexOf(::System::Array* array, ::System::Object* value);

  /// @brief Method LastIndexOf addr 0x25d4690 size 0x5c virtual false final false
  static inline int32_t LastIndexOf(::System::Array* array, ::System::Object* value, int32_t startIndex);

  /// @brief Method LastIndexOf addr 0x25d43d4 size 0x2bc virtual false final false
  ...
  /// @brief Method Reverse addr 0x25d46ec size 0x88 virtual false final false
  static inline void Reverse(::System::Array* array);

  /// @brief Method Reverse addr 0x25d4774 size 0x254 virtual false final false
  ...
  /// @brief Method GetEnumerator addr 0x25d5470 size 0x64 virtual true final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  static inline ::System::Array* New_ctor();

  /// @brief Method .ctor addr 0x25d54d4 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method InternalArray__ICollection_get_Count addr 0x25d54dc size 0x4 virtual false final false
  inline int32_t InternalArray__ICollection_get_Count();

  /// @brief Method InternalArray__ICollection_get_IsReadOnly addr 0x25d54e0 size 0x8 virtual false final false
  inline bool InternalArray__ICollection_get_IsReadOnly();

  /// @brief Method GetRawSzArrayData addr 0x25d54e8 size 0x14 virtual false final false
  ...
  /// @brief Method InternalArray__ICollection_Clear addr 0x25d54fc size 0x50 virtual false final false
  ...
  /// @brief Method InternalArray__IReadOnlyCollection_get_Count addr 0x25d554c size 0x4 virtual false final false
  ...
  /// @brief Method InternalArray__RemoveAt addr 0x25d5550 size 0x50 virtual false final false
  ...
  /// @brief Method get_Length addr 0x25c81a0 size 0x60 virtual false final false
  inline int32_t get_Length();

  /// @brief Method get_Rank addr 0x25d2814 size 0x4 virtual false final false
  inline int32_t get_Rank();

  /// @brief Method GetRank addr 0x25d55a0 size 0x4 virtual false final false
  inline int32_t GetRank();

  /// @brief Method GetLength addr 0x25d3a70 size 0x4 virtual false final false
  inline int32_t GetLength(int32_t dimension);

  /// @brief Method GetLowerBound addr 0x25d2540 size 0x4 virtual false final false
  inline int32_t GetLowerBound(int32_t dimension);

  /// @brief Method GetValue addr 0x25d3f34 size 0x4 virtual false final false
  inline ::System::Object* GetValue(::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method SetValue addr 0x25d4e9c size 0x4 virtual false final false
  inline void SetValue(::System::Object* value, ::ArrayW<int32_t, ::Array<int32_t>*> indices);

  /// @brief Method GetValueImpl addr 0x25d55a4 size 0x4 virtual false final false
  inline ::System::Object* GetValueImpl(int32_t pos);

  /// @brief Method SetValueImpl addr 0x25d55a8 size 0x4 virtual false final false
  inline void SetValueImpl(::System::Object* value, int32_t pos);

  /// @brief Method FastCopy addr 0x25d55ac size 0x4 virtual false final false
  static inline bool FastCopy(::System::Array* source, int32_t source_idx, ::System::Array* dest, int32_t dest_idx, int32_t length);

  /// @brief Method CreateInstanceImpl addr 0x25d55b0 size 0x4 virtual false final false
  ...
  /// @brief Method GetUpperBound addr 0x25d55b4 size 0x38 virtual false final false
  inline int32_t GetUpperBound(int32_t dimension);

  /// @brief Method GetValue addr 0x25c8200 size 0x174 virtual false final false
  inline ::System::Object* GetValue(int32_t index);

  /// @brief Method GetValue addr 0x25d3ba4 size 0x88 virtual false final false
  inline ::System::Object* GetValue(int32_t index1, int32_t index2);

  /// @brief Method GetValue addr 0x25d3d00 size 0xa0 virtual false final false
  inline ::System::Object* GetValue(int32_t index1, int32_t index2, int32_t index3);

  /// @brief Method SetValue addr 0x25d2294 size 0x17c virtual false final false
  inline void SetValue(::System::Object* value, int32_t index);

  /// @brief Method SetValue addr 0x25d4ae4 size 0x98 virtual false final false
  inline void SetValue(::System::Object* value, int32_t index1, int32_t index2);

  /// @brief Method SetValue addr 0x25d4c50 size 0xa8 virtual false final false
  inline void SetValue(::System::Object* value, int32_t index1, int32_t index2, int32_t index3);

  /// @brief Method UnsafeCreateInstance addr 0x25d55ec size 0x4 virtual false final false
  ...
  /// @brief Method Clear addr 0x25d2544 size 0x128 virtual false final false
  static inline void Clear(::System::Array* array, int32_t index, int32_t length);

  /// @brief Method ClearInternal addr 0x25d5b8c size 0x4 virtual false final false
  static inline void ClearInternal(::System::Array* a, int32_t index, int32_t count);

  /// @brief Method Copy addr 0x25d37f8 size 0xcc virtual false final false
  static inline void Copy(::System::Array* sourceArray, ::System::Array* destinationArray, int32_t length);

  /// @brief Method Copy addr 0x25d2818 size 0x534 virtual false final false
  ...
  /// @brief Method CreateArrayTypeMismatchException addr 0x25d5b90 size 0x5c virtual false final false
  static inline ::System::ArrayTypeMismatchException* CreateArrayTypeMismatchException();

  /// @brief Method CanAssignArrayElement addr 0x25d5bec size 0xd4 virtual false final false
  static inline bool CanAssignArrayElement(::System::Type* source, ::System::Type* target);

  /// @brief Method ConstrainedCopy addr 0x25d5cc0 size 0x4 virtual false final false
  ...
  /// @brief Method Initialize addr 0x25d5cc4 size 0x4 virtual false final false
  ...
  /// @brief Method SortImpl addr 0x25d5378 size 0xf8 virtual false final false
