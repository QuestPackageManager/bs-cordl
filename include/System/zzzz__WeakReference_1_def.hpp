...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WeakReference_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WeakReference_1(WeakReference_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WeakReference_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WeakReference_1(WeakReference_1const&) = delete;
