...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Action_9", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Action_9(Action_9&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Action_9", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Action_9(Action_9const&) = delete;
