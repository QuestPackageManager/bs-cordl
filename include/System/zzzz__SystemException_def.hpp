...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SystemException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SystemException(SystemException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SystemException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SystemException(SystemExceptionconst&) = delete;
