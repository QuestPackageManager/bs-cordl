...
// Ctor Parameters [CppParam { name: "Size", ty: "::System::Coord", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "CursorPosition", ty: "::System::Coord", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "Attribute", ty: "int16_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Window", ty: "::System::SmallRect",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "MaxWindowSize", ty: "::System::Coord", modifiers: "", def_value: Some("{}"), comment: None }]
