...
/// @brief Method GetObjectData, addr 0x5b4ec44, size 0x1bc, virtual true, abstract: false, final false
...
/// @brief Method SetMessageField, addr 0x5b4e914, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b4e878, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5b4ea48, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::StringW  className, ::StringW  assemblyName) ;

/// @brief Method .ctor, addr 0x5b4ea90, size 0x58, virtual false, abstract: false, final false
inline void _ctor(::StringW  className, ::StringW  assemblyName, ::StringW  messageArg, int32_t  resourceId) ;

/// @brief Method .ctor, addr 0x5b4eae8, size 0x15c, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x5b4e8d8, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method get_Message, addr 0x5b4e8fc, size 0x18, virtual true, abstract: false, final false
