...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2874bfc, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetMessageField, addr 0x2874958, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28748b8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2874a48, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::StringW assemblyName);

  /// @brief Method .ctor, addr 0x2874a54, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::StringW assemblyName, ::StringW messageArg, int32_t resourceId);

  /// @brief Method .ctor, addr 0x2874ab4, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2874918, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_Message, addr 0x2874940, size 0x18, virtual true, abstract: false, final false
