...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b4d0cc, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetMessageField, addr 0x5b4cd9c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b4cd00, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b4ced0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::StringW assemblyName);

  /// @brief Method .ctor, addr 0x5b4cf18, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::StringW assemblyName, ::StringW messageArg, int32_t resourceId);

  /// @brief Method .ctor, addr 0x5b4cf70, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5b4cd60, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_Message, addr 0x5b4cd84, size 0x18, virtual true, abstract: false, final false
