...
inline void System::Func_9<T1, T2, T3, T4, T5, T6, T7, T8, TResult>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Func_9<T1, T2, T3, T4, T5, T6, T7, T8, TResult>*>::get(),
