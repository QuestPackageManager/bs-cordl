...
public:
  ...
  /// @brief Method .ctor, addr 0x245713c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t codePage);

  /// @brief Method GetByteCount, addr 0x2457144, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0x24572c8, size 0x90, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW s);

  /// @brief Method GetByteCount, addr 0x2457358, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetBytes, addr 0x2457430, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x2457690, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x245790c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x2457a0c, size 0x184, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x2457b90, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetChars, addr 0x2457c68, size 0x27c, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x2457ee4, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method GetString, addr 0x2457fe4, size 0x1c8, virtual true, abstract: false, final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetDecoder, addr 0x24581ac, size 0x64, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x2458210, size 0x60, virtual true, abstract: false, final false
