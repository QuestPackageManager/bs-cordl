...
public:
  // Declarations
  /// @brief Method GetByteCount, addr 0x3c05078, size 0x178, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0x3c0527c, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetByteCount, addr 0x3c051f0, size 0x8c, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW s);

  /// @brief Method GetBytes, addr 0x3c05594, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x3c057f8, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x3c0534c, size 0x248, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x3c058f0, size 0x178, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x3c05a68, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetChars, addr 0x3c05b38, size 0x264, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x3c05d9c, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDecoder, addr 0x3c06050, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x3c060ac, size 0x58, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetString, addr 0x3c05e94, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c05070, size 0x8, virtual false, abstract: false, final false
