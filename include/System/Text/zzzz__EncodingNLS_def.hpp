...
public:
  ...
  /// @brief Method .ctor addr 0x22dd7bc size 0x8 virtual false final false
  inline void _ctor(int32_t codePage);

  /// @brief Method GetByteCount addr 0x22dd7c4 size 0x184 virtual true final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount addr 0x22dd948 size 0x90 virtual true final false
  inline int32_t GetByteCount(::StringW s);

  /// @brief Method GetByteCount addr 0x22dd9d8 size 0xd8 virtual true final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetBytes addr 0x22ddab0 size 0x260 virtual true final false
  ...
  /// @brief Method GetBytes addr 0x22ddd10 size 0x27c virtual true final false
  ...
  /// @brief Method GetBytes addr 0x22ddf8c size 0x100 virtual true final false
  ...
  /// @brief Method GetCharCount addr 0x22de08c size 0x184 virtual true final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount addr 0x22de210 size 0xd8 virtual true final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetChars addr 0x22de2e8 size 0x27c virtual true final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars addr 0x22de564 size 0x100 virtual true final false
  ...
  /// @brief Method GetString addr 0x22de664 size 0x1c8 virtual true final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetDecoder addr 0x22de82c size 0x64 virtual true final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder addr 0x22de890 size 0x60 virtual true final false
