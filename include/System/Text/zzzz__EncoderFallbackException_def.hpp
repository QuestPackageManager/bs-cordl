...
public:
  ...
  /// @brief Method .ctor addr 0x2634098 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::Text::EncoderFallbackException* New_ctor(::StringW message, char16_t charUnknown, int32_t index);

  /// @brief Method .ctor addr 0x2633bf8 size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2633e88 size 0x1f8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26340f4 size 0x8 virtual false final false
