...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncoderFallbackException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncoderFallbackException(EncoderFallbackException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncoderFallbackException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncoderFallbackException(EncoderFallbackExceptionconst&) = delete;
