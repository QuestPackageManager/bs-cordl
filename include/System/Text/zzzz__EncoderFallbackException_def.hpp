...
public:
  ...
  /// @brief Method .ctor, addr 0x26b29a8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26b2508, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, char16_t charUnknown, int32_t index);

  /// @brief Method .ctor, addr 0x26b2798, size 0x1f8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index);

  /// @brief Method .ctor, addr 0x26b2a04, size 0x8, virtual false, abstract: false, final false
