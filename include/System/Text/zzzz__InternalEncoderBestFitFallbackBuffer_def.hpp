...
public:
  ...
  /// @brief Method Fallback, addr 0x5ad166c, size 0x30, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknown, int32_t index);

  /// @brief Method Fallback, addr 0x5ad1770, size 0x190, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index);

  /// @brief Method GetNextChar, addr 0x5ad1900, size 0x40, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method MovePrevious, addr 0x5ad1940, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5ad1978, size 0x14, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method TryBestFit, addr 0x5ad169c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ad13c8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InternalSyncObject, addr 0x5ad15d4, size 0x94, virtual false, abstract: false, final false
  static inline ::System::Object* get_InternalSyncObject();

  /// @brief Method get_Remaining, addr 0x5ad196c, size 0xc, virtual true, abstract: false, final false
