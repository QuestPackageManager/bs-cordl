...
public:
  ...
  /// @brief Method .ctor addr 0x22e5b4c size 0x8 virtual false final false
  inline void _ctor(::System::Text::UTF32Encoding* encoding);

  /// @brief Method Reset addr 0x22e6280 size 0x20 virtual true final false
  inline void Reset();

  /// @brief Method get_HasState addr 0x22e62a0 size 0x10 virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0x22e3ab4 size 0x28 virtual false final false
  inline void _ctor();

  static inline ::System::Text::UTF32Encoding* New_ctor(bool bigEndian, bool byteOrderMark);

  /// @brief Method .ctor addr 0x22e3b4c size 0x40 virtual false final false
  ...
  /// @brief Method .ctor addr 0x22e3adc size 0x70 virtual false final false
  inline void _ctor(bool bigEndian, bool byteOrderMark, bool throwOnInvalidCharacters);

  /// @brief Method SetDefaultFallbacks addr 0x22e3b8c size 0xd4 virtual true final false
  inline void SetDefaultFallbacks();

  /// @brief Method GetByteCount addr 0x22e3c60 size 0x184 virtual true final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount addr 0x22e3de4 size 0x90 virtual true final false
  inline int32_t GetByteCount(::StringW s);

  /// @brief Method GetByteCount addr 0x22e3e74 size 0xd8 virtual true final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetBytes addr 0x22e3f4c size 0x260 virtual true final false
  ...
  /// @brief Method GetBytes addr 0x22e41ac size 0x27c virtual true final false
  ...
  /// @brief Method GetBytes addr 0x22e4428 size 0x100 virtual true final false
  ...
  /// @brief Method GetCharCount addr 0x22e4528 size 0x184 virtual true final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount addr 0x22e46ac size 0xd8 virtual true final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetChars addr 0x22e4784 size 0x27c virtual true final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars addr 0x22e4a00 size 0x100 virtual true final false
  ...
  /// @brief Method GetString addr 0x22e4b00 size 0x1c8 virtual true final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetByteCount addr 0x22e4cc8 size 0x2d8 virtual true final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count, ::System::Text::EncoderNLS* encoder);

  /// @brief Method GetBytes addr 0x22e4fa0 size 0x3c8 virtual true final false
  ...
  /// @brief Method GetCharCount addr 0x22e5384 size 0x348 virtual true final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* baseDecoder);

  /// @brief Method GetChars addr 0x22e56cc size 0x3fc virtual true final false
  ...
  /// @brief Method GetSurrogate addr 0x22e5368 size 0x1c virtual false final false
  inline uint32_t GetSurrogate(char16_t cHigh, char16_t cLow);

  /// @brief Method GetHighSurrogate addr 0x22e5ac8 size 0x14 virtual false final false
  inline char16_t GetHighSurrogate(uint32_t iChar);

  /// @brief Method GetLowSurrogate addr 0x22e5adc size 0xc virtual false final false
  inline char16_t GetLowSurrogate(uint32_t iChar);

  /// @brief Method GetDecoder addr 0x22e5ae8 size 0x64 virtual true final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder addr 0x22e5b54 size 0x60 virtual true final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetMaxByteCount addr 0x22e5bb4 size 0x108 virtual true final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount addr 0x22e5cbc size 0xd0 virtual true final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method GetPreamble addr 0x22e5d8c size 0x104 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  /// @brief Method get_Preamble addr 0x22e5e90 size 0x170 virtual true final false
  inline ::System::ReadOnlySpan_1<uint8_t> get_Preamble();

  /// @brief Method Equals addr 0x22e6000 size 0xc4 virtual true final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode addr 0x22e60c4 size 0x7c virtual true final false
