...
public:
  ...
  /// @brief Method IsMatch, addr 0x623f70c, size 0x6c, virtual false, abstract: false, final false
  inline bool IsMatch(::StringW text, int32_t index, int32_t beglimit, int32_t endlimit);

  /// @brief Method MatchPattern, addr 0x623f5d0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Scan, addr 0x623f778, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x623f180, size 0x450, virtual false, abstract: false, final false
