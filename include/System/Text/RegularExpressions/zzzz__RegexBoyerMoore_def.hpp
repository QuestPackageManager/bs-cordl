...
public:
  ...
  /// @brief Method IsMatch, addr 0x2a9f774, size 0x6c, virtual false, abstract: false, final false
  inline bool IsMatch(::StringW text, int32_t index, int32_t beglimit, int32_t endlimit);

  /// @brief Method MatchPattern, addr 0x2a9f650, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Scan, addr 0x2a9f7e0, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a9f19c, size 0x4b4, virtual false, abstract: false, final false
