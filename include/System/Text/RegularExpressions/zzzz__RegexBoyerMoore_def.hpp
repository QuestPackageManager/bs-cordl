...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RegexBoyerMoore", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RegexBoyerMoore(RegexBoyerMoore&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RegexBoyerMoore", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RegexBoyerMoore(RegexBoyerMooreconst&) = delete;
