...
public:
  ...
  /// @brief Method .ctor addr 0x27e18d8 size 0x10 virtual false final false
  inline void _ctor(::StringW prefix, bool ci);

  /// @brief Method get_CaseInsensitive addr 0x27eb974 size 0x8 virtual false final false
  inline bool get_CaseInsensitive();

  /// @brief Method get_Empty addr 0x27eb97c size 0x58 virtual false final false
  static inline ::System::Text::RegularExpressions::RegexPrefix get_Empty();

  /// @brief Method get_Prefix addr 0x27eb9d4 size 0x8 virtual false final false
