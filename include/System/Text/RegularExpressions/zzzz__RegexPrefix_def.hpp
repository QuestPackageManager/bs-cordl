...
public:
  ...
  /// @brief Method .ctor, addr 0x61d475c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CaseInsensitive, addr 0x61de914, size 0x8, virtual false, abstract: false, final false
  inline bool get_CaseInsensitive();

  /// @brief Method get_Empty, addr 0x61de91c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::RegexPrefix get_Empty();

  /// @brief Method get_Prefix, addr 0x61de978, size 0x8, virtual false, abstract: false, final false
