...
public:
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x624a594, size 0x114, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x624a3f0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x624a468, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x624a32c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::StringW regexInput, ::StringW regexPattern, ::System::TimeSpan matchTimeout);

  /// @brief Method get_Input, addr 0x624a6a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Input();

  /// @brief Method get_MatchTimeout, addr 0x624a6b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_MatchTimeout();

  /// @brief Method get_Pattern, addr 0x624a6b0, size 0x8, virtual false, abstract: false, final false
