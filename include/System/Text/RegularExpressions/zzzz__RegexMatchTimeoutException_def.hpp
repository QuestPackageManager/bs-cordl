...
public:
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x638d9c0, size 0x114, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x638d81c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x638d894, size 0x12c, virtual false, abstract: false, final false
