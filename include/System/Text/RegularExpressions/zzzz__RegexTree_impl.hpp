...
constexpr ::cordl_internals::to_const_pointer<::System::Text::RegularExpressions::RegexNode*> const& System::Text::RegularExpressions::RegexTree::__get_Root() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->___Root;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> const& System::Text::RegularExpressions::RegexTree::__get_Caps() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->___Caps;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> const& System::Text::RegularExpressions::RegexTree::__get_CapNames() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->___CapNames;
}
