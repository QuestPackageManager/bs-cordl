...
/// @brief Method GetLeftSubstring, addr 0x623a910, size 0x84, virtual false, abstract: false, final false
inline ::System::ReadOnlySpan_1<char16_t> GetLeftSubstring() ;

/// @brief Method GetRightSubstring, addr 0x623a994, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x623a90c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x623aa2c, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x623a8b0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  text, int32_t  index, int32_t  length) ;

/// @brief Method get_Index, addr 0x623a8bc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Index() ;

/// @brief Method get_Length, addr 0x623a8cc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_Text, addr 0x623a8dc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Text() ;

/// @brief Method get_Value, addr 0x623a8ec, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Index, addr 0x623a8c4, size 0x8, virtual false, abstract: false, final false
inline void set_Index(int32_t  value) ;

/// @brief Method set_Length, addr 0x623a8d4, size 0x8, virtual false, abstract: false, final false
inline void set_Length(int32_t  value) ;

/// @brief Method set_Text, addr 0x623a8e4, size 0x8, virtual false, abstract: false, final false
