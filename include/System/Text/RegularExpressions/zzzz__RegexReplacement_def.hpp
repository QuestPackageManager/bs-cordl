...
public:
  ...
  /// @brief Method GetOrCreate, addr 0x63944d4, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x63949dc, size 0x3a0, virtual false, abstract: false, final false
  inline ::StringW Replace(::System::Text::RegularExpressions::Regex* regex, ::StringW input, int32_t count, int32_t startat);

  /// @brief Method ReplacementImpl, addr 0x6394608, size 0x1a0, virtual false, abstract: false, final false
  inline void ReplacementImpl(::System::Text::StringBuilder* sb, ::System::Text::RegularExpressions::Match* match);

  /// @brief Method ReplacementImplRTL, addr 0x63947a8, size 0x234, virtual false, abstract: false, final false
