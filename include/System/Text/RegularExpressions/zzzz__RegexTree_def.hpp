...
public:
  ...
  /// @brief Method .ctor, addr 0x638f774, size 0x18, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RegexTree", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RegexTree(RegexTree&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RegexTree", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RegexTree(RegexTreeconst&) = delete;
