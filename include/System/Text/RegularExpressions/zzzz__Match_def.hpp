...
public:
  ...
  /// @brief Method AddMatch, addr 0x61c8ed8, size 0x1dc, virtual true, abstract: false, final false
  inline void AddMatch(int32_t cap, int32_t start, int32_t len);

  /// @brief Method BalanceMatch, addr 0x61c90b4, size 0xd8, virtual true, abstract: false, final false
  inline void BalanceMatch(int32_t cap);

  /// @brief Method GroupToStringImpl, addr 0x61c8d58, size 0x15c, virtual true, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> GroupToStringImpl(int32_t groupnum);

  /// @brief Method IsMatched, addr 0x61c91c4, size 0x90, virtual true, abstract: false, final false
  inline bool IsMatched(int32_t cap);

  /// @brief Method LastGroupToStringImpl, addr 0x61c8eb4, size 0x24, virtual false, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> LastGroupToStringImpl();

  /// @brief Method MatchIndex, addr 0x61c9254, size 0x8c, virtual true, abstract: false, final false
  inline int32_t MatchIndex(int32_t cap);

  /// @brief Method MatchLength, addr 0x61c92e0, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method NextMatch, addr 0x61c8a74, size 0x30, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::Match* NextMatch();

  /// @brief Method RemoveMatch, addr 0x61c918c, size 0x38, virtual true, abstract: false, final false
  inline void RemoveMatch(int32_t cap);

  /// @brief Method Reset, addr 0x61c89bc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method Tidy, addr 0x61c936c, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61c954c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x61c8814, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Empty, addr 0x61c8960, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::Match* get_Empty();

  /// @brief Method get_Groups, addr 0x61c8a18, size 0x5c, virtual true, abstract: false, final false
