...
namespace System::Text::RegularExpressions {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6913))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2954014, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Empty, addr 0x2954184, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::Match* get_Empty();

  /// @brief Method Reset, addr 0x29541dc, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Groups, addr 0x2954240, size 0x70, virtual true, abstract: false, final false
  inline ::System::Text::RegularExpressions::GroupCollection* get_Groups();

  /// @brief Method NextMatch, addr 0x29542b0, size 0x30, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::Match* NextMatch();

  /// @brief Method GroupToStringImpl, addr 0x2954570, size 0x198, virtual true, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> GroupToStringImpl(int32_t groupnum);

  /// @brief Method LastGroupToStringImpl, addr 0x2954708, size 0x28, virtual false, abstract: false, final false
  inline ::System::ReadOnlySpan_1<char16_t> LastGroupToStringImpl();

  /// @brief Method AddMatch, addr 0x2954730, size 0x224, virtual true, abstract: false, final false
  inline void AddMatch(int32_t cap, int32_t start, int32_t len);

  /// @brief Method BalanceMatch, addr 0x2954954, size 0xd8, virtual true, abstract: false, final false
  inline void BalanceMatch(int32_t cap);

  /// @brief Method RemoveMatch, addr 0x2954a2c, size 0x38, virtual true, abstract: false, final false
  inline void RemoveMatch(int32_t cap);

  /// @brief Method IsMatched, addr 0x2954a64, size 0x90, virtual true, abstract: false, final false
  inline bool IsMatched(int32_t cap);

  /// @brief Method MatchIndex, addr 0x2954af4, size 0x8c, virtual true, abstract: false, final false
  inline int32_t MatchIndex(int32_t cap);

  /// @brief Method MatchLength, addr 0x2954b80, size 0x8c, virtual true, abstract: false, final false
  inline int32_t MatchLength(int32_t cap);

  /// @brief Method Tidy, addr 0x2954c0c, size 0x164, virtual true, abstract: false, final false
  inline void Tidy(int32_t textpos);

  static inline ::System::Text::RegularExpressions::Match* New_ctor();

  /// @brief Method .ctor, addr 0x2954e08, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();
