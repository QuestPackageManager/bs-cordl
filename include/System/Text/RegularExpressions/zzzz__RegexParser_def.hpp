...
public:
  ...
  /// @brief Method Parse addr 0x27e5efc size 0x19c virtual false final false
  static inline ::System::Text::RegularExpressions::RegexTree* Parse(::StringW re, ::System::Text::RegularExpressions::RegexOptions op);

  /// @brief Method ParseReplacement addr 0x27e6d30 size 0x150 virtual false final false
  ...
  /// @brief Method .ctor addr 0x27e6098 size 0xc0 virtual false final false
  inline void _ctor(::System::Globalization::CultureInfo* culture);

  /// @brief Method SetPattern addr 0x27e6158 size 0x5c virtual false final false
  inline void SetPattern(::StringW Re);

  /// @brief Method Reset addr 0x27e64f4 size 0x8c virtual false final false
  inline void Reset(::System::Text::RegularExpressions::RegexOptions topopts);

  /// @brief Method ScanRegex addr 0x27e6580 size 0x748 virtual false final false
  inline ::System::Text::RegularExpressions::RegexNode* ScanRegex();

  /// @brief Method ScanReplacement addr 0x27e6e8c size 0x124 virtual false final false
  inline ::System::Text::RegularExpressions::RegexNode* ScanReplacement();

  /// @brief Method ScanCharClass addr 0x27e7ebc size 0x608 virtual false final false
  inline ::System::Text::RegularExpressions::RegexCharClass* ScanCharClass(bool caseInsensitive, bool scanOnly);

  /// @brief Method ScanGroupOpen addr 0x27e85e8 size 0x8e8 virtual false final false
  inline ::System::Text::RegularExpressions::RegexNode* ScanGroupOpen();

  /// @brief Method ScanBlank addr 0x27e7544 size 0x2e4 virtual false final false
  inline void ScanBlank();

  /// @brief Method ScanBackslash addr 0x27e9390 size 0x4e4 virtual false final false
  inline ::System::Text::RegularExpressions::RegexNode* ScanBackslash(bool scanOnly);

  /// @brief Method ScanBasicBackslash addr 0x27ea688 size 0x5a8 virtual false final false
  inline ::System::Text::RegularExpressions::RegexNode* ScanBasicBackslash(bool scanOnly);

  /// @brief Method ScanDollar addr 0x27e9b2c size 0x3f8 virtual false final false
  inline ::System::Text::RegularExpressions::RegexNode* ScanDollar();

  /// @brief Method ScanCapname addr 0x27ea220 size 0xbc virtual false final false
  inline ::StringW ScanCapname();

  /// @brief Method ScanOctal addr 0x27eac30 size 0x9c virtual false final false
  inline char16_t ScanOctal();

  /// @brief Method ScanDecimal addr 0x27e9a1c size 0xcc virtual false final false
  inline int32_t ScanDecimal();

  /// @brief Method ScanHex addr 0x27eaccc size 0x130 virtual false final false
  inline char16_t ScanHex(int32_t c);

  /// @brief Method HexDigit addr 0x27eadfc size 0x38 virtual false final false
  static inline int32_t HexDigit(char16_t ch);

  /// @brief Method ScanControl addr 0x27eae34 size 0x9c virtual false final false
  inline char16_t ScanControl();

  /// @brief Method IsOnlyTopOption addr 0x27eaed0 size 0x28 virtual false final false
  inline bool IsOnlyTopOption(::System::Text::RegularExpressions::RegexOptions option);

  /// @brief Method ScanOptions addr 0x27ea464 size 0xfc virtual false final false
  inline void ScanOptions();

  /// @brief Method ScanCharEscape addr 0x27ea0a0 size 0x180 virtual false final false
  inline char16_t ScanCharEscape();

  /// @brief Method ParseProperty addr 0x27e9f30 size 0x170 virtual false final false
  inline ::StringW ParseProperty();

  /// @brief Method TypeFromCode addr 0x27ea5f8 size 0x90 virtual false final false
  inline int32_t TypeFromCode(char16_t ch);

  /// @brief Method OptionFromCode addr 0x27eaef8 size 0x60 virtual false final false
  static inline ::System::Text::RegularExpressions::RegexOptions OptionFromCode(char16_t ch);

  /// @brief Method CountCaptures addr 0x27e61b4 size 0x340 virtual false final false
  inline void CountCaptures();

  /// @brief Method NoteCaptureSlot addr 0x27eaf58 size 0x108 virtual false final false
  inline void NoteCaptureSlot(int32_t i, int32_t pos);

  /// @brief Method NoteCaptureName addr 0x27eb0b0 size 0x19c virtual false final false
  inline void NoteCaptureName(::StringW name, int32_t pos);

  /// @brief Method NoteCaptures addr 0x27e6e80 size 0xc virtual false final false
  inline void NoteCaptures(::System::Collections::Hashtable* caps, int32_t capsize, ::System::Collections::Hashtable* capnames);

  /// @brief Method AssignNameSlots addr 0x27eb24c size 0x674 virtual false final false
  inline void AssignNameSlots();

  /// @brief Method CaptureSlotFromName addr 0x27ea3d8 size 0x8c virtual false final false
  inline int32_t CaptureSlotFromName(::StringW capname);

  /// @brief Method IsCaptureSlot addr 0x27ea320 size 0x9c virtual false final false
  inline bool IsCaptureSlot(int32_t i);

  /// @brief Method IsCaptureName addr 0x27ea3bc size 0x1c virtual false final false
  inline bool IsCaptureName(::StringW capname);

  /// @brief Method UseOptionN addr 0x27ea314 size 0xc virtual false final false
  inline bool UseOptionN();

  /// @brief Method UseOptionI addr 0x27e7eb0 size 0xc virtual false final false
  inline bool UseOptionI();

  /// @brief Method UseOptionM addr 0x27e9874 size 0xc virtual false final false
  inline bool UseOptionM();

  /// @brief Method UseOptionS addr 0x27e98f8 size 0xc virtual false final false
  inline bool UseOptionS();

  /// @brief Method UseOptionX addr 0x27e7828 size 0xc virtual false final false
  inline bool UseOptionX();

  /// @brief Method UseOptionE addr 0x27e9f24 size 0xc virtual false final false
  inline bool UseOptionE();

  /// @brief Method IsSpecial addr 0x27e7ac4 size 0x98 virtual false final false
  static inline bool IsSpecial(char16_t ch);

  /// @brief Method IsStopperX addr 0x27e788c size 0x98 virtual false final false
  static inline bool IsStopperX(char16_t ch);

  /// @brief Method IsQuantifier addr 0x27e7b5c size 0x98 virtual false final false
  static inline bool IsQuantifier(char16_t ch);

  /// @brief Method IsTrueQuantifier addr 0x27e7924 size 0x1a0 virtual false final false
  inline bool IsTrueQuantifier();

  /// @brief Method IsSpace addr 0x27ea560 size 0x98 virtual false final false
  static inline bool IsSpace(char16_t ch);

  /// @brief Method AddConcatenate addr 0x27e7bf4 size 0x1ec virtual false final false
  inline void AddConcatenate(int32_t pos, int32_t cch, bool isReplacement);

  /// @brief Method PushGroup addr 0x27e8f34 size 0x3c virtual false final false
  inline void PushGroup();

  /// @brief Method PopGroup addr 0x27e9228 size 0xd0 virtual false final false
  inline void PopGroup();

  /// @brief Method EmptyStack addr 0x27e9038 size 0x10 virtual false final false
  inline bool EmptyStack();

  /// @brief Method StartGroup addr 0x27e7498 size 0xac virtual false final false
  inline void StartGroup(::System::Text::RegularExpressions::RegexNode* openGroup);

  /// @brief Method AddAlternate addr 0x27e8f70 size 0xc8 virtual false final false
  inline void AddAlternate();

  /// @brief Method AddConcatenate addr 0x27e99c8 size 0x28 virtual false final false
  inline void AddConcatenate();

  /// @brief Method AddConcatenate addr 0x27e9ae8 size 0x44 virtual false final false
  inline void AddConcatenate(bool lazy, int32_t min, int32_t max);

  /// @brief Method Unit addr 0x27eb8c0 size 0x8 virtual false final false
  inline ::System::Text::RegularExpressions::RegexNode* Unit();

  /// @brief Method AddUnitOne addr 0x27e7dfc size 0xb4 virtual false final false
  inline void AddUnitOne(char16_t ch);

  /// @brief Method AddUnitNotone addr 0x27e9904 size 0xb4 virtual false final false
  inline void AddUnitNotone(char16_t ch);

  /// @brief Method AddUnitSet addr 0x27e84c4 size 0x80 virtual false final false
  inline void AddUnitSet(::StringW cc);

  /// @brief Method AddUnitNode addr 0x27eb8c8 size 0x8 virtual false final false
  inline void AddUnitNode(::System::Text::RegularExpressions::RegexNode* node);

  /// @brief Method AddUnitType addr 0x27e9880 size 0x78 virtual false final false
  inline void AddUnitType(int32_t type);

  /// @brief Method AddGroup addr 0x27e90e8 size 0x140 virtual false final false
  inline void AddGroup();

  /// @brief Method PushOptions addr 0x27e8544 size 0xa4 virtual false final false
  inline void PushOptions();

  /// @brief Method PopOptions addr 0x27e92f8 size 0x98 virtual false final false
  inline void PopOptions();

  /// @brief Method EmptyOptionsStack addr 0x27eb060 size 0x50 virtual false final false
  inline bool EmptyOptionsStack();

  /// @brief Method PopKeepOptions addr 0x27e8ed0 size 0x64 virtual false final false
  inline void PopKeepOptions();

  /// @brief Method MakeException addr 0x27e9048 size 0xa0 virtual false final false
  inline ::System::ArgumentException* MakeException(::StringW message);

  /// @brief Method Textpos addr 0x27eb8d0 size 0x8 virtual false final false
  inline int32_t Textpos();

  /// @brief Method Textto addr 0x27eb8d8 size 0x8 virtual false final false
  inline void Textto(int32_t pos);

  /// @brief Method RightCharMoveRight addr 0x27e99f0 size 0x2c virtual false final false
  inline char16_t RightCharMoveRight();

  /// @brief Method MoveRight addr 0x27e7834 size 0x10 virtual false final false
  inline void MoveRight();

  /// @brief Method MoveRight addr 0x27ea304 size 0x10 virtual false final false
  inline void MoveRight(int32_t i);

  /// @brief Method MoveLeft addr 0x27e99b8 size 0x10 virtual false final false
  inline void MoveLeft();

  /// @brief Method CharAt addr 0x27e7de0 size 0x1c virtual false final false
  inline char16_t CharAt(int32_t i);

  /// @brief Method RightChar addr 0x27e7868 size 0x24 virtual false final false
  inline char16_t RightChar();

  /// @brief Method RightChar addr 0x27ea2dc size 0x28 virtual false final false
  inline char16_t RightChar(int32_t i);

  /// @brief Method CharsRight addr 0x27e7844 size 0x24 virtual false final false
