...
public:
  ...
  /// @brief Method Equals, addr 0x4423608, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4423698, size 0x68, virtual true, abstract: false, final true
  inline bool Equals(::System::Text::RegularExpressions::Regex_CachedCodeEntryKey other);

  /// @brief Method GetHashCode, addr 0x4423700, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x44234e4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x44212e8, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x4421980, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FillCacheDictionary, addr 0x44219f8, size 0x104, virtual false, abstract: false, final false
  inline void FillCacheDictionary();

  /// @brief Method GetCachedCode, addr 0x44211f0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCachedCodeEntryInternal, addr 0x4421318, size 0x4a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GroupNameFromNumber, addr 0x441e948, size 0x140, virtual false, abstract: false, final false
  inline ::StringW GroupNameFromNumber(int32_t i);

  /// @brief Method GroupNumberFromName, addr 0x441e554, size 0x140, virtual false, abstract: false, final false
  inline int32_t GroupNumberFromName(::StringW name);

  /// @brief Method InitDefaultMatchTimeout, addr 0x4423030, size 0x230, virtual false, abstract: false, final false
  static inline ::System::TimeSpan InitDefaultMatchTimeout();

  /// @brief Method InitializeReferences, addr 0x44234f0, size 0xfc, virtual false, abstract: false, final false
  inline void InitializeReferences();

  /// @brief Method IsMatch, addr 0x4422178, size 0x6c, virtual false, abstract: false, final false
  inline bool IsMatch(::StringW input);

  /// @brief Method IsMatch, addr 0x4421cf8, size 0x74, virtual false, abstract: false, final false
  static inline bool IsMatch(::StringW input, ::StringW pattern);

  /// @brief Method IsMatch, addr 0x4421d6c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMatch, addr 0x44221f0, size 0x7c, virtual false, abstract: false, final false
  inline bool IsMatch(::StringW input, int32_t startat);

  /// @brief Method LookupCachedAndPromote, addr 0x44217bc, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Match, addr 0x442236c, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::Match* Match(::StringW input);

  /// @brief Method Match, addr 0x442226c, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::Match* Match(::StringW input, ::StringW pattern);

  /// @brief Method Match, addr 0x44222e0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Match, addr 0x44223d8, size 0x70, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::Match* Match(::StringW input, int32_t startat);

  /// @brief Method Matches, addr 0x4422448, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x4422510, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW Replace(::StringW input, ::StringW pattern, ::StringW replacement);

  /// @brief Method Replace, addr 0x4422620, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x442258c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Replace, addr 0x44226a8, size 0x70, virtual false, abstract: false, final false
  inline ::StringW Replace(::StringW input, ::StringW replacement);

  /// @brief Method Replace, addr 0x4422718, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW Replace(::StringW input, ::StringW replacement, int32_t count, int32_t startat);

  /// @brief Method Run, addr 0x441f778, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method Split, addr 0x44227f0, size 0x70, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> Split(::StringW input);

  /// @brief Method Split, addr 0x4422860, size 0xc0, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> Split(::StringW input, int32_t count, int32_t startat);

  /// @brief Method Split, addr 0x4422920, size 0x5d4, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x44234ac, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x44235f4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetCacheValue, addr 0x4421afc, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetCacheValueSmall, addr 0x4421c18, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method UseOptionInvariant, addr 0x44235fc, size 0xc, virtual false, abstract: false, final false
  inline bool UseOptionInvariant();

  /// @brief Method UseOptionR, addr 0x44221e4, size 0xc, virtual false, abstract: false, final false
  inline bool UseOptionR();

  /// @brief Method ValidateMatchTimeout, addr 0x4423260, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44233b8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW pattern);

  /// @brief Method .ctor, addr 0x4423430, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW pattern, ::System::Text::RegularExpressions::RegexOptions options);

  /// @brief Method .ctor, addr 0x4421df8, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Options, addr 0x44235ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexOptions get_Options();

  /// @brief Method get_RightToLeft, addr 0x4422ef4, size 0xc, virtual false, abstract: false, final false
