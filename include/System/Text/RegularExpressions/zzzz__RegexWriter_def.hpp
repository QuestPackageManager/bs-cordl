...
namespace System::Text::RegularExpressions {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8367)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8367), inst: 101 })}
...
public:
  // Declarations
  /// @brief Method .ctor addr 0x27ecb78 size 0x148 virtual false final false
  inline void _ctor(::System::Span_1<int32_t> emittedSpan, ::System::Span_1<int32_t> intStackSpan);

  /// @brief Method Write addr 0x27eccc0 size 0x104 virtual false final false
  static inline ::System::Text::RegularExpressions::RegexCode* Write(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method Dispose addr 0x27ed224 size 0x54 virtual false final false
  inline void Dispose();

  /// @brief Method RegexCodeFromRegexTree addr 0x27ecdc4 size 0x460 virtual false final false
  inline ::System::Text::RegularExpressions::RegexCode* RegexCodeFromRegexTree(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method PatchJump addr 0x27eddd4 size 0x64 virtual false final false
  inline void PatchJump(int32_t offset, int32_t jumpDest);

  /// @brief Method Emit addr 0x27ede38 size 0xe4 virtual false final false
  inline void Emit(int32_t op);

  /// @brief Method Emit addr 0x27ed278 size 0x14c virtual false final false
  inline void Emit(int32_t op, int32_t opd1);

  /// @brief Method Emit addr 0x27edf1c size 0x1ac virtual false final false
  inline void Emit(int32_t op, int32_t opd1, int32_t opd2);

  /// @brief Method StringCode addr 0x27ee0c8 size 0x14c virtual false final false
  inline int32_t StringCode(::StringW str);

  /// @brief Method MapCapnum addr 0x27ee214 size 0xb4 virtual false final false
  inline int32_t MapCapnum(int32_t capnum);

  /// @brief Method EmitFragment addr 0x27ed3c4 size 0xa10 virtual false final false
