...
public:
  ...
  /// @brief Method .ctor, addr 0x61c76b4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x61c7550, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Success, addr 0x61c75ac, size 0x10, virtual false, abstract: false, final false
