...
public:
  ...
  /// @brief Method .ctor, addr 0x4410e60, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4410cb0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Success, addr 0x4410d4c, size 0x10, virtual false, abstract: false, final false
