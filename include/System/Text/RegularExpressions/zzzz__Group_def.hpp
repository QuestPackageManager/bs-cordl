...
public:
  ...
  /// @brief Method .ctor, addr 0x4410de8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4410c38, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Success, addr 0x4410cd4, size 0x10, virtual false, abstract: false, final false
