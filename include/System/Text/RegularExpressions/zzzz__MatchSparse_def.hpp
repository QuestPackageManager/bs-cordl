...
public:
  ...
  /// @brief Method .ctor, addr 0x2a3a2bc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Groups, addr 0x2a3a36c, size 0x74, virtual true, abstract: false, final false
