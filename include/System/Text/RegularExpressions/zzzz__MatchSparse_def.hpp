...
public:
  ...
  /// @brief Method .ctor, addr 0x4412d48, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Groups, addr 0x4412df8, size 0x6c, virtual true, abstract: false, final false
