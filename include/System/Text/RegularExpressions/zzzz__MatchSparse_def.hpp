...
public:
  ...
  /// @brief Method .ctor, addr 0x623bc54, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Groups, addr 0x623bd08, size 0x60, virtual true, abstract: false, final false
