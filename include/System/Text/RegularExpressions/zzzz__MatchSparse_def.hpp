...
public:
  ...
  /// @brief Method .ctor, addr 0x637f080, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Groups, addr 0x637f134, size 0x60, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MatchSparse", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MatchSparse(MatchSparse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MatchSparse", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MatchSparse(MatchSparseconst&) = delete;
