...
public:
  ...
  /// @brief Method .ctor, addr 0x44113a0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Groups, addr 0x4411450, size 0x6c, virtual true, abstract: false, final false
