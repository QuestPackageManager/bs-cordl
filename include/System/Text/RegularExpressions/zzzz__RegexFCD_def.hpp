...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x295ed68, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::System::Span_1<int32_t> intStack);

  /// @brief Method FirstChars, addr 0x295ee3c, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method Prefix, addr 0x295f1e4, size 0x218, virtual false, abstract: false, final false
  static inline ::System::Text::RegularExpressions::RegexPrefix Prefix(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method Anchors, addr 0x295f4a0, size 0x130, virtual false, abstract: false, final false
  static inline int32_t Anchors(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method AnchorFromType, addr 0x295f5d0, size 0x70, virtual false, abstract: false, final false
  static inline int32_t AnchorFromType(int32_t type);

  /// @brief Method PushInt, addr 0x295f640, size 0xb4, virtual false, abstract: false, final false
  inline void PushInt(int32_t i);

  /// @brief Method IntIsEmpty, addr 0x295f6f4, size 0x44, virtual false, abstract: false, final false
  inline bool IntIsEmpty();

  /// @brief Method PopInt, addr 0x295f738, size 0x5c, virtual false, abstract: false, final false
  inline int32_t PopInt();

  /// @brief Method PushFC, addr 0x295f794, size 0xa8, virtual false, abstract: false, final false
  inline void PushFC(::System::Text::RegularExpressions::RegexFC* fc);

  /// @brief Method FCIsEmpty, addr 0x295f83c, size 0x50, virtual false, abstract: false, final false
  inline bool FCIsEmpty();

  /// @brief Method PopFC, addr 0x295f88c, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexFC* PopFC();

  /// @brief Method TopFC, addr 0x295f908, size 0x64, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexFC* TopFC();

  /// @brief Method Dispose, addr 0x295f154, size 0x48, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method RegexFCFromRegexTree, addr 0x295efbc, size 0x198, virtual false, abstract: false, final false
  inline ::System::Text::RegularExpressions::RegexFC* RegexFCFromRegexTree(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method SkipChild, addr 0x295fd58, size 0xc, virtual false, abstract: false, final false
  inline void SkipChild();

  /// @brief Method CalculateFC, addr 0x295f96c, size 0x3ec, virtual false, abstract: false, final false
