...
public:
  // Declarations
  /// @brief Method .ctor addr 0x27e146c size 0xd4 virtual false final false
  inline void _ctor(::System::Span_1<int32_t> intStack);

  /// @brief Method FirstChars addr 0x27e1540 size 0x180 virtual false final false
  ...
  /// @brief Method Prefix addr 0x27e18e8 size 0x218 virtual false final false
  static inline ::System::Text::RegularExpressions::RegexPrefix Prefix(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method Anchors addr 0x27e1ba4 size 0x130 virtual false final false
  static inline int32_t Anchors(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method AnchorFromType addr 0x27e1cd4 size 0x70 virtual false final false
  static inline int32_t AnchorFromType(int32_t type);

  /// @brief Method PushInt addr 0x27e1d44 size 0xb4 virtual false final false
  inline void PushInt(int32_t i);

  /// @brief Method IntIsEmpty addr 0x27e1df8 size 0x44 virtual false final false
  inline bool IntIsEmpty();

  /// @brief Method PopInt addr 0x27e1e3c size 0x5c virtual false final false
  inline int32_t PopInt();

  /// @brief Method PushFC addr 0x27e1e98 size 0xa8 virtual false final false
  inline void PushFC(::System::Text::RegularExpressions::RegexFC* fc);

  /// @brief Method FCIsEmpty addr 0x27e1f40 size 0x50 virtual false final false
  inline bool FCIsEmpty();

  /// @brief Method PopFC addr 0x27e1f90 size 0x7c virtual false final false
  inline ::System::Text::RegularExpressions::RegexFC* PopFC();

  /// @brief Method TopFC addr 0x27e200c size 0x64 virtual false final false
  inline ::System::Text::RegularExpressions::RegexFC* TopFC();

  /// @brief Method Dispose addr 0x27e1858 size 0x48 virtual false final false
  inline void Dispose();

  /// @brief Method RegexFCFromRegexTree addr 0x27e16c0 size 0x198 virtual false final false
  inline ::System::Text::RegularExpressions::RegexFC* RegexFCFromRegexTree(::System::Text::RegularExpressions::RegexTree* tree);

  /// @brief Method SkipChild addr 0x27e245c size 0xc virtual false final false
  inline void SkipChild();

  /// @brief Method CalculateFC addr 0x27e2070 size 0x3ec virtual false final false
