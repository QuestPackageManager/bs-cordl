...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RegexFC", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RegexFC(RegexFC&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RegexFC", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RegexFC(RegexFCconst&) = delete;
