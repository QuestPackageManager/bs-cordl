...
public:
  ...
  /// @brief Method Get, addr 0x623cae4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x623cb2c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x623cbe0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
