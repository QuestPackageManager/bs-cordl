...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::ExclusiveReference*);
DEFINE_IL2CPP_CLASS(::System::Text::RegularExpressions::ExclusiveReference*, "System.Text.RegularExpressions", "ExclusiveReference");
...
public:
  ...
  /// @brief Method Get, addr 0x637a6f8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x637a740, size 0xb4, virtual false, abstract: false, final false
  ...
  constexpr ::System::Text::RegularExpressions::RegexRunner* const& __cordl_internal_get__obj() const;

  constexpr ::System::Text::RegularExpressions::RegexRunner*& __cordl_internal_get__obj();

  constexpr ::System::Text::RegularExpressions::RegexRunner* const& __cordl_internal_get__ref() const;
  ...
  /// @brief Method .ctor, addr 0x637a7f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Text::RegularExpressions::ExclusiveReference) == 0x28, "Size mismatch!");
