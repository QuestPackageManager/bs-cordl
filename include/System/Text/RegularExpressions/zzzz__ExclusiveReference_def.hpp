...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExclusiveReference", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExclusiveReference(ExclusiveReference&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExclusiveReference", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExclusiveReference(ExclusiveReferenceconst&) = delete;
