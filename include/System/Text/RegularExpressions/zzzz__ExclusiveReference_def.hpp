...
public:
  ...
  /// @brief Method Get, addr 0x2fa4e38, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x2fa4e90, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fa4f4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
