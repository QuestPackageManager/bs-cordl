...
public:
  ...
  /// @brief Method OpcodeBacktracks, addr 0x2aaa0e8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2aaa018, size 0xd0, virtual false, abstract: false, final false
