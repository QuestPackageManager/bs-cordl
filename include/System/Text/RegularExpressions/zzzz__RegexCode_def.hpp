...
public:
  ...
  /// @brief Method OpcodeBacktracks, addr 0x441e18c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x441e0bc, size 0xd0, virtual false, abstract: false, final false
