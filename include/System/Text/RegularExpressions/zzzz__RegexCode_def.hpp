...
public:
  ...
  /// @brief Method OpcodeBacktracks, addr 0x616c764, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x616c694, size 0xd0, virtual false, abstract: false, final false
