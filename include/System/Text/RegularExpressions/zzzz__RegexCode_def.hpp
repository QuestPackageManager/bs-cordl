...
public:
  ...
  /// @brief Method OpcodeBacktracks, addr 0x4419218, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4419148, size 0xd0, virtual false, abstract: false, final false
