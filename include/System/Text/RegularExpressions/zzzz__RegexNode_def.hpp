...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RegexNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RegexNode(RegexNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RegexNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RegexNode(RegexNodeconst&) = delete;
