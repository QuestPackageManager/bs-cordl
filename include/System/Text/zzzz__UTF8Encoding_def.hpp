...
public:
  ...
  /// @brief Method Reset, addr 0x58cd000, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x58ccfd8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF8Encoding* encoding);

  /// @brief Method get_HasState, addr 0x58cd020, size 0x10, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Reset, addr 0x58cd058, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x58cd030, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF8Encoding* encoding);

  /// @brief Method get_HasState, addr 0x58cd078, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasState();
...
public:
  ...
  /// @brief Method Equals, addr 0x58ccc48, size 0xd8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FallbackInvalidByteSequence, addr 0x58cc490, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method FallbackInvalidByteSequence, addr 0x58cbe28, size 0x40, virtual false, abstract: false, final false
  inline int32_t FallbackInvalidByteSequence(uint8_t* pSrc, int32_t ch, ::System::Text::DecoderFallbackBuffer* fallback);

  /// @brief Method GetByteCount, addr 0x58c9c38, size 0x188, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0x58c9dc0, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW chars);

  /// @brief Method GetByteCount, addr 0x58c9e2c, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetByteCount(char16_t* chars, int32_t count);

  /// @brief Method GetByteCount, addr 0x58cac20, size 0x5e0, virtual true, abstract: false, final false
  inline int32_t GetByteCount(char16_t* chars, int32_t count, ::System::Text::EncoderNLS* baseEncoder);

  /// @brief Method GetBytes, addr 0x58ca144, size 0x280, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x58ca3c4, size 0xf8, virtual true, abstract: false, final false
  inline int32_t GetBytes(char16_t* chars, int32_t charCount, uint8_t* bytes, int32_t byteCount);

  /// @brief Method GetBytes, addr 0x58cb228, size 0x738, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x58c9efc, size 0x248, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytesUnknown, addr 0x58cc4fc, size 0x210, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytesUnknown(::ByRef<uint8_t*> pSrc, int32_t ch);

  /// @brief Method GetCharCount, addr 0x58ca4bc, size 0x188, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x58ca644, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetCharCount(uint8_t* bytes, int32_t count);

  /// @brief Method GetCharCount, addr 0x58cb960, size 0x4c8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(uint8_t* bytes, int32_t count, ::System::Text::DecoderNLS* baseDecoder);

  /// @brief Method GetChars, addr 0x58ca714, size 0x284, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x58ca998, size 0xf8, virtual true, abstract: false, final false
  inline int32_t GetChars(uint8_t* bytes, int32_t byteCount, char16_t* chars, int32_t charCount);

  /// @brief Method GetChars, addr 0x58cbe68, size 0x628, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDecoder, addr 0x58cc70c, size 0x74, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x58cc780, size 0x74, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetHashCode, addr 0x58ccd20, size 0x60, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetMaxByteCount, addr 0x58cc7f4, size 0xfc, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x58cc8f0, size 0xfc, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method GetPreamble, addr 0x58cc9ec, size 0xf8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  /// @brief Method GetString, addr 0x58caa90, size 0x190, virtual true, abstract: false, final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method InRange, addr 0x58cb200, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method PtrDiff, addr 0x58cb214, size 0xc, virtual false, abstract: false, final false
  static inline int32_t PtrDiff(char16_t* a, char16_t* b);

  /// @brief Method PtrDiff, addr 0x58cb220, size 0x8, virtual false, abstract: false, final false
  static inline int32_t PtrDiff(uint8_t* a, uint8_t* b);

  /// @brief Method SetDefaultFallbacks, addr 0x58c9b70, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c9aa0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x58c9ad0, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(bool encoderShouldEmitUTF8Identifier);

  /// @brief Method .ctor, addr 0x58c9b10, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Preamble, addr 0x58ccae4, size 0x164, virtual true, abstract: false, final false
