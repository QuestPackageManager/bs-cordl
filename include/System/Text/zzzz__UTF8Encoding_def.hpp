...
public:
  ...
  /// @brief Method Reset, addr 0x3c27410, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3c27408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF8Encoding* encoding);

  /// @brief Method get_HasState, addr 0x3c27430, size 0x10, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Reset, addr 0x3c27448, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3c27440, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::UTF8Encoding* encoding);

  /// @brief Method get_HasState, addr 0x3c27468, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasState();
...
public:
  ...
  /// @brief Method Equals, addr 0x3c270c0, size 0xd0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FallbackInvalidByteSequence, addr 0x3c26954, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method FallbackInvalidByteSequence, addr 0x3c26274, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x3c24098, size 0x178, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount, addr 0x3c24210, size 0x8c, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::StringW chars);

  /// @brief Method GetByteCount, addr 0x3c2429c, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetByteCount, addr 0x3c25070, size 0x5ec, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count, ::System::Text::EncoderNLS* baseEncoder);

  /// @brief Method GetBytes, addr 0x3c245b4, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x3c24818, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x3c25684, size 0x74c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x3c2436c, size 0x248, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytesUnknown, addr 0x3c269c0, size 0x1f4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytesUnknown(ByRef<::cordl_internals::Ptr<uint8_t>> pSrc, int32_t ch);

  /// @brief Method GetCharCount, addr 0x3c24910, size 0x178, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x3c24a88, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetCharCount, addr 0x3c25dd0, size 0x4a4, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* baseDecoder);

  /// @brief Method GetChars, addr 0x3c24b58, size 0x264, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x3c24dbc, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x3c262b4, size 0x6a0, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDecoder, addr 0x3c26bb4, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder, addr 0x3c26c10, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetHashCode, addr 0x3c27190, size 0x60, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetMaxByteCount, addr 0x3c26c6c, size 0x100, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x3c26d6c, size 0x100, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method GetPreamble, addr 0x3c26e6c, size 0xe4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  /// @brief Method GetString, addr 0x3c24eb4, size 0x1bc, virtual true, abstract: false, final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method InRange, addr 0x3c2565c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method PtrDiff, addr 0x3c25670, size 0xc, virtual false, abstract: false, final false
  static inline int32_t PtrDiff(::cordl_internals::Ptr<char16_t> a, ::cordl_internals::Ptr<char16_t> b);

  /// @brief Method PtrDiff, addr 0x3c2567c, size 0x8, virtual false, abstract: false, final false
  static inline int32_t PtrDiff(::cordl_internals::Ptr<uint8_t> a, ::cordl_internals::Ptr<uint8_t> b);

  /// @brief Method SetDefaultFallbacks, addr 0x3c23fdc, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c23f2c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3c23f4c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool encoderShouldEmitUTF8Identifier);

  /// @brief Method .ctor, addr 0x3c23f7c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Preamble, addr 0x3c26f50, size 0x170, virtual true, abstract: false, final false
