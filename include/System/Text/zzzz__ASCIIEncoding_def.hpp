...
public:
  ...
  /// @brief Method .ctor addr 0x24d3dd8 size 0xc virtual false final false
  inline void _ctor();

  /// @brief Method SetDefaultFallbacks addr 0x24d3de4 size 0x20 virtual true final false
  inline void SetDefaultFallbacks();

  /// @brief Method GetByteCount addr 0x24d3f3c size 0x184 virtual true final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount addr 0x24d40c0 size 0x90 virtual true final false
  inline int32_t GetByteCount(::StringW chars);

  /// @brief Method GetByteCount addr 0x24d4150 size 0xd8 virtual true final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetBytes addr 0x24d4228 size 0x260 virtual true final false
  ...
  /// @brief Method GetBytes addr 0x24d4488 size 0x27c virtual true final false
  ...
  /// @brief Method GetBytes addr 0x24d4704 size 0x100 virtual true final false
  ...
  /// @brief Method GetCharCount addr 0x24d4804 size 0x184 virtual true final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount addr 0x24d4988 size 0xd8 virtual true final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetChars addr 0x24d4a60 size 0x27c virtual true final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars addr 0x24d4cdc size 0x100 virtual true final false
  ...
  /// @brief Method GetString addr 0x24d4ddc size 0x1c8 virtual true final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount);

  /// @brief Method GetByteCount addr 0x24d4fa4 size 0x2f8 virtual true final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t charCount, ::System::Text::EncoderNLS* encoder);

  /// @brief Method GetBytes addr 0x24d5338 size 0x42c virtual true final false
  ...
  /// @brief Method GetCharCount addr 0x24d5764 size 0x150 virtual true final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* decoder);

  /// @brief Method GetChars addr 0x24d58f8 size 0x288 virtual true final false
  ...
  /// @brief Method GetMaxByteCount addr 0x24d5b90 size 0x108 virtual true final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount addr 0x24d5c98 size 0x104 virtual true final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method GetDecoder addr 0x24d5d9c size 0x60 virtual true final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetEncoder addr 0x24d5e40 size 0x64 virtual true final false
