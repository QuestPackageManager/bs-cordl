...
public:
  ...
  /// @brief Method ClearMustFlush, addr 0x5b8f1ec, size 0x8, virtual false, abstract: false, final false
  inline void ClearMustFlush();

  /// @brief Method Convert, addr 0x5b8ed6c, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x5b8f038, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x5b8e6dc, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x5b8e6ec, size 0x1d8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetCharCount, addr 0x5b8e8c4, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetCharCount(uint8_t* bytes, int32_t count, bool flush);

  /// @brief Method GetChars, addr 0x5b8e9b4, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x5b8e9c4, size 0x290, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x5b8ec54, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5b8e6c4, size 0x18, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5b8cc8c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_HasState, addr 0x5b8f1e4, size 0x8, virtual true, abstract: false, final false
  inline bool get_HasState();

  /// @brief Method get_MustFlush, addr 0x5b8f1dc, size 0x8, virtual false, abstract: false, final false
