...
public:
  ...
  /// @brief Method ClearMustFlush, addr 0x28b752c, size 0x8, virtual false, abstract: false, final false
  inline void ClearMustFlush();

  /// @brief Method Convert, addr 0x28b70a0, size 0x2d0, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x28b7370, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x28b69f8, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x28b6a08, size 0x1d8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetCharCount, addr 0x28b6be0, size 0xf8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, bool flush);

  /// @brief Method GetChars, addr 0x28b6cd8, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x28b6ce8, size 0x298, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x28b6f80, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x28b69e0, size 0x18, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x28b4f5c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_HasState, addr 0x28b7524, size 0x8, virtual true, abstract: false, final false
  inline bool get_HasState();

  /// @brief Method get_MustFlush, addr 0x28b751c, size 0x8, virtual false, abstract: false, final false
