...
public:
  ...
  /// @brief Method ClearMustFlush, addr 0x5b1ccf8, size 0x8, virtual false, abstract: false, final false
  inline void ClearMustFlush();

  /// @brief Method Convert, addr 0x5b1c878, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x5b1cb44, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x5b1c1e8, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x5b1c1f8, size 0x1d8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetCharCount, addr 0x5b1c3d0, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetCharCount(uint8_t* bytes, int32_t count, bool flush);

  /// @brief Method GetChars, addr 0x5b1c4c0, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x5b1c4d0, size 0x290, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x5b1c760, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5b1c1d0, size 0x18, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5b1a798, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_HasState, addr 0x5b1ccf0, size 0x8, virtual true, abstract: false, final false
  inline bool get_HasState();

  /// @brief Method get_MustFlush, addr 0x5b1cce8, size 0x8, virtual false, abstract: false, final false
