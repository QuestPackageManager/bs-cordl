...
public:
  ...
  __declspec(property(get = __get__bytesUsed, put = __set__bytesUsed)) int32_t _bytesUsed;
  ...
  constexpr int32_t& __get__bytesUsed();

  constexpr int32_t const& __get__bytesUsed() const;

  constexpr void __set__bytesUsed(int32_t value);

  static inline ::System::Text::DecoderNLS* New_ctor(::System::Text::Encoding* encoding);

  /// @brief Method .ctor addr 0x262ff08 size 0x44 virtual false final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method Reset addr 0x263198c size 0x18 virtual true final false
  inline void Reset();

  /// @brief Method GetCharCount addr 0x26319a4 size 0x10 virtual true final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount addr 0x26319b4 size 0x1d8 virtual true final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetCharCount addr 0x2631b8c size 0xf8 virtual true final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, bool flush);

  /// @brief Method GetChars addr 0x2631c84 size 0x10 virtual true final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars addr 0x2631c94 size 0x298 virtual true final false
  ...
  /// @brief Method GetChars addr 0x2631f2c size 0x120 virtual true final false
  ...
  /// @brief Method Convert addr 0x263204c size 0x2d0 virtual true final false
  ...
  /// @brief Method Convert addr 0x263231c size 0x1ac virtual true final false
  ...
  /// @brief Method get_MustFlush addr 0x26324c8 size 0x8 virtual false final false
  inline bool get_MustFlush();

  /// @brief Method get_HasState addr 0x26324d0 size 0x8 virtual true final false
  inline bool get_HasState();

  /// @brief Method ClearMustFlush addr 0x26324d8 size 0x8 virtual false final false
