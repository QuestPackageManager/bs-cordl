...
DEFINE_IL2CPP_CLASS(::System::Text::NormalizationCheck, "System.Text", "NormalizationCheck");
// Dependencies
namespace System::Text {
// Is value type: true
...
static_assert(sizeof(::System::Text::NormalizationCheck) == 0x4, "Size mismatch!");
