...
public:
  ...
  /// @brief Method GetByteCount, addr 0x5ff042c, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetBytes, addr 0x5ff0440, size 0x550, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x5ff0a9c, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetChars, addr 0x5ff0ab0, size 0x458, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetMaxByteCount, addr 0x5ff0314, size 0x118, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x5ff0990, size 0x10c, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  static inline ::System::Text::BinHexEncoding* New_ctor();

  /// @brief Method .ctor, addr 0x5ff0f08, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
