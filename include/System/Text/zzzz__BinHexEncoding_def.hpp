...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinHexEncoding", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinHexEncoding(BinHexEncoding&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinHexEncoding", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinHexEncoding(BinHexEncodingconst&) = delete;
