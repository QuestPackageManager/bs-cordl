...
public:
  ...
  /// @brief Method .ctor addr 0x22ef1f0 size 0x10 virtual false final false
  inline void _ctor(::System::Text::UnicodeEncoding* encoding);

  /// @brief Method Reset addr 0x22ef200 size 0x28 virtual true final false
  inline void Reset();

  /// @brief Method get_HasState addr 0x22ef228 size 0x24 virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0x22ebac0 size 0x34 virtual false final false
  inline void _ctor();

  static inline ::System::Text::UnicodeEncoding* New_ctor(bool bigEndian, bool byteOrderMark);

  /// @brief Method .ctor addr 0x22ebaf4 size 0x48 virtual false final false
  ...
  /// @brief Method .ctor addr 0x22ebb3c size 0x78 virtual false final false
  inline void _ctor(bool bigEndian, bool byteOrderMark, bool throwOnInvalidBytes);

  /// @brief Method SetDefaultFallbacks addr 0x22ebbb4 size 0xd4 virtual true final false
  inline void SetDefaultFallbacks();

  /// @brief Method GetByteCount addr 0x22ebc88 size 0x184 virtual true final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetByteCount addr 0x22ebe0c size 0x90 virtual true final false
  inline int32_t GetByteCount(::StringW s);

  /// @brief Method GetByteCount addr 0x22ebe9c size 0xd8 virtual true final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count);

  /// @brief Method GetBytes addr 0x22ebf74 size 0x260 virtual true final false
  ...
  /// @brief Method GetBytes addr 0x22ec1d4 size 0x27c virtual true final false
  ...
  /// @brief Method GetBytes addr 0x22ec450 size 0x100 virtual true final false
  ...
  /// @brief Method GetCharCount addr 0x22ec550 size 0x184 virtual true final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount addr 0x22ec6d4 size 0xd8 virtual true final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count);

  /// @brief Method GetChars addr 0x22ec7ac size 0x27c virtual true final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars addr 0x22eca28 size 0x100 virtual true final false
  ...
  /// @brief Method GetString addr 0x22ecb28 size 0x1c8 virtual true final false
  inline ::StringW GetString(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetByteCount addr 0x22eccf0 size 0x56c virtual true final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count, ::System::Text::EncoderNLS* encoder);

  /// @brief Method GetBytes addr 0x22ed25c size 0x734 virtual true final false
  ...
  /// @brief Method GetCharCount addr 0x22ed990 size 0x6c0 virtual true final false
  inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t> bytes, int32_t count, ::System::Text::DecoderNLS* baseDecoder);

  /// @brief Method GetChars addr 0x22ee050 size 0x920 virtual true final false
  ...
  /// @brief Method GetEncoder addr 0x22ee970 size 0x60 virtual true final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method GetDecoder addr 0x22ee9d0 size 0x64 virtual true final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetPreamble addr 0x22eea34 size 0xfc virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  /// @brief Method get_Preamble addr 0x22eeb30 size 0x170 virtual true final false
  inline ::System::ReadOnlySpan_1<uint8_t> get_Preamble();

  /// @brief Method GetMaxByteCount addr 0x22eeca0 size 0x108 virtual true final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount addr 0x22eeda8 size 0x10c virtual true final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method Equals addr 0x22eeeb4 size 0x114 virtual true final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode addr 0x22eefc8 size 0x7c virtual true final false
