...
public:
  ...
  /// @brief Method Fallback, addr 0x5b1d124, size 0x40, virtual true, abstract: false, final false
  inline bool Fallback(::ArrayW<uint8_t, ::Array<uint8_t>*> bytesUnknown, int32_t index);

  /// @brief Method GetNextChar, addr 0x5b1d164, size 0x7c, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method InternalFallback, addr 0x5b1d1fc, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5b1d1ec, size 0x10, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5b1d050, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::DecoderReplacementFallback* fallback);

  /// @brief Method get_Remaining, addr 0x5b1d1e0, size 0xc, virtual true, abstract: false, final false
