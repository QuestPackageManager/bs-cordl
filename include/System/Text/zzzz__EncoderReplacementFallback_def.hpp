...
public:
  ...
  /// @brief Method .ctor addr 0x22dcee8 size 0x48 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x22dd0d8 size 0x104 virtual false final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x22dd1dc size 0x5c virtual true final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  static inline ::System::Text::EncoderReplacementFallback* New_ctor(::StringW replacement);

  /// @brief Method .ctor addr 0x22dcf30 size 0x1a8 virtual false final false
  inline void _ctor(::StringW replacement);

  /// @brief Method get_DefaultString addr 0x22dd238 size 0x8 virtual false final false
  inline ::StringW get_DefaultString();

  /// @brief Method CreateFallbackBuffer addr 0x22dd240 size 0x60 virtual true final false
  inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer();

  /// @brief Method get_MaxCharCount addr 0x22dd2e8 size 0x1c virtual true final false
  inline int32_t get_MaxCharCount();

  /// @brief Method Equals addr 0x22dd304 size 0x80 virtual true final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode addr 0x22dd384 size 0x20 virtual true final false
