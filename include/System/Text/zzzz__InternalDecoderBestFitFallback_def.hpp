...
public:
  ...
  /// @brief Method CreateFallbackBuffer, addr 0x3e705f4, size 0x58, virtual true, abstract: false, final false
  inline ::System::Text::DecoderFallbackBuffer* CreateFallbackBuffer();

  /// @brief Method Equals, addr 0x3e70778, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x3e70820, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e705bc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_MaxCharCount, addr 0x3e70770, size 0x8, virtual true, abstract: false, final false
