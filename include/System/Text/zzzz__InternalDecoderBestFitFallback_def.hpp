...
public:
  ...
  /// @brief Method CreateFallbackBuffer, addr 0x5b8d8d8, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Text::DecoderFallbackBuffer* CreateFallbackBuffer();

  /// @brief Method Equals, addr 0x5b8da54, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5b8db04, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b8d8c4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_MaxCharCount, addr 0x5b8da4c, size 0x8, virtual true, abstract: false, final false
