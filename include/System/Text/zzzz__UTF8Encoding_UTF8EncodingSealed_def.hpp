...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UTF8Encoding_UTF8EncodingSealed", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UTF8Encoding_UTF8EncodingSealed(UTF8Encoding_UTF8EncodingSealed&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UTF8Encoding_UTF8EncodingSealed", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UTF8Encoding_UTF8EncodingSealed(UTF8Encoding_UTF8EncodingSealedconst&) = delete;
