...
/// @brief Method .ctor, addr 0x5933cac, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(bool  encoderShouldEmitUTF8Identifier) ;

/// @brief Method get_Preamble, addr 0x5933d38, size 0xf8, virtual true, abstract: false, final false
