...
public:
  ...
  /// @brief Method .ctor, addr 0x59337a0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(bool encoderShouldEmitUTF8Identifier);

  /// @brief Method get_Preamble, addr 0x593382c, size 0xf8, virtual true, abstract: false, final false
