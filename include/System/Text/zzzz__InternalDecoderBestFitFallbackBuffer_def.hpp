...
public:
  ...
  /// @brief Method Fallback, addr 0x5ccba80, size 0x40, virtual true, abstract: false, final false
  inline bool Fallback(::ArrayW<uint8_t> bytesUnknown, int32_t index);

  /// @brief Method GetNextChar, addr 0x5ccbc0c, size 0x40, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method InternalFallback, addr 0x5ccbc68, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5ccbc58, size 0x10, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method TryBestFit, addr 0x5ccbac0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ccb7f8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InternalSyncObject, addr 0x5ccb9e8, size 0x94, virtual false, abstract: false, final false
  static inline ::System::Object* get_InternalSyncObject();

  /// @brief Method get_Remaining, addr 0x5ccbc4c, size 0xc, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InternalDecoderBestFitFallbackBuffer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InternalDecoderBestFitFallbackBuffer(InternalDecoderBestFitFallbackBuffer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InternalDecoderBestFitFallbackBuffer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InternalDecoderBestFitFallbackBuffer(InternalDecoderBestFitFallbackBufferconst&) = delete;
