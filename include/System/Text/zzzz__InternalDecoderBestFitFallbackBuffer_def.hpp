...
/// @brief Method Fallback, addr 0x5b1bbd4, size 0x40, virtual true, abstract: false, final false
inline bool Fallback(::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x5b1bd60, size 0x40, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method InternalFallback, addr 0x5b1bdbc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x5b1bdac, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method TryBestFit, addr 0x5b1bc14, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b1b94c, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method get_InternalSyncObject, addr 0x5b1bb3c, size 0x94, virtual false, abstract: false, final false
static inline ::System::Object* get_InternalSyncObject() ;

/// @brief Method get_Remaining, addr 0x5b1bda0, size 0xc, virtual true, abstract: false, final false
