...
public:
  ...
  /// @brief Method Convert, addr 0x5b8d3c8, size 0x2dc, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x5b8d6a4, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x5b8cf50, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetCharCount, addr 0x5b8cf5c, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x5b8d0b4, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x5b8d2d0, size 0xf8, virtual true, abstract: false, final false
  inline int32_t GetChars(::System::ReadOnlySpan_1<uint8_t> bytes, ::System::Span_1<char16_t> chars, bool flush);

  /// @brief Method GetChars, addr 0x5b8d0c0, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5b8ce28, size 0x128, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5b8ce0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0x5b8ce10, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::DecoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0x5b8c72c, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::DecoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0x5b8ce18, size 0x10, virtual false, abstract: false, final false
