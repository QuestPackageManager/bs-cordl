...
public:
  ...
  /// @brief Method Convert, addr 0x29b7ee4, size 0x2f8, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x29b81dc, size 0x22c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x29b7aa8, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetCharCount, addr 0x29b7ab4, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x29b7c18, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChars, addr 0x29b7e3c, size 0xa8, virtual true, abstract: false, final false
  inline int32_t GetChars(::System::ReadOnlySpan_1<uint8_t> bytes, ::System::Span_1<char16_t> chars, bool flush);

  /// @brief Method GetChars, addr 0x29b7c24, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x29b79a0, size 0x108, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x29b7980, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0x29b7988, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::DecoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0x29b72c0, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::DecoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0x29b7990, size 0x10, virtual false, abstract: false, final false
