...
/// @brief Method Convert, addr 0x5b1b3e0, size 0x2dc, virtual true, abstract: false, final false
...
/// @brief Method Convert, addr 0x5b1b6bc, size 0x220, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x5b1af68, size 0xc, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count, bool  flush) ;

/// @brief Method GetCharCount, addr 0x5b1af74, size 0x158, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x5b1b0cc, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x5b1b2e8, size 0xf8, virtual true, abstract: false, final false
inline int32_t GetChars(::System::ReadOnlySpan_1<uint8_t>  bytes, ::System::Span_1<char16_t>  chars, bool  flush) ;

/// @brief Method GetChars, addr 0x5b1b0d8, size 0x210, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x5b1ae40, size 0x128, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x5b1ae24, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Fallback, addr 0x5b1ae28, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::DecoderFallback* get_Fallback() ;

/// @brief Method get_FallbackBuffer, addr 0x5b1a744, size 0x3c, virtual false, abstract: false, final false
inline ::System::Text::DecoderFallbackBuffer* get_FallbackBuffer() ;

/// @brief Method get_InternalHasFallbackBuffer, addr 0x5b1ae30, size 0x10, virtual false, abstract: false, final false
