...
// Write type traits
MARK_REF_T(::System::Text::EncoderFallbackBuffer*);
DEFINE_IL2CPP_CLASS(::System::Text::EncoderFallbackBuffer*, "System.Text", "EncoderFallbackBuffer");
...
public:
  ...
  /// @brief Method InternalFallback, addr 0x5ad20d0, size 0x184, virtual true, abstract: false, final false
  inline bool InternalFallback(char16_t ch, ::by_ref<char16_t*> chars);

  /// @brief Method InternalGetNextChar, addr 0x5ad20a0, size 0x30, virtual false, abstract: false, final false
  inline char16_t InternalGetNextChar();

  /// @brief Method InternalInitialize, addr 0x5ad2088, size 0x18, virtual false, abstract: false, final false
  inline void InternalInitialize(char16_t* charStart, char16_t* charEnd, ::System::Text::EncoderNLS* encoder, bool setEncoder);

  /// @brief Method InternalReset, addr 0x5ad2070, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5ad2048, size 0x28, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ThrowLastCharRecursive, addr 0x5ad2254, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ad1668, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Text::EncoderFallbackBuffer) == 0x30, "Size mismatch!");
