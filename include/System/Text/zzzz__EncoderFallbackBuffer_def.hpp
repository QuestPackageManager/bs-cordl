...
/// @brief Method InternalFallback, addr 0x59248b8, size 0x184, virtual true, abstract: false, final false
inline bool InternalFallback(char16_t  ch, ::ByRef<char16_t*>  chars) ;

/// @brief Method InternalGetNextChar, addr 0x5924888, size 0x30, virtual false, abstract: false, final false
inline char16_t InternalGetNextChar() ;

/// @brief Method InternalInitialize, addr 0x5924870, size 0x18, virtual false, abstract: false, final false
inline void InternalInitialize(char16_t*  charStart, char16_t*  charEnd, ::System::Text::EncoderNLS*  encoder, bool  setEncoder) ;

/// @brief Method InternalReset, addr 0x5924858, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x5924830, size 0x28, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ThrowLastCharRecursive, addr 0x5924a3c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5923e50, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
