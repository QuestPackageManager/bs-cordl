...
/// @brief Method CreateFallbackBuffer, addr 0x5997638, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer() ;

/// @brief Method Equals, addr 0x59977b4, size 0xcc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetHashCode, addr 0x5997880, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x599762c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Text::Encoding*  encoding) ;

/// @brief Method get_MaxCharCount, addr 0x59977ac, size 0x8, virtual true, abstract: false, final false
