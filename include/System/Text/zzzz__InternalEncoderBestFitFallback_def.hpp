...
public:
  ...
  /// @brief Method CreateFallbackBuffer, addr 0x5923648, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer();

  /// @brief Method Equals, addr 0x59237c4, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5923890, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592363c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_MaxCharCount, addr 0x59237bc, size 0x8, virtual true, abstract: false, final false
