...
// Write type traits
MARK_REF_T(::System::Text::InternalEncoderBestFitFallback*);
DEFINE_IL2CPP_CLASS(::System::Text::InternalEncoderBestFitFallback*, "System.Text", "InternalEncoderBestFitFallback");
...
public:
  ...
  /// @brief Method CreateFallbackBuffer, addr 0x5ad366c, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer();

  /// @brief Method Equals, addr 0x5ad37e8, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5ad38b4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ad3660, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_MaxCharCount, addr 0x5ad37e0, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InternalEncoderBestFitFallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InternalEncoderBestFitFallback(InternalEncoderBestFitFallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InternalEncoderBestFitFallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InternalEncoderBestFitFallback(InternalEncoderBestFitFallbackconst&) = delete;
...
static_assert(sizeof(::System::Text::InternalEncoderBestFitFallback) == 0x20, "Size mismatch!");
