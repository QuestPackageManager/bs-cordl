...
namespace System::Text {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2468), inst: 730 }), TypeDefinitionIndex(TypeDefinitionIndex(2468))}
...
public:
  // Declarations
  /// @brief Method .ctor addr 0x22eff3c size 0xc virtual false final false
  inline void _ctor(::System::Span_1<uint8_t> initialBuffer);

  /// @brief Method ConvertAndTerminateString addr 0x22eff48 size 0x224 virtual false final false
  inline ::System::Span_1<uint8_t> ConvertAndTerminateString(::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method Dispose addr 0x22f0218 size 0xf4 virtual false final false
  inline void Dispose();
