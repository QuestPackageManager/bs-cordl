...
public:
  // Declarations
  /// @brief Method ConvertAndTerminateString, addr 0x3c91618, size 0x1f0, virtual false, abstract: false, final false
  inline ::System::Span_1<uint8_t> ConvertAndTerminateString(::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method Dispose, addr 0x3c918ac, size 0xf4, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method .ctor, addr 0x3c9160c, size 0xc, virtual false, abstract: false, final false
