...
public:
  // Declarations
  /// @brief Method ConvertAndTerminateString, addr 0x3c9a51c, size 0x1f0, virtual false, abstract: false, final false
  inline ::System::Span_1<uint8_t> ConvertAndTerminateString(::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method Dispose, addr 0x3c9a7b0, size 0xf4, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method .ctor, addr 0x3c9a510, size 0xc, virtual false, abstract: false, final false
