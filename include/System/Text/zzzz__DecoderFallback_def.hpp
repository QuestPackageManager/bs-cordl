...
public:
  ...
  /// @brief Method get_ReplacementFallback addr 0x262dfac size 0x9c virtual false final false
  static inline ::System::Text::DecoderFallback* get_ReplacementFallback();

  /// @brief Method get_ExceptionFallback addr 0x26313c4 size 0xa4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2630b38 size 0x8 virtual false final false
  inline void _ctor();
