...
// Write type traits
MARK_REF_T(::System::Text::DecoderFallback*);
DEFINE_IL2CPP_CLASS(::System::Text::DecoderFallback*, "System.Text", "DecoderFallback");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5cc9570, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x5cc9d94, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x5cc6ac0, size 0xa8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::DecoderFallback) == 0x10, "Size mismatch!");
