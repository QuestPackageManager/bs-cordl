...
public:
  ...
  /// @brief Method .ctor, addr 0x29ea4d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x29ead64, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x29e79a8, size 0x9c, virtual false, abstract: false, final false
