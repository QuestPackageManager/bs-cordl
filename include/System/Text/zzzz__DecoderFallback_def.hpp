...
public:
  ...
  /// @brief Method .ctor, addr 0x5b1b3e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x5b1bc50, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x5b1890c, size 0xa4, virtual false, abstract: false, final false
