...
public:
  ...
  /// @brief Method .ctor, addr 0x3e6eb40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x3e6f3a8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x3e6c0c0, size 0x94, virtual false, abstract: false, final false
