...
public:
  ...
  /// @brief Method .ctor, addr 0x3e6e7d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x3e6f040, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x3e6bd58, size 0x94, virtual false, abstract: false, final false
