...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Normalization", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Normalization(Normalization&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Normalization", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Normalization(Normalizationconst&) = delete;
