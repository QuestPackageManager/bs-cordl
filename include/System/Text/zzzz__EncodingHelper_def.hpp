...
public:
  ...
  /// @brief Method GetDefaultEncoding, addr 0x3c9d920, size 0x17c, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* GetDefaultEncoding();

  /// @brief Method InternalCodePage, addr 0x3ca0b80, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW InternalCodePage(::ByRef<int32_t> code_page);

  /// @brief Method InvokeI18N, addr 0x3c9bd90, size 0x714, virtual false, abstract: false, final false
  ...
  /// @brief Method get_UTF8Unmarked, addr 0x3ca099c, size 0x1e4, virtual false, abstract: false, final false
