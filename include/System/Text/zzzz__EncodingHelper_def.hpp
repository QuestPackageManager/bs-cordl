...
public:
  ...
  /// @brief Method GetDefaultEncoding, addr 0x59ad3dc, size 0x1a0, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* GetDefaultEncoding();

  /// @brief Method InternalCodePage, addr 0x59b065c, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW InternalCodePage(::ByRef<int32_t> code_page);

  /// @brief Method InvokeI18N, addr 0x59ab8f0, size 0x6cc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_UTF8Unmarked, addr 0x59b0468, size 0x1f4, virtual false, abstract: false, final false
