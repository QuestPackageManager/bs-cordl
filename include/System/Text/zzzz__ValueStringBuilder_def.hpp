...
public:
  ...
  /// @brief Method Append, addr 0x3c8e0e0, size 0x7c, virtual false, abstract: false, final false
  inline void Append(char16_t c);

  /// @brief Method Append, addr 0x3c8e5f8, size 0x128, virtual false, abstract: false, final false
  inline void Append(char16_t c, int32_t count);

  /// @brief Method Append, addr 0x3c8e1dc, size 0xac, virtual false, abstract: false, final false
  inline void Append(::StringW s);

  /// @brief Method Append, addr 0x3c8e720, size 0xe0, virtual false, abstract: false, final false
  inline void Append(::cordl_internals::Ptr<char16_t> value, int32_t length);

  /// @brief Method AppendSlow, addr 0x3c8e288, size 0x12c, virtual false, abstract: false, final false
  inline void AppendSlow(::StringW s);

  /// @brief Method AppendSpan, addr 0x3c8e800, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Span_1<char16_t> AppendSpan(int32_t length);

  /// @brief Method Dispose, addr 0x3c8e8bc, size 0xf8, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Grow, addr 0x3c8e3b4, size 0x244, virtual false, abstract: false, final false
  inline void Grow(int32_t requiredAdditionalCapacity);

  /// @brief Method GrowAndAppend, addr 0x3c8e15c, size 0x80, virtual false, abstract: false, final false
  inline void GrowAndAppend(char16_t c);

  /// @brief Method ToString, addr 0x3c8df2c, size 0xcc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryCopyTo, addr 0x3c8dff8, size 0xe8, virtual false, abstract: false, final false
  inline bool TryCopyTo(::System::Span_1<char16_t> destination, ::ByRef<int32_t> charsWritten);

  /// @brief Method .ctor, addr 0x3c8def0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Span_1<char16_t> initialBuffer);

  /// @brief Method get_Item, addr 0x3c8df08, size 0x24, virtual false, abstract: false, final false
  inline ::ByRef<char16_t> get_Item(int32_t index);

  /// @brief Method get_Length, addr 0x3c8df00, size 0x8, virtual false, abstract: false, final false
