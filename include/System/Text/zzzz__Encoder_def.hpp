...
public:
  ...
  /// @brief Method Convert, addr 0x3e70e78, size 0x2dc, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x3e71154, size 0x380, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x3e70b04, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x3e70c68, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3e70a20, size 0xe4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3e70a10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0x3e70a18, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0x3e6d4a8, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0x3e6d498, size 0x10, virtual false, abstract: false, final false
