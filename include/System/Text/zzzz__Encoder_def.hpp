...
public:
  ...
  /// @brief Method Convert, addr 0x3e6bf04, size 0x2dc, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x3e6c1e0, size 0x380, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x3e6bb90, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x3e6bcf4, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3e6baac, size 0xe4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3e6ba9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0x3e6baa4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0x3e68534, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0x3e68524, size 0x10, virtual false, abstract: false, final false
