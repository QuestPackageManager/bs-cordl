...
public:
  ...
  /// @brief Method Convert, addr 0x58bc7f4, size 0x2dc, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x58bcad0, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x58bc478, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x58bc5e0, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x58bc398, size 0xe0, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x58bc2a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0x58bc2a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0x58bc2b0, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0x58bc388, size 0x10, virtual false, abstract: false, final false
