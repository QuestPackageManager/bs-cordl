...
public:
  ...
  /// @brief Method Convert, addr 0x29ec82c, size 0x2f8, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x29ecb24, size 0x22c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x29ec4a8, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x29ec614, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x29ec3c4, size 0xe4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x29ec3b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0x29ec3bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0x29e8db8, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0x29e8da8, size 0x10, virtual false, abstract: false, final false
