...
public:
  ...
  /// @brief Method .ctor, addr 0x2658b38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0x2658b40, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0x26554dc, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0x26554cc, size 0x10, virtual false, abstract: false, final false
  inline bool get_InternalHasFallbackBuffer();

  /// @brief Method Reset, addr 0x2658b48, size 0xe4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method GetByteCount, addr 0x2658c2c, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x2658d98, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x2658fb0, size 0x2f8, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x26592a8, size 0x22c, virtual true, abstract: false, final false
