...
public:
  ...
  /// @brief Method Convert, addr 0x29ba78c, size 0x2f8, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x29baa84, size 0x122c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x29ba408, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x29ba574, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x29ba324, size 0xe4, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x29ba314, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Fallback, addr 0x29ba31c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallback* get_Fallback();

  /// @brief Method get_FallbackBuffer, addr 0x29b6d18, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* get_FallbackBuffer();

  /// @brief Method get_InternalHasFallbackBuffer, addr 0x29b6d08, size 0x10, virtual false, abstract: false, final false
