...
public:
  ...
  /// @brief Method GetByteCount, addr 0x5f7c410, size 0x49c, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetBytes, addr 0x5f7c8ac, size 0x62c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x5f7ced8, size 0x614, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x5f7d620, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetChars, addr 0x5f7d634, size 0x4fc, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetChars, addr 0x5f7a618, size 0x4fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaxByteCount, addr 0x5f7c2c0, size 0x120, virtual true, abstract: false, final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetMaxCharCount, addr 0x5f7d4ec, size 0x134, virtual true, abstract: false, final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method IsValidLeadBytes, addr 0x5f7c3e0, size 0x1c, virtual false, abstract: false, final false
  inline bool IsValidLeadBytes(int32_t v1, int32_t v2, int32_t v3, int32_t v4);

  /// @brief Method IsValidTailBytes, addr 0x5f7c3fc, size 0x14, virtual false, abstract: false, final false
  inline bool IsValidTailBytes(int32_t v3, int32_t v4);

  static inline ::System::Text::Base64Encoding* New_ctor();

  /// @brief Method .ctor, addr 0x5f7db30, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
