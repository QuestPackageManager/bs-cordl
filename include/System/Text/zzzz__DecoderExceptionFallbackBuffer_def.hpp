...
public:
  ...
  /// @brief Method Fallback, addr 0x28b6150, size 0x8, virtual true, abstract: false, final false
  inline bool Fallback(::ArrayW<uint8_t, ::Array<uint8_t>*> bytesUnknown, int32_t index);

  /// @brief Method GetNextChar, addr 0x28b632c, size 0x8, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  static inline ::System::Text::DecoderExceptionFallbackBuffer* New_ctor();

  /// @brief Method Throw, addr 0x28b6158, size 0x1d4, virtual false, abstract: false, final false
  inline void Throw(::ArrayW<uint8_t, ::Array<uint8_t>*> bytesUnknown, int32_t index);

  /// @brief Method .ctor, addr 0x28b60dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Remaining, addr 0x28b6334, size 0x8, virtual true, abstract: false, final false
