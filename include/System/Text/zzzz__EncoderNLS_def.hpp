...
public:
  ...
  /// @brief Method ClearMustFlush, addr 0x599756c, size 0x8, virtual false, abstract: false, final false
  inline void ClearMustFlush();

  /// @brief Method Convert, addr 0x59970e4, size 0x2c8, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x59973ac, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x5996a78, size 0x1d8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count, bool flush);

  /// @brief Method GetByteCount, addr 0x5996c50, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetByteCount(char16_t* chars, int32_t count, bool flush);

  /// @brief Method GetBytes, addr 0x5996d40, size 0x28c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x5996fcc, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5996a58, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5996a30, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_Encoding, addr 0x599754c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method get_HasState, addr 0x599755c, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasState();

  /// @brief Method get_MustFlush, addr 0x5997554, size 0x8, virtual false, abstract: false, final false
