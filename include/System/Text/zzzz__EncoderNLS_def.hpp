...
public:
  ...
  /// @brief Method ClearMustFlush, addr 0x26b39d4, size 0x8, virtual false, abstract: false, final false
  inline void ClearMustFlush();

  /// @brief Method Convert, addr 0x26b3540, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x26b380c, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetByteCount, addr 0x26b2eb8, size 0x1d8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count, bool flush);

  /// @brief Method GetByteCount, addr 0x26b3090, size 0xf8, virtual true, abstract: false, final false
  inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t> chars, int32_t count, bool flush);

  /// @brief Method GetBytes, addr 0x26b3188, size 0x298, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBytes, addr 0x26b3420, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x26b2e98, size 0x20, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x26b2e54, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::Encoding* encoding);

  /// @brief Method get_Encoding, addr 0x26b39b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method get_HasState, addr 0x26b39c4, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasState();

  /// @brief Method get_MustFlush, addr 0x26b39bc, size 0x8, virtual false, abstract: false, final false
