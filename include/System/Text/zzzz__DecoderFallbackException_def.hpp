...
public:
  ...
  /// @brief Method .ctor, addr 0x29d52a4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x29d5274, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytesUnknown, int32_t index);

  /// @brief Method .ctor, addr 0x29d5300, size 0x8, virtual false, abstract: false, final false
