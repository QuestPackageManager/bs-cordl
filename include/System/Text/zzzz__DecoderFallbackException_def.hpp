...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecoderFallbackException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecoderFallbackException(DecoderFallbackException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecoderFallbackException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecoderFallbackException(DecoderFallbackExceptionconst&) = delete;
