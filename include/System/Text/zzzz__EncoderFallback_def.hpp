...
public:
  ...
  /// @brief Method .ctor, addr 0x27b60e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x27b6ee4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x27b6e04, size 0x98, virtual false, abstract: false, final false
