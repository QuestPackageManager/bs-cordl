...
public:
  ...
  /// @brief Method .ctor, addr 0x26b7ce4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x26b8ae8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x26b8a08, size 0x98, virtual false, abstract: false, final false
