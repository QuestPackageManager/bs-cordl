...
public:
  ...
  /// @brief Method .ctor, addr 0x5995abc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ExceptionFallback, addr 0x5996704, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReplacementFallback, addr 0x59950b0, size 0x9c, virtual false, abstract: false, final false
