...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Action_15", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Action_15(Action_15&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Action_15", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Action_15(Action_15const&) = delete;
