...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Func_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Func_1(Func_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Func_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Func_1(Func_1const&) = delete;
