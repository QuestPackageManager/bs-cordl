...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5b52744, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b526d8, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DoWindowsConsoleCancelEvent, addr 0x5b525d4, size 0x64, virtual false, abstract: false, final false
  static inline bool DoWindowsConsoleCancelEvent(int32_t keyCode);

  /// @brief Method GetConsoleCP, addr 0x5b52508, size 0x64, virtual false, abstract: false, final false
  static inline int32_t GetConsoleCP();

  /// @brief Method GetConsoleOutputCP, addr 0x5b5256c, size 0x68, virtual false, abstract: false, final false
  static inline int32_t GetConsoleOutputCP();

  /// @brief Method GetInputCodePage, addr 0x5b513dc, size 0x50, virtual false, abstract: false, final false
  static inline int32_t GetInputCodePage();

  /// @brief Method GetOutputCodePage, addr 0x5b5142c, size 0x50, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DoConsoleCancelEvent, addr 0x5b5230c, size 0x1fc, virtual false, abstract: false, final false
  static inline void DoConsoleCancelEvent();

  /// @brief Method Open, addr 0x5b51be4, size 0x164, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* Open(::System::IntPtr handle, ::System::IO::FileAccess access, int32_t bufferSize);

  /// @brief Method OpenStandardError, addr 0x5b51a98, size 0x94, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* OpenStandardError(int32_t bufferSize);

  /// @brief Method OpenStandardInput, addr 0x5b51970, size 0x94, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* OpenStandardInput(int32_t bufferSize);

  /// @brief Method OpenStandardOutput, addr 0x5b51a04, size 0x94, virtual false, abstract: false, final false
  static inline ::System::IO::Stream* OpenStandardOutput(int32_t bufferSize);

  /// @brief Method ReadKey, addr 0x5b52170, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::ConsoleKeyInfo ReadKey();

  /// @brief Method ReadKey, addr 0x5b521cc, size 0x60, virtual false, abstract: false, final false
  static inline ::System::ConsoleKeyInfo ReadKey(bool intercept);

  /// @brief Method SetError, addr 0x5b51d48, size 0xe8, virtual false, abstract: false, final false
  static inline void SetError(::System::IO::TextWriter* newError);

  /// @brief Method SetOut, addr 0x5b51e30, size 0xe8, virtual false, abstract: false, final false
  static inline void SetOut(::System::IO::TextWriter* newOut);

  /// @brief Method SetupStreams, addr 0x5b5147c, size 0x3b0, virtual false, abstract: false, final false
  static inline void SetupStreams(::System::Text::Encoding* inputEncoding, ::System::Text::Encoding* outputEncoding);

  /// @brief Method WriteLine, addr 0x5b51f90, size 0x88, virtual false, abstract: false, final false
  static inline void WriteLine(::StringW format, ::System::Object* arg0);

  /// @brief Method WriteLine, addr 0x5b52018, size 0xa0, virtual false, abstract: false, final false
  static inline void WriteLine(::StringW format, ::System::Object* arg0, ::System::Object* arg1, ::System::Object* arg2);

  /// @brief Method WriteLine, addr 0x5b51f18, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Error, addr 0x5b51b2c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::IO::TextWriter* get_Error();

  /// @brief Method get_InputEncoding, addr 0x5b520b8, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* get_InputEncoding();

  /// @brief Method get_Out, addr 0x5b51b88, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::IO::TextWriter* get_Out();

  /// @brief Method get_OutputEncoding, addr 0x5b52114, size 0x5c, virtual false, abstract: false, final false
