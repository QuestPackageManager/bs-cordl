...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Enum_ParseFailureKind, "System", "Enum/ParseFailureKind");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::Enum_ParseFailureKind) == 0x4, "Size mismatch!");
