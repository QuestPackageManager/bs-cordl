...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Func_11);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Func_11, "System", "Func`11");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Func_11", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Func_11(Func_11&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Func_11", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Func_11(Func_11const&) = delete;
