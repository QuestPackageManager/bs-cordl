...
public:
  ...
  /// @brief Method Compare, addr 0x5a47f78, size 0x14, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW x, ::StringW y);

  /// @brief Method Equals, addr 0x5a47f8c, size 0x14, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x5a47fa0, size 0x68, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW obj);

  /// @brief Method GetObjectData, addr 0x5a48008, size 0xa4, virtual true, abstract: false, final true
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  static inline ::System::OrdinalIgnoreCaseComparer* New_ctor();

  /// @brief Method .ctor, addr 0x5a475e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
