...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Tuple_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Tuple_2(Tuple_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Tuple_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Tuple_2(Tuple_2const&) = delete;
