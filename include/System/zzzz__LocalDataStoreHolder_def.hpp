...
public:
  ...
  /// @brief Method Finalize, addr 0x5b33084, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b3307c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::LocalDataStore* store);

  /// @brief Method get_Store, addr 0x5b330e8, size 0x8, virtual false, abstract: false, final false
