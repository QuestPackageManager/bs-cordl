...
public:
  ...
  /// @brief Method Finalize, addr 0x5ac0b90, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ac0b88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::LocalDataStore* store);

  /// @brief Method get_Store, addr 0x5ac0bf4, size 0x8, virtual false, abstract: false, final false
