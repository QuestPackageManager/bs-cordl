...
public:
  ...
  /// @brief Method GetPreamble, addr 0x2eeb104, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  static inline ::System::Xml::Ucs4Encoding1234* New_ctor();

  /// @brief Method .ctor, addr 0x2eeaed0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EncodingName, addr 0x2eeb0c4, size 0x40, virtual true, abstract: false, final false
