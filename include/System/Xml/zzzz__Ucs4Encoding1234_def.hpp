...
public:
  ...
  /// @brief Method .ctor addr 0x2728db0 size 0x68 virtual false final false
  inline void _ctor();

  /// @brief Method get_EncodingName addr 0x2728fa4 size 0x40 virtual true final false
  inline ::StringW get_EncodingName();

  /// @brief Method GetPreamble addr 0x2728fe4 size 0x78 virtual true final false
