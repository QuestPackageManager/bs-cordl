...
public:
  ...
  /// @brief Method Count, addr 0x5ff7c80, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t Count(uint32_t num);

  /// @brief Method LeastPosition, addr 0x5ff7d20, size 0x70, virtual false, abstract: false, final false
