...
public:
  ...
  /// @brief Method PrivateDisposeNodeList, addr 0x6186390, size 0x4, virtual true, abstract: false, final false
  inline void PrivateDisposeNodeList();

  /// @brief Method System.IDisposable.Dispose, addr 0x6186384, size 0xc, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method .ctor, addr 0x61785b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_ItemOf, addr 0x6186378, size 0xc, virtual true, abstract: false, final false
