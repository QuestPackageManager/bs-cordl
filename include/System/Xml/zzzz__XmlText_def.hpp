...
public:
  ...
  /// @brief Method .ctor addr 0x288baec size 0xc virtual false final false
  inline void _ctor(::StringW strData);

  static inline ::System::Xml::XmlText* New_ctor(::StringW strData, ::System::Xml::XmlDocument* doc);

  /// @brief Method .ctor addr 0x288bae4 size 0x8 virtual false final false
  inline void _ctor(::StringW strData, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_Name addr 0x2891da0 size 0x28 virtual true final false
  inline ::StringW get_Name();

  /// @brief Method get_LocalName addr 0x2891dc8 size 0x28 virtual true final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NodeType addr 0x2891df0 size 0x8 virtual true final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_ParentNode addr 0x2891df8 size 0x84 virtual true final false
  inline ::System::Xml::XmlNode* get_ParentNode();

  /// @brief Method CloneNode addr 0x2891e7c size 0x5c virtual true final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  /// @brief Method get_Value addr 0x2891ed8 size 0x10 virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x2891ee8 size 0xd4 virtual true final false
  inline void set_Value(::StringW value);

  /// @brief Method get_IsText addr 0x2891fbc size 0x8 virtual true final false
