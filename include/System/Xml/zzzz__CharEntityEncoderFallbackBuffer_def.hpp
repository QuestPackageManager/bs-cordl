...
public:
  ...
  /// @brief Method Fallback, addr 0x5ff80ac, size 0x1d0, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknown, int32_t index);

  /// @brief Method Fallback, addr 0x5ff827c, size 0x25c, virtual true, abstract: false, final false
  inline bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index);

  /// @brief Method GetNextChar, addr 0x5ff84f4, size 0x6c, virtual true, abstract: false, final false
  inline char16_t GetNextChar();

  /// @brief Method MovePrevious, addr 0x5ff8560, size 0x1c, virtual true, abstract: false, final false
  inline bool MovePrevious();

  static inline ::System::Xml::CharEntityEncoderFallbackBuffer* New_ctor(::System::Xml::CharEntityEncoderFallback* parent);

  /// @brief Method Reset, addr 0x5ff85ac, size 0xc, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SurrogateCharToUtf32, addr 0x5ff84d8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ff7ff0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::CharEntityEncoderFallback* parent);

  /// @brief Method get_Remaining, addr 0x5ff857c, size 0x30, virtual true, abstract: false, final false
