...
public:
  // Declarations
  /// @brief Method CDataNormalize, addr 0x6197f4c, size 0x1f8, virtual false, abstract: false, final false
  static inline ::StringW CDataNormalize(::StringW value);

  /// @brief Method NonCDataNormalize, addr 0x6197c3c, size 0x310, virtual false, abstract: false, final false
