...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlComplianceUtil", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlComplianceUtil(XmlComplianceUtil&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlComplianceUtil", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlComplianceUtil(XmlComplianceUtilconst&) = delete;
