...
public:
  // Declarations
  /// @brief Method CDataNormalize, addr 0x6125880, size 0x1f8, virtual false, abstract: false, final false
  static inline ::StringW CDataNormalize(::StringW value);

  /// @brief Method NonCDataNormalize, addr 0x6125570, size 0x310, virtual false, abstract: false, final false
