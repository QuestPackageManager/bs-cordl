...
public:
  // Declarations
  /// @brief Method CDataNormalize, addr 0x2db1560, size 0x1e4, virtual false, abstract: false, final false
  static inline ::StringW CDataNormalize(::StringW value);

  /// @brief Method NonCDataNormalize, addr 0x2db12d4, size 0x28c, virtual false, abstract: false, final false
