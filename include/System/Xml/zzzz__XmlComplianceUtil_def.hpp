...
public:
  // Declarations
  /// @brief Method CDataNormalize, addr 0x60bdcf4, size 0x1f8, virtual false, abstract: false, final false
  static inline ::StringW CDataNormalize(::StringW value);

  /// @brief Method NonCDataNormalize, addr 0x60bd9e4, size 0x310, virtual false, abstract: false, final false
