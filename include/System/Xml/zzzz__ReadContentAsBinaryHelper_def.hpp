...
public:
  ...
  /// @brief Method CreateOrReset, addr 0x6070270, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Finish, addr 0x6070934, size 0x148, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method Init, addr 0x60704d8, size 0x2c, virtual false, abstract: false, final false
  inline bool Init();

  /// @brief Method InitBase64Decoder, addr 0x607066c, size 0x70, virtual false, abstract: false, final false
  inline void InitBase64Decoder();

  /// @brief Method InitBinHexDecoder, addr 0x60708c4, size 0x70, virtual false, abstract: false, final false
  inline void InitBinHexDecoder();

  /// @brief Method MoveToNextContentNode, addr 0x6070a7c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadContentAsBase64, addr 0x60702f4, size 0x1e4, virtual false, abstract: false, final false
  inline int32_t ReadContentAsBase64(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBinHex, addr 0x60706dc, size 0x1e8, virtual false, abstract: false, final false
  inline int32_t ReadContentAsBinHex(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBinary, addr 0x6070504, size 0x168, virtual false, abstract: false, final false
  inline int32_t ReadContentAsBinary(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Reset, addr 0x60702e8, size 0xc, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x60701e4, size 0x8c, virtual false, abstract: false, final false
