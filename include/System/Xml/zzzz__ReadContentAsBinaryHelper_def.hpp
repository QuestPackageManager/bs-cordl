...
public:
  ...
  /// @brief Method CreateOrReset, addr 0x61acee4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Finish, addr 0x61ad5a8, size 0x148, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method Init, addr 0x61ad14c, size 0x2c, virtual false, abstract: false, final false
  inline bool Init();

  /// @brief Method InitBase64Decoder, addr 0x61ad2e0, size 0x70, virtual false, abstract: false, final false
  inline void InitBase64Decoder();

  /// @brief Method InitBinHexDecoder, addr 0x61ad538, size 0x70, virtual false, abstract: false, final false
  inline void InitBinHexDecoder();

  /// @brief Method MoveToNextContentNode, addr 0x61ad6f0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadContentAsBase64, addr 0x61acf68, size 0x1e4, virtual false, abstract: false, final false
  inline int32_t ReadContentAsBase64(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBinHex, addr 0x61ad350, size 0x1e8, virtual false, abstract: false, final false
  inline int32_t ReadContentAsBinHex(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBinary, addr 0x61ad178, size 0x168, virtual false, abstract: false, final false
  inline int32_t ReadContentAsBinary(::ArrayW<uint8_t> buffer, int32_t index, int32_t count);

  /// @brief Method Reset, addr 0x61acf5c, size 0xc, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x61ace58, size 0x8c, virtual false, abstract: false, final false
