...
/// @brief Method CreateOrReset, addr 0x5ffe264, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method Finish, addr 0x5ffe928, size 0x148, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method Init, addr 0x5ffe4cc, size 0x2c, virtual false, abstract: false, final false
inline bool Init() ;

/// @brief Method InitBase64Decoder, addr 0x5ffe660, size 0x70, virtual false, abstract: false, final false
inline void InitBase64Decoder() ;

/// @brief Method InitBinHexDecoder, addr 0x5ffe8b8, size 0x70, virtual false, abstract: false, final false
inline void InitBinHexDecoder() ;

/// @brief Method MoveToNextContentNode, addr 0x5ffea70, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method ReadContentAsBase64, addr 0x5ffe2e8, size 0x1e4, virtual false, abstract: false, final false
inline int32_t ReadContentAsBase64(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadContentAsBinHex, addr 0x5ffe6d0, size 0x1e8, virtual false, abstract: false, final false
inline int32_t ReadContentAsBinHex(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadContentAsBinary, addr 0x5ffe4f8, size 0x168, virtual false, abstract: false, final false
inline int32_t ReadContentAsBinary(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Reset, addr 0x5ffe2dc, size 0xc, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x5ffe1d8, size 0x8c, virtual false, abstract: false, final false
