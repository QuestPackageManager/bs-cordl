...
public:
  ...
  /// @brief Method HasLineInfo, addr 0x618b960, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x618b954, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method get_LineNumber, addr 0x618ba04, size 0xa8, virtual true, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x618baac, size 0xa8, virtual true, abstract: false, final false
