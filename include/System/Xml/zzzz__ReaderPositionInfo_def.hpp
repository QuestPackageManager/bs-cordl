...
public:
  ...
  /// @brief Method HasLineInfo, addr 0x62cddec, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62cdde0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method get_LineNumber, addr 0x62cde90, size 0xa8, virtual true, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x62cdf38, size 0xa8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReaderPositionInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReaderPositionInfo(ReaderPositionInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReaderPositionInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReaderPositionInfo(ReaderPositionInfoconst&) = delete;
