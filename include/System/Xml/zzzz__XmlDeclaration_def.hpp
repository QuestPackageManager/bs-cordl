...
public:
  ...
  /// @brief Method .ctor addr 0x28840e8 size 0x190 virtual false final false
  inline void _ctor(::StringW version, ::StringW encoding, ::StringW standalone, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_Version addr 0x28844a8 size 0x8 virtual false final false
  inline ::StringW get_Version();

  /// @brief Method set_Version addr 0x28844b0 size 0x8 virtual false final false
  inline void set_Version(::StringW value);

  /// @brief Method get_Encoding addr 0x28844b8 size 0x8 virtual false final false
  inline ::StringW get_Encoding();

  /// @brief Method set_Encoding addr 0x28842f4 size 0x68 virtual false final false
  inline void set_Encoding(::StringW value);

  /// @brief Method get_Standalone addr 0x28844c0 size 0x8 virtual false final false
  inline ::StringW get_Standalone();

  /// @brief Method set_Standalone addr 0x288435c size 0x14c virtual false final false
  inline void set_Standalone(::StringW value);

  /// @brief Method get_Value addr 0x28844c8 size 0x10 virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x28844d8 size 0x10 virtual true final false
  inline void set_Value(::StringW value);

  /// @brief Method get_InnerText addr 0x28844e8 size 0x168 virtual true final false
  inline ::StringW get_InnerText();

  /// @brief Method set_InnerText addr 0x2884650 size 0x18c virtual true final false
  inline void set_InnerText(::StringW value);

  /// @brief Method get_Name addr 0x28847dc size 0x40 virtual true final false
  inline ::StringW get_Name();

  /// @brief Method get_LocalName addr 0x288481c size 0xc virtual true final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NodeType addr 0x2884828 size 0x8 virtual true final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method CloneNode addr 0x2884830 size 0x3c virtual true final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  /// @brief Method IsValidXmlVersion addr 0x2884278 size 0x7c virtual false final false
