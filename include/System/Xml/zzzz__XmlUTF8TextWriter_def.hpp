...
// Write type traits
MARK_REF_T(::System::Xml::XmlUTF8TextWriter*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlUTF8TextWriter*, "System.Xml", "XmlUTF8TextWriter");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlUTF8TextWriter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlUTF8TextWriter(XmlUTF8TextWriter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlUTF8TextWriter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlUTF8TextWriter(XmlUTF8TextWriterconst&) = delete;
...
static_assert(sizeof(::System::Xml::XmlUTF8TextWriter) == 0xa0, "Size mismatch!");
