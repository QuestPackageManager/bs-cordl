...
/// @brief Method SetOutput, addr 0x5f78bb8, size 0x160, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5f78e14, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
