...
public:
  ...
  /// @brief Method SetOutput, addr 0x5feabc4, size 0x160, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5feae20, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
