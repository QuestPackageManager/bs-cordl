...
// Write type traits
MARK_REF_T(::System::Xml::HWStack*);
DEFINE_IL2CPP_CLASS(::System::Xml::HWStack*, "System.Xml", "HWStack");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_stack, put = __cordl_internal_set_stack)) ::ArrayW<::System::Object*> stack;
  ...
  /// @brief Method AddToTop, addr 0x62c829c, size 0x6c, virtual false, abstract: false, final false
  inline void AddToTop(::System::Object* o);

  /// @brief Method Clone, addr 0x62c843c, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method Peek, addr 0x62c8258, size 0x44, virtual false, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method Pop, addr 0x62c8210, size 0x48, virtual false, abstract: false, final false
  inline ::System::Object* Pop();

  /// @brief Method Push, addr 0x62c80d8, size 0x138, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_stack() const;

  constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_stack();
  ...
  constexpr void __cordl_internal_set_stack(::ArrayW<::System::Object*> value);

  constexpr void __cordl_internal_set_used(int32_t value);

  /// @brief Method .ctor, addr 0x62c8064, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t GrowthRate);

  /// @brief Method .ctor, addr 0x62c806c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t GrowthRate, int32_t limit);

  /// @brief Method .ctor, addr 0x62c842c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Object*> stack, int32_t growthRate, int32_t used, int32_t size);

  /// @brief Method get_Item, addr 0x62c8308, size 0x74, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Method get_Length, addr 0x62c8424, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Item, addr 0x62c837c, size 0xa8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::HWStack) == 0x28, "Size mismatch!");
