...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HWStack", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HWStack(HWStack&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HWStack", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HWStack(HWStackconst&) = delete;
