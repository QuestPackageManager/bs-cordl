...
public:
  ...
  /// @brief Method ReadArray, addr 0x5ee1948, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x5ee1980, size 0x3c, virtual true, abstract: false, final false
  inline void WriteArray(::System::Xml::XmlDictionaryWriter* writer, ::StringW prefix, ::StringW localName, ::StringW namespaceUri, ::ArrayW<bool, ::Array<bool>*> array, int32_t offset,
                         int32_t count);

  /// @brief Method .ctor, addr 0x5ee19bc, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
