...
public:
  ...
  /// @brief Method ReadArray, addr 0x60fe02c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x60fe064, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60fe0a0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BooleanArrayHelperWithString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BooleanArrayHelperWithString(BooleanArrayHelperWithString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BooleanArrayHelperWithString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BooleanArrayHelperWithString(BooleanArrayHelperWithStringconst&) = delete;
