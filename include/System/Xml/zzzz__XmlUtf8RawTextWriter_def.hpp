...
public:
  ...
  /// @brief Method AmpEntity, addr 0x615c9b4, size 0x1c, virtual false, abstract: false, final false
  static inline uint8_t* AmpEntity(uint8_t* pDst);

  /// @brief Method CarriageReturnEntity, addr 0x615ca28, size 0x1c, virtual false, abstract: false, final false
  static inline uint8_t* CarriageReturnEntity(uint8_t* pDst);

  /// @brief Method CharEntity, addr 0x615cef4, size 0xac, virtual false, abstract: false, final false
  static inline uint8_t* CharEntity(uint8_t* pDst, char16_t ch);

  /// @brief Method CharToUTF8, addr 0x615d064, size 0xb4, virtual false, abstract: false, final false
  static inline void CharToUTF8(::ByRef<char16_t*> pSrc, char16_t* pSrcEnd, ::ByRef<uint8_t*> pDst);

  /// @brief Method Close, addr 0x615c6f4, size 0xf0, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EncodeChar, addr 0x615cfa0, size 0xc4, virtual false, abstract: false, final false
  inline void EncodeChar(::ByRef<char16_t*> pSrc, char16_t* pSrcEnd, ::ByRef<uint8_t*> pDst);

  /// @brief Method EncodeMultibyteUTF8, addr 0x615cca0, size 0x44, virtual false, abstract: false, final false
  static inline uint8_t* EncodeMultibyteUTF8(int32_t ch, uint8_t* pDst);

  /// @brief Method EncodeSurrogate, addr 0x615ca60, size 0x190, virtual false, abstract: false, final false
  static inline uint8_t* EncodeSurrogate(char16_t* pSrc, char16_t* pSrcEnd, uint8_t* pDst);

  /// @brief Method Flush, addr 0x615c7e8, size 0x3c, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushBuffer, addr 0x615c824, size 0x190, virtual true, abstract: false, final false
  inline void FlushBuffer();

  /// @brief Method FlushEncoder, addr 0x615c7e4, size 0x4, virtual false, abstract: false, final false
  inline void FlushEncoder();

  /// @brief Method GtEntity, addr 0x615c9e0, size 0x10, virtual false, abstract: false, final false
  static inline uint8_t* GtEntity(uint8_t* pDst);

  /// @brief Method InvalidXmlChar, addr 0x615cbf0, size 0xb0, virtual false, abstract: false, final false
  inline uint8_t* InvalidXmlChar(int32_t ch, uint8_t* pDst, bool entitize);

  /// @brief Method IsSurrogateByte, addr 0x615cee4, size 0x10, virtual false, abstract: false, final false
  static inline bool IsSurrogateByte(uint8_t b);

  /// @brief Method LineFeedEntity, addr 0x615ca44, size 0x1c, virtual false, abstract: false, final false
  static inline uint8_t* LineFeedEntity(uint8_t* pDst);

  /// @brief Method LtEntity, addr 0x615c9d0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method QuoteEntity, addr 0x615c9f0, size 0x1c, virtual false, abstract: false, final false
  static inline uint8_t* QuoteEntity(uint8_t* pDst);

  /// @brief Method RawEndCData, addr 0x615cea8, size 0x18, virtual false, abstract: false, final false
  static inline uint8_t* RawEndCData(uint8_t* pDst);

  /// @brief Method RawStartCData, addr 0x615cec0, size 0x24, virtual false, abstract: false, final false
  static inline uint8_t* RawStartCData(uint8_t* pDst);

  /// @brief Method RawText, addr 0x615cd38, size 0x170, virtual false, abstract: false, final false
  inline void RawText(char16_t* pSrcBegin, char16_t* pSrcEnd);

  /// @brief Method RawText, addr 0x615a698, size 0x1c, virtual false, abstract: false, final false
  inline void RawText(::StringW s);

  /// @brief Method StartElementContent, addr 0x615aa00, size 0x48, virtual true, abstract: false, final false
  inline void StartElementContent();

  /// @brief Method TabEntity, addr 0x615ca0c, size 0x1c, virtual false, abstract: false, final false
  static inline uint8_t* TabEntity(uint8_t* pDst);

  /// @brief Method ValidateContentChars, addr 0x615a088, size 0x340, virtual false, abstract: false, final false
  inline void ValidateContentChars(::StringW chars, ::StringW propertyName, bool allowOnlyWhitespace);

  /// @brief Method WriteAttributeTextBlock, addr 0x615bd18, size 0x2e0, virtual false, abstract: false, final false
  inline void WriteAttributeTextBlock(char16_t* pSrc, char16_t* pSrcEnd);

  /// @brief Method WriteCData, addr 0x615afb8, size 0x25c, virtual true, abstract: false, final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteCDataSection, addr 0x615b214, size 0x2fc, virtual false, abstract: false, final false
  inline void WriteCDataSection(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x615bb30, size 0x1c0, virtual true, abstract: false, final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteChars, addr 0x615c420, size 0x40, virtual true, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteComment, addr 0x615b510, size 0x158, virtual true, abstract: false, final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteCommentOrPi, addr 0x615b668, size 0x300, virtual false, abstract: false, final false
  inline void WriteCommentOrPi(::StringW text, int32_t stopChar);

  /// @brief Method WriteDocType, addr 0x615a73c, size 0x218, virtual true, abstract: false, final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteElementTextBlock, addr 0x615bff8, size 0x2a0, virtual false, abstract: false, final false
  inline void WriteElementTextBlock(char16_t* pSrc, char16_t* pSrcEnd);

  /// @brief Method WriteEndAttribute, addr 0x615adb8, size 0x4c, virtual true, abstract: false, final false
  inline void WriteEndAttribute();

  /// @brief Method WriteEndElement, addr 0x615aa48, size 0x160, virtual true, abstract: false, final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteEndNamespaceDeclaration, addr 0x615af6c, size 0x4c, virtual true, abstract: false, final false
  inline void WriteEndNamespaceDeclaration();

  /// @brief Method WriteEntityRef, addr 0x615ba90, size 0xa0, virtual true, abstract: false, final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteFullEndElement, addr 0x615aba8, size 0xfc, virtual true, abstract: false, final false
  inline void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteNamespaceDeclaration, addr 0x615ae04, size 0x54, virtual true, abstract: false, final false
  inline void WriteNamespaceDeclaration(::StringW prefix, ::StringW namespaceName);

  /// @brief Method WriteNewLine, addr 0x615cce4, size 0x54, virtual false, abstract: false, final false
  inline uint8_t* WriteNewLine(uint8_t* pDst);

  /// @brief Method WriteProcessingInstruction, addr 0x615b968, size 0x128, virtual true, abstract: false, final false
  inline void WriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method WriteRaw, addr 0x615c460, size 0x40, virtual true, abstract: false, final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw, addr 0x615c6c4, size 0x30, virtual true, abstract: false, final false
  inline void WriteRaw(::StringW data);

  /// @brief Method WriteRawWithCharChecking, addr 0x615c4a0, size 0x224, virtual false, abstract: false, final false
  inline void WriteRawWithCharChecking(char16_t* pSrcBegin, char16_t* pSrcEnd);

  /// @brief Method WriteStartAttribute, addr 0x615aca4, size 0x114, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartElement, addr 0x615a954, size 0xac, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartNamespaceDeclaration, addr 0x615ae60, size 0x10c, virtual true, abstract: false, final false
  inline void WriteStartNamespaceDeclaration(::StringW prefix);

  /// @brief Method WriteString, addr 0x615c298, size 0x28, virtual true, abstract: false, final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteSurrogateCharEntity, addr 0x615c2c0, size 0x160, virtual true, abstract: false, final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteWhitespace, addr 0x615bcf0, size 0x28, virtual true, abstract: false, final false
  inline void WriteWhitespace(::StringW ws);

  /// @brief Method WriteXmlDeclaration, addr 0x615a514, size 0x184, virtual true, abstract: false, final false
  inline void WriteXmlDeclaration(::System::Xml::XmlStandalone standalone);

  /// @brief Method WriteXmlDeclaration, addr 0x615a6b4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6159fac, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlWriterSettings* settings);

  /// @brief Method .ctor, addr 0x615a3c8, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method get_SupportsNamespaceDeclarationInChunks, addr 0x615ae58, size 0x8, virtual true, abstract: false, final false
