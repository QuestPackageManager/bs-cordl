...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x4340b40, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4340a3c, size 0x104, virtual false, abstract: false, final false
