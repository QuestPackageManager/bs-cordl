...
public:
  ...
  /// @brief Method ReadArray, addr 0x60fe77c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x60fe7b4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60fe7f0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Int64ArrayHelperWithString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Int64ArrayHelperWithString(Int64ArrayHelperWithString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Int64ArrayHelperWithString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Int64ArrayHelperWithString(Int64ArrayHelperWithStringconst&) = delete;
