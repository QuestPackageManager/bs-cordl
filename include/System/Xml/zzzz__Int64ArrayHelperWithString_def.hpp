...
/// @brief Method ReadArray, addr 0x5f4a2e4, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method WriteArray, addr 0x5f4a31c, size 0x3c, virtual true, abstract: false, final false
inline void WriteArray(::System::Xml::XmlDictionaryWriter*  writer, ::StringW  prefix, ::StringW  localName, ::StringW  namespaceUri, ::ArrayW<int64_t,::Array<int64_t>*>  array, int32_t  offset, int32_t  count) ;

/// @brief Method .ctor, addr 0x5f4a358, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
