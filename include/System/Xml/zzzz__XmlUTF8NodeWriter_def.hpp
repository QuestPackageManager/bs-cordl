...
public:
  ...
  /// @brief Method GetCharBuffer, addr 0x5f78880, size 0x98, virtual false, abstract: false, final false
  inline ::ArrayW<char16_t, ::Array<char16_t>*> GetCharBuffer(int32_t charCount);

  /// @brief Method GetCharEntityBuffer, addr 0x5f78824, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetCharEntityBuffer();

  /// @brief Method InternalWriteBase64Text, addr 0x5f7a470, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOutput, addr 0x5f786bc, size 0x98, virtual false, abstract: false, final false
  inline void SetOutput(::System::IO::Stream* stream, bool ownsStream, ::System::Text::Encoding* encoding);

  /// @brief Method ToBase16, addr 0x5f79ca0, size 0xd0, virtual false, abstract: false, final false
  inline int32_t ToBase16(::ArrayW<uint8_t, ::Array<uint8_t>*> chars, int32_t offset, uint32_t value);

  /// @brief Method UnsafeWriteEscapedText, addr 0x5f79420, size 0x110, virtual false, abstract: false, final false
  inline void UnsafeWriteEscapedText(char16_t* chars, int32_t count);

  /// @brief Method WriteAmpersandCharEntity, addr 0x5f79914, size 0xdc, virtual false, abstract: false, final false
  inline void WriteAmpersandCharEntity();

  /// @brief Method WriteApostropheCharEntity, addr 0x5f799f0, size 0xf8, virtual false, abstract: false, final false
  inline void WriteApostropheCharEntity();

  /// @brief Method WriteBase64Text, addr 0x5f7a41c, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBoolText, addr 0x5f79db8, size 0xac, virtual true, abstract: false, final false
  inline void WriteBoolText(bool value);

  /// @brief Method WriteCData, addr 0x5f78a60, size 0x1ec, virtual true, abstract: false, final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x5f79d70, size 0x48, virtual true, abstract: false, final false
  inline void WriteCharEntity(int32_t ch);

  /// @brief Method WriteComment, addr 0x5f78da8, size 0x30, virtual true, abstract: false, final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteDateTimeText, addr 0x5f7a070, size 0xac, virtual true, abstract: false, final false
  inline void WriteDateTimeText(::System::DateTime value);

  /// @brief Method WriteDecimalText, addr 0x5f79e64, size 0xb4, virtual true, abstract: false, final false
  inline void WriteDecimalText(::System::Decimal value);

  /// @brief Method WriteDeclaration, addr 0x5f78918, size 0x148, virtual true, abstract: false, final false
  inline void WriteDeclaration();

  /// @brief Method WriteDoubleText, addr 0x5f79f18, size 0xac, virtual true, abstract: false, final false
  inline void WriteDoubleText(double_t value);

  /// @brief Method WriteEndAttribute, addr 0x5f793c0, size 0x1c, virtual true, abstract: false, final false
  inline void WriteEndAttribute();

  /// @brief Method WriteEndComment, addr 0x5f78d08, size 0xa0, virtual false, abstract: false, final false
  inline void WriteEndComment();

  /// @brief Method WriteEndElement, addr 0x5f78f54, size 0x68, virtual true, abstract: false, final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName);

  /// @brief Method WriteEndElement, addr 0x5f78fbc, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteEndStartElement, addr 0x5f78f3c, size 0x18, virtual true, abstract: false, final false
  inline void WriteEndStartElement(bool isEmpty);

  /// @brief Method WriteEscapedText, addr 0x5f79570, size 0x1c4, virtual true, abstract: false, final false
  inline void WriteEscapedText(::ArrayW<uint8_t, ::Array<uint8_t>*> chars, int32_t offset, int32_t count);

  /// @brief Method WriteEscapedText, addr 0x5f79530, size 0x40, virtual true, abstract: false, final false
  inline void WriteEscapedText(::ArrayW<char16_t, ::Array<char16_t>*> s, int32_t offset, int32_t count);

  /// @brief Method WriteEscapedText, addr 0x5f793fc, size 0x24, virtual true, abstract: false, final false
  inline void WriteEscapedText(::StringW s);

  /// @brief Method WriteEscapedText, addr 0x5f793dc, size 0x20, virtual true, abstract: false, final false
  inline void WriteEscapedText(::System::Xml::XmlDictionaryString* s);

  /// @brief Method WriteFloatText, addr 0x5f79fc4, size 0xac, virtual true, abstract: false, final false
  inline void WriteFloatText(float_t value);

  /// @brief Method WriteGreaterThanCharEntity, addr 0x5f79854, size 0xc0, virtual false, abstract: false, final false
  inline void WriteGreaterThanCharEntity();

  /// @brief Method WriteGuidText, addr 0x5f7a3e0, size 0x3c, virtual true, abstract: false, final false
  inline void WriteGuidText(::System::Guid value);

  /// @brief Method WriteHexCharEntity, addr 0x5f79be0, size 0xc0, virtual false, abstract: false, final false
  inline void WriteHexCharEntity(int32_t ch);

  /// @brief Method WriteInt32Text, addr 0x5f7a1dc, size 0xac, virtual true, abstract: false, final false
  inline void WriteInt32Text(int32_t value);

  /// @brief Method WriteInt64Text, addr 0x5f7a288, size 0xac, virtual true, abstract: false, final false
  inline void WriteInt64Text(int64_t value);

  /// @brief Method WriteLessThanCharEntity, addr 0x5f79794, size 0xc0, virtual false, abstract: false, final false
  inline void WriteLessThanCharEntity();

  /// @brief Method WriteLocalName, addr 0x5f78e60, size 0x4, virtual false, abstract: false, final false
  inline void WriteLocalName(::StringW localName);

  /// @brief Method WriteLocalName, addr 0x5f78f38, size 0x4, virtual false, abstract: false, final false
  inline void WriteLocalName(::ArrayW<uint8_t, ::Array<uint8_t>*> localNameBuffer, int32_t localNameOffset, int32_t localNameLength);

  /// @brief Method WritePrefix, addr 0x5f78e30, size 0x30, virtual false, abstract: false, final false
  inline void WritePrefix(::StringW prefix);

  /// @brief Method WritePrefix, addr 0x5f78efc, size 0x3c, virtual false, abstract: false, final false
  inline void WritePrefix(::ArrayW<uint8_t, ::Array<uint8_t>*> prefixBuffer, int32_t prefixOffset, int32_t prefixLength);

  /// @brief Method WriteQualifiedName, addr 0x5f7abb8, size 0x54, virtual true, abstract: false, final false
  inline void WriteQualifiedName(::StringW prefix, ::System::Xml::XmlDictionaryString* localName);

  /// @brief Method WriteQuoteCharEntity, addr 0x5f79ae8, size 0xf8, virtual false, abstract: false, final false
  inline void WriteQuoteCharEntity();

  /// @brief Method WriteStartAttribute, addr 0x5f79294, size 0x74, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName);

  /// @brief Method WriteStartAttribute, addr 0x5f79308, size 0x20, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::System::Xml::XmlDictionaryString* localName);

  /// @brief Method WriteStartAttribute, addr 0x5f79328, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteStartComment, addr 0x5f78c4c, size 0xbc, virtual false, abstract: false, final false
  inline void WriteStartComment();

  /// @brief Method WriteStartElement, addr 0x5f78dd8, size 0x58, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName);

  /// @brief Method WriteStartElement, addr 0x5f78e64, size 0x1c, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::System::Xml::XmlDictionaryString* localName);

  /// @brief Method WriteStartElement, addr 0x5f78e80, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteStartXmlnsAttribute, addr 0x5f79048, size 0x100, virtual false, abstract: false, final false
  inline void WriteStartXmlnsAttribute();

  /// @brief Method WriteText, addr 0x5f79734, size 0x4, virtual false, abstract: false, final false
  inline void WriteText(int32_t ch);

  /// @brief Method WriteText, addr 0x5f7973c, size 0x40, virtual true, abstract: false, final false
  inline void WriteText(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t offset, int32_t count);

  /// @brief Method WriteText, addr 0x5f79738, size 0x4, virtual true, abstract: false, final false
  inline void WriteText(::ArrayW<uint8_t, ::Array<uint8_t>*> chars, int32_t offset, int32_t count);

  /// @brief Method WriteText, addr 0x5f7977c, size 0x4, virtual true, abstract: false, final false
  inline void WriteText(::StringW value);

  /// @brief Method WriteText, addr 0x5f79780, size 0x14, virtual true, abstract: false, final false
  inline void WriteText(::System::Xml::XmlDictionaryString* value);

  /// @brief Method WriteTimeSpanText, addr 0x5f7ab14, size 0xa4, virtual true, abstract: false, final false
  inline void WriteTimeSpanText(::System::TimeSpan value);

  /// @brief Method WriteUInt64Text, addr 0x5f7a334, size 0xac, virtual true, abstract: false, final false
  inline void WriteUInt64Text(uint64_t value);

  /// @brief Method WriteUniqueIdText, addr 0x5f7a11c, size 0xc0, virtual true, abstract: false, final false
  inline void WriteUniqueIdText(::System::Xml::UniqueId* value);

  /// @brief Method WriteXmlnsAttribute, addr 0x5f79148, size 0x84, virtual true, abstract: false, final false
  inline void WriteXmlnsAttribute(::StringW prefix, ::StringW ns);

  /// @brief Method WriteXmlnsAttribute, addr 0x5f791cc, size 0x20, virtual true, abstract: false, final false
  inline void WriteXmlnsAttribute(::StringW prefix, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method WriteXmlnsAttribute, addr 0x5f791ec, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f78658, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f787b0, size 0x74, virtual false, abstract: false, final false
