...
public:
  ...
  /// @brief Method CalibrateText, addr 0x60ff42c, size 0x48, virtual false, abstract: false, final false
  inline void CalibrateText();

  /// @brief Method CheckAttributePosition, addr 0x61004e0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Clone, addr 0x60ff368, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNavigator* Clone();

  /// @brief Method IsSamePosition, addr 0x61008fc, size 0x9c, virtual true, abstract: false, final false
  inline bool IsSamePosition(::System::Xml::XPath::XPathNavigator* other);

  /// @brief Method LookupNamespace, addr 0x6100754, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method MoveToFirstNamespace, addr 0x60ffc1c, size 0x200, virtual true, abstract: false, final false
  inline bool MoveToFirstNamespace(::System::Xml::XPath::XPathNamespaceScope scope);

  /// @brief Method MoveToFirstNamespaceGlobal, addr 0x60fffc4, size 0x144, virtual false, abstract: false, final false
  static inline bool MoveToFirstNamespaceGlobal(::ByRef<::System::Xml::XmlAttributeCollection*> attributes, ::ByRef<int32_t> index);

  /// @brief Method MoveToFirstNamespaceLocal, addr 0x60ffe1c, size 0x60, virtual false, abstract: false, final false
  static inline bool MoveToFirstNamespaceLocal(::System::Xml::XmlAttributeCollection* attributes, ::ByRef<int32_t> index);

  /// @brief Method MoveToNamespace, addr 0x60ff940, size 0x238, virtual true, abstract: false, final false
  inline bool MoveToNamespace(::StringW name);

  /// @brief Method MoveToNextNamespace, addr 0x610024c, size 0x294, virtual true, abstract: false, final false
  inline bool MoveToNextNamespace(::System::Xml::XPath::XPathNamespaceScope scope);

  /// @brief Method MoveToNextNamespaceGlobal, addr 0x6100108, size 0x144, virtual false, abstract: false, final false
  static inline bool MoveToNextNamespaceGlobal(::ByRef<::System::Xml::XmlAttributeCollection*> attributes, ::ByRef<int32_t> index);

  /// @brief Method MoveToNextNamespaceLocal, addr 0x6100608, size 0x54, virtual false, abstract: false, final false
  static inline bool MoveToNextNamespaceLocal(::System::Xml::XmlAttributeCollection* attributes, ::ByRef<int32_t> index);

  /// @brief Method MoveToParent, addr 0x61007b0, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method NextSibling, addr 0x60ff8cc, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* NextSibling(::System::Xml::XmlNode* node);

  /// @brief Method NextSiblingTail, addr 0x6100a5c, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* NextSiblingTail(::System::Xml::XmlNode* node, ::System::Xml::XmlNode* sibling);

  /// @brief Method ParentNode, addr 0x6100884, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* ParentNode(::System::Xml::XmlNode* node);

  /// @brief Method ParentNodeTail, addr 0x6100a14, size 0x48, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* ParentNodeTail(::System::Xml::XmlNode* parent);

  /// @brief Method PathHasDuplicateNamespace, addr 0x610065c, size 0xf8, virtual false, abstract: false, final false
  inline bool PathHasDuplicateNamespace(::System::Xml::XmlElement* top, ::System::Xml::XmlElement* bottom, ::StringW localName);

  /// @brief Method PreviousText, addr 0x61009b8, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* PreviousText(::System::Xml::XmlNode* node);

  /// @brief Method PreviousTextTail, addr 0x6100b10, size 0x104, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* PreviousTextTail(::System::Xml::XmlNode* node, ::System::Xml::XmlNode* text);

  /// @brief Method ResetAttributePosition, addr 0x6100574, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetPosition, addr 0x60ff218, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60ff1a8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDocument* document, ::System::Xml::XmlNode* node);

  /// @brief Method .ctor, addr 0x60ff2e8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::DocumentXPathNavigator* other);

  /// @brief Method get_LocalName, addr 0x60ff474, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NameTable, addr 0x60ff3c4, size 0x24, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0x60ff494, size 0xb4, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0x60ff400, size 0x2c, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x60ff578, size 0xb4, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_SchemaInfo, addr 0x6100998, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_UnderlyingObject, addr 0x60ff928, size 0x18, virtual true, abstract: false, final false
  inline ::System::Object* get_UnderlyingObject();

  /// @brief Method get_Value, addr 0x60ff62c, size 0x98, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_ValueDocument, addr 0x60ff6c4, size 0x44, virtual false, abstract: false, final false
  inline ::StringW get_ValueDocument();

  /// @brief Method get_ValueText, addr 0x60ff708, size 0x134, virtual false, abstract: false, final false
