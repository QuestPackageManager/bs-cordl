...
/// @brief Method Compare, addr 0x5fdab9c, size 0x94, virtual true, abstract: false, final true
...
/// @brief Method Sort, addr 0x5fda654, size 0x1cc, virtual false, abstract: false, final false
inline void Sort() ;
...
/// @brief Method .ctor, addr 0x5fda64c, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "prefixOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "prefixLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "localNameOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "localNameLength", ty: "int32_t", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "prefixOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "prefixLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "localNameOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "localNameLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "nsOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "nsLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "offset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "length", ty: "int32_t", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "prefixOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "prefixLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "nsOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "nsLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "referred", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Field attributes, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_attributes, put=__cordl_internal_set_attributes)) ::ArrayW<::System::Xml::XmlCanonicalWriter_Attribute,::Array<::System::Xml::XmlCanonicalWriter_Attribute>*>  attributes;
...
/// @brief Field scopes, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_scopes, put=__cordl_internal_set_scopes)) ::ArrayW<::System::Xml::XmlCanonicalWriter_Scope,::Array<::System::Xml::XmlCanonicalWriter_Scope>*>  scopes;
...
/// @brief Field xmlnsAttributes, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_xmlnsAttributes, put=__cordl_internal_set_xmlnsAttributes)) ::ArrayW<::System::Xml::XmlCanonicalWriter_XmlnsAttribute,::Array<::System::Xml::XmlCanonicalWriter_XmlnsAttribute>*>  xmlnsAttributes;
...
/// @brief Method AddAttribute, addr 0x5fd9b44, size 0x108, virtual false, abstract: false, final false
inline void AddAttribute(::ByRef<::System::Xml::XmlCanonicalWriter_Attribute>  attribute) ;

/// @brief Method AddXmlnsAttribute, addr 0x5fd8dfc, size 0x23c, virtual false, abstract: false, final false
inline void AddXmlnsAttribute(::ByRef<::System::Xml::XmlCanonicalWriter_XmlnsAttribute>  xmlnsAttribute) ;

/// @brief Method Close, addr 0x5fd8900, size 0xac, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method Compare, addr 0x5fda5d4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method Compare, addr 0x5fda994, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Compare, addr 0x5fda9b4, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method Compare, addr 0x5fda820, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method EndElement, addr 0x5fd8b18, size 0x44, virtual false, abstract: false, final false
inline void EndElement() ;

/// @brief Method EnsureXmlnsBuffer, addr 0x5fd967c, size 0x108, virtual false, abstract: false, final false
inline void EnsureXmlnsBuffer(int32_t  byteCount) ;

/// @brief Method Equals, addr 0x5fd9378, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method Flush, addr 0x5fd88c8, size 0x24, virtual false, abstract: false, final false
inline void Flush() ;

/// @brief Method IsInclusivePrefix, addr 0x5fd8d2c, size 0xd0, virtual false, abstract: false, final false
inline bool IsInclusivePrefix(::ByRef<::System::Xml::XmlCanonicalWriter_XmlnsAttribute>  xmlnsAttribute) ;

/// @brief Method ResolvePrefix, addr 0x5fda978, size 0x1c, virtual false, abstract: false, final false
inline void ResolvePrefix(::ByRef<::System::Xml::XmlCanonicalWriter_Attribute>  attribute) ;

/// @brief Method ResolvePrefix, addr 0x5fda84c, size 0x12c, virtual false, abstract: false, final false
inline void ResolvePrefix(int32_t  prefixOffset, int32_t  prefixLength, ::ByRef<int32_t>  nsOffset, ::ByRef<int32_t>  nsLength) ;

/// @brief Method ResolvePrefixes, addr 0x5fd92e4, size 0x94, virtual false, abstract: false, final false
inline void ResolvePrefixes() ;

/// @brief Method SortAttributes, addr 0x5fd945c, size 0x1a8, virtual false, abstract: false, final false
inline void SortAttributes() ;

/// @brief Method StartElement, addr 0x5fd8a1c, size 0xfc, virtual false, abstract: false, final false
inline void StartElement() ;

/// @brief Method ThrowClosed, addr 0x5fda570, size 0x64, virtual false, abstract: false, final false
inline void ThrowClosed() ;

/// @brief Method ThrowIfClosed, addr 0x5fd88ec, size 0x14, virtual false, abstract: false, final false
inline void ThrowIfClosed() ;

/// @brief Method WriteCharEntity, addr 0x5fd9c4c, size 0xb4, virtual false, abstract: false, final false
inline void WriteCharEntity(int32_t  ch) ;

/// @brief Method WriteComment, addr 0x5fd89b0, size 0x6c, virtual false, abstract: false, final false
inline void WriteComment(::StringW  value) ;

/// @brief Method WriteDeclaration, addr 0x5fd89ac, size 0x4, virtual false, abstract: false, final false
inline void WriteDeclaration() ;

/// @brief Method WriteEndAttribute, addr 0x5fd9ac4, size 0x80, virtual false, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndElement, addr 0x5fd9604, size 0x78, virtual false, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName) ;

/// @brief Method WriteEndStartElement, addr 0x5fd9038, size 0x2ac, virtual false, abstract: false, final false
inline void WriteEndStartElement(bool  isEmpty) ;

/// @brief Method WriteEscapedText, addr 0x5fd9d00, size 0x54, virtual false, abstract: false, final false
inline void WriteEscapedText(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  offset, int32_t  count) ;

/// @brief Method WriteEscapedText, addr 0x5fd9e10, size 0x254, virtual false, abstract: false, final false
inline void WriteEscapedText(::ArrayW<uint8_t,::Array<uint8_t>*>  chars, int32_t  offset, int32_t  count) ;

/// @brief Method WriteEscapedText, addr 0x5fd9d88, size 0x88, virtual false, abstract: false, final false
inline void WriteEscapedText(::StringW  value) ;

/// @brief Method WriteStartAttribute, addr 0x5fd999c, size 0x128, virtual false, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName) ;

/// @brief Method WriteStartElement, addr 0x5fd8b5c, size 0x1d0, virtual false, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName) ;

/// @brief Method WriteText, addr 0x5fd9d54, size 0x34, virtual false, abstract: false, final false
inline void WriteText(int32_t  ch) ;

/// @brief Method WriteText, addr 0x5fda334, size 0x23c, virtual false, abstract: false, final false
inline void WriteText(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  offset, int32_t  count) ;

/// @brief Method WriteText, addr 0x5fda064, size 0x23c, virtual false, abstract: false, final false
inline void WriteText(::ArrayW<uint8_t,::Array<uint8_t>*>  chars, int32_t  offset, int32_t  count) ;

/// @brief Method WriteText, addr 0x5fda2a0, size 0x94, virtual false, abstract: false, final false
inline void WriteText(::StringW  value) ;

/// @brief Method WriteXmlnsAttribute, addr 0x5fd9784, size 0x218, virtual false, abstract: false, final false
inline void WriteXmlnsAttribute(::StringW  prefix, ::StringW  ns) ;

/// @brief Method WriteXmlnsAttribute, addr 0x5fd941c, size 0x40, virtual false, abstract: false, final false
