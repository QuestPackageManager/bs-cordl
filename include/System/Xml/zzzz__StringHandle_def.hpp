...
public:
  ...
  /// @brief Method CompareTo, addr 0x5fc0f38, size 0x84, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Xml::StringHandle* that);

  /// @brief Method Equals, addr 0x5fc0fbc, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals2, addr 0x5fc0c24, size 0xd8, virtual false, abstract: false, final false
  inline bool Equals2(int32_t key2, ::System::Xml::XmlBufferReader* bufferReader2);

  /// @brief Method Equals2, addr 0x5fc0da4, size 0xdc, virtual false, abstract: false, final false
  inline bool Equals2(int32_t offset2, int32_t length2, ::System::Xml::XmlBufferReader* bufferReader2);

  /// @brief Method Equals2, addr 0x5fc0620, size 0x70, virtual false, abstract: false, final false
  inline bool Equals2(::StringW s2);

  /// @brief Method Equals2, addr 0x5fc0e80, size 0x68, virtual false, abstract: false, final false
  inline bool Equals2(::System::Xml::StringHandle* s2);

  /// @brief Method Equals2, addr 0x5fc0cfc, size 0xa8, virtual false, abstract: false, final false
  inline bool Equals2(::System::Xml::XmlDictionaryString* xmlString2);

  /// @brief Method GetHashCode, addr 0x5fc106c, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetString, addr 0x5fc09ec, size 0x164, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetString(::ByRef<int32_t> offset, ::ByRef<int32_t> length);

  /// @brief Method GetString, addr 0x5fc08f8, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW GetString();

  /// @brief Method GetString, addr 0x5fc07cc, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x5fc05a4, size 0x10, virtual false, abstract: false, final false
  inline void SetValue(int32_t offset, int32_t length);

  /// @brief Method SetValue, addr 0x5fc05b4, size 0x24, virtual false, abstract: false, final false
  inline void SetValue(int32_t offset, int32_t length, bool escaped);

  /// @brief Method SetValue, addr 0x5fc05d8, size 0x18, virtual false, abstract: false, final false
  inline void SetValue(::System::Xml::StringHandle* value);

  /// @brief Method ToPrefixHandle, addr 0x5fc07b0, size 0x1c, virtual false, abstract: false, final false
  inline void ToPrefixHandle(::System::Xml::PrefixHandle* prefix);

  /// @brief Method ToString, addr 0x5fc0c20, size 0x4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetDictionaryString, addr 0x5fc0b50, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fc0590, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsEmpty, addr 0x5fc05f0, size 0x30, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_IsXmlns, addr 0x5fc0690, size 0x120, virtual false, abstract: false, final false
  inline bool get_IsXmlns();

  /// @brief Method op_Equality, addr 0x5fc0ef8, size 0x10, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::StringHandle* s1, ::StringW s2);

  /// @brief Method op_Equality, addr 0x5fc0f28, size 0x10, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::StringHandle* s1, ::System::Xml::StringHandle* s2);

  /// @brief Method op_Equality, addr 0x5fc0ee8, size 0x10, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::StringHandle* s1, ::System::Xml::XmlDictionaryString* xmlString2);

  /// @brief Method op_Inequality, addr 0x5fc0f08, size 0x20, virtual false, abstract: false, final false
