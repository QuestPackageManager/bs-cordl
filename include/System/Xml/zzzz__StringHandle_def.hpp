...
DEFINE_IL2CPP_CLASS(::System::Xml::StringHandle_StringHandleType, "System.Xml", "StringHandle/StringHandleType");
...
static_assert(sizeof(::System::Xml::StringHandle_StringHandleType) == 0x4, "Size mismatch!");
