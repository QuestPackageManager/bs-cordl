...
public:
  ...
  /// @brief Method .ctor addr 0x2887bc0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Load addr 0x288a454 size 0x23c virtual false final false
  inline void Load(::System::Xml::XmlDocument* doc, ::System::Xml::XmlReader* reader, bool preserveWhitespace);

  /// @brief Method LoadDocSequence addr 0x288a690 size 0x6c virtual false final false
  inline void LoadDocSequence(::System::Xml::XmlDocument* parentDoc);

  /// @brief Method LoadNode addr 0x288a6fc size 0x594 virtual false final false
  inline ::System::Xml::XmlNode* LoadNode(bool skipOverWhitespace);

  /// @brief Method LoadAttributeNode addr 0x288ac90 size 0x330 virtual false final false
  inline ::System::Xml::XmlAttribute* LoadAttributeNode();

  /// @brief Method LoadDefaultAttribute addr 0x288b62c size 0x19c virtual false final false
  inline ::System::Xml::XmlAttribute* LoadDefaultAttribute();

  /// @brief Method LoadAttributeValue addr 0x288b7c8 size 0x31c virtual false final false
  inline void LoadAttributeValue(::System::Xml::XmlNode* parent, bool direct);

  /// @brief Method LoadEntityReferenceNode addr 0x288afc0 size 0x1f4 virtual false final false
  inline ::System::Xml::XmlEntityReference* LoadEntityReferenceNode(bool direct);

  /// @brief Method LoadDeclarationNode addr 0x288b1b4 size 0x1b4 virtual false final false
  inline ::System::Xml::XmlDeclaration* LoadDeclarationNode();

  /// @brief Method LoadDocumentTypeNode addr 0x288b368 size 0x1ac virtual false final false
  inline ::System::Xml::XmlDocumentType* LoadDocumentTypeNode();

  /// @brief Method LoadNodeDirect addr 0x288baf8 size 0x4a0 virtual false final false
  inline ::System::Xml::XmlNode* LoadNodeDirect();

  /// @brief Method LoadAttributeNodeDirect addr 0x288ccd4 size 0x148 virtual false final false
  inline ::System::Xml::XmlAttribute* LoadAttributeNodeDirect();

  /// @brief Method ParseDocumentType addr 0x2888020 size 0x68 virtual false final false
  inline void ParseDocumentType(::System::Xml::XmlDocumentType* dtNode);

  /// @brief Method ParseDocumentType addr 0x288cf9c size 0x2c8 virtual false final false
  inline void ParseDocumentType(::System::Xml::XmlDocumentType* dtNode, bool bUseResolver, ::System::Xml::XmlResolver* resolver);

  /// @brief Method LoadDocumentType addr 0x288c1a0 size 0xb34 virtual false final false
  inline void LoadDocumentType(::System::Xml::IDtdInfo* dtdInfo, ::System::Xml::XmlDocumentType* dtNode);

  /// @brief Method GetContext addr 0x288d324 size 0x8d8 virtual false final false
  inline ::System::Xml::XmlParserContext* GetContext(::System::Xml::XmlNode* node);

  /// @brief Method ParsePartialContent addr 0x2887bc8 size 0x204 virtual false final false
  ...
  /// @brief Method LoadInnerXmlElement addr 0x2889138 size 0x74 virtual false final false
  inline void LoadInnerXmlElement(::System::Xml::XmlElement* node, ::StringW innerxmltext);

  /// @brief Method LoadInnerXmlAttribute addr 0x288e104 size 0x8 virtual false final false
  inline void LoadInnerXmlAttribute(::System::Xml::XmlAttribute* node, ::StringW innerxmltext);

  /// @brief Method RemoveDuplicateNamespace addr 0x288de74 size 0x290 virtual false final false
  inline void RemoveDuplicateNamespace(::System::Xml::XmlElement* elem, ::System::Xml::XmlNamespaceManager* mgr, bool fCheckElemAttrs);

  /// @brief Method EntitizeName addr 0x288e10c size 0x6c virtual false final false
  inline ::StringW EntitizeName(::StringW name);

  /// @brief Method ExpandEntity addr 0x2889628 size 0x4c virtual false final false
  inline void ExpandEntity(::System::Xml::XmlEntity* ent);

  /// @brief Method ExpandEntityReference addr 0x28899ec size 0x628 virtual false final false
  inline void ExpandEntityReference(::System::Xml::XmlEntityReference* eref);

  /// @brief Method CreateInnerXmlReader addr 0x288dbfc size 0x278 virtual false final false
  ...
  /// @brief Method ParseXmlDeclarationValue addr 0x288bf98 size 0x208 virtual false final false
  ...
  /// @brief Method UnexpectedNodeType addr 0x288b514 size 0x118 virtual false final false
