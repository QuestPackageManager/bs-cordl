...
/// @brief Method GetPreamble, addr 0x61a309c, size 0x78, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreamble() ;

static inline ::System::Xml::Ucs4Encoding4321* New_ctor() ;

/// @brief Method .ctor, addr 0x61a2cac, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EncodingName, addr 0x61a3058, size 0x44, virtual true, abstract: false, final false
