...
public:
  ...
  /// @brief Method GetInvalidNameException, addr 0x60bcfb4, size 0x1d0, virtual false, abstract: false, final false
  static inline ::System::Exception* GetInvalidNameException(::StringW s, int32_t offsetStartChar, int32_t offsetBadChar);

  /// @brief Method IsNameNoNamespaces, addr 0x60bc9d8, size 0x84, virtual false, abstract: false, final false
  static inline bool IsNameNoNamespaces(::StringW s);

  /// @brief Method ParseNCName, addr 0x60bcb9c, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t ParseNCName(::StringW s);

  /// @brief Method ParseNCName, addr 0x60bca5c, size 0x140, virtual false, abstract: false, final false
  static inline int32_t ParseNCName(::StringW s, int32_t offset);

  /// @brief Method ParseNameNoNamespaces, addr 0x60bc878, size 0x160, virtual false, abstract: false, final false
  static inline int32_t ParseNameNoNamespaces(::StringW s, int32_t offset);

  /// @brief Method ParseNmtoken, addr 0x60bc6c0, size 0xd8, virtual false, abstract: false, final false
  static inline int32_t ParseNmtoken(::StringW s, int32_t offset);

  /// @brief Method ParseNmtokenNoNamespaces, addr 0x60bc798, size 0xe0, virtual false, abstract: false, final false
  static inline int32_t ParseNmtokenNoNamespaces(::StringW s, int32_t offset);

  /// @brief Method ParseQName, addr 0x60bcbf8, size 0xe4, virtual false, abstract: false, final false
  static inline int32_t ParseQName(::StringW s, int32_t offset, ::ByRef<int32_t> colonOffset);

  /// @brief Method ParseQNameThrow, addr 0x60bccdc, size 0x11c, virtual false, abstract: false, final false
  static inline void ParseQNameThrow(::StringW s, ::ByRef<::StringW> prefix, ::ByRef<::StringW> localName);

  /// @brief Method SplitQName, addr 0x60bd184, size 0x130, virtual false, abstract: false, final false
  static inline void SplitQName(::StringW name, ::ByRef<::StringW> prefix, ::ByRef<::StringW> lname);

  /// @brief Method ThrowInvalidName, addr 0x60bcdf8, size 0x188, virtual false, abstract: false, final false
