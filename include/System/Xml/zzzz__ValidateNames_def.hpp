...
public:
  ...
  /// @brief Method ParseNmtoken addr 0x271fa5c size 0xc8 virtual false final false
  static inline int32_t ParseNmtoken(::StringW s, int32_t offset);

  /// @brief Method ParseNmtokenNoNamespaces addr 0x271fb24 size 0xe4 virtual false final false
  static inline int32_t ParseNmtokenNoNamespaces(::StringW s, int32_t offset);

  /// @brief Method ParseNameNoNamespaces addr 0x271fc08 size 0x158 virtual false final false
  static inline int32_t ParseNameNoNamespaces(::StringW s, int32_t offset);

  /// @brief Method ParseNCName addr 0x271fd60 size 0x11c virtual false final false
  static inline int32_t ParseNCName(::StringW s, int32_t offset);

  /// @brief Method ParseNCName addr 0x271fe7c size 0x58 virtual false final false
  static inline int32_t ParseNCName(::StringW s);

  /// @brief Method ParseQName addr 0x271fed4 size 0xdc virtual false final false
  static inline int32_t ParseQName(::StringW s, int32_t offset, ByRef<int32_t> colonOffset);

  /// @brief Method ParseQNameThrow addr 0x271ffb0 size 0x10c virtual false final false
  static inline void ParseQNameThrow(::StringW s, ByRef<::StringW> prefix, ByRef<::StringW> localName);

  /// @brief Method ThrowInvalidName addr 0x27200bc size 0x178 virtual false final false
  static inline void ThrowInvalidName(::StringW s, int32_t offsetStartChar, int32_t offsetBadChar);

  /// @brief Method GetInvalidNameException addr 0x2720494 size 0x1c0 virtual false final false
