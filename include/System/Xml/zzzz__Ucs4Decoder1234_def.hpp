...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x2dbdff0, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dbd6bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
