...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x62e4258, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62e38a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ucs4Decoder1234", modifiers: "&&", def_value: None, comment: None }]
