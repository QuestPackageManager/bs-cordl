...
// Write type traits
MARK_REF_T(::System::Xml::Schema::ValidationState*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ValidationState*, "System.Xml.Schema", "ValidationState");
// Dependencies System.Object, System.Xml.Schema.BitSet, System.Xml.Schema.ConstraintStruct, System.Xml.Schema.StateUnion, System.Xml.Schema.XmlSchemaContentProcessing,
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_Constr, put = __cordl_internal_set_Constr)) ::ArrayW<::System::Xml::Schema::ConstraintStruct*> Constr;

  /// @brief Field CurPos, offset 0x50, size 0x8
  __declspec(property(get = __cordl_internal_get_CurPos, put = __cordl_internal_set_CurPos)) ::ArrayW<::System::Xml::Schema::BitSet*> CurPos;
  ...
  constexpr ::ArrayW<::System::Xml::Schema::ConstraintStruct*> const& __cordl_internal_get_Constr() const;

  constexpr ::ArrayW<::System::Xml::Schema::ConstraintStruct*>& __cordl_internal_get_Constr();

  constexpr ::ArrayW<::System::Xml::Schema::BitSet*> const& __cordl_internal_get_CurPos() const;

  constexpr ::ArrayW<::System::Xml::Schema::BitSet*>& __cordl_internal_get_CurPos();
  ...
  constexpr void __cordl_internal_set_Constr(::ArrayW<::System::Xml::Schema::ConstraintStruct*> value);

  constexpr void __cordl_internal_set_CurPos(::ArrayW<::System::Xml::Schema::BitSet*> value);
  ...
  /// @brief Method .ctor, addr 0x621f124, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValidationState", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValidationState(ValidationState&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValidationState", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValidationState(ValidationStateconst&) = delete;
  ...
  ::ArrayW<::System::Xml::Schema::ConstraintStruct*> ___Constr;
  ...
  ::ArrayW<::System::Xml::Schema::BitSet*> ___CurPos;
...
static_assert(sizeof(::System::Xml::Schema::ValidationState) == 0x70, "Size mismatch!");
