...
/// @brief Field Constr, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_Constr, put=__cordl_internal_set_Constr)) ::ArrayW<::System::Xml::Schema::ConstraintStruct*,::Array<::System::Xml::Schema::ConstraintStruct*>*>  Constr;
...
/// @brief Field RunningPositions, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_RunningPositions, put=__cordl_internal_set_RunningPositions)) ::System::Collections::Generic::List_1<::System::Xml::Schema::RangePositionInfo>*  RunningPositions;
...
/// @brief Method .ctor, addr 0x60de810, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
