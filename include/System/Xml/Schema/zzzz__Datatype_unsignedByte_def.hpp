...
public:
  ...
  /// @brief Method Compare, addr 0x61ca1c4, size 0x54, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  static inline ::System::Xml::Schema::Datatype_unsignedByte* New_ctor();

  /// @brief Method TryParseValue, addr 0x61ca2d0, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61c0484, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FacetsChecker, addr 0x61ca160, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x61ca274, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TypeCode, addr 0x61ca1bc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValueType, addr 0x61ca218, size 0x5c, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_unsignedByte", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_unsignedByte(Datatype_unsignedByte&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_unsignedByte", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_unsignedByte(Datatype_unsignedByteconst&) = delete;
