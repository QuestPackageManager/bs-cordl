...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x4267ff4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4267f6c, size 0x88, virtual false, abstract: false, final false
