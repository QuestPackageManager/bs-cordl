...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2d207d8, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* Invoke();

  static inline ::System::Xml::Schema::XmlValueGetter* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x2d2071c, size 0xbc, virtual false, abstract: false, final false
