...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x42c5db4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42c5d2c, size 0x88, virtual false, abstract: false, final false
