...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlValueGetter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlValueGetter(XmlValueGetter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlValueGetter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlValueGetter(XmlValueGetterconst&) = delete;
