...
public:
  ...
  /// @brief Method .ctor, addr 0x61bfb48, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x61c67a4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_day", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_day(Datatype_day&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_day", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_day(Datatype_dayconst&) = delete;
