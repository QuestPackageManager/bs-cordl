...
public:
  ...
  /// @brief Method CompleteValidation, addr 0x61bb318, size 0x14, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method ExpectedElements, addr 0x61bb32c, size 0x28c, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState* context, bool isRequiredOnly);

  /// @brief Method ExpectedParticles, addr 0x61bb5b8, size 0x22c, virtual true, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x61ba8f4, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x61baab4, size 0x864, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61ba83c, size 0xb8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RangeContentValidator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RangeContentValidator(RangeContentValidator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RangeContentValidator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RangeContentValidator(RangeContentValidatorconst&) = delete;
