...
public:
  ...
  /// @brief Method .ctor, addr 0x61bfaec, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_dateTimeTimeZone", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_dateTimeTimeZone(Datatype_dateTimeTimeZone&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_dateTimeTimeZone", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_dateTimeTimeZone(Datatype_dateTimeTimeZoneconst&) = delete;
