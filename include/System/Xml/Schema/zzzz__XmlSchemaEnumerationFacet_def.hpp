...
public:
  ...
  /// @brief Method .ctor, addr 0x62316d0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaEnumerationFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaEnumerationFacet(XmlSchemaEnumerationFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaEnumerationFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaEnumerationFacet(XmlSchemaEnumerationFacetconst&) = delete;
