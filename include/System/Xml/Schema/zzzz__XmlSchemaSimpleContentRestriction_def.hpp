...
public:
  ...
  /// @brief Method SetAttributes, addr 0x2e1dd18, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e1dd20, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AnyAttribute, addr 0x2e1dd08, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute();

  /// @brief Method get_Attributes, addr 0x2e1dd00, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Attributes();

  /// @brief Method get_BaseType, addr 0x2e1dce8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* get_BaseType();

  /// @brief Method get_BaseTypeName, addr 0x2e1dc48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_BaseTypeName();

  /// @brief Method get_Facets, addr 0x2e1dcf8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Facets();

  /// @brief Method set_AnyAttribute, addr 0x2e1dd10, size 0x8, virtual false, abstract: false, final false
  inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_BaseType, addr 0x2e1dcf0, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseType(::System::Xml::Schema::XmlSchemaSimpleType* value);

  /// @brief Method set_BaseTypeName, addr 0x2e1dc50, size 0x98, virtual false, abstract: false, final false
