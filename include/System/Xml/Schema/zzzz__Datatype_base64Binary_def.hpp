...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_base64Binary", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_base64Binary(Datatype_base64Binary&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_base64Binary", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_base64Binary(Datatype_base64Binaryconst&) = delete;
