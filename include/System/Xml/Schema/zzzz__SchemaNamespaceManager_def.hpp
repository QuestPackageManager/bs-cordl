...
public:
  ...
  /// @brief Method LookupNamespace, addr 0x60c8b70, size 0x124, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x60c8c94, size 0x3e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60c8b68, size 0x8, virtual false, abstract: false, final false
