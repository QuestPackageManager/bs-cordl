...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SchemaNamespaceManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SchemaNamespaceManager(SchemaNamespaceManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SchemaNamespaceManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SchemaNamespaceManager(SchemaNamespaceManagerconst&) = delete;
