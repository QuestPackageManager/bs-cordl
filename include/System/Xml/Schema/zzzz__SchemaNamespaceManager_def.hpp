...
public:
  ...
  /// @brief Method LookupNamespace, addr 0x429cef0, size 0x130, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x429d020, size 0x3fc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x429cec8, size 0x28, virtual false, abstract: false, final false
