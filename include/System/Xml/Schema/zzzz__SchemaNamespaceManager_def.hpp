...
public:
  ...
  /// @brief Method LookupNamespace, addr 0x2e0d7ac, size 0x128, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x2e0d8d4, size 0x3fc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e0d784, size 0x28, virtual false, abstract: false, final false
