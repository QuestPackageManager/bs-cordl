...
public:
  ...
  /// @brief Method .ctor, addr 0x61c03c8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_timeNoTimeZone", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_timeNoTimeZone(Datatype_timeNoTimeZone&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_timeNoTimeZone", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_timeNoTimeZone(Datatype_timeNoTimeZoneconst&) = delete;
