...
/// @brief Method .ctor, addr 0x6078e58, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_RefName, addr 0x6078dbc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_RefName() ;

/// @brief Method set_RefName, addr 0x6078dc4, size 0x94, virtual false, abstract: false, final false
