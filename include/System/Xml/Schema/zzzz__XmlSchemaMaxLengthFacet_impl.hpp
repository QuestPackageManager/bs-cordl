...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Schema::XmlSchemaMaxLengthFacet::*)()>(&::System::Xml::Schema::XmlSchemaMaxLengthFacet::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x42c33ec;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Xml::Schema::XmlSchemaMaxLengthFacet*>::get(), ".ctor",
