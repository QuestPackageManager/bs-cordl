...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Schema::XmlSchemaFractionDigitsFacet::*)()>(
    &::System::Xml::Schema::XmlSchemaFractionDigitsFacet::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x6015034;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Xml::Schema::XmlSchemaFractionDigitsFacet*>::get(),
...
inline ::System::Xml::Schema::XmlSchemaFractionDigitsFacet* System::Xml::Schema::XmlSchemaFractionDigitsFacet::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Xml::Schema::XmlSchemaFractionDigitsFacet*>());
}
// Ctor Parameters []
