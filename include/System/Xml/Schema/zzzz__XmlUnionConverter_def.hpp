...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlUnionConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlUnionConverter(XmlUnionConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlUnionConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlUnionConverter(XmlUnionConverterconst&) = delete;
