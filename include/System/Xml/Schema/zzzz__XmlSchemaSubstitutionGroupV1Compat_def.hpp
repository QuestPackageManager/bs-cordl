...
public:
  ...
  /// @brief Method .ctor, addr 0x42ca234, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Choice, addr 0x42ca22c, size 0x8, virtual false, abstract: false, final false
