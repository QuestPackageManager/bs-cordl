...
public:
  ...
  /// @brief Method .ctor, addr 0x42c9ecc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Choice, addr 0x42c9ec4, size 0x8, virtual false, abstract: false, final false
