...
public:
  ...
  /// @brief Method .ctor, addr 0x42ce748, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Choice, addr 0x42ce740, size 0x8, virtual false, abstract: false, final false
