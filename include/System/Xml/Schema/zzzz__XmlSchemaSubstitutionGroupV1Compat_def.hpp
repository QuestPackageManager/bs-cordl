...
public:
  ...
  /// @brief Method .ctor, addr 0x60877e0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Choice, addr 0x60877d8, size 0x8, virtual false, abstract: false, final false
