...
public:
  ...
  /// @brief Method .ctor, addr 0x60f9eac, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Choice, addr 0x60f9ea4, size 0x8, virtual false, abstract: false, final false
