...
// Write type traits
MARK_REF_T(::System::Xml::Schema::KSStruct*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::KSStruct*, "System.Xml.Schema", "KSStruct");
// Dependencies System.Object, System.Xml.Schema.LocatedActiveAxis
namespace System::Xml::Schema {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_fields, put = __cordl_internal_set_fields)) ::ArrayW<::System::Xml::Schema::LocatedActiveAxis*> fields;
  ...
  constexpr ::ArrayW<::System::Xml::Schema::LocatedActiveAxis*> const& __cordl_internal_get_fields() const;

  constexpr ::ArrayW<::System::Xml::Schema::LocatedActiveAxis*>& __cordl_internal_get_fields();
  ...
  constexpr void __cordl_internal_set_fields(::ArrayW<::System::Xml::Schema::LocatedActiveAxis*> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KSStruct", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KSStruct(KSStruct&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KSStruct", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KSStruct(KSStructconst&) = delete;
  ...
  ::ArrayW<::System::Xml::Schema::LocatedActiveAxis*> ___fields;
...
static_assert(sizeof(::System::Xml::Schema::KSStruct) == 0x28, "Size mismatch!");
