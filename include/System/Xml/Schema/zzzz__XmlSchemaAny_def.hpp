...
public:
  ...
  /// @brief Method Allows, addr 0x6077a1c, size 0x28, virtual false, abstract: false, final false
  inline bool Allows(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method BuildNamespaceList, addr 0x6077904, size 0x7c, virtual false, abstract: false, final false
  inline void BuildNamespaceList(::StringW targetNamespace);

  /// @brief Method BuildNamespaceListV1Compat, addr 0x6077980, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6077a44, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NameString, addr 0x6077428, size 0x4dc, virtual true, abstract: false, final false
  inline ::StringW get_NameString();

  /// @brief Method get_Namespace, addr 0x6077394, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_NamespaceList, addr 0x60773ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::NamespaceList* get_NamespaceList();

  /// @brief Method get_ProcessContentsCorrect, addr 0x6077414, size 0x14, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContentsCorrect();

  /// @brief Method get_ResolvedNamespace, addr 0x60773b4, size 0x60, virtual false, abstract: false, final false
  inline ::StringW get_ResolvedNamespace();

  /// @brief Method set_Namespace, addr 0x607739c, size 0x8, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_ProcessContents, addr 0x60773a4, size 0x8, virtual false, abstract: false, final false
