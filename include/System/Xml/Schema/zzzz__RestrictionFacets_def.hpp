...
public:
  ...
  /// @brief Method .ctor, addr 0x61bc478, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RestrictionFacets", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RestrictionFacets(RestrictionFacets&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RestrictionFacets", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RestrictionFacets(RestrictionFacetsconst&) = delete;
