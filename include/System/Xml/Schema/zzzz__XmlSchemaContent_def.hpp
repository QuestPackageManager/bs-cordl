...
public:
  ...
  /// @brief Method .ctor, addr 0x622e0c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaContent(XmlSchemaContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaContent(XmlSchemaContentconst&) = delete;
