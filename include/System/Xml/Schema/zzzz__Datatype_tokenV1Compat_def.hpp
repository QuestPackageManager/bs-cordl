...
public:
  ...
  /// @brief Method .ctor, addr 0x2a069a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x2a069a0, size 0x8, virtual true, abstract: false, final false
