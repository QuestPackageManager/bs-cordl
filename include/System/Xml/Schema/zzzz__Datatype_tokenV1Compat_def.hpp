...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11581))}
...
public:
  ...
  /// @brief Method get_TypeCode addr 0x273d660 size 0x8 virtual true final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  static inline ::System::Xml::Schema::Datatype_tokenV1Compat* New_ctor();

  /// @brief Method .ctor addr 0x273d668 size 0x4 virtual false final false
  inline void _ctor();
