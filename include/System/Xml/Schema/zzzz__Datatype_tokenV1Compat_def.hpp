...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_tokenV1Compat*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_tokenV1Compat*, "System.Xml.Schema", "Datatype_tokenV1Compat");
// Dependencies System.Xml.Schema.Datatype_normalizedStringV1Compat
namespace System::Xml::Schema {
// Is value type: false
...
public:
  ...
  /// @brief Method .ctor, addr 0x61c06e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x61c7b44, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_tokenV1Compat) == 0x38, "Size mismatch!");
