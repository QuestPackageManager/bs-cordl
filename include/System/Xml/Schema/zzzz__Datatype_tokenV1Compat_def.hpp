...
public:
  ...
  /// @brief Method .ctor, addr 0x2e04394, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x2e0b9dc, size 0x8, virtual true, abstract: false, final false
