...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_dateTimeNoTimeZone", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_dateTimeNoTimeZone(Datatype_dateTimeNoTimeZone&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_dateTimeNoTimeZone", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_dateTimeNoTimeZone(Datatype_dateTimeNoTimeZoneconst&) = delete;
