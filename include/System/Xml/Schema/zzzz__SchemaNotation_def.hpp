...
public:
  ...
  /// @brief Method .ctor, addr 0x42a644c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlQualifiedName* name);

  /// @brief Method get_Name, addr 0x42a6474, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_Name();

  /// @brief Method get_Pubid, addr 0x42a648c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Pubid();

  /// @brief Method get_SystemLiteral, addr 0x42a647c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SystemLiteral();

  /// @brief Method set_Pubid, addr 0x42a6494, size 0x8, virtual false, abstract: false, final false
  inline void set_Pubid(::StringW value);

  /// @brief Method set_SystemLiteral, addr 0x42a6484, size 0x8, virtual false, abstract: false, final false
