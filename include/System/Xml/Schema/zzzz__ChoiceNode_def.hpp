...
public:
  ...
  /// @brief Method ConstructChildPos, addr 0x631f620, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ConstructPos, addr 0x631f6f8, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method ExpandTree, addr 0x631f8a4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631ee48, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNullable, addr 0x631f810, size 0x94, virtual true, abstract: false, final false
...
public:
  ...
  ChoiceNode(ChoiceNodeconst&) = delete;
