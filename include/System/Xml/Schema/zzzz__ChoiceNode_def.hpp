...
/// @brief Method ConstructChildPos, addr 0x61ded0c, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method ConstructPos, addr 0x61dede4, size 0x118, virtual true, abstract: false, final false
...
/// @brief Method ExpandTree, addr 0x61def90, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61de534, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsNullable, addr 0x61deefc, size 0x94, virtual true, abstract: false, final false
