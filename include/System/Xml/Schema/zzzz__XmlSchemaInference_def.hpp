...
public:
  ...
  /// @brief Method AddAttribute, addr 0x6094eb4, size 0x7f0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddElement, addr 0x6093550, size 0x5b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckSimpleContentExtension, addr 0x60982d4, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewElementforChoice, addr 0x6099bd4, size 0x1bc, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* CreateNewElementforChoice(::System::Xml::Schema::XmlSchemaElement* copyElement);

  /// @brief Method CreateXmlSchema, addr 0x6097620, size 0x94, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* CreateXmlSchema(::StringW targetNS);

  /// @brief Method DateTime, addr 0x609ae6c, size 0x11c, virtual false, abstract: false, final false
  static inline int32_t DateTime(::StringW s, bool bDate, bool bTime);

  /// @brief Method FindAttribute, addr 0x6095a4c, size 0x364, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAttribute* FindAttribute(::System::Collections::ICollection* attributes, ::StringW attrName);

  /// @brief Method FindAttributeRef, addr 0x60956a4, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindElement, addr 0x6099940, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method FindElementRef, addr 0x6099a74, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method FindGlobalElement, addr 0x60976b4, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method FindMatchingElement, addr 0x6098888, size 0xf5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEffectiveSchemaType, addr 0x6097a18, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSchemaType, addr 0x6096e58, size 0x7c8, virtual false, abstract: false, final false
  static inline int32_t GetSchemaType(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method InferElement, addr 0x6093b08, size 0x13ac, virtual false, abstract: false, final false
  ...
  /// @brief Method InferSchema, addr 0x6092b14, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSet* InferSchema(::System::Xml::XmlReader* instanceDocument);

  /// @brief Method InferSchema1, addr 0x6092b8c, size 0x970, virtual false, abstract: false, final false
  ...
  /// @brief Method InferSimpleType, addr 0x6099f6c, size 0xf00, virtual false, abstract: false, final false
  static inline int32_t InferSimpleType(::StringW s, ::ByRef<bool> bNeedsRangeCheck);

  /// @brief Method MakeExistingAttributesOptional, addr 0x609824c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveAttributes, addr 0x6098414, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveAttributes, addr 0x60987dc, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttributes, addr 0x6097b58, size 0x6f4, virtual false, abstract: false, final false
  ...
  /// @brief Method RefineSimpleType, addr 0x6095db0, size 0x10a8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* RefineSimpleType(::StringW s, ::ByRef<int32_t> iTypeFlags);

  /// @brief Method SetMinMaxOccurs, addr 0x60997e4, size 0x15c, virtual false, abstract: false, final false
  inline void SetMinMaxOccurs(::System::Xml::Schema::XmlSchemaElement* el, bool setMaxOccurs);

  /// @brief Method SwitchUseToOptional, addr 0x6099e44, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6092a04, size 0x110, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Occurrence, addr 0x60929f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Occurrence, addr 0x60929ec, size 0x8, virtual false, abstract: false, final false
  inline void set_Occurrence(::System::Xml::Schema::XmlSchemaInference_InferenceOption value);

  /// @brief Method set_TypeInference, addr 0x60929fc, size 0x8, virtual false, abstract: false, final false
