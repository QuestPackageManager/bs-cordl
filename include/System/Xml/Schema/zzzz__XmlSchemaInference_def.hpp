...
public:
  ...
  /// @brief Method AddAttribute, addr 0x4268f7c, size 0x7d0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddElement, addr 0x42675c4, size 0x5d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckSimpleContentExtension, addr 0x426c484, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewElementforChoice, addr 0x426de54, size 0x1c8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* CreateNewElementforChoice(::System::Xml::Schema::XmlSchemaElement* copyElement);

  /// @brief Method CreateXmlSchema, addr 0x426b7b8, size 0x90, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* CreateXmlSchema(::StringW targetNS);

  /// @brief Method DateTime, addr 0x426f78c, size 0x114, virtual false, abstract: false, final false
  static inline int32_t DateTime(::StringW s, bool bDate, bool bTime);

  /// @brief Method FindAttribute, addr 0x4269b14, size 0x384, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAttribute* FindAttribute(::System::Collections::ICollection* attributes, ::StringW attrName);

  /// @brief Method FindAttributeRef, addr 0x426974c, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindElement, addr 0x426dbc4, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method FindElementRef, addr 0x426dcf4, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method FindGlobalElement, addr 0x426b848, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method FindMatchingElement, addr 0x426ca4c, size 0xfec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEffectiveSchemaType, addr 0x426bbd0, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSchemaType, addr 0x426afe4, size 0x7d4, virtual false, abstract: false, final false
  static inline int32_t GetSchemaType(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method InferElement, addr 0x4267b9c, size 0x13e0, virtual false, abstract: false, final false
  ...
  /// @brief Method InferSchema, addr 0x4266b48, size 0x74, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSet* InferSchema(::System::Xml::XmlReader* instanceDocument);

  /// @brief Method InferSchema1, addr 0x4266bbc, size 0x9d4, virtual false, abstract: false, final false
  ...
  /// @brief Method InferSimpleType, addr 0x426e1e4, size 0x15a8, virtual false, abstract: false, final false
  static inline int32_t InferSimpleType(::StringW s, ::ByRef<bool> bNeedsRangeCheck);

  /// @brief Method MakeExistingAttributesOptional, addr 0x426c3f4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveAttributes, addr 0x426c5bc, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveAttributes, addr 0x426c9b0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttributes, addr 0x426bd08, size 0x6ec, virtual false, abstract: false, final false
  ...
  /// @brief Method RefineSimpleType, addr 0x4269e98, size 0x114c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* RefineSimpleType(::StringW s, ::ByRef<int32_t> iTypeFlags);

  /// @brief Method SetMinMaxOccurs, addr 0x426da38, size 0x18c, virtual false, abstract: false, final false
  inline void SetMinMaxOccurs(::System::Xml::Schema::XmlSchemaElement* el, bool setMaxOccurs);

  /// @brief Method SwitchUseToOptional, addr 0x426e0c0, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4266a38, size 0x110, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Occurrence, addr 0x4266a28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Occurrence, addr 0x4266a20, size 0x8, virtual false, abstract: false, final false
  inline void set_Occurrence(::System::Xml::Schema::XmlSchemaInference_InferenceOption value);

  /// @brief Method set_TypeInference, addr 0x4266a30, size 0x8, virtual false, abstract: false, final false
