...
public:
  ...
  /// @brief Method AddAttribute, addr 0x4266324, size 0x7d0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddElement, addr 0x426496c, size 0x5d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckSimpleContentExtension, addr 0x426982c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewElementforChoice, addr 0x426b1fc, size 0x1c8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* CreateNewElementforChoice(::System::Xml::Schema::XmlSchemaElement* copyElement);

  /// @brief Method CreateXmlSchema, addr 0x4268b60, size 0x90, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* CreateXmlSchema(::StringW targetNS);

  /// @brief Method DateTime, addr 0x426cb34, size 0x114, virtual false, abstract: false, final false
  static inline int32_t DateTime(::StringW s, bool bDate, bool bTime);

  /// @brief Method FindAttribute, addr 0x4266ebc, size 0x384, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAttribute* FindAttribute(::System::Collections::ICollection* attributes, ::StringW attrName);

  /// @brief Method FindAttributeRef, addr 0x4266af4, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindElement, addr 0x426af6c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method FindElementRef, addr 0x426b09c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method FindGlobalElement, addr 0x4268bf0, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method FindMatchingElement, addr 0x4269df4, size 0xfec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEffectiveSchemaType, addr 0x4268f78, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSchemaType, addr 0x426838c, size 0x7d4, virtual false, abstract: false, final false
  static inline int32_t GetSchemaType(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method InferElement, addr 0x4264f44, size 0x13e0, virtual false, abstract: false, final false
  ...
  /// @brief Method InferSchema, addr 0x4263ef0, size 0x74, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSet* InferSchema(::System::Xml::XmlReader* instanceDocument);

  /// @brief Method InferSchema1, addr 0x4263f64, size 0x9d4, virtual false, abstract: false, final false
  ...
  /// @brief Method InferSimpleType, addr 0x426b58c, size 0x15a8, virtual false, abstract: false, final false
  static inline int32_t InferSimpleType(::StringW s, ::ByRef<bool> bNeedsRangeCheck);

  /// @brief Method MakeExistingAttributesOptional, addr 0x426979c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveAttributes, addr 0x4269964, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveAttributes, addr 0x4269d58, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAttributes, addr 0x42690b0, size 0x6ec, virtual false, abstract: false, final false
  ...
  /// @brief Method RefineSimpleType, addr 0x4267240, size 0x114c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* RefineSimpleType(::StringW s, ::ByRef<int32_t> iTypeFlags);

  /// @brief Method SetMinMaxOccurs, addr 0x426ade0, size 0x18c, virtual false, abstract: false, final false
  inline void SetMinMaxOccurs(::System::Xml::Schema::XmlSchemaElement* el, bool setMaxOccurs);

  /// @brief Method SwitchUseToOptional, addr 0x426b468, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4263de0, size 0x110, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Occurrence, addr 0x4263dd0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Occurrence, addr 0x4263dc8, size 0x8, virtual false, abstract: false, final false
  inline void set_Occurrence(::System::Xml::Schema::XmlSchemaInference_InferenceOption value);

  /// @brief Method set_TypeInference, addr 0x4263dd8, size 0x8, virtual false, abstract: false, final false
