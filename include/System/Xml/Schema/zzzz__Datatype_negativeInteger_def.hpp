...
public:
  ...
  /// @brief Method get_FacetsChecker, addr 0x43ae180, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_TypeCode, addr 0x43ae1d8, size 0x8, virtual true, abstract: false, final false
