...
public:
  ...
  /// @brief Method .ctor, addr 0x607dee0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x60842f0, size 0x8, virtual true, abstract: false, final false
