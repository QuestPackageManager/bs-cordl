...
public:
  ...
  /// @brief Method .ctor, addr 0x5fa3c88, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x5faa098, size 0x8, virtual true, abstract: false, final false
