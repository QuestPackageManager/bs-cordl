...
public:
  ...
  /// @brief Method CreateTokenToQNameTable, addr 0x620959c, size 0x1968, virtual false, abstract: false, final false
  inline void CreateTokenToQNameTable();

  /// @brief Method IsXDRRoot, addr 0x620afac, size 0x48, virtual false, abstract: false, final false
  inline bool IsXDRRoot(::StringW localName, ::StringW ns);

  /// @brief Method IsXSDRoot, addr 0x620af64, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method SchemaTypeFromRoot, addr 0x620af04, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62068f0, size 0x2cac, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SchemaNames", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SchemaNames(SchemaNames&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SchemaNames", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SchemaNames(SchemaNamesconst&) = delete;
