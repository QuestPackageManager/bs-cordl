...
public:
  // Declarations
  /// @brief Method .ctor addr 0x273173c size 0x10 virtual false final false
...
public:
  ...
  /// @brief Method ConstructPos addr 0x27313f4 size 0x348 virtual true final false
  inline void ConstructPos(::System::Xml::Schema::BitSet* firstpos, ::System::Xml::Schema::BitSet* lastpos,
                           ::ArrayW<::System::Xml::Schema::BitSet*, ::Array<::System::Xml::Schema::BitSet*>*> followpos);

  /// @brief Method get_IsNullable addr 0x273174c size 0x15c virtual true final false
  inline bool get_IsNullable();

  /// @brief Method ExpandTree addr 0x27318a8 size 0x4 virtual true final false
  ...
  /// @brief Method .ctor addr 0x27318ac size 0x8 virtual false final false
  inline void _ctor();
