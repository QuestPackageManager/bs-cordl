...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaSubstitutionGroup*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaSubstitutionGroup*, "System.Xml.Schema", "XmlSchemaSubstitutionGroup");
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaSubstitutionGroup) == 0x48, "Size mismatch!");
