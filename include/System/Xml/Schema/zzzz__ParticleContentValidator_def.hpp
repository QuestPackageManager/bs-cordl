...
public:
  ...
  /// @brief Method AddChoice, addr 0x2dfaa84, size 0xe0, virtual false, abstract: false, final false
  inline void AddChoice();

  /// @brief Method AddLeafNode, addr 0x2dfa918, size 0xdc, virtual false, abstract: false, final false
  inline void AddLeafNode(::System::Xml::Schema::SyntaxTreeNode* node);

  /// @brief Method AddLeafRange, addr 0x2dfaec0, size 0xec, virtual false, abstract: false, final false
  inline void AddLeafRange(::System::Decimal min, ::System::Decimal max);

  /// @brief Method AddName, addr 0x2dfa86c, size 0xac, virtual false, abstract: false, final false
  inline void AddName(::System::Xml::XmlQualifiedName* name, ::System::Object* particle);

  /// @brief Method AddNamespaceList, addr 0x2dfa9f4, size 0x90, virtual false, abstract: false, final false
  inline void AddNamespaceList(::System::Xml::Schema::NamespaceList* namespaceList, ::System::Object* particle);

  /// @brief Method AddPlus, addr 0x2dfadf8, size 0x64, virtual false, abstract: false, final false
  inline void AddPlus();

  /// @brief Method AddQMark, addr 0x2dfae5c, size 0x64, virtual false, abstract: false, final false
  inline void AddQMark();

  /// @brief Method AddSequence, addr 0x2dfab64, size 0xe0, virtual false, abstract: false, final false
  inline void AddSequence();

  /// @brief Method AddStar, addr 0x2dfac44, size 0x64, virtual false, abstract: false, final false
  inline void AddStar();

  /// @brief Method BuildTransitionTable, addr 0x2dfbb70, size 0x598, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateTotalFollowposForRangeNodes, addr 0x2dfb51c, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCMUPAWithLeafRangeNodes, addr 0x2dfb970, size 0x178, virtual false, abstract: false, final false
  inline void CheckCMUPAWithLeafRangeNodes(::System::Xml::Schema::BitSet* curpos);

  /// @brief Method CheckUniqueParticleAttribution, addr 0x2dfc1a8, size 0x1bc, virtual false, abstract: false, final false
  inline void CheckUniqueParticleAttribution(::System::Xml::Schema::BitSet* curpos);

  /// @brief Method CheckUniqueParticleAttribution, addr 0x2dfbae8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method CloseGroup, addr 0x2dfa6e4, size 0x150, virtual false, abstract: false, final false
  inline void CloseGroup();

  /// @brief Method Closure, addr 0x2dfaca8, size 0x150, virtual false, abstract: false, final false
  inline void Closure(::System::Xml::Schema::InteriorNode* node);

  /// @brief Method CompleteValidation, addr 0x2dfa5c4, size 0x40, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method Exists, addr 0x2dfa834, size 0x38, virtual false, abstract: false, final false
  inline bool Exists(::System::Xml::XmlQualifiedName* name);

  /// @brief Method Finish, addr 0x2dfafac, size 0x570, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ContentValidator* Finish(bool useDFA);

  /// @brief Method GetApplicableMinMaxFollowPos, addr 0x2dfb800, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x2dfa544, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method OpenGroup, addr 0x2dfa6bc, size 0x28, virtual false, abstract: false, final false
  inline void OpenGroup();

  /// @brief Method Start, addr 0x2dfa604, size 0xb8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method ValidateElement, addr 0x2dfa584, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dfa4c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaContentType contentType);

  /// @brief Method .ctor, addr 0x2dfa4c8, size 0x7c, virtual false, abstract: false, final false
