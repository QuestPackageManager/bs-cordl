...
/// @brief Method Equal, addr 0x6162970, size 0x74, virtual false, abstract: false, final false
static inline bool Equal(::StringW  thisname, ::StringW  thisURN, ::StringW  name, ::StringW  URN) ;

/// @brief Method MoveToAttribute, addr 0x6162e00, size 0x178, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  name, ::StringW  URN, int32_t  depth) ;

/// @brief Method MoveToChild, addr 0x6162cbc, size 0x144, virtual false, abstract: false, final false
inline bool MoveToChild(::StringW  name, ::StringW  URN, int32_t  depth) ;

/// @brief Method MoveToParent, addr 0x6162b74, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x6162b34, size 0x40, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method Push, addr 0x6162aa8, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6162a0c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::ForwardAxis*  faxis, ::System::Xml::Schema::ActiveAxis*  parent) ;

/// @brief Method get_Length, addr 0x61629ec, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_Subtree, addr 0x61629e4, size 0x8, virtual false, abstract: false, final false
