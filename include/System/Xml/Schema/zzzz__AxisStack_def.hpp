...
public:
  ...
  /// @brief Method Equal, addr 0x63115f0, size 0x74, virtual false, abstract: false, final false
  static inline bool Equal(::StringW thisname, ::StringW thisURN, ::StringW name, ::StringW URN);

  /// @brief Method MoveToAttribute, addr 0x6311a80, size 0x178, virtual false, abstract: false, final false
  inline bool MoveToAttribute(::StringW name, ::StringW URN, int32_t depth);

  /// @brief Method MoveToChild, addr 0x631193c, size 0x144, virtual false, abstract: false, final false
  inline bool MoveToChild(::StringW name, ::StringW URN, int32_t depth);

  /// @brief Method MoveToParent, addr 0x63117f4, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x63117b4, size 0x40, virtual false, abstract: false, final false
  inline void Pop();

  /// @brief Method Push, addr 0x6311728, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631168c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::ForwardAxis* faxis, ::System::Xml::Schema::ActiveAxis* parent);

  /// @brief Method get_Length, addr 0x631166c, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Length();

  /// @brief Method get_Subtree, addr 0x6311664, size 0x8, virtual false, abstract: false, final false
