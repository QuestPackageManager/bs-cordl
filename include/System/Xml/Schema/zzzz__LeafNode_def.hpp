...
public:
  ...
  /// @brief Method ConstructPos, addr 0x63191a4, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method ExpandTree, addr 0x63191a0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6319188, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t pos);

  /// @brief Method get_IsNullable, addr 0x63191e4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_Pos, addr 0x6319190, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Pos();

  /// @brief Method set_Pos, addr 0x6319198, size 0x8, virtual false, abstract: false, final false
