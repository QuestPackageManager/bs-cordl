...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeafNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeafNode(LeafNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeafNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeafNode(LeafNodeconst&) = delete;
