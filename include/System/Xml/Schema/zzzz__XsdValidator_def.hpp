...
/// @brief Method AddID, addr 0x60c1c8c, size 0x98, virtual false, abstract: false, final false
inline void AddID(::StringW  name, ::System::Object*  node) ;

/// @brief Method AddIdentityConstraints, addr 0x60c1d40, size 0x400, virtual false, abstract: false, final false
inline void AddIdentityConstraints() ;

/// @brief Method AttributeIdentityConstraints, addr 0x60c1220, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method CheckForwardRefs, addr 0x60be0d4, size 0x10c, virtual false, abstract: false, final false
inline void CheckForwardRefs() ;

/// @brief Method CheckValue, addr 0x60bffc4, size 0x464, virtual false, abstract: false, final false
inline void CheckValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CompleteValidation, addr 0x60be0d0, size 0x4, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method ElementIdentityConstraints, addr 0x60c2140, size 0x350, virtual false, abstract: false, final false
inline void ElementIdentityConstraints() ;

/// @brief Method EndElementIdentityConstraints, addr 0x60c0438, size 0xca8, virtual false, abstract: false, final false
inline void EndElementIdentityConstraints() ;

/// @brief Method FastGetElementDecl, addr 0x60be64c, size 0xec, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaElementDecl* FastGetElementDecl(::System::Object*  particle) ;

/// @brief Method FindId, addr 0x60c1d24, size 0x1c, virtual true, abstract: false, final false
inline ::System::Object* FindId(::StringW  name) ;

/// @brief Method Init, addr 0x60bd5d0, size 0x35c, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method IsXSDRoot, addr 0x60be3d8, size 0x24, virtual false, abstract: false, final false
inline bool IsXSDRoot(::StringW  localName, ::StringW  ns) ;

/// @brief Method LoadSchema, addr 0x60bfdf8, size 0x1cc, virtual false, abstract: false, final false
inline void LoadSchema(::StringW  uri, ::StringW  url) ;

/// @brief Method LoadSchemaFromLocation, addr 0x60c14f8, size 0x558, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x60c10e0, size 0xc4, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method ProcessElement, addr 0x60be3fc, size 0x250, virtual false, abstract: false, final false
inline void ProcessElement(::System::Object*  particle) ;

/// @brief Method ProcessInlineSchema, addr 0x60bdb08, size 0x280, virtual false, abstract: false, final false
inline void ProcessInlineSchema() ;

/// @brief Method ProcessTokenizedType, addr 0x60c1a90, size 0x1fc, virtual false, abstract: false, final false
inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType  ttype, ::StringW  name) ;

/// @brief Method ProcessXsiAttributes, addr 0x60be738, size 0x78c, virtual false, abstract: false, final false
inline void ProcessXsiAttributes(::ByRef<::System::Xml::XmlQualifiedName*>  xsiType, ::ByRef<::StringW>  xsiNil) ;

/// @brief Method Push, addr 0x60bd950, size 0xf0, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method ThoroughGetElementDecl, addr 0x60beec4, size 0x41c, virtual false, abstract: false, final false
...
/// @brief Method UnWrapUnion, addr 0x60c11a4, size 0x7c, virtual false, abstract: false, final false
inline ::System::Object* UnWrapUnion(::System::Object*  typedValue) ;

/// @brief Method Validate, addr 0x60bda40, size 0xb8, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateChildElement, addr 0x60be1e0, size 0x1f8, virtual false, abstract: false, final false
inline ::System::Object* ValidateChildElement() ;

/// @brief Method ValidateElement, addr 0x60bdd88, size 0x164, virtual false, abstract: false, final false
inline void ValidateElement() ;

/// @brief Method ValidateEndElement, addr 0x60bdeec, size 0x1e4, virtual false, abstract: false, final false
inline void ValidateEndElement() ;

/// @brief Method ValidateEndStartElement, addr 0x60bfa30, size 0x3c8, virtual false, abstract: false, final false
inline void ValidateEndStartElement() ;

/// @brief Method ValidateStartElement, addr 0x60bf34c, size 0x6e4, virtual false, abstract: false, final false
inline void ValidateStartElement() ;

/// @brief Method ValidateStartElementIdentityConstraints, addr 0x60bf300, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60bd92c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60bd5ac, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get_HasIdentityConstraints, addr 0x60c0428, size 0x10, virtual false, abstract: false, final false
inline bool get_HasIdentityConstraints() ;

/// @brief Method get_HasSchema, addr 0x60bf2e0, size 0x20, virtual false, abstract: false, final false
inline bool get_HasSchema() ;

/// @brief Method get_IsInlineSchemaStarted, addr 0x60bdaf8, size 0x10, virtual false, abstract: false, final false
inline bool get_IsInlineSchemaStarted() ;

/// @brief Method get_PreserveWhitespace, addr 0x60c1a50, size 0x40, virtual true, abstract: false, final false
