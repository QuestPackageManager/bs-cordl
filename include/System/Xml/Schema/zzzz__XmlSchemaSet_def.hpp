...
/// @brief Method Add, addr 0x6082a48, size 0x178, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Add(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Add, addr 0x60829ec, size 0x5c, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Add(::StringW  targetNamespace, ::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Add, addr 0x6080638, size 0x8f0, virtual false, abstract: false, final false
inline void Add(::System::Xml::Schema::XmlSchemaSet*  schemas) ;

/// @brief Method Add, addr 0x6085d40, size 0x398, virtual false, abstract: false, final false
inline void Add(::StringW  targetNamespace, ::System::Xml::XmlReader*  reader, ::System::Collections::Hashtable*  validatedNamespaces) ;

/// @brief Method AddSchemaToSet, addr 0x60859c4, size 0x37c, virtual false, abstract: false, final false
inline void AddSchemaToSet(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method AddToTable, addr 0x6086d7c, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method ClearTables, addr 0x6083eac, size 0x5c, virtual false, abstract: false, final false
inline void ClearTables() ;

/// @brief Method Compile, addr 0x6083a0c, size 0x4a0, virtual false, abstract: false, final false
inline void Compile() ;

/// @brief Method Contains, addr 0x60839c8, size 0x44, virtual false, abstract: false, final false
inline bool Contains(::StringW  targetNamespace) ;

/// @brief Method CopyFromCompiledSet, addr 0x6080f28, size 0x186c, virtual false, abstract: false, final false
inline void CopyFromCompiledSet(::System::Xml::Schema::XmlSchemaSet*  otherSet) ;

/// @brief Method CopyTo, addr 0x608583c, size 0x168, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<::System::Xml::Schema::XmlSchema*,::Array<::System::Xml::Schema::XmlSchema*>*>  schemas, int32_t  index) ;

/// @brief Method FindSchemaByNSAndUrl, addr 0x6082794, size 0x258, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* FindSchemaByNSAndUrl(::System::Uri*  schemaUri, ::StringW  ns, ::ArrayW<::System::Collections::DictionaryEntry,::Array<::System::Collections::DictionaryEntry>*>  locationsTable) ;

/// @brief Method GetEventHandler, addr 0x6087210, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ValidationEventHandler* GetEventHandler() ;

/// @brief Method GetResolver, addr 0x60871f8, size 0x18, virtual false, abstract: false, final false
inline ::System::Xml::XmlResolver* GetResolver() ;

/// @brief Method GetSchemaByUri, addr 0x6087218, size 0x14c, virtual false, abstract: false, final false
inline bool GetSchemaByUri(::System::Uri*  schemaUri, ::ByRef<::System::Xml::Schema::XmlSchema*>  schema) ;

/// @brief Method GetSchemaNames, addr 0x6087078, size 0xa4, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaNames* GetSchemaNames(::System::Xml::XmlNameTable*  nt) ;

/// @brief Method GetTargetNamespace, addr 0x60835b4, size 0x2c, virtual false, abstract: false, final false
inline ::StringW GetTargetNamespace(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method InternalValidationCallback, addr 0x608736c, size 0x38, virtual false, abstract: false, final false
inline void InternalValidationCallback(::System::Object*  sender, ::System::Xml::Schema::ValidationEventArgs*  e) ;

/// @brief Method IsSchemaLoaded, addr 0x60860d8, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method ParseSchema, addr 0x6086368, size 0x170, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* ParseSchema(::StringW  targetNamespace, ::System::Xml::XmlReader*  reader) ;

/// @brief Method PreprocessSchema, addr 0x608574c, size 0xf0, virtual false, abstract: false, final false
inline bool PreprocessSchema(::ByRef<::System::Xml::Schema::XmlSchema*>  schema, ::StringW  targetNamespace) ;

/// @brief Method ProcessNewSubstitutionGroups, addr 0x60864d8, size 0x4b0, virtual false, abstract: false, final false
inline void ProcessNewSubstitutionGroups(::System::Xml::Schema::XmlSchemaObjectTable*  substitutionGroupsTable, bool  resolve) ;

/// @brief Method Remove, addr 0x6083684, size 0x344, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Remove(::System::Xml::Schema::XmlSchema*  schema, bool  forceCompile) ;

/// @brief Method RemoveRecursive, addr 0x6082bc0, size 0x9f4, virtual false, abstract: false, final false
inline bool RemoveRecursive(::System::Xml::Schema::XmlSchema*  schemaToRemove) ;

/// @brief Method RemoveSchemaFromCaches, addr 0x6084fd0, size 0x618, virtual false, abstract: false, final false
inline void RemoveSchemaFromCaches(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method RemoveSchemaFromGlobalTables, addr 0x60845ec, size 0x9e4, virtual false, abstract: false, final false
inline void RemoveSchemaFromGlobalTables(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Reprocess, addr 0x6083f08, size 0x6e4, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Reprocess(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method ResolveSubstitutionGroup, addr 0x6086988, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method Schemas, addr 0x60859a4, size 0x20, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* Schemas() ;

/// @brief Method Schemas, addr 0x60855e8, size 0x164, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* Schemas(::StringW  targetNamespace) ;

/// @brief Method SendValidationEvent, addr 0x60835e0, size 0xa4, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method VerifyTables, addr 0x608711c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x607ffc4, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6080024, size 0x274, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNameTable*  nameTable) ;

/// @brief Method add_ValidationEventHandler, addr 0x6080298, size 0xc4, virtual false, abstract: false, final false
inline void add_ValidationEventHandler(::System::Xml::Schema::ValidationEventHandler*  value) ;

/// @brief Method get_CompilationSettings, addr 0x608040c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCompilationSettings* get_CompilationSettings() ;

/// @brief Method get_CompiledInfo, addr 0x60871e8, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_CompiledInfo() ;

/// @brief Method get_Count, addr 0x608041c, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_GlobalAttributes, addr 0x60804a0, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalAttributes() ;

/// @brief Method get_GlobalElements, addr 0x608043c, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalElements() ;

/// @brief Method get_GlobalTypes, addr 0x6080504, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalTypes() ;

/// @brief Method get_InternalSyncObject, addr 0x607ff58, size 0x6c, virtual false, abstract: false, final false
inline ::System::Object* get_InternalSyncObject() ;

/// @brief Method get_IsCompiled, addr 0x60803ec, size 0x8, virtual false, abstract: false, final false
inline bool get_IsCompiled() ;

/// @brief Method get_ReaderSettings, addr 0x60871f0, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_ReaderSettings() ;

/// @brief Method get_SchemaLocations, addr 0x60805cc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Hashtable* get_SchemaLocations() ;

/// @brief Method get_SortedSchemas, addr 0x6087364, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::SortedList* get_SortedSchemas() ;

/// @brief Method get_SubstitutionGroups, addr 0x6080568, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_SubstitutionGroups() ;

/// @brief Method get_TypeExtensions, addr 0x60805d4, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_TypeExtensions() ;

/// @brief Method remove_ValidationEventHandler, addr 0x608035c, size 0x90, virtual false, abstract: false, final false
inline void remove_ValidationEventHandler(::System::Xml::Schema::ValidationEventHandler*  value) ;

/// @brief Method set_CompilationSettings, addr 0x6080414, size 0x8, virtual false, abstract: false, final false
inline void set_CompilationSettings(::System::Xml::Schema::XmlSchemaCompilationSettings*  value) ;

/// @brief Method set_XmlResolver, addr 0x60803f4, size 0x18, virtual false, abstract: false, final false
