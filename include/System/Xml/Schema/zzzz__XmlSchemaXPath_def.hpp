...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaXPath*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaXPath*, "System.Xml.Schema", "XmlSchemaXPath");
...
public:
  ...
  /// @brief Method .ctor, addr 0x622c1ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XPath, addr 0x622c19c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XPath();

  /// @brief Method set_XPath, addr 0x622c1a4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaXPath) == 0x58, "Size mismatch!");
