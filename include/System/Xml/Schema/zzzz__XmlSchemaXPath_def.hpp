...
public:
  ...
  /// @brief Method .ctor, addr 0x60ef538, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XPath, addr 0x60ef528, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XPath();

  /// @brief Method set_XPath, addr 0x60ef530, size 0x8, virtual false, abstract: false, final false
