...
/// @brief Method .ctor, addr 0x60f10b0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_XPath, addr 0x60f10a0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_XPath() ;

/// @brief Method set_XPath, addr 0x60f10a8, size 0x8, virtual false, abstract: false, final false
