...
public:
  ...
  /// @brief Method .ctor, addr 0x607ce6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XPath, addr 0x607ce5c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XPath();

  /// @brief Method set_XPath, addr 0x607ce64, size 0x8, virtual false, abstract: false, final false
