...
public:
  ...
  /// @brief Method .ctor, addr 0x425c5f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XPath, addr 0x425c5e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XPath();

  /// @brief Method set_XPath, addr 0x425c5ec, size 0x8, virtual false, abstract: false, final false
