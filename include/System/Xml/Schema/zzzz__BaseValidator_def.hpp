...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BaseValidator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BaseValidator(BaseValidator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BaseValidator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BaseValidator(BaseValidatorconst&) = delete;
