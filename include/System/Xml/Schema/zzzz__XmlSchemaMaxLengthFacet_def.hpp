...
public:
  ...
  /// @brief Method .ctor, addr 0x62316b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMaxLengthFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaMaxLengthFacet(XmlSchemaMaxLengthFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMaxLengthFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaMaxLengthFacet(XmlSchemaMaxLengthFacetconst&) = delete;
