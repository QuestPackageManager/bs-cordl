...
public:
  ...
  /// @brief Method .ctor, addr 0x43a1ca8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaSimpleType* st, ::System::Object* value);

  /// @brief Method get_TypedValue, addr 0x43a1cdc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_TypedValue();

  /// @brief Method get_XmlType, addr 0x43a1cd4, size 0x8, virtual false, abstract: false, final false
