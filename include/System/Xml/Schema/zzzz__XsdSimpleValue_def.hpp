...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XsdSimpleValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XsdSimpleValue(XsdSimpleValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XsdSimpleValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XsdSimpleValue(XsdSimpleValueconst&) = delete;
