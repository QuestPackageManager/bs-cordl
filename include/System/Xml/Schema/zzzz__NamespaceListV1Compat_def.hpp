...
public:
  // Declarations
  /// @brief Method Allows, addr 0x609d27c, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x609d278, size 0x4, virtual false, abstract: false, final false
