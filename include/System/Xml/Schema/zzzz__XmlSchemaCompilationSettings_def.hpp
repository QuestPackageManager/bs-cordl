...
public:
  ...
  /// @brief Method .ctor, addr 0x60eba8c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EnableUpaCheck, addr 0x60eba98, size 0x8, virtual false, abstract: false, final false
