...
public:
  ...
  /// @brief Method .ctor, addr 0x2e31140, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EnableUpaCheck, addr 0x2e31160, size 0x8, virtual false, abstract: false, final false
