...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaCompilationSettings*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaCompilationSettings*, "System.Xml.Schema", "XmlSchemaCompilationSettings");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaCompilationSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaCompilationSettings(XmlSchemaCompilationSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaCompilationSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaCompilationSettings(XmlSchemaCompilationSettingsconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaCompilationSettings) == 0x18, "Size mismatch!");
