...
public:
  ...
  /// @brief Method .ctor, addr 0x6011834, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EnableUpaCheck, addr 0x6011840, size 0x8, virtual false, abstract: false, final false
