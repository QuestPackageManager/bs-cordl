...
// Ctor Parameters [CppParam { name: "State", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "AllElementsRequired", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "CurPosIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "NumberOfRunningPos", ty: "int32_t", modifiers: "", def_value: None }]
