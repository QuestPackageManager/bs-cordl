...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaWhiteSpace, "System.Xml.Schema", "XmlSchemaWhiteSpace");
// Dependencies
namespace System::Xml::Schema {
// Is value type: true
...
public:
  ...
  /// @brief Field Collapse value: I32(2)
  static ::System::Xml::Schema::XmlSchemaWhiteSpace const Collapse;

  /// @brief Field Preserve value: I32(0)
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaWhiteSpace) == 0x4, "Size mismatch!");
