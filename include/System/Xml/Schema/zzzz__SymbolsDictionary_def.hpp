...
public:
  ...
  /// @brief Method .ctor addr 0x272fafc size 0xa4 virtual false final false
  inline void _ctor();

  /// @brief Method get_Count addr 0x272fba0 size 0xc virtual false final false
  inline int32_t get_Count();

  /// @brief Method get_IsUpaEnforced addr 0x272fbac size 0x8 virtual false final false
  inline bool get_IsUpaEnforced();

  /// @brief Method set_IsUpaEnforced addr 0x272fbb4 size 0xc virtual false final false
  inline void set_IsUpaEnforced(bool value);

  /// @brief Method AddName addr 0x272fbc0 size 0x134 virtual false final false
  inline int32_t AddName(::System::Xml::XmlQualifiedName* name, ::System::Object* particle);

  /// @brief Method AddNamespaceList addr 0x272fcf4 size 0x39c virtual false final false
  inline void AddNamespaceList(::System::Xml::Schema::NamespaceList* list, ::System::Object* particle, bool allowLocal);

  /// @brief Method AddWildcard addr 0x2730090 size 0x168 virtual false final false
  inline void AddWildcard(::StringW wildcard, ::System::Object* particle);

  /// @brief Method GetNamespaceListSymbols addr 0x27301f8 size 0x78c virtual false final false
  inline ::System::Collections::ICollection* GetNamespaceListSymbols(::System::Xml::Schema::NamespaceList* list);

  /// @brief Method Exists addr 0x2730984 size 0x30 virtual false final false
  inline bool Exists(::System::Xml::XmlQualifiedName* name);

  /// @brief Method GetParticle addr 0x27309b4 size 0x3c virtual false final false
