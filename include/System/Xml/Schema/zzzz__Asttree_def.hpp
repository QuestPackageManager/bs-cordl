...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Asttree", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Asttree(Asttree&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Asttree", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Asttree(Asttreeconst&) = delete;
