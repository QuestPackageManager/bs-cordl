...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaKeyref*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaKeyref*, "System.Xml.Schema", "XmlSchemaKeyref");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6231a6c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Refer, addr 0x62319d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_Refer();

  /// @brief Method set_Refer, addr 0x62319d8, size 0x94, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaKeyref) == 0x80, "Size mismatch!");
