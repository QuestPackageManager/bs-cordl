...
/// @brief Method .ctor, addr 0x6167748, size 0x104, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::CompiledIdentityConstraint*  constraint) ;

/// @brief Method get_TableDim, addr 0x6167740, size 0x8, virtual false, abstract: false, final false
