...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConstraintStruct", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConstraintStruct(ConstraintStruct&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConstraintStruct", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConstraintStruct(ConstraintStructconst&) = delete;
