...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMinLengthFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaMinLengthFacet(XmlSchemaMinLengthFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMinLengthFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaMinLengthFacet(XmlSchemaMinLengthFacetconst&) = delete;
