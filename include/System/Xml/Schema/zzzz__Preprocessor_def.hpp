...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Preprocessor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Preprocessor(Preprocessor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Preprocessor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Preprocessor(Preprocessorconst&) = delete;
