...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::AttributeMatchState, "System.Xml.Schema", "AttributeMatchState");
// Dependencies
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(sizeof(::System::Xml::Schema::AttributeMatchState) == 0x4, "Size mismatch!");
