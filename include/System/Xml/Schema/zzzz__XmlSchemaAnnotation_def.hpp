...
public:
  ...
  /// @brief Method SetUnhandledAttributes, addr 0x60e99fc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60e9a04, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Id, addr 0x60e99d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_IdAttribute, addr 0x60e99ec, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IdAttribute();

  /// @brief Method get_Items, addr 0x60e99e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items();

  /// @brief Method set_Id, addr 0x60e99dc, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::StringW value);

  /// @brief Method set_IdAttribute, addr 0x60e99f4, size 0x8, virtual true, abstract: false, final false
