...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaWhiteSpaceFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaWhiteSpaceFacet(XmlSchemaWhiteSpaceFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaWhiteSpaceFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaWhiteSpaceFacet(XmlSchemaWhiteSpaceFacetconst&) = delete;
