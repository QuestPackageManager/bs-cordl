...
public:
  ...
  /// @brief Method .ctor, addr 0x28b475c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28b4788, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Xml::Schema::DatatypeImplementation* type, int32_t parentIndex);

  /// @brief Method op_Explicit, addr 0x28b5948, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Name, addr 0x28b5960, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ParentIndex, addr 0x28b5968, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ParentIndex();

  /// @brief Method CompareTo, addr 0x28b5970, size 0x70, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method get_AnySimpleType, addr 0x28b4f90, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* get_AnySimpleType();

  /// @brief Method get_UntypedAtomicType, addr 0x28b4fe8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* get_UntypedAtomicType();

  /// @brief Method FromXmlTokenizedType, addr 0x28b5040, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::DatatypeImplementation* FromXmlTokenizedType(::System::Xml::XmlTokenizedType token);

  /// @brief Method FromTypeName, addr 0x28b50bc, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::DatatypeImplementation* FromTypeName(::StringW name);

  /// @brief Method StartBuiltinType, addr 0x28b517c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishBuiltinType, addr 0x28b5250, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBuiltinTypes, addr 0x28b47c4, size 0x7cc, virtual false, abstract: false, final false
  static inline void CreateBuiltinTypes();

  /// @brief Method GetSimpleTypeFromTypeCode, addr 0x28b5434, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetSimpleTypeFromTypeCode(::System::Xml::Schema::XmlTypeCode typeCode);

  /// @brief Method DeriveByList, addr 0x28b45d4, size 0x188, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* DeriveByList(int32_t minSize, ::System::Xml::Schema::XmlSchemaType* schemaType);

  /// @brief Method IsEqual, addr 0x28b5524, size 0x20, virtual true, abstract: false, final false
  inline bool IsEqual(::System::Object* o1, ::System::Object* o2);

  /// @brief Method CreateValueConverter, addr 0x28b5544, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlValueConverter* CreateValueConverter(::System::Xml::Schema::XmlSchemaType* schemaType);

  /// @brief Method get_FacetsChecker, addr 0x28b554c, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ValueConverter, addr 0x28b55a4, size 0x34, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlValueConverter* get_ValueConverter();

  /// @brief Method get_TokenizedType, addr 0x28b55d8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  /// @brief Method get_ValueType, addr 0x28b55e0, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_Variety, addr 0x28b564c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatypeVariety get_Variety();

  /// @brief Method get_TypeCode, addr 0x28b5654, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_Restriction, addr 0x28b565c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_BuiltInWhitespaceFacet, addr 0x28b5664, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet();

  /// @brief Method ParseValue, addr 0x28b566c, size 0x1f8, virtual true, abstract: false, final false
  inline ::System::Object* ParseValue(::StringW s, ::System::Xml::XmlNameTable* nameTable, ::System::Xml::IXmlNamespaceResolver* nsmgr);

  /// @brief Method GetTypeName, addr 0x28b5864, size 0x68, virtual false, abstract: false, final false
  inline ::StringW GetTypeName();

  /// @brief Method Compare, addr 0x28b58cc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28b5940, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
