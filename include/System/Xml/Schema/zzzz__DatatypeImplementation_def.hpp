...
public:
  ...
  /// @brief Method CompareTo, addr 0x43a8688, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x43a6280, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Xml::Schema::DatatypeImplementation* type);

  /// @brief Method .ctor, addr 0x43a62ac, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Xml::Schema::DatatypeImplementation* type, int32_t parentIndex);

  /// @brief Method get_Name, addr 0x43a8678, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ParentIndex, addr 0x43a8680, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ParentIndex();

  /// @brief Convert to "::System::IComparable"
  constexpr ::System::IComparable* i___System__IComparable() noexcept;

  /// @brief Method op_Explicit, addr 0x43a8660, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compare, addr 0x43a85e4, size 0x74, virtual false, abstract: false, final false
  inline int32_t Compare(::ArrayW<uint8_t, ::Array<uint8_t>*> value1, ::ArrayW<uint8_t, ::Array<uint8_t>*> value2);

  /// @brief Method CreateBuiltinTypes, addr 0x43a62e8, size 0x7d0, virtual false, abstract: false, final false
  static inline void CreateBuiltinTypes();

  /// @brief Method CreateValueConverter, addr 0x43a7cec, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlValueConverter* CreateValueConverter(::System::Xml::Schema::XmlSchemaType* schemaType);

  /// @brief Method DeriveByList, addr 0x43a5778, size 0x180, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* DeriveByList(int32_t minSize, ::System::Xml::Schema::XmlSchemaType* schemaType);

  /// @brief Method DeriveByList, addr 0x43a7734, size 0xc, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* DeriveByList(::System::Xml::Schema::XmlSchemaType* schemaType);

  /// @brief Method DeriveByRestriction, addr 0x43a7650, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method DeriveByUnion, addr 0x43a782c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishBuiltinType, addr 0x43a6eb0, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method FromTypeName, addr 0x43a6d20, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::DatatypeImplementation* FromTypeName(::StringW name);

  /// @brief Method FromXdrName, addr 0x43a6c60, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::DatatypeImplementation* FromXdrName(::StringW name);

  /// @brief Method FromXmlTokenizedType, addr 0x43a6b68, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::DatatypeImplementation* FromXmlTokenizedType(::System::Xml::XmlTokenizedType token);

  /// @brief Method FromXmlTokenizedTypeXsd, addr 0x43a6be4, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::DatatypeImplementation* FromXmlTokenizedTypeXsd(::System::Xml::XmlTokenizedType token);

  /// @brief Method GetBuiltInTypes, addr 0x43a74c8, size 0x58, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Xml::Schema::XmlSchemaSimpleType*, ::Array<::System::Xml::Schema::XmlSchemaSimpleType*>*> GetBuiltInTypes();

  /// @brief Method GetNormalizedStringTypeV1Compat, addr 0x43a71e8, size 0x170, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetNormalizedStringTypeV1Compat();

  /// @brief Method GetPrimitiveTypeCode, addr 0x43a7520, size 0x130, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlTypeCode GetPrimitiveTypeCode(::System::Xml::Schema::XmlTypeCode typeCode);

  /// @brief Method GetSimpleTypeFromTypeCode, addr 0x43a70ac, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetSimpleTypeFromTypeCode(::System::Xml::Schema::XmlTypeCode typeCode);

  /// @brief Method GetSimpleTypeFromXsdType, addr 0x43a7128, size 0xc0, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetSimpleTypeFromXsdType(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method GetTokenTypeV1Compat, addr 0x43a7358, size 0x170, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* GetTokenTypeV1Compat();

  /// @brief Method GetTypeName, addr 0x43a8040, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW GetTypeName();

  /// @brief Method IsComparable, addr 0x43a7c00, size 0xec, virtual true, abstract: false, final false
  inline bool IsComparable(::System::Xml::Schema::XmlSchemaDatatype* dtype);

  /// @brief Method IsDerivedFrom, addr 0x43a7944, size 0x210, virtual true, abstract: false, final false
  inline bool IsDerivedFrom(::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method IsEqual, addr 0x43a7bdc, size 0x24, virtual true, abstract: false, final false
  inline bool IsEqual(::System::Object* o1, ::System::Object* o2);

  static inline ::System::Xml::Schema::DatatypeImplementation* New_ctor();

  /// @brief Method ParseValue, addr 0x43a7e6c, size 0x1d4, virtual true, abstract: false, final false
  inline ::System::Object* ParseValue(::StringW s, ::System::Xml::XmlNameTable* nameTable, ::System::Xml::IXmlNamespaceResolver* nsmgr);

  /// @brief Method ParseValue, addr 0x43a80ac, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method StartBuiltinType, addr 0x43a6de0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseValue, addr 0x43a8200, size 0x3e4, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifySchemaValid, addr 0x43a7940, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43a8658, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AnySimpleType, addr 0x43a6ab8, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaSimpleType* get_AnySimpleType();

  /// @brief Method get_Base, addr 0x43a7e5c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::DatatypeImplementation* get_Base();

  /// @brief Method get_BuiltInWhitespaceFacet, addr 0x43a7e64, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet();

  /// @brief Method get_FacetsChecker, addr 0x43a7cf4, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_HasLexicalFacets, addr 0x43a7e0c, size 0x28, virtual true, abstract: false, final false
  inline bool get_HasLexicalFacets();

  /// @brief Method get_HasValueFacets, addr 0x43a7e34, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Restriction, addr 0x43a7e04, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::RestrictionFacets* get_Restriction();

  /// @brief Method get_TokenizedType, addr 0x43a7d80, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  /// @brief Method get_TypeCode, addr 0x43a7dfc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_UntypedAtomicType, addr 0x43a6b10, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ValueConverter, addr 0x43a7d4c, size 0x34, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlValueConverter* get_ValueConverter();

  /// @brief Method get_ValueType, addr 0x43a7d88, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_Variety, addr 0x43a7df4, size 0x8, virtual true, abstract: false, final false
