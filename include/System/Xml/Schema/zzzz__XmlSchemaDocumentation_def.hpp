...
public:
  ...
  /// @brief Method .ctor, addr 0x6013f10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_Language, addr 0x6013e44, size 0xc4, virtual false, abstract: false, final false
  inline void set_Language(::StringW value);

  /// @brief Method set_Markup, addr 0x6013f08, size 0x8, virtual false, abstract: false, final false
  inline void set_Markup(::ArrayW<::System::Xml::XmlNode*, ::Array<::System::Xml::XmlNode*>*> value);

  /// @brief Method set_Source, addr 0x6013e3c, size 0x8, virtual false, abstract: false, final false
