...
public:
  ...
  /// @brief Method MoveToChild, addr 0x6316c70, size 0x168, virtual false, abstract: false, final false
  inline bool MoveToChild(::StringW name, ::StringW URN, int32_t depth, ::System::Xml::Schema::ForwardAxis* parent);

  /// @brief Method MoveToParent, addr 0x6316b5c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDepth, addr 0x6316b54, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6316b44, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::DoubleLinkAxis* node, int32_t depth);

  /// @brief Method get_CurNode, addr 0x6316b3c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AxisElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AxisElement(AxisElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AxisElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AxisElement(AxisElementconst&) = delete;
