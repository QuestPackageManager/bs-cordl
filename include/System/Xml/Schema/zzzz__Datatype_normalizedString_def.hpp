...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_normalizedString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_normalizedString(Datatype_normalizedString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_normalizedString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_normalizedString(Datatype_normalizedStringconst&) = delete;
