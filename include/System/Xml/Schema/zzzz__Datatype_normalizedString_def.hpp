...
public:
  ...
  /// @brief Method get_TypeCode, addr 0x28bb650, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_BuiltInWhitespaceFacet, addr 0x28bb658, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet();

  static inline ::System::Xml::Schema::Datatype_normalizedString* New_ctor();

  /// @brief Method .ctor, addr 0x28bb660, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
