...
public:
  ...
  /// @brief Method .ctor, addr 0x623bc9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaSimpleTypeContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaSimpleTypeContent(XmlSchemaSimpleTypeContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaSimpleTypeContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaSimpleTypeContent(XmlSchemaSimpleTypeContentconst&) = delete;
