...
/// @brief Method ConstructPos, addr 0x616b4cc, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x616b4f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsNullable, addr 0x616b4e8, size 0x8, virtual true, abstract: false, final false
