...
public:
  ...
  /// @brief Method ConstructPos addr 0x2731c00 size 0x20 virtual true final false
  inline void ConstructPos(::System::Xml::Schema::BitSet* firstpos, ::System::Xml::Schema::BitSet* lastpos,
                           ::ArrayW<::System::Xml::Schema::BitSet*, ::Array<::System::Xml::Schema::BitSet*>*> followpos);

  /// @brief Method get_IsNullable addr 0x2731c20 size 0x8 virtual true final false
  inline bool get_IsNullable();

  static inline ::System::Xml::Schema::QmarkNode* New_ctor();

  /// @brief Method .ctor addr 0x2731c28 size 0x8 virtual false final false
  inline void _ctor();
