...
public:
  ...
  /// @brief Method CompleteValidation, addr 0x6318a8c, size 0x4, virtual true, abstract: false, final false
  inline void CompleteValidation();

  /// @brief Method DetectValidationType, addr 0x6318758, size 0x334, virtual false, abstract: false, final false
  inline ::System::Xml::ValidationType DetectValidationType();

  /// @brief Method FindId, addr 0x6318a90, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x6318668, size 0xf0, virtual true, abstract: false, final false
  inline void Validate();

  /// @brief Method .ctor, addr 0x6318510, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PreserveWhitespace, addr 0x6318660, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AutoValidator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AutoValidator(AutoValidator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AutoValidator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AutoValidator(AutoValidatorconst&) = delete;
