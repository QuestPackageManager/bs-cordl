...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaContentType, "System.Xml.Schema", "XmlSchemaContentType");
// Dependencies
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaContentType) == 0x4, "Size mismatch!");
