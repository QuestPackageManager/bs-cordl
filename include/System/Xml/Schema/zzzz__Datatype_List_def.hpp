...
public:
  ...
  /// @brief Method Compare, addr 0x600e2d0, size 0x290, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  /// @brief Method CreateValueConverter, addr 0x600dffc, size 0x2d4, virtual true, abstract: false, final false
  ...
  /// @brief Method TryParseValue, addr 0x600ec04, size 0x438, virtual true, abstract: false, final false
  inline ::System::Exception* TryParseValue(::StringW s, ::System::Xml::XmlNameTable* nameTable, ::System::Xml::IXmlNamespaceResolver* nsmgr, ::ByRef<::System::Object*> typedValue);

  /// @brief Method TryParseValue, addr 0x600e634, size 0x5d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x600d1ac, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::DatatypeImplementation* type, int32_t minListSize);

  /// @brief Method get_FacetsChecker, addr 0x600e5ac, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ItemType, addr 0x600e62c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::DatatypeImplementation* get_ItemType();

  /// @brief Method get_ListValueType, addr 0x600e58c, size 0x20, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TokenizedType, addr 0x600e570, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  /// @brief Method get_TypeCode, addr 0x600e608, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValidRestrictionFlags, addr 0x600e624, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::RestrictionFlags get_ValidRestrictionFlags();

  /// @brief Method get_ValueType, addr 0x600e560, size 0x10, virtual true, abstract: false, final false
