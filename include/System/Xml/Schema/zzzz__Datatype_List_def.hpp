...
public:
  ...
  /// @brief Method Compare, addr 0x29a0768, size 0x29c, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  /// @brief Method CreateValueConverter, addr 0x29a04c4, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method TryParseValue, addr 0x29a0ad0, size 0x418, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x299ff94, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::DatatypeImplementation* type, int32_t minListSize);

  /// @brief Method get_FacetsChecker, addr 0x29a0a58, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x29a0a34, size 0x24, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TokenizedType, addr 0x29a0a14, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  /// @brief Method get_TypeCode, addr 0x29a0ab0, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValueType, addr 0x29a0a04, size 0x10, virtual true, abstract: false, final false
