...
public:
  ...
  /// @brief Method Add, addr 0x5fe956c, size 0x974, virtual false, abstract: false, final false
  inline void Add(::System::Xml::Schema::SchemaInfo* sinfo, ::System::Xml::Schema::ValidationEventHandler* eventhandler);

  /// @brief Method Contains, addr 0x5fe9058, size 0x7c, virtual false, abstract: false, final false
  inline bool Contains(::StringW ns);

  /// @brief Method Finish, addr 0x5fe9ee0, size 0x174, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method GetAttributeXdr, addr 0x5fe90d4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeXsd, addr 0x5fe9244, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeXsd, addr 0x5fe9474, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetElement, addr 0x5fe8fc4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* GetElement(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method GetElementDecl, addr 0x5fe8ecc, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* GetElementDecl(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method GetTypeDecl, addr 0x5fe8f48, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* GetTypeDecl(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method HasSchema, addr 0x5fe8fdc, size 0x7c, virtual false, abstract: false, final false
  inline bool HasSchema(::StringW ns);

  static inline ::System::Xml::Schema::SchemaInfo* New_ctor();

  /// @brief Method System.Xml.IDtdInfo.LookupAttributeList, addr 0x5fea064, size 0xd0, virtual true, abstract: false, final true
  inline ::System::Xml::IDtdAttributeListInfo* System_Xml_IDtdInfo_LookupAttributeList(::StringW prefix, ::StringW localName);

  /// @brief Method System.Xml.IDtdInfo.LookupEntity, addr 0x5fea134, size 0xc8, virtual true, abstract: false, final true
  inline ::System::Xml::IDtdEntityInfo* System_Xml_IDtdInfo_LookupEntity(::StringW name);

  /// @brief Method System.Xml.IDtdInfo.get_HasDefaultAttributes, addr 0x5fea054, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdInfo_get_HasDefaultAttributes();

  /// @brief Method System.Xml.IDtdInfo.get_HasNonCDataAttributes, addr 0x5fea05c, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdInfo_get_HasNonCDataAttributes();

  /// @brief Method System.Xml.IDtdInfo.get_InternalDtdSubset, addr 0x5fea204, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdInfo_get_InternalDtdSubset();

  /// @brief Method System.Xml.IDtdInfo.get_Name, addr 0x5fea1fc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5fe8a44, size 0x23c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AttributeDecls, addr 0x5fe8e10, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DocTypeName, addr 0x5fe8c80, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_DocTypeName();

  /// @brief Method get_ElementDecls, addr 0x5fe8c98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ElementDeclsByType, addr 0x5fe8e08, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ErrorCount, addr 0x5fe8ebc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ErrorCount();

  /// @brief Method get_GeneralEntities, addr 0x5fe8ca8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Notations, addr 0x5fe8e18, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::System::Xml::Schema::SchemaNotation*>* get_Notations();

  /// @brief Method get_ParameterEntities, addr 0x5fe8d4c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SchemaType, addr 0x5fe8df0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaType get_SchemaType();

  /// @brief Method get_TargetNamespaces, addr 0x5fe8e00, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, bool>* get_TargetNamespaces();

  /// @brief Method get_UndeclaredElementDecls, addr 0x5fe8ca0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DocTypeName, addr 0x5fe8c88, size 0x8, virtual false, abstract: false, final false
  inline void set_DocTypeName(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_ErrorCount, addr 0x5fe8ec4, size 0x8, virtual false, abstract: false, final false
  inline void set_ErrorCount(int32_t value);

  /// @brief Method set_InternalDtdSubset, addr 0x5fe8c90, size 0x8, virtual false, abstract: false, final false
  inline void set_InternalDtdSubset(::StringW value);

  /// @brief Method set_SchemaType, addr 0x5fe8df8, size 0x8, virtual false, abstract: false, final false
