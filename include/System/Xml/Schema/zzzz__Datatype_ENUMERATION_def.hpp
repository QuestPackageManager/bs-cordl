...
public:
  ...
  /// @brief Method .ctor, addr 0x5fa378c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TokenizedType, addr 0x5fae6fc, size 0x8, virtual true, abstract: false, final false
