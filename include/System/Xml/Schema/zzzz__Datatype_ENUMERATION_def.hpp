...
public:
  ...
  /// @brief Method .ctor, addr 0x61bfe70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TokenizedType, addr 0x61cade0, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_ENUMERATION", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_ENUMERATION(Datatype_ENUMERATION&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_ENUMERATION", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_ENUMERATION(Datatype_ENUMERATIONconst&) = delete;
