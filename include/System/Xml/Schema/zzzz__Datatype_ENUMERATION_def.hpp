...
public:
  ...
  /// @brief Method get_TokenizedType, addr 0x28c1a24, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  static inline ::System::Xml::Schema::Datatype_ENUMERATION* New_ctor();

  /// @brief Method .ctor, addr 0x28c1a2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
