...
public:
  ...
  /// @brief Method .ctor, addr 0x43a58f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TokenizedType, addr 0x43b10b4, size 0x8, virtual true, abstract: false, final false
