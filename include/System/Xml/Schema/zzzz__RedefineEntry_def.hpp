...
public:
  ...
  /// @brief Method .ctor, addr 0x61e0e48, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RedefineEntry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RedefineEntry(RedefineEntry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RedefineEntry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RedefineEntry(RedefineEntryconst&) = delete;
