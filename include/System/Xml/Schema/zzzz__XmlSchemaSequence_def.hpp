...
/// @brief Method SetItems, addr 0x60f3a70, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60f3a78, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsEmpty, addr 0x60f3a24, size 0x4c, virtual true, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Items, addr 0x60f3a1c, size 0x8, virtual true, abstract: false, final false
