...
public:
  ...
  /// @brief Method SetItems, addr 0x42c62f0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42c62f8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x42c62b4, size 0x3c, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Items, addr 0x42c62ac, size 0x8, virtual true, abstract: false, final false
