...
public:
  ...
  /// @brief Method .ctor, addr 0x2a12e7c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Items, addr 0x2a140c4, size 0x8, virtual true, abstract: false, final false
