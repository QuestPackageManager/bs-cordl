...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaSequence*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaSequence*, "System.Xml.Schema", "XmlSchemaSequence");
...
public:
  ...
  /// @brief Method SetItems, addr 0x622eb6c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x622eb74, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x622eb20, size 0x4c, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Items, addr 0x622eb18, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaSequence) == 0x80, "Size mismatch!");
