...
public:
  ...
  /// @brief Method get_TypeCode addr 0x28bb69c size 0x8 virtual true final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_TokenizedType addr 0x28bb6a4 size 0x8 virtual true final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  static inline ::System::Xml::Schema::Datatype_NMTOKEN* New_ctor();

  /// @brief Method .ctor addr 0x28bb6ac size 0x4 virtual false final false
  inline void _ctor();
