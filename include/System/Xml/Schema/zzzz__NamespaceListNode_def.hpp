...
// Write type traits
MARK_REF_T(::System::Xml::Schema::NamespaceListNode*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::NamespaceListNode*, "System.Xml.Schema", "NamespaceListNode");
...
public:
  ...
  /// @brief Method ConstructPos, addr 0x631ee4c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method ExpandTree, addr 0x631ea28, size 0x420, virtual true, abstract: false, final false
  ...
  /// @brief Method GetResolvedSymbols, addr 0x631ea0c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631ea04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::NamespaceList* namespaceList, ::System::Object* particle);

  /// @brief Method get_IsNullable, addr 0x631ee84, size 0x38, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NamespaceListNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NamespaceListNode(NamespaceListNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NamespaceListNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NamespaceListNode(NamespaceListNodeconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::NamespaceListNode) == 0x20, "Size mismatch!");
