...
public:
  ...
  /// @brief Method ConstructPos, addr 0x43a093c, size 0x38, virtual true, abstract: false, final false
  inline void ConstructPos(::System::Xml::Schema::BitSet* firstpos, ::System::Xml::Schema::BitSet* lastpos,
                           ::ArrayW<::System::Xml::Schema::BitSet*, ::Array<::System::Xml::Schema::BitSet*>*> followpos);

  /// @brief Method ExpandTree, addr 0x43a04c0, size 0x474, virtual true, abstract: false, final false
  ...
  /// @brief Method GetResolvedSymbols, addr 0x43a04a0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43a0474, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::NamespaceList* namespaceList, ::System::Object* particle);

  /// @brief Method get_IsNullable, addr 0x43a0974, size 0x38, virtual true, abstract: false, final false
