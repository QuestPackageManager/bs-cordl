...
public:
  ...
  /// @brief Method ConstructPos, addr 0x616a2f4, size 0x38, virtual true, abstract: false, final false
  inline void ConstructPos(::System::Xml::Schema::BitSet* firstpos, ::System::Xml::Schema::BitSet* lastpos,
                           ::ArrayW<::System::Xml::Schema::BitSet*, ::Array<::System::Xml::Schema::BitSet*>*> followpos);

  /// @brief Method ExpandTree, addr 0x6169ed0, size 0x420, virtual true, abstract: false, final false
  ...
  /// @brief Method GetResolvedSymbols, addr 0x6169eb4, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6169eac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::NamespaceList* namespaceList, ::System::Object* particle);

  /// @brief Method get_IsNullable, addr 0x616a32c, size 0x38, virtual true, abstract: false, final false
