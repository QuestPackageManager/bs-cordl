...
public:
  ...
  /// @brief Method .ctor, addr 0x6231718, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaFractionDigitsFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaFractionDigitsFacet(XmlSchemaFractionDigitsFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaFractionDigitsFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaFractionDigitsFacet(XmlSchemaFractionDigitsFacetconst&) = delete;
