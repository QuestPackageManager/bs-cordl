...
public:
  ...
  /// @brief Method ConstructPos, addr 0x61dd41c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61dd4d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNullable, addr 0x61dd4b8, size 0x1c, virtual true, abstract: false, final false
