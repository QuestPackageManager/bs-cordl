...
public:
  ...
  /// @brief Method ConstructPos, addr 0x61031c4, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x610327c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNullable, addr 0x6103260, size 0x1c, virtual true, abstract: false, final false
