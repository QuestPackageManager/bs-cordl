...
public:
  ...
  /// @brief Method ConstructPos, addr 0x4397f80, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method get_IsNullable, addr 0x439801c, size 0x20, virtual true, abstract: false, final false
