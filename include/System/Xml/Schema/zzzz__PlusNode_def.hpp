...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlusNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlusNode(PlusNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlusNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlusNode(PlusNodeconst&) = delete;
