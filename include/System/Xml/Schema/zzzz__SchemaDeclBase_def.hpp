...
public:
  ...
  /// @brief Method AddValue, addr 0x60c1bec, size 0x104, virtual false, abstract: false, final false
  inline void AddValue(::StringW value);

  /// @brief Method CheckEnumeration, addr 0x60c1d38, size 0xc8, virtual false, abstract: false, final false
  inline bool CheckEnumeration(::System::Object* pVal);

  /// @brief Method CheckValue, addr 0x60c1e00, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60c1af0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x60c1a80, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlQualifiedName* name, ::StringW prefix);

  /// @brief Method get_Datatype, addr 0x60c1bdc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDatatype* get_Datatype();

  /// @brief Method get_DefaultValueRaw, addr 0x60c1d00, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_DefaultValueRaw();

  /// @brief Method get_DefaultValueTyped, addr 0x60c1d28, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_DefaultValueTyped();

  /// @brief Method get_IsDeclaredInExternal, addr 0x60c1b8c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDeclaredInExternal();

  /// @brief Method get_MaxLength, addr 0x60c1bac, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MaxLength();

  /// @brief Method get_MinLength, addr 0x60c1bbc, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MinLength();

  /// @brief Method get_Name, addr 0x60c1b54, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_Name();

  /// @brief Method get_Prefix, addr 0x60c1b64, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_Presence, addr 0x60c1b9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaDeclBase_Use get_Presence();

  /// @brief Method get_SchemaType, addr 0x60c1bcc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType();

  /// @brief Method get_Values, addr 0x60c1cf0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Values();

  /// @brief Method set_Datatype, addr 0x60c1be4, size 0x8, virtual false, abstract: false, final false
  inline void set_Datatype(::System::Xml::Schema::XmlSchemaDatatype* value);

  /// @brief Method set_DefaultValueRaw, addr 0x60c1d20, size 0x8, virtual false, abstract: false, final false
  inline void set_DefaultValueRaw(::StringW value);

  /// @brief Method set_DefaultValueTyped, addr 0x60c1d30, size 0x8, virtual false, abstract: false, final false
  inline void set_DefaultValueTyped(::System::Object* value);

  /// @brief Method set_IsDeclaredInExternal, addr 0x60c1b94, size 0x8, virtual false, abstract: false, final false
  inline void set_IsDeclaredInExternal(bool value);

  /// @brief Method set_MaxLength, addr 0x60c1bb4, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxLength(int64_t value);

  /// @brief Method set_MinLength, addr 0x60c1bc4, size 0x8, virtual false, abstract: false, final false
  inline void set_MinLength(int64_t value);

  /// @brief Method set_Name, addr 0x60c1b5c, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_Prefix, addr 0x60c1b84, size 0x8, virtual false, abstract: false, final false
  inline void set_Prefix(::StringW value);

  /// @brief Method set_Presence, addr 0x60c1ba4, size 0x8, virtual false, abstract: false, final false
  inline void set_Presence(::System::Xml::Schema::SchemaDeclBase_Use value);

  /// @brief Method set_SchemaType, addr 0x60c1bd4, size 0x8, virtual false, abstract: false, final false
  inline void set_SchemaType(::System::Xml::Schema::XmlSchemaType* value);

  /// @brief Method set_Values, addr 0x60c1cf8, size 0x8, virtual false, abstract: false, final false
