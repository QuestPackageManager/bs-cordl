...
public:
  ...
  /// @brief Method ConstructPos, addr 0x2efa764, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2efa808, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNullable, addr 0x2efa800, size 0x8, virtual true, abstract: false, final false
