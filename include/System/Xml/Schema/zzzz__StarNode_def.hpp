...
public:
  ...
  /// @brief Method ConstructPos, addr 0x631a174, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631a218, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNullable, addr 0x631a210, size 0x8, virtual true, abstract: false, final false
