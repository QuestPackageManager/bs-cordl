...
public:
  ...
  /// @brief Method CompleteValidation, addr 0x61ba484, size 0x44, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method ExpectedElements, addr 0x61ba4c8, size 0x1ec, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState* context, bool isRequiredOnly);

  /// @brief Method ExpectedParticles, addr 0x61ba6b4, size 0x188, virtual true, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x61ba218, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x61ba2d8, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61ba164, size 0xb4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NfaContentValidator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NfaContentValidator(NfaContentValidator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NfaContentValidator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NfaContentValidator(NfaContentValidatorconst&) = delete;
