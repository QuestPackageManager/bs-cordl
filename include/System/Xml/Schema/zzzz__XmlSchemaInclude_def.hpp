...
/// @brief Method AddAnnotation, addr 0x607d66c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x607d660, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
