...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaInclude*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaInclude*, "System.Xml.Schema", "XmlSchemaInclude");
...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x6231b04, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6231af8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaInclude", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaInclude(XmlSchemaInclude&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaInclude", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaInclude(XmlSchemaIncludeconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaInclude) == 0x70, "Size mismatch!");
