...
/// @brief Method AddAnnotation, addr 0x60f11f0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60f11e4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
