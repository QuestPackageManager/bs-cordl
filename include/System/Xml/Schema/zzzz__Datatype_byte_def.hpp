...
public:
  ...
  /// @brief Method Compare, addr 0x61c3988, size 0x54, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  static inline ::System::Xml::Schema::Datatype_byte* New_ctor();

  /// @brief Method TryParseValue, addr 0x61c3a94, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61ba118, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FacetsChecker, addr 0x61c3924, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x61c3a38, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TypeCode, addr 0x61c3980, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValueType, addr 0x61c39dc, size 0x5c, virtual true, abstract: false, final false
