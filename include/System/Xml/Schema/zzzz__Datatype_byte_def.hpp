...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_byte*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_byte*, "System.Xml.Schema", "Datatype_byte");
// Dependencies System.Xml.Schema.Datatype_short
namespace System::Xml::Schema {
// Is value type: false
...
public:
  ...
  /// @brief Method Compare, addr 0x61c91a0, size 0x54, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  static inline ::System::Xml::Schema::Datatype_byte* New_ctor();

  /// @brief Method TryParseValue, addr 0x61c92ac, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61bf930, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FacetsChecker, addr 0x61c913c, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x61c9250, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TypeCode, addr 0x61c9198, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValueType, addr 0x61c91f4, size 0x5c, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_byte", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_byte(Datatype_byte&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_byte", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_byte(Datatype_byteconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::Datatype_byte) == 0x38, "Size mismatch!");
