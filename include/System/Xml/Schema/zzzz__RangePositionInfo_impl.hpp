...
// Ctor Parameters [CppParam { name: "curpos", ty: "::System::Xml::Schema::BitSet*", modifiers: "", def_value: Some("{}") }, CppParam { name: "rangeCounters", ty:
// "::ArrayW<::System::Decimal,::Array<::System::Decimal>*>", modifiers: "", def_value: Some("{}") }]
