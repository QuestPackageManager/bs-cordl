...
/// @brief Method .ctor, addr 0x60873b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Content, addr 0x60873a4, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContent* get_Content() ;

/// @brief Method set_Content, addr 0x60873ac, size 0x8, virtual true, abstract: false, final false
