...
public:
  ...
  /// @brief Method Add, addr 0x61dc364, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61dc4ac, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x61dc48c, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x61dc3f4, size 0x98, virtual false, abstract: false, final false
