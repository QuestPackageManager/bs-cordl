...
public:
  ...
  /// @brief Method Add, addr 0x631e7f0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631e938, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x631e918, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x631e880, size 0x98, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Positions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Positions(Positions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Positions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Positions(Positionsconst&) = delete;
