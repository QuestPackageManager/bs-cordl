...
public:
  ...
  /// @brief Method get_FacetsChecker addr 0x273ddec size 0x58 virtual true final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_TypeCode addr 0x273de44 size 0x8 virtual true final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  static inline ::System::Xml::Schema::Datatype_nonPositiveInteger* New_ctor();

  /// @brief Method .ctor addr 0x273de4c size 0x4 virtual false final false
  inline void _ctor();
