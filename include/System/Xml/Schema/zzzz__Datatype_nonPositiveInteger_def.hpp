...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_nonPositiveInteger*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_nonPositiveInteger*, "System.Xml.Schema", "Datatype_nonPositiveInteger");
...
public:
  ...
  /// @brief Method .ctor, addr 0x61c017c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Xml::Schema::FacetsChecker* getStaticF_numeric10FacetsChecker();

  /// @brief Method get_FacetsChecker, addr 0x61c8454, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_HasValueFacets, addr 0x61c84b8, size 0x8, virtual true, abstract: false, final false
  inline bool get_HasValueFacets();

  /// @brief Method get_TypeCode, addr 0x61c84b0, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_nonPositiveInteger", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_nonPositiveInteger(Datatype_nonPositiveInteger&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_nonPositiveInteger", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_nonPositiveInteger(Datatype_nonPositiveIntegerconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::Datatype_nonPositiveInteger) == 0x38, "Size mismatch!");
