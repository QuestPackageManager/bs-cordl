...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UpaException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UpaException(UpaException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UpaException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UpaException(UpaExceptionconst&) = delete;
