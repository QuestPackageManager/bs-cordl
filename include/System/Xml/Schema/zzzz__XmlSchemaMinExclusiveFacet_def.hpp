...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaMinExclusiveFacet*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaMinExclusiveFacet*, "System.Xml.Schema", "XmlSchemaMinExclusiveFacet");
...
public:
  ...
  /// @brief Method .ctor, addr 0x62316dc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMinExclusiveFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaMinExclusiveFacet(XmlSchemaMinExclusiveFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMinExclusiveFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaMinExclusiveFacet(XmlSchemaMinExclusiveFacetconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaMinExclusiveFacet) == 0x60, "Size mismatch!");
