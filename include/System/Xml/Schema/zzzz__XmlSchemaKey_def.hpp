...
public:
  ...
  /// @brief Method .ctor, addr 0x62319cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaKey(XmlSchemaKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaKey(XmlSchemaKeyconst&) = delete;
