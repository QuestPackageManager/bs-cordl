...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Schema::XmlSchemaMinLengthFacet::*)()>(&::System::Xml::Schema::XmlSchemaMinLengthFacet::_ctor)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x42c0774;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Xml::Schema::XmlSchemaMinLengthFacet*>::get(), ".ctor",
...
inline ::System::Xml::Schema::XmlSchemaMinLengthFacet* System::Xml::Schema::XmlSchemaMinLengthFacet::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Xml::Schema::XmlSchemaMinLengthFacet*>());
}
// Ctor Parameters []
