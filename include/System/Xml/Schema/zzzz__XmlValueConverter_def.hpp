...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlValueConverter*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlValueConverter*, "System.Xml.Schema", "XmlValueConverter");
...
public:
  ...
  /// @brief Method .ctor, addr 0x62474b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlValueConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlValueConverter(XmlValueConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlValueConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlValueConverter(XmlValueConverterconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::XmlValueConverter) == 0x10, "Size mismatch!");
