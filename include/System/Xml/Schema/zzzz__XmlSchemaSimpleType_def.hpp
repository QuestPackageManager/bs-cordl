...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11640))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x28cb748, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Content, addr 0x28cb74c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleTypeContent* get_Content();

  /// @brief Method set_Content, addr 0x28cb754, size 0x8, virtual false, abstract: false, final false
