...
CORDL_MODULE_EXPORT(Datatype_year)
...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_year*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_year*, "System.Xml.Schema", "Datatype_year");
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr Datatype_year();

public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_year", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_year(Datatype_year&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_year", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_year(Datatype_yearconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::Datatype_year) == 0x40, "Size mismatch!");
