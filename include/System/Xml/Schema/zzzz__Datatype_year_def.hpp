...
// Write type traits
MARK_REF_PTR_T(::System::Xml::Schema::Datatype_year);
...
public:
  ...
  /// @brief Method .ctor, addr 0x43a6050, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x43ac400, size 0x8, virtual true, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::System::Xml::Schema::Datatype_year, 0x40>, "Size mismatch!");
