...
public:
  ...
  /// @brief Method get_FacetsChecker, addr 0x28bf9e0, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_TypeCode, addr 0x28bfa38, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  static inline ::System::Xml::Schema::Datatype_nonNegativeInteger* New_ctor();

  /// @brief Method .ctor, addr 0x28bfa40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
