...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11498))}
...
public:
  // Declarations
  /// @brief Method LookupNamespace addr 0x2742908 size 0x8 virtual true final false
  inline ::StringW LookupNamespace(::StringW prefix);

  static inline ::System::Xml::Schema::__DtdValidator__NamespaceManager* New_ctor();

  /// @brief Method .ctor addr 0x2742900 size 0x8 virtual false final false
  inline void _ctor();
...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11521))}
...
public:
  ...
  /// @brief Method SetDefaultTypedValue addr 0x2742458 size 0x3dc virtual false final false
