...
public:
  ...
  /// @brief Method get_TypeCode, addr 0x28bdcf8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  static inline ::System::Xml::Schema::Datatype_language* New_ctor();

  /// @brief Method .ctor, addr 0x28bdd00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
