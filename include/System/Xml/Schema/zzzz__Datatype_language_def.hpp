...
public:
  ...
  /// @brief Method .ctor, addr 0x43a9f98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x43b1c54, size 0x8, virtual true, abstract: false, final false
