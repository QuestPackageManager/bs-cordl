...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x60f0398, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CopyTo, addr 0x60f0be0, size 0x120, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t arrayIndex);

  /// @brief Method GetEnumerator, addr 0x60f0d00, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x60f09d8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x60f0a88, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x60f0b38, size 0xa8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x60f0a90, size 0xa8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x60f0f14, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x60f0fb8, size 0x10, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x60f0d68, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry>* entries, int32_t size,
                    ::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType enumType);

  /// @brief Method get_Current, addr 0x60f0d7c, size 0x198, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x60f0a74, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry>* entries, int32_t size,
                    ::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType enumType);

  /// @brief Method get_Entry, addr 0x60f0fc8, size 0x124, virtual true, abstract: false, final true
  inline ::System::Collections::DictionaryEntry get_Entry();

  /// @brief Method get_Key, addr 0x60f10ec, size 0x120, virtual true, abstract: false, final true
  inline ::System::Object* get_Key();

  /// @brief Method get_Value, addr 0x60f120c, size 0x120, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0x60f029c, size 0xfc, virtual false, abstract: false, final false
  inline void Add(::System::Xml::XmlQualifiedName* name, ::System::Xml::Schema::XmlSchemaObject* value);

  /// @brief Method Clear, addr 0x60f067c, size 0xa0, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x60f085c, size 0x7c, virtual false, abstract: false, final false
  inline bool Contains(::System::Xml::XmlQualifiedName* name);

  /// @brief Method FindIndexByValue, addr 0x60f04c0, size 0xa8, virtual false, abstract: false, final false
  inline int32_t FindIndexByValue(::System::Xml::Schema::XmlSchemaObject* xso);

  /// @brief Method GetEnumerator, addr 0x60f09e4, size 0x90, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method Insert, addr 0x60f03a0, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x60f071c, size 0xe8, virtual false, abstract: false, final false
  inline void Remove(::System::Xml::XmlQualifiedName* name);

  /// @brief Method Replace, addr 0x60f0568, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60f01bc, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x60f0804, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x60f08d8, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* get_Item(::System::Xml::XmlQualifiedName* name);

  /// @brief Method get_Values, addr 0x60f0954, size 0x84, virtual false, abstract: false, final false
