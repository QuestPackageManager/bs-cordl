...
public:
  ...
  /// @brief Method .ctor, addr 0x623170c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaTotalDigitsFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaTotalDigitsFacet(XmlSchemaTotalDigitsFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaTotalDigitsFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaTotalDigitsFacet(XmlSchemaTotalDigitsFacetconst&) = delete;
