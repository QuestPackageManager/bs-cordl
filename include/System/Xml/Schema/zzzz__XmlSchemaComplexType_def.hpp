...
public:
  ...
  /// @brief Method ClearCompiledState, addr 0x42ca1f4, size 0x70, virtual false, abstract: false, final false
  inline void ClearCompiledState();

  /// @brief Method Clone, addr 0x42c9cc8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  /// @brief Method Clone, addr 0x42c5db8, size 0x66c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone(::System::Xml::Schema::XmlSchema* parentSchema);

  /// @brief Method CloneAttributes, addr 0x42c7df8, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneGroupBaseParticles, addr 0x42ca2e4, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneParticle, addr 0x42c9f4c, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ContainsIdAttribute, addr 0x42c992c, size 0x39c, virtual false, abstract: false, final false
  inline bool ContainsIdAttribute(bool findAll);

  /// @brief Method CreateAnyType, addr 0x42c9278, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResolvedElementForm, addr 0x42ca4bc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAttributeQNameRef, addr 0x42c7c9c, size 0x15c, virtual false, abstract: false, final false
  static inline bool HasAttributeQNameRef(::System::Xml::Schema::XmlSchemaObjectCollection* attributes);

  /// @brief Method HasParticleRef, addr 0x42c9cd0, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeWildcard, addr 0x42c990c, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributeWildcard(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method SetAttributes, addr 0x42c9924, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributes(::System::Xml::Schema::XmlSchemaObjectCollection* newAttributes);

  /// @brief Method SetBlockResolved, addr 0x42c9904, size 0x8, virtual false, abstract: false, final false
  inline void SetBlockResolved(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method SetContentTypeParticle, addr 0x42c98fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42c9588, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AnyAttribute, addr 0x42c9804, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute();

  /// @brief Method get_AnyType, addr 0x42c9668, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* get_AnyType();

  /// @brief Method get_AnyTypeContentValidator, addr 0x42c95f8, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::ContentValidator* get_AnyTypeContentValidator();

  /// @brief Method get_AttributeUses, addr 0x42c982c, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeUses();

  /// @brief Method get_AttributeWildcard, addr 0x42c9890, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AttributeWildcard();

  /// @brief Method get_Attributes, addr 0x42c97a0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Attributes();

  /// @brief Method get_Block, addr 0x42c9744, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Block();

  /// @brief Method get_BlockResolved, addr 0x42c9824, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_BlockResolved();

  /// @brief Method get_ContentModel, addr 0x42c9780, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentModel* get_ContentModel();

  /// @brief Method get_ContentType, addr 0x42c9814, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType();

  /// @brief Method get_ContentTypeParticle, addr 0x42c981c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_ContentTypeParticle();

  /// @brief Method get_IsAbstract, addr 0x42c9718, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsAbstract();

  /// @brief Method get_IsMixed, addr 0x42c9754, size 0xc, virtual true, abstract: false, final false
  inline bool get_IsMixed();

  /// @brief Method get_LocalElements, addr 0x42c9898, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_LocalElements();

  /// @brief Method get_Particle, addr 0x42c9790, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_Particle();

  /// @brief Method get_UntypedAnyType, addr 0x42c96c0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AnyAttribute, addr 0x42c980c, size 0x8, virtual false, abstract: false, final false
  inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_Block, addr 0x42c974c, size 0x8, virtual false, abstract: false, final false
  inline void set_Block(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_ContentModel, addr 0x42c9788, size 0x8, virtual false, abstract: false, final false
  inline void set_ContentModel(::System::Xml::Schema::XmlSchemaContentModel* value);

  /// @brief Method set_HasWildCard, addr 0x42c9914, size 0x10, virtual false, abstract: false, final false
  inline void set_HasWildCard(bool value);

  /// @brief Method set_IsAbstract, addr 0x42c9724, size 0x20, virtual false, abstract: false, final false
  inline void set_IsAbstract(bool value);

  /// @brief Method set_IsMixed, addr 0x42c9760, size 0x20, virtual true, abstract: false, final false
  inline void set_IsMixed(bool value);

  /// @brief Method set_Particle, addr 0x42c9798, size 0x8, virtual false, abstract: false, final false
