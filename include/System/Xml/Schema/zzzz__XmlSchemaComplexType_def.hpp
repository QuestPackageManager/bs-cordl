...
public:
  ...
  /// @brief Method ClearCompiledState, addr 0x42bcd28, size 0x70, virtual false, abstract: false, final false
  inline void ClearCompiledState();

  /// @brief Method Clone, addr 0x42bc7fc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  /// @brief Method Clone, addr 0x42b88ec, size 0x66c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone(::System::Xml::Schema::XmlSchema* parentSchema);

  /// @brief Method CloneAttributes, addr 0x42ba92c, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneGroupBaseParticles, addr 0x42bce18, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneParticle, addr 0x42bca80, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ContainsIdAttribute, addr 0x42bc460, size 0x39c, virtual false, abstract: false, final false
  inline bool ContainsIdAttribute(bool findAll);

  /// @brief Method CreateAnyType, addr 0x42bbdac, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResolvedElementForm, addr 0x42bcff0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAttributeQNameRef, addr 0x42ba7d0, size 0x15c, virtual false, abstract: false, final false
  static inline bool HasAttributeQNameRef(::System::Xml::Schema::XmlSchemaObjectCollection* attributes);

  /// @brief Method HasParticleRef, addr 0x42bc804, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeWildcard, addr 0x42bc440, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributeWildcard(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method SetAttributes, addr 0x42bc458, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributes(::System::Xml::Schema::XmlSchemaObjectCollection* newAttributes);

  /// @brief Method SetBlockResolved, addr 0x42bc438, size 0x8, virtual false, abstract: false, final false
  inline void SetBlockResolved(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method SetContentTypeParticle, addr 0x42bc430, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42bc0bc, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AnyAttribute, addr 0x42bc338, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute();

  /// @brief Method get_AnyType, addr 0x42bc19c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* get_AnyType();

  /// @brief Method get_AnyTypeContentValidator, addr 0x42bc12c, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::ContentValidator* get_AnyTypeContentValidator();

  /// @brief Method get_AttributeUses, addr 0x42bc360, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeUses();

  /// @brief Method get_AttributeWildcard, addr 0x42bc3c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AttributeWildcard();

  /// @brief Method get_Attributes, addr 0x42bc2d4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Attributes();

  /// @brief Method get_Block, addr 0x42bc278, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Block();

  /// @brief Method get_BlockResolved, addr 0x42bc358, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_BlockResolved();

  /// @brief Method get_ContentModel, addr 0x42bc2b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentModel* get_ContentModel();

  /// @brief Method get_ContentType, addr 0x42bc348, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType();

  /// @brief Method get_ContentTypeParticle, addr 0x42bc350, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_ContentTypeParticle();

  /// @brief Method get_IsAbstract, addr 0x42bc24c, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsAbstract();

  /// @brief Method get_IsMixed, addr 0x42bc288, size 0xc, virtual true, abstract: false, final false
  inline bool get_IsMixed();

  /// @brief Method get_LocalElements, addr 0x42bc3cc, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_LocalElements();

  /// @brief Method get_Particle, addr 0x42bc2c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_Particle();

  /// @brief Method get_UntypedAnyType, addr 0x42bc1f4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AnyAttribute, addr 0x42bc340, size 0x8, virtual false, abstract: false, final false
  inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_Block, addr 0x42bc280, size 0x8, virtual false, abstract: false, final false
  inline void set_Block(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_ContentModel, addr 0x42bc2bc, size 0x8, virtual false, abstract: false, final false
  inline void set_ContentModel(::System::Xml::Schema::XmlSchemaContentModel* value);

  /// @brief Method set_HasWildCard, addr 0x42bc448, size 0x10, virtual false, abstract: false, final false
  inline void set_HasWildCard(bool value);

  /// @brief Method set_IsAbstract, addr 0x42bc258, size 0x20, virtual false, abstract: false, final false
  inline void set_IsAbstract(bool value);

  /// @brief Method set_IsMixed, addr 0x42bc294, size 0x20, virtual true, abstract: false, final false
  inline void set_IsMixed(bool value);

  /// @brief Method set_Particle, addr 0x42bc2cc, size 0x8, virtual false, abstract: false, final false
