...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11622)), TypeDefinitionIndex(TypeDefinitionIndex(11640))]
...
public:
  ...
  /// @brief Method CreateAnyType, addr 0x28c9b18, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28c9dfc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AnyType, addr 0x28ca358, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* get_AnyType();

  /// @brief Method get_AnyTypeContentValidator, addr 0x28c9ec8, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::ContentValidator* get_AnyTypeContentValidator();

  /// @brief Method set_IsMixed, addr 0x28ca3b0, size 0x1c, virtual true, abstract: false, final false
  inline void set_IsMixed(bool value);

  /// @brief Method get_ContentTypeParticle, addr 0x28ca3cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_ContentTypeParticle();

  /// @brief Method SetContentTypeParticle, addr 0x28ca3d4, size 0x8, virtual false, abstract: false, final false
  inline void SetContentTypeParticle(::System::Xml::Schema::XmlSchemaParticle* value);

  /// @brief Method SetAttributeWildcard, addr 0x28ca3dc, size 0x8, virtual false, abstract: false, final false
