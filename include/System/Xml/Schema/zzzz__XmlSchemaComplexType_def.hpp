...
public:
  ...
  /// @brief Method ClearCompiledState, addr 0x60eced0, size 0x74, virtual false, abstract: false, final false
  inline void ClearCompiledState();

  /// @brief Method Clone, addr 0x60ec974, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  /// @brief Method Clone, addr 0x60e8a68, size 0x6a0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone(::System::Xml::Schema::XmlSchema* parentSchema);

  /// @brief Method CloneAttributes, addr 0x60eaaec, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneGroupBaseParticles, addr 0x60ecfc8, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneParticle, addr 0x60ecc24, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ContainsIdAttribute, addr 0x60ec5ec, size 0x388, virtual false, abstract: false, final false
  inline bool ContainsIdAttribute(bool findAll);

  /// @brief Method CreateAnyType, addr 0x60ebf5c, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResolvedElementForm, addr 0x60ed1a4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAttributeQNameRef, addr 0x60ea980, size 0x16c, virtual false, abstract: false, final false
  static inline bool HasAttributeQNameRef(::System::Xml::Schema::XmlSchemaObjectCollection* attributes);

  /// @brief Method HasParticleRef, addr 0x60ec97c, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeWildcard, addr 0x60ec5c8, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributeWildcard(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method SetAttributes, addr 0x60ec5e4, size 0x8, virtual false, abstract: false, final false
  inline void SetAttributes(::System::Xml::Schema::XmlSchemaObjectCollection* newAttributes);

  /// @brief Method SetBlockResolved, addr 0x60ec5c0, size 0x8, virtual false, abstract: false, final false
  inline void SetBlockResolved(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method SetContentTypeParticle, addr 0x60ec5b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60ec228, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AnyAttribute, addr 0x60ec4b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute();

  /// @brief Method get_AnyType, addr 0x60ec310, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* get_AnyType();

  /// @brief Method get_AnyTypeContentValidator, addr 0x60ec29c, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::ContentValidator* get_AnyTypeContentValidator();

  /// @brief Method get_AttributeUses, addr 0x60ec4e0, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeUses();

  /// @brief Method get_AttributeWildcard, addr 0x60ec548, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AttributeWildcard();

  /// @brief Method get_Attributes, addr 0x60ec450, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Attributes();

  /// @brief Method get_Block, addr 0x60ec3f4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Block();

  /// @brief Method get_BlockResolved, addr 0x60ec4d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_BlockResolved();

  /// @brief Method get_ContentModel, addr 0x60ec430, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentModel* get_ContentModel();

  /// @brief Method get_ContentType, addr 0x60ec4c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType();

  /// @brief Method get_ContentTypeParticle, addr 0x60ec4d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_ContentTypeParticle();

  /// @brief Method get_IsAbstract, addr 0x60ec3c8, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsAbstract();

  /// @brief Method get_IsMixed, addr 0x60ec404, size 0xc, virtual true, abstract: false, final false
  inline bool get_IsMixed();

  /// @brief Method get_LocalElements, addr 0x60ec550, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectTable* get_LocalElements();

  /// @brief Method get_Particle, addr 0x60ec440, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_Particle();

  /// @brief Method get_UntypedAnyType, addr 0x60ec36c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AnyAttribute, addr 0x60ec4c0, size 0x8, virtual false, abstract: false, final false
  inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_Block, addr 0x60ec3fc, size 0x8, virtual false, abstract: false, final false
  inline void set_Block(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_ContentModel, addr 0x60ec438, size 0x8, virtual false, abstract: false, final false
  inline void set_ContentModel(::System::Xml::Schema::XmlSchemaContentModel* value);

  /// @brief Method set_HasWildCard, addr 0x60ec5d0, size 0x14, virtual false, abstract: false, final false
  inline void set_HasWildCard(bool value);

  /// @brief Method set_IsAbstract, addr 0x60ec3d4, size 0x20, virtual false, abstract: false, final false
  inline void set_IsAbstract(bool value);

  /// @brief Method set_IsMixed, addr 0x60ec410, size 0x20, virtual true, abstract: false, final false
  inline void set_IsMixed(bool value);

  /// @brief Method set_Particle, addr 0x60ec448, size 0x8, virtual false, abstract: false, final false
