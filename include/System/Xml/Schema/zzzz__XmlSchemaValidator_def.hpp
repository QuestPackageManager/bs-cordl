...
// Dependencies System.Object, System.Xml.Schema.ValidatorState, System.Xml.Schema.XmlSchemaContentProcessing, System.Xml.Schema.XmlSchemaValidationFlags, System.Xml.XmlCharType
namespace System::Xml::Schema {
// Is value type: false
...
/// @brief Field EmptyAttributeArray, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_EmptyAttributeArray, put=setStaticF_EmptyAttributeArray)) ::ArrayW<::System::Xml::Schema::XmlSchemaAttribute*,::Array<::System::Xml::Schema::XmlSchemaAttribute*>*>  EmptyAttributeArray;

/// @brief Field EmptyParticleArray, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_EmptyParticleArray, put=setStaticF_EmptyParticleArray)) ::ArrayW<::System::Xml::Schema::XmlSchemaParticle*,::Array<::System::Xml::Schema::XmlSchemaParticle*>*>  EmptyParticleArray;
...
/// @brief Field MethodNames, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_MethodNames, put=setStaticF_MethodNames)) ::ArrayW<::StringW,::Array<::StringW>*>  MethodNames;
...
/// @brief Field ValidStates, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_ValidStates, put=setStaticF_ValidStates)) ::System::Object*  ValidStates;
...
/// @brief Method AddIdentityConstraints, addr 0x60913d8, size 0x3f4, virtual false, abstract: false, final false
inline void AddIdentityConstraints() ;

/// @brief Method AddSchema, addr 0x60892c4, size 0x404, virtual false, abstract: false, final false
inline void AddSchema(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method AddXmlNamespaceSchema, addr 0x6091b80, size 0x8c, virtual false, abstract: false, final false
inline void AddXmlNamespaceSchema() ;

/// @brief Method AttributeIdentityConstraints, addr 0x608c758, size 0x2a4, virtual false, abstract: false, final false
...
/// @brief Method BuildElementName, addr 0x608d0f0, size 0x148, virtual false, abstract: false, final false
static inline ::StringW BuildElementName(::StringW  localName, ::StringW  ns) ;

/// @brief Method BuildElementName, addr 0x6090918, size 0x68, virtual false, abstract: false, final false
static inline ::StringW BuildElementName(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method CheckAttributeValue, addr 0x608c3b4, size 0x204, virtual false, abstract: false, final false
inline ::System::Object* CheckAttributeValue(::System::Object*  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CheckElementProperties, addr 0x608b434, size 0xb0, virtual false, abstract: false, final false
inline void CheckElementProperties() ;

/// @brief Method CheckElementValue, addr 0x6091170, size 0x1f0, virtual false, abstract: false, final false
inline ::System::Object* CheckElementValue(::StringW  stringValue) ;

/// @brief Method CheckForwardRefs, addr 0x608e160, size 0xf0, virtual false, abstract: false, final false
inline void CheckForwardRefs() ;

/// @brief Method CheckIsXmlAttribute, addr 0x608c154, size 0xbc, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaAttDef* CheckIsXmlAttribute(::System::Xml::XmlQualifiedName*  attQName) ;

/// @brief Method CheckMixedValueConstraint, addr 0x608f18c, size 0xf0, virtual false, abstract: false, final false
inline ::System::Object* CheckMixedValueConstraint(::StringW  elementValue) ;

/// @brief Method CheckRequiredAttributes, addr 0x608cac8, size 0x1c0, virtual false, abstract: false, final false
inline void CheckRequiredAttributes(::System::Xml::Schema::SchemaElementDecl*  currentElementDecl) ;

/// @brief Method CheckStateTransition, addr 0x608a15c, size 0x1fc, virtual false, abstract: false, final false
inline void CheckStateTransition(::System::Xml::Schema::ValidatorState  toState, ::StringW  methodName) ;

/// @brief Method CheckTokenizedTypes, addr 0x608c5b8, size 0x180, virtual false, abstract: false, final false
inline void CheckTokenizedTypes(::System::Xml::Schema::XmlSchemaDatatype*  dtype, ::System::Object*  typedValue, bool  attrValue) ;

/// @brief Method CheckXsiTypeAndNil, addr 0x608ad34, size 0x5a8, virtual false, abstract: false, final false
...
/// @brief Method ClearPSVI, addr 0x608a358, size 0x44, virtual false, abstract: false, final false
inline void ClearPSVI() ;

/// @brief Method CompleteValidationError, addr 0x608f27c, size 0x40c, virtual false, abstract: false, final false
static inline void CompleteValidationError(::System::Xml::Schema::ValidationState*  context, ::System::Xml::Schema::ValidationEventHandler*  eventHandler, ::System::Object*  sender, ::StringW  sourceUri, int32_t  lineNo, int32_t  linePos, ::System::Xml::Schema::XmlSchemaSet*  schemaSet) ;

/// @brief Method ElementIdentityConstraints, addr 0x60917cc, size 0x3b4, virtual false, abstract: false, final false
inline void ElementIdentityConstraints() ;

/// @brief Method ElementValidationError, addr 0x6090b70, size 0x600, virtual false, abstract: false, final false
static inline void ElementValidationError(::System::Xml::XmlQualifiedName*  name, ::System::Xml::Schema::ValidationState*  context, ::System::Xml::Schema::ValidationEventHandler*  eventHandler, ::System::Object*  sender, ::StringW  sourceUri, int32_t  lineNo, int32_t  linePos, ::System::Xml::Schema::XmlSchemaSet*  schemaSet) ;

/// @brief Method EndElementIdentityConstraints, addr 0x608f688, size 0xbb4, virtual false, abstract: false, final false
...
/// @brief Method EndValidation, addr 0x608e078, size 0xe8, virtual false, abstract: false, final false
inline void EndValidation() ;

/// @brief Method EnumerateAny, addr 0x6092a44, size 0x248, virtual false, abstract: false, final false
static inline void EnumerateAny(::System::Text::StringBuilder*  builder, ::StringW  namespaces) ;

/// @brief Method FastGetElementDecl, addr 0x608a7ec, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method FindId, addr 0x609208c, size 0x1c, virtual false, abstract: false, final false
inline ::System::Object* FindId(::StringW  name) ;

/// @brief Method GetConcatenatedValue, addr 0x608ec40, size 0x1c, virtual false, abstract: false, final false
inline ::StringW GetConcatenatedValue() ;

/// @brief Method GetDefaultAttributePrefix, addr 0x608e7c4, size 0x3a0, virtual false, abstract: false, final false
inline ::StringW GetDefaultAttributePrefix(::StringW  attributeNS) ;

/// @brief Method GetSchemaElement, addr 0x608b540, size 0x110, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* GetSchemaElement() ;

/// @brief Method GetSubstitutionGroupHead, addr 0x6090758, size 0x1c0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* GetSubstitutionGroupHead(::System::Xml::XmlQualifiedName*  member) ;

/// @brief Method GetTypeName, addr 0x6091360, size 0x58, virtual false, abstract: false, final false
inline ::StringW GetTypeName(::System::Xml::Schema::SchemaDeclBase*  decl) ;

/// @brief Method GetUnspecifiedDefaultAttributes, addr 0x608e250, size 0x574, virtual false, abstract: false, final false
inline void GetUnspecifiedDefaultAttributes(::System::Collections::ArrayList*  defaultAttributes, bool  createNodeData) ;

/// @brief Method Init, addr 0x6088bc8, size 0x338, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method Initialize, addr 0x6089a2c, size 0x12c, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method Initialize, addr 0x6089b58, size 0x290, virtual false, abstract: false, final false
inline void Initialize(::System::Xml::Schema::XmlSchemaObject*  partialValidationType) ;

/// @brief Method InternalValidateEndElement, addr 0x608d850, size 0x4e0, virtual false, abstract: false, final false
inline ::System::Object* InternalValidateEndElement(::System::Xml::Schema::XmlSchemaInfo*  schemaInfo, ::System::Object*  typedValue) ;

/// @brief Method LoadSchema, addr 0x609023c, size 0x448, virtual false, abstract: false, final false
inline void LoadSchema(::StringW  uri, ::StringW  url) ;

static inline ::System::Xml::Schema::XmlSchemaValidator* New_ctor(::System::Xml::XmlNameTable*  nameTable, ::System::Xml::Schema::XmlSchemaSet*  schemas, ::System::Xml::IXmlNamespaceResolver*  namespaceResolver, ::System::Xml::Schema::XmlSchemaValidationFlags  validationFlags) ;

/// @brief Method Pop, addr 0x608df40, size 0x138, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method PrintExpectedElements, addr 0x608d238, size 0x3ec, virtual false, abstract: false, final false
static inline ::StringW PrintExpectedElements(::System::Collections::ArrayList*  expected, bool  getParticles) ;

/// @brief Method PrintNames, addr 0x60928c0, size 0x184, virtual false, abstract: false, final false
static inline ::StringW PrintNames(::System::Collections::ArrayList*  expected) ;

/// @brief Method PrintNamesWithNS, addr 0x6092434, size 0x48c, virtual false, abstract: false, final false
static inline void PrintNamesWithNS(::System::Collections::ArrayList*  expected, ::System::Text::StringBuilder*  builder) ;

/// @brief Method ProcessEntity, addr 0x60920a8, size 0x198, virtual false, abstract: false, final false
inline void ProcessEntity(::StringW  name) ;

/// @brief Method ProcessSchemaLocations, addr 0x608aa44, size 0x2f0, virtual false, abstract: false, final false
inline void ProcessSchemaLocations(::StringW  xsiSchemaLocation, ::StringW  xsiNoNamespaceSchemaLocation) ;

/// @brief Method ProcessTokenizedType, addr 0x6091de8, size 0x2a4, virtual false, abstract: false, final false
inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType  ttype, ::StringW  name, bool  attrValue) ;

/// @brief Method Push, addr 0x6088f00, size 0xf8, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method QNameString, addr 0x608d02c, size 0x84, virtual false, abstract: false, final false
static inline ::StringW QNameString(::StringW  localName, ::StringW  ns) ;

/// @brief Method RecompileSchemaSet, addr 0x6089084, size 0xc4, virtual false, abstract: false, final false
inline void RecompileSchemaSet() ;

/// @brief Method Reset, addr 0x6088ff8, size 0x8c, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SaveTextValue, addr 0x608d0b0, size 0x40, virtual false, abstract: false, final false
inline void SaveTextValue(::System::Object*  value) ;

/// @brief Method SendValidationEvent, addr 0x60913b8, size 0x14, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code) ;

/// @brief Method SendValidationEvent, addr 0x608bfd4, size 0x180, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  arg) ;

/// @brief Method SendValidationEvent, addr 0x6090980, size 0x1f0, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  arg1, ::StringW  arg2) ;

/// @brief Method SendValidationEvent, addr 0x608c210, size 0x1a4, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::ArrayW<::StringW,::Array<::StringW>*>  args) ;

/// @brief Method SendValidationEvent, addr 0x608987c, size 0x1b0, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::ArrayW<::StringW,::Array<::StringW>*>  args, ::System::Exception*  innerException) ;

/// @brief Method SendValidationEvent, addr 0x6091c0c, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x60896c8, size 0x1b4, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  msg, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method SendValidationEvent, addr 0x6090684, size 0xd4, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e) ;

/// @brief Method SendValidationEvent, addr 0x6092368, size 0x8, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaValidationException*  e) ;

/// @brief Method SendValidationEvent, addr 0x6092240, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x6092370, size 0xc4, virtual false, abstract: false, final false
static inline void SendValidationEvent(::System::Xml::Schema::ValidationEventHandler*  eventHandler, ::System::Object*  sender, ::System::Xml::Schema::XmlSchemaValidationException*  e, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method SetDtdSchemaInfo, addr 0x608eba8, size 0x10, virtual false, abstract: false, final false
inline void SetDtdSchemaInfo(::System::Xml::IDtdInfo*  dtdSchemaInfo) ;

/// @brief Method SkipToEndElement, addr 0x608dd30, size 0x210, virtual false, abstract: false, final false
inline void SkipToEndElement(::System::Xml::Schema::XmlSchemaInfo*  schemaInfo) ;

/// @brief Method ThrowDeclNotFoundWarningOrError, addr 0x608b2dc, size 0x158, virtual false, abstract: false, final false
inline void ThrowDeclNotFoundWarningOrError(bool  declFound) ;

/// @brief Method ValidateAtomicValue, addr 0x608eed0, size 0x2bc, virtual false, abstract: false, final false
...
/// @brief Method ValidateAtomicValue, addr 0x608ec5c, size 0x274, virtual false, abstract: false, final false
inline ::System::Object* ValidateAtomicValue(::StringW  stringValue, ::ByRef<::System::Xml::Schema::XmlSchemaSimpleType*>  memberType) ;

/// @brief Method ValidateAttribute, addr 0x608b6ac, size 0x928, virtual false, abstract: false, final false
inline ::System::Object* ValidateAttribute(::StringW  lName, ::StringW  ns, ::System::Xml::Schema::XmlValueGetter*  attributeValueGetter, ::StringW  attributeStringValue, ::System::Xml::Schema::XmlSchemaInfo*  schemaInfo) ;

/// @brief Method ValidateAttribute, addr 0x608b650, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method ValidateElement, addr 0x6089de8, size 0x374, virtual false, abstract: false, final false
inline void ValidateElement(::StringW  localName, ::StringW  namespaceUri, ::System::Xml::Schema::XmlSchemaInfo*  schemaInfo, ::StringW  xsiType, ::StringW  xsiNil, ::StringW  xsiSchemaLocation, ::StringW  xsiNoNamespaceSchemaLocation) ;

/// @brief Method ValidateElementContext, addr 0x608a39c, size 0x450, virtual false, abstract: false, final false
inline ::System::Object* ValidateElementContext(::System::Xml::XmlQualifiedName*  elementName, ::ByRef<bool>  invalidElementInContext) ;

/// @brief Method ValidateEndElement, addr 0x608d848, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* ValidateEndElement(::System::Xml::Schema::XmlSchemaInfo*  schemaInfo) ;

/// @brief Method ValidateEndOfAttributes, addr 0x608c9fc, size 0xcc, virtual false, abstract: false, final false
inline void ValidateEndOfAttributes(::System::Xml::Schema::XmlSchemaInfo*  schemaInfo) ;

/// @brief Method ValidateStartElementIdentityConstraints, addr 0x608b4e4, size 0x5c, virtual false, abstract: false, final false
inline void ValidateStartElementIdentityConstraints() ;

/// @brief Method ValidateText, addr 0x608cce4, size 0x348, virtual false, abstract: false, final false
inline void ValidateText(::StringW  elementStringValue, ::System::Xml::Schema::XmlValueGetter*  elementValueGetter) ;

/// @brief Method ValidateText, addr 0x608cc88, size 0x5c, virtual false, abstract: false, final false
inline void ValidateText(::System::Xml::Schema::XmlValueGetter*  elementValue) ;

/// @brief Method ValidateWhitespace, addr 0x608d680, size 0x1c8, virtual false, abstract: false, final false
inline void ValidateWhitespace(::StringW  elementStringValue, ::System::Xml::Schema::XmlValueGetter*  elementValueGetter) ;

/// @brief Method ValidateWhitespace, addr 0x608d624, size 0x5c, virtual false, abstract: false, final false
...
constexpr ::System::Xml::Schema::SchemaInfo* const& __cordl_internal_get_compiledSchemaInfo() const;
...
constexpr ::System::Xml::XmlQualifiedName* const& __cordl_internal_get_contextQName() const;
...
constexpr ::System::Xml::IDtdInfo* const& __cordl_internal_get_dtdSchemaInfo() const;

constexpr ::System::Xml::IDtdInfo*& __cordl_internal_get_dtdSchemaInfo() ;

constexpr ::System::Xml::IXmlLineInfo* const& __cordl_internal_get_dummyPositionInfo() const;
...
constexpr ::System::Xml::IXmlNamespaceResolver* const& __cordl_internal_get_nsResolver() const;

constexpr ::System::Xml::IXmlNamespaceResolver*& __cordl_internal_get_nsResolver() ;

constexpr ::System::Xml::Schema::XmlSchemaObject* const& __cordl_internal_get_partialValidationType() const;

constexpr ::System::Xml::Schema::XmlSchemaObject*& __cordl_internal_get_partialValidationType() ;

constexpr ::System::Xml::IXmlLineInfo* const& __cordl_internal_get_positionInfo() const;
...
constexpr ::System::Uri* const& __cordl_internal_get_sourceUri() const;
...
constexpr ::System::Collections::Hashtable* const& __cordl_internal_get_validatedNamespaces() const;

constexpr ::System::Collections::Hashtable*& __cordl_internal_get_validatedNamespaces() ;

constexpr ::System::Object* const& __cordl_internal_get_validationEventSender() const;
...
constexpr ::System::Xml::Schema::SchemaAttDef* const& __cordl_internal_get_wildID() const;
...
/// @brief Method .ctor, addr 0x60889f8, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNameTable*  nameTable, ::System::Xml::Schema::XmlSchemaSet*  schemas, ::System::Xml::IXmlNamespaceResolver*  namespaceResolver, ::System::Xml::Schema::XmlSchemaValidationFlags  validationFlags) ;

/// @brief Method add_ValidationEventHandler, addr 0x60891ac, size 0x8c, virtual false, abstract: false, final false
...
static inline ::System::Object* getStaticF_ValidStates() ;
...
/// @brief Method get_CurrentContentType, addr 0x608eb74, size 0x34, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentType get_CurrentContentType() ;

/// @brief Method get_HasIdentityConstraints, addr 0x608c738, size 0x20, virtual false, abstract: false, final false
inline bool get_HasIdentityConstraints() ;

/// @brief Method get_HasSchema, addr 0x608ebf8, size 0x48, virtual false, abstract: false, final false
inline bool get_HasSchema() ;

/// @brief Method get_ProcessIdentityConstraints, addr 0x60913cc, size 0xc, virtual false, abstract: false, final false
inline bool get_ProcessIdentityConstraints() ;

/// @brief Method get_ProcessSchemaHints, addr 0x6089148, size 0x10, virtual false, abstract: false, final false
inline bool get_ProcessSchemaHints() ;

/// @brief Method get_ReportValidationWarnings, addr 0x609235c, size 0xc, virtual false, abstract: false, final false
inline bool get_ReportValidationWarnings() ;

/// @brief Method get_SchemaSet, addr 0x608eb64, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSet* get_SchemaSet() ;

/// @brief Method get_StrictlyAssessed, addr 0x608ebb8, size 0x40, virtual false, abstract: false, final false
inline bool get_StrictlyAssessed() ;

/// @brief Method get_ValidationFlags, addr 0x608eb6c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaValidationFlags get_ValidationFlags() ;

/// @brief Method remove_ValidationEventHandler, addr 0x6089238, size 0x8c, virtual false, abstract: false, final false
...
static inline void setStaticF_ValidStates(::System::Object*  value) ;
...
/// @brief Method set_LineInfoProvider, addr 0x6089160, size 0x10, virtual false, abstract: false, final false
inline void set_LineInfoProvider(::System::Xml::IXmlLineInfo*  value) ;

/// @brief Method set_SourceUri, addr 0x6089170, size 0x34, virtual false, abstract: false, final false
inline void set_SourceUri(::System::Uri*  value) ;

/// @brief Method set_ValidationEventSender, addr 0x60891a4, size 0x8, virtual false, abstract: false, final false
inline void set_ValidationEventSender(::System::Object*  value) ;

/// @brief Method set_XmlResolver, addr 0x6089158, size 0x8, virtual false, abstract: false, final false
