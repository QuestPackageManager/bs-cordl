...
public:
  ...
  /// @brief Method AddIdentityConstraints, addr 0x61033e4, size 0x3f4, virtual false, abstract: false, final false
  inline void AddIdentityConstraints();

  /// @brief Method AddSchema, addr 0x60fb2d0, size 0x404, virtual false, abstract: false, final false
  inline void AddSchema(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method AddXmlNamespaceSchema, addr 0x6103b8c, size 0x8c, virtual false, abstract: false, final false
  inline void AddXmlNamespaceSchema();

  /// @brief Method AttributeIdentityConstraints, addr 0x60fe764, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildElementName, addr 0x60ff0fc, size 0x148, virtual false, abstract: false, final false
  static inline ::StringW BuildElementName(::StringW localName, ::StringW ns);

  /// @brief Method BuildElementName, addr 0x6102924, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW BuildElementName(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method CheckAttributeValue, addr 0x60fe3c0, size 0x204, virtual false, abstract: false, final false
  inline ::System::Object* CheckAttributeValue(::System::Object* value, ::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method CheckElementProperties, addr 0x60fd440, size 0xb0, virtual false, abstract: false, final false
  inline void CheckElementProperties();

  /// @brief Method CheckElementValue, addr 0x610317c, size 0x1f0, virtual false, abstract: false, final false
  inline ::System::Object* CheckElementValue(::StringW stringValue);

  /// @brief Method CheckForwardRefs, addr 0x610016c, size 0xf0, virtual false, abstract: false, final false
  inline void CheckForwardRefs();

  /// @brief Method CheckIsXmlAttribute, addr 0x60fe160, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaAttDef* CheckIsXmlAttribute(::System::Xml::XmlQualifiedName* attQName);

  /// @brief Method CheckMixedValueConstraint, addr 0x6101198, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Object* CheckMixedValueConstraint(::StringW elementValue);

  /// @brief Method CheckRequiredAttributes, addr 0x60fead4, size 0x1c0, virtual false, abstract: false, final false
  inline void CheckRequiredAttributes(::System::Xml::Schema::SchemaElementDecl* currentElementDecl);

  /// @brief Method CheckStateTransition, addr 0x60fc168, size 0x1fc, virtual false, abstract: false, final false
  inline void CheckStateTransition(::System::Xml::Schema::ValidatorState toState, ::StringW methodName);

  /// @brief Method CheckTokenizedTypes, addr 0x60fe5c4, size 0x180, virtual false, abstract: false, final false
  inline void CheckTokenizedTypes(::System::Xml::Schema::XmlSchemaDatatype* dtype, ::System::Object* typedValue, bool attrValue);

  /// @brief Method CheckXsiTypeAndNil, addr 0x60fcd40, size 0x5a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearPSVI, addr 0x60fc364, size 0x44, virtual false, abstract: false, final false
  inline void ClearPSVI();

  /// @brief Method CompleteValidationError, addr 0x6101288, size 0x40c, virtual false, abstract: false, final false
  ...
  /// @brief Method ElementIdentityConstraints, addr 0x61037d8, size 0x3b4, virtual false, abstract: false, final false
  inline void ElementIdentityConstraints();

  /// @brief Method ElementValidationError, addr 0x6102b7c, size 0x600, virtual false, abstract: false, final false
  ...
  /// @brief Method EndElementIdentityConstraints, addr 0x6101694, size 0xbb4, virtual false, abstract: false, final false
  ...
  /// @brief Method EndValidation, addr 0x6100084, size 0xe8, virtual false, abstract: false, final false
  inline void EndValidation();

  /// @brief Method EnumerateAny, addr 0x6104a50, size 0x248, virtual false, abstract: false, final false
  static inline void EnumerateAny(::System::Text::StringBuilder* builder, ::StringW namespaces);

  /// @brief Method FastGetElementDecl, addr 0x60fc7f8, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method FindId, addr 0x6104098, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* FindId(::StringW name);

  /// @brief Method GetConcatenatedValue, addr 0x6100c4c, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW GetConcatenatedValue();

  /// @brief Method GetDefaultAttributePrefix, addr 0x61007d0, size 0x3a0, virtual false, abstract: false, final false
  inline ::StringW GetDefaultAttributePrefix(::StringW attributeNS);

  /// @brief Method GetSchemaElement, addr 0x60fd54c, size 0x110, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* GetSchemaElement();

  /// @brief Method GetSubstitutionGroupHead, addr 0x6102764, size 0x1c0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* GetSubstitutionGroupHead(::System::Xml::XmlQualifiedName* member);

  /// @brief Method GetTypeName, addr 0x610336c, size 0x58, virtual false, abstract: false, final false
  inline ::StringW GetTypeName(::System::Xml::Schema::SchemaDeclBase* decl);

  /// @brief Method GetUnspecifiedDefaultAttributes, addr 0x610025c, size 0x574, virtual false, abstract: false, final false
  inline void GetUnspecifiedDefaultAttributes(::System::Collections::ArrayList* defaultAttributes, bool createNodeData);

  /// @brief Method Init, addr 0x60fabd4, size 0x338, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method Initialize, addr 0x60fba38, size 0x12c, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method Initialize, addr 0x60fbb64, size 0x290, virtual false, abstract: false, final false
  inline void Initialize(::System::Xml::Schema::XmlSchemaObject* partialValidationType);

  /// @brief Method InternalValidateEndElement, addr 0x60ff85c, size 0x4e0, virtual false, abstract: false, final false
  inline ::System::Object* InternalValidateEndElement(::System::Xml::Schema::XmlSchemaInfo* schemaInfo, ::System::Object* typedValue);

  /// @brief Method LoadSchema, addr 0x6102248, size 0x448, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x60fff4c, size 0x138, virtual false, abstract: false, final false
  inline void Pop();

  /// @brief Method PrintExpectedElements, addr 0x60ff244, size 0x3ec, virtual false, abstract: false, final false
  static inline ::StringW PrintExpectedElements(::System::Collections::ArrayList* expected, bool getParticles);

  /// @brief Method PrintNames, addr 0x61048cc, size 0x184, virtual false, abstract: false, final false
  static inline ::StringW PrintNames(::System::Collections::ArrayList* expected);

  /// @brief Method PrintNamesWithNS, addr 0x6104440, size 0x48c, virtual false, abstract: false, final false
  static inline void PrintNamesWithNS(::System::Collections::ArrayList* expected, ::System::Text::StringBuilder* builder);

  /// @brief Method ProcessEntity, addr 0x61040b4, size 0x198, virtual false, abstract: false, final false
  inline void ProcessEntity(::StringW name);

  /// @brief Method ProcessSchemaLocations, addr 0x60fca50, size 0x2f0, virtual false, abstract: false, final false
  inline void ProcessSchemaLocations(::StringW xsiSchemaLocation, ::StringW xsiNoNamespaceSchemaLocation);

  /// @brief Method ProcessTokenizedType, addr 0x6103df4, size 0x2a4, virtual false, abstract: false, final false
  inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType ttype, ::StringW name, bool attrValue);

  /// @brief Method Push, addr 0x60faf0c, size 0xf8, virtual false, abstract: false, final false
  inline void Push(::System::Xml::XmlQualifiedName* elementName);

  /// @brief Method QNameString, addr 0x60ff038, size 0x84, virtual false, abstract: false, final false
  static inline ::StringW QNameString(::StringW localName, ::StringW ns);

  /// @brief Method RecompileSchemaSet, addr 0x60fb090, size 0xc4, virtual false, abstract: false, final false
  inline void RecompileSchemaSet();

  /// @brief Method Reset, addr 0x60fb004, size 0x8c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SaveTextValue, addr 0x60ff0bc, size 0x40, virtual false, abstract: false, final false
  inline void SaveTextValue(::System::Object* value);

  /// @brief Method SendValidationEvent, addr 0x61033c4, size 0x14, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code);

  /// @brief Method SendValidationEvent, addr 0x60fdfe0, size 0x180, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::StringW arg);

  /// @brief Method SendValidationEvent, addr 0x610298c, size 0x1f0, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::StringW arg1, ::StringW arg2);

  /// @brief Method SendValidationEvent, addr 0x60fe21c, size 0x1a4, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method SendValidationEvent, addr 0x60fb888, size 0x1b0, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Exception* innerException);

  /// @brief Method SendValidationEvent, addr 0x6103c18, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SendValidationEvent, addr 0x60fb6d4, size 0x1b4, virtual false, abstract: false, final false
  inline void SendValidationEvent(::StringW code, ::StringW msg, ::System::Xml::Schema::XmlSeverityType severity);

  /// @brief Method SendValidationEvent, addr 0x6102690, size 0xd4, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException* e);

  /// @brief Method SendValidationEvent, addr 0x6104374, size 0x8, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaValidationException* e);

  /// @brief Method SendValidationEvent, addr 0x610424c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendValidationEvent, addr 0x610437c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDtdSchemaInfo, addr 0x6100bb4, size 0x10, virtual false, abstract: false, final false
  inline void SetDtdSchemaInfo(::System::Xml::IDtdInfo* dtdSchemaInfo);

  /// @brief Method SkipToEndElement, addr 0x60ffd3c, size 0x210, virtual false, abstract: false, final false
  inline void SkipToEndElement(::System::Xml::Schema::XmlSchemaInfo* schemaInfo);

  /// @brief Method ThrowDeclNotFoundWarningOrError, addr 0x60fd2e8, size 0x158, virtual false, abstract: false, final false
  inline void ThrowDeclNotFoundWarningOrError(bool declFound);

  /// @brief Method ValidateAtomicValue, addr 0x6100edc, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateAtomicValue, addr 0x6100c68, size 0x274, virtual false, abstract: false, final false
  inline ::System::Object* ValidateAtomicValue(::StringW stringValue, ::ByRef<::System::Xml::Schema::XmlSchemaSimpleType*> memberType);

  /// @brief Method ValidateAttribute, addr 0x60fd6b8, size 0x928, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateAttribute, addr 0x60fd65c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x60fbdf4, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateElementContext, addr 0x60fc3a8, size 0x450, virtual false, abstract: false, final false
  inline ::System::Object* ValidateElementContext(::System::Xml::XmlQualifiedName* elementName, ::ByRef<bool> invalidElementInContext);

  /// @brief Method ValidateEndElement, addr 0x60ff854, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* ValidateEndElement(::System::Xml::Schema::XmlSchemaInfo* schemaInfo);

  /// @brief Method ValidateEndOfAttributes, addr 0x60fea08, size 0xcc, virtual false, abstract: false, final false
  inline void ValidateEndOfAttributes(::System::Xml::Schema::XmlSchemaInfo* schemaInfo);

  /// @brief Method ValidateStartElementIdentityConstraints, addr 0x60fd4f0, size 0x5c, virtual false, abstract: false, final false
  inline void ValidateStartElementIdentityConstraints();

  /// @brief Method ValidateText, addr 0x60fecf0, size 0x348, virtual false, abstract: false, final false
  inline void ValidateText(::StringW elementStringValue, ::System::Xml::Schema::XmlValueGetter* elementValueGetter);

  /// @brief Method ValidateText, addr 0x60fec94, size 0x5c, virtual false, abstract: false, final false
  inline void ValidateText(::System::Xml::Schema::XmlValueGetter* elementValue);

  /// @brief Method ValidateWhitespace, addr 0x60ff68c, size 0x1c8, virtual false, abstract: false, final false
  inline void ValidateWhitespace(::StringW elementStringValue, ::System::Xml::Schema::XmlValueGetter* elementValueGetter);

  /// @brief Method ValidateWhitespace, addr 0x60ff630, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60faa04, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_ValidationEventHandler, addr 0x60fb1b8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentContentType, addr 0x6100b80, size 0x34, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_CurrentContentType();

  /// @brief Method get_HasIdentityConstraints, addr 0x60fe744, size 0x20, virtual false, abstract: false, final false
  inline bool get_HasIdentityConstraints();

  /// @brief Method get_HasSchema, addr 0x6100c04, size 0x48, virtual false, abstract: false, final false
  inline bool get_HasSchema();

  /// @brief Method get_ProcessIdentityConstraints, addr 0x61033d8, size 0xc, virtual false, abstract: false, final false
  inline bool get_ProcessIdentityConstraints();

  /// @brief Method get_ProcessSchemaHints, addr 0x60fb154, size 0x10, virtual false, abstract: false, final false
  inline bool get_ProcessSchemaHints();

  /// @brief Method get_ReportValidationWarnings, addr 0x6104368, size 0xc, virtual false, abstract: false, final false
  inline bool get_ReportValidationWarnings();

  /// @brief Method get_SchemaSet, addr 0x6100b70, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSet* get_SchemaSet();

  /// @brief Method get_StrictlyAssessed, addr 0x6100bc4, size 0x40, virtual false, abstract: false, final false
  inline bool get_StrictlyAssessed();

  /// @brief Method get_ValidationFlags, addr 0x6100b78, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaValidationFlags get_ValidationFlags();

  /// @brief Method remove_ValidationEventHandler, addr 0x60fb244, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LineInfoProvider, addr 0x60fb16c, size 0x10, virtual false, abstract: false, final false
  inline void set_LineInfoProvider(::System::Xml::IXmlLineInfo* value);

  /// @brief Method set_SourceUri, addr 0x60fb17c, size 0x34, virtual false, abstract: false, final false
  inline void set_SourceUri(::System::Uri* value);

  /// @brief Method set_ValidationEventSender, addr 0x60fb1b0, size 0x8, virtual false, abstract: false, final false
  inline void set_ValidationEventSender(::System::Object* value);

  /// @brief Method set_XmlResolver, addr 0x60fb164, size 0x8, virtual false, abstract: false, final false
