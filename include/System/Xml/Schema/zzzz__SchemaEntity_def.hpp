...
public:
  ...
  /// @brief Method .ctor, addr 0x28c783c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlQualifiedName* qname, bool isParameter);

  /// @brief Method System.Xml.IDtdEntityInfo.get_Name, addr 0x28c78c0, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_Name();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsExternal, addr 0x28c78dc, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsExternal();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsDeclaredInExternal, addr 0x28c78e4, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsDeclaredInExternal();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsUnparsedEntity, addr 0x28c78ec, size 0x28, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsUnparsedEntity();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsParameterEntity, addr 0x28c7914, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsParameterEntity();

  /// @brief Method System.Xml.IDtdEntityInfo.get_BaseUriString, addr 0x28c791c, size 0x54, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_BaseUriString();

  /// @brief Method System.Xml.IDtdEntityInfo.get_DeclaredUriString, addr 0x28c79c4, size 0x54, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_DeclaredUriString();

  /// @brief Method System.Xml.IDtdEntityInfo.get_SystemId, addr 0x28c7a6c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_SystemId();

  /// @brief Method System.Xml.IDtdEntityInfo.get_PublicId, addr 0x28c7a74, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_PublicId();

  /// @brief Method System.Xml.IDtdEntityInfo.get_Text, addr 0x28c7a7c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_Text();

  /// @brief Method System.Xml.IDtdEntityInfo.get_LineNumber, addr 0x28c7a84, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdEntityInfo_get_LineNumber();

  /// @brief Method System.Xml.IDtdEntityInfo.get_LinePosition, addr 0x28c7a8c, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdEntityInfo_get_LinePosition();

  /// @brief Method get_Name, addr 0x28c7a94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_Name();

  /// @brief Method get_Url, addr 0x28c7a9c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Url();

  /// @brief Method set_Url, addr 0x28c7aa4, size 0x10, virtual false, abstract: false, final false
  inline void set_Url(::StringW value);

  /// @brief Method get_Pubid, addr 0x28c7ab4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Pubid();

  /// @brief Method set_Pubid, addr 0x28c7abc, size 0x8, virtual false, abstract: false, final false
  inline void set_Pubid(::StringW value);

  /// @brief Method get_IsExternal, addr 0x28c7ac4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsExternal();

  /// @brief Method set_IsExternal, addr 0x28c7acc, size 0xc, virtual false, abstract: false, final false
  inline void set_IsExternal(bool value);

  /// @brief Method get_DeclaredInExternal, addr 0x28c7ad8, size 0x8, virtual false, abstract: false, final false
  inline bool get_DeclaredInExternal();

  /// @brief Method set_DeclaredInExternal, addr 0x28c7ae0, size 0xc, virtual false, abstract: false, final false
  inline void set_DeclaredInExternal(bool value);

  /// @brief Method get_NData, addr 0x28c7aec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_NData();

  /// @brief Method set_NData, addr 0x28c7af4, size 0x8, virtual false, abstract: false, final false
  inline void set_NData(::System::Xml::XmlQualifiedName* value);

  /// @brief Method get_Text, addr 0x28c7afc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Text();

  /// @brief Method set_Text, addr 0x28c7b04, size 0xc, virtual false, abstract: false, final false
  inline void set_Text(::StringW value);

  /// @brief Method get_Line, addr 0x28c7b10, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Line();

  /// @brief Method set_Line, addr 0x28c7b18, size 0x8, virtual false, abstract: false, final false
  inline void set_Line(int32_t value);

  /// @brief Method get_Pos, addr 0x28c7b20, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Pos();

  /// @brief Method set_Pos, addr 0x28c7b28, size 0x8, virtual false, abstract: false, final false
  inline void set_Pos(int32_t value);

  /// @brief Method get_BaseURI, addr 0x28c7970, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method set_BaseURI, addr 0x28c7b30, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseURI(::StringW value);

  /// @brief Method get_ParsingInProgress, addr 0x28c7b38, size 0x8, virtual false, abstract: false, final false
  inline bool get_ParsingInProgress();

  /// @brief Method set_ParsingInProgress, addr 0x28c7b40, size 0xc, virtual false, abstract: false, final false
  inline void set_ParsingInProgress(bool value);

  /// @brief Method get_DeclaredURI, addr 0x28c7a18, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DeclaredURI();

  /// @brief Method set_DeclaredURI, addr 0x28c7b4c, size 0x8, virtual false, abstract: false, final false
