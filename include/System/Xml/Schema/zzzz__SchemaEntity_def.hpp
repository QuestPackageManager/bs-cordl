...
public:
  ...
  /// @brief Method IsPredefinedEntity, addr 0x6050420, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.IDtdEntityInfo.get_BaseUriString, addr 0x6050378, size 0x20, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_BaseUriString();

  /// @brief Method System.Xml.IDtdEntityInfo.get_DeclaredUriString, addr 0x60503b8, size 0x20, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_DeclaredUriString();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsDeclaredInExternal, addr 0x6050340, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsDeclaredInExternal();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsExternal, addr 0x6050338, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsExternal();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsParameterEntity, addr 0x6050370, size 0x8, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsParameterEntity();

  /// @brief Method System.Xml.IDtdEntityInfo.get_IsUnparsedEntity, addr 0x6050348, size 0x28, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdEntityInfo_get_IsUnparsedEntity();

  /// @brief Method System.Xml.IDtdEntityInfo.get_LineNumber, addr 0x6050410, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdEntityInfo_get_LineNumber();

  /// @brief Method System.Xml.IDtdEntityInfo.get_LinePosition, addr 0x6050418, size 0x8, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdEntityInfo_get_LinePosition();

  /// @brief Method System.Xml.IDtdEntityInfo.get_Name, addr 0x6050320, size 0x18, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_Name();

  /// @brief Method System.Xml.IDtdEntityInfo.get_PublicId, addr 0x6050400, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_PublicId();

  /// @brief Method System.Xml.IDtdEntityInfo.get_SystemId, addr 0x60503f8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IDtdEntityInfo_get_SystemId();

  /// @brief Method System.Xml.IDtdEntityInfo.get_Text, addr 0x6050408, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x60502a0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlQualifiedName* qname, bool isParameter);

  /// @brief Method get_BaseURI, addr 0x6050398, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_DeclaredInExternal, addr 0x605055c, size 0x8, virtual false, abstract: false, final false
  inline bool get_DeclaredInExternal();

  /// @brief Method get_DeclaredURI, addr 0x60503d8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_DeclaredURI();

  /// @brief Method get_IsExternal, addr 0x605054c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsExternal();

  /// @brief Method get_Line, addr 0x6050590, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Line();

  /// @brief Method get_NData, addr 0x605056c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_NData();

  /// @brief Method get_Name, addr 0x605051c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_Name();

  /// @brief Method get_ParsingInProgress, addr 0x60505b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_ParsingInProgress();

  /// @brief Method get_Pos, addr 0x60505a0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Pos();

  /// @brief Method get_Pubid, addr 0x605053c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Pubid();

  /// @brief Method get_Text, addr 0x605057c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Text();

  /// @brief Method get_Url, addr 0x6050524, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_BaseURI, addr 0x60505b0, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseURI(::StringW value);

  /// @brief Method set_DeclaredInExternal, addr 0x6050564, size 0x8, virtual false, abstract: false, final false
  inline void set_DeclaredInExternal(bool value);

  /// @brief Method set_DeclaredURI, addr 0x60505c8, size 0x8, virtual false, abstract: false, final false
  inline void set_DeclaredURI(::StringW value);

  /// @brief Method set_IsExternal, addr 0x6050554, size 0x8, virtual false, abstract: false, final false
  inline void set_IsExternal(bool value);

  /// @brief Method set_Line, addr 0x6050598, size 0x8, virtual false, abstract: false, final false
  inline void set_Line(int32_t value);

  /// @brief Method set_NData, addr 0x6050574, size 0x8, virtual false, abstract: false, final false
  inline void set_NData(::System::Xml::XmlQualifiedName* value);

  /// @brief Method set_ParsingInProgress, addr 0x60505c0, size 0x8, virtual false, abstract: false, final false
  inline void set_ParsingInProgress(bool value);

  /// @brief Method set_Pos, addr 0x60505a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Pos(int32_t value);

  /// @brief Method set_Pubid, addr 0x6050544, size 0x8, virtual false, abstract: false, final false
  inline void set_Pubid(::StringW value);

  /// @brief Method set_Text, addr 0x6050584, size 0xc, virtual false, abstract: false, final false
  inline void set_Text(::StringW value);

  /// @brief Method set_Url, addr 0x605052c, size 0x10, virtual false, abstract: false, final false
