...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaMaxExclusiveFacet*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaMaxExclusiveFacet*, "System.Xml.Schema", "XmlSchemaMaxExclusiveFacet");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMaxExclusiveFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaMaxExclusiveFacet(XmlSchemaMaxExclusiveFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMaxExclusiveFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaMaxExclusiveFacet(XmlSchemaMaxExclusiveFacetconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaMaxExclusiveFacet) == 0x60, "Size mismatch!");
