...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x601540c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60153f0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Namespace, addr 0x60153fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_Namespace, addr 0x6015404, size 0x8, virtual false, abstract: false, final false
