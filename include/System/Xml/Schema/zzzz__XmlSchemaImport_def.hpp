...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x42bf3f4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42bf3c4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Namespace, addr 0x42bf3e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_Namespace, addr 0x42bf3ec, size 0x8, virtual false, abstract: false, final false
