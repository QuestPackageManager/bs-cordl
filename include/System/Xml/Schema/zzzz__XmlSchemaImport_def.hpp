...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x42bf08c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42bf05c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Namespace, addr 0x42bf07c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_Namespace, addr 0x42bf084, size 0x8, virtual false, abstract: false, final false
