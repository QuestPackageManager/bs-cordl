...
/// @brief Method AddAnnotation, addr 0x60f11dc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60f11c0, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Namespace, addr 0x60f11cc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method set_Namespace, addr 0x60f11d4, size 0x8, virtual false, abstract: false, final false
