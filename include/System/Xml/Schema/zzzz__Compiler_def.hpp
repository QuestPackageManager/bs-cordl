...
public:
  ...
  /// @brief Method BuildParticleContentModel, addr 0x42ac204, size 0x500, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateEffectiveTotalRange, addr 0x42ab498, size 0x7c4, virtual false, abstract: false, final false
  ...
  /// @brief Method CannonicalizeAll, addr 0x42a88b8, size 0x284, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeAll(::System::Xml::Schema::XmlSchemaAll* all, bool root);

  /// @brief Method CannonicalizeChoice, addr 0x42a8b3c, size 0x4f4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeChoice(::System::Xml::Schema::XmlSchemaChoice* choice, bool root);

  /// @brief Method CannonicalizeElement, addr 0x42a94e4, size 0x204, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeElement(::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method CannonicalizeGroupRef, addr 0x42a83a4, size 0x514, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeGroupRef(::System::Xml::Schema::XmlSchemaGroupRef* groupRef, bool root);

  /// @brief Method CannonicalizeParticle, addr 0x42a3338, size 0x21c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeParticle(::System::Xml::Schema::XmlSchemaParticle* particle, bool root);

  /// @brief Method CannonicalizePointlessRoot, addr 0x42a7708, size 0x264, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizePointlessRoot(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method CannonicalizeSequence, addr 0x42a9030, size 0x4b4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CannonicalizeSequence(::System::Xml::Schema::XmlSchemaSequence* sequence, bool root);

  /// @brief Method CheckAtrributeGroupRestriction, addr 0x42a37b4, size 0x9a8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckParticleDerivation, addr 0x42a24a4, size 0x5f0, virtual false, abstract: false, final false
  inline void CheckParticleDerivation(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CheckParticleDerivation, addr 0x42a36dc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckUnionType, addr 0x42a45d4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupAttribute, addr 0x429dac8, size 0x28, virtual false, abstract: false, final false
  inline void CleanupAttribute(::System::Xml::Schema::XmlSchemaAttribute* attribute);

  /// @brief Method CleanupAttributeGroup, addr 0x429db2c, size 0x54, virtual false, abstract: false, final false
  inline void CleanupAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup* attributeGroup);

  /// @brief Method CleanupAttributes, addr 0x42a2bbc, size 0xd8, virtual false, abstract: false, final false
  inline void CleanupAttributes(::System::Xml::Schema::XmlSchemaObjectCollection* attributes);

  /// @brief Method CleanupComplexType, addr 0x429db80, size 0x420, virtual false, abstract: false, final false
  inline void CleanupComplexType(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CleanupElement, addr 0x429d944, size 0x184, virtual false, abstract: false, final false
  inline void CleanupElement(::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method CleanupGroup, addr 0x429daf0, size 0x3c, virtual false, abstract: false, final false
  inline void CleanupGroup(::System::Xml::Schema::XmlSchemaGroup* group);

  /// @brief Method CleanupParticle, addr 0x42a2c94, size 0x19c, virtual false, abstract: false, final false
  inline void CleanupParticle(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method CleanupSimpleType, addr 0x429dfa0, size 0xb4, virtual false, abstract: false, final false
  inline void CleanupSimpleType(::System::Xml::Schema::XmlSchemaSimpleType* simpleType);

  /// @brief Method Compile, addr 0x429918c, size 0x200c, virtual false, abstract: false, final false
  inline bool Compile();

  /// @brief Method CompileAnyAttributeIntersection, addr 0x42abe5c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileAnyAttributeUnion, addr 0x42abef0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileAttribute, addr 0x42a0cdc, size 0x7d8, virtual false, abstract: false, final false
  inline void CompileAttribute(::System::Xml::Schema::XmlSchemaAttribute* xa);

  /// @brief Method CompileAttributeGroup, addr 0x429e374, size 0x880, virtual false, abstract: false, final false
  inline void CompileAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup* attributeGroup);

  /// @brief Method CompileBaseMemberTypes, addr 0x42a4234, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileComplexContent, addr 0x42a6abc, size 0xa4c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ContentValidator* CompileComplexContent(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CompileComplexContentExtension, addr 0x42a4d50, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileComplexContentRestriction, addr 0x42a50c4, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileComplexType, addr 0x429ebf4, size 0xaac, virtual false, abstract: false, final false
  inline void CompileComplexType(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CompileComplexTypeElements, addr 0x42a1b1c, size 0x11c, virtual false, abstract: false, final false
  inline void CompileComplexTypeElements(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method CompileContentTypeParticle, addr 0x42a68f0, size 0x15c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* CompileContentTypeParticle(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method CompileElement, addr 0x429ff94, size 0xd48, virtual false, abstract: false, final false
  inline void CompileElement(::System::Xml::Schema::XmlSchemaElement* xe);

  /// @brief Method CompileGroup, addr 0x429e2ac, size 0xc8, virtual false, abstract: false, final false
  inline void CompileGroup(::System::Xml::Schema::XmlSchemaGroup* group);

  /// @brief Method CompileIdentityConstraint, addr 0x42a14b4, size 0x668, virtual false, abstract: false, final false
  inline void CompileIdentityConstraint(::System::Xml::Schema::XmlSchemaIdentityConstraint* xi);

  /// @brief Method CompileLocalAttributes, addr 0x42a5374, size 0x157c, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileParticleElements, addr 0x42ac704, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileParticleElements, addr 0x42a3554, size 0x188, virtual false, abstract: false, final false
  inline void CompileParticleElements(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method CompileSimpleContentExtension, addr 0x42a46ec, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileSimpleContentRestriction, addr 0x42a492c, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileSimpleType, addr 0x429f6a0, size 0x8f4, virtual false, abstract: false, final false
  inline void CompileSimpleType(::System::Xml::Schema::XmlSchemaSimpleType* simpleType);

  /// @brief Method CompileSubstitutionGroup, addr 0x42a2e30, size 0x508, virtual false, abstract: false, final false
  inline void CompileSubstitutionGroup(::System::Xml::Schema::XmlSchemaSubstitutionGroup* substitutionGroup);

  /// @brief Method CopyPosition, addr 0x42a96e8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x4299110, size 0x7c, virtual false, abstract: false, final false
  inline bool Execute(::System::Xml::Schema::XmlSchemaSet* schemaSet, ::System::Xml::Schema::SchemaInfo* schemaCompiledInfo);

  /// @brief Method GetAnySchemaType, addr 0x42a7508, size 0x158, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaType* GetAnySchemaType(::System::Xml::XmlQualifiedName* name);

  /// @brief Method GetComplexType, addr 0x42a7660, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaComplexType* GetComplexType(::System::Xml::XmlQualifiedName* name);

  /// @brief Method GetMappingParticle, addr 0x42abd44, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSchemaContentType, addr 0x42a6a4c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSimpleType, addr 0x42a415c, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSimpleType* GetSimpleType(::System::Xml::XmlQualifiedName* name);

  /// @brief Method ImportAllCompiledSchemas, addr 0x429e1a4, size 0x108, virtual false, abstract: false, final false
  inline void ImportAllCompiledSchemas(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method IsAnyFromAny, addr 0x42a9b84, size 0xf8, virtual false, abstract: false, final false
  inline bool IsAnyFromAny(::System::Xml::Schema::XmlSchemaAny* derivedAny, ::System::Xml::Schema::XmlSchemaAny* baseAny);

  /// @brief Method IsChoiceFromChoiceSubstGroup, addr 0x42aae28, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsElementFromAny, addr 0x42a99f4, size 0x190, virtual false, abstract: false, final false
  inline bool IsElementFromAny(::System::Xml::Schema::XmlSchemaElement* derivedElement, ::System::Xml::Schema::XmlSchemaAny* baseAny);

  /// @brief Method IsElementFromElement, addr 0x42a9808, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method IsElementFromGroupBase, addr 0x42aa044, size 0x808, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFixedEqual, addr 0x42ab33c, size 0x15c, virtual false, abstract: false, final false
  inline bool IsFixedEqual(::System::Xml::Schema::SchemaDeclBase* baseDecl, ::System::Xml::Schema::SchemaDeclBase* derivedDecl);

  /// @brief Method IsGroupBaseFromAny, addr 0x42a9c7c, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsGroupBaseFromGroupBase, addr 0x42aa84c, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsParticleEmptiable, addr 0x42a9744, size 0xc4, virtual false, abstract: false, final false
  inline bool IsParticleEmptiable(::System::Xml::Schema::XmlSchemaParticle* particle);

  /// @brief Method IsProcessContentsRestricted, addr 0x42abf84, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSequenceFromAll, addr 0x42aab1c, size 0x30c, virtual false, abstract: false, final false
  inline bool IsSequenceFromAll(::System::Xml::Schema::XmlSchemaSequence* derivedSequence, ::System::Xml::Schema::XmlSchemaAll* baseAll);

  /// @brief Method IsSequenceFromChoice, addr 0x42aafb4, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidOccurrenceRangeRestriction, addr 0x42ab2f8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidOccurrenceRangeRestriction, addr 0x42abc5c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidRestriction, addr 0x42a796c, size 0xa38, virtual false, abstract: false, final false
  ...
  /// @brief Method Output, addr 0x429b198, size 0x10b0, virtual false, abstract: false, final false
  inline void Output(::System::Xml::Schema::SchemaInfo* schemaInfo);

  /// @brief Method Prepare, addr 0x429c248, size 0x16fc, virtual false, abstract: false, final false
  inline void Prepare(::System::Xml::Schema::XmlSchema* schema, bool cleanup);

  /// @brief Method ProcessSubstitutionGroups, addr 0x42a1c38, size 0x86c, virtual false, abstract: false, final false
  inline void ProcessSubstitutionGroups();

  /// @brief Method PushComplexType, addr 0x42abe38, size 0x24, virtual false, abstract: false, final false
  inline void PushComplexType(::System::Xml::Schema::XmlSchemaComplexType* complexType);

  /// @brief Method RecursivelyCheckRedefinedAttributeGroups, addr 0x42a2b44, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method RecursivelyCheckRedefinedGroups, addr 0x42a2a94, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefaultFixed, addr 0x42ac060, size 0x1a4, virtual false, abstract: false, final false
  inline void SetDefaultFixed(::System::Xml::Schema::XmlSchemaAttribute* xa, ::System::Xml::Schema::SchemaAttDef* decl);

  /// @brief Method UpdateSForSSimpleTypes, addr 0x429e054, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4298f58, size 0x1b8, virtual false, abstract: false, final false
