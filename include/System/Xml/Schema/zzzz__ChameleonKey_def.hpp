...
public:
  ...
  /// @brief Method Equals, addr 0x43a5e1c, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x43a5d9c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43a5d44, size 0x58, virtual false, abstract: false, final false
