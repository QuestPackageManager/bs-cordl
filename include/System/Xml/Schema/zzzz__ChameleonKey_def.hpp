...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChameleonKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChameleonKey(ChameleonKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChameleonKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChameleonKey(ChameleonKeyconst&) = delete;
