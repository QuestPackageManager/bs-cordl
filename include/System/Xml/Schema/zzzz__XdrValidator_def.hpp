...
public:
  ...
  /// @brief Method AddID, addr 0x60e67ec, size 0x98, virtual false, abstract: false, final false
  inline void AddID(::StringW name, ::System::Object* node);

  /// @brief Method CheckDefaultValue, addr 0x60e214c, size 0x468, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForwardRefs, addr 0x60e693c, size 0x108, virtual false, abstract: false, final false
  inline void CheckForwardRefs();

  /// @brief Method CheckValue, addr 0x60e566c, size 0x5fc, virtual false, abstract: false, final false
  inline void CheckValue(::StringW value, ::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method CompleteValidation, addr 0x60e6884, size 0xb8, virtual true, abstract: false, final false
  inline void CompleteValidation();

  /// @brief Method FindId, addr 0x60e6af8, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Object* FindId(::StringW name);

  /// @brief Method Init, addr 0x60e4144, size 0x1a8, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method LoadSchema, addr 0x60e5d08, size 0x19c, virtual false, abstract: false, final false
  inline void LoadSchema(::StringW uri);

  /// @brief Method LoadSchemaFromLocation, addr 0x60e5f4c, size 0x5a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Pop, addr 0x60e5c68, size 0xa0, virtual false, abstract: false, final false
  inline void Pop();

  /// @brief Method ProcessElement, addr 0x60e4b84, size 0xa8, virtual false, abstract: false, final false
  inline void ProcessElement();

  /// @brief Method ProcessInlineSchema, addr 0x60e4530, size 0x1d0, virtual false, abstract: false, final false
  inline void ProcessInlineSchema();

  /// @brief Method ProcessTokenizedType, addr 0x60e65f0, size 0x1fc, virtual false, abstract: false, final false
  inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType ttype, ::StringW name);

  /// @brief Method Push, addr 0x60e4388, size 0xe0, virtual false, abstract: false, final false
  inline void Push(::System::Xml::XmlQualifiedName* elementName);

  /// @brief Method QualifiedName, addr 0x60e5ea4, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* QualifiedName(::StringW name, ::StringW ns);

  /// @brief Method ThoroughGetElementDecl, addr 0x60e4c34, size 0x308, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* ThoroughGetElementDecl();

  /// @brief Method Validate, addr 0x60e4468, size 0xb8, virtual true, abstract: false, final false
  inline void Validate();

  /// @brief Method ValidateChildElement, addr 0x60e4a3c, size 0x148, virtual false, abstract: false, final false
  inline void ValidateChildElement();

  /// @brief Method ValidateElement, addr 0x60e4700, size 0x188, virtual false, abstract: false, final false
  inline void ValidateElement();

  /// @brief Method ValidateEndElement, addr 0x60e4888, size 0x1b4, virtual false, abstract: false, final false
  inline void ValidateEndElement();

  /// @brief Method ValidateEndStartElement, addr 0x60e531c, size 0x350, virtual false, abstract: false, final false
  inline void ValidateEndStartElement();

  /// @brief Method ValidateStartElement, addr 0x60e4f3c, size 0x3e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60e42ec, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60e40c0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::BaseValidator* validator);

  /// @brief Method get_HasSchema, addr 0x60e6590, size 0x20, virtual false, abstract: false, final false
  inline bool get_HasSchema();

  /// @brief Method get_IsInlineSchemaStarted, addr 0x60e4520, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsInlineSchemaStarted();

  /// @brief Method get_PreserveWhitespace, addr 0x60e65b0, size 0x40, virtual true, abstract: false, final false
