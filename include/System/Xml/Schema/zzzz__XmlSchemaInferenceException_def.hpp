...
public:
  // Declarations
  /// @brief Method GetObjectData, addr 0x4266dec, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4266df4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4266de4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x4264c0c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg);

  /// @brief Method .ctor, addr 0x425e180, size 0x34, virtual false, abstract: false, final false
