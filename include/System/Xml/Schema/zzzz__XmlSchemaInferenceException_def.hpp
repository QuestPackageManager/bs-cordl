...
public:
  // Declarations
  /// @brief Method GetObjectData, addr 0x426bce8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x426bcf0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x426bce0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x4269b08, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg);

  /// @brief Method .ctor, addr 0x426307c, size 0x34, virtual false, abstract: false, final false
