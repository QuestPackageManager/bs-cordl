...
public:
  // Declarations
  /// @brief Method GetObjectData, addr 0x6029260, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6029268, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6029258, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x60276c4, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg);

  /// @brief Method .ctor, addr 0x6020e30, size 0x54, virtual false, abstract: false, final false
