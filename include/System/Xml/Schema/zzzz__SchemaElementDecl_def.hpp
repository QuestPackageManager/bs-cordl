...
// Dependencies System.Xml.Schema.SchemaDeclBase, System.Xml.Schema.XmlSchemaDerivationMethod
namespace System::Xml::Schema {
// Is value type: false
...
public:
  ...
  /// @brief Method AddAttDef, addr 0x604fdbc, size 0x184, virtual false, abstract: false, final false
  inline void AddAttDef(::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method CheckAttributes, addr 0x604ffd4, size 0x270, virtual false, abstract: false, final false
  inline void CheckAttributes(::System::Collections::Hashtable* presence, bool standalone);

  /// @brief Method Clone, addr 0x604fcc0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* Clone();

  /// @brief Method CreateAnyTypeElementDecl, addr 0x604faf8, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::SchemaElementDecl* CreateAnyTypeElementDecl();

  /// @brief Method GetAttDef, addr 0x604ff40, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.IDtdAttributeListInfo.LookupAttribute, addr 0x604fbdc, size 0xbc, virtual true, abstract: false, final true
  inline ::System::Xml::IDtdAttributeInfo* System_Xml_IDtdAttributeListInfo_LookupAttribute(::StringW prefix, ::StringW localName);

  /// @brief Method System.Xml.IDtdAttributeListInfo.LookupDefaultAttributes, addr 0x604fc98, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IDtdAttributeListInfo.get_HasNonCDataAttributes, addr 0x604fbd4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x604f77c, size 0x108, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x604f884, size 0x154, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaDatatype* dtype);

  /// @brief Method .ctor, addr 0x604f9d8, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AnyAttribute, addr 0x604fd8c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute();

  /// @brief Method get_AttDefs, addr 0x604ffc4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*, ::System::Xml::Schema::SchemaAttDef*>* get_AttDefs();

  /// @brief Method get_Block, addr 0x604fd44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Block();

  /// @brief Method get_Constraints, addr 0x604fd9c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ContentValidator, addr 0x604fd7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ContentValidator* get_ContentValidator();

  /// @brief Method get_DefaultAttDefs, addr 0x604ffbc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::System::Xml::IDtdDefaultAttributeInfo*>* get_DefaultAttDefs();

  /// @brief Method get_HasDefaultAttribute, addr 0x604fd64, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasDefaultAttribute();

  /// @brief Method get_HasNonCDataAttribute, addr 0x604fcb0, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasNonCDataAttribute();

  /// @brief Method get_HasRequiredAttribute, addr 0x604fd74, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasRequiredAttribute();

  /// @brief Method get_IsAbstract, addr 0x604fd24, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAbstract();

  /// @brief Method get_IsIdDeclared, addr 0x604fca0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsIdDeclared();

  /// @brief Method get_IsNillable, addr 0x604fd34, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNillable();

  /// @brief Method get_IsNotationDeclared, addr 0x604fd54, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNotationDeclared();

  /// @brief Method get_ProhibitedAttributes, addr 0x604ffcc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SchemaElement, addr 0x604fdac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AnyAttribute, addr 0x604fd94, size 0x8, virtual false, abstract: false, final false
  inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute* value);

  /// @brief Method set_Block, addr 0x604fd4c, size 0x8, virtual false, abstract: false, final false
  inline void set_Block(::System::Xml::Schema::XmlSchemaDerivationMethod value);

  /// @brief Method set_Constraints, addr 0x604fda4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ContentValidator, addr 0x604fd84, size 0x8, virtual false, abstract: false, final false
  inline void set_ContentValidator(::System::Xml::Schema::ContentValidator* value);

  /// @brief Method set_HasNonCDataAttribute, addr 0x604fcb8, size 0x8, virtual false, abstract: false, final false
  inline void set_HasNonCDataAttribute(bool value);

  /// @brief Method set_IsAbstract, addr 0x604fd2c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsAbstract(bool value);

  /// @brief Method set_IsIdDeclared, addr 0x604fca8, size 0x8, virtual false, abstract: false, final false
  inline void set_IsIdDeclared(bool value);

  /// @brief Method set_IsNillable, addr 0x604fd3c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsNillable(bool value);

  /// @brief Method set_IsNotationDeclared, addr 0x604fd5c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsNotationDeclared(bool value);

  /// @brief Method set_SchemaElement, addr 0x604fdb4, size 0x8, virtual false, abstract: false, final false
