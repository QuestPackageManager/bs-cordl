...
public:
  ...
  /// @brief Method ChangeListType, addr 0x6040050, size 0xcdc, virtual true, abstract: false, final false
  ...
  /// @brief Method ChangeType, addr 0x604436c, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Object* ChangeType(::System::Object* value, ::System::Type* destinationType, ::System::Xml::IXmlNamespaceResolver* nsResolver);

  /// @brief Method Create, addr 0x60441b0, size 0x1bc, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlValueConverter* Create(::System::Xml::Schema::XmlValueConverter* atomicConverter);

  /// @brief Method CreateInvalidClrMappingException, addr 0x6044594, size 0x264, virtual false, abstract: false, final false
  inline ::System::Exception* CreateInvalidClrMappingException(::System::Type* sourceType, ::System::Type* destinationType);

  /// @brief Method IsListType, addr 0x6044438, size 0x15c, virtual false, abstract: false, final false
  inline bool IsListType(::System::Type* type);

  /// @brief Method ListAsString, addr 0x60447f8, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method StringAsList, addr 0x6044b7c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToList, addr 0x6044c30, size 0x640, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6043dc4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlBaseConverter* atomicConverter);

  /// @brief Method .ctor, addr 0x603ac24, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlBaseConverter* atomicConverter, ::System::Type* clrTypeDefault);

  /// @brief Method .ctor, addr 0x603ab14, size 0x6c, virtual false, abstract: false, final false
