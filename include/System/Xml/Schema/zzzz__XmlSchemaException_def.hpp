...
public:
  ...
  /// @brief Method CreateMessage, addr 0x60eea44, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW CreateMessage(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method GetObjectData, addr 0x60eeb24, size 0x184, virtual true, abstract: false, final false
  ...
  /// @brief Method SetSchemaObject, addr 0x60ef070, size 0x8, virtual false, abstract: false, final false
  inline void SetSchemaObject(::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method SetSource, addr 0x60ef078, size 0x24, virtual false, abstract: false, final false
  inline void SetSource(::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method SetSource, addr 0x60e5f40, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60eeca8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x60ee6b4, size 0x390, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x60eecbc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x60eeddc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x60eeccc, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x60e6a44, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg);

  /// @brief Method .ctor, addr 0x60eefac, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method .ctor, addr 0x60e26f8, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::StringW sourceUri, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x60eee70, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method .ctor, addr 0x60eede8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60eef2c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method .ctor, addr 0x60e25b4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60eef20, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::System::Xml::Schema::XmlSchemaObject* source);

  /// @brief Method .ctor, addr 0x60eeec8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW sourceUri, int32_t lineNumber, int32_t linePosition);

  /// @brief Method get_Args, addr 0x60ef048, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Args();

  /// @brief Method get_GetRes, addr 0x60ef040, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_GetRes();

  /// @brief Method get_LineNumber, addr 0x60ef058, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x60ef060, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_Message, addr 0x60ef09c, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_SourceSchemaObject, addr 0x60ef068, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* get_SourceSchemaObject();

  /// @brief Method get_SourceUri, addr 0x60ef050, size 0x8, virtual false, abstract: false, final false
