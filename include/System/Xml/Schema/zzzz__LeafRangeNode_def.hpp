...
public:
  ...
  /// @brief Method ExpandTree, addr 0x43981e8, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4398120, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Decimal min, ::System::Decimal max);

  /// @brief Method .ctor, addr 0x4398168, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(int32_t pos, ::System::Decimal min, ::System::Decimal max);

  /// @brief Method get_IsRangeNode, addr 0x43981e0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsRangeNode();

  /// @brief Method get_Max, addr 0x43981b8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Decimal get_Max();

  /// @brief Method get_Min, addr 0x43981c4, size 0xc, virtual false, abstract: false, final false
  inline ::System::Decimal get_Min();

  /// @brief Method get_NextIteration, addr 0x43981d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::BitSet* get_NextIteration();

  /// @brief Method set_NextIteration, addr 0x43981d8, size 0x8, virtual false, abstract: false, final false
