...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_short*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_short*, "System.Xml.Schema", "Datatype_short");
// Dependencies System.Xml.Schema.Datatype_int
namespace System::Xml::Schema {
// Is value type: false
...
public:
  ...
  /// @brief Method Compare, addr 0x61c8e10, size 0x54, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  static inline ::System::Xml::Schema::Datatype_short* New_ctor();

  /// @brief Method TryParseValue, addr 0x61c8f1c, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61c02c4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FacetsChecker, addr 0x61c8dac, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x61c8ec0, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TypeCode, addr 0x61c8e08, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValueType, addr 0x61c8e64, size 0x5c, virtual true, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr Datatype_short();

public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_short", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_short(Datatype_short&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_short", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_short(Datatype_short const&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::Datatype_short) == 0x38, "Size mismatch!");
