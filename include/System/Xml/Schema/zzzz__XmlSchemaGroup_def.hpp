...
public:
  ...
  /// @brief Method Clone, addr 0x607cc48, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  /// @brief Method Clone, addr 0x6076c2c, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetQualifiedName, addr 0x607cc40, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x607cc50, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CanonicalParticle, addr 0x607cc00, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_CanonicalParticle();

  /// @brief Method get_Name, addr 0x607cbd8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameAttribute, addr 0x607cc30, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NameAttribute();

  /// @brief Method get_Particle, addr 0x607cbe8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaGroupBase* get_Particle();

  /// @brief Method get_QualifiedName, addr 0x607cbf8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_QualifiedName();

  /// @brief Method get_Redefined, addr 0x607cc10, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaGroup* get_Redefined();

  /// @brief Method get_SelfReferenceCount, addr 0x607cc20, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_SelfReferenceCount();

  /// @brief Method set_CanonicalParticle, addr 0x607cc08, size 0x8, virtual false, abstract: false, final false
  inline void set_CanonicalParticle(::System::Xml::Schema::XmlSchemaParticle* value);

  /// @brief Method set_Name, addr 0x607cbe0, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_NameAttribute, addr 0x607cc38, size 0x8, virtual true, abstract: false, final false
  inline void set_NameAttribute(::StringW value);

  /// @brief Method set_Particle, addr 0x607cbf0, size 0x8, virtual false, abstract: false, final false
  inline void set_Particle(::System::Xml::Schema::XmlSchemaGroupBase* value);

  /// @brief Method set_Redefined, addr 0x607cc18, size 0x8, virtual false, abstract: false, final false
  inline void set_Redefined(::System::Xml::Schema::XmlSchemaGroup* value);

  /// @brief Method set_SelfReferenceCount, addr 0x607cc28, size 0x8, virtual false, abstract: false, final false
