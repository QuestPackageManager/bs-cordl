...
public:
  ...
  /// @brief Method Clone, addr 0x60ef314, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObject* Clone();

  /// @brief Method Clone, addr 0x60e92f8, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetQualifiedName, addr 0x60ef30c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60ef31c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CanonicalParticle, addr 0x60ef2cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* get_CanonicalParticle();

  /// @brief Method get_Name, addr 0x60ef2a4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameAttribute, addr 0x60ef2fc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NameAttribute();

  /// @brief Method get_Particle, addr 0x60ef2b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaGroupBase* get_Particle();

  /// @brief Method get_QualifiedName, addr 0x60ef2c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* get_QualifiedName();

  /// @brief Method get_Redefined, addr 0x60ef2dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaGroup* get_Redefined();

  /// @brief Method get_SelfReferenceCount, addr 0x60ef2ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_SelfReferenceCount();

  /// @brief Method set_CanonicalParticle, addr 0x60ef2d4, size 0x8, virtual false, abstract: false, final false
  inline void set_CanonicalParticle(::System::Xml::Schema::XmlSchemaParticle* value);

  /// @brief Method set_Name, addr 0x60ef2ac, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_NameAttribute, addr 0x60ef304, size 0x8, virtual true, abstract: false, final false
  inline void set_NameAttribute(::StringW value);

  /// @brief Method set_Particle, addr 0x60ef2bc, size 0x8, virtual false, abstract: false, final false
  inline void set_Particle(::System::Xml::Schema::XmlSchemaGroupBase* value);

  /// @brief Method set_Redefined, addr 0x60ef2e4, size 0x8, virtual false, abstract: false, final false
  inline void set_Redefined(::System::Xml::Schema::XmlSchemaGroup* value);

  /// @brief Method set_SelfReferenceCount, addr 0x60ef2f4, size 0x8, virtual false, abstract: false, final false
