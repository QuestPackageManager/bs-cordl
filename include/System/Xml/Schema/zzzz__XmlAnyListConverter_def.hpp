...
public:
  ...
  /// @brief Method ChangeType, addr 0x2e67b24, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e67ab0, size 0x4, virtual false, abstract: false, final false
