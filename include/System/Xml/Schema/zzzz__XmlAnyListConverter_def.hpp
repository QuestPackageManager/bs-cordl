...
/// @brief Method ChangeType, addr 0x611fc08, size 0x228, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x611fb90, size 0x4, virtual false, abstract: false, final false
