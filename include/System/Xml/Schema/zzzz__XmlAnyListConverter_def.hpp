...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlAnyListConverter*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlAnyListConverter*, "System.Xml.Schema", "XmlAnyListConverter");
...
public:
  ...
  /// @brief Method ChangeType, addr 0x626051c, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62604a4, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlAnyListConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlAnyListConverter(XmlAnyListConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlAnyListConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlAnyListConverter(XmlAnyListConverterconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::XmlAnyListConverter) == 0x30, "Size mismatch!");
