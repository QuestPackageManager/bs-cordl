...
public:
  ...
  /// @brief Method ChangeType, addr 0x42f05f8, size 0x250, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42f0584, size 0x4, virtual false, abstract: false, final false
