...
public:
  ...
  /// @brief Method ChangeType, addr 0x42f4b0c, size 0x250, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42f4a98, size 0x4, virtual false, abstract: false, final false
