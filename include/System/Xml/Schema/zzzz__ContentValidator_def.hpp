...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ContentValidator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ContentValidator(ContentValidator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ContentValidator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ContentValidator(ContentValidatorconst&) = delete;
