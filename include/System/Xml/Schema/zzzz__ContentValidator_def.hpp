...
// Write type traits
MARK_REF_T(::System::Xml::Schema::ContentValidator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ContentValidator*, "System.Xml.Schema", "ContentValidator");
...
public:
  ...
  /// @brief Method AddParticleToExpected, addr 0x631a35c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method AddParticleToExpected, addr 0x631a3d0, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method CompleteValidation, addr 0x631a344, size 0x8, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method ExpectedElements, addr 0x631a34c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState* context, bool isRequiredOnly);

  /// @brief Method ExpectedParticles, addr 0x631a354, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x631a314, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x631a318, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631a2a4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaContentType contentType);

  /// @brief Method .ctor, addr 0x631a2b4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ContentType, addr 0x631a2c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType();

  /// @brief Method get_IsEmptiable, addr 0x631a2e0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsEmptiable();

  /// @brief Method get_IsOpen, addr 0x631a2e8, size 0x24, virtual false, abstract: false, final false
  inline bool get_IsOpen();

  /// @brief Method get_PreserveWhitespace, addr 0x631a2cc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsOpen, addr 0x631a30c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::ContentValidator) == 0x18, "Size mismatch!");
