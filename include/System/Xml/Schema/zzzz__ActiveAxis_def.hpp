...
public:
  ...
  /// @brief Method EndElement, addr 0x6317714, size 0x114, virtual true, abstract: false, final false
  inline bool EndElement(::StringW localname, ::StringW URN);

  /// @brief Method MoveToAttribute, addr 0x6317828, size 0x110, virtual false, abstract: false, final false
  inline bool MoveToAttribute(::StringW localname, ::StringW URN);

  /// @brief Method MoveToStartElement, addr 0x63175d0, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method Reactivate, addr 0x6317418, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631742c, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree);

  /// @brief Method get_CurrentDepth, addr 0x6317410, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ActiveAxis", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ActiveAxis(ActiveAxis&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ActiveAxis", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ActiveAxis(ActiveAxisconst&) = delete;
