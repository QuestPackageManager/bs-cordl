...
public:
  ...
  /// @brief Method EndElement, addr 0x6311efc, size 0x114, virtual true, abstract: false, final false
  inline bool EndElement(::StringW localname, ::StringW URN);

  /// @brief Method MoveToAttribute, addr 0x6312010, size 0x110, virtual false, abstract: false, final false
  inline bool MoveToAttribute(::StringW localname, ::StringW URN);

  /// @brief Method MoveToStartElement, addr 0x6311db8, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method Reactivate, addr 0x6311c00, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6311c14, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree);

  /// @brief Method get_CurrentDepth, addr 0x6311bf8, size 0x8, virtual false, abstract: false, final false
