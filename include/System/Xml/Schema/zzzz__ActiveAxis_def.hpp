...
public:
  ...
  /// @brief Method EndElement, addr 0x6162bbc, size 0x114, virtual true, abstract: false, final false
  inline bool EndElement(::StringW localname, ::StringW URN);

  /// @brief Method MoveToAttribute, addr 0x6162cd0, size 0x110, virtual false, abstract: false, final false
  inline bool MoveToAttribute(::StringW localname, ::StringW URN);

  /// @brief Method MoveToStartElement, addr 0x6162a78, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method Reactivate, addr 0x61628c0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61628d4, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree);

  /// @brief Method get_CurrentDepth, addr 0x61628b8, size 0x8, virtual false, abstract: false, final false
