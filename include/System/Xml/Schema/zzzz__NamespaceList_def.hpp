...
public:
  ...
  /// @brief Method Allows, addr 0x5fc1b24, size 0x80, virtual true, abstract: false, final false
  inline bool Allows(::StringW ns);

  /// @brief Method Allows, addr 0x5fc1ba4, size 0x1c, virtual false, abstract: false, final false
  inline bool Allows(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method Clone, addr 0x5fc1980, size 0x130, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::NamespaceList* Clone();

  /// @brief Method CompareSetToOther, addr 0x5fc2960, size 0x144, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::NamespaceList* CompareSetToOther(::System::Xml::Schema::NamespaceList* other);

  /// @brief Method Intersection, addr 0x5fc2aa4, size 0x51c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSubset, addr 0x5fc2080, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveNamespace, addr 0x5fc2fc0, size 0x60, virtual false, abstract: false, final false
  inline void RemoveNamespace(::StringW tns);

  /// @brief Method ToString, addr 0x5fc1bc0, size 0x4c0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Union, addr 0x5fc2424, size 0x53c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fc16f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5fc16f4, size 0x28c, virtual false, abstract: false, final false
  inline void _ctor(::StringW namespaces, ::StringW targetNamespace);

  /// @brief Method get_Enumerate, addr 0x5fc1ac0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Enumerate();

  /// @brief Method get_Excluded, addr 0x5fc1ab8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Excluded();

  /// @brief Method get_Type, addr 0x5fc1ab0, size 0x8, virtual false, abstract: false, final false
