...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(11596))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x28c6130, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Xml::Schema::NamespaceList* New_ctor(::StringW namespaces, ::StringW targetNamespace);

  /// @brief Method .ctor, addr 0x28c6138, size 0x2a0, virtual false, abstract: false, final false
  inline void _ctor(::StringW namespaces, ::StringW targetNamespace);

  /// @brief Method get_Type, addr 0x28c63d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::__NamespaceList__ListType get_Type();

  /// @brief Method get_Excluded, addr 0x28c63e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Excluded();

  /// @brief Method get_Enumerate, addr 0x28c63e8, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Enumerate();

  /// @brief Method Allows, addr 0x28c6454, size 0x84, virtual true, abstract: false, final false
  inline bool Allows(::StringW ns);

  /// @brief Method Allows, addr 0x28c64d8, size 0x20, virtual false, abstract: false, final false
  inline bool Allows(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method ToString, addr 0x28c64f8, size 0x4c8, virtual true, abstract: false, final false
