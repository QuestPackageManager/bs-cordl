...
public:
  ...
  /// @brief Method get_FacetsChecker addr 0x27407ec size 0x58 virtual true final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_TypeCode addr 0x2740844 size 0x8 virtual true final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  static inline ::System::Xml::Schema::Datatype_positiveInteger* New_ctor();

  /// @brief Method .ctor addr 0x274084c size 0x54 virtual false final false
  inline void _ctor();
