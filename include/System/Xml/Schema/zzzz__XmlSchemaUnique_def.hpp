...
public:
  ...
  /// @brief Method .ctor, addr 0x62319c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaUnique", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaUnique(XmlSchemaUnique&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaUnique", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaUnique(XmlSchemaUniqueconst&) = delete;
