...
public:
  ...
  /// @brief Method AddElement, addr 0x61b60e0, size 0x124, virtual false, abstract: false, final false
  inline bool AddElement(::System::Xml::XmlQualifiedName* name, ::System::Object* particle, bool isEmptiable);

  /// @brief Method CompleteValidation, addr 0x61b63d0, size 0x50, virtual true, abstract: false, final false
  inline bool CompleteValidation(::System::Xml::Schema::ValidationState* context);

  /// @brief Method ExpectedElements, addr 0x61b6420, size 0x3bc, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState* context, bool isRequiredOnly);

  /// @brief Method ExpectedParticles, addr 0x61b67dc, size 0x46c, virtual true, abstract: false, final false
  ...
  /// @brief Method InitValidation, addr 0x61b6224, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateElement, addr 0x61b62c0, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61b5fcc, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XmlSchemaContentType contentType, int32_t size, bool isEmptiable);

  /// @brief Method get_IsEmptiable, addr 0x61b6204, size 0x20, virtual true, abstract: false, final false
