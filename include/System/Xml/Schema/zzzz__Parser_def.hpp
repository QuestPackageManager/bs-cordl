...
public:
  ...
  /// @brief Method CheckSchemaRoot, addr 0x426df24, size 0x100, virtual false, abstract: false, final false
  inline bool CheckSchemaRoot(::System::Xml::Schema::SchemaType rootType, ::ByRef<::StringW> code);

  /// @brief Method CreateXmlNsAttribute, addr 0x426e7b0, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateXmlNsAttribute(::StringW prefix, ::StringW value);

  /// @brief Method FinishParsing, addr 0x426e024, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaType FinishParsing();

  /// @brief Method LoadAttributeNode, addr 0x426e63c, size 0x174, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* LoadAttributeNode();

  /// @brief Method LoadElementNode, addr 0x426e264, size 0x3d8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* LoadElementNode(bool root);

  /// @brief Method LoadEntityReferenceInAttribute, addr 0x426e8cc, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x426d4a8, size 0x50, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaType Parse(::System::Xml::XmlReader* reader, ::StringW targetNamespace);

  /// @brief Method ParseReaderNode, addr 0x426d8a8, size 0x67c, virtual false, abstract: false, final false
  inline bool ParseReaderNode();

  /// @brief Method ProcessAppInfoDocMarkup, addr 0x426e044, size 0x220, virtual false, abstract: false, final false
  inline void ProcessAppInfoDocMarkup(bool root);

  /// @brief Method StartParsing, addr 0x426d4f8, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x426d3f8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_XdrSchema, addr 0x426e03c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* get_XdrSchema();

  /// @brief Method get_XmlSchema, addr 0x426e02c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* get_XmlSchema();

  /// @brief Method set_XmlResolver, addr 0x426e034, size 0x8, virtual false, abstract: false, final false
