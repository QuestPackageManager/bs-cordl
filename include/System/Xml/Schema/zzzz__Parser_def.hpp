...
/// @brief Method CheckSchemaRoot, addr 0x602bdc4, size 0x120, virtual false, abstract: false, final false
inline bool CheckSchemaRoot(::System::Xml::Schema::SchemaType  rootType, ::ByRef<::StringW>  code) ;

/// @brief Method CreateXmlNsAttribute, addr 0x602c6b4, size 0x118, virtual false, abstract: false, final false
inline ::System::Xml::XmlAttribute* CreateXmlNsAttribute(::StringW  prefix, ::StringW  value) ;

/// @brief Method FinishParsing, addr 0x602bee4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaType FinishParsing() ;

/// @brief Method LoadAttributeNode, addr 0x602c548, size 0x16c, virtual false, abstract: false, final false
inline ::System::Xml::XmlAttribute* LoadAttributeNode() ;

/// @brief Method LoadElementNode, addr 0x602c170, size 0x3d8, virtual false, abstract: false, final false
inline ::System::Xml::XmlElement* LoadElementNode(bool  root) ;

/// @brief Method LoadEntityReferenceInAttribute, addr 0x602c7cc, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x602b34c, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaType Parse(::System::Xml::XmlReader*  reader, ::StringW  targetNamespace) ;

/// @brief Method ParseReaderNode, addr 0x602b75c, size 0x668, virtual false, abstract: false, final false
inline bool ParseReaderNode() ;

/// @brief Method ProcessAppInfoDocMarkup, addr 0x602bf04, size 0x26c, virtual false, abstract: false, final false
inline void ProcessAppInfoDocMarkup(bool  root) ;

/// @brief Method StartParsing, addr 0x602b39c, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x602b2a4, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method get_XdrSchema, addr 0x602befc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_XdrSchema() ;

/// @brief Method get_XmlSchema, addr 0x602beec, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* get_XmlSchema() ;

/// @brief Method set_XmlResolver, addr 0x602bef4, size 0x8, virtual false, abstract: false, final false
