...
public:
  ...
  /// @brief Method .ctor, addr 0x28af9c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Xml::Schema::BitSet* New_ctor(int32_t count);

  /// @brief Method .ctor, addr 0x28af9c8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(int32_t count);

  /// @brief Method get_Count, addr 0x28afa40, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x28afa48, size 0x4, virtual false, abstract: false, final false
  inline bool get_Item(int32_t index);

  /// @brief Method Clear, addr 0x28afaa8, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Set, addr 0x28afafc, size 0x5c, virtual false, abstract: false, final false
  inline void Set(int32_t index);

  /// @brief Method Get, addr 0x28afa4c, size 0x5c, virtual false, abstract: false, final false
  inline bool Get(int32_t index);

  /// @brief Method NextSet, addr 0x28afbec, size 0x9c, virtual false, abstract: false, final false
  inline int32_t NextSet(int32_t startFrom);

  /// @brief Method And, addr 0x28afc88, size 0xb8, virtual false, abstract: false, final false
  inline void And(::System::Xml::Schema::BitSet* other);

  /// @brief Method Or, addr 0x28afd40, size 0xa4, virtual false, abstract: false, final false
  inline void Or(::System::Xml::Schema::BitSet* other);

  /// @brief Method GetHashCode, addr 0x28afde4, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Equals, addr 0x28afe1c, size 0x148, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Clone, addr 0x28aff64, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::BitSet* Clone();

  /// @brief Method Intersects, addr 0x28b0038, size 0xe0, virtual false, abstract: false, final false
  inline bool Intersects(::System::Xml::Schema::BitSet* other);

  /// @brief Method Subscript, addr 0x28afa38, size 0x8, virtual false, abstract: false, final false
  inline int32_t Subscript(int32_t bitIndex);

  /// @brief Method EnsureLength, addr 0x28afb58, size 0x94, virtual false, abstract: false, final false
