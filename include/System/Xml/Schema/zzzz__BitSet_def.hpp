...
public:
  ...
  /// @brief Method And, addr 0x439c808, size 0xbc, virtual false, abstract: false, final false
  inline void And(::System::Xml::Schema::BitSet* other);

  /// @brief Method Clear, addr 0x439c62c, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x439cafc, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::BitSet* Clone();

  /// @brief Method EnsureLength, addr 0x439c6dc, size 0x94, virtual false, abstract: false, final false
  inline void EnsureLength(int32_t nRequiredLength);

  /// @brief Method Equals, addr 0x439c9a0, size 0x15c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Get, addr 0x439c5dc, size 0x50, virtual false, abstract: false, final false
  inline bool Get(int32_t index);

  /// @brief Method GetHashCode, addr 0x439c968, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Intersects, addr 0x439cc38, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method NextSet, addr 0x439c770, size 0x98, virtual false, abstract: false, final false
  inline int32_t NextSet(int32_t startFrom);

  /// @brief Method Or, addr 0x439c8c4, size 0xa4, virtual false, abstract: false, final false
  inline void Or(::System::Xml::Schema::BitSet* other);

  /// @brief Method Set, addr 0x439c680, size 0x5c, virtual false, abstract: false, final false
  inline void Set(int32_t index);

  /// @brief Method Subscript, addr 0x439c5c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x439c550, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x439c558, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(int32_t count);

  /// @brief Method get_Count, addr 0x439c5d0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsEmpty, addr 0x439cbd0, size 0x68, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Item, addr 0x439c5d8, size 0x4, virtual false, abstract: false, final false
