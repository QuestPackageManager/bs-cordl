...
public:
  ...
  /// @brief Method get_TypeCode addr 0x273d7a0 size 0x8 virtual true final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_TokenizedType addr 0x273d7a8 size 0x8 virtual true final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  static inline ::System::Xml::Schema::Datatype_ID* New_ctor();

  /// @brief Method .ctor addr 0x273d7b0 size 0x4 virtual false final false
  inline void _ctor();
