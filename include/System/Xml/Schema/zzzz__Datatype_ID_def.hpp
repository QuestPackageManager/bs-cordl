...
public:
  ...
  /// @brief Method get_TypeCode, addr 0x28bde2c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_TokenizedType, addr 0x28bde34, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlTokenizedType get_TokenizedType();

  static inline ::System::Xml::Schema::Datatype_ID* New_ctor();

  /// @brief Method .ctor, addr 0x28bde3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
