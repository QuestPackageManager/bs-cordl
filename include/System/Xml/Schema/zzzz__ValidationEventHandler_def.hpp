...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x42a7c54, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42a7b50, size 0x104, virtual false, abstract: false, final false
