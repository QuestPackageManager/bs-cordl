...
public:
  ...
  /// @brief Method .ctor, addr 0x61d91d8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x61d9240, size 0x4b0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Fields, addr 0x61d91d0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::Schema::Asttree*, ::Array<::System::Xml::Schema::Asttree*>*> get_Fields();

  /// @brief Method get_Role, addr 0x61d91c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::CompiledIdentityConstraint_ConstraintRole get_Role();

  /// @brief Method get_Selector, addr 0x61d91c8, size 0x8, virtual false, abstract: false, final false
