...
public:
  ...
  /// @brief Method .ctor, addr 0x43a5f10, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x43a5f7c, size 0x494, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Fields, addr 0x43a5f08, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::Schema::Asttree*, ::Array<::System::Xml::Schema::Asttree*>*> get_Fields();

  /// @brief Method get_Role, addr 0x43a5ef8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::CompiledIdentityConstraint_ConstraintRole get_Role();

  /// @brief Method get_Selector, addr 0x43a5f00, size 0x8, virtual false, abstract: false, final false
