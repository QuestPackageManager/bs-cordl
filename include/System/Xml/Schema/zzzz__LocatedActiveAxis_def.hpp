...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocatedActiveAxis", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocatedActiveAxis(LocatedActiveAxis&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocatedActiveAxis", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocatedActiveAxis(LocatedActiveAxisconst&) = delete;
