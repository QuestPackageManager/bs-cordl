...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_decimal", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_decimal(Datatype_decimal&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_decimal", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_decimal(Datatype_decimalconst&) = delete;
