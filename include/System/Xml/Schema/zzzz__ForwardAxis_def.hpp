...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ForwardAxis", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ForwardAxis(ForwardAxis&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ForwardAxis", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ForwardAxis(ForwardAxisconst&) = delete;
