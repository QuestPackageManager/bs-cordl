...
public:
  ...
  /// @brief Method ParseValue, addr 0x2a09cf0, size 0x27c, virtual true, abstract: false, final false
  inline ::System::Object* ParseValue(::StringW s, ::System::Xml::XmlNameTable* nameTable, ::System::Xml::IXmlNamespaceResolver* nsmgr);

  /// @brief Method .ctor, addr 0x2a09f78, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
