...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11528))]
...
public:
  // Declarations
  /// @brief Method ParseValue, addr 0x28c103c, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28c12c4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
