...
public:
  ...
  /// @brief Method ParseValue, addr 0x43b088c, size 0x1e8, virtual true, abstract: false, final false
  inline ::System::Object* ParseValue(::StringW s, ::System::Xml::XmlNameTable* nameTable, ::System::Xml::IXmlNamespaceResolver* nsmgr);

  /// @brief Method .ctor, addr 0x43a5654, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
