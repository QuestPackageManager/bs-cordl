...
/// @brief Method EndElement, addr 0x61db544, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method PopKS, addr 0x61db94c, size 0xa4, virtual false, abstract: false, final false
inline ::System::Xml::Schema::KeySequence* PopKS() ;

/// @brief Method PushKS, addr 0x61db58c, size 0x2dc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61db3d0, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::Asttree*  axisTree, ::System::Xml::Schema::ConstraintStruct*  cs) ;

/// @brief Method get_lastDepth, addr 0x61db498, size 0xac, virtual false, abstract: false, final false
