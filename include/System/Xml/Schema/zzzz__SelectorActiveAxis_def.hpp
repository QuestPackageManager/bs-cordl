...
public:
  ...
  /// @brief Method EndElement, addr 0x439429c, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method PopKS, addr 0x43946b4, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::KeySequence* PopKS();

  /// @brief Method PushKS, addr 0x43942e4, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4394130, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree, ::System::Xml::Schema::ConstraintStruct* cs);

  /// @brief Method get_lastDepth, addr 0x43941f4, size 0xa8, virtual false, abstract: false, final false
