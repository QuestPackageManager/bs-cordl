...
// Write type traits
MARK_REF_T(::System::Xml::Schema::SelectorActiveAxis*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SelectorActiveAxis*, "System.Xml.Schema", "SelectorActiveAxis");
...
public:
  ...
  /// @brief Method EndElement, addr 0x631be58, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method PopKS, addr 0x631c260, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::KeySequence* PopKS();

  /// @brief Method PushKS, addr 0x631bea0, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x631bce4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree, ::System::Xml::Schema::ConstraintStruct* cs);

  /// @brief Method get_lastDepth, addr 0x631bdac, size 0xac, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SelectorActiveAxis", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SelectorActiveAxis(SelectorActiveAxis&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SelectorActiveAxis", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SelectorActiveAxis(SelectorActiveAxisconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::SelectorActiveAxis) == 0x40, "Size mismatch!");
