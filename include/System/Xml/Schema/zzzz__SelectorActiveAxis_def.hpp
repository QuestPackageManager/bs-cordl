...
public:
  ...
  /// @brief Method EndElement, addr 0x2df60c8, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method PopKS, addr 0x2df64e0, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::KeySequence* PopKS();

  /// @brief Method PushKS, addr 0x2df6110, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2df5f54, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::Asttree* axisTree, ::System::Xml::Schema::ConstraintStruct* cs);

  /// @brief Method get_lastDepth, addr 0x2df6020, size 0xa8, virtual false, abstract: false, final false
