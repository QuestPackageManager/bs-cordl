...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaCollectionEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaCollectionEnumerator*, "System.Xml.Schema", "XmlSchemaCollectionEnumerator");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x622d8c4, size 0xa4, virtual false, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Xml::Schema::XmlSchemaCollectionEnumerator* New_ctor(::System::Collections::Hashtable* collection);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x622dd94, size 0xa4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x622dcec, size 0xa8, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x622de38, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x622d630, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* collection);

  /// @brief Method get_Current, addr 0x622d7e4, size 0xe0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchema* get_Current();

  /// @brief Method get_CurrentNode, addr 0x622de3c, size 0xdc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaCollectionEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaCollectionEnumerator(XmlSchemaCollectionEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaCollectionEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaCollectionEnumerator(XmlSchemaCollectionEnumeratorconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaCollectionEnumerator) == 0x18, "Size mismatch!");
