...
public:
  ...
  /// @brief Method SetItems, addr 0x42b96b4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42b96bc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x42b9674, size 0x40, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Items, addr 0x42b966c, size 0x8, virtual true, abstract: false, final false
