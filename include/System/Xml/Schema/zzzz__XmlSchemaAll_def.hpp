...
public:
  ...
  /// @brief Method SetItems, addr 0x622bd48, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x622bd50, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x622bcf8, size 0x50, virtual true, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Items, addr 0x622bcf0, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaAll", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaAll(XmlSchemaAll&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaAll", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaAll(XmlSchemaAllconst&) = delete;
