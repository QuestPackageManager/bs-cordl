...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_token", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Datatype_token(Datatype_token&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Datatype_token", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Datatype_token(Datatype_tokenconst&) = delete;
