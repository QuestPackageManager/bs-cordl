...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11550))]
...
public:
  ...
  /// @brief Method get_TypeCode, addr 0x28bdcd8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_BuiltInWhitespaceFacet, addr 0x28bdce0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet();

  static inline ::System::Xml::Schema::Datatype_token* New_ctor();

  /// @brief Method .ctor, addr 0x28bdce8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
