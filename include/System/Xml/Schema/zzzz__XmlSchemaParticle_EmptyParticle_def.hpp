...
public:
  ...
  /// @brief Method .ctor, addr 0x42c1cb4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x42c1d08, size 0x8, virtual true, abstract: false, final false
