...
public:
  ...
  /// @brief Method .ctor, addr 0x622e9c8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x622ea20, size 0x8, virtual true, abstract: false, final false
