...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMaxInclusiveFacet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSchemaMaxInclusiveFacet(XmlSchemaMaxInclusiveFacet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSchemaMaxInclusiveFacet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSchemaMaxInclusiveFacet(XmlSchemaMaxInclusiveFacetconst&) = delete;
