...
public:
  ...
  /// @brief Method Compare, addr 0x61c45ec, size 0x54, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  static inline ::System::Xml::Schema::Datatype_unsignedShort* New_ctor();

  /// @brief Method TryParseValue, addr 0x61c46f8, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61bad64, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FacetsChecker, addr 0x61c4588, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x61c469c, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TypeCode, addr 0x61c45e4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValueType, addr 0x61c4640, size 0x5c, virtual true, abstract: false, final false
