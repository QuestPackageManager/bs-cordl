...
public:
  ...
  /// @brief Method get_TypeCode, addr 0x28bc834, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  static inline ::System::Xml::Schema::Datatype_month* New_ctor();

  /// @brief Method .ctor, addr 0x28bc83c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
