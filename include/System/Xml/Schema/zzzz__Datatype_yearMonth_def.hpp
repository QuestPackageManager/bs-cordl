...
public:
  ...
  /// @brief Method .ctor, addr 0x600bb28, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x6011c34, size 0x8, virtual true, abstract: false, final false
