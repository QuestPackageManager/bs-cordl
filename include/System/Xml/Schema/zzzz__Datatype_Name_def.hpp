...
public:
  ...
  /// @brief Method .ctor, addr 0x2f327cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x2f3a3fc, size 0x8, virtual true, abstract: false, final false
