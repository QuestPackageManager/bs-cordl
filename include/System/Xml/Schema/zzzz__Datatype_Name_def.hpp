...
public:
  ...
  /// @brief Method .ctor, addr 0x61c011c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x61c7b64, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Datatype_Name", modifiers: "&&", def_value: None, comment: None }]
