...
public:
  ...
  /// @brief Method .ctor, addr 0x5fa3a38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeCode, addr 0x5fab480, size 0x8, virtual true, abstract: false, final false
