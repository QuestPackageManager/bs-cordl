...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaValidity, "System.Xml.Schema", "XmlSchemaValidity");
// Dependencies
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaValidity) == 0x4, "Size mismatch!");
