...
// Write type traits
MARK_REF_T(::System::Xml::Schema::IdRefNode*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::IdRefNode*, "System.Xml.Schema", "IdRefNode");
...
public:
  ...
  /// @brief Method .ctor, addr 0x623ce80, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IdRefNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IdRefNode(IdRefNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IdRefNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IdRefNode(IdRefNodeconst&) = delete;
...
static_assert(sizeof(::System::Xml::Schema::IdRefNode) == 0x28, "Size mismatch!");
