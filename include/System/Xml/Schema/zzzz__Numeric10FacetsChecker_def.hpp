...
public:
  ...
  /// @brief Method CheckTotalAndFractionDigits, addr 0x60169c4, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckValueFacets, addr 0x601d568, size 0x614, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(::System::Decimal value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method CheckValueFacets, addr 0x601d4f8, size 0x70, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(::System::Object* value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method CheckValueFacets, addr 0x601dda8, size 0x84, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(int16_t value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method CheckValueFacets, addr 0x601dd28, size 0x80, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(int32_t value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method CheckValueFacets, addr 0x601dca4, size 0x84, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(int64_t value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method MatchEnumeration, addr 0x601db7c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchEnumeration, addr 0x601de2c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6010d30, size 0xc, virtual false, abstract: false, final false
