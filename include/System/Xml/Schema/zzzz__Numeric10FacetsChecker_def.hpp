...
public:
  ...
  /// @brief Method CheckTotalAndFractionDigits, addr 0x6089090, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckValueFacets, addr 0x608fc34, size 0x614, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(::System::Decimal value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method CheckValueFacets, addr 0x608fbc4, size 0x70, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(::System::Object* value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method CheckValueFacets, addr 0x6090474, size 0x84, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(int16_t value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method CheckValueFacets, addr 0x60903f4, size 0x80, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(int32_t value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method CheckValueFacets, addr 0x6090370, size 0x84, virtual true, abstract: false, final false
  inline ::System::Exception* CheckValueFacets(int64_t value, ::System::Xml::Schema::XmlSchemaDatatype* datatype);

  /// @brief Method MatchEnumeration, addr 0x6090248, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchEnumeration, addr 0x60904f8, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60833fc, size 0xc, virtual false, abstract: false, final false
