...
public:
  ...
  /// @brief Method Compare, addr 0x2e0a1a4, size 0x108, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  /// @brief Method CreateValueConverter, addr 0x2e0a010, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method TryParseValue, addr 0x2e0a2ac, size 0x324, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e0a07c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BuiltInWhitespaceFacet, addr 0x2e0a194, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet();

  /// @brief Method get_FacetsChecker, addr 0x2e0a01c, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x2e0a13c, size 0x58, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TypeCode, addr 0x2e0a074, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValidRestrictionFlags, addr 0x2e0a19c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::RestrictionFlags get_ValidRestrictionFlags();

  /// @brief Method get_ValueType, addr 0x2e0a0e4, size 0x58, virtual true, abstract: false, final false
