...
public:
  ...
  /// @brief Method Compare, addr 0x2e0c1a0, size 0x108, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  /// @brief Method CreateValueConverter, addr 0x2e0c00c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method TryParseValue, addr 0x2e0c2a8, size 0x324, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e0c078, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BuiltInWhitespaceFacet, addr 0x2e0c190, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet();

  /// @brief Method get_FacetsChecker, addr 0x2e0c018, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x2e0c138, size 0x58, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TypeCode, addr 0x2e0c070, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValidRestrictionFlags, addr 0x2e0c198, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::RestrictionFlags get_ValidRestrictionFlags();

  /// @brief Method get_ValueType, addr 0x2e0c0e0, size 0x58, virtual true, abstract: false, final false
