...
public:
  ...
  /// @brief Method Compare, addr 0x4334af0, size 0x148, virtual true, abstract: false, final false
  inline int32_t Compare(::System::Object* value1, ::System::Object* value2);

  /// @brief Method CreateValueConverter, addr 0x433495c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method TryParseValue, addr 0x4334c38, size 0x320, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43349c8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BuiltInWhitespaceFacet, addr 0x4334ae0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet();

  /// @brief Method get_FacetsChecker, addr 0x4334968, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker();

  /// @brief Method get_ListValueType, addr 0x4334a88, size 0x58, virtual true, abstract: false, final false
  inline ::System::Type* get_ListValueType();

  /// @brief Method get_TypeCode, addr 0x43349c0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::XmlTypeCode get_TypeCode();

  /// @brief Method get_ValidRestrictionFlags, addr 0x4334ae8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::RestrictionFlags get_ValidRestrictionFlags();

  /// @brief Method get_ValueType, addr 0x4334a30, size 0x58, virtual true, abstract: false, final false
