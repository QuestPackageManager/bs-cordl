...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaDatatypeVariety, "System.Xml.Schema", "XmlSchemaDatatypeVariety");
// Dependencies
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaDatatypeVariety) == 0x4, "Size mismatch!");
