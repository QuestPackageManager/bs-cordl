...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InteriorNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InteriorNode(InteriorNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InteriorNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InteriorNode(InteriorNodeconst&) = delete;
