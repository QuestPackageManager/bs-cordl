...
public:
  ...
  /// @brief Method ExpandTree, addr 0x43252cc, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method ExpandTreeNoRecursive, addr 0x43250e4, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4325330, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LeftChild, addr 0x43250c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SyntaxTreeNode* get_LeftChild();

  /// @brief Method get_RightChild, addr 0x43250d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SyntaxTreeNode* get_RightChild();

  /// @brief Method set_LeftChild, addr 0x43250cc, size 0x8, virtual false, abstract: false, final false
  inline void set_LeftChild(::System::Xml::Schema::SyntaxTreeNode* value);

  /// @brief Method set_RightChild, addr 0x43250dc, size 0x8, virtual false, abstract: false, final false
