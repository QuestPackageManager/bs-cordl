...
public:
  ...
  /// @brief Method ExpandTree, addr 0x2dfb5bc, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method ExpandTreeNoRecursive, addr 0x2dfb3dc, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dfb620, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LeftChild, addr 0x2dfb3bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SyntaxTreeNode* get_LeftChild();

  /// @brief Method get_RightChild, addr 0x2dfb3cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SyntaxTreeNode* get_RightChild();

  /// @brief Method set_LeftChild, addr 0x2dfb3c4, size 0x8, virtual false, abstract: false, final false
  inline void set_LeftChild(::System::Xml::Schema::SyntaxTreeNode* value);

  /// @brief Method set_RightChild, addr 0x2dfb3d4, size 0x8, virtual false, abstract: false, final false
