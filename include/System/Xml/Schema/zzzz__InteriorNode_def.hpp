...
/// @brief Method ExpandTree, addr 0x616ac30, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method ExpandTreeNoRecursive, addr 0x616aa44, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x616ac94, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_LeftChild, addr 0x616aa24, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SyntaxTreeNode* get_LeftChild() ;

/// @brief Method get_RightChild, addr 0x616aa34, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SyntaxTreeNode* get_RightChild() ;

/// @brief Method set_LeftChild, addr 0x616aa2c, size 0x8, virtual false, abstract: false, final false
inline void set_LeftChild(::System::Xml::Schema::SyntaxTreeNode*  value) ;

/// @brief Method set_RightChild, addr 0x616aa3c, size 0x8, virtual false, abstract: false, final false
