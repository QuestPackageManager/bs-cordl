...
public:
  ...
  /// @brief Method Parse, addr 0x42fcd68, size 0xb44, virtual false, abstract: false, final false
  inline bool Parse(::StringW text, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method Parse2Dig, addr 0x42fff94, size 0xa8, virtual false, abstract: false, final false
  inline bool Parse2Dig(int32_t start, ::ByRef<int32_t> num);

  /// @brief Method Parse4Dig, addr 0x42ffe6c, size 0x128, virtual false, abstract: false, final false
  inline bool Parse4Dig(int32_t start, ::ByRef<int32_t> num);

  /// @brief Method ParseChar, addr 0x42ffa84, size 0x44, virtual false, abstract: false, final false
  inline bool ParseChar(int32_t start, char16_t ch);

  /// @brief Method ParseDate, addr 0x42ff868, size 0x21c, virtual false, abstract: false, final false
  inline bool ParseDate(int32_t start);

  /// @brief Method ParseTime, addr 0x430003c, size 0x378, virtual false, abstract: false, final false
  inline bool ParseTime(::ByRef<int32_t> start);

  /// @brief Method ParseTimeAndWhitespace, addr 0x42ffdd0, size 0x9c, virtual false, abstract: false, final false
  inline bool ParseTimeAndWhitespace(int32_t start);

  /// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x42ffac8, size 0x9c, virtual false, abstract: false, final false
  inline bool ParseTimeAndZoneAndWhitespace(int32_t start);

  /// @brief Method ParseZoneAndWhitespace, addr 0x42ffb64, size 0x26c, virtual false, abstract: false, final false
  inline bool ParseZoneAndWhitespace(int32_t start);

  /// @brief Method Test, addr 0x42ff85c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InitiateXsdDateTime, addr 0x42fd8ac, size 0xbc, virtual false, abstract: false, final false
  inline void InitiateXsdDateTime(::System::Xml::Schema::XsdDateTime_Parser parser);

  /// @brief Method IntToCharArray, addr 0x42ff23c, size 0x68, virtual false, abstract: false, final false
  inline void IntToCharArray(::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t start, int32_t value, int32_t digits);

  /// @brief Method PrintDate, addr 0x42feea4, size 0x144, virtual false, abstract: false, final false
  inline void PrintDate(::System::Text::StringBuilder* sb);

  /// @brief Method PrintTime, addr 0x42fefe8, size 0x254, virtual false, abstract: false, final false
  inline void PrintTime(::System::Text::StringBuilder* sb);

  /// @brief Method PrintZone, addr 0x42ff30c, size 0x1a0, virtual false, abstract: false, final false
  inline void PrintZone(::System::Text::StringBuilder* sb);

  /// @brief Method ShortToCharArray, addr 0x42ff2a4, size 0x68, virtual false, abstract: false, final false
  inline void ShortToCharArray(::ArrayW<char16_t, ::Array<char16_t>*> text, int32_t start, int32_t value);

  /// @brief Method ToString, addr 0x42fea60, size 0x444, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x42fd9fc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42fdabc, size 0x1c4, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dateTime, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method .ctor, addr 0x42fdc80, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTimeOffset dateTimeOffset);

  /// @brief Method .ctor, addr 0x42fdcf0, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTimeOffset dateTimeOffset, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method .ctor, addr 0x42fd968, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XsdDateTime_Parser parser);

  /// @brief Method .ctor, addr 0x42fcbc0, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Day, addr 0x42fdf40, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_Day();

  /// @brief Method get_Fraction, addr 0x42fe0a0, size 0x118, virtual false, abstract: false, final false
  inline int32_t get_Fraction();

  /// @brief Method get_Hour, addr 0x42fdf98, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_Hour();

  /// @brief Method get_InternalKind, addr 0x42fde88, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XsdDateTime_XsdDateTimeKind get_InternalKind();

  /// @brief Method get_InternalTypeCode, addr 0x42fde80, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XsdDateTime_DateTimeTypeCode get_InternalTypeCode();

  /// @brief Method get_Minute, addr 0x42fdff0, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_Minute();

  /// @brief Method get_Month, addr 0x42fdee8, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_Month();

  /// @brief Method get_Second, addr 0x42fe048, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_Second();

  /// @brief Method get_Year, addr 0x42fde90, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_Year();

  /// @brief Method get_ZoneHour, addr 0x42fe1b8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ZoneHour();

  /// @brief Method get_ZoneMinute, addr 0x42fe1c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ZoneMinute();

  /// @brief Method op_Implicit, addr 0x42fe1c8, size 0x53c, virtual false, abstract: false, final false
  static inline ::System::DateTime op_Implicit___System__DateTime(::System::Xml::Schema::XsdDateTime xdt);

  /// @brief Method op_Implicit, addr 0x42fe704, size 0x35c, virtual false, abstract: false, final false
