...
public:
  ...
  /// @brief Method Parse, addr 0x626ca84, size 0xb0c, virtual false, abstract: false, final false
  inline bool Parse(::StringW text, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method Parse2Dig, addr 0x626fdf0, size 0x90, virtual false, abstract: false, final false
  inline bool Parse2Dig(int32_t start, ::by_ref<int32_t> num);

  /// @brief Method Parse4Dig, addr 0x626fd14, size 0xdc, virtual false, abstract: false, final false
  inline bool Parse4Dig(int32_t start, ::by_ref<int32_t> num);

  /// @brief Method ParseChar, addr 0x626f934, size 0x54, virtual false, abstract: false, final false
  inline bool ParseChar(int32_t start, char16_t ch);

  /// @brief Method ParseDate, addr 0x626f724, size 0x210, virtual false, abstract: false, final false
  inline bool ParseDate(int32_t start);

  /// @brief Method ParseTime, addr 0x626fe80, size 0x378, virtual false, abstract: false, final false
  inline bool ParseTime(::by_ref<int32_t> start);

  /// @brief Method ParseTimeAndWhitespace, addr 0x626fc8c, size 0x88, virtual false, abstract: false, final false
  inline bool ParseTimeAndWhitespace(int32_t start);

  /// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x626f988, size 0xa0, virtual false, abstract: false, final false
  inline bool ParseTimeAndZoneAndWhitespace(int32_t start);

  /// @brief Method ParseZoneAndWhitespace, addr 0x626fa28, size 0x264, virtual false, abstract: false, final false
  inline bool ParseZoneAndWhitespace(int32_t start);

  /// @brief Method Test, addr 0x626f718, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InitiateXsdDateTime, addr 0x626d590, size 0xc0, virtual false, abstract: false, final false
  inline void InitiateXsdDateTime(::System::Xml::Schema::XsdDateTime_Parser parser);

  /// @brief Method IntToCharArray, addr 0x626f08c, size 0x68, virtual false, abstract: false, final false
  inline void IntToCharArray(::ArrayW<char16_t> text, int32_t start, int32_t value, int32_t digits);

  /// @brief Method PrintDate, addr 0x626ece8, size 0x14c, virtual false, abstract: false, final false
  inline void PrintDate(::System::Text::StringBuilder* sb);

  /// @brief Method PrintTime, addr 0x626ee34, size 0x258, virtual false, abstract: false, final false
  inline void PrintTime(::System::Text::StringBuilder* sb);

  /// @brief Method PrintZone, addr 0x626f15c, size 0x1a8, virtual false, abstract: false, final false
  inline void PrintZone(::System::Text::StringBuilder* sb);

  /// @brief Method ShortToCharArray, addr 0x626f0f4, size 0x68, virtual false, abstract: false, final false
  inline void ShortToCharArray(::ArrayW<char16_t> text, int32_t start, int32_t value);

  /// @brief Method ToString, addr 0x626e87c, size 0x46c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x626d6d8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x626d79c, size 0x264, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dateTime, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method .ctor, addr 0x626da00, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTimeOffset dateTimeOffset);

  /// @brief Method .ctor, addr 0x626da74, size 0x228, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTimeOffset dateTimeOffset, ::System::Xml::Schema::XsdDateTimeFlags kinds);

  /// @brief Method .ctor, addr 0x626d650, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Schema::XsdDateTime_Parser parser);

  /// @brief Method .ctor, addr 0x626c8ec, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Day, addr 0x626dd64, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_Day();

  /// @brief Method get_Fraction, addr 0x626ded4, size 0x118, virtual false, abstract: false, final false
  inline int32_t get_Fraction();

  /// @brief Method get_Hour, addr 0x626ddc0, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_Hour();

  /// @brief Method get_InternalKind, addr 0x626dca4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XsdDateTime_XsdDateTimeKind get_InternalKind();

  /// @brief Method get_InternalTypeCode, addr 0x626dc9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XsdDateTime_DateTimeTypeCode get_InternalTypeCode();

  /// @brief Method get_Minute, addr 0x626de1c, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_Minute();

  /// @brief Method get_Month, addr 0x626dd08, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_Month();

  /// @brief Method get_Second, addr 0x626de78, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_Second();

  /// @brief Method get_Year, addr 0x626dcac, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_Year();

  /// @brief Method get_ZoneHour, addr 0x626dfec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ZoneHour();

  /// @brief Method get_ZoneMinute, addr 0x626dff4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ZoneMinute();

  /// @brief Method op_Implicit, addr 0x626dffc, size 0x530, virtual false, abstract: false, final false
  static inline ::System::DateTime op_Implicit___System__DateTime(::System::Xml::Schema::XsdDateTime xdt);

  /// @brief Method op_Implicit, addr 0x626e52c, size 0x350, virtual false, abstract: false, final false
