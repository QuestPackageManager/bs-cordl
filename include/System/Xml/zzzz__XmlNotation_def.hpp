...
/// @brief Method CloneNode, addr 0x61185c0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method WriteContentTo, addr 0x611866c, size 0x4, virtual true, abstract: false, final false
inline void WriteContentTo(::System::Xml::XmlWriter*  w) ;

/// @brief Method WriteTo, addr 0x6118668, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x611853c, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  publicId, ::StringW  systemId, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_IsReadOnly, addr 0x6118610, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_LocalName, addr 0x61185b0, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x61185a8, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NodeType, addr 0x61185b8, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method set_InnerXml, addr 0x6118618, size 0x50, virtual true, abstract: false, final false
