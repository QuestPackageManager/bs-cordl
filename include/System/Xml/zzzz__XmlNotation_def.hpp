...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlNotation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlNotation(XmlNotation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlNotation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlNotation(XmlNotationconst&) = delete;
