...
public:
  ...
  /// @brief Method CloneNode, addr 0x6117f00, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteContentTo, addr 0x6117fac, size 0x4, virtual true, abstract: false, final false
  inline void WriteContentTo(::System::Xml::XmlWriter* w);

  /// @brief Method WriteTo, addr 0x6117fa8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6117e7c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW publicId, ::StringW systemId, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_IsReadOnly, addr 0x6117f50, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_LocalName, addr 0x6117ef0, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x6117ee8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0x6117ef8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method set_InnerXml, addr 0x6117f58, size 0x50, virtual true, abstract: false, final false
