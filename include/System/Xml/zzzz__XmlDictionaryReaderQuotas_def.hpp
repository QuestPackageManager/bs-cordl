...
/// @brief Method CopyTo, addr 0x5f6fd6c, size 0xc0, virtual false, abstract: false, final false
inline void CopyTo(::System::Xml::XmlDictionaryReaderQuotas*  quotas) ;

/// @brief Method InternalCopyTo, addr 0x5f6feac, size 0x20, virtual false, abstract: false, final false
inline void InternalCopyTo(::System::Xml::XmlDictionaryReaderQuotas*  quotas) ;

/// @brief Method MakeReadOnly, addr 0x5f6fe44, size 0xc, virtual false, abstract: false, final false
inline void MakeReadOnly() ;

static inline ::System::Xml::XmlDictionaryReaderQuotas* New_ctor() ;

static inline ::System::Xml::XmlDictionaryReaderQuotas* New_ctor(int32_t  maxDepth, int32_t  maxStringContentLength, int32_t  maxArrayLength, int32_t  maxBytesPerRead, int32_t  maxNameTableCharCount, ::System::Xml::XmlDictionaryReaderQuotaTypes  modifiedQuotas) ;
...
/// @brief Method .ctor, addr 0x5f6fd00, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5f6fe2c, size 0x18, virtual false, abstract: false, final false
inline void _ctor(int32_t  maxDepth, int32_t  maxStringContentLength, int32_t  maxArrayLength, int32_t  maxBytesPerRead, int32_t  maxNameTableCharCount, ::System::Xml::XmlDictionaryReaderQuotaTypes  modifiedQuotas) ;
...
/// @brief Method get_Max, addr 0x5f6fe50, size 0x5c, virtual false, abstract: false, final false
static inline ::System::Xml::XmlDictionaryReaderQuotas* get_Max() ;

/// @brief Method get_MaxArrayLength, addr 0x5f6fed4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxArrayLength() ;

/// @brief Method get_MaxBytesPerRead, addr 0x5f6fedc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxBytesPerRead() ;

/// @brief Method get_MaxDepth, addr 0x5f6fee4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxDepth() ;

/// @brief Method get_MaxNameTableCharCount, addr 0x5f6feec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxNameTableCharCount() ;

/// @brief Method get_MaxStringContentLength, addr 0x5f6fecc, size 0x8, virtual false, abstract: false, final false
