...
public:
  ...
  /// @brief Method CopyTo, addr 0x5fe1d78, size 0xc0, virtual false, abstract: false, final false
  inline void CopyTo(::System::Xml::XmlDictionaryReaderQuotas* quotas);

  /// @brief Method InternalCopyTo, addr 0x5fe1eb8, size 0x20, virtual false, abstract: false, final false
  inline void InternalCopyTo(::System::Xml::XmlDictionaryReaderQuotas* quotas);

  /// @brief Method MakeReadOnly, addr 0x5fe1e50, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fe1d0c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5fe1e38, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Max, addr 0x5fe1e5c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlDictionaryReaderQuotas* get_Max();

  /// @brief Method get_MaxArrayLength, addr 0x5fe1ee0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxArrayLength();

  /// @brief Method get_MaxBytesPerRead, addr 0x5fe1ee8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxBytesPerRead();

  /// @brief Method get_MaxDepth, addr 0x5fe1ef0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxDepth();

  /// @brief Method get_MaxNameTableCharCount, addr 0x5fe1ef8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxNameTableCharCount();

  /// @brief Method get_MaxStringContentLength, addr 0x5fe1ed8, size 0x8, virtual false, abstract: false, final false
