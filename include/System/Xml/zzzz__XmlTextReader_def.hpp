...
public:
  ...
  /// @brief Method .ctor addr 0x2873da8 size 0xac virtual false final false
  inline void _ctor(::System::IO::TextReader* input, ::System::Xml::XmlNameTable* nt);

  /// @brief Method get_NodeType addr 0x2873e54 size 0x20 virtual true final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Name addr 0x2873e74 size 0x20 virtual true final false
  inline ::StringW get_Name();

  /// @brief Method get_LocalName addr 0x2873e94 size 0x20 virtual true final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceURI addr 0x2873eb4 size 0x20 virtual true final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_Prefix addr 0x2873ed4 size 0x20 virtual true final false
  inline ::StringW get_Prefix();

  /// @brief Method get_Value addr 0x2873ef4 size 0x20 virtual true final false
  inline ::StringW get_Value();

  /// @brief Method get_BaseURI addr 0x2873f14 size 0x20 virtual true final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_IsEmptyElement addr 0x2873f34 size 0x24 virtual true final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_IsDefault addr 0x2873f58 size 0x24 virtual true final false
  inline bool get_IsDefault();

  /// @brief Method MoveToAttribute addr 0x2873f7c size 0x24 virtual true final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToFirstAttribute addr 0x2873fa0 size 0x24 virtual true final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute addr 0x2873fc4 size 0x24 virtual true final false
  inline bool MoveToNextAttribute();

  /// @brief Method MoveToElement addr 0x2873fe8 size 0x24 virtual true final false
  inline bool MoveToElement();

  /// @brief Method ReadAttributeValue addr 0x287400c size 0x24 virtual true final false
  inline bool ReadAttributeValue();

  /// @brief Method Read addr 0x2874030 size 0x24 virtual true final false
  inline bool Read();

  /// @brief Method Close addr 0x2874054 size 0x24 virtual true final false
  inline void Close();

  /// @brief Method get_ReadState addr 0x2874078 size 0x24 virtual true final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_NameTable addr 0x287409c size 0x24 virtual true final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method LookupNamespace addr 0x28740c0 size 0x38 virtual true final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method get_CanResolveEntity addr 0x28740f8 size 0x8 virtual true final false
  inline bool get_CanResolveEntity();

  /// @brief Method ResolveEntity addr 0x2874100 size 0x24 virtual true final false
  inline void ResolveEntity();

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace addr 0x2874124 size 0x24 virtual true final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix addr 0x2874148 size 0x1c virtual true final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method set_EntityHandling addr 0x2874164 size 0x1c virtual false final false
  inline void set_EntityHandling(::System::Xml::EntityHandling value);

  /// @brief Method set_XmlResolver addr 0x2874180 size 0x1c virtual false final false
  inline void set_XmlResolver(::System::Xml::XmlResolver* value);

  /// @brief Method get_Impl addr 0x287419c size 0x8 virtual false final false
  inline ::System::Xml::XmlTextReaderImpl* get_Impl();

  /// @brief Method set_XmlValidatingReaderCompatibilityMode addr 0x28741a4 size 0x20 virtual false final false
  inline void set_XmlValidatingReaderCompatibilityMode(bool value);

  /// @brief Method get_DtdInfo addr 0x28741c4 size 0x24 virtual true final false
