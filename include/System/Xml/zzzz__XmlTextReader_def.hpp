...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11384))}
...
public:
  ...
  /// @brief Method .ctor addr 0x26f6d8c size 0xac virtual false final false
  inline void _ctor(::System::IO::TextReader* input, ::System::Xml::XmlNameTable* nt);

  /// @brief Method get_NodeType addr 0x26f6e38 size 0x20 virtual true final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Name addr 0x26f6e58 size 0x20 virtual true final false
  inline ::StringW get_Name();

  /// @brief Method get_LocalName addr 0x26f6e78 size 0x20 virtual true final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceURI addr 0x26f6e98 size 0x20 virtual true final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_Prefix addr 0x26f6eb8 size 0x20 virtual true final false
  inline ::StringW get_Prefix();

  /// @brief Method get_Value addr 0x26f6ed8 size 0x20 virtual true final false
  inline ::StringW get_Value();

  /// @brief Method get_BaseURI addr 0x26f6ef8 size 0x20 virtual true final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_IsEmptyElement addr 0x26f6f18 size 0x24 virtual true final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_IsDefault addr 0x26f6f3c size 0x24 virtual true final false
  inline bool get_IsDefault();

  /// @brief Method MoveToAttribute addr 0x26f6f60 size 0x24 virtual true final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToFirstAttribute addr 0x26f6f84 size 0x24 virtual true final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute addr 0x26f6fa8 size 0x24 virtual true final false
  inline bool MoveToNextAttribute();

  /// @brief Method MoveToElement addr 0x26f6fcc size 0x24 virtual true final false
  inline bool MoveToElement();

  /// @brief Method ReadAttributeValue addr 0x26f6ff0 size 0x24 virtual true final false
  inline bool ReadAttributeValue();

  /// @brief Method Read addr 0x26f7014 size 0x24 virtual true final false
  inline bool Read();

  /// @brief Method Close addr 0x26f7038 size 0x24 virtual true final false
  inline void Close();

  /// @brief Method get_ReadState addr 0x26f705c size 0x24 virtual true final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_NameTable addr 0x26f7080 size 0x24 virtual true final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method LookupNamespace addr 0x26f70a4 size 0x38 virtual true final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method get_CanResolveEntity addr 0x26f70dc size 0x8 virtual true final false
  inline bool get_CanResolveEntity();

  /// @brief Method ResolveEntity addr 0x26f70e4 size 0x24 virtual true final false
  inline void ResolveEntity();

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace addr 0x26f7108 size 0x24 virtual true final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix addr 0x26f712c size 0x1c virtual true final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method set_EntityHandling addr 0x26f7148 size 0x1c virtual false final false
  inline void set_EntityHandling(::System::Xml::EntityHandling value);

  /// @brief Method set_XmlResolver addr 0x26f7164 size 0x1c virtual false final false
  inline void set_XmlResolver(::System::Xml::XmlResolver* value);

  /// @brief Method get_Impl addr 0x26f7180 size 0x8 virtual false final false
  inline ::System::Xml::XmlTextReaderImpl* get_Impl();

  /// @brief Method set_XmlValidatingReaderCompatibilityMode addr 0x26f7188 size 0x20 virtual false final false
  inline void set_XmlValidatingReaderCompatibilityMode(bool value);

  /// @brief Method get_DtdInfo addr 0x26f71a8 size 0x24 virtual true final false
