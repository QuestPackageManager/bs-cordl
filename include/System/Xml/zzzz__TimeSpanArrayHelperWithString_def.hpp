...
public:
  ...
  /// @brief Method ReadArray, addr 0x60f9e04, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x60f9e3c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60f9e78, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
