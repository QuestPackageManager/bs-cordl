...
public:
  ...
  /// @brief Method CloneNode, addr 0x2eb0ab0, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  static inline ::System::Xml::XmlComment* New_ctor(::StringW comment, ::System::Xml::XmlDocument* doc);

  /// @brief Method WriteContentTo, addr 0x2eb0b4c, size 0x4, virtual true, abstract: false, final false
  inline void WriteContentTo(::System::Xml::XmlWriter* w);

  /// @brief Method WriteTo, addr 0x2eb0b0c, size 0x40, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* w);

  /// @brief Method .ctor, addr 0x2eb0a2c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW comment, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_LocalName, addr 0x2eb0a80, size 0x28, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x2eb0a58, size 0x28, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0x2eb0aa8, size 0x8, virtual true, abstract: false, final false
