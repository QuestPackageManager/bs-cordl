...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlComment", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlComment(XmlComment&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlComment", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlComment(XmlCommentconst&) = delete;
