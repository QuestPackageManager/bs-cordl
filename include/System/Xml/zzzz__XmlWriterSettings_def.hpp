...
public:
  ...
  /// @brief Method CheckReadOnly, addr 0x4328598, size 0xb4, virtual false, abstract: false, final false
  inline void CheckReadOnly(::StringW propertyName);

  /// @brief Method Clone, addr 0x4328874, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlWriterSettings* Clone();

  /// @brief Method CreateWriter, addr 0x4327c5c, size 0x478, virtual false, abstract: false, final false
  inline ::System::Xml::XmlWriter* CreateWriter(::System::IO::Stream* output);

  /// @brief Method CreateWriter, addr 0x432813c, size 0x2fc, virtual false, abstract: false, final false
  inline ::System::Xml::XmlWriter* CreateWriter(::System::IO::TextWriter* output);

  /// @brief Method Initialize, addr 0x4328440, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4327bd8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Async, addr 0x4328520, size 0x8, virtual false, abstract: false, final false
  inline bool get_Async();

  /// @brief Method get_AutoXmlDeclaration, addr 0x4328974, size 0x8, virtual false, abstract: false, final false
  inline bool get_AutoXmlDeclaration();

  /// @brief Method get_CDataSectionElements, addr 0x432893c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::Xml::XmlQualifiedName*>* get_CDataSectionElements();

  /// @brief Method get_CheckCharacters, addr 0x43287a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_CheckCharacters();

  /// @brief Method get_CloseOutput, addr 0x43286e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_CloseOutput();

  /// @brief Method get_ConformanceLevel, addr 0x43286ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::ConformanceLevel get_ConformanceLevel();

  /// @brief Method get_DoNotEscapeUriAttributes, addr 0x4328944, size 0x8, virtual false, abstract: false, final false
  inline bool get_DoNotEscapeUriAttributes();

  /// @brief Method get_DocTypePublic, addr 0x4328964, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DocTypePublic();

  /// @brief Method get_DocTypeSystem, addr 0x432895c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DocTypeSystem();

  /// @brief Method get_Encoding, addr 0x4328528, size 0x8, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method get_Indent, addr 0x432865c, size 0x10, virtual false, abstract: false, final false
  inline bool get_Indent();

  /// @brief Method get_IndentChars, addr 0x43286d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_IndentChars();

  /// @brief Method get_IndentInternal, addr 0x432897c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::TriState get_IndentInternal();

  /// @brief Method get_IsQuerySpecific, addr 0x4328984, size 0x70, virtual false, abstract: false, final false
  inline bool get_IsQuerySpecific();

  /// @brief Method get_MediaType, addr 0x4328954, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MediaType();

  /// @brief Method get_MergeCDataSections, addr 0x432894c, size 0x8, virtual false, abstract: false, final false
  inline bool get_MergeCDataSections();

  /// @brief Method get_NamespaceHandling, addr 0x43287a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::NamespaceHandling get_NamespaceHandling();

  /// @brief Method get_NewLineChars, addr 0x4328654, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NewLineChars();

  /// @brief Method get_NewLineHandling, addr 0x432864c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::NewLineHandling get_NewLineHandling();

  /// @brief Method get_NewLineOnAttributes, addr 0x43286dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_NewLineOnAttributes();

  /// @brief Method get_OmitXmlDeclaration, addr 0x4328530, size 0x8, virtual false, abstract: false, final false
  inline bool get_OmitXmlDeclaration();

  /// @brief Method get_OutputMethod, addr 0x4328864, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlOutputMethod get_OutputMethod();

  /// @brief Method get_Standalone, addr 0x432896c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlStandalone get_Standalone();

  /// @brief Method get_WriteEndDocumentOnClose, addr 0x432885c, size 0x8, virtual false, abstract: false, final false
  inline bool get_WriteEndDocumentOnClose();

  /// @brief Method set_ConformanceLevel, addr 0x43286f4, size 0xac, virtual false, abstract: false, final false
  inline void set_ConformanceLevel(::System::Xml::ConformanceLevel value);

  /// @brief Method set_Indent, addr 0x432866c, size 0x68, virtual false, abstract: false, final false
  inline void set_Indent(bool value);

  /// @brief Method set_NamespaceHandling, addr 0x43287b0, size 0xac, virtual false, abstract: false, final false
  inline void set_NamespaceHandling(::System::Xml::NamespaceHandling value);

  /// @brief Method set_OmitXmlDeclaration, addr 0x4328538, size 0x60, virtual false, abstract: false, final false
  inline void set_OmitXmlDeclaration(bool value);

  /// @brief Method set_OutputMethod, addr 0x432886c, size 0x8, virtual false, abstract: false, final false
  inline void set_OutputMethod(::System::Xml::XmlOutputMethod value);

  /// @brief Method set_ReadOnly, addr 0x43289f4, size 0xc, virtual false, abstract: false, final false
