...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ucs4Encoding", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Ucs4Encoding(Ucs4Encoding&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Ucs4Encoding", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Ucs4Encoding(Ucs4Encodingconst&) = delete;
