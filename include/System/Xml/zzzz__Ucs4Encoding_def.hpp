...
public:
  ...
  /// @brief Method get_WebName addr 0x2728ba4 size 0xc virtual true final false
  inline ::StringW get_WebName();

  /// @brief Method GetDecoder addr 0x2728bb0 size 0x8 virtual true final false
  inline ::System::Text::Decoder* GetDecoder();

  /// @brief Method GetByteCount addr 0x2728bb8 size 0x60 virtual true final false
  inline int32_t GetByteCount(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t index, int32_t count);

  /// @brief Method GetBytes addr 0x2728c18 size 0x8 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytes(::StringW s);

  /// @brief Method GetBytes addr 0x2728c20 size 0x8 virtual true final false
  ...
  /// @brief Method GetMaxByteCount addr 0x2728c28 size 0x8 virtual true final false
  inline int32_t GetMaxByteCount(int32_t charCount);

  /// @brief Method GetCharCount addr 0x2728c30 size 0x20 virtual true final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetChars addr 0x2728c50 size 0x20 virtual true final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method GetMaxCharCount addr 0x2728c70 size 0x18 virtual true final false
  inline int32_t GetMaxCharCount(int32_t byteCount);

  /// @brief Method get_CodePage addr 0x2728c88 size 0x8 virtual true final false
  inline int32_t get_CodePage();

  /// @brief Method GetEncoder addr 0x2728c90 size 0x8 virtual true final false
  inline ::System::Text::Encoder* GetEncoder();

  /// @brief Method get_UCS4_Littleendian addr 0x2728c98 size 0x58 virtual false final false
  static inline ::System::Text::Encoding* get_UCS4_Littleendian();

  /// @brief Method get_UCS4_Bigendian addr 0x2728d58 size 0x58 virtual false final false
  static inline ::System::Text::Encoding* get_UCS4_Bigendian();

  /// @brief Method get_UCS4_2143 addr 0x2728e18 size 0x58 virtual false final false
  static inline ::System::Text::Encoding* get_UCS4_2143();

  /// @brief Method get_UCS4_3412 addr 0x2728ed8 size 0x58 virtual false final false
  static inline ::System::Text::Encoding* get_UCS4_3412();

  static inline ::System::Xml::Ucs4Encoding* New_ctor();

  /// @brief Method .ctor addr 0x2728f98 size 0x8 virtual false final false
  inline void _ctor();
