...
public:
  ...
  /// @brief Method MoveNext, addr 0x62ba93c, size 0x60, virtual false, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Xml::XmlChildEnumerator* New_ctor(::System::Xml::XmlNode* container);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x62ba938, size 0x4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x62ba99c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x62ba9d4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x62ba8f8, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Current, addr 0x62ba9d8, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlChildEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlChildEnumerator(XmlChildEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlChildEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlChildEnumerator(XmlChildEnumeratorconst&) = delete;
