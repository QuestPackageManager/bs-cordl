...
public:
  ...
  /// @brief Method MoveNext, addr 0x4335a94, size 0x64, virtual false, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Xml::XmlChildEnumerator* New_ctor(::System::Xml::XmlNode* container);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x4335a90, size 0x4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x4335af8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x4335b30, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4335a40, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Current, addr 0x4335b34, size 0x74, virtual false, abstract: false, final false
