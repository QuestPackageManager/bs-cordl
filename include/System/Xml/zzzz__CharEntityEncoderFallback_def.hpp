...
public:
  ...
  /// @brief Method CanReplaceAt, addr 0x61acb84, size 0x80, virtual false, abstract: false, final false
  inline bool CanReplaceAt(int32_t index);

  /// @brief Method CreateFallbackBuffer, addr 0x61acad4, size 0x74, virtual true, abstract: false, final false
  inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer();

  static inline ::System::Xml::CharEntityEncoderFallback* New_ctor();

  /// @brief Method Reset, addr 0x61acb78, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61acad0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_MaxCharCount, addr 0x61acb68, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_MaxCharCount();

  /// @brief Method set_StartOffset, addr 0x61acb70, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CharEntityEncoderFallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CharEntityEncoderFallback(CharEntityEncoderFallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CharEntityEncoderFallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CharEntityEncoderFallback(CharEntityEncoderFallbackconst&) = delete;
