...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5ffe6dc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ffe65c, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x5ffe4bc, size 0x14, virtual true, abstract: false, final true
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x5ff7724, size 0xa0, virtual true, abstract: false, final true
  inline int32_t GetHashCode(::StringW key);

  /// @brief Method GetHashCodeDelegate, addr 0x5ffe4d0, size 0x148, virtual false, abstract: false, final false
  static inline ::System::Xml::SecureStringHasher_HashCodeOfStringDelegate* GetHashCodeDelegate();

  /// @brief Method GetHashCodeOfString, addr 0x5ffe618, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ffe4a4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
