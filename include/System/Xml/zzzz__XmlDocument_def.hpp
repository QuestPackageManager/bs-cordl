...
public:
  ...
  /// @brief Method AddAttrXmlName, addr 0x6173be0, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDefaultAttributes, addr 0x617ac8c, size 0x2b4, virtual false, abstract: false, final false
  inline void AddDefaultAttributes(::System::Xml::XmlElement* elem);

  /// @brief Method AddElementWithId, addr 0x6177ce4, size 0x208, virtual false, abstract: false, final false
  inline void AddElementWithId(::StringW id, ::System::Xml::XmlElement* elem);

  /// @brief Method AddIdInfo, addr 0x6179784, size 0xc8, virtual false, abstract: false, final false
  inline bool AddIdInfo(::System::Xml::XmlName* eleName, ::System::Xml::XmlName* attrName);

  /// @brief Method AddXmlName, addr 0x617975c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method AfterEvent, addr 0x617d0c0, size 0x54, virtual true, abstract: false, final false
  inline void AfterEvent(::System::Xml::XmlNodeChangedEventArgs* args);

  /// @brief Method AppendChildForLoad, addr 0x617d3f4, size 0x1c8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* AppendChildForLoad(::System::Xml::XmlNode* newChild, ::System::Xml::XmlDocument* doc);

  /// @brief Method BeforeEvent, addr 0x617d06c, size 0x54, virtual true, abstract: false, final false
  inline void BeforeEvent(::System::Xml::XmlNodeChangedEventArgs* args);

  /// @brief Method CanInsertAfter, addr 0x617a698, size 0xf4, virtual true, abstract: false, final false
  inline bool CanInsertAfter(::System::Xml::XmlNode* newChild, ::System::Xml::XmlNode* refChild);

  /// @brief Method CanInsertBefore, addr 0x617a534, size 0x164, virtual true, abstract: false, final false
  inline bool CanInsertBefore(::System::Xml::XmlNode* newChild, ::System::Xml::XmlNode* refChild);

  /// @brief Method CheckName, addr 0x6173ab4, size 0xd8, virtual false, abstract: false, final false
  static inline void CheckName(::StringW name);

  /// @brief Method CloneNode, addr 0x6179f18, size 0x60, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  /// @brief Method CreateAttribute, addr 0x617a78c, size 0x80, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW name);

  /// @brief Method CreateAttribute, addr 0x617bf00, size 0x9c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method CreateAttribute, addr 0x617b83c, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW qualifiedName, ::StringW namespaceURI);

  /// @brief Method CreateCDataSection, addr 0x617a940, size 0x74, virtual true, abstract: false, final false
  inline ::System::Xml::XmlCDataSection* CreateCDataSection(::StringW data);

  /// @brief Method CreateComment, addr 0x617a9b4, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlComment* CreateComment(::StringW data);

  /// @brief Method CreateDefaultAttribute, addr 0x617bf9c, size 0x84, virtual true, abstract: false, final false
  inline ::System::Xml::XmlAttribute* CreateDefaultAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method CreateDocumentFragment, addr 0x617ab6c, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDocumentFragment* CreateDocumentFragment();

  /// @brief Method CreateDocumentType, addr 0x617aa20, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateElement, addr 0x617ac24, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW name);

  /// @brief Method CreateElement, addr 0x617c020, size 0xbc, virtual true, abstract: false, final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method CreateElement, addr 0x617b8a0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW qualifiedName, ::StringW namespaceURI);

  /// @brief Method CreateEntityReference, addr 0x617b160, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlEntityReference* CreateEntityReference(::StringW name);

  /// @brief Method CreateNavigator, addr 0x617b46c, size 0x14, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNavigator* CreateNavigator();

  /// @brief Method CreateNavigator, addr 0x617b480, size 0x180, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathNavigator* CreateNavigator(::System::Xml::XmlNode* node);

  /// @brief Method CreateProcessingInstruction, addr 0x617b298, size 0x74, virtual true, abstract: false, final false
  inline ::System::Xml::XmlProcessingInstruction* CreateProcessingInstruction(::StringW target, ::StringW data);

  /// @brief Method CreateSignificantWhitespace, addr 0x617b3fc, size 0x70, virtual true, abstract: false, final false
  inline ::System::Xml::XmlSignificantWhitespace* CreateSignificantWhitespace(::StringW text);

  /// @brief Method CreateTextNode, addr 0x617b390, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlText* CreateTextNode(::StringW text);

  /// @brief Method CreateWhitespace, addr 0x617b7cc, size 0x70, virtual true, abstract: false, final false
  inline ::System::Xml::XmlWhitespace* CreateWhitespace(::StringW text);

  /// @brief Method CreateXmlDeclaration, addr 0x617b30c, size 0x84, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDeclaration* CreateXmlDeclaration(::StringW version, ::StringW encoding, ::StringW standalone);

  /// @brief Method GetDefaultAttribute, addr 0x61779cc, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method GetElement, addr 0x617991c, size 0x5fc, virtual false, abstract: false, final false
  inline ::System::WeakReference* GetElement(::System::Collections::ArrayList* elementList, ::System::Xml::XmlElement* elem);

  /// @brief Method GetEntityNode, addr 0x617d15c, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::XmlEntity* GetEntityNode(::StringW name);

  /// @brief Method GetEventArgs, addr 0x617cee0, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetIDInfoByElement, addr 0x6177cd0, size 0x14, virtual false, abstract: false, final false
  inline ::System::Xml::XmlName* GetIDInfoByElement(::System::Xml::XmlName* eleName);

  /// @brief Method GetIDInfoByElement_, addr 0x617984c, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::XmlName* GetIDInfoByElement_(::System::Xml::XmlName* eleName);

  /// @brief Method GetInsertEventArgsForLoad, addr 0x6174728, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeChangedEventArgs* GetInsertEventArgsForLoad(::System::Xml::XmlNode* node, ::System::Xml::XmlNode* newParent);

  /// @brief Method GetResolver, addr 0x617a1a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetResolver();

  /// @brief Method GetSchemaElementDecl, addr 0x617af40, size 0x118, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaElementDecl* GetSchemaElementDecl(::System::Xml::XmlElement* elem);

  /// @brief Method GetXmlName, addr 0x6179770, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method HasNodeTypeInNextSiblings, addr 0x617a4d0, size 0x64, virtual false, abstract: false, final false
  inline bool HasNodeTypeInNextSiblings(::System::Xml::XmlNodeType nt, ::System::Xml::XmlNode* refNode);

  /// @brief Method HasNodeTypeInPrevSiblings, addr 0x617a41c, size 0xb4, virtual false, abstract: false, final false
  inline bool HasNodeTypeInPrevSiblings(::System::Xml::XmlNodeType nt, ::System::Xml::XmlNode* refNode);

  /// @brief Method ImportAttributes, addr 0x617bdec, size 0x114, virtual false, abstract: false, final false
  inline void ImportAttributes(::System::Xml::XmlNode* fromElem, ::System::Xml::XmlNode* toElem);

  /// @brief Method ImportChildren, addr 0x6179f78, size 0x98, virtual false, abstract: false, final false
  inline void ImportChildren(::System::Xml::XmlNode* fromNode, ::System::Xml::XmlNode* toNode, bool deep);

  /// @brief Method ImportNodeInternal, addr 0x617b904, size 0x4e8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* ImportNodeInternal(::System::Xml::XmlNode* node, bool deep);

  /// @brief Method IsTextNode, addr 0x617b7b4, size 0x18, virtual false, abstract: false, final false
  static inline bool IsTextNode(::System::Xml::XmlNodeType nt);

  /// @brief Method IsValidChildType, addr 0x617a338, size 0xe4, virtual true, abstract: false, final false
  inline bool IsValidChildType(::System::Xml::XmlNodeType type);

  /// @brief Method Load, addr 0x617c4b8, size 0x108, virtual true, abstract: false, final false
  inline void Load(::System::Xml::XmlReader* reader);

  /// @brief Method LoadXml, addr 0x617c7dc, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method NormalizeText, addr 0x617b600, size 0x1b4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNode* NormalizeText(::System::Xml::XmlNode* n);

  /// @brief Method PrepareDefaultAttribute, addr 0x617b058, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadNode, addr 0x617c274, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* ReadNode(::System::Xml::XmlReader* reader);

  /// @brief Method RemoveElementWithId, addr 0x6177eec, size 0x148, virtual false, abstract: false, final false
  inline void RemoveElementWithId(::StringW id, ::System::Xml::XmlElement* elem);

  /// @brief Method Save, addr 0x617c988, size 0x204, virtual true, abstract: false, final false
  inline void Save(::System::Xml::XmlWriter* w);

  /// @brief Method SetBaseURI, addr 0x617d3ec, size 0x8, virtual false, abstract: false, final false
  inline void SetBaseURI(::StringW inBaseURI);

  /// @brief Method SetDefaultNamespace, addr 0x617a8bc, size 0x84, virtual false, abstract: false, final false
  inline void SetDefaultNamespace(::StringW prefix, ::StringW localName, ::ByRef<::StringW> namespaceURI);

  /// @brief Method SetupReader, addr 0x617c458, size 0x60, virtual false, abstract: false, final false
  inline ::System::Xml::XmlTextReader* SetupReader(::System::Xml::XmlTextReader* tr);

  /// @brief Method WriteContentTo, addr 0x617cbc0, size 0x2a0, virtual true, abstract: false, final false
  inline void WriteContentTo(::System::Xml::XmlWriter* xw);

  /// @brief Method WriteTo, addr 0x617cbb0, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6179260, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6179318, size 0x3c4, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlImplementation* imp);

  /// @brief Method .ctor, addr 0x61796dc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ActualLoadingStatus, addr 0x617c26c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ActualLoadingStatus();

  /// @brief Method get_BaseURI, addr 0x617d3e4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_CanReportValidity, addr 0x617a198, size 0x8, virtual false, abstract: false, final false
  inline bool get_CanReportValidity();

  /// @brief Method get_Declaration, addr 0x617a0b0, size 0xa8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDeclaration* get_Declaration();

  /// @brief Method get_DocumentElement, addr 0x6171f08, size 0x90, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* get_DocumentElement();

  /// @brief Method get_DocumentType, addr 0x617a020, size 0x90, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDocumentType* get_DocumentType();

  /// @brief Method get_DtdSchemaInfo, addr 0x617974c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::SchemaInfo* get_DtdSchemaInfo();

  /// @brief Method get_Encoding, addr 0x617d138, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_Encoding();

  /// @brief Method get_Entities, addr 0x617c1f8, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNamedNodeMap* get_Entities();

  /// @brief Method get_HasEntityReferences, addr 0x617d5c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasEntityReferences();

  /// @brief Method get_HasSetResolver, addr 0x617a1a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasSetResolver();

  /// @brief Method get_Implementation, addr 0x617a158, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlImplementation* get_Implementation();

  /// @brief Method get_IsContainer, addr 0x617a170, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsContainer();

  /// @brief Method get_IsLoading, addr 0x617c25c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsLoading();

  /// @brief Method get_IsReadOnly, addr 0x617c1f0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_LastNode, addr 0x617a178, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlLinkedNode* get_LastNode();

  /// @brief Method get_LocalName, addr 0x617a168, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x617a160, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0x6171ab4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceXml, addr 0x6172244, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlAttribute* get_NamespaceXml();

  /// @brief Method get_NodeType, addr 0x617a010, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_OwnerDocument, addr 0x617a188, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlDocument* get_OwnerDocument();

  /// @brief Method get_ParentNode, addr 0x617a018, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* get_ParentNode();

  /// @brief Method get_SchemaInfo, addr 0x617d288, size 0x15c, virtual true, abstract: false, final false
  inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo();

  /// @brief Method get_Standalone, addr 0x617cb8c, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0x617d114, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_Version();

  /// @brief Method get_XPNodeType, addr 0x617d5bc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_DtdSchemaInfo, addr 0x6179754, size 0x8, virtual false, abstract: false, final false
  inline void set_DtdSchemaInfo(::System::Xml::Schema::SchemaInfo* value);

  /// @brief Method set_Entities, addr 0x617c254, size 0x8, virtual false, abstract: false, final false
  inline void set_Entities(::System::Xml::XmlNamedNodeMap* value);

  /// @brief Method set_InnerText, addr 0x617c928, size 0x50, virtual true, abstract: false, final false
  inline void set_InnerText(::StringW value);

  /// @brief Method set_InnerXml, addr 0x617c978, size 0x10, virtual true, abstract: false, final false
  inline void set_InnerXml(::StringW value);

  /// @brief Method set_IsLoading, addr 0x617c264, size 0x8, virtual false, abstract: false, final false
  inline void set_IsLoading(bool value);

  /// @brief Method set_LastNode, addr 0x617a180, size 0x8, virtual true, abstract: false, final false
  inline void set_LastNode(::System::Xml::XmlLinkedNode* value);

  /// @brief Method set_Schemas, addr 0x617a190, size 0x8, virtual false, abstract: false, final false
  inline void set_Schemas(::System::Xml::Schema::XmlSchemaSet* value);

  /// @brief Method set_XmlResolver, addr 0x617a1b0, size 0x188, virtual true, abstract: false, final false
