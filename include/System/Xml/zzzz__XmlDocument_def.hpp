...
public:
  ...
  /// @brief Method .ctor addr 0x270784c size 0x64 virtual false final false
  inline void _ctor();

  static inline ::System::Xml::XmlDocument* New_ctor(::System::Xml::XmlImplementation* imp);

  /// @brief Method .ctor addr 0x27078b0 size 0x3c8 virtual false final false
  inline void _ctor(::System::Xml::XmlImplementation* imp);

  /// @brief Method get_DtdSchemaInfo addr 0x2707c78 size 0x8 virtual false final false
  inline ::System::Xml::Schema::SchemaInfo* get_DtdSchemaInfo();

  /// @brief Method set_DtdSchemaInfo addr 0x2707c80 size 0x8 virtual false final false
  inline void set_DtdSchemaInfo(::System::Xml::Schema::SchemaInfo* value);

  /// @brief Method CheckName addr 0x2704a94 size 0xd8 virtual false final false
  static inline void CheckName(::StringW name);

  /// @brief Method AddXmlName addr 0x2707c88 size 0x18 virtual false final false
  ...
  /// @brief Method GetXmlName addr 0x2707ca0 size 0x18 virtual false final false
  ...
  /// @brief Method AddAttrXmlName addr 0x2704ba8 size 0x11c virtual false final false
  ...
  /// @brief Method AddIdInfo addr 0x2707cb8 size 0xc0 virtual false final false
  inline bool AddIdInfo(::System::Xml::XmlName* eleName, ::System::Xml::XmlName* attrName);

  /// @brief Method GetIDInfoByElement_ addr 0x2707d78 size 0xd4 virtual false final false
  inline ::System::Xml::XmlName* GetIDInfoByElement_(::System::Xml::XmlName* eleName);

  /// @brief Method GetIDInfoByElement addr 0x2706714 size 0x14 virtual false final false
  inline ::System::Xml::XmlName* GetIDInfoByElement(::System::Xml::XmlName* eleName);

  /// @brief Method GetElement addr 0x2707e4c size 0x650 virtual false final false
  inline ::System::WeakReference* GetElement(::System::Collections::ArrayList* elementList, ::System::Xml::XmlElement* elem);

  /// @brief Method AddElementWithId addr 0x2706728 size 0x1f4 virtual false final false
  inline void AddElementWithId(::StringW id, ::System::Xml::XmlElement* elem);

  /// @brief Method RemoveElementWithId addr 0x270691c size 0x138 virtual false final false
  inline void RemoveElementWithId(::StringW id, ::System::Xml::XmlElement* elem);

  /// @brief Method CloneNode addr 0x270849c size 0x60 virtual true final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  /// @brief Method get_NodeType addr 0x2708598 size 0x8 virtual true final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_ParentNode addr 0x27085a0 size 0x8 virtual true final false
  inline ::System::Xml::XmlNode* get_ParentNode();

  /// @brief Method get_DocumentType addr 0x27085a8 size 0x8c virtual true final false
  inline ::System::Xml::XmlDocumentType* get_DocumentType();

  /// @brief Method get_Declaration addr 0x2708634 size 0xa4 virtual true final false
  inline ::System::Xml::XmlDeclaration* get_Declaration();

  /// @brief Method get_Implementation addr 0x27086d8 size 0x8 virtual false final false
  inline ::System::Xml::XmlImplementation* get_Implementation();

  /// @brief Method get_Name addr 0x27086e0 size 0x8 virtual true final false
  inline ::StringW get_Name();

  /// @brief Method get_LocalName addr 0x27086e8 size 0x8 virtual true final false
  inline ::StringW get_LocalName();

  /// @brief Method get_DocumentElement addr 0x27086f0 size 0x8c virtual false final false
  inline ::System::Xml::XmlElement* get_DocumentElement();

  /// @brief Method get_IsContainer addr 0x270877c size 0x8 virtual true final false
  inline bool get_IsContainer();

  /// @brief Method get_LastNode addr 0x2708784 size 0x8 virtual true final false
  inline ::System::Xml::XmlLinkedNode* get_LastNode();

  /// @brief Method set_LastNode addr 0x270878c size 0x8 virtual true final false
  inline void set_LastNode(::System::Xml::XmlLinkedNode* value);

  /// @brief Method get_OwnerDocument addr 0x2708794 size 0x8 virtual true final false
  inline ::System::Xml::XmlDocument* get_OwnerDocument();

  /// @brief Method set_Schemas addr 0x270879c size 0x8 virtual false final false
  inline void set_Schemas(::System::Xml::Schema::XmlSchemaSet* value);

  /// @brief Method get_CanReportValidity addr 0x27087a4 size 0x8 virtual false final false
  inline bool get_CanReportValidity();

  /// @brief Method get_HasSetResolver addr 0x27087ac size 0x8 virtual false final false
  inline bool get_HasSetResolver();

  /// @brief Method GetResolver addr 0x27087b4 size 0x8 virtual false final false
  inline ::System::Xml::XmlResolver* GetResolver();

  /// @brief Method set_XmlResolver addr 0x27087bc size 0x188 virtual true final false
  inline void set_XmlResolver(::System::Xml::XmlResolver* value);

  /// @brief Method IsValidChildType addr 0x2708944 size 0xf0 virtual true final false
  inline bool IsValidChildType(::System::Xml::XmlNodeType type);

  /// @brief Method HasNodeTypeInPrevSiblings addr 0x2708a34 size 0xb0 virtual false final false
  inline bool HasNodeTypeInPrevSiblings(::System::Xml::XmlNodeType nt, ::System::Xml::XmlNode* refNode);

  /// @brief Method HasNodeTypeInNextSiblings addr 0x2708ae4 size 0x64 virtual false final false
  inline bool HasNodeTypeInNextSiblings(::System::Xml::XmlNodeType nt, ::System::Xml::XmlNode* refNode);

  /// @brief Method CanInsertAfter addr 0x2708b48 size 0xf8 virtual true final false
  inline bool CanInsertAfter(::System::Xml::XmlNode* newChild, ::System::Xml::XmlNode* refChild);

  /// @brief Method CreateAttribute addr 0x2708c40 size 0xc0 virtual false final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW name);

  /// @brief Method SetDefaultNamespace addr 0x2708d00 size 0x90 virtual false final false
  inline void SetDefaultNamespace(::StringW prefix, ::StringW localName, ByRef<::StringW> namespaceURI);

  /// @brief Method CreateCDataSection addr 0x2708d90 size 0x7c virtual true final false
  inline ::System::Xml::XmlCDataSection* CreateCDataSection(::StringW data);

  /// @brief Method CreateComment addr 0x2708e0c size 0x74 virtual true final false
  inline ::System::Xml::XmlComment* CreateComment(::StringW data);

  /// @brief Method CreateDocumentType addr 0x2708e80 size 0x94 virtual true final false
  ...
  /// @brief Method CreateDocumentFragment addr 0x2708f14 size 0x64 virtual true final false
  inline ::System::Xml::XmlDocumentFragment* CreateDocumentFragment();

  /// @brief Method CreateElement addr 0x2708f78 size 0xb0 virtual false final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW name);

  /// @brief Method AddDefaultAttributes addr 0x2709028 size 0x288 virtual false final false
  inline void AddDefaultAttributes(::System::Xml::XmlElement* elem);

  /// @brief Method GetSchemaElementDecl addr 0x27092b0 size 0x110 virtual false final false
  inline ::System::Xml::Schema::SchemaElementDecl* GetSchemaElementDecl(::System::Xml::XmlElement* elem);

  /// @brief Method PrepareDefaultAttribute addr 0x27093c0 size 0xfc virtual false final false
  ...
  /// @brief Method CreateEntityReference addr 0x27094bc size 0x74 virtual true final false
  inline ::System::Xml::XmlEntityReference* CreateEntityReference(::StringW name);

  /// @brief Method CreateProcessingInstruction addr 0x2709530 size 0x7c virtual true final false
  inline ::System::Xml::XmlProcessingInstruction* CreateProcessingInstruction(::StringW target, ::StringW data);

  /// @brief Method CreateXmlDeclaration addr 0x27095ac size 0x88 virtual true final false
  inline ::System::Xml::XmlDeclaration* CreateXmlDeclaration(::StringW version, ::StringW encoding, ::StringW standalone);

  /// @brief Method CreateTextNode addr 0x2709634 size 0x74 virtual true final false
  inline ::System::Xml::XmlText* CreateTextNode(::StringW text);

  /// @brief Method CreateSignificantWhitespace addr 0x27096a8 size 0x74 virtual true final false
  inline ::System::Xml::XmlSignificantWhitespace* CreateSignificantWhitespace(::StringW text);

  /// @brief Method CreateWhitespace addr 0x270971c size 0x74 virtual true final false
  inline ::System::Xml::XmlWhitespace* CreateWhitespace(::StringW text);

  /// @brief Method CreateAttribute addr 0x2709790 size 0xa4 virtual false final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW qualifiedName, ::StringW namespaceURI);

  /// @brief Method CreateElement addr 0x2709834 size 0xa4 virtual false final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW qualifiedName, ::StringW namespaceURI);

  /// @brief Method ImportNodeInternal addr 0x27098d8 size 0x4b0 virtual false final false
  inline ::System::Xml::XmlNode* ImportNodeInternal(::System::Xml::XmlNode* node, bool deep);

  /// @brief Method ImportAttributes addr 0x2709d88 size 0x114 virtual false final false
  inline void ImportAttributes(::System::Xml::XmlNode* fromElem, ::System::Xml::XmlNode* toElem);

  /// @brief Method ImportChildren addr 0x27084fc size 0x9c virtual false final false
  inline void ImportChildren(::System::Xml::XmlNode* fromNode, ::System::Xml::XmlNode* toNode, bool deep);

  /// @brief Method get_NameTable addr 0x2704484 size 0x1c virtual false final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method CreateAttribute addr 0x2709e9c size 0xa0 virtual true final false
  inline ::System::Xml::XmlAttribute* CreateAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method CreateDefaultAttribute addr 0x2709f3c size 0x8c virtual true final false
  inline ::System::Xml::XmlAttribute* CreateDefaultAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method CreateElement addr 0x2709fc8 size 0xb8 virtual true final false
  inline ::System::Xml::XmlElement* CreateElement(::StringW prefix, ::StringW localName, ::StringW namespaceURI);

  /// @brief Method get_IsReadOnly addr 0x270a080 size 0x8 virtual true final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Entities addr 0x270a088 size 0x70 virtual false final false
  inline ::System::Xml::XmlNamedNodeMap* get_Entities();

  /// @brief Method set_Entities addr 0x270a0f8 size 0x8 virtual false final false
  inline void set_Entities(::System::Xml::XmlNamedNodeMap* value);

  /// @brief Method get_IsLoading addr 0x270a100 size 0x8 virtual false final false
  inline bool get_IsLoading();

  /// @brief Method set_IsLoading addr 0x270a108 size 0xc virtual false final false
  inline void set_IsLoading(bool value);

  /// @brief Method get_ActualLoadingStatus addr 0x270a114 size 0x8 virtual false final false
  inline bool get_ActualLoadingStatus();

  /// @brief Method SetupReader addr 0x270a11c size 0x6c virtual false final false
  inline ::System::Xml::XmlTextReader* SetupReader(::System::Xml::XmlTextReader* tr);

  /// @brief Method Load addr 0x270a188 size 0x114 virtual true final false
  inline void Load(::System::Xml::XmlReader* reader);

  /// @brief Method LoadXml addr 0x270a29c size 0x14c virtual true final false
  inline void LoadXml(::StringW xml);

  /// @brief Method set_InnerText addr 0x270a3e8 size 0x60 virtual true final false
  inline void set_InnerText(::StringW value);

  /// @brief Method set_InnerXml addr 0x270a448 size 0x10 virtual true final false
  inline void set_InnerXml(::StringW value);

  /// @brief Method GetEventArgs addr 0x270a458 size 0x100 virtual true final false
  ...
  /// @brief Method GetInsertEventArgsForLoad addr 0x270530c size 0xbc virtual false final false
  inline ::System::Xml::XmlNodeChangedEventArgs* GetInsertEventArgsForLoad(::System::Xml::XmlNode* node, ::System::Xml::XmlNode* newParent);

  /// @brief Method BeforeEvent addr 0x270a558 size 0x54 virtual true final false
  inline void BeforeEvent(::System::Xml::XmlNodeChangedEventArgs* args);

  /// @brief Method AfterEvent addr 0x270a5ac size 0x54 virtual true final false
  inline void AfterEvent(::System::Xml::XmlNodeChangedEventArgs* args);

  /// @brief Method GetDefaultAttribute addr 0x2706480 size 0x294 virtual false final false
  ...
  /// @brief Method GetEntityNode addr 0x270a600 size 0xc8 virtual false final false
  inline ::System::Xml::XmlEntity* GetEntityNode(::StringW name);

  /// @brief Method get_BaseURI addr 0x270a6c8 size 0x8 virtual true final false
  inline ::StringW get_BaseURI();

  /// @brief Method SetBaseURI addr 0x270a6d0 size 0x8 virtual false final false
  inline void SetBaseURI(::StringW inBaseURI);

  /// @brief Method AppendChildForLoad addr 0x270a6d8 size 0x1d4 virtual true final false
