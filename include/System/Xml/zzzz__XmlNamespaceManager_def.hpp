...
public:
  // Declarations
  /// @brief Method Set, addr 0x2ebd150, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNamespace, addr 0x2ebd2bc, size 0x3a4, virtual true, abstract: false, final false
  inline void AddNamespace(::StringW prefix, ::StringW uri);

  /// @brief Method GetEnumerator, addr 0x2ebd928, size 0x170, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetNamespacesInScope, addr 0x2ebda98, size 0x1b8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope scope);

  /// @brief Method LookupNamespace, addr 0x2ebdc50, size 0x4c, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupNamespaceDecl, addr 0x2ebd660, size 0x18c, virtual false, abstract: false, final false
  inline int32_t LookupNamespaceDecl(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x2ebdc9c, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method PopScope, addr 0x2ebd1e4, size 0xd8, virtual true, abstract: false, final false
  inline bool PopScope();

  /// @brief Method PushScope, addr 0x2ebd1d4, size 0x10, virtual true, abstract: false, final false
  inline void PushScope();

  /// @brief Method RemoveNamespace, addr 0x2ebd7ec, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ebcf8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2ebcf94, size 0x1bc, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nameTable);

  /// @brief Method get_DefaultNamespace, addr 0x2ebd164, size 0x70, virtual true, abstract: false, final false
  inline ::StringW get_DefaultNamespace();

  /// @brief Method get_NameTable, addr 0x2ebd15c, size 0x8, virtual true, abstract: false, final false
