...
// Write type traits
MARK_REF_T(::System::Xml::XmlNamespaceManager*);
MARK_VAL_T(::System::Xml::XmlNamespaceManager_NamespaceDeclaration);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlNamespaceManager*, "System.Xml", "XmlNamespaceManager");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlNamespaceManager_NamespaceDeclaration, "System.Xml", "XmlNamespaceManager/NamespaceDeclaration");
// Dependencies
namespace System::Xml {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method Set, addr 0x62e0378, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlNamespaceManager_NamespaceDeclaration) == 0x18, "Size mismatch!");

} // namespace System::Xml
// Dependencies System.Object, System.Xml.XmlNamespaceManager::NamespaceDeclaration
namespace System::Xml {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_nsdecls, put = __cordl_internal_set_nsdecls)) ::ArrayW<::System::Xml::XmlNamespaceManager_NamespaceDeclaration> nsdecls;
  ...
  /// @brief Method AddNamespace, addr 0x62e04c8, size 0x3d8, virtual true, abstract: false, final false
  inline void AddNamespace(::StringW prefix, ::StringW uri);

  /// @brief Method GetEnumerator, addr 0x62e0b68, size 0x1a8, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetNamespacesInScope, addr 0x62e0d10, size 0x1ec, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope scope);

  /// @brief Method LookupNamespace, addr 0x62e0efc, size 0x4c, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupNamespaceDecl, addr 0x62e08a0, size 0x190, virtual false, abstract: false, final false
  inline int32_t LookupNamespaceDecl(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x62e0f48, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method PopScope, addr 0x62e03d8, size 0xf0, virtual true, abstract: false, final false
  inline bool PopScope();

  /// @brief Method PushScope, addr 0x62e03c8, size 0x10, virtual true, abstract: false, final false
  inline void PushScope();

  /// @brief Method RemoveNamespace, addr 0x62e0a30, size 0x138, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::System::Xml::XmlNamespaceManager_NamespaceDeclaration> const& __cordl_internal_get_nsdecls() const;

  constexpr ::ArrayW<::System::Xml::XmlNamespaceManager_NamespaceDeclaration>& __cordl_internal_get_nsdecls();
  ...
  constexpr void __cordl_internal_set_nsdecls(::ArrayW<::System::Xml::XmlNamespaceManager_NamespaceDeclaration> value);
  ...
  /// @brief Method .ctor, addr 0x62e01bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x62e01c0, size 0x1b8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nameTable);

  /// @brief Method get_DefaultNamespace, addr 0x62e038c, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW get_DefaultNamespace();

  /// @brief Method get_NameTable, addr 0x62e0384, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlNamespaceManager) == 0x50, "Size mismatch!");
