...
public:
// Declarations
/// @brief Method Set, addr 0x61a527c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field nsdecls, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_nsdecls, put=__cordl_internal_set_nsdecls)) ::ArrayW<::System::Xml::XmlNamespaceManager_NamespaceDeclaration,::Array<::System::Xml::XmlNamespaceManager_NamespaceDeclaration>*>  nsdecls;
...
/// @brief Method AddNamespace, addr 0x61a53cc, size 0x3d8, virtual true, abstract: false, final false
inline void AddNamespace(::StringW  prefix, ::StringW  uri) ;

/// @brief Method GetEnumerator, addr 0x61a5a6c, size 0x1a8, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method GetNamespacesInScope, addr 0x61a5c14, size 0x1ec, virtual true, abstract: false, final false
inline ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope  scope) ;

/// @brief Method LookupNamespace, addr 0x61a5e00, size 0x4c, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupNamespaceDecl, addr 0x61a57a4, size 0x190, virtual false, abstract: false, final false
inline int32_t LookupNamespaceDecl(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x61a5e4c, size 0xc4, virtual true, abstract: false, final false
...
/// @brief Method PopScope, addr 0x61a52dc, size 0xf0, virtual true, abstract: false, final false
inline bool PopScope() ;

/// @brief Method PushScope, addr 0x61a52cc, size 0x10, virtual true, abstract: false, final false
inline void PushScope() ;

/// @brief Method RemoveNamespace, addr 0x61a5934, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61a50c0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x61a50c4, size 0x1b8, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNameTable*  nameTable) ;

/// @brief Method get_DefaultNamespace, addr 0x61a5290, size 0x3c, virtual true, abstract: false, final false
inline ::StringW get_DefaultNamespace() ;

/// @brief Method get_NameTable, addr 0x61a5288, size 0x8, virtual true, abstract: false, final false
