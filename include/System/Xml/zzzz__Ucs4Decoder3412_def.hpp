...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x62dee40, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62de2d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
