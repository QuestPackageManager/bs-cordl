...
public:
  ...
  /// @brief Method Close, addr 0x432c32c, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Create, addr 0x432cae4, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlWriter* Create(::System::IO::Stream* output, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method Create, addr 0x432d048, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlWriter* Create(::System::IO::TextWriter* output, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method Dispose, addr 0x432ca8c, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x432caa0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAttributeString, addr 0x432c208, size 0x5c, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteAttributeString, addr 0x432c264, size 0x5c, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW localName, ::StringW value);

  /// @brief Method WriteAttributeString, addr 0x432c2c0, size 0x50, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW prefix, ::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteAttributes, addr 0x432c348, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBinHex, addr 0x432c310, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteElementString, addr 0x432ca28, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteNode, addr 0x432c5c4, size 0x464, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteStartElement, addr 0x432c1f0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValue, addr 0x432c330, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x432d3ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
