...
public:
  ...
  /// @brief Method Close, addr 0x2eb687c, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Create, addr 0x2eb7040, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlWriter* Create(::System::IO::Stream* output, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method Create, addr 0x2eb75e0, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlWriter* Create(::System::IO::TextWriter* output, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method Dispose, addr 0x2eb6fe8, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2eb6ffc, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAttributeString, addr 0x2eb6758, size 0x5c, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteAttributeString, addr 0x2eb67b4, size 0x5c, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW localName, ::StringW value);

  /// @brief Method WriteAttributeString, addr 0x2eb6810, size 0x50, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW prefix, ::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteAttributes, addr 0x2eb6898, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBinHex, addr 0x2eb6860, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteElementString, addr 0x2eb6f84, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteNode, addr 0x2eb6b1c, size 0x468, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteStartElement, addr 0x2eb6740, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValue, addr 0x2eb6880, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2eb7968, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
