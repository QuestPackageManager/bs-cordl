...
/// @brief Method Close, addr 0x60f528c, size 0x4, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Create, addr 0x60f5fbc, size 0x74, virtual false, abstract: false, final false
static inline ::System::Xml::XmlWriter* Create(::System::IO::Stream*  output, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method Create, addr 0x60f6590, size 0x74, virtual false, abstract: false, final false
static inline ::System::Xml::XmlWriter* Create(::System::IO::TextWriter*  output, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method Dispose, addr 0x60f5f64, size 0x14, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x60f5f78, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method WriteAttributeString, addr 0x60f5184, size 0x5c, virtual false, abstract: false, final false
inline void WriteAttributeString(::StringW  localName, ::StringW  ns, ::StringW  value) ;

/// @brief Method WriteAttributeString, addr 0x60f51e0, size 0x5c, virtual false, abstract: false, final false
inline void WriteAttributeString(::StringW  localName, ::StringW  value) ;

/// @brief Method WriteAttributeString, addr 0x60f523c, size 0x50, virtual false, abstract: false, final false
inline void WriteAttributeString(::StringW  prefix, ::StringW  localName, ::StringW  ns, ::StringW  value) ;

/// @brief Method WriteAttributes, addr 0x60f57c8, size 0x278, virtual true, abstract: false, final false
...
/// @brief Method WriteBinHex, addr 0x60f3c28, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method WriteElementString, addr 0x60f5f00, size 0x64, virtual false, abstract: false, final false
inline void WriteElementString(::StringW  localName, ::StringW  ns, ::StringW  value) ;

/// @brief Method WriteElementString, addr 0x60f5ef4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method WriteNode, addr 0x60f5a40, size 0x4b4, virtual true, abstract: false, final false
...
/// @brief Method WriteQualifiedName, addr 0x60f52ac, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method WriteStartElement, addr 0x60f516c, size 0x18, virtual false, abstract: false, final false
inline void WriteStartElement(::StringW  localName) ;

/// @brief Method WriteStartElement, addr 0x60f5154, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method WriteValue, addr 0x60f53fc, size 0x18, virtual true, abstract: false, final false
inline void WriteValue(::StringW  value) ;

/// @brief Method WriteValue, addr 0x60f5494, size 0x84, virtual true, abstract: false, final false
inline void WriteValue(::System::DateTime  value) ;

/// @brief Method WriteValue, addr 0x60f5618, size 0x88, virtual true, abstract: false, final false
inline void WriteValue(::System::Decimal  value) ;

/// @brief Method WriteValue, addr 0x60f5414, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(bool  value) ;

/// @brief Method WriteValue, addr 0x60f5518, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(double_t  value) ;

/// @brief Method WriteValue, addr 0x60f5598, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(float_t  value) ;

/// @brief Method WriteValue, addr 0x60f56a0, size 0x94, virtual true, abstract: false, final false
inline void WriteValue(int32_t  value) ;

/// @brief Method WriteValue, addr 0x60f5734, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60ed5c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_XmlLang, addr 0x60f5298, size 0x14, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x60f5290, size 0x8, virtual true, abstract: false, final false
