...
public:
  ...
  /// @brief Method Close, addr 0x2d88e78, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Create, addr 0x2d8963c, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlWriter* Create(::System::IO::Stream* output, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method Create, addr 0x2d89bdc, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlWriter* Create(::System::IO::TextWriter* output, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method Dispose, addr 0x2d895e4, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2d895f8, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAttributeString, addr 0x2d88d54, size 0x5c, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteAttributeString, addr 0x2d88db0, size 0x5c, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW localName, ::StringW value);

  /// @brief Method WriteAttributeString, addr 0x2d88e0c, size 0x50, virtual false, abstract: false, final false
  inline void WriteAttributeString(::StringW prefix, ::StringW localName, ::StringW ns, ::StringW value);

  /// @brief Method WriteAttributes, addr 0x2d88e94, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBinHex, addr 0x2d88e5c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteElementString, addr 0x2d89580, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteNode, addr 0x2d89118, size 0x468, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteStartElement, addr 0x2d88d3c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValue, addr 0x2d88e7c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d89f64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
