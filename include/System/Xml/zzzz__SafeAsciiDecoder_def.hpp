...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SafeAsciiDecoder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SafeAsciiDecoder(SafeAsciiDecoder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SafeAsciiDecoder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SafeAsciiDecoder(SafeAsciiDecoderconst&) = delete;
