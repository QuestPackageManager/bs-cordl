...
DEFINE_IL2CPP_CLASS(::System::Xml::ExceptionType, "System.Xml", "ExceptionType");
// Dependencies
namespace System::Xml {
// Is value type: true
...
public:
  ...
  /// @brief Field ArgumentException value: I32(0)
  static ::System::Xml::ExceptionType const ArgumentException;

  /// @brief Field XmlException value: I32(1)
...
static_assert(sizeof(::System::Xml::ExceptionType) == 0x4, "Size mismatch!");
