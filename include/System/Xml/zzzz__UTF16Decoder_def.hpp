...
public:
  ...
  /// @brief Method Convert, addr 0x61a0d14, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x61a0ab4, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x61a0ac4, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetChars, addr 0x61a0b9c, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a0aa4, size 0x10, virtual false, abstract: false, final false
