...
public:
  ...
  /// @brief Method .ctor, addr 0x28a54c4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool bigEndian);

  /// @brief Method GetCharCount, addr 0x28a54f4, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x28a5504, size 0xec, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetChars, addr 0x28a55f0, size 0x238, virtual true, abstract: false, final false
  inline int32_t GetChars(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t charIndex);

  /// @brief Method Convert, addr 0x28a5828, size 0x298, virtual true, abstract: false, final false
