...
public:
  ...
  /// @brief Method Convert, addr 0x435f8f0, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharCount, addr 0x435f688, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count);

  /// @brief Method GetCharCount, addr 0x435f698, size 0xe4, virtual true, abstract: false, final false
  inline int32_t GetCharCount(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t index, int32_t count, bool flush);

  /// @brief Method GetChars, addr 0x435f77c, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x435f658, size 0x30, virtual false, abstract: false, final false
