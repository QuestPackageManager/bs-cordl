...
public:
  ...
  /// @brief Method BuildCharExceptionArgs, addr 0x61a34c0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildCharExceptionArgs, addr 0x61999a0, size 0x54, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> BuildCharExceptionArgs(::StringW data, int32_t invCharIndex);

  /// @brief Method BuildCharExceptionArgs, addr 0x619ee80, size 0x25c, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> BuildCharExceptionArgs(char16_t invChar, char16_t nextChar);

  /// @brief Method CreateMessage, addr 0x61a2778, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatUserMessage, addr 0x61a2cb0, size 0xe4, virtual false, abstract: false, final false
  static inline ::StringW FormatUserMessage(::StringW message, int32_t lineNumber, int32_t linePosition);

  /// @brief Method GetObjectData, addr 0x61a29c8, size 0x184, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a2b4c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x61a23cc, size 0x3ac, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x61a2b64, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x61a2b80, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x61a2b78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x61a2b90, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61998e8, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg);

  /// @brief Method .ctor, addr 0x61a3104, size 0x1e4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::System::Exception* innerException, ::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method .ctor, addr 0x61a2ed8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method .ctor, addr 0x619e7c4, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x61a32f0, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, int32_t lineNumber, int32_t linePosition, ::StringW sourceUri);

  /// @brief Method .ctor, addr 0x61a2e14, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::StringW arg, ::StringW sourceUri);

  /// @brief Method .ctor, addr 0x61999f4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method .ctor, addr 0x61a3444, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a2d94, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a32e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Xml::IXmlLineInfo* lineInfo);

  /// @brief Method .ctor, addr 0x61a2f70, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Xml::IXmlLineInfo* lineInfo, ::StringW sourceUri);

  /// @brief Method .ctor, addr 0x619ea50, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, int32_t lineNumber, int32_t linePosition);

  /// @brief Method .ctor, addr 0x61a33c8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LineNumber, addr 0x61a3514, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x61a351c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePosition();

  /// @brief Method get_Message, addr 0x61a3524, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_ResString, addr 0x61a353c, size 0x8, virtual false, abstract: false, final false
