...
public:
  // Declarations
  /// @brief Method CheckPrefixNS, addr 0x61a68fc, size 0xdc, virtual false, abstract: false, final false
  inline void CheckPrefixNS(::StringW prefix, ::StringW namespaceUri);

  /// @brief Method Clear, addr 0x61a6850, size 0x1c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Equals, addr 0x61a6b04, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetHashCode, addr 0x61a69d8, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetNSHashCode, addr 0x61a6a20, size 0x44, virtual false, abstract: false, final false
  inline int32_t GetNSHashCode(::System::Xml::SecureStringHasher* hasher);

  /// @brief Method MatchNs, addr 0x61a686c, size 0x48, virtual false, abstract: false, final false
  inline bool MatchNs(::StringW lname, ::StringW nsUri);

  /// @brief Method MatchPrefix, addr 0x61a68b4, size 0x48, virtual false, abstract: false, final false
  inline bool MatchPrefix(::StringW prefix, ::StringW lname);

  /// @brief Method Set, addr 0x61a6844, size 0xc, virtual false, abstract: false, final false
  inline void Set(::StringW prefix, ::StringW lname, ::StringW nsUri);

  /// @brief Method ToString, addr 0x61a6bfc, size 0x74, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x61a6838, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW prefix, ::StringW lname, ::StringW nsUri);

  /// @brief Method op_Equality, addr 0x61a6ba8, size 0x54, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Clear, addr 0x61a6c8c, size 0x10, virtual false, abstract: false, final false
  inline ::System::Xml::XmlSqlBinaryReader_NamespaceDecl* Clear();

  /// @brief Method Set, addr 0x61a6c70, size 0x1c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method AdjustPosition, addr 0x61a6d34, size 0x14, virtual false, abstract: false, final false
  inline void AdjustPosition(int32_t adj);

  /// @brief Method GetLocalnameAndNamespaceUri, addr 0x61a6cd4, size 0x14, virtual false, abstract: false, final false
  inline void GetLocalnameAndNamespaceUri(::by_ref<::StringW> localname, ::by_ref<::StringW> namespaceUri);

  /// @brief Method GetLocalnameAndNamespaceUriAndHash, addr 0x61a6ce8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchHashNS, addr 0x61a6d14, size 0x20, virtual false, abstract: false, final false
  inline bool MatchHashNS(int32_t hash, ::StringW localname, ::StringW namespaceUri);

  /// @brief Method MatchNS, addr 0x61a6d10, size 0x4, virtual false, abstract: false, final false
  inline bool MatchNS(::StringW localname, ::StringW namespaceUri);

  /// @brief Method Set, addr 0x61a6cb8, size 0x1c, virtual false, abstract: false, final false
  inline void Set(::System::Xml::XmlSqlBinaryReader_QName n, int32_t pos);

  /// @brief Method Set, addr 0x61a6c9c, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x61a6d48, size 0x14, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Init, addr 0x61a6d5c, size 0xb4, virtual false, abstract: false, final false
  inline void Init();
...
public:
  ...
  /// @brief Method .ctor, addr 0x61a6e10, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddInitNamespace, addr 0x6191940, size 0xe0, virtual false, abstract: false, final false
  inline void AddInitNamespace(::StringW prefix, ::StringW uri);

  /// @brief Method AddName, addr 0x61998ec, size 0x114, virtual false, abstract: false, final false
  inline void AddName();

  /// @brief Method AddQName, addr 0x6199ac4, size 0x264, virtual false, abstract: false, final false
  inline void AddQName();

  /// @brief Method CDATAValue, addr 0x61927e0, size 0x108, virtual false, abstract: false, final false
  inline ::StringW CDATAValue();

  /// @brief Method CheckAllowContent, addr 0x619c484, size 0x64, virtual false, abstract: false, final false
  inline void CheckAllowContent();

  /// @brief Method CheckText, addr 0x619c590, size 0x1b0, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType CheckText(bool attr);

  /// @brief Method CheckTextIsWS, addr 0x619c740, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType CheckTextIsWS();

  /// @brief Method CheckValueTokenBounds, addr 0x619cc6c, size 0x5c, virtual false, abstract: false, final false
  inline void CheckValueTokenBounds();

  /// @brief Method ClearAttributes, addr 0x619a944, size 0x10, virtual false, abstract: false, final false
  inline void ClearAttributes();

  /// @brief Method Close, addr 0x6193ff0, size 0x6c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Fill, addr 0x6199ec4, size 0x1c, virtual false, abstract: false, final false
  inline void Fill(int32_t require);

  /// @brief Method FillAllowEOF, addr 0x6199f64, size 0x214, virtual false, abstract: false, final false
  inline bool FillAllowEOF();

  /// @brief Method Fill_, addr 0x619a178, size 0x78, virtual false, abstract: false, final false
  inline void Fill_(int32_t require);

  /// @brief Method FinishCDATA, addr 0x619b7b8, size 0xa0, virtual false, abstract: false, final false
  inline void FinishCDATA();

  /// @brief Method FinishContentAsXXX, addr 0x6194d50, size 0xc8, virtual false, abstract: false, final false
  inline int32_t FinishContentAsXXX(int32_t origPos);

  /// @brief Method FinishEndElement, addr 0x619b858, size 0x54, virtual false, abstract: false, final false
  inline void FinishEndElement();

  /// @brief Method GenerateImpliedXmlnsAttrs, addr 0x619ac54, size 0x108, virtual false, abstract: false, final false
  inline void GenerateImpliedXmlnsAttrs();

  /// @brief Method GenerateTokenTypeMap, addr 0x6191a20, size 0xa1c, virtual false, abstract: false, final false
  inline void GenerateTokenTypeMap();

  /// @brief Method GetAttribute, addr 0x619377c, size 0x90, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0x6193628, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetAttribute, addr 0x61934d0, size 0xcc, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name, ::StringW ns);

  /// @brief Method GetAttributeText, addr 0x6193178, size 0x138, virtual false, abstract: false, final false
  inline ::StringW GetAttributeText(int32_t i);

  /// @brief Method GetDouble, addr 0x619d178, size 0xd4, virtual false, abstract: false, final false
  inline double_t GetDouble(int32_t offset);

  /// @brief Method GetInt16, addr 0x619cda0, size 0x44, virtual false, abstract: false, final false
  inline int16_t GetInt16(int32_t pos);

  /// @brief Method GetInt32, addr 0x619cde4, size 0x74, virtual false, abstract: false, final false
  inline int32_t GetInt32(int32_t pos);

  /// @brief Method GetInt64, addr 0x619ce58, size 0xd0, virtual false, abstract: false, final false
  inline int64_t GetInt64(int32_t pos);

  /// @brief Method GetSingle, addr 0x619d100, size 0x78, virtual false, abstract: false, final false
  inline float_t GetSingle(int32_t offset);

  /// @brief Method GetString, addr 0x6192684, size 0x15c, virtual false, abstract: false, final false
  inline ::StringW GetString(int32_t pos, int32_t cch);

  /// @brief Method GetStringAligned, addr 0x619a804, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW GetStringAligned(::ArrayW<uint8_t> data, int32_t offset, int32_t cch);

  /// @brief Method GetUInt16, addr 0x619cf28, size 0x44, virtual false, abstract: false, final false
  inline uint16_t GetUInt16(int32_t pos);

  /// @brief Method GetUInt32, addr 0x619cf6c, size 0x74, virtual false, abstract: false, final false
  inline uint32_t GetUInt32(int32_t pos);

  /// @brief Method GetUInt64, addr 0x619cfe0, size 0xd0, virtual false, abstract: false, final false
  inline uint64_t GetUInt64(int32_t pos);

  /// @brief Method GetValueConverter, addr 0x619d694, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlValueConverter* GetValueConverter(::System::Xml::Schema::XmlTypeCode typeCode);

  /// @brief Method GetValueType, addr 0x6193f20, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Type* GetValueType(::System::Xml::BinXmlToken token);

  /// @brief Method GetXsdKatmaiTokenLength, addr 0x619cb84, size 0xe8, virtual false, abstract: false, final false
  inline int32_t GetXsdKatmaiTokenLength(::System::Xml::BinXmlToken token);

  /// @brief Method GrowAttributes, addr 0x619a8bc, size 0x88, virtual false, abstract: false, final false
  inline void GrowAttributes();

  /// @brief Method GrowElements, addr 0x619a830, size 0x8c, virtual false, abstract: false, final false
  inline void GrowElements();

  /// @brief Method HashCheckForDuplicateAttributes, addr 0x619b568, size 0x250, virtual false, abstract: false, final false
  inline void HashCheckForDuplicateAttributes();

  /// @brief Method ImplReadCDATA, addr 0x619beb4, size 0x34, virtual false, abstract: false, final false
  inline void ImplReadCDATA();

  /// @brief Method ImplReadComment, addr 0x619be88, size 0x2c, virtual false, abstract: false, final false
  inline void ImplReadComment();

  /// @brief Method ImplReadData, addr 0x619c30c, size 0x178, virtual false, abstract: false, final false
  inline void ImplReadData(::System::Xml::BinXmlToken tokenType);

  /// @brief Method ImplReadDoctype, addr 0x619bbc4, size 0x260, virtual false, abstract: false, final false
  inline void ImplReadDoctype();

  /// @brief Method ImplReadElement, addr 0x619b8ac, size 0x24c, virtual false, abstract: false, final false
  inline void ImplReadElement();

  /// @brief Method ImplReadEndElement, addr 0x619baf8, size 0xcc, virtual false, abstract: false, final false
  inline void ImplReadEndElement();

  /// @brief Method ImplReadEndNest, addr 0x619bf78, size 0x2c, virtual false, abstract: false, final false
  inline void ImplReadEndNest();

  /// @brief Method ImplReadNest, addr 0x619bee8, size 0x90, virtual false, abstract: false, final false
  inline void ImplReadNest();

  /// @brief Method ImplReadPI, addr 0x619be24, size 0x64, virtual false, abstract: false, final false
  inline void ImplReadPI();

  /// @brief Method ImplReadXmlText, addr 0x619bfa4, size 0x368, virtual false, abstract: false, final false
  inline void ImplReadXmlText();

  /// @brief Method LocateAttribute, addr 0x6193694, size 0xe8, virtual false, abstract: false, final false
  inline int32_t LocateAttribute(::StringW name);

  /// @brief Method LocateAttribute, addr 0x619359c, size 0x8c, virtual false, abstract: false, final false
  inline int32_t LocateAttribute(::StringW name, ::StringW ns);

  /// @brief Method LookupNamespace, addr 0x6194064, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method MoveToAttribute, addr 0x61939d0, size 0x7c, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0x619380c, size 0xdc, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name, ::StringW ns);

  /// @brief Method MoveToAttribute, addr 0x6193a4c, size 0xa4, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0x6193be4, size 0xbc, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0x6193af0, size 0x70, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x6193b60, size 0x84, virtual true, abstract: false, final false
  inline bool MoveToNextAttribute();

  /// @brief Method NameFlush, addr 0x6199dac, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method NextToken, addr 0x619a6b0, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken NextToken();

  /// @brief Method NextToken1, addr 0x619a638, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken NextToken1();

  /// @brief Method NextToken2, addr 0x619a5c0, size 0x78, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken NextToken2(::System::Xml::BinXmlToken token);

  /// @brief Method ParseMB32, addr 0x6199e98, size 0x2c, virtual false, abstract: false, final false
  inline int32_t ParseMB32();

  /// @brief Method ParseMB32, addr 0x619a3d0, size 0xec, virtual false, abstract: false, final false
  inline int32_t ParseMB32(int32_t pos);

  /// @brief Method ParseMB32_, addr 0x619a338, size 0x98, virtual false, abstract: false, final false
  inline int32_t ParseMB32_(uint8_t b);

  /// @brief Method ParseMB64, addr 0x619a4bc, size 0x2c, virtual false, abstract: false, final false
  inline int32_t ParseMB64();

  /// @brief Method ParseText, addr 0x6199a00, size 0xc4, virtual false, abstract: false, final false
  inline ::StringW ParseText();

  /// @brief Method PeekNextToken, addr 0x619a718, size 0x28, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken PeekNextToken();

  /// @brief Method PeekToken, addr 0x619a4e8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken PeekToken();

  /// @brief Method PopNamespaces, addr 0x619ab94, size 0xc0, virtual false, abstract: false, final false
  inline void PopNamespaces(::System::Xml::XmlSqlBinaryReader_NamespaceDecl* firstInScopeChain);

  /// @brief Method PositionOnAttribute, addr 0x6193904, size 0xcc, virtual false, abstract: false, final false
  inline void PositionOnAttribute(int32_t i);

  /// @brief Method PushNamespace, addr 0x619a954, size 0x240, virtual false, abstract: false, final false
  inline void PushNamespace(::StringW prefix, ::StringW ns, bool implied);

  /// @brief Method ReScanOverValue, addr 0x6193f14, size 0xc, virtual false, abstract: false, final false
  inline void ReScanOverValue(::System::Xml::BinXmlToken token);

  /// @brief Method Read, addr 0x61941e0, size 0x1cc, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAttributeValue, addr 0x6193cb0, size 0x168, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadByte, addr 0x619a268, size 0x5c, virtual false, abstract: false, final false
  inline uint8_t ReadByte();

  /// @brief Method ReadContentAs, addr 0x61986fc, size 0x46c, virtual true, abstract: false, final false
  inline ::System::Object* ReadContentAs(::System::Type* returnType, ::System::Xml::IXmlNamespaceResolver* namespaceResolver);

  /// @brief Method ReadContentAsBoolean, addr 0x6194e98, size 0x494, virtual true, abstract: false, final false
  inline bool ReadContentAsBoolean();

  /// @brief Method ReadContentAsDateTime, addr 0x619532c, size 0x53c, virtual true, abstract: false, final false
  inline ::System::DateTime ReadContentAsDateTime();

  /// @brief Method ReadContentAsDecimal, addr 0x6196758, size 0x548, virtual true, abstract: false, final false
  inline ::System::Decimal ReadContentAsDecimal();

  /// @brief Method ReadContentAsDouble, addr 0x6195ba4, size 0x530, virtual true, abstract: false, final false
  inline double_t ReadContentAsDouble();

  /// @brief Method ReadContentAsFloat, addr 0x619622c, size 0x52c, virtual true, abstract: false, final false
  inline float_t ReadContentAsFloat();

  /// @brief Method ReadContentAsInt, addr 0x6196ee0, size 0x58c, virtual true, abstract: false, final false
  inline int32_t ReadContentAsInt();

  /// @brief Method ReadContentAsLong, addr 0x61976ac, size 0x53c, virtual true, abstract: false, final false
  inline int64_t ReadContentAsLong();

  /// @brief Method ReadContentAsObject, addr 0x6197be8, size 0x394, virtual true, abstract: false, final false
  inline ::System::Object* ReadContentAsObject();

  /// @brief Method ReadDoc, addr 0x61947c4, size 0x398, virtual false, abstract: false, final false
  inline bool ReadDoc();

  /// @brief Method ReadInit, addr 0x61943ac, size 0x418, virtual false, abstract: false, final false
  inline bool ReadInit(bool skipXmlDecl);

  /// @brief Method ReadNameRef, addr 0x6199d28, size 0x84, virtual false, abstract: false, final false
  inline int32_t ReadNameRef();

  /// @brief Method ReadQNameRef, addr 0x6199ee0, size 0x84, virtual false, abstract: false, final false
  inline int32_t ReadQNameRef();

  /// @brief Method ReadToken, addr 0x619a550, size 0x70, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken ReadToken();

  /// @brief Method ReadUShort, addr 0x619a2c4, size 0x74, virtual false, abstract: false, final false
  inline uint16_t ReadUShort();

  /// @brief Method RescanNextToken, addr 0x6193e18, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Xml::BinXmlToken RescanNextToken();

  /// @brief Method ResolveEntity, addr 0x6194124, size 0x38, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method ScanAttributes, addr 0x619ad5c, size 0x498, virtual false, abstract: false, final false
  inline void ScanAttributes();

  /// @brief Method ScanOverAnyValue, addr 0x619c7dc, size 0x3a8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType ScanOverAnyValue(::System::Xml::BinXmlToken token, bool attr, bool checkChars);

  /// @brief Method ScanOverValue, addr 0x619b2c8, size 0x148, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType ScanOverValue(::System::Xml::BinXmlToken token, bool attr, bool checkChars);

  /// @brief Method ScanText, addr 0x619a740, size 0xc4, virtual false, abstract: false, final false
  inline int32_t ScanText(::by_ref<int32_t> start);

  /// @brief Method SetupContentAsXXX, addr 0x6194b5c, size 0x1f4, virtual false, abstract: false, final false
  inline bool SetupContentAsXXX(::StringW name);

  /// @brief Method SimpleCheckForDuplicateAttributes, addr 0x619b410, size 0x158, virtual false, abstract: false, final false
  inline void SimpleCheckForDuplicateAttributes();

  /// @brief Method SkipExtn, addr 0x6199dfc, size 0x9c, virtual false, abstract: false, final false
  inline void SkipExtn();

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x6199314, size 0x3b4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x61996c8, size 0x1a4, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method ThrowNotSupported, addr 0x6194e18, size 0x80, virtual false, abstract: false, final false
  inline ::System::Exception* ThrowNotSupported(::StringW res);

  /// @brief Method ThrowUnexpectedToken, addr 0x61998a0, size 0x4c, virtual false, abstract: false, final false
  inline ::System::Exception* ThrowUnexpectedToken(::System::Xml::BinXmlToken token);

  /// @brief Method ThrowXmlException, addr 0x619a1f0, size 0x78, virtual false, abstract: false, final false
  inline ::System::Exception* ThrowXmlException(::StringW res);

  /// @brief Method ThrowXmlException, addr 0x619b1f4, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Exception* ThrowXmlException(::StringW res, ::StringW arg1, ::StringW arg2);

  /// @brief Method UpdateFromTextReader, addr 0x61938e8, size 0x1c, virtual false, abstract: false, final false
  inline bool UpdateFromTextReader(bool needUpdate);

  /// @brief Method UpdateFromTextReader, addr 0x619c4e8, size 0xa8, virtual false, abstract: false, final false
  inline void UpdateFromTextReader();

  /// @brief Method ValueAs, addr 0x6198b68, size 0x7ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ValueAsDateTime, addr 0x6195868, size 0x33c, virtual false, abstract: false, final false
  inline ::System::DateTime ValueAsDateTime();

  /// @brief Method ValueAsDateTimeOffset, addr 0x619d24c, size 0x10c, virtual false, abstract: false, final false
  inline ::System::DateTimeOffset ValueAsDateTimeOffset();

  /// @brief Method ValueAsDateTimeString, addr 0x619d358, size 0x33c, virtual false, abstract: false, final false
  inline ::StringW ValueAsDateTimeString();

  /// @brief Method ValueAsDecimal, addr 0x6196ca0, size 0x240, virtual false, abstract: false, final false
  inline ::System::Decimal ValueAsDecimal();

  /// @brief Method ValueAsDouble, addr 0x61960d4, size 0x158, virtual false, abstract: false, final false
  inline double_t ValueAsDouble();

  /// @brief Method ValueAsLong, addr 0x619746c, size 0x240, virtual false, abstract: false, final false
  inline int64_t ValueAsLong();

  /// @brief Method ValueAsObject, addr 0x6197f7c, size 0x780, virtual false, abstract: false, final false
  inline ::System::Object* ValueAsObject(::System::Xml::BinXmlToken token, bool returnInternalTypes);

  /// @brief Method ValueAsString, addr 0x6192a28, size 0x750, virtual false, abstract: false, final false
  inline ::StringW ValueAsString(::System::Xml::BinXmlToken token);

  /// @brief Method ValueAsULong, addr 0x619d0b0, size 0x50, virtual false, abstract: false, final false
  inline uint64_t ValueAsULong();

  /// @brief Method VerifyVersion, addr 0x619986c, size 0x34, virtual false, abstract: false, final false
  inline void VerifyVersion(int32_t requiredVersion, ::System::Xml::BinXmlToken token);

  /// @brief Method XmlDeclValue, addr 0x61928e8, size 0x140, virtual false, abstract: false, final false
  inline ::StringW XmlDeclValue();

  /// @brief Method XsdKatmaiTimeScaleToValueLength, addr 0x619ccc8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x619149c, size 0x4a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AttributeCount, addr 0x6193484, size 0x4c, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_BaseURI, addr 0x619334c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_Depth, addr 0x61932b0, size 0x9c, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_EOF, addr 0x6193ca0, size 0x10, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_IsEmptyElement, addr 0x6193354, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LocalName, addr 0x6192564, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NameTable, addr 0x619405c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceURI, addr 0x619256c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_NodeType, addr 0x619255c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x6192574, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_ReadState, addr 0x619415c, size 0x84, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_Settings, addr 0x619243c, size 0x120, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_Value, addr 0x619257c, size 0x108, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_ValueType, addr 0x619347c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* get_ValueType();

  /// @brief Method get_XmlLang, addr 0x61933f4, size 0x88, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x6193378, size 0x7c, virtual true, abstract: false, final false
