...
/// @brief Method Init, addr 0x5ff8d80, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method OutputRestAmps, addr 0x5ffa090, size 0x94, virtual false, abstract: false, final false
inline void OutputRestAmps() ;

/// @brief Method StartElementContent, addr 0x5ff9790, size 0x54, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method WriteCharEntity, addr 0x5ffa62c, size 0x50, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x5ffa6cc, size 0x88, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteDocType, addr 0x5ff91b0, size 0x258, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndAttribute, addr 0x5ffa004, size 0x8c, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndElement, addr 0x5ff98f4, size 0xf8, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteEntityRef, addr 0x5ffa5dc, size 0x50, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x5ff9b60, size 0xf8, virtual true, abstract: false, final false
inline void WriteFullEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteHtmlAttributeText, addr 0x5ffb1a0, size 0x2a0, virtual false, abstract: false, final false
inline void WriteHtmlAttributeText(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteHtmlAttributeTextBlock, addr 0x5ffa58c, size 0x40, virtual false, abstract: false, final false
inline void WriteHtmlAttributeTextBlock(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteHtmlElementTextBlock, addr 0x5ffa5cc, size 0x10, virtual false, abstract: false, final false
inline void WriteHtmlElementTextBlock(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteMetaElement, addr 0x5ff97e4, size 0x110, virtual false, abstract: false, final false
inline void WriteMetaElement() ;

/// @brief Method WriteProcessingInstruction, addr 0x5ffa124, size 0x128, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  target, ::StringW  text) ;

/// @brief Method WriteStartAttribute, addr 0x5ff9d64, size 0x17c, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x5ff9498, size 0x128, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteString, addr 0x5ffa528, size 0x64, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x5ffa67c, size 0x50, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteUriAttributeText, addr 0x5ffae00, size 0x3a0, virtual false, abstract: false, final false
inline void WriteUriAttributeText(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteXmlDeclaration, addr 0x5ff91a8, size 0x4, virtual true, abstract: false, final false
inline void WriteXmlDeclaration(::System::Xml::XmlStandalone  standalone) ;

/// @brief Method WriteXmlDeclaration, addr 0x5ff91ac, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ff8ee8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x5ff8c78, size 0x28, virtual false, abstract: false, final false
