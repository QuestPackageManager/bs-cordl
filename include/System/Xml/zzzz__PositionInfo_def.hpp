...
public:
  ...
  /// @brief Method GetPositionInfo, addr 0x43582a8, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::Xml::PositionInfo* GetPositionInfo(::System::Object* o);

  /// @brief Method HasLineInfo, addr 0x4358290, size 0x8, virtual true, abstract: false, final false
  inline bool HasLineInfo();

  static inline ::System::Xml::PositionInfo* New_ctor();

  /// @brief Method .ctor, addr 0x4358380, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LineNumber, addr 0x4358298, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x43582a0, size 0x8, virtual true, abstract: false, final false
