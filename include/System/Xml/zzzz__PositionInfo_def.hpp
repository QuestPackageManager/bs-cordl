...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PositionInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PositionInfo(PositionInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PositionInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PositionInfo(PositionInfoconst&) = delete;
