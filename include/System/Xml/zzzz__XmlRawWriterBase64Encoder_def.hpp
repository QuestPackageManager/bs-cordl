...
namespace System::Xml {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11302))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2851224, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlRawWriter* rawWriter);

  /// @brief Method WriteChars, addr 0x2851248, size 0x24, virtual true, abstract: false, final false
