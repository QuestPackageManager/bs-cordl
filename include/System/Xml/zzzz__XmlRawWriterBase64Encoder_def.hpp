...
// Write type traits
MARK_REF_T(::System::Xml::XmlRawWriterBase64Encoder*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlRawWriterBase64Encoder*, "System.Xml", "XmlRawWriterBase64Encoder");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlRawWriterBase64Encoder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlRawWriterBase64Encoder(XmlRawWriterBase64Encoder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlRawWriterBase64Encoder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlRawWriterBase64Encoder(XmlRawWriterBase64Encoderconst&) = delete;
...
static_assert(sizeof(::System::Xml::XmlRawWriterBase64Encoder) == 0x30, "Size mismatch!");
