...
public:
  ...
  /// @brief Method WriteChars, addr 0x5fde020, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fddffc, size 0x24, virtual false, abstract: false, final false
