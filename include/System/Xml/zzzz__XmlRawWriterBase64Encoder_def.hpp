...
public:
  ...
  /// @brief Method WriteChars, addr 0x2da74d4, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2da74b0, size 0x24, virtual false, abstract: false, final false
