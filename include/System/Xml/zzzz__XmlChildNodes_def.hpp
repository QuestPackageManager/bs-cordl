...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x6178664, size 0xd8, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method Item, addr 0x61785bc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61785b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Count, addr 0x6178618, size 0x4c, virtual true, abstract: false, final false
