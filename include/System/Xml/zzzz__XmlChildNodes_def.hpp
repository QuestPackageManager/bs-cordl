...
public:
  ...
  /// @brief Method .ctor, addr 0x2883ee0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Count, addr 0x2883f08, size 0x4c, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method GetEnumerator, addr 0x2883f54, size 0xb4, virtual true, abstract: false, final false
