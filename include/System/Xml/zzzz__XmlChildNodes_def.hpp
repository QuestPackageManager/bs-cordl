...
public:
  ...
  /// @brief Method .ctor addr 0x2706ec0 size 0x28 virtual false final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Count addr 0x2706ee8 size 0x4c virtual true final false
  inline int32_t get_Count();

  /// @brief Method GetEnumerator addr 0x2706f34 size 0xb4 virtual true final false
