...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x2eb0978, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method Item, addr 0x2eb08d0, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2eb08a8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Count, addr 0x2eb092c, size 0x4c, virtual true, abstract: false, final false
