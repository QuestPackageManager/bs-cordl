...
namespace System::Xml {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11421))]
// Self: TypeDefinitionIndex(TypeDefinitionIndex(11400))
...
public:
  ...
  /// @brief Method .ctor, addr 0x2887548, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNode* container);

  /// @brief Method get_Count, addr 0x2887570, size 0x4c, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method GetEnumerator, addr 0x28875bc, size 0xb4, virtual true, abstract: false, final false
