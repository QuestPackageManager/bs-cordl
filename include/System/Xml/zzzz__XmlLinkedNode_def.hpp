...
public:
  ...
  /// @brief Method .ctor, addr 0x43358c0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDocument* doc);

  /// @brief Method get_NextSibling, addr 0x433da30, size 0x50, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* get_NextSibling();

  /// @brief Method get_PreviousSibling, addr 0x433d9c8, size 0x68, virtual true, abstract: false, final false
