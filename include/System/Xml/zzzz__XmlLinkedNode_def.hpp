...
public:
  ...
  /// @brief Method .ctor addr 0x270afe8 size 0x18 virtual false final false
  inline void _ctor(::System::Xml::XmlDocument* doc);

  /// @brief Method get_PreviousSibling addr 0x270d37c size 0x68 virtual true final false
  inline ::System::Xml::XmlNode* get_PreviousSibling();

  /// @brief Method get_NextSibling addr 0x270d3e4 size 0x50 virtual true final false
