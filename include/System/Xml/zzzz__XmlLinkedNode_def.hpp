...
public:
  ...
  /// @brief Method .ctor, addr 0x609dff4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDocument* doc);

  /// @brief Method get_NextSibling, addr 0x60a6360, size 0x50, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* get_NextSibling();

  /// @brief Method get_PreviousSibling, addr 0x60a62f8, size 0x68, virtual true, abstract: false, final false
