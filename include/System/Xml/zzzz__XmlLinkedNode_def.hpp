...
public:
  ...
  /// @brief Method .ctor, addr 0x43309c4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDocument* doc);

  /// @brief Method get_NextSibling, addr 0x4338b34, size 0x50, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* get_NextSibling();

  /// @brief Method get_PreviousSibling, addr 0x4338acc, size 0x68, virtual true, abstract: false, final false
