...
public:
  ...
  /// @brief Method ReadArray, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method WriteArray, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArrayHelper_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArrayHelper_2(ArrayHelper_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArrayHelper_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArrayHelper_2(ArrayHelper_2const&) = delete;
