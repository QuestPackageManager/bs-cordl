...
inline void WriteArray(::System::Xml::XmlDictionaryWriter*  writer, ::StringW  prefix, TArgument  localName, TArgument  namespaceUri, ::ArrayW<TArray,::Array<TArray>*>  array, int32_t  offset, int32_t  count) ;
