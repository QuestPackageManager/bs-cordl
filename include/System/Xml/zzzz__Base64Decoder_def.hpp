...
public:
  ...
  /// @brief Method ConstructMapBase64, addr 0x618cb54, size 0x324, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ConstructMapBase64();

  /// @brief Method Decode, addr 0x618c588, size 0x150, virtual true, abstract: false, final false
  inline int32_t Decode(::ArrayW<char16_t> chars, int32_t startPos, int32_t len);

  /// @brief Method Decode, addr 0x618c954, size 0x14c, virtual true, abstract: false, final false
  inline int32_t Decode(::StringW str, int32_t startPos, int32_t len);

  /// @brief Method Decode, addr 0x618c6d8, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x618caa0, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SetNextOutputBuffer, addr 0x618caa8, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x618ce78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_DecodedCount, addr 0x618c56c, size 0xc, virtual true, abstract: false, final false
  inline int32_t get_DecodedCount();

  /// @brief Method get_IsFull, addr 0x618c578, size 0x10, virtual true, abstract: false, final false
