...
public:
// Declarations
/// @brief Method Invoke, addr 0x6132d88, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x613293c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Atomize, addr 0x6132a7c, size 0x54, virtual false, abstract: false, final false
inline void Atomize(::System::Xml::XmlNameTable*  nameTable) ;

/// @brief Method Clone, addr 0x6132c80, size 0x80, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* Clone() ;

/// @brief Method Equals, addr 0x61326f8, size 0xe8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetHashCode, addr 0x6132408, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHashCodeDelegate, addr 0x61324d8, size 0x170, virtual false, abstract: false, final false
static inline ::System::Xml::XmlQualifiedName_HashCodeOfStringDelegate* GetHashCodeDelegate() ;

/// @brief Method GetHashCodeOfString, addr 0x61329bc, size 0x18, virtual false, abstract: false, final false
static inline int32_t GetHashCodeOfString(::StringW  s, int32_t  length, int64_t  additionalEntropy) ;

/// @brief Method Init, addr 0x61329d4, size 0xc, virtual false, abstract: false, final false
inline void Init(::StringW  name, ::StringW  ns) ;

/// @brief Method IsRandomizedHashingDisabled, addr 0x6132934, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x6132ad0, size 0x1b0, virtual false, abstract: false, final false
static inline ::System::Xml::XmlQualifiedName* Parse(::StringW  s, ::System::Xml::IXmlNamespaceResolver*  nsmgr, ::ByRef<::StringW>  prefix) ;

/// @brief Method SetNamespace, addr 0x61329e0, size 0x8, virtual false, abstract: false, final false
inline void SetNamespace(::StringW  ns) ;

/// @brief Method ToString, addr 0x6132684, size 0x74, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x61328b4, size 0x80, virtual false, abstract: false, final false
static inline ::StringW ToString(::StringW  name, ::StringW  ns) ;

/// @brief Method Verify, addr 0x61329e8, size 0x94, virtual false, abstract: false, final false
inline void Verify() ;
...
/// @brief Method .ctor, addr 0x613238c, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x61323e4, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x61323a4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_IsEmpty, addr 0x6132648, size 0x3c, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Name, addr 0x6132400, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Namespace, addr 0x61323f8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method op_Equality, addr 0x6132854, size 0x60, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Xml::XmlQualifiedName*  a, ::System::Xml::XmlQualifiedName*  b) ;

/// @brief Method op_Inequality, addr 0x61327e0, size 0x74, virtual false, abstract: false, final false
