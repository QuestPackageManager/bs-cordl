...
public:
  ...
  /// @brief Method AppendChild, addr 0x611894c, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* AppendChild(::System::Xml::XmlNode* newChild);

  /// @brief Method CloneNode, addr 0x6118788, size 0x134, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* CloneNode(bool deep);

  /// @brief Method InsertAfter, addr 0x61188fc, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* InsertAfter(::System::Xml::XmlNode* newChild, ::System::Xml::XmlNode* refChild);

  /// @brief Method InsertBefore, addr 0x61188dc, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveChild, addr 0x611891c, size 0x30, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNode* RemoveChild(::System::Xml::XmlNode* oldChild);

  /// @brief Method SetSpecified, addr 0x6118980, size 0x8, virtual false, abstract: false, final false
  inline void SetSpecified(bool f);

  /// @brief Method WriteTo, addr 0x611896c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6118778, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW prefix, ::StringW localName, ::StringW namespaceURI, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_Specified, addr 0x6118780, size 0x8, virtual true, abstract: false, final false
  inline bool get_Specified();

  /// @brief Method set_InnerText, addr 0x61188bc, size 0x20, virtual true, abstract: false, final false
