...
public:
  ...
  /// @brief Method PeekBit, addr 0x4246528, size 0xc, virtual false, abstract: false, final false
  inline bool PeekBit();

  /// @brief Method PopBit, addr 0x42464bc, size 0x28, virtual false, abstract: false, final false
  inline bool PopBit();

  /// @brief Method PopCurr, addr 0x42464e4, size 0x44, virtual false, abstract: false, final false
  inline void PopCurr();

  /// @brief Method PushBit, addr 0x42463b4, size 0x38, virtual false, abstract: false, final false
  inline void PushBit(bool bit);

  /// @brief Method PushCurr, addr 0x42463ec, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4246394, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
