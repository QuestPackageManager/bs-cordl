...
/// @brief Method PeekBit, addr 0x5ff8334, size 0xc, virtual false, abstract: false, final false
inline bool PeekBit() ;

/// @brief Method PopBit, addr 0x5ff82c8, size 0x28, virtual false, abstract: false, final false
inline bool PopBit() ;

/// @brief Method PopCurr, addr 0x5ff82f0, size 0x44, virtual false, abstract: false, final false
inline void PopCurr() ;

/// @brief Method PushBit, addr 0x5ff81b0, size 0x38, virtual false, abstract: false, final false
inline void PushBit(bool  bit) ;

/// @brief Method PushCurr, addr 0x5ff81e8, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ff81a4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
