...
public:
  ...
  /// @brief Method .ctor, addr 0x2851ba0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method PushBit, addr 0x2851bc0, size 0x38, virtual false, abstract: false, final false
  inline void PushBit(bool bit);

  /// @brief Method PopBit, addr 0x2851cc0, size 0x28, virtual false, abstract: false, final false
  inline bool PopBit();

  /// @brief Method PeekBit, addr 0x2851d2c, size 0xc, virtual false, abstract: false, final false
  inline bool PeekBit();

  /// @brief Method PushCurr, addr 0x2851bf8, size 0xc8, virtual false, abstract: false, final false
  inline void PushCurr();

  /// @brief Method PopCurr, addr 0x2851ce8, size 0x44, virtual false, abstract: false, final false
  inline void PopCurr();
