...
public:
  ...
  /// @brief Method AddName, addr 0x432db4c, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method GetName, addr 0x432d9e4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method Grow, addr 0x432ddbc, size 0x128, virtual false, abstract: false, final false
  inline void Grow();
  ...
  /// @brief Method .ctor, addr 0x432d944, size 0x84, virtual false, abstract: false, final false
