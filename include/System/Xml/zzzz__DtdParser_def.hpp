...
public:
  ...
  /// @brief Method .ctor, addr 0x43555f4, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x4355634, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddUndeclaredNotation, addr 0x4350060, size 0x15c, virtual false, abstract: false, final false
  inline void AddUndeclaredNotation(::StringW notationName);

  /// @brief Method Create, addr 0x434b8b8, size 0x50, virtual false, abstract: false, final false
  static inline ::System::Xml::IDtdParser* Create();

  /// @brief Method EatPublicKeyword, addr 0x4353e9c, size 0xe4, virtual false, abstract: false, final false
  inline bool EatPublicKeyword();

  /// @brief Method EatSystemKeyword, addr 0x4353f80, size 0xe4, virtual false, abstract: false, final false
  inline bool EatSystemKeyword();

  /// @brief Method GetNameQualified, addr 0x434d2d0, size 0x174, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* GetNameQualified(bool canHavePrefix);

  /// @brief Method GetNameString, addr 0x4350044, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW GetNameString();

  /// @brief Method GetNmtokenString, addr 0x43501bc, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW GetNmtokenString();

  /// @brief Method GetToken, addr 0x434ca4c, size 0x838, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token GetToken(bool needWhiteSpace);

  /// @brief Method GetValue, addr 0x4350238, size 0x5c, virtual false, abstract: false, final false
  inline ::StringW GetValue();

  /// @brief Method GetValueWithStrippedSpaces, addr 0x43501d8, size 0x60, virtual false, abstract: false, final false
  inline ::StringW GetValueWithStrippedSpaces();

  /// @brief Method HandleEntityEnd, addr 0x4353b84, size 0x1a8, virtual false, abstract: false, final false
  inline bool HandleEntityEnd(bool inLiteral);

  /// @brief Method HandleEntityReference, addr 0x4355354, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEntityReference, addr 0x4350e44, size 0x50, virtual false, abstract: false, final false
  inline bool HandleEntityReference(bool paramEntity, bool inLiteral, bool inAttribute);

  /// @brief Method Initialize, addr 0x434b908, size 0x3cc, virtual false, abstract: false, final false
  inline void Initialize(::System::Xml::IDtdParserAdapter* readerAdapter);

  /// @brief Method InitializeFreeFloatingDtd, addr 0x434bcd4, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAttributeValueType, addr 0x434ff78, size 0xc, virtual false, abstract: false, final false
  inline bool IsAttributeValueType(::System::Xml::DtdParser_Token token);

  /// @brief Method LoadParsingBuffer, addr 0x434c8d0, size 0x17c, virtual false, abstract: false, final false
  inline void LoadParsingBuffer();

  static inline ::System::Xml::DtdParser* New_ctor();

  /// @brief Method OnUnexpectedError, addr 0x434d284, size 0x4c, virtual false, abstract: false, final false
  inline void OnUnexpectedError();

  /// @brief Method Parse, addr 0x434c148, size 0x23c, virtual false, abstract: false, final false
  inline void Parse(bool saveInternalSubset);

  /// @brief Method ParseAttlistDecl, addr 0x434de18, size 0x5bc, virtual false, abstract: false, final false
  inline void ParseAttlistDecl();

  /// @brief Method ParseAttlistDefault, addr 0x434fdc4, size 0x1b4, virtual false, abstract: false, final false
  inline void ParseAttlistDefault(::System::Xml::Schema::SchemaAttDef* attrDef, bool ignoreErrors);

  /// @brief Method ParseAttlistType, addr 0x434f858, size 0x56c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseComment, addr 0x434ecbc, size 0x24c, virtual false, abstract: false, final false
  inline void ParseComment();

  /// @brief Method ParseCondSection, addr 0x434f0d4, size 0x23c, virtual false, abstract: false, final false
  inline void ParseCondSection();

  /// @brief Method ParseElementDecl, addr 0x434e3d4, size 0x39c, virtual false, abstract: false, final false
  inline void ParseElementDecl();

  /// @brief Method ParseElementMixedContent, addr 0x4350294, size 0x294, virtual false, abstract: false, final false
  inline void ParseElementMixedContent(::System::Xml::Schema::ParticleContentValidator* pcv, int32_t startParenEntityId);

  /// @brief Method ParseElementOnlyContent, addr 0x4350528, size 0x348, virtual false, abstract: false, final false
  inline void ParseElementOnlyContent(::System::Xml::Schema::ParticleContentValidator* pcv, int32_t startParenEntityId);

  /// @brief Method ParseEntityDecl, addr 0x434e770, size 0x35c, virtual false, abstract: false, final false
  inline void ParseEntityDecl();

  /// @brief Method ParseExternalId, addr 0x434d444, size 0x4e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExternalSubset, addr 0x434d934, size 0x1a4, virtual false, abstract: false, final false
  inline void ParseExternalSubset();

  /// @brief Method ParseFreeFloatingDtd, addr 0x434c4c8, size 0x54, virtual false, abstract: false, final false
  inline void ParseFreeFloatingDtd();

  /// @brief Method ParseHowMany, addr 0x4350870, size 0x70, virtual false, abstract: false, final false
  inline void ParseHowMany(::System::Xml::Schema::ParticleContentValidator* pcv);

  /// @brief Method ParseInDocumentDtd, addr 0x434c51c, size 0x14c, virtual false, abstract: false, final false
  inline void ParseInDocumentDtd(bool saveInternalSubset);

  /// @brief Method ParseInternalSubset, addr 0x434d930, size 0x4, virtual false, abstract: false, final false
  inline void ParseInternalSubset();

  /// @brief Method ParseNotationDecl, addr 0x434eacc, size 0x1f0, virtual false, abstract: false, final false
  inline void ParseNotationDecl();

  /// @brief Method ParsePI, addr 0x434ef08, size 0x164, virtual false, abstract: false, final false
  inline void ParsePI();

  /// @brief Method ParseSubset, addr 0x434dad8, size 0x340, virtual false, abstract: false, final false
  inline void ParseSubset();

  /// @brief Method ParseUnexpectedToken, addr 0x4350e94, size 0xbc, virtual false, abstract: false, final false
  inline ::StringW ParseUnexpectedToken(int32_t startPos);

  /// @brief Method ReadData, addr 0x4353ac0, size 0xc4, virtual false, abstract: false, final false
  inline int32_t ReadData();

  /// @brief Method ReadDataInName, addr 0x43550ec, size 0x44, virtual false, abstract: false, final false
  inline bool ReadDataInName();

  /// @brief Method SaveParsingBuffer, addr 0x434d928, size 0x8, virtual false, abstract: false, final false
  inline void SaveParsingBuffer();

  /// @brief Method SaveParsingBuffer, addr 0x434f3e4, size 0x14c, virtual false, abstract: false, final false
  inline void SaveParsingBuffer(int32_t internalSubsetValueEndPos);

  /// @brief Method ScanAttlist1, addr 0x4351f6c, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanAttlist1();

  /// @brief Method ScanAttlist2, addr 0x4352030, size 0x680, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanAttlist2();

  /// @brief Method ScanAttlist3, addr 0x43526b0, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanAttlist3();

  /// @brief Method ScanAttlist4, addr 0x4352750, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanAttlist4();

  /// @brief Method ScanAttlist5, addr 0x4352820, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanAttlist5();

  /// @brief Method ScanAttlist6, addr 0x43528f0, size 0x374, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanAttlist6();

  /// @brief Method ScanAttlist7, addr 0x4352c64, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanAttlist7();

  /// @brief Method ScanClosingTag, addr 0x4353a2c, size 0x94, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanClosingTag();

  /// @brief Method ScanCondSection1, addr 0x43532ac, size 0x29c, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanCondSection1();

  /// @brief Method ScanCondSection2, addr 0x4353548, size 0x98, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanCondSection2();

  /// @brief Method ScanCondSection3, addr 0x43535e0, size 0x44c, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanCondSection3();

  /// @brief Method ScanDoctype1, addr 0x43516bc, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanDoctype1();

  /// @brief Method ScanDoctype2, addr 0x43517e8, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanDoctype2();

  /// @brief Method ScanElement1, addr 0x4351890, size 0x1d0, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanElement1();

  /// @brief Method ScanElement2, addr 0x4351a60, size 0x1a4, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanElement2();

  /// @brief Method ScanElement3, addr 0x4351c04, size 0x80, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanElement3();

  /// @brief Method ScanElement4, addr 0x4351c84, size 0xcc, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanElement4();

  /// @brief Method ScanElement5, addr 0x4351d50, size 0xec, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanElement5();

  /// @brief Method ScanElement6, addr 0x4351e3c, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanElement6();

  /// @brief Method ScanElement7, addr 0x4351f0c, size 0x60, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanElement7();

  /// @brief Method ScanEntity1, addr 0x4352ff0, size 0x74, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanEntity1();

  /// @brief Method ScanEntity2, addr 0x4353064, size 0x134, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanEntity2();

  /// @brief Method ScanEntity3, addr 0x4353198, size 0x114, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanEntity3();

  /// @brief Method ScanEntityName, addr 0x4354ae4, size 0x160, virtual false, abstract: false, final false
  inline ::System::Xml::XmlQualifiedName* ScanEntityName();

  /// @brief Method ScanLiteral, addr 0x4354064, size 0xa80, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanLiteral(::System::Xml::DtdParser_LiteralType literalType);

  /// @brief Method ScanName, addr 0x4353d2c, size 0x8, virtual false, abstract: false, final false
  inline void ScanName();

  /// @brief Method ScanNameExpected, addr 0x4350f50, size 0x24, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanNameExpected();

  /// @brief Method ScanNmtoken, addr 0x4353d3c, size 0x160, virtual false, abstract: false, final false
  inline void ScanNmtoken();

  /// @brief Method ScanNmtokenExpected, addr 0x4350f98, size 0x20, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanNmtokenExpected();

  /// @brief Method ScanNotation1, addr 0x4352d20, size 0x100, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanNotation1();

  /// @brief Method ScanPublicId1, addr 0x4352ed4, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanPublicId1();

  /// @brief Method ScanPublicId2, addr 0x4352f88, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanPublicId2();

  /// @brief Method ScanQName, addr 0x4353d34, size 0x8, virtual false, abstract: false, final false
  inline void ScanQName();

  /// @brief Method ScanQName, addr 0x4354e6c, size 0x280, virtual false, abstract: false, final false
  inline void ScanQName(bool isQName);

  /// @brief Method ScanQNameExpected, addr 0x4350f74, size 0x24, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanQNameExpected();

  /// @brief Method ScanSubsetContent, addr 0x4350fb8, size 0x704, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanSubsetContent();

  /// @brief Method ScanSystemId, addr 0x4352e20, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Xml::DtdParser_Token ScanSystemId();

  /// @brief Method SendValidationEvent, addr 0x434f310, size 0xd4, virtual false, abstract: false, final false
  inline void SendValidationEvent(int32_t pos, ::System::Xml::Schema::XmlSeverityType severity, ::StringW code, ::StringW arg);

  /// @brief Method SendValidationEvent, addr 0x434ff84, size 0xc0, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSeverityType severity, ::StringW code, ::StringW arg);

  /// @brief Method SendValidationEvent, addr 0x434c78c, size 0x144, virtual false, abstract: false, final false
  inline void SendValidationEvent(::System::Xml::Schema::XmlSeverityType severity, ::System::Xml::Schema::XmlSchemaException* e);

  /// @brief Method StripSpaces, addr 0x4355130, size 0x224, virtual false, abstract: false, final false
  static inline ::StringW StripSpaces(::StringW value);

  /// @brief Method System.Xml.IDtdParser.ParseFreeFloatingDtd, addr 0x434c384, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IDtdParser.ParseInternalDtd, addr 0x434c118, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method Throw, addr 0x434f06c, size 0x68, virtual false, abstract: false, final false
  inline void Throw(int32_t curPos, ::StringW res);

  /// @brief Method Throw, addr 0x43508e0, size 0x1e4, virtual false, abstract: false, final false
  inline void Throw(int32_t curPos, ::StringW res, ::StringW arg);

  /// @brief Method Throw, addr 0x4350be0, size 0x1e4, virtual false, abstract: false, final false
  inline void Throw(int32_t curPos, ::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method Throw, addr 0x434f68c, size 0x1cc, virtual false, abstract: false, final false
  inline void Throw(::StringW res, ::StringW arg, int32_t lineNo, int32_t linePos);

  /// @brief Method ThrowInvalidChar, addr 0x4350dc4, size 0x80, virtual false, abstract: false, final false
  inline void ThrowInvalidChar(::ArrayW<char16_t, ::Array<char16_t>*> data, int32_t length, int32_t invCharPos);

  /// @brief Method ThrowInvalidChar, addr 0x434c09c, size 0x7c, virtual false, abstract: false, final false
  inline void ThrowInvalidChar(int32_t pos, ::StringW data, int32_t invCharPos);

  /// @brief Method ThrowUnexpectedToken, addr 0x434f530, size 0x8, virtual false, abstract: false, final false
  inline void ThrowUnexpectedToken(int32_t pos, ::StringW expectedToken);

  /// @brief Method ThrowUnexpectedToken, addr 0x4350ac4, size 0x11c, virtual false, abstract: false, final false
  inline void ThrowUnexpectedToken(int32_t pos, ::StringW expectedToken1, ::StringW expectedToken2);

  /// @brief Method VerifyEntityReference, addr 0x4354c44, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x434b830, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseUriStr, addr 0x434c668, size 0x124, virtual false, abstract: false, final false
  inline ::StringW get_BaseUriStr();

  /// @brief Method get_IgnoreEntityReferences, addr 0x434c3b8, size 0x10, virtual false, abstract: false, final false
  inline bool get_IgnoreEntityReferences();

  /// @brief Method get_LineNo, addr 0x434f538, size 0xa4, virtual false, abstract: false, final false
  inline int32_t get_LineNo();

  /// @brief Method get_LinePos, addr 0x434f5dc, size 0xb0, virtual false, abstract: false, final false
  inline int32_t get_LinePos();

  /// @brief Method get_Normalize, addr 0x434c4c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_Normalize();

  /// @brief Method get_ParsingInternalSubset, addr 0x434c3a8, size 0x10, virtual false, abstract: false, final false
  inline bool get_ParsingInternalSubset();

  /// @brief Method get_ParsingTopLevelMarkup, addr 0x434c488, size 0x30, virtual false, abstract: false, final false
  inline bool get_ParsingTopLevelMarkup();

  /// @brief Method get_SaveInternalSubsetValue, addr 0x434c3c8, size 0xc0, virtual false, abstract: false, final false
  inline bool get_SaveInternalSubsetValue();

  /// @brief Method get_SupportNamespaces, addr 0x434c4b8, size 0x8, virtual false, abstract: false, final false
