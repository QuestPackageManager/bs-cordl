...
public:
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x434c0ac, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x434c0b4, size 0x4, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x434c0b8, size 0x58, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x434c110, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
