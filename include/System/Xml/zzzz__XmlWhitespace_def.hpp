...
// Write type traits
MARK_REF_T(::System::Xml::XmlWhitespace*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWhitespace*, "System.Xml", "XmlWhitespace");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlWhitespace", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlWhitespace(XmlWhitespace&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlWhitespace", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlWhitespace(XmlWhitespaceconst&) = delete;
...
static_assert(sizeof(::System::Xml::XmlWhitespace) == 0x28, "Size mismatch!");
