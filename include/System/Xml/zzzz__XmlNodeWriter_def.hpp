...
// Write type traits
MARK_REF_T(::System::Xml::XmlNodeWriter*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlNodeWriter*, "System.Xml", "XmlNodeWriter");
...
public:
  ...
  /// @brief Method WriteBase64Text, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteBase64Text(::ArrayW<uint8_t> trailBuffer, int32_t trailCount, ::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteBoolText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method WriteDateTimeText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteDateTimeText(::System::DateTime value);

  /// @brief Method WriteDecimalText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteDecimalText(::System::Decimal value);

  /// @brief Method WriteDeclaration, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteDeclaration();

  /// @brief Method WriteDoubleText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method WriteEndStartElement, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteEndStartElement(bool isEmpty);

  /// @brief Method WriteEscapedText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteEscapedText(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);
  ...
  /// @brief Method WriteFloatText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteFloatText(float_t value);

  /// @brief Method WriteGuidText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteGuidText(::System::Guid value);

  /// @brief Method WriteInt32Text, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteInt32Text(int32_t value);

  /// @brief Method WriteInt64Text, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteInt64Text(int64_t value);

  /// @brief Method WriteQualifiedName, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method WriteText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteText(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);
  ...
  /// @brief Method WriteTimeSpanText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteTimeSpanText(::System::TimeSpan value);

  /// @brief Method WriteUInt64Text, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteUInt64Text(uint64_t value);

  /// @brief Method WriteUniqueIdText, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void WriteUniqueIdText(::System::Xml::UniqueId* value);

  /// @brief Method WriteXmlnsAttribute, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlNodeWriter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlNodeWriter(XmlNodeWriter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlNodeWriter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlNodeWriter(XmlNodeWriterconst&) = delete;
...
static_assert(sizeof(::System::Xml::XmlNodeWriter) == 0x10, "Size mismatch!");
