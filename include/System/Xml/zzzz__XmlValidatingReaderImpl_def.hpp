...
public:
  ...
  /// @brief Method AddHandler, addr 0x615dd58, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.IValidationEventHandling.SendEvent, addr 0x615f0a8, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IValidationEventHandling.get_EventHandler, addr 0x615f0a0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x615dd50, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddDefaultAttribute, addr 0x615ef24, size 0x18, virtual false, abstract: false, final false
  inline bool AddDefaultAttribute(::System::Xml::Schema::SchemaAttDef* attdef);

  /// @brief Method Close, addr 0x615e790, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetAttribute, addr 0x615e268, size 0x20, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0x615e248, size 0x20, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW localName, ::StringW namespaceURI);

  /// @brief Method GetAttribute, addr 0x615e228, size 0x20, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetNamespacesInScope, addr 0x615ec4c, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope scope);

  /// @brief Method GetResolver, addr 0x615dc8c, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetResolver();

  /// @brief Method HasLineInfo, addr 0x615ea68, size 0x8, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method LookupNamespace, addr 0x615e7c4, size 0x20, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x615ed14, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW LookupPrefix(::StringW namespaceName);

  /// @brief Method MoveOffEntityReference, addr 0x615e9a4, size 0xa8, virtual false, abstract: false, final false
  inline void MoveOffEntityReference();

  /// @brief Method MoveToAttribute, addr 0x615e2c0, size 0x38, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW localName, ::StringW namespaceURI);

  /// @brief Method MoveToAttribute, addr 0x615e288, size 0x38, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0x615e2f8, size 0x30, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0x615e398, size 0x38, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0x615e328, size 0x38, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x615e360, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method ParseDtdFromParserContext, addr 0x615e594, size 0x174, virtual false, abstract: false, final false
  inline void ParseDtdFromParserContext();

  /// @brief Method ProcessCoreReaderEvent, addr 0x615e4b8, size 0xdc, virtual false, abstract: false, final false
  inline void ProcessCoreReaderEvent();

  /// @brief Method Read, addr 0x615e3d0, size 0xe8, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAttributeValue, addr 0x615e7e4, size 0x58, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadContentAsBase64, addr 0x615e83c, size 0x98, virtual true, abstract: false, final false
  inline int32_t ReadContentAsBase64(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadContentAsBinHex, addr 0x615e8d4, size 0x98, virtual true, abstract: false, final false
  inline int32_t ReadContentAsBinHex(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadString, addr 0x615ea4c, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ResolveEntity, addr 0x615e974, size 0x30, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method ResolveEntityInternally, addr 0x615e708, size 0x88, virtual false, abstract: false, final false
  inline void ResolveEntityInternally();

  /// @brief Method SetupValidation, addr 0x615dde4, size 0x158, virtual false, abstract: false, final false
  inline void SetupValidation(::System::Xml::ValidationType valType);

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x615ec48, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x615ed00, size 0x10, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x615ed10, size 0x4, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method ValidateDefaultAttributeOnUse, addr 0x615ef5c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateDtd, addr 0x615edf4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615d930, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AttributeCount, addr 0x615e208, size 0x20, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_BaseURI, addr 0x615e0d4, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_CanResolveEntity, addr 0x615e96c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanResolveEntity();

  /// @brief Method get_Depth, addr 0x615e0b8, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_DtdInfo, addr 0x615ef3c, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::IDtdInfo* get_DtdInfo();

  /// @brief Method get_EOF, addr 0x615e1c8, size 0x20, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_IsDefault, addr 0x615e114, size 0x20, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0x615e0f4, size 0x20, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LineNumber, addr 0x615ea70, size 0xec, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x615eb5c, size 0xec, virtual true, abstract: false, final true
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0x615e048, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x615e02c, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0x615e1e8, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceManager, addr 0x615ee80, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNamespaceManager* get_NamespaceManager();

  /// @brief Method get_NamespaceURI, addr 0x615e064, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_Namespaces, addr 0x615eddc, size 0x18, virtual false, abstract: false, final false
  inline bool get_Namespaces();

  /// @brief Method get_NodeType, addr 0x615e010, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x615e080, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_QuoteChar, addr 0x615e134, size 0x20, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_ReadState, addr 0x615e194, size 0x34, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_Schemas, addr 0x615edd4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaCollection* get_Schemas();

  /// @brief Method get_Settings, addr 0x615df3c, size 0xd4, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_StandAlone, addr 0x615eea0, size 0x18, virtual false, abstract: false, final false
  inline bool get_StandAlone();

  /// @brief Method get_TypedValueObject, addr 0x615eedc, size 0x24, virtual false, abstract: false, final false
  inline ::System::Object* get_TypedValueObject();

  /// @brief Method get_ValidationType, addr 0x615edcc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::ValidationType get_ValidationType();

  /// @brief Method get_Validator, addr 0x615ee70, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::BaseValidator* get_Validator();

  /// @brief Method get_Value, addr 0x615e09c, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_XmlLang, addr 0x615e174, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x615e154, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method set_SchemaTypeObject, addr 0x615eeb8, size 0x24, virtual false, abstract: false, final false
  inline void set_SchemaTypeObject(::System::Object* value);

  /// @brief Method set_TypedValueObject, addr 0x615ef00, size 0x24, virtual false, abstract: false, final false
  inline void set_TypedValueObject(::System::Object* value);

  /// @brief Method set_Validator, addr 0x615ee78, size 0x8, virtual false, abstract: false, final false
