...
/// @brief Method AddHandler, addr 0x615f8d0, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method System.Xml.IValidationEventHandling.SendEvent, addr 0x6160c20, size 0x11c, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IValidationEventHandling.get_EventHandler, addr 0x6160c18, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x615f8c8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddDefaultAttribute, addr 0x6160a9c, size 0x18, virtual false, abstract: false, final false
inline bool AddDefaultAttribute(::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method Close, addr 0x6160308, size 0x34, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetAttribute, addr 0x615fde0, size 0x20, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  i) ;

/// @brief Method GetAttribute, addr 0x615fdc0, size 0x20, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  localName, ::StringW  namespaceURI) ;

/// @brief Method GetAttribute, addr 0x615fda0, size 0x20, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetNamespacesInScope, addr 0x61607c4, size 0xb4, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope  scope) ;

/// @brief Method GetResolver, addr 0x615f804, size 0xc4, virtual false, abstract: false, final false
inline ::System::Xml::XmlResolver* GetResolver() ;

/// @brief Method HasLineInfo, addr 0x61605e0, size 0x8, virtual true, abstract: false, final true
inline bool HasLineInfo() ;

/// @brief Method LookupNamespace, addr 0x616033c, size 0x20, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x616088c, size 0xb8, virtual false, abstract: false, final false
inline ::StringW LookupPrefix(::StringW  namespaceName) ;

/// @brief Method MoveOffEntityReference, addr 0x616051c, size 0xa8, virtual false, abstract: false, final false
inline void MoveOffEntityReference() ;

/// @brief Method MoveToAttribute, addr 0x615fe38, size 0x38, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  localName, ::StringW  namespaceURI) ;

/// @brief Method MoveToAttribute, addr 0x615fe00, size 0x38, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x615fe70, size 0x30, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  i) ;

/// @brief Method MoveToElement, addr 0x615ff10, size 0x38, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x615fea0, size 0x38, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x615fed8, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method ParseDtdFromParserContext, addr 0x616010c, size 0x174, virtual false, abstract: false, final false
inline void ParseDtdFromParserContext() ;

/// @brief Method ProcessCoreReaderEvent, addr 0x6160030, size 0xdc, virtual false, abstract: false, final false
inline void ProcessCoreReaderEvent() ;

/// @brief Method Read, addr 0x615ff48, size 0xe8, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAttributeValue, addr 0x616035c, size 0x58, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method ReadContentAsBase64, addr 0x61603b4, size 0x98, virtual true, abstract: false, final false
inline int32_t ReadContentAsBase64(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadContentAsBinHex, addr 0x616044c, size 0x98, virtual true, abstract: false, final false
inline int32_t ReadContentAsBinHex(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadString, addr 0x61605c4, size 0x1c, virtual true, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ResolveEntity, addr 0x61604ec, size 0x30, virtual true, abstract: false, final false
inline void ResolveEntity() ;

/// @brief Method ResolveEntityInternally, addr 0x6160280, size 0x88, virtual false, abstract: false, final false
inline void ResolveEntityInternally() ;

/// @brief Method SetupValidation, addr 0x615f95c, size 0x158, virtual false, abstract: false, final false
inline void SetupValidation(::System::Xml::ValidationType  valType) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x61607c0, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x6160878, size 0x10, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW  prefix) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x6160888, size 0x4, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW  namespaceName) ;

/// @brief Method ValidateDefaultAttributeOnUse, addr 0x6160ad4, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method ValidateDtd, addr 0x616096c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x615f4a8, size 0x35c, virtual false, abstract: false, final false
...
/// @brief Method get_AttributeCount, addr 0x615fd80, size 0x20, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x615fc4c, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_CanResolveEntity, addr 0x61604e4, size 0x8, virtual true, abstract: false, final false
inline bool get_CanResolveEntity() ;

/// @brief Method get_Depth, addr 0x615fc30, size 0x1c, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_DtdInfo, addr 0x6160ab4, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::IDtdInfo* get_DtdInfo() ;

/// @brief Method get_EOF, addr 0x615fd40, size 0x20, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_IsDefault, addr 0x615fc8c, size 0x20, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsEmptyElement, addr 0x615fc6c, size 0x20, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LineNumber, addr 0x61605e8, size 0xec, virtual true, abstract: false, final true
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x61606d4, size 0xec, virtual true, abstract: false, final true
inline int32_t get_LinePosition() ;

/// @brief Method get_LocalName, addr 0x615fbc0, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x615fba4, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameTable, addr 0x615fd60, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceManager, addr 0x61609f8, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::XmlNamespaceManager* get_NamespaceManager() ;

/// @brief Method get_NamespaceURI, addr 0x615fbdc, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_Namespaces, addr 0x6160954, size 0x18, virtual false, abstract: false, final false
inline bool get_Namespaces() ;

/// @brief Method get_NodeType, addr 0x615fb88, size 0x1c, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x615fbf8, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_QuoteChar, addr 0x615fcac, size 0x20, virtual true, abstract: false, final false
inline char16_t get_QuoteChar() ;

/// @brief Method get_ReadState, addr 0x615fd0c, size 0x34, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_Schemas, addr 0x616094c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCollection* get_Schemas() ;

/// @brief Method get_Settings, addr 0x615fab4, size 0xd4, virtual true, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_Settings() ;

/// @brief Method get_StandAlone, addr 0x6160a18, size 0x18, virtual false, abstract: false, final false
inline bool get_StandAlone() ;

/// @brief Method get_TypedValueObject, addr 0x6160a54, size 0x24, virtual false, abstract: false, final false
inline ::System::Object* get_TypedValueObject() ;

/// @brief Method get_ValidationType, addr 0x6160944, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::ValidationType get_ValidationType() ;

/// @brief Method get_Validator, addr 0x61609e8, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::BaseValidator* get_Validator() ;

/// @brief Method get_Value, addr 0x615fc14, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_XmlLang, addr 0x615fcec, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x615fccc, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method set_SchemaTypeObject, addr 0x6160a30, size 0x24, virtual false, abstract: false, final false
inline void set_SchemaTypeObject(::System::Object*  value) ;

/// @brief Method set_TypedValueObject, addr 0x6160a78, size 0x24, virtual false, abstract: false, final false
inline void set_TypedValueObject(::System::Object*  value) ;

/// @brief Method set_Validator, addr 0x61609f0, size 0x8, virtual false, abstract: false, final false
