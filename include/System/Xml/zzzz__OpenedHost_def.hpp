...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OpenedHost", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OpenedHost(OpenedHost&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OpenedHost", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OpenedHost(OpenedHostconst&) = delete;
