...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11383))}
...
public:
  ...
  /// @brief Method .ctor addr 0x26d93d4 size 0xc0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26d94c4 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26d94ec size 0x28 virtual false final false
  inline void _ctor(::System::IO::Stream* strm, ::System::Xml::XmlWriterSettings* writerSettings);

  /// @brief Method WriteDocType addr 0x26d9514 size 0x68 virtual true final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteStartElement addr 0x26d958c size 0x80 virtual true final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartAttribute addr 0x26d9860 size 0x60 virtual true final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteEndAttribute addr 0x26d98c0 size 0x24 virtual true final false
  inline void WriteEndAttribute();

  /// @brief Method WriteCData addr 0x26d98e4 size 0x48 virtual true final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteComment addr 0x26d998c size 0x30 virtual true final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteProcessingInstruction addr 0x26d99bc size 0x30 virtual true final false
  inline void WriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method WriteWhitespace addr 0x26d99ec size 0x30 virtual true final false
  inline void WriteWhitespace(::StringW ws);

  /// @brief Method WriteString addr 0x26d9a1c size 0x48 virtual true final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteChars addr 0x26d9a64 size 0x30 virtual true final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw addr 0x26d9a94 size 0x30 virtual true final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw addr 0x26d9ac4 size 0x48 virtual true final false
  inline void WriteRaw(::StringW data);

  /// @brief Method WriteEntityRef addr 0x26d9b0c size 0x4c virtual true final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteCharEntity addr 0x26d9b58 size 0x4c virtual true final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteSurrogateCharEntity addr 0x26d9ba4 size 0x54 virtual true final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteBase64 addr 0x26d9bf8 size 0x64 virtual true final false
  inline void WriteBase64(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteBinHex addr 0x26d9c5c size 0x64 virtual true final false
  inline void WriteBinHex(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Close addr 0x26d9cc0 size 0x3c virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0x26d9cfc size 0x3c virtual true final false
  inline void Flush();

  /// @brief Method WriteValue addr 0x26d9d38 size 0x4c virtual true final false
  inline void WriteValue(::StringW value);

  /// @brief Method set_NamespaceResolver addr 0x26d9d84 size 0x34 virtual true final false
  inline void set_NamespaceResolver(::System::Xml::IXmlNamespaceResolver* value);

  /// @brief Method WriteXmlDeclaration addr 0x26d9db8 size 0x4c virtual true final false
  inline void WriteXmlDeclaration(::System::Xml::XmlStandalone standalone);

  /// @brief Method WriteXmlDeclaration addr 0x26d9e04 size 0x4c virtual true final false
  inline void WriteXmlDeclaration(::StringW xmldecl);

  /// @brief Method StartElementContent addr 0x26d9e50 size 0x24 virtual true final false
  inline void StartElementContent();

  /// @brief Method WriteEndElement addr 0x26d9e74 size 0x24 virtual true final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteFullEndElement addr 0x26d9e98 size 0x24 virtual true final false
  inline void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteNamespaceDeclaration addr 0x26d9ebc size 0x54 virtual true final false
  inline void WriteNamespaceDeclaration(::StringW prefix, ::StringW ns);

  /// @brief Method get_SupportsNamespaceDeclarationInChunks addr 0x26d9f10 size 0x24 virtual true final false
  inline bool get_SupportsNamespaceDeclarationInChunks();

  /// @brief Method WriteStartNamespaceDeclaration addr 0x26d9f34 size 0x4c virtual true final false
  inline void WriteStartNamespaceDeclaration(::StringW prefix);

  /// @brief Method WriteEndNamespaceDeclaration addr 0x26d9f80 size 0x24 virtual true final false
  inline void WriteEndNamespaceDeclaration();

  /// @brief Method IsHtmlTag addr 0x26d960c size 0x114 virtual false final false
  static inline bool IsHtmlTag(::StringW tagName);

  /// @brief Method EnsureWrappedWriter addr 0x26d957c size 0x10 virtual false final false
  inline void EnsureWrappedWriter(::System::Xml::XmlOutputMethod outMethod);

  /// @brief Method TextBlockCreatesWriter addr 0x26d992c size 0x60 virtual false final false
  inline bool TextBlockCreatesWriter(::StringW textBlock);

  /// @brief Method CreateWrappedWriter addr 0x26d9720 size 0x140 virtual false final false
