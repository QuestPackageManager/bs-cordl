...
public:
  ...
  /// @brief Method ReadArray, addr 0x60ff754, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x60ff78c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60ff7c8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TimeSpanArrayHelperWithDictionaryString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TimeSpanArrayHelperWithDictionaryString(TimeSpanArrayHelperWithDictionaryString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TimeSpanArrayHelperWithDictionaryString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TimeSpanArrayHelperWithDictionaryString(TimeSpanArrayHelperWithDictionaryStringconst&) = delete;
