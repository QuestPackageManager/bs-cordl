...
public:
  ...
  /// @brief Method BreakText, addr 0x5fe9fa4, size 0xb4, virtual false, abstract: false, final false
  inline int32_t BreakText(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t length);

  /// @brief Method BufferElement, addr 0x5fe8060, size 0x128, virtual false, abstract: false, final false
  inline void BufferElement();

  /// @brief Method Close, addr 0x5fe7b58, size 0xf0, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetPosition, addr 0x5feaa4c, size 0xc0, virtual false, abstract: false, final false
  inline void GetPosition(::ByRef<int32_t> row, ::ByRef<int32_t> column);

  /// @brief Method HasLineInfo, addr 0x5feaa24, size 0x8, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method IsNextCharacterNonFFFE, addr 0x5fe931c, size 0x64, virtual false, abstract: false, final false
  inline bool IsNextCharacterNonFFFE(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method MoveToInitial, addr 0x5fe7b1c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x5fea548, size 0x48c, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAttributeText, addr 0x5fe8f9c, size 0xe8, virtual false, abstract: false, final false
  inline int32_t ReadAttributeText(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t offsetMax);

  /// @brief Method ReadAttributes, addr 0x5fe8228, size 0x5e8, virtual false, abstract: false, final false
  inline void ReadAttributes();

  /// @brief Method ReadCData, addr 0x5fe9b4c, size 0x2a8, virtual false, abstract: false, final false
  inline void ReadCData();

  /// @brief Method ReadCharRef, addr 0x5fe9100, size 0x9c, virtual false, abstract: false, final false
  inline int32_t ReadCharRef();

  /// @brief Method ReadComment, addr 0x5fe9814, size 0x284, virtual false, abstract: false, final false
  inline void ReadComment();

  /// @brief Method ReadDeclaration, addr 0x5fe7d18, size 0x348, virtual false, abstract: false, final false
  inline void ReadDeclaration();

  /// @brief Method ReadEndElement, addr 0x5fe9580, size 0x210, virtual false, abstract: false, final false
  inline void ReadEndElement();

  /// @brief Method ReadEscapedText, addr 0x5fea478, size 0xd0, virtual false, abstract: false, final false
  inline void ReadEscapedText();

  /// @brief Method ReadNonFFFE, addr 0x5fe919c, size 0x110, virtual false, abstract: false, final false
  inline void ReadNonFFFE();

  /// @brief Method ReadQualifiedName, addr 0x5fe8c28, size 0x374, virtual false, abstract: false, final false
  inline void ReadQualifiedName(::System::Xml::PrefixHandle* prefix, ::System::Xml::StringHandle* localName);

  /// @brief Method ReadStartElement, addr 0x5fe9380, size 0x200, virtual false, abstract: false, final false
  inline void ReadStartElement();

  /// @brief Method ReadText, addr 0x5fea058, size 0xe8, virtual false, abstract: false, final false
  inline int32_t ReadText(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t offsetMax);

  /// @brief Method ReadText, addr 0x5fea2f0, size 0x188, virtual false, abstract: false, final false
  inline void ReadText(bool hasLeadingByteOf0xEF);

  /// @brief Method ReadTextAndWatchForInvalidCharacters, addr 0x5fea140, size 0x1b0, virtual false, abstract: false, final false
  inline int32_t ReadTextAndWatchForInvalidCharacters(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t offsetMax);

  /// @brief Method ReadWhitespace, addr 0x5fe9ebc, size 0xe8, virtual false, abstract: false, final false
  inline int32_t ReadWhitespace(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t offsetMax);

  /// @brief Method ReadWhitespace, addr 0x5fe9df4, size 0xc8, virtual false, abstract: false, final false
  inline void ReadWhitespace();

  /// @brief Method SetInput, addr 0x5fe7a34, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method SkipWhitespace, addr 0x5fe7c48, size 0xd0, virtual false, abstract: false, final false
  inline void SkipWhitespace();

  /// @brief Method VerifyNCName, addr 0x5fe886c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fe796c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_charType();

  /// @brief Method get_LineNumber, addr 0x5feaa2c, size 0x20, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x5feab0c, size 0x20, virtual true, abstract: false, final true
