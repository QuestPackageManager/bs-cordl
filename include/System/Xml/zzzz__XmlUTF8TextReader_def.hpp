...
/// @brief Method BreakText, addr 0x5f77f98, size 0xb4, virtual false, abstract: false, final false
inline int32_t BreakText(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  length) ;

/// @brief Method BufferElement, addr 0x5f76054, size 0x128, virtual false, abstract: false, final false
inline void BufferElement() ;

/// @brief Method Close, addr 0x5f75b4c, size 0xf0, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetPosition, addr 0x5f78a40, size 0xc0, virtual false, abstract: false, final false
inline void GetPosition(::ByRef<int32_t>  row, ::ByRef<int32_t>  column) ;

/// @brief Method HasLineInfo, addr 0x5f78a18, size 0x8, virtual true, abstract: false, final true
inline bool HasLineInfo() ;

/// @brief Method IsNextCharacterNonFFFE, addr 0x5f77310, size 0x64, virtual false, abstract: false, final false
inline bool IsNextCharacterNonFFFE(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method MoveToInitial, addr 0x5f75b10, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x5f7853c, size 0x48c, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAttributeText, addr 0x5f76f90, size 0xe8, virtual false, abstract: false, final false
inline int32_t ReadAttributeText(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  offsetMax) ;

/// @brief Method ReadAttributes, addr 0x5f7621c, size 0x5e8, virtual false, abstract: false, final false
inline void ReadAttributes() ;

/// @brief Method ReadCData, addr 0x5f77b40, size 0x2a8, virtual false, abstract: false, final false
inline void ReadCData() ;

/// @brief Method ReadCharRef, addr 0x5f770f4, size 0x9c, virtual false, abstract: false, final false
inline int32_t ReadCharRef() ;

/// @brief Method ReadComment, addr 0x5f77808, size 0x284, virtual false, abstract: false, final false
inline void ReadComment() ;

/// @brief Method ReadDeclaration, addr 0x5f75d0c, size 0x348, virtual false, abstract: false, final false
inline void ReadDeclaration() ;

/// @brief Method ReadEndElement, addr 0x5f77574, size 0x210, virtual false, abstract: false, final false
inline void ReadEndElement() ;

/// @brief Method ReadEscapedText, addr 0x5f7846c, size 0xd0, virtual false, abstract: false, final false
inline void ReadEscapedText() ;

/// @brief Method ReadNonFFFE, addr 0x5f77190, size 0x110, virtual false, abstract: false, final false
inline void ReadNonFFFE() ;

/// @brief Method ReadQualifiedName, addr 0x5f76c1c, size 0x374, virtual false, abstract: false, final false
inline void ReadQualifiedName(::System::Xml::PrefixHandle*  prefix, ::System::Xml::StringHandle*  localName) ;

/// @brief Method ReadStartElement, addr 0x5f77374, size 0x200, virtual false, abstract: false, final false
inline void ReadStartElement() ;

/// @brief Method ReadText, addr 0x5f7804c, size 0xe8, virtual false, abstract: false, final false
inline int32_t ReadText(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  offsetMax) ;

/// @brief Method ReadText, addr 0x5f782e4, size 0x188, virtual false, abstract: false, final false
inline void ReadText(bool  hasLeadingByteOf0xEF) ;

/// @brief Method ReadTextAndWatchForInvalidCharacters, addr 0x5f78134, size 0x1b0, virtual false, abstract: false, final false
inline int32_t ReadTextAndWatchForInvalidCharacters(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  offsetMax) ;

/// @brief Method ReadWhitespace, addr 0x5f77eb0, size 0xe8, virtual false, abstract: false, final false
inline int32_t ReadWhitespace(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  offsetMax) ;

/// @brief Method ReadWhitespace, addr 0x5f77de8, size 0xc8, virtual false, abstract: false, final false
inline void ReadWhitespace() ;

/// @brief Method SetInput, addr 0x5f75a28, size 0xe8, virtual true, abstract: false, final true
...
/// @brief Method SkipWhitespace, addr 0x5f75c3c, size 0xd0, virtual false, abstract: false, final false
inline void SkipWhitespace() ;

/// @brief Method VerifyNCName, addr 0x5f76860, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5f75960, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_charType() ;

/// @brief Method get_LineNumber, addr 0x5f78a20, size 0x20, virtual true, abstract: false, final true
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x5f78b00, size 0x20, virtual true, abstract: false, final true
