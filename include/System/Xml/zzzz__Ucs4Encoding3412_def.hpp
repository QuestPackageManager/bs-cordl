...
public:
  ...
  /// @brief Method .ctor, addr 0x28a95bc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EncodingName, addr 0x28a9860, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_EncodingName();

  /// @brief Method GetPreamble, addr 0x28a98a0, size 0x74, virtual true, abstract: false, final false
