...
public:
  ...
  /// @brief Method .ctor, addr 0x288cf64, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW target, ::StringW data, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_Name, addr 0x2891a60, size 0x54, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_LocalName, addr 0x2891ab4, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Value, addr 0x2891ac0, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x2891ac8, size 0x4, virtual true, abstract: false, final false
  inline void set_Value(::StringW value);

  /// @brief Method set_Data, addr 0x2891acc, size 0xa0, virtual false, abstract: false, final false
  inline void set_Data(::StringW value);

  /// @brief Method get_InnerText, addr 0x2891b6c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_InnerText();

  /// @brief Method set_InnerText, addr 0x2891b74, size 0x4, virtual true, abstract: false, final false
  inline void set_InnerText(::StringW value);

  /// @brief Method get_NodeType, addr 0x2891b78, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method CloneNode, addr 0x2891b80, size 0x38, virtual true, abstract: false, final false
