...
public:
  ...
  /// @brief Method WriteChars, addr 0x4237a34, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4237a10, size 0x24, virtual false, abstract: false, final false
