...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTextWriterBase64Encoder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTextWriterBase64Encoder(XmlTextWriterBase64Encoder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTextWriterBase64Encoder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTextWriterBase64Encoder(XmlTextWriterBase64Encoderconst&) = delete;
