...
public:
  ...
  /// @brief Method WriteChars, addr 0x42436bc, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4243698, size 0x24, virtual false, abstract: false, final false
