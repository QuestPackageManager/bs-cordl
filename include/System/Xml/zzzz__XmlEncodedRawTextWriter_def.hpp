...
/// @brief Method AmpEntity, addr 0x5ffb440, size 0x24, virtual false, abstract: false, final false
static inline char16_t* AmpEntity(char16_t*  pDst) ;

/// @brief Method CarriageReturnEntity, addr 0x5ffb48c, size 0x24, virtual false, abstract: false, final false
static inline char16_t* CarriageReturnEntity(char16_t*  pDst) ;

/// @brief Method ChangeTextContentMark, addr 0x5ff9408, size 0x74, virtual false, abstract: false, final false
inline void ChangeTextContentMark(bool  value) ;

/// @brief Method CharEntity, addr 0x6004d70, size 0xb0, virtual false, abstract: false, final false
static inline char16_t* CharEntity(char16_t*  pDst, char16_t  ch) ;

/// @brief Method Close, addr 0x6004814, size 0x7c, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EncodeChar, addr 0x5ffb4d4, size 0x90, virtual false, abstract: false, final false
inline void EncodeChar(::ByRef<char16_t*>  pSrc, char16_t*  pSrcEnd, ::ByRef<char16_t*>  pDst) ;

/// @brief Method EncodeChars, addr 0x6004984, size 0x134, virtual false, abstract: false, final false
inline void EncodeChars(int32_t  startOffset, int32_t  endOffset, bool  writeAllToStream) ;

/// @brief Method EncodeSurrogate, addr 0x6004b0c, size 0x150, virtual false, abstract: false, final false
static inline char16_t* EncodeSurrogate(char16_t*  pSrc, char16_t*  pSrcEnd, char16_t*  pDst) ;

/// @brief Method Flush, addr 0x600492c, size 0x58, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushBuffer, addr 0x5ffb9e4, size 0x20c, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method FlushEncoder, addr 0x6004890, size 0x9c, virtual false, abstract: false, final false
inline void FlushEncoder() ;

/// @brief Method GrowTextContentMarks, addr 0x6004e20, size 0x84, virtual false, abstract: false, final false
inline void GrowTextContentMarks() ;

/// @brief Method GtEntity, addr 0x6004ad0, size 0x18, virtual false, abstract: false, final false
static inline char16_t* GtEntity(char16_t*  pDst) ;

/// @brief Method InvalidXmlChar, addr 0x6004c5c, size 0x64, virtual false, abstract: false, final false
inline char16_t* InvalidXmlChar(int32_t  ch, char16_t*  pDst, bool  entitize) ;

/// @brief Method LineFeedEntity, addr 0x5ffb4b0, size 0x24, virtual false, abstract: false, final false
static inline char16_t* LineFeedEntity(char16_t*  pDst) ;

/// @brief Method LtEntity, addr 0x6004ab8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method QuoteEntity, addr 0x5ffb464, size 0x28, virtual false, abstract: false, final false
static inline char16_t* QuoteEntity(char16_t*  pDst) ;

/// @brief Method RawEndCData, addr 0x6004d1c, size 0x1c, virtual false, abstract: false, final false
static inline char16_t* RawEndCData(char16_t*  pDst) ;

/// @brief Method RawStartCData, addr 0x6004d38, size 0x38, virtual false, abstract: false, final false
static inline char16_t* RawStartCData(char16_t*  pDst) ;

/// @brief Method RawText, addr 0x5ffacac, size 0x154, virtual false, abstract: false, final false
inline void RawText(char16_t*  pSrcBegin, char16_t*  pSrcEnd) ;

/// @brief Method RawText, addr 0x5ff947c, size 0x1c, virtual false, abstract: false, final false
inline void RawText(::StringW  s) ;

/// @brief Method StartElementContent, addr 0x6003724, size 0x44, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method TabEntity, addr 0x6004ae8, size 0x24, virtual false, abstract: false, final false
static inline char16_t* TabEntity(char16_t*  pDst) ;

/// @brief Method ValidateContentChars, addr 0x6002fa8, size 0x340, virtual false, abstract: false, final false
inline void ValidateContentChars(::StringW  chars, ::StringW  propertyName, bool  allowOnlyWhitespace) ;

/// @brief Method WriteAttributeTextBlock, addr 0x5ffa754, size 0x2cc, virtual false, abstract: false, final false
inline void WriteAttributeTextBlock(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteCData, addr 0x60039d4, size 0x1e0, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCDataSection, addr 0x6003bb4, size 0x2e8, virtual false, abstract: false, final false
inline void WriteCDataSection(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x60041c0, size 0x1b8, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x6004598, size 0x88, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteComment, addr 0x6003e9c, size 0x12c, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteCommentOrPi, addr 0x5ffa24c, size 0x2dc, virtual false, abstract: false, final false
inline void WriteCommentOrPi(::StringW  text, int32_t  stopChar) ;

/// @brief Method WriteDocType, addr 0x6003510, size 0x214, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteElementTextBlock, addr 0x5ffaa20, size 0x284, virtual false, abstract: false, final false
inline void WriteElementTextBlock(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteEndAttribute, addr 0x6003768, size 0x68, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndElement, addr 0x5ff99ec, size 0x174, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteEndNamespaceDeclaration, addr 0x600396c, size 0x68, virtual true, abstract: false, final false
inline void WriteEndNamespaceDeclaration() ;

/// @brief Method WriteEntityRef, addr 0x60040f4, size 0xcc, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x5ff9c58, size 0x10c, virtual true, abstract: false, final false
inline void WriteFullEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteNamespaceDeclaration, addr 0x60037d0, size 0x54, virtual true, abstract: false, final false
inline void WriteNamespaceDeclaration(::StringW  prefix, ::StringW  namespaceName) ;

/// @brief Method WriteNewLine, addr 0x6004cc0, size 0x5c, virtual false, abstract: false, final false
inline char16_t* WriteNewLine(char16_t*  pDst) ;

/// @brief Method WriteProcessingInstruction, addr 0x6003fc8, size 0x12c, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x5ffee98, size 0x7c, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x5ffedf8, size 0x5c, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteRawWithCharChecking, addr 0x6004620, size 0x1f4, virtual false, abstract: false, final false
inline void WriteRawWithCharChecking(char16_t*  pSrcBegin, char16_t*  pSrcEnd) ;

/// @brief Method WriteStartAttribute, addr 0x5ff9ee0, size 0x124, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x5ff96c4, size 0xcc, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartNamespaceDeclaration, addr 0x600382c, size 0x140, virtual true, abstract: false, final false
inline void WriteStartNamespaceDeclaration(::StringW  prefix) ;

/// @brief Method WriteString, addr 0x60043dc, size 0x64, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x6004440, size 0x158, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace, addr 0x6004378, size 0x64, virtual true, abstract: false, final false
inline void WriteWhitespace(::StringW  ws) ;

/// @brief Method WriteXmlDeclaration, addr 0x60032e8, size 0x1a0, virtual true, abstract: false, final false
inline void WriteXmlDeclaration(::System::Xml::XmlStandalone  standalone) ;

/// @brief Method WriteXmlDeclaration, addr 0x6003488, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6002ecc, size 0xdc, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x5ff8f10, size 0x298, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x5ff8ca0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::TextWriter*  writer, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method get_SupportsNamespaceDeclarationInChunks, addr 0x6003824, size 0x8, virtual true, abstract: false, final false
