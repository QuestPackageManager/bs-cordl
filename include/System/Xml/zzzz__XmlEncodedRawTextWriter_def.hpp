...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11472)), TypeDefinitionIndex(TypeDefinitionIndex(11383)), TypeDefinitionIndex(TypeDefinitionIndex(11363)),
// TypeDefinitionIndex(TypeDefinitionIndex(11422)), TypeDefinitionIndex(TypeDefinitionIndex(11420))} Self: TypeDefinitionIndex(TypeDefinitionIndex(11377)) CS Name:
...
public:
  ...
  /// @brief Method .ctor addr 0x26da6ac size 0xdc virtual false final false
  ...
  /// @brief Method .ctor addr 0x26d3074 size 0xd8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26d32e8 size 0x284 virtual false final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Xml::XmlWriterSettings* settings);

  /// @brief Method WriteXmlDeclaration addr 0x26daae8 size 0x17c virtual true final false
  inline void WriteXmlDeclaration(::System::Xml::XmlStandalone standalone);

  /// @brief Method WriteXmlDeclaration addr 0x26dac64 size 0x78 virtual true final false
  inline void WriteXmlDeclaration(::StringW xmldecl);

  /// @brief Method WriteDocType addr 0x26dacdc size 0x1ec virtual true final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteStartElement addr 0x26d3a90 size 0xc8 virtual true final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method StartElementContent addr 0x26daec8 size 0x44 virtual true final false
  inline void StartElementContent();

  /// @brief Method WriteEndElement addr 0x26d3da0 size 0x170 virtual true final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteFullEndElement addr 0x26d4008 size 0x108 virtual true final false
  inline void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartAttribute addr 0x26d4280 size 0x120 virtual true final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteEndAttribute addr 0x26daf0c size 0x68 virtual true final false
  inline void WriteEndAttribute();

  /// @brief Method WriteNamespaceDeclaration addr 0x26daf74 size 0x54 virtual true final false
  inline void WriteNamespaceDeclaration(::StringW prefix, ::StringW namespaceName);

  /// @brief Method get_SupportsNamespaceDeclarationInChunks addr 0x26dafc8 size 0x8 virtual true final false
  inline bool get_SupportsNamespaceDeclarationInChunks();

  /// @brief Method WriteStartNamespaceDeclaration addr 0x26dafd0 size 0x124 virtual true final false
  inline void WriteStartNamespaceDeclaration(::StringW prefix);

  /// @brief Method WriteEndNamespaceDeclaration addr 0x26db0f4 size 0x68 virtual true final false
  inline void WriteEndNamespaceDeclaration();

  /// @brief Method WriteCData addr 0x26db15c size 0x1e0 virtual true final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteComment addr 0x26db64c size 0x12c virtual true final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteProcessingInstruction addr 0x26db778 size 0x12c virtual true final false
  inline void WriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method WriteEntityRef addr 0x26db8a4 size 0xcc virtual true final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteCharEntity addr 0x26db970 size 0x1c4 virtual true final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteWhitespace addr 0x26dbb34 size 0x6c virtual true final false
  inline void WriteWhitespace(::StringW ws);

  /// @brief Method WriteString addr 0x26dbba0 size 0x6c virtual true final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteSurrogateCharEntity addr 0x26dbc0c size 0x148 virtual true final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteChars addr 0x26dbd54 size 0x88 virtual true final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw addr 0x26d8adc size 0x7c virtual true final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw addr 0x26d8a34 size 0x64 virtual true final false
  inline void WriteRaw(::StringW data);

  /// @brief Method Close addr 0x26dc000 size 0x7c virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0x26dc118 size 0x58 virtual true final false
  inline void Flush();

  /// @brief Method FlushBuffer addr 0x26d5eb4 size 0x1f8 virtual true final false
  inline void FlushBuffer();

  /// @brief Method EncodeChars addr 0x26dc170 size 0x134 virtual false final false
  inline void EncodeChars(int32_t startOffset, int32_t endOffset, bool writeAllToStream);

  /// @brief Method FlushEncoder addr 0x26dc07c size 0x9c virtual false final false
  inline void FlushEncoder();

  /// @brief Method WriteAttributeTextBlock addr 0x26d4b64 size 0x2f4 virtual false final false
  inline void WriteAttributeTextBlock(::cordl_internals::Ptr<char16_t> pSrc, ::cordl_internals::Ptr<char16_t> pSrcEnd);

  /// @brief Method WriteElementTextBlock addr 0x26d4e58 size 0x2b0 virtual false final false
  inline void WriteElementTextBlock(::cordl_internals::Ptr<char16_t> pSrc, ::cordl_internals::Ptr<char16_t> pSrcEnd);

  /// @brief Method RawText addr 0x26d3810 size 0x3c virtual false final false
  inline void RawText(::StringW s);

  /// @brief Method RawText addr 0x26d5130 size 0x174 virtual false final false
  inline void RawText(::cordl_internals::Ptr<char16_t> pSrcBegin, ::cordl_internals::Ptr<char16_t> pSrcEnd);

  /// @brief Method WriteRawWithCharChecking addr 0x26dbddc size 0x224 virtual false final false
  inline void WriteRawWithCharChecking(::cordl_internals::Ptr<char16_t> pSrcBegin, ::cordl_internals::Ptr<char16_t> pSrcEnd);

  /// @brief Method WriteCommentOrPi addr 0x26d45ec size 0x314 virtual false final false
  inline void WriteCommentOrPi(::StringW text, int32_t stopChar);

  /// @brief Method WriteCDataSection addr 0x26db33c size 0x310 virtual false final false
  inline void WriteCDataSection(::StringW text);

  /// @brief Method EncodeSurrogate addr 0x26dc2fc size 0x160 virtual false final false
  ...
  /// @brief Method InvalidXmlChar addr 0x26dc45c size 0x6c virtual false final false
  inline ::cordl_internals::Ptr<char16_t> InvalidXmlChar(int32_t ch, ::cordl_internals::Ptr<char16_t> pDst, bool entitize);

  /// @brief Method EncodeChar addr 0x26d5998 size 0xa4 virtual false final false
  ...
  /// @brief Method ChangeTextContentMark addr 0x26d379c size 0x74 virtual false final false
  inline void ChangeTextContentMark(bool value);

  /// @brief Method GrowTextContentMarks addr 0x26dc62c size 0x80 virtual false final false
  inline void GrowTextContentMarks();

  /// @brief Method WriteNewLine addr 0x26dc4c8 size 0x5c virtual false final false
  inline ::cordl_internals::Ptr<char16_t> WriteNewLine(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method LtEntity addr 0x26dc2a4 size 0x18 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> LtEntity(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method GtEntity addr 0x26dc2bc size 0x18 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> GtEntity(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method AmpEntity addr 0x26d58f4 size 0x28 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> AmpEntity(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method QuoteEntity addr 0x26d591c size 0x2c virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> QuoteEntity(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method TabEntity addr 0x26dc2d4 size 0x28 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> TabEntity(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method LineFeedEntity addr 0x26d5970 size 0x28 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> LineFeedEntity(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method CarriageReturnEntity addr 0x26d5948 size 0x28 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> CarriageReturnEntity(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method CharEntity addr 0x26dc57c size 0xb0 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> CharEntity(::cordl_internals::Ptr<char16_t> pDst, char16_t ch);

  /// @brief Method RawStartCData addr 0x26dc544 size 0x38 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> RawStartCData(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method RawEndCData addr 0x26dc524 size 0x20 virtual false final false
  static inline ::cordl_internals::Ptr<char16_t> RawEndCData(::cordl_internals::Ptr<char16_t> pDst);

  /// @brief Method ValidateContentChars addr 0x26da788 size 0x360 virtual false final false
