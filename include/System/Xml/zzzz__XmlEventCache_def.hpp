...
public:
  ...
  /// @brief Method InitEvent addr 0x26dd5a4 size 0x8 virtual false final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType);

  /// @brief Method InitEvent addr 0x26dd560 size 0xc virtual false final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1);

  /// @brief Method InitEvent addr 0x26dd56c size 0xc virtual false final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2);

  /// @brief Method InitEvent addr 0x26dd578 size 0x10 virtual false final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3);

  /// @brief Method InitEvent addr 0x26dd588 size 0x10 virtual false final false
  ...
  /// @brief Method InitEvent addr 0x26dd598 size 0xc virtual false final false
  inline void InitEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::System::Object* o);

  /// @brief Method get_EventType addr 0x26dd5ac size 0x8 virtual false final false
  inline ::System::Xml::__XmlEventCache__XmlEventType get_EventType();

  /// @brief Method get_String1 addr 0x26dd5b4 size 0x8 virtual false final false
  inline ::StringW get_String1();

  /// @brief Method get_String2 addr 0x26dd5bc size 0x8 virtual false final false
  inline ::StringW get_String2();

  /// @brief Method get_String3 addr 0x26dd5c4 size 0x8 virtual false final false
  inline ::StringW get_String3();

  /// @brief Method get_Object addr 0x26dd5cc size 0x8 virtual false final false
...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11383)), TypeDefinitionIndex(TypeDefinitionIndex(11520))}
...
public:
  ...
  /// @brief Method .ctor addr 0x26d9494 size 0x30 virtual false final false
  inline void _ctor(::StringW baseUri, bool hasRootNode);

  /// @brief Method EndEvents addr 0x26d9fa4 size 0x14 virtual false final false
  inline void EndEvents();

  /// @brief Method EventsToWriter addr 0x26d9fb8 size 0x6f4 virtual false final false
  inline void EventsToWriter(::System::Xml::XmlWriter* writer);

  /// @brief Method WriteDocType addr 0x26dccdc size 0x18 virtual true final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteStartElement addr 0x26dcd64 size 0x14 virtual true final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartAttribute addr 0x26dcddc size 0x14 virtual true final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteEndAttribute addr 0x26dcdf0 size 0x8 virtual true final false
  inline void WriteEndAttribute();

  /// @brief Method WriteCData addr 0x26dcdf8 size 0xc virtual true final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteComment addr 0x26dce54 size 0xc virtual true final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteProcessingInstruction addr 0x26dce60 size 0x10 virtual true final false
  inline void WriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method WriteWhitespace addr 0x26dcecc size 0xc virtual true final false
  inline void WriteWhitespace(::StringW ws);

  /// @brief Method WriteString addr 0x26dced8 size 0x24 virtual true final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteChars addr 0x26dcefc size 0x30 virtual true final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw addr 0x26dcf2c size 0x30 virtual true final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw addr 0x26dcf5c size 0xc virtual true final false
  inline void WriteRaw(::StringW data);

  /// @brief Method WriteEntityRef addr 0x26dcf68 size 0xc virtual true final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteCharEntity addr 0x26dcf74 size 0x6c virtual true final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteSurrogateCharEntity addr 0x26dd030 size 0x8c virtual true final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteBase64 addr 0x26dd0bc size 0x2c virtual true final false
  inline void WriteBase64(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteBinHex addr 0x26dd19c size 0x2c virtual true final false
  inline void WriteBinHex(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Close addr 0x26dd1c8 size 0x8 virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0x26dd1d0 size 0x8 virtual true final false
  inline void Flush();

  /// @brief Method WriteValue addr 0x26dd1d8 size 0x10 virtual true final false
  inline void WriteValue(::StringW value);

  /// @brief Method Dispose addr 0x26dd1e8 size 0xb0 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method WriteXmlDeclaration addr 0x26dd298 size 0x6c virtual true final false
  inline void WriteXmlDeclaration(::System::Xml::XmlStandalone standalone);

  /// @brief Method WriteXmlDeclaration addr 0x26dd304 size 0xc virtual true final false
  inline void WriteXmlDeclaration(::StringW xmldecl);

  /// @brief Method StartElementContent addr 0x26dd310 size 0x8 virtual true final false
  inline void StartElementContent();

  /// @brief Method WriteEndElement addr 0x26dd318 size 0x14 virtual true final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteFullEndElement addr 0x26dd32c size 0x14 virtual true final false
  inline void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteNamespaceDeclaration addr 0x26dd340 size 0x10 virtual true final false
  inline void WriteNamespaceDeclaration(::StringW prefix, ::StringW ns);

  /// @brief Method WriteEndBase64 addr 0x26dd350 size 0x8 virtual true final false
  inline void WriteEndBase64();

  /// @brief Method AddEvent addr 0x26dcc94 size 0x48 virtual false final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType);

  /// @brief Method AddEvent addr 0x26dce04 size 0x50 virtual false final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1);

  /// @brief Method AddEvent addr 0x26dce70 size 0x5c virtual false final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2);

  /// @brief Method AddEvent addr 0x26dcd78 size 0x64 virtual false final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3);

  /// @brief Method AddEvent addr 0x26dccf4 size 0x70 virtual false final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3, ::System::Object* o);

  /// @brief Method AddEvent addr 0x26dcfe0 size 0x50 virtual false final false
  inline void AddEvent(::System::Xml::__XmlEventCache__XmlEventType eventType, ::System::Object* o);

  /// @brief Method NewEvent addr 0x26dd358 size 0x208 virtual false final false
  inline int32_t NewEvent();

  /// @brief Method ToBytes addr 0x26dd0e8 size 0xb4 virtual false final false
