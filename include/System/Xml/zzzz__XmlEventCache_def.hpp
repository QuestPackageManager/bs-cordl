...
public:
  ...
  /// @brief Method InitEvent, addr 0x4314ad4, size 0x8, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::XmlEventCache_XmlEventType eventType);

  /// @brief Method InitEvent, addr 0x4314ac8, size 0xc, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::System::Object* o);

  /// @brief Method InitEvent, addr 0x4314a90, size 0xc, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::StringW s1);

  /// @brief Method InitEvent, addr 0x4314a9c, size 0xc, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::StringW s1, ::StringW s2);

  /// @brief Method InitEvent, addr 0x4314aa8, size 0x10, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3);

  /// @brief Method InitEvent, addr 0x4314ab8, size 0x10, virtual false, abstract: false, final false
  inline void InitEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3, ::System::Object* o);

  /// @brief Method get_EventType, addr 0x4314adc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlEventCache_XmlEventType get_EventType();

  /// @brief Method get_Object, addr 0x4314afc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Object();

  /// @brief Method get_String1, addr 0x4314ae4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_String1();

  /// @brief Method get_String2, addr 0x4314aec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_String2();

  /// @brief Method get_String3, addr 0x4314af4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddEvent, addr 0x43141c8, size 0x48, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::XmlEventCache_XmlEventType eventType);

  /// @brief Method AddEvent, addr 0x4314514, size 0x50, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::System::Object* o);

  /// @brief Method AddEvent, addr 0x4314338, size 0x50, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::StringW s1);

  /// @brief Method AddEvent, addr 0x43143a4, size 0x5c, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::StringW s1, ::StringW s2);

  /// @brief Method AddEvent, addr 0x43142ac, size 0x64, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3);

  /// @brief Method AddEvent, addr 0x4314228, size 0x70, virtual false, abstract: false, final false
  inline void AddEvent(::System::Xml::XmlEventCache_XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3, ::System::Object* o);

  /// @brief Method Close, addr 0x43146fc, size 0x8, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x431471c, size 0xb0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndEvents, addr 0x431030c, size 0x14, virtual false, abstract: false, final false
  inline void EndEvents();

  /// @brief Method EventsToWriter, addr 0x4310320, size 0x6ec, virtual false, abstract: false, final false
  inline void EventsToWriter(::System::Xml::XmlWriter* writer);

  /// @brief Method Flush, addr 0x4314704, size 0x8, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method NewEvent, addr 0x431488c, size 0x204, virtual false, abstract: false, final false
  inline int32_t NewEvent();

  static inline ::System::Xml::XmlEventCache* New_ctor(::StringW baseUri, bool hasRootNode);

  /// @brief Method StartElementContent, addr 0x4314844, size 0x8, virtual true, abstract: false, final false
  inline void StartElementContent();

  /// @brief Method ToBytes, addr 0x431461c, size 0xb4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteBase64, addr 0x43145f0, size 0x2c, virtual true, abstract: false, final false
  inline void WriteBase64(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteBinHex, addr 0x43146d0, size 0x2c, virtual true, abstract: false, final false
  inline void WriteBinHex(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteCData, addr 0x431432c, size 0xc, virtual true, abstract: false, final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x43144a8, size 0x6c, virtual true, abstract: false, final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteChars, addr 0x4314430, size 0x30, virtual true, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteComment, addr 0x4314388, size 0xc, virtual true, abstract: false, final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteDocType, addr 0x4314210, size 0x18, virtual true, abstract: false, final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteEndAttribute, addr 0x4314324, size 0x8, virtual true, abstract: false, final false
  inline void WriteEndAttribute();

  /// @brief Method WriteEndBase64, addr 0x4314884, size 0x8, virtual true, abstract: false, final false
  inline void WriteEndBase64();

  /// @brief Method WriteEndElement, addr 0x431484c, size 0x14, virtual true, abstract: false, final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteEntityRef, addr 0x431449c, size 0xc, virtual true, abstract: false, final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteFullEndElement, addr 0x4314860, size 0x14, virtual true, abstract: false, final false
  inline void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteNamespaceDeclaration, addr 0x4314874, size 0x10, virtual true, abstract: false, final false
  inline void WriteNamespaceDeclaration(::StringW prefix, ::StringW ns);

  /// @brief Method WriteProcessingInstruction, addr 0x4314394, size 0x10, virtual true, abstract: false, final false
  inline void WriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method WriteRaw, addr 0x4314460, size 0x30, virtual true, abstract: false, final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw, addr 0x4314490, size 0xc, virtual true, abstract: false, final false
  inline void WriteRaw(::StringW data);

  /// @brief Method WriteStartAttribute, addr 0x4314310, size 0x14, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartElement, addr 0x4314298, size 0x14, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteString, addr 0x431440c, size 0x24, virtual true, abstract: false, final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteSurrogateCharEntity, addr 0x4314564, size 0x8c, virtual true, abstract: false, final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteValue, addr 0x431470c, size 0x10, virtual true, abstract: false, final false
  inline void WriteValue(::StringW value);

  /// @brief Method WriteWhitespace, addr 0x4314400, size 0xc, virtual true, abstract: false, final false
  inline void WriteWhitespace(::StringW ws);

  /// @brief Method WriteXmlDeclaration, addr 0x43147cc, size 0x6c, virtual true, abstract: false, final false
  inline void WriteXmlDeclaration(::System::Xml::XmlStandalone standalone);

  /// @brief Method WriteXmlDeclaration, addr 0x4314838, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x430f800, size 0x30, virtual false, abstract: false, final false
