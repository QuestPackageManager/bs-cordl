...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Xml::Ucs4Decoder3412::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t, ::ArrayW<char16_t,::Array<char16_t>*>, int32_t)>(&::System::Xml::Ucs4Decoder3412::GetFullChars)> {
  constexpr static std::size_t size = 0x200;
  constexpr static std::size_t addrs = 0x61a3d44;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Ucs4Decoder3412::*)()>(&::System::Xml::Ucs4Decoder3412::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x61a31d8;
...
inline int32_t System::Xml::Ucs4Decoder3412::GetFullChars(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  charIndex)  {
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Xml::Ucs4Decoder3412*>());
}
// Ctor Parameters []
