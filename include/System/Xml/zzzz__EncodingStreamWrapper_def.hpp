...
/// @brief Method CheckUTF8DeclarationEncoding, addr 0x5f4bd88, size 0x5f0, virtual false, abstract: false, final false
...
/// @brief Method CleanupCharBreak, addr 0x5f4c454, size 0x1b0, virtual false, abstract: false, final false
inline void CleanupCharBreak() ;

/// @brief Method Close, addr 0x5f4cf4c, size 0x44, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Compare, addr 0x5f4cba0, size 0x88, virtual false, abstract: false, final false
static inline bool Compare(::ArrayW<uint8_t,::Array<uint8_t>*>  key, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method CompareCaseInsensitive, addr 0x5f4cc28, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method EnsureBuffers, addr 0x5f4c378, size 0x64, virtual false, abstract: false, final false
inline void EnsureBuffers() ;

/// @brief Method EnsureByteBuffer, addr 0x5f4cb24, size 0x5c, virtual false, abstract: false, final false
inline void EnsureByteBuffer() ;

/// @brief Method FillBuffer, addr 0x5f4bd18, size 0x70, virtual false, abstract: false, final false
inline void FillBuffer(int32_t  count) ;

/// @brief Method Flush, addr 0x5f4cf90, size 0x20, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method GetEncoding, addr 0x5f4c604, size 0x108, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* GetEncoding(::System::Xml::EncodingStreamWrapper_SupportedEncoding  e) ;

/// @brief Method GetEncodingName, addr 0x5f4c70c, size 0xc8, virtual false, abstract: false, final false
static inline ::StringW GetEncodingName(::System::Xml::EncodingStreamWrapper_SupportedEncoding  enc) ;

/// @brief Method GetSupportedEncoding, addr 0x5f4b854, size 0x1ac, virtual false, abstract: false, final false
static inline ::System::Xml::EncodingStreamWrapper_SupportedEncoding GetSupportedEncoding(::System::Text::Encoding*  encoding) ;

/// @brief Method IsWhitespace, addr 0x5f4cb80, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x5f4d034, size 0x24c, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadBOMEncoding, addr 0x5f4c9b4, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method ReadBOMEncoding, addr 0x5f4ba00, size 0x234, virtual false, abstract: false, final false
inline ::System::Xml::EncodingStreamWrapper_SupportedEncoding ReadBOMEncoding(bool  notOutOfBand) ;

/// @brief Method ReadByte, addr 0x5f4cfb0, size 0x84, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method Seek, addr 0x5f4d280, size 0x38, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x5f4d4e8, size 0x38, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method SetReadDocumentEncoding, addr 0x5f4c3dc, size 0x78, virtual false, abstract: false, final false
inline void SetReadDocumentEncoding(::System::Xml::EncodingStreamWrapper_SupportedEncoding  e) ;

/// @brief Method ThrowEncodingMismatch, addr 0x5f4cd60, size 0xb8, virtual false, abstract: false, final false
static inline void ThrowEncodingMismatch(::StringW  declEnc, ::StringW  docEnc) ;

/// @brief Method ThrowEncodingMismatch, addr 0x5f4ce18, size 0x64, virtual false, abstract: false, final false
static inline void ThrowEncodingMismatch(::StringW  declEnc, ::System::Xml::EncodingStreamWrapper_SupportedEncoding  enc) ;

/// @brief Method ThrowExpectedEncodingMismatch, addr 0x5f4bc34, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x5f4d31c, size 0x114, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteByte, addr 0x5f4d2b8, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5f4b3f4, size 0x460, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x5f4c7d4, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x5f4ce7c, size 0x2c, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x5f4cea8, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x5f4d430, size 0x1c, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_CanWrite, addr 0x5f4ceb0, size 0x2c, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x5f4d44c, size 0x1c, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x5f4cedc, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x5f4d468, size 0x20, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_WriteTimeout, addr 0x5f4d4a8, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method set_Position, addr 0x5f4cf14, size 0x38, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x5f4d488, size 0x20, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x5f4d4c8, size 0x20, virtual true, abstract: false, final false
