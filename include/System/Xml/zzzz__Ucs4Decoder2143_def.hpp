...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x2ebbb04, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ebb130, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
