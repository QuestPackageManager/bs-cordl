...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x62e4458, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62e3a28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Ucs4Decoder2143", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Ucs4Decoder2143(Ucs4Decoder2143&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Ucs4Decoder2143", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Ucs4Decoder2143(Ucs4Decoder2143const&) = delete;
