...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x4360b74, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4360168, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
