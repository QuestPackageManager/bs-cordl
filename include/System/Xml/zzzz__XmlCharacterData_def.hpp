...
public:
  ...
  /// @brief Method CheckOnData, addr 0x29d0054, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29cfdbc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW data, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_Data, addr 0x29cff60, size 0x54, virtual true, abstract: false, final false
  inline ::StringW get_Data();

  /// @brief Method get_InnerText, addr 0x29cff48, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_InnerText();

  /// @brief Method get_Value, addr 0x29cff28, size 0x10, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Data, addr 0x29cffb4, size 0xa0, virtual true, abstract: false, final false
  inline void set_Data(::StringW value);

  /// @brief Method set_InnerText, addr 0x29cff54, size 0xc, virtual true, abstract: false, final false
  inline void set_InnerText(::StringW value);

  /// @brief Method set_Value, addr 0x29cff38, size 0x10, virtual true, abstract: false, final false
