...
public:
  ...
  /// @brief Method CheckOnData, addr 0x2e8f010, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e8ed18, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW data, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_Data, addr 0x2e8ef1c, size 0x54, virtual true, abstract: false, final false
  inline ::StringW get_Data();

  /// @brief Method get_InnerText, addr 0x2e8ef04, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_InnerText();

  /// @brief Method get_Value, addr 0x2e8eee4, size 0x10, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Data, addr 0x2e8ef70, size 0xa0, virtual true, abstract: false, final false
  inline void set_Data(::StringW value);

  /// @brief Method set_InnerText, addr 0x2e8ef10, size 0xc, virtual true, abstract: false, final false
  inline void set_InnerText(::StringW value);

  /// @brief Method set_Value, addr 0x2e8eef4, size 0x10, virtual true, abstract: false, final false
