...
public:
  ...
  /// @brief Method CheckOnData, addr 0x4335a80, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4335788, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW data, ::System::Xml::XmlDocument* doc);

  /// @brief Method get_Data, addr 0x433598c, size 0x54, virtual true, abstract: false, final false
  inline ::StringW get_Data();

  /// @brief Method get_InnerText, addr 0x4335974, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_InnerText();

  /// @brief Method get_Value, addr 0x4335954, size 0x10, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Data, addr 0x43359e0, size 0xa0, virtual true, abstract: false, final false
  inline void set_Data(::StringW value);

  /// @brief Method set_InnerText, addr 0x4335980, size 0xc, virtual true, abstract: false, final false
  inline void set_InnerText(::StringW value);

  /// @brief Method set_Value, addr 0x4335964, size 0x10, virtual true, abstract: false, final false
