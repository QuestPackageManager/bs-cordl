...
DEFINE_IL2CPP_CLASS(::System::Xml::XPath::XPathNamespaceScope, "System.Xml.XPath", "XPathNamespaceScope");
// Dependencies
namespace System::Xml::XPath {
// Is value type: true
...
static_assert(sizeof(::System::Xml::XPath::XPathNamespaceScope) == 0x4, "Size mismatch!");
