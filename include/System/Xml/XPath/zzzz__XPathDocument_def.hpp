...
public:
  ...
  /// @brief Method GetXmlNamespaceNode, addr 0x4365af8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method LookupNamespaces, addr 0x4365b08, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HasLineInfo, addr 0x4365af0, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasLineInfo();

  /// @brief Method get_NameTable, addr 0x4365ae8, size 0x8, virtual false, abstract: false, final false
