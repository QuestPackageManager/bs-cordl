...
// Write type traits
MARK_REF_T(::System::Xml::XPath::XPathDocument*);
DEFINE_IL2CPP_CLASS(::System::Xml::XPath::XPathDocument*, "System.Xml.XPath", "XPathDocument");
...
public:
  ...
  /// @brief Method GetXmlNamespaceNode, addr 0x62e7cb8, size 0x14, virtual false, abstract: false, final false
  inline int32_t GetXmlNamespaceNode(::by_ref<::ArrayW<::MS::Internal::Xml::Cache::XPathNode>> pageXmlNmsp);

  /// @brief Method LookupNamespaces, addr 0x62e7ccc, size 0xd8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> const& __cordl_internal_get_pageXmlNmsp() const;

  constexpr ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>& __cordl_internal_get_pageXmlNmsp();
  ...
  /// @brief Method get_HasLineInfo, addr 0x62e7cb0, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasLineInfo();

  /// @brief Method get_NameTable, addr 0x62e7ca8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XPathDocument", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XPathDocument(XPathDocument&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XPathDocument", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XPathDocument(XPathDocumentconst&) = delete;
...
static_assert(sizeof(::System::Xml::XPath::XPathDocument) == 0x38, "Size mismatch!");
