...
public:
  ...
  /// @brief Method GetXmlNamespaceNode, addr 0x4368750, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method LookupNamespaces, addr 0x4368760, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HasLineInfo, addr 0x4368748, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasLineInfo();

  /// @brief Method get_NameTable, addr 0x4368740, size 0x8, virtual false, abstract: false, final false
