...
public:
  ...
  /// @brief Method Create, addr 0x4301c68, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Xml::XPath::XPathException* Create(::StringW res);

  /// @brief Method Create, addr 0x4301d38, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Xml::XPath::XPathException* Create(::StringW res, ::StringW arg);

  /// @brief Method Create, addr 0x4301e00, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::Xml::XPath::XPathException* Create(::StringW res, ::StringW arg, ::StringW arg2);

  /// @brief Method CreateMessage, addr 0x43018d4, size 0x13c, virtual false, abstract: false, final false
  static inline ::StringW CreateMessage(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method GetObjectData, addr 0x4301a10, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4301af8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4301660, size 0x274, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x4301b4c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x4301ce8, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method .ctor, addr 0x4301c0c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Exception* inner);

  /// @brief Method get_Message, addr 0x4301ed8, size 0x18, virtual true, abstract: false, final false
