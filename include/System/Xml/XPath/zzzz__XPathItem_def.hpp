...
/// @brief Method ValueAs, addr 0x6134198, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61341ac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
