...
public:
  ...
  /// @brief Method ValueAs, addr 0x6133ad8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6133aec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
