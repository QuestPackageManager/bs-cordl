...
public:
  ...
  /// @brief Method ValueAs, addr 0x62e2e18, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62e2e2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
