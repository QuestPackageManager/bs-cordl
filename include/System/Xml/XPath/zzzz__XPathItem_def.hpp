...
public:
  ...
  /// @brief Method ValueAs, addr 0x2ebfd64, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ebfd78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
