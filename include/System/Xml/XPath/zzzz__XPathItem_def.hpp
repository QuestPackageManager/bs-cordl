...
public:
  ...
  /// @brief Method ValueAs, addr 0x2eefe68, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2eefe7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
