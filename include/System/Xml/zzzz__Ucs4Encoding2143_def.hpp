...
public:
  ...
  /// @brief Method .ctor, addr 0x28a5e94, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EncodingName, addr 0x28a613c, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_EncodingName();

  /// @brief Method GetPreamble, addr 0x28a617c, size 0x78, virtual true, abstract: false, final false
