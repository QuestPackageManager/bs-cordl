...
public:
  ...
  /// @brief Method GetPreamble, addr 0x612ef18, size 0x7c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPreamble();

  static inline ::System::Xml::Ucs4Encoding2143* New_ctor();

  /// @brief Method .ctor, addr 0x612ebf8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_EncodingName, addr 0x612eed4, size 0x44, virtual true, abstract: false, final false
