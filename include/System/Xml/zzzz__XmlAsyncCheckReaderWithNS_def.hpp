...
public:
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x6072584, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x6072638, size 0xb8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x60726f0, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6071648, size 0x9c, virtual false, abstract: false, final false
