...
/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x6074514, size 0xb4, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x60745c8, size 0xb8, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW  prefix) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x6074680, size 0xb8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6073088, size 0x9c, virtual false, abstract: false, final false
