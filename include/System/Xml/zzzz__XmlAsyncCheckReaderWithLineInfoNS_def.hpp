...
// Write type traits
MARK_REF_T(::System::Xml::XmlAsyncCheckReaderWithLineInfoNS*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlAsyncCheckReaderWithLineInfoNS*, "System.Xml", "XmlAsyncCheckReaderWithLineInfoNS");
// Dependencies System.Xml.XmlAsyncCheckReaderWithLineInfo
namespace System::Xml {
// Is value type: false
...
public:
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x61b4e28, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x61b4edc, size 0xb8, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x61b4f94, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x61b399c, size 0x9c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlAsyncCheckReaderWithLineInfoNS", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlAsyncCheckReaderWithLineInfoNS(XmlAsyncCheckReaderWithLineInfoNS&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlAsyncCheckReaderWithLineInfoNS", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlAsyncCheckReaderWithLineInfoNS(XmlAsyncCheckReaderWithLineInfoNSconst&) = delete;
...
static_assert(sizeof(::System::Xml::XmlAsyncCheckReaderWithLineInfoNS) == 0x30, "Size mismatch!");
