...
/// @brief Method Close, addr 0x6118184, size 0xc, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method FinishReadBinary, addr 0x6117734, size 0x20, virtual false, abstract: false, final false
inline void FinishReadBinary() ;

/// @brief Method GetAttribute, addr 0x61175e8, size 0x70, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  attributeIndex) ;

/// @brief Method GetAttribute, addr 0x611757c, size 0x2c, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x61175a8, size 0x40, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  namespaceURI) ;

/// @brief Method IsInReadingStates, addr 0x6117264, size 0x10, virtual false, abstract: false, final false
inline bool IsInReadingStates() ;

/// @brief Method LookupNamespace, addr 0x6118278, size 0x3c, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method MoveToAttribute, addr 0x6117658, size 0xdc, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x6117754, size 0xec, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name, ::StringW  namespaceURI) ;

/// @brief Method MoveToAttribute, addr 0x6117840, size 0x1e0, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  attributeIndex) ;

/// @brief Method MoveToElement, addr 0x6117be4, size 0xe0, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x6117a20, size 0xe0, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x6117b00, size 0xe4, virtual true, abstract: false, final false
inline bool MoveToNextAttribute() ;

static inline ::System::Xml::XmlNodeReader* New_ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method ReSetReadingMarks, addr 0x6117fac, size 0x24, virtual false, abstract: false, final false
inline void ReSetReadingMarks() ;

/// @brief Method Read, addr 0x6117cc4, size 0x8, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method Read, addr 0x6117ccc, size 0x110, virtual false, abstract: false, final false
inline bool Read(bool  fSkipChildren) ;

/// @brief Method ReadAtZeroLevel, addr 0x61180e8, size 0x78, virtual false, abstract: false, final false
inline bool ReadAtZeroLevel(bool  fSkipChildren) ;

/// @brief Method ReadAttributeValue, addr 0x6118328, size 0x50, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method ReadContentAsBase64, addr 0x6118378, size 0x84, virtual true, abstract: false, final false
inline int32_t ReadContentAsBase64(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadContentAsBinHex, addr 0x61183fc, size 0x84, virtual true, abstract: false, final false
inline int32_t ReadContentAsBinHex(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadForward, addr 0x6117fd0, size 0x100, virtual false, abstract: false, final false
inline bool ReadForward(bool  fSkipChildren) ;

/// @brief Method ReadNextNode, addr 0x6117ddc, size 0x1d0, virtual false, abstract: false, final false
inline bool ReadNextNode(bool  fSkipChildren) ;

/// @brief Method ReadString, addr 0x61181a0, size 0x9c, virtual true, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ResolveEntity, addr 0x61182b4, size 0x74, virtual true, abstract: false, final false
inline void ResolveEntity() ;

/// @brief Method SetEndOfFile, addr 0x61180d0, size 0x18, virtual false, abstract: false, final false
inline void SetEndOfFile() ;

/// @brief Method Skip, addr 0x6118198, size 0x8, virtual true, abstract: false, final false
inline void Skip() ;

/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x6118480, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x61184b0, size 0x68, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW  prefix) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x6118498, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6117180, size 0xe4, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method get_AttributeCount, addr 0x6117544, size 0x38, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x61173e0, size 0x2c, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_CanResolveEntity, addr 0x611740c, size 0x8, virtual true, abstract: false, final false
inline bool get_CanResolveEntity() ;

/// @brief Method get_Depth, addr 0x61173d8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_DtdInfo, addr 0x6118518, size 0x24, virtual true, abstract: false, final false
inline ::System::Xml::IDtdInfo* get_DtdInfo() ;

/// @brief Method get_EOF, addr 0x6118160, size 0x24, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_HasAttributes, addr 0x611823c, size 0x24, virtual true, abstract: false, final false
inline bool get_HasAttributes() ;

/// @brief Method get_IsDefault, addr 0x6117440, size 0x2c, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsEmptyElement, addr 0x6117414, size 0x2c, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LocalName, addr 0x61172c8, size 0x38, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x6117290, size 0x38, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameTable, addr 0x6118260, size 0x18, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x6117300, size 0x50, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x6117274, size 0x1c, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x6117350, size 0x50, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_ReadState, addr 0x6118190, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_SchemaInfo, addr 0x6117500, size 0x44, virtual true, abstract: false, final false
inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo() ;

/// @brief Method get_Value, addr 0x61173a0, size 0x38, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_XmlLang, addr 0x61174b0, size 0x50, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x611746c, size 0x44, virtual true, abstract: false, final false
