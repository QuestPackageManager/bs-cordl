...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlNodeReader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlNodeReader(XmlNodeReader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlNodeReader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlNodeReader(XmlNodeReaderconst&) = delete;
