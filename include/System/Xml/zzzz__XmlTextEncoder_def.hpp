...
public:
  ...
  /// @brief Method EndAttribute, addr 0x628f15c, size 0x38, virtual false, abstract: false, final false
  inline void EndAttribute();

  static inline ::System::Xml::XmlTextEncoder* New_ctor(::System::IO::TextWriter* textWriter);

  /// @brief Method StartAttribute, addr 0x628f0c0, size 0x9c, virtual false, abstract: false, final false
  inline void StartAttribute(bool cacheAttrValue);

  /// @brief Method Write, addr 0x628f280, size 0x434, virtual false, abstract: false, final false
  inline void Write(::ArrayW<char16_t> array, int32_t offset, int32_t count);

  /// @brief Method Write, addr 0x628f930, size 0x454, virtual false, abstract: false, final false
  inline void Write(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x6290128, size 0x138, virtual false, abstract: false, final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteCharEntityImpl, addr 0x628f6b4, size 0x7c, virtual false, abstract: false, final false
  inline void WriteCharEntityImpl(char16_t ch);

  /// @brief Method WriteCharEntityImpl, addr 0x6290260, size 0xa4, virtual false, abstract: false, final false
  inline void WriteCharEntityImpl(::StringW strVal);

  /// @brief Method WriteEntityRef, addr 0x6290304, size 0x6c, virtual false, abstract: false, final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteEntityRefImpl, addr 0x628f730, size 0x70, virtual false, abstract: false, final false
  inline void WriteEntityRefImpl(::StringW name);

  /// @brief Method WriteRaw, addr 0x628fffc, size 0x12c, virtual false, abstract: false, final false
  inline void WriteRaw(::ArrayW<char16_t> array, int32_t offset, int32_t count);

  /// @brief Method WriteRawWithSurrogateChecking, addr 0x628fe2c, size 0x1d0, virtual false, abstract: false, final false
  inline void WriteRawWithSurrogateChecking(::StringW text);

  /// @brief Method WriteStringFragment, addr 0x628fd84, size 0xa8, virtual false, abstract: false, final false
  inline void WriteStringFragment(::StringW str, int32_t offset, int32_t count, ::ArrayW<char16_t> helperBuffer);

  /// @brief Method WriteSurrogateChar, addr 0x628f1cc, size 0xb4, virtual false, abstract: false, final false
  inline void WriteSurrogateChar(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteSurrogateCharEntity, addr 0x628f7a0, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x628f090, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextWriter* textWriter);

  /// @brief Method get_AttributeValue, addr 0x628f194, size 0x38, virtual false, abstract: false, final false
  inline ::StringW get_AttributeValue();

  /// @brief Method set_QuoteChar, addr 0x628f0b8, size 0x8, virtual false, abstract: false, final false
