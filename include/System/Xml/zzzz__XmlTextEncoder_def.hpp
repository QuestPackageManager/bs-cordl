...
public:
  ...
  /// @brief Method EndAttribute, addr 0x2ea0d44, size 0x38, virtual false, abstract: false, final false
  inline void EndAttribute();

  static inline ::System::Xml::XmlTextEncoder* New_ctor(::System::IO::TextWriter* textWriter);

  /// @brief Method StartAttribute, addr 0x2ea0ca4, size 0xa0, virtual false, abstract: false, final false
  inline void StartAttribute(bool cacheAttrValue);

  /// @brief Method Write, addr 0x2ea0ea4, size 0x42c, virtual false, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> array, int32_t offset, int32_t count);

  /// @brief Method Write, addr 0x2ea154c, size 0x434, virtual false, abstract: false, final false
  inline void Write(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x2ea1d58, size 0x148, virtual false, abstract: false, final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteCharEntityImpl, addr 0x2ea12d0, size 0x7c, virtual false, abstract: false, final false
  inline void WriteCharEntityImpl(char16_t ch);

  /// @brief Method WriteCharEntityImpl, addr 0x2ea1ea0, size 0x98, virtual false, abstract: false, final false
  inline void WriteCharEntityImpl(::StringW strVal);

  /// @brief Method WriteEntityRef, addr 0x2ea1f38, size 0x6c, virtual false, abstract: false, final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteEntityRefImpl, addr 0x2ea134c, size 0x70, virtual false, abstract: false, final false
  inline void WriteEntityRefImpl(::StringW name);

  /// @brief Method WriteRaw, addr 0x2ea1c20, size 0x138, virtual false, abstract: false, final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> array, int32_t offset, int32_t count);

  /// @brief Method WriteRawWithSurrogateChecking, addr 0x2ea1a28, size 0x1f8, virtual false, abstract: false, final false
  inline void WriteRawWithSurrogateChecking(::StringW text);

  /// @brief Method WriteStringFragment, addr 0x2ea1980, size 0xa8, virtual false, abstract: false, final false
  inline void WriteStringFragment(::StringW str, int32_t offset, int32_t count, ::ArrayW<char16_t, ::Array<char16_t>*> helperBuffer);

  /// @brief Method WriteSurrogateChar, addr 0x2ea0df0, size 0xb4, virtual false, abstract: false, final false
  inline void WriteSurrogateChar(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteSurrogateCharEntity, addr 0x2ea13bc, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ea0c60, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextWriter* textWriter);

  /// @brief Method get_AttributeValue, addr 0x2ea0d7c, size 0x74, virtual false, abstract: false, final false
  inline ::StringW get_AttributeValue();

  /// @brief Method set_QuoteChar, addr 0x2ea0c9c, size 0x8, virtual false, abstract: false, final false
