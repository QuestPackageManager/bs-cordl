...
public:
  ...
  /// @brief Method Clear, addr 0x2df0960, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ConcatNoDelimiter, addr 0x2df0a68, size 0x2b8, virtual false, abstract: false, final false
  inline void ConcatNoDelimiter(::StringW s);

  /// @brief Method GetResult, addr 0x2df0974, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW GetResult();

  /// @brief Method get_Count, addr 0x2df096c, size 0x8, virtual false, abstract: false, final false
