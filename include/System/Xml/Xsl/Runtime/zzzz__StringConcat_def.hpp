...
public:
  ...
  /// @brief Method Clear, addr 0x61d42e0, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ConcatNoDelimiter, addr 0x61d43e8, size 0x2c8, virtual false, abstract: false, final false
  inline void ConcatNoDelimiter(::StringW s);

  /// @brief Method GetResult, addr 0x61d42f4, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW GetResult();

  /// @brief Method get_Count, addr 0x61d42ec, size 0x8, virtual false, abstract: false, final false
