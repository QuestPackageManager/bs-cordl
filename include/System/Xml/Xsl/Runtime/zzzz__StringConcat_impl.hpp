...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Xsl::Runtime::StringConcat::*)()>(&::System::Xml::Xsl::Runtime::StringConcat::Clear)> {
  ...
  constexpr static std::size_t addrs = 0x61622d4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Xml::Xsl::Runtime::StringConcat::*)()>(&::System::Xml::Xsl::Runtime::StringConcat::get_Count)> {
  ...
  constexpr static std::size_t addrs = 0x61622e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::System::Xml::Xsl::Runtime::StringConcat::*)()>(&::System::Xml::Xsl::Runtime::StringConcat::GetResult)> {
  ...
  constexpr static std::size_t addrs = 0x61622e8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Xsl::Runtime::StringConcat::*)(::StringW)>(&::System::Xml::Xsl::Runtime::StringConcat::ConcatNoDelimiter)> {
  constexpr static std::size_t size = 0x2c8;
  constexpr static std::size_t addrs = 0x61623dc;
...
// Ctor Parameters [CppParam { name: "s1", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "s2", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "s3", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "s4", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "delimiter", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "strList", ty: "::System::Collections::Generic::List_1<::StringW>*", modifiers: "", def_value: Some("{}") }, CppParam { name: "idxStr", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Xml::Xsl::Runtime::StringConcat::StringConcat(::StringW  s1, ::StringW  s2, ::StringW  s3, ::StringW  s4, ::StringW  delimiter, ::System::Collections::Generic::List_1<::StringW>*  strList, int32_t  idxStr) noexcept  {
this->s1 = s1;
this->s2 = s2;
this->s3 = s3;
this->s4 = s4;
