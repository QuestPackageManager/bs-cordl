...
public:
  ...
  /// @brief Method ResolveUri addr 0x28a92cc size 0x1d8 virtual true final false
  inline ::System::Uri* ResolveUri(::System::Uri* baseUri, ::StringW relativeUri);

  /// @brief Method SupportsType addr 0x28a94a4 size 0x148 virtual true final false
  inline bool SupportsType(::System::Uri* absoluteUri, ::System::Type* type);

  /// @brief Method GetEntityAsync addr 0x28a95ec size 0x40 virtual true final false
  ...
  /// @brief Method .ctor addr 0x28a962c size 0x8 virtual false final false
  inline void _ctor();
