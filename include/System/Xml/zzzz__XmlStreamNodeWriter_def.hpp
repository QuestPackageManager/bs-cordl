...
/// @brief Method Advance, addr 0x5fe8d90, size 0x10, virtual false, abstract: false, final false
inline void Advance(int32_t  count) ;

/// @brief Method Close, addr 0x5fe940c, size 0x34, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EnsureByte, addr 0x5fe8da0, size 0x20, virtual false, abstract: false, final false
inline void EnsureByte() ;

/// @brief Method Flush, addr 0x5fe93d4, size 0x38, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushBuffer, addr 0x5fe9394, size 0x40, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method GetBuffer, addr 0x5fe8d44, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method SetOutput, addr 0x5fe8cf8, size 0x18, virtual false, abstract: false, final false
inline void SetOutput(::System::IO::Stream*  stream, bool  ownsStream, ::System::Text::Encoding*  encoding) ;

/// @brief Method UnsafeGetUTF8Chars, addr 0x5fe9288, size 0x10c, virtual false, abstract: false, final false
inline int32_t UnsafeGetUTF8Chars(char16_t*  chars, int32_t  charCount, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method UnsafeWriteUTF8Chars, addr 0x5fe8f6c, size 0x108, virtual false, abstract: false, final false
inline void UnsafeWriteUTF8Chars(char16_t*  chars, int32_t  charCount) ;

/// @brief Method WriteByte, addr 0x5fe8dc0, size 0x6c, virtual false, abstract: false, final false
inline void WriteByte(uint8_t  b) ;

/// @brief Method WriteByte, addr 0x5fe8e2c, size 0x4, virtual false, abstract: false, final false
inline void WriteByte(char16_t  ch) ;

/// @brief Method WriteBytes, addr 0x5fe8e30, size 0x98, virtual false, abstract: false, final false
inline void WriteBytes(uint8_t  b1, uint8_t  b2) ;

/// @brief Method WriteBytes, addr 0x5fe8ec8, size 0x4, virtual false, abstract: false, final false
inline void WriteBytes(char16_t  ch1, char16_t  ch2) ;

/// @brief Method WriteUTF8Char, addr 0x5fe8ecc, size 0xa0, virtual false, abstract: false, final false
inline void WriteUTF8Char(int32_t  ch) ;

/// @brief Method WriteUTF8Chars, addr 0x5fe919c, size 0xc8, virtual false, abstract: false, final false
inline void WriteUTF8Chars(::ArrayW<uint8_t,::Array<uint8_t>*>  chars, int32_t  charOffset, int32_t  charCount) ;

/// @brief Method WriteUTF8Chars, addr 0x5fe9264, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fe8c68, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Text::UTF8Encoding* getStaticF_UTF8Encoding() ;

/// @brief Method get_Position, addr 0x5fe8d10, size 0x34, virtual false, abstract: false, final false
