...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlStreamNodeWriter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlStreamNodeWriter(XmlStreamNodeWriter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlStreamNodeWriter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlStreamNodeWriter(XmlStreamNodeWriterconst&) = delete;
