...
// Write type traits
MARK_REF_T(::System::Xml::XmlStreamNodeWriter*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlStreamNodeWriter*, "System.Xml", "XmlStreamNodeWriter");
...
public:
  ...
  /// @brief Method Advance, addr 0x6123e8c, size 0x10, virtual false, abstract: false, final false
  inline void Advance(int32_t count);

  /// @brief Method Close, addr 0x6124508, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EnsureByte, addr 0x6123e9c, size 0x20, virtual false, abstract: false, final false
  inline void EnsureByte();

  /// @brief Method Flush, addr 0x61244d0, size 0x38, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushBuffer, addr 0x6124490, size 0x40, virtual true, abstract: false, final false
  inline void FlushBuffer();

  /// @brief Method GetBuffer, addr 0x6123e40, size 0x4c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetBuffer(int32_t count, ::by_ref<int32_t> offset);

  static inline ::System::Xml::XmlStreamNodeWriter* New_ctor();

  /// @brief Method SetOutput, addr 0x6123df4, size 0x18, virtual false, abstract: false, final false
  inline void SetOutput(::System::IO::Stream* stream, bool ownsStream, ::System::Text::Encoding* encoding);

  /// @brief Method UnsafeGetUTF8Chars, addr 0x6124384, size 0x10c, virtual false, abstract: false, final false
  inline int32_t UnsafeGetUTF8Chars(char16_t* chars, int32_t charCount, ::ArrayW<uint8_t> buffer, int32_t offset);

  /// @brief Method UnsafeWriteUTF8Chars, addr 0x6124068, size 0x108, virtual false, abstract: false, final false
  inline void UnsafeWriteUTF8Chars(char16_t* chars, int32_t charCount);

  /// @brief Method WriteByte, addr 0x6123ebc, size 0x6c, virtual false, abstract: false, final false
  inline void WriteByte(uint8_t b);

  /// @brief Method WriteByte, addr 0x6123f28, size 0x4, virtual false, abstract: false, final false
  inline void WriteByte(char16_t ch);

  /// @brief Method WriteBytes, addr 0x6123f2c, size 0x98, virtual false, abstract: false, final false
  inline void WriteBytes(uint8_t b1, uint8_t b2);

  /// @brief Method WriteBytes, addr 0x6123fc4, size 0x4, virtual false, abstract: false, final false
  inline void WriteBytes(char16_t ch1, char16_t ch2);

  /// @brief Method WriteUTF8Char, addr 0x6123fc8, size 0xa0, virtual false, abstract: false, final false
  inline void WriteUTF8Char(int32_t ch);

  /// @brief Method WriteUTF8Chars, addr 0x6124298, size 0xc8, virtual false, abstract: false, final false
  inline void WriteUTF8Chars(::ArrayW<uint8_t> chars, int32_t charOffset, int32_t charCount);

  /// @brief Method WriteUTF8Chars, addr 0x6124360, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6123d64, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Text::UTF8Encoding* getStaticF_UTF8Encoding();

  /// @brief Method get_Position, addr 0x6123e0c, size 0x34, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlStreamNodeWriter) == 0x30, "Size mismatch!");
