...
public:
  ...
  /// @brief Method ReadArray, addr 0x60f8e2c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x60f8e64, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60f8ea0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
