...
/// @brief Method Create, addr 0x6101738, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x6112110, size 0xc, virtual true, abstract: false, final false
inline bool Equals(::System::Xml::Schema::IXmlSchemaInfo*  schemaInfo) ;

/// @brief Method GetHashCode, addr 0x6101490, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6111cd0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_HashCode, addr 0x61120c8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_HashCode() ;

/// @brief Method get_IsDefault, addr 0x61120e0, size 0x8, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsNil, addr 0x61120e8, size 0x8, virtual true, abstract: false, final false
inline bool get_IsNil() ;

/// @brief Method get_LocalName, addr 0x61120b0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_MemberType, addr 0x61120f0, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType() ;

/// @brief Method get_Name, addr 0x6101ddc, size 0x1b8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NamespaceURI, addr 0x61120b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_OwnerDocument, addr 0x61120d0, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlDocument* get_OwnerDocument() ;

/// @brief Method get_Prefix, addr 0x61120c0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SchemaAttribute, addr 0x6112108, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute() ;

/// @brief Method get_SchemaElement, addr 0x6112100, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement() ;

/// @brief Method get_SchemaType, addr 0x61120f8, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType() ;

/// @brief Method get_Validity, addr 0x61120d8, size 0x8, virtual true, abstract: false, final false
