...
public:
  ...
  /// @brief Method .ctor, addr 0x431e0ec, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Clear, addr 0x431e0fc, size 0x7c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Close, addr 0x431e178, size 0x38, virtual false, abstract: false, final false
  inline void Close(bool closeInput);

  /// @brief Method get_LineNo, addr 0x431e1b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNo();

  /// @brief Method get_LinePos, addr 0x431e1b8, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x431e1c8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x431e22c, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNamespace, addr 0x431e2c8, size 0x4, virtual true, abstract: false, final false
  inline void AddNamespace(::StringW prefix, ::StringW uri);

  /// @brief Method GetEnumerator, addr 0x431e2d0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetNamespacesInScope, addr 0x431e2d8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope scope);

  /// @brief Method LookupNamespace, addr 0x431e2e0, size 0x48, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x431e328, size 0x8, virtual true, abstract: false, final false
  inline ::StringW LookupPrefix(::StringW uri);

  static inline ::System::Xml::XmlTextReaderImpl_NoNamespaceManager* New_ctor();

  /// @brief Method PopScope, addr 0x431e2c0, size 0x8, virtual true, abstract: false, final false
  inline bool PopScope();

  /// @brief Method PushScope, addr 0x431e2bc, size 0x4, virtual true, abstract: false, final false
  inline void PushScope();

  /// @brief Method RemoveNamespace, addr 0x431e2cc, size 0x4, virtual true, abstract: false, final false
  inline void RemoveNamespace(::StringW prefix, ::StringW uri);

  /// @brief Method .ctor, addr 0x431e26c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DefaultNamespace, addr 0x431e274, size 0x48, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method System.Xml.IDtdParserAdapterV1.get_Namespaces, addr 0x431e66c, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapterV1_get_Namespaces();

  /// @brief Method System.Xml.IDtdParserAdapterV1.get_Normalization, addr 0x431e650, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapterV1_get_Normalization();

  /// @brief Method System.Xml.IDtdParserAdapterV1.get_V1CompatibilityMode, addr 0x431e688, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapterV1_get_V1CompatibilityMode();

  /// @brief Method System.Xml.IDtdParserAdapterWithValidation.get_DtdValidation, addr 0x431e618, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapterWithValidation_get_DtdValidation();

  /// @brief Method System.Xml.IDtdParserAdapterWithValidation.get_ValidationEventHandling, addr 0x431e634, size 0x1c, virtual true, abstract: false, final true
  inline ::System::Xml::IValidationEventHandling* System_Xml_IDtdParserAdapterWithValidation_get_ValidationEventHandling();

  /// @brief Method System.Xml.IDtdParserAdapter.OnNewLine, addr 0x431e470, size 0x1c, virtual true, abstract: false, final true
  inline void System_Xml_IDtdParserAdapter_OnNewLine(int32_t pos);

  /// @brief Method System.Xml.IDtdParserAdapter.OnPublicId, addr 0x431e5fc, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IDtdParserAdapter.OnSystemId, addr 0x431e5e0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IDtdParserAdapter.ParseComment, addr 0x431e538, size 0x1c, virtual true, abstract: false, final true
  inline void System_Xml_IDtdParserAdapter_ParseComment(::System::Text::StringBuilder* sb);

  /// @brief Method System.Xml.IDtdParserAdapter.ParseNamedCharRef, addr 0x431e4fc, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IDtdParserAdapter.ParseNumericCharRef, addr 0x431e4e0, size 0x1c, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdParserAdapter_ParseNumericCharRef(::System::Text::StringBuilder* internalSubsetBuilder);

  /// @brief Method System.Xml.IDtdParserAdapter.ParsePI, addr 0x431e51c, size 0x1c, virtual true, abstract: false, final true
  inline void System_Xml_IDtdParserAdapter_ParsePI(::System::Text::StringBuilder* sb);

  /// @brief Method System.Xml.IDtdParserAdapter.PopEntity, addr 0x431e570, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapter_PopEntity(::ByRef<::System::Xml::IDtdEntityInfo*> oldEntity, ::ByRef<int32_t> newEntityId);

  /// @brief Method System.Xml.IDtdParserAdapter.PushEntity, addr 0x431e554, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapter_PushEntity(::System::Xml::IDtdEntityInfo* entity, ::ByRef<int32_t> entityId);

  /// @brief Method System.Xml.IDtdParserAdapter.PushExternalSubset, addr 0x431e58c, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapter_PushExternalSubset(::StringW systemId, ::StringW publicId);

  /// @brief Method System.Xml.IDtdParserAdapter.PushInternalDtd, addr 0x431e5a8, size 0x1c, virtual true, abstract: false, final true
  inline void System_Xml_IDtdParserAdapter_PushInternalDtd(::StringW baseUri, ::StringW internalDtd);

  /// @brief Method System.Xml.IDtdParserAdapter.ReadData, addr 0x431e4c4, size 0x1c, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdParserAdapter_ReadData();

  /// @brief Method System.Xml.IDtdParserAdapter.Throw, addr 0x431e5c4, size 0x1c, virtual true, abstract: false, final true
  inline void System_Xml_IDtdParserAdapter_Throw(::System::Exception* e);

  /// @brief Method System.Xml.IDtdParserAdapter.get_BaseUri, addr 0x431e390, size 0x1c, virtual true, abstract: false, final true
  inline ::System::Uri* System_Xml_IDtdParserAdapter_get_BaseUri();

  /// @brief Method System.Xml.IDtdParserAdapter.get_CurrentPosition, addr 0x431e400, size 0x1c, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdParserAdapter_get_CurrentPosition();

  /// @brief Method System.Xml.IDtdParserAdapter.get_EntityStackLength, addr 0x431e438, size 0x1c, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdParserAdapter_get_EntityStackLength();

  /// @brief Method System.Xml.IDtdParserAdapter.get_IsEntityEolNormalized, addr 0x431e454, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapter_get_IsEntityEolNormalized();

  /// @brief Method System.Xml.IDtdParserAdapter.get_IsEof, addr 0x431e3ac, size 0x1c, virtual true, abstract: false, final true
  inline bool System_Xml_IDtdParserAdapter_get_IsEof();

  /// @brief Method System.Xml.IDtdParserAdapter.get_LineNo, addr 0x431e48c, size 0x1c, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdParserAdapter_get_LineNo();

  /// @brief Method System.Xml.IDtdParserAdapter.get_LineStartPosition, addr 0x431e4a8, size 0x1c, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdParserAdapter_get_LineStartPosition();

  /// @brief Method System.Xml.IDtdParserAdapter.get_NameTable, addr 0x431e358, size 0x1c, virtual true, abstract: false, final true
  inline ::System::Xml::XmlNameTable* System_Xml_IDtdParserAdapter_get_NameTable();

  /// @brief Method System.Xml.IDtdParserAdapter.get_NamespaceResolver, addr 0x431e374, size 0x1c, virtual true, abstract: false, final true
  inline ::System::Xml::IXmlNamespaceResolver* System_Xml_IDtdParserAdapter_get_NamespaceResolver();

  /// @brief Method System.Xml.IDtdParserAdapter.get_ParsingBuffer, addr 0x431e3c8, size 0x1c, virtual true, abstract: false, final true
  inline ::ArrayW<char16_t, ::Array<char16_t>*> System_Xml_IDtdParserAdapter_get_ParsingBuffer();

  /// @brief Method System.Xml.IDtdParserAdapter.get_ParsingBufferLength, addr 0x431e3e4, size 0x1c, virtual true, abstract: false, final true
  inline int32_t System_Xml_IDtdParserAdapter_get_ParsingBufferLength();

  /// @brief Method System.Xml.IDtdParserAdapter.set_CurrentPosition, addr 0x431e41c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x431e330, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x431e764, size 0x8c, virtual false, abstract: false, final false
  inline void Clear(::System::Xml::XmlNodeType type);

  /// @brief Method ClearName, addr 0x431e8d8, size 0x54, virtual false, abstract: false, final false
  inline void ClearName();

  /// @brief Method CopyTo, addr 0x431ec34, size 0x60, virtual false, abstract: false, final false
  inline int32_t CopyTo(int32_t valueOffset, ::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t offset, int32_t length);

  /// @brief Method CopyTo, addr 0x431ebb4, size 0x80, virtual false, abstract: false, final false
  inline void CopyTo(int32_t valueOffset, ::System::Text::StringBuilder* sb);

  /// @brief Method CreateNameWPrefix, addr 0x431eca8, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW CreateNameWPrefix(::System::Xml::XmlNameTable* nt);

  /// @brief Method GetNameWPrefix, addr 0x431ec94, size 0x14, virtual false, abstract: false, final false
  inline ::StringW GetNameWPrefix(::System::Xml::XmlNameTable* nt);

  static inline ::System::Xml::XmlTextReaderImpl_NodeData* New_ctor();

  /// @brief Method OnBufferInvalidated, addr 0x431eb7c, size 0x38, virtual false, abstract: false, final false
  inline void OnBufferInvalidated();

  /// @brief Method SetLineInfo, addr 0x431e92c, size 0xc, virtual false, abstract: false, final false
  inline void SetLineInfo(int32_t lineNo, int32_t linePos);

  /// @brief Method SetLineInfo2, addr 0x431e938, size 0xc, virtual false, abstract: false, final false
  inline void SetLineInfo2(int32_t lineNo, int32_t linePos);

  /// @brief Method SetNamedNode, addr 0x431ea30, size 0xa8, virtual false, abstract: false, final false
  inline void SetNamedNode(::System::Xml::XmlNodeType type, ::StringW localName);

  /// @brief Method SetNamedNode, addr 0x431ead8, size 0x88, virtual false, abstract: false, final false
  inline void SetNamedNode(::System::Xml::XmlNodeType type, ::StringW localName, ::StringW prefix, ::StringW nameWPrefix);

  /// @brief Method SetValue, addr 0x431eb70, size 0xc, virtual false, abstract: false, final false
  inline void SetValue(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t startPos, int32_t len);

  /// @brief Method SetValue, addr 0x431eb60, size 0x10, virtual false, abstract: false, final false
  inline void SetValue(::StringW value);

  /// @brief Method SetValueNode, addr 0x431e9b4, size 0x7c, virtual false, abstract: false, final false
  inline void SetValueNode(::System::Xml::XmlNodeType type, ::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t startPos, int32_t len);

  /// @brief Method SetValueNode, addr 0x431e944, size 0x70, virtual false, abstract: false, final false
  inline void SetValueNode(::System::Xml::XmlNodeType type, ::StringW value);

  /// @brief Method System.IComparable.CompareTo, addr 0x431ed34, size 0xd8, virtual true, abstract: false, final true
  inline int32_t System_IComparable_CompareTo(::System::Object* obj);

  /// @brief Method TrimSpacesInValue, addr 0x431e89c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x431e73c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Xml::XmlTextReaderImpl_NodeData* getStaticF_s_None();

  /// @brief Method get_IsDefaultAttribute, addr 0x431e830, size 0x24, virtual false, abstract: false, final false
  inline bool get_IsDefaultAttribute();

  /// @brief Method get_IsEmptyElement, addr 0x431e800, size 0x24, virtual false, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_LineNo, addr 0x431e7f0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNo();

  /// @brief Method get_LinePos, addr 0x431e7f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePos();

  /// @brief Method get_None, addr 0x431e6a4, size 0x98, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlTextReaderImpl_NodeData* get_None();

  /// @brief Method get_StringValue, addr 0x431e870, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_StringValue();

  /// @brief Method get_ValueBuffered, addr 0x431e860, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDefaultAttribute, addr 0x431e854, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDefaultAttribute(bool value);

  /// @brief Method set_IsEmptyElement, addr 0x431e824, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compare, addr 0x431ee64, size 0x340, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x431f1a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::IComparer_1<::System::Object*>* getStaticF_s_instance();

  /// @brief Method get_Instance, addr 0x431ee0c, size 0x58, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x431f30c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x431f208, size 0x104, virtual false, abstract: false, final false
...
// Dependencies System.Xml.DtdProcessing, System.Xml.EntityHandling, System.Xml.IXmlLineInfo, System.Xml.IXmlNamespaceResolver, System.Xml.LineInfo, System.Xml.ReadState,
// System.Xml.WhitespaceHandling, System.Xml.XmlCharType, System.Xml.XmlNodeType, System.Xml.XmlReader, System.Xml.XmlTextReaderImpl::IncrementalReadState,
// System.Xml.XmlTextReaderImpl::ParsingFunction, System.Xml.XmlTextReaderImpl::ParsingMode, System.Xml.XmlTextReaderImpl::ParsingState
namespace System::Xml {
// Is value type: false
...
public:
  ...
  /// @brief Method AddAttribute, addr 0x4260700, size 0x1a4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlTextReaderImpl_NodeData* AddAttribute(int32_t endNamePos, int32_t colonPos);

  /// @brief Method AddAttribute, addr 0x426415c, size 0x134, virtual false, abstract: false, final false
  inline ::System::Xml::XmlTextReaderImpl_NodeData* AddAttribute(::StringW localName, ::StringW prefix, ::StringW nameWPrefix);

  /// @brief Method AddAttributeChunkToList, addr 0x4261ca4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAttributeNoChecks, addr 0x425bd40, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlTextReaderImpl_NodeData* AddAttributeNoChecks(::StringW name, int32_t attrDepth);

  /// @brief Method AddDefaultAttributeDtd, addr 0x425fda8, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDefaultAttributeInternal, addr 0x4265480, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDefaultAttributeNonDtd, addr 0x42656c0, size 0x200, virtual false, abstract: false, final false
  inline bool AddDefaultAttributeNonDtd(::System::Xml::Schema::SchemaAttDef* attrDef);

  /// @brief Method AddDefaultAttributesAndNormalize, addr 0x425f34c, size 0xa18, virtual false, abstract: false, final false
  inline void AddDefaultAttributesAndNormalize();

  /// @brief Method AddNamespace, addr 0x4261a48, size 0x25c, virtual false, abstract: false, final false
  inline void AddNamespace(::StringW prefix, ::StringW uri, ::System::Xml::XmlTextReaderImpl_NodeData* attr);

  /// @brief Method AddNode, addr 0x4257478, size 0x44, virtual false, abstract: false, final false
  inline ::System::Xml::XmlTextReaderImpl_NodeData* AddNode(int32_t nodeIndex, int32_t nodeDepth);

  /// @brief Method AllocNode, addr 0x4264020, size 0x13c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlTextReaderImpl_NodeData* AllocNode(int32_t nodeIndex, int32_t nodeDepth);

  /// @brief Method AttributeDuplCheck, addr 0x426159c, size 0x374, virtual false, abstract: false, final false
  inline void AttributeDuplCheck();

  /// @brief Method AttributeNamespaceLookup, addr 0x4260414, size 0xa4, virtual false, abstract: false, final false
  inline void AttributeNamespaceLookup();

  /// @brief Method BlockCopy, addr 0x425d34c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method BlockCopyChars, addr 0x4259618, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ChangeCurrentNodeType, addr 0x42653c0, size 0x1c, virtual false, abstract: false, final false
  inline void ChangeCurrentNodeType(::System::Xml::XmlNodeType newNodeType);

  /// @brief Method CheckEncoding, addr 0x425cfa4, size 0x334, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* CheckEncoding(::StringW newEncodingName);

  /// @brief Method Close, addr 0x4257ae0, size 0x8, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Close, addr 0x4257ae8, size 0xb8, virtual false, abstract: false, final false
  inline void Close(bool closeInput);

  /// @brief Method DetectEncoding, addr 0x425c6b4, size 0x228, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* DetectEncoding();

  /// @brief Method DtdParserProxy_OnNewLine, addr 0x4259cd4, size 0x14, virtual false, abstract: false, final false
  inline void DtdParserProxy_OnNewLine(int32_t pos);

  /// @brief Method DtdParserProxy_OnPublicId, addr 0x425bdbc, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method DtdParserProxy_OnSystemId, addr 0x425bcb4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method DtdParserProxy_ParseComment, addr 0x425a628, size 0x184, virtual false, abstract: false, final false
  inline void DtdParserProxy_ParseComment(::System::Text::StringBuilder* sb);

  /// @brief Method DtdParserProxy_ParseNamedCharRef, addr 0x425a208, size 0x8, virtual false, abstract: false, final false
  inline int32_t DtdParserProxy_ParseNamedCharRef(bool expand, ::System::Text::StringBuilder* internalSubsetBuilder);

  /// @brief Method DtdParserProxy_ParseNumericCharRef, addr 0x425a13c, size 0x20, virtual false, abstract: false, final false
  inline int32_t DtdParserProxy_ParseNumericCharRef(::System::Text::StringBuilder* internalSubsetBuilder);

  /// @brief Method DtdParserProxy_ParsePI, addr 0x425a274, size 0x44, virtual false, abstract: false, final false
  inline void DtdParserProxy_ParsePI(::System::Text::StringBuilder* sb);

  /// @brief Method DtdParserProxy_PopEntity, addr 0x425b20c, size 0x50, virtual false, abstract: false, final false
  inline bool DtdParserProxy_PopEntity(::ByRef<::System::Xml::IDtdEntityInfo*> oldEntity, ::ByRef<int32_t> newEntityId);

  /// @brief Method DtdParserProxy_PushEntity, addr 0x425aa48, size 0x10c, virtual false, abstract: false, final false
  inline bool DtdParserProxy_PushEntity(::System::Xml::IDtdEntityInfo* entity, ::ByRef<int32_t> entityId);

  /// @brief Method DtdParserProxy_PushExternalSubset, addr 0x425b2a8, size 0x128, virtual false, abstract: false, final false
  inline bool DtdParserProxy_PushExternalSubset(::StringW systemId, ::StringW publicId);

  /// @brief Method DtdParserProxy_PushInternalDtd, addr 0x425b9b0, size 0x64, virtual false, abstract: false, final false
  inline void DtdParserProxy_PushInternalDtd(::StringW baseUri, ::StringW internalDtd);

  /// @brief Method DtdParserProxy_ReadData, addr 0x4259d0c, size 0x4, virtual false, abstract: false, final false
  inline int32_t DtdParserProxy_ReadData();

  /// @brief Method DtdParserProxy_Throw, addr 0x425bc24, size 0x8, virtual false, abstract: false, final false
  inline void DtdParserProxy_Throw(::System::Exception* e);

  /// @brief Method EatWhitespaces, addr 0x425b758, size 0x258, virtual false, abstract: false, final false
  inline int32_t EatWhitespaces(::System::Text::StringBuilder* sb);

  /// @brief Method ElementNamespaceLookup, addr 0x425fd64, size 0x44, virtual false, abstract: false, final false
  inline void ElementNamespaceLookup();

  /// @brief Method FinishAttributeValueIterator, addr 0x42556d8, size 0xa0, virtual false, abstract: false, final false
  inline void FinishAttributeValueIterator();

  /// @brief Method FinishIncrementalRead, addr 0x42576ac, size 0x64, virtual false, abstract: false, final false
  inline void FinishIncrementalRead();

  /// @brief Method FinishInit, addr 0x42559d8, size 0x48, virtual false, abstract: false, final false
  inline void FinishInit();

  /// @brief Method FinishInitStream, addr 0x4254a34, size 0x80, virtual false, abstract: false, final false
  inline void FinishInitStream();

  /// @brief Method FinishInitTextReader, addr 0x4254b9c, size 0x64, virtual false, abstract: false, final false
  inline void FinishInitTextReader();

  /// @brief Method FinishInitUriString, addr 0x42541c8, size 0x2e8, virtual false, abstract: false, final false
  inline void FinishInitUriString();

  /// @brief Method FinishOtherValueIterator, addr 0x4254fac, size 0x110, virtual false, abstract: false, final false
  inline void FinishOtherValueIterator();

  /// @brief Method FinishPartialValue, addr 0x4254ef4, size 0xb8, virtual false, abstract: false, final false
  inline void FinishPartialValue();

  /// @brief Method FinishReadContentAsBinary, addr 0x42579c8, size 0x50, virtual false, abstract: false, final false
  inline void FinishReadContentAsBinary();

  /// @brief Method FinishReadElementContentAsBinary, addr 0x4257a18, size 0xc8, virtual false, abstract: false, final false
  inline void FinishReadElementContentAsBinary();

  /// @brief Method FinishReadValueChunk, addr 0x42579a8, size 0x20, virtual false, abstract: false, final false
  inline void FinishReadValueChunk();

  /// @brief Method FullAttributeCleanup, addr 0x42642bc, size 0x64, virtual false, abstract: false, final false
  inline void FullAttributeCleanup();

  /// @brief Method GetAttribute, addr 0x425555c, size 0x9c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(int32_t i);

  /// @brief Method GetAttribute, addr 0x42553e0, size 0x17c, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW localName, ::StringW namespaceURI);

  /// @brief Method GetAttribute, addr 0x42551b0, size 0x94, virtual true, abstract: false, final false
  inline ::StringW GetAttribute(::StringW name);

  /// @brief Method GetChars, addr 0x425d354, size 0x118, virtual false, abstract: false, final false
  inline int32_t GetChars(int32_t maxCharsCount);

  /// @brief Method GetIndexOfAttributeWithPrefix, addr 0x425532c, size 0xb4, virtual false, abstract: false, final false
  inline int32_t GetIndexOfAttributeWithPrefix(::StringW name);

  /// @brief Method GetIndexOfAttributeWithoutPrefix, addr 0x4255244, size 0xe8, virtual false, abstract: false, final false
  inline int32_t GetIndexOfAttributeWithoutPrefix(::StringW name);

  /// @brief Method GetNamespacesInScope, addr 0x4259690, size 0x24, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope scope);

  /// @brief Method GetResolver, addr 0x42653dc, size 0x38, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetResolver();

  /// @brief Method GetTempResolver, addr 0x425a9e8, size 0x60, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetTempResolver();

  /// @brief Method GetTextNodeType, addr 0x4261e10, size 0x58, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType GetTextNodeType(int32_t orChars);

  /// @brief Method GetWhitespaceType, addr 0x4261ff8, size 0x48, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType GetWhitespaceType();

  /// @brief Method HandleEntityEnd, addr 0x425c518, size 0x12c, virtual false, abstract: false, final false
  inline bool HandleEntityEnd(bool checkEntityNesting);

  /// @brief Method HandleEntityReference, addr 0x425df78, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleGeneralEntityReference, addr 0x4258674, size 0x4b0, virtual false, abstract: false, final false
  ...
  /// @brief Method HasLineInfo, addr 0x425962c, size 0x8, virtual true, abstract: false, final true
  inline bool HasLineInfo();

  /// @brief Method IncrementalRead, addr 0x42647a8, size 0x924, virtual false, abstract: false, final false
  inline int32_t IncrementalRead();

  /// @brief Method InitFragmentReader, addr 0x4253e78, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method InitStreamInput, addr 0x42544b0, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method InitStreamInput, addr 0x425c6a4, size 0x10, virtual false, abstract: false, final false
  inline void InitStreamInput(::System::Uri* baseUri, ::StringW baseUriStr, ::System::IO::Stream* stream, ::System::Text::Encoding* encoding);

  /// @brief Method InitStreamInput, addr 0x425c644, size 0x60, virtual false, abstract: false, final false
  inline void InitStreamInput(::System::Uri* baseUri, ::System::IO::Stream* stream, ::System::Text::Encoding* encoding);

  /// @brief Method InitStreamInput, addr 0x4253ac0, size 0x1c, virtual false, abstract: false, final false
  inline void InitStreamInput(::StringW baseUriStr, ::System::IO::Stream* stream, ::System::Text::Encoding* encoding);

  /// @brief Method InitStreamInput, addr 0x4253a4c, size 0x74, virtual false, abstract: false, final false
  inline void InitStreamInput(::System::IO::Stream* stream, ::System::Text::Encoding* encoding);

  /// @brief Method InitStringInput, addr 0x4253dac, size 0xcc, virtual false, abstract: false, final false
  inline void InitStringInput(::StringW baseUriStr, ::System::Text::Encoding* originalEncoding, ::StringW str);

  /// @brief Method InitTextReaderInput, addr 0x425ca14, size 0xb0, virtual false, abstract: false, final false
  inline void InitTextReaderInput(::StringW baseUriStr, ::System::Uri* baseUri, ::System::IO::TextReader* input);

  /// @brief Method InitTextReaderInput, addr 0x4253c9c, size 0xc, virtual false, abstract: false, final false
  inline void InitTextReaderInput(::StringW baseUriStr, ::System::IO::TextReader* input);

  /// @brief Method InvalidCharRecovery, addr 0x425d46c, size 0x17c, virtual false, abstract: false, final false
  inline void InvalidCharRecovery(::ByRef<int32_t> bytesCount, ::ByRef<int32_t> charsCount);

  /// @brief Method LookupNamespace, addr 0x4261910, size 0xc4, virtual false, abstract: false, final false
  inline ::StringW LookupNamespace(::System::Xml::XmlTextReaderImpl_NodeData* node);

  /// @brief Method LookupNamespace, addr 0x4257d20, size 0x38, virtual true, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x42596e8, size 0x24, virtual false, abstract: false, final false
  inline ::StringW LookupPrefix(::StringW namespaceName);

  /// @brief Method MoveOffEntityReference, addr 0x4258b2c, size 0xb0, virtual false, abstract: false, final false
  inline void MoveOffEntityReference();

  /// @brief Method MoveToAttribute, addr 0x42555f8, size 0xbc, virtual true, abstract: false, final false
  inline bool MoveToAttribute(::StringW name);

  /// @brief Method MoveToAttribute, addr 0x4255778, size 0xc8, virtual true, abstract: false, final false
  inline void MoveToAttribute(int32_t i);

  /// @brief Method MoveToElement, addr 0x4255950, size 0x88, virtual true, abstract: false, final false
  inline bool MoveToElement();

  /// @brief Method MoveToFirstAttribute, addr 0x4255840, size 0x78, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x42558b8, size 0x98, virtual true, abstract: false, final false
  inline bool MoveToNextAttribute();

  /// @brief Method MoveToNextContentNode, addr 0x4261f50, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDefaultNamespaceDecl, addr 0x42611e4, size 0xfc, virtual false, abstract: false, final false
  inline void OnDefaultNamespaceDecl(::System::Xml::XmlTextReaderImpl_NodeData* attr);

  /// @brief Method OnEof, addr 0x4257854, size 0x88, virtual false, abstract: false, final false
  inline void OnEof();

  /// @brief Method OnNamespaceDecl, addr 0x42612e0, size 0xd0, virtual false, abstract: false, final false
  inline void OnNamespaceDecl(::System::Xml::XmlTextReaderImpl_NodeData* attr);

  /// @brief Method OnNewLine, addr 0x4259ce8, size 0x14, virtual false, abstract: false, final false
  inline void OnNewLine(int32_t pos);

  /// @brief Method OnXmlReservedAttribute, addr 0x42613b0, size 0x1ec, virtual false, abstract: false, final false
  inline void OnXmlReservedAttribute(::System::Xml::XmlTextReaderImpl_NodeData* attr);

  /// @brief Method OpenAndPush, addr 0x4264320, size 0x234, virtual false, abstract: false, final false
  inline bool OpenAndPush(::System::Uri* uri);

  /// @brief Method OpenUrl, addr 0x42565e0, size 0x18c, virtual false, abstract: false, final false
  inline void OpenUrl();

  /// @brief Method OpenUrlDelegate, addr 0x425cce8, size 0x124, virtual false, abstract: false, final false
  inline void OpenUrlDelegate(::System::Object* xmlResolver);

  /// @brief Method ParseAttributeValueChunk, addr 0x4257fa4, size 0x488, virtual false, abstract: false, final false
  inline bool ParseAttributeValueChunk();

  /// @brief Method ParseAttributeValueSlow, addr 0x42608a4, size 0x940, virtual false, abstract: false, final false
  inline void ParseAttributeValueSlow(int32_t curPos, char16_t quoteChar, ::System::Xml::XmlTextReaderImpl_NodeData* attr);

  /// @brief Method ParseAttributes, addr 0x425ed28, size 0x624, virtual false, abstract: false, final false
  inline void ParseAttributes();

  /// @brief Method ParseCData, addr 0x425d84c, size 0x8, virtual false, abstract: false, final false
  inline void ParseCData();

  /// @brief Method ParseCDataOrComment, addr 0x4262438, size 0x43c, virtual false, abstract: false, final false
  inline bool ParseCDataOrComment(::System::Xml::XmlNodeType type, ::ByRef<int32_t> outStartPos, ::ByRef<int32_t> outEndPos);

  /// @brief Method ParseCDataOrComment, addr 0x425a7ac, size 0x158, virtual false, abstract: false, final false
  inline void ParseCDataOrComment(::System::Xml::XmlNodeType type);

  /// @brief Method ParseCharRefInline, addr 0x4261e68, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseComment, addr 0x425d7e8, size 0x54, virtual false, abstract: false, final false
  inline bool ParseComment();

  /// @brief Method ParseDoctypeDecl, addr 0x425d854, size 0x27c, virtual false, abstract: false, final false
  inline bool ParseDoctypeDecl();

  /// @brief Method ParseDocumentContent, addr 0x42560f0, size 0x4f0, virtual false, abstract: false, final false
  inline bool ParseDocumentContent();

  /// @brief Method ParseDtd, addr 0x4262874, size 0x318, virtual false, abstract: false, final false
  inline void ParseDtd();

  /// @brief Method ParseDtdFromParserContext, addr 0x425cac4, size 0x224, virtual false, abstract: false, final false
  inline void ParseDtdFromParserContext();

  /// @brief Method ParseElement, addr 0x425dae8, size 0x490, virtual false, abstract: false, final false
  inline void ParseElement();

  /// @brief Method ParseElementContent, addr 0x4255db8, size 0x338, virtual false, abstract: false, final false
  inline bool ParseElementContent();

  /// @brief Method ParseEndElement, addr 0x425e794, size 0x3ec, virtual false, abstract: false, final false
  inline void ParseEndElement();

  /// @brief Method ParseEntityName, addr 0x4261cd4, size 0x13c, virtual false, abstract: false, final false
  inline ::StringW ParseEntityName();

  /// @brief Method ParseEntityReference, addr 0x4257500, size 0x74, virtual false, abstract: false, final false
  inline void ParseEntityReference();

  /// @brief Method ParseFragmentAttribute, addr 0x4257710, size 0x88, virtual false, abstract: false, final false
  inline bool ParseFragmentAttribute();

  /// @brief Method ParseName, addr 0x425d67c, size 0x20, virtual false, abstract: false, final false
  inline int32_t ParseName();

  /// @brief Method ParseNamedCharRef, addr 0x425a210, size 0x64, virtual false, abstract: false, final false
  inline int32_t ParseNamedCharRef(bool expand, ::System::Text::StringBuilder* internalSubsetBuilder);

  /// @brief Method ParseNamedCharRefInline, addr 0x4263a70, size 0x2dc, virtual false, abstract: false, final false
  inline int32_t ParseNamedCharRefInline(int32_t startPos, bool expand, ::System::Text::StringBuilder* internalSubsetBuilder);

  /// @brief Method ParseNumericCharRef, addr 0x425a15c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseNumericCharRefInline, addr 0x42633ec, size 0x684, virtual false, abstract: false, final false
  ...
  /// @brief Method ParsePI, addr 0x425d7e0, size 0x8, virtual false, abstract: false, final false
  inline bool ParsePI();

  /// @brief Method ParsePI, addr 0x425a2b8, size 0x370, virtual false, abstract: false, final false
  inline bool ParsePI(::System::Text::StringBuilder* piInDtdStringBuilder);

  /// @brief Method ParsePIValue, addr 0x42620a8, size 0x390, virtual false, abstract: false, final false
  inline bool ParsePIValue(::ByRef<int32_t> outStartPos, ::ByRef<int32_t> outEndPos);

  /// @brief Method ParseQName, addr 0x425ed18, size 0x10, virtual false, abstract: false, final false
  inline int32_t ParseQName(::ByRef<int32_t> colonPos);

  /// @brief Method ParseQName, addr 0x4263d4c, size 0x294, virtual false, abstract: false, final false
  inline int32_t ParseQName(bool isQName, int32_t startOffset, ::ByRef<int32_t> colonPos);

  /// @brief Method ParseRootLevelWhitespace, addr 0x425e598, size 0x1fc, virtual false, abstract: false, final false
  inline bool ParseRootLevelWhitespace();

  /// @brief Method ParseText, addr 0x425e224, size 0x374, virtual false, abstract: false, final false
  inline bool ParseText();

  /// @brief Method ParseText, addr 0x4259040, size 0x5d8, virtual false, abstract: false, final false
  inline bool ParseText(::ByRef<int32_t> startPos, ::ByRef<int32_t> endPos, ::ByRef<int32_t> outOrChars);

  /// @brief Method ParseUnexpectedToken, addr 0x42650cc, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW ParseUnexpectedToken();

  /// @brief Method ParseUnexpectedToken, addr 0x425dad0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW ParseUnexpectedToken(int32_t pos);

  /// @brief Method ParseXmlDeclaration, addr 0x425676c, size 0xce0, virtual false, abstract: false, final false
  inline bool ParseXmlDeclaration(bool isTextDecl);

  /// @brief Method ParseXmlDeclarationFragment, addr 0x4257798, size 0xbc, virtual false, abstract: false, final false
  inline void ParseXmlDeclarationFragment();

  /// @brief Method PopElementContext, addr 0x42574bc, size 0x44, virtual false, abstract: false, final false
  inline void PopElementContext();

  /// @brief Method PopEntity, addr 0x425b25c, size 0x4c, virtual false, abstract: false, final false
  inline void PopEntity();

  /// @brief Method PopParsingState, addr 0x425d5e8, size 0x6c, virtual false, abstract: false, final false
  inline void PopParsingState();

  /// @brief Method PopXmlContext, addr 0x4264290, size 0x2c, virtual false, abstract: false, final false
  inline void PopXmlContext();

  /// @brief Method ProcessDtdFromParserContext, addr 0x4254728, size 0x6c, virtual false, abstract: false, final false
  inline void ProcessDtdFromParserContext(::System::Xml::XmlParserContext* context);

  /// @brief Method PushExternalEntity, addr 0x425ab54, size 0x390, virtual false, abstract: false, final false
  inline bool PushExternalEntity(::System::Xml::IDtdEntityInfo* entity);

  /// @brief Method PushExternalEntityOrSubset, addr 0x425b3d0, size 0x388, virtual false, abstract: false, final false
  inline void PushExternalEntityOrSubset(::StringW publicId, ::StringW systemId, ::System::Uri* baseUri, ::StringW entityName);

  /// @brief Method PushInternalEntity, addr 0x425aee4, size 0x328, virtual false, abstract: false, final false
  inline void PushInternalEntity(::System::Xml::IDtdEntityInfo* entity);

  /// @brief Method PushParsingState, addr 0x425ba14, size 0x128, virtual false, abstract: false, final false
  inline void PushParsingState();

  /// @brief Method PushXmlContext, addr 0x42619d4, size 0x74, virtual false, abstract: false, final false
  inline void PushXmlContext();

  /// @brief Method ReThrow, addr 0x425c24c, size 0xa0, virtual false, abstract: false, final false
  inline void ReThrow(::System::Exception* e, int32_t lineNo, int32_t linePos);

  /// @brief Method Read, addr 0x4255a20, size 0x398, virtual true, abstract: false, final false
  inline bool Read();

  /// @brief Method ReadAttributeValue, addr 0x4257d58, size 0x24c, virtual true, abstract: false, final false
  inline bool ReadAttributeValue();

  /// @brief Method ReadData, addr 0x4259d10, size 0x42c, virtual false, abstract: false, final false
  inline int32_t ReadData();

  /// @brief Method ReadDataInName, addr 0x4263fe0, size 0x40, virtual false, abstract: false, final false
  inline bool ReadDataInName(::ByRef<int32_t> pos);

  /// @brief Method ReadString, addr 0x4258bdc, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ReadValueChunk, addr 0x4258c00, size 0x440, virtual true, abstract: false, final false
  inline int32_t ReadValueChunk(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method RegisterConsumedCharacters, addr 0x425bb3c, size 0xe8, virtual false, abstract: false, final false
  inline void RegisterConsumedCharacters(int64_t characters, bool inEntityReference);

  /// @brief Method RegisterEntity, addr 0x4264554, size 0x1f0, virtual false, abstract: false, final false
  inline void RegisterEntity(::System::Xml::IDtdEntityInfo* entity);

  /// @brief Method ResetAttributes, addr 0x425744c, size 0x2c, virtual false, abstract: false, final false
  inline void ResetAttributes();

  /// @brief Method ResolveEntity, addr 0x425842c, size 0x248, virtual true, abstract: false, final false
  inline void ResolveEntity();

  /// @brief Method SendValidationEvent, addr 0x425a904, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendValidationEvent, addr 0x425c450, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDtdInfo, addr 0x426519c, size 0x134, virtual false, abstract: false, final false
  inline void SetDtdInfo(::System::Xml::IDtdInfo* newDtdInfo);

  /// @brief Method SetErrorState, addr 0x425c238, size 0x14, virtual false, abstract: false, final false
  inline void SetErrorState();

  /// @brief Method SetupEncoding, addr 0x425c8dc, size 0x138, virtual false, abstract: false, final false
  inline void SetupEncoding(::System::Text::Encoding* encoding);

  /// @brief Method SetupEndEntityNodeInAttribute, addr 0x4262040, size 0x68, virtual false, abstract: false, final false
  inline void SetupEndEntityNodeInAttribute();

  /// @brief Method SetupEndEntityNodeInContent, addr 0x4257574, size 0x138, virtual false, abstract: false, final false
  inline void SetupEndEntityNodeInContent();

  /// @brief Method SetupFromParserContext, addr 0x42536c0, size 0x22c, virtual false, abstract: false, final false
  inline void SetupFromParserContext(::System::Xml::XmlParserContext* context, ::System::Xml::XmlReaderSettings* settings);

  /// @brief Method ShiftBuffer, addr 0x425d654, size 0x20, virtual false, abstract: false, final false
  inline void ShiftBuffer(int32_t sourcePos, int32_t destPos, int32_t count);

  /// @brief Method Skip, addr 0x4257ba0, size 0x180, virtual true, abstract: false, final false
  inline void Skip();

  /// @brief Method SkipDtd, addr 0x4262b8c, size 0x36c, virtual false, abstract: false, final false
  inline void SkipDtd();

  /// @brief Method SkipPartialTextValue, addr 0x4257968, size 0x40, virtual false, abstract: false, final false
  inline void SkipPartialTextValue();

  /// @brief Method SkipPublicOrSystemIdLiteral, addr 0x4262ef8, size 0xb8, virtual false, abstract: false, final false
  inline void SkipPublicOrSystemIdLiteral();

  /// @brief Method SkipUntil, addr 0x4262fb0, size 0x43c, virtual false, abstract: false, final false
  inline void SkipUntil(char16_t stopChar, bool recognizeLiterals);

  /// @brief Method StripSpaces, addr 0x42658cc, size 0x224, virtual false, abstract: false, final false
  static inline ::StringW StripSpaces(::StringW value);

  /// @brief Method StripSpaces, addr 0x4265af0, size 0x110, virtual false, abstract: false, final false
  static inline void StripSpaces(::ArrayW<char16_t, ::Array<char16_t>*> value, int32_t index, ::ByRef<int32_t> len);

  /// @brief Method SwitchEncoding, addr 0x425ce0c, size 0xf0, virtual false, abstract: false, final false
  inline void SwitchEncoding(::System::Text::Encoding* newEncoding);

  /// @brief Method SwitchEncodingToUTF8, addr 0x425d2e8, size 0x64, virtual false, abstract: false, final false
  inline void SwitchEncodingToUTF8();

  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x425966c, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x42596b4, size 0x10, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x42596c4, size 0x24, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW namespaceName);

  /// @brief Method Throw, addr 0x425bc2c, size 0x88, virtual false, abstract: false, final false
  inline void Throw(::System::Exception* e);

  /// @brief Method Throw, addr 0x425bf98, size 0x5c, virtual false, abstract: false, final false
  inline void Throw(int32_t pos, ::StringW res);

  /// @brief Method Throw, addr 0x425be48, size 0x14, virtual false, abstract: false, final false
  inline void Throw(int32_t pos, ::StringW res, ::StringW arg);

  /// @brief Method Throw, addr 0x425bef0, size 0x14, virtual false, abstract: false, final false
  inline void Throw(int32_t pos, ::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method Throw, addr 0x42549e0, size 0x54, virtual false, abstract: false, final false
  inline void Throw(::StringW res);

  /// @brief Method Throw, addr 0x425be5c, size 0x94, virtual false, abstract: false, final false
  inline void Throw(::StringW res, ::StringW arg);

  /// @brief Method Throw, addr 0x425c118, size 0x80, virtual false, abstract: false, final false
  inline void Throw(::StringW res, ::StringW arg, ::System::Exception* innerException);

  /// @brief Method Throw, addr 0x425c094, size 0x84, virtual false, abstract: false, final false
  inline void Throw(::StringW res, ::StringW arg, int32_t lineNo, int32_t linePos);

  /// @brief Method Throw, addr 0x425bf04, size 0x94, virtual false, abstract: false, final false
  inline void Throw(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method Throw, addr 0x425c198, size 0xa0, virtual false, abstract: false, final false
  inline void Throw(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Exception* innerException);

  /// @brief Method Throw, addr 0x425bff4, size 0xa0, virtual false, abstract: false, final false
  inline void Throw(::StringW res, int32_t lineNo, int32_t linePos);

  /// @brief Method ThrowExpectingWhitespace, addr 0x4260680, size 0x80, virtual false, abstract: false, final false
  inline void ThrowExpectingWhitespace(int32_t pos);

  /// @brief Method ThrowInvalidChar, addr 0x425c3e0, size 0x70, virtual false, abstract: false, final false
  inline void ThrowInvalidChar(::ArrayW<char16_t, ::Array<char16_t>*> data, int32_t length, int32_t invCharPos);

  /// @brief Method ThrowTagMismatch, addr 0x42604b8, size 0x1c8, virtual false, abstract: false, final false
  inline void ThrowTagMismatch(::System::Xml::XmlTextReaderImpl_NodeData* startTag);

  /// @brief Method ThrowUnclosedElements, addr 0x425eb80, size 0x198, virtual false, abstract: false, final false
  inline void ThrowUnclosedElements();

  /// @brief Method ThrowUnexpectedToken, addr 0x425d674, size 0x8, virtual false, abstract: false, final false
  inline void ThrowUnexpectedToken(::StringW expectedToken1);

  /// @brief Method ThrowUnexpectedToken, addr 0x425d69c, size 0x144, virtual false, abstract: false, final false
  inline void ThrowUnexpectedToken(::StringW expectedToken1, ::StringW expectedToken2);

  /// @brief Method ThrowUnexpectedToken, addr 0x425d83c, size 0x10, virtual false, abstract: false, final false
  inline void ThrowUnexpectedToken(int32_t pos, ::StringW expectedToken);

  /// @brief Method ThrowUnexpectedToken, addr 0x425dad8, size 0x10, virtual false, abstract: false, final false
  inline void ThrowUnexpectedToken(int32_t pos, ::StringW expectedToken1, ::StringW expectedToken2);

  /// @brief Method ThrowWithoutLineInfo, addr 0x42578dc, size 0x8c, virtual false, abstract: false, final false
  inline void ThrowWithoutLineInfo(::StringW res);

  /// @brief Method ThrowWithoutLineInfo, addr 0x425c2ec, size 0x70, virtual false, abstract: false, final false
  inline void ThrowWithoutLineInfo(::StringW res, ::StringW arg);

  /// @brief Method ThrowWithoutLineInfo, addr 0x425c35c, size 0x84, virtual false, abstract: false, final false
  inline void ThrowWithoutLineInfo(::StringW res, ::ArrayW<::StringW, ::Array<::StringW>*> args, ::System::Exception* innerException);

  /// @brief Method UnDecodeChars, addr 0x425cefc, size 0xa8, virtual false, abstract: false, final false
  inline void UnDecodeChars();

  /// @brief Method UnregisterEntity, addr 0x4264744, size 0x64, virtual false, abstract: false, final false
  inline void UnregisterEntity();

  /// @brief Method UriEqual, addr 0x42548fc, size 0xe4, virtual false, abstract: false, final false
  inline bool UriEqual(::System::Uri* uri1, ::StringW uri1Str, ::StringW uri2Str, ::System::Xml::XmlResolver* resolver);

  /// @brief Method ZeroEndingStream, addr 0x4261ed4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42538ec, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x4253adc, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextReader* input);

  /// @brief Method .ctor, addr 0x4253c34, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::TextReader* input, ::System::Xml::XmlNameTable* nt);

  /// @brief Method .ctor, addr 0x4254ab4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4252ef0, size 0x36c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nt);

  /// @brief Method .ctor, addr 0x425325c, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4254794, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x425397c, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::StringW url, ::System::IO::Stream* input, ::System::Xml::XmlNameTable* nt);

  /// @brief Method .ctor, addr 0x4253b6c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::StringW url, ::System::IO::TextReader* input, ::System::Xml::XmlNameTable* nt);

  /// @brief Method .ctor, addr 0x425406c, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::StringW xmlFragment, ::System::Xml::XmlParserContext* context);

  /// @brief Method .ctor, addr 0x4254c00, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW xmlFragment, ::System::Xml::XmlParserContext* context, ::System::Xml::XmlReaderSettings* settings);

  /// @brief Method .ctor, addr 0x4253ca8, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::StringW xmlFragment, ::System::Xml::XmlNodeType fragType, ::System::Xml::XmlParserContext* context);

  /// @brief Method get_AttributeCount, addr 0x42551a8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_AttributeCount();

  /// @brief Method get_BaseURI, addr 0x42550d8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_BaseURI();

  /// @brief Method get_CanReadValueChunk, addr 0x4258bf8, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanReadValueChunk();

  /// @brief Method get_CanResolveEntity, addr 0x42551a0, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanResolveEntity();

  /// @brief Method get_Depth, addr 0x42550bc, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_DtdInfo, addr 0x4265194, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::IDtdInfo* get_DtdInfo();

  /// @brief Method get_DtdParserProxy_BaseUri, addr 0x4259bec, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Uri* get_DtdParserProxy_BaseUri();

  /// @brief Method get_DtdParserProxy_CurrentPosition, addr 0x4259ca8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DtdParserProxy_CurrentPosition();

  /// @brief Method get_DtdParserProxy_DtdValidation, addr 0x4259bb4, size 0x10, virtual false, abstract: false, final false
  inline bool get_DtdParserProxy_DtdValidation();

  /// @brief Method get_DtdParserProxy_EntityStackLength, addr 0x4259cb8, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_DtdParserProxy_EntityStackLength();

  /// @brief Method get_DtdParserProxy_IsEntityEolNormalized, addr 0x4259cc4, size 0x8, virtual false, abstract: false, final false
  inline bool get_DtdParserProxy_IsEntityEolNormalized();

  /// @brief Method get_DtdParserProxy_IsEof, addr 0x4259c90, size 0x8, virtual false, abstract: false, final false
  inline bool get_DtdParserProxy_IsEof();

  /// @brief Method get_DtdParserProxy_LineNo, addr 0x4259cfc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DtdParserProxy_LineNo();

  /// @brief Method get_DtdParserProxy_LineStartPosition, addr 0x4259d04, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DtdParserProxy_LineStartPosition();

  /// @brief Method get_DtdParserProxy_NameTable, addr 0x4259ba4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_DtdParserProxy_NameTable();

  /// @brief Method get_DtdParserProxy_NamespaceResolver, addr 0x4259bac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::IXmlNamespaceResolver* get_DtdParserProxy_NamespaceResolver();

  /// @brief Method get_DtdParserProxy_Namespaces, addr 0x4259bdc, size 0x8, virtual false, abstract: false, final false
  inline bool get_DtdParserProxy_Namespaces();

  /// @brief Method get_DtdParserProxy_Normalization, addr 0x4259bd4, size 0x8, virtual false, abstract: false, final false
  inline bool get_DtdParserProxy_Normalization();

  /// @brief Method get_DtdParserProxy_ParsingBuffer, addr 0x4259c98, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<char16_t, ::Array<char16_t>*> get_DtdParserProxy_ParsingBuffer();

  /// @brief Method get_DtdParserProxy_ParsingBufferLength, addr 0x4259ca0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DtdParserProxy_ParsingBufferLength();

  /// @brief Method get_DtdParserProxy_V1CompatibilityMode, addr 0x4259be4, size 0x8, virtual false, abstract: false, final false
  inline bool get_DtdParserProxy_V1CompatibilityMode();

  /// @brief Method get_DtdParserProxy_ValidationEventHandling, addr 0x4259ccc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::IValidationEventHandling* get_DtdParserProxy_ValidationEventHandling();

  /// @brief Method get_DtdValidation, addr 0x4259bc4, size 0x10, virtual false, abstract: false, final false
  inline bool get_DtdValidation();

  /// @brief Method get_EOF, addr 0x4255188, size 0x10, virtual true, abstract: false, final false
  inline bool get_EOF();

  /// @brief Method get_FragmentType, addr 0x42653b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_FragmentType();

  /// @brief Method get_InAttributeValueIterator, addr 0x42556b4, size 0x24, virtual false, abstract: false, final false
  inline bool get_InAttributeValueIterator();

  /// @brief Method get_InEntity, addr 0x425d2d8, size 0x10, virtual false, abstract: false, final false
  inline bool get_InEntity();

  /// @brief Method get_InternalTypedValue, addr 0x4265430, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* get_InternalTypedValue();

  /// @brief Method get_IsDefault, addr 0x42550fc, size 0x1c, virtual true, abstract: false, final false
  inline bool get_IsDefault();

  /// @brief Method get_IsEmptyElement, addr 0x42550e0, size 0x1c, virtual true, abstract: false, final false
  inline bool get_IsEmptyElement();

  /// @brief Method get_IsResolverNull, addr 0x425a9a8, size 0x40, virtual false, abstract: false, final false
  inline bool get_IsResolverNull();

  /// @brief Method get_IsResolverSet, addr 0x4259b40, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsResolverSet();

  /// @brief Method get_LineNumber, addr 0x4259634, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_LineNumber();

  /// @brief Method get_LinePosition, addr 0x4259650, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_LinePosition();

  /// @brief Method get_LocalName, addr 0x4254e58, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_Name, addr 0x4254e34, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameTable, addr 0x4255198, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_NamespaceManager, addr 0x4265470, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNamespaceManager* get_NamespaceManager();

  /// @brief Method get_NamespaceURI, addr 0x4254e74, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_NamespaceURI();

  /// @brief Method get_Namespaces, addr 0x425970c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Namespaces();

  /// @brief Method get_NodeType, addr 0x4254e18, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Normalization, addr 0x42598d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_Normalization();

  /// @brief Method get_Prefix, addr 0x4254e90, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_QuoteChar, addr 0x4255118, size 0x30, virtual true, abstract: false, final false
  inline char16_t get_QuoteChar();

  /// @brief Method get_ReadState, addr 0x4255180, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::ReadState get_ReadState();

  /// @brief Method get_Settings, addr 0x4254ca4, size 0x174, virtual true, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* get_Settings();

  /// @brief Method get_StandAlone, addr 0x4265468, size 0x8, virtual false, abstract: false, final false
  inline bool get_StandAlone();

  /// @brief Method get_V1Compat, addr 0x4265478, size 0x8, virtual false, abstract: false, final false
  inline bool get_V1Compat();

  /// @brief Method get_Value, addr 0x4254eac, size 0x48, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_XmlLang, addr 0x4255164, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_XmlLang();

  /// @brief Method get_XmlSpace, addr 0x4255148, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method set_DisableUndeclaredEntityCheck, addr 0x42658c0, size 0xc, virtual false, abstract: false, final false
  inline void set_DisableUndeclaredEntityCheck(bool value);

  /// @brief Method set_DtdParserProxy_CurrentPosition, addr 0x4259cb0, size 0x8, virtual false, abstract: false, final false
  inline void set_DtdParserProxy_CurrentPosition(int32_t value);

  /// @brief Method set_EntityHandling, addr 0x4259abc, size 0x84, virtual false, abstract: false, final false
  inline void set_EntityHandling(::System::Xml::EntityHandling value);

  /// @brief Method set_InternalSchemaType, addr 0x4265414, size 0x1c, virtual false, abstract: false, final false
  inline void set_InternalSchemaType(::System::Object* value);

  /// @brief Method set_InternalTypedValue, addr 0x426544c, size 0x1c, virtual false, abstract: false, final false
  inline void set_InternalTypedValue(::System::Object* value);

  /// @brief Method set_Namespaces, addr 0x4259714, size 0x1bc, virtual false, abstract: false, final false
  inline void set_Namespaces(bool value);

  /// @brief Method set_Normalization, addr 0x42598d8, size 0x11c, virtual false, abstract: false, final false
  inline void set_Normalization(bool value);

  /// @brief Method set_OnDefaultAttributeUse, addr 0x42652d8, size 0x8, virtual false, abstract: false, final false
  inline void set_OnDefaultAttributeUse(::System::Xml::XmlTextReaderImpl_OnDefaultAttributeUseDelegate* value);

  /// @brief Method set_OuterReader, addr 0x4258b24, size 0x8, virtual false, abstract: false, final false
  inline void set_OuterReader(::System::Xml::XmlReader* value);

  /// @brief Method set_ValidationEventHandling, addr 0x42652d0, size 0x8, virtual false, abstract: false, final false
  inline void set_ValidationEventHandling(::System::Xml::IValidationEventHandling* value);

  /// @brief Method set_WhitespaceHandling, addr 0x42599f4, size 0xc8, virtual false, abstract: false, final false
  inline void set_WhitespaceHandling(::System::Xml::WhitespaceHandling value);

  /// @brief Method set_XmlResolver, addr 0x4259b48, size 0x5c, virtual false, abstract: false, final false
  inline void set_XmlResolver(::System::Xml::XmlResolver* value);

  /// @brief Method set_XmlValidatingReaderCompatibilityMode, addr 0x42652e0, size 0xd8, virtual false, abstract: false, final false
