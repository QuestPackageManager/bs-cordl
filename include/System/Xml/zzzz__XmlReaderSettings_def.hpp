...
public:
  ...
  /// @brief Method AddValidation, addr 0x6151658, size 0xe8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlReader* AddValidation(::System::Xml::XmlReader* reader);

  /// @brief Method CheckReadOnly, addr 0x6151818, size 0xac, virtual false, abstract: false, final false
  inline void CheckReadOnly(::StringW propertyName);

  /// @brief Method Clone, addr 0x61521b0, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* Clone();

  /// @brief Method CreateDefaultResolver, addr 0x615235c, size 0x44, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlResolver* CreateDefaultResolver();

  /// @brief Method CreateDtdValidatingReader, addr 0x61523a0, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlValidatingReaderImpl* CreateDtdValidatingReader(::System::Xml::XmlReader* baseReader);

  /// @brief Method CreateReader, addr 0x6150f88, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateReader, addr 0x615119c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableLegacyXmlSettings, addr 0x61522ac, size 0xb0, virtual false, abstract: false, final false
  static inline bool EnableLegacyXmlSettings();

  /// @brief Method GetEventHandler, addr 0x6152218, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ValidationEventHandler* GetEventHandler();

  /// @brief Method GetXmlResolver, addr 0x61519a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetXmlResolver();

  /// @brief Method GetXmlResolver_CheckConfig, addr 0x61519ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetXmlResolver_CheckConfig();

  /// @brief Method Initialize, addr 0x61517a4, size 0x8, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method Initialize, addr 0x6152228, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6150f80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Nullable_1<bool> getStaticF_s_enableLegacyXmlSettings();

  /// @brief Method get_Async, addr 0x61517ac, size 0x8, virtual false, abstract: false, final false
  inline bool get_Async();

  /// @brief Method get_CheckCharacters, addr 0x6151b3c, size 0x8, virtual false, abstract: false, final false
  inline bool get_CheckCharacters();

  /// @brief Method get_CloseInput, addr 0x6151f0c, size 0x8, virtual false, abstract: false, final false
  inline bool get_CloseInput();

  /// @brief Method get_ConformanceLevel, addr 0x6151a84, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::ConformanceLevel get_ConformanceLevel();

  /// @brief Method get_DtdProcessing, addr 0x6151e54, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::DtdProcessing get_DtdProcessing();

  /// @brief Method get_IgnoreComments, addr 0x6151de8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreComments();

  /// @brief Method get_IgnoreProcessingInstructions, addr 0x6151d7c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreProcessingInstructions();

  /// @brief Method get_IgnoreWhitespace, addr 0x6151d10, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreWhitespace();

  /// @brief Method get_IsXmlResolverSet, addr 0x615192c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsXmlResolverSet();

  /// @brief Method get_LineNumberOffset, addr 0x61519b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumberOffset();

  /// @brief Method get_LinePositionOffset, addr 0x6151a1c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePositionOffset();

  /// @brief Method get_MaxCharactersFromEntities, addr 0x6151c5c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MaxCharactersFromEntities();

  /// @brief Method get_MaxCharactersInDocument, addr 0x6151ba8, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MaxCharactersInDocument();

  /// @brief Method get_NameTable, addr 0x61518c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_Schemas, addr 0x61520e8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSet* get_Schemas();

  /// @brief Method get_ValidationFlags, addr 0x6152030, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaValidationFlags get_ValidationFlags();

  /// @brief Method get_ValidationType, addr 0x6151f78, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Async, addr 0x61517b4, size 0x64, virtual false, abstract: false, final false
  inline void set_Async(bool value);

  /// @brief Method set_CheckCharacters, addr 0x6151b44, size 0x64, virtual false, abstract: false, final false
  inline void set_CheckCharacters(bool value);

  /// @brief Method set_CloseInput, addr 0x6151f14, size 0x64, virtual false, abstract: false, final false
  inline void set_CloseInput(bool value);

  /// @brief Method set_ConformanceLevel, addr 0x6151a8c, size 0xb0, virtual false, abstract: false, final false
  inline void set_ConformanceLevel(::System::Xml::ConformanceLevel value);

  /// @brief Method set_DtdProcessing, addr 0x6151e5c, size 0xb0, virtual false, abstract: false, final false
  inline void set_DtdProcessing(::System::Xml::DtdProcessing value);

  /// @brief Method set_IgnoreComments, addr 0x6151df0, size 0x64, virtual false, abstract: false, final false
  inline void set_IgnoreComments(bool value);

  /// @brief Method set_IgnoreProcessingInstructions, addr 0x6151d84, size 0x64, virtual false, abstract: false, final false
  inline void set_IgnoreProcessingInstructions(bool value);

  /// @brief Method set_IgnoreWhitespace, addr 0x6151d18, size 0x64, virtual false, abstract: false, final false
  inline void set_IgnoreWhitespace(bool value);

  /// @brief Method set_IsXmlResolverSet, addr 0x6151934, size 0x8, virtual false, abstract: false, final false
  inline void set_IsXmlResolverSet(bool value);

  /// @brief Method set_LineNumberOffset, addr 0x61519bc, size 0x60, virtual false, abstract: false, final false
  inline void set_LineNumberOffset(int32_t value);

  /// @brief Method set_LinePositionOffset, addr 0x6151a24, size 0x60, virtual false, abstract: false, final false
  inline void set_LinePositionOffset(int32_t value);

  /// @brief Method set_MaxCharactersFromEntities, addr 0x6151c64, size 0xac, virtual false, abstract: false, final false
  inline void set_MaxCharactersFromEntities(int64_t value);

  /// @brief Method set_MaxCharactersInDocument, addr 0x6151bb0, size 0xac, virtual false, abstract: false, final false
  inline void set_MaxCharactersInDocument(int64_t value);

  /// @brief Method set_NameTable, addr 0x61518cc, size 0x60, virtual false, abstract: false, final false
  inline void set_NameTable(::System::Xml::XmlNameTable* value);

  /// @brief Method set_ReadOnly, addr 0x6152220, size 0x8, virtual false, abstract: false, final false
  inline void set_ReadOnly(bool value);

  /// @brief Method set_Schemas, addr 0x6152150, size 0x60, virtual false, abstract: false, final false
  inline void set_Schemas(::System::Xml::Schema::XmlSchemaSet* value);

  /// @brief Method set_ValidationFlags, addr 0x6152038, size 0xb0, virtual false, abstract: false, final false
  inline void set_ValidationFlags(::System::Xml::Schema::XmlSchemaValidationFlags value);

  /// @brief Method set_ValidationType, addr 0x6151f80, size 0xb0, virtual false, abstract: false, final false
  inline void set_ValidationType(::System::Xml::ValidationType value);

  /// @brief Method set_XmlResolver, addr 0x615193c, size 0x68, virtual false, abstract: false, final false
