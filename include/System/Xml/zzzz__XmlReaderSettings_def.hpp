...
public:
  ...
  /// @brief Method AddValidation, addr 0x2e6edfc, size 0x108, virtual false, abstract: false, final false
  inline ::System::Xml::XmlReader* AddValidation(::System::Xml::XmlReader* reader);

  /// @brief Method CheckReadOnly, addr 0x2e6ef70, size 0xb8, virtual false, abstract: false, final false
  inline void CheckReadOnly(::StringW propertyName);

  /// @brief Method Clone, addr 0x2e65508, size 0x68, virtual false, abstract: false, final false
  inline ::System::Xml::XmlReaderSettings* Clone();

  /// @brief Method CreateDefaultResolver, addr 0x2e6f980, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlResolver* CreateDefaultResolver();

  /// @brief Method CreateDtdValidatingReader, addr 0x2e6fadc, size 0x80, virtual false, abstract: false, final false
  inline ::System::Xml::XmlValidatingReaderImpl* CreateDtdValidatingReader(::System::Xml::XmlReader* baseReader);

  /// @brief Method CreateReader, addr 0x2e6e6d0, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateReader, addr 0x2e6e914, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableLegacyXmlSettings, addr 0x2e6f9dc, size 0x100, virtual false, abstract: false, final false
  static inline bool EnableLegacyXmlSettings();

  /// @brief Method GetEventHandler, addr 0x2e6f908, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::ValidationEventHandler* GetEventHandler();

  /// @brief Method GetXmlResolver, addr 0x2e6f104, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetXmlResolver();

  /// @brief Method GetXmlResolver_CheckConfig, addr 0x2e6f10c, size 0x30, virtual false, abstract: false, final false
  inline ::System::Xml::XmlResolver* GetXmlResolver_CheckConfig();

  /// @brief Method Initialize, addr 0x2e6ef60, size 0x8, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method Initialize, addr 0x2e6f91c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e65570, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Nullable_1<bool> getStaticF_s_enableLegacyXmlSettings();

  /// @brief Method get_Async, addr 0x2e6ef68, size 0x8, virtual false, abstract: false, final false
  inline bool get_Async();

  /// @brief Method get_CheckCharacters, addr 0x2e6f2bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_CheckCharacters();

  /// @brief Method get_CloseInput, addr 0x2e6f66c, size 0x8, virtual false, abstract: false, final false
  inline bool get_CloseInput();

  /// @brief Method get_ConformanceLevel, addr 0x2e6f204, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::ConformanceLevel get_ConformanceLevel();

  /// @brief Method get_DtdProcessing, addr 0x2e6f5b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::DtdProcessing get_DtdProcessing();

  /// @brief Method get_IgnoreComments, addr 0x2e6f550, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreComments();

  /// @brief Method get_IgnoreProcessingInstructions, addr 0x2e6f4ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreProcessingInstructions();

  /// @brief Method get_IgnoreWhitespace, addr 0x2e6f488, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreWhitespace();

  /// @brief Method get_IsXmlResolverSet, addr 0x2e6f08c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsXmlResolverSet();

  /// @brief Method get_LineNumberOffset, addr 0x2e6f13c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LineNumberOffset();

  /// @brief Method get_LinePositionOffset, addr 0x2e6f1a0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LinePositionOffset();

  /// @brief Method get_MaxCharactersFromEntities, addr 0x2e6f3d4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MaxCharactersFromEntities();

  /// @brief Method get_MaxCharactersInDocument, addr 0x2e6f320, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_MaxCharactersInDocument();

  /// @brief Method get_NameTable, addr 0x2e6f028, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlNameTable* get_NameTable();

  /// @brief Method get_Schemas, addr 0x2e6f840, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaSet* get_Schemas();

  /// @brief Method get_ValidationFlags, addr 0x2e6f788, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaValidationFlags get_ValidationFlags();

  /// @brief Method get_ValidationType, addr 0x2e6f6d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Async, addr 0x2e65590, size 0x5c, virtual false, abstract: false, final false
  inline void set_Async(bool value);

  /// @brief Method set_CheckCharacters, addr 0x2e6f2c4, size 0x5c, virtual false, abstract: false, final false
  inline void set_CheckCharacters(bool value);

  /// @brief Method set_CloseInput, addr 0x2e6f674, size 0x5c, virtual false, abstract: false, final false
  inline void set_CloseInput(bool value);

  /// @brief Method set_ConformanceLevel, addr 0x2e6f20c, size 0xb0, virtual false, abstract: false, final false
  inline void set_ConformanceLevel(::System::Xml::ConformanceLevel value);

  /// @brief Method set_DtdProcessing, addr 0x2e6f5bc, size 0xb0, virtual false, abstract: false, final false
  inline void set_DtdProcessing(::System::Xml::DtdProcessing value);

  /// @brief Method set_IgnoreComments, addr 0x2e6f558, size 0x5c, virtual false, abstract: false, final false
  inline void set_IgnoreComments(bool value);

  /// @brief Method set_IgnoreProcessingInstructions, addr 0x2e6f4f4, size 0x5c, virtual false, abstract: false, final false
  inline void set_IgnoreProcessingInstructions(bool value);

  /// @brief Method set_IgnoreWhitespace, addr 0x2e6f490, size 0x5c, virtual false, abstract: false, final false
  inline void set_IgnoreWhitespace(bool value);

  /// @brief Method set_IsXmlResolverSet, addr 0x2e6f094, size 0xc, virtual false, abstract: false, final false
  inline void set_IsXmlResolverSet(bool value);

  /// @brief Method set_LineNumberOffset, addr 0x2e6f144, size 0x5c, virtual false, abstract: false, final false
  inline void set_LineNumberOffset(int32_t value);

  /// @brief Method set_LinePositionOffset, addr 0x2e6f1a8, size 0x5c, virtual false, abstract: false, final false
  inline void set_LinePositionOffset(int32_t value);

  /// @brief Method set_MaxCharactersFromEntities, addr 0x2e6f3dc, size 0xac, virtual false, abstract: false, final false
  inline void set_MaxCharactersFromEntities(int64_t value);

  /// @brief Method set_MaxCharactersInDocument, addr 0x2e6f328, size 0xac, virtual false, abstract: false, final false
  inline void set_MaxCharactersInDocument(int64_t value);

  /// @brief Method set_NameTable, addr 0x2e6f030, size 0x5c, virtual false, abstract: false, final false
  inline void set_NameTable(::System::Xml::XmlNameTable* value);

  /// @brief Method set_ReadOnly, addr 0x2e6f910, size 0xc, virtual false, abstract: false, final false
  inline void set_ReadOnly(bool value);

  /// @brief Method set_Schemas, addr 0x2e6f8ac, size 0x5c, virtual false, abstract: false, final false
  inline void set_Schemas(::System::Xml::Schema::XmlSchemaSet* value);

  /// @brief Method set_ValidationFlags, addr 0x2e6f790, size 0xb0, virtual false, abstract: false, final false
  inline void set_ValidationFlags(::System::Xml::Schema::XmlSchemaValidationFlags value);

  /// @brief Method set_ValidationType, addr 0x2e6f6d8, size 0xb0, virtual false, abstract: false, final false
  inline void set_ValidationType(::System::Xml::ValidationType value);

  /// @brief Method set_XmlResolver, addr 0x2e6f0a0, size 0x64, virtual false, abstract: false, final false
