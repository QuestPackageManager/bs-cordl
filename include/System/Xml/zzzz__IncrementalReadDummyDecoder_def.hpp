...
public:
  ...
  /// @brief Method Decode, addr 0x2e84b18, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e84b20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsFull, addr 0x2e84b10, size 0x8, virtual true, abstract: false, final false
