...
public:
  ...
  /// @brief Method get_IsFull, addr 0x2853abc, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsFull();

  /// @brief Method Decode, addr 0x2853ac4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2853acc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
