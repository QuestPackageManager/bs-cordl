...
public:
  ...
  /// @brief Method get_IsFull, addr 0x2857124, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsFull();

  /// @brief Method Decode, addr 0x285712c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2857134, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
