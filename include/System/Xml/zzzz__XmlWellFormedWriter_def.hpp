...
public:
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x432c954, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x432c98c, size 0x18, virtual true, abstract: false, final true
  inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix);

  /// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x432c9a4, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x43269bc, size 0x28, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Set, addr 0x43269f4, size 0x1c, virtual false, abstract: false, final false
  inline void Set(::StringW prefix, ::StringW localName, ::StringW namespaceUri, int32_t prevNSTop);

  /// @brief Method WriteEndElement, addr 0x432813c, size 0x30, virtual false, abstract: false, final false
  inline void WriteEndElement(::System::Xml::XmlRawWriter* rawWriter);

  /// @brief Method WriteFullEndElement, addr 0x4328424, size 0x30, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Set, addr 0x43269e4, size 0x10, virtual false, abstract: false, final false
  inline void Set(::StringW prefix, ::StringW namespaceUri, ::System::Xml::XmlWellFormedWriter_NamespaceKind kind);

  /// @brief Method WriteDecl, addr 0x432c000, size 0x13c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method IsDuplicate, addr 0x432c9d8, size 0x6c, virtual false, abstract: false, final false
  inline bool IsDuplicate(::StringW prefix, ::StringW localName, ::StringW namespaceUri);

  /// @brief Method Set, addr 0x432c9c8, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Set, addr 0x432d9c0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x432d9b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x432d08c, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddItem, addr 0x432cc50, size 0x178, virtual false, abstract: false, final false
  inline void AddItem(::System::Xml::AttributeValueCache_XmlWellFormedWriter_ItemType type, ::System::Object* data);

  /// @brief Method Clear, addr 0x432d988, size 0x30, virtual false, abstract: false, final false
  inline void Clear();

  static inline ::System::Xml::XmlWellFormedWriter_AttributeValueCache* New_ctor();

  /// @brief Method Replay, addr 0x432d214, size 0x324, virtual false, abstract: false, final false
  inline void Replay(::System::Xml::XmlWriter* writer);

  /// @brief Method StartComplexValue, addr 0x432cc14, size 0x3c, virtual false, abstract: false, final false
  inline void StartComplexValue();

  /// @brief Method Trim, addr 0x432d538, size 0x450, virtual false, abstract: false, final false
  inline void Trim();

  /// @brief Method WriteCharEntity, addr 0x432cdc8, size 0x94, virtual false, abstract: false, final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteChars, addr 0x432cfe0, size 0xac, virtual false, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteEntityRef, addr 0x432ca78, size 0x19c, virtual false, abstract: false, final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteRaw, addr 0x432d0c8, size 0xac, virtual false, abstract: false, final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw, addr 0x432d174, size 0x50, virtual false, abstract: false, final false
  inline void WriteRaw(::StringW data);

  /// @brief Method WriteString, addr 0x432cf70, size 0x70, virtual false, abstract: false, final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteSurrogateCharEntity, addr 0x432ce5c, size 0xc4, virtual false, abstract: false, final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteValue, addr 0x432d1c4, size 0x50, virtual false, abstract: false, final false
  inline void WriteValue(::StringW value);

  /// @brief Method WriteWhitespace, addr 0x432cf20, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x432d9cc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_StringValue, addr 0x432ca44, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAttribute, addr 0x4328d98, size 0x27c, virtual false, abstract: false, final false
  inline void AddAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceName);

  /// @brief Method AddNamespace, addr 0x432b964, size 0x178, virtual false, abstract: false, final false
  inline void AddNamespace(::StringW prefix, ::StringW ns, ::System::Xml::XmlWellFormedWriter_NamespaceKind kind);

  /// @brief Method AddToAttrHashTable, addr 0x432c254, size 0x134, virtual false, abstract: false, final false
  inline void AddToAttrHashTable(int32_t attributeIndex);

  /// @brief Method AddToNamespaceHashtable, addr 0x432bbec, size 0xe8, virtual false, abstract: false, final false
  inline void AddToNamespaceHashtable(int32_t namespaceIndex);

  /// @brief Method AdvanceState, addr 0x4326dc0, size 0x304, virtual false, abstract: false, final false
  inline void AdvanceState(::System::Xml::XmlWellFormedWriter_Token token);

  /// @brief Method CheckNCName, addr 0x432791c, size 0x100, virtual false, abstract: false, final false
  inline void CheckNCName(::StringW ncname);

  /// @brief Method Close, addr 0x432b120, size 0x1bc, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method DupAttrException, addr 0x432badc, size 0x110, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlException* DupAttrException(::StringW prefix, ::StringW localName);

  /// @brief Method Flush, addr 0x432b304, size 0xb4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method GeneratePrefix, addr 0x4328b94, size 0x134, virtual false, abstract: false, final false
  inline ::StringW GeneratePrefix();

  /// @brief Method GetStateName, addr 0x432bcd4, size 0xa0, virtual false, abstract: false, final false
  static inline ::StringW GetStateName(::System::Xml::XmlWellFormedWriter_State state);

  /// @brief Method InvalidCharsException, addr 0x432c13c, size 0x118, virtual false, abstract: false, final false
  static inline ::System::Exception* InvalidCharsException(::StringW name, int32_t badCharIndex);

  /// @brief Method LookupLocalNamespace, addr 0x4328cc8, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW LookupLocalNamespace(::StringW prefix);

  /// @brief Method LookupNamespace, addr 0x4327a1c, size 0x140, virtual false, abstract: false, final false
  inline ::StringW LookupNamespace(::StringW prefix);

  /// @brief Method LookupNamespaceIndex, addr 0x432b888, size 0xdc, virtual false, abstract: false, final false
  inline int32_t LookupNamespaceIndex(::StringW prefix);

  /// @brief Method LookupPrefix, addr 0x432b3b8, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method PopNamespaces, addr 0x432816c, size 0xd4, virtual false, abstract: false, final false
  inline void PopNamespaces(int32_t indexFrom, int32_t indexTo);

  /// @brief Method PushNamespaceExplicit, addr 0x432986c, size 0x4b8, virtual false, abstract: false, final false
  inline bool PushNamespaceExplicit(::StringW prefix, ::StringW ns);

  /// @brief Method PushNamespaceImplicit, addr 0x4327b5c, size 0x3fc, virtual false, abstract: false, final false
  inline void PushNamespaceImplicit(::StringW prefix, ::StringW ns);

  /// @brief Method SetSpecialAttribute, addr 0x4328b08, size 0x8c, virtual false, abstract: false, final false
  inline void SetSpecialAttribute(::System::Xml::XmlWellFormedWriter_SpecialAttribute special);

  /// @brief Method StartElementContent, addr 0x432bf38, size 0xc8, virtual false, abstract: false, final false
  inline void StartElementContent();

  /// @brief Method StartFragment, addr 0x432b87c, size 0xc, virtual false, abstract: false, final false
  inline void StartFragment();

  /// @brief Method ThrowInvalidStateTransition, addr 0x432bd74, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteBase64, addr 0x432aef0, size 0x230, virtual true, abstract: false, final false
  inline void WriteBase64(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteBinHex, addr 0x432b738, size 0x12c, virtual true, abstract: false, final false
  inline void WriteBinHex(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteCData, addr 0x4329d24, size 0x104, virtual true, abstract: false, final false
  inline void WriteCData(::StringW text);

  /// @brief Method WriteCharEntity, addr 0x432a344, size 0x1a4, virtual true, abstract: false, final false
  inline void WriteCharEntity(char16_t ch);

  /// @brief Method WriteChars, addr 0x432a93c, size 0x260, virtual true, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteComment, addr 0x4329e28, size 0x104, virtual true, abstract: false, final false
  inline void WriteComment(::StringW text);

  /// @brief Method WriteDocType, addr 0x43270c4, size 0x4b0, virtual true, abstract: false, final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteEndAttribute, addr 0x4329014, size 0x858, virtual true, abstract: false, final false
  inline void WriteEndAttribute();

  /// @brief Method WriteEndDocument, addr 0x4326c70, size 0x150, virtual true, abstract: false, final false
  inline void WriteEndDocument();

  /// @brief Method WriteEndElement, addr 0x4327f58, size 0x1e4, virtual true, abstract: false, final false
  inline void WriteEndElement();

  /// @brief Method WriteEntityRef, addr 0x432a1d0, size 0x164, virtual true, abstract: false, final false
  inline void WriteEntityRef(::StringW name);

  /// @brief Method WriteFullEndElement, addr 0x4328240, size 0x1e4, virtual true, abstract: false, final false
  inline void WriteFullEndElement();

  /// @brief Method WriteProcessingInstruction, addr 0x4329f2c, size 0x2a4, virtual true, abstract: false, final false
  inline void WriteProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method WriteRaw, addr 0x432ab9c, size 0x260, virtual true, abstract: false, final false
  inline void WriteRaw(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteRaw, addr 0x432adfc, size 0xf4, virtual true, abstract: false, final false
  inline void WriteRaw(::StringW data);

  /// @brief Method WriteStartAttribute, addr 0x4328454, size 0x6b4, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceName);

  /// @brief Method WriteStartDocument, addr 0x4326aa4, size 0x8, virtual true, abstract: false, final false
  inline void WriteStartDocument();

  /// @brief Method WriteStartDocument, addr 0x4326c54, size 0x1c, virtual true, abstract: false, final false
  inline void WriteStartDocument(bool standalone);

  /// @brief Method WriteStartDocumentImpl, addr 0x4326aac, size 0x1a8, virtual false, abstract: false, final false
  inline void WriteStartDocumentImpl(::System::Xml::XmlStandalone standalone);

  /// @brief Method WriteStartElement, addr 0x4327574, size 0x3a8, virtual true, abstract: false, final false
  inline void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteString, addr 0x432a848, size 0xf4, virtual true, abstract: false, final false
  inline void WriteString(::StringW text);

  /// @brief Method WriteSurrogateCharEntity, addr 0x432a4e8, size 0x1a8, virtual true, abstract: false, final false
  inline void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar);

  /// @brief Method WriteValue, addr 0x432b634, size 0x104, virtual true, abstract: false, final false
  inline void WriteValue(::StringW value);

  /// @brief Method WriteWhitespace, addr 0x432a690, size 0x1b8, virtual true, abstract: false, final false
  inline void WriteWhitespace(::StringW ws);
  ...
  /// @brief Method .ctor, addr 0x43265dc, size 0x3e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InBase64, addr 0x432b2dc, size 0x28, virtual false, abstract: false, final false
  inline bool get_InBase64();

  /// @brief Method get_IsClosedOrErrorState, addr 0x432b864, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsClosedOrErrorState();

  /// @brief Method get_RawWriter, addr 0x432b874, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlRawWriter* get_RawWriter();

  /// @brief Method get_SaveAttrValue, addr 0x432a334, size 0x10, virtual false, abstract: false, final false
  inline bool get_SaveAttrValue();

  /// @brief Method get_WriteState, addr 0x4326a10, size 0x94, virtual true, abstract: false, final false
