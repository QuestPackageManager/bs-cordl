...
public:
  ...
  /// @brief Method Reset, addr 0x60f80c0, size 0x44, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x60f8058, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
