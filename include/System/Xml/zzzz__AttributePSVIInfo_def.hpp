...
public:
  ...
  /// @brief Method Reset, addr 0x62acc18, size 0x44, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x62acbb0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AttributePSVIInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AttributePSVIInfo(AttributePSVIInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AttributePSVIInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AttributePSVIInfo(AttributePSVIInfoconst&) = delete;
