...
public:
  ...
  /// @brief Method Reset, addr 0x432ed68, size 0x64, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x432ed04, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
