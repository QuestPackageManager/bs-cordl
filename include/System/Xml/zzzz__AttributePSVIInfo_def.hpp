...
public:
  ...
  /// @brief Method Reset, addr 0x432f148, size 0x64, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x432f0e4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
