...
/// @brief Method ReadArray, addr 0x5f4a074, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method WriteArray, addr 0x5f4a0ac, size 0x3c, virtual true, abstract: false, final false
inline void WriteArray(::System::Xml::XmlDictionaryWriter*  writer, ::StringW  prefix, ::StringW  localName, ::StringW  namespaceUri, ::ArrayW<int32_t,::Array<int32_t>*>  array, int32_t  offset, int32_t  count) ;

/// @brief Method .ctor, addr 0x5f4a0e8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
