...
// Write type traits
MARK_REF_T(::System::Xml::Int32ArrayHelperWithString*);
DEFINE_IL2CPP_CLASS(::System::Xml::Int32ArrayHelperWithString*, "System.Xml", "Int32ArrayHelperWithString");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Int32ArrayHelperWithString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Int32ArrayHelperWithString(Int32ArrayHelperWithString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Int32ArrayHelperWithString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Int32ArrayHelperWithString(Int32ArrayHelperWithStringconst&) = delete;
...
static_assert(sizeof(::System::Xml::Int32ArrayHelperWithString) == 0x10, "Size mismatch!");
