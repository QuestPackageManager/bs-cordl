...
#include <cmath>
#include <cstdint>
CORDL_MODULE_EXPORT(DoubleArrayHelperWithString)
...
// Write type traits
MARK_REF_T(::System::Xml::DoubleArrayHelperWithString*);
DEFINE_IL2CPP_CLASS(::System::Xml::DoubleArrayHelperWithString*, "System.Xml", "DoubleArrayHelperWithString");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DoubleArrayHelperWithString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DoubleArrayHelperWithString(DoubleArrayHelperWithString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DoubleArrayHelperWithString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DoubleArrayHelperWithString(DoubleArrayHelperWithStringconst&) = delete;
...
static_assert(sizeof(::System::Xml::DoubleArrayHelperWithString) == 0x10, "Size mismatch!");
