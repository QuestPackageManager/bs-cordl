...
public:
  ...
  /// @brief Method ReadArray, addr 0x5ee2578, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x5ee25b0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ee25ec, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
