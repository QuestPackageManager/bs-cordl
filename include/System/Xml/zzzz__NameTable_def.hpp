...
public:
  ...
  /// @brief Method .ctor, addr 0x618c28c, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x618be2c, size 0x154, virtual true, abstract: false, final false
  inline ::StringW Add(::ArrayW<char16_t, ::Array<char16_t>*> key, int32_t start, int32_t len);

  /// @brief Method Add, addr 0x618bbc8, size 0x160, virtual true, abstract: false, final false
  inline ::StringW Add(::StringW key);

  /// @brief Method AddEntry, addr 0x618bd28, size 0x104, virtual false, abstract: false, final false
  inline ::StringW AddEntry(::StringW str, int32_t hashCode);

  /// @brief Method Get, addr 0x618c16c, size 0x120, virtual true, abstract: false, final false
  inline ::StringW Get(::ArrayW<char16_t, ::Array<char16_t>*> key, int32_t start, int32_t len);

  /// @brief Method Get, addr 0x618c030, size 0x13c, virtual true, abstract: false, final false
  inline ::StringW Get(::StringW value);

  /// @brief Method Grow, addr 0x618c29c, size 0x12c, virtual false, abstract: false, final false
  inline void Grow();

  static inline ::System::Xml::NameTable* New_ctor();

  /// @brief Method TextEquals, addr 0x618bf80, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x618bb64, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
