...
public:
  ...
  /// @brief Method .ctor addr 0x27159c8 size 0x40 virtual false final false
...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11496))}
...
public:
  ...
  /// @brief Method .ctor addr 0x270d278 size 0x70 virtual false final false
  inline void _ctor();

  /// @brief Method Add addr 0x27153b4 size 0x17c virtual true final false
  inline ::StringW Add(::StringW key);

  /// @brief Method Add addr 0x2715638 size 0x178 virtual true final false
  inline ::StringW Add(::ArrayW<char16_t, ::Array<char16_t>*> key, int32_t start, int32_t len);

  /// @brief Method Get addr 0x2715860 size 0x168 virtual true final false
  inline ::StringW Get(::StringW value);

  /// @brief Method AddEntry addr 0x2715530 size 0x108 virtual false final false
  inline ::StringW AddEntry(::StringW str, int32_t hashCode);

  /// @brief Method Grow addr 0x2715a08 size 0x124 virtual false final false
  inline void Grow();

  /// @brief Method TextEquals addr 0x27157b0 size 0xb0 virtual false final false
