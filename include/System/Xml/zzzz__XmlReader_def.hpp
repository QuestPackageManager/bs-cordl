...
public:
  ...
  /// @brief Method get_Settings addr 0x26dddf8 size 0x8 virtual true final false
  ...
  /// @brief Method get_Name addr 0x26dde00 size 0xe4 virtual true final false
  ...
  /// @brief Method get_IsDefault addr 0x26ddee4 size 0x8 virtual true final false
  inline bool get_IsDefault();

  /// @brief Method get_SchemaInfo addr 0x26ddeec size 0x48 virtual true final false
  ...
  /// @brief Method Close addr 0x26ddf34 size 0x4 virtual true final false
  inline void Close();
  ...
  /// @brief Method get_CanResolveEntity addr 0x26ddf38 size 0x8 virtual true final false
  ...
  /// @brief Method Dispose addr 0x26ddf40 size 0x14 virtual true final true
  inline void Dispose();

  /// @brief Method Dispose addr 0x26ddf54 size 0x44 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method get_DtdInfo addr 0x26ddf98 size 0x8 virtual true final false
  inline ::System::Xml::IDtdInfo* get_DtdInfo();

  /// @brief Method CalcBufferSize addr 0x26ddfa0 size 0x84 virtual false final false
  static inline int32_t CalcBufferSize(::System::IO::Stream* input);

  static inline ::System::Xml::XmlReader* New_ctor();

  /// @brief Method .ctor addr 0x26de024 size 0x8 virtual false final false
  inline void _ctor();
