...
// Write type traits
MARK_REF_T(::System::Xml::XmlNodeChangedEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlNodeChangedEventArgs*, "System.Xml", "XmlNodeChangedEventArgs");
...
public:
  ...
  /// @brief Method .ctor, addr 0x62bf464, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Action, addr 0x62c86a0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlNodeChangedEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlNodeChangedEventArgs(XmlNodeChangedEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlNodeChangedEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlNodeChangedEventArgs(XmlNodeChangedEventArgsconst&) = delete;
...
static_assert(sizeof(::System::Xml::XmlNodeChangedEventArgs) == 0x40, "Size mismatch!");
