...
public:
  ...
  /// @brief Method .ctor, addr 0x29dda9c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Action, addr 0x29ddb38, size 0x8, virtual false, abstract: false, final false
