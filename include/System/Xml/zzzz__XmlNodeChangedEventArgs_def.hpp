...
public:
  ...
  /// @brief Method .ctor, addr 0x2da28b0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Action, addr 0x2da294c, size 0x8, virtual false, abstract: false, final false
