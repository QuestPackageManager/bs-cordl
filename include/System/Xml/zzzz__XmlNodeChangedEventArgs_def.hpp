...
public:
  ...
  /// @brief Method .ctor, addr 0x2d9f8b4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Action, addr 0x2d9f950, size 0x8, virtual false, abstract: false, final false
