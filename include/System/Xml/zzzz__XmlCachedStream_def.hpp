...
public:
  ...
  /// @brief Method .ctor, addr 0x62e1d38, size 0x164, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlCachedStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlCachedStream(XmlCachedStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlCachedStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlCachedStream(XmlCachedStreamconst&) = delete;
