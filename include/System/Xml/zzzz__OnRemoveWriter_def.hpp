...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x430a100, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x430a000, size 0x100, virtual false, abstract: false, final false
