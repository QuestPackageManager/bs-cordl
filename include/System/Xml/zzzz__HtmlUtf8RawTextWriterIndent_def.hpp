...
public:
  ...
  /// @brief Method FlushBuffer, addr 0x293c42c, size 0x2c, virtual true, abstract: false, final false
  inline void FlushBuffer();

  /// @brief Method Init, addr 0x293c06c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method StartElementContent, addr 0x293c2a4, size 0x74, virtual true, abstract: false, final false
  inline void StartElementContent();

  /// @brief Method WriteDocType, addr 0x293c094, size 0x1c, virtual true, abstract: false, final false
  inline void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset);

  /// @brief Method WriteEndElement, addr 0x293c318, size 0xa0, virtual true, abstract: false, final false
  inline void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteIndent, addr 0x293c254, size 0x50, virtual false, abstract: false, final false
  inline void WriteIndent();

  /// @brief Method WriteStartAttribute, addr 0x293c3b8, size 0x74, virtual true, abstract: false, final false
  inline void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns);

  /// @brief Method WriteStartElement, addr 0x293c0b0, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x293c020, size 0x4c, virtual false, abstract: false, final false
