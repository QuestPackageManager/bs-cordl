...
/// @brief Method Equals2, addr 0x5f521f0, size 0x138, virtual false, abstract: false, final false
inline bool Equals2(::StringW  str, bool  checkLower) ;

/// @brief Method GetBase64, addr 0x5f51f28, size 0x30, virtual false, abstract: false, final false
inline void GetBase64(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method GetChar, addr 0x5f52f90, size 0x8, virtual false, abstract: false, final false
inline int32_t GetChar() ;

/// @brief Method GetCharText, addr 0x5f5202c, size 0xdc, virtual false, abstract: false, final false
inline ::StringW GetCharText() ;

/// @brief Method GetCharsText, addr 0x5f51f58, size 0x94, virtual false, abstract: false, final false
inline ::StringW GetCharsText() ;

/// @brief Method GetDecimal, addr 0x5f5178c, size 0x20, virtual false, abstract: false, final false
inline ::System::Decimal GetDecimal() ;

/// @brief Method GetDictionaryString, addr 0x5f52108, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::XmlDictionaryString* GetDictionaryString() ;

/// @brief Method GetDouble, addr 0x5f5144c, size 0x20, virtual false, abstract: false, final false
inline double_t GetDouble() ;

/// @brief Method GetEscapedCharsText, addr 0x5f5200c, size 0x20, virtual false, abstract: false, final false
inline ::StringW GetEscapedCharsText() ;

/// @brief Method GetGuid, addr 0x5f51b34, size 0x20, virtual false, abstract: false, final false
inline ::System::Guid GetGuid() ;

/// @brief Method GetInt16, addr 0x5f50fb4, size 0x20, virtual false, abstract: false, final false
inline int32_t GetInt16() ;

/// @brief Method GetInt32, addr 0x5f50fd4, size 0x20, virtual false, abstract: false, final false
inline int32_t GetInt32() ;

/// @brief Method GetInt64, addr 0x5f50ff4, size 0x20, virtual false, abstract: false, final false
inline int64_t GetInt64() ;

/// @brief Method GetInt8, addr 0x5f508e0, size 0x28, virtual false, abstract: false, final false
inline int32_t GetInt8() ;

/// @brief Method GetQNameDictionaryText, addr 0x5f52148, size 0xa8, virtual false, abstract: false, final false
inline ::StringW GetQNameDictionaryText() ;

/// @brief Method GetSingle, addr 0x5f5142c, size 0x20, virtual false, abstract: false, final false
inline float_t GetSingle() ;

/// @brief Method GetString, addr 0x5f50908, size 0x530, virtual false, abstract: false, final false
inline ::StringW GetString() ;

/// @brief Method GetUInt64, addr 0x5f51014, size 0x1c, virtual false, abstract: false, final false
inline uint64_t GetUInt64() ;

/// @brief Method GetUnicodeCharsText, addr 0x5f51fec, size 0x20, virtual false, abstract: false, final false
inline ::StringW GetUnicodeCharsText() ;

/// @brief Method GetUniqueId, addr 0x5f51974, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::UniqueId* GetUniqueId() ;

/// @brief Method IsWhitespace, addr 0x5f50414, size 0x194, virtual false, abstract: false, final false
inline bool IsWhitespace() ;

static inline ::System::Xml::ValueHandle* New_ctor(::System::Xml::XmlBufferReader*  bufferReader) ;

/// @brief Method SetCharValue, addr 0x5f503f4, size 0x10, virtual false, abstract: false, final false
inline void SetCharValue(int32_t  ch) ;

/// @brief Method SetDictionaryValue, addr 0x5f503d8, size 0x10, virtual false, abstract: false, final false
inline void SetDictionaryValue(int32_t  key) ;

/// @brief Method SetQNameValue, addr 0x5f50404, size 0x10, virtual false, abstract: false, final false
inline void SetQNameValue(int32_t  prefix, int32_t  key) ;

/// @brief Method SetValue, addr 0x5f503d0, size 0x8, virtual false, abstract: false, final false
inline void SetValue(::System::Xml::ValueHandleType  type) ;

/// @brief Method SetValue, addr 0x5f503e8, size 0xc, virtual false, abstract: false, final false
inline void SetValue(::System::Xml::ValueHandleType  type, int32_t  offset, int32_t  length) ;

/// @brief Method Sign, addr 0x5f52328, size 0x1fc, virtual false, abstract: false, final false
inline void Sign(::System::Xml::XmlSigningNodeWriter*  writer) ;

/// @brief Method ToBoolean, addr 0x5f507d4, size 0x10c, virtual false, abstract: false, final false
inline bool ToBoolean() ;

/// @brief Method ToByteArray, addr 0x5f51b58, size 0x3d0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ToByteArray() ;

/// @brief Method ToDateTime, addr 0x5f517ac, size 0xf8, virtual false, abstract: false, final false
inline ::System::DateTime ToDateTime() ;

/// @brief Method ToDecimal, addr 0x5f515d4, size 0x1b8, virtual false, abstract: false, final false
inline ::System::Decimal ToDecimal() ;

/// @brief Method ToDouble, addr 0x5f5146c, size 0x168, virtual false, abstract: false, final false
inline double_t ToDouble() ;

/// @brief Method ToGuid, addr 0x5f51a64, size 0xd0, virtual false, abstract: false, final false
inline ::System::Guid ToGuid() ;

/// @brief Method ToInt, addr 0x5f50e38, size 0x17c, virtual false, abstract: false, final false
inline int32_t ToInt() ;

/// @brief Method ToList, addr 0x5f52128, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::System::Object*,::Array<::System::Object*>*> ToList() ;

/// @brief Method ToLong, addr 0x5f51030, size 0x168, virtual false, abstract: false, final false
inline int64_t ToLong() ;

/// @brief Method ToObject, addr 0x5f52524, size 0x2ac, virtual false, abstract: false, final false
inline ::System::Object* ToObject() ;

/// @brief Method ToSingle, addr 0x5f512ac, size 0x180, virtual false, abstract: false, final false
inline float_t ToSingle() ;

/// @brief Method ToString, addr 0x5f51b54, size 0x4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToTimeSpan, addr 0x5f51994, size 0xd0, virtual false, abstract: false, final false
inline ::System::TimeSpan ToTimeSpan() ;

/// @brief Method ToType, addr 0x5f505a8, size 0x22c, virtual false, abstract: false, final false
inline ::System::Type* ToType() ;

/// @brief Method ToULong, addr 0x5f51198, size 0x114, virtual false, abstract: false, final false
inline uint64_t ToULong() ;

/// @brief Method ToUniqueId, addr 0x5f518a4, size 0xd0, virtual false, abstract: false, final false
inline ::System::Xml::UniqueId* ToUniqueId() ;

/// @brief Method TryGetByteArrayLength, addr 0x5f52f68, size 0x28, virtual false, abstract: false, final false
inline bool TryGetByteArrayLength(::ByRef<int32_t>  length) ;

/// @brief Method TryGetDictionaryString, addr 0x5f52f28, size 0x40, virtual false, abstract: false, final false
inline bool TryGetDictionaryString(::ByRef<::System::Xml::XmlDictionaryString*>  value) ;

/// @brief Method TryReadBase64, addr 0x5f527d0, size 0x220, virtual false, abstract: false, final false
inline bool TryReadBase64(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count, ::ByRef<int32_t>  actual) ;

/// @brief Method TryReadChars, addr 0x5f529f0, size 0x424, virtual false, abstract: false, final false
inline bool TryReadChars(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  offset, int32_t  count, ::ByRef<int32_t>  actual) ;

/// @brief Method TryReadUnicodeChars, addr 0x5f52e14, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5f502f0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_Base64Encoding, addr 0x5f502fc, size 0xd4, virtual false, abstract: false, final false
