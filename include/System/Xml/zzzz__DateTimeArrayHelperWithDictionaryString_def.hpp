...
// Write type traits
MARK_REF_T(::System::Xml::DateTimeArrayHelperWithDictionaryString*);
DEFINE_IL2CPP_CLASS(::System::Xml::DateTimeArrayHelperWithDictionaryString*, "System.Xml", "DateTimeArrayHelperWithDictionaryString");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DateTimeArrayHelperWithDictionaryString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DateTimeArrayHelperWithDictionaryString(DateTimeArrayHelperWithDictionaryString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DateTimeArrayHelperWithDictionaryString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DateTimeArrayHelperWithDictionaryString(DateTimeArrayHelperWithDictionaryStringconst&) = delete;
...
static_assert(sizeof(::System::Xml::DateTimeArrayHelperWithDictionaryString) == 0x10, "Size mismatch!");
