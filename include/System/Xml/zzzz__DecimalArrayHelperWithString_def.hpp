...
public:
  ...
  /// @brief Method ReadArray, addr 0x5f4a374, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteArray, addr 0x5f4a3ac, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f4a3e8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
