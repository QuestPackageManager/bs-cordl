...
/// @brief Method AppendText, addr 0x606b5d0, size 0x20, virtual true, abstract: false, final false
inline void AppendText(::System::Text::StringBuilder*  sb) ;

/// @brief Method CloneNode, addr 0x606b5f0, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method WriteTo, addr 0x606b4d8, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6063a00, size 0x5c, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XText*  other) ;

/// @brief Method .ctor, addr 0x60639a4, size 0x58, virtual false, abstract: false, final false
inline void _ctor(::StringW  value) ;

/// @brief Method get_NodeType, addr 0x606b4c8, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Value, addr 0x606b4d0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x6065538, size 0x100, virtual false, abstract: false, final false
