...
public:
  ...
  /// @brief Method .ctor addr 0x26dfb9c size 0x78 virtual false final false
  inline void _ctor(::StringW value);

  static inline ::System::Xml::Linq::XText* New_ctor(::System::Xml::Linq::XText* other);

  /// @brief Method .ctor addr 0x26dfc18 size 0x7c virtual false final false
  inline void _ctor(::System::Xml::Linq::XText* other);

  /// @brief Method get_NodeType addr 0x26e584c size 0x8 virtual true final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value addr 0x26e5854 size 0x8 virtual false final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x26e1880 size 0xf4 virtual false final false
  inline void set_Value(::StringW value);

  /// @brief Method WriteTo addr 0x26e585c size 0xf4 virtual true final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method AppendText addr 0x26e5950 size 0x24 virtual true final false
  inline void AppendText(::System::Text::StringBuilder* sb);

  /// @brief Method CloneNode addr 0x26e5974 size 0x60 virtual true final false
