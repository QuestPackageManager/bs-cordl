...
public:
  ...
  /// @brief Method .ctor, addr 0x285f220, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  static inline ::System::Xml::Linq::XText* New_ctor(::System::Xml::Linq::XText* other);

  /// @brief Method .ctor, addr 0x285f29c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XText* other);

  /// @brief Method get_NodeType, addr 0x2864ed0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x2864ed8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x2860f04, size 0xf4, virtual false, abstract: false, final false
  inline void set_Value(::StringW value);

  /// @brief Method WriteTo, addr 0x2864ee0, size 0xf4, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method AppendText, addr 0x2864fd4, size 0x24, virtual true, abstract: false, final false
  inline void AppendText(::System::Text::StringBuilder* sb);

  /// @brief Method CloneNode, addr 0x2864ff8, size 0x60, virtual true, abstract: false, final false
