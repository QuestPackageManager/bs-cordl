...
/// @brief Method CloneNode, addr 0x5ff444c, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method WriteTo, addr 0x5ff43e0, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ff34fc, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  publicId, ::StringW  systemId, ::StringW  internalSubset) ;

/// @brief Method .ctor, addr 0x5ff4354, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XDocumentType*  other) ;

/// @brief Method get_InternalSubset, addr 0x5ff43b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_InternalSubset() ;

/// @brief Method get_Name, addr 0x5ff43c0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NodeType, addr 0x5ff43c8, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_PublicId, addr 0x5ff43d0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_PublicId() ;

/// @brief Method get_SystemId, addr 0x5ff43d8, size 0x8, virtual false, abstract: false, final false
