...
public:
  ...
  /// @brief Method .ctor, addr 0x2861f98, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2862028, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDocumentType* other);

  /// @brief Method get_InternalSubset, addr 0x28620ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InternalSubset();

  /// @brief Method get_Name, addr 0x28620b4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0x28620bc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_PublicId, addr 0x28620c4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PublicId();

  /// @brief Method get_SystemId, addr 0x28620cc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SystemId();

  /// @brief Method WriteTo, addr 0x28620d4, size 0x74, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method CloneNode, addr 0x2862148, size 0x60, virtual true, abstract: false, final false
