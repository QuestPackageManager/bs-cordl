...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XDocumentType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XDocumentType(XDocumentType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XDocumentType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XDocumentType(XDocumentTypeconst&) = delete;
