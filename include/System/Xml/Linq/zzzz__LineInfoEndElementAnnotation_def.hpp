...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LineInfoEndElementAnnotation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LineInfoEndElementAnnotation(LineInfoEndElementAnnotation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LineInfoEndElementAnnotation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LineInfoEndElementAnnotation(LineInfoEndElementAnnotationconst&) = delete;
