...
public:
  ...
  /// @brief Method ReadContentFrom, addr 0x61a091c, size 0x5f4, virtual false, abstract: false, final false
  inline bool ReadContentFrom(::System::Xml::Linq::XContainer* rootContainer, ::System::Xml::XmlReader* r);

  /// @brief Method ReadContentFrom, addr 0x61a10e8, size 0xc04, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a0914, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* rootContainer);

  /// @brief Method .ctor, addr 0x61a103c, size 0xac, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x61a2414, size 0x90, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Xml::Linq::XContainer__Nodes_d__18* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Xml.Linq.XNode>.GetEnumerator, addr 0x61a24ec, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Xml.Linq.XNode>.get_Current, addr 0x61a24a4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Linq::XNode* System_Collections_Generic_IEnumerator_System_Xml_Linq_XNode__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x61a2584, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x61a24ac, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x61a24e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x61a2410, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x619ff68, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x619f1b4, size 0x4d8, virtual false, abstract: false, final false
  inline void Add(::System::Object* content);

  /// @brief Method AddAttribute, addr 0x61a0348, size 0x4, virtual true, abstract: false, final false
  inline void AddAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddAttributeSkipNotify, addr 0x61a034c, size 0x4, virtual true, abstract: false, final false
  inline void AddAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddContentSkipNotify, addr 0x619f700, size 0x4b0, virtual false, abstract: false, final false
  inline void AddContentSkipNotify(::System::Object* content);

  /// @brief Method AddNode, addr 0x619fbb0, size 0x80, virtual false, abstract: false, final false
  inline void AddNode(::System::Xml::Linq::XNode* n);

  /// @brief Method AddNodeSkipNotify, addr 0x61a0350, size 0x80, virtual false, abstract: false, final false
  inline void AddNodeSkipNotify(::System::Xml::Linq::XNode* n);

  /// @brief Method AddString, addr 0x619fc30, size 0x268, virtual false, abstract: false, final false
  inline void AddString(::StringW s);

  /// @brief Method AddStringSkipNotify, addr 0x61a03d0, size 0x14c, virtual false, abstract: false, final false
  inline void AddStringSkipNotify(::StringW s);

  /// @brief Method AppendNode, addr 0x61a051c, size 0x118, virtual false, abstract: false, final false
  inline void AppendNode(::System::Xml::Linq::XNode* n);

  /// @brief Method AppendNodeSkipNotify, addr 0x619efe0, size 0xbc, virtual false, abstract: false, final false
  inline void AppendNodeSkipNotify(::System::Xml::Linq::XNode* n);

  /// @brief Method AppendText, addr 0x61a0734, size 0xe8, virtual true, abstract: false, final false
  inline void AppendText(::System::Text::StringBuilder* sb);

  /// @brief Method ConvertTextToNode, addr 0x61a02b8, size 0x90, virtual false, abstract: false, final false
  inline void ConvertTextToNode();

  /// @brief Method GetStringValue, addr 0x619da74, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method Nodes, addr 0x619fef8, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Xml::Linq::XNode*>* Nodes();

  /// @brief Method ReadContentFrom, addr 0x61a081c, size 0xf8, virtual false, abstract: false, final false
  inline void ReadContentFrom(::System::Xml::XmlReader* r);

  /// @brief Method ReadContentFrom, addr 0x61a0f10, size 0x12c, virtual false, abstract: false, final false
  inline void ReadContentFrom(::System::Xml::XmlReader* r, ::System::Xml::Linq::LoadOptions o);

  /// @brief Method RemoveNode, addr 0x61a1cec, size 0x1a4, virtual false, abstract: false, final false
  inline void RemoveNode(::System::Xml::Linq::XNode* n);

  /// @brief Method RemoveNodes, addr 0x619ff88, size 0x290, virtual false, abstract: false, final false
  inline void RemoveNodes();

  /// @brief Method RemoveNodesSkipNotify, addr 0x61a0218, size 0xa0, virtual false, abstract: false, final false
  inline void RemoveNodesSkipNotify();

  /// @brief Method ValidateNode, addr 0x61a1e90, size 0x4, virtual true, abstract: false, final false
  inline void ValidateNode(::System::Xml::Linq::XNode* node, ::System::Xml::Linq::XNode* previous);

  /// @brief Method ValidateString, addr 0x61a1e94, size 0x4, virtual true, abstract: false, final false
  inline void ValidateString(::StringW s);

  /// @brief Method WriteContentTo, addr 0x61a1e98, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x619eeb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x619eebc, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XContainer* other);

  /// @brief Method get_LastNode, addr 0x619f09c, size 0x118, virtual false, abstract: false, final false
