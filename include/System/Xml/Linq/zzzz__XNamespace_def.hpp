...
public:
  ...
  /// @brief Method EnsureNamespace, addr 0x4248978, size 0xe0, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* EnsureNamespace(::ByRef<::System::WeakReference*> refNmsp, ::StringW namespaceName);

  /// @brief Method Equals, addr 0x4248b2c, size 0xc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method ExtractLocalName, addr 0x4248b4c, size 0x18, virtual false, abstract: false, final false
  static inline ::StringW ExtractLocalName(::System::Xml::Linq::XName* n);

  /// @brief Method ExtractNamespace, addr 0x4248b64, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW ExtractNamespace(::System::WeakReference* r);

  /// @brief Method Get, addr 0x4247448, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* Get(::StringW namespaceName);

  /// @brief Method Get, addr 0x4248368, size 0x2d8, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* Get(::StringW namespaceName, int32_t index, int32_t count);

  /// @brief Method GetHashCode, addr 0x4248b38, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetName, addr 0x4245268, size 0x60, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XName* GetName(::StringW localName);

  /// @brief Method GetName, addr 0x4248640, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x4248970, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4248870, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NamespaceName, addr 0x4248968, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NamespaceName();

  /// @brief Method get_None, addr 0x4248748, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* get_None();

  /// @brief Method get_Xml, addr 0x4248a58, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* get_Xml();

  /// @brief Method get_Xmlns, addr 0x4248ab8, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* get_Xmlns();

  /// @brief Method op_Equality, addr 0x424665c, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Xml::Linq::XNamespace* left, ::System::Xml::Linq::XNamespace* right);

  /// @brief Method op_Implicit, addr 0x4248b18, size 0x14, virtual false, abstract: false, final false
  static inline ::System::Xml::Linq::XNamespace* op_Implicit___System__Xml__Linq__XNamespace_(::StringW namespaceName);

  /// @brief Method op_Inequality, addr 0x4248b40, size 0xc, virtual false, abstract: false, final false
