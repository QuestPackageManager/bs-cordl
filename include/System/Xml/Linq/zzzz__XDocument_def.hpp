...
namespace System::Xml::Linq {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15550))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x28618c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Xml::Linq::XDocument* New_ctor(::System::Xml::Linq::XDocument* other);

  /// @brief Method .ctor, addr 0x28618c8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDocument* other);

  /// @brief Method get_Declaration, addr 0x2861944, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XDeclaration* get_Declaration();

  /// @brief Method set_Declaration, addr 0x286194c, size 0x8, virtual false, abstract: false, final false
  inline void set_Declaration(::System::Xml::Linq::XDeclaration* value);

  /// @brief Method get_NodeType, addr 0x2861954, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Root, addr 0x286195c, size 0x48, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XElement* get_Root();

  /// @brief Method WriteTo, addr 0x28619a4, size 0x130, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method AddAttribute, addr 0x2861ad4, size 0x50, virtual true, abstract: false, final false
  inline void AddAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddAttributeSkipNotify, addr 0x2861b24, size 0x50, virtual true, abstract: false, final false
  inline void AddAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method CloneNode, addr 0x2861b74, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method IsWhitespace, addr 0x2861bd4, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsWhitespace(::StringW s);

  /// @brief Method ValidateNode, addr 0x2861c60, size 0x1a8, virtual true, abstract: false, final false
  inline void ValidateNode(::System::Xml::Linq::XNode* node, ::System::Xml::Linq::XNode* previous);

  /// @brief Method ValidateDocument, addr 0x2861e08, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateString, addr 0x2861f34, size 0x64, virtual true, abstract: false, final false
