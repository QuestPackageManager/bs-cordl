...
public:
  ...
  /// @brief Method AddAttribute, addr 0x42581c4, size 0x4c, virtual true, abstract: false, final false
  inline void AddAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddAttributeSkipNotify, addr 0x4258210, size 0x4c, virtual true, abstract: false, final false
  inline void AddAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method CloneNode, addr 0x425825c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method IsWhitespace, addr 0x42582b4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateDocument, addr 0x42584ec, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateNode, addr 0x4258348, size 0x1a4, virtual true, abstract: false, final false
  inline void ValidateNode(::System::Xml::Linq::XNode* node, ::System::Xml::Linq::XNode* previous);

  /// @brief Method ValidateString, addr 0x4258610, size 0x60, virtual true, abstract: false, final false
  inline void ValidateString(::StringW s);

  /// @brief Method WriteTo, addr 0x4258098, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4257fb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4257fc0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDocument* other);

  /// @brief Method get_Declaration, addr 0x4258038, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XDeclaration* get_Declaration();

  /// @brief Method get_NodeType, addr 0x4258048, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Root, addr 0x4258050, size 0x48, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XElement* get_Root();

  /// @brief Method set_Declaration, addr 0x4258040, size 0x8, virtual false, abstract: false, final false
