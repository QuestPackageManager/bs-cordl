...
public:
  ...
  /// @brief Method AddAttribute, addr 0x2dbbec4, size 0x50, virtual true, abstract: false, final false
  inline void AddAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddAttributeSkipNotify, addr 0x2dbbf14, size 0x50, virtual true, abstract: false, final false
  inline void AddAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method CloneNode, addr 0x2dbbf64, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method IsWhitespace, addr 0x2dbbfc4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateDocument, addr 0x2dbc1fc, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateNode, addr 0x2dbc050, size 0x1ac, virtual true, abstract: false, final false
  inline void ValidateNode(::System::Xml::Linq::XNode* node, ::System::Xml::Linq::XNode* previous);

  /// @brief Method ValidateString, addr 0x2dbc328, size 0x64, virtual true, abstract: false, final false
  inline void ValidateString(::StringW s);

  /// @brief Method WriteTo, addr 0x2dbbd94, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dbbcb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2dbbcb8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDocument* other);

  /// @brief Method get_Declaration, addr 0x2dbbd34, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XDeclaration* get_Declaration();

  /// @brief Method get_NodeType, addr 0x2dbbd44, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Root, addr 0x2dbbd4c, size 0x48, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XElement* get_Root();

  /// @brief Method set_Declaration, addr 0x2dbbd3c, size 0x8, virtual false, abstract: false, final false
