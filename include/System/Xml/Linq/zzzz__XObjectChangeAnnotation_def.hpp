...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XObjectChangeAnnotation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XObjectChangeAnnotation(XObjectChangeAnnotation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XObjectChangeAnnotation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XObjectChangeAnnotation(XObjectChangeAnnotationconst&) = delete;
