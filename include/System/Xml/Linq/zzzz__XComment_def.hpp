...
public:
  ...
  /// @brief Method .ctor addr 0x26dfd70 size 0x78 virtual false final false
  inline void _ctor(::StringW value);

  static inline ::System::Xml::Linq::XComment* New_ctor(::System::Xml::Linq::XComment* other);

  /// @brief Method .ctor addr 0x26dfdf0 size 0x7c virtual false final false
  inline void _ctor(::System::Xml::Linq::XComment* other);

  /// @brief Method get_NodeType addr 0x26dfe6c size 0x8 virtual true final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value addr 0x26dfe74 size 0x8 virtual false final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x26dfe7c size 0xf4 virtual false final false
  inline void set_Value(::StringW value);

  /// @brief Method WriteTo addr 0x26dff70 size 0x74 virtual true final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method CloneNode addr 0x26dffe4 size 0x60 virtual true final false
