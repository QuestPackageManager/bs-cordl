...
public:
  ...
  /// @brief Method .ctor, addr 0x285bd8c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  static inline ::System::Xml::Linq::XComment* New_ctor(::System::Xml::Linq::XComment* other);

  /// @brief Method .ctor, addr 0x285be0c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XComment* other);

  /// @brief Method get_NodeType, addr 0x285be88, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x285be90, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x285be98, size 0xf4, virtual false, abstract: false, final false
  inline void set_Value(::StringW value);

  /// @brief Method WriteTo, addr 0x285bf8c, size 0x74, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method CloneNode, addr 0x285c000, size 0x60, virtual true, abstract: false, final false
