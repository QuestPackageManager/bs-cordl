...
public:
  ...
  /// @brief Method CloneNode, addr 0x2db8048, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteTo, addr 0x2db7fd4, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2db7e54, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XComment* other);

  /// @brief Method .ctor, addr 0x2db7dd4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_NodeType, addr 0x2db7ed0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x2db7ed8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x2db7ee0, size 0xf4, virtual false, abstract: false, final false
