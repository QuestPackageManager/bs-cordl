...
public:
  ...
  /// @brief Method MoveNext, addr 0x42477f8, size 0xa8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Xml::Linq::XElement__GetAttributes_d__116* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Xml.Linq.XAttribute>.GetEnumerator, addr 0x42478e8, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Xml.Linq.XAttribute>.get_Current, addr 0x42478a0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Linq::XAttribute* System_Collections_Generic_IEnumerator_System_Xml_Linq_XAttribute__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x424798c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x42478a8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x42478e0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x42477f4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4246f14, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAttribute, addr 0x4246b98, size 0xe8, virtual true, abstract: false, final false
  inline void AddAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AddAttributeSkipNotify, addr 0x4246db4, size 0x108, virtual true, abstract: false, final false
  inline void AddAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AppendAttribute, addr 0x4246c80, size 0x134, virtual false, abstract: false, final false
  inline void AppendAttribute(::System::Xml::Linq::XAttribute* a);

  /// @brief Method AppendAttributeSkipNotify, addr 0x424533c, size 0x38, virtual false, abstract: false, final false
  inline void AppendAttributeSkipNotify(::System::Xml::Linq::XAttribute* a);

  /// @brief Method Attribute, addr 0x4246598, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XAttribute* Attribute(::System::Xml::Linq::XName* name);

  /// @brief Method Attributes, addr 0x42465d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Xml::Linq::XAttribute*>* Attributes();

  /// @brief Method CloneNode, addr 0x4246ebc, size 0x58, virtual true, abstract: false, final false
  inline ::System::Xml::Linq::XNode* CloneNode();

  /// @brief Method GetAttributes, addr 0x42465dc, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Xml::Linq::XAttribute*>* GetAttributes(::System::Xml::Linq::XName* name);

  /// @brief Method GetNamespaceOfPrefixInScope, addr 0x4246668, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW GetNamespaceOfPrefixInScope(::StringW prefix, ::System::Xml::Linq::XElement* outOfScope);

  /// @brief Method GetPrefixOfNamespace, addr 0x4241958, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadElementFrom, addr 0x4246b14, size 0x78, virtual false, abstract: false, final false
  inline void ReadElementFrom(::System::Xml::XmlReader* r, ::System::Xml::Linq::LoadOptions o);

  /// @brief Method ReadElementFromImpl, addr 0x4246f48, size 0x500, virtual false, abstract: false, final false
  inline void ReadElementFromImpl(::System::Xml::XmlReader* r, ::System::Xml::Linq::LoadOptions o);

  /// @brief Method SetEndElementLineInfo, addr 0x4245560, size 0x70, virtual false, abstract: false, final false
  inline void SetEndElementLineInfo(int32_t lineNumber, int32_t linePosition);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x4246980, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x4246988, size 0x18c, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x4246b8c, size 0xc, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ValidateNode, addr 0x42476c0, size 0x134, virtual true, abstract: false, final false
  inline void ValidateNode(::System::Xml::Linq::XNode* node, ::System::Xml::Linq::XNode* previous);

  /// @brief Method WriteTo, addr 0x424675c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x42452c8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XName* name);

  /// @brief Method .ctor, addr 0x42463a0, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XElement* other);

  /// @brief Method .ctor, addr 0x4243014, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XStreamingElement* other);

  /// @brief Method get_HasAttributes, addr 0x4246460, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasAttributes();

  /// @brief Method get_IsEmpty, addr 0x4246470, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsEmpty();

  /// @brief Method get_Name, addr 0x4246480, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XName* get_Name();

  /// @brief Method get_NodeType, addr 0x4246488, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x4246490, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Value, addr 0x4246524, size 0x74, virtual false, abstract: false, final false
