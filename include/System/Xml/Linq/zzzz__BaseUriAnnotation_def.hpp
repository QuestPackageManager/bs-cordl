...
// Write type traits
MARK_REF_T(::System::Xml::Linq::BaseUriAnnotation*);
DEFINE_IL2CPP_CLASS(::System::Xml::Linq::BaseUriAnnotation*, "System.Xml.Linq", "BaseUriAnnotation");
...
public:
  ...
  /// @brief Method .ctor, addr 0x61a31bc, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BaseUriAnnotation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BaseUriAnnotation(BaseUriAnnotation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BaseUriAnnotation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BaseUriAnnotation(BaseUriAnnotationconst&) = delete;
...
static_assert(sizeof(::System::Xml::Linq::BaseUriAnnotation) == 0x18, "Size mismatch!");
