...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XObjectChangeEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XObjectChangeEventArgs(XObjectChangeEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XObjectChangeEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XObjectChangeEventArgs(XObjectChangeEventArgsconst&) = delete;
