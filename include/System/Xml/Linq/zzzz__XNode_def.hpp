...
public:
  ...
  /// @brief Method AppendText, addr 0x5ff6b98, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetXmlString, addr 0x5ff67c0, size 0x3d8, virtual false, abstract: false, final false
  inline ::StringW GetXmlString(::System::Xml::Linq::SaveOptions o);

  static inline ::System::Xml::Linq::XNode* New_ctor();

  /// @brief Method Remove, addr 0x5ff6674, size 0x5c, virtual false, abstract: false, final false
  inline void Remove();

  /// @brief Method ToString, addr 0x5ff66d0, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fef940, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
