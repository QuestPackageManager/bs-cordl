...
public:
  ...
  /// @brief Method AppendText, addr 0x42525c0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetXmlString, addr 0x4252148, size 0x478, virtual false, abstract: false, final false
  inline ::StringW GetXmlString(::System::Xml::Linq::SaveOptions o);

  static inline ::System::Xml::Linq::XNode* New_ctor();

  /// @brief Method Remove, addr 0x4251fec, size 0x60, virtual false, abstract: false, final false
  inline void Remove();

  /// @brief Method ToString, addr 0x425204c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x424b1b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
