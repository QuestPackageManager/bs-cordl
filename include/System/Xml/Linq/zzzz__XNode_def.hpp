...
public:
  ...
  /// @brief Method AppendText, addr 0x424e0ac, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetXmlString, addr 0x424dc34, size 0x478, virtual false, abstract: false, final false
  inline ::StringW GetXmlString(::System::Xml::Linq::SaveOptions o);

  static inline ::System::Xml::Linq::XNode* New_ctor();

  /// @brief Method Remove, addr 0x424dad8, size 0x60, virtual false, abstract: false, final false
  inline void Remove();

  /// @brief Method ToString, addr 0x424db38, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4246ca0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
