...
public:
  ...
  /// @brief Method AppendText, addr 0x29ac4cc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetXmlString, addr 0x29ac05c, size 0x470, virtual false, abstract: false, final false
  inline ::StringW GetXmlString(::System::Xml::Linq::SaveOptions o);

  static inline ::System::Xml::Linq::XNode* New_ctor();

  /// @brief Method Remove, addr 0x29abefc, size 0x64, virtual false, abstract: false, final false
  inline void Remove();

  /// @brief Method ToString, addr 0x29abf60, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29a7120, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
