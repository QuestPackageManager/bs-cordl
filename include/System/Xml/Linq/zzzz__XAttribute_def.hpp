...
/// @brief Method GetPrefixOfNamespace, addr 0x6063638, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x60632c8, size 0x370, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ValidateAttribute, addr 0x6062d20, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60628c0, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XName*  name, ::System::Object*  value) ;

/// @brief Method .ctor, addr 0x6062f38, size 0x5c, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XAttribute*  other) ;

/// @brief Method get_IsNamespaceDeclaration, addr 0x6062f94, size 0xa0, virtual false, abstract: false, final false
inline bool get_IsNamespaceDeclaration() ;

/// @brief Method get_Name, addr 0x606304c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XName* get_Name() ;

/// @brief Method get_NodeType, addr 0x6063054, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Value, addr 0x606305c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x6063064, size 0x10c, virtual false, abstract: false, final false
