...
public:
  ...
  /// @brief Method .ctor addr 0x26de9cc size 0xbc virtual false final false
  ...
  /// @brief Method .ctor addr 0x26df0cc size 0x7c virtual false final false
  inline void _ctor(::System::Xml::Linq::XAttribute* other);

  /// @brief Method get_IsNamespaceDeclaration addr 0x26df148 size 0x9c virtual false final false
  inline bool get_IsNamespaceDeclaration();

  /// @brief Method get_Name addr 0x26df200 size 0x8 virtual false final false
  inline ::System::Xml::Linq::XName* get_Name();

  /// @brief Method get_NodeType addr 0x26df208 size 0x8 virtual true final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value addr 0x26df210 size 0x8 virtual false final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x26df218 size 0x100 virtual false final false
  inline void set_Value(::StringW value);

  /// @brief Method ToString addr 0x26df468 size 0x3d4 virtual true final false
  inline ::StringW ToString();

  /// @brief Method GetPrefixOfNamespace addr 0x26df83c size 0x138 virtual false final false
  inline ::StringW GetPrefixOfNamespace(::System::Xml::Linq::XNamespace* ns);

  /// @brief Method ValidateAttribute addr 0x26dee9c size 0x230 virtual false final false
