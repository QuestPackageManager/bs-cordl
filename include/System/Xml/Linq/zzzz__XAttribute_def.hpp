...
public:
  ...
  /// @brief Method GetPrefixOfNamespace, addr 0x5fef3f4, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5fef084, size 0x370, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateAttribute, addr 0x5feeadc, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fee67c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XName* name, ::System::Object* value);

  /// @brief Method .ctor, addr 0x5feecf4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XAttribute* other);

  /// @brief Method get_IsNamespaceDeclaration, addr 0x5feed50, size 0xa0, virtual false, abstract: false, final false
  inline bool get_IsNamespaceDeclaration();

  /// @brief Method get_Name, addr 0x5feee08, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XName* get_Name();

  /// @brief Method get_NodeType, addr 0x5feee10, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x5feee18, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x5feee20, size 0x10c, virtual false, abstract: false, final false
