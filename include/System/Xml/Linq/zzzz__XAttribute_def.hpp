...
public:
  ...
  /// @brief Method GetPrefixOfNamespace, addr 0x5f87868, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5f874f8, size 0x370, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateAttribute, addr 0x5f86f50, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f86af0, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XName* name, ::System::Object* value);

  /// @brief Method .ctor, addr 0x5f87168, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XAttribute* other);

  /// @brief Method get_IsNamespaceDeclaration, addr 0x5f871c4, size 0xa0, virtual false, abstract: false, final false
  inline bool get_IsNamespaceDeclaration();

  /// @brief Method get_Name, addr 0x5f8727c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Linq::XName* get_Name();

  /// @brief Method get_NodeType, addr 0x5f87284, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XmlNodeType get_NodeType();

  /// @brief Method get_Value, addr 0x5f8728c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x5f87294, size 0x10c, virtual false, abstract: false, final false
