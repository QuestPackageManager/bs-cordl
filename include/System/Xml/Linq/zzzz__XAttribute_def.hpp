...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XAttribute(XAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XAttribute(XAttributeconst&) = delete;
