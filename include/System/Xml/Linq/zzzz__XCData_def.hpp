...
/// @brief Method CloneNode, addr 0x5feff4c, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method WriteTo, addr 0x5fefee0, size 0x6c, virtual true, abstract: false, final false
inline void WriteTo(::System::Xml::XmlWriter*  writer) ;

/// @brief Method .ctor, addr 0x5fefe78, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XCData*  other) ;

/// @brief Method .ctor, addr 0x5fefe1c, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::StringW  value) ;

/// @brief Method get_NodeType, addr 0x5fefed8, size 0x8, virtual true, abstract: false, final false
