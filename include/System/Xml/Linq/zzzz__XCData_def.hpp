...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XCData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XCData(XCData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XCData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XCData(XCDataconst&) = delete;
