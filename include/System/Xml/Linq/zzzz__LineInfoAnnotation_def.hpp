...
public:
  ...
  /// @brief Method .ctor, addr 0x61a31c4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LineInfoAnnotation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LineInfoAnnotation(LineInfoAnnotation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LineInfoAnnotation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LineInfoAnnotation(LineInfoAnnotationconst&) = delete;
