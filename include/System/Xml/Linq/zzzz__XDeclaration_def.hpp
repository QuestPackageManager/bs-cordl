...
public:
  ...
  /// @brief Method ToString, addr 0x4257d50, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4257ca8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::Linq::XDeclaration* other);

  /// @brief Method .ctor, addr 0x4257c6c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW version, ::StringW encoding, ::StringW standalone);

  /// @brief Method get_Encoding, addr 0x4257d28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Encoding();

  /// @brief Method get_Standalone, addr 0x4257d38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Standalone();

  /// @brief Method get_Version, addr 0x4257d48, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Version();

  /// @brief Method set_Encoding, addr 0x4257d30, size 0x8, virtual false, abstract: false, final false
  inline void set_Encoding(::StringW value);

  /// @brief Method set_Standalone, addr 0x4257d40, size 0x8, virtual false, abstract: false, final false
