...
public:
  ...
  /// @brief Method Pop, addr 0x5ff7f30, size 0x48, virtual false, abstract: false, final false
  inline uint8_t Pop();

  /// @brief Method Push, addr 0x5ff7e54, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ff7dec, size 0x68, virtual false, abstract: false, final false
