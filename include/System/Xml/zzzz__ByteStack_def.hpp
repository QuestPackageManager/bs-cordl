...
public:
  ...
  /// @brief Method Pop, addr 0x2db33c0, size 0x4c, virtual false, abstract: false, final false
  inline uint8_t Pop();

  /// @brief Method Push, addr 0x2db32f0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2db3280, size 0x70, virtual false, abstract: false, final false
