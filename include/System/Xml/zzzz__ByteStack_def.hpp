...
public:
  ...
  /// @brief Method Pop, addr 0x2999c8c, size 0x4c, virtual false, abstract: false, final false
  inline uint8_t Pop();

  /// @brief Method Push, addr 0x2999bbc, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2999b4c, size 0x70, virtual false, abstract: false, final false
