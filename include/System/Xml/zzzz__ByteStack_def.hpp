...
public:
  ...
  /// @brief Method Pop, addr 0x606a5fc, size 0x48, virtual false, abstract: false, final false
  inline uint8_t Pop();

  /// @brief Method Push, addr 0x606a520, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x606a4b8, size 0x68, virtual false, abstract: false, final false
