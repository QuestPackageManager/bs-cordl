...
public:
  ...
  /// @brief Method Pop, addr 0x61aca88, size 0x48, virtual false, abstract: false, final false
  inline uint8_t Pop();

  /// @brief Method Push, addr 0x61ac9ac, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61ac944, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ByteStack", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ByteStack(ByteStack&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ByteStack", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ByteStack(ByteStackconst&) = delete;
