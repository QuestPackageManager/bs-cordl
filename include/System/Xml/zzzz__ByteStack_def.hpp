...
public:
  ...
  /// @brief Method Pop, addr 0x4243b7c, size 0x48, virtual false, abstract: false, final false
  inline uint8_t Pop();

  /// @brief Method Push, addr 0x4243aac, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4243a3c, size 0x70, virtual false, abstract: false, final false
