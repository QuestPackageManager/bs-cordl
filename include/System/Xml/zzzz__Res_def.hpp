...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Res", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Res(Res&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Res", modifiers: "const&", def_value: None, comment: None }]
