...
public:
  ...
  /// @brief Method get_IsFull addr 0x26d1bf0 size 0x10 virtual true final false
  inline bool get_IsFull();

  /// @brief Method Decode addr 0x26d1c00 size 0x158 virtual true final false
  inline int32_t Decode(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t startPos, int32_t len);

  /// @brief Method Decode addr 0x26d1f24 size 0x1e8 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Decode(::ArrayW<char16_t, ::Array<char16_t>*> chars, bool allowOddChars);

  /// @brief Method Decode addr 0x26d1d58 size 0x1cc virtual false final false
