...
public:
  ...
  /// @brief Method Decode, addr 0x618d8d4, size 0x1dc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Decode(::ArrayW<char16_t> chars, bool allowOddChars);

  /// @brief Method Decode, addr 0x618d3d8, size 0x150, virtual true, abstract: false, final false
  inline int32_t Decode(::ArrayW<char16_t> chars, int32_t startPos, int32_t len);

  /// @brief Method Decode, addr 0x618d6d4, size 0x14c, virtual true, abstract: false, final false
  inline int32_t Decode(::StringW str, int32_t startPos, int32_t len);

  /// @brief Method Decode, addr 0x618d528, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x618d820, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SetNextOutputBuffer, addr 0x618d828, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x618dab0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DecodedCount, addr 0x618d3bc, size 0xc, virtual true, abstract: false, final false
  inline int32_t get_DecodedCount();

  /// @brief Method get_IsFull, addr 0x618d3c8, size 0x10, virtual true, abstract: false, final false
