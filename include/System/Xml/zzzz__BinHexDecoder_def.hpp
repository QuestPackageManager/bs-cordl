...
/// @brief Method Decode, addr 0x60527d8, size 0x1dc, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Decode(::ArrayW<char16_t,::Array<char16_t>*>  chars, bool  allowOddChars) ;

/// @brief Method Decode, addr 0x60522dc, size 0x150, virtual true, abstract: false, final false
inline int32_t Decode(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  startPos, int32_t  len) ;

/// @brief Method Decode, addr 0x60525d8, size 0x14c, virtual true, abstract: false, final false
inline int32_t Decode(::StringW  str, int32_t  startPos, int32_t  len) ;

/// @brief Method Decode, addr 0x605242c, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x6052724, size 0x8, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method SetNextOutputBuffer, addr 0x605272c, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60529b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_DecodedCount, addr 0x60522c0, size 0xc, virtual true, abstract: false, final false
inline int32_t get_DecodedCount() ;

/// @brief Method get_IsFull, addr 0x60522cc, size 0x10, virtual true, abstract: false, final false
