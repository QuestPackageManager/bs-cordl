...
/// @brief Method Decode, addr 0x5fdec54, size 0x1dc, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Decode(::ArrayW<char16_t,::Array<char16_t>*>  chars, bool  allowOddChars) ;

/// @brief Method Decode, addr 0x5fde758, size 0x150, virtual true, abstract: false, final false
inline int32_t Decode(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  startPos, int32_t  len) ;

/// @brief Method Decode, addr 0x5fdea54, size 0x14c, virtual true, abstract: false, final false
inline int32_t Decode(::StringW  str, int32_t  startPos, int32_t  len) ;

/// @brief Method Decode, addr 0x5fde8a8, size 0x1ac, virtual false, abstract: false, final false
static inline void Decode(char16_t*  pChars, char16_t*  pCharsEndPos, uint8_t*  pBytes, uint8_t*  pBytesEndPos, ::ByRef<bool>  hasHalfByteCached, ::ByRef<uint8_t>  cachedHalfByte, ::ByRef<int32_t>  charsDecoded, ::ByRef<int32_t>  bytesDecoded) ;

static inline ::System::Xml::BinHexDecoder* New_ctor() ;

/// @brief Method Reset, addr 0x5fdeba0, size 0x8, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method SetNextOutputBuffer, addr 0x5fdeba8, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fdee30, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_DecodedCount, addr 0x5fde73c, size 0xc, virtual true, abstract: false, final false
inline int32_t get_DecodedCount() ;

/// @brief Method get_IsFull, addr 0x5fde748, size 0x10, virtual true, abstract: false, final false
