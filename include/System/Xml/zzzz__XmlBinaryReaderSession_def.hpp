...
/// @brief Field stringDict, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_stringDict, put=__cordl_internal_set_stringDict)) ::System::Collections::Generic::Dictionary_2<int32_t,::System::Xml::XmlDictionaryString*>*  stringDict;
...
/// @brief Method TryLookup, addr 0x5f619ac, size 0xb8, virtual true, abstract: false, final true
