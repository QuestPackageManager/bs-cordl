...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlBinaryReaderSession", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlBinaryReaderSession(XmlBinaryReaderSession&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlBinaryReaderSession", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlBinaryReaderSession(XmlBinaryReaderSessionconst&) = delete;
