...
// Write type traits
MARK_REF_T(::System::Xml::XmlRegisteredNonCachedStream*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlRegisteredNonCachedStream*, "System.Xml", "XmlRegisteredNonCachedStream");
...
public:
  ...
  /// @brief Method BeginRead, addr 0x62dd508, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x62dd528, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x62dd420, size 0xe8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x62dd548, size 0x20, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x62dd568, size 0x20, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Finalize, addr 0x62dd3c8, size 0x58, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x62dd588, size 0x20, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Read, addr 0x62dd5a8, size 0x20, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x62dd5c8, size 0x20, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x62dd5e8, size 0x20, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x62dd608, size 0x20, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x62dd628, size 0x20, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte, addr 0x62dd648, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62dc4a8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Xml::XmlDownloadManager* downloadManager, ::StringW host);

  /// @brief Method get_CanRead, addr 0x62dd668, size 0x1c, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x62dd684, size 0x1c, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x62dd6a0, size 0x1c, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x62dd6bc, size 0x1c, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x62dd6d8, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method set_Position, addr 0x62dd6f8, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlRegisteredNonCachedStream) == 0x40, "Size mismatch!");
