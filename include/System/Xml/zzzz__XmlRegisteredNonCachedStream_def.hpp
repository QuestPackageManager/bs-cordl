...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlRegisteredNonCachedStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlRegisteredNonCachedStream(XmlRegisteredNonCachedStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlRegisteredNonCachedStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlRegisteredNonCachedStream(XmlRegisteredNonCachedStreamconst&) = delete;
