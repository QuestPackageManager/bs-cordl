...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x61204b4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6120370, size 0x144, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OnXmlDictionaryReaderClose", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OnXmlDictionaryReaderClose(OnXmlDictionaryReaderClose&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OnXmlDictionaryReaderClose", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OnXmlDictionaryReaderClose(OnXmlDictionaryReaderCloseconst&) = delete;
