...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x2dbade0, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dba77c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
