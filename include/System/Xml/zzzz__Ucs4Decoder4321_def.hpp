...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x4360764, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43600b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
