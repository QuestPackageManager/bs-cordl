...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x612f500, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x612ee10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
