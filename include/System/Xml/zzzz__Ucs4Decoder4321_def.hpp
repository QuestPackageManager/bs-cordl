...
public:
  // Declarations
  /// @brief Method GetFullChars, addr 0x436dc30, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x436d57c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
