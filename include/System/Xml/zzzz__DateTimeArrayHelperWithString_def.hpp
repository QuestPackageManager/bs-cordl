...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DateTimeArrayHelperWithString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DateTimeArrayHelperWithString(DateTimeArrayHelperWithString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DateTimeArrayHelperWithString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DateTimeArrayHelperWithString(DateTimeArrayHelperWithStringconst&) = delete;
