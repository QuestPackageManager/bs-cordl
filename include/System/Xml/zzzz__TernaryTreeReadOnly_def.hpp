...
public:
  ...
  /// @brief Method FindCaseInsensitiveString, addr 0x606b5cc, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x606ccb0, size 0x8, virtual false, abstract: false, final false
