...
public:
  ...
  /// @brief Method FindCaseInsensitiveString, addr 0x5ff8f00, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ffa5e4, size 0x8, virtual false, abstract: false, final false
