...
public:
  ...
  /// @brief Method FindCaseInsensitiveString, addr 0x430b30c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x430c538, size 0x28, virtual false, abstract: false, final false
