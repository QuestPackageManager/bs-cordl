...
public:
  ...
  /// @brief Method FindCaseInsensitiveString, addr 0x299ac9c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x299c440, size 0x28, virtual false, abstract: false, final false
