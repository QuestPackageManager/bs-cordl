...
public:
  ...
  /// @brief Method MoveNext, addr 0x61a53c8, size 0x3cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x61a5794, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetEntity, addr 0x61a5190, size 0x13c, virtual true, abstract: false, final false
  inline ::System::Object* GetEntity(::System::Uri* absoluteUri, ::StringW role, ::System::Type* ofObjectToReturn);

  /// @brief Method GetEntityAsync, addr 0x61a52d0, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveUri, addr 0x61a52cc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a518c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Object* getStaticF_s_DownloadManager();

  /// @brief Method get_DownloadManager, addr 0x61a50c0, size 0xcc, virtual false, abstract: false, final false
