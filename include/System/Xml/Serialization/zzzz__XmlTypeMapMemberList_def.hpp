...
public:
  ...
  /// @brief Method .ctor, addr 0x6313110, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTypeMapMemberList(XmlTypeMapMemberList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTypeMapMemberList(XmlTypeMapMemberListconst&) = delete;
