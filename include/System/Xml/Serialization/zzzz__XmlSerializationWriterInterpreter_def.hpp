...
public:
  ...
  /// @brief Method WriteEnum, addr 0x61ce77c, size 0x50, virtual false, abstract: false, final false
  inline void WriteEnum(::System::Object* ob);

  /// @brief Method WriteObject, addr 0x61ce72c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61c849c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetEnumXmlValue, addr 0x61ce2f0, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW GetEnumXmlValue(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method GetListCount, addr 0x61cd45c, size 0x11c, virtual false, abstract: false, final false
  inline int32_t GetListCount(::System::Xml::Serialization::TypeData* listType, ::System::Object* ob);

  /// @brief Method GetMemberValue, addr 0x61ca8b0, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Object* GetMemberValue(::System::Xml::Serialization::XmlTypeMapMember* member, ::System::Object* ob, bool isValueList);

  /// @brief Method GetStringValue, addr 0x61cad90, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplicitConvert, addr 0x61c8ea4, size 0x2ac, virtual false, abstract: false, final false
  static inline ::System::Object* ImplicitConvert(::System::Object* obj, ::System::Type* type);

  /// @brief Method InitCallbacks, addr 0x61c80b8, size 0x3e4, virtual true, abstract: false, final false
  inline void InitCallbacks();

  /// @brief Method MemberHasValue, addr 0x61ca684, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteAnyElementContent, addr 0x61cbda8, size 0x608, virtual false, abstract: false, final false
  inline void WriteAnyElementContent(::System::Xml::Serialization::XmlTypeMapMemberAnyElement* member, ::System::Object* memberValue);

  /// @brief Method WriteAttributeMembers, addr 0x61c9804, size 0x6e0, virtual false, abstract: false, final false
  inline void WriteAttributeMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteElementMembers, addr 0x61c9f8c, size 0x6f8, virtual false, abstract: false, final false
  inline void WriteElementMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteEnumElement, addr 0x61ce2c0, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteListContent, addr 0x61cb5f4, size 0x7b4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteListElement, addr 0x61cd278, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteMemberElement, addr 0x61cb050, size 0x5a4, virtual false, abstract: false, final false
  inline void WriteMemberElement(::System::Xml::Serialization::XmlTypeMapElementInfo* elem, ::System::Object* memberValue);

  /// @brief Method WriteMembers, addr 0x61c94c8, size 0x40, virtual false, abstract: false, final false
  inline void WriteMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteMessage, addr 0x61c92bc, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObject, addr 0x61c86ac, size 0x7f8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObjectElement, addr 0x61c9508, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObjectElementAttributes, addr 0x61c975c, size 0xa8, virtual true, abstract: false, final false
  inline void WriteObjectElementAttributes(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method WriteObjectElementElements, addr 0x61c9ee4, size 0xa8, virtual true, abstract: false, final false
  inline void WriteObjectElementElements(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method WritePrimitiveElement, addr 0x61ce284, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method WritePrimitiveValueEncoded, addr 0x61ccfb4, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePrimitiveValueLiteral, addr 0x61ccc6c, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteRoot, addr 0x61c84a4, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61c8080, size 0x38, virtual false, abstract: false, final false
