...
public:
  ...
  /// @brief Method WriteEnum, addr 0x438c470, size 0x50, virtual false, abstract: false, final false
  inline void WriteEnum(::System::Object* ob);

  /// @brief Method WriteObject, addr 0x438c420, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4385f40, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetEnumXmlValue, addr 0x438bfe8, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW GetEnumXmlValue(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method GetListCount, addr 0x438b0b8, size 0x128, virtual false, abstract: false, final false
  inline int32_t GetListCount(::System::Xml::Serialization::TypeData* listType, ::System::Object* ob);

  /// @brief Method GetMemberValue, addr 0x43884bc, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Object* GetMemberValue(::System::Xml::Serialization::XmlTypeMapMember* member, ::System::Object* ob, bool isValueList);

  /// @brief Method GetStringValue, addr 0x4388998, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplicitConvert, addr 0x4386988, size 0x2d8, virtual false, abstract: false, final false
  static inline ::System::Object* ImplicitConvert(::System::Object* obj, ::System::Type* type);

  /// @brief Method InitCallbacks, addr 0x4385b24, size 0x41c, virtual true, abstract: false, final false
  inline void InitCallbacks();

  /// @brief Method MemberHasValue, addr 0x4388294, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteAnyElementContent, addr 0x43899b4, size 0x658, virtual false, abstract: false, final false
  inline void WriteAnyElementContent(::System::Xml::Serialization::XmlTypeMapMemberAnyElement* member, ::System::Object* memberValue);

  /// @brief Method WriteAttributeMembers, addr 0x4387334, size 0x760, virtual false, abstract: false, final false
  inline void WriteAttributeMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteElementMembers, addr 0x4387b38, size 0x75c, virtual false, abstract: false, final false
  inline void WriteElementMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteEnumElement, addr 0x438bfb8, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteListContent, addr 0x43891b8, size 0x7fc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteListElement, addr 0x438aed0, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteMemberElement, addr 0x4388c44, size 0x574, virtual false, abstract: false, final false
  inline void WriteMemberElement(::System::Xml::Serialization::XmlTypeMapElementInfo* elem, ::System::Object* memberValue);

  /// @brief Method WriteMembers, addr 0x4387014, size 0x44, virtual false, abstract: false, final false
  inline void WriteMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method WriteMessage, addr 0x4386e24, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObject, addr 0x4386180, size 0x808, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObjectElement, addr 0x4387058, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteObjectElementAttributes, addr 0x4387290, size 0xa4, virtual true, abstract: false, final false
  inline void WriteObjectElementAttributes(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method WriteObjectElementElements, addr 0x4387a94, size 0xa4, virtual true, abstract: false, final false
  inline void WriteObjectElementElements(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method WritePrimitiveElement, addr 0x438bf7c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method WritePrimitiveValueEncoded, addr 0x438ac54, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePrimitiveValueLiteral, addr 0x438a94c, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteRoot, addr 0x4385f6c, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4385aec, size 0x38, virtual false, abstract: false, final false
