...
public:
  ...
  /// @brief Method GetRealElementMap, addr 0x438b8e8, size 0x3c4, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* GetRealElementMap(::StringW name, ::StringW ens);

  /// @brief Method GetRealTypeMap, addr 0x438370c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateRoot, addr 0x438bcac, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x438b7bc, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseMap, addr 0x438b8a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* get_BaseMap();

  /// @brief Method get_DerivedTypes, addr 0x438b894, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_DerivedTypes();

  /// @brief Method get_HasXmlTypeNamespace, addr 0x438b884, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasXmlTypeNamespace();

  /// @brief Method get_IsAny, addr 0x438b8d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAny();

  /// @brief Method get_IsNullable, addr 0x438b8c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_MultiReferenceType, addr 0x438b89c, size 0x8, virtual false, abstract: false, final false
  inline bool get_MultiReferenceType();

  /// @brief Method get_TypeData, addr 0x438b864, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_TypeData();

  /// @brief Method get_TypeFullName, addr 0x4388b3c, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_TypeFullName();

  /// @brief Method get_XmlType, addr 0x438b86c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlType();

  /// @brief Method get_XmlTypeNamespace, addr 0x438387c, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_XmlTypeNamespace();

  /// @brief Method set_BaseMap, addr 0x438b8ac, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseMap(::System::Xml::Serialization::XmlTypeMapping* value);

  /// @brief Method set_IncludeInSchema, addr 0x438b8b4, size 0xc, virtual false, abstract: false, final false
  inline void set_IncludeInSchema(bool value);

  /// @brief Method set_IsAny, addr 0x438b8dc, size 0xc, virtual false, abstract: false, final false
  inline void set_IsAny(bool value);

  /// @brief Method set_IsNullable, addr 0x438b8c8, size 0xc, virtual false, abstract: false, final false
  inline void set_IsNullable(bool value);

  /// @brief Method set_XmlType, addr 0x438b874, size 0x8, virtual false, abstract: false, final false
  inline void set_XmlType(::StringW value);

  /// @brief Method set_XmlTypeNamespace, addr 0x438b87c, size 0x8, virtual false, abstract: false, final false
