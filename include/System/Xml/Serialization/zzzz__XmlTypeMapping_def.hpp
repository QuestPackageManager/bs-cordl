...
public:
  ...
  /// @brief Method GetRealElementMap, addr 0x61d10a4, size 0x344, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* GetRealElementMap(::StringW name, ::StringW ens);

  /// @brief Method GetRealTypeMap, addr 0x61c9150, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateRoot, addr 0x61d13e8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61d0f90, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseMap, addr 0x61d106c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* get_BaseMap();

  /// @brief Method get_DerivedTypes, addr 0x61d105c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_DerivedTypes();

  /// @brief Method get_HasXmlTypeNamespace, addr 0x61d104c, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasXmlTypeNamespace();

  /// @brief Method get_IsAny, addr 0x61d1094, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAny();

  /// @brief Method get_IsNullable, addr 0x61d1084, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_MultiReferenceType, addr 0x61d1064, size 0x8, virtual false, abstract: false, final false
  inline bool get_MultiReferenceType();

  /// @brief Method get_TypeData, addr 0x61d102c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_TypeData();

  /// @brief Method get_TypeFullName, addr 0x61ce3a8, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_TypeFullName();

  /// @brief Method get_XmlType, addr 0x61d1034, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlType();

  /// @brief Method get_XmlTypeNamespace, addr 0x61c929c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_XmlTypeNamespace();

  /// @brief Method set_BaseMap, addr 0x61d1074, size 0x8, virtual false, abstract: false, final false
  inline void set_BaseMap(::System::Xml::Serialization::XmlTypeMapping* value);

  /// @brief Method set_IncludeInSchema, addr 0x61d107c, size 0x8, virtual false, abstract: false, final false
  inline void set_IncludeInSchema(bool value);

  /// @brief Method set_IsAny, addr 0x61d109c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsAny(bool value);

  /// @brief Method set_IsNullable, addr 0x61d108c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsNullable(bool value);

  /// @brief Method set_XmlType, addr 0x61d103c, size 0x8, virtual false, abstract: false, final false
  inline void set_XmlType(::StringW value);

  /// @brief Method set_XmlTypeNamespace, addr 0x61d1044, size 0x8, virtual false, abstract: false, final false
