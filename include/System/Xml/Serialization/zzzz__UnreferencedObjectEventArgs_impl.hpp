...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Serialization::UnreferencedObjectEventArgs::*)(::System::Object*, ::StringW)>(
  ...
  constexpr static std::size_t addrs = 0x42f0b80;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> const& System::Xml::Serialization::UnreferencedObjectEventArgs::__cordl_internal_get_o() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___o;
}
