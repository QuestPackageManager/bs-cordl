...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Xml::Serialization::XmlMembersMapping::*)()>(&::System::Xml::Serialization::XmlMembersMapping::get_Count)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x614203c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Xml::Serialization::XmlMembersMapping*>::get(),
                        "get_Count",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::System::Xml::Serialization::XmlMembersMapping::*)()>(&::System::Xml::Serialization::XmlMembersMapping::get_HasWrapperElement)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6142054;
...
constexpr ::ArrayW<::System::Xml::Serialization::XmlMemberMapping*,::Array<::System::Xml::Serialization::XmlMemberMapping*>*>& System::Xml::Serialization::XmlMembersMapping::__cordl_internal_get__mapping()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____mapping;
}
constexpr ::ArrayW<::System::Xml::Serialization::XmlMemberMapping*,::Array<::System::Xml::Serialization::XmlMemberMapping*>*> const& System::Xml::Serialization::XmlMembersMapping::__cordl_internal_get__mapping() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____mapping;
}
constexpr void System::Xml::Serialization::XmlMembersMapping::__cordl_internal_set__mapping(::ArrayW<::System::Xml::Serialization::XmlMemberMapping*,::Array<::System::Xml::Serialization::XmlMemberMapping*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
