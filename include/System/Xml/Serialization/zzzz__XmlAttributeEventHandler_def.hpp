...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x43676e4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43675e0, size 0x104, virtual false, abstract: false, final false
