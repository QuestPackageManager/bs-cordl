...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlAttributeEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlAttributeEventHandler(XmlAttributeEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlAttributeEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlAttributeEventHandler(XmlAttributeEventHandlerconst&) = delete;
