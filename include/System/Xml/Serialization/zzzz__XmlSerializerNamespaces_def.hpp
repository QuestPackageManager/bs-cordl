...
public:
  ...
  /// @brief Method Add, addr 0x6136164, size 0xb4, virtual false, abstract: false, final false
  inline void Add(::StringW prefix, ::StringW ns);

  /// @brief Method AddInternal, addr 0x6136218, size 0x3c, virtual false, abstract: false, final false
  inline void AddInternal(::StringW prefix, ::StringW ns);

  static inline ::System::Xml::Serialization::XmlSerializerNamespaces* New_ctor();

  /// @brief Method ToArray, addr 0x61362c0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6136160, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x61367bc, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_NamespaceList, addr 0x61363b8, size 0x404, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_NamespaceList();

  /// @brief Method get_Namespaces, addr 0x6136254, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* get_Namespaces();

  /// @brief Method set_Namespaces, addr 0x61367e0, size 0x8, virtual false, abstract: false, final false
