...
public:
  ...
  /// @brief Method CreateSerializer, addr 0x438ee64, size 0x14, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializer* CreateSerializer(::System::Type* type);

  /// @brief Method CreateSerializer, addr 0x438ee78, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSerializer, addr 0x438f0e4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x438ee5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
