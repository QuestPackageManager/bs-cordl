...
public:
  ...
  /// @brief Method CreateSerializer, addr 0x439c3a8, size 0x14, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializer* CreateSerializer(::System::Type* type);

  /// @brief Method CreateSerializer, addr 0x439c3bc, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSerializer, addr 0x439c628, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x439c3a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
