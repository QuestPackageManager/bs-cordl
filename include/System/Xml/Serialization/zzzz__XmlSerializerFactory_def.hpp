...
public:
  ...
  /// @brief Method CreateSerializer, addr 0x615d170, size 0x14, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlSerializer* CreateSerializer(::System::Type* type);

  /// @brief Method CreateSerializer, addr 0x615d184, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSerializer, addr 0x615d3fc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615d16c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
