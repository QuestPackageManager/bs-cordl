...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlReflectionMember", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlReflectionMember(XmlReflectionMember&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlReflectionMember", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlReflectionMember(XmlReflectionMemberconst&) = delete;
