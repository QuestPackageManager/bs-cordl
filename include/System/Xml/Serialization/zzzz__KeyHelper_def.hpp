...
public:
  // Declarations
  /// @brief Method AddField, addr 0x61a9620, size 0x8, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, ::StringW val);

  /// @brief Method AddField, addr 0x61a9628, size 0xf4, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, ::StringW val, ::StringW def);

  /// @brief Method AddField, addr 0x61a9850, size 0xdc, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, ::System::Type* val);

  /// @brief Method AddField, addr 0x61a971c, size 0x8, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, bool val);

  /// @brief Method AddField, addr 0x61a9724, size 0x58, virtual false, abstract: false, final false
  static inline void AddField(::System::Text::StringBuilder* sb, int32_t n, bool val, bool def);

  /// @brief Method AddField, addr 0x61a977c, size 0xd4, virtual false, abstract: false, final false
