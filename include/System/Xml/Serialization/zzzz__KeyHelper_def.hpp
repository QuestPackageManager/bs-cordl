...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyHelper(KeyHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyHelper(KeyHelperconst&) = delete;
