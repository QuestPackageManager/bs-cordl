...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializerImplementation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSerializerImplementation(XmlSerializerImplementation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializerImplementation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSerializerImplementation(XmlSerializerImplementationconst&) = delete;
