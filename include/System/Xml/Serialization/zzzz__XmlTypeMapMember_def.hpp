...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMember", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTypeMapMember(XmlTypeMapMember&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMember", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTypeMapMember(XmlTypeMapMemberconst&) = delete;
