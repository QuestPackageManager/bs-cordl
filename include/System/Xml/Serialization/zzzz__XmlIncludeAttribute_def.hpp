...
// [AttributeUsage((System.AttributeTargets)1100, AllowMultiple = true)]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlIncludeAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlIncludeAttribute(XmlIncludeAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlIncludeAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlIncludeAttribute(XmlIncludeAttributeconst&) = delete;
