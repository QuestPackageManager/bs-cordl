...
public:
  ...
  /// @brief Method Add, addr 0x61aff4c, size 0xb4, virtual false, abstract: false, final false
  inline int32_t Add(::System::Xml::Serialization::XmlAnyElementAttribute* attribute);

  /// @brief Method AddKeyHash, addr 0x61b0000, size 0xe8, virtual false, abstract: false, final false
  inline void AddKeyHash(::System::Text::StringBuilder* sb);

  static inline ::System::Xml::Serialization::XmlAnyElementAttributes* New_ctor();

  /// @brief Method .ctor, addr 0x61b03a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x61afe4c, size 0x100, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAnyElementAttribute* get_Item(int32_t index);

  /// @brief Method get_Order, addr 0x61b00e8, size 0x2b8, virtual false, abstract: false, final false
