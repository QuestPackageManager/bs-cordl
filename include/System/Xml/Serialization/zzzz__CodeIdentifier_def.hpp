...
public:
  ...
  /// @brief Method IsValid, addr 0x4362238, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsValid(char16_t c);

  /// @brief Method IsValidStart, addr 0x43622b4, size 0x64, virtual false, abstract: false, final false
  static inline bool IsValidStart(char16_t c);

  /// @brief Method MakePascal, addr 0x4361f04, size 0x1b0, virtual false, abstract: false, final false
  static inline ::StringW MakePascal(::StringW identifier);

  /// @brief Method MakeValid, addr 0x43620b4, size 0x184, virtual false, abstract: false, final false
