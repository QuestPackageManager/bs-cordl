...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CodeIdentifier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CodeIdentifier(CodeIdentifier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CodeIdentifier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CodeIdentifier(CodeIdentifierconst&) = delete;
