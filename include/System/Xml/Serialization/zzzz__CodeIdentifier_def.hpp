...
public:
  ...
  /// @brief Method IsValid, addr 0x613606c, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsValid(char16_t c);

  /// @brief Method IsValidStart, addr 0x61360b8, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsValidStart(char16_t c);

  /// @brief Method MakePascal, addr 0x6135d54, size 0x1a0, virtual false, abstract: false, final false
  static inline ::StringW MakePascal(::StringW identifier);

  /// @brief Method MakeValid, addr 0x6135ef4, size 0x178, virtual false, abstract: false, final false
