...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializationReadCallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSerializationReadCallback(XmlSerializationReadCallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializationReadCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSerializationReadCallback(XmlSerializationReadCallbackconst&) = delete;
