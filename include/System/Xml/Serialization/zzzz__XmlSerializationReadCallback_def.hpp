...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x61487a4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x614873c, size 0x68, virtual false, abstract: false, final false
