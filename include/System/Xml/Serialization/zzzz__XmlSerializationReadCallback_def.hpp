...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x60e0c18, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60e0bb0, size 0x68, virtual false, abstract: false, final false
