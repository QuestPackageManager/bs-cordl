...
public:
// Declarations
/// @brief Method Invoke, addr 0x6148e64, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6148dfc, size 0x68, virtual false, abstract: false, final false
