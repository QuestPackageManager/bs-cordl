...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x43788d4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x437884c, size 0x88, virtual false, abstract: false, final false
