...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x43175c0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4317538, size 0x88, virtual false, abstract: false, final false
