...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializationGeneratedCode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSerializationGeneratedCode(XmlSerializationGeneratedCode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializationGeneratedCode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSerializationGeneratedCode(XmlSerializationGeneratedCodeconst&) = delete;
