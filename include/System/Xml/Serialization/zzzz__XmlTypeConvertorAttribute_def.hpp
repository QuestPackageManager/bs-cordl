...
public:
  ...
  /// @brief Method .ctor, addr 0x61aa92c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW method);

  /// @brief Method get_Method, addr 0x61aa91c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method set_Method, addr 0x61aa924, size 0x8, virtual false, abstract: false, final false
