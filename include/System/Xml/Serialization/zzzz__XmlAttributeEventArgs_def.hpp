...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlAttribute*> const& __cordl_internal_get_attr() const;
  ...
  /// @brief Method .ctor, addr 0x2dc2344, size 0x94, virtual false, abstract: false, final false
