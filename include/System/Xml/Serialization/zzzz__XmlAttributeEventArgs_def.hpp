...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlAttributeEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlAttributeEventArgs*, "System.Xml.Serialization", "XmlAttributeEventArgs");
...
public:
  ...
  /// @brief Method .ctor, addr 0x62eb49c, size 0x8c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlAttributeEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlAttributeEventArgs(XmlAttributeEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlAttributeEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlAttributeEventArgs(XmlAttributeEventArgsconst&) = delete;
...
static_assert(sizeof(::System::Xml::Serialization::XmlAttributeEventArgs) == 0x30, "Size mismatch!");
