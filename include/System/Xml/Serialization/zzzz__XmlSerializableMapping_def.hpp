...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializableMapping", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSerializableMapping(XmlSerializableMapping&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializableMapping", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSerializableMapping(XmlSerializableMappingconst&) = delete;
