...
/// @brief Field empty_modifiers, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_empty_modifiers, put=setStaticF_empty_modifiers)) ::ArrayW<::System::Reflection::ParameterModifier,::Array<::System::Reflection::ParameterModifier>*>  empty_modifiers;

/// @brief Method CheckSerializableType, addr 0x61ab8bc, size 0x2d0, virtual false, abstract: false, final false
static inline void CheckSerializableType(::System::Type*  type, bool  allowPrivateConstructors) ;

/// @brief Method GetRegisteredClrType, addr 0x61ab780, size 0x13c, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* GetRegisteredClrType(::System::Type*  type, ::StringW  ns) ;

/// @brief Method GetRegisteredSchemaType, addr 0x61ab574, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method RegisterClrType, addr 0x61ab650, size 0x130, virtual false, abstract: false, final false
inline void RegisterClrType(::System::Xml::Serialization::XmlTypeMapping*  map, ::System::Type*  type, ::StringW  ns) ;

/// @brief Method RegisterSchemaType, addr 0x61ab4a4, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61abbfc, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
