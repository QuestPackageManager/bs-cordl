...
public:
  ...
  /// @brief Method CheckSerializableType, addr 0x6137678, size 0x2d0, virtual false, abstract: false, final false
  static inline void CheckSerializableType(::System::Type* type, bool allowPrivateConstructors);

  /// @brief Method GetRegisteredClrType, addr 0x613753c, size 0x13c, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapping* GetRegisteredClrType(::System::Type* type, ::StringW ns);

  /// @brief Method GetRegisteredSchemaType, addr 0x6137330, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterClrType, addr 0x613740c, size 0x130, virtual false, abstract: false, final false
  inline void RegisterClrType(::System::Xml::Serialization::XmlTypeMapping* map, ::System::Type* type, ::StringW ns);

  /// @brief Method RegisterSchemaType, addr 0x6137260, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61379b8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
