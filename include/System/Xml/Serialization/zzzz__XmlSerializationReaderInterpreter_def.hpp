...
public:
  ...
  /// @brief Method FixupMembers, addr 0x43826a8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4381574, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ReadObject, addr 0x43826d0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x437d384, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddListValue, addr 0x4381068, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyEnumerableList, addr 0x4382194, size 0x438, virtual false, abstract: false, final false
  inline void CopyEnumerableList(::System::Object* source, ::System::Object* dest);

  /// @brief Method CreateInstance, addr 0x437db20, size 0x64, virtual false, abstract: false, final false
  inline ::System::Object* CreateInstance(::System::Type* type);

  /// @brief Method CreateInstance, addr 0x4380c24, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Object* CreateInstance(::System::Type* type, bool nonPublic);

  /// @brief Method CreateList, addr 0x43815b0, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Object* CreateList(::System::Type* listType);

  /// @brief Method FillList, addr 0x4382184, size 0x10, virtual false, abstract: false, final false
  inline void FillList(::System::Object* list, ::System::Object* items);

  /// @brief Method FixupMembers, addr 0x43818a4, size 0x400, virtual false, abstract: false, final false
  inline void FixupMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* obfixup, bool isValueList);

  /// @brief Method GetEnumValue, addr 0x4382054, size 0x130, virtual false, abstract: false, final false
  inline ::System::Object* GetEnumValue(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::StringW val);

  /// @brief Method GetMemberValue, addr 0x4380f9c, size 0xcc, virtual false, abstract: false, final false
  inline ::System::Object* GetMemberValue(::System::Xml::Serialization::XmlTypeMapMember* member, ::System::Object* ob, bool isValueList);

  /// @brief Method GetValueFromXmlString, addr 0x4380cd8, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method InitCallbacks, addr 0x437cfac, size 0x3d8, virtual true, abstract: false, final false
  inline void InitCallbacks();

  /// @brief Method InitIDs, addr 0x437d3b0, size 0x4, virtual true, abstract: false, final false
  inline void InitIDs();

  /// @brief Method InitializeList, addr 0x43814e8, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Object* InitializeList(::System::Xml::Serialization::TypeData* listType);

  /// @brief Method IsReadOnly, addr 0x4381484, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessUnknownAttribute, addr 0x4381ca4, size 0x34, virtual true, abstract: false, final false
  inline void ProcessUnknownAttribute(::System::Object* target);

  /// @brief Method ProcessUnknownElement, addr 0x4381cd8, size 0x34, virtual true, abstract: false, final false
  inline void ProcessUnknownElement(::System::Object* target);

  /// @brief Method ReadAttributeMembers, addr 0x437dc44, size 0x3fc, virtual false, abstract: false, final false
  inline void ReadAttributeMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method ReadClassInstance, addr 0x4380948, size 0x2dc, virtual true, abstract: false, final false
  inline ::System::Object* ReadClassInstance(::System::Xml::Serialization::XmlTypeMapping* typeMap, bool isNullable, bool checkType);

  /// @brief Method ReadClassInstanceMembers, addr 0x4380c30, size 0xa8, virtual true, abstract: false, final false
  inline void ReadClassInstanceMembers(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::System::Object* ob);

  /// @brief Method ReadEncodedObject, addr 0x437d594, size 0x104, virtual false, abstract: false, final false
  inline ::System::Object* ReadEncodedObject(::System::Xml::Serialization::XmlTypeMapping* typeMap);

  /// @brief Method ReadEnumElement, addr 0x4380744, size 0x70, virtual false, abstract: false, final false
  inline ::System::Object* ReadEnumElement(::System::Xml::Serialization::XmlTypeMapping* typeMap, bool isNullable);

  /// @brief Method ReadListElement, addr 0x43802dc, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadListString, addr 0x4381e24, size 0x230, virtual false, abstract: false, final false
  inline ::System::Object* ReadListString(::System::Xml::Serialization::XmlTypeMapping* typeMap, ::StringW values);

  /// @brief Method ReadMembers, addr 0x437e040, size 0x219c, virtual false, abstract: false, final false
  inline void ReadMembers(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList, bool readBySoapOrder);

  /// @brief Method ReadMessage, addr 0x437d698, size 0x488, virtual true, abstract: false, final false
  inline ::System::Object* ReadMessage(::System::Xml::Serialization::XmlMembersMapping* typeMap);

  /// @brief Method ReadObject, addr 0x43801f8, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Object* ReadObject(::System::Xml::Serialization::XmlTypeMapping* typeMap, bool isNullable, bool checkType);

  /// @brief Method ReadObjectElement, addr 0x438164c, size 0x198, virtual false, abstract: false, final false
  inline ::System::Object* ReadObjectElement(::System::Xml::Serialization::XmlTypeMapElementInfo* elem);

  /// @brief Method ReadPrimitiveElement, addr 0x438068c, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Object* ReadPrimitiveElement(::System::Xml::Serialization::XmlTypeMapping* typeMap, bool isNullable);

  /// @brief Method ReadPrimitiveValue, addr 0x4381d0c, size 0x118, virtual false, abstract: false, final false
  inline ::System::Object* ReadPrimitiveValue(::System::Xml::Serialization::XmlTypeMapElementInfo* elem);

  /// @brief Method ReadRoot, addr 0x437d3b4, size 0x108, virtual false, abstract: false, final false
  inline ::System::Object* ReadRoot();

  /// @brief Method ReadRoot, addr 0x437d4bc, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Object* ReadRoot(::System::Xml::Serialization::XmlTypeMapping* rootMap);

  /// @brief Method ReadXmlNode, addr 0x43817e4, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Object* ReadXmlNode(::System::Xml::Serialization::TypeData* type, bool wrapped);

  /// @brief Method ReadXmlNodeElement, addr 0x43801dc, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* ReadXmlNodeElement(::System::Xml::Serialization::XmlTypeMapping* typeMap, bool isNullable);

  /// @brief Method ReadXmlSerializableElement, addr 0x43807b4, size 0x194, virtual false, abstract: false, final false
  inline ::System::Object* ReadXmlSerializableElement(::System::Xml::Serialization::XmlTypeMapping* typeMap, bool isNullable);

  /// @brief Method SetListMembersDefaults, addr 0x438133c, size 0x148, virtual false, abstract: false, final false
  inline void SetListMembersDefaults(::System::Xml::Serialization::ClassMap* map, ::System::Object* ob, bool isValueList);

  /// @brief Method SetMemberValue, addr 0x4380e10, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMemberValueFromAttr, addr 0x437db84, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x437cf74, size 0x38, virtual false, abstract: false, final false
