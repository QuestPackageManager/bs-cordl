...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x437bed4, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ElementName, addr 0x437be60, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_Form, addr 0x437beb4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_IsNullable, addr 0x437bebc, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_Namespace, addr 0x437bec4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_Order, addr 0x437becc, size 0x8, virtual false, abstract: false, final false
