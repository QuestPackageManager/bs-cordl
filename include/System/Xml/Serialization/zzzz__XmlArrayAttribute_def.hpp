...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlArrayAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlArrayAttribute(XmlArrayAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlArrayAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlArrayAttribute(XmlArrayAttributeconst&) = delete;
