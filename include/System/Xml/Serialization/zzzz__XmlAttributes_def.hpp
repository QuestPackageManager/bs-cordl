...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x613e5d8, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x613e8b8, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x613e9ac, size 0x650, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::ICustomAttributeProvider* provider);

  /// @brief Method get_Order, addr 0x613f064, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_Order();

  /// @brief Method get_SortableOrder, addr 0x613f13c, size 0x88, virtual false, abstract: false, final false
  inline int32_t get_SortableOrder();

  /// @brief Method get_XmlAnyAttribute, addr 0x613effc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAnyAttributeAttribute* get_XmlAnyAttribute();

  /// @brief Method get_XmlAnyElements, addr 0x613f004, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAnyElementAttributes* get_XmlAnyElements();

  /// @brief Method get_XmlArray, addr 0x613f00c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlArrayAttribute* get_XmlArray();

  /// @brief Method get_XmlArrayItems, addr 0x613f014, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlArrayItemAttributes* get_XmlArrayItems();

  /// @brief Method get_XmlAttribute, addr 0x613f01c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlAttributeAttribute* get_XmlAttribute();

  /// @brief Method get_XmlChoiceIdentifier, addr 0x613f024, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlChoiceIdentifierAttribute* get_XmlChoiceIdentifier();

  /// @brief Method get_XmlDefaultValue, addr 0x613f02c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_XmlDefaultValue();

  /// @brief Method get_XmlElements, addr 0x613f034, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlElementAttributes* get_XmlElements();

  /// @brief Method get_XmlIgnore, addr 0x613f03c, size 0x8, virtual false, abstract: false, final false
  inline bool get_XmlIgnore();

  /// @brief Method get_XmlRoot, addr 0x613f04c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlRootAttribute* get_XmlRoot();

  /// @brief Method get_XmlText, addr 0x613f054, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTextAttribute* get_XmlText();

  /// @brief Method get_XmlType, addr 0x613f05c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeAttribute* get_XmlType();

  /// @brief Method get_Xmlns, addr 0x613f044, size 0x8, virtual false, abstract: false, final false
