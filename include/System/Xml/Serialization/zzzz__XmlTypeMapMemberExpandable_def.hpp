...
public:
  ...
  /// @brief Method .ctor, addr 0x61d0c98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_FlatArrayIndex, addr 0x61d0c88, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_FlatArrayIndex();

  /// @brief Method set_FlatArrayIndex, addr 0x61d0c90, size 0x8, virtual false, abstract: false, final false
