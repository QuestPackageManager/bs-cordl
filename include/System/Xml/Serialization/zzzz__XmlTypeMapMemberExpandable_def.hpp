...
public:
  ...
  /// @brief Method .ctor, addr 0x6313124, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_FlatArrayIndex, addr 0x6313114, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_FlatArrayIndex();

  /// @brief Method set_FlatArrayIndex, addr 0x631311c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberExpandable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTypeMapMemberExpandable(XmlTypeMapMemberExpandable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberExpandable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTypeMapMemberExpandable(XmlTypeMapMemberExpandableconst&) = delete;
