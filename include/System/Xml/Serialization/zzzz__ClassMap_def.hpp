...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClassMap", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClassMap(ClassMap&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClassMap", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClassMap(ClassMapconst&) = delete;
