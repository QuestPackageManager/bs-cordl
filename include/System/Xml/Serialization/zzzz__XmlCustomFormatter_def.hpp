...
/// @brief Method FromEnum, addr 0x613f928, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method FromXmlNCName, addr 0x613fbfc, size 0x5c, virtual false, abstract: false, final false
static inline ::StringW FromXmlNCName(::StringW  ncName) ;

/// @brief Method FromXmlName, addr 0x613fba0, size 0x5c, virtual false, abstract: false, final false
static inline ::StringW FromXmlName(::StringW  name) ;

/// @brief Method FromXmlString, addr 0x6140938, size 0xa98, virtual false, abstract: false, final false
static inline ::System::Object* FromXmlString(::System::Xml::Serialization::TypeData*  type, ::StringW  value) ;

/// @brief Method ToXmlString, addr 0x613fc58, size 0xce0, virtual false, abstract: false, final false
