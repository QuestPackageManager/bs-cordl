...
public:
  ...
  /// @brief Method FromEnum, addr 0x61b1934, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method FromXmlNCName, addr 0x61b1c08, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW FromXmlNCName(::StringW ncName);

  /// @brief Method FromXmlName, addr 0x61b1bac, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW FromXmlName(::StringW name);

  /// @brief Method FromXmlString, addr 0x61b2944, size 0xa98, virtual false, abstract: false, final false
  static inline ::System::Object* FromXmlString(::System::Xml::Serialization::TypeData* type, ::StringW value);

  /// @brief Method ToXmlString, addr 0x61b1c64, size 0xce0, virtual false, abstract: false, final false
