...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x62f5d30, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62f5ca4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName);

  /// @brief Method .ctor, addr 0x62f5cb4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName, ::System::Type* type);

  /// @brief Method get_DataType, addr 0x62f5cc8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_ElementName, addr 0x62f5ce8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_Form, addr 0x62f5d08, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_IsNullable, addr 0x62f5d18, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_Namespace, addr 0x62f5d10, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_Order, addr 0x62f5d20, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method get_Type, addr 0x62f5d28, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlElementAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlElementAttribute(XmlElementAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlElementAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlElementAttribute(XmlElementAttributeconst&) = delete;
