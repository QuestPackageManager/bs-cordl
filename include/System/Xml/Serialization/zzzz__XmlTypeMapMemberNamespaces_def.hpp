...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberNamespaces", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTypeMapMemberNamespaces(XmlTypeMapMemberNamespaces&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberNamespaces", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTypeMapMemberNamespaces(XmlTypeMapMemberNamespacesconst&) = delete;
