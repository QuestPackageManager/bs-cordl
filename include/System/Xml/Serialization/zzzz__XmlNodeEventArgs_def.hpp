...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlNodeEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlNodeEventArgs(XmlNodeEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlNodeEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlNodeEventArgs(XmlNodeEventArgsconst&) = delete;
