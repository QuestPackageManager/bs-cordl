...
public:
  ...
  /// @brief Method Equals, addr 0x2f1228c, size 0x15c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method FindElement, addr 0x2f11c5c, size 0x330, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindElement(::StringW elementName, ::StringW ns);

  /// @brief Method FindElement, addr 0x2f0b7d4, size 0x848, virtual false, abstract: false, final false
  ...
  /// @brief Method FindTextElement, addr 0x2f11f8c, size 0x300, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindTextElement();

  /// @brief Method GetArrayType, addr 0x2f0b5cc, size 0x208, virtual false, abstract: false, final false
  inline void GetArrayType(int32_t itemCount, ByRef<::StringW> localName, ByRef<::StringW> ns);

  /// @brief Method GetHashCode, addr 0x2f123e8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f123f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ItemInfo, addr 0x2f11c4c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ItemInfo();

  /// @brief Method set_ChoiceMember, addr 0x2f11c44, size 0x8, virtual false, abstract: false, final false
  inline void set_ChoiceMember(::StringW value);

  /// @brief Method set_ItemInfo, addr 0x2f11c54, size 0x8, virtual false, abstract: false, final false
