...
public:
  ...
  /// @brief Method Equals, addr 0x60f9a7c, size 0x15c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method FindElement, addr 0x60f94c4, size 0x2f0, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindElement(::StringW elementName, ::StringW ns);

  /// @brief Method FindElement, addr 0x60f3548, size 0x7c4, virtual false, abstract: false, final false
  ...
  /// @brief Method FindTextElement, addr 0x60f97b4, size 0x2c8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindTextElement();

  /// @brief Method GetArrayType, addr 0x60f3320, size 0x228, virtual false, abstract: false, final false
  inline void GetArrayType(int32_t itemCount, ::ByRef<::StringW> localName, ::ByRef<::StringW> ns);

  /// @brief Method GetHashCode, addr 0x60f9bd8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60f9bec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ItemInfo, addr 0x60f94b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ItemInfo();

  /// @brief Method set_ChoiceMember, addr 0x60f94ac, size 0x8, virtual false, abstract: false, final false
  inline void set_ChoiceMember(::StringW value);

  /// @brief Method set_ItemInfo, addr 0x60f94bc, size 0x8, virtual false, abstract: false, final false
