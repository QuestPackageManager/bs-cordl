...
public:
// Declarations
/// @brief Method Invoke, addr 0x6152be4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6152aa0, size 0x144, virtual false, abstract: false, final false
