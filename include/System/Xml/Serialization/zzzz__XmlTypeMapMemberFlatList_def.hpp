...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberFlatList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTypeMapMemberFlatList(XmlTypeMapMemberFlatList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberFlatList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTypeMapMemberFlatList(XmlTypeMapMemberFlatListconst&) = delete;
