...
public:
  ...
  /// @brief Method get_ListMap, addr 0x43903b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::ListMap* get_ListMap();

  /// @brief Method set_ListMap, addr 0x43903bc, size 0x8, virtual false, abstract: false, final false
