...
public:
  ...
  /// @brief Method .ctor, addr 0x60f6a54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ListMap, addr 0x60f6a44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::ListMap* get_ListMap();

  /// @brief Method set_ListMap, addr 0x60f6a4c, size 0x8, virtual false, abstract: false, final false
