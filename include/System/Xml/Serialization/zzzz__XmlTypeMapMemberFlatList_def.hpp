...
/// @brief Method .ctor, addr 0x615eca0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ListMap, addr 0x615ec90, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::ListMap* get_ListMap() ;

/// @brief Method set_ListMap, addr 0x615ec98, size 0x8, virtual false, abstract: false, final false
