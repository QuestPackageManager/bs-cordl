...
public:
  ...
  /// @brief Method BaseEquals, addr 0x60cff28, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60cff18, size 0x10, virtual false, abstract: false, final false
