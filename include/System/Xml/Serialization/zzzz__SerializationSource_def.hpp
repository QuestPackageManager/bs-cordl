...
public:
  ...
  /// @brief Method BaseEquals, addr 0x2dc34e0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dc34ac, size 0x34, virtual false, abstract: false, final false
