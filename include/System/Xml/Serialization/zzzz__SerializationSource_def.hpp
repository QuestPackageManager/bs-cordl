...
public:
  ...
  /// @brief Method BaseEquals, addr 0x436d080, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x436d04c, size 0x34, virtual false, abstract: false, final false
