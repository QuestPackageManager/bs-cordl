...
public:
  ...
  /// @brief Method BaseEquals, addr 0x6137ab4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6137aa4, size 0x10, virtual false, abstract: false, final false
