...
public:
  ...
  /// @brief Method BaseEquals, addr 0x436a428, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x436a3f4, size 0x34, virtual false, abstract: false, final false
