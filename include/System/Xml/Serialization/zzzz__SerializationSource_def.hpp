...
public:
  ...
  /// @brief Method BaseEquals, addr 0x61aa180, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61aa170, size 0x10, virtual false, abstract: false, final false
