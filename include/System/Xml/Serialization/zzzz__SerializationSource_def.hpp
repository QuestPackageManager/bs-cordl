...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::SerializationSource*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::SerializationSource*, "System.Xml.Serialization", "SerializationSource");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_includedTypes, put = __cordl_internal_set_includedTypes)) ::ArrayW<::System::Type*> includedTypes;
  ...
  constexpr ::ArrayW<::System::Type*> const& __cordl_internal_get_includedTypes() const;

  constexpr ::ArrayW<::System::Type*>& __cordl_internal_get_includedTypes();
  ...
  constexpr void __cordl_internal_set_includedTypes(::ArrayW<::System::Type*> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerializationSource", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerializationSource(SerializationSource&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerializationSource", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerializationSource(SerializationSourceconst&) = delete;
...
static_assert(sizeof(::System::Xml::Serialization::SerializationSource) == 0x28, "Size mismatch!");
