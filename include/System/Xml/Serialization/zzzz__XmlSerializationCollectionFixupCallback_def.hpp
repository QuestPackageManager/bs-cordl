...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x61485cc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6148484, size 0x148, virtual false, abstract: false, final false
