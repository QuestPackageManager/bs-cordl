...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x60e0a40, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60e08f8, size 0x148, virtual false, abstract: false, final false
