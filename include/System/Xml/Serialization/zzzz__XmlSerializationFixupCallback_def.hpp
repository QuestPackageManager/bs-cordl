...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x4302e04, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4302d04, size 0x100, virtual false, abstract: false, final false
