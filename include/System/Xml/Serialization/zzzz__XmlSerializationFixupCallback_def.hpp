...
public:
// Declarations
/// @brief Method Invoke, addr 0x6148de4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6148ca0, size 0x144, virtual false, abstract: false, final false
