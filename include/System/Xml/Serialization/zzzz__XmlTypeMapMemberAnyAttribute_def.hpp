...
public:
  ...
  /// @brief Method .ctor, addr 0x6313414, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberAnyAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTypeMapMemberAnyAttribute(XmlTypeMapMemberAnyAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberAnyAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTypeMapMemberAnyAttribute(XmlTypeMapMemberAnyAttributeconst&) = delete;
