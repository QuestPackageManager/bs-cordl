...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlAttributeOverrides", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlAttributeOverrides(XmlAttributeOverrides&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlAttributeOverrides", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlAttributeOverrides(XmlAttributeOverridesconst&) = delete;
