...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x60e0818, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60e07ac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x60e07b8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName);

  /// @brief Method get_DataType, addr 0x60e07c8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_ElementName, addr 0x60dccf8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_IsNullable, addr 0x60e07f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_Namespace, addr 0x60e0808, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_DataType, addr 0x60e07e8, size 0x8, virtual false, abstract: false, final false
  inline void set_DataType(::StringW value);

  /// @brief Method set_ElementName, addr 0x60e07f0, size 0x8, virtual false, abstract: false, final false
  inline void set_ElementName(::StringW value);

  /// @brief Method set_IsNullable, addr 0x60e0800, size 0x8, virtual false, abstract: false, final false
  inline void set_IsNullable(bool value);

  /// @brief Method set_Namespace, addr 0x60e0810, size 0x8, virtual false, abstract: false, final false
