...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberAnyElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTypeMapMemberAnyElement(XmlTypeMapMemberAnyElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeMapMemberAnyElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTypeMapMemberAnyElement(XmlTypeMapMemberAnyElementconst&) = delete;
