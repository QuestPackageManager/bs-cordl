...
public:
  ...
  /// @brief Method IsElementDefined, addr 0x43886f4, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x438b7b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsDefaultAny, addr 0x438b4cc, size 0x2e4, virtual false, abstract: false, final false
