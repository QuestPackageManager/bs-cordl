...
public:
  ...
  /// @brief Method get_Count, addr 0x2dd1304, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_HasWrapperElement, addr 0x2dd1320, size 0x8, virtual false, abstract: false, final false
