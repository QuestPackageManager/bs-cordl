...
public:
  ...
  /// @brief Method get_Count, addr 0x60d9df0, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_HasWrapperElement, addr 0x60d9e08, size 0x8, virtual false, abstract: false, final false
