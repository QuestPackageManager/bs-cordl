...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlMembersMapping*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlMembersMapping*, "System.Xml.Serialization", "XmlMembersMapping");
// [DefaultMember("Item")]
// Dependencies System.Xml.Serialization.XmlMapping, System.Xml.Serialization.XmlMemberMapping
namespace System::Xml::Serialization {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__mapping, put = __cordl_internal_set__mapping)) ::ArrayW<::System::Xml::Serialization::XmlMemberMapping*> _mapping;

  constexpr bool const& __cordl_internal_get__hasWrapperElement() const;

  constexpr bool& __cordl_internal_get__hasWrapperElement();

  constexpr ::ArrayW<::System::Xml::Serialization::XmlMemberMapping*> const& __cordl_internal_get__mapping() const;

  constexpr ::ArrayW<::System::Xml::Serialization::XmlMemberMapping*>& __cordl_internal_get__mapping();
  ...
  /// @brief Method get_Count, addr 0x62f64d4, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_HasWrapperElement, addr 0x62f64ec, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlMembersMapping", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlMembersMapping(XmlMembersMapping&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlMembersMapping", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlMembersMapping(XmlMembersMappingconst&) = delete;
  ...
  ::ArrayW<::System::Xml::Serialization::XmlMemberMapping*> ____mapping;
...
static_assert(sizeof(::System::Xml::Serialization::XmlMembersMapping) == 0x58, "Size mismatch!");
