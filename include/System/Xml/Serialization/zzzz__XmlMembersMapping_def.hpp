...
public:
  ...
  /// @brief Method get_Count, addr 0x61b4048, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_HasWrapperElement, addr 0x61b4060, size 0x8, virtual false, abstract: false, final false
