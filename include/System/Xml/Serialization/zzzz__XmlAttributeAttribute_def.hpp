...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x437c5a4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x437c4bc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW attributeName);

  /// @brief Method get_AttributeName, addr 0x437c4e4, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_AttributeName();

  /// @brief Method get_DataType, addr 0x437c538, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_Form, addr 0x437c594, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_Namespace, addr 0x437c59c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_DataType, addr 0x437c58c, size 0x8, virtual false, abstract: false, final false
