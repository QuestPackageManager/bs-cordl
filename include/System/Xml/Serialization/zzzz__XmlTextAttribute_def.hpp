...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x630c830, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x630c804, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DataType, addr 0x630c808, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_Type, addr 0x630c828, size 0x8, virtual false, abstract: false, final false
