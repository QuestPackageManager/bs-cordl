...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x438a308, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x438a2a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DataType, addr 0x438a2ac, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_Type, addr 0x438a300, size 0x8, virtual false, abstract: false, final false
