...
public:
  ...
  /// @brief Method ConvertForAssignment, addr 0x43645f8, size 0xd0, virtual false, abstract: false, final false
  inline void ConvertForAssignment(::ByRef<::System::Object*> value);

  /// @brief Method CreateMissingAddMethodException, addr 0x43652e4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGenericListItemType, addr 0x4364fb0, size 0x1f4, virtual false, abstract: false, final false
  static inline ::System::Type* GetGenericListItemType(::System::Type* type);

  /// @brief Method GetIndexerProperty, addr 0x43651a4, size 0x140, virtual false, abstract: false, final false
  static inline ::System::Reflection::PropertyInfo* GetIndexerProperty(::System::Type* collectionType);

  /// @brief Method LookupTypeConvertor, addr 0x4364558, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4363fb8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW elementName, bool isPrimitive);

  /// @brief Method .ctor, addr 0x4363fc8, size 0x3cc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FullTypeName, addr 0x43646e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FullTypeName();

  /// @brief Method get_HasPublicConstructor, addr 0x43653f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasPublicConstructor();

  /// @brief Method get_IsComplexType, addr 0x43646f0, size 0x28, virtual false, abstract: false, final false
  inline bool get_IsComplexType();

  /// @brief Method get_IsListType, addr 0x4363b4c, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsListType();

  /// @brief Method get_IsNullable, addr 0x43647bc, size 0x114, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_IsValueType, addr 0x4364728, size 0x94, virtual false, abstract: false, final false
  inline bool get_IsValueType();

  /// @brief Method get_IsXsdType, addr 0x4364718, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsXsdType();

  /// @brief Method get_ListItemType, addr 0x43648dc, size 0x6d4, virtual false, abstract: false, final false
  inline ::System::Type* get_ListItemType();

  /// @brief Method get_ListItemTypeData, addr 0x4364394, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::TypeData* get_ListItemTypeData();

  /// @brief Method get_SchemaType, addr 0x43646e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::SchemaTypes get_SchemaType();

  /// @brief Method get_Type, addr 0x43646d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_Type();

  /// @brief Method get_TypeName, addr 0x43646c8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TypeName();

  /// @brief Method get_XmlType, addr 0x43646d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlType();

  static inline void setStaticF_keywords(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_IsNullable, addr 0x43648d0, size 0xc, virtual false, abstract: false, final false
