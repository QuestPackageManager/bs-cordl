...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x61b0590, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DataType, addr 0x61b0520, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_DataType();

  /// @brief Method get_ElementName, addr 0x61b0540, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_Form, addr 0x61b0560, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaForm get_Form();

  /// @brief Method get_IsNullable, addr 0x61b0570, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_IsNullableSpecified, addr 0x61b0578, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullableSpecified();

  /// @brief Method get_Namespace, addr 0x61b0568, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_NestingLevel, addr 0x61b0588, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NestingLevel();

  /// @brief Method get_Type, addr 0x61b0580, size 0x8, virtual false, abstract: false, final false
