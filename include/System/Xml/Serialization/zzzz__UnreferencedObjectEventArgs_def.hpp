...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::UnreferencedObjectEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::UnreferencedObjectEventArgs*, "System.Xml.Serialization", "UnreferencedObjectEventArgs");
...
public:
  ...
  /// @brief Method .ctor, addr 0x62eba44, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnreferencedObjectEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnreferencedObjectEventArgs(UnreferencedObjectEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnreferencedObjectEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnreferencedObjectEventArgs(UnreferencedObjectEventArgsconst&) = delete;
...
static_assert(sizeof(::System::Xml::Serialization::UnreferencedObjectEventArgs) == 0x20, "Size mismatch!");
