...
/// @brief Method .ctor, addr 0x6148b24, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  methodName) ;

/// @brief Method get_IsAny, addr 0x6148b34, size 0x8, virtual false, abstract: false, final false
inline bool get_IsAny() ;

/// @brief Method get_MethodName, addr 0x6148b2c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_MethodName() ;

/// @brief Method set_IsAny, addr 0x6148b3c, size 0x8, virtual false, abstract: false, final false
