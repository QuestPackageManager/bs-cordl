...
public:
  ...
  /// @brief Method .ctor, addr 0x4379ff4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW methodName);

  /// @brief Method get_IsAny, addr 0x437a024, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAny();

  /// @brief Method get_MethodName, addr 0x437a01c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MethodName();

  /// @brief Method set_IsAny, addr 0x437a02c, size 0xc, virtual false, abstract: false, final false
