...
public:
  ...
  /// @brief Method .ctor, addr 0x61bab30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW methodName);

  /// @brief Method get_IsAny, addr 0x61bab40, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAny();

  /// @brief Method get_MethodName, addr 0x61bab38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MethodName();

  /// @brief Method set_IsAny, addr 0x61bab48, size 0x8, virtual false, abstract: false, final false
