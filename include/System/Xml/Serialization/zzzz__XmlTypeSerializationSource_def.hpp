...
public:
  ...
  /// @brief Method Equals, addr 0x62eccac, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x62ecd8c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62ec6e8, size 0x100, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeSerializationSource", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlTypeSerializationSource(XmlTypeSerializationSource&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlTypeSerializationSource", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlTypeSerializationSource(XmlTypeSerializationSourceconst&) = delete;
