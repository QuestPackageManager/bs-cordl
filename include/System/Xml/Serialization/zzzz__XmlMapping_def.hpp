...
/// @brief Method SetKey, addr 0x6141ff8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6141fe0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  elementName, ::StringW  ns) ;

/// @brief Method get_ElementName, addr 0x6141fe8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ElementName() ;

/// @brief Method get_Format, addr 0x6142020, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::SerializationFormat get_Format() ;

/// @brief Method get_Namespace, addr 0x6141ff0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_ObjectMap, addr 0x6142000, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::ObjectMap* get_ObjectMap() ;

/// @brief Method get_RelatedMaps, addr 0x6142010, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_RelatedMaps() ;

/// @brief Method get_Source, addr 0x6142030, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::SerializationSource* get_Source() ;

/// @brief Method set_Format, addr 0x6142028, size 0x8, virtual false, abstract: false, final false
inline void set_Format(::System::Xml::Serialization::SerializationFormat  value) ;

/// @brief Method set_ObjectMap, addr 0x6142008, size 0x8, virtual false, abstract: false, final false
inline void set_ObjectMap(::System::Xml::Serialization::ObjectMap*  value) ;

/// @brief Method set_RelatedMaps, addr 0x6142018, size 0x8, virtual false, abstract: false, final false
