...
public:
  ...
  /// @brief Method SetKey, addr 0x61b4004, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61b3fec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW elementName, ::StringW ns);

  /// @brief Method get_ElementName, addr 0x61b3ff4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ElementName();

  /// @brief Method get_Format, addr 0x61b402c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::SerializationFormat get_Format();

  /// @brief Method get_Namespace, addr 0x61b3ffc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_ObjectMap, addr 0x61b400c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::ObjectMap* get_ObjectMap();

  /// @brief Method get_RelatedMaps, addr 0x61b401c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_RelatedMaps();

  /// @brief Method get_Source, addr 0x61b403c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::SerializationSource* get_Source();

  /// @brief Method set_Format, addr 0x61b4034, size 0x8, virtual false, abstract: false, final false
  inline void set_Format(::System::Xml::Serialization::SerializationFormat value);

  /// @brief Method set_ObjectMap, addr 0x61b4014, size 0x8, virtual false, abstract: false, final false
  inline void set_ObjectMap(::System::Xml::Serialization::ObjectMap* value);

  /// @brief Method set_RelatedMaps, addr 0x61b4024, size 0x8, virtual false, abstract: false, final false
