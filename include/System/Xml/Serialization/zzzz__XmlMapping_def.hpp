...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlMapping", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlMapping(XmlMapping&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlMapping", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlMapping(XmlMappingconst&) = delete;
