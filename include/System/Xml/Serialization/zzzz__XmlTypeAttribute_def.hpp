...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x438f2f8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IncludeInSchema, addr 0x438f294, size 0x8, virtual false, abstract: false, final false
  inline bool get_IncludeInSchema();

  /// @brief Method get_Namespace, addr 0x438f29c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_TypeName, addr 0x438f2a4, size 0x54, virtual false, abstract: false, final false
