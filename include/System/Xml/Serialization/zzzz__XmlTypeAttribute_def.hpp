...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x2debdb0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IncludeInSchema, addr 0x2debd4c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IncludeInSchema();

  /// @brief Method get_Namespace, addr 0x2debd54, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_TypeName, addr 0x2debd5c, size 0x54, virtual false, abstract: false, final false
