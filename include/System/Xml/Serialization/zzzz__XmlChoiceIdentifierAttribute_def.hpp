...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x60d7658, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MemberName, addr 0x60d7638, size 0x20, virtual false, abstract: false, final false
