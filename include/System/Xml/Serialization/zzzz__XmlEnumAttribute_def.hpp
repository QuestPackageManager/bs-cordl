...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x61b3f5c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61b3f4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x61b3f54, size 0x8, virtual false, abstract: false, final false
