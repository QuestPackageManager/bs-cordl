...
public:
  ...
  /// @brief Method AddKeyHash, addr 0x60d9d04, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60d9cf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x60d9cfc, size 0x8, virtual false, abstract: false, final false
