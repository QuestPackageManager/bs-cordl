...
/// @brief Method AddKeyHash, addr 0x6141f50, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6141f40, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_Name, addr 0x6141f48, size 0x8, virtual false, abstract: false, final false
