...
public:
  ...
  /// @brief Method Equals, addr 0x5ee7f10, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5ee7fb4, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method ToCharArray, addr 0x5ee77d8, size 0x628, virtual false, abstract: false, final false
  inline int32_t ToCharArray(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t offset);

  /// @brief Method ToString, addr 0x5ee7e08, size 0x80, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnsafeDecode, addr 0x5ee7770, size 0x34, virtual false, abstract: false, final false
  inline int32_t UnsafeDecode(int16_t* char2val, char16_t ch1, char16_t ch2);

  /// @brief Method UnsafeEncode, addr 0x5ee77a4, size 0x20, virtual false, abstract: false, final false
  inline void UnsafeEncode(char16_t* val2char, uint8_t b, char16_t* pch);

  /// @brief Method UnsafeGetInt32, addr 0x5ee7ffc, size 0x8, virtual false, abstract: false, final false
  inline int32_t UnsafeGetInt32(uint8_t* pb);

  /// @brief Method UnsafeGetInt64, addr 0x5ee714c, size 0x8, virtual false, abstract: false, final false
  inline int64_t UnsafeGetInt64(uint8_t* pb);

  /// @brief Method UnsafeParse, addr 0x5ee7200, size 0x558, virtual false, abstract: false, final false
  inline void UnsafeParse(char16_t* chars, int32_t charCount);

  /// @brief Method UnsafeSetInt32, addr 0x5ee8004, size 0x8, virtual false, abstract: false, final false
  inline void UnsafeSetInt32(int32_t value, uint8_t* pb);

  /// @brief Method UnsafeSetInt64, addr 0x5ee7e00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ee6f28, size 0x224, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> guid, int32_t offset);

  /// @brief Method .ctor, addr 0x5ee7154, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  static inline ::ArrayW<int16_t, ::Array<int16_t>*> getStaticF_char2val();

  /// @brief Method get_CharArrayLength, addr 0x5ee7758, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_CharArrayLength();

  /// @brief Method get_IsGuid, addr 0x5ee77c4, size 0x14, virtual false, abstract: false, final false
  inline bool get_IsGuid();

  /// @brief Method op_Equality, addr 0x5ee7e88, size 0x88, virtual false, abstract: false, final false
