...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::XmlCachedStream::*)(::System::Uri*, ::System::IO::Stream*)>(
  ...
  constexpr static std::size_t addrs = 0x2db89c8;
...
constexpr ::cordl_internals::to_const_pointer<::System::Uri*> const& System::Xml::XmlCachedStream::__cordl_internal_get_uri() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___uri;
}
