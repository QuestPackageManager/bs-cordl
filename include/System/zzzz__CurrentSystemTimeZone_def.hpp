...
public:
  ...
  /// @brief Method CreateDaylightChanges, addr 0x5ae8250, size 0x284, virtual false, abstract: false, final false
  static inline ::System::Globalization::DaylightTime* CreateDaylightChanges(int32_t year);

  /// @brief Method GetCachedDaylightChanges, addr 0x5ae8070, size 0x1e0, virtual false, abstract: false, final false
  inline ::System::Globalization::DaylightTime* GetCachedDaylightChanges(int32_t year);

  /// @brief Method GetDaylightChanges, addr 0x5ae7fa8, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Globalization::DaylightTime* GetDaylightChanges(int32_t year);

  /// @brief Method GetTimeZoneData, addr 0x5ae85e0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUtcOffset, addr 0x5ae84d4, size 0x10c, virtual true, abstract: false, final false
  inline ::System::TimeSpan GetUtcOffset(::System::DateTime time);

  /// @brief Method GetUtcOffsetFromUniversalTime, addr 0x5ae76fc, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToLocalTime, addr 0x5ae7c60, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ae75f8, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();
