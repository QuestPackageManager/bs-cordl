...
/// @brief Method CreateDaylightChanges, addr 0x5a76268, size 0x284, virtual false, abstract: false, final false
static inline ::System::Globalization::DaylightTime* CreateDaylightChanges(int32_t  year) ;

/// @brief Method GetCachedDaylightChanges, addr 0x5a76088, size 0x1e0, virtual false, abstract: false, final false
inline ::System::Globalization::DaylightTime* GetCachedDaylightChanges(int32_t  year) ;

/// @brief Method GetDaylightChanges, addr 0x5a75fc0, size 0xc8, virtual true, abstract: false, final false
inline ::System::Globalization::DaylightTime* GetDaylightChanges(int32_t  year) ;

/// @brief Method GetTimeZoneData, addr 0x5a765f8, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method GetUtcOffset, addr 0x5a764ec, size 0x10c, virtual true, abstract: false, final false
inline ::System::TimeSpan GetUtcOffset(::System::DateTime  time) ;

/// @brief Method GetUtcOffsetFromUniversalTime, addr 0x5a75714, size 0x2bc, virtual false, abstract: false, final false
...
/// @brief Method ToLocalTime, addr 0x5a75c78, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a75610, size 0x104, virtual false, abstract: false, final false
inline void _ctor() ;
