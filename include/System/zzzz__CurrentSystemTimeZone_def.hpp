...
public:
  ...
  /// @brief Method CreateDaylightChanges, addr 0x3dca5e4, size 0x2a0, virtual false, abstract: false, final false
  static inline ::System::Globalization::DaylightTime* CreateDaylightChanges(int32_t year);

  /// @brief Method GetCachedDaylightChanges, addr 0x3dca3f8, size 0x1ec, virtual false, abstract: false, final false
  inline ::System::Globalization::DaylightTime* GetCachedDaylightChanges(int32_t year);

  /// @brief Method GetDaylightChanges, addr 0x3dca32c, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Globalization::DaylightTime* GetDaylightChanges(int32_t year);

  /// @brief Method GetTimeZoneData, addr 0x3dcaa50, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUtcOffset, addr 0x3dca8dc, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dca23c, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();
