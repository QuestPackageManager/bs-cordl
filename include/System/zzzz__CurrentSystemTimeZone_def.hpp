...
public:
  ...
  /// @brief Method CreateDaylightChanges, addr 0x5a75d5c, size 0x284, virtual false, abstract: false, final false
  static inline ::System::Globalization::DaylightTime* CreateDaylightChanges(int32_t year);

  /// @brief Method GetCachedDaylightChanges, addr 0x5a75b7c, size 0x1e0, virtual false, abstract: false, final false
  inline ::System::Globalization::DaylightTime* GetCachedDaylightChanges(int32_t year);

  /// @brief Method GetDaylightChanges, addr 0x5a75ab4, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Globalization::DaylightTime* GetDaylightChanges(int32_t year);

  /// @brief Method GetTimeZoneData, addr 0x5a760ec, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUtcOffset, addr 0x5a75fe0, size 0x10c, virtual true, abstract: false, final false
  inline ::System::TimeSpan GetUtcOffset(::System::DateTime time);

  /// @brief Method GetUtcOffsetFromUniversalTime, addr 0x5a75208, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToLocalTime, addr 0x5a7576c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a75104, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();
