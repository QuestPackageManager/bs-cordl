...
public:
  ...
  /// @brief Method .ctor, addr 0x272b408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x272b418, size 0x28, virtual false, abstract: false, final false
