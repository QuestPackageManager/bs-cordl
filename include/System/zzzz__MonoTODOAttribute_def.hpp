...
public:
  ...
  /// @brief Method .ctor, addr 0x3e0ed80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e0ed90, size 0x28, virtual false, abstract: false, final false
