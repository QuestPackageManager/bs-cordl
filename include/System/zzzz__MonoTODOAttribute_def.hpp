...
public:
  ...
  /// @brief Method .ctor, addr 0x3e13cf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e13d04, size 0x28, virtual false, abstract: false, final false
