...
public:
  ...
  /// @brief Method .ctor, addr 0x2f7dbd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2f7dbe0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AllowIdnStatic, addr 0x2f19d68, size 0xc8, virtual false, abstract: false, final false
  inline bool AllowIdnStatic(::System::UriParser* syntax, ::System::__Uri__Flags flags);

  /// @brief Method CalculateCaseInsensitiveHashCode, addr 0x2f1f704, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t CalculateCaseInsensitiveHashCode(::StringW text);

  /// @brief Method CheckAuthorityHelper, addr 0x2f20fe4, size 0xe04, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAuthorityHelperHandleAnyHostIri, addr 0x2f24d14, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAuthorityHelperHandleDnsIri, addr 0x2f249c4, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCanonical, addr 0x2f224e0, size 0x3f8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForColonInFirstPathSegment, addr 0x2f200fc, size 0xb8, virtual false, abstract: false, final false
  static inline bool CheckForColonInFirstPathSegment(::StringW uriString);

  /// @brief Method CheckForConfigLoad, addr 0x2f25928, size 0xac, virtual false, abstract: false, final false
  inline bool CheckForConfigLoad(::StringW data);

  /// @brief Method CheckForEscapedUnreserved, addr 0x2f25aec, size 0x1ac, virtual false, abstract: false, final false
  inline bool CheckForEscapedUnreserved(::StringW data);

  /// @brief Method CheckForUnicode, addr 0x2f259d4, size 0x118, virtual false, abstract: false, final false
  inline bool CheckForUnicode(::StringW data);

  /// @brief Method CheckKnownSchemes, addr 0x2f244c4, size 0x500, virtual false, abstract: false, final false
  static inline bool CheckKnownSchemes(::cordl_internals::Ptr<int64_t> lptr, uint16_t nChars, ByRef<::System::UriParser*> syntax);

  /// @brief Method CheckSchemeName, addr 0x2f1f2f8, size 0x140, virtual false, abstract: false, final false
  static inline bool CheckSchemeName(::StringW schemeName);

  /// @brief Method CheckSchemeSyntax, addr 0x2f1c47c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CombineUri, addr 0x2f1c5d8, size 0xa74, virtual false, abstract: false, final false
  static inline ::StringW CombineUri(::System::Uri* basePart, ::StringW relativePart, ::System::UriFormat uriFormat);

  /// @brief Method Compress, addr 0x2f1e68c, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHelper, addr 0x2f25c98, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHostString, addr 0x2f1b0bc, size 0x3fc, virtual false, abstract: false, final false
  inline void CreateHostString();

  /// @brief Method CreateHostStringHelper, addr 0x2f222fc, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateThis, addr 0x2f1b53c, size 0x1c0, virtual false, abstract: false, final false
  inline void CreateThis(::StringW uri, bool dontEscape, ::System::UriKind uriKind);

  /// @brief Method CreateThisFromUri, addr 0x2f1bee8, size 0x120, virtual false, abstract: false, final false
  inline void CreateThisFromUri(::System::Uri* otherUri);

  /// @brief Method CreateUri, addr 0x2f1b85c, size 0x188, virtual false, abstract: false, final false
  inline void CreateUri(::System::Uri* baseUri, ::StringW relativeUri, bool dontEscape);

  /// @brief Method CreateUriInfo, addr 0x2f19f00, size 0x594, virtual false, abstract: false, final false
  inline void CreateUriInfo(::System::__Uri__Flags cF);

  /// @brief Method EnsureHostString, addr 0x2f1b05c, size 0x60, virtual false, abstract: false, final false
  inline void EnsureHostString(bool allowDnsOptimization);

  /// @brief Method EnsureParseRemaining, addr 0x2f1a494, size 0x10, virtual false, abstract: false, final false
  inline void EnsureParseRemaining();

  /// @brief Method EnsureUriInfo, addr 0x2f19edc, size 0x24, virtual false, abstract: false, final false
  inline ::System::__Uri__UriInfo* EnsureUriInfo();

  /// @brief Method Equals, addr 0x2f1fabc, size 0x588, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method EscapeUnescapeIri, addr 0x2f24474, size 0x50, virtual false, abstract: false, final false
  inline ::StringW EscapeUnescapeIri(::StringW input, int32_t start, int32_t end, ::System::UriComponents component);

  /// @brief Method FindEndOfComponent, addr 0x2f24420, size 0x54, virtual false, abstract: false, final false
  inline void FindEndOfComponent(::StringW input, ByRef<uint16_t> idx, uint16_t end, char16_t delim);

  /// @brief Method FindEndOfComponent, addr 0x2f25150, size 0x94, virtual false, abstract: false, final false
  inline void FindEndOfComponent(::cordl_internals::Ptr<char16_t> str, ByRef<uint16_t> idx, uint16_t end, char16_t delim);

  /// @brief Method FromHex, addr 0x2f1f51c, size 0xb0, virtual false, abstract: false, final false
  static inline int32_t FromHex(char16_t digit);

  /// @brief Method GetCanonicalPath, addr 0x2f23db8, size 0x668, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCombinedString, addr 0x2f1c22c, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponents, addr 0x2f228d8, size 0x1dc, virtual false, abstract: false, final false
  inline ::StringW GetComponents(::System::UriComponents components, ::System::UriFormat format);

  /// @brief Method GetComponentsHelper, addr 0x2f1f870, size 0x218, virtual false, abstract: false, final false
  inline ::StringW GetComponentsHelper(::System::UriComponents uriComponents, ::System::UriFormat uriFormat);

  /// @brief Method GetEscapedParts, addr 0x2f22ab4, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW GetEscapedParts(::System::UriComponents uriParts);

  /// @brief Method GetException, addr 0x2f1d04c, size 0x1a0, virtual false, abstract: false, final false
  static inline ::System::UriFormatException* GetException(::System::ParsingError err);

  /// @brief Method GetHashCode, addr 0x2f1f5cc, size 0x138, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHostViaCustomSyntax, addr 0x2f21ebc, size 0x440, virtual false, abstract: false, final false
  inline void GetHostViaCustomSyntax();

  /// @brief Method GetLocalPath, addr 0x2f1d6b8, size 0x5f4, virtual false, abstract: false, final false
  inline ::StringW GetLocalPath();

  /// @brief Method GetObjectData, addr 0x2f1d2f4, size 0xd8, virtual false, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetParts, addr 0x2f1d3cc, size 0x4, virtual false, abstract: false, final false
  inline ::StringW GetParts(::System::UriComponents uriParts, ::System::UriFormat formatAs);

  /// @brief Method GetRelativeSerializationString, addr 0x2f26150, size 0x220, virtual false, abstract: false, final false
  inline ::StringW GetRelativeSerializationString(::System::UriFormat format);

  /// @brief Method GetUnescapedParts, addr 0x2f1eb64, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW GetUnescapedParts(::System::UriComponents uriParts, ::System::UriFormat formatAs);

  /// @brief Method GetUriPartsFromUserString, addr 0x2f22b7c, size 0x5b0, virtual false, abstract: false, final false
  inline ::StringW GetUriPartsFromUserString(::System::UriComponents uriParts);

  /// @brief Method InFact, addr 0x2f19ec0, size 0x10, virtual false, abstract: false, final false
  inline bool InFact(::System::__Uri__Flags flags);

  /// @brief Method InitializeUri, addr 0x2f25454, size 0x4d4, virtual false, abstract: false, final false
  inline void InitializeUri(::System::ParsingError err, ::System::UriKind uriKind, ByRef<::System::UriFormatException*> e);

  /// @brief Method InitializeUriConfig, addr 0x2f1e4ec, size 0x1a0, virtual false, abstract: false, final false
  static inline void InitializeUriConfig();

  /// @brief Method InternalEscapeString, addr 0x2f201b4, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW InternalEscapeString(::StringW rawString);

  /// @brief Method InternalIsWellFormedOriginalString, addr 0x2f263b4, size 0x484, virtual false, abstract: false, final false
  inline bool InternalIsWellFormedOriginalString();

  /// @brief Method IriParsingStatic, addr 0x2f19c10, size 0x8c, virtual false, abstract: false, final false
  static inline bool IriParsingStatic(::System::UriParser* syntax);

  /// @brief Method IsAsciiLetter, addr 0x2f1f438, size 0x2c, virtual false, abstract: false, final false
  static inline bool IsAsciiLetter(char16_t character);

  /// @brief Method IsAsciiLetterOrDigit, addr 0x2f1f464, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsAsciiLetterOrDigit(char16_t character);

  /// @brief Method IsBaseOf, addr 0x2f26abc, size 0xb8, virtual false, abstract: false, final false
  inline bool IsBaseOf(::System::Uri* uri);

  /// @brief Method IsBaseOfHelper, addr 0x2f26b74, size 0x204, virtual false, abstract: false, final false
  inline bool IsBaseOfHelper(::System::Uri* uriLink);

  /// @brief Method IsBidiControlCharacter, addr 0x2f2540c, size 0x48, virtual false, abstract: false, final false
  static inline bool IsBidiControlCharacter(char16_t ch);

  /// @brief Method IsGenDelim, addr 0x2f1f2ac, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsGenDelim(char16_t ch);

  /// @brief Method IsHexDigit, addr 0x2f1f4e0, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsHexDigit(char16_t character);

  /// @brief Method IsIntranet, addr 0x2f19e3c, size 0x8, virtual false, abstract: false, final false
  inline bool IsIntranet(::StringW schemeHost);

  /// @brief Method IsLWS, addr 0x2f20fa4, size 0x40, virtual false, abstract: false, final false
  static inline bool IsLWS(char16_t ch);

  /// @brief Method IsWellFormedOriginalString, addr 0x2f26370, size 0x44, virtual false, abstract: false, final false
  inline bool IsWellFormedOriginalString();

  /// @brief Method IsWellFormedUriString, addr 0x2f26838, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method NotAny, addr 0x2f19d58, size 0x10, virtual false, abstract: false, final false
  inline bool NotAny(::System::__Uri__Flags flags);

  /// @brief Method ParseMinimal, addr 0x2f208bc, size 0x80, virtual false, abstract: false, final false
  inline ::System::UriFormatException* ParseMinimal();

  /// @brief Method ParseRemaining, addr 0x2f1a4a4, size 0xbb8, virtual false, abstract: false, final false
  inline void ParseRemaining();

  /// @brief Method ParseScheme, addr 0x2f20294, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseSchemeCheckImplicitFile, addr 0x2f20374, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method PrivateParseMinimal, addr 0x2f2093c, size 0x668, virtual false, abstract: false, final false
  inline ::System::ParsingError PrivateParseMinimal();

  /// @brief Method PrivateParseMinimalIri, addr 0x2f21de8, size 0xd4, virtual false, abstract: false, final false
  inline void PrivateParseMinimalIri(::StringW newHost, uint16_t idx);

  /// @brief Method ReCreateParts, addr 0x2f2312c, size 0xc8c, virtual false, abstract: false, final false
  inline ::StringW ReCreateParts(::System::UriComponents parts, uint16_t nonCanonical, ::System::UriFormat formatAs);

  /// @brief Method ResolveHelper, addr 0x2f1b9e4, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUserDrivenParsing, addr 0x2f19e50, size 0x14, virtual false, abstract: false, final false
  inline void SetUserDrivenParsing();

  /// @brief Method StaticInFact, addr 0x2f19ed0, size 0xc, virtual false, abstract: false, final false
  static inline bool StaticInFact(::System::__Uri__Flags allFlags, ::System::__Uri__Flags checkFlags);

  /// @brief Method StaticIsFile, addr 0x2f1e400, size 0x18, virtual false, abstract: false, final false
  static inline bool StaticIsFile(::System::UriParser* syntax);

  /// @brief Method StaticNotAny, addr 0x2f19e30, size 0xc, virtual false, abstract: false, final false
  static inline bool StaticNotAny(::System::__Uri__Flags allFlags, ::System::__Uri__Flags checkFlags);

  /// @brief Method StripBidiControlCharacter, addr 0x2f24fd8, size 0x178, virtual false, abstract: false, final false
  static inline ::StringW StripBidiControlCharacter(::cordl_internals::Ptr<char16_t> strToClean, int32_t start, int32_t length);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x2f1d2f0, size 0x4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method ToString, addr 0x2f1f7a4, size 0xcc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryCreate, addr 0x2f25f0c, size 0xd0, virtual false, abstract: false, final false
  static inline bool TryCreate(::System::Uri* baseUri, ::StringW relativeUri, ByRef<::System::Uri*> result);

  /// @brief Method TryCreate, addr 0x2f25fdc, size 0x174, virtual false, abstract: false, final false
  static inline bool TryCreate(::System::Uri* baseUri, ::System::Uri* relativeUri, ByRef<::System::Uri*> result);

  /// @brief Method TryCreate, addr 0x2f20044, size 0xb8, virtual false, abstract: false, final false
  static inline bool TryCreate(::StringW uriString, ::System::UriKind uriKind, ByRef<::System::Uri*> result);

  /// @brief Method UnescapeDataString, addr 0x2f268d4, size 0x1a8, virtual false, abstract: false, final false
  static inline ::StringW UnescapeDataString(::StringW stringToUnescape);

  /// @brief Method UnescapeOnly, addr 0x2f251e4, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f1b784, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* baseUri, ::StringW relativeUri);

  /// @brief Method .ctor, addr 0x2f1c008, size 0x224, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* baseUri, ::System::Uri* relativeUri);

  /// @brief Method .ctor, addr 0x2f26a7c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::__Uri__Flags flags, ::System::UriParser* uriParser, ::StringW uri);

  /// @brief Method .ctor, addr 0x2f1d1ec, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x2f1b4b8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW uriString);

  /// @brief Method .ctor, addr 0x2f1b6fc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AbsolutePath, addr 0x2f1d3d0, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW get_AbsolutePath();

  /// @brief Method get_AbsoluteUri, addr 0x2f1d540, size 0x104, virtual false, abstract: false, final false
  inline ::StringW get_AbsoluteUri();

  /// @brief Method get_AllowIdn, addr 0x2f19c9c, size 0xbc, virtual false, abstract: false, final false
  inline bool get_AllowIdn();

  /// @brief Method get_Authority, addr 0x2f1dcac, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW get_Authority();

  /// @brief Method get_DnsSafeHost, addr 0x2f1efd0, size 0x254, virtual false, abstract: false, final false
  inline ::StringW get_DnsSafeHost();

  /// @brief Method get_Fragment, addr 0x2f1ee08, size 0x108, virtual false, abstract: false, final false
  inline ::StringW get_Fragment();

  /// @brief Method get_HasAuthority, addr 0x2f25400, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasAuthority();

  /// @brief Method get_Host, addr 0x2f1e384, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW get_Host();

  /// @brief Method get_HostNameType, addr 0x2f1dd28, size 0x100, virtual false, abstract: false, final false
  inline ::System::UriHostNameType get_HostNameType();

  /// @brief Method get_HostType, addr 0x2f19bec, size 0xc, virtual false, abstract: false, final false
  inline ::System::__Uri__Flags get_HostType();

  /// @brief Method get_InitializeLock, addr 0x2f1e418, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Object* get_InitializeLock();

  /// @brief Method get_IsAbsoluteUri, addr 0x2f1b84c, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsAbsoluteUri();

  /// @brief Method get_IsDefaultPort, addr 0x2f1de28, size 0xb0, virtual false, abstract: false, final false
  inline bool get_IsDefaultPort();

  /// @brief Method get_IsDosPath, addr 0x2f19bd4, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsDosPath();

  /// @brief Method get_IsFile, addr 0x2f1ded8, size 0xc8, virtual false, abstract: false, final false
  inline bool get_IsFile();

  /// @brief Method get_IsImplicitFile, addr 0x2f19bb8, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsImplicitFile();

  /// @brief Method get_IsLoopback, addr 0x2f1dfa0, size 0x88, virtual false, abstract: false, final false
  inline bool get_IsLoopback();

  /// @brief Method get_IsNotAbsoluteUri, addr 0x2f19c00, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsNotAbsoluteUri();

  /// @brief Method get_IsUnc, addr 0x2f1e308, size 0x7c, virtual false, abstract: false, final false
  inline bool get_IsUnc();

  /// @brief Method get_IsUncOrDosPath, addr 0x2f19bc4, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsUncOrDosPath();

  /// @brief Method get_IsUncPath, addr 0x2f19be0, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsUncPath();

  /// @brief Method get_LocalPath, addr 0x2f1d644, size 0x74, virtual false, abstract: false, final false
  inline ::StringW get_LocalPath();

  /// @brief Method get_OriginalString, addr 0x2f1c5b0, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_OriginalString();

  /// @brief Method get_OriginalStringSwitched, addr 0x2f1ef88, size 0x48, virtual false, abstract: false, final false
  inline bool get_OriginalStringSwitched();

  /// @brief Method get_PathAndQuery, addr 0x2f1e028, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW get_PathAndQuery();

  /// @brief Method get_Port, addr 0x2f1ec34, size 0xcc, virtual false, abstract: false, final false
  inline int32_t get_Port();

  /// @brief Method get_PrivateAbsolutePath, addr 0x2f1d498, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW get_PrivateAbsolutePath();

  /// @brief Method get_Query, addr 0x2f1ed00, size 0x108, virtual false, abstract: false, final false
  inline ::StringW get_Query();

  /// @brief Method get_Scheme, addr 0x2f1ef10, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_Scheme();

  /// @brief Method get_SecuredPathIndex, addr 0x2f19e64, size 0x5c, virtual false, abstract: false, final false
  inline uint16_t get_SecuredPathIndex();

  /// @brief Method get_Segments, addr 0x2f1e0f8, size 0x210, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Segments();

  /// @brief Method get_Syntax, addr 0x2f19bf8, size 0x8, virtual false, abstract: false, final false
  inline ::System::UriParser* get_Syntax();

  /// @brief Method get_UserDrivenParsing, addr 0x2f19e44, size 0xc, virtual false, abstract: false, final false
  inline bool get_UserDrivenParsing();

  /// @brief Method get_UserEscaped, addr 0x2f1f224, size 0xc, virtual false, abstract: false, final false
  inline bool get_UserEscaped();

  /// @brief Method get_UserInfo, addr 0x2f1f230, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW get_UserInfo();

  /// @brief Convert to "::System::Runtime::Serialization::ISerializable"
  constexpr ::System::Runtime::Serialization::ISerializable* i___System__Runtime__Serialization__ISerializable() noexcept;

  /// @brief Method op_Equality, addr 0x2f1fa88, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Uri* uri1, ::System::Uri* uri2);

  /// @brief Method op_Inequality, addr 0x2f1bea0, size 0x48, virtual false, abstract: false, final false
