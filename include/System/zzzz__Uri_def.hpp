...
public:
  ...
  /// @brief Method .ctor, addr 0x6234354, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6234358, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AllowIdnStatic, addr 0x61dfed0, size 0xd4, virtual false, abstract: false, final false
  inline bool AllowIdnStatic(::System::UriParser* syntax, ::System::Uri_Flags flags);

  /// @brief Method CalculateCaseInsensitiveHashCode, addr 0x61e53b0, size 0xb4, virtual false, abstract: false, final false
  static inline int32_t CalculateCaseInsensitiveHashCode(::StringW text);

  /// @brief Method CheckAuthorityHelper, addr 0x61e6a60, size 0xca0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAuthorityHelperHandleAnyHostIri, addr 0x61ea568, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAuthorityHelperHandleDnsIri, addr 0x61ea220, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCanonical, addr 0x61e7d9c, size 0x424, virtual false, abstract: false, final false
  inline ::System::Uri_Check CheckCanonical(char16_t* str, ::ByRef<uint16_t> idx, uint16_t end, char16_t delim);

  /// @brief Method CheckForColonInFirstPathSegment, addr 0x61e5d34, size 0xc4, virtual false, abstract: false, final false
  static inline bool CheckForColonInFirstPathSegment(::StringW uriString);

  /// @brief Method CheckForConfigLoad, addr 0x61eb0cc, size 0xc0, virtual false, abstract: false, final false
  inline bool CheckForConfigLoad(::StringW data);

  /// @brief Method CheckForEscapedUnreserved, addr 0x61eb2b0, size 0x1d0, virtual false, abstract: false, final false
  inline bool CheckForEscapedUnreserved(::StringW data);

  /// @brief Method CheckForUnicode, addr 0x61eb18c, size 0x124, virtual false, abstract: false, final false
  inline bool CheckForUnicode(::StringW data);

  /// @brief Method CheckKnownSchemes, addr 0x61e9d10, size 0x510, virtual false, abstract: false, final false
  static inline bool CheckKnownSchemes(int64_t* lptr, uint16_t nChars, ::ByRef<::System::UriParser*> syntax);

  /// @brief Method CheckSchemeName, addr 0x61e5020, size 0x118, virtual false, abstract: false, final false
  static inline bool CheckSchemeName(::StringW schemeName);

  /// @brief Method CheckSchemeSyntax, addr 0x61e2444, size 0x144, virtual false, abstract: false, final false
  static inline ::System::ParsingError CheckSchemeSyntax(char16_t* ptr, uint16_t length, ::ByRef<::System::UriParser*> syntax);

  /// @brief Method CombineUri, addr 0x61e25b0, size 0x8b0, virtual false, abstract: false, final false
  static inline ::StringW CombineUri(::System::Uri* basePart, ::StringW relativePart, ::System::UriFormat uriFormat);

  /// @brief Method Compress, addr 0x61e43ec, size 0x46c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHelper, addr 0x61eb480, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHostString, addr 0x61e1294, size 0x3c8, virtual false, abstract: false, final false
  inline void CreateHostString();

  /// @brief Method CreateHostStringHelper, addr 0x61e7bd0, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateThis, addr 0x61e16b8, size 0x1ac, virtual false, abstract: false, final false
  inline void CreateThis(::StringW uri, bool dontEscape, ::System::UriKind uriKind);

  /// @brief Method CreateThisFromUri, addr 0x61e1f50, size 0x11c, virtual false, abstract: false, final false
  inline void CreateThisFromUri(::System::Uri* otherUri);

  /// @brief Method CreateUri, addr 0x61e1968, size 0x190, virtual false, abstract: false, final false
  inline void CreateUri(::System::Uri* baseUri, ::StringW relativeUri, bool dontEscape);

  /// @brief Method CreateUriInfo, addr 0x61e007c, size 0x574, virtual false, abstract: false, final false
  inline void CreateUriInfo(::System::Uri_Flags cF);

  /// @brief Method EnsureHostString, addr 0x61e1234, size 0x60, virtual false, abstract: false, final false
  inline void EnsureHostString(bool allowDnsOptimization);

  /// @brief Method EnsureParseRemaining, addr 0x61e05f0, size 0x10, virtual false, abstract: false, final false
  inline void EnsureParseRemaining();

  /// @brief Method EnsureUriInfo, addr 0x61e0058, size 0x24, virtual false, abstract: false, final false
  inline ::System::Uri_UriInfo* EnsureUriInfo();

  /// @brief Method Equals, addr 0x61e5770, size 0x504, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method EscapeDataString, addr 0x61ec2e0, size 0x110, virtual false, abstract: false, final false
  static inline ::StringW EscapeDataString(::StringW stringToEscape);

  /// @brief Method EscapeUnescapeIri, addr 0x61e9cf0, size 0x20, virtual false, abstract: false, final false
  inline ::StringW EscapeUnescapeIri(::StringW input, int32_t start, int32_t end, ::System::UriComponents component);

  /// @brief Method EscapeUriString, addr 0x61ec1d0, size 0x110, virtual false, abstract: false, final false
  static inline ::StringW EscapeUriString(::StringW stringToEscape);

  /// @brief Method FindEndOfComponent, addr 0x61e9ce0, size 0x10, virtual false, abstract: false, final false
  inline void FindEndOfComponent(::StringW input, ::ByRef<uint16_t> idx, uint16_t end, char16_t delim);

  /// @brief Method FindEndOfComponent, addr 0x61ea97c, size 0x68, virtual false, abstract: false, final false
  inline void FindEndOfComponent(char16_t* str, ::ByRef<uint16_t> idx, uint16_t end, char16_t delim);

  /// @brief Method FromHex, addr 0x61e51f0, size 0x8c, virtual false, abstract: false, final false
  static inline int32_t FromHex(char16_t digit);

  /// @brief Method GetCanonicalPath, addr 0x61e9678, size 0x668, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCombinedString, addr 0x61e2274, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponents, addr 0x61e81c0, size 0x1a0, virtual false, abstract: false, final false
  inline ::StringW GetComponents(::System::UriComponents components, ::System::UriFormat format);

  /// @brief Method GetComponentsHelper, addr 0x61e5528, size 0x214, virtual false, abstract: false, final false
  inline ::StringW GetComponentsHelper(::System::UriComponents uriComponents, ::System::UriFormat uriFormat);

  /// @brief Method GetEscapedParts, addr 0x61e8360, size 0xd4, virtual false, abstract: false, final false
  inline ::StringW GetEscapedParts(::System::UriComponents uriParts);

  /// @brief Method GetException, addr 0x61e2e60, size 0x218, virtual false, abstract: false, final false
  static inline ::System::UriFormatException* GetException(::System::ParsingError err);

  /// @brief Method GetHashCode, addr 0x61e527c, size 0x134, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHostViaCustomSyntax, addr 0x61e77d4, size 0x3fc, virtual false, abstract: false, final false
  inline void GetHostViaCustomSyntax();

  /// @brief Method GetLocalPath, addr 0x61e3504, size 0x5e0, virtual false, abstract: false, final false
  inline ::StringW GetLocalPath();

  /// @brief Method GetObjectData, addr 0x61e3188, size 0xe0, virtual false, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetParts, addr 0x61e3268, size 0x4, virtual false, abstract: false, final false
  inline ::StringW GetParts(::System::UriComponents uriParts, ::System::UriFormat formatAs);

  /// @brief Method GetRelativeSerializationString, addr 0x61eb920, size 0x22c, virtual false, abstract: false, final false
  inline ::StringW GetRelativeSerializationString(::System::UriFormat format);

  /// @brief Method GetUnescapedParts, addr 0x61e4858, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW GetUnescapedParts(::System::UriComponents uriParts, ::System::UriFormat formatAs);

  /// @brief Method GetUriPartsFromUserString, addr 0x61e8434, size 0x5e0, virtual false, abstract: false, final false
  inline ::StringW GetUriPartsFromUserString(::System::UriComponents uriParts);

  /// @brief Method HexEscape, addr 0x61e4f04, size 0xf4, virtual false, abstract: false, final false
  static inline ::StringW HexEscape(char16_t character);

  /// @brief Method InFact, addr 0x61e003c, size 0x10, virtual false, abstract: false, final false
  inline bool InFact(::System::Uri_Flags flags);

  /// @brief Method InitializeUri, addr 0x61eac10, size 0x4bc, virtual false, abstract: false, final false
  inline void InitializeUri(::System::ParsingError err, ::System::UriKind uriKind, ::ByRef<::System::UriFormatException*> e);

  /// @brief Method InitializeUriConfig, addr 0x61e4250, size 0x19c, virtual false, abstract: false, final false
  static inline void InitializeUriConfig();

  /// @brief Method InternalEscapeString, addr 0x61e5df8, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW InternalEscapeString(::StringW rawString);

  /// @brief Method InternalIsWellFormedOriginalString, addr 0x61ebb74, size 0x434, virtual false, abstract: false, final false
  inline bool InternalIsWellFormedOriginalString();

  /// @brief Method IriParsingStatic, addr 0x61dfd78, size 0x88, virtual false, abstract: false, final false
  static inline bool IriParsingStatic(::System::UriParser* syntax);

  /// @brief Method IsAsciiLetter, addr 0x61e5138, size 0x18, virtual false, abstract: false, final false
  static inline bool IsAsciiLetter(char16_t character);

  /// @brief Method IsAsciiLetterOrDigit, addr 0x61e5150, size 0x70, virtual false, abstract: false, final false
  static inline bool IsAsciiLetterOrDigit(char16_t character);

  /// @brief Method IsBaseOf, addr 0x61ec400, size 0x84, virtual false, abstract: false, final false
  inline bool IsBaseOf(::System::Uri* uri);

  /// @brief Method IsBaseOfHelper, addr 0x61ec484, size 0x1c8, virtual false, abstract: false, final false
  inline bool IsBaseOfHelper(::System::Uri* uriLink);

  /// @brief Method IsBidiControlCharacter, addr 0x61eabe8, size 0x28, virtual false, abstract: false, final false
  static inline bool IsBidiControlCharacter(char16_t ch);

  /// @brief Method IsGenDelim, addr 0x61e4ff8, size 0x28, virtual false, abstract: false, final false
  static inline bool IsGenDelim(char16_t ch);

  /// @brief Method IsHexDigit, addr 0x61e51c0, size 0x30, virtual false, abstract: false, final false
  static inline bool IsHexDigit(char16_t character);

  /// @brief Method IsIntranet, addr 0x61dffb0, size 0x8, virtual false, abstract: false, final false
  inline bool IsIntranet(::StringW schemeHost);

  /// @brief Method IsLWS, addr 0x61e6a40, size 0x20, virtual false, abstract: false, final false
  static inline bool IsLWS(char16_t ch);

  /// @brief Method IsWellFormedOriginalString, addr 0x61ebb4c, size 0x28, virtual false, abstract: false, final false
  inline bool IsWellFormedOriginalString();

  /// @brief Method IsWellFormedUriString, addr 0x61ebfa8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method NotAny, addr 0x61dfec0, size 0x10, virtual false, abstract: false, final false
  inline bool NotAny(::System::Uri_Flags flags);

  /// @brief Method ParseMinimal, addr 0x61e6400, size 0x84, virtual false, abstract: false, final false
  inline ::System::UriFormatException* ParseMinimal();

  /// @brief Method ParseRemaining, addr 0x61e0600, size 0xc34, virtual false, abstract: false, final false
  inline void ParseRemaining();

  /// @brief Method ParseScheme, addr 0x61e5ebc, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseSchemeCheckImplicitFile, addr 0x61e5f8c, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method PrivateParseMinimal, addr 0x61e6484, size 0x5bc, virtual false, abstract: false, final false
  inline ::System::ParsingError PrivateParseMinimal();

  /// @brief Method PrivateParseMinimalIri, addr 0x61e7700, size 0xd4, virtual false, abstract: false, final false
  inline void PrivateParseMinimalIri(::StringW newHost, uint16_t idx);

  /// @brief Method ReCreateParts, addr 0x61e8a14, size 0xc64, virtual false, abstract: false, final false
  inline ::StringW ReCreateParts(::System::UriComponents parts, uint16_t nonCanonical, ::System::UriFormat formatAs);

  /// @brief Method ResolveHelper, addr 0x61e1af8, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUserDrivenParsing, addr 0x61dffc4, size 0x14, virtual false, abstract: false, final false
  inline void SetUserDrivenParsing();

  /// @brief Method StaticInFact, addr 0x61e004c, size 0xc, virtual false, abstract: false, final false
  static inline bool StaticInFact(::System::Uri_Flags allFlags, ::System::Uri_Flags checkFlags);

  /// @brief Method StaticIsFile, addr 0x61e4168, size 0x18, virtual false, abstract: false, final false
  static inline bool StaticIsFile(::System::UriParser* syntax);

  /// @brief Method StaticNotAny, addr 0x61dffa4, size 0xc, virtual false, abstract: false, final false
  static inline bool StaticNotAny(::System::Uri_Flags allFlags, ::System::Uri_Flags checkFlags);

  /// @brief Method StripBidiControlCharacter, addr 0x61ea814, size 0x168, virtual false, abstract: false, final false
  static inline ::StringW StripBidiControlCharacter(char16_t* strToClean, int32_t start, int32_t length);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x61e3184, size 0x4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method ToString, addr 0x61e5464, size 0xc4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryCreate, addr 0x61eb6cc, size 0xdc, virtual false, abstract: false, final false
  static inline bool TryCreate(::System::Uri* baseUri, ::StringW relativeUri, ::ByRef<::System::Uri*> result);

  /// @brief Method TryCreate, addr 0x61eb7a8, size 0x178, virtual false, abstract: false, final false
  static inline bool TryCreate(::System::Uri* baseUri, ::System::Uri* relativeUri, ::ByRef<::System::Uri*> result);

  /// @brief Method TryCreate, addr 0x61e5c74, size 0xc0, virtual false, abstract: false, final false
  static inline bool TryCreate(::StringW uriString, ::System::UriKind uriKind, ::ByRef<::System::Uri*> result);

  /// @brief Method UnescapeDataString, addr 0x61ec04c, size 0x184, virtual false, abstract: false, final false
  static inline ::StringW UnescapeDataString(::StringW stringToUnescape);

  /// @brief Method UnescapeOnly, addr 0x61ea9e4, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61e18c0, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* baseUri, ::StringW relativeUri);

  /// @brief Method .ctor, addr 0x61e206c, size 0x208, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* baseUri, ::System::Uri* relativeUri);

  /// @brief Method .ctor, addr 0x61ec3f0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri_Flags flags, ::System::UriParser* uriParser, ::StringW uri);

  /// @brief Method .ctor, addr 0x61e3078, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x61e165c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::StringW uriString);

  /// @brief Method .ctor, addr 0x61e1864, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AbsolutePath, addr 0x61e326c, size 0xb0, virtual false, abstract: false, final false
  inline ::StringW get_AbsolutePath();

  /// @brief Method get_AbsoluteUri, addr 0x61e33bc, size 0xec, virtual false, abstract: false, final false
  inline ::StringW get_AbsoluteUri();

  /// @brief Method get_AllowIdn, addr 0x61dfe00, size 0xc0, virtual false, abstract: false, final false
  inline bool get_AllowIdn();

  /// @brief Method get_Authority, addr 0x61e3ae4, size 0x64, virtual false, abstract: false, final false
  inline ::StringW get_Authority();

  /// @brief Method get_DnsSafeHost, addr 0x61e4c74, size 0x220, virtual false, abstract: false, final false
  inline ::StringW get_DnsSafeHost();

  /// @brief Method get_Fragment, addr 0x61e4adc, size 0xf0, virtual false, abstract: false, final false
  inline ::StringW get_Fragment();

  /// @brief Method get_HasAuthority, addr 0x61eabdc, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasAuthority();

  /// @brief Method get_Host, addr 0x61e4104, size 0x64, virtual false, abstract: false, final false
  inline ::StringW get_Host();

  /// @brief Method get_HostNameType, addr 0x61e3b48, size 0xec, virtual false, abstract: false, final false
  inline ::System::UriHostNameType get_HostNameType();

  /// @brief Method get_HostType, addr 0x61dfd54, size 0xc, virtual false, abstract: false, final false
  inline ::System::Uri_Flags get_HostType();

  /// @brief Method get_InitializeLock, addr 0x61e4180, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Object* get_InitializeLock();

  /// @brief Method get_IsAbsoluteUri, addr 0x61e1958, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsAbsoluteUri();

  /// @brief Method get_IsDefaultPort, addr 0x61e3c34, size 0x9c, virtual false, abstract: false, final false
  inline bool get_IsDefaultPort();

  /// @brief Method get_IsDosPath, addr 0x61dfd3c, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsDosPath();

  /// @brief Method get_IsFile, addr 0x61e3cd0, size 0xbc, virtual false, abstract: false, final false
  inline bool get_IsFile();

  /// @brief Method get_IsImplicitFile, addr 0x61dfd20, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsImplicitFile();

  /// @brief Method get_IsLoopback, addr 0x61e3d8c, size 0x78, virtual false, abstract: false, final false
  inline bool get_IsLoopback();

  /// @brief Method get_IsNotAbsoluteUri, addr 0x61dfd68, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsNotAbsoluteUri();

  /// @brief Method get_IsUnc, addr 0x61e40a0, size 0x64, virtual false, abstract: false, final false
  inline bool get_IsUnc();

  /// @brief Method get_IsUncOrDosPath, addr 0x61dfd2c, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsUncOrDosPath();

  /// @brief Method get_IsUncPath, addr 0x61dfd48, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsUncPath();

  /// @brief Method get_LocalPath, addr 0x61e34a8, size 0x5c, virtual false, abstract: false, final false
  inline ::StringW get_LocalPath();

  /// @brief Method get_OriginalString, addr 0x61e2588, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_OriginalString();

  /// @brief Method get_OriginalStringSwitched, addr 0x61e4c2c, size 0x48, virtual false, abstract: false, final false
  inline bool get_OriginalStringSwitched();

  /// @brief Method get_PathAndQuery, addr 0x61e3e04, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW get_PathAndQuery();

  /// @brief Method get_Port, addr 0x61e4934, size 0xb8, virtual false, abstract: false, final false
  inline int32_t get_Port();

  /// @brief Method get_PrivateAbsolutePath, addr 0x61e331c, size 0xa0, virtual false, abstract: false, final false
  inline ::StringW get_PrivateAbsolutePath();

  /// @brief Method get_Query, addr 0x61e49ec, size 0xf0, virtual false, abstract: false, final false
  inline ::StringW get_Query();

  /// @brief Method get_Scheme, addr 0x61e4bcc, size 0x60, virtual false, abstract: false, final false
  inline ::StringW get_Scheme();

  /// @brief Method get_SecuredPathIndex, addr 0x61dffd8, size 0x64, virtual false, abstract: false, final false
  inline uint16_t get_SecuredPathIndex();

  /// @brief Method get_Segments, addr 0x61e3ebc, size 0x1e4, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Segments();

  /// @brief Method get_Syntax, addr 0x61dfd60, size 0x8, virtual false, abstract: false, final false
  inline ::System::UriParser* get_Syntax();

  /// @brief Method get_UserDrivenParsing, addr 0x61dffb8, size 0xc, virtual false, abstract: false, final false
  inline bool get_UserDrivenParsing();

  /// @brief Method get_UserEscaped, addr 0x61e4e94, size 0xc, virtual false, abstract: false, final false
  inline bool get_UserEscaped();

  /// @brief Method get_UserInfo, addr 0x61e4ea0, size 0x64, virtual false, abstract: false, final false
  inline ::StringW get_UserInfo();

  /// @brief Convert to "::System::Runtime::Serialization::ISerializable"
  constexpr ::System::Runtime::Serialization::ISerializable* i___System__Runtime__Serialization__ISerializable() noexcept;

  /// @brief Method op_Equality, addr 0x61e573c, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Uri* uri1, ::System::Uri* uri2);

  /// @brief Method op_Inequality, addr 0x61e1f08, size 0x48, virtual false, abstract: false, final false
