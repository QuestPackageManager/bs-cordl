...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Action_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Action_5(Action_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Action_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Action_5(Action_5const&) = delete;
