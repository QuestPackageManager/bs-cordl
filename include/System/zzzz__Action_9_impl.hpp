...
inline ::System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9>* System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9>::New_ctor(::System::Object* object, void* method) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9>*>(object, method));
}
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
inline void System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9>::_ctor(::System::Object* object, void* method) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
