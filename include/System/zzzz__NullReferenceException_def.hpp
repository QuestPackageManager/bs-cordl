...
public:
  ...
  /// @brief Method .ctor addr 0x2454054 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::NullReferenceException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x24540b0 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24540d4 size 0x8 virtual false final false
