...
public:
  ...
  /// @brief Method .ctor, addr 0x25d2e94, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::NullReferenceException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25d2ef0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d2f14, size 0x8, virtual false, abstract: false, final false
