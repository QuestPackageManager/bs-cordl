...
public:
  ...
  /// @brief Method .ctor, addr 0x5b2ab3c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b2aad0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::ConsoleSpecialKey type);

  /// @brief Method get_Cancel, addr 0x5b2ab34, size 0x8, virtual false, abstract: false, final false
