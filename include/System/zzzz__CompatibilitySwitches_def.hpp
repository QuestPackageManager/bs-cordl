...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompatibilitySwitches", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompatibilitySwitches(CompatibilitySwitches&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompatibilitySwitches", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompatibilitySwitches(CompatibilitySwitchesconst&) = delete;
