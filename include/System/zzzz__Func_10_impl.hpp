...
inline void System::Func_10<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Func_10<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>*>(),
...
inline TResult System::Func_10<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>::Invoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8, T9 arg9) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Func_10<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>*>(), 13 })));
