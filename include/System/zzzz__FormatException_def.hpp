...
public:
  ...
  /// @brief Method .ctor, addr 0x25b9150, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::FormatException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25b91ac, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  static inline ::System::FormatException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x25b91d0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b91f4, size 0x8, virtual false, abstract: false, final false
