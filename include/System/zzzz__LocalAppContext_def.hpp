...
/// @brief Method .ctor, addr 0x5e493fc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_DisableCaching>b__6_0, addr 0x5e49400, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetCachedSwitchValue, addr 0x5e491cc, size 0x20, virtual false, abstract: false, final false
static inline bool GetCachedSwitchValue(::StringW  switchName, ::ByRef<int32_t>  switchValue) ;

/// @brief Method GetCachedSwitchValueInternal, addr 0x5e491ec, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_DisableCaching, addr 0x5e49284, size 0x124, virtual false, abstract: false, final false
