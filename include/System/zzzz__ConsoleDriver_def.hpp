...
public:
  ...
  /// @brief Method CreateNullConsoleDriver, addr 0x2997cdc, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::IConsoleDriver* CreateNullConsoleDriver();

  /// @brief Method CreateTermInfoDriver, addr 0x2997d84, size 0x60, virtual false, abstract: false, final false
  static inline ::System::IConsoleDriver* CreateTermInfoDriver(::StringW term);

  /// @brief Method CreateWindowsConsoleDriver, addr 0x2997d28, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::IConsoleDriver* CreateWindowsConsoleDriver();

  /// @brief Method InternalKeyAvailable, addr 0x2998134, size 0x4, virtual false, abstract: false, final false
  static inline int32_t InternalKeyAvailable(int32_t ms_timeout);

  /// @brief Method Isatty, addr 0x2998130, size 0x4, virtual false, abstract: false, final false
  static inline bool Isatty(::System::IntPtr handle);

  /// @brief Method ReadKey, addr 0x29976a0, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::ConsoleKeyInfo ReadKey(bool intercept);

  /// @brief Method SetEcho, addr 0x299813c, size 0x8, virtual false, abstract: false, final false
  static inline bool SetEcho(bool wantEcho);

  /// @brief Method TtySetup, addr 0x2998138, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsConsole, addr 0x2996ef0, size 0x138, virtual false, abstract: false, final false
