...
/// @brief Method System.IFormattable.ToString, addr 0x5a80dac, size 0x10, virtual true, abstract: false, final true
inline ::StringW System_IFormattable_ToString(::StringW  ignored, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method ToString, addr 0x5a80dbc, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a80e28, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
