...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x440aa3c, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseCanonicalName, addr 0x440aa38, size 0x4, virtual false, abstract: false, final false
