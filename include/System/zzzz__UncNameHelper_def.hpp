...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x61c563c, size 0x2cc, virtual false, abstract: false, final false
  static inline bool IsValid(char16_t* name, uint16_t start, ::ByRef<int32_t> returnedEnd, bool notImplicitFile);

  /// @brief Method ParseCanonicalName, addr 0x61c5638, size 0x4, virtual false, abstract: false, final false
