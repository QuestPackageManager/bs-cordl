...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x44111f4, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseCanonicalName, addr 0x44111f0, size 0x4, virtual false, abstract: false, final false
