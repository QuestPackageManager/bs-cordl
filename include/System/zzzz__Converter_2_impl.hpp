...
template <typename TInput, typename TOutput> inline void System::Converter_2<TInput, TOutput>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Converter_2<TInput, TOutput>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
