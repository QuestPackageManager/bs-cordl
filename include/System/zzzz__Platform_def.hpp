...
public:
  ...
  /// @brief Method CheckOS, addr 0x441d5e0, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsAix, addr 0x441d9e0, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsAix();

  /// @brief Method get_IsFreeBSD, addr 0x441d8cc, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsFreeBSD();

  /// @brief Method get_IsIBMi, addr 0x441d984, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsIBMi();

  /// @brief Method get_IsMacOS, addr 0x441d7ec, size 0xe0, virtual false, abstract: false, final false
  static inline bool get_IsMacOS();

  /// @brief Method get_IsOpenBSD, addr 0x441d928, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method uname, addr 0x441d564, size 0x7c, virtual false, abstract: false, final false
