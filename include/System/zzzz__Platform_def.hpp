...
public:
  ...
  /// @brief Method CheckOS, addr 0x2a98d2c, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsAix, addr 0x2a9912c, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsAix();

  /// @brief Method get_IsFreeBSD, addr 0x2a99018, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsFreeBSD();

  /// @brief Method get_IsIBMi, addr 0x2a990d0, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsIBMi();

  /// @brief Method get_IsMacOS, addr 0x2a98f38, size 0xe0, virtual false, abstract: false, final false
  static inline bool get_IsMacOS();

  /// @brief Method get_IsOpenBSD, addr 0x2a99074, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method uname, addr 0x2a98cb0, size 0x7c, virtual false, abstract: false, final false
