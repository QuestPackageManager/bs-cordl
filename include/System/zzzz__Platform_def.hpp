...
public:
  ...
  /// @brief Method CheckOS, addr 0x61c5d74, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsAix, addr 0x61c6180, size 0x60, virtual false, abstract: false, final false
  static inline bool get_IsAix();

  /// @brief Method get_IsFreeBSD, addr 0x61c6060, size 0x60, virtual false, abstract: false, final false
  static inline bool get_IsFreeBSD();

  /// @brief Method get_IsIBMi, addr 0x61c6120, size 0x60, virtual false, abstract: false, final false
  static inline bool get_IsIBMi();

  /// @brief Method get_IsMacOS, addr 0x61c5f74, size 0xec, virtual false, abstract: false, final false
  static inline bool get_IsMacOS();

  /// @brief Method get_IsOpenBSD, addr 0x61c60c0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method uname, addr 0x61c5cf8, size 0x7c, virtual false, abstract: false, final false
