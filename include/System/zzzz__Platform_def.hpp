...
public:
  ...
  /// @brief Method CheckOS, addr 0x2e821d8, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsAix, addr 0x2e825d8, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsAix();

  /// @brief Method get_IsFreeBSD, addr 0x2e824c4, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsFreeBSD();

  /// @brief Method get_IsIBMi, addr 0x2e8257c, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_IsIBMi();

  /// @brief Method get_IsMacOS, addr 0x2e823e4, size 0xe0, virtual false, abstract: false, final false
  static inline bool get_IsMacOS();

  /// @brief Method get_IsOpenBSD, addr 0x2e82520, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method uname, addr 0x2e8215c, size 0x7c, virtual false, abstract: false, final false
