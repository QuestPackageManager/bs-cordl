...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Action_7);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Action_7, "System", "Action`7");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Action_7", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Action_7(Action_7&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Action_7", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Action_7(Action_7const&) = delete;
