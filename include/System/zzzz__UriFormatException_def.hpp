...
public:
  ...
  /// @brief Method .ctor, addr 0x294e188, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::UriFormatException* New_ctor(::StringW textString);

  /// @brief Method .ctor, addr 0x294c368, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x294e190, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x294e198, size 0x8, virtual true, abstract: false, final true
