...
public:
  // Declarations
  /// @brief Method IdnEquivalent, addr 0x62371c0, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method IdnEquivalent, addr 0x6237448, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsASCIILetterOrDigit, addr 0x6236f4c, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsASCIILetterOrDigit(char16_t character, ::ByRef<bool> notCanonical);

  /// @brief Method IsIdnAce, addr 0x6237684, size 0x90, virtual false, abstract: false, final false
  static inline bool IsIdnAce(::StringW input, int32_t index);

  /// @brief Method IsIdnAce, addr 0x6237638, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsIdnAce(char16_t* input, int32_t index);

  /// @brief Method IsValid, addr 0x6236dd8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidByIri, addr 0x6236fd4, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidDomainLabelCharacter, addr 0x6236f88, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsValidDomainLabelCharacter(char16_t character, ::ByRef<bool> notCanonical);

  /// @brief Method ParseCanonicalName, addr 0x6236c48, size 0x190, virtual false, abstract: false, final false
  static inline ::StringW ParseCanonicalName(::StringW str, int32_t start, int32_t end, ::ByRef<bool> loopback);

  /// @brief Method UnicodeEquivalent, addr 0x6237830, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnicodeEquivalent, addr 0x6237714, size 0x11c, virtual false, abstract: false, final false
