#pragma once
// IWYU pragma private; include "System/ValueTuple_3.hpp"
...
DEFINE_IL2CPP_GEN_CLASS(::System::ValueTuple_3, "System", "ValueTuple`3");
// Dependencies
namespace System {
// cpp template
...
public:
  ...
  constexpr ::System::IComparable_1<::System::ValueTuple_3<T1, T2, T3>>* i___System__IComparable_1___System__ValueTuple_3_T1_T2_T3__();

  /// @brief Convert to "::System::IEquatable_1<::System::ValueTuple_3<T1,T2,T3>>"
  constexpr ::System::IEquatable_1<::System::ValueTuple_3<T1, T2, T3>>* i___System__IEquatable_1___System__ValueTuple_3_T1_T2_T3__();
  ...
  // { name: "Item3", ty: "T3", modifiers: "", def_value: None, comment: None }]
  constexpr ValueTuple_3(T1 Item1, T2 Item2, T3 Item3) noexcept;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 2513 };
