...
// Ctor Parameters [CppParam { name: "s", ty: "::System::ReadOnlySpan_1<char16_t>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "index", ty: "int32_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "length", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "type", ty: "::System::DTSubStringType",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "value", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
