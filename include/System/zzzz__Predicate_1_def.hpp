...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Predicate_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Predicate_1(Predicate_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Predicate_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Predicate_1(Predicate_1const&) = delete;
