...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5a718ac, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method SetMessageField, addr 0x5a719cc, size 0x7c, virtual false, abstract: false, final false
  inline void SetMessageField();

  /// @brief Method ToString, addr 0x5a71a48, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a71710, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a717ec, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5a71770, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5a717b8, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::StringW fileName);

  /// @brief Method .ctor, addr 0x5a71794, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* inner);

  /// @brief Method get_Message, addr 0x5a719b4, size 0x18, virtual true, abstract: false, final false
