...
namespace System {
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename TResult> class Func_9;
}
// Write type traits
MARK_GEN_REF_T_PTR(::System::Func_9);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Func_9, "System", "Func`9");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Func_9", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Func_9(Func_9&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Func_9", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Func_9(Func_9const&) = delete;
