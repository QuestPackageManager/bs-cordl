...
public:
  ...
  /// @brief Method Equals, addr 0x2b4e5e4, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExpression, addr 0x2b4e6c4, size 0x380, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression();

  /// @brief Method GetHashCode, addr 0x2b4e678, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b4dd88, size 0x70, virtual false, abstract: false, final false
