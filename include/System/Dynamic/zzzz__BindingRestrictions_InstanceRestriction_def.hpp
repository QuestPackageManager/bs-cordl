...
public:
  ...
  /// @brief Method Equals, addr 0x5e80258, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExpression, addr 0x5e8033c, size 0x370, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression();

  /// @brief Method GetHashCode, addr 0x5e802f0, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7f9a4, size 0x68, virtual false, abstract: false, final false
