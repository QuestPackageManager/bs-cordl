...
public:
  ...
  /// @brief Method Equals, addr 0x5fc26e4, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExpression, addr 0x5fc27c8, size 0x370, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression();

  /// @brief Method GetHashCode, addr 0x5fc277c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fc1e30, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BindingRestrictions_InstanceRestriction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BindingRestrictions_InstanceRestriction(BindingRestrictions_InstanceRestriction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BindingRestrictions_InstanceRestriction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BindingRestrictions_InstanceRestriction(BindingRestrictions_InstanceRestrictionconst&) = delete;
