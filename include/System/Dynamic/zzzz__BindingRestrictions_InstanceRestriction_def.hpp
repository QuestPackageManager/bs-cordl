...
public:
  ...
  /// @brief Method Equals, addr 0x40f73d0, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExpression, addr 0x40f74b0, size 0x378, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression();

  /// @brief Method GetHashCode, addr 0x40f7464, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f6b7c, size 0x70, virtual false, abstract: false, final false
