...
/// @brief Method Bind, addr 0x5e87fc8, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method FallbackGetMember, addr 0x5e86c78, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e87f10, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  ignoreCase) ;

/// @brief Method get_IgnoreCase, addr 0x5e87fc0, size 0x8, virtual false, abstract: false, final false
inline bool get_IgnoreCase() ;

/// @brief Method get_IsStandardBinder, addr 0x5e880ac, size 0x8, virtual true, abstract: false, final true
inline bool get_IsStandardBinder() ;

/// @brief Method get_Name, addr 0x5e87fb8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_ReturnType, addr 0x5e87f88, size 0x30, virtual true, abstract: false, final true
