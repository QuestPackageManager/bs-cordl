...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BindingRestrictions_CustomRestriction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BindingRestrictions_CustomRestriction(BindingRestrictions_CustomRestriction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BindingRestrictions_CustomRestriction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BindingRestrictions_CustomRestriction(BindingRestrictions_CustomRestrictionconst&) = delete;
