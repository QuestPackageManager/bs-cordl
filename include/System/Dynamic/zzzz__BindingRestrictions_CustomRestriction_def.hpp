...
public:
  ...
  /// @brief Method Equals, addr 0x40f71b0, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExpression, addr 0x40f7250, size 0x8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression();

  /// @brief Method GetHashCode, addr 0x40f7220, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f6ca0, size 0x6c, virtual false, abstract: false, final false
