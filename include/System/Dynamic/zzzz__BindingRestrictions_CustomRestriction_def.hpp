...
public:
  ...
  /// @brief Method Equals, addr 0x5e0d950, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExpression, addr 0x5e0d9fc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression();

  /// @brief Method GetHashCode, addr 0x5e0d9cc, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0d400, size 0x64, virtual false, abstract: false, final false
