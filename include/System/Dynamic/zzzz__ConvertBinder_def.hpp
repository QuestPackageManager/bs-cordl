...
public:
  ...
  /// @brief Method Bind, addr 0x5fbd338, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackConvert, addr 0x5fbd328, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x5fbd320, size 0x8, virtual false, abstract: false, final false
