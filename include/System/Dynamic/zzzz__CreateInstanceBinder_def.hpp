...
public:
  // Declarations
  /// @brief Method Bind, addr 0x5fbd400, size 0xc4, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackCreateInstance, addr 0x5fbd3f0, size 0x10, virtual false, abstract: false, final false
