...
public:
// Declarations
/// @brief Method Bind, addr 0x5e0e780, size 0xc4, virtual true, abstract: false, final true
...
/// @brief Method FallbackCreateInstance, addr 0x5e0e770, size 0x10, virtual false, abstract: false, final false
