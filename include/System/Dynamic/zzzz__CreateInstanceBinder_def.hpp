...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CreateInstanceBinder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CreateInstanceBinder(CreateInstanceBinder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CreateInstanceBinder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CreateInstanceBinder(CreateInstanceBinderconst&) = delete;
