...
/// @brief Method Bind, addr 0x5e830d0, size 0x5cc, virtual true, abstract: false, final true
...
/// @brief Method CreateArgumentMetaObjects, addr 0x5e8369c, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method GetUpdateExpression, addr 0x5e8383c, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e83048, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsStandardBinder, addr 0x5e83914, size 0x8, virtual true, abstract: false, final false
inline bool get_IsStandardBinder() ;

/// @brief Method get_ReturnType, addr 0x5e830a0, size 0x30, virtual true, abstract: false, final false
