...
public:
  ...
  /// @brief Method Bind, addr 0x5da7300, size 0x5cc, virtual true, abstract: false, final true
  ...
  /// @brief Method CreateArgumentMetaObjects, addr 0x5da78cc, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUpdateExpression, addr 0x5da7a6c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5da7278, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsStandardBinder, addr 0x5da7b44, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsStandardBinder();

  /// @brief Method get_ReturnType, addr 0x5da72d0, size 0x30, virtual true, abstract: false, final false
