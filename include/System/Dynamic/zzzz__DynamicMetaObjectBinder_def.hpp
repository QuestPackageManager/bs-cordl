...
public:
  ...
  /// @brief Method Bind, addr 0x2b4f87c, size 0x5fc, virtual true, abstract: false, final true
  ...
  /// @brief Method CreateArgumentMetaObjects, addr 0x2b4fe78, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUpdateExpression, addr 0x2b50004, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b4f7b8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsStandardBinder, addr 0x2b500c4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsStandardBinder();

  /// @brief Method get_ReturnType, addr 0x2b4f810, size 0x6c, virtual true, abstract: false, final false
