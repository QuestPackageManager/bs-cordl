...
public:
  ...
  /// @brief Method Bind, addr 0x5fbe1cc, size 0x5cc, virtual true, abstract: false, final true
  ...
  /// @brief Method CreateArgumentMetaObjects, addr 0x5fbe798, size 0x1a0, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Dynamic::DynamicMetaObject*>
  CreateArgumentMetaObjects(::ArrayW<::System::Object*> args, ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ParameterExpression*>* parameters);

  /// @brief Method GetUpdateExpression, addr 0x5fbe938, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbe144, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsStandardBinder, addr 0x5fbea10, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsStandardBinder();

  /// @brief Method get_ReturnType, addr 0x5fbe19c, size 0x30, virtual true, abstract: false, final false
