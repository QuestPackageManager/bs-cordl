...
public:
  ...
  /// @brief Method GetExpression, addr 0x40fa5b8, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f9d30, size 0x70, virtual false, abstract: false, final false
