...
public:
  ...
  /// @brief Method GetExpression, addr 0x40fbfd8, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40fb750, size 0x70, virtual false, abstract: false, final false
