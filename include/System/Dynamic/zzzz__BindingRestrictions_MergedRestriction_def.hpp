...
public:
  ...
  /// @brief Method GetExpression, addr 0x40fd81c, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40fcf94, size 0x70, virtual false, abstract: false, final false
