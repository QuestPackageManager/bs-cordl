...
public:
  ...
  /// @brief Method GetExpression, addr 0x2c6e260, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c6d9c4, size 0x70, virtual false, abstract: false, final false
