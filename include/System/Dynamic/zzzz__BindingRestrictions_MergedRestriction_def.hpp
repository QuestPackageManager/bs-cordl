...
/// @brief Method GetExpression, addr 0x5e0dea4, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e0d5f0, size 0x68, virtual false, abstract: false, final false
