...
public:
  ...
  /// @brief Method GetExpression, addr 0x5fbcb24, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbc270, size 0x68, virtual false, abstract: false, final false
