...
public:
  ...
  /// @brief Method BindBinaryOperation, addr 0x40fb764, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method BindConvert, addr 0x40fb22c, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindConvert(::System::Dynamic::ConvertBinder* binder);

  /// @brief Method BindCreateInstance, addr 0x40fb674, size 0x80, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindCreateInstance(::System::Dynamic::CreateInstanceBinder* binder,
                                                                  ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> args);

  /// @brief Method BindDeleteIndex, addr 0x40fb504, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method BindDeleteMember, addr 0x40fb38c, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindDeleteMember(::System::Dynamic::DeleteMemberBinder* binder);

  /// @brief Method BindGetIndex, addr 0x40fb404, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindGetIndex(::System::Dynamic::GetIndexBinder* binder,
                                                            ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> indexes);

  /// @brief Method BindGetMember, addr 0x40fb2a4, size 0x70, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindGetMember(::System::Dynamic::GetMemberBinder* binder);

  /// @brief Method BindInvoke, addr 0x40fb5fc, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindInvoke(::System::Dynamic::InvokeBinder* binder,
                                                          ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> args);

  /// @brief Method BindInvokeMember, addr 0x40fb584, size 0x78, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindInvokeMember(::System::Dynamic::InvokeMemberBinder* binder,
                                                                ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> args);

  /// @brief Method BindSetIndex, addr 0x40fb47c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method BindSetMember, addr 0x40fb314, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method BindUnaryOperation, addr 0x40fb6f4, size 0x70, virtual true, abstract: false, final false
  inline ::System::Dynamic::DynamicMetaObject* BindUnaryOperation(::System::Dynamic::UnaryOperationBinder* binder);

  /// @brief Method Create, addr 0x40fb870, size 0x1b0, virtual false, abstract: false, final false
  static inline ::System::Dynamic::DynamicMetaObject* Create(::System::Object* value, ::System::Linq::Expressions::Expression* expression);

  /// @brief Method GetDynamicMemberNames, addr 0x40fb7e4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40fb0b0, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* expression, ::System::Dynamic::BindingRestrictions* restrictions);

  /// @brief Method .ctor, addr 0x40fb180, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Expression, addr 0x40fb1a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Expression();

  /// @brief Method get_HasValue, addr 0x40f9fa8, size 0x68, virtual false, abstract: false, final false
  inline bool get_HasValue();

  /// @brief Method get_LimitType, addr 0x40fa09c, size 0x34, virtual false, abstract: false, final false
  inline ::System::Type* get_LimitType();

  /// @brief Method get_Restrictions, addr 0x40fb1ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Dynamic::BindingRestrictions* get_Restrictions();

  /// @brief Method get_RuntimeType, addr 0x40fb1b4, size 0x78, virtual false, abstract: false, final false
  inline ::System::Type* get_RuntimeType();

  /// @brief Method get_Value, addr 0x40f9f84, size 0x24, virtual false, abstract: false, final false
