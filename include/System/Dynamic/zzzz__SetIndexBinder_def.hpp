...
public:
  // Declarations
  /// @brief Method Bind, addr 0x5fc8b60, size 0x134, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackSetIndex, addr 0x5fc8c94, size 0x10, virtual false, abstract: false, final false
