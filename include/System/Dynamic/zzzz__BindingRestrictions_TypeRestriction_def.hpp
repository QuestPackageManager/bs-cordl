...
// Write type traits
MARK_REF_T(::GlobalNamespace::BindingRestrictions_TypeRestriction*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BindingRestrictions_TypeRestriction*, "System.Dynamic", "BindingRestrictions/TypeRestriction");
...
public:
  ...
  /// @brief Method Equals, addr 0x5fbcd44, size 0xd0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExpression, addr 0x5fbce68, size 0x64, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression();

  /// @brief Method GetHashCode, addr 0x5fbce14, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbc394, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BindingRestrictions_TypeRestriction) == 0x20, "Size mismatch!");
