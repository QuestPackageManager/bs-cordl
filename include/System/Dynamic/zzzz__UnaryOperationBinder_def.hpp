...
public:
// Declarations
/// @brief Method Bind, addr 0x5e149c0, size 0xb4, virtual true, abstract: false, final true
...
/// @brief Method FallbackUnaryOperation, addr 0x5e149b0, size 0x10, virtual false, abstract: false, final false
