...
public:
  // Declarations
  /// @brief Method Bind, addr 0x5fc8e58, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackUnaryOperation, addr 0x5fc8e48, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnaryOperationBinder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnaryOperationBinder(UnaryOperationBinder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnaryOperationBinder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnaryOperationBinder(UnaryOperationBinderconst&) = delete;
