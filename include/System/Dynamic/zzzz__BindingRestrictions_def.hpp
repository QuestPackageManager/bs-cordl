...
public:
  ...
  /// @brief Method Append, addr 0x5e7fb30, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method Push, addr 0x5e7fbd8, size 0x138, virtual false, abstract: false, final false
  inline void Push(::System::Linq::Expressions::Expression* node, int32_t depth);

  /// @brief Method ToExpression, addr 0x5e7fd10, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7fdf4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetInstanceRestriction, addr 0x5e7f8dc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeRestriction, addr 0x5e7f664, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeRestriction, addr 0x5e7f788, size 0xc4, virtual false, abstract: false, final false
  static inline ::System::Dynamic::BindingRestrictions* GetTypeRestriction(::System::Dynamic::DynamicMetaObject* obj);

  /// @brief Method Merge, addr 0x5e7f500, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToExpression, addr 0x5e7fa0c, size 0xc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ToExpression();

  /// @brief Method .ctor, addr 0x5e7f4fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
