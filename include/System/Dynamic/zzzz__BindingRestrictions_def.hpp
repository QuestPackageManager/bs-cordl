...
public:
  ...
  /// @brief Method Append, addr 0x410914c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Push, addr 0x41091d8, size 0x134, virtual false, abstract: false, final false
  inline void Push(::System::Linq::Expressions::Expression* node, int32_t depth);

  /// @brief Method ToExpression, addr 0x410930c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41093e0, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetInstanceRestriction, addr 0x4108efc, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeRestriction, addr 0x4108c8c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeRestriction, addr 0x4108db4, size 0xbc, virtual false, abstract: false, final false
  static inline ::System::Dynamic::BindingRestrictions* GetTypeRestriction(::System::Dynamic::DynamicMetaObject* obj);

  /// @brief Method Merge, addr 0x4108b2c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToExpression, addr 0x410902c, size 0xc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ToExpression();

  /// @brief Method .ctor, addr 0x4108b24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
