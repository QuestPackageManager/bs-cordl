...
public:
  ...
  /// @brief Method Bind, addr 0x40f7aac, size 0xb0, virtual true, abstract: false, final true
  inline ::System::Dynamic::DynamicMetaObject* Bind(::System::Dynamic::DynamicMetaObject* target,
                                                    ::ArrayW<::System::Dynamic::DynamicMetaObject*, ::Array<::System::Dynamic::DynamicMetaObject*>*> args);

  /// @brief Method FallbackDeleteMember, addr 0x40f7a9c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IgnoreCase, addr 0x40f7a94, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreCase();

  /// @brief Method get_Name, addr 0x40f7a8c, size 0x8, virtual false, abstract: false, final false
