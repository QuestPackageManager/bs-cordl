...
/// @brief Method Bind, addr 0x5e148c4, size 0xd4, virtual true, abstract: false, final true
...
/// @brief Method FallbackSetMember, addr 0x5e149a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e1480c, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  ignoreCase) ;

/// @brief Method get_IgnoreCase, addr 0x5e148bc, size 0x8, virtual false, abstract: false, final false
inline bool get_IgnoreCase() ;

/// @brief Method get_IsStandardBinder, addr 0x5e14998, size 0x8, virtual true, abstract: false, final true
inline bool get_IsStandardBinder() ;

/// @brief Method get_Name, addr 0x5e148b4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_ReturnType, addr 0x5e14884, size 0x30, virtual true, abstract: false, final true
