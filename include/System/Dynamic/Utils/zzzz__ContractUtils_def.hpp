...
public:
  // Declarations
  /// @brief Method GetParamName, addr 0x2c76034, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW GetParamName(::StringW paramName, int32_t index);

  /// @brief Method Requires, addr 0x2c759c4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresNotNull, addr 0x2c736f4, size 0x54, virtual false, abstract: false, final false
  static inline void RequiresNotNull(::System::Object* value, ::StringW paramName);

  /// @brief Method RequiresNotNull, addr 0x2c75fd4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Unreachable, addr 0x2c75f60, size 0x74, virtual false, abstract: false, final false
