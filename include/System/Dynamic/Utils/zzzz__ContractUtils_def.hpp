...
public:
  // Declarations
  /// @brief Method GetParamName, addr 0x5fc37cc, size 0xb0, virtual false, abstract: false, final false
  static inline ::StringW GetParamName(::StringW paramName, int32_t index);

  /// @brief Method Requires, addr 0x5fc3174, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresNotNull, addr 0x5fc1018, size 0x4c, virtual false, abstract: false, final false
  static inline void RequiresNotNull(::System::Object* value, ::StringW paramName);

  /// @brief Method RequiresNotNull, addr 0x5fc3774, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Unreachable, addr 0x5fc36f4, size 0x80, virtual false, abstract: false, final false
