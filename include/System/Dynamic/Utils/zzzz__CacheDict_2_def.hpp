...
/// @brief Field _entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::ArrayW<::System::Dynamic::Utils::CacheDict_2_Entry<TKey,TValue>*,::Array<::System::Dynamic::Utils::CacheDict_2_Entry<TKey,TValue>*>*>  _entries;
