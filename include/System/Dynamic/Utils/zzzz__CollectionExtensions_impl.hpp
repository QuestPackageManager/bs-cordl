...
inline ::System::Runtime::CompilerServices::TrueReadOnlyCollection_1<T>* System::Dynamic::Utils::CollectionExtensions::AddFirst(::System::Collections::ObjectModel::ReadOnlyCollection_1<T>* list,
  ...
  static auto* ___internal_method_base = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Dynamic::Utils::CollectionExtensions*>::get(), "AddFirst",
...
template <typename T> inline ::ArrayW<T, ::Array<T>*> System::Dynamic::Utils::CollectionExtensions::AddLast(::ArrayW<T, ::Array<T>*> array, T item) {
  static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Dynamic::Utils::CollectionExtensions*>::get(), "AddLast",
      std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
...
template <typename T> inline ::ArrayW<T, ::Array<T>*> System::Dynamic::Utils::CollectionExtensions::RemoveFirst(::ArrayW<T, ::Array<T>*> array) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Dynamic::Utils::CollectionExtensions*>::get(), "RemoveFirst",
                                               std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
...
template <typename T> inline ::ArrayW<T, ::Array<T>*> System::Dynamic::Utils::CollectionExtensions::RemoveLast(::ArrayW<T, ::Array<T>*> array) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Dynamic::Utils::CollectionExtensions*>::get(), "RemoveLast",
                                               std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
                                               ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<T, ::Array<T>*>>::get() })));
  static auto* ___internal_method =
      THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal_method_base, std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() }));
...
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<T>* System::Dynamic::Utils::CollectionExtensions::ToReadOnly(::System::Collections::Generic::IEnumerable_1<T>* enumerable) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Dynamic::Utils::CollectionExtensions*>::get(), "ToReadOnly",
                                               std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
