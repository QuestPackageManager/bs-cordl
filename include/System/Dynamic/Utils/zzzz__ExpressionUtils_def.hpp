...
public:
  // Declarations
  /// @brief Method GetParametersForValidation, addr 0x5e86ec0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresCanRead, addr 0x5e876b0, size 0x8, virtual false, abstract: false, final false
  static inline void RequiresCanRead(::System::Linq::Expressions::Expression* expression, ::StringW paramName);

  /// @brief Method RequiresCanRead, addr 0x5e8722c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method TryQuote, addr 0x5e8758c, size 0x124, virtual false, abstract: false, final false
  static inline bool TryQuote(::System::Type* parameterType, ::ByRef<::System::Linq::Expressions::Expression*> argument);

  /// @brief Method ValidateArgumentCount, addr 0x5e87884, size 0xd8, virtual false, abstract: false, final false
  static inline void ValidateArgumentCount(::System::Linq::Expressions::LambdaExpression* lambda);

  /// @brief Method ValidateArgumentCount, addr 0x5e86f5c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateArgumentTypes, addr 0x5e86c08, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateOneArgument, addr 0x5e87008, size 0x224, virtual false, abstract: false, final false
