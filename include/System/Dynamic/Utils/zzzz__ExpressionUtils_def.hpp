...
public:
  // Declarations
  /// @brief Method GetParametersForValidation, addr 0x5dacc68, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresCanRead, addr 0x5dad458, size 0x8, virtual false, abstract: false, final false
  static inline void RequiresCanRead(::System::Linq::Expressions::Expression* expression, ::StringW paramName);

  /// @brief Method RequiresCanRead, addr 0x5dacfd4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method TryQuote, addr 0x5dad334, size 0x124, virtual false, abstract: false, final false
  static inline bool TryQuote(::System::Type* parameterType, ::ByRef<::System::Linq::Expressions::Expression*> argument);

  /// @brief Method ValidateArgumentCount, addr 0x5dad62c, size 0xd8, virtual false, abstract: false, final false
  static inline void ValidateArgumentCount(::System::Linq::Expressions::LambdaExpression* lambda);

  /// @brief Method ValidateArgumentCount, addr 0x5dacd04, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateArgumentTypes, addr 0x5dac9b0, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateOneArgument, addr 0x5dacdb0, size 0x224, virtual false, abstract: false, final false
