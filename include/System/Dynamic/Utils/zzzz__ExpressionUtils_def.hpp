...
public:
  // Declarations
  /// @brief Method GetParametersForValidation, addr 0x5e147f4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresCanRead, addr 0x5e14fe4, size 0x8, virtual false, abstract: false, final false
  static inline void RequiresCanRead(::System::Linq::Expressions::Expression* expression, ::StringW paramName);

  /// @brief Method RequiresCanRead, addr 0x5e14b60, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method TryQuote, addr 0x5e14ec0, size 0x124, virtual false, abstract: false, final false
  static inline bool TryQuote(::System::Type* parameterType, ::ByRef<::System::Linq::Expressions::Expression*> argument);

  /// @brief Method ValidateArgumentCount, addr 0x5e151b8, size 0xd8, virtual false, abstract: false, final false
  static inline void ValidateArgumentCount(::System::Linq::Expressions::LambdaExpression* lambda);

  /// @brief Method ValidateArgumentCount, addr 0x5e14890, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateArgumentTypes, addr 0x5e1453c, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateOneArgument, addr 0x5e1493c, size 0x224, virtual false, abstract: false, final false
