...
public:
  ...
  /// @brief Method GetAnyStaticMethodValidated, addr 0x41040ac, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParametersCached, addr 0x41037e0, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetReturnType, addr 0x4104298, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Type* GetReturnType(::System::Reflection::MethodBase* mi);

  /// @brief Method GetTypeCode, addr 0x410433c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::TypeCode GetTypeCode(::System::Type* type);

  /// @brief Method MatchesArgumentTypes, addr 0x4104150, size 0x148, virtual false, abstract: false, final false
