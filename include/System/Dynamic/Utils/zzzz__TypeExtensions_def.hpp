...
public:
  ...
  /// @brief Method GetAnyStaticMethodValidated, addr 0x40ff1b0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParametersCached, addr 0x40fe8e4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetReturnType, addr 0x40ff39c, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Type* GetReturnType(::System::Reflection::MethodBase* mi);

  /// @brief Method GetTypeCode, addr 0x40ff440, size 0x58, virtual false, abstract: false, final false
  static inline ::System::TypeCode GetTypeCode(::System::Type* type);

  /// @brief Method MatchesArgumentTypes, addr 0x40ff254, size 0x148, virtual false, abstract: false, final false
