...
public:
  // Declarations
  /// @brief Method VisitArguments, addr 0x41056d4, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method VisitBlockExpressions, addr 0x410527c, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method VisitParameters, addr 0x4105420, size 0x2b4, virtual false, abstract: false, final false
