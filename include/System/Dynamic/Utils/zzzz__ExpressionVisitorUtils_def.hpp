...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExpressionVisitorUtils", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExpressionVisitorUtils(ExpressionVisitorUtils&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExpressionVisitorUtils", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExpressionVisitorUtils(ExpressionVisitorUtilsconst&) = delete;
