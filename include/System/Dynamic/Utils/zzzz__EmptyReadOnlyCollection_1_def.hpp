...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Dynamic::Utils::EmptyReadOnlyCollection_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Dynamic::Utils::EmptyReadOnlyCollection_1, "System.Dynamic.Utils", "EmptyReadOnlyCollection`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EmptyReadOnlyCollection_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EmptyReadOnlyCollection_1(EmptyReadOnlyCollection_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EmptyReadOnlyCollection_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EmptyReadOnlyCollection_1(EmptyReadOnlyCollection_1const&) = delete;
