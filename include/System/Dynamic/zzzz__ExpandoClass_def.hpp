...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExpandoClass", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExpandoClass(ExpandoClass&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExpandoClass", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExpandoClass(ExpandoClassconst&) = delete;
