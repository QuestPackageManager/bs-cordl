...
public:
// Declarations
/// @brief Method Bind, addr 0x5e14540, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method FallbackInvoke, addr 0x5e14530, size 0x10, virtual false, abstract: false, final false
