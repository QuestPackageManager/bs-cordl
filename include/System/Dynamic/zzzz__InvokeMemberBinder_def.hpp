...
public:
  ...
  /// @brief Method Bind, addr 0x4106bd4, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method FallbackInvokeMember, addr 0x4105710, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IgnoreCase, addr 0x4106bcc, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreCase();

  /// @brief Method get_Name, addr 0x4106bc4, size 0x8, virtual false, abstract: false, final false
