...
public:
  ...
  /// @brief Method .ctor, addr 0x5b2e914, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AssemblyName, addr 0x5b2e918, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AssemblyName();

  /// @brief Method get_TypeName, addr 0x5b2e928, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TypeName();

  /// @brief Method set_AssemblyName, addr 0x5b2e920, size 0x8, virtual false, abstract: false, final false
  inline void set_AssemblyName(::StringW value);

  /// @brief Method set_TypeName, addr 0x5b2e930, size 0x8, virtual false, abstract: false, final false
