...
public:
  ...
  /// @brief Method CreateObjRef, addr 0x5b213d4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b211dc, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectUri, ::System::Runtime::Remoting::ObjRef* objRef);

  /// @brief Method get_ClientProxy, addr 0x5b212d0, size 0x8c, virtual false, abstract: false, final false
  inline ::System::MarshalByRefObject* get_ClientProxy();

  /// @brief Method get_TargetUri, addr 0x5b213dc, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_TargetUri();

  /// @brief Method set_ClientProxy, addr 0x5b2135c, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  ClientIdentity(ClientIdentityconst&) = delete;
