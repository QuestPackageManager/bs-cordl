...
/// @brief Method .ctor, addr 0x5981050, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CodeXmlNamespaceForClrTypeNamespace, addr 0x59800c8, size 0x198, virtual false, abstract: false, final false
static inline ::StringW CodeXmlNamespaceForClrTypeNamespace(::StringW  typeNamespace, ::StringW  assemblyName) ;

/// @brief Method EncodeNs, addr 0x5980260, size 0xfc, virtual false, abstract: false, final false
static inline ::StringW EncodeNs(::StringW  ns) ;

/// @brief Method GetAssemblyName, addr 0x59803d4, size 0xec, virtual false, abstract: false, final false
static inline ::StringW GetAssemblyName(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetNameKey, addr 0x598035c, size 0x78, virtual false, abstract: false, final false
static inline ::StringW GetNameKey(::StringW  name, ::StringW  namspace) ;

/// @brief Method GetXmlElementForInteropType, addr 0x59804c0, size 0xdc, virtual false, abstract: false, final false
static inline bool GetXmlElementForInteropType(::System::Type*  type, ::ByRef<::StringW>  xmlElement, ::ByRef<::StringW>  xmlNamespace) ;

/// @brief Method GetXmlNamespaceForMethodCall, addr 0x598059c, size 0x98, virtual false, abstract: false, final false
static inline ::StringW GetXmlNamespaceForMethodCall(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetXmlNamespaceForMethodResponse, addr 0x5980634, size 0x98, virtual false, abstract: false, final false
static inline ::StringW GetXmlNamespaceForMethodResponse(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetXmlTypeForInteropType, addr 0x59806cc, size 0xd0, virtual false, abstract: false, final false
static inline bool GetXmlTypeForInteropType(::System::Type*  type, ::ByRef<::StringW>  xmlType, ::ByRef<::StringW>  xmlTypeNamespace) ;

/// @brief Method PreLoad, addr 0x598079c, size 0xc0, virtual false, abstract: false, final false
static inline void PreLoad(::System::Reflection::Assembly*  assembly) ;

/// @brief Method PreLoad, addr 0x598085c, size 0x4d4, virtual false, abstract: false, final false
static inline void PreLoad(::System::Type*  type) ;

/// @brief Method RegisterInteropXmlElement, addr 0x5980ec0, size 0x190, virtual false, abstract: false, final false
static inline void RegisterInteropXmlElement(::StringW  xmlElement, ::StringW  xmlNamespace, ::System::Type*  type) ;

/// @brief Method RegisterInteropXmlType, addr 0x5980d30, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method get_XmlNsForClrTypeWithAssembly, addr 0x597fffc, size 0x44, virtual false, abstract: false, final false
static inline ::StringW get_XmlNsForClrTypeWithAssembly() ;

/// @brief Method get_XmlNsForClrTypeWithNs, addr 0x5980040, size 0x44, virtual false, abstract: false, final false
static inline ::StringW get_XmlNsForClrTypeWithNs() ;

/// @brief Method get_XmlNsForClrTypeWithNsAndAssembly, addr 0x5980084, size 0x44, virtual false, abstract: false, final false
