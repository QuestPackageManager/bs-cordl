...
public:
  ...
  /// @brief Method .ctor, addr 0x5b1ecc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::IMessageSink* sinks);

  /// @brief Method get_EnvoySinks, addr 0x5b1eccc, size 0x8, virtual true, abstract: false, final true
