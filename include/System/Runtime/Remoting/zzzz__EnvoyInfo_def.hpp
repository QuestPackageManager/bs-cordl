...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::EnvoyInfo*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::EnvoyInfo*, "System.Runtime.Remoting", "EnvoyInfo");
...
public:
  ...
  constexpr ::System::Runtime::Remoting::Messaging::IMessageSink* const& __cordl_internal_get_envoySinks() const;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnvoyInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnvoyInfo(EnvoyInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnvoyInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnvoyInfo(EnvoyInfoconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Remoting::EnvoyInfo) == 0x18, "Size mismatch!");
