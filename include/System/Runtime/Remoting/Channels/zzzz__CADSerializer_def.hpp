...
public:
  // Declarations
  /// @brief Method DeserializeMessage, addr 0x3ce56cc, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeObject, addr 0x3ce5b18, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Object* DeserializeObject(::System::IO::MemoryStream* mem);

  /// @brief Method DeserializeObjectSafe, addr 0x3ce5a7c, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Object* DeserializeObjectSafe(::ArrayW<uint8_t, ::Array<uint8_t>*> mem);

  /// @brief Method SerializeMessage, addr 0x3ce5130, size 0xec, virtual false, abstract: false, final false
  static inline ::System::IO::MemoryStream* SerializeMessage(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method SerializeObject, addr 0x3ce5ba0, size 0xec, virtual false, abstract: false, final false
