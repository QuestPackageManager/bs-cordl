...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Channels::IChannelReceiver*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Channels::IChannelReceiver*, "System.Runtime.Remoting.Channels", "IChannelReceiver");
// [ComVisible(true)]
// Dependencies
namespace System::Runtime::Remoting::Channels {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IChannelReceiver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IChannelReceiver(IChannelReceiverconst&) = delete;
