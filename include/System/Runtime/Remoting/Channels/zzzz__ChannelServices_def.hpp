...
public:
  ...
  /// @brief Method CheckIncomingMessage, addr 0x5b3ae44, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckReturnMessage, addr 0x5b3b0f4, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClientChannelSinkChain, addr 0x5b3941c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClientChannelSinkChain, addr 0x5b2cabc, size 0x7b4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateProvider, addr 0x5b3aa9c, size 0x2fc, virtual false, abstract: false, final false
  static inline ::System::Object* CreateProvider(::System::Runtime::Remoting::ProviderData* prov);

  /// @brief Method GetCurrentChannelInfo, addr 0x5b3b2e0, size 0x4e4, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterChannel, addr 0x5b39698, size 0x81c, virtual false, abstract: false, final false
  static inline void RegisterChannel(::System::Runtime::Remoting::Channels::IChannel* chnl, bool ensureSecurity);

  /// @brief Method RegisterChannelConfig, addr 0x5b39eb4, size 0xbe8, virtual false, abstract: false, final false
  static inline void RegisterChannelConfig(::System::Runtime::Remoting::ChannelData* channel);

  /// @brief Method SyncDispatchMessage, addr 0x5b3ad98, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CrossContextChannel, addr 0x5b393c0, size 0x5c, virtual false, abstract: false, final false
