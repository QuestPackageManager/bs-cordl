...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CrossAppDomainData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CrossAppDomainData(CrossAppDomainData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CrossAppDomainData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CrossAppDomainData(CrossAppDomainDataconst&) = delete;
