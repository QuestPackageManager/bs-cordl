...
public:
  ...
  /// @brief Method .ctor, addr 0x5b39634, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(int32_t domainId);

  /// @brief Method get_DomainID, addr 0x5b396c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DomainID();

  /// @brief Method get_ProcessID, addr 0x5b396c8, size 0x8, virtual false, abstract: false, final false
