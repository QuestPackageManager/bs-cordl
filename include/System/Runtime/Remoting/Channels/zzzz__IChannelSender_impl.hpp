...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Runtime::Remoting::Messaging::IMessageSink* (::System::Runtime::Remoting::Channels::IChannelSender::*)(::StringW, ::System::Object*, ::ByRef<::StringW>)>(&::System::Runtime::Remoting::Channels::IChannelSender::CreateMessageSink)> {
...
inline ::System::Runtime::Remoting::Messaging::IMessageSink* System::Runtime::Remoting::Channels::IChannelSender::CreateMessageSink(::StringW  url, ::System::Object*  remoteChannelData, ::ByRef<::StringW>  objectURI)  {
