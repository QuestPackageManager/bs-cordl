...
public:
  ...
  /// @brief Method .ctor, addr 0x283ec08, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Children, addr 0x283ecb4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* get_Children();

  /// @brief Method get_Properties, addr 0x283ecbc, size 0x8, virtual false, abstract: false, final false
