...
public:
  ...
  /// @brief Method .ctor, addr 0x25fa73c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Children, addr 0x25fa7e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* get_Children();

  /// @brief Method get_Properties, addr 0x25fa7f0, size 0x8, virtual false, abstract: false, final false
