...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::InternalRemotingServices*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::InternalRemotingServices*, "System.Runtime.Remoting", "InternalRemotingServices");
// [ComVisible(true)]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InternalRemotingServices", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InternalRemotingServices(InternalRemotingServices&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InternalRemotingServices", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InternalRemotingServices(InternalRemotingServicesconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Remoting::InternalRemotingServices) == 0x10, "Size mismatch!");
