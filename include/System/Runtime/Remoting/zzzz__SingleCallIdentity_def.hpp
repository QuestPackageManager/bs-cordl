...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x2830998, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x2830788, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x282e258, size 0x30, virtual false, abstract: false, final false
