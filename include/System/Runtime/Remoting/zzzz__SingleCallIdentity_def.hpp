...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x3ce39b4, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x3ce3794, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ce133c, size 0x30, virtual false, abstract: false, final false
