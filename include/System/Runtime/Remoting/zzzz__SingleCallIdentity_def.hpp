...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x25ea704, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x25ea4f4, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ea4c4, size 0x30, virtual false, abstract: false, final false
