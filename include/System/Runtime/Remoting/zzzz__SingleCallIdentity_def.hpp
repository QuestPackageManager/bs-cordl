...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x597f7c8, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x597f718, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x597d41c, size 0x10, virtual false, abstract: false, final false
