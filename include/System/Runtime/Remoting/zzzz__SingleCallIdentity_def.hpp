...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x28433ac, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x284319c, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2840c6c, size 0x30, virtual false, abstract: false, final false
