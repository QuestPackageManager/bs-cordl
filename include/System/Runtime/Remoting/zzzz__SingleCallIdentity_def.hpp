...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x5b2f788, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x5b2f6d8, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b2d3dc, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SingleCallIdentity", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SingleCallIdentity(SingleCallIdentity&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SingleCallIdentity", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SingleCallIdentity(SingleCallIdentityconst&) = delete;
