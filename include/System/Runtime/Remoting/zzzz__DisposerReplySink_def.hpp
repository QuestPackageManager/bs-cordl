...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x25eaa0c, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method SyncProcessMessage, addr 0x25ea8f0, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25ea8c4, size 0x2c, virtual false, abstract: false, final false
