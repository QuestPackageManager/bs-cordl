...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5b2fa78, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method SyncProcessMessage, addr 0x5b2f94c, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b2f944, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DisposerReplySink", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DisposerReplySink(DisposerReplySink&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DisposerReplySink", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DisposerReplySink(DisposerReplySinkconst&) = delete;
