...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::ChannelData*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::ChannelData*, "System.Runtime.Remoting", "ChannelData");
...
public:
  ...
  /// @brief Method CopyFrom, addr 0x5b25f4c, size 0x888, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b26ed0, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ClientProviders, addr 0x5b25e78, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_ClientProviders();

  /// @brief Method get_CustomProperties, addr 0x5b25ee0, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* get_CustomProperties();

  /// @brief Method get_ServerProviders, addr 0x5b25e10, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::ChannelData) == 0x48, "Size mismatch!");
