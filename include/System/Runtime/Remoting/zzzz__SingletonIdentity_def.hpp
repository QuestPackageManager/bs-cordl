...
public:
  ...
  /// @brief Method .ctor addr 0x2493b80 size 0x30 virtual false final false
  inline void _ctor(::StringW objectUri, ::System::Runtime::Remoting::Contexts::Context* context, ::System::Type* objectType);

  /// @brief Method GetServerObject addr 0x2493bb0 size 0x1f0 virtual false final false
  inline ::System::MarshalByRefObject* GetServerObject();

  /// @brief Method SyncObjectProcessMessage addr 0x2493da8 size 0xd0 virtual true final false
  ...
  /// @brief Method AsyncObjectProcessMessage addr 0x2493e78 size 0xe4 virtual true final false
