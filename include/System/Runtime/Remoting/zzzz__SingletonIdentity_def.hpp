...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x597f630, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetServerObject, addr 0x597f3ac, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x597f554, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x597d42c, size 0x10, virtual false, abstract: false, final false
