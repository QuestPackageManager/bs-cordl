...
public:
  // Declarations
  /// @brief Method AsyncObjectProcessMessage, addr 0x3cd7b54, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetServerObject, addr 0x3cd7898, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncObjectProcessMessage, addr 0x3cd7a84, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cd5810, size 0x30, virtual false, abstract: false, final false
