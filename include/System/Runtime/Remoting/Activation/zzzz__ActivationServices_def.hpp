...
public:
  ...
  /// @brief Method Activate, addr 0x59847f4, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocateUninitializedClassInstance, addr 0x598d114, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Object* AllocateUninitializedClassInstance(::System::Type* type);

  /// @brief Method CreateConstructionCall, addr 0x59830ac, size 0x918, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInstanceFromMessage, addr 0x598cf34, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateProxyForType, addr 0x598d118, size 0x138, virtual false, abstract: false, final false
  static inline ::System::Object* CreateProxyForType(::System::Type* type);

  /// @brief Method EnableProxyActivation, addr 0x598d250, size 0x8, virtual false, abstract: false, final false
  static inline void EnableProxyActivation(::System::Type* type, bool enable);

  /// @brief Method RemoteActivate, addr 0x598cd44, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConstructionActivator, addr 0x598ccb8, size 0x88, virtual false, abstract: false, final false
