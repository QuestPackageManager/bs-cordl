...
public:
  ...
  /// @brief Method Activate, addr 0x3ce08a0, size 0x360, virtual true, abstract: false, final true
  ...
  /// @brief Method get_NextActivator, addr 0x3ce0c00, size 0x38, virtual true, abstract: false, final true
