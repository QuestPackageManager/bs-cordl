...
public:
  ...
  /// @brief Method Activate, addr 0x3ce9ea0, size 0x360, virtual true, abstract: false, final true
  ...
  /// @brief Method get_NextActivator, addr 0x3cea200, size 0x38, virtual true, abstract: false, final true
