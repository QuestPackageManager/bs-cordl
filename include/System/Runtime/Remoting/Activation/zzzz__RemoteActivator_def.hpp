...
public:
  ...
  /// @brief Method Activate, addr 0x3ce579c, size 0x360, virtual true, abstract: false, final true
  ...
  /// @brief Method get_NextActivator, addr 0x3ce5afc, size 0x38, virtual true, abstract: false, final true
