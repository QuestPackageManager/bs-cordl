...
public:
  ...
  /// @brief Method Activate, addr 0x5b3bac8, size 0x444, virtual true, abstract: false, final true
  ...
  /// @brief Method get_NextActivator, addr 0x5b3bf0c, size 0x38, virtual true, abstract: false, final true
