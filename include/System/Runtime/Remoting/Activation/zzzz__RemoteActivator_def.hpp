...
public:
  ...
  /// @brief Method Activate, addr 0x5a00280, size 0x444, virtual true, abstract: false, final true
  ...
  /// @brief Method get_NextActivator, addr 0x5a006c4, size 0x38, virtual true, abstract: false, final true
