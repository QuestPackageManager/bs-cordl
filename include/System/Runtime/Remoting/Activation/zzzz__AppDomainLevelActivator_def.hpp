...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Activation::AppDomainLevelActivator*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Activation::AppDomainLevelActivator*, "System.Runtime.Remoting.Activation", "AppDomainLevelActivator");
...
public:
  ...
  /// @brief Method Activate, addr 0x5b3af20, size 0x4c8, virtual true, abstract: false, final true
  ...
  constexpr ::System::Runtime::Remoting::Activation::IActivator* const& __cordl_internal_get__next() const;
  ...
  /// @brief Method .ctor, addr 0x5b3abe4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW activationUrl, ::System::Runtime::Remoting::Activation::IActivator* next);

  /// @brief Method get_NextActivator, addr 0x5b3af18, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Activation::AppDomainLevelActivator) == 0x20, "Size mismatch!");
