...
/// @brief Method Activate, addr 0x5a01250, size 0x4c8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5a00f14, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  activationUrl, ::System::Runtime::Remoting::Activation::IActivator*  next) ;

/// @brief Method get_NextActivator, addr 0x5a01248, size 0x8, virtual true, abstract: false, final true
