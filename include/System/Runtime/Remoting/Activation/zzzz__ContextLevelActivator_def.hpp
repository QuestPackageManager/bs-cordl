...
public:
  ...
  /// @brief Method Activate, addr 0x3ce38a0, size 0x32c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ce2d68, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Activation::IActivator* next);

  /// @brief Method get_NextActivator, addr 0x3ce3898, size 0x8, virtual true, abstract: false, final true
