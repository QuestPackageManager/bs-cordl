...
public:
  ...
  /// @brief Method GetPropertiesForNewContext, addr 0x5b3b700, size 0x3c8, virtual true, abstract: false, final true
  inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage* ctor);

  /// @brief Method IsContextOK, addr 0x5b3b6f8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b3b6f0, size 0x8, virtual false, abstract: false, final false
