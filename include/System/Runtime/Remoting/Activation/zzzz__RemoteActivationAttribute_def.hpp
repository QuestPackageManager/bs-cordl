...
/// @brief Method GetPropertiesForNewContext, addr 0x598df4c, size 0x3c8, virtual true, abstract: false, final true
inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage*  ctor) ;

/// @brief Method IsContextOK, addr 0x598df44, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x598df3c, size 0x8, virtual false, abstract: false, final false
