...
public:
  ...
  /// @brief Method GetPropertiesForNewContext, addr 0x25fb950, size 0x3e8, virtual true, abstract: false, final true
  inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage* ctor);

  /// @brief Method IsContextOK, addr 0x25fb948, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25fb920, size 0x28, virtual false, abstract: false, final false
