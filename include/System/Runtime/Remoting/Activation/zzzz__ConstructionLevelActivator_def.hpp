...
public:
  ...
  /// @brief Method Activate, addr 0x3ce6a0c, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ce5dc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NextActivator, addr 0x3ce6a04, size 0x8, virtual true, abstract: false, final true
