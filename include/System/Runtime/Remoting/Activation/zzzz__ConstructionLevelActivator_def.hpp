...
public:
  ...
  /// @brief Method Activate, addr 0x598d738, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x598cd40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NextActivator, addr 0x598d730, size 0x8, virtual true, abstract: false, final true
