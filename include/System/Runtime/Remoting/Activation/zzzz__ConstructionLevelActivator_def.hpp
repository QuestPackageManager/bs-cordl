...
public:
  ...
  /// @brief Method Activate, addr 0x3ce0064, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3cdf420, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NextActivator, addr 0x3ce005c, size 0x8, virtual true, abstract: false, final true
