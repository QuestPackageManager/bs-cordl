...
public:
  ...
  /// @brief Method Activate, addr 0x25fb4f4, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25fa88c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NextActivator, addr 0x25fb4ec, size 0x8, virtual true, abstract: false, final true
