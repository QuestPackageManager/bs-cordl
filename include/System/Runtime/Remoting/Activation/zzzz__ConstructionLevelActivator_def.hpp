...
public:
  ...
  /// @brief Method Activate, addr 0x59ffbb0, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59ff1b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NextActivator, addr 0x59ffba8, size 0x8, virtual true, abstract: false, final true
