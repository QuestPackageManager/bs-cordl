...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConstructionLevelActivator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConstructionLevelActivator(ConstructionLevelActivator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConstructionLevelActivator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConstructionLevelActivator(ConstructionLevelActivatorconst&) = delete;
