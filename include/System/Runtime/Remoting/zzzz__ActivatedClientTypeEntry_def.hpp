...
public:
  ...
  /// @brief Method ToString, addr 0x3c658ac, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c65768, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW appUrl);

  /// @brief Method get_ApplicationUrl, addr 0x3c65894, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ApplicationUrl();

  /// @brief Method get_ContextAttributes, addr 0x3c6589c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ObjectType, addr 0x3c658a4, size 0x8, virtual false, abstract: false, final false
