...
public:
  ...
  /// @brief Method ToString, addr 0x3c5121c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c510d8, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW appUrl);

  /// @brief Method get_ApplicationUrl, addr 0x3c51204, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ApplicationUrl();

  /// @brief Method get_ContextAttributes, addr 0x3c5120c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ObjectType, addr 0x3c51214, size 0x8, virtual false, abstract: false, final false
