...
/// @brief Method ToString, addr 0x59713fc, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59712f8, size 0xec, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName, ::StringW  assemblyName, ::StringW  appUrl) ;

/// @brief Method get_ApplicationUrl, addr 0x59713e4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ApplicationUrl() ;

/// @brief Method get_ContextAttributes, addr 0x59713ec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_ObjectType, addr 0x59713f4, size 0x8, virtual false, abstract: false, final false
