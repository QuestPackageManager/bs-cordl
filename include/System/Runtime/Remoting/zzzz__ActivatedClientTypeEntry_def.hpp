...
public:
  ...
  /// @brief Method ToString, addr 0x59e3368, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59e3264, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW appUrl);

  /// @brief Method get_ApplicationUrl, addr 0x59e3350, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ApplicationUrl();

  /// @brief Method get_ContextAttributes, addr 0x59e3358, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ObjectType, addr 0x59e3360, size 0x8, virtual false, abstract: false, final false
