...
public:
  ...
  /// @brief Method .ctor addr 0x2339c94 size 0x30 virtual false final false
  inline void _ctor(::StringW objectUri, ::System::Runtime::Remoting::Contexts::Context* context, ::System::Type* objectType);

  /// @brief Method get_ObjectType addr 0x2339cc4 size 0x8 virtual false final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method StartTrackingLifetime addr 0x2339ccc size 0x18c virtual false final false
  inline void StartTrackingLifetime(::System::Runtime::Remoting::Lifetime::ILease* lease);

  /// @brief Method OnLifetimeExpired addr 0x233a018 size 0x4 virtual true final false
  inline void OnLifetimeExpired();

  /// @brief Method CreateObjRef addr 0x233a098 size 0x1ac virtual true final false
  inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type* requestedType);

  /// @brief Method AttachServerObject addr 0x233a654 size 0xf8 virtual false final false
  inline void AttachServerObject(::System::MarshalByRefObject* serverObject, ::System::Runtime::Remoting::Contexts::Context* context);

  /// @brief Method get_Lease addr 0x233a950 size 0x8 virtual false final false
  inline ::System::Runtime::Remoting::Lifetime::Lease* get_Lease();

  /// @brief Method get_Context addr 0x233a958 size 0x8 virtual false final false
  inline ::System::Runtime::Remoting::Contexts::Context* get_Context();

  /// @brief Method set_Context addr 0x233a960 size 0x8 virtual false final false
  ...
  /// @brief Method DisposeServerObject addr 0x233a01c size 0x7c virtual false final false
