...
public:
  ...
  /// @brief Method AttachServerObject, addr 0x2715774, size 0x5c, virtual false, abstract: false, final false
  inline void AttachServerObject(::System::MarshalByRefObject* serverObject, ::System::Runtime::Remoting::Contexts::Context* context);

  /// @brief Method CreateObjRef, addr 0x2716a90, size 0x1ac, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type* requestedType);

  /// @brief Method DisposeServerObject, addr 0x2716a14, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnLifetimeExpired, addr 0x2716a10, size 0x4, virtual true, abstract: false, final false
  inline void OnLifetimeExpired();

  /// @brief Method StartTrackingLifetime, addr 0x27132bc, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2716818, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectUri, ::System::Runtime::Remoting::Contexts::Context* context, ::System::Type* objectType);

  /// @brief Method get_Context, addr 0x2717258, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Contexts::Context* get_Context();

  /// @brief Method get_Lease, addr 0x2717250, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Lifetime::Lease* get_Lease();

  /// @brief Method get_ObjectType, addr 0x2716848, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method set_Context, addr 0x2717260, size 0x8, virtual false, abstract: false, final false
