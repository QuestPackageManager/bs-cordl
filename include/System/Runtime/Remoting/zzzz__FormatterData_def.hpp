...
public:
  ...
  /// @brief Method .ctor, addr 0x5b29278, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FormatterData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FormatterData(FormatterData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FormatterData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FormatterData(FormatterDataconst&) = delete;
