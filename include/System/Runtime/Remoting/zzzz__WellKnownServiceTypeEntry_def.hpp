...
public:
  ...
  /// @brief Method ToString, addr 0x3cd65b0, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cd6464, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Mode, addr 0x3cd6598, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::WellKnownObjectMode get_Mode();

  /// @brief Method get_ObjectType, addr 0x3cd65a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_ObjectUri, addr 0x3cd65a8, size 0x8, virtual false, abstract: false, final false
