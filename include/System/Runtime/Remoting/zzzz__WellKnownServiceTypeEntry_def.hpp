...
public:
  ...
  /// @brief Method ToString, addr 0x25ec0f0, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ebf98, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Mode, addr 0x25ec0d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::WellKnownObjectMode get_Mode();

  /// @brief Method get_ObjectType, addr 0x25ec0e0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_ObjectUri, addr 0x25ec0e8, size 0x8, virtual false, abstract: false, final false
