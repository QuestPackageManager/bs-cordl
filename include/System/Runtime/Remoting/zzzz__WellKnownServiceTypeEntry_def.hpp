...
public:
  ...
  /// @brief Method ToString, addr 0x3cd2e6c, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cd2d20, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Mode, addr 0x3cd2e54, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::WellKnownObjectMode get_Mode();

  /// @brief Method get_ObjectType, addr 0x3cd2e5c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_ObjectUri, addr 0x3cd2e64, size 0x8, virtual false, abstract: false, final false
