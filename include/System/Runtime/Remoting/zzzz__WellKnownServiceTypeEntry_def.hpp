...
public:
  ...
  /// @brief Method ToString, addr 0x5b2edbc, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b2ecb0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Mode, addr 0x5b2eda4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::WellKnownObjectMode get_Mode();

  /// @brief Method get_ObjectType, addr 0x5b2edac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_ObjectUri, addr 0x5b2edb4, size 0x8, virtual false, abstract: false, final false
