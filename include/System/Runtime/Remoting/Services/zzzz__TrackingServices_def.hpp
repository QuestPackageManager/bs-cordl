...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TrackingServices", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TrackingServices(TrackingServices&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TrackingServices", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TrackingServices(TrackingServicesconst&) = delete;
