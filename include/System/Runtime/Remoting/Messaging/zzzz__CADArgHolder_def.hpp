...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::CADArgHolder*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::CADArgHolder*, "System.Runtime.Remoting.Messaging", "CADArgHolder");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5b400f8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CADArgHolder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CADArgHolder(CADArgHolder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CADArgHolder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CADArgHolder(CADArgHolderconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::CADArgHolder) == 0x18, "Size mismatch!");
