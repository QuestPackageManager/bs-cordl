...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CADMethodCallMessage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CADMethodCallMessage(CADMethodCallMessage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CADMethodCallMessage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CADMethodCallMessage(CADMethodCallMessageconst&) = delete;
