...
public:
  ...
  /// @brief Method Create, addr 0x5b3a260, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArgs, addr 0x5b4050c, size 0x10, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetArgs(::System::Collections::ArrayList* args);

  /// @brief Method GetArguments, addr 0x5b403c4, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b401d4, size 0x1f0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::IMethodCallMessage* callMsg);

  /// @brief Method get_PropertiesCount, addr 0x5b4051c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PropertiesCount();

  /// @brief Method get_Uri, addr 0x5b401cc, size 0x8, virtual false, abstract: false, final false
