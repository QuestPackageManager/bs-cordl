...
public:
  ...
  /// @brief Method GetObjectData, addr 0x599a1f0, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectData, addr 0x599a374, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x599a3c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
