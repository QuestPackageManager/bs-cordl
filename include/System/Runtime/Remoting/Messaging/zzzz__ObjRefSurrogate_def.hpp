...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3cf19c8, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectData, addr 0x3cf1b9c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cf1be8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
