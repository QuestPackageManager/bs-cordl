...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b4a1b0, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectData, addr 0x5b4a334, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b4a380, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjRefSurrogate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjRefSurrogate(ObjRefSurrogate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjRefSurrogate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjRefSurrogate(ObjRefSurrogateconst&) = delete;
