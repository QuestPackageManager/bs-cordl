...
public:
  ...
  /// @brief Method GetObjectData, addr 0x27351b4, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectData, addr 0x2735390, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27353e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
