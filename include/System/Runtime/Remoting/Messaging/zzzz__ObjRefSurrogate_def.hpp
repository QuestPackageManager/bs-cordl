...
public:
  ...
  /// @brief Method GetObjectData, addr 0x25a48ec, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectData, addr 0x25a49f8, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25a4a48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
