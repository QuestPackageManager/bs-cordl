...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2860650, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectData, addr 0x286082c, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x286087c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
