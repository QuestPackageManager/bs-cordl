...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5b4aff8, size 0x1cc, virtual true, abstract: false, final true
  ...
  /// @brief Method SyncProcessMessage, addr 0x5b4ae78, size 0x180, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b4ae70, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ServerObjectTerminatorSink", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ServerObjectTerminatorSink(ServerObjectTerminatorSink&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ServerObjectTerminatorSink", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ServerObjectTerminatorSink(ServerObjectTerminatorSinkconst&) = delete;
