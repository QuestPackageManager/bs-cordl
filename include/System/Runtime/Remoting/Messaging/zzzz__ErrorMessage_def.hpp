...
public:
  ...
  /// @brief Method GetArg, addr 0x5b43560, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b39d68, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ArgCount, addr 0x5b434a8, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_ArgCount();

  /// @brief Method get_Args, addr 0x5b434b0, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Object*> get_Args();

  /// @brief Method get_LogicalCallContext, addr 0x5b43568, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext();

  /// @brief Method get_MethodBase, addr 0x5b434b8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Reflection::MethodBase* get_MethodBase();

  /// @brief Method get_MethodName, addr 0x5b434c0, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_MethodName();

  /// @brief Method get_MethodSignature, addr 0x5b43504, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_MethodSignature();

  /// @brief Method get_Properties, addr 0x5b4350c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* get_Properties();

  /// @brief Method get_TypeName, addr 0x5b43514, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_TypeName();

  /// @brief Method get_Uri, addr 0x5b43558, size 0x8, virtual true, abstract: false, final true
