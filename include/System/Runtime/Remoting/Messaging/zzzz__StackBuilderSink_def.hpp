...
public:
  ...
  /// @brief Method .ctor addr 0x24b3a28 size 0xa4 virtual false final false
  inline void _ctor(::System::MarshalByRefObject* obj, bool forceInternalExecute);

  /// @brief Method SyncProcessMessage addr 0x24b3acc size 0xcc virtual true final true
  inline ::System::Runtime::Remoting::Messaging::IMessage* SyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method AsyncProcessMessage addr 0x24b3fe8 size 0x120 virtual true final true
  inline ::System::Runtime::Remoting::Messaging::IMessageCtrl* AsyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg,
                                                                                   ::System::Runtime::Remoting::Messaging::IMessageSink* replySink);

  /// @brief Method ExecuteAsyncMessage addr 0x24b4108 size 0x200 virtual false final false
  inline void ExecuteAsyncMessage(::System::Object* ob);

  /// @brief Method CheckParameters addr 0x24b3b98 size 0x450 virtual false final false
  inline void CheckParameters(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method <AsyncProcessMessage>b__4_0 addr 0x24b4308 size 0x80 virtual false final false
