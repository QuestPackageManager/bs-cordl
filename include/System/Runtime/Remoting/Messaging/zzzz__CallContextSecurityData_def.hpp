...
public:
  ...
  /// @brief Method Clone, addr 0x3cf483c, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method get_HasInfo, addr 0x3cf48b4, size 0x10, virtual false, abstract: false, final false
