...
public:
  ...
  /// @brief Method Clone, addr 0x3ce7234, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ce7390, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HasInfo, addr 0x3ce72ac, size 0x10, virtual false, abstract: false, final false
