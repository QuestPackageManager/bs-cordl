...
public:
  ...
  /// @brief Method Clone, addr 0x3ceb938, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ceba94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HasInfo, addr 0x3ceb9b0, size 0x10, virtual false, abstract: false, final false
