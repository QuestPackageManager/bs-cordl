...
public:
  ...
  /// @brief Method Clone, addr 0x598f9b0, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x598faf8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HasInfo, addr 0x598fa1c, size 0x10, virtual false, abstract: false, final false
