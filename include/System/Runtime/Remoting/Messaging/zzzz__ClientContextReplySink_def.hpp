...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5b43364, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method SyncProcessMessage, addr 0x5b43258, size 0x10c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b43250, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClientContextReplySink", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClientContextReplySink(ClientContextReplySink&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClientContextReplySink", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClientContextReplySink(ClientContextReplySinkconst&) = delete;
