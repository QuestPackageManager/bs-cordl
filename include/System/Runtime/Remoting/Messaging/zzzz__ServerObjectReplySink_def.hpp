...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5a0d758, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method SyncProcessMessage, addr 0x5a0d684, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a0d67c, size 0x8, virtual false, abstract: false, final false
