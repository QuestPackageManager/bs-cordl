...
public:
  ...
  /// @brief Method GetArg, addr 0x5b48898, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_TargetIdentity, addr 0x5b4897c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Identity* System_Runtime_Remoting_Messaging_IInternalMessage_get_TargetIdentity();

  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_Uri, addr 0x5b48888, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Runtime_Remoting_Messaging_IInternalMessage_get_Uri();

  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_TargetIdentity, addr 0x5b48984, size 0x8, virtual true, abstract: false, final true
  inline void System_Runtime_Remoting_Messaging_IInternalMessage_set_TargetIdentity(::System::Runtime::Remoting::Identity* value);

  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_Uri, addr 0x5b48890, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b48480, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* e, ::System::Runtime::Remoting::Messaging::IMethodCallMessage* mcm);

  /// @brief Method .ctor, addr 0x5b48314, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgCount, addr 0x5b485c4, size 0x18, virtual true, abstract: false, final true
  inline int32_t get_ArgCount();

  /// @brief Method get_Args, addr 0x5b485dc, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Object*> get_Args();

  /// @brief Method get_Exception, addr 0x5b488c8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Exception* get_Exception();

  /// @brief Method get_LogicalCallContext, addr 0x5b485e4, size 0x58, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext();

  /// @brief Method get_MethodBase, addr 0x5b4863c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Reflection::MethodBase* get_MethodBase();

  /// @brief Method get_MethodName, addr 0x5b48644, size 0x48, virtual true, abstract: false, final true
  inline ::StringW get_MethodName();

  /// @brief Method get_MethodSignature, addr 0x5b4868c, size 0x128, virtual true, abstract: false, final true
  inline ::System::Object* get_MethodSignature();

  /// @brief Method get_OutArgs, addr 0x5b488d0, size 0xa4, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Object*> get_OutArgs();

  /// @brief Method get_Properties, addr 0x5b487b4, size 0x68, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* get_Properties();

  /// @brief Method get_ReturnValue, addr 0x5b48974, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* get_ReturnValue();

  /// @brief Method get_TypeName, addr 0x5b4881c, size 0x5c, virtual true, abstract: false, final true
  inline ::StringW get_TypeName();

  /// @brief Method get_Uri, addr 0x5b48878, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Uri, addr 0x5b48880, size 0x8, virtual false, abstract: false, final false
