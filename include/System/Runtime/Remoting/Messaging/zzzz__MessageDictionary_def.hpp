...
public:
  ...
  /// @brief Method MoveNext, addr 0x3cf0f68, size 0x1d0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x3cf1138, size 0xac, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3cf0cb8, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::MessageDictionary* methodDictionary);

  /// @brief Method get_Current, addr 0x3cf0d9c, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* get_Current();

  /// @brief Method get_Entry, addr 0x3cf0e00, size 0x168, virtual true, abstract: false, final true
  inline ::System::Collections::DictionaryEntry get_Entry();

  /// @brief Method get_Key, addr 0x3cf11e4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* get_Key();

  /// @brief Method get_Value, addr 0x3cf11e8, size 0x14, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0x3cefd30, size 0x168, virtual true, abstract: false, final true
  inline void Add(::System::Object* key, ::System::Object* value);

  /// @brief Method AllocInternalProperties, addr 0x3cefaf4, size 0x60, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* AllocInternalProperties();

  /// @brief Method Clear, addr 0x3cf0700, size 0xac, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x3cf07ac, size 0x13c, virtual true, abstract: false, final true
  inline bool Contains(::System::Object* key);

  /// @brief Method CopyTo, addr 0x3cf0b40, size 0xc0, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x3cf0c5c, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetInternalProperties, addr 0x3cec9b8, size 0x30, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* GetInternalProperties();

  /// @brief Method GetMethodProperty, addr 0x3cedcb8, size 0x564, virtual true, abstract: false, final false
  inline ::System::Object* GetMethodProperty(::StringW key);

  /// @brief Method HasUserData, addr 0x3cea744, size 0xfc, virtual false, abstract: false, final false
  inline bool HasUserData();

  /// @brief Method IsOverridenKey, addr 0x3cefb54, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x3cf08e8, size 0x184, virtual true, abstract: false, final true
  inline void Remove(::System::Object* key);

  /// @brief Method SetMethodProperty, addr 0x3cee484, size 0x2e0, virtual true, abstract: false, final false
  inline void SetMethodProperty(::StringW key, ::System::Object* value);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3cf0c00, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ced8c4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::IMethodMessage* message);

  /// @brief Method get_Count, addr 0x3cf0a6c, size 0xc8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_InternalDictionary, addr 0x3cea840, size 0x88, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* get_InternalDictionary();

  /// @brief Method get_IsFixedSize, addr 0x3cefbdc, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x3cefbe4, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x3cf0b34, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x3cefbec, size 0x140, virtual true, abstract: false, final true
  inline ::System::Object* get_Item(::System::Object* key);

  /// @brief Method get_Keys, addr 0x3cefe98, size 0x440, virtual true, abstract: false, final true
  inline ::System::Collections::ICollection* get_Keys();

  /// @brief Method get_SyncRoot, addr 0x3cf0b3c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* get_SyncRoot();

  /// @brief Method get_Values, addr 0x3cf02d8, size 0x428, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x3cefd2c, size 0x4, virtual true, abstract: false, final true
  inline void set_Item(::System::Object* key, ::System::Object* value);

  /// @brief Method set_MethodKeys, addr 0x3cefaec, size 0x8, virtual false, abstract: false, final false
