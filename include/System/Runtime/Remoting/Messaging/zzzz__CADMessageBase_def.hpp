...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CADMessageBase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CADMessageBase(CADMessageBase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CADMessageBase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CADMessageBase(CADMessageBaseconst&) = delete;
