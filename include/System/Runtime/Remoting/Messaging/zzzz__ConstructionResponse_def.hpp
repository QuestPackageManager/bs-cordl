...
public:
  ...
  /// @brief Method .ctor, addr 0x5926ddc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* e, ::System::Runtime::Remoting::Messaging::IMethodCallMessage* msg);

  /// @brief Method .ctor, addr 0x592ec90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x591db2c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Properties, addr 0x592ec98, size 0x8, virtual true, abstract: false, final false
