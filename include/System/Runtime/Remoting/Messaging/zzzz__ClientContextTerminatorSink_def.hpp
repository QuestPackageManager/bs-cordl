...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClientContextTerminatorSink", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClientContextTerminatorSink(ClientContextTerminatorSink&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClientContextTerminatorSink", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClientContextTerminatorSink(ClientContextTerminatorSinkconst&) = delete;
