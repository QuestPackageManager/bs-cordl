...
public:
  ...
  /// @brief Method GetArg, addr 0x5b47b68, size 0x30, virtual true, abstract: false, final true
  inline ::System::Object* GetArg(int32_t arg_num);

  /// @brief Method GetMethodInfo, addr 0x5b477a8, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodInfo* GetMethodInfo(::System::Type* type, ::StringW methodName);

  /// @brief Method InitMessage, addr 0x5b47348, size 0x27c, virtual false, abstract: false, final false
  inline void InitMessage(::System::Reflection::RuntimeMethodInfo* method, ::ArrayW<::System::Object*> out_args);

  /// @brief Method NeedsOutProcessing, addr 0x5b47d54, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_TargetIdentity, addr 0x5b47d3c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Identity* System_Runtime_Remoting_Messaging_IInternalMessage_get_TargetIdentity();

  /// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_TargetIdentity, addr 0x5b47d44, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b475c4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodBase* method, ::ArrayW<::System::Object*> out_args);

  /// @brief Method .ctor, addr 0x5b47680, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* minfo, ::ArrayW<::System::Object*> in_args, ::ArrayW<::System::Object*> out_args);

  /// @brief Method .ctor, addr 0x5b47844, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW methodName, ::ArrayW<::System::Object*> in_args);

  /// @brief Method get_ArgCount, addr 0x5b478e8, size 0x38, virtual true, abstract: false, final true
  inline int32_t get_ArgCount();

  /// @brief Method get_Args, addr 0x5b479a0, size 0x8, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Object*> get_Args();

  /// @brief Method get_AsyncResult, addr 0x5b47d4c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::AsyncResult* get_AsyncResult();

  /// @brief Method get_CallType, addr 0x5b47920, size 0x80, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::CallType get_CallType();

  /// @brief Method get_Exception, addr 0x5b47b98, size 0x8, virtual true, abstract: false, final true
  inline ::System::Exception* get_Exception();

  /// @brief Method get_LogicalCallContext, addr 0x5b479a8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext();

  /// @brief Method get_MethodBase, addr 0x5b479b8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Reflection::MethodBase* get_MethodBase();

  /// @brief Method get_MethodName, addr 0x5b479c0, size 0x28, virtual true, abstract: false, final true
  inline ::StringW get_MethodName();

  /// @brief Method get_MethodSignature, addr 0x5b479e8, size 0x124, virtual true, abstract: false, final true
  inline ::System::Object* get_MethodSignature();

  /// @brief Method get_OutArgCount, addr 0x5b47ba0, size 0x68, virtual true, abstract: false, final true
  inline int32_t get_OutArgCount();

  /// @brief Method get_OutArgs, addr 0x5b47c08, size 0x12c, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Object*> get_OutArgs();

  /// @brief Method get_Properties, addr 0x5b4787c, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Collections::IDictionary* get_Properties();

  /// @brief Method get_ReturnValue, addr 0x5b47d34, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_ReturnValue();

  /// @brief Method get_TypeName, addr 0x5b47b0c, size 0x4c, virtual true, abstract: false, final true
  inline ::StringW get_TypeName();

  /// @brief Method get_Uri, addr 0x5b47b58, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LogicalCallContext, addr 0x5b479b0, size 0x8, virtual false, abstract: false, final false
  inline void set_LogicalCallContext(::System::Runtime::Remoting::Messaging::LogicalCallContext* value);

  /// @brief Method set_Uri, addr 0x5b47b60, size 0x8, virtual true, abstract: false, final true
