...
public:
  ...
  /// @brief Method .ctor, addr 0x5b461c8, size 0x74, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MCMDictionary", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MCMDictionary(MCMDictionary&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MCMDictionary", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MCMDictionary(MCMDictionaryconst&) = delete;
