...
public:
  ...
  /// @brief Method GetInOutArgs, addr 0x272451c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2724368, size 0x1b4, virtual false, abstract: false, final false
