...
public:
  ...
  /// @brief Method GetInOutArgs, addr 0x5b3fc94, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b3fad0, size 0x1c4, virtual false, abstract: false, final false
