...
public:
  ...
  /// @brief Method GetInOutArgs, addr 0x3cf4b6c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cf49b8, size 0x1b4, virtual false, abstract: false, final false
