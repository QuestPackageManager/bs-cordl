...
public:
  ...
  /// @brief Method GetInOutArgs, addr 0x3ce71fc, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ce7048, size 0x1b4, virtual false, abstract: false, final false
