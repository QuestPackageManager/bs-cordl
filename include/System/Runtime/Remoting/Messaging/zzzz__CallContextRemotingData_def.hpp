...
/// @brief Method Clone, addr 0x598fe60, size 0x5c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5990018, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasInfo, addr 0x598ff18, size 0x10, virtual false, abstract: false, final false
inline bool get_HasInfo() ;

/// @brief Method get_LogicalCallID, addr 0x5990008, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LogicalCallID() ;

/// @brief Convert to "::System::ICloneable"
constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

/// @brief Method set_LogicalCallID, addr 0x5990010, size 0x8, virtual false, abstract: false, final false
