...
public:
  // Declarations
  /// @brief Method LogicalGetData, addr 0x5b3e748, size 0x40, virtual false, abstract: false, final false
  static inline ::System::Object* LogicalGetData(::StringW name);

  /// @brief Method LogicalSetData, addr 0x5b3e798, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentCallContext, addr 0x5b3e740, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Object* SetCurrentCallContext(::System::Runtime::Remoting::Messaging::LogicalCallContext* ctx);

  /// @brief Method SetLogicalCallContext, addr 0x5b29ce4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b3e73c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CallContext", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CallContext(CallContext&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CallContext", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CallContext(CallContextconst&) = delete;
