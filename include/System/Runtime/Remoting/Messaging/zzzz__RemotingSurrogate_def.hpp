...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RemotingSurrogate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RemotingSurrogate(RemotingSurrogate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RemotingSurrogate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RemotingSurrogate(RemotingSurrogateconst&) = delete;
