...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3cf62e4, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectData, addr 0x3cf63f4, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cf642c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
