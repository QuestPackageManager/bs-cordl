...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HeaderHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HeaderHandler(HeaderHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HeaderHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HeaderHandler(HeaderHandlerconst&) = delete;
