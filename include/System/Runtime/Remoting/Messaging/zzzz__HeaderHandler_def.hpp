...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x592f0a8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592ef64, size 0x144, virtual false, abstract: false, final false
