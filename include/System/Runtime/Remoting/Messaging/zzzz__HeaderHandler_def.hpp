...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x285a8a0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x285a774, size 0x12c, virtual false, abstract: false, final false
