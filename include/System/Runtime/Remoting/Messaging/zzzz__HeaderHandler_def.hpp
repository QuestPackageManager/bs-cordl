...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5b436b4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b43570, size 0x144, virtual false, abstract: false, final false
