...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x59959f4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59958b0, size 0x144, virtual false, abstract: false, final false
