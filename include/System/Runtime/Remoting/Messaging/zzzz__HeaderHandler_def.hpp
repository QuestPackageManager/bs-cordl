...
public:
// Declarations
/// @brief Method Invoke, addr 0x5995f00, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5995dbc, size 0x144, virtual false, abstract: false, final false
