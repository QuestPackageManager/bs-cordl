...
public:
  ...
  /// @brief Method GetMethodProperty, addr 0x3ce6f44, size 0x3cc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetMethodProperty, addr 0x3ce7874, size 0x268, virtual true, abstract: false, final false
  inline void SetMethodProperty(::StringW key, ::System::Object* value);

  /// @brief Method .ctor, addr 0x3ce5f94, size 0x7c, virtual false, abstract: false, final false
