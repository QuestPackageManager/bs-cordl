...
public:
  ...
  /// @brief Method GetMethodProperty, addr 0x282c2ac, size 0x3ac, virtual true, abstract: false, final false
  ...
  /// @brief Method SetMethodProperty, addr 0x282cb98, size 0x26c, virtual true, abstract: false, final false
  inline void SetMethodProperty(::StringW key, ::System::Object* value);

  /// @brief Method .ctor, addr 0x282b304, size 0x7c, virtual false, abstract: false, final false
