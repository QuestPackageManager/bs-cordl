...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x59956b4, size 0xdc, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::IMessageCtrl* AsyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg,
                                                                                   ::System::Runtime::Remoting::Messaging::IMessageSink* replySink);

  static inline ::System::Runtime::Remoting::Messaging::EnvoyTerminatorSink* New_ctor();

  /// @brief Method SyncProcessMessage, addr 0x59955ec, size 0xc8, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::IMessage* SyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method .ctor, addr 0x5995790, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
