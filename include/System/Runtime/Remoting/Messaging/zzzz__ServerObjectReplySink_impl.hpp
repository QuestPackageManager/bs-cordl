...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Runtime::Remoting::Messaging::ServerObjectReplySink::*)(
  ...
  constexpr static std::size_t addrs = 0x5b4b1c4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::System::Runtime::Remoting::Messaging::ServerObjectReplySink*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<
  ...
  constexpr static std::size_t addrs = 0x5b4b1cc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::Remoting::Messaging::ServerObjectReplySink*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Runtime::Remoting::Messaging::IMessageCtrl* (
  ...
  constexpr static std::size_t addrs = 0x5b4b2a0;
