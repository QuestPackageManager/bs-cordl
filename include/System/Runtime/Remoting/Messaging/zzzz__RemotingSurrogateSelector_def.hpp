...
public:
  ...
  /// @brief Method GetSurrogate, addr 0x5a0c840, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0c83c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
