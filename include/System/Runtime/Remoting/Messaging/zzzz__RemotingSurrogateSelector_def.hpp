...
public:
  ...
  /// @brief Method GetSurrogate, addr 0x25a4a50, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2596d20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
