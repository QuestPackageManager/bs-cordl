...
public:
  ...
  /// @brief Method GetSurrogate, addr 0x284de78, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x284de70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
