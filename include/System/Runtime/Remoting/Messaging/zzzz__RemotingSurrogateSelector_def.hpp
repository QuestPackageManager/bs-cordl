...
/// @brief Field _objRefSurrogate, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__objRefSurrogate, put=setStaticF__objRefSurrogate)) ::System::Runtime::Remoting::Messaging::ObjRefSurrogate*  _objRefSurrogate;

/// @brief Field _objRemotingSurrogate, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__objRemotingSurrogate, put=setStaticF__objRemotingSurrogate)) ::System::Runtime::Remoting::Messaging::RemotingSurrogate*  _objRemotingSurrogate;

/// @brief Field s_cachedTypeObjRef, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cachedTypeObjRef, put=setStaticF_s_cachedTypeObjRef)) ::System::Type*  s_cachedTypeObjRef;
...
/// @brief Method GetSurrogate, addr 0x599a8d4, size 0x1a8, virtual true, abstract: false, final false
inline ::System::Runtime::Serialization::ISerializationSurrogate* GetSurrogate(::System::Type*  type, ::System::Runtime::Serialization::StreamingContext  context, ::ByRef<::System::Runtime::Serialization::ISurrogateSelector*>  ssout) ;

static inline ::System::Runtime::Remoting::Messaging::RemotingSurrogateSelector* New_ctor() ;

constexpr ::System::Runtime::Serialization::ISurrogateSelector* const& __cordl_internal_get__next() const;
...
/// @brief Method .ctor, addr 0x599a8d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
