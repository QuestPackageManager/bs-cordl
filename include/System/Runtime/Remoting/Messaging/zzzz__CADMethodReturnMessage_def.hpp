...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CADMethodReturnMessage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CADMethodReturnMessage(CADMethodReturnMessage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CADMethodReturnMessage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CADMethodReturnMessage(CADMethodReturnMessageconst&) = delete;
