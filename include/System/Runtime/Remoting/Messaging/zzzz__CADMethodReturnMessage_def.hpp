...
public:
  ...
  /// @brief Method Create, addr 0x5b40524, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArgs, addr 0x5b40a78, size 0x10, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetArgs(::System::Collections::ArrayList* args);

  /// @brief Method GetArguments, addr 0x5b40930, size 0x148, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* GetArguments();

  /// @brief Method GetException, addr 0x5b40a98, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Exception* GetException(::System::Collections::ArrayList* args);

  /// @brief Method GetReturnValue, addr 0x5b40a88, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b405b4, size 0x37c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Remoting::Messaging::IMethodReturnMessage* retMsg);

  /// @brief Method get_PropertiesCount, addr 0x5b40b48, size 0x8, virtual false, abstract: false, final false
