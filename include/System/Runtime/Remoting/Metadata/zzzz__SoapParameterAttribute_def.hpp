...
public:
  ...
  /// @brief Method .ctor, addr 0x5b3e504, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SoapParameterAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SoapParameterAttribute(SoapParameterAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SoapParameterAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SoapParameterAttribute(SoapParameterAttributeconst&) = delete;
