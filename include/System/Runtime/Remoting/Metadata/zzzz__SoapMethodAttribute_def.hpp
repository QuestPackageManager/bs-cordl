...
public:
  ...
  /// @brief Method SetReflectionObject, addr 0x598e378, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x598e364, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_UseAttribute, addr 0x598e368, size 0x8, virtual true, abstract: false, final false
  inline bool get_UseAttribute();

  /// @brief Method get_XmlNamespace, addr 0x598e370, size 0x8, virtual true, abstract: false, final false
