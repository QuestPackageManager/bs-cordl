...
public:
  ...
  /// @brief Method SetReflectionObject, addr 0x2853298, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2853258, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInteropXmlElement, addr 0x2853288, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInteropXmlElement();

  /// @brief Method get_IsInteropXmlType, addr 0x2853290, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInteropXmlType();

  /// @brief Method get_UseAttribute, addr 0x2853260, size 0x8, virtual true, abstract: false, final false
  inline bool get_UseAttribute();

  /// @brief Method get_XmlElementName, addr 0x2853268, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlElementName();

  /// @brief Method get_XmlNamespace, addr 0x2853270, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_XmlNamespace();

  /// @brief Method get_XmlTypeName, addr 0x2853278, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlTypeName();

  /// @brief Method get_XmlTypeNamespace, addr 0x2853280, size 0x8, virtual false, abstract: false, final false
