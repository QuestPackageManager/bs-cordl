...
public:
  ...
  /// @brief Method SetReflectionObject, addr 0x5b3bf58, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b3bf44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_UseAttribute, addr 0x5b3bf48, size 0x8, virtual true, abstract: false, final false
  inline bool get_UseAttribute();

  /// @brief Method get_XmlNamespace, addr 0x5b3bf50, size 0x8, virtual true, abstract: false, final false
