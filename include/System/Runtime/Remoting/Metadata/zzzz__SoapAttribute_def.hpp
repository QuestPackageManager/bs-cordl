...
public:
  ...
  /// @brief Method SetReflectionObject, addr 0x2722b34, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2722b1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_UseAttribute, addr 0x2722b24, size 0x8, virtual true, abstract: false, final false
  inline bool get_UseAttribute();

  /// @brief Method get_XmlNamespace, addr 0x2722b2c, size 0x8, virtual true, abstract: false, final false
