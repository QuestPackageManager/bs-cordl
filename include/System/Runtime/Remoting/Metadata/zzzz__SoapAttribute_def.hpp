...
public:
  ...
  /// @brief Method SetReflectionObject, addr 0x592794c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5927938, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_UseAttribute, addr 0x592793c, size 0x8, virtual true, abstract: false, final false
  inline bool get_UseAttribute();

  /// @brief Method get_XmlNamespace, addr 0x5927944, size 0x8, virtual true, abstract: false, final false
