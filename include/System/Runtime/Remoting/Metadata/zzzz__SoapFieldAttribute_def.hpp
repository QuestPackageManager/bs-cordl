...
public:
  ...
  /// @brief Method IsInteropXmlElement, addr 0x3ce5b64, size 0x8, virtual false, abstract: false, final false
  inline bool IsInteropXmlElement();

  static inline ::System::Runtime::Remoting::Metadata::SoapFieldAttribute* New_ctor();

  /// @brief Method SetReflectionObject, addr 0x3ce5b6c, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ce5b54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XmlElementName, addr 0x3ce5b5c, size 0x8, virtual false, abstract: false, final false
