...
public:
  ...
  /// @brief Method IsInteropXmlElement, addr 0x3ce7610, size 0x8, virtual false, abstract: false, final false
  inline bool IsInteropXmlElement();

  static inline ::System::Runtime::Remoting::Metadata::SoapFieldAttribute* New_ctor();

  /// @brief Method SetReflectionObject, addr 0x3ce7618, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ce7600, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XmlElementName, addr 0x3ce7608, size 0x8, virtual false, abstract: false, final false
