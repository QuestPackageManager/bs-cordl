...
public:
  ...
  /// @brief Method CanCastTo, addr 0x59f30f8, size 0x24c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59f0bd0, size 0x364, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_TypeName, addr 0x59f30f0, size 0x8, virtual true, abstract: false, final true
