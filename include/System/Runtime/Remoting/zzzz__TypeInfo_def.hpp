...
public:
  ...
  /// @brief Method CanCastTo, addr 0x3cd78c0, size 0x274, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3cd51c0, size 0x3a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_TypeName, addr 0x3cd78b8, size 0x8, virtual true, abstract: false, final true
