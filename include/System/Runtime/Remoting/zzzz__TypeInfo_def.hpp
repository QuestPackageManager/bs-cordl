...
public:
  ...
  /// @brief Method CanCastTo, addr 0x25ebbc4, size 0x26c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25e92a0, size 0x410, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_TypeName, addr 0x25ebbbc, size 0x8, virtual true, abstract: false, final true
