...
/// @brief Method .ctor, addr 0x597db40, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Connect, addr 0x597a274, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Object* Connect(::System::Type*  classToProxy, ::StringW  url) ;

/// @brief Method Connect, addr 0x597a38c, size 0xa4, virtual false, abstract: false, final false
static inline ::System::Object* Connect(::System::Type*  classToProxy, ::StringW  url, ::System::Object*  data) ;

/// @brief Method CreateClientActivatedServerIdentity, addr 0x597b9b4, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method CreateClientProxy, addr 0x597c1c4, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method CreateClientProxy, addr 0x597c548, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Object* CreateClientProxy(::System::Runtime::Remoting::WellKnownClientTypeEntry*  entry) ;

/// @brief Method CreateClientProxy, addr 0x597c2cc, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method CreateClientProxyForContextBound, addr 0x597c5b4, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method CreateContextBoundObjectIdentity, addr 0x597d7bc, size 0xd8, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::ClientActivatedIdentity* CreateContextBoundObjectIdentity(::System::Type*  objectType) ;

/// @brief Method CreateWellKnownServerIdentity, addr 0x5979a9c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method DeserializeCallData, addr 0x597dbb0, size 0x24c, virtual false, abstract: false, final false
static inline ::System::Object* DeserializeCallData(::ArrayW<uint8_t,::Array<uint8_t>*>  array) ;

/// @brief Method DisposeIdentity, addr 0x597cdac, size 0x208, virtual false, abstract: false, final false
static inline void DisposeIdentity(::System::Runtime::Remoting::Identity*  ident) ;

/// @brief Method FindInterfaceMethod, addr 0x597bf1c, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method GetClientChannelSinkChain, addr 0x597c41c, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetIdentityForUri, addr 0x597a4e0, size 0x258, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Identity* GetIdentityForUri(::StringW  uri) ;

/// @brief Method GetMessageTargetIdentity, addr 0x597e320, size 0x354, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Identity* GetMessageTargetIdentity(::System::Runtime::Remoting::Messaging::IMessage*  msg) ;

/// @brief Method GetMethodBaseFromMethodMessage, addr 0x597ba78, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method GetMethodBaseFromName, addr 0x597bd50, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method GetNormalizedUri, addr 0x597c74c, size 0x80, virtual false, abstract: false, final false
static inline ::StringW GetNormalizedUri(::StringW  uri) ;

/// @brief Method GetObjectData, addr 0x597c05c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method GetOrCreateClientIdentity, addr 0x597c8e0, size 0x4cc, virtual false, abstract: false, final false
...
/// @brief Method GetProxyForRemoteObject, addr 0x597ad18, size 0xfc, virtual false, abstract: false, final false
static inline ::System::Object* GetProxyForRemoteObject(::System::Runtime::Remoting::ObjRef*  objref, ::System::Type*  classToProxy) ;

/// @brief Method GetRealProxy, addr 0x597aeec, size 0x54, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Proxies::RealProxy* GetRealProxy(::System::Object*  proxy) ;

/// @brief Method GetRemoteObject, addr 0x597a314, size 0x78, virtual false, abstract: false, final false
static inline ::System::Object* GetRemoteObject(::System::Runtime::Remoting::ObjRef*  objRef, ::System::Type*  proxyType) ;

/// @brief Method GetServerTypeForUri, addr 0x597a430, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Type* GetServerTypeForUri(::StringW  URI) ;

/// @brief Method GetVirtualMethod, addr 0x5979bac, size 0x8, virtual false, abstract: false, final false
static inline ::System::Reflection::MethodBase* GetVirtualMethod(::System::Type*  type, ::System::Reflection::MethodBase*  method) ;

/// @brief Method InternalExecute, addr 0x5979ba4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method InternalExecuteMessage, addr 0x5979bec, size 0x644, virtual false, abstract: false, final false
...
/// @brief Method IsOneWay, addr 0x597c140, size 0x84, virtual false, abstract: false, final false
static inline bool IsOneWay(::System::Reflection::MethodBase*  method) ;

/// @brief Method IsTransparentProxy, addr 0x5979bb4, size 0x38, virtual false, abstract: false, final false
static inline bool IsTransparentProxy(::System::Object*  proxy) ;

/// @brief Method Marshal, addr 0x597ae14, size 0x48, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::ObjRef* Marshal(::System::MarshalByRefObject*  Obj) ;

/// @brief Method Marshal, addr 0x597ae5c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method NewUri, addr 0x597afd8, size 0x300, virtual false, abstract: false, final false
static inline ::StringW NewUri() ;

/// @brief Method RegisterInternalChannels, addr 0x5979a4c, size 0x50, virtual false, abstract: false, final false
static inline void RegisterInternalChannels() ;

/// @brief Method RegisterServerIdentity, addr 0x597b2d8, size 0x214, virtual false, abstract: false, final false
static inline void RegisterServerIdentity(::System::Runtime::Remoting::ServerIdentity*  identity) ;

/// @brief Method RemoveAppNameFromUri, addr 0x597c7cc, size 0x114, virtual false, abstract: false, final false
static inline ::StringW RemoveAppNameFromUri(::StringW  uri) ;

/// @brief Method SerializeCallData, addr 0x597d948, size 0x1e8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> SerializeCallData(::System::Object*  obj) ;

/// @brief Method SerializeExceptionData, addr 0x597e084, size 0x16c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> SerializeExceptionData(::System::Exception*  ex) ;

/// @brief Method SetMessageTargetIdentity, addr 0x597e674, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method Unmarshal, addr 0x597a738, size 0x5c, virtual false, abstract: false, final false
static inline ::System::Object* Unmarshal(::System::Runtime::Remoting::ObjRef*  objectRef) ;

/// @brief Method Unmarshal, addr 0x597a794, size 0x268, virtual false, abstract: false, final false
static inline ::System::Object* Unmarshal(::System::Runtime::Remoting::ObjRef*  objectRef, bool  fRefine) ;

/// @brief Method UpdateOutArgObject, addr 0x597e78c, size 0xf4, virtual false, abstract: false, final false
