...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RemotingException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RemotingException(RemotingException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RemotingException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RemotingException(RemotingExceptionconst&) = delete;
