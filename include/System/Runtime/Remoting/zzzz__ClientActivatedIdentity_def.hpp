...
public:
  ...
  /// @brief Method AsyncObjectProcessMessage, addr 0x59f1730, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetServerObject, addr 0x59f141c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnLifetimeExpired, addr 0x59f142c, size 0x60, virtual true, abstract: false, final false
  inline void OnLifetimeExpired();

  /// @brief Method SetClientProxy, addr 0x59f1424, size 0x8, virtual false, abstract: false, final false
  inline void SetClientProxy(::System::MarshalByRefObject* obj);

  /// @brief Method SyncObjectProcessMessage, addr 0x59f148c, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59ef800, size 0x10, virtual false, abstract: false, final false
