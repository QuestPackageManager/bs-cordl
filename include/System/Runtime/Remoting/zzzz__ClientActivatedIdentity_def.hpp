...
public:
  ...
  /// @brief Method AsyncObjectProcessMessage, addr 0x28302f4, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method GetServerObject, addr 0x282fff4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnLifetimeExpired, addr 0x2830004, size 0x5c, virtual true, abstract: false, final false
  inline void OnLifetimeExpired();

  /// @brief Method SetClientProxy, addr 0x282fffc, size 0x8, virtual false, abstract: false, final false
  inline void SetClientProxy(::System::MarshalByRefObject* obj);

  /// @brief Method SyncObjectProcessMessage, addr 0x2830060, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x282e1c8, size 0x2c, virtual false, abstract: false, final false
