...
public:
  ...
  /// @brief Method NotifyClientDynamicSinks, addr 0x59e3584, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyServerDynamicSinks, addr 0x59e360c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59e348c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectUri);

  /// @brief Method get_ChannelSink, addr 0x59e3494, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_ChannelSink();

  /// @brief Method get_ClientDynamicProperties, addr 0x59e34dc, size 0x68, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Contexts::DynamicPropertyCollection* get_ClientDynamicProperties();

  /// @brief Method get_Disposed, addr 0x59e34cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_Disposed();

  /// @brief Method get_EnvoySink, addr 0x59e34a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_EnvoySink();

  /// @brief Method get_HasServerDynamicSinks, addr 0x59e3544, size 0x40, virtual false, abstract: false, final false
  inline bool get_HasServerDynamicSinks();

  /// @brief Method get_IsConnected, addr 0x59e34bc, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsConnected();

  /// @brief Method get_ObjectUri, addr 0x59e34ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ObjectUri();

  /// @brief Method set_ChannelSink, addr 0x59e349c, size 0x8, virtual false, abstract: false, final false
  inline void set_ChannelSink(::System::Runtime::Remoting::Messaging::IMessageSink* value);

  /// @brief Method set_Disposed, addr 0x59e34d4, size 0x8, virtual false, abstract: false, final false
  inline void set_Disposed(bool value);

  /// @brief Method set_ObjectUri, addr 0x59e34b4, size 0x8, virtual false, abstract: false, final false
