...
public:
  ...
  /// @brief Method NotifyClientDynamicSinks, addr 0x3cc74bc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyServerDynamicSinks, addr 0x3cc7530, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc73d0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW objectUri);

  /// @brief Method get_ChannelSink, addr 0x3cc73f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_ChannelSink();

  /// @brief Method get_ClientDynamicProperties, addr 0x3cc7444, size 0x64, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Contexts::DynamicPropertyCollection* get_ClientDynamicProperties();

  /// @brief Method get_Disposed, addr 0x3cc7430, size 0x8, virtual false, abstract: false, final false
  inline bool get_Disposed();

  /// @brief Method get_EnvoySink, addr 0x3cc7408, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_EnvoySink();

  /// @brief Method get_HasServerDynamicSinks, addr 0x3cc74a8, size 0x14, virtual false, abstract: false, final false
  inline bool get_HasServerDynamicSinks();

  /// @brief Method get_IsConnected, addr 0x3cc7420, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsConnected();

  /// @brief Method get_ObjectUri, addr 0x3cc7410, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ObjectUri();

  /// @brief Method set_ChannelSink, addr 0x3cc7400, size 0x8, virtual false, abstract: false, final false
  inline void set_ChannelSink(::System::Runtime::Remoting::Messaging::IMessageSink* value);

  /// @brief Method set_Disposed, addr 0x3cc7438, size 0xc, virtual false, abstract: false, final false
  inline void set_Disposed(bool value);

  /// @brief Method set_ObjectUri, addr 0x3cc7418, size 0x8, virtual false, abstract: false, final false
