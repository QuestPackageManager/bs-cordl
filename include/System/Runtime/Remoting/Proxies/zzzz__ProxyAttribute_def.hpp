...
public:
  ...
  /// @brief Method CreateInstance, addr 0x5b2ef14, size 0x104, virtual true, abstract: false, final false
  inline ::System::MarshalByRefObject* CreateInstance(::System::Type* serverType);

  /// @brief Method CreateProxy, addr 0x5b2f018, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesForNewContext, addr 0x5b2f078, size 0x4, virtual true, abstract: false, final true
  inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage* msg);

  /// @brief Method IsContextOK, addr 0x5b2f07c, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Proxies::ProxyAttribute) == 0x10, "Size mismatch!");
