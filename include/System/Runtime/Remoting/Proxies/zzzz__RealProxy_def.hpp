...
public:
  ...
  /// @brief Method AttachServer, addr 0x3cd4cf0, size 0x8, virtual false, abstract: false, final false
  inline void AttachServer(::System::MarshalByRefObject* s);

  /// @brief Method GetAppDomainTarget, addr 0x3cd4d00, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Object* GetAppDomainTarget();

  /// @brief Method GetObjectData, addr 0x3cd41d8, size 0x7c, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetProxiedType, addr 0x3ccc364, size 0xac, virtual false, abstract: false, final false
  inline ::System::Type* GetProxiedType();

  /// @brief Method GetTransparentProxy, addr 0x3cd4b8c, size 0x164, virtual true, abstract: false, final false
  inline ::System::Object* GetTransparentProxy();

  /// @brief Method InternalGetProxyType, addr 0x3cd41d4, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Type* InternalGetProxyType(::System::Object* transparentProxy);

  /// @brief Method InternalGetTransparentProxy, addr 0x3cd4b88, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method PrivateInvoke, addr 0x3cd351c, size 0x8b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessResponse, addr 0x3cd44a0, size 0x6e8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTargetDomain, addr 0x3cd4cf8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cd40a8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cd40b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* classToProxy);

  /// @brief Method .ctor, addr 0x3cd41ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* classToProxy, ::System::Runtime::Remoting::ClientIdentity* identity);

  /// @brief Method .ctor, addr 0x3cd40c0, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* classToProxy, ::System::IntPtr stub, ::System::Object* stubData);

  /// @brief Method get_ObjectIdentity, addr 0x3cd4254, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::Identity* get_ObjectIdentity();

  /// @brief Method set_ObjectIdentity, addr 0x3cd425c, size 0x8, virtual false, abstract: false, final false
