...
public:
  ...
  /// @brief Method GetProxyType, addr 0x3ce560c, size 0xd0, virtual false, abstract: false, final false
  inline ::System::RuntimeType* GetProxyType();

  /// @brief Method InCurrentContext, addr 0x3ce5714, size 0x40, virtual false, abstract: false, final false
  inline bool InCurrentContext();

  /// @brief Method LoadRemoteFieldNew, addr 0x3ce5754, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreRemoteField, addr 0x3ce62d8, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ce65a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsContextBoundObject, addr 0x3ce56dc, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsContextBoundObject();

  /// @brief Method get_TargetContext, addr 0x3ce56f8, size 0x1c, virtual false, abstract: false, final false
