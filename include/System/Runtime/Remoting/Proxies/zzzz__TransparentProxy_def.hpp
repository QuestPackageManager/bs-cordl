...
/// @brief Method GetProxyType, addr 0x59818d0, size 0xa8, virtual false, abstract: false, final false
inline ::System::RuntimeType* GetProxyType() ;

/// @brief Method InCurrentContext, addr 0x59819b4, size 0x50, virtual false, abstract: false, final false
inline bool InCurrentContext() ;

/// @brief Method LoadRemoteFieldNew, addr 0x5981a04, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method StoreRemoteField, addr 0x598258c, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5982834, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsContextBoundObject, addr 0x5981978, size 0x24, virtual false, abstract: false, final false
inline bool get_IsContextBoundObject() ;

/// @brief Method get_TargetContext, addr 0x598199c, size 0x18, virtual false, abstract: false, final false
