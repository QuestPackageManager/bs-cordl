...
public:
  ...
  /// @brief Method GetProxyType, addr 0x5b2f084, size 0xa8, virtual false, abstract: false, final false
  inline ::System::RuntimeType* GetProxyType();

  /// @brief Method InCurrentContext, addr 0x5b2f168, size 0x50, virtual false, abstract: false, final false
  inline bool InCurrentContext();

  /// @brief Method LoadRemoteFieldNew, addr 0x5b2f1b8, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreRemoteField, addr 0x5b2fd40, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b2ffe8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsContextBoundObject, addr 0x5b2f12c, size 0x24, virtual false, abstract: false, final false
  inline bool get_IsContextBoundObject();

  /// @brief Method get_TargetContext, addr 0x5b2f150, size 0x18, virtual false, abstract: false, final false
