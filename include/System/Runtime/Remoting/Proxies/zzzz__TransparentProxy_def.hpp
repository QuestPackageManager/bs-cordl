...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TransparentProxy", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TransparentProxy(TransparentProxy&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TransparentProxy", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TransparentProxy(TransparentProxyconst&) = delete;
