...
public:
  ...
  /// @brief Method ActivateRemoteObject, addr 0x3cd92e8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method AttachIdentity, addr 0x3cdafe4, size 0x228, virtual false, abstract: false, final false
  inline void AttachIdentity(::System::Runtime::Remoting::Identity* identity);

  /// @brief Method CanCastTo, addr 0x3cdb8d8, size 0x21c, virtual true, abstract: false, final true
  inline bool CanCastTo(::System::Type* fromType, ::System::Object* o);

  /// @brief Method Finalize, addr 0x3cdbaf4, size 0x118, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Invoke, addr 0x3cda758, size 0x5d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cd28f4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW activationUrl, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> activationAttributes);

  /// @brief Method .ctor, addr 0x3cd336c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TypeName, addr 0x3cdb7a0, size 0x138, virtual true, abstract: false, final true
