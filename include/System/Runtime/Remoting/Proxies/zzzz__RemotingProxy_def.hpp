...
namespace System::Runtime::Remoting::Proxies {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3087))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2340140 size 0x44 virtual false final false
  ...
  /// @brief Method .ctor addr 0x233d9a8 size 0x48 virtual false final false
  inline void _ctor(::System::Type* type, ::StringW activationUrl, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> activationAttributes);

  /// @brief Method Invoke addr 0x2340b40 size 0x5c8 virtual true final false
  inline ::System::Runtime::Remoting::Messaging::IMessage* Invoke(::System::Runtime::Remoting::Messaging::IMessage* request);

  /// @brief Method AttachIdentity addr 0x234149c size 0x230 virtual false final false
  inline void AttachIdentity(::System::Runtime::Remoting::Identity* identity);

  /// @brief Method ActivateRemoteObject addr 0x233f068 size 0xdc virtual false final false
  ...
  /// @brief Method get_TypeName addr 0x2341c5c size 0x138 virtual true final true
  inline ::StringW get_TypeName();

  /// @brief Method CanCastTo addr 0x2341d94 size 0x21c virtual true final true
  inline bool CanCastTo(::System::Type* fromType, ::System::Object* o);

  /// @brief Method Finalize addr 0x2341fb0 size 0x11c virtual true final false
