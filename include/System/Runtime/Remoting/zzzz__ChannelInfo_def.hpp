...
public:
  ...
  /// @brief Method .ctor, addr 0x3cc6ff4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cc705c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* remoteChannelData);

  /// @brief Method get_ChannelData, addr 0x3cc7104, size 0x8, virtual true, abstract: false, final true
