...
public:
  ...
  /// @brief Method TrackLifetime, addr 0x27169a8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LeaseManagerPollTime, addr 0x271ef70, size 0x58, virtual false, abstract: false, final false
  static inline ::System::TimeSpan get_LeaseManagerPollTime();

  /// @brief Method get_LeaseTime, addr 0x271f03c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::TimeSpan get_LeaseTime();

  /// @brief Method get_RenewOnCallTime, addr 0x271f0f0, size 0x58, virtual false, abstract: false, final false
  static inline ::System::TimeSpan get_RenewOnCallTime();

  /// @brief Method get_SponsorshipTimeout, addr 0x271f1a4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LeaseManagerPollTime, addr 0x271efc8, size 0x74, virtual false, abstract: false, final false
  static inline void set_LeaseManagerPollTime(::System::TimeSpan value);

  /// @brief Method set_LeaseTime, addr 0x271f094, size 0x5c, virtual false, abstract: false, final false
  static inline void set_LeaseTime(::System::TimeSpan value);

  /// @brief Method set_RenewOnCallTime, addr 0x271f148, size 0x5c, virtual false, abstract: false, final false
  static inline void set_RenewOnCallTime(::System::TimeSpan value);

  /// @brief Method set_SponsorshipTimeout, addr 0x271f1fc, size 0x5c, virtual false, abstract: false, final false
