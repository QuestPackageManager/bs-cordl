...
public:
  ...
  /// @brief Method ManageLeases, addr 0x591f390, size 0x25c, virtual false, abstract: false, final false
  inline void ManageLeases(::System::Object* state);

  static inline ::System::Runtime::Remoting::Lifetime::LeaseManager* New_ctor();

  /// @brief Method SetPollTime, addr 0x591efdc, size 0xe8, virtual false, abstract: false, final false
  inline void SetPollTime(::System::TimeSpan timeSpan);

  /// @brief Method StartManager, addr 0x591f1f0, size 0x184, virtual false, abstract: false, final false
  inline void StartManager();

  /// @brief Method StopManager, addr 0x591f374, size 0x1c, virtual false, abstract: false, final false
  inline void StopManager();

  /// @brief Method TrackLifetime, addr 0x591f0c4, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591f5ec, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
