...
public:
  ...
  /// @brief Method ManageLeases, addr 0x3cdc980, size 0x260, virtual false, abstract: false, final false
  inline void ManageLeases(::System::Object* state);

  static inline ::System::Runtime::Remoting::Lifetime::LeaseManager* New_ctor();

  /// @brief Method SetPollTime, addr 0x3cdc5ec, size 0xf4, virtual false, abstract: false, final false
  inline void SetPollTime(::System::TimeSpan timeSpan);

  /// @brief Method StartManager, addr 0x3cdc810, size 0x154, virtual false, abstract: false, final false
  inline void StartManager();

  /// @brief Method StopManager, addr 0x3cdc964, size 0x1c, virtual false, abstract: false, final false
  inline void StopManager();

  /// @brief Method TrackLifetime, addr 0x3cdc6e0, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cdcbe0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
