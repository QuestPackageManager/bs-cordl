...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x3cdcfa4, size 0xc4, virtual true, abstract: false, final true
  ...
  /// @brief Method RenewLease, addr 0x3cdcd18, size 0x28c, virtual false, abstract: false, final false
  inline void RenewLease(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method SyncProcessMessage, addr 0x3cdcc68, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3cdcc40, size 0x28, virtual false, abstract: false, final false
