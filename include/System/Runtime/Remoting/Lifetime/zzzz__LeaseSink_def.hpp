...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x591f99c, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method RenewLease, addr 0x591f70c, size 0x290, virtual false, abstract: false, final false
  inline void RenewLease(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method SyncProcessMessage, addr 0x591f650, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x591f648, size 0x8, virtual false, abstract: false, final false
