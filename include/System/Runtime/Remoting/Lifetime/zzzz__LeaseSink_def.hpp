...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5b362a8, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method RenewLease, addr 0x5b36018, size 0x290, virtual false, abstract: false, final false
  inline void RenewLease(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method SyncProcessMessage, addr 0x5b35f5c, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b35f54, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeaseSink", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeaseSink(LeaseSink&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeaseSink", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeaseSink(LeaseSinkconst&) = delete;
