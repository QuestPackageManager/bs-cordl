...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x3cdd01c, size 0xc4, virtual true, abstract: false, final true
  ...
  /// @brief Method RenewLease, addr 0x3cdcd90, size 0x28c, virtual false, abstract: false, final false
  inline void RenewLease(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method SyncProcessMessage, addr 0x3cdcce0, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3cdccb8, size 0x28, virtual false, abstract: false, final false
