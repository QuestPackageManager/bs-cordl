...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x59856e0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x59858f0, size 0x24, virtual true, abstract: false, final false
  inline ::System::TimeSpan EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5985914, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x598559c, size 0x144, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Activate, addr 0x5984fc8, size 0xc, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method CheckNextSponsor, addr 0x598533c, size 0x260, virtual false, abstract: false, final false
  inline void CheckNextSponsor();

  static inline ::System::Runtime::Remoting::Lifetime::Lease* New_ctor();

  /// @brief Method ProcessSponsorResponse, addr 0x5985700, size 0x1f0, virtual false, abstract: false, final false
  inline void ProcessSponsorResponse(::System::Object* state, bool timedOut);

  /// @brief Method Renew, addr 0x5984fdc, size 0x90, virtual true, abstract: false, final true
  inline ::System::TimeSpan Renew(::System::TimeSpan renewalTime);

  /// @brief Method Unregister, addr 0x598506c, size 0x140, virtual true, abstract: false, final true
  inline void Unregister(::System::Runtime::Remoting::Lifetime::ISponsor* obj);

  /// @brief Method UpdateState, addr 0x59851ac, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x597e38c, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CurrentLeaseTime, addr 0x5984f54, size 0x6c, virtual true, abstract: false, final true
  inline ::System::TimeSpan get_CurrentLeaseTime();

  /// @brief Method get_CurrentState, addr 0x5984fc0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Lifetime::LeaseState get_CurrentState();

  /// @brief Method get_RenewOnCallTime, addr 0x5984fd4, size 0x8, virtual true, abstract: false, final true
