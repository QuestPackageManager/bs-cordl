...
public:
  ...
  /// @brief Method CopyFrom, addr 0x3cca108, size 0x700, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cca0a8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
