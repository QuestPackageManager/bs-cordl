...
public:
  ...
  /// @brief Method CopyFrom, addr 0x59eafec, size 0x69c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59eaf8c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
