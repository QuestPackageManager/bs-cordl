...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProviderData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProviderData(ProviderData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProviderData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProviderData(ProviderDataconst&) = delete;
