...
public:
  ...
  /// @brief Method CopyFrom, addr 0x3cd0ab0, size 0x700, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cd0a50, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
