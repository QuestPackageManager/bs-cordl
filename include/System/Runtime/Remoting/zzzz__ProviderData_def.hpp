...
public:
  ...
  /// @brief Method CopyFrom, addr 0x25df7b0, size 0x704, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25e3b50, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
