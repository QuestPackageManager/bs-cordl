...
public:
  ...
  /// @brief Method ToString, addr 0x59e346c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59e337c, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName);

  /// @brief Method get_ObjectType, addr 0x59e3464, size 0x8, virtual false, abstract: false, final false
