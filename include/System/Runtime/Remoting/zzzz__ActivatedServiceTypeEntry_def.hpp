...
public:
  ...
  /// @brief Method ToString, addr 0x2832dcc, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2832c98, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName);

  /// @brief Method get_ObjectType, addr 0x2832dc4, size 0x8, virtual false, abstract: false, final false
