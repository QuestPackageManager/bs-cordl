...
/// @brief Method ToString, addr 0x5971500, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5971410, size 0xe8, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName, ::StringW  assemblyName) ;

/// @brief Method get_ObjectType, addr 0x59714f8, size 0x8, virtual false, abstract: false, final false
