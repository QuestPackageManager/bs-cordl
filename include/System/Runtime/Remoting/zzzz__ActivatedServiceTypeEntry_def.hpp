...
public:
  ...
  /// @brief Method ToString, addr 0x3cc7390, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc7264, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName);

  /// @brief Method get_ObjectType, addr 0x3cc7388, size 0x8, virtual false, abstract: false, final false
