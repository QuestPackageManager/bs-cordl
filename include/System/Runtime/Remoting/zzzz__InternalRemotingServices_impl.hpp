...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Runtime::Remoting::Metadata::SoapAttribute* (*)(::System::Object*)>(&::System::Runtime::Remoting::InternalRemotingServices::GetCachedSoapAttribute)> {
  constexpr static std::size_t size = 0x4fc;
  constexpr static std::size_t addrs = 0x59e5428;
