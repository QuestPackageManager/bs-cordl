...
public:
  ...
  /// @brief Method DeserializeInTheCurrentDomain, addr 0x27043e4, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::ObjRef* DeserializeInTheCurrentDomain(int32_t domainId, ::ArrayW<uint8_t, ::Array<uint8_t>*> tInfo);

  /// @brief Method GetObjectData, addr 0x2704c60, size 0x1d8, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetRealObject, addr 0x2704e38, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method SerializeType, addr 0x2704510, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> SerializeType();

  /// @brief Method UpdateChannelInfo, addr 0x270435c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2704340, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x270468c, size 0x534, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x270458c, size 0x100, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW url, ::System::Object* remoteChannelData);

  /// @brief Method .ctor, addr 0x27043b8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ChannelInfo, addr 0x2704c28, size 0x8, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::IChannelInfo* get_ChannelInfo();

  /// @brief Method get_EnvoyInfo, addr 0x2704c30, size 0x8, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::IEnvoyInfo* get_EnvoyInfo();

  /// @brief Method get_IsReferenceToWellKnow, addr 0x2704bc0, size 0x68, virtual false, abstract: false, final false
  inline bool get_IsReferenceToWellKnow();

  /// @brief Method get_ServerType, addr 0x2704ee0, size 0x144, virtual false, abstract: false, final false
  inline ::System::Type* get_ServerType();

  /// @brief Method get_TypeInfo, addr 0x2704c40, size 0x8, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::IRemotingTypeInfo* get_TypeInfo();

  /// @brief Method get_URI, addr 0x2704c50, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_EnvoyInfo, addr 0x2704c38, size 0x8, virtual true, abstract: false, final false
  inline void set_EnvoyInfo(::System::Runtime::Remoting::IEnvoyInfo* value);

  /// @brief Method set_TypeInfo, addr 0x2704c48, size 0x8, virtual true, abstract: false, final false
  inline void set_TypeInfo(::System::Runtime::Remoting::IRemotingTypeInfo* value);

  /// @brief Method set_URI, addr 0x2704c58, size 0x8, virtual true, abstract: false, final false
