...
public:
  ...
  /// @brief Method ToString, addr 0x5b2ec8c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b2eb8c, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW objectUrl);

  /// @brief Method get_ApplicationUrl, addr 0x5b2ec74, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ApplicationUrl();

  /// @brief Method get_ObjectType, addr 0x5b2ec7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_ObjectUrl, addr 0x5b2ec84, size 0x8, virtual false, abstract: false, final false
