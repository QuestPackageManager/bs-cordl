...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Contexts::IContextProperty*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Contexts::IContextProperty*, "System.Runtime.Remoting.Contexts", "IContextProperty");
// [ComVisible(true)]
// Dependencies
namespace System::Runtime::Remoting::Contexts {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IContextProperty", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IContextProperty(IContextPropertyconst&) = delete;
