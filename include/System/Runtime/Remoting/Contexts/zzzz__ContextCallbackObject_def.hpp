...
public:
  // Declarations
  /// @brief Method DoCallBack, addr 0x5b35fe8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b35fe4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
