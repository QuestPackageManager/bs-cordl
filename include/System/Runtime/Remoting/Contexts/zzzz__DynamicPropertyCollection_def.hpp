...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Contexts::DynamicPropertyCollection*);
MARK_REF_T(::System::Runtime::Remoting::Contexts::DynamicPropertyCollection_DynamicPropertyReg*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Contexts::DynamicPropertyCollection*, "System.Runtime.Remoting.Contexts", "DynamicPropertyCollection");
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Contexts::DynamicPropertyCollection_DynamicPropertyReg*, "System.Runtime.Remoting.Contexts", "DynamicPropertyCollection/DynamicPropertyReg");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5b3888c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DynamicPropertyCollection_DynamicPropertyReg", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DynamicPropertyCollection_DynamicPropertyReg(DynamicPropertyCollection_DynamicPropertyReg&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DynamicPropertyCollection_DynamicPropertyReg", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DynamicPropertyCollection_DynamicPropertyReg(DynamicPropertyCollection_DynamicPropertyRegconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Remoting::Contexts::DynamicPropertyCollection_DynamicPropertyReg) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method FindProperty, addr 0x5b38724, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyMessage, addr 0x5b37298, size 0x5e0, virtual false, abstract: false, final false
  inline void NotifyMessage(bool start, ::System::Runtime::Remoting::Messaging::IMessage* msg, bool client_site, bool async);

  /// @brief Method RegisterDynamicProperty, addr 0x5b36c40, size 0x304, virtual false, abstract: false, final false
  inline bool RegisterDynamicProperty(::System::Runtime::Remoting::Contexts::IDynamicProperty* prop);

  /// @brief Method UnregisterDynamicProperty, addr 0x5b36fc0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b37138, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HasProperties, addr 0x5b36a0c, size 0x30, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DynamicPropertyCollection", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DynamicPropertyCollection(DynamicPropertyCollection&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DynamicPropertyCollection", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DynamicPropertyCollection(DynamicPropertyCollectionconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Remoting::Contexts::DynamicPropertyCollection) == 0x18, "Size mismatch!");
