...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5922a00, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method SyncProcessMessage, addr 0x5922750, size 0x2b0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5922740, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5922364, size 0x3dc, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::IMessageCtrl* AsyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg,
                                                                                   ::System::Runtime::Remoting::Messaging::IMessageSink* replySink);

  static inline ::System::Runtime::Remoting::Contexts::CrossContextChannel* New_ctor();

  /// @brief Method SyncProcessMessage, addr 0x5921f84, size 0x3e0, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::IMessage* SyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method .ctor, addr 0x592274c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
