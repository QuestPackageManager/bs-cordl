...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Contexts::CrossContextChannel*);
MARK_REF_T(::System::Runtime::Remoting::Contexts::CrossContextChannel_ContextRestoreSink*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Contexts::CrossContextChannel*, "System.Runtime.Remoting.Contexts", "CrossContextChannel");
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Contexts::CrossContextChannel_ContextRestoreSink*, "System.Runtime.Remoting.Contexts", "CrossContextChannel/ContextRestoreSink");
...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5b3930c, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method SyncProcessMessage, addr 0x5b3905c, size 0x2b0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b3904c, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CrossContextChannel_ContextRestoreSink", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::System::Runtime::Remoting::Contexts::CrossContextChannel_ContextRestoreSink) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method AsyncProcessMessage, addr 0x5b38c70, size 0x3dc, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::IMessageCtrl* AsyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg,
                                                                                   ::System::Runtime::Remoting::Messaging::IMessageSink* replySink);

  static inline ::System::Runtime::Remoting::Contexts::CrossContextChannel* New_ctor();

  /// @brief Method SyncProcessMessage, addr 0x5b38890, size 0x3e0, virtual true, abstract: false, final true
  inline ::System::Runtime::Remoting::Messaging::IMessage* SyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage* msg);

  /// @brief Method .ctor, addr 0x5b39058, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CrossContextChannel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
// Non member Declarations
static_assert(sizeof(::System::Runtime::Remoting::Contexts::CrossContextChannel) == 0x10, "Size mismatch!");
