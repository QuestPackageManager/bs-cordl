...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x59fb864, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::System::Runtime::Remoting::Contexts::CrossContextDelegate* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x59fb7fc, size 0x68, virtual false, abstract: false, final false
