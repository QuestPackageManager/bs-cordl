...
public:
  ...
  /// @brief Method .ctor, addr 0x24f9d94, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke, addr 0x24fa834, size 0x14, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x24fa848, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::System::ValueTuple_2<::System::Type*, ::StringW> lhs, ::System::ValueTuple_2<::System::Type*, ::StringW> rhs);

  /// @brief Method GetHashCode, addr 0x24fa8bc, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x24fa910, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x24fa97c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <GetCustomMarshalerInstance>b__201_0, addr 0x24fa984, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AllocCoTaskMem, addr 0x24f8cd4, size 0x4, virtual false, abstract: false, final false
  static inline void* AllocCoTaskMem(int32_t cb);

  /// @brief Method AllocHGlobal, addr 0x24f8cd8, size 0x4, virtual false, abstract: false, final false
  static inline void* AllocHGlobal(void* cb);

  /// @brief Method AllocHGlobal, addr 0x24f8cdc, size 0x68, virtual false, abstract: false, final false
  static inline void* AllocHGlobal(int32_t cb);

  /// @brief Method copy_to_unmanaged_fixed, addr 0x24f8d44, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method skip_fixed, addr 0x24f8d48, size 0x34, virtual false, abstract: false, final false
  static inline bool skip_fixed(::System::Array* array, int32_t startIndex);

  /// @brief Method copy_to_unmanaged, addr 0x24f8d7c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x24f8e64, size 0xf4, virtual false, abstract: false, final false
  static inline void Copy(::ArrayW<uint8_t, ::Array<uint8_t>*> source, int32_t startIndex, void* destination, int32_t length);

  /// @brief Method copy_from_unmanaged, addr 0x24f8f58, size 0x80, virtual false, abstract: false, final false
  static inline void copy_from_unmanaged(void* source, int32_t startIndex, ::System::Array* destination, int32_t length);

  /// @brief Method copy_from_unmanaged_fixed, addr 0x24f8fd8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x24f8fdc, size 0xf4, virtual false, abstract: false, final false
  static inline void Copy(void* source, ::ArrayW<uint8_t, ::Array<uint8_t>*> destination, int32_t startIndex, int32_t length);

  /// @brief Method Copy, addr 0x24f90d0, size 0xf4, virtual false, abstract: false, final false
  static inline void Copy(void* source, ::ArrayW<char16_t, ::Array<char16_t>*> destination, int32_t startIndex, int32_t length);

  /// @brief Method Copy, addr 0x24f91c4, size 0xf4, virtual false, abstract: false, final false
  static inline void Copy(void* source, ::ArrayW<float_t, ::Array<float_t>*> destination, int32_t startIndex, int32_t length);

  /// @brief Method FreeBSTR, addr 0x24f92b8, size 0x4, virtual false, abstract: false, final false
  static inline void FreeBSTR(void* ptr);

  /// @brief Method FreeCoTaskMem, addr 0x24f92bc, size 0x4, virtual false, abstract: false, final false
  static inline void FreeCoTaskMem(void* ptr);

  /// @brief Method FreeHGlobal, addr 0x24f92c0, size 0x4, virtual false, abstract: false, final false
  static inline void FreeHGlobal(void* hglobal);

  /// @brief Method ClearBSTR, addr 0x24f92c4, size 0xac, virtual false, abstract: false, final false
  static inline void ClearBSTR(void* ptr);

  /// @brief Method ZeroFreeBSTR, addr 0x24f93e0, size 0x5c, virtual false, abstract: false, final false
  static inline void ZeroFreeBSTR(void* s);

  /// @brief Method ClearAnsi, addr 0x24f943c, size 0x9c, virtual false, abstract: false, final false
  static inline void ClearAnsi(void* ptr);

  /// @brief Method ClearUnicode, addr 0x24f94f4, size 0x90, virtual false, abstract: false, final false
  static inline void ClearUnicode(void* ptr);

  /// @brief Method ZeroFreeGlobalAllocAnsi, addr 0x24f9618, size 0x5c, virtual false, abstract: false, final false
  static inline void ZeroFreeGlobalAllocAnsi(void* s);

  /// @brief Method ZeroFreeGlobalAllocUnicode, addr 0x24f9674, size 0x5c, virtual false, abstract: false, final false
  static inline void ZeroFreeGlobalAllocUnicode(void* s);

  /// @brief Method GetHRForException, addr 0x24f96d0, size 0xc, virtual false, abstract: false, final false
  static inline int32_t GetHRForException(::System::Exception* e);

  /// @brief Method IsComObject, addr 0x24f96dc, size 0x8, virtual false, abstract: false, final false
  static inline bool IsComObject(::System::Object* o);

  /// @brief Method GetLastWin32Error, addr 0x24f96e4, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetLastWin32Error();

  /// @brief Method OffsetOf, addr 0x24f96e8, size 0x4, virtual false, abstract: false, final false
  static inline void* OffsetOf(::System::Type* t, ::StringW fieldName);

  /// @brief Method PtrToStringAnsi, addr 0x24f96ec, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW PtrToStringAnsi(void* ptr);

  /// @brief Method PtrToStringAnsi, addr 0x24f96f0, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW PtrToStringAnsi(void* ptr, int32_t len);

  /// @brief Method PtrToStringUni, addr 0x24f96f4, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW PtrToStringUni(void* ptr);

  /// @brief Method PtrToStringUni, addr 0x24f96f8, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW PtrToStringUni(void* ptr, int32_t len);

  /// @brief Method PtrToStructure, addr 0x24f96fc, size 0x4, virtual false, abstract: false, final false
  static inline void PtrToStructure(void* ptr, ::System::Object* structure);

  /// @brief Method PtrToStructure, addr 0x24f9700, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadByte, addr 0x24f94d8, size 0x1c, virtual false, abstract: false, final false
  static inline uint8_t ReadByte(void* ptr, int32_t ofs);

  /// @brief Method ReadInt16, addr 0x24f95d0, size 0x48, virtual false, abstract: false, final false
  static inline int16_t ReadInt16(void* ptr, int32_t ofs);

  /// @brief Method ReadInt32, addr 0x24f9704, size 0x40, virtual false, abstract: false, final false
  static inline int32_t ReadInt32(void* ptr);

  /// @brief Method ReadInt32, addr 0x24f9370, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t ReadInt32(void* ptr, int32_t ofs);

  /// @brief Method SizeOf, addr 0x24f9744, size 0x70, virtual false, abstract: false, final false
  static inline int32_t SizeOf(::System::Object* structure);

  /// @brief Method SizeOf, addr 0x24f97b4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToHGlobalAnsi, addr 0x24f97b8, size 0x4, virtual false, abstract: false, final false
  static inline void* StringToHGlobalAnsi(::cordl_internals::Ptr<char16_t> s, int32_t length);

  /// @brief Method StringToHGlobalAnsi, addr 0x24f97bc, size 0x70, virtual false, abstract: false, final false
  static inline void* StringToHGlobalAnsi(::StringW s);

  /// @brief Method SecureStringToBSTR, addr 0x24f9830, size 0x188, virtual false, abstract: false, final false
  static inline void* SecureStringToBSTR(::System::Security::SecureString* s);

  /// @brief Method SecureStringGlobalAllocator, addr 0x24f99bc, size 0x54, virtual false, abstract: false, final false
  static inline void* SecureStringGlobalAllocator(int32_t len);

  /// @brief Method SecureStringToUnicode, addr 0x24f9a10, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method SecureStringToGlobalAllocUnicode, addr 0x24f9ca4, size 0xf0, virtual false, abstract: false, final false
  static inline void* SecureStringToGlobalAllocUnicode(::System::Security::SecureString* s);

  /// @brief Method StructureToPtr, addr 0x24f9e58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method BufferToBSTR, addr 0x24f99b8, size 0x4, virtual false, abstract: false, final false
  static inline void* BufferToBSTR(::cordl_internals::Ptr<char16_t> ptr, int32_t slen);

  /// @brief Method UnsafeAddrOfPinnedArrayElement, addr 0x24f9e60, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteByte, addr 0x24f93bc, size 0x24, virtual false, abstract: false, final false
  static inline void WriteByte(void* ptr, int32_t ofs, uint8_t val);

  /// @brief Method WriteInt16, addr 0x24f9584, size 0x4c, virtual false, abstract: false, final false
  static inline void WriteInt16(void* ptr, int32_t ofs, int16_t val);

  /// @brief Method GetFunctionPointerForDelegateInternal, addr 0x24f9e64, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomMarshalerInstance, addr 0x24f9e68, size 0x814, virtual false, abstract: false, final false
