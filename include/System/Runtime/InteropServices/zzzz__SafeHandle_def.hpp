...
/// @brief Method Close, addr 0x59bcc3c, size 0x10, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method DangerousAddRef, addr 0x59bc5ec, size 0xbc, virtual false, abstract: false, final false
inline void DangerousAddRef(::ByRef<bool>  success) ;

/// @brief Method DangerousGetHandle, addr 0x59bcc28, size 0x8, virtual false, abstract: false, final false
inline ::System::IntPtr DangerousGetHandle() ;

/// @brief Method DangerousRelease, addr 0x59bc74c, size 0x8, virtual false, abstract: false, final false
inline void DangerousRelease() ;

/// @brief Method DangerousReleaseInternal, addr 0x59bcdac, size 0x154, virtual false, abstract: false, final false
inline void DangerousReleaseInternal(bool  dispose) ;

/// @brief Method Dispose, addr 0x59bcc4c, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x59bcc5c, size 0x1c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x59bcbd0, size 0x50, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method InternalDispose, addr 0x59bcc78, size 0xa4, virtual false, abstract: false, final false
inline void InternalDispose() ;

/// @brief Method InternalFinalize, addr 0x59bcd1c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method SetHandle, addr 0x59bcc20, size 0x8, virtual false, abstract: false, final false
inline void SetHandle(::System::IntPtr  handle) ;

/// @brief Method SetHandleAsInvalid, addr 0x59bcd30, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59bcb38, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  invalidHandleValue, bool  ownsHandle) ;

/// @brief Method get_IsClosed, addr 0x59bcc30, size 0xc, virtual false, abstract: false, final false
