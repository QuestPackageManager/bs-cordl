...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExternalException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExternalException(ExternalException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExternalException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExternalException(ExternalExceptionconst&) = delete;
