...
public:
  ...
  /// @brief Method .ctor, addr 0x5b6c5d8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FieldOffsetAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FieldOffsetAttribute(FieldOffsetAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FieldOffsetAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FieldOffsetAttribute(FieldOffsetAttributeconst&) = delete;
