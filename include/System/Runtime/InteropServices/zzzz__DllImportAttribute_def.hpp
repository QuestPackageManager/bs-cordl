...
namespace System::Runtime::InteropServices {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2547)), TypeDefinitionIndex(TypeDefinitionIndex(3301)), TypeDefinitionIndex(TypeDefinitionIndex(3331))]
...
public:
  ...
  /// @brief Method GetCustomAttribute, addr 0x24f7fa0, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::RuntimeMethodInfo* method);

  /// @brief Method IsDefined, addr 0x24f81e4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f8158, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f820c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW dllName);

  /// @brief Method get_Value, addr 0x24f8234, size 0x8, virtual false, abstract: false, final false
