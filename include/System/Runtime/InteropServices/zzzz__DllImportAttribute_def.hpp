...
public:
  ...
  /// @brief Method GetCustomAttribute, addr 0x3d14cfc, size 0x1b0, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::RuntimeMethodInfo* method);

  /// @brief Method IsDefined, addr 0x3d14f38, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d14f60, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW dllName);

  /// @brief Method .ctor, addr 0x3d14eac, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x3d14f88, size 0x8, virtual false, abstract: false, final false
