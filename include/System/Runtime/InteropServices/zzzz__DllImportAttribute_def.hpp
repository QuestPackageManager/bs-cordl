...
public:
  ...
  /// @brief Method GetCustomAttribute, addr 0x59bc4ec, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::RuntimeMethodInfo* method);

  /// @brief Method IsDefined, addr 0x59bc5e0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bc608, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW dllName);

  /// @brief Method .ctor, addr 0x59bc5b4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x59bc610, size 0x8, virtual false, abstract: false, final false
