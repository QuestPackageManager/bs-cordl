...
public:
  ...
  /// @brief Method GetCustomAttribute, addr 0x2857e74, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::RuntimeMethodInfo* method);

  /// @brief Method IsDefined, addr 0x28580b8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28580e0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW dllName);

  /// @brief Method .ctor, addr 0x285802c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x2858108, size 0x8, virtual false, abstract: false, final false
