...
public:
  ...
  /// @brief Method GetCustomAttribute, addr 0x2752a74, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::RuntimeMethodInfo* method);

  /// @brief Method IsDefined, addr 0x2752cb8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2752ce0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW dllName);

  /// @brief Method .ctor, addr 0x2752c2c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x2752d08, size 0x8, virtual false, abstract: false, final false
