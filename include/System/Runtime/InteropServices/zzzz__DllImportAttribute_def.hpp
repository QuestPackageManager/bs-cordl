...
public:
  ...
  /// @brief Method GetCustomAttribute, addr 0x5b6a1ac, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::RuntimeMethodInfo* method);

  /// @brief Method IsDefined, addr 0x5b6a2a0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b6a2c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW dllName);

  /// @brief Method .ctor, addr 0x5b6a274, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x5b6a2d0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::InteropServices::DllImportAttribute) == 0x30, "Size mismatch!");
