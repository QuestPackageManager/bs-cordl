...
// Write type traits
MARK_REF_T(::System::Runtime::InteropServices::InterfaceTypeAttribute*);
DEFINE_IL2CPP_CLASS(::System::Runtime::InteropServices::InterfaceTypeAttribute*, "System.Runtime.InteropServices", "InterfaceTypeAttribute");
// [AttributeUsage((System.AttributeTargets)1024, Inherited = false)]
// [ComVisible(true)]
...
public:
  ...
  /// @brief Method .ctor, addr 0x5b6c468, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InterfaceTypeAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InterfaceTypeAttribute(InterfaceTypeAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InterfaceTypeAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InterfaceTypeAttribute(InterfaceTypeAttributeconst&) = delete;
...
static_assert(sizeof(::System::Runtime::InteropServices::InterfaceTypeAttribute) == 0x18, "Size mismatch!");
