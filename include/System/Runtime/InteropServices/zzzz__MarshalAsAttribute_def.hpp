...
public:
  ...
  /// @brief Method Copy, addr 0x5958ce4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5958cd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::UnmanagedType unmanagedType);

  /// @brief Method get_Value, addr 0x5958cdc, size 0x8, virtual false, abstract: false, final false
