...
public:
  ...
  /// @brief Method Copy, addr 0x5b6d2f0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b6d2e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::UnmanagedType unmanagedType);

  /// @brief Method get_Value, addr 0x5b6d2e8, size 0x8, virtual false, abstract: false, final false
