...
namespace System::Runtime::InteropServices {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2547)), TypeDefinitionIndex(TypeDefinitionIndex(3318)), TypeDefinitionIndex(TypeDefinitionIndex(3319))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x24faa24, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::UnmanagedType unmanagedType);

  /// @brief Method get_Value, addr 0x24faa4c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::InteropServices::UnmanagedType get_Value();

  /// @brief Method Copy, addr 0x24faa54, size 0x64, virtual false, abstract: false, final false
