...
public:
  ...
  /// @brief Method Copy, addr 0x5a31aa8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a31a98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::UnmanagedType unmanagedType);

  /// @brief Method get_Value, addr 0x5a31aa0, size 0x8, virtual false, abstract: false, final false
