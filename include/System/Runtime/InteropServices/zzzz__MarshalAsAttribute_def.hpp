...
public:
  ...
  /// @brief Method Copy, addr 0x3d1c548, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d1c518, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::UnmanagedType unmanagedType);

  /// @brief Method get_Value, addr 0x3d1c540, size 0x8, virtual false, abstract: false, final false
