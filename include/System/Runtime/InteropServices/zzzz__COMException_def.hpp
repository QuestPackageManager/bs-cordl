...
public:
  ...
  /// @brief Method ToString, addr 0x25c7d58, size 0x1e4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x25c7d4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25c7d50, size 0x8, virtual false, abstract: false, final false
