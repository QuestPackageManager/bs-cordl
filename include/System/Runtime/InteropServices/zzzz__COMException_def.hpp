...
public:
  // Ctor Parameters [CppParam { name: "", ty: "COMException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  COMException(COMException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "COMException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  COMException(COMExceptionconst&) = delete;
