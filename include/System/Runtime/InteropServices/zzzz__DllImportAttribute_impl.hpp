...
inline ::System::Runtime::InteropServices::DllImportAttribute* System::Runtime::InteropServices::DllImportAttribute::New_ctor(::StringW dllName, ::StringW entryPoint,
  ...
  return THROW_UNLESS(::il2cpp_utils::New<::System::Runtime::InteropServices::DllImportAttribute*>(dllName, entryPoint, charSet, exactSpelling, setLastError, preserveSig, callingConvention,
