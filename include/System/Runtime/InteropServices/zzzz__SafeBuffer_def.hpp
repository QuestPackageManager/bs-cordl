...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SafeBuffer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SafeBuffer(SafeBuffer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SafeBuffer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SafeBuffer(SafeBufferconst&) = delete;
