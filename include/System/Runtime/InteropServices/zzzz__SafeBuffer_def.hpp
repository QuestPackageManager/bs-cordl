...
public:
  ...
  /// @brief Method AcquirePointer, addr 0x5a2e418, size 0xc0, virtual false, abstract: false, final false
  inline void AcquirePointer(::ByRef<uint8_t*> pointer);

  /// @brief Method NotInitialized, addr 0x5a2e4d8, size 0x80, virtual false, abstract: false, final false
  static inline ::System::InvalidOperationException* NotInitialized();

  /// @brief Method ReleasePointer, addr 0x5a2e614, size 0xa4, virtual false, abstract: false, final false
