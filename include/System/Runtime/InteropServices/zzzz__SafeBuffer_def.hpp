...
public:
  ...
  /// @brief Method AcquirePointer, addr 0x3d146ac, size 0xd0, virtual false, abstract: false, final false
  inline void AcquirePointer(::ByRef<::cordl_internals::Ptr<uint8_t>> pointer);

  /// @brief Method NotInitialized, addr 0x3d1477c, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::InvalidOperationException* NotInitialized();

  /// @brief Method ReleasePointer, addr 0x3d148ac, size 0xa8, virtual false, abstract: false, final false
