...
/// @brief Method AcquirePointer, addr 0x59bc4ac, size 0xc0, virtual false, abstract: false, final false
inline void AcquirePointer(::ByRef<uint8_t*>  pointer) ;

/// @brief Method NotInitialized, addr 0x59bc56c, size 0x80, virtual false, abstract: false, final false
static inline ::System::InvalidOperationException* NotInitialized() ;

/// @brief Method ReleasePointer, addr 0x59bc6a8, size 0xa4, virtual false, abstract: false, final false
