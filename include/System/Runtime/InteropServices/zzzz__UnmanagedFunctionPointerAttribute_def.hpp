...
public:
  ...
  /// @brief Method .ctor, addr 0x3d14c2c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::CallingConvention callingConvention);

  /// @brief Method get_CallingConvention, addr 0x3d14c54, size 0x8, virtual false, abstract: false, final false
