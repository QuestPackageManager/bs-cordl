...
public:
  ...
  /// @brief Method .ctor, addr 0x59bc498, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::InteropServices::CallingConvention callingConvention);

  /// @brief Method get_CallingConvention, addr 0x59bc4a0, size 0x8, virtual false, abstract: false, final false
