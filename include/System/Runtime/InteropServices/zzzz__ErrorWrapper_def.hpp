...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ErrorWrapper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ErrorWrapper(ErrorWrapper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ErrorWrapper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ErrorWrapper(ErrorWrapperconst&) = delete;
