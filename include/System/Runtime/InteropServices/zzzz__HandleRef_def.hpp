...
public:
  ...
  /// @brief Method .ctor, addr 0x59bba54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* wrapper, ::System::IntPtr handle);

  /// @brief Method get_Handle, addr 0x59bba5c, size 0x8, virtual false, abstract: false, final false
