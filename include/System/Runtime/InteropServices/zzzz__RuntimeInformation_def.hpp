...
/// @brief Method GetOSName, addr 0x59bd670, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetOSName() ;

/// @brief Method GetRuntimeArchitecture, addr 0x59bd660, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetRuntimeArchitecture() ;

/// @brief Method IsOSPlatform, addr 0x59bd680, size 0x94, virtual false, abstract: false, final false
