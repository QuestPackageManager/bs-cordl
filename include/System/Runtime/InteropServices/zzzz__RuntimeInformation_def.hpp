...
public:
  ...
  /// @brief Method GetOSName, addr 0x3d10c18, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetOSName();

  /// @brief Method GetRuntimeArchitecture, addr 0x3d10c14, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetRuntimeArchitecture();

  /// @brief Method IsOSPlatform, addr 0x3d10c1c, size 0x8c, virtual false, abstract: false, final false
