...
public:
  ...
  /// @brief Method GetOSName, addr 0x5a2f5dc, size 0x10, virtual false, abstract: false, final false
  static inline ::StringW GetOSName();

  /// @brief Method GetRuntimeArchitecture, addr 0x5a2f5cc, size 0x10, virtual false, abstract: false, final false
  static inline ::StringW GetRuntimeArchitecture();

  /// @brief Method IsOSPlatform, addr 0x5a2f5ec, size 0x94, virtual false, abstract: false, final false
