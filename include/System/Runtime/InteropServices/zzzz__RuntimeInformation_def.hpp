...
public:
  ...
  /// @brief Method GetOSName, addr 0x3d2311c, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetOSName();

  /// @brief Method GetRuntimeArchitecture, addr 0x3d23118, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetRuntimeArchitecture();

  /// @brief Method IsOSPlatform, addr 0x3d23120, size 0x8c, virtual false, abstract: false, final false
