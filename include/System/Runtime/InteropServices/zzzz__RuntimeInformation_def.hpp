...
public:
  ...
  /// @brief Method GetOSName, addr 0x5b6ae24, size 0x10, virtual false, abstract: false, final false
  static inline ::StringW GetOSName();

  /// @brief Method GetRuntimeArchitecture, addr 0x5b6ae14, size 0x10, virtual false, abstract: false, final false
  static inline ::StringW GetRuntimeArchitecture();

  /// @brief Method IsOSPlatform, addr 0x5b6ae34, size 0x94, virtual false, abstract: false, final false
