...
// [AttributeUsage((System.AttributeTargets)5, Inherited = false)]
// [ComVisible(true)]
...
public:
  ...
  /// @brief Method .ctor, addr 0x5b6c478, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClassInterfaceAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClassInterfaceAttribute(ClassInterfaceAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClassInterfaceAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClassInterfaceAttribute(ClassInterfaceAttributeconst&) = delete;
