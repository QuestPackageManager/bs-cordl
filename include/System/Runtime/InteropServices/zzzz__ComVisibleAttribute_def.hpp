...
public:
  ...
  /// @brief Method .ctor, addr 0x5b6a180, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::InteropServices::ComVisibleAttribute) == 0x18, "Size mismatch!");
