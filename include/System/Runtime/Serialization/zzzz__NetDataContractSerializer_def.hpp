...
public:
  ...
  /// @brief Method GetDataContractFromSurrogateSelector, addr 0x6017040, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSurrogate, addr 0x6016f6c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeInformation, addr 0x6016678, size 0x204, virtual false, abstract: false, final false
  static inline ::System::Runtime::Serialization::TypeInformation* GetTypeInformation(::System::Type* type);

  /// @brief Method IsAssemblyNameForwardingSafe, addr 0x601687c, size 0x16c, virtual false, abstract: false, final false
  static inline bool IsAssemblyNameForwardingSafe(::StringW originalAssemblyName, ::StringW newAssemblyName);

  /// @brief Method IsPublicKeyTokenForwardingSafe, addr 0x60173f4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadObject, addr 0x6016ee8, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Object* ReadObject(::System::Xml::XmlDictionaryReader* reader, bool verifyObjectName);

  /// @brief Method WriteClrTypeInfo, addr 0x60169e8, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteClrTypeInfo, addr 0x60164e4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteClrTypeInfo, addr 0x6016b10, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteClrTypeInfo, addr 0x6016be0, size 0x150, virtual false, abstract: false, final false
  static inline void WriteClrTypeInfo(::System::Runtime::Serialization::XmlWriterDelegator* writer, ::System::Type* dataContractType, ::System::Runtime::Serialization::SerializationBinder* binder,
                                      ::System::Runtime::Serialization::SerializationInfo* serInfo);

  /// @brief Method WriteEndObject, addr 0x6016d30, size 0x70, virtual true, abstract: false, final false
  inline void WriteEndObject(::System::Xml::XmlDictionaryWriter* writer);

  /// @brief Method WriteObjectContent, addr 0x6015f20, size 0x78, virtual true, abstract: false, final false
  inline void WriteObjectContent(::System::Xml::XmlDictionaryWriter* writer, ::System::Object* graph);

  /// @brief Method WriteStartObject, addr 0x6015d3c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Binder, addr 0x6015d1c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Serialization::SerializationBinder* get_Binder();

  /// @brief Method get_Context, addr 0x6015d10, size 0xc, virtual true, abstract: false, final true
  inline ::System::Runtime::Serialization::StreamingContext get_Context();

  /// @brief Method get_IgnoreExtensionDataObject, addr 0x6015d34, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreExtensionDataObject();

  /// @brief Method get_MaxItemsInObjectGraph, addr 0x6015d2c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxItemsInObjectGraph();

  /// @brief Method get_SurrogateSelector, addr 0x6015d24, size 0x8, virtual true, abstract: false, final true
  inline ::System::Runtime::Serialization::ISurrogateSelector* get_SurrogateSelector();

  /// @brief Method get_UnsafeTypeForwardingEnabled, addr 0x6015c30, size 0xe0, virtual false, abstract: false, final false
