...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Globals", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Globals(Globals&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Globals", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Globals(Globalsconst&) = delete;
