...
// Write type traits
MARK_REF_PTR_T(::System::Runtime::Serialization::DecimalDataContract);
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x5f40c18, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x5f40b8c, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f40a54, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x5f40b48, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x5f40b04, size 0x44, virtual true, abstract: false, final false
