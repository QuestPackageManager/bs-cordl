...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::UnsignedLongDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::UnsignedLongDataContract*, "System.Runtime.Serialization", "UnsignedLongDataContract");
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x615cca4, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615cc4c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615cb28, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x615cc08, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x615cbc4, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnsignedLongDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnsignedLongDataContract(UnsignedLongDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnsignedLongDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnsignedLongDataContract(UnsignedLongDataContractconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::UnsignedLongDataContract) == 0x30, "Size mismatch!");
