...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataContractSurrogateCaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataContractSurrogateCaller(DataContractSurrogateCaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataContractSurrogateCaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataContractSurrogateCaller(DataContractSurrogateCallerconst&) = delete;
