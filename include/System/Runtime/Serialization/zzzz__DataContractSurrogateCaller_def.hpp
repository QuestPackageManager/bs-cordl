...
public:
  // Declarations
  /// @brief Method GetDataContractType, addr 0x6152230, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeserializedObject, addr 0x6152410, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObjectToSerialize, addr 0x615231c, size 0xf4, virtual false, abstract: false, final false
