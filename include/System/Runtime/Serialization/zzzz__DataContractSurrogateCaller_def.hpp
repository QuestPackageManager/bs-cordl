...
public:
  // Declarations
  /// @brief Method GetDataContractType, addr 0x60155bc, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeserializedObject, addr 0x601579c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObjectToSerialize, addr 0x60156a8, size 0xf4, virtual false, abstract: false, final false
