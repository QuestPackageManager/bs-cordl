...
public:
  ...
  /// @brief Method CreateObject, addr 0x603b17c, size 0x24c, virtual false, abstract: false, final false
  inline void CreateObject(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method GetRequiredMembers, addr 0x603c6c0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRequiredMembers, addr 0x603cf94, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleUnexpectedItemInCollection, addr 0x603db68, size 0x7c, virtual false, abstract: false, final false
  inline void HandleUnexpectedItemInCollection(::ByRef<int32_t> iterator);

  /// @brief Method HasFactoryMethod, addr 0x603b514, size 0x80, virtual false, abstract: false, final false
  inline bool HasFactoryMethod(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method InternalDeserialize, addr 0x603d0a4, size 0x1fc, virtual false, abstract: false, final false
  inline ::System::Object* InternalDeserialize(::System::Type* type, ::StringW name, ::StringW ns);

  /// @brief Method InvokeFactoryMethod, addr 0x603b85c, size 0x118, virtual false, abstract: false, final false
  inline bool InvokeFactoryMethod(::System::Runtime::Serialization::ClassDataContract* classContract, ::StringW objectId);

  /// @brief Method InvokeOnDeserialized, addr 0x603b974, size 0x14c, virtual false, abstract: false, final false
  inline void InvokeOnDeserialized(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method InvokeOnDeserializing, addr 0x603b3c8, size 0x14c, virtual false, abstract: false, final false
  inline void InvokeOnDeserializing(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method IsEndElement, addr 0x603db44, size 0x24, virtual false, abstract: false, final false
  inline bool IsEndElement();

  /// @brief Method IsStartElement, addr 0x603dbe4, size 0x14, virtual false, abstract: false, final false
  inline bool IsStartElement();

  /// @brief Method IsStartElement, addr 0x603d7e0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadClass, addr 0x603b700, size 0x15c, virtual false, abstract: false, final false
  inline void ReadClass(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method ReadCollection, addr 0x603bae8, size 0x844, virtual false, abstract: false, final false
  inline void ReadCollection(::System::Runtime::Serialization::CollectionDataContract* collectionContract);

  /// @brief Method ReadCollectionFromXml, addr 0x603bac0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCollectionItem, addr 0x603d7f4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFromXml, addr 0x603ae80, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadGetOnlyCollection, addr 0x603c340, size 0x23c, virtual false, abstract: false, final false
  inline void ReadGetOnlyCollection(::System::Runtime::Serialization::CollectionDataContract* collectionContract);

  /// @brief Method ReadGetOnlyCollectionFromXml, addr 0x603c32c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadISerializable, addr 0x603b594, size 0x16c, virtual false, abstract: false, final false
  inline void ReadISerializable(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method ReadMembers, addr 0x603c7b0, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadMembers, addr 0x603c57c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValue, addr 0x603c9d4, size 0x5c0, virtual false, abstract: false, final false
  inline ::System::Object* ReadValue(::System::Type* type, ::StringW name, ::StringW ns);

  /// @brief Method StoreCollectionValue, addr 0x603d904, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method TryReadPrimitiveArray, addr 0x603d484, size 0x35c, virtual false, abstract: false, final false
  inline bool TryReadPrimitiveArray(::System::Type* type, ::System::Type* itemType, int32_t size, ::ByRef<bool> readResult);

  /// @brief Method WrapNullableObject, addr 0x603d2a0, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x603ae6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method .ctor, addr 0x603ae74, size 0xc, virtual false, abstract: false, final false
