...
/// @brief Field memberNames, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_memberNames, put=__cordl_internal_set_memberNames)) ::ArrayW<::System::Xml::XmlDictionaryString*,::Array<::System::Xml::XmlDictionaryString*>*>  memberNames;

/// @brief Field memberNamespaces, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_memberNamespaces, put=__cordl_internal_set_memberNamespaces)) ::ArrayW<::System::Xml::XmlDictionaryString*,::Array<::System::Xml::XmlDictionaryString*>*>  memberNamespaces;
...
/// @brief Method CreateObject, addr 0x603ccf4, size 0x24c, virtual false, abstract: false, final false
inline void CreateObject(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method GetRequiredMembers, addr 0x603e238, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetRequiredMembers, addr 0x603eb0c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method HandleUnexpectedItemInCollection, addr 0x603f6e0, size 0x7c, virtual false, abstract: false, final false
inline void HandleUnexpectedItemInCollection(::ByRef<int32_t>  iterator) ;

/// @brief Method HasFactoryMethod, addr 0x603d08c, size 0x80, virtual false, abstract: false, final false
inline bool HasFactoryMethod(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method InternalDeserialize, addr 0x603ec1c, size 0x1fc, virtual false, abstract: false, final false
inline ::System::Object* InternalDeserialize(::System::Type*  type, ::StringW  name, ::StringW  ns) ;

/// @brief Method InvokeFactoryMethod, addr 0x603d3d4, size 0x118, virtual false, abstract: false, final false
inline bool InvokeFactoryMethod(::System::Runtime::Serialization::ClassDataContract*  classContract, ::StringW  objectId) ;

/// @brief Method InvokeOnDeserialized, addr 0x603d4ec, size 0x14c, virtual false, abstract: false, final false
inline void InvokeOnDeserialized(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method InvokeOnDeserializing, addr 0x603cf40, size 0x14c, virtual false, abstract: false, final false
inline void InvokeOnDeserializing(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method IsEndElement, addr 0x603f6bc, size 0x24, virtual false, abstract: false, final false
inline bool IsEndElement() ;

/// @brief Method IsStartElement, addr 0x603f75c, size 0x14, virtual false, abstract: false, final false
inline bool IsStartElement() ;

/// @brief Method IsStartElement, addr 0x603f358, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ReadClass, addr 0x603d278, size 0x15c, virtual false, abstract: false, final false
inline void ReadClass(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method ReadCollection, addr 0x603d660, size 0x844, virtual false, abstract: false, final false
inline void ReadCollection(::System::Runtime::Serialization::CollectionDataContract*  collectionContract) ;

/// @brief Method ReadCollectionFromXml, addr 0x603d638, size 0x28, virtual false, abstract: false, final false
inline ::System::Object* ReadCollectionFromXml(::System::Runtime::Serialization::XmlReaderDelegator*  xmlReader, ::System::Runtime::Serialization::XmlObjectSerializerReadContext*  context, ::System::Xml::XmlDictionaryString*  itemName, ::System::Xml::XmlDictionaryString*  itemNamespace, ::System::Runtime::Serialization::CollectionDataContract*  collectionContract) ;

/// @brief Method ReadCollectionItem, addr 0x603f36c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method ReadFromXml, addr 0x603c9f8, size 0x2fc, virtual false, abstract: false, final false
inline ::System::Object* ReadFromXml(::System::Runtime::Serialization::XmlReaderDelegator*  xmlReader, ::System::Runtime::Serialization::XmlObjectSerializerReadContext*  context, ::ArrayW<::System::Xml::XmlDictionaryString*,::Array<::System::Xml::XmlDictionaryString*>*>  memberNames, ::ArrayW<::System::Xml::XmlDictionaryString*,::Array<::System::Xml::XmlDictionaryString*>*>  memberNamespaces) ;

/// @brief Method ReadGetOnlyCollection, addr 0x603deb8, size 0x23c, virtual false, abstract: false, final false
inline void ReadGetOnlyCollection(::System::Runtime::Serialization::CollectionDataContract*  collectionContract) ;

/// @brief Method ReadGetOnlyCollectionFromXml, addr 0x603dea4, size 0x14, virtual false, abstract: false, final false
inline void ReadGetOnlyCollectionFromXml(::System::Runtime::Serialization::XmlReaderDelegator*  xmlReader, ::System::Runtime::Serialization::XmlObjectSerializerReadContext*  context, ::System::Xml::XmlDictionaryString*  itemName, ::System::Xml::XmlDictionaryString*  itemNamespace, ::System::Runtime::Serialization::CollectionDataContract*  collectionContract) ;

/// @brief Method ReadISerializable, addr 0x603d10c, size 0x16c, virtual false, abstract: false, final false
inline void ReadISerializable(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method ReadMembers, addr 0x603e328, size 0x224, virtual false, abstract: false, final false
inline int32_t ReadMembers(int32_t  index, ::System::Runtime::Serialization::ClassDataContract*  classContract, ::ArrayW<bool,::Array<bool>*>  requiredMembers, ::ByRef<int32_t>  memberIndex, ::ByRef<int32_t>  requiredIndex) ;

/// @brief Method ReadMembers, addr 0x603e0f4, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method ReadValue, addr 0x603e54c, size 0x5c0, virtual false, abstract: false, final false
inline ::System::Object* ReadValue(::System::Type*  type, ::StringW  name, ::StringW  ns) ;

/// @brief Method StoreCollectionValue, addr 0x603f47c, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method TryReadPrimitiveArray, addr 0x603effc, size 0x35c, virtual false, abstract: false, final false
inline bool TryReadPrimitiveArray(::System::Type*  type, ::System::Type*  itemType, int32_t  size, ::ByRef<bool>  readResult) ;

/// @brief Method WrapNullableObject, addr 0x603ee18, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x603c9e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method .ctor, addr 0x603c9ec, size 0xc, virtual false, abstract: false, final false
