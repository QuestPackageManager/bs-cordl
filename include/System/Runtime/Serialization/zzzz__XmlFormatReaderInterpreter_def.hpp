...
public:
  ...
  /// @brief Method CreateObject, addr 0x6177df0, size 0x24c, virtual false, abstract: false, final false
  inline void CreateObject(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method GetRequiredMembers, addr 0x6179334, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRequiredMembers, addr 0x6179c08, size 0x110, virtual false, abstract: false, final false
  inline int32_t GetRequiredMembers(::System::Runtime::Serialization::ClassDataContract* contract, ::ArrayW<bool> requiredMembers);

  /// @brief Method HandleUnexpectedItemInCollection, addr 0x617a7dc, size 0x7c, virtual false, abstract: false, final false
  inline void HandleUnexpectedItemInCollection(::by_ref<int32_t> iterator);

  /// @brief Method HasFactoryMethod, addr 0x6178188, size 0x80, virtual false, abstract: false, final false
  inline bool HasFactoryMethod(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method InternalDeserialize, addr 0x6179d18, size 0x1fc, virtual false, abstract: false, final false
  inline ::System::Object* InternalDeserialize(::System::Type* type, ::StringW name, ::StringW ns);

  /// @brief Method InvokeFactoryMethod, addr 0x61784d0, size 0x118, virtual false, abstract: false, final false
  inline bool InvokeFactoryMethod(::System::Runtime::Serialization::ClassDataContract* classContract, ::StringW objectId);

  /// @brief Method InvokeOnDeserialized, addr 0x61785e8, size 0x14c, virtual false, abstract: false, final false
  inline void InvokeOnDeserialized(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method InvokeOnDeserializing, addr 0x617803c, size 0x14c, virtual false, abstract: false, final false
  inline void InvokeOnDeserializing(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method IsEndElement, addr 0x617a7b8, size 0x24, virtual false, abstract: false, final false
  inline bool IsEndElement();

  /// @brief Method IsStartElement, addr 0x617a858, size 0x14, virtual false, abstract: false, final false
  inline bool IsStartElement();

  /// @brief Method IsStartElement, addr 0x617a454, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadClass, addr 0x6178374, size 0x15c, virtual false, abstract: false, final false
  inline void ReadClass(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method ReadCollection, addr 0x617875c, size 0x844, virtual false, abstract: false, final false
  inline void ReadCollection(::System::Runtime::Serialization::CollectionDataContract* collectionContract);

  /// @brief Method ReadCollectionFromXml, addr 0x6178734, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCollectionItem, addr 0x617a468, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFromXml, addr 0x6177af4, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadGetOnlyCollection, addr 0x6178fb4, size 0x23c, virtual false, abstract: false, final false
  inline void ReadGetOnlyCollection(::System::Runtime::Serialization::CollectionDataContract* collectionContract);

  /// @brief Method ReadGetOnlyCollectionFromXml, addr 0x6178fa0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadISerializable, addr 0x6178208, size 0x16c, virtual false, abstract: false, final false
  inline void ReadISerializable(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method ReadMembers, addr 0x6179424, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadMembers, addr 0x61791f0, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValue, addr 0x6179648, size 0x5c0, virtual false, abstract: false, final false
  inline ::System::Object* ReadValue(::System::Type* type, ::StringW name, ::StringW ns);

  /// @brief Method StoreCollectionValue, addr 0x617a578, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method TryReadPrimitiveArray, addr 0x617a0f8, size 0x35c, virtual false, abstract: false, final false
  inline bool TryReadPrimitiveArray(::System::Type* type, ::System::Type* itemType, int32_t size, ::by_ref<bool> readResult);

  /// @brief Method WrapNullableObject, addr 0x6179f14, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6177ae0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::ClassDataContract* classContract);

  /// @brief Method .ctor, addr 0x6177ae8, size 0xc, virtual false, abstract: false, final false
