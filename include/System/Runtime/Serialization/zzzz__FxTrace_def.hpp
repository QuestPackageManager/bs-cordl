...
/// @brief Method IsEventEnabled, addr 0x5fc7efc, size 0x8, virtual false, abstract: false, final false
static inline bool IsEventEnabled(int32_t  index) ;

/// @brief Method UpdateEventDefinitions, addr 0x5fc7f04, size 0x4, virtual false, abstract: false, final false
static inline void UpdateEventDefinitions(::ArrayW<::System::Runtime::Diagnostics::EventDescriptor,::Array<::System::Runtime::Diagnostics::EventDescriptor>*>  ed, ::ArrayW<uint16_t,::Array<uint16_t>*>  events) ;

static inline bool getStaticF_ShouldTraceError() ;

static inline bool getStaticF_ShouldTraceVerbose() ;

/// @brief Method get_Trace, addr 0x5fc7ef4, size 0x8, virtual false, abstract: false, final false
