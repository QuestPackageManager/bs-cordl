...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x601cc10, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteRootElement, addr 0x601ccb0, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x601cb6c, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x601ca2c, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsPrimitive, addr 0x601cb64, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPrimitive();

  /// @brief Method get_ReadMethodName, addr 0x601cb20, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x601cadc, size 0x44, virtual true, abstract: false, final false
