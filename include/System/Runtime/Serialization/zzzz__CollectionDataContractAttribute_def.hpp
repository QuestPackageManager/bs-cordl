...
public:
  ...
  /// @brief Method get_IsItemNameSetExplicitly, addr 0x5ffcd60, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsItemNameSetExplicitly();

  /// @brief Method get_IsKeyNameSetExplicitly, addr 0x5ffcd78, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsKeyNameSetExplicitly();

  /// @brief Method get_IsNameSetExplicitly, addr 0x5ffcd50, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNameSetExplicitly();

  /// @brief Method get_IsNamespaceSetExplicitly, addr 0x5ffcd40, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNamespaceSetExplicitly();

  /// @brief Method get_IsReference, addr 0x5ffcd70, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsReference();

  /// @brief Method get_IsValueNameSetExplicitly, addr 0x5ffcd88, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsValueNameSetExplicitly();

  /// @brief Method get_ItemName, addr 0x5ffcd58, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ItemName();

  /// @brief Method get_KeyName, addr 0x5ffcd68, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_KeyName();

  /// @brief Method get_Name, addr 0x5ffcd48, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Namespace, addr 0x5ffcd38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_ValueName, addr 0x5ffcd80, size 0x8, virtual false, abstract: false, final false
