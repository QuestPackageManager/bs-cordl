...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataNode_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataNode_1(DataNode_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataNode_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataNode_1(DataNode_1const&) = delete;
