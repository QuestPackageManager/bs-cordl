...
// Declarations
 ...
 __declspec(property(get=System_Runtime_Serialization_IDataNode_get_IsFinalValue, put=System_Runtime_Serialization_IDataNode_set_IsFinalValue)) bool  System_Runtime_Serialization_IDataNode_IsFinalValue;
...
inline void AddQualifiedNameAttribute(::System::Runtime::Serialization::ElementData*  element, ::StringW  elementPrefix, ::StringW  elementName, ::StringW  elementNs, ::StringW  valueName, ::StringW  valueNs) ;
