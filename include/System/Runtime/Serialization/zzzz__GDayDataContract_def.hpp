...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::GDayDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::GDayDataContract*, "System.Runtime.Serialization", "GDayDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x615db0c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GDayDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GDayDataContract(GDayDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GDayDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GDayDataContract(GDayDataContractconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::GDayDataContract) == 0x30, "Size mismatch!");
