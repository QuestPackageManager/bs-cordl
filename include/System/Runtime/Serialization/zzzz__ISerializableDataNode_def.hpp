...
public:
  ...
  /// @brief Method Clear, addr 0x6150f7c, size 0x4c, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method GetData, addr 0x6150e88, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6150cdc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_FactoryTypeName, addr 0x6150e58, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FactoryTypeName();

  /// @brief Method get_FactoryTypeNamespace, addr 0x6150e68, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FactoryTypeNamespace();

  /// @brief Method get_Members, addr 0x6150e78, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::System::Runtime::Serialization::ISerializableDataMember*>* get_Members();

  /// @brief Method set_FactoryTypeName, addr 0x6150e60, size 0x8, virtual false, abstract: false, final false
  inline void set_FactoryTypeName(::StringW value);

  /// @brief Method set_FactoryTypeNamespace, addr 0x6150e70, size 0x8, virtual false, abstract: false, final false
  inline void set_FactoryTypeNamespace(::StringW value);

  /// @brief Method set_Members, addr 0x6150e80, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ISerializableDataNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ISerializableDataNode(ISerializableDataNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ISerializableDataNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISerializableDataNode(ISerializableDataNodeconst&) = delete;
