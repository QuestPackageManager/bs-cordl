...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x615b9c0, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615b96c, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615b848, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x615b928, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x615b8e4, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BooleanDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BooleanDataContract(BooleanDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BooleanDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BooleanDataContract(BooleanDataContractconst&) = delete;
