...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GYearMonthDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GYearMonthDataContract(GYearMonthDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GYearMonthDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GYearMonthDataContract(GYearMonthDataContractconst&) = delete;
