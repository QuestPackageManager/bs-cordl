...
public:
// Declarations
/// @brief Method Invoke, addr 0x5faf6e4, size 0x14, virtual true, abstract: false, final false
inline void Invoke(::System::Runtime::Serialization::XmlReaderDelegator*  xmlReader, ::System::Runtime::Serialization::XmlObjectSerializerReadContext*  context, ::System::Xml::XmlDictionaryString*  itemName, ::System::Xml::XmlDictionaryString*  itemNamespace, ::System::Runtime::Serialization::CollectionDataContract*  collectionContract) ;
...
/// @brief Method .ctor, addr 0x5faf59c, size 0x148, virtual false, abstract: false, final false
