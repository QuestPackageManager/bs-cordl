...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6163b7c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6163a34, size 0x148, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlFormatGetOnlyCollectionReaderDelegate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlFormatGetOnlyCollectionReaderDelegate(XmlFormatGetOnlyCollectionReaderDelegate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlFormatGetOnlyCollectionReaderDelegate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlFormatGetOnlyCollectionReaderDelegate(XmlFormatGetOnlyCollectionReaderDelegateconst&) = delete;
