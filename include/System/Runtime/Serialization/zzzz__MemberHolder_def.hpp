...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemberHolder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemberHolder(MemberHolder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemberHolder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemberHolder(MemberHolderconst&) = delete;
