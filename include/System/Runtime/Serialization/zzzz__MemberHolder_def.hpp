...
public:
  ...
  /// @brief Method .ctor addr 0x24b4e80 size 0x3c virtual false final false
  inline void _ctor(::System::Type* type, ::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method GetHashCode addr 0x24b4ebc size 0x20 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x24b4edc size 0x8c virtual true final false
