...
public:
  ...
  /// @brief Method .ctor, addr 0x61558dc, size 0xa4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6148a48, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_IsBuiltInDataContract, addr 0x6155980, size 0x8, virtual true, abstract: false, final false
