...
public:
  ...
  /// @brief Method .ctor, addr 0x6013450, size 0xa4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x60065bc, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_IsBuiltInDataContract, addr 0x60134f4, size 0x8, virtual true, abstract: false, final false
