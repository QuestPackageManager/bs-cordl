...
/// @brief Method .ctor, addr 0x5fa1444, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Field helper, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_helper, put=__cordl_internal_set_helper)) ::System::Runtime::Serialization::GenericParameterDataContract_GenericParameterDataContractCriticalHelper*  helper;
...
/// @brief Method .ctor, addr 0x5f945b0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  type) ;

/// @brief Method get_IsBuiltInDataContract, addr 0x5fa14e8, size 0x8, virtual true, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Serialization::GenericParameterDataContract_GenericParameterDataContractCriticalHelper*, "System.Runtime.Serialization", "GenericParameterDataContract/GenericParameterDataContractCriticalHelper");
