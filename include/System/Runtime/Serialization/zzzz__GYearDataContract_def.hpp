...
public:
  ...
  /// @brief Method .ctor, addr 0x615da3c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GYearDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GYearDataContract(GYearDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GYearDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GYearDataContract(GYearDataContractconst&) = delete;
