...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TypeHandleRef", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TypeHandleRef(TypeHandleRef&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TypeHandleRef", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TypeHandleRef(TypeHandleRefconst&) = delete;
