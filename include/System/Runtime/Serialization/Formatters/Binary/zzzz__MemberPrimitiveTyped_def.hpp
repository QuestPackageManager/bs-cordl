...
/// @brief Field primitiveTypeEnum, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get_primitiveTypeEnum, put=__cordl_internal_set_primitiveTypeEnum)) ::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  primitiveTypeEnum;

/// @brief Field value, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_value, put=__cordl_internal_set_value)) ::System::Object*  value;

/// @brief Method Dump, addr 0x59a9124, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped* New_ctor() ;

/// @brief Method Read, addr 0x59a90d4, size 0x50, virtual true, abstract: false, final true
inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser*  input) ;

/// @brief Method Set, addr 0x59a9068, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x59a9074, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x59a9064, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
