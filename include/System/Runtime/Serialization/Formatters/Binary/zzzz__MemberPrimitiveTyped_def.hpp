...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped*, "System.Runtime.Serialization.Formatters.Binary", "MemberPrimitiveTyped");
...
public:
  ...
  /// @brief Method Dump, addr 0x5b58bd8, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped* New_ctor();

  /// @brief Method Read, addr 0x5b58b88, size 0x50, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x5b58b1c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5b58b28, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b58b18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemberPrimitiveTyped", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemberPrimitiveTyped(MemberPrimitiveTyped&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemberPrimitiveTyped", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemberPrimitiveTyped(MemberPrimitiveTypedconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped) == 0x20, "Size mismatch!");
