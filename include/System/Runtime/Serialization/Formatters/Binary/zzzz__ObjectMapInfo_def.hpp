...
public:
  ...
  /// @brief Method .ctor, addr 0x261c744, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method isCompatible, addr 0x261c608, size 0x13c, virtual false, abstract: false, final false
