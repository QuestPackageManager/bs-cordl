...
public:
  ...
  /// @brief Method .ctor, addr 0x59addd0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method isCompatible, addr 0x59adddc, size 0x110, virtual false, abstract: false, final false
