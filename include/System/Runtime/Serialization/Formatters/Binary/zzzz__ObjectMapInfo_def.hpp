...
public:
  ...
  /// @brief Method .ctor, addr 0x3d0ac68, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method isCompatible, addr 0x3d0aca8, size 0x13c, virtual false, abstract: false, final false
