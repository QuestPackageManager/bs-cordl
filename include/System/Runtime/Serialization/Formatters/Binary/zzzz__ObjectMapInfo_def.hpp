...
public:
  ...
  /// @brief Method .ctor, addr 0x3d13b6c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method isCompatible, addr 0x3d13bac, size 0x13c, virtual false, abstract: false, final false
