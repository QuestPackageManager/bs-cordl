...
public:
  ...
  /// @brief Method .ctor addr 0x24c21b0 size 0x10 virtual false final false
  inline void _ctor();

  /// @brief Method Write addr 0x24c21c0 size 0x148 virtual true final true
  inline void Write(::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);

  /// @brief Method Dump addr 0x24c2308 size 0x4 virtual false final false
  inline void Dump();
