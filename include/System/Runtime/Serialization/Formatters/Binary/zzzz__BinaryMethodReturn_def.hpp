...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn*, "System.Runtime.Serialization.Formatters.Binary", "BinaryMethodReturn");
// Dependencies System.Object, System.Runtime.Serialization.Formatters.Binary.MessageEnum, System.Type
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_argTypes, put = __cordl_internal_set_argTypes)) ::ArrayW<::System::Type*> argTypes;
  ...
  constexpr ::ArrayW<::System::Type*>& __cordl_internal_get_argTypes();
  ...
  constexpr void __cordl_internal_set_argTypes(::ArrayW<::System::Type*> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinaryMethodReturn", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinaryMethodReturn(BinaryMethodReturn&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinaryMethodReturn", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinaryMethodReturn(BinaryMethodReturnconst&) = delete;
  ...
  ::ArrayW<::System::Type*> ___argTypes;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn) == 0x40, "Size mismatch!");
