...
public:
  ...
  /// @brief Method Dump, addr 0x5a1ae44, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn* New_ctor();

  /// @brief Method Write, addr 0x5a1ad20, size 0x124, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a1ad14, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
