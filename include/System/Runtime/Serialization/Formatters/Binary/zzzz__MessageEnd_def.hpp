...
public:
  // Declarations
  /// @brief Method Dump, addr 0x5a1c1a0, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  /// @brief Method Dump, addr 0x5a1c1a4, size 0x4, virtual false, abstract: false, final false
  inline void Dump(::System::IO::Stream* sout);

  static inline ::System::Runtime::Serialization::Formatters::Binary::MessageEnd* New_ctor();

  /// @brief Method Read, addr 0x5a1c19c, size 0x4, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Write, addr 0x5a1c174, size 0x28, virtual true, abstract: false, final true
  inline void Write(::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);

  /// @brief Method .ctor, addr 0x5a1c170, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
