...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::Serialization::Formatters::Binary::InternalFE::*)()>(&::System::Runtime::Serialization::Formatters::Binary::InternalFE::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x59bb8bc;
...
constexpr ::System::Runtime::Serialization::Formatters::Binary::InternalSerializerTypeE const& System::Runtime::Serialization::Formatters::Binary::InternalFE::__cordl_internal_get_FEserializerTypeEnum() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___FEserializerTypeEnum;
}
constexpr void System::Runtime::Serialization::Formatters::Binary::InternalFE::__cordl_internal_set_FEserializerTypeEnum(::System::Runtime::Serialization::Formatters::Binary::InternalSerializerTypeE  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
