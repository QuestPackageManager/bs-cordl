...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NameInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NameInfo(NameInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NameInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NameInfo(NameInfoconst&) = delete;
