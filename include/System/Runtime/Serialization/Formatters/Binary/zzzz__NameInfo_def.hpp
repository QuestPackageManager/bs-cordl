...
public:
  ...
  /// @brief Method Init, addr 0x3d0aa8c, size 0x20, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x3d0aaac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsSealed, addr 0x3d0a7f0, size 0x4c, virtual false, abstract: false, final false
  inline bool get_IsSealed();

  /// @brief Method get_NIname, addr 0x3d0ec60, size 0x38, virtual false, abstract: false, final false
  inline ::StringW get_NIname();

  /// @brief Method set_NIname, addr 0x3d0ec98, size 0x8, virtual false, abstract: false, final false
