...
public:
  ...
  /// @brief Method Clone, addr 0x5a2d524, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method IncreaseCapacity, addr 0x5a2d580, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a26498, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a2d44c, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::Formatters::Binary::IntSizedArray* sizedArray);

  /// @brief Method get_Item, addr 0x5a26500, size 0x78, virtual false, abstract: false, final false
  inline int32_t get_Item(int32_t index);

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Item, addr 0x5a26578, size 0xb8, virtual false, abstract: false, final false
