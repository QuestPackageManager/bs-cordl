...
public:
  ...
  /// @brief Method GetAssembly, addr 0x3cff1b4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cff160, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyString);

  /// @brief Method .ctor, addr 0x3cff188, size 0x2c, virtual false, abstract: false, final false
