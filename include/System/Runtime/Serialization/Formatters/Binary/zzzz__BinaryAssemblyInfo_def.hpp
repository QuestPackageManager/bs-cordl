...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinaryAssemblyInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinaryAssemblyInfo(BinaryAssemblyInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinaryAssemblyInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinaryAssemblyInfo(BinaryAssemblyInfoconst&) = delete;
