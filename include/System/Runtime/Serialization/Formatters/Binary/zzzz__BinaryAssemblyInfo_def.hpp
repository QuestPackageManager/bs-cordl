...
public:
  ...
  /// @brief Method GetAssembly, addr 0x5a1a54c, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1a53c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyString);

  /// @brief Method .ctor, addr 0x5a1a544, size 0x8, virtual false, abstract: false, final false
