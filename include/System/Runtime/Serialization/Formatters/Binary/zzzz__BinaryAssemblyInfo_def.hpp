...
public:
  ...
  /// @brief Method GetAssembly, addr 0x2616f20, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2616ecc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyString);

  /// @brief Method .ctor, addr 0x2616ef4, size 0x2c, virtual false, abstract: false, final false
