...
public:
  ...
  /// @brief Method GetAssembly, addr 0x3d0df74, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d0df20, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyString);

  /// @brief Method .ctor, addr 0x3d0df48, size 0x2c, virtual false, abstract: false, final false
