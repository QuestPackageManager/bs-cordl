...
public:
  // Ctor Parameters [CppParam { name: "", ty: "__BinaryWriter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __BinaryWriter(__BinaryWriter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__BinaryWriter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __BinaryWriter(__BinaryWriterconst&) = delete;
