...
public:
  ...
  /// @brief Method InternalWriteItemNull, addr 0x5a1f5e8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteArrayAsBytes, addr 0x5a1f9fc, size 0x144, virtual false, abstract: false, final false
  inline void WriteArrayAsBytes(::System::Array* array, int32_t typeLength);

  /// @brief Method WriteAssembly, addr 0x5a20188, size 0xc0, virtual false, abstract: false, final false
  inline void WriteAssembly(::System::Type* type, ::StringW assemblyString, int32_t assemId, bool isNew);

  /// @brief Method WriteBegin, addr 0x5a1ebdc, size 0x4, virtual false, abstract: false, final false
  inline void WriteBegin();

  /// @brief Method WriteBoolean, addr 0x5a1ebfc, size 0x20, virtual false, abstract: false, final false
  inline void WriteBoolean(bool value);

  /// @brief Method WriteByte, addr 0x5a194a8, size 0x1c, virtual false, abstract: false, final false
  inline void WriteByte(uint8_t value);

  /// @brief Method WriteBytes, addr 0x5a1ec3c, size 0x20, virtual false, abstract: false, final false
  inline void WriteBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> byteA, int32_t offset, int32_t size);

  /// @brief Method WriteBytes, addr 0x5a1ec1c, size 0x20, virtual false, abstract: false, final false
  inline void WriteBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method WriteChar, addr 0x5a1ec5c, size 0x20, virtual false, abstract: false, final false
  inline void WriteChar(char16_t value);

  /// @brief Method WriteChars, addr 0x5a1ec7c, size 0x20, virtual false, abstract: false, final false
  inline void WriteChars(::ArrayW<char16_t, ::Array<char16_t>*> value);

  /// @brief Method WriteDateTime, addr 0x5a1eeb4, size 0x7c, virtual false, abstract: false, final false
  inline void WriteDateTime(::System::DateTime value);

  /// @brief Method WriteDecimal, addr 0x5a1ec9c, size 0x100, virtual false, abstract: false, final false
  inline void WriteDecimal(::System::Decimal value);

  /// @brief Method WriteDelayedNullItem, addr 0x5a20144, size 0x10, virtual false, abstract: false, final false
  inline void WriteDelayedNullItem();

  /// @brief Method WriteDouble, addr 0x5a1edbc, size 0x20, virtual false, abstract: false, final false
  inline void WriteDouble(double_t value);

  /// @brief Method WriteEnd, addr 0x5a1ebe0, size 0x1c, virtual false, abstract: false, final false
  inline void WriteEnd();

  /// @brief Method WriteInt16, addr 0x5a1eddc, size 0x20, virtual false, abstract: false, final false
  inline void WriteInt16(int16_t value);

  /// @brief Method WriteInt32, addr 0x5a194e4, size 0x20, virtual false, abstract: false, final false
  inline void WriteInt32(int32_t value);

  /// @brief Method WriteInt64, addr 0x5a1edfc, size 0x20, virtual false, abstract: false, final false
  inline void WriteInt64(int64_t value);

  /// @brief Method WriteItem, addr 0x5a200f4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteItemEnd, addr 0x5a20154, size 0x4, virtual false, abstract: false, final false
  inline void WriteItemEnd();

  /// @brief Method WriteItemObjectRef, addr 0x5a20158, size 0x30, virtual false, abstract: false, final false
  inline void WriteItemObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo* nameInfo, int32_t idRef);

  /// @brief Method WriteJaggedArray, addr 0x5a1fb40, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteMember, addr 0x5a1fe78, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteMemberNested, addr 0x5a20090, size 0x1c, virtual false, abstract: false, final false
  inline void WriteMemberNested(::System::Runtime::Serialization::Formatters::Binary::NameInfo* memberNameInfo);

  /// @brief Method WriteMemberObjectRef, addr 0x5a2000c, size 0x84, virtual false, abstract: false, final false
  inline void WriteMemberObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo* memberNameInfo, int32_t idRef);

  /// @brief Method WriteMemberString, addr 0x5a200ac, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteMethodCall, addr 0x5a1f070, size 0x64, virtual false, abstract: false, final false
  inline void WriteMethodCall();

  /// @brief Method WriteMethodReturn, addr 0x5a1f0d4, size 0x64, virtual false, abstract: false, final false
  inline void WriteMethodReturn();

  /// @brief Method WriteNullItem, addr 0x5a20134, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteNullMember, addr 0x5a1ff78, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteObject, addr 0x5a1f138, size 0x4b0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method WriteObjectByteArray, addr 0x5a1fe18, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteObjectEnd, addr 0x5a1ef90, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteObjectString, addr 0x5a1f668, size 0x84, virtual false, abstract: false, final false
  inline void WriteObjectString(int32_t objectId, ::StringW value);

  /// @brief Method WriteRectangleArray, addr 0x5a1fcc0, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteSByte, addr 0x5a1ee1c, size 0x1c, virtual false, abstract: false, final false
  inline void WriteSByte(int8_t value);

  /// @brief Method WriteSerializationHeader, addr 0x5a1efec, size 0x84, virtual false, abstract: false, final false
  inline void WriteSerializationHeader(int32_t topId, int32_t headerId, int32_t minorVersion, int32_t majorVersion);

  /// @brief Method WriteSerializationHeaderEnd, addr 0x5a1ef94, size 0x58, virtual false, abstract: false, final false
  inline void WriteSerializationHeaderEnd();

  /// @brief Method WriteSingle, addr 0x5a1ed9c, size 0x20, virtual false, abstract: false, final false
  inline void WriteSingle(float_t value);

  /// @brief Method WriteSingleArray, addr 0x5a1f6ec, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteString, addr 0x5a194c4, size 0x20, virtual false, abstract: false, final false
  inline void WriteString(::StringW value);

  /// @brief Method WriteTimeSpan, addr 0x5a1ee38, size 0x7c, virtual false, abstract: false, final false
  inline void WriteTimeSpan(::System::TimeSpan value);

  /// @brief Method WriteUInt16, addr 0x5a1ef30, size 0x20, virtual false, abstract: false, final false
  inline void WriteUInt16(uint16_t value);

  /// @brief Method WriteUInt32, addr 0x5a1ef50, size 0x20, virtual false, abstract: false, final false
  inline void WriteUInt32(uint32_t value);

  /// @brief Method WriteUInt64, addr 0x5a1ef70, size 0x20, virtual false, abstract: false, final false
  inline void WriteUInt64(uint64_t value);

  /// @brief Method WriteValue, addr 0x5a19e24, size 0x718, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1e81c, size 0xa8, virtual false, abstract: false, final false
