...
public:
  ...
  /// @brief Method Dump, addr 0x5b567d8, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainString* New_ctor();

  /// @brief Method Read, addr 0x5b56778, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b56774, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
