...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinaryCrossAppDomainString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinaryCrossAppDomainString(BinaryCrossAppDomainString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinaryCrossAppDomainString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinaryCrossAppDomainString(BinaryCrossAppDomainStringconst&) = delete;
