...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinaryCrossAppDomainMap", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinaryCrossAppDomainMap(BinaryCrossAppDomainMap&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinaryCrossAppDomainMap", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinaryCrossAppDomainMap(BinaryCrossAppDomainMapconst&) = delete;
