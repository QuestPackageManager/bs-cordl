...
public:
  ...
  /// @brief Method Dump, addr 0x3d0e9f4, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainMap* New_ctor();

  /// @brief Method Read, addr 0x3d0e9cc, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3d0e9c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
