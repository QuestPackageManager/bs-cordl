...
/// @brief Method Dump, addr 0x59a9060, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainMap* New_ctor() ;

/// @brief Method Read, addr 0x59a902c, size 0x34, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x59a9028, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
