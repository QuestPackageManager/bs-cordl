...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrimitiveArray", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrimitiveArray(PrimitiveArray&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrimitiveArray", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrimitiveArray(PrimitiveArrayconst&) = delete;
