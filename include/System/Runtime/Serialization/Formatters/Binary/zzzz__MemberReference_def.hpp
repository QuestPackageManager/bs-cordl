...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemberReference", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemberReference(MemberReference&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemberReference", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemberReference(MemberReferenceconst&) = delete;
