...
public:
  ...
  /// @brief Method CheckTypeForwardedFrom, addr 0x2744b44, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAssemblyString, addr 0x2745544, size 0x28, virtual false, abstract: false, final false
  inline ::StringW GetAssemblyString();

  /// @brief Method GetMemberInfo, addr 0x274556c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMemberType, addr 0x27453ac, size 0x170, virtual false, abstract: false, final false
  inline ::System::Type* GetMemberType(::System::Reflection::MemberInfo* objMember);

  /// @brief Method GetObjectInfo, addr 0x2744184, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeFullName, addr 0x274551c, size 0x28, virtual false, abstract: false, final false
  inline ::StringW GetTypeFullName();

  /// @brief Method InitMemberInfo, addr 0x2744ca4, size 0x2dc, virtual false, abstract: false, final false
  inline void InitMemberInfo();

  /// @brief Method InitNoMembers, addr 0x2744738, size 0xe4, virtual false, abstract: false, final false
  inline void InitNoMembers();

  /// @brief Method InitSerialize, addr 0x2744250, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitSerialize, addr 0x2745008, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method InitSiWrite, addr 0x2744844, size 0x300, virtual false, abstract: false, final false
  inline void InitSiWrite();

  /// @brief Method InternalInit, addr 0x27440d4, size 0x20, virtual false, abstract: false, final false
  inline void InternalInit();

  /// @brief Method InvokeSerializationBinder, addr 0x274481c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ObjectEnd, addr 0x27440ac, size 0xc, virtual false, abstract: false, final false
  inline void ObjectEnd();

  /// @brief Method PutObjectInfo, addr 0x27440b8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x27440f4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x2744f80, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27440a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
