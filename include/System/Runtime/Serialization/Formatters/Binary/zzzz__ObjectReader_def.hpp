...
public:
  ...
  /// @brief Method .ctor, addr 0x5a26e10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ResolveType, addr 0x5a2705c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a26eac, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Bind, addr 0x5a26630, size 0x58, virtual false, abstract: false, final false
  inline ::System::Type* Bind(::StringW assemblyString, ::StringW typeString);

  /// @brief Method CheckSerializable, addr 0x5a23974, size 0x118, virtual false, abstract: false, final false
  inline void CheckSerializable(::System::Type* t);

  /// @brief Method CheckTypeForwardedTo, addr 0x5a26cc8, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateReadObjectInfo, addr 0x5a23bb8, size 0x78, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo* CreateReadObjectInfo(::System::Type* objectType);

  /// @brief Method CreateReadObjectInfo, addr 0x5a23c30, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CrossAppDomainArray, addr 0x5a23b88, size 0x30, virtual false, abstract: false, final false
  inline ::System::Object* CrossAppDomainArray(int32_t index);

  /// @brief Method Deserialize, addr 0x5a22fe8, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method FastBindToType, addr 0x5a26688, size 0x2e8, virtual false, abstract: false, final false
  inline ::System::Type* FastBindToType(::StringW assemblyName, ::StringW typeName);

  /// @brief Method GetId, addr 0x5a263b0, size 0xe8, virtual false, abstract: false, final false
  inline int64_t GetId(int64_t objectId);

  /// @brief Method GetSimplyNamedTypeFromAssembly, addr 0x5a26a7c, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetType, addr 0x5a26eb4, size 0x1a8, virtual false, abstract: false, final false
  inline ::System::Type* GetType(::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* assemblyInfo, ::StringW name);

  /// @brief Method HasSurrogate, addr 0x5a2389c, size 0xd8, virtual false, abstract: false, final false
  inline bool HasSurrogate(::System::Type* t);

  /// @brief Method InitFullDeserialization, addr 0x5a23a8c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method NextRectangleMap, addr 0x5a2550c, size 0xdc, virtual false, abstract: false, final false
  inline void NextRectangleMap(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method Parse, addr 0x5a23cbc, size 0x158, virtual false, abstract: false, final false
  inline void Parse(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArray, addr 0x5a24b64, size 0x660, virtual false, abstract: false, final false
  inline void ParseArray(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArrayMember, addr 0x5a255e8, size 0x82c, virtual false, abstract: false, final false
  inline void ParseArrayMember(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArrayMemberEnd, addr 0x5a26270, size 0x20, virtual false, abstract: false, final false
  inline void ParseArrayMemberEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseError, addr 0x5a24954, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseMember, addr 0x5a243ac, size 0x4e8, virtual false, abstract: false, final false
  inline void ParseMember(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseMemberEnd, addr 0x5a24894, size 0xc0, virtual false, abstract: false, final false
  inline void ParseMemberEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseObject, addr 0x5a23e3c, size 0x350, virtual false, abstract: false, final false
  inline void ParseObject(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseObjectEnd, addr 0x5a2418c, size 0x220, virtual false, abstract: false, final false
  inline void ParseObjectEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseSerializedStreamHeader, addr 0x5a23e14, size 0x14, virtual false, abstract: false, final false
  inline void ParseSerializedStreamHeader(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseSerializedStreamHeaderEnd, addr 0x5a23e28, size 0x14, virtual false, abstract: false, final false
  inline void ParseSerializedStreamHeaderEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseString, addr 0x5a25e24, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterObject, addr 0x5a25204, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterObject, addr 0x5a262a4, size 0x10c, virtual false, abstract: false, final false
  inline void RegisterObject(::System::Object* obj, ::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr, ::System::Runtime::Serialization::Formatters::Binary::ParseRecord* objectPr,
                             bool bIsString);

  /// @brief Method ResolveSimpleAssemblyName, addr 0x5a26a20, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a22ef8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TopObject, addr 0x5a22edc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_TopObject();

  /// @brief Method get_ValueFixupStack, addr 0x5a22e5c, size 0x80, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SerStack* get_ValueFixupStack();

  /// @brief Method set_TopObject, addr 0x5a22ee4, size 0x14, virtual false, abstract: false, final false
