...
public:
  ...
  /// @brief Method .ctor, addr 0x2869728, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ResolveType, addr 0x286999c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28697c0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Bind, addr 0x2868f40, size 0x58, virtual false, abstract: false, final false
  inline ::System::Type* Bind(::StringW assemblyString, ::StringW typeString);

  /// @brief Method CheckSerializable, addr 0x28662bc, size 0x138, virtual false, abstract: false, final false
  inline void CheckSerializable(::System::Type* t);

  /// @brief Method CheckTypeForwardedTo, addr 0x28695e4, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateReadObjectInfo, addr 0x2866534, size 0x30, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo* CreateReadObjectInfo(::System::Type* objectType);

  /// @brief Method CreateReadObjectInfo, addr 0x2866564, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method CrossAppDomainArray, addr 0x2866504, size 0x30, virtual false, abstract: false, final false
  inline ::System::Object* CrossAppDomainArray(int32_t index);

  /// @brief Method Deserialize, addr 0x2865904, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method FastBindToType, addr 0x2868f98, size 0x2f0, virtual false, abstract: false, final false
  inline ::System::Type* FastBindToType(::StringW assemblyName, ::StringW typeName);

  /// @brief Method GetId, addr 0x2868cd0, size 0xdc, virtual false, abstract: false, final false
  inline int64_t GetId(int64_t objectId);

  /// @brief Method GetSimplyNamedTypeFromAssembly, addr 0x2869390, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method GetType, addr 0x28697e8, size 0x1b4, virtual false, abstract: false, final false
  inline ::System::Type* GetType(::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* assemblyInfo, ::StringW name);

  /// @brief Method HasSurrogate, addr 0x28661e8, size 0xd4, virtual false, abstract: false, final false
  inline bool HasSurrogate(::System::Type* t);

  /// @brief Method InitFullDeserialization, addr 0x28663f4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method NextRectangleMap, addr 0x2867eb4, size 0xc4, virtual false, abstract: false, final false
  inline void NextRectangleMap(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method Parse, addr 0x28665a4, size 0x144, virtual false, abstract: false, final false
  inline void Parse(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArray, addr 0x286749c, size 0x68c, virtual false, abstract: false, final false
  inline void ParseArray(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArrayMember, addr 0x2867f78, size 0x79c, virtual false, abstract: false, final false
  inline void ParseArrayMember(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseArrayMemberEnd, addr 0x2868b44, size 0x28, virtual false, abstract: false, final false
  inline void ParseArrayMemberEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseError, addr 0x28671c4, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseMember, addr 0x2866c40, size 0x4c8, virtual false, abstract: false, final false
  inline void ParseMember(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseMemberEnd, addr 0x2867108, size 0xbc, virtual false, abstract: false, final false
  inline void ParseMemberEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseObject, addr 0x2866718, size 0x310, virtual false, abstract: false, final false
  inline void ParseObject(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseObjectEnd, addr 0x2866a28, size 0x218, virtual false, abstract: false, final false
  inline void ParseObjectEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseSerializedStreamHeader, addr 0x28666e8, size 0x18, virtual false, abstract: false, final false
  inline void ParseSerializedStreamHeader(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseSerializedStreamHeaderEnd, addr 0x2866700, size 0x18, virtual false, abstract: false, final false
  inline void ParseSerializedStreamHeaderEnd(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ParseString, addr 0x2868748, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterObject, addr 0x2867b68, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterObject, addr 0x2868bb0, size 0x120, virtual false, abstract: false, final false
  inline void RegisterObject(::System::Object* obj, ::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr, ::System::Runtime::Serialization::Formatters::Binary::ParseRecord* objectPr,
                             bool bIsString);

  /// @brief Method ResolveSimpleAssemblyName, addr 0x2869330, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28657e8, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TopObject, addr 0x28657cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_TopObject();

  /// @brief Method get_ValueFixupStack, addr 0x286574c, size 0x80, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SerStack* get_ValueFixupStack();

  /// @brief Method set_TopObject, addr 0x28657d4, size 0x14, virtual false, abstract: false, final false
