...
/// @brief Field typeInformation, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get_typeInformation, put=__cordl_internal_set_typeInformation)) ::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  typeInformation;

/// @brief Field value, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_value, put=__cordl_internal_set_value)) ::System::Object*  value;

/// @brief Method Dump, addr 0x5a1db14, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveUnTyped* New_ctor() ;

/// @brief Method Read, addr 0x5a1dae4, size 0x30, virtual true, abstract: false, final true
inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser*  input) ;

/// @brief Method Set, addr 0x5a1dabc, size 0x8, virtual false, abstract: false, final false
inline void Set(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  typeInformation) ;

/// @brief Method Set, addr 0x5a1dab0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x5a1dac4, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5a1daac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
