...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveUnTyped*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveUnTyped*, "System.Runtime.Serialization.Formatters.Binary", "MemberPrimitiveUnTyped");
...
public:
  ...
  /// @brief Method Dump, addr 0x5b59ae4, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveUnTyped* New_ctor();

  /// @brief Method Read, addr 0x5b59ab4, size 0x30, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x5b59a8c, size 0x8, virtual false, abstract: false, final false
  inline void Set(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE typeInformation);

  /// @brief Method Set, addr 0x5b59a80, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5b59a94, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b59a7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemberPrimitiveUnTyped", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemberPrimitiveUnTyped(MemberPrimitiveUnTyped&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemberPrimitiveUnTyped", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemberPrimitiveUnTyped(MemberPrimitiveUnTypedconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveUnTyped) == 0x20, "Size mismatch!");
