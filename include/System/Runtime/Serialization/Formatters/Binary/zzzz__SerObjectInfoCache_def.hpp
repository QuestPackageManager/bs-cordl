...
public:
  ...
  /// @brief Method .ctor, addr 0x5b5cd70, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x5b5cdf4, size 0xc, virtual false, abstract: false, final false
