...
public:
  ...
  /// @brief Method .ctor, addr 0x2863d68, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x2863df4, size 0x3c, virtual false, abstract: false, final false
