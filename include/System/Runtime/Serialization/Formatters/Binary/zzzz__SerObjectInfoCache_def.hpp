...
public:
  ...
  /// @brief Method .ctor, addr 0x59af0b0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x59af134, size 0xc, virtual false, abstract: false, final false
