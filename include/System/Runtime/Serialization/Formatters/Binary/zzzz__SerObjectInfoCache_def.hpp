...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerObjectInfoCache", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerObjectInfoCache(SerObjectInfoCache&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerObjectInfoCache", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerObjectInfoCache(SerObjectInfoCacheconst&) = delete;
