...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoInit*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoInit*, "System.Runtime.Serialization.Formatters.Binary", "SerObjectInfoInit");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerObjectInfoInit", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerObjectInfoInit(SerObjectInfoInit&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerObjectInfoInit", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerObjectInfoInit(SerObjectInfoInitconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoInit) == 0x28, "Size mismatch!");
