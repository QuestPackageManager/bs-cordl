...
public:
  ...
  /// @brief Method Dump, addr 0x3d00ccc, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::ObjectNull* New_ctor();

  /// @brief Method Read, addr 0x3d00c6c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNullCount, addr 0x3d00bb8, size 0x8, virtual false, abstract: false, final false
  inline void SetNullCount(int32_t nullCount);

  /// @brief Method Write, addr 0x3d00bc0, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3d00bb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
