...
public:
  ...
  /// @brief Method Dump, addr 0x5b579b4, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::ObjectNull* New_ctor();

  /// @brief Method Read, addr 0x5b57940, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNullCount, addr 0x5b57884, size 0x8, virtual false, abstract: false, final false
  inline void SetNullCount(int32_t nullCount);

  /// @brief Method Write, addr 0x5b5788c, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b57880, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
