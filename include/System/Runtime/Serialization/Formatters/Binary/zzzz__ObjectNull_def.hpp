...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectNull", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectNull(ObjectNull&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectNull", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectNull(ObjectNullconst&) = delete;
