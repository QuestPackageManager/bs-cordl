...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerStack", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerStack(SerStack&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerStack", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerStack(SerStackconst&) = delete;
