...
public:
  ...
  /// @brief Method IncreaseCapacity, addr 0x5a2d098, size 0x8c, virtual false, abstract: false, final false
  inline void IncreaseCapacity();

  /// @brief Method IsEmpty, addr 0x5a21818, size 0x10, virtual false, abstract: false, final false
  inline bool IsEmpty();

  static inline ::System::Runtime::Serialization::Formatters::Binary::SerStack* New_ctor(::StringW stackId);

  /// @brief Method Peek, addr 0x5a251c4, size 0x40, virtual false, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method PeekPeek, addr 0x5a2c158, size 0x44, virtual false, abstract: false, final false
  inline ::System::Object* PeekPeek();

  /// @brief Method Pop, addr 0x5a21828, size 0x50, virtual false, abstract: false, final false
  inline ::System::Object* Pop();

  /// @brief Method Push, addr 0x5a21878, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a22dd0, size 0x68, virtual false, abstract: false, final false
