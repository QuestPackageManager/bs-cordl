...
public:
  ...
  /// @brief Method IncreaseCapacity, addr 0x2751140, size 0x88, virtual false, abstract: false, final false
  inline void IncreaseCapacity();

  /// @brief Method IsEmpty, addr 0x2745614, size 0x10, virtual false, abstract: false, final false
  inline bool IsEmpty();

  static inline ::System::Runtime::Serialization::Formatters::Binary::SerStack* New_ctor(::StringW stackId);

  /// @brief Method Peek, addr 0x27490a4, size 0x40, virtual false, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method PeekPeek, addr 0x27500a0, size 0x44, virtual false, abstract: false, final false
  inline ::System::Object* PeekPeek();

  /// @brief Method Pop, addr 0x2745624, size 0x50, virtual false, abstract: false, final false
  inline ::System::Object* Pop();

  /// @brief Method Push, addr 0x2745674, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2746c00, size 0x74, virtual false, abstract: false, final false
