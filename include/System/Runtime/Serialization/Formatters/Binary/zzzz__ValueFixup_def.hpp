...
public:
  ...
  /// @brief Method Fixup, addr 0x5a2520c, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a25e14, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* arrayObj, ::ArrayW<int32_t, ::Array<int32_t>*> indexMap);

  /// @brief Method .ctor, addr 0x5a26290, size 0x14, virtual false, abstract: false, final false
