...
public:
  ...
  /// @brief Method Fixup, addr 0x2621ee0, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2622a88, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* arrayObj, ::ArrayW<int32_t, ::Array<int32_t>*> indexMap);

  /// @brief Method .ctor, addr 0x2622ee0, size 0x44, virtual false, abstract: false, final false
