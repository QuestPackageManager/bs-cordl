...
public:
  ...
  /// @brief Method Fixup, addr 0x5b60a54, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b6165c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* arrayObj, ::ArrayW<int32_t> indexMap);

  /// @brief Method .ctor, addr 0x5b61ad8, size 0x14, virtual false, abstract: false, final false
