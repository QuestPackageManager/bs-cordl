...
public:
  ...
  /// @brief Method Fixup, addr 0x5b62d54, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b6395c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* arrayObj, ::ArrayW<int32_t> indexMap);

  /// @brief Method .ctor, addr 0x5b63dd8, size 0x14, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValueFixup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValueFixup(ValueFixup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValueFixup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValueFixup(ValueFixupconst&) = delete;
