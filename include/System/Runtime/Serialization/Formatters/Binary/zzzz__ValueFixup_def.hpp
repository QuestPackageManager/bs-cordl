...
public:
  ...
  /// @brief Method Fixup, addr 0x3d0b594, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d0c134, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* arrayObj, ::ArrayW<int32_t, ::Array<int32_t>*> indexMap);

  /// @brief Method .ctor, addr 0x3d0c5d0, size 0x44, virtual false, abstract: false, final false
