...
public:
  ...
  /// @brief Method Fixup, addr 0x25be6e4, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25bf28c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* arrayObj, ::ArrayW<int32_t, ::Array<int32_t>*> indexMap);

  /// @brief Method .ctor, addr 0x25bf6e4, size 0x44, virtual false, abstract: false, final false
