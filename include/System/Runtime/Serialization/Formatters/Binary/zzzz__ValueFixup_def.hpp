...
public:
  ...
  /// @brief Method Fixup, addr 0x27490ec, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2749c90, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Array* arrayObj, ::ArrayW<int32_t, ::Array<int32_t>*> indexMap);

  /// @brief Method .ctor, addr 0x274a0e8, size 0x44, virtual false, abstract: false, final false
