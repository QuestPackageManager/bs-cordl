...
public:
  // Declarations
  /// @brief Method FlagTest addr 0x2368660 size 0xc virtual false final false
  ...
  /// @brief Method WriteStringWithCode addr 0x236866c size 0x74 virtual false final false
  static inline void WriteStringWithCode(::StringW value, ::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);

  /// @brief Method WriteWithCode addr 0x23686e0 size 0x12c virtual false final false
