...
public:
  // Declarations
  /// @brief Method FlagTest, addr 0x5a19c7c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteStringWithCode, addr 0x5a19c88, size 0x7c, virtual false, abstract: false, final false
  static inline void WriteStringWithCode(::StringW value, ::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);

  /// @brief Method WriteWithCode, addr 0x5a19d04, size 0x120, virtual false, abstract: false, final false
