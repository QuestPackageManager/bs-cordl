...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IOUtil", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IOUtil(IOUtil&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IOUtil", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IOUtil(IOUtilconst&) = delete;
