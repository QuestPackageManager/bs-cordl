...
public:
  // Declarations
  /// @brief Method FlagTest, addr 0x26166bc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteStringWithCode, addr 0x26166c8, size 0x74, virtual false, abstract: false, final false
  static inline void WriteStringWithCode(::StringW value, ::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);

  /// @brief Method WriteWithCode, addr 0x261673c, size 0x12c, virtual false, abstract: false, final false
