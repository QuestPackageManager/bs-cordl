...
public:
  // Declarations
  /// @brief Method FlagTest, addr 0x3cfb118, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteStringWithCode, addr 0x3cfb124, size 0x74, virtual false, abstract: false, final false
  static inline void WriteStringWithCode(::StringW value, ::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);

  /// @brief Method WriteWithCode, addr 0x3cfb198, size 0x12c, virtual false, abstract: false, final false
