...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NameCache", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NameCache(NameCache&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NameCache", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NameCache(NameCacheconst&) = delete;
