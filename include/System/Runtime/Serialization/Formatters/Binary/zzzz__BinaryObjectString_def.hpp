...
/// @brief Method Dump, addr 0x59a8fbc, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryObjectString* New_ctor() ;

/// @brief Method Read, addr 0x59a8f5c, size 0x60, virtual true, abstract: false, final true
inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser*  input) ;

/// @brief Method Set, addr 0x59a8ee0, size 0xc, virtual false, abstract: false, final false
inline void Set(int32_t  objectId, ::StringW  value) ;

/// @brief Method Write, addr 0x59a8eec, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x59a8edc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
