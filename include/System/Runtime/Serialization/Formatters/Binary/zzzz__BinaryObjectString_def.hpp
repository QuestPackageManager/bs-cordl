...
public:
  ...
  /// @brief Method Dump, addr 0x273eaac, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryObjectString* New_ctor();

  /// @brief Method Read, addr 0x273ea68, size 0x44, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x273e9ec, size 0xc, virtual false, abstract: false, final false
  inline void Set(int32_t objectId, ::StringW value);

  /// @brief Method Write, addr 0x273e9f8, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x273e9e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
