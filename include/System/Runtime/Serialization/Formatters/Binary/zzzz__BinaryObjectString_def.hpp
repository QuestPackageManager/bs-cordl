...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinaryObjectString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinaryObjectString(BinaryObjectString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinaryObjectString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinaryObjectString(BinaryObjectStringconst&) = delete;
