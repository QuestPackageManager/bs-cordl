...
public:
  ...
  /// @brief Method ArrayCountIncrement, addr 0x5b58128, size 0x10, virtual false, abstract: false, final false
  inline void ArrayCountIncrement(int32_t value);

  /// @brief Method GetNext, addr 0x5b58138, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x5b58094, size 0x94, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x5b5803c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
