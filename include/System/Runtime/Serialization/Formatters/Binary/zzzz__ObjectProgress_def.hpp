...
public:
  ...
  /// @brief Method ArrayCountIncrement, addr 0x5a1c8e0, size 0x10, virtual false, abstract: false, final false
  inline void ArrayCountIncrement(int32_t value);

  /// @brief Method GetNext, addr 0x5a1c8f0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x5a1c84c, size 0x94, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x5a1c7f4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
