...
public:
  ...
  /// @brief Method ArrayCountIncrement, addr 0x3cfdcd4, size 0x10, virtual false, abstract: false, final false
  inline void ArrayCountIncrement(int32_t value);

  /// @brief Method GetNext, addr 0x3cfdce4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x3cfdc84, size 0x50, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x3cfdc1c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
