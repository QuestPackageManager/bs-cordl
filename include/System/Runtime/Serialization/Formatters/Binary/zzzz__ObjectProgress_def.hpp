...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectProgress", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectProgress(ObjectProgress&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectProgress", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectProgress(ObjectProgressconst&) = delete;
