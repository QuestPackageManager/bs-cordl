...
public:
  ...
  /// @brief Method Init, addr 0x59b962c, size 0x58, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x59b7768, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
