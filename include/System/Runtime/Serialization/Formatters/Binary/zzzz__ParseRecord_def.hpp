...
public:
  ...
  /// @brief Method Init, addr 0x5a2baa4, size 0x58, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x5a29be0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
