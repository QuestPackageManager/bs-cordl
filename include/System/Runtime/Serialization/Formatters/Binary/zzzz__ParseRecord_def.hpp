...
public:
  ...
  /// @brief Method Init, addr 0x5b672ec, size 0x58, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x5b65428, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
