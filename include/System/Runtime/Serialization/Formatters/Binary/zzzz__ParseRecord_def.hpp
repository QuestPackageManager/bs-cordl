...
public:
  ...
  /// @brief Method Init, addr 0x3d1644c, size 0x58, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x3d14464, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
