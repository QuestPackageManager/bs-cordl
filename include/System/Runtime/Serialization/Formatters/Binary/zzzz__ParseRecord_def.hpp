...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ParseRecord", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ParseRecord(ParseRecord&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ParseRecord", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ParseRecord(ParseRecordconst&) = delete;
