...
public:
  ...
  /// @brief Method Init, addr 0x25c4fd0, size 0x58, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x25c2f98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
