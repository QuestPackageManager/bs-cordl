...
public:
  ...
  /// @brief Method Dump, addr 0x274467c, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryObject* New_ctor();

  /// @brief Method Read, addr 0x2744638, size 0x44, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x27445c0, size 0x8, virtual false, abstract: false, final false
  inline void Set(int32_t objectId, int32_t mapId);

  /// @brief Method Write, addr 0x27445c8, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27445b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
