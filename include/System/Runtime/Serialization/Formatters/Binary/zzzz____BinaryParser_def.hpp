...
public:
  ...
  /// @brief Method .ctor addr 0x24d1e50 size 0x10c virtual false final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Runtime::Serialization::Formatters::Binary::ObjectReader* objectReader);

  /// @brief Method get_SystemAssemblyInfo addr 0x24d1f5c size 0xac virtual false final false
  inline ::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* get_SystemAssemblyInfo();

  /// @brief Method get_ObjectMapIdTable addr 0x24d2008 size 0x68 virtual false final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SizedArray* get_ObjectMapIdTable();

  /// @brief Method get_AssemIdToAssemblyTable addr 0x24d20dc size 0x6c virtual false final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SizedArray* get_AssemIdToAssemblyTable();

  /// @brief Method get_prs addr 0x24d21c0 size 0x6c virtual false final false
  inline ::System::Runtime::Serialization::Formatters::Binary::ParseRecord* get_prs();

  /// @brief Method Run addr 0x24cb8ec size 0x5d4 virtual false final false
  inline void Run();

  /// @brief Method ReadBegin addr 0x24d2234 size 0x4 virtual false final false
  inline void ReadBegin();

  /// @brief Method ReadEnd addr 0x24d3fb8 size 0x4 virtual false final false
  inline void ReadEnd();

  /// @brief Method ReadBoolean addr 0x24d4344 size 0x20 virtual false final false
  inline bool ReadBoolean();

  /// @brief Method ReadByte addr 0x24d4364 size 0x20 virtual false final false
  inline uint8_t ReadByte();

  /// @brief Method ReadBytes addr 0x24d4384 size 0x24 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBytes(int32_t length);

  /// @brief Method ReadBytes addr 0x24d43a8 size 0x7c virtual false final false
  inline void ReadBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> byteA, int32_t offset, int32_t size);

  /// @brief Method ReadChar addr 0x24d4424 size 0x20 virtual false final false
  inline char16_t ReadChar();

  /// @brief Method ReadChars addr 0x24d4444 size 0x24 virtual false final false
  inline ::ArrayW<char16_t, ::Array<char16_t>*> ReadChars(int32_t length);

  /// @brief Method ReadDecimal addr 0x24d4468 size 0xb4 virtual false final false
  inline ::System::Decimal ReadDecimal();

  /// @brief Method ReadSingle addr 0x24d451c size 0x24 virtual false final false
  inline float_t ReadSingle();

  /// @brief Method ReadDouble addr 0x24d4540 size 0x24 virtual false final false
  inline double_t ReadDouble();

  /// @brief Method ReadInt16 addr 0x24d4564 size 0x24 virtual false final false
  inline int16_t ReadInt16();

  /// @brief Method ReadInt32 addr 0x24d4588 size 0x24 virtual false final false
  inline int32_t ReadInt32();

  /// @brief Method ReadInt64 addr 0x24d45ac size 0x24 virtual false final false
  inline int64_t ReadInt64();

  /// @brief Method ReadSByte addr 0x24d45d0 size 0x20 virtual false final false
  inline int8_t ReadSByte();

  /// @brief Method ReadString addr 0x24d45f0 size 0x24 virtual false final false
  inline ::StringW ReadString();

  /// @brief Method ReadTimeSpan addr 0x24d4614 size 0x24 virtual false final false
  inline ::System::TimeSpan ReadTimeSpan();

  /// @brief Method ReadDateTime addr 0x24d4638 size 0x7c virtual false final false
  inline ::System::DateTime ReadDateTime();

  /// @brief Method ReadUInt16 addr 0x24d46b4 size 0x24 virtual false final false
  inline uint16_t ReadUInt16();

  /// @brief Method ReadUInt32 addr 0x24d46d8 size 0x24 virtual false final false
  inline uint32_t ReadUInt32();

  /// @brief Method ReadUInt64 addr 0x24d46fc size 0x24 virtual false final false
  inline uint64_t ReadUInt64();

  /// @brief Method ReadSerializationHeaderRecord addr 0x24d2238 size 0xc0 virtual false final false
  inline void ReadSerializationHeaderRecord();

  /// @brief Method ReadAssembly addr 0x24d22f8 size 0x274 virtual false final false
  inline void ReadAssembly(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObject addr 0x24d256c size 0x358 virtual false final false
  inline void ReadObject();

  /// @brief Method ReadCrossAppDomainMap addr 0x24d28c4 size 0x1cc virtual false final false
  inline void ReadCrossAppDomainMap();

  /// @brief Method ReadObjectWithMap addr 0x24d2a90 size 0xa0 virtual false final false
  inline void ReadObjectWithMap(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectWithMap addr 0x24d4980 size 0x40c virtual false final false
  inline void ReadObjectWithMap(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap* record);

  /// @brief Method ReadObjectWithMapTyped addr 0x24d2b30 size 0x90 virtual false final false
  inline void ReadObjectWithMapTyped(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectWithMapTyped addr 0x24d4d8c size 0x42c virtual false final false
  inline void ReadObjectWithMapTyped(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped* record);

  /// @brief Method ReadObjectString addr 0x24d2bc0 size 0x584 virtual false final false
  inline void ReadObjectString(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadMemberPrimitiveTyped addr 0x24d36e0 size 0x384 virtual false final false
  inline void ReadMemberPrimitiveTyped();

  /// @brief Method ReadArray addr 0x24d3144 size 0x59c virtual false final false
  inline void ReadArray(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadArrayAsBytes addr 0x24d51b8 size 0x338 virtual false final false
  inline void ReadArrayAsBytes(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ReadMemberPrimitiveUnTyped addr 0x24d3fbc size 0x2a8 virtual false final false
  inline void ReadMemberPrimitiveUnTyped();

  /// @brief Method ReadMemberReference addr 0x24d3a64 size 0x1e8 virtual false final false
  inline void ReadMemberReference();

  /// @brief Method ReadObjectNull addr 0x24d3c4c size 0x1f4 virtual false final false
  inline void ReadObjectNull(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadMessageEnd addr 0x24d3e40 size 0x178 virtual false final false
  inline void ReadMessageEnd();

  /// @brief Method ReadValue addr 0x24d54f0 size 0x420 virtual false final false
  inline ::System::Object* ReadValue(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);

  /// @brief Method GetOp addr 0x24d4894 size 0xa8 virtual false final false
  inline ::System::Runtime::Serialization::Formatters::Binary::ObjectProgress* GetOp();

  /// @brief Method PutOp addr 0x24d42bc size 0x88 virtual false final false
