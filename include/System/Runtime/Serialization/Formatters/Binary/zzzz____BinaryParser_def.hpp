...
public:
  ...
  /// @brief Method GetOp, addr 0x274fff8, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method PutOp, addr 0x274fa20, size 0x88, virtual false, abstract: false, final false
  inline void PutOp(::System::Runtime::Serialization::Formatters::Binary::ObjectProgress* op);

  /// @brief Method ReadArray, addr 0x274e8a8, size 0x59c, virtual false, abstract: false, final false
  inline void ReadArray(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadArrayAsBytes, addr 0x275091c, size 0x338, virtual false, abstract: false, final false
  inline void ReadArrayAsBytes(::System::Runtime::Serialization::Formatters::Binary::ParseRecord* pr);

  /// @brief Method ReadAssembly, addr 0x274da5c, size 0x274, virtual false, abstract: false, final false
  inline void ReadAssembly(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadBegin, addr 0x274d998, size 0x4, virtual false, abstract: false, final false
  inline void ReadBegin();

  /// @brief Method ReadBoolean, addr 0x274faa8, size 0x20, virtual false, abstract: false, final false
  inline bool ReadBoolean();

  /// @brief Method ReadByte, addr 0x274fac8, size 0x20, virtual false, abstract: false, final false
  inline uint8_t ReadByte();

  /// @brief Method ReadBytes, addr 0x274fae8, size 0x24, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBytes(int32_t length);

  /// @brief Method ReadBytes, addr 0x274fb0c, size 0x7c, virtual false, abstract: false, final false
  inline void ReadBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> byteA, int32_t offset, int32_t size);

  /// @brief Method ReadChar, addr 0x274fb88, size 0x20, virtual false, abstract: false, final false
  inline char16_t ReadChar();

  /// @brief Method ReadChars, addr 0x274fba8, size 0x24, virtual false, abstract: false, final false
  inline ::ArrayW<char16_t, ::Array<char16_t>*> ReadChars(int32_t length);

  /// @brief Method ReadCrossAppDomainMap, addr 0x274e028, size 0x1cc, virtual false, abstract: false, final false
  inline void ReadCrossAppDomainMap();

  /// @brief Method ReadDateTime, addr 0x274fd9c, size 0x7c, virtual false, abstract: false, final false
  inline ::System::DateTime ReadDateTime();

  /// @brief Method ReadDecimal, addr 0x274fbcc, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Decimal ReadDecimal();

  /// @brief Method ReadDouble, addr 0x274fca4, size 0x24, virtual false, abstract: false, final false
  inline double_t ReadDouble();

  /// @brief Method ReadEnd, addr 0x274f71c, size 0x4, virtual false, abstract: false, final false
  inline void ReadEnd();

  /// @brief Method ReadInt16, addr 0x274fcc8, size 0x24, virtual false, abstract: false, final false
  inline int16_t ReadInt16();

  /// @brief Method ReadInt32, addr 0x274fcec, size 0x24, virtual false, abstract: false, final false
  inline int32_t ReadInt32();

  /// @brief Method ReadInt64, addr 0x274fd10, size 0x24, virtual false, abstract: false, final false
  inline int64_t ReadInt64();

  /// @brief Method ReadMemberPrimitiveTyped, addr 0x274ee44, size 0x384, virtual false, abstract: false, final false
  inline void ReadMemberPrimitiveTyped();

  /// @brief Method ReadMemberPrimitiveUnTyped, addr 0x274f720, size 0x2a8, virtual false, abstract: false, final false
  inline void ReadMemberPrimitiveUnTyped();

  /// @brief Method ReadMemberReference, addr 0x274f1c8, size 0x1e8, virtual false, abstract: false, final false
  inline void ReadMemberReference();

  /// @brief Method ReadMessageEnd, addr 0x274f5a4, size 0x178, virtual false, abstract: false, final false
  inline void ReadMessageEnd();

  /// @brief Method ReadObject, addr 0x274dcd0, size 0x358, virtual false, abstract: false, final false
  inline void ReadObject();

  /// @brief Method ReadObjectNull, addr 0x274f3b0, size 0x1f4, virtual false, abstract: false, final false
  inline void ReadObjectNull(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectString, addr 0x274e324, size 0x584, virtual false, abstract: false, final false
  inline void ReadObjectString(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectWithMap, addr 0x274e1f4, size 0xa0, virtual false, abstract: false, final false
  inline void ReadObjectWithMap(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectWithMap, addr 0x27500e4, size 0x40c, virtual false, abstract: false, final false
  inline void ReadObjectWithMap(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap* record);

  /// @brief Method ReadObjectWithMapTyped, addr 0x274e294, size 0x90, virtual false, abstract: false, final false
  inline void ReadObjectWithMapTyped(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum);

  /// @brief Method ReadObjectWithMapTyped, addr 0x27504f0, size 0x42c, virtual false, abstract: false, final false
  inline void ReadObjectWithMapTyped(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped* record);

  /// @brief Method ReadSByte, addr 0x274fd34, size 0x20, virtual false, abstract: false, final false
  inline int8_t ReadSByte();

  /// @brief Method ReadSerializationHeaderRecord, addr 0x274d99c, size 0xc0, virtual false, abstract: false, final false
  inline void ReadSerializationHeaderRecord();

  /// @brief Method ReadSingle, addr 0x274fc80, size 0x24, virtual false, abstract: false, final false
  inline float_t ReadSingle();

  /// @brief Method ReadString, addr 0x274fd54, size 0x24, virtual false, abstract: false, final false
  inline ::StringW ReadString();

  /// @brief Method ReadTimeSpan, addr 0x274fd78, size 0x24, virtual false, abstract: false, final false
  inline ::System::TimeSpan ReadTimeSpan();

  /// @brief Method ReadUInt16, addr 0x274fe18, size 0x24, virtual false, abstract: false, final false
  inline uint16_t ReadUInt16();

  /// @brief Method ReadUInt32, addr 0x274fe3c, size 0x24, virtual false, abstract: false, final false
  inline uint32_t ReadUInt32();

  /// @brief Method ReadUInt64, addr 0x274fe60, size 0x24, virtual false, abstract: false, final false
  inline uint64_t ReadUInt64();

  /// @brief Method ReadValue, addr 0x2750c54, size 0x420, virtual false, abstract: false, final false
  inline ::System::Object* ReadValue(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);

  /// @brief Method Run, addr 0x2747190, size 0x5d4, virtual false, abstract: false, final false
  inline void Run();
  ...
  /// @brief Method .ctor, addr 0x274d5b4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AssemIdToAssemblyTable, addr 0x274d840, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SizedArray* get_AssemIdToAssemblyTable();

  /// @brief Method get_ObjectMapIdTable, addr 0x274d76c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::SizedArray* get_ObjectMapIdTable();

  /// @brief Method get_SystemAssemblyInfo, addr 0x274d6c0, size 0xac, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* get_SystemAssemblyInfo();

  /// @brief Method get_prs, addr 0x274d924, size 0x6c, virtual false, abstract: false, final false
