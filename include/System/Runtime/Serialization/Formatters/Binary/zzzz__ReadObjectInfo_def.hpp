...
public:
  ...
  /// @brief Method AddValue, addr 0x3d0a3e4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x3d09a70, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x3d097c4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMemberInfo, addr 0x3d09f8c, size 0x190, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* GetMemberInfo(::StringW name);

  /// @brief Method GetMemberType, addr 0x3d09e24, size 0x168, virtual false, abstract: false, final false
  inline ::System::Type* GetMemberType(::System::Reflection::MemberInfo* objMember);

  /// @brief Method GetMemberTypes, addr 0x3d0a688, size 0x4f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObjectInfo, addr 0x3d0984c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method GetType, addr 0x3d0a250, size 0x194, virtual false, abstract: false, final false
  inline ::System::Type* GetType(::StringW name);

  /// @brief Method Init, addr 0x3d09b0c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x3d098bc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitDataStore, addr 0x3d0a47c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method InitMemberInfo, addr 0x3d09c30, size 0x1f4, virtual false, abstract: false, final false
  inline void InitMemberInfo();

  /// @brief Method InitNoMembers, addr 0x3d09b5c, size 0x5c, virtual false, abstract: false, final false
  inline void InitNoMembers();

  /// @brief Method InitReadConstructor, addr 0x3d098d8, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method InitSiRead, addr 0x3d09bb8, size 0x78, virtual false, abstract: false, final false
  inline void InitSiRead();

  static inline ::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo* New_ctor();

  /// @brief Method ObjectEnd, addr 0x3d097b8, size 0x4, virtual false, abstract: false, final false
  inline void ObjectEnd();

  /// @brief Method PopulateObjectMembers, addr 0x3d0a5ec, size 0x9c, virtual false, abstract: false, final false
  inline void PopulateObjectMembers(::System::Object* obj, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> memberData);

  /// @brief Method Position, addr 0x3d0a11c, size 0x134, virtual false, abstract: false, final false
  inline int32_t Position(::StringW name);

  /// @brief Method PrepareForReuse, addr 0x3d097bc, size 0x8, virtual false, abstract: false, final false
  inline void PrepareForReuse();

  /// @brief Method RecordFixup, addr 0x3d0a548, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d097b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
