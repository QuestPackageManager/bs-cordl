...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReadObjectInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReadObjectInfo(ReadObjectInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReadObjectInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReadObjectInfo(ReadObjectInfoconst&) = delete;
