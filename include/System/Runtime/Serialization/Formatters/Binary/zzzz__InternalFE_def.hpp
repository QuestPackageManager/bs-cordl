...
public:
  ...
  /// @brief Method .ctor, addr 0x5b6b370, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InternalFE", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InternalFE(InternalFE&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InternalFE", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InternalFE(InternalFEconst&) = delete;
