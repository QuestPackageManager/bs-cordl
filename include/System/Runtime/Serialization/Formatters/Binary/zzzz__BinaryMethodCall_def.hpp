...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinaryMethodCall", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinaryMethodCall(BinaryMethodCall&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinaryMethodCall", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinaryMethodCall(BinaryMethodCallconst&) = delete;
