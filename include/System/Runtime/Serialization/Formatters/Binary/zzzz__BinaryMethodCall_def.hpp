...
public:
  ...
  /// @brief Method Dump, addr 0x2842bc4, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryMethodCall* New_ctor();

  /// @brief Method Write, addr 0x2842a7c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2842bc8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
