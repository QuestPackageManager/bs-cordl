...
public:
  ...
  /// @brief Method Dump, addr 0x59a87d8, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryMethodCall* New_ctor();

  /// @brief Method Write, addr 0x59a86b4, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59a87dc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
