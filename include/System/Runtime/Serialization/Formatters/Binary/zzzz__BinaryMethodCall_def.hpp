...
public:
  ...
  /// @brief Method Dump, addr 0x5a1ac50, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryMethodCall* New_ctor();

  /// @brief Method Write, addr 0x5a1ab2c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1ac54, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
