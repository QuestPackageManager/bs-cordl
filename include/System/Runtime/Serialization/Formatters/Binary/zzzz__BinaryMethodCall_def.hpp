...
public:
  ...
  /// @brief Method Dump, addr 0x3d0e690, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryMethodCall* New_ctor();

  /// @brief Method Write, addr 0x3d0e548, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d0e694, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
