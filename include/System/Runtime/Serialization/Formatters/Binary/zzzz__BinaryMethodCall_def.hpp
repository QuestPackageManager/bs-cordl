...
public:
  ...
  /// @brief Method Dump, addr 0x3d0578c, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryMethodCall* New_ctor();

  /// @brief Method Write, addr 0x3d05644, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d05790, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
