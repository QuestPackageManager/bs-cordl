...
public:
  ...
  /// @brief Method Dump, addr 0x3d00e24, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryAssembly* New_ctor();

  /// @brief Method Read, addr 0x3d00de0, size 0x44, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x3d00d64, size 0xc, virtual false, abstract: false, final false
  inline void Set(int32_t assemId, ::StringW assemblyString);

  /// @brief Method Write, addr 0x3d00d70, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3d00d5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
