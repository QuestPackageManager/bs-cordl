...
public:
  ...
  /// @brief Method Deserialize, addr 0x3d08d94, size 0xc, virtual true, abstract: false, final true
  inline ::System::Object* Deserialize(::System::IO::Stream* serializationStream);

  /// @brief Method Deserialize, addr 0x3d08da0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Deserialize, addr 0x3d08da8, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeInformation, addr 0x3d09298, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x3d08fe4, size 0xc, virtual true, abstract: false, final true
  inline void Serialize(::System::IO::Stream* serializationStream, ::System::Object* graph);

  /// @brief Method Serialize, addr 0x3d08ff0, size 0x8, virtual true, abstract: false, final true
  inline void Serialize(::System::IO::Stream* serializationStream, ::System::Object* graph,
                        ::ArrayW<::System::Runtime::Remoting::Messaging::Header*, ::Array<::System::Runtime::Remoting::Messaging::Header*>*> headers);

  /// @brief Method Serialize, addr 0x3d08ff8, size 0x1f0, virtual false, abstract: false, final false
  inline void Serialize(::System::IO::Stream* serializationStream, ::System::Object* graph,
  ...
  /// @brief Method .ctor, addr 0x3d08d14, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3d08d48, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AssemblyFormat, addr 0x3d08cfc, size 0x8, virtual false, abstract: false, final false
  inline void set_AssemblyFormat(::System::Runtime::Serialization::Formatters::FormatterAssemblyStyle value);

  /// @brief Method set_Binder, addr 0x3d08d0c, size 0x8, virtual true, abstract: false, final true
  inline void set_Binder(::System::Runtime::Serialization::SerializationBinder* value);

  /// @brief Method set_SurrogateSelector, addr 0x3d08d04, size 0x8, virtual true, abstract: false, final true
