...
public:
  ...
  /// @brief Method Deserialize, addr 0x5a1e3f0, size 0xc, virtual true, abstract: false, final true
  inline ::System::Object* Deserialize(::System::IO::Stream* serializationStream);

  /// @brief Method Deserialize, addr 0x5a1e3fc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Deserialize, addr 0x5a1e404, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeInformation, addr 0x5a1e8c4, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x5a1e630, size 0xc, virtual true, abstract: false, final true
  inline void Serialize(::System::IO::Stream* serializationStream, ::System::Object* graph);

  /// @brief Method Serialize, addr 0x5a1e63c, size 0x8, virtual true, abstract: false, final true
  inline void Serialize(::System::IO::Stream* serializationStream, ::System::Object* graph,
                        ::ArrayW<::System::Runtime::Remoting::Messaging::Header*, ::Array<::System::Runtime::Remoting::Messaging::Header*>*> headers);

  /// @brief Method Serialize, addr 0x5a1e644, size 0x1d8, virtual false, abstract: false, final false
  inline void Serialize(::System::IO::Stream* serializationStream, ::System::Object* graph,
  ...
  /// @brief Method .ctor, addr 0x5a1e3ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a1e3d4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AssemblyFormat, addr 0x5a1e394, size 0x8, virtual false, abstract: false, final false
  inline void set_AssemblyFormat(::System::Runtime::Serialization::Formatters::FormatterAssemblyStyle value);

  /// @brief Method set_Binder, addr 0x5a1e3a4, size 0x8, virtual true, abstract: false, final true
  inline void set_Binder(::System::Runtime::Serialization::SerializationBinder* value);

  /// @brief Method set_SurrogateSelector, addr 0x5a1e39c, size 0x8, virtual true, abstract: false, final true
