...
public:
  ...
  /// @brief Method Read, addr 0x5b59088, size 0x2f8, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x5b58e84, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5b58eb0, size 0x1d8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b58e78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b58e7c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinaryObjectWithMapTyped", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinaryObjectWithMapTyped(BinaryObjectWithMapTyped&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinaryObjectWithMapTyped", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinaryObjectWithMapTyped(BinaryObjectWithMapTypedconst&) = delete;
