...
public:
  ...
  /// @brief Method Read, addr 0x273f0d0, size 0x2a4, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x273eecc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x273eef8, size 0x1d8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x273ee9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x273eea4, size 0x28, virtual false, abstract: false, final false
