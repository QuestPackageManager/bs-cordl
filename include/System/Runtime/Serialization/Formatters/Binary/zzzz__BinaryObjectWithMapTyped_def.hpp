...
public:
  ...
  /// @brief Method Read, addr 0x59a90c8, size 0x2f8, virtual true, abstract: false, final true
  inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input);

  /// @brief Method Set, addr 0x59a8ec4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x59a8ef0, size 0x1d8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59a8eb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59a8ebc, size 0x8, virtual false, abstract: false, final false
