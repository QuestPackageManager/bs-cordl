...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BinaryCrossAppDomainAssembly", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BinaryCrossAppDomainAssembly(BinaryCrossAppDomainAssembly&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BinaryCrossAppDomainAssembly", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BinaryCrossAppDomainAssembly(BinaryCrossAppDomainAssemblyconst&) = delete;
