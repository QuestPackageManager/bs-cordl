...
public:
  ...
  /// @brief Method Dump, addr 0x3d00e74, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainAssembly* New_ctor();

  /// @brief Method Read, addr 0x3d00e30, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3d00e28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
