...
public:
  ...
  /// @brief Method Dump, addr 0x5941c84, size 0x4, virtual false, abstract: false, final false
  inline void Dump();

  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainAssembly* New_ctor();

  /// @brief Method Read, addr 0x5941c24, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5941c20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
