...
public:
// Declarations
/// @brief Method GetDataContract, addr 0x5fac494, size 0xa8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::DataContract* GetDataContract(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method Pop, addr 0x5fac484, size 0x10, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method Push, addr 0x5fac378, size 0x10c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "dataContractDictionaries", ty: "::ArrayW<::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Runtime::Serialization::DataContract*>*,::Array<::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Runtime::Serialization::DataContract*>*>*>", modifiers: "", def_value: None }, CppParam { name: "count", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ScopedKnownTypes(::ArrayW<::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Runtime::Serialization::DataContract*>*,::Array<::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Runtime::Serialization::DataContract*>*>*>  dataContractDictionaries, int32_t  count) noexcept;
...
/// @brief Field dataContractDictionaries, offset: 0x0, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Runtime::Serialization::DataContract*>*,::Array<::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Runtime::Serialization::DataContract*>*>*>  dataContractDictionaries;
