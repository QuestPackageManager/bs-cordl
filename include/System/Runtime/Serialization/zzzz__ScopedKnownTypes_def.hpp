...
public:
  // Declarations
  /// @brief Method GetDataContract, addr 0x601e4a0, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* GetDataContract(::System::Xml::XmlQualifiedName* qname);

  /// @brief Method Pop, addr 0x601e490, size 0x10, virtual false, abstract: false, final false
  inline void Pop();

  /// @brief Method Push, addr 0x601e384, size 0x10c, virtual false, abstract: false, final false
