...
public:
  ...
  /// @brief Method .ctor, addr 0x615cac0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  NonNegativeIntegerDataContract(NonNegativeIntegerDataContractconst&) = delete;
