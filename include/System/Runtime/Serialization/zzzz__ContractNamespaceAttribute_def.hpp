...
/// @brief Method get_ClrNamespace, addr 0x5ffe908, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ClrNamespace() ;

/// @brief Method get_ContractNamespace, addr 0x5ffe910, size 0x8, virtual false, abstract: false, final false
