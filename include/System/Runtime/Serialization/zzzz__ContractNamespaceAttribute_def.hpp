...
public:
  ...
  /// @brief Method get_ClrNamespace, addr 0x5ffcd90, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ClrNamespace();

  /// @brief Method get_ContractNamespace, addr 0x5ffcd98, size 0x8, virtual false, abstract: false, final false
