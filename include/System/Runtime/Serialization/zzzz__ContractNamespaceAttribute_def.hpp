...
public:
  ...
  /// @brief Method get_ClrNamespace, addr 0x6139a04, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ClrNamespace();

  /// @brief Method get_ContractNamespace, addr 0x6139a0c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::ContractNamespaceAttribute) == 0x20, "Size mismatch!");
