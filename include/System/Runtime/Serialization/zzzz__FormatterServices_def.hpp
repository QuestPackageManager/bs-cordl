...
public:
  ...
  /// @brief Method <GetSerializableMembers>b__0, addr 0x25a9ff8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25a8bdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckSerializable, addr 0x25a7d8c, size 0x20, virtual false, abstract: false, final false
  static inline bool CheckSerializable(::System::RuntimeType* type);

  /// @brief Method GetClrAssemblyName, addr 0x25a9974, size 0x16c, virtual false, abstract: false, final false
  static inline ::StringW GetClrAssemblyName(::System::Type* type, ByRef<bool> hasTypeForwardedFrom);

  /// @brief Method GetClrTypeFullName, addr 0x25a9ae0, size 0x80, virtual false, abstract: false, final false
  static inline ::StringW GetClrTypeFullName(::System::Type* type);

  /// @brief Method GetClrTypeFullNameForArray, addr 0x25a9b60, size 0x224, virtual false, abstract: false, final false
  static inline ::StringW GetClrTypeFullNameForArray(::System::Type* type);

  /// @brief Method GetClrTypeFullNameForNonArrayTypes, addr 0x25a9d84, size 0x274, virtual false, abstract: false, final false
  static inline ::StringW GetClrTypeFullNameForNonArrayTypes(::System::Type* type);

  /// @brief Method GetEnableUnsafeTypeForwarders, addr 0x25a8db8, size 0x8, virtual false, abstract: false, final false
  static inline bool GetEnableUnsafeTypeForwarders();

  /// @brief Method GetObjectData, addr 0x25a9410, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentTypes, addr 0x25a84ac, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSerializableMembers, addr 0x25a7bf4, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSerializableMembers, addr 0x25a8944, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeFromAssembly, addr 0x25a97fc, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Type* GetTypeFromAssembly(::System::Reflection::Assembly* assem, ::StringW name);

  /// @brief Method GetUninitializedObject, addr 0x25a8be4, size 0x1cc, virtual false, abstract: false, final false
  static inline ::System::Object* GetUninitializedObject(::System::Type* type);

  /// @brief Method InternalGetSerializableMembers, addr 0x25a7dac, size 0x700, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAssemblyFromString, addr 0x25a9898, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Reflection::Assembly* LoadAssemblyFromString(::StringW assemblyName);

  /// @brief Method LoadAssemblyFromStringNoThrow, addr 0x25a98a0, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Reflection::Assembly* LoadAssemblyFromStringNoThrow(::StringW assemblyName);

  /// @brief Method PopulateObjectMembers, addr 0x25a90fc, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializationSetValue, addr 0x25a8e68, size 0x1e4, virtual false, abstract: false, final false
  static inline void SerializationSetValue(::System::Reflection::MemberInfo* fi, ::System::Object* target, ::System::Object* value);

  /// @brief Method UnsafeTypeForwardersIsEnabled, addr 0x25a8dc0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method nativeGetUninitializedObject, addr 0x25a8db0, size 0x8, virtual false, abstract: false, final false
