...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x6159000, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x6158f78, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6158e00, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6158e68, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x6158f34, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x6158ef0, size 0x44, virtual true, abstract: false, final false
