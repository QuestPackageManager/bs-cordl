...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TimeSpanDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TimeSpanDataContract(TimeSpanDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TimeSpanDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TimeSpanDataContract(TimeSpanDataContractconst&) = delete;
