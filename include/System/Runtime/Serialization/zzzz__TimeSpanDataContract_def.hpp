...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x5f42134, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x5f420ac, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f41f34, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f41f9c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x5f42068, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x5f42024, size 0x44, virtual true, abstract: false, final false
