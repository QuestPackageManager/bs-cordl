...
public:
  ...
  /// @brief Method GetDataContract, addr 0x614c490, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeserializeType, addr 0x614c938, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* GetDeserializeType();

  /// @brief Method GetSerializeType, addr 0x614c920, size 0x18, virtual true, abstract: false, final false
  inline ::System::Type* GetSerializeType(::System::Object* graph);

  /// @brief Method GetSurrogatedType, addr 0x614bb40, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x614b620, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalIsStartObject, addr 0x614c8ec, size 0x34, virtual true, abstract: false, final false
  inline bool InternalIsStartObject(::System::Runtime::Serialization::XmlReaderDelegator* reader);

  /// @brief Method InternalReadObject, addr 0x614c57c, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* InternalReadObject(::System::Runtime::Serialization::XmlReaderDelegator* xmlReader, bool verifyObjectName);

  /// @brief Method InternalReadObject, addr 0x614c590, size 0x35c, virtual true, abstract: false, final false
  inline ::System::Object* InternalReadObject(::System::Runtime::Serialization::XmlReaderDelegator* xmlReader, bool verifyObjectName,
                                              ::System::Runtime::Serialization::DataContractResolver* dataContractResolver);

  /// @brief Method InternalWriteEndObject, addr 0x614c528, size 0x54, virtual true, abstract: false, final false
  inline void InternalWriteEndObject(::System::Runtime::Serialization::XmlWriterDelegator* writer);

  /// @brief Method InternalWriteObject, addr 0x614bb64, size 0x14, virtual true, abstract: false, final false
  inline void InternalWriteObject(::System::Runtime::Serialization::XmlWriterDelegator* writer, ::System::Object* graph);

  /// @brief Method InternalWriteObject, addr 0x614bb78, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method InternalWriteObjectContent, addr 0x614c3d4, size 0x8, virtual true, abstract: false, final false
  inline void InternalWriteObjectContent(::System::Runtime::Serialization::XmlWriterDelegator* writer, ::System::Object* graph);

  /// @brief Method InternalWriteObjectContent, addr 0x614bbdc, size 0x3f0, virtual false, abstract: false, final false
  inline void InternalWriteObjectContent(::System::Runtime::Serialization::XmlWriterDelegator* writer, ::System::Object* graph,
                                         ::System::Runtime::Serialization::DataContractResolver* dataContractResolver);

  /// @brief Method InternalWriteStartObject, addr 0x614c39c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadObject, addr 0x614c320, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Object* ReadObject(::System::Xml::XmlDictionaryReader* reader, bool verifyObjectName);

  /// @brief Method ReadObject, addr 0x614c2a4, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Object* ReadObject(::System::Xml::XmlReader* reader, bool verifyObjectName);

  /// @brief Method SurrogateToDataContractType, addr 0x614c3dc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEndObject, addr 0x614c230, size 0x74, virtual true, abstract: false, final false
  inline void WriteEndObject(::System::Xml::XmlDictionaryWriter* writer);

  /// @brief Method WriteEndObject, addr 0x614c0c4, size 0x74, virtual true, abstract: false, final false
  inline void WriteEndObject(::System::Xml::XmlWriter* writer);

  /// @brief Method WriteObjectContent, addr 0x614c1b4, size 0x7c, virtual true, abstract: false, final false
  inline void WriteObjectContent(::System::Xml::XmlDictionaryWriter* writer, ::System::Object* graph);

  /// @brief Method WriteObjectContent, addr 0x614c048, size 0x7c, virtual true, abstract: false, final false
  inline void WriteObjectContent(::System::Xml::XmlWriter* writer, ::System::Object* graph);

  /// @brief Method WriteStartObject, addr 0x614c138, size 0x7c, virtual true, abstract: false, final false
  inline void WriteStartObject(::System::Xml::XmlDictionaryWriter* writer, ::System::Object* graph);

  /// @brief Method WriteStartObject, addr 0x614bfcc, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x614b580, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x614b5b4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::System::Collections::Generic::IEnumerable_1<::System::Type*>* knownTypes);

  /// @brief Method .ctor, addr 0x614b5e4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x614b604, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::System::Collections::Generic::IEnumerable_1<::System::Type*>* knownTypes, int32_t maxItemsInObjectGraph, bool ignoreExtensionDataObject,
                    bool preserveObjectReferences, ::System::Runtime::Serialization::IDataContractSurrogate* dataContractSurrogate,
                    ::System::Runtime::Serialization::DataContractResolver* dataContractResolver);

  /// @brief Method get_DataContractResolver, addr 0x614bac4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContractResolver* get_DataContractResolver();

  /// @brief Method get_DataContractSurrogate, addr 0x614baac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::IDataContractSurrogate* get_DataContractSurrogate();

  /// @brief Method get_IgnoreExtensionDataObject, addr 0x614babc, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreExtensionDataObject();

  /// @brief Method get_KnownDataContracts, addr 0x614ba78, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method get_MaxItemsInObjectGraph, addr 0x614baa4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxItemsInObjectGraph();

  /// @brief Method get_PreserveObjectReferences, addr 0x614bab4, size 0x8, virtual false, abstract: false, final false
  inline bool get_PreserveObjectReferences();

  /// @brief Method get_RootContract, addr 0x614bad4, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* get_RootContract();

  /// @brief Method get_SerializeReadOnlyTypes, addr 0x614bacc, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataContractSerializer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataContractSerializer(DataContractSerializer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataContractSerializer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataContractSerializer(DataContractSerializerconst&) = delete;
