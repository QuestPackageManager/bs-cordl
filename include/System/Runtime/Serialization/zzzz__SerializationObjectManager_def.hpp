...
public:
  ...
  /// @brief Method AddOnSerialized, addr 0x3cf4e84, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method RaiseOnSerializedEvent, addr 0x3cf4f14, size 0x20, virtual false, abstract: false, final false
  inline void RaiseOnSerializedEvent();

  /// @brief Method RegisterObject, addr 0x3cf4d74, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cf4ce0, size 0x94, virtual false, abstract: false, final false
