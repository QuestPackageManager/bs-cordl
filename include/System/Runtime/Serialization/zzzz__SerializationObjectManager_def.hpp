...
public:
  ...
  /// @brief Method AddOnSerialized, addr 0x5a0f61c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method RaiseOnSerializedEvent, addr 0x5a0f6b8, size 0x24, virtual false, abstract: false, final false
  inline void RaiseOnSerializedEvent();

  /// @brief Method RegisterObject, addr 0x5a0f4f8, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0f44c, size 0xac, virtual false, abstract: false, final false
