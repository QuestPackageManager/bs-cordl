...
public:
  ...
  /// @brief Method .ctor, addr 0x6006504, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method get_Value, addr 0x6009094, size 0x8, virtual false, abstract: false, final false
