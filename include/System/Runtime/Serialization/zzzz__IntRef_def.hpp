...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::IntRef*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::IntRef*, "System.Runtime.Serialization", "IntRef");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6148990, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method get_Value, addr 0x614b520, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IntRef", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IntRef(IntRef&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IntRef", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IntRef(IntRefconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::IntRef) == 0x18, "Size mismatch!");
