...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FixupHolder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FixupHolder(FixupHolder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FixupHolder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FixupHolder(FixupHolderconst&) = delete;
