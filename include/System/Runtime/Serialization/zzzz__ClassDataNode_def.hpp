...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClassDataNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClassDataNode(ClassDataNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClassDataNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClassDataNode(ClassDataNodeconst&) = delete;
