...
public:
  ...
  /// @brief Method Clear, addr 0x600e214, size 0x48, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method .ctor, addr 0x600e088, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Members, addr 0x600e204, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::System::Runtime::Serialization::ExtensionDataMember*>* get_Members();

  /// @brief Method set_Members, addr 0x600e20c, size 0x8, virtual false, abstract: false, final false
