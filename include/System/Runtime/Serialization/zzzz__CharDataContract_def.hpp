...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x615b744, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615b6e8, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615b594, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x615b5fc, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x615b6a4, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x615b660, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  CharDataContract(CharDataContractconst&) = delete;
