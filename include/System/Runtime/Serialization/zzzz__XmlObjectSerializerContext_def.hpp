...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlObjectSerializerContext", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlObjectSerializerContext(XmlObjectSerializerContext&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlObjectSerializerContext", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlObjectSerializerContext(XmlObjectSerializerContextconst&) = delete;
