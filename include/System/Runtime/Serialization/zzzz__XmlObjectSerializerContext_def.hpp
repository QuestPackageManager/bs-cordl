...
public:
  ...
  /// @brief Method CheckIfTypeSerializable, addr 0x5f4a360, size 0x9c, virtual true, abstract: false, final false
  inline void CheckIfTypeSerializable(::System::Type* memberType, bool isMemberTypeSerializable);

  /// @brief Method DemandMemberAccessPermission, addr 0x5f49f7c, size 0x4, virtual false, abstract: false, final false
  inline void DemandMemberAccessPermission();

  /// @brief Method DemandSerializationFormatterPermission, addr 0x5f49f78, size 0x4, virtual false, abstract: false, final false
  inline void DemandSerializationFormatterPermission();

  /// @brief Method GetDataContract, addr 0x5f4a2e4, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* GetDataContract(int32_t id, ::System::RuntimeTypeHandle typeHandle);

  /// @brief Method GetDataContract, addr 0x5f4a194, size 0x4c, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* GetDataContract(::System::Type* type);

  /// @brief Method GetDataContract, addr 0x5f4a1e0, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* GetDataContract(::System::RuntimeTypeHandle typeHandle, ::System::Type* type);

  /// @brief Method GetDataContractFromSerializerKnownTypes, addr 0x5f4a448, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDataContractSkipValidation, addr 0x5f4a284, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDataContractsForKnownTypes, addr 0x5f4a4c4, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStreamingContext, addr 0x5f49f80, size 0xc, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::StreamingContext GetStreamingContext();

  /// @brief Method GetSurrogatedType, addr 0x5f4a3fc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* GetSurrogatedType(::System::Type* type);

  /// @brief Method IncrementItemCount, addr 0x5f4a060, size 0xbc, virtual false, abstract: false, final false
  inline void IncrementItemCount(int32_t count);

  /// @brief Method IsKnownType, addr 0x5f4a7bc, size 0x78, virtual false, abstract: false, final false
  inline bool IsKnownType(::System::Runtime::Serialization::DataContract* dataContract, ::System::Type* declaredType);

  /// @brief Method IsKnownType, addr 0x5f3b8b4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveDataContractFromDataContractResolver, addr 0x5f4a9c4, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveDataContractFromKnownTypes, addr 0x5f4a834, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveDataContractFromKnownTypes, addr 0x5f4a970, size 0x54, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* ResolveDataContractFromKnownTypes(::System::Xml::XmlQualifiedName* typeName);

  /// @brief Method ResolveDataContractFromRootDataContract, addr 0x5f4ab04, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveNameFromKnownTypes, addr 0x5f3b9b0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f49eec, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f49f2c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::NetDataContractSerializer* serializer);

  /// @brief Method .ctor, addr 0x5f49ed0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f49eb4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::XmlObjectSerializer* serializer, int32_t maxItemsInObjectGraph, ::System::Runtime::Serialization::StreamingContext streamingContext,
  ...
  /// @brief Method get_DataContractResolver, addr 0x5f4a130, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContractResolver* get_DataContractResolver();

  /// @brief Method get_IgnoreExtensionDataObject, addr 0x5f4a128, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreExtensionDataObject();

  /// @brief Method get_IncrementItemCountMethod, addr 0x5f49f8c, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodInfo* get_IncrementItemCountMethod();

  /// @brief Method get_IsGetOnlyCollection, addr 0x5f49f6c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsGetOnlyCollection();

  /// @brief Method get_KnownTypeResolver, addr 0x5f4a138, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::KnownTypeDataContractResolver* get_KnownTypeResolver();

  /// @brief Method get_Mode, addr 0x5f49f64, size 0x8, virtual true, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationMode get_Mode();

  /// @brief Method get_RemainingItemCount, addr 0x5f4a11c, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_RemainingItemCount();

  /// @brief Method get_SerializerKnownDataContracts, addr 0x5f4a404, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsGetOnlyCollection, addr 0x5f49f74, size 0x4, virtual true, abstract: false, final false
