...
// Write type traits
MARK_REF_PTR_T(::System::Runtime::Serialization::TypeInformation);
// Dependencies System.Object
namespace System::Runtime::Serialization {
// Is value type: false
// CS Name: System.Runtime.Serialization.TypeInformation
...
static inline ::System::Runtime::Serialization::TypeInformation* New_ctor(::StringW  fullTypeName, ::StringW  assemblyString, bool  hasTypeForwardedFrom) ;
...
/// @brief Method .ctor, addr 0x6018f60, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  fullTypeName, ::StringW  assemblyString, bool  hasTypeForwardedFrom) ;

/// @brief Method get_AssemblyString, addr 0x6021134, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AssemblyString() ;

/// @brief Method get_FullTypeName, addr 0x602112c, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::System::Runtime::Serialization::TypeInformation, ___fullTypeName) == 0x10, "Offset mismatch!");

static_assert(offsetof(::System::Runtime::Serialization::TypeInformation, ___assemblyString) == 0x18, "Offset mismatch!");

static_assert(offsetof(::System::Runtime::Serialization::TypeInformation, ___hasTypeForwardedFrom) == 0x20, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::System::Runtime::Serialization::TypeInformation, 0x28>, "Size mismatch!");

} // namespace end def System::Runtime::Serialization
NEED_NO_BOX(::System::Runtime::Serialization::TypeInformation);
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Serialization::TypeInformation*, "System.Runtime.Serialization", "TypeInformation");
