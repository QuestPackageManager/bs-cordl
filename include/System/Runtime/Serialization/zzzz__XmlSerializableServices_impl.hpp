...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::System::Xml::XmlNode*,::Array<::System::Xml::XmlNode*>*> (*)(::System::Xml::XmlReader*)>(&::System::Runtime::Serialization::XmlSerializableServices::ReadNodes)> {
  constexpr static std::size_t size = 0x324;
  constexpr static std::size_t addrs = 0x5fc3f0c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::System::Xml::XmlReader*)>(&::System::Runtime::Serialization::XmlSerializableServices::IsValidAttribute)> {
  ...
  constexpr static std::size_t addrs = 0x5fc4290;
...
::cordl_internals::setStaticField<::StringW, "ReadNodesMethodName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::Serialization::XmlSerializableServices*>::get>(std::forward<::StringW>(value));
}
...
::cordl_internals::setStaticField<::StringW, "WriteNodesMethodName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::Serialization::XmlSerializableServices*>::get>(std::forward<::StringW>(value));
}
inline ::StringW System::Runtime::Serialization::XmlSerializableServices::getStaticF_WriteNodesMethodName()  {
return ::cordl_internals::getStaticField<::StringW, "WriteNodesMethodName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::Serialization::XmlSerializableServices*>::get>();
}
inline void System::Runtime::Serialization::XmlSerializableServices::setStaticF_AddDefaultSchemaMethodName(::StringW  value)  {
::cordl_internals::setStaticField<::StringW, "AddDefaultSchemaMethodName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::Serialization::XmlSerializableServices*>::get>(std::forward<::StringW>(value));
}
inline ::StringW System::Runtime::Serialization::XmlSerializableServices::getStaticF_AddDefaultSchemaMethodName()  {
return ::cordl_internals::getStaticField<::StringW, "AddDefaultSchemaMethodName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::Serialization::XmlSerializableServices*>::get>();
}
