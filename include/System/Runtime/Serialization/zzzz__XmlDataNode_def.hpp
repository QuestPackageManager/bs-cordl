...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlDataNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlDataNode(XmlDataNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlDataNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlDataNode(XmlDataNodeconst&) = delete;
