...
public:
  ...
  /// @brief Method Equals, addr 0x6009048, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::System::Runtime::Serialization::TypeHandleRef* x, ::System::Runtime::Serialization::TypeHandleRef* y);

  /// @brief Method GetHashCode, addr 0x6009070, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x60058d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
