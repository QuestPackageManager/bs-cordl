...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TypeHandleRefEqualityComparer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TypeHandleRefEqualityComparer(TypeHandleRefEqualityComparer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TypeHandleRefEqualityComparer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TypeHandleRefEqualityComparer(TypeHandleRefEqualityComparerconst&) = delete;
