...
public:
  ...
  /// @brief Method Equals, addr 0x6145cbc, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::System::Runtime::Serialization::TypeHandleRef* x, ::System::Runtime::Serialization::TypeHandleRef* y);

  /// @brief Method GetHashCode, addr 0x6145ce4, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x614254c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
