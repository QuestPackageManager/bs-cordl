...
/// @brief Method get_MethodName, addr 0x5fa39cc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_MethodName() ;

/// @brief Method get_Type, addr 0x5fa39d4, size 0x8, virtual false, abstract: false, final false
