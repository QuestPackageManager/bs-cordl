...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ISerializableDataMember*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ISerializableDataMember*, "System.Runtime.Serialization", "ISerializableDataMember");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ISerializableDataMember", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ISerializableDataMember(ISerializableDataMember&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ISerializableDataMember", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISerializableDataMember(ISerializableDataMemberconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::ISerializableDataMember) == 0x20, "Size mismatch!");
