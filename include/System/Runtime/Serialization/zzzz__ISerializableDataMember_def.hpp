...
public:
  ...
  /// @brief Method .ctor, addr 0x600eb5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Name, addr 0x600eb3c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x600eb4c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::IDataNode* get_Value();

  /// @brief Method set_Name, addr 0x600eb44, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Value, addr 0x600eb54, size 0x8, virtual false, abstract: false, final false
