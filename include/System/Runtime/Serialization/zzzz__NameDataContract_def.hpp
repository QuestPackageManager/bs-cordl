...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::NameDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::NameDataContract*, "System.Runtime.Serialization", "NameDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x615dd14, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NameDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NameDataContract(NameDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NameDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NameDataContract(NameDataContractconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::NameDataContract) == 0x30, "Size mismatch!");
