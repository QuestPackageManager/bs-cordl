...
public:
  ...
  /// @brief Method ComputeStartPosition, addr 0x6018344, size 0x34, virtual false, abstract: false, final false
  inline int32_t ComputeStartPosition(::System::Object* o);

  /// @brief Method FindElement, addr 0x6017cf8, size 0xd0, virtual false, abstract: false, final false
  inline int32_t FindElement(::System::Object* obj, ::ByRef<bool> isEmpty, ::ByRef<bool> isWrapped);

  /// @brief Method GetId, addr 0x6017bb8, size 0x140, virtual false, abstract: false, final false
  inline int32_t GetId(::System::Object* obj, ::ByRef<bool> newId);

  /// @brief Method GetPrime, addr 0x6017ab4, size 0x104, virtual false, abstract: false, final false
  static inline int32_t GetPrime(int32_t min);

  /// @brief Method IsPrime, addr 0x6018378, size 0xa8, virtual false, abstract: false, final false
  static inline bool IsPrime(int32_t candidate);

  static inline ::System::Runtime::Serialization::ObjectToIdCache* New_ctor();

  /// @brief Method ReassignId, addr 0x6017fd0, size 0x160, virtual false, abstract: false, final false
  inline int32_t ReassignId(int32_t oldObjId, ::System::Object* oldObj, ::System::Object* newObj);

  /// @brief Method Rehash, addr 0x6017dc8, size 0x208, virtual false, abstract: false, final false
  inline void Rehash();

  /// @brief Method RemoveAt, addr 0x6018130, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60179c0, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();
