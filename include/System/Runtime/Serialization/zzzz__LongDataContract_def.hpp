...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x601a408, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x601a3b4, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x601a260, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x601a2c8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x601a370, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x601a32c, size 0x44, virtual true, abstract: false, final false
