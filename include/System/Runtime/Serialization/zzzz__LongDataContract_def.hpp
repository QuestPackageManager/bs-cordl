...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::LongDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::LongDataContract*, "System.Runtime.Serialization", "LongDataContract");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LongDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LongDataContract(LongDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LongDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LongDataContract(LongDataContractconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::LongDataContract) == 0x30, "Size mismatch!");
