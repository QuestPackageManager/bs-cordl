...
public:
  ...
  /// @brief Method MoveNext, addr 0x3d083a8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d09440, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::ObjectHolderList* list, bool isFixupEnumerator);

  /// @brief Method get_Current, addr 0x3d08350, size 0x3c, virtual false, abstract: false, final false
