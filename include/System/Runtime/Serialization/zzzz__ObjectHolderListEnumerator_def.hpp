...
public:
  ...
  /// @brief Method MoveNext, addr 0x5a1532c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a163ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::ObjectHolderList* list, bool isFixupEnumerator);

  /// @brief Method get_Current, addr 0x5a152d8, size 0x3c, virtual false, abstract: false, final false
