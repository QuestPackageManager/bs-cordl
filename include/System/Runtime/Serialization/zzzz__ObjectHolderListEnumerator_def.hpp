...
public:
  ...
  /// @brief Method MoveNext, addr 0x59a2eb4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Current, addr 0x59a2e60, size 0x3c, virtual false, abstract: false, final false
