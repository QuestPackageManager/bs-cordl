...
public:
  ...
  /// @brief Method .ctor, addr 0x6018580, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_XmlFormatContentWriterMethod, addr 0x60190e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_XmlFormatContentWriterMethod();

  /// @brief Method get_XmlFormatReaderMethod, addr 0x60190f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_XmlFormatReaderMethod();

  /// @brief Method get_XmlFormatWriterMethod, addr 0x60190d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_XmlFormatWriterMethod();

  /// @brief Method set_XmlFormatContentWriterMethod, addr 0x60190f0, size 0x8, virtual false, abstract: false, final false
  inline void set_XmlFormatContentWriterMethod(::System::Reflection::MethodInfo* value);

  /// @brief Method set_XmlFormatReaderMethod, addr 0x6019100, size 0x8, virtual false, abstract: false, final false
  inline void set_XmlFormatReaderMethod(::System::Reflection::MethodInfo* value);

  /// @brief Method set_XmlFormatWriterMethod, addr 0x60190e0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x6018fc4, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPrimitiveDataContract, addr 0x6018698, size 0x98, virtual false, abstract: false, final false
  static inline ::System::Runtime::Serialization::PrimitiveDataContract* GetPrimitiveDataContract(::StringW name, ::StringW ns);

  /// @brief Method GetPrimitiveDataContract, addr 0x6018610, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Runtime::Serialization::PrimitiveDataContract* GetPrimitiveDataContract(::System::Type* type);

  /// @brief Method HandleReadValue, addr 0x6018e30, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method TryReadNullAtTopLevel, addr 0x6018e70, size 0x154, virtual false, abstract: false, final false
  inline bool TryReadNullAtTopLevel(::System::Runtime::Serialization::XmlReaderDelegator* reader);

  /// @brief Method WriteXmlValue, addr 0x6018e14, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60184b8, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_CanContainReferences, addr 0x601878c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanContainReferences();

  /// @brief Method get_IsBuiltInDataContract, addr 0x601879c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsBuiltInDataContract();

  /// @brief Method get_IsPrimitive, addr 0x6018794, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_TopLevelElementNamespace, addr 0x6018730, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method get_XmlFormatContentWriterMethod, addr 0x6018afc, size 0x25c, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_XmlFormatContentWriterMethod();

  /// @brief Method get_XmlFormatReaderMethod, addr 0x6018d58, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_XmlFormatReaderMethod();

  /// @brief Method get_XmlFormatWriterMethod, addr 0x60187a4, size 0x358, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_XmlFormatWriterMethod();
