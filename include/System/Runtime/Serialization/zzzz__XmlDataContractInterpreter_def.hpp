...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlDataContractInterpreter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlDataContractInterpreter(XmlDataContractInterpreter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlDataContractInterpreter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlDataContractInterpreter(XmlDataContractInterpreterconst&) = delete;
