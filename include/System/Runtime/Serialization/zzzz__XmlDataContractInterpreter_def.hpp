...
public:
  ...
  /// @brief Method CreateXmlSerializable, addr 0x6177820, size 0x138, virtual false, abstract: false, final false
  inline ::System::Xml::Serialization::IXmlSerializable* CreateXmlSerializable();

  /// @brief Method GetConstructor, addr 0x6177958, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6177818, size 0x8, virtual false, abstract: false, final false
