...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValueTypeFixupInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValueTypeFixupInfo(ValueTypeFixupInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValueTypeFixupInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValueTypeFixupInfo(ValueTypeFixupInfoconst&) = delete;
