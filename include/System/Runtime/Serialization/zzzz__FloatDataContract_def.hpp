...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::FloatDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::FloatDataContract*, "System.Runtime.Serialization", "FloatDataContract");
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x61576a0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615764c, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6157528, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x6157608, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x61575c4, size 0x44, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::FloatDataContract) == 0x30, "Size mismatch!");
