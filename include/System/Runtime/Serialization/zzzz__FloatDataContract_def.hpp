...
/// @brief Method ReadXmlValue, addr 0x601c5a4, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method WriteXmlValue, addr 0x601c550, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x601c42c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ReadMethodName, addr 0x601c50c, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_ReadMethodName() ;

/// @brief Method get_WriteMethodName, addr 0x601c4c8, size 0x44, virtual true, abstract: false, final false
