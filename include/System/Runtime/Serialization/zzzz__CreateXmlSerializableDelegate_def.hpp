...
public:
// Declarations
/// @brief Method Invoke, addr 0x5fad620, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fad5b8, size 0x68, virtual false, abstract: false, final false
