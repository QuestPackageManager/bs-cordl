...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CreateXmlSerializableDelegate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CreateXmlSerializableDelegate(CreateXmlSerializableDelegate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CreateXmlSerializableDelegate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CreateXmlSerializableDelegate(CreateXmlSerializableDelegateconst&) = delete;
