...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::FixupHolderList*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::FixupHolderList*, "System.Runtime.Serialization", "FixupHolderList");
// Dependencies System.Object, System.Runtime.Serialization.FixupHolder
namespace System::Runtime::Serialization {
// Is value type: false
...
public:
  ...
  /// @brief Method Add, addr 0x5b51860, size 0xa8, virtual true, abstract: false, final false
  inline void Add(::System::Runtime::Serialization::FixupHolder* fixup);

  /// @brief Method EnlargeArray, addr 0x5b51908, size 0x8c, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::System::Runtime::Serialization::FixupHolder*> const& __cordl_internal_get_m_values() const;

  constexpr ::ArrayW<::System::Runtime::Serialization::FixupHolder*>& __cordl_internal_get_m_values();
  ...
  /// @brief Method .ctor, addr 0x5b516f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b517fc, size 0x64, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::System::Runtime::Serialization::FixupHolder*> ___m_values;
...
static_assert(sizeof(::System::Runtime::Serialization::FixupHolderList) == 0x20, "Size mismatch!");
