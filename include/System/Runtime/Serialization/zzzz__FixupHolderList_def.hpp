...
public:
  ...
  /// @brief Method Add, addr 0x3d001a8, size 0xa8, virtual true, abstract: false, final false
  inline void Add(::System::Runtime::Serialization::FixupHolder* fixup);

  /// @brief Method EnlargeArray, addr 0x3d00250, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d00030, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3d0013c, size 0x6c, virtual false, abstract: false, final false
