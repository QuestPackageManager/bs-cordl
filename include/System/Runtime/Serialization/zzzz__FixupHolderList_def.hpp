...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FixupHolderList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FixupHolderList(FixupHolderList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FixupHolderList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FixupHolderList(FixupHolderListconst&) = delete;
