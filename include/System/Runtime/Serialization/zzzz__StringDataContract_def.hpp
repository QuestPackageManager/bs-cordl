...
// Write type traits
MARK_REF_PTR_T(::System::Runtime::Serialization::StringDataContract);
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x5fa8cd0, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x5fa8c7c, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fa8b28, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5fa8b90, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x5fa8c38, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x5fa8bf4, size 0x44, virtual true, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::System::Runtime::Serialization::StringDataContract, 0x30>, "Size mismatch!");

} // namespace System::Runtime::Serialization
NEED_NO_BOX(::System::Runtime::Serialization::StringDataContract);
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Serialization::StringDataContract*, "System.Runtime.Serialization", "StringDataContract");
