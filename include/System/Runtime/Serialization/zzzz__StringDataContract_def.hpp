...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x615d828, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615d7d4, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615d680, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x615d6e8, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x615d790, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x615d74c, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  StringDataContract(StringDataContractconst&) = delete;
