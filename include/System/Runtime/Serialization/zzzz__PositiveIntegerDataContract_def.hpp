...
public:
  ...
  /// @brief Method .ctor, addr 0x615c988, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PositiveIntegerDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PositiveIntegerDataContract(PositiveIntegerDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PositiveIntegerDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PositiveIntegerDataContract(PositiveIntegerDataContractconst&) = delete;
