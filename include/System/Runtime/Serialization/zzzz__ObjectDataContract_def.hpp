...
/// @brief Method ReadXmlValue, addr 0x5fa9f28, size 0x1cc, virtual true, abstract: false, final false
...
/// @brief Method WriteXmlValue, addr 0x5fa9f24, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fa9e00, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CanContainReferences, addr 0x5faa170, size 0x8, virtual true, abstract: false, final false
inline bool get_CanContainReferences() ;

/// @brief Method get_IsPrimitive, addr 0x5faa178, size 0x8, virtual true, abstract: false, final false
inline bool get_IsPrimitive() ;

/// @brief Method get_ReadMethodName, addr 0x5fa9ee0, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_ReadMethodName() ;

/// @brief Method get_WriteMethodName, addr 0x5fa9e9c, size 0x44, virtual true, abstract: false, final false
