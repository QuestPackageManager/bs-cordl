...
public:
  ...
  /// @brief Method .ctor, addr 0x615dfec, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NMTOKENDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NMTOKENDataContract(NMTOKENDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NMTOKENDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NMTOKENDataContract(NMTOKENDataContractconst&) = delete;
