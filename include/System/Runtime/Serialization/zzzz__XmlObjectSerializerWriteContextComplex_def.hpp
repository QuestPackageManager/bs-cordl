...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::XmlObjectSerializerWriteContextComplex*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::XmlObjectSerializerWriteContextComplex*, "System.Runtime.Serialization", "XmlObjectSerializerWriteContextComplex");
...
public:
  ...
  /// @brief Method CheckIfTypeSerializable, addr 0x6172ae8, size 0x140, virtual true, abstract: false, final false
  inline void CheckIfTypeSerializable(::System::Type* memberType, bool isMemberTypeSerializable);

  /// @brief Method CheckIfTypeSerializableForSharedTypeMode, addr 0x6172a14, size 0xd4, virtual false, abstract: false, final false
  inline bool CheckIfTypeSerializableForSharedTypeMode(::System::Type* memberType);

  /// @brief Method GetDataContract, addr 0x61718ec, size 0x1ac, virtual true, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* GetDataContract(int32_t id, ::System::RuntimeTypeHandle typeHandle);

  /// @brief Method GetDataContract, addr 0x6171740, size 0x1ac, virtual true, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* GetDataContract(::System::RuntimeTypeHandle typeHandle, ::System::Type* type);

  /// @brief Method GetDataContractSkipValidation, addr 0x6171a98, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetSurrogatedType, addr 0x6172c28, size 0x120, virtual true, abstract: false, final false
  inline ::System::Type* GetSurrogatedType(::System::Type* type);

  /// @brief Method InternalSerialize, addr 0x61724b4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method InternalSerializeWithSurrogate, addr 0x61724d4, size 0x33c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEndHandleReference, addr 0x61729ac, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method OnHandleReference, addr 0x6172810, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAnyType, addr 0x6171e18, size 0x54, virtual true, abstract: false, final false
  inline void WriteAnyType(::System::Runtime::Serialization::XmlWriterDelegator* xmlWriter, ::System::Object* value);

  /// @brief Method WriteArraySize, addr 0x6172d48, size 0xc0, virtual true, abstract: false, final false
  inline void WriteArraySize(::System::Runtime::Serialization::XmlWriterDelegator* xmlWriter, int32_t size);

  /// @brief Method WriteBase64, addr 0x6171fbc, size 0x58, virtual true, abstract: false, final false
  inline void WriteBase64(::System::Runtime::Serialization::XmlWriterDelegator* xmlWriter, ::ArrayW<uint8_t> value);

  /// @brief Method WriteBase64, addr 0x6172014, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteClrTypeInfo, addr 0x6171c4c, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteClrTypeInfo, addr 0x6171cd8, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteClrTypeInfo, addr 0x6171d7c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteQName, addr 0x61722c8, size 0x5c, virtual true, abstract: false, final false
  inline void WriteQName(::System::Runtime::Serialization::XmlWriterDelegator* xmlWriter, ::System::Xml::XmlQualifiedName* value);

  /// @brief Method WriteQName, addr 0x6172324, size 0x190, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteString, addr 0x6171e6c, size 0x60, virtual true, abstract: false, final false
  inline void WriteString(::System::Runtime::Serialization::XmlWriterDelegator* xmlWriter, ::StringW value);

  /// @brief Method WriteString, addr 0x6171ecc, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteUri, addr 0x6172130, size 0x54, virtual true, abstract: false, final false
  inline void WriteUri(::System::Runtime::Serialization::XmlWriterDelegator* xmlWriter, ::System::Uri* value);

  /// @brief Method WriteUri, addr 0x6172184, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x616dc74, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x616dd1c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Mode, addr 0x6171738, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlObjectSerializerWriteContextComplex", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlObjectSerializerWriteContextComplex(XmlObjectSerializerWriteContextComplex&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlObjectSerializerWriteContextComplex", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlObjectSerializerWriteContextComplex(XmlObjectSerializerWriteContextComplexconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::XmlObjectSerializerWriteContextComplex) == 0xf0, "Size mismatch!");
