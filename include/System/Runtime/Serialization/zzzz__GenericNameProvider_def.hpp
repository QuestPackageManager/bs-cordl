...
public:
  ...
  /// @brief Method GetGenericTypeName, addr 0x5f2ec70, size 0x8, virtual true, abstract: false, final true
  inline ::StringW GetGenericTypeName();

  /// @brief Method GetNamespaces, addr 0x5f2eb8c, size 0xe4, virtual true, abstract: false, final true
  inline ::StringW GetNamespaces();

  /// @brief Method GetNestedParameterCounts, addr 0x5f2e990, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<int32_t>* GetNestedParameterCounts();

  /// @brief Method GetParameterCount, addr 0x5f2e978, size 0x18, virtual true, abstract: false, final true
  inline int32_t GetParameterCount();

  /// @brief Method GetParameterName, addr 0x5f2e998, size 0x1c, virtual true, abstract: false, final true
  inline ::StringW GetParameterName(int32_t paramIndex);

  /// @brief Method GetStableName, addr 0x5f2e9b4, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f2e8c8, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::StringW genericTypeName, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> genericParams);

  /// @brief Method .ctor, addr 0x5f295e0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_ParametersFromBuiltInNamespaces, addr 0x5f2ec78, size 0x64, virtual true, abstract: false, final true
