...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5b4c138, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b4c0cc, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerializationEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerializationEventHandler(SerializationEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerializationEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerializationEventHandler(SerializationEventHandlerconst&) = delete;
