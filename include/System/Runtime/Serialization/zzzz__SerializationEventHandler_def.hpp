...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3cf3e28, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cf3d9c, size 0x8c, virtual false, abstract: false, final false
