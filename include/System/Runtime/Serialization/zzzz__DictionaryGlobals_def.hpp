...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::DictionaryGlobals*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::DictionaryGlobals*, "System.Runtime.Serialization", "DictionaryGlobals");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DictionaryGlobals", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DictionaryGlobals(DictionaryGlobals&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DictionaryGlobals", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DictionaryGlobals(DictionaryGlobalsconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::DictionaryGlobals) == 0x10, "Size mismatch!");
