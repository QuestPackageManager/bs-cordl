...
public:
  ...
  /// @brief Method Convert, addr 0x3cf3dc4, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method ThrowValueNullException, addr 0x3cf3e64, size 0x4c, virtual false, abstract: false, final false
  static inline void ThrowValueNullException();

  /// @brief Method ToBoolean, addr 0x3cf3eb0, size 0x98, virtual true, abstract: false, final true
  inline bool ToBoolean(::System::Object* value);

  /// @brief Method ToInt32, addr 0x3cf3f48, size 0x98, virtual true, abstract: false, final true
  inline int32_t ToInt32(::System::Object* value);

  /// @brief Method ToInt64, addr 0x3cf3fe0, size 0x98, virtual true, abstract: false, final true
  inline int64_t ToInt64(::System::Object* value);

  /// @brief Method ToSingle, addr 0x3cf4078, size 0x98, virtual true, abstract: false, final true
  inline float_t ToSingle(::System::Object* value);

  /// @brief Method ToString, addr 0x3cf4110, size 0x98, virtual true, abstract: false, final true
  inline ::StringW ToString(::System::Object* value);

  /// @brief Method .ctor, addr 0x3cf41a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
