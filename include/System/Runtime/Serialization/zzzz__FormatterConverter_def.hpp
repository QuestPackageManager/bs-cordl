...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FormatterConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FormatterConverter(FormatterConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FormatterConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FormatterConverter(FormatterConverterconst&) = delete;
