...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x615bdec, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615bd90, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615bc6c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x615bd4c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x615bd08, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnsignedByteDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnsignedByteDataContract(UnsignedByteDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnsignedByteDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnsignedByteDataContract(UnsignedByteDataContractconst&) = delete;
