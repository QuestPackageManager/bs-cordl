...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GuidDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GuidDataContract(GuidDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GuidDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GuidDataContract(GuidDataContractconst&) = delete;
