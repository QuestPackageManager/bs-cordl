...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x5fa9fe8, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x5fa9f60, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fa9de8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5fa9e50, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x5fa9f1c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x5fa9ed8, size 0x44, virtual true, abstract: false, final false
