...
// Write type traits
MARK_REF_PTR_T(::System::Runtime::Serialization::GuidDataContract);
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x5f4245c, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x5f423d4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f4225c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f422c4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlDictionaryString* name, ::System::Xml::XmlDictionaryString* ns);

  /// @brief Method get_ReadMethodName, addr 0x5f42390, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x5f4234c, size 0x44, virtual true, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::System::Runtime::Serialization::GuidDataContract, 0x30>, "Size mismatch!");

} // namespace System::Runtime::Serialization
NEED_NO_BOX(::System::Runtime::Serialization::GuidDataContract);
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Serialization::GuidDataContract*, "System.Runtime.Serialization", "GuidDataContract");
