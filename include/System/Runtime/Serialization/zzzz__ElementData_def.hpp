...
public:
  ...
  /// @brief Method AddAttribute, addr 0x600e504, size 0x104, virtual false, abstract: false, final false
  inline void AddAttribute(::StringW prefix, ::StringW ns, ::StringW name, ::StringW value);

  /// @brief Method GrowAttributesIfNeeded, addr 0x60133a0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6013398, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
