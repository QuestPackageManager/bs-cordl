...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ElementData*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ElementData*, "System.Runtime.Serialization", "ElementData");
// Dependencies System.Object, System.Runtime.Serialization.AttributeData
namespace System::Runtime::Serialization {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_attributes, put = __cordl_internal_set_attributes)) ::ArrayW<::System::Runtime::Serialization::AttributeData*> attributes;
  ...
  /// @brief Method AddAttribute, addr 0x6150990, size 0x104, virtual false, abstract: false, final false
  inline void AddAttribute(::StringW prefix, ::StringW ns, ::StringW name, ::StringW value);

  /// @brief Method GrowAttributesIfNeeded, addr 0x615582c, size 0xb0, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::System::Runtime::Serialization::AttributeData*> const& __cordl_internal_get_attributes() const;

  constexpr ::ArrayW<::System::Runtime::Serialization::AttributeData*>& __cordl_internal_get_attributes();
  ...
  constexpr void __cordl_internal_set_attributes(::ArrayW<::System::Runtime::Serialization::AttributeData*> value);
  ...
  /// @brief Method .ctor, addr 0x6155824, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ElementData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ElementData(ElementData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ElementData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ElementData(ElementDataconst&) = delete;
  ...
  ::ArrayW<::System::Runtime::Serialization::AttributeData*> ___attributes;
...
static_assert(sizeof(::System::Runtime::Serialization::ElementData) == 0x48, "Size mismatch!");
