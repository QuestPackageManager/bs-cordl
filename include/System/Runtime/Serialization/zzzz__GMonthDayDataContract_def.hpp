...
public:
  ...
  /// @brief Method .ctor, addr 0x615daa4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GMonthDayDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GMonthDayDataContract(GMonthDayDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GMonthDayDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GMonthDayDataContract(GMonthDayDataContractconst&) = delete;
