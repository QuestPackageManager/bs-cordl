...
public:
  ...
  /// @brief Method Initialize, addr 0x603a7b0, size 0x8, virtual false, abstract: false, final false
  inline void Initialize(::StringW typeName);

  /// @brief Method Initialize, addr 0x6039f70, size 0x838, virtual false, abstract: false, final false
  ...
  /// @brief Method RipOffAssemblyInformationFromTypeName, addr 0x603a7b8, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x603aa40, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::CodeTypeReference* arrayType, int32_t rank);

  /// @brief Method .ctor, addr 0x603a7a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName);

  /// @brief Method .ctor, addr 0x6039f6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::System::Runtime::Serialization::CodeTypeReferenceOptions codeTypeReferenceOption);

  /// @brief Method get_BaseType, addr 0x603aa50, size 0x144, virtual false, abstract: false, final false
  inline ::StringW get_BaseType();

  /// @brief Method get_Options, addr 0x603ab94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::CodeTypeReferenceOptions get_Options();

  /// @brief Method get_TypeArguments, addr 0x603a998, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::Runtime::Serialization::CodeTypeReference*>* get_TypeArguments();

  /// @brief Method set_Options, addr 0x603ab9c, size 0x8, virtual false, abstract: false, final false
