...
/// @brief Field typeArguments, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_typeArguments, put=__cordl_internal_set_typeArguments)) ::System::Collections::Generic::List_1<::System::Runtime::Serialization::CodeTypeReference*>*  typeArguments;

/// @brief Method Initialize, addr 0x5fc87a4, size 0x8, virtual false, abstract: false, final false
inline void Initialize(::StringW  typeName) ;

/// @brief Method Initialize, addr 0x5fc7f64, size 0x838, virtual false, abstract: false, final false
...
/// @brief Method RipOffAssemblyInformationFromTypeName, addr 0x5fc87ac, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fc8a34, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::CodeTypeReference*  arrayType, int32_t  rank) ;

/// @brief Method .ctor, addr 0x5fc879c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName) ;

/// @brief Method .ctor, addr 0x5fc7f60, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName, ::System::Runtime::Serialization::CodeTypeReferenceOptions  codeTypeReferenceOption) ;

/// @brief Method get_BaseType, addr 0x5fc8a44, size 0x144, virtual false, abstract: false, final false
inline ::StringW get_BaseType() ;

/// @brief Method get_Options, addr 0x5fc8b88, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::CodeTypeReferenceOptions get_Options() ;

/// @brief Method get_TypeArguments, addr 0x5fc898c, size 0xa8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::System::Runtime::Serialization::CodeTypeReference*>* get_TypeArguments() ;

/// @brief Method set_Options, addr 0x5fc8b90, size 0x8, virtual false, abstract: false, final false
