...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::IntDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::IntDataContract*, "System.Runtime.Serialization", "IntDataContract");
...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x615c444, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615c3f0, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615c2cc, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x615c3ac, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x615c368, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IntDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IntDataContract(IntDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IntDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IntDataContract(IntDataContractconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::IntDataContract) == 0x30, "Size mismatch!");
