...
public:
  ...
  /// @brief Method get_EmitDefaultValue, addr 0x424307c, size 0x8, virtual false, abstract: false, final false
  inline bool get_EmitDefaultValue();

  /// @brief Method get_IsRequired, addr 0x4243074, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsRequired();

  /// @brief Method get_Name, addr 0x4243064, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Order, addr 0x424306c, size 0x8, virtual false, abstract: false, final false
