...
public:
  ...
  /// @brief Method <GetSerializationEventsForType>b__1_0, addr 0x3cf9314, size 0x58, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationEvents* _GetSerializationEventsForType_b__1_0(::System::Type* type);

  /// @brief Method .ctor, addr 0x3cf930c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetSerializationEventsForType, addr 0x3cf90f4, size 0x130, virtual false, abstract: false, final false
