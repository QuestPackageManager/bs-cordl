...
public:
  ...
  /// @brief Method .ctor, addr 0x24d695c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <GetSerializationEventsForType>b__1_0, addr 0x24d6964, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetSerializationEventsForType, addr 0x24d6738, size 0x134, virtual false, abstract: false, final false
