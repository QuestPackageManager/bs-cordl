...
public:
  ...
  /// @brief Method .ctor, addr 0x24b58e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <GetSerializationEventsForType>b__1_0, addr 0x24b58f0, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetSerializationEventsForType, addr 0x24b56c4, size 0x134, virtual false, abstract: false, final false
