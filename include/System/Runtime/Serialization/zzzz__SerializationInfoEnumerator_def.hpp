...
public:
  ...
  /// @brief Method MoveNext, addr 0x25a62d8, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x25a643c, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x25a6304, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25a6288, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Current, addr 0x25a6374, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationEntry get_Current();

  /// @brief Method get_Name, addr 0x25a644c, size 0x88, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ObjectType, addr 0x25a655c, size 0x88, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_Value, addr 0x25a64d4, size 0x88, virtual false, abstract: false, final false
