...
public:
  ...
  /// @brief Method MoveNext, addr 0x5b487ac, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x5b4bdd8, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5b4bd74, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b4bd58, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::StringW> members, ::ArrayW<::System::Object*> info, ::ArrayW<::System::Type*> types, int32_t numItems);

  /// @brief Method get_Current, addr 0x5b48200, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationEntry get_Current();

  /// @brief Method get_Name, addr 0x5b4bde8, size 0x84, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ObjectType, addr 0x5b4bef0, size 0x84, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_Value, addr 0x5b4be6c, size 0x84, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerializationInfoEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerializationInfoEnumerator(SerializationInfoEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerializationInfoEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerializationInfoEnumerator(SerializationInfoEnumeratorconst&) = delete;
