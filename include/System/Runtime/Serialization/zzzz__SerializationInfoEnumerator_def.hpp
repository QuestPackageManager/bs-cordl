...
public:
  ...
  /// @brief Method MoveNext, addr 0x5a0ac64, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x5a0e290, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5a0e22c, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a0e210, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Current, addr 0x5a0a6b8, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationEntry get_Current();

  /// @brief Method get_Name, addr 0x5a0e2a0, size 0x84, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ObjectType, addr 0x5a0e3a8, size 0x84, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_Value, addr 0x5a0e324, size 0x84, virtual false, abstract: false, final false
