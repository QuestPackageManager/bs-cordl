...
public:
  ...
  /// @brief Method .ctor, addr 0x24d5590, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveNext, addr 0x24d55e0, size 0x2c, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x24d560c, size 0x70, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method get_Current, addr 0x24d567c, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationEntry get_Current();

  /// @brief Method Reset, addr 0x24d5744, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method get_Name, addr 0x24d5754, size 0x88, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x24d57dc, size 0x88, virtual false, abstract: false, final false
  inline ::System::Object* get_Value();

  /// @brief Method get_ObjectType, addr 0x24d5864, size 0x88, virtual false, abstract: false, final false
