...
public:
  ...
  /// @brief Method MoveNext, addr 0x5b464ac, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x5b49ad8, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5b49a74, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b49a58, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::StringW> members, ::ArrayW<::System::Object*> info, ::ArrayW<::System::Type*> types, int32_t numItems);

  /// @brief Method get_Current, addr 0x5b45f00, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationEntry get_Current();

  /// @brief Method get_Name, addr 0x5b49ae8, size 0x84, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ObjectType, addr 0x5b49bf0, size 0x84, virtual false, abstract: false, final false
  inline ::System::Type* get_ObjectType();

  /// @brief Method get_Value, addr 0x5b49b6c, size 0x84, virtual false, abstract: false, final false
