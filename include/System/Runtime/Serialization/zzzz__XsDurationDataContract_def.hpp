...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::XsDurationDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::XsDurationDataContract*, "System.Runtime.Serialization", "XsDurationDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x615e8d8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::XsDurationDataContract) == 0x30, "Size mismatch!");
