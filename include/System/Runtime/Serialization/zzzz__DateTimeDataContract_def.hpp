...
public:
  ...
  /// @brief Method ReadXmlValue, addr 0x615d5b8, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteXmlValue, addr 0x615d52c, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615d3f4, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ReadMethodName, addr 0x615d4e8, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_ReadMethodName();

  /// @brief Method get_WriteMethodName, addr 0x615d4a4, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  DateTimeDataContract(DateTimeDataContractconst&) = delete;
