...
public:
  // Declarations
  /// @brief Method KeyEquals, addr 0x3cfed00, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cfe968, size 0x8, virtual false, abstract: false, final false
