...
public:
  // Declarations
  /// @brief Method KeyEquals, addr 0x25b1b58, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b17ac, size 0x8, virtual false, abstract: false, final false
