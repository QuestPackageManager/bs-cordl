...
public:
  ...
  /// @brief Method .ctor, addr 0x24e0ab4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t size);

  /// @brief Method KeyEquals, addr 0x24e0e60, size 0x128, virtual true, abstract: false, final false
