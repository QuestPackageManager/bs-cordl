...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HybridObjectCache", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HybridObjectCache(HybridObjectCache&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HybridObjectCache", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HybridObjectCache(HybridObjectCacheconst&) = delete;
