...
/// @brief Field objectDictionary, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_objectDictionary, put=__cordl_internal_set_objectDictionary)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Object*>*  objectDictionary;

/// @brief Field referencedObjectDictionary, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_referencedObjectDictionary, put=__cordl_internal_set_referencedObjectDictionary)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Object*>*  referencedObjectDictionary;

/// @brief Method Add, addr 0x5fa31ac, size 0x1a4, virtual false, abstract: false, final false
inline void Add(::StringW  id, ::System::Object*  obj) ;

/// @brief Method GetObject, addr 0x5fa33c8, size 0x170, virtual false, abstract: false, final false
inline ::System::Object* GetObject(::StringW  id) ;

/// @brief Method IsObjectReferenced, addr 0x5fa3538, size 0x78, virtual false, abstract: false, final false
inline bool IsObjectReferenced(::StringW  id) ;

static inline ::System::Runtime::Serialization::HybridObjectCache* New_ctor() ;

/// @brief Method Remove, addr 0x5fa3358, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fa31a8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
