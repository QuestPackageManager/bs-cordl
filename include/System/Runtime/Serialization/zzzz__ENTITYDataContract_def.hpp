...
public:
  ...
  /// @brief Method .ctor, addr 0x615df1c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ENTITYDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ENTITYDataContract(ENTITYDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ENTITYDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ENTITYDataContract(ENTITYDataContractconst&) = delete;
