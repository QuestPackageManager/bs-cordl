...
public:
  // Declarations
  /// @brief Method BindToName, addr 0x2862d54, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2862d60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
