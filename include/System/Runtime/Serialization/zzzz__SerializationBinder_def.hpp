...
public:
  // Declarations
  /// @brief Method BindToName, addr 0x5935d14, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5935d20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
