...
public:
  // Declarations
  /// @brief Method BindToName, addr 0x3c7e2dc, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c7e2e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
