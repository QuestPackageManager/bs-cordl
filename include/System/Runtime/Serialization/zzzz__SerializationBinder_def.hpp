...
public:
  // Declarations
  /// @brief Method BindToName, addr 0x260a4d0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260a4dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
