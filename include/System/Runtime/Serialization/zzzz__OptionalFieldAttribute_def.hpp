...
public:
  ...
  /// @brief Method .ctor, addr 0x3cfcfc4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_VersionAdded, addr 0x3cfcfd4, size 0x70, virtual false, abstract: false, final false
