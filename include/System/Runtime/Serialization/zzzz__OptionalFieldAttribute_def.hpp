...
/// @brief Method .ctor, addr 0x59a54b0, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_VersionAdded, addr 0x59a54bc, size 0x60, virtual false, abstract: false, final false
