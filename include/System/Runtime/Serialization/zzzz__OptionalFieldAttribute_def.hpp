...
public:
  ...
  /// @brief Method .ctor, addr 0x26133b0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_VersionAdded, addr 0x26133c0, size 0x78, virtual false, abstract: false, final false
