...
public:
  ...
  /// @brief Method .ctor, addr 0x2859220, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_VersionAdded, addr 0x2859230, size 0x78, virtual false, abstract: false, final false
