...
public:
  ...
  /// @brief Method .ctor, addr 0x3cfcf4c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_VersionAdded, addr 0x3cfcf5c, size 0x70, virtual false, abstract: false, final false
