...
public:
  ...
  /// @brief Method .ctor, addr 0x5a1741c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_VersionAdded, addr 0x5a17428, size 0x60, virtual false, abstract: false, final false
