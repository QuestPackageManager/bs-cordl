...
public:
  ...
  /// @brief Method .ctor, addr 0x273a79c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_VersionAdded, addr 0x273a7ac, size 0x78, virtual false, abstract: false, final false
