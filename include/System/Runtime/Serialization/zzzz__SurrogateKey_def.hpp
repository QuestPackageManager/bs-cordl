...
public:
  ...
  /// @brief Method GetHashCode, addr 0x3cfd4b0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cfd280, size 0x3c, virtual false, abstract: false, final false
