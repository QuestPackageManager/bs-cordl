...
public:
  ...
  /// @brief Method GetHashCode, addr 0x3cf9d6c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cf9b3c, size 0x3c, virtual false, abstract: false, final false
