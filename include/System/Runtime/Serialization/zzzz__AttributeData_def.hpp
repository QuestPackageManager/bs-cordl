...
public:
  ...
  /// @brief Method .ctor, addr 0x6155828, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AttributeData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AttributeData(AttributeData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AttributeData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AttributeData(AttributeDataconst&) = delete;
