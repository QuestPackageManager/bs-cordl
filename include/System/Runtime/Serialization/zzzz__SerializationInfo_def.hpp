...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_data, put = __cordl_internal_set_m_data)) ::ArrayW<::System::Object*> m_data;
  ...
  __declspec(property(get = __cordl_internal_get_m_members, put = __cordl_internal_set_m_members)) ::ArrayW<::StringW> m_members;
  ...
  __declspec(property(get = __cordl_internal_get_m_types, put = __cordl_internal_set_m_types)) ::ArrayW<::System::Type*> m_types;
  ...
  /// @brief Method AddValue, addr 0x5b53814, size 0xc0, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, ::System::DateTime value);

  /// @brief Method AddValue, addr 0x5b470fc, size 0x7c, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, ::System::Object* value);

  /// @brief Method AddValue, addr 0x5b52374, size 0x7c, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, ::System::Object* value, ::System::Type* type);

  /// @brief Method AddValue, addr 0x5b5355c, size 0x74, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, bool value);

  /// @brief Method AddValue, addr 0x5b537a0, size 0x74, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, float_t value);

  /// @brief Method AddValue, addr 0x5b53644, size 0x74, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, int16_t value);

  /// @brief Method AddValue, addr 0x5b47fc0, size 0x74, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, int32_t value);

  /// @brief Method AddValue, addr 0x5b536b8, size 0x74, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, int64_t value);

  /// @brief Method AddValue, addr 0x5b5372c, size 0x74, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, uint64_t value);

  /// @brief Method AddValue, addr 0x5b535d0, size 0x74, virtual false, abstract: false, final false
  inline void AddValue(::StringW name, uint8_t value);

  /// @brief Method AddValueInternal, addr 0x5b53384, size 0x1d8, virtual false, abstract: false, final false
  inline void AddValueInternal(::StringW name, ::System::Object* value, ::System::Type* type);

  /// @brief Method Compare, addr 0x5b53098, size 0x74, virtual false, abstract: false, final false
  static inline bool Compare(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b);

  /// @brief Method DemandForUnsafeAssemblyNameAssignments, addr 0x5b53094, size 0x4, virtual false, abstract: false, final false
  static inline void DemandForUnsafeAssemblyNameAssignments(::StringW originalAssemblyName, ::StringW newAssemblyName);

  /// @brief Method ExpandArrays, addr 0x5b53268, size 0x11c, virtual false, abstract: false, final false
  inline void ExpandArrays();

  /// @brief Method FindElement, addr 0x5b538d4, size 0xc8, virtual false, abstract: false, final false
  inline int32_t FindElement(::StringW name);

  /// @brief Method GetBoolean, addr 0x5b53b14, size 0x144, virtual false, abstract: false, final false
  inline bool GetBoolean(::StringW name);

  /// @brief Method GetElement, addr 0x5b5399c, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Object* GetElement(::StringW name, ::by_ref<::System::Type*> foundType);

  /// @brief Method GetElementNoThrow, addr 0x5b53a98, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Object* GetElementNoThrow(::StringW name, ::by_ref<::System::Type*> foundType);

  /// @brief Method GetEnumerator, addr 0x5b45e80, size 0x80, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::SerializationInfoEnumerator* GetEnumerator();

  /// @brief Method GetInt32, addr 0x5b53c58, size 0x144, virtual false, abstract: false, final false
  inline int32_t GetInt32(::StringW name);

  /// @brief Method GetInt64, addr 0x5b53d9c, size 0x144, virtual false, abstract: false, final false
  inline int64_t GetInt64(::StringW name);

  /// @brief Method GetSingle, addr 0x5b53ee0, size 0x144, virtual false, abstract: false, final false
  inline float_t GetSingle(::StringW name);

  /// @brief Method GetString, addr 0x5b54024, size 0x140, virtual false, abstract: false, final false
  inline ::StringW GetString(::StringW name);

  /// @brief Method GetValue, addr 0x5b51fec, size 0x204, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(::StringW name, ::System::Type* type);

  /// @brief Method GetValueNoThrow, addr 0x5b51ecc, size 0x120, virtual false, abstract: false, final false
  inline ::System::Object* GetValueNoThrow(::StringW name, ::System::Type* type);

  /// @brief Method IsAssemblyNameAssignmentSafe, addr 0x5b5310c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetType, addr 0x5b523f0, size 0x134, virtual false, abstract: false, final false
  inline void SetType(::System::Type* type);

  /// @brief Method UpdateValue, addr 0x5b4f908, size 0xe4, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_m_data() const;

  constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_m_data();

  constexpr ::StringW const& __cordl_internal_get_m_fullTypeName() const;

  constexpr ::StringW& __cordl_internal_get_m_fullTypeName();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_m_members() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_m_members();
  ...
  constexpr ::ArrayW<::System::Type*> const& __cordl_internal_get_m_types() const;

  constexpr ::ArrayW<::System::Type*>& __cordl_internal_get_m_types();
  ...
  constexpr void __cordl_internal_set_m_data(::ArrayW<::System::Object*> value);

  constexpr void __cordl_internal_set_m_fullTypeName(::StringW value);

  constexpr void __cordl_internal_set_m_members(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set_m_nameToIndex(::System::Collections::Generic::Dictionary_2<::StringW, int32_t>* value);

  constexpr void __cordl_internal_set_m_types(::ArrayW<::System::Type*> value);
  ...
  /// @brief Method .ctor, addr 0x5b52e6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::System::Runtime::Serialization::IFormatterConverter* converter);

  /// @brief Method .ctor, addr 0x5b52e74, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AssemblyName, addr 0x5b5308c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AssemblyName();

  /// @brief Method get_FullTypeName, addr 0x5b53084, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FullTypeName();

  /// @brief Method get_IsAssemblyNameSetExplicit, addr 0x5b53260, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAssemblyNameSetExplicit();

  /// @brief Method get_IsFullTypeNameSetExplicit, addr 0x5b53258, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsFullTypeNameSetExplicit();

  /// @brief Method get_MemberCount, addr 0x5b53248, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MemberCount();

  /// @brief Method get_ObjectType, addr 0x5b53250, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::SerializationInfo) == 0x60, "Size mismatch!");
