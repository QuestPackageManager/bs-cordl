...
public:
  ...
  /// @brief Method CreateEventDescriptors, addr 0x617fd68, size 0x244, virtual false, abstract: false, final false
  static inline void CreateEventDescriptors();

  /// @brief Method DCDeserializeWithSurrogateStart, addr 0x617f20c, size 0xa8, virtual false, abstract: false, final false
  static inline void DCDeserializeWithSurrogateStart(::StringW SurrogateType);

  /// @brief Method DCDeserializeWithSurrogateStartIsEnabled, addr 0x617f17c, size 0x90, virtual false, abstract: false, final false
  static inline bool DCDeserializeWithSurrogateStartIsEnabled();

  /// @brief Method DCDeserializeWithSurrogateStop, addr 0x617f344, size 0xa8, virtual false, abstract: false, final false
  static inline void DCDeserializeWithSurrogateStop();

  /// @brief Method DCDeserializeWithSurrogateStopIsEnabled, addr 0x617f2b4, size 0x90, virtual false, abstract: false, final false
  static inline bool DCDeserializeWithSurrogateStopIsEnabled();

  /// @brief Method DCGenReaderStart, addr 0x617fb88, size 0xa8, virtual false, abstract: false, final false
  static inline void DCGenReaderStart(::StringW Kind, ::StringW TypeName);

  /// @brief Method DCGenReaderStartIsEnabled, addr 0x617faf8, size 0x90, virtual false, abstract: false, final false
  static inline bool DCGenReaderStartIsEnabled();

  /// @brief Method DCGenReaderStop, addr 0x617fcc0, size 0xa8, virtual false, abstract: false, final false
  static inline void DCGenReaderStop();

  /// @brief Method DCGenReaderStopIsEnabled, addr 0x617fc30, size 0x90, virtual false, abstract: false, final false
  static inline bool DCGenReaderStopIsEnabled();

  /// @brief Method DCGenWriterStart, addr 0x617f824, size 0xa8, virtual false, abstract: false, final false
  static inline void DCGenWriterStart(::StringW Kind, ::StringW TypeName);

  /// @brief Method DCGenWriterStartIsEnabled, addr 0x617f794, size 0x90, virtual false, abstract: false, final false
  static inline bool DCGenWriterStartIsEnabled();

  /// @brief Method DCGenWriterStop, addr 0x617fa50, size 0xa8, virtual false, abstract: false, final false
  static inline void DCGenWriterStop();

  /// @brief Method DCGenWriterStopIsEnabled, addr 0x617f9c0, size 0x90, virtual false, abstract: false, final false
  static inline bool DCGenWriterStopIsEnabled();

  /// @brief Method DCResolverResolve, addr 0x617f6ec, size 0xa8, virtual false, abstract: false, final false
  static inline void DCResolverResolve(::StringW TypeName);

  /// @brief Method DCResolverResolveIsEnabled, addr 0x617f65c, size 0x90, virtual false, abstract: false, final false
  static inline bool DCResolverResolveIsEnabled();

  /// @brief Method DCSerializeWithSurrogateStart, addr 0x617eec0, size 0xa8, virtual false, abstract: false, final false
  static inline void DCSerializeWithSurrogateStart(::StringW SurrogateType);

  /// @brief Method DCSerializeWithSurrogateStartIsEnabled, addr 0x617ee30, size 0x90, virtual false, abstract: false, final false
  static inline bool DCSerializeWithSurrogateStartIsEnabled();

  /// @brief Method DCSerializeWithSurrogateStop, addr 0x617eff8, size 0xa8, virtual false, abstract: false, final false
  static inline void DCSerializeWithSurrogateStop();

  /// @brief Method DCSerializeWithSurrogateStopIsEnabled, addr 0x617ef68, size 0x90, virtual false, abstract: false, final false
  static inline bool DCSerializeWithSurrogateStopIsEnabled();

  /// @brief Method EnsureEventDescriptors, addr 0x617ffac, size 0x150, virtual false, abstract: false, final false
  static inline void EnsureEventDescriptors();

  /// @brief Method ImportKnownTypesStart, addr 0x617f47c, size 0xa8, virtual false, abstract: false, final false
  static inline void ImportKnownTypesStart();

  /// @brief Method ImportKnownTypesStartIsEnabled, addr 0x617f3ec, size 0x90, virtual false, abstract: false, final false
  static inline bool ImportKnownTypesStartIsEnabled();

  /// @brief Method ImportKnownTypesStop, addr 0x617f5b4, size 0xa8, virtual false, abstract: false, final false
  static inline void ImportKnownTypesStop();

  /// @brief Method ImportKnownTypesStopIsEnabled, addr 0x617f524, size 0x90, virtual false, abstract: false, final false
  static inline bool ImportKnownTypesStopIsEnabled();

  /// @brief Method IsEtwEventEnabled, addr 0x617ebec, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsEtwEventEnabled(int32_t eventIndex);

  /// @brief Method ReaderQuotaExceeded, addr 0x617ec9c, size 0xa8, virtual false, abstract: false, final false
  static inline void ReaderQuotaExceeded(::StringW param0);

  /// @brief Method ReaderQuotaExceededIsEnabled, addr 0x617eb5c, size 0x90, virtual false, abstract: false, final false
  static inline bool ReaderQuotaExceededIsEnabled();

  /// @brief Method WriteEtwEvent, addr 0x617f0a0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEtwEvent, addr 0x617ed44, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEtwEvent, addr 0x617f8cc, size 0xf4, virtual false, abstract: false, final false
