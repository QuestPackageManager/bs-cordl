...
public:
  ...
  /// @brief Method CreateEventDescriptors, addr 0x5f68e9c, size 0x244, virtual false, abstract: false, final false
  static inline void CreateEventDescriptors();

  /// @brief Method DCDeserializeWithSurrogateStart, addr 0x5f68340, size 0xa8, virtual false, abstract: false, final false
  static inline void DCDeserializeWithSurrogateStart(::StringW SurrogateType);

  /// @brief Method DCDeserializeWithSurrogateStartIsEnabled, addr 0x5f682b0, size 0x90, virtual false, abstract: false, final false
  static inline bool DCDeserializeWithSurrogateStartIsEnabled();

  /// @brief Method DCDeserializeWithSurrogateStop, addr 0x5f68478, size 0xa8, virtual false, abstract: false, final false
  static inline void DCDeserializeWithSurrogateStop();

  /// @brief Method DCDeserializeWithSurrogateStopIsEnabled, addr 0x5f683e8, size 0x90, virtual false, abstract: false, final false
  static inline bool DCDeserializeWithSurrogateStopIsEnabled();

  /// @brief Method DCGenReaderStart, addr 0x5f68cbc, size 0xa8, virtual false, abstract: false, final false
  static inline void DCGenReaderStart(::StringW Kind, ::StringW TypeName);

  /// @brief Method DCGenReaderStartIsEnabled, addr 0x5f68c2c, size 0x90, virtual false, abstract: false, final false
  static inline bool DCGenReaderStartIsEnabled();

  /// @brief Method DCGenReaderStop, addr 0x5f68df4, size 0xa8, virtual false, abstract: false, final false
  static inline void DCGenReaderStop();

  /// @brief Method DCGenReaderStopIsEnabled, addr 0x5f68d64, size 0x90, virtual false, abstract: false, final false
  static inline bool DCGenReaderStopIsEnabled();

  /// @brief Method DCGenWriterStart, addr 0x5f68958, size 0xa8, virtual false, abstract: false, final false
  static inline void DCGenWriterStart(::StringW Kind, ::StringW TypeName);

  /// @brief Method DCGenWriterStartIsEnabled, addr 0x5f688c8, size 0x90, virtual false, abstract: false, final false
  static inline bool DCGenWriterStartIsEnabled();

  /// @brief Method DCGenWriterStop, addr 0x5f68b84, size 0xa8, virtual false, abstract: false, final false
  static inline void DCGenWriterStop();

  /// @brief Method DCGenWriterStopIsEnabled, addr 0x5f68af4, size 0x90, virtual false, abstract: false, final false
  static inline bool DCGenWriterStopIsEnabled();

  /// @brief Method DCResolverResolve, addr 0x5f68820, size 0xa8, virtual false, abstract: false, final false
  static inline void DCResolverResolve(::StringW TypeName);

  /// @brief Method DCResolverResolveIsEnabled, addr 0x5f68790, size 0x90, virtual false, abstract: false, final false
  static inline bool DCResolverResolveIsEnabled();

  /// @brief Method DCSerializeWithSurrogateStart, addr 0x5f67ff4, size 0xa8, virtual false, abstract: false, final false
  static inline void DCSerializeWithSurrogateStart(::StringW SurrogateType);

  /// @brief Method DCSerializeWithSurrogateStartIsEnabled, addr 0x5f67f64, size 0x90, virtual false, abstract: false, final false
  static inline bool DCSerializeWithSurrogateStartIsEnabled();

  /// @brief Method DCSerializeWithSurrogateStop, addr 0x5f6812c, size 0xa8, virtual false, abstract: false, final false
  static inline void DCSerializeWithSurrogateStop();

  /// @brief Method DCSerializeWithSurrogateStopIsEnabled, addr 0x5f6809c, size 0x90, virtual false, abstract: false, final false
  static inline bool DCSerializeWithSurrogateStopIsEnabled();

  /// @brief Method EnsureEventDescriptors, addr 0x5f690e0, size 0x150, virtual false, abstract: false, final false
  static inline void EnsureEventDescriptors();

  /// @brief Method ImportKnownTypesStart, addr 0x5f685b0, size 0xa8, virtual false, abstract: false, final false
  static inline void ImportKnownTypesStart();

  /// @brief Method ImportKnownTypesStartIsEnabled, addr 0x5f68520, size 0x90, virtual false, abstract: false, final false
  static inline bool ImportKnownTypesStartIsEnabled();

  /// @brief Method ImportKnownTypesStop, addr 0x5f686e8, size 0xa8, virtual false, abstract: false, final false
  static inline void ImportKnownTypesStop();

  /// @brief Method ImportKnownTypesStopIsEnabled, addr 0x5f68658, size 0x90, virtual false, abstract: false, final false
  static inline bool ImportKnownTypesStopIsEnabled();

  /// @brief Method IsEtwEventEnabled, addr 0x5f67d20, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsEtwEventEnabled(int32_t eventIndex);

  /// @brief Method ReaderQuotaExceeded, addr 0x5f67dd0, size 0xa8, virtual false, abstract: false, final false
  static inline void ReaderQuotaExceeded(::StringW param0);

  /// @brief Method ReaderQuotaExceededIsEnabled, addr 0x5f67c90, size 0x90, virtual false, abstract: false, final false
  static inline bool ReaderQuotaExceededIsEnabled();

  /// @brief Method WriteEtwEvent, addr 0x5f681d4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEtwEvent, addr 0x5f67e78, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEtwEvent, addr 0x5f68a00, size 0xf4, virtual false, abstract: false, final false
