...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TraceUtility", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TraceUtility(TraceUtility&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TraceUtility", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TraceUtility(TraceUtilityconst&) = delete;
