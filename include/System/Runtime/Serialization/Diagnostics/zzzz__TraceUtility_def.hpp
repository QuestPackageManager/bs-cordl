...
/// @brief Method Trace, addr 0x5fcf6f8, size 0x74, virtual false, abstract: false, final false
static inline void Trace(::System::Diagnostics::TraceEventType  severity, int32_t  traceCode, ::StringW  traceDescription) ;

/// @brief Method Trace, addr 0x5fcf76c, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Trace, addr 0x5fcf7f0, size 0x1e0, virtual false, abstract: false, final false
static inline void Trace(::System::Diagnostics::TraceEventType  severity, int32_t  traceCode, ::StringW  traceDescription, ::System::Runtime::Diagnostics::TraceRecord*  record, ::System::Exception*  exception) ;
...
} // namespace end def System::Runtime::Serialization::Diagnostics
