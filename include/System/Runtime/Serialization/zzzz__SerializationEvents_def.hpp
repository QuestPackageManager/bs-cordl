...
public:
  ...
  /// @brief Method AddOnDelegate, addr 0x5a0efbc, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOnDeserialized, addr 0x5a0f1b0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOnSerialized, addr 0x5a0efa8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMethodsWithAttribute, addr 0x5a0ec14, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeOnDelegate, addr 0x5a0eeb0, size 0x50, virtual false, abstract: false, final false
  static inline void InvokeOnDelegate(::System::Object* obj, ::System::Runtime::Serialization::StreamingContext context,
                                      ::System::Collections::Generic::List_1<::System::Reflection::MethodInfo*>* methods);

  /// @brief Method InvokeOnDeserialized, addr 0x5a0ef54, size 0x54, virtual false, abstract: false, final false
  inline void InvokeOnDeserialized(::System::Object* obj, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method InvokeOnDeserializing, addr 0x5a0ef00, size 0x54, virtual false, abstract: false, final false
  inline void InvokeOnDeserializing(::System::Object* obj, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method InvokeOnSerializing, addr 0x5a0ee5c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0eae8, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* t);

  /// @brief Method get_HasOnSerializingEvents, addr 0x5a0ee3c, size 0x20, virtual false, abstract: false, final false
