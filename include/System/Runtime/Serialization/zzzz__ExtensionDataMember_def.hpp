...
public:
  ...
  /// @brief Method .ctor, addr 0x600e084, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_MemberIndex, addr 0x600e074, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MemberIndex();

  /// @brief Method get_Name, addr 0x600e044, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Namespace, addr 0x600e054, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_Value, addr 0x600e064, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::IDataNode* get_Value();

  /// @brief Method set_MemberIndex, addr 0x600e07c, size 0x8, virtual false, abstract: false, final false
  inline void set_MemberIndex(int32_t value);

  /// @brief Method set_Name, addr 0x600e04c, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Namespace, addr 0x600e05c, size 0x8, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_Value, addr 0x600e06c, size 0x8, virtual false, abstract: false, final false
