...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ExtensionDataMember*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ExtensionDataMember*, "System.Runtime.Serialization", "ExtensionDataMember");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExtensionDataMember", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExtensionDataMember(ExtensionDataMember&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExtensionDataMember", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExtensionDataMember(ExtensionDataMemberconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::ExtensionDataMember) == 0x30, "Size mismatch!");
