...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HexBinaryDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HexBinaryDataContract(HexBinaryDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HexBinaryDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HexBinaryDataContract(HexBinaryDataContractconst&) = delete;
