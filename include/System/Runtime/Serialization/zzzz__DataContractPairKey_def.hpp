...
public:
  ...
  /// @brief Method Equals, addr 0x614b3c0, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetHashCode, addr 0x614b48c, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6147b70, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataContractPairKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataContractPairKey(DataContractPairKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataContractPairKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataContractPairKey(DataContractPairKeyconst&) = delete;
