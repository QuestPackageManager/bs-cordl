...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::EnumDataContract*);
MARK_REF_T(::System::Runtime::Serialization::EnumDataContract_EnumDataContractCriticalHelper*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::EnumDataContract*, "System.Runtime.Serialization", "EnumDataContract");
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::EnumDataContract_EnumDataContractCriticalHelper*, "System.Runtime.Serialization", "EnumDataContract/EnumDataContractCriticalHelper");
// Dependencies System.Runtime.Serialization.DataContract::DataContractCriticalHelper, System.Xml.XmlDictionaryString
namespace System::Runtime::Serialization {
// Is value type: false
...
public:
  // Declarations
  __declspec(property(get = get_ChildElementNames)) ::ArrayW<::System::Xml::XmlDictionaryString*> ChildElementNames;
  ...
  __declspec(property(get = __cordl_internal_get_childElementNames, put = __cordl_internal_set_childElementNames)) ::ArrayW<::System::Xml::XmlDictionaryString*> childElementNames;
  ...
  constexpr ::ArrayW<::System::Xml::XmlDictionaryString*> const& __cordl_internal_get_childElementNames() const;

  constexpr ::ArrayW<::System::Xml::XmlDictionaryString*>& __cordl_internal_get_childElementNames();
  ...
  constexpr void __cordl_internal_set_childElementNames(::ArrayW<::System::Xml::XmlDictionaryString*> value);
...
public:
  ...
  ::ArrayW<::System::Xml::XmlDictionaryString*> ___childElementNames;
...
static_assert(sizeof(::System::Runtime::Serialization::EnumDataContract_EnumDataContractCriticalHelper) == 0x70, "Size mismatch!");
...
static_assert(sizeof(::System::Runtime::Serialization::EnumDataContract) == 0x30, "Size mismatch!");
