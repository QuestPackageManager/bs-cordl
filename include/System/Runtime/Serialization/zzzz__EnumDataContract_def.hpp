...
public:
  ...
  /// @brief Method Add, addr 0x600d224, size 0x11c, virtual false, abstract: false, final false
  static inline void Add(::System::Type* type, ::StringW localName);

  /// @brief Method GetBaseContractName, addr 0x600d340, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* GetBaseContractName(::System::Type* type);

  /// @brief Method ImportBaseType, addr 0x600d3e0, size 0x8c, virtual false, abstract: false, final false
  inline void ImportBaseType(::System::Type* baseType);

  /// @brief Method ImportDataMembers, addr 0x600d568, size 0x7a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x600beac, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ChildElementNames, addr 0x600dd34, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::XmlDictionaryString*, ::Array<::System::Xml::XmlDictionaryString*>*> get_ChildElementNames();

  /// @brief Method get_IsFlags, addr 0x600dd1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsFlags();

  /// @brief Method get_IsULong, addr 0x600dd2c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsULong();

  /// @brief Method get_Members, addr 0x600dd0c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::Runtime::Serialization::DataMember*>* get_Members();

  /// @brief Method get_Values, addr 0x600dd14, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsFlags, addr 0x600dd24, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x600cc28, size 0x2e8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x600cf10, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Runtime::Serialization::EnumDataContract* New_ctor(::System::Type* type);

  /// @brief Method ReadEnumValue, addr 0x600c780, size 0x2c8, virtual false, abstract: false, final false
  inline ::System::Object* ReadEnumValue(::System::Runtime::Serialization::XmlReaderDelegator* reader);

  /// @brief Method ReadEnumValue, addr 0x600ca48, size 0x1e0, virtual false, abstract: false, final false
  inline int64_t ReadEnumValue(::StringW value, int32_t index, int32_t count);

  /// @brief Method ReadXmlValue, addr 0x600cf28, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteEnumValue, addr 0x600c328, size 0x458, virtual false, abstract: false, final false
  inline void WriteEnumValue(::System::Runtime::Serialization::XmlWriterDelegator* writer, ::System::Object* value);

  /// @brief Method WriteXmlValue, addr 0x600cf24, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x600650c, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_CanContainReferences, addr 0x600c320, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanContainReferences();

  /// @brief Method get_ChildElementNames, addr 0x600c308, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Xml::XmlDictionaryString*, ::Array<::System::Xml::XmlDictionaryString*>*> get_ChildElementNames();

  /// @brief Method get_IsFlags, addr 0x600c2d8, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsFlags();

  /// @brief Method get_IsULong, addr 0x600c2f0, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsULong();

  /// @brief Method get_Members, addr 0x600c2a8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::Runtime::Serialization::DataMember*>* get_Members();

  /// @brief Method get_Values, addr 0x600c2c0, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<int64_t>* get_Values();
