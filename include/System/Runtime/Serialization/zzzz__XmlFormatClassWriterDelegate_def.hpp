...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlFormatClassWriterDelegate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlFormatClassWriterDelegate(XmlFormatClassWriterDelegate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlFormatClassWriterDelegate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlFormatClassWriterDelegate(XmlFormatClassWriterDelegateconst&) = delete;
