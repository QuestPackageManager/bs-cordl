...
public:
  ...
  /// @brief Method .ctor, addr 0x615d89c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TimeDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TimeDataContract(TimeDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TimeDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TimeDataContract(TimeDataContractconst&) = delete;
