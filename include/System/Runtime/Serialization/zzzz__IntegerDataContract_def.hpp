...
public:
  ...
  /// @brief Method .ctor, addr 0x615c920, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IntegerDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IntegerDataContract(IntegerDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IntegerDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IntegerDataContract(IntegerDataContractconst&) = delete;
