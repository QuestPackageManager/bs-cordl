...
public:
  ...
  /// @brief Method AddObjectHolder, addr 0x273b7ac, size 0x12c, virtual false, abstract: false, final false
  inline void AddObjectHolder(::System::Runtime::Serialization::ObjectHolder* holder);

  /// @brief Method AddOnDeserialization, addr 0x273ee04, size 0x80, virtual true, abstract: false, final false
  inline void AddOnDeserialization(::System::Runtime::Serialization::DeserializationEventHandler* handler);

  /// @brief Method AddOnDeserialized, addr 0x273ee84, size 0x90, virtual true, abstract: false, final false
  inline void AddOnDeserialized(::System::Object* obj);

  /// @brief Method CanCallGetType, addr 0x273b5f0, size 0x8, virtual false, abstract: false, final false
  inline bool CanCallGetType(::System::Object* obj);

  /// @brief Method CompleteISerializableObject, addr 0x273c07c, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method CompleteObject, addr 0x273cc48, size 0x620, virtual false, abstract: false, final false
  inline void CompleteObject(::System::Runtime::Serialization::ObjectHolder* holder, bool bObjectFullyComplete);

  /// @brief Method DoFixups, addr 0x273e180, size 0x304, virtual true, abstract: false, final false
  inline void DoFixups();

  /// @brief Method DoNewlyRegisteredObjectFixups, addr 0x273c8cc, size 0xd8, virtual false, abstract: false, final false
  inline void DoNewlyRegisteredObjectFixups(::System::Runtime::Serialization::ObjectHolder* holder);

  /// @brief Method DoValueTypeFixup, addr 0x273c36c, size 0x560, virtual false, abstract: false, final false
  ...
  /// @brief Method FindObjectHolder, addr 0x273b67c, size 0x58, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::ObjectHolder* FindObjectHolder(int64_t objectID);

  /// @brief Method FindOrCreateObjectHolder, addr 0x273b6d4, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::ObjectHolder* FindOrCreateObjectHolder(int64_t objectID);

  /// @brief Method FixupSpecialObject, addr 0x273bbe0, size 0x238, virtual false, abstract: false, final false
  inline void FixupSpecialObject(::System::Runtime::Serialization::ObjectHolder* holder);

  /// @brief Method GetCompletionInfo, addr 0x273b8d8, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructor, addr 0x273e048, size 0x138, virtual false, abstract: false, final false
  static inline ::System::Reflection::RuntimeConstructorInfo* GetConstructor(::System::RuntimeType* t);

  /// @brief Method GetObject, addr 0x273d46c, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method RaiseDeserializationEvent, addr 0x273edb8, size 0x4c, virtual true, abstract: false, final false
  inline void RaiseDeserializationEvent();

  /// @brief Method RaiseOnDeserializedEvent, addr 0x273ef14, size 0x84, virtual true, abstract: false, final false
  inline void RaiseOnDeserializedEvent(::System::Object* obj);

  /// @brief Method RaiseOnDeserializingEvent, addr 0x273ef98, size 0x84, virtual false, abstract: false, final false
  inline void RaiseOnDeserializingEvent(::System::Object* obj);

  /// @brief Method RecordArrayElementFixup, addr 0x273ec50, size 0x168, virtual true, abstract: false, final false
  inline void RecordArrayElementFixup(int64_t arrayToBeFixed, ::ArrayW<int32_t, ::Array<int32_t>*> indices, int64_t objectRequired);

  /// @brief Method RecordDelayedFixup, addr 0x273eae8, size 0x168, virtual true, abstract: false, final false
  inline void RecordDelayedFixup(int64_t objectToBeFixed, ::StringW memberName, int64_t objectRequired);

  /// @brief Method RecordFixup, addr 0x273e80c, size 0x2a0, virtual true, abstract: false, final false
  inline void RecordFixup(int64_t objectToBeFixed, ::System::Reflection::MemberInfo* member, int64_t objectRequired);

  /// @brief Method RegisterFixup, addr 0x273e5fc, size 0xe0, virtual false, abstract: false, final false
  inline void RegisterFixup(::System::Runtime::Serialization::FixupHolder* fixup, int64_t objectToBeFixed, int64_t objectRequired);

  /// @brief Method RegisterObject, addr 0x273d704, size 0x5bc, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterString, addr 0x273d520, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveObjectReference, addr 0x273c9a4, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x273b570, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SpecialFixupObjects, addr 0x273b608, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::ObjectHolderList* get_SpecialFixupObjects();

  /// @brief Method get_TopObject, addr 0x273b600, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_TopObject();

  /// @brief Method set_TopObject, addr 0x273b5f8, size 0x8, virtual false, abstract: false, final false
