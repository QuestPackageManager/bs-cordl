...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5a0e570, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0e42c, size 0x144, virtual false, abstract: false, final false
