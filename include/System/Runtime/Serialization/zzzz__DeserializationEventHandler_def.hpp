...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DeserializationEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DeserializationEventHandler(DeserializationEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DeserializationEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DeserializationEventHandler(DeserializationEventHandlerconst&) = delete;
