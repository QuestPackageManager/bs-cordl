...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::NonPositiveIntegerDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::NonPositiveIntegerDataContract*, "System.Runtime.Serialization", "NonPositiveIntegerDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x615ca58, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NonPositiveIntegerDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NonPositiveIntegerDataContract(NonPositiveIntegerDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NonPositiveIntegerDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NonPositiveIntegerDataContract(NonPositiveIntegerDataContractconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::NonPositiveIntegerDataContract) == 0x30, "Size mismatch!");
