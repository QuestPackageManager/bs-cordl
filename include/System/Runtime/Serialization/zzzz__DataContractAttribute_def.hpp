...
public:
  ...
  /// @brief Method .ctor, addr 0x600909c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsNameSetExplicitly, addr 0x60090e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNameSetExplicitly();

  /// @brief Method get_IsNamespaceSetExplicitly, addr 0x60090c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNamespaceSetExplicitly();

  /// @brief Method get_IsReference, addr 0x60090a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsReference();

  /// @brief Method get_IsReferenceSetExplicitly, addr 0x60090a8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsReferenceSetExplicitly();

  /// @brief Method get_Name, addr 0x60090d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Namespace, addr 0x60090b0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method set_Name, addr 0x60090d8, size 0x10, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Namespace, addr 0x60090b8, size 0x10, virtual false, abstract: false, final false
