...
/// @brief Method CheckIfNeedsContractNsAtRoot, addr 0x6024e74, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method CheckNull, addr 0x6024514, size 0x4c, virtual false, abstract: false, final false
static inline void CheckNull(::System::Object*  obj, ::StringW  name) ;

/// @brief Method CreateSerializationException, addr 0x6016ed4, size 0x8, virtual false, abstract: false, final false
static inline ::System::Runtime::Serialization::SerializationException* CreateSerializationException(::StringW  errorMessage) ;

/// @brief Method CreateSerializationException, addr 0x601dc78, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method CreateSerializationExceptionWithReaderDetails, addr 0x6025aa4, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method GetDeserializeType, addr 0x6025c78, size 0x8, virtual true, abstract: false, final false
inline ::System::Type* GetDeserializeType() ;

/// @brief Method GetSerializeType, addr 0x6025c60, size 0x18, virtual true, abstract: false, final false
inline ::System::Type* GetSerializeType(::System::Object*  graph) ;

/// @brief Method GetTypeInfo, addr 0x6024a84, size 0x50, virtual false, abstract: false, final false
static inline ::StringW GetTypeInfo(::System::Type*  type) ;

/// @brief Method GetTypeInfoError, addr 0x6024ad4, size 0x1a0, virtual false, abstract: false, final false
static inline ::StringW GetTypeInfoError(::StringW  errorMessage, ::System::Type*  type, ::System::Exception*  innerException) ;

/// @brief Method InternalIsStartObject, addr 0x6025308, size 0x38, virtual true, abstract: false, final false
inline bool InternalIsStartObject(::System::Runtime::Serialization::XmlReaderDelegator*  reader) ;

/// @brief Method InternalReadObject, addr 0x60252d4, size 0x24, virtual true, abstract: false, final false
inline ::System::Object* InternalReadObject(::System::Runtime::Serialization::XmlReaderDelegator*  reader, bool  verifyObjectName) ;

/// @brief Method InternalReadObject, addr 0x60252f8, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method InternalWriteEndObject, addr 0x6024d5c, size 0x38, virtual true, abstract: false, final false
inline void InternalWriteEndObject(::System::Runtime::Serialization::XmlWriterDelegator*  writer) ;

/// @brief Method InternalWriteObject, addr 0x6024c7c, size 0x60, virtual true, abstract: false, final false
inline void InternalWriteObject(::System::Runtime::Serialization::XmlWriterDelegator*  writer, ::System::Object*  graph) ;

/// @brief Method InternalWriteObject, addr 0x6024cdc, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method InternalWriteObjectContent, addr 0x6024d24, size 0x38, virtual true, abstract: false, final false
inline void InternalWriteObjectContent(::System::Runtime::Serialization::XmlWriterDelegator*  writer, ::System::Object*  graph) ;

/// @brief Method InternalWriteStartObject, addr 0x6024cec, size 0x38, virtual true, abstract: false, final false
inline void InternalWriteStartObject(::System::Runtime::Serialization::XmlWriterDelegator*  writer, ::System::Object*  graph) ;

/// @brief Method IsContractDeclared, addr 0x602501c, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method IsRootElement, addr 0x60256dc, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method IsRootXmlAny, addr 0x6025668, size 0x38, virtual false, abstract: false, final false
inline bool IsRootXmlAny(::System::Xml::XmlDictionaryString*  rootName, ::System::Runtime::Serialization::DataContract*  contract) ;

/// @brief Method IsStartElement, addr 0x60256a0, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method ReadObject, addr 0x60251d8, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method ReadObject, addr 0x6025250, size 0x84, virtual true, abstract: false, final false
inline ::System::Object* ReadObject(::System::Xml::XmlReader*  reader, bool  verifyObjectName) ;

/// @brief Method ReadObject, addr 0x60250ec, size 0xec, virtual true, abstract: false, final false
inline ::System::Object* ReadObject(::System::IO::Stream*  stream) ;

/// @brief Method ReadObjectHandleExceptions, addr 0x6018adc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ReadObjectHandleExceptions, addr 0x6025340, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method TryAddLineInfo, addr 0x60258b8, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method WriteEndObject, addr 0x6024660, size 0x78, virtual true, abstract: false, final false
inline void WriteEndObject(::System::Xml::XmlWriter*  writer) ;

/// @brief Method WriteEndObjectHandleExceptions, addr 0x6018918, size 0x148, virtual false, abstract: false, final false
inline void WriteEndObjectHandleExceptions(::System::Runtime::Serialization::XmlWriterDelegator*  writer) ;

/// @brief Method WriteNull, addr 0x6024f88, size 0x94, virtual false, abstract: false, final false
static inline void WriteNull(::System::Runtime::Serialization::XmlWriterDelegator*  writer) ;

/// @brief Method WriteObject, addr 0x6024464, size 0xb0, virtual true, abstract: false, final false
inline void WriteObject(::System::IO::Stream*  stream, ::System::Object*  graph) ;

/// @brief Method WriteObject, addr 0x60246d8, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method WriteObjectContent, addr 0x60245e0, size 0x80, virtual true, abstract: false, final false
inline void WriteObjectContent(::System::Xml::XmlWriter*  writer, ::System::Object*  graph) ;

/// @brief Method WriteObjectContentHandleExceptions, addr 0x6017b10, size 0x54c, virtual false, abstract: false, final false
...
/// @brief Method WriteObjectHandleExceptions, addr 0x6024754, size 0x8, virtual false, abstract: false, final false
inline void WriteObjectHandleExceptions(::System::Runtime::Serialization::XmlWriterDelegator*  writer, ::System::Object*  graph) ;

/// @brief Method WriteObjectHandleExceptions, addr 0x602475c, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method WriteRootElement, addr 0x6024d94, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method WriteStartObject, addr 0x6024560, size 0x80, virtual true, abstract: false, final false
inline void WriteStartObject(::System::Xml::XmlWriter*  writer, ::System::Object*  graph) ;

/// @brief Method WriteStartObjectHandleExceptions, addr 0x601792c, size 0x16c, virtual false, abstract: false, final false
inline void WriteStartObjectHandleExceptions(::System::Runtime::Serialization::XmlWriterDelegator*  writer, ::System::Object*  graph) ;

/// @brief Method .ctor, addr 0x6025c80, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Runtime::Serialization::IFormatterConverter* getStaticF_formatterConverter() ;

/// @brief Method get_FormatterConverter, addr 0x60203cc, size 0x88, virtual false, abstract: false, final false
static inline ::System::Runtime::Serialization::IFormatterConverter* get_FormatterConverter() ;

/// @brief Method get_KnownDataContracts, addr 0x6024c74, size 0x8, virtual true, abstract: false, final false
