...
public:
  ...
  /// @brief Method .ctor, addr 0x615b7e0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsmxCharDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsmxCharDataContract(AsmxCharDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsmxCharDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsmxCharDataContract(AsmxCharDataContractconst&) = delete;
