...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SafeSerializationEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SafeSerializationEventArgs(SafeSerializationEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SafeSerializationEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SafeSerializationEventArgs(SafeSerializationEventArgsconst&) = delete;
