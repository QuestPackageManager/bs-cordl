...
public:
  ...
  /// @brief Method .ctor, addr 0x5a163f4, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_SerializedStates, addr 0x5a164a4, size 0x8, virtual false, abstract: false, final false
