...
public:
  ...
  /// @brief Method .ctor, addr 0x27396e8, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_SerializedStates, addr 0x27397a0, size 0x8, virtual false, abstract: false, final false
