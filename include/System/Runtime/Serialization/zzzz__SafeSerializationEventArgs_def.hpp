...
/// @brief Method .ctor, addr 0x59a4488, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method get_SerializedStates, addr 0x59a4538, size 0x8, virtual false, abstract: false, final false
