...
public:
  ...
  /// @brief Method .ctor, addr 0x615de4c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IDREFDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IDREFDataContract(IDREFDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IDREFDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDREFDataContract(IDREFDataContractconst&) = delete;
