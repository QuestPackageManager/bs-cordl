...
public:
  ...
  /// @brief Method Add, addr 0x3cf6a58, size 0x80, virtual false, abstract: false, final false
  inline void Add(int64_t value);

  /// @brief Method EnlargeArray, addr 0x3cf6d44, size 0x88, virtual false, abstract: false, final false
  inline void EnlargeArray();

  /// @brief Method MoveNext, addr 0x3cf4db0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveElement, addr 0x3cf69a4, size 0x8c, virtual false, abstract: false, final false
  inline bool RemoveElement(int64_t value);

  /// @brief Method StartEnumeration, addr 0x3cf4d64, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cf6a50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cf6cd8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t startingSize);

  /// @brief Method get_Count, addr 0x3cf6dcc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Current, addr 0x3cf4d70, size 0x34, virtual false, abstract: false, final false
