...
public:
  ...
  /// @brief Method Add, addr 0x5b51718, size 0x84, virtual false, abstract: false, final false
  inline void Add(int64_t value);

  /// @brief Method EnlargeArray, addr 0x5b519f8, size 0x8c, virtual false, abstract: false, final false
  inline void EnlargeArray();

  /// @brief Method MoveNext, addr 0x5b4fa94, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveElement, addr 0x5b51660, size 0x90, virtual false, abstract: false, final false
  inline bool RemoveElement(int64_t value);

  /// @brief Method StartEnumeration, addr 0x5b4fa48, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b51710, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b51994, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(int32_t startingSize);

  /// @brief Method get_Count, addr 0x5b51a84, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Current, addr 0x5b4fa54, size 0x34, virtual false, abstract: false, final false
