...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LongList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LongList(LongList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LongList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LongList(LongListconst&) = delete;
