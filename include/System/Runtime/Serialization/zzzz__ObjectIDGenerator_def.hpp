...
public:
  ...
  /// @brief Method FindElement, addr 0x3cf296c, size 0xc4, virtual false, abstract: false, final false
  inline int32_t FindElement(::System::Object* obj, ::ByRef<bool> found);

  /// @brief Method GetId, addr 0x3cf2a30, size 0x180, virtual true, abstract: false, final false
  inline int64_t GetId(::System::Object* obj, ::ByRef<bool> firstTime);

  /// @brief Method HasId, addr 0x3cf2e5c, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rehash, addr 0x3cf2bb0, size 0x2ac, virtual false, abstract: false, final false
  inline void Rehash();
  ...
  /// @brief Method .ctor, addr 0x3cf2894, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();
