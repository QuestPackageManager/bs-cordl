...
public:
  ...
  /// @brief Method FindElement, addr 0x5a11f58, size 0xbc, virtual false, abstract: false, final false
  inline int32_t FindElement(::System::Object* obj, ::ByRef<bool> found);

  /// @brief Method GetId, addr 0x5a12014, size 0x168, virtual true, abstract: false, final false
  inline int64_t GetId(::System::Object* obj, ::ByRef<bool> firstTime);

  /// @brief Method HasId, addr 0x5a1242c, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rehash, addr 0x5a1217c, size 0x2b0, virtual false, abstract: false, final false
  inline void Rehash();
  ...
  /// @brief Method .ctor, addr 0x5a11e7c, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor();
