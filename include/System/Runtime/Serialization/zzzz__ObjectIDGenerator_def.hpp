...
public:
  ...
  /// @brief Method FindElement, addr 0x3cf9314, size 0xc4, virtual false, abstract: false, final false
  inline int32_t FindElement(::System::Object* obj, ::ByRef<bool> found);

  /// @brief Method GetId, addr 0x3cf93d8, size 0x180, virtual true, abstract: false, final false
  inline int64_t GetId(::System::Object* obj, ::ByRef<bool> firstTime);

  /// @brief Method HasId, addr 0x3cf9804, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rehash, addr 0x3cf9558, size 0x2ac, virtual false, abstract: false, final false
  inline void Rehash();
  ...
  /// @brief Method .ctor, addr 0x3cf923c, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();
