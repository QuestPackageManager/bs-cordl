...
public:
  ...
  /// @brief Method FindElement, addr 0x3cf78e0, size 0xc4, virtual false, abstract: false, final false
  inline int32_t FindElement(::System::Object* obj, ::ByRef<bool> found);

  /// @brief Method GetId, addr 0x3cf79a4, size 0x180, virtual true, abstract: false, final false
  inline int64_t GetId(::System::Object* obj, ::ByRef<bool> firstTime);

  /// @brief Method HasId, addr 0x3cf7dd0, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rehash, addr 0x3cf7b24, size 0x2ac, virtual false, abstract: false, final false
  inline void Rehash();
  ...
  /// @brief Method .ctor, addr 0x3cf7808, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();
