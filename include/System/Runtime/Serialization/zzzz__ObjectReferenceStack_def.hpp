...
public:
  ...
  /// @brief Method Contains, addr 0x60178c0, size 0xf8, virtual false, abstract: false, final false
  inline bool Contains(::System::Object* obj);

  /// @brief Method EnsureSetAsIsReference, addr 0x60176fc, size 0x144, virtual false, abstract: false, final false
  inline void EnsureSetAsIsReference(::System::Object* obj);

  /// @brief Method Pop, addr 0x6017840, size 0x80, virtual false, abstract: false, final false
  inline void Pop(::System::Object* obj);

  /// @brief Method Push, addr 0x60174e4, size 0x218, virtual false, abstract: false, final false
  inline void Push(::System::Object* obj);

  /// @brief Method get_Count, addr 0x60179b8, size 0x8, virtual false, abstract: false, final false
