...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::IObjectReference*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::IObjectReference*, "System.Runtime.Serialization", "IObjectReference");
// Dependencies
namespace System::Runtime::Serialization {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IObjectReference", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IObjectReference(IObjectReferenceconst&) = delete;
