...
public:
  ...
  /// @brief Method CreateAnyElementType, addr 0x601df70, size 0x17c, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* CreateAnyElementType();

  /// @brief Method CreateAnyType, addr 0x601e1cc, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* CreateAnyType();

  /// @brief Method ExportActualType, addr 0x601cdb0, size 0x144, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlElement* ExportActualType(::System::Xml::XmlQualifiedName* typeName, ::System::Xml::XmlDocument* xmlDoc);

  /// @brief Method GetSchemaAnnotation, addr 0x601e0ec, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetXmlTypeInfo, addr 0x601cfd8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeSchemaProviderMethod, addr 0x601d318, size 0xc58, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSpecialXmlType, addr 0x601d14c, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ActualTypeAnnotationName, addr 0x601cef4, size 0xe4, virtual false, abstract: false, final false
