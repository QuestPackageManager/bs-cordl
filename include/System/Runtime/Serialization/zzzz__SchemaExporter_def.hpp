...
/// @brief Method CreateAnyElementType, addr 0x5fabf64, size 0x17c, virtual false, abstract: false, final false
static inline ::System::Xml::Schema::XmlSchemaComplexType* CreateAnyElementType() ;

/// @brief Method CreateAnyType, addr 0x5fac1c0, size 0x1b8, virtual false, abstract: false, final false
static inline ::System::Xml::Schema::XmlSchemaComplexType* CreateAnyType() ;

/// @brief Method ExportActualType, addr 0x5faada4, size 0x144, virtual false, abstract: false, final false
static inline ::System::Xml::XmlElement* ExportActualType(::System::Xml::XmlQualifiedName*  typeName, ::System::Xml::XmlDocument*  xmlDoc) ;

/// @brief Method GetSchemaAnnotation, addr 0x5fac0e0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetXmlTypeInfo, addr 0x5faafcc, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method InvokeSchemaProviderMethod, addr 0x5fab30c, size 0xc58, virtual false, abstract: false, final false
static inline bool InvokeSchemaProviderMethod(::System::Type*  clrType, ::System::Xml::Schema::XmlSchemaSet*  schemas, ::ByRef<::System::Xml::XmlQualifiedName*>  stableName, ::ByRef<::System::Xml::Schema::XmlSchemaType*>  xsdType, ::ByRef<bool>  hasRoot) ;

/// @brief Method IsSpecialXmlType, addr 0x5fab140, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method get_ActualTypeAnnotationName, addr 0x5faaee8, size 0xe4, virtual false, abstract: false, final false
