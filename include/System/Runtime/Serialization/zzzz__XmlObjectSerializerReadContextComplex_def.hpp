...
/// @brief Method ResolveType, addr 0x5fb9504, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fb8fc8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fb9054, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::Assembly*  assembly, ::System::Type*  type) ;

/// @brief Method get_Assembly, addr 0x5fb956c, size 0x8, virtual false, abstract: false, final false
inline ::System::Reflection::Assembly* get_Assembly() ;

/// @brief Method get_Type, addr 0x5fb9574, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x5fb957c, size 0xbc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x5fb9638, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fb8e98, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CheckIfTypeSerializable, addr 0x5fb918c, size 0x140, virtual true, abstract: false, final false
inline void CheckIfTypeSerializable(::System::Type*  memberType, bool  isMemberTypeSerializable) ;

/// @brief Method CheckIfTypeSerializableForSharedTypeMode, addr 0x5fb90b8, size 0xd4, virtual false, abstract: false, final false
inline bool CheckIfTypeSerializableForSharedTypeMode(::System::Type*  memberType) ;

/// @brief Method CheckTypeForwardedTo, addr 0x5fb8fd0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method GetArraySize, addr 0x5fb93ec, size 0x28, virtual true, abstract: false, final false
inline int32_t GetArraySize() ;

/// @brief Method GetDataContract, addr 0x5fb7bd8, size 0x1ac, virtual true, abstract: false, final false
inline ::System::Runtime::Serialization::DataContract* GetDataContract(int32_t  id, ::System::RuntimeTypeHandle  typeHandle) ;

/// @brief Method GetDataContract, addr 0x5fb7d84, size 0x1ac, virtual true, abstract: false, final false
inline ::System::Runtime::Serialization::DataContract* GetDataContract(::System::RuntimeTypeHandle  typeHandle, ::System::Type*  type) ;

/// @brief Method GetSurrogatedType, addr 0x5fb92cc, size 0x120, virtual true, abstract: false, final false
inline ::System::Type* GetSurrogatedType(::System::Type*  type) ;

/// @brief Method InternalDeserialize, addr 0x5fb87fc, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method InternalDeserialize, addr 0x5fb8730, size 0xcc, virtual true, abstract: false, final false
...
/// @brief Method InternalDeserialize, addr 0x5fb7f30, size 0xfc, virtual true, abstract: false, final false
inline ::System::Object* InternalDeserialize(::System::Runtime::Serialization::XmlReaderDelegator*  xmlReader, int32_t  declaredTypeID, ::System::RuntimeTypeHandle  declaredTypeHandle, ::StringW  name, ::StringW  ns) ;

/// @brief Method InternalDeserializeInSharedTypeMode, addr 0x5fb82b0, size 0x480, virtual false, abstract: false, final false
inline ::System::Object* InternalDeserializeInSharedTypeMode(::System::Runtime::Serialization::XmlReaderDelegator*  xmlReader, int32_t  declaredTypeID, ::System::Type*  declaredType, ::StringW  name, ::StringW  ns) ;

/// @brief Method InternalDeserializeWithSurrogate, addr 0x5fb802c, size 0x284, virtual false, abstract: false, final false
inline ::System::Object* InternalDeserializeWithSurrogate(::System::Runtime::Serialization::XmlReaderDelegator*  xmlReader, ::System::Type*  declaredType, ::System::Runtime::Serialization::DataContract*  surrogateDataContract, ::StringW  name, ::StringW  ns) ;

static inline ::System::Runtime::Serialization::XmlObjectSerializerReadContextComplex* New_ctor(::System::Runtime::Serialization::DataContractSerializer*  serializer, ::System::Runtime::Serialization::DataContract*  rootTypeDataContract, ::System::Runtime::Serialization::DataContractResolver*  dataContractResolver) ;

/// @brief Method ResolveDataContractFromTypeName, addr 0x5fb905c, size 0x5c, virtual true, abstract: false, final false
inline ::System::Runtime::Serialization::DataContract* ResolveDataContractFromTypeName() ;

/// @brief Method ResolveDataContractInSharedTypeMode, addr 0x5fb882c, size 0x5c, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::DataContract* ResolveDataContractInSharedTypeMode(::StringW  assemblyName, ::StringW  typeName, ::ByRef<::System::Reflection::Assembly*>  assembly, ::ByRef<::System::Type*>  type) ;

/// @brief Method ResolveDataContractTypeInSharedTypeMode, addr 0x5fb8888, size 0x610, virtual false, abstract: false, final false
...
/// @brief Method ResolveSimpleAssemblyName, addr 0x5fb8ea0, size 0x128, virtual false, abstract: false, final false
static inline ::System::Reflection::Assembly* ResolveSimpleAssemblyName(::StringW  assemblyName) ;

/// @brief Method ResolveSimpleAssemblyName, addr 0x5fb9414, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fb3240, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_Mode, addr 0x5fb7bd0, size 0x8, virtual true, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Serialization::XmlObjectSerializerReadContextComplex_TopLevelAssemblyTypeResolver*, "System.Runtime.Serialization", "XmlObjectSerializerReadContextComplex/TopLevelAssemblyTypeResolver");
NEED_NO_BOX(::System::Runtime::Serialization::XmlObjectSerializerReadContextComplex_XmlObjectDataContractTypeInfo);
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Serialization::XmlObjectSerializerReadContextComplex_XmlObjectDataContractTypeInfo*, "System.Runtime.Serialization", "XmlObjectSerializerReadContextComplex/XmlObjectDataContractTypeInfo");
NEED_NO_BOX(::System::Runtime::Serialization::XmlObjectSerializerReadContextComplex_XmlObjectDataContractTypeKey);
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Serialization::XmlObjectSerializerReadContextComplex_XmlObjectDataContractTypeKey*, "System.Runtime.Serialization", "XmlObjectSerializerReadContextComplex/XmlObjectDataContractTypeKey");
