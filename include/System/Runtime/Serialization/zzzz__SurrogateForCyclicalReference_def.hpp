...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3cf26e8, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x3cf27b8, size 0xdc, virtual true, abstract: false, final true
