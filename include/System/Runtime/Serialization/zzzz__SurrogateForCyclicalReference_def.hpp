...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5a11cc0, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x5a11d94, size 0xe8, virtual true, abstract: false, final true
