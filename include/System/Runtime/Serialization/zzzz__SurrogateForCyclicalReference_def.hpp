...
public:
  ...
  /// @brief Method GetObjectData, addr 0x260d8a0, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x260d970, size 0xdc, virtual true, abstract: false, final true
