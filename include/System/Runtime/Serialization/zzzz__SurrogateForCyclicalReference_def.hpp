...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b4d508, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x5b4d5dc, size 0xe8, virtual true, abstract: false, final true
