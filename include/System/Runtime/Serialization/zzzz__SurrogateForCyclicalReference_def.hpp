...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::SurrogateForCyclicalReference*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::SurrogateForCyclicalReference*, "System.Runtime.Serialization", "SurrogateForCyclicalReference");
...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b4f808, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x5b4f8dc, size 0xe8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SurrogateForCyclicalReference", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SurrogateForCyclicalReference(SurrogateForCyclicalReference&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SurrogateForCyclicalReference", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SurrogateForCyclicalReference(SurrogateForCyclicalReferenceconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::SurrogateForCyclicalReference) == 0x18, "Size mismatch!");
