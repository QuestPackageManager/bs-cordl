...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2734c8c, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x2734d5c, size 0xdc, virtual true, abstract: false, final true
