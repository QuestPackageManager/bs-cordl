...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3d04bec, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x3d04cbc, size 0xdc, virtual true, abstract: false, final true
