...
public:
  ...
  /// @brief Method GetObjectData, addr 0x2853710, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x28537e0, size 0xdc, virtual true, abstract: false, final true
