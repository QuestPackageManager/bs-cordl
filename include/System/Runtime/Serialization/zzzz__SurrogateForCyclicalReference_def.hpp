...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3cf9090, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x3cf9160, size 0xdc, virtual true, abstract: false, final true
