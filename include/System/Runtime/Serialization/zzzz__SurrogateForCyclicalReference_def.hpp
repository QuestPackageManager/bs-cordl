...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3cf765c, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method SetObjectData, addr 0x3cf772c, size 0xdc, virtual true, abstract: false, final true
