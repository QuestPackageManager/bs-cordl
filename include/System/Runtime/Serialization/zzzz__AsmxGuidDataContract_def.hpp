...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::AsmxGuidDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::AsmxGuidDataContract*, "System.Runtime.Serialization", "AsmxGuidDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x61593f0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Runtime::Serialization::AsmxGuidDataContract) == 0x30, "Size mismatch!");
