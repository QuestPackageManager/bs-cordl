...
public:
  ...
  /// @brief Method AddSurrogate, addr 0x3cfe970, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method GetSurrogate, addr 0x3cfeaec, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cfe900, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
