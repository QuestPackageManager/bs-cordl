...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::TokenDataContract*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::TokenDataContract*, "System.Runtime.Serialization", "TokenDataContract");
...
public:
  ...
  /// @brief Method .ctor, addr 0x615dc44, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TokenDataContract", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TokenDataContract(TokenDataContract&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TokenDataContract", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TokenDataContract(TokenDataContractconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::TokenDataContract) == 0x30, "Size mismatch!");
