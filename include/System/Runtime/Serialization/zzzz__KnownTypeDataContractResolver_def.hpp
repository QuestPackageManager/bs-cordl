...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KnownTypeDataContractResolver", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KnownTypeDataContractResolver(KnownTypeDataContractResolver&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KnownTypeDataContractResolver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KnownTypeDataContractResolver(KnownTypeDataContractResolverconst&) = delete;
