...
/// @brief Method ResolveName, addr 0x5fa3b68, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method TryResolveType, addr 0x5fa39e4, size 0x11c, virtual true, abstract: false, final false
inline bool TryResolveType(::System::Type*  type, ::System::Type*  declaredType, ::System::Runtime::Serialization::DataContractResolver*  knownTypeResolver, ::ByRef<::System::Xml::XmlDictionaryString*>  typeName, ::ByRef<::System::Xml::XmlDictionaryString*>  typeNamespace) ;
...
/// @brief Method .ctor, addr 0x5fa39dc, size 0x8, virtual false, abstract: false, final false
