...
// Write type traits
MARK_REF_PTR_T(::System::Runtime::Serialization::NormalizedStringDataContract);
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f414f8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::System::Runtime::Serialization::NormalizedStringDataContract, 0x30>, "Size mismatch!");

} // namespace System::Runtime::Serialization
NEED_NO_BOX(::System::Runtime::Serialization::NormalizedStringDataContract);
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Serialization::NormalizedStringDataContract*, "System.Runtime.Serialization", "NormalizedStringDataContract");
