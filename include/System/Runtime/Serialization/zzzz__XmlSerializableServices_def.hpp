...
/// @brief Method IsValidAttribute, addr 0x5fc4290, size 0xf8, virtual false, abstract: false, final false
static inline bool IsValidAttribute(::System::Xml::XmlReader*  xmlReader) ;

/// @brief Method ReadNodes, addr 0x5fc3f0c, size 0x324, virtual false, abstract: false, final false
