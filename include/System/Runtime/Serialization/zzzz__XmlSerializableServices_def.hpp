...
public:
  ...
  /// @brief Method IsValidAttribute, addr 0x603629c, size 0xf8, virtual false, abstract: false, final false
  static inline bool IsValidAttribute(::System::Xml::XmlReader* xmlReader);

  /// @brief Method ReadNodes, addr 0x6035f18, size 0x324, virtual false, abstract: false, final false
