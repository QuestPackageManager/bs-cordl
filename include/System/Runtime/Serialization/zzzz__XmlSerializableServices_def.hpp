...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::XmlSerializableServices*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::XmlSerializableServices*, "System.Runtime.Serialization", "XmlSerializableServices");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializableServices", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlSerializableServices(XmlSerializableServices&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlSerializableServices", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlSerializableServices(XmlSerializableServicesconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Serialization::XmlSerializableServices) == 0x10, "Size mismatch!");
