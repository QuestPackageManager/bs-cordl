...
/// @brief Method <WriteCollection>b__1, addr 0x5fcf6e0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fcedec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <WriteMembers>b__0, addr 0x5fcf6e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fcedf0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <WriteValue>b__0, addr 0x5fcf6f0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fcf2e4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CheckIfConflictingMembersHaveDifferentTypes, addr 0x5fcf19c, size 0x98, virtual false, abstract: false, final false
inline bool CheckIfConflictingMembersHaveDifferentTypes(::System::Runtime::Serialization::DataMember*  member) ;

/// @brief Method CheckIfMemberHasConflict, addr 0x5fcee50, size 0x180, virtual false, abstract: false, final false
inline bool CheckIfMemberHasConflict(::System::Runtime::Serialization::DataMember*  member, ::System::Runtime::Serialization::ClassDataContract*  classContract, ::System::Runtime::Serialization::ClassDataContract*  derivedMostClassContract) ;

/// @brief Method GetDefaultValue, addr 0x5fcefd0, size 0x1cc, virtual false, abstract: false, final false
inline ::System::Object* GetDefaultValue(::System::Type*  type) ;

/// @brief Method InitArgs, addr 0x5fcbd38, size 0x154, virtual false, abstract: false, final false
inline void InitArgs(::System::Type*  objType) ;

/// @brief Method InvokeOnSerialized, addr 0x5fcd404, size 0x15c, virtual false, abstract: false, final false
inline void InvokeOnSerialized(::System::Runtime::Serialization::ClassDataContract*  classContract, ::System::Object*  objSerialized, ::System::Runtime::Serialization::XmlObjectSerializerWriteContext*  ctx) ;

/// @brief Method InvokeOnSerializing, addr 0x5fcd2a8, size 0x15c, virtual false, abstract: false, final false
inline void InvokeOnSerializing(::System::Runtime::Serialization::ClassDataContract*  classContract, ::System::Object*  objSerialized, ::System::Runtime::Serialization::XmlObjectSerializerWriteContext*  ctx) ;

/// @brief Method IsDefaultValue, addr 0x5fcee1c, size 0x34, virtual false, abstract: false, final false
inline bool IsDefaultValue(::System::Type*  type, ::System::Object*  value) ;

/// @brief Method LoadMemberValue, addr 0x5fcedf4, size 0x28, virtual false, abstract: false, final false
inline ::System::Object* LoadMemberValue(::System::Runtime::Serialization::DataMember*  member) ;

/// @brief Method NeedsPrefix, addr 0x5fcf234, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method TryWritePrimitive, addr 0x5fcdd50, size 0x484, virtual false, abstract: false, final false
inline bool TryWritePrimitive(::System::Type*  type, ::System::Func_1<::System::Object*>*  value, ::System::Reflection::MemberInfo*  memberInfo, ::System::Nullable_1<int32_t>  arrayItemIndex, ::System::Xml::XmlDictionaryString*  ns, ::System::Xml::XmlDictionaryString*  name, int32_t  nameIndex) ;

/// @brief Method TryWritePrimitiveArray, addr 0x5fcd9c4, size 0x38c, virtual false, abstract: false, final false
inline bool TryWritePrimitiveArray(::System::Type*  type, ::System::Type*  itemType, ::System::Func_1<::System::Object*>*  value, ::System::Xml::XmlDictionaryString*  itemName, ::System::Xml::XmlDictionaryString*  itemNamespace) ;

/// @brief Method UnwrapNullableObject, addr 0x5fcf2e8, size 0x3f0, virtual false, abstract: false, final false
...
/// @brief Method WriteClass, addr 0x5fcbe8c, size 0x2b0, virtual false, abstract: false, final false
inline void WriteClass(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method WriteCollection, addr 0x5fcc1a8, size 0x1100, virtual false, abstract: false, final false
inline void WriteCollection(::System::Runtime::Serialization::CollectionDataContract*  collectionContract) ;

/// @brief Method WriteCollectionToXml, addr 0x5fcc13c, size 0x6c, virtual false, abstract: false, final false
inline void WriteCollectionToXml(::System::Runtime::Serialization::XmlWriterDelegator*  xmlWriter, ::System::Object*  obj, ::System::Runtime::Serialization::XmlObjectSerializerWriteContext*  context, ::System::Runtime::Serialization::CollectionDataContract*  collectionContract) ;

/// @brief Method WriteEndElement, addr 0x5fcedd8, size 0x14, virtual false, abstract: false, final false
inline void WriteEndElement() ;

/// @brief Method WriteMembers, addr 0x5fcd560, size 0x464, virtual false, abstract: false, final false
inline int32_t WriteMembers(::System::Runtime::Serialization::ClassDataContract*  classContract, ::System::Runtime::Serialization::ExtensionDataObject*  extensionData, ::System::Runtime::Serialization::ClassDataContract*  derivedMostClassContract) ;

/// @brief Method WriteStartElement, addr 0x5fce1d4, size 0xd0, virtual false, abstract: false, final false
inline void WriteStartElement(::System::Type*  type, ::System::Xml::XmlDictionaryString*  ns, ::System::Xml::XmlDictionaryString*  namespaceLocal, ::System::Xml::XmlDictionaryString*  nameLocal, int32_t  nameIndex) ;

/// @brief Method WriteToXml, addr 0x5fcbccc, size 0x6c, virtual false, abstract: false, final false
inline void WriteToXml(::System::Runtime::Serialization::XmlWriterDelegator*  xmlWriter, ::System::Object*  obj, ::System::Runtime::Serialization::XmlObjectSerializerWriteContext*  context, ::System::Runtime::Serialization::ClassDataContract*  dataContract) ;

/// @brief Method WriteValue, addr 0x5fce2a4, size 0xb34, virtual false, abstract: false, final false
inline void WriteValue(::System::Type*  memberType, ::System::Object*  memberValue, bool  writeXsiType) ;

/// @brief Method <WriteCollection>b__24_0, addr 0x5fcf6d8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fcbbec, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::ClassDataContract*  classContract) ;

/// @brief Method .ctor, addr 0x5fcbbfc, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::CollectionDataContract*  collectionContract) ;

/// @brief Method get_classDataContract, addr 0x5fcbc0c, size 0x60, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ClassDataContract* get_classDataContract() ;

/// @brief Method get_collectionDataContract, addr 0x5fcbc6c, size 0x60, virtual false, abstract: false, final false
