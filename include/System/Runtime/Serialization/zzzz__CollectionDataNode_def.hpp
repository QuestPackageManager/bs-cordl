...
public:
  ...
  /// @brief Method Clear, addr 0x600e608, size 0x50, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method GetData, addr 0x600e420, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x600e25c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ItemName, addr 0x600e3f0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ItemName();

  /// @brief Method get_ItemNamespace, addr 0x600e400, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ItemNamespace();

  /// @brief Method get_Items, addr 0x600e3e0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::System::Runtime::Serialization::IDataNode*>* get_Items();

  /// @brief Method get_Size, addr 0x600e410, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Size();

  /// @brief Method set_ItemName, addr 0x600e3f8, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemName(::StringW value);

  /// @brief Method set_ItemNamespace, addr 0x600e408, size 0x8, virtual false, abstract: false, final false
  inline void set_ItemNamespace(::StringW value);

  /// @brief Method set_Items, addr 0x600e3e8, size 0x8, virtual false, abstract: false, final false
  inline void set_Items(::System::Collections::Generic::IList_1<::System::Runtime::Serialization::IDataNode*>* value);

  /// @brief Method set_Size, addr 0x600e418, size 0x8, virtual false, abstract: false, final false
