...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CollectionDataNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CollectionDataNode(CollectionDataNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CollectionDataNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CollectionDataNode(CollectionDataNodeconst&) = delete;
