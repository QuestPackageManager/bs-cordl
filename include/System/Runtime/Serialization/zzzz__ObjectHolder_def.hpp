...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectHolder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectHolder(ObjectHolder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectHolder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectHolder(ObjectHolderconst&) = delete;
