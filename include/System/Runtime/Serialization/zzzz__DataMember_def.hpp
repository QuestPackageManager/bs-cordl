...
public:
  ...
  /// @brief Method .ctor, addr 0x600a51c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* memberInfo);

  /// @brief Method get_ConflictingMember, addr 0x600aae8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataMember* get_ConflictingMember();

  /// @brief Method get_EmitDefaultValue, addr 0x600aaa8, size 0x8, virtual false, abstract: false, final false
  inline bool get_EmitDefaultValue();

  /// @brief Method get_HasConflictingNameAndType, addr 0x600aad8, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasConflictingNameAndType();

  /// @brief Method get_IsGetOnlyCollection, addr 0x600aac8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsGetOnlyCollection();

  /// @brief Method get_IsNullable, addr 0x600aab8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_IsRequired, addr 0x600aa98, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsRequired();

  /// @brief Method get_MemberInfo, addr 0x600aa70, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_MemberInfo();

  /// @brief Method get_MemberType, addr 0x600a688, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Type* get_MemberType();

  /// @brief Method get_MemberTypeContract, addr 0x600a774, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* get_MemberTypeContract();

  /// @brief Method get_Name, addr 0x600aa78, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Order, addr 0x600aa88, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method set_ConflictingMember, addr 0x600aaf0, size 0x8, virtual false, abstract: false, final false
  inline void set_ConflictingMember(::System::Runtime::Serialization::DataMember* value);

  /// @brief Method set_EmitDefaultValue, addr 0x600aab0, size 0x8, virtual false, abstract: false, final false
  inline void set_EmitDefaultValue(bool value);

  /// @brief Method set_HasConflictingNameAndType, addr 0x600aae0, size 0x8, virtual false, abstract: false, final false
  inline void set_HasConflictingNameAndType(bool value);

  /// @brief Method set_IsGetOnlyCollection, addr 0x600aad0, size 0x8, virtual false, abstract: false, final false
  inline void set_IsGetOnlyCollection(bool value);

  /// @brief Method set_IsNullable, addr 0x600aac0, size 0x8, virtual false, abstract: false, final false
  inline void set_IsNullable(bool value);

  /// @brief Method set_IsRequired, addr 0x600aaa0, size 0x8, virtual false, abstract: false, final false
  inline void set_IsRequired(bool value);

  /// @brief Method set_Name, addr 0x600aa80, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Order, addr 0x600aa90, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x600a888, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x600aa5c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x600a4b4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* memberInfo);

  /// @brief Method get_ConflictingMember, addr 0x600a858, size 0x18, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataMember* get_ConflictingMember();

  /// @brief Method get_EmitDefaultValue, addr 0x600a5d8, size 0x18, virtual false, abstract: false, final false
  inline bool get_EmitDefaultValue();

  /// @brief Method get_HasConflictingNameAndType, addr 0x600a824, size 0x18, virtual false, abstract: false, final false
  inline bool get_HasConflictingNameAndType();

  /// @brief Method get_IsGetOnlyCollection, addr 0x600a640, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsGetOnlyCollection();

  /// @brief Method get_IsNullable, addr 0x600a60c, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsNullable();

  /// @brief Method get_IsRequired, addr 0x600a5a4, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsRequired();

  /// @brief Method get_MemberInfo, addr 0x600a52c, size 0x18, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_MemberInfo();

  /// @brief Method get_MemberType, addr 0x600a674, size 0x14, virtual false, abstract: false, final false
  inline ::System::Type* get_MemberType();

  /// @brief Method get_MemberTypeContract, addr 0x600a760, size 0x14, virtual false, abstract: false, final false
  inline ::System::Runtime::Serialization::DataContract* get_MemberTypeContract();

  /// @brief Method get_Name, addr 0x600a544, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Order, addr 0x600a574, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_Order();

  /// @brief Method set_ConflictingMember, addr 0x600a870, size 0x18, virtual false, abstract: false, final false
  inline void set_ConflictingMember(::System::Runtime::Serialization::DataMember* value);

  /// @brief Method set_EmitDefaultValue, addr 0x600a5f0, size 0x1c, virtual false, abstract: false, final false
  inline void set_EmitDefaultValue(bool value);

  /// @brief Method set_HasConflictingNameAndType, addr 0x600a83c, size 0x1c, virtual false, abstract: false, final false
  inline void set_HasConflictingNameAndType(bool value);

  /// @brief Method set_IsGetOnlyCollection, addr 0x600a658, size 0x1c, virtual false, abstract: false, final false
  inline void set_IsGetOnlyCollection(bool value);

  /// @brief Method set_IsNullable, addr 0x600a624, size 0x1c, virtual false, abstract: false, final false
  inline void set_IsNullable(bool value);

  /// @brief Method set_IsRequired, addr 0x600a5bc, size 0x1c, virtual false, abstract: false, final false
  inline void set_IsRequired(bool value);

  /// @brief Method set_Name, addr 0x600a55c, size 0x18, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Order, addr 0x600a58c, size 0x18, virtual false, abstract: false, final false
  inline void set_Order(int32_t value);
