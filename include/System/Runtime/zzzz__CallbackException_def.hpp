...
// Write type traits
MARK_REF_T(::System::Runtime::CallbackException*);
DEFINE_IL2CPP_CLASS(::System::Runtime::CallbackException*, "System.Runtime", "CallbackException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6185980, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x61859a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x6185990, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CallbackException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CallbackException(CallbackException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CallbackException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CallbackException(CallbackExceptionconst&) = delete;
...
static_assert(sizeof(::System::Runtime::CallbackException) == 0x90, "Size mismatch!");
