...
template <typename T> inline void System::Runtime::CompilerServices::TrueReadOnlyCollection_1<T>::_ctor(/* [ParamArray] */ ::ArrayW<T> list) {
...
template <typename T>
inline ::System::Runtime::CompilerServices::TrueReadOnlyCollection_1<T>* System::Runtime::CompilerServices::TrueReadOnlyCollection_1<T>::New_ctor(/* [ParamArray] */ ::ArrayW<T> list) {
