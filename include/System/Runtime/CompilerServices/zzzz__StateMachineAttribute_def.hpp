...
public:
  ...
  /// @brief Method .ctor, addr 0x5a31d74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* stateMachineType);

  /// @brief Method get_StateMachineType, addr 0x5a32cac, size 0x8, virtual false, abstract: false, final false
