...
public:
  ...
  /// @brief Method .ctor, addr 0x3d257a0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* stateMachineType);

  /// @brief Method get_StateMachineType, addr 0x3d265cc, size 0x8, virtual false, abstract: false, final false
