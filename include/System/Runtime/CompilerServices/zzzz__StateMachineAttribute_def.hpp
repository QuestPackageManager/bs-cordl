...
public:
  ...
  /// @brief Method .ctor, addr 0x3d18198, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* stateMachineType);

  /// @brief Method get_StateMachineType, addr 0x3d18fc4, size 0x8, virtual false, abstract: false, final false
