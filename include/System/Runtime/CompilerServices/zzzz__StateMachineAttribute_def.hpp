...
public:
  ...
  /// @brief Method .ctor, addr 0x3d1329c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* stateMachineType);

  /// @brief Method get_StateMachineType, addr 0x3d140c8, size 0x8, virtual false, abstract: false, final false
