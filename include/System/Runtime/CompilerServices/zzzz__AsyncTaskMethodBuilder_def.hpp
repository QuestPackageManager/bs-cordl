...
public:
  ...
  /// @brief Method Create, addr 0x3d1a35c, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder Create();

  /// @brief Method SetException, addr 0x3d18424, size 0x7c, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method SetResult, addr 0x3d1831c, size 0xa4, virtual false, abstract: false, final false
  inline void SetResult();

  /// @brief Method SetStateMachine, addr 0x3d18230, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Task, addr 0x3d18530, size 0x6c, virtual false, abstract: false, final false
