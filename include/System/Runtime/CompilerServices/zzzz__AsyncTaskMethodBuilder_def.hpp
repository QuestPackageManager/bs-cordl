...
public:
  ...
  /// @brief Method Create, addr 0x3d1a3d4, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder Create();

  /// @brief Method SetException, addr 0x3d1849c, size 0x7c, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method SetResult, addr 0x3d18394, size 0xa4, virtual false, abstract: false, final false
  inline void SetResult();

  /// @brief Method SetStateMachine, addr 0x3d182a8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Task, addr 0x3d185a8, size 0x6c, virtual false, abstract: false, final false
