...
public:
  ...
  /// @brief Method Create, addr 0x5a341e0, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder Create();

  /// @brief Method SetException, addr 0x5a31ff8, size 0x84, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method SetResult, addr 0x5a31ee0, size 0xb0, virtual false, abstract: false, final false
  inline void SetResult();

  /// @brief Method SetStateMachine, addr 0x5a31df0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Task, addr 0x5a32108, size 0x74, virtual false, abstract: false, final false
