...
namespace System::Runtime::CompilerServices {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 880 }), TypeDefinitionIndex(TypeDefinitionIndex(3397)),
// TypeDefinitionIndex(TypeDefinitionIndex(2790))} Self: TypeDefinitionIndex(TypeDefinitionIndex(3396)) CS Name: ::System.Runtime.CompilerServices::AsyncTaskMethodBuilder
...
public:
  ...
  /// @brief Method Create addr 0x2382ec4 size 0xc virtual false final false
  ...
  /// @brief Method SetStateMachine addr 0x2382ed0 size 0x58 virtual false final false
  ...
  /// @brief Method get_Task addr 0x2382f28 size 0x48 virtual false final false
  inline ::System::Threading::Tasks::Task* get_Task();

  /// @brief Method SetResult addr 0x2382f70 size 0x78 virtual false final false
  inline void SetResult();

  /// @brief Method SetException addr 0x2382fe8 size 0x58 virtual false final false
