...
public:
  ...
  /// @brief Method Create, addr 0x2876f4c, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder Create();

  /// @brief Method SetException, addr 0x2874d98, size 0x58, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method SetResult, addr 0x2874d1c, size 0x78, virtual false, abstract: false, final false
  inline void SetResult();

  /// @brief Method SetStateMachine, addr 0x2874cac, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Task, addr 0x2874e38, size 0x48, virtual false, abstract: false, final false
