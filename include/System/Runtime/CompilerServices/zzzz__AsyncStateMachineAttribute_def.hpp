...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsyncStateMachineAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsyncStateMachineAttribute(AsyncStateMachineAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsyncStateMachineAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsyncStateMachineAttribute(AsyncStateMachineAttributeconst&) = delete;
