...
// [AttributeUsage((System.AttributeTargets)1036, AllowMultiple = true, Inherited = false)]
...
public:
  ...
  /// @brief Method .ctor, addr 0x5b72e64, size 0x58, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TypeDependencyAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TypeDependencyAttribute(TypeDependencyAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TypeDependencyAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TypeDependencyAttribute(TypeDependencyAttributeconst&) = delete;
