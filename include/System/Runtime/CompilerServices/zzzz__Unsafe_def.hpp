...
/// @brief Method AddByteOffset, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ByRef<T> AddByteOffset(::ByRef<T>  source, uint64_t  byteOffset) ;
...
/// @brief Method InitBlockUnaligned, addr 0x59c350c, size 0x8, virtual false, abstract: false, final false
