...
public:
  ...
  /// @brief Method InvokeMoveNext, addr 0x3d1adcc, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x3d1abcc, size 0x200, virtual false, abstract: false, final false
  inline void Run();
  ...
  /// @brief Method .ctor, addr 0x3d1a7a8, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Invoke, addr 0x3d1aeac, size 0x24, virtual false, abstract: false, final false
  inline void Invoke();
  ...
  /// @brief Method .ctor, addr 0x3d1aaec, size 0x4c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <OutputAsyncCausalityEvents>b__0, addr 0x3d1aed0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d1a890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ThrowAsync>b__7_0, addr 0x3d1af90, size 0x54, virtual false, abstract: false, final false
  inline void _ThrowAsync_b__7_0(::System::Object* state);

  /// @brief Method <ThrowAsync>b__7_1, addr 0x3d1afe4, size 0x54, virtual false, abstract: false, final false
  inline void _ThrowAsync_b__7_1(::System::Object* state);

  /// @brief Method .ctor, addr 0x3d1af88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateContinuationWrapper, addr 0x3d1a898, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCompletionAction, addr 0x3d1a5f0, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method OutputAsyncCausalityEvents, addr 0x3d1a7d4, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Action* OutputAsyncCausalityEvents(::System::Threading::Tasks::Task* innerTask, ::System::Action* continuation);

  /// @brief Method PostBoxInitialization, addr 0x3d1a954, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method SetStateMachine, addr 0x3d19dac, size 0xbc, virtual false, abstract: false, final false
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);

  /// @brief Method ThrowAsync, addr 0x3d1a0fc, size 0x2d8, virtual false, abstract: false, final false
  static inline void ThrowAsync(::System::Exception* exception, ::System::Threading::SynchronizationContext* targetContext);

  /// @brief Method TryGetContinuationTask, addr 0x3d1ab38, size 0x94, virtual false, abstract: false, final false
