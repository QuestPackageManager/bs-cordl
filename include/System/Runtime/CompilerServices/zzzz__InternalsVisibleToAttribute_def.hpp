...
public:
  ...
  /// @brief Method .ctor, addr 0x5a35300, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyName);

  /// @brief Method set_AllInternalsVisible, addr 0x5a35310, size 0x8, virtual false, abstract: false, final false
