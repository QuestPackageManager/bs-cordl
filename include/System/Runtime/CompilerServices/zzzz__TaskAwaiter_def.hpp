...
public:
  ...
  /// @brief Method <OutputWaitEtwEvents>b__0, addr 0x3d19b18, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d19b10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetResult, addr 0x3d19738, size 0x8, virtual false, abstract: false, final false
  inline void GetResult();

  /// @brief Method HandleNonSuccessAndDebuggerNotification, addr 0x3d1978c, size 0x60, virtual false, abstract: false, final false
  static inline void HandleNonSuccessAndDebuggerNotification(::System::Threading::Tasks::Task* task);

  /// @brief Method OnCompleted, addr 0x3d1931c, size 0x10, virtual true, abstract: false, final true
  inline void OnCompleted(::System::Action* continuation);

  /// @brief Method OnCompletedInternal, addr 0x3d19688, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method OutputWaitEtwEvents, addr 0x3d19938, size 0x1d8, virtual false, abstract: false, final false
  static inline ::System::Action* OutputWaitEtwEvents(::System::Threading::Tasks::Task* task, ::System::Action* continuation);

  /// @brief Method ThrowForNonSuccess, addr 0x3d197ec, size 0x14c, virtual false, abstract: false, final false
  static inline void ThrowForNonSuccess(::System::Threading::Tasks::Task* task);

  /// @brief Method UnsafeOnCompleted, addr 0x3d194b8, size 0x10, virtual true, abstract: false, final true
  inline void UnsafeOnCompleted(::System::Action* continuation);

  /// @brief Method ValidateEnd, addr 0x3d19740, size 0x4c, virtual false, abstract: false, final false
  static inline void ValidateEnd(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0x3d19664, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  /// @brief Method get_IsCompleted, addr 0x3d1966c, size 0x1c, virtual false, abstract: false, final false
