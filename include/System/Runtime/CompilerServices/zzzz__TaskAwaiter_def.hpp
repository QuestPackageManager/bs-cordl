...
public:
  ...
  /// @brief Method <OutputWaitEtwEvents>b__0, addr 0x25ccf38, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ccf30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetResult, addr 0x25ccb4c, size 0x8, virtual false, abstract: false, final false
  inline void GetResult();

  /// @brief Method HandleNonSuccessAndDebuggerNotification, addr 0x25ccba0, size 0x60, virtual false, abstract: false, final false
  static inline void HandleNonSuccessAndDebuggerNotification(::System::Threading::Tasks::Task* task);

  /// @brief Method OnCompleted, addr 0x25cc724, size 0x10, virtual true, abstract: false, final true
  inline void OnCompleted(::System::Action* continuation);

  /// @brief Method OnCompletedInternal, addr 0x25cca98, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OutputWaitEtwEvents, addr 0x25ccd54, size 0x1dc, virtual false, abstract: false, final false
  static inline ::System::Action* OutputWaitEtwEvents(::System::Threading::Tasks::Task* task, ::System::Action* continuation);

  /// @brief Method ThrowForNonSuccess, addr 0x25ccc00, size 0x154, virtual false, abstract: false, final false
  static inline void ThrowForNonSuccess(::System::Threading::Tasks::Task* task);

  /// @brief Method UnsafeOnCompleted, addr 0x25cc8c0, size 0x10, virtual true, abstract: false, final true
  inline void UnsafeOnCompleted(::System::Action* continuation);

  /// @brief Method ValidateEnd, addr 0x25ccb54, size 0x4c, virtual false, abstract: false, final false
  static inline void ValidateEnd(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0x25cca74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  /// @brief Method get_IsCompleted, addr 0x25cca7c, size 0x1c, virtual false, abstract: false, final false
