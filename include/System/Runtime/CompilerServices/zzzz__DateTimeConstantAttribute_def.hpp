...
public:
  ...
  /// @brief Method get_Value, addr 0x5b70308, size 0x60, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::CompilerServices::DateTimeConstantAttribute) == 0x18, "Size mismatch!");
