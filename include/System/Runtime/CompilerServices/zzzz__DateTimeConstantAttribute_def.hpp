...
namespace System::Runtime::CompilerServices {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2368)), TypeDefinitionIndex(TypeDefinitionIndex(3362))]
...
public:
  ...
  /// @brief Method get_Value, addr 0x24fb2a4, size 0x5c, virtual true, abstract: false, final false
