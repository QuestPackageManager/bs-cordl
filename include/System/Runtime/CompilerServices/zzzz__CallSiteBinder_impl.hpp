...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Runtime::CompilerServices::CallSiteBinder::*)()>(&::System::Runtime::CompilerServices::CallSiteBinder::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5fbbf30;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Linq::Expressions::LabelTarget* (*)()>(&::System::Runtime::CompilerServices::CallSiteBinder::get_UpdateLabel)> {
  ...
  constexpr static std::size_t addrs = 0x5fbbf34;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Linq::Expressions::Expression* (
    ::System::Runtime::CompilerServices::CallSiteBinder::*)(::ArrayW<::System::Object*>, ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ParameterExpression*>*,
                                                            ::System::Linq::Expressions::LabelTarget*)>(&::System::Runtime::CompilerServices::CallSiteBinder::Bind)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::CallSiteBinder*>(),
...
inline void System::Runtime::CompilerServices::CallSiteBinder::setStaticF__UpdateLabel_k__BackingField(::System::Linq::Expressions::LabelTarget* value) {
  ::cordl_internals::setStaticField<::System::Linq::Expressions::LabelTarget*, "<UpdateLabel>k__BackingField", ::System::Runtime::CompilerServices::CallSiteBinder*>(
...
System::Runtime::CompilerServices::CallSiteBinder::Bind(::ArrayW<::System::Object*> args,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Runtime::CompilerServices::CallSiteBinder*>(), 4 })));
...
template <typename T> inline T System::Runtime::CompilerServices::CallSiteBinder::BindDelegate(::System::Runtime::CompilerServices::CallSite_1<T>* site, ::ArrayW<::System::Object*> args) {
  auto* ___internal_method_base =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Runtime::CompilerServices::CallSiteBinder*>(), 5 })));
...
template <typename T> inline T System::Runtime::CompilerServices::CallSiteBinder::BindCore(::System::Runtime::CompilerServices::CallSite_1<T>* site, ::ArrayW<::System::Object*> args) {
  static auto* ___internal_method_base = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::CallSiteBinder*>(),
...
template <typename T> inline void System::Runtime::CompilerServices::CallSiteBinder::CacheTarget(T target) {
  static auto* ___internal_method_base = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::CallSiteBinder*>(), { "CacheTarget", { ::i2c::class_of<T>() }, { ::i2c::type_of<T>() } })));
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::make_generic(___internal_method_base, { ::i2c::class_of<T>() })));
...
inline ::System::Linq::Expressions::Expression_1<T>* System::Runtime::CompilerServices::CallSiteBinder::Stitch(::System::Linq::Expressions::Expression* binding,
  ...
  static auto* ___internal_method_base = THROW_UNLESS(
      ...
      (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::CallSiteBinder*>(),
                          { "Stitch",
                            { ::i2c::class_of<T>() },
                            { ::i2c::type_of<::System::Linq::Expressions::Expression*>(), ::i2c::type_of<::System::Runtime::CompilerServices::CallSiteBinder_LambdaSignature_1<T>*>() } })));
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::make_generic(___internal_method_base, { ::i2c::class_of<T>() })));
...
template <typename T> inline ::System::Runtime::CompilerServices::RuleCache_1<T>* System::Runtime::CompilerServices::CallSiteBinder::GetRuleCache() {
  static auto* ___internal_method_base =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Runtime::CompilerServices::CallSiteBinder*>(), { "GetRuleCache", { ::i2c::class_of<T>() }, {} })));
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::make_generic(___internal_method_base, { ::i2c::class_of<T>() })));
