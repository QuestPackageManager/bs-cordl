...
public:
  ...
  /// @brief Method .ctor, addr 0x5fbbf20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::CompilerServices::CallSiteBinder* binder);

  /// @brief Method get_Binder, addr 0x5fbbf28, size 0x8, virtual false, abstract: false, final false
