...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CallSite", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CallSite(CallSite&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CallSite", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CallSite(CallSiteconst&) = delete;
