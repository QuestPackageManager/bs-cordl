...
public:
  ...
  /// @brief Method .ctor, addr 0x2b4f664, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::CompilerServices::CallSiteBinder* binder);

  /// @brief Method get_Binder, addr 0x2b4f68c, size 0x8, virtual false, abstract: false, final false
