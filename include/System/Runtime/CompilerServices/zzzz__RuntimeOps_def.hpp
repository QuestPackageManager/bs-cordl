...
public:
  // Declarations
  /// @brief Method ExpandoCheckVersion, addr 0x40f62bc, size 0x28, virtual false, abstract: false, final false
  static inline bool ExpandoCheckVersion(::System::Dynamic::ExpandoObject* expando, ::System::Object* version);

  /// @brief Method ExpandoPromoteClass, addr 0x40f6300, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTryDeleteValue, addr 0x40f5f14, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTryGetValue, addr 0x40f5a18, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTrySetValue, addr 0x40f5b54, size 0x28, virtual false, abstract: false, final false
