...
public:
  // Declarations
  /// @brief Method ExpandoCheckVersion, addr 0x41086fc, size 0x28, virtual false, abstract: false, final false
  static inline bool ExpandoCheckVersion(::System::Dynamic::ExpandoObject* expando, ::System::Object* version);

  /// @brief Method ExpandoPromoteClass, addr 0x4108740, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTryDeleteValue, addr 0x4108354, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTryGetValue, addr 0x4107e58, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTrySetValue, addr 0x4107f94, size 0x28, virtual false, abstract: false, final false
