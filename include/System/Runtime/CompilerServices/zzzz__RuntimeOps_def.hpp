...
public:
  // Declarations
  /// @brief Method ExpandoCheckVersion, addr 0x5e0ca28, size 0x28, virtual false, abstract: false, final false
  static inline bool ExpandoCheckVersion(::System::Dynamic::ExpandoObject* expando, ::System::Object* version);

  /// @brief Method ExpandoPromoteClass, addr 0x5e0ca68, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTryDeleteValue, addr 0x5e0c670, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTryGetValue, addr 0x5e0c15c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTrySetValue, addr 0x5e0c2a4, size 0x28, virtual false, abstract: false, final false
