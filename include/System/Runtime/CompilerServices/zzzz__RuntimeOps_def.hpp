...
public:
  // Declarations
  /// @brief Method ExpandoCheckVersion, addr 0x40fb1b8, size 0x28, virtual false, abstract: false, final false
  static inline bool ExpandoCheckVersion(::System::Dynamic::ExpandoObject* expando, ::System::Object* version);

  /// @brief Method ExpandoPromoteClass, addr 0x40fb1fc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTryDeleteValue, addr 0x40fae10, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTryGetValue, addr 0x40fa914, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandoTrySetValue, addr 0x40faa50, size 0x28, virtual false, abstract: false, final false
