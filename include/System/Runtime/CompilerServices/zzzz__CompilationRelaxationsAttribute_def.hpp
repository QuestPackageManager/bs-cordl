...
public:
  ...
  /// @brief Method .ctor, addr 0x5b70b38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::CompilerServices::CompilationRelaxations relaxations);

  /// @brief Method .ctor, addr 0x5b70b30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t relaxations);

  /// @brief Method get_CompilationRelaxations, addr 0x5b70b40, size 0x8, virtual false, abstract: false, final false
