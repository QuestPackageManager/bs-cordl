...
// [ComVisible(true)]
// [AttributeUsage((System.AttributeTargets)71)]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompilationRelaxationsAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompilationRelaxationsAttribute(CompilationRelaxationsAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompilationRelaxationsAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompilationRelaxationsAttribute(CompilationRelaxationsAttributeconst&) = delete;
