...
/// @brief Method .ctor, addr 0x59c3384, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::CompilerServices::CompilationRelaxations  relaxations) ;

/// @brief Method .ctor, addr 0x59c337c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  relaxations) ;

/// @brief Method get_CompilationRelaxations, addr 0x59c338c, size 0x8, virtual false, abstract: false, final false
