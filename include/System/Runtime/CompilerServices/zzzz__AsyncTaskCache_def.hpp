...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsyncTaskCache", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsyncTaskCache(AsyncTaskCache&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsyncTaskCache", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsyncTaskCache(AsyncTaskCacheconst&) = delete;
