...
template<typename T>
static inline T Bind(::System::Runtime::CompilerServices::CallSiteBinder*  binder, ::System::Runtime::CompilerServices::CallSite_1<T>*  site, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  args) ;

/// @brief Method ClearMatch, addr 0x5e80f5c, size 0x18, virtual false, abstract: false, final false
...
template<typename T>
static inline ::ArrayW<T,::Array<T>*> GetCachedRules(::System::Runtime::CompilerServices::RuleCache_1<T>*  cache) ;

/// @brief Method GetMatch, addr 0x5e80f48, size 0x14, virtual false, abstract: false, final false
...
template<typename T>
static inline ::ArrayW<T,::Array<T>*> GetRules(::System::Runtime::CompilerServices::CallSite_1<T>*  site) ;
...
/// @brief Method SetNotMatched, addr 0x5e80f2c, size 0x1c, virtual false, abstract: false, final false
