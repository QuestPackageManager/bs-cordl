...
public:
  ...
  /// @brief Method .ctor addr 0x23827cc size 0x10 virtual false final false
  inline void _ctor(::System::Threading::Tasks::Task* task, bool continueOnCapturedContext);

  /// @brief Method get_IsCompleted addr 0x23827e8 size 0x1c virtual false final false
  inline bool get_IsCompleted();

  /// @brief Method OnCompleted addr 0x2382804 size 0x14 virtual true final true
  inline void OnCompleted(::System::Action* continuation);

  /// @brief Method UnsafeOnCompleted addr 0x238152c size 0x14 virtual true final true
  inline void UnsafeOnCompleted(::System::Action* continuation);

  /// @brief Method GetResult addr 0x2382818 size 0x8 virtual false final false
...
namespace System::Runtime::CompilerServices {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3390))}
...
public:
  ...
  /// @brief Method .ctor addr 0x23827b4 size 0x18 virtual false final false
  inline void _ctor(::System::Threading::Tasks::Task* task, bool continueOnCapturedContext);

  /// @brief Method GetAwaiter addr 0x23827dc size 0xc virtual false final false
