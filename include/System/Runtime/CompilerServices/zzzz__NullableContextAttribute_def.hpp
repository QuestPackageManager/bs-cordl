...
public:
  ...
  /// @brief Method .ctor, addr 0x6bbdfac, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::CompilerServices::NullableContextAttribute) == 0x18, "Size mismatch!");
