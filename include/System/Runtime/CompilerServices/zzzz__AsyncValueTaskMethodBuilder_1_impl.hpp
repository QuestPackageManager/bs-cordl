...
// Ctor Parameters [CppParam { name: "_methodBuilder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TResult>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "_result", ty: "TResult", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_haveResult", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "_useBuilder", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename TResult>
