...
namespace System::Runtime::CompilerServices {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2547)), TypeDefinitionIndex(TypeDefinitionIndex(3407))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x24fdd10, size 0x28, virtual false, abstract: false, final false
