...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultDependencyAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultDependencyAttribute(DefaultDependencyAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultDependencyAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultDependencyAttribute(DefaultDependencyAttributeconst&) = delete;
