...
MARK_GEN_REF_T_PTR(::System::Runtime::CompilerServices::CallSiteBinder_LambdaSignature_1);
DEFINE_IL2CPP_CLASS(::System::Runtime::CompilerServices::CallSiteBinder*, "System.Runtime.CompilerServices", "CallSiteBinder");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Runtime::CompilerServices::CallSiteBinder_LambdaSignature_1, "System.Runtime.CompilerServices", "CallSiteBinder/LambdaSignature`1");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5fbbf30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Linq::Expressions::LabelTarget* getStaticF__UpdateLabel_k__BackingField();

  /// @brief Method get_UpdateLabel, addr 0x5fbbf34, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::CompilerServices::CallSiteBinder) == 0x18, "Size mismatch!");
