...
public:
  ...
  /// @brief Method .ctor, addr 0x5e7f2bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Linq::Expressions::LabelTarget* getStaticF__UpdateLabel_k__BackingField();

  /// @brief Method get_UpdateLabel, addr 0x5e7f2c0, size 0x5c, virtual false, abstract: false, final false
