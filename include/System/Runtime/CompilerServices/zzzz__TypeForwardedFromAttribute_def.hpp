...
public:
  ...
  /// @brief Method .ctor, addr 0x3d1414c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyFullName);

  /// @brief Method get_AssemblyFullName, addr 0x3d141cc, size 0x8, virtual false, abstract: false, final false
