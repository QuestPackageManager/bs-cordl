...
public:
  ...
  /// @brief Method .ctor, addr 0x5a32d10, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyFullName);

  /// @brief Method get_AssemblyFullName, addr 0x5a32d70, size 0x8, virtual false, abstract: false, final false
