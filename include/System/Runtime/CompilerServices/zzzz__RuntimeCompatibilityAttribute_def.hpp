...
/// @brief Field <WrapNonExceptionThrows>k__BackingField, offset 0x10, size 0x1 
 __declspec(property(get=__cordl_internal_get__WrapNonExceptionThrows_k__BackingField, put=__cordl_internal_set__WrapNonExceptionThrows_k__BackingField)) bool  _WrapNonExceptionThrows_k__BackingField;
...
/// @brief Method .ctor, addr 0x59c0aa8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_WrapNonExceptionThrows, addr 0x59c0aac, size 0x8, virtual false, abstract: false, final false
