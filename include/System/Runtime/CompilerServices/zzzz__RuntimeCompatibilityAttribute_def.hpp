...
public:
  ...
  /// @brief Method .ctor, addr 0x3d1a7a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_WrapNonExceptionThrows, addr 0x3d1a7b0, size 0xc, virtual false, abstract: false, final false
