...
public:
  ...
  /// @brief Method .ctor, addr 0x3d18d74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_WrapNonExceptionThrows, addr 0x3d18d7c, size 0xc, virtual false, abstract: false, final false
