...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RuntimeFeature", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RuntimeFeature(RuntimeFeature&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RuntimeFeature", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RuntimeFeature(RuntimeFeatureconst&) = delete;
