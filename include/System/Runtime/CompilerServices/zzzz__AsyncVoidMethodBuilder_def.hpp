...
public:
  ...
  /// @brief Method Create, addr 0x24fc584, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetStateMachine, addr 0x24fc5c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetResult, addr 0x24fc694, size 0x5c, virtual false, abstract: false, final false
  inline void SetResult();

  /// @brief Method SetException, addr 0x24fc800, size 0x134, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method NotifySynchronizationContextOfCompletion, addr 0x24fc75c, size 0xa4, virtual false, abstract: false, final false
  inline void NotifySynchronizationContextOfCompletion();

  /// @brief Method get_Task, addr 0x24fc6f0, size 0x6c, virtual false, abstract: false, final false
