...
/// @brief Method .ctor, addr 0x59c08b4, size 0x74, virtual false, abstract: false, final false
inline void _ctor(uint8_t  scale, uint8_t  sign, uint32_t  hi, uint32_t  mid, uint32_t  low) ;

/// @brief Method get_Value, addr 0x59c0928, size 0xc, virtual false, abstract: false, final false
