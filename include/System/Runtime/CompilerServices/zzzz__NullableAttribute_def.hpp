...
public:
  ...
  __declspec(property(get = __cordl_internal_get_NullableFlags, put = __cordl_internal_set_NullableFlags)) ::ArrayW<uint8_t> NullableFlags;

  static inline ::System::Runtime::CompilerServices::NullableAttribute* New_ctor(::ArrayW<uint8_t> _cordl_fixed_empty_name_whitespace);

  static inline ::System::Runtime::CompilerServices::NullableAttribute* New_ctor(uint8_t _cordl_fixed_empty_name_whitespace);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_NullableFlags() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_NullableFlags();

  constexpr void __cordl_internal_set_NullableFlags(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x328debc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> _cordl_fixed_empty_name_whitespace);

  /// @brief Method .ctor, addr 0x328de44, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<uint8_t> ___NullableFlags;
...
static_assert(sizeof(::System::Runtime::CompilerServices::NullableAttribute) == 0x18, "Size mismatch!");
