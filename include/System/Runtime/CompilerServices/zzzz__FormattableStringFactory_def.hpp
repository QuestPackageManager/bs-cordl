...
public:
  ...
  /// @brief Method GetArgument, addr 0x5b6e204, size 0x30, virtual true, abstract: false, final false
  inline ::System::Object* GetArgument(int32_t index);

  /// @brief Method GetArguments, addr 0x5b6e1e4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5b6e234, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b6e1d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW format, ::ArrayW<::System::Object*> arguments);

  /// @brief Method get_ArgumentCount, addr 0x5b6e1ec, size 0x18, virtual true, abstract: false, final false
  inline int32_t get_ArgumentCount();

  /// @brief Method get_Format, addr 0x5b6e1dc, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x5b6e108, size 0xcc, virtual false, abstract: false, final false
