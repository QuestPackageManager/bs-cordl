...
public:
  ...
  /// @brief Method GetArgument, addr 0x262f724, size 0x30, virtual true, abstract: false, final false
  inline ::System::Object* GetArgument(int32_t index);

  /// @brief Method GetArguments, addr 0x262f700, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x262f754, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262f6cc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> arguments);

  /// @brief Method get_ArgumentCount, addr 0x262f708, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_ArgumentCount();

  /// @brief Method get_Format, addr 0x262f6f8, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x262f5ec, size 0xe0, virtual false, abstract: false, final false
