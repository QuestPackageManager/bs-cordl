...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Runtime::CompilerServices::StrongBox_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Runtime::CompilerServices::StrongBox_1, "System.Runtime.CompilerServices", "StrongBox`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StrongBox_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StrongBox_1(StrongBox_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StrongBox_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StrongBox_1(StrongBox_1const&) = delete;
