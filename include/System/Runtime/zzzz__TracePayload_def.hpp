...
public:
  ...
  /// @brief Method .ctor, addr 0x6045848, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AppDomainFriendlyName, addr 0x6045868, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AppDomainFriendlyName();

  /// @brief Method get_EventSource, addr 0x6045860, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EventSource();

  /// @brief Method get_ExtendedData, addr 0x6045870, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ExtendedData();

  /// @brief Method get_SerializedException, addr 0x6045858, size 0x8, virtual false, abstract: false, final false
