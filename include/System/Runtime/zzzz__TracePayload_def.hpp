...
/// @brief Method .ctor, addr 0x5fd383c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_AppDomainFriendlyName, addr 0x5fd385c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AppDomainFriendlyName() ;

/// @brief Method get_EventSource, addr 0x5fd3854, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_EventSource() ;

/// @brief Method get_ExtendedData, addr 0x5fd3864, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ExtendedData() ;

/// @brief Method get_SerializedException, addr 0x5fd384c, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "serializedException", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "eventSource", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "appDomainFriendlyName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "extendedData", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "hostReference", ty: "::StringW", modifiers: "", def_value: None }]
