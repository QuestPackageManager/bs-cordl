...
public:
  ...
  /// @brief Method Capture, addr 0x3d1c6e4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Throw, addr 0x3d1c7ac, size 0x44, virtual false, abstract: false, final false
  inline void Throw();

  /// @brief Method Throw, addr 0x3d1c7f0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d1c5b4, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* exception);

  /// @brief Method get_BinaryStackTraceArray, addr 0x3d1c6dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_BinaryStackTraceArray();

  /// @brief Method get_SourceException, addr 0x3d1c7a4, size 0x8, virtual false, abstract: false, final false
