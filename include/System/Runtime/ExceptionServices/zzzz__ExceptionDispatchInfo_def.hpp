...
/// @brief Method Capture, addr 0x59bfcc8, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method Throw, addr 0x59bfd8c, size 0x44, virtual false, abstract: false, final false
inline void Throw() ;

/// @brief Method Throw, addr 0x59bfdd0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59bfba4, size 0x11c, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  exception) ;

/// @brief Method get_BinaryStackTraceArray, addr 0x59bfcc0, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_BinaryStackTraceArray() ;

/// @brief Method get_SourceException, addr 0x59bfd84, size 0x8, virtual false, abstract: false, final false
