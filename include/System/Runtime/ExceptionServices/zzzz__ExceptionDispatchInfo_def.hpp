...
public:
  ...
  /// @brief Method Capture, addr 0x262e6b4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method Throw, addr 0x262e780, size 0x44, virtual false, abstract: false, final false
  inline void Throw();

  /// @brief Method Throw, addr 0x262ec30, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262eaf8, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* exception);

  /// @brief Method get_BinaryStackTraceArray, addr 0x262ec20, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_BinaryStackTraceArray();

  /// @brief Method get_SourceException, addr 0x262ec28, size 0x8, virtual false, abstract: false, final false
