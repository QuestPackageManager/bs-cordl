...
public:
  ...
  /// @brief Method .ctor, addr 0x3cf3824, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW frameworkName);

  /// @brief Method set_FrameworkDisplayName, addr 0x3cf3898, size 0x8, virtual false, abstract: false, final false
