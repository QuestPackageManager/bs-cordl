...
public:
  ...
  /// @brief Method .ctor, addr 0x2730d58, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW frameworkName);

  /// @brief Method set_FrameworkDisplayName, addr 0x2730dd0, size 0x8, virtual false, abstract: false, final false
