...
public:
  ...
  /// @brief Method .ctor, addr 0x284f7dc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW frameworkName);

  /// @brief Method set_FrameworkDisplayName, addr 0x284f854, size 0x8, virtual false, abstract: false, final false
