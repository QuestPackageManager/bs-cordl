...
/// @brief Method .ctor, addr 0x5a0fb8c, size 0x58, virtual false, abstract: false, final false
inline void _ctor(::StringW  frameworkName) ;

/// @brief Method set_FrameworkDisplayName, addr 0x5a0fbe4, size 0x8, virtual false, abstract: false, final false
