...
public:
  ...
  /// @brief Method ArgumentOutOfRange, addr 0x61859b8, size 0xac, virtual false, abstract: false, final false
  inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW paramName, ::System::Object* actualValue, ::StringW message);

  /// @brief Method BreakOnException, addr 0x618676c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61859b0, size 0x8, virtual false, abstract: false, final false
