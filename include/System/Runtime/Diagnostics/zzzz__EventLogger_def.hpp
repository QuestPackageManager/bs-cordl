...
/// @brief Method EventLogEntryTypeFromEventType, addr 0x5fdd6c8, size 0x20, virtual false, abstract: false, final false
static inline ::System::Diagnostics::EventLogEntryType EventLogEntryTypeFromEventType(::System::Diagnostics::TraceEventType  type) ;

/// @brief Method IsInPartialTrust, addr 0x5fdcf1c, size 0x1cc, virtual false, abstract: false, final false
inline bool IsInPartialTrust() ;

/// @brief Method LogEvent, addr 0x5fd8ff0, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method NormalizeEventLogParameter, addr 0x5fdd0f0, size 0x194, virtual false, abstract: false, final false
static inline ::StringW NormalizeEventLogParameter(::StringW  eventLogParameter) ;

/// @brief Method SafeLogEvent, addr 0x5fdd6c0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method SafeSetLogSourceName, addr 0x5fdd6e8, size 0x8, virtual false, abstract: false, final false
inline void SafeSetLogSourceName(::StringW  eventLogSourceName) ;

/// @brief Method SetLogSourceName, addr 0x5fdd0e8, size 0x8, virtual false, abstract: false, final false
inline void SetLogSourceName(::StringW  eventLogSourceName, ::System::Runtime::Diagnostics::DiagnosticTraceBase*  diagnosticTrace) ;

/// @brief Method UnsafeCreateEventLogger, addr 0x5fd8244, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method UnsafeGetProcessId, addr 0x5fdd3b4, size 0x134, virtual false, abstract: false, final false
inline int32_t UnsafeGetProcessId() ;

/// @brief Method UnsafeGetProcessName, addr 0x5fdd284, size 0x130, virtual false, abstract: false, final false
inline ::StringW UnsafeGetProcessName() ;

/// @brief Method UnsafeLogEvent, addr 0x5fd82b4, size 0x554, virtual false, abstract: false, final false
...
/// @brief Method UnsafeWriteEventLog, addr 0x5fdd4e8, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fdcf00, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5fd8ecc, size 0x124, virtual false, abstract: false, final false
