...
/// @brief Method Deregister, addr 0x5fd6b64, size 0x20, virtual false, abstract: false, final false
inline void Deregister() ;

/// @brief Method Dispose, addr 0x5fd6ab0, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x5fd6b20, size 0x44, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EtwEnableCallBack, addr 0x5fd6bd4, size 0x20, virtual false, abstract: false, final false
inline void EtwEnableCallBack(::ByRef<::System::Guid>  sourceId, ::ByRefConst<int32_t>  isEnabled, ::ByRefConst<uint8_t>  setLevel, ::ByRefConst<int64_t>  anyKeyword, ::ByRefConst<int64_t>  allKeyword, ::ByRefConst<void*>  filterData, ::ByRefConst<void*>  callbackContext) ;

/// @brief Method EtwRegister, addr 0x5fd6998, size 0x118, virtual false, abstract: false, final false
inline void EtwRegister() ;

/// @brief Method Finalize, addr 0x5fd6b84, size 0x50, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method IsEnabled, addr 0x5fd6bf4, size 0x8, virtual false, abstract: false, final false
inline bool IsEnabled() ;

/// @brief Method IsEnabled, addr 0x5fd6bfc, size 0x44, virtual false, abstract: false, final false
inline bool IsEnabled(uint8_t  level, int64_t  keywords) ;

/// @brief Method IsEventEnabled, addr 0x5fd6c40, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method SetActivityId, addr 0x5fd6eb4, size 0xc, virtual false, abstract: false, final false
static inline void SetActivityId(::ByRef<::System::Guid>  id) ;

/// @brief Method SetLastError, addr 0x5fd6c8c, size 0x94, virtual false, abstract: false, final false
static inline void SetLastError(int32_t  error) ;

/// @brief Method WriteEvent, addr 0x5fd6d20, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method WriteEvent, addr 0x5fd6ec0, size 0x68, virtual false, abstract: false, final false
inline bool WriteEvent(::ByRef<::System::Runtime::Diagnostics::EventDescriptor>  eventDescriptor, ::System::Runtime::Diagnostics::EventTraceActivity*  eventTraceActivity, int32_t  dataCount, ::System::IntPtr  data) ;
...
/// @brief Method .ctor, addr 0x5fd6950, size 0x48, virtual false, abstract: false, final false
