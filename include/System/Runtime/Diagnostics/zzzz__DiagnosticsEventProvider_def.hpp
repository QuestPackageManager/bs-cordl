...
public:
  ...
  /// @brief Method Deregister, addr 0x61857e4, size 0x20, virtual false, abstract: false, final false
  inline void Deregister();

  /// @brief Method Dispose, addr 0x6185730, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x61857a0, size 0x44, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EtwEnableCallBack, addr 0x6185854, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method EtwRegister, addr 0x6185618, size 0x118, virtual false, abstract: false, final false
  inline void EtwRegister();

  /// @brief Method Finalize, addr 0x6185804, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method IsEnabled, addr 0x6185874, size 0x8, virtual false, abstract: false, final false
  inline bool IsEnabled();

  /// @brief Method IsEnabled, addr 0x618587c, size 0x44, virtual false, abstract: false, final false
  inline bool IsEnabled(uint8_t level, int64_t keywords);

  /// @brief Method IsEventEnabled, addr 0x61858c0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActivityId, addr 0x6185b34, size 0xc, virtual false, abstract: false, final false
  static inline void SetActivityId(::by_ref<::System::Guid> id);

  /// @brief Method SetLastError, addr 0x618590c, size 0x94, virtual false, abstract: false, final false
  static inline void SetLastError(int32_t error);

  /// @brief Method WriteEvent, addr 0x61859a0, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEvent, addr 0x6185b40, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61855d0, size 0x48, virtual false, abstract: false, final false
