...
public:
  ...
  /// @brief Method Deregister, addr 0x6048b70, size 0x20, virtual false, abstract: false, final false
  inline void Deregister();

  /// @brief Method Dispose, addr 0x6048abc, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6048b2c, size 0x44, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EtwEnableCallBack, addr 0x6048be0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method EtwRegister, addr 0x60489a4, size 0x118, virtual false, abstract: false, final false
  inline void EtwRegister();

  /// @brief Method Finalize, addr 0x6048b90, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method IsEnabled, addr 0x6048c00, size 0x8, virtual false, abstract: false, final false
  inline bool IsEnabled();

  /// @brief Method IsEnabled, addr 0x6048c08, size 0x44, virtual false, abstract: false, final false
  inline bool IsEnabled(uint8_t level, int64_t keywords);

  /// @brief Method IsEventEnabled, addr 0x6048c4c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActivityId, addr 0x6048ec0, size 0xc, virtual false, abstract: false, final false
  static inline void SetActivityId(::ByRef<::System::Guid> id);

  /// @brief Method SetLastError, addr 0x6048c98, size 0x94, virtual false, abstract: false, final false
  static inline void SetLastError(int32_t error);

  /// @brief Method WriteEvent, addr 0x6048d2c, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEvent, addr 0x6048ecc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x604895c, size 0x48, virtual false, abstract: false, final false
