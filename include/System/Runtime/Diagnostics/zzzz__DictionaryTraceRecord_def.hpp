...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DictionaryTraceRecord", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DictionaryTraceRecord(DictionaryTraceRecord&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DictionaryTraceRecord", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DictionaryTraceRecord(DictionaryTraceRecordconst&) = delete;
