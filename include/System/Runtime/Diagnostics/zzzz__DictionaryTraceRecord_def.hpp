...
public:
  ...
  /// @brief Method WriteTo, addr 0x604a908, size 0x420, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x604a8fc, size 0x8, virtual false, abstract: false, final false
