...
// Write type traits
MARK_REF_T(::System::Runtime::Diagnostics::EventTraceActivity*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Diagnostics::EventTraceActivity*, "System.Runtime.Diagnostics", "EventTraceActivity");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventTraceActivity", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventTraceActivity(EventTraceActivity&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventTraceActivity", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventTraceActivity(EventTraceActivityconst&) = delete;
...
static_assert(sizeof(::System::Runtime::Diagnostics::EventTraceActivity) == 0x20, "Size mismatch!");
