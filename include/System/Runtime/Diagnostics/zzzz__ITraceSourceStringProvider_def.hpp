...
public:
  // Declarations
  /// @brief Method GetSourceString, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::StringW GetSourceString();

  // Ctor Parameters [CppParam { name: "", ty: "ITraceSourceStringProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ITraceSourceStringProvider(ITraceSourceStringProviderconst&) = delete;
