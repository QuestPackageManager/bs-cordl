...
public:
  ...
  /// @brief Method WriteTo, addr 0x5f7551c, size 0x4, virtual true, abstract: false, final false
  inline void WriteTo(::System::Xml::XmlWriter* writer);

  /// @brief Method .ctor, addr 0x5f706ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
