...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TraceRecord", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TraceRecord(TraceRecord&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TraceRecord", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TraceRecord(TraceRecordconst&) = delete;
