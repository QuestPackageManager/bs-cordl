...
/// @brief Method Equals, addr 0x5fdcdd0, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x5fdce50, size 0x74, virtual false, abstract: false, final false
inline bool Equals(::System::Runtime::Diagnostics::EventDescriptor  other) ;

/// @brief Method GetHashCode, addr 0x5fdcec4, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fd57c4, size 0x1a4, virtual false, abstract: false, final false
inline void _ctor(int32_t  id, uint8_t  version, uint8_t  channel, uint8_t  level, uint8_t  opcode, int32_t  task, int64_t  keywords) ;

/// @brief Method get_Channel, addr 0x5fdcdb0, size 0x8, virtual false, abstract: false, final false
inline uint8_t get_Channel() ;

/// @brief Method get_EventId, addr 0x5fdcda8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_EventId() ;

/// @brief Method get_Keywords, addr 0x5fdcdc8, size 0x8, virtual false, abstract: false, final false
inline int64_t get_Keywords() ;

/// @brief Method get_Level, addr 0x5fdcdb8, size 0x8, virtual false, abstract: false, final false
inline uint8_t get_Level() ;

/// @brief Method get_Opcode, addr 0x5fdcdc0, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_id", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "m_version", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_channel", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_level", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_opcode", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_task", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "m_keywords", ty: "int64_t", modifiers: "", def_value: None }]
