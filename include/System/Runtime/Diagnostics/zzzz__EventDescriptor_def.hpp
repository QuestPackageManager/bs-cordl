...
public:
  ...
  /// @brief Method Equals, addr 0x604eddc, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x604ee5c, size 0x74, virtual false, abstract: false, final false
  inline bool Equals(::System::Runtime::Diagnostics::EventDescriptor other);

  /// @brief Method GetHashCode, addr 0x604eed0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60477d0, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(int32_t id, uint8_t version, uint8_t channel, uint8_t level, uint8_t opcode, int32_t task, int64_t keywords);

  /// @brief Method get_Channel, addr 0x604edbc, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_Channel();

  /// @brief Method get_EventId, addr 0x604edb4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_EventId();

  /// @brief Method get_Keywords, addr 0x604edd4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_Keywords();

  /// @brief Method get_Level, addr 0x604edc4, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_Level();

  /// @brief Method get_Opcode, addr 0x604edcc, size 0x8, virtual false, abstract: false, final false
