...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StringTraceRecord", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StringTraceRecord(StringTraceRecord&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StringTraceRecord", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StringTraceRecord(StringTraceRecordconst&) = delete;
