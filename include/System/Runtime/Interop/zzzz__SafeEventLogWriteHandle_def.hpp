...
public:
  // Declarations
  /// @brief Method DeregisterEventSource, addr 0x6048420, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterEventSource, addr 0x6048270, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseHandle, addr 0x60484a8, size 0x8, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x604821c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
