...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SafeEventLogWriteHandle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SafeEventLogWriteHandle(SafeEventLogWriteHandle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SafeEventLogWriteHandle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SafeEventLogWriteHandle(SafeEventLogWriteHandleconst&) = delete;
