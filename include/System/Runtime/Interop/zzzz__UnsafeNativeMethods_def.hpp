...
// Ctor Parameters [CppParam { name: "DataPointer", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "Size", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "Reserved", ty: "int32_t", modifiers: "", def_value: None }]
...
public:
// Declarations
/// @brief Method Invoke, addr 0x5fd6938, size 0x18, virtual true, abstract: false, final false
inline void Invoke(::ByRef<::System::Guid>  sourceId, ::ByRefConst<int32_t>  isEnabled, ::ByRefConst<uint8_t>  level, ::ByRefConst<int64_t>  matchAnyKeywords, ::ByRefConst<int64_t>  matchAllKeywords, ::ByRefConst<void*>  filterData, ::ByRefConst<void*>  callbackContext) ;
...
/// @brief Method .ctor, addr 0x5fd68b8, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method EventActivityIdControl, addr 0x5fd66f8, size 0x84, virtual false, abstract: false, final false
static inline uint32_t EventActivityIdControl(::ByRefConst<int32_t>  ControlCode, ::ByRef<::System::Guid>  ActivityId) ;

/// @brief Method EventEnabled, addr 0x5fd65cc, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method EventRegister, addr 0x5fd64a4, size 0xa8, virtual false, abstract: false, final false
static inline uint32_t EventRegister(::ByRef<::System::Guid>  providerId, ::ByRefConst<::System::Runtime::Interop::UnsafeNativeMethods_EtwEnableCallback*>  enableCallback, ::ByRefConst<void*>  callbackContext, ::ByRef<int64_t>  registrationHandle) ;

/// @brief Method EventUnregister, addr 0x5fd654c, size 0x80, virtual false, abstract: false, final false
static inline uint32_t EventUnregister(::ByRefConst<int64_t>  registrationHandle) ;

/// @brief Method EventWrite, addr 0x5fd6658, size 0xa0, virtual false, abstract: false, final false
static inline uint32_t EventWrite(::ByRefConst<int64_t>  registrationHandle, ::ByRef<::System::Runtime::Diagnostics::EventDescriptor>  eventDescriptor, ::ByRefConst<uint32_t>  userDataCount, ::ByRefConst<::System::Runtime::Interop::UnsafeNativeMethods_EventData*>  userData) ;

/// @brief Method RegisterEventSource, addr 0x5fd62f8, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method ReportEvent, addr 0x5fd677c, size 0x13c, virtual false, abstract: false, final false
static inline bool ReportEvent(::System::Runtime::InteropServices::SafeHandle*  hEventLog, uint16_t  type, uint16_t  category, uint32_t  eventID, ::ArrayW<uint8_t,::Array<uint8_t>*>  userSID, uint16_t  numStrings, uint32_t  dataLen, ::System::Runtime::InteropServices::HandleRef  strings, ::ArrayW<uint8_t,::Array<uint8_t>*>  rawData) ;
