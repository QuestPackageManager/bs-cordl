...
DEFINE_IL2CPP_CLASS(::System::Runtime::Interop::UnsafeNativeMethods_EventData, "System.Runtime.Interop", "UnsafeNativeMethods/EventData");
// Dependencies
namespace System::Runtime::Interop {
// Is value type: true
...
static_assert(sizeof(::System::Runtime::Interop::UnsafeNativeMethods_EventData) == 0x10, "Size mismatch!");
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x618add0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x618ad50, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method EventActivityIdControl, addr 0x618ab90, size 0x84, virtual false, abstract: false, final false
  static inline uint32_t EventActivityIdControl(::ByRefConst<int32_t> ControlCode, ::by_ref<::System::Guid> ActivityId);

  /// @brief Method EventEnabled, addr 0x618aa64, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method EventRegister, addr 0x618a93c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method EventUnregister, addr 0x618a9e4, size 0x80, virtual false, abstract: false, final false
  static inline uint32_t EventUnregister(::ByRefConst<int64_t> registrationHandle);

  /// @brief Method EventWrite, addr 0x618aaf0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterEventSource, addr 0x618a790, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReportEvent, addr 0x618ac14, size 0x13c, virtual false, abstract: false, final false
