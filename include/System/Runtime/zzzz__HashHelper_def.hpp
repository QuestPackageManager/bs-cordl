...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HashHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HashHelper(HashHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HashHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HashHelper(HashHelperconst&) = delete;
