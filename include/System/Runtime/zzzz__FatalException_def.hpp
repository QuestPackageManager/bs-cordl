...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FatalException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FatalException(FatalException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FatalException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FatalException(FatalExceptionconst&) = delete;
