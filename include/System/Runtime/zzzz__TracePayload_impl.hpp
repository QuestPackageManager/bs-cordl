...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::TracePayload::*)(::StringW, ::StringW, ::StringW, ::StringW, ::StringW)>(&::System::Runtime::TracePayload::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x5fd383c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::TracePayload>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::System::Runtime::TracePayload::*)()>(&::System::Runtime::TracePayload::get_EventSource)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5fd3854;
...
// Ctor Parameters [CppParam { name: "serializedException", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "eventSource", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "appDomainFriendlyName", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "extendedData", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "hostReference", ty: "::StringW", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Runtime::TracePayload::TracePayload(::StringW  serializedException, ::StringW  eventSource, ::StringW  appDomainFriendlyName, ::StringW  extendedData, ::StringW  hostReference) noexcept  {
