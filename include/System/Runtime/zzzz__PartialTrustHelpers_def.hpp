...
public:
  // Declarations
  /// @brief Method HasEtwPermissions, addr 0x61879c8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PartialTrustHelpers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PartialTrustHelpers(PartialTrustHelpers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PartialTrustHelpers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PartialTrustHelpers(PartialTrustHelpersconst&) = delete;
