...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CriticalFinalizerObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CriticalFinalizerObject(CriticalFinalizerObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CriticalFinalizerObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CriticalFinalizerObject(CriticalFinalizerObjectconst&) = delete;
