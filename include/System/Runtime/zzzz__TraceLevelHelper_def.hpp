...
public:
  ...
  /// @brief Method GetTraceEventType, addr 0x6045544, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::TraceEventType GetTraceEventType(::System::Runtime::TraceEventLevel level);

  /// @brief Method LookupSeverity, addr 0x60455c4, size 0x1ec, virtual false, abstract: false, final false
