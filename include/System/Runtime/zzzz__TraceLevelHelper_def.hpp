...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TraceLevelHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TraceLevelHelper(TraceLevelHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TraceLevelHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TraceLevelHelper(TraceLevelHelperconst&) = delete;
