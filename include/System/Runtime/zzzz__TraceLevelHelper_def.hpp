...
/// @brief Field EtwLevelToTraceEventType, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_EtwLevelToTraceEventType, put=setStaticF_EtwLevelToTraceEventType)) ::ArrayW<::System::Diagnostics::TraceEventType,::Array<::System::Diagnostics::TraceEventType>*>  EtwLevelToTraceEventType;

/// @brief Method GetTraceEventType, addr 0x5fd3538, size 0x80, virtual false, abstract: false, final false
static inline ::System::Diagnostics::TraceEventType GetTraceEventType(::System::Runtime::TraceEventLevel  level) ;

/// @brief Method LookupSeverity, addr 0x5fd35b8, size 0x1ec, virtual false, abstract: false, final false
