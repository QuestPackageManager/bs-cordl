...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SpanDebugView_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SpanDebugView_1(SpanDebugView_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SpanDebugView_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SpanDebugView_1(SpanDebugView_1const&) = delete;
