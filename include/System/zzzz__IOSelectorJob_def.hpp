...
public:
  ...
  /// @brief Method MarkDisposed, addr 0x440b100, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x440b0d4, size 0x28, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0x440b0fc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x440b098, size 0x3c, virtual false, abstract: false, final false
