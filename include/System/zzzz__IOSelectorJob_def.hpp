...
public:
  ...
  /// @brief Method MarkDisposed, addr 0x637a830, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x637a808, size 0x24, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0x637a82c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x637a7fc, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IOSelectorJob", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IOSelectorJob(IOSelectorJob&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IOSelectorJob", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IOSelectorJob(IOSelectorJobconst&) = delete;
