...
public:
  ...
  /// @brief Method MarkDisposed, addr 0x4410074, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x4410048, size 0x28, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0x4410070, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x441000c, size 0x3c, virtual false, abstract: false, final false
