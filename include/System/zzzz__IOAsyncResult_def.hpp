...
public:
  ...
  /// @brief Method .ctor addr 0x294d5f8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Init addr 0x294d600 size 0x20 virtual false final false
  ...
  /// @brief Method .ctor addr 0x294d620 size 0x2c virtual false final false
  inline void _ctor(::System::AsyncCallback* async_callback, ::System::Object* async_state);

  /// @brief Method get_AsyncCallback addr 0x294d64c size 0x8 virtual false final false
  inline ::System::AsyncCallback* get_AsyncCallback();

  /// @brief Method get_AsyncState addr 0x294d654 size 0x8 virtual true final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle addr 0x294d65c size 0x124 virtual true final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously addr 0x294d780 size 0x8 virtual true final true
  inline bool get_CompletedSynchronously();

  /// @brief Method set_CompletedSynchronously addr 0x294d788 size 0xc virtual false final false
  inline void set_CompletedSynchronously(bool value);

  /// @brief Method get_IsCompleted addr 0x294d794 size 0x8 virtual true final true
  inline bool get_IsCompleted();

  /// @brief Method set_IsCompleted addr 0x294d79c size 0xd8 virtual false final false
