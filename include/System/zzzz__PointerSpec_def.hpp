...
public:
  ...
  /// @brief Method Append, addr 0x3de1904, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x3de18b0, size 0x54, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x3de192c, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3de1888, size 0x28, virtual false, abstract: false, final false
