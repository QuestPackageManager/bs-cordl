...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PointerSpec", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PointerSpec(PointerSpec&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PointerSpec", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PointerSpec(PointerSpecconst&) = delete;
