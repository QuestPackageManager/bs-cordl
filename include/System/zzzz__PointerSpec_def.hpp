...
public:
  ...
  /// @brief Method Append, addr 0x26fa0fc, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x26fa0a8, size 0x54, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x26fa124, size 0x1074, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26fa0a0, size 0x8, virtual false, abstract: false, final false
