...
public:
  ...
  /// @brief Method Append, addr 0x5aeeb10, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x5aeeabc, size 0x54, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x5aeeb30, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5aeeab4, size 0x8, virtual false, abstract: false, final false
