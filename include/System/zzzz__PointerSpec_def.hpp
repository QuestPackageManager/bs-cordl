...
public:
  ...
  /// @brief Method Append, addr 0x3e44c14, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x3e44bc0, size 0x54, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x3e44c3c, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e44b98, size 0x28, virtual false, abstract: false, final false
