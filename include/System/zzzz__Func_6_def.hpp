...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Func_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Func_6(Func_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Func_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Func_6(Func_6const&) = delete;
