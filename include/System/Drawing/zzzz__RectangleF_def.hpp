...
public:
  ...
  /// @brief Method Equals, addr 0x4213bc8, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4213c78, size 0x3c, virtual true, abstract: false, final true
  inline bool Equals(::System::Drawing::RectangleF other);

  /// @brief Method GetHashCode, addr 0x4213cdc, size 0xd8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x4213db4, size 0x1b4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Height, addr 0x4213bc0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Height();

  /// @brief Method get_Width, addr 0x4213bb8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Width();

  /// @brief Method get_X, addr 0x4213ba8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_X();

  /// @brief Method get_Y, addr 0x4213bb0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4213cb4, size 0x28, virtual false, abstract: false, final false
