...
public:
  ...
  /// @brief Method Equals, addr 0x4211f8c, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x421203c, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::System::Drawing::Rectangle other);

  /// @brief Method GetHashCode, addr 0x42120bc, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x4212138, size 0x1b4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Height, addr 0x4211f84, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Height();

  /// @brief Method get_Width, addr 0x4211f7c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Width();

  /// @brief Method get_X, addr 0x4211f6c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_X();

  /// @brief Method get_Y, addr 0x4211f74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4212080, size 0x3c, virtual false, abstract: false, final false
