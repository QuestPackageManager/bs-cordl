...
public:
  ...
  /// @brief Method Equals, addr 0x420ff60, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x420fff0, size 0x48, virtual true, abstract: false, final true
  inline bool Equals(::System::Drawing::Color other);

  /// @brief Method GetHashCode, addr 0x4210038, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x420fce0, size 0x238, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_A, addr 0x420fc34, size 0x14, virtual false, abstract: false, final false
  inline uint8_t get_A();

  /// @brief Method get_B, addr 0x420fc24, size 0x10, virtual false, abstract: false, final false
  inline uint8_t get_B();

  /// @brief Method get_G, addr 0x420fc10, size 0x14, virtual false, abstract: false, final false
  inline uint8_t get_G();

  /// @brief Method get_IsKnownColor, addr 0x420fc48, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsKnownColor();

  /// @brief Method get_Name, addr 0x420fc54, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_R, addr 0x420fbc8, size 0x14, virtual false, abstract: false, final false
  inline uint8_t get_R();

  /// @brief Method get_Value, addr 0x420fbdc, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x420ff18, size 0x48, virtual false, abstract: false, final false
