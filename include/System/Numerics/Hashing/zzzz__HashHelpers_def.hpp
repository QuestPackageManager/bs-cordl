...
// Write type traits
MARK_REF_T(::System::Numerics::Hashing::HashHelpers*);
DEFINE_IL2CPP_CLASS(::System::Numerics::Hashing::HashHelpers*, "System.Numerics.Hashing", "HashHelpers");
...
public:
  ...
  /// @brief Method Combine, addr 0x60d2664, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Numerics::Hashing::HashHelpers) == 0x10, "Size mismatch!");
