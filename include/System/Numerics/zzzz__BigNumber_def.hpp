...
public:
  // Declarations
  /// @brief Method Create, addr 0x423cbb8, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FormatBigInteger, addr 0x423dbd4, size 0x9e0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatBigInteger, addr 0x4239248, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatBigIntegerToHex, addr 0x423d29c, size 0x5b0, virtual false, abstract: false, final false
  ...
  /// @brief Method HexNumberToBigInteger, addr 0x423cd08, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberToBigInteger, addr 0x423ceac, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseBigInteger, addr 0x42384dc, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseBigInteger, addr 0x423d074, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseFormatSpecifier, addr 0x423d1ac, size 0xf0, virtual false, abstract: false, final false
  static inline char16_t ParseFormatSpecifier(::System::ReadOnlySpan_1<char16_t> format, ::ByRef<int32_t> digits);

  /// @brief Method TryParseBigInteger, addr 0x423ca70, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method TryValidateParseStyleInteger, addr 0x423c980, size 0xf0, virtual false, abstract: false, final false
