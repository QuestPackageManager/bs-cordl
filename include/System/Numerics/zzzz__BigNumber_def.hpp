...
DEFINE_IL2CPP_CLASS(::System::Numerics::BigNumber_BigNumberBuffer, "System.Numerics", "BigNumber/BigNumberBuffer");
// Dependencies
namespace System::Numerics {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method Create, addr 0x60f1b70, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Numerics::BigNumber_BigNumberBuffer) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method FormatBigInteger, addr 0x60f2cd0, size 0xc34, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatBigInteger, addr 0x60ee03c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatBigIntegerToHex, addr 0x60f2270, size 0x6c4, virtual false, abstract: false, final false
  ...
  /// @brief Method HexNumberToBigInteger, addr 0x60f1cb8, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberToBigInteger, addr 0x60f1e5c, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseBigInteger, addr 0x60ed298, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseBigInteger, addr 0x60f2030, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseFormatSpecifier, addr 0x60f2178, size 0xf8, virtual false, abstract: false, final false
  static inline char16_t ParseFormatSpecifier(::System::ReadOnlySpan_1<char16_t> format, ::by_ref<int32_t> digits);

  /// @brief Method TryParseBigInteger, addr 0x60f1a10, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method TryValidateParseStyleInteger, addr 0x60f1900, size 0x110, virtual false, abstract: false, final false
