...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConsoleCancelEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConsoleCancelEventHandler(ConsoleCancelEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConsoleCancelEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConsoleCancelEventHandler(ConsoleCancelEventHandlerconst&) = delete;
