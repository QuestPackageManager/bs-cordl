...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventHandler_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventHandler_1(EventHandler_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventHandler_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventHandler_1(EventHandler_1const&) = delete;
