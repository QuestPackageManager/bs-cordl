...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3e4efc8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e4eec8, size 0x100, virtual false, abstract: false, final false
