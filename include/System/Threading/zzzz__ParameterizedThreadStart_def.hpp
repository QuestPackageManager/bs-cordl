...
public:
// Declarations
/// @brief Method Invoke, addr 0x5af94a0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5af935c, size 0x144, virtual false, abstract: false, final false
