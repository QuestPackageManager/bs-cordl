...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ParameterizedThreadStart", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ParameterizedThreadStart(ParameterizedThreadStart&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ParameterizedThreadStart", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ParameterizedThreadStart(ParameterizedThreadStartconst&) = delete;
