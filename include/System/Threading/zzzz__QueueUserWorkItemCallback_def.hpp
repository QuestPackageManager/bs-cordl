...
public:
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x5b06240, size 0xd4, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0x5b06314, size 0x4, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_MarkAborted(::System::Threading::ThreadAbortException* tae);

  /// @brief Method WaitCallback_Context, addr 0x5b06318, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b06190, size 0xb0, virtual false, abstract: false, final false
