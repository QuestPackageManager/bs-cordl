...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x289dfcc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x289de24, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Invoke, addr 0x289df18, size 0x28, virtual false, abstract: false, final false
  inline void Invoke();
  ...
  /// @brief Method .ctor, addr 0x289dee8, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Get>b__3_0, addr 0x289e04c, size 0x64, virtual false, abstract: false, final false
  inline ::System::Threading::OSSpecificSynchronizationContext* _Get_b__3_0(::System::Object* _osContext);

  /// @brief Method .ctor, addr 0x289e044, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateCopy, addr 0x289dc24, size 0x68, virtual true, abstract: false, final false
  inline ::System::Threading::SynchronizationContext* CreateCopy();

  /// @brief Method Get, addr 0x289d8d4, size 0x15c, virtual false, abstract: false, final false
  static inline ::System::Threading::OSSpecificSynchronizationContext* Get();

  /// @brief Method GetOSContext, addr 0x289dc20, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Object* GetOSContext();

  /// @brief Method InvocationEntry, addr 0x289da90, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method Post, addr 0x289dccc, size 0x158, virtual true, abstract: false, final false
  inline void Post(::System::Threading::SendOrPostCallback* d, ::System::Object* state);

  /// @brief Method PostInternal, addr 0x289df14, size 0x4, virtual false, abstract: false, final false
  static inline void PostInternal(::System::Object* osSynchronizationContext, void* callback, void* arg);

  /// @brief Method Send, addr 0x289dc8c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x289dbf8, size 0x28, virtual false, abstract: false, final false
