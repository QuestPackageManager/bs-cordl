...
public:
  ...
  /// @brief Method CleanUp, addr 0x3e5eabc, size 0xc8, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0x3e5eb84, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e5cf80, size 0x118, virtual false, abstract: false, final false
