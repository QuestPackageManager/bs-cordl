...
public:
  ...
  /// @brief Method CleanUp, addr 0x3e5a430, size 0xc8, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0x3e5a4f8, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e588f4, size 0x118, virtual false, abstract: false, final false
