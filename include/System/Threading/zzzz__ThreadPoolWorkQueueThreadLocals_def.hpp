...
public:
  ...
  /// @brief Method CleanUp, addr 0x28a52e0, size 0xcc, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0x28a53ac, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a3998, size 0x118, virtual false, abstract: false, final false
