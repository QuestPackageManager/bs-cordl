...
public:
  ...
  /// @brief Method CleanUp, addr 0x5b05ff0, size 0xe0, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0x5b060d0, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b045c0, size 0x114, virtual false, abstract: false, final false
