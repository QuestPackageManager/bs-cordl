...
public:
  ...
  /// @brief Method CleanUp, addr 0x3e5a3b8, size 0xc8, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0x3e5a480, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e5887c, size 0x118, virtual false, abstract: false, final false
