...
public:
  ...
  /// @brief Method CleanUp, addr 0x3e5be64, size 0xc8, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0x3e5bf2c, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e5a328, size 0x118, virtual false, abstract: false, final false
