...
public:
  ...
  /// @brief Method CleanUp, addr 0x3e58c00, size 0xc8, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0x3e58cc8, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e570c4, size 0x118, virtual false, abstract: false, final false
