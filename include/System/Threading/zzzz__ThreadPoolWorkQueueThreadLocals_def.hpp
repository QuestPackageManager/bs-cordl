...
public:
  ...
  /// @brief Method CleanUp, addr 0x29c021c, size 0xcc, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Finalize, addr 0x29c02e8, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29be8d4, size 0x118, virtual false, abstract: false, final false
