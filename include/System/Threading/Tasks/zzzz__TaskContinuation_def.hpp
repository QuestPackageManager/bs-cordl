...
public:
  // Declarations
  /// @brief Method InlineIfPossibleOrElseQueue, addr 0x3e76e0c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e76f4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
