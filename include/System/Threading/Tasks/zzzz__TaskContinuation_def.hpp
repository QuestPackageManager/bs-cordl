...
public:
  ...
  /// @brief Method InlineIfPossibleOrElseQueue, addr 0x262b4c0, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262b604, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
