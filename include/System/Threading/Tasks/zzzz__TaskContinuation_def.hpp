...
public:
  // Declarations
  /// @brief Method InlineIfPossibleOrElseQueue, addr 0x28b0694, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28b07d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
