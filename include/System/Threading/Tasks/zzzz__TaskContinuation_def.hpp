...
public:
  // Declarations
  /// @brief Method InlineIfPossibleOrElseQueue, addr 0x2780078, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27801bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
