...
public:
// Declarations
/// @brief Method InlineIfPossibleOrElseQueue, addr 0x5b16160, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b162a8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
