...
public:
  ...
  /// @brief Method .ctor, addr 0x2648330, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  /// @brief Method GetAwaiter, addr 0x2648338, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::ForceAsyncAwaiter GetAwaiter();

  /// @brief Method get_IsCompleted, addr 0x2648340, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCompleted();

  /// @brief Method GetResult, addr 0x2648348, size 0x2c, virtual false, abstract: false, final false
  inline void GetResult();

  /// @brief Method UnsafeOnCompleted, addr 0x2648374, size 0x58, virtual true, abstract: false, final true
