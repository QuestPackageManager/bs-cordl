...
public:
  ...
  /// @brief Method EndInliningScope, addr 0x5b8805c, size 0x14, virtual false, abstract: false, final false
  inline void EndInliningScope();

  static inline ::System::Threading::Tasks::StackGuard* New_ctor();

  /// @brief Method TryBeginInliningScope, addr 0x5b88044, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b80f84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
