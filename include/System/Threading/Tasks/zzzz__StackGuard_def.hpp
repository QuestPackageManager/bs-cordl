...
public:
  ...
  /// @brief Method EndInliningScope, addr 0x3e64824, size 0x14, virtual false, abstract: false, final false
  inline void EndInliningScope();

  static inline ::System::Threading::Tasks::StackGuard* New_ctor();

  /// @brief Method TryBeginInliningScope, addr 0x3e647e4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e5d538, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
