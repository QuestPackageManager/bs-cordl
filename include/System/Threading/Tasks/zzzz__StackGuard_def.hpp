...
/// @brief Method EndInliningScope, addr 0x5b89bd4, size 0x14, virtual false, abstract: false, final false
inline void EndInliningScope() ;

static inline ::System::Threading::Tasks::StackGuard* New_ctor() ;

/// @brief Method TryBeginInliningScope, addr 0x5b89bbc, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b82afc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
