...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::StackGuard*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::StackGuard*, "System.Threading.Tasks", "StackGuard");
...
public:
  ...
  /// @brief Method EndInliningScope, addr 0x5cc3d24, size 0x14, virtual false, abstract: false, final false
  inline void EndInliningScope();

  static inline ::System::Threading::Tasks::StackGuard* New_ctor();

  /// @brief Method TryBeginInliningScope, addr 0x5cc3d0c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cbcc4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Threading::Tasks::StackGuard) == 0x18, "Size mismatch!");
