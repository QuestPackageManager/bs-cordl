...
public:
  ...
  /// @brief Method Run, addr 0x5cc6184, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cc2c40, size 0x12c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StandardTaskContinuation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StandardTaskContinuation(StandardTaskContinuation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StandardTaskContinuation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StandardTaskContinuation(StandardTaskContinuationconst&) = delete;
