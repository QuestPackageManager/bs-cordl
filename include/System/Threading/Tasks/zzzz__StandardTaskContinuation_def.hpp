...
public:
  ...
  /// @brief Method Run, addr 0x3e6e050, size 0x190, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e6ad20, size 0x120, virtual false, abstract: false, final false
