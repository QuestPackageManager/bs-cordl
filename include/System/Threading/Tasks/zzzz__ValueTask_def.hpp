...
public:
  ...
  /// @brief Method .ctor addr 0x24c7dd8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <.cctor>b__4_0 addr 0x24c7de0 size 0x2a4 virtual false final false
...
namespace System::Threading::Tasks {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2769)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2769), inst: 880 }),
// TypeDefinitionIndex(TypeDefinitionIndex(2790))} Self: TypeDefinitionIndex(TypeDefinitionIndex(2761)) CS Name: ::ValueTask::ValueTaskSourceAsTask*
...
public:
  ...
  /// @brief Method .ctor addr 0x24c7888 size 0x120 virtual false final false
...
public:
  ...
  /// @brief Method get_CompletedTask addr 0x24c7264 size 0x88 virtual false final false
  static inline ::System::Threading::Tasks::Task* get_CompletedTask();

  /// @brief Method .ctor addr 0x24c72ec size 0x38 virtual false final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor addr 0x24c7324 size 0x3c virtual false final false
  inline void _ctor(::System::Threading::Tasks::Sources::IValueTaskSource* source, int16_t token);

  /// @brief Method .ctor addr 0x24c7360 size 0x14 virtual false final false
  inline void _ctor(::System::Object* obj, int16_t token, bool continueOnCapturedContext);

  /// @brief Method GetHashCode addr 0x24c7374 size 0x18 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x24c738c size 0x88 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0x24c7414 size 0x24 virtual true final true
  inline bool Equals(::System::Threading::Tasks::ValueTask other);

  /// @brief Method AsTask addr 0x24c7438 size 0xb8 virtual false final false
  inline ::System::Threading::Tasks::Task* AsTask();

  /// @brief Method GetTaskForValueTaskSource addr 0x24c74f0 size 0x2d8 virtual false final false
  inline ::System::Threading::Tasks::Task* GetTaskForValueTaskSource(::System::Threading::Tasks::Sources::IValueTaskSource* t);

  /// @brief Method get_IsCompleted addr 0x24c79a8 size 0x104 virtual false final false
  inline bool get_IsCompleted();

  /// @brief Method ThrowIfCompletedUnsuccessfully addr 0x24c7aac size 0x104 virtual false final false
  inline void ThrowIfCompletedUnsuccessfully();

  /// @brief Method GetAwaiter addr 0x24c7bb0 size 0xc virtual false final false
  inline ::System::Runtime::CompilerServices::ValueTaskAwaiter GetAwaiter();

  /// @brief Method ConfigureAwait addr 0x24c7bbc size 0x18 virtual false final false
