...
public:
  ...
  /// @brief Method <.cctor>b__4_0, addr 0x3e61ba0, size 0x2a4, virtual false, abstract: false, final false
  inline void __cctor_b__4_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x3e61b98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3e61648, size 0x120, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AsTask, addr 0x3e611e4, size 0xcc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* AsTask();

  /// @brief Method ConfigureAwait, addr 0x3e6197c, size 0x20, virtual false, abstract: false, final false
  inline ::System::Runtime::CompilerServices::ConfiguredValueTaskAwaitable ConfigureAwait(bool continueOnCapturedContext);

  /// @brief Method Equals, addr 0x3e61108, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3e611c0, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::System::Threading::Tasks::ValueTask other);

  /// @brief Method GetAwaiter, addr 0x3e61970, size 0xc, virtual false, abstract: false, final false
  inline ::System::Runtime::CompilerServices::ValueTaskAwaiter GetAwaiter();

  /// @brief Method GetHashCode, addr 0x3e610f0, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTaskForValueTaskSource, addr 0x3e612b0, size 0x2d4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* GetTaskForValueTaskSource(::System::Threading::Tasks::Sources::IValueTaskSource* t);

  /// @brief Method ThrowIfCompletedUnsuccessfully, addr 0x3e6186c, size 0x104, virtual false, abstract: false, final false
  inline void ThrowIfCompletedUnsuccessfully();

  /// @brief Method .ctor, addr 0x3e610dc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* obj, int16_t token, bool continueOnCapturedContext);

  /// @brief Method .ctor, addr 0x3e610a0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Sources::IValueTaskSource* source, int16_t token);

  /// @brief Method .ctor, addr 0x3e61068, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  static inline ::System::Threading::Tasks::Task* getStaticF_s_canceledTask();

  /// @brief Method get_CompletedTask, addr 0x3e60fe0, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* get_CompletedTask();

  /// @brief Method get_IsCompleted, addr 0x3e61768, size 0x104, virtual false, abstract: false, final false
