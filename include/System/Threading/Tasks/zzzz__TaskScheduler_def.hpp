...
public:
  ...
  /// @brief Method NotifyWorkItemProgress, addr 0x3e0a240, size 0x4, virtual true, abstract: false, final false
  inline void NotifyWorkItemProgress();

  /// @brief Method PublishUnobservedTaskException, addr 0x3e09410, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method TryDequeue, addr 0x3e0a238, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method TryRunInline, addr 0x3e03db8, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e0a24c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Current, addr 0x3e04720, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_Current();

  /// @brief Method get_Default, addr 0x3e0a254, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_Default();

  /// @brief Method get_Id, addr 0x3e03fac, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_Id();

  /// @brief Method get_InternalCurrent, addr 0x3e033f8, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::TaskScheduler* get_InternalCurrent();

  /// @brief Method get_RequiresAtomicStartTransition, addr 0x3e0a244, size 0x8, virtual true, abstract: false, final false
