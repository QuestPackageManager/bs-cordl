...
public:
  ...
  /// @brief Field CompletionNotification value: static_cast<int32_t>(0x0)
  static ::System::Threading::Tasks::CausalitySynchronousWork const CompletionNotification;

  /// @brief Field ProgressNotification value: static_cast<int32_t>(0x1)
  static ::System::Threading::Tasks::CausalitySynchronousWork const ProgressNotification;

  /// @brief Field Execution value: static_cast<int32_t>(0x2)
