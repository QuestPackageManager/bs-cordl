...
public:
  ...
  /// @brief Method Add, addr 0x3e01658, size 0xc, virtual false, abstract: false, final false
  inline void Add(::System::Object* exceptionObject, bool representsCancellation);

  /// @brief Method AddFaultException, addr 0x3e09600, size 0x510, virtual false, abstract: false, final false
  inline void AddFaultException(::System::Object* exceptionObject);

  /// @brief Method CreateExceptionObject, addr 0x3e01664, size 0x1ac, virtual false, abstract: false, final false
  inline ::System::AggregateException* CreateExceptionObject(bool calledFromFinalizer, ::System::Exception* includeThisException);

  /// @brief Method Finalize, addr 0x3e091ac, size 0x1f8, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetCancellationExceptionDispatchInfo, addr 0x3e09b80, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* GetCancellationExceptionDispatchInfo();

  /// @brief Method GetExceptionDispatchInfos, addr 0x3e01928, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkAsHandled, addr 0x3e01420, size 0x7c, virtual false, abstract: false, final false
  inline void MarkAsHandled(bool calledFromFinalizer);

  /// @brief Method MarkAsUnhandled, addr 0x3e09b10, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCancellationException, addr 0x3e09544, size 0xbc, virtual false, abstract: false, final false
  inline void SetCancellationException(::System::Object* exceptionObject);

  /// @brief Method ShouldFailFastOnUnobservedException, addr 0x3e091a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e01630, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::Tasks::Task* task);

  static inline bool getStaticF_s_failFastOnUnobservedException();

  /// @brief Method get_ContainsFaultList, addr 0x3e0124c, size 0x1c, virtual false, abstract: false, final false
