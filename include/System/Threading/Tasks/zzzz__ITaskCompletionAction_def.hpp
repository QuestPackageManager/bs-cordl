...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ITaskCompletionAction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ITaskCompletionAction(ITaskCompletionActionconst&) = delete;
