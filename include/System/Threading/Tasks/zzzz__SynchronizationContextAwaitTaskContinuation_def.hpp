...
public:
  ...
  /// @brief Method <.cctor>b__7_0, addr 0x28b0fec, size 0x6c, virtual false, abstract: false, final false
  inline void __cctor_b__7_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x28b0fe4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPostActionCallback, addr 0x28b0df4, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method PostAction, addr 0x28b0d60, size 0x94, virtual false, abstract: false, final false
  static inline void PostAction(::System::Object* state);

  /// @brief Method Run, addr 0x28b09f8, size 0x1ec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x28aba74, size 0x30, virtual false, abstract: false, final false
