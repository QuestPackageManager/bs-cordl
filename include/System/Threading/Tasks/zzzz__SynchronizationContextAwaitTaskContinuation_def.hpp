...
public:
  ...
  /// @brief Method <.cctor>b__7_0, addr 0x3e6bb5c, size 0x6c, virtual false, abstract: false, final false
  inline void __cctor_b__7_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x3e6bb54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPostActionCallback, addr 0x3e6b974, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method PostAction, addr 0x3e6b8e0, size 0x94, virtual false, abstract: false, final false
  static inline void PostAction(::System::Object* state);

  /// @brief Method Run, addr 0x3e6b608, size 0x164, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3e666d8, size 0x30, virtual false, abstract: false, final false
