...
public:
  ...
  /// @brief Method <.cctor>b__7_0, addr 0x29b3898, size 0x6c, virtual false, abstract: false, final false
  inline void __cctor_b__7_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x29b3890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPostActionCallback, addr 0x29b36a0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method PostAction, addr 0x29b360c, size 0x94, virtual false, abstract: false, final false
  static inline void PostAction(::System::Object* state);

  /// @brief Method Run, addr 0x29b32a4, size 0x1ec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x29ae320, size 0x30, virtual false, abstract: false, final false
