...
public:
  ...
  /// @brief Method <.cctor>b__7_0, addr 0x3df41bc, size 0x6c, virtual false, abstract: false, final false
  inline void __cctor_b__7_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x3df41b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPostActionCallback, addr 0x3df3fd4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method PostAction, addr 0x3df3f40, size 0x94, virtual false, abstract: false, final false
  static inline void PostAction(::System::Object* state);

  /// @brief Method Run, addr 0x3df3c68, size 0x164, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3deed38, size 0x30, virtual false, abstract: false, final false
