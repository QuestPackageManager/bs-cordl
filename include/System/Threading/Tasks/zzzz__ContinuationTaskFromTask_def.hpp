...
public:
  ...
  /// @brief Method InnerInvoke, addr 0x277ffa8, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x277cbd0, size 0xb4, virtual false, abstract: false, final false
