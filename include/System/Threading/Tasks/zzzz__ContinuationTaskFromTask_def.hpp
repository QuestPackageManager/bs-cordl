...
public:
  ...
  /// @brief Method InnerInvoke, addr 0x28b05c4, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28ad1ec, size 0xb4, virtual false, abstract: false, final false
