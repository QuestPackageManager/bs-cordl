...
public:
  ...
  /// @brief Method InnerInvoke, addr 0x5b15b7c, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b124c4, size 0xb8, virtual false, abstract: false, final false
