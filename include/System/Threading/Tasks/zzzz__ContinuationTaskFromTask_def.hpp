...
public:
  ...
  /// @brief Method InnerInvoke, addr 0x3e67f7c, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e64ae0, size 0xb4, virtual false, abstract: false, final false
