...
public:
  ...
  /// @brief Method InnerInvoke, addr 0x5cc5f60, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cc28a8, size 0xb8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ContinuationTaskFromTask", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ContinuationTaskFromTask(ContinuationTaskFromTask&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ContinuationTaskFromTask", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ContinuationTaskFromTask(ContinuationTaskFromTaskconst&) = delete;
