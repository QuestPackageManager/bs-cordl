...
public:
  ...
  /// @brief Method InnerInvoke, addr 0x29cf4fc, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29cc124, size 0xb4, virtual false, abstract: false, final false
