...
public:
  ...
  /// @brief Method InnerInvoke, addr 0x3e64838, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e6139c, size 0xb4, virtual false, abstract: false, final false
