...
namespace System::Threading::Tasks {
template<typename TResult>
class TaskWhenAnyCast_Task_1___c;
}
namespace System::Threading::Tasks {
template<typename TResult>
class Task_1_TaskWhenAnyCast;
}
namespace System::Threading::Tasks {
class Task;
}
...
/// @brief Field Value, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Value, put=setStaticF_Value)) ::System::Func_2<::System::Threading::Tasks::Task_1<::System::Threading::Tasks::Task*>*,::System::Threading::Tasks::Task_1<TResult>*>*  Value;
