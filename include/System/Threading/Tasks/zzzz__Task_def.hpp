...
public:
  ...
  /// @brief Method SetCompleted addr 0x24cb594 size 0x28 virtual false final false
  inline void SetCompleted();

  /// @brief Method UnregisterCancellationCallback addr 0x24cb5bc size 0x108 virtual false final false
  inline void UnregisterCancellationCallback();

  static inline ::System::Threading::Tasks::__Task__ContingentProperties* New_ctor();

  /// @brief Method .ctor addr 0x24c87ac size 0x24 virtual false final false
  inline void _ctor();
...
namespace System::Threading::Tasks {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2676))}
...
public:
  ...
  /// @brief Method .ctor addr 0x24cd788 size 0x60 virtual false final false
  inline void _ctor();

  /// @brief Method Invoke addr 0x24d0b94 size 0x8 virtual true final true
  inline void Invoke(::System::Threading::Tasks::Task* completingTask);

  /// @brief Method get_InvokeMayRunArbitraryCode addr 0x24d0b9c size 0x8 virtual true final true
...
public:
  ...
  /// @brief Method .ctor addr 0x24d1084 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Delay>b__247_0 addr 0x24d108c size 0x60 virtual false final false
  inline void _Delay_b__247_0(::System::Object* state);

  /// @brief Method <Delay>b__247_1 addr 0x24d10ec size 0x60 virtual false final false
  inline void _Delay_b__247_1(::System::Object* state);

  /// @brief Method <.cctor>b__271_0 addr 0x24d114c size 0x6c virtual false final false
  inline ::System::Threading::Tasks::__Task__ContingentProperties* __cctor_b__271_0();

  /// @brief Method <.cctor>b__271_1 addr 0x24d11b8 size 0x20 virtual false final false
  inline bool __cctor_b__271_1(::System::Threading::Tasks::Task* t);

  /// @brief Method <.cctor>b__271_2 addr 0x24d11d8 size 0xc virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x24c86ec size 0xc0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24c87d0 size 0x28 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x24c87f8 size 0x124 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24c8a74 size 0xc8 virtual false final false
  ...
  /// @brief Method TaskConstructorCore addr 0x24c891c size 0x158 virtual false final false
  ...
  /// @brief Method AssignCancellationToken addr 0x24c8bc4 size 0x28c virtual false final false
  ...
  /// @brief Method TaskCancelCallback addr 0x24c91a8 size 0xf0 virtual false final false
  static inline void TaskCancelCallback(::System::Object* o);

  /// @brief Method TrySetCanceled addr 0x24c8084 size 0x8 virtual false final false
  inline bool TrySetCanceled(::System::Threading::CancellationToken tokenToRecord);

  /// @brief Method TrySetCanceled addr 0x24c77c8 size 0x54 virtual false final false
  inline bool TrySetCanceled(::System::Threading::CancellationToken tokenToRecord, ::System::Object* cancellationException);

  /// @brief Method TrySetException addr 0x24c808c size 0x70 virtual false final false
  inline bool TrySetException(::System::Object* exceptionObject);

  /// @brief Method get_Options addr 0x24c8f28 size 0x5c virtual false final false
  inline ::System::Threading::Tasks::TaskCreationOptions get_Options();

  /// @brief Method OptionsMethod addr 0x24c9864 size 0x8 virtual false final false
  static inline ::System::Threading::Tasks::TaskCreationOptions OptionsMethod(int32_t flags);

  /// @brief Method AtomicStateUpdate addr 0x24c94ec size 0x88 virtual false final false
  inline bool AtomicStateUpdate(int32_t newBits, int32_t illegalBits);

  /// @brief Method AtomicStateUpdate addr 0x24c986c size 0xa0 virtual false final false
  inline bool AtomicStateUpdate(int32_t newBits, int32_t illegalBits, ByRef<int32_t> oldFlags);

  /// @brief Method SetNotificationForWaitCompletion addr 0x24c990c size 0x7c virtual false final false
  inline void SetNotificationForWaitCompletion(bool enabled);

  /// @brief Method NotifyDebuggerOfWaitCompletionIfNecessary addr 0x24c9988 size 0x50 virtual false final false
  inline bool NotifyDebuggerOfWaitCompletionIfNecessary();

  /// @brief Method AnyTaskRequiresNotifyDebuggerOfWaitCompletion addr 0x24c9a18 size 0x90 virtual false final false
  ...
  /// @brief Method get_IsWaitNotificationEnabledOrNotRanToCompletion addr 0x24c9aa8 size 0x28 virtual false final false
  inline bool get_IsWaitNotificationEnabledOrNotRanToCompletion();

  /// @brief Method get_ShouldNotifyDebuggerOfWaitCompletion addr 0x24c9ad0 size 0x18 virtual true final false
  inline bool get_ShouldNotifyDebuggerOfWaitCompletion();

  /// @brief Method get_IsWaitNotificationEnabled addr 0x24c99d8 size 0x18 virtual false final false
  inline bool get_IsWaitNotificationEnabled();

  /// @brief Method NotifyDebuggerOfWaitCompletion addr 0x24c99f0 size 0x28 virtual false final false
  inline void NotifyDebuggerOfWaitCompletion();

  /// @brief Method MarkStarted addr 0x24c9ae8 size 0xc virtual false final false
  inline bool MarkStarted();

  /// @brief Method AddNewChild addr 0x24c8b50 size 0x74 virtual false final false
  inline void AddNewChild();

  /// @brief Method DisregardChild addr 0x24c9160 size 0x48 virtual false final false
  inline void DisregardChild();

  /// @brief Method InternalStartNew addr 0x24c9af4 size 0x10c virtual false final false
  ...
  /// @brief Method get_Id addr 0x24c83a8 size 0x90 virtual false final false
  inline int32_t get_Id();

  /// @brief Method get_InternalCurrent addr 0x24c9e10 size 0x58 virtual false final false
  static inline ::System::Threading::Tasks::Task* get_InternalCurrent();

  /// @brief Method InternalCurrentIfAttached addr 0x24c9e68 size 0x9c virtual false final false
  ...
  /// @brief Method get_CurrentStackGuard addr 0x24c9f04 size 0xb4 virtual false final false
  static inline ::System::Threading::Tasks::StackGuard* get_CurrentStackGuard();

  /// @brief Method get_Exception addr 0x24c9fc0 size 0x3c virtual false final false
  inline ::System::AggregateException* get_Exception();

  /// @brief Method get_Status addr 0x24ca160 size 0x60 virtual false final false
  inline ::System::Threading::Tasks::TaskStatus get_Status();

  /// @brief Method get_IsCanceled addr 0x24ca1c0 size 0x20 virtual false final false
  inline bool get_IsCanceled();

  /// @brief Method get_IsCancellationRequested addr 0x24ca1e0 size 0x50 virtual false final false
  inline bool get_IsCancellationRequested();

  /// @brief Method EnsureContingentPropertiesInitialized addr 0x24c8ee8 size 0x40 virtual false final false
  inline ::System::Threading::Tasks::__Task__ContingentProperties* EnsureContingentPropertiesInitialized(bool needsProtection);

  /// @brief Method EnsureContingentPropertiesInitializedCore addr 0x24ca230 size 0xe0 virtual false final false
  ...
  /// @brief Method get_CancellationToken addr 0x24c6c1c size 0x24 virtual false final false
  inline ::System::Threading::CancellationToken get_CancellationToken();

  /// @brief Method get_IsCancellationAcknowledged addr 0x24ca310 size 0x18 virtual false final false
  inline bool get_IsCancellationAcknowledged();

  /// @brief Method get_IsCompleted addr 0x24c6eac size 0x64 virtual true final true
  inline bool get_IsCompleted();

  /// @brief Method IsCompletedMethod addr 0x24ca328 size 0x10 virtual false final false
  static inline bool IsCompletedMethod(int32_t flags);

  /// @brief Method get_IsCompletedSuccessfully addr 0x24ca338 size 0x28 virtual false final false
  inline bool get_IsCompletedSuccessfully();

  /// @brief Method get_CreationOptions addr 0x24c8b3c size 0x14 virtual false final false
  inline ::System::Threading::Tasks::TaskCreationOptions get_CreationOptions();

  /// @brief Method System.IAsyncResult.get_AsyncWaitHandle addr 0x24ca360 size 0x88 virtual true final true
  inline ::System::Threading::WaitHandle* System_IAsyncResult_get_AsyncWaitHandle();

  /// @brief Method get_AsyncState addr 0x24ca4dc size 0x8 virtual true final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method System.IAsyncResult.get_CompletedSynchronously addr 0x24ca4e4 size 0x8 virtual true final true
  inline bool System_IAsyncResult_get_CompletedSynchronously();

  /// @brief Method get_ExecutingTaskScheduler addr 0x24ca4ec size 0x8 virtual false final false
  inline ::System::Threading::Tasks::TaskScheduler* get_ExecutingTaskScheduler();

  /// @brief Method get_Factory addr 0x24ca4f4 size 0x58 virtual false final false
  static inline ::System::Threading::Tasks::TaskFactory* get_Factory();

  /// @brief Method get_CompletedTask addr 0x24ca54c size 0x58 virtual false final false
  static inline ::System::Threading::Tasks::Task* get_CompletedTask();

  /// @brief Method get_CompletedEvent addr 0x24ca3e8 size 0xf4 virtual false final false
  inline ::System::Threading::ManualResetEventSlim* get_CompletedEvent();

  /// @brief Method get_ExceptionRecorded addr 0x24ca5a4 size 0x54 virtual false final false
  inline bool get_ExceptionRecorded();

  /// @brief Method get_IsFaulted addr 0x24c9ffc size 0x18 virtual false final false
  inline bool get_IsFaulted();

  /// @brief Method get_CapturedContext addr 0x24ca614 size 0x70 virtual false final false
  inline ::System::Threading::ExecutionContext* get_CapturedContext();

  /// @brief Method set_CapturedContext addr 0x24c8e50 size 0x98 virtual false final false
  inline void set_CapturedContext(::System::Threading::ExecutionContext* value);

  /// @brief Method Dispose addr 0x24ca684 size 0x6c virtual true final true
  inline void Dispose();

  /// @brief Method Dispose addr 0x24ca6f0 size 0xe0 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method ScheduleAndStart addr 0x24c9c00 size 0x210 virtual false final false
  inline void ScheduleAndStart(bool needsProtection);

  /// @brief Method AddException addr 0x24c96d0 size 0x8 virtual false final false
  inline void AddException(::System::Object* exceptionObject);

  /// @brief Method AddException addr 0x24ca84c size 0x198 virtual false final false
  inline void AddException(::System::Object* exceptionObject, bool representsCancellation);

  /// @brief Method GetExceptions addr 0x24ca014 size 0x14c virtual false final false
  inline ::System::AggregateException* GetExceptions(bool includeTaskCanceledExceptions);

  /// @brief Method GetExceptionDispatchInfos addr 0x24cabcc size 0x10c virtual false final false
  ...
  /// @brief Method GetCancellationExceptionDispatchInfo addr 0x24cad64 size 0x30 virtual false final false
  inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* GetCancellationExceptionDispatchInfo();

  /// @brief Method ThrowIfExceptional addr 0x24cad94 size 0x48 virtual false final false
  inline void ThrowIfExceptional(bool includeTaskCanceledExceptions);

  /// @brief Method UpdateExceptionObservedStatus addr 0x24caddc size 0xd4 virtual false final false
  inline void UpdateExceptionObservedStatus();

  /// @brief Method get_IsExceptionObservedByParent addr 0x24caeb0 size 0x18 virtual false final false
  inline bool get_IsExceptionObservedByParent();

  /// @brief Method get_IsDelegateInvoked addr 0x24caec8 size 0x18 virtual false final false
  inline bool get_IsDelegateInvoked();

  /// @brief Method Finish addr 0x24c96d8 size 0x18c virtual false final false
  inline void Finish(bool bUserDelegateExecuted);

  /// @brief Method FinishStageTwo addr 0x24caee0 size 0x278 virtual false final false
  inline void FinishStageTwo();

  /// @brief Method FinishStageThree addr 0x24cb6c4 size 0x50 virtual false final false
  inline void FinishStageThree();

  /// @brief Method ProcessChildCompletion addr 0x24cb714 size 0x1b8 virtual false final false
  inline void ProcessChildCompletion(::System::Threading::Tasks::Task* childTask);

  /// @brief Method AddExceptionsFromChildren addr 0x24cb158 size 0x43c virtual false final false
  inline void AddExceptionsFromChildren();

  /// @brief Method Execute addr 0x24cbfb4 size 0xac virtual false final false
  inline void Execute();

  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem addr 0x24cc168 size 0x8 virtual true final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method ExecuteEntry addr 0x24cc170 size 0x11c virtual false final false
  inline bool ExecuteEntry(bool bPreventDoubleExecution);

  /// @brief Method ExecutionContextCallback addr 0x24cc430 size 0x78 virtual false final false
  static inline void ExecutionContextCallback(::System::Object* obj);

  /// @brief Method InnerInvoke addr 0x24cc4a8 size 0xb4 virtual true final false
  inline void InnerInvoke();

  /// @brief Method HandleException addr 0x24cc060 size 0x108 virtual false final false
  inline void HandleException(::System::Exception* unhandledException);

  /// @brief Method GetAwaiter addr 0x24c7130 size 0x4 virtual false final false
  inline ::System::Runtime::CompilerServices::TaskAwaiter GetAwaiter();

  /// @brief Method ConfigureAwait addr 0x24c713c size 0x34 virtual false final false
  inline ::System::Runtime::CompilerServices::ConfiguredTaskAwaitable ConfigureAwait(bool continueOnCapturedContext);

  /// @brief Method SetContinuationForAwait addr 0x24cc588 size 0x204 virtual false final false
  ...
  /// @brief Method Yield addr 0x24cc9b0 size 0x8 virtual false final false
  static inline ::System::Runtime::CompilerServices::YieldAwaitable Yield();

  /// @brief Method Wait addr 0x24cc9b8 size 0xc virtual false final false
  inline void Wait();

  /// @brief Method Wait addr 0x24cc9c4 size 0x11c virtual false final false
  inline bool Wait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method WrappedTryRunInline addr 0x24cd1cc size 0xd8 virtual false final false
  inline bool WrappedTryRunInline();

  /// @brief Method InternalWait addr 0x24ccae0 size 0x6ec virtual false final false
  inline bool InternalWait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method SpinThenBlockingWait addr 0x24cd530 size 0x19c virtual false final false
  inline bool SpinThenBlockingWait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method SpinWait addr 0x24cd6cc size 0xbc virtual false final false
  inline bool SpinWait(int32_t millisecondsTimeout);

  /// @brief Method InternalCancel addr 0x24c8f84 size 0x1dc virtual false final false
  inline bool InternalCancel(bool bCancelNonExecutingOnly);

  /// @brief Method RecordInternalCancellationRequest addr 0x24cd8bc size 0x48 virtual false final false
  inline void RecordInternalCancellationRequest();

  /// @brief Method RecordInternalCancellationRequest addr 0x24cd904 size 0x8c virtual false final false
  inline void RecordInternalCancellationRequest(::System::Threading::CancellationToken tokenToRecord);

  /// @brief Method RecordInternalCancellationRequest addr 0x24c9574 size 0x3c virtual false final false
  ...
  /// @brief Method CancellationCleanupLogic addr 0x24c95b0 size 0x120 virtual false final false
  inline void CancellationCleanupLogic();

  /// @brief Method SetCancellationAcknowledged addr 0x24cc55c size 0x2c virtual false final false
  inline void SetCancellationAcknowledged();

  /// @brief Method FinishContinuations addr 0x24cb8cc size 0x6e8 virtual false final false
  inline void FinishContinuations();

  /// @brief Method LogFinishCompletionNotification addr 0x24cdb14 size 0x54 virtual false final false
  inline void LogFinishCompletionNotification();

  /// @brief Method ContinueWith addr 0x24cdb68 size 0x74 virtual false final false
  inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_1<::System::Threading::Tasks::Task*>* continuationAction);

  /// @brief Method ContinueWith addr 0x24cdc7c size 0x164 virtual false final false
  ...
  /// @brief Method ContinueWith addr 0x24ce0e0 size 0x14 virtual false final false
  ...
  /// @brief Method ContinueWith addr 0x24ce0f4 size 0x170 virtual false final false
  inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_2<::System::Threading::Tasks::Task*, ::System::Object*>* continuationAction, ::System::Object* state,
                                                        ::System::Threading::Tasks::TaskScheduler* scheduler, ::System::Threading::CancellationToken cancellationToken,
                                                        ::System::Threading::Tasks::TaskContinuationOptions continuationOptions);

  /// @brief Method CreationOptionsFromContinuationOptions addr 0x24cdde0 size 0x12c virtual false final false
  ...
  /// @brief Method ContinueWithCore addr 0x24cdfc0 size 0x120 virtual false final false
  ...
  /// @brief Method AddCompletionAction addr 0x24ce384 size 0x8 virtual false final false
  inline void AddCompletionAction(::System::Threading::Tasks::ITaskCompletionAction* action);

  /// @brief Method AddCompletionAction addr 0x24cd7e8 size 0xd4 virtual false final false
  inline void AddCompletionAction(::System::Threading::Tasks::ITaskCompletionAction* action, bool addBeforeOthers);

  /// @brief Method AddTaskContinuationComplex addr 0x24ce38c size 0x320 virtual false final false
  inline bool AddTaskContinuationComplex(::System::Object* tc, bool addBeforeOthers);

  /// @brief Method AddTaskContinuation addr 0x24cc890 size 0x94 virtual false final false
  inline bool AddTaskContinuation(::System::Object* tc, bool addBeforeOthers);

  /// @brief Method RemoveContinuation addr 0x24c9298 size 0x254 virtual false final false
  ...
  /// @brief Method FromException addr 0x24c781c size 0x6c virtual false final false
  ...
  /// @brief Method FromCancellation addr 0x24ce6ac size 0xc8 virtual false final false
  static inline ::System::Threading::Tasks::Task* FromCancellation(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method FromCanceled addr 0x24c7c5c size 0x54 virtual false final false
  ...
  /// @brief Method Run addr 0x24ce774 size 0xd0 virtual false final false
  static inline ::System::Threading::Tasks::Task* Run(::System::Action* action);

  /// @brief Method Run addr 0x24ce844 size 0xdc virtual false final false
  ...
  /// @brief Method Run addr 0x24ce920 size 0x58 virtual false final false
  static inline ::System::Threading::Tasks::Task* Run(::System::Func_1<::System::Threading::Tasks::Task*>* function);

  /// @brief Method Run addr 0x24ce978 size 0x210 virtual false final false
  ...
  /// @brief Method Delay addr 0x24ceb88 size 0xf4 virtual false final false
  ...
  /// @brief Method Delay addr 0x24cefb0 size 0x58 virtual false final false
  static inline ::System::Threading::Tasks::Task* Delay(int32_t millisecondsDelay);

  /// @brief Method Delay addr 0x24cec7c size 0x334 virtual false final false
  ...
  /// @brief Method WhenAll addr 0x24cf11c size 0x864 virtual false final false
  ...
  /// @brief Method WhenAll addr 0x24cf980 size 0x1b8 virtual false final false
  ...
  /// @brief Method InternalWhenAll addr 0x24cfb38 size 0xd0 virtual false final false
  ...
  /// @brief Method WhenAny addr 0x24cfd7c size 0x198 virtual false final false
  ...
  /// @brief Method WhenAny addr 0x24d0150 size 0x47c virtual false final false
  ...
  /// @brief Method AddToActiveTasks addr 0x24d05cc size 0x164 virtual false final false
  static inline bool AddToActiveTasks(::System::Threading::Tasks::Task* task);

  /// @brief Method RemoveFromActiveTasks addr 0x24d0730 size 0x144 virtual false final false
  static inline void RemoveFromActiveTasks(int32_t taskId);

  /// @brief Method MarkAborted addr 0x24d0874 size 0x4 virtual true final true
  inline void MarkAborted(::System::Threading::ThreadAbortException* e);

  /// @brief Method ExecuteWithThreadLocal addr 0x24cc28c size 0x1a4 virtual false final false
