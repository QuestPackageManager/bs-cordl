...
public:
  ...
  /// @brief Method <.cctor>b__10_0, addr 0x5cc68d4, size 0x88, virtual false, abstract: false, final false
  inline void __cctor_b__10_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x5cc68d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method NotifyWorkItemProgress, addr 0x5cc6798, size 0x10, virtual true, abstract: false, final false
  inline void NotifyWorkItemProgress();

  /// @brief Method QueueTask, addr 0x5cc64ac, size 0x208, virtual true, abstract: false, final false
  inline void QueueTask(::System::Threading::Tasks::Task* task);

  /// @brief Method TryDequeue, addr 0x5cc6790, size 0x8, virtual true, abstract: false, final false
  inline bool TryDequeue(::System::Threading::Tasks::Task* task);

  /// @brief Method TryExecuteTaskInline, addr 0x5cc66b4, size 0xdc, virtual true, abstract: false, final false
  inline bool TryExecuteTaskInline(::System::Threading::Tasks::Task* task, bool taskWasPreviouslyQueued);

  /// @brief Method .ctor, addr 0x5cc6454, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Threading::ParameterizedThreadStart* getStaticF_s_longRunningThreadWork();

  /// @brief Method get_RequiresAtomicStartTransition, addr 0x5cc67a8, size 0x8, virtual true, abstract: false, final false
