...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::Task_WhenAllPromise_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::Task_WhenAllPromise_1, "System.Threading.Tasks", "Task/WhenAllPromise`1");
...
class CORDL_TYPE Task_WhenAllPromise_1 : public ::System::Threading::Tasks::Task_1<::ArrayW<T>> {
public:
  // Declarations
  ...
  __declspec(property(get = __cordl_internal_get_m_tasks, put = __cordl_internal_set_m_tasks)) ::ArrayW<::System::Threading::Tasks::Task_1<T>*> m_tasks;
  ...
  static inline ::GlobalNamespace::Task_WhenAllPromise_1<T>* New_ctor(::ArrayW<::System::Threading::Tasks::Task_1<T>*> tasks);

  constexpr int32_t const& __cordl_internal_get_m_count() const;

  constexpr int32_t& __cordl_internal_get_m_count();

  constexpr ::ArrayW<::System::Threading::Tasks::Task_1<T>*> const& __cordl_internal_get_m_tasks() const;

  constexpr ::ArrayW<::System::Threading::Tasks::Task_1<T>*>& __cordl_internal_get_m_tasks();

  constexpr void __cordl_internal_set_m_count(int32_t value);

  constexpr void __cordl_internal_set_m_tasks(::ArrayW<::System::Threading::Tasks::Task_1<T>*> value);

  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Threading::Tasks::Task_1<T>*> tasks);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Task_WhenAllPromise_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Task_WhenAllPromise_1(Task_WhenAllPromise_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Task_WhenAllPromise_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Task_WhenAllPromise_1(Task_WhenAllPromise_1const&) = delete;
  ...
  ::ArrayW<::System::Threading::Tasks::Task_1<T>*> ___m_tasks;
