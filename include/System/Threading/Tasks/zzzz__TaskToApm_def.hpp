...
public:
  ...
  /// @brief Method System.IAsyncResult.get_AsyncState, addr 0x29c5308, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_IAsyncResult_get_AsyncState();

  /// @brief Method System.IAsyncResult.get_AsyncWaitHandle, addr 0x29c5330, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* System_IAsyncResult_get_AsyncWaitHandle();

  /// @brief Method System.IAsyncResult.get_CompletedSynchronously, addr 0x29c5310, size 0x8, virtual true, abstract: false, final true
  inline bool System_IAsyncResult_get_CompletedSynchronously();

  /// @brief Method System.IAsyncResult.get_IsCompleted, addr 0x29c5318, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x29c50a8, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <InvokeCallbackWhenTaskCompletes>b__0, addr 0x29c53d4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c52cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Begin, addr 0x29c4f50, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method End, addr 0x29c51dc, size 0xec, virtual false, abstract: false, final false
  static inline void End(::System::IAsyncResult* asyncResult);

  /// @brief Method InvokeCallbackWhenTaskCompletes, addr 0x29c50e4, size 0xf8, virtual false, abstract: false, final false
