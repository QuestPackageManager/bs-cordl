...
public:
  // Declarations
  /// @brief Method TraceOperationCompletion, addr 0x3e6db34, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceOperationCreation, addr 0x3e6db30, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceSynchronousWorkCompletion, addr 0x3e6a768, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceSynchronousWorkStart, addr 0x3e6db38, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LoggingOn, addr 0x3e6a760, size 0x8, virtual false, abstract: false, final false
