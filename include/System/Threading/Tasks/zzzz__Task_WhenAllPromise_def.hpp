...
public:
  ...
  /// @brief Method Invoke, addr 0x5b87a44, size 0x334, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b868c8, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Threading::Tasks::Task*, ::Array<::System::Threading::Tasks::Task*>*> tasks);

  /// @brief Method get_InvokeMayRunArbitraryCode, addr 0x5b87df0, size 0x8, virtual true, abstract: false, final true
  inline bool get_InvokeMayRunArbitraryCode();

  /// @brief Method get_ShouldNotifyDebuggerOfWaitCompletion, addr 0x5b87d78, size 0x78, virtual true, abstract: false, final false
