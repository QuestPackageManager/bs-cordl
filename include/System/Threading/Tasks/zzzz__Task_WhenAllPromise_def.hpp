...
// TypeDefinitionIndex(TypeDefinitionIndex(2790))} Self: TypeDefinitionIndex(TypeDefinitionIndex(2780)) CS Name: ::Task::WhenAllPromise*
...
public:
  ...
  /// @brief Method .ctor addr 0x24cfc08 size 0x174 virtual false final false
  inline void _ctor(::ArrayW<::System::Threading::Tasks::Task*, ::Array<::System::Threading::Tasks::Task*>*> tasks);

  /// @brief Method Invoke addr 0x24d0cdc size 0x2c8 virtual true final true
  inline void Invoke(::System::Threading::Tasks::Task* ignored);

  /// @brief Method get_ShouldNotifyDebuggerOfWaitCompletion addr 0x24d0fa4 size 0x74 virtual true final false
  inline bool get_ShouldNotifyDebuggerOfWaitCompletion();

  /// @brief Method get_InvokeMayRunArbitraryCode addr 0x24d1018 size 0x8 virtual true final true
