...
public:
  ...
  /// @brief Method .ctor, addr 0x5cc74f4, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnobservedTaskExceptionEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnobservedTaskExceptionEventArgs(UnobservedTaskExceptionEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnobservedTaskExceptionEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnobservedTaskExceptionEventArgs(UnobservedTaskExceptionEventArgsconst&) = delete;
