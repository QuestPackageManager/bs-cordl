...
public:
  ...
  /// @brief Method <Run>b__2_0, addr 0x5b16a7c, size 0xf8, virtual false, abstract: false, final false
  inline void _Run_b__2_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x5b16a78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Run, addr 0x5b165dc, size 0x26c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b112d0, size 0x2c, virtual false, abstract: false, final false
