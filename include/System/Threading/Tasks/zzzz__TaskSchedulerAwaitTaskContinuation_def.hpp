...
public:
  ...
  /// @brief Method <Run>b__2_0, addr 0x3e6a558, size 0xf0, virtual false, abstract: false, final false
  inline void _Run_b__2_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x3e6a550, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Run, addr 0x3e6a11c, size 0x23c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3e64d00, size 0x30, virtual false, abstract: false, final false
