...
public:
  ...
  /// @brief Method <Run>b__2_0, addr 0x29b3d60, size 0xf0, virtual false, abstract: false, final false
  inline void _Run_b__2_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x29b3d58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Run, addr 0x29b3904, size 0x244, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x29ae3f4, size 0x30, virtual false, abstract: false, final false
