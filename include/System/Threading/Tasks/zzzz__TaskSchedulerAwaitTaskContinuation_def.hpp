...
public:
  ...
  /// @brief Method <Run>b__2_0, addr 0x28b54b0, size 0xf0, virtual false, abstract: false, final false
  inline void _Run_b__2_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x28b54a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Run, addr 0x28b5054, size 0x244, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x28afb44, size 0x30, virtual false, abstract: false, final false
