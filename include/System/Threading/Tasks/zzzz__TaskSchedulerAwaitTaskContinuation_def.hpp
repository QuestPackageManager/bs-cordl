...
public:
  ...
  /// @brief Method <Run>b__2_0, addr 0x28b14b4, size 0xf0, virtual false, abstract: false, final false
  inline void _Run_b__2_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x28b14ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Run, addr 0x28b1058, size 0x244, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x28abb48, size 0x30, virtual false, abstract: false, final false
