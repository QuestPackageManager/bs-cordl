...
public:
  ...
  /// @brief Method .ctor, addr 0x5cbb274, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5cbb37c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5cbb2f0, size 0x8c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TaskSchedulerException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TaskSchedulerException(TaskSchedulerException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TaskSchedulerException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TaskSchedulerException(TaskSchedulerExceptionconst&) = delete;
