...
public:
  ...
  /// @brief Method CreateTask, addr 0x28b53b4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInvokeActionCallback, addr 0x28b58c0, size 0xa8, virtual false, abstract: false, final false
  static inline ::System::Threading::ContextCallback* GetInvokeActionCallback();

  /// @brief Method InvokeAction, addr 0x28b5854, size 0x6c, virtual false, abstract: false, final false
  static inline void InvokeAction(::System::Object* state);

  /// @brief Method MarkAborted, addr 0x28b5968, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x28b5298, size 0x11c, virtual true, abstract: false, final false
  inline void Run(::System::Threading::Tasks::Task* ignored, bool canInlineContinuationTask);

  /// @brief Method RunCallback, addr 0x28b4be0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method RunOrScheduleAction, addr 0x28b0c6c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x28b572c, size 0x128, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method ThrowAsyncIfNecessary, addr 0x28b55a0, size 0x58, virtual false, abstract: false, final false
  static inline void ThrowAsyncIfNecessary(::System::Exception* exc);

  /// @brief Method UnsafeScheduleAction, addr 0x28afc08, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28b4974, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsValidLocationForInlining, addr 0x28b55f8, size 0x134, virtual false, abstract: false, final false
