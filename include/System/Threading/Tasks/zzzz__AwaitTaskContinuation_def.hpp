...
public:
  ...
  /// @brief Method CreateTask, addr 0x3e77a74, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInvokeActionCallback, addr 0x3e77f6c, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Threading::ContextCallback* GetInvokeActionCallback();

  /// @brief Method InvokeAction, addr 0x3e77f00, size 0x6c, virtual false, abstract: false, final false
  static inline void InvokeAction(::System::Object* state);

  /// @brief Method MarkAborted, addr 0x3e7800c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x3e77960, size 0x114, virtual true, abstract: false, final false
  inline void Run(::System::Threading::Tasks::Task* ignored, bool canInlineContinuationTask);

  /// @brief Method RunCallback, addr 0x3e772c8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method RunOrScheduleAction, addr 0x3e7333c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x3e77ddc, size 0x124, virtual true, abstract: false, final true
  inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem();

  /// @brief Method ThrowAsyncIfNecessary, addr 0x3e77c50, size 0x58, virtual false, abstract: false, final false
  static inline void ThrowAsyncIfNecessary(::System::Exception* exc);

  /// @brief Method UnsafeScheduleAction, addr 0x3e723cc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e770e4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsValidLocationForInlining, addr 0x3e77ca8, size 0x134, virtual false, abstract: false, final false
