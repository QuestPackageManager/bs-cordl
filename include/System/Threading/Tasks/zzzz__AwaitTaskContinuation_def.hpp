...
/// @brief Method CreateTask, addr 0x5b8aa04, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method GetInvokeActionCallback, addr 0x5b8af14, size 0xac, virtual false, abstract: false, final false
static inline ::System::Threading::ContextCallback* GetInvokeActionCallback() ;

/// @brief Method InvokeAction, addr 0x5b8aea4, size 0x70, virtual false, abstract: false, final false
static inline void InvokeAction(::System::Object*  state) ;

/// @brief Method MarkAborted, addr 0x5b8afc0, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x5b8a8b4, size 0x150, virtual true, abstract: false, final false
inline void Run(::System::Threading::Tasks::Task*  ignored, bool  canInlineContinuationTask) ;

/// @brief Method RunCallback, addr 0x5b8a1c8, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method RunOrScheduleAction, addr 0x5b85fd0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x5b8ad70, size 0x134, virtual true, abstract: false, final true
inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method ThrowAsyncIfNecessary, addr 0x5b8abe0, size 0x5c, virtual false, abstract: false, final false
static inline void ThrowAsyncIfNecessary(::System::Exception*  exc) ;

/// @brief Method UnsafeScheduleAction, addr 0x5b853e0, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b89fa8, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_IsValidLocationForInlining, addr 0x5b8ac3c, size 0x134, virtual false, abstract: false, final false
