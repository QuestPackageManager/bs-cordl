...
public:
  ...
  /// @brief Method Complete, addr 0x3e765dc, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e74a68, size 0x114, virtual false, abstract: false, final false
