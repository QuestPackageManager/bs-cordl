...
public:
  ...
  /// @brief Method Complete, addr 0x29cedbc, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29cd220, size 0x114, virtual false, abstract: false, final false
