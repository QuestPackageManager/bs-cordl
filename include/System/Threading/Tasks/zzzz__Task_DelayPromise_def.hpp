...
public:
  ...
  /// @brief Method Complete, addr 0x3e6904c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e674d8, size 0x114, virtual false, abstract: false, final false
