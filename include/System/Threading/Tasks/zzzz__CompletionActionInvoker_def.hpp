...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompletionActionInvoker", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompletionActionInvoker(CompletionActionInvoker&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompletionActionInvoker", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompletionActionInvoker(CompletionActionInvokerconst&) = delete;
