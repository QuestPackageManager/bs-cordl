...
public:
  ...
  /// @brief Method MarkAborted, addr 0x277ff50, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x277fea8, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x277c7ac, size 0x2c, virtual false, abstract: false, final false
