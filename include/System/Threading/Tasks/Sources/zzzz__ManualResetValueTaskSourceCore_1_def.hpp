...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Threading::Tasks::Sources::ManualResetValueTaskSourceCore_1___c);
...
public:
  ...
  inline void _SignalCompletion_b__21_0(::by_ref<::System::Threading::Tasks::Sources::ManualResetValueTaskSourceCore_1<TResult>> s);
