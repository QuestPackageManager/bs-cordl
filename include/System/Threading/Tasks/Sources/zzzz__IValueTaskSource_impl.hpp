...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Sources::ValueTaskSourceStatus (::System::Threading::Tasks::Sources::IValueTaskSource::*)(int16_t)>(&::System::Threading::Tasks::Sources::IValueTaskSource::GetStatus)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Threading::Tasks::Sources::IValueTaskSource::*)(int16_t)>(&::System::Threading::Tasks::Sources::IValueTaskSource::GetResult)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
