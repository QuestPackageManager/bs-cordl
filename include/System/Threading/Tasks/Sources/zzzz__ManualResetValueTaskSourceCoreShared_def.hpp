...
public:
  ...
  /// @brief Method CompletionSentinel, addr 0x5b8ace0, size 0x48, virtual false, abstract: false, final false
  static inline void CompletionSentinel(::System::Object* _);

  /// @brief Method ThrowInvalidOperationException, addr 0x5b8aca8, size 0x38, virtual false, abstract: false, final false
