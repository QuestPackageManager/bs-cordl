...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ManualResetValueTaskSourceCoreShared", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ManualResetValueTaskSourceCoreShared(ManualResetValueTaskSourceCoreShared&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ManualResetValueTaskSourceCoreShared", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ManualResetValueTaskSourceCoreShared(ManualResetValueTaskSourceCoreSharedconst&) = delete;
