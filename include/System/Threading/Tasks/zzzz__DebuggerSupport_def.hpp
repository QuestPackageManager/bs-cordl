...
public:
  ...
  /// @brief Method AddToActiveTasks, addr 0x5aa5aac, size 0x9c, virtual false, abstract: false, final false
  static inline void AddToActiveTasks(::System::Threading::Tasks::Task* task);

  /// @brief Method AddToActiveTasksNonInlined, addr 0x5aa5b48, size 0x15c, virtual false, abstract: false, final false
  static inline void AddToActiveTasksNonInlined(::System::Threading::Tasks::Task* task);

  /// @brief Method RemoveFromActiveTasks, addr 0x5aa5d3c, size 0x9c, virtual false, abstract: false, final false
  static inline void RemoveFromActiveTasks(::System::Threading::Tasks::Task* task);

  /// @brief Method RemoveFromActiveTasksNonInlined, addr 0x5aa5dd8, size 0x15c, virtual false, abstract: false, final false
  static inline void RemoveFromActiveTasksNonInlined(::System::Threading::Tasks::Task* task);

  /// @brief Method TraceOperationCompletion, addr 0x5aa5a9c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceOperationCreation, addr 0x5aa5a98, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceOperationRelation, addr 0x5aa5aa0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceSynchronousWorkCompletion, addr 0x5aa5aa8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceSynchronousWorkStart, addr 0x5aa5aa4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LoggingOn, addr 0x5aa5a90, size 0x8, virtual false, abstract: false, final false
