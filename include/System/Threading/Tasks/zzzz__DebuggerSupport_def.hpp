...
public:
  ...
  /// @brief Method AddToActiveTasks, addr 0x3e601b4, size 0x94, virtual false, abstract: false, final false
  static inline void AddToActiveTasks(::System::Threading::Tasks::Task* task);

  /// @brief Method AddToActiveTasksNonInlined, addr 0x3e60248, size 0x158, virtual false, abstract: false, final false
  static inline void AddToActiveTasksNonInlined(::System::Threading::Tasks::Task* task);

  /// @brief Method RemoveFromActiveTasks, addr 0x3e60430, size 0x94, virtual false, abstract: false, final false
  static inline void RemoveFromActiveTasks(::System::Threading::Tasks::Task* task);

  /// @brief Method RemoveFromActiveTasksNonInlined, addr 0x3e604c4, size 0x158, virtual false, abstract: false, final false
  static inline void RemoveFromActiveTasksNonInlined(::System::Threading::Tasks::Task* task);

  /// @brief Method TraceOperationCompletion, addr 0x3e601a4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceOperationCreation, addr 0x3e601a0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceOperationRelation, addr 0x3e601a8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceSynchronousWorkCompletion, addr 0x3e601b0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceSynchronousWorkStart, addr 0x3e601ac, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LoggingOn, addr 0x3e60198, size 0x8, virtual false, abstract: false, final false
