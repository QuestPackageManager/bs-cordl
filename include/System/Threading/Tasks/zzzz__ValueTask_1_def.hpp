...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Threading::Tasks::ValueTaskSourceAsTask_ValueTask_1___c);
MARK_GEN_REF_T_PTR(::System::Threading::Tasks::ValueTask_1_ValueTaskSourceAsTask);
