...
public:
  ...
  /// @brief Method .ctor addr 0x24b5284 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::Threading::ThreadStateException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x24b52e0 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24b5304 size 0x8 virtual false final false
