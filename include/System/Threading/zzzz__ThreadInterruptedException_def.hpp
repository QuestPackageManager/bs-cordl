...
public:
  ...
  /// @brief Method .ctor, addr 0x3e59ea8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e59f24, size 0x8, virtual false, abstract: false, final false
