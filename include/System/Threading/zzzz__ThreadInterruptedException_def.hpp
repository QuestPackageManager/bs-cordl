...
public:
  ...
  /// @brief Method .ctor, addr 0x28a34a8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x28a3524, size 0x8, virtual false, abstract: false, final false
