...
public:
  ...
  /// @brief Method .ctor, addr 0x3e53500, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e5357c, size 0x8, virtual false, abstract: false, final false
