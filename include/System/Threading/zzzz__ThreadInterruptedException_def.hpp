...
public:
  ...
  /// @brief Method .ctor, addr 0x29a1d58, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x29a1dd4, size 0x8, virtual false, abstract: false, final false
