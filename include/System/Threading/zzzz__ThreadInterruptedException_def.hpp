...
public:
  ...
  /// @brief Method .ctor, addr 0x270ec98, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x270ed14, size 0x8, virtual false, abstract: false, final false
