...
// Write type traits
MARK_REF_T(::System::Threading::IAsyncLocal*);
DEFINE_IL2CPP_CLASS(::System::Threading::IAsyncLocal*, "System.Threading", "IAsyncLocal");
// Dependencies
namespace System::Threading {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IAsyncLocal", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IAsyncLocal(IAsyncLocalconst&) = delete;
