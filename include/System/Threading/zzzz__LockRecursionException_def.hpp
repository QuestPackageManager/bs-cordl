...
public:
  ...
  /// @brief Method .ctor, addr 0x29b2ae0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x29b2ba0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x29b2b38, size 0x68, virtual false, abstract: false, final false
