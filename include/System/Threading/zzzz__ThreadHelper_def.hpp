...
public:
  ...
  /// @brief Method SetExecutionContextHelper, addr 0x5b74bb8, size 0x8, virtual false, abstract: false, final false
  inline void SetExecutionContextHelper(::System::Threading::ExecutionContext* ec);

  /// @brief Method ThreadStart, addr 0x5b74dd4, size 0xf4, virtual false, abstract: false, final false
  inline void ThreadStart();

  /// @brief Method ThreadStart, addr 0x5b74cc8, size 0x10c, virtual false, abstract: false, final false
  inline void ThreadStart(::System::Object* obj);

  /// @brief Method ThreadStart_Context, addr 0x5b74bc0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b74bb0, size 0x8, virtual false, abstract: false, final false
