...
public:
  ...
  /// @brief Method SetExecutionContextHelper, addr 0x5b026c4, size 0x8, virtual false, abstract: false, final false
  inline void SetExecutionContextHelper(::System::Threading::ExecutionContext* ec);

  /// @brief Method ThreadStart, addr 0x5b028e0, size 0xf4, virtual false, abstract: false, final false
  inline void ThreadStart();

  /// @brief Method ThreadStart, addr 0x5b027d4, size 0x10c, virtual false, abstract: false, final false
  inline void ThreadStart(::System::Object* obj);

  /// @brief Method ThreadStart_Context, addr 0x5b026cc, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b026bc, size 0x8, virtual false, abstract: false, final false
