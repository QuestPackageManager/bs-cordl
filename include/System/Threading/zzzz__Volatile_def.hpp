...
public:
  ...
  /// @brief Method Read, addr 0x3e60858, size 0x18, virtual false, abstract: false, final false
  static inline bool Read(::ByRef<bool> location);

  /// @brief Method Read, addr 0x3e60894, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x3e60870, size 0x24, virtual false, abstract: false, final false
  static inline void Write(::ByRef<bool> location, bool value);

  /// @brief Method Write, addr 0x3e608ac, size 0x24, virtual false, abstract: false, final false
