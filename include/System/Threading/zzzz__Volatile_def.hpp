...
public:
  ...
  /// @brief Method Read, addr 0x5b7d230, size 0xc, virtual false, abstract: false, final false
  static inline bool Read(::ByRef<bool> location);

  /// @brief Method Read, addr 0x5b7d248, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5b7d23c, size 0xc, virtual false, abstract: false, final false
  static inline void Write(::ByRef<bool> location, bool value);

  /// @brief Method Write, addr 0x5b7d254, size 0xc, virtual false, abstract: false, final false
