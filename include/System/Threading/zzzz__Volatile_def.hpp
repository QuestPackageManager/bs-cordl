...
public:
  ...
  /// @brief Method Read, addr 0x3e634b0, size 0x18, virtual false, abstract: false, final false
  static inline bool Read(::ByRef<bool> location);

  /// @brief Method Read, addr 0x3e634ec, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x3e634c8, size 0x24, virtual false, abstract: false, final false
  static inline void Write(::ByRef<bool> location, bool value);

  /// @brief Method Write, addr 0x3e63504, size 0x24, virtual false, abstract: false, final false
