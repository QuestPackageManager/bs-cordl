...
public:
  ...
  /// @brief Method Read, addr 0x3e5ee24, size 0x18, virtual false, abstract: false, final false
  static inline bool Read(::ByRef<bool> location);

  /// @brief Method Read, addr 0x3e5ee60, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x3e5ee3c, size 0x24, virtual false, abstract: false, final false
  static inline void Write(::ByRef<bool> location, bool value);

  /// @brief Method Write, addr 0x3e5ee78, size 0x24, virtual false, abstract: false, final false
