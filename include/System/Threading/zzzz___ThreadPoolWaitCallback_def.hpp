...
public:
  // Ctor Parameters [CppParam { name: "", ty: "_ThreadPoolWaitCallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  _ThreadPoolWaitCallback(_ThreadPoolWaitCallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "_ThreadPoolWaitCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  _ThreadPoolWaitCallback(_ThreadPoolWaitCallbackconst&) = delete;
