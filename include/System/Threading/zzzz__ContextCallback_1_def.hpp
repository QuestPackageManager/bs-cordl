...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Threading::ContextCallback_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Threading::ContextCallback_1, "System.Threading", "ContextCallback`1");
...
public:
  ...
  inline void Invoke(::by_ref<TState> state);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ContextCallback_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ContextCallback_1(ContextCallback_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ContextCallback_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ContextCallback_1(ContextCallback_1const&) = delete;
