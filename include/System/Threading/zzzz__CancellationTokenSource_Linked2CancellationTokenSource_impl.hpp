...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::*)(::System::Threading::CancellationToken, ::System::Threading::CancellationToken)>(&::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::_ctor)> {
  constexpr static std::size_t size = 0x128;
  constexpr static std::size_t addrs = 0x5afd248;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::*)(bool)>(&::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::Dispose)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x5afd5d4;
