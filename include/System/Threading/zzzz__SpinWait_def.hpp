...
public:
  ...
  /// @brief Method Reset, addr 0x3e5d140, size 0x8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SpinOnce, addr 0x3e5ce28, size 0x58, virtual false, abstract: false, final false
  inline void SpinOnce();

  /// @brief Method SpinOnce, addr 0x3e5ca74, size 0xf8, virtual false, abstract: false, final false
  inline void SpinOnce(int32_t sleep1Threshold);

  /// @brief Method SpinOnceCore, addr 0x3e5cf94, size 0x1ac, virtual false, abstract: false, final false
  inline void SpinOnceCore(int32_t sleep1Threshold);

  static inline int32_t getStaticF_SpinCountforSpinBeforeWait();

  /// @brief Method get_Count, addr 0x3e5cf14, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_NextSpinWillYield, addr 0x3e5cf1c, size 0x78, virtual false, abstract: false, final false
