...
template<typename T>
class ThreadLocal_1_FinalizationHelper;
}
namespace System::Threading {
template<typename T>
class ThreadLocal_1_IdManager;
}
namespace System::Threading {
template<typename T>
...
/// @brief Field SlotArray, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_SlotArray, put=__cordl_internal_set_SlotArray)) ::ArrayW<::System::Threading::ThreadLocal_1_LinkedSlotVolatile<T>,::Array<::System::Threading::ThreadLocal_1_LinkedSlotVolatile<T>>*>  SlotArray;
...
static inline ::System::Threading::ThreadLocal_1_LinkedSlot<T>* New_ctor(::ArrayW<::System::Threading::ThreadLocal_1_LinkedSlotVolatile<T>,::Array<::System::Threading::ThreadLocal_1_LinkedSlotVolatile<T>>*>  slotArray) ;
...
static inline ::System::Threading::ThreadLocal_1_FinalizationHelper<T>* New_ctor(::ArrayW<::System::Threading::ThreadLocal_1_LinkedSlotVolatile<T>,::Array<::System::Threading::ThreadLocal_1_LinkedSlotVolatile<T>>*>  slotArray, bool  trackAllValues) ;
...
/// @brief Field ts_slotArray, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_ts_slotArray, put=setStaticF_ts_slotArray)) ::ArrayW<::System::Threading::ThreadLocal_1_LinkedSlotVolatile<T>,::Array<::System::Threading::ThreadLocal_1_LinkedSlotVolatile<T>>*>  ts_slotArray;
