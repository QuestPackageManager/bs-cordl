...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ThreadStart", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ThreadStart(ThreadStart&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ThreadStart", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ThreadStart(ThreadStartconst&) = delete;
