...
public:
  ...
  /// @brief Method <.cctor>b__4_0, addr 0x2768780, size 0x84, virtual false, abstract: false, final false
  inline void __cctor_b__4_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x2768778, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cancel, addr 0x276736c, size 0x1c, virtual false, abstract: false, final false
  inline void Cancel();

  /// @brief Method Cancel, addr 0x2767388, size 0x28, virtual false, abstract: false, final false
  inline void Cancel(bool throwOnFirstException);

  /// @brief Method CancelAfter, addr 0x2767460, size 0xa4, virtual false, abstract: false, final false
  inline void CancelAfter(::System::TimeSpan delay);

  /// @brief Method CancelAfter, addr 0x2767504, size 0x1ec, virtual false, abstract: false, final false
  inline void CancelAfter(int32_t millisecondsDelay);

  /// @brief Method CancellationCallbackCoreWork, addr 0x2767ec8, size 0xbc, virtual false, abstract: false, final false
  inline void CancellationCallbackCoreWork(::System::Threading::CancellationCallbackCoreWorkArguments args);

  /// @brief Method CancellationCallbackCoreWork_OnSyncContext, addr 0x2767f84, size 0x78, virtual false, abstract: false, final false
  inline void CancellationCallbackCoreWork_OnSyncContext(::System::Object* obj);

  /// @brief Method CreateLinkedTokenSource, addr 0x27683b0, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::Threading::CancellationTokenSource* CreateLinkedTokenSource(::System::Threading::CancellationToken token);

  /// @brief Method CreateLinkedTokenSource, addr 0x27680f8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x2767808, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2767874, size 0x90, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExecuteCallbackHandlers, addr 0x27679e8, size 0x4d4, virtual false, abstract: false, final false
  inline void ExecuteCallbackHandlers(bool throwOnFirstException);

  /// @brief Method InitializeWithTimer, addr 0x27672b0, size 0xbc, virtual false, abstract: false, final false
  inline void InitializeWithTimer(int32_t millisecondsDelay);

  /// @brief Method InternalRegister, addr 0x27650c0, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyCancellation, addr 0x27673b0, size 0xb0, virtual false, abstract: false, final false
  inline void NotifyCancellation(bool throwOnFirstException);

  /// @brief Method ThrowIfDisposed, addr 0x2767154, size 0x54, virtual false, abstract: false, final false
  inline void ThrowIfDisposed();

  /// @brief Method ThrowObjectDisposedException, addr 0x2767904, size 0x54, virtual false, abstract: false, final false
  static inline void ThrowObjectDisposedException();

  /// @brief Method TimerCallbackLogic, addr 0x27676f0, size 0x118, virtual false, abstract: false, final false
  static inline void TimerCallbackLogic(::System::Object* obj);

  /// @brief Method WaitForCallbackToComplete, addr 0x2766e90, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27671c0, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27671f4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExecutingCallback, addr 0x27671a8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Threading::CancellationCallbackInfo* get_ExecutingCallback();

  /// @brief Method get_IsCancellationCompleted, addr 0x2766e5c, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsCancellationCompleted();

  /// @brief Method get_IsCancellationRequested, addr 0x2764d0c, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsCancellationRequested();

  /// @brief Method get_IsDisposed, addr 0x2767110, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDisposed();

  /// @brief Method get_ThreadIDExecutingCallbacks, addr 0x2766e78, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_ThreadIDExecutingCallbacks();

  /// @brief Method get_Token, addr 0x276713c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ThreadIDExecutingCallbacks, addr 0x2767118, size 0x24, virtual false, abstract: false, final false
