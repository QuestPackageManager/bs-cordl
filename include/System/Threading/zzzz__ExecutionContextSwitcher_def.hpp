...
public:
  // Declarations
  /// @brief Method Undo, addr 0x3e549a8, size 0x88, virtual false, abstract: false, final false
  inline void Undo();

  /// @brief Method UndoNoThrow, addr 0x3e54920, size 0x88, virtual false, abstract: false, final false
