...
public:
  // Declarations
  /// @brief Method Undo, addr 0x276b61c, size 0x88, virtual false, abstract: false, final false
  inline void Undo();

  /// @brief Method UndoNoThrow, addr 0x276b594, size 0x88, virtual false, abstract: false, final false
