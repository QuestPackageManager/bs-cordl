...
public:
  // Declarations
  /// @brief Method Undo, addr 0x29b9b20, size 0x88, virtual false, abstract: false, final false
  inline void Undo();

  /// @brief Method UndoNoThrow, addr 0x29b9a98, size 0x88, virtual false, abstract: false, final false
