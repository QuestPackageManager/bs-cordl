...
public:
  // Declarations
  /// @brief Method Undo, addr 0x3e4faac, size 0x88, virtual false, abstract: false, final false
  inline void Undo();

  /// @brief Method UndoNoThrow, addr 0x3e4fa24, size 0x88, virtual false, abstract: false, final false
