...
public:
// Declarations
/// @brief Method Undo, addr 0x5b00954, size 0x8c, virtual false, abstract: false, final false
inline void Undo() ;

/// @brief Method UndoNoThrow, addr 0x5b008d0, size 0x84, virtual false, abstract: false, final false
