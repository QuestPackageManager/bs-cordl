...
public:
  // Declarations
  /// @brief Method Undo, addr 0x3e531f0, size 0x88, virtual false, abstract: false, final false
  inline void Undo();

  /// @brief Method UndoNoThrow, addr 0x3e53168, size 0x88, virtual false, abstract: false, final false
