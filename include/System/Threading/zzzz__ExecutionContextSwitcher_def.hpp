...
public:
  // Declarations
  /// @brief Method Undo, addr 0x5b7293c, size 0x8c, virtual false, abstract: false, final false
  inline void Undo();

  /// @brief Method UndoNoThrow, addr 0x5b728b8, size 0x84, virtual false, abstract: false, final false
