...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5cb4634, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cb44f0, size 0x144, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WaitCallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WaitCallback(WaitCallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WaitCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WaitCallback(WaitCallbackconst&) = delete;
