...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3e65b88, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e65a88, size 0x100, virtual false, abstract: false, final false
