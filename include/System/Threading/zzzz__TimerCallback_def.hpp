...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3e6c3a0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e6c2a0, size 0x100, virtual false, abstract: false, final false
