...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3de8ea4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3de8da4, size 0x100, virtual false, abstract: false, final false
