...
public:
  // Declarations
  /// @brief Method Add, addr 0x3e5dc44, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Add(::ByRef<int32_t> location1, int32_t value);

  /// @brief Method Add, addr 0x3e5dc48, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Add(::ByRef<int64_t> location1, int64_t value);

  /// @brief Method CompareExchange, addr 0x3e5dc2c, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr CompareExchange(::ByRef<::System::IntPtr> location1, ::System::IntPtr value, ::System::IntPtr comparand);

  /// @brief Method CompareExchange, addr 0x3e5dbbc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareExchange, addr 0x3e5dc30, size 0x4, virtual false, abstract: false, final false
  static inline double_t CompareExchange(::ByRef<double_t> location1, double_t value, double_t comparand);

  /// @brief Method CompareExchange, addr 0x3e5dbe8, size 0x4, virtual false, abstract: false, final false
  static inline float_t CompareExchange(::ByRef<float_t> location1, float_t value, float_t comparand);

  /// @brief Method CompareExchange, addr 0x3e5a4d8, size 0x4, virtual false, abstract: false, final false
  static inline int32_t CompareExchange(::ByRef<int32_t> location1, int32_t value, int32_t comparand);

  /// @brief Method CompareExchange, addr 0x3e5dbb4, size 0x4, virtual false, abstract: false, final false
  static inline int32_t CompareExchange(::ByRef<int32_t> location1, int32_t value, int32_t comparand, ::ByRef<bool> succeeded);

  /// @brief Method CompareExchange, addr 0x3e5dc28, size 0x4, virtual false, abstract: false, final false
  static inline int64_t CompareExchange(::ByRef<int64_t> location1, int64_t value, int64_t comparand);

  /// @brief Method CompareExchange, addr 0x3e5dbb8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Decrement, addr 0x3e5dbec, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Decrement(::ByRef<int32_t> location);

  /// @brief Method Decrement, addr 0x3e5dbf0, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Decrement(::ByRef<int64_t> location);

  /// @brief Method Exchange, addr 0x3e5dc38, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr Exchange(::ByRef<::System::IntPtr> location1, ::System::IntPtr value);

  /// @brief Method Exchange, addr 0x3e5dc00, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Exchange, addr 0x3e5dc3c, size 0x4, virtual false, abstract: false, final false
  static inline double_t Exchange(::ByRef<double_t> location1, double_t value);

  /// @brief Method Exchange, addr 0x3e5dc24, size 0x4, virtual false, abstract: false, final false
  static inline float_t Exchange(::ByRef<float_t> location1, float_t value);

  /// @brief Method Exchange, addr 0x3e5ba88, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Exchange(::ByRef<int32_t> location1, int32_t value);

  /// @brief Method Exchange, addr 0x3e5dc34, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Exchange(::ByRef<int64_t> location1, int64_t value);

  /// @brief Method Exchange, addr 0x3e5dbfc, size 0x4, virtual false, abstract: false, final false
  static inline void Exchange(::ByRef<::System::Object*> location1, ::ByRef<::System::Object*> value, ::ByRef<::System::Object*> result);

  /// @brief Method Increment, addr 0x3e5dbf4, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Increment(::ByRef<int32_t> location);

  /// @brief Method Increment, addr 0x3e5dbf8, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Increment(::ByRef<int64_t> location);

  /// @brief Method MemoryBarrier, addr 0x3e5dc4c, size 0x8, virtual false, abstract: false, final false
  static inline void MemoryBarrier();

  /// @brief Method Read, addr 0x3e5dc40, size 0x4, virtual false, abstract: false, final false
