...
public:
  // Declarations
  /// @brief Method CompareExchange addr 0x24c1d90 size 0x4 virtual false final false
  static inline int32_t CompareExchange(ByRef<int32_t> location1, int32_t value, int32_t comparand);

  /// @brief Method CompareExchange addr 0x24c3ebc size 0x4 virtual false final false
  static inline int32_t CompareExchange(ByRef<int32_t> location1, int32_t value, int32_t comparand, ByRef<bool> succeeded);

  /// @brief Method CompareExchange addr 0x24c3ec0 size 0x4 virtual false final false
  ...
  /// @brief Method CompareExchange addr 0x24c3ec4 size 0x2c virtual false final false
  static inline ::System::Object* CompareExchange(ByRef<::System::Object*> location1, ::System::Object* value, ::System::Object* comparand);

  /// @brief Method CompareExchange addr 0x24c3ef0 size 0x4 virtual false final false
  static inline float_t CompareExchange(ByRef<float_t> location1, float_t value, float_t comparand);

  /// @brief Method Decrement addr 0x24c3ef4 size 0x4 virtual false final false
  static inline int32_t Decrement(ByRef<int32_t> location);

  /// @brief Method Increment addr 0x24c3ef8 size 0x4 virtual false final false
  static inline int32_t Increment(ByRef<int32_t> location);

  /// @brief Method Increment addr 0x24c3efc size 0x4 virtual false final false
  static inline int64_t Increment(ByRef<int64_t> location);

  /// @brief Method Exchange addr 0x24c3f00 size 0x4 virtual false final false
  static inline int32_t Exchange(ByRef<int32_t> location1, int32_t value);

  /// @brief Method Exchange addr 0x24c3f04 size 0x4 virtual false final false
  static inline void Exchange(ByRef<::System::Object*> location1, ByRef<::System::Object*> value, ByRef<::System::Object*> result);

  /// @brief Method Exchange addr 0x24c3f08 size 0x24 virtual false final false
  static inline ::System::Object* Exchange(ByRef<::System::Object*> location1, ::System::Object* value);

  /// @brief Method Exchange addr 0x24c3f2c size 0x4 virtual false final false
  static inline float_t Exchange(ByRef<float_t> location1, float_t value);

  /// @brief Method CompareExchange addr 0x24c3f30 size 0x4 virtual false final false
  static inline int64_t CompareExchange(ByRef<int64_t> location1, int64_t value, int64_t comparand);

  /// @brief Method CompareExchange addr 0x24c3f34 size 0x4 virtual false final false
  static inline void* CompareExchange(ByRef<void*> location1, void* value, void* comparand);

  /// @brief Method CompareExchange addr 0x24c3f38 size 0x4 virtual false final false
  ...
  /// @brief Method Exchange addr 0x24c3f3c size 0x4 virtual false final false
  static inline int64_t Exchange(ByRef<int64_t> location1, int64_t value);

  /// @brief Method Exchange addr 0x24c3f40 size 0x4 virtual false final false
  static inline void* Exchange(ByRef<void*> location1, void* value);

  /// @brief Method Exchange addr 0x24c3f44 size 0x4 virtual false final false
  ...
  /// @brief Method Read addr 0x24c3f48 size 0x4 virtual false final false
  static inline int64_t Read(ByRef<int64_t> location);

  /// @brief Method Add addr 0x24c3f4c size 0x4 virtual false final false
  static inline int32_t Add(ByRef<int32_t> location1, int32_t value);

  /// @brief Method Add addr 0x24c3f50 size 0x4 virtual false final false
  static inline int64_t Add(ByRef<int64_t> location1, int64_t value);

  /// @brief Method MemoryBarrier addr 0x24c3f54 size 0x8 virtual false final false
