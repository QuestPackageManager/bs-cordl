...
public:
  // Declarations
  /// @brief Method Add, addr 0x2772b2c, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Add(ByRef<int32_t> location1, int32_t value);

  /// @brief Method Add, addr 0x2772b30, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Add(ByRef<int64_t> location1, int64_t value);

  /// @brief Method CompareExchange, addr 0x2772aa0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareExchange, addr 0x2772b18, size 0x4, virtual false, abstract: false, final false
  static inline double_t CompareExchange(ByRef<double_t> location1, double_t value, double_t comparand);

  /// @brief Method CompareExchange, addr 0x2772acc, size 0x4, virtual false, abstract: false, final false
  static inline float_t CompareExchange(ByRef<float_t> location1, float_t value, float_t comparand);

  /// @brief Method CompareExchange, addr 0x277096c, size 0x4, virtual false, abstract: false, final false
  static inline int32_t CompareExchange(ByRef<int32_t> location1, int32_t value, int32_t comparand);

  /// @brief Method CompareExchange, addr 0x2772a98, size 0x4, virtual false, abstract: false, final false
  static inline int32_t CompareExchange(ByRef<int32_t> location1, int32_t value, int32_t comparand, ByRef<bool> succeeded);

  /// @brief Method CompareExchange, addr 0x2772b10, size 0x4, virtual false, abstract: false, final false
  static inline int64_t CompareExchange(ByRef<int64_t> location1, int64_t value, int64_t comparand);

  /// @brief Method CompareExchange, addr 0x2772a9c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareExchange, addr 0x2772b14, size 0x4, virtual false, abstract: false, final false
  static inline void* CompareExchange(ByRef<void*> location1, void* value, void* comparand);

  /// @brief Method Decrement, addr 0x2772ad0, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Decrement(ByRef<int32_t> location);

  /// @brief Method Decrement, addr 0x2772ad4, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Decrement(ByRef<int64_t> location);

  /// @brief Method Exchange, addr 0x2772ae8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Exchange, addr 0x2772b24, size 0x4, virtual false, abstract: false, final false
  static inline double_t Exchange(ByRef<double_t> location1, double_t value);

  /// @brief Method Exchange, addr 0x2772b0c, size 0x4, virtual false, abstract: false, final false
  static inline float_t Exchange(ByRef<float_t> location1, float_t value);

  /// @brief Method Exchange, addr 0x2772ae0, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Exchange(ByRef<int32_t> location1, int32_t value);

  /// @brief Method Exchange, addr 0x2772b1c, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Exchange(ByRef<int64_t> location1, int64_t value);

  /// @brief Method Exchange, addr 0x2772ae4, size 0x4, virtual false, abstract: false, final false
  static inline void Exchange(ByRef<::System::Object*> location1, ByRef<::System::Object*> value, ByRef<::System::Object*> result);

  /// @brief Method Exchange, addr 0x2772b20, size 0x4, virtual false, abstract: false, final false
  static inline void* Exchange(ByRef<void*> location1, void* value);

  /// @brief Method Increment, addr 0x2772ad8, size 0x4, virtual false, abstract: false, final false
  static inline int32_t Increment(ByRef<int32_t> location);

  /// @brief Method Increment, addr 0x2772adc, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Increment(ByRef<int64_t> location);

  /// @brief Method MemoryBarrier, addr 0x2772b34, size 0x8, virtual false, abstract: false, final false
  static inline void MemoryBarrier();

  /// @brief Method Read, addr 0x2772b28, size 0x4, virtual false, abstract: false, final false
