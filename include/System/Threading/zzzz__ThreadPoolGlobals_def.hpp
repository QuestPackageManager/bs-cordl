...
// Write type traits
MARK_REF_T(::System::Threading::ThreadPoolGlobals*);
DEFINE_IL2CPP_CLASS(::System::Threading::ThreadPoolGlobals*, "System.Threading", "ThreadPoolGlobals");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ThreadPoolGlobals", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ThreadPoolGlobals(ThreadPoolGlobals&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ThreadPoolGlobals", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ThreadPoolGlobals(ThreadPoolGlobalsconst&) = delete;
...
static_assert(sizeof(::System::Threading::ThreadPoolGlobals) == 0x10, "Size mismatch!");
