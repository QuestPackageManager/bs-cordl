...
namespace System::Threading {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2601)), TypeDefinitionIndex(TypeDefinitionIndex(2603))}
...
public:
  ...
  /// @brief Method .ctor addr 0x24c2d1c size 0x1c virtual false final false
  inline void _ctor();

  /// @brief Method Init addr 0x24c2d38 size 0x6c virtual false final false
  inline void Init();

  /// @brief Method set_Handle addr 0x24c2da4 size 0xec virtual true final false
  inline void set_Handle(void* value);

  /// @brief Method get_SafeWaitHandle addr 0x24c2e90 size 0xb8 virtual false final false
  inline ::Microsoft::Win32::SafeHandles::SafeWaitHandle* get_SafeWaitHandle();

  /// @brief Method set_SafeWaitHandle addr 0x24c2f48 size 0x88 virtual false final false
  inline void set_SafeWaitHandle(::Microsoft::Win32::SafeHandles::SafeWaitHandle* value);

  /// @brief Method SetHandleInternal addr 0x24c2fd0 size 0x34 virtual false final false
  inline void SetHandleInternal(::Microsoft::Win32::SafeHandles::SafeWaitHandle* handle);

  /// @brief Method WaitOne addr 0x24c3004 size 0x84 virtual true final false
  inline bool WaitOne(int32_t millisecondsTimeout, bool exitContext);

  /// @brief Method WaitOne addr 0x24c3108 size 0xcc virtual true final false
  inline bool WaitOne(::System::TimeSpan timeout, bool exitContext);

  /// @brief Method WaitOne addr 0x24c31d4 size 0x14 virtual true final false
  inline bool WaitOne();

  /// @brief Method WaitOne addr 0x24c31e8 size 0x10 virtual true final false
  inline bool WaitOne(int32_t millisecondsTimeout);

  /// @brief Method WaitOne addr 0x24c31f8 size 0x10 virtual true final false
  inline bool WaitOne(::System::TimeSpan timeout);

  /// @brief Method WaitOne addr 0x24c3088 size 0x80 virtual false final false
  inline bool WaitOne(int64_t timeout, bool exitContext);

  /// @brief Method InternalWaitOne addr 0x24c3208 size 0xf4 virtual false final false
  ...
  /// @brief Method WaitAny addr 0x24c3500 size 0x308 virtual false final false
  ...
  /// @brief Method WaitAny addr 0x24c3c2c size 0x10c virtual false final false
  ...
  /// @brief Method ThrowAbandonedMutexException addr 0x24c34c0 size 0x40 virtual false final false
  static inline void ThrowAbandonedMutexException();

  /// @brief Method ThrowAbandonedMutexException addr 0x24c3bd8 size 0x54 virtual false final false
  static inline void ThrowAbandonedMutexException(int32_t location, ::System::Threading::WaitHandle* handle);

  /// @brief Method Close addr 0x24c3d38 size 0x70 virtual true final false
  inline void Close();

  /// @brief Method Dispose addr 0x24c3da8 size 0x48 virtual true final false
  inline void Dispose(bool explicitDisposing);

  /// @brief Method Dispose addr 0x24c3df0 size 0x70 virtual true final true
  inline void Dispose();

  /// @brief Method WaitOneNative addr 0x24c32fc size 0x1c4 virtual false final false
  ...
  /// @brief Method WaitMultiple addr 0x24c3808 size 0x3d0 virtual false final false
  ...
  /// @brief Method Wait_internal addr 0x24c3e60 size 0x8 virtual false final false
