...
public:
  ...
  /// @brief Method Close, addr 0x3e5da30, size 0x70, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x3e5dae8, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x3e5daa0, size 0x48, virtual true, abstract: false, final false
  inline void Dispose(bool explicitDisposing);

  /// @brief Method Init, addr 0x3e5caa4, size 0x6c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InternalWaitOne, addr 0x3e5cf18, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHandleInternal, addr 0x3e5cca8, size 0x34, virtual false, abstract: false, final false
  inline void SetHandleInternal(::Microsoft::Win32::SafeHandles::SafeWaitHandle* handle);

  /// @brief Method ThrowAbandonedMutexException, addr 0x3e5d1c8, size 0x38, virtual false, abstract: false, final false
  static inline void ThrowAbandonedMutexException();

  /// @brief Method ThrowAbandonedMutexException, addr 0x3e5d8b8, size 0x4c, virtual false, abstract: false, final false
  static inline void ThrowAbandonedMutexException(int32_t location, ::System::Threading::WaitHandle* handle);

  /// @brief Method WaitAny, addr 0x3e5d200, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitAny, addr 0x3e5d904, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitMultiple, addr 0x3e5d4e4, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitOne, addr 0x3e5cee4, size 0x14, virtual true, abstract: false, final false
  inline bool WaitOne();

  /// @brief Method WaitOne, addr 0x3e5cef8, size 0x10, virtual true, abstract: false, final false
  inline bool WaitOne(int32_t millisecondsTimeout);

  /// @brief Method WaitOne, addr 0x3e5ccdc, size 0x80, virtual true, abstract: false, final false
  inline bool WaitOne(int32_t millisecondsTimeout, bool exitContext);

  /// @brief Method WaitOne, addr 0x3e5cf08, size 0x10, virtual true, abstract: false, final false
  inline bool WaitOne(::System::TimeSpan timeout);

  /// @brief Method WaitOne, addr 0x3e5cddc, size 0x108, virtual true, abstract: false, final false
  inline bool WaitOne(::System::TimeSpan timeout, bool exitContext);

  /// @brief Method WaitOne, addr 0x3e5cd5c, size 0x80, virtual false, abstract: false, final false
  inline bool WaitOne(int64_t timeout, bool exitContext);

  /// @brief Method WaitOneNative, addr 0x3e5d004, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Wait_internal, addr 0x3e5db58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e5ca88, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::IntPtr getStaticF_InvalidHandle();

  /// @brief Method get_SafeWaitHandle, addr 0x3e5cbf8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Handle, addr 0x3e5cb10, size 0xe8, virtual true, abstract: false, final false
