...
public:
  ...
  /// @brief Method Close, addr 0x5b7a1b0, size 0x74, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x5b7a258, size 0x74, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5b7a224, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool explicitDisposing);

  /// @brief Method Init, addr 0x5b790ec, size 0x70, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InternalWaitOne, addr 0x5b7958c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHandleInternal, addr 0x5b79328, size 0x20, virtual false, abstract: false, final false
  inline void SetHandleInternal(::Microsoft::Win32::SafeHandles::SafeWaitHandle* handle);

  /// @brief Method ThrowAbandonedMutexException, addr 0x5b7985c, size 0x38, virtual false, abstract: false, final false
  static inline void ThrowAbandonedMutexException();

  /// @brief Method ThrowAbandonedMutexException, addr 0x5b7a01c, size 0x4c, virtual false, abstract: false, final false
  static inline void ThrowAbandonedMutexException(int32_t location, ::System::Threading::WaitHandle* handle);

  /// @brief Method WaitAny, addr 0x5b79894, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitAny, addr 0x5b7a068, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitMultiple, addr 0x5b79b70, size 0x4ac, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitOne, addr 0x5b79558, size 0x14, virtual true, abstract: false, final false
  inline bool WaitOne();

  /// @brief Method WaitOne, addr 0x5b7956c, size 0x10, virtual true, abstract: false, final false
  inline bool WaitOne(int32_t millisecondsTimeout);

  /// @brief Method WaitOne, addr 0x5b79348, size 0x78, virtual true, abstract: false, final false
  inline bool WaitOne(int32_t millisecondsTimeout, bool exitContext);

  /// @brief Method WaitOne, addr 0x5b7957c, size 0x10, virtual true, abstract: false, final false
  inline bool WaitOne(::System::TimeSpan timeout);

  /// @brief Method WaitOne, addr 0x5b79438, size 0x120, virtual true, abstract: false, final false
  inline bool WaitOne(::System::TimeSpan timeout, bool exitContext);

  /// @brief Method WaitOne, addr 0x5b793c0, size 0x78, virtual false, abstract: false, final false
  inline bool WaitOne(int64_t timeout, bool exitContext);

  /// @brief Method WaitOneNative, addr 0x5b7967c, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method Wait_internal, addr 0x5b7a2cc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b790e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::IntPtr getStaticF_InvalidHandle();

  /// @brief Method get_SafeWaitHandle, addr 0x5b7926c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Handle, addr 0x5b7915c, size 0x110, virtual true, abstract: false, final false
