...
public:
  ...
  /// @brief Method LocalFindAndPop, addr 0x5b77428, size 0x328, virtual false, abstract: false, final false
  inline bool LocalFindAndPop(::System::Threading::IThreadPoolWorkItem* obj);

  /// @brief Method LocalPop, addr 0x5b77918, size 0x2e4, virtual false, abstract: false, final false
  inline bool LocalPop(::ByRef<::System::Threading::IThreadPoolWorkItem*> obj);

  /// @brief Method LocalPush, addr 0x5b76e24, size 0x4c4, virtual false, abstract: false, final false
  ...
  /// @brief Method TrySteal, addr 0x5b77d5c, size 0x8, virtual false, abstract: false, final false
  inline bool TrySteal(::ByRef<::System::Threading::IThreadPoolWorkItem*> obj, ::ByRef<bool> missedSteal);

  /// @brief Method TrySteal, addr 0x5b78154, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b783f8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CompareExchangeIndexes, addr 0x5b78484, size 0x60, virtual false, abstract: false, final false
  inline bool CompareExchangeIndexes(::ByRef<int32_t> prevUpper, int32_t newUpper, ::ByRef<int32_t> prevLower, int32_t newLower);

  /// @brief Method GetIndexes, addr 0x5b78468, size 0x1c, virtual false, abstract: false, final false
  inline void GetIndexes(::ByRef<int32_t> upper, ::ByRef<int32_t> lower);

  /// @brief Method IsUsedUp, addr 0x5b77d2c, size 0x30, virtual false, abstract: false, final false
  inline bool IsUsedUp();

  static inline ::System::Threading::ThreadPoolWorkQueue_QueueSegment* New_ctor();

  /// @brief Method TryDequeue, addr 0x5b77bfc, size 0x130, virtual false, abstract: false, final false
  inline bool TryDequeue(::ByRef<::System::Threading::IThreadPoolWorkItem*> node);

  /// @brief Method TryEnqueue, addr 0x5b772e8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b76968, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dequeue, addr 0x5b77750, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispatch, addr 0x5b77d64, size 0x338, virtual false, abstract: false, final false
  static inline bool Dispatch();

  /// @brief Method Enqueue, addr 0x5b76cd8, size 0x14c, virtual false, abstract: false, final false
  inline void Enqueue(::System::Threading::IThreadPoolWorkItem* callback, bool forceGlobal);

  /// @brief Method EnsureCurrentThreadHasQueue, addr 0x5b769bc, size 0xf8, virtual false, abstract: false, final false
  inline ::System::Threading::ThreadPoolWorkQueueThreadLocals* EnsureCurrentThreadHasQueue();

  /// @brief Method EnsureThreadRequested, addr 0x5b76bc8, size 0xa0, virtual false, abstract: false, final false
  inline void EnsureThreadRequested();

  /// @brief Method LocalFindAndPop, addr 0x5b77390, size 0x98, virtual false, abstract: false, final false
  inline bool LocalFindAndPop(::System::Threading::IThreadPoolWorkItem* callback);

  /// @brief Method MarkThreadRequestSatisfied, addr 0x5b76c8c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b76904, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
