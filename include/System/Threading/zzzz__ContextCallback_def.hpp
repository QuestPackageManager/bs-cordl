...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3e563b8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e53374, size 0x100, virtual false, abstract: false, final false
