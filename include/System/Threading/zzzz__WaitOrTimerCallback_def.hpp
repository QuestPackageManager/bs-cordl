...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x289f7a0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x289f670, size 0x130, virtual false, abstract: false, final false
