...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x29d40ec, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29d3fbc, size 0x130, virtual false, abstract: false, final false
