...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3de27a4, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3de26a0, size 0x104, virtual false, abstract: false, final false
