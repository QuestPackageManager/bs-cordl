...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x29be6d8, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29be5a8, size 0x130, virtual false, abstract: false, final false
