...
public:
  ...
  /// @brief Method DiscontinuousWait, addr 0x637bd3c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x637c02c, size 0xe4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x637c110, size 0x54, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FinishPhase, addr 0x637ba48, size 0x2f4, virtual false, abstract: false, final false
  inline void FinishPhase(bool observedSense);

  /// @brief Method GetCurrentTotal, addr 0x637b498, size 0x20, virtual false, abstract: false, final false
  inline void GetCurrentTotal(int32_t currentTotal, ::by_ref<int32_t> current, ::by_ref<int32_t> total, ::by_ref<bool> sense);

  /// @brief Method InvokePostPhaseAction, addr 0x637bf94, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentTotal, addr 0x637b4b8, size 0x3c, virtual false, abstract: false, final false
  inline bool SetCurrentTotal(int32_t currentTotal, int32_t current, int32_t total, bool sense);

  /// @brief Method SetResetEvents, addr 0x637bf30, size 0x64, virtual false, abstract: false, final false
  inline void SetResetEvents(bool observedSense);

  /// @brief Method SignalAndWait, addr 0x637b50c, size 0x4cc, virtual false, abstract: false, final false
  inline bool SignalAndWait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method SignalAndWait, addr 0x637b4f4, size 0xc, virtual false, abstract: false, final false
  inline void SignalAndWait();

  /// @brief Method SignalAndWait, addr 0x637b500, size 0xc, virtual false, abstract: false, final false
  inline void SignalAndWait(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ThrowIfDisposed, addr 0x637b9d8, size 0x70, virtual false, abstract: false, final false
  inline void ThrowIfDisposed();

  /// @brief Method WaitCurrentPhase, addr 0x637be78, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x637b318, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t participantCount);

  /// @brief Method .ctor, addr 0x637b320, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentPhaseNumber, addr 0x637b300, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CurrentPhaseNumber, addr 0x637b30c, size 0xc, virtual false, abstract: false, final false
