...
public:
  ...
  /// @brief Method Dispose, addr 0x5b6dce8, size 0x84, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x5b6dfbc, size 0x94, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method Equals, addr 0x5b6de18, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5b6deac, size 0x98, virtual true, abstract: false, final true
  inline bool Equals(::System::Threading::CancellationTokenRegistration other);

  /// @brief Method GetHashCode, addr 0x5b6df44, size 0x78, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Unregister, addr 0x5b6dc58, size 0x90, virtual false, abstract: false, final false
  inline bool Unregister();

  /// @brief Method .ctor, addr 0x5b6dc4c, size 0xc, virtual false, abstract: false, final false
