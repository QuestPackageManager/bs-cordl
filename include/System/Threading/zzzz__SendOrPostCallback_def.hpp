...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3e4d6fc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e4d5fc, size 0x100, virtual false, abstract: false, final false
