...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BarrierPostPhaseException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BarrierPostPhaseException(BarrierPostPhaseException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BarrierPostPhaseException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BarrierPostPhaseException(BarrierPostPhaseExceptionconst&) = delete;
