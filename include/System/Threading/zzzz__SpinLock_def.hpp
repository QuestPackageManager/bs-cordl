...
public:
  ...
  /// @brief Method ContinueTryEnter, addr 0x270a510, size 0x488, virtual false, abstract: false, final false
  inline void ContinueTryEnter(int32_t millisecondsTimeout, ByRef<bool> lockTaken);

  /// @brief Method ContinueTryEnterWithThreadTracking, addr 0x270aa9c, size 0x128, virtual false, abstract: false, final false
  inline void ContinueTryEnterWithThreadTracking(int32_t millisecondsTimeout, uint32_t startTime, ByRef<bool> lockTaken);

  /// @brief Method DecrementWaiters, addr 0x270abc4, size 0x60, virtual false, abstract: false, final false
  inline void DecrementWaiters();

  /// @brief Method Enter, addr 0x270a444, size 0x7c, virtual false, abstract: false, final false
  inline void Enter(ByRef<bool> lockTaken);

  /// @brief Method Exit, addr 0x270ad54, size 0x50, virtual false, abstract: false, final false
  inline void Exit(bool useMemoryBarrier);

  /// @brief Method ExitSlowPath, addr 0x270ada4, size 0xe0, virtual false, abstract: false, final false
  inline void ExitSlowPath(bool useMemoryBarrier);

  /// @brief Method TryEnter, addr 0x270a998, size 0x98, virtual false, abstract: false, final false
  inline void TryEnter(int32_t millisecondsTimeout, ByRef<bool> lockTaken);

  /// @brief Method .ctor, addr 0x270a40c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(bool enableThreadOwnerTracking);

  static inline int32_t getStaticF_MAXIMUM_WAITERS();

  /// @brief Method get_IsHeldByCurrentThread, addr 0x270ae84, size 0xa0, virtual false, abstract: false, final false
  inline bool get_IsHeldByCurrentThread();

  /// @brief Method get_IsThreadOwnerTrackingEnabled, addr 0x270aa80, size 0x1c, virtual false, abstract: false, final false
