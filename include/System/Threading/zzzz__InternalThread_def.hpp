...
public:
  ...
  /// @brief Method Finalize, addr 0x5b7be00, size 0x44, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::System::Threading::InternalThread* New_ctor();

  /// @brief Method Thread_free_internal, addr 0x5b7bdfc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b7be44, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
