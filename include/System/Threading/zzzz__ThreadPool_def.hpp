...
namespace System::Threading {
template<typename TState>
class ThreadPool___c__DisplayClass18_0_1;
}
namespace System::Threading {
class WaitCallback;
}
...
template<typename TState>
using __c__DisplayClass18_0_1 = ::System::Threading::ThreadPool___c__DisplayClass18_0_1<TState>;

/// @brief Method EnsureVMInitialized, addr 0x5b06f0c, size 0x98, virtual false, abstract: false, final false
static inline void EnsureVMInitialized() ;

/// @brief Method InitializeVMTp, addr 0x5b070c4, size 0xc, virtual false, abstract: false, final false
static inline void InitializeVMTp(::ByRef<bool>  enableWorkerTracking) ;

/// @brief Method NotifyWorkItemComplete, addr 0x5b060b4, size 0x4, virtual false, abstract: false, final false
static inline bool NotifyWorkItemComplete() ;

/// @brief Method NotifyWorkItemProgress, addr 0x5b070d0, size 0x10, virtual false, abstract: false, final false
static inline void NotifyWorkItemProgress() ;

/// @brief Method NotifyWorkItemProgressNative, addr 0x5b070e0, size 0x4, virtual false, abstract: false, final false
static inline void NotifyWorkItemProgressNative() ;

/// @brief Method NotifyWorkItemQueued, addr 0x5b053a4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method QueueUserWorkItem, addr 0x5b06ee0, size 0x2c, virtual false, abstract: false, final false
static inline bool QueueUserWorkItem(::System::Threading::WaitCallback*  callBack) ;

/// @brief Method QueueUserWorkItem, addr 0x5b06bac, size 0x28, virtual false, abstract: false, final false
static inline bool QueueUserWorkItem(::System::Threading::WaitCallback*  callBack, ::System::Object*  state) ;

/// @brief Method QueueUserWorkItemHelper, addr 0x5b06dc0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x5b06bfc, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x5b06938, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x5b06c74, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method ReportThreadStatus, addr 0x5b070d0, size 0x10, virtual false, abstract: false, final false
static inline void ReportThreadStatus(bool  isWorking) ;

/// @brief Method RequestWorkerThread, addr 0x5b04ca0, size 0x4, virtual false, abstract: false, final false
static inline bool RequestWorkerThread() ;

/// @brief Method TryPopCustomWorkItem, addr 0x5b07024, size 0xa0, virtual false, abstract: false, final false
static inline bool TryPopCustomWorkItem(::System::Threading::IThreadPoolWorkItem*  workItem) ;

/// @brief Method UnsafeQueueCustomWorkItem, addr 0x5b06fa4, size 0x80, virtual false, abstract: false, final false
...
template<typename TState>
static inline bool UnsafeQueueUserWorkItem(::System::Action_1<TState>*  callBack, TState  state, bool  preferLocal) ;

/// @brief Method UnsafeQueueUserWorkItem, addr 0x5b06bd4, size 0x28, virtual false, abstract: false, final false
static inline bool UnsafeQueueUserWorkItem(::System::Threading::WaitCallback*  callBack, ::System::Object*  state) ;

/// @brief Method get_IsThreadPoolThread, addr 0x5b070e4, size 0x1c, virtual false, abstract: false, final false
