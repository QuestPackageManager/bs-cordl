...
public:
  ...
  /// @brief Method CancellationTokenCallback, addr 0x3e5cd0c, size 0x11c, virtual false, abstract: false, final false
  static inline void CancellationTokenCallback(::System::Object* obj);

  /// @brief Method Dispose, addr 0x3e5cbb0, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x3e5cc1c, size 0xf0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureLockObjectCreated, addr 0x3e5c268, size 0x80, virtual false, abstract: false, final false
  inline void EnsureLockObjectCreated();

  /// @brief Method ExtractStatePortion, addr 0x3e5bda0, size 0x8, virtual false, abstract: false, final false
  static inline int32_t ExtractStatePortion(int32_t state, int32_t mask);

  /// @brief Method ExtractStatePortionAndShiftRight, addr 0x3e5befc, size 0xc, virtual false, abstract: false, final false
  static inline int32_t ExtractStatePortionAndShiftRight(int32_t state, int32_t mask, int32_t rightBitShiftCount);

  /// @brief Method Initialize, addr 0x3e5c0a0, size 0xb0, virtual false, abstract: false, final false
  inline void Initialize(bool initialState, int32_t spinCount);

  /// @brief Method LazyInitializeEvent, addr 0x3e5bbcc, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x3e5c364, size 0x8, virtual false, abstract: false, final false
  inline void Set();

  /// @brief Method Set, addr 0x3e5c36c, size 0x1ac, virtual false, abstract: false, final false
  inline void Set(bool duringCancellation);

  /// @brief Method ThrowIfDisposed, addr 0x3e5bb6c, size 0x60, virtual false, abstract: false, final false
  inline void ThrowIfDisposed();

  /// @brief Method UpdateStateAtomically, addr 0x3e5bdc8, size 0xd8, virtual false, abstract: false, final false
  inline void UpdateStateAtomically(int32_t newBits, int32_t updateBitsMask);

  /// @brief Method Wait, addr 0x3e5c56c, size 0x500, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e5c024, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(bool initialState);

  /// @brief Method .ctor, addr 0x3e5c150, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsSet, addr 0x3e5bd44, size 0x5c, virtual false, abstract: false, final false
  inline bool get_IsSet();

  /// @brief Method get_SpinCount, addr 0x3e5bea0, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_SpinCount();

  /// @brief Method get_WaitHandle, addr 0x3e5bb30, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Threading::WaitHandle* get_WaitHandle();

  /// @brief Method get_Waiters, addr 0x3e5bf3c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsSet, addr 0x3e5bda8, size 0x20, virtual false, abstract: false, final false
  inline void set_IsSet(bool value);

  /// @brief Method set_SpinCount, addr 0x3e5bf08, size 0x34, virtual false, abstract: false, final false
  inline void set_SpinCount(int32_t value);

  /// @brief Method set_Waiters, addr 0x3e5bf98, size 0x8c, virtual false, abstract: false, final false
