...
public:
  ...
  /// @brief Method get_WaitHandle addr 0x24b5df8 size 0x3c virtual false final false
  inline ::System::Threading::WaitHandle* get_WaitHandle();

  /// @brief Method get_IsSet addr 0x24b6000 size 0x5c virtual false final false
  inline bool get_IsSet();

  /// @brief Method set_IsSet addr 0x24b6064 size 0x20 virtual false final false
  inline void set_IsSet(bool value);

  /// @brief Method get_SpinCount addr 0x24b6128 size 0x5c virtual false final false
  inline int32_t get_SpinCount();

  /// @brief Method set_SpinCount addr 0x24b6190 size 0x34 virtual false final false
  inline void set_SpinCount(int32_t value);

  /// @brief Method get_Waiters addr 0x24b61c4 size 0x5c virtual false final false
  inline int32_t get_Waiters();

  /// @brief Method set_Waiters addr 0x24b6220 size 0x94 virtual false final false
  inline void set_Waiters(int32_t value);

  static inline ::System::Threading::ManualResetEventSlim* New_ctor(bool initialState);

  /// @brief Method .ctor addr 0x24b62b4 size 0x7c virtual false final false
  ...
  /// @brief Method .ctor addr 0x24b63e0 size 0x120 virtual false final false
  inline void _ctor(bool initialState, int32_t spinCount);

  /// @brief Method Initialize addr 0x24b6330 size 0xb0 virtual false final false
  inline void Initialize(bool initialState, int32_t spinCount);

  /// @brief Method EnsureLockObjectCreated addr 0x24b6500 size 0x88 virtual false final false
  inline void EnsureLockObjectCreated();

  /// @brief Method LazyInitializeEvent addr 0x24b5e98 size 0x168 virtual false final false
  inline bool LazyInitializeEvent();

  /// @brief Method Set addr 0x24b660c size 0x8 virtual false final false
  inline void Set();

  /// @brief Method Set addr 0x24b6614 size 0x1ac virtual false final false
  inline void Set(bool duringCancellation);

  /// @brief Method Wait addr 0x24b6818 size 0x450 virtual false final false
  inline bool Wait(int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Dispose addr 0x24b6d60 size 0x6c virtual true final true
  inline void Dispose();

  /// @brief Method Dispose addr 0x24b6dcc size 0xf4 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method ThrowIfDisposed addr 0x24b5e34 size 0x64 virtual false final false
  inline void ThrowIfDisposed();

  /// @brief Method CancellationTokenCallback addr 0x24b6ec0 size 0x120 virtual false final false
  static inline void CancellationTokenCallback(::System::Object* obj);

  /// @brief Method UpdateStateAtomically addr 0x24b6084 size 0xa4 virtual false final false
  inline void UpdateStateAtomically(int32_t newBits, int32_t updateBitsMask);

  /// @brief Method ExtractStatePortionAndShiftRight addr 0x24b6184 size 0xc virtual false final false
  static inline int32_t ExtractStatePortionAndShiftRight(int32_t state, int32_t mask, int32_t rightBitShiftCount);

  /// @brief Method ExtractStatePortion addr 0x24b605c size 0x8 virtual false final false
