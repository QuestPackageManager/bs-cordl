...
public:
  ...
  /// @brief Method .ctor, addr 0x5b6b49c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b6b4ec, size 0x8, virtual false, abstract: false, final false
