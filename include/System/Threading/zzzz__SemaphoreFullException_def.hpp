...
public:
  ...
  /// @brief Method .ctor, addr 0x29b2d70, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x29b2dbc, size 0x8, virtual false, abstract: false, final false
