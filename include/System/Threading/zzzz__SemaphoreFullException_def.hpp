...
public:
  ...
  /// @brief Method .ctor, addr 0x3e4efdc, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e4f028, size 0x8, virtual false, abstract: false, final false
