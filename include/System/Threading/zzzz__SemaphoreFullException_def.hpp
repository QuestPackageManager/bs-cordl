...
public:
  ...
  /// @brief Method .ctor, addr 0x5af8fa8, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5af8ff8, size 0x8, virtual false, abstract: false, final false
