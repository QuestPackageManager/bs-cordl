...
public:
  ...
  /// @brief Method .ctor, addr 0x3e51c34, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e51c80, size 0x8, virtual false, abstract: false, final false
