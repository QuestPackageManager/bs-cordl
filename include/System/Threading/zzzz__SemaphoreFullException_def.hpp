...
public:
  ...
  /// @brief Method .ctor, addr 0x260ff20, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method .ctor, addr 0x260ff6c, size 0x8, virtual false, abstract: false, final false
