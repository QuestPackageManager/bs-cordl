...
public:
  ...
  /// @brief Method .ctor, addr 0x3e5ab38, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e5ab84, size 0x8, virtual false, abstract: false, final false
