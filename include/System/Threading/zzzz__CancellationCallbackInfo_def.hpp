...
public:
  ...
  /// @brief Method ExecuteCallback, addr 0x5b6ef10, size 0x104, virtual false, abstract: false, final false
  inline void ExecuteCallback();

  /// @brief Method ExecutionContextCallback, addr 0x5b6f9c4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b6e8f4, size 0xc, virtual false, abstract: false, final false
