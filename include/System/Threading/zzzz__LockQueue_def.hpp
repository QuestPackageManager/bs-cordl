...
public:
  ...
  /// @brief Method Pulse, addr 0x3e57538, size 0xb8, virtual false, abstract: false, final false
  inline void Pulse();

  /// @brief Method Wait, addr 0x3e572d4, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e572ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Threading::ReaderWriterLock* rwlock);

  /// @brief Method get_IsEmpty, addr 0x3e57478, size 0xc0, virtual false, abstract: false, final false
