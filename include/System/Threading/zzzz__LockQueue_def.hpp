...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LockQueue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LockQueue(LockQueue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LockQueue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LockQueue(LockQueueconst&) = delete;
