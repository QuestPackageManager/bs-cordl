...
public:
  ...
  /// @brief Method Dispose, addr 0x3e51724, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e512c4, size 0xfc, virtual false, abstract: false, final false
