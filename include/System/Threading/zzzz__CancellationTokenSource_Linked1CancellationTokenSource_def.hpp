...
public:
  ...
  /// @brief Method Dispose, addr 0x3e53158, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e52cf8, size 0xfc, virtual false, abstract: false, final false
