...
public:
  ...
  /// @brief Method Dispose, addr 0x29b6ae4, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29b66d0, size 0xd8, virtual false, abstract: false, final false
