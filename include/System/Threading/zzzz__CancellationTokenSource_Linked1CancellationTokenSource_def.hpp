...
public:
  ...
  /// @brief Method Dispose, addr 0x5cab194, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5caaa20, size 0xfc, virtual false, abstract: false, final false
