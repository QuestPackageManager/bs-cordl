...
public:
  ...
  /// @brief Method Dispose, addr 0x3defe48, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3def9e8, size 0xfc, virtual false, abstract: false, final false
