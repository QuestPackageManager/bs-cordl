...
public:
  ...
  /// @brief Method Dispose, addr 0x289cba8, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x289c794, size 0xd8, virtual false, abstract: false, final false
