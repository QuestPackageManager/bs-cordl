...
public:
  ...
  /// @brief Method Dispose, addr 0x5cab71c, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Hold, addr 0x5cab6f0, size 0x24, virtual false, abstract: false, final false
