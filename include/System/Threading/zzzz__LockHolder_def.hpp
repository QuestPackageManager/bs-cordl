...
public:
  ...
  /// @brief Method Dispose, addr 0x3e503a8, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Hold, addr 0x3e5037c, size 0x24, virtual false, abstract: false, final false
