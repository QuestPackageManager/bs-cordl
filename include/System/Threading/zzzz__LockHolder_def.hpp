...
/// @brief Method Dispose, addr 0x5afda98, size 0x18, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Hold, addr 0x5afda6c, size 0x24, virtual false, abstract: false, final false
