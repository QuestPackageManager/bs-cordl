...
public:
  // Declarations
  /// @brief Method GetTime, addr 0x5b6d3d4, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetTime();

  /// @brief Method UpdateTimeOut, addr 0x5b6d4d0, size 0x34, virtual false, abstract: false, final false
