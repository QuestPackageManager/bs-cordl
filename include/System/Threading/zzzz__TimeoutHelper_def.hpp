...
public:
  // Declarations
  /// @brief Method GetTime, addr 0x5caaee8, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetTime();

  /// @brief Method UpdateTimeOut, addr 0x5caafe4, size 0x34, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TimeoutHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TimeoutHelper(TimeoutHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TimeoutHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TimeoutHelper(TimeoutHelperconst&) = delete;
