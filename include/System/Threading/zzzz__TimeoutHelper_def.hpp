...
public:
  // Declarations
  /// @brief Method GetTime, addr 0x3e4f464, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t GetTime();

  /// @brief Method UpdateTimeOut, addr 0x3e4f564, size 0x3c, virtual false, abstract: false, final false
