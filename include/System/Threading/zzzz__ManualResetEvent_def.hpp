...
public:
  ...
  /// @brief Method .ctor, addr 0x5ca8db0, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ManualResetEvent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ManualResetEvent(ManualResetEvent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ManualResetEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ManualResetEvent(ManualResetEventconst&) = delete;
