...
public:
  // Declarations
  /// @brief Method Enter addr 0x26141a8 size 0x4 virtual false final false
  static inline void Enter(::System::Object* obj);

  /// @brief Method Enter addr 0x2611510 size 0x20 virtual false final false
  static inline void Enter(::System::Object* obj, ByRef<bool> lockTaken);

  /// @brief Method ThrowLockTakenException addr 0x2618428 size 0x70 virtual false final false
  static inline void ThrowLockTakenException();

  /// @brief Method Exit addr 0x26141ac size 0x4 virtual false final false
  static inline void Exit(::System::Object* obj);

  /// @brief Method Wait addr 0x26184a4 size 0x60 virtual false final false
  static inline bool Wait(::System::Object* obj, int32_t millisecondsTimeout, bool exitContext);

  /// @brief Method Wait addr 0x2611ce0 size 0x8 virtual false final false
  static inline bool Wait(::System::Object* obj, int32_t millisecondsTimeout);

  /// @brief Method Pulse addr 0x2615290 size 0x58 virtual false final false
  static inline void Pulse(::System::Object* obj);

  /// @brief Method PulseAll addr 0x2611748 size 0x58 virtual false final false
  static inline void PulseAll(::System::Object* obj);

  /// @brief Method Monitor_test_synchronised addr 0x2618684 size 0x4 virtual false final false
  static inline bool Monitor_test_synchronised(::System::Object* obj);

  /// @brief Method Monitor_pulse addr 0x2618688 size 0x4 virtual false final false
  static inline void Monitor_pulse(::System::Object* obj);

  /// @brief Method ObjPulse addr 0x26185bc size 0x64 virtual false final false
  static inline void ObjPulse(::System::Object* obj);

  /// @brief Method Monitor_pulse_all addr 0x261868c size 0x4 virtual false final false
  static inline void Monitor_pulse_all(::System::Object* obj);

  /// @brief Method ObjPulseAll addr 0x2618620 size 0x64 virtual false final false
  static inline void ObjPulseAll(::System::Object* obj);

  /// @brief Method Monitor_wait addr 0x2618690 size 0x4 virtual false final false
  static inline bool Monitor_wait(::System::Object* obj, int32_t ms);

  /// @brief Method ObjWait addr 0x2618504 size 0xb8 virtual false final false
  static inline bool ObjWait(bool exitContext, int32_t millisecondsTimeout, ::System::Object* obj);

  /// @brief Method try_enter_with_atomic_var addr 0x2618694 size 0x4 virtual false final false
  static inline void try_enter_with_atomic_var(::System::Object* obj, int32_t millisecondsTimeout, ByRef<bool> lockTaken);

  /// @brief Method ReliableEnterTimeout addr 0x2618698 size 0x9c virtual false final false
  static inline void ReliableEnterTimeout(::System::Object* obj, int32_t timeout, ByRef<bool> lockTaken);

  /// @brief Method ReliableEnter addr 0x2618498 size 0xc virtual false final false
