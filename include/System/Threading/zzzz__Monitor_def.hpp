...
public:
  // Declarations
  /// @brief Method Enter addr 0x24b918c size 0x4 virtual false final false
  static inline void Enter(::System::Object* obj);

  /// @brief Method Enter addr 0x24b6588 size 0x20 virtual false final false
  static inline void Enter(::System::Object* obj, ByRef<bool> lockTaken);

  /// @brief Method ThrowLockTakenException addr 0x24bd40c size 0x70 virtual false final false
  static inline void ThrowLockTakenException();

  /// @brief Method Exit addr 0x24b9190 size 0x4 virtual false final false
  static inline void Exit(::System::Object* obj);

  /// @brief Method Wait addr 0x24bd488 size 0x60 virtual false final false
  static inline bool Wait(::System::Object* obj, int32_t millisecondsTimeout, bool exitContext);

  /// @brief Method Wait addr 0x24b6d58 size 0x8 virtual false final false
  static inline bool Wait(::System::Object* obj, int32_t millisecondsTimeout);

  /// @brief Method Pulse addr 0x24ba274 size 0x58 virtual false final false
  static inline void Pulse(::System::Object* obj);

  /// @brief Method PulseAll addr 0x24b67c0 size 0x58 virtual false final false
  static inline void PulseAll(::System::Object* obj);

  /// @brief Method Monitor_test_synchronised addr 0x24bd668 size 0x4 virtual false final false
  static inline bool Monitor_test_synchronised(::System::Object* obj);

  /// @brief Method Monitor_pulse addr 0x24bd66c size 0x4 virtual false final false
  static inline void Monitor_pulse(::System::Object* obj);

  /// @brief Method ObjPulse addr 0x24bd5a0 size 0x64 virtual false final false
  static inline void ObjPulse(::System::Object* obj);

  /// @brief Method Monitor_pulse_all addr 0x24bd670 size 0x4 virtual false final false
  static inline void Monitor_pulse_all(::System::Object* obj);

  /// @brief Method ObjPulseAll addr 0x24bd604 size 0x64 virtual false final false
  static inline void ObjPulseAll(::System::Object* obj);

  /// @brief Method Monitor_wait addr 0x24bd674 size 0x4 virtual false final false
  static inline bool Monitor_wait(::System::Object* obj, int32_t ms);

  /// @brief Method ObjWait addr 0x24bd4e8 size 0xb8 virtual false final false
  static inline bool ObjWait(bool exitContext, int32_t millisecondsTimeout, ::System::Object* obj);

  /// @brief Method try_enter_with_atomic_var addr 0x24bd678 size 0x4 virtual false final false
  static inline void try_enter_with_atomic_var(::System::Object* obj, int32_t millisecondsTimeout, ByRef<bool> lockTaken);

  /// @brief Method ReliableEnterTimeout addr 0x24bd67c size 0x9c virtual false final false
  static inline void ReliableEnterTimeout(::System::Object* obj, int32_t timeout, ByRef<bool> lockTaken);

  /// @brief Method ReliableEnter addr 0x24bd47c size 0xc virtual false final false
