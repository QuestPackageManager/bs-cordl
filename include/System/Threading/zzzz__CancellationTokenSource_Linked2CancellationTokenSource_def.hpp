...
public:
  ...
  /// @brief Method Dispose, addr 0x5cab1c8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5caab1c, size 0x128, virtual false, abstract: false, final false
