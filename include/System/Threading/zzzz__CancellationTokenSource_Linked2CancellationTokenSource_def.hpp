...
public:
  ...
  /// @brief Method Dispose, addr 0x3e4ff28, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e4fb90, size 0x128, virtual false, abstract: false, final false
