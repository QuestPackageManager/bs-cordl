...
public:
  ...
  /// @brief Method Dispose, addr 0x5b6f5bc, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b6f230, size 0x128, virtual false, abstract: false, final false
