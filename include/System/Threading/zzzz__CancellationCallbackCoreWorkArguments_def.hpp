...
DEFINE_IL2CPP_CLASS(::System::Threading::CancellationCallbackCoreWorkArguments, "System.Threading", "CancellationCallbackCoreWorkArguments");
// Dependencies
namespace System::Threading {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5caa6b4, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::CancellationCallbackCoreWorkArguments) == 0x10, "Size mismatch!");
