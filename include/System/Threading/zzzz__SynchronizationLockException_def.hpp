...
public:
  ...
  /// @brief Method .ctor, addr 0x2634fbc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Threading::SynchronizationLockException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2635018, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263503c, size 0x8, virtual false, abstract: false, final false
