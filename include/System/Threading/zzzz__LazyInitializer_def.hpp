...
/// @brief Method EnsureInitialized, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T EnsureInitialized(::ByRef<T>  target, ::ByRef<bool>  initialized, ::ByRef<::System::Object*>  syncLock, ::System::Func_1<T>*  valueFactory) ;
...
/// @brief Method EnsureInitializedCore, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T EnsureInitializedCore(::ByRef<T>  target, ::ByRef<bool>  initialized, ::ByRef<::System::Object*>  syncLock, ::System::Func_1<T>*  valueFactory) ;
...
/// @brief Method EnsureLockInitialized, addr 0x5af9194, size 0x74, virtual false, abstract: false, final false
