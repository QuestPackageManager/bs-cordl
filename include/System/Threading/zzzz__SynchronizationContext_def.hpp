...
public:
  ...
  /// @brief Method CreateCopy, addr 0x3e56848, size 0x54, virtual true, abstract: false, final false
  inline ::System::Threading::SynchronizationContext* CreateCopy();

  /// @brief Method GetThreadLocalContext, addr 0x3e56674, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Threading::SynchronizationContext* GetThreadLocalContext();

  /// @brief Method IsWaitNotificationRequired, addr 0x3e5649c, size 0xc, virtual false, abstract: false, final false
  inline bool IsWaitNotificationRequired();

  static inline ::System::Threading::SynchronizationContext* New_ctor();

  /// @brief Method OperationCompleted, addr 0x3e5655c, size 0x4, virtual true, abstract: false, final false
  inline void OperationCompleted();

  /// @brief Method OperationStarted, addr 0x3e56558, size 0x4, virtual true, abstract: false, final false
  inline void OperationStarted();

  /// @brief Method Post, addr 0x3e564d0, size 0x88, virtual true, abstract: false, final false
  inline void Post(::System::Threading::SendOrPostCallback* d, ::System::Object* state);

  /// @brief Method Send, addr 0x3e564a8, size 0x28, virtual true, abstract: false, final false
  inline void Send(::System::Threading::SendOrPostCallback* d, ::System::Object* state);

  /// @brief Method SetSynchronizationContext, addr 0x3e5664c, size 0x28, virtual false, abstract: false, final false
  static inline void SetSynchronizationContext(::System::Threading::SynchronizationContext* syncContext);

  /// @brief Method Wait, addr 0x3e56560, size 0x64, virtual true, abstract: false, final false
  inline int32_t Wait(::ArrayW<::System::IntPtr, ::Array<::System::IntPtr>*> waitHandles, bool waitAll, int32_t millisecondsTimeout);

  /// @brief Method WaitHelper, addr 0x3e565c4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e56494, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Current, addr 0x3e4de0c, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Threading::SynchronizationContext* get_Current();

  /// @brief Method get_CurrentExplicit, addr 0x3e5689c, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Threading::SynchronizationContext* get_CurrentExplicit();

  /// @brief Method get_CurrentNoFlow, addr 0x3e566c0, size 0x30, virtual false, abstract: false, final false
