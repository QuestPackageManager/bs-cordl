...
// Ctor Parameters [CppParam { name: "InternalLow", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "InternalHigh", ty: "::System::IntPtr", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "OffsetLow", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "OffsetHigh", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "EventHandle", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }]
