...
public:
  ...
  /// @brief Method DoCallBack, addr 0x5b7bc40, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Unregister, addr 0x5b7bd08, size 0xf4, virtual false, abstract: false, final false
  inline bool Unregister(::System::Threading::WaitHandle* waitObject);

  /// @brief Method Wait, addr 0x5b7b6a4, size 0x59c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b78ae8, size 0xac, virtual false, abstract: false, final false
