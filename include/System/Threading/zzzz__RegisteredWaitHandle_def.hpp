...
public:
  ...
  /// @brief Method DoCallBack, addr 0x28a87b8, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Unregister, addr 0x28a88bc, size 0xf4, virtual false, abstract: false, final false
  inline bool Unregister(::System::Threading::WaitHandle* waitObject);

  /// @brief Method Wait, addr 0x28a828c, size 0x52c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a5938, size 0xb4, virtual false, abstract: false, final false
