...
public:
  ...
  /// @brief Method DoCallBack, addr 0x3e6ae18, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Unregister, addr 0x3e6af1c, size 0xf4, virtual false, abstract: false, final false
  inline bool Unregister(::System::Threading::WaitHandle* waitObject);

  /// @brief Method Wait, addr 0x3e6a8f8, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e68004, size 0xb0, virtual false, abstract: false, final false
