...
public:
  ...
  /// @brief Method DoCallBack, addr 0x3e5d810, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Unregister, addr 0x3e5d914, size 0xf4, virtual false, abstract: false, final false
  inline bool Unregister(::System::Threading::WaitHandle* waitObject);

  /// @brief Method Wait, addr 0x3e5d2f0, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e5a9fc, size 0xb0, virtual false, abstract: false, final false
