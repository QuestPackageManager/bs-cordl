...
public:
  ...
  /// @brief Method DoCallBack, addr 0x3e5d888, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Unregister, addr 0x3e5d98c, size 0xf4, virtual false, abstract: false, final false
  inline bool Unregister(::System::Threading::WaitHandle* waitObject);

  /// @brief Method Wait, addr 0x3e5d368, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e5aa74, size 0xb0, virtual false, abstract: false, final false
