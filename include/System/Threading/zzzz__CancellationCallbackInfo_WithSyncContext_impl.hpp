...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Threading::__CancellationCallbackInfo__WithSyncContext::*)(
  ...
  constexpr static std::size_t addrs = 0x2767998;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Threading::__CancellationCallbackInfo__WithSyncContext*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
constexpr ::System::Threading::SynchronizationContext*& System::Threading::__CancellationCallbackInfo__WithSyncContext::__cordl_internal_get_TargetSyncContext() {
...
System::Threading::__CancellationCallbackInfo__WithSyncContext::__cordl_internal_get_TargetSyncContext() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___TargetSyncContext;
}
constexpr void System::Threading::__CancellationCallbackInfo__WithSyncContext::__cordl_internal_set_TargetSyncContext(::System::Threading::SynchronizationContext* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::System::Threading::__CancellationCallbackInfo__WithSyncContext* System::Threading::__CancellationCallbackInfo__WithSyncContext::New_ctor(
  ...
  return THROW_UNLESS(
      ::il2cpp_utils::NewSpecific<::System::Threading::__CancellationCallbackInfo__WithSyncContext*>(callback, stateForCallback, targetExecutionContext, cancellationTokenSource, targetSyncContext));
}
