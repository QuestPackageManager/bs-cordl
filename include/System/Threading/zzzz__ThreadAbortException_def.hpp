...
public:
  ...
  /// @brief Method .ctor, addr 0x29be360, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x29be3dc, size 0x8, virtual false, abstract: false, final false
