...
public:
  ...
  /// @brief Method .ctor, addr 0x270ec14, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x270ec90, size 0x8, virtual false, abstract: false, final false
