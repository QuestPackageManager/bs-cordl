...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb21c0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5cb223c, size 0x8, virtual false, abstract: false, final false
