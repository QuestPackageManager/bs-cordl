...
public:
  ...
  /// @brief Method .ctor, addr 0x3e583f0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e5846c, size 0x8, virtual false, abstract: false, final false
