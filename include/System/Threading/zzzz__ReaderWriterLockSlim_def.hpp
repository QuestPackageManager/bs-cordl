...
public:
  ...
  // Ctor Parameters [CppParam { name: "m_total", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_start", ty: "int32_t", modifiers: "", def_value: None, comment:
  // None }]
...
public:
  ...
  ReaderWriterLockSlim(ReaderWriterLockSlimconst&) = delete;
