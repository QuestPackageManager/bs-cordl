...
public:
  ...
  /// @brief Method .ctor, addr 0x5cac414, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CancellationCallbackInfo_WithSyncContext", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CancellationCallbackInfo_WithSyncContext(CancellationCallbackInfo_WithSyncContext&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CancellationCallbackInfo_WithSyncContext", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CancellationCallbackInfo_WithSyncContext(CancellationCallbackInfo_WithSyncContextconst&) = delete;
