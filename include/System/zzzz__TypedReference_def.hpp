...
public:
  ...
  /// @brief Method Equals, addr 0x3dccf78, size 0x50, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x3dccee4, size 0x88, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method InternalMakeTypedReference, addr 0x3dccee0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeTypedReference, addr 0x3dccab4, size 0x428, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTypedReference, addr 0x3dccfe8, size 0x4c, virtual false, abstract: false, final false
  static inline void SetTypedReference(::System::TypedReference target, ::System::Object* value);

  /// @brief Method get_IsNull, addr 0x3dccfc8, size 0x20, virtual false, abstract: false, final false
