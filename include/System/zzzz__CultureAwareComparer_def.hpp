...
namespace System {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2474)), TypeDefinitionIndex(TypeDefinitionIndex(3657))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x25e7264, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25e72b8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25e739c, size 0x20c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method Compare, addr 0x25e75a8, size 0x54, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW x, ::StringW y);

  /// @brief Method Equals, addr 0x25e75fc, size 0x50, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x25e764c, size 0x74, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW obj);

  /// @brief Method Equals, addr 0x25e76c0, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x25e7758, size 0x34, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetObjectData, addr 0x25e778c, size 0xec, virtual true, abstract: false, final true
