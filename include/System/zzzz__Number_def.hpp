...
public:
  ...
  /// @brief Method get_digits, addr 0x3df524c, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<char16_t> get_digits();

  /// @brief Method get_sign, addr 0x3df5230, size 0x10, virtual false, abstract: false, final false
  inline bool get_sign();

  /// @brief Method set_sign, addr 0x3df5240, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DecimalToNumber, addr 0x3de99a4, size 0x23c, virtual false, abstract: false, final false
  static inline void DecimalToNumber(::System::Decimal value, ::ByRef<::System::Number_NumberBuffer> number);

  /// @brief Method DigitsToInt, addr 0x3df44b0, size 0x34, virtual false, abstract: false, final false
  static inline uint32_t DigitsToInt(::cordl_internals::Ptr<char16_t> p, int32_t count);

  /// @brief Method DoubleToNumber, addr 0x3debb14, size 0x3e0, virtual false, abstract: false, final false
  static inline void DoubleToNumber(double_t value, int32_t precision, ::ByRef<::System::Number_NumberBuffer> number);

  /// @brief Method FindSection, addr 0x3deff98, size 0x14c, virtual false, abstract: false, final false
  static inline int32_t FindSection(::System::ReadOnlySpan_1<char16_t> format, int32_t section);

  /// @brief Method FormatCurrency, addr 0x3deed34, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatDecimal, addr 0x3de96b0, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatDouble, addr 0x3deb5f8, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatDouble, addr 0x3deb4b8, size 0x140, virtual false, abstract: false, final false
  static inline ::StringW FormatDouble(double_t value, ::StringW format, ::System::Globalization::NumberFormatInfo* info);

  /// @brief Method FormatExponent, addr 0x3df00e4, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatFixed, addr 0x3deef9c, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatGeneral, addr 0x3def978, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatInt32, addr 0x3de2ee8, size 0x29c, virtual false, abstract: false, final false
  static inline ::StringW FormatInt32(int32_t value, ::System::ReadOnlySpan_1<char16_t> format, ::System::IFormatProvider* provider);

  /// @brief Method FormatInt64, addr 0x3de5ccc, size 0x298, virtual false, abstract: false, final false
  static inline ::StringW FormatInt64(int64_t value, ::System::ReadOnlySpan_1<char16_t> format, ::System::IFormatProvider* provider);

  /// @brief Method FormatNumber, addr 0x3def4cc, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatPercent, addr 0x3defd30, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatScientific, addr 0x3def720, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatSingle, addr 0x3dec514, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatSingle, addr 0x3dec3d4, size 0x140, virtual false, abstract: false, final false
  static inline ::StringW FormatSingle(float_t value, ::StringW format, ::System::Globalization::NumberFormatInfo* info);

  /// @brief Method FormatUInt32, addr 0x3de3390, size 0x264, virtual false, abstract: false, final false
  static inline ::StringW FormatUInt32(uint32_t value, ::System::ReadOnlySpan_1<char16_t> format, ::System::IFormatProvider* provider);

  /// @brief Method FormatUInt64, addr 0x3dee2e0, size 0x260, virtual false, abstract: false, final false
  static inline ::StringW FormatUInt64(uint64_t value, ::System::ReadOnlySpan_1<char16_t> format, ::System::IFormatProvider* provider);

  /// @brief Method High32, addr 0x3deec2c, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t High32(uint64_t value);

  /// @brief Method Int32ToHexChars, addr 0x3deea9c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method Int32ToHexStr, addr 0x3decca4, size 0x138, virtual false, abstract: false, final false
  static inline ::StringW Int32ToHexStr(int32_t value, char16_t hexBase, int32_t digits);

  /// @brief Method Int32ToNumber, addr 0x3dee970, size 0x12c, virtual false, abstract: false, final false
  static inline void Int32ToNumber(int32_t value, ::ByRef<::System::Number_NumberBuffer> number);

  /// @brief Method Int64DivMod1E9, addr 0x3deebf4, size 0x38, virtual false, abstract: false, final false
  static inline uint32_t Int64DivMod1E9(::ByRef<uint64_t> value);

  /// @brief Method Int64ToHexStr, addr 0x3ded7f4, size 0x1f0, virtual false, abstract: false, final false
  static inline ::StringW Int64ToHexStr(int64_t value, char16_t hexBase, int32_t digits);

  /// @brief Method Int64ToNumber, addr 0x3ded9e4, size 0x1a8, virtual false, abstract: false, final false
  static inline void Int64ToNumber(int64_t input, ::ByRef<::System::Number_NumberBuffer> number);

  /// @brief Method IsDigit, addr 0x3df315c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsDigit(int32_t ch);

  /// @brief Method IsWhite, addr 0x3df30bc, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsWhite(int32_t ch);

  /// @brief Method Low32, addr 0x3deec34, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t Low32(uint64_t value);

  /// @brief Method MatchChars, addr 0x3df30d8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Mul32x32To64, addr 0x3df44e4, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t Mul32x32To64(uint32_t a, uint32_t b);

  /// @brief Method Mul64Lossy, addr 0x3df44ec, size 0x98, virtual false, abstract: false, final false
  static inline uint64_t Mul64Lossy(uint64_t a, uint64_t b, ::ByRef<int32_t> pexp);

  /// @brief Method NegativeInt32ToDecStr, addr 0x3decaf8, size 0x1ac, virtual false, abstract: false, final false
  static inline ::StringW NegativeInt32ToDecStr(int32_t value, int32_t digits, ::StringW sNegative);

  /// @brief Method NegativeInt64ToDecStr, addr 0x3ded554, size 0x2a0, virtual false, abstract: false, final false
  static inline ::StringW NegativeInt64ToDecStr(int64_t input, int32_t digits, ::StringW sNegative);

  /// @brief Method NumberBufferToDecimal, addr 0x3df373c, size 0x2f8, virtual false, abstract: false, final false
  static inline bool NumberBufferToDecimal(::ByRef<::System::Number_NumberBuffer> number, ::ByRef<::System::Decimal> value);

  /// @brief Method NumberBufferToDouble, addr 0x3df3d84, size 0x8c, virtual false, abstract: false, final false
  static inline bool NumberBufferToDouble(::ByRef<::System::Number_NumberBuffer> number, ::ByRef<double_t> value);

  /// @brief Method NumberToDouble, addr 0x3debef4, size 0x4e0, virtual false, abstract: false, final false
  static inline double_t NumberToDouble(::ByRef<::System::Number_NumberBuffer> number);

  /// @brief Method NumberToInt32, addr 0x3df038c, size 0xbc, virtual false, abstract: false, final false
  static inline bool NumberToInt32(::ByRef<::System::Number_NumberBuffer> number, ::ByRef<int32_t> value);

  /// @brief Method NumberToInt64, addr 0x3df0448, size 0xb8, virtual false, abstract: false, final false
  static inline bool NumberToInt64(::ByRef<::System::Number_NumberBuffer> number, ::ByRef<int64_t> value);

  /// @brief Method NumberToString, addr 0x3de9be0, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberToStringFormat, addr 0x3dea170, size 0x1138, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberToUInt32, addr 0x3df0500, size 0xb0, virtual false, abstract: false, final false
  static inline bool NumberToUInt32(::ByRef<::System::Number_NumberBuffer> number, ::ByRef<uint32_t> value);

  /// @brief Method NumberToUInt64, addr 0x3df05b0, size 0xb0, virtual false, abstract: false, final false
  static inline bool NumberToUInt64(::ByRef<::System::Number_NumberBuffer> number, ::ByRef<uint64_t> value);

  /// @brief Method ParseDecimal, addr 0x3df3634, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDouble, addr 0x3df3a34, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseFormatSpecifier, addr 0x3de9860, size 0x144, virtual false, abstract: false, final false
  static inline char16_t ParseFormatSpecifier(::System::ReadOnlySpan_1<char16_t> format, ::ByRef<int32_t> digits);

  /// @brief Method ParseInt32, addr 0x3de3f54, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseInt64, addr 0x3de659c, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseNumber, addr 0x3df29c0, size 0x6fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseSingle, addr 0x3df3e10, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseUInt32, addr 0x3df1a8c, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseUInt64, addr 0x3df2210, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method RoundNumber, addr 0x3deec38, size 0xfc, virtual false, abstract: false, final false
  static inline void RoundNumber(::ByRef<::System::Number_NumberBuffer> number, int32_t pos);

  /// @brief Method StringToNumber, addr 0x3df1018, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowOverflowOrFormatException, addr 0x3df0c40, size 0x88, virtual false, abstract: false, final false
  static inline void ThrowOverflowOrFormatException(bool overflow, ::StringW overflowResourceKey);

  /// @brief Method TrailingZeros, addr 0x3df329c, size 0x90, virtual false, abstract: false, final false
  static inline bool TrailingZeros(::System::ReadOnlySpan_1<char16_t> value, int32_t index);

  /// @brief Method TryCopyTo, addr 0x3deba40, size 0xd4, virtual false, abstract: false, final false
  static inline bool TryCopyTo(::StringW source, ::System::Span_1<char16_t> destination, ::ByRef<int32_t> charsWritten);

  /// @brief Method TryFormatDecimal, addr 0x3deb2a8, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatDouble, addr 0x3deb8e4, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatInt32, addr 0x3de39a8, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatInt64, addr 0x3de6200, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatSingle, addr 0x3dec80c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatUInt32, addr 0x3de3708, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatUInt64, addr 0x3dee6d4, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryInt32ToHexStr, addr 0x3ded188, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method TryInt64ToHexStr, addr 0x3dee0dc, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method TryNegativeInt32ToDecStr, addr 0x3decfa0, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryNegativeInt64ToDecStr, addr 0x3dede10, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDecimal, addr 0x3df4174, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseDouble, addr 0x3df4278, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseInt32, addr 0x3de4284, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseInt32IntegerStyle, addr 0x3df0660, size 0x5e0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseInt64, addr 0x3de69e4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseInt64IntegerStyle, addr 0x3df1150, size 0x5ec, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseSingle, addr 0x3df437c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseUInt32, addr 0x3df332c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseUInt32HexNumberStyle, addr 0x3df0cc8, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseUInt32IntegerStyle, addr 0x3df1c3c, size 0x5d4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseUInt64, addr 0x3df34b0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseUInt64HexNumberStyle, addr 0x3df173c, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseUInt64IntegerStyle, addr 0x3df23c0, size 0x600, virtual false, abstract: false, final false
  ...
  /// @brief Method TryStringToNumber, addr 0x3df316c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method TryUInt32ToDecStr, addr 0x3decddc, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryUInt64ToDecStr, addr 0x3dedb8c, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method UInt32ToDecChars, addr 0x3deb46c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method UInt32ToDecStr, addr 0x3dec968, size 0x190, virtual false, abstract: false, final false
  static inline ::StringW UInt32ToDecStr(uint32_t value, int32_t digits);

  /// @brief Method UInt32ToNumber, addr 0x3deeadc, size 0x118, virtual false, abstract: false, final false
  static inline void UInt32ToNumber(uint32_t value, ::ByRef<::System::Number_NumberBuffer> number);

  /// @brief Method UInt64ToDecStr, addr 0x3ded2fc, size 0x258, virtual false, abstract: false, final false
  static inline ::StringW UInt64ToDecStr(uint64_t value, int32_t digits);

  /// @brief Method UInt64ToNumber, addr 0x3dee540, size 0x194, virtual false, abstract: false, final false
  static inline void UInt64ToNumber(uint64_t value, ::ByRef<::System::Number_NumberBuffer> number);

  /// @brief Method abs, addr 0x3df4584, size 0xc, virtual false, abstract: false, final false
