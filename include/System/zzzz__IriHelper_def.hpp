...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IriHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IriHelper(IriHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IriHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IriHelper(IriHelperconst&) = delete;
