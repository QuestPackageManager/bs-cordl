...
namespace System::Collections::Generic {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3857)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3857), inst: 730 })}
...
public:
  // Declarations
  /// @brief Method Equals addr 0x2430888 size 0x10 virtual true final false
  inline bool Equals(uint8_t x, uint8_t y);

  /// @brief Method GetHashCode addr 0x2430898 size 0x1c virtual true final false
  inline int32_t GetHashCode(uint8_t b);

  /// @brief Method IndexOf addr 0x24308b4 size 0x194 virtual true final false
  inline int32_t IndexOf(::ArrayW<uint8_t, ::Array<uint8_t>*> array, uint8_t value, int32_t startIndex, int32_t count);

  /// @brief Method LastIndexOf addr 0x2430a48 size 0x58 virtual true final false
  inline int32_t LastIndexOf(::ArrayW<uint8_t, ::Array<uint8_t>*> array, uint8_t value, int32_t startIndex, int32_t count);

  /// @brief Method Equals addr 0x2430aa0 size 0x78 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2430b18 size 0x34 virtual true final false
  inline int32_t GetHashCode();

  static inline ::System::Collections::Generic::ByteEqualityComparer* New_ctor();

  /// @brief Method .ctor addr 0x2430b4c size 0x48 virtual false final false
  inline void _ctor();
