...
public:
// Declarations
/// @brief Method Equals, addr 0x5a43f4c, size 0x7c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x5a43d60, size 0x10, virtual true, abstract: false, final false
inline bool Equals(uint8_t  x, uint8_t  y) ;

/// @brief Method GetHashCode, addr 0x5a43fc8, size 0x38, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHashCode, addr 0x5a43d70, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode(uint8_t  b) ;

/// @brief Method IndexOf, addr 0x5a43d78, size 0x178, virtual true, abstract: false, final false
inline int32_t IndexOf(::ArrayW<uint8_t,::Array<uint8_t>*>  array, uint8_t  value, int32_t  startIndex, int32_t  count) ;

/// @brief Method LastIndexOf, addr 0x5a43ef0, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a44000, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
