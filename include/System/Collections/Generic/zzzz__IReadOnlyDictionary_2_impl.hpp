...
template <typename TKey, typename TValue> inline bool System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>::ContainsKey(TKey key) {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>*>(), 0 })));
  return ::cordl_internals::RunMethodRethrow<bool>(this, ___internal_method, key);
}
template <typename TKey, typename TValue> inline bool System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>::TryGetValue(TKey key, ::by_ref<TValue> value) {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>*>(), 1 })));
...
template <typename TKey, typename TValue> inline TValue System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>::get_Item(TKey key) {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>*>(), 2 })));
...
template <typename TKey, typename TValue> inline ::System::Collections::Generic::IEnumerable_1<TKey>* System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>::get_Keys() {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>*>(), 3 })));
...
template <typename TKey, typename TValue> inline ::System::Collections::Generic::IEnumerable_1<TValue>* System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>::get_Values() {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>*>(), 4 })));
