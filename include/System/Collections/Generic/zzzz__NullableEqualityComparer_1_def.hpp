...
// Dependencies System.Collections.Generic.EqualityComparer`1<T>, System.IEquatable`1<T>, System.Nullable`1<T>
namespace System::Collections::Generic {
// cpp template
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IEquatable_1<T>*> && ::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullableEqualityComparer_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullableEqualityComparer_1(NullableEqualityComparer_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullableEqualityComparer_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullableEqualityComparer_1(NullableEqualityComparer_1const&) = delete;
