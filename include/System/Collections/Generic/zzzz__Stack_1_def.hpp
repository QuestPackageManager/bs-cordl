...
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::Stack_1_Enumerator, "System.Collections.Generic", "Stack`1/Enumerator");
// Dependencies
namespace System::Collections::Generic {
// cpp template
template <typename T>
...
public:
  ...
  // Ctor Parameters [CppParam { name: "_stack", ty: "::System::Collections::Generic::Stack_1<T>*", modifiers: "", def_value: None, comment: None }, CppParam { name: "_version", ty: "int32_t",
  // modifiers: "", def_value: None, comment: None }, CppParam { name: "_index", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "_currentElement", ty: "T", modifiers:
