...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::ObjectEqualityComparer_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::ObjectEqualityComparer_1, "System.Collections.Generic", "ObjectEqualityComparer`1");
...
public:
  ...
  inline int32_t IndexOf(::ArrayW<T> array, T value, int32_t startIndex, int32_t count);

  /// @brief Method LastIndexOf, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline int32_t LastIndexOf(::ArrayW<T> array, T value, int32_t startIndex, int32_t count);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectEqualityComparer_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectEqualityComparer_1(ObjectEqualityComparer_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectEqualityComparer_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectEqualityComparer_1(ObjectEqualityComparer_1const&) = delete;
