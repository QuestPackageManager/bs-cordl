...
public:
  ...
  static inline ::System::Collections::Generic::SortedSet_1_Node<T>* ConstructRootFromSortedArray(::ArrayW<T> arr, int32_t startIndex, int32_t endIndex,
  ...
  inline void InsertionBalance(::System::Collections::Generic::SortedSet_1_Node<T>* current, ::by_ref<::System::Collections::Generic::SortedSet_1_Node<T>*> parent,
  ...
  inline void SymmetricExceptWithSameComparer(::ArrayW<T> other, int32_t count);
