...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SortedSet_1_TreeSubSet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SortedSet_1_TreeSubSet(SortedSet_1_TreeSubSet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SortedSet_1_TreeSubSet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SortedSet_1_TreeSubSet(SortedSet_1_TreeSubSetconst&) = delete;
