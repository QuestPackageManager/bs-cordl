...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::TreeSet_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::TreeSet_1, "System.Collections.Generic", "TreeSet`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TreeSet_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TreeSet_1(TreeSet_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TreeSet_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TreeSet_1(TreeSet_1const&) = delete;
