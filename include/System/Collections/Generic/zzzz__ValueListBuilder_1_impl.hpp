...
template<typename T>
inline ::ByRef<T> System::Collections::Generic::ValueListBuilder_1<T>::get_Item(int32_t  index)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Collections::Generic::ValueListBuilder_1<T>>::get(),
                        "get_Item",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline T System::Collections::Generic::ValueListBuilder_1<T>::Pop()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Collections::Generic::ValueListBuilder_1<T>>::get(),
                        "Pop",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters [CppParam { name: "_span", ty: "::System::Span_1<T>", modifiers: "", def_value: Some("{}") }, CppParam { name: "_arrayFromPool", ty: "::ArrayW<T,::Array<T>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "_pos", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
template<typename T>
constexpr ::System::Collections::Generic::ValueListBuilder_1<T>::ValueListBuilder_1(::System::Span_1<T>  _span, ::ArrayW<T,::Array<T>*>  _arrayFromPool, int32_t  _pos) noexcept  {
this->_span = _span;
