...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectComparer_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectComparer_1(ObjectComparer_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectComparer_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectComparer_1(ObjectComparer_1const&) = delete;
