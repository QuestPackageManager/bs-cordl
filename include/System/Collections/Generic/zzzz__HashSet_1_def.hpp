...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::HashSet_1);
...
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::HashSet_1, "System.Collections.Generic", "HashSet`1");
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::HashSet_1_ElementCount, "System.Collections.Generic", "HashSet`1/ElementCount");
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::HashSet_1_Enumerator, "System.Collections.Generic", "HashSet`1/Enumerator");
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::HashSet_1_Slot, "System.Collections.Generic", "HashSet`1/Slot");
// Dependencies
namespace System::Collections::Generic {
// cpp template
template <typename T>
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__slots, put = __cordl_internal_set__slots)) ::ArrayW<::System::Collections::Generic::HashSet_1_Slot<T>> _slots;
  ...
  inline bool AddOrGetLocation(T value, ::by_ref<int32_t> location);
  ...
  /// @brief Method CopyTo, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void CopyTo(::ArrayW<T> array, int32_t arrayIndex, int32_t count);
  ...
  constexpr ::ArrayW<::System::Collections::Generic::HashSet_1_Slot<T>> const& __cordl_internal_get__slots() const;

  constexpr ::ArrayW<::System::Collections::Generic::HashSet_1_Slot<T>>& __cordl_internal_get__slots();
  ...
  constexpr void __cordl_internal_set__slots(::ArrayW<::System::Collections::Generic::HashSet_1_Slot<T>> value);
...
public:
  ...
  ::ArrayW<::System::Collections::Generic::HashSet_1_Slot<T>> ____slots;
