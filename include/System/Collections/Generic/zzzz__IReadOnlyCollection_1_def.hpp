...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IReadOnlyCollection_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IReadOnlyCollection_1(IReadOnlyCollection_1const&) = delete;
