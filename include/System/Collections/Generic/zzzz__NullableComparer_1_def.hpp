...
template <typename T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3865), inst: 1033 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2448), inst: 2684 }),
// TypeDefinitionIndex(TypeDefinitionIndex(2448)), TypeDefinitionIndex(TypeDefinitionIndex(3865))} Self: TypeDefinitionIndex(TypeDefinitionIndex(3867)) CS Name:
