...
/// @brief Field _entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::ArrayW<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>,::Array<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>>*>  _entries;
...
static inline ::System::Collections::Generic::Dictionary_2<TKey,TValue>* New_ctor(::System::Collections::Generic::IEnumerable_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*  collection) ;

static inline ::System::Collections::Generic::Dictionary_2<TKey,TValue>* New_ctor(::System::Collections::Generic::IEnumerable_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*  collection, ::System::Collections::Generic::IEqualityComparer_1<TKey>*  comparer) ;
...
constexpr ::ArrayW<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>,::Array<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>>*> const& __cordl_internal_get__entries() const;
...
constexpr void __cordl_internal_set__entries(::ArrayW<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>,::Array<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>>*>  value) ;
