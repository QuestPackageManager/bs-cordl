...
public:
  ...
  /// @brief Method System.Collections.IDictionaryEnumerator.get_Entry addr 0x0 size 0xffffffffffffffff virtual true final true
  inline ::System::Collections::DictionaryEntry System_Collections_IDictionaryEnumerator_get_Entry();

  /// @brief Method System.Collections.IDictionaryEnumerator.get_Key addr 0x0 size 0xffffffffffffffff virtual true final true
  inline ::System::Object* System_Collections_IDictionaryEnumerator_get_Key();

  /// @brief Method System.Collections.IDictionaryEnumerator.get_Value addr 0x0 size 0xffffffffffffffff virtual true final true
...
public:
  ...
  /// @brief Method System.Collections.Generic.ICollection<TKey>.get_IsReadOnly addr 0x0 size 0xffffffffffffffff virtual true final true
  inline bool System_Collections_Generic_ICollection_TKey__get_IsReadOnly();

  /// @brief Method System.Collections.Generic.ICollection<TKey>.Add addr 0x0 size 0xffffffffffffffff virtual true final true
  inline void System_Collections_Generic_ICollection_TKey__Add(TKey item);

  /// @brief Method System.Collections.Generic.ICollection<TKey>.Clear addr 0x0 size 0xffffffffffffffff virtual true final true
  inline void System_Collections_Generic_ICollection_TKey__Clear();

  /// @brief Method System.Collections.Generic.ICollection<TKey>.Contains addr 0x0 size 0xffffffffffffffff virtual true final true
  inline bool System_Collections_Generic_ICollection_TKey__Contains(TKey item);

  /// @brief Method System.Collections.Generic.ICollection<TKey>.Remove addr 0x0 size 0xffffffffffffffff virtual true final true
  inline bool System_Collections_Generic_ICollection_TKey__Remove(TKey item);

  /// @brief Method System.Collections.Generic.IEnumerable<TKey>.GetEnumerator addr 0x0 size 0xffffffffffffffff virtual true final true
...
public:
  ...
  /// @brief Method System.Collections.Generic.ICollection<TValue>.get_IsReadOnly addr 0x0 size 0xffffffffffffffff virtual true final true
  inline bool System_Collections_Generic_ICollection_TValue__get_IsReadOnly();

  /// @brief Method System.Collections.Generic.ICollection<TValue>.Add addr 0x0 size 0xffffffffffffffff virtual true final true
  inline void System_Collections_Generic_ICollection_TValue__Add(TValue item);

  /// @brief Method System.Collections.Generic.ICollection<TValue>.Remove addr 0x0 size 0xffffffffffffffff virtual true final true
  inline bool System_Collections_Generic_ICollection_TValue__Remove(TValue item);

  /// @brief Method System.Collections.Generic.ICollection<TValue>.Clear addr 0x0 size 0xffffffffffffffff virtual true final true
  inline void System_Collections_Generic_ICollection_TValue__Clear();

  /// @brief Method System.Collections.Generic.ICollection<TValue>.Contains addr 0x0 size 0xffffffffffffffff virtual true final true
...
public:
  ...
  /// @brief Method System.Collections.Generic.IDictionary<TKey,TValue>.get_Keys addr 0x0 size 0xffffffffffffffff virtual true final true
  inline ::System::Collections::Generic::ICollection_1<TKey>* System_Collections_Generic_IDictionary_TKey_TValue__get_Keys();

  /// @brief Method get_Values addr 0x0 size 0xffffffffffffffff virtual false final false
  inline ::System::Collections::Generic::__Dictionary_2__ValueCollection<TKey, TValue>* get_Values();

  /// @brief Method System.Collections.Generic.IDictionary<TKey,TValue>.get_Values addr 0x0 size 0xffffffffffffffff virtual true final true
  ...
  /// @brief Method TryInsert addr 0x0 size 0xffffffffffffffff virtual false final false
  ...
  /// @brief Method IsCompatibleKey addr 0x0 size 0xffffffffffffffff virtual false final false
