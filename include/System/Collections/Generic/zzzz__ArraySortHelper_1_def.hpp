...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArraySortHelper_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArraySortHelper_1(ArraySortHelper_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArraySortHelper_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArraySortHelper_1(ArraySortHelper_1const&) = delete;
