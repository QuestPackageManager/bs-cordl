...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyValuePair", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyValuePair(KeyValuePair&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyValuePair", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyValuePair(KeyValuePairconst&) = delete;
