...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArraySortHelper_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArraySortHelper_2(ArraySortHelper_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArraySortHelper_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArraySortHelper_2(ArraySortHelper_2const&) = delete;
