...
public:
  // Declarations
  /// @brief Method FloorLog2PlusOne, addr 0x5ab5cb8, size 0x30, virtual false, abstract: false, final false
  static inline int32_t FloorLog2PlusOne(int32_t n);

  /// @brief Method ThrowOrIgnoreBadComparer, addr 0x5ab5ce8, size 0x60, virtual false, abstract: false, final false
