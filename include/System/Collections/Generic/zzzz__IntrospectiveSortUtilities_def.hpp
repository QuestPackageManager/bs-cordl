...
public:
  // Declarations
  /// @brief Method FloorLog2PlusOne, addr 0x292c8f4, size 0x34, virtual false, abstract: false, final false
  static inline int32_t FloorLog2PlusOne(int32_t n);

  /// @brief Method ThrowOrIgnoreBadComparer, addr 0x292c928, size 0x68, virtual false, abstract: false, final false
