...
public:
  // Declarations
  /// @brief Method FloorLog2PlusOne, addr 0x3dc975c, size 0x28, virtual false, abstract: false, final false
  static inline int32_t FloorLog2PlusOne(int32_t n);

  /// @brief Method ThrowOrIgnoreBadComparer, addr 0x3dc9784, size 0x60, virtual false, abstract: false, final false
