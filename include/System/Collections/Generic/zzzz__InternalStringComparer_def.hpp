...
public:
// Declarations
/// @brief Method Equals, addr 0x5a4405c, size 0x30, virtual true, abstract: false, final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x5a4403c, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode(::StringW  obj) ;

/// @brief Method IndexOf, addr 0x5a4408c, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a440f0, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
