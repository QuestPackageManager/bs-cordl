...
public:
  // Declarations
  /// @brief Method Equals, addr 0x5a43b50, size 0x30, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x5a43b30, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW obj);

  /// @brief Method IndexOf, addr 0x5a43b80, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a43be4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
