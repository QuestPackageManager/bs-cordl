...
public:
  // Declarations
  /// @brief Method Equals, addr 0x5ab6044, size 0x30, virtual true, abstract: false, final false
  inline bool Equals(::StringW x, ::StringW y);

  /// @brief Method GetHashCode, addr 0x5ab6024, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW obj);

  /// @brief Method IndexOf, addr 0x5ab6074, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ab60d8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
