...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CollectionDebugView_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CollectionDebugView_1(CollectionDebugView_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CollectionDebugView_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CollectionDebugView_1(CollectionDebugView_1const&) = delete;
