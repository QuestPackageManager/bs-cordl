...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DictionaryValueCollectionDebugView_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DictionaryValueCollectionDebugView_2(DictionaryValueCollectionDebugView_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DictionaryValueCollectionDebugView_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DictionaryValueCollectionDebugView_2(DictionaryValueCollectionDebugView_2const&) = delete;
