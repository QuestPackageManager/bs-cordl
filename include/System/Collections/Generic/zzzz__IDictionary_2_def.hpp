...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::IDictionary_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::IDictionary_2, "System.Collections.Generic", "IDictionary`2");
// [DefaultMember("Item")]
// Dependencies
namespace System::Collections::Generic {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDictionary_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDictionary_2(IDictionary_2const&) = delete;
