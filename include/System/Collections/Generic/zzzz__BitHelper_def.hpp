...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BitHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BitHelper(BitHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BitHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BitHelper(BitHelperconst&) = delete;
