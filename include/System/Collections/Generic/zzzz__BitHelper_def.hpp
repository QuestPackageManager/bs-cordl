...
public:
  ...
  /// @brief Method IsMarked, addr 0x41028c4, size 0x84, virtual false, abstract: false, final false
  inline bool IsMarked(int32_t bitPosition);

  /// @brief Method MarkBit, addr 0x4102848, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToIntArrayLength, addr 0x4102948, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4102818, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int32_t, ::Array<int32_t>*> bitArray, int32_t length);

  /// @brief Method .ctor, addr 0x41027e0, size 0x38, virtual false, abstract: false, final false
