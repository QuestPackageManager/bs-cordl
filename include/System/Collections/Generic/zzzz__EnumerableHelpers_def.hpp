...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnumerableHelpers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnumerableHelpers(EnumerableHelpers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnumerableHelpers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnumerableHelpers(EnumerableHelpersconst&) = delete;
