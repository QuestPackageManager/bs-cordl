...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedList_2);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedList_2_KeyList);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedList_2_SortedListKeyEnumerator);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedList_2_SortedListValueEnumerator);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedList_2_ValueList);
MARK_GEN_VAL_T(::System::Collections::Generic::SortedList_2_Enumerator);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedList_2, "System.Collections.Generic", "SortedList`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedList_2_KeyList, "System.Collections.Generic", "SortedList`2/KeyList");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedList_2_SortedListKeyEnumerator, "System.Collections.Generic", "SortedList`2/SortedListKeyEnumerator");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedList_2_SortedListValueEnumerator, "System.Collections.Generic", "SortedList`2/SortedListValueEnumerator");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedList_2_ValueList, "System.Collections.Generic", "SortedList`2/ValueList");
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::SortedList_2_Enumerator, "System.Collections.Generic", "SortedList`2/Enumerator");
// Dependencies
namespace System::Collections::Generic {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "_sortedList", ty: "::System::Collections::Generic::SortedList_2<TKey,TValue>*", modifiers: "", def_value: None, comment: None }, CppParam { name: "_key", ty:
  // "TKey", modifiers: "", def_value: None, comment: None }, CppParam { name: "_value", ty: "TValue", modifiers: "", def_value: None, comment: None }, CppParam { name: "_index", ty: "int32_t",
  // modifiers: "", def_value: None, comment: None }, CppParam { name: "_version", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "_getEnumeratorRetType", ty:
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SortedList_2_SortedListKeyEnumerator", modifiers: "&&", def_value: None, comment: None }]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SortedList_2_SortedListValueEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SortedList_2_KeyList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SortedList_2_ValueList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_values, put = __cordl_internal_set_values)) ::ArrayW<TValue> values;
  ...
  constexpr ::ArrayW<TValue> const& __cordl_internal_get_values() const;

  constexpr ::ArrayW<TValue>& __cordl_internal_get_values();
  ...
  constexpr void __cordl_internal_set_values(::ArrayW<TValue> value);
