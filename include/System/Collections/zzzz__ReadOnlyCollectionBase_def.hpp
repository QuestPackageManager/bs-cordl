...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x5aa8f3c, size 0x24, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  static inline ::System::Collections::ReadOnlyCollectionBase* New_ctor();

  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x5aa8f00, size 0x3c, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.ICollection.get_IsSynchronized, addr 0x5aa8eb8, size 0x24, virtual true, abstract: false, final true
  inline bool System_Collections_ICollection_get_IsSynchronized();

  /// @brief Method System.Collections.ICollection.get_SyncRoot, addr 0x5aa8edc, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5aa8f60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x5aa8e94, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_InnerList, addr 0x5aa8e30, size 0x64, virtual false, abstract: false, final false
