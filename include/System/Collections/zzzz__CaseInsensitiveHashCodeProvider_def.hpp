...
public:
  ...
  /// @brief Method .ctor addr 0x2422adc size 0x7c virtual false final false
  inline void _ctor();

  static inline ::System::Collections::CaseInsensitiveHashCodeProvider* New_ctor(::System::Globalization::CultureInfo* culture);

  /// @brief Method .ctor addr 0x2422b58 size 0x88 virtual false final false
  inline void _ctor(::System::Globalization::CultureInfo* culture);

  /// @brief Method GetHashCode addr 0x2422be0 size 0xd8 virtual true final true
