...
public:
  ...
  /// @brief Method GetHashCode, addr 0x3dc82a0, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3dc81a0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3dc821c, size 0x84, virtual false, abstract: false, final false
