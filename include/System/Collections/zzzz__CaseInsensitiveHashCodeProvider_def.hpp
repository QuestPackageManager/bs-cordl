...
public:
  ...
  /// @brief Method GetHashCode, addr 0x27fcdb8, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27fccb4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27fcd30, size 0x88, virtual false, abstract: false, final false
