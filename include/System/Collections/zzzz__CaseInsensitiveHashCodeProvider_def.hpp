...
public:
  ...
  /// @brief Method GetHashCode, addr 0x26d2994, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26d2894, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26d290c, size 0x88, virtual false, abstract: false, final false
