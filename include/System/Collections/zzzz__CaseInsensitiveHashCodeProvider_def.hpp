...
public:
  ...
  /// @brief Method GetHashCode, addr 0x5be2c74, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5be2b8c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5be2c00, size 0x74, virtual false, abstract: false, final false
