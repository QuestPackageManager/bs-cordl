...
public:
  ...
  /// @brief Method GetHashCode, addr 0x5aa7424, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5aa733c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5aa73b0, size 0x74, virtual false, abstract: false, final false
