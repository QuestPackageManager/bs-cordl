...
public:
  ...
  /// @brief Method Clone, addr 0x3dcd978, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x3dcd980, size 0x108, virtual true, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Collections::Stack_StackEnumerator* New_ctor(::System::Collections::Stack* stack);

  /// @brief Method Reset, addr 0x3dcdb14, size 0x7c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3dcd71c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Stack* stack);

  /// @brief Method get_Current, addr 0x3dcda88, size 0x8c, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x3dcd35c, size 0x30, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x3dcd38c, size 0x90, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method CopyTo, addr 0x3dcd41c, size 0x2a8, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x3dcd6c4, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x3dcd75c, size 0x84, virtual true, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method Pop, addr 0x3dcd7e0, size 0x94, virtual true, abstract: false, final false
  inline ::System::Object* Pop();

  /// @brief Method Push, addr 0x3dcd874, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dcd1b8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3dcd214, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method get_Count, addr 0x3dcd2dc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x3dcd2e4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x3dcd2ec, size 0x70, virtual true, abstract: false, final false
