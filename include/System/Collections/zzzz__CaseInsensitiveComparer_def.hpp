...
public:
  ...
  /// @brief Method Compare, addr 0x5aa725c, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5aa7174, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5aa71e8, size 0x74, virtual false, abstract: false, final false
