...
public:
  ...
  /// @brief Method Compare, addr 0x3dbaaac, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3dba9ac, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3dbaa28, size 0x84, virtual false, abstract: false, final false
