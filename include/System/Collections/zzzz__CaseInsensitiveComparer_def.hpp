...
public:
  ...
  /// @brief Method Compare, addr 0x3dbab24, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3dbaa24, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3dbaaa0, size 0x84, virtual false, abstract: false, final false
