...
public:
  ...
  /// @brief Method Compare, addr 0x26d27a8, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26d26a8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26d2720, size 0x88, virtual false, abstract: false, final false
