...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CaseInsensitiveComparer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CaseInsensitiveComparer(CaseInsensitiveComparer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CaseInsensitiveComparer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CaseInsensitiveComparer(CaseInsensitiveComparerconst&) = delete;
