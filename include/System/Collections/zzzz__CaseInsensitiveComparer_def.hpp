...
public:
  ...
  /// @brief Method Compare, addr 0x5be2aac, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5be29c4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5be2a38, size 0x74, virtual false, abstract: false, final false
