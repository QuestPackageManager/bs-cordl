...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentQueue_1);
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentQueue_1_Segment);
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentQueue_1__Enumerate_d__28);
MARK_GEN_VAL_T(::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentQueue_1, "System.Collections.Concurrent", "ConcurrentQueue`1");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__slots, put = __cordl_internal_set__slots)) ::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>> _slots;
  ...
  inline bool TryPeek(::by_ref<T> result, bool resultUsed);
  ...
  constexpr ::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>> const& __cordl_internal_get__slots() const;

  constexpr ::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>>& __cordl_internal_get__slots();
  ...
  constexpr void __cordl_internal_set__slots(::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>> value);
...
public:
  ...
  ::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>> ____slots;
...
public:
  ...
  inline void SnapForObservation(::by_ref<::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*> head, ::by_ref<int32_t> headHead,
  ...
  inline bool System_Collections_Concurrent_IProducerConsumerCollection_T__TryTake(::by_ref<T> item);
