...
template<typename T>
class ConcurrentQueue_1_Segment;
}
namespace System::Collections::Concurrent {
template<typename T>
class ConcurrentQueue_1__Enumerate_d__28;
}
namespace System::Collections::Concurrent {
template<typename T>
...
/// @brief Field _slots, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__slots, put=__cordl_internal_set__slots)) ::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>,::Array<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>>*>  _slots;
...
constexpr ::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>,::Array<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>>*> const& __cordl_internal_get__slots() const;

constexpr ::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>,::Array<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>>*>& __cordl_internal_get__slots() ;
...
constexpr void __cordl_internal_set__slots(::ArrayW<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>,::Array<::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>>*>  value) ;
...
inline ::System::Collections::Generic::IEnumerator_1<T>* Enumerate(::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*  head, int32_t  headHead, ::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*  tail, int32_t  tailTail) ;
...
/// @brief Method GetCount, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline int64_t GetCount(::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*  head, int32_t  headHead, ::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*  tail, int32_t  tailTail) ;
...
inline void SnapForObservation(::ByRef<::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*>  head, ::ByRef<int32_t>  headHead, ::ByRef<::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*>  tail, ::ByRef<int32_t>  tailTail) ;
