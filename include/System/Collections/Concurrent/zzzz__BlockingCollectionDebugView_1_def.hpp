...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BlockingCollectionDebugView_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BlockingCollectionDebugView_1(BlockingCollectionDebugView_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BlockingCollectionDebugView_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BlockingCollectionDebugView_1(BlockingCollectionDebugView_1const&) = delete;
