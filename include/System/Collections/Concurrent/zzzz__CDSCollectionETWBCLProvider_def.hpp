...
public:
  ...
  /// @brief Method ConcurrentDictionary_AcquiringAllLocks, addr 0x3dc95b8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dc95b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
