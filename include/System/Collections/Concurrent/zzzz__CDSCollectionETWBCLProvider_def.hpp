...
/// @brief Method ConcurrentBag_TryPeekSteals, addr 0x62b2544, size 0x4, virtual false, abstract: false, final false
inline void ConcurrentBag_TryPeekSteals() ;

/// @brief Method ConcurrentBag_TryTakeSteals, addr 0x62b2540, size 0x4, virtual false, abstract: false, final false
inline void ConcurrentBag_TryTakeSteals() ;

static inline ::System::Collections::Concurrent::CDSCollectionETWBCLProvider* New_ctor() ;

/// @brief Method .ctor, addr 0x62b2538, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
