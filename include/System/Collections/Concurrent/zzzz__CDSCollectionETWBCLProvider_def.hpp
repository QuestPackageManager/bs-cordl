...
public:
  ...
  /// @brief Method ConcurrentDictionary_AcquiringAllLocks, addr 0x3dc91d8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dc91d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
