...
public:
  ...
  /// @brief Method ConcurrentDictionary_AcquiringAllLocks, addr 0x5bf132c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bf1328, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
