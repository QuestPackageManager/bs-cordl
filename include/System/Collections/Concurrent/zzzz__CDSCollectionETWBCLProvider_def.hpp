...
public:
  ...
  /// @brief Method .ctor, addr 0x2941a4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method ConcurrentBag_TryTakeSteals, addr 0x2941a54, size 0x38, virtual false, abstract: false, final false
  inline void ConcurrentBag_TryTakeSteals();

  /// @brief Method ConcurrentBag_TryPeekSteals, addr 0x2941a8c, size 0x38, virtual false, abstract: false, final false
