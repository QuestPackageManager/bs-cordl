...
public:
  ...
  /// [Event(5, Level = (System.Diagnostics.Tracing.EventLevel)5)]
  /// @brief Method ConcurrentBag_TryPeekSteals, addr 0x63f3df8, size 0x4, virtual false, abstract: false, final false
  inline void ConcurrentBag_TryPeekSteals();

  /// [Event(4, Level = (System.Diagnostics.Tracing.EventLevel)5)]
  /// @brief Method ConcurrentBag_TryTakeSteals, addr 0x63f3df4, size 0x4, virtual false, abstract: false, final false
  inline void ConcurrentBag_TryTakeSteals();

  static inline ::System::Collections::Concurrent::CDSCollectionETWBCLProvider* New_ctor();

  /// @brief Method .ctor, addr 0x63f3dec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Collections::Concurrent::CDSCollectionETWBCLProvider) == 0x18, "Size mismatch!");
