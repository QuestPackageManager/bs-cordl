...
public:
  ...
  /// @brief Method ConcurrentDictionary_AcquiringAllLocks, addr 0x292c748, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x292c744, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
