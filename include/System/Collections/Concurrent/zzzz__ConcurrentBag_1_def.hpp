...
template<typename T>
class ConcurrentBag_1_Enumerator;
}
namespace System::Collections::Concurrent {
template<typename T>
class ConcurrentBag_1_WorkStealingQueue;
}
namespace System::Collections::Concurrent {
template<typename T>
...
MARK_GEN_REF_PTR_T(::System::Collections::Concurrent::ConcurrentBag_1_Enumerator);
MARK_GEN_REF_PTR_T(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue);
...
static inline ::System::Collections::Concurrent::ConcurrentBag_1_Enumerator<T>* New_ctor(::ArrayW<T,::Array<T>*>  array) ;
...
/// @brief Field _locals, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__locals, put=__cordl_internal_set__locals)) ::System::Threading::ThreadLocal_1<::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*>*  _locals;

/// @brief Field _workStealingQueues, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__workStealingQueues, put=__cordl_internal_set__workStealingQueues)) ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*  _workStealingQueues;
...
inline bool TryStealFromTo(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*  startInclusive, ::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>*  endExclusive, ::ByRef<T>  result, bool  take) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::System::Collections::Concurrent::ConcurrentBag_1_Enumerator, "System.Collections.Concurrent", "ConcurrentBag`1/Enumerator");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue, "System.Collections.Concurrent", "ConcurrentBag`1/WorkStealingQueue");
