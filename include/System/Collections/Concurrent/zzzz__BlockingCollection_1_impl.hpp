...
template<typename T>
constexpr ::System::Threading::SemaphoreSlim* const& System::Collections::Concurrent::BlockingCollection_1<T>::__cordl_internal_get__freeNodes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____freeNodes;
}
template<typename T>
...
template<typename T>
constexpr ::System::Threading::SemaphoreSlim* const& System::Collections::Concurrent::BlockingCollection_1<T>::__cordl_internal_get__occupiedNodes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____occupiedNodes;
}
template<typename T>
