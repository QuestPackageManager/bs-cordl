...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::IDictionaryDebugView_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::IDictionaryDebugView_2, "System.Collections.Concurrent", "IDictionaryDebugView`2");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IDictionaryDebugView_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IDictionaryDebugView_2(IDictionaryDebugView_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IDictionaryDebugView_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDictionaryDebugView_2(IDictionaryDebugView_2const&) = delete;
