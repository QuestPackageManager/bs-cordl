...
/// @brief Field _consumersCancellationTokenSource, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__consumersCancellationTokenSource, put=__cordl_internal_set__consumersCancellationTokenSource)) ::System::Threading::CancellationTokenSource*  _consumersCancellationTokenSource;
...
/// @brief Field _producersCancellationTokenSource, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__producersCancellationTokenSource, put=__cordl_internal_set__producersCancellationTokenSource)) ::System::Threading::CancellationTokenSource*  _producersCancellationTokenSource;
...
inline bool TryTakeWithNoTimeValidation(::ByRef<T>  item, int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::CancellationTokenSource*  combinedTokenSource) ;
