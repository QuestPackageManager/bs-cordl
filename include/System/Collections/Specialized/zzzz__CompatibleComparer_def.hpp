...
public:
  ...
  /// @brief Method Equals, addr 0x4486ed8, size 0x200, virtual true, abstract: false, final true
  inline bool Equals(::System::Object* a, ::System::Object* b);

  /// @brief Method GetHashCode, addr 0x44870d8, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x44866d4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Comparer, addr 0x44871e0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IComparer* get_Comparer();

  /// @brief Method get_DefaultComparer, addr 0x4485ebc, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Collections::IComparer* get_DefaultComparer();

  /// @brief Method get_DefaultHashCodeProvider, addr 0x4485de4, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::Collections::IHashCodeProvider* get_DefaultHashCodeProvider();

  /// @brief Method get_HashCodeProvider, addr 0x44871e8, size 0x8, virtual false, abstract: false, final false
