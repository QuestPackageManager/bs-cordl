...
public:
  ...
  /// @brief Method .ctor, addr 0x293fd60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Add, addr 0x293fd64, size 0x74, virtual true, abstract: false, final false
