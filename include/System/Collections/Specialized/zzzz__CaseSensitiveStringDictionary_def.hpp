...
namespace System::Collections::Specialized {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(7528))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x29443c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Add, addr 0x29443cc, size 0x74, virtual true, abstract: false, final false
