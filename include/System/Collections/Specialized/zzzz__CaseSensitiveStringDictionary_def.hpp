...
public:
  // Declarations
  /// @brief Method Add, addr 0x2f93514, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f93510, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
