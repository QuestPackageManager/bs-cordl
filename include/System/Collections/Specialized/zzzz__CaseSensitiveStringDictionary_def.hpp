...
public:
  // Declarations
  /// @brief Method Add, addr 0x4489aa4, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4489aa0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
