...
public:
  ...
  /// @brief Method get_Item, addr 0x293b4d4, size 0x18, virtual false, abstract: false, final false
  inline bool get_Item(int32_t bit);

  /// @brief Method set_Item, addr 0x293b4ec, size 0x1c, virtual false, abstract: false, final false
  inline void set_Item(int32_t bit, bool value);

  /// @brief Method CreateMask, addr 0x293b508, size 0x8, virtual false, abstract: false, final false
  static inline int32_t CreateMask();

  /// @brief Method CreateMask, addr 0x293b510, size 0x70, virtual false, abstract: false, final false
  static inline int32_t CreateMask(int32_t previous);

  /// @brief Method Equals, addr 0x293b580, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x293b5f8, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x293b65c, size 0xd0, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::Collections::Specialized::BitVector32 value);

  /// @brief Method ToString, addr 0x293b72c, size 0x8, virtual true, abstract: false, final false
