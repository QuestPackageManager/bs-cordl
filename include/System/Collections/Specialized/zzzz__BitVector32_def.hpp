...
public:
  ...
  /// @brief Method get_Item addr 0x27bd4ac size 0x18 virtual false final false
  inline bool get_Item(int32_t bit);

  /// @brief Method set_Item addr 0x27bd4c4 size 0x1c virtual false final false
  inline void set_Item(int32_t bit, bool value);

  /// @brief Method CreateMask addr 0x27bd4e0 size 0x8 virtual false final false
  static inline int32_t CreateMask();

  /// @brief Method CreateMask addr 0x27bd4e8 size 0x70 virtual false final false
  static inline int32_t CreateMask(int32_t previous);

  /// @brief Method Equals addr 0x27bd558 size 0x78 virtual true final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode addr 0x27bd5d0 size 0x64 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method ToString addr 0x27bd634 size 0xd0 virtual false final false
  static inline ::StringW ToString(::System::Collections::Specialized::BitVector32 value);

  /// @brief Method ToString addr 0x27bd704 size 0x8 virtual true final false
