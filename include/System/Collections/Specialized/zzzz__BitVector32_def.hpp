...
public:
  ...
  /// @brief Method get_Item, addr 0x293fb3c, size 0x18, virtual false, abstract: false, final false
  inline bool get_Item(int32_t bit);

  /// @brief Method set_Item, addr 0x293fb54, size 0x1c, virtual false, abstract: false, final false
  inline void set_Item(int32_t bit, bool value);

  /// @brief Method CreateMask, addr 0x293fb70, size 0x8, virtual false, abstract: false, final false
  static inline int32_t CreateMask();

  /// @brief Method CreateMask, addr 0x293fb78, size 0x70, virtual false, abstract: false, final false
  static inline int32_t CreateMask(int32_t previous);

  /// @brief Method Equals, addr 0x293fbe8, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x293fc60, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x293fcc4, size 0xd0, virtual false, abstract: false, final false
  static inline ::StringW ToString(::System::Collections::Specialized::BitVector32 value);

  /// @brief Method ToString, addr 0x293fd94, size 0x8, virtual true, abstract: false, final false
