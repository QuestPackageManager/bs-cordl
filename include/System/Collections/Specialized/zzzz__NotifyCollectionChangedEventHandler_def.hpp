...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x623bfb0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x623be68, size 0x148, virtual false, abstract: false, final false
