...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x63f1aa8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63f1960, size 0x148, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotifyCollectionChangedEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotifyCollectionChangedEventHandler(NotifyCollectionChangedEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotifyCollectionChangedEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotifyCollectionChangedEventHandler(NotifyCollectionChangedEventHandlerconst&) = delete;
