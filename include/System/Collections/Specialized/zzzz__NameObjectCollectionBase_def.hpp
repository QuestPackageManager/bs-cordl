...
public:
  ...
  /// @brief Method .ctor, addr 0x4488004, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x448851c, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x44885f4, size 0x88, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x4488088, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Specialized::NameObjectCollectionBase* coll);

  /// @brief Method get_Current, addr 0x448867c, size 0xa0, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method BaseAdd, addr 0x44832b8, size 0x158, virtual false, abstract: false, final false
  inline void BaseAdd(::StringW name, ::System::Object* value);

  /// @brief Method BaseGet, addr 0x4483968, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Object* BaseGet(int32_t index);

  /// @brief Method BaseGet, addr 0x44832a0, size 0x18, virtual false, abstract: false, final false
  inline ::System::Object* BaseGet(::StringW name);

  /// @brief Method BaseGetKey, addr 0x4483a8c, size 0x9c, virtual false, abstract: false, final false
  inline ::StringW BaseGetKey(int32_t index);

  /// @brief Method BaseRemove, addr 0x44836c0, size 0x204, virtual false, abstract: false, final false
  inline void BaseRemove(::StringW name);

  /// @brief Method BaseSet, addr 0x4483610, size 0xa8, virtual false, abstract: false, final false
  inline void BaseSet(::StringW name, ::System::Object* value);

  /// @brief Method FindEntry, addr 0x4487f44, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Collections::Specialized::NameObjectCollectionBase_NameObjectEntry* FindEntry(::StringW key);

  /// @brief Method GetEnumerator, addr 0x4488030, size 0x58, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetObjectData, addr 0x44870a0, size 0x588, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDeserialization, addr 0x44877d4, size 0x744, virtual true, abstract: false, final false
  inline void OnDeserialization(::System::Object* sender);

  /// @brief Method Reset, addr 0x4486f3c, size 0xac, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Reset, addr 0x4486fe8, size 0xb8, virtual false, abstract: false, final false
  inline void Reset(int32_t capacity);

  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x44880ec, size 0x30c, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.ICollection.get_IsSynchronized, addr 0x448846c, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_ICollection_get_IsSynchronized();

  /// @brief Method System.Collections.ICollection.get_SyncRoot, addr 0x44883f8, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4482c38, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4482cfc, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method .ctor, addr 0x4482e20, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, ::System::Collections::IEqualityComparer* equalityComparer);

  /// @brief Method .ctor, addr 0x4483b80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::DBNull* dummy);

  /// @brief Method .ctor, addr 0x4486ebc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEqualityComparer* equalityComparer);

  /// @brief Method .ctor, addr 0x4482eb8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  static inline ::System::StringComparer* getStaticF_defaultComparer();

  /// @brief Method get_Count, addr 0x44880c8, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x4487ffc, size 0x8, virtual false, abstract: false, final false
