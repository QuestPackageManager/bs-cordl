...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StringCollection", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StringCollection(StringCollection&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StringCollection", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StringCollection(StringCollectionconst&) = delete;
