...
/// @brief Method Add, addr 0x62af7e8, size 0x94, virtual true, abstract: false, final false
inline void Add(::StringW  key, ::StringW  value) ;

/// @brief Method GetEnumerator, addr 0x62af87c, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62af788, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
