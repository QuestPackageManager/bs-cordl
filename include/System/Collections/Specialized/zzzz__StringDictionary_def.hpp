...
public:
  ...
  /// @brief Method Add, addr 0x2f71c84, size 0x98, virtual true, abstract: false, final false
  inline void Add(::StringW key, ::StringW value);

  /// @brief Method GetEnumerator, addr 0x2f71d1c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f71c1c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
