...
/// @brief Method ExpandPrime, addr 0x5a33c4c, size 0x88, virtual false, abstract: false, final false
static inline int32_t ExpandPrime(int32_t  oldSize) ;

/// @brief Method GetPrime, addr 0x5a33ac4, size 0x188, virtual false, abstract: false, final false
static inline int32_t GetPrime(int32_t  min) ;

/// @brief Method IsPrime, addr 0x5a33a1c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method get_SerializationInfoTable, addr 0x5a33cd4, size 0xe8, virtual false, abstract: false, final false
