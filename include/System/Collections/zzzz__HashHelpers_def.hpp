...
public:
  ...
  /// @brief Method ExpandPrime, addr 0x26d1054, size 0x84, virtual false, abstract: false, final false
  static inline int32_t ExpandPrime(int32_t oldSize);

  /// @brief Method GetPrime, addr 0x26d0ec4, size 0x190, virtual false, abstract: false, final false
  static inline int32_t GetPrime(int32_t min);

  /// @brief Method IsPrime, addr 0x26d0e14, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SerializationInfoTable, addr 0x26d10d8, size 0xe0, virtual false, abstract: false, final false
