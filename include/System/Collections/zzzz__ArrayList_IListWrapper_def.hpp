...
public:
  ...
  /// @brief Method .ctor addr 0x2428bac size 0x28 virtual false final false
  inline void _ctor(::System::Collections::IList* list);

  /// @brief Method set_Capacity addr 0x2429d4c size 0x94 virtual true final false
  inline void set_Capacity(int32_t value);

  /// @brief Method get_Count addr 0x2429de0 size 0xa4 virtual true final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly addr 0x2429e84 size 0xa4 virtual true final false
  inline bool get_IsReadOnly();

  /// @brief Method get_IsFixedSize addr 0x2429f28 size 0xa4 virtual true final false
  inline bool get_IsFixedSize();

  /// @brief Method get_IsSynchronized addr 0x2429fcc size 0xa4 virtual true final false
  inline bool get_IsSynchronized();

  /// @brief Method get_Item addr 0x242a070 size 0xa8 virtual true final false
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Method set_Item addr 0x242a118 size 0xcc virtual true final false
  inline void set_Item(int32_t index, ::System::Object* value);

  /// @brief Method get_SyncRoot addr 0x242a1e4 size 0xa4 virtual true final false
  inline ::System::Object* get_SyncRoot();

  /// @brief Method Add addr 0x242a288 size 0xbc virtual true final false
  inline int32_t Add(::System::Object* obj);

  /// @brief Method AddRange addr 0x242a344 size 0x48 virtual true final false
  inline void AddRange(::System::Collections::ICollection* c);

  /// @brief Method Clear addr 0x242a38c size 0x168 virtual true final false
  inline void Clear();

  /// @brief Method Clone addr 0x242a4f4 size 0x68 virtual true final false
  inline ::System::Object* Clone();

  /// @brief Method Contains addr 0x242a55c size 0xac virtual true final false
  inline bool Contains(::System::Object* obj);

  /// @brief Method CopyTo addr 0x242a608 size 0xb8 virtual true final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method CopyTo addr 0x242a6c0 size 0x348 virtual true final false
  inline void CopyTo(int32_t index, ::System::Array* array, int32_t arrayIndex, int32_t count);

  /// @brief Method GetEnumerator addr 0x242aa08 size 0xa0 virtual true final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf addr 0x242aaa8 size 0xac virtual true final false
  inline int32_t IndexOf(::System::Object* value);

  /// @brief Method Insert addr 0x242ab54 size 0xcc virtual true final false
  inline void Insert(int32_t index, ::System::Object* obj);

  /// @brief Method InsertRange addr 0x242ac20 size 0x3d0 virtual true final false
  inline void InsertRange(int32_t index, ::System::Collections::ICollection* c);

  /// @brief Method Remove addr 0x242aff0 size 0x40 virtual true final false
  inline void Remove(::System::Object* value);

  /// @brief Method RemoveAt addr 0x242b030 size 0xbc virtual true final false
  inline void RemoveAt(int32_t index);

  /// @brief Method RemoveRange addr 0x242b0ec size 0x220 virtual true final false
  inline void RemoveRange(int32_t index, int32_t count);

  /// @brief Method Reverse addr 0x242b30c size 0x370 virtual true final false
  inline void Reverse(int32_t index, int32_t count);

  /// @brief Method Sort addr 0x242b67c size 0x2c4 virtual true final false
  inline void Sort(int32_t index, int32_t count, ::System::Collections::IComparer* comparer);

  /// @brief Method ToArray addr 0x242b940 size 0x15c virtual true final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> ToArray();

  /// @brief Method ToArray addr 0x242ba9c size 0x1b8 virtual true final false
