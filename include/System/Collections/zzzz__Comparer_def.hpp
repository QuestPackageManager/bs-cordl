...
public:
  ...
  /// @brief Method Compare, addr 0x3db3fe0, size 0x20c, virtual true, abstract: false, final true
  inline int32_t Compare(::System::Object* a, ::System::Object* b);

  /// @brief Method GetObjectData, addr 0x3db3f40, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3db3d4c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::CultureInfo* culture);

  /// @brief Method .ctor, addr 0x3db3dd0, size 0x170, virtual false, abstract: false, final false
