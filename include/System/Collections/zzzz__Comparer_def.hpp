...
public:
  ...
  /// @brief Method Compare, addr 0x3db8f54, size 0x20c, virtual true, abstract: false, final true
  inline int32_t Compare(::System::Object* a, ::System::Object* b);

  /// @brief Method GetObjectData, addr 0x3db8eb4, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3db8cc0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::CultureInfo* culture);

  /// @brief Method .ctor, addr 0x3db8d44, size 0x170, virtual false, abstract: false, final false
