...
public:
  ...
  /// @brief Method .ctor addr 0x2586f98 size 0x28 virtual false final false
  inline void _ctor(::System::Collections::ArrayList* l);

  /// @brief Method get_Count addr 0x2586fc0 size 0x24 virtual true final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly addr 0x2586fe4 size 0x8 virtual true final false
  inline bool get_IsReadOnly();

  /// @brief Method get_IsFixedSize addr 0x2586fec size 0x8 virtual true final false
  inline bool get_IsFixedSize();

  /// @brief Method get_IsSynchronized addr 0x2586ff4 size 0x24 virtual true final false
  inline bool get_IsSynchronized();

  /// @brief Method get_Item addr 0x2587018 size 0x24 virtual true final false
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Method set_Item addr 0x258703c size 0x50 virtual true final false
  inline void set_Item(int32_t index, ::System::Object* value);

  /// @brief Method get_SyncRoot addr 0x258708c size 0x24 virtual true final false
  inline ::System::Object* get_SyncRoot();

  /// @brief Method Add addr 0x25870b0 size 0x50 virtual true final false
  inline int32_t Add(::System::Object* obj);

  /// @brief Method AddRange addr 0x2587100 size 0x50 virtual true final false
  inline void AddRange(::System::Collections::ICollection* c);

  /// @brief Method set_Capacity addr 0x2587150 size 0x50 virtual true final false
  inline void set_Capacity(int32_t value);

  /// @brief Method Clear addr 0x25871a0 size 0x50 virtual true final false
  inline void Clear();

  /// @brief Method Clone addr 0x25871f0 size 0xf0 virtual true final false
  inline ::System::Object* Clone();

  /// @brief Method Contains addr 0x25872e0 size 0x24 virtual true final false
  inline bool Contains(::System::Object* obj);

  /// @brief Method CopyTo addr 0x2587304 size 0x24 virtual true final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method CopyTo addr 0x2587328 size 0x24 virtual true final false
  inline void CopyTo(int32_t index, ::System::Array* array, int32_t arrayIndex, int32_t count);

  /// @brief Method GetEnumerator addr 0x258734c size 0x24 virtual true final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf addr 0x2587370 size 0x24 virtual true final false
  inline int32_t IndexOf(::System::Object* value);

  /// @brief Method Insert addr 0x2587394 size 0x50 virtual true final false
  inline void Insert(int32_t index, ::System::Object* obj);

  /// @brief Method InsertRange addr 0x25873e4 size 0x50 virtual true final false
  inline void InsertRange(int32_t index, ::System::Collections::ICollection* c);

  /// @brief Method Remove addr 0x2587434 size 0x50 virtual true final false
  inline void Remove(::System::Object* value);

  /// @brief Method RemoveAt addr 0x2587484 size 0x50 virtual true final false
  inline void RemoveAt(int32_t index);

  /// @brief Method RemoveRange addr 0x25874d4 size 0x50 virtual true final false
  inline void RemoveRange(int32_t index, int32_t count);

  /// @brief Method Reverse addr 0x2587524 size 0x50 virtual true final false
  inline void Reverse(int32_t index, int32_t count);

  /// @brief Method Sort addr 0x2587574 size 0x50 virtual true final false
  inline void Sort(int32_t index, int32_t count, ::System::Collections::IComparer* comparer);

  /// @brief Method ToArray addr 0x25875c4 size 0x24 virtual true final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> ToArray();

  /// @brief Method ToArray addr 0x25875e8 size 0x24 virtual true final false
