...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Collection_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Collection_1(Collection_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Collection_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Collection_1(Collection_1const&) = delete;
