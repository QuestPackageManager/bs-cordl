...
public:
  ...
  /// @brief Method Clone, addr 0x3dc9b34, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x3dc9b3c, size 0xcc, virtual true, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Collections::Queue_QueueEnumerator* New_ctor(::System::Collections::Queue* q);

  /// @brief Method Reset, addr 0x3dc9c98, size 0x88, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3dc994c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Queue* q);

  /// @brief Method get_Current, addr 0x3dc9c08, size 0x90, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Clone, addr 0x3dc93c8, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method CopyTo, addr 0x3dc9528, size 0x1e4, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method Dequeue, addr 0x3dc999c, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Object* Dequeue();

  /// @brief Method Enqueue, addr 0x3dc970c, size 0xfc, virtual true, abstract: false, final false
  inline void Enqueue(::System::Object* obj);

  /// @brief Method GetElement, addr 0x3dc9af4, size 0x40, virtual false, abstract: false, final false
  inline ::System::Object* GetElement(int32_t i);

  /// @brief Method GetEnumerator, addr 0x3dc98f4, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x3dc9a64, size 0x90, virtual true, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method SetCapacity, addr 0x3dc9808, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dc8f7c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3dc9140, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method .ctor, addr 0x3dc8f88, size 0x1b8, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, float_t growFactor);

  /// @brief Method .ctor, addr 0x3dc9148, size 0x278, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ICollection* col);

  /// @brief Method get_Count, addr 0x3dc93c0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x3dc94ac, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x3dc94b4, size 0x74, virtual true, abstract: false, final false
