...
public:
  ...
  /// @brief Method Clone, addr 0x5aa8c44, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method MoveNext, addr 0x5aa8c48, size 0xcc, virtual true, abstract: false, final false
  inline bool MoveNext();

  static inline ::System::Collections::Queue_QueueEnumerator* New_ctor(::System::Collections::Queue* q);

  /// @brief Method Reset, addr 0x5aa8da8, size 0x88, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5aa8a74, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Queue* q);

  /// @brief Method get_Current, addr 0x5aa8d14, size 0x94, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Clone, addr 0x5aa84dc, size 0xe4, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method CopyTo, addr 0x5aa8634, size 0x1e0, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method Dequeue, addr 0x5aa8aac, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Object* Dequeue();

  /// @brief Method Enqueue, addr 0x5aa8814, size 0xfc, virtual true, abstract: false, final false
  inline void Enqueue(::System::Object* obj);

  /// @brief Method GetElement, addr 0x5aa8c04, size 0x40, virtual false, abstract: false, final false
  inline ::System::Object* GetElement(int32_t i);

  /// @brief Method GetEnumerator, addr 0x5aa89fc, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x5aa8b74, size 0x90, virtual true, abstract: false, final false
  inline ::System::Object* Peek();

  /// @brief Method SetCapacity, addr 0x5aa8910, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5aa8088, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5aa8248, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method .ctor, addr 0x5aa8094, size 0x1b4, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, float_t growFactor);

  /// @brief Method .ctor, addr 0x5aa8250, size 0x284, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ICollection* col);

  /// @brief Method get_Count, addr 0x5aa84d4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x5aa85c0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot, addr 0x5aa85c8, size 0x6c, virtual true, abstract: false, final false
