...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDictionaryEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDictionaryEnumerator(IDictionaryEnumeratorconst&) = delete;
