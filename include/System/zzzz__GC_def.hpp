...
public:
  ...
  /// @brief Method GetCollectionCount, addr 0x5c7fdec, size 0xc, virtual false, abstract: false, final false
  static inline int32_t GetCollectionCount(int32_t generation);

  /// @brief Method GetMaxGeneration, addr 0x5c7fdf8, size 0x8, virtual false, abstract: false, final false
  static inline int32_t GetMaxGeneration();

  /// @brief Method GetMemoryInfo, addr 0x5c7fe1c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MaxGeneration, addr 0x5c7fe8c, size 0x54, virtual false, abstract: false, final false
  static inline int32_t get_MaxGeneration();

  /// @brief Method get_ephemeron_tombstone, addr 0x5c7fe08, size 0x14, virtual false, abstract: false, final false
  static inline ::System::Object* get_ephemeron_tombstone();

  /// @brief Method register_ephemeron_array, addr 0x5c7fe04, size 0x4, virtual false, abstract: false, final false
