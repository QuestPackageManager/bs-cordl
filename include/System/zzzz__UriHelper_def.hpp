...
public:
  ...
  /// @brief Method EnsureDestinationSize, addr 0x2e7ca44, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapeAsciiChar, addr 0x2e7c1d4, size 0x108, virtual false, abstract: false, final false
  static inline void EscapeAsciiChar(char16_t ch, ::ArrayW<char16_t, ::Array<char16_t>*> to, ByRef<int32_t> pos);

  /// @brief Method EscapeString, addr 0x2e7c508, size 0x53c, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapedAscii, addr 0x2e7bba0, size 0xc0, virtual false, abstract: false, final false
  static inline char16_t EscapedAscii(char16_t digit, char16_t next);

  /// @brief Method Is3986Unreserved, addr 0x2e7d7ac, size 0x9c, virtual false, abstract: false, final false
  static inline bool Is3986Unreserved(char16_t c);

  /// @brief Method IsNotSafeForUnescape, addr 0x2e7bc60, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsNotSafeForUnescape(char16_t ch);

  /// @brief Method IsReservedUnreservedOrHash, addr 0x2e7cc50, size 0x108, virtual false, abstract: false, final false
  static inline bool IsReservedUnreservedOrHash(char16_t c);

  /// @brief Method IsUnreserved, addr 0x2e7cb70, size 0xe0, virtual false, abstract: false, final false
  static inline bool IsUnreserved(char16_t c);

  /// @brief Method MatchUTF8Sequence, addr 0x2e7bcec, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method TestForSubPath, addr 0x2e7c304, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x2e7cd58, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x2e7ce38, size 0x914, virtual false, abstract: false, final false
