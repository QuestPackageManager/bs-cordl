...
public:
  ...
  /// @brief Method EnsureDestinationSize, addr 0x44079d8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapeAsciiChar, addr 0x4407198, size 0x108, virtual false, abstract: false, final false
  static inline void EscapeAsciiChar(char16_t ch, ::ArrayW<char16_t, ::Array<char16_t>*> to, ::ByRef<int32_t> pos);

  /// @brief Method EscapeString, addr 0x44074c4, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapedAscii, addr 0x4406b74, size 0xbc, virtual false, abstract: false, final false
  static inline char16_t EscapedAscii(char16_t digit, char16_t next);

  /// @brief Method Is3986Unreserved, addr 0x44087e0, size 0x9c, virtual false, abstract: false, final false
  static inline bool Is3986Unreserved(char16_t c);

  /// @brief Method IsNotSafeForUnescape, addr 0x4406c30, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsNotSafeForUnescape(char16_t ch);

  /// @brief Method IsReservedUnreservedOrHash, addr 0x4407be4, size 0x108, virtual false, abstract: false, final false
  static inline bool IsReservedUnreservedOrHash(char16_t c);

  /// @brief Method IsUnreserved, addr 0x4407b04, size 0xe0, virtual false, abstract: false, final false
  static inline bool IsUnreserved(char16_t c);

  /// @brief Method MatchUTF8Sequence, addr 0x4406cbc, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method TestForSubPath, addr 0x44072c8, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x4407cec, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x4407dcc, size 0x9b4, virtual false, abstract: false, final false
