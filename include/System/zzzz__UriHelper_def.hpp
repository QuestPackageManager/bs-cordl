...
public:
  ...
  /// @brief Method EnsureDestinationSize, addr 0x4419e18, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapeAsciiChar, addr 0x44195d8, size 0x108, virtual false, abstract: false, final false
  static inline void EscapeAsciiChar(char16_t ch, ::ArrayW<char16_t, ::Array<char16_t>*> to, ::ByRef<int32_t> pos);

  /// @brief Method EscapeString, addr 0x4419904, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapedAscii, addr 0x4418fb4, size 0xbc, virtual false, abstract: false, final false
  static inline char16_t EscapedAscii(char16_t digit, char16_t next);

  /// @brief Method Is3986Unreserved, addr 0x441ac20, size 0x9c, virtual false, abstract: false, final false
  static inline bool Is3986Unreserved(char16_t c);

  /// @brief Method IsNotSafeForUnescape, addr 0x4419070, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsNotSafeForUnescape(char16_t ch);

  /// @brief Method IsReservedUnreservedOrHash, addr 0x441a024, size 0x108, virtual false, abstract: false, final false
  static inline bool IsReservedUnreservedOrHash(char16_t c);

  /// @brief Method IsUnreserved, addr 0x4419f44, size 0xe0, virtual false, abstract: false, final false
  static inline bool IsUnreserved(char16_t c);

  /// @brief Method MatchUTF8Sequence, addr 0x44190fc, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method TestForSubPath, addr 0x4419708, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x441a12c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x441a20c, size 0x9b4, virtual false, abstract: false, final false
