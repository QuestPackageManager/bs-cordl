...
public:
  ...
  /// @brief Method TestForSubPath, addr 0x294e1a0, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapeString, addr 0x294e3a4, size 0x53c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureDestinationSize, addr 0x294e8e0, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x294ebf4, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x294ecd4, size 0x914, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchUTF8Sequence, addr 0x294db88, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapeAsciiChar, addr 0x294e070, size 0x108, virtual false, abstract: false, final false
  static inline void EscapeAsciiChar(char16_t ch, ::ArrayW<char16_t, ::Array<char16_t>*> to, ByRef<int32_t> pos);

  /// @brief Method EscapedAscii, addr 0x294da3c, size 0xc0, virtual false, abstract: false, final false
  static inline char16_t EscapedAscii(char16_t digit, char16_t next);

  /// @brief Method IsNotSafeForUnescape, addr 0x294dafc, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsNotSafeForUnescape(char16_t ch);

  /// @brief Method IsReservedUnreservedOrHash, addr 0x294eaec, size 0x108, virtual false, abstract: false, final false
  static inline bool IsReservedUnreservedOrHash(char16_t c);

  /// @brief Method IsUnreserved, addr 0x294ea0c, size 0xe0, virtual false, abstract: false, final false
  static inline bool IsUnreserved(char16_t c);

  /// @brief Method Is3986Unreserved, addr 0x294f648, size 0x9c, virtual false, abstract: false, final false
