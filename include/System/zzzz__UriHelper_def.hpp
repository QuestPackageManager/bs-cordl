...
public:
  ...
  /// @brief Method EnsureDestinationSize, addr 0x440af2c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapeAsciiChar, addr 0x440a6ec, size 0x108, virtual false, abstract: false, final false
  static inline void EscapeAsciiChar(char16_t ch, ::ArrayW<char16_t, ::Array<char16_t>*> to, ::ByRef<int32_t> pos);

  /// @brief Method EscapeString, addr 0x440aa18, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method EscapedAscii, addr 0x440a0c8, size 0xbc, virtual false, abstract: false, final false
  static inline char16_t EscapedAscii(char16_t digit, char16_t next);

  /// @brief Method Is3986Unreserved, addr 0x440bd34, size 0x9c, virtual false, abstract: false, final false
  static inline bool Is3986Unreserved(char16_t c);

  /// @brief Method IsNotSafeForUnescape, addr 0x440a184, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsNotSafeForUnescape(char16_t ch);

  /// @brief Method IsReservedUnreservedOrHash, addr 0x440b138, size 0x108, virtual false, abstract: false, final false
  static inline bool IsReservedUnreservedOrHash(char16_t c);

  /// @brief Method IsUnreserved, addr 0x440b058, size 0xe0, virtual false, abstract: false, final false
  static inline bool IsUnreserved(char16_t c);

  /// @brief Method MatchUTF8Sequence, addr 0x440a210, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method TestForSubPath, addr 0x440a81c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x440b240, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method UnescapeString, addr 0x440b320, size 0x9b4, virtual false, abstract: false, final false
