...
public:
  ...
  /// @brief Method .ctor addr 0x2451bb8 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::InvalidOperationException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x2451c14 size 0x24 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::System::InvalidOperationException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor addr 0x2451c38 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2451c5c size 0x8 virtual false final false
