...
public:
  ...
  /// @brief Method .ctor, addr 0x5c48ad0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5c48b78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5c48b30, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5c48b54, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvalidOperationException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvalidOperationException(InvalidOperationException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvalidOperationException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvalidOperationException(InvalidOperationExceptionconst&) = delete;
