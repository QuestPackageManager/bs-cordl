...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AppDomainUnloadedException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AppDomainUnloadedException(AppDomainUnloadedException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AppDomainUnloadedException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AppDomainUnloadedException(AppDomainUnloadedExceptionconst&) = delete;
