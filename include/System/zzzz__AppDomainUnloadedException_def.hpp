...
public:
  ...
  /// @brief Method .ctor, addr 0x3e0ed24, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e0ed7c, size 0x4, virtual false, abstract: false, final false
