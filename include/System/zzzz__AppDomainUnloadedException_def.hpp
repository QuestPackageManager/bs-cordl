...
public:
  ...
  /// @brief Method .ctor, addr 0x28568f4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x285694c, size 0x4, virtual false, abstract: false, final false
