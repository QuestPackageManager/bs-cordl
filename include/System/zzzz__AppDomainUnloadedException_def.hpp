...
public:
  ...
  /// @brief Method .ctor, addr 0x5b2c308, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b2c364, size 0x4, virtual false, abstract: false, final false
