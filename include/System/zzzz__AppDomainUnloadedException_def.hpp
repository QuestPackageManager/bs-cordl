...
public:
  ...
  /// @brief Method .ctor, addr 0x2723be8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2723c40, size 0x4, virtual false, abstract: false, final false
