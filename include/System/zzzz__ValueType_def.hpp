...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValueType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValueType(ValueType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValueType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValueType(ValueTypeconst&) = delete;
