...
public:
  // Declarations
  /// @brief Method GetProxies, addr 0x44b9bac, size 0xc, virtual false, abstract: false, final false
  inline bool GetProxies(::System::Uri* destination, ::ByRef<::System::Collections::Generic::IList_1<::StringW>*> proxyList);

  /// @brief Method GetProxies, addr 0x44b9f58, size 0xc, virtual false, abstract: false, final false
