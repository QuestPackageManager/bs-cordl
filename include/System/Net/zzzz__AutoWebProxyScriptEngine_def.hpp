...
public:
  // Declarations
  /// @brief Method GetProxies, addr 0x62e29e8, size 0xc, virtual false, abstract: false, final false
  inline bool GetProxies(::System::Uri* destination, ::ByRef<::System::Collections::Generic::IList_1<::StringW>*> proxyList);

  /// @brief Method GetProxies, addr 0x62e2d6c, size 0xc, virtual false, abstract: false, final false
