...
public:
// Declarations
/// @brief Method GetProxies, addr 0x62709dc, size 0xc, virtual false, abstract: false, final false
inline bool GetProxies(::System::Uri*  destination, ::ByRef<::System::Collections::Generic::IList_1<::StringW>*>  proxyList) ;

/// @brief Method GetProxies, addr 0x6270d60, size 0xc, virtual false, abstract: false, final false
