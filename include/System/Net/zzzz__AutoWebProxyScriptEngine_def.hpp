...
public:
  // Declarations
  /// @brief Method GetProxies, addr 0x6425e14, size 0xc, virtual false, abstract: false, final false
  inline bool GetProxies(::System::Uri* destination, ::by_ref<::System::Collections::Generic::IList_1<::StringW>*> proxyList);

  /// @brief Method GetProxies, addr 0x6426198, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  AutoWebProxyScriptEngine(AutoWebProxyScriptEngineconst&) = delete;
