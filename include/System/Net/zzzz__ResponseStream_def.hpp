...
/// @brief Method BeginRead, addr 0x61887cc, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x6188320, size 0x23c, virtual true, abstract: false, final false
...
/// @brief Method Close, addr 0x6187a84, size 0x278, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EndRead, addr 0x6188804, size 0x38, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  ares) ;

/// @brief Method EndWrite, addr 0x618855c, size 0x238, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  ares) ;

/// @brief Method Flush, addr 0x618801c, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method GetChunkSizeBytes, addr 0x6187e50, size 0x114, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetChunkSizeBytes(int32_t  size, bool  final) ;

/// @brief Method GetHeaders, addr 0x6187cfc, size 0x154, virtual false, abstract: false, final false
inline ::System::IO::MemoryStream* GetHeaders(bool  closing) ;

/// @brief Method InternalWrite, addr 0x6187f64, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x6188794, size 0x38, virtual true, abstract: false, final false
inline int32_t Read(::ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method Seek, addr 0x618883c, size 0x38, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x6188874, size 0x38, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x6188020, size 0x300, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6187944, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x61879c4, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x61879cc, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x61879d4, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x61879dc, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x6187a14, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Position() ;

static inline void setStaticF_crlf(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method set_Position, addr 0x6187a4c, size 0x38, virtual true, abstract: false, final false
