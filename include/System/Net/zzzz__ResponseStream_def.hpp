...
public:
  ...
  /// @brief Method BeginRead, addr 0x2b23474, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x2b22fc4, size 0x244, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x2b2274c, size 0x264, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EndRead, addr 0x2b234b4, size 0x40, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* ares);

  /// @brief Method EndWrite, addr 0x2b23208, size 0x22c, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* ares);

  /// @brief Method Flush, addr 0x2b22cb8, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method GetChunkSizeBytes, addr 0x2b22b0c, size 0xf0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetChunkSizeBytes(int32_t size, bool final);

  /// @brief Method GetHeaders, addr 0x2b229b0, size 0x15c, virtual false, abstract: false, final false
  inline ::System::IO::MemoryStream* GetHeaders(bool closing);

  /// @brief Method InternalWrite, addr 0x2b22bfc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2b23434, size 0x40, virtual true, abstract: false, final false
  inline int32_t Read(ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> buffer, int32_t offset, int32_t count);

  /// @brief Method Seek, addr 0x2b234f4, size 0x40, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x2b23534, size 0x40, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x2b22cbc, size 0x308, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b225f0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanRead, addr 0x2b22674, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x2b2267c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x2b22684, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x2b2268c, size 0x40, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x2b226cc, size 0x40, virtual true, abstract: false, final false
  inline int64_t get_Position();

  static inline void setStaticF_crlf(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_Position, addr 0x2b2270c, size 0x40, virtual true, abstract: false, final false
