...
public:
  // Declarations
  /// @brief Method get_DefaultCredentials, addr 0x62c853c, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Net::ICredentials* get_DefaultCredentials();

  /// @brief Method get_DefaultNetworkCredentials, addr 0x62c8598, size 0x5c, virtual false, abstract: false, final false
