...
public:
  // Declarations
  /// @brief Method get_DefaultCredentials, addr 0x6255e70, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Net::ICredentials* get_DefaultCredentials();

  /// @brief Method get_DefaultNetworkCredentials, addr 0x6255ecc, size 0x5c, virtual false, abstract: false, final false
