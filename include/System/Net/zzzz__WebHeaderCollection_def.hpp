...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8350)), TypeDefinitionIndex(TypeDefinitionIndex(7926))}
...
public:
  ...
  /// @brief Method NormalizeCommonHeaders addr 0x28224c0 size 0x100 virtual false final false
  inline void NormalizeCommonHeaders();

  /// @brief Method get_InnerCollection addr 0x28225c0 size 0xa4 virtual false final false
  inline ::System::Collections::Specialized::NameValueCollection* get_InnerCollection();

  /// @brief Method AllowMultiValues addr 0x2822664 size 0xa8 virtual false final false
  static inline bool AllowMultiValues(::StringW name);

  /// @brief Method get_AllowHttpRequestHeader addr 0x28227e8 size 0x38 virtual false final false
  inline bool get_AllowHttpRequestHeader();

  /// @brief Method Remove addr 0x2822820 size 0xf8 virtual false final false
  inline void Remove(::System::Net::HttpRequestHeader header);

  /// @brief Method AddInternal addr 0x2822918 size 0x54 virtual false final false
  inline void AddInternal(::StringW name, ::StringW value);

  /// @brief Method ChangeInternal addr 0x282296c size 0x54 virtual false final false
  inline void ChangeInternal(::StringW name, ::StringW value);

  /// @brief Method RemoveInternal addr 0x28229c0 size 0x5c virtual false final false
  inline void RemoveInternal(::StringW name);

  /// @brief Method CheckBadChars addr 0x2822a1c size 0x394 virtual false final false
  static inline ::StringW CheckBadChars(::StringW name, bool isHeaderValue);

  /// @brief Method ContainsNonAsciiChars addr 0x2822db0 size 0x84 virtual false final false
  static inline bool ContainsNonAsciiChars(::StringW token);

  /// @brief Method ThrowOnRestrictedHeader addr 0x2822e34 size 0x168 virtual false final false
  inline void ThrowOnRestrictedHeader(::StringW headerName);

  /// @brief Method Add addr 0x2822f9c size 0x1b4 virtual true final false
  inline void Add(::StringW name, ::StringW value);

  /// @brief Method Add addr 0x2823150 size 0x2dc virtual false final false
  inline void Add(::StringW header);

  /// @brief Method Set addr 0x282342c size 0x230 virtual true final false
  inline void Set(::StringW name, ::StringW value);

  /// @brief Method SetInternal addr 0x282365c size 0x224 virtual false final false
  inline void SetInternal(::StringW name, ::StringW value);

  /// @brief Method Remove addr 0x2823880 size 0x13c virtual true final false
  inline void Remove(::StringW name);

  /// @brief Method GetValues addr 0x28239bc size 0x208 virtual true final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetValues(::StringW header);

  /// @brief Method ToString addr 0x2823bc4 size 0x5c virtual true final false
  inline ::StringW ToString();

  /// @brief Method GetAsString addr 0x2823c20 size 0x2a4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2823ec4 size 0x64 virtual false final false
  inline void _ctor();

  static inline ::System::Net::WebHeaderCollection* New_ctor(::System::Net::WebHeaderCollectionType type);

  /// @brief Method .ctor addr 0x2823f28 size 0xe4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x282400c size 0x1c4 virtual false final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method OnDeserialization addr 0x28241d0 size 0x4 virtual true final false
  inline void OnDeserialization(::System::Object* sender);

  /// @brief Method GetObjectData addr 0x28241d4 size 0x180 virtual true final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x2824354 size 0xc virtual true final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method Get addr 0x2824360 size 0x328 virtual true final false
  inline ::StringW Get(::StringW name);

  /// @brief Method GetEnumerator addr 0x2824688 size 0x7c virtual true final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method get_Count addr 0x2824704 size 0x30 virtual true final false
  inline int32_t get_Count();

  /// @brief Method Get addr 0x2824734 size 0x40 virtual true final false
  inline ::StringW Get(int32_t index);

  /// @brief Method GetValues addr 0x2824774 size 0x40 virtual true final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetValues(int32_t index);

  /// @brief Method GetKey addr 0x28247b4 size 0x40 virtual true final false
