...
public:
  ...
  /// @brief Method .ctor, addr 0x2f988a8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x2f988e0, size 0x38, virtual true, abstract: false, final false
