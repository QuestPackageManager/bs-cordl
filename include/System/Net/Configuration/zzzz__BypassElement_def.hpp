...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BypassElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BypassElement(BypassElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BypassElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BypassElement(BypassElementconst&) = delete;
