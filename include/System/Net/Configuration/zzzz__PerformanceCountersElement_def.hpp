...
public:
  ...
  /// @brief Method .ctor, addr 0x6371f0c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x6371f48, size 0x3c, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PerformanceCountersElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PerformanceCountersElement(PerformanceCountersElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PerformanceCountersElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PerformanceCountersElement(PerformanceCountersElementconst&) = delete;
