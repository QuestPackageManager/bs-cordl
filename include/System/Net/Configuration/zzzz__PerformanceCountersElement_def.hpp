...
public:
  ...
  /// @brief Method .ctor, addr 0x6155828, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x6155864, size 0x3c, virtual true, abstract: false, final false
