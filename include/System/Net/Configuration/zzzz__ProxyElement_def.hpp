...
public:
  ...
  /// @brief Method .ctor, addr 0x6371cf0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x6371d2c, size 0x3c, virtual true, abstract: false, final false
...
public:
  ...
  ProxyElement(ProxyElementconst&) = delete;
