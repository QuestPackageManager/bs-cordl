...
public:
  ...
  /// @brief Method Reset, addr 0x622f828, size 0x3c, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentElement);

  /// @brief Method .ctor, addr 0x622f7b0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x622f7ec, size 0x3c, virtual true, abstract: false, final false
