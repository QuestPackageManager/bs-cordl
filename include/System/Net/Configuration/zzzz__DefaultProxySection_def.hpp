...
public:
  ...
  /// @brief Method Reset, addr 0x4402780, size 0x38, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentElement);

  /// @brief Method .ctor, addr 0x4402710, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x4402748, size 0x38, virtual true, abstract: false, final false
