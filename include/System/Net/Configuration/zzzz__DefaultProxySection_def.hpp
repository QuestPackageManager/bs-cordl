...
public:
  ...
  /// @brief Method Reset, addr 0x4414bc0, size 0x38, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentElement);

  /// @brief Method .ctor, addr 0x4414b50, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x4414b88, size 0x38, virtual true, abstract: false, final false
