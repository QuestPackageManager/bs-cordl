...
/// @brief Method Reset, addr 0x62313a0, size 0x3c, virtual true, abstract: false, final false
inline void Reset(::System::Configuration::ConfigurationElement*  parentElement) ;

/// @brief Method .ctor, addr 0x6231328, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Properties, addr 0x6231364, size 0x3c, virtual true, abstract: false, final false
