...
public:
  ...
  /// @brief Method .ctor, addr 0x61bd33c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Properties, addr 0x61bd378, size 0x3c, virtual true, abstract: false, final false
