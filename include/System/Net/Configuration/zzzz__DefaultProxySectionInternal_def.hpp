...
public:
  ...
  /// @brief Method GetDefaultProxy_UsingOldMonoCode, addr 0x43f0720, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Net::IWebProxy* GetDefaultProxy_UsingOldMonoCode();

  /// @brief Method GetSection, addr 0x43f07c8, size 0x110, virtual false, abstract: false, final false
  static inline ::System::Net::Configuration::DefaultProxySectionInternal* GetSection();

  /// @brief Method GetSystemWebProxy, addr 0x43f0728, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43f08d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Object* getStaticF_classSyncObject();

  /// @brief Method get_ClassSyncObject, addr 0x43f0730, size 0x98, virtual false, abstract: false, final false
  static inline ::System::Object* get_ClassSyncObject();

  /// @brief Method get_WebProxy, addr 0x43f08e0, size 0x8, virtual false, abstract: false, final false
