...
public:
  ...
  /// @brief Method .ctor, addr 0x6351dbc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Net::Configuration::SettingsSectionInternal* getStaticF_instance();

  /// @brief Method get_Ipv6Enabled, addr 0x6351db4, size 0x8, virtual false, abstract: false, final false
  inline bool get_Ipv6Enabled();

  /// @brief Method get_Section, addr 0x6351d58, size 0x5c, virtual false, abstract: false, final false
