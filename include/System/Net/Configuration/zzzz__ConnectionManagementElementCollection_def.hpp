...
public:
  ...
  /// @brief Method .ctor, addr 0x6371b88, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ConnectionManagementElementCollection(ConnectionManagementElementCollectionconst&) = delete;
