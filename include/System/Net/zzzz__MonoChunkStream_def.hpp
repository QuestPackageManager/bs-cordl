...
public:
  ...
  /// @brief Method MoveNext, addr 0x4370170, size 0x3e8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x4370558, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x43705d4, size 0x458, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x4370a2c, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method FinishReading, addr 0x4370038, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessReadAsync, addr 0x436ff1c, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method ThrowExpectingChunkTrailer, addr 0x4370110, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method <>n__0, addr 0x4370168, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* __n__0(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method .ctor, addr 0x436fe90, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* innerStream, ::System::Net::WebHeaderCollection* headers);

  /// @brief Method get_Decoder, addr 0x436fe88, size 0x8, virtual false, abstract: false, final false
