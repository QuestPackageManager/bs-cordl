...
namespace System::Net {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(7037)), TypeDefinitionIndex(TypeDefinitionIndex(7107))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x29d6774, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method .ctor, addr 0x29d677c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29d5fb8, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29d6a44, size 0x39c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_Headers, addr 0x29d6de0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_ResponseUri, addr 0x29d6de8, size 0x18, virtual true, abstract: false, final false
  inline ::System::Uri* get_ResponseUri();

  /// @brief Method get_StatusCode, addr 0x29d6e84, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::HttpStatusCode get_StatusCode();

  /// @brief Method get_StatusDescription, addr 0x29d6e8c, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_StatusDescription();

  /// @brief Method GetResponseStream, addr 0x29d6ea4, size 0x9c, virtual true, abstract: false, final false
  inline ::System::IO::Stream* GetResponseStream();

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x29d6f40, size 0xc, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetObjectData, addr 0x29d6f4c, size 0x1c0, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method Close, addr 0x29d710c, size 0x30, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method System.IDisposable.Dispose, addr 0x29d713c, size 0x10, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method Dispose, addr 0x29d714c, size 0x14, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method CheckDisposed, addr 0x29d6e00, size 0x84, virtual false, abstract: false, final false
  inline void CheckDisposed();

  /// @brief Method FillCookies, addr 0x29d6830, size 0x214, virtual false, abstract: false, final false
