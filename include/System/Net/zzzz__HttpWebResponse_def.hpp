...
public:
  ...
  /// @brief Method CheckDisposed, addr 0x43d0644, size 0x7c, virtual false, abstract: false, final false
  inline void CheckDisposed();

  /// @brief Method Close, addr 0x43d0948, size 0x30, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x43d0988, size 0x14, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FillCookies, addr 0x43d0074, size 0x214, virtual false, abstract: false, final false
  inline void FillCookies();

  /// @brief Method GetObjectData, addr 0x43d0788, size 0x1c0, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetResponseStream, addr 0x43d06e0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.IDisposable.Dispose, addr 0x43d0978, size 0x10, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x43d077c, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x43cffb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x43d0288, size 0x39c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x43cffc0, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* uri, ::StringW method, ::System::Net::HttpStatusCode status, ::System::Net::WebHeaderCollection* headers);

  /// @brief Method .ctor, addr 0x43cf788, size 0x2e0, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* uri, ::StringW method, ::System::Net::WebResponseStream* stream, ::System::Net::CookieContainer* container);

  /// @brief Method get_Headers, addr 0x43d0624, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_ResponseUri, addr 0x43d062c, size 0x18, virtual true, abstract: false, final false
  inline ::System::Uri* get_ResponseUri();

  /// @brief Method get_StatusCode, addr 0x43d06c0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::HttpStatusCode get_StatusCode();

  /// @brief Method get_StatusDescription, addr 0x43d06c8, size 0x18, virtual true, abstract: false, final false
