...
public:
  ...
  /// @brief Method CheckUri, addr 0x6184704, size 0x344, virtual false, abstract: false, final false
  static inline void CheckUri(::StringW uri);

  /// @brief Method Equals, addr 0x6184668, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x61846e8, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::ListenerPrefix* New_ctor(::StringW prefix);

  /// @brief Method Parse, addr 0x618433c, size 0x304, virtual false, abstract: false, final false
  inline void Parse(::StringW uri);

  /// @brief Method ToString, addr 0x6184640, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6184334, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW prefix);

  /// @brief Method get_Host, addr 0x6184650, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Host();

  /// @brief Method get_Path, addr 0x6184660, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Path();

  /// @brief Method get_Port, addr 0x6184658, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Port();

  /// @brief Method get_Secure, addr 0x6184648, size 0x8, virtual false, abstract: false, final false
