...
public:
  ...
  /// @brief Method .ctor addr 0x29d32b4 size 0x30 virtual false final false
  inline void _ctor(::StringW prefix);

  /// @brief Method ToString addr 0x29d35d4 size 0x8 virtual true final false
  inline ::StringW ToString();

  /// @brief Method get_Secure addr 0x29d35dc size 0x8 virtual false final false
  inline bool get_Secure();

  /// @brief Method get_Host addr 0x29d35e4 size 0x8 virtual false final false
  inline ::StringW get_Host();

  /// @brief Method get_Port addr 0x29d35ec size 0x8 virtual false final false
  inline int32_t get_Port();

  /// @brief Method get_Path addr 0x29d35f4 size 0x8 virtual false final false
  inline ::StringW get_Path();

  /// @brief Method Equals addr 0x29d35fc size 0x80 virtual true final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode addr 0x29d367c size 0x20 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Parse addr 0x29d32e4 size 0x2f0 virtual false final false
  inline void Parse(::StringW uri);

  /// @brief Method CheckUri addr 0x29d369c size 0x350 virtual false final false
