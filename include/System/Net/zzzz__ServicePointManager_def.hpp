...
public:
  ...
  /// @brief Method Equals, addr 0x61fc2e8, size 0x100, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x61fc228, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61fbd48, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* uri, ::System::Uri* proxy, bool use_connect);

  /// @brief Method get_UsesProxy, addr 0x61fc1c8, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CloseConnectionGroup, addr 0x61fbd54, size 0x3d8, virtual false, abstract: false, final false
  static inline void CloseConnectionGroup(::StringW connectionGroupName);

  /// @brief Method FindServicePoint, addr 0x61fbcec, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Net::ServicePoint* FindServicePoint(::System::Uri* address);

  /// @brief Method FindServicePoint, addr 0x61ef6a8, size 0x678, virtual false, abstract: false, final false
  static inline ::System::Net::ServicePoint* FindServicePoint(::System::Uri* address, ::System::Net::IWebProxy* proxy);

  /// @brief Method GetLegacyCertificatePolicy, addr 0x61fb8d4, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Net::ICertificatePolicy* GetLegacyCertificatePolicy();

  /// @brief Method RemoveServicePoint, addr 0x61fc12c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CheckCertificateRevocationList, addr 0x61fb930, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_CheckCertificateRevocationList();

  /// @brief Method get_DnsRefreshTimeout, addr 0x61fba3c, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_DnsRefreshTimeout();

  /// @brief Method get_SecurityProtocol, addr 0x61fba98, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Net::SecurityProtocolType get_SecurityProtocol();

  /// @brief Method get_ServerCertValidationCallback, addr 0x61fbaf4, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Net::ServerCertValidationCallback* get_ServerCertValidationCallback();

  /// @brief Method get_ServerCertificateValidationCallback, addr 0x61fbb50, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DefaultConnectionLimit, addr 0x61fb98c, size 0xb0, virtual false, abstract: false, final false
  static inline void set_DefaultConnectionLimit(int32_t value);

  /// @brief Method set_Expect100Continue, addr 0x61fbc88, size 0x64, virtual false, abstract: false, final false
  static inline void set_Expect100Continue(bool value);

  /// @brief Method set_ServerCertificateValidationCallback, addr 0x61fbbdc, size 0xac, virtual false, abstract: false, final false
