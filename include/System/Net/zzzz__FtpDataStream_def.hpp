...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FtpDataStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FtpDataStream(FtpDataStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FtpDataStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FtpDataStream(FtpDataStreamconst&) = delete;
