...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FileWebStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FileWebStream(FileWebStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FileWebStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FileWebStream(FileWebStreamconst&) = delete;
