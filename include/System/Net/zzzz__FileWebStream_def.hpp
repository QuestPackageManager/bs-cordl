...
public:
  ...
  /// @brief Method BeginRead, addr 0x44b3158, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x44b32d8, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckError, addr 0x44b3010, size 0x80, virtual false, abstract: false, final false
  inline void CheckError();

  /// @brief Method Dispose, addr 0x44b2e5c, size 0xb0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x44b3238, size 0xa0, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* ar);

  /// @brief Method EndWrite, addr 0x44b33b8, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x44b2f48, size 0xc8, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method System.Net.ICloseEx.CloseEx, addr 0x44b2f0c, size 0x3c, virtual true, abstract: false, final true
  inline void System_Net_ICloseEx_CloseEx(::System::Net::CloseExState closeState);

  /// @brief Method Write, addr 0x44b3090, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44b219c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44b2da8, size 0xb4, virtual false, abstract: false, final false
