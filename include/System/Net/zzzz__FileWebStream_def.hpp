...
public:
  ...
  /// @brief Method BeginRead, addr 0x2ee7a5c, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x2ee7bdc, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckError, addr 0x2ee7914, size 0x80, virtual false, abstract: false, final false
  inline void CheckError();

  /// @brief Method Dispose, addr 0x2ee7760, size 0xb0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x2ee7b3c, size 0xa0, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* ar);

  /// @brief Method EndWrite, addr 0x2ee7cbc, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2ee784c, size 0xc8, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method System.Net.ICloseEx.CloseEx, addr 0x2ee7810, size 0x3c, virtual true, abstract: false, final true
  inline void System_Net_ICloseEx_CloseEx(::System::Net::CloseExState closeState);

  /// @brief Method Write, addr 0x2ee7994, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ee6a3c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ee76ac, size 0xb4, virtual false, abstract: false, final false
