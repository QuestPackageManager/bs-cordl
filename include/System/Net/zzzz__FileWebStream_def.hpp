...
public:
  ...
  /// @brief Method BeginRead, addr 0x62e0f08, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x62e1080, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckError, addr 0x62e0dc4, size 0x80, virtual false, abstract: false, final false
  inline void CheckError();

  /// @brief Method Dispose, addr 0x62e0c10, size 0xac, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x62e0fe4, size 0x9c, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* ar);

  /// @brief Method EndWrite, addr 0x62e115c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x62e0d00, size 0xc4, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method System.Net.ICloseEx.CloseEx, addr 0x62e0cbc, size 0x44, virtual true, abstract: false, final true
  inline void System_Net_ICloseEx_CloseEx(::System::Net::CloseExState closeState);

  /// @brief Method Write, addr 0x62e0e44, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62dfec8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62e0b48, size 0xc8, virtual false, abstract: false, final false
