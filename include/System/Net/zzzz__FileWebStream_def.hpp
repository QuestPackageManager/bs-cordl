...
public:
  ...
  /// @brief Method BeginRead, addr 0x641eb1c, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x641ec94, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckError, addr 0x641e9d8, size 0x80, virtual false, abstract: false, final false
  inline void CheckError();

  /// @brief Method Dispose, addr 0x641e824, size 0xac, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x641ebf8, size 0x9c, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* ar);

  /// @brief Method EndWrite, addr 0x641ed70, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x641e914, size 0xc4, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size);

  /// @brief Method System.Net.ICloseEx.CloseEx, addr 0x641e8d0, size 0x44, virtual true, abstract: false, final true
  inline void System_Net_ICloseEx_CloseEx(::System::Net::CloseExState closeState);

  /// @brief Method Write, addr 0x641ea58, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x641dadc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x641e75c, size 0xc8, virtual false, abstract: false, final false
