...
public:
  ...
  /// @brief Method MoveNext, addr 0x6203a34, size 0xd90, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x62047c4, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x6204830, size 0x870, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x62050a0, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method FlushContents, addr 0x6203998, size 0x9c, virtual false, abstract: false, final false
  inline void FlushContents(::System::IO::Stream* stream, int32_t contentLength);

  /// @brief Method Initialize, addr 0x62037d0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadHeaders, addr 0x620389c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6203750, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpWebRequest* request, ::System::Uri* connectUri);

  /// @brief Method get_Challenge, addr 0x6203790, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Challenge();

  /// @brief Method get_CloseConnection, addr 0x6203768, size 0x8, virtual false, abstract: false, final false
  inline bool get_CloseConnection();

  /// @brief Method get_ConnectUri, addr 0x6203748, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_ConnectUri();

  /// @brief Method get_Data, addr 0x62037c0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Data();

  /// @brief Method get_Headers, addr 0x62037a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_ProxyVersion, addr 0x62037b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_ProxyVersion();

  /// @brief Method get_Request, addr 0x6203740, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpWebRequest* get_Request();

  /// @brief Method get_StatusCode, addr 0x6203778, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_StatusCode();

  /// @brief Method get_Success, addr 0x6203758, size 0x8, virtual false, abstract: false, final false
  inline bool get_Success();

  /// @brief Method set_Challenge, addr 0x6203798, size 0x8, virtual false, abstract: false, final false
  inline void set_Challenge(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_CloseConnection, addr 0x6203770, size 0x8, virtual false, abstract: false, final false
  inline void set_CloseConnection(bool value);

  /// @brief Method set_Data, addr 0x62037c8, size 0x8, virtual false, abstract: false, final false
  inline void set_Data(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_Headers, addr 0x62037a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Headers(::System::Net::WebHeaderCollection* value);

  /// @brief Method set_ProxyVersion, addr 0x62037b8, size 0x8, virtual false, abstract: false, final false
  inline void set_ProxyVersion(::System::Version* value);

  /// @brief Method set_StatusCode, addr 0x6203780, size 0x8, virtual false, abstract: false, final false
  inline void set_StatusCode(int32_t value);

  /// @brief Method set_StatusDescription, addr 0x6203788, size 0x8, virtual false, abstract: false, final false
  inline void set_StatusDescription(::StringW value);

  /// @brief Method set_Success, addr 0x6203760, size 0x8, virtual false, abstract: false, final false
