...
public:
  ...
  /// @brief Method Parse, addr 0x449ce4c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x449cae8, size 0x58, virtual false, abstract: false, final false
