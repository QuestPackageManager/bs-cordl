...
public:
  ...
  /// @brief Method Parse, addr 0x2ff117c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ff0e0c, size 0x58, virtual false, abstract: false, final false
