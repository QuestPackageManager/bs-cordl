...
// Write type traits
MARK_REF_T(::System::Net::KnownHttpVerb*);
DEFINE_IL2CPP_CLASS(::System::Net::KnownHttpVerb*, "System.Net", "KnownHttpVerb");
...
public:
  ...
  __declspec(property(get = getStaticF_Connect, put = setStaticF_Connect)) ::System::Net::KnownHttpVerb* Connect;
  ...
  __declspec(property(get = getStaticF_Get, put = setStaticF_Get)) ::System::Net::KnownHttpVerb* Get;

  /// @brief Field Head, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Head, put = setStaticF_Head)) ::System::Net::KnownHttpVerb* Head;

  /// @brief Field MkCol, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_MkCol, put = setStaticF_MkCol)) ::System::Net::KnownHttpVerb* MkCol;

  /// @brief Field Name, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get_Name, put = __cordl_internal_set_Name)) ::StringW Name;

  /// @brief Field NamedHeaders, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_NamedHeaders, put = setStaticF_NamedHeaders)) ::System::Collections::Specialized::ListDictionary* NamedHeaders;

  /// @brief Field Post, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Post, put = setStaticF_Post)) ::System::Net::KnownHttpVerb* Post;

  /// @brief Field Put, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Put, put = setStaticF_Put)) ::System::Net::KnownHttpVerb* Put;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KnownHttpVerb", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KnownHttpVerb(KnownHttpVerb&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KnownHttpVerb", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KnownHttpVerb(KnownHttpVerbconst&) = delete;
...
static_assert(sizeof(::System::Net::KnownHttpVerb) == 0x20, "Size mismatch!");
