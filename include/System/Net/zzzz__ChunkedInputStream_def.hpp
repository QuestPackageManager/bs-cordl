...
public:
  ...
  /// @brief Method .ctor, addr 0x44bcd10, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BeginRead, addr 0x44bca24, size 0x2ec, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x44bd560, size 0x1c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EndRead, addr 0x44bd2d4, size 0x28c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnRead, addr 0x44bcd58, size 0x3a0, virtual false, abstract: false, final false
  inline void OnRead(::System::IAsyncResult* base_ares);

  /// @brief Method Read, addr 0x44bc9e8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44bc8e8, size 0x100, virtual false, abstract: false, final false
