...
/// @brief Method .ctor, addr 0x62e7744, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method BeginRead, addr 0x62e7438, size 0x30c, virtual true, abstract: false, final false
...
/// @brief Method Close, addr 0x62e7ff4, size 0x1c, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EndRead, addr 0x62e7d58, size 0x29c, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  ares) ;

static inline ::System::Net::ChunkedInputStream* New_ctor(::System::Net::HttpListenerContext*  context, ::System::IO::Stream*  stream, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  length) ;

/// @brief Method OnRead, addr 0x62e7758, size 0x3c4, virtual false, abstract: false, final false
inline void OnRead(::System::IAsyncResult*  base_ares) ;

/// @brief Method Read, addr 0x62e73fc, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62e72ec, size 0x110, virtual false, abstract: false, final false
