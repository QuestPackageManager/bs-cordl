...
// Write type traits
MARK_REF_T(::System::Net::ChunkedInputStream*);
MARK_REF_T(::System::Net::ChunkedInputStream_ReadBufferState*);
DEFINE_IL2CPP_CLASS(::System::Net::ChunkedInputStream*, "System.Net", "ChunkedInputStream");
DEFINE_IL2CPP_CLASS(::System::Net::ChunkedInputStream_ReadBufferState*, "System.Net", "ChunkedInputStream/ReadBufferState");
...
public:
  ...
  static inline ::System::Net::ChunkedInputStream_ReadBufferState* New_ctor(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, ::System::Net::HttpStreamAsyncResult* ares);
  ...
  /// @brief Method .ctor, addr 0x6428ff8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, ::System::Net::HttpStreamAsyncResult* ares);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChunkedInputStream_ReadBufferState", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChunkedInputStream_ReadBufferState(ChunkedInputStream_ReadBufferState&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChunkedInputStream_ReadBufferState", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChunkedInputStream_ReadBufferState(ChunkedInputStream_ReadBufferStateconst&) = delete;
...
static_assert(sizeof(::System::Net::ChunkedInputStream_ReadBufferState) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method BeginRead, addr 0x6428cec, size 0x30c, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x64298a8, size 0x1c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EndRead, addr 0x642960c, size 0x29c, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* ares);

  static inline ::System::Net::ChunkedInputStream* New_ctor(::System::Net::HttpListenerContext* context, ::System::IO::Stream* stream, ::ArrayW<uint8_t> buffer, int32_t offset, int32_t length);

  /// @brief Method OnRead, addr 0x642900c, size 0x3c4, virtual false, abstract: false, final false
  inline void OnRead(::System::IAsyncResult* base_ares);

  /// @brief Method Read, addr 0x6428cb0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6428ba0, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpListenerContext* context, ::System::IO::Stream* stream, ::ArrayW<uint8_t> buffer, int32_t offset, int32_t length);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChunkedInputStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChunkedInputStream(ChunkedInputStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChunkedInputStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChunkedInputStream(ChunkedInputStreamconst&) = delete;
...
static_assert(sizeof(::System::Net::ChunkedInputStream) == 0x70, "Size mismatch!");
