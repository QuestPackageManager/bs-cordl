...
public:
  ...
  /// @brief Method .ctor, addr 0x44be554, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BeginRead, addr 0x44be268, size 0x2ec, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x44beda4, size 0x1c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EndRead, addr 0x44beb18, size 0x28c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnRead, addr 0x44be59c, size 0x3a0, virtual false, abstract: false, final false
  inline void OnRead(::System::IAsyncResult* base_ares);

  /// @brief Method Read, addr 0x44be22c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44be12c, size 0x100, virtual false, abstract: false, final false
