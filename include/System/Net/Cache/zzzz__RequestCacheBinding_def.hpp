...
public:
  ...
  /// @brief Method .ctor, addr 0x2addf68, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Cache, addr 0x2addfe4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Cache::RequestCache* get_Cache();

  /// @brief Method get_Policy, addr 0x2addff4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Cache::RequestCachePolicy* get_Policy();

  /// @brief Method get_Validator, addr 0x2addfec, size 0x8, virtual false, abstract: false, final false
