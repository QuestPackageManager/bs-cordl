...
public:
  ...
  /// @brief Method .ctor, addr 0x61a3000, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Cache, addr 0x61a3044, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Cache::RequestCache* get_Cache();

  /// @brief Method get_Policy, addr 0x61a3054, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Cache::RequestCachePolicy* get_Policy();

  /// @brief Method get_Validator, addr 0x61a304c, size 0x8, virtual false, abstract: false, final false
