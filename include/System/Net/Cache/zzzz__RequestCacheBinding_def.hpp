...
public:
  ...
  /// @brief Method .ctor, addr 0x613b474, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Cache, addr 0x613b4b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Cache::RequestCache* get_Cache();

  /// @brief Method get_Policy, addr 0x613b4c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Cache::RequestCachePolicy* get_Policy();

  /// @brief Method get_Validator, addr 0x613b4c0, size 0x8, virtual false, abstract: false, final false
