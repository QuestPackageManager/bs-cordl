...
public:
  ...
  /// @brief Method .ctor, addr 0x6357c54, size 0x38, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RequestCacheProtocol", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RequestCacheProtocol(RequestCacheProtocol&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RequestCacheProtocol", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RequestCacheProtocol(RequestCacheProtocolconst&) = delete;
