...
public:
  ...
  /// @brief Method .ctor, addr 0x6357a50, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RequestCachingSectionInternal", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RequestCachingSectionInternal(RequestCachingSectionInternal&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RequestCachingSectionInternal", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RequestCachingSectionInternal(RequestCachingSectionInternalconst&) = delete;
