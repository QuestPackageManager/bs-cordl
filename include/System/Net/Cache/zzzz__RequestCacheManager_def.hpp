...
/// @brief Method GetBinding, addr 0x61a3250, size 0x1fc, virtual false, abstract: false, final false
static inline ::System::Net::Cache::RequestCacheBinding* GetBinding(::StringW  internedScheme) ;

/// @brief Method LoadConfigSettings, addr 0x61a344c, size 0x16c, virtual false, abstract: false, final false
