...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RequestCachePolicy", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RequestCachePolicy(RequestCachePolicy&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RequestCachePolicy", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RequestCachePolicy(RequestCachePolicyconst&) = delete;
