...
public:
  ...
  /// @brief Method ToString, addr 0x61a3064, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a2fa4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Cache::RequestCacheLevel level);

  /// @brief Method get_Level, addr 0x61a305c, size 0x8, virtual false, abstract: false, final false
