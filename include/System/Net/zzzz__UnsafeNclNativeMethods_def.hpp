...
public:
  ...
  /// @brief Method ToString, addr 0x2b04e4c, size 0x7c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method CreateSecureString, addr 0x2b05b3c, size 0xac, virtual false, abstract: false, final false
  static inline ::System::Security::SecureString* CreateSecureString(::StringW plainString);

  /// @brief Method CreateString, addr 0x2b0598c, size 0x1b0, virtual false, abstract: false, final false
