...
public:
  ...
  /// @brief Method ToString, addr 0x44bbc54, size 0x7c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method CreateSecureString, addr 0x44bc47c, size 0x9c, virtual false, abstract: false, final false
  static inline ::System::Security::SecureString* CreateSecureString(::StringW plainString);

  /// @brief Method CreateString, addr 0x44bc308, size 0x174, virtual false, abstract: false, final false
