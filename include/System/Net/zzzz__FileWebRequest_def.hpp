...
public:
  ...
  /// @brief Method .ctor addr 0x29b3514 size 0x178 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29b368c size 0x39c virtual false final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x29b3a28 size 0xc virtual true final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetObjectData addr 0x29b3a34 size 0x290 virtual true final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_Aborted addr 0x29b3cc4 size 0x10 virtual false final false
  inline bool get_Aborted();

  /// @brief Method set_ConnectionGroupName addr 0x29b3cd4 size 0x8 virtual true final false
  inline void set_ConnectionGroupName(::StringW value);

  /// @brief Method get_ContentLength addr 0x29b3cdc size 0x8 virtual true final false
  inline int64_t get_ContentLength();

  /// @brief Method set_ContentLength addr 0x29b3ce4 size 0x84 virtual true final false
  inline void set_ContentLength(int64_t value);

  /// @brief Method get_Credentials addr 0x29b3d68 size 0x8 virtual true final false
  inline ::System::Net::ICredentials* get_Credentials();

  /// @brief Method set_Credentials addr 0x29b3d70 size 0x8 virtual true final false
  inline void set_Credentials(::System::Net::ICredentials* value);

  /// @brief Method get_Headers addr 0x29b3d78 size 0x8 virtual true final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_Method addr 0x29b3d80 size 0x8 virtual true final false
  inline ::StringW get_Method();

  /// @brief Method set_Method addr 0x29b3d88 size 0xd4 virtual true final false
  inline void set_Method(::StringW value);

  /// @brief Method set_PreAuthenticate addr 0x29b3e5c size 0xc virtual true final false
  inline void set_PreAuthenticate(bool value);

  /// @brief Method get_Proxy addr 0x29b3e68 size 0x8 virtual true final false
  inline ::System::Net::IWebProxy* get_Proxy();

  /// @brief Method set_Proxy addr 0x29b3e70 size 0x8 virtual true final false
  inline void set_Proxy(::System::Net::IWebProxy* value);

  /// @brief Method get_Timeout addr 0x29b3e78 size 0x8 virtual true final false
  inline int32_t get_Timeout();

  /// @brief Method set_Timeout addr 0x29b3e80 size 0x88 virtual true final false
  inline void set_Timeout(int32_t value);

  /// @brief Method get_RequestUri addr 0x29b3f08 size 0x8 virtual true final false
  inline ::System::Uri* get_RequestUri();

  /// @brief Method BeginGetRequestStream addr 0x29b3f10 size 0x3d4 virtual true final false
  inline ::System::IAsyncResult* BeginGetRequestStream(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method BeginGetResponse addr 0x29b4354 size 0x2e0 virtual true final false
  inline ::System::IAsyncResult* BeginGetResponse(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method CanGetRequestStream addr 0x29b42e4 size 0x70 virtual false final false
  inline bool CanGetRequestStream();

  /// @brief Method EndGetRequestStream addr 0x29b4634 size 0x304 virtual true final false
  inline ::System::IO::Stream* EndGetRequestStream(::System::IAsyncResult* asyncResult);

  /// @brief Method EndGetResponse addr 0x29b4938 size 0x304 virtual true final false
  inline ::System::Net::WebResponse* EndGetResponse(::System::IAsyncResult* asyncResult);

  /// @brief Method GetResponse addr 0x29b4c3c size 0x370 virtual true final false
  inline ::System::Net::WebResponse* GetResponse();

  /// @brief Method GetRequestStreamCallback addr 0x29b4fac size 0x230 virtual false final false
  static inline void GetRequestStreamCallback(::System::Object* state);

  /// @brief Method GetResponseCallback addr 0x29b5278 size 0x324 virtual false final false
  static inline void GetResponseCallback(::System::Object* state);

  /// @brief Method UnblockReader addr 0x29b5868 size 0xd8 virtual false final false
  inline void UnblockReader();

  /// @brief Method get_UseDefaultCredentials addr 0x29b5940 size 0x24 virtual true final false
  inline bool get_UseDefaultCredentials();

  /// @brief Method Abort addr 0x29b5964 size 0x3b4 virtual true final false
  inline void Abort();
