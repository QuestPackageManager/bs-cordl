...
public:
  ...
  /// @brief Method AddPercentEncodedOctetToRawOctetsList, addr 0x2ed06a8, size 0x154, virtual false, abstract: false, final false
  inline bool AddPercentEncodedOctetToRawOctetsList(::System::Text::Encoding* encoding, ::StringW escapedCharacter);

  /// @brief Method AddSlashToAsteriskOnlyPath, addr 0x2ecf25c, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW AddSlashToAsteriskOnlyPath(::StringW path);

  /// @brief Method AppendOctetsPercentEncoded, addr 0x2ed07fc, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendUnicodeCodePointValuePercentEncoded, addr 0x2ed0394, size 0x314, virtual false, abstract: false, final false
  inline bool AppendUnicodeCodePointValuePercentEncoded(::StringW codePoint);

  /// @brief Method Build, addr 0x2ecf368, size 0xe8, virtual false, abstract: false, final false
  inline ::System::Uri* Build();

  /// @brief Method BuildRequestUriUsingCookedPath, addr 0x2ecf450, size 0x294, virtual false, abstract: false, final false
  inline void BuildRequestUriUsingCookedPath();

  /// @brief Method BuildRequestUriUsingRawPath, addr 0x2ecfc4c, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildRequestUriUsingRawPath, addr 0x2ecf6e4, size 0x384, virtual false, abstract: false, final false
  inline void BuildRequestUriUsingRawPath();

  /// @brief Method EmptyDecodeAndAppendRawOctetsList, addr 0x2ecffec, size 0x3a8, virtual false, abstract: false, final false
  inline bool EmptyDecodeAndAppendRawOctetsList(::System::Text::Encoding* encoding);

  /// @brief Method GetEncoding, addr 0x2ecfbe0, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* GetEncoding(::System::Net::__HttpListenerRequestUriBuilder__EncodingType type);

  /// @brief Method GetOctetsAsString, addr 0x2ed0b68, size 0x13d8, virtual false, abstract: false, final false
  static inline ::StringW GetOctetsAsString(::System::Collections::Generic::IEnumerable_1<uint8_t>* octets);

  /// @brief Method GetPath, addr 0x2ecfa70, size 0x170, virtual false, abstract: false, final false
  static inline ::StringW GetPath(::StringW uriString);

  /// @brief Method GetRequestUri, addr 0x2ecf2d8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method LogWarning, addr 0x2ecfa68, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseRawPath, addr 0x2ecfe9c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ecf190, size 0xcc, virtual false, abstract: false, final false
