...
public:
  ...
  /// @brief Method AddPercentEncodedOctetToRawOctetsList, addr 0x62c9e5c, size 0x160, virtual false, abstract: false, final false
  inline bool AddPercentEncodedOctetToRawOctetsList(::System::Text::Encoding* encoding, ::StringW escapedCharacter);

  /// @brief Method AddSlashToAsteriskOnlyPath, addr 0x62c8b00, size 0x6c, virtual false, abstract: false, final false
  static inline ::StringW AddSlashToAsteriskOnlyPath(::StringW path);

  /// @brief Method AppendOctetsPercentEncoded, addr 0x62c9fbc, size 0x34c, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendUnicodeCodePointValuePercentEncoded, addr 0x62c9b54, size 0x308, virtual false, abstract: false, final false
  inline bool AppendUnicodeCodePointValuePercentEncoded(::StringW codePoint);

  /// @brief Method Build, addr 0x62c8c00, size 0xe8, virtual false, abstract: false, final false
  inline ::System::Uri* Build();

  /// @brief Method BuildRequestUriUsingCookedPath, addr 0x62c8ce8, size 0x210, virtual false, abstract: false, final false
  inline void BuildRequestUriUsingCookedPath();

  /// @brief Method BuildRequestUriUsingRawPath, addr 0x62c9404, size 0x268, virtual false, abstract: false, final false
  inline ::System::Net::HttpListenerRequestUriBuilder_ParsingResult BuildRequestUriUsingRawPath(::System::Text::Encoding* encoding);

  /// @brief Method BuildRequestUriUsingRawPath, addr 0x62c8ef8, size 0x2f8, virtual false, abstract: false, final false
  inline void BuildRequestUriUsingRawPath();

  /// @brief Method EmptyDecodeAndAppendRawOctetsList, addr 0x62c97b0, size 0x3a4, virtual false, abstract: false, final false
  inline bool EmptyDecodeAndAppendRawOctetsList(::System::Text::Encoding* encoding);

  /// @brief Method GetEncoding, addr 0x62c9380, size 0x84, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* GetEncoding(::System::Net::HttpListenerRequestUriBuilder_EncodingType type);

  /// @brief Method GetOctetsAsString, addr 0x62ca308, size 0x3d4, virtual false, abstract: false, final false
  static inline ::StringW GetOctetsAsString(::System::Collections::Generic::IEnumerable_1<uint8_t>* octets);

  /// @brief Method GetPath, addr 0x62c91f4, size 0x18c, virtual false, abstract: false, final false
  static inline ::StringW GetPath(::StringW uriString);

  /// @brief Method GetRequestUri, addr 0x62c8b6c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method LogWarning, addr 0x62c91f0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseRawPath, addr 0x62c966c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62c8a54, size 0xac, virtual false, abstract: false, final false
