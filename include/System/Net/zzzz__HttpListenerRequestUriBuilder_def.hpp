...
/// @brief Method AddPercentEncodedOctetToRawOctetsList, addr 0x6257e50, size 0x160, virtual false, abstract: false, final false
inline bool AddPercentEncodedOctetToRawOctetsList(::System::Text::Encoding*  encoding, ::StringW  escapedCharacter) ;

/// @brief Method AddSlashToAsteriskOnlyPath, addr 0x6256af4, size 0x6c, virtual false, abstract: false, final false
static inline ::StringW AddSlashToAsteriskOnlyPath(::StringW  path) ;

/// @brief Method AppendOctetsPercentEncoded, addr 0x6257fb0, size 0x34c, virtual false, abstract: false, final false
...
/// @brief Method AppendUnicodeCodePointValuePercentEncoded, addr 0x6257b48, size 0x308, virtual false, abstract: false, final false
inline bool AppendUnicodeCodePointValuePercentEncoded(::StringW  codePoint) ;

/// @brief Method Build, addr 0x6256bf4, size 0xe8, virtual false, abstract: false, final false
inline ::System::Uri* Build() ;

/// @brief Method BuildRequestUriUsingCookedPath, addr 0x6256cdc, size 0x210, virtual false, abstract: false, final false
inline void BuildRequestUriUsingCookedPath() ;

/// @brief Method BuildRequestUriUsingRawPath, addr 0x62573f8, size 0x268, virtual false, abstract: false, final false
inline ::System::Net::HttpListenerRequestUriBuilder_ParsingResult BuildRequestUriUsingRawPath(::System::Text::Encoding*  encoding) ;

/// @brief Method BuildRequestUriUsingRawPath, addr 0x6256eec, size 0x2f8, virtual false, abstract: false, final false
inline void BuildRequestUriUsingRawPath() ;

/// @brief Method EmptyDecodeAndAppendRawOctetsList, addr 0x62577a4, size 0x3a4, virtual false, abstract: false, final false
inline bool EmptyDecodeAndAppendRawOctetsList(::System::Text::Encoding*  encoding) ;

/// @brief Method GetEncoding, addr 0x6257374, size 0x84, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* GetEncoding(::System::Net::HttpListenerRequestUriBuilder_EncodingType  type) ;

/// @brief Method GetOctetsAsString, addr 0x62582fc, size 0x3d4, virtual false, abstract: false, final false
static inline ::StringW GetOctetsAsString(::System::Collections::Generic::IEnumerable_1<uint8_t>*  octets) ;

/// @brief Method GetPath, addr 0x62571e8, size 0x18c, virtual false, abstract: false, final false
static inline ::StringW GetPath(::StringW  uriString) ;

/// @brief Method GetRequestUri, addr 0x6256b60, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method LogWarning, addr 0x62571e4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ParseRawPath, addr 0x6257660, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6256a48, size 0xac, virtual false, abstract: false, final false
