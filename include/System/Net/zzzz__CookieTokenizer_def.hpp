...
public:
  ...
  /// @brief Method IsEqualTo, addr 0x2a98e74, size 0x24, virtual false, abstract: false, final false
  inline bool IsEqualTo(::StringW value);

  /// @brief Method .ctor, addr 0x2a991a8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Net::CookieToken token);

  /// @brief Method get_Token, addr 0x2a991b4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Extract, addr 0x2a98824, size 0x88, virtual false, abstract: false, final false
  inline ::StringW Extract();

  /// @brief Method FindNext, addr 0x2a988ac, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Next, addr 0x2a98b50, size 0x100, virtual false, abstract: false, final false
  inline ::System::Net::CookieToken Next(bool first, bool parseResponseCookies);

  /// @brief Method Reset, addr 0x2a98c50, size 0x68, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method TokenFromName, addr 0x2a98cb8, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a98784, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EndOfCookie, addr 0x2a987bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_EndOfCookie();

  /// @brief Method get_Eof, addr 0x2a987d0, size 0x10, virtual false, abstract: false, final false
  inline bool get_Eof();

  /// @brief Method get_Name, addr 0x2a987e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Quoted, addr 0x2a987f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_Quoted();

  /// @brief Method get_Token, addr 0x2a98804, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::CookieToken get_Token();

  /// @brief Method get_Value, addr 0x2a98814, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_EndOfCookie, addr 0x2a987c4, size 0xc, virtual false, abstract: false, final false
  inline void set_EndOfCookie(bool value);

  /// @brief Method set_Name, addr 0x2a987e8, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Quoted, addr 0x2a987f8, size 0xc, virtual false, abstract: false, final false
  inline void set_Quoted(bool value);

  /// @brief Method set_Token, addr 0x2a9880c, size 0x8, virtual false, abstract: false, final false
  inline void set_Token(::System::Net::CookieToken value);

  /// @brief Method set_Value, addr 0x2a9881c, size 0x8, virtual false, abstract: false, final false
