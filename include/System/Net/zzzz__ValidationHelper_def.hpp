...
public:
  ...
  /// @brief Method MakeStringNull, addr 0x299dde8, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW MakeStringNull(::StringW stringValue);

  /// @brief Method IsBlankString, addr 0x299ddfc, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsBlankString(::StringW stringValue);

  /// @brief Method ValidateTcpPort, addr 0x299de18, size 0xc, virtual false, abstract: false, final false
