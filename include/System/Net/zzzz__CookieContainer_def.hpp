...
public:
  ...
  /// @brief Method Add, addr 0x62da050, size 0x7f4, virtual false, abstract: false, final false
  inline void Add(::System::Net::Cookie* cookie, bool throwOnError);

  /// @brief Method AddRemoveDomain, addr 0x62d9f30, size 0x120, virtual false, abstract: false, final false
  inline void AddRemoveDomain(::StringW key, ::System::Net::PathList* value);

  /// @brief Method AgeCookies, addr 0x62dae54, size 0x1384, virtual false, abstract: false, final false
  inline bool AgeCookies(::StringW domain);

  /// @brief Method BuildCookieCollectionFromDomainMatches, addr 0x62dd12c, size 0x79c, virtual false, abstract: false, final false
  ...
  /// @brief Method CookieCutter, addr 0x62dc5a0, size 0x6d8, virtual false, abstract: false, final false
  inline ::System::Net::CookieCollection* CookieCutter(::System::Uri* uri, ::StringW headerName, ::StringW setCookieHeader, bool isThrow);

  /// @brief Method ExpireCollection, addr 0x62dc21c, size 0x178, virtual false, abstract: false, final false
  inline int32_t ExpireCollection(::System::Net::CookieCollection* cc);

  /// @brief Method GetCookieHeader, addr 0x62ddae8, size 0xbc, virtual false, abstract: false, final false
  inline ::StringW GetCookieHeader(::System::Uri* uri);

  /// @brief Method GetCookieHeader, addr 0x62ddba4, size 0x38c, virtual false, abstract: false, final false
  inline ::StringW GetCookieHeader(::System::Uri* uri, ::ByRef<::StringW> optCookie2);

  /// @brief Method InternalGetCookies, addr 0x62dcc78, size 0x4b4, virtual false, abstract: false, final false
  inline ::System::Net::CookieCollection* InternalGetCookies(::System::Uri* uri);

  /// @brief Method IsLocalDomain, addr 0x62dc3b4, size 0x1ec, virtual false, abstract: false, final false
  inline bool IsLocalDomain(::StringW host);

  /// @brief Method MergeUpdateCollections, addr 0x62dd8e8, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62d9e54, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor();
