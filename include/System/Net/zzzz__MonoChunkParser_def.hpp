...
public:
  ...
  /// @brief Method Read, addr 0x2f04620, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f0511c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetChunkSize, addr 0x2f047dc, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalWrite, addr 0x2f046a0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2f04304, size 0x4, virtual false, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method ReadBody, addr 0x2f04ae4, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCRLF, addr 0x2f04c1c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFromChunks, addr 0x2f04308, size 0x318, virtual false, abstract: false, final false
  inline int32_t ReadFromChunks(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method ReadTrailer, addr 0x2f04d1c, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveChunkExtension, addr 0x2f0519c, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW RemoveChunkExtension(::StringW input);

  /// @brief Method ThrowProtocolViolation, addr 0x2f05144, size 0x58, virtual false, abstract: false, final false
  static inline void ThrowProtocolViolation(::StringW message);

  /// @brief Method Write, addr 0x2f04680, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f0424c, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebHeaderCollection* headers);

  /// @brief Method get_ChunkLeft, addr 0x2f05110, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_ChunkLeft();

  /// @brief Method get_DataAvailable, addr 0x2f05010, size 0x100, virtual false, abstract: false, final false
  inline bool get_DataAvailable();

  /// @brief Method get_WantMore, addr 0x2f04fe8, size 0x28, virtual false, abstract: false, final false
