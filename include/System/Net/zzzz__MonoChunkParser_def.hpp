...
/// @brief Method Read, addr 0x61854a4, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6185fdc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetChunkSize, addr 0x6185664, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method InternalWrite, addr 0x6185524, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x61851b0, size 0x4, virtual false, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method ReadBody, addr 0x618596c, size 0x130, virtual false, abstract: false, final false
inline ::System::Net::MonoChunkParser_State ReadBody(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, ::ByRef<int32_t>  offset, int32_t  size) ;

/// @brief Method ReadCRLF, addr 0x6185a9c, size 0x114, virtual false, abstract: false, final false
inline ::System::Net::MonoChunkParser_State ReadCRLF(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, ::ByRef<int32_t>  offset, int32_t  size) ;

/// @brief Method ReadFromChunks, addr 0x61851b4, size 0x2f0, virtual false, abstract: false, final false
inline int32_t ReadFromChunks(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method ReadTrailer, addr 0x6185bb0, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method RemoveChunkExtension, addr 0x6186034, size 0x50, virtual false, abstract: false, final false
static inline ::StringW RemoveChunkExtension(::StringW  input) ;

/// @brief Method ThrowProtocolViolation, addr 0x6185fe4, size 0x50, virtual false, abstract: false, final false
static inline void ThrowProtocolViolation(::StringW  message) ;

/// @brief Method Write, addr 0x6185504, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6185108, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::System::Net::WebHeaderCollection*  headers) ;

/// @brief Method get_ChunkLeft, addr 0x6185fd0, size 0xc, virtual false, abstract: false, final false
inline int32_t get_ChunkLeft() ;

/// @brief Method get_DataAvailable, addr 0x6185ecc, size 0x104, virtual false, abstract: false, final false
inline bool get_DataAvailable() ;

/// @brief Method get_WantMore, addr 0x6185ea8, size 0x24, virtual false, abstract: false, final false
