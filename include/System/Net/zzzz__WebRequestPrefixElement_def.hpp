...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WebRequestPrefixElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WebRequestPrefixElement(WebRequestPrefixElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WebRequestPrefixElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WebRequestPrefixElement(WebRequestPrefixElementconst&) = delete;
