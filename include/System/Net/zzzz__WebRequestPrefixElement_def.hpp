...
public:
  ...
  /// @brief Method .ctor, addr 0x44a1918, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW P, ::System::Net::IWebRequestCreate* C);

  /// @brief Method get_Creator, addr 0x44a1718, size 0x1f8, virtual false, abstract: false, final false
  inline ::System::Net::IWebRequestCreate* get_Creator();

  /// @brief Method set_Creator, addr 0x44a1910, size 0x8, virtual false, abstract: false, final false
