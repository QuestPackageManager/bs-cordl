...
public:
  ...
  /// @brief Method .ctor, addr 0x62cb200, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW P, ::System::Net::IWebRequestCreate* C);

  /// @brief Method get_Creator, addr 0x62cb010, size 0x1e8, virtual false, abstract: false, final false
  inline ::System::Net::IWebRequestCreate* get_Creator();

  /// @brief Method set_Creator, addr 0x62cb1f8, size 0x8, virtual false, abstract: false, final false
