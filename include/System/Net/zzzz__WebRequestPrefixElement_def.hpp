...
public:
  ...
  /// @brief Method get_Creator addr 0x299e2b8 size 0x1fc virtual false final false
  inline ::System::Net::IWebRequestCreate* get_Creator();

  /// @brief Method set_Creator addr 0x299e4b4 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x299e4bc size 0x2c virtual false final false
