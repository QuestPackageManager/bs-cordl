...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TcpValidationHelpers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TcpValidationHelpers(TcpValidationHelpers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TcpValidationHelpers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TcpValidationHelpers(TcpValidationHelpersconst&) = delete;
