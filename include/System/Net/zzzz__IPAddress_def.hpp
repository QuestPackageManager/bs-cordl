...
public:
  ...
  /// @brief Method get_IsIPv4 addr 0x280cf10 size 0x10 virtual false final false
  inline bool get_IsIPv4();

  /// @brief Method get_IsIPv6 addr 0x280cf20 size 0x10 virtual false final false
  inline bool get_IsIPv6();

  /// @brief Method get_PrivateAddress addr 0x280cf30 size 0x8 virtual false final false
  inline uint32_t get_PrivateAddress();

  /// @brief Method set_PrivateAddress addr 0x280cf38 size 0x10 virtual false final false
  inline void set_PrivateAddress(uint32_t value);

  /// @brief Method get_PrivateScopeId addr 0x280cf48 size 0x8 virtual false final false
  inline uint32_t get_PrivateScopeId();

  /// @brief Method set_PrivateScopeId addr 0x280cf50 size 0x10 virtual false final false
  inline void set_PrivateScopeId(uint32_t value);

  static inline ::System::Net::IPAddress* New_ctor(int64_t newAddress);

  /// @brief Method .ctor addr 0x280cf60 size 0x84 virtual false final false
  ...
  /// @brief Method .ctor addr 0x280cfe4 size 0x7c virtual false final false
  ...
  /// @brief Method .ctor addr 0x280d0b0 size 0x184 virtual false final false
  ...
  /// @brief Method .ctor addr 0x280d234 size 0xb8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x280d2ec size 0x34 virtual false final false
  ...
  /// @brief Method .ctor addr 0x280d320 size 0x6c virtual false final false
  ...
  /// @brief Method .ctor addr 0x280d38c size 0x150 virtual false final false
  inline void _ctor(::System::ReadOnlySpan_1<uint8_t> address);

  /// @brief Method TryParse addr 0x280d4dc size 0x6c virtual false final false
  static inline bool TryParse(::StringW ipString, ByRef<::System::Net::IPAddress*> address);

  /// @brief Method Parse addr 0x280d744 size 0x9c virtual false final false
  static inline ::System::Net::IPAddress* Parse(::StringW ipString);

  /// @brief Method TryWriteBytes addr 0x280d7e0 size 0x118 virtual false final false
  inline bool TryWriteBytes(::System::Span_1<uint8_t> destination, ByRef<int32_t> bytesWritten);

  /// @brief Method WriteIPv6Bytes addr 0x280d8f8 size 0x8c virtual false final false
  inline void WriteIPv6Bytes(::System::Span_1<uint8_t> destination);

  /// @brief Method WriteIPv4Bytes addr 0x280d984 size 0x4c virtual false final false
  inline void WriteIPv4Bytes(::System::Span_1<uint8_t> destination);

  /// @brief Method GetAddressBytes addr 0x280d9d0 size 0x154 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetAddressBytes();

  /// @brief Method get_AddressFamily addr 0x280db24 size 0x18 virtual false final false
  inline ::System::Net::Sockets::AddressFamily get_AddressFamily();

  /// @brief Method get_ScopeId addr 0x280db3c size 0x58 virtual false final false
  inline int64_t get_ScopeId();

  /// @brief Method ToString addr 0x280db94 size 0x98 virtual true final false
  inline ::StringW ToString();

  /// @brief Method IsLoopback addr 0x280dca0 size 0xc8 virtual false final false
  static inline bool IsLoopback(::System::Net::IPAddress* address);

  /// @brief Method get_IsIPv6Multicast addr 0x280dd68 size 0x34 virtual false final false
  inline bool get_IsIPv6Multicast();

  /// @brief Method Equals addr 0x280dd9c size 0x134 virtual false final false
  inline bool Equals(::System::Object* comparandObj, bool compareScopeId);

  /// @brief Method Equals addr 0x280ded0 size 0x8 virtual true final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetHashCode addr 0x280ded8 size 0x468 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method MapToIPv6 addr 0x280e340 size 0xe0 virtual false final false
  inline ::System::Net::IPAddress* MapToIPv6();

  /// @brief Method ThrowAddressNullException addr 0x280d060 size 0x50 virtual false final false
