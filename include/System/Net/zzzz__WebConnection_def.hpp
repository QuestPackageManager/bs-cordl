...
public:
  ...
  /// @brief Method .ctor addr 0x29ddd58 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Connect>b__16_0 addr 0x29ddd60 size 0xa0 virtual false final false
  ...
  /// @brief Method <Connect>b__16_1 addr 0x29dde00 size 0xf4 virtual false final false
...
public:
  ...
  /// @brief Method MoveNext addr 0x29ddef4 size 0x8c0 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x29de7f8 size 0xc virtual true final true
...
public:
  ...
  /// @brief Method MoveNext addr 0x29de804 size 0x66c virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x29def80 size 0x58 virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext addr 0x29defd8 size 0x4cc virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x29df650 size 0x58 virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method get_ServicePoint addr 0x29dcb34 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29db9c0 size 0x28 virtual false final false
  inline void _ctor(::System::Net::ServicePoint* sPoint);

  /// @brief Method CanReuse addr 0x29dcb3c size 0x30 virtual false final false
  inline bool CanReuse();

  /// @brief Method CheckReusable addr 0x29dcb6c size 0x9c virtual false final false
  inline bool CheckReusable();

  /// @brief Method Connect addr 0x29dcc08 size 0xe4 virtual false final false
  ...
  /// @brief Method CreateStream addr 0x29dccec size 0x120 virtual false final false
  ...
  /// @brief Method InitConnection addr 0x29dce0c size 0x104 virtual false final false
  ...
  /// @brief Method GetException addr 0x29dcf10 size 0x188 virtual false final false
  static inline ::System::Net::WebException* GetException(::System::Net::WebExceptionStatus status, ::System::Exception* error);

  /// @brief Method ReadLine addr 0x29dd098 size 0x1e8 virtual false final false
  static inline bool ReadLine(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, ByRef<int32_t> start, int32_t max, ByRef<::StringW> output);

  /// @brief Method CanReuseConnection addr 0x29db3a0 size 0x42c virtual false final false
  inline bool CanReuseConnection(::System::Net::WebOperation* operation);

  /// @brief Method PrepareSharingNtlm addr 0x29dd280 size 0x31c virtual false final false
  inline bool PrepareSharingNtlm(::System::Net::WebOperation* operation);

  /// @brief Method Reset addr 0x29dd59c size 0xb8 virtual false final false
  inline void Reset();

  /// @brief Method Close addr 0x29dd660 size 0xc8 virtual false final false
  inline void Close(bool reset);

  /// @brief Method CloseSocket addr 0x29dd728 size 0x26c virtual false final false
  inline void CloseSocket();

  /// @brief Method get_Closed addr 0x29dafec size 0x10 virtual false final false
  inline bool get_Closed();

  /// @brief Method get_IdleSince addr 0x29dd994 size 0x8 virtual false final false
  inline ::System::DateTime get_IdleSince();

  /// @brief Method StartOperation addr 0x29db7cc size 0x1f4 virtual false final false
  inline bool StartOperation(::System::Net::WebOperation* operation, bool reused);

  /// @brief Method Continue addr 0x29da188 size 0x160 virtual false final false
  inline bool Continue(::System::Net::WebOperation* next);

  /// @brief Method Dispose addr 0x29ddc84 size 0x38 virtual false final false
  inline void Dispose(bool disposing);

  /// @brief Method Dispose addr 0x29dafe4 size 0x8 virtual true final true
  inline void Dispose();

  /// @brief Method ResetNtlm addr 0x29dd654 size 0xc virtual false final false
  inline void ResetNtlm();

  /// @brief Method get_NtlmAuthenticated addr 0x29ddcbc size 0x8 virtual false final false
  inline bool get_NtlmAuthenticated();

  /// @brief Method set_NtlmAuthenticated addr 0x29ddcc4 size 0xc virtual false final false
  inline void set_NtlmAuthenticated(bool value);

  /// @brief Method get_NtlmCredential addr 0x29ddcd0 size 0x8 virtual false final false
  inline ::System::Net::NetworkCredential* get_NtlmCredential();

  /// @brief Method set_NtlmCredential addr 0x29ddcd8 size 0x8 virtual false final false
  inline void set_NtlmCredential(::System::Net::NetworkCredential* value);

  /// @brief Method get_UnsafeAuthenticatedConnectionSharing addr 0x29ddce0 size 0x8 virtual false final false
  inline bool get_UnsafeAuthenticatedConnectionSharing();

  /// @brief Method set_UnsafeAuthenticatedConnectionSharing addr 0x29ddce8 size 0xc virtual false final false
