...
namespace System::Net {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(3391)), TypeDefinitionIndex(TypeDefinitionIndex(3396))]
// Self: TypeDefinitionIndex(TypeDefinitionIndex(7058))
...
public:
  ...
  /// @brief Method MoveNext, addr 0x299e2e0, size 0x30c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x299e5ec, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x299e65c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_ClientCertificates>b__114_0, addr 0x299e664, size 0x5c, virtual false, abstract: false, final false
...
namespace System::Net {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2368)), TypeDefinitionIndex(TypeDefinitionIndex(7057)), TypeDefinitionIndex(TypeDefinitionIndex(7106))]
...
public:
  ...
  /// @brief Method get_MethodInfo, addr 0x29989b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::FtpMethodInfo* get_MethodInfo();

  /// @brief Method get_Method, addr 0x29989b8, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method set_Method, addr 0x29989d4, size 0x1ac, virtual true, abstract: false, final false
  inline void set_Method(::StringW value);

  /// @brief Method get_RenameTo, addr 0x2998b98, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_RenameTo();

  /// @brief Method get_Credentials, addr 0x2998ba0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::ICredentials* get_Credentials();

  /// @brief Method set_Credentials, addr 0x2998ba8, size 0x150, virtual true, abstract: false, final false
  inline void set_Credentials(::System::Net::ICredentials* value);

  /// @brief Method get_RequestUri, addr 0x2998cf8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Uri* get_RequestUri();

  /// @brief Method get_Timeout, addr 0x2998d00, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Timeout();

  /// @brief Method set_Timeout, addr 0x2998d08, size 0xd8, virtual true, abstract: false, final false
  inline void set_Timeout(int32_t value);

  /// @brief Method get_RemainingTimeout, addr 0x2998de0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RemainingTimeout();

  /// @brief Method get_ReadWriteTimeout, addr 0x2998de8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ReadWriteTimeout();

  /// @brief Method get_ContentOffset, addr 0x2998df0, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_ContentOffset();

  /// @brief Method get_ContentLength, addr 0x2998df8, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_ContentLength();

  /// @brief Method set_ContentLength, addr 0x2998e00, size 0x8, virtual true, abstract: false, final false
  inline void set_ContentLength(int64_t value);

  /// @brief Method get_Proxy, addr 0x2998e08, size 0x8, virtual true, abstract: false, final false
  inline ::System::Net::IWebProxy* get_Proxy();

  /// @brief Method set_Proxy, addr 0x2998e10, size 0x68, virtual true, abstract: false, final false
  inline void set_Proxy(::System::Net::IWebProxy* value);

  /// @brief Method set_ConnectionGroupName, addr 0x2998e78, size 0x6c, virtual true, abstract: false, final false
  inline void set_ConnectionGroupName(::StringW value);

  /// @brief Method get_Aborted, addr 0x2998ee4, size 0x8, virtual false, abstract: false, final false
  inline bool get_Aborted();

  static inline ::System::Net::FtpWebRequest* New_ctor(::System::Uri* uri);

  /// @brief Method .ctor, addr 0x2998eec, size 0x3c0, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* uri);

  /// @brief Method GetResponse, addr 0x29992ac, size 0x7ac, virtual true, abstract: false, final false
  inline ::System::Net::WebResponse* GetResponse();

  /// @brief Method BeginGetResponse, addr 0x299abc0, size 0x6c0, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginGetResponse(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method EndGetResponse, addr 0x299b280, size 0x40c, virtual true, abstract: false, final false
  inline ::System::Net::WebResponse* EndGetResponse(::System::IAsyncResult* asyncResult);

  /// @brief Method BeginGetRequestStream, addr 0x299b68c, size 0x53c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginGetRequestStream(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method EndGetRequestStream, addr 0x299bbc8, size 0x470, virtual true, abstract: false, final false
  inline ::System::IO::Stream* EndGetRequestStream(::System::IAsyncResult* asyncResult);

  /// @brief Method SubmitRequest, addr 0x2999ea0, size 0x4ec, virtual false, abstract: false, final false
  inline void SubmitRequest(bool isAsync);

  /// @brief Method TranslateConnectException, addr 0x299c928, size 0x104, virtual false, abstract: false, final false
  inline ::System::Exception* TranslateConnectException(::System::Exception* e);

  /// @brief Method CreateConnectionAsync, addr 0x299c038, size 0x94, virtual false, abstract: false, final false
  inline void CreateConnectionAsync();

  /// @brief Method CreateConnection, addr 0x299c0cc, size 0x164, virtual false, abstract: false, final false
  inline ::System::Net::FtpControlStream* CreateConnection();

  /// @brief Method TimedSubmitRequestHelper, addr 0x299c280, size 0x428, virtual false, abstract: false, final false
  inline ::System::IO::Stream* TimedSubmitRequestHelper(bool isAsync);

  /// @brief Method TimerCallback, addr 0x299ca98, size 0xfc, virtual false, abstract: false, final false
  inline void TimerCallback(::System::Net::__TimerThread__Timer* timer, int32_t timeNoticed, ::System::Object* context);

  /// @brief Method get_TimerQueue, addr 0x299ca2c, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Net::__TimerThread__Queue* get_TimerQueue();

  /// @brief Method AttemptedRecovery, addr 0x299c6a8, size 0x280, virtual false, abstract: false, final false
  inline bool AttemptedRecovery(::System::Exception* e);

  /// @brief Method SetException, addr 0x299a87c, size 0x344, virtual false, abstract: false, final false
  inline void SetException(::System::Exception* exception);

  /// @brief Method CheckError, addr 0x2999a58, size 0x14, virtual false, abstract: false, final false
  inline void CheckError();

  /// @brief Method RequestCallback, addr 0x2990aec, size 0x10, virtual false, abstract: false, final false
  inline void RequestCallback(::System::Object* obj);

  /// @brief Method SyncRequestCallback, addr 0x299d604, size 0x3d0, virtual false, abstract: false, final false
  inline void SyncRequestCallback(::System::Object* obj);

  /// @brief Method AsyncRequestCallback, addr 0x299cba4, size 0xa60, virtual false, abstract: false, final false
  inline void AsyncRequestCallback(::System::Object* obj);

  /// @brief Method FinishRequestStage, addr 0x2999a6c, size 0x434, virtual false, abstract: false, final false
  inline ::System::Net::__FtpWebRequest__RequestStage FinishRequestStage(::System::Net::__FtpWebRequest__RequestStage stage);

  /// @brief Method Abort, addr 0x299d9d4, size 0x48c, virtual true, abstract: false, final false
  inline void Abort();

  /// @brief Method set_CachePolicy, addr 0x299de60, size 0x68, virtual true, abstract: false, final false
  inline void set_CachePolicy(::System::Net::Cache::RequestCachePolicy* value);

  /// @brief Method get_UseBinary, addr 0x299dec8, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseBinary();

  /// @brief Method get_UsePassive, addr 0x299ded0, size 0x8, virtual false, abstract: false, final false
  inline bool get_UsePassive();

  /// @brief Method get_ClientCertificates, addr 0x29935c8, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates();

  /// @brief Method get_EnableSsl, addr 0x299ded8, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableSsl();

  /// @brief Method get_Headers, addr 0x299dee0, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_UseDefaultCredentials, addr 0x299df4c, size 0x28, virtual true, abstract: false, final false
  inline bool get_UseDefaultCredentials();

  /// @brief Method set_PreAuthenticate, addr 0x299df74, size 0x28, virtual true, abstract: false, final false
  inline void set_PreAuthenticate(bool value);

  /// @brief Method get_InUse, addr 0x2998b80, size 0x18, virtual false, abstract: false, final false
  inline bool get_InUse();

  /// @brief Method EnsureFtpWebResponse, addr 0x299a38c, size 0x4f0, virtual false, abstract: false, final false
  inline void EnsureFtpWebResponse(::System::Exception* exception);

  /// @brief Method DataStreamClosed, addr 0x299e14c, size 0x80, virtual false, abstract: false, final false
