...
public:
  ...
  /// @brief Method AddByte, addr 0x625f8b8, size 0xa4, virtual false, abstract: false, final false
  inline void AddByte(uint8_t b);

  /// @brief Method AddChar, addr 0x625f95c, size 0x60, virtual false, abstract: false, final false
  inline void AddChar(char16_t ch);

  /// @brief Method FlushBytes, addr 0x625fb44, size 0x60, virtual false, abstract: false, final false
  inline void FlushBytes();

  /// @brief Method GetString, addr 0x625f9bc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x625f818, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetNextUnicodeScalarValueFromUtf16Surrogate, addr 0x625f568, size 0xa4, virtual false, abstract: false, final false
  static inline int32_t GetNextUnicodeScalarValueFromUtf16Surrogate(::ByRef<char16_t*> pch, ::ByRef<int32_t> charsRemaining);

  /// @brief Method HexToInt, addr 0x625f884, size 0x34, virtual false, abstract: false, final false
  static inline int32_t HexToInt(char16_t h);

  /// @brief Method HtmlEncode, addr 0x625ee9c, size 0x128, virtual false, abstract: false, final false
  static inline ::StringW HtmlEncode(::StringW value);

  /// @brief Method HtmlEncode, addr 0x625f0dc, size 0x3a0, virtual false, abstract: false, final false
  static inline void HtmlEncode(::StringW value, ::System::IO::TextWriter* output);

  /// @brief Method IndexOfHtmlEncodingChars, addr 0x625efc4, size 0x118, virtual false, abstract: false, final false
  static inline int32_t IndexOfHtmlEncodingChars(::StringW s, int32_t startPos);

  /// @brief Method UrlDecode, addr 0x625fa0c, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW UrlDecode(::StringW encodedValue);

  /// @brief Method UrlDecodeInternal, addr 0x625f60c, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HtmlEncodeConformance, addr 0x625f47c, size 0xec, virtual false, abstract: false, final false
