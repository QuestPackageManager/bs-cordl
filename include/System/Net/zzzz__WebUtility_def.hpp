...
public:
  ...
  /// @brief Method AddByte, addr 0x2ed72a0, size 0x98, virtual false, abstract: false, final false
  inline void AddByte(uint8_t b);

  /// @brief Method AddChar, addr 0x2ed7338, size 0x60, virtual false, abstract: false, final false
  inline void AddChar(char16_t ch);

  /// @brief Method FlushBytes, addr 0x2ed7550, size 0x60, virtual false, abstract: false, final false
  inline void FlushBytes();

  /// @brief Method GetString, addr 0x2ed7398, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ed71dc, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetNextUnicodeScalarValueFromUtf16Surrogate, addr 0x2ed6f14, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method HexToInt, addr 0x2ed7250, size 0x50, virtual false, abstract: false, final false
  static inline int32_t HexToInt(char16_t h);

  /// @brief Method HtmlEncode, addr 0x2ed6814, size 0x120, virtual false, abstract: false, final false
  static inline ::StringW HtmlEncode(::StringW value);

  /// @brief Method HtmlEncode, addr 0x2ed6a7c, size 0x3b4, virtual false, abstract: false, final false
  static inline void HtmlEncode(::StringW value, ::System::IO::TextWriter* output);

  /// @brief Method IndexOfHtmlEncodingChars, addr 0x2ed6934, size 0x148, virtual false, abstract: false, final false
  static inline int32_t IndexOfHtmlEncodingChars(::StringW s, int32_t startPos);

  /// @brief Method UrlDecode, addr 0x2ed7420, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW UrlDecode(::StringW encodedValue);

  /// @brief Method UrlDecodeInternal, addr 0x2ed6fcc, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HtmlEncodeConformance, addr 0x2ed6e30, size 0xe4, virtual false, abstract: false, final false
