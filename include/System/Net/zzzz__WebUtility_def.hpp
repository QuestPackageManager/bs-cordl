...
public:
  ...
  /// @brief Method AddByte, addr 0x44a84ec, size 0x98, virtual false, abstract: false, final false
  inline void AddByte(uint8_t b);

  /// @brief Method AddChar, addr 0x44a8584, size 0x60, virtual false, abstract: false, final false
  inline void AddChar(char16_t ch);

  /// @brief Method FlushBytes, addr 0x44a879c, size 0x60, virtual false, abstract: false, final false
  inline void FlushBytes();

  /// @brief Method GetString, addr 0x44a85e4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44a8428, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetNextUnicodeScalarValueFromUtf16Surrogate, addr 0x44a814c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method HexToInt, addr 0x44a849c, size 0x50, virtual false, abstract: false, final false
  static inline int32_t HexToInt(char16_t h);

  /// @brief Method HtmlEncode, addr 0x44a7a58, size 0x120, virtual false, abstract: false, final false
  static inline ::StringW HtmlEncode(::StringW value);

  /// @brief Method HtmlEncode, addr 0x44a7cc0, size 0x3a8, virtual false, abstract: false, final false
  static inline void HtmlEncode(::StringW value, ::System::IO::TextWriter* output);

  /// @brief Method IndexOfHtmlEncodingChars, addr 0x44a7b78, size 0x148, virtual false, abstract: false, final false
  static inline int32_t IndexOfHtmlEncodingChars(::StringW s, int32_t startPos);

  /// @brief Method UrlDecode, addr 0x44a866c, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW UrlDecode(::StringW encodedValue);

  /// @brief Method UrlDecodeInternal, addr 0x44a8204, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HtmlEncodeConformance, addr 0x44a8068, size 0xe4, virtual false, abstract: false, final false
