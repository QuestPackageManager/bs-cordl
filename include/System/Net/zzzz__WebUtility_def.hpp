...
public:
  ...
  /// @brief Method AddByte, addr 0x44aa110, size 0x98, virtual false, abstract: false, final false
  inline void AddByte(uint8_t b);

  /// @brief Method AddChar, addr 0x44aa1a8, size 0x60, virtual false, abstract: false, final false
  inline void AddChar(char16_t ch);

  /// @brief Method FlushBytes, addr 0x44aa3c0, size 0x60, virtual false, abstract: false, final false
  inline void FlushBytes();

  /// @brief Method GetString, addr 0x44aa208, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44aa04c, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetNextUnicodeScalarValueFromUtf16Surrogate, addr 0x44a9d70, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method HexToInt, addr 0x44aa0c0, size 0x50, virtual false, abstract: false, final false
  static inline int32_t HexToInt(char16_t h);

  /// @brief Method HtmlEncode, addr 0x44a967c, size 0x120, virtual false, abstract: false, final false
  static inline ::StringW HtmlEncode(::StringW value);

  /// @brief Method HtmlEncode, addr 0x44a98e4, size 0x3a8, virtual false, abstract: false, final false
  static inline void HtmlEncode(::StringW value, ::System::IO::TextWriter* output);

  /// @brief Method IndexOfHtmlEncodingChars, addr 0x44a979c, size 0x148, virtual false, abstract: false, final false
  static inline int32_t IndexOfHtmlEncodingChars(::StringW s, int32_t startPos);

  /// @brief Method UrlDecode, addr 0x44aa290, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW UrlDecode(::StringW encodedValue);

  /// @brief Method UrlDecodeInternal, addr 0x44a9e28, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HtmlEncodeConformance, addr 0x44a9c8c, size 0xe4, virtual false, abstract: false, final false
