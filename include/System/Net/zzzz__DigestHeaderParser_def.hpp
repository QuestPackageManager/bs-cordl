...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DigestHeaderParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DigestHeaderParser(DigestHeaderParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DigestHeaderParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DigestHeaderParser(DigestHeaderParserconst&) = delete;
