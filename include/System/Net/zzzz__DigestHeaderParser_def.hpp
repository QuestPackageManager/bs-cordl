...
public:
  ...
  /// @brief Method GetKey, addr 0x2aa963c, size 0x90, virtual false, abstract: false, final false
  inline ::StringW GetKey();

  /// @brief Method GetKeywordAndValue, addr 0x2aa942c, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x2aa9250, size 0x1dc, virtual false, abstract: false, final false
  inline bool Parse();

  /// @brief Method SkipWhitespace, addr 0x2aa95bc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2aa90c4, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW header);

  static inline ::ArrayW<::StringW, ::Array<::StringW>*> getStaticF_keywords();

  /// @brief Method get_Algorithm, addr 0x2aa91f8, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Algorithm();

  /// @brief Method get_Nonce, addr 0x2aa91cc, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Nonce();

  /// @brief Method get_Opaque, addr 0x2aa91a0, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Opaque();

  /// @brief Method get_QOP, addr 0x2aa9224, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_QOP();

  /// @brief Method get_Realm, addr 0x2aa9178, size 0x28, virtual false, abstract: false, final false
