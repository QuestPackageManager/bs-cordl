...
public:
  ...
  /// @brief Method GetKey, addr 0x62e6c38, size 0x90, virtual false, abstract: false, final false
  inline ::StringW GetKey();

  /// @brief Method GetKeywordAndValue, addr 0x62e6a1c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x62e6868, size 0x1b4, virtual false, abstract: false, final false
  inline bool Parse();

  /// @brief Method SkipWhitespace, addr 0x62e6ba0, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62e66e0, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::StringW header);

  static inline ::ArrayW<::StringW, ::Array<::StringW>*> getStaticF_keywords();

  /// @brief Method get_Algorithm, addr 0x62e6810, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Algorithm();

  /// @brief Method get_Nonce, addr 0x62e67e4, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Nonce();

  /// @brief Method get_Opaque, addr 0x62e67b8, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Opaque();

  /// @brief Method get_QOP, addr 0x62e683c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_QOP();

  /// @brief Method get_Realm, addr 0x62e6790, size 0x28, virtual false, abstract: false, final false
