...
public:
  ...
  /// @brief Method .ctor addr 0x2839360 size 0x14 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x2839374 size 0xb4 virtual false final false
  ...
  /// @brief Method get_Credentials addr 0x2839660 size 0x8 virtual true final true
  inline ::System::Net::ICredentials* get_Credentials();

  /// @brief Method get_UseDefaultCredentials addr 0x2839668 size 0x7c virtual false final false
  inline bool get_UseDefaultCredentials();

  /// @brief Method set_UseDefaultCredentials addr 0x28396e4 size 0x78 virtual false final false
  inline void set_UseDefaultCredentials(bool value);

  /// @brief Method GetProxy addr 0x283975c size 0x190 virtual true final true
  inline ::System::Uri* GetProxy(::System::Uri* destination);

  /// @brief Method UpdateRegExList addr 0x2839428 size 0x238 virtual false final false
  inline void UpdateRegExList(bool canThrow);

  /// @brief Method IsMatchInBypassList addr 0x2839b3c size 0x198 virtual false final false
  inline bool IsMatchInBypassList(::System::Uri* input);

  /// @brief Method IsLocal addr 0x2839cd4 size 0x160 virtual false final false
  inline bool IsLocal(::System::Uri* host);

  /// @brief Method IsLocalInProxyHash addr 0x2839e34 size 0xf0 virtual false final false
  inline bool IsLocalInProxyHash(::System::Uri* host);

  /// @brief Method IsBypassed addr 0x2839f24 size 0xf4 virtual true final true
  inline bool IsBypassed(::System::Uri* host);

  /// @brief Method IsBypassedManual addr 0x2839a74 size 0xc8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x283a120 size 0x360 virtual false final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x283a48c size 0xc virtual true final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetObjectData addr 0x283a498 size 0x124 virtual true final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_ScriptEngine addr 0x283a5bc size 0x8 virtual false final false
  inline ::System::Net::AutoWebProxyScriptEngine* get_ScriptEngine();

  /// @brief Method CreateDefaultProxy addr 0x283a5c4 size 0x68 virtual false final false
  static inline ::System::Net::IWebProxy* CreateDefaultProxy();

  static inline ::System::Net::WebProxy* New_ctor(bool enableAutoproxy);

  /// @brief Method .ctor addr 0x283a62c size 0x30 virtual false final false
  inline void _ctor(bool enableAutoproxy);

  /// @brief Method UnsafeUpdateFromRegistry addr 0x283a480 size 0xc virtual false final false
  inline void UnsafeUpdateFromRegistry();

  /// @brief Method GetProxyAuto addr 0x28398ec size 0x188 virtual false final false
  inline bool GetProxyAuto(::System::Uri* destination, ByRef<::System::Uri*> proxyUri);

  /// @brief Method IsBypassedAuto addr 0x283a018 size 0x108 virtual false final false
  inline bool IsBypassedAuto(::System::Uri* destination, ByRef<bool> isBypassed);

  /// @brief Method AreAllBypassed addr 0x283a65c size 0x308 virtual false final false
  static inline bool AreAllBypassed(::System::Collections::Generic::IEnumerable_1<::StringW>* proxies, bool checkFirstOnly);

  /// @brief Method ProxyUri addr 0x283a964 size 0x10a4 virtual false final false
