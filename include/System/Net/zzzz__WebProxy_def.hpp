...
public:
  ...
  /// @brief Method AreAllBypassed, addr 0x62e29f4, size 0x2d4, virtual false, abstract: false, final false
  static inline bool AreAllBypassed(::System::Collections::Generic::IEnumerable_1<::StringW>* proxies, bool checkFirstOnly);

  /// @brief Method CreateDefaultProxy, addr 0x62e2984, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Net::IWebProxy* CreateDefaultProxy();

  /// @brief Method GetObjectData, addr 0x62e2844, size 0x138, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetProxy, addr 0x62e1cf8, size 0x184, virtual true, abstract: false, final true
  inline ::System::Uri* GetProxy(::System::Uri* destination);

  /// @brief Method GetProxyAuto, addr 0x62e1e7c, size 0x5c, virtual false, abstract: false, final false
  inline bool GetProxyAuto(::System::Uri* destination, ::ByRef<::System::Uri*> proxyUri);

  /// @brief Method IsBypassed, addr 0x62e239c, size 0xdc, virtual true, abstract: false, final true
  inline bool IsBypassed(::System::Uri* host);

  /// @brief Method IsBypassedAuto, addr 0x62e2478, size 0x4c, virtual false, abstract: false, final false
  inline bool IsBypassedAuto(::System::Uri* destination, ::ByRef<bool> isBypassed);

  /// @brief Method IsBypassedManual, addr 0x62e1ed8, size 0xd0, virtual false, abstract: false, final false
  inline bool IsBypassedManual(::System::Uri* host);

  /// @brief Method IsLocal, addr 0x62e2148, size 0x170, virtual false, abstract: false, final false
  inline bool IsLocal(::System::Uri* host);

  /// @brief Method IsLocalInProxyHash, addr 0x62e22b8, size 0xe4, virtual false, abstract: false, final false
  inline bool IsLocalInProxyHash(::System::Uri* host);

  /// @brief Method IsMatchInBypassList, addr 0x62e1fa8, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProxyUri, addr 0x62e2cc8, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Uri* ProxyUri(::StringW proxyName);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x62e2838, size 0xc, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo,
                                                                       ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method UnsafeUpdateFromRegistry, addr 0x62e282c, size 0xc, virtual false, abstract: false, final false
  inline void UnsafeUpdateFromRegistry();

  /// @brief Method UpdateRegExList, addr 0x62e19b8, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62e18c4, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x62e1914, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62e29d8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(bool enableAutoproxy);

  /// @brief Method .ctor, addr 0x62e24c4, size 0x368, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_Credentials, addr 0x62e1bf8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Net::ICredentials* get_Credentials();

  /// @brief Method get_ScriptEngine, addr 0x62e297c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::AutoWebProxyScriptEngine* get_ScriptEngine();

  /// @brief Method get_UseDefaultCredentials, addr 0x62e1c00, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method set_UseDefaultCredentials, addr 0x62e1c80, size 0x78, virtual false, abstract: false, final false
