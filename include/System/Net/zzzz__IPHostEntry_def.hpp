...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IPHostEntry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IPHostEntry(IPHostEntry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IPHostEntry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPHostEntry(IPHostEntryconst&) = delete;
