...
public:
  ...
  /// @brief Method Create, addr 0x620c240, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishReading, addr 0x620c37c, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessReadAsync, addr 0x620c35c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x620c32c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* decodeStream, ::System::IO::Stream* originalInnerStream);

  /// @brief Method get_OriginalInnerStream, addr 0x620c354, size 0x8, virtual false, abstract: false, final false
