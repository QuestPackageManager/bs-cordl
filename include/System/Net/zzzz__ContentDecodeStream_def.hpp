...
public:
  ...
  /// @brief Method Create, addr 0x44b8608, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishReading, addr 0x44b8738, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessReadAsync, addr 0x44b8714, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44b86e4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* decodeStream, ::System::IO::Stream* originalInnerStream);

  /// @brief Method get_OriginalInnerStream, addr 0x44b870c, size 0x8, virtual false, abstract: false, final false
