...
public:
  ...
  /// @brief Method Create, addr 0x2ff3478, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishReading, addr 0x2ff35b8, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessReadAsync, addr 0x2ff3594, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ff3564, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* decodeStream, ::System::IO::Stream* originalInnerStream);

  /// @brief Method get_OriginalInnerStream, addr 0x2ff358c, size 0x8, virtual false, abstract: false, final false
