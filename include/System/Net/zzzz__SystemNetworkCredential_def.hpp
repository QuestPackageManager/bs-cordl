...
// Write type traits
MARK_REF_T(::System::Net::SystemNetworkCredential*);
DEFINE_IL2CPP_CLASS(::System::Net::SystemNetworkCredential*, "System.Net", "SystemNetworkCredential");
...
public:
  ...
  /// @brief Method .ctor, addr 0x640ba20, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SystemNetworkCredential", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SystemNetworkCredential(SystemNetworkCredential&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SystemNetworkCredential", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SystemNetworkCredential(SystemNetworkCredentialconst&) = delete;
...
static_assert(sizeof(::System::Net::SystemNetworkCredential) == 0x28, "Size mismatch!");
