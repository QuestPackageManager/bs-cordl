...
public:
  ...
  /// @brief Method MoveNext, addr 0x2eeca3c, size 0x2b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2eeccec, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method ProcessReadAsync, addr 0x2eec884, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method TryReadFromBuffer, addr 0x2eec9ac, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2eec85c, size 0x28, virtual false, abstract: false, final false
