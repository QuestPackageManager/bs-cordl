...
public:
  ...
  /// @brief Method .ctor, addr 0x636e1ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncodedStreamFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncodedStreamFactory(EncodedStreamFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncodedStreamFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncodedStreamFactory(EncodedStreamFactoryconst&) = delete;
