...
public:
  ...
  /// @brief Method ParseMultiValue, addr 0x62d243c, size 0x210, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> ParseMultiValue(::StringW value);

  /// @brief Method ParseSingleValue, addr 0x62d23d4, size 0x68, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> ParseSingleValue(::StringW value);

  /// @brief Method .ctor, addr 0x62cee14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Item, addr 0x62cc8f8, size 0xe4, virtual false, abstract: false, final false
