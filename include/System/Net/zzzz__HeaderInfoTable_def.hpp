...
public:
  ...
  /// @brief Method ParseMultiValue, addr 0x6410050, size 0x210, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> ParseMultiValue(::StringW value);

  /// @brief Method ParseSingleValue, addr 0x640ffe8, size 0x68, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> ParseSingleValue(::StringW value);

  /// @brief Method .ctor, addr 0x640ca28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Item, addr 0x640a50c, size 0xe4, virtual false, abstract: false, final false
