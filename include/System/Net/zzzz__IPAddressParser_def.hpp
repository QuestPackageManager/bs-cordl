...
public:
  // Declarations
  /// @brief Method AppendHex, addr 0x6246028, size 0xa0, virtual false, abstract: false, final false
  static inline void AppendHex(uint16_t value, ::System::Text::StringBuilder* buffer);

  /// @brief Method AppendSections, addr 0x6245e44, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractIPv4Address, addr 0x6245ff4, size 0x34, virtual false, abstract: false, final false
  static inline uint32_t ExtractIPv4Address(::ArrayW<uint16_t, ::Array<uint16_t>*> address);

  /// @brief Method FormatIPv4AddressNumber, addr 0x6245bfc, size 0xd4, virtual false, abstract: false, final false
  static inline void FormatIPv4AddressNumber(int32_t number, char16_t* addressString, ::ByRef<int32_t> offset);

  /// @brief Method IPv4AddressToString, addr 0x6244f78, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW IPv4AddressToString(uint32_t address);

  /// @brief Method IPv4AddressToString, addr 0x6245b7c, size 0x80, virtual false, abstract: false, final false
  static inline void IPv4AddressToString(uint32_t address, ::System::Text::StringBuilder* destination);

  /// @brief Method IPv4AddressToStringHelper, addr 0x6245ae0, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t IPv4AddressToStringHelper(uint32_t address, char16_t* addressString);

  /// @brief Method IPv6AddressToString, addr 0x6244f64, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW IPv6AddressToString(::ArrayW<uint16_t, ::Array<uint16_t>*> address, uint32_t scopeId);

  /// @brief Method IPv6AddressToStringHelper, addr 0x6245cd0, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method Ipv4StringToAddress, addr 0x6245a34, size 0xac, virtual false, abstract: false, final false
  static inline bool Ipv4StringToAddress(::System::ReadOnlySpan_1<char16_t> ipSpan, ::ByRef<int64_t> address);

  /// @brief Method Ipv6StringToAddress, addr 0x62458f8, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x62448ac, size 0x1e4, virtual false, abstract: false, final false
  static inline ::System::Net::IPAddress* Parse(::System::ReadOnlySpan_1<char16_t> ipSpan, bool tryParse);

  /// @brief Method Reverse, addr 0x62460c8, size 0xc, virtual false, abstract: false, final false
