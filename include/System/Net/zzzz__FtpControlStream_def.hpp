...
public:
  ...
  /// @brief Method <PipelineCallback>b__0, addr 0x44a2f4c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x449ff58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AbortConnect, addr 0x449eafc, size 0x8c, virtual false, abstract: false, final false
  inline void AbortConnect();

  /// @brief Method AcceptCallback, addr 0x449eb88, size 0x354, virtual false, abstract: false, final false
  static inline void AcceptCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method BuildCommandsList, addr 0x44a0f88, size 0xe18, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckValid, addr 0x44a2a64, size 0x3bc, virtual true, abstract: false, final false
  inline bool CheckValid(::System::Net::ResponseDescription* response, ::ByRef<int32_t> validThrough, ::ByRef<int32_t> completeLength);

  /// @brief Method ClearState, addr 0x449f66c, size 0x90, virtual true, abstract: false, final false
  inline void ClearState();

  /// @brief Method ConnectCallback, addr 0x449eedc, size 0x1b4, virtual false, abstract: false, final false
  static inline void ConnectCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method CreateFtpDataSocket, addr 0x44a2750, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFtpListenerSocket, addr 0x44a2048, size 0x178, virtual false, abstract: false, final false
  inline void CreateFtpListenerSocket(::System::Net::FtpWebRequest* request);

  /// @brief Method FormatAddress, addr 0x44a27cc, size 0x128, virtual false, abstract: false, final false
  inline ::StringW FormatAddress(::System::Net::IPAddress* address, int32_t Port);

  /// @brief Method FormatAddressV6, addr 0x44a28f4, size 0x110, virtual false, abstract: false, final false
  inline ::StringW FormatAddressV6(::System::Net::IPAddress* address, int32_t port);

  /// @brief Method FormatFtpCommand, addr 0x44a1da0, size 0xf8, virtual false, abstract: false, final false
  inline ::StringW FormatFtpCommand(::StringW command, ::StringW parameter);

  /// @brief Method GetContentLengthFrom213Response, addr 0x44a0a20, size 0x138, virtual false, abstract: false, final false
  inline int64_t GetContentLengthFrom213Response(::StringW responseString);

  /// @brief Method GetLastModifiedFrom213Response, addr 0x44a0b58, size 0x380, virtual false, abstract: false, final false
  inline ::System::DateTime GetLastModifiedFrom213Response(::StringW str);

  /// @brief Method GetLoginDirectory, addr 0x44a0ed8, size 0xb0, virtual false, abstract: false, final false
  inline ::StringW GetLoginDirectory(::StringW str);

  /// @brief Method GetPathInfo, addr 0x44a1ea8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPortCommandLine, addr 0x44a21c0, size 0x1f0, virtual false, abstract: false, final false
  inline ::StringW GetPortCommandLine(::System::Net::FtpWebRequest* request);

  /// @brief Method GetPortV4, addr 0x44a23b0, size 0x1e8, virtual false, abstract: false, final false
  inline int32_t GetPortV4(::StringW responseString);

  /// @brief Method GetPortV6, addr 0x44a2598, size 0x1b8, virtual false, abstract: false, final false
  inline int32_t GetPortV6(::StringW responseString);

  /// @brief Method IsFtpDataStreamWriteable, addr 0x449f4ec, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method PipelineCallback, addr 0x449f6fc, size 0x85c, virtual true, abstract: false, final false
  ...
  /// @brief Method QueueOrCreateDataConection, addr 0x449ff60, size 0x680, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueOrCreateFtpDataStream, addr 0x449f258, size 0x294, virtual false, abstract: false, final false
  inline ::System::Net::CommandStream_PipelineInstruction QueueOrCreateFtpDataStream(::ByRef<::System::IO::Stream*> stream);

  /// @brief Method SSLHandshakeCallback, addr 0x449f090, size 0x1c8, virtual false, abstract: false, final false
  static inline void SSLHandshakeCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method TryUpdateContentLength, addr 0x44a05e0, size 0xec, virtual false, abstract: false, final false
  inline void TryUpdateContentLength(::StringW str);

  /// @brief Method TryUpdateResponseUri, addr 0x44a06d8, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x449ea70, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BannerMessage, addr 0x44a2a1c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_BannerMessage();

  /// @brief Method get_ContentLength, addr 0x44a2a04, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_ContentLength();

  /// @brief Method get_Credentials, addr 0x449e948, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Net::NetworkCredential* get_Credentials();

  /// @brief Method get_ExitMessage, addr 0x44a2a4c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_ExitMessage();

  /// @brief Method get_LastModified, addr 0x44a2a0c, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_LastModified();

  /// @brief Method get_ResponseUri, addr 0x44a2a14, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_ResponseUri();

  /// @brief Method get_WelcomeMessage, addr 0x44a2a34, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Credentials, addr 0x449e9f0, size 0x80, virtual false, abstract: false, final false
