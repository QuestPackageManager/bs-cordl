...
public:
  ...
  /// @brief Method <PipelineCallback>b__0, addr 0x4499f1c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4496f28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AbortConnect, addr 0x4495acc, size 0x8c, virtual false, abstract: false, final false
  inline void AbortConnect();

  /// @brief Method AcceptCallback, addr 0x4495b58, size 0x354, virtual false, abstract: false, final false
  static inline void AcceptCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method BuildCommandsList, addr 0x4497f58, size 0xe18, virtual true, abstract: false, final false
  ...
  /// @brief Method CheckValid, addr 0x4499a34, size 0x3bc, virtual true, abstract: false, final false
  inline bool CheckValid(::System::Net::ResponseDescription* response, ::ByRef<int32_t> validThrough, ::ByRef<int32_t> completeLength);

  /// @brief Method ClearState, addr 0x449663c, size 0x90, virtual true, abstract: false, final false
  inline void ClearState();

  /// @brief Method ConnectCallback, addr 0x4495eac, size 0x1b4, virtual false, abstract: false, final false
  static inline void ConnectCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method CreateFtpDataSocket, addr 0x4499720, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFtpListenerSocket, addr 0x4499018, size 0x178, virtual false, abstract: false, final false
  inline void CreateFtpListenerSocket(::System::Net::FtpWebRequest* request);

  /// @brief Method FormatAddress, addr 0x449979c, size 0x128, virtual false, abstract: false, final false
  inline ::StringW FormatAddress(::System::Net::IPAddress* address, int32_t Port);

  /// @brief Method FormatAddressV6, addr 0x44998c4, size 0x110, virtual false, abstract: false, final false
  inline ::StringW FormatAddressV6(::System::Net::IPAddress* address, int32_t port);

  /// @brief Method FormatFtpCommand, addr 0x4498d70, size 0xf8, virtual false, abstract: false, final false
  inline ::StringW FormatFtpCommand(::StringW command, ::StringW parameter);

  /// @brief Method GetContentLengthFrom213Response, addr 0x44979f0, size 0x138, virtual false, abstract: false, final false
  inline int64_t GetContentLengthFrom213Response(::StringW responseString);

  /// @brief Method GetLastModifiedFrom213Response, addr 0x4497b28, size 0x380, virtual false, abstract: false, final false
  inline ::System::DateTime GetLastModifiedFrom213Response(::StringW str);

  /// @brief Method GetLoginDirectory, addr 0x4497ea8, size 0xb0, virtual false, abstract: false, final false
  inline ::StringW GetLoginDirectory(::StringW str);

  /// @brief Method GetPathInfo, addr 0x4498e78, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPortCommandLine, addr 0x4499190, size 0x1f0, virtual false, abstract: false, final false
  inline ::StringW GetPortCommandLine(::System::Net::FtpWebRequest* request);

  /// @brief Method GetPortV4, addr 0x4499380, size 0x1e8, virtual false, abstract: false, final false
  inline int32_t GetPortV4(::StringW responseString);

  /// @brief Method GetPortV6, addr 0x4499568, size 0x1b8, virtual false, abstract: false, final false
  inline int32_t GetPortV6(::StringW responseString);

  /// @brief Method IsFtpDataStreamWriteable, addr 0x44964bc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method PipelineCallback, addr 0x44966cc, size 0x85c, virtual true, abstract: false, final false
  ...
  /// @brief Method QueueOrCreateDataConection, addr 0x4496f30, size 0x680, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueOrCreateFtpDataStream, addr 0x4496228, size 0x294, virtual false, abstract: false, final false
  inline ::System::Net::CommandStream_PipelineInstruction QueueOrCreateFtpDataStream(::ByRef<::System::IO::Stream*> stream);

  /// @brief Method SSLHandshakeCallback, addr 0x4496060, size 0x1c8, virtual false, abstract: false, final false
  static inline void SSLHandshakeCallback(::System::IAsyncResult* asyncResult);

  /// @brief Method TryUpdateContentLength, addr 0x44975b0, size 0xec, virtual false, abstract: false, final false
  inline void TryUpdateContentLength(::StringW str);

  /// @brief Method TryUpdateResponseUri, addr 0x44976a8, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4495a40, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BannerMessage, addr 0x44999ec, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_BannerMessage();

  /// @brief Method get_ContentLength, addr 0x44999d4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_ContentLength();

  /// @brief Method get_Credentials, addr 0x4495918, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Net::NetworkCredential* get_Credentials();

  /// @brief Method get_ExitMessage, addr 0x4499a1c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_ExitMessage();

  /// @brief Method get_LastModified, addr 0x44999dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_LastModified();

  /// @brief Method get_ResponseUri, addr 0x44999e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_ResponseUri();

  /// @brief Method get_WelcomeMessage, addr 0x4499a04, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Credentials, addr 0x44959c0, size 0x80, virtual false, abstract: false, final false
