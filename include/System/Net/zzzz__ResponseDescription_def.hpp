...
public:
  ...
  /// @brief Method .ctor, addr 0x63fdf48, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InvalidStatusCode, addr 0x63fdf34, size 0x14, virtual false, abstract: false, final false
  inline bool get_InvalidStatusCode();

  /// @brief Method get_PermanentFailure, addr 0x63fdf20, size 0x14, virtual false, abstract: false, final false
  inline bool get_PermanentFailure();

  /// @brief Method get_PositiveCompletion, addr 0x63fdef8, size 0x14, virtual false, abstract: false, final false
  inline bool get_PositiveCompletion();

  /// @brief Method get_PositiveIntermediate, addr 0x63fdee4, size 0x14, virtual false, abstract: false, final false
  inline bool get_PositiveIntermediate();

  /// @brief Method get_TransientFailure, addr 0x63fdf0c, size 0x14, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ResponseDescription", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ResponseDescription(ResponseDescription&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ResponseDescription", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ResponseDescription(ResponseDescriptionconst&) = delete;
