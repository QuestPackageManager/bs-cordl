...
public:
  ...
  /// @brief Method .ctor addr 0x280f428 size 0x84 virtual false final false
  inline void _ctor(::System::Net::Sockets::TcpClient* client);

  /// @brief Method get_UsingSecureStream addr 0x2812238 size 0x7c virtual false final false
  inline bool get_UsingSecureStream();

  /// @brief Method get_ServerAddress addr 0x2811a14 size 0x94 virtual false final false
  inline ::System::Net::IPAddress* get_ServerAddress();

  /// @brief Method get_Socket addr 0x2813728 size 0x1c virtual false final false
  inline ::System::Net::Sockets::Socket* get_Socket();

  /// @brief Method get_NetworkStream addr 0x281d718 size 0x8 virtual false final false
  inline ::System::Net::Sockets::NetworkStream* get_NetworkStream();

  /// @brief Method set_NetworkStream addr 0x281d720 size 0x8 virtual false final false
  inline void set_NetworkStream(::System::Net::Sockets::NetworkStream* value);

  /// @brief Method get_CanRead addr 0x281d728 size 0x20 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek addr 0x281d748 size 0x20 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite addr 0x281d768 size 0x20 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method get_CanTimeout addr 0x281d788 size 0x20 virtual true final false
  inline bool get_CanTimeout();

  /// @brief Method get_ReadTimeout addr 0x281d7a8 size 0x24 virtual true final false
  inline int32_t get_ReadTimeout();

  /// @brief Method set_ReadTimeout addr 0x281d7cc size 0x24 virtual true final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method get_WriteTimeout addr 0x281d7f0 size 0x24 virtual true final false
  inline int32_t get_WriteTimeout();

  /// @brief Method set_WriteTimeout addr 0x281d814 size 0x24 virtual true final false
  inline void set_WriteTimeout(int32_t value);

  /// @brief Method get_Length addr 0x281d838 size 0x20 virtual true final false
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0x281d858 size 0x20 virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0x281d878 size 0x24 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method Seek addr 0x281d89c size 0x24 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method Read addr 0x281d8c0 size 0x24 virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Write addr 0x281d8e4 size 0x24 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Dispose addr 0x281d908 size 0xac virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method CloseSocket addr 0x2810944 size 0x38 virtual false final false
  inline void CloseSocket();

  /// @brief Method Close addr 0x280f6a4 size 0x30 virtual false final false
  inline void Close(int32_t timeout);

  /// @brief Method BeginRead addr 0x281d9b4 size 0x24 virtual true final false
  ...
  /// @brief Method EndRead addr 0x281d9d8 size 0x24 virtual true final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method ReadAsync addr 0x281d9fc size 0x24 virtual true final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method BeginWrite addr 0x281da20 size 0x24 virtual true final false
  ...
  /// @brief Method EndWrite addr 0x281da44 size 0x24 virtual true final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method WriteAsync addr 0x281da68 size 0x24 virtual true final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Flush addr 0x281da8c size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method FlushAsync addr 0x281dab0 size 0x24 virtual true final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method SetLength addr 0x281dad4 size 0x24 virtual true final false
  inline void SetLength(int64_t value);

  /// @brief Method SetSocketTimeoutOption addr 0x281af18 size 0x50 virtual false final false
