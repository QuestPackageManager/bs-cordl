...
public:
  ...
  /// @brief Method .ctor, addr 0x61f9b34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cleanup, addr 0x61fa1fc, size 0x4, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Complete, addr 0x61f9fc8, size 0x190, virtual true, abstract: false, final false
  inline void Complete(::System::IntPtr userToken);

  /// @brief Method InternalWaitForCompletion, addr 0x61e6184, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* InternalWaitForCompletion();

  /// @brief Method InvokeCallback, addr 0x61e979c, size 0xc, virtual false, abstract: false, final false
  inline void InvokeCallback();

  /// @brief Method InvokeCallback, addr 0x61e5da8, size 0x8, virtual false, abstract: false, final false
  inline void InvokeCallback(::System::Object* result);

  /// @brief Method LazilyCreateEvent, addr 0x61f9bf8, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProtectedInvokeCallback, addr 0x61f9de0, size 0x1e8, virtual false, abstract: false, final false
  inline void ProtectedInvokeCallback(::System::Object* result, ::System::IntPtr userToken);

  /// @brief Method WaitForCompletion, addr 0x61fa200, size 0x2b0, virtual false, abstract: false, final false
  inline ::System::Object* WaitForCompletion(bool snap);

  /// @brief Method WorkerThreadComplete, addr 0x61fa158, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61e5f80, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AsyncCallback, addr 0x61f9b48, size 0x8, virtual false, abstract: false, final false
  inline ::System::AsyncCallback* get_AsyncCallback();

  /// @brief Method get_AsyncObject, addr 0x61f9b38, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_AsyncObject();

  /// @brief Method get_AsyncState, addr 0x61f9b40, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x61f9b50, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously, addr 0x61f9d9c, size 0x34, virtual true, abstract: false, final true
  inline bool get_CompletedSynchronously();

  /// @brief Method get_CurrentThreadContext, addr 0x61f9a58, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Net::LazyAsyncResult_ThreadContext* get_CurrentThreadContext();

  /// @brief Method get_EndCalled, addr 0x61f9dd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_EndCalled();

  /// @brief Method get_InternalPeekCompleted, addr 0x61e978c, size 0x10, virtual false, abstract: false, final false
  inline bool get_InternalPeekCompleted();

  /// @brief Method get_IsCompleted, addr 0x61e5db0, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method set_EndCalled, addr 0x61f9dd8, size 0x8, virtual false, abstract: false, final false
