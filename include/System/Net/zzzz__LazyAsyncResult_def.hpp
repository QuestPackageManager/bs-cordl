...
public:
  ...
  /// @brief Method .ctor, addr 0x2ed93b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cleanup, addr 0x2ed9c14, size 0x4, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Complete, addr 0x2ed99d0, size 0x198, virtual true, abstract: false, final false
  inline void Complete(void* userToken);

  /// @brief Method InternalWaitForCompletion, addr 0x2ed9c18, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* InternalWaitForCompletion();

  /// @brief Method InvokeCallback, addr 0x2ed997c, size 0x54, virtual false, abstract: false, final false
  inline void InvokeCallback();

  /// @brief Method InvokeCallback, addr 0x2ed991c, size 0x60, virtual false, abstract: false, final false
  inline void InvokeCallback(::System::Object* result);

  /// @brief Method LazilyCreateEvent, addr 0x2ed950c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProtectedInvokeCallback, addr 0x2ed9744, size 0x1d8, virtual false, abstract: false, final false
  inline void ProtectedInvokeCallback(::System::Object* result, void* userToken);

  /// @brief Method WaitForCompletion, addr 0x2ed9c20, size 0x2b8, virtual false, abstract: false, final false
  inline ::System::Object* WaitForCompletion(bool snap);

  /// @brief Method WorkerThreadComplete, addr 0x2ed9b68, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ed93c0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AsyncCallback, addr 0x2ed9460, size 0x8, virtual false, abstract: false, final false
  inline ::System::AsyncCallback* get_AsyncCallback();

  /// @brief Method get_AsyncObject, addr 0x2ed9450, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_AsyncObject();

  /// @brief Method get_AsyncState, addr 0x2ed9458, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x2ed9468, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously, addr 0x2ed96d0, size 0x30, virtual true, abstract: false, final true
  inline bool get_CompletedSynchronously();

  /// @brief Method get_CurrentThreadContext, addr 0x2ed9324, size 0x94, virtual false, abstract: false, final false
  static inline ::System::Net::__LazyAsyncResult__ThreadContext* get_CurrentThreadContext();

  /// @brief Method get_EndCalled, addr 0x2ed9730, size 0x8, virtual false, abstract: false, final false
  inline bool get_EndCalled();

  /// @brief Method get_InternalPeekCompleted, addr 0x2ed96c0, size 0x10, virtual false, abstract: false, final false
  inline bool get_InternalPeekCompleted();

  /// @brief Method get_IsCompleted, addr 0x2ed9700, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method set_EndCalled, addr 0x2ed9738, size 0xc, virtual false, abstract: false, final false
