...
template <typename T>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3402)), TypeDefinitionIndex(TypeDefinitionIndex(3397)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3402), inst: 97
// }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 105 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(9182)) CS Name:
...
namespace System::Net {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 872 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2510), inst: 5337 }),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 901 }), TypeDefinitionIndex(TypeDefinitionIndex(3402)), TypeDefinitionIndex(TypeDefinitionIndex(9187)),
// TypeDefinitionIndex(TypeDefinitionIndex(9100)), TypeDefinitionIndex(TypeDefinitionIndex(9244)), TypeDefinitionIndex(TypeDefinitionIndex(2510)), TypeDefinitionIndex(TypeDefinitionIndex(9227)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3402), inst: 884 }), TypeDefinitionIndex(TypeDefinitionIndex(3397)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3394), inst: 5068 }), TypeDefinitionIndex(TypeDefinitionIndex(9238)), TypeDefinitionIndex(TypeDefinitionIndex(3394)), TypeDefinitionIndex(TypeDefinitionIndex(3395)),
// TypeDefinitionIndex(TypeDefinitionIndex(2677))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9183)) CS Name: ::HttpWebRequest::<MyGetResponseAsync>d__243
...
namespace System::Net {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9187)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2510), inst: 5337 }),
// TypeDefinitionIndex(TypeDefinitionIndex(3395)), TypeDefinitionIndex(TypeDefinitionIndex(9100)), TypeDefinitionIndex(TypeDefinitionIndex(3397)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3402), inst: 872 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 879 }), TypeDefinitionIndex(TypeDefinitionIndex(2510)),
// TypeDefinitionIndex(TypeDefinitionIndex(3402)), TypeDefinitionIndex(TypeDefinitionIndex(9227)), TypeDefinitionIndex(TypeDefinitionIndex(2677))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9184))
...
// TypeDefinitionIndex(TypeDefinitionIndex(9100)), TypeDefinitionIndex(TypeDefinitionIndex(3395))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9185)) CS Name:
