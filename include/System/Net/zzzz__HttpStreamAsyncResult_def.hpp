...
/// @brief Method Complete, addr 0x617c29c, size 0xec, virtual false, abstract: false, final false
inline void Complete() ;

/// @brief Method Complete, addr 0x617c294, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x617c594, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AsyncState, addr 0x617c388, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x617c390, size 0x130, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x617c4c0, size 0x14, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted, addr 0x617c4d4, size 0xc0, virtual true, abstract: false, final true
