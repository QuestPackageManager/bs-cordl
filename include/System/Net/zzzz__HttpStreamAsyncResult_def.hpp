...
public:
  ...
  /// @brief Method Complete, addr 0x2ef11f0, size 0x100, virtual false, abstract: false, final false
  inline void Complete();

  /// @brief Method Complete, addr 0x2ef18b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ef1188, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AsyncState, addr 0x2f00224, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x2f0022c, size 0x13c, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously, addr 0x2f00368, size 0x14, virtual true, abstract: false, final true
  inline bool get_CompletedSynchronously();

  /// @brief Method get_IsCompleted, addr 0x2f0037c, size 0xc8, virtual true, abstract: false, final true
