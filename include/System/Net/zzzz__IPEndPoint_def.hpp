...
public:
  ...
  /// @brief Method Create, addr 0x61de774, size 0x1f0, virtual true, abstract: false, final false
  inline ::System::Net::EndPoint* Create(::System::Net::SocketAddress* socketAddress);

  /// @brief Method Equals, addr 0x61de964, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetHashCode, addr 0x61dea1c, size 0x30, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::IPEndPoint* New_ctor(::System::Net::IPAddress* address, int32_t port);

  /// @brief Method Serialize, addr 0x61de708, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Net::SocketAddress* Serialize();

  /// @brief Method ToString, addr 0x61de61c, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61de570, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Address, addr 0x61de60c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::IPAddress* get_Address();

  /// @brief Method get_AddressFamily, addr 0x61de548, size 0x28, virtual true, abstract: false, final false
  inline ::System::Net::Sockets::AddressFamily get_AddressFamily();

  /// @brief Method get_Port, addr 0x61de614, size 0x8, virtual false, abstract: false, final false
