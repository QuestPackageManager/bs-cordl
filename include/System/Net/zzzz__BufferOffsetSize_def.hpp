...
public:
  ...
  /// @brief Method .ctor, addr 0x640ff28, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> buffer, bool copyBuffer);

  /// @brief Method .ctor, addr 0x640fe84, size 0xa4, virtual false, abstract: false, final false
