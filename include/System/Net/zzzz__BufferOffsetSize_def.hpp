...
/// @brief Method .ctor, addr 0x6260308, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, bool  copyBuffer) ;

/// @brief Method .ctor, addr 0x6260264, size 0xa4, virtual false, abstract: false, final false
