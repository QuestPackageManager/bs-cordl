...
public:
  ...
  /// @brief Method CheckQuoted, addr 0x44afac8, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW CheckQuoted(::StringW value);

  /// @brief Method Get, addr 0x44af564, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44af4f0, size 0x74, virtual false, abstract: false, final false
