...
public:
  ...
  /// @brief Method CheckQuoted, addr 0x44af760, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW CheckQuoted(::StringW value);

  /// @brief Method Get, addr 0x44af1fc, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44af188, size 0x74, virtual false, abstract: false, final false
