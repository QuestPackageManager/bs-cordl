...
public:
  ...
  /// @brief Method CheckQuoted, addr 0x44aabcc, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW CheckQuoted(::StringW value);

  /// @brief Method Get, addr 0x44aa668, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44aa5f4, size 0x74, virtual false, abstract: false, final false
