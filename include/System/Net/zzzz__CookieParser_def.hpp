...
public:
  ...
  /// @brief Method CheckQuoted, addr 0x6266598, size 0x64, virtual false, abstract: false, final false
  static inline ::StringW CheckQuoted(::StringW value);

  /// @brief Method Get, addr 0x6265fe8, size 0x5b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6265f78, size 0x70, virtual false, abstract: false, final false
