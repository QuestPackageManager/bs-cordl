...
public:
  ...
  /// @brief Method CheckQuoted, addr 0x2ffe570, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW CheckQuoted(::StringW value);

  /// @brief Method Get, addr 0x2ffff08, size 0x55c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fffe90, size 0x78, virtual false, abstract: false, final false
