...
public:
  ...
  /// @brief Method CheckQuoted, addr 0x61fea0c, size 0x64, virtual false, abstract: false, final false
  static inline ::StringW CheckQuoted(::StringW value);

  /// @brief Method Get, addr 0x61fe45c, size 0x5b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61fe3ec, size 0x70, virtual false, abstract: false, final false
