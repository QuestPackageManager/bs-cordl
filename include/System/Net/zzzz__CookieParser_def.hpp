...
/// @brief Method CheckQuoted, addr 0x62da7dc, size 0x64, virtual false, abstract: false, final false
static inline ::StringW CheckQuoted(::StringW  value) ;

/// @brief Method Get, addr 0x62da22c, size 0x5b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62da1bc, size 0x70, virtual false, abstract: false, final false
