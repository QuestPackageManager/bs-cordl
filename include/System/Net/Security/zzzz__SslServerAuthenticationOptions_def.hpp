...
/// @brief Field <ClientCertificateRequired>k__BackingField, offset 0x1d, size 0x1 
 __declspec(property(get=__cordl_internal_get__ClientCertificateRequired_k__BackingField, put=__cordl_internal_set__ClientCertificateRequired_k__BackingField)) bool  _ClientCertificateRequired_k__BackingField;

/// @brief Field <ServerCertificate>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__ServerCertificate_k__BackingField, put=__cordl_internal_set__ServerCertificate_k__BackingField)) ::System::Security::Cryptography::X509Certificates::X509Certificate*  _ServerCertificate_k__BackingField;
...
/// @brief Field _checkCertificateRevocation, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__checkCertificateRevocation, put=__cordl_internal_set__checkCertificateRevocation)) ::System::Security::Cryptography::X509Certificates::X509RevocationMode  _checkCertificateRevocation;
...
/// @brief Method .ctor, addr 0x61bc380, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ClientCertificateRequired, addr 0x61bc228, size 0x8, virtual false, abstract: false, final false
inline bool get_ClientCertificateRequired() ;

/// @brief Method get_EnabledSslProtocols, addr 0x61bc248, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::Authentication::SslProtocols get_EnabledSslProtocols() ;

/// @brief Method get_ServerCertificate, addr 0x61bc238, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_ServerCertificate() ;

/// @brief Method set_CertificateRevocationCheckMode, addr 0x61bc258, size 0x94, virtual false, abstract: false, final false
inline void set_CertificateRevocationCheckMode(::System::Security::Cryptography::X509Certificates::X509RevocationMode  value) ;

/// @brief Method set_ClientCertificateRequired, addr 0x61bc230, size 0x8, virtual false, abstract: false, final false
inline void set_ClientCertificateRequired(bool  value) ;

/// @brief Method set_EnabledSslProtocols, addr 0x61bc250, size 0x8, virtual false, abstract: false, final false
inline void set_EnabledSslProtocols(::System::Security::Authentication::SslProtocols  value) ;

/// @brief Method set_EncryptionPolicy, addr 0x61bc2ec, size 0x94, virtual false, abstract: false, final false
inline void set_EncryptionPolicy(::System::Net::Security::EncryptionPolicy  value) ;

/// @brief Method set_ServerCertificate, addr 0x61bc240, size 0x8, virtual false, abstract: false, final false
