...
/// @brief Method Dispose, addr 0x61bc514, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61bc38c, size 0x180, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  innerStream, bool  leaveInnerStreamOpen) ;

/// @brief Method get_InnerStream, addr 0x61bc50c, size 0x8, virtual false, abstract: false, final false
