...
public:
  ...
  /// @brief Method Dispose, addr 0x4405fcc, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4405e34, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* innerStream, bool leaveInnerStreamOpen);

  /// @brief Method get_InnerStream, addr 0x4405fc4, size 0x8, virtual false, abstract: false, final false
