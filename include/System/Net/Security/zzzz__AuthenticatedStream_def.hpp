...
public:
  ...
  /// @brief Method Dispose, addr 0x2f4e350, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f4e1b0, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* innerStream, bool leaveInnerStreamOpen);

  /// @brief Method get_InnerStream, addr 0x2f4e348, size 0x8, virtual false, abstract: false, final false
