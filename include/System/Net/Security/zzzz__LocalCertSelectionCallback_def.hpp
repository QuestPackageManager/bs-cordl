...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2a4b064, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a4af8c, size 0xd8, virtual false, abstract: false, final false
