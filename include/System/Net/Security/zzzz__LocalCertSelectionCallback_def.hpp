...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2e2d7ac, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e2d6d4, size 0xd8, virtual false, abstract: false, final false
