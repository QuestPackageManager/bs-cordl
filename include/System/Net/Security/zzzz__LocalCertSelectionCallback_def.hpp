...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6154688, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6154608, size 0x80, virtual false, abstract: false, final false
