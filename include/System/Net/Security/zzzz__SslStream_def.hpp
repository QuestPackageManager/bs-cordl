...
public:
  ...
  /// @brief Method .ctor addr 0x2900368 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SetAndVerifySelectionCallback>b__0 addr 0x2900b34 size 0x38 virtual false final false
...
public:
  ...
  /// @brief Method get_Impl addr 0x28ffe44 size 0x18 virtual false final false
  inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Impl();

  /// @brief Method get_InternalTargetHost addr 0x28ffebc size 0x24 virtual false final false
  inline ::StringW get_InternalTargetHost();

  /// @brief Method GetProvider addr 0x28ffee0 size 0x70 virtual false final false
  ...
  /// @brief Method .ctor addr 0x28fff50 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0x28fff5c size 0x90 virtual false final false
  inline void _ctor(::System::IO::Stream* innerStream, bool leaveInnerStreamOpen, ::System::Net::Security::RemoteCertificateValidationCallback* userCertificateValidationCallback,
                    ::System::Net::Security::LocalCertificateSelectionCallback* userCertificateSelectionCallback);
  ...
  /// @brief Method .ctor addr 0x2900244 size 0x124 virtual false final false
  ...
  /// @brief Method SetAndVerifyValidationCallback addr 0x28fffec size 0xe0 virtual false final false
  inline void SetAndVerifyValidationCallback(::System::Net::Security::RemoteCertificateValidationCallback* callback);

  /// @brief Method SetAndVerifySelectionCallback addr 0x29000cc size 0x178 virtual false final false
  inline void SetAndVerifySelectionCallback(::System::Net::Security::LocalCertificateSelectionCallback* callback);

  /// @brief Method AuthenticateAsClient addr 0x2900370 size 0x54 virtual true final false
  ...
  /// @brief Method BeginAuthenticateAsClient addr 0x29003c4 size 0x74 virtual true final false
  ...
  /// @brief Method EndAuthenticateAsClient addr 0x2900438 size 0xc virtual true final false
  inline void EndAuthenticateAsClient(::System::IAsyncResult* asyncResult);

  /// @brief Method AuthenticateAsServer addr 0x2900444 size 0x54 virtual true final false
  ...
  /// @brief Method AuthenticateAsClientAsync addr 0x2900498 size 0x54 virtual true final false
  ...
  /// @brief Method get_IsAuthenticated addr 0x29004ec size 0x2c virtual true final false
  inline bool get_IsAuthenticated();

  /// @brief Method get_LocalCertificate addr 0x2900518 size 0x24 virtual true final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalCertificate();

  /// @brief Method get_CanSeek addr 0x290053c size 0x8 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_CanRead addr 0x2900544 size 0x18 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanTimeout addr 0x290055c size 0x20 virtual true final false
  inline bool get_CanTimeout();

  /// @brief Method get_CanWrite addr 0x290057c size 0x18 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method get_ReadTimeout addr 0x2900594 size 0x2c virtual true final false
  inline int32_t get_ReadTimeout();

  /// @brief Method set_ReadTimeout addr 0x29005c0 size 0x3c virtual true final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method get_WriteTimeout addr 0x29005fc size 0x2c virtual true final false
  inline int32_t get_WriteTimeout();

  /// @brief Method set_WriteTimeout addr 0x2900628 size 0x3c virtual true final false
  inline void set_WriteTimeout(int32_t value);

  /// @brief Method get_Length addr 0x2900664 size 0x28 virtual true final false
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0x290068c size 0x2c virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0x29006b8 size 0x60 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method SetLength addr 0x2900718 size 0x3c virtual true final false
  inline void SetLength(int64_t value);

  /// @brief Method Seek addr 0x2900754 size 0x60 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method FlushAsync addr 0x29007b4 size 0x24 virtual true final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Flush addr 0x29007d8 size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method CheckDisposed addr 0x28ffe5c size 0x60 virtual false final false
  inline void CheckDisposed();

  /// @brief Method Dispose addr 0x29007fc size 0xac virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method Read addr 0x29008a8 size 0x54 virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method Write addr 0x29008fc size 0x54 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadAsync addr 0x2900950 size 0x5c virtual true final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method WriteAsync addr 0x29009ac size 0x5c virtual true final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method BeginRead addr 0x2900a08 size 0x6c virtual true final false
  ...
  /// @brief Method EndRead addr 0x2900a74 size 0x48 virtual true final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method BeginWrite addr 0x2900abc size 0x6c virtual true final false
  ...
  /// @brief Method EndWrite addr 0x2900b28 size 0xc virtual true final false
