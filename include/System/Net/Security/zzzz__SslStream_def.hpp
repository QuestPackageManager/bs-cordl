...
/// @brief Method <SetAndVerifySelectionCallback>b__0, addr 0x61bd63c, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61bce90, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AuthenticateAsClient, addr 0x61bce94, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method AuthenticateAsClientAsync, addr 0x61bcfbc, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method AuthenticateAsServer, addr 0x61bcf68, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method BeginAuthenticateAsClient, addr 0x61bcee8, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method BeginRead, addr 0x61bd50c, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x61bd5c4, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method CheckDisposed, addr 0x61bc990, size 0x58, virtual false, abstract: false, final false
inline void CheckDisposed() ;

/// @brief Method Dispose, addr 0x61bd2f4, size 0xb8, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndAuthenticateAsClient, addr 0x61bcf5c, size 0xc, virtual true, abstract: false, final false
inline void EndAuthenticateAsClient(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndRead, addr 0x61bd578, size 0x4c, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndWrite, addr 0x61bd630, size 0xc, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  asyncResult) ;

/// @brief Method Flush, addr 0x61bd2d4, size 0x20, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x61bd2b4, size 0x20, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method GetProvider, addr 0x61bca0c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x61bd3ac, size 0x54, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadAsync, addr 0x61bd454, size 0x5c, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Seek, addr 0x61bd264, size 0x50, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetAndVerifySelectionCallback, addr 0x61bcbf0, size 0x174, virtual false, abstract: false, final false
inline void SetAndVerifySelectionCallback(::System::Net::Security::LocalCertificateSelectionCallback*  callback) ;

/// @brief Method SetAndVerifyValidationCallback, addr 0x61bcb1c, size 0xd4, virtual false, abstract: false, final false
inline void SetAndVerifyValidationCallback(::System::Net::Security::RemoteCertificateValidationCallback*  callback) ;

/// @brief Method SetLength, addr 0x61bd228, size 0x3c, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x61bd400, size 0x54, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteAsync, addr 0x61bd4b0, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61bcd64, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61bca88, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61bca90, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x61bd068, size 0x18, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x61bd060, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x61bd080, size 0x1c, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_CanWrite, addr 0x61bd09c, size 0x18, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Impl, addr 0x61bc978, size 0x18, virtual false, abstract: false, final false
inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Impl() ;

/// @brief Method get_InternalTargetHost, addr 0x61bc9e8, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_InternalTargetHost() ;

/// @brief Method get_IsAuthenticated, addr 0x61bd010, size 0x2c, virtual true, abstract: false, final false
inline bool get_IsAuthenticated() ;

/// @brief Method get_Length, addr 0x61bd184, size 0x28, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_LocalCertificate, addr 0x61bd03c, size 0x24, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalCertificate() ;

/// @brief Method get_Position, addr 0x61bd1ac, size 0x2c, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x61bd0b4, size 0x2c, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_WriteTimeout, addr 0x61bd11c, size 0x2c, virtual true, abstract: false, final false
inline int32_t get_WriteTimeout() ;

/// @brief Method set_Position, addr 0x61bd1d8, size 0x50, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x61bd0e0, size 0x3c, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x61bd148, size 0x3c, virtual true, abstract: false, final false
