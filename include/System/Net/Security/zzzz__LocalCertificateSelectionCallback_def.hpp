...
public:
// Declarations
/// @brief Method Invoke, addr 0x61bc6e4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61bc59c, size 0x148, virtual false, abstract: false, final false
