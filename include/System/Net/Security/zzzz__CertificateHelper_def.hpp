...
public:
  // Declarations
  /// @brief Method GetEligibleClientCertificate, addr 0x2e2caf4, size 0x1ac, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2* GetEligibleClientCertificate();

  /// @brief Method GetEligibleClientCertificate, addr 0x2e2cca0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEligibleClientCertificate, addr 0x2e2ce24, size 0x94, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2*
