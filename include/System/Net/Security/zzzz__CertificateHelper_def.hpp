...
public:
  // Declarations
  /// @brief Method GetEligibleClientCertificate, addr 0x4407598, size 0x1b4, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2* GetEligibleClientCertificate();

  /// @brief Method GetEligibleClientCertificate, addr 0x4407348, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEligibleClientCertificate, addr 0x44072b4, size 0x94, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2*
  GetEligibleClientCertificate(::System::Security::Cryptography::X509Certificates::X509CertificateCollection* candidateCerts);

  /// @brief Method IsValidClientCertificate, addr 0x44073dc, size 0xf8, virtual false, abstract: false, final false
  static inline bool IsValidClientCertificate(::System::Security::Cryptography::X509Certificates::X509Certificate2* cert);

  /// @brief Method IsValidForClientAuthenticationEKU, addr 0x44074d4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidForDigitalSignatureUsage, addr 0x4407578, size 0x20, virtual false, abstract: false, final false
