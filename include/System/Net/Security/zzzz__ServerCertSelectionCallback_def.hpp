...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ServerCertSelectionCallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ServerCertSelectionCallback(ServerCertSelectionCallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ServerCertSelectionCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ServerCertSelectionCallback(ServerCertSelectionCallbackconst&) = delete;
