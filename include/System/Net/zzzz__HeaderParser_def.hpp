...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x44b6210, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44b6174, size 0x9c, virtual false, abstract: false, final false
