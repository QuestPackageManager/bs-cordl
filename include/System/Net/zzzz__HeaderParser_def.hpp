...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x640ffc0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x640ff44, size 0x7c, virtual false, abstract: false, final false
