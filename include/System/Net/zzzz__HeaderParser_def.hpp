...
public:
// Declarations
/// @brief Method Invoke, addr 0x62603a0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6260324, size 0x7c, virtual false, abstract: false, final false
