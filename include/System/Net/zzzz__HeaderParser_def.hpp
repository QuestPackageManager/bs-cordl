...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2af12a0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2af11cc, size 0xd4, virtual false, abstract: false, final false
