...
namespace System::Net {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9212), inst: 2 }), TypeDefinitionIndex(TypeDefinitionIndex(9212)),
// TypeDefinitionIndex(TypeDefinitionIndex(2613))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9213)) CS Name: ::System.Net::WebCompletionSource*
