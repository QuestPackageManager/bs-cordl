...
namespace System::Net {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9212), inst: 2 }), TypeDefinitionIndex(TypeDefinitionIndex(2613)),
// TypeDefinitionIndex(TypeDefinitionIndex(9212))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9213)) CS Name: ::System.Net::WebCompletionSource*
...
public:
  ...
  /// @brief Method .ctor, addr 0x29dcae8, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
