...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9212)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9212), inst: 2
// })} Self: TypeDefinitionIndex(TypeDefinitionIndex(9213)) CS Name: ::System.Net::WebCompletionSource*
