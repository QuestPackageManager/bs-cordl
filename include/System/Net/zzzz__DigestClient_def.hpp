...
/// @brief Method Authenticate, addr 0x62ea21c, size 0x2b0, virtual true, abstract: false, final true
...
/// @brief Method CheckExpired, addr 0x62e9a2c, size 0x7f0, virtual false, abstract: false, final false
static inline void CheckExpired(int32_t  count) ;

static inline ::System::Net::DigestClient* New_ctor() ;

/// @brief Method PreAuthenticate, addr 0x62ea4cc, size 0x180, virtual true, abstract: false, final true
inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest*  webRequest, ::System::Net::ICredentials*  credentials) ;

/// @brief Method .ctor, addr 0x62e5c44, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Hashtable* getStaticF_cache() ;

/// @brief Method get_AuthenticationType, addr 0x62ea64c, size 0x44, virtual true, abstract: false, final true
inline ::StringW get_AuthenticationType() ;

/// @brief Method get_Cache, addr 0x62e98c8, size 0x164, virtual false, abstract: false, final false
