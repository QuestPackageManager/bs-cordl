...
// TypeDefinitionIndex(TypeDefinitionIndex(7248)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3393), inst: 904 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3398), inst: 902 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(7235)) CS Name: ::WebOperation::<GetRequestStream>d__50
...
public:
  ...
  /// @brief Method MoveNext, addr 0x29e7604, size 0x21c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x29e7820, size 0x58, virtual true, abstract: false, final true
...
namespace System::Net {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(3391)), TypeDefinitionIndex(TypeDefinitionIndex(3393)), TypeDefinitionIndex(TypeDefinitionIndex(3396)),
// TypeDefinitionIndex(TypeDefinitionIndex(7248)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3393), inst: 904 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(7236)) CS
...
public:
  ...
  /// @brief Method MoveNext, addr 0x29e7878, size 0x58c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x29e7ee0, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method get_Request, addr 0x29e69d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpWebRequest* get_Request();

  /// @brief Method get_Connection, addr 0x29e69e0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebConnection* get_Connection();

  /// @brief Method set_Connection, addr 0x29e69e8, size 0x8, virtual false, abstract: false, final false
  inline void set_Connection(::System::Net::WebConnection* value);

  /// @brief Method get_ServicePoint, addr 0x29e69f0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  /// @brief Method set_ServicePoint, addr 0x29e69f8, size 0x8, virtual false, abstract: false, final false
  inline void set_ServicePoint(::System::Net::ServicePoint* value);

  /// @brief Method get_WriteBuffer, addr 0x29e6a00, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::BufferOffsetSize* get_WriteBuffer();

  /// @brief Method get_IsNtlmChallenge, addr 0x29e6a08, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29e6a10, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aborted, addr 0x29dfae0, size 0x50, virtual false, abstract: false, final false
  inline bool get_Aborted();

  /// @brief Method get_Closed, addr 0x29e6ba4, size 0x2c, virtual false, abstract: false, final false
  inline bool get_Closed();

  /// @brief Method Abort, addr 0x29dfaa0, size 0x40, virtual false, abstract: false, final false
  inline void Abort();

  /// @brief Method Close, addr 0x29e6d8c, size 0xac, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method SetCanceled, addr 0x29e6cc0, size 0xcc, virtual false, abstract: false, final false
  inline void SetCanceled();

  /// @brief Method SetError, addr 0x29e707c, size 0xa4, virtual false, abstract: false, final false
  inline void SetError(::System::Exception* error);

  /// @brief Method SetDisposed, addr 0x29e6bd0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckDisposed, addr 0x29e7120, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowIfDisposed, addr 0x29e71c4, size 0x60, virtual false, abstract: false, final false
  inline void ThrowIfDisposed();

  /// @brief Method ThrowIfDisposed, addr 0x29e3258, size 0x44, virtual false, abstract: false, final false
  inline void ThrowIfDisposed(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ThrowIfClosedOrDisposed, addr 0x29e4728, size 0x60, virtual false, abstract: false, final false
  inline void ThrowIfClosedOrDisposed();

  /// @brief Method ThrowIfClosedOrDisposed, addr 0x29e3f48, size 0x4c, virtual false, abstract: false, final false
  inline void ThrowIfClosedOrDisposed(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method CheckThrowDisposed, addr 0x29e716c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterRequest, addr 0x29e2440, size 0x254, virtual false, abstract: false, final false
  inline void RegisterRequest(::System::Net::ServicePoint* servicePoint, ::System::Net::WebConnection* connection);

  /// @brief Method SetPriorityRequest, addr 0x29e7224, size 0x18c, virtual false, abstract: false, final false
  inline void SetPriorityRequest(::System::Net::WebOperation* operation);

  /// @brief Method GetRequestStream, addr 0x29e73b0, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::IO::Stream*>* GetRequestStream();

  /// @brief Method GetRequestStreamInternal, addr 0x29e74a0, size 0x50, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::Net::WebRequestStream*>* GetRequestStreamInternal();

  /// @brief Method get_WriteStream, addr 0x29e74f0, size 0x18, virtual false, abstract: false, final false
  inline ::System::Net::WebRequestStream* get_WriteStream();

  /// @brief Method GetResponseStream, addr 0x29e7508, size 0x50, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::Net::WebResponseStream*>* GetResponseStream();

  /// @brief Method get_Finished, addr 0x29e7558, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebCompletionSource_1<::System::ValueTuple_2<bool, ::System::Net::WebOperation*>>* get_Finished();

  /// @brief Method Run, addr 0x29e2694, size 0x94, virtual false, abstract: false, final false
  inline void Run();

  /// @brief Method CompleteRequestWritten, addr 0x29e7560, size 0x80, virtual false, abstract: false, final false
  inline void CompleteRequestWritten(::System::Net::WebRequestStream* stream, ::System::Exception* error);

  /// @brief Method Finish, addr 0x29e6e38, size 0x244, virtual false, abstract: false, final false
  inline void Finish(bool ok, ::System::Exception* error);

  /// @brief Method <RegisterRequest>b__48_0, addr 0x29e75e0, size 0x24, virtual false, abstract: false, final false
