...
public:
  ...
  /// @brief Method MoveNext, addr 0x6342e7c, size 0x2bc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x6343138, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x63431b8, size 0x5ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x6343960, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Abort, addr 0x6341f90, size 0x58, virtual false, abstract: false, final false
  inline void Abort();

  /// @brief Method CheckDisposed, addr 0x6342518, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckThrowDisposed, addr 0x63425c0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x634218c, size 0xac, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method CompleteRequestWritten, addr 0x6342dd8, size 0x84, virtual false, abstract: false, final false
  inline void CompleteRequestWritten(::System::Net::WebRequestStream* stream, ::System::Exception* error);

  /// @brief Method Finish, addr 0x6342238, size 0x22c, virtual false, abstract: false, final false
  inline void Finish(bool ok, ::System::Exception* error);

  /// @brief Method GetRequestStream, addr 0x6342b88, size 0xe4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::IO::Stream*>* GetRequestStream();

  /// @brief Method GetRequestStreamInternal, addr 0x6342c6c, size 0x54, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::Net::WebRequestStream*>* GetRequestStreamInternal();

  /// @brief Method GetResponseStream, addr 0x6342cd8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterRequest, addr 0x6342724, size 0x2b8, virtual false, abstract: false, final false
  inline void RegisterRequest(::System::Net::ServicePoint* servicePoint, ::System::Net::WebConnection* connection);

  /// @brief Method Run, addr 0x6342d34, size 0xa4, virtual false, abstract: false, final false
  inline void Run();

  /// @brief Method SetCanceled, addr 0x63420b8, size 0xd4, virtual false, abstract: false, final false
  inline void SetCanceled();

  /// @brief Method SetDisposed, addr 0x6341fe8, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetError, addr 0x6342464, size 0xb4, virtual false, abstract: false, final false
  inline void SetError(::System::Exception* error);

  /// @brief Method SetPriorityRequest, addr 0x63429dc, size 0x1ac, virtual false, abstract: false, final false
  inline void SetPriorityRequest(::System::Net::WebOperation* operation);

  /// @brief Method ThrowIfClosedOrDisposed, addr 0x633f90c, size 0x5c, virtual false, abstract: false, final false
  inline void ThrowIfClosedOrDisposed();

  /// @brief Method ThrowIfClosedOrDisposed, addr 0x633f04c, size 0xac, virtual false, abstract: false, final false
  inline void ThrowIfClosedOrDisposed(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ThrowIfDisposed, addr 0x6342624, size 0x5c, virtual false, abstract: false, final false
  inline void ThrowIfDisposed();

  /// @brief Method ThrowIfDisposed, addr 0x6342680, size 0xa4, virtual false, abstract: false, final false
  inline void ThrowIfDisposed(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method <RegisterRequest>b__48_0, addr 0x6342e5c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6341dcc, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Aborted, addr 0x633f5f4, size 0x64, virtual false, abstract: false, final false
  inline bool get_Aborted();

  /// @brief Method get_Closed, addr 0x6341f64, size 0x2c, virtual false, abstract: false, final false
  inline bool get_Closed();

  /// @brief Method get_Connection, addr 0x6341d9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebConnection* get_Connection();

  /// @brief Method get_Finished, addr 0x6342d2c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebCompletionSource_1<::System::ValueTuple_2<bool, ::System::Net::WebOperation*>>* get_Finished();

  /// @brief Method get_IsNtlmChallenge, addr 0x6341dc4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsNtlmChallenge();

  /// @brief Method get_Request, addr 0x6341d94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpWebRequest* get_Request();

  /// @brief Method get_ServicePoint, addr 0x6341dac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  /// @brief Method get_WriteBuffer, addr 0x6341dbc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::BufferOffsetSize* get_WriteBuffer();

  /// @brief Method get_WriteStream, addr 0x6342cc0, size 0x18, virtual false, abstract: false, final false
  inline ::System::Net::WebRequestStream* get_WriteStream();

  /// @brief Method set_Connection, addr 0x6341da4, size 0x8, virtual false, abstract: false, final false
  inline void set_Connection(::System::Net::WebConnection* value);

  /// @brief Method set_ServicePoint, addr 0x6341db4, size 0x8, virtual false, abstract: false, final false
