...
public:
  ...
  /// @brief Method Complete, addr 0x61f617c, size 0x8, virtual false, abstract: false, final false
  inline void Complete(::System::Net::HttpListenerContext* context);

  /// @brief Method Complete, addr 0x61f6184, size 0x570, virtual false, abstract: false, final false
  inline void Complete(::System::Net::HttpListenerContext* context, bool synch);

  /// @brief Method Complete, addr 0x61f5e14, size 0x210, virtual false, abstract: false, final false
  inline void Complete(::System::Exception* exc);

  /// @brief Method GetContext, addr 0x61f66f4, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Net::HttpListenerContext* GetContext();

  /// @brief Method InvokeCallback, addr 0x61f6024, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61f5db0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AsyncState, addr 0x61f6730, size 0x14, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x61f6744, size 0x134, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously, addr 0x61f6878, size 0x14, virtual true, abstract: false, final true
  inline bool get_CompletedSynchronously();

  /// @brief Method get_IsCompleted, addr 0x61f688c, size 0xdc, virtual true, abstract: false, final true
