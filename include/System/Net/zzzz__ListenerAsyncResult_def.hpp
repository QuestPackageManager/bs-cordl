...
// Write type traits
MARK_REF_T(::System::Net::ListenerAsyncResult*);
DEFINE_IL2CPP_CLASS(::System::Net::ListenerAsyncResult*, "System.Net", "ListenerAsyncResult");
...
public:
  ...
  /// @brief Method Complete, addr 0x6332df0, size 0x8, virtual false, abstract: false, final false
  inline void Complete(::System::Net::HttpListenerContext* context);

  /// @brief Method Complete, addr 0x6332df8, size 0x570, virtual false, abstract: false, final false
  inline void Complete(::System::Net::HttpListenerContext* context, bool synch);

  /// @brief Method Complete, addr 0x6332a88, size 0x210, virtual false, abstract: false, final false
  inline void Complete(::System::Exception* exc);

  /// @brief Method GetContext, addr 0x6333368, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Net::HttpListenerContext* GetContext();

  /// @brief Method InvokeCallback, addr 0x6332c98, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6332a24, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AsyncState, addr 0x63333a4, size 0x14, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x63333b8, size 0x134, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously, addr 0x63334ec, size 0x14, virtual true, abstract: false, final true
  inline bool get_CompletedSynchronously();

  /// @brief Method get_IsCompleted, addr 0x6333500, size 0xdc, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Net::ListenerAsyncResult) == 0x58, "Size mismatch!");
