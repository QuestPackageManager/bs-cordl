...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ListenerAsyncResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ListenerAsyncResult(ListenerAsyncResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ListenerAsyncResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ListenerAsyncResult(ListenerAsyncResultconst&) = delete;
