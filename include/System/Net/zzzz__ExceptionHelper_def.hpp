...
public:
  // Declarations
  /// @brief Method get_MethodNotImplementedException addr 0x28206b0 size 0x88 virtual false final false
  static inline ::System::NotImplementedException* get_MethodNotImplementedException();

  /// @brief Method get_PropertyNotImplementedException addr 0x2820738 size 0x88 virtual false final false
  static inline ::System::NotImplementedException* get_PropertyNotImplementedException();

  /// @brief Method get_TimeoutException addr 0x28207c0 size 0x80 virtual false final false
  static inline ::System::Net::WebException* get_TimeoutException();

  /// @brief Method get_PropertyNotSupportedException addr 0x2820854 size 0x88 virtual false final false
  static inline ::System::NotSupportedException* get_PropertyNotSupportedException();

  /// @brief Method get_RequestAbortedException addr 0x28208dc size 0x94 virtual false final false
