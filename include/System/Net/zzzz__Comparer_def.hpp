...
public:
  ...
  /// @brief Method System.Collections.IComparer.Compare, addr 0x44b40a0, size 0xe4, virtual true, abstract: false, final true
  inline int32_t System_Collections_IComparer_Compare(::System::Object* ol, ::System::Object* _cordl_or);

  /// @brief Method .ctor, addr 0x44b4184, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
