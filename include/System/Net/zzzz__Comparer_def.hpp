...
public:
  ...
  /// @brief Method System.Collections.IComparer.Compare, addr 0x2edf478, size 0xdc, virtual true, abstract: false, final true
  inline int32_t System_Collections_IComparer_Compare(::System::Object* ol, ::System::Object* _cordl_or);

  /// @brief Method .ctor, addr 0x2ede464, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
