...
// TypeDefinitionIndex(TypeDefinitionIndex(3398)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3393), inst: 103 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3398), inst: 103 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(7238)) CS Name: ::WebReadStream::<ReadAsync>d__28
...
public:
  ...
  /// @brief Method MoveNext, addr 0x29e8904, size 0x584, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x29e8e88, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method get_Operation, addr 0x29e7eec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebOperation* get_Operation();

  /// @brief Method get_InnerStream, addr 0x29e7ef4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29d94c0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* innerStream);

  /// @brief Method get_Length, addr 0x29e7efc, size 0x40, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x29e7f3c, size 0x40, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method set_Position, addr 0x29e7f7c, size 0x40, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method get_CanSeek, addr 0x29e7fbc, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanRead, addr 0x29e7fc4, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanWrite, addr 0x29e7fcc, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method SetLength, addr 0x29e7fd4, size 0x40, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Seek, addr 0x29e8014, size 0x40, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method Write, addr 0x29e8054, size 0x40, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method Flush, addr 0x29e8094, size 0x40, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method GetException, addr 0x29e80d4, size 0x168, virtual false, abstract: false, final false
  inline ::System::Exception* GetException(::System::Exception* e);

  /// @brief Method Read, addr 0x29e823c, size 0x268, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method BeginRead, addr 0x29e84a4, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method EndRead, addr 0x29e8674, size 0x124, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* r);

  /// @brief Method ReadAsync, addr 0x29e8798, size 0x120, virtual true, abstract: false, final true
  ...
  /// @brief Method FinishReading, addr 0x29d9794, size 0x104, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FinishReading(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Dispose, addr 0x29e88b8, size 0x4c, virtual true, abstract: false, final false
