...
public:
  ...
  /// @brief Method .ctor addr 0x281ded4 size 0x64 virtual false final false
  inline void _ctor();

  static inline ::System::Net::HttpListenerException* New_ctor(int32_t errorCode, ::StringW message);

  /// @brief Method .ctor addr 0x281df38 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x281df40 size 0x8 virtual false final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_ErrorCode addr 0x281df48 size 0x8 virtual true final false
