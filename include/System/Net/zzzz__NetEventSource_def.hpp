...
public:
  ...
  /// @brief Method get_IsEnabled, addr 0x2987f7c, size 0x64, virtual false, abstract: false, final false
  static inline bool get_IsEnabled();

  /// @brief Method IdOf, addr 0x2988f64, size 0xec, virtual false, abstract: false, final false
  static inline ::StringW IdOf(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x298a1d4, size 0x14, virtual false, abstract: false, final false
  static inline int32_t GetHashCode(::System::Object* value);

  /// @brief Method Format, addr 0x29894f4, size 0x3e0, virtual false, abstract: false, final false
  static inline ::System::Object* Format(::System::Object* value);

  /// @brief Method Format, addr 0x2989050, size 0x340, virtual false, abstract: false, final false
  static inline ::StringW Format(::System::FormattableString* s);

  /// @brief Method WriteEvent, addr 0x2989fc8, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x298a1e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
