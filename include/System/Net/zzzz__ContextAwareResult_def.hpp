...
/// @brief Method <Complete>b__17_0, addr 0x62425e0, size 0x84, virtual false, abstract: false, final false
inline void _Complete_b__17_0(::System::Object*  s) ;

/// @brief Method .ctor, addr 0x62425dc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CaptureOrComplete, addr 0x6241b08, size 0x408, virtual false, abstract: false, final false
inline bool CaptureOrComplete(::ByRef<::System::Threading::ExecutionContext*>  cachedContext, bool  returnContext) ;

/// @brief Method Cleanup, addr 0x6241f10, size 0x9c, virtual true, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CleanupInternal, addr 0x6241834, size 0x4, virtual false, abstract: false, final false
inline void CleanupInternal() ;

/// @brief Method Complete, addr 0x62421e0, size 0x2f0, virtual true, abstract: false, final false
inline void Complete(::System::IntPtr  userToken) ;

/// @brief Method CompleteCallback, addr 0x62424d0, size 0xb8, virtual false, abstract: false, final false
inline void CompleteCallback() ;

/// @brief Method FinishPostingAsyncOp, addr 0x6241acc, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method SafeCaptureIdentity, addr 0x6241830, size 0x4, virtual false, abstract: false, final false
inline void SafeCaptureIdentity() ;

/// @brief Method StartPostingAsyncOp, addr 0x6241908, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* StartPostingAsyncOp() ;

/// @brief Method StartPostingAsyncOp, addr 0x6241910, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6241840, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6241890, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6241838, size 0x8, virtual false, abstract: false, final false
