...
public:
  ...
  /// @brief Method <Complete>b__17_0, addr 0x62b45ec, size 0x84, virtual false, abstract: false, final false
  inline void _Complete_b__17_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x62b45e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CaptureOrComplete, addr 0x62b3b14, size 0x408, virtual false, abstract: false, final false
  inline bool CaptureOrComplete(::ByRef<::System::Threading::ExecutionContext*> cachedContext, bool returnContext);

  /// @brief Method Cleanup, addr 0x62b3f1c, size 0x9c, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CleanupInternal, addr 0x62b3840, size 0x4, virtual false, abstract: false, final false
  inline void CleanupInternal();

  /// @brief Method Complete, addr 0x62b41ec, size 0x2f0, virtual true, abstract: false, final false
  inline void Complete(::System::IntPtr userToken);

  /// @brief Method CompleteCallback, addr 0x62b44dc, size 0xb8, virtual false, abstract: false, final false
  inline void CompleteCallback();

  /// @brief Method FinishPostingAsyncOp, addr 0x62b3ad8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeCaptureIdentity, addr 0x62b383c, size 0x4, virtual false, abstract: false, final false
  inline void SafeCaptureIdentity();

  /// @brief Method StartPostingAsyncOp, addr 0x62b3914, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* StartPostingAsyncOp();

  /// @brief Method StartPostingAsyncOp, addr 0x62b391c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b384c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b389c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b3844, size 0x8, virtual false, abstract: false, final false
