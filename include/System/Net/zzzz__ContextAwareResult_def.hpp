...
public:
  ...
  /// @brief Method <Complete>b__17_0, addr 0x61da394, size 0x84, virtual false, abstract: false, final false
  inline void _Complete_b__17_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x61da390, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CaptureOrComplete, addr 0x61d98bc, size 0x408, virtual false, abstract: false, final false
  inline bool CaptureOrComplete(::ByRef<::System::Threading::ExecutionContext*> cachedContext, bool returnContext);

  /// @brief Method Cleanup, addr 0x61d9cc4, size 0x9c, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CleanupInternal, addr 0x61d95e8, size 0x4, virtual false, abstract: false, final false
  inline void CleanupInternal();

  /// @brief Method Complete, addr 0x61d9f94, size 0x2f0, virtual true, abstract: false, final false
  inline void Complete(::System::IntPtr userToken);

  /// @brief Method CompleteCallback, addr 0x61da284, size 0xb8, virtual false, abstract: false, final false
  inline void CompleteCallback();

  /// @brief Method FinishPostingAsyncOp, addr 0x61d9880, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeCaptureIdentity, addr 0x61d95e4, size 0x4, virtual false, abstract: false, final false
  inline void SafeCaptureIdentity();

  /// @brief Method StartPostingAsyncOp, addr 0x61d96bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* StartPostingAsyncOp();

  /// @brief Method StartPostingAsyncOp, addr 0x61d96c4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61d95f4, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61d9644, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61d95ec, size 0x8, virtual false, abstract: false, final false
