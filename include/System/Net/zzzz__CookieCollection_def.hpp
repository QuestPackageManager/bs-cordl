...
public:
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x62676cc, size 0x94, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x6267760, size 0xc, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6267630, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x62675dc, size 0x54, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x6266878, size 0xc0, virtual false, abstract: false, final false
  inline void Add(::System::Net::Cookie* cookie);

  /// @brief Method Add, addr 0x6266ccc, size 0x2d0, virtual false, abstract: false, final false
  inline void Add(::System::Net::CookieCollection* cookies);

  /// @brief Method CopyTo, addr 0x6267024, size 0x20, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x6266f9c, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf, addr 0x6266938, size 0x394, virtual false, abstract: false, final false
  inline int32_t IndexOf(::System::Net::Cookie* cookie);

  /// @brief Method InternalAdd, addr 0x6267120, size 0x49c, virtual false, abstract: false, final false
  inline int32_t InternalAdd(::System::Net::Cookie* cookie, bool isStrict);

  static inline ::System::Net::CookieCollection* New_ctor();

  /// @brief Method RemoveAt, addr 0x62675bc, size 0x20, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t idx);

  /// @brief Method TimeStamp, addr 0x6267044, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62666e8, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x6266ff8, size 0x20, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsOtherVersionSeen, addr 0x6267118, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsOtherVersionSeen();

  /// @brief Method get_IsSynchronized, addr 0x6267018, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x6266784, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Net::Cookie* get_Item(int32_t index);

  /// @brief Method get_SyncRoot, addr 0x6267020, size 0x4, virtual true, abstract: false, final true
