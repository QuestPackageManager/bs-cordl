...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::System::Net::WebExceptionStatus)>(&::System::Net::WebExceptionMapping::GetWebStatusString)> {
  ...
  constexpr static std::size_t addrs = 0x62ce010;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Net::WebExceptionStatus>::get()}
                    )));
    return ___internal_method;
  }
};
inline void System::Net::WebExceptionMapping::setStaticF_s_Mapping(::ArrayW<::StringW,::Array<::StringW>*>  value)  {
::cordl_internals::setStaticField<::ArrayW<::StringW,::Array<::StringW>*>, "s_Mapping", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::WebExceptionMapping*>::get>(std::forward<::ArrayW<::StringW,::Array<::StringW>*>>(value));
}
