...
public:
  ...
  /// @brief Method Authenticate, addr 0x2ff0f24, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoAuthenticate, addr 0x2ff1030, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureModules, addr 0x2ff0c74, size 0x2a0, virtual false, abstract: false, final false
  static inline void EnsureModules();

  /// @brief Method PreAuthenticate, addr 0x2ff1518, size 0x538, virtual false, abstract: false, final false
