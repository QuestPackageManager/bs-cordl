...
public:
  ...
  /// @brief Method Authenticate, addr 0x44bb1b4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method DoAuthenticate, addr 0x44bb2b4, size 0x4ec, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureModules, addr 0x44baf38, size 0x26c, virtual false, abstract: false, final false
  static inline void EnsureModules();

  /// @brief Method PreAuthenticate, addr 0x44bb7a0, size 0x538, virtual false, abstract: false, final false
