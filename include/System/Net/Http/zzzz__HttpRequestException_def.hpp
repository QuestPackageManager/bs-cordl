...
public:
  ...
  /// @brief Method .ctor, addr 0x2d8a37c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2d895d4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2d86f84, size 0x70, virtual false, abstract: false, final false
