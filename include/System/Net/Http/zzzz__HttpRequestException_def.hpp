...
public:
  ...
  /// @brief Method .ctor, addr 0x2d9cd90, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2d9bfe8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2d99998, size 0x70, virtual false, abstract: false, final false
