...
public:
  ...
  /// @brief Method Dispose, addr 0x4219348, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method SerializeToStreamAsync, addr 0x4219394, size 0xd4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SerializeToStreamAsync(::System::IO::Stream* stream, ::System::Net::TransportContext* context);

  /// @brief Method TryComputeLength, addr 0x4219468, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x421925c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* content);

  /// @brief Method .ctor, addr 0x4219264, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* content, int32_t bufferSize);

  /// @brief Method .ctor, addr 0x42158ec, size 0x28, virtual false, abstract: false, final false
