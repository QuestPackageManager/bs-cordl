...
public:
  ...
  /// @brief Method Dispose, addr 0x60d94d4, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x60d1160, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60d0e10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
