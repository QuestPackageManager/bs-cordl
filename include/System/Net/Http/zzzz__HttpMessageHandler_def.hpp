...
public:
  ...
  /// @brief Method Dispose, addr 0x2d89e68, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2d836b0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d83374, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
