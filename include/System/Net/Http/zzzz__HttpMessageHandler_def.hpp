...
public:
  ...
  /// @brief Method Dispose, addr 0x5f2a194, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5f21e20, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f21ad0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
