...
public:
  ...
  /// @brief Method Dispose, addr 0x5ec2608, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5eba294, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5eb9f44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
