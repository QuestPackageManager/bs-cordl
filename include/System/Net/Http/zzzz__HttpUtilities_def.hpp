...
public:
  // Declarations
  /// @brief Method IsSecureWebSocketScheme, addr 0x5f93eec, size 0x54, virtual false, abstract: false, final false
  static inline bool IsSecureWebSocketScheme(::StringW scheme);

  /// @brief Method IsSupportedSecureScheme, addr 0x5f93e7c, size 0x70, virtual false, abstract: false, final false
