...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HttpUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HttpUtilities(HttpUtilities&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HttpUtilities", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HttpUtilities(HttpUtilitiesconst&) = delete;
