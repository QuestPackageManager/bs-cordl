...
public:
  ...
  /// @brief Method Create, addr 0x422182c, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Net::Http::Headers::NameValueHeaderValue* Create(::StringW name, ::StringW value);

  /// @brief Method Equals, addr 0x4228c24, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x4228ba8, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x4228b50, size 0x58, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x4228db4, size 0x74, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParseElement, addr 0x4228e28, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseParameters, addr 0x4222b5c, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParsePragma, addr 0x4228d04, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4228b30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x422231c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW value);

  /// @brief Method .ctor, addr 0x42227bc, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::NameValueHeaderValue* source);

  /// @brief Method get_Name, addr 0x4228b38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x4228b48, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Name, addr 0x4228b40, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Value, addr 0x42221c0, size 0x15c, virtual false, abstract: false, final false
