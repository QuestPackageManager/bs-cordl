...
public:
  ...
  /// @brief Method .ctor addr 0x26bc3c8 size 0x3c virtual false final false
  ...
  /// @brief Method .ctor addr 0x26bc880 size 0x34 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26c2d0c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method get_Name addr 0x26c2d14 size 0x8 virtual false final false
  inline ::StringW get_Name();

  /// @brief Method set_Name addr 0x26c2d1c size 0x8 virtual false final false
  inline void set_Name(::StringW value);

  /// @brief Method get_Value addr 0x26c2d24 size 0x8 virtual false final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x26bc26c size 0x15c virtual false final false
  inline void set_Value(::StringW value);

  /// @brief Method Create addr 0x26bb948 size 0x70 virtual false final false
  static inline ::System::Net::Http::Headers::NameValueHeaderValue* Create(::StringW name, ::StringW value);

  /// @brief Method System.ICloneable.Clone addr 0x26c2d2c size 0x60 virtual true final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method GetHashCode addr 0x26c2d8c size 0x7c virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x26c2e08 size 0xe0 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method TryParsePragma addr 0x26c2ee8 size 0xb0 virtual false final false
  ...
  /// @brief Method TryParseParameters addr 0x26bcc20 size 0x2c0 virtual false final false
  ...
  /// @brief Method ToString addr 0x26c2f98 size 0x74 virtual true final false
  inline ::StringW ToString();

  /// @brief Method TryParseElement addr 0x26c300c size 0x188 virtual false final false
