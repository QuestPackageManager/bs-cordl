...
public:
  ...
  /// @brief Method Create, addr 0x2c6d310, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Net::Http::Headers::NameValueHeaderValue* Create(::StringW name, ::StringW value);

  /// @brief Method Equals, addr 0x2c74764, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2c746e8, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x2c74688, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x2c748f4, size 0x74, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParseElement, addr 0x2c74968, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseParameters, addr 0x2c6e5e8, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParsePragma, addr 0x2c74844, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c74668, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2c6dd90, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW value);

  /// @brief Method .ctor, addr 0x2c6e248, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::NameValueHeaderValue* source);

  /// @brief Method get_Name, addr 0x2c74670, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x2c74680, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Name, addr 0x2c74678, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Value, addr 0x2c6dc34, size 0x15c, virtual false, abstract: false, final false
