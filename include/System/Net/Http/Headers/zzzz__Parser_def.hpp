...
public:
  // Declarations
  /// @brief Method Check, addr 0x4219e10, size 0xf4, virtual false, abstract: false, final false
  static inline void Check(::StringW s);

  /// @brief Method TryCheck, addr 0x4222478, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__2_0, addr 0x4225394, size 0xf0, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__2_0(::System::Object* l);

  /// @brief Method .ctor, addr 0x422538c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method TryParse, addr 0x4225208, size 0x64, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method TryParse, addr 0x4225484, size 0xe0, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method TryParse, addr 0x4225564, size 0xc8, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ::ByRef<::StringW> result);
...
public:
  // Declarations
  /// @brief Method TryParse, addr 0x422562c, size 0x78, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method TryParse, addr 0x42256a4, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__2_0, addr 0x4225934, size 0x94, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__2_0(::System::Object* l);

  /// @brief Method .ctor, addr 0x422592c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method TryParse, addr 0x422571c, size 0xf0, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method TryParse, addr 0x42259c8, size 0xb0, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method TryParse, addr 0x4225a78, size 0x6c, virtual false, abstract: false, final false
