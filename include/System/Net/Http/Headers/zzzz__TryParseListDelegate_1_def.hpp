...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TryParseListDelegate_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TryParseListDelegate_1(TryParseListDelegate_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TryParseListDelegate_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TryParseListDelegate_1(TryParseListDelegate_1const&) = delete;
