...
public:
  ...
  /// @brief Method ToString, addr 0x5f36170, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5f2dfe8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EndPosition, addr 0x5f36154, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_EndPosition();

  /// @brief Method get_Kind, addr 0x5f36164, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::Token_Type get_Kind();

  /// @brief Method get_StartPosition, addr 0x5f36144, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_StartPosition();

  /// @brief Method op_Implicit, addr 0x5f3616c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_EndPosition, addr 0x5f3615c, size 0x8, virtual false, abstract: false, final false
  inline void set_EndPosition(int32_t value);

  /// @brief Method set_StartPosition, addr 0x5f3614c, size 0x8, virtual false, abstract: false, final false
