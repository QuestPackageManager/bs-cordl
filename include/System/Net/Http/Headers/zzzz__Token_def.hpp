...
/// @brief Method ToString, addr 0x5f36830, size 0x6c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x5f2e6a8, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method get_EndPosition, addr 0x5f36814, size 0x8, virtual false, abstract: false, final false
inline int32_t get_EndPosition() ;

/// @brief Method get_Kind, addr 0x5f36824, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::Http::Headers::Token_Type get_Kind() ;

/// @brief Method get_StartPosition, addr 0x5f36804, size 0x8, virtual false, abstract: false, final false
inline int32_t get_StartPosition() ;

/// @brief Method op_Implicit, addr 0x5f3682c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method set_EndPosition, addr 0x5f3681c, size 0x8, virtual false, abstract: false, final false
inline void set_EndPosition(int32_t  value) ;

/// @brief Method set_StartPosition, addr 0x5f3680c, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "type", ty: "::System::Net::Http::Headers::Token_Type", modifiers: "", def_value: None }, CppParam { name: "_StartPosition_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_EndPosition_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }]
