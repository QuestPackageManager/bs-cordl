...
public:
  ...
  /// @brief Method ToString, addr 0x2c73168, size 0x68, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2c6ba6c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EndPosition, addr 0x2c7314c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_EndPosition();

  /// @brief Method get_Kind, addr 0x2c7315c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::__Token__Type get_Kind();

  /// @brief Method get_StartPosition, addr 0x2c7313c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_StartPosition();

  /// @brief Method op_Implicit, addr 0x2c73164, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_EndPosition, addr 0x2c73154, size 0x8, virtual false, abstract: false, final false
  inline void set_EndPosition(int32_t value);

  /// @brief Method set_StartPosition, addr 0x2c73144, size 0x8, virtual false, abstract: false, final false
