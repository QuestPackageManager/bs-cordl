...
public:
  ...
  /// @brief Method Equals, addr 0x5fab078, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5fab134, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::ProductHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x5fab074, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x5fab3c4, size 0x60, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x5fab198, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x5fab24c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fab050, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Name, addr 0x5fab054, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Version, addr 0x5fab064, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Version();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Name, addr 0x5fab05c, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Version, addr 0x5fab06c, size 0x8, virtual false, abstract: false, final false
