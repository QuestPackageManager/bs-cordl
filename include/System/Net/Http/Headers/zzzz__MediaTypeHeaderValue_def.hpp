...
public:
  ...
  /// @brief Method .ctor, addr 0x2d943d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_CharSet>b__6_0, addr 0x2d943dc, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x2d9404c, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2d94114, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x2d93fec, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x2d94190, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x2d941fc, size 0x174, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ByRef<::System::Net::Http::Headers::MediaTypeHeaderValue*> parsedValue);

  /// @brief Method TryParseMediaType, addr 0x2d93e5c, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d93e54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2d8b15c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW mediaType);

  /// @brief Method .ctor, addr 0x2d93b5c, size 0x278, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::MediaTypeHeaderValue* source);

  /// @brief Method get_CharSet, addr 0x2d89cfc, size 0x114, virtual false, abstract: false, final false
  inline ::StringW get_CharSet();

  /// @brief Method get_Parameters, addr 0x2d93dd4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CharSet, addr 0x2d8b188, size 0xa0, virtual false, abstract: false, final false
  inline void set_CharSet(::StringW value);

  /// @brief Method set_MediaType, addr 0x2d93a1c, size 0x140, virtual false, abstract: false, final false
