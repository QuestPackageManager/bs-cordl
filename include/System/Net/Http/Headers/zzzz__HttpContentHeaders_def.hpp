...
public:
  ...
  /// @brief Method .ctor addr 0x26b76b0 size 0x70 virtual false final false
  inline void _ctor(::System::Net::Http::HttpContent* content);

  /// @brief Method get_ContentLength addr 0x26b52b8 size 0x128 virtual false final false
  inline ::System::Nullable_1<int64_t> get_ContentLength();

  /// @brief Method get_ContentType addr 0x26b8244 size 0x68 virtual false final false
  inline ::System::Net::Http::Headers::MediaTypeHeaderValue* get_ContentType();

  /// @brief Method set_ContentType addr 0x26b9874 size 0x74 virtual false final false
