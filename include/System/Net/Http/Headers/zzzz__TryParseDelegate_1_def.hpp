...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TryParseDelegate_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TryParseDelegate_1(TryParseDelegate_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TryParseDelegate_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TryParseDelegate_1(TryParseDelegate_1const&) = delete;
