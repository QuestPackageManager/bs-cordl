...
public:
  ...
  /// @brief Method ParsedToString, addr 0x422ff8c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x422f658, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* parsed, ::System::Func_2<::System::Object*, ::StringW>* converter);

  /// @brief Method get_HasStringValues, addr 0x422ffc8, size 0x54, virtual false, abstract: false, final false
  inline bool get_HasStringValues();

  /// @brief Method get_Values, addr 0x422f688, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Values();

  /// @brief Method set_Values, addr 0x423001c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x4230040, size 0x2bc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Net::Http::Headers::HttpHeaders__GetEnumerator_d__19* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,System.Collections.Generic.IEnumerable<System.String>>>.get_Current, addr 0x423034c,
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x4230358, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x4230390, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x4230024, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x42302fc, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x422f9ac, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddInternal, addr 0x422f028, size 0x630, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckName, addr 0x422f7e4, size 0x160, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HeaderInfo* CheckName(::StringW name);

  /// @brief Method GetAllHeaderValues, addr 0x422fdb8, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x4221b88, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method GetKnownHeaderKind, addr 0x4224268, size 0xfc, virtual false, abstract: false, final false
  static inline ::System::Net::Http::Headers::HttpHeaderKind GetKnownHeaderKind(::StringW name);

  /// @brief Method GetSingleHeaderString, addr 0x4224364, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x422f9d8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x422f9d4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method ToString, addr 0x422fa3c, size 0x37c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryAddWithoutValidation, addr 0x4222034, size 0xa4, virtual false, abstract: false, final false
  inline bool TryAddWithoutValidation(::StringW name, ::System::Collections::Generic::IEnumerable_1<::StringW>* values);

  /// @brief Method TryCheckName, addr 0x422f700, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x422ef44, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x422cf50, size 0x24, virtual false, abstract: false, final false
