...
public:
  ...
  /// @brief Method ParsedToString, addr 0x4222ac0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x422218c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* parsed, ::System::Func_2<::System::Object*, ::StringW>* converter);

  /// @brief Method get_HasStringValues, addr 0x4222afc, size 0x54, virtual false, abstract: false, final false
  inline bool get_HasStringValues();

  /// @brief Method get_Values, addr 0x42221bc, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_Values();

  /// @brief Method set_Values, addr 0x4222b50, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x4222b74, size 0x2bc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Net::Http::Headers::HttpHeaders__GetEnumerator_d__19* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,System.Collections.Generic.IEnumerable<System.String>>>.get_Current, addr 0x4222e80,
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x4222e8c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x4222ec4, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x4222b58, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x4222e30, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x42224e0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddInternal, addr 0x4221b5c, size 0x630, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckName, addr 0x4222318, size 0x160, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HeaderInfo* CheckName(::StringW name);

  /// @brief Method GetAllHeaderValues, addr 0x42228ec, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x42146bc, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method GetKnownHeaderKind, addr 0x4216d9c, size 0xfc, virtual false, abstract: false, final false
  static inline ::System::Net::Http::Headers::HttpHeaderKind GetKnownHeaderKind(::StringW name);

  /// @brief Method GetSingleHeaderString, addr 0x4216e98, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x422250c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x4222508, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method ToString, addr 0x4222570, size 0x37c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryAddWithoutValidation, addr 0x4214b68, size 0xa4, virtual false, abstract: false, final false
  inline bool TryAddWithoutValidation(::StringW name, ::System::Collections::Generic::IEnumerable_1<::StringW>* values);

  /// @brief Method TryCheckName, addr 0x4222234, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4221a78, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x421fa84, size 0x24, virtual false, abstract: false, final false
