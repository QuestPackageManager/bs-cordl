...
namespace System::Net::Http::Headers {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(14690))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2842168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method TryParseElement, addr 0x2842170, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x28422d8, size 0xb0, virtual false, abstract: false, final false
