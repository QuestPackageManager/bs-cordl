...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MediaTypeWithQualityHeaderValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MediaTypeWithQualityHeaderValue(MediaTypeWithQualityHeaderValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MediaTypeWithQualityHeaderValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MediaTypeWithQualityHeaderValue(MediaTypeWithQualityHeaderValueconst&) = delete;
