...
namespace System::Net::Http::Headers {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14902))}
...
public:
  ...
  /// @brief Method .ctor addr 0x26c2aec size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method TryParseElement addr 0x26c2af4 size 0x168 virtual false final false
  ...
  /// @brief Method TryParse addr 0x26c2c5c size 0xb0 virtual false final false
