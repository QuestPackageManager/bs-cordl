...
public:
  ...
  /// @brief Method TryParse, addr 0x42245e4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x4224478, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4224470, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
