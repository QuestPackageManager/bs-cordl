...
public:
  ...
  /// @brief Method TryParse, addr 0x4225e28, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x4225cbc, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4225cb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
