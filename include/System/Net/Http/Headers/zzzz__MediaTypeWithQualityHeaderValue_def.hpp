...
public:
  ...
  /// @brief Method TryParse, addr 0x2da6fb8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x2da6e50, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2da6e48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
