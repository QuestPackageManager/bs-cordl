...
public:
  ...
  /// @brief Method .ctor, addr 0x283db00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method TryParseElement, addr 0x283db08, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x283dc70, size 0xb0, virtual false, abstract: false, final false
