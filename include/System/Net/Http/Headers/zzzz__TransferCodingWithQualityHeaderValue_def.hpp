...
public:
  ...
  /// @brief Method .ctor, addr 0x2846a50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method TryParse, addr 0x2846a58, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x2846b08, size 0x144, virtual false, abstract: false, final false
