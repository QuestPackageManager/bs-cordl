...
public:
  ...
  /// @brief Method .ctor, addr 0x28423e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method TryParse, addr 0x28423f0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x28424a0, size 0x144, virtual false, abstract: false, final false
