...
namespace System::Net::Http::Headers {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14925))}
...
public:
  ...
  /// @brief Method .ctor addr 0x26c73d4 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method TryParse addr 0x26c73dc size 0xb0 virtual false final false
  ...
  /// @brief Method TryParseElement addr 0x26c748c size 0x144 virtual false final false
