...
public:
  ...
  /// @brief Method Equals, addr 0x421fe54, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x421ff14, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x421fdfc, size 0x58, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x421ff74, size 0x94, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x4220008, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x42200b8, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x421fdf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x421fba0, size 0x1dc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::NameValueWithParametersHeaderValue* source);

  /// @brief Method get_Parameters, addr 0x421fd7c, size 0x78, virtual false, abstract: false, final false
