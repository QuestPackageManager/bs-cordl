...
public:
  ...
  /// @brief Method Equals, addr 0x41c6298, size 0xe8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x41c6380, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::Headers::ViaHeaderValue* New_ctor();

  /// @brief Method System.ICloneable.Clone, addr 0x41c6290, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x41c6758, size 0x110, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x41c644c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x41c64fc, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41c6248, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Comment, addr 0x41c6250, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Comment();

  /// @brief Method get_ProtocolName, addr 0x41c6260, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ProtocolName();

  /// @brief Method get_ProtocolVersion, addr 0x41c6270, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ProtocolVersion();

  /// @brief Method get_ReceivedBy, addr 0x41c6280, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ReceivedBy();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Comment, addr 0x41c6258, size 0x8, virtual false, abstract: false, final false
  inline void set_Comment(::StringW value);

  /// @brief Method set_ProtocolName, addr 0x41c6268, size 0x8, virtual false, abstract: false, final false
  inline void set_ProtocolName(::StringW value);

  /// @brief Method set_ProtocolVersion, addr 0x41c6278, size 0x8, virtual false, abstract: false, final false
  inline void set_ProtocolVersion(::StringW value);

  /// @brief Method set_ReceivedBy, addr 0x41c6288, size 0x8, virtual false, abstract: false, final false
