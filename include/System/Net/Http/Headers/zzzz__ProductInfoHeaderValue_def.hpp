...
public:
  ...
  /// @brief Method Equals, addr 0x5fab490, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5fab550, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x5fab48c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x5fab908, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x5fab578, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseElement, addr 0x5fab72c, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fab468, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5fab424, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::ProductHeaderValue* product);

  /// @brief Method get_Comment, addr 0x5fab46c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Comment();

  /// @brief Method get_Product, addr 0x5fab47c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::ProductHeaderValue* get_Product();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Comment, addr 0x5fab474, size 0x8, virtual false, abstract: false, final false
  inline void set_Comment(::StringW value);

  /// @brief Method set_Product, addr 0x5fab484, size 0x8, virtual false, abstract: false, final false
