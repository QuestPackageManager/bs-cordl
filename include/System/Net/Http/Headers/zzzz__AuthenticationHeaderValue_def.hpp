...
public:
  ...
  /// @brief Method Equals, addr 0x60dcb44, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x60dcbf8, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method System.ICloneable.Clone, addr 0x60dcb40, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x60dd3a4, size 0x60, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x60dcea0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x60dcc64, size 0xc0, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ::by_ref<::System::Net::Http::Headers::AuthenticationHeaderValue*> parsedValue);

  /// @brief Method TryParseElement, addr 0x60dcd2c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60dcb1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x60dcaf0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW scheme, ::StringW parameter);

  /// @brief Method get_Parameter, addr 0x60dcb20, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Parameter();

  /// @brief Method get_Scheme, addr 0x60dcb30, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Scheme();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_Parameter, addr 0x60dcb28, size 0x8, virtual false, abstract: false, final false
  inline void set_Parameter(::StringW value);

  /// @brief Method set_Scheme, addr 0x60dcb38, size 0x8, virtual false, abstract: false, final false
