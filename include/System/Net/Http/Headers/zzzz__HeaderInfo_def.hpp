...
// Write type traits
MARK_REF_T(::System::Net::Http::Headers::HeaderInfo*);
DEFINE_IL2CPP_CLASS(::System::Net::Http::Headers::HeaderInfo*, "System.Net.Http.Headers", "HeaderInfo");
...
public:
  ...
  /// @brief Method CreateCollection, addr 0x60e17a4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60e1798, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Net::Http::Headers::HttpHeaderKind headerKind);

  /// @brief Method get_CustomToString, addr 0x60e17b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::System::Object*, ::StringW>* get_CustomToString();

  /// @brief Method get_Separator, addr 0x60e17c4, size 0x38, virtual true, abstract: false, final false
  inline ::StringW get_Separator();

  /// @brief Method set_CustomToString, addr 0x60e17bc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Http::Headers::HeaderInfo) == 0x28, "Size mismatch!");
