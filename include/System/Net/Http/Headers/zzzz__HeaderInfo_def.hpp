...
/// @brief Field <CustomToString>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__CustomToString_k__BackingField, put=__cordl_internal_set__CustomToString_k__BackingField)) ::System::Func_2<::System::Object*,::StringW>*  _CustomToString_k__BackingField;
...
/// @brief Method CreateCollection, addr 0x5fa66a8, size 0x10, virtual false, abstract: false, final false
...
template<typename T>
static inline ::System::Net::Http::Headers::HeaderInfo* CreateMulti(::StringW  name, ::System::Net::Http::Headers::TryParseListDelegate_1<T>*  elementParser, ::System::Net::Http::Headers::HttpHeaderKind  headerKind, int32_t  minimalCount, ::StringW  separator) ;

/// @brief Method CreateSingle, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::Net::Http::Headers::HeaderInfo* CreateSingle(::StringW  name, ::System::Net::Http::Headers::TryParseDelegate_1<T>*  parser, ::System::Net::Http::Headers::HttpHeaderKind  headerKind, ::System::Func_2<::System::Object*,::StringW>*  toString) ;
...
/// @brief Method .ctor, addr 0x5fa669c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Net::Http::Headers::HttpHeaderKind  headerKind) ;

/// @brief Method get_CustomToString, addr 0x5fa66b8, size 0x8, virtual false, abstract: false, final false
inline ::System::Func_2<::System::Object*,::StringW>* get_CustomToString() ;

/// @brief Method get_Separator, addr 0x5fa66c8, size 0x38, virtual true, abstract: false, final false
inline ::StringW get_Separator() ;

/// @brief Method set_CustomToString, addr 0x5fa66c0, size 0x8, virtual false, abstract: false, final false
