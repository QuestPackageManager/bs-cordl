...
// Write type traits
MARK_REF_T(::System::Net::Http::Headers::HashCodeCalculator*);
DEFINE_IL2CPP_CLASS(::System::Net::Http::Headers::HashCodeCalculator*, "System.Net.Http.Headers", "HashCodeCalculator");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HashCodeCalculator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HashCodeCalculator(HashCodeCalculator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HashCodeCalculator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HashCodeCalculator(HashCodeCalculatorconst&) = delete;
...
static_assert(sizeof(::System::Net::Http::Headers::HashCodeCalculator) == 0x10, "Size mismatch!");
