...
/// @brief Method TryParse, addr 0x5f30938, size 0xb4, virtual false, abstract: false, final false
static inline bool TryParse(::StringW  input, int32_t  minimalCount, ::ByRef<::System::Collections::Generic::List_1<::StringW>*>  result) ;

/// @brief Method TryParseStringElement, addr 0x5f309ec, size 0xd0, virtual false, abstract: false, final false
