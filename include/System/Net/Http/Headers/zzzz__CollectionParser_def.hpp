...
public:
  ...
  /// @brief Method TryParse, addr 0x2d8ddb8, size 0xb0, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, int32_t minimalCount, ByRef<::System::Collections::Generic::List_1<::StringW>*> result);

  /// @brief Method TryParseStringElement, addr 0x2d8de68, size 0xcc, virtual false, abstract: false, final false
