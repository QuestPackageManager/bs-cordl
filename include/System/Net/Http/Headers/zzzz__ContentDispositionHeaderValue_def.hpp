...
public:
  ...
  /// @brief Method .ctor addr 0x2837594 size 0x8 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x283759c size 0x278 virtual false final false
  inline void _ctor(::System::Net::Http::Headers::ContentDispositionHeaderValue* source);

  /// @brief Method get_Parameters addr 0x2837814 size 0x80 virtual false final false
  inline ::System::Collections::Generic::ICollection_1<::System::Net::Http::Headers::NameValueHeaderValue*>* get_Parameters();

  /// @brief Method System.ICloneable.Clone addr 0x28378c8 size 0x60 virtual true final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method Equals addr 0x2837928 size 0xc8 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x28379f0 size 0x7c virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method ToString addr 0x2837a6c size 0x58 virtual true final false
  inline ::StringW ToString();

  /// @brief Method TryParse addr 0x2837ac4 size 0x170 virtual false final false
