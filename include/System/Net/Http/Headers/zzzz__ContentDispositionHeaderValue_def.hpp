...
public:
  ...
  /// @brief Method EncodeBase64Value, addr 0x5f306e0, size 0x1fc, virtual false, abstract: false, final false
  static inline ::StringW EncodeBase64Value(::StringW value);

  /// @brief Method EncodeRFC5987, addr 0x5f30974, size 0x2b4, virtual false, abstract: false, final false
  static inline ::StringW EncodeRFC5987(::StringW value);

  /// @brief Method Equals, addr 0x5f30c84, size 0xd0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5f30ebc, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x5f308dc, size 0x98, virtual false, abstract: false, final false
  inline void SetValue(::StringW key, ::StringW value);

  /// @brief Method System.ICloneable.Clone, addr 0x5f30c28, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ToString, addr 0x5f30f3c, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x5f30f98, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f303fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f2d0d8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW dispositionType);

  /// @brief Method .ctor, addr 0x5f30428, size 0x220, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::Headers::ContentDispositionHeaderValue* source);

  /// @brief Method get_Parameters, addr 0x5f30648, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DispositionType, addr 0x5f30400, size 0x28, virtual false, abstract: false, final false
  inline void set_DispositionType(::StringW value);

  /// @brief Method set_FileName, addr 0x5f2d170, size 0x70, virtual false, abstract: false, final false
  inline void set_FileName(::StringW value);

  /// @brief Method set_FileNameStar, addr 0x5f2d1e0, size 0x70, virtual false, abstract: false, final false
  inline void set_FileNameStar(::StringW value);

  /// @brief Method set_Name, addr 0x5f2d100, size 0x70, virtual false, abstract: false, final false
