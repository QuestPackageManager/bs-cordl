...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TransferCodingHeaderValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TransferCodingHeaderValue(TransferCodingHeaderValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TransferCodingHeaderValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TransferCodingHeaderValue(TransferCodingHeaderValueconst&) = delete;
