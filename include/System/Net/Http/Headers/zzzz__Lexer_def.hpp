...
public:
  ...
  /// @brief Method EatChar, addr 0x5f322b0, size 0x10, virtual false, abstract: false, final false
  inline void EatChar();

  /// @brief Method GetQuotedStringValue, addr 0x5f2f748, size 0x88, virtual false, abstract: false, final false
  inline ::StringW GetQuotedStringValue(::System::Net::Http::Headers::Token start);

  /// @brief Method GetRemainingStringValue, addr 0x5f2dfc0, size 0x28, virtual false, abstract: false, final false
  inline ::StringW GetRemainingStringValue(int32_t position);

  /// @brief Method GetStringValue, addr 0x5f36268, size 0x80, virtual false, abstract: false, final false
  inline ::StringW GetStringValue(::System::Net::Http::Headers::Token start, ::System::Net::Http::Headers::Token end);

  /// @brief Method GetStringValue, addr 0x5f2df40, size 0x80, virtual false, abstract: false, final false
  inline ::StringW GetStringValue(::System::Net::Http::Headers::Token token);

  /// @brief Method IsStarStringValue, addr 0x5f31ab4, size 0xc8, virtual false, abstract: false, final false
  inline bool IsStarStringValue(::System::Net::Http::Headers::Token token);

  /// @brief Method IsValidCharacter, addr 0x5f30e08, size 0xb4, virtual false, abstract: false, final false
  static inline bool IsValidCharacter(char16_t input);

  /// @brief Method IsValidToken, addr 0x5f30d54, size 0xb4, virtual false, abstract: false, final false
  static inline bool IsValidToken(::StringW input);

  static inline ::System::Net::Http::Headers::Lexer* New_ctor(::StringW stream);

  /// @brief Method PeekChar, addr 0x5f32268, size 0x48, virtual false, abstract: false, final false
  inline int32_t PeekChar();

  /// @brief Method Scan, addr 0x5f2dc14, size 0x32c, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::Token Scan(bool recognizeDash);

  /// @brief Method ScanCommentOptional, addr 0x5f36610, size 0x174, virtual false, abstract: false, final false
  inline bool ScanCommentOptional(::ByRef<::StringW> value, ::ByRef<::System::Net::Http::Headers::Token> readToken);

  /// @brief Method TryGetDateValue, addr 0x5f36484, size 0xe8, virtual false, abstract: false, final false
  static inline bool TryGetDateValue(::StringW text, ::ByRef<::System::DateTimeOffset> value);

  /// @brief Method TryGetDateValue, addr 0x5f3638c, size 0xf8, virtual false, abstract: false, final false
  inline bool TryGetDateValue(::System::Net::Http::Headers::Token token, ::ByRef<::System::DateTimeOffset> value);

  /// @brief Method TryGetDoubleValue, addr 0x5f3656c, size 0xa4, virtual false, abstract: false, final false
  inline bool TryGetDoubleValue(::System::Net::Http::Headers::Token token, ::ByRef<double_t> value);

  /// @brief Method TryGetNumericValue, addr 0x5f362e8, size 0xa4, virtual false, abstract: false, final false
  inline bool TryGetNumericValue(::System::Net::Http::Headers::Token token, ::ByRef<int32_t> value);

  /// @brief Method TryGetNumericValue, addr 0x5f31b7c, size 0xa4, virtual false, abstract: false, final false
  inline bool TryGetNumericValue(::System::Net::Http::Headers::Token token, ::ByRef<int64_t> value);

  /// @brief Method TryGetTimeSpanValue, addr 0x5f2f688, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f2d9e4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Position, addr 0x5f36258, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Position, addr 0x5f36260, size 0x8, virtual false, abstract: false, final false
