...
public:
  ...
  /// @brief Method Dispose, addr 0x60df58c, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x60df59c, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method IsAllowedAbsoluteUri, addr 0x60df434, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIsUsed, addr 0x60dbda4, size 0x1c, virtual false, abstract: false, final false
  inline bool SetIsUsed();

  /// @brief Method ToString, addr 0x60df5d0, size 0x288, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60df25c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Headers, addr 0x60d7cb0, size 0x64, virtual false, abstract: false, final false
  inline ::System::Net::Http::Headers::HttpRequestHeaders* get_Headers();

  /// @brief Method get_Method, addr 0x60df424, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::HttpMethod* get_Method();

  /// @brief Method get_RequestUri, addr 0x60df42c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Uri* get_RequestUri();

  /// @brief Method get_Version, addr 0x60d7c48, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Method, addr 0x60df300, size 0xb0, virtual false, abstract: false, final false
  inline void set_Method(::System::Net::Http::HttpMethod* value);

  /// @brief Method set_RequestUri, addr 0x60d8520, size 0xcc, virtual false, abstract: false, final false
