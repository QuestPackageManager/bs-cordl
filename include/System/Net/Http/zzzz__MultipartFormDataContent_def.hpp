...
public:
  // Declarations
  /// @brief Method Add, addr 0x5f9f580, size 0x20, virtual true, abstract: false, final false
  inline void Add(::System::Net::Http::HttpContent* content);

  /// @brief Method Add, addr 0x5f9f684, size 0xb8, virtual false, abstract: false, final false
  inline void Add(::System::Net::Http::HttpContent* content, ::StringW name, ::StringW fileName);

  /// @brief Method AddContentDisposition, addr 0x5f9f5a0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f9f534, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
