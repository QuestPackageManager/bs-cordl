...
public:
// Declarations
/// @brief Method Add, addr 0x5f2d574, size 0x20, virtual true, abstract: false, final false
inline void Add(::System::Net::Http::HttpContent*  content) ;

/// @brief Method Add, addr 0x5f2d678, size 0xb8, virtual false, abstract: false, final false
inline void Add(::System::Net::Http::HttpContent*  content, ::StringW  name, ::StringW  fileName) ;

/// @brief Method AddContentDisposition, addr 0x5f2d594, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5f2d528, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
