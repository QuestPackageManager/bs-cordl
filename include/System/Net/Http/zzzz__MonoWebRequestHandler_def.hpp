...
public:
  ...
  /// @brief Method <CreateWebRequest>b__96_0, addr 0x2d8541c, size 0x4c, virtual false, abstract: false, final false
  inline bool _CreateWebRequest_b__96_0(::StringW l);

  /// @brief Method <GetConnectionKeepAlive>b__95_0, addr 0x2d853cc, size 0x50, virtual false, abstract: false, final false
  inline bool _GetConnectionKeepAlive_b__95_0(::StringW l);

  /// @brief Method <SendAsync>b__99_0, addr 0x2d85468, size 0xb0, virtual false, abstract: false, final false
  inline void _SendAsync_b__99_0(::System::Object* l);

  /// @brief Method .ctor, addr 0x2d853c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2d85518, size 0x1700, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2d86ff4, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateResponseMessage, addr 0x2d84ba0, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWebRequest, addr 0x2d83efc, size 0x7bc, virtual true, abstract: false, final false
  inline ::System::Net::HttpWebRequest* CreateWebRequest(::System::Net::Http::HttpRequestMessage* request);

  /// @brief Method Dispose, addr 0x2d83cf0, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2d83d00, size 0x84, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureModifiability, addr 0x2d83b8c, size 0x60, virtual false, abstract: false, final false
  inline void EnsureModifiability();

  /// @brief Method GetConnectionKeepAlive, addr 0x2d83d84, size 0x110, virtual false, abstract: false, final false
  inline bool GetConnectionKeepAlive(::System::Net::Http::Headers::HttpRequestHeaders* headers);

  /// @brief Method MethodHasBody, addr 0x2d850d0, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendAsync, addr 0x2d851dc, size 0x114, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Net.Http.IMonoHttpClientHandler.SetWebRequestTimeout, addr 0x2d852f0, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2d8315c, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int64_t getStaticF_groupCounter();

  /// @brief Method get_CookieContainer, addr 0x2d83bec, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Net::CookieContainer* get_CookieContainer();

  /// @brief Method get_MaxRequestContentBufferSize, addr 0x2d83c58, size 0x8, virtual true, abstract: false, final true
  inline int64_t get_MaxRequestContentBufferSize();

  /// @brief Method get_SslOptions, addr 0x2d83c60, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method set_SslOptions, addr 0x2d83ccc, size 0x24, virtual true, abstract: false, final true
