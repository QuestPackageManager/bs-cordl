...
public:
  ...
  /// @brief Method <CreateWebRequest>b__96_1, addr 0x5f964d4, size 0x58, virtual false, abstract: false, final false
  inline bool _CreateWebRequest_b__96_1(::StringW l);

  /// @brief Method <GetConnectionKeepAlive>b__95_0, addr 0x5f96480, size 0x54, virtual false, abstract: false, final false
  inline bool _GetConnectionKeepAlive_b__95_0(::StringW l);

  /// @brief Method <SendAsync>b__99_0, addr 0x5f9652c, size 0x8c, virtual false, abstract: false, final false
  inline void _SendAsync_b__99_0(::System::Object* l);

  /// @brief Method .ctor, addr 0x5f9647c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5f965b8, size 0x1860, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f981f0, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateResponseMessage, addr 0x5f95c90, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWebRequest, addr 0x5f94ef4, size 0x8c8, virtual true, abstract: false, final false
  inline ::System::Net::HttpWebRequest* CreateWebRequest(::System::Net::Http::HttpRequestMessage* request);

  /// @brief Method Dispose, addr 0x5f94cc8, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5f94cdc, size 0x94, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureModifiability, addr 0x5f94b34, size 0x58, virtual false, abstract: false, final false
  inline void EnsureModifiability();

  /// @brief Method GetConnectionKeepAlive, addr 0x5f94d70, size 0x11c, virtual false, abstract: false, final false
  inline bool GetConnectionKeepAlive(::System::Net::Http::Headers::HttpRequestHeaders* headers);

  /// @brief Method MethodHasBody, addr 0x5f96160, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendAsync, addr 0x5f9626c, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Net.Http.IMonoHttpClientHandler.SetWebRequestTimeout, addr 0x5f96364, size 0x60, virtual true, abstract: false, final true
  inline void System_Net_Http_IMonoHttpClientHandler_SetWebRequestTimeout(::System::TimeSpan timeout);

  /// @brief Method <CreateWebRequest>b__96_0, addr 0x5f963c4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f93f94, size 0x1d4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int64_t getStaticF_groupCounter();

  /// @brief Method get_CookieContainer, addr 0x5f94bb0, size 0x68, virtual true, abstract: false, final true
  inline ::System::Net::CookieContainer* get_CookieContainer();

  /// @brief Method get_MaxRequestContentBufferSize, addr 0x5f94c18, size 0x8, virtual true, abstract: false, final true
  inline int64_t get_MaxRequestContentBufferSize();

  /// @brief Method get_SslOptions, addr 0x5f94c44, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method set_AllowAutoRedirect, addr 0x5f94b8c, size 0x24, virtual true, abstract: false, final true
  inline void set_AllowAutoRedirect(bool value);

  /// @brief Method set_SslOptions, addr 0x5f94ca4, size 0x24, virtual true, abstract: false, final true
  inline void set_SslOptions(::System::Net::Security::SslClientAuthenticationOptions* value);

  /// @brief Method set_UseProxy, addr 0x5f94c20, size 0x24, virtual true, abstract: false, final true
