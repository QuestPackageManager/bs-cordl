...
public:
  ...
  /// @brief Method .ctor, addr 0x5f94b28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <set_ClientCertificateOptions>b__23_1, addr 0x5f94b2c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateDefaultHandler, addr 0x5f93f40, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Net::Http::IMonoHttpClientHandler* CreateDefaultHandler();

  /// @brief Method Dispose, addr 0x5f94428, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method SendAsync, addr 0x5f94a00, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method SetWebRequestTimeout, addr 0x5f94948, size 0xb8, virtual false, abstract: false, final false
  inline void SetWebRequestTimeout(::System::TimeSpan timeout);

  /// @brief Method ThrowForModifiedManagedSslOptionsIfStarted, addr 0x5f944f0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f94168, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f9418c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::IMonoHttpClientHandler* handler);

  /// @brief Method <set_ClientCertificateOptions>b__23_0, addr 0x5f94ac0, size 0x14, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate*
  ...
  /// @brief Method get_ClientCertificateOptions, addr 0x5f945f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::ClientCertificateOption get_ClientCertificateOptions();

  /// @brief Method get_ClientCertificates, addr 0x5f94600, size 0x1d8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates();

  /// @brief Method set_AllowAutoRedirect, addr 0x5f94890, size 0xb8, virtual false, abstract: false, final false
  inline void set_AllowAutoRedirect(bool value);

  /// @brief Method set_ClientCertificateOptions, addr 0x5f941a0, size 0x288, virtual false, abstract: false, final false
  inline void set_ClientCertificateOptions(::System::Net::Http::ClientCertificateOption value);

  /// @brief Method set_UseProxy, addr 0x5f947d8, size 0xb8, virtual false, abstract: false, final false
