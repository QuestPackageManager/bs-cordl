...
public:
  ...
  /// @brief Method .ctor, addr 0x4217b80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <set_ClientCertificateOptions>b__23_1, addr 0x4217b88, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateDefaultHandler, addr 0x4217120, size 0x50, virtual false, abstract: false, final false
  static inline ::System::Net::Http::IMonoHttpClientHandler* CreateDefaultHandler();

  /// @brief Method Dispose, addr 0x4217614, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method SendAsync, addr 0x4217a54, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetWebRequestTimeout, addr 0x42179a8, size 0xac, virtual false, abstract: false, final false
  inline void SetWebRequestTimeout(::System::TimeSpan timeout);

  /// @brief Method ThrowForModifiedManagedSslOptionsIfStarted, addr 0x42176cc, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4217320, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4217358, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Http::IMonoHttpClientHandler* handler);

  /// @brief Method <set_ClientCertificateOptions>b__23_0, addr 0x4217b10, size 0x14, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate*
  ...
  /// @brief Method get_ClientCertificateOptions, addr 0x42177d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Http::ClientCertificateOption get_ClientCertificateOptions();

  /// @brief Method get_ClientCertificates, addr 0x42177d8, size 0x1d0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates();

  /// @brief Method set_ClientCertificateOptions, addr 0x4217390, size 0x284, virtual false, abstract: false, final false
