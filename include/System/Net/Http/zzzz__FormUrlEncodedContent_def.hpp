...
public:
// Declarations
/// @brief Method EncodeContent, addr 0x5f269dc, size 0x52c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeContent(::System::Collections::Generic::IEnumerable_1<::System::Collections::Generic::KeyValuePair_2<::StringW,::StringW>>*  nameValueCollection) ;

static inline ::System::Net::Http::FormUrlEncodedContent* New_ctor(::System::Collections::Generic::IEnumerable_1<::System::Collections::Generic::KeyValuePair_2<::StringW,::StringW>>*  nameValueCollection) ;

/// @brief Method SerializeValue, addr 0x5f26f88, size 0xdc, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> SerializeValue(::StringW  value) ;

/// @brief Method .ctor, addr 0x5f2692c, size 0xb0, virtual false, abstract: false, final false
