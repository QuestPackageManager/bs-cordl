...
public:
  // Declarations
  /// @brief Method EncodeContent, addr 0x5f989e8, size 0x52c, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeValue, addr 0x5f98f94, size 0xdc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> SerializeValue(::StringW value);

  /// @brief Method .ctor, addr 0x5f98938, size 0xb0, virtual false, abstract: false, final false
