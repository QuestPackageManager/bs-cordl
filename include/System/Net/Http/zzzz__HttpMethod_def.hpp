...
public:
  ...
  /// @brief Method Equals, addr 0x42274d4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x42274b0, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::System::Net::Http::HttpMethod* other);

  /// @brief Method GetHashCode, addr 0x4227560, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::System::Net::Http::HttpMethod* New_ctor(::StringW method);

  /// @brief Method ToString, addr 0x4227580, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4227254, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Get, addr 0x42273d0, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Net::Http::HttpMethod* get_Get();

  /// @brief Method get_Method, addr 0x4227428, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method get_Post, addr 0x4227430, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4227488, size 0x28, virtual false, abstract: false, final false
