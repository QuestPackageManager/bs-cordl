...
public:
  // Declarations
  /// @brief Method GetByteArray, addr 0x60dca08, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60dc8fc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW content);

  /// @brief Method .ctor, addr 0x60dc908, size 0x100, virtual false, abstract: false, final false
