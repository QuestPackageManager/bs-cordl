...
namespace System::Net::Http {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14857))}
...
public:
  ...
  /// @brief Method .ctor addr 0x26b9658 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0x26b9664 size 0x108 virtual false final false
  inline void _ctor(::StringW content, ::System::Text::Encoding* encoding, ::StringW mediaType);

  /// @brief Method GetByteArray addr 0x26b976c size 0x3c virtual false final false
