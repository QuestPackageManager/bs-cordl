...
public:
  // Declarations
  /// @brief Method GetByteArray, addr 0x421af7c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x421ae78, size 0x104, virtual false, abstract: false, final false
