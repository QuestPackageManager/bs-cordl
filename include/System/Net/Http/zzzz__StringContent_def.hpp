...
public:
// Declarations
/// @brief Method GetByteArray, addr 0x5fa190c, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5fa1800, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  content) ;

/// @brief Method .ctor, addr 0x5fa180c, size 0x100, virtual false, abstract: false, final false
