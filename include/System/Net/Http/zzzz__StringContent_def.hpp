...
public:
  ...
  /// @brief Method .ctor, addr 0x283466c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2834678, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::StringW content, ::System::Text::Encoding* encoding, ::StringW mediaType);

  /// @brief Method GetByteArray, addr 0x2834780, size 0x3c, virtual false, abstract: false, final false
