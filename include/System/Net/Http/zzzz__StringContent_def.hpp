...
public:
  // Declarations
  /// @brief Method GetByteArray, addr 0x2c6b134, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c6b02c, size 0x108, virtual false, abstract: false, final false
