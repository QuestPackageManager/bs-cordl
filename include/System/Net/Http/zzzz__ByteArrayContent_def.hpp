...
public:
  ...
  /// @brief Method SerializeToStreamAsync, addr 0x2d67f68, size 0x28, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SerializeToStreamAsync(::System::IO::Stream* stream, ::System::Net::TransportContext* context);

  /// @brief Method TryComputeLength, addr 0x2d67f90, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d67ee0, size 0x80, virtual false, abstract: false, final false
