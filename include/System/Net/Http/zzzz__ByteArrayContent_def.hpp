...
// Write type traits
MARK_REF_T(::System::Net::Http::ByteArrayContent*);
DEFINE_IL2CPP_CLASS(::System::Net::Http::ByteArrayContent*, "System.Net.Http", "ByteArrayContent");
...
public:
  ...
  /// @brief Method CreateContentReadStreamAsync, addr 0x60dacd0, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method SerializeToStreamAsync, addr 0x60dad90, size 0x24, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SerializeToStreamAsync(::System::IO::Stream* stream, ::System::Net::TransportContext* context);

  /// @brief Method TryComputeLength, addr 0x60dadb4, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60dac6c, size 0x60, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ByteArrayContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ByteArrayContent(ByteArrayContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ByteArrayContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ByteArrayContent(ByteArrayContentconst&) = delete;
...
static_assert(sizeof(::System::Net::Http::ByteArrayContent) == 0x40, "Size mismatch!");
