...
public:
  ...
  /// @brief Method MoveNext, addr 0x5f9e770, size 0xd58, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f9f4c8, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0x5f9dcd0, size 0x150, virtual true, abstract: false, final false
  inline void Add(::System::Net::Http::HttpContent* content);

  /// @brief Method Dispose, addr 0x5f9de20, size 0x15c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetEnumerator, addr 0x5f9e660, size 0x88, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::System::Net::Http::HttpContent*>* GetEnumerator();

  /// @brief Method IsValidRFC2049, addr 0x5f9db74, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeToStreamAsync, addr 0x5f9df7c, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SerializeToStreamAsync(::System::IO::Stream* stream, ::System::Net::TransportContext* context);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5f9e6e8, size 0x88, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method TryComputeLength, addr 0x5f9e048, size 0x618, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f9d7ac, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::StringW subtype);

  /// @brief Method .ctor, addr 0x5f9d864, size 0x310, virtual false, abstract: false, final false
