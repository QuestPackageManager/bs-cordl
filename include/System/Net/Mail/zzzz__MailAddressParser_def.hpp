...
public:
  // Declarations
  /// @brief Method NormalizeOrThrow, addr 0x622d1c8, size 0xec, virtual false, abstract: false, final false
  static inline ::StringW NormalizeOrThrow(::StringW input);

  /// @brief Method ParseAddress, addr 0x622c4f4, size 0x2c, virtual false, abstract: false, final false
  static inline ::System::Net::Mail::MailAddress* ParseAddress(::StringW data);

  /// @brief Method ParseAddress, addr 0x622c520, size 0x368, virtual false, abstract: false, final false
  static inline ::System::Net::Mail::MailAddress* ParseAddress(::StringW data, bool expectMultipleAddresses, ::ByRef<int32_t> index);

  /// @brief Method ParseDisplayName, addr 0x622cca0, size 0x1f4, virtual false, abstract: false, final false
  static inline ::StringW ParseDisplayName(::StringW data, ::ByRef<int32_t> index, bool expectMultipleAddresses);

  /// @brief Method ParseDomain, addr 0x622c8e4, size 0xfc, virtual false, abstract: false, final false
  static inline ::StringW ParseDomain(::StringW data, ::ByRef<int32_t> index);

  /// @brief Method ParseLocalPart, addr 0x622c9e0, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCfwsAndThrowIfIncomplete, addr 0x622c888, size 0x5c, virtual false, abstract: false, final false
