...
public:
  // Declarations
  /// @brief Method NormalizeOrThrow, addr 0x2f5170c, size 0xec, virtual false, abstract: false, final false
  static inline ::StringW NormalizeOrThrow(::StringW input);

  /// @brief Method ParseAddress, addr 0x2f509e4, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Net::Mail::MailAddress* ParseAddress(::StringW data);

  /// @brief Method ParseAddress, addr 0x2f50a14, size 0x378, virtual false, abstract: false, final false
  static inline ::System::Net::Mail::MailAddress* ParseAddress(::StringW data, bool expectMultipleAddresses, ByRef<int32_t> index);

  /// @brief Method ParseDisplayName, addr 0x2f511a8, size 0x204, virtual false, abstract: false, final false
  static inline ::StringW ParseDisplayName(::StringW data, ByRef<int32_t> index, bool expectMultipleAddresses);

  /// @brief Method ParseDomain, addr 0x2f50dec, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW ParseDomain(::StringW data, ByRef<int32_t> index);

  /// @brief Method ParseLocalPart, addr 0x2f50ed4, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCfwsAndThrowIfIncomplete, addr 0x2f50d8c, size 0x60, virtual false, abstract: false, final false
