...
public:
  // Declarations
  /// @brief Method ParseAddress, addr 0x29065fc, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Net::Mail::MailAddress* ParseAddress(::StringW data);

  /// @brief Method ParseAddress, addr 0x290662c, size 0x378, virtual false, abstract: false, final false
  static inline ::System::Net::Mail::MailAddress* ParseAddress(::StringW data, bool expectMultipleAddresses, ByRef<int32_t> index);

  /// @brief Method ReadCfwsAndThrowIfIncomplete, addr 0x29069a4, size 0x60, virtual false, abstract: false, final false
  static inline int32_t ReadCfwsAndThrowIfIncomplete(::StringW data, int32_t index);

  /// @brief Method ParseDomain, addr 0x2906a04, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW ParseDomain(::StringW data, ByRef<int32_t> index);

  /// @brief Method ParseLocalPart, addr 0x2906aec, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDisplayName, addr 0x2906dc0, size 0x204, virtual false, abstract: false, final false
  static inline ::StringW ParseDisplayName(::StringW data, ByRef<int32_t> index, bool expectMultipleAddresses);

  /// @brief Method NormalizeOrThrow, addr 0x2907324, size 0xec, virtual false, abstract: false, final false
