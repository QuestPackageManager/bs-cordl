...
public:
  // Declarations
  /// @brief Method ReadCfwsReverse, addr 0x2a4dcf8, size 0x2e0, virtual false, abstract: false, final false
  static inline int32_t ReadCfwsReverse(::StringW data, int32_t index);

  /// @brief Method ReadFwsReverse, addr 0x2a4ccbc, size 0x20c, virtual false, abstract: false, final false
