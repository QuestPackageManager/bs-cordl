...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DomainLiteralReader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DomainLiteralReader(DomainLiteralReader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DomainLiteralReader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DomainLiteralReader(DomainLiteralReaderconst&) = delete;
