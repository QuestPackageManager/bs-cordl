...
public:
  ...
  /// @brief Method Equals, addr 0x2f31998, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x2f319fc, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2f318f4, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f315d0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW address);

  /// @brief Method .ctor, addr 0x2f315dc, size 0x24c, virtual false, abstract: false, final false
  inline void _ctor(::StringW address, ::StringW displayName, ::System::Text::Encoding* displayNameEncoding);

  /// @brief Method .ctor, addr 0x2f30cbc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Address, addr 0x2f31830, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_Address();

  /// @brief Method get_DisplayName, addr 0x2f31828, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_SmtpAddress, addr 0x2f3187c, size 0x78, virtual false, abstract: false, final false
