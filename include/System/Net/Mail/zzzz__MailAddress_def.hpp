...
// Write type traits
MARK_REF_T(::System::Net::Mail::MailAddress*);
DEFINE_IL2CPP_CLASS(::System::Net::Mail::MailAddress*, "System.Net.Mail", "MailAddress");
...
public:
  ...
  /// @brief Method Equals, addr 0x636ffbc, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x6370020, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x636ff20, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x636fc20, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW address);

  /// @brief Method .ctor, addr 0x636fc2c, size 0x224, virtual false, abstract: false, final false
  inline void _ctor(::StringW address, ::StringW displayName, ::System::Text::Encoding* displayNameEncoding);

  /// @brief Method .ctor, addr 0x636f320, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Address, addr 0x636fe58, size 0x50, virtual false, abstract: false, final false
  inline ::StringW get_Address();

  /// @brief Method get_DisplayName, addr 0x636fe50, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_SmtpAddress, addr 0x636fea8, size 0x78, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MailAddress", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MailAddress(MailAddress&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MailAddress", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MailAddress(MailAddressconst&) = delete;
...
static_assert(sizeof(::System::Net::Mail::MailAddress) == 0x30, "Size mismatch!");
