...
public:
  // Declarations
  /// @brief Method IsValidQtext, addr 0x636fb64, size 0xbc, virtual false, abstract: false, final false
  static inline bool IsValidQtext(bool allowUnicode, char16_t ch);

  /// @brief Method ReadReverseQuoted, addr 0x636f740, size 0x1bc, virtual false, abstract: false, final false
  static inline int32_t ReadReverseQuoted(::StringW data, int32_t index, bool permitUnicode);

  /// @brief Method ReadReverseUnQuoted, addr 0x636f8fc, size 0x19c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QuotedStringFormatReader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QuotedStringFormatReader(QuotedStringFormatReader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QuotedStringFormatReader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QuotedStringFormatReader(QuotedStringFormatReaderconst&) = delete;
