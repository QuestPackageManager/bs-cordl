...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Net::Authorization* (::System::Net::IAuthenticationModule::*)(::StringW, ::System::Net::WebRequest*, ::System::Net::ICredentials*)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Net::IAuthenticationModule*>(), { ::i2c::class_of<::System::Net::IAuthenticationModule*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Net::Authorization* (::System::Net::IAuthenticationModule::*)(::System::Net::WebRequest*, ::System::Net::ICredentials*)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Net::IAuthenticationModule*>(), { ::i2c::class_of<::System::Net::IAuthenticationModule*>(), 1 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::System::Net::IAuthenticationModule::*)()>(&::System::Net::IAuthenticationModule::get_AuthenticationType)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Net::IAuthenticationModule*>(), { ::i2c::class_of<::System::Net::IAuthenticationModule*>(), 2 }));
    return ___internal_method;
  }
};
inline ::System::Net::Authorization* System::Net::IAuthenticationModule::Authenticate(::StringW challenge, ::System::Net::WebRequest* request, ::System::Net::ICredentials* credentials) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Net::IAuthenticationModule*>(), 0 })));
...
inline ::System::Net::Authorization* System::Net::IAuthenticationModule::PreAuthenticate(::System::Net::WebRequest* request, ::System::Net::ICredentials* credentials) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Net::IAuthenticationModule*>(), 1 })));
...
inline ::StringW System::Net::IAuthenticationModule::get_AuthenticationType() {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Net::IAuthenticationModule*>(), 2 })));
