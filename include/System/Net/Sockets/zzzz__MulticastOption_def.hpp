...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MulticastOption", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MulticastOption(MulticastOption&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MulticastOption", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MulticastOption(MulticastOptionconst&) = delete;
