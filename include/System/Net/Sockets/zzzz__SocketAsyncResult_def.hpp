...
public:
  ...
  /// @brief Method <Complete>b__27_0, addr 0x6150ea4, size 0x7c, virtual false, abstract: false, final false
  inline void _Complete_b__27_0(::System::Object* state);

  /// @brief Method .ctor, addr 0x6150ea0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckIfThrowDelayedException, addr 0x6150d94, size 0xa0, virtual false, abstract: false, final false
  inline void CheckIfThrowDelayedException();

  /// @brief Method Complete, addr 0x614bd48, size 0x1f4, virtual false, abstract: false, final false
  inline void Complete();

  /// @brief Method Complete, addr 0x614b530, size 0x8, virtual false, abstract: false, final false
  inline void Complete(::System::Exception* e);

  /// @brief Method Complete, addr 0x6150e40, size 0xc, virtual false, abstract: false, final false
  inline void Complete(::System::Exception* e, bool synch);

  /// @brief Method Complete, addr 0x614b538, size 0x8, virtual false, abstract: false, final false
  inline void Complete(::System::Net::Sockets::Socket* s);

  /// @brief Method Complete, addr 0x614b7b0, size 0xc, virtual false, abstract: false, final false
  inline void Complete(::System::Net::Sockets::Socket* s, int32_t total);

  /// @brief Method Complete, addr 0x6150e38, size 0x8, virtual false, abstract: false, final false
  inline void Complete(bool synch);

  /// @brief Method Complete, addr 0x614c864, size 0x8, virtual false, abstract: false, final false
  inline void Complete(int32_t total);

  /// @brief Method CompleteDisposed, addr 0x6150e34, size 0x4, virtual true, abstract: false, final false
  inline void CompleteDisposed();

  /// @brief Method Init, addr 0x6150c34, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x615097c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6150cfc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ErrorCode, addr 0x6150d0c, size 0x88, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::SocketError get_ErrorCode();

  /// @brief Method get_Handle, addr 0x6150c0c, size 0x28, virtual false, abstract: false, final false
