...
public:
  // Declarations
  /// @brief Method Equals, addr 0x61b54b0, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetHashCode, addr 0x61b554c, size 0x30, virtual true, abstract: false, final false
