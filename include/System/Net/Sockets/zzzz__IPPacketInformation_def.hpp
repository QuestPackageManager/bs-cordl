...
public:
  // Declarations
  /// @brief Method Equals, addr 0x614d924, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetHashCode, addr 0x614d9c0, size 0x30, virtual true, abstract: false, final false
