...
public:
  ...
  /// @brief Method WSAGetLastError_icall, addr 0x6227a30, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6227a4c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6227aa0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(int32_t error, ::StringW message);

  /// @brief Method .ctor, addr 0x6223cb0, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(int32_t errorCode);

  /// @brief Method .ctor, addr 0x6227ad8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x6227048, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::SocketError socketError);

  /// @brief Method get_ErrorCode, addr 0x6227ae0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ErrorCode();

  /// @brief Method get_Message, addr 0x6227ae8, size 0x94, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_SocketErrorCode, addr 0x622564c, size 0x8, virtual false, abstract: false, final false
