...
public:
  ...
  /// @brief Method WSAGetLastError_icall, addr 0x4400594, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4400598, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44005b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t error, ::StringW message);

  /// @brief Method .ctor, addr 0x43fcd60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t errorCode);

  /// @brief Method .ctor, addr 0x44005c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method .ctor, addr 0x43ffd34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::SocketError socketError);

  /// @brief Method get_ErrorCode, addr 0x44005c8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ErrorCode();

  /// @brief Method get_Message, addr 0x44005d0, size 0x90, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_SocketErrorCode, addr 0x43fe4a8, size 0x8, virtual false, abstract: false, final false
