...
public:
  ...
  /// @brief Method BeginReceive, addr 0x6229748, size 0x13c, virtual false, abstract: false, final false
  inline ::System::IAsyncResult* BeginReceive(::System::AsyncCallback* requestCallback, ::System::Object* state);

  /// @brief Method BeginSend, addr 0x62294a4, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForBroadcast, addr 0x62293c0, size 0x58, virtual false, abstract: false, final false
  inline void CheckForBroadcast(::System::Net::IPAddress* ipAddress);

  /// @brief Method Dispose, addr 0x622932c, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x622933c, size 0x84, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndReceive, addr 0x6229884, size 0x1f8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EndReceive(::System::IAsyncResult* asyncResult, ::ByRef<::System::Net::IPEndPoint*> remoteEP);

  /// @brief Method EndSend, addr 0x62296a0, size 0xa8, virtual false, abstract: false, final false
  inline int32_t EndSend(::System::IAsyncResult* asyncResult);

  /// @brief Method FreeResources, addr 0x62292d8, size 0x54, virtual false, abstract: false, final false
  inline void FreeResources();

  /// @brief Method IsBroadcast, addr 0x6229418, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReceiveAsync, addr 0x6229bc4, size 0x138, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::Net::Sockets::UdpReceiveResult>* ReceiveAsync();

  /// @brief Method SendAsync, addr 0x6229a7c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method <ReceiveAsync>b__65_0, addr 0x6229cfc, size 0x4, virtual false, abstract: false, final false
  inline ::System::IAsyncResult* _ReceiveAsync_b__65_0(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method <ReceiveAsync>b__65_1, addr 0x6229d00, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6229124, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::AddressFamily family);

  /// @brief Method createClientSocket, addr 0x622925c, size 0x6c, virtual false, abstract: false, final false
  inline void createClientSocket();

  /// @brief Method get_Client, addr 0x62292c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::Socket* get_Client();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_Client, addr 0x62292d0, size 0x8, virtual false, abstract: false, final false
