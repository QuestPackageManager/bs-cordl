...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TcpListener", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TcpListener(TcpListener&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TcpListener", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TcpListener(TcpListenerconst&) = delete;
