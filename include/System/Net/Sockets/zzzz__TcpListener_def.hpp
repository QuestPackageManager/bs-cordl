...
/// @brief Method BeginAcceptTcpClient, addr 0x61b6f4c, size 0x74, virtual false, abstract: false, final false
inline ::System::IAsyncResult* BeginAcceptTcpClient(::System::AsyncCallback*  callback, ::System::Object*  state) ;

/// @brief Method EndAcceptTcpClient, addr 0x61b6fc0, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x61b6d10, size 0x8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Start, addr 0x61b6d18, size 0x170, virtual false, abstract: false, final false
inline void Start(int32_t  backlog) ;

/// @brief Method Stop, addr 0x61b6e88, size 0xc4, virtual false, abstract: false, final false
inline void Stop() ;
...
/// @brief Method .ctor, addr 0x61b6b68, size 0x180, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPAddress*  localaddr, int32_t  port) ;

/// @brief Method get_LocalEndpoint, addr 0x61b6ce8, size 0x28, virtual false, abstract: false, final false
