...
public:
  ...
  /// @brief Method BeginAcceptTcpClient, addr 0x2a48e00, size 0xb4, virtual false, abstract: false, final false
  inline ::System::IAsyncResult* BeginAcceptTcpClient(::System::AsyncCallback* callback, ::System::Object* state);

  /// @brief Method EndAcceptTcpClient, addr 0x2a48eb4, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x2a48ba8, size 0x8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Start, addr 0x2a48bb0, size 0x18c, virtual false, abstract: false, final false
  inline void Start(int32_t backlog);

  /// @brief Method Stop, addr 0x2a48d3c, size 0xc4, virtual false, abstract: false, final false
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x2a489d8, size 0x1a0, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::IPAddress* localaddr, int32_t port);

  /// @brief Method get_LocalEndpoint, addr 0x2a48b78, size 0x30, virtual false, abstract: false, final false
