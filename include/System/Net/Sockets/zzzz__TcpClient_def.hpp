...
/// @brief Method BeginConnect, addr 0x61b65cc, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Close, addr 0x61b68b8, size 0x98, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method Connect, addr 0x61b5df8, size 0x6e8, virtual false, abstract: false, final false
inline void Connect(::StringW  hostname, int32_t  port) ;

/// @brief Method Connect, addr 0x61b64e0, size 0xec, virtual false, abstract: false, final false
inline void Connect(::System::Net::IPEndPoint*  remoteEP) ;

/// @brief Method ConnectAsync, addr 0x61b6610, size 0x184, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* ConnectAsync(::StringW  host, int32_t  port) ;

/// @brief Method Dispose, addr 0x61b6b08, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x61b6950, size 0x1b8, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndConnect, addr 0x61b65e4, size 0x2c, virtual false, abstract: false, final false
inline void EndConnect(::System::IAsyncResult*  asyncResult) ;

/// @brief Method Finalize, addr 0x61b6b18, size 0x50, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetStream, addr 0x61b6794, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61b5c5c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x61b5db8, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::Socket*  acceptedSocket) ;

/// @brief Method .ctor, addr 0x61b5c68, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::AddressFamily  family) ;

/// @brief Method get_Client, addr 0x61b5dd0, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::Sockets::Socket* get_Client() ;

/// @brief Method get_Connected, addr 0x61b5de0, size 0x18, virtual false, abstract: false, final false
inline bool get_Connected() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method initialize, addr 0x61b5d48, size 0x70, virtual false, abstract: false, final false
inline void initialize() ;

/// @brief Method set_Client, addr 0x61b5dd8, size 0x8, virtual false, abstract: false, final false
