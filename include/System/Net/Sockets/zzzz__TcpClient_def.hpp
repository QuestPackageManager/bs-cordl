...
namespace System::Net::Sockets {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(7347))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2900ce0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Net::Sockets::TcpClient* New_ctor(::System::Net::Sockets::AddressFamily family);

  /// @brief Method .ctor, addr 0x2900d00, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2900e84, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* acceptedSocket);

  /// @brief Method get_Client, addr 0x2900ec8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::Socket* get_Client();

  /// @brief Method set_Client, addr 0x2900ed0, size 0x8, virtual false, abstract: false, final false
  inline void set_Client(::System::Net::Sockets::Socket* value);

  /// @brief Method get_Connected, addr 0x2900ed8, size 0x1c, virtual false, abstract: false, final false
  inline bool get_Connected();

  /// @brief Method Connect, addr 0x2900ef4, size 0x6d0, virtual false, abstract: false, final false
  inline void Connect(::StringW hostname, int32_t port);

  /// @brief Method Connect, addr 0x29015c4, size 0x10c, virtual false, abstract: false, final false
  inline void Connect(::System::Net::IPEndPoint* remoteEP);

  /// @brief Method BeginConnect, addr 0x29016d0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndConnect, addr 0x290173c, size 0x48, virtual false, abstract: false, final false
  inline void EndConnect(::System::IAsyncResult* asyncResult);

  /// @brief Method ConnectAsync, addr 0x2901784, size 0x16c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ConnectAsync(::StringW host, int32_t port);

  /// @brief Method GetStream, addr 0x29018f0, size 0x14c, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::NetworkStream* GetStream();

  /// @brief Method Close, addr 0x2901a3c, size 0xa4, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x2901ae0, size 0x194, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Dispose, addr 0x2901c74, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Finalize, addr 0x2901c84, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method initialize, addr 0x2900e10, size 0x74, virtual false, abstract: false, final false
