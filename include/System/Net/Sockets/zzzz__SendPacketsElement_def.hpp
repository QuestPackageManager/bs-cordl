...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SendPacketsElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SendPacketsElement(SendPacketsElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SendPacketsElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SendPacketsElement(SendPacketsElementconst&) = delete;
