...
/// @brief Method RegisterForBlockingSyscall, addr 0x61b855c, size 0x168, virtual false, abstract: false, final false
inline void RegisterForBlockingSyscall() ;

/// @brief Method ReleaseHandle, addr 0x61b8050, size 0x50c, virtual true, abstract: false, final false
inline bool ReleaseHandle() ;

/// @brief Method UnRegisterForBlockingSyscall, addr 0x61b86c4, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61b7ff8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x61b7f00, size 0xf8, virtual false, abstract: false, final false
