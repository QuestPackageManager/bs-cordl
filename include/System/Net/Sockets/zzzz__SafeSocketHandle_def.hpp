...
public:
  ...
  /// @brief Method RegisterForBlockingSyscall, addr 0x2e2bdf8, size 0x148, virtual false, abstract: false, final false
  inline void RegisterForBlockingSyscall();

  /// @brief Method ReleaseHandle, addr 0x2e2b82c, size 0x5cc, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method UnRegisterForBlockingSyscall, addr 0x2e2bf40, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e2b760, size 0xcc, virtual false, abstract: false, final false
