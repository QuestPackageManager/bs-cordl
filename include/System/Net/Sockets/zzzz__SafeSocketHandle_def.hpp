...
// Write type traits
MARK_REF_T(::System::Net::Sockets::SafeSocketHandle*);
DEFINE_IL2CPP_CLASS(::System::Net::Sockets::SafeSocketHandle*, "System.Net.Sockets", "SafeSocketHandle");
...
public:
  ...
  /// @brief Method RegisterForBlockingSyscall, addr 0x63671dc, size 0x168, virtual false, abstract: false, final false
  inline void RegisterForBlockingSyscall();

  /// @brief Method ReleaseHandle, addr 0x6366cd0, size 0x50c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method UnRegisterForBlockingSyscall, addr 0x6367344, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6366c78, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6366b80, size 0xf8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Sockets::SafeSocketHandle) == 0x38, "Size mismatch!");
