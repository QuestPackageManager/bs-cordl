...
public:
  ...
  /// @brief Method RegisterForBlockingSyscall, addr 0x61b7e9c, size 0x168, virtual false, abstract: false, final false
  inline void RegisterForBlockingSyscall();

  /// @brief Method ReleaseHandle, addr 0x61b7990, size 0x50c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method UnRegisterForBlockingSyscall, addr 0x61b8004, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61b7938, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x61b7840, size 0xf8, virtual false, abstract: false, final false
