...
public:
  ...
  /// @brief Method BeginRead, addr 0x2f23844, size 0x324, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x2f23e6c, size 0x324, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x2f23630, size 0x68, virtual false, abstract: false, final false
  inline void Close(int32_t timeout);

  /// @brief Method Dispose, addr 0x2f23698, size 0x78, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x2f23be8, size 0x21c, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x2f24210, size 0x21c, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Finalize, addr 0x2f237a0, size 0xa4, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x2f255ec, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x2f255f0, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2f227e8, size 0x30c, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Read, addr 0x2f22b5c, size 0x274, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<uint8_t> destination);

  /// @brief Method ReadAsync, addr 0x2f24494, size 0x3c0, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadAsync, addr 0x2f24b10, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadByte, addr 0x2f22ec0, size 0x84, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x2f22798, size 0x50, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x2f25678, size 0x50, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method SetSocketTimeoutOption, addr 0x2f22268, size 0x1cc, virtual false, abstract: false, final false
  inline void SetSocketTimeoutOption(::System::Net::Sockets::SocketShutdown mode, int32_t timeout, bool silent);

  /// @brief Method Write, addr 0x2f22f44, size 0x30c, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Write, addr 0x2f232b8, size 0x274, virtual true, abstract: false, final false
  inline void Write(::System::ReadOnlySpan_1<uint8_t> source);

  /// @brief Method WriteAsync, addr 0x2f24d68, size 0x374, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAsync, addr 0x2f25398, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteByte, addr 0x2f235b8, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f21dcc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket);

  /// @brief Method .ctor, addr 0x2f21dd8, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket, ::System::IO::FileAccess access, bool ownsSocket);

  /// @brief Method .ctor, addr 0x2f21f88, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket, bool ownsSocket);

  /// @brief Method get_CanRead, addr 0x2f21f94, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x2f21f9c, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanTimeout, addr 0x2f21fac, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanTimeout();

  /// @brief Method get_CanWrite, addr 0x2f21fa4, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_DataAvailable, addr 0x2f22544, size 0xa8, virtual true, abstract: false, final false
  inline bool get_DataAvailable();

  /// @brief Method get_InternalSocket, addr 0x2f25818, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::Socket* get_InternalSocket();

  /// @brief Method get_Length, addr 0x2f226a8, size 0x50, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x2f226f8, size 0x50, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_ReadTimeout, addr 0x2f21fb4, size 0x88, virtual true, abstract: false, final false
  inline int32_t get_ReadTimeout();

  /// @brief Method get_WriteTimeout, addr 0x2f22434, size 0x88, virtual true, abstract: false, final false
  inline int32_t get_WriteTimeout();

  /// @brief Method set_Position, addr 0x2f22748, size 0x50, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method set_ReadTimeout, addr 0x2f221e0, size 0x88, virtual true, abstract: false, final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method set_WriteTimeout, addr 0x2f224bc, size 0x88, virtual true, abstract: false, final false
