...
public:
  ...
  /// @brief Method BeginRead, addr 0x43fe66c, size 0x304, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x43fec50, size 0x304, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x43fe45c, size 0x64, virtual false, abstract: false, final false
  inline void Close(int32_t timeout);

  /// @brief Method Dispose, addr 0x43fe4c0, size 0x78, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x43fe9e8, size 0x208, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x43fefcc, size 0x208, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Finalize, addr 0x43fe5c8, size 0xa4, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x4400380, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x4400384, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x43fd6cc, size 0x2ec, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Read, addr 0x43fda18, size 0x258, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<uint8_t> destination);

  /// @brief Method ReadAsync, addr 0x43ff234, size 0x370, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadAsync, addr 0x43ff88c, size 0x244, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadByte, addr 0x43fdd70, size 0x64, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x43fd680, size 0x4c, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x440040c, size 0x4c, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method SetSocketTimeoutOption, addr 0x43fd178, size 0x1c4, virtual false, abstract: false, final false
  inline void SetSocketTimeoutOption(::System::Net::Sockets::SocketShutdown mode, int32_t timeout, bool silent);

  /// @brief Method Write, addr 0x43fddd4, size 0x2ec, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Write, addr 0x43fe120, size 0x258, virtual true, abstract: false, final false
  inline void Write(::System::ReadOnlySpan_1<uint8_t> source);

  /// @brief Method WriteAsync, addr 0x43ffad0, size 0x380, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAsync, addr 0x4400140, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteByte, addr 0x43fe404, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43fccf8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket);

  /// @brief Method .ctor, addr 0x43fcd04, size 0x1a0, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket, ::System::IO::FileAccess access, bool ownsSocket);

  /// @brief Method .ctor, addr 0x43fcea4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::Socket* socket, bool ownsSocket);

  /// @brief Method get_CanRead, addr 0x43fceb0, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x43fceb8, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanTimeout, addr 0x43fcec8, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanTimeout();

  /// @brief Method get_CanWrite, addr 0x43fcec0, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_DataAvailable, addr 0x43fd448, size 0xa0, virtual true, abstract: false, final false
  inline bool get_DataAvailable();

  /// @brief Method get_InternalSocket, addr 0x4400598, size 0x94, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::Socket* get_InternalSocket();

  /// @brief Method get_Length, addr 0x43fd59c, size 0x4c, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x43fd5e8, size 0x4c, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_ReadTimeout, addr 0x43fced0, size 0x88, virtual true, abstract: false, final false
  inline int32_t get_ReadTimeout();

  /// @brief Method get_WriteTimeout, addr 0x43fd33c, size 0x88, virtual true, abstract: false, final false
  inline int32_t get_WriteTimeout();

  /// @brief Method set_Position, addr 0x43fd634, size 0x4c, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method set_ReadTimeout, addr 0x43fd0f4, size 0x84, virtual true, abstract: false, final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method set_WriteTimeout, addr 0x43fd3c4, size 0x84, virtual true, abstract: false, final false
