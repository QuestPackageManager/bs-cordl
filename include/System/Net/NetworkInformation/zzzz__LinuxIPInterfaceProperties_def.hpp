...
public:
  ...
  /// @brief Method ParseRouteInfo, addr 0x2f1e350, size 0x488, virtual false, abstract: false, final false
  inline ::System::Net::NetworkInformation::IPAddressCollection* ParseRouteInfo(::StringW iface);

  /// @brief Method .ctor, addr 0x2f1e2e0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_GatewayAddresses, addr 0x2f1e7d8, size 0x3c, virtual true, abstract: false, final false
