...
/// @brief Method ParseRouteInfo, addr 0x61a01d4, size 0x484, virtual false, abstract: false, final false
inline ::System::Net::NetworkInformation::IPAddressCollection* ParseRouteInfo(::StringW  iface) ;

/// @brief Method .ctor, addr 0x61a016c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method get_GatewayAddresses, addr 0x61a0658, size 0x3c, virtual true, abstract: false, final false
