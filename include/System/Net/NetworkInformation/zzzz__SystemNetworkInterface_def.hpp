...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::SystemNetworkInterface*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::SystemNetworkInterface*, "System.Net.NetworkInformation", "SystemNetworkInterface");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SystemNetworkInterface", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SystemNetworkInterface(SystemNetworkInterface&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SystemNetworkInterface", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SystemNetworkInterface(SystemNetworkInterfaceconst&) = delete;
...
static_assert(sizeof(::System::Net::NetworkInformation::SystemNetworkInterface) == 0x10, "Size mismatch!");
