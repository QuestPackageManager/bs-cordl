...
public:
  // Declarations
  /// @brief Method Create, addr 0x2b3c640, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b3c694, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
