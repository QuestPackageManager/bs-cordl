...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::NetworkInterfaceFactory*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::NetworkInterfaceFactory*, "System.Net.NetworkInformation", "NetworkInterfaceFactory");
...
public:
  // Declarations
  /// @brief Method Create, addr 0x63512e4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6351330, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Net::NetworkInformation::NetworkInterfaceFactory) == 0x10, "Size mismatch!");
