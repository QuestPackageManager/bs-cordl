...
public:
  // Declarations
  /// @brief Method Create, addr 0x2f20af0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f20b44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
