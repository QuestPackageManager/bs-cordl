...
public:
  ...
  /// @brief Method Create, addr 0x43e6dc0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x43e9be0, size 0x48, virtual false, abstract: false, final false
