...
public:
  ...
  /// @brief Method Create, addr 0x2ada54c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x2add3bc, size 0x48, virtual false, abstract: false, final false
