...
public:
  ...
  /// @brief Method Create, addr 0x2f1e234, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x2f210a4, size 0x48, virtual false, abstract: false, final false
