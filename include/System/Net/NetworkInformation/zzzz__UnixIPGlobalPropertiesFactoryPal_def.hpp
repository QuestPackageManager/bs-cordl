...
public:
  ...
  /// @brief Method Create, addr 0x43f9200, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x43fc020, size 0x48, virtual false, abstract: false, final false
