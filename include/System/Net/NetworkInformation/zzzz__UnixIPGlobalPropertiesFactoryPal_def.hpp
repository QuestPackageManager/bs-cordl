...
public:
  ...
  /// @brief Method Create, addr 0x43ebcbc, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x43eeadc, size 0x48, virtual false, abstract: false, final false
