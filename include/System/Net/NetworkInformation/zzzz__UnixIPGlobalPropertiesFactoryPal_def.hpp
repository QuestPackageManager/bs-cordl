...
public:
  ...
  /// @brief Method Create, addr 0x3023b30, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x30269a0, size 0x48, virtual false, abstract: false, final false
