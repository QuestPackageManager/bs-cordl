...
public:
  ...
  /// @brief Method Create, addr 0x62120bc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x6214c04, size 0x4c, virtual false, abstract: false, final false
