...
namespace System::Net::NetworkInformation {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(7259))]
...
public:
  ...
  /// @brief Method getdomainname, addr 0x29f4e84, size 0x8c, virtual false, abstract: false, final false
  static inline int32_t getdomainname(::ArrayW<uint8_t, ::Array<uint8_t>*> name, int32_t len);

  /// @brief Method get_DomainName, addr 0x29f4f10, size 0x17c, virtual true, abstract: false, final false
  inline ::StringW get_DomainName();

  static inline ::System::Net::NetworkInformation::CommonUnixIPGlobalProperties* New_ctor();

  /// @brief Method .ctor, addr 0x29f508c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
