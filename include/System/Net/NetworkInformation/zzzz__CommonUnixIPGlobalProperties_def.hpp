...
public:
  ...
  /// @brief Method .ctor, addr 0x6351654, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DomainName, addr 0x63514b4, size 0x1a0, virtual true, abstract: false, final false
  inline ::StringW get_DomainName();

  /// @brief Method getdomainname, addr 0x6351428, size 0x8c, virtual false, abstract: false, final false
