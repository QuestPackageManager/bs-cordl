...
public:
  ...
  /// @brief Method .ctor, addr 0x43fbdc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DomainName, addr 0x43fbc38, size 0x18c, virtual true, abstract: false, final false
  inline ::StringW get_DomainName();

  /// @brief Method getdomainname, addr 0x43fbbac, size 0x8c, virtual false, abstract: false, final false
