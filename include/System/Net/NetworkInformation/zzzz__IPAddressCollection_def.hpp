...
public:
  ...
  /// @brief Method Add, addr 0x6352078, size 0x50, virtual true, abstract: false, final false
  inline void Add(::System::Net::IPAddress* address);

  /// @brief Method Clear, addr 0x6352244, size 0x50, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x635212c, size 0x64, virtual true, abstract: false, final false
  inline bool Contains(::System::Net::IPAddress* address);

  /// @brief Method CopyTo, addr 0x6351fb0, size 0x6c, virtual true, abstract: false, final false
  inline void CopyTo(::ArrayW<::System::Net::IPAddress*> array, int32_t offset);

  /// @brief Method GetEnumerator, addr 0x63521a0, size 0x54, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerator_1<::System::Net::IPAddress*>* GetEnumerator();

  /// @brief Method InternalAdd, addr 0x63520c8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x63521f4, size 0x50, virtual true, abstract: false, final false
  inline bool Remove(::System::Net::IPAddress* address);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6352190, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6351f3c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x635201c, size 0x54, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x6352070, size 0x8, virtual true, abstract: false, final false
