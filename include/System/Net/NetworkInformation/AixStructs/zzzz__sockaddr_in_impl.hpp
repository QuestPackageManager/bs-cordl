...
// Ctor Parameters [CppParam { name: "sin_len", ty: "uint8_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sin_family", ty: "uint8_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "sin_port", ty: "uint16_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sin_addr", ty: "uint32_t", modifiers: "",
