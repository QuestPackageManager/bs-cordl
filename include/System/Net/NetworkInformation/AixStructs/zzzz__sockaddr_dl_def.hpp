...
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::AixStructs::sockaddr_dl, "System.Net.NetworkInformation.AixStructs", "sockaddr_dl");
// Dependencies
namespace System::Net::NetworkInformation::AixStructs {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method Read, addr 0x634e9dc, size 0x138, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::NetworkInformation::AixStructs::sockaddr_dl) == 0x10, "Size mismatch!");
