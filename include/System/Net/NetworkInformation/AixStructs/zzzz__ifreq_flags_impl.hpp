...
// Ctor Parameters [CppParam { name: "ifr_name", ty: "::System::Net::NetworkInformation::AixStructs::ifreq_flags__ifr_name_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "ifru_flags", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Net::NetworkInformation::AixStructs::ifreq_flags::ifreq_flags(::System::Net::NetworkInformation::AixStructs::ifreq_flags__ifr_name_e__FixedBuffer  ifr_name, uint32_t  ifru_flags) noexcept  {
