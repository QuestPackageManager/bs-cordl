...
public:
  ...
  /// @brief Method .ctor, addr 0x6356e8c, size 0x168, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MibIPGlobalProperties", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MibIPGlobalProperties(MibIPGlobalProperties&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MibIPGlobalProperties", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MibIPGlobalProperties(MibIPGlobalPropertiesconst&) = delete;
