...
public:
  ...
  __declspec(property(get = getStaticF_wsChars, put = setStaticF_wsChars)) ::ArrayW<char16_t, ::Array<char16_t>*> wsChars;
  ...
  /// @brief Method .ctor, addr 0x61a2334, size 0x168, virtual false, abstract: false, final false
