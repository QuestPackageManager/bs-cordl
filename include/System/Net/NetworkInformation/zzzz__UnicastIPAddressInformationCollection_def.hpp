...
public:
  ...
  /// @brief Method Add, addr 0x619de50, size 0x50, virtual true, abstract: false, final false
  inline void Add(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method Clear, addr 0x619e01c, size 0x50, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x619df04, size 0x64, virtual true, abstract: false, final false
  inline bool Contains(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method CopyTo, addr 0x619dd88, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x619df78, size 0x54, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerator_1<::System::Net::NetworkInformation::UnicastIPAddressInformation*>* GetEnumerator();

  /// @brief Method InternalAdd, addr 0x619dea0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x619dfcc, size 0x50, virtual true, abstract: false, final false
  inline bool Remove(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x619df68, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x619dd14, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x619ddf4, size 0x54, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x619de48, size 0x8, virtual true, abstract: false, final false
