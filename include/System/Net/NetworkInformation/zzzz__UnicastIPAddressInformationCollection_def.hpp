...
public:
  ...
  /// @brief Method .ctor addr 0x286f474 size 0x7c virtual false final false
  inline void _ctor();

  /// @brief Method CopyTo addr 0x286f4f0 size 0x68 virtual true final false
  ...
  /// @brief Method get_Count addr 0x286f558 size 0x50 virtual true final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly addr 0x286f5a8 size 0x8 virtual true final false
  inline bool get_IsReadOnly();

  /// @brief Method Add addr 0x286f5b0 size 0x60 virtual true final false
  inline void Add(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method InternalAdd addr 0x286f610 size 0x58 virtual false final false
  inline void InternalAdd(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method Contains addr 0x286f668 size 0x58 virtual true final false
  inline bool Contains(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x286f6c0 size 0x10 virtual true final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method GetEnumerator addr 0x286f6d0 size 0x50 virtual true final false
  inline ::System::Collections::Generic::IEnumerator_1<::System::Net::NetworkInformation::UnicastIPAddressInformation*>* GetEnumerator();

  /// @brief Method Remove addr 0x286f720 size 0x60 virtual true final false
  inline bool Remove(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method Clear addr 0x286f780 size 0x60 virtual true final false
  inline void Clear();
