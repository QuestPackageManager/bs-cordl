...
public:
  ...
  /// @brief Method Add, addr 0x43ea224, size 0x58, virtual true, abstract: false, final false
  inline void Add(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method Clear, addr 0x43ea3e4, size 0x58, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x43ea2d4, size 0x58, virtual true, abstract: false, final false
  inline bool Contains(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method CopyTo, addr 0x43ea164, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x43ea33c, size 0x50, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerator_1<::System::Net::NetworkInformation::UnicastIPAddressInformation*>* GetEnumerator();

  /// @brief Method InternalAdd, addr 0x43ea27c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x43ea38c, size 0x58, virtual true, abstract: false, final false
  inline bool Remove(::System::Net::NetworkInformation::UnicastIPAddressInformation* address);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x43ea32c, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x43ea0e8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x43ea1cc, size 0x50, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x43ea21c, size 0x8, virtual true, abstract: false, final false
