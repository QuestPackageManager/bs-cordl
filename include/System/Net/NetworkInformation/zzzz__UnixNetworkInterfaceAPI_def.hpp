...
public:
  ...
  /// @brief Method .ctor, addr 0x6211f8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method freeifaddrs, addr 0x62126a4, size 0x7c, virtual false, abstract: false, final false
  static inline void freeifaddrs(::System::IntPtr ifap);

  /// @brief Method getifaddrs, addr 0x6212724, size 0x7c, virtual false, abstract: false, final false
