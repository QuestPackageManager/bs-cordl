...
public:
  ...
  /// @brief Method .ctor, addr 0x619f8c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method freeifaddrs, addr 0x619ffd8, size 0x7c, virtual false, abstract: false, final false
  static inline void freeifaddrs(::System::IntPtr ifap);

  /// @brief Method getifaddrs, addr 0x61a0058, size 0x7c, virtual false, abstract: false, final false
