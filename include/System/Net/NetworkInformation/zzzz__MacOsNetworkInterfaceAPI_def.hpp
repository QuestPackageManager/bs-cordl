...
public:
  ...
  /// @brief Method GetAllNetworkInterfaces, addr 0x6350720, size 0x994, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6350714, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x634ed28, size 0x8, virtual false, abstract: false, final false
