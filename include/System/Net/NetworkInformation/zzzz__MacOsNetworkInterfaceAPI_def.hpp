...
public:
  ...
  /// @brief Method GetAllNetworkInterfaces, addr 0x6355f38, size 0x994, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6355f2c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6354540, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MacOsNetworkInterfaceAPI", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MacOsNetworkInterfaceAPI(MacOsNetworkInterfaceAPI&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MacOsNetworkInterfaceAPI", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MacOsNetworkInterfaceAPI(MacOsNetworkInterfaceAPIconst&) = delete;
