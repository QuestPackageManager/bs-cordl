...
public:
  ...
  /// @brief Method .ctor, addr 0x29f4020, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI* New_ctor(int32_t AF_INET6);

  /// @brief Method .ctor, addr 0x29f2450, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t AF_INET6);

  /// @brief Method GetAllNetworkInterfaces, addr 0x29f4040, size 0xa6c, virtual true, abstract: false, final false
