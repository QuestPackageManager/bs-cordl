...
public:
  ...
  /// @brief Method GetAllNetworkInterfaces, addr 0x3042de8, size 0xa6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3042dc8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x30411f8, size 0x28, virtual false, abstract: false, final false
