...
public:
  ...
  /// @brief Method .ctor, addr 0x63522ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IPInterfaceProperties", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IPInterfaceProperties(IPInterfaceProperties&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IPInterfaceProperties", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPInterfaceProperties(IPInterfacePropertiesconst&) = delete;
