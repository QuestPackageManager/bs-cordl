...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::SystemGatewayIPAddressInformation*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::SystemGatewayIPAddressInformation*, "System.Net.NetworkInformation", "SystemGatewayIPAddressInformation");
...
public:
  ...
  /// @brief Method ToGatewayIpAddressInformationCollection, addr 0x63525bc, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63525b4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SystemGatewayIPAddressInformation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SystemGatewayIPAddressInformation(SystemGatewayIPAddressInformation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SystemGatewayIPAddressInformation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SystemGatewayIPAddressInformation(SystemGatewayIPAddressInformationconst&) = delete;
...
static_assert(sizeof(::System::Net::NetworkInformation::SystemGatewayIPAddressInformation) == 0x18, "Size mismatch!");
