...
public:
  ...
  /// @brief Method ToGatewayIpAddressInformationCollection, addr 0x619da64, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x619da5c, size 0x8, virtual false, abstract: false, final false
