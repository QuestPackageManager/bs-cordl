...
public:
  ...
  /// @brief Method ToGatewayIpAddressInformationCollection, addr 0x43ee298, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43ee270, size 0x28, virtual false, abstract: false, final false
