...
public:
  ...
  /// @brief Method ToGatewayIpAddressInformationCollection, addr 0x43e9dfc, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43e9dd4, size 0x28, virtual false, abstract: false, final false
