...
public:
  ...
  /// @brief Method .ctor, addr 0x6354534, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FreeBSDNetworkInterfaceAPI", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FreeBSDNetworkInterfaceAPI(FreeBSDNetworkInterfaceAPI&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FreeBSDNetworkInterfaceAPI", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FreeBSDNetworkInterfaceAPI(FreeBSDNetworkInterfaceAPIconst&) = delete;
