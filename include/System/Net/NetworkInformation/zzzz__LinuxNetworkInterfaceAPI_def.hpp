...
public:
  // Declarations
  /// @brief Method FreeInterfaceAddresses, addr 0x62126a0, size 0x4, virtual false, abstract: false, final false
  static inline void FreeInterfaceAddresses(::System::IntPtr ifap);

  /// @brief Method GetAllNetworkInterfaces, addr 0x62127a0, size 0xae8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInterfaceAddresses, addr 0x6212720, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x621336c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
