...
public:
// Declarations
/// @brief Method FreeInterfaceAddresses, addr 0x61a0694, size 0x4, virtual false, abstract: false, final false
static inline void FreeInterfaceAddresses(::System::IntPtr  ifap) ;

/// @brief Method GetAllNetworkInterfaces, addr 0x61a0794, size 0xae8, virtual true, abstract: false, final false
...
/// @brief Method GetInterfaceAddresses, addr 0x61a0714, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61a1360, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
