...
public:
  // Declarations
  /// @brief Method FreeInterfaceAddresses, addr 0x2f1e814, size 0x4, virtual false, abstract: false, final false
  static inline void FreeInterfaceAddresses(void* ifap);

  /// @brief Method GetAllNetworkInterfaces, addr 0x2f1e914, size 0xaf4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInterfaceAddresses, addr 0x2f1e894, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f1f4e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
