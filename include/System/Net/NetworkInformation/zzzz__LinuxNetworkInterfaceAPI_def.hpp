...
namespace System::Net::NetworkInformation {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(7301))]
...
public:
  // Declarations
  /// @brief Method FreeInterfaceAddresses, addr 0x29f2a58, size 0x4, virtual false, abstract: false, final false
  static inline void FreeInterfaceAddresses(void* ifap);

  /// @brief Method GetInterfaceAddresses, addr 0x29f2ad8, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetInterfaceAddresses(ByRef<void*> ifap);

  /// @brief Method GetAllNetworkInterfaces, addr 0x29f2b58, size 0xaf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29f3724, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
