...
public:
  // Declarations
  /// @brief Method FreeInterfaceAddresses, addr 0x29edfb4, size 0x4, virtual false, abstract: false, final false
  static inline void FreeInterfaceAddresses(void* ifap);

  /// @brief Method GetInterfaceAddresses, addr 0x29ee034, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetInterfaceAddresses(ByRef<void*> ifap);

  /// @brief Method GetAllNetworkInterfaces, addr 0x29ee0b4, size 0xaf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29eec80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
