...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetworkInformationException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetworkInformationException(NetworkInformationException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetworkInformationException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetworkInformationException(NetworkInformationExceptionconst&) = delete;
