...
public:
  ...
  /// @brief Method ParseRouteInfo_icall, addr 0x43ea470, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43ea3c4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_GatewayAddresses, addr 0x43ea4b4, size 0x25c, virtual true, abstract: false, final false
