...
namespace System::Net::NetworkInformation {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8127))}
...
public:
  ...
  /// @brief Method .ctor addr 0x286f7e0 size 0x80 virtual false final false
  ...
  /// @brief Method ParseRouteInfo_icall addr 0x286f88c size 0x44 virtual false final false
  static inline bool ParseRouteInfo_icall(::StringW iface, ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> gw_addr_list);

  /// @brief Method get_GatewayAddresses addr 0x286f8d0 size 0x254 virtual true final false
