...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::AixIPInterfaceProperties*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::AixIPInterfaceProperties*, "System.Net.NetworkInformation", "AixIPInterfaceProperties");
...
public:
  ...
  /// @brief Method ParseRouteInfo_icall, addr 0x6352c44, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6352bc4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_GatewayAddresses, addr 0x6352c88, size 0x28c, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AixIPInterfaceProperties", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AixIPInterfaceProperties(AixIPInterfaceProperties&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AixIPInterfaceProperties", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AixIPInterfaceProperties(AixIPInterfacePropertiesconst&) = delete;
...
static_assert(sizeof(::System::Net::NetworkInformation::AixIPInterfaceProperties) == 0x28, "Size mismatch!");
