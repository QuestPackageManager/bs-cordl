...
// Ctor Parameters [CppParam { name: "sin6_family", ty: "uint16_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sin6_port", ty: "uint16_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "sin6_flowinfo", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sin6_addr", ty:
// "::System::Net::NetworkInformation::in6_addr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sin6_scope_id", ty: "uint32_t", modifiers: "", def_value: Some("{}"),
// comment: None }]
