...
public:
  // Declarations
  /// @brief Method ByteArrayCopy, addr 0x6210e20, size 0x1c, virtual false, abstract: false, final false
  static inline void ByteArrayCopy(uint8_t* dst, uint8_t* src, int32_t elements);

  /// @brief Method GetAllNetworkInterfaces, addr 0x6210e3c, size 0xf2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6211f88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method close, addr 0x6210b28, size 0x78, virtual false, abstract: false, final false
  static inline int32_t close(int32_t fd);

  /// @brief Method ioctl, addr 0x6210c40, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ioctl, addr 0x6210ce0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ioctl, addr 0x6210d80, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ioctl, addr 0x6210ba0, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t ioctl(int32_t fd, ::System::Net::NetworkInformation::AixIoctlRequest request, ::ByRef<int32_t> arg);

  /// @brief Method socket, addr 0x6210a88, size 0xa0, virtual false, abstract: false, final false
