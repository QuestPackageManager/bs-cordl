...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::NetworkInformation::MacOsStructs::sockaddr_dl::*)(::System::IntPtr)>(&::System::Net::NetworkInformation::MacOsStructs::sockaddr_dl::Read)> {
  constexpr static std::size_t size = 0x138;
  constexpr static std::size_t addrs = 0x6215fb8;
