...
// Ctor Parameters [CppParam { name: "ifa_next", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "ifa_name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "ifa_flags", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "ifa_addr", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "ifa_netmask", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "ifa_dstaddr", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "ifa_data", ty: "::System::IntPtr", modifiers: "", def_value: None }]
constexpr ifaddrs(::System::IntPtr  ifa_next, ::StringW  ifa_name, uint32_t  ifa_flags, ::System::IntPtr  ifa_addr, ::System::IntPtr  ifa_netmask, ::System::IntPtr  ifa_dstaddr, ::System::IntPtr  ifa_data) noexcept;
