...
// Ctor Parameters [CppParam { name: "sin6_len", ty: "uint8_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "sin6_family", ty: "uint8_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "sin6_port", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "sin6_flowinfo", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "sin6_addr", ty: "::System::Net::NetworkInformation::MacOsStructs::in6_addr", modifiers: "", def_value: Some("{}") }, CppParam { name: "sin6_scope_id", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Net::NetworkInformation::MacOsStructs::sockaddr_in6::sockaddr_in6(uint8_t  sin6_len, uint8_t  sin6_family, uint16_t  sin6_port, uint32_t  sin6_flowinfo, ::System::Net::NetworkInformation::MacOsStructs::in6_addr  sin6_addr, uint32_t  sin6_scope_id) noexcept  {
