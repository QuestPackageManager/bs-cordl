...
// def_value: Some("{}"), comment: None }, CppParam { name: "ifa_netmask", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "ifa_dstaddr", ty:
// "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "ifa_data", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }]
