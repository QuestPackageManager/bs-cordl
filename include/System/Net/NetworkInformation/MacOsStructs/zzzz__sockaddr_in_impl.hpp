...
constexpr ::System::Net::NetworkInformation::MacOsStructs::sockaddr_in::sockaddr_in(uint8_t sin_len, uint8_t sin_family, uint16_t sin_port, uint32_t sin_addr) noexcept {
...
// Ctor Parameters []
constexpr ::System::Net::NetworkInformation::MacOsStructs::sockaddr_in::sockaddr_in() {}
