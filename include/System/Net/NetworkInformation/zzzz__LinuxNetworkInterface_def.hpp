...
public:
  ...
  /// @brief Method get_IfacePath, addr 0x29f372c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_IfacePath();

  static inline ::System::Net::NetworkInformation::LinuxNetworkInterface* New_ctor(::StringW name);

  /// @brief Method .ctor, addr 0x29f364c, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method GetIPProperties, addr 0x29f3734, size 0x74, virtual true, abstract: false, final false
  inline ::System::Net::NetworkInformation::IPInterfaceProperties* GetIPProperties();

  /// @brief Method get_OperationalStatus, addr 0x29f37a8, size 0x2bc, virtual true, abstract: false, final false
  inline ::System::Net::NetworkInformation::OperationalStatus get_OperationalStatus();

  /// @brief Method ReadLine, addr 0x29f3a64, size 0x2ec, virtual false, abstract: false, final false
