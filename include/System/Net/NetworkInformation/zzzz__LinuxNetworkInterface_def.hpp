...
public:
  ...
  /// @brief Method GetIPProperties, addr 0x2b3b040, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadLine, addr 0x2b3b370, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b3af58, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_IfacePath, addr 0x2b3b038, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_IfacePath();

  /// @brief Method get_OperationalStatus, addr 0x2b3b0b4, size 0x2bc, virtual true, abstract: false, final false
