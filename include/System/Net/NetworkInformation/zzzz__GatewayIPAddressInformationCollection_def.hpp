...
public:
  ...
  /// @brief Method Add, addr 0x634c508, size 0x50, virtual true, abstract: false, final false
  inline void Add(::System::Net::NetworkInformation::GatewayIPAddressInformation* address);

  /// @brief Method Clear, addr 0x634c6d4, size 0x50, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x634c5bc, size 0x64, virtual true, abstract: false, final false
  inline bool Contains(::System::Net::NetworkInformation::GatewayIPAddressInformation* address);

  /// @brief Method CopyTo, addr 0x634c440, size 0x6c, virtual true, abstract: false, final false
  inline void CopyTo(::ArrayW<::System::Net::NetworkInformation::GatewayIPAddressInformation*> array, int32_t offset);

  /// @brief Method GetEnumerator, addr 0x634c620, size 0x54, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerator_1<::System::Net::NetworkInformation::GatewayIPAddressInformation*>* GetEnumerator();

  /// @brief Method InternalAdd, addr 0x634c558, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x634c684, size 0x50, virtual true, abstract: false, final false
  inline bool Remove(::System::Net::NetworkInformation::GatewayIPAddressInformation* address);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x634c674, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x634c3cc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x634c4ac, size 0x54, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x634c500, size 0x8, virtual true, abstract: false, final false
