...
public:
  ...
  /// @brief Method Add, addr 0x43e917c, size 0x58, virtual true, abstract: false, final false
  inline void Add(::System::Net::NetworkInformation::GatewayIPAddressInformation* address);

  /// @brief Method Clear, addr 0x43e933c, size 0x58, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x43e922c, size 0x58, virtual true, abstract: false, final false
  inline bool Contains(::System::Net::NetworkInformation::GatewayIPAddressInformation* address);

  /// @brief Method CopyTo, addr 0x43e90bc, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x43e9284, size 0x50, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerator_1<::System::Net::NetworkInformation::GatewayIPAddressInformation*>* GetEnumerator();

  /// @brief Method InternalAdd, addr 0x43e91d4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x43e92e4, size 0x58, virtual true, abstract: false, final false
  inline bool Remove(::System::Net::NetworkInformation::GatewayIPAddressInformation* address);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x43e92d4, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x43e9040, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x43e9124, size 0x50, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x43e9174, size 0x8, virtual true, abstract: false, final false
