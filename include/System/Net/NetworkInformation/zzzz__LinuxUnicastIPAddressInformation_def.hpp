...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::LinuxUnicastIPAddressInformation*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::LinuxUnicastIPAddressInformation*, "System.Net.NetworkInformation", "LinuxUnicastIPAddressInformation");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LinuxUnicastIPAddressInformation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LinuxUnicastIPAddressInformation(LinuxUnicastIPAddressInformation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LinuxUnicastIPAddressInformation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LinuxUnicastIPAddressInformation(LinuxUnicastIPAddressInformationconst&) = delete;
...
static_assert(sizeof(::System::Net::NetworkInformation::LinuxUnicastIPAddressInformation) == 0x18, "Size mismatch!");
