...
/// @brief Method .ctor, addr 0x61a1988, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPAddress*  address) ;

/// @brief Method get_Address, addr 0x61a1990, size 0x8, virtual true, abstract: false, final false
