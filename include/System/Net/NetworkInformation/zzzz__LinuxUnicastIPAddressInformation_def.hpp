...
public:
  ...
  /// @brief Method .ctor, addr 0x29ef2ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::IPAddress* address);

  /// @brief Method get_Address, addr 0x29ef2d4, size 0x8, virtual true, abstract: false, final false
