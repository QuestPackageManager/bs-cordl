...
public:
  ...
  /// @brief Method AddAddress, addr 0x619f7fc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLinkLayerInfo, addr 0x619f8b0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x619f8c4, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x61a2850, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NetworkInterfaceType, addr 0x61a2858, size 0x8, virtual true, abstract: false, final false
