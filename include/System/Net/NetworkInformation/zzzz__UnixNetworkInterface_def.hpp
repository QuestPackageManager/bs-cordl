...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnixNetworkInterface", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnixNetworkInterface(UnixNetworkInterface&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnixNetworkInterface", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnixNetworkInterface(UnixNetworkInterfaceconst&) = delete;
