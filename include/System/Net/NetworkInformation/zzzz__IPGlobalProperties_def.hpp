...
public:
  ...
  /// @brief Method GetIPGlobalProperties, addr 0x620fe0c, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Net::NetworkInformation::IPGlobalProperties* GetIPGlobalProperties();

  /// @brief Method InternalGetIPGlobalProperties, addr 0x620fe58, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x620fe5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
