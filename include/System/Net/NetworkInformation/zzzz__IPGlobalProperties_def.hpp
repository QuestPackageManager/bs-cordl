...
public:
  ...
  /// @brief Method GetIPGlobalProperties addr 0x29eb6ac size 0x4 virtual false final false
  static inline ::System::Net::NetworkInformation::IPGlobalProperties* GetIPGlobalProperties();

  /// @brief Method InternalGetIPGlobalProperties addr 0x29eb700 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29eb704 size 0x8 virtual false final false
  inline void _ctor();
