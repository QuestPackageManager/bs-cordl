...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IPGlobalProperties", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IPGlobalProperties(IPGlobalProperties&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IPGlobalProperties", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPGlobalProperties(IPGlobalPropertiesconst&) = delete;
