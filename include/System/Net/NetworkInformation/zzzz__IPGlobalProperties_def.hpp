...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::IPGlobalProperties*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::IPGlobalProperties*, "System.Net.NetworkInformation", "IPGlobalProperties");
...
public:
  ...
  /// @brief Method GetIPGlobalProperties, addr 0x634ca80, size 0x4, virtual false, abstract: false, final false
  static inline ::System::Net::NetworkInformation::IPGlobalProperties* GetIPGlobalProperties();

  /// @brief Method InternalGetIPGlobalProperties, addr 0x634cacc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x634cad0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Net::NetworkInformation::IPGlobalProperties) == 0x10, "Size mismatch!");
