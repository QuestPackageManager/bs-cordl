...
public:
  ...
  /// @brief Method GetIPProperties, addr 0x2f25a18, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f259f4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, uint32_t ifa_flags);

  /// @brief Method get_OperationalStatus, addr 0x2f25a8c, size 0x14, virtual true, abstract: false, final false
