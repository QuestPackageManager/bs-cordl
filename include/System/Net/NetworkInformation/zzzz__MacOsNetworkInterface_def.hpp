...
public:
  ...
  /// @brief Method GetIPProperties, addr 0x3026318, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30262f4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, uint32_t ifa_flags);

  /// @brief Method get_OperationalStatus, addr 0x302638c, size 0x14, virtual true, abstract: false, final false
