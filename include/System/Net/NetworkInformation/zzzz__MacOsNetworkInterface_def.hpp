...
public:
  ...
  /// @brief Method GetIPProperties, addr 0x6356a28, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6356a04, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, uint32_t ifa_flags);

  /// @brief Method get_OperationalStatus, addr 0x6356a98, size 0x14, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MacOsNetworkInterface", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MacOsNetworkInterface(MacOsNetworkInterface&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MacOsNetworkInterface", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MacOsNetworkInterface(MacOsNetworkInterfaceconst&) = delete;
