...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetworkInterface", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetworkInterface(NetworkInterface&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetworkInterface", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetworkInterface(NetworkInterfaceconst&) = delete;
