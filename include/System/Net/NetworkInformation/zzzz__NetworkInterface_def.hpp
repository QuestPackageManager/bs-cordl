...
public:
  ...
  /// @brief Method GetAllNetworkInterfaces, addr 0x2f1bfe8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIPProperties, addr 0x2f1c170, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f1c230, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Name, addr 0x2f1c130, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NetworkInterfaceType, addr 0x2f1c1f0, size 0x40, virtual true, abstract: false, final false
  inline ::System::Net::NetworkInformation::NetworkInterfaceType get_NetworkInterfaceType();

  /// @brief Method get_OperationalStatus, addr 0x2f1c1b0, size 0x40, virtual true, abstract: false, final false
