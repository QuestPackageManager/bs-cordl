...
/// @brief Method GetAllNetworkInterfaces, addr 0x619dee8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method GetIPProperties, addr 0x619e070, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x619e118, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Name, addr 0x619e038, size 0x38, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NetworkInterfaceType, addr 0x619e0e0, size 0x38, virtual true, abstract: false, final false
inline ::System::Net::NetworkInformation::NetworkInterfaceType get_NetworkInterfaceType() ;

/// @brief Method get_OperationalStatus, addr 0x619e0a8, size 0x38, virtual true, abstract: false, final false
