...
public:
  ...
  /// @brief Method GetAllNetworkInterfaces, addr 0x43e9b2c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIPProperties, addr 0x43e9cac, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43e9d54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Name, addr 0x43e9c74, size 0x38, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NetworkInterfaceType, addr 0x43e9d1c, size 0x38, virtual true, abstract: false, final false
  inline ::System::Net::NetworkInformation::NetworkInterfaceType get_NetworkInterfaceType();

  /// @brief Method get_OperationalStatus, addr 0x43e9ce4, size 0x38, virtual true, abstract: false, final false
