...
public:
  ...
  /// @brief Method get_DomainName, addr 0x29f05f8, size 0x48, virtual true, abstract: false, final false
  inline ::StringW get_DomainName();

  static inline ::System::Net::NetworkInformation::UnixNoLibCIPGlobalProperties* New_ctor();

  /// @brief Method .ctor, addr 0x29f0640, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
