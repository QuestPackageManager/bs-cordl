...
public:
  ...
  /// @brief Method .ctor, addr 0x61a2330, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DomainName, addr 0x61a231c, size 0x14, virtual true, abstract: false, final false
