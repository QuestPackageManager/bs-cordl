...
// Write type traits
MARK_REF_T(::System::Net::NetworkInformation::UnixNoLibCIPGlobalProperties*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkInformation::UnixNoLibCIPGlobalProperties*, "System.Net.NetworkInformation", "UnixNoLibCIPGlobalProperties");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6356e88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DomainName, addr 0x6356e74, size 0x14, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnixNoLibCIPGlobalProperties", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnixNoLibCIPGlobalProperties(UnixNoLibCIPGlobalProperties&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnixNoLibCIPGlobalProperties", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnixNoLibCIPGlobalProperties(UnixNoLibCIPGlobalPropertiesconst&) = delete;
...
static_assert(sizeof(::System::Net::NetworkInformation::UnixNoLibCIPGlobalProperties) == 0x10, "Size mismatch!");
