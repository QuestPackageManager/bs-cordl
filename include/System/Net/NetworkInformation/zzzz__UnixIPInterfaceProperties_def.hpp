...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnixIPInterfaceProperties", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnixIPInterfaceProperties(UnixIPInterfaceProperties&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnixIPInterfaceProperties", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnixIPInterfaceProperties(UnixIPInterfacePropertiesconst&) = delete;
