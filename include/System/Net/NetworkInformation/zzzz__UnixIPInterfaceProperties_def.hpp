...
namespace System::Net::NetworkInformation {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8087))}
...
public:
  ...
  /// @brief Method .ctor addr 0x286f860 size 0x2c virtual false final false
  ...
  /// @brief Method get_UnicastAddresses addr 0x2874008 size 0x274 virtual true final false
