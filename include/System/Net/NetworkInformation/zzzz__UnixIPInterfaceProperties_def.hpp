...
public:
  ...
  /// @brief Method .ctor, addr 0x2f1c944, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_UnicastAddresses, addr 0x2f210ec, size 0x274, virtual true, abstract: false, final false
