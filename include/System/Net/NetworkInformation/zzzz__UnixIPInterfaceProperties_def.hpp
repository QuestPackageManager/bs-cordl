...
public:
  ...
  /// @brief Method .ctor, addr 0x43ea0dc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_UnicastAddresses, addr 0x43ee7bc, size 0x268, virtual true, abstract: false, final false
