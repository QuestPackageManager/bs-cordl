...
// CppParam { name: "ifa_flags", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "ifa_addr", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "ifa_netmask", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }, CppParam { name: "ifa_ifu", ty: "::System::Net::NetworkInformation::ifa_ifu", modifiers: "", def_value: Some("{}") },
// CppParam { name: "ifa_data", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }]
