...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::ServiceNameStore::*)()>(&::System::Net::ServiceNameStore::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x29a88b0;
...
constexpr ::System::Collections::Generic::List_1<::StringW>*& System::Net::ServiceNameStore::__get_serviceNames() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___serviceNames;
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> const& System::Net::ServiceNameStore::__get_serviceNames() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___serviceNames;
}
...
constexpr ::System::Security::Authentication::ExtendedProtection::ServiceNameCollection*& System::Net::ServiceNameStore::__get_serviceNameCollection() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
System::Net::ServiceNameStore::__get_serviceNameCollection() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___serviceNameCollection;
}
...
inline ::System::Net::ServiceNameStore* System::Net::ServiceNameStore::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::System::Net::ServiceNameStore*>());
}
