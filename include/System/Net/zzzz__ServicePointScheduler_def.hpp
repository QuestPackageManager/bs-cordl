...
public:
  ...
  /// @brief Method Cleanup, addr 0x61fd448, size 0x138, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Close, addr 0x61fdc84, size 0x29c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method CreateOrReuseConnection, addr 0x61fd580, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method EnqueueOperation, addr 0x61fdc20, size 0x64, virtual false, abstract: false, final false
  inline void EnqueueOperation(::System::Net::WebOperation* operation);

  /// @brief Method FindIdleConnection, addr 0x61fe0ac, size 0x288, virtual false, abstract: false, final false
  inline ::System::Net::WebConnection* FindIdleConnection(::System::Net::WebOperation* operation);

  /// @brief Method GetNextOperation, addr 0x61fd728, size 0x134, virtual false, abstract: false, final false
  inline ::System::Net::WebOperation* GetNextOperation();

  /// @brief Method IsEmpty, addr 0x61fcb44, size 0x84, virtual false, abstract: false, final false
  inline bool IsEmpty();
  ...
  /// @brief Method RemoveConnection, addr 0x61fd280, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61fc49c, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePointScheduler* scheduler, ::StringW name);

  static inline int32_t getStaticF_nextId();

  /// @brief Method get_Scheduler, addr 0x61fe058, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Set>b__4_0, addr 0x61fe9f8, size 0xa4, virtual false, abstract: false, final false
  inline bool _Set_b__4_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x61fe9f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Reset, addr 0x61fcd8c, size 0xd8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Set, addr 0x61fc654, size 0x254, virtual false, abstract: false, final false
  inline void Set();

  /// @brief Method WaitAsync, addr 0x61fe93c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61fc400, size 0x9c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x61fea9c, size 0xbc8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x61ff664, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x61ff6d0, size 0x554, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x61ffc24, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Cleanup, addr 0x61fc960, size 0x1e4, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CloseConnectionGroup, addr 0x61fb4f0, size 0x114, virtual false, abstract: false, final false
  inline bool CloseConnectionGroup(::StringW groupName);

  /// @brief Method CloseIdleConnection, addr 0x61fd6f0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalCleanup, addr 0x61fd96c, size 0x84, virtual false, abstract: false, final false
  inline void FinalCleanup();

  /// @brief Method GetConnectionGroup, addr 0x61fd9f0, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method OnConnectionClosed, addr 0x61fdf3c, size 0x24, virtual false, abstract: false, final false
  inline void OnConnectionClosed(::System::Net::WebConnection* connection);

  /// @brief Method OnConnectionCreated, addr 0x61fdf20, size 0x1c, virtual false, abstract: false, final false
  inline void OnConnectionCreated(::System::Net::WebConnection* connection);

  /// @brief Method OperationCompleted, addr 0x61fcf28, size 0x1f4, virtual false, abstract: false, final false
  inline bool OperationCompleted(::System::Net::ServicePointScheduler_ConnectionGroup* group, ::System::Net::WebOperation* operation);

  /// @brief Method RemoveIdleConnection, addr 0x61fd338, size 0x110, virtual false, abstract: false, final false
  inline void RemoveIdleConnection(::System::Net::WebConnection* connection);

  /// @brief Method RemoveOperation, addr 0x61fd85c, size 0x110, virtual false, abstract: false, final false
  inline void RemoveOperation(::System::Net::WebOperation* operation);

  /// @brief Method Run, addr 0x61fc580, size 0xd4, virtual false, abstract: false, final false
  inline void Run();

  /// @brief Method RunScheduler, addr 0x61fc8a8, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RunScheduler();

  /// @brief Method RunSchedulerIteration, addr 0x61fcbc8, size 0x1c4, virtual false, abstract: false, final false
  inline void RunSchedulerIteration();

  /// @brief Method SchedulerIteration, addr 0x61fce64, size 0xc4, virtual false, abstract: false, final false
  inline bool SchedulerIteration(::System::Net::ServicePointScheduler_ConnectionGroup* group);

  /// @brief Method SendRequest, addr 0x61fb324, size 0xe4, virtual false, abstract: false, final false
  inline void SendRequest(::System::Net::WebOperation* operation, ::StringW groupName);

  /// @brief Method WaitAsync, addr 0x61fdf60, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method <Run>b__31_0, addr 0x61fe054, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61faa18, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePoint* servicePoint, int32_t connectionLimit, int32_t maxIdleTime);

  static inline int32_t getStaticF_nextId();

  /// @brief Method get_MaxIdleTime, addr 0x61fc3f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxIdleTime();

  /// @brief Method get_ServicePoint, addr 0x61fc3e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  static inline void setStaticF_nextId(int32_t value);

  /// @brief Method set_ServicePoint, addr 0x61fc3f0, size 0x8, virtual false, abstract: false, final false
