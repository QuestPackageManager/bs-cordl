...
public:
  ...
  /// @brief Method get_Scheduler, addr 0x29dfa80, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29ddfd4, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePointScheduler* scheduler, ::StringW name);

  /// @brief Method IsEmpty, addr 0x29de668, size 0x74, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method RemoveConnection, addr 0x29ded8c, size 0x88, virtual false, abstract: false, final false
  inline void RemoveConnection(::System::Net::WebConnection* connection);

  /// @brief Method Cleanup, addr 0x29deee0, size 0xf0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Close, addr 0x29df634, size 0x318, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method EnqueueOperation, addr 0x29df5dc, size 0x58, virtual false, abstract: false, final false
  inline void EnqueueOperation(::System::Net::WebOperation* operation);

  /// @brief Method GetNextOperation, addr 0x29df1a8, size 0xec, virtual false, abstract: false, final false
  inline ::System::Net::WebOperation* GetNextOperation();

  /// @brief Method FindIdleConnection, addr 0x29dfb30, size 0x314, virtual false, abstract: false, final false
  inline ::System::Net::WebConnection* FindIdleConnection(::System::Net::WebOperation* operation);

  /// @brief Method CreateOrReuseConnection, addr 0x29defd0, size 0x1a0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x29e0544, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <Set>b__4_0, addr 0x29e054c, size 0x9c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method WaitAsync, addr 0x29e048c, size 0x54, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<bool>* WaitAsync(int32_t millisecondTimeout);

  /// @brief Method Set, addr 0x29de1a8, size 0x230, virtual false, abstract: false, final false
  inline void Set();

  /// @brief Method Reset, addr 0x29de868, size 0xc4, virtual false, abstract: false, final false
  inline void Reset();

  static inline ::System::Net::__ServicePointScheduler__AsyncManualResetEvent* New_ctor(bool state);

  /// @brief Method .ctor, addr 0x29ddf2c, size 0xa8, virtual false, abstract: false, final false
...
namespace System::Net {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2787)), TypeDefinitionIndex(TypeDefinitionIndex(3393)), TypeDefinitionIndex(TypeDefinitionIndex(3397)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3393), inst: 401 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(7216)) CS Name: ::ServicePointScheduler::<RunScheduler>d__32
...
public:
  ...
  /// @brief Method MoveNext, addr 0x29e05e8, size 0xaf4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x29e10dc, size 0xc, virtual true, abstract: false, final true
...
namespace System::Net {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2787)), TypeDefinitionIndex(TypeDefinitionIndex(3393)), TypeDefinitionIndex(TypeDefinitionIndex(3398)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3393), inst: 401 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3398), inst: 77 })] Self:
// TypeDefinitionIndex(TypeDefinitionIndex(7217)) CS Name: ::ServicePointScheduler::<WaitAsync>d__46
...
public:
  ...
  /// @brief Method MoveNext, addr 0x29e10e8, size 0x44c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x29e1534, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method get_ServicePoint, addr 0x29ddf14, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  /// @brief Method set_ServicePoint, addr 0x29ddf1c, size 0x8, virtual false, abstract: false, final false
  inline void set_ServicePoint(::System::Net::ServicePoint* value);

  /// @brief Method get_MaxIdleTime, addr 0x29ddf24, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29dbddc, size 0x1d8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePoint* servicePoint, int32_t connectionLimit, int32_t maxIdleTime);

  /// @brief Method Run, addr 0x29de0e0, size 0xc8, virtual false, abstract: false, final false
  inline void Run();

  /// @brief Method RunScheduler, addr 0x29de3d8, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RunScheduler();

  /// @brief Method Cleanup, addr 0x29de4a8, size 0x1c0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method RunSchedulerIteration, addr 0x29de6dc, size 0x18c, virtual false, abstract: false, final false
  inline void RunSchedulerIteration();

  /// @brief Method OperationCompleted, addr 0x29dea0c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CloseIdleConnection, addr 0x29df170, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method SchedulerIteration, addr 0x29de92c, size 0xe0, virtual false, abstract: false, final false
  inline bool SchedulerIteration(::System::Net::__ServicePointScheduler__ConnectionGroup* group);

  /// @brief Method RemoveOperation, addr 0x29df294, size 0xcc, virtual false, abstract: false, final false
  inline void RemoveOperation(::System::Net::WebOperation* operation);

  /// @brief Method RemoveIdleConnection, addr 0x29dee14, size 0xcc, virtual false, abstract: false, final false
  inline void RemoveIdleConnection(::System::Net::WebConnection* connection);

  /// @brief Method FinalCleanup, addr 0x29df360, size 0x80, virtual false, abstract: false, final false
  inline void FinalCleanup();

  /// @brief Method SendRequest, addr 0x29dc9bc, size 0xe8, virtual false, abstract: false, final false
  inline void SendRequest(::System::Net::WebOperation* operation, ::StringW groupName);

  /// @brief Method CloseConnectionGroup, addr 0x29dcb90, size 0x110, virtual false, abstract: false, final false
  inline bool CloseConnectionGroup(::StringW groupName);

  /// @brief Method GetConnectionGroup, addr 0x29df3e0, size 0x1fc, virtual false, abstract: false, final false
  inline ::System::Net::__ServicePointScheduler__ConnectionGroup* GetConnectionGroup(::StringW name);

  /// @brief Method OnConnectionCreated, addr 0x29df94c, size 0xc, virtual false, abstract: false, final false
  inline void OnConnectionCreated(::System::Net::WebConnection* connection);

  /// @brief Method OnConnectionClosed, addr 0x29df958, size 0x1c, virtual false, abstract: false, final false
  inline void OnConnectionClosed(::System::Net::WebConnection* connection);

  /// @brief Method WaitAsync, addr 0x29df974, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method <Run>b__31_0, addr 0x29dfa7c, size 0x4, virtual false, abstract: false, final false
