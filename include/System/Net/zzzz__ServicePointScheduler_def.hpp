...
/// @brief Method Cleanup, addr 0x618b43c, size 0x138, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Close, addr 0x618bc78, size 0x29c, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method CreateOrReuseConnection, addr 0x618b574, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method EnqueueOperation, addr 0x618bc14, size 0x64, virtual false, abstract: false, final false
inline void EnqueueOperation(::System::Net::WebOperation*  operation) ;

/// @brief Method FindIdleConnection, addr 0x618c0a0, size 0x288, virtual false, abstract: false, final false
inline ::System::Net::WebConnection* FindIdleConnection(::System::Net::WebOperation*  operation) ;

/// @brief Method GetNextOperation, addr 0x618b71c, size 0x134, virtual false, abstract: false, final false
inline ::System::Net::WebOperation* GetNextOperation() ;

/// @brief Method IsEmpty, addr 0x618ab38, size 0x84, virtual false, abstract: false, final false
inline bool IsEmpty() ;
...
/// @brief Method RemoveConnection, addr 0x618b274, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x618a490, size 0xe4, virtual false, abstract: false, final false
inline void _ctor(::System::Net::ServicePointScheduler*  scheduler, ::StringW  name) ;

static inline int32_t getStaticF_nextId() ;

/// @brief Method get_Scheduler, addr 0x618c04c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <Set>b__4_0, addr 0x618c9ec, size 0xa4, virtual false, abstract: false, final false
inline bool _Set_b__4_0(::System::Object*  s) ;

/// @brief Method .ctor, addr 0x618c9e8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Reset, addr 0x618ad80, size 0xd8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Set, addr 0x618a648, size 0x254, virtual false, abstract: false, final false
inline void Set() ;

/// @brief Method WaitAsync, addr 0x618c930, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x618a3f4, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x618ca90, size 0xbc8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x618d658, size 0x6c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Net::ServicePointScheduler*", modifiers: "", def_value: None }, CppParam { name: "_operationArray_5__2", ty: "::ArrayW<::System::ValueTuple_2<::System::Net::ServicePointScheduler_ConnectionGroup*,::System::Net::WebOperation*>,::Array<::System::ValueTuple_2<::System::Net::ServicePointScheduler_ConnectionGroup*,::System::Net::WebOperation*>>*>", modifiers: "", def_value: None }, CppParam { name: "_idleArray_5__3", ty: "::ArrayW<::System::ValueTuple_3<::System::Net::ServicePointScheduler_ConnectionGroup*,::System::Net::WebConnection*,::System::Threading::Tasks::Task*>,::Array<::System::ValueTuple_3<::System::Net::ServicePointScheduler_ConnectionGroup*,::System::Net::WebConnection*,::System::Threading::Tasks::Task*>>*>", modifiers: "", def_value: None }, CppParam { name: "_taskList_5__4", ty: "::System::Collections::Generic::List_1<::System::Threading::Tasks::Task*>*", modifiers: "", def_value: None }, CppParam { name: "_schedulerTask_5__5", ty: "::System::Threading::Tasks::Task_1<bool>*", modifiers: "", def_value: None }, CppParam { name: "_finalCleanup_5__6", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Threading::Tasks::Task*>", modifiers: "", def_value: None }]
...
/// @brief Field <operationArray>5__2, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::System::ValueTuple_2<::System::Net::ServicePointScheduler_ConnectionGroup*,::System::Net::WebOperation*>,::Array<::System::ValueTuple_2<::System::Net::ServicePointScheduler_ConnectionGroup*,::System::Net::WebOperation*>>*>  _operationArray_5__2;
...
/// @brief Method MoveNext, addr 0x618d6c4, size 0x554, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x618dc18, size 0x80, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool>", modifiers: "", def_value: None }, CppParam { name: "millisecondTimeout", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "workerTask", ty: "::System::Threading::Tasks::Task*", modifiers: "", def_value: None }, CppParam { name: "_cts_5__2", ty: "::System::Threading::CancellationTokenSource*", modifiers: "", def_value: None }, CppParam { name: "_timeoutTask_5__3", ty: "::System::Threading::Tasks::Task*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Threading::Tasks::Task*>", modifiers: "", def_value: None }]
...
/// @brief Method Cleanup, addr 0x618a954, size 0x1e4, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CloseConnectionGroup, addr 0x61894e4, size 0x114, virtual false, abstract: false, final false
inline bool CloseConnectionGroup(::StringW  groupName) ;

/// @brief Method CloseIdleConnection, addr 0x618b6e4, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method FinalCleanup, addr 0x618b960, size 0x84, virtual false, abstract: false, final false
inline void FinalCleanup() ;

/// @brief Method GetConnectionGroup, addr 0x618b9e4, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method OnConnectionClosed, addr 0x618bf30, size 0x24, virtual false, abstract: false, final false
inline void OnConnectionClosed(::System::Net::WebConnection*  connection) ;

/// @brief Method OnConnectionCreated, addr 0x618bf14, size 0x1c, virtual false, abstract: false, final false
inline void OnConnectionCreated(::System::Net::WebConnection*  connection) ;

/// @brief Method OperationCompleted, addr 0x618af1c, size 0x1f4, virtual false, abstract: false, final false
inline bool OperationCompleted(::System::Net::ServicePointScheduler_ConnectionGroup*  group, ::System::Net::WebOperation*  operation) ;

/// @brief Method RemoveIdleConnection, addr 0x618b32c, size 0x110, virtual false, abstract: false, final false
inline void RemoveIdleConnection(::System::Net::WebConnection*  connection) ;

/// @brief Method RemoveOperation, addr 0x618b850, size 0x110, virtual false, abstract: false, final false
inline void RemoveOperation(::System::Net::WebOperation*  operation) ;

/// @brief Method Run, addr 0x618a574, size 0xd4, virtual false, abstract: false, final false
inline void Run() ;

/// @brief Method RunScheduler, addr 0x618a89c, size 0xb8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* RunScheduler() ;

/// @brief Method RunSchedulerIteration, addr 0x618abbc, size 0x1c4, virtual false, abstract: false, final false
inline void RunSchedulerIteration() ;

/// @brief Method SchedulerIteration, addr 0x618ae58, size 0xc4, virtual false, abstract: false, final false
inline bool SchedulerIteration(::System::Net::ServicePointScheduler_ConnectionGroup*  group) ;

/// @brief Method SendRequest, addr 0x6189318, size 0xe4, virtual false, abstract: false, final false
inline void SendRequest(::System::Net::WebOperation*  operation, ::StringW  groupName) ;

/// @brief Method WaitAsync, addr 0x618bf54, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method <Run>b__31_0, addr 0x618c048, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6188a0c, size 0x1a4, virtual false, abstract: false, final false
inline void _ctor(::System::Net::ServicePoint*  servicePoint, int32_t  connectionLimit, int32_t  maxIdleTime) ;

static inline int32_t getStaticF_nextId() ;

/// @brief Method get_MaxIdleTime, addr 0x618a3ec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxIdleTime() ;

/// @brief Method get_ServicePoint, addr 0x618a3dc, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::ServicePoint* get_ServicePoint() ;

static inline void setStaticF_nextId(int32_t  value) ;

/// @brief Method set_ServicePoint, addr 0x618a3e4, size 0x8, virtual false, abstract: false, final false
