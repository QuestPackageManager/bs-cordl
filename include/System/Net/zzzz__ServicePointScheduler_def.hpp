...
public:
  ...
  /// @brief Method Cleanup, addr 0x302dc88, size 0xf0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Close, addr 0x302e3dc, size 0x318, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method CreateOrReuseConnection, addr 0x302dd78, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method EnqueueOperation, addr 0x302e384, size 0x58, virtual false, abstract: false, final false
  inline void EnqueueOperation(::System::Net::WebOperation* operation);

  /// @brief Method FindIdleConnection, addr 0x302e8d8, size 0x314, virtual false, abstract: false, final false
  inline ::System::Net::WebConnection* FindIdleConnection(::System::Net::WebOperation* operation);

  /// @brief Method GetNextOperation, addr 0x302df50, size 0xec, virtual false, abstract: false, final false
  inline ::System::Net::WebOperation* GetNextOperation();

  /// @brief Method IsEmpty, addr 0x302d410, size 0x74, virtual false, abstract: false, final false
  inline bool IsEmpty();
  ...
  /// @brief Method RemoveConnection, addr 0x302db34, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x302cd7c, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePointScheduler* scheduler, ::StringW name);

  static inline int32_t getStaticF_nextId();

  /// @brief Method get_Scheduler, addr 0x302e828, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Set>b__4_0, addr 0x302f2f4, size 0x9c, virtual false, abstract: false, final false
  inline bool _Set_b__4_0(::System::Object* s);

  /// @brief Method .ctor, addr 0x302f2ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Reset, addr 0x302d610, size 0xc4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Set, addr 0x302cf50, size 0x230, virtual false, abstract: false, final false
  inline void Set();

  /// @brief Method WaitAsync, addr 0x302f234, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x302ccd4, size 0xa8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x302f390, size 0xaf4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x302fe84, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x302fe90, size 0x44c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x30302dc, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Cleanup, addr 0x302d250, size 0x1c0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CloseConnectionGroup, addr 0x302b938, size 0x110, virtual false, abstract: false, final false
  inline bool CloseConnectionGroup(::StringW groupName);

  /// @brief Method CloseIdleConnection, addr 0x302df18, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalCleanup, addr 0x302e108, size 0x80, virtual false, abstract: false, final false
  inline void FinalCleanup();

  /// @brief Method GetConnectionGroup, addr 0x302e188, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnConnectionClosed, addr 0x302e700, size 0x1c, virtual false, abstract: false, final false
  inline void OnConnectionClosed(::System::Net::WebConnection* connection);

  /// @brief Method OnConnectionCreated, addr 0x302e6f4, size 0xc, virtual false, abstract: false, final false
  inline void OnConnectionCreated(::System::Net::WebConnection* connection);

  /// @brief Method OperationCompleted, addr 0x302d7b4, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveIdleConnection, addr 0x302dbbc, size 0xcc, virtual false, abstract: false, final false
  inline void RemoveIdleConnection(::System::Net::WebConnection* connection);

  /// @brief Method RemoveOperation, addr 0x302e03c, size 0xcc, virtual false, abstract: false, final false
  inline void RemoveOperation(::System::Net::WebOperation* operation);

  /// @brief Method Run, addr 0x302ce88, size 0xc8, virtual false, abstract: false, final false
  inline void Run();

  /// @brief Method RunScheduler, addr 0x302d180, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RunScheduler();

  /// @brief Method RunSchedulerIteration, addr 0x302d484, size 0x18c, virtual false, abstract: false, final false
  inline void RunSchedulerIteration();

  /// @brief Method SchedulerIteration, addr 0x302d6d4, size 0xe0, virtual false, abstract: false, final false
  inline bool SchedulerIteration(::System::Net::__ServicePointScheduler__ConnectionGroup* group);

  /// @brief Method SendRequest, addr 0x302b764, size 0xe8, virtual false, abstract: false, final false
  inline void SendRequest(::System::Net::WebOperation* operation, ::StringW groupName);

  /// @brief Method WaitAsync, addr 0x302e71c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method <Run>b__31_0, addr 0x302e824, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x302ab84, size 0x1d8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::ServicePoint* servicePoint, int32_t connectionLimit, int32_t maxIdleTime);

  static inline int32_t getStaticF_nextId();

  /// @brief Method get_MaxIdleTime, addr 0x302cccc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxIdleTime();

  /// @brief Method get_ServicePoint, addr 0x302ccbc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::ServicePoint* get_ServicePoint();

  static inline void setStaticF_nextId(int32_t value);

  /// @brief Method set_ServicePoint, addr 0x302ccc4, size 0x8, virtual false, abstract: false, final false
