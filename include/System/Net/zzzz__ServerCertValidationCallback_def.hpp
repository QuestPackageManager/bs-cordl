...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(8206))}
...
public:
  ...
  /// @brief Method .ctor addr 0x283d25c size 0x44 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x283cfc8 size 0x78 virtual false final false
  inline void _ctor(::System::Net::Security::RemoteCertificateValidationCallback* validationCallback);

  /// @brief Method get_ValidationCallback addr 0x283d040 size 0x8 virtual false final false
  inline ::System::Net::Security::RemoteCertificateValidationCallback* get_ValidationCallback();

  /// @brief Method Callback addr 0x283d048 size 0xac virtual false final false
  inline void Callback(::System::Object* state);

  /// @brief Method Invoke addr 0x283d0f4 size 0x168 virtual false final false
