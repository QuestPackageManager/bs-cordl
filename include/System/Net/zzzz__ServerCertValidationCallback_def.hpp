...
public:
  ...
  /// @brief Method .ctor, addr 0x2aa664c, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Callback, addr 0x2aa6438, size 0xac, virtual false, abstract: false, final false
  inline void Callback(::System::Object* state);

  /// @brief Method Invoke, addr 0x2aa64e4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2aa63b8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Security::RemoteCertificateValidationCallback* validationCallback);

  /// @brief Method get_ValidationCallback, addr 0x2aa6430, size 0x8, virtual false, abstract: false, final false
