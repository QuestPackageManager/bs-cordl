...
public:
  ...
  /// @brief Method .ctor, addr 0x627178c, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Callback, addr 0x6271578, size 0xb8, virtual false, abstract: false, final false
  inline void Callback(::System::Object* state);

  /// @brief Method Invoke, addr 0x6271630, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6271500, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Security::RemoteCertificateValidationCallback* validationCallback);

  /// @brief Method get_ValidationCallback, addr 0x6271570, size 0x8, virtual false, abstract: false, final false
