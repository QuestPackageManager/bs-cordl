...
public:
  ...
  /// @brief Method AuthenticateAsClient, addr 0x448cd54, size 0x100, virtual false, abstract: false, final false
  inline void AuthenticateAsClient();

  /// @brief Method BeginAuthenticateAsClient, addr 0x448ce54, size 0x118, virtual false, abstract: false, final false
  inline ::System::IAsyncResult* BeginAuthenticateAsClient(::System::AsyncCallback* asyncCallback, ::System::Object* state);

  /// @brief Method BeginRead, addr 0x448d020, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x448cf90, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x448d068, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EndAuthenticateAsClient, addr 0x448cf6c, size 0x24, virtual false, abstract: false, final false
  inline void EndAuthenticateAsClient(::System::IAsyncResult* asyncResult);

  /// @brief Method EndRead, addr 0x448d044, size 0x24, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x448cfb4, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x448cffc, size 0x24, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Write, addr 0x448cfd8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x448cc88, size 0xcc, virtual false, abstract: false, final false
