...
public:
  ...
  /// @brief Method AuthenticateAsClient, addr 0x44911f0, size 0x100, virtual false, abstract: false, final false
  inline void AuthenticateAsClient();

  /// @brief Method BeginAuthenticateAsClient, addr 0x44912f0, size 0x118, virtual false, abstract: false, final false
  inline ::System::IAsyncResult* BeginAuthenticateAsClient(::System::AsyncCallback* asyncCallback, ::System::Object* state);

  /// @brief Method BeginRead, addr 0x44914bc, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x449142c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method Close, addr 0x4491504, size 0x34, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method EndAuthenticateAsClient, addr 0x4491408, size 0x24, virtual false, abstract: false, final false
  inline void EndAuthenticateAsClient(::System::IAsyncResult* asyncResult);

  /// @brief Method EndRead, addr 0x44914e0, size 0x24, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x4491450, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x4491498, size 0x24, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size);

  /// @brief Method Write, addr 0x4491474, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4491124, size 0xcc, virtual false, abstract: false, final false
