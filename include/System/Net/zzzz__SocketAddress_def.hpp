...
public:
  ...
  /// @brief Method Equals, addr 0x61f1b48, size 0xe8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* comparand);

  /// @brief Method GetHashCode, addr 0x61f1c30, size 0x144, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetIPAddress, addr 0x61f18d8, size 0x1d4, virtual false, abstract: false, final false
  inline ::System::Net::IPAddress* GetIPAddress();

  /// @brief Method GetIPEndPoint, addr 0x61f1aac, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x61f1d74, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61f153c, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::Sockets::AddressFamily family, int32_t size);

  /// @brief Method .ctor, addr 0x61f1634, size 0x248, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::IPAddress* ipAddress);

  /// @brief Method .ctor, addr 0x61f187c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::IPAddress* ipaddress, int32_t port);

  /// @brief Method get_Family, addr 0x61f1490, size 0x30, virtual false, abstract: false, final false
  inline ::System::Net::Sockets::AddressFamily get_Family();

  /// @brief Method get_Item, addr 0x61f14c8, size 0x74, virtual false, abstract: false, final false
  inline uint8_t get_Item(int32_t offset);

  /// @brief Method get_Size, addr 0x61f14c0, size 0x8, virtual false, abstract: false, final false
