...
public:
  ...
  /// @brief Method MoveNext, addr 0x44bfbd0, size 0x318, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x44bfee8, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method ProcessReadAsync, addr 0x44bfab0, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44bfa88, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::WebOperation* operation, ::System::IO::Stream* innerStream, int64_t contentLength);

  /// @brief Method get_ContentLength, addr 0x44bfa80, size 0x8, virtual false, abstract: false, final false
