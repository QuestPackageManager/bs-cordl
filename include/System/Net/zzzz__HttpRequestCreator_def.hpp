...
public:
  ...
  /// @brief Method Create, addr 0x2b16b70, size 0x60, virtual true, abstract: false, final true
  inline ::System::Net::WebRequest* Create(::System::Uri* uri);

  static inline ::System::Net::HttpRequestCreator* New_ctor();

  /// @brief Method .ctor, addr 0x2b16b68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
