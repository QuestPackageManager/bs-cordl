...
// Write type traits
MARK_REF_T(::System::Net::FtpWebRequestCreator*);
DEFINE_IL2CPP_CLASS(::System::Net::FtpWebRequestCreator*, "System.Net", "FtpWebRequestCreator");
...
public:
  ...
  /// @brief Method Create, addr 0x640af10, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Net::WebRequest* Create(::System::Uri* uri);

  static inline ::System::Net::FtpWebRequestCreator* New_ctor();

  /// @brief Method .ctor, addr 0x640af0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FtpWebRequestCreator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FtpWebRequestCreator(FtpWebRequestCreator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FtpWebRequestCreator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FtpWebRequestCreator(FtpWebRequestCreatorconst&) = delete;
...
static_assert(sizeof(::System::Net::FtpWebRequestCreator) == 0x10, "Size mismatch!");
