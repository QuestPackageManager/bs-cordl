...
public:
  ...
  /// @brief Method Add, addr 0x2efe1ec, size 0x130, virtual true, abstract: false, final true
  inline void Add(::StringW uriPrefix);

  /// @brief Method Clear, addr 0x2efe31c, size 0xb8, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x2efe3d4, size 0x64, virtual true, abstract: false, final true
  inline bool Contains(::StringW uriPrefix);

  /// @brief Method CopyTo, addr 0x2efe438, size 0x74, virtual true, abstract: false, final true
  inline void CopyTo(::ArrayW<::StringW, ::Array<::StringW>*> array, int32_t offset);

  /// @brief Method GetEnumerator, addr 0x2ef84bc, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x2efe53c, size 0x108, virtual true, abstract: false, final true
  inline bool Remove(::StringW uriPrefix);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2efe4ac, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2efc728, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpListener* listener);

  /// @brief Method get_Count, addr 0x2efdc2c, size 0x48, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x2efe1e4, size 0x8, virtual true, abstract: false, final true
