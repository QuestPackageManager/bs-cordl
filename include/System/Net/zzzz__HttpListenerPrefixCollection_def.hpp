...
public:
  ...
  /// @brief Method Add, addr 0x62f252c, size 0x144, virtual true, abstract: false, final true
  inline void Add(::StringW uriPrefix);

  /// @brief Method Clear, addr 0x62f2670, size 0xc4, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x62f2734, size 0x70, virtual true, abstract: false, final true
  inline bool Contains(::StringW uriPrefix);

  /// @brief Method CopyTo, addr 0x62f27a4, size 0x80, virtual true, abstract: false, final true
  inline void CopyTo(::ArrayW<::StringW, ::Array<::StringW>*> array, int32_t offset);

  /// @brief Method GetEnumerator, addr 0x62ecc98, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x62f28ac, size 0x110, virtual true, abstract: false, final true
  inline bool Remove(::StringW uriPrefix);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x62f2824, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x62f0bec, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpListener* listener);

  /// @brief Method get_Count, addr 0x62f206c, size 0x50, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x62f2524, size 0x8, virtual true, abstract: false, final true
