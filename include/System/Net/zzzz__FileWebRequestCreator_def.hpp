...
/// @brief Method Create, addr 0x626eae0, size 0x5c, virtual true, abstract: false, final true
inline ::System::Net::WebRequest* Create(::System::Uri*  uri) ;

static inline ::System::Net::FileWebRequestCreator* New_ctor() ;

/// @brief Method .ctor, addr 0x626eadc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
