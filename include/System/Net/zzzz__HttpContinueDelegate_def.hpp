...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x300080c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3000748, size 0xc4, virtual false, abstract: false, final false
