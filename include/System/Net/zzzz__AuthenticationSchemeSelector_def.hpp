...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x44ac0b8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44ac01c, size 0x9c, virtual false, abstract: false, final false
