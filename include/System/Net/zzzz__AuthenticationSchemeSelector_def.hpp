...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2ffc6a4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ffc5d0, size 0xd4, virtual false, abstract: false, final false
