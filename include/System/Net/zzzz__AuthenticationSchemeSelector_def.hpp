...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x61ee198, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61ee11c, size 0x7c, virtual false, abstract: false, final false
