...
public:
  // Declarations
  /// @brief Method Get, addr 0x63f2284, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW Get(::System::Net::HttpStatusCode code);

  /// @brief Method Get, addr 0x63f2288, size 0x930, virtual false, abstract: false, final false
