...
public:
  // Declarations
  /// @brief Method Get, addr 0x62b4670, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW Get(::System::Net::HttpStatusCode code);

  /// @brief Method Get, addr 0x62b4674, size 0x930, virtual false, abstract: false, final false
