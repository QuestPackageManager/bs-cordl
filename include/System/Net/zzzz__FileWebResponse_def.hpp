...
public:
  ...
  /// @brief Method CheckDisposed, addr 0x44b87f8, size 0x7c, virtual false, abstract: false, final false
  inline void CheckDisposed();

  /// @brief Method Close, addr 0x44b888c, size 0x98, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetObjectData, addr 0x44b8628, size 0x1b8, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetResponseStream, addr 0x44b8a90, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Net.ICloseEx.CloseEx, addr 0x44b8924, size 0x16c, virtual true, abstract: false, final true
  inline void System_Net_ICloseEx_CloseEx(::System::Net::CloseExState closeState);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x44b861c, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x44b74a8, size 0x2d0, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::FileWebRequest* request, ::System::Uri* uri, ::System::IO::FileAccess access, bool asyncHint);

  /// @brief Method .ctor, addr 0x44b83cc, size 0x250, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_Headers, addr 0x44b87e0, size 0x18, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_ResponseUri, addr 0x44b8874, size 0x18, virtual true, abstract: false, final false
