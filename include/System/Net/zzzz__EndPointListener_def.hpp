...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EndPointListener", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EndPointListener(EndPointListener&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EndPointListener", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EndPointListener(EndPointListenerconst&) = delete;
