...
public:
  ...
  /// @brief Method Authenticate, addr 0x2f05e60, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method PreAuthenticate, addr 0x2f05f30, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2f05df4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AuthenticationType, addr 0x2f05f38, size 0x40, virtual true, abstract: false, final true
