...
public:
  ...
  /// @brief Method Authenticate, addr 0x633b1f8, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method PreAuthenticate, addr 0x633b2d8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x633b1a8, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AuthenticationType, addr 0x633b2e0, size 0x44, virtual true, abstract: false, final true
