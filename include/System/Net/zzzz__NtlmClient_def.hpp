...
public:
  ...
  /// @brief Method Authenticate, addr 0x2b219b0, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method PreAuthenticate, addr 0x2b21a80, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2b21944, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AuthenticationType, addr 0x2b21a88, size 0x40, virtual true, abstract: false, final true
