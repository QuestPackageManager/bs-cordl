...
public:
  ...
  /// @brief Method .ctor addr 0x29bfaec size 0xd4 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x29c07a0 size 0x14 virtual true final false
  inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> Invoke(::StringW hostName);

  /// @brief Method BeginInvoke addr 0x29bfbc0 size 0x20 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(::StringW hostName, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x29bfcec size 0xc virtual true final false
...
public:
  ...
  /// @brief Method BeginGetHostAddresses addr 0x29bf95c size 0x190 virtual false final false
  ...
  /// @brief Method EndGetHostAddresses addr 0x29bfbe0 size 0x10c virtual false final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> EndGetHostAddresses(::System::IAsyncResult* asyncResult);

  /// @brief Method GetHostByName_icall addr 0x29bfcf8 size 0x4 virtual false final false
  ...
  /// @brief Method GetHostByAddr_icall addr 0x29bfcfc size 0x4 virtual false final false
  static inline bool GetHostByAddr_icall(::StringW addr, ByRef<::StringW> h_name, ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> h_aliases,
                                         ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> h_addr_list, int32_t hint);

  /// @brief Method GetHostName_icall addr 0x29bfd00 size 0x4 virtual false final false
  static inline bool GetHostName_icall(ByRef<::StringW> h_name);

  /// @brief Method Error_11001 addr 0x29bfd04 size 0x6c virtual false final false
  static inline void Error_11001(::StringW hostName);

  /// @brief Method hostent_to_IPHostEntry addr 0x29bfd70 size 0x314 virtual false final false
  ...
  /// @brief Method GetHostByAddressFromString addr 0x29c0084 size 0x12c virtual false final false
  static inline ::System::Net::IPHostEntry* GetHostByAddressFromString(::StringW address, bool parse);

  /// @brief Method GetHostEntry addr 0x29c01b0 size 0x174 virtual false final false
  static inline ::System::Net::IPHostEntry* GetHostEntry(::StringW hostNameOrAddress);

  /// @brief Method GetHostEntry addr 0x29c0324 size 0x6c virtual false final false
  static inline ::System::Net::IPHostEntry* GetHostEntry(::System::Net::IPAddress* address);

  /// @brief Method GetHostAddresses addr 0x29c047c size 0x1dc virtual false final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> GetHostAddresses(::StringW hostNameOrAddress);

  /// @brief Method GetHostByName addr 0x29c0390 size 0xec virtual false final false
  static inline ::System::Net::IPHostEntry* GetHostByName(::StringW hostName);

  /// @brief Method GetHostName addr 0x29c0658 size 0x2c virtual false final false
  static inline ::StringW GetHostName();

  /// @brief Method GetHostAddressesAsync addr 0x29c0684 size 0x11c virtual false final false
