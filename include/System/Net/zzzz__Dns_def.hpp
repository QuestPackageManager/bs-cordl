...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x620eb54, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::StringW hostName, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x620ec84, size 0xc, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x620f74c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x620ead8, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BeginGetHostAddresses, addr 0x620e948, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method EndGetHostAddresses, addr 0x620eb74, size 0x110, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> EndGetHostAddresses(::System::IAsyncResult* asyncResult);

  /// @brief Method Error_11001, addr 0x620ec9c, size 0x64, virtual false, abstract: false, final false
  static inline void Error_11001(::StringW hostName);

  /// @brief Method GetHostAddresses, addr 0x620f41c, size 0x1e0, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> GetHostAddresses(::StringW hostNameOrAddress);

  /// @brief Method GetHostAddressesAsync, addr 0x620f620, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHostByAddr_icall, addr 0x620ec94, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHostByAddressFromString, addr 0x620f010, size 0x13c, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetHostByAddressFromString(::StringW address, bool parse);

  /// @brief Method GetHostByName, addr 0x620f330, size 0xec, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetHostByName(::StringW hostName);

  /// @brief Method GetHostByName_icall, addr 0x620ec90, size 0x4, virtual false, abstract: false, final false
  static inline bool GetHostByName_icall(::StringW host, ::ByRef<::StringW> h_name, ::ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> h_aliases,
                                         ::ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> h_addr_list, int32_t hint);

  /// @brief Method GetHostEntry, addr 0x620f2c8, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetHostEntry(::System::Net::IPAddress* address);

  /// @brief Method GetHostEntry, addr 0x620f14c, size 0x17c, virtual false, abstract: false, final false
  static inline ::System::Net::IPHostEntry* GetHostEntry(::StringW hostNameOrAddress);

  /// @brief Method GetHostName, addr 0x620f5fc, size 0x24, virtual false, abstract: false, final false
  static inline ::StringW GetHostName();

  /// @brief Method GetHostName_icall, addr 0x620ec98, size 0x4, virtual false, abstract: false, final false
  static inline bool GetHostName_icall(::ByRef<::StringW> h_name);

  /// @brief Method hostent_to_IPHostEntry, addr 0x620ed00, size 0x310, virtual false, abstract: false, final false
