...
public:
  ...
  /// @brief Method .ctor addr 0x2842274 size 0xd4 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x2842f28 size 0x14 virtual true final false
  inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> Invoke(::StringW hostName);

  /// @brief Method BeginInvoke addr 0x2842348 size 0x20 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(::StringW hostName, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x2842474 size 0xc virtual true final false
...
public:
  ...
  /// @brief Method BeginGetHostAddresses addr 0x28420e4 size 0x190 virtual false final false
  ...
  /// @brief Method EndGetHostAddresses addr 0x2842368 size 0x10c virtual false final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> EndGetHostAddresses(::System::IAsyncResult* asyncResult);

  /// @brief Method GetHostByName_icall addr 0x2842480 size 0x4 virtual false final false
  ...
  /// @brief Method GetHostByAddr_icall addr 0x2842484 size 0x4 virtual false final false
  static inline bool GetHostByAddr_icall(::StringW addr, ByRef<::StringW> h_name, ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> h_aliases,
                                         ByRef<::ArrayW<::StringW, ::Array<::StringW>*>> h_addr_list, int32_t hint);

  /// @brief Method GetHostName_icall addr 0x2842488 size 0x4 virtual false final false
  static inline bool GetHostName_icall(ByRef<::StringW> h_name);

  /// @brief Method Error_11001 addr 0x284248c size 0x6c virtual false final false
  static inline void Error_11001(::StringW hostName);

  /// @brief Method hostent_to_IPHostEntry addr 0x28424f8 size 0x314 virtual false final false
  ...
  /// @brief Method GetHostByAddressFromString addr 0x284280c size 0x12c virtual false final false
  static inline ::System::Net::IPHostEntry* GetHostByAddressFromString(::StringW address, bool parse);

  /// @brief Method GetHostEntry addr 0x2842938 size 0x174 virtual false final false
  static inline ::System::Net::IPHostEntry* GetHostEntry(::StringW hostNameOrAddress);

  /// @brief Method GetHostEntry addr 0x2842aac size 0x6c virtual false final false
  static inline ::System::Net::IPHostEntry* GetHostEntry(::System::Net::IPAddress* address);

  /// @brief Method GetHostAddresses addr 0x2842c04 size 0x1dc virtual false final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> GetHostAddresses(::StringW hostNameOrAddress);

  /// @brief Method GetHostByName addr 0x2842b18 size 0xec virtual false final false
  static inline ::System::Net::IPHostEntry* GetHostByName(::StringW hostName);

  /// @brief Method GetHostName addr 0x2842de0 size 0x2c virtual false final false
  static inline ::StringW GetHostName();

  /// @brief Method GetHostAddressesAsync addr 0x2842e0c size 0x11c virtual false final false
