...
public:
  ...
  /// @brief Method GetBytes, addr 0x29bbdc4, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytes(::StringW str);

  /// @brief Method InternalAuthenticate, addr 0x29bba18, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method PreAuthenticate, addr 0x29bbe6c, size 0xc, virtual true, abstract: false, final true
  inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest* webRequest, ::System::Net::ICredentials* credentials);

  /// @brief Method get_AuthenticationType, addr 0x29bbe78, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_AuthenticationType();

  static inline ::System::Net::BasicClient* New_ctor();

  /// @brief Method .ctor, addr 0x29badc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
