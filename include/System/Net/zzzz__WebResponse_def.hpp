...
public:
  ...
  /// @brief Method Close, addr 0x44a2d54, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x44a2d58, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x44a2dc4, size 0x8c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetObjectData, addr 0x44a2d50, size 0x4, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method GetResponseStream, addr 0x44a2e58, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x44a2d44, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4499304, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x44a2d3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext);

  /// @brief Method get_Headers, addr 0x44a2ea0, size 0x24, virtual true, abstract: false, final false
  inline ::System::Net::WebHeaderCollection* get_Headers();

  /// @brief Method get_IsFromCache, addr 0x44a2e50, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsFromCache();

  /// @brief Method get_ResponseUri, addr 0x44a2e7c, size 0x24, virtual true, abstract: false, final false
