...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b3cbf4, size 0x68, virtual true, abstract: false, final true
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  static inline ::System::Empty* New_ctor();

  /// @brief Method ToString, addr 0x5b3cbe0, size 0x14, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5b3cbdc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
