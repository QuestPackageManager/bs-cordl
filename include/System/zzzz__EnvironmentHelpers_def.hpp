...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnvironmentHelpers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnvironmentHelpers(EnvironmentHelpers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnvironmentHelpers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnvironmentHelpers(EnvironmentHelpersconst&) = delete;
