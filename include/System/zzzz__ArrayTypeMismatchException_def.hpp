...
public:
  ...
  /// @brief Method .ctor, addr 0x59fee58, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59feeb8, size 0x8, virtual false, abstract: false, final false
