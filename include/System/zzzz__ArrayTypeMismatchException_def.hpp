...
public:
  ...
  /// @brief Method .ctor, addr 0x28b58c4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x28b5920, size 0x8, virtual false, abstract: false, final false
