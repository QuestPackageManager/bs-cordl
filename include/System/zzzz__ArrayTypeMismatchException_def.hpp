...
public:
  ...
  /// @brief Method .ctor, addr 0x599850c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x599856c, size 0x8, virtual false, abstract: false, final false
