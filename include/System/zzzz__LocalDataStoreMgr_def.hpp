...
public:
  ...
  /// @brief Method CreateLocalDataStore, addr 0x25fb4b4, size 0x1c0, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreHolder* CreateLocalDataStore();

  /// @brief Method DeleteLocalDataStore, addr 0x25fabcc, size 0x104, virtual false, abstract: false, final false
  inline void DeleteLocalDataStore(::System::LocalDataStore* store);

  /// @brief Method AllocateDataSlot, addr 0x25fb674, size 0x250, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreSlot* AllocateDataSlot();

  /// @brief Method AllocateNamedDataSlot, addr 0x25fb8c4, size 0x11c, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreSlot* AllocateNamedDataSlot(::StringW name);

  /// @brief Method GetNamedDataSlot, addr 0x25fb9e0, size 0x11c, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreSlot* GetNamedDataSlot(::StringW name);

  /// @brief Method FreeNamedDataSlot, addr 0x25fbafc, size 0x104, virtual false, abstract: false, final false
  inline void FreeNamedDataSlot(::StringW name);

  /// @brief Method FreeDataSlot, addr 0x25fb31c, size 0x198, virtual false, abstract: false, final false
  inline void FreeDataSlot(int32_t slot, int64_t cookie);

  /// @brief Method ValidateSlot, addr 0x25fada8, size 0x7c, virtual false, abstract: false, final false
  inline void ValidateSlot(::System::LocalDataStoreSlot* slot);

  /// @brief Method GetSlotTableLength, addr 0x25fb1fc, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetSlotTableLength();

  static inline ::System::LocalDataStoreMgr* New_ctor();

  /// @brief Method .ctor, addr 0x25fbc00, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();
