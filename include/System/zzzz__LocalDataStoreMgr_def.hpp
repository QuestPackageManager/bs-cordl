...
public:
  ...
  /// @brief Method AllocateDataSlot, addr 0x3e16980, size 0x234, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreSlot* AllocateDataSlot();

  /// @brief Method AllocateNamedDataSlot, addr 0x3e16bb4, size 0x11c, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreSlot* AllocateNamedDataSlot(::StringW name);

  /// @brief Method CreateLocalDataStore, addr 0x3e167d0, size 0x1b0, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreHolder* CreateLocalDataStore();

  /// @brief Method DeleteLocalDataStore, addr 0x3e15f38, size 0x104, virtual false, abstract: false, final false
  inline void DeleteLocalDataStore(::System::LocalDataStore* store);

  /// @brief Method FreeDataSlot, addr 0x3e16638, size 0x198, virtual false, abstract: false, final false
  inline void FreeDataSlot(int32_t slot, int64_t cookie);

  /// @brief Method FreeNamedDataSlot, addr 0x3e16dec, size 0x104, virtual false, abstract: false, final false
  inline void FreeNamedDataSlot(::StringW name);

  /// @brief Method GetNamedDataSlot, addr 0x3e16cd0, size 0x11c, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreSlot* GetNamedDataSlot(::StringW name);

  /// @brief Method GetSlotTableLength, addr 0x3e16518, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetSlotTableLength();

  static inline ::System::LocalDataStoreMgr* New_ctor();

  /// @brief Method ValidateSlot, addr 0x3e1610c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e16ef0, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor();
