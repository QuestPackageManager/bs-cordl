...
public:
  ...
  /// @brief Method PopulateDefaultValues, addr 0x5b4e824, size 0x4, virtual false, abstract: false, final false
  static inline void PopulateDefaultValues();

  /// @brief Method TryGetSwitchOverride, addr 0x5b4e828, size 0xc, virtual false, abstract: false, final false
