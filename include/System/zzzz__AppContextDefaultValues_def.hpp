...
public:
  ...
  /// @brief Method PopulateDefaultValues, addr 0x3e2b434, size 0x4, virtual false, abstract: false, final false
  static inline void PopulateDefaultValues();

  /// @brief Method TryGetSwitchOverride, addr 0x3e2b438, size 0xc, virtual false, abstract: false, final false
