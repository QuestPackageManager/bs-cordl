...
public:
  ...
  /// @brief Method .ctor, addr 0x5c617f0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5c6184c, size 0x8, virtual false, abstract: false, final false
