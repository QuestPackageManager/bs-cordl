...
public:
  ...
  /// @brief Method .ctor, addr 0x3e0b78c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3e0b7e8, size 0x8, virtual false, abstract: false, final false
