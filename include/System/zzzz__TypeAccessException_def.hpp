...
public:
  ...
  /// @brief Method .ctor, addr 0x5ab3aac, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5ab3b08, size 0x8, virtual false, abstract: false, final false
