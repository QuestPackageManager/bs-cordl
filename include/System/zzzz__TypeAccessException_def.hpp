...
public:
  ...
  /// @brief Method .ctor, addr 0x5b25fa0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b25ffc, size 0x8, virtual false, abstract: false, final false
