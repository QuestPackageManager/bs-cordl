...
public:
  ...
  /// @brief Method .ctor, addr 0x5c63a18, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5c63a74, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TypeAccessException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TypeAccessException(TypeAccessException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TypeAccessException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TypeAccessException(TypeAccessExceptionconst&) = delete;
