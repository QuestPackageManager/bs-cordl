...
public:
  ...
  /// @brief Method Equals, addr 0x5b062f8, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::System::Index other);

  /// @brief Method Equals, addr 0x5b0627c, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FromStart, addr 0x5b0623c, size 0x14, virtual false, abstract: false, final false
  static inline ::System::Index FromStart(int32_t value);

  /// @brief Method GetHashCode, addr 0x5b06308, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetOffset, addr 0x5b06268, size 0x14, virtual false, abstract: false, final false
  inline int32_t GetOffset(int32_t length);

  /// @brief Method ToString, addr 0x5b06324, size 0x28, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToStringFromEnd, addr 0x5b0634c, size 0x180, virtual false, abstract: false, final false
  inline ::StringW ToStringFromEnd();

  /// @brief Method .ctor, addr 0x5b06234, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method get_IsFromEnd, addr 0x5b0625c, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsFromEnd();

  /// @brief Method get_Value, addr 0x5b06250, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x5b06310, size 0x14, virtual false, abstract: false, final false
