...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryDebugView_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryDebugView_1(MemoryDebugView_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryDebugView_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryDebugView_1(MemoryDebugView_1const&) = delete;
