...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x5fdef5c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidCanonical, addr 0x5fdef8c, size 0x168, virtual false, abstract: false, final false
  static inline bool IsValidCanonical(char16_t* name, int32_t start, ::by_ref<int32_t> end, bool allowIPv6, bool notImplicitFile);

  /// @brief Method Parse, addr 0x5fdf608, size 0x54, virtual false, abstract: false, final false
  static inline bool Parse(::StringW name, uint8_t* numbers, int32_t start, int32_t end);

  /// @brief Method ParseCanonical, addr 0x5fdeecc, size 0x90, virtual false, abstract: false, final false
  static inline bool ParseCanonical(::System::ReadOnlySpan_1<char16_t> name, uint8_t* numbers, int32_t start, int32_t end);

  /// @brief Method ParseCanonicalName, addr 0x5fdf3b8, size 0x250, virtual false, abstract: false, final false
  static inline ::StringW ParseCanonicalName(::StringW str, int32_t start, int32_t end, ::by_ref<bool> isLoopback);

  /// @brief Method ParseHostNumber, addr 0x5fdee9c, size 0x30, virtual false, abstract: false, final false
  static inline int32_t ParseHostNumber(::System::ReadOnlySpan_1<char16_t> str, int32_t start, int32_t end);

  /// @brief Method ParseNonCanonical, addr 0x5fdf0f4, size 0x2c4, virtual false, abstract: false, final false
