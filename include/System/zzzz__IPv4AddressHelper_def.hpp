...
public:
  // Declarations
  /// @brief Method IsValid, addr 0x2b71cc8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidCanonical, addr 0x2b71cf8, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x2b72354, size 0x6c, virtual false, abstract: false, final false
  static inline bool Parse(::StringW name, ::cordl_internals::Ptr<uint8_t> numbers, int32_t start, int32_t end);

  /// @brief Method ParseCanonical, addr 0x2b71c3c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseCanonicalName, addr 0x2b7212c, size 0x228, virtual false, abstract: false, final false
  static inline ::StringW ParseCanonicalName(::StringW str, int32_t start, int32_t end, ByRef<bool> isLoopback);

  /// @brief Method ParseHostNumber, addr 0x2b71c0c, size 0x30, virtual false, abstract: false, final false
  static inline int32_t ParseHostNumber(::System::ReadOnlySpan_1<char16_t> str, int32_t start, int32_t end);

  /// @brief Method ParseNonCanonical, addr 0x2b71e38, size 0x2f4, virtual false, abstract: false, final false
