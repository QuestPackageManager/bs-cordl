...
public:
  ...
  /// @brief Method .ctor, addr 0x5b4c3f8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeHandle, addr 0x5b4c44c, size 0x50, virtual true, abstract: false, final false
