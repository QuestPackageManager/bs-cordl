...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReflectionOnlyType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReflectionOnlyType(ReflectionOnlyType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReflectionOnlyType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReflectionOnlyType(ReflectionOnlyTypeconst&) = delete;
