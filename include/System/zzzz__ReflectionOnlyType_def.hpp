...
public:
  ...
  /// @brief Method .ctor, addr 0x2877e64, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeHandle, addr 0x2877ebc, size 0x58, virtual true, abstract: false, final false
