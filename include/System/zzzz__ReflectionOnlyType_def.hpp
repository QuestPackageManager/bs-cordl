...
public:
  ...
  /// @brief Method .ctor, addr 0x2873e68, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TypeHandle, addr 0x2873ec0, size 0x58, virtual true, abstract: false, final false
