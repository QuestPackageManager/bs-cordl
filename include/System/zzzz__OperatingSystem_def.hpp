...
public:
  ...
  /// @brief Method Clone, addr 0x5b2c558, size 0x78, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetObjectData, addr 0x5b2c514, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x5b2c5d0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b2c3e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version);

  /// @brief Method .ctor, addr 0x5b2c3f0, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version, ::StringW servicePack);

  /// @brief Method get_Platform, addr 0x5b2c548, size 0x8, virtual false, abstract: false, final false
  inline ::System::PlatformID get_Platform();

  /// @brief Method get_Version, addr 0x5b2c550, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Method get_VersionString, addr 0x5b2c5d4, size 0x248, virtual false, abstract: false, final false
