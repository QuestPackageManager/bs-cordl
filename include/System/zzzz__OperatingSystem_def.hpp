...
public:
  ...
  /// @brief Method Clone, addr 0x3e085d0, size 0x74, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetObjectData, addr 0x3e08594, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x3e08644, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e08454, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version);

  /// @brief Method .ctor, addr 0x3e0845c, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version, ::StringW servicePack);

  /// @brief Method get_Platform, addr 0x3e085c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::PlatformID get_Platform();

  /// @brief Method get_VersionString, addr 0x3e08648, size 0x1cc, virtual false, abstract: false, final false
