...
public:
  ...
  /// @brief Method Clone, addr 0x5aba064, size 0x78, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetObjectData, addr 0x5aba020, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x5aba0dc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ab9ef4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version);

  /// @brief Method .ctor, addr 0x5ab9efc, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version, ::StringW servicePack);

  /// @brief Method get_Platform, addr 0x5aba054, size 0x8, virtual false, abstract: false, final false
  inline ::System::PlatformID get_Platform();

  /// @brief Method get_Version, addr 0x5aba05c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Method get_VersionString, addr 0x5aba0e0, size 0x248, virtual false, abstract: false, final false
