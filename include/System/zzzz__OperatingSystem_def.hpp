...
public:
  ...
  /// @brief Method Clone, addr 0x3e0d4cc, size 0x74, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetObjectData, addr 0x3e0d490, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x3e0d540, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e0d350, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version);

  /// @brief Method .ctor, addr 0x3e0d358, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version, ::StringW servicePack);

  /// @brief Method get_Platform, addr 0x3e0d4c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::PlatformID get_Platform();

  /// @brief Method get_VersionString, addr 0x3e0d544, size 0x1cc, virtual false, abstract: false, final false
