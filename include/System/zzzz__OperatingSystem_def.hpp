...
public:
  ...
  /// @brief Method Clone, addr 0x3e0d544, size 0x74, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetObjectData, addr 0x3e0d508, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x3e0d5b8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e0d3c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version);

  /// @brief Method .ctor, addr 0x3e0d3d0, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version, ::StringW servicePack);

  /// @brief Method get_Platform, addr 0x3e0d53c, size 0x8, virtual false, abstract: false, final false
  inline ::System::PlatformID get_Platform();

  /// @brief Method get_VersionString, addr 0x3e0d5bc, size 0x1cc, virtual false, abstract: false, final false
