...
// Write type traits
MARK_REF_T(::System::OperatingSystem*);
DEFINE_IL2CPP_CLASS(::System::OperatingSystem*, "System", "OperatingSystem");
...
public:
  ...
  /// @brief Method Clone, addr 0x5c69fd0, size 0x78, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetObjectData, addr 0x5c69f8c, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x5c6a048, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c69e60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version);

  /// @brief Method .ctor, addr 0x5c69e68, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version, ::StringW servicePack);

  /// @brief Method get_Platform, addr 0x5c69fc0, size 0x8, virtual false, abstract: false, final false
  inline ::System::PlatformID get_Platform();

  /// @brief Method get_Version, addr 0x5c69fc8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Method get_VersionString, addr 0x5c6a04c, size 0x248, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OperatingSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OperatingSystem(OperatingSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OperatingSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OperatingSystem(OperatingSystemconst&) = delete;
...
static_assert(sizeof(::System::OperatingSystem) == 0x30, "Size mismatch!");
