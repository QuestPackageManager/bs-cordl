...
public:
  ...
  /// @brief Method Clone, addr 0x3e1aad4, size 0x74, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetObjectData, addr 0x3e1aa98, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x3e1ab48, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e1a958, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version);

  /// @brief Method .ctor, addr 0x3e1a960, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::PlatformID platform, ::System::Version* version, ::StringW servicePack);

  /// @brief Method get_Platform, addr 0x3e1aacc, size 0x8, virtual false, abstract: false, final false
  inline ::System::PlatformID get_Platform();

  /// @brief Method get_VersionString, addr 0x3e1ab4c, size 0x1cc, virtual false, abstract: false, final false
