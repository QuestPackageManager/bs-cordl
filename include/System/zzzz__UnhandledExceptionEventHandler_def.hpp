...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x284e6dc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x284e5ac, size 0x130, virtual false, abstract: false, final false
