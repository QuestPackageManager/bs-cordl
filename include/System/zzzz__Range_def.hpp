...
public:
  ...
  /// @brief Method Equals, addr 0x5b1c33c, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::System::Range other);

  /// @brief Method Equals, addr 0x5b1c2b0, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5b1c364, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x5b1c3e0, size 0x240, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5b1c2a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Index start, ::System::Index end);

  /// @brief Method get_End, addr 0x5b1c2a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Index get_End();

  /// @brief Method get_Start, addr 0x5b1c298, size 0x8, virtual false, abstract: false, final false
