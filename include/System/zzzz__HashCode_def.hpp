...
public:
  ...
  /// @brief Method GenerateGlobalSeed, addr 0x25a8664, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Rol, addr 0x25a8688, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t Rol(uint32_t value, int32_t count);

  /// @brief Method Initialize, addr 0x25a8694, size 0xb8, virtual false, abstract: false, final false
  static inline void Initialize(ByRef<uint32_t> v1, ByRef<uint32_t> v2, ByRef<uint32_t> v3, ByRef<uint32_t> v4);

  /// @brief Method Round, addr 0x25a874c, size 0x78, virtual false, abstract: false, final false
  static inline uint32_t Round(uint32_t hash, uint32_t input);

  /// @brief Method QueueRound, addr 0x25a87c4, size 0x78, virtual false, abstract: false, final false
  static inline uint32_t QueueRound(uint32_t hash, uint32_t queuedValue);

  /// @brief Method MixState, addr 0x25a883c, size 0x88, virtual false, abstract: false, final false
  static inline uint32_t MixState(uint32_t v1, uint32_t v2, uint32_t v3, uint32_t v4);

  /// @brief Method MixEmptyState, addr 0x25a88c4, size 0x64, virtual false, abstract: false, final false
  static inline uint32_t MixEmptyState();

  /// @brief Method MixFinal, addr 0x25a8928, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t MixFinal(uint32_t hash);

  /// @brief Method Add, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> inline void Add(T value);

  /// @brief Method Add, addr 0x25a8950, size 0x288, virtual false, abstract: false, final false
  inline void Add(int32_t value);

  /// @brief Method ToHashCode, addr 0x25a8bd8, size 0x220, virtual false, abstract: false, final false
  inline int32_t ToHashCode();

  /// @brief Method GetHashCode, addr 0x25a8df8, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Equals, addr 0x25a8e68, size 0x4c, virtual true, abstract: false, final false
