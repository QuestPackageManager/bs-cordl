...
public:
  ...
  /// @brief Method Add, addr 0x269af4c, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x269b464, size 0x4c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GenerateGlobalSeed, addr 0x269ac60, size 0x24, virtual false, abstract: false, final false
  static inline uint32_t GenerateGlobalSeed();

  /// @brief Method GetHashCode, addr 0x269b3f4, size 0x4c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Initialize, addr 0x269ac90, size 0xb8, virtual false, abstract: false, final false
  static inline void Initialize(ByRef<uint32_t> v1, ByRef<uint32_t> v2, ByRef<uint32_t> v3, ByRef<uint32_t> v4);

  /// @brief Method MixEmptyState, addr 0x269aec0, size 0x64, virtual false, abstract: false, final false
  static inline uint32_t MixEmptyState();

  /// @brief Method MixFinal, addr 0x269af24, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t MixFinal(uint32_t hash);

  /// @brief Method MixState, addr 0x269ae38, size 0x88, virtual false, abstract: false, final false
  static inline uint32_t MixState(uint32_t v1, uint32_t v2, uint32_t v3, uint32_t v4);

  /// @brief Method QueueRound, addr 0x269adc0, size 0x78, virtual false, abstract: false, final false
  static inline uint32_t QueueRound(uint32_t hash, uint32_t queuedValue);

  /// @brief Method Rol, addr 0x269ac84, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t Rol(uint32_t value, int32_t count);

  /// @brief Method Round, addr 0x269ad48, size 0x78, virtual false, abstract: false, final false
  static inline uint32_t Round(uint32_t hash, uint32_t input);

  /// @brief Method ToHashCode, addr 0x269b1d4, size 0x220, virtual false, abstract: false, final false
