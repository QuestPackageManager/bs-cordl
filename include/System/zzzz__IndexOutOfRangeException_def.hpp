...
public:
  ...
  /// @brief Method .ctor, addr 0x25cbe2c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::IndexOutOfRangeException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25cbe88, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25cbeac, size 0x8, virtual false, abstract: false, final false
