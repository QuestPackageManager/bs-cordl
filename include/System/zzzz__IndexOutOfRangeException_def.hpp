...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IndexOutOfRangeException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IndexOutOfRangeException(IndexOutOfRangeException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IndexOutOfRangeException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IndexOutOfRangeException(IndexOutOfRangeExceptionconst&) = delete;
