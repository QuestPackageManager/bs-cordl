...
public:
  // Declarations
  /// @brief Method AsSpan, addr 0x5b0d180, size 0x58, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text);

  /// @brief Method AsSpan, addr 0x5b0d1d8, size 0x80, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text, int32_t start);

  /// @brief Method AsSpan, addr 0x5b0d258, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x5b0cc34, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWith, addr 0x5b0ce70, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method EqualsOrdinal, addr 0x5b0ca7c, size 0xf8, virtual false, abstract: false, final false
  static inline bool EqualsOrdinal(::System::ReadOnlySpan_1<char16_t> span, ::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method EqualsOrdinalIgnoreCase, addr 0x5b0cb74, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToUpperInvariant, addr 0x5b0ccd8, size 0x198, virtual false, abstract: false, final false
  static inline int32_t ToUpperInvariant(::System::ReadOnlySpan_1<char16_t> source, ::System::Span_1<char16_t> destination);

  /// @brief Method Trim, addr 0x5b0391c, size 0x10, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> Trim(::System::ReadOnlySpan_1<char16_t> span);

  /// @brief Method TrimEnd, addr 0x5b0d3dc, size 0x104, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> TrimEnd(::System::ReadOnlySpan_1<char16_t> span);

  /// @brief Method TrimStart, addr 0x5b0d2ec, size 0xf0, virtual false, abstract: false, final false
