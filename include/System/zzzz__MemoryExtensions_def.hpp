...
public:
  // Declarations
  /// @brief Method AsSpan, addr 0x3dfb280, size 0x58, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text);

  /// @brief Method AsSpan, addr 0x3dfb2d8, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text, int32_t start);

  /// @brief Method AsSpan, addr 0x3dfb364, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x3dfae20, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWith, addr 0x3dfb00c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method EqualsOrdinal, addr 0x3dfacd8, size 0x9c, virtual false, abstract: false, final false
  static inline bool EqualsOrdinal(::System::ReadOnlySpan_1<char16_t> span, ::System::ReadOnlySpan_1<char16_t> value);

  /// @brief Method EqualsOrdinalIgnoreCase, addr 0x3dfad74, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ToUpperInvariant, addr 0x3dfaeb4, size 0x158, virtual false, abstract: false, final false
  static inline int32_t ToUpperInvariant(::System::ReadOnlySpan_1<char16_t> source, ::System::Span_1<char16_t> destination);

  /// @brief Method Trim, addr 0x3df273c, size 0x10, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> Trim(::System::ReadOnlySpan_1<char16_t> span);

  /// @brief Method TrimEnd, addr 0x3dfb4f8, size 0xe4, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> TrimEnd(::System::ReadOnlySpan_1<char16_t> span);

  /// @brief Method TrimStart, addr 0x3dfb404, size 0xf4, virtual false, abstract: false, final false
