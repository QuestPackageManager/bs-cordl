...
public:
  // Declarations
  /// @brief Method Equals, addr 0x2878914, size 0x50, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x2878964, size 0x8, virtual true, abstract: false, final false
