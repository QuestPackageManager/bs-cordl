...
public:
  // Declarations
  /// @brief Method Equals, addr 0x3e34518, size 0x4c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x3e34564, size 0x8, virtual true, abstract: false, final false
