...
// Write type traits
MARK_REF_T(::System::DelegateData*);
DEFINE_IL2CPP_CLASS(::System::DelegateData*, "System", "DelegateData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5c9071c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DelegateData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DelegateData(DelegateData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DelegateData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DelegateData(DelegateDataconst&) = delete;
...
static_assert(sizeof(::System::DelegateData) == 0x28, "Size mismatch!");
