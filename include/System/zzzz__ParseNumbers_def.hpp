...
public:
  // Declarations
  /// @brief Method EatWhiteSpace, addr 0x5c56164, size 0xc0, virtual false, abstract: false, final false
  static inline void EatWhiteSpace(::System::ReadOnlySpan_1<char16_t> s, ::by_ref<int32_t> i);

  /// @brief Method GrabInts, addr 0x5c567bc, size 0x1f8, virtual false, abstract: false, final false
  static inline int32_t GrabInts(int32_t radix, ::System::ReadOnlySpan_1<char16_t> s, ::by_ref<int32_t> i, bool isUnsigned);

  /// @brief Method GrabLongs, addr 0x5c56224, size 0x1c0, virtual false, abstract: false, final false
  static inline int64_t GrabLongs(int32_t radix, ::System::ReadOnlySpan_1<char16_t> s, ::by_ref<int32_t> i, bool isUnsigned);

  /// @brief Method IntToString, addr 0x5c569b4, size 0x34c, virtual false, abstract: false, final false
  static inline ::StringW IntToString(int32_t n, int32_t radix, int32_t width, char16_t paddingChar, int32_t flags);

  /// @brief Method IsDigit, addr 0x5c571d4, size 0x54, virtual false, abstract: false, final false
  static inline bool IsDigit(char16_t c, int32_t radix, ::by_ref<int32_t> result);

  /// @brief Method LongToString, addr 0x5c56d00, size 0x3b4, virtual false, abstract: false, final false
  static inline ::StringW LongToString(int64_t n, int32_t radix, int32_t width, char16_t paddingChar, int32_t flags);

  /// @brief Method StringToInt, addr 0x5c563e4, size 0x18, virtual false, abstract: false, final false
  static inline int32_t StringToInt(::System::ReadOnlySpan_1<char16_t> s, int32_t radix, int32_t flags);

  /// @brief Method StringToInt, addr 0x5c563fc, size 0x3c0, virtual false, abstract: false, final false
  static inline int32_t StringToInt(::System::ReadOnlySpan_1<char16_t> s, int32_t radix, int32_t flags, ::by_ref<int32_t> currPos);

  /// @brief Method StringToLong, addr 0x5c55de4, size 0x18, virtual false, abstract: false, final false
  static inline int64_t StringToLong(::System::ReadOnlySpan_1<char16_t> s, int32_t radix, int32_t flags);

  /// @brief Method StringToLong, addr 0x5c55dfc, size 0x368, virtual false, abstract: false, final false
  static inline int64_t StringToLong(::System::ReadOnlySpan_1<char16_t> s, int32_t radix, int32_t flags, ::by_ref<int32_t> currPos);

  /// @brief Method ThrowOverflowInt32Exception, addr 0x5c57144, size 0x48, virtual false, abstract: false, final false
  static inline void ThrowOverflowInt32Exception();

  /// @brief Method ThrowOverflowInt64Exception, addr 0x5c570b4, size 0x48, virtual false, abstract: false, final false
  static inline void ThrowOverflowInt64Exception();

  /// @brief Method ThrowOverflowUInt32Exception, addr 0x5c5718c, size 0x48, virtual false, abstract: false, final false
  static inline void ThrowOverflowUInt32Exception();

  /// @brief Method ThrowOverflowUInt64Exception, addr 0x5c570fc, size 0x48, virtual false, abstract: false, final false
