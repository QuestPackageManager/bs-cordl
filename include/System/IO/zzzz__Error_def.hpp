...
public:
  // Declarations
  /// @brief Method GetEndOfFile, addr 0x2775d88, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Exception* GetEndOfFile();

  /// @brief Method GetReadNotSupported, addr 0x2775e08, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Exception* GetReadNotSupported();

  /// @brief Method GetStreamIsClosed, addr 0x2775d10, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Exception* GetStreamIsClosed();

  /// @brief Method GetWriteNotSupported, addr 0x2775e7c, size 0x74, virtual false, abstract: false, final false
