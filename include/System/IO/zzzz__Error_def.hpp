...
public:
  // Declarations
  /// @brief Method GetEndOfFile, addr 0x3d39008, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Exception* GetEndOfFile();

  /// @brief Method GetReadNotSupported, addr 0x3d39080, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetReadNotSupported();

  /// @brief Method GetStreamIsClosed, addr 0x3d38f98, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Exception* GetStreamIsClosed();

  /// @brief Method GetWriteNotSupported, addr 0x3d390ec, size 0x6c, virtual false, abstract: false, final false
