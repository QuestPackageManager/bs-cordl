...
public:
  ...
  /// @brief Method MoveNext, addr 0x5bff3ac, size 0x278, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5bff624, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5bff630, size 0x464, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5bffa94, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5bffb00, size 0x4b4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5bfffb4, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5c00020, size 0x5e0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5c00600, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5c0066c, size 0x4b4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5c00b20, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method CheckAsyncTaskInProgress, addr 0x5bfc59c, size 0x70, virtual false, abstract: false, final false
  inline void CheckAsyncTaskInProgress();

  /// @brief Method Close, addr 0x5bfcfb4, size 0x70, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method CloseStreamFromDispose, addr 0x5bfd470, size 0xe0, virtual false, abstract: false, final false
  inline void CloseStreamFromDispose(bool disposing);

  /// @brief Method Dispose, addr 0x5bfd024, size 0x90, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DisposeAsync, addr 0x5bfd238, size 0x98, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method DisposeAsyncCore, addr 0x5bfd2d0, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::ValueTask DisposeAsyncCore();

  /// @brief Method Flush, addr 0x5bfd560, size 0x20, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method Flush, addr 0x5bfd0b4, size 0x184, virtual false, abstract: false, final false
  inline void Flush(bool flushStream, bool flushEncoder);

  /// @brief Method FlushAsync, addr 0x5bfecdc, size 0x110, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync();

  /// @brief Method FlushAsyncInternal, addr 0x5bff1d0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method FlushAsyncInternal, addr 0x5bfeff4, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x5bfcaa0, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowAsyncIOInProgress, addr 0x5bfc60c, size 0x4c, virtual false, abstract: false, final false
  static inline void ThrowAsyncIOInProgress();

  /// @brief Method Write, addr 0x5bfd65c, size 0x78, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t> buffer);

  /// @brief Method Write, addr 0x5bfd6d4, size 0x1ec, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x5bfdb6c, size 0x74, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method Write, addr 0x5bfd5d0, size 0x8c, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method WriteAsync, addr 0x5bfe68c, size 0x2dc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<char16_t> buffer, int32_t index, int32_t count);

  /// @brief Method WriteAsync, addr 0x5bfe138, size 0x1f4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::StringW value);

  /// @brief Method WriteAsync, addr 0x5bfdc58, size 0x180, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(char16_t value);

  /// @brief Method WriteAsyncInternal, addr 0x5bfebbc, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteAsyncInternal, addr 0x5bfe574, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteAsyncInternal, addr 0x5bfe024, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteLine, addr 0x5bfdbe0, size 0x78, virtual true, abstract: false, final false
  inline void WriteLine(::StringW value);

  /// @brief Method WriteSpan, addr 0x5bfd8c0, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bfc6ac, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5bfcbe8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW path);

  /// @brief Method .ctor, addr 0x5bfcec0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, bool append);

  /// @brief Method .ctor, addr 0x5bfcf3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, bool append, ::System::Text::Encoding* encoding);

  /// @brief Method .ctor, addr 0x5bfcc60, size 0x260, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, bool append, ::System::Text::Encoding* encoding, int32_t bufferSize);

  /// @brief Method .ctor, addr 0x5bfc7fc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream);

  /// @brief Method .ctor, addr 0x5bfca8c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Text::Encoding* encoding);

  /// @brief Method .ctor, addr 0x5bfca98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Text::Encoding* encoding, int32_t bufferSize);

  /// @brief Method .ctor, addr 0x5bfc874, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseStream, addr 0x5bfd5c0, size 0x8, virtual true, abstract: false, final false
  inline ::System::IO::Stream* get_BaseStream();

  /// @brief Method get_Encoding, addr 0x5bfd5c8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method get_LeaveOpen, addr 0x5bfd550, size 0x10, virtual false, abstract: false, final false
  inline bool get_LeaveOpen();

  /// @brief Method get_UTF8NoBOM, addr 0x5bfc658, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Text::Encoding* get_UTF8NoBOM();

  static inline void setStaticF_Null(::System::IO::StreamWriter* value);

  /// @brief Method set_AutoFlush, addr 0x5bfd580, size 0x40, virtual true, abstract: false, final false
  inline void set_AutoFlush(bool value);

  /// @brief Method set_CharPos_Prop, addr 0x5bff1c0, size 0x8, virtual false, abstract: false, final false
  inline void set_CharPos_Prop(int32_t value);

  /// @brief Method set_HaveWrittenPreamble_Prop, addr 0x5bff1c8, size 0x8, virtual false, abstract: false, final false
