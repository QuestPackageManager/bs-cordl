...
public:
  ...
  /// @brief Method EndsInDirectorySeparator, addr 0x3cd9478, size 0x80, virtual false, abstract: false, final false
  static inline bool EndsInDirectorySeparator(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method GetIsCaseSensitive, addr 0x3cd9868, size 0x30c, virtual false, abstract: false, final false
  static inline bool GetIsCaseSensitive();

  /// @brief Method GetRootLength, addr 0x3cd93ec, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t GetRootLength(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method IsDirectorySeparator, addr 0x3cd9468, size 0x10, virtual false, abstract: false, final false
  static inline bool IsDirectorySeparator(char16_t c);

  /// @brief Method IsPartiallyQualified, addr 0x3cd9b74, size 0x8, virtual false, abstract: false, final false
  static inline bool IsPartiallyQualified(::StringW path);

  /// @brief Method IsRoot, addr 0x3cd96b4, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsRoot(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method StartsWithDirectorySeparator, addr 0x3cd94f8, size 0x7c, virtual false, abstract: false, final false
  static inline bool StartsWithDirectorySeparator(::System::ReadOnlySpan_1<char16_t> path);

  /// @brief Method TrimEndingDirectorySeparator, addr 0x3cd9574, size 0x140, virtual false, abstract: false, final false
  static inline ::StringW TrimEndingDirectorySeparator(::StringW path);

  /// @brief Method TrimEndingDirectorySeparator, addr 0x3cd9730, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsCaseSensitive, addr 0x3cd9810, size 0x58, virtual false, abstract: false, final false
