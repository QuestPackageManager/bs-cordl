...
public:
  ...
  /// @brief Method Dispose, addr 0x5bfaf74, size 0x28, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x5bfaf20, size 0x54, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::System::IO::PinnedBufferMemoryStream* New_ctor(::ArrayW<uint8_t> array);

  /// @brief Method Read, addr 0x5bfaa3c, size 0x4, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<uint8_t> buffer);

  /// @brief Method Write, addr 0x5bfac40, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bfa738, size 0xbc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PinnedBufferMemoryStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PinnedBufferMemoryStream(PinnedBufferMemoryStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PinnedBufferMemoryStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PinnedBufferMemoryStream(PinnedBufferMemoryStreamconst&) = delete;
