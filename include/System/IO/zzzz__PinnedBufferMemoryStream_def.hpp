...
/// @brief Method Dispose, addr 0x5a4b43c, size 0x28, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x5a4b3e8, size 0x54, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::System::IO::PinnedBufferMemoryStream* New_ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  array) ;

/// @brief Method Read, addr 0x5a4af04, size 0x4, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<uint8_t>  buffer) ;

/// @brief Method Write, addr 0x5a4b108, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a4ac00, size 0xbc, virtual false, abstract: false, final false
