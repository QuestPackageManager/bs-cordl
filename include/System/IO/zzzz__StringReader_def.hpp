...
public:
  ...
  /// @brief Method Close, addr 0x5adae54, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x5adae64, size 0x8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::System::IO::StringReader* New_ctor(::StringW s);

  /// @brief Method Peek, addr 0x5adae6c, size 0x48, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x5adaeb4, size 0x50, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x5adaf04, size 0x188, virtual true, abstract: false, final false
  inline int32_t Read(::ByRef<::ArrayW<char16_t, ::Array<char16_t>*>> buffer, int32_t index, int32_t count);

  /// @brief Method ReadAsync, addr 0x5adb1d8, size 0x1cc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x5adb0c8, size 0x110, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x5adb08c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5adad9c, size 0xb8, virtual false, abstract: false, final false
