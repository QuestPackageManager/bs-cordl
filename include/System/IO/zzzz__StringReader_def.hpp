...
public:
  ...
  /// @brief Method Close, addr 0x28ec398, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x28ec3a8, size 0x10, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::System::IO::StringReader* New_ctor(::StringW s);

  /// @brief Method Peek, addr 0x28ec3b8, size 0x3c, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x28ec3f4, size 0x44, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x28ec438, size 0x1bc, virtual true, abstract: false, final false
  inline int32_t Read(ByRef<::ArrayW<char16_t, ::Array<char16_t>*>> buffer, int32_t index, int32_t count);

  /// @brief Method ReadAsync, addr 0x28ec744, size 0x1f0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x28ec630, size 0x114, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x28ec5f4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28ec2cc, size 0xcc, virtual false, abstract: false, final false
