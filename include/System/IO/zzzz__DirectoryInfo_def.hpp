...
public:
  // Declarations
  /// @brief Method Init, addr 0x5ac97e4, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ac9a60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5ac9064, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::StringW originalPath, ::StringW fullPath, ::StringW fileName, bool isNormalized);

  /// @brief Method .ctor, addr 0x5ab7e88, size 0x8c, virtual false, abstract: false, final false
