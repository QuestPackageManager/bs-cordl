...
/// @brief Method CBWrapper, addr 0x5a6e9b0, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a6da54, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::AsyncCallback*  cb, ::System::Object*  state) ;

/// @brief Method get_AsyncState, addr 0x5a6ea54, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x5a6ea64, size 0x8, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x5a6ea5c, size 0x8, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted, addr 0x5a6ea6c, size 0x8, virtual true, abstract: false, final true
