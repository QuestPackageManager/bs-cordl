...
public:
  ...
  /// @brief Method CBWrapper, addr 0x3d7e3ac, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d7e2e0, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::System::AsyncCallback* cb, ::System::Object* state);

  /// @brief Method get_AsyncState, addr 0x3d7e440, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_AsyncState();

  /// @brief Method get_AsyncWaitHandle, addr 0x3d7e450, size 0x8, virtual true, abstract: false, final true
  inline ::System::Threading::WaitHandle* get_AsyncWaitHandle();

  /// @brief Method get_CompletedSynchronously, addr 0x3d7e448, size 0x8, virtual true, abstract: false, final true
  inline bool get_CompletedSynchronously();

  /// @brief Method get_IsCompleted, addr 0x3d7e458, size 0x8, virtual true, abstract: false, final true
