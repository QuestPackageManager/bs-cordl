...
public:
  ...
  /// @brief Method BeginRead, addr 0x5c13ccc, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x5c13dfc, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method CopyTo, addr 0x5c13a7c, size 0x8, virtual true, abstract: false, final false
  inline void CopyTo(::System::IO::Stream* destination, int32_t bufferSize);

  /// @brief Method CopyToAsync, addr 0x5c13a84, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5c13bc0, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x5c13d58, size 0xa4, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x5c13e88, size 0xa4, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Flush, addr 0x5c13bc4, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method FlushAsync, addr 0x5c13bc8, size 0x104, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  static inline ::GlobalNamespace::Stream_NullStream* New_ctor();

  /// @brief Method Read, addr 0x5c13f2c, size 0x8, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method Read, addr 0x5c13f34, size 0x8, virtual true, abstract: false, final false
  inline int32_t Read(::System::Span_1<uint8_t> buffer);

  /// @brief Method ReadAsync, addr 0x5c13f3c, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadAsync, addr 0x5c13f98, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadByte, addr 0x5c13fdc, size 0x8, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method Seek, addr 0x5c141b8, size 0x8, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x5c141c0, size 0x4, virtual true, abstract: false, final false
  inline void SetLength(int64_t length);

  /// @brief Method Write, addr 0x5c13fe4, size 0x4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method Write, addr 0x5c13fe8, size 0x4, virtual true, abstract: false, final false
  inline void Write(::System::ReadOnlySpan_1<uint8_t> buffer);

  /// @brief Method WriteAsync, addr 0x5c13fec, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteAsync, addr 0x5c140f0, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteByte, addr 0x5c141b4, size 0x4, virtual true, abstract: false, final false
  inline void WriteByte(uint8_t value);

  /// @brief Method .ctor, addr 0x5c1383c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Threading::Tasks::Task_1<int32_t>* getStaticF_s_zeroTask();

  /// @brief Method get_CanRead, addr 0x5c13a50, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x5c13a60, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x5c13a58, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x5c13a68, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x5c13a70, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_Position();

  static inline void setStaticF_s_zeroTask(::System::Threading::Tasks::Task_1<int32_t>* value);

  /// @brief Method set_Position, addr 0x5c13a78, size 0x4, virtual true, abstract: false, final false
