...
namespace System::IO::Enumeration {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3609)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2464), inst: 292 }), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(2470), inst: 292 }), TypeDefinitionIndex(TypeDefinitionIndex(3641)), TypeDefinitionIndex(TypeDefinitionIndex(3594)), TypeDefinitionIndex(TypeDefinitionIndex(2470)),
