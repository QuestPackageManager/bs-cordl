...
// Write type traits
MARK_REF_T(::System::IO::Enumeration::FileSystemName*);
DEFINE_IL2CPP_CLASS(::System::IO::Enumeration::FileSystemName*, "System.IO.Enumeration", "FileSystemName");
...
public:
  ...
  __declspec(property(get = getStaticF_s_simpleWildcardChars, put = setStaticF_s_simpleWildcardChars)) ::ArrayW<char16_t> s_simpleWildcardChars;
  ...
  /// @brief Method MatchPattern, addr 0x5c22548, size 0x7ac, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesSimpleExpression, addr 0x5c21bd0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesWin32Expression, addr 0x5c21c5c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method TranslateWin32Expression, addr 0x5c215f4, size 0x3b0, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<char16_t> getStaticF_s_wildcardChars();

  static inline void setStaticF_s_simpleWildcardChars(::ArrayW<char16_t> value);

  static inline void setStaticF_s_wildcardChars(::ArrayW<char16_t> value);
...
static_assert(sizeof(::System::IO::Enumeration::FileSystemName) == 0x10, "Size mismatch!");
