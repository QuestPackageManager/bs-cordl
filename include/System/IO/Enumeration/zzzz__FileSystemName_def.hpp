...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FileSystemName", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FileSystemName(FileSystemName&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FileSystemName", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FileSystemName(FileSystemNameconst&) = delete;
