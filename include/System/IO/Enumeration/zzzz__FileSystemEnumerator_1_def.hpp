...
public:
  ...
  __declspec(property(get = __cordl_internal_get__entryBuffer, put = __cordl_internal_set__entryBuffer)) ::ArrayW<uint8_t> _entryBuffer;
  ...
  __declspec(property(get = __cordl_internal_get__pathBuffer, put = __cordl_internal_set__pathBuffer)) ::ArrayW<char16_t> _pathBuffer;
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__entryBuffer() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get__entryBuffer();
  ...
  constexpr ::ArrayW<char16_t> const& __cordl_internal_get__pathBuffer() const;

  constexpr ::ArrayW<char16_t>& __cordl_internal_get__pathBuffer();
  ...
  constexpr void __cordl_internal_set__entryBuffer(::ArrayW<uint8_t> value);
  ...
  constexpr void __cordl_internal_set__pathBuffer(::ArrayW<char16_t> value);
...
public:
  ...
  ::ArrayW<char16_t> ____pathBuffer;

  /// @brief Field _entryBuffer, offset: 0x70, size: 0x8, def value: None
  ::ArrayW<uint8_t> ____entryBuffer;
