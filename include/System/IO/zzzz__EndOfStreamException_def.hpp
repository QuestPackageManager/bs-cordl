...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EndOfStreamException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EndOfStreamException(EndOfStreamException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EndOfStreamException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EndOfStreamException(EndOfStreamExceptionconst&) = delete;
