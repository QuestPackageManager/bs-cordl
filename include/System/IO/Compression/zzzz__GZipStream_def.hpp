...
public:
  ...
  /// @brief Method .ctor addr 0x2941cb8 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2941cc0 size 0xb8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2941d84 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2941d8c size 0xac virtual false final false
  inline void _ctor(::System::IO::Stream* stream, ::System::IO::Compression::CompressionLevel compressionLevel, bool leaveOpen);

  /// @brief Method get_CanRead addr 0x2941e48 size 0x18 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanWrite addr 0x2941e60 size 0x18 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method get_CanSeek addr 0x2941e78 size 0x18 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_Length addr 0x2941e90 size 0x50 virtual true final false
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0x2941ee0 size 0x50 virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0x2941f30 size 0x50 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method Flush addr 0x2941f80 size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method Seek addr 0x2941fbc size 0x50 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0x294200c size 0x50 virtual true final false
  inline void SetLength(int64_t value);

  /// @brief Method ReadByte addr 0x294205c size 0x24 virtual true final false
  inline int32_t ReadByte();

  /// @brief Method BeginRead addr 0x2942080 size 0xb4 virtual true final false
  ...
  /// @brief Method EndRead addr 0x2942134 size 0x48 virtual true final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method Read addr 0x294217c size 0x24 virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method Read addr 0x29421a0 size 0xec virtual true final false
  inline int32_t Read(::System::Span_1<uint8_t> buffer);

  /// @brief Method BeginWrite addr 0x29423a8 size 0xb4 virtual true final false
  ...
  /// @brief Method EndWrite addr 0x294245c size 0xc virtual true final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Write addr 0x2942468 size 0x24 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method Write addr 0x294248c size 0xec virtual true final false
  inline void Write(::System::ReadOnlySpan_1<uint8_t> buffer);

  /// @brief Method CopyTo addr 0x29425fc size 0x24 virtual true final false
  inline void CopyTo(::System::IO::Stream* destination, int32_t bufferSize);

  /// @brief Method Dispose addr 0x2942620 size 0xb8 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method ReadAsync addr 0x29426d8 size 0x24 virtual true final false
  ...
  /// @brief Method ReadAsync addr 0x29426fc size 0xdc virtual true final false
  ...
  /// @brief Method WriteAsync addr 0x29427e0 size 0x24 virtual true final false
  ...
  /// @brief Method WriteAsync addr 0x2942804 size 0xdc virtual true final false
  ...
  /// @brief Method FlushAsync addr 0x29428e8 size 0x24 virtual true final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method CopyToAsync addr 0x294290c size 0x24 virtual true final false
  ...
  /// @brief Method CheckDeflateStream addr 0x2941fa4 size 0x18 virtual false final false
  inline void CheckDeflateStream();

  /// @brief Method ThrowStreamClosedException addr 0x2942930 size 0x54 virtual false final false
