...
public:
  ...
  /// @brief Method .ctor, addr 0x2948a28, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke, addr 0x2949280, size 0x14, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method get_IsInvalid, addr 0x2949294, size 0x54, virtual true, abstract: false, final false
  inline bool get_IsInvalid();

  static inline ::System::IO::Compression::__DeflateStreamNative__SafeDeflateStreamHandle* New_ctor();

  /// @brief Method .ctor, addr 0x2949224, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method ReleaseHandle, addr 0x29492e8, size 0x88, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2948a20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Create, addr 0x29471f8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x2948b84, size 0x98, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Dispose, addr 0x2947498, size 0x104, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Flush, addr 0x2947ba8, size 0x54, virtual false, abstract: false, final false
  inline void Flush();

  /// @brief Method ReadZStream, addr 0x29475e4, size 0x78, virtual false, abstract: false, final false
  inline int32_t ReadZStream(void* buffer, int32_t length);

  /// @brief Method WriteZStream, addr 0x294788c, size 0x6c, virtual false, abstract: false, final false
  inline void WriteZStream(void* buffer, int32_t length);

  /// @brief Method UnmanagedRead, addr 0x29488a8, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t UnmanagedRead(void* buffer, int32_t length, void* data);

  /// @brief Method UnmanagedRead, addr 0x2948eac, size 0x1a4, virtual false, abstract: false, final false
  inline int32_t UnmanagedRead(void* buffer, int32_t length);

  /// @brief Method UnmanagedWrite, addr 0x2948964, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t UnmanagedWrite(void* buffer, int32_t length, void* data);

  /// @brief Method UnmanagedWrite, addr 0x2949050, size 0x1d4, virtual false, abstract: false, final false
  inline int32_t UnmanagedWrite(void* buffer, int32_t length);

  /// @brief Method CheckResult, addr 0x2948c80, size 0x134, virtual false, abstract: false, final false
  inline void CheckResult(int32_t result, ::StringW where);

  /// @brief Method CreateZStream, addr 0x2948aec, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CloseZStream, addr 0x294927c, size 0x4, virtual false, abstract: false, final false
  static inline int32_t CloseZStream(void* stream);

  /// @brief Method Flush, addr 0x2948c1c, size 0x64, virtual false, abstract: false, final false
  static inline int32_t Flush(::System::IO::Compression::__DeflateStreamNative__SafeDeflateStreamHandle* stream);

  /// @brief Method ReadZStream, addr 0x2948db4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteZStream, addr 0x2948e30, size 0x7c, virtual false, abstract: false, final false
