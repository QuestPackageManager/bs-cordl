...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x63f6bc0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63f642c, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x63f6be4, size 0x84, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x63f6b68, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInvalid, addr 0x63f6bd4, size 0x10, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckResult, addr 0x63f6614, size 0xd8, virtual false, abstract: false, final false
  inline void CheckResult(int32_t result, ::StringW where);

  /// @brief Method CloseZStream, addr 0x63f6bbc, size 0x4, virtual false, abstract: false, final false
  static inline int32_t CloseZStream(::System::IntPtr stream);

  /// @brief Method Create, addr 0x63f4d38, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateZStream, addr 0x63f6498, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x63f4f8c, size 0x114, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x63f6568, size 0x48, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x63f65b0, size 0x64, virtual false, abstract: false, final false
  static inline int32_t Flush(::System::IO::Compression::DeflateStreamNative_SafeDeflateStreamHandle* stream);

  /// @brief Method Flush, addr 0x63f5664, size 0x58, virtual false, abstract: false, final false
  inline void Flush();

  static inline ::System::IO::Compression::DeflateStreamNative* New_ctor();

  /// @brief Method ReadZStream, addr 0x63f50e0, size 0x7c, virtual false, abstract: false, final false
  inline int32_t ReadZStream(::System::IntPtr buffer, int32_t length);

  /// @brief Method ReadZStream, addr 0x63f66ec, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteZStream, addr 0x63f6768, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteZStream, addr 0x63f5368, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63f6428, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
