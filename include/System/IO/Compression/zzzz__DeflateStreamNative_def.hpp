...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x62b3794, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b3000, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x62b37b8, size 0x84, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x62b373c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInvalid, addr 0x62b37a8, size 0x10, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckResult, addr 0x62b31e8, size 0xd8, virtual false, abstract: false, final false
  inline void CheckResult(int32_t result, ::StringW where);

  /// @brief Method CloseZStream, addr 0x62b3790, size 0x4, virtual false, abstract: false, final false
  static inline int32_t CloseZStream(::System::IntPtr stream);

  /// @brief Method Create, addr 0x62b190c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateZStream, addr 0x62b306c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x62b1b60, size 0x114, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x62b313c, size 0x48, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x62b3184, size 0x64, virtual false, abstract: false, final false
  static inline int32_t Flush(::System::IO::Compression::DeflateStreamNative_SafeDeflateStreamHandle* stream);

  /// @brief Method Flush, addr 0x62b2238, size 0x58, virtual false, abstract: false, final false
  inline void Flush();

  static inline ::System::IO::Compression::DeflateStreamNative* New_ctor();

  /// @brief Method ReadZStream, addr 0x62b1cb4, size 0x7c, virtual false, abstract: false, final false
  inline int32_t ReadZStream(::System::IntPtr buffer, int32_t length);

  /// @brief Method ReadZStream, addr 0x62b32c0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnmanagedRead, addr 0x62b33b8, size 0x1a8, virtual false, abstract: false, final false
  inline int32_t UnmanagedRead(::System::IntPtr buffer, int32_t length);

  /// @brief Method UnmanagedRead, addr 0x62b2de4, size 0x10c, virtual false, abstract: false, final false
  static inline int32_t UnmanagedRead(::System::IntPtr buffer, int32_t length, ::System::IntPtr data);

  /// @brief Method UnmanagedWrite, addr 0x62b3560, size 0x1dc, virtual false, abstract: false, final false
  inline int32_t UnmanagedWrite(::System::IntPtr buffer, int32_t length);

  /// @brief Method UnmanagedWrite, addr 0x62b2ef0, size 0x10c, virtual false, abstract: false, final false
  static inline int32_t UnmanagedWrite(::System::IntPtr buffer, int32_t length, ::System::IntPtr data);

  /// @brief Method WriteZStream, addr 0x62b333c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteZStream, addr 0x62b1f3c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62b2ffc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
