...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x4488fb8, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x4489548, size 0x28, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x4489858, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4488f18, size 0xa0, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x4489364, size 0xa8, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x44896b0, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x448986c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44892c4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method BeginRead, addr 0x4488cb4, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginWrite, addr 0x4489060, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x44884d8, size 0xb8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndRead, addr 0x448940c, size 0x13c, virtual true, abstract: false, final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method EndWrite, addr 0x4489570, size 0x140, virtual true, abstract: false, final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Finalize, addr 0x4488434, size 0xa4, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Flush, addr 0x4488bb0, size 0xb0, virtual true, abstract: false, final false
  inline void Flush();
  ...
  /// @brief Method Read, addr 0x4488754, size 0x1d0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method ReadAsyncMemory, addr 0x4487fdc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCore, addr 0x4487a98, size 0x118, virtual false, abstract: false, final false
  inline int32_t ReadCore(::System::Span_1<uint8_t> destination);

  /// @brief Method ReadInternal, addr 0x4488694, size 0x48, virtual false, abstract: false, final false
  inline int32_t ReadInternal(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method Seek, addr 0x44896bc, size 0x38, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength, addr 0x44896f4, size 0x38, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method Write, addr 0x44889d4, size 0x1dc, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method WriteAsyncMemory, addr 0x44880e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteCore, addr 0x4487d80, size 0x84, virtual false, abstract: false, final false
  inline void WriteCore(::System::ReadOnlySpan_1<uint8_t> source);

  /// @brief Method WriteInternal, addr 0x4488924, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x448818c, size 0x160, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* compressedStream, ::System::IO::Compression::CompressionMode mode, bool leaveOpen, bool gzip);

  /// @brief Method .ctor, addr 0x4488424, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4487658, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4488180, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::IO::Compression::CompressionMode mode);

  /// @brief Method .ctor, addr 0x44875a0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* stream, ::System::IO::Compression::CompressionMode mode, bool leaveOpen, int32_t windowsBits);

  /// @brief Method get_CanRead, addr 0x448972c, size 0x3c, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x4489768, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite, addr 0x4489770, size 0x40, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_Length, addr 0x44897b0, size 0x38, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_Position, addr 0x44897e8, size 0x38, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method set_Position, addr 0x4489820, size 0x38, virtual true, abstract: false, final false
