...
// Write type traits
MARK_REF_T(::System::IO::CStreamWriter*);
DEFINE_IL2CPP_CLASS(::System::IO::CStreamWriter*, "System.IO", "CStreamWriter");
...
public:
  ...
  /// @brief Method InternalWriteChar, addr 0x5c22a8c, size 0x88, virtual false, abstract: false, final false
  inline void InternalWriteChar(char16_t val);

  /// @brief Method InternalWriteChars, addr 0x5c22b9c, size 0x90, virtual false, abstract: false, final false
  inline void InternalWriteChars(::ArrayW<char16_t> buffer, int32_t n);

  /// @brief Method InternalWriteString, addr 0x5c22b14, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5c22504, size 0x3d0, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x5c22c2c, size 0x24, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t> val);

  /// @brief Method Write, addr 0x5c22c50, size 0xd0, virtual true, abstract: false, final false
  inline void Write(::StringW val);

  /// @brief Method Write, addr 0x5c228d4, size 0x1b8, virtual true, abstract: false, final false
  inline void Write(char16_t val);

  /// @brief Method WriteLine, addr 0x5c22d20, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c223cc, size 0x138, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CStreamWriter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CStreamWriter(CStreamWriter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CStreamWriter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CStreamWriter(CStreamWriterconst&) = delete;
...
static_assert(sizeof(::System::IO::CStreamWriter) == 0x78, "Size mismatch!");
