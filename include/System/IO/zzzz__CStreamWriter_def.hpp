...
public:
  ...
  /// @brief Method .ctor addr 0x23e9574 size 0x128 virtual false final false
  inline void _ctor(::System::IO::Stream* stream, ::System::Text::Encoding* encoding, bool leaveOpen);

  /// @brief Method Write addr 0x23e969c size 0x348 virtual true final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write addr 0x23e99e4 size 0x18c virtual true final false
  inline void Write(char16_t val);

  /// @brief Method InternalWriteString addr 0x23e9bf4 size 0x84 virtual false final false
  inline void InternalWriteString(::StringW val);

  /// @brief Method InternalWriteChar addr 0x23e9b70 size 0x84 virtual false final false
  inline void InternalWriteChar(char16_t val);

  /// @brief Method InternalWriteChars addr 0x23e9c78 size 0x8c virtual false final false
  inline void InternalWriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t n);

  /// @brief Method Write addr 0x23e9d04 size 0x28 virtual true final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> val);

  /// @brief Method Write addr 0x23e9d2c size 0xcc virtual true final false
  inline void Write(::StringW val);

  /// @brief Method WriteLine addr 0x23e9df8 size 0x44 virtual true final false
