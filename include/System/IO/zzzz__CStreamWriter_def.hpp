...
public:
  ...
  /// @brief Method InternalWriteChar, addr 0x5ae4f3c, size 0x88, virtual false, abstract: false, final false
  inline void InternalWriteChar(char16_t val);

  /// @brief Method InternalWriteChars, addr 0x5ae504c, size 0x90, virtual false, abstract: false, final false
  inline void InternalWriteChars(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t n);

  /// @brief Method InternalWriteString, addr 0x5ae4fc4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5ae49b4, size 0x3d0, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x5ae50dc, size 0x24, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> val);

  /// @brief Method Write, addr 0x5ae5100, size 0xd0, virtual true, abstract: false, final false
  inline void Write(::StringW val);

  /// @brief Method Write, addr 0x5ae4d84, size 0x1b8, virtual true, abstract: false, final false
  inline void Write(char16_t val);

  /// @brief Method WriteLine, addr 0x5ae51d0, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ae487c, size 0x138, virtual false, abstract: false, final false
