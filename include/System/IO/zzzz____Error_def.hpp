...
public:
// Declarations
/// @brief Method EndOfFile, addr 0x5a65c34, size 0x50, virtual false, abstract: false, final false
static inline void EndOfFile() ;

/// @brief Method FileNotOpen, addr 0x5a65c84, size 0x54, virtual false, abstract: false, final false
static inline void FileNotOpen() ;

/// @brief Method GetDisplayablePath, addr 0x5a65d2c, size 0x12c, virtual false, abstract: false, final false
static inline ::StringW GetDisplayablePath(::StringW  path, bool  isInvalidPath) ;

/// @brief Method ReaderClosed, addr 0x5a65cd8, size 0x54, virtual false, abstract: false, final false
static inline void ReaderClosed() ;

/// @brief Method WinIOError, addr 0x5a66008, size 0x550, virtual false, abstract: false, final false
static inline void WinIOError(int32_t  errorCode, ::StringW  maybeFullPath) ;

/// @brief Method WriterClosed, addr 0x5a66558, size 0x54, virtual false, abstract: false, final false
