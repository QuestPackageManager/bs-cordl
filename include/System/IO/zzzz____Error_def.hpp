...
public:
  // Declarations
  /// @brief Method EndOfFile addr 0x23dc6d0 size 0x60 virtual false final false
  static inline void EndOfFile();

  /// @brief Method FileNotOpen addr 0x23dc730 size 0x64 virtual false final false
  static inline void FileNotOpen();

  /// @brief Method ReaderClosed addr 0x23dc794 size 0x64 virtual false final false
  static inline void ReaderClosed();

  /// @brief Method GetDisplayablePath addr 0x23dc7f8 size 0x144 virtual false final false
  static inline ::StringW GetDisplayablePath(::StringW path, bool isInvalidPath);

  /// @brief Method WinIOError addr 0x23dcad8 size 0x5a0 virtual false final false
  static inline void WinIOError(int32_t errorCode, ::StringW maybeFullPath);

  /// @brief Method WriterClosed addr 0x23dd078 size 0x64 virtual false final false
