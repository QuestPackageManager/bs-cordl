...
public:
  ...
  /// @brief Method .ctor addr 0x250dd6c size 0x4 virtual false final false
  inline void _ctor();

  static inline ::System::IO::FileInfo* New_ctor(::StringW fileName);

  /// @brief Method .ctor addr 0x250dd70 size 0x10 virtual false final false
  ...
  /// @brief Method .ctor addr 0x250dd80 size 0x128 virtual false final false
  inline void _ctor(::StringW originalPath, ::StringW fullPath, ::StringW fileName, bool isNormalized);

  /// @brief Method get_Length addr 0x250dea8 size 0x88 virtual false final false
  inline int64_t get_Length();

  /// @brief Method CreateText addr 0x250e080 size 0x68 virtual false final false
  inline ::System::IO::StreamWriter* CreateText();

  /// @brief Method AppendText addr 0x250e0e8 size 0x68 virtual false final false
  inline ::System::IO::StreamWriter* AppendText();

  /// @brief Method Delete addr 0x250e150 size 0x8 virtual true final false
  inline void Delete();

  /// @brief Method OpenRead addr 0x250e158 size 0x7c virtual false final false
  ...
  /// @brief Method .ctor addr 0x250e1d4 size 0x4 virtual false final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_Name addr 0x250e1d8 size 0x8 virtual true final false
