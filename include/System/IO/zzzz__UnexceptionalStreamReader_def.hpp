...
public:
  ...
  /// @brief Method CheckEOL, addr 0x5ae3d20, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x5ae397c, size 0x8c, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x5ae3a08, size 0x8c, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x5ae3a94, size 0x28c, virtual true, abstract: false, final false
  inline int32_t Read(::ByRef<::ArrayW<char16_t, ::Array<char16_t>*>> dest_buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x5ae3ec4, size 0x8c, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x5ae3f50, size 0x8c, virtual true, abstract: false, final false
  inline ::StringW ReadToEnd();

  /// @brief Method .ctor, addr 0x5ae3900, size 0x7c, virtual false, abstract: false, final false
