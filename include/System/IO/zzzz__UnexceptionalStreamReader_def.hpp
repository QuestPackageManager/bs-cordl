...
public:
  ...
  /// @brief Method CheckEOL, addr 0x2638648, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method Peek, addr 0x26382a0, size 0x88, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x2638328, size 0x88, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x26383b0, size 0x298, virtual true, abstract: false, final false
  inline int32_t Read(ByRef<::ArrayW<char16_t, ::Array<char16_t>*>> dest_buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x26387e0, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x2638868, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ReadToEnd();

  /// @brief Method .ctor, addr 0x2638230, size 0x70, virtual false, abstract: false, final false
