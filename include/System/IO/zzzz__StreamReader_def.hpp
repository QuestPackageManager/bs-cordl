...
/// @brief Method MoveNext, addr 0x5a4db78, size 0xac4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5a4e63c, size 0x5c, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x5a4e698, size 0x64c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5a4ece4, size 0x80, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method CheckAsyncTaskInProgress, addr 0x5a4b470, size 0x70, virtual false, abstract: false, final false
inline void CheckAsyncTaskInProgress() ;

/// @brief Method Close, addr 0x5a4bce0, size 0x10, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method CompressBuffer, addr 0x5a4cb28, size 0x44, virtual false, abstract: false, final false
inline void CompressBuffer(int32_t  n) ;

/// @brief Method DataAvailable, addr 0x5a4d9b4, size 0x10, virtual false, abstract: false, final false
inline bool DataAvailable() ;

/// @brief Method DetectEncoding, addr 0x5a4cb6c, size 0x2a4, virtual false, abstract: false, final false
inline void DetectEncoding() ;

/// @brief Method Dispose, addr 0x5a4bcf0, size 0xf0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Init, addr 0x5a4bcd0, size 0x10, virtual false, abstract: false, final false
inline void Init(::System::IO::Stream*  stream) ;

/// @brief Method Init, addr 0x5a4b8b4, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method IsPreamble, addr 0x5a4ce10, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method Peek, addr 0x5a4be98, size 0xc4, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x5a4bf5c, size 0xc4, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x5a4c020, size 0x19c, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Read, addr 0x5a4c3c4, size 0xbc, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<char16_t>  buffer) ;

/// @brief Method ReadAsync, addr 0x5a4d308, size 0x2b4, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadAsyncInternal, addr 0x5a4d7a0, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method ReadBuffer, addr 0x5a4cf40, size 0x164, virtual true, abstract: false, final false
inline int32_t ReadBuffer() ;

/// @brief Method ReadBuffer, addr 0x5a4c70c, size 0x300, virtual false, abstract: false, final false
inline int32_t ReadBuffer(::System::Span_1<char16_t>  userBuffer, ::ByRef<bool>  readToUserBuffer) ;

/// @brief Method ReadBufferAsync, addr 0x5a4d8d0, size 0xe4, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadBufferAsync() ;

/// @brief Method ReadLine, addr 0x5a4d0a4, size 0x264, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadSpan, addr 0x5a4c1bc, size 0x208, virtual false, abstract: false, final false
inline int32_t ReadSpan(::System::Span_1<char16_t>  buffer) ;

/// @brief Method ReadToEnd, addr 0x5a4ca0c, size 0x11c, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method ThrowAsyncIOInProgress, addr 0x5a4b4e0, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a4b52c, size 0xd8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5a4b9fc, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::StringW  path) ;

/// @brief Method .ctor, addr 0x5a4ba34, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x5a4bcbc, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x5a4bcc8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::Text::Encoding*  encoding, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x5a4ba70, size 0x24c, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::Text::Encoding*  encoding, bool  detectEncodingFromByteOrderMarks, int32_t  bufferSize) ;

/// @brief Method .ctor, addr 0x5a4b608, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream) ;

/// @brief Method .ctor, addr 0x5a4b644, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x5a4b898, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x5a4b8a8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Text::Encoding*  encoding, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x5a4b684, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method get_BaseStream, addr 0x5a4bdf8, size 0x8, virtual true, abstract: false, final false
inline ::System::IO::Stream* get_BaseStream() ;

/// @brief Method get_CurrentEncoding, addr 0x5a4bdf0, size 0x8, virtual true, abstract: false, final false
inline ::System::Text::Encoding* get_CurrentEncoding() ;

/// @brief Method get_EndOfStream, addr 0x5a4be00, size 0x98, virtual false, abstract: false, final false
inline bool get_EndOfStream() ;

/// @brief Method get_LeaveOpen, addr 0x5a4bde0, size 0x10, virtual false, abstract: false, final false
