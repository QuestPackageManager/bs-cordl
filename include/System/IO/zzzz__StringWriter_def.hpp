...
public:
  ...
  /// @brief Method Close, addr 0x5adb5fc, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x5adb60c, size 0x8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FlushAsync, addr 0x5adbad0, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5adbb64, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Write, addr 0x5adb6fc, size 0x154, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x5adb850, size 0x34, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method Write, addr 0x5adb6d4, size 0x28, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method WriteAsync, addr 0x5adb9fc, size 0xd4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteAsync, addr 0x5adb940, size 0xbc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::StringW value);

  /// @brief Method WriteAsync, addr 0x5adb884, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5adb3a4, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5adb518, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::IFormatProvider* formatProvider);

  /// @brief Method .ctor, addr 0x5adb588, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::StringBuilder* sb);

  /// @brief Method .ctor, addr 0x5adb438, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Encoding, addr 0x5adb614, size 0xc0, virtual true, abstract: false, final false
