...
public:
  ...
  /// @brief Method Close, addr 0x3d7a370, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x3d7a380, size 0x10, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FlushAsync, addr 0x3d7a82c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3d7a8b4, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Write, addr 0x3d7a45c, size 0x174, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x3d7a5d0, size 0x34, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method Write, addr 0x3d7a434, size 0x28, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method WriteAsync, addr 0x3d7a764, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method WriteAsync, addr 0x3d7a6b4, size 0xb0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::StringW value);

  /// @brief Method WriteAsync, addr 0x3d7a604, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d7a11c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3d7a294, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::IFormatProvider* formatProvider);

  /// @brief Method .ctor, addr 0x3d7a300, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Text::StringBuilder* sb);

  /// @brief Method .ctor, addr 0x3d7a1b0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Encoding, addr 0x3d7a390, size 0xa4, virtual true, abstract: false, final false
