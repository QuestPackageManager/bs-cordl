...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IOException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IOException(IOException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IOException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IOException(IOExceptionconst&) = delete;
