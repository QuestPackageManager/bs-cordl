...
public:
  ...
  /// @brief Method .ctor addr 0x23a310c size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::IO::IOException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x23a2478 size 0x24 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::System::IO::IOException* New_ctor(::StringW message, int32_t hresult);

  /// @brief Method .ctor addr 0x23a3168 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23a3190 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23a24c8 size 0x8 virtual false final false
