...
public:
  ...
  /// @brief Method .ctor, addr 0x5ab96b8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5ab8a1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5ab7bdc, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5ab9718, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, int32_t hresult);

  /// @brief Method .ctor, addr 0x5ab9740, size 0x24, virtual false, abstract: false, final false
