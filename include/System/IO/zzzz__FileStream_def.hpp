...
public:
  ...
  /// @brief Method .ctor addr 0x23e36d4 size 0xd8 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x23e5290 size 0x14 virtual true final false
  inline int32_t Invoke(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method BeginInvoke addr 0x23e37ac size 0xa8 virtual true final false
  ...
  /// @brief Method EndInvoke addr 0x23e39b8 size 0x28 virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0x23e4354 size 0xd8 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x23e52a4 size 0x14 virtual true final false
  inline void Invoke(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method BeginInvoke addr 0x23e442c size 0xa8 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x23e463c size 0xc virtual true final false
...
namespace System::IO {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3554)), TypeDefinitionIndex(TypeDefinitionIndex(3607))}
...
public:
  ...
  /// @brief Method .ctor addr 0x23e0118 size 0x10 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e0128 size 0x1ac virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e05bc size 0x34 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e0d18 size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e0d5c size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e0d80 size 0x20 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e0da0 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e0dc8 size 0x20 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e0d44 size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23e05f0 size 0x728 virtual false final false
  ...
  /// @brief Method Init addr 0x23e02d4 size 0x2e8 virtual false final false
  ...
  /// @brief Method get_CanRead addr 0x23e25f8 size 0x14 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanWrite addr 0x23e260c size 0x14 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method get_CanSeek addr 0x23e2620 size 0x8 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_Length addr 0x23e2628 size 0x164 virtual true final false
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0x23e28c4 size 0x170 virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0x23e2a34 size 0x90 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method get_SafeFileHandle addr 0x23e2ac4 size 0x3c virtual true final false
  inline ::Microsoft::Win32::SafeHandles::SafeFileHandle* get_SafeFileHandle();

  /// @brief Method ExposeHandle addr 0x23e2490 size 0x28 virtual false final false
  inline void ExposeHandle();

  /// @brief Method ReadByte addr 0x23e2c78 size 0x148 virtual true final false
  inline int32_t ReadByte();

  /// @brief Method WriteByte addr 0x23e2f18 size 0x15c virtual true final false
  inline void WriteByte(uint8_t value);

  /// @brief Method Read addr 0x23e3074 size 0x268 virtual true final false
  inline int32_t Read(ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> array, int32_t offset, int32_t count);

  /// @brief Method ReadInternal addr 0x23e32dc size 0x9c virtual false final false
  inline int32_t ReadInternal(::ArrayW<uint8_t, ::Array<uint8_t>*> dest, int32_t offset, int32_t count);

  /// @brief Method BeginRead addr 0x23e3430 size 0x2a4 virtual true final false
  ...
  /// @brief Method EndRead addr 0x23e3854 size 0x164 virtual true final false
  inline int32_t EndRead(::System::IAsyncResult* asyncResult);

  /// @brief Method Write addr 0x23e39e0 size 0x23c virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t offset, int32_t count);

  /// @brief Method WriteInternal addr 0x23e3c1c size 0x1b4 virtual false final false
  inline void WriteInternal(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t offset, int32_t count);

  /// @brief Method BeginWrite addr 0x23e3f90 size 0x2ec virtual true final false
  ...
  /// @brief Method EndWrite addr 0x23e44d4 size 0x168 virtual true final false
  inline void EndWrite(::System::IAsyncResult* asyncResult);

  /// @brief Method Seek addr 0x23e4648 size 0x264 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0x23e48ac size 0x210 virtual true final false
  inline void SetLength(int64_t value);

  /// @brief Method Flush addr 0x23e4bec size 0x78 virtual true final false
  inline void Flush();

  /// @brief Method Finalize addr 0x23e4c64 size 0xa4 virtual true final false
  inline void Finalize();

  /// @brief Method Dispose addr 0x23e4d08 size 0x334 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method FlushAsync addr 0x23e5040 size 0x88 virtual true final false
  inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ReadAsync addr 0x23e50c8 size 0x4 virtual true final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method WriteAsync addr 0x23e50cc size 0x4 virtual true final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method ReadSegment addr 0x23e3378 size 0xb8 virtual false final false
  inline int32_t ReadSegment(::ArrayW<uint8_t, ::Array<uint8_t>*> dest, int32_t dest_offset, int32_t count);

  /// @brief Method WriteSegment addr 0x23e3f18 size 0x78 virtual false final false
  inline int32_t WriteSegment(::ArrayW<uint8_t, ::Array<uint8_t>*> src, int32_t src_offset, int32_t count);

  /// @brief Method FlushBuffer addr 0x23e2b00 size 0x178 virtual false final false
  inline void FlushBuffer();

  /// @brief Method FlushBufferIfDirty addr 0x23e278c size 0x10 virtual false final false
  inline void FlushBufferIfDirty();

  /// @brief Method RefillBuffer addr 0x23e2ee8 size 0x30 virtual false final false
  inline void RefillBuffer();

  /// @brief Method ReadData addr 0x23e2dc0 size 0x128 virtual false final false
  ...
  /// @brief Method InitBuffer addr 0x23e2204 size 0x28c virtual false final false
  inline void InitBuffer(int32_t size, bool isZeroSize);

  /// @brief Method GetSecureFileName addr 0x23e1948 size 0x78 virtual false final false
  inline ::StringW GetSecureFileName(::StringW filename);

  /// @brief Method GetSecureFileName addr 0x23e143c size 0xa8 virtual false final false
