...
/// @brief Method <ReadAsyncInternal>b__17_0, addr 0x5ac7b08, size 0x104, virtual false, abstract: false, final false
inline int32_t _ReadAsyncInternal_b__17_0(::System::Object*  state) ;

/// @brief Method .ctor, addr 0x5ac7b04, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Close, addr 0x5ac6eb4, size 0x70, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x5ac6f24, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x5ac6f94, size 0x4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::System::IO::TextReader* New_ctor() ;

/// @brief Method Peek, addr 0x5ac6f98, size 0x8, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x5ac6fa0, size 0x8, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x5ac6fa8, size 0x1ac, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Read, addr 0x5abffe0, size 0x28c, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<char16_t>  buffer) ;

/// @brief Method ReadAsync, addr 0x5ac111c, size 0x1e4, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadAsyncInternal, addr 0x5ac734c, size 0x22c, virtual true, abstract: false, final false
...
/// @brief Method ReadLine, addr 0x5ac7254, size 0xf8, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x5ac7154, size 0x100, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method Synchronized, addr 0x5ac7578, size 0xb8, virtual false, abstract: false, final false
static inline ::System::IO::TextReader* Synchronized(::System::IO::TextReader*  reader) ;

/// @brief Method .ctor, addr 0x5abf164, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
