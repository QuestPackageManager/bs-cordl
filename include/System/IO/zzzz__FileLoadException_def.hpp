...
public:
  ...
  /// @brief Method .ctor, addr 0x251b348, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::IO::FileLoadException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x251b3a4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_Message, addr 0x251b3c8, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_FileName, addr 0x251b460, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_FusionLog, addr 0x251b468, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FusionLog();

  /// @brief Method ToString, addr 0x251b470, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x251b654, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetObjectData, addr 0x251b704, size 0x118, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method FormatFileLoadExceptionMessage, addr 0x251b3ec, size 0x74, virtual false, abstract: false, final false
