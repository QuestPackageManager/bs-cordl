...
public:
  ...
  /// @brief Method FormatFileLoadExceptionMessage, addr 0x264e414, size 0x74, virtual false, abstract: false, final false
  static inline ::StringW FormatFileLoadExceptionMessage(::StringW fileName, int32_t hResult);

  /// @brief Method GetObjectData, addr 0x264e72c, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x264e498, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264e370, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x264e67c, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x264e3cc, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_FileName, addr 0x264e488, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_FusionLog, addr 0x264e490, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FusionLog();

  /// @brief Method get_Message, addr 0x264e3f0, size 0x24, virtual true, abstract: false, final false
