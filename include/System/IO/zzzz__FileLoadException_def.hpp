...
public:
  ...
  /// @brief Method FormatFileLoadExceptionMessage, addr 0x2775f94, size 0x74, virtual false, abstract: false, final false
  static inline ::StringW FormatFileLoadExceptionMessage(::StringW fileName, int32_t hResult);

  /// @brief Method GetObjectData, addr 0x27762ac, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2776018, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2775ef0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27761fc, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2775f4c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method get_FileName, addr 0x2776008, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_FusionLog, addr 0x2776010, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FusionLog();

  /// @brief Method get_Message, addr 0x2775f70, size 0x24, virtual true, abstract: false, final false
