...
public:
  ...
  /// @brief Method .ctor addr 0x23ad604 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::IO::DriveNotFoundException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x23ad660 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23ad684 size 0x8 virtual false final false
