...
public:
  ...
  /// @brief Method .ctor, addr 0x252a954, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::IO::DriveNotFoundException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x252a9b0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252a9d4, size 0x8, virtual false, abstract: false, final false
