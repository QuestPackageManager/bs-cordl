...
public:
  ...
  /// @brief Method .ctor addr 0x253a8ec size 0xec virtual false final false
  inline void _ctor();

  static inline ::System::IO::BinaryWriter* New_ctor(::System::IO::Stream* output);

  /// @brief Method .ctor addr 0x253a9d8 size 0x80 virtual false final false
  ...
  /// @brief Method .ctor addr 0x253abd0 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x253aa58 size 0x178 virtual false final false
  inline void _ctor(::System::IO::Stream* output, ::System::Text::Encoding* encoding, bool leaveOpen);

  /// @brief Method Close addr 0x253abd8 size 0x10 virtual true final false
  inline void Close();

  /// @brief Method Dispose addr 0x253abe8 size 0x48 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method Dispose addr 0x253ac30 size 0x10 virtual true final true
  inline void Dispose();

  /// @brief Method Flush addr 0x253ac40 size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method DisposeAsync addr 0x253ac64 size 0x1d4 virtual true final false
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method Write addr 0x253ae38 size 0x50 virtual true final false
  inline void Write(bool value);

  /// @brief Method Write addr 0x253ae88 size 0x24 virtual true final false
  inline void Write(uint8_t value);

  /// @brief Method Write addr 0x253aeac size 0x24 virtual true final false
  inline void Write(int8_t value);

  /// @brief Method Write addr 0x253aed0 size 0x7c virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method Write addr 0x253af4c size 0x24 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write addr 0x253af70 size 0x12c virtual true final false
  inline void Write(char16_t ch);

  /// @brief Method Write addr 0x253b09c size 0xa8 virtual true final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> chars);

  /// @brief Method Write addr 0x253b144 size 0x3c virtual true final false
  inline void Write(double_t value);

  /// @brief Method Write addr 0x253b180 size 0x68 virtual true final false
  inline void Write(int16_t value);

  /// @brief Method Write addr 0x253b1e8 size 0x68 virtual true final false
  inline void Write(uint16_t value);

  /// @brief Method Write addr 0x253b250 size 0xa0 virtual true final false
  inline void Write(int32_t value);

  /// @brief Method Write addr 0x253b2f0 size 0xa0 virtual true final false
  inline void Write(uint32_t value);

  /// @brief Method Write addr 0x253b390 size 0x110 virtual true final false
  inline void Write(int64_t value);

  /// @brief Method Write addr 0x253b4a0 size 0x110 virtual true final false
  inline void Write(uint64_t value);

  /// @brief Method Write addr 0x253b5b0 size 0x3c virtual true final false
  inline void Write(float_t value);

  /// @brief Method Write addr 0x253b5ec size 0x2b4 virtual true final false
  inline void Write(::StringW value);

  /// @brief Method Write7BitEncodedInt addr 0x253b8a0 size 0x60 virtual false final false
