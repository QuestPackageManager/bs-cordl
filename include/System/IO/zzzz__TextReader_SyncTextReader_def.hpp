...
public:
  ...
  /// @brief Method Close, addr 0x59ecdb8, size 0x1c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x59ecdd4, size 0xc4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::GlobalNamespace::TextReader_SyncTextReader* New_ctor(::System::IO::TextReader* t);

  /// @brief Method Peek, addr 0x59ece98, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x59eceb4, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x59eced0, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadAsync, addr 0x59ecf2c, size 0x1cc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x59eceec, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x59ecf0c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59ecc78, size 0x64, virtual false, abstract: false, final false
