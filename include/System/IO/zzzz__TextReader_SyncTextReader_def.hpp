...
public:
  ...
  /// @brief Method Close, addr 0x5ac5bf8, size 0x1c, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x5ac5c14, size 0xc4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::GlobalNamespace::TextReader_SyncTextReader* New_ctor(::System::IO::TextReader* t);

  /// @brief Method Peek, addr 0x5ac5cd8, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x5ac5cf4, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Read();

  /// @brief Method Read, addr 0x5ac5d10, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadAsync, addr 0x5ac5d6c, size 0x1cc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method ReadLine, addr 0x5ac5d2c, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ReadLine();

  /// @brief Method ReadToEnd, addr 0x5ac5d4c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ac5ab8, size 0x64, virtual false, abstract: false, final false
