...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextReader_SyncTextReader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextReader_SyncTextReader(TextReader_SyncTextReader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextReader_SyncTextReader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextReader_SyncTextReader(TextReader_SyncTextReaderconst&) = delete;
