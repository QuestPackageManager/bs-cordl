...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextWriter_NullTextWriter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextWriter_NullTextWriter(TextWriter_NullTextWriter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextWriter_NullTextWriter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextWriter_NullTextWriter(TextWriter_NullTextWriterconst&) = delete;
