...
public:
  ...
  /// @brief Method .ctor, addr 0x2528984, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Encoding, addr 0x2528a10, size 0x8, virtual true, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method Write, addr 0x2528a18, size 0x4, virtual true, abstract: false, final false
  inline void Write(::ArrayW<char16_t, ::Array<char16_t>*> buffer, int32_t index, int32_t count);

  /// @brief Method Write, addr 0x2528a1c, size 0x4, virtual true, abstract: false, final false
  inline void Write(::StringW value);

  /// @brief Method WriteLine, addr 0x2528a20, size 0x4, virtual true, abstract: false, final false
  inline void WriteLine();

  /// @brief Method WriteLine, addr 0x2528a24, size 0x4, virtual true, abstract: false, final false
  inline void WriteLine(::StringW value);

  /// @brief Method Write, addr 0x2528a28, size 0x4, virtual true, abstract: false, final false
