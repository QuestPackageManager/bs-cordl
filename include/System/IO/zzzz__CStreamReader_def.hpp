...
/// @brief Method Peek, addr 0x5a72454, size 0x8c, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x5a724e0, size 0xd8, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x5a725b8, size 0x1a4, virtual true, abstract: false, final false
inline int32_t Read(::ByRef<::ArrayW<char16_t,::Array<char16_t>*>>  dest, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine, addr 0x5a7275c, size 0x9c, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x5a727f8, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a72328, size 0x12c, virtual false, abstract: false, final false
