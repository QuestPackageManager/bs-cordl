...
public:
  ...
  /// @brief Method .ctor, addr 0x251f2a0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::IO::PathTooLongException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x251f2fc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x251f320, size 0x8, virtual false, abstract: false, final false
