...
// Write type traits
MARK_REF_T(::System::IO::PathTooLongException*);
DEFINE_IL2CPP_CLASS(::System::IO::PathTooLongException*, "System.IO", "PathTooLongException");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PathTooLongException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PathTooLongException(PathTooLongException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PathTooLongException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PathTooLongException(PathTooLongExceptionconst&) = delete;
...
static_assert(sizeof(::System::IO::PathTooLongException) == 0x90, "Size mismatch!");
