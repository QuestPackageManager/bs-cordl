...
public:
  // Declarations
  /// @brief Method GetParent, addr 0x2509a24, size 0x14c, virtual false, abstract: false, final false
  static inline ::System::IO::DirectoryInfo* GetParent(::StringW path);

  /// @brief Method CreateDirectory, addr 0x2509bf4, size 0x150, virtual false, abstract: false, final false
  static inline ::System::IO::DirectoryInfo* CreateDirectory(::StringW path);

  /// @brief Method Exists, addr 0x250a36c, size 0x17c, virtual false, abstract: false, final false
  static inline bool Exists(::StringW path);

  /// @brief Method GetFiles, addr 0x250a508, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetFiles(::StringW path);

  /// @brief Method GetFiles, addr 0x250a618, size 0xa0, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetFiles(::StringW path, ::StringW searchPattern);

  /// @brief Method GetFiles, addr 0x250a6b8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFiles, addr 0x250a5b0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalEnumeratePaths, addr 0x250a868, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateDirectories, addr 0x250aa34, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateDirectories, addr 0x250aaac, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateFileSystemEntries, addr 0x250aab8, size 0xac, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* EnumerateFileSystemEntries(::StringW path);

  /// @brief Method EnumerateFileSystemEntries, addr 0x250ab64, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalGetDirectoryRoot, addr 0x250ab70, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW InternalGetDirectoryRoot(::StringW path);

  /// @brief Method GetCurrentDirectory, addr 0x250ac28, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW GetCurrentDirectory();

  /// @brief Method GetLogicalDrives, addr 0x250ac30, size 0x8, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetLogicalDrives();

  /// @brief Method GetAccessControl, addr 0x250ac40, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAccessControl, addr 0x250acb4, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Security::AccessControl::DirectorySecurity* GetAccessControl(::StringW path);

  /// @brief Method InsecureGetCurrentDirectory, addr 0x250acbc, size 0x9c, virtual false, abstract: false, final false
