...
public:
  ...
  /// @brief Method Cancel, addr 0x3d08ef4, size 0x138, virtual false, abstract: false, final false
  static inline bool Cancel(::System::Runtime::InteropServices::SafeHandle* safeHandle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method Cancel_internal, addr 0x3d08ef0, size 0x4, virtual false, abstract: false, final false
  static inline bool Cancel_internal(::System::IntPtr handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method Close, addr 0x3d0902c, size 0x4, virtual false, abstract: false, final false
  static inline bool Close(::System::IntPtr handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method CreatePipe, addr 0x3d096c8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method DumpHandles, addr 0x3d08d0c, size 0x4, virtual false, abstract: false, final false
  static inline void DumpHandles();

  /// @brief Method DuplicateHandle, addr 0x3d096cc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentDirectory, addr 0x3d08d10, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetCurrentDirectory(ByRef<::System::IO::MonoIOError> error);

  /// @brief Method GetException, addr 0x3d084a4, size 0x124, virtual false, abstract: false, final false
  static inline ::System::Exception* GetException(::System::IO::MonoIOError error);

  /// @brief Method GetException, addr 0x3d085c8, size 0x744, virtual false, abstract: false, final false
  static inline ::System::Exception* GetException(::StringW path, ::System::IO::MonoIOError error);

  /// @brief Method GetFileType, addr 0x3d08d14, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IO::MonoFileType GetFileType(::System::IntPtr handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method GetFileType, addr 0x3d08d18, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLength, addr 0x3d0943c, size 0x4, virtual false, abstract: false, final false
  static inline int64_t GetLength(::System::IntPtr handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method GetLength, addr 0x3d09440, size 0x138, virtual false, abstract: false, final false
  static inline int64_t GetLength(::System::Runtime::InteropServices::SafeHandle* safeHandle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method Open, addr 0x3d08e54, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x3d08e50, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x3d09030, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x3d09034, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method RemapPath, addr 0x3d096e0, size 0x4, virtual false, abstract: false, final false
  static inline bool RemapPath(::StringW path, ByRef<::StringW> newPath);

  /// @brief Method Seek, addr 0x3d092e8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Seek, addr 0x3d092ec, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLength, addr 0x3d09578, size 0x4, virtual false, abstract: false, final false
  static inline bool SetLength(::System::IntPtr handle, int64_t length, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method SetLength, addr 0x3d0957c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x3d0918c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x3d09190, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AltDirectorySeparatorChar, addr 0x3d096d8, size 0x4, virtual false, abstract: false, final false
  static inline char16_t get_AltDirectorySeparatorChar();

  /// @brief Method get_ConsoleError, addr 0x3d096c4, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_ConsoleError();

  /// @brief Method get_ConsoleInput, addr 0x3d096c0, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_ConsoleInput();

  /// @brief Method get_ConsoleOutput, addr 0x3d096bc, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_ConsoleOutput();

  /// @brief Method get_DirectorySeparatorChar, addr 0x3d096d4, size 0x4, virtual false, abstract: false, final false
  static inline char16_t get_DirectorySeparatorChar();

  /// @brief Method get_PathSeparator, addr 0x3d096dc, size 0x4, virtual false, abstract: false, final false
  static inline char16_t get_PathSeparator();

  /// @brief Method get_VolumeSeparatorChar, addr 0x3d096d0, size 0x4, virtual false, abstract: false, final false
