...
public:
  ...
  /// @brief Method Cancel, addr 0x27bec88, size 0x128, virtual false, abstract: false, final false
  static inline bool Cancel(::System::Runtime::InteropServices::SafeHandle* safeHandle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method Cancel_internal, addr 0x27bec84, size 0x4, virtual false, abstract: false, final false
  static inline bool Cancel_internal(void* handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method Close, addr 0x27bedb0, size 0x4, virtual false, abstract: false, final false
  static inline bool Close(void* handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method CreatePipe, addr 0x27bf3fc, size 0x4, virtual false, abstract: false, final false
  static inline bool CreatePipe(ByRef<void*> read_handle, ByRef<void*> write_handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method DumpHandles, addr 0x27beab0, size 0x4, virtual false, abstract: false, final false
  static inline void DumpHandles();

  /// @brief Method DuplicateHandle, addr 0x27bf400, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentDirectory, addr 0x27beab4, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetCurrentDirectory(ByRef<::System::IO::MonoIOError> error);

  /// @brief Method GetException, addr 0x27be264, size 0x130, virtual false, abstract: false, final false
  static inline ::System::Exception* GetException(::System::IO::MonoIOError error);

  /// @brief Method GetException, addr 0x27be394, size 0x71c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetException(::StringW path, ::System::IO::MonoIOError error);

  /// @brief Method GetFileType, addr 0x27beab8, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IO::MonoFileType GetFileType(void* handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method GetFileType, addr 0x27beabc, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLength, addr 0x27bf190, size 0x4, virtual false, abstract: false, final false
  static inline int64_t GetLength(void* handle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method GetLength, addr 0x27bf194, size 0x128, virtual false, abstract: false, final false
  static inline int64_t GetLength(::System::Runtime::InteropServices::SafeHandle* safeHandle, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method Open, addr 0x27bebe8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Open, addr 0x27bebe4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x27bedb4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x27bedb8, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method RemapPath, addr 0x27bf414, size 0x4, virtual false, abstract: false, final false
  static inline bool RemapPath(::StringW path, ByRef<::StringW> newPath);

  /// @brief Method Seek, addr 0x27bf04c, size 0x4, virtual false, abstract: false, final false
  static inline int64_t Seek(void* handle, int64_t offset, ::System::IO::SeekOrigin origin, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method Seek, addr 0x27bf050, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLength, addr 0x27bf2bc, size 0x4, virtual false, abstract: false, final false
  static inline bool SetLength(void* handle, int64_t length, ByRef<::System::IO::MonoIOError> error);

  /// @brief Method SetLength, addr 0x27bf2c0, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x27bef00, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x27bef04, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AltDirectorySeparatorChar, addr 0x27bf40c, size 0x4, virtual false, abstract: false, final false
  static inline char16_t get_AltDirectorySeparatorChar();

  /// @brief Method get_ConsoleError, addr 0x27bf3f8, size 0x4, virtual false, abstract: false, final false
  static inline void* get_ConsoleError();

  /// @brief Method get_ConsoleInput, addr 0x27bf3f4, size 0x4, virtual false, abstract: false, final false
  static inline void* get_ConsoleInput();

  /// @brief Method get_ConsoleOutput, addr 0x27bf3f0, size 0x4, virtual false, abstract: false, final false
  static inline void* get_ConsoleOutput();

  /// @brief Method get_DirectorySeparatorChar, addr 0x27bf408, size 0x4, virtual false, abstract: false, final false
  static inline char16_t get_DirectorySeparatorChar();

  /// @brief Method get_PathSeparator, addr 0x27bf410, size 0x4, virtual false, abstract: false, final false
  static inline char16_t get_PathSeparator();

  /// @brief Method get_VolumeSeparatorChar, addr 0x27bf404, size 0x4, virtual false, abstract: false, final false
