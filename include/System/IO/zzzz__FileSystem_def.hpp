...
public:
// Declarations
/// @brief Method CopyDanglingSymlink, addr 0x5a446c0, size 0x16c, virtual false, abstract: false, final false
static inline bool CopyDanglingSymlink(::StringW  sourceFullPath, ::StringW  destFullPath) ;

/// @brief Method CopyFile, addr 0x5a4482c, size 0x3c0, virtual false, abstract: false, final false
static inline void CopyFile(::StringW  sourceFullPath, ::StringW  destFullPath, bool  overwrite) ;

/// @brief Method CreateDirectory, addr 0x5a455ac, size 0x5a4, virtual false, abstract: false, final false
static inline void CreateDirectory(::StringW  fullPath) ;

/// @brief Method DeleteFile, addr 0x5a451b0, size 0x1a8, virtual false, abstract: false, final false
static inline void DeleteFile(::StringW  fullPath) ;

/// @brief Method DirectoryExists, addr 0x5a44bec, size 0x1c, virtual false, abstract: false, final false
static inline bool DirectoryExists(::System::ReadOnlySpan_1<char16_t>  fullPath) ;

/// @brief Method DirectoryExists, addr 0x5a45dd4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method FileExists, addr 0x5a45d58, size 0x7c, virtual false, abstract: false, final false
static inline bool FileExists(::System::ReadOnlySpan_1<char16_t>  fullPath) ;

/// @brief Method FileExists, addr 0x5a45498, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method GetAttributes, addr 0x5a467f4, size 0x8c, virtual false, abstract: false, final false
static inline ::System::IO::FileAttributes GetAttributes(::StringW  fullPath) ;

/// @brief Method GetLogicalDrives, addr 0x5a469a4, size 0x4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetLogicalDrives() ;

/// @brief Method LinkOrCopyFile, addr 0x5a44c08, size 0x18c, virtual false, abstract: false, final false
static inline void LinkOrCopyFile(::StringW  sourceFullPath, ::StringW  destFullPath) ;

/// @brief Method MoveFile, addr 0x5a45094, size 0x11c, virtual false, abstract: false, final false
static inline void MoveFile(::StringW  sourceFullPath, ::StringW  destFullPath) ;

/// @brief Method RemoveDirectory, addr 0x5a45de0, size 0xc0, virtual false, abstract: false, final false
static inline void RemoveDirectory(::StringW  fullPath, bool  recursive) ;

/// @brief Method RemoveDirectoryInternal, addr 0x5a45f2c, size 0x68c, virtual false, abstract: false, final false
...
/// @brief Method ReplaceFile, addr 0x5a44f24, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method ShouldIgnoreDirectory, addr 0x5a4667c, size 0x84, virtual false, abstract: false, final false
