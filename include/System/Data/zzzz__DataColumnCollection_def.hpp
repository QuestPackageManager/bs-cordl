...
public:
  ...
  /// @brief Method Add, addr 0x5ede9f4, size 0xc, virtual false, abstract: false, final false
  inline void Add(::System::Data::DataColumn* column);

  /// @brief Method AddAt, addr 0x5edea00, size 0x250, virtual false, abstract: false, final false
  inline void AddAt(int32_t index, ::System::Data::DataColumn* column);

  /// @brief Method AddColumnsImplementingIChangeTrackingList, addr 0x5ee03d0, size 0xcc, virtual false, abstract: false, final false
  inline void AddColumnsImplementingIChangeTrackingList(::System::Data::DataColumn* dataColumn);

  /// @brief Method ArrayAdd, addr 0x5edef54, size 0x6c, virtual false, abstract: false, final false
  inline void ArrayAdd(::System::Data::DataColumn* column);

  /// @brief Method ArrayAdd, addr 0x5edef14, size 0x40, virtual false, abstract: false, final false
  inline void ArrayAdd(int32_t index, ::System::Data::DataColumn* column);

  /// @brief Method ArrayRemove, addr 0x5edf35c, size 0x134, virtual false, abstract: false, final false
  inline void ArrayRemove(::System::Data::DataColumn* column);

  /// @brief Method AssignName, addr 0x5edf598, size 0xa4, virtual false, abstract: false, final false
  inline ::StringW AssignName();

  /// @brief Method BaseAdd, addr 0x5edec78, size 0x29c, virtual false, abstract: false, final false
  inline void BaseAdd(::System::Data::DataColumn* column);

  /// @brief Method BaseGroupSwitch, addr 0x5edf9ac, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method BaseRemove, addr 0x5edfb90, size 0xb8, virtual false, abstract: false, final false
  inline void BaseRemove(::System::Data::DataColumn* column);

  /// @brief Method CanRegisterName, addr 0x5ee09f4, size 0x78, virtual false, abstract: false, final false
  inline bool CanRegisterName(::StringW name);

  /// @brief Method CanRemove, addr 0x5edfc48, size 0x644, virtual false, abstract: false, final false
  inline bool CanRemove(::System::Data::DataColumn* column, bool fThrowException);

  /// @brief Method CheckIChangeTracking, addr 0x5edf31c, size 0x40, virtual false, abstract: false, final false
  inline void CheckIChangeTracking(::System::Data::DataColumn* column);

  /// @brief Method Clear, addr 0x5ee049c, size 0x2dc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Contains, addr 0x5ee0778, size 0x98, virtual false, abstract: false, final false
  inline bool Contains(::StringW name);

  /// @brief Method Contains, addr 0x5ee0810, size 0xa8, virtual false, abstract: false, final false
  inline bool Contains(::StringW name, bool caseSensitive);

  /// @brief Method IndexOf, addr 0x5ee08b8, size 0x100, virtual false, abstract: false, final false
  inline int32_t IndexOf(::StringW columnName);

  /// @brief Method IndexOfCaseInsensitive, addr 0x5ede7f4, size 0x154, virtual false, abstract: false, final false
  inline int32_t IndexOfCaseInsensitive(::StringW name);

  /// @brief Method MakeName, addr 0x5edf63c, size 0xd4, virtual false, abstract: false, final false
  inline ::StringW MakeName(int32_t index);

  static inline ::System::Data::DataColumnCollection* New_ctor(::System::Data::DataTable* table);

  /// @brief Method OnCollectionChanged, addr 0x5edefc0, size 0xac, virtual false, abstract: false, final false
  inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method OnCollectionChanging, addr 0x5edec50, size 0x28, virtual false, abstract: false, final false
  inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method OnColumnPropertyChanged, addr 0x5ee09b8, size 0x3c, virtual false, abstract: false, final false
  inline void OnColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventArgs* ccevent);

  /// @brief Method RegisterColumnName, addr 0x5edf710, size 0x1d8, virtual false, abstract: false, final false
  inline void RegisterColumnName(::StringW name, ::System::Data::DataColumn* column);

  /// @brief Method Remove, addr 0x5ee0a6c, size 0x110, virtual false, abstract: false, final false
  inline void Remove(::System::Data::DataColumn* column);

  /// @brief Method RemoveColumnsImplementingIChangeTrackingList, addr 0x5edf490, size 0x108, virtual false, abstract: false, final false
  inline void RemoveColumnsImplementingIChangeTrackingList(::System::Data::DataColumn* dataColumn);

  /// @brief Method UnregisterName, addr 0x5edf8e8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ede3cc, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method add_CollectionChanged, addr 0x5edf06c, size 0xac, virtual false, abstract: false, final false
  inline void add_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler* value);

  /// @brief Method add_ColumnPropertyChanged, addr 0x5edf1c4, size 0xac, virtual false, abstract: false, final false
  inline void add_ColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler* value);

  /// @brief Method get_ColumnsImplementingIChangeTracking, addr 0x5ede550, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ColumnsImplementingIChangeTracking();

  /// @brief Method get_ColumnsImplementingIChangeTrackingCount, addr 0x5ede558, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ColumnsImplementingIChangeTrackingCount();

  /// @brief Method get_ColumnsImplementingIRevertibleChangeTrackingCount, addr 0x5ede560, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ColumnsImplementingIRevertibleChangeTrackingCount();

  /// @brief Method get_Item, addr 0x5ede568, size 0x140, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x5ede6a8, size 0x14c, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* get_Item(::StringW name);

  /// @brief Method get_Item, addr 0x5ede948, size 0xac, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* get_Item(::StringW name, ::StringW ns);

  /// @brief Method get_List, addr 0x5ede548, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* get_List();

  /// @brief Method remove_CollectionChanged, addr 0x5edf118, size 0xac, virtual false, abstract: false, final false
  inline void remove_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler* value);

  /// @brief Method remove_ColumnPropertyChanged, addr 0x5edf270, size 0xac, virtual false, abstract: false, final false
