...
/// @brief Method CheckConstraint, addr 0x5e692e0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method CheckStateForProperty, addr 0x5e69334, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x5e69434, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e69440, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ConstraintName, addr 0x5e68dc8, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_ConstraintName() ;

/// @brief Method get_ExtendedProperties, addr 0x5e69274, size 0x6c, virtual false, abstract: false, final false
inline ::System::Data::PropertyCollection* get_ExtendedProperties() ;

/// @brief Method get_InCollection, addr 0x5e6922c, size 0x8, virtual true, abstract: false, final false
inline bool get_InCollection() ;

/// @brief Method get_SchemaName, addr 0x5e691f4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get__DataSet, addr 0x5e6942c, size 0x8, virtual true, abstract: false, final false
inline ::System::Data::DataSet* get__DataSet() ;

/// @brief Method set_ConstraintName, addr 0x5e68dd0, size 0x1c4, virtual true, abstract: false, final false
inline void set_ConstraintName(::StringW  value) ;

/// @brief Method set_InCollection, addr 0x5e69234, size 0x40, virtual true, abstract: false, final false
inline void set_InCollection(bool  value) ;

/// @brief Method set_SchemaName, addr 0x5e69218, size 0x14, virtual false, abstract: false, final false
