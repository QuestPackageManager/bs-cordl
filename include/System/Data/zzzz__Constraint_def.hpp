...
public:
  ...
  /// @brief Method CheckConstraint, addr 0x5e68c20, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateForProperty, addr 0x5e68c74, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5e68d74, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e68d80, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConstraintName, addr 0x5e68708, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ConstraintName();

  /// @brief Method get_ExtendedProperties, addr 0x5e68bb4, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_InCollection, addr 0x5e68b6c, size 0x8, virtual true, abstract: false, final false
  inline bool get_InCollection();

  /// @brief Method get_SchemaName, addr 0x5e68b34, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get__DataSet, addr 0x5e68d6c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Data::DataSet* get__DataSet();

  /// @brief Method set_ConstraintName, addr 0x5e68710, size 0x1c4, virtual true, abstract: false, final false
  inline void set_ConstraintName(::StringW value);

  /// @brief Method set_InCollection, addr 0x5e68b74, size 0x40, virtual true, abstract: false, final false
  inline void set_InCollection(bool value);

  /// @brief Method set_SchemaName, addr 0x5e68b58, size 0x14, virtual false, abstract: false, final false
