...
public:
  // Declarations
  /// @brief Method CompareNode, addr 0x5eebd78, size 0x2c, virtual true, abstract: false, final false
  inline int32_t CompareNode(::System::Data::DataRow* record1, ::System::Data::DataRow* record2);

  /// @brief Method CompareSateliteTreeNode, addr 0x5eebda4, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5eeb610, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x5eeb6c4, size 0x20, virtual false, abstract: false, final false
  inline void Add(::System::Data::DataRow* row);

  /// @brief Method AddWithColumnEvents, addr 0x5eeb990, size 0x64, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* AddWithColumnEvents(::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method ArrayAdd, addr 0x5eeb9f4, size 0x74, virtual false, abstract: false, final false
  inline void ArrayAdd(::System::Data::DataRow* row);

  /// @brief Method ArrayClear, addr 0x5eebaf4, size 0x74, virtual false, abstract: false, final false
  inline void ArrayClear();

  /// @brief Method ArrayInsert, addr 0x5eeba68, size 0x8c, virtual false, abstract: false, final false
  inline void ArrayInsert(::System::Data::DataRow* row, int32_t pos);

  /// @brief Method ArrayRemove, addr 0x5eebb68, size 0xb4, virtual false, abstract: false, final false
  inline void ArrayRemove(::System::Data::DataRow* row);

  /// @brief Method CopyTo, addr 0x5eebc1c, size 0x6c, virtual true, abstract: false, final false
  inline void CopyTo(::System::Array* ar, int32_t index);

  /// @brief Method CopyTo, addr 0x5eebc88, size 0x6c, virtual false, abstract: false, final false
  inline void CopyTo(::ArrayW<::System::Data::DataRow*, ::Array<::System::Data::DataRow*>*> array, int32_t index);

  /// @brief Method DiffInsertAt, addr 0x5eeb6e4, size 0x204, virtual false, abstract: false, final false
  inline void DiffInsertAt(::System::Data::DataRow* row, int32_t pos);

  /// @brief Method GetEnumerator, addr 0x5eebcf4, size 0x84, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf, addr 0x5eeb8e8, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5eeb580, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method get_Count, addr 0x5eeb670, size 0x54, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x5ee028c, size 0x80, virtual false, abstract: false, final false
