...
public:
  ...
  /// @brief Method .ctor, addr 0x6058bdc, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConstraintTable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConstraintTable(ConstraintTable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConstraintTable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConstraintTable(ConstraintTableconst&) = delete;
