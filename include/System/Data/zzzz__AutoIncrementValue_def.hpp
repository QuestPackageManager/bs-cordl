...
public:
  ...
  /// @brief Method Clone, addr 0x5e4ede0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4fcc8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Auto, addr 0x5e4fcb8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Auto, addr 0x5e4fcc0, size 0x8, virtual false, abstract: false, final false
