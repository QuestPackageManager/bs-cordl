...
public:
  ...
  /// @brief Method .ctor, addr 0x602eb98, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataTableClearEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataTableClearEventArgs(DataTableClearEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataTableClearEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataTableClearEventArgs(DataTableClearEventArgsconst&) = delete;
