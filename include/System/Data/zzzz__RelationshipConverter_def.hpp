...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RelationshipConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RelationshipConverter(RelationshipConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RelationshipConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RelationshipConverter(RelationshipConverterconst&) = delete;
