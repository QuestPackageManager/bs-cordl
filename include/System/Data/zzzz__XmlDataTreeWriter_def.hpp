...
public:
  ...
  /// @brief Method CreateTablesHierarchy, addr 0x5f3ddd8, size 0x358, virtual false, abstract: false, final false
  inline void CreateTablesHierarchy(::System::Data::DataTable* dt);

  /// @brief Method CreateToplevelTables, addr 0x5f3e130, size 0x2f8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataTable*, ::Array<::System::Data::DataTable*>*> CreateToplevelTables();

  /// @brief Method GetNestedChildRelations, addr 0x5f406e4, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method PreserveSpace, addr 0x5f3dd48, size 0x90, virtual false, abstract: false, final false
  static inline bool PreserveSpace(::System::Object* value);

  /// @brief Method RowHasErrors, addr 0x5f3d2a4, size 0xb8, virtual false, abstract: false, final false
  static inline bool RowHasErrors(::System::Data::DataRow* row);

  /// @brief Method Save, addr 0x5f3fe10, size 0x8d4, virtual false, abstract: false, final false
  inline void Save(::System::Xml::XmlWriter* xw, bool writeSchema);

  /// @brief Method SaveDiffgramData, addr 0x5f3bbec, size 0x690, virtual false, abstract: false, final false
  inline void SaveDiffgramData(::System::Xml::XmlWriter* xw, ::System::Collections::Hashtable* rowsOrder);

  /// @brief Method XmlDataRowWriter, addr 0x5f3e428, size 0x19e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f3c27c, size 0x318, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* ds);

  /// @brief Method .ctor, addr 0x5f3baa4, size 0x148, virtual false, abstract: false, final false
