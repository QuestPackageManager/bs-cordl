...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BooleanStorage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BooleanStorage(BooleanStorage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BooleanStorage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BooleanStorage(BooleanStorageconst&) = delete;
