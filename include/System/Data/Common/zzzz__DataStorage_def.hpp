...
public:
  ...
  /// @brief Method Aggregate, addr 0x5eee68c, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* Aggregate(::ArrayW<int32_t, ::Array<int32_t>*> recordNos, ::System::Data::AggregateType kind);

  /// @brief Method AggregateCount, addr 0x5ef0e44, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareBits, addr 0x5eecc10, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertObjectToXml, addr 0x5ef0f54, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertValue, addr 0x5ef0eec, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertXmlToObject, addr 0x5ef0f14, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method CopyBits, addr 0x5eedb04, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyValueInternal, addr 0x5ef2d7c, size 0x10, virtual false, abstract: false, final false
  inline void CopyValueInternal(int32_t record, ::System::Object* store, ::System::Collections::BitArray* nullbits, int32_t storeIndex);

  /// @brief Method CreateStorage, addr 0x5ef0f90, size 0x7dc, virtual false, abstract: false, final false
  ...
  /// @brief Method DetermineIfValueType, addr 0x5ef0de4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBits, addr 0x5eedc10, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEmptyStorageInternal, addr 0x5ef2d6c, size 0x10, virtual false, abstract: false, final false
  inline ::System::Object* GetEmptyStorageInternal(int32_t recordCount);

  /// @brief Method GetQualifiedName, addr 0x5ef2ed0, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW GetQualifiedName(::System::Type* type);

  /// @brief Method GetStorageType, addr 0x5ef2518, size 0x108, virtual false, abstract: false, final false
  static inline ::System::Data::Common::StorageType GetStorageType(::System::Type* dataType);

  /// @brief Method GetStringLength, addr 0x5ef0ef4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetStringLength(int32_t record);

  /// @brief Method GetType, addr 0x5ef2da4, size 0x12c, virtual false, abstract: false, final false
  static inline ::System::Type* GetType(::StringW value);

  /// @brief Method GetTypeStorage, addr 0x5ef2620, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Type* GetTypeStorage(::System::Data::Common::StorageType storageType);

  /// @brief Method HasValue, addr 0x5eecd98, size 0x28, virtual false, abstract: false, final false
  inline bool HasValue(int32_t recordNo);

  /// @brief Method ImplementsINullableValue, addr 0x5ef2b48, size 0xc4, virtual false, abstract: false, final false
  static inline bool ImplementsINullableValue(::System::Data::Common::StorageType typeCode, ::System::Type* dataType);

  /// @brief Method ImplementsInterfaces, addr 0x5ef2818, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method InspectTypeForInterfaces, addr 0x5ef2994, size 0x1b4, virtual false, abstract: false, final false
  static inline ::System::Tuple_4<bool, bool, bool, bool>* InspectTypeForInterfaces(::System::Type* dataType);

  /// @brief Method IsNull, addr 0x5ef0efc, size 0x18, virtual true, abstract: false, final false
  inline bool IsNull(int32_t recordNo);

  /// @brief Method IsObjectNull, addr 0x5ef2c0c, size 0xa8, virtual false, abstract: false, final false
  static inline bool IsObjectNull(::System::Object* value);

  /// @brief Method IsObjectSqlNull, addr 0x5ef2cb4, size 0xb8, virtual false, abstract: false, final false
  static inline bool IsObjectSqlNull(::System::Object* value);

  /// @brief Method IsSqlType, addr 0x5ef2720, size 0xf8, virtual false, abstract: false, final false
  static inline bool IsSqlType(::System::Type* dataType);

  /// @brief Method IsSqlType, addr 0x5ef2714, size 0xc, virtual false, abstract: false, final false
  static inline bool IsSqlType(::System::Data::Common::StorageType storageType);

  /// @brief Method IsTypeCustomType, addr 0x5ef26a0, size 0x74, virtual false, abstract: false, final false
  static inline bool IsTypeCustomType(::System::Type* type);

  /// @brief Method IsTypeCustomType, addr 0x5ef0dc8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCapacity, addr 0x5eede60, size 0x8c, virtual true, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method SetNullBit, addr 0x5eedd84, size 0x1c, virtual false, abstract: false, final false
  inline void SetNullBit(int32_t recordNo, bool flag);

  /// @brief Method SetNullStorage, addr 0x5ef2d9c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetStorageInternal, addr 0x5ef2d8c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ef0c8c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ef0dbc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5eeca38, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DateTimeMode, addr 0x5ef0e2c, size 0x18, virtual false, abstract: false, final false
  inline ::System::Data::DataSetDateTime get_DateTimeMode();

  /// @brief Method get_FormatProvider, addr 0x5eeda98, size 0x18, virtual false, abstract: false, final false
