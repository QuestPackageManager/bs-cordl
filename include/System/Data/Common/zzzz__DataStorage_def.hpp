...
public:
  ...
  /// @brief Method Aggregate, addr 0x60a31e4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateStorage, addr 0x60a5ae8, size 0x7dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQualifiedName, addr 0x60a7a28, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW GetQualifiedName(::System::Type* type);

  /// @brief Method GetStorageType, addr 0x60a7070, size 0x108, virtual false, abstract: false, final false
  static inline ::System::Data::Common::StorageType GetStorageType(::System::Type* dataType);

  /// @brief Method GetStringLength, addr 0x60a5a4c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetStringLength(int32_t record);

  /// @brief Method GetType, addr 0x60a78fc, size 0x12c, virtual false, abstract: false, final false
  static inline ::System::Type* GetType(::StringW value);

  /// @brief Method GetTypeStorage, addr 0x60a7178, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Type* GetTypeStorage(::System::Data::Common::StorageType storageType);

  /// @brief Method HasValue, addr 0x60a18f0, size 0x28, virtual false, abstract: false, final false
  inline bool HasValue(int32_t recordNo);

  /// @brief Method ImplementsINullableValue, addr 0x60a76a0, size 0xc4, virtual false, abstract: false, final false
  static inline bool ImplementsINullableValue(::System::Data::Common::StorageType typeCode, ::System::Type* dataType);

  /// @brief Method ImplementsInterfaces, addr 0x60a7370, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method InspectTypeForInterfaces, addr 0x60a74ec, size 0x1b4, virtual false, abstract: false, final false
  static inline ::System::Tuple_4<bool, bool, bool, bool>* InspectTypeForInterfaces(::System::Type* dataType);

  /// @brief Method IsNull, addr 0x60a5a54, size 0x18, virtual true, abstract: false, final false
  inline bool IsNull(int32_t recordNo);

  /// @brief Method IsObjectNull, addr 0x60a7764, size 0xa8, virtual false, abstract: false, final false
  static inline bool IsObjectNull(::System::Object* value);

  /// @brief Method IsObjectSqlNull, addr 0x60a780c, size 0xb8, virtual false, abstract: false, final false
  static inline bool IsObjectSqlNull(::System::Object* value);

  /// @brief Method IsSqlType, addr 0x60a7278, size 0xf8, virtual false, abstract: false, final false
  static inline bool IsSqlType(::System::Type* dataType);

  /// @brief Method IsSqlType, addr 0x60a726c, size 0xc, virtual false, abstract: false, final false
  static inline bool IsSqlType(::System::Data::Common::StorageType storageType);

  /// @brief Method IsTypeCustomType, addr 0x60a71f8, size 0x74, virtual false, abstract: false, final false
  static inline bool IsTypeCustomType(::System::Type* type);

  /// @brief Method IsTypeCustomType, addr 0x60a5920, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNullBit, addr 0x60a28dc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60a57e4, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60a5914, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60a1590, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DateTimeMode, addr 0x60a5984, size 0x18, virtual false, abstract: false, final false
  inline ::System::Data::DataSetDateTime get_DateTimeMode();

  /// @brief Method get_FormatProvider, addr 0x60a25f0, size 0x18, virtual false, abstract: false, final false
