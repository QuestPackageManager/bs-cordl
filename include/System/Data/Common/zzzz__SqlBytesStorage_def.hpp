...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SqlBytesStorage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SqlBytesStorage(SqlBytesStorage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SqlBytesStorage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SqlBytesStorage(SqlBytesStorageconst&) = delete;
