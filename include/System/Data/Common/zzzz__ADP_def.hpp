...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ADP", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ADP(ADP&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ADP", modifiers: "const&", def_value: None, comment: None }]
