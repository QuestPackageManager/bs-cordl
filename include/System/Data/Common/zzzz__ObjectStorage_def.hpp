...
public:
  ...
  /// @brief Method Equals, addr 0x41d8e40, size 0x144, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x41d8f84, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x41d8e38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Aggregate, addr 0x41d5890, size 0x30, virtual true, abstract: false, final false
  inline ::System::Object* Aggregate(::ArrayW<int32_t, ::Array<int32_t>*> records, ::System::Data::AggregateType kind);

  /// @brief Method Compare, addr 0x41d58c0, size 0x1b4, virtual true, abstract: false, final false
  inline int32_t Compare(int32_t recordNo1, int32_t recordNo2);

  /// @brief Method CompareTo, addr 0x41d60f4, size 0x1d8, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Object* valueNo1, ::System::Object* valueNo2);

  /// @brief Method CompareValueTo, addr 0x41d5f10, size 0x1e4, virtual true, abstract: false, final false
  inline int32_t CompareValueTo(int32_t recordNo1, ::System::Object* value);

  /// @brief Method CompareWithFamilies, addr 0x41d5a74, size 0x49c, virtual false, abstract: false, final false
  inline int32_t CompareWithFamilies(::System::Object* valueNo1, ::System::Object* valueNo2);

  /// @brief Method ConvertObjectToXml, addr 0x41d8088, size 0x660, virtual true, abstract: false, final false
  inline ::StringW ConvertObjectToXml(::System::Object* value);

  /// @brief Method ConvertObjectToXml, addr 0x41d86e8, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertXmlToObject, addr 0x41d6dfc, size 0x558, virtual true, abstract: false, final false
  inline ::System::Object* ConvertXmlToObject(::StringW s);

  /// @brief Method ConvertXmlToObject, addr 0x41d73c8, size 0x6f0, virtual true, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x41d63c0, size 0x74, virtual true, abstract: false, final false
  inline void Copy(int32_t recordNo1, int32_t recordNo2);

  /// @brief Method CopyValue, addr 0x41d8894, size 0x1fc, virtual true, abstract: false, final false
  inline void CopyValue(int32_t record, ::System::Object* store, ::System::Collections::BitArray* nullbits, int32_t storeIndex);

  /// @brief Method Get, addr 0x41d6434, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Object* Get(int32_t recordNo);

  /// @brief Method GetEmptyStorage, addr 0x41d884c, size 0x48, virtual true, abstract: false, final false
  inline ::System::Object* GetEmptyStorage(int32_t recordCount);

  /// @brief Method GetFamily, addr 0x41d62cc, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Data::Common::ObjectStorage_Families GetFamily(::System::Type* dataType);

  /// @brief Method GetXmlSerializer, addr 0x41d7354, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Xml::Serialization::XmlSerializer* GetXmlSerializer(::System::Type* type);

  /// @brief Method GetXmlSerializer, addr 0x41d7ab8, size 0x5d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNull, addr 0x41d6470, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method Set, addr 0x41d64a8, size 0x89c, virtual true, abstract: false, final false
  inline void Set(int32_t recordNo, ::System::Object* value);

  /// @brief Method SetCapacity, addr 0x41d6d44, size 0xb8, virtual true, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method SetStorage, addr 0x41d8a90, size 0x1c4, virtual true, abstract: false, final false
  inline void SetStorage(::System::Object* store, ::System::Collections::BitArray* nullbits);

  /// @brief Method VerifyIDynamicMetaObjectProvider, addr 0x41d8c54, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41d56e8, size 0x1a8, virtual false, abstract: false, final false
