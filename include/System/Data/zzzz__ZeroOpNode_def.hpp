...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ZeroOpNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ZeroOpNode(ZeroOpNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ZeroOpNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ZeroOpNode(ZeroOpNodeconst&) = delete;
