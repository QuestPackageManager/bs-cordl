...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RowNotInTableException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RowNotInTableException(RowNotInTableException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RowNotInTableException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RowNotInTableException(RowNotInTableExceptionconst&) = delete;
