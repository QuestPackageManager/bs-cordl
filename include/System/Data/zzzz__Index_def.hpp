...
public:
  ...
  /// @brief Method CompareNode, addr 0x5f0df68, size 0x14, virtual true, abstract: false, final false
  inline int32_t CompareNode(int32_t record1, int32_t record2);

  /// @brief Method CompareSateliteTreeNode, addr 0x5f0df7c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f0d630, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <OnListChanged>b__85_0, addr 0x5f0dff4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__22_0, addr 0x5f0dfe8, size 0xc, virtual false, abstract: false, final false
  inline bool __ctor_b__22_0(::System::Data::DataViewListener* listener);

  /// @brief Method .ctor, addr 0x5f0dfe4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <MaintainDataView>b__0, addr 0x5f0e010, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f0d7cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AcceptRecord, addr 0x5f0b6cc, size 0x2c, virtual false, abstract: false, final false
  inline bool AcceptRecord(int32_t record);

  /// @brief Method AcceptRecord, addr 0x5f0b6f8, size 0x1a4, virtual false, abstract: false, final false
  inline bool AcceptRecord(int32_t record, ::System::Data::IFilter* filter);

  /// @brief Method AddRef, addr 0x5f0b96c, size 0x1f4, virtual false, abstract: false, final false
  inline void AddRef();

  /// @brief Method ApplyChangeAction, addr 0x5f0bd20, size 0xa4, virtual false, abstract: false, final false
  inline void ApplyChangeAction(int32_t record, int32_t action, int32_t changeRecord);

  /// @brief Method CheckUnique, addr 0x5f0c1b8, size 0x18, virtual false, abstract: false, final false
  inline bool CheckUnique();

  /// @brief Method CompareDataRows, addr 0x5f0c324, size 0x6c, virtual false, abstract: false, final false
  inline int32_t CompareDataRows(int32_t record1, int32_t record2);

  /// @brief Method CompareDuplicateRecords, addr 0x5f0c390, size 0x1d8, virtual false, abstract: false, final false
  inline int32_t CompareDuplicateRecords(int32_t record1, int32_t record2);

  /// @brief Method CompareRecordToKey, addr 0x5f0c568, size 0xd0, virtual false, abstract: false, final false
  inline int32_t CompareRecordToKey(int32_t record1, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> vals);

  /// @brief Method CompareRecords, addr 0x5f0c1d0, size 0x154, virtual false, abstract: false, final false
  inline int32_t CompareRecords(int32_t record1, int32_t record2);

  /// @brief Method DeleteRecord, addr 0x5f0c14c, size 0x8, virtual false, abstract: false, final false
  inline void DeleteRecord(int32_t recordIndex);

  /// @brief Method DeleteRecord, addr 0x5f0c640, size 0x138, virtual false, abstract: false, final false
  inline void DeleteRecord(int32_t recordIndex, bool fireEvent);

  /// @brief Method DeleteRecordFromIndex, addr 0x5f0c638, size 0x8, virtual false, abstract: false, final false
  inline void DeleteRecordFromIndex(int32_t recordIndex);

  /// @brief Method Equal, addr 0x5f0b4bc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindNodeByKey, addr 0x5f0cbd8, size 0x22c, virtual false, abstract: false, final false
  inline int32_t FindNodeByKey(::System::Object* originalKey);

  /// @brief Method FindNodeByKeyRecord, addr 0x5f0d058, size 0x104, virtual false, abstract: false, final false
  inline int32_t FindNodeByKeyRecord(int32_t record);

  /// @brief Method FindNodeByKeys, addr 0x5f0ce04, size 0x254, virtual false, abstract: false, final false
  inline int32_t FindNodeByKeys(::ArrayW<::System::Object*, ::Array<::System::Object*>*> originalKey);

  /// @brief Method FindRecords, addr 0x5f03354, size 0x24, virtual false, abstract: false, final false
  inline ::System::Data::Range FindRecords(::ArrayW<::System::Object*, ::Array<::System::Object*>*> key);

  /// @brief Method FindRecords, addr 0x5f0d290, size 0x24, virtual false, abstract: false, final false
  inline ::System::Data::Range FindRecords(::System::Object* key);

  /// @brief Method FireResetEvent, addr 0x5f0d2b4, size 0xf8, virtual false, abstract: false, final false
  inline void FireResetEvent();

  /// @brief Method GetAllFields, addr 0x5f0b038, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChangeAction, addr 0x5f0d5c4, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetChangeAction(::System::Data::DataViewRowState oldState, ::System::Data::DataViewRowState newState);

  /// @brief Method GetEnumerator, addr 0x5f0c930, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::RBTree_1_RBTreeEnumerator<int32_t> GetEnumerator(int32_t startIndex);

  /// @brief Method GetIndex, addr 0x5f0c154, size 0x64, virtual false, abstract: false, final false
  inline int32_t GetIndex(int32_t record);

  /// @brief Method GetIndex, addr 0x5f0bfcc, size 0x180, virtual false, abstract: false, final false
  inline int32_t GetIndex(int32_t record, int32_t changeRecord);

  /// @brief Method GetRangeFromNode, addr 0x5f0d15c, size 0x134, virtual false, abstract: false, final false
  inline ::System::Data::Range GetRangeFromNode(int32_t nodeId);

  /// @brief Method GetRecord, addr 0x5f0b5ec, size 0x80, virtual false, abstract: false, final false
  inline int32_t GetRecord(int32_t recordIndex);

  /// @brief Method GetReplaceAction, addr 0x5f0d5e0, size 0x20, virtual false, abstract: false, final false
  static inline int32_t GetReplaceAction(::System::Data::DataViewRowState oldState);

  /// @brief Method GetRow, addr 0x5f03c70, size 0x2c, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* GetRow(int32_t i);

  /// @brief Method GetRows, addr 0x5f03378, size 0x15c, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataRow*, ::Array<::System::Data::DataRow*>*> GetRows(::System::Data::Range range);

  /// @brief Method GetRows, addr 0x5f0d600, size 0x30, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataRow*, ::Array<::System::Data::DataRow*>*> GetRows(::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method GetUniqueKeyValues, addr 0x5f03200, size 0x13c, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetUniqueKeyValues();

  /// @brief Method GetUniqueKeyValues, addr 0x5f0c99c, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitRecords, addr 0x5f0b104, size 0x3b8, virtual false, abstract: false, final false
  inline void InitRecords(::System::Data::IFilter* filter);

  /// @brief Method InsertRecord, addr 0x5f0bdc4, size 0x208, virtual false, abstract: false, final false
  inline int32_t InsertRecord(int32_t record, bool fireEvent);

  /// @brief Method InsertRecordToIndex, addr 0x5f0d6a4, size 0x50, virtual false, abstract: false, final false
  inline int32_t InsertRecordToIndex(int32_t record);

  /// @brief Method IsKeyInIndex, addr 0x5f0333c, size 0x18, virtual false, abstract: false, final false
  inline bool IsKeyInIndex(::ArrayW<::System::Object*, ::Array<::System::Object*>*> key);

  /// @brief Method IsKeyInIndex, addr 0x5f0d6f4, size 0x18, virtual false, abstract: false, final false
  inline bool IsKeyInIndex(::System::Object* key);

  /// @brief Method IsKeyRecordInIndex, addr 0x5f0d70c, size 0x18, virtual false, abstract: false, final false
  inline bool IsKeyRecordInIndex(int32_t record);

  /// @brief Method ListChangedAdd, addr 0x5f0b89c, size 0x64, virtual false, abstract: false, final false
  inline void ListChangedAdd(::System::Data::DataViewListener* listener);

  /// @brief Method ListChangedRemove, addr 0x5f0b900, size 0x64, virtual false, abstract: false, final false
  inline void ListChangedRemove(::System::Data::DataViewListener* listener);

  /// @brief Method MaintainDataView, addr 0x5f0c778, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method OnListChanged, addr 0x5f0c89c, size 0x94, virtual false, abstract: false, final false
  inline void OnListChanged(::System::ComponentModel::ListChangedType changedType, int32_t index);

  /// @brief Method OnListChanged, addr 0x5f0d724, size 0xa8, virtual false, abstract: false, final false
  inline void OnListChanged(::System::ComponentModel::ListChangedType changedType, int32_t newIndex, int32_t oldIndex);

  /// @brief Method OnListChanged, addr 0x5f0d430, size 0x194, virtual false, abstract: false, final false
  inline void OnListChanged(::System::ComponentModel::ListChangedEventArgs* e);

  /// @brief Method RecordChanged, addr 0x5f0d994, size 0x138, virtual false, abstract: false, final false
  inline void RecordChanged(int32_t oldIndex, int32_t newIndex);

  /// @brief Method RecordChanged, addr 0x5f0d8a4, size 0xf0, virtual false, abstract: false, final false
  inline void RecordChanged(int32_t record);

  /// @brief Method RecordStateChanged, addr 0x5f0dbd8, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordStateChanged, addr 0x5f0dacc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveRef, addr 0x5f0bb60, size 0x1c0, virtual false, abstract: false, final false
  inline int32_t RemoveRef();

  /// @brief Method Reset, addr 0x5f0d7d0, size 0xd4, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5f0afe0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f0acdc, size 0x304, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::ArrayW<::System::Data::IndexField, ::Array<::System::Data::IndexField>*> indexFields,
                    ::System::Comparison_1<::System::Data::DataRow*>* comparison, ::System::Data::DataViewRowState recordStates, ::System::Data::IFilter* rowFilter);

  /// @brief Method .ctor, addr 0x5f0accc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DoListChanged, addr 0x5f0d3ac, size 0x84, virtual false, abstract: false, final false
  inline bool get_DoListChanged();

  /// @brief Method get_HasDuplicates, addr 0x5f0b66c, size 0x58, virtual false, abstract: false, final false
  inline bool get_HasDuplicates();

  /// @brief Method get_HasRemoteAggregate, addr 0x5f0b558, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasRemoteAggregate();

  /// @brief Method get_ObjectID, addr 0x5f0b560, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_RecordCount, addr 0x5f0b6c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RecordCount();

  /// @brief Method get_RecordStates, addr 0x5f0b568, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataViewRowState get_RecordStates();

  /// @brief Method get_RefCount, addr 0x5f0b964, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RefCount();

  /// @brief Method get_RowFilter, addr 0x5f0b570, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Data::IFilter* get_RowFilter();

  /// @brief Method get_Table, addr 0x5f0df60, size 0x8, virtual false, abstract: false, final false
