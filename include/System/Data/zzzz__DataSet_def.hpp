...
public:
  ...
  /// @brief Method Clear, addr 0x600f9e4, size 0x1f8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Clone, addr 0x600fc04, size 0xf44, virtual true, abstract: false, final false
  inline ::System::Data::DataSet* Clone();

  /// @brief Method DeserializeDataSet, addr 0x600a92c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeDataSetData, addr 0x600c1b0, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeDataSetProperties, addr 0x600c360, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeDataSetSchema, addr 0x600bcc8, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeRelations, addr 0x600c608, size 0x81c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableConstraints, addr 0x600dfc4, size 0x6f4, virtual false, abstract: false, final false
  inline void EnableConstraints();

  /// @brief Method EstimatedXmlStringSize, addr 0x600b9a0, size 0x120, virtual false, abstract: false, final false
  inline int32_t EstimatedXmlStringSize();

  /// @brief Method FailedEnableConstraints, addr 0x600d734, size 0x2c, virtual false, abstract: false, final false
  inline void FailedEnableConstraints();

  /// @brief Method FindTable, addr 0x6015638, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDataSetSchema, addr 0x6015a54, size 0x224, virtual false, abstract: false, final false
  static inline ::System::Xml::Schema::XmlSchemaComplexType* GetDataSetSchema(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method GetObjectData, addr 0x600a974, size 0x8, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetRemotingDiffGram, addr 0x6010b48, size 0x13c, virtual false, abstract: false, final false
  inline ::StringW GetRemotingDiffGram(::System::Data::DataTable* table);

  /// @brief Method GetXmlSchemaForRemoting, addr 0x600b7f4, size 0x1ac, virtual false, abstract: false, final false
  inline ::StringW GetXmlSchemaForRemoting(::System::Data::DataTable* table);

  /// @brief Method InferSchema, addr 0x60111d8, size 0x37c, virtual false, abstract: false, final false
  inline void InferSchema(::System::Xml::XmlDocument* xdoc, ::ArrayW<::StringW> excludedNamespaces, ::System::Data::XmlReadMode mode);

  /// @brief Method InitializeDerivedDataSet, addr 0x600afe8, size 0x4, virtual true, abstract: false, final false
  inline void InitializeDerivedDataSet();

  /// @brief Method IsEmpty, addr 0x6013a88, size 0x2cc, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method Merge, addr 0x6013d54, size 0x170, virtual false, abstract: false, final false
  inline void Merge(::System::Data::DataSet* dataSet);

  /// @brief Method Merge, addr 0x6014c7c, size 0x254, virtual false, abstract: false, final false
  inline void Merge(::System::Data::DataSet* dataSet, bool preserveChanges, ::System::Data::MissingSchemaAction missingSchemaAction);

  /// @brief Method MoveToElement, addr 0x6011088, size 0xb4, virtual false, abstract: false, final false
  inline bool MoveToElement(::System::Xml::XmlReader* reader, int32_t depth);

  /// @brief Method MoveToElement, addr 0x6011554, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method OnClearFunctionCalled, addr 0x600fbdc, size 0x28, virtual false, abstract: false, final false
  inline void OnClearFunctionCalled(::System::Data::DataTable* table);

  /// @brief Method OnDataRowCreated, addr 0x6015000, size 0x28, virtual false, abstract: false, final false
  inline void OnDataRowCreated(::System::Data::DataRow* row);

  /// @brief Method OnMergeFailed, addr 0x6014ef8, size 0x58, virtual false, abstract: false, final false
  inline void OnMergeFailed(::System::Data::MergeFailedEventArgs* mfevent);

  /// @brief Method OnPropertyChanging, addr 0x6014ed0, size 0x28, virtual true, abstract: false, final false
  inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs* pcevent);

  /// @brief Method OnRemoveRelation, addr 0x6015068, size 0x4, virtual true, abstract: false, final false
  inline void OnRemoveRelation(::System::Data::DataRelation* relation);

  /// @brief Method OnRemoveRelationHack, addr 0x601506c, size 0x10, virtual false, abstract: false, final false
  inline void OnRemoveRelationHack(::System::Data::DataRelation* relation);

  /// @brief Method OnRemoveTable, addr 0x6015028, size 0x4, virtual true, abstract: false, final false
  inline void OnRemoveTable(::System::Data::DataTable* table);

  /// @brief Method OnRemovedTable, addr 0x601502c, size 0x3c, virtual false, abstract: false, final false
  inline void OnRemovedTable(::System::Data::DataTable* table);

  /// @brief Method RaiseMergeFailed, addr 0x6014f50, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method RaisePropertyChanging, addr 0x600e6c8, size 0x7c, virtual false, abstract: false, final false
  inline void RaisePropertyChanging(::StringW name);

  /// @brief Method ReadEndElement, addr 0x601113c, size 0x9c, virtual false, abstract: false, final false
  inline void ReadEndElement(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXDRSchema, addr 0x6010c8c, size 0x168, virtual false, abstract: false, final false
  inline void ReadXDRSchema(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXSDSchema, addr 0x6010df4, size 0x294, virtual false, abstract: false, final false
  inline void ReadXSDSchema(::System::Xml::XmlReader* reader, bool denyResolving);

  /// @brief Method ReadXml, addr 0x60117fc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::XmlReadMode ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXml, addr 0x6011804, size 0x104c, virtual false, abstract: false, final false
  inline ::System::Data::XmlReadMode ReadXml(::System::Xml::XmlReader* reader, bool denyResolving);

  /// @brief Method ReadXml, addr 0x600d6c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::XmlReadMode ReadXml(::System::Xml::XmlReader* reader, ::System::Data::XmlReadMode mode);

  /// @brief Method ReadXml, addr 0x6013ec4, size 0xdb8, virtual false, abstract: false, final false
  inline ::System::Data::XmlReadMode ReadXml(::System::Xml::XmlReader* reader, ::System::Data::XmlReadMode mode, bool denyResolving);

  /// @brief Method ReadXmlDiffgram, addr 0x60128c0, size 0x11c8, virtual false, abstract: false, final false
  inline void ReadXmlDiffgram(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXmlSchema, addr 0x6010c84, size 0x8, virtual false, abstract: false, final false
  inline void ReadXmlSchema(::System::Xml::XmlReader* reader);

  /// @brief Method ReadXmlSchema, addr 0x600ce24, size 0x89c, virtual false, abstract: false, final false
  inline void ReadXmlSchema(::System::Xml::XmlReader* reader, bool denyResolving);

  /// @brief Method ReadXmlSerializable, addr 0x6015758, size 0x2fc, virtual true, abstract: false, final false
  inline void ReadXmlSerializable(::System::Xml::XmlReader* reader);

  /// @brief Method Reset, addr 0x6015388, size 0x2b0, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method RestoreEnforceConstraints, addr 0x600e6b8, size 0x8, virtual false, abstract: false, final false
  inline void RestoreEnforceConstraints(bool value);

  /// @brief Method SerializeDataSet, addr 0x600a97c, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeDataSetProperties, addr 0x600afec, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializeRelations, addr 0x600b178, size 0x67c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLocaleValue, addr 0x600ee7c, size 0x704, virtual false, abstract: false, final false
  inline void SetLocaleValue(::System::Globalization::CultureInfo* value, bool userSet);

  /// @brief Method ShouldSerializeLocale, addr 0x600f9c4, size 0x8, virtual false, abstract: false, final false
  inline bool ShouldSerializeLocale();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x6015c78, size 0x1d8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x6015e50, size 0x260, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x60160b0, size 0x34, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method TopLevelTables, addr 0x601507c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataTable*> TopLevelTables();

  /// @brief Method TopLevelTables, addr 0x6015084, size 0x304, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataTable*> TopLevelTables(bool forSchema);

  /// @brief Method ValidateCaseConstraint, addr 0x600dbd0, size 0x3ec, virtual false, abstract: false, final false
  inline bool ValidateCaseConstraint();

  /// @brief Method ValidateLocaleConstraint, addr 0x600f580, size 0x444, virtual false, abstract: false, final false
  inline bool ValidateLocaleConstraint();

  /// @brief Method WriteXml, addr 0x600bac0, size 0x208, virtual false, abstract: false, final false
  inline void WriteXml(::System::Xml::XmlWriter* writer, ::System::Data::XmlWriteMode mode);

  /// @brief Method WriteXmlSchema, addr 0x60115cc, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x600a2a0, size 0x240, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x600a4e0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW dataSetName);

  /// @brief Method .ctor, addr 0x600a704, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x600a70c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CaseSensitive, addr 0x600d8d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_CaseSensitive();

  /// @brief Method get_DataSetName, addr 0x600e6c0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DataSetName();

  /// @brief Method get_EnforceConstraints, addr 0x600dfbc, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnforceConstraints();

  /// @brief Method get_ExtendedProperties, addr 0x600d6c8, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_Locale, addr 0x600ece8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_Locale();

  /// @brief Method get_MainTableName, addr 0x60160e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MainTableName();

  /// @brief Method get_Namespace, addr 0x600e744, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_ObjectID, addr 0x60160f4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_Prefix, addr 0x600ebd0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_Relations, addr 0x600f9d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataRelationCollection* get_Relations();

  /// @brief Method get_RemotingFormat, addr 0x600a654, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::SerializationFormat get_RemotingFormat();

  /// @brief Method get_SchemaSerializationMode, addr 0x600a6fc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Data::SchemaSerializationMode get_SchemaSerializationMode();

  /// @brief Method get_Site, addr 0x600f9cc, size 0x8, virtual true, abstract: false, final false
  inline ::System::ComponentModel::ISite* get_Site();

  /// @brief Method get_Tables, addr 0x600f9dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CaseSensitive, addr 0x600d8d8, size 0x2f8, virtual false, abstract: false, final false
  inline void set_CaseSensitive(bool value);

  /// @brief Method set_DataSetName, addr 0x600a508, size 0x14c, virtual false, abstract: false, final false
  inline void set_DataSetName(::StringW value);

  /// @brief Method set_EnforceConstraints, addr 0x600d760, size 0x170, virtual false, abstract: false, final false
  inline void set_EnforceConstraints(bool value);

  /// @brief Method set_Locale, addr 0x600ecf0, size 0x18c, virtual false, abstract: false, final false
  inline void set_Locale(::System::Globalization::CultureInfo* value);

  /// @brief Method set_MainTableName, addr 0x60160ec, size 0x8, virtual false, abstract: false, final false
  inline void set_MainTableName(::StringW value);

  /// @brief Method set_Namespace, addr 0x600e74c, size 0x484, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_Prefix, addr 0x600ebd8, size 0x110, virtual false, abstract: false, final false
  inline void set_Prefix(::StringW value);

  /// @brief Method set_RemotingFormat, addr 0x600a65c, size 0xa0, virtual false, abstract: false, final false
