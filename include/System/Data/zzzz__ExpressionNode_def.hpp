...
public:
  ...
  /// @brief Method BindTable, addr 0x5e2493c, size 0x8, virtual false, abstract: false, final false
  inline void BindTable(::System::Data::DataTable* table);

  /// @brief Method DependsOn, addr 0x5e24944, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method IsFloat, addr 0x5e2494c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsFloat(::System::Data::Common::StorageType type);

  /// @brief Method IsFloatSql, addr 0x5e2495c, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsFloatSql(::System::Data::Common::StorageType type);

  /// @brief Method IsInteger, addr 0x5e2204c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsInteger(::System::Data::Common::StorageType type);

  /// @brief Method IsIntegerSql, addr 0x5e21d18, size 0x20, virtual false, abstract: false, final false
  static inline bool IsIntegerSql(::System::Data::Common::StorageType type);

  /// @brief Method IsNumeric, addr 0x5e2203c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsNumeric(::System::Data::Common::StorageType type);

  /// @brief Method IsNumericSql, addr 0x5e22164, size 0x20, virtual false, abstract: false, final false
  static inline bool IsNumericSql(::System::Data::Common::StorageType type);

  /// @brief Method IsSigned, addr 0x5e21f3c, size 0x30, virtual false, abstract: false, final false
  static inline bool IsSigned(::System::Data::Common::StorageType type);

  /// @brief Method IsSignedSql, addr 0x5e22000, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsUnsigned, addr 0x5e21f6c, size 0x10, virtual false, abstract: false, final false
  static inline bool IsUnsigned(::System::Data::Common::StorageType type);

  /// @brief Method IsUnsignedSql, addr 0x5e2201c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e199e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method get_FormatProvider, addr 0x5e21358, size 0x70, virtual false, abstract: false, final false
  inline ::System::IFormatProvider* get_FormatProvider();

  /// @brief Method get_IsSqlColumn, addr 0x5e2492c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSqlColumn();

  /// @brief Method get_table, addr 0x5e24934, size 0x8, virtual false, abstract: false, final false
