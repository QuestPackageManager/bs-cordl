...
public:
  ...
  /// @brief Method BindTable, addr 0x2bcaeb4, size 0x8, virtual false, abstract: false, final false
  inline void BindTable(::System::Data::DataTable* table);

  /// @brief Method DependsOn, addr 0x2bcaebc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method IsFloat, addr 0x2bcaec4, size 0x20, virtual false, abstract: false, final false
  static inline bool IsFloat(::System::Data::Common::StorageType type);

  /// @brief Method IsFloatSql, addr 0x2bcaee4, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsFloatSql(::System::Data::Common::StorageType type);

  /// @brief Method IsInteger, addr 0x2bc8304, size 0x24, virtual false, abstract: false, final false
  static inline bool IsInteger(::System::Data::Common::StorageType type);

  /// @brief Method IsIntegerSql, addr 0x2bc7f04, size 0x38, virtual false, abstract: false, final false
  static inline bool IsIntegerSql(::System::Data::Common::StorageType type);

  /// @brief Method IsNumeric, addr 0x2bc82e4, size 0x20, virtual false, abstract: false, final false
  static inline bool IsNumeric(::System::Data::Common::StorageType type);

  /// @brief Method IsNumericSql, addr 0x2bc842c, size 0x64, virtual false, abstract: false, final false
  static inline bool IsNumericSql(::System::Data::Common::StorageType type);

  /// @brief Method IsSigned, addr 0x2bc8150, size 0x48, virtual false, abstract: false, final false
  static inline bool IsSigned(::System::Data::Common::StorageType type);

  /// @brief Method IsSignedSql, addr 0x2bc8270, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method IsUnsigned, addr 0x2bc8198, size 0x2c, virtual false, abstract: false, final false
  static inline bool IsUnsigned(::System::Data::Common::StorageType type);

  /// @brief Method IsUnsignedSql, addr 0x2bc82a8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bbfa70, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method get_FormatProvider, addr 0x2bc746c, size 0x6c, virtual false, abstract: false, final false
  inline ::System::IFormatProvider* get_FormatProvider();

  /// @brief Method get_IsSqlColumn, addr 0x2bcaea4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsSqlColumn();

  /// @brief Method get_table, addr 0x2bcaeac, size 0x8, virtual false, abstract: false, final false
