...
public:
  ...
  /// @brief Method AddColumnProperties, addr 0x41b78a8, size 0x60c, virtual false, abstract: false, final false
  inline void AddColumnProperties(::System::Data::DataColumn* col, ::System::Xml::XmlElement* root);

  /// @brief Method AddExtendedProperties, addr 0x41abdf8, size 0x8, virtual false, abstract: false, final false
  static inline void AddExtendedProperties(::System::Data::PropertyCollection* props, ::System::Xml::XmlElement* node);

  /// @brief Method AddExtendedProperties, addr 0x41abe00, size 0x774, virtual false, abstract: false, final false
  ...
  /// @brief Method AddXdoProperties, addr 0x41ac574, size 0x1b0, virtual false, abstract: false, final false
  inline void AddXdoProperties(::System::Object* instance, ::System::Xml::XmlElement* root, ::System::Xml::XmlDocument* xd);

  /// @brief Method AddXdoProperty, addr 0x41ac724, size 0x92c, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendChildWithoutRef, addr 0x41b3728, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method AutoGenerated, addr 0x41afab4, size 0x574, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::DataColumn* col);

  /// @brief Method AutoGenerated, addr 0x41b0028, size 0xc, virtual false, abstract: false, final false
  inline bool AutoGenerated(::System::Data::ForeignKeyConstraint* fk);

  /// @brief Method AutoGenerated, addr 0x41b9240, size 0x140, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::ForeignKeyConstraint* fk, bool checkRelation);

  /// @brief Method AutoGenerated, addr 0x41b915c, size 0xe4, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::DataRelation* rel);

  /// @brief Method AutoGenerated, addr 0x41b0034, size 0xd4, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::UniqueConstraint* unique);

  /// @brief Method CreateRelations, addr 0x41b048c, size 0x358, virtual false, abstract: false, final false
  inline void CreateRelations(::System::Data::DataTable* dt);

  /// @brief Method CreateTablesHierarchy, addr 0x41b0108, size 0x384, virtual false, abstract: false, final false
  inline void CreateTablesHierarchy(::System::Data::DataTable* dt);

  /// @brief Method CreateToplevelTables, addr 0x41b07e4, size 0x2ec, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataTable*, ::Array<::System::Data::DataTable*>*> CreateToplevelTables();

  /// @brief Method FillDataSetElement, addr 0x41b3100, size 0x620, virtual false, abstract: false, final false
  ...
  /// @brief Method FindSimpleType, addr 0x41b70a4, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlElement* FindSimpleType(::System::Xml::XmlElement* schema, ::StringW name);

  /// @brief Method FindTargetNamespace, addr 0x41b7eb4, size 0x110, virtual false, abstract: false, final false
  inline ::StringW FindTargetNamespace(::System::Data::DataTable* table);

  /// @brief Method FindTypeNode, addr 0x41b8ad4, size 0x1c8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* FindTypeNode(::System::Xml::XmlElement* node, ::StringW strType);

  /// @brief Method GenerateConstraintNames, addr 0x41ae52c, size 0x2e4, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Data::DataSet* ds);

  /// @brief Method GenerateConstraintNames, addr 0x41adf18, size 0x51c, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Data::DataTable* table, bool fromTable);

  /// @brief Method GenerateConstraintNames, addr 0x41ae434, size 0xf8, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Collections::ArrayList* tables);

  /// @brief Method GetSchema, addr 0x41b7198, size 0x294, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* GetSchema(::StringW NamespaceURI);

  /// @brief Method HandleColumn, addr 0x41b7fc4, size 0xb10, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleColumnType, addr 0x41b742c, size 0x47c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleRelation, addr 0x41b37e0, size 0x5c4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* HandleRelation(::System::Data::DataRelation* rel, ::System::Xml::XmlDocument* dc);

  /// @brief Method HandleTable, addr 0x41b3720, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleTable, addr 0x41b41f0, size 0x29e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HasMixedColumns, addr 0x41b8dc4, size 0x398, virtual false, abstract: false, final false
  inline bool HasMixedColumns(::System::Data::DataTable* table);

  /// @brief Method HaveExtendedProperties, addr 0x41ae838, size 0x184, virtual false, abstract: false, final false
  inline bool HaveExtendedProperties(::System::Data::DataSet* ds);

  /// @brief Method IsAutoGenerated, addr 0x41b9380, size 0x44, virtual false, abstract: false, final false
  inline bool IsAutoGenerated(::System::Object* o);

  static inline ::System::Data::XmlTreeGen* New_ctor(::System::Data::SchemaFormat format);

  /// @brief Method Save, addr 0x41b6e7c, size 0xc, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw);

  /// @brief Method Save, addr 0x41b6f48, size 0xc, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw, bool writeHierarchy);

  /// @brief Method Save, addr 0x41b6f54, size 0x150, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw, bool writeHierarchy,
                   ::System::Converter_2<::System::Type*, ::StringW>* multipleTargetConverter);

  /// @brief Method Save, addr 0x41b6e68, size 0x14, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Xml::XmlWriter* xw);

  /// @brief Method Save, addr 0x41b6e88, size 0xc0, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw);

  /// @brief Method SchemaTree, addr 0x41b3da4, size 0x44c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* SchemaTree(::System::Xml::XmlDocument* xd, ::System::Data::DataTable* dt);

  /// @brief Method SchemaTree, addr 0x41b0ad0, size 0x2630, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMSDataAttribute, addr 0x41add34, size 0x1e4, virtual false, abstract: false, final false
  inline void SetMSDataAttribute(::System::Xml::XmlElement* root, ::System::Type* type);

  /// @brief Method SetPath, addr 0x41b6bd4, size 0x200, virtual false, abstract: false, final false
  inline void SetPath(::System::Xml::XmlWriter* xw);

  /// @brief Method SetupAutoGenerated, addr 0x41aeca8, size 0x2e0, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Data::DataSet* ds);

  /// @brief Method SetupAutoGenerated, addr 0x41af9c0, size 0xf4, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Collections::ArrayList* dt);

  /// @brief Method SetupAutoGenerated, addr 0x41aef88, size 0xa38, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Data::DataTable* dt);

  /// @brief Method TranslateAcceptRejectRule, addr 0x41b8c9c, size 0x70, virtual false, abstract: false, final false
  static inline ::StringW TranslateAcceptRejectRule(::System::Data::AcceptRejectRule rule);

  /// @brief Method TranslateRule, addr 0x41b8d0c, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW TranslateRule(::System::Data::Rule rule);

  /// @brief Method ValidateColumnMapping, addr 0x41aec20, size 0x88, virtual false, abstract: false, final false
  static inline void ValidateColumnMapping(::System::Type* columnType);

  /// @brief Method WriteSchemaRoot, addr 0x41ae9bc, size 0x264, virtual false, abstract: false, final false
  inline void WriteSchemaRoot(::System::Xml::XmlDocument* xd, ::System::Xml::XmlElement* rootSchema, ::StringW targetNamespace);

  /// @brief Method XmlDataTypeName, addr 0x41ad050, size 0xce4, virtual false, abstract: false, final false
  static inline ::StringW XmlDataTypeName(::System::Type* type);

  /// @brief Method _PropsNotEmpty, addr 0x41ae810, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41abd64, size 0x94, virtual false, abstract: false, final false
