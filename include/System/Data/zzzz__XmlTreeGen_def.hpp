...
public:
  ...
  /// @brief Method AddColumnProperties, addr 0x41b5fec, size 0x60c, virtual false, abstract: false, final false
  inline void AddColumnProperties(::System::Data::DataColumn* col, ::System::Xml::XmlElement* root);

  /// @brief Method AddExtendedProperties, addr 0x41aa53c, size 0x8, virtual false, abstract: false, final false
  static inline void AddExtendedProperties(::System::Data::PropertyCollection* props, ::System::Xml::XmlElement* node);

  /// @brief Method AddExtendedProperties, addr 0x41aa544, size 0x774, virtual false, abstract: false, final false
  ...
  /// @brief Method AddXdoProperties, addr 0x41aacb8, size 0x1b0, virtual false, abstract: false, final false
  inline void AddXdoProperties(::System::Object* instance, ::System::Xml::XmlElement* root, ::System::Xml::XmlDocument* xd);

  /// @brief Method AddXdoProperty, addr 0x41aae68, size 0x92c, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendChildWithoutRef, addr 0x41b1e6c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method AutoGenerated, addr 0x41ae1f8, size 0x574, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::DataColumn* col);

  /// @brief Method AutoGenerated, addr 0x41ae76c, size 0xc, virtual false, abstract: false, final false
  inline bool AutoGenerated(::System::Data::ForeignKeyConstraint* fk);

  /// @brief Method AutoGenerated, addr 0x41b7984, size 0x140, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::ForeignKeyConstraint* fk, bool checkRelation);

  /// @brief Method AutoGenerated, addr 0x41b78a0, size 0xe4, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::DataRelation* rel);

  /// @brief Method AutoGenerated, addr 0x41ae778, size 0xd4, virtual false, abstract: false, final false
  static inline bool AutoGenerated(::System::Data::UniqueConstraint* unique);

  /// @brief Method CreateRelations, addr 0x41aebd0, size 0x358, virtual false, abstract: false, final false
  inline void CreateRelations(::System::Data::DataTable* dt);

  /// @brief Method CreateTablesHierarchy, addr 0x41ae84c, size 0x384, virtual false, abstract: false, final false
  inline void CreateTablesHierarchy(::System::Data::DataTable* dt);

  /// @brief Method CreateToplevelTables, addr 0x41aef28, size 0x2ec, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataTable*, ::Array<::System::Data::DataTable*>*> CreateToplevelTables();

  /// @brief Method FillDataSetElement, addr 0x41b1844, size 0x620, virtual false, abstract: false, final false
  ...
  /// @brief Method FindSimpleType, addr 0x41b57e8, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlElement* FindSimpleType(::System::Xml::XmlElement* schema, ::StringW name);

  /// @brief Method FindTargetNamespace, addr 0x41b65f8, size 0x110, virtual false, abstract: false, final false
  inline ::StringW FindTargetNamespace(::System::Data::DataTable* table);

  /// @brief Method FindTypeNode, addr 0x41b7218, size 0x1c8, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* FindTypeNode(::System::Xml::XmlElement* node, ::StringW strType);

  /// @brief Method GenerateConstraintNames, addr 0x41acc70, size 0x2e4, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Data::DataSet* ds);

  /// @brief Method GenerateConstraintNames, addr 0x41ac65c, size 0x51c, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Data::DataTable* table, bool fromTable);

  /// @brief Method GenerateConstraintNames, addr 0x41acb78, size 0xf8, virtual false, abstract: false, final false
  inline void GenerateConstraintNames(::System::Collections::ArrayList* tables);

  /// @brief Method GetSchema, addr 0x41b58dc, size 0x294, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* GetSchema(::StringW NamespaceURI);

  /// @brief Method HandleColumn, addr 0x41b6708, size 0xb10, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleColumnType, addr 0x41b5b70, size 0x47c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleRelation, addr 0x41b1f24, size 0x5c4, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* HandleRelation(::System::Data::DataRelation* rel, ::System::Xml::XmlDocument* dc);

  /// @brief Method HandleTable, addr 0x41b1e64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleTable, addr 0x41b2934, size 0x29e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HasMixedColumns, addr 0x41b7508, size 0x398, virtual false, abstract: false, final false
  inline bool HasMixedColumns(::System::Data::DataTable* table);

  /// @brief Method HaveExtendedProperties, addr 0x41acf7c, size 0x184, virtual false, abstract: false, final false
  inline bool HaveExtendedProperties(::System::Data::DataSet* ds);

  /// @brief Method IsAutoGenerated, addr 0x41b7ac4, size 0x44, virtual false, abstract: false, final false
  inline bool IsAutoGenerated(::System::Object* o);

  static inline ::System::Data::XmlTreeGen* New_ctor(::System::Data::SchemaFormat format);

  /// @brief Method Save, addr 0x41b55c0, size 0xc, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw);

  /// @brief Method Save, addr 0x41b568c, size 0xc, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw, bool writeHierarchy);

  /// @brief Method Save, addr 0x41b5698, size 0x150, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw, bool writeHierarchy,
                   ::System::Converter_2<::System::Type*, ::StringW>* multipleTargetConverter);

  /// @brief Method Save, addr 0x41b55ac, size 0x14, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataSet* ds, ::System::Xml::XmlWriter* xw);

  /// @brief Method Save, addr 0x41b55cc, size 0xc0, virtual false, abstract: false, final false
  inline void Save(::System::Data::DataTable* dt, ::System::Xml::XmlWriter* xw);

  /// @brief Method SchemaTree, addr 0x41b24e8, size 0x44c, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* SchemaTree(::System::Xml::XmlDocument* xd, ::System::Data::DataTable* dt);

  /// @brief Method SchemaTree, addr 0x41af214, size 0x2630, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMSDataAttribute, addr 0x41ac478, size 0x1e4, virtual false, abstract: false, final false
  inline void SetMSDataAttribute(::System::Xml::XmlElement* root, ::System::Type* type);

  /// @brief Method SetPath, addr 0x41b5318, size 0x200, virtual false, abstract: false, final false
  inline void SetPath(::System::Xml::XmlWriter* xw);

  /// @brief Method SetupAutoGenerated, addr 0x41ad3ec, size 0x2e0, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Data::DataSet* ds);

  /// @brief Method SetupAutoGenerated, addr 0x41ae104, size 0xf4, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Collections::ArrayList* dt);

  /// @brief Method SetupAutoGenerated, addr 0x41ad6cc, size 0xa38, virtual false, abstract: false, final false
  inline void SetupAutoGenerated(::System::Data::DataTable* dt);

  /// @brief Method TranslateAcceptRejectRule, addr 0x41b73e0, size 0x70, virtual false, abstract: false, final false
  static inline ::StringW TranslateAcceptRejectRule(::System::Data::AcceptRejectRule rule);

  /// @brief Method TranslateRule, addr 0x41b7450, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW TranslateRule(::System::Data::Rule rule);

  /// @brief Method ValidateColumnMapping, addr 0x41ad364, size 0x88, virtual false, abstract: false, final false
  static inline void ValidateColumnMapping(::System::Type* columnType);

  /// @brief Method WriteSchemaRoot, addr 0x41ad100, size 0x264, virtual false, abstract: false, final false
  inline void WriteSchemaRoot(::System::Xml::XmlDocument* xd, ::System::Xml::XmlElement* rootSchema, ::StringW targetNamespace);

  /// @brief Method XmlDataTypeName, addr 0x41ab794, size 0xce4, virtual false, abstract: false, final false
  static inline ::StringW XmlDataTypeName(::System::Type* type);

  /// @brief Method _PropsNotEmpty, addr 0x41acf54, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41aa4a8, size 0x94, virtual false, abstract: false, final false
