...
public:
  ...
  /// @brief Method AnalyzePattern, addr 0x603ed7c, size 0x2a8, virtual false, abstract: false, final false
  inline ::StringW AnalyzePattern(::StringW pat);

  /// @brief Method Eval, addr 0x603e878, size 0x504, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x603e868, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LikeNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LikeNode(LikeNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LikeNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LikeNode(LikeNodeconst&) = delete;
