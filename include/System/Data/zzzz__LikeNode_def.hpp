...
public:
  ...
  /// @brief Method AnalyzePattern, addr 0x4185534, size 0x2e0, virtual false, abstract: false, final false
  inline ::StringW AnalyzePattern(::StringW pat);

  /// @brief Method Eval, addr 0x4184fe0, size 0x554, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4184f9c, size 0x44, virtual false, abstract: false, final false
