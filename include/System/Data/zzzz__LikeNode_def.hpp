...
public:
  ...
  /// @brief Method AnalyzePattern, addr 0x5e8a224, size 0x2a8, virtual false, abstract: false, final false
  inline ::StringW AnalyzePattern(::StringW pat);

  /// @brief Method Eval, addr 0x5e89d20, size 0x504, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e89d10, size 0x10, virtual false, abstract: false, final false
