...
// Write type traits
MARK_REF_T(::System::Data::ForeignKeyConstraintEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Data::ForeignKeyConstraintEnumerator*, "System.Data", "ForeignKeyConstraintEnumerator");
...
public:
  // Declarations
  /// @brief Method GetForeignKeyConstraint, addr 0x60203fc, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Data::ForeignKeyConstraint* GetForeignKeyConstraint();

  /// @brief Method IsValidCandidate, addr 0x6020380, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x602037c, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ForeignKeyConstraintEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ForeignKeyConstraintEnumerator(ForeignKeyConstraintEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ForeignKeyConstraintEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ForeignKeyConstraintEnumerator(ForeignKeyConstraintEnumeratorconst&) = delete;
...
static_assert(sizeof(::System::Data::ForeignKeyConstraintEnumerator) == 0x28, "Size mismatch!");
