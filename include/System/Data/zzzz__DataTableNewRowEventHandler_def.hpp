...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataTableNewRowEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataTableNewRowEventHandler(DataTableNewRowEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataTableNewRowEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataTableNewRowEventHandler(DataTableNewRowEventHandlerconst&) = delete;
