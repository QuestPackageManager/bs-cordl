...
// Write type traits
MARK_REF_T(::System::Data::DeletedRowInaccessibleException*);
DEFINE_IL2CPP_CLASS(::System::Data::DeletedRowInaccessibleException*, "System.Data", "DeletedRowInaccessibleException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6005494, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x600548c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x60054f4, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DeletedRowInaccessibleException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DeletedRowInaccessibleException(DeletedRowInaccessibleException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DeletedRowInaccessibleException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DeletedRowInaccessibleException(DeletedRowInaccessibleExceptionconst&) = delete;
...
static_assert(sizeof(::System::Data::DeletedRowInaccessibleException) == 0x90, "Size mismatch!");
