...
public:
  ...
  /// @brief Method CheckNull, addr 0x5f0902c, size 0x34, virtual false, abstract: false, final false
  inline void CheckNull();

  /// @brief Method .ctor, addr 0x5f08fe4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(int32_t min, int32_t max);

  /// @brief Method get_Count, addr 0x5f03c38, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsNull, addr 0x5f03784, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsNull();

  /// @brief Method get_Min, addr 0x5f03c58, size 0x18, virtual false, abstract: false, final false
