...
public:
  ...
  /// @brief Method .ctor, addr 0x602d844, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataRowChangeEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataRowChangeEventArgs(DataRowChangeEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataRowChangeEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataRowChangeEventArgs(DataRowChangeEventArgsconst&) = delete;
