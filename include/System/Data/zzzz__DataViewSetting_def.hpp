...
public:
  ...
  /// @brief Method SetDataTable, addr 0x5ef3678, size 0x14, virtual false, abstract: false, final false
  inline void SetDataTable(::System::Data::DataTable* table);

  /// @brief Method SetDataViewManager, addr 0x5ef3664, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ef363c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ApplyDefaultSort, addr 0x5ef365c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ApplyDefaultSort();

  /// @brief Method get_RowFilter, addr 0x5ef368c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_RowFilter();

  /// @brief Method get_RowStateFilter, addr 0x5ef3694, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataViewRowState get_RowStateFilter();

  /// @brief Method get_Sort, addr 0x5ef369c, size 0x8, virtual false, abstract: false, final false
