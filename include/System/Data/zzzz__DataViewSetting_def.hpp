...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataViewSetting", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataViewSetting(DataViewSetting&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataViewSetting", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataViewSetting(DataViewSettingconst&) = delete;
