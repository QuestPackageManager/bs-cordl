...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataTableTypeConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataTableTypeConverter(DataTableTypeConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataTableTypeConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataTableTypeConverter(DataTableTypeConverterconst&) = delete;
