...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SimpleType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SimpleType(SimpleType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SimpleType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SimpleType(SimpleTypeconst&) = delete;
