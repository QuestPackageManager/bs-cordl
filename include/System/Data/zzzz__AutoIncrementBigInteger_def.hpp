...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AutoIncrementBigInteger", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AutoIncrementBigInteger(AutoIncrementBigInteger&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AutoIncrementBigInteger", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AutoIncrementBigInteger(AutoIncrementBigIntegerconst&) = delete;
