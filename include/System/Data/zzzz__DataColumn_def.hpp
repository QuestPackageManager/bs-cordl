...
public:
  ...
  /// @brief Method AddDependentColumn, addr 0x5ec21d0, size 0x10c, virtual false, abstract: false, final false
  inline void AddDependentColumn(::System::Data::DataColumn* expressionColumn);

  /// @brief Method CheckColumnConstraint, addr 0x5ec0b4c, size 0x64, virtual false, abstract: false, final false
  inline void CheckColumnConstraint(::System::Data::DataRow* row, ::System::Data::DataRowAction action);

  /// @brief Method CheckMaxLength, addr 0x5ebf728, size 0x334, virtual false, abstract: false, final false
  inline bool CheckMaxLength();

  /// @brief Method CheckMaxLength, addr 0x5ec0c28, size 0x7c, virtual false, abstract: false, final false
  inline void CheckMaxLength(::System::Data::DataRow* dr);

  /// @brief Method CheckNotAllowNull, addr 0x5ebc3c4, size 0x420, virtual false, abstract: false, final false
  inline void CheckNotAllowNull();

  /// @brief Method CheckNullable, addr 0x5ec0bb0, size 0x78, virtual false, abstract: false, final false
  inline void CheckNullable(::System::Data::DataRow* row);

  /// @brief Method CheckUnique, addr 0x5ec07d4, size 0x48, virtual false, abstract: false, final false
  inline void CheckUnique();

  /// @brief Method Clone, addr 0x5ec1008, size 0x4a4, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* Clone();

  /// @brief Method Compare, addr 0x5ec0e08, size 0x1c, virtual false, abstract: false, final false
  inline int32_t Compare(int32_t record1, int32_t record2);

  /// @brief Method CompareValueTo, addr 0x5ec0e24, size 0x190, virtual false, abstract: false, final false
  inline bool CompareValueTo(int32_t record1, ::System::Object* value, bool checkType);

  /// @brief Method CompareValueTo, addr 0x5ec0fb4, size 0x1c, virtual false, abstract: false, final false
  inline int32_t CompareValueTo(int32_t record1, ::System::Object* value);

  /// @brief Method ConvertObjectToXml, addr 0x5ebe1ac, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW ConvertObjectToXml(::System::Object* value);

  /// @brief Method ConvertObjectToXml, addr 0x5ec20dc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertValue, addr 0x5ec0fd0, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* ConvertValue(::System::Object* value);

  /// @brief Method ConvertXmlToObject, addr 0x5ec205c, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Object* ConvertXmlToObject(::StringW s);

  /// @brief Method ConvertXmlToObject, addr 0x5ec2098, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x5ec0fec, size 0x1c, virtual false, abstract: false, final false
  inline void Copy(int32_t srcRecordNo, int32_t dstRecordNo);

  /// @brief Method CopyValueIntoStore, addr 0x5ec216c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method FreeRecord, addr 0x5ec0358, size 0x20, virtual false, abstract: false, final false
  inline void FreeRecord(int32_t record);

  /// @brief Method GetAggregateValue, addr 0x5ec15bc, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Object* GetAggregateValue(::ArrayW<int32_t, ::Array<int32_t>*> records, ::System::Data::AggregateType kind);

  /// @brief Method GetColumnValueAsString, addr 0x5ebe0c4, size 0xcc, virtual false, abstract: false, final false
  inline ::StringW GetColumnValueAsString(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method GetDataRow, addr 0x5ebffd0, size 0x24, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* GetDataRow(int32_t index);

  /// @brief Method GetEmptyColumnStore, addr 0x5ec2130, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Object* GetEmptyColumnStore(int32_t recordCount);

  /// @brief Method GetStringLength, addr 0x5ec0ca4, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetStringLength(int32_t record);

  /// @brief Method HandleDependentColumnList, addr 0x5ebf030, size 0x144, virtual false, abstract: false, final false
  inline void HandleDependentColumnList(::System::Data::DataExpression* oldExpression, ::System::Data::DataExpression* newExpression);

  /// @brief Method Init, addr 0x5ec1680, size 0x8c, virtual false, abstract: false, final false
  inline void Init(int32_t record);

  /// @brief Method InitializeRecord, addr 0x5ebf174, size 0x3c, virtual false, abstract: false, final false
  inline void InitializeRecord(int32_t record);

  /// @brief Method InsureStorage, addr 0x5ec1f28, size 0x7c, virtual false, abstract: false, final false
  inline void InsureStorage();

  /// @brief Method InternalUnique, addr 0x5ec081c, size 0x8, virtual false, abstract: false, final false
  inline void InternalUnique(bool value);

  /// @brief Method IsAutoIncrementType, addr 0x5ebca28, size 0x248, virtual false, abstract: false, final false
  static inline bool IsAutoIncrementType(::System::Type* dataType);

  /// @brief Method IsInRelation, addr 0x5ebe290, size 0x154, virtual false, abstract: false, final false
  inline bool IsInRelation();

  /// @brief Method IsMaxLengthViolated, addr 0x5ec184c, size 0x4e0, virtual false, abstract: false, final false
  inline bool IsMaxLengthViolated();

  /// @brief Method IsNotAllowDBNullViolated, addr 0x5ec1d78, size 0x13c, virtual false, abstract: false, final false
  inline bool IsNotAllowDBNullViolated();

  /// @brief Method IsValueCustomTypeInstance, addr 0x5ec1784, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPropertyChanging, addr 0x5ec1f00, size 0x28, virtual true, abstract: false, final false
  inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs* pcevent);

  /// @brief Method OnSetDataSet, addr 0x5ec1fe0, size 0x4, virtual false, abstract: false, final false
  inline void OnSetDataSet();

  /// @brief Method RaisePropertyChanging, addr 0x5ebde20, size 0x78, virtual false, abstract: false, final false
  inline void RaisePropertyChanging(::StringW name);

  /// @brief Method RemoveDependentColumn, addr 0x5ec22dc, size 0xa8, virtual false, abstract: false, final false
  inline void RemoveDependentColumn(::System::Data::DataColumn* expressionColumn);

  /// @brief Method SetCapacity, addr 0x5ec1fa4, size 0x3c, virtual false, abstract: false, final false
  inline void SetCapacity(int32_t capacity);

  /// @brief Method SetMaxLengthSimpleType, addr 0x5ebf2a8, size 0xac, virtual false, abstract: false, final false
  inline void SetMaxLengthSimpleType();

  /// @brief Method SetOrdinalInternal, addr 0x5ebfcdc, size 0x14c, virtual false, abstract: false, final false
  inline void SetOrdinalInternal(int32_t ordinal);

  /// @brief Method SetStorage, addr 0x5ec218c, size 0x44, virtual false, abstract: false, final false
  inline void SetStorage(::System::Object* store, ::System::Collections::BitArray* nullbits);

  /// @brief Method SetTable, addr 0x5ebff1c, size 0xb4, virtual false, abstract: false, final false
  inline void SetTable(::System::Data::DataTable* table);

  /// @brief Method SetValue, addr 0x5ec0250, size 0x108, virtual false, abstract: false, final false
  inline void SetValue(int32_t record, ::System::Object* value);

  /// @brief Method ToString, addr 0x5ec1fe4, size 0x78, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateColumnType, addr 0x5ebb8cc, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ebb48c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5ebb7bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW columnName, ::System::Type* dataType);

  /// @brief Method .ctor, addr 0x5ebb4e4, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AllowDBNull, addr 0x5ebc220, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowDBNull();

  /// @brief Method get_AutoInc, addr 0x5ebd458, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Data::AutoIncrementValue* get_AutoInc();

  /// @brief Method get_AutoIncrement, addr 0x5ebc7e4, size 0x20, virtual false, abstract: false, final false
  inline bool get_AutoIncrement();

  /// @brief Method get_AutoIncrementCurrent, addr 0x5ebd534, size 0x30, virtual false, abstract: false, final false
  inline ::System::Object* get_AutoIncrementCurrent();

  /// @brief Method get_AutoIncrementSeed, addr 0x5ebd564, size 0x18, virtual false, abstract: false, final false
  inline int64_t get_AutoIncrementSeed();

  /// @brief Method get_AutoIncrementStep, addr 0x5ebd890, size 0x1c, virtual false, abstract: false, final false
  inline int64_t get_AutoIncrementStep();

  /// @brief Method get_Caption, addr 0x5ebd9b0, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Caption();

  /// @brief Method get_ColumnMapping, addr 0x5ec083c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Data::MappingType get_ColumnMapping();

  /// @brief Method get_ColumnName, addr 0x5ebda98, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ColumnName();

  /// @brief Method get_Computed, addr 0x5ebe1e8, size 0x10, virtual false, abstract: false, final false
  inline bool get_Computed();

  /// @brief Method get_DataExpression, addr 0x5ebe1f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataExpression* get_DataExpression();

  /// @brief Method get_DataType, addr 0x5ebe200, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_DataType();

  /// @brief Method get_DateTimeMode, addr 0x5ebe998, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataSetDateTime get_DateTimeMode();

  /// @brief Method get_DefaultValue, addr 0x5ebe428, size 0x10c, virtual false, abstract: false, final false
  inline ::System::Object* get_DefaultValue();

  /// @brief Method get_DefaultValueIsNull, addr 0x5ebecfc, size 0x8, virtual false, abstract: false, final false
  inline bool get_DefaultValueIsNull();

  /// @brief Method get_EncodedColumnName, addr 0x5ebde98, size 0x70, virtual false, abstract: false, final false
  inline ::StringW get_EncodedColumnName();

  /// @brief Method get_Expression, addr 0x5ebed04, size 0x90, virtual false, abstract: false, final false
  inline ::StringW get_Expression();

  /// @brief Method get_ExtendedProperties, addr 0x5ebf204, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_FormatProvider, addr 0x5ebd690, size 0x70, virtual false, abstract: false, final false
  inline ::System::IFormatProvider* get_FormatProvider();

  /// @brief Method get_HasData, addr 0x5ebcc70, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasData();

  /// @brief Method get_ImplementsIChangeTracking, addr 0x5ebf278, size 0x8, virtual false, abstract: false, final false
  inline bool get_ImplementsIChangeTracking();

  /// @brief Method get_ImplementsINullable, addr 0x5ebf270, size 0x8, virtual false, abstract: false, final false
  inline bool get_ImplementsINullable();

  /// @brief Method get_ImplementsIRevertibleChangeTracking, addr 0x5ebf280, size 0x8, virtual false, abstract: false, final false
  inline bool get_ImplementsIRevertibleChangeTracking();

  /// @brief Method get_ImplementsIXMLSerializable, addr 0x5ec1844, size 0x8, virtual false, abstract: false, final false
  inline bool get_ImplementsIXMLSerializable();

  /// @brief Method get_IsCustomType, addr 0x5ec170c, size 0x78, virtual false, abstract: false, final false
  inline bool get_IsCustomType();

  /// @brief Method get_IsSqlType, addr 0x5ebf2a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsSqlType();

  /// @brief Method get_IsValueType, addr 0x5ebf288, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsValueType();

  /// @brief Method get_Item, addr 0x5ebe190, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(int32_t record);

  /// @brief Method get_Locale, addr 0x5ebda28, size 0x70, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_Locale();

  /// @brief Method get_MaxLength, addr 0x5ebf354, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxLength();

  /// @brief Method get_Namespace, addr 0x5ebfb0c, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_Namespace();

  /// @brief Method get_ObjectID, addr 0x5ebdf08, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_Ordinal, addr 0x5ebfcd4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Ordinal();

  /// @brief Method get_Prefix, addr 0x5ebdf10, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_ReadOnly, addr 0x5ebfe28, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReadOnly();

  /// @brief Method get_SimpleType, addr 0x5ec0834, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::SimpleType* get_SimpleType();

  /// @brief Method get_SortIndex, addr 0x5ebfe74, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Data::Index* get_SortIndex();

  /// @brief Method get_Table, addr 0x5ebff14, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* get_Table();

  /// @brief Method get_Unique, addr 0x5ec0378, size 0x8, virtual false, abstract: false, final false
  inline bool get_Unique();

  /// @brief Method get_XmlDataType, addr 0x5ec0824, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_XmlDataType();

  static inline void setStaticF_s_objectTypeCount(int32_t value);

  /// @brief Method set_AllowDBNull, addr 0x5ebc228, size 0x19c, virtual false, abstract: false, final false
  inline void set_AllowDBNull(bool value);

  /// @brief Method set_AutoIncrement, addr 0x5ebc804, size 0x19c, virtual false, abstract: false, final false
  inline void set_AutoIncrement(bool value);

  /// @brief Method set_AutoIncrementCurrent, addr 0x5ebd57c, size 0x114, virtual false, abstract: false, final false
  inline void set_AutoIncrementCurrent(::System::Object* value);

  /// @brief Method set_AutoIncrementSeed, addr 0x5ebd794, size 0xfc, virtual false, abstract: false, final false
  inline void set_AutoIncrementSeed(int64_t value);

  /// @brief Method set_AutoIncrementStep, addr 0x5ebd8ac, size 0x104, virtual false, abstract: false, final false
  inline void set_AutoIncrementStep(int64_t value);

  /// @brief Method set_Caption, addr 0x5ebd9cc, size 0x5c, virtual false, abstract: false, final false
  inline void set_Caption(::StringW value);

  /// @brief Method set_ColumnMapping, addr 0x5ec0844, size 0x214, virtual true, abstract: false, final false
  inline void set_ColumnMapping(::System::Data::MappingType value);

  /// @brief Method set_ColumnName, addr 0x5ebdaa0, size 0x33c, virtual false, abstract: false, final false
  inline void set_ColumnName(::StringW value);

  /// @brief Method set_DataType, addr 0x5ebccd0, size 0x788, virtual false, abstract: false, final false
  inline void set_DataType(::System::Type* value);

  /// @brief Method set_DateTimeMode, addr 0x5ebe9a0, size 0x114, virtual false, abstract: false, final false
  inline void set_DateTimeMode(::System::Data::DataSetDateTime value);

  /// @brief Method set_DefaultValue, addr 0x5ebe534, size 0x2e0, virtual false, abstract: false, final false
  inline void set_DefaultValue(::System::Object* value);

  /// @brief Method set_Expression, addr 0x5ebb9cc, size 0x854, virtual false, abstract: false, final false
  inline void set_Expression(::StringW value);

  /// @brief Method set_Item, addr 0x5ebfff4, size 0x180, virtual false, abstract: false, final false
  inline void set_Item(int32_t record, ::System::Object* value);

  /// @brief Method set_MaxLength, addr 0x5ebf35c, size 0x31c, virtual false, abstract: false, final false
  inline void set_MaxLength(int32_t value);

  /// @brief Method set_Namespace, addr 0x5ebfb4c, size 0x138, virtual false, abstract: false, final false
  inline void set_Namespace(::StringW value);

  /// @brief Method set_Prefix, addr 0x5ebdf18, size 0x15c, virtual false, abstract: false, final false
  inline void set_Prefix(::StringW value);

  /// @brief Method set_ReadOnly, addr 0x5ebee5c, size 0xf8, virtual false, abstract: false, final false
  inline void set_ReadOnly(bool value);

  /// @brief Method set_SimpleType, addr 0x5ebb890, size 0x3c, virtual false, abstract: false, final false
  inline void set_SimpleType(::System::Data::SimpleType* value);

  /// @brief Method set_Unique, addr 0x5ec0380, size 0x410, virtual false, abstract: false, final false
  inline void set_Unique(bool value);

  /// @brief Method set_XmlDataType, addr 0x5ec082c, size 0x8, virtual false, abstract: false, final false
