...
// Write type traits
MARK_REF_T(::System::Data::OperatorInfo*);
DEFINE_IL2CPP_CLASS(::System::Data::OperatorInfo*, "System.Data", "OperatorInfo");
...
public:
  ...
  /// @brief Method .ctor, addr 0x603b8cc, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::OperatorInfo) == 0x20, "Size mismatch!");
