...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x4166a50, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4166a2c, size 0x24, virtual false, abstract: false, final false
