...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x415da20, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x415d9fc, size 0x24, virtual false, abstract: false, final false
