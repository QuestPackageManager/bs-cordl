...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x5ede010, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5eddfec, size 0x24, virtual false, abstract: false, final false
