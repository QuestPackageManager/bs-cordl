...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x415adc8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x415ada4, size 0x24, virtual false, abstract: false, final false
