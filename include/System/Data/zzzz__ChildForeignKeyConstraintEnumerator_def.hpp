...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x5e6b944, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6b920, size 0x24, virtual false, abstract: false, final false
