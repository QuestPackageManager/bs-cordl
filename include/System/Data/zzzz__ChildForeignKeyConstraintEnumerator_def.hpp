...
// Write type traits
MARK_REF_T(::System::Data::ChildForeignKeyConstraintEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Data::ChildForeignKeyConstraintEnumerator*, "System.Data", "ChildForeignKeyConstraintEnumerator");
...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x602049c, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6020478, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChildForeignKeyConstraintEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChildForeignKeyConstraintEnumerator(ChildForeignKeyConstraintEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChildForeignKeyConstraintEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChildForeignKeyConstraintEnumerator(ChildForeignKeyConstraintEnumeratorconst&) = delete;
...
static_assert(sizeof(::System::Data::ChildForeignKeyConstraintEnumerator) == 0x30, "Size mismatch!");
