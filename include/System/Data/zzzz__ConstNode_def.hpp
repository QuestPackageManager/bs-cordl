...
public:
  ...
  /// @brief Method Bind, addr 0x417a6a4, size 0x8, virtual true, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method Eval, addr 0x417a6ac, size 0x8, virtual true, abstract: false, final false
  inline ::System::Object* Eval();

  /// @brief Method Eval, addr 0x417a6c0, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::ArrayW<int32_t, ::Array<int32_t>*> recordNos);

  /// @brief Method Eval, addr 0x417a6b4, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method HasLocalAggregate, addr 0x417a6dc, size 0x8, virtual true, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x417a6e4, size 0x8, virtual true, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method IsConstant, addr 0x417a6cc, size 0x8, virtual true, abstract: false, final false
  inline bool IsConstant();

  /// @brief Method IsTableConstant, addr 0x417a6d4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Optimize, addr 0x417a6ec, size 0x4, virtual true, abstract: false, final false
  inline ::System::Data::ExpressionNode* Optimize();

  /// @brief Method SmallestDecimal, addr 0x417a214, size 0x490, virtual false, abstract: false, final false
  inline ::System::Object* SmallestDecimal(::System::Object* constant);

  /// @brief Method SmallestNumeric, addr 0x4179be4, size 0x630, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4179bdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::System::Data::ValueType type, ::System::Object* constant);

  /// @brief Method .ctor, addr 0x4176fb0, size 0x2e4, virtual false, abstract: false, final false
