...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6020844, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60206fc, size 0x148, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataColumnChangeEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataColumnChangeEventHandler(DataColumnChangeEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataColumnChangeEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataColumnChangeEventHandler(DataColumnChangeEventHandlerconst&) = delete;
