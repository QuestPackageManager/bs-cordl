...
public:
  ...
  /// @brief Method Bind, addr 0x417e370, size 0xe8, virtual false, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table);

  /// @brief Method DependsOn, addr 0x4173fa4, size 0x1c, virtual false, abstract: false, final false
  inline bool DependsOn(::System::Data::DataColumn* column);

  /// @brief Method Evaluate, addr 0x417e4b8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Object* Evaluate();

  /// @brief Method Evaluate, addr 0x417e4c4, size 0x1f4, virtual false, abstract: false, final false
  inline ::System::Object* Evaluate(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method GetDependency, addr 0x417e8b4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> GetDependency();

  /// @brief Method HasLocalAggregate, addr 0x417e92c, size 0x18, virtual false, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x417e944, size 0x18, virtual false, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method Invoke, addr 0x417e744, size 0xdc, virtual true, abstract: false, final true
  inline bool Invoke(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method IsTableAggregate, addr 0x417e8bc, size 0x18, virtual false, abstract: false, final false
  inline bool IsTableAggregate();

  /// @brief Method IsUnknown, addr 0x417e8d4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBoolean, addr 0x417b040, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4171944, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::StringW expression);

  /// @brief Method .ctor, addr 0x417d348, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::StringW expression, ::System::Type* type);

  /// @brief Method get_Expression, addr 0x417e458, size 0x50, virtual false, abstract: false, final false
  inline ::StringW get_Expression();

  /// @brief Method get_HasValue, addr 0x417e4a8, size 0x10, virtual false, abstract: false, final false
