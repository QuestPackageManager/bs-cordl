...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Data::DataTableNewRowEventHandler::*)(::System::Object*, ::System::IntPtr)>(
    &::System::Data::DataTableNewRowEventHandler::_ctor)> {
  constexpr static std::size_t size = 0x148;
  constexpr static std::size_t addrs = 0x602b83c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Data::DataTableNewRowEventHandler*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Data::DataTableNewRowEventHandler::*)(::System::Object*, ::System::Data::DataTableNewRowEventArgs*)>(
    &::System::Data::DataTableNewRowEventHandler::Invoke)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x602b984;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Data::DataTableNewRowEventHandler*>(), { ::i2c::class_of<::System::Data::DataTableNewRowEventHandler*>(), 13 }));
    return ___internal_method;
  }
};
inline void System::Data::DataTableNewRowEventHandler::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::System::Data::DataTableNewRowEventHandler*>(), { ".ctor", {}, { ::i2c::type_of<::System::Object*>(), ::i2c::type_of<::System::IntPtr>() } })));
...
inline void System::Data::DataTableNewRowEventHandler::Invoke(::System::Object* sender, ::System::Data::DataTableNewRowEventArgs* e) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Data::DataTableNewRowEventHandler*>(), 13 })));
