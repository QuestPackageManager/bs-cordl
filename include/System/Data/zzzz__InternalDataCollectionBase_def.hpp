...
/// @brief Method CopyTo, addr 0x5edb33c, size 0x48, virtual true, abstract: false, final false
inline void CopyTo(::System::Array*  ar, int32_t  index) ;

/// @brief Method GetEnumerator, addr 0x5edb384, size 0x2c, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method NamesEqual, addr 0x5edb3b8, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5edb468, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::ComponentModel::CollectionChangeEventArgs* getStaticF_s_refreshEventArgs() ;

/// @brief Method get_Count, addr 0x5edb310, size 0x2c, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsSynchronized, addr 0x5edb3b0, size 0x8, virtual true, abstract: false, final true
inline bool get_IsSynchronized() ;

/// @brief Method get_List, addr 0x5edb460, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method get_SyncRoot, addr 0x5edb45c, size 0x4, virtual true, abstract: false, final true
