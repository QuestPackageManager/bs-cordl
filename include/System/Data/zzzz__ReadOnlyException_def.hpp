...
public:
  ...
  /// @brief Method .ctor, addr 0x6005750, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6005748, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x60057b0, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReadOnlyException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReadOnlyException(ReadOnlyException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReadOnlyException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReadOnlyException(ReadOnlyExceptionconst&) = delete;
