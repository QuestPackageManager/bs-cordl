...
public:
  ...
  /// @brief Method AddCache, addr 0x416fe44, size 0x48, virtual false, abstract: false, final false
  inline void AddCache(::System::Data::DataRelation* relation);

  /// @brief Method AddCore, addr 0x416fe8c, size 0xc0, virtual true, abstract: false, final false
  inline void AddCore(::System::Data::DataRelation* relation);

  /// @brief Method EnsureDataSet, addr 0x416fab8, size 0x44, virtual false, abstract: false, final false
  inline void EnsureDataSet();

  /// @brief Method GetDataSet, addr 0x416fafc, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveCache, addr 0x416ff4c, size 0xd4, virtual false, abstract: false, final false
  inline void RemoveCache(::System::Data::DataRelation* relation);

  /// @brief Method RemoveCore, addr 0x4170020, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x416fa0c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, bool fParentCollection);

  /// @brief Method add_RelationPropertyChanged, addr 0x416fd0c, size 0x9c, virtual false, abstract: false, final false
  inline void add_RelationPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler* value);

  /// @brief Method get_Item, addr 0x416fb20, size 0x100, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x416fc20, size 0xec, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(::StringW name);

  /// @brief Method get_List, addr 0x416fab0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::ArrayList* get_List();

  /// @brief Method remove_RelationPropertyChanged, addr 0x416fda8, size 0x9c, virtual false, abstract: false, final false
