...
public:
  ...
  /// @brief Method GetDataView, addr 0x6031300, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  DataViewManagerListItemTypeDescriptor(DataViewManagerListItemTypeDescriptorconst&) = delete;
...
static_assert(sizeof(::System::Data::DataViewManagerListItemTypeDescriptor) == 0x18, "Size mismatch!");
