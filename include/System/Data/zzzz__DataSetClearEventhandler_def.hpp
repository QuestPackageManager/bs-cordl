...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x602e500, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x602e3b8, size 0x148, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataSetClearEventhandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataSetClearEventhandler(DataSetClearEventhandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataSetClearEventhandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataSetClearEventhandler(DataSetClearEventhandlerconst&) = delete;
