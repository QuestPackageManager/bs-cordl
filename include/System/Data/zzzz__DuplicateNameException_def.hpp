...
// Write type traits
MARK_REF_T(::System::Data::DuplicateNameException*);
DEFINE_IL2CPP_CLASS(::System::Data::DuplicateNameException*, "System.Data", "DuplicateNameException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6005520, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6005518, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x6005580, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DuplicateNameException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DuplicateNameException(DuplicateNameException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DuplicateNameException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DuplicateNameException(DuplicateNameExceptionconst&) = delete;
...
static_assert(sizeof(::System::Data::DuplicateNameException) == 0x90, "Size mismatch!");
