...
public:
  ...
  /// @brief Method CompareTo, addr 0x41a0bf8, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x41a0bcc, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddTablesToList, addr 0x419f4fc, size 0x20c, virtual false, abstract: false, final false
  inline void AddTablesToList(::System::Collections::Generic::List_1<::System::Data::DataTable*>* tableList, ::System::Data::DataTable* dt);

  /// @brief Method BuildKey, addr 0x419be7c, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CollectElementsAnnotations, addr 0x4190abc, size 0x88, virtual false, abstract: false, final false
  inline void CollectElementsAnnotations(::System::Xml::Schema::XmlSchema* schema);

  /// @brief Method CollectElementsAnnotations, addr 0x4190b44, size 0x994, virtual false, abstract: false, final false
  inline void CollectElementsAnnotations(::System::Xml::Schema::XmlSchema* schema, ::System::Collections::ArrayList* schemaList);

  /// @brief Method DatasetElementCount, addr 0x4193a38, size 0x240, virtual false, abstract: false, final false
  inline int32_t DatasetElementCount(::System::Xml::Schema::XmlSchemaObjectCollection* elements);

  /// @brief Method FindDatasetElement, addr 0x4193dd0, size 0x4d0, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaElement* FindDatasetElement(::System::Xml::Schema::XmlSchemaObjectCollection* elements);

  /// @brief Method FindField, addr 0x419bd00, size 0x17c, virtual false, abstract: false, final false
  inline ::System::Data::DataColumn* FindField(::System::Data::DataTable* table, ::StringW field);

  /// @brief Method FindNameType, addr 0x419f250, size 0xd4, virtual false, abstract: false, final false
  static inline ::System::Data::XSDSchema_NameType* FindNameType(::StringW name);

  /// @brief Method FindTypeNode, addr 0x4196488, size 0x2ac, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaAnnotated* FindTypeNode(::System::Xml::Schema::XmlSchemaAnnotated* node);

  /// @brief Method GetBooleanAttribute, addr 0x4193c78, size 0x158, virtual false, abstract: false, final false
  inline bool GetBooleanAttribute(::System::Xml::Schema::XmlSchemaAnnotated* element, ::StringW attrName, bool defVal);

  /// @brief Method GetInstanceName, addr 0x4192478, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW GetInstanceName(::System::Xml::Schema::XmlSchemaAnnotated* node);

  /// @brief Method GetMsdataAttribute, addr 0x41914d8, size 0x118, virtual false, abstract: false, final false
  static inline ::StringW GetMsdataAttribute(::System::Xml::Schema::XmlSchemaAnnotated* node, ::StringW ln);

  /// @brief Method GetNamespaceFromPrefix, addr 0x419f708, size 0x418, virtual false, abstract: false, final false
  inline ::StringW GetNamespaceFromPrefix(::StringW prefix);

  /// @brief Method GetParticle, addr 0x41942a0, size 0x11c, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaParticle* GetParticle(::System::Xml::Schema::XmlSchemaComplexType* ct);

  /// @brief Method GetParticleItems, addr 0x41935bc, size 0x210, virtual false, abstract: false, final false
  inline ::System::Xml::Schema::XmlSchemaObjectCollection* GetParticleItems(::System::Xml::Schema::XmlSchemaParticle* pt);

  /// @brief Method GetPrefix, addr 0x419d6fc, size 0x410, virtual false, abstract: false, final false
  inline ::StringW GetPrefix(::StringW ns);

  /// @brief Method GetStringAttribute, addr 0x4196404, size 0x84, virtual false, abstract: false, final false
  inline ::StringW GetStringAttribute(::System::Xml::Schema::XmlSchemaAnnotated* element, ::StringW attrName, ::StringW defVal);

  /// @brief Method GetTableName, addr 0x419ca6c, size 0x118, virtual false, abstract: false, final false
  inline ::StringW GetTableName(::System::Xml::Schema::XmlSchemaIdentityConstraint* key);

  /// @brief Method GetTableNamespace, addr 0x419efe4, size 0x190, virtual false, abstract: false, final false
  inline ::StringW GetTableNamespace(::System::Xml::Schema::XmlSchemaIdentityConstraint* key);

  /// @brief Method HandleAttributeColumn, addr 0x4199874, size 0x9b4, virtual false, abstract: false, final false
  inline void HandleAttributeColumn(::System::Xml::Schema::XmlSchemaAttribute* attrib, ::System::Data::DataTable* table, bool isBase);

  /// @brief Method HandleAttributeGroup, addr 0x419a228, size 0x3e8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleAttributes, addr 0x4199578, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleColumnExpression, addr 0x4191f64, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleComplexType, addr 0x419a610, size 0x5ec, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConstraint, addr 0x419cb84, size 0x438, virtual false, abstract: false, final false
  inline void HandleConstraint(::System::Xml::Schema::XmlSchemaIdentityConstraint* keyNode);

  /// @brief Method HandleDataSet, addr 0x41968ac, size 0x12d8, virtual false, abstract: false, final false
  inline void HandleDataSet(::System::Xml::Schema::XmlSchemaElement* node, bool isNewDataSet);

  /// @brief Method HandleElementColumn, addr 0x4198878, size 0xd00, virtual false, abstract: false, final false
  inline void HandleElementColumn(::System::Xml::Schema::XmlSchemaElement* elem, ::System::Data::DataTable* table, bool isBase);

  /// @brief Method HandleKeyref, addr 0x419c2c0, size 0x7ac, virtual false, abstract: false, final false
  inline void HandleKeyref(::System::Xml::Schema::XmlSchemaKeyref* keyref);

  /// @brief Method HandleParticle, addr 0x4197eb0, size 0x9c8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleRefTableProperties, addr 0x4192394, size 0xe4, virtual false, abstract: false, final false
  inline void HandleRefTableProperties(::System::Collections::ArrayList* RefTables, ::System::Xml::Schema::XmlSchemaElement* element);

  /// @brief Method HandleRelation, addr 0x4192550, size 0x840, virtual false, abstract: false, final false
  inline void HandleRelation(::System::Xml::XmlElement* node, bool fNested);

  /// @brief Method HandleRelations, addr 0x4197b84, size 0x32c, virtual false, abstract: false, final false
  inline void HandleRelations(::System::Xml::Schema::XmlSchemaAnnotation* ann, bool fNested);

  /// @brief Method HandleSimpleContentColumn, addr 0x419abfc, size 0x77c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSimpleTypeSimpleContentColumn, addr 0x419b378, size 0x988, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleTable, addr 0x4196734, size 0x178, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* HandleTable(::System::Xml::Schema::XmlSchemaElement* node);

  /// @brief Method HasAttributes, addr 0x4192d90, size 0x280, virtual false, abstract: false, final false
  inline bool HasAttributes(::System::Xml::Schema::XmlSchemaObjectCollection* attributes);

  /// @brief Method InstantiateSimpleTable, addr 0x419cfbc, size 0x740, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* InstantiateSimpleTable(::System::Xml::Schema::XmlSchemaElement* node);

  /// @brief Method InstantiateTable, addr 0x419db0c, size 0x14d8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDatasetParticle, addr 0x4193010, size 0x5ac, virtual false, abstract: false, final false
  inline bool IsDatasetParticle(::System::Xml::Schema::XmlSchemaParticle* pt);

  /// @brief Method IsTable, addr 0x41937cc, size 0x26c, virtual false, abstract: false, final false
  inline bool IsTable(::System::Xml::Schema::XmlSchemaElement* node);

  /// @brief Method IsXsdType, addr 0x419f48c, size 0x70, virtual false, abstract: false, final false
  static inline bool IsXsdType(::StringW name);

  /// @brief Method LoadSchema, addr 0x41943e0, size 0x2024, virtual false, abstract: false, final false
  inline void LoadSchema(::System::Xml::Schema::XmlSchemaSet* schemaSet, ::System::Data::DataSet* ds);

  /// @brief Method LoadSchema, addr 0x41943bc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDataType, addr 0x419f324, size 0x168, virtual false, abstract: false, final false
  inline ::System::Type* ParseDataType(::StringW dt);

  /// @brief Method QualifiedName, addr 0x41915f0, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW QualifiedName(::StringW name);

  /// @brief Method SetExtProperties, addr 0x4191bd4, size 0x390, virtual false, abstract: false, final false
  ...
  /// @brief Method SetExtProperties, addr 0x4192150, size 0x244, virtual false, abstract: false, final false
  static inline void SetExtProperties(::System::Object* instance, ::System::Xml::XmlAttributeCollection* attrs);

  /// @brief Method SetProperties, addr 0x419166c, size 0x568, virtual false, abstract: false, final false
  ...
  /// @brief Method TranslateAcceptRejectRule, addr 0x419c150, size 0x84, virtual false, abstract: false, final false
  static inline ::System::Data::AcceptRejectRule TranslateAcceptRejectRule(::StringW strRule);

  /// @brief Method TranslateRule, addr 0x419c1d4, size 0xec, virtual false, abstract: false, final false
  static inline ::System::Data::Rule TranslateRule(::StringW strRule);

  /// @brief Method XsdtoClr, addr 0x419f174, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x419fb20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::System::Data::XSDSchema_NameType*, ::Array<::System::Data::XSDSchema_NameType*>*> getStaticF_s_mapNameTypeXsd();

  /// @brief Method get_FromInference, addr 0x4190aa8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_FromInference, addr 0x4190ab0, size 0xc, virtual false, abstract: false, final false
