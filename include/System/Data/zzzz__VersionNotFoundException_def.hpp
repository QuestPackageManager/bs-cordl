...
// Write type traits
MARK_REF_T(::System::Data::VersionNotFoundException*);
DEFINE_IL2CPP_CLASS(::System::Data::VersionNotFoundException*, "System.Data", "VersionNotFoundException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6005868, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6005860, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x60058c8, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VersionNotFoundException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VersionNotFoundException(VersionNotFoundException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VersionNotFoundException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VersionNotFoundException(VersionNotFoundExceptionconst&) = delete;
...
static_assert(sizeof(::System::Data::VersionNotFoundException) == 0x90, "Size mismatch!");
