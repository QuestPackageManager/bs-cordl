...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NewDiffgramGen", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NewDiffgramGen(NewDiffgramGen&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NewDiffgramGen", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NewDiffgramGen(NewDiffgramGenconst&) = delete;
