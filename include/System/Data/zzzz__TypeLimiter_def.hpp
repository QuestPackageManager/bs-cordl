...
/// @brief Method <.ctor>b__3_0, addr 0x5e676ec, size 0x2c, virtual false, abstract: false, final false
inline bool __ctor_b__3_0(::System::Type*  type) ;

/// @brief Method .ctor, addr 0x5e676e8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Dispose, addr 0x5e6691c, size 0x120, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method IsAllowedType, addr 0x5e66094, size 0x184, virtual false, abstract: false, final false
inline bool IsAllowedType(::System::Type*  type) ;

/// @brief Method IsTypeUnconditionallyAllowed, addr 0x5e66a3c, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e664d4, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method <GetPreviouslyDeclaredDataTypes>b__10_0, addr 0x5e67770, size 0x14, virtual false, abstract: false, final false
inline ::System::Type* _GetPreviouslyDeclaredDataTypes_b__10_0(::System::Data::DataColumn*  column) ;

/// @brief Method <GetPreviouslyDeclaredDataTypes>b__11_0, addr 0x5e67784, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e6776c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Capture, addr 0x5e65f44, size 0x88, virtual false, abstract: false, final false
static inline ::System::Data::TypeLimiter* Capture() ;

/// @brief Method EnsureTypeIsAllowed, addr 0x5e65fcc, size 0xc8, virtual false, abstract: false, final false
static inline void EnsureTypeIsAllowed(::System::Type*  type, ::System::Data::TypeLimiter*  capturedLimiter) ;

/// @brief Method EnterRestrictedScope, addr 0x5e66218, size 0x108, virtual false, abstract: false, final false
static inline ::System::IDisposable* EnterRestrictedScope(::System::Data::DataSet*  dataSet) ;

/// @brief Method EnterRestrictedScope, addr 0x5e66660, size 0x108, virtual false, abstract: false, final false
static inline ::System::IDisposable* EnterRestrictedScope(::System::Data::DataTable*  dataTable) ;

/// @brief Method GetPreviouslyDeclaredDataTypes, addr 0x5e66320, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method GetPreviouslyDeclaredDataTypes, addr 0x5e66768, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e65eb0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_IsTypeLimitingDisabled, addr 0x5e65eb8, size 0x8c, virtual false, abstract: false, final false
