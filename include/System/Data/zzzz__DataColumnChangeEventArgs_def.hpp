...
public:
  ...
  /// @brief Method InitializeColumnChangeEvent, addr 0x601aed8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x601adec, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataRow* row);

  /// @brief Method .ctor, addr 0x601ae50, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataRow* row, ::System::Data::DataColumn* column, ::System::Object* value);

  /// @brief Method get_ProposedValue, addr 0x601aec8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_ProposedValue();

  /// @brief Method set_ProposedValue, addr 0x601aed0, size 0x8, virtual false, abstract: false, final false
