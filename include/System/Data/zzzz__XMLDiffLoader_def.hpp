...
public:
  ...
  /// @brief Method CreateTablesHierarchy, addr 0x41904f8, size 0x384, virtual false, abstract: false, final false
  inline void CreateTablesHierarchy(::System::Data::DataTable* dt);

  /// @brief Method GetTable, addr 0x4192118, size 0x1d4, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* GetTable(::StringW tableName, ::StringW ns);

  /// @brief Method LoadDiffGram, addr 0x418fcdc, size 0x1a4, virtual false, abstract: false, final false
  inline void LoadDiffGram(::System::Data::DataSet* ds, ::System::Xml::XmlReader* dataTextReader);

  /// @brief Method LoadDiffGram, addr 0x419087c, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessDiffs, addr 0x418fe80, size 0x2d8, virtual false, abstract: false, final false
  inline void ProcessDiffs(::System::Data::DataSet* ds, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessDiffs, addr 0x4190a74, size 0x2cc, virtual false, abstract: false, final false
  inline void ProcessDiffs(::System::Collections::ArrayList* tableList, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessErrors, addr 0x4190158, size 0x3a0, virtual false, abstract: false, final false
  inline void ProcessErrors(::System::Data::DataSet* ds, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessErrors, addr 0x4190d40, size 0x4b0, virtual false, abstract: false, final false
  inline void ProcessErrors(::System::Collections::ArrayList* dt, ::System::Xml::XmlReader* ssync);

  /// @brief Method ReadOldRowData, addr 0x4191250, size 0xec8, virtual false, abstract: false, final false
  ...
  /// @brief Method SkipWhitespaces, addr 0x41911f0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41922ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
