...
public:
  ...
  /// @brief Method CreateTablesHierarchy, addr 0x5ea21dc, size 0x358, virtual false, abstract: false, final false
  inline void CreateTablesHierarchy(::System::Data::DataTable* dt);

  /// @brief Method GetTable, addr 0x5ea3d00, size 0x1cc, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* GetTable(::StringW tableName, ::StringW ns);

  /// @brief Method LoadDiffGram, addr 0x5ea19b4, size 0x18c, virtual false, abstract: false, final false
  inline void LoadDiffGram(::System::Data::DataSet* ds, ::System::Xml::XmlReader* dataTextReader);

  /// @brief Method LoadDiffGram, addr 0x5ea2534, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessDiffs, addr 0x5ea1b40, size 0x2e8, virtual false, abstract: false, final false
  inline void ProcessDiffs(::System::Data::DataSet* ds, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessDiffs, addr 0x5ea271c, size 0x2dc, virtual false, abstract: false, final false
  inline void ProcessDiffs(::System::Collections::ArrayList* tableList, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessErrors, addr 0x5ea1e28, size 0x3b4, virtual false, abstract: false, final false
  inline void ProcessErrors(::System::Data::DataSet* ds, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessErrors, addr 0x5ea29f8, size 0x4c4, virtual false, abstract: false, final false
  inline void ProcessErrors(::System::Collections::ArrayList* dt, ::System::Xml::XmlReader* ssync);

  /// @brief Method ReadOldRowData, addr 0x5ea2f1c, size 0xde4, virtual false, abstract: false, final false
  ...
  /// @brief Method SkipWhitespaces, addr 0x5ea2ebc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ea3ecc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
