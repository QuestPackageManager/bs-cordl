...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XMLDiffLoader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XMLDiffLoader(XMLDiffLoader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XMLDiffLoader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XMLDiffLoader(XMLDiffLoaderconst&) = delete;
