...
public:
  ...
  /// @brief Method CreateTablesHierarchy, addr 0x4194994, size 0x384, virtual false, abstract: false, final false
  inline void CreateTablesHierarchy(::System::Data::DataTable* dt);

  /// @brief Method GetTable, addr 0x41965b4, size 0x1d4, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* GetTable(::StringW tableName, ::StringW ns);

  /// @brief Method LoadDiffGram, addr 0x4194178, size 0x1a4, virtual false, abstract: false, final false
  inline void LoadDiffGram(::System::Data::DataSet* ds, ::System::Xml::XmlReader* dataTextReader);

  /// @brief Method LoadDiffGram, addr 0x4194d18, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessDiffs, addr 0x419431c, size 0x2d8, virtual false, abstract: false, final false
  inline void ProcessDiffs(::System::Data::DataSet* ds, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessDiffs, addr 0x4194f10, size 0x2cc, virtual false, abstract: false, final false
  inline void ProcessDiffs(::System::Collections::ArrayList* tableList, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessErrors, addr 0x41945f4, size 0x3a0, virtual false, abstract: false, final false
  inline void ProcessErrors(::System::Data::DataSet* ds, ::System::Xml::XmlReader* ssync);

  /// @brief Method ProcessErrors, addr 0x41951dc, size 0x4b0, virtual false, abstract: false, final false
  inline void ProcessErrors(::System::Collections::ArrayList* dt, ::System::Xml::XmlReader* ssync);

  /// @brief Method ReadOldRowData, addr 0x41956ec, size 0xec8, virtual false, abstract: false, final false
  ...
  /// @brief Method SkipWhitespaces, addr 0x419568c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4196788, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
