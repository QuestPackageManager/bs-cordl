...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataTableNewRowEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataTableNewRowEventArgs(DataTableNewRowEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataTableNewRowEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataTableNewRowEventArgs(DataTableNewRowEventArgsconst&) = delete;
