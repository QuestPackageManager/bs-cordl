...
public:
  ...
  /// @brief Method Clone, addr 0x5f08d08, size 0x2dc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f08cf4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f08d00, size 0x8, virtual false, abstract: false, final false
