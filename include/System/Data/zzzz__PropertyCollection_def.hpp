...
public:
  ...
  /// @brief Method Clone, addr 0x4184910, size 0x2fc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4184900, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4184908, size 0x8, virtual false, abstract: false, final false
