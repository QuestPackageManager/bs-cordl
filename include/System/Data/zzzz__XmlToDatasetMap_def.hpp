...
public:
  ...
  /// @brief Method Equals, addr 0x41a9db8, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x41a9d98, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41a9370, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x41a9e54, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method get_Item, addr 0x41a9f64, size 0x70, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(::System::Xml::XmlReader* dataReader);

  /// @brief Method get_Item, addr 0x41aa03c, size 0x74, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(::StringW name);

  /// @brief Method get_Item, addr 0x41a9eec, size 0x78, virtual false, abstract: false, final false
  inline ::System::Object* get_Item(::System::Xml::XmlNode* node);

  /// @brief Method get_Item, addr 0x41a9fd4, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x41aa0b0, size 0x90, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddColumnSchema, addr 0x41a9510, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method AddColumnSchema, addr 0x41a97a0, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTableSchema, addr 0x41a939c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTableSchema, addr 0x41a924c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildIdentityMap, addr 0x41a7288, size 0x61c, virtual false, abstract: false, final false
  inline void BuildIdentityMap(::System::Data::DataSet* dataSet, ::System::Xml::XmlNameTable* nameTable);

  /// @brief Method BuildIdentityMap, addr 0x41a83e0, size 0x364, virtual false, abstract: false, final false
  inline void BuildIdentityMap(::System::Data::DataTable* dataTable, ::System::Xml::XmlNameTable* nameTable);

  /// @brief Method BuildIdentityMap, addr 0x41a78a4, size 0xb3c, virtual false, abstract: false, final false
  inline void BuildIdentityMap(::System::Xml::XmlNameTable* nameTable, ::System::Data::DataSet* dataSet);

  /// @brief Method BuildIdentityMap, addr 0x41a8744, size 0xb08, virtual false, abstract: false, final false
  inline void BuildIdentityMap(::System::Xml::XmlNameTable* nameTable, ::System::Data::DataTable* dataTable);

  /// @brief Method GetColumnSchema, addr 0x41a3258, size 0x1e4, virtual false, abstract: false, final false
  inline ::System::Object* GetColumnSchema(::System::Xml::XmlNode* node, bool fIgnoreNamespace);

  /// @brief Method GetColumnSchema, addr 0x41a6838, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Object* GetColumnSchema(::System::Data::DataTable* table, ::System::Xml::XmlReader* dataReader, bool fIgnoreNamespace);

  /// @brief Method GetSchemaForNode, addr 0x41a3818, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Object* GetSchemaForNode(::System::Xml::XmlNode* node, bool fIgnoreNamespace);

  /// @brief Method GetSelfAndDescendants, addr 0x41a994c, size 0x44c, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* GetSelfAndDescendants(::System::Data::DataTable* dt);

  /// @brief Method GetTableForNode, addr 0x41a587c, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* GetTableForNode(::System::Xml::XmlReader* node, bool fIgnoreNamespace);

  /// @brief Method HandleSpecialColumn, addr 0x41a9644, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMappedColumn, addr 0x41a4918, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41a37e4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataSet, ::System::Xml::XmlNameTable* nameTable);

  /// @brief Method .ctor, addr 0x41a37b0, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* dataTable, ::System::Xml::XmlNameTable* nameTable);

  /// @brief Method .ctor, addr 0x41a4ed4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Xml::XmlNameTable* nameTable, ::System::Data::DataSet* dataSet);

  /// @brief Method .ctor, addr 0x41a4f08, size 0x34, virtual false, abstract: false, final false
