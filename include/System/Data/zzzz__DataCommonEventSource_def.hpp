...
public:
  ...
  /// @brief Method EnterScope, addr 0x5edace8, size 0x68, virtual false, abstract: false, final false
  inline int64_t EnterScope(::StringW message);

  /// @brief Method ExitScope, addr 0x5edad50, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x5edacd8, size 0x10, virtual false, abstract: false, final false
  inline void Trace(::StringW message);

  /// @brief Method .ctor, addr 0x5edad60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
