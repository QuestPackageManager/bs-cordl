...
public:
  ...
  /// @brief Method EnterScope, addr 0x601795c, size 0x68, virtual false, abstract: false, final false
  inline int64_t EnterScope(::StringW message);

  /// @brief Method ExitScope, addr 0x60179c4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x601794c, size 0x10, virtual false, abstract: false, final false
  inline void Trace(::StringW message);

  /// @brief Method .ctor, addr 0x60179d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
