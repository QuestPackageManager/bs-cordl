...
public:
  ...
  /// @brief Method EnterScope, addr 0x4163688, size 0xc4, virtual false, abstract: false, final false
  inline int64_t EnterScope(::StringW message);

  /// @brief Method ExitScope, addr 0x416374c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x4163678, size 0x10, virtual false, abstract: false, final false
  inline void Trace(::StringW message);

  /// @brief Method .ctor, addr 0x416375c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
