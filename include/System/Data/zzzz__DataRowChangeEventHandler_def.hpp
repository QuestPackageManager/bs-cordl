...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x4166d00, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4166bfc, size 0x104, virtual false, abstract: false, final false
