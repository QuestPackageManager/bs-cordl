...
/// @brief Method AddCore, addr 0x5e75754, size 0x568, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method Clear, addr 0x5e75520, size 0x34, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method GetDataSet, addr 0x5e75554, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method RemoveCore, addr 0x5e75cbc, size 0x244, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e7547c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataSet) ;

/// @brief Method get_Item, addr 0x5e7555c, size 0x100, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x5e7565c, size 0xf8, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(::StringW  name) ;

/// @brief Method get_List, addr 0x5e75518, size 0x8, virtual true, abstract: false, final false
