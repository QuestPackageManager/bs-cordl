...
public:
  ...
  /// @brief Method AddCore, addr 0x2ba5cf4, size 0x574, virtual true, abstract: false, final false
  inline void AddCore(::System::Data::DataRelation* relation);

  /// @brief Method Clear, addr 0x2ba5acc, size 0x34, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method GetDataSet, addr 0x2ba5b00, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveCore, addr 0x2ba6268, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ba5a2c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataSet);

  /// @brief Method get_Item, addr 0x2ba5b08, size 0x100, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x2ba5c08, size 0xec, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(::StringW name);

  /// @brief Method get_List, addr 0x2ba5ac4, size 0x8, virtual true, abstract: false, final false
