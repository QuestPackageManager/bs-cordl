...
public:
  ...
  /// @brief Method AddCore, addr 0x5ee7760, size 0x568, virtual true, abstract: false, final false
  inline void AddCore(::System::Data::DataRelation* relation);

  /// @brief Method Clear, addr 0x5ee752c, size 0x34, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method GetDataSet, addr 0x5ee7560, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveCore, addr 0x5ee7cc8, size 0x244, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ee7488, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataSet* dataSet);

  /// @brief Method get_Item, addr 0x5ee7568, size 0x100, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x5ee7668, size 0xf8, virtual true, abstract: false, final false
  inline ::System::Data::DataRelation* get_Item(::StringW name);

  /// @brief Method get_List, addr 0x5ee7524, size 0x8, virtual true, abstract: false, final false
