...
public:
  ...
  /// @brief Method ChildRelationCollectionChanged, addr 0x5ef2cd0, size 0xc0, virtual false, abstract: false, final false
  inline void ChildRelationCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method CleanUp, addr 0x5ef2d90, size 0x18, virtual false, abstract: false, final false
  inline void CleanUp(bool updateListeners);

  /// @brief Method ColumnCollectionChanged, addr 0x5ef2e68, size 0xd0, virtual false, abstract: false, final false
  inline void ColumnCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method IndexListChanged, addr 0x5ef3014, size 0xc0, virtual false, abstract: false, final false
  inline void IndexListChanged(::System::ComponentModel::ListChangedEventArgs* e);

  /// @brief Method MaintainDataView, addr 0x5ef2f38, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParentRelationCollectionChanged, addr 0x5ef2da8, size 0xc0, virtual false, abstract: false, final false
  inline void ParentRelationCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method RegisterListChangedEvent, addr 0x5ef24a4, size 0xe0, virtual false, abstract: false, final false
  inline void RegisterListChangedEvent(::System::Data::Index* index);

  /// @brief Method RegisterListener, addr 0x5ef30d4, size 0x238, virtual false, abstract: false, final false
  inline void RegisterListener(::System::Data::DataTable* table);

  /// @brief Method RegisterMetaDataEvents, addr 0x5eef324, size 0x1e4, virtual false, abstract: false, final false
  inline void RegisterMetaDataEvents(::System::Data::DataTable* table);

  /// @brief Method UnregisterListChangedEvent, addr 0x5ef23ac, size 0xf8, virtual false, abstract: false, final false
  inline void UnregisterListChangedEvent();

  /// @brief Method UnregisterMetaDataEvents, addr 0x5ef000c, size 0x8, virtual false, abstract: false, final false
  inline void UnregisterMetaDataEvents();

  /// @brief Method UnregisterMetaDataEvents, addr 0x5ef330c, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5eef29c, size 0x88, virtual false, abstract: false, final false
