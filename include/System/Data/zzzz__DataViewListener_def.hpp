...
public:
  ...
  /// @brief Method ChildRelationCollectionChanged, addr 0x603515c, size 0xc0, virtual false, abstract: false, final false
  inline void ChildRelationCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method CleanUp, addr 0x603521c, size 0x18, virtual false, abstract: false, final false
  inline void CleanUp(bool updateListeners);

  /// @brief Method ColumnCollectionChanged, addr 0x60352f4, size 0xd0, virtual false, abstract: false, final false
  inline void ColumnCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method IndexListChanged, addr 0x60354a0, size 0xc0, virtual false, abstract: false, final false
  inline void IndexListChanged(::System::ComponentModel::ListChangedEventArgs* e);

  /// @brief Method MaintainDataView, addr 0x60353c4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParentRelationCollectionChanged, addr 0x6035234, size 0xc0, virtual false, abstract: false, final false
  inline void ParentRelationCollectionChanged(::System::Object* sender, ::System::ComponentModel::CollectionChangeEventArgs* e);

  /// @brief Method RegisterListChangedEvent, addr 0x6034930, size 0xe0, virtual false, abstract: false, final false
  inline void RegisterListChangedEvent(::System::Data::Index* index);

  /// @brief Method RegisterListener, addr 0x6035560, size 0x238, virtual false, abstract: false, final false
  inline void RegisterListener(::System::Data::DataTable* table);

  /// @brief Method RegisterMetaDataEvents, addr 0x60317b0, size 0x1e4, virtual false, abstract: false, final false
  inline void RegisterMetaDataEvents(::System::Data::DataTable* table);

  /// @brief Method UnregisterListChangedEvent, addr 0x6034838, size 0xf8, virtual false, abstract: false, final false
  inline void UnregisterListChangedEvent();

  /// @brief Method UnregisterMetaDataEvents, addr 0x6032498, size 0x8, virtual false, abstract: false, final false
  inline void UnregisterMetaDataEvents();

  /// @brief Method UnregisterMetaDataEvents, addr 0x6035798, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6031728, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  DataViewListener(DataViewListenerconst&) = delete;
