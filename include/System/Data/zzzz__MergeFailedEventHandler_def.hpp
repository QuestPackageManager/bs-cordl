...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MergeFailedEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MergeFailedEventHandler(MergeFailedEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MergeFailedEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MergeFailedEventHandler(MergeFailedEventHandlerconst&) = delete;
