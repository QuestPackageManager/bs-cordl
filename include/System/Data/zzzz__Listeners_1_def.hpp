...
// Is value type: false
// CS Name: ::Listeners`1::Action`4<TElem,T1,T2,T3,T4>*
class CORDL_TYPE __Listeners_1__Action_4 : public ::System::MulticastDelegate {
public:
  // Declarations
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __Listeners_1__Action_4();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__Listeners_1__Action_4", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __Listeners_1__Action_4(__Listeners_1__Action_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__Listeners_1__Action_4", modifiers: "const&", def_value: None }]
...
// Is value type: false
// CS Name: ::Listeners`1::Func`2<TElem,T1,TResult>*
class CORDL_TYPE __Listeners_1__Func_2 : public ::System::MulticastDelegate {
public:
  // Declarations
  /// @brief Method Invoke, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __Listeners_1__Func_2();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__Listeners_1__Func_2", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __Listeners_1__Func_2(__Listeners_1__Func_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__Listeners_1__Func_2", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
public:
  // Declarations
  template <typename T1, typename T2, typename T3, typename T4> using Action_4 = ::System::Data::__Listeners_1__Action_4<TElem, T1, T2, T3, T4>;

  template <typename T1, typename TResult> using Func_2 = ::System::Data::__Listeners_1__Func_2<TElem, T1, TResult>;
  ...
  static inline ::System::Data::Listeners_1<TElem>* New_ctor(int32_t ObjectID, ::System::Data::__Listeners_1__Func_2<TElem, TElem, bool>* notifyFilter);

  /// @brief Method Notify, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T1, typename T2, typename T3> inline void Notify(T1 arg1, T2 arg2, T3 arg3, ::System::Data::__Listeners_1__Action_4<TElem, TElem, T1, T2, T3>* action);
  ...
  constexpr ::System::Data::__Listeners_1__Func_2<TElem, TElem, bool>*& __cordl_internal_get__filter();

  constexpr ::cordl_internals::to_const_pointer<::System::Data::__Listeners_1__Func_2<TElem, TElem, bool>*> const& __cordl_internal_get__filter() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<TElem>*> const& __cordl_internal_get__listeners() const;

  constexpr int32_t const& __cordl_internal_get__objectID() const;

  constexpr int32_t& __cordl_internal_get__objectID();

  constexpr void __cordl_internal_set__filter(::System::Data::__Listeners_1__Func_2<TElem, TElem, bool>* value);
  ...
  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor(int32_t ObjectID, ::System::Data::__Listeners_1__Func_2<TElem, TElem, bool>* notifyFilter);
...
public:
  ...
  ::System::Data::__Listeners_1__Func_2<TElem, TElem, bool>* ____filter;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::System::Data::__Listeners_1__Action_4, "System.Data", "Listeners`1/Action`4");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::System::Data::__Listeners_1__Func_2, "System.Data", "Listeners`1/Func`2");
