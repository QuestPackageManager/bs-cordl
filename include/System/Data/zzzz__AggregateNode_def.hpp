...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AggregateNode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AggregateNode(AggregateNode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AggregateNode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AggregateNode(AggregateNodeconst&) = delete;
