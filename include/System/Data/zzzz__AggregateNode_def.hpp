...
// Write type traits
MARK_REF_T(::System::Data::AggregateNode*);
DEFINE_IL2CPP_CLASS(::System::Data::AggregateNode*, "System.Data", "AggregateNode");
...
public:
  ...
  /// @brief Method Bind, addr 0x6030c88, size 0x1dc, virtual false, abstract: false, final false
  static inline void Bind(::System::Data::DataRelation* relation, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method Bind, addr 0x6030908, size 0x274, virtual true, abstract: false, final false
  inline void Bind(::System::Data::DataTable* table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>* list);

  /// @brief Method DependsOn, addr 0x60312a4, size 0x48, virtual true, abstract: false, final false
  inline bool DependsOn(::System::Data::DataColumn* column);

  /// @brief Method Eval, addr 0x6030e64, size 0x14, virtual true, abstract: false, final false
  inline ::System::Object* Eval();

  /// @brief Method Eval, addr 0x60311b4, size 0x74, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::ArrayW<int32_t> records);

  /// @brief Method Eval, addr 0x6030e78, size 0x2f8, virtual true, abstract: false, final false
  inline ::System::Object* Eval(::System::Data::DataRow* row, ::System::Data::DataRowVersion version);

  /// @brief Method HasLocalAggregate, addr 0x603128c, size 0x8, virtual true, abstract: false, final false
  inline bool HasLocalAggregate();

  /// @brief Method HasRemoteAggregate, addr 0x6031294, size 0x10, virtual true, abstract: false, final false
  inline bool HasRemoteAggregate();

  /// @brief Method IsConstant, addr 0x603127c, size 0x8, virtual true, abstract: false, final false
  inline bool IsConstant();

  /// @brief Method IsTableConstant, addr 0x6031284, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Optimize, addr 0x6031308, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x60307fc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::System::Data::FunctionId aggregateType, ::StringW columnName);

  /// @brief Method .ctor, addr 0x6030808, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::AggregateNode) == 0x50, "Size mismatch!");
