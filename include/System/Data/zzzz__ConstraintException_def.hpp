...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConstraintException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConstraintException(ConstraintException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConstraintException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConstraintException(ConstraintExceptionconst&) = delete;
