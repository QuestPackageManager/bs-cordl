...
public:
  ...
  /// @brief Method MoveToFirstAttribute, addr 0x5e4bd14, size 0x114, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x5e4be28, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4bc7c, size 0x98, virtual false, abstract: false, final false
