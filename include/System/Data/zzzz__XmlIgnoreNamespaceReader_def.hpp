...
public:
  ...
  /// @brief Method MoveToFirstAttribute, addr 0x60683f8, size 0x114, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x606850c, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6068360, size 0x98, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XmlIgnoreNamespaceReader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XmlIgnoreNamespaceReader(XmlIgnoreNamespaceReader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XmlIgnoreNamespaceReader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XmlIgnoreNamespaceReader(XmlIgnoreNamespaceReaderconst&) = delete;
