...
public:
  ...
  /// @brief Method MoveToFirstAttribute, addr 0x2bf9624, size 0x110, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x2bf9734, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bf958c, size 0x98, virtual false, abstract: false, final false
