...
public:
  ...
  /// @brief Method MoveToFirstAttribute, addr 0x41a3f64, size 0x110, virtual true, abstract: false, final false
  inline bool MoveToFirstAttribute();

  /// @brief Method MoveToNextAttribute, addr 0x41a4074, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41a3ecc, size 0x98, virtual false, abstract: false, final false
