...
public:
  ...
  /// @brief Method CompareTo, addr 0x60564d4, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x60564cc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FindNameType, addr 0x6054140, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::Data::XDRSchema_NameType* FindNameType(::StringW name);

  /// @brief Method FindTypeNode, addr 0x6053214, size 0x330, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* FindTypeNode(::System::Xml::XmlElement* node);

  /// @brief Method GetInstanceName, addr 0x6054368, size 0x184, virtual false, abstract: false, final false
  inline ::StringW GetInstanceName(::System::Xml::XmlElement* node);

  /// @brief Method GetMinMax, addr 0x6054e90, size 0x354, virtual false, abstract: false, final false
  inline void GetMinMax(::System::Xml::XmlElement* elNode, bool isAttribute, ::by_ref<int32_t> minOccurs, ::by_ref<int32_t> maxOccurs);

  /// @brief Method GetMinMax, addr 0x6053868, size 0x10, virtual false, abstract: false, final false
  inline void GetMinMax(::System::Xml::XmlElement* elNode, ::by_ref<int32_t> minOccurs, ::by_ref<int32_t> maxOccurs);

  /// @brief Method HandleColumn, addr 0x60544ec, size 0x87c, virtual false, abstract: false, final false
  inline void HandleColumn(::System::Xml::XmlElement* node, ::System::Data::DataTable* table);

  /// @brief Method HandleTable, addr 0x6053040, size 0x1d4, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* HandleTable(::System::Xml::XmlElement* node);

  /// @brief Method HandleTypeNode, addr 0x60555fc, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateSimpleTable, addr 0x6053878, size 0x23c, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* InstantiateSimpleTable(::System::Data::DataSet* dataSet, ::System::Xml::XmlElement* node);

  /// @brief Method InstantiateTable, addr 0x6053ab4, size 0x68c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTextOnlyContent, addr 0x6053544, size 0x1d4, virtual false, abstract: false, final false
  inline bool IsTextOnlyContent(::System::Xml::XmlElement* node);

  /// @brief Method IsXDRField, addr 0x6053718, size 0x150, virtual false, abstract: false, final false
  inline bool IsXDRField(::System::Xml::XmlElement* node, ::System::Xml::XmlElement* typeNode);

  /// @brief Method LoadSchema, addr 0x6052dc0, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDataType, addr 0x6054218, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6052da0, size 0x1c, virtual false, abstract: false, final false
