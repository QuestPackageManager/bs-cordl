...
public:
  ...
  /// @brief Method CompareTo, addr 0x5f14048, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5f14040, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FindNameType, addr 0x5f11cb4, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::Data::XDRSchema_NameType* FindNameType(::StringW name);

  /// @brief Method FindTypeNode, addr 0x5f10d88, size 0x330, virtual false, abstract: false, final false
  inline ::System::Xml::XmlElement* FindTypeNode(::System::Xml::XmlElement* node);

  /// @brief Method GetInstanceName, addr 0x5f11edc, size 0x184, virtual false, abstract: false, final false
  inline ::StringW GetInstanceName(::System::Xml::XmlElement* node);

  /// @brief Method GetMinMax, addr 0x5f12a04, size 0x354, virtual false, abstract: false, final false
  inline void GetMinMax(::System::Xml::XmlElement* elNode, bool isAttribute, ::ByRef<int32_t> minOccurs, ::ByRef<int32_t> maxOccurs);

  /// @brief Method GetMinMax, addr 0x5f113dc, size 0x10, virtual false, abstract: false, final false
  inline void GetMinMax(::System::Xml::XmlElement* elNode, ::ByRef<int32_t> minOccurs, ::ByRef<int32_t> maxOccurs);

  /// @brief Method HandleColumn, addr 0x5f12060, size 0x87c, virtual false, abstract: false, final false
  inline void HandleColumn(::System::Xml::XmlElement* node, ::System::Data::DataTable* table);

  /// @brief Method HandleTable, addr 0x5f10bb4, size 0x1d4, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* HandleTable(::System::Xml::XmlElement* node);

  /// @brief Method HandleTypeNode, addr 0x5f13170, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateSimpleTable, addr 0x5f113ec, size 0x23c, virtual false, abstract: false, final false
  inline ::System::Data::DataTable* InstantiateSimpleTable(::System::Data::DataSet* dataSet, ::System::Xml::XmlElement* node);

  /// @brief Method InstantiateTable, addr 0x5f11628, size 0x68c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTextOnlyContent, addr 0x5f110b8, size 0x1d4, virtual false, abstract: false, final false
  inline bool IsTextOnlyContent(::System::Xml::XmlElement* node);

  /// @brief Method IsXDRField, addr 0x5f1128c, size 0x150, virtual false, abstract: false, final false
  inline bool IsXDRField(::System::Xml::XmlElement* node, ::System::Xml::XmlElement* typeNode);

  /// @brief Method LoadSchema, addr 0x5f10934, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDataType, addr 0x5f11d8c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f10914, size 0x1c, virtual false, abstract: false, final false
