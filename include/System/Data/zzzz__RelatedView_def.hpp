...
public:
  ...
  /// @brief Method AddNew, addr 0x4185b38, size 0x60, virtual true, abstract: false, final false
  inline ::System::Data::DataRowView* AddNew();

  /// @brief Method GetFilter, addr 0x4185b34, size 0x4, virtual true, abstract: false, final false
  inline ::System::Data::IFilter* GetFilter();

  /// @brief Method GetParentValues, addr 0x4185914, size 0x98, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetParentValues();

  /// @brief Method Invoke, addr 0x41859ac, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method SetIndex, addr 0x4185b98, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41856f4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x418580c, size 0x108, virtual false, abstract: false, final false
