...
// Write type traits
MARK_REF_T(::System::Data::InRowChangingEventException*);
DEFINE_IL2CPP_CLASS(::System::Data::InRowChangingEventException*, "System.Data", "InRowChangingEventException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x60055ac, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x60055a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x600560c, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InRowChangingEventException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InRowChangingEventException(InRowChangingEventException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InRowChangingEventException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InRowChangingEventException(InRowChangingEventExceptionconst&) = delete;
...
static_assert(sizeof(::System::Data::InRowChangingEventException) == 0x90, "Size mismatch!");
