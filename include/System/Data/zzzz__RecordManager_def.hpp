...
public:
  ...
  /// @brief Method Clear, addr 0x2bdd8b0, size 0x1f0, virtual false, abstract: false, final false
  inline void Clear(bool clearAll);

  /// @brief Method CopyRecord, addr 0x2bddad8, size 0x314, virtual false, abstract: false, final false
  inline int32_t CopyRecord(::System::Data::DataTable* src, int32_t record, int32_t copy);

  /// @brief Method FreeRecord, addr 0x2bdd6f8, size 0x154, virtual false, abstract: false, final false
  inline void FreeRecord(ByRef<int32_t> record);

  /// @brief Method GrowRecordCapacity, addr 0x2bdd3b8, size 0x13c, virtual false, abstract: false, final false
  inline void GrowRecordCapacity();

  /// @brief Method ImportRecord, addr 0x2bddad0, size 0x8, virtual false, abstract: false, final false
  inline int32_t ImportRecord(::System::Data::DataTable* src, int32_t record);

  /// @brief Method NewCapacity, addr 0x2bdd4f4, size 0x14, virtual false, abstract: false, final false
  static inline int32_t NewCapacity(int32_t capacity);

  /// @brief Method NewRecordBase, addr 0x2bdd62c, size 0xcc, virtual false, abstract: false, final false
  inline int32_t NewRecordBase();

  static inline ::System::Data::RecordManager* New_ctor(::System::Data::DataTable* table);

  /// @brief Method NormalizedMinimumCapacity, addr 0x2bdd508, size 0x38, virtual false, abstract: false, final false
  inline int32_t NormalizedMinimumCapacity(int32_t capacity);

  /// @brief Method SetRowCache, addr 0x2bdddec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bdd2ec, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table);

  /// @brief Method get_Item, addr 0x2bddaa0, size 0x30, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* get_Item(int32_t record);

  /// @brief Method get_LastFreeRecord, addr 0x2bdd5d0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LastFreeRecord();

  /// @brief Method get_MinimumCapacity, addr 0x2bdd5d8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MinimumCapacity();

  /// @brief Method get_RecordCapacity, addr 0x2bdd624, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RecordCapacity();

  /// @brief Method set_Item, addr 0x2bdd84c, size 0x64, virtual false, abstract: false, final false
  inline void set_Item(int32_t record, ::System::Data::DataRow* value);

  /// @brief Method set_MinimumCapacity, addr 0x2bdd5e0, size 0x44, virtual false, abstract: false, final false
  inline void set_MinimumCapacity(int32_t value);

  /// @brief Method set_RecordCapacity, addr 0x2bdd540, size 0x90, virtual false, abstract: false, final false
