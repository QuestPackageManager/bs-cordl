...
public:
  ...
  /// @brief Method CreateChildView, addr 0x2ba870c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataView* CreateChildView(::System::Data::DataRelation* relation);

  /// @brief Method CreateChildView, addr 0x2baca0c, size 0x1b8, virtual false, abstract: false, final false
  inline ::System::Data::DataView* CreateChildView(::System::Data::DataRelation* relation, bool followParent);

  /// @brief Method EndEdit, addr 0x2bacdec, size 0x48, virtual true, abstract: false, final true
  inline void EndEdit();

  /// @brief Method Equals, addr 0x2bac878, size 0xc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetColumnValue, addr 0x2bac94c, size 0x34, virtual false, abstract: false, final false
  inline ::System::Object* GetColumnValue(::System::Data::DataColumn* column);

  /// @brief Method GetHashCode, addr 0x2bac884, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetRecord, addr 0x2bac904, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetRecord();

  /// @brief Method HasRecord, addr 0x2bac928, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method RaisePropertyChangedEvent, addr 0x2bacff4, size 0x98, virtual false, abstract: false, final false
  inline void RaisePropertyChangedEvent(::StringW propName);

  /// @brief Method SetColumnValue, addr 0x2bac980, size 0x8c, virtual false, abstract: false, final false
  inline void SetColumnValue(::System::Data::DataColumn* column, ::System::Object* value);

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetAttributes, addr 0x2bad08c, size 0x60, virtual true, abstract: false, final true
  inline ::System::ComponentModel::AttributeCollection* System_ComponentModel_ICustomTypeDescriptor_GetAttributes();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetClassName, addr 0x2bad0ec, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_ComponentModel_ICustomTypeDescriptor_GetClassName();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetComponentName, addr 0x2bad0f4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_ComponentModel_ICustomTypeDescriptor_GetComponentName();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetConverter, addr 0x2bad0fc, size 0x8, virtual true, abstract: false, final true
  inline ::System::ComponentModel::TypeConverter* System_ComponentModel_ICustomTypeDescriptor_GetConverter();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetDefaultEvent, addr 0x2bad104, size 0x8, virtual true, abstract: false, final true
  inline ::System::ComponentModel::EventDescriptor* System_ComponentModel_ICustomTypeDescriptor_GetDefaultEvent();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetDefaultProperty, addr 0x2bad10c, size 0x8, virtual true, abstract: false, final true
  inline ::System::ComponentModel::PropertyDescriptor* System_ComponentModel_ICustomTypeDescriptor_GetDefaultProperty();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetEditor, addr 0x2bad114, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_ComponentModel_ICustomTypeDescriptor_GetEditor(::System::Type* editorBaseType);

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetEvents, addr 0x2bad11c, size 0x60, virtual true, abstract: false, final true
  inline ::System::ComponentModel::EventDescriptorCollection* System_ComponentModel_ICustomTypeDescriptor_GetEvents();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetEvents, addr 0x2bad17c, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetProperties, addr 0x2bad1dc, size 0x9c, virtual true, abstract: false, final true
  inline ::System::ComponentModel::PropertyDescriptorCollection* System_ComponentModel_ICustomTypeDescriptor_GetProperties();

  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetProperties, addr 0x2bad278, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetPropertyOwner, addr 0x2bad300, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2bac84c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DataView, addr 0x2bac8a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataView* get_DataView();

  /// @brief Method get_IsNew, addr 0x2bace34, size 0x28, virtual false, abstract: false, final false
  inline bool get_IsNew();

  /// @brief Method get_Row, addr 0x2bacde4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Data::DataRow* get_Row();

  /// @brief Method get_RowVersionDefault, addr 0x2bac8ac, size 0x58, virtual false, abstract: false, final false
