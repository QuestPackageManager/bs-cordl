...
public:
  ...
  /// @brief Method Remove, addr 0x5ef3848, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x5ef36a4, size 0x124, virtual true, abstract: false, final false
  inline ::System::Data::DataViewSetting* get_Item(::System::Data::DataTable* table);

  /// @brief Method set_Item, addr 0x5ef37c8, size 0x80, virtual true, abstract: false, final false
