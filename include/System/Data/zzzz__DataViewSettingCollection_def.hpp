...
public:
  ...
  /// @brief Method Remove, addr 0x2bbf610, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x2bbf48c, size 0x104, virtual true, abstract: false, final false
  inline ::System::Data::DataViewSetting* get_Item(::System::Data::DataTable* table);

  /// @brief Method set_Item, addr 0x2bbf590, size 0x80, virtual true, abstract: false, final false
