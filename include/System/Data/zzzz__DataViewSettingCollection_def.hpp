...
public:
  ...
  /// @brief Method Remove, addr 0x416ebd4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x416ea5c, size 0xf8, virtual true, abstract: false, final false
  inline ::System::Data::DataViewSetting* get_Item(::System::Data::DataTable* table);

  /// @brief Method set_Item, addr 0x416eb54, size 0x80, virtual true, abstract: false, final false
