...
public:
  ...
  /// @brief Method Remove, addr 0x417c118, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x417bfa0, size 0xf8, virtual true, abstract: false, final false
  inline ::System::Data::DataViewSetting* get_Item(::System::Data::DataTable* table);

  /// @brief Method set_Item, addr 0x417c098, size 0x80, virtual true, abstract: false, final false
