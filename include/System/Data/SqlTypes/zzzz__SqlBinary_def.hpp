...
public:
  ...
  /// @brief Method CompareTo, addr 0x5f41f70, size 0x150, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Data::SqlTypes::SqlBinary value);

  /// @brief Method CompareTo, addr 0x5f41e70, size 0x100, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method Equals, addr 0x5f42120, size 0x128, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5f422fc, size 0xbc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetXsdType, addr 0x5f426f8, size 0x90, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method HashByteArray, addr 0x5f4229c, size 0x60, virtual false, abstract: false, final false
  static inline int32_t HashByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbValue, int32_t length);

  /// @brief Method PerformCompareByte, addr 0x5f41a30, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x5f423b8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x5f423c0, size 0x1c4, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x5f42584, size 0x174, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ToString, addr 0x5f418fc, size 0x134, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5f41764, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool fNull);

  /// @brief Method .ctor, addr 0x5f4176c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  static inline ::System::Data::SqlTypes::SqlBinary getStaticF_Null();

  /// @brief Method get_IsNull, addr 0x5f417f4, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Value, addr 0x5f41804, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5f41b50, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method op_GreaterThan, addr 0x5f41d6c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x5f418e0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_LessThan, addr 0x5f41c68, size 0x104, virtual false, abstract: false, final false
