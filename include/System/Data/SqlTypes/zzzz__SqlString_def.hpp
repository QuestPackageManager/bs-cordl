...
public:
  ...
  /// @brief Method Compare, addr 0x41d3004, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareBinary, addr 0x41d2c1c, size 0x1c8, virtual false, abstract: false, final false
  static inline int32_t CompareBinary(::System::Data::SqlTypes::SqlString x, ::System::Data::SqlTypes::SqlString y);

  /// @brief Method CompareBinary2, addr 0x41d2de4, size 0x178, virtual false, abstract: false, final false
  static inline int32_t CompareBinary2(::System::Data::SqlTypes::SqlString x, ::System::Data::SqlTypes::SqlString y);

  /// @brief Method CompareOptionsFromSqlCompareOptions, addr 0x41d2f5c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTo, addr 0x41d338c, size 0x100, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Data::SqlTypes::SqlString value);

  /// @brief Method CompareTo, addr 0x41d3274, size 0x118, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method Equals, addr 0x41d348c, size 0x1bc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FBinarySort, addr 0x41d3208, size 0x6c, virtual false, abstract: false, final false
  inline bool FBinarySort();

  /// @brief Method GetHashCode, addr 0x41d3648, size 0x220, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetXsdType, addr 0x41d3a60, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method SetCompareInfo, addr 0x41d27a0, size 0x80, virtual false, abstract: false, final false
  inline void SetCompareInfo();

  /// @brief Method StringCompare, addr 0x41d29e8, size 0x234, virtual false, abstract: false, final false
  static inline int32_t StringCompare(::System::Data::SqlTypes::SqlString x, ::System::Data::SqlTypes::SqlString y);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x41d3868, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x41d3870, size 0xf4, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x41d3964, size 0xfc, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ToString, addr 0x41d2834, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateSqlCompareOptions, addr 0x41d25a4, size 0xac, virtual false, abstract: false, final false
  static inline void ValidateSqlCompareOptions(::System::Data::SqlTypes::SqlCompareOptions compareOptions);

  /// @brief Method .ctor, addr 0x41d2650, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::StringW data);

  /// @brief Method .ctor, addr 0x41d2518, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW data, int32_t lcid, ::System::Data::SqlTypes::SqlCompareOptions compareOptions);

  /// @brief Method .ctor, addr 0x41d2508, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(bool fNull);

  /// @brief Method .ctor, addr 0x41d270c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsNull, addr 0x41c03dc, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Value, addr 0x41c03ec, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x41d28a0, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x41d3170, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x41d2820, size 0x14, virtual false, abstract: false, final false
