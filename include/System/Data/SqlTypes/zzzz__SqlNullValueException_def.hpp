...
public:
  ...
  /// @brief Method SqlNullValueExceptionSerialization, addr 0x2c29da8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c17d54, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2c29d20, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2c29cfc, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x2c29d48, size 0x60, virtual false, abstract: false, final false
