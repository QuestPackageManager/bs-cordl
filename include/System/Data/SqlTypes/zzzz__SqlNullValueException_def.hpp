...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SqlNullValueException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SqlNullValueException(SqlNullValueException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SqlNullValueException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SqlNullValueException(SqlNullValueExceptionconst&) = delete;
