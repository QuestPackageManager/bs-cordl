...
public:
  ...
  /// @brief Method SqlNullValueExceptionSerialization, addr 0x5ee6be4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ed0e64, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5ee6b5c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5ee6b38, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x5ee6b84, size 0x60, virtual false, abstract: false, final false
