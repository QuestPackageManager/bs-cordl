...
public:
  ...
  /// @brief Method CompareTo, addr 0x6088ea0, size 0x180, virtual false, abstract: false, final false
  inline int32_t CompareTo(::System::Data::SqlTypes::SqlDateTime value);

  /// @brief Method CompareTo, addr 0x6088d98, size 0x108, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method Equals, addr 0x6089020, size 0x144, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method FromDateTime, addr 0x60881fc, size 0xfc, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDateTime FromDateTime(::System::DateTime value);

  /// @brief Method FromTimeSpan, addr 0x6088590, size 0x1f4, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDateTime FromTimeSpan(::System::TimeSpan value);

  /// @brief Method GetHashCode, addr 0x6089164, size 0xc0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetXsdType, addr 0x60895e0, size 0x90, virtual false, abstract: false, final false
  static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet* schemaSet);

  /// @brief Method GreaterThan, addr 0x6088d18, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method LessThan, addr 0x6088c98, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x6089224, size 0x8, virtual true, abstract: false, final true
  inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema();

  /// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x608922c, size 0x210, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader* reader);

  /// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x608943c, size 0x1a4, virtual true, abstract: false, final true
  inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter* writer);

  /// @brief Method ToDateTime, addr 0x60884e0, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::DateTime ToDateTime(::System::Data::SqlTypes::SqlDateTime value);

  /// @brief Method ToString, addr 0x60888d8, size 0x100, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToTimeSpan, addr 0x6088434, size 0xac, virtual false, abstract: false, final false
  static inline ::System::TimeSpan ToTimeSpan(::System::Data::SqlTypes::SqlDateTime value);

  /// @brief Method .ctor, addr 0x60882f8, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(int32_t dayTicks, int32_t timeTicks);

  /// @brief Method .ctor, addr 0x6088180, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool fNull);

  /// @brief Method .ctor, addr 0x608818c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DayTicks, addr 0x6088820, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_DayTicks();

  /// @brief Method get_IsNull, addr 0x6088424, size 0x10, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_TimeTicks, addr 0x6088864, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_TimeTicks();

  /// @brief Method get_Value, addr 0x6088784, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x60889d8, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_GreaterThan, addr 0x6088ba8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x60888a8, size 0x30, virtual false, abstract: false, final false
  static inline ::System::Data::SqlTypes::SqlDateTime op_Implicit___System__Data__SqlTypes__SqlDateTime(::System::DateTime value);

  /// @brief Method op_LessThan, addr 0x6088ab8, size 0xf0, virtual false, abstract: false, final false
