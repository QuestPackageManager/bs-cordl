...
public:
  ...
  /// @brief Method SqlTypeExceptionSerialization, addr 0x41e2b58, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41e2a84, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x41ced2c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x41e2ae4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x41e2b08, size 0x50, virtual false, abstract: false, final false
