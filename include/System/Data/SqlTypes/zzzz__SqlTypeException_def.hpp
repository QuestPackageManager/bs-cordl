...
public:
  ...
  /// @brief Method SqlTypeExceptionSerialization, addr 0x2d49c0c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d49b38, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2d37f5c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2d49b98, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x2d49bbc, size 0x50, virtual false, abstract: false, final false
