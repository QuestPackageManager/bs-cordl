...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SqlTypeException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SqlTypeException(SqlTypeException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SqlTypeException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SqlTypeException(SqlTypeExceptionconst&) = delete;
