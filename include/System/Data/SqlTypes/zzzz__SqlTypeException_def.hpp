...
/// @brief Method SqlTypeExceptionSerialization, addr 0x5ee711c, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ee7044, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5ed2eac, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x5ee70a8, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  e) ;

/// @brief Method .ctor, addr 0x5ee70cc, size 0x50, virtual false, abstract: false, final false
