...
public:
  ...
  /// @brief Method SqlTruncateExceptionSerialization, addr 0x2d5d930, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d525f8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2d5d8a8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2d5d884, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x2d5d8d0, size 0x60, virtual false, abstract: false, final false
