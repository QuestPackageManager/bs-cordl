...
public:
  ...
  /// @brief Method SqlTruncateExceptionSerialization, addr 0x5ee6d6c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ed9e3c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5ee6ce4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5ee6cc0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x5ee6d0c, size 0x60, virtual false, abstract: false, final false
