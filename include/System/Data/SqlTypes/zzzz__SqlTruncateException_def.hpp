...
public:
  ...
  /// @brief Method SqlTruncateExceptionSerialization, addr 0x41d71d0, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41ca3ec, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x41d7148, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x41d7124, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x41d7170, size 0x60, virtual false, abstract: false, final false
