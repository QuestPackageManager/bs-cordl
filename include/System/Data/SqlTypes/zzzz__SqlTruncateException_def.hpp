...
public:
  ...
  /// @brief Method SqlTruncateExceptionSerialization, addr 0x415e540, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x415175c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x415e4b8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x415e494, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor, addr 0x415e4e0, size 0x60, virtual false, abstract: false, final false
