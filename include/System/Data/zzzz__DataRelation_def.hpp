...
public:
  ...
  /// @brief Method CheckNamespaceValidityForNestedRelations, addr 0x415e4b4, size 0x3a4, virtual false, abstract: false, final false
  inline void CheckNamespaceValidityForNestedRelations(::StringW ns);

  /// @brief Method CheckNestedRelations, addr 0x415e858, size 0x410, virtual false, abstract: false, final false
  inline void CheckNestedRelations();

  /// @brief Method CheckState, addr 0x41603fc, size 0x23c, virtual false, abstract: false, final false
  inline void CheckState();

  /// @brief Method CheckStateForProperty, addr 0x415df18, size 0xec, virtual false, abstract: false, final false
  inline void CheckStateForProperty();

  /// @brief Method Clone, addr 0x4160638, size 0x650, virtual false, abstract: false, final false
  inline ::System::Data::DataRelation* Clone(::System::Data::DataSet* destination);

  /// @brief Method Create, addr 0x415d970, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildRows, addr 0x415e120, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentRow, addr 0x415e274, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentRows, addr 0x415e1dc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAutoGenerated, addr 0x4160e6c, size 0x1d4, virtual false, abstract: false, final false
  inline bool IsAutoGenerated(::System::Data::DataColumn* col);

  /// @brief Method IsKeyNull, addr 0x415e05c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPropertyChanging, addr 0x4160d90, size 0xd0, virtual false, abstract: false, final false
  inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs* pcevent);

  /// @brief Method RaisePropertyChanging, addr 0x41601fc, size 0x6c, virtual false, abstract: false, final false
  inline void RaisePropertyChanging(::StringW name);

  /// @brief Method SetChildKeyConstraint, addr 0x41603f4, size 0x8, virtual false, abstract: false, final false
  inline void SetChildKeyConstraint(::System::Data::ForeignKeyConstraint* value);

  /// @brief Method SetDataSet, addr 0x415e450, size 0x14, virtual false, abstract: false, final false
  inline void SetDataSet(::System::Data::DataSet* dataSet);

  /// @brief Method SetParentKeyConstraint, addr 0x416035c, size 0x8, virtual false, abstract: false, final false
  inline void SetParentKeyConstraint(::System::Data::UniqueConstraint* value);

  /// @brief Method ToString, addr 0x4160e60, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateMultipleNestedRelations, addr 0x415fd2c, size 0x4d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x415d778, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x415dc6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW relationName, ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> parentColumns,
                    ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> childColumns);

  /// @brief Method .ctor, addr 0x415dc74, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::StringW relationName, ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> parentColumns,
                    ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> childColumns, bool createConstraints);

  /// @brief Method .ctor, addr 0x415dd3c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x415de14, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CheckMultipleNested, addr 0x41603e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_CheckMultipleNested();

  /// @brief Method get_ChildColumnNames, addr 0x415e054, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ChildColumnNames();

  /// @brief Method get_ChildColumns, addr 0x415df00, size 0x18, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ChildColumns();

  /// @brief Method get_ChildColumnsReference, addr 0x415e004, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ChildColumnsReference();

  /// @brief Method get_ChildKey, addr 0x415b814, size 0x18, virtual false, abstract: false, final false
  inline ::System::Data::DataKey get_ChildKey();

  /// @brief Method get_ChildKeyConstraint, addr 0x4160364, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::ForeignKeyConstraint* get_ChildKeyConstraint();

  /// @brief Method get_ChildTable, addr 0x415e01c, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataTable* get_ChildTable();

  /// @brief Method get_DataSet, addr 0x415e034, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataSet* get_DataSet();

  /// @brief Method get_ExtendedProperties, addr 0x416037c, size 0x64, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_Nested, addr 0x415ec68, size 0x18, virtual true, abstract: false, final false
  inline bool get_Nested();

  /// @brief Method get_ObjectID, addr 0x4161040, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_ParentColumnNames, addr 0x415e04c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ParentColumnNames();

  /// @brief Method get_ParentColumns, addr 0x415e464, size 0x18, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ParentColumns();

  /// @brief Method get_ParentColumnsReference, addr 0x415e47c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ParentColumnsReference();

  /// @brief Method get_ParentKey, addr 0x415b82c, size 0x18, virtual false, abstract: false, final false
  inline ::System::Data::DataKey get_ParentKey();

  /// @brief Method get_ParentKeyConstraint, addr 0x4160344, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::UniqueConstraint* get_ParentKeyConstraint();

  /// @brief Method get_ParentTable, addr 0x415e484, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataTable* get_ParentTable();

  /// @brief Method get_RelationName, addr 0x415e49c, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_RelationName();

  static inline void setStaticF_s_objectTypeCount(int32_t value);

  /// @brief Method set_CheckMultipleNested, addr 0x41603e8, size 0xc, virtual false, abstract: false, final false
  inline void set_CheckMultipleNested(bool value);

  /// @brief Method set_Nested, addr 0x415ec80, size 0x10ac, virtual true, abstract: false, final false
