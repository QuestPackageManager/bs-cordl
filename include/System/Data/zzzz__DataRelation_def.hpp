...
public:
  ...
  /// @brief Method CheckNamespaceValidityForNestedRelations, addr 0x2b8a598, size 0x3a4, virtual false, abstract: false, final false
  inline void CheckNamespaceValidityForNestedRelations(::StringW ns);

  /// @brief Method CheckNestedRelations, addr 0x2b8a93c, size 0x410, virtual false, abstract: false, final false
  inline void CheckNestedRelations();

  /// @brief Method CheckState, addr 0x2b8c3c0, size 0x21c, virtual false, abstract: false, final false
  inline void CheckState();

  /// @brief Method CheckStateForProperty, addr 0x2b8a0dc, size 0xe8, virtual false, abstract: false, final false
  inline void CheckStateForProperty();

  /// @brief Method Clone, addr 0x2b8c5dc, size 0x654, virtual false, abstract: false, final false
  inline ::System::Data::DataRelation* Clone(::System::Data::DataSet* destination);

  /// @brief Method Create, addr 0x2b89b40, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildRows, addr 0x2b8a2d0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentRow, addr 0x2b8a3e0, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentRows, addr 0x2b8a35c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAutoGenerated, addr 0x2b8cd0c, size 0x1d4, virtual false, abstract: false, final false
  inline bool IsAutoGenerated(::System::Data::DataColumn* col);

  /// @brief Method IsKeyNull, addr 0x2b8a21c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPropertyChanging, addr 0x2b8cc30, size 0xd0, virtual false, abstract: false, final false
  inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs* pcevent);

  /// @brief Method RaisePropertyChanging, addr 0x2b8c28c, size 0x74, virtual false, abstract: false, final false
  inline void RaisePropertyChanging(::StringW name);

  /// @brief Method SetChildKeyConstraint, addr 0x2b8c3b8, size 0x8, virtual false, abstract: false, final false
  inline void SetChildKeyConstraint(::System::Data::ForeignKeyConstraint* value);

  /// @brief Method SetDataSet, addr 0x2b8a534, size 0x14, virtual false, abstract: false, final false
  inline void SetDataSet(::System::Data::DataSet* dataSet);

  /// @brief Method SetParentKeyConstraint, addr 0x2b8c318, size 0x8, virtual false, abstract: false, final false
  inline void SetParentKeyConstraint(::System::Data::UniqueConstraint* value);

  /// @brief Method ToString, addr 0x2b8cd00, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateMultipleNestedRelations, addr 0x2b8bdd0, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b89948, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b89e34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW relationName, ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> parentColumns,
                    ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> childColumns);

  /// @brief Method .ctor, addr 0x2b89e3c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::StringW relationName, ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> parentColumns,
                    ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> childColumns, bool createConstraints);

  /// @brief Method .ctor, addr 0x2b89f04, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b89fd8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CheckMultipleNested, addr 0x2b8c3a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_CheckMultipleNested();

  /// @brief Method get_ChildColumnNames, addr 0x2b8a214, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ChildColumnNames();

  /// @brief Method get_ChildColumns, addr 0x2b8a0c4, size 0x18, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ChildColumns();

  /// @brief Method get_ChildColumnsReference, addr 0x2b8a1c4, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ChildColumnsReference();

  /// @brief Method get_ChildKey, addr 0x2b7fdb4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Data::DataKey get_ChildKey();

  /// @brief Method get_ChildKeyConstraint, addr 0x2b8c320, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::ForeignKeyConstraint* get_ChildKeyConstraint();

  /// @brief Method get_ChildTable, addr 0x2b8a1dc, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataTable* get_ChildTable();

  /// @brief Method get_DataSet, addr 0x2b8a1f4, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataSet* get_DataSet();

  /// @brief Method get_ExtendedProperties, addr 0x2b8c338, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Data::PropertyCollection* get_ExtendedProperties();

  /// @brief Method get_Nested, addr 0x2b8ad4c, size 0x18, virtual true, abstract: false, final false
  inline bool get_Nested();

  /// @brief Method get_ObjectID, addr 0x2b8cee0, size 0x1008, virtual false, abstract: false, final false
  inline int32_t get_ObjectID();

  /// @brief Method get_ParentColumnNames, addr 0x2b8a20c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_ParentColumnNames();

  /// @brief Method get_ParentColumns, addr 0x2b8a548, size 0x18, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ParentColumns();

  /// @brief Method get_ParentColumnsReference, addr 0x2b8a560, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Data::DataColumn*, ::Array<::System::Data::DataColumn*>*> get_ParentColumnsReference();

  /// @brief Method get_ParentKey, addr 0x2b7fe28, size 0x18, virtual false, abstract: false, final false
  inline ::System::Data::DataKey get_ParentKey();

  /// @brief Method get_ParentKeyConstraint, addr 0x2b8c300, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::UniqueConstraint* get_ParentKeyConstraint();

  /// @brief Method get_ParentTable, addr 0x2b8a568, size 0x18, virtual true, abstract: false, final false
  inline ::System::Data::DataTable* get_ParentTable();

  /// @brief Method get_RelationName, addr 0x2b8a580, size 0x18, virtual true, abstract: false, final false
  inline ::StringW get_RelationName();

  static inline void setStaticF_s_objectTypeCount(int32_t value);

  /// @brief Method set_CheckMultipleNested, addr 0x2b8c3ac, size 0xc, virtual false, abstract: false, final false
  inline void set_CheckMultipleNested(bool value);

  /// @brief Method set_Nested, addr 0x2b8ad64, size 0x106c, virtual true, abstract: false, final false
