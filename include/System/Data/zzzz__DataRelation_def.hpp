...
/// @brief Method CheckNamespaceValidityForNestedRelations, addr 0x5e70e3c, size 0x368, virtual false, abstract: false, final false
inline void CheckNamespaceValidityForNestedRelations(::StringW  ns) ;

/// @brief Method CheckNestedRelations, addr 0x5e711a4, size 0x434, virtual false, abstract: false, final false
inline void CheckNestedRelations() ;

/// @brief Method CheckState, addr 0x5e72c74, size 0x208, virtual false, abstract: false, final false
inline void CheckState() ;

/// @brief Method CheckStateForProperty, addr 0x5e708bc, size 0xec, virtual false, abstract: false, final false
inline void CheckStateForProperty() ;

/// @brief Method Clone, addr 0x5e72e7c, size 0x644, virtual false, abstract: false, final false
inline ::System::Data::DataRelation* Clone(::System::Data::DataSet*  destination) ;

/// @brief Method Create, addr 0x5e70380, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method GetChildRows, addr 0x5e70ab8, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method GetParentRow, addr 0x5e70c08, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method GetParentRows, addr 0x5e70b70, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method IsAutoGenerated, addr 0x5e736c0, size 0x1a0, virtual false, abstract: false, final false
inline bool IsAutoGenerated(::System::Data::DataColumn*  col) ;

/// @brief Method IsKeyNull, addr 0x5e70a00, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method OnPropertyChanging, addr 0x5e735cc, size 0xe8, virtual false, abstract: false, final false
inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs*  pcevent) ;

/// @brief Method RaisePropertyChanging, addr 0x5e72a6c, size 0x70, virtual false, abstract: false, final false
inline void RaisePropertyChanging(::StringW  name) ;

/// @brief Method SetChildKeyConstraint, addr 0x5e72c6c, size 0x8, virtual false, abstract: false, final false
inline void SetChildKeyConstraint(::System::Data::ForeignKeyConstraint*  value) ;

/// @brief Method SetDataSet, addr 0x5e70dd8, size 0x14, virtual false, abstract: false, final false
inline void SetDataSet(::System::Data::DataSet*  dataSet) ;

/// @brief Method SetParentKeyConstraint, addr 0x5e72bd0, size 0x8, virtual false, abstract: false, final false
inline void SetParentKeyConstraint(::System::Data::UniqueConstraint*  value) ;

/// @brief Method ToString, addr 0x5e736b4, size 0xc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ValidateMultipleNestedRelations, addr 0x5e725a4, size 0x4c8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e7018c, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e70658, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e70660, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e70710, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e707d0, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method get_CheckMultipleNested, addr 0x5e72c5c, size 0x8, virtual false, abstract: false, final false
inline bool get_CheckMultipleNested() ;

/// @brief Method get_ChildColumnNames, addr 0x5e709f8, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ChildColumnNames() ;

/// @brief Method get_ChildColumns, addr 0x5e708a4, size 0x18, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ChildColumns() ;

/// @brief Method get_ChildColumnsReference, addr 0x5e709a8, size 0x18, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ChildColumnsReference() ;

/// @brief Method get_ChildKey, addr 0x5e6e394, size 0x18, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_ChildKey() ;

/// @brief Method get_ChildKeyConstraint, addr 0x5e72bd8, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::ForeignKeyConstraint* get_ChildKeyConstraint() ;

/// @brief Method get_ChildTable, addr 0x5e709c0, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_ChildTable() ;

/// @brief Method get_DataSet, addr 0x5e709d8, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::DataSet* get_DataSet() ;

/// @brief Method get_ExtendedProperties, addr 0x5e72bf0, size 0x6c, virtual false, abstract: false, final false
inline ::System::Data::PropertyCollection* get_ExtendedProperties() ;

/// @brief Method get_Nested, addr 0x5e715d8, size 0x18, virtual true, abstract: false, final false
inline bool get_Nested() ;

/// @brief Method get_ObjectID, addr 0x5e73860, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ObjectID() ;

/// @brief Method get_ParentColumnNames, addr 0x5e709f0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ParentColumnNames() ;

/// @brief Method get_ParentColumns, addr 0x5e70dec, size 0x18, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ParentColumns() ;

/// @brief Method get_ParentColumnsReference, addr 0x5e70e04, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ParentColumnsReference() ;

/// @brief Method get_ParentKey, addr 0x5e6e3ac, size 0x18, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_ParentKey() ;

/// @brief Method get_ParentKeyConstraint, addr 0x5e72bb8, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::UniqueConstraint* get_ParentKeyConstraint() ;

/// @brief Method get_ParentTable, addr 0x5e70e0c, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_ParentTable() ;

/// @brief Method get_RelationName, addr 0x5e70e24, size 0x18, virtual true, abstract: false, final false
inline ::StringW get_RelationName() ;

static inline void setStaticF_s_objectTypeCount(int32_t  value) ;

/// @brief Method set_CheckMultipleNested, addr 0x5e72c64, size 0x8, virtual false, abstract: false, final false
inline void set_CheckMultipleNested(bool  value) ;

/// @brief Method set_Nested, addr 0x5e715f0, size 0xfb4, virtual true, abstract: false, final false
