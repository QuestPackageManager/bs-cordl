...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5f007c4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BuildExpression, addr 0x5eff0c4, size 0x21c, virtual false, abstract: false, final false
  inline void BuildExpression(int32_t pri);

  /// @brief Method CheckToken, addr 0x5eff590, size 0x40, virtual false, abstract: false, final false
  inline void CheckToken(::System::Data::Tokens token);

  /// @brief Method IsAlpha, addr 0x5f00484, size 0x24, virtual false, abstract: false, final false
  inline bool IsAlpha(char16_t ch);

  /// @brief Method IsAlphaNumeric, addr 0x5f0032c, size 0x44, virtual false, abstract: false, final false
  inline bool IsAlphaNumeric(char16_t ch);

  /// @brief Method IsDigit, addr 0x5f0013c, size 0x14, virtual false, abstract: false, final false
  inline bool IsDigit(char16_t ch);

  /// @brief Method IsWhiteSpace, addr 0x5f004fc, size 0x14, virtual false, abstract: false, final false
  inline bool IsWhiteSpace(char16_t ch);

  /// @brief Method LoadExpression, addr 0x5efd7c8, size 0xd4, virtual false, abstract: false, final false
  inline void LoadExpression(::StringW data);

  static inline ::System::Data::ExpressionParser* New_ctor(::System::Data::DataTable* table);

  /// @brief Method NodePeek, addr 0x5eff6dc, size 0x44, virtual false, abstract: false, final false
  inline ::System::Data::ExpressionNode* NodePeek();

  /// @brief Method NodePop, addr 0x5eff764, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Data::ExpressionNode* NodePop();

  /// @brief Method NodePush, addr 0x5eff648, size 0x94, virtual false, abstract: false, final false
  inline void NodePush(::System::Data::ExpressionNode* node);

  /// @brief Method Parse, addr 0x5efd914, size 0xc48, virtual false, abstract: false, final false
  inline ::System::Data::ExpressionNode* Parse();

  /// @brief Method ParseAggregateArgument, addr 0x5eff7a0, size 0x2b4, virtual false, abstract: false, final false
  inline ::System::Data::ExpressionNode* ParseAggregateArgument(::System::Data::FunctionId aggregate);

  /// @brief Method Scan, addr 0x5efec64, size 0x3c8, virtual false, abstract: false, final false
  inline ::System::Data::Tokens Scan();

  /// @brief Method ScanBinaryConstant, addr 0x5f00138, size 0x4, virtual false, abstract: false, final false
  inline void ScanBinaryConstant();

  /// @brief Method ScanDate, addr 0x5effd98, size 0x9c, virtual false, abstract: false, final false
  inline void ScanDate();

  /// @brief Method ScanName, addr 0x5f00370, size 0x6c, virtual false, abstract: false, final false
  inline void ScanName();

  /// @brief Method ScanName, addr 0x5efff00, size 0x108, virtual false, abstract: false, final false
  inline void ScanName(char16_t chEnd, char16_t esc, ::StringW charsToEscape);

  /// @brief Method ScanNumeric, addr 0x5f00008, size 0x130, virtual false, abstract: false, final false
  inline void ScanNumeric();

  /// @brief Method ScanReserved, addr 0x5f00150, size 0x1dc, virtual false, abstract: false, final false
  inline void ScanReserved();

  /// @brief Method ScanString, addr 0x5effe34, size 0xcc, virtual false, abstract: false, final false
  inline void ScanString(char16_t escape);

  /// @brief Method ScanToken, addr 0x5eff378, size 0x28, virtual false, abstract: false, final false
  inline void ScanToken(::System::Data::Tokens token);

  /// @brief Method ScanWhite, addr 0x5effd38, size 0x60, virtual false, abstract: false, final false
  inline void ScanWhite();

  /// @brief Method StartScan, addr 0x5efebd0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5efd728, size 0xa0, virtual false, abstract: false, final false
