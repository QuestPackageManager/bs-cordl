...
public:
  ...
  /// @brief Method .ctor, addr 0x6042814, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::Data::DataTable* table, ::StringW conflict);

  /// @brief Method get_Conflict, addr 0x604287c, size 0x8, virtual false, abstract: false, final false
