...
// Write type traits
MARK_REF_T(::System::Data::ParentForeignKeyConstraintEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Data::ParentForeignKeyConstraintEnumerator*, "System.Data", "ParentForeignKeyConstraintEnumerator");
...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x6020560, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x602053c, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ParentForeignKeyConstraintEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ParentForeignKeyConstraintEnumerator(ParentForeignKeyConstraintEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ParentForeignKeyConstraintEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ParentForeignKeyConstraintEnumerator(ParentForeignKeyConstraintEnumeratorconst&) = delete;
...
static_assert(sizeof(::System::Data::ParentForeignKeyConstraintEnumerator) == 0x30, "Size mismatch!");
