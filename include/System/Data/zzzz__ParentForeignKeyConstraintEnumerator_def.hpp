...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x41595c4, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41595a0, size 0x24, virtual false, abstract: false, final false
