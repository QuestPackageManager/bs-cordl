...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x5e6ba08, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6b9e4, size 0x24, virtual false, abstract: false, final false
