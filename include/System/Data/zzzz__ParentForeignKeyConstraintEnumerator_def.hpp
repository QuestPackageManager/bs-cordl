...
public:
  ...
  /// @brief Method IsValidCandidate, addr 0x415925c, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4159238, size 0x24, virtual false, abstract: false, final false
