...
/// @brief Method GetConstraint, addr 0x5e6becc, size 0x8, virtual false, abstract: false, final false
inline ::System::Data::Constraint* GetConstraint() ;

/// @brief Method GetNext, addr 0x5e6bbe0, size 0x2ec, virtual false, abstract: false, final false
inline bool GetNext() ;

/// @brief Method IsValidCandidate, addr 0x5e6bed4, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e6bba0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataSet) ;

/// @brief Method get_CurrentObject, addr 0x5e6bedc, size 0x8, virtual false, abstract: false, final false
