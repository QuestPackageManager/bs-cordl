...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataRowBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DataRowBuilder(DataRowBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DataRowBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DataRowBuilder(DataRowBuilderconst&) = delete;
