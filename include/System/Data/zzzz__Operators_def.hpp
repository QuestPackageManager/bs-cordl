...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Operators", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Operators(Operators&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Operators", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Operators(Operatorsconst&) = delete;
