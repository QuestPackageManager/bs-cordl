...
public:
  ...
  /// @brief Method IsArithmetical, addr 0x417ea68, size 0x24, virtual false, abstract: false, final false
  static inline bool IsArithmetical(int32_t op);

  /// @brief Method IsLogical, addr 0x417ea8c, size 0x2c, virtual false, abstract: false, final false
  static inline bool IsLogical(int32_t op);

  /// @brief Method IsRelational, addr 0x417eab8, size 0x10, virtual false, abstract: false, final false
  static inline bool IsRelational(int32_t op);

  /// @brief Method Priority, addr 0x417eac8, size 0xac, virtual false, abstract: false, final false
  static inline int32_t Priority(int32_t op);

  /// @brief Method ToString, addr 0x417eb74, size 0xc0, virtual false, abstract: false, final false
