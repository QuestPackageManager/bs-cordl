...
public:
  ...
  /// @brief Method .ctor, addr 0x5fffb5c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5fffb54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5fffbbc, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW s);

  /// @brief Method .ctor, addr 0x5fffbe0, size 0x8, virtual false, abstract: false, final false
