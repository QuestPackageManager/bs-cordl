...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrimaryKeyTypeConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrimaryKeyTypeConverter(PrimaryKeyTypeConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrimaryKeyTypeConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrimaryKeyTypeConverter(PrimaryKeyTypeConverterconst&) = delete;
