...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Tuple_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Tuple_3, "System", "Tuple`3");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Tuple_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Tuple_3(Tuple_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Tuple_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Tuple_3(Tuple_3const&) = delete;
