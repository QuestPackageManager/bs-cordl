...
public:
  ...
  /// @brief Method Dispose, addr 0x272b52c, size 0x1c, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method FreeData, addr 0x272bbe8, size 0x48, virtual false, abstract: false, final false
  inline void FreeData(int32_t slot, int64_t cookie);

  /// @brief Method GetData, addr 0x272b704, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateElement, addr 0x272b93c, size 0x2ac, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreElement* PopulateElement(::System::LocalDataStoreSlot* slot);

  /// @brief Method SetData, addr 0x272b858, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x272b590, size 0x70, virtual false, abstract: false, final false
