...
public:
  ...
  /// @brief Method Dispose, addr 0x5b330d0, size 0x18, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method FreeData, addr 0x5b336f0, size 0x48, virtual false, abstract: false, final false
  inline void FreeData(int32_t slot, int64_t cookie);

  /// @brief Method GetData, addr 0x5b33280, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateElement, addr 0x5b33468, size 0x288, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreElement* PopulateElement(::System::LocalDataStoreSlot* slot);

  /// @brief Method SetData, addr 0x5b333a0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b33110, size 0x68, virtual false, abstract: false, final false
