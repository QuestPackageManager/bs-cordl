...
public:
  ...
  /// @brief Method Dispose, addr 0x5c6e920, size 0x18, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method FreeData, addr 0x5c6ef40, size 0x48, virtual false, abstract: false, final false
  inline void FreeData(int32_t slot, int64_t cookie);

  /// @brief Method GetData, addr 0x5c6ead0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateElement, addr 0x5c6ecb8, size 0x288, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreElement* PopulateElement(::System::LocalDataStoreSlot* slot);

  /// @brief Method SetData, addr 0x5c6ebf0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c6e960, size 0x68, virtual false, abstract: false, final false
