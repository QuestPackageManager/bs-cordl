...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlatformNotSupportedException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlatformNotSupportedException(PlatformNotSupportedException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlatformNotSupportedException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlatformNotSupportedException(PlatformNotSupportedExceptionconst&) = delete;
