...
public:
  ...
  /// @brief Method .ctor, addr 0x59fcd60, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59fcdc0, size 0x8, virtual false, abstract: false, final false
