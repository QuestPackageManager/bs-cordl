...
public:
  ...
  /// @brief Method .ctor, addr 0x28b3810, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x28b386c, size 0x8, virtual false, abstract: false, final false
