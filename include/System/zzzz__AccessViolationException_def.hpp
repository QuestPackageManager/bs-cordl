...
public:
  ...
  /// @brief Method .ctor, addr 0x2792a68, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2792ac4, size 0x8, virtual false, abstract: false, final false
