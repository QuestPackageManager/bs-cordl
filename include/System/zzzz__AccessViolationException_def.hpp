...
public:
  ...
  /// @brief Method .ctor, addr 0x5bacd28, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5bacd88, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AccessViolationException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AccessViolationException(AccessViolationException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AccessViolationException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AccessViolationException(AccessViolationExceptionconst&) = delete;
