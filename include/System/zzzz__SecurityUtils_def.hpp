...
public:
  // Declarations
  /// @brief Method DemandReflectionAccess, addr 0x2947d68, size 0x4, virtual false, abstract: false, final false
  static inline void DemandReflectionAccess(::System::Type* type);

  /// @brief Method DemandGrantSet, addr 0x2947d6c, size 0x4, virtual false, abstract: false, final false
  static inline void DemandGrantSet(::System::Reflection::Assembly* assembly);

  /// @brief Method HasReflectionPermission, addr 0x2947d70, size 0x8, virtual false, abstract: false, final false
  static inline bool HasReflectionPermission(::System::Type* type);

  /// @brief Method SecureCreateInstance, addr 0x2947d78, size 0xc, virtual false, abstract: false, final false
  static inline ::System::Object* SecureCreateInstance(::System::Type* type);

  /// @brief Method SecureCreateInstance, addr 0x2947d84, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method SecureConstructorInvoke, addr 0x2947e7c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SecureConstructorInvoke, addr 0x2947e88, size 0x178, virtual false, abstract: false, final false
  static inline ::System::Object* SecureConstructorInvoke(::System::Type* type, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> argTypes,
                                                          ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args, bool allowNonPublic, ::System::Reflection::BindingFlags extraFlags);

  /// @brief Method GenericArgumentsAreVisible, addr 0x2948000, size 0xa0, virtual false, abstract: false, final false
  static inline bool GenericArgumentsAreVisible(::System::Reflection::MethodInfo* method);

  /// @brief Method MethodInfoInvoke, addr 0x29480a0, size 0x110, virtual false, abstract: false, final false
