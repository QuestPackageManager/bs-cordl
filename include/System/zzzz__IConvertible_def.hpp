...
// Write type traits
MARK_REF_T(::System::IConvertible*);
DEFINE_IL2CPP_CLASS(::System::IConvertible*, "System", "IConvertible");
// [CLSCompliant(false)]
// Dependencies
namespace System {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IConvertible", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IConvertible(IConvertibleconst&) = delete;
