...
public:
  ...
  /// @brief Method InitializeDefaultSwitchValues, addr 0x3e183e0, size 0x174, virtual false, abstract: false, final false
  static inline void InitializeDefaultSwitchValues();

  /// @brief Method TryGetSwitch, addr 0x3e18554, size 0x408, virtual false, abstract: false, final false
