...
public:
  ...
  /// @brief Method CalculateUtcOffset, addr 0x3e106c8, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e10564, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_CurrentTimeZone, addr 0x3e1056c, size 0x15c, virtual false, abstract: false, final false
  static inline ::System::TimeZone* get_CurrentTimeZone();

  /// @brief Method get_InternalSyncObject, addr 0x3e104cc, size 0x98, virtual false, abstract: false, final false
