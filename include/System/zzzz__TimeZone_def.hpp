...
public:
  ...
  /// @brief Method CalculateUtcOffset, addr 0x3e077c4, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e07660, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_CurrentTimeZone, addr 0x3e07668, size 0x15c, virtual false, abstract: false, final false
  static inline ::System::TimeZone* get_CurrentTimeZone();

  /// @brief Method get_InternalSyncObject, addr 0x3e075c8, size 0x98, virtual false, abstract: false, final false
