...
public:
  ...
  /// @brief Method CalculateUtcOffset, addr 0x2719a40, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27198cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_CurrentTimeZone, addr 0x27198d4, size 0x16c, virtual false, abstract: false, final false
  static inline ::System::TimeZone* get_CurrentTimeZone();

  /// @brief Method get_InternalSyncObject, addr 0x271982c, size 0xa0, virtual false, abstract: false, final false
