...
// Write type traits
MARK_REF_PTR_T(::System::InsufficientMemoryException);
...
public:
  ...
  /// @brief Method .ctor, addr 0x5b2c81c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b2c898, size 0x4, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::System::InsufficientMemoryException, 0x90>, "Size mismatch!");

} // namespace System
NEED_NO_BOX(::System::InsufficientMemoryException);
DEFINE_IL2CPP_ARG_TYPE(::System::InsufficientMemoryException*, "System", "InsufficientMemoryException");
