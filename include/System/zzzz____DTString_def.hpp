...
public:
  ...
  /// @brief Method Advance, addr 0x3ddd998, size 0xb8, virtual false, abstract: false, final false
  inline bool Advance(int32_t count);

  /// @brief Method AtEnd, addr 0x3ddd918, size 0x80, virtual false, abstract: false, final false
  inline bool AtEnd();

  /// @brief Method ConsumeSubString, addr 0x3ddf2e4, size 0xb0, virtual false, abstract: false, final false
  inline void ConsumeSubString(::System::DTSubString sub);

  /// @brief Method GetChar, addr 0x3ddea38, size 0x28, virtual false, abstract: false, final false
  inline char16_t GetChar();

  /// @brief Method GetDigit, addr 0x3ddea60, size 0x2c, virtual false, abstract: false, final false
  inline int32_t GetDigit();

  /// @brief Method GetNext, addr 0x3ddd86c, size 0xac, virtual false, abstract: false, final false
  inline bool GetNext();

  /// @brief Method GetNextDigit, addr 0x3dde95c, size 0xdc, virtual false, abstract: false, final false
  inline bool GetNextDigit();

  /// @brief Method GetRegularToken, addr 0x3ddda50, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRepeatCount, addr 0x3dde880, size 0xdc, virtual false, abstract: false, final false
  inline int32_t GetRepeatCount();

  /// @brief Method GetSeparatorToken, addr 0x3dddd84, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSubString, addr 0x3ddf164, size 0x180, virtual false, abstract: false, final false
  inline ::System::DTSubString GetSubString();

  /// @brief Method Match, addr 0x3dde6b4, size 0xd4, virtual false, abstract: false, final false
  inline bool Match(char16_t ch);

  /// @brief Method Match, addr 0x3dde564, size 0x150, virtual false, abstract: false, final false
  inline bool Match(::StringW str);

  /// @brief Method MatchLongestWords, addr 0x3dde788, size 0xf8, virtual false, abstract: false, final false
  inline int32_t MatchLongestWords(::ArrayW<::StringW, ::Array<::StringW>*> words, ::ByRef<int32_t> maxMatchStrLen);

  /// @brief Method MatchSpecifiedWord, addr 0x3dddff4, size 0x124, virtual false, abstract: false, final false
  inline bool MatchSpecifiedWord(::StringW target);

  /// @brief Method MatchSpecifiedWords, addr 0x3dde118, size 0x44c, virtual false, abstract: false, final false
  inline bool MatchSpecifiedWords(::StringW target, bool checkWordBoundary, ::ByRef<int32_t> matchLength);

  /// @brief Method RemoveLeadingInQuoteSpaces, addr 0x3ddeed4, size 0x290, virtual false, abstract: false, final false
  inline void RemoveLeadingInQuoteSpaces();

  /// @brief Method RemoveTrailingInQuoteSpaces, addr 0x3ddeca8, size 0x22c, virtual false, abstract: false, final false
  inline void RemoveTrailingInQuoteSpaces();

  /// @brief Method SkipWhiteSpaceCurrent, addr 0x3ddde8c, size 0x168, virtual false, abstract: false, final false
  inline bool SkipWhiteSpaceCurrent();

  /// @brief Method SkipWhiteSpaces, addr 0x3ddea8c, size 0xf8, virtual false, abstract: false, final false
  inline void SkipWhiteSpaces();

  /// @brief Method TrimTail, addr 0x3ddeb84, size 0x124, virtual false, abstract: false, final false
  inline void TrimTail();

  /// @brief Method .ctor, addr 0x3ddd7a0, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> str, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method .ctor, addr 0x3ddd714, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CompareInfo, addr 0x3ddd864, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CompareInfo* get_CompareInfo();

  /// @brief Method get_Length, addr 0x3ddd6d8, size 0x3c, virtual false, abstract: false, final false
