...
public:
  ...
  /// @brief Method Advance, addr 0x5c3eb40, size 0xc4, virtual false, abstract: false, final false
  inline bool Advance(int32_t count);

  /// @brief Method AtEnd, addr 0x5c3eaac, size 0x94, virtual false, abstract: false, final false
  inline bool AtEnd();

  /// @brief Method ConsumeSubString, addr 0x5c4057c, size 0xbc, virtual false, abstract: false, final false
  inline void ConsumeSubString(::System::DTSubString sub);

  /// @brief Method GetChar, addr 0x5c3fc70, size 0x24, virtual false, abstract: false, final false
  inline char16_t GetChar();

  /// @brief Method GetDigit, addr 0x5c3fc94, size 0x28, virtual false, abstract: false, final false
  inline int32_t GetDigit();

  /// @brief Method GetNext, addr 0x5c3e9ec, size 0xc0, virtual false, abstract: false, final false
  inline bool GetNext();

  /// @brief Method GetNextDigit, addr 0x5c3fb80, size 0xf0, virtual false, abstract: false, final false
  inline bool GetNextDigit();

  /// @brief Method GetRegularToken, addr 0x5c3ec04, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRepeatCount, addr 0x5c3fa98, size 0xe8, virtual false, abstract: false, final false
  inline int32_t GetRepeatCount();

  /// @brief Method GetSeparatorToken, addr 0x5c3ef58, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSubString, addr 0x5c4040c, size 0x170, virtual false, abstract: false, final false
  inline ::System::DTSubString GetSubString();

  /// @brief Method Match, addr 0x5c3f8bc, size 0xe0, virtual false, abstract: false, final false
  inline bool Match(char16_t ch);

  /// @brief Method Match, addr 0x5c3f750, size 0x16c, virtual false, abstract: false, final false
  inline bool Match(::StringW str);

  /// @brief Method MatchLongestWords, addr 0x5c3f99c, size 0xfc, virtual false, abstract: false, final false
  inline int32_t MatchLongestWords(::ArrayW<::StringW> words, ::by_ref<int32_t> maxMatchStrLen);

  /// @brief Method MatchSpecifiedWord, addr 0x5c3f1d0, size 0x138, virtual false, abstract: false, final false
  inline bool MatchSpecifiedWord(::StringW target);

  /// @brief Method MatchSpecifiedWords, addr 0x5c3f308, size 0x448, virtual false, abstract: false, final false
  inline bool MatchSpecifiedWords(::StringW target, bool checkWordBoundary, ::by_ref<int32_t> matchLength);

  /// @brief Method RemoveLeadingInQuoteSpaces, addr 0x5c40148, size 0x2c4, virtual false, abstract: false, final false
  inline void RemoveLeadingInQuoteSpaces();

  /// @brief Method RemoveTrailingInQuoteSpaces, addr 0x5c3fef8, size 0x250, virtual false, abstract: false, final false
  inline void RemoveTrailingInQuoteSpaces();

  /// @brief Method SkipWhiteSpaceCurrent, addr 0x5c3f064, size 0x16c, virtual false, abstract: false, final false
  inline bool SkipWhiteSpaceCurrent();

  /// @brief Method SkipWhiteSpaces, addr 0x5c3fcbc, size 0xf4, virtual false, abstract: false, final false
  inline void SkipWhiteSpaces();

  /// @brief Method TrimTail, addr 0x5c3fdb0, size 0x148, virtual false, abstract: false, final false
  inline void TrimTail();

  /// @brief Method .ctor, addr 0x5c3e908, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> str, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method .ctor, addr 0x5c3e878, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CompareInfo, addr 0x5c3e9e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CompareInfo* get_CompareInfo();

  /// @brief Method get_Length, addr 0x5c3e834, size 0x44, virtual false, abstract: false, final false
