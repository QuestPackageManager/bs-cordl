...
public:
  ...
  /// @brief Method get_Length addr 0x2448870 size 0x3c virtual false final false
  inline int32_t get_Length();

  /// @brief Method .ctor addr 0x24488ac size 0x24 virtual false final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> str, ::System::Globalization::DateTimeFormatInfo* dtfi, bool checkDigitToken);

  /// @brief Method .ctor addr 0x24488d0 size 0xc4 virtual false final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> str, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method get_CompareInfo addr 0x2448994 size 0x8 virtual false final false
  inline ::System::Globalization::CompareInfo* get_CompareInfo();

  /// @brief Method GetNext addr 0x244899c size 0x78 virtual false final false
  inline bool GetNext();

  /// @brief Method AtEnd addr 0x2448a14 size 0x48 virtual false final false
  inline bool AtEnd();

  /// @brief Method Advance addr 0x2448a5c size 0x78 virtual false final false
  inline bool Advance(int32_t count);

  /// @brief Method GetRegularToken addr 0x2448ad4 size 0x2e8 virtual false final false
  ...
  /// @brief Method GetSeparatorToken addr 0x2448dbc size 0xe0 virtual false final false
  ...
  /// @brief Method MatchSpecifiedWord addr 0x2448fc4 size 0x100 virtual false final false
  inline bool MatchSpecifiedWord(::StringW target);

  /// @brief Method MatchSpecifiedWords addr 0x24490c4 size 0x44c virtual false final false
  inline bool MatchSpecifiedWords(::StringW target, bool checkWordBoundary, ByRef<int32_t> matchLength);

  /// @brief Method Match addr 0x2449510 size 0x12c virtual false final false
  inline bool Match(::StringW str);

  /// @brief Method Match addr 0x244963c size 0x9c virtual false final false
  inline bool Match(char16_t ch);

  /// @brief Method MatchLongestWords addr 0x24496d8 size 0xb8 virtual false final false
  inline int32_t MatchLongestWords(::ArrayW<::StringW, ::Array<::StringW>*> words, ByRef<int32_t> maxMatchStrLen);

  /// @brief Method GetRepeatCount addr 0x2449790 size 0xa8 virtual false final false
  inline int32_t GetRepeatCount();

  /// @brief Method GetNextDigit addr 0x2449838 size 0xb8 virtual false final false
  inline bool GetNextDigit();

  /// @brief Method GetChar addr 0x24498f0 size 0x28 virtual false final false
  inline char16_t GetChar();

  /// @brief Method GetDigit addr 0x2449918 size 0x2c virtual false final false
  inline int32_t GetDigit();

  /// @brief Method SkipWhiteSpaces addr 0x2449944 size 0xd4 virtual false final false
  inline void SkipWhiteSpaces();

  /// @brief Method SkipWhiteSpaceCurrent addr 0x2448e9c size 0x128 virtual false final false
  inline bool SkipWhiteSpaceCurrent();

  /// @brief Method TrimTail addr 0x2449a18 size 0x10c virtual false final false
  inline void TrimTail();

  /// @brief Method RemoveTrailingInQuoteSpaces addr 0x2449b24 size 0x234 virtual false final false
  inline void RemoveTrailingInQuoteSpaces();

  /// @brief Method RemoveLeadingInQuoteSpaces addr 0x2449d58 size 0x274 virtual false final false
  inline void RemoveLeadingInQuoteSpaces();

  /// @brief Method GetSubString addr 0x2449fcc size 0x138 virtual false final false
  inline ::System::DTSubString GetSubString();

  /// @brief Method ConsumeSubString addr 0x244a104 size 0x6c virtual false final false
