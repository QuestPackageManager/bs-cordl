...
public:
  // Declarations
  /// @brief Method FindCompressionRange addr 0x27c81ec size 0xe0 virtual false final false
  static inline ::System::ValueTuple_2<int32_t, int32_t> FindCompressionRange(::System::ReadOnlySpan_1<uint16_t> numbers);

  /// @brief Method ShouldHaveIpv4Embedded addr 0x27c82cc size 0xd0 virtual false final false
  static inline bool ShouldHaveIpv4Embedded(::System::ReadOnlySpan_1<uint16_t> numbers);

  /// @brief Method IsValidStrict addr 0x27c839c size 0x344 virtual false final false
  static inline bool IsValidStrict(::cordl_internals::Ptr<char16_t> name, int32_t start, ByRef<int32_t> end);

  /// @brief Method Parse addr 0x27c86e0 size 0x50c virtual false final false
  ...
  /// @brief Method ParseCanonicalName addr 0x27c8bec size 0x63c virtual false final false
  static inline ::StringW ParseCanonicalName(::StringW str, int32_t start, ByRef<bool> isLoopback, ByRef<::StringW> scopeId);

  /// @brief Method IsLoopback addr 0x27c9228 size 0xe0 virtual false final false
  static inline bool IsLoopback(::System::ReadOnlySpan_1<uint16_t> numbers);

  /// @brief Method InternalIsValid addr 0x27c9308 size 0x2dc virtual false final false
  ...
  /// @brief Method IsValid addr 0x27c95e4 size 0x8 virtual false final false
