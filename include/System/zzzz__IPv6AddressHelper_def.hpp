...
public:
// Declarations
/// @brief Method FindCompressionRange, addr 0x61bddb8, size 0xcc, virtual false, abstract: false, final false
static inline ::System::ValueTuple_2<int32_t,int32_t> FindCompressionRange(::System::ReadOnlySpan_1<uint16_t>  numbers) ;

/// @brief Method InternalIsValid, addr 0x61bee34, size 0x304, virtual false, abstract: false, final false
static inline bool InternalIsValid(char16_t*  name, int32_t  start, ::ByRef<int32_t>  end, bool  validateStrictAddress) ;

/// @brief Method IsLoopback, addr 0x61bed58, size 0xdc, virtual false, abstract: false, final false
static inline bool IsLoopback(::System::ReadOnlySpan_1<uint16_t>  numbers) ;

/// @brief Method IsValid, addr 0x61bf138, size 0x8, virtual false, abstract: false, final false
static inline bool IsValid(char16_t*  name, int32_t  start, ::ByRef<int32_t>  end) ;

/// @brief Method IsValidStrict, addr 0x61bdf54, size 0x38c, virtual false, abstract: false, final false
static inline bool IsValidStrict(char16_t*  name, int32_t  start, ::ByRef<int32_t>  end) ;

/// @brief Method Parse, addr 0x61be2e0, size 0x4c4, virtual false, abstract: false, final false
static inline void Parse(::System::ReadOnlySpan_1<char16_t>  address, uint16_t*  numbers, int32_t  start, ::ByRef<::StringW>  scopeId) ;

/// @brief Method ParseCanonicalName, addr 0x61be7a4, size 0x5b4, virtual false, abstract: false, final false
static inline ::StringW ParseCanonicalName(::StringW  str, int32_t  start, ::ByRef<bool>  isLoopback, ::ByRef<::StringW>  scopeId) ;

/// @brief Method ShouldHaveIpv4Embedded, addr 0x61bde84, size 0xd0, virtual false, abstract: false, final false
