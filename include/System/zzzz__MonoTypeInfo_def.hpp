...
public:
  ...
  /// @brief Method .ctor, addr 0x5c8ec54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoTypeInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoTypeInfo(MonoTypeInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoTypeInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoTypeInfo(MonoTypeInfoconst&) = delete;
