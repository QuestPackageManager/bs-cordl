...
public:
  // Declarations
  /// @brief Method GetType, addr 0x5c8ec58, size 0x58, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TypeNameParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TypeNameParser(TypeNameParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TypeNameParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TypeNameParser(TypeNameParserconst&) = delete;
