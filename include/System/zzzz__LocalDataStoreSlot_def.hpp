...
public:
  ...
  /// @brief Method Finalize, addr 0x5b33778, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b33750, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::LocalDataStoreMgr* mgr, int32_t slot, int64_t cookie);

  /// @brief Method get_Cookie, addr 0x5b33770, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_Cookie();

  /// @brief Method get_Manager, addr 0x5b33760, size 0x8, virtual false, abstract: false, final false
  inline ::System::LocalDataStoreMgr* get_Manager();

  /// @brief Method get_Slot, addr 0x5b33768, size 0x8, virtual false, abstract: false, final false
