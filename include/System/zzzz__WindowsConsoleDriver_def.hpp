...
public:
  ...
  /// @brief Method GetConsoleScreenBufferInfo, addr 0x2890c50, size 0x94, virtual false, abstract: false, final false
  static inline bool GetConsoleScreenBufferInfo(void* handle, ByRef<::System::ConsoleScreenBufferInfo> info);

  /// @brief Method GetStdHandle, addr 0x2890bcc, size 0x84, virtual false, abstract: false, final false
  static inline void* GetStdHandle(::System::Handles handle);

  /// @brief Method IsModifierKey, addr 0x2890f2c, size 0x34, virtual false, abstract: false, final false
  static inline bool IsModifierKey(int16_t virtualKeyCode);

  static inline ::System::WindowsConsoleDriver* New_ctor();

  /// @brief Method ReadConsoleInput, addr 0x2890e24, size 0x108, virtual false, abstract: false, final false
  static inline bool ReadConsoleInput(void* handle, ByRef<::System::InputRecord> record, int32_t length, ByRef<int32_t> nread);

  /// @brief Method ReadKey, addr 0x2890ce4, size 0x140, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2890b78, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
