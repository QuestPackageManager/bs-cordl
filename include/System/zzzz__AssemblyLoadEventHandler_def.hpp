...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x28b5ac4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28b5994, size 0x130, virtual false, abstract: false, final false
