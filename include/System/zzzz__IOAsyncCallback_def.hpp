...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x440f9a8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x440f8a8, size 0x100, virtual false, abstract: false, final false
