...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoType", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoType(MonoType&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoType", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoType(MonoTypeconst&) = delete;
