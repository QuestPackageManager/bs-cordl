...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CharEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CharEnumerator(CharEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CharEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CharEnumerator(CharEnumeratorconst&) = delete;
