...
public:
  ...
  /// @brief Method Clone, addr 0x599de14, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method Dispose, addr 0x599de7c, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x599de18, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x599df58, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x599de94, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x599df68, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x599de04, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method get_Current, addr 0x599debc, size 0x9c, virtual true, abstract: false, final true
