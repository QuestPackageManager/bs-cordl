...
public:
  ...
  /// @brief Method Clone, addr 0x3cfaf5c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method Dispose, addr 0x3cfafc0, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x3cfaf64, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x3cfb0d8, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3cfafd8, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3cfb0e8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cfaf2c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method get_Current, addr 0x3cfb03c, size 0x9c, virtual true, abstract: false, final true
