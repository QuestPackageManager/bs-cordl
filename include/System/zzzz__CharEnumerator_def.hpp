...
public:
  ...
  /// @brief Method Clone, addr 0x5a04760, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method Dispose, addr 0x5a047c8, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x5a04764, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x5a048a4, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5a047e0, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a048b4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a04750, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method get_Current, addr 0x5a04808, size 0x9c, virtual true, abstract: false, final true
