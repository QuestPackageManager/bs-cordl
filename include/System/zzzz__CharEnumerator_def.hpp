...
public:
  ...
  /// @brief Method Clone, addr 0x3d5e334, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method Dispose, addr 0x3d5e398, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x3d5e33c, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x3d5e4b0, size 0x10, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3d5e3b0, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3d5e4c0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3d5e304, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method get_Current, addr 0x3d5e414, size 0x9c, virtual true, abstract: false, final true
