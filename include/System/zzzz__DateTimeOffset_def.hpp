...
public:
  ...
  /// @brief Method .ctor addr 0x2437240 size 0x94 virtual false final false
  inline void _ctor(int64_t ticks, ::System::TimeSpan offset);

  /// @brief Method .ctor addr 0x2437490 size 0xc4 virtual false final false
  inline void _ctor(::System::DateTime dateTime);

  /// @brief Method .ctor addr 0x2437554 size 0x1b4 virtual false final false
  inline void _ctor(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method .ctor addr 0x2437708 size 0xcc virtual false final false
  ...
  /// @brief Method .ctor addr 0x24377d4 size 0xdc virtual false final false
  ...
  /// @brief Method .ctor addr 0x24378b0 size 0xe4 virtual false final false
  ...
  /// @brief Method get_DateTime addr 0x2437994 size 0x4 virtual false final false
  inline ::System::DateTime get_DateTime();

  /// @brief Method get_UtcDateTime addr 0x2437a38 size 0x74 virtual false final false
  inline ::System::DateTime get_UtcDateTime();

  /// @brief Method get_LocalDateTime addr 0x2437aac size 0x20 virtual false final false
  inline ::System::DateTime get_LocalDateTime();

  /// @brief Method get_ClockDateTime addr 0x2437998 size 0xa0 virtual false final false
  inline ::System::DateTime get_ClockDateTime();

  /// @brief Method get_Day addr 0x2437af8 size 0x20 virtual false final false
  inline int32_t get_Day();

  /// @brief Method get_Hour addr 0x2437b18 size 0x44 virtual false final false
  inline int32_t get_Hour();

  /// @brief Method get_Millisecond addr 0x2437b5c size 0x50 virtual false final false
  inline int32_t get_Millisecond();

  /// @brief Method get_Minute addr 0x2437bac size 0x44 virtual false final false
  inline int32_t get_Minute();

  /// @brief Method get_Month addr 0x2437bf0 size 0x20 virtual false final false
  inline int32_t get_Month();

  /// @brief Method get_Offset addr 0x2437acc size 0x2c virtual false final false
  inline ::System::TimeSpan get_Offset();

  /// @brief Method get_Second addr 0x2437c10 size 0x44 virtual false final false
  inline int32_t get_Second();

  /// @brief Method get_Ticks addr 0x2437c54 size 0x14 virtual false final false
  inline int64_t get_Ticks();

  /// @brief Method get_TimeOfDay addr 0x2437c68 size 0x3c virtual false final false
  inline ::System::TimeSpan get_TimeOfDay();

  /// @brief Method get_Year addr 0x2437ca4 size 0x20 virtual false final false
  inline int32_t get_Year();

  /// @brief Method AddTicks addr 0x2437cc4 size 0x70 virtual false final false
  inline ::System::DateTimeOffset AddTicks(int64_t ticks);

  /// @brief Method System.IComparable.CompareTo addr 0x2437d34 size 0x130 virtual true final true
  inline int32_t System_IComparable_CompareTo(::System::Object* obj);

  /// @brief Method CompareTo addr 0x2437e64 size 0xa8 virtual true final true
  inline int32_t CompareTo(::System::DateTimeOffset other);

  /// @brief Method Equals addr 0x2437f0c size 0xbc virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0x2437fc8 size 0x34 virtual true final true
  inline bool Equals(::System::DateTimeOffset other);

  /// @brief Method FromFileTime addr 0x2437ffc size 0x74 virtual false final false
  static inline ::System::DateTimeOffset FromFileTime(int64_t fileTime);

  /// @brief Method FromUnixTimeSeconds addr 0x2438070 size 0x174 virtual false final false
  static inline ::System::DateTimeOffset FromUnixTimeSeconds(int64_t seconds);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization addr 0x24381e4 size 0x180 virtual true final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x2438364 size 0xcc virtual true final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor addr 0x2438430 size 0x1c0 virtual false final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetHashCode addr 0x24385f0 size 0x18 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Parse addr 0x2438608 size 0x70 virtual false final false
  static inline ::System::DateTimeOffset Parse(::StringW input, ::System::IFormatProvider* formatProvider);

  /// @brief Method Parse addr 0x2438678 size 0x16c virtual false final false
  ...
  /// @brief Method ParseExact addr 0x24389c4 size 0x1d8 virtual false final false
  ...
  /// @brief Method ToLocalTime addr 0x2438cf0 size 0x8 virtual false final false
  inline ::System::DateTimeOffset ToLocalTime();

  /// @brief Method ToLocalTime addr 0x2438cf8 size 0x40 virtual false final false
  inline ::System::DateTimeOffset ToLocalTime(bool throwOnOverflow);

  /// @brief Method ToString addr 0x2438d38 size 0x98 virtual true final false
  inline ::StringW ToString();

  /// @brief Method ToString addr 0x24390a0 size 0x9c virtual false final false
  inline ::StringW ToString(::System::IFormatProvider* formatProvider);

  /// @brief Method ToString addr 0x243913c size 0xa8 virtual true final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method TryFormat addr 0x24391e4 size 0xdc virtual true final true
  ...
  /// @brief Method ToUniversalTime addr 0x24394d0 size 0x2c virtual false final false
  inline ::System::DateTimeOffset ToUniversalTime();

  /// @brief Method TryParse addr 0x24394fc size 0x188 virtual false final false
  ...
  /// @brief Method TryParseExact addr 0x24397f0 size 0x1c8 virtual false final false
  ...
  /// @brief Method TryParseExact addr 0x2439b3c size 0x188 virtual false final false
  ...
  /// @brief Method ValidateOffset addr 0x24372d4 size 0x114 virtual false final false
  static inline int16_t ValidateOffset(::System::TimeSpan offset);

  /// @brief Method ValidateDate addr 0x24373e8 size 0xa8 virtual false final false
  static inline ::System::DateTime ValidateDate(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method ValidateStyles addr 0x24387e4 size 0xd8 virtual false final false
  ...
  /// @brief Method op_Implicit addr 0x2439e38 size 0x28 virtual false final false
  static inline ::System::DateTimeOffset op_Implicit___System__DateTimeOffset(::System::DateTime dateTime);

  /// @brief Method op_Equality addr 0x2439e60 size 0x84 virtual false final false
