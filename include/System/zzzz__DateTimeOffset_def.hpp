...
public:
  ...
  /// @brief Method AddTicks, addr 0x3dcc26c, size 0xdc, virtual false, abstract: false, final false
  inline ::System::DateTimeOffset AddTicks(int64_t ticks);

  /// @brief Method Compare, addr 0x3dcc348, size 0xa4, virtual false, abstract: false, final false
  static inline int32_t Compare(::System::DateTimeOffset first, ::System::DateTimeOffset second);

  /// @brief Method CompareTo, addr 0x3dcc534, size 0xd4, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::DateTimeOffset other);

  /// @brief Method Equals, addr 0x3dcc608, size 0xf0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3dcc6f8, size 0xac, virtual true, abstract: false, final true
  inline bool Equals(::System::DateTimeOffset other);

  /// @brief Method FromFileTime, addr 0x3dcc7a4, size 0x74, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset FromFileTime(int64_t fileTime);

  /// @brief Method FromUnixTimeSeconds, addr 0x3dcc818, size 0x170, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset FromUnixTimeSeconds(int64_t seconds);

  /// @brief Method GetHashCode, addr 0x3dccd8c, size 0x94, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Parse, addr 0x3dcce20, size 0x70, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset Parse(::StringW input, ::System::IFormatProvider* formatProvider);

  /// @brief Method Parse, addr 0x3dcce90, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExact, addr 0x3dcd210, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method System.IComparable.CompareTo, addr 0x3dcc3ec, size 0x148, virtual true, abstract: false, final true
  inline int32_t System_IComparable_CompareTo(::System::Object* obj);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x3dcc988, size 0x180, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x3dccb08, size 0xc8, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ToLocalTime, addr 0x3dcd57c, size 0x58, virtual false, abstract: false, final false
  inline ::System::DateTimeOffset ToLocalTime();

  /// @brief Method ToLocalTime, addr 0x3dcd5d4, size 0xb8, virtual false, abstract: false, final false
  inline ::System::DateTimeOffset ToLocalTime(bool throwOnOverflow);

  /// @brief Method ToString, addr 0x3dcd68c, size 0xbc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x3dcdab8, size 0xcc, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method ToString, addr 0x3dcd9f8, size 0xc0, virtual false, abstract: false, final false
  inline ::StringW ToString(::System::IFormatProvider* formatProvider);

  /// @brief Method ToUniversalTime, addr 0x3dcde90, size 0x74, virtual false, abstract: false, final false
  inline ::System::DateTimeOffset ToUniversalTime();

  /// @brief Method TryFormat, addr 0x3dcdb84, size 0x100, virtual true, abstract: false, final true
  ...
  /// @brief Method TryParse, addr 0x3dcdf04, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExact, addr 0x3dce218, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExact, addr 0x3dce58c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateDate, addr 0x3dcb3d8, size 0x11c, virtual false, abstract: false, final false
  static inline ::System::DateTime ValidateDate(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method ValidateOffset, addr 0x3dcb280, size 0x158, virtual false, abstract: false, final false
  static inline int16_t ValidateOffset(::System::TimeSpan offset);

  /// @brief Method ValidateStyles, addr 0x3dcd03c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dcb4f4, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dateTime);

  /// @brief Method .ctor, addr 0x3dcb608, size 0x1f8, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime dateTime, ::System::TimeSpan offset);

  /// @brief Method .ctor, addr 0x3dccbd0, size 0x1bc, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x3dcb1c8, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(int64_t ticks, ::System::TimeSpan offset);

  /// @brief Method .ctor, addr 0x3dcb9a8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dcb8cc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dcb800, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ClockDateTime, addr 0x3dcbb4c, size 0xd0, virtual false, abstract: false, final false
  inline ::System::DateTime get_ClockDateTime();

  /// @brief Method get_DateTime, addr 0x3dcbaf8, size 0x54, virtual false, abstract: false, final false
  inline ::System::DateTime get_DateTime();

  /// @brief Method get_Day, addr 0x3dcbd38, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_Day();

  /// @brief Method get_Hour, addr 0x3dcbdcc, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_Hour();

  /// @brief Method get_LocalDateTime, addr 0x3dcbc78, size 0x94, virtual false, abstract: false, final false
  inline ::System::DateTime get_LocalDateTime();

  /// @brief Method get_Millisecond, addr 0x3dcbe60, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_Millisecond();

  /// @brief Method get_Minute, addr 0x3dcbef4, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_Minute();

  /// @brief Method get_Month, addr 0x3dcbf88, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_Month();

  /// @brief Method get_Now, addr 0x3dcba8c, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset get_Now();

  /// @brief Method get_Offset, addr 0x3dcbd0c, size 0x2c, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_Offset();

  /// @brief Method get_Second, addr 0x3dcc01c, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_Second();

  /// @brief Method get_Ticks, addr 0x3dcc0b0, size 0x94, virtual false, abstract: false, final false
  inline int64_t get_Ticks();

  /// @brief Method get_TimeOfDay, addr 0x3dcc144, size 0x94, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_TimeOfDay();

  /// @brief Method get_UtcDateTime, addr 0x3dcbc1c, size 0x5c, virtual false, abstract: false, final false
  inline ::System::DateTime get_UtcDateTime();

  /// @brief Method get_Year, addr 0x3dcc1d8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x3dce988, size 0xa4, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::DateTimeOffset left, ::System::DateTimeOffset right);

  /// @brief Method op_Implicit, addr 0x3dce8bc, size 0x28, virtual false, abstract: false, final false
  static inline ::System::DateTimeOffset op_Implicit___System__DateTimeOffset(::System::DateTime dateTime);

  /// @brief Method op_Inequality, addr 0x3dcea2c, size 0xa4, virtual false, abstract: false, final false
  static inline bool op_Inequality(::System::DateTimeOffset left, ::System::DateTimeOffset right);

  /// @brief Method op_Subtraction, addr 0x3dce8e4, size 0xa4, virtual false, abstract: false, final false
