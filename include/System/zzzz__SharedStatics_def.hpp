...
public:
  ...
  /// @brief Method GetSharedStringMaker, addr 0x3e290b4, size 0x1c8, virtual false, abstract: false, final false
  static inline ::System::Security::Util::Tokenizer_StringMaker* GetSharedStringMaker();

  static inline ::System::SharedStatics* New_ctor();

  /// @brief Method ReleaseSharedStringMaker, addr 0x3e2927c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e290ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
