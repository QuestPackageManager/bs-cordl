...
public:
  ...
  /// @brief Method GetSharedStringMaker, addr 0x2873f24, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseSharedStringMaker, addr 0x28740f4, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2873f1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
