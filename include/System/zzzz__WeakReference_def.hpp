...
public:
  ...
  /// @brief Method AllocateHandle, addr 0x275da4c, size 0x28, virtual false, abstract: false, final false
  inline void AllocateHandle(::System::Object* target);

  /// @brief Method Finalize, addr 0x275dc80, size 0x9c, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetObjectData, addr 0x275dd1c, size 0x184, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x275da74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x275dae0, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x275da7c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* target);

  /// @brief Method .ctor, addr 0x275daac, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* target, bool trackResurrection);

  /// @brief Method get_IsAlive, addr 0x275dc18, size 0x20, virtual true, abstract: false, final false
  inline bool get_IsAlive();

  /// @brief Method get_Target, addr 0x275dc38, size 0x34, virtual true, abstract: false, final false
  inline ::System::Object* get_Target();

  /// @brief Method get_TrackResurrection, addr 0x275dc78, size 0x8, virtual true, abstract: false, final false
  inline bool get_TrackResurrection();

  /// @brief Convert to "::System::Runtime::Serialization::ISerializable"
  constexpr ::System::Runtime::Serialization::ISerializable* i___System__Runtime__Serialization__ISerializable() noexcept;

  /// @brief Method set_Target, addr 0x275dc6c, size 0xc, virtual true, abstract: false, final false
