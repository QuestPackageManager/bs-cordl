...
public:
  ...
  /// @brief Method CreateObjRef, addr 0x287caf0, size 0x40, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type* requestedType);

  /// @brief Method InitializeLifetimeService, addr 0x287cb30, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x287636c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ObjectIdentity, addr 0x287ca70, size 0x40, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::ServerIdentity* get_ObjectIdentity();

  /// @brief Method set_ObjectIdentity, addr 0x287cab0, size 0x40, virtual false, abstract: false, final false
