...
public:
  ...
  /// @brief Method CreateObjRef, addr 0x3e36d80, size 0x38, virtual true, abstract: false, final false
  inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type* requestedType);

  /// @brief Method InitializeLifetimeService, addr 0x3e36db8, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e30468, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ObjectIdentity, addr 0x3e36d10, size 0x38, virtual false, abstract: false, final false
  inline ::System::Runtime::Remoting::ServerIdentity* get_ObjectIdentity();

  /// @brief Method set_ObjectIdentity, addr 0x3e36d48, size 0x38, virtual false, abstract: false, final false
