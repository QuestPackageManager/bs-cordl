...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::AssemblyLoadEventArgs::*)(::System::Reflection::Assembly*)>(
  ...
  constexpr static std::size_t addrs = 0x23c7e94;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::AssemblyLoadEventArgs*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
constexpr ::cordl_internals::to_const_pointer<::System::Reflection::Assembly*> const& System::AssemblyLoadEventArgs::__get__LoadedAssembly_k__BackingField() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____LoadedAssembly_k__BackingField;
}
