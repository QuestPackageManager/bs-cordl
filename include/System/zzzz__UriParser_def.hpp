...
namespace System {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7727)), TypeDefinitionIndex(TypeDefinitionIndex(7722)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method get_SchemeName addr 0x27cdf5c size 0x8 virtual false final false
  inline ::StringW get_SchemeName();

  /// @brief Method get_DefaultPort addr 0x27cdf64 size 0x8 virtual false final false
  inline int32_t get_DefaultPort();

  /// @brief Method OnNewUri addr 0x27cdf6c size 0x4 virtual true final false
  inline ::System::UriParser* OnNewUri();

  /// @brief Method InitializeAndValidate addr 0x27cdf70 size 0x28 virtual true final false
  inline void InitializeAndValidate(::System::Uri* uri, ByRef<::System::UriFormatException*> parsingError);

  /// @brief Method Resolve addr 0x27cdf98 size 0x1e8 virtual true final false
  inline ::StringW Resolve(::System::Uri* baseUri, ::System::Uri* relativeUri, ByRef<::System::UriFormatException*> parsingError);

  /// @brief Method IsBaseOf addr 0x27ce180 size 0x1c virtual true final false
  inline bool IsBaseOf(::System::Uri* baseUri, ::System::Uri* relativeUri);

  /// @brief Method GetComponents addr 0x27ce19c size 0x22c virtual true final false
  inline ::StringW GetComponents(::System::Uri* uri, ::System::UriComponents components, ::System::UriFormat format);

  /// @brief Method IsWellFormedOriginalString addr 0x27ce3c8 size 0x18 virtual true final false
  inline bool IsWellFormedOriginalString(::System::Uri* uri);

  /// @brief Method get_ShouldUseLegacyV2Quirks addr 0x27cddcc size 0x60 virtual false final false
  static inline bool get_ShouldUseLegacyV2Quirks();

  /// @brief Method get_Flags addr 0x27cebe4 size 0x8 virtual false final false
  inline ::System::UriSyntaxFlags get_Flags();

  /// @brief Method NotAny addr 0x27cac40 size 0x8 virtual false final false
  inline bool NotAny(::System::UriSyntaxFlags flags);

  /// @brief Method InFact addr 0x27cac24 size 0x1c virtual false final false
  inline bool InFact(::System::UriSyntaxFlags flags);

  /// @brief Method IsAllSet addr 0x27cec48 size 0x8 virtual false final false
  inline bool IsAllSet(::System::UriSyntaxFlags flags);

  /// @brief Method IsFullMatch addr 0x27cebec size 0x5c virtual false final false
  ...
  /// @brief Method .ctor addr 0x27cec50 size 0x6c virtual false final false
  inline void _ctor(::System::UriSyntaxFlags flags);

  /// @brief Method FindOrFetchAsUnknownV1Syntax addr 0x27cecbc size 0x2f0 virtual false final false
  static inline ::System::UriParser* FindOrFetchAsUnknownV1Syntax(::StringW lwrCaseScheme);

  /// @brief Method GetSyntax addr 0x27cab54 size 0xd0 virtual false final false
  static inline ::System::UriParser* GetSyntax(::StringW lwrCaseScheme);

  /// @brief Method get_IsSimple addr 0x27cefac size 0xc virtual false final false
  inline bool get_IsSimple();

  /// @brief Method InternalOnNewUri addr 0x27cefb8 size 0x44 virtual false final false
  inline ::System::UriParser* InternalOnNewUri();

  /// @brief Method InternalValidate addr 0x27ceffc size 0xc virtual false final false
  inline void InternalValidate(::System::Uri* thisUri, ByRef<::System::UriFormatException*> parsingError);

  /// @brief Method InternalResolve addr 0x27cf008 size 0xc virtual false final false
  inline ::StringW InternalResolve(::System::Uri* thisBaseUri, ::System::Uri* uriLink, ByRef<::System::UriFormatException*> parsingError);

  /// @brief Method InternalIsBaseOf addr 0x27cf014 size 0xc virtual false final false
  inline bool InternalIsBaseOf(::System::Uri* thisBaseUri, ::System::Uri* uriLink);

  /// @brief Method InternalGetComponents addr 0x27cf020 size 0xc virtual false final false
  inline ::StringW InternalGetComponents(::System::Uri* thisUri, ::System::UriComponents uriComponents, ::System::UriFormat uriFormat);

  /// @brief Method InternalIsWellFormedOriginalString addr 0x27cf02c size 0xc virtual false final false
