...
// Write type traits
MARK_REF_T(::System::PasteArguments*);
DEFINE_IL2CPP_CLASS(::System::PasteArguments*, "System", "PasteArguments");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PasteArguments", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PasteArguments(PasteArguments&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PasteArguments", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PasteArguments(PasteArgumentsconst&) = delete;
...
static_assert(sizeof(::System::PasteArguments) == 0x10, "Size mismatch!");
