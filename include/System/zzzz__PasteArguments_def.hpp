...
public:
  // Declarations
  /// @brief Method AppendArgument, addr 0x43a623c, size 0x1dc, virtual false, abstract: false, final false
  static inline void AppendArgument(::System::Text::StringBuilder* stringBuilder, ::StringW argument);

  /// @brief Method ContainsNoWhitespaceOrQuotes, addr 0x43a6418, size 0xc8, virtual false, abstract: false, final false
