...
public:
  ...
  /// @brief Method .ctor, addr 0x5b330f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int64_t cookie);

  /// @brief Method get_Cookie, addr 0x5b33108, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_Cookie();

  /// @brief Method get_Value, addr 0x5b330f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Value();

  /// @brief Method set_Value, addr 0x5b33100, size 0x8, virtual false, abstract: false, final false
