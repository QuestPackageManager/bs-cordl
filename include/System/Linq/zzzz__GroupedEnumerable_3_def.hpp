...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GroupedEnumerable_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GroupedEnumerable_3(GroupedEnumerable_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GroupedEnumerable_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GroupedEnumerable_3(GroupedEnumerable_3const&) = delete;
