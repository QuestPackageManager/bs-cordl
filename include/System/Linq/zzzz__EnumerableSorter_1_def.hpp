...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Linq::EnumerableSorter_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::EnumerableSorter_1, "System.Linq", "EnumerableSorter`1");
...
public:
  ...
  inline ::ArrayW<int32_t> Sort(::ArrayW<TElement> elements, int32_t count);
