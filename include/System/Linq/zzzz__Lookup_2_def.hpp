...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Linq::Grouping_Lookup_2__GetEnumerator_d__7);
MARK_GEN_REF_T_PTR(::System::Linq::Lookup_2);
MARK_GEN_REF_T_PTR(::System::Linq::Lookup_2_Grouping);
MARK_GEN_REF_T_PTR(::System::Linq::Lookup_2__GetEnumerator_d__12);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::Grouping_Lookup_2__GetEnumerator_d__7, "System.Linq", "Lookup`2/Grouping/<GetEnumerator>d__7");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_elements, put = __cordl_internal_set_elements)) ::ArrayW<TElement> elements;
  ...
  inline void System_Collections_Generic_ICollection_TElement__CopyTo(::ArrayW<TElement> array, int32_t arrayIndex);
  ...
  constexpr ::ArrayW<TElement> const& __cordl_internal_get_elements() const;

  constexpr ::ArrayW<TElement>& __cordl_internal_get_elements();
  ...
  constexpr void __cordl_internal_set_elements(::ArrayW<TElement> value);
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_groupings, put = __cordl_internal_set_groupings)) ::ArrayW<::System::Linq::Lookup_2_Grouping<TKey, TElement>*> groupings;
  ...
  constexpr ::ArrayW<::System::Linq::Lookup_2_Grouping<TKey, TElement>*> const& __cordl_internal_get_groupings() const;

  constexpr ::ArrayW<::System::Linq::Lookup_2_Grouping<TKey, TElement>*>& __cordl_internal_get_groupings();
  ...
  constexpr void __cordl_internal_set_groupings(::ArrayW<::System::Linq::Lookup_2_Grouping<TKey, TElement>*> value);
...
public:
  ...
  ::ArrayW<::System::Linq::Lookup_2_Grouping<TKey, TElement>*> ___groupings;
