...
template <typename TElement> constexpr ::ArrayW<::System::Linq::Set_1_Slot<TElement>, ::Array<::System::Linq::Set_1_Slot<TElement>>*>& System::Linq::Set_1<TElement>::__cordl_internal_get_slots() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
