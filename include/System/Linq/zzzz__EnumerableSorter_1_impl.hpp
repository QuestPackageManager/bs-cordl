...
template <typename TElement> inline void System::Linq::EnumerableSorter_1<TElement>::ComputeKeys(::ArrayW<TElement, ::Array<TElement>*> elements, int32_t count) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Linq::EnumerableSorter_1<TElement>*>::get(), "ComputeKeys", std::vector<Il2CppClass*>{},
...
template <typename TElement> inline int32_t System::Linq::EnumerableSorter_1<TElement>::CompareKeys(int32_t index1, int32_t index2) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Linq::EnumerableSorter_1<TElement>*>::get(), "CompareKeys", std::vector<Il2CppClass*>{},
