...
public:
  ...
  /// @brief Method Accept, addr 0x40b832c, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x40b3f88, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40b8268, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Body, addr 0x40b830c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Body();

  /// @brief Method get_Fault, addr 0x40b8324, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Fault();

  /// @brief Method get_Finally, addr 0x40b831c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Finally();

  /// @brief Method get_Handlers, addr 0x40b8314, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::CatchBlock*>* get_Handlers();

  /// @brief Method get_NodeType, addr 0x40b8304, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x40b82fc, size 0x8, virtual true, abstract: false, final true
