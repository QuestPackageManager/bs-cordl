...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubInstruction_SubDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubInstruction_SubDouble*, "System.Linq.Expressions.Interpreter", "SubInstruction/SubDouble");
...
public:
  ...
  /// @brief Method Run, addr 0x5fbdc58, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbd50c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubDouble", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubInstruction_SubDouble(SubInstruction_SubDouble&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubDouble", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubInstruction_SubDouble(SubInstruction_SubDoubleconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::SubInstruction_SubDouble) == 0x10, "Size mismatch!");
