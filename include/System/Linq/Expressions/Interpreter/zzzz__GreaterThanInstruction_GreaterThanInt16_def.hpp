...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanInstruction_GreaterThanInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanInstruction_GreaterThanInt16*, "System.Linq.Expressions.Interpreter", "GreaterThanInstruction/GreaterThanInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5f95d58, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f95c64, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction_GreaterThanInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GreaterThanInstruction_GreaterThanInt16(GreaterThanInstruction_GreaterThanInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction_GreaterThanInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GreaterThanInstruction_GreaterThanInt16(GreaterThanInstruction_GreaterThanInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GreaterThanInstruction_GreaterThanInt16) == 0x18, "Size mismatch!");
