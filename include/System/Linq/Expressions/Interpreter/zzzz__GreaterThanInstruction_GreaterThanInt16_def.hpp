...
public:
  ...
  /// @brief Method Run, addr 0x5de1200, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5de110c, size 0x8, virtual false, abstract: false, final false
