...
public:
  ...
  /// @brief Method Run, addr 0x5de2844, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5de21d4, size 0x8, virtual false, abstract: false, final false
