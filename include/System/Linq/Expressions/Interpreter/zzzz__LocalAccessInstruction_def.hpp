...
public:
  ...
  /// @brief Method ToDebugString, addr 0x5dfd3e0, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dfd3d8, size 0x8, virtual false, abstract: false, final false
