...
public:
  ...
  /// @brief Method ToDebugString, addr 0x5fb1f38, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fb1f30, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocalAccessInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocalAccessInstruction(LocalAccessInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocalAccessInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocalAccessInstruction(LocalAccessInstructionconst&) = delete;
