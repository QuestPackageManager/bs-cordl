...
public:
  ...
  /// @brief Method ToDebugString, addr 0x40eac34, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40eac0c, size 0x28, virtual false, abstract: false, final false
