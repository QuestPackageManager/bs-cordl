...
public:
  ...
  /// @brief Method Run, addr 0x5d70b90, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d70b30, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* elementType, int32_t elementCount);

  /// @brief Method get_ConsumedStack, addr 0x5d70b3c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5d70b4c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5d70b44, size 0x8, virtual true, abstract: false, final false
