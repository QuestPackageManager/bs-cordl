...
public:
  ...
  /// @brief Method Run, addr 0x5f8d274, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8d214, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* elementType, int32_t elementCount);

  /// @brief Method get_ConsumedStack, addr 0x5f8d220, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f8d230, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f8d228, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NewArrayInitInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NewArrayInitInstruction(NewArrayInitInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NewArrayInitInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NewArrayInitInstruction(NewArrayInitInstructionconst&) = delete;
