...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanSByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanSByte*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanSByte");
...
public:
  ...
  /// @brief Method Run, addr 0x5f9fe94, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9fe3c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanSByte", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanInstruction_LessThanSByte(LessThanInstruction_LessThanSByte&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanSByte", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanInstruction_LessThanSByte(LessThanInstruction_LessThanSByteconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanSByte) == 0x18, "Size mismatch!");
