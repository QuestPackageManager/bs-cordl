...
public:
  ...
  /// @brief Method Run, addr 0x5fa01c8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9fe64, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanByte", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanInstruction_LessThanByte(LessThanInstruction_LessThanByte&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanByte", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanInstruction_LessThanByte(LessThanInstruction_LessThanByteconst&) = delete;
