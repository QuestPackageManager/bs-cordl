...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CastInstruction_CastInstructionT_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CastInstruction_CastInstructionT_1(CastInstruction_CastInstructionT_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CastInstruction_CastInstructionT_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CastInstruction_CastInstructionT_1(CastInstruction_CastInstructionT_1const&) = delete;
