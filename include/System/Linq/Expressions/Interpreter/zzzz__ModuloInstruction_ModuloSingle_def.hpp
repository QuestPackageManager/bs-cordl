...
public:
  ...
  /// @brief Method Run, addr 0x5fb4e00, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb4668, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction_ModuloSingle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ModuloInstruction_ModuloSingle(ModuloInstruction_ModuloSingle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction_ModuloSingle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ModuloInstruction_ModuloSingle(ModuloInstruction_ModuloSingleconst&) = delete;
