...
public:
  ...
  /// @brief Method ToString, addr 0x5f97d70, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5f94ff4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConsumedContinuations, addr 0x5f97ce8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedContinuations();

  /// @brief Method get_ConsumedStack, addr 0x5f97cd8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ProducedStack, addr 0x5f97ce0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ProducedStack();

  /// @brief Method get_StackBalance, addr 0x5f97cf8, size 0x3c, virtual false, abstract: false, final false
