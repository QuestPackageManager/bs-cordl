...
// Write type traits
MARK_REF_T(::GlobalNamespace::NullableMethodCallInstruction_GetHashCodeClass*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullableMethodCallInstruction_GetHashCodeClass*, "System.Linq.Expressions.Interpreter", "NullableMethodCallInstruction/GetHashCodeClass");
...
public:
  ...
  /// @brief Method Run, addr 0x5fbf4c0, size 0x50, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbf150, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction_GetHashCodeClass", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullableMethodCallInstruction_GetHashCodeClass(NullableMethodCallInstruction_GetHashCodeClass&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction_GetHashCodeClass", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullableMethodCallInstruction_GetHashCodeClass(NullableMethodCallInstruction_GetHashCodeClassconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NullableMethodCallInstruction_GetHashCodeClass) == 0x10, "Size mismatch!");
