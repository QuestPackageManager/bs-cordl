...
// Write type traits
MARK_REF_T(::GlobalNamespace::IncrementInstruction_IncrementInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IncrementInstruction_IncrementInt16*, "System.Linq.Expressions.Interpreter", "IncrementInstruction/IncrementInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5f97800, size 0x68, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f977e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IncrementInstruction_IncrementInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IncrementInstruction_IncrementInt16(IncrementInstruction_IncrementInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IncrementInstruction_IncrementInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IncrementInstruction_IncrementInt16(IncrementInstruction_IncrementInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::IncrementInstruction_IncrementInt16) == 0x10, "Size mismatch!");
