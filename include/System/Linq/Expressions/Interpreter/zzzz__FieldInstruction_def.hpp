...
public:
  ...
  /// @brief Method ToString, addr 0x40ca6dc, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40ca6ac, size 0x28, virtual false, abstract: false, final false
