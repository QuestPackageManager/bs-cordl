...
public:
  ...
  /// @brief Method ToString, addr 0x5de04a0, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5de0494, size 0x8, virtual false, abstract: false, final false
