...
public:
  ...
  /// @brief Method ToString, addr 0x5e52b6c, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e52b60, size 0x8, virtual false, abstract: false, final false
