...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FieldInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FieldInstruction(FieldInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FieldInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FieldInstruction(FieldInstructionconst&) = delete;
