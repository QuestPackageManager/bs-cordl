...
public:
  ...
  /// @brief Method ToString, addr 0x5f8f7e0, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8f7d4, size 0x8, virtual false, abstract: false, final false
