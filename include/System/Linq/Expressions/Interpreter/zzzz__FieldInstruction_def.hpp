...
public:
  ...
  /// @brief Method ToString, addr 0x40cbf98, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40cbf68, size 0x28, virtual false, abstract: false, final false
