...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::EqualInstruction_EqualDouble);
...
public:
  ...
  /// @brief Method Run, addr 0x40c8acc, size 0xe8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40c8114, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
