...
public:
  ...
  /// @brief Method Fixup, addr 0x5f8f1d0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDebugString, addr 0x5f8f260, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5f8f328, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8f3f8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OffsetInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OffsetInstruction(OffsetInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OffsetInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OffsetInstruction(OffsetInstructionconst&) = delete;
