...
public:
  ...
  /// @brief Method Fixup, addr 0x404c4ec, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDebugString, addr 0x404c580, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x404c648, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x404c714, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
