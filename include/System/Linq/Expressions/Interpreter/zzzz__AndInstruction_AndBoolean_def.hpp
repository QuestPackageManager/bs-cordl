...
public:
  ...
  /// @brief Method Run, addr 0x5f8d0dc, size 0x138, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f8cb68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction_AndBoolean", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AndInstruction_AndBoolean(AndInstruction_AndBoolean&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction_AndBoolean", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AndInstruction_AndBoolean(AndInstruction_AndBooleanconst&) = delete;
