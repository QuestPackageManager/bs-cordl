...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IndexedBranchInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IndexedBranchInstruction(IndexedBranchInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IndexedBranchInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IndexedBranchInstruction(IndexedBranchInstructionconst&) = delete;
