...
public:
  ...
  /// @brief Method Run, addr 0x5fbfc18, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbfc00, size 0x8, virtual false, abstract: false, final false
