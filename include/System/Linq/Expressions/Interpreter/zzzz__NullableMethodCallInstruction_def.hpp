...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullableMethodCallInstruction(NullableMethodCallInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullableMethodCallInstruction(NullableMethodCallInstructionconst&) = delete;
