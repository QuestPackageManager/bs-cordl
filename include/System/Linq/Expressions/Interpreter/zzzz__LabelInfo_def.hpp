...
public:
  ...
  /// @brief Method <ValidateJump>b__9_0, addr 0x5e5d2d0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e5d2cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddDefinition, addr 0x5e5cd08, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method Define, addr 0x5e5cad8, size 0x1c0, virtual false, abstract: false, final false
  inline void Define(::System::Linq::Expressions::Interpreter::LabelScopeInfo* block);

  /// @brief Method DefinedIn, addr 0x5e5cf80, size 0xc8, virtual false, abstract: false, final false
  inline bool DefinedIn(::System::Linq::Expressions::Interpreter::LabelScopeInfo* scope);

  /// @brief Method EnsureLabel, addr 0x5e5c754, size 0x30, virtual false, abstract: false, final false
  inline void EnsureLabel(::System::Linq::Expressions::Interpreter::LightCompiler* compiler);

  /// @brief Method FirstDefinition, addr 0x5e5d048, size 0x18c, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::LabelScopeInfo* FirstDefinition();

  /// @brief Method GetLabel, addr 0x5e5c73c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Reference, addr 0x5e5c784, size 0xcc, virtual false, abstract: false, final false
  inline void Reference(::System::Linq::Expressions::Interpreter::LabelScopeInfo* block);

  /// @brief Method ValidateFinish, addr 0x5e5d1e4, size 0x94, virtual false, abstract: false, final false
  inline void ValidateFinish();

  /// @brief Method ValidateJump, addr 0x5e5c860, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e5c6b8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::LabelTarget* node);

  /// @brief Method get_HasDefinitions, addr 0x5e5c850, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasDefinitions();

  /// @brief Method get_HasMultipleDefinitions, addr 0x5e5cf00, size 0x80, virtual false, abstract: false, final false
