...
public:
  ...
  /// @brief Method <ValidateJump>b__9_0, addr 0x2b27d9c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b27d94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddDefinition, addr 0x2b2777c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Define, addr 0x2b27518, size 0x204, virtual false, abstract: false, final false
  inline void Define(::System::Linq::Expressions::Interpreter::LabelScopeInfo* block);

  /// @brief Method DefinedIn, addr 0x2b279d0, size 0xc0, virtual false, abstract: false, final false
  inline bool DefinedIn(::System::Linq::Expressions::Interpreter::LabelScopeInfo* scope);

  /// @brief Method EnsureLabel, addr 0x2b27180, size 0x30, virtual false, abstract: false, final false
  inline void EnsureLabel(::System::Linq::Expressions::Interpreter::LightCompiler* compiler);

  /// @brief Method FirstDefinition, addr 0x2b27a90, size 0x204, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::LabelScopeInfo* FirstDefinition();

  /// @brief Method GetLabel, addr 0x2b27168, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Reference, addr 0x2b271b0, size 0xc0, virtual false, abstract: false, final false
  inline void Reference(::System::Linq::Expressions::Interpreter::LabelScopeInfo* block);

  /// @brief Method ValidateFinish, addr 0x2b27ca4, size 0x8c, virtual false, abstract: false, final false
  inline void ValidateFinish();

  /// @brief Method ValidateJump, addr 0x2b27280, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b270d8, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::LabelTarget* node);

  /// @brief Method get_HasDefinitions, addr 0x2b27270, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasDefinitions();

  /// @brief Method get_HasMultipleDefinitions, addr 0x2b27954, size 0x7c, virtual false, abstract: false, final false
