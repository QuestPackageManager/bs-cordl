...
// Write type traits
MARK_REF_T(::GlobalNamespace::LeftShiftInstruction_LeftShiftByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LeftShiftInstruction_LeftShiftByte*, "System.Linq.Expressions.Interpreter", "LeftShiftInstruction/LeftShiftByte");
...
public:
  ...
  /// @brief Method Run, addr 0x5f9a300, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9a048, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LeftShiftInstruction_LeftShiftByte) == 0x10, "Size mismatch!");
