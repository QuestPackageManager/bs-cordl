...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotEqualInstruction(NotEqualInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotEqualInstruction(NotEqualInstructionconst&) = delete;
