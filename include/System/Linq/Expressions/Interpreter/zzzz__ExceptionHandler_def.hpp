...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExceptionHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExceptionHandler(ExceptionHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExceptionHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExceptionHandler(ExceptionHandlerconst&) = delete;
