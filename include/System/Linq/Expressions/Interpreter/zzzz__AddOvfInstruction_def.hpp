...
namespace GlobalNamespace {
class AddOvfInstruction_AddOvfInt32;
}
namespace GlobalNamespace {
...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::AddOvfInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::AddOvfInstruction*, "System.Linq.Expressions.Interpreter", "AddOvfInstruction");
...
public:
  // Declarations
  using AddOvfInt16 = ::GlobalNamespace::AddOvfInstruction_AddOvfInt16;

  using AddOvfInt32 = ::GlobalNamespace::AddOvfInstruction_AddOvfInt32;

  using AddOvfInt64 = ::GlobalNamespace::AddOvfInstruction_AddOvfInt64;

  using AddOvfUInt16 = ::GlobalNamespace::AddOvfInstruction_AddOvfUInt16;

  using AddOvfUInt32 = ::GlobalNamespace::AddOvfInstruction_AddOvfUInt32;

  using AddOvfUInt64 = ::GlobalNamespace::AddOvfInstruction_AddOvfUInt64;
  ...
  /// @brief Method Create, addr 0x5f8bcc8, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8bcc4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5f8bc70, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f8bc80, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f8bc78, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AddOvfInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AddOvfInstruction(AddOvfInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AddOvfInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AddOvfInstruction(AddOvfInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::AddOvfInstruction) == 0x10, "Size mismatch!");
