...
public:
  ...
  /// @brief Method Create, addr 0x5d6f5e4, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d6f5e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5d6f58c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5d6f59c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5d6f594, size 0x8, virtual true, abstract: false, final false
