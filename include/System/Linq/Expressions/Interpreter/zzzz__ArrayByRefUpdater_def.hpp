...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArrayByRefUpdater", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArrayByRefUpdater(ArrayByRefUpdater&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArrayByRefUpdater", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArrayByRefUpdater(ArrayByRefUpdaterconst&) = delete;
