...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x40e0fc8, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x40e0ebc, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40e0e6c, size 0x50, virtual false, abstract: false, final false
