...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x40f3408, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x40f32fc, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f32ac, size 0x50, virtual false, abstract: false, final false
