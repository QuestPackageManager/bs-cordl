...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanInstruction_GreaterThanUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanInstruction_GreaterThanUInt32*, "System.Linq.Expressions.Interpreter", "GreaterThanInstruction/GreaterThanUInt32");
...
public:
  ...
  /// @brief Method Run, addr 0x5f96130, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f95c94, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction_GreaterThanUInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GreaterThanInstruction_GreaterThanUInt32(GreaterThanInstruction_GreaterThanUInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction_GreaterThanUInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GreaterThanInstruction_GreaterThanUInt32(GreaterThanInstruction_GreaterThanUInt32const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GreaterThanInstruction_GreaterThanUInt32) == 0x18, "Size mismatch!");
