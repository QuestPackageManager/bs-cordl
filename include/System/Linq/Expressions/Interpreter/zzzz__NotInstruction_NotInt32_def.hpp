...
public:
  ...
  /// @brief Method Run, addr 0x5fb9540, size 0x74, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb9420, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotInstruction_NotInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotInstruction_NotInt32(NotInstruction_NotInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotInstruction_NotInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotInstruction_NotInt32(NotInstruction_NotInt32const&) = delete;
