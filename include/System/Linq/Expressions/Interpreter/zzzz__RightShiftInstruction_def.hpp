...
public:
  ...
  /// @brief Method Create, addr 0x40f4fb0, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f4fa8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x40f4f58, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x40f4f68, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x40f4f60, size 0x8, virtual true, abstract: false, final false
