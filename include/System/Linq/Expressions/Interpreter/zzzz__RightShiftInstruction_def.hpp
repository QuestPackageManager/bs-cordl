...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::RightShiftInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::RightShiftInstruction*, "System.Linq.Expressions.Interpreter", "RightShiftInstruction");
...
public:
  ...
  /// @brief Method Create, addr 0x5fbc22c, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbc228, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5fbc1d4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fbc1e4, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fbc1dc, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RightShiftInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RightShiftInstruction(RightShiftInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RightShiftInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RightShiftInstruction(RightShiftInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::RightShiftInstruction) == 0x10, "Size mismatch!");
