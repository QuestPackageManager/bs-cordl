...
// Write type traits
MARK_REF_T(::GlobalNamespace::MulOvfInstruction_MulOvfUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MulOvfInstruction_MulOvfUInt32*, "System.Linq.Expressions.Interpreter", "MulOvfInstruction/MulOvfUInt32");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb64a0, size 0x150, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb5f20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MulOvfInstruction_MulOvfUInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MulOvfInstruction_MulOvfUInt32(MulOvfInstruction_MulOvfUInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MulOvfInstruction_MulOvfUInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MulOvfInstruction_MulOvfUInt32(MulOvfInstruction_MulOvfUInt32const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MulOvfInstruction_MulOvfUInt32) == 0x10, "Size mismatch!");
