...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanUInt64*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanUInt64");
...
public:
  ...
  /// @brief Method Run, addr 0x5fa03b4, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9fe7c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanUInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanInstruction_LessThanUInt64(LessThanInstruction_LessThanUInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanUInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanInstruction_LessThanUInt64(LessThanInstruction_LessThanUInt64const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanUInt64) == 0x18, "Size mismatch!");
