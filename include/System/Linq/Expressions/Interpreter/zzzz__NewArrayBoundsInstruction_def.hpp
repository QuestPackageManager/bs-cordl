...
public:
  ...
  /// @brief Method Run, addr 0x5dd8a5c, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd89fc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* elementType, int32_t rank);

  /// @brief Method get_ConsumedStack, addr 0x5dd8a08, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5dd8a18, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5dd8a10, size 0x8, virtual true, abstract: false, final false
