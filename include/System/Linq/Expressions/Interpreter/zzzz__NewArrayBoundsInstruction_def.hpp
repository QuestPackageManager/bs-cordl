...
public:
  ...
  /// @brief Method Run, addr 0x5f8d5b4, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8d554, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* elementType, int32_t rank);

  /// @brief Method get_ConsumedStack, addr 0x5f8d560, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f8d570, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f8d568, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NewArrayBoundsInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NewArrayBoundsInstruction(NewArrayBoundsInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NewArrayBoundsInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NewArrayBoundsInstruction(NewArrayBoundsInstructionconst&) = delete;
