...
public:
  ...
  /// @brief Method Create, addr 0x5f9af80, size 0x8c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f9fe34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5f9fde0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f9fdf0, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f9fde8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanInstruction(LessThanInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanInstruction(LessThanInstructionconst&) = delete;
