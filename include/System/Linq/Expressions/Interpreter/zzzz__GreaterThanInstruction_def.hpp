...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GreaterThanInstruction(GreaterThanInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GreaterThanInstruction(GreaterThanInstructionconst&) = delete;
