...
public:
  ...
  /// @brief Method Create, addr 0x40d8048, size 0x960, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40d8020, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x40d7fd0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x40d7fe0, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x40d7fd8, size 0x8, virtual true, abstract: false, final false
