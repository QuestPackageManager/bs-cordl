...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullCheckInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullCheckInstruction(NullCheckInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullCheckInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullCheckInstruction(NullCheckInstructionconst&) = delete;
