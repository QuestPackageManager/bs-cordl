...
public:
  ...
  /// @brief Method .ctor, addr 0x5fb2e78, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InitializeLocalInstruction(InitializeLocalInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InitializeLocalInstruction(InitializeLocalInstructionconst&) = delete;
