...
public:
  ...
  /// @brief Method Run, addr 0x40c5320, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_InstructionName, addr 0x40c52d8, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x40c5318, size 0x8, virtual true, abstract: false, final false
