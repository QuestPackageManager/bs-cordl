...
public:
  ...
  /// @brief Method Run, addr 0x2c3558c, size 0x8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x2c3553c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Linq::Expressions::Interpreter::EnterExceptionFilterInstruction* getStaticF_Instance();

  /// @brief Method get_InstructionName, addr 0x2c35544, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x2c35584, size 0x8, virtual true, abstract: false, final false
