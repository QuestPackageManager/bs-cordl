...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction_GetValueOrDefault1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullableMethodCallInstruction_GetValueOrDefault1(NullableMethodCallInstruction_GetValueOrDefault1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction_GetValueOrDefault1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullableMethodCallInstruction_GetValueOrDefault1(NullableMethodCallInstruction_GetValueOrDefault1const&) = delete;
