...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x5dfa534, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5dfa2c0, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dfa2a4, size 0x1c, virtual false, abstract: false, final false
