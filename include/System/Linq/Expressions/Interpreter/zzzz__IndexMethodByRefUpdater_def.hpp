...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x40f3bc0, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x40f396c, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f391c, size 0x50, virtual false, abstract: false, final false
