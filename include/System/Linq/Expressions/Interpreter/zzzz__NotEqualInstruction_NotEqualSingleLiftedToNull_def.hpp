...
public:
  ...
  /// @brief Method Run, addr 0x5fb8ecc, size 0xb0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb7ffc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualSingleLiftedToNull", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotEqualInstruction_NotEqualSingleLiftedToNull(NotEqualInstruction_NotEqualSingleLiftedToNull&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualSingleLiftedToNull", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotEqualInstruction_NotEqualSingleLiftedToNull(NotEqualInstruction_NotEqualSingleLiftedToNullconst&) = delete;
