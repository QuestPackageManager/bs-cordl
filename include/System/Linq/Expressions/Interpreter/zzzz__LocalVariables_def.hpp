...
/// @brief Field ChildScopes, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_ChildScopes, put=__cordl_internal_set_ChildScopes)) ::System::Collections::Generic::List_1<::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope*>*  ChildScopes;
...
static inline ::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope* New_ctor(::System::Linq::Expressions::Interpreter::LocalVariable*  variable, int32_t  start, ::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope*  parent) ;
...
/// @brief Method .ctor, addr 0x5dffa10, size 0x10, virtual false, abstract: false, final false
...
using VariableScope = ::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope;
 ...
 __declspec(property(get=get_ClosureVariables)) ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  ClosureVariables;

 __declspec(property(get=get_LocalCount)) int32_t  LocalCount;

/// @brief Field _closureVariables, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__closureVariables, put=__cordl_internal_set__closureVariables)) ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  _closureVariables;
...
/// @brief Field _variables, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__variables, put=__cordl_internal_set__variables)) ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope*>*  _variables;

/// @brief Method AddClosureVariable, addr 0x5dffc68, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method Box, addr 0x5dffa20, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method DefineLocal, addr 0x5dff7c4, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method TryGetLocalOrClosure, addr 0x5dffb84, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method UndefineLocal, addr 0x5dfa4f8, size 0xe4, virtual false, abstract: false, final false
inline void UndefineLocal(::System::Linq::Expressions::Interpreter::LocalDefinition  definition, int32_t  end) ;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>* const& __cordl_internal_get__closureVariables() const;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*& __cordl_internal_get__closureVariables() ;
...
constexpr ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope*>* const& __cordl_internal_get__variables() const;

constexpr ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope*>*& __cordl_internal_get__variables() ;

constexpr void __cordl_internal_set__closureVariables(::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  value) ;
...
constexpr void __cordl_internal_set__variables(::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope*>*  value) ;

/// @brief Method .ctor, addr 0x5dffdb4, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ClosureVariables, addr 0x5dffc60, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_LocalCount, addr 0x5dffb7c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _variables, offset: 0x10, size: 0x8, def value: None
 ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope*>*  ____variables;
