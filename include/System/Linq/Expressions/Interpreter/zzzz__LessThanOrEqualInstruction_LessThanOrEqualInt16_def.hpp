...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt16*, "System.Linq.Expressions.Interpreter", "LessThanOrEqualInstruction/LessThanOrEqualInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5fa06f8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fa0604, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanOrEqualInstruction_LessThanOrEqualInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanOrEqualInstruction_LessThanOrEqualInt16(LessThanOrEqualInstruction_LessThanOrEqualInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanOrEqualInstruction_LessThanOrEqualInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanOrEqualInstruction_LessThanOrEqualInt16(LessThanOrEqualInstruction_LessThanOrEqualInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt16) == 0x18, "Size mismatch!");
