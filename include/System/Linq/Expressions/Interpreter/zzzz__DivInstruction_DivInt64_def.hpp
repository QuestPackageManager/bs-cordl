...
public:
  ...
  /// @brief Method Run, addr 0x5f92484, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9225c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DivInstruction_DivInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DivInstruction_DivInt64(DivInstruction_DivInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DivInstruction_DivInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DivInstruction_DivInt64(DivInstruction_DivInt64const&) = delete;
