...
public:
  ...
  /// @brief Method Run, addr 0x5f9f870, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9f850, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction_LeftShiftSByte", modifiers: "&&", def_value: None, comment: None }]
