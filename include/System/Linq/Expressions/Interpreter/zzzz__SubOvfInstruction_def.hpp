...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::SubOvfInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::SubOvfInstruction*, "System.Linq.Expressions.Interpreter", "SubOvfInstruction");
...
public:
  ...
  /// @brief Method Create, addr 0x5fbddbc, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbddb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5fbdd64, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fbdd74, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fbdd6c, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubOvfInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubOvfInstruction(SubOvfInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubOvfInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubOvfInstruction(SubOvfInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::SubOvfInstruction) == 0x10, "Size mismatch!");
