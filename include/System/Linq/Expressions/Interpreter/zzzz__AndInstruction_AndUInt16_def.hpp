...
public:
  ...
  /// @brief Method Run, addr 0x5f8cec4, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f8cb5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction_AndUInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AndInstruction_AndUInt16(AndInstruction_AndUInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction_AndUInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AndInstruction_AndUInt16(AndInstruction_AndUInt16const&) = delete;
