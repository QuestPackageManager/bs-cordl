...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LoadCachedObjectInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LoadCachedObjectInstruction(LoadCachedObjectInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LoadCachedObjectInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LoadCachedObjectInstruction(LoadCachedObjectInstructionconst&) = delete;
