...
public:
  ...
  /// @brief Method Run, addr 0x5e7a8c0, size 0x98, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToDebugString, addr 0x5e7a958, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5e7aab8, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7a86c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t index);

  /// @brief Method get_InstructionName, addr 0x5e7a87c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e7a874, size 0x8, virtual true, abstract: false, final false
