...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_Reference", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InitializeLocalInstruction_Reference(InitializeLocalInstruction_Reference&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_Reference", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InitializeLocalInstruction_Reference(InitializeLocalInstruction_Referenceconst&) = delete;
