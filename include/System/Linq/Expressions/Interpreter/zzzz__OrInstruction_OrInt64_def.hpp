...
// Write type traits
MARK_REF_T(::GlobalNamespace::OrInstruction_OrInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OrInstruction_OrInt64*, "System.Linq.Expressions.Interpreter", "OrInstruction/OrInt64");
...
public:
  ...
  /// @brief Method Run, addr 0x5fbbd24, size 0xb8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbbb14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OrInstruction_OrInt64(OrInstruction_OrInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OrInstruction_OrInt64(OrInstruction_OrInt64const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::OrInstruction_OrInt64) == 0x10, "Size mismatch!");
