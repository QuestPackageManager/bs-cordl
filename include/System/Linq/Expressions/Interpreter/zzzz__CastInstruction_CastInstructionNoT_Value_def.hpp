...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CastInstructionNoT_CastInstruction_Value", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CastInstructionNoT_CastInstruction_Value(CastInstructionNoT_CastInstruction_Value&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CastInstructionNoT_CastInstruction_Value", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CastInstructionNoT_CastInstruction_Value(CastInstructionNoT_CastInstruction_Valueconst&) = delete;
