...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x2c7f634, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c7f470, size 0x28, virtual false, abstract: false, final false
