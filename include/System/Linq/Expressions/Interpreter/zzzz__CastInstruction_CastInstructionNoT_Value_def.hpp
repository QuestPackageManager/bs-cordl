...
public:
// Declarations
/// @brief Method ConvertNull, addr 0x5e7f478, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e7f2f4, size 0x8, virtual false, abstract: false, final false
