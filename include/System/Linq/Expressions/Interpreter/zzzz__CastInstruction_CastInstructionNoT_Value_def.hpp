...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x5e7d900, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7d77c, size 0x8, virtual false, abstract: false, final false
