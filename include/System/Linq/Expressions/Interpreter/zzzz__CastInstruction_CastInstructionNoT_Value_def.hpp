...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x2b4bc34, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b4ba70, size 0x28, virtual false, abstract: false, final false
