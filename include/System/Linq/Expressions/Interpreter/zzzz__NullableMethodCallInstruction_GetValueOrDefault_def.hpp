...
public:
  ...
  /// @brief Method Run, addr 0x5fbf2a8, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbf154, size 0x34, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction_GetValueOrDefault", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullableMethodCallInstruction_GetValueOrDefault(NullableMethodCallInstruction_GetValueOrDefault&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction_GetValueOrDefault", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullableMethodCallInstruction_GetValueOrDefault(NullableMethodCallInstruction_GetValueOrDefaultconst&) = delete;
