...
/// @brief Method Run, addr 0x5e0ae10, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e0acbc, size 0x34, virtual false, abstract: false, final false
