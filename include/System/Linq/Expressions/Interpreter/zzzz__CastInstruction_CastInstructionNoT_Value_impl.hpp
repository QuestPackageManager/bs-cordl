...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::CastInstructionNoT_CastInstruction_Value::*)(::System::Type*)>(&::GlobalNamespace::CastInstructionNoT_CastInstruction_Value::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5e0b770;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::CastInstructionNoT_CastInstruction_Value*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::CastInstructionNoT_CastInstruction_Value::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::CastInstructionNoT_CastInstruction_Value::ConvertNull)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x5e0b8f4;
