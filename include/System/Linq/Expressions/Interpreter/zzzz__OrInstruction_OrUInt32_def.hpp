...
// Write type traits
MARK_REF_T(::GlobalNamespace::OrInstruction_OrUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OrInstruction_OrUInt32*, "System.Linq.Expressions.Interpreter", "OrInstruction/OrUInt32");
...
public:
  ...
  /// @brief Method Run, addr 0x5fbbf2c, size 0xb8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbbb20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrUInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OrInstruction_OrUInt32(OrInstruction_OrUInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrUInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OrInstruction_OrUInt32(OrInstruction_OrUInt32const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::OrInstruction_OrUInt32) == 0x10, "Size mismatch!");
