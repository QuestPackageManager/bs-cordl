...
/// @brief Method Run, addr 0x5e7b618, size 0xb8, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x5e7b20c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
