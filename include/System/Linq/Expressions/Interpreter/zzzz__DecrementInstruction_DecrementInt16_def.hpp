...
// Write type traits
MARK_REF_T(::GlobalNamespace::DecrementInstruction_DecrementInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DecrementInstruction_DecrementInt16*, "System.Linq.Expressions.Interpreter", "DecrementInstruction/DecrementInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5f91994, size 0x74, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f91974, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecrementInstruction_DecrementInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecrementInstruction_DecrementInt16(DecrementInstruction_DecrementInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecrementInstruction_DecrementInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecrementInstruction_DecrementInt16(DecrementInstruction_DecrementInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::DecrementInstruction_DecrementInt16) == 0x10, "Size mismatch!");
