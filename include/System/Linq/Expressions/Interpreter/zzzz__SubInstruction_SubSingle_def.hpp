...
public:
  ...
  /// @brief Method Run, addr 0x5fbdb4c, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbd508, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubSingle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubInstruction_SubSingle(SubInstruction_SubSingle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubSingle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubInstruction_SubSingle(SubInstruction_SubSingleconst&) = delete;
