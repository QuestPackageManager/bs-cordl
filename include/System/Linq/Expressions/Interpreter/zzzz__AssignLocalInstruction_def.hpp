...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::AssignLocalInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::AssignLocalInstruction*, "System.Linq.Expressions.Interpreter", "AssignLocalInstruction");
...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x5fb2720, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x5fb26a8, size 0x78, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb264c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_ConsumedStack, addr 0x5fb2654, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fb2664, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fb265c, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssignLocalInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssignLocalInstruction(AssignLocalInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssignLocalInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssignLocalInstruction(AssignLocalInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::AssignLocalInstruction) == 0x18, "Size mismatch!");
