...
public:
  ...
  /// @brief Method AddHandlerExit, addr 0x5e6f360, size 0xb8, virtual false, abstract: false, final false
  inline void AddHandlerExit(int32_t index);

  /// @brief Method AddTryStart, addr 0x5e6f278, size 0xe8, virtual false, abstract: false, final false
  inline void AddTryStart(int32_t index);

  /// @brief Method Analyze, addr 0x5e6efa0, size 0x2d8, virtual false, abstract: false, final false
  inline void Analyze();

  /// @brief Method Dedent, addr 0x5e6f448, size 0x30, virtual false, abstract: false, final false
  inline void Dedent();

  /// @brief Method EmitExits, addr 0x5e6f9a4, size 0xd4, virtual false, abstract: false, final false
  inline void EmitExits(::System::Text::StringBuilder* sb, int32_t index);

  /// @brief Method Indent, addr 0x5e6f418, size 0x30, virtual false, abstract: false, final false
  inline void Indent();
  ...
  /// @brief Method ToString, addr 0x5e6f478, size 0x52c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6d084, size 0x170, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <MakeRunDelegateCtor>b__0, addr 0x5e6fa78, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6dbd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateCustomDelegate, addr 0x5e6e378, size 0x8c0, virtual false, abstract: false, final false
  inline ::System::Delegate* CreateCustomDelegate(::System::Type* delegateType);

  /// @brief Method GetRunDelegateCtor, addr 0x5e6d1f4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeDelegate, addr 0x5e6cdd0, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Delegate* MakeDelegate(::System::Type* delegateType);

  /// @brief Method MakeFrame, addr 0x5e6cf30, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeRunDelegateCtor, addr 0x5e6d378, size 0x858, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeRunVoid0, addr 0x5e6cf98, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x5e6ec38, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method RunVoid, addr 0x5e6eda8, size 0x164, virtual false, abstract: false, final false
  inline ::System::Object* RunVoid(::ArrayW<::System::Object*, ::Array<::System::Object*>*> arguments);

  /// @brief Method RunVoid0, addr 0x5e6ce5c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6cdb0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DebugView, addr 0x5e6d014, size 0x70, virtual false, abstract: false, final false
