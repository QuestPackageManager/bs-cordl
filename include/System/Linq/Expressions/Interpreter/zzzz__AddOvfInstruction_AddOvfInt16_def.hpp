...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddOvfInstruction_AddOvfInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddOvfInstruction_AddOvfInt16*, "System.Linq.Expressions.Interpreter", "AddOvfInstruction/AddOvfInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5f8bf6c, size 0x158, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f8bf54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AddOvfInstruction_AddOvfInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AddOvfInstruction_AddOvfInt16(AddOvfInstruction_AddOvfInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AddOvfInstruction_AddOvfInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AddOvfInstruction_AddOvfInt16(AddOvfInstruction_AddOvfInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::AddOvfInstruction_AddOvfInt16) == 0x10, "Size mismatch!");
