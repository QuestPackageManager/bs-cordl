...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::AddOvfInstruction_AddOvfInt32::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(
    &::GlobalNamespace::AddOvfInstruction_AddOvfInt32::Run)> {
  constexpr static std::size_t size = 0x148;
  constexpr static std::size_t addrs = 0x5f8c0c4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::AddOvfInstruction_AddOvfInt32*>(), { ::i2c::class_of<::GlobalNamespace::AddOvfInstruction_AddOvfInt32*>(), 8 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::AddOvfInstruction_AddOvfInt32::*)()>(&::GlobalNamespace::AddOvfInstruction_AddOvfInt32::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5f8bf58;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::AddOvfInstruction_AddOvfInt32*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
inline int32_t GlobalNamespace::AddOvfInstruction_AddOvfInt32::Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::AddOvfInstruction_AddOvfInt32*>(), 8 })));
