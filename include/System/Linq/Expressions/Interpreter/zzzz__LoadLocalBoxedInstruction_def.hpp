...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::LoadLocalBoxedInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::LoadLocalBoxedInstruction*, "System.Linq.Expressions.Interpreter", "LoadLocalBoxedInstruction");
...
public:
  ...
  /// @brief Method Run, addr 0x5faca70, size 0x160, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5faca1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_InstructionName, addr 0x5faca2c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5faca24, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::LoadLocalBoxedInstruction) == 0x18, "Size mismatch!");
