...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LoadLocalBoxedInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LoadLocalBoxedInstruction(LoadLocalBoxedInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LoadLocalBoxedInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LoadLocalBoxedInstruction(LoadLocalBoxedInstructionconst&) = delete;
