...
public:
  ...
  /// @brief Method Create, addr 0x5e4e72c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x5e4e824, size 0x50, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e4e6d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstructionName, addr 0x5e4e6e0, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e4e724, size 0x8, virtual true, abstract: false, final false
