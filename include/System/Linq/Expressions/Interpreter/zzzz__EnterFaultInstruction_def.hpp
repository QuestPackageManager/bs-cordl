...
public:
  ...
  /// @brief Method Create, addr 0x5f90bb8, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x5f90cb0, size 0x50, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f90b64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstructionName, addr 0x5f90b6c, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnterFaultInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnterFaultInstruction(EnterFaultInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnterFaultInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnterFaultInstruction(EnterFaultInstructionconst&) = delete;
