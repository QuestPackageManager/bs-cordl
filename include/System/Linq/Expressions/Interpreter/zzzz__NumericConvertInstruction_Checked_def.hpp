...
public:
  ...
  /// @brief Method Convert, addr 0x5fba85c, size 0x278, virtual true, abstract: false, final false
  inline ::System::Object* Convert(::System::Object* obj);

  /// @brief Method ConvertDouble, addr 0x5fbb1c4, size 0x33c, virtual false, abstract: false, final false
  inline ::System::Object* ConvertDouble(double_t obj);

  /// @brief Method ConvertInt32, addr 0x5fbaad4, size 0x220, virtual false, abstract: false, final false
  inline ::System::Object* ConvertInt32(int32_t obj);

  /// @brief Method ConvertInt64, addr 0x5fbacf4, size 0x270, virtual false, abstract: false, final false
  inline ::System::Object* ConvertInt64(int64_t obj);

  /// @brief Method ConvertUInt64, addr 0x5fbaf64, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fba850, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::TypeCode from, ::System::TypeCode to, bool isLiftedToNull);

  /// @brief Method get_InstructionName, addr 0x5fba80c, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NumericConvertInstruction_Checked", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NumericConvertInstruction_Checked(NumericConvertInstruction_Checked&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NumericConvertInstruction_Checked", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NumericConvertInstruction_Checked(NumericConvertInstruction_Checkedconst&) = delete;
