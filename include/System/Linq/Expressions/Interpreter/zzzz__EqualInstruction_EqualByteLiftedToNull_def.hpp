...
public:
  ...
  /// @brief Method Run, addr 0x5f93f4c, size 0xb0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f932ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualByteLiftedToNull", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EqualInstruction_EqualByteLiftedToNull(EqualInstruction_EqualByteLiftedToNull&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualByteLiftedToNull", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EqualInstruction_EqualByteLiftedToNull(EqualInstruction_EqualByteLiftedToNullconst&) = delete;
