...
public:
  ...
  /// @brief Method Run, addr 0x5fa0458, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9fe84, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanSingle", modifiers: "&&", def_value: None, comment: None }]
