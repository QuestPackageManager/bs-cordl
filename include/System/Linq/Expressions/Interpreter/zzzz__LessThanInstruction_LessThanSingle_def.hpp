...
public:
  ...
  /// @brief Method Run, addr 0x2c5ba54, size 0xe4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x2c5b248, size 0x28, virtual false, abstract: false, final false
