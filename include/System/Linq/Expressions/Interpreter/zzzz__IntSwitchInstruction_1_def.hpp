...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IntSwitchInstruction_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IntSwitchInstruction_1(IntSwitchInstruction_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IntSwitchInstruction_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IntSwitchInstruction_1(IntSwitchInstruction_1const&) = delete;
