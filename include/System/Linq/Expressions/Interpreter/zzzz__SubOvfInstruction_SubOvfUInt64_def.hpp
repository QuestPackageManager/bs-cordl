...
public:
  ...
  /// @brief Method Run, addr 0x5fbe6e8, size 0x148, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbe05c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubOvfInstruction_SubOvfUInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubOvfInstruction_SubOvfUInt64(SubOvfInstruction_SubOvfUInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubOvfInstruction_SubOvfUInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubOvfInstruction_SubOvfUInt64(SubOvfInstruction_SubOvfUInt64const&) = delete;
