...
public:
  ...
  /// @brief Method Run, addr 0x5fbd828, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbd4fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubUInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubInstruction_SubUInt16(SubInstruction_SubUInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubUInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubInstruction_SubUInt16(SubInstruction_SubUInt16const&) = delete;
