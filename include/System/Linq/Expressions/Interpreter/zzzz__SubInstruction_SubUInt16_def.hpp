...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::SubInstruction_SubUInt16);
...
public:
  ...
  /// @brief Method Run, addr 0x41041d0, size 0x148, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x4103de4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
