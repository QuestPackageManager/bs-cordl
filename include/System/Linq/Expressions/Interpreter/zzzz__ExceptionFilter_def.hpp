...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::ExceptionFilter*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::ExceptionFilter*, "System.Linq.Expressions.Interpreter", "ExceptionFilter");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5fa0d60, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExceptionFilter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExceptionFilter(ExceptionFilter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExceptionFilter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExceptionFilter(ExceptionFilterconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::ExceptionFilter) == 0x20, "Size mismatch!");
