...
public:
  // Declarations
  /// @brief Method ToInt32NoNull, addr 0x5f8d400, size 0x154, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConvertHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConvertHelper(ConvertHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConvertHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConvertHelper(ConvertHelperconst&) = delete;
