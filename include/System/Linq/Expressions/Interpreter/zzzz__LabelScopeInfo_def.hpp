...
public:
  ...
  /// @brief Method AddLabelInfo, addr 0x5e5ce58, size 0xa8, virtual false, abstract: false, final false
  inline void AddLabelInfo(::System::Linq::Expressions::LabelTarget* target, ::System::Linq::Expressions::Interpreter::LabelInfo* info);

  /// @brief Method ContainsTarget, addr 0x5e5cc98, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetLabelInfo, addr 0x5e5d2f0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e5d2e4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanJumpInto, addr 0x5e5d1d4, size 0x10, virtual false, abstract: false, final false
