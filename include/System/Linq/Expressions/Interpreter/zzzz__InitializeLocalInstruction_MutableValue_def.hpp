...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x40f8108, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x40f7fec, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f7fbc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, ::System::Type* type);

  /// @brief Method get_InstructionName, addr 0x40f81b4, size 0x40, virtual true, abstract: false, final false
