...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x2b3cda0, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x2b3cc84, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b3cc54, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, ::System::Type* type);

  /// @brief Method get_InstructionName, addr 0x2b3ce54, size 0x40, virtual true, abstract: false, final false
