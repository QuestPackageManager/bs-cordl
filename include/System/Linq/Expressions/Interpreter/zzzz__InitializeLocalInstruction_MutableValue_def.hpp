...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x40e5cc8, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x40e5bac, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40e5b7c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, ::System::Type* type);

  /// @brief Method get_InstructionName, addr 0x40e5d74, size 0x40, virtual true, abstract: false, final false
