...
// Write type traits
MARK_REF_T(::GlobalNamespace::NegateInstruction_NegateInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NegateInstruction_NegateInt32*, "System.Linq.Expressions.Interpreter", "NegateInstruction/NegateInt32");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb6a70, size 0x74, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb69ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NegateInstruction_NegateInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NegateInstruction_NegateInt32(NegateInstruction_NegateInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NegateInstruction_NegateInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NegateInstruction_NegateInt32(NegateInstruction_NegateInt32const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NegateInstruction_NegateInt32) == 0x10, "Size mismatch!");
