...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::System::Linq::Expressions::Interpreter::FieldInstruction::*)()>(
  ...
  constexpr static std::size_t addrs = 0x2b1d5b4;
...
constexpr ::cordl_internals::to_const_pointer<::System::Reflection::FieldInfo*> const& System::Linq::Expressions::Interpreter::FieldInstruction::__cordl_internal_get__field() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____field;
}
