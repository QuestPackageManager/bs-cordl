...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanUInt16*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanUInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5fa026c, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9fe6c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanUInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanInstruction_LessThanUInt16(LessThanInstruction_LessThanUInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanUInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanInstruction_LessThanUInt16(LessThanInstruction_LessThanUInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanUInt16) == 0x18, "Size mismatch!");
