...
/// @brief Field s_cache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::ArrayW<::System::Linq::Expressions::Interpreter::Instruction*,::Array<::System::Linq::Expressions::Interpreter::Instruction*>*>  s_cache;

static inline ::System::Linq::Expressions::Interpreter::BranchTrueInstruction* New_ctor() ;

/// @brief Method Run, addr 0x5ddb184, size 0x5c, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x5ddb1e0, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Cache, addr 0x5ddb0ac, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method get_ConsumedStack, addr 0x5ddb17c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x5ddb138, size 0x44, virtual true, abstract: false, final false
