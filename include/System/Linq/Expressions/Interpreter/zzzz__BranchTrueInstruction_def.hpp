...
public:
  ...
  /// @brief Method Run, addr 0x40c8244, size 0x90, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40c82d4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Cache, addr 0x40c8178, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x40c823c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x40c81fc, size 0x40, virtual true, abstract: false, final false
