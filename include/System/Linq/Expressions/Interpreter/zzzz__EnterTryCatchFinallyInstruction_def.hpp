...
public:
  ...
  /// @brief Method CreateTryCatch, addr 0x5d738c0, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Linq::Expressions::Interpreter::EnterTryCatchFinallyInstruction* CreateTryCatch();

  /// @brief Method CreateTryFinally, addr 0x5d73868, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x5d73914, size 0x4f8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method SetTryHandler, addr 0x5d73844, size 0x8, virtual false, abstract: false, final false
  inline void SetTryHandler(::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler* tryHandler);

  /// @brief Method ToString, addr 0x5d73e88, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d7385c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t targetIndex, bool hasFinally);

  /// @brief Method get_Handler, addr 0x5d7384c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler* get_Handler();

  /// @brief Method get_InstructionName, addr 0x5d73e0c, size 0x7c, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedContinuations, addr 0x5d73854, size 0x8, virtual true, abstract: false, final false
