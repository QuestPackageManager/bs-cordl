...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanInstruction_GreaterThanUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanInstruction_GreaterThanUInt64*, "System.Linq.Expressions.Interpreter", "GreaterThanInstruction/GreaterThanUInt64");
...
public:
  ...
  /// @brief Method Run, addr 0x5f961d4, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f95c9c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction_GreaterThanUInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GreaterThanInstruction_GreaterThanUInt64(GreaterThanInstruction_GreaterThanUInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction_GreaterThanUInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GreaterThanInstruction_GreaterThanUInt64(GreaterThanInstruction_GreaterThanUInt64const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GreaterThanInstruction_GreaterThanUInt64) == 0x18, "Size mismatch!");
