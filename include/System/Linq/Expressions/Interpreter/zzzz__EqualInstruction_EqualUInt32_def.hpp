...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualUInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EqualInstruction_EqualUInt32(EqualInstruction_EqualUInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualUInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EqualInstruction_EqualUInt32(EqualInstruction_EqualUInt32const&) = delete;
