...
public:
  ...
  /// @brief Method CreateDelegate, addr 0x5e6cd1c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Delegate* CreateDelegate();

  /// @brief Method CreateDelegate, addr 0x5e6cd24, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6cd0c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Interpreter, addr 0x5e6cd14, size 0x8, virtual false, abstract: false, final false
