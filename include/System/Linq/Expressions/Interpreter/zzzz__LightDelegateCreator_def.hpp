...
public:
  ...
  /// @brief Method CreateDelegate, addr 0x40f3cf0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Delegate* CreateDelegate();

  /// @brief Method CreateDelegate, addr 0x40f3cf8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f3cbc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Interpreter, addr 0x40f3ce8, size 0x8, virtual false, abstract: false, final false
