...
public:
  ...
  /// @brief Method Run, addr 0x5f97ac0, size 0x84, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f977f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IncrementInstruction_IncrementUInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IncrementInstruction_IncrementUInt32(IncrementInstruction_IncrementUInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IncrementInstruction_IncrementUInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IncrementInstruction_IncrementUInt32(IncrementInstruction_IncrementUInt32const&) = delete;
