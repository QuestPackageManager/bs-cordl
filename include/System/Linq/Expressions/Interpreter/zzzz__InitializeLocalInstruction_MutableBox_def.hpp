...
public:
  ...
  /// @brief Method Run, addr 0x5fb36d0, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fb3680, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, ::System::Type* type);

  /// @brief Method get_InstructionName, addr 0x5fb3820, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_MutableBox", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InitializeLocalInstruction_MutableBox(InitializeLocalInstruction_MutableBox&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_MutableBox", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InitializeLocalInstruction_MutableBox(InitializeLocalInstruction_MutableBoxconst&) = delete;
