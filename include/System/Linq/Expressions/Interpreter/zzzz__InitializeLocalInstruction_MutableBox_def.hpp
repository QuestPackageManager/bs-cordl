...
public:
  ...
  /// @brief Method Run, addr 0x5fadeb8, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fade68, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, ::System::Type* type);

  /// @brief Method get_InstructionName, addr 0x5fae008, size 0x44, virtual true, abstract: false, final false
