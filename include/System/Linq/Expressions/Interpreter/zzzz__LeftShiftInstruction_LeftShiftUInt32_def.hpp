...
public:
  ...
  /// @brief Method Run, addr 0x405ee80, size 0x100, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x405e8fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
