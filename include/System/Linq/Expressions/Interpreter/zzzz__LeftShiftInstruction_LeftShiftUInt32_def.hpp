...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction_LeftShiftUInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeftShiftInstruction_LeftShiftUInt32(LeftShiftInstruction_LeftShiftUInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction_LeftShiftUInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeftShiftInstruction_LeftShiftUInt32(LeftShiftInstruction_LeftShiftUInt32const&) = delete;
