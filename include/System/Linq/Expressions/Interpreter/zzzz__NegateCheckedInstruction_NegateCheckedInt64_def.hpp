...
public:
  ...
  /// @brief Method Run, addr 0x5e74b7c, size 0xdc, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e749fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
