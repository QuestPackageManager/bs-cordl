...
public:
  ...
  /// @brief Method Run, addr 0x5fb7008, size 0xdc, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb6e88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NegateCheckedInstruction_NegateCheckedInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NegateCheckedInstruction_NegateCheckedInt64(NegateCheckedInstruction_NegateCheckedInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NegateCheckedInstruction_NegateCheckedInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NegateCheckedInstruction_NegateCheckedInt64(NegateCheckedInstruction_NegateCheckedInt64const&) = delete;
