...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSingle*, "System.Linq.Expressions.Interpreter", "GreaterThanOrEqualInstruction/GreaterThanOrEqualSingle");
...
public:
  ...
  /// @brief Method Run, addr 0x5f972f8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f96d24, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanOrEqualInstruction_GreaterThanOrEqualSingle", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanOrEqualInstruction_GreaterThanOrEqualSingle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GreaterThanOrEqualInstruction_GreaterThanOrEqualSingle(GreaterThanOrEqualInstruction_GreaterThanOrEqualSingleconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSingle) == 0x18, "Size mismatch!");
