...
public:
  ...
  /// @brief Method Run, addr 0x404f374, size 0xb4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x404eebc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
