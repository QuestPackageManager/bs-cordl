...
public:
  ...
  /// @brief Method Create, addr 0x2c34f34, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x2c35050, size 0x6c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x2c34ebc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedContinuations, addr 0x2c34f2c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedContinuations();

  /// @brief Method get_InstructionName, addr 0x2c34ee4, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x2c34f24, size 0x8, virtual true, abstract: false, final false
