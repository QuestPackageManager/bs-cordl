...
public:
  ...
  __declspec(property(get = __cordl_internal_get__debugInfos,
                      put = __cordl_internal_set__debugInfos)) ::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*, ::Array<::System::Linq::Expressions::Interpreter::DebugInfo*>*>
      _debugInfos;
  ...
  __declspec(property(get = __cordl_internal_get__labels,
                      put = __cordl_internal_set__labels)) ::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel, ::Array<::System::Linq::Expressions::Interpreter::RuntimeLabel>*>
      _labels;
  ...
  /// @brief Method Run, addr 0x40d9340, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40d9248, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ClosureSize, addr 0x40d92cc, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_ClosureSize();

  /// @brief Method get_ClosureVariables, addr 0x40d9338, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Instructions, addr 0x40d9324, size 0x14, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::InstructionArray get_Instructions();

  /// @brief Method get_LocalCount, addr 0x40d92c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LocalCount();

  /// @brief Method get_Name, addr 0x40d92bc, size 0x8, virtual false, abstract: false, final false
