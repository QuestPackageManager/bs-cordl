...
public:
  ...
  /// @brief Method Run, addr 0x5e5c5d8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e5c50c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ClosureSize, addr 0x5e5c560, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_ClosureSize();

  /// @brief Method get_ClosureVariables, addr 0x5e5c5d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Instructions, addr 0x5e5c5bc, size 0x14, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::InstructionArray get_Instructions();

  /// @brief Method get_LocalCount, addr 0x5e5c558, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LocalCount();

  /// @brief Method get_Name, addr 0x5e5c550, size 0x8, virtual false, abstract: false, final false
