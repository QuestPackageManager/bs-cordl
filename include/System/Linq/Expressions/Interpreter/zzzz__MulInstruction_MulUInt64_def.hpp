...
public:
  ...
  /// @brief Method Run, addr 0x5fb5908, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb53cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MulInstruction_MulUInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MulInstruction_MulUInt64(MulInstruction_MulUInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MulInstruction_MulUInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MulInstruction_MulUInt64(MulInstruction_MulUInt64const&) = delete;
