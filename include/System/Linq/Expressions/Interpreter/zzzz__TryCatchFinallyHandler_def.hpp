...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TryCatchFinallyHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TryCatchFinallyHandler(TryCatchFinallyHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TryCatchFinallyHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TryCatchFinallyHandler(TryCatchFinallyHandlerconst&) = delete;
