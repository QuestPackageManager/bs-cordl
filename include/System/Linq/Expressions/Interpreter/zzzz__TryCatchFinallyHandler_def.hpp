...
public:
  ...
  /// @brief Method FilterPasses, addr 0x5f9b854, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasHandler, addr 0x5f9b6f4, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f9b6e0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t tryStart, int32_t tryEnd, int32_t gotoEndLabelIndex, int32_t finallyStart, int32_t finallyEnd,
                    ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*> handlers);

  /// @brief Method .ctor, addr 0x5f9b6c8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Handlers, addr 0x5f9b6b0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*> get_Handlers();

  /// @brief Method get_IsCatchBlockExist, addr 0x5f9b6b8, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsCatchBlockExist();

  /// @brief Method get_IsFinallyBlockExist, addr 0x5f9b69c, size 0x14, virtual false, abstract: false, final false
