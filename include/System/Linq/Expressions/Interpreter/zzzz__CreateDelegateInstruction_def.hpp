...
public:
  ...
  /// @brief Method Run, addr 0x40f7f50, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f7ebc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Interpreter::LightDelegateCreator* delegateCreator);

  /// @brief Method get_ConsumedStack, addr 0x40f7ee4, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x40f7f10, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x40f7f08, size 0x8, virtual true, abstract: false, final false
