...
public:
  ...
  /// @brief Method Run, addr 0x5fb9090, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fb9018, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Interpreter::LightDelegateCreator* delegateCreator);

  /// @brief Method get_ConsumedStack, addr 0x5fb9020, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fb904c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fb9044, size 0x8, virtual true, abstract: false, final false
