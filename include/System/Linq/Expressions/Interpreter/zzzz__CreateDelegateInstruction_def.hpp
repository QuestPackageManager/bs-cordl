...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::CreateDelegateInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::CreateDelegateInstruction*, "System.Linq.Expressions.Interpreter", "CreateDelegateInstruction");
...
public:
  ...
  /// @brief Method Run, addr 0x5fbe8a8, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbe830, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Interpreter::LightDelegateCreator* delegateCreator);

  /// @brief Method get_ConsumedStack, addr 0x5fbe838, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fbe864, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fbe85c, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CreateDelegateInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CreateDelegateInstruction(CreateDelegateInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CreateDelegateInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CreateDelegateInstruction(CreateDelegateInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::CreateDelegateInstruction) == 0x18, "Size mismatch!");
