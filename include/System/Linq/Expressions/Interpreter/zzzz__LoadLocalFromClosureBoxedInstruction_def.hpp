...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LoadLocalFromClosureBoxedInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LoadLocalFromClosureBoxedInstruction(LoadLocalFromClosureBoxedInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LoadLocalFromClosureBoxedInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LoadLocalFromClosureBoxedInstruction(LoadLocalFromClosureBoxedInstructionconst&) = delete;
