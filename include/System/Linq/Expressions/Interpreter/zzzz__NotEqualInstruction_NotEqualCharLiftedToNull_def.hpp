...
public:
  ...
  /// @brief Method Run, addr 0x5fb89fc, size 0xb0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb7fe0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualCharLiftedToNull", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotEqualInstruction_NotEqualCharLiftedToNull(NotEqualInstruction_NotEqualCharLiftedToNull&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualCharLiftedToNull", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotEqualInstruction_NotEqualCharLiftedToNull(NotEqualInstruction_NotEqualCharLiftedToNullconst&) = delete;
