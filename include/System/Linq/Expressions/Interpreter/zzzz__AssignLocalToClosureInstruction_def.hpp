...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssignLocalToClosureInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssignLocalToClosureInstruction(AssignLocalToClosureInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssignLocalToClosureInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssignLocalToClosureInstruction(AssignLocalToClosureInstructionconst&) = delete;
