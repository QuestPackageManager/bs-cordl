...
/// @brief Method ToString, addr 0x5dff5d8, size 0x118, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5dff5c4, size 0x14, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, bool  closure) ;

/// @brief Method get_InClosure, addr 0x5dfa3a0, size 0xc, virtual false, abstract: false, final false
inline bool get_InClosure() ;

/// @brief Method get_IsBoxed, addr 0x5dfa3ac, size 0xc, virtual false, abstract: false, final false
inline bool get_IsBoxed() ;

/// @brief Method set_IsBoxed, addr 0x5dff5b4, size 0x10, virtual false, abstract: false, final false
