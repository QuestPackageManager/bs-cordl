...
public:
  ...
  /// @brief Method Create, addr 0x5fb6794, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fb6790, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5fb673c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fb674c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fb6744, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NegateInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NegateInstruction(NegateInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NegateInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NegateInstruction(NegateInstructionconst&) = delete;
