...
public:
  ...
  /// @brief Method Create, addr 0x40eff58, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40eff50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x40eff00, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x40eff10, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x40eff08, size 0x8, virtual true, abstract: false, final false
