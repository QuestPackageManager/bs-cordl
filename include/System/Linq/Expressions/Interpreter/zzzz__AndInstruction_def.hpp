...
public:
  ...
  /// @brief Method Create, addr 0x5f8c7b4, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8c7b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5f8c75c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f8c76c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f8c764, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AndInstruction(AndInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AndInstruction(AndInstructionconst&) = delete;
