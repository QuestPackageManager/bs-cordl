...
public:
  ...
  /// @brief Method Run, addr 0x2b4bd64, size 0x48c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b4bd3c, size 0x28, virtual false, abstract: false, final false
