...
/// @brief Method Run, addr 0x5e0b9b8, size 0x3dc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e0b9b0, size 0x8, virtual false, abstract: false, final false
