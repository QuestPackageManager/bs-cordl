...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CastReferenceToEnumInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CastReferenceToEnumInstruction(CastReferenceToEnumInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CastReferenceToEnumInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CastReferenceToEnumInstruction(CastReferenceToEnumInstructionconst&) = delete;
