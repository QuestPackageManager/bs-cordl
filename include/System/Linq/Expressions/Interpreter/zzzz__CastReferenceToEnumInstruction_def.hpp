...
public:
  ...
  /// @brief Method Run, addr 0x2c7f764, size 0x48c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c7f73c, size 0x28, virtual false, abstract: false, final false
