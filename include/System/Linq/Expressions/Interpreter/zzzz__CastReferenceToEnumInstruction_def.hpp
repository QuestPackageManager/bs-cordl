...
public:
  ...
  /// @brief Method Run, addr 0x40fb2b8, size 0x4cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40fb290, size 0x28, virtual false, abstract: false, final false
