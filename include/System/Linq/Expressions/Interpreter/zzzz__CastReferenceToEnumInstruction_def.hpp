...
public:
  ...
  /// @brief Method Run, addr 0x4082628, size 0x4cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4082600, size 0x28, virtual false, abstract: false, final false
