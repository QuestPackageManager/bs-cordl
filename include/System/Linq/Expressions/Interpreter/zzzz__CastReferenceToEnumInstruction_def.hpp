...
public:
  ...
  /// @brief Method Run, addr 0x40f4b00, size 0x4cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f4ad8, size 0x28, virtual false, abstract: false, final false
