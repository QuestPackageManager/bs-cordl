...
public:
  ...
  /// @brief Method Run, addr 0x5e7d9c4, size 0x3dc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7d9bc, size 0x8, virtual false, abstract: false, final false
