...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RuntimeVariables", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RuntimeVariables(RuntimeVariables&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RuntimeVariables", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RuntimeVariables(RuntimeVariablesconst&) = delete;
