...
public:
  ...
  /// @brief Method Create, addr 0x2c3baf4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c46a64, size 0x28, virtual false, abstract: false, final false
