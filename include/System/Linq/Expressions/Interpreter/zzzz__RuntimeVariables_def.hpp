...
public:
  ...
  /// @brief Method Create, addr 0x5e71570, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e7a6ec, size 0x8, virtual false, abstract: false, final false
