...
/// @brief Field _boxes, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__boxes, put=__cordl_internal_set__boxes)) ::ArrayW<::System::Runtime::CompilerServices::IStrongBox*,::Array<::System::Runtime::CompilerServices::IStrongBox*>*>  _boxes;
...
/// @brief Method Create, addr 0x5dff564, size 0x50, virtual false, abstract: false, final false
static inline ::System::Runtime::CompilerServices::IRuntimeVariables* Create(::ArrayW<::System::Runtime::CompilerServices::IStrongBox*,::Array<::System::Runtime::CompilerServices::IStrongBox*>*>  boxes) ;

static inline ::System::Linq::Expressions::Interpreter::RuntimeVariables* New_ctor(::ArrayW<::System::Runtime::CompilerServices::IStrongBox*,::Array<::System::Runtime::CompilerServices::IStrongBox*>*>  boxes) ;
...
/// @brief Method .ctor, addr 0x5e086e0, size 0x8, virtual false, abstract: false, final false
