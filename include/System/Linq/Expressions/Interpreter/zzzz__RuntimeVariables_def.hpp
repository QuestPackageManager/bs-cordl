...
public:
  ...
  /// @brief Method Create, addr 0x5dfeea4, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e08020, size 0x8, virtual false, abstract: false, final false
