...
public:
  ...
  /// @brief Method Create, addr 0x2b3f1f4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b4a164, size 0x28, virtual false, abstract: false, final false
