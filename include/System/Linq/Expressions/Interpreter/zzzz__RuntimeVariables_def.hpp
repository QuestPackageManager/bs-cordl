...
public:
  ...
  /// @brief Method Create, addr 0x40f8554, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41033ec, size 0x28, virtual false, abstract: false, final false
