...
public:
  ...
  /// @brief Method Create, addr 0x40ec8cc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f7764, size 0x28, virtual false, abstract: false, final false
