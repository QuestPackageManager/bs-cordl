...
public:
  ...
  /// @brief Method Run, addr 0x5f8ecdc, size 0x4f4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5f8ec64, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ProducedStack, addr 0x5f8ec74, size 0x68, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ByRefMethodInfoCallInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ByRefMethodInfoCallInstruction(ByRefMethodInfoCallInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ByRefMethodInfoCallInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ByRefMethodInfoCallInstruction(ByRefMethodInfoCallInstructionconst&) = delete;
