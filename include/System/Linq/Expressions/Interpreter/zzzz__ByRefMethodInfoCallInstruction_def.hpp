...
public:
  ...
  /// @brief Method Run, addr 0x40c4cd4, size 0x4a8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x40c4be4, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* target, int32_t argumentCount,
                    ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*, ::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*> byrefArgs);

  /// @brief Method get_ProducedStack, addr 0x40c4c24, size 0xb0, virtual true, abstract: false, final false
