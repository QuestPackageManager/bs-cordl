...
public:
  // Declarations
  /// @brief Method GetPrimitiveDefaultValue, addr 0x5e7e548, size 0x2e0, virtual false, abstract: false, final false
  static inline ::System::Object* GetPrimitiveDefaultValue(::System::Type* type);

  /// @brief Method Int32ToObject, addr 0x5e723f8, size 0x13c, virtual false, abstract: false, final false
