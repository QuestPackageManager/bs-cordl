...
public:
  // Declarations
  /// @brief Method GetPrimitiveDefaultValue, addr 0x40fbeb4, size 0x31c, virtual false, abstract: false, final false
  static inline ::System::Object* GetPrimitiveDefaultValue(::System::Type* type);

  /// @brief Method Int32ToObject, addr 0x40ed834, size 0x148, virtual false, abstract: false, final false
