...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScriptingRuntimeHelpers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScriptingRuntimeHelpers(ScriptingRuntimeHelpers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScriptingRuntimeHelpers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScriptingRuntimeHelpers(ScriptingRuntimeHelpersconst&) = delete;
