...
public:
  ...
  /// @brief Method Convert, addr 0x5fbb550, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbb544, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::TypeCode to, bool isLiftedToNull);

  /// @brief Method get_InstructionName, addr 0x5fbb500, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NumericConvertInstruction_ToUnderlying", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NumericConvertInstruction_ToUnderlying(NumericConvertInstruction_ToUnderlying&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NumericConvertInstruction_ToUnderlying", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NumericConvertInstruction_ToUnderlying(NumericConvertInstruction_ToUnderlyingconst&) = delete;
