...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualReference*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualReference*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualReference");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb8848, size 0x54, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb8034, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualReference", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotEqualInstruction_NotEqualReference(NotEqualInstruction_NotEqualReference&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualReference", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotEqualInstruction_NotEqualReference(NotEqualInstruction_NotEqualReferenceconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualReference) == 0x10, "Size mismatch!");
