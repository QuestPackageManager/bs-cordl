...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::ModuloInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::ModuloInstruction*, "System.Linq.Expressions.Interpreter", "ModuloInstruction");
...
public:
  ...
  /// @brief Method Create, addr 0x5fb4308, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fb4304, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5fb42b0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fb42c0, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fb42b8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ModuloInstruction(ModuloInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ModuloInstruction(ModuloInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::ModuloInstruction) == 0x10, "Size mismatch!");
