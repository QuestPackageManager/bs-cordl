...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::AddInstruction_AddDouble);
...
public:
  ...
  /// @brief Method Run, addr 0x40be044, size 0x148, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40bd754, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
