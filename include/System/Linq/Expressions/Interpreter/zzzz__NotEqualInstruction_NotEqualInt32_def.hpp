...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualInt32*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualInt32");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb82e8, size 0xac, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb8014, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotEqualInstruction_NotEqualInt32(NotEqualInstruction_NotEqualInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotEqualInstruction_NotEqualInt32(NotEqualInstruction_NotEqualInt32const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualInt32) == 0x10, "Size mismatch!");
