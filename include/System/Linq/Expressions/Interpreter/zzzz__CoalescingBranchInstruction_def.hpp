...
public:
  ...
  /// @brief Method Run, addr 0x2b14d30, size 0x34, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x2b14d64, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Cache, addr 0x2b14c5c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x2b14d20, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x2b14ce0, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x2b14d28, size 0x8, virtual true, abstract: false, final false
