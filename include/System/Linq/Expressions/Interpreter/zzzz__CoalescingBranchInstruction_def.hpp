...
public:
  ...
  /// @brief Method Run, addr 0x5e4d2d8, size 0x34, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e4d30c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Cache, addr 0x5e4d1f8, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5e4d2c8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e4d284, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e4d2d0, size 0x8, virtual true, abstract: false, final false
