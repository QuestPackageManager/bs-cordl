...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x5fb3008, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x5fb2f9c, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fb2f90, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, ::System::Object* defaultValue);

  /// @brief Method get_InstructionName, addr 0x5fb308c, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_ImmutableValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InitializeLocalInstruction_ImmutableValue(InitializeLocalInstruction_ImmutableValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_ImmutableValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InitializeLocalInstruction_ImmutableValue(InitializeLocalInstruction_ImmutableValueconst&) = delete;
