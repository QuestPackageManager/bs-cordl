...
/// @brief Method BoxIfIndexMatches, addr 0x5dfeb70, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x5dfeb04, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5dfeaf8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, ::System::Object*  defaultValue) ;

/// @brief Method get_InstructionName, addr 0x5dfebf4, size 0x44, virtual true, abstract: false, final false
