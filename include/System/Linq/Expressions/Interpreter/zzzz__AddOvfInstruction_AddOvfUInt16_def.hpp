...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddOvfInstruction_AddOvfUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddOvfInstruction_AddOvfUInt16*, "System.Linq.Expressions.Interpreter", "AddOvfInstruction/AddOvfUInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5f8c374, size 0x14c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f8bf60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AddOvfInstruction_AddOvfUInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AddOvfInstruction_AddOvfUInt16(AddOvfInstruction_AddOvfUInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AddOvfInstruction_AddOvfUInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AddOvfInstruction_AddOvfUInt16(AddOvfInstruction_AddOvfUInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::AddOvfInstruction_AddOvfUInt16) == 0x10, "Size mismatch!");
