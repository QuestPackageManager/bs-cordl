...
public:
  ...
  /// @brief Method Run, addr 0x5fbf43c, size 0x84, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbf18c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction_ToStringClass", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullableMethodCallInstruction_ToStringClass(NullableMethodCallInstruction_ToStringClass&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullableMethodCallInstruction_ToStringClass", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullableMethodCallInstruction_ToStringClass(NullableMethodCallInstruction_ToStringClassconst&) = delete;
