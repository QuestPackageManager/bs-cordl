...
public:
  ...
  /// @brief Method Run, addr 0x5fb6e8c, size 0xc0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb6e84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NegateCheckedInstruction_NegateCheckedInt32", modifiers: "&&", def_value: None, comment: None }]
