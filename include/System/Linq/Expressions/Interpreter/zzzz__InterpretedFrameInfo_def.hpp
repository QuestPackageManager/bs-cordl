...
public:
// Declarations
/// @brief Method ToString, addr 0x5e60c90, size 0x7c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x5e5df3c, size 0x8, virtual false, abstract: false, final false
