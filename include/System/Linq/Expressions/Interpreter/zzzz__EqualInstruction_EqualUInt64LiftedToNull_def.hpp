...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualUInt64LiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualUInt64LiftedToNull*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualUInt64LiftedToNull");
...
public:
  ...
  /// @brief Method Run, addr 0x5f9415c, size 0xb0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f932b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualUInt64LiftedToNull", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EqualInstruction_EqualUInt64LiftedToNull(EqualInstruction_EqualUInt64LiftedToNull&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualUInt64LiftedToNull", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EqualInstruction_EqualUInt64LiftedToNull(EqualInstruction_EqualUInt64LiftedToNullconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualUInt64LiftedToNull) == 0x10, "Size mismatch!");
