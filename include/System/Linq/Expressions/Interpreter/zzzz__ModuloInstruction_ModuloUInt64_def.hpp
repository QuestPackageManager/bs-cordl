...
public:
  ...
  /// @brief Method Run, addr 0x5fb4cf0, size 0x110, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb4664, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction_ModuloUInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ModuloInstruction_ModuloUInt64(ModuloInstruction_ModuloUInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction_ModuloUInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ModuloInstruction_ModuloUInt64(ModuloInstruction_ModuloUInt64const&) = delete;
