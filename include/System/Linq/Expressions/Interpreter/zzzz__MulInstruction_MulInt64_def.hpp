...
public:
  ...
  /// @brief Method Run, addr 0x40f1418, size 0x148, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40f116c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
