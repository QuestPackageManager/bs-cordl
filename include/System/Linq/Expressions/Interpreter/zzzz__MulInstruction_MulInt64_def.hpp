...
// Write type traits
MARK_REF_T(::GlobalNamespace::MulInstruction_MulInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MulInstruction_MulInt64*, "System.Linq.Expressions.Interpreter", "MulInstruction/MulInt64");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb55e4, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb53c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MulInstruction_MulInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MulInstruction_MulInt64(MulInstruction_MulInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MulInstruction_MulInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MulInstruction_MulInt64(MulInstruction_MulInt64const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MulInstruction_MulInt64) == 0x10, "Size mismatch!");
