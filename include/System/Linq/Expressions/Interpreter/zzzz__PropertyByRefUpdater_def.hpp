...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x5faed54, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5faebfc, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5faebe4, size 0x18, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PropertyByRefUpdater", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PropertyByRefUpdater(PropertyByRefUpdater&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PropertyByRefUpdater", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PropertyByRefUpdater(PropertyByRefUpdaterconst&) = delete;
