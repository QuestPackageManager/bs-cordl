...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x5dfa1fc, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5dfa0a4, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dfa08c, size 0x18, virtual false, abstract: false, final false
