...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x40f3884, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x40f3720, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f36d8, size 0x48, virtual false, abstract: false, final false
