...
public:
  ...
  /// @brief Method Run, addr 0x5e0a6f0, size 0x60, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e0a5f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
