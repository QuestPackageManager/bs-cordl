...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArrayLengthInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArrayLengthInstruction(ArrayLengthInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArrayLengthInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArrayLengthInstruction(ArrayLengthInstructionconst&) = delete;
