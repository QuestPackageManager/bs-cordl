...
/// @brief Method Run, addr 0x5de09d8, size 0x9c, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x5de0b50, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
