...
public:
  ...
  /// @brief Method Run, addr 0x4102c04, size 0xf8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x4102bc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
