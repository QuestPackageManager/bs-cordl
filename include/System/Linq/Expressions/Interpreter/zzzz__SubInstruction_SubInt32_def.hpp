...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubInstruction_SubInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubInstruction_SubInt32*, "System.Linq.Expressions.Interpreter", "SubInstruction/SubInt32");
...
public:
  ...
  /// @brief Method Run, addr 0x5fbd61c, size 0x100, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbd4f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubInstruction_SubInt32(SubInstruction_SubInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubInstruction_SubInt32(SubInstruction_SubInt32const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::SubInstruction_SubInt32) == 0x10, "Size mismatch!");
