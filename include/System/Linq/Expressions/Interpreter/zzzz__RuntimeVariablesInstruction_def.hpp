...
public:
  ...
  /// @brief Method Run, addr 0x2c70ac4, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c70a4c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t count);

  /// @brief Method get_ConsumedStack, addr 0x2c70a7c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x2c70a84, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x2c70a74, size 0x8, virtual true, abstract: false, final false
