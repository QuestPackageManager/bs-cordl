...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RuntimeVariablesInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RuntimeVariablesInstruction(RuntimeVariablesInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RuntimeVariablesInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RuntimeVariablesInstruction(RuntimeVariablesInstructionconst&) = delete;
