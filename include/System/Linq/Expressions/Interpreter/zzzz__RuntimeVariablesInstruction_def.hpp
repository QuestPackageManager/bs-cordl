...
/// @brief Method Run, addr 0x5dff428, size 0x13c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5dff3cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  count) ;

/// @brief Method get_ConsumedStack, addr 0x5dff3dc, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x5dff3e4, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x5dff3d4, size 0x8, virtual true, abstract: false, final false
