...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::OrInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::OrInstruction*, "System.Linq.Expressions.Interpreter", "OrInstruction");
...
public:
  ...
  /// @brief Method Create, addr 0x5fbb774, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbb770, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5fbb71c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fbb72c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fbb724, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OrInstruction(OrInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OrInstruction(OrInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::OrInstruction) == 0x10, "Size mismatch!");
