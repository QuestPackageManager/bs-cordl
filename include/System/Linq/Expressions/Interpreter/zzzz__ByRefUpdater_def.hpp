...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x40e5bac, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40e5b84, size 0x28, virtual false, abstract: false, final false
