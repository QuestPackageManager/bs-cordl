...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x5d91f50, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d91f48, size 0x8, virtual false, abstract: false, final false
