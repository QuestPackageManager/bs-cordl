...
public:
  ...
  /// @brief Method UndefineTemps, addr 0x5df9adc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5df9ad4, size 0x8, virtual false, abstract: false, final false
