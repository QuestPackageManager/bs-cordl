...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::ByRefUpdater*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::ByRefUpdater*, "System.Linq.Expressions.Interpreter", "ByRefUpdater");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5fae62c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::ByRefUpdater) == 0x18, "Size mismatch!");
