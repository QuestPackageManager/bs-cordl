...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanInt16*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5f9ff38, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9fe44, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanInstruction_LessThanInt16(LessThanInstruction_LessThanInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanInstruction_LessThanInt16(LessThanInstruction_LessThanInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanInt16) == 0x18, "Size mismatch!");
