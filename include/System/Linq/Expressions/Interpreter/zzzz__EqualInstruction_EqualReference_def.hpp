...
/// @brief Method Run, addr 0x5ddf640, size 0x54, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x5ddee5c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
