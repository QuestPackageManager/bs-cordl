...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualReference", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EqualInstruction_EqualReference(EqualInstruction_EqualReference&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualReference", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EqualInstruction_EqualReference(EqualInstruction_EqualReferenceconst&) = delete;
