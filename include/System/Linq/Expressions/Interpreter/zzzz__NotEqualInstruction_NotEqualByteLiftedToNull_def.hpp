...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualByteLiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualByteLiftedToNull*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualByteLiftedToNull");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb8c0c, size 0xb0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb7fec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualByteLiftedToNull", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotEqualInstruction_NotEqualByteLiftedToNull(NotEqualInstruction_NotEqualByteLiftedToNull&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotEqualInstruction_NotEqualByteLiftedToNull", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotEqualInstruction_NotEqualByteLiftedToNull(NotEqualInstruction_NotEqualByteLiftedToNullconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualByteLiftedToNull) == 0x10, "Size mismatch!");
