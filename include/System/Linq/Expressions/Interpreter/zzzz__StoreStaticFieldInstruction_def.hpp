...
public:
  ...
  /// @brief Method Run, addr 0x40c5b50, size 0x40, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40c5ae0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstructionName, addr 0x40c5b08, size 0x40, virtual true, abstract: false, final false
