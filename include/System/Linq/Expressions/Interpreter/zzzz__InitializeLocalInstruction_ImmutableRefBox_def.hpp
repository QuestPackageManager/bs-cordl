...
public:
  ...
  /// @brief Method Run, addr 0x40e5850, size 0xc0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40e5828, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_InstructionName, addr 0x40e5910, size 0x40, virtual true, abstract: false, final false
