...
/// @brief Method Run, addr 0x5dfed48, size 0xc4, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x5dfed40, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  index) ;

/// @brief Method get_InstructionName, addr 0x5dfee0c, size 0x44, virtual true, abstract: false, final false
