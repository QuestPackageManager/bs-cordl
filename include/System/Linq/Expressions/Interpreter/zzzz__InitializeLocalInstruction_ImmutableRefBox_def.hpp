...
public:
  ...
  /// @brief Method Run, addr 0x5fad9c8, size 0xc4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fad9c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_InstructionName, addr 0x5fada8c, size 0x44, virtual true, abstract: false, final false
