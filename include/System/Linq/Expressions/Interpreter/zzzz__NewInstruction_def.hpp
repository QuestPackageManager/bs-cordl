...
public:
  ...
  /// @brief Method GetArgs, addr 0x5fb7288, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x5fb7144, size 0x144, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToString, addr 0x5fb740c, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fb70e4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::ConstructorInfo* constructor, int32_t argumentCount);

  /// @brief Method get_ConsumedStack, addr 0x5fb70f0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fb7100, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fb70f8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NewInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NewInstruction(NewInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NewInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NewInstruction(NewInstructionconst&) = delete;
