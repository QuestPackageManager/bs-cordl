...
/// @brief Method Run, addr 0x5e4fd68, size 0x1e4, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method SetTryHandler, addr 0x5e4fd60, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e4fd04, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  targetIndex) ;

/// @brief Method get_Handler, addr 0x5e4fd58, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::TryFaultHandler* get_Handler() ;

/// @brief Method get_InstructionName, addr 0x5e4fd0c, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedContinuations, addr 0x5e4fd50, size 0x8, virtual true, abstract: false, final false
