...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::EnterTryFaultInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::EnterTryFaultInstruction*, "System.Linq.Expressions.Interpreter", "EnterTryFaultInstruction");
...
public:
  ...
  /// @brief Method Run, addr 0x5f9067c, size 0x1e4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method SetTryHandler, addr 0x5f90674, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f90618, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t targetIndex);

  /// @brief Method get_Handler, addr 0x5f9066c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Interpreter::TryFaultHandler* get_Handler();

  /// @brief Method get_InstructionName, addr 0x5f90620, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedContinuations, addr 0x5f90664, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::EnterTryFaultInstruction) == 0x20, "Size mismatch!");
