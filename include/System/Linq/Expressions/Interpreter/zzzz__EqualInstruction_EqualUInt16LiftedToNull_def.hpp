...
public:
  ...
  /// @brief Method Run, addr 0x2b1a154, size 0xe8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x2b18f88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
