...
/// @brief Method Run, addr 0x5dd8ec8, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5dd8e6c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  elementType) ;

/// @brief Method get_ConsumedStack, addr 0x5dd8e74, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x5dd8e84, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x5dd8e7c, size 0x8, virtual true, abstract: false, final false
