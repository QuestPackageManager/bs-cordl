...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::OrInstruction_OrInt16);
...
public:
  ...
  /// @brief Method Run, addr 0x40f6358, size 0xf4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40f6224, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
