...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x4106dfc, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4106c84, size 0x28, virtual false, abstract: false, final false
