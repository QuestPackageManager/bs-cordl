...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CastInstructionNoT_CastInstruction_Ref", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CastInstructionNoT_CastInstruction_Ref(CastInstructionNoT_CastInstruction_Ref&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CastInstructionNoT_CastInstruction_Ref", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CastInstructionNoT_CastInstruction_Ref(CastInstructionNoT_CastInstruction_Refconst&) = delete;
