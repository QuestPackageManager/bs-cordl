...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x5fba558, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fba3f8, size 0x8, virtual false, abstract: false, final false
