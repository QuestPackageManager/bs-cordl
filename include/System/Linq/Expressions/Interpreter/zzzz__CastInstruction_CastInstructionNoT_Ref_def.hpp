...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x2b4dc14, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b4da94, size 0x28, virtual false, abstract: false, final false
