...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x2c4a514, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c4a394, size 0x28, virtual false, abstract: false, final false
