...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x40f9930, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f97b8, size 0x28, virtual false, abstract: false, final false
