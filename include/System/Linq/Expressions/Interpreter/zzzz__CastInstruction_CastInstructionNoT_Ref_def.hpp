...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x40fb174, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40faffc, size 0x28, virtual false, abstract: false, final false
