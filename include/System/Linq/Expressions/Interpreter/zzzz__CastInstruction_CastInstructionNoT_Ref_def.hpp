...
public:
  // Declarations
  /// @brief Method ConvertNull, addr 0x40f7f10, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f7d98, size 0x28, virtual false, abstract: false, final false
