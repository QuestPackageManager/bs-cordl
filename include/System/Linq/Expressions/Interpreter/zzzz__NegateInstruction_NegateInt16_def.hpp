...
public:
  ...
  /// @brief Method Run, addr 0x5fb69fc, size 0x74, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb69e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NegateInstruction_NegateInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NegateInstruction_NegateInt16(NegateInstruction_NegateInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NegateInstruction_NegateInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NegateInstruction_NegateInt16(NegateInstruction_NegateInt16const&) = delete;
