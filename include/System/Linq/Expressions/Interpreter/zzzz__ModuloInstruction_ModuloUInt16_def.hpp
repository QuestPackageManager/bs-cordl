...
public:
  ...
  /// @brief Method Run, addr 0x5d983ec, size 0x110, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5d97f78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
