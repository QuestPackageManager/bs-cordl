...
// Write type traits
MARK_REF_T(::GlobalNamespace::ModuloInstruction_ModuloUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ModuloInstruction_ModuloUInt16*, "System.Linq.Expressions.Interpreter", "ModuloInstruction/ModuloUInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb4ad0, size 0x110, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb465c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction_ModuloUInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ModuloInstruction_ModuloUInt16(ModuloInstruction_ModuloUInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction_ModuloUInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ModuloInstruction_ModuloUInt16(ModuloInstruction_ModuloUInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::ModuloInstruction_ModuloUInt16) == 0x10, "Size mismatch!");
