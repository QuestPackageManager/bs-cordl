...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::CastToEnumInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::CastToEnumInstruction*, "System.Linq.Expressions.Interpreter", "CastToEnumInstruction");
...
public:
  ...
  /// @brief Method Run, addr 0x5fbfdcc, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fbfdc4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CastToEnumInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CastToEnumInstruction(CastToEnumInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CastToEnumInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CastToEnumInstruction(CastToEnumInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::CastToEnumInstruction) == 0x18, "Size mismatch!");
