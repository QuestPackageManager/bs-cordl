...
public:
  ...
  /// @brief Method Run, addr 0x40f4a38, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f4a10, size 0x28, virtual false, abstract: false, final false
