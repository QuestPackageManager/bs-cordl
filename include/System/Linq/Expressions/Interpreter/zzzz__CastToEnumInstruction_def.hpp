...
public:
  ...
  /// @brief Method Run, addr 0x2c4a598, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c4a570, size 0x28, virtual false, abstract: false, final false
