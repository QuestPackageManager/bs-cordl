...
public:
  ...
  /// @brief Method Run, addr 0x5e0b274, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0b26c, size 0x8, virtual false, abstract: false, final false
