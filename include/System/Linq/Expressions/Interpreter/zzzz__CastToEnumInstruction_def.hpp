...
public:
  ...
  /// @brief Method Run, addr 0x40f99ac, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f9984, size 0x28, virtual false, abstract: false, final false
