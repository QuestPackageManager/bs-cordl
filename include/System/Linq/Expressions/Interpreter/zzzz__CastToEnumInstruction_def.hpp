...
public:
  ...
  /// @brief Method Run, addr 0x40f95cc, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40f95a4, size 0x28, virtual false, abstract: false, final false
