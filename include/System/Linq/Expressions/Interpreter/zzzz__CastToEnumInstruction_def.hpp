...
public:
  ...
  /// @brief Method Run, addr 0x5da36e8, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5da36e0, size 0x8, virtual false, abstract: false, final false
