...
public:
  ...
  /// @brief Method GetArgs, addr 0x40be224, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x40bdf24, size 0x300, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToString, addr 0x40be3a8, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40bdc68, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* target, int32_t argumentCount);

  /// @brief Method get_ArgumentCount, addr 0x40bde6c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ArgumentCount();

  /// @brief Method get_ProducedStack, addr 0x40bde74, size 0xb0, virtual true, abstract: false, final false
