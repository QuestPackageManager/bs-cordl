...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodInfoCallInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodInfoCallInstruction(MethodInfoCallInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodInfoCallInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodInfoCallInstruction(MethodInfoCallInstructionconst&) = delete;
