...
public:
  ...
  /// @brief Method Run, addr 0x5fb53d8, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb53b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MulInstruction_MulInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MulInstruction_MulInt16(MulInstruction_MulInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MulInstruction_MulInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MulInstruction_MulInt16(MulInstruction_MulInt16const&) = delete;
