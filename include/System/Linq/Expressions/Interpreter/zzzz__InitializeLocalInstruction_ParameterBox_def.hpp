...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::InitializeLocalInstruction_ParameterBox);
...
public:
  ...
  /// @brief Method Run, addr 0x40ea874, size 0xdc, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40ea84c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_InstructionName, addr 0x40ea950, size 0x40, virtual true, abstract: false, final false
