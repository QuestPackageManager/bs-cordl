...
public:
  ...
  /// @brief Method Run, addr 0x5dfe798, size 0xd0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5dfe790, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_InstructionName, addr 0x5dfe868, size 0x44, virtual true, abstract: false, final false
