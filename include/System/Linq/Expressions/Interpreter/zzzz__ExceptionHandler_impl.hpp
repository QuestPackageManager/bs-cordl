...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Linq::Expressions::Interpreter::ExceptionHandler::*)(
  ...
  constexpr static std::size_t addrs = 0x5f9b554;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::Interpreter::ExceptionHandler*>(),
                                                             { ".ctor",
                                                               {},
                                                               { ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<::System::Type*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::System::Linq::Expressions::Interpreter::ExceptionHandler::*)(::System::Type*)>(
    &::System::Linq::Expressions::Interpreter::ExceptionHandler::Matches)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x5f9b568;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::Interpreter::ExceptionHandler*>(), { "Matches", {}, { ::i2c::type_of<::System::Type*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::System::Linq::Expressions::Interpreter::ExceptionHandler::*)()>(
    &::System::Linq::Expressions::Interpreter::ExceptionHandler::ToString)> {
  constexpr static std::size_t size = 0x114;
  constexpr static std::size_t addrs = 0x5f9b588;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::Interpreter::ExceptionHandler*>(),
...
inline bool System::Linq::Expressions::Interpreter::ExceptionHandler::Matches(::System::Type* exceptionType) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::Interpreter::ExceptionHandler*>(), { "Matches", {}, { ::i2c::type_of<::System::Type*>() } })));
...
inline ::StringW System::Linq::Expressions::Interpreter::ExceptionHandler::ToString() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::Interpreter::ExceptionHandler*>(), 3 })));
