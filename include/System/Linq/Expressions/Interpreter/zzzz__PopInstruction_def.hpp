...
public:
  ...
  /// @brief Method Run, addr 0x41038bc, size 0x24, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x410386c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Linq::Expressions::Interpreter::PopInstruction* getStaticF_Instance();

  /// @brief Method get_ConsumedStack, addr 0x4103874, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x410387c, size 0x40, virtual true, abstract: false, final false
