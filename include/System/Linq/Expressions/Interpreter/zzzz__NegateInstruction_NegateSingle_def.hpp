...
public:
  ...
  /// @brief Method Run, addr 0x4077760, size 0xb0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x4077558, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
