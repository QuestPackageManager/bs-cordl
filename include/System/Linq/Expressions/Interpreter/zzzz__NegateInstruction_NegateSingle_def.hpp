...
public:
  ...
  /// @brief Method Run, addr 0x5d9a48c, size 0x8c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5d9a310, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
