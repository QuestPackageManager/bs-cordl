...
public:
  ...
  /// @brief Method Run, addr 0x5fb6b70, size 0x8c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb69f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NegateInstruction_NegateSingle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NegateInstruction_NegateSingle(NegateInstruction_NegateSingle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NegateInstruction_NegateSingle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NegateInstruction_NegateSingle(NegateInstruction_NegateSingleconst&) = delete;
