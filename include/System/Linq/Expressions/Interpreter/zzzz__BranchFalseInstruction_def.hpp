...
public:
  ...
  /// @brief Method Run, addr 0x5dda984, size 0x5c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5dda9e0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Cache, addr 0x5dda8ac, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5dda97c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5dda938, size 0x44, virtual true, abstract: false, final false
