...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BranchFalseInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BranchFalseInstruction(BranchFalseInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BranchFalseInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BranchFalseInstruction(BranchFalseInstructionconst&) = delete;
