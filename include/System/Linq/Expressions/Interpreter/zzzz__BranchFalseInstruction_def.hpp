...
public:
  ...
  /// @brief Method Run, addr 0x5e4d050, size 0x5c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e4d0ac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Cache, addr 0x5e4cf78, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5e4d048, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e4d004, size 0x44, virtual true, abstract: false, final false
