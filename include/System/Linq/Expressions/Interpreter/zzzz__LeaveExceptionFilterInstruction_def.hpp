...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeaveExceptionFilterInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeaveExceptionFilterInstruction(LeaveExceptionFilterInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeaveExceptionFilterInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeaveExceptionFilterInstruction(LeaveExceptionFilterInstructionconst&) = delete;
