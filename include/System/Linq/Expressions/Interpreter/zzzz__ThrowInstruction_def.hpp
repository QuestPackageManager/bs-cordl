...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::ThrowInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::ThrowInstruction*, "System.Linq.Expressions.Interpreter", "ThrowInstruction");
...
public:
  ...
  /// @brief Method Run, addr 0x5f912dc, size 0x8c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method WrapThrownObject, addr 0x5f91368, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f9127c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5f912d4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f91288, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f912cc, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ThrowInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ThrowInstruction(ThrowInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ThrowInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ThrowInstruction(ThrowInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::ThrowInstruction) == 0x18, "Size mismatch!");
