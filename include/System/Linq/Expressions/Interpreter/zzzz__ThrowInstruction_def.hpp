...
public:
  ...
  /// @brief Method Run, addr 0x5e4ee50, size 0x8c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method WrapThrownObject, addr 0x5e4eedc, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4edf0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5e4ee48, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e4edfc, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e4ee40, size 0x8, virtual true, abstract: false, final false
