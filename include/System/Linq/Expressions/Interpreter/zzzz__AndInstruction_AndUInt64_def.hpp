...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::AndInstruction_AndUInt64);
...
public:
  ...
  /// @brief Method Run, addr 0x40c15b8, size 0x100, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40c0ee4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::AndInstruction_AndUInt64, 0x10>, "Size mismatch!");

} // namespace GlobalNamespace
NEED_NO_BOX(::GlobalNamespace::AndInstruction_AndUInt64);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::AndInstruction_AndUInt64*, "System.Linq.Expressions.Interpreter", "AndInstruction/AndUInt64");
