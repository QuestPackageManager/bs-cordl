...
public:
  ...
  /// @brief Method Run, addr 0x5fbd934, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbd500, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubUInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubInstruction_SubUInt32(SubInstruction_SubUInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubInstruction_SubUInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubInstruction_SubUInt32(SubInstruction_SubUInt32const&) = delete;
