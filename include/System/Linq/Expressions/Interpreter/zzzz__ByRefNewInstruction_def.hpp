...
/// @brief Field _byrefArgs, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__byrefArgs, put=__cordl_internal_set__byrefArgs)) ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*,::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*>  _byrefArgs;

static inline ::System::Linq::Expressions::Interpreter::ByRefNewInstruction* New_ctor(::System::Reflection::ConstructorInfo*  target, int32_t  argumentCount, ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*,::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*>  byrefArgs) ;

/// @brief Method Run, addr 0x5e76c84, size 0x220, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5e76c30, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::ConstructorInfo*  target, int32_t  argumentCount, ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*,::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*>  byrefArgs) ;

/// @brief Method get_InstructionName, addr 0x5e76c40, size 0x44, virtual true, abstract: false, final false
