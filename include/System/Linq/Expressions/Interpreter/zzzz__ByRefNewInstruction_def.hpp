...
public:
  ...
  /// @brief Method Run, addr 0x5e02a40, size 0x220, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5e029ec, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::ConstructorInfo* target, int32_t argumentCount,
                    ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*, ::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*> byrefArgs);

  /// @brief Method get_InstructionName, addr 0x5e029fc, size 0x44, virtual true, abstract: false, final false
