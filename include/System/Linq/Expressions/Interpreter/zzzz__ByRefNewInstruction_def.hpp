...
public:
  ...
  static inline ::System::Linq::Expressions::Interpreter::ByRefNewInstruction* New_ctor(::System::Reflection::ConstructorInfo* target, int32_t argumentCount,
                                                                                        ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*> byrefArgs);

  /// @brief Method Run, addr 0x5fb7598, size 0x220, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5fb7544, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstructionName, addr 0x5fb7554, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ByRefNewInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ByRefNewInstruction(ByRefNewInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ByRefNewInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ByRefNewInstruction(ByRefNewInstructionconst&) = delete;
