...
public:
  ...
  /// @brief Method Update, addr 0x40e5be0, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40e5bb0, size 0x30, virtual false, abstract: false, final false
