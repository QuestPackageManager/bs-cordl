...
public:
  ...
  /// @brief Method Update, addr 0x2b37c7c, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b37c4c, size 0x30, virtual false, abstract: false, final false
