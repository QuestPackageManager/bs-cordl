...
public:
  ...
  /// @brief Method Update, addr 0x5fa8e2c, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fa8e20, size 0xc, virtual false, abstract: false, final false
