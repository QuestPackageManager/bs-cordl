...
public:
  ...
  /// @brief Method Update, addr 0x5fae644, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fae638, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ParameterByRefUpdater", modifiers: "&&", def_value: None, comment: None }]
