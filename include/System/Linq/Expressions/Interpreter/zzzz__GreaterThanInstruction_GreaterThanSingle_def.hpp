...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanInstruction_GreaterThanSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanInstruction_GreaterThanSingle*, "System.Linq.Expressions.Interpreter", "GreaterThanInstruction/GreaterThanSingle");
...
public:
  ...
  /// @brief Method Run, addr 0x5f96278, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f95ca4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction_GreaterThanSingle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GreaterThanInstruction_GreaterThanSingle(GreaterThanInstruction_GreaterThanSingle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanInstruction_GreaterThanSingle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GreaterThanInstruction_GreaterThanSingle(GreaterThanInstruction_GreaterThanSingleconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GreaterThanInstruction_GreaterThanSingle) == 0x18, "Size mismatch!");
