...
// Write type traits
MARK_REF_T(::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt64*, "System.Linq.Expressions.Interpreter", "LeftShiftInstruction/LeftShiftUInt64");
...
public:
  ...
  /// @brief Method Run, addr 0x5f9fd24, size 0xbc, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9f86c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction_LeftShiftUInt64", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeftShiftInstruction_LeftShiftUInt64(LeftShiftInstruction_LeftShiftUInt64&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction_LeftShiftUInt64", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeftShiftInstruction_LeftShiftUInt64(LeftShiftInstruction_LeftShiftUInt64const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt64) == 0x10, "Size mismatch!");
