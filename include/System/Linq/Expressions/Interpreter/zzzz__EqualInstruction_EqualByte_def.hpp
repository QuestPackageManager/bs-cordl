...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualByte", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EqualInstruction_EqualByte(EqualInstruction_EqualByte&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EqualInstruction_EqualByte", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EqualInstruction_EqualByte(EqualInstruction_EqualByteconst&) = delete;
