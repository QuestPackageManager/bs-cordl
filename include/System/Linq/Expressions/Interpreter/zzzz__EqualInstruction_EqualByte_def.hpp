...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::EqualInstruction_EqualByte);
...
public:
  ...
  /// @brief Method Run, addr 0x40ccb78, size 0xe0, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40cc600, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
