...
// Write type traits
MARK_REF_T(::GlobalNamespace::AndInstruction_AndByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AndInstruction_AndByte*, "System.Linq.Expressions.Interpreter", "AndInstruction/AndByte");
...
public:
  ...
  /// @brief Method Run, addr 0x5f8ce1c, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f8cb58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction_AndByte", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::GlobalNamespace::AndInstruction_AndByte) == 0x10, "Size mismatch!");
