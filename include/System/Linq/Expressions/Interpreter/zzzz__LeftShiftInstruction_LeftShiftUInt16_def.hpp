...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt16);
...
public:
  ...
  /// @brief Method Run, addr 0x40d616c, size 0xe8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40d5cc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
