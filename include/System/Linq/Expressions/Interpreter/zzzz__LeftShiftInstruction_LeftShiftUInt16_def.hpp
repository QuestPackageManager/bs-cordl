...
// Write type traits
MARK_REF_T(::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt16*, "System.Linq.Expressions.Interpreter", "LeftShiftInstruction/LeftShiftUInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5f9fbc0, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9f864, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction_LeftShiftUInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeftShiftInstruction_LeftShiftUInt16(LeftShiftInstruction_LeftShiftUInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction_LeftShiftUInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeftShiftInstruction_LeftShiftUInt16(LeftShiftInstruction_LeftShiftUInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt16) == 0x10, "Size mismatch!");
