...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5f8da78, size 0x10c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5f8da6c, size 0xc, virtual false, abstract: false, final false
