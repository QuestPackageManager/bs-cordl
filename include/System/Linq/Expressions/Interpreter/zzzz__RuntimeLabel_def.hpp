...
public:
// Declarations
/// @brief Method ToString, addr 0x5dd95e0, size 0x10c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x5dd95d4, size 0xc, virtual false, abstract: false, final false
