...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5e4b5ec, size 0x10c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5e4b5e0, size 0xc, virtual false, abstract: false, final false
