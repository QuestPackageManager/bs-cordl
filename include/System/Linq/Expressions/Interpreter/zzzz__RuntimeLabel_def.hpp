...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5dd8f20, size 0x10c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5dd8f14, size 0xc, virtual false, abstract: false, final false
