...
public:
  // Declarations
  /// @brief Method ToString, addr 0x40c1d2c, size 0xfc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x40c1d20, size 0xc, virtual false, abstract: false, final false
