...
public:
  ...
  /// @brief Method <MakeDelegate>b__1_0, addr 0x5e7e524, size 0x24, virtual false, abstract: false, final false
  inline bool _MakeDelegate_b__1_0(::System::Type* t);

  /// @brief Method .ctor, addr 0x5e7e520, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MakeDelegate, addr 0x5e6dbd4, size 0x7a4, virtual false, abstract: false, final false
