...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanInt32*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanInt32");
...
public:
  ...
  /// @brief Method Run, addr 0x5fa0080, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9fe54, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanInstruction_LessThanInt32(LessThanInstruction_LessThanInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanInstruction_LessThanInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanInstruction_LessThanInt32(LessThanInstruction_LessThanInt32const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanInt32) == 0x18, "Size mismatch!");
