...
// Write type traits
MARK_REF_T(::GlobalNamespace::AndInstruction_AndUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AndInstruction_AndUInt32*, "System.Linq.Expressions.Interpreter", "AndInstruction/AndUInt32");
...
public:
  ...
  /// @brief Method Run, addr 0x5f8cf6c, size 0xb8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f8cb60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction_AndUInt32", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AndInstruction_AndUInt32(AndInstruction_AndUInt32&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AndInstruction_AndUInt32", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AndInstruction_AndUInt32(AndInstruction_AndUInt32const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::AndInstruction_AndUInt32) == 0x10, "Size mismatch!");
