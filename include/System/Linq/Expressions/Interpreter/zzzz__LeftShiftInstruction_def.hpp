...
/// @brief Method Create, addr 0x5e5a28c, size 0x348, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e5ef38, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ConsumedStack, addr 0x5e5eee4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x5e5eef4, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x5e5eeec, size 0x8, virtual true, abstract: false, final false
