...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::LeftShiftInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::LeftShiftInstruction*, "System.Linq.Expressions.Interpreter", "LeftShiftInstruction");
...
public:
  ...
  /// @brief Method Create, addr 0x5f9aba0, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f9f84c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5f9f7f8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f9f808, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f9f800, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeftShiftInstruction(LeftShiftInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeftShiftInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeftShiftInstruction(LeftShiftInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::LeftShiftInstruction) == 0x10, "Size mismatch!");
