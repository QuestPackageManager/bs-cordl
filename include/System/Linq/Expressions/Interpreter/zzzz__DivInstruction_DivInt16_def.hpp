...
public:
  ...
  /// @brief Method Run, addr 0x5f92274, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f92254, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DivInstruction_DivInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DivInstruction_DivInt16(DivInstruction_DivInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DivInstruction_DivInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DivInstruction_DivInt16(DivInstruction_DivInt16const&) = delete;
