...
public:
  ...
  /// @brief Method Run, addr 0x5f9aaf8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9a65c, size 0x8, virtual false, abstract: false, final false
