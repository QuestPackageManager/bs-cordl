...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt16*, "System.Linq.Expressions.Interpreter", "GreaterThanOrEqualInstruction/GreaterThanOrEqualUInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5f9710c, size 0xa4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f96d0c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt16", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt16(GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt16) == 0x18, "Size mismatch!");
