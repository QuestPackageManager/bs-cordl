...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotInstruction_NotByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotInstruction_NotByte*, "System.Linq.Expressions.Interpreter", "NotInstruction/NotByte");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb97b4, size 0x74, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb9434, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotInstruction_NotByte", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotInstruction_NotByte(NotInstruction_NotByte&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotInstruction_NotByte", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotInstruction_NotByte(NotInstruction_NotByteconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NotInstruction_NotByte) == 0x10, "Size mismatch!");
