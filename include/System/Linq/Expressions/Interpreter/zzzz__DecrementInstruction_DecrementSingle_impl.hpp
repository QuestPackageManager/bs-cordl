...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::DecrementInstruction_DecrementSingle::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(
  ...
  constexpr static std::size_t addrs = 0x5f8c47c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::DecrementInstruction_DecrementSingle::*)()>(&::GlobalNamespace::DecrementInstruction_DecrementSingle::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5f8c174;
...
inline int32_t GlobalNamespace::DecrementInstruction_DecrementSingle::Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::DecrementInstruction_DecrementSingle*>(), 8 })));
