...
public:
  ...
  /// @brief Method Run, addr 0x5fbbb2c, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbbb08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrSByte", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OrInstruction_OrSByte(OrInstruction_OrSByte&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrSByte", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OrInstruction_OrSByte(OrInstruction_OrSByteconst&) = delete;
