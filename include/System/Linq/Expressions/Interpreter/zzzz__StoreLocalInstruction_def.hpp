...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::StoreLocalInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::StoreLocalInstruction*, "System.Linq.Expressions.Interpreter", "StoreLocalInstruction");
...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x5fb2874, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x5fb27fc, size 0x78, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb27a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_ConsumedStack, addr 0x5fb27b0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fb27b8, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StoreLocalInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StoreLocalInstruction(StoreLocalInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StoreLocalInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StoreLocalInstruction(StoreLocalInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::StoreLocalInstruction) == 0x18, "Size mismatch!");
