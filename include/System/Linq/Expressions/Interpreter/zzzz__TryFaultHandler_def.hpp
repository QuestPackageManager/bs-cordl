...
public:
  ...
  /// @brief Method .ctor, addr 0x5fa1244, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TryFaultHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TryFaultHandler(TryFaultHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TryFaultHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TryFaultHandler(TryFaultHandlerconst&) = delete;
