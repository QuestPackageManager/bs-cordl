...
public:
  ...
  /// @brief Method Create, addr 0x40cc018, size 0x960, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40cbff0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x40cbfa0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x40cbfb0, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x40cbfa8, size 0x8, virtual true, abstract: false, final false
