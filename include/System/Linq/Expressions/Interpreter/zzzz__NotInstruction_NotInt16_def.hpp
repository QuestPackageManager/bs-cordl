...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotInstruction_NotInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotInstruction_NotInt16*, "System.Linq.Expressions.Interpreter", "NotInstruction/NotInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb95b4, size 0x74, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb9424, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotInstruction_NotInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotInstruction_NotInt16(NotInstruction_NotInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotInstruction_NotInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotInstruction_NotInt16(NotInstruction_NotInt16const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NotInstruction_NotInt16) == 0x10, "Size mismatch!");
