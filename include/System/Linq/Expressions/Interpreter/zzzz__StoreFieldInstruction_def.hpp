...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StoreFieldInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StoreFieldInstruction(StoreFieldInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StoreFieldInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StoreFieldInstruction(StoreFieldInstructionconst&) = delete;
