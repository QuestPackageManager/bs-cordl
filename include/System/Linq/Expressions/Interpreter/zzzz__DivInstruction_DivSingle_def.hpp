...
public:
  ...
  /// @brief Method Run, addr 0x5f928b4, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5f9226c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DivInstruction_DivSingle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DivInstruction_DivSingle(DivInstruction_DivSingle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DivInstruction_DivSingle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DivInstruction_DivSingle(DivInstruction_DivSingleconst&) = delete;
