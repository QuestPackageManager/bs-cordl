...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BranchInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BranchInstruction(BranchInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BranchInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BranchInstruction(BranchInstructionconst&) = delete;
