...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x5dfe8bc, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x5dfe8b4, size 0x8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5dfe8ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_InstructionName, addr 0x5dfe944, size 0x44, virtual true, abstract: false, final false
