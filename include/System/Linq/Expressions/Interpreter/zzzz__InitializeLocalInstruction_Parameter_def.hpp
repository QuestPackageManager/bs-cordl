...
public:
  ...
  /// @brief Method BoxIfIndexMatches, addr 0x5fb3414, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x5fb340c, size 0x8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb3404, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t index);

  /// @brief Method get_InstructionName, addr 0x5fb349c, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_Parameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InitializeLocalInstruction_Parameter(InitializeLocalInstruction_Parameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_Parameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InitializeLocalInstruction_Parameter(InitializeLocalInstruction_Parameterconst&) = delete;
