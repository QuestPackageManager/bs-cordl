...
public:
  ...
  /// @brief Method Run, addr 0x40c6328, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x40c62e0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x40c62e8, size 0x40, virtual true, abstract: false, final false
