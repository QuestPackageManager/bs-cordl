...
public:
  ...
  /// @brief Method Run, addr 0x5e4b3cc, size 0x9c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5e4b37c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Linq::Expressions::Interpreter::SetArrayItemInstruction* getStaticF_Instance();

  /// @brief Method get_ConsumedStack, addr 0x5e4b380, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e4b388, size 0x44, virtual true, abstract: false, final false
