...
public:
  ...
  /// @brief Method Run, addr 0x40bb1c0, size 0x218, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40baf4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
