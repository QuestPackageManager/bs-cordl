...
// Write type traits
MARK_REF_T(::GlobalNamespace::ModuloInstruction_ModuloDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ModuloInstruction_ModuloDouble*, "System.Linq.Expressions.Interpreter", "ModuloInstruction/ModuloDouble");
...
public:
  ...
  /// @brief Method Run, addr 0x5fb4f0c, size 0x10c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb466c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction_ModuloDouble", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ModuloInstruction_ModuloDouble(ModuloInstruction_ModuloDouble&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ModuloInstruction_ModuloDouble", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ModuloInstruction_ModuloDouble(ModuloInstruction_ModuloDoubleconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::ModuloInstruction_ModuloDouble) == 0x10, "Size mismatch!");
