...
public:
  ...
  /// @brief Method Run, addr 0x40c9d10, size 0xf4, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x40c9b18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
