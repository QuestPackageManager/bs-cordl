...
/// @brief Method AddBranch, addr 0x5dd9888, size 0x134, virtual false, abstract: false, final false
inline void AddBranch(::System::Linq::Expressions::Interpreter::InstructionList*  instructions, int32_t  branchIndex) ;

/// @brief Method FixupBranch, addr 0x5dd9860, size 0x28, virtual false, abstract: false, final false
inline void FixupBranch(::System::Linq::Expressions::Interpreter::InstructionList*  instructions, int32_t  branchIndex) ;

/// @brief Method Mark, addr 0x5dd9728, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method ToRuntimeLabel, addr 0x5dd9718, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5dd99bc, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasRuntimeLabel, addr 0x5dd96fc, size 0x14, virtual false, abstract: false, final false
inline bool get_HasRuntimeLabel() ;

/// @brief Method get_LabelIndex, addr 0x5dd96ec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LabelIndex() ;

/// @brief Method get_TargetIndex, addr 0x5dd9710, size 0x8, virtual false, abstract: false, final false
inline int32_t get_TargetIndex() ;

/// @brief Method set_LabelIndex, addr 0x5dd96f4, size 0x8, virtual false, abstract: false, final false
