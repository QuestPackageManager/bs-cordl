...
public:
  ...
  /// @brief Method Run, addr 0x5fbe060, size 0x158, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbe048, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubOvfInstruction_SubOvfInt16", modifiers: "&&", def_value: None, comment: None }]
