...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrBoolean", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OrInstruction_OrBoolean(OrInstruction_OrBoolean&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrBoolean", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OrInstruction_OrBoolean(OrInstruction_OrBooleanconst&) = delete;
