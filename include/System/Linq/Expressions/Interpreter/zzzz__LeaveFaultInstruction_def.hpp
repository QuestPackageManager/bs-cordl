...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeaveFaultInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeaveFaultInstruction(LeaveFaultInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeaveFaultInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeaveFaultInstruction(LeaveFaultInstructionconst&) = delete;
