...
/// @brief Field s_cache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::ArrayW<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*,::Array<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*>*>  s_cache;

/// @brief Method Create, addr 0x5e507c0, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x5e508d4, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e50760, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  labelIndex, bool  hasValue) ;

static inline ::ArrayW<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*,::Array<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*>*> getStaticF_s_cache() ;

/// @brief Method get_ConsumedStack, addr 0x5e507b0, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x5e5076c, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x5e507b8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ProducedStack() ;

static inline void setStaticF_s_cache(::ArrayW<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*,::Array<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*>*>  value) ;
