...
public:
  ...
  /// @brief Method Run, addr 0x2c1e684, size 0xac, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x2c1e180, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
