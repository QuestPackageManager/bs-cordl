...
public:
  ...
  /// @brief Method Create, addr 0x5f9b864, size 0x8c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fa05f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5fa05a0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5fa05b0, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5fa05a8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LessThanOrEqualInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LessThanOrEqualInstruction(LessThanOrEqualInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LessThanOrEqualInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LessThanOrEqualInstruction(LessThanOrEqualInstructionconst&) = delete;
