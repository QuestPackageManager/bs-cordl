...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultValueInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultValueInstruction(DefaultValueInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultValueInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultValueInstruction(DefaultValueInstructionconst&) = delete;
