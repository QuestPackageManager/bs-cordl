...
public:
  ...
  /// @brief Method Run, addr 0x5e4f97c, size 0x3c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method ToString, addr 0x5e4f9b8, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4f928, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_InstructionName, addr 0x5e4f938, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5e4f930, size 0x8, virtual true, abstract: false, final false
