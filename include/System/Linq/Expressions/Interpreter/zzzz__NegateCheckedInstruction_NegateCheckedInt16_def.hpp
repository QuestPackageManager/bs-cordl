...
public:
  ...
  /// @brief Method Run, addr 0x5fb6f4c, size 0xbc, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb6e80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
