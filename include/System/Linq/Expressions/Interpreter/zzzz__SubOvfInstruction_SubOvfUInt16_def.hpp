...
public:
  ...
  /// @brief Method Run, addr 0x40808a0, size 0x21c, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x4080244, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
