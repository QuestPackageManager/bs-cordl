...
public:
  ...
  /// @brief Method Run, addr 0x5fbbe84, size 0xa8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbbb1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrUInt16", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OrInstruction_OrUInt16(OrInstruction_OrUInt16&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OrInstruction_OrUInt16", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OrInstruction_OrUInt16(OrInstruction_OrUInt16const&) = delete;
