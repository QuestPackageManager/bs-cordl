...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_ImmutableBox", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InitializeLocalInstruction_ImmutableBox(InitializeLocalInstruction_ImmutableBox&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InitializeLocalInstruction_ImmutableBox", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InitializeLocalInstruction_ImmutableBox(InitializeLocalInstruction_ImmutableBoxconst&) = delete;
