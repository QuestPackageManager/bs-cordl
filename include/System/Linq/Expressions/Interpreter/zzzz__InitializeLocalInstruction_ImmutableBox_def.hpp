...
/// @brief Method Run, addr 0x5dfec38, size 0xc4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5dfebe8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, ::System::Object*  defaultValue) ;

/// @brief Method get_InstructionName, addr 0x5dfecfc, size 0x44, virtual true, abstract: false, final false
