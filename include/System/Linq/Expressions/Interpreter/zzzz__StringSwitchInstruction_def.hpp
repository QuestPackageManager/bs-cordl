...
public:
  ...
  /// @brief Method Run, addr 0x5e4f088, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4f034, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5e4f080, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5e4f03c, size 0x44, virtual true, abstract: false, final false
