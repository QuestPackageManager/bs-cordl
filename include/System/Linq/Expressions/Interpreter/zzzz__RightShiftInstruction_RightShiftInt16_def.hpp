...
public:
  ...
  /// @brief Method Run, addr 0x4102cfc, size 0xf8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x4102bcc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
