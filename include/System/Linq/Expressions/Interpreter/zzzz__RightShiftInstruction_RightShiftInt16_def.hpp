...
// Write type traits
MARK_REF_T(::GlobalNamespace::RightShiftInstruction_RightShiftInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RightShiftInstruction_RightShiftInt16*, "System.Linq.Expressions.Interpreter", "RightShiftInstruction/RightShiftInt16");
...
public:
  ...
  /// @brief Method Run, addr 0x5fbc64c, size 0xb8, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fbc578, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RightShiftInstruction_RightShiftInt16", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::GlobalNamespace::RightShiftInstruction_RightShiftInt16) == 0x10, "Size mismatch!");
