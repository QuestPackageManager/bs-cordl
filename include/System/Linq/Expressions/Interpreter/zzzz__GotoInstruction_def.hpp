...
/// @brief Field s_cache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::ArrayW<::System::Linq::Expressions::Interpreter::GotoInstruction*,::Array<::System::Linq::Expressions::Interpreter::GotoInstruction*>*>  s_cache;

/// @brief Method Create, addr 0x5ddb7f0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x5ddb950, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ddb7dc, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_ConsumedStack, addr 0x5ddb7cc, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x5ddb788, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x5ddb7d4, size 0x8, virtual true, abstract: false, final false
