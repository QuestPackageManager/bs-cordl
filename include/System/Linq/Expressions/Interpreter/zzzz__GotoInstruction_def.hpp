...
public:
  ...
  /// @brief Method Create, addr 0x5f8fc88, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x5f8fde8, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8fc74, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ConsumedStack, addr 0x5f8fc64, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f8fc20, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f8fc6c, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GotoInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GotoInstruction(GotoInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GotoInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GotoInstruction(GotoInstructionconst&) = delete;
