...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LoadFieldInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LoadFieldInstruction(LoadFieldInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LoadFieldInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LoadFieldInstruction(LoadFieldInstructionconst&) = delete;
