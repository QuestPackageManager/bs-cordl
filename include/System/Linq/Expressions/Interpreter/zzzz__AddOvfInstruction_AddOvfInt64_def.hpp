...
public:
  ...
  /// @brief Method Run, addr 0x5dd76b4, size 0x168, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5dd7404, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
