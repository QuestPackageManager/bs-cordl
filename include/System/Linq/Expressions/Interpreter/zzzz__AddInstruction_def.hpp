...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::AddInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::AddInstruction*, "System.Linq.Expressions.Interpreter", "AddInstruction");
...
public:
  ...
  /// @brief Method Create, addr 0x5f8b0b0, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8b0ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ConsumedStack, addr 0x5f8b058, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConsumedStack();

  /// @brief Method get_InstructionName, addr 0x5f8b068, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_InstructionName();

  /// @brief Method get_ProducedStack, addr 0x5f8b060, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AddInstruction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AddInstruction(AddInstruction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AddInstruction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AddInstruction(AddInstructionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::AddInstruction) == 0x10, "Size mismatch!");
