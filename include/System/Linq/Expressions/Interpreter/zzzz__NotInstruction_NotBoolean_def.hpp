...
public:
  ...
  /// @brief Method Run, addr 0x5fb943c, size 0x78, virtual true, abstract: false, final false
  inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame* frame);

  /// @brief Method .ctor, addr 0x5fb9418, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotInstruction_NotBoolean", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotInstruction_NotBoolean(NotInstruction_NotBoolean&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotInstruction_NotBoolean", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotInstruction_NotBoolean(NotInstruction_NotBooleanconst&) = delete;
