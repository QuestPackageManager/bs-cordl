...
public:
  ...
  /// @brief Method Accept, addr 0x5f842d4, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method FunctionalOp, addr 0x5f85124, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x5f84320, size 0x70, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Reduce();

  /// @brief Method ReduceIndex, addr 0x5f84390, size 0x5d0, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceIndex();

  /// @brief Method ReduceMember, addr 0x5f84960, size 0x4bc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceMember();

  /// @brief Method ReduceVariable, addr 0x5f84e1c, size 0x2c4, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceVariable();

  /// @brief Method Update, addr 0x5f7fda4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f83f90, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanReduce, addr 0x5f842fc, size 0x24, virtual true, abstract: false, final false
  inline bool get_CanReduce();

  /// @brief Method get_IsLifted, addr 0x5f84030, size 0x214, virtual false, abstract: false, final false
  inline bool get_IsLifted();

  /// @brief Method get_IsLiftedToNull, addr 0x5f84244, size 0x90, virtual false, abstract: false, final false
  inline bool get_IsLiftedToNull();

  /// @brief Method get_IsPrefix, addr 0x5f850e0, size 0x44, virtual false, abstract: false, final false
  inline bool get_IsPrefix();

  /// @brief Method get_Method, addr 0x5f84028, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_Method();

  /// @brief Method get_NodeType, addr 0x5f84018, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Operand, addr 0x5f84020, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Operand();

  /// @brief Method get_Type, addr 0x5f84010, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Linq::Expressions::UnaryExpression) == 0x30, "Size mismatch!");
