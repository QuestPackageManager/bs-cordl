...
public:
  ...
  /// @brief Method ValidateBinary, addr 0x5f7ee8c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateChildType, addr 0x5f7ff64, size 0xfc, virtual false, abstract: false, final false
  static inline void ValidateChildType(::System::Type* before, ::System::Type* after, ::StringW methodName);

  /// @brief Method ValidateUnary, addr 0x5f7fe68, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Visit, addr 0x5f7eb5c, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Visit, addr 0x5f7eb38, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method VisitLoop, addr 0x5f7f43c, size 0x84, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitLoop(::System::Linq::Expressions::LoopExpression* node);

  /// @brief Method VisitMember, addr 0x5f7f57c, size 0x30, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMember(::System::Linq::Expressions::MemberExpression* node);

  /// @brief Method VisitMethodCall, addr 0x5f7f744, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMethodCall(::System::Linq::Expressions::MethodCallExpression* node);

  /// @brief Method VisitNewArray, addr 0x5f7f7e8, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitNewArray(::System::Linq::Expressions::NewArrayExpression* node);

  /// @brief Method VisitParameter, addr 0x5f7f988, size 0x8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitParameter(::System::Linq::Expressions::ParameterExpression* node);

  /// @brief Method VisitParameters, addr 0x5f7eda0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method VisitTry, addr 0x5f7fa54, size 0x104, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTry(::System::Linq::Expressions::TryExpression* node);

  /// @brief Method VisitTypeBinary, addr 0x5f7fc68, size 0x30, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTypeBinary(::System::Linq::Expressions::TypeBinaryExpression* node);

  /// @brief Method VisitUnary, addr 0x5f7fd68, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitUnary(::System::Linq::Expressions::UnaryExpression* node);

  /// @brief Method .ctor, addr 0x5f7c580, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
