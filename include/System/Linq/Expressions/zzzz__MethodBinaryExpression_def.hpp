...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodBinaryExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodBinaryExpression(MethodBinaryExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodBinaryExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodBinaryExpression(MethodBinaryExpressionconst&) = delete;
