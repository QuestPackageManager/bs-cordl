...
public:
  ...
  /// @brief Method GetMethod, addr 0x5dae5b8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dae52c, size 0x40, virtual false, abstract: false, final false
