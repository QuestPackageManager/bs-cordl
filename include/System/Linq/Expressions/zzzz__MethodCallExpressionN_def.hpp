...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f86ff8, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f87150, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f86fd4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f870ac, size 0xa4, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpressionN", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodCallExpressionN(MethodCallExpressionN&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpressionN", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodCallExpressionN(MethodCallExpressionNconst&) = delete;
