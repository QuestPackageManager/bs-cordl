...
public:
  ...
  /// @brief Method get_BindingType, addr 0x40ba768, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::MemberBindingType get_BindingType();

  /// @brief Method get_Member, addr 0x40ba770, size 0x8, virtual false, abstract: false, final false
