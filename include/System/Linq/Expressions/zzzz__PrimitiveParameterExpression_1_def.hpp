...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrimitiveParameterExpression_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrimitiveParameterExpression_1(PrimitiveParameterExpression_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrimitiveParameterExpression_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrimitiveParameterExpression_1(PrimitiveParameterExpression_1const&) = delete;
