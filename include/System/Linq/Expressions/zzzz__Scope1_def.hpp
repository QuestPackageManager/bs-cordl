...
public:
  ...
  /// @brief Method GetExpression, addr 0x5f741d4, size 0x88, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5f74264, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f7426c, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f74184, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f741ac, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5f7425c, size 0x8, virtual true, abstract: false, final false
