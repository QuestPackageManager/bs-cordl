...
public:
  ...
  /// @brief Method GetExpression, addr 0x40add40, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40addc4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40addcc, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40adcf0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40add18, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x40addbc, size 0x8, virtual true, abstract: false, final false
