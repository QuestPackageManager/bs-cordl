...
public:
  ...
  /// @brief Method GetExpression, addr 0x5d5d308, size 0x88, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5d5d398, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5d5d3a0, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d5d2b8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d5d2e0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5d5d390, size 0x8, virtual true, abstract: false, final false
