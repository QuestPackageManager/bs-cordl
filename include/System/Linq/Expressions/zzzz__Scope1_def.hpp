...
public:
  ...
  /// @brief Method GetExpression, addr 0x40a91ac, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40a9230, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40a9238, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40a915c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40a9184, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x40a9228, size 0x8, virtual true, abstract: false, final false
