...
public:
  ...
  /// @brief Method GetExpression, addr 0x2afea5c, size 0x7c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x2afeae0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x2afeae8, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2afea0c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2afea34, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x2afead8, size 0x8, virtual true, abstract: false, final false
