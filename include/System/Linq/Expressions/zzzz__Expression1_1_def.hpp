...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Expression1_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Expression1_1(Expression1_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Expression1_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Expression1_1(Expression1_1const&) = delete;
