...
public:
  ...
  /// @brief Method GetConversion, addr 0x4098a50, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40989c8, size 0x48, virtual false, abstract: false, final false
