...
public:
  ...
  /// @brief Method GetConversion, addr 0x40a46d8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40a4650, size 0x48, virtual false, abstract: false, final false
