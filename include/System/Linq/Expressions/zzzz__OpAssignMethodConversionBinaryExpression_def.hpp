...
public:
  ...
  /// @brief Method GetConversion, addr 0x5e20c38, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e20bb0, size 0x48, virtual false, abstract: false, final false
