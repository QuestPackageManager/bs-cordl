...
public:
  ...
  /// @brief Method GetConversion, addr 0x5f630c4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f6303c, size 0x48, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OpAssignMethodConversionBinaryExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OpAssignMethodConversionBinaryExpression(OpAssignMethodConversionBinaryExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OpAssignMethodConversionBinaryExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OpAssignMethodConversionBinaryExpression(OpAssignMethodConversionBinaryExpressionconst&) = delete;
