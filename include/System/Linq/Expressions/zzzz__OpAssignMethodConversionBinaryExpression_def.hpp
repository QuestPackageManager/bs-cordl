...
public:
  ...
  /// @brief Method GetConversion, addr 0x5f5d8ac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f5d824, size 0x48, virtual false, abstract: false, final false
