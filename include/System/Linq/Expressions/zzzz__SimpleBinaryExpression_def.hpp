...
public:
  ...
  /// @brief Method .ctor, addr 0x409b6b0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x409b6e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x409b6ec, size 0x8, virtual true, abstract: false, final true
