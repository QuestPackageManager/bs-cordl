...
/// @brief Field <Document>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__Document_k__BackingField, put=__cordl_internal_set__Document_k__BackingField)) ::System::Linq::Expressions::SymbolDocumentInfo*  _Document_k__BackingField;
...
/// @brief Method get_Document, addr 0x5dc6870, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::SymbolDocumentInfo* get_Document() ;

/// @brief Method get_EndLine, addr 0x5dc6848, size 0x28, virtual true, abstract: false, final false
inline int32_t get_EndLine() ;

/// @brief Method get_IsClear, addr 0x5dc6878, size 0x28, virtual true, abstract: false, final false
inline bool get_IsClear() ;

/// @brief Method get_StartLine, addr 0x5dc6820, size 0x28, virtual true, abstract: false, final false
