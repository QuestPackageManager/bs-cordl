...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Linq::Expressions::Expression2_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::Expressions::Expression2_1, "System.Linq.Expressions", "Expression2`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Expression2_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Expression2_1(Expression2_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Expression2_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Expression2_1(Expression2_1const&) = delete;
