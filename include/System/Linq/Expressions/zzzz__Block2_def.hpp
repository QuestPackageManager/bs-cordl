...
public:
  ...
  /// @brief Method GetExpression, addr 0x5dc441c, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5dc4528, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5dc4530, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dc43f4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* arg0, ::System::Linq::Expressions::Expression* arg1);

  /// @brief Method get_ExpressionCount, addr 0x5dc4520, size 0x8, virtual true, abstract: false, final false
