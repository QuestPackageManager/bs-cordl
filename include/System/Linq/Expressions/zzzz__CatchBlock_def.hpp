...
public:
  ...
  /// @brief Method ToString, addr 0x5e37fec, size 0x4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Update, addr 0x5e38070, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e37fc0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Body, addr 0x5e37fdc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Body();

  /// @brief Method get_Filter, addr 0x5e37fe4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Filter();

  /// @brief Method get_Test, addr 0x5e37fd4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_Test();

  /// @brief Method get_Variable, addr 0x5e37fcc, size 0x8, virtual false, abstract: false, final false
