...
public:
  ...
  /// @brief Method ToString, addr 0x5f7a478, size 0x4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Update, addr 0x5f7a4fc, size 0xc4, virtual false, abstract: false, final false
