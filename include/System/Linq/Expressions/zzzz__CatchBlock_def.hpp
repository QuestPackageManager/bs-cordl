...
/// @brief Field <Variable>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__Variable_k__BackingField, put=__cordl_internal_set__Variable_k__BackingField)) ::System::Linq::Expressions::ParameterExpression*  _Variable_k__BackingField;

static inline ::System::Linq::Expressions::CatchBlock* New_ctor(::System::Type*  test, ::System::Linq::Expressions::ParameterExpression*  variable, ::System::Linq::Expressions::Expression*  body, ::System::Linq::Expressions::Expression*  filter) ;

/// @brief Method ToString, addr 0x5dc5fe0, size 0x4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Update, addr 0x5dc6064, size 0xc4, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::CatchBlock* Update(::System::Linq::Expressions::ParameterExpression*  variable, ::System::Linq::Expressions::Expression*  filter, ::System::Linq::Expressions::Expression*  body) ;
...
/// @brief Method .ctor, addr 0x5dc5fb4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_Body, addr 0x5dc5fd0, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Body() ;

/// @brief Method get_Filter, addr 0x5dc5fd8, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Filter() ;

/// @brief Method get_Test, addr 0x5dc5fc8, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_Test() ;

/// @brief Method get_Variable, addr 0x5dc5fc0, size 0x8, virtual false, abstract: false, final false
