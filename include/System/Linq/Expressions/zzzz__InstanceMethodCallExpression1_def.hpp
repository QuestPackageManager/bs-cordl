...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f884f0, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f8859c, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f884c8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f88594, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InstanceMethodCallExpression1(InstanceMethodCallExpression1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InstanceMethodCallExpression1(InstanceMethodCallExpression1const&) = delete;
