...
public:
  ...
  /// @brief Method GetExpression, addr 0x5d5ca68, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5d5cb24, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5d5cb2c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d5ca30, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5d5cb1c, size 0x8, virtual true, abstract: false, final false
