...
public:
  ...
  /// @brief Method GetExpression, addr 0x2afe238, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x2afe2e4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x2afe2ec, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2afe200, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x2afe2dc, size 0x8, virtual true, abstract: false, final false
