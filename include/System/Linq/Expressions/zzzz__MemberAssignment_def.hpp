...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemberAssignment", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemberAssignment(MemberAssignment&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemberAssignment", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemberAssignment(MemberAssignmentconst&) = delete;
