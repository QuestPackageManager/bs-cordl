...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f88988, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f88a60, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f8894c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f88a58, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InstanceMethodCallExpression3(InstanceMethodCallExpression3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InstanceMethodCallExpression3(InstanceMethodCallExpression3const&) = delete;
