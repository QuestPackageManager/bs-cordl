...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::InstanceMethodCallExpressionN*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::InstanceMethodCallExpressionN*, "System.Linq.Expressions", "InstanceMethodCallExpressionN");
// Dependencies System.Linq.Expressions.InstanceMethodCallExpression
namespace System::Linq::Expressions {
// Is value type: false
...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f871f0, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f87348, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f871c8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* instance,
                    ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* args);

  /// @brief Method get_ArgumentCount, addr 0x5f872a4, size 0xa4, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpressionN", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InstanceMethodCallExpressionN(InstanceMethodCallExpressionN&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpressionN", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InstanceMethodCallExpressionN(InstanceMethodCallExpressionNconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::InstanceMethodCallExpressionN) == 0x28, "Size mismatch!");
