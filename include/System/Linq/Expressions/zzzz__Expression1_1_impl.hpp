...
template <typename TDelegate> constexpr ::cordl_internals::to_const_pointer<::System::Object*> const& System::Linq::Expressions::Expression1_1<TDelegate>::__cordl_internal_get__par0() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____par0;
}
