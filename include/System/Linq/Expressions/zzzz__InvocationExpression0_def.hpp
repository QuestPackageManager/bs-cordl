...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f85d64, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f85db8, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f85d60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* lambda, ::System::Type* returnType);

  /// @brief Method get_ArgumentCount, addr 0x5f85db0, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression0", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvocationExpression0(InvocationExpression0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvocationExpression0(InvocationExpression0const&) = delete;
