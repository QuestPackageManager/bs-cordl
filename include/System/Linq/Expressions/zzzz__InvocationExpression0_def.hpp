...
public:
  ...
  /// @brief Method GetArgument, addr 0x2c08f2c, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x2c08f84, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c08f28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* lambda, ::System::Type* returnType);

  /// @brief Method get_ArgumentCount, addr 0x2c08f7c, size 0x8, virtual true, abstract: false, final false
