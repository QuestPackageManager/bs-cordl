...
public:
  ...
  /// @brief Method GetArgument, addr 0x40b94ec, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40b9540, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40b94e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* lambda, ::System::Type* returnType);

  /// @brief Method get_ArgumentCount, addr 0x40b9538, size 0x8, virtual true, abstract: false, final false
