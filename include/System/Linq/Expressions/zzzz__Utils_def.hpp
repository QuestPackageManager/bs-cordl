...
public:
  ...
  /// @brief Method Constant, addr 0x40bfee8, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Linq::Expressions::ConstantExpression* Constant(bool value);

  /// @brief Method Constant, addr 0x40bff54, size 0x180, virtual false, abstract: false, final false
