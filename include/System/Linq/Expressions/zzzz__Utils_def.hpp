...
public:
  ...
  /// @brief Method Constant, addr 0x5e48580, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Linq::Expressions::ConstantExpression* Constant(bool value);

  /// @brief Method Constant, addr 0x5e48600, size 0x180, virtual false, abstract: false, final false
