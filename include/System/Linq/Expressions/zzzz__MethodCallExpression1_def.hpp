...
public:
  ...
  /// @brief Method GetArgument, addr 0x2b0bd7c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x2b0be20, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0bd58, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* arg0);

  /// @brief Method get_ArgumentCount, addr 0x2b0be18, size 0x8, virtual true, abstract: false, final false
