...
public:
  ...
  /// @brief Method GetArgument, addr 0x40bf488, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40bf528, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40bf464, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* arg0);

  /// @brief Method get_ArgumentCount, addr 0x40bf520, size 0x8, virtual true, abstract: false, final false
