...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::MethodCallExpression1*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::MethodCallExpression1*, "System.Linq.Expressions", "MethodCallExpression1");
...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f874a4, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f87550, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f87480, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* arg0);

  /// @brief Method get_ArgumentCount, addr 0x5f87548, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodCallExpression1(MethodCallExpression1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodCallExpression1(MethodCallExpression1const&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::MethodCallExpression1) == 0x20, "Size mismatch!");
