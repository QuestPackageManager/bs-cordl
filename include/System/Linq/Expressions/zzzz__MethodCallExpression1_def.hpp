...
public:
  ...
  /// @brief Method GetArgument, addr 0x40b6078, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40b6118, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40b6054, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* arg0);

  /// @brief Method get_ArgumentCount, addr 0x40b6110, size 0x8, virtual true, abstract: false, final false
