...
public:
  ...
  /// @brief Method get_Body, addr 0x5f83d2c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Body();

  /// @brief Method get_TestValues, addr 0x5f83d24, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::SwitchCase) == 0x20, "Size mismatch!");
