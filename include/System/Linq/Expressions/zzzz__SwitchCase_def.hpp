...
public:
  ...
  /// @brief Method get_Body, addr 0x5d6ce60, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Body();

  /// @brief Method get_TestValues, addr 0x5d6ce58, size 0x8, virtual false, abstract: false, final false
