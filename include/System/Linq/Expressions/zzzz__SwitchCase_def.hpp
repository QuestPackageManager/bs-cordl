...
public:
  ...
  /// @brief Method get_Body, addr 0x5e470b8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Body();

  /// @brief Method get_TestValues, addr 0x5e470b0, size 0x8, virtual false, abstract: false, final false
