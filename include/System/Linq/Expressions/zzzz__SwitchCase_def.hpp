...
/// @brief Field <TestValues>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__TestValues_k__BackingField, put=__cordl_internal_set__TestValues_k__BackingField)) ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::Expression*>*  _TestValues_k__BackingField;
...
/// @brief Method get_Body, addr 0x5e48c30, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Body() ;

/// @brief Method get_TestValues, addr 0x5e48c28, size 0x8, virtual false, abstract: false, final false
