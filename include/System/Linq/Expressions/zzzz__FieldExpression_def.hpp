...
public:
  ...
  /// @brief Method GetMember, addr 0x5f86dfc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f86d80, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* expression, ::System::Reflection::FieldInfo* member);

  /// @brief Method get_Type, addr 0x5f86e04, size 0x20, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FieldExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FieldExpression(FieldExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FieldExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FieldExpression(FieldExpressionconst&) = delete;
