...
public:
  ...
  /// @brief Method GetArgument, addr 0x5e38954, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method get_AddMethod, addr 0x5e38944, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_AddMethod();

  /// @brief Method get_ArgumentCount, addr 0x5e389b8, size 0x54, virtual true, abstract: false, final true
  inline int32_t get_ArgumentCount();

  /// @brief Method get_Arguments, addr 0x5e3894c, size 0x8, virtual false, abstract: false, final false
