...
template <typename TDelegate> inline void System::Linq::Expressions::Expression0_1<TDelegate>::_ctor(::System::Linq::Expressions::Expression* body) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::Expression0_1<TDelegate>*>(), { ".ctor", {}, { ::i2c::type_of<::System::Linq::Expressions::Expression*>() } })));
...
template <typename TDelegate> inline int32_t System::Linq::Expressions::Expression0_1<TDelegate>::get_ParameterCount() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::Expression0_1<TDelegate>*>(), 17 })));
...
template <typename TDelegate> inline ::System::Linq::Expressions::ParameterExpression* System::Linq::Expressions::Expression0_1<TDelegate>::GetParameter(int32_t index) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::Expression0_1<TDelegate>*>(), 16 })));
  return ::cordl_internals::RunMethodRethrow<::System::Linq::Expressions::ParameterExpression*>(this, ___internal_method, index);
}
template <typename TDelegate>
inline ::System::Linq::Expressions::Expression_1<TDelegate>* System::Linq::Expressions::Expression0_1<TDelegate>::Rewrite(::System::Linq::Expressions::Expression* body,
                                                                                                                          ::ArrayW<::System::Linq::Expressions::ParameterExpression*> parameters) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::Expression0_1<TDelegate>*>(), 18 })));
...
inline ::System::Linq::Expressions::Expression0_1<TDelegate>* System::Linq::Expressions::Expression0_1<TDelegate>::New_ctor(::System::Linq::Expressions::Expression* body) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::System::Linq::Expressions::Expression0_1<TDelegate>*>(body));
}
// Ctor Parameters []
