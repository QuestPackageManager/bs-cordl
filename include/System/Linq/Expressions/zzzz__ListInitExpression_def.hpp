...
public:
  ...
  /// @brief Method get_Initializers, addr 0x5dd1fa0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ElementInit*>* get_Initializers();

  /// @brief Method get_NewExpression, addr 0x5dd1f98, size 0x8, virtual false, abstract: false, final false
