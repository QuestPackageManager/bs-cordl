...
public:
  ...
  /// @brief Method get_Initializers, addr 0x40b5690, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ElementInit*>* get_Initializers();

  /// @brief Method get_NewExpression, addr 0x40b5688, size 0x8, virtual false, abstract: false, final false
