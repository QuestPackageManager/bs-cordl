...
public:
  ...
  /// @brief Method get_Initializers, addr 0x40bbe48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ElementInit*>* get_Initializers();

  /// @brief Method get_NewExpression, addr 0x40bbe40, size 0x8, virtual false, abstract: false, final false
