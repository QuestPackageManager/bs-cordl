...
public:
  ...
  /// @brief Method Accept, addr 0x5f85920, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5f84a14, size 0xc0, virtual false, abstract: false, final false
