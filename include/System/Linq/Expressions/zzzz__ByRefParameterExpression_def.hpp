...
public:
  // Declarations
  /// @brief Method GetIsByRef, addr 0x5f89518, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f89458, size 0x28, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ByRefParameterExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ByRefParameterExpression(ByRefParameterExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ByRefParameterExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ByRefParameterExpression(ByRefParameterExpressionconst&) = delete;
