...
public:
  // Declarations
  /// @brief Method GetIsByRef, addr 0x5f83d00, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f83c40, size 0x28, virtual false, abstract: false, final false
