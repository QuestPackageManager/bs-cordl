...
public:
  // Declarations
  /// @brief Method GetIsByRef, addr 0x5e4708c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e46fcc, size 0x28, virtual false, abstract: false, final false
