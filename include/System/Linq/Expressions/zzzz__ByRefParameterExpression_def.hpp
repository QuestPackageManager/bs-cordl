...
public:
// Declarations
/// @brief Method GetIsByRef, addr 0x5dd5080, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5dd4fc0, size 0x28, virtual false, abstract: false, final false
