...
public:
  // Declarations
  /// @brief Method GetIsByRef, addr 0x2b0de88, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0dd88, size 0x28, virtual false, abstract: false, final false
