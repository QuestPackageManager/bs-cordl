...
public:
  // Declarations
  /// @brief Method GetIsByRef, addr 0x40ca54c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40ca44c, size 0x28, virtual false, abstract: false, final false
