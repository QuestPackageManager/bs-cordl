...
public:
  // Declarations
  /// @brief Method AnalyzeTypeIs, addr 0x40b31cc, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method AnalyzeTypeIs, addr 0x40b31b0, size 0x1c, virtual false, abstract: false, final false
