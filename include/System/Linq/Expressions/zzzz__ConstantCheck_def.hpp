...
public:
  // Declarations
  /// @brief Method AnalyzeTypeIs, addr 0x5dc5a80, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method AnalyzeTypeIs, addr 0x5dc5a68, size 0x18, virtual false, abstract: false, final false
