...
public:
  // Declarations
  /// @brief Method AnalyzeTypeIs, addr 0x5f74dc0, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method AnalyzeTypeIs, addr 0x5f74da8, size 0x18, virtual false, abstract: false, final false
