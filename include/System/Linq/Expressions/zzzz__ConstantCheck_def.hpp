...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConstantCheck", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConstantCheck(ConstantCheck&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConstantCheck", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConstantCheck(ConstantCheckconst&) = delete;
