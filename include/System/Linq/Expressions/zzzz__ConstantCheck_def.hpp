...
public:
  // Declarations
  /// @brief Method AnalyzeTypeIs, addr 0x5e3814c, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method AnalyzeTypeIs, addr 0x5e38134, size 0x18, virtual false, abstract: false, final false
