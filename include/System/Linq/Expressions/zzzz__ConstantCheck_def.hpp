...
public:
  // Declarations
  /// @brief Method AnalyzeTypeIs, addr 0x2c1e688, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method AnalyzeTypeIs, addr 0x2c1e66c, size 0x1c, virtual false, abstract: false, final false
