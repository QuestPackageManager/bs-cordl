...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::InvocationExpression5*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::InvocationExpression5*, "System.Linq.Expressions", "InvocationExpression5");
...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f865ec, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f866ec, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f865a0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f866e4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvocationExpression5(InvocationExpression5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvocationExpression5(InvocationExpression5const&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::InvocationExpression5) == 0x48, "Size mismatch!");
