...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExpressionCreator_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExpressionCreator_1(ExpressionCreator_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExpressionCreator_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExpressionCreator_1(ExpressionCreator_1const&) = delete;
