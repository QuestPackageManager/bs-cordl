...
public:
  ...
  /// @brief Method Accept, addr 0x5f89780, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5f854b0, size 0xd0, virtual false, abstract: false, final false
