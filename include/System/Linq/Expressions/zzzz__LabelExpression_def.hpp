...
public:
  ...
  /// @brief Method Accept, addr 0x5dd1d54, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5dd0060, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd1cbc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::LabelTarget* label, ::System::Linq::Expressions::Expression* defaultValue);

  /// @brief Method get_DefaultValue, addr 0x5dd1d4c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_DefaultValue();

  /// @brief Method get_NodeType, addr 0x5dd1d3c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Target, addr 0x5dd1d44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::LabelTarget* get_Target();

  /// @brief Method get_Type, addr 0x5dd1d24, size 0x18, virtual true, abstract: false, final true
