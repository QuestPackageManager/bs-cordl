...
/// @brief Method GetExpression, addr 0x5e389d4, size 0xcc, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetExpression(int32_t  index) ;

/// @brief Method GetOrMakeExpressions, addr 0x5e38aa8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x5e38ab0, size 0xa4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e38998, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_ExpressionCount, addr 0x5e38aa0, size 0x8, virtual true, abstract: false, final false
