...
public:
  ...
  /// @brief Method GetExpression, addr 0x4036634, size 0xbc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40366f8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x4036700, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40365f8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x40366f0, size 0x8, virtual true, abstract: false, final false
