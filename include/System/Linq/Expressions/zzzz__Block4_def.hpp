...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Block4*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Block4*, "System.Linq.Expressions", "Block4");
...
public:
  ...
  /// @brief Method GetExpression, addr 0x5f792e8, size 0xcc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5f793bc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f793c4, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f792ac, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5f793b4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Block4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Block4(Block4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Block4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Block4(Block4const&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::Block4) == 0x30, "Size mismatch!");
