...
public:
  ...
  /// @brief Method GetExpression, addr 0x40ad6a0, size 0xbc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40ad764, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40ad76c, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40ad664, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x40ad75c, size 0x8, virtual true, abstract: false, final false
