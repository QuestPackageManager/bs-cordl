...
public:
  ...
  /// @brief Method GetExpression, addr 0x40a8b0c, size 0xbc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40a8bd0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40a8bd8, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40a8ad0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x40a8bc8, size 0x8, virtual true, abstract: false, final false
