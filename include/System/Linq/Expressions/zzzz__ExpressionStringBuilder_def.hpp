...
public:
  ...
  /// @brief Method CatchBlockToString, addr 0x40ad1c4, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW CatchBlockToString(::System::Linq::Expressions::CatchBlock* node);

  /// @brief Method DumpLabel, addr 0x40b5ca8, size 0xbc, virtual false, abstract: false, final false
  inline void DumpLabel(::System::Linq::Expressions::LabelTarget* target);

  /// @brief Method ExpressionToString, addr 0x40b435c, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW ExpressionToString(::System::Linq::Expressions::Expression* node);

  /// @brief Method GetId, addr 0x40b4210, size 0x110, virtual false, abstract: false, final false
  inline int32_t GetId(::System::Object* o);

  /// @brief Method GetLabelId, addr 0x40b420c, size 0x4, virtual false, abstract: false, final false
  inline int32_t GetLabelId(::System::Linq::Expressions::LabelTarget* label);

  /// @brief Method GetParamId, addr 0x40b4320, size 0x4, virtual false, abstract: false, final false
  inline int32_t GetParamId(::System::Linq::Expressions::ParameterExpression* p);

  /// @brief Method IsBool, addr 0x40b48dc, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Out, addr 0x40b4340, size 0x1c, virtual false, abstract: false, final false
  inline void Out(char16_t c);

  /// @brief Method Out, addr 0x40b4324, size 0x1c, virtual false, abstract: false, final false
  inline void Out(::StringW s);

  /// @brief Method OutMember, addr 0x40b4d7c, size 0xb0, virtual false, abstract: false, final false
  inline void OutMember(::System::Linq::Expressions::Expression* instance, ::System::Reflection::MemberInfo* member);

  /// @brief Method ToString, addr 0x40b41ec, size 0x20, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method VisitBinary, addr 0x40b43d4, size 0x508, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitBinary(::System::Linq::Expressions::BinaryExpression* node);

  /// @brief Method VisitBlock, addr 0x40b5838, size 0x33c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitBlock(::System::Linq::Expressions::BlockExpression* node);

  /// @brief Method VisitCatchBlock, addr 0x40b5f1c, size 0x108, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::CatchBlock* VisitCatchBlock(::System::Linq::Expressions::CatchBlock* node);

  /// @brief Method VisitConditional, addr 0x40b4b04, size 0x100, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitConditional(::System::Linq::Expressions::ConditionalExpression* node);

  /// @brief Method VisitConstant, addr 0x40b4c04, size 0x178, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitConstant(::System::Linq::Expressions::ConstantExpression* node);

  /// @brief Method VisitDefault, addr 0x40b5b74, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method VisitExtension, addr 0x40b6354, size 0x1fc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitExtension(::System::Linq::Expressions::Expression* node);

  /// @brief Method VisitGoto, addr 0x40b5d64, size 0x158, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitGoto(::System::Linq::Expressions::GotoExpression* node);

  /// @brief Method VisitIndex, addr 0x40b6084, size 0x188, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitIndex(::System::Linq::Expressions::IndexExpression* node);

  /// @brief Method VisitInvocation, addr 0x40b4e84, size 0x128, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitInvocation(::System::Linq::Expressions::InvocationExpression* node);

  /// @brief Method VisitLabel, addr 0x40b5c24, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method VisitLoop, addr 0x40b5ebc, size 0x60, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitLoop(::System::Linq::Expressions::LoopExpression* node);

  /// @brief Method VisitMember, addr 0x40b4e2c, size 0x4c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMember(::System::Linq::Expressions::MemberExpression* node);

  /// @brief Method VisitMethodCall, addr 0x40b4fac, size 0x1fc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitMethodCall(::System::Linq::Expressions::MethodCallExpression* node);

  /// @brief Method VisitNewArray, addr 0x40b51b4, size 0x128, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitNewArray(::System::Linq::Expressions::NewArrayExpression* node);

  /// @brief Method VisitParameter, addr 0x40b49f8, size 0x100, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitParameter(::System::Linq::Expressions::ParameterExpression* node);

  /// @brief Method VisitTry, addr 0x40b6024, size 0x60, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTry(::System::Linq::Expressions::TryExpression* node);

  /// @brief Method VisitTypeBinary, addr 0x40b52dc, size 0x10c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* VisitTypeBinary(::System::Linq::Expressions::TypeBinaryExpression* node);

  /// @brief Method VisitUnary, addr 0x40b53e8, size 0x450, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40b4180, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
