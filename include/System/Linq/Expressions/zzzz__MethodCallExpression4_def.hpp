...
public:
  ...
  /// @brief Method GetArgument, addr 0x40b9cf0, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40b9dd0, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40b9cb4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x40b9dc8, size 0x8, virtual true, abstract: false, final false
