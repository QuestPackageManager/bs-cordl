#pragma once
// IWYU pragma private; include "System/Linq/Expressions/MethodCallExpression4.hpp"
...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::MethodCallExpression4*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::MethodCallExpression4*, "System.Linq.Expressions", "MethodCallExpression4");
...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f87c3c, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f87d2c, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f87c00, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f87d24, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodCallExpression4(MethodCallExpression4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodCallExpression4(MethodCallExpression4const&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::MethodCallExpression4) == 0x38, "Size mismatch!");
