...
public:
  ...
  /// @brief Method Accept, addr 0x40a321c, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetBinaryOpFromAssignmentOp, addr 0x40a2820, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConversion, addr 0x40a3084, size 0x8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::LambdaExpression* GetConversion();

  /// @brief Method GetMethod, addr 0x40a0e1c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodInfo* GetMethod();

  /// @brief Method IsOpAssignment, addr 0x40a0df0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x40a1e34, size 0x78, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Reduce();

  /// @brief Method ReduceIndex, addr 0x40a22c0, size 0x45c, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceIndex();

  /// @brief Method ReduceMember, addr 0x40a1eac, size 0x414, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceMember();

  /// @brief Method ReduceUserdefinedLifted, addr 0x40a33ac, size 0x668, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceUserdefinedLifted();

  /// @brief Method ReduceVariable, addr 0x40a271c, size 0x104, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* ReduceVariable();

  /// @brief Method Update, addr 0x40a0e24, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40a0d54, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* left, ::System::Linq::Expressions::Expression* right);

  /// @brief Method get_CanReduce, addr 0x40a0dcc, size 0x24, virtual true, abstract: false, final false
  inline bool get_CanReduce();

  /// @brief Method get_Conversion, addr 0x40a0f88, size 0xc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::LambdaExpression* get_Conversion();

  /// @brief Method get_IsLifted, addr 0x40a308c, size 0x190, virtual false, abstract: false, final false
  inline bool get_IsLifted();

  /// @brief Method get_IsLiftedLogical, addr 0x40a3244, size 0x168, virtual false, abstract: false, final false
  inline bool get_IsLiftedLogical();

  /// @brief Method get_IsLiftedToNull, addr 0x40a1378, size 0x8c, virtual false, abstract: false, final false
  inline bool get_IsLiftedToNull();

  /// @brief Method get_IsReferenceComparison, addr 0x40a0f94, size 0xd4, virtual false, abstract: false, final false
  inline bool get_IsReferenceComparison();

  /// @brief Method get_Left, addr 0x40a0e08, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Left();

  /// @brief Method get_Method, addr 0x40a0e10, size 0xc, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_Method();

  /// @brief Method get_Right, addr 0x40a0e00, size 0x8, virtual false, abstract: false, final false
