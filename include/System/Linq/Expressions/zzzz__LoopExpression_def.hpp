...
/// @brief Field <BreakLabel>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__BreakLabel_k__BackingField, put=__cordl_internal_set__BreakLabel_k__BackingField)) ::System::Linq::Expressions::LabelTarget*  _BreakLabel_k__BackingField;

/// @brief Field <ContinueLabel>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__ContinueLabel_k__BackingField, put=__cordl_internal_set__ContinueLabel_k__BackingField)) ::System::Linq::Expressions::LabelTarget*  _ContinueLabel_k__BackingField;

/// @brief Method Accept, addr 0x5dd2740, size 0x28, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor*  visitor) ;

static inline ::System::Linq::Expressions::LoopExpression* New_ctor(::System::Linq::Expressions::Expression*  body, ::System::Linq::Expressions::LabelTarget*  _cordl_break, ::System::Linq::Expressions::LabelTarget*  _cordl_continue) ;

/// @brief Method Update, addr 0x5dd0840, size 0xbc, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::LoopExpression* Update(::System::Linq::Expressions::LabelTarget*  breakLabel, ::System::Linq::Expressions::LabelTarget*  continueLabel, ::System::Linq::Expressions::Expression*  body) ;
...
/// @brief Method .ctor, addr 0x5dd2668, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_Body, addr 0x5dd2728, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Body() ;

/// @brief Method get_BreakLabel, addr 0x5dd2730, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::LabelTarget* get_BreakLabel() ;

/// @brief Method get_ContinueLabel, addr 0x5dd2738, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::LabelTarget* get_ContinueLabel() ;

/// @brief Method get_NodeType, addr 0x5dd2720, size 0x8, virtual true, abstract: false, final true
inline ::System::Linq::Expressions::ExpressionType get_NodeType() ;

/// @brief Method get_Type, addr 0x5dd26e0, size 0x40, virtual true, abstract: false, final true
