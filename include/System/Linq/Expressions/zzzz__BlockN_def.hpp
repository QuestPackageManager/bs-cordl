...
public:
  ...
  /// @brief Method GetExpression, addr 0x5f79680, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5f797d8, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f79824, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f7965c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* expressions);

  /// @brief Method get_ExpressionCount, addr 0x5f79734, size 0xa4, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BlockN", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BlockN(BlockN&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BlockN", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BlockN(BlockNconst&) = delete;
