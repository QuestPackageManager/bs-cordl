...
public:
  ...
  /// @brief Method GetExpression, addr 0x5d5cf9c, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5d5d0f4, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5d5d140, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d5cf78, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* expressions);

  /// @brief Method get_ExpressionCount, addr 0x5d5d050, size 0xa4, virtual true, abstract: false, final false
