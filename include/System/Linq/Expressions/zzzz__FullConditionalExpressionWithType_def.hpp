...
public:
  ...
  /// @brief Method .ctor, addr 0x5f75198, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x5f75390, size 0x8, virtual true, abstract: false, final true
