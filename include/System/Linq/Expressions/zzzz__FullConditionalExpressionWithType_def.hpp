...
public:
  ...
  /// @brief Method .ctor, addr 0x5d5e2cc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x5d5e4c4, size 0x8, virtual true, abstract: false, final true
