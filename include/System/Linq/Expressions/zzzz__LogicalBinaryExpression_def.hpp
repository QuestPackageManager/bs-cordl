...
public:
  ...
  /// @brief Method .ctor, addr 0x5dae408, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x5dae464, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x5dae434, size 0x30, virtual true, abstract: false, final true
