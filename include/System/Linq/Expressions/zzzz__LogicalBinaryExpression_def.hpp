...
public:
  ...
  /// @brief Method .ctor, addr 0x5d4687c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x5d468d8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x5d468a8, size 0x30, virtual true, abstract: false, final true
