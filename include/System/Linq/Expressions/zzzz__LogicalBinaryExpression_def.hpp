...
public:
  ...
  /// @brief Method .ctor, addr 0x2be52a0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x2be5338, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x2be52cc, size 0x6c, virtual true, abstract: false, final true
