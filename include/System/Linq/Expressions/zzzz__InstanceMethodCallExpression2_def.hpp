...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f886f4, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f887bc, size 0x190, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f886bc, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f887b4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InstanceMethodCallExpression2(InstanceMethodCallExpression2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InstanceMethodCallExpression2(InstanceMethodCallExpression2const&) = delete;
