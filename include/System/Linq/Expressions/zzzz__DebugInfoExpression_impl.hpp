...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Linq::Expressions::DebugInfoExpression::*)()>(&::System::Linq::Expressions::DebugInfoExpression::get_StartLine)> {
  ...
  constexpr static std::size_t addrs = 0x5f754a0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), { ::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), 10 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Linq::Expressions::DebugInfoExpression::*)()>(&::System::Linq::Expressions::DebugInfoExpression::get_EndLine)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x5f754c8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), { ::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), 11 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Linq::Expressions::SymbolDocumentInfo* (::System::Linq::Expressions::DebugInfoExpression::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5f754f0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::System::Linq::Expressions::DebugInfoExpression::*)()>(&::System::Linq::Expressions::DebugInfoExpression::get_IsClear)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x5f754f8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), { ::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), 12 }));
    return ___internal_method;
  }
};
...
inline int32_t System::Linq::Expressions::DebugInfoExpression::get_StartLine() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), 10 })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method);
}
inline int32_t System::Linq::Expressions::DebugInfoExpression::get_EndLine() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), 11 })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method);
}
...
inline bool System::Linq::Expressions::DebugInfoExpression::get_IsClear() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::System::Linq::Expressions::DebugInfoExpression*>(), 12 })));
