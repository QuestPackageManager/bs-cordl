...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::LabelTarget*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::LabelTarget*, "System.Linq.Expressions", "LabelTarget");
...
public:
  ...
  /// @brief Method ToString, addr 0x5f868ec, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f868d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW name);

  /// [CompilerGenerated]
  /// @brief Method get_Name, addr 0x5f868dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// [CompilerGenerated]
  /// @brief Method get_Type, addr 0x5f868e4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LabelTarget", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LabelTarget(LabelTarget&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LabelTarget", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LabelTarget(LabelTargetconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::LabelTarget) == 0x20, "Size mismatch!");
