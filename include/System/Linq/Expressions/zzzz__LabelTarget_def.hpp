...
public:
  ...
  /// @brief Method ToString, addr 0x5dd1d94, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd1d7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type, ::StringW name);

  /// @brief Method get_Name, addr 0x5dd1d84, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Type, addr 0x5dd1d8c, size 0x8, virtual false, abstract: false, final false
