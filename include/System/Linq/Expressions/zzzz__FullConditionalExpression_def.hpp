...
public:
  ...
  /// @brief Method GetFalse, addr 0x5f7aba0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f7a9d8, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FullConditionalExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FullConditionalExpression(FullConditionalExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FullConditionalExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FullConditionalExpression(FullConditionalExpressionconst&) = delete;
