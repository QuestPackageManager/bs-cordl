...
public:
  ...
  /// @brief Method GetFalse, addr 0x2bfe5a8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bfe3ec, size 0x24, virtual false, abstract: false, final false
