...
public:
  ...
  /// @brief Method GetFalse, addr 0x5f75388, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f751c0, size 0x24, virtual false, abstract: false, final false
