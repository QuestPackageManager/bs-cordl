...
public:
  ...
  /// @brief Method GetFalse, addr 0x5d5e4bc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d5e2f4, size 0x24, virtual false, abstract: false, final false
