...
public:
  ...
  /// @brief Method GetFalse, addr 0x5dc6048, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dc5e80, size 0x24, virtual false, abstract: false, final false
