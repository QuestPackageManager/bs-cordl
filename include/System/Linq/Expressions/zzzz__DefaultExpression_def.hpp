...
public:
  ...
  /// @brief Method Accept, addr 0x5f7adac, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f7ad38, size 0x64, virtual false, abstract: false, final false
