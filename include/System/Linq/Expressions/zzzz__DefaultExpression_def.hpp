...
public:
  ...
  /// @brief Method Accept, addr 0x5d5e6c8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d5e654, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_NodeType, addr 0x5d5e6c0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x5d5e6b8, size 0x8, virtual true, abstract: false, final true
