...
public:
  ...
  /// @brief Method get_Bindings, addr 0x5e449c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::MemberBinding*>* get_Bindings();

  /// @brief Method get_NewExpression, addr 0x5e449c0, size 0x8, virtual false, abstract: false, final false
