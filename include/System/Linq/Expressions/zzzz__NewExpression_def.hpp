...
public:
  ...
  /// @brief Method GetArgument, addr 0x2c2c598, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Constructor, addr 0x2c2c590, size 0x8, virtual false, abstract: false, final false
