...
public:
  ...
  /// @brief Method GetArgument, addr 0x2b0d5ac, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Constructor, addr 0x2b0d5a4, size 0x8, virtual false, abstract: false, final false
