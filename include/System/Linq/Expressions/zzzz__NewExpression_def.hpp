...
public:
  ...
  /// @brief Method GetArgument, addr 0x40be034, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Constructor, addr 0x40be02c, size 0x8, virtual false, abstract: false, final false
