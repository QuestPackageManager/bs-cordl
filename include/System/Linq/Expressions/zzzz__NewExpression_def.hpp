...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f835c4, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Constructor, addr 0x5f835bc, size 0x8, virtual false, abstract: false, final false
