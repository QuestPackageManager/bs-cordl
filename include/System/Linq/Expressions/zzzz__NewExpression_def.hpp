...
public:
  ...
  /// @brief Method GetArgument, addr 0x5dd4284, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Constructor, addr 0x5dd427c, size 0x8, virtual false, abstract: false, final false
