...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f85fc4, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f8608c, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f85f9c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f86084, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvocationExpression2(InvocationExpression2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvocationExpression2(InvocationExpression2const&) = delete;
