...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Linq::Expressions::Expression0_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::Expressions::Expression0_1, "System.Linq.Expressions", "Expression0`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Expression0_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Expression0_1(Expression0_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Expression0_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Expression0_1(Expression0_1const&) = delete;
