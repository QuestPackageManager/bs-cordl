...
// [DebuggerTypeProxy(typeof(System.Linq.Expressions.Expression::RuntimeVariablesExpressionProxy))]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RuntimeVariablesExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RuntimeVariablesExpression(RuntimeVariablesExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RuntimeVariablesExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RuntimeVariablesExpression(RuntimeVariablesExpressionconst&) = delete;
