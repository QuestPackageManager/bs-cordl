...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f87918, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f879f0, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f878e0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f879e8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodCallExpression3(MethodCallExpression3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodCallExpression3(MethodCallExpression3const&) = delete;
