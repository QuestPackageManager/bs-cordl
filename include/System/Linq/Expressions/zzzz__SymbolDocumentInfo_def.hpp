...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SymbolDocumentInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SymbolDocumentInfo(SymbolDocumentInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SymbolDocumentInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SymbolDocumentInfo(SymbolDocumentInfoconst&) = delete;
