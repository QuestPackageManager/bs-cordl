...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CoalesceConversionBinaryExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CoalesceConversionBinaryExpression(CoalesceConversionBinaryExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CoalesceConversionBinaryExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CoalesceConversionBinaryExpression(CoalesceConversionBinaryExpressionconst&) = delete;
