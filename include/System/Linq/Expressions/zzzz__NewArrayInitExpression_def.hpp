...
public:
  ...
  /// @brief Method .ctor, addr 0x40bdfd8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x40be01c, size 0x8, virtual true, abstract: false, final true
