...
public:
  ...
  /// @brief Method .ctor, addr 0x2c40f50, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x2c40f94, size 0x8, virtual true, abstract: false, final true
