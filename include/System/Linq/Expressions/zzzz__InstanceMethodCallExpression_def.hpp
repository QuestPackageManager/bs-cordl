...
public:
  ...
  /// @brief Method GetInstance, addr 0x5f86fcc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f86fa8, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InstanceMethodCallExpression(InstanceMethodCallExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InstanceMethodCallExpression(InstanceMethodCallExpressionconst&) = delete;
