...
public:
  ...
  /// @brief Method GetInstance, addr 0x40bc38c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40bc368, size 0x24, virtual false, abstract: false, final false
