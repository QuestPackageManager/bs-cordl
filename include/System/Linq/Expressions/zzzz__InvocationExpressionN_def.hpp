...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpressionN", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvocationExpressionN(InvocationExpressionN&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpressionN", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvocationExpressionN(InvocationExpressionNconst&) = delete;
