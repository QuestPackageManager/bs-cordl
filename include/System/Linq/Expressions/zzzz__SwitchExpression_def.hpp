...
/// @brief Field <Cases>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__Cases_k__BackingField, put=__cordl_internal_set__Cases_k__BackingField)) ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::SwitchCase*>*  _Cases_k__BackingField;
...
/// @brief Field <DefaultBody>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__DefaultBody_k__BackingField, put=__cordl_internal_set__DefaultBody_k__BackingField)) ::System::Linq::Expressions::Expression*  _DefaultBody_k__BackingField;

/// @brief Field <SwitchValue>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__SwitchValue_k__BackingField, put=__cordl_internal_set__SwitchValue_k__BackingField)) ::System::Linq::Expressions::Expression*  _SwitchValue_k__BackingField;
...
/// @brief Method get_Cases, addr 0x5dd50bc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::SwitchCase*>* get_Cases() ;

/// @brief Method get_Comparison, addr 0x5dd50cc, size 0x8, virtual false, abstract: false, final false
inline ::System::Reflection::MethodInfo* get_Comparison() ;

/// @brief Method get_DefaultBody, addr 0x5dd50c4, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_DefaultBody() ;

/// @brief Method get_SwitchValue, addr 0x5dd50b4, size 0x8, virtual false, abstract: false, final false
