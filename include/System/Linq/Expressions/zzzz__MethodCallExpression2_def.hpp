...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f87690, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f87758, size 0x188, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f87668, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f87750, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodCallExpression2(MethodCallExpression2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodCallExpression2(MethodCallExpression2const&) = delete;
