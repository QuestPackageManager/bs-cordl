...
public:
  ...
  /// @brief Method .ctor, addr 0x5d5e5a8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* value, ::System::Type* type);

  /// @brief Method get_Type, addr 0x5d5e5cc, size 0x8, virtual true, abstract: false, final true
