...
public:
  ...
  /// @brief Method Accept, addr 0x5e43690, size 0x24, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetArgument, addr 0x5e43640, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5e436b4, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e435c0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* expression, ::System::Type* returnType);

  /// @brief Method get_ArgumentCount, addr 0x5e43668, size 0x28, virtual true, abstract: false, final false
  inline int32_t get_ArgumentCount();

  /// @brief Method get_Expression, addr 0x5e43638, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Expression();

  /// @brief Method get_NodeType, addr 0x5e43630, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x5e43628, size 0x8, virtual true, abstract: false, final true
