...
public:
  ...
  /// @brief Method GetExpression, addr 0x5dc495c, size 0xdc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5dc4a40, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5dc4a48, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dc4910, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5dc4a38, size 0x8, virtual true, abstract: false, final false
