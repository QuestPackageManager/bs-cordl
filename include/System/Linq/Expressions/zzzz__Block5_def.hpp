...
public:
  ...
  /// @brief Method GetExpression, addr 0x40adc38, size 0xc4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40add04, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40add0c, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40adbec, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x40adcfc, size 0x8, virtual true, abstract: false, final false
