...
public:
  ...
  /// @brief Method GetExpression, addr 0x40af47c, size 0xc4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40af548, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40af550, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40af430, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x40af540, size 0x8, virtual true, abstract: false, final false
