...
public:
  ...
  /// @brief Method GetExpression, addr 0x5f794b4, size 0xdc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5f79598, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f795a0, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f79468, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5f79590, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Block5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Block5(Block5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Block5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Block5(Block5const&) = delete;
