...
public:
  ...
  /// @brief Method GetExpression, addr 0x5d5cdd0, size 0xdc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5d5ceb4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5d5cebc, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d5cd84, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5d5ceac, size 0x8, virtual true, abstract: false, final false
