...
public:
  ...
  /// @brief Method GetExpression, addr 0x5e37028, size 0xdc, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5e3710c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5e37114, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e36fdc, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x5e37104, size 0x8, virtual true, abstract: false, final false
