...
public:
  ...
  /// @brief Method GetExpression, addr 0x40adbc0, size 0xc4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40adc8c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40adc94, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40adb74, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExpressionCount, addr 0x40adc84, size 0x8, virtual true, abstract: false, final false
