...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::InvocationExpression3*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::InvocationExpression3*, "System.Linq.Expressions", "InvocationExpression3");
...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f86198, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f86270, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f86160, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f86268, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvocationExpression3(InvocationExpression3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvocationExpression3(InvocationExpression3const&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::InvocationExpression3) == 0x38, "Size mismatch!");
