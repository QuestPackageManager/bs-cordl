...
public:
  ...
  /// @brief Method Accept, addr 0x40b9060, size 0x2c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetArgument, addr 0x40b90b4, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetArgument(int32_t index);

  /// @brief Method GetInstance, addr 0x40b9024, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40b908c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40b8fb8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method);

  /// @brief Method get_ArgumentCount, addr 0x40b90dc, size 0x28, virtual true, abstract: false, final false
  inline int32_t get_ArgumentCount();

  /// @brief Method get_Method, addr 0x40b9058, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MethodInfo* get_Method();

  /// @brief Method get_NodeType, addr 0x40b902c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Object, addr 0x40b51a8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Object();

  /// @brief Method get_Type, addr 0x40b9034, size 0x24, virtual true, abstract: false, final true
