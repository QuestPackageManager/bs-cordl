...
public:
  ...
  /// @brief Method MoveNext, addr 0x40b2f08, size 0xcc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Linq::Expressions::BlockExpressionList__GetEnumerator_d__18* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Linq.Expressions.Expression>.get_Current, addr 0x40b2fd4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x40b2fdc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x40b3014, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x40b2f04, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x40b2ed8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x40b2c14, size 0x28, virtual true, abstract: false, final true
  inline void Add(::System::Linq::Expressions::Expression* item);

  /// @brief Method Clear, addr 0x40b2c3c, size 0x28, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x40b2c64, size 0x18, virtual true, abstract: false, final true
  inline bool Contains(::System::Linq::Expressions::Expression* item);

  /// @brief Method CopyTo, addr 0x40b2c7c, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetEnumerator, addr 0x40b2e78, size 0x60, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::System::Linq::Expressions::Expression*>* GetEnumerator();

  /// @brief Method IndexOf, addr 0x40b2ae4, size 0x88, virtual true, abstract: false, final true
  inline int32_t IndexOf(::System::Linq::Expressions::Expression* item);

  /// @brief Method Insert, addr 0x40b2b6c, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x40b2e50, size 0x28, virtual true, abstract: false, final true
  inline bool Remove(::System::Linq::Expressions::Expression* item);

  /// @brief Method RemoveAt, addr 0x40b2b94, size 0x28, virtual true, abstract: false, final true
  inline void RemoveAt(int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x40b2f00, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x40b1b90, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::BlockExpression* provider, ::System::Linq::Expressions::Expression* arg0);

  /// @brief Method get_Count, addr 0x40b2e08, size 0x20, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x40b2e28, size 0x28, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_Item, addr 0x40b2bbc, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x40b2bec, size 0x28, virtual true, abstract: false, final true
