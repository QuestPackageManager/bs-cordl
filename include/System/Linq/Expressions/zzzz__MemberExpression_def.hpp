...
public:
  ...
  /// @brief Method Accept, addr 0x2b0b6c0, size 0x2c, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetMember, addr 0x2b0b698, size 0x28, virtual true, abstract: false, final false
  inline ::System::Reflection::MemberInfo* GetMember();

  /// @brief Method Make, addr 0x2b0b5fc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Make, addr 0x2b0b568, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x2b0971c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0b4fc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Linq::Expressions::Expression* expression);

  /// @brief Method get_Expression, addr 0x2b0b4f4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* get_Expression();

  /// @brief Method get_Member, addr 0x2b075d8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_Member();

  /// @brief Method get_NodeType, addr 0x2b0b690, size 0x8, virtual true, abstract: false, final true
