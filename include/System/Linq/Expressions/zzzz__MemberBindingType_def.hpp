...
public:
  ...
  /// @brief Field Assignment value: static_cast<int32_t>(0x0)
  static ::System::Linq::Expressions::MemberBindingType const Assignment;

  /// @brief Field ListBinding value: static_cast<int32_t>(0x2)
  static ::System::Linq::Expressions::MemberBindingType const ListBinding;

  /// @brief Field MemberBinding value: static_cast<int32_t>(0x1)
