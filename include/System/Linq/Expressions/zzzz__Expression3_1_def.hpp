...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Expression3_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Expression3_1(Expression3_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Expression3_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Expression3_1(Expression3_1const&) = delete;
