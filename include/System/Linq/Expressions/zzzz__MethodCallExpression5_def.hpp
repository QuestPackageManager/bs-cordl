...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::MethodCallExpression5*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::MethodCallExpression5*, "System.Linq.Expressions", "MethodCallExpression5");
...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f87ff4, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f880f4, size 0x2ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f87fa8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f880ec, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodCallExpression5(MethodCallExpression5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodCallExpression5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodCallExpression5(MethodCallExpression5const&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::MethodCallExpression5) == 0x40, "Size mismatch!");
