...
public:
  ...
  /// @brief Method GetArgument, addr 0x40bd2f0, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40bd3d8, size 0x2d8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40bd2a4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x40bd3d0, size 0x8, virtual true, abstract: false, final false
