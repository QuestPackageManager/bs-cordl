...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssignBinaryExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssignBinaryExpression(AssignBinaryExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssignBinaryExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssignBinaryExpression(AssignBinaryExpressionconst&) = delete;
