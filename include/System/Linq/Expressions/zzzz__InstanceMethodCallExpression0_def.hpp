...
public:
  ...
  /// @brief Method GetArgument, addr 0x5e45f78, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5e45fcc, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e45f54, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* instance);

  /// @brief Method get_ArgumentCount, addr 0x5e45fc4, size 0x8, virtual true, abstract: false, final false
