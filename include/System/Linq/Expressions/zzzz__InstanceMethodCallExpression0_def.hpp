...
public:
  ...
  /// @brief Method GetArgument, addr 0x40c935c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40c93b0, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40c9338, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* instance);

  /// @brief Method get_ArgumentCount, addr 0x40c93a8, size 0x8, virtual true, abstract: false, final false
