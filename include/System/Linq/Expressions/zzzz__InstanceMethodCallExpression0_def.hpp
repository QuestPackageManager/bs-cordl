...
public:
  ...
  /// @brief Method GetArgument, addr 0x5d6bd20, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5d6bd74, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d6bcfc, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* instance);

  /// @brief Method get_ArgumentCount, addr 0x5d6bd6c, size 0x8, virtual true, abstract: false, final false
