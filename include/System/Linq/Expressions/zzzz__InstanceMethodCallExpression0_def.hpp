...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::InstanceMethodCallExpression0*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::InstanceMethodCallExpression0*, "System.Linq.Expressions", "InstanceMethodCallExpression0");
...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f88404, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f88458, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f883e0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MethodInfo* method, ::System::Linq::Expressions::Expression* instance);

  /// @brief Method get_ArgumentCount, addr 0x5f88450, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression0", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InstanceMethodCallExpression0(InstanceMethodCallExpression0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InstanceMethodCallExpression0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InstanceMethodCallExpression0(InstanceMethodCallExpression0const&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::InstanceMethodCallExpression0) == 0x20, "Size mismatch!");
