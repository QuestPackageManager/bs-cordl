...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::ScopeN*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::ScopeN*, "System.Linq.Expressions", "ScopeN");
...
public:
  ...
  /// @brief Method GetExpression, addr 0x5f79ba0, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x5f79cf8, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f79d44, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f79b70, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>* variables,
                    ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* body);

  /// @brief Method get_Body, addr 0x5f79b98, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* get_Body();

  /// @brief Method get_ExpressionCount, addr 0x5f79c54, size 0xa4, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScopeN", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScopeN(ScopeN&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScopeN", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScopeN(ScopeNconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::ScopeN) == 0x20, "Size mismatch!");
