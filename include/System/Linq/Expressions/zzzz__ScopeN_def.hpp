...
public:
  ...
  /// @brief Method GetExpression, addr 0x40ac898, size 0xa8, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* GetExpression(int32_t index);

  /// @brief Method GetOrMakeExpressions, addr 0x40ac9e0, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x40aca28, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40ac868, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>* variables,
                    ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* body);

  /// @brief Method get_Body, addr 0x40ac890, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* get_Body();

  /// @brief Method get_ExpressionCount, addr 0x40ac940, size 0xa0, virtual true, abstract: false, final false
