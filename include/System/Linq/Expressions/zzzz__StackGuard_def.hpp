...
public:
  ...
  /// @brief Method TryEnterOnCurrentStack, addr 0x40bb678, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40bb6d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
