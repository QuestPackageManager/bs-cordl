...
public:
  ...
  /// @brief Method TryEnterOnCurrentStack, addr 0x2b0dea0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0df10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
