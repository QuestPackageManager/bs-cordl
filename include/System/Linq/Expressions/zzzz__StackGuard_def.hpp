...
public:
  ...
  /// @brief Method TryEnterOnCurrentStack, addr 0x5d6ce4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d6ce54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
