...
public:
  ...
  /// @brief Method GetArgument, addr 0x5f85e38, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method Rewrite, addr 0x5f85ee4, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f85e14, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentCount, addr 0x5f85edc, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvocationExpression1(InvocationExpression1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvocationExpression1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvocationExpression1(InvocationExpression1const&) = delete;
