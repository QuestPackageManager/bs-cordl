...
public:
  ...
  /// @brief Method Accept, addr 0x5e47064, size 0x28, virtual true, abstract: false, final false
  inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor* visitor);

  /// @brief Method GetIsByRef, addr 0x5e4705c, size 0x8, virtual true, abstract: false, final false
  inline bool GetIsByRef();

  /// @brief Method Make, addr 0x5e46a68, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e46a04, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_IsByRef, addr 0x5e40358, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsByRef();

  /// @brief Method get_Name, addr 0x5e47054, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NodeType, addr 0x5e4704c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Linq::Expressions::ExpressionType get_NodeType();

  /// @brief Method get_Type, addr 0x5e4701c, size 0x30, virtual true, abstract: false, final false
