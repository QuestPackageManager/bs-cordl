...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::NewArrayBoundsExpression*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::NewArrayBoundsExpression*, "System.Linq.Expressions", "NewArrayBoundsExpression");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f88d88, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NodeType, addr 0x5f88dcc, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NewArrayBoundsExpression", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NewArrayBoundsExpression(NewArrayBoundsExpression&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NewArrayBoundsExpression", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NewArrayBoundsExpression(NewArrayBoundsExpressionconst&) = delete;
...
static_assert(sizeof(::System::Linq::Expressions::NewArrayBoundsExpression) == 0x20, "Size mismatch!");
