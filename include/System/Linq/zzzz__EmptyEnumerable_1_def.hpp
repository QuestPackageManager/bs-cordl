...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EmptyEnumerable_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EmptyEnumerable_1(EmptyEnumerable_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EmptyEnumerable_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EmptyEnumerable_1(EmptyEnumerable_1const&) = delete;
