...
public:
  ...
  /// @brief Method AddModifier, addr 0x288bfb4, size 0xf0, virtual false, abstract: false, final false
  inline void AddModifier(::System::ModifierSpec* md);

  /// @brief Method AddName, addr 0x288be94, size 0x118, virtual false, abstract: false, final false
  inline void AddName(::StringW type_name);

  /// @brief Method BoundCheck, addr 0x288c154, size 0x88, virtual false, abstract: false, final false
  static inline void BoundCheck(int32_t idx, ::StringW s);

  /// @brief Method GetDisplayFullName, addr 0x288a1d4, size 0x454, virtual false, abstract: false, final false
  inline ::StringW GetDisplayFullName(::System::__TypeSpec__DisplayNameFormat flags);

  /// @brief Method GetModifierString, addr 0x288a650, size 0x1f4, virtual false, abstract: false, final false
  inline ::System::Text::StringBuilder* GetModifierString(::System::Text::StringBuilder* sb);

  static inline ::System::TypeSpec* New_ctor();

  /// @brief Method Parse, addr 0x288a91c, size 0xb84, virtual false, abstract: false, final false
  static inline ::System::TypeSpec* Parse(::StringW name, ByRef<int32_t> p, bool is_recurse, bool allow_aqn);

  /// @brief Method Parse, addr 0x288a844, size 0xd8, virtual false, abstract: false, final false
  static inline ::System::TypeSpec* Parse(::StringW typeName);

  /// @brief Method ParsedTypeIdentifier, addr 0x288bfac, size 0x8, virtual false, abstract: false, final false
  static inline ::System::TypeIdentifier* ParsedTypeIdentifier(::StringW displayName);

  /// @brief Method Resolve, addr 0x288b588, size 0x90c, virtual false, abstract: false, final false
  ...
  /// @brief Method SkipSpace, addr 0x288c0a4, size 0xb0, virtual false, abstract: false, final false
  static inline void SkipSpace(::StringW name, ByRef<int32_t> pos);

  /// @brief Method UnescapeInternalName, addr 0x288b4a0, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x288c1dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DisplayFullName, addr 0x288a628, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_DisplayFullName();

  /// @brief Method get_HasModifiers, addr 0x288a1c4, size 0x10, virtual false, abstract: false, final false
