...
public:
  ...
  /// @brief Method Convert, addr 0x3db4a68, size 0x1f8, virtual false, abstract: false, final false
  inline ::StringW Convert(::StringW input, int32_t index, int32_t count, bool toAscii);

  /// @brief Method Equals, addr 0x3db48a4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetAscii, addr 0x3db4940, size 0x60, virtual false, abstract: false, final false
  inline ::StringW GetAscii(::StringW unicode);

  /// @brief Method GetAscii, addr 0x3db49a0, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW GetAscii(::StringW unicode, int32_t index, int32_t count);

  /// @brief Method GetHashCode, addr 0x3db4930, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUnicode, addr 0x3db59b0, size 0x60, virtual false, abstract: false, final false
  inline ::StringW GetUnicode(::StringW ascii);

  /// @brief Method GetUnicode, addr 0x3db5a10, size 0xc8, virtual false, abstract: false, final false
  inline ::StringW GetUnicode(::StringW ascii, int32_t index, int32_t count);

  /// @brief Method NamePrep, addr 0x3db5060, size 0x144, virtual false, abstract: false, final false
  inline ::StringW NamePrep(::StringW s, int32_t offset);

  static inline ::System::Globalization::IdnMapping* New_ctor();

  /// @brief Method ToAscii, addr 0x3db4c60, size 0x234, virtual false, abstract: false, final false
  inline ::StringW ToAscii(::StringW s, int32_t offset);

  /// @brief Method ToUnicode, addr 0x3db4e94, size 0x1cc, virtual false, abstract: false, final false
  inline ::StringW ToUnicode(::StringW s, int32_t offset);

  /// @brief Method VerifyLength, addr 0x3db56b4, size 0xc4, virtual false, abstract: false, final false
  inline void VerifyLength(::StringW s, int32_t offset);

  /// @brief Method VerifyProhibitedCharacters, addr 0x3db5778, size 0x238, virtual false, abstract: false, final false
  inline void VerifyProhibitedCharacters(::StringW s, int32_t offset);

  /// @brief Method VerifyStd3AsciiRules, addr 0x3db51a4, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3db4844, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
