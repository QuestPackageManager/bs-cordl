...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IdnMapping", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IdnMapping(IdnMapping&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IdnMapping", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IdnMapping(IdnMappingconst&) = delete;
