...
public:
  ...
  /// @brief Method Init, addr 0x3d90070, size 0x37c, virtual false, abstract: false, final false
  inline void Init(::System::ReadOnlySpan_1<char16_t> format, bool useInvariantFieldLengths);

  /// @brief Method InitInvariant, addr 0x3d8ff10, size 0x160, virtual false, abstract: false, final false
  static inline ::System::Globalization::TimeSpanFormat_FormatLiterals InitInvariant(bool isNegative);

  /// @brief Method get_DayHourSep, addr 0x3d8fe34, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_DayHourSep();

  /// @brief Method get_End, addr 0x3d8fee4, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_End();

  /// @brief Method get_HourMinuteSep, addr 0x3d8fe60, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_HourMinuteSep();

  /// @brief Method get_MinuteSecondSep, addr 0x3d8fe8c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_MinuteSecondSep();

  /// @brief Method get_SecondFractionSep, addr 0x3d8feb8, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_SecondFractionSep();

  /// @brief Method get_Start, addr 0x3d8fe0c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AppendNonNegativeInt32, addr 0x3d8e94c, size 0xf8, virtual false, abstract: false, final false
  static inline void AppendNonNegativeInt32(::System::Text::StringBuilder* sb, int32_t n, int32_t digits);

  /// @brief Method Format, addr 0x3d8ea44, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW Format(::System::TimeSpan value, ::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method FormatCustomized, addr 0x3d8f3e8, size 0x728, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatStandard, addr 0x3d8eef4, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatToBuilder, addr 0x3d8eafc, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormat, addr 0x3d8edd4, size 0x120, virtual false, abstract: false, final false
