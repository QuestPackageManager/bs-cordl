...
public:
  ...
  /// @brief Method Adapt, addr 0x5be0258, size 0x74, virtual false, abstract: false, final false
  inline int32_t Adapt(int32_t delta, int32_t numPoints, bool firstTime);

  /// @brief Method Decode, addr 0x5bdff6c, size 0x2b8, virtual false, abstract: false, final false
  inline ::StringW Decode(::StringW s, int32_t offset);

  /// @brief Method DecodeDigit, addr 0x5be02cc, size 0x40, virtual false, abstract: false, final false
  inline int32_t DecodeDigit(char16_t c);

  /// @brief Method Encode, addr 0x5bdf888, size 0x304, virtual false, abstract: false, final false
  inline ::StringW Encode(::StringW s, int32_t offset);

  /// @brief Method EncodeDigit, addr 0x5be0240, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5be0224, size 0x1c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Bootstring", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Bootstring(Bootstring&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Bootstring", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Bootstring(Bootstringconst&) = delete;
