...
public:
  ...
  /// @brief Method Adapt, addr 0x3dba538, size 0x78, virtual false, abstract: false, final false
  inline int32_t Adapt(int32_t delta, int32_t numPoints, bool firstTime);

  /// @brief Method Decode, addr 0x3dba1dc, size 0x2d8, virtual false, abstract: false, final false
  inline ::StringW Decode(::StringW s, int32_t offset);

  /// @brief Method DecodeDigit, addr 0x3dba5b0, size 0x40, virtual false, abstract: false, final false
  inline int32_t DecodeDigit(char16_t c);

  /// @brief Method Encode, addr 0x3db9a70, size 0x348, virtual false, abstract: false, final false
  inline ::StringW Encode(::StringW s, int32_t offset);

  /// @brief Method EncodeDigit, addr 0x3dba520, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dba4b4, size 0x6c, virtual false, abstract: false, final false
