...
public:
  ...
  /// @brief Method Equals, addr 0x5a8fa24, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetCurrentTextElementLen, addr 0x5a8fcd0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x5a8facc, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x5a8fa00, size 0x24, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x5a8f9e8, size 0x18, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method ParseCombiningCharacters, addr 0x5a8fb28, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a8f928, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a8f974, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method get_Indexes, addr 0x5a8fae8, size 0x40, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_Indexes();

  /// @brief Method get_LengthInTextElements, addr 0x5a8fca4, size 0x2c, virtual false, abstract: false, final false
  inline int32_t get_LengthInTextElements();

  /// @brief Method get_String, addr 0x5a8fc9c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_String();

  /// @brief Method set_String, addr 0x5a8f978, size 0x70, virtual false, abstract: false, final false
