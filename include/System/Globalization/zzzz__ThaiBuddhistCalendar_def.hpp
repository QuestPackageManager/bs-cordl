...
namespace System::Globalization {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3684))}
...
public:
  ...
  /// @brief Method get_MinSupportedDateTime addr 0x240d604 size 0x58 virtual true final false
  inline ::System::DateTime get_MinSupportedDateTime();

  /// @brief Method get_MaxSupportedDateTime addr 0x240d65c size 0x58 virtual true final false
  inline ::System::DateTime get_MaxSupportedDateTime();

  static inline ::System::Globalization::ThaiBuddhistCalendar* New_ctor();

  /// @brief Method .ctor addr 0x240d6b4 size 0xa4 virtual false final false
  inline void _ctor();

  /// @brief Method get_ID addr 0x240d758 size 0x8 virtual true final false
  inline int32_t get_ID();

  /// @brief Method GetDaysInMonth addr 0x240d760 size 0x1c virtual true final false
  inline int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era);

  /// @brief Method GetDaysInYear addr 0x240d77c size 0x1c virtual true final false
  inline int32_t GetDaysInYear(int32_t year, int32_t era);

  /// @brief Method GetDayOfMonth addr 0x240d798 size 0x1c virtual true final false
  inline int32_t GetDayOfMonth(::System::DateTime time);

  /// @brief Method GetDayOfWeek addr 0x240d7b4 size 0x1c virtual true final false
  inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime time);

  /// @brief Method GetMonthsInYear addr 0x240d7d0 size 0x1c virtual true final false
  inline int32_t GetMonthsInYear(int32_t year, int32_t era);

  /// @brief Method GetEra addr 0x240d7ec size 0x1c virtual true final false
  inline int32_t GetEra(::System::DateTime time);

  /// @brief Method GetMonth addr 0x240d808 size 0x1c virtual true final false
  inline int32_t GetMonth(::System::DateTime time);

  /// @brief Method GetYear addr 0x240d824 size 0x1c virtual true final false
  inline int32_t GetYear(::System::DateTime time);

  /// @brief Method IsLeapYear addr 0x240d840 size 0x1c virtual true final false
  inline bool IsLeapYear(int32_t year, int32_t era);

  /// @brief Method ToDateTime addr 0x240d85c size 0x24 virtual true final false
  ...
  /// @brief Method get_Eras addr 0x240d880 size 0x1c virtual true final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_Eras();

  /// @brief Method get_TwoDigitYearMax addr 0x240d89c size 0x3c virtual true final false
  inline int32_t get_TwoDigitYearMax();

  /// @brief Method set_TwoDigitYearMax addr 0x240d8d8 size 0x13c virtual true final false
  inline void set_TwoDigitYearMax(int32_t value);

  /// @brief Method ToFourDigitYear addr 0x240da14 size 0xb0 virtual true final false
