...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5a0d604, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IsDigit, addr 0x5a0d26c, size 0xd8, virtual false, abstract: false, final false
  static inline bool IsDigit(char16_t ch);

  /// @brief Method ParseByChar, addr 0x5a0d0cc, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5a0ce24, size 0x2a8, virtual false, abstract: false, final false
