...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3d9383c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IsDigit, addr 0x3d9147c, size 0xd0, virtual false, abstract: false, final false
  static inline bool IsDigit(char16_t ch);

  /// @brief Method ParseByChar, addr 0x3d91558, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3d93308, size 0x284, virtual false, abstract: false, final false
