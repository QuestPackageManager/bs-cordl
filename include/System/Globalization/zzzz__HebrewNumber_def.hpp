...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3d938b4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IsDigit, addr 0x3d914f4, size 0xd0, virtual false, abstract: false, final false
  static inline bool IsDigit(char16_t ch);

  /// @brief Method ParseByChar, addr 0x3d915d0, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3d93380, size 0x284, virtual false, abstract: false, final false
