...
namespace System::Globalization {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(3673))]
...
public:
  ...
  /// @brief Method ToString, addr 0x2576894, size 0x258, virtual false, abstract: false, final false
  static inline ::StringW ToString(int32_t Number);

  /// @brief Method ParseByChar, addr 0x2574ab4, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDigit, addr 0x25749d8, size 0xd0, virtual false, abstract: false, final false
