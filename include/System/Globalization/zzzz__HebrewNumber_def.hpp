...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x2648a7c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IsDigit, addr 0x26466b8, size 0xd0, virtual false, abstract: false, final false
  static inline bool IsDigit(char16_t ch);

  /// @brief Method ParseByChar, addr 0x2646794, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2648574, size 0x258, virtual false, abstract: false, final false
