...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3d92084, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IsDigit, addr 0x3d8fcc4, size 0xd0, virtual false, abstract: false, final false
  static inline bool IsDigit(char16_t ch);

  /// @brief Method ParseByChar, addr 0x3d8fda0, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3d91b50, size 0x284, virtual false, abstract: false, final false
