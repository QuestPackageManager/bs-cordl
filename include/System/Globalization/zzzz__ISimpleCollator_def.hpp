...
// Write type traits
MARK_REF_T(::System::Globalization::ISimpleCollator*);
DEFINE_IL2CPP_CLASS(::System::Globalization::ISimpleCollator*, "System.Globalization", "ISimpleCollator");
// Dependencies
namespace System::Globalization {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISimpleCollator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISimpleCollator(ISimpleCollatorconst&) = delete;
