...
public:
  ...
  /// @brief Method CalendarIdToCultureName, addr 0x59b0bdc, size 0x11c, virtual false, abstract: false, final false
  static inline ::StringW CalendarIdToCultureName(int32_t calendarId);

  /// @brief Method GetCalendarData, addr 0x59ae758, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::Globalization::CalendarData* GetCalendarData(int32_t calendarId);

  /// @brief Method GetJapaneseEnglishEraNames, addr 0x59b083c, size 0xf4, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetJapaneseEnglishEraNames();

  /// @brief Method GetJapaneseEraNames, addr 0x59b0930, size 0xf4, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetJapaneseEraNames();

  /// @brief Method InitializeAbbreviatedEraNames, addr 0x59b0548, size 0x2f4, virtual false, abstract: false, final false
  inline void InitializeAbbreviatedEraNames(::StringW localeName, int32_t calendarId);

  /// @brief Method InitializeEraNames, addr 0x59b014c, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59aee40, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59afb9c, size 0x4f8, virtual false, abstract: false, final false
  inline void _ctor(::StringW localeName, int32_t calendarId, bool bUseUserOverrides);

  /// @brief Method fill_calendar_data, addr 0x59b0cf8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method nativeGetCalendarData, addr 0x59b0094, size 0xb8, virtual false, abstract: false, final false
  static inline bool nativeGetCalendarData(::System::Globalization::CalendarData* data, ::StringW localeName, int32_t calendarId);

  /// @brief Method nativeGetTwoDigitYearMax, addr 0x59aee38, size 0x8, virtual false, abstract: false, final false
