...
/// @brief Method CalendarIdToCultureName, addr 0x5a17a34, size 0x11c, virtual false, abstract: false, final false
static inline ::StringW CalendarIdToCultureName(int32_t  calendarId) ;

/// @brief Method GetCalendarData, addr 0x5a155b0, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Globalization::CalendarData* GetCalendarData(int32_t  calendarId) ;

/// @brief Method GetJapaneseEnglishEraNames, addr 0x5a17694, size 0xf4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetJapaneseEnglishEraNames() ;

/// @brief Method GetJapaneseEraNames, addr 0x5a17788, size 0xf4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetJapaneseEraNames() ;

/// @brief Method InitializeAbbreviatedEraNames, addr 0x5a173a0, size 0x2f4, virtual false, abstract: false, final false
inline void InitializeAbbreviatedEraNames(::StringW  localeName, int32_t  calendarId) ;

/// @brief Method InitializeEraNames, addr 0x5a16fa4, size 0x3fc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a15c98, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5a169f4, size 0x4f8, virtual false, abstract: false, final false
inline void _ctor(::StringW  localeName, int32_t  calendarId, bool  bUseUserOverrides) ;

/// @brief Method fill_calendar_data, addr 0x5a17b50, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method nativeGetCalendarData, addr 0x5a16eec, size 0xb8, virtual false, abstract: false, final false
static inline bool nativeGetCalendarData(::System::Globalization::CalendarData*  data, ::StringW  localeName, int32_t  calendarId) ;

/// @brief Method nativeGetTwoDigitYearMax, addr 0x5a15c90, size 0x8, virtual false, abstract: false, final false
