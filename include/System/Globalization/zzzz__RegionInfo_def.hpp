...
public:
  ...
  /// @brief Method ClearCachedData, addr 0x3db8108, size 0x48, virtual false, abstract: false, final false
  static inline void ClearCachedData();

  /// @brief Method Equals, addr 0x3db8004, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetByTerritory, addr 0x3db7d34, size 0xa8, virtual false, abstract: false, final false
  inline bool GetByTerritory(::System::Globalization::CultureInfo* ci);

  /// @brief Method GetHashCode, addr 0x3db80cc, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3db80f8, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3db7a98, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::CultureInfo* ci);

  /// @brief Method .ctor, addr 0x3db7c2c, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(int32_t culture);

  /// @brief Method .ctor, addr 0x3db7ddc, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method construct_internal_region_from_name, addr 0x3db7f14, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrencyEnglishName, addr 0x3db7f18, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencyEnglishName();

  /// @brief Method get_CurrencyNativeName, addr 0x3db7fdc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencyNativeName();

  /// @brief Method get_CurrencySymbol, addr 0x3db7f20, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencySymbol();

  /// @brief Method get_CurrentRegion, addr 0x3db79d4, size 0xc4, virtual false, abstract: false, final false
  static inline ::System::Globalization::RegionInfo* get_CurrentRegion();

  /// @brief Method get_DisplayName, addr 0x3db7f28, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_EnglishName, addr 0x3db7f30, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_EnglishName();

  /// @brief Method get_GeoId, addr 0x3db7f38, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_GeoId();

  /// @brief Method get_ISOCurrencySymbol, addr 0x3db7fcc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ISOCurrencySymbol();

  /// @brief Method get_IsMetric, addr 0x3db7f40, size 0x8c, virtual true, abstract: false, final false
  inline bool get_IsMetric();

  /// @brief Method get_Name, addr 0x3db7fe4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NativeName, addr 0x3db7fd4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NativeName();

  /// @brief Method get_ThreeLetterISORegionName, addr 0x3db7fec, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ThreeLetterISORegionName();

  /// @brief Method get_ThreeLetterWindowsRegionName, addr 0x3db7ff4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ThreeLetterWindowsRegionName();

  /// @brief Method get_TwoLetterISORegionName, addr 0x3db7ffc, size 0x8, virtual true, abstract: false, final false
