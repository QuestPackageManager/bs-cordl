...
public:
  ...
  /// @brief Method ClearCachedData, addr 0x3dc3c64, size 0x48, virtual false, abstract: false, final false
  static inline void ClearCachedData();

  /// @brief Method Equals, addr 0x3dc3b60, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetByTerritory, addr 0x3dc3890, size 0xa8, virtual false, abstract: false, final false
  inline bool GetByTerritory(::System::Globalization::CultureInfo* ci);

  /// @brief Method GetHashCode, addr 0x3dc3c28, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3dc3c54, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dc35f4, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::CultureInfo* ci);

  /// @brief Method .ctor, addr 0x3dc3788, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(int32_t culture);

  /// @brief Method .ctor, addr 0x3dc3938, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method construct_internal_region_from_name, addr 0x3dc3a70, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrencyEnglishName, addr 0x3dc3a74, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencyEnglishName();

  /// @brief Method get_CurrencyNativeName, addr 0x3dc3b38, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencyNativeName();

  /// @brief Method get_CurrencySymbol, addr 0x3dc3a7c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CurrencySymbol();

  /// @brief Method get_CurrentRegion, addr 0x3dc3530, size 0xc4, virtual false, abstract: false, final false
  static inline ::System::Globalization::RegionInfo* get_CurrentRegion();

  /// @brief Method get_DisplayName, addr 0x3dc3a84, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_EnglishName, addr 0x3dc3a8c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_EnglishName();

  /// @brief Method get_GeoId, addr 0x3dc3a94, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_GeoId();

  /// @brief Method get_ISOCurrencySymbol, addr 0x3dc3b28, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ISOCurrencySymbol();

  /// @brief Method get_IsMetric, addr 0x3dc3a9c, size 0x8c, virtual true, abstract: false, final false
  inline bool get_IsMetric();

  /// @brief Method get_Name, addr 0x3dc3b40, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NativeName, addr 0x3dc3b30, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_NativeName();

  /// @brief Method get_ThreeLetterISORegionName, addr 0x3dc3b48, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ThreeLetterISORegionName();

  /// @brief Method get_ThreeLetterWindowsRegionName, addr 0x3dc3b50, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_ThreeLetterWindowsRegionName();

  /// @brief Method get_TwoLetterISORegionName, addr 0x3dc3b58, size 0x8, virtual true, abstract: false, final false
