...
public:
  ...
  /// @brief Method get_digits, addr 0x5ee10d8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FindSection, addr 0x5ee0824, size 0x138, virtual false, abstract: false, final false
  static inline int32_t FindSection(::System::ReadOnlySpan_1<char16_t> format, int32_t section);

  /// @brief Method FormatCurrency, addr 0x5edef48, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatExponent, addr 0x5ee04f8, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatFixed, addr 0x5edf1b4, size 0x550, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatGeneral, addr 0x5edfbb0, size 0x3bc, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatNumber, addr 0x5edf704, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatPercent, addr 0x5edff6c, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatScientific, addr 0x5edf958, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method Int32ToDecChars, addr 0x5ededfc, size 0x5c, virtual false, abstract: false, final false
  static inline void Int32ToDecChars(char16_t* buffer, ::ByRef<int32_t> index, uint32_t value, int32_t digits);

  /// @brief Method IsWhite, addr 0x5ede514, size 0x18, virtual false, abstract: false, final false
  static inline bool IsWhite(char16_t ch);

  /// @brief Method MatchChars, addr 0x5ede52c, size 0xc4, virtual false, abstract: false, final false
  static inline char16_t* MatchChars(char16_t* p, char16_t* pEnd, ::StringW str);

  /// @brief Method MatchChars, addr 0x5ede5f0, size 0x5c, virtual false, abstract: false, final false
  static inline char16_t* MatchChars(char16_t* p, char16_t* pEnd, char16_t* str);

  /// @brief Method NumberToString, addr 0x5edccf0, size 0x588, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberToStringFormat, addr 0x5edd278, size 0x1170, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseFormatSpecifier, addr 0x5edcba4, size 0x14c, virtual false, abstract: false, final false
  static inline char16_t ParseFormatSpecifier(::System::ReadOnlySpan_1<char16_t> format, ::ByRef<int32_t> digits);

  /// @brief Method ParseNumber, addr 0x5ede64c, size 0x70c, virtual false, abstract: false, final false
  ...
  /// @brief Method RoundNumber, addr 0x5edee58, size 0xf0, virtual false, abstract: false, final false
  static inline void RoundNumber(::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer> number, int32_t pos);

  /// @brief Method TrailingZeros, addr 0x5eded58, size 0xa4, virtual false, abstract: false, final false
  static inline bool TrailingZeros(::System::ReadOnlySpan_1<char16_t> s, int32_t index);

  /// @brief Method TryStringToNumber, addr 0x5ede3e8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method wcslen, addr 0x5ee01d8, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FormatBigInteger, addr 0x5edca38, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method TryStringToBigInteger, addr 0x5edad04, size 0xe8, virtual false, abstract: false, final false
