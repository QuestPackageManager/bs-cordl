...
public:
  ...
  /// @brief Method get_digits, addr 0x5fbb330, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FindSection, addr 0x5fbaa7c, size 0x138, virtual false, abstract: false, final false
  static inline int32_t FindSection(::System::ReadOnlySpan_1<char16_t> format, int32_t section);

  /// @brief Method FormatCurrency, addr 0x5fb91a0, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatExponent, addr 0x5fba750, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatFixed, addr 0x5fb940c, size 0x550, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatGeneral, addr 0x5fb9e08, size 0x3bc, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatNumber, addr 0x5fb995c, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatPercent, addr 0x5fba1c4, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatScientific, addr 0x5fb9bb0, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method Int32ToDecChars, addr 0x5fb9054, size 0x5c, virtual false, abstract: false, final false
  static inline void Int32ToDecChars(char16_t* buffer, ::ByRef<int32_t> index, uint32_t value, int32_t digits);

  /// @brief Method IsWhite, addr 0x5fb876c, size 0x18, virtual false, abstract: false, final false
  static inline bool IsWhite(char16_t ch);

  /// @brief Method MatchChars, addr 0x5fb8784, size 0xc4, virtual false, abstract: false, final false
  static inline char16_t* MatchChars(char16_t* p, char16_t* pEnd, ::StringW str);

  /// @brief Method MatchChars, addr 0x5fb8848, size 0x5c, virtual false, abstract: false, final false
  static inline char16_t* MatchChars(char16_t* p, char16_t* pEnd, char16_t* str);

  /// @brief Method NumberToString, addr 0x5fb6f48, size 0x588, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberToStringFormat, addr 0x5fb74d0, size 0x1170, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseFormatSpecifier, addr 0x5fb6dfc, size 0x14c, virtual false, abstract: false, final false
  static inline char16_t ParseFormatSpecifier(::System::ReadOnlySpan_1<char16_t> format, ::ByRef<int32_t> digits);

  /// @brief Method ParseNumber, addr 0x5fb88a4, size 0x70c, virtual false, abstract: false, final false
  ...
  /// @brief Method RoundNumber, addr 0x5fb90b0, size 0xf0, virtual false, abstract: false, final false
  static inline void RoundNumber(::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer> number, int32_t pos);

  /// @brief Method TrailingZeros, addr 0x5fb8fb0, size 0xa4, virtual false, abstract: false, final false
  static inline bool TrailingZeros(::System::ReadOnlySpan_1<char16_t> s, int32_t index);

  /// @brief Method TryStringToNumber, addr 0x5fb8640, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method wcslen, addr 0x5fba430, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FormatBigInteger, addr 0x5fb6c90, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method TryStringToBigInteger, addr 0x5fb4f5c, size 0xe8, virtual false, abstract: false, final false
