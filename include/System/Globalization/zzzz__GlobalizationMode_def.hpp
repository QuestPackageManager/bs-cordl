...
public:
  ...
  /// @brief Method get_Invariant, addr 0x2580c54, size 0x58, virtual false, abstract: false, final false
  static inline bool get_Invariant();

  /// @brief Method GetGlobalizationInvariantMode, addr 0x2580cac, size 0x8, virtual false, abstract: false, final false
