...
public:
  ...
  /// @brief Method GetGlobalizationInvariantMode, addr 0x28fd678, size 0x8, virtual false, abstract: false, final false
  static inline bool GetGlobalizationInvariantMode();

  static inline bool getStaticF__Invariant_k__BackingField();

  /// @brief Method get_Invariant, addr 0x28fd620, size 0x58, virtual false, abstract: false, final false
