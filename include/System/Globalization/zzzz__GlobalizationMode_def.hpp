...
/// @brief Method GetGlobalizationInvariantMode, addr 0x5a15304, size 0x8, virtual false, abstract: false, final false
static inline bool GetGlobalizationInvariantMode() ;

static inline bool getStaticF__Invariant_k__BackingField() ;

/// @brief Method get_Invariant, addr 0x5a152a8, size 0x5c, virtual false, abstract: false, final false
