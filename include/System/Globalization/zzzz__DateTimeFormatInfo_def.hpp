...
public:
  ...
  /// @brief Method .ctor, addr 0x5a61370, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddMonthNames, addr 0x5a6044c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearTokenHashTable, addr 0x5a5c834, size 0x10, virtual false, abstract: false, final false
  inline void ClearTokenHashTable();

  /// @brief Method Clone, addr 0x5a5c614, size 0x108, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method CompareStringIgnoreCaseOptimized, addr 0x5a6137c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTokenHashTable, addr 0x5a5ef34, size 0x92c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAbbreviatedDayName, addr 0x5a5d774, size 0xfc, virtual false, abstract: false, final false
  inline ::StringW GetAbbreviatedDayName(::System::DayOfWeek dayofweek);

  /// @brief Method GetAbbreviatedEraName, addr 0x5a5c9cc, size 0xe8, virtual false, abstract: false, final false
  inline ::StringW GetAbbreviatedEraName(int32_t era);

  /// @brief Method GetAbbreviatedMonthName, addr 0x5a5e118, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW GetAbbreviatedMonthName(int32_t month);

  /// @brief Method GetAllDateTimePatterns, addr 0x5a5d994, size 0x408, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetAllDateTimePatterns(char16_t format);

  /// @brief Method GetCombinedPatterns, addr 0x5a5d870, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDayName, addr 0x5a5e01c, size 0xfc, virtual false, abstract: false, final false
  inline ::StringW GetDayName(::System::DayOfWeek dayofweek);

  /// @brief Method GetEraName, addr 0x5a5c89c, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW GetEraName(int32_t era);

  /// @brief Method GetFormat, addr 0x5a5c598, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Object* GetFormat(::System::Type* formatType);

  /// @brief Method GetInstance, addr 0x5a5c3ec, size 0x1ac, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* GetInstance(::System::IFormatProvider* provider);

  /// @brief Method GetJapaneseCalendarDTFI, addr 0x5a5ebc4, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* GetJapaneseCalendarDTFI();

  /// @brief Method GetMergedPatterns, addr 0x5a5e300, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMonthName, addr 0x5a5e20c, size 0xf4, virtual false, abstract: false, final false
  inline ::StringW GetMonthName(int32_t month);

  /// @brief Method GetTaiwanCalendarDTFI, addr 0x5a5ed7c, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* GetTaiwanCalendarDTFI();

  /// @brief Method InitializeFormatFlags, addr 0x5a5e7d0, size 0x13c, virtual false, abstract: false, final false
  inline ::System::Globalization::DateTimeFormatFlags InitializeFormatFlags();

  /// @brief Method InitializeOverridableProperties, addr 0x5a5be40, size 0x124, virtual false, abstract: false, final false
  inline void InitializeOverridableProperties(::System::Globalization::CultureData* cultureData, int32_t calendarId);

  /// @brief Method InsertAtCurrentHashNode, addr 0x5a611d0, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertHash, addr 0x5a5f860, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAllowedJapaneseTokenFollowedByNonSpaceLetter, addr 0x5a60abc, size 0x118, virtual false, abstract: false, final false
  inline bool IsAllowedJapaneseTokenFollowedByNonSpaceLetter(::StringW tokenString, char16_t nextCh);

  /// @brief Method IsHebrewChar, addr 0x5a60aa8, size 0x14, virtual false, abstract: false, final false
  static inline bool IsHebrewChar(char16_t ch);

  /// @brief Method IsJapaneseCalendar, addr 0x5a6080c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateSpecialTokenHashTable, addr 0x5a5fb1c, size 0x930, virtual false, abstract: false, final false
  ...
  /// @brief Method Tokenize, addr 0x5a60bd4, size 0x5fc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseHebrewNumber, addr 0x5a60944, size 0x164, virtual false, abstract: false, final false
  static inline bool TryParseHebrewNumber(::ByRef<::System::__DTString> str, ::ByRef<bool> badFormat, ::ByRef<int32_t> number);

  /// @brief Method ValidateStyles, addr 0x5a5e700, size 0xd0, virtual false, abstract: false, final false
  static inline void ValidateStyles(::System::Globalization::DateTimeStyles style, ::StringW parameterName);

  /// @brief Method YearMonthAdjustment, addr 0x5a5ea90, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a5bd6c, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a5bf64, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AMDesignator, addr 0x5a5c71c, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_AMDesignator();

  /// @brief Method get_AbbreviatedDayNames, addr 0x5a5d2b0, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AbbreviatedDayNames();

  /// @brief Method get_AbbreviatedEnglishEraNames, addr 0x5a5cab4, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AbbreviatedEnglishEraNames();

  /// @brief Method get_AbbreviatedEraNames, addr 0x5a5c974, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AbbreviatedEraNames();

  /// @brief Method get_AbbreviatedMonthNames, addr 0x5a5d3b8, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AbbreviatedMonthNames();

  /// @brief Method get_AllLongDatePatterns, addr 0x5a5de14, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllLongDatePatterns();

  /// @brief Method get_AllLongTimePatterns, addr 0x5a5df18, size 0x8c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllLongTimePatterns();

  /// @brief Method get_AllShortDatePatterns, addr 0x5a5dd9c, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllShortDatePatterns();

  /// @brief Method get_AllShortTimePatterns, addr 0x5a5de8c, size 0x8c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllShortTimePatterns();

  /// @brief Method get_AllYearMonthPatterns, addr 0x5a5dfa4, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_AllYearMonthPatterns();

  /// @brief Method get_Calendar, addr 0x5a5c744, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::Calendar* get_Calendar();

  /// @brief Method get_CompareInfo, addr 0x5a5e65c, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Globalization::CompareInfo* get_CompareInfo();

  /// @brief Method get_Culture, addr 0x5a5bb2c, size 0x88, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_Culture();

  /// @brief Method get_CultureName, addr 0x5a5bb04, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_CultureName();

  /// @brief Method get_CurrentInfo, addr 0x5a5c2f0, size 0xfc, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* get_CurrentInfo();

  /// @brief Method get_DateSeparator, addr 0x5a5cb0c, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_DateSeparator();

  /// @brief Method get_DateTimeOffsetPattern, addr 0x5a5cff0, size 0x1c0, virtual false, abstract: false, final false
  inline ::StringW get_DateTimeOffsetPattern();

  /// @brief Method get_DayNames, addr 0x5a5d334, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_DayNames();

  /// @brief Method get_EraNames, addr 0x5a5c844, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_EraNames();

  /// @brief Method get_FormatFlags, addr 0x5a5d4e8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Globalization::DateTimeFormatFlags get_FormatFlags();

  /// @brief Method get_FullDateTimePattern, addr 0x5a5cb60, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_FullDateTimePattern();

  /// @brief Method get_FullTimeSpanNegativePattern, addr 0x5a5e5f0, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW get_FullTimeSpanNegativePattern();

  /// @brief Method get_FullTimeSpanPositivePattern, addr 0x5a5e518, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW get_FullTimeSpanPositivePattern();

  /// @brief Method get_GeneralLongTimePattern, addr 0x5a5cf78, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_GeneralLongTimePattern();

  /// @brief Method get_GeneralShortTimePattern, addr 0x5a5cf00, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_GeneralShortTimePattern();

  /// @brief Method get_HasForceTwoDigitYears, addr 0x5a5ea34, size 0x34, virtual false, abstract: false, final false
  inline bool get_HasForceTwoDigitYears();

  /// @brief Method get_HasSpacesInDayNames, addr 0x5a5d500, size 0x28, virtual false, abstract: false, final false
  inline bool get_HasSpacesInDayNames();

  /// @brief Method get_HasSpacesInMonthNames, addr 0x5a5d4c0, size 0x28, virtual false, abstract: false, final false
  inline bool get_HasSpacesInMonthNames();

  /// @brief Method get_HasYearMonthAdjustment, addr 0x5a5ea68, size 0x28, virtual false, abstract: false, final false
  inline bool get_HasYearMonthAdjustment();

  /// @brief Method get_InvariantInfo, addr 0x5a5c220, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Globalization::DateTimeFormatInfo* get_InvariantInfo();

  /// @brief Method get_IsReadOnly, addr 0x5a5c74c, size 0xb8, virtual false, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_LanguageName, addr 0x5a5bbb4, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_LanguageName();

  /// @brief Method get_LongDatePattern, addr 0x5a5cbd8, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_LongDatePattern();

  /// @brief Method get_LongTimePattern, addr 0x5a5cc14, size 0x50, virtual false, abstract: false, final false
  inline ::StringW get_LongTimePattern();

  /// @brief Method get_MonthDayPattern, addr 0x5a5cce8, size 0x58, virtual false, abstract: false, final false
  inline ::StringW get_MonthDayPattern();

  /// @brief Method get_MonthGenitiveNames, addr 0x5a5e498, size 0x80, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_MonthGenitiveNames();

  /// @brief Method get_MonthNames, addr 0x5a5d43c, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_MonthNames();

  /// @brief Method get_OptionalCalendars, addr 0x5a5c804, size 0x30, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Globalization::CalendarId, ::Array<::System::Globalization::CalendarId>*> get_OptionalCalendars();

  /// @brief Method get_PMDesignator, addr 0x5a5cd40, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_PMDesignator();

  /// @brief Method get_RFC1123Pattern, addr 0x5a5cd68, size 0x44, virtual false, abstract: false, final false
  inline ::StringW get_RFC1123Pattern();

  /// @brief Method get_ShortDatePattern, addr 0x5a5cdac, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_ShortDatePattern();

  /// @brief Method get_ShortTimePattern, addr 0x5a5ce40, size 0x50, virtual false, abstract: false, final false
  inline ::StringW get_ShortTimePattern();

  /// @brief Method get_SortableDateTimePattern, addr 0x5a5cebc, size 0x44, virtual false, abstract: false, final false
  inline ::StringW get_SortableDateTimePattern();

  /// @brief Method get_TimeSeparator, addr 0x5a5d1b0, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_TimeSeparator();

  /// @brief Method get_UnclonedLongDatePatterns, addr 0x5a5cc64, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedLongDatePatterns();

  /// @brief Method get_UnclonedLongTimePatterns, addr 0x5a5ccbc, size 0x2c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedLongTimePatterns();

  /// @brief Method get_UnclonedShortDatePatterns, addr 0x5a5cde8, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedShortDatePatterns();

  /// @brief Method get_UnclonedShortTimePatterns, addr 0x5a5ce90, size 0x2c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedShortTimePatterns();

  /// @brief Method get_UnclonedYearMonthPatterns, addr 0x5a5d258, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_UnclonedYearMonthPatterns();

  /// @brief Method get_UniversalSortableDateTimePattern, addr 0x5a5d1d8, size 0x44, virtual false, abstract: false, final false
  inline ::StringW get_UniversalSortableDateTimePattern();

  /// @brief Method get_YearMonthPattern, addr 0x5a5d21c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method internalGetAbbreviatedDayOfWeekNames, addr 0x5a5bbdc, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetAbbreviatedDayOfWeekNames();

  /// @brief Method internalGetAbbreviatedDayOfWeekNamesCore, addr 0x5a5bbf0, size 0x50, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetAbbreviatedDayOfWeekNamesCore();

  /// @brief Method internalGetAbbreviatedMonthNames, addr 0x5a5bca4, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetAbbreviatedMonthNames();

  /// @brief Method internalGetAbbreviatedMonthNamesCore, addr 0x5a5bcb8, size 0x50, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetAbbreviatedMonthNamesCore();

  /// @brief Method internalGetDayOfWeekNames, addr 0x5a5bc40, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetDayOfWeekNames();

  /// @brief Method internalGetDayOfWeekNamesCore, addr 0x5a5bc54, size 0x50, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetDayOfWeekNamesCore();

  /// @brief Method internalGetGenitiveMonthNames, addr 0x5a5d680, size 0x9c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetGenitiveMonthNames(bool abbreviated);

  /// @brief Method internalGetLeapYearMonthNames, addr 0x5a5d71c, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetLeapYearMonthNames();

  /// @brief Method internalGetMonthName, addr 0x5a5d528, size 0x158, virtual false, abstract: false, final false
  inline ::StringW internalGetMonthName(int32_t month, ::System::Globalization::MonthNameStyles style, bool abbreviated);

  /// @brief Method internalGetMonthNames, addr 0x5a5bd08, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> internalGetMonthNames();

  /// @brief Method internalGetMonthNamesCore, addr 0x5a5bd1c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Calendar, addr 0x5a5bf84, size 0x29c, virtual false, abstract: false, final false
