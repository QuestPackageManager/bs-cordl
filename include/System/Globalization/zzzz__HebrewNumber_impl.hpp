...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Globalization::HebrewNumber_HebrewValue::*)(::System::Globalization::HebrewNumber_HebrewToken, int16_t)>(&::System::Globalization::HebrewNumber_HebrewValue::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x5a0db10;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Globalization::HebrewNumber_HebrewValue>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Globalization::HebrewNumber_HebrewToken>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int16_t>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(int32_t)>(&::System::Globalization::HebrewNumber::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x5a0d330;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Globalization::HebrewNumberParsingState (*)(char16_t, ::ByRef<::System::Globalization::HebrewNumberParsingContext>)>(&::System::Globalization::HebrewNumber::ParseByChar)> {
  ...
  constexpr static std::size_t addrs = 0x5a0d5d8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(char16_t)>(&::System::Globalization::HebrewNumber::IsDigit)> {
  ...
  constexpr static std::size_t addrs = 0x5a0d778;
...
inline void System::Globalization::HebrewNumber::setStaticF_s_hebrewValues(::ArrayW<::System::Globalization::HebrewNumber_HebrewValue,::Array<::System::Globalization::HebrewNumber_HebrewValue>*>  value)  {
::cordl_internals::setStaticField<::ArrayW<::System::Globalization::HebrewNumber_HebrewValue,::Array<::System::Globalization::HebrewNumber_HebrewValue>*>, "s_hebrewValues", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Globalization::HebrewNumber*>::get>(std::forward<::ArrayW<::System::Globalization::HebrewNumber_HebrewValue,::Array<::System::Globalization::HebrewNumber_HebrewValue>*>>(value));
}
...
return ::cordl_internals::getStaticField<::ArrayW<::System::Globalization::HebrewNumber_HebrewValue,::Array<::System::Globalization::HebrewNumber_HebrewValue>*>, "s_hebrewValues", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Globalization::HebrewNumber*>::get>();
}
...
::cordl_internals::setStaticField<::ArrayW<::System::Globalization::HebrewNumber_HS,::Array<::System::Globalization::HebrewNumber_HS>*>, "s_numberPasingState", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Globalization::HebrewNumber*>::get>(std::forward<::ArrayW<::System::Globalization::HebrewNumber_HS,::Array<::System::Globalization::HebrewNumber_HS>*>>(value));
}
...
return ::cordl_internals::getStaticField<::ArrayW<::System::Globalization::HebrewNumber_HS,::Array<::System::Globalization::HebrewNumber_HS>*>, "s_numberPasingState", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Globalization::HebrewNumber*>::get>();
}
