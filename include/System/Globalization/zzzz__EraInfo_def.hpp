...
public:
  ...
  /// @brief Method .ctor, addr 0x3da36f0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3da37d4, size 0xf4, virtual false, abstract: false, final false
