...
public:
  ...
  /// @brief Method .ctor, addr 0x3dac5f4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3dac6d8, size 0xf4, virtual false, abstract: false, final false
