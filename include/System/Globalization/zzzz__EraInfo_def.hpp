...
public:
  ...
  /// @brief Method .ctor, addr 0x3d9efec, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d9f0d0, size 0xf4, virtual false, abstract: false, final false
