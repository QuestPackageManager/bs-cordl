...
public:
  ...
  /// @brief Method .ctor, addr 0x5a18ba4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a18c7c, size 0xec, virtual false, abstract: false, final false
