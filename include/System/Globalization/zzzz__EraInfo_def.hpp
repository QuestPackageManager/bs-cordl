...
public:
  ...
  /// @brief Method .ctor, addr 0x3da0a98, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3da0b7c, size 0xf4, virtual false, abstract: false, final false
