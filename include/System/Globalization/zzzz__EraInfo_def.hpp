...
public:
  ...
  /// @brief Method .ctor, addr 0x26b6dc8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b6e64, size 0xb4, virtual false, abstract: false, final false
