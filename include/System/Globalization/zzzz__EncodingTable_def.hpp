...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncodingTable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncodingTable(EncodingTable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncodingTable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncodingTable(EncodingTableconst&) = delete;
