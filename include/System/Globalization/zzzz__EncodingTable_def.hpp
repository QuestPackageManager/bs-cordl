...
public:
  ...
  /// @brief Method ENC, addr 0x3db67b8, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Globalization::InternalEncodingDataItem ENC(::StringW name, uint16_t cp);

  /// @brief Method GetCodePageDataItem, addr 0x3dbc170, size 0x2bc, virtual false, abstract: false, final false
  static inline ::System::Globalization::CodePageDataItem* GetCodePageDataItem(int32_t codepage);

  /// @brief Method GetCodePageFromName, addr 0x3dbbef4, size 0x27c, virtual false, abstract: false, final false
  static inline int32_t GetCodePageFromName(::StringW name);

  /// @brief Method GetNumEncodingItems, addr 0x3db6754, size 0x64, virtual false, abstract: false, final false
  static inline int32_t GetNumEncodingItems();

  /// @brief Method MapCodePageDataItem, addr 0x3db67c0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method internalGetCodePageFromName, addr 0x3dbbc84, size 0x250, virtual false, abstract: false, final false
