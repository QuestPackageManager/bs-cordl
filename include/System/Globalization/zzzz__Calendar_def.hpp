...
public:
  ...
  /// @brief Method IsValidMonth, addr 0x5bc53c0, size 0x78, virtual true, abstract: false, final false
  inline bool IsValidMonth(int32_t year, int32_t month, int32_t era);

  /// @brief Method IsValidYear, addr 0x5bc533c, size 0x84, virtual true, abstract: false, final false
  inline bool IsValidYear(int32_t year, int32_t era);

  static inline ::System::Globalization::Calendar* New_ctor();

  /// @brief Method SetReadOnlyState, addr 0x5bc5050, size 0x8, virtual false, abstract: false, final false
  inline void SetReadOnlyState(bool readOnly);

  /// @brief Method TimeToTicks, addr 0x5bc55d4, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryToDateTime, addr 0x5bc51d4, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method VerifyWritable, addr 0x5bc4ff4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc4f48, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BaseCalendarID, addr 0x5bc4f60, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method get_MaxSupportedDateTime, addr 0x5bc4eec, size 0x5c, virtual true, abstract: false, final false
  inline ::System::DateTime get_MaxSupportedDateTime();

  /// @brief Method get_MinSupportedDateTime, addr 0x5bc4e90, size 0x5c, virtual true, abstract: false, final false
  inline ::System::DateTime get_MinSupportedDateTime();

  /// @brief Method get_TwoDigitYearMax, addr 0x5bc54b8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_TwoDigitYearMax();

  /// @brief Convert to "::System::ICloneable"
  constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

  /// @brief Method set_TwoDigitYearMax, addr 0x5bc54c0, size 0x24, virtual true, abstract: false, final false
