...
public:
  ...
  /// @brief Method get_MinSupportedDateTime, addr 0x2580cfc, size 0x58, virtual true, abstract: false, final false
  inline ::System::DateTime get_MinSupportedDateTime();

  /// @brief Method get_MaxSupportedDateTime, addr 0x2580d54, size 0x58, virtual true, abstract: false, final false
  inline ::System::DateTime get_MaxSupportedDateTime();

  static inline ::System::Globalization::Calendar* New_ctor();

  /// @brief Method .ctor, addr 0x2580dac, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ID, addr 0x2580dc0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ID();

  /// @brief Method get_BaseCalendarID, addr 0x2580dc8, size 0xc, virtual true, abstract: false, final false
  inline int32_t get_BaseCalendarID();

  /// @brief Method Clone, addr 0x2580dd4, size 0x88, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method VerifyWritable, addr 0x2580e5c, size 0x74, virtual false, abstract: false, final false
  inline void VerifyWritable();

  /// @brief Method SetReadOnlyState, addr 0x2580ed0, size 0xc, virtual false, abstract: false, final false
  inline void SetReadOnlyState(bool readOnly);

  /// @brief Method get_CurrentEraValue, addr 0x2580edc, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method IsLeapYear, addr 0x258100c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method ToDateTime, addr 0x2581020, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method TryToDateTime, addr 0x2581048, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValidYear, addr 0x25811a8, size 0x84, virtual true, abstract: false, final false
  inline bool IsValidYear(int32_t year, int32_t era);

  /// @brief Method IsValidMonth, addr 0x258122c, size 0x78, virtual true, abstract: false, final false
  inline bool IsValidMonth(int32_t year, int32_t month, int32_t era);

  /// @brief Method IsValidDay, addr 0x25812a4, size 0x80, virtual true, abstract: false, final false
  inline bool IsValidDay(int32_t year, int32_t month, int32_t day, int32_t era);

  /// @brief Method get_TwoDigitYearMax, addr 0x2581324, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_TwoDigitYearMax();

  /// @brief Method set_TwoDigitYearMax, addr 0x258132c, size 0x24, virtual true, abstract: false, final false
  inline void set_TwoDigitYearMax(int32_t value);

  /// @brief Method ToFourDigitYear, addr 0x2581350, size 0xfc, virtual true, abstract: false, final false
  inline int32_t ToFourDigitYear(int32_t year);

  /// @brief Method TimeToTicks, addr 0x258144c, size 0x1bc, virtual false, abstract: false, final false
  static inline int64_t TimeToTicks(int32_t hour, int32_t minute, int32_t second, int32_t millisecond);

  /// @brief Method GetSystemTwoDigitYearSetting, addr 0x2581608, size 0x54, virtual false, abstract: false, final false
