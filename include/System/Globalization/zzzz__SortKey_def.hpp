...
public:
  ...
  /// @brief Method Compare, addr 0x28ef258, size 0x174, virtual false, abstract: false, final false
  static inline int32_t Compare(::System::Globalization::SortKey* sortkey1, ::System::Globalization::SortKey* sortkey2);

  /// @brief Method Equals, addr 0x28ef538, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x28ef5e8, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x28ef650, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28ef840, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x28ef4a0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28ef3cc, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(int32_t lcid, ::StringW source, ::System::Globalization::CompareOptions opt);

  /// @brief Method .ctor, addr 0x28ef4e0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyData, addr 0x28ef530, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyData();

  /// @brief Method get_OriginalString, addr 0x28ef528, size 0x8, virtual true, abstract: false, final false
