...
public:
  ...
  /// @brief Method Compare, addr 0x5a93c74, size 0x174, virtual false, abstract: false, final false
  static inline int32_t Compare(::System::Globalization::SortKey* sortkey1, ::System::Globalization::SortKey* sortkey2);

  /// @brief Method Equals, addr 0x5a93f10, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5a93fcc, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5a94034, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a9417c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a93ebc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a93de8, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(int32_t lcid, ::StringW source, ::System::Globalization::CompareOptions opt);

  /// @brief Method .ctor, addr 0x5a93ec8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_KeyData, addr 0x5a93f08, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyData();

  /// @brief Method get_OriginalString, addr 0x5a93f00, size 0x8, virtual true, abstract: false, final false
