...
/// @brief Method Compare, addr 0x5a957ec, size 0x174, virtual false, abstract: false, final false
static inline int32_t Compare(::System::Globalization::SortKey*  sortkey1, ::System::Globalization::SortKey*  sortkey2) ;

/// @brief Method Equals, addr 0x5a95a88, size 0xbc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetHashCode, addr 0x5a95b44, size 0x68, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::System::Globalization::SortKey* New_ctor() ;

static inline ::System::Globalization::SortKey* New_ctor(int32_t  lcid, ::StringW  source, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, ::System::Globalization::CompareOptions  opt, int32_t  lv1Length, int32_t  lv2Length, int32_t  lv3Length, int32_t  kanaSmallLength, int32_t  markTypeLength, int32_t  katakanaLength, int32_t  kanaWidthLength, int32_t  identLength) ;
...
/// @brief Method ToString, addr 0x5a95bac, size 0x148, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a95cf4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5a95a34, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  lcid, ::StringW  source, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, ::System::Globalization::CompareOptions  opt, int32_t  lv1Length, int32_t  lv2Length, int32_t  lv3Length, int32_t  kanaSmallLength, int32_t  markTypeLength, int32_t  katakanaLength, int32_t  kanaWidthLength, int32_t  identLength) ;

/// @brief Method .ctor, addr 0x5a95960, size 0xd4, virtual false, abstract: false, final false
inline void _ctor(int32_t  lcid, ::StringW  source, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method .ctor, addr 0x5a95a40, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method get_KeyData, addr 0x5a95a80, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_KeyData() ;

/// @brief Method get_OriginalString, addr 0x5a95a78, size 0x8, virtual true, abstract: false, final false
