...
public:
  ...
  /// @brief Method Compare addr 0x256b2d0 size 0x174 virtual false final false
  ...
  /// @brief Method .ctor addr 0x256b444 size 0xd4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x256b518 size 0x40 virtual false final false
  ...
  /// @brief Method .ctor addr 0x256b558 size 0x48 virtual false final false
  ...
  /// @brief Method get_OriginalString addr 0x256b5a0 size 0x8 virtual true final false
  inline ::StringW get_OriginalString();

  /// @brief Method get_KeyData addr 0x256b5a8 size 0x8 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyData();

  /// @brief Method Equals addr 0x256b5b0 size 0xb0 virtual true final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode addr 0x256b660 size 0x68 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method ToString addr 0x256b6c8 size 0x1f0 virtual true final false
  inline ::StringW ToString();

  static inline ::System::Globalization::SortKey* New_ctor();

  /// @brief Method .ctor addr 0x256b8b8 size 0x38 virtual false final false
  inline void _ctor();
