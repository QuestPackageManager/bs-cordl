...
namespace System::Globalization {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(3657))]
...
public:
  ...
  /// @brief Method Compare, addr 0x258df18, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x258e08c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x258e160, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x258e1a0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_OriginalString, addr 0x258e1e8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_OriginalString();

  /// @brief Method get_KeyData, addr 0x258e1f0, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyData();

  /// @brief Method Equals, addr 0x258e1f8, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x258e2a8, size 0x68, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x258e310, size 0x1f0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  static inline ::System::Globalization::SortKey* New_ctor();

  /// @brief Method .ctor, addr 0x258e500, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();
