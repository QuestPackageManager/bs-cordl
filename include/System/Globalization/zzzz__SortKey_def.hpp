...
public:
  ...
  /// @brief Method Compare, addr 0x5bcf4c4, size 0x174, virtual false, abstract: false, final false
  static inline int32_t Compare(::System::Globalization::SortKey* sortkey1, ::System::Globalization::SortKey* sortkey2);

  /// @brief Method Equals, addr 0x5bcf760, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode, addr 0x5bcf81c, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5bcf884, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bcf9cc, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5bcf70c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bcf638, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(int32_t lcid, ::StringW source, ::System::Globalization::CompareOptions opt);

  /// @brief Method .ctor, addr 0x5bcf718, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW localeName, ::StringW str, ::System::Globalization::CompareOptions options, ::ArrayW<uint8_t> keyData);

  /// @brief Method get_KeyData, addr 0x5bcf758, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_KeyData();

  /// @brief Method get_OriginalString, addr 0x5bcf750, size 0x8, virtual true, abstract: false, final false
