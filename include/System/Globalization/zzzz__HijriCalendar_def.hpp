...
public:
  ...
  /// @brief Method get_MinSupportedDateTime addr 0x2407724 size 0x58 virtual true final false
  inline ::System::DateTime get_MinSupportedDateTime();

  /// @brief Method get_MaxSupportedDateTime addr 0x240777c size 0x58 virtual true final false
  inline ::System::DateTime get_MaxSupportedDateTime();

  static inline ::System::Globalization::HijriCalendar* New_ctor();

  /// @brief Method .ctor addr 0x24077d4 size 0x10 virtual false final false
  inline void _ctor();

  /// @brief Method get_ID addr 0x24077e4 size 0x8 virtual true final false
  inline int32_t get_ID();

  /// @brief Method GetAbsoluteDateHijri addr 0x24077ec size 0xc8 virtual false final false
  inline int64_t GetAbsoluteDateHijri(int32_t y, int32_t m, int32_t d);

  /// @brief Method DaysUpToHijriYear addr 0x24078b4 size 0xbc virtual false final false
  inline int64_t DaysUpToHijriYear(int32_t HijriYear);

  /// @brief Method get_HijriAdjustment addr 0x2407970 size 0x68 virtual false final false
  inline int32_t get_HijriAdjustment();

  /// @brief Method GetAdvanceHijriDate addr 0x24079d8 size 0x8 virtual false final false
  static inline int32_t GetAdvanceHijriDate();

  /// @brief Method CheckTicksRange addr 0x24079e0 size 0x1ac virtual false final false
  static inline void CheckTicksRange(int64_t ticks);

  /// @brief Method CheckEraRange addr 0x2407bec size 0xd0 virtual false final false
  static inline void CheckEraRange(int32_t era);

  /// @brief Method CheckYearRange addr 0x2407cbc size 0x154 virtual false final false
  static inline void CheckYearRange(int32_t year, int32_t era);

  /// @brief Method CheckYearMonthRange addr 0x2407e30 size 0x184 virtual false final false
  static inline void CheckYearMonthRange(int32_t year, int32_t month, int32_t era);

  /// @brief Method GetDatePart addr 0x2407fb4 size 0x270 virtual true final false
  inline int32_t GetDatePart(int64_t ticks, int32_t part);

  /// @brief Method GetDayOfMonth addr 0x2408224 size 0x44 virtual true final false
  inline int32_t GetDayOfMonth(::System::DateTime time);

  /// @brief Method GetDayOfWeek addr 0x2408268 size 0x68 virtual true final false
  inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime time);

  /// @brief Method GetDaysInMonth addr 0x24082d0 size 0xcc virtual true final false
  inline int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era);

  /// @brief Method GetDaysInYear addr 0x240839c size 0x94 virtual true final false
  inline int32_t GetDaysInYear(int32_t year, int32_t era);

  /// @brief Method GetEra addr 0x2408430 size 0x78 virtual true final false
  inline int32_t GetEra(::System::DateTime time);

  /// @brief Method get_Eras addr 0x24084a8 size 0x9c virtual true final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_Eras();

  /// @brief Method GetMonth addr 0x2408544 size 0x44 virtual true final false
  inline int32_t GetMonth(::System::DateTime time);

  /// @brief Method GetMonthsInYear addr 0x2408588 size 0x6c virtual true final false
  inline int32_t GetMonthsInYear(int32_t year, int32_t era);

  /// @brief Method GetYear addr 0x24085f4 size 0x44 virtual true final false
  inline int32_t GetYear(::System::DateTime time);

  /// @brief Method IsLeapYear addr 0x2408638 size 0xa0 virtual true final false
  inline bool IsLeapYear(int32_t year, int32_t era);

  /// @brief Method ToDateTime addr 0x24086d8 size 0x1e0 virtual true final false
  ...
  /// @brief Method get_TwoDigitYearMax addr 0x24088b8 size 0x3c virtual true final false
  inline int32_t get_TwoDigitYearMax();

  /// @brief Method set_TwoDigitYearMax addr 0x24088f4 size 0x118 virtual true final false
  inline void set_TwoDigitYearMax(int32_t value);

  /// @brief Method ToFourDigitYear addr 0x2408a0c size 0x13c virtual true final false
