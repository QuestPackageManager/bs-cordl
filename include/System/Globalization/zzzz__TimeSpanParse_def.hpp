...
public:
  // Declarations
  /// @brief Method IsInvalidFraction, addr 0x5a814d0, size 0x5c, virtual false, abstract: false, final false
  inline bool IsInvalidFraction();

  /// @brief Method .ctor, addr 0x5a84354, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t number);

  /// @brief Method .ctor, addr 0x5a869b0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t number, int32_t leadingZeroes);

  /// @brief Method .ctor, addr 0x5a86bc8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::TimeSpanParse_TTT type);

  /// @brief Method .ctor, addr 0x5a86bd8, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BackOne, addr 0x5a869c4, size 0x14, virtual false, abstract: false, final false
  inline void BackOne();

  /// @brief Method GetNextToken, addr 0x5a81a20, size 0x254, virtual false, abstract: false, final false
  inline ::System::Globalization::TimeSpanParse_TimeSpanToken GetNextToken();

  /// @brief Method .ctor, addr 0x5a819c0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> input);

  /// @brief Method .ctor, addr 0x5a86774, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> input, int32_t startPosition);

  /// @brief Method get_EOL, addr 0x5a8695c, size 0x54, virtual false, abstract: false, final false
  inline bool get_EOL();

  /// @brief Method get_NextChar, addr 0x5a868f4, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNum, addr 0x5a86de4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSep, addr 0x5a86cc4, size 0x120, virtual false, abstract: false, final false
  inline bool AddSep(::System::ReadOnlySpan_1<char16_t> sep, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult> result);

  /// @brief Method FullAppCompatMatch, addr 0x5a84b58, size 0x3f0, virtual false, abstract: false, final false
  inline bool FullAppCompatMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullDHMMatch, addr 0x5a85318, size 0x3d0, virtual false, abstract: false, final false
  inline bool FullDHMMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullDHMSMatch, addr 0x5a84760, size 0x3f8, virtual false, abstract: false, final false
  inline bool FullDHMSMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullDMatch, addr 0x5a85dd4, size 0x26c, virtual false, abstract: false, final false
  inline bool FullDMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullHMMatch, addr 0x5a85ab0, size 0x324, virtual false, abstract: false, final false
  inline bool FullHMMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullHMSFMatch, addr 0x5a84368, size 0x3f8, virtual false, abstract: false, final false
  inline bool FullHMSFMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullHMSMatch, addr 0x5a84f48, size 0x3d0, virtual false, abstract: false, final false
  inline bool FullHMSMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullMatch, addr 0x5a83dc0, size 0x428, virtual false, abstract: false, final false
  inline bool FullMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method Init, addr 0x5a819cc, size 0x54, virtual false, abstract: false, final false
  inline void Init(::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method PartialAppCompatMatch, addr 0x5a856e8, size 0x3c8, virtual false, abstract: false, final false
  inline bool PartialAppCompatMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method ProcessToken, addr 0x5a81c74, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NegativeInvariant, addr 0x5a86c54, size 0x70, virtual false, abstract: false, final false
  inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_NegativeInvariant();

  /// @brief Method get_NegativeLocalized, addr 0x5a8429c, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_NegativeLocalized();

  /// @brief Method get_PositiveInvariant, addr 0x5a86be8, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_PositiveInvariant();

  /// @brief Method get_PositiveLocalized, addr 0x5a841e8, size 0xb4, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method SetFailure, addr 0x5a818a4, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a81560, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method NextChar, addr 0x5a86ed4, size 0x48, virtual false, abstract: false, final false
  inline void NextChar();

  /// @brief Method NextNonDigit, addr 0x5a86f1c, size 0x64, virtual false, abstract: false, final false
  inline char16_t NextNonDigit();

  /// @brief Method ParseInt, addr 0x5a8716c, size 0x124, virtual false, abstract: false, final false
  inline bool ParseInt(int32_t max, ::ByRef<int32_t> i, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult> result);

  /// @brief Method ParseTime, addr 0x5a86fb0, size 0x1bc, virtual false, abstract: false, final false
  inline bool ParseTime(::ByRef<int64_t> time, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult> result);

  /// @brief Method SkipBlanks, addr 0x5a86f80, size 0x30, virtual false, abstract: false, final false
  inline void SkipBlanks();

  /// @brief Method TryParse, addr 0x5a869d8, size 0x1f0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Parse, addr 0x5a8152c, size 0x34, virtual false, abstract: false, final false
  static inline ::System::TimeSpan Parse(::System::ReadOnlySpan_1<char16_t> input, ::System::IFormatProvider* formatProvider);

  /// @brief Method ParseExactDigits, addr 0x5a867ac, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExactDigits, addr 0x5a86780, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExactLiteral, addr 0x5a86870, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Pow10, addr 0x5a80fd8, size 0xa8, virtual false, abstract: false, final false
  static inline int64_t Pow10(int32_t pow);

  /// @brief Method ProcessTerminalState, addr 0x5a81d94, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_D, addr 0x5a81f10, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_DHMSF, addr 0x5a83b64, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HM, addr 0x5a821d8, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HMS_F_D, addr 0x5a83048, size 0xb1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HM_S_D, addr 0x5a82498, size 0xbb0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseByFormat, addr 0x5a86074, size 0x700, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExact, addr 0x5a816e0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExactTimeSpan, addr 0x5a8171c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseTimeSpan, addr 0x5a8156c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseTimeSpanConstant, addr 0x5a86040, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method TryTimeToTicks, addr 0x5a81380, size 0x150, virtual false, abstract: false, final false
