...
public:
  // Declarations
  /// @brief Method IsInvalidFraction, addr 0x3da2adc, size 0x5c, virtual false, abstract: false, final false
  inline bool IsInvalidFraction();

  /// @brief Method .ctor, addr 0x3da5d90, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t number);

  /// @brief Method .ctor, addr 0x3da7f20, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t number, int32_t leadingZeroes);

  /// @brief Method .ctor, addr 0x3da811c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Globalization::TimeSpanParse_TTT type);

  /// @brief Method .ctor, addr 0x3da812c, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BackOne, addr 0x3da7f34, size 0x14, virtual false, abstract: false, final false
  inline void BackOne();

  /// @brief Method GetNextToken, addr 0x3da303c, size 0x25c, virtual false, abstract: false, final false
  inline ::System::Globalization::TimeSpanParse_TimeSpanToken GetNextToken();

  /// @brief Method .ctor, addr 0x3da2fdc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> input);

  /// @brief Method .ctor, addr 0x3da7ce0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<char16_t> input, int32_t startPosition);

  /// @brief Method get_EOL, addr 0x3da7ed4, size 0x4c, virtual false, abstract: false, final false
  inline bool get_EOL();

  /// @brief Method get_NextChar, addr 0x3da7e74, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddNum, addr 0x3da831c, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSep, addr 0x3da8210, size 0x10c, virtual false, abstract: false, final false
  inline bool AddSep(::System::ReadOnlySpan_1<char16_t> sep, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult> result);

  /// @brief Method FullAppCompatMatch, addr 0x3da64f4, size 0x3a0, virtual false, abstract: false, final false
  inline bool FullAppCompatMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullDHMMatch, addr 0x3da6b98, size 0x304, virtual false, abstract: false, final false
  inline bool FullDHMMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullDHMSMatch, addr 0x3da614c, size 0x3a8, virtual false, abstract: false, final false
  inline bool FullDHMSMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullDMatch, addr 0x3da73f8, size 0x1bc, virtual false, abstract: false, final false
  inline bool FullDMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullHMMatch, addr 0x3da7198, size 0x260, virtual false, abstract: false, final false
  inline bool FullHMMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullHMSFMatch, addr 0x3da5da4, size 0x3a8, virtual false, abstract: false, final false
  inline bool FullHMSFMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullHMSMatch, addr 0x3da6894, size 0x304, virtual false, abstract: false, final false
  inline bool FullHMSMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method FullMatch, addr 0x3da57e0, size 0x44c, virtual false, abstract: false, final false
  inline bool FullMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method Init, addr 0x3da2fe8, size 0x54, virtual false, abstract: false, final false
  inline void Init(::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method PartialAppCompatMatch, addr 0x3da6e9c, size 0x2fc, virtual false, abstract: false, final false
  inline bool PartialAppCompatMatch(::System::Globalization::TimeSpanFormat_FormatLiterals pattern);

  /// @brief Method ProcessToken, addr 0x3da3298, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NegativeInvariant, addr 0x3da81a4, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_NegativeInvariant();

  /// @brief Method get_NegativeLocalized, addr 0x3da5cdc, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_NegativeLocalized();

  /// @brief Method get_PositiveInvariant, addr 0x3da813c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_PositiveInvariant();

  /// @brief Method get_PositiveLocalized, addr 0x3da5c2c, size 0xb0, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method SetFailure, addr 0x3da2eb4, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3da2b6c, size 0x10, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method NextChar, addr 0x3da842c, size 0x4c, virtual false, abstract: false, final false
  inline void NextChar();

  /// @brief Method NextNonDigit, addr 0x3da8478, size 0x5c, virtual false, abstract: false, final false
  inline char16_t NextNonDigit();

  /// @brief Method ParseInt, addr 0x3da86c4, size 0x118, virtual false, abstract: false, final false
  inline bool ParseInt(int32_t max, ::ByRef<int32_t> i, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult> result);

  /// @brief Method ParseTime, addr 0x3da8504, size 0x1c0, virtual false, abstract: false, final false
  inline bool ParseTime(::ByRef<int64_t> time, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult> result);

  /// @brief Method SkipBlanks, addr 0x3da84d4, size 0x30, virtual false, abstract: false, final false
  inline void SkipBlanks();

  /// @brief Method TryParse, addr 0x3da7f48, size 0x1d4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Parse, addr 0x3da2b38, size 0x34, virtual false, abstract: false, final false
  static inline ::System::TimeSpan Parse(::System::ReadOnlySpan_1<char16_t> input, ::System::IFormatProvider* formatProvider);

  /// @brief Method ParseExactDigits, addr 0x3da7d1c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExactDigits, addr 0x3da7cec, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseExactLiteral, addr 0x3da7de0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Pow10, addr 0x3da28f0, size 0x90, virtual false, abstract: false, final false
  static inline int64_t Pow10(int32_t pow);

  /// @brief Method ProcessTerminalState, addr 0x3da33a8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_D, addr 0x3da34dc, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_DHMSF, addr 0x3da558c, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HM, addr 0x3da384c, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HMS_F_D, addr 0x3da49d8, size 0xbb4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTerminal_HM_S_D, addr 0x3da3b84, size 0xe54, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseByFormat, addr 0x3da75e8, size 0x6f8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExact, addr 0x3da2d04, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseExactTimeSpan, addr 0x3da2d40, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseTimeSpan, addr 0x3da2b7c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseTimeSpanConstant, addr 0x3da75b4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method TryTimeToTicks, addr 0x3da2980, size 0x15c, virtual false, abstract: false, final false
