...
public:
  ...
  __declspec(property(get = getStaticF_range_00c0_0556, put = setStaticF_range_00c0_0556)) ::ArrayW<char16_t, ::Array<char16_t>*> range_00c0_0556;

  /// @brief Field range_10a0_10c5, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_range_10a0_10c5, put = setStaticF_range_10a0_10c5)) ::ArrayW<char16_t, ::Array<char16_t>*> range_10a0_10c5;

  /// @brief Field range_1e00_1ffc, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_range_1e00_1ffc, put = setStaticF_range_1e00_1ffc)) ::ArrayW<char16_t, ::Array<char16_t>*> range_1e00_1ffc;

  /// @brief Field range_2160_216f, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_range_2160_216f, put = setStaticF_range_2160_216f)) ::ArrayW<char16_t, ::Array<char16_t>*> range_2160_216f;

  /// @brief Field range_24b6_24cf, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_range_24b6_24cf, put = setStaticF_range_24b6_24cf)) ::ArrayW<char16_t, ::Array<char16_t>*> range_24b6_24cf;

  /// @brief Field range_2c00_2c2e, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_range_2c00_2c2e, put = setStaticF_range_2c00_2c2e)) ::ArrayW<char16_t, ::Array<char16_t>*> range_2c00_2c2e;

  /// @brief Field range_2c60_2ce2, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_range_2c60_2ce2, put = setStaticF_range_2c60_2ce2)) ::ArrayW<char16_t, ::Array<char16_t>*> range_2c60_2ce2;

  /// @brief Field range_a640_a696, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_range_a640_a696, put = setStaticF_range_a640_a696)) ::ArrayW<char16_t, ::Array<char16_t>*> range_a640_a696;

  /// @brief Field range_a722_a78b, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_range_a722_a78b, put = setStaticF_range_a722_a78b)) ::ArrayW<char16_t, ::Array<char16_t>*> range_a722_a78b;
