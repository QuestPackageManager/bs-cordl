...
public:
  ...
  /// @brief Method .ctor, addr 0x5bdee68, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Punycode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Punycode(Punycode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Punycode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Punycode(Punycodeconst&) = delete;
