...
public:
  ...
  /// @brief Method GetObjectData, addr 0x59e931c, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59e9000, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59e90dc, size 0x240, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x59e90a4, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW paramName, ::StringW message);

  /// @brief Method get_DefaultMessage, addr 0x59e9060, size 0x44, virtual false, abstract: false, final false
  static inline ::StringW get_DefaultMessage();

  /// @brief Method get_FormatedInvalidCultureId, addr 0x59e9478, size 0x14c, virtual false, abstract: false, final false
  inline ::StringW get_FormatedInvalidCultureId();

  /// @brief Method get_InvalidCultureId, addr 0x59e9468, size 0x8, virtual true, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_InvalidCultureId();

  /// @brief Method get_InvalidCultureName, addr 0x59e9470, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_InvalidCultureName();

  /// @brief Method get_Message, addr 0x59e95c4, size 0xc8, virtual true, abstract: false, final false
