...
public:
  ...
  /// @brief Method Compare, addr 0x3d89270, size 0x54c, virtual true, abstract: false, final false
  ...
  /// @brief Method Compare, addr 0x3d886a8, size 0x10, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW string1, ::StringW string2);

  /// @brief Method Compare, addr 0x3d886b8, size 0x2a0, virtual true, abstract: false, final false
  inline int32_t Compare(::StringW string1, ::StringW string2, ::System::Globalization::CompareOptions options);

  /// @brief Method Compare, addr 0x3d88c48, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareOptionIgnoreCase, addr 0x3d89044, size 0x13c, virtual false, abstract: false, final false
  inline int32_t CompareOptionIgnoreCase(::System::ReadOnlySpan_1<char16_t> string1, ::System::ReadOnlySpan_1<char16_t> string2);

  /// @brief Method CompareOrdinalIgnoreCase, addr 0x3d897bc, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareOrdinalIgnoreCase, addr 0x3d88958, size 0x1f4, virtual false, abstract: false, final false
  static inline int32_t CompareOrdinalIgnoreCase(::System::ReadOnlySpan_1<char16_t> strA, ::System::ReadOnlySpan_1<char16_t> strB);

  /// @brief Method CompareString, addr 0x3d88fe0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareString, addr 0x3d89180, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareStringOrdinalIgnoreCase, addr 0x3d89930, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSortKey, addr 0x3d8ac68, size 0xb8, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* CreateSortKey(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method CreateSortKeyCore, addr 0x3d8b9e8, size 0x138, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* CreateSortKeyCore(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method EndsWith, addr 0x3d8a050, size 0x170, virtual false, abstract: false, final false
  inline bool EndsWith(::StringW source, ::StringW suffix, ::System::Globalization::CompareOptions options);

  /// @brief Method EndsWith, addr 0x3d8a1c4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x3d8ad20, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetCollator, addr 0x3d8b6cc, size 0x31c, virtual false, abstract: false, final false
  inline ::System::Globalization::ISimpleCollator* GetCollator();

  /// @brief Method GetCompareInfo, addr 0x3d88424, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::Globalization::CompareInfo* GetCompareInfo(::StringW name);

  /// @brief Method GetHashCode, addr 0x3d8ade0, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetHashCode, addr 0x3d8b420, size 0x100, virtual true, abstract: false, final false
  inline int32_t GetHashCode(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method GetHashCodeOfString, addr 0x3d8b254, size 0x1a0, virtual false, abstract: false, final false
  inline int32_t GetHashCodeOfString(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method GetHashCodeOfStringCore, addr 0x3d8b3f4, size 0x2c, virtual false, abstract: false, final false
  inline int32_t GetHashCodeOfStringCore(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method GetIgnoreCaseHash, addr 0x3d8ae08, size 0x44c, virtual false, abstract: false, final false
  static inline int32_t GetIgnoreCaseHash(::StringW source);

  /// @brief Method GetSortKey, addr 0x3d8aba0, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Globalization::SortKey* GetSortKey(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method IndexOf, addr 0x3d8a224, size 0x6c, virtual true, abstract: false, final false
  inline int32_t IndexOf(::StringW source, ::StringW value, ::System::Globalization::CompareOptions options);

  /// @brief Method IndexOf, addr 0x3d8a290, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method IndexOfCore, addr 0x3d8a640, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfOrdinal, addr 0x3d8a540, size 0x100, virtual false, abstract: false, final false
  inline int32_t IndexOfOrdinal(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method IndexOfOrdinalCore, addr 0x3d8a694, size 0x20, virtual false, abstract: false, final false
  static inline int32_t IndexOfOrdinalCore(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method InitSort, addr 0x3d88408, size 0x1c, virtual false, abstract: false, final false
  inline void InitSort(::System::Globalization::CultureInfo* culture);

  /// @brief Method InvariantCreateSortKey, addr 0x3d8812c, size 0x2a8, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* InvariantCreateSortKey(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method InvariantFindString, addr 0x3d87cac, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvariantIndexOf, addr 0x3d87be8, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t InvariantIndexOf(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method InvariantLastIndexOf, addr 0x3d88048, size 0xcc, virtual false, abstract: false, final false
  static inline int32_t InvariantLastIndexOf(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method InvariantToUpper, addr 0x3d88114, size 0x18, virtual false, abstract: false, final false
  static inline char16_t InvariantToUpper(char16_t c);

  /// @brief Method IsPrefix, addr 0x3d89ab4, size 0x214, virtual true, abstract: false, final false
  inline bool IsPrefix(::StringW source, ::StringW prefix, ::System::Globalization::CompareOptions options);

  /// @brief Method IsSuffix, addr 0x3d89e3c, size 0x214, virtual true, abstract: false, final false
  inline bool IsSuffix(::StringW source, ::StringW suffix, ::System::Globalization::CompareOptions options);

  /// @brief Method IsSuffix, addr 0x3d8a1c0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOf, addr 0x3d8a6b4, size 0x70, virtual true, abstract: false, final false
  inline int32_t LastIndexOf(::StringW source, ::StringW value, ::System::Globalization::CompareOptions options);

  /// @brief Method LastIndexOf, addr 0x3d8a724, size 0x344, virtual true, abstract: false, final false
  ...
  /// @brief Method LastIndexOfCore, addr 0x3d8ab68, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOfOrdinal, addr 0x3d8aa68, size 0x100, virtual false, abstract: false, final false
  inline int32_t LastIndexOfOrdinal(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method LastIndexOfOrdinalCore, addr 0x3d8ab80, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x3d884e8, size 0xa4, virtual false, abstract: false, final false
  inline void OnDeserialized();

  /// @brief Method OnDeserialized, addr 0x3d8858c, size 0x4, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x3d884dc, size 0x8, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x3d88590, size 0x8c, virtual false, abstract: false, final false
  inline void OnSerializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method StartsWith, addr 0x3d89cc8, size 0x174, virtual false, abstract: false, final false
  inline bool StartsWith(::StringW source, ::StringW prefix, ::System::Globalization::CompareOptions options);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x3d884e4, size 0x4, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method ToString, addr 0x3d8b520, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d8c084, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3d883d4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Name, addr 0x3d8861c, size 0x8c, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_UseManagedCollation, addr 0x3d8b580, size 0x14c, virtual false, abstract: false, final false
  static inline bool get_UseManagedCollation();

  /// @brief Convert to "::System::Runtime::Serialization::IDeserializationCallback"
  constexpr ::System::Runtime::Serialization::IDeserializationCallback* i___System__Runtime__Serialization__IDeserializationCallback() noexcept;

  /// @brief Method internal_compare, addr 0x3d8be3c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_compare_icall, addr 0x3d8bff0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_compare_managed, addr 0x3d8bef0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_compare_switch, addr 0x3d88b4c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_index, addr 0x3d8bc5c, size 0xb4, virtual false, abstract: false, final false
  static inline int32_t internal_index(::StringW source, int32_t sindex, int32_t count, ::StringW value, bool first);

  /// @brief Method internal_index_icall, addr 0x3d8bff4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_index_managed, addr 0x3d8bd10, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method internal_index_switch, addr 0x3d8bb20, size 0x13c, virtual false, abstract: false, final false
