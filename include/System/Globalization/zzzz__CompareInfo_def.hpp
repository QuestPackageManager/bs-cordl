...
public:
  ...
  /// @brief Method InvariantIndexOf addr 0x23ed140 size 0xc4 virtual false final false
  static inline int32_t InvariantIndexOf(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method InvariantLastIndexOf addr 0x23ed530 size 0xcc virtual false final false
  static inline int32_t InvariantLastIndexOf(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method InvariantFindString addr 0x23ed204 size 0x32c virtual false final false
  ...
  /// @brief Method InvariantToUpper addr 0x23ed5fc size 0x18 virtual false final false
  static inline char16_t InvariantToUpper(char16_t c);

  /// @brief Method InvariantCreateSortKey addr 0x23ed614 size 0x29c virtual false final false
  ...
  /// @brief Method .ctor addr 0x23ed8b0 size 0x34 virtual false final false
  inline void _ctor(::System::Globalization::CultureInfo* culture);

  /// @brief Method GetCompareInfo addr 0x23ed900 size 0xbc virtual false final false
  static inline ::System::Globalization::CompareInfo* GetCompareInfo(::StringW name);

  /// @brief Method OnDeserializing addr 0x23ed9bc size 0x8 virtual false final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization addr 0x23ed9c4 size 0x4 virtual true final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method OnDeserialized addr 0x23eda6c size 0x4 virtual false final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserialized addr 0x23ed9c8 size 0xa4 virtual false final false
  inline void OnDeserialized();

  /// @brief Method OnSerializing addr 0x23eda70 size 0x8c virtual false final false
  inline void OnSerializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method get_Name addr 0x23edafc size 0x8c virtual true final false
  inline ::StringW get_Name();

  /// @brief Method Compare addr 0x23edb88 size 0x10 virtual true final false
  inline int32_t Compare(::StringW string1, ::StringW string2);

  /// @brief Method Compare addr 0x23edb98 size 0x2a8 virtual true final false
  inline int32_t Compare(::StringW string1, ::StringW string2, ::System::Globalization::CompareOptions options);

  /// @brief Method Compare addr 0x23ee130 size 0x3a0 virtual false final false
  ...
  /// @brief Method CompareOptionIgnoreCase addr 0x23ee534 size 0x13c virtual false final false
  inline int32_t CompareOptionIgnoreCase(::System::ReadOnlySpan_1<char16_t> string1, ::System::ReadOnlySpan_1<char16_t> string2);

  /// @brief Method Compare addr 0x23ee760 size 0x560 virtual true final false
  ...
  /// @brief Method CompareOrdinalIgnoreCase addr 0x23eecc0 size 0x174 virtual false final false
  ...
  /// @brief Method IndexOf addr 0x23ef724 size 0x70 virtual true final false
  inline int32_t IndexOf(::StringW source, ::StringW value, ::System::Globalization::CompareOptions options);

  /// @brief Method IndexOf addr 0x23ef794 size 0x2c4 virtual true final false
  ...
  /// @brief Method IndexOfOrdinal addr 0x23efa58 size 0x100 virtual false final false
  inline int32_t IndexOfOrdinal(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method LastIndexOf addr 0x23efbd4 size 0x74 virtual true final false
  inline int32_t LastIndexOf(::StringW source, ::StringW value, ::System::Globalization::CompareOptions options);

  /// @brief Method LastIndexOf addr 0x23efc48 size 0x35c virtual true final false
  ...
  /// @brief Method LastIndexOfOrdinal addr 0x23effa4 size 0x100 virtual false final false
  inline int32_t LastIndexOfOrdinal(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method GetSortKey addr 0x23f00dc size 0xc8 virtual true final false
  inline ::System::Globalization::SortKey* GetSortKey(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method Equals addr 0x23f0264 size 0xc0 virtual true final false
  inline bool Equals(::System::Object* value);

  /// @brief Method GetHashCode addr 0x23f0324 size 0x28 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method GetIgnoreCaseHash addr 0x23f034c size 0x47c virtual false final false
  static inline int32_t GetIgnoreCaseHash(::StringW source);

  /// @brief Method GetHashCodeOfString addr 0x23f07c8 size 0x1a8 virtual false final false
  inline int32_t GetHashCodeOfString(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method GetHashCode addr 0x23f099c size 0x104 virtual true final false
  inline int32_t GetHashCode(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method ToString addr 0x23f0aa0 size 0x60 virtual true final false
  inline ::StringW ToString();

  /// @brief Method get_UseManagedCollation addr 0x23f0b00 size 0x144 virtual false final false
  static inline bool get_UseManagedCollation();

  /// @brief Method GetCollator addr 0x23f0c44 size 0x334 virtual false final false
  inline ::System::Globalization::ISimpleCollator* GetCollator();

  /// @brief Method CreateSortKeyCore addr 0x23f0f78 size 0x13c virtual false final false
  inline ::System::Globalization::SortKey* CreateSortKeyCore(::StringW source, ::System::Globalization::CompareOptions options);

  /// @brief Method internal_index_switch addr 0x23f10b4 size 0x13c virtual false final false
  ...
  /// @brief Method internal_compare_switch addr 0x23ee034 size 0xfc virtual false final false
  ...
  /// @brief Method internal_compare_managed addr 0x23f1484 size 0x100 virtual false final false
  ...
  /// @brief Method internal_index_managed addr 0x23f12a4 size 0x12c virtual false final false
  ...
  /// @brief Method internal_compare_icall addr 0x23f1584 size 0x4 virtual false final false
  ...
  /// @brief Method internal_compare addr 0x23f13d0 size 0xb4 virtual false final false
  ...
  /// @brief Method internal_index_icall addr 0x23f1588 size 0x8 virtual false final false
  ...
  /// @brief Method internal_index addr 0x23f11f0 size 0xb4 virtual false final false
  static inline int32_t internal_index(::StringW source, int32_t sindex, int32_t count, ::StringW value, bool first);

  /// @brief Method InitSort addr 0x23ed8e4 size 0x1c virtual false final false
  inline void InitSort(::System::Globalization::CultureInfo* culture);

  /// @brief Method CompareStringOrdinalIgnoreCase addr 0x23eee34 size 0x160 virtual false final false
  ...
  /// @brief Method IndexOfOrdinalCore addr 0x23efbb4 size 0x20 virtual false final false
  static inline int32_t IndexOfOrdinalCore(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase);

  /// @brief Method LastIndexOfOrdinalCore addr 0x23f00bc size 0x20 virtual false final false
  ...
  /// @brief Method LastIndexOfCore addr 0x23f00a4 size 0x18 virtual false final false
  ...
  /// @brief Method IndexOfCore addr 0x23efb58 size 0x5c virtual false final false
  ...
  /// @brief Method CompareString addr 0x23ee4d0 size 0x64 virtual false final false
  ...
  /// @brief Method CompareString addr 0x23ee670 size 0xf0 virtual false final false
  ...
  /// @brief Method GetHashCodeOfStringCore addr 0x23f0970 size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x23f1618 size 0x38 virtual false final false
  inline void _ctor();
