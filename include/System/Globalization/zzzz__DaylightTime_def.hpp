...
// Write type traits
MARK_REF_T(::System::Globalization::DaylightTime*);
DEFINE_IL2CPP_CLASS(::System::Globalization::DaylightTime*, "System.Globalization", "DaylightTime");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5bbce2c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime start, ::System::DateTime end, ::System::TimeSpan delta);

  /// @brief Method get_Delta, addr 0x5bbce48, size 0x8, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_Delta();

  /// @brief Method get_End, addr 0x5bbce40, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_End();

  /// @brief Method get_Start, addr 0x5bbce38, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DaylightTime", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DaylightTime(DaylightTime&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DaylightTime", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DaylightTime(DaylightTimeconst&) = delete;
...
static_assert(sizeof(::System::Globalization::DaylightTime) == 0x28, "Size mismatch!");
