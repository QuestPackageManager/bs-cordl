...
public:
  ...
  /// @brief Method Clone, addr 0x3da359c, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method GetFormat, addr 0x3da3918, size 0x98, virtual true, abstract: false, final true
  inline ::System::Object* GetFormat(::System::Type* formatType);

  /// @brief Method GetInstance, addr 0x3da32fc, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x3da2f0c, size 0x4, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x3da2f08, size 0x4, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x3da2e84, size 0x84, virtual false, abstract: false, final false
  inline void OnSerializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method ReadOnly, addr 0x3da322c, size 0xd0, virtual false, abstract: false, final false
  static inline ::System::Globalization::NumberFormatInfo* ReadOnly(::System::Globalization::NumberFormatInfo* nfi);

  /// @brief Method ValidateParseStyleFloatingPoint, addr 0x3da3a7c, size 0xc0, virtual false, abstract: false, final false
  static inline void ValidateParseStyleFloatingPoint(::System::Globalization::NumberStyles style);

  /// @brief Method ValidateParseStyleInteger, addr 0x3da39b0, size 0xcc, virtual false, abstract: false, final false
  static inline void ValidateParseStyleInteger(::System::Globalization::NumberStyles style);

  /// @brief Method VerifyGroupSeparator, addr 0x3da2f10, size 0x68, virtual false, abstract: false, final false
  static inline void VerifyGroupSeparator(::StringW groupSep, ::StringW propertyName);

  /// @brief Method VerifyWritable, addr 0x3da311c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3da2a4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3da2a54, size 0x430, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrencyDecimalDigits, addr 0x3da3608, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrencyDecimalDigits();

  /// @brief Method get_CurrencyDecimalSeparator, addr 0x3da3610, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CurrencyDecimalSeparator();

  /// @brief Method get_CurrencyGroupSeparator, addr 0x3da3788, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CurrencyGroupSeparator();

  /// @brief Method get_CurrencyGroupSizes, addr 0x3da3620, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_CurrencyGroupSizes();

  /// @brief Method get_CurrencyNegativePattern, addr 0x3da382c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrencyNegativePattern();

  /// @brief Method get_CurrencyPositivePattern, addr 0x3da38d8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrencyPositivePattern();

  /// @brief Method get_CurrencySymbol, addr 0x3da3790, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CurrencySymbol();

  /// @brief Method get_CurrentInfo, addr 0x3da34a8, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Globalization::NumberFormatInfo* get_CurrentInfo();

  /// @brief Method get_InvariantInfo, addr 0x3da3188, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Globalization::NumberFormatInfo* get_InvariantInfo();

  /// @brief Method get_IsReadOnly, addr 0x3da3618, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_NaNSymbol, addr 0x3da3798, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NaNSymbol();

  /// @brief Method get_NegativeInfinitySymbol, addr 0x3da384c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NegativeInfinitySymbol();

  /// @brief Method get_NegativeSign, addr 0x3da3854, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NegativeSign();

  /// @brief Method get_NumberDecimalDigits, addr 0x3da385c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NumberDecimalDigits();

  /// @brief Method get_NumberDecimalSeparator, addr 0x3da3864, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NumberDecimalSeparator();

  /// @brief Method get_NumberGroupSeparator, addr 0x3da386c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_NumberGroupSeparator();

  /// @brief Method get_NumberGroupSizes, addr 0x3da3698, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_NumberGroupSizes();

  /// @brief Method get_NumberNegativePattern, addr 0x3da3834, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NumberNegativePattern();

  /// @brief Method get_PerMilleSymbol, addr 0x3da3910, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PerMilleSymbol();

  /// @brief Method get_PercentDecimalDigits, addr 0x3da38f0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PercentDecimalDigits();

  /// @brief Method get_PercentDecimalSeparator, addr 0x3da38f8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PercentDecimalSeparator();

  /// @brief Method get_PercentGroupSeparator, addr 0x3da3900, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PercentGroupSeparator();

  /// @brief Method get_PercentGroupSizes, addr 0x3da3710, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_PercentGroupSizes();

  /// @brief Method get_PercentNegativePattern, addr 0x3da3844, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PercentNegativePattern();

  /// @brief Method get_PercentPositivePattern, addr 0x3da383c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PercentPositivePattern();

  /// @brief Method get_PercentSymbol, addr 0x3da3908, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PercentSymbol();

  /// @brief Method get_PositiveInfinitySymbol, addr 0x3da38e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PositiveInfinitySymbol();

  /// @brief Method get_PositiveSign, addr 0x3da38e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_NaNSymbol, addr 0x3da37a0, size 0x8c, virtual false, abstract: false, final false
  inline void set_NaNSymbol(::StringW value);

  /// @brief Method set_NumberGroupSeparator, addr 0x3da3874, size 0x64, virtual false, abstract: false, final false
