...
// Ctor Parameters [CppParam { name: "codePage", ty: "uint16_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "uiFamilyCodePage", ty: "uint16_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "flags", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Names", ty: "::StringW", modifiers: "", def_value:
// Some("{}"), comment: None }]
