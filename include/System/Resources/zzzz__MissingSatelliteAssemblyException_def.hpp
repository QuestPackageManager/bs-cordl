...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissingSatelliteAssemblyException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MissingSatelliteAssemblyException(MissingSatelliteAssemblyException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MissingSatelliteAssemblyException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MissingSatelliteAssemblyException(MissingSatelliteAssemblyExceptionconst&) = delete;
