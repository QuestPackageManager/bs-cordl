...
public:
  ...
  /// @brief Method .ctor, addr 0x3d1b2b0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW cultureName);

  /// @brief Method get_CultureName, addr 0x3d1b328, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CultureName();

  /// @brief Method get_Location, addr 0x3d1b330, size 0x8, virtual false, abstract: false, final false
