...
public:
  ...
  /// @brief Method .ctor, addr 0x5a355a8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(::StringW cultureName);

  /// @brief Method get_CultureName, addr 0x5a35604, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_CultureName();

  /// @brief Method get_Location, addr 0x5a3560c, size 0x8, virtual false, abstract: false, final false
