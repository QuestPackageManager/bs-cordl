...
public:
  ...
  /// @brief Method MoveNext, addr 0x3d1cc0c, size 0x70, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Resources::ResourceReader_ResourceEnumerator* New_ctor(::System::Resources::ResourceReader* reader);

  /// @brief Method Reset, addr 0x3d216b0, size 0x84, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3d1e800, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Resources::ResourceReader* reader);

  /// @brief Method get_Current, addr 0x3d2125c, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* get_Current();

  /// @brief Method get_DataPosition, addr 0x3d21600, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DataPosition();

  /// @brief Method get_Entry, addr 0x3d212c0, size 0x340, virtual true, abstract: false, final true
  inline ::System::Collections::DictionaryEntry get_Entry();

  /// @brief Method get_Key, addr 0x3d1cb5c, size 0xb0, virtual true, abstract: false, final true
  inline ::System::Object* get_Key();

  /// @brief Method get_Value, addr 0x3d21608, size 0xa8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AllocateStringForNameIndex, addr 0x3d1ea3c, size 0x7c0, virtual false, abstract: false, final false
  inline ::StringW AllocateStringForNameIndex(int32_t index, ::ByRef<int32_t> dataOffset);

  /// @brief Method Close, addr 0x3d1b800, size 0x3c, virtual true, abstract: false, final true
  inline void Close();

  /// @brief Method CompareStringEqualsName, addr 0x3d1e834, size 0x208, virtual false, abstract: false, final false
  inline bool CompareStringEqualsName(::StringW name);

  /// @brief Method DeserializeObject, addr 0x3d202b8, size 0x1d0, virtual false, abstract: false, final false
  inline ::System::Object* DeserializeObject(int32_t typeIndex);

  /// @brief Method Dispose, addr 0x3d1e4ec, size 0x3c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x3d1e4ac, size 0x40, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method FindPosForResource, addr 0x3d1c3f0, size 0x3ac, virtual false, abstract: false, final false
  inline int32_t FindPosForResource(::StringW name);

  /// @brief Method FindType, addr 0x3d1f688, size 0x3bc, virtual false, abstract: false, final false
  inline ::System::RuntimeType* FindType(int32_t typeIndex);

  /// @brief Method GetEnumerator, addr 0x3d1e740, size 0xc0, virtual true, abstract: false, final true
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetEnumeratorInternal, addr 0x3d1caf4, size 0x68, virtual false, abstract: false, final false
  inline ::System::Resources::ResourceReader_ResourceEnumerator* GetEnumeratorInternal();

  /// @brief Method GetNameHash, addr 0x3d1e5e0, size 0x44, virtual false, abstract: false, final false
  inline int32_t GetNameHash(int32_t index);

  /// @brief Method GetNamePosition, addr 0x3d1e624, size 0x118, virtual false, abstract: false, final false
  inline int32_t GetNamePosition(int32_t index);

  /// @brief Method GetValueForNameIndex, addr 0x3d1f1fc, size 0x29c, virtual false, abstract: false, final false
  inline ::System::Object* GetValueForNameIndex(int32_t index);

  /// @brief Method LoadObject, addr 0x3d1fa44, size 0x2c, virtual false, abstract: false, final false
  inline ::System::Object* LoadObject(int32_t pos);

  /// @brief Method LoadObject, addr 0x3d1ca44, size 0x98, virtual false, abstract: false, final false
  inline ::System::Object* LoadObject(int32_t pos, ::ByRef<::System::Resources::ResourceTypeCode> typeCode);

  /// @brief Method LoadObjectV1, addr 0x3d1f498, size 0xf8, virtual false, abstract: false, final false
  inline ::System::Object* LoadObjectV1(int32_t pos);

  /// @brief Method LoadObjectV2, addr 0x3d1f590, size 0xf8, virtual false, abstract: false, final false
  inline ::System::Object* LoadObjectV2(int32_t pos, ::ByRef<::System::Resources::ResourceTypeCode> typeCode);

  /// @brief Method LoadString, addr 0x3d1c79c, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadResources, addr 0x3d1e348, size 0x164, virtual false, abstract: false, final false
  inline void ReadResources();

  /// @brief Method ReadUnalignedI4, addr 0x3d1e528, size 0x8, virtual false, abstract: false, final false
  static inline int32_t ReadUnalignedI4(::cordl_internals::Ptr<int32_t> p);

  /// @brief Method SkipString, addr 0x3d1e530, size 0xb0, virtual false, abstract: false, final false
  inline void SkipString();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3d1e73c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method _LoadObjectV1, addr 0x3d1fa70, size 0x848, virtual false, abstract: false, final false
  inline ::System::Object* _LoadObjectV1(int32_t pos);

  /// @brief Method _LoadObjectV2, addr 0x3d20488, size 0x724, virtual false, abstract: false, final false
  inline ::System::Object* _LoadObjectV2(int32_t pos, ::ByRef<::System::Resources::ResourceTypeCode> typeCode);

  /// @brief Method _ReadResources, addr 0x3d20bac, size 0x6b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d1b4e8, size 0xe4, virtual false, abstract: false, final false
