...
/// @brief Method Compare, addr 0x59c555c, size 0x10, virtual true, abstract: false, final true
inline int32_t Compare(::StringW  a, ::StringW  b) ;

/// @brief Method Compare, addr 0x59c54f4, size 0x68, virtual true, abstract: false, final true
inline int32_t Compare(::System::Object*  a, ::System::Object*  b) ;

/// @brief Method CompareOrdinal, addr 0x59c55e4, size 0x84, virtual false, abstract: false, final false
static inline int32_t CompareOrdinal(::StringW  a, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  bCharLength) ;

/// @brief Method CompareOrdinal, addr 0x59c56e0, size 0x5c, virtual false, abstract: false, final false
static inline int32_t CompareOrdinal(uint8_t*  a, int32_t  byteLen, ::StringW  b) ;

/// @brief Method CompareOrdinal, addr 0x59c5668, size 0x78, virtual false, abstract: false, final false
static inline int32_t CompareOrdinal(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  aCharLength, ::StringW  b) ;

/// @brief Method Equals, addr 0x59c556c, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::StringW  a, ::StringW  b) ;

/// @brief Method Equals, addr 0x59c557c, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::System::Object*  a, ::System::Object*  b) ;

/// @brief Method GetHashCode, addr 0x59c5468, size 0x8c, virtual true, abstract: false, final true
inline int32_t GetHashCode(::StringW  key) ;

/// @brief Method GetHashCode, addr 0x59c537c, size 0xa8, virtual true, abstract: false, final true
inline int32_t GetHashCode(::System::Object*  key) ;

/// @brief Method HashFunction, addr 0x59c5424, size 0x44, virtual false, abstract: false, final false
static inline int32_t HashFunction(::StringW  key) ;

static inline ::System::Resources::FastResourceComparer* New_ctor() ;

/// @brief Method .ctor, addr 0x59c573c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
