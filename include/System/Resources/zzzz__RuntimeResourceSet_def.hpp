...
public:
  ...
  /// @brief Method Dispose, addr 0x28782cc, size 0x140, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetEnumerator, addr 0x28784fc, size 0x4, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetEnumeratorHelper, addr 0x2878500, size 0x100, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumeratorHelper();

  /// @brief Method GetObject, addr 0x2879000, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW key);

  /// @brief Method GetObject, addr 0x287900c, size 0xc, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW key, bool ignoreCase);

  /// @brief Method GetObject, addr 0x2878674, size 0x910, virtual false, abstract: false, final false
  inline ::System::Object* GetObject(::StringW key, bool ignoreCase, bool isString);

  /// @brief Method GetString, addr 0x2878604, size 0x70, virtual true, abstract: false, final false
  inline ::StringW GetString(::StringW key);

  /// @brief Method GetString, addr 0x2878f84, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method ResolveResourceLocator, addr 0x28798d0, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2878600, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2877fa8, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::StringW fileName);

  /// @brief Method .ctor, addr 0x28781d4, size 0xf8, virtual false, abstract: false, final false
