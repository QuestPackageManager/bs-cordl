...
public:
  ...
  /// @brief Method .ctor addr 0x238ba18 size 0x1c virtual false final false
  inline void _ctor();

  static inline ::System::Resources::ResourceSet* New_ctor(bool junk);

  /// @brief Method .ctor addr 0x238ba94 size 0x8 virtual false final false
  inline void _ctor(bool junk);

  /// @brief Method CommonInit addr 0x238ba34 size 0x60 virtual false final false
  inline void CommonInit();

  /// @brief Method Dispose addr 0x238ba9c size 0xb4 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method Dispose addr 0x238bb50 size 0x10 virtual true final true
  inline void Dispose();

  /// @brief Method GetEnumerator addr 0x238bb60 size 0x4 virtual true final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x238bbe8 size 0x4 virtual true final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method GetEnumeratorHelper addr 0x238bb64 size 0x84 virtual false final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumeratorHelper();

  /// @brief Method GetString addr 0x238bbec size 0x168 virtual true final false
  inline ::StringW GetString(::StringW name);

  /// @brief Method GetString addr 0x238be28 size 0x204 virtual true final false
  inline ::StringW GetString(::StringW name, bool ignoreCase);

  /// @brief Method GetObject addr 0x238c2fc size 0x4 virtual true final false
  inline ::System::Object* GetObject(::StringW name);

  /// @brief Method GetObject addr 0x238c300 size 0x40 virtual true final false
  inline ::System::Object* GetObject(::StringW name, bool ignoreCase);

  /// @brief Method GetObjectInternal addr 0x238bd54 size 0xd4 virtual false final false
  inline ::System::Object* GetObjectInternal(::StringW name);

  /// @brief Method GetCaseInsensitiveObjectInternal addr 0x238c02c size 0x2d0 virtual false final false
