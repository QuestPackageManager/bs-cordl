...
public:
  ...
  /// @brief Method CommonInit, addr 0x3d216d8, size 0x58, virtual false, abstract: false, final false
  inline void CommonInit();

  /// @brief Method Dispose, addr 0x3d21730, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x3d1b7c4, size 0xb4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetCaseInsensitiveObjectInternal, addr 0x3d21be8, size 0x2cc, virtual false, abstract: false, final false
  inline ::System::Object* GetCaseInsensitiveObjectInternal(::StringW name);

  /// @brief Method GetEnumerator, addr 0x3d21740, size 0x4, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumerator();

  /// @brief Method GetEnumeratorHelper, addr 0x3d21744, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionaryEnumerator* GetEnumeratorHelper();

  /// @brief Method GetObject, addr 0x3d21eb4, size 0x4, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW name);

  /// @brief Method GetObject, addr 0x3d21eb8, size 0x40, virtual true, abstract: false, final false
  inline ::System::Object* GetObject(::StringW name, bool ignoreCase);

  /// @brief Method GetObjectInternal, addr 0x3d21924, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Object* GetObjectInternal(::StringW name);

  /// @brief Method GetString, addr 0x3d217c4, size 0x160, virtual true, abstract: false, final false
  inline ::StringW GetString(::StringW name);

  /// @brief Method GetString, addr 0x3d219ec, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3d217c0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3d216bc, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3d1b468, size 0x8, virtual false, abstract: false, final false
