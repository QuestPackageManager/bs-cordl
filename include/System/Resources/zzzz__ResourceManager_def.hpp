...
public:
  ...
  /// @brief Method .ctor, addr 0x287a5c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x287a5c8, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareNames, addr 0x287a88c, size 0x254, virtual false, abstract: false, final false
  static inline bool CompareNames(::StringW asmTypeName1, ::StringW typeName2, ::System::Reflection::AssemblyName* asmName2);

  /// @brief Method Init, addr 0x287a3d0, size 0x118, virtual false, abstract: false, final false
  inline void Init();

  static inline ::System::Resources::ResourceManager* New_ctor();

  /// @brief Method OnDeserialized, addr 0x287a650, size 0x1cc, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x287a640, size 0x10, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x287a81c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x287a4ec, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();
