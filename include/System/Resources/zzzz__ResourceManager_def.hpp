...
public:
  ...
  /// @brief Method .ctor, addr 0x3d2aecc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3d2aed4, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareNames, addr 0x3d2b18c, size 0x25c, virtual false, abstract: false, final false
  static inline bool CompareNames(::StringW asmTypeName1, ::StringW typeName2, ::System::Reflection::AssemblyName* asmName2);

  /// @brief Method Init, addr 0x3d2ace4, size 0x118, virtual false, abstract: false, final false
  inline void Init();

  static inline ::System::Resources::ResourceManager* New_ctor();

  /// @brief Method OnDeserialized, addr 0x3d2af58, size 0x1cc, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x3d2af48, size 0x10, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x3d2b124, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d2ae00, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
