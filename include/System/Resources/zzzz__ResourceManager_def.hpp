...
public:
  ...
  /// @brief Method .ctor, addr 0x5a3a140, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetResourceFileName, addr 0x5a3794c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ObtainSatelliteContractVersion, addr 0x5a39bd0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a3a144, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::Resources::ResourceManager* rm);

  /// @brief Method get_BaseName, addr 0x5a39f54, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_BaseName();

  /// @brief Method get_BaseNameField, addr 0x5a37a1c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_BaseNameField();

  /// @brief Method get_CallingAssembly, addr 0x5a39848, size 0x18, virtual false, abstract: false, final false
  inline ::System::Reflection::RuntimeAssembly* get_CallingAssembly();

  /// @brief Method get_FallbackLoc, addr 0x5a38110, size 0x18, virtual false, abstract: false, final false
  inline ::System::Resources::UltimateResourceFallbackLocation get_FallbackLoc();

  /// @brief Method get_LocationInfo, addr 0x5a37a34, size 0x18, virtual false, abstract: false, final false
  inline ::System::Type* get_LocationInfo();

  /// @brief Method get_LookedForSatelliteContractVersion, addr 0x5a39bb8, size 0x18, virtual false, abstract: false, final false
  inline bool get_LookedForSatelliteContractVersion();

  /// @brief Method get_MainAssembly, addr 0x5a38128, size 0x88, virtual false, abstract: false, final false
  inline ::System::Reflection::RuntimeAssembly* get_MainAssembly();

  /// @brief Method get_ModuleDir, addr 0x5a37d14, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_ModuleDir();

  /// @brief Method get_NeutralResourcesCulture, addr 0x5a3935c, size 0x18, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_NeutralResourcesCulture();

  /// @brief Method get_SatelliteContractVersion, addr 0x5a39cd8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Version* get_SatelliteContractVersion();

  /// @brief Method get_UserResourceSet, addr 0x5a37d2c, size 0x18, virtual false, abstract: false, final false
  inline ::System::Type* get_UserResourceSet();

  /// @brief Method set_LookedForSatelliteContractVersion, addr 0x5a39c40, size 0x1c, virtual false, abstract: false, final false
  inline void set_LookedForSatelliteContractVersion(bool value);

  /// @brief Method set_SatelliteContractVersion, addr 0x5a39c28, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddResourceSet, addr 0x5a3b500, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method CommonAssemblyInit, addr 0x5a3a458, size 0x16c, virtual false, abstract: false, final false
  inline void CommonAssemblyInit();

  /// @brief Method CompareNames, addr 0x5a39cf0, size 0x264, virtual false, abstract: false, final false
  static inline bool CompareNames(::StringW asmTypeName1, ::StringW typeName2, ::System::Reflection::AssemblyName* asmName2);

  /// @brief Method GetFirstResourceSet, addr 0x5a3a988, size 0x3ac, virtual false, abstract: false, final false
  inline ::System::Resources::ResourceSet* GetFirstResourceSet(::System::Globalization::CultureInfo* culture);

  /// @brief Method GetResourceFileName, addr 0x5a3a844, size 0x144, virtual true, abstract: false, final false
  inline ::StringW GetResourceFileName(::System::Globalization::CultureInfo* culture);

  /// @brief Method GetSatelliteContractVersion, addr 0x5a3b6cc, size 0x70c, virtual false, abstract: false, final false
  static inline ::System::Version* GetSatelliteContractVersion(::System::Reflection::Assembly* a);

  /// @brief Method GetString, addr 0x5a3bdd8, size 0x474, virtual true, abstract: false, final false
  inline ::StringW GetString(::StringW name, ::System::Globalization::CultureInfo* culture);

  /// @brief Method Init, addr 0x5a39f70, size 0x120, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InternalGetResourceSet, addr 0x5a3ad34, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method InternalGetResourceSet, addr 0x5a3ad50, size 0x7b0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialized, addr 0x5a3a5d4, size 0x1f0, virtual false, abstract: false, final false
  inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnDeserializing, addr 0x5a3a5c4, size 0x10, virtual false, abstract: false, final false
  inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method OnSerializing, addr 0x5a3a7c4, size 0x70, virtual false, abstract: false, final false
  inline void OnSerializing(::System::Runtime::Serialization::StreamingContext ctx);

  /// @brief Method SetAppXConfiguration, addr 0x5a3a454, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a3a090, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a3a19c, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BaseName, addr 0x5a3a834, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_BaseName();

  /// @brief Method get_FallbackLocation, addr 0x5a3a83c, size 0x8, virtual false, abstract: false, final false
