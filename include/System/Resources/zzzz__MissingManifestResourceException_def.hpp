...
public:
  ...
  /// @brief Method .ctor, addr 0x275f11c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x275f178, size 0x8, virtual false, abstract: false, final false
