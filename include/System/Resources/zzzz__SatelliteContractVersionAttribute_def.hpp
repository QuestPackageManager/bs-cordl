...
public:
  ...
  /// @brief Method .ctor, addr 0x5b72ad0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::StringW version);

  /// @brief Method get_Version, addr 0x5b72b28, size 0x8, virtual false, abstract: false, final false
