...
// Write type traits
MARK_REF_T(::System::Resources::FileBasedResourceGroveler*);
DEFINE_IL2CPP_CLASS(::System::Resources::FileBasedResourceGroveler*, "System.Resources", "FileBasedResourceGroveler");
...
public:
  ...
  /// @brief Method CreateResourceSet, addr 0x5b75594, size 0x2c8, virtual false, abstract: false, final false
  inline ::System::Resources::ResourceSet* CreateResourceSet(::StringW file);

  /// @brief Method FindResourceFile, addr 0x5b754b0, size 0xb4, virtual false, abstract: false, final false
  inline ::StringW FindResourceFile(::System::Globalization::CultureInfo* culture, ::StringW fileName);

  /// @brief Method GrovelForResourceSet, addr 0x5b75250, size 0x244, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b75248, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FileBasedResourceGroveler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FileBasedResourceGroveler(FileBasedResourceGroveler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FileBasedResourceGroveler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FileBasedResourceGroveler(FileBasedResourceGrovelerconst&) = delete;
...
static_assert(sizeof(::System::Resources::FileBasedResourceGroveler) == 0x18, "Size mismatch!");
