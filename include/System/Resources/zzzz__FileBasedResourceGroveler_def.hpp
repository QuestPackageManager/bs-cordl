...
/// @brief Method CreateResourceSet, addr 0x59c5ae0, size 0x2c8, virtual false, abstract: false, final false
inline ::System::Resources::ResourceSet* CreateResourceSet(::StringW  file) ;

/// @brief Method FindResourceFile, addr 0x59c59fc, size 0xb4, virtual false, abstract: false, final false
inline ::StringW FindResourceFile(::System::Globalization::CultureInfo*  culture, ::StringW  fileName) ;

/// @brief Method GrovelForResourceSet, addr 0x59c579c, size 0x244, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x59c5794, size 0x8, virtual false, abstract: false, final false
