...
/// @brief Method CanUseDefaultResourceClasses, addr 0x59c7798, size 0x144, virtual false, abstract: false, final false
inline bool CanUseDefaultResourceClasses(::StringW  readerTypeName, ::StringW  resSetTypeName) ;

/// @brief Method CaseInsensitiveManifestResourceStreamLookup, addr 0x59c78f4, size 0x358, virtual false, abstract: false, final false
...
/// @brief Method CreateResourceSet, addr 0x59c6834, size 0x910, virtual false, abstract: false, final false
inline ::System::Resources::ResourceSet* CreateResourceSet(::System::IO::Stream*  store, ::System::Reflection::Assembly*  assembly) ;

/// @brief Method GetManifestResourceStream, addr 0x59c6768, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method GetNeutralResourcesLanguage, addr 0x59c7408, size 0x314, virtual false, abstract: false, final false
...
/// @brief Method GetNeutralResourcesLanguageAttribute, addr 0x59c771c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method GetSatelliteAssembly, addr 0x59c6244, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method GetSatelliteAssemblyName, addr 0x59c7cf0, size 0x7c, virtual false, abstract: false, final false
inline ::StringW GetSatelliteAssemblyName() ;

/// @brief Method GrovelForResourceSet, addr 0x59c5de0, size 0x2b4, virtual true, abstract: false, final true
...
/// @brief Method HandleResourceStreamMissing, addr 0x59c7144, size 0x2ac, virtual false, abstract: false, final false
inline void HandleResourceStreamMissing(::StringW  fileName) ;

/// @brief Method HandleSatelliteMissing, addr 0x59c63c4, size 0x3a4, virtual false, abstract: false, final false
...
/// @brief Method UltimateFallbackFixup, addr 0x59c6094, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59c5dd8, size 0x8, virtual false, abstract: false, final false
