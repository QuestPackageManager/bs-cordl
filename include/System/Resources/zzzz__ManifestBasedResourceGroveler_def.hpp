...
public:
  ...
  /// @brief Method CanUseDefaultResourceClasses, addr 0x59c728c, size 0x144, virtual false, abstract: false, final false
  inline bool CanUseDefaultResourceClasses(::StringW readerTypeName, ::StringW resSetTypeName);

  /// @brief Method CaseInsensitiveManifestResourceStreamLookup, addr 0x59c73e8, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateResourceSet, addr 0x59c6328, size 0x910, virtual false, abstract: false, final false
  inline ::System::Resources::ResourceSet* CreateResourceSet(::System::IO::Stream* store, ::System::Reflection::Assembly* assembly);

  /// @brief Method GetManifestResourceStream, addr 0x59c625c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNeutralResourcesLanguage, addr 0x59c6efc, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNeutralResourcesLanguageAttribute, addr 0x59c7210, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSatelliteAssembly, addr 0x59c5d38, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSatelliteAssemblyName, addr 0x59c77e4, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW GetSatelliteAssemblyName();

  /// @brief Method GrovelForResourceSet, addr 0x59c58d4, size 0x2b4, virtual true, abstract: false, final true
  ...
  /// @brief Method HandleResourceStreamMissing, addr 0x59c6c38, size 0x2ac, virtual false, abstract: false, final false
  inline void HandleResourceStreamMissing(::StringW fileName);

  /// @brief Method HandleSatelliteMissing, addr 0x59c5eb8, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method UltimateFallbackFixup, addr 0x59c5b88, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59c58cc, size 0x8, virtual false, abstract: false, final false
