...
public:
  ...
  /// @brief Method Equals, addr 0x62320bc, size 0x5c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* rparam);

  /// @brief Method GetHashCode, addr 0x6232118, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Init, addr 0x62317e0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFieldsFromUri, addr 0x6231aac, size 0x174, virtual false, abstract: false, final false
  inline void SetFieldsFromUri(::System::Uri* uri);

  /// @brief Method ToString, addr 0x6232138, size 0x3b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6231570, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6231664, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor(::StringW uri);

  /// @brief Method .ctor, addr 0x6231958, size 0x154, virtual false, abstract: false, final false
  inline void _ctor(::System::Uri* uri);

  /// @brief Method get_Uri, addr 0x6232028, size 0x94, virtual false, abstract: false, final false
  inline ::System::Uri* get_Uri();

  /// @brief Method set_Host, addr 0x6231c20, size 0xf4, virtual false, abstract: false, final false
  inline void set_Host(::StringW value);

  /// @brief Method set_Path, addr 0x6231d14, size 0xc4, virtual false, abstract: false, final false
  inline void set_Path(::StringW value);

  /// @brief Method set_Port, addr 0x6231dd8, size 0x68, virtual false, abstract: false, final false
  inline void set_Port(int32_t value);

  /// @brief Method set_Query, addr 0x6231e40, size 0xa4, virtual false, abstract: false, final false
  inline void set_Query(::StringW value);

  /// @brief Method set_Scheme, addr 0x6231ee4, size 0x144, virtual false, abstract: false, final false
