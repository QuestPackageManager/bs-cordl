...
public:
  ...
  /// @brief Method FormatDigits, addr 0x25975c4, size 0x70, virtual false, abstract: false, final false
  static inline void FormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t value, int32_t len);

  /// @brief Method FormatDigits, addr 0x2597634, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method HebrewFormatDigits, addr 0x259772c, size 0x7c, virtual false, abstract: false, final false
  static inline void HebrewFormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t digits);

  /// @brief Method ParseRepeatPattern, addr 0x25977a8, size 0x78, virtual false, abstract: false, final false
  static inline int32_t ParseRepeatPattern(::System::ReadOnlySpan_1<char16_t> format, int32_t pos, char16_t patternChar);

  /// @brief Method FormatDayOfWeek, addr 0x2597820, size 0x34, virtual false, abstract: false, final false
  static inline ::StringW FormatDayOfWeek(int32_t dayOfWeek, int32_t repeat, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method FormatMonth, addr 0x2597854, size 0x34, virtual false, abstract: false, final false
  static inline ::StringW FormatMonth(int32_t month, int32_t repeatCount, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method FormatHebrewMonthName, addr 0x2597888, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseQuoteString, addr 0x2597948, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseNextChar, addr 0x2597af8, size 0x70, virtual false, abstract: false, final false
  static inline int32_t ParseNextChar(::System::ReadOnlySpan_1<char16_t> format, int32_t pos);

  /// @brief Method IsUseGenitiveForm, addr 0x2597b68, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomized, addr 0x2597cb4, size 0x10cc, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomizedTimeZone, addr 0x2598d80, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomizedRoundripTimeZone, addr 0x259909c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method Append2DigitNumber, addr 0x2599298, size 0x5c, virtual false, abstract: false, final false
  static inline void Append2DigitNumber(::System::Text::StringBuilder* result, int32_t val);

  /// @brief Method GetRealFormat, addr 0x25992f4, size 0x2a8, virtual false, abstract: false, final false
  static inline ::StringW GetRealFormat(::System::ReadOnlySpan_1<char16_t> format, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method ExpandPredefinedFormat, addr 0x259959c, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x2591368, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW Format(::System::DateTime dateTime, ::StringW format, ::System::IFormatProvider* provider);

  /// @brief Method Format, addr 0x2594410, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormat, addr 0x25915c8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormat, addr 0x2594900, size 0x210, virtual false, abstract: false, final false
  static inline bool TryFormat(::System::DateTime dateTime, ::System::Span_1<char16_t> destination, ByRef<int32_t> charsWritten, ::System::ReadOnlySpan_1<char16_t> format,
                               ::System::IFormatProvider* provider, ::System::TimeSpan offset);

  /// @brief Method FormatStringBuilder, addr 0x259a230, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatO, addr 0x2599910, size 0x508, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatR, addr 0x2599e18, size 0x418, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteTwoDecimalDigits, addr 0x259a53c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvalidFormatForLocal, addr 0x259990c, size 0x4, virtual false, abstract: false, final false
