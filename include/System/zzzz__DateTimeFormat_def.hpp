...
public:
  ...
  /// @brief Method Append2DigitNumber, addr 0x5c309d0, size 0x54, virtual false, abstract: false, final false
  static inline void Append2DigitNumber(::System::Text::StringBuilder* result, int32_t val);

  /// @brief Method ExpandPredefinedFormat, addr 0x5c30da8, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x5c27c08, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW Format(::System::DateTime dateTime, ::StringW format, ::System::IFormatProvider* provider);

  /// @brief Method Format, addr 0x5c2b8cc, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomized, addr 0x5c2f04c, size 0x11c0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomizedRoundripTimeZone, addr 0x5c306b4, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomizedTimeZone, addr 0x5c3020c, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatDayOfWeek, addr 0x5c2eb84, size 0x3c, virtual false, abstract: false, final false
  static inline ::StringW FormatDayOfWeek(int32_t dayOfWeek, int32_t repeat, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method FormatDigits, addr 0x5c2e8ec, size 0x74, virtual false, abstract: false, final false
  static inline void FormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t value, int32_t len);

  /// @brief Method FormatDigits, addr 0x5c2e960, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatHebrewMonthName, addr 0x5c2ebfc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatMonth, addr 0x5c2ebc0, size 0x3c, virtual false, abstract: false, final false
  static inline ::StringW FormatMonth(int32_t month, int32_t repeatCount, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method FormatStringBuilder, addr 0x5c319f0, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRealFormat, addr 0x5c30a24, size 0x384, virtual false, abstract: false, final false
  static inline ::StringW GetRealFormat(::System::ReadOnlySpan_1<char16_t> format, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method HebrewFormatDigits, addr 0x5c2ea68, size 0x80, virtual false, abstract: false, final false
  static inline void HebrewFormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t digits);

  /// @brief Method InvalidFormatForLocal, addr 0x5c31128, size 0x4, virtual false, abstract: false, final false
  static inline void InvalidFormatForLocal(::System::ReadOnlySpan_1<char16_t> format, ::System::DateTime dateTime);

  /// @brief Method IsUseGenitiveForm, addr 0x5c2eee0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseNextChar, addr 0x5c2ee68, size 0x78, virtual false, abstract: false, final false
  static inline int32_t ParseNextChar(::System::ReadOnlySpan_1<char16_t> format, int32_t pos);

  /// @brief Method ParseQuoteString, addr 0x5c2ecbc, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseRepeatPattern, addr 0x5c2eae8, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t ParseRepeatPattern(::System::ReadOnlySpan_1<char16_t> format, int32_t pos, char16_t patternChar);

  /// @brief Method TryFormat, addr 0x5c27e7c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormat, addr 0x5c2be60, size 0x230, virtual false, abstract: false, final false
  static inline bool TryFormat(::System::DateTime dateTime, ::System::Span_1<char16_t> destination, ::by_ref<int32_t> charsWritten, ::System::ReadOnlySpan_1<char16_t> format,
                               ::System::IFormatProvider* provider, ::System::TimeSpan offset);

  /// @brief Method TryFormatO, addr 0x5c3112c, size 0x544, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatR, addr 0x5c31670, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDigits, addr 0x5c31e24, size 0xac, virtual false, abstract: false, final false
  static inline void WriteDigits(uint64_t value, ::System::Span_1<char16_t> buffer);

  /// @brief Method WriteFourDecimalDigits, addr 0x5c31d84, size 0xa0, virtual false, abstract: false, final false
  static inline void WriteFourDecimalDigits(uint32_t value, ::System::Span_1<char16_t> buffer, int32_t startingIndex);

  /// @brief Method WriteTwoDecimalDigits, addr 0x5c31d38, size 0x4c, virtual false, abstract: false, final false
