...
public:
  ...
  /// @brief Method Append2DigitNumber, addr 0x3dd72fc, size 0x5c, virtual false, abstract: false, final false
  static inline void Append2DigitNumber(::System::Text::StringBuilder* result, int32_t val);

  /// @brief Method ExpandPredefinedFormat, addr 0x3dd75fc, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method Format, addr 0x3dce904, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW Format(::System::DateTime dateTime, ::StringW format, ::System::IFormatProvider* provider);

  /// @brief Method Format, addr 0x3dd2644, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomized, addr 0x3dd5bc8, size 0x1138, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomizedRoundripTimeZone, addr 0x3dd70ac, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatCustomizedTimeZone, addr 0x3dd6d00, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatDayOfWeek, addr 0x3dd5730, size 0x34, virtual false, abstract: false, final false
  static inline ::StringW FormatDayOfWeek(int32_t dayOfWeek, int32_t repeat, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method FormatDigits, addr 0x3dd54c4, size 0x70, virtual false, abstract: false, final false
  static inline void FormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t value, int32_t len);

  /// @brief Method FormatDigits, addr 0x3dd5534, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatHebrewMonthName, addr 0x3dd5798, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method FormatMonth, addr 0x3dd5764, size 0x34, virtual false, abstract: false, final false
  static inline ::StringW FormatMonth(int32_t month, int32_t repeatCount, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method FormatStringBuilder, addr 0x3dd81dc, size 0x330, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRealFormat, addr 0x3dd7358, size 0x2a4, virtual false, abstract: false, final false
  static inline ::StringW GetRealFormat(::System::ReadOnlySpan_1<char16_t> format, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method HebrewFormatDigits, addr 0x3dd562c, size 0x7c, virtual false, abstract: false, final false
  static inline void HebrewFormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t digits);

  /// @brief Method InvalidFormatForLocal, addr 0x3dd7998, size 0x4, virtual false, abstract: false, final false
  static inline void InvalidFormatForLocal(::System::ReadOnlySpan_1<char16_t> format, ::System::DateTime dateTime);

  /// @brief Method IsUseGenitiveForm, addr 0x3dd5a70, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseNextChar, addr 0x3dd5a00, size 0x70, virtual false, abstract: false, final false
  static inline int32_t ParseNextChar(::System::ReadOnlySpan_1<char16_t> format, int32_t pos);

  /// @brief Method ParseQuoteString, addr 0x3dd5858, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseRepeatPattern, addr 0x3dd56a8, size 0x88, virtual false, abstract: false, final false
  static inline int32_t ParseRepeatPattern(::System::ReadOnlySpan_1<char16_t> format, int32_t pos, char16_t patternChar);

  /// @brief Method TryFormat, addr 0x3dceb64, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormat, addr 0x3dd2b80, size 0x20c, virtual false, abstract: false, final false
  static inline bool TryFormat(::System::DateTime dateTime, ::System::Span_1<char16_t> destination, ::ByRef<int32_t> charsWritten, ::System::ReadOnlySpan_1<char16_t> format,
                               ::System::IFormatProvider* provider, ::System::TimeSpan offset);

  /// @brief Method TryFormatO, addr 0x3dd799c, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFormatR, addr 0x3dd7e78, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteDigits, addr 0x3dd85f8, size 0xac, virtual false, abstract: false, final false
  static inline void WriteDigits(uint64_t value, ::System::Span_1<char16_t> buffer);

  /// @brief Method WriteFourDecimalDigits, addr 0x3dd8558, size 0xa0, virtual false, abstract: false, final false
  static inline void WriteFourDecimalDigits(uint32_t value, ::System::Span_1<char16_t> buffer, int32_t startingIndex);

  /// @brief Method WriteTwoDecimalDigits, addr 0x3dd850c, size 0x4c, virtual false, abstract: false, final false
