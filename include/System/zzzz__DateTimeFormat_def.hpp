...
public:
  ...
  /// @brief Method FormatDigits addr 0x243bf84 size 0x70 virtual false final false
  static inline void FormatDigits(::System::Text::StringBuilder* outputBuffer, int32_t value, int32_t len);

  /// @brief Method FormatDigits addr 0x243bff4 size 0xf8 virtual false final false
  ...
  /// @brief Method ParseQuoteString addr 0x243c308 size 0x1b0 virtual false final false
  ...
  /// @brief Method ParseNextChar addr 0x243c4b8 size 0x70 virtual false final false
  static inline int32_t ParseNextChar(::System::ReadOnlySpan_1<char16_t> format, int32_t pos);

  /// @brief Method IsUseGenitiveForm addr 0x243c528 size 0x14c virtual false final false
  ...
  /// @brief Method FormatCustomized addr 0x243c674 size 0x10cc virtual false final false
  ...
  /// @brief Method FormatCustomizedTimeZone addr 0x243d740 size 0x31c virtual false final false
  ...
  /// @brief Method FormatCustomizedRoundripTimeZone addr 0x243da5c size 0x1fc virtual false final false
  ...
  /// @brief Method Append2DigitNumber addr 0x243dc58 size 0x5c virtual false final false
  static inline void Append2DigitNumber(::System::Text::StringBuilder* result, int32_t val);

  /// @brief Method GetRealFormat addr 0x243dcb4 size 0x2a8 virtual false final false
  static inline ::StringW GetRealFormat(::System::ReadOnlySpan_1<char16_t> format, ::System::Globalization::DateTimeFormatInfo* dtfi);

  /// @brief Method ExpandPredefinedFormat addr 0x243df5c size 0x370 virtual false final false
  ...
  /// @brief Method Format addr 0x2435d28 size 0x78 virtual false final false
  static inline ::StringW Format(::System::DateTime dateTime, ::StringW format, ::System::IFormatProvider* provider);

  /// @brief Method Format addr 0x2438dd0 size 0x2d0 virtual false final false
  ...
  /// @brief Method TryFormat addr 0x2435f88 size 0xb8 virtual false final false
  ...
  /// @brief Method TryFormat addr 0x24392c0 size 0x210 virtual false final false
  static inline bool TryFormat(::System::DateTime dateTime, ::System::Span_1<char16_t> destination, ByRef<int32_t> charsWritten, ::System::ReadOnlySpan_1<char16_t> format,
                               ::System::IFormatProvider* provider, ::System::TimeSpan offset);

  /// @brief Method FormatStringBuilder addr 0x243ebf0 size 0x30c virtual false final false
  ...
  /// @brief Method TryFormatO addr 0x243e2d0 size 0x508 virtual false final false
  ...
  /// @brief Method TryFormatR addr 0x243e7d8 size 0x418 virtual false final false
  ...
  /// @brief Method WriteTwoDecimalDigits addr 0x243eefc size 0x4c virtual false final false
  static inline void WriteTwoDecimalDigits(uint32_t value, ::System::Span_1<char16_t> destination, int32_t offset);

  /// @brief Method WriteFourDecimalDigits addr 0x243ef48 size 0xa0 virtual false final false
  static inline void WriteFourDecimalDigits(uint32_t value, ::System::Span_1<char16_t> buffer, int32_t startingIndex);

  /// @brief Method WriteDigits addr 0x243efe8 size 0xac virtual false final false
  static inline void WriteDigits(uint64_t value, ::System::Span_1<char16_t> buffer);

  /// @brief Method InvalidFormatForLocal addr 0x243e2cc size 0x4 virtual false final false
