...
public:
  ...
  /// @brief Method CompareTo, addr 0x2829410, size 0xdc, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Guid value);

  /// @brief Method CompareTo, addr 0x2829284, size 0x18c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* value);

  /// @brief Method EatAllWhitespace, addr 0x2828570, size 0x23c, virtual false, abstract: false, final false
  static inline ::System::ReadOnlySpan_1<char16_t> EatAllWhitespace(::System::ReadOnlySpan_1<char16_t> str);

  /// @brief Method Equals, addr 0x2829230, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::System::Guid g);

  /// @brief Method Equals, addr 0x2829188, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x2829170, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetResult, addr 0x2829274, size 0x10, virtual false, abstract: false, final false
  inline int32_t GetResult(uint32_t me, uint32_t them);

  /// @brief Method HexToChar, addr 0x2829570, size 0x1c, virtual false, abstract: false, final false
  static inline char16_t HexToChar(int32_t a);

  /// @brief Method HexsToChars, addr 0x282958c, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t HexsToChars(::cordl_internals::Ptr<char16_t> guidChars, int32_t a, int32_t b);

  /// @brief Method HexsToCharsHexOutput, addr 0x2829608, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t HexsToCharsHexOutput(::cordl_internals::Ptr<char16_t> guidChars, int32_t a, int32_t b);

  /// @brief Method IsHexPrefix, addr 0x28287ac, size 0xcc, virtual false, abstract: false, final false
  static inline bool IsHexPrefix(::System::ReadOnlySpan_1<char16_t> str, int32_t i);

  /// @brief Method NewGuid, addr 0x2826cc0, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Guid NewGuid();

  /// @brief Method Parse, addr 0x2827500, size 0x98, virtual false, abstract: false, final false
  static inline ::System::Guid Parse(::StringW input);

  /// @brief Method Parse, addr 0x2827598, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Guid Parse(::System::ReadOnlySpan_1<char16_t> input);

  /// @brief Method StringToInt, addr 0x2828a48, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToInt, addr 0x2828884, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToLong, addr 0x28288f4, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToShort, addr 0x2828c3c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToShort, addr 0x28288b0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method System.ISpanFormattable.TryFormat, addr 0x2829ac8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method ToByteArray, addr 0x2828d90, size 0x17c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToByteArray();

  /// @brief Method ToString, addr 0x2828f0c, size 0x48, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x282956c, size 0x4, virtual false, abstract: false, final false
  inline ::StringW ToString(::StringW format);

  /// @brief Method ToString, addr 0x2828f54, size 0x21c, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* provider);

  /// @brief Method TryFormat, addr 0x28296a4, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParse, addr 0x28275fc, size 0x90, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW input, ByRef<::System::Guid> result);

  /// @brief Method TryParse, addr 0x282768c, size 0x50, virtual false, abstract: false, final false
  static inline bool TryParse(::System::ReadOnlySpan_1<char16_t> input, ByRef<::System::Guid> result);

  /// @brief Method TryParseExact, addr 0x28276dc, size 0xc4, virtual false, abstract: false, final false
  static inline bool TryParseExact(::StringW input, ::StringW format, ByRef<::System::Guid> result);

  /// @brief Method TryParseExact, addr 0x28277a0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseGuid, addr 0x282713c, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseGuidWithDashes, addr 0x282790c, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseGuidWithHexPrefix, addr 0x2827bd0, size 0x674, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseGuidWithNoStyle, addr 0x2828244, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteByteHelper, addr 0x2828c80, size 0x110, virtual false, abstract: false, final false
  inline void WriteByteHelper(::System::Span_1<uint8_t> destination);

  /// @brief Method .ctor, addr 0x2826ecc, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(int32_t a, int16_t b, int16_t c, ::ArrayW<uint8_t, ::Array<uint8_t>*> d);

  /// @brief Method .ctor, addr 0x2827008, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2826d0c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> b);

  /// @brief Method .ctor, addr 0x2826da4, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::System::ReadOnlySpan_1<uint8_t> b);

  /// @brief Method .ctor, addr 0x2827048, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x28294ec, size 0x40, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Guid a, ::System::Guid b);

  /// @brief Method op_Inequality, addr 0x282952c, size 0x40, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetGuidParseException, addr 0x2827384, size 0x17c, virtual false, abstract: false, final false
  inline ::System::Exception* GetGuidParseException();

  /// @brief Method Init, addr 0x2829acc, size 0x8, virtual false, abstract: false, final false
  inline void Init(::System::__Guid__GuidParseThrowStyle canThrow);

  /// @brief Method SetFailure, addr 0x28278fc, size 0x10, virtual false, abstract: false, final false
  inline void SetFailure(::System::__Guid__ParseFailureKind failure, ::StringW failureMessageID);

  /// @brief Method SetFailure, addr 0x2828878, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFailure, addr 0x2828530, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFailure, addr 0x2828c70, size 0x10, virtual false, abstract: false, final false
