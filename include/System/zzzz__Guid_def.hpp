...
/// @brief Method CompareTo, addr 0x5b06e14, size 0xd0, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Guid  value) ;

/// @brief Method CompareTo, addr 0x5b06c88, size 0x18c, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  value) ;

/// @brief Method EatAllWhitespace, addr 0x5b0607c, size 0x250, virtual false, abstract: false, final false
static inline ::System::ReadOnlySpan_1<char16_t> EatAllWhitespace(::System::ReadOnlySpan_1<char16_t>  str) ;

/// @brief Method Equals, addr 0x5b06c34, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::System::Guid  g) ;

/// @brief Method Equals, addr 0x5b06b88, size 0xac, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method GetHashCode, addr 0x5b06b6c, size 0x1c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetResult, addr 0x5b06c78, size 0x10, virtual false, abstract: false, final false
inline int32_t GetResult(uint32_t  me, uint32_t  them) ;

/// @brief Method HexToChar, addr 0x5b06f38, size 0x1c, virtual false, abstract: false, final false
static inline char16_t HexToChar(int32_t  a) ;

/// @brief Method HexsToChars, addr 0x5b06f54, size 0x7c, virtual false, abstract: false, final false
static inline int32_t HexsToChars(char16_t*  guidChars, int32_t  a, int32_t  b) ;

/// @brief Method HexsToCharsHexOutput, addr 0x5b06fd0, size 0x9c, virtual false, abstract: false, final false
static inline int32_t HexsToCharsHexOutput(char16_t*  guidChars, int32_t  a, int32_t  b) ;

/// @brief Method IsHexPrefix, addr 0x5b062cc, size 0xc4, virtual false, abstract: false, final false
static inline bool IsHexPrefix(::System::ReadOnlySpan_1<char16_t>  str, int32_t  i) ;

/// @brief Method NewGuid, addr 0x5b049e0, size 0x4c, virtual false, abstract: false, final false
static inline ::System::Guid NewGuid() ;

/// @brief Method Parse, addr 0x5b050ec, size 0x94, virtual false, abstract: false, final false
static inline ::System::Guid Parse(::StringW  input) ;

/// @brief Method Parse, addr 0x5b05180, size 0x64, virtual false, abstract: false, final false
static inline ::System::Guid Parse(::System::ReadOnlySpan_1<char16_t>  input) ;

/// @brief Method StringToInt, addr 0x5b06564, size 0x1fc, virtual false, abstract: false, final false
...
/// @brief Method StringToInt, addr 0x5b0639c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method StringToLong, addr 0x5b0640c, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method StringToShort, addr 0x5b06760, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method StringToShort, addr 0x5b063c8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method System.ISpanFormattable.TryFormat, addr 0x5b07488, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method ToByteArray, addr 0x5b068b4, size 0x94, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ToByteArray() ;

/// @brief Method ToString, addr 0x5b06948, size 0x4c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x5b06f34, size 0x4, virtual false, abstract: false, final false
inline ::StringW ToString(::StringW  format) ;

/// @brief Method ToString, addr 0x5b06994, size 0x1d8, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  provider) ;

/// @brief Method TryFormat, addr 0x5b0706c, size 0x41c, virtual false, abstract: false, final false
...
/// @brief Method TryParse, addr 0x5b051e4, size 0x94, virtual false, abstract: false, final false
static inline bool TryParse(::StringW  input, ::ByRef<::System::Guid>  result) ;

/// @brief Method TryParse, addr 0x5b05278, size 0x4c, virtual false, abstract: false, final false
static inline bool TryParse(::System::ReadOnlySpan_1<char16_t>  input, ::ByRef<::System::Guid>  result) ;

/// @brief Method TryParseExact, addr 0x5b052c4, size 0x8c, virtual false, abstract: false, final false
static inline bool TryParseExact(::StringW  input, ::StringW  format, ::ByRef<::System::Guid>  result) ;

/// @brief Method TryParseExact, addr 0x5b05350, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method TryParseGuid, addr 0x5b04d20, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method TryParseGuidWithDashes, addr 0x5b054b4, size 0x2a8, virtual false, abstract: false, final false
static inline bool TryParseGuidWithDashes(::System::ReadOnlySpan_1<char16_t>  guidString, ::ByRef<::System::Guid_GuidResult>  result) ;

/// @brief Method TryParseGuidWithHexPrefix, addr 0x5b0575c, size 0x5fc, virtual false, abstract: false, final false
...
/// @brief Method TryParseGuidWithNoStyle, addr 0x5b05d58, size 0x2e8, virtual false, abstract: false, final false
static inline bool TryParseGuidWithNoStyle(::System::ReadOnlySpan_1<char16_t>  guidString, ::ByRef<::System::Guid_GuidResult>  result) ;

/// @brief Method WriteByteHelper, addr 0x5b067a4, size 0x110, virtual false, abstract: false, final false
inline void WriteByteHelper(::System::Span_1<uint8_t>  destination) ;

/// @brief Method .ctor, addr 0x5b04bfc, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b04a2c, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  b) ;

/// @brief Method .ctor, addr 0x5b04ad0, size 0x12c, virtual false, abstract: false, final false
inline void _ctor(::System::ReadOnlySpan_1<uint8_t>  b) ;

/// @brief Method .ctor, addr 0x5b04c3c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x5b06ee4, size 0x28, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Guid  a, ::System::Guid  b) ;

/// @brief Method op_Inequality, addr 0x5b06f0c, size 0x28, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetGuidParseException, addr 0x5b04f7c, size 0x170, virtual false, abstract: false, final false
inline ::System::Exception* GetGuidParseException() ;

/// @brief Method Init, addr 0x5b0748c, size 0x8, virtual false, abstract: false, final false
inline void Init(::System::Guid_GuidParseThrowStyle  canThrow) ;

/// @brief Method SetFailure, addr 0x5b054a4, size 0x10, virtual false, abstract: false, final false
inline void SetFailure(::System::Guid_ParseFailureKind  failure, ::StringW  failureMessageID) ;

/// @brief Method SetFailure, addr 0x5b06390, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method SetFailure, addr 0x5b06040, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method SetFailure, addr 0x5b06794, size 0x10, virtual false, abstract: false, final false
