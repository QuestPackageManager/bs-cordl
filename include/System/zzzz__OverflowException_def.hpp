...
public:
  ...
  /// @brief Method .ctor addr 0x24611b0 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::OverflowException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x246120c size 0x24 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::System::OverflowException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor addr 0x2461230 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2461254 size 0x8 virtual false final false
