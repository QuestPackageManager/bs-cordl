...
public:
  ...
  /// @brief Method .ctor, addr 0x25dfff0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::OverflowException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25e004c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  static inline ::System::OverflowException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x25e0070, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25e0094, size 0x8, virtual false, abstract: false, final false
