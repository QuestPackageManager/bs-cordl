...
public:
  // Declarations
  /// @brief Method IndexOfAny, addr 0x25c2a6c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x25c2aec, size 0x298, virtual false, abstract: false, final false
  static inline int32_t IndexOf(ByRef<uint8_t> searchSpace, uint8_t value, int32_t length);

  /// @brief Method SequenceEqual, addr 0x25c2d84, size 0x1c8, virtual false, abstract: false, final false
  static inline bool SequenceEqual(ByRef<uint8_t> first, ByRef<uint8_t> second, uint64_t length);

  /// @brief Method SequenceCompareTo, addr 0x25c2f4c, size 0x4d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x25c341c, size 0x73c, virtual false, abstract: false, final false
  static inline int32_t IndexOf(ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method LastIndexOf, addr 0x25c3b58, size 0x6e4, virtual false, abstract: false, final false
  static inline int32_t LastIndexOf(ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method LocateFirstFoundChar, addr 0x25c423c, size 0x1c0, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateFirstFoundChar, addr 0x25c43fc, size 0x20, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(uint64_t match);

  /// @brief Method LocateLastFoundChar, addr 0x25c441c, size 0x1c0, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateLastFoundChar, addr 0x25c45dc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithCultureHelper, addr 0x25c4608, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithCultureIgnoreCaseHelper, addr 0x25c4808, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithOrdinalIgnoreCaseHelper, addr 0x25c4928, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearWithoutReferences, addr 0x25c4a08, size 0x1e8, virtual false, abstract: false, final false
  static inline void ClearWithoutReferences(ByRef<uint8_t> b, uint64_t byteLength);

  /// @brief Method ClearWithReferences, addr 0x25c4bf0, size 0x150, virtual false, abstract: false, final false
