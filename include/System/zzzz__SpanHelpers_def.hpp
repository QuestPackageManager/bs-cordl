...
public:
  // Declarations
  /// @brief Method ClearWithReferences, addr 0x2979964, size 0x150, virtual false, abstract: false, final false
  static inline void ClearWithReferences(ByRef<::System::IntPtr> ip, uint64_t pointerSizeLength);

  /// @brief Method ClearWithoutReferences, addr 0x297977c, size 0x1e8, virtual false, abstract: false, final false
  static inline void ClearWithoutReferences(ByRef<uint8_t> b, uint64_t byteLength);

  /// @brief Method EndsWithCultureHelper, addr 0x297937c, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithCultureIgnoreCaseHelper, addr 0x297957c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithOrdinalIgnoreCaseHelper, addr 0x297969c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x2978190, size 0x73c, virtual false, abstract: false, final false
  static inline int32_t IndexOf(ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method IndexOf, addr 0x2977860, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfAny, addr 0x29777e0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOf, addr 0x29788cc, size 0x6e4, virtual false, abstract: false, final false
  static inline int32_t LastIndexOf(ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method LocateFirstFoundChar, addr 0x2978fb0, size 0x1c0, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateFirstFoundChar, addr 0x2979170, size 0x20, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(uint64_t match);

  /// @brief Method LocateLastFoundChar, addr 0x2979190, size 0x1c0, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateLastFoundChar, addr 0x2979350, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(uint64_t match);

  /// @brief Method SequenceCompareTo, addr 0x2977cc0, size 0x4d0, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceEqual, addr 0x2977af8, size 0x1c8, virtual false, abstract: false, final false
