...
public:
  // Declarations
  /// @brief Method IndexOfAny addr 0x2465b44 size 0x80 virtual false final false
  ...
  /// @brief Method IndexOf addr 0x2465bc4 size 0x298 virtual false final false
  static inline int32_t IndexOf(ByRef<uint8_t> searchSpace, uint8_t value, int32_t length);

  /// @brief Method SequenceEqual addr 0x2465e5c size 0x1c8 virtual false final false
  static inline bool SequenceEqual(ByRef<uint8_t> first, ByRef<uint8_t> second, uint64_t length);

  /// @brief Method SequenceCompareTo addr 0x2466024 size 0x4d0 virtual false final false
  ...
  /// @brief Method IndexOf addr 0x24664f4 size 0x73c virtual false final false
  static inline int32_t IndexOf(ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method LastIndexOf addr 0x2466c30 size 0x6e4 virtual false final false
  static inline int32_t LastIndexOf(ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method LocateFirstFoundChar addr 0x2467314 size 0x1c0 virtual false final false
  static inline int32_t LocateFirstFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateFirstFoundChar addr 0x24674d4 size 0x20 virtual false final false
  static inline int32_t LocateFirstFoundChar(uint64_t match);

  /// @brief Method LocateLastFoundChar addr 0x24674f4 size 0x1c0 virtual false final false
  static inline int32_t LocateLastFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateLastFoundChar addr 0x24676b4 size 0x2c virtual false final false
  ...
  /// @brief Method EndsWithCultureHelper addr 0x24676e0 size 0x200 virtual false final false
  ...
  /// @brief Method EndsWithCultureIgnoreCaseHelper addr 0x24678e0 size 0x120 virtual false final false
  ...
  /// @brief Method EndsWithOrdinalIgnoreCaseHelper addr 0x2467a00 size 0xe0 virtual false final false
  ...
  /// @brief Method ClearWithoutReferences addr 0x2467ae0 size 0x1e8 virtual false final false
  static inline void ClearWithoutReferences(ByRef<uint8_t> b, uint64_t byteLength);

  /// @brief Method ClearWithReferences addr 0x2467cc8 size 0x150 virtual false final false
