...
public:
  // Declarations
  /// @brief Method ClearWithReferences, addr 0x3dff334, size 0x150, virtual false, abstract: false, final false
  static inline void ClearWithReferences(::ByRef<::System::IntPtr> ip, uint64_t pointerSizeLength);

  /// @brief Method ClearWithoutReferences, addr 0x3dff14c, size 0x1e8, virtual false, abstract: false, final false
  static inline void ClearWithoutReferences(::ByRef<uint8_t> b, uint64_t byteLength);

  /// @brief Method EndsWithCultureHelper, addr 0x3dfee10, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithCultureIgnoreCaseHelper, addr 0x3dfef48, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithOrdinalIgnoreCaseHelper, addr 0x3dff068, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x3dfde78, size 0x5f0, virtual false, abstract: false, final false
  static inline int32_t IndexOf(::ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method IndexOf, addr 0x3dfd520, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfAny, addr 0x3dfd4a0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOf, addr 0x3dfe468, size 0x5a4, virtual false, abstract: false, final false
  static inline int32_t LastIndexOf(::ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method LocateFirstFoundChar, addr 0x3dfea0c, size 0x1dc, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateFirstFoundChar, addr 0x3dfebe8, size 0x20, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(uint64_t match);

  /// @brief Method LocateLastFoundChar, addr 0x3dfec08, size 0x1dc, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateLastFoundChar, addr 0x3dfede4, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(uint64_t match);

  /// @brief Method SequenceCompareTo, addr 0x3dfd938, size 0x540, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceEqual, addr 0x3dfd7c8, size 0x170, virtual false, abstract: false, final false
