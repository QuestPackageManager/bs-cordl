...
public:
  // Declarations
  /// @brief Method ClearWithReferences, addr 0x5c5b590, size 0x70, virtual false, abstract: false, final false
  static inline void ClearWithReferences(::by_ref<::System::IntPtr> ip, uint64_t pointerSizeLength);

  /// @brief Method ClearWithoutReferences, addr 0x5c5b364, size 0x22c, virtual false, abstract: false, final false
  static inline void ClearWithoutReferences(::by_ref<uint8_t> b, uint64_t byteLength);

  /// @brief Method EndsWithCultureHelper, addr 0x5c5af80, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithCultureIgnoreCaseHelper, addr 0x5c5b12c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithOrdinalIgnoreCaseHelper, addr 0x5c5b26c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x5c5a818, size 0x160, virtual false, abstract: false, final false
  static inline int32_t IndexOf(::by_ref<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method IndexOf, addr 0x5c5a3a4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x5c5a478, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfAny, addr 0x5c5a5d0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOf, addr 0x5c5a978, size 0x198, virtual false, abstract: false, final false
  static inline int32_t LastIndexOf(::by_ref<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method LocateFirstFoundChar, addr 0x5c5ab10, size 0x214, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateFirstFoundChar, addr 0x5c5ad24, size 0x20, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(uint64_t match);

  /// @brief Method LocateLastFoundChar, addr 0x5c5ad44, size 0x210, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateLastFoundChar, addr 0x5c5af54, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(uint64_t match);

  /// @brief Method SequenceCompareTo, addr 0x5c5a6d8, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceEqual, addr 0x5c5a64c, size 0x8c, virtual false, abstract: false, final false
