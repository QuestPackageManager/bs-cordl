...
public:
  // Declarations
  /// @brief Method ClearWithReferences, addr 0x5b1fd40, size 0x70, virtual false, abstract: false, final false
  static inline void ClearWithReferences(::ByRef<::System::IntPtr> ip, uint64_t pointerSizeLength);

  /// @brief Method ClearWithoutReferences, addr 0x5b1fb14, size 0x22c, virtual false, abstract: false, final false
  static inline void ClearWithoutReferences(::ByRef<uint8_t> b, uint64_t byteLength);

  /// @brief Method EndsWithCultureHelper, addr 0x5b1f730, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithCultureIgnoreCaseHelper, addr 0x5b1f8dc, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method EndsWithOrdinalIgnoreCaseHelper, addr 0x5b1fa1c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x5b1efc8, size 0x160, virtual false, abstract: false, final false
  static inline int32_t IndexOf(::ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method IndexOf, addr 0x5b1eb54, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x5b1ec28, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfAny, addr 0x5b1ed80, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOf, addr 0x5b1f128, size 0x198, virtual false, abstract: false, final false
  static inline int32_t LastIndexOf(::ByRef<char16_t> searchSpace, char16_t value, int32_t length);

  /// @brief Method LocateFirstFoundChar, addr 0x5b1f2c0, size 0x214, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateFirstFoundChar, addr 0x5b1f4d4, size 0x20, virtual false, abstract: false, final false
  static inline int32_t LocateFirstFoundChar(uint64_t match);

  /// @brief Method LocateLastFoundChar, addr 0x5b1f4f4, size 0x210, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(::System::Numerics::Vector_1<uint16_t> match);

  /// @brief Method LocateLastFoundChar, addr 0x5b1f704, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t LocateLastFoundChar(uint64_t match);

  /// @brief Method SequenceCompareTo, addr 0x5b1ee88, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceEqual, addr 0x5b1edfc, size 0x8c, virtual false, abstract: false, final false
