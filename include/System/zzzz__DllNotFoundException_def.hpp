...
public:
  ...
  /// @brief Method .ctor, addr 0x25b75a4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::DllNotFoundException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25b7600, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b7624, size 0x8, virtual false, abstract: false, final false
