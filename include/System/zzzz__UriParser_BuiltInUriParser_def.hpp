...
public:
  ...
  /// @brief Method .ctor, addr 0x6378c50, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UriParser_BuiltInUriParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UriParser_BuiltInUriParser(UriParser_BuiltInUriParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UriParser_BuiltInUriParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UriParser_BuiltInUriParser(UriParser_BuiltInUriParserconst&) = delete;
