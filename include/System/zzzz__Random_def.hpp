...
public:
  ...
  /// @brief Method GenerateGlobalSeed, addr 0x2845354, size 0x24, virtual false, abstract: false, final false
  static inline int32_t GenerateGlobalSeed();

  /// @brief Method GenerateSeed, addr 0x2844f34, size 0x1c0, virtual false, abstract: false, final false
  static inline int32_t GenerateSeed();

  /// @brief Method GetSampleForLargeRange, addr 0x284537c, size 0x4c, virtual false, abstract: false, final false
  inline double_t GetSampleForLargeRange();

  /// @brief Method InternalSample, addr 0x28452c4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Next, addr 0x2845378, size 0x4, virtual true, abstract: false, final false
  inline int32_t Next();

  /// @brief Method Next, addr 0x28454e4, size 0xc8, virtual true, abstract: false, final false
  inline int32_t Next(int32_t maxValue);

  /// @brief Method Next, addr 0x28453c8, size 0x11c, virtual true, abstract: false, final false
  inline int32_t Next(int32_t minValue, int32_t maxValue);

  /// @brief Method NextBytes, addr 0x28455b8, size 0xb0, virtual true, abstract: false, final false
  inline void NextBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method NextDouble, addr 0x28455ac, size 0xc, virtual true, abstract: false, final false
  inline double_t NextDouble();

  /// @brief Method Sample, addr 0x28452a4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2844ed8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x28450f4, size 0x1b0, virtual false, abstract: false, final false
