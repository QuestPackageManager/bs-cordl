...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IgnoreSection", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IgnoreSection(IgnoreSection&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IgnoreSection", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IgnoreSection(IgnoreSectionconst&) = delete;
