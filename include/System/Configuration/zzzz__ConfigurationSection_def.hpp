...
public:
  // Declarations
  /// @brief Method DeserializeSection, addr 0x5da2da0, size 0x3c, virtual true, abstract: false, final false
  inline void DeserializeSection(::System::Xml::XmlReader* reader);

  /// @brief Method IsModified, addr 0x5da2ddc, size 0x3c, virtual true, abstract: false, final false
  inline bool IsModified();

  /// @brief Method ResetModified, addr 0x5da2e18, size 0x3c, virtual true, abstract: false, final false
  inline void ResetModified();

  /// @brief Method SerializeSection, addr 0x5da2e54, size 0x3c, virtual true, abstract: false, final false
