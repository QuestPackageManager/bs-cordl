...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16433))
...
public:
  // Declarations
  /// @brief Method DeserializeSection, addr 0x2811220, size 0x38, virtual true, abstract: false, final false
  inline void DeserializeSection(::System::Xml::XmlReader* reader);

  /// @brief Method IsModified, addr 0x2811258, size 0x38, virtual true, abstract: false, final false
  inline bool IsModified();

  /// @brief Method ResetModified, addr 0x2811290, size 0x38, virtual true, abstract: false, final false
  inline void ResetModified();

  /// @brief Method SerializeSection, addr 0x28112c8, size 0x38, virtual true, abstract: false, final false
