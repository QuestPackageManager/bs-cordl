...
public:
  // Declarations
  /// @brief Method DeserializeSection addr 0x280ca38 size 0x38 virtual true final false
  inline void DeserializeSection(::System::Xml::XmlReader* reader);

  /// @brief Method IsModified addr 0x280ca70 size 0x38 virtual true final false
  inline bool IsModified();

  /// @brief Method ResetModified addr 0x280caa8 size 0x38 virtual true final false
  inline void ResetModified();

  /// @brief Method SerializeSection addr 0x280cae0 size 0x38 virtual true final false
