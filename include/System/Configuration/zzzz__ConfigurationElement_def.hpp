...
public:
  ...
  /// @brief Method IsModified, addr 0x5f5202c, size 0x3c, virtual true, abstract: false, final false
  inline bool IsModified();

  /// @brief Method Reset, addr 0x5f52068, size 0x3c, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentElement);

  /// @brief Method ResetModified, addr 0x5f520a4, size 0x3c, virtual true, abstract: false, final false
  inline void ResetModified();

  /// @brief Method get_Properties, addr 0x5f51ff0, size 0x3c, virtual true, abstract: false, final false
