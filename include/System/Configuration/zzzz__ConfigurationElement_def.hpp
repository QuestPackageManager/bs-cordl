...
public:
  ...
  /// @brief Method IsModified, addr 0x408d044, size 0x38, virtual true, abstract: false, final false
  inline bool IsModified();

  /// @brief Method Reset, addr 0x408d07c, size 0x38, virtual true, abstract: false, final false
  inline void Reset(::System::Configuration::ConfigurationElement* parentElement);

  /// @brief Method ResetModified, addr 0x408d0b4, size 0x38, virtual true, abstract: false, final false
  inline void ResetModified();

  /// @brief Method get_Properties, addr 0x408d00c, size 0x38, virtual true, abstract: false, final false
