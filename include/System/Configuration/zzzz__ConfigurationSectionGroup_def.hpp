...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConfigurationSectionGroup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConfigurationSectionGroup(ConfigurationSectionGroup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConfigurationSectionGroup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConfigurationSectionGroup(ConfigurationSectionGroupconst&) = delete;
