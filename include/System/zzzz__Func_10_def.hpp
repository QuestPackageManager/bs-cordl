...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Func_10);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Func_10, "System", "Func`10");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Func_10", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Func_10(Func_10&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Func_10", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Func_10(Func_10const&) = delete;
