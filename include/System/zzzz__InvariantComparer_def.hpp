...
public:
  ...
  /// @brief Method Compare, addr 0x6232ab0, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6232a3c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
