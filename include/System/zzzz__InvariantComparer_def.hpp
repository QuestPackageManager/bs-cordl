...
public:
  ...
  /// @brief Method Compare, addr 0x4417e48, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4417dcc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
