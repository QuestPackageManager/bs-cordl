...
// Write type traits
MARK_REF_T(::System::InvariantComparer*);
DEFINE_IL2CPP_CLASS(::System::InvariantComparer*, "System", "InvariantComparer");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvariantComparer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvariantComparer(InvariantComparer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvariantComparer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvariantComparer(InvariantComparerconst&) = delete;
...
static_assert(sizeof(::System::InvariantComparer) == 0x18, "Size mismatch!");
