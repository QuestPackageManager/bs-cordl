...
/// @brief Method Compare, addr 0x61c0aa4, size 0xe0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x61c0a30, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
