...
public:
  ...
  /// @brief Method Compare, addr 0x2f9ba78, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2f9b9fc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
