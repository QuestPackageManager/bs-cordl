...
public:
  ...
  /// @brief Method Compare, addr 0x4408f5c, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4408ee0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
