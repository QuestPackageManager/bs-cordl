...
public:
  // Declarations
  /// @brief Method BlockCopy, addr 0x3e139a4, size 0x1a8, virtual false, abstract: false, final false
  static inline void BlockCopy(::System::Array* src, int32_t srcOffset, ::System::Array* dst, int32_t dstOffset, int32_t count);

  /// @brief Method ByteLength, addr 0x3e13910, size 0x94, virtual false, abstract: false, final false
  static inline int32_t ByteLength(::System::Array* array);

  /// @brief Method IndexOfByte, addr 0x3e1365c, size 0x118, virtual false, abstract: false, final false
  static inline int32_t IndexOfByte(::cordl_internals::Ptr<uint8_t> src, uint8_t value, int32_t index, int32_t count);

  /// @brief Method InternalBlockCopy, addr 0x3e13658, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalMemcpy, addr 0x3e1390c, size 0x4, virtual false, abstract: false, final false
  static inline void InternalMemcpy(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t count);

  /// @brief Method Memcpy, addr 0x3e1382c, size 0xe0, virtual false, abstract: false, final false
  static inline void Memcpy(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t len);

  /// @brief Method Memcpy, addr 0x3e137fc, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Memmove, addr 0x3e13bd8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method MemoryCopy, addr 0x3e13b4c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ZeroMemory, addr 0x3e13778, size 0x84, virtual false, abstract: false, final false
  static inline void ZeroMemory(::cordl_internals::Ptr<uint8_t> src, int64_t len);

  /// @brief Method _ByteLength, addr 0x3e13774, size 0x4, virtual false, abstract: false, final false
  static inline int32_t _ByteLength(::System::Array* array);

  /// @brief Method memcpy1, addr 0x3e13ce8, size 0x9c, virtual false, abstract: false, final false
  static inline void memcpy1(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t size);

  /// @brief Method memcpy2, addr 0x3e13c7c, size 0x6c, virtual false, abstract: false, final false
  static inline void memcpy2(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t size);

  /// @brief Method memcpy4, addr 0x3e13c00, size 0x7c, virtual false, abstract: false, final false
