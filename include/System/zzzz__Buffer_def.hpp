...
public:
  // Declarations
  /// @brief Method InternalBlockCopy addr 0x247ffc8 size 0x4 virtual false final false
  ...
  /// @brief Method IndexOfByte addr 0x247ffcc size 0x110 virtual false final false
  static inline int32_t IndexOfByte(::cordl_internals::Ptr<uint8_t> src, uint8_t value, int32_t index, int32_t count);

  /// @brief Method _ByteLength addr 0x24800dc size 0x4 virtual false final false
  static inline int32_t _ByteLength(::System::Array* array);

  /// @brief Method ZeroMemory addr 0x24800e0 size 0x24 virtual false final false
  static inline void ZeroMemory(::cordl_internals::Ptr<uint8_t> src, int64_t len);

  /// @brief Method Memcpy addr 0x2480104 size 0x34 virtual false final false
  ...
  /// @brief Method InternalMemcpy addr 0x24801a4 size 0x4 virtual false final false
  static inline void InternalMemcpy(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t count);

  /// @brief Method ByteLength addr 0x24801a8 size 0x9c virtual false final false
  static inline int32_t ByteLength(::System::Array* array);

  /// @brief Method BlockCopy addr 0x2480244 size 0x1c0 virtual false final false
  static inline void BlockCopy(::System::Array* src, int32_t srcOffset, ::System::Array* dst, int32_t dstOffset, int32_t count);

  /// @brief Method MemoryCopy addr 0x2480404 size 0x80 virtual false final false
