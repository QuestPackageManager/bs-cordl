...
public:
// Declarations
/// @brief Method BlockCopy, addr 0x5ac5408, size 0x1a8, virtual false, abstract: false, final false
static inline void BlockCopy(::System::Array*  src, int32_t  srcOffset, ::System::Array*  dst, int32_t  dstOffset, int32_t  count) ;

/// @brief Method ByteLength, addr 0x5ac5374, size 0x94, virtual false, abstract: false, final false
static inline int32_t ByteLength(::System::Array*  array) ;

/// @brief Method IndexOfByte, addr 0x5ac50f0, size 0x124, virtual false, abstract: false, final false
static inline int32_t IndexOfByte(uint8_t*  src, uint8_t  value, int32_t  index, int32_t  count) ;

/// @brief Method InternalBlockCopy, addr 0x5ac50ec, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method InternalMemcpy, addr 0x5ac536c, size 0x8, virtual false, abstract: false, final false
static inline void InternalMemcpy(uint8_t*  dest, uint8_t*  src, int32_t  count) ;

/// @brief Method Memcpy, addr 0x5ac5270, size 0xfc, virtual false, abstract: false, final false
static inline void Memcpy(uint8_t*  dest, uint8_t*  src, int32_t  len) ;

/// @brief Method Memcpy, addr 0x5ac523c, size 0x34, virtual false, abstract: false, final false
static inline void Memcpy(uint8_t*  pDest, int32_t  destIndex, ::ArrayW<uint8_t,::Array<uint8_t>*>  src, int32_t  srcIndex, int32_t  len) ;

/// @brief Method Memmove, addr 0x5ac56ac, size 0x28, virtual false, abstract: false, final false
...
template<typename T>
static inline void Memmove(::ByRef<T>  destination, ::ByRef<T>  source, uint64_t  elementCount) ;

/// @brief Method MemoryCopy, addr 0x5ac55b0, size 0xfc, virtual false, abstract: false, final false
static inline void MemoryCopy(void*  source, void*  destination, int64_t  destinationSizeInBytes, int64_t  sourceBytesToCopy) ;

/// @brief Method ZeroMemory, addr 0x5ac5218, size 0x24, virtual false, abstract: false, final false
static inline void ZeroMemory(uint8_t*  src, int64_t  len) ;

/// @brief Method _ByteLength, addr 0x5ac5214, size 0x4, virtual false, abstract: false, final false
static inline int32_t _ByteLength(::System::Array*  array) ;

/// @brief Method memcpy1, addr 0x5ac57ec, size 0xb4, virtual false, abstract: false, final false
static inline void memcpy1(uint8_t*  dest, uint8_t*  src, int32_t  size) ;

/// @brief Method memcpy2, addr 0x5ac5768, size 0x84, virtual false, abstract: false, final false
static inline void memcpy2(uint8_t*  dest, uint8_t*  src, int32_t  size) ;

/// @brief Method memcpy4, addr 0x5ac56d4, size 0x94, virtual false, abstract: false, final false
