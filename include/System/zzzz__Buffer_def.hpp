...
public:
  // Declarations
  /// @brief Method BlockCopy, addr 0x3e170e8, size 0x1a8, virtual false, abstract: false, final false
  static inline void BlockCopy(::System::Array* src, int32_t srcOffset, ::System::Array* dst, int32_t dstOffset, int32_t count);

  /// @brief Method ByteLength, addr 0x3e17054, size 0x94, virtual false, abstract: false, final false
  static inline int32_t ByteLength(::System::Array* array);

  /// @brief Method IndexOfByte, addr 0x3e16da0, size 0x118, virtual false, abstract: false, final false
  static inline int32_t IndexOfByte(::cordl_internals::Ptr<uint8_t> src, uint8_t value, int32_t index, int32_t count);

  /// @brief Method InternalBlockCopy, addr 0x3e16d9c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalMemcpy, addr 0x3e17050, size 0x4, virtual false, abstract: false, final false
  static inline void InternalMemcpy(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t count);

  /// @brief Method Memcpy, addr 0x3e16f70, size 0xe0, virtual false, abstract: false, final false
  static inline void Memcpy(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t len);

  /// @brief Method Memcpy, addr 0x3e16f40, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Memmove, addr 0x3e1731c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method MemoryCopy, addr 0x3e17290, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ZeroMemory, addr 0x3e16ebc, size 0x84, virtual false, abstract: false, final false
  static inline void ZeroMemory(::cordl_internals::Ptr<uint8_t> src, int64_t len);

  /// @brief Method _ByteLength, addr 0x3e16eb8, size 0x4, virtual false, abstract: false, final false
  static inline int32_t _ByteLength(::System::Array* array);

  /// @brief Method memcpy1, addr 0x3e1742c, size 0x9c, virtual false, abstract: false, final false
  static inline void memcpy1(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t size);

  /// @brief Method memcpy2, addr 0x3e173c0, size 0x6c, virtual false, abstract: false, final false
  static inline void memcpy2(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t size);

  /// @brief Method memcpy4, addr 0x3e17344, size 0x7c, virtual false, abstract: false, final false
