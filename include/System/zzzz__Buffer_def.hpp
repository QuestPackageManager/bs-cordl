...
public:
  // Declarations
  /// @brief Method InternalBlockCopy, addr 0x25dbef0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfByte, addr 0x25dbef4, size 0x110, virtual false, abstract: false, final false
  static inline int32_t IndexOfByte(::cordl_internals::Ptr<uint8_t> src, uint8_t value, int32_t index, int32_t count);

  /// @brief Method _ByteLength, addr 0x25dc004, size 0x4, virtual false, abstract: false, final false
  static inline int32_t _ByteLength(::System::Array* array);

  /// @brief Method ZeroMemory, addr 0x25dc008, size 0x24, virtual false, abstract: false, final false
  static inline void ZeroMemory(::cordl_internals::Ptr<uint8_t> src, int64_t len);

  /// @brief Method Memcpy, addr 0x25dc02c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalMemcpy, addr 0x25dc0cc, size 0x4, virtual false, abstract: false, final false
  static inline void InternalMemcpy(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t count);

  /// @brief Method ByteLength, addr 0x25dc0d0, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t ByteLength(::System::Array* array);

  /// @brief Method BlockCopy, addr 0x25dc16c, size 0x1c0, virtual false, abstract: false, final false
  static inline void BlockCopy(::System::Array* src, int32_t srcOffset, ::System::Array* dst, int32_t dstOffset, int32_t count);

  /// @brief Method MemoryCopy, addr 0x25dc32c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method memcpy4, addr 0x25dc3d8, size 0x8c, virtual false, abstract: false, final false
  static inline void memcpy4(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t size);

  /// @brief Method memcpy2, addr 0x25dc464, size 0x7c, virtual false, abstract: false, final false
  static inline void memcpy2(::cordl_internals::Ptr<uint8_t> dest, ::cordl_internals::Ptr<uint8_t> src, int32_t size);

  /// @brief Method memcpy1, addr 0x25dc4e0, size 0xac, virtual false, abstract: false, final false
