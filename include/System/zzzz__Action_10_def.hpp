...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Action_10", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Action_10(Action_10&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Action_10", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Action_10(Action_10const&) = delete;
