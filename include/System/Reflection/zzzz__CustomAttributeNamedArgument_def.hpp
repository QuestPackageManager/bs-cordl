...
namespace System::Reflection {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(3500))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x250b9cc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x250b9f4, size 0x22c, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* memberInfo, ::System::Object* value);

  /// @brief Method .ctor, addr 0x250bc20, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* memberInfo, ::System::Reflection::CustomAttributeTypedArgument typedArgument);

  /// @brief Method get_TypedValue, addr 0x250bd44, size 0xc, virtual false, abstract: false, final false
  inline ::System::Reflection::CustomAttributeTypedArgument get_TypedValue();

  /// @brief Method get_IsField, addr 0x250bd50, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsField();

  /// @brief Method get_MemberName, addr 0x250bd58, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_MemberName();

  /// @brief Method get_MemberInfo, addr 0x250bd60, size 0x118, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_MemberInfo();

  /// @brief Method Equals, addr 0x250be78, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x250bef0, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality, addr 0x250bf5c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x250bfdc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x250c060, size 0x38c, virtual true, abstract: false, final false
