...
public:
  // Declarations
  /// @brief Method GetCustomAttribute, addr 0x3d2a5d8, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::Assembly* element, ::System::Type* attributeType);

  /// @brief Method GetCustomAttribute, addr 0x3d2a5e0, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::MemberInfo* element, ::System::Type* attributeType);

  /// @brief Method GetCustomAttribute, addr 0x3d2a5e8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x3d2a5f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x3d2a5fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x3d2a604, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x3d2a60c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDefined, addr 0x3d2a618, size 0x8, virtual false, abstract: false, final false
