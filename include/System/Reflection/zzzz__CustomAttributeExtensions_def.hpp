...
public:
  // Declarations
  /// @brief Method GetCustomAttribute, addr 0x2887838, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::Assembly* element, ::System::Type* attributeType);

  /// @brief Method GetCustomAttribute, addr 0x2887840, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::MemberInfo* element, ::System::Type* attributeType);

  /// @brief Method GetCustomAttribute, addr 0x2887848, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x2887854, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x288785c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x2887864, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x288786c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDefined, addr 0x2887878, size 0x8, virtual false, abstract: false, final false
