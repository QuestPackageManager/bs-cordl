...
public:
  // Declarations
  /// @brief Method GetCustomAttribute, addr 0x3d2a650, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::Assembly* element, ::System::Type* attributeType);

  /// @brief Method GetCustomAttribute, addr 0x3d2a658, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Attribute* GetCustomAttribute(::System::Reflection::MemberInfo* element, ::System::Type* attributeType);

  /// @brief Method GetCustomAttribute, addr 0x3d2a660, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x3d2a66c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x3d2a674, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x3d2a67c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCustomAttributes, addr 0x3d2a684, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDefined, addr 0x3d2a690, size 0x8, virtual false, abstract: false, final false
