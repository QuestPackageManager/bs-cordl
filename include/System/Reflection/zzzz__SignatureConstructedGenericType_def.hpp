...
public:
  ...
  /// @brief Method .ctor addr 0x2390608 size 0x1a4 virtual false final false
  inline void _ctor(::System::Type* genericTypeDefinition, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> typeArguments);

  /// @brief Method get_IsGenericTypeDefinition addr 0x2390804 size 0x8 virtual true final true
  inline bool get_IsGenericTypeDefinition();

  /// @brief Method HasElementTypeImpl addr 0x239080c size 0x8 virtual true final true
  inline bool HasElementTypeImpl();

  /// @brief Method IsArrayImpl addr 0x2390814 size 0x8 virtual true final true
  inline bool IsArrayImpl();

  /// @brief Method IsByRefImpl addr 0x239081c size 0x8 virtual true final true
  inline bool IsByRefImpl();

  /// @brief Method IsPointerImpl addr 0x2390824 size 0x8 virtual true final true
  inline bool IsPointerImpl();

  /// @brief Method get_IsSZArray addr 0x239082c size 0x8 virtual true final true
  inline bool get_IsSZArray();

  /// @brief Method get_IsVariableBoundArray addr 0x2390834 size 0x8 virtual true final true
  inline bool get_IsVariableBoundArray();

  /// @brief Method get_IsConstructedGenericType addr 0x239083c size 0x8 virtual true final true
  inline bool get_IsConstructedGenericType();

  /// @brief Method get_IsGenericParameter addr 0x2390844 size 0x8 virtual true final true
  inline bool get_IsGenericParameter();

  /// @brief Method get_IsGenericMethodParameter addr 0x239084c size 0x8 virtual true final true
  inline bool get_IsGenericMethodParameter();

  /// @brief Method get_ContainsGenericParameters addr 0x2390854 size 0x78 virtual true final true
  inline bool get_ContainsGenericParameters();

  /// @brief Method get_ElementType addr 0x23908cc size 0x8 virtual true final true
  inline ::System::Reflection::SignatureType* get_ElementType();

  /// @brief Method GetArrayRank addr 0x23908d4 size 0x50 virtual true final true
  inline int32_t GetArrayRank();

  /// @brief Method GetGenericTypeDefinition addr 0x2390924 size 0x8 virtual true final true
  inline ::System::Type* GetGenericTypeDefinition();

  /// @brief Method GetGenericArguments addr 0x239092c size 0x10 virtual true final true
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> GetGenericArguments();

  /// @brief Method get_GenericTypeArguments addr 0x239093c size 0x78 virtual true final true
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> get_GenericTypeArguments();

  /// @brief Method get_GenericParameterPosition addr 0x23909b4 size 0x50 virtual true final true
  inline int32_t get_GenericParameterPosition();

  /// @brief Method get_Name addr 0x2390a04 size 0x20 virtual true final true
  inline ::StringW get_Name();

  /// @brief Method get_Namespace addr 0x2390a24 size 0x24 virtual true final true
  inline ::StringW get_Namespace();

  /// @brief Method ToString addr 0x2390a48 size 0x124 virtual true final true
