...
public:
  ...
  /// @brief Method .ctor addr 0x238dcac size 0x60 virtual false final false
  inline void _ctor();

  static inline ::System::Reflection::InvalidFilterCriteriaException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x238dd0c size 0x28 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::System::Reflection::InvalidFilterCriteriaException* New_ctor(::StringW message, ::System::Exception* inner);

  /// @brief Method .ctor addr 0x238dd34 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x238dd58 size 0x8 virtual false final false
