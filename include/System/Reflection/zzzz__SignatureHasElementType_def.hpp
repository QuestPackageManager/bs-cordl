...
// Write type traits
MARK_REF_T(::System::Reflection::SignatureHasElementType*);
DEFINE_IL2CPP_CLASS(::System::Reflection::SignatureHasElementType*, "System.Reflection", "SignatureHasElementType");
...
public:
  ...
  /// @brief Method GetGenericArguments, addr 0x5b7fa28, size 0x98, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Type*> GetGenericArguments();

  /// @brief Method GetGenericTypeDefinition, addr 0x5b7f9dc, size 0x4c, virtual true, abstract: false, final true
  inline ::System::Type* GetGenericTypeDefinition();

  /// @brief Method HasElementTypeImpl, addr 0x5b7f994, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x5b7fc18, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b7f288, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::SignatureType* elementType);

  /// @brief Method get_ContainsGenericParameters, addr 0x5b7f9b4, size 0x20, virtual true, abstract: false, final true
  inline bool get_ContainsGenericParameters();

  /// @brief Method get_ElementType, addr 0x5b7f9d4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Reflection::SignatureType* get_ElementType();

  /// @brief Method get_GenericParameterPosition, addr 0x5b7fb58, size 0x4c, virtual true, abstract: false, final true
  inline int32_t get_GenericParameterPosition();

  /// @brief Method get_GenericTypeArguments, addr 0x5b7fac0, size 0x98, virtual true, abstract: false, final true
  inline ::ArrayW<::System::Type*> get_GenericTypeArguments();

  /// @brief Method get_IsConstructedGenericType, addr 0x5b7f99c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsConstructedGenericType();

  /// @brief Method get_IsGenericMethodParameter, addr 0x5b7f9ac, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsGenericMethodParameter();

  /// @brief Method get_IsGenericParameter, addr 0x5b7f9a4, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsGenericParameter();

  /// @brief Method get_IsGenericTypeDefinition, addr 0x5b7f98c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Name, addr 0x5b7fba4, size 0x54, virtual true, abstract: false, final true
  inline ::StringW get_Name();

  /// @brief Method get_Namespace, addr 0x5b7fbf8, size 0x20, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Reflection::SignatureHasElementType) == 0x20, "Size mismatch!");
