...
public:
  ...
  /// @brief Method .ctor addr 0x24ef43c size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_CodeBase addr 0x24eee4c size 0x40 virtual true final false
  inline ::StringW get_CodeBase();

  /// @brief Method get_FullName addr 0x24eee8c size 0x40 virtual true final false
  inline ::StringW get_FullName();

  /// @brief Method get_MonoAssembly addr 0x24eeecc size 0x40 virtual true final false
  inline void* get_MonoAssembly();

  /// @brief Method GetObjectData addr 0x24eef0c size 0x40 virtual true final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method IsDefined addr 0x24eef4c size 0x40 virtual true final false
  inline bool IsDefined(::System::Type* attributeType, bool inherit);

  /// @brief Method GetCustomAttributes addr 0x24eef8c size 0x40 virtual true final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetCustomAttributes(bool inherit);

  /// @brief Method GetCustomAttributes addr 0x24eefcc size 0x40 virtual true final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> GetCustomAttributes(::System::Type* attributeType, bool inherit);

  /// @brief Method GetTypes addr 0x24ef00c size 0x8 virtual true final false
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> GetTypes(bool exportedOnly);

  /// @brief Method GetTypes addr 0x24ef014 size 0x14 virtual true final false
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> GetTypes();

  /// @brief Method GetType addr 0x24ef028 size 0x18 virtual true final false
  inline ::System::Type* GetType(::StringW name);

  /// @brief Method InternalGetType addr 0x24ef040 size 0xc virtual false final false
  inline ::System::Type* InternalGetType(::System::Reflection::Module* module, ::StringW name, bool throwOnError, bool ignoreCase);

  /// @brief Method GetName addr 0x24ef04c size 0x40 virtual true final false
  inline ::System::Reflection::AssemblyName* GetName(bool copiedName);

  /// @brief Method GetName addr 0x24ef08c size 0x14 virtual true final false
  inline ::System::Reflection::AssemblyName* GetName();

  /// @brief Method ToString addr 0x24ef0a0 size 0x8 virtual true final false
  inline ::StringW ToString();

  /// @brief Method GetAssembly addr 0x24ef0a8 size 0xc8 virtual false final false
  static inline ::System::Reflection::Assembly* GetAssembly(::System::Type* type);

  /// @brief Method Load addr 0x24ef170 size 0x28 virtual false final false
  static inline ::System::Reflection::Assembly* Load(::StringW assemblyString);

  /// @brief Method ReflectionOnlyLoad addr 0x24ef198 size 0x48 virtual false final false
  static inline ::System::Reflection::Assembly* ReflectionOnlyLoad(::StringW assemblyString);

  /// @brief Method load_with_partial_name addr 0x24ef1e0 size 0x4 virtual false final false
  static inline ::System::Reflection::Assembly* load_with_partial_name(::StringW name, ::System::Security::Policy::Evidence* e);

  /// @brief Method LoadWithPartialName addr 0x24ef1e4 size 0x8 virtual false final false
  ...
  /// @brief Method LoadWithPartialName addr 0x24ef1ec size 0x78 virtual false final false
  ...
  /// @brief Method GetModulesInternal addr 0x24ef264 size 0x40 virtual true final false
  inline ::ArrayW<::System::Reflection::Module*, ::Array<::System::Reflection::Module*>*> GetModulesInternal();

  /// @brief Method GetExecutingAssembly addr 0x24ef2a4 size 0x40 virtual false final false
  static inline ::System::Reflection::Assembly* GetExecutingAssembly();

  /// @brief Method GetCallingAssembly addr 0x24e14b0 size 0x4 virtual false final false
  static inline ::System::Reflection::Assembly* GetCallingAssembly();

  /// @brief Method GetHashCode addr 0x24ef2e4 size 0x8 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x24ef2ec size 0x8 virtual true final false
  inline bool Equals(::System::Object* o);

  /// @brief Method CreateNIE addr 0x24ef2f4 size 0x74 virtual false final false
  static inline ::System::Exception* CreateNIE();

  /// @brief Method get_IsFullyTrusted addr 0x24ef368 size 0x8 virtual false final false
  inline bool get_IsFullyTrusted();

  /// @brief Method GetType addr 0x24ef370 size 0x24 virtual true final false
  inline ::System::Type* GetType(::StringW name, bool throwOnError, bool ignoreCase);

  /// @brief Method GetModule addr 0x24ef394 size 0x24 virtual true final false
  inline ::System::Reflection::Module* GetModule(::StringW name);

  /// @brief Method GetModules addr 0x24ef3b8 size 0x24 virtual true final false
  inline ::ArrayW<::System::Reflection::Module*, ::Array<::System::Reflection::Module*>*> GetModules(bool getResourceModules);

  /// @brief Method op_Equality addr 0x24e1348 size 0x50 virtual false final false
  static inline bool op_Equality(::System::Reflection::Assembly* left, ::System::Reflection::Assembly* right);

  /// @brief Method op_Inequality addr 0x24ef3dc size 0x58 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24ef434 size 0x8 virtual false final false
  inline void _ctor();
