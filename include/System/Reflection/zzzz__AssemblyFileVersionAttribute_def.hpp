...
public:
  ...
  /// @brief Method .ctor, addr 0x5b7d92c, size 0x58, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssemblyFileVersionAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssemblyFileVersionAttribute(AssemblyFileVersionAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssemblyFileVersionAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssemblyFileVersionAttribute(AssemblyFileVersionAttributeconst&) = delete;
