...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ICustomAttributeProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ICustomAttributeProvider(ICustomAttributeProviderconst&) = delete;
