...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b861b4, size 0x50, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetRealObject, addr 0x5b86204, size 0xb2c, virtual true, abstract: false, final false
  inline ::System::Object* GetRealObject(::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetSerializationInfo, addr 0x5b85bbc, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSerializationInfo, addr 0x5b85bac, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b85ecc, size 0x2e8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemberInfoSerializationHolder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemberInfoSerializationHolder(MemberInfoSerializationHolder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemberInfoSerializationHolder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemberInfoSerializationHolder(MemberInfoSerializationHolderconst&) = delete;
