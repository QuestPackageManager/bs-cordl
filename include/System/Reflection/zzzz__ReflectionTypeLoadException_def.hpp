...
public:
  ...
  /// @brief Method CreateString, addr 0x276a2bc, size 0x138, virtual false, abstract: false, final false
  inline ::StringW CreateString(bool isMessage);

  /// @brief Method GetObjectData, addr 0x276a184, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x276a3f4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x276a010, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Type*, ::Array<::System::Type*>*> classes, ::ArrayW<::System::Exception*, ::Array<::System::Exception*>*> exceptions);

  /// @brief Method .ctor, addr 0x276a04c, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_LoaderExceptions, addr 0x276a2ac, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Exception*, ::Array<::System::Exception*>*> get_LoaderExceptions();

  /// @brief Method get_Message, addr 0x276a2b4, size 0x8, virtual true, abstract: false, final false
