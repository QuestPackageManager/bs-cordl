...
public:
  ...
  /// @brief Method .ctor, addr 0x5b7d904, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssemblyConfigurationAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssemblyConfigurationAttribute(AssemblyConfigurationAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssemblyConfigurationAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssemblyConfigurationAttribute(AssemblyConfigurationAttributeconst&) = delete;
