...
public:
// Declarations
/// @brief Method Invoke, addr 0x5a42030, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a41ee8, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x5a41dbc, size 0xc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetAddMethod, addr 0x5a41c84, size 0x14, virtual true, abstract: false, final true
...
/// @brief Method GetEventFromHandle, addr 0x5a41e68, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x5a41dd4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method GetRemoveMethod, addr 0x5a41c98, size 0x14, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5a41c74, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EventHandlerType, addr 0x5a41cac, size 0x110, virtual true, abstract: false, final false
inline ::System::Type* get_EventHandlerType() ;

/// @brief Method get_MemberType, addr 0x5a41c7c, size 0x8, virtual true, abstract: false, final false
inline ::System::Reflection::MemberTypes get_MemberType() ;

/// @brief Method internal_from_handle_type, addr 0x5a41e64, size 0x4, virtual false, abstract: false, final false
static inline ::System::Reflection::EventInfo* internal_from_handle_type(::System::IntPtr  event_handle, ::System::IntPtr  type_handle) ;

/// @brief Method op_Equality, addr 0x5a41dfc, size 0x2c, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Reflection::EventInfo*  left, ::System::Reflection::EventInfo*  right) ;

/// @brief Method op_Inequality, addr 0x5a41e28, size 0x3c, virtual false, abstract: false, final false
