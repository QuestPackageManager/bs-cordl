...
public:
  ...
  /// @brief Method .ctor, addr 0x5a4133c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileName, addr 0x5a41350, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_FileName();

  /// @brief Method get_ReferencedAssembly, addr 0x5a41348, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::Assembly* get_ReferencedAssembly();

  /// @brief Method get_ResourceLocation, addr 0x5a41358, size 0x8, virtual true, abstract: false, final false
