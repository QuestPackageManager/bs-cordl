...
/// @brief Field <ReferencedAssembly>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__ReferencedAssembly_k__BackingField, put=__cordl_internal_set__ReferencedAssembly_k__BackingField)) ::System::Reflection::Assembly*  _ReferencedAssembly_k__BackingField;

/// @brief Field <ResourceLocation>k__BackingField, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get__ResourceLocation_k__BackingField, put=__cordl_internal_set__ResourceLocation_k__BackingField)) ::System::Reflection::ResourceLocation  _ResourceLocation_k__BackingField;

static inline ::System::Reflection::ManifestResourceInfo* New_ctor(::System::Reflection::Assembly*  containingAssembly, ::StringW  containingFileName, ::System::Reflection::ResourceLocation  resourceLocation) ;
...
/// @brief Method .ctor, addr 0x5a42eb4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_FileName, addr 0x5a42ec8, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_FileName() ;

/// @brief Method get_ReferencedAssembly, addr 0x5a42ec0, size 0x8, virtual true, abstract: false, final false
inline ::System::Reflection::Assembly* get_ReferencedAssembly() ;

/// @brief Method get_ResourceLocation, addr 0x5a42ed0, size 0x8, virtual true, abstract: false, final false
