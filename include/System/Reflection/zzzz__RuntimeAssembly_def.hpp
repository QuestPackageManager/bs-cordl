...
public:
  ...
  /// @brief Method Dispose, addr 0x5b8b9bc, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b8b754, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Equals, addr 0x5b8b8e8, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetAotId, addr 0x5b8b25c, size 0x50, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GetAotId();

  /// @brief Method GetAotIdInternal, addr 0x5b8b2ac, size 0x8, virtual false, abstract: false, final false
  static inline bool GetAotIdInternal(::ArrayW<uint8_t> aotid);

  /// @brief Method GetCodeBase, addr 0x5b8b2c8, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetCodeBase(::System::Reflection::Assembly* a, bool escaped);

  /// @brief Method GetCustomAttributes, addr 0x5b8b85c, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetCustomAttributes(::System::Type* attributeType, bool inherit);

  /// @brief Method GetCustomAttributes, addr 0x5b8b7f0, size 0x6c, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Object*> GetCustomAttributes(bool inherit);

  /// @brief Method GetHashCode, addr 0x5b8b8d4, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetManifestResourceInfo, addr 0x5b8b304, size 0x104, virtual true, abstract: false, final false
  inline ::System::Reflection::ManifestResourceInfo* GetManifestResourceInfo(::StringW resourceName);

  /// @brief Method GetManifestResourceInfoInternal, addr 0x5b8b300, size 0x4, virtual false, abstract: false, final false
  inline bool GetManifestResourceInfoInternal(::StringW name, ::System::Reflection::ManifestResourceInfo* info);

  /// @brief Method GetManifestResourceInternal, addr 0x5b8b40c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetManifestResourceNames, addr 0x5b8b408, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<::StringW> GetManifestResourceNames();

  /// @brief Method GetManifestResourceStream, addr 0x5b8b410, size 0x344, virtual true, abstract: false, final false
  inline ::System::IO::Stream* GetManifestResourceStream(::StringW name);

  /// @brief Method GetModule, addr 0x5b8af98, size 0x118, virtual true, abstract: false, final false
  inline ::System::Reflection::Module* GetModule(::StringW name);

  /// @brief Method GetModules, addr 0x5b8b0b4, size 0x1a8, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Reflection::Module*> GetModules(bool getResourceModules);

  /// @brief Method GetModulesInternal, addr 0x5b8b8d0, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Reflection::Module*> GetModulesInternal();

  /// @brief Method GetName, addr 0x5b8aed8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::AssemblyName* GetName(bool copiedName);

  /// @brief Method GetObjectData, addr 0x5b8ad94, size 0x88, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetReferencedAssemblies, addr 0x5b8b0b0, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Reflection::AssemblyName*> GetReferencedAssemblies();

  /// @brief Method GetType, addr 0x5b8aee0, size 0xb8, virtual true, abstract: false, final false
  inline ::System::Type* GetType(::StringW name, bool throwOnError, bool ignoreCase);

  /// @brief Method IsDefined, addr 0x5b8b77c, size 0x74, virtual true, abstract: false, final false
  inline bool IsDefined(::System::Type* attributeType, bool inherit);

  /// @brief Method LoadWithPartialNameInternal, addr 0x5b8aeb0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadWithPartialNameInternal, addr 0x5b8ae1c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5b8b990, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b8ad44, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CodeBase, addr 0x5b8b2cc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_CodeBase();

  /// @brief Method get_FullName, addr 0x5b8b2d4, size 0x4, virtual true, abstract: false, final false
  inline ::StringW get_FullName();

  /// @brief Method get_Location, addr 0x5b8b2e0, size 0x20, virtual true, abstract: false, final false
  inline ::StringW get_Location();

  /// @brief Method get_MonoAssembly, addr 0x5b8b2d8, size 0x8, virtual true, abstract: false, final false
  inline ::System::IntPtr get_MonoAssembly();

  /// @brief Method get_ReflectionOnly, addr 0x5b8b2c0, size 0x8, virtual true, abstract: false, final false
  inline bool get_ReflectionOnly();

  /// @brief Method get_code_base, addr 0x5b8b2b4, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW get_code_base(::System::Reflection::Assembly* a, bool escaped);

  /// @brief Method get_fullname, addr 0x5b8b2bc, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW get_fullname(::System::Reflection::Assembly* a);

  /// @brief Method get_location, addr 0x5b8b2b8, size 0x4, virtual false, abstract: false, final false
  inline ::StringW get_location();
