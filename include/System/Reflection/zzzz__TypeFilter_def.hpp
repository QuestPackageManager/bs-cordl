...
public:
// Declarations
/// @brief Method Invoke, addr 0x59d4aac, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59d0c20, size 0x148, virtual false, abstract: false, final false
