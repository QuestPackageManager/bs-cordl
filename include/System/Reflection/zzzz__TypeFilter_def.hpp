...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x25dd574, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d9e00, size 0x130, virtual false, abstract: false, final false
