...
public:
  ...
  /// @brief Method ToString, addr 0x3d2e304, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d2e2fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
