...
public:
  ...
  /// @brief Method ToString, addr 0x3d32a08, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d32a00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
