...
public:
  ...
  /// @brief Method ToString, addr 0x3d3b90c, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d3b904, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
