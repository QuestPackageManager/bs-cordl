...
public:
  ...
  /// @brief Method ToString, addr 0x5b8ac60, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b8ac5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocalVariableInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocalVariableInfo(LocalVariableInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocalVariableInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocalVariableInfo(LocalVariableInfoconst&) = delete;
