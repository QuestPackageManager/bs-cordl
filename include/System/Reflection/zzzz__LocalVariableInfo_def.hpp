...
public:
  ...
  /// @brief Method ToString, addr 0x59dac98, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59dac94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
