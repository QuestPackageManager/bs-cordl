...
public:
  ...
  /// @brief Method .ctor, addr 0x2508b54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_MemberType, addr 0x2508b5c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGetMethod, addr 0x2508b64, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method GetSetMethod, addr 0x2508b78, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method GetValue, addr 0x2508b8c, size 0x14, virtual false, abstract: false, final false
  inline ::System::Object* GetValue(::System::Object* obj);

  /// @brief Method GetValue, addr 0x2508ba0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x2508bc0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2508be0, size 0x8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2508be8, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality, addr 0x250712c, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Reflection::PropertyInfo* left, ::System::Reflection::PropertyInfo* right);

  /// @brief Method op_Inequality, addr 0x25070f0, size 0x3c, virtual false, abstract: false, final false
