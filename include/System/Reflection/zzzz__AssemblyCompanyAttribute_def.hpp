...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssemblyCompanyAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssemblyCompanyAttribute(AssemblyCompanyAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssemblyCompanyAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssemblyCompanyAttribute(AssemblyCompanyAttributeconst&) = delete;
