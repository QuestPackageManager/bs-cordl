...
public:
  ...
  /// @brief Method .ctor, addr 0x2505210, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_MemberType, addr 0x2505220, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::MemberTypes get_MemberType();

  /// @brief Method Invoke, addr 0x2505228, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2505248, size 0x8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2505258, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality, addr 0x2505268, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Reflection::ConstructorInfo* left, ::System::Reflection::ConstructorInfo* right);

  /// @brief Method op_Inequality, addr 0x2505294, size 0x94, virtual false, abstract: false, final false
