...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodBuilder(MethodBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodBuilder(MethodBuilderconst&) = delete;
