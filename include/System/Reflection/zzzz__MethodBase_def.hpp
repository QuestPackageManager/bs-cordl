...
public:
  ...
  /// @brief Method .ctor addr 0x238c608 size 0x8 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method get_CallingConvention addr 0x238e560 size 0x8 virtual true final false
  inline ::System::Reflection::CallingConventions get_CallingConvention();

  /// @brief Method get_IsAbstract addr 0x238e568 size 0x20 virtual true final true
  inline bool get_IsAbstract();

  /// @brief Method get_IsConstructor addr 0x238e588 size 0xa4 virtual true final true
  inline bool get_IsConstructor();

  /// @brief Method get_IsStatic addr 0x238e62c size 0x20 virtual true final true
  inline bool get_IsStatic();

  /// @brief Method get_IsVirtual addr 0x238e64c size 0x20 virtual true final true
  inline bool get_IsVirtual();

  /// @brief Method get_IsPublic addr 0x238e66c size 0x28 virtual true final true
  inline bool get_IsPublic();

  /// @brief Method get_IsGenericMethod addr 0x238e694 size 0x8 virtual true final false
  inline bool get_IsGenericMethod();

  /// @brief Method get_IsGenericMethodDefinition addr 0x238e69c size 0x8 virtual true final false
  inline bool get_IsGenericMethodDefinition();

  /// @brief Method GetGenericArguments addr 0x238e6a4 size 0x50 virtual true final false
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> GetGenericArguments();

  /// @brief Method get_ContainsGenericParameters addr 0x238e6f4 size 0x8 virtual true final false
  inline bool get_ContainsGenericParameters();

  /// @brief Method Invoke addr 0x238e6fc size 0x20 virtual true final true
  ...
  /// @brief Method get_IsSecurityCritical addr 0x238e71c size 0x28 virtual true final false
  inline bool get_IsSecurityCritical();

  /// @brief Method Equals addr 0x238c640 size 0x8 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x238c650 size 0x8 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality addr 0x238e32c size 0x1b4 virtual false final false
  static inline bool op_Equality(::System::Reflection::MethodBase* left, ::System::Reflection::MethodBase* right);

  /// @brief Method op_Inequality addr 0x238e314 size 0x18 virtual false final false
  static inline bool op_Inequality(::System::Reflection::MethodBase* left, ::System::Reflection::MethodBase* right);

  /// @brief Method GetParametersInternal addr 0x238e7ac size 0x10 virtual true final false
  inline ::ArrayW<::System::Reflection::ParameterInfo*, ::Array<::System::Reflection::ParameterInfo*>*> GetParametersInternal();

  /// @brief Method GetParametersCount addr 0x238e7bc size 0x28 virtual true final false
  inline int32_t GetParametersCount();

  /// @brief Method FormatNameAndSig addr 0x238e7e4 size 0x12c virtual true final false
  inline ::StringW FormatNameAndSig(bool serialization);

  /// @brief Method GetParameterTypes addr 0x238eafc size 0x108 virtual true final false
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> GetParameterTypes();

  /// @brief Method GetParametersNoCopy addr 0x238ec04 size 0x10 virtual true final false
  inline ::ArrayW<::System::Reflection::ParameterInfo*, ::Array<::System::Reflection::ParameterInfo*>*> GetParametersNoCopy();

  /// @brief Method GetMethodFromHandle addr 0x238ec14 size 0x208 virtual false final false
  static inline ::System::Reflection::MethodBase* GetMethodFromHandle(::System::RuntimeMethodHandle handle);

  /// @brief Method ConstructParameters addr 0x238e910 size 0x1ec virtual false final false
