...
public:
  ...
  /// @brief Method .ctor addr 0x24ec780 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::Reflection::TargetParameterCountException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x24ec7dc size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x24ec800 size 0x8 virtual false final false
