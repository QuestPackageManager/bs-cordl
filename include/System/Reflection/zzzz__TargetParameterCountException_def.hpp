...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TargetParameterCountException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TargetParameterCountException(TargetParameterCountException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TargetParameterCountException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TargetParameterCountException(TargetParameterCountExceptionconst&) = delete;
