...
public:
  ...
  /// @brief Method .ctor addr 0x2392cc8 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::System::Reflection::TargetParameterCountException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x2392d24 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2392d48 size 0x8 virtual false final false
