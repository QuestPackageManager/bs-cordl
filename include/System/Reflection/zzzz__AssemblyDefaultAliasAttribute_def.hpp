...
public:
  ...
  /// @brief Method .ctor, addr 0x5b7d914, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssemblyDefaultAliasAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssemblyDefaultAliasAttribute(AssemblyDefaultAliasAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssemblyDefaultAliasAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssemblyDefaultAliasAttribute(AssemblyDefaultAliasAttributeconst&) = delete;
