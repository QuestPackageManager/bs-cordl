...
public:
  ...
  /// @brief Method Clone, addr 0x5a4b788, size 0x9c, virtual true, abstract: false, final true
  inline ::System::Object* Clone();

  /// @brief Method ComputePublicKeyToken, addr 0x5a4b2f8, size 0xe4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ComputePublicKeyToken();

  /// @brief Method Create, addr 0x5a4b844, size 0xc4, virtual false, abstract: false, final false
  static inline ::System::Reflection::AssemblyName* Create(::System::Reflection::Assembly* assembly, bool fillCodebase);

  /// @brief Method FillName, addr 0x5a4a02c, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNativeName, addr 0x5a4b840, size 0x4, virtual false, abstract: false, final false
  static inline ::Mono::MonoAssemblyName* GetNativeName(::System::IntPtr assembly_ptr);

  /// @brief Method GetObjectData, addr 0x5a4b43c, size 0x34c, virtual true, abstract: false, final true
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetPublicKey, addr 0x5a4b184, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPublicKey();

  /// @brief Method GetPublicKeyToken, addr 0x5a4b18c, size 0xe8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPublicKeyToken();

  /// @brief Method InternalGetPublicKeyToken, addr 0x5a4b06c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserialization, addr 0x5a4b824, size 0x1c, virtual true, abstract: false, final true
  inline void OnDeserialization(::System::Object* sender);

  /// @brief Method ParseAssemblyName, addr 0x5a4a4a8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPublicKey, addr 0x5a49b24, size 0x20, virtual false, abstract: false, final false
  inline void SetPublicKey(::ArrayW<uint8_t, ::Array<uint8_t>*> publicKey);

  /// @brief Method ToString, addr 0x5a4b15c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a49b18, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a4a4ac, size 0x2d8, virtual false, abstract: false, final false
  inline void _ctor(::StringW assemblyName);

  /// @brief Method .ctor, addr 0x5a4a784, size 0x544, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* si, ::System::Runtime::Serialization::StreamingContext sc);

  /// @brief Method get_CultureInfo, addr 0x5a4acd8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_CultureInfo();

  /// @brief Method get_Flags, addr 0x5a4ace8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::AssemblyNameFlags get_Flags();

  /// @brief Method get_FullName, addr 0x5a4acf8, size 0x374, virtual false, abstract: false, final false
  inline ::StringW get_FullName();

  /// @brief Method get_IsPublicKeyValid, addr 0x5a4b274, size 0x84, virtual false, abstract: false, final false
  inline bool get_IsPublicKeyValid();

  /// @brief Method get_Name, addr 0x5a4acc8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Version, addr 0x5a4b154, size 0x8, virtual false, abstract: false, final false
  inline ::System::Version* get_Version();

  /// @brief Method get_public_token, addr 0x5a4b3dc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CultureInfo, addr 0x5a4ace0, size 0x8, virtual false, abstract: false, final false
  inline void set_CultureInfo(::System::Globalization::CultureInfo* value);

  /// @brief Method set_Flags, addr 0x5a4acf0, size 0x8, virtual false, abstract: false, final false
  inline void set_Flags(::System::Reflection::AssemblyNameFlags value);

  /// @brief Method set_Name, addr 0x5a4acd0, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Version, addr 0x5a49b44, size 0x1c, virtual false, abstract: false, final false
