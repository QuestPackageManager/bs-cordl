...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Reflection::AssemblyDefaultAliasAttribute::*)(::StringW)>(&::System::Reflection::AssemblyDefaultAliasAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5b7b614;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Reflection::AssemblyDefaultAliasAttribute*>(), { ".ctor", {}, { ::i2c::type_of<::StringW>() } })));
