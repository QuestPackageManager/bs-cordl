...
public:
  ...
  /// @brief Method System.Reflection.IReflectableType.GetTypeInfo, addr 0x3d365f8, size 0x4, virtual true, abstract: false, final true
  inline ::System::Reflection::TypeInfo* System_Reflection_IReflectableType_GetTypeInfo();

  /// @brief Method .ctor, addr 0x3d35f08, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ImplementedInterfaces, addr 0x3d365fc, size 0x10, virtual true, abstract: false, final false
