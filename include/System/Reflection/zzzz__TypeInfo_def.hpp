...
public:
  ...
  /// @brief Method System.Reflection.IReflectableType.GetTypeInfo, addr 0x286cb58, size 0x4, virtual true, abstract: false, final true
  inline ::System::Reflection::TypeInfo* System_Reflection_IReflectableType_GetTypeInfo();

  /// @brief Method .ctor, addr 0x286c490, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ImplementedInterfaces, addr 0x286cb5c, size 0x10, virtual true, abstract: false, final false
