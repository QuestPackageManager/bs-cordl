...
public:
  ...
  /// @brief Method .ctor, addr 0x5b7d99c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssemblyProductAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssemblyProductAttribute(AssemblyProductAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssemblyProductAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssemblyProductAttribute(AssemblyProductAttributeconst&) = delete;
