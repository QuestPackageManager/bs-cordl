...
// Some("{}") }, CppParam { name: "TargetMethods", ty: "::ArrayW<::System::Reflection::MethodInfo*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "InterfaceMethods", ty:
// "::ArrayW<::System::Reflection::MethodInfo*>", modifiers: "", def_value: Some("{}") }]
