...
/// @brief Method GetArrayRank, addr 0x59d1b34, size 0x8, virtual true, abstract: false, final true
inline int32_t GetArrayRank() ;

/// @brief Method IsArrayImpl, addr 0x59d1b04, size 0x8, virtual true, abstract: false, final true
inline bool IsArrayImpl() ;

/// @brief Method IsByRefImpl, addr 0x59d1b0c, size 0x8, virtual true, abstract: false, final true
inline bool IsByRefImpl() ;

/// @brief Method IsPointerImpl, addr 0x59d1b14, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x59d1a78, size 0x54, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::SignatureType*  elementType, int32_t  rank, bool  isMultiDim) ;

/// @brief Method get_IsSZArray, addr 0x59d1b1c, size 0x10, virtual true, abstract: false, final true
inline bool get_IsSZArray() ;

/// @brief Method get_IsVariableBoundArray, addr 0x59d1b2c, size 0x8, virtual true, abstract: false, final true
inline bool get_IsVariableBoundArray() ;

/// @brief Method get_Suffix, addr 0x59d1b3c, size 0xd4, virtual true, abstract: false, final true
