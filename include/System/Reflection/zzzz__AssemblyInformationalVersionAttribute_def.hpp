...
public:
  ...
  /// @brief Method .ctor, addr 0x5b7d984, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssemblyInformationalVersionAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssemblyInformationalVersionAttribute(AssemblyInformationalVersionAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssemblyInformationalVersionAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssemblyInformationalVersionAttribute(AssemblyInformationalVersionAttributeconst&) = delete;
