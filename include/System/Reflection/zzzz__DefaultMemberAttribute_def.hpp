...
public:
  ...
  /// @brief Method .ctor, addr 0x3d20c80, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW memberName);

  /// @brief Method get_MemberName, addr 0x3d20ca8, size 0x8, virtual false, abstract: false, final false
