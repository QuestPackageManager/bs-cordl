...
/// @brief Method .ctor, addr 0x59ce180, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  memberName) ;

/// @brief Method get_MemberName, addr 0x59ce188, size 0x8, virtual false, abstract: false, final false
