...
public:
  ...
  /// @brief Method .ctor, addr 0x59cdc74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW memberName);

  /// @brief Method get_MemberName, addr 0x59cdc7c, size 0x8, virtual false, abstract: false, final false
