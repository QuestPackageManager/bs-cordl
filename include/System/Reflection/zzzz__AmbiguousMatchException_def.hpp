...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AmbiguousMatchException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AmbiguousMatchException(AmbiguousMatchException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AmbiguousMatchException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AmbiguousMatchException(AmbiguousMatchExceptionconst&) = delete;
