...
public:
  ...
  /// @brief Method Equals, addr 0x3d24084, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x3d24094, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d23f1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_MetadataToken, addr 0x3d256f0, size 0x38, virtual true, abstract: false, final false
  inline int32_t get_MetadataToken();

  /// @brief Method get_Module, addr 0x3d2561c, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x3d25728, size 0x35c, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Reflection::MemberInfo* left, ::System::Reflection::MemberInfo* right);

  /// @brief Method op_Inequality, addr 0x3d25cb8, size 0x18, virtual false, abstract: false, final false
