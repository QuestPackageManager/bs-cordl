...
public:
  ...
  /// @brief Method Equals, addr 0x3d225d8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x3d225e8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3d22470, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_MetadataToken, addr 0x3d23c44, size 0x38, virtual true, abstract: false, final false
  inline int32_t get_MetadataToken();

  /// @brief Method get_Module, addr 0x3d23b70, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x3d23c7c, size 0x35c, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Reflection::MemberInfo* left, ::System::Reflection::MemberInfo* right);

  /// @brief Method op_Inequality, addr 0x3d2420c, size 0x18, virtual false, abstract: false, final false
