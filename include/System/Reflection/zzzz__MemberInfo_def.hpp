...
public:
  ...
  /// @brief Method Equals, addr 0x5b7ba98, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x5b7bab8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b7b948, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_MetadataToken, addr 0x5b7cd94, size 0x38, virtual true, abstract: false, final false
  inline int32_t get_MetadataToken();

  /// @brief Method get_Module, addr 0x5b7cd04, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5b7cdcc, size 0x308, virtual false, abstract: false, final false
  static inline bool op_Equality(::System::Reflection::MemberInfo* left, ::System::Reflection::MemberInfo* right);

  /// @brief Method op_Inequality, addr 0x5b7d308, size 0x18, virtual false, abstract: false, final false
