...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::AppDomainSetup::*)()>(&::System::AppDomainSetup::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x249b364;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> const& System::AppDomainSetup::__get__activationArguments() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____activationArguments;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> const& System::AppDomainSetup::__get_domain_initializer() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___domain_initializer;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> const& System::AppDomainSetup::__get_application_trust() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___application_trust;
}
...
inline void System::AppDomainSetup::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::AppDomainSetup*>::get(), ".ctor", std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
