...
public:
  ...
  /// @brief Method GetInternalName, addr 0x275b25c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x275b224, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName);

  /// @brief Method get_DisplayName, addr 0x275b22c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_InternalName, addr 0x275b234, size 0x28, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method FromDisplay, addr 0x275b1d0, size 0x54, virtual false, abstract: false, final false
