...
public:
  ...
  /// @brief Method GetInternalName, addr 0x2888f38, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2888f00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName);

  /// @brief Method get_DisplayName, addr 0x2888f08, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_InternalName, addr 0x2888f10, size 0x28, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method FromDisplay, addr 0x2888eac, size 0x54, virtual false, abstract: false, final false
