...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Nullable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Nullable(Nullable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Nullable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Nullable(Nullableconst&) = delete;
