...
public:
  // Declarations
  /// @brief Method GetMaxSizeForBucket, addr 0x2940c38, size 0xc, virtual false, abstract: false, final false
  static inline int32_t GetMaxSizeForBucket(int32_t binIndex);

  /// @brief Method SelectBucketIndex, addr 0x2940bbc, size 0x7c, virtual false, abstract: false, final false
