...
// Write type traits
MARK_REF_T(::System::Buffers::Utilities*);
DEFINE_IL2CPP_CLASS(::System::Buffers::Utilities*, "System.Buffers", "Utilities");
...
public:
  // Declarations
  /// @brief Method GetMaxSizeForBucket, addr 0x5bf4044, size 0xc, virtual false, abstract: false, final false
  static inline int32_t GetMaxSizeForBucket(int32_t binIndex);

  /// @brief Method SelectBucketIndex, addr 0x5bf3fc8, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  Utilities(Utilitiesconst&) = delete;
...
static_assert(sizeof(::System::Buffers::Utilities) == 0x10, "Size mismatch!");
