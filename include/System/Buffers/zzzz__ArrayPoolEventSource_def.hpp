...
/// @brief Method BufferAllocated, addr 0x5a44228, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method BufferRented, addr 0x5a44178, size 0xb0, virtual false, abstract: false, final false
inline void BufferRented(int32_t  bufferId, int32_t  bufferSize, int32_t  poolId, int32_t  bucketId) ;

/// @brief Method BufferReturned, addr 0x5a442e4, size 0x18, virtual false, abstract: false, final false
inline void BufferReturned(int32_t  bufferId, int32_t  bufferSize, int32_t  poolId) ;

/// @brief Method BufferTrimPoll, addr 0x5a44314, size 0x14, virtual false, abstract: false, final false
inline void BufferTrimPoll(int32_t  milliseconds, int32_t  pressure) ;

/// @brief Method BufferTrimmed, addr 0x5a442fc, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a4412c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
