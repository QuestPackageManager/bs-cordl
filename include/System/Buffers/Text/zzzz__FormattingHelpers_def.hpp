...
public:
// Declarations
/// @brief Method CountDigits, addr 0x5a44610, size 0x68, virtual false, abstract: false, final false
static inline int32_t CountDigits(uint32_t  value) ;

/// @brief Method CountDigits, addr 0x5a44534, size 0xdc, virtual false, abstract: false, final false
static inline int32_t CountDigits(uint64_t  value) ;

/// @brief Method CountHexDigits, addr 0x5a44678, size 0x48, virtual false, abstract: false, final false
