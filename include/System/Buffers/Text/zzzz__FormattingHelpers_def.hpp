...
public:
  // Declarations
  /// @brief Method CountDigits, addr 0x267fd80, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t CountDigits(uint32_t value);

  /// @brief Method CountDigits, addr 0x267fcc4, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t CountDigits(uint64_t value);

  /// @brief Method CountHexDigits, addr 0x267fdec, size 0x48, virtual false, abstract: false, final false
