...
public:
  // Declarations
  /// @brief Method CountDigits, addr 0x280c588, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t CountDigits(uint32_t value);

  /// @brief Method CountDigits, addr 0x280c4cc, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t CountDigits(uint64_t value);

  /// @brief Method CountHexDigits, addr 0x280c5f4, size 0x48, virtual false, abstract: false, final false
