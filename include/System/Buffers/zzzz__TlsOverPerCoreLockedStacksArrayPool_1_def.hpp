...
/// @brief Field _perCoreStacks, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__perCoreStacks, put=__cordl_internal_set__perCoreStacks)) ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*,::Array<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*>*>  _perCoreStacks;
...
constexpr ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*,::Array<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*>*> const& __cordl_internal_get__perCoreStacks() const;

constexpr ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*,::Array<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*>*>& __cordl_internal_get__perCoreStacks() ;

constexpr void __cordl_internal_set__perCoreStacks(::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*,::Array<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*>*>  value) ;
...
/// @brief Field _buckets, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__buckets, put=__cordl_internal_set__buckets)) ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*,::Array<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*>*>  _buckets;
...
/// @brief Field s_allTlsBuckets, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_allTlsBuckets, put=setStaticF_s_allTlsBuckets)) ::System::Runtime::CompilerServices::ConditionalWeakTable_2<::ArrayW<::ArrayW<T,::Array<T>*>,::Array<::ArrayW<T,::Array<T>*>>*>,::System::Object*>*  s_allTlsBuckets;
...
constexpr ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*,::Array<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*>*> const& __cordl_internal_get__buckets() const;

constexpr ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*,::Array<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*>*>& __cordl_internal_get__buckets() ;
...
constexpr void __cordl_internal_set__buckets(::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*,::Array<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*>*>  value) ;
