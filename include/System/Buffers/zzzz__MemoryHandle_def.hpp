...
public:
  ...
  /// @brief Method Dispose, addr 0x26e0e80, size 0xc8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x26e0e6c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Pointer, addr 0x26e0e78, size 0x8, virtual false, abstract: false, final false
