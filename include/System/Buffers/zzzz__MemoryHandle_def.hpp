...
public:
  ...
  /// @brief Method Dispose, addr 0x5ab63b8, size 0xc0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x5ab63a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(void* pointer, ::System::Runtime::InteropServices::GCHandle handle, ::System::Buffers::IPinnable* pinnable);

  /// @brief Method get_Pointer, addr 0x5ab63b0, size 0x8, virtual false, abstract: false, final false
