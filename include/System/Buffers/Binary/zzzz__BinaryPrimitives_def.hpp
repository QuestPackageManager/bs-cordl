...
public:
  // Declarations
  /// @brief Method ReverseEndianness, addr 0x3dce6f4, size 0x8, virtual false, abstract: false, final false
  static inline int32_t ReverseEndianness(int32_t value);

  /// @brief Method ReverseEndianness, addr 0x3dce6fc, size 0x8, virtual false, abstract: false, final false
  static inline int64_t ReverseEndianness(int64_t value);

  /// @brief Method ReverseEndianness, addr 0x3dce704, size 0xc, virtual false, abstract: false, final false
  static inline uint16_t ReverseEndianness(uint16_t value);

  /// @brief Method ReverseEndianness, addr 0x3dce710, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t ReverseEndianness(uint32_t value);

  /// @brief Method ReverseEndianness, addr 0x3dce718, size 0x8, virtual false, abstract: false, final false
