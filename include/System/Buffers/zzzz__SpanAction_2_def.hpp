...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Buffers::SpanAction_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Buffers::SpanAction_2, "System.Buffers", "SpanAction`2");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SpanAction_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SpanAction_2(SpanAction_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SpanAction_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SpanAction_2(SpanAction_2const&) = delete;
