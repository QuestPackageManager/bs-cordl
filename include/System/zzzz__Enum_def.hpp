...
public:
  // Declarations
  /// @brief Method GetEnumParseException, addr 0x3e1f7c8, size 0x16c, virtual false, abstract: false, final false
  inline ::System::Exception* GetEnumParseException();

  /// @brief Method Init, addr 0x3e1f10c, size 0x68, virtual false, abstract: false, final false
  inline void Init(bool canMethodThrow);

  /// @brief Method SetFailure, addr 0x3e1f970, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFailure, addr 0x3e1f934, size 0x3c, virtual false, abstract: false, final false
  inline void SetFailure(::GlobalNamespace::Enum_ParseFailureKind failure, ::StringW failureParameter);

  /// @brief Method SetFailure, addr 0x3e1ff70, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3e1e5a8, size 0x2c, virtual false, abstract: false, final false
