...
public:
  // Declarations
  /// @brief Method GetEnumParseException, addr 0x2736a4c, size 0x17c, virtual false, abstract: false, final false
  inline ::System::Exception* GetEnumParseException();

  /// @brief Method Init, addr 0x2736370, size 0x64, virtual false, abstract: false, final false
  inline void Init(bool canMethodThrow);

  /// @brief Method SetFailure, addr 0x2736c04, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFailure, addr 0x2736bc8, size 0x3c, virtual false, abstract: false, final false
  inline void SetFailure(::System::__Enum__ParseFailureKind failure, ::StringW failureParameter);

  /// @brief Method SetFailure, addr 0x27371c8, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x273580c, size 0x2c, virtual false, abstract: false, final false
