...
public:
  ...
  /// @brief Method GetLogicalOperationStack, addr 0x2fbe48c, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Collections::Stack* GetLogicalOperationStack();

  static inline ::System::Diagnostics::CorrelationManager* New_ctor();

  /// @brief Method .ctor, addr 0x2fbe480, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LogicalOperationStack, addr 0x2fbe488, size 0x4, virtual false, abstract: false, final false
