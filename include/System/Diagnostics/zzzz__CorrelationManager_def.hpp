...
public:
  ...
  /// @brief Method GetLogicalOperationStack, addr 0x61e1618, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Collections::Stack* GetLogicalOperationStack();

  static inline ::System::Diagnostics::CorrelationManager* New_ctor();

  /// @brief Method .ctor, addr 0x61e1610, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LogicalOperationStack, addr 0x61e1614, size 0x4, virtual false, abstract: false, final false
