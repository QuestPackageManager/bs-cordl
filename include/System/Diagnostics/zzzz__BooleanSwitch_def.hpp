...
public:
  ...
  /// @brief Method OnValueChanged, addr 0x61e13f8, size 0x68, virtual true, abstract: false, final false
  inline void OnValueChanged();

  /// @brief Method .ctor, addr 0x61e1324, size 0x70, virtual false, abstract: false, final false
