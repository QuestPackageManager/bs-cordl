...
public:
  ...
  /// @brief Method .ctor, addr 0x625ce78, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::StringW description);

  /// @brief Method get_Description, addr 0x625cedc, size 0x8, virtual true, abstract: false, final false
