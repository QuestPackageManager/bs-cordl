...
/// @brief Method .ctor, addr 0x61eae6c, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::StringW  description) ;

/// @brief Method get_Description, addr 0x61eaed0, size 0x8, virtual true, abstract: false, final false
