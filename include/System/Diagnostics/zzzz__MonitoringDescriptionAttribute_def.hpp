...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonitoringDescriptionAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonitoringDescriptionAttribute(MonitoringDescriptionAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonitoringDescriptionAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonitoringDescriptionAttribute(MonitoringDescriptionAttributeconst&) = delete;
