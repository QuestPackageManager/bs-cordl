...
/// @brief Method Create, addr 0x62318c8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x623188c, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
