...
public:
  ...
  /// @brief Method Create, addr 0x2f98ad8, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f98aa0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();
