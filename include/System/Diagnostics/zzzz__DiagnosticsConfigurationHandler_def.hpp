...
public:
  ...
  /// @brief Method Create, addr 0x4409408, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44093d0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();
