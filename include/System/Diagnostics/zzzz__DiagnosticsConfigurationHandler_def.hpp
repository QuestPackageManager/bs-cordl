...
public:
  ...
  /// @brief Method Create, addr 0x636c9c4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x636c988, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
