...
/// @brief Method Create, addr 0x61bdd44, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61bdd08, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
