...
// Write type traits
MARK_REF_T(::System::Diagnostics::Stopwatch*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::Stopwatch*, "System.Diagnostics", "Stopwatch");
...
public:
  ...
  /// @brief Method GetTimestamp, addr 0x63983b8, size 0x4, virtual false, abstract: false, final false
  static inline int64_t GetTimestamp();

  static inline ::System::Diagnostics::Stopwatch* New_ctor();

  /// @brief Method Reset, addr 0x63a06b8, size 0xc, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Restart, addr 0x63a0740, size 0x64, virtual false, abstract: false, final false
  inline void Restart();

  /// @brief Method Start, addr 0x63a0370, size 0x6c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartNew, addr 0x63a0310, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::Stopwatch* StartNew();

  /// @brief Method Stop, addr 0x63a06c4, size 0x7c, virtual false, abstract: false, final false
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x63a036c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Elapsed, addr 0x63a03dc, size 0xf8, virtual false, abstract: false, final false
  inline ::System::TimeSpan get_Elapsed();

  /// @brief Method get_ElapsedMilliseconds, addr 0x63a0548, size 0x168, virtual false, abstract: false, final false
  inline int64_t get_ElapsedMilliseconds();

  /// @brief Method get_ElapsedTicks, addr 0x63a04d4, size 0x74, virtual false, abstract: false, final false
  inline int64_t get_ElapsedTicks();

  /// @brief Method get_IsRunning, addr 0x63a06b0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Stopwatch", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Stopwatch(Stopwatch&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Stopwatch", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Stopwatch(Stopwatchconst&) = delete;
...
static_assert(sizeof(::System::Diagnostics::Stopwatch) == 0x28, "Size mismatch!");
