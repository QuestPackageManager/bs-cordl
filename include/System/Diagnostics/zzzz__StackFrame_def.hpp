...
/// @brief Method GetFileLineNumber, addr 0x5a31224, size 0x8, virtual true, abstract: false, final false
inline int32_t GetFileLineNumber() ;

/// @brief Method GetFileName, addr 0x5a3122c, size 0x8, virtual true, abstract: false, final false
inline ::StringW GetFileName() ;

/// @brief Method GetILOffset, addr 0x5a31310, size 0x8, virtual true, abstract: false, final false
inline int32_t GetILOffset() ;

/// @brief Method GetInternalMethodName, addr 0x5a31338, size 0x8, virtual false, abstract: false, final false
inline ::StringW GetInternalMethodName() ;

/// @brief Method GetMethod, addr 0x5a31318, size 0x8, virtual true, abstract: false, final false
inline ::System::Reflection::MethodBase* GetMethod() ;

/// @brief Method GetMethodAddress, addr 0x5a31328, size 0x8, virtual false, abstract: false, final false
inline int64_t GetMethodAddress() ;

/// @brief Method GetMethodIndex, addr 0x5a31330, size 0x8, virtual false, abstract: false, final false
inline uint32_t GetMethodIndex() ;

/// @brief Method GetNativeOffset, addr 0x5a31320, size 0x8, virtual true, abstract: false, final false
inline int32_t GetNativeOffset() ;

/// @brief Method GetSecureFileName, addr 0x5a31234, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x5a31340, size 0x22c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a311c8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5a311f4, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  skipFrames, bool  fNeedFileInfo) ;

/// @brief Method get_frame_info, addr 0x5a311c4, size 0x4, virtual false, abstract: false, final false
static inline bool get_frame_info(int32_t  skip, bool  needFileInfo, ::ByRef<::System::Reflection::MethodBase*>  method, ::ByRef<int32_t>  iloffset, ::ByRef<int32_t>  native_offset, ::ByRef<::StringW>  file, ::ByRef<int32_t>  line, ::ByRef<int32_t>  column) ;
