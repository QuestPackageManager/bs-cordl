...
public:
  ...
  /// @brief Method GetFileLineNumber, addr 0x27f8aac, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetFileLineNumber();

  /// @brief Method GetFileName, addr 0x27f8ab4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW GetFileName();

  /// @brief Method GetILOffset, addr 0x27f8b90, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetILOffset();

  /// @brief Method GetInternalMethodName, addr 0x27f8bb8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetInternalMethodName();

  /// @brief Method GetMethod, addr 0x27f8b98, size 0x8, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodBase* GetMethod();

  /// @brief Method GetMethodAddress, addr 0x27f8ba8, size 0x8, virtual false, abstract: false, final false
  inline int64_t GetMethodAddress();

  /// @brief Method GetMethodIndex, addr 0x27f8bb0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t GetMethodIndex();

  /// @brief Method GetNativeOffset, addr 0x27f8ba0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetNativeOffset();

  /// @brief Method GetSecureFileName, addr 0x27f8abc, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x27f8bc0, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27f89fc, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27f8a4c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(int32_t skipFrames, bool fNeedFileInfo);

  /// @brief Method get_frame_info, addr 0x27f89f4, size 0x8, virtual false, abstract: false, final false
