...
public:
  ...
  /// @brief Method .ctor, addr 0x5be0cd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Guid, addr 0x5be0cc0, size 0x8, virtual false, abstract: false, final false
  inline void set_Guid(::StringW value);

  /// @brief Method set_Name, addr 0x5be0cc8, size 0x8, virtual false, abstract: false, final false
