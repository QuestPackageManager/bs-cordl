...
/// @brief Method set_Guid, addr 0x5a33488, size 0x8, virtual false, abstract: false, final false
inline void set_Guid(::StringW  value) ;

/// @brief Method set_Name, addr 0x5a33490, size 0x8, virtual false, abstract: false, final false
