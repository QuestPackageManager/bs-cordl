...
public:
  ...
  /// @brief Method .ctor, addr 0x26d0850, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Guid, addr 0x26d0840, size 0x8, virtual false, abstract: false, final false
  inline void set_Guid(::StringW value);

  /// @brief Method set_Name, addr 0x26d0848, size 0x8, virtual false, abstract: false, final false
