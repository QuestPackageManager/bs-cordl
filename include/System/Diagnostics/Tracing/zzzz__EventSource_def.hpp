...
/// @brief Method set_DataPointer, addr 0x5a33470, size 0x8, virtual false, abstract: false, final false
inline void set_DataPointer(::System::IntPtr  value) ;

/// @brief Method set_Reserved, addr 0x5a33480, size 0x8, virtual false, abstract: false, final false
inline void set_Reserved(int32_t  value) ;

/// @brief Method set_Size, addr 0x5a33478, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x5a32dc8, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x5a32e38, size 0x4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x5a32d60, size 0x50, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method IsEnabled, addr 0x5a32db8, size 0x8, virtual false, abstract: false, final false
inline bool IsEnabled() ;

/// @brief Method IsEnabled, addr 0x5a32dc0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method WriteEvent, addr 0x5a32e3c, size 0x48, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId) ;

/// @brief Method WriteEvent, addr 0x5a32f38, size 0x90, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, ::StringW  arg1) ;

/// @brief Method WriteEvent, addr 0x5a3337c, size 0xf0, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, ::StringW  arg1, ::StringW  arg2, ::StringW  arg3) ;

/// @brief Method WriteEvent, addr 0x5a32e88, size 0xb0, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int32_t  arg1) ;

/// @brief Method WriteEvent, addr 0x5a32fc8, size 0xf0, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int32_t  arg1, int32_t  arg2) ;

/// @brief Method WriteEvent, addr 0x5a330b8, size 0x138, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int32_t  arg1, int32_t  arg2, int32_t  arg3) ;

/// @brief Method WriteEvent, addr 0x5a331f0, size 0xb0, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int64_t  arg1) ;

/// @brief Method WriteEvent, addr 0x5a332a0, size 0xdc, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int64_t  arg1, ::StringW  arg2) ;

/// @brief Method WriteEvent, addr 0x5a32e84, size 0x4, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  args) ;

/// @brief Method WriteEventCore, addr 0x5a3346c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a32d1c, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5a32d58, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Guid  eventSourceGuid, ::StringW  eventSourceName) ;

/// @brief Method .ctor, addr 0x5a32d50, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  eventSourceName) ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_Name, addr 0x5a32db0, size 0x8, virtual false, abstract: false, final false
