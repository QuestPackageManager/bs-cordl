...
public:
  ...
  /// @brief Method .ctor, addr 0x5be2fd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::Diagnostics::Tracing::NonEventAttribute) == 0x10, "Size mismatch!");
