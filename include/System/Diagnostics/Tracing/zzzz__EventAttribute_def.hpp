...
public:
  ...
  /// @brief Method .ctor, addr 0x5aa4cdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t eventId);

  /// @brief Method set_EventId, addr 0x5aa4ce4, size 0x8, virtual false, abstract: false, final false
  inline void set_EventId(int32_t value);

  /// @brief Method set_Keywords, addr 0x5aa4cf4, size 0x8, virtual false, abstract: false, final false
  inline void set_Keywords(::System::Diagnostics::Tracing::EventKeywords value);

  /// @brief Method set_Level, addr 0x5aa4cec, size 0x8, virtual false, abstract: false, final false
  inline void set_Level(::System::Diagnostics::Tracing::EventLevel value);

  /// @brief Method set_Message, addr 0x5aa4cfc, size 0x8, virtual false, abstract: false, final false
