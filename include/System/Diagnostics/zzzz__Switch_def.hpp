...
/// @brief Method Initialize, addr 0x61e2800, size 0x4, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeConfigSettings, addr 0x61e2804, size 0x8, virtual false, abstract: false, final false
inline bool InitializeConfigSettings() ;

/// @brief Method InitializeWithStatus, addr 0x61e26dc, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method OnSwitchSettingChanged, addr 0x61e280c, size 0x4, virtual true, abstract: false, final false
inline void OnSwitchSettingChanged() ;

/// @brief Method OnValueChanged, addr 0x61e1c4c, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61e1a54, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::StringW  displayName, ::StringW  description) ;

/// @brief Method .ctor, addr 0x61e1e18, size 0x234, virtual false, abstract: false, final false
inline void _ctor(::StringW  displayName, ::StringW  description, ::StringW  defaultSwitchValue) ;

/// @brief Method _pruneCachedSwitches, addr 0x61e21d0, size 0x50c, virtual false, abstract: false, final false
...
/// @brief Method get_IntializedLock, addr 0x61e2164, size 0x6c, virtual false, abstract: false, final false
inline ::System::Object* get_IntializedLock() ;

/// @brief Method get_SwitchSetting, addr 0x61e2050, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_SwitchSetting() ;

/// @brief Method get_Value, addr 0x61e1b20, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method set_SwitchSetting, addr 0x61e1b3c, size 0x110, virtual false, abstract: false, final false
