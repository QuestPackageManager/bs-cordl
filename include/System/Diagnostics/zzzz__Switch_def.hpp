...
public:
  ...
  /// @brief Method Initialize, addr 0x625480c, size 0x4, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeConfigSettings, addr 0x6254810, size 0x8, virtual false, abstract: false, final false
  inline bool InitializeConfigSettings();

  /// @brief Method InitializeWithStatus, addr 0x62546e8, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSwitchSettingChanged, addr 0x6254818, size 0x4, virtual true, abstract: false, final false
  inline void OnSwitchSettingChanged();

  /// @brief Method OnValueChanged, addr 0x6253c58, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6253a60, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName, ::StringW description);

  /// @brief Method .ctor, addr 0x6253e24, size 0x234, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName, ::StringW description, ::StringW defaultSwitchValue);

  /// @brief Method _pruneCachedSwitches, addr 0x62541dc, size 0x50c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IntializedLock, addr 0x6254170, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Object* get_IntializedLock();

  /// @brief Method get_SwitchSetting, addr 0x625405c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_SwitchSetting();

  /// @brief Method get_Value, addr 0x6253b2c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_SwitchSetting, addr 0x6253b48, size 0x110, virtual false, abstract: false, final false
