...
public:
  ...
  /// @brief Method Flush, addr 0x6257a64, size 0x6ec, virtual false, abstract: false, final false
  inline void Flush();

  /// @brief Method Initialize, addr 0x625780c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method NoConfigInit, addr 0x62578f4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6257080, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x6257088, size 0x278, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Diagnostics::SourceLevels defaultLevel);

  /// @brief Method _pruneCachedTraceSources, addr 0x6257300, size 0x50c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Listeners, addr 0x6258150, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Diagnostics::TraceListenerCollection* get_Listeners();

  /// @brief Method get_Switch, addr 0x625816c, size 0x1c, virtual false, abstract: false, final false
