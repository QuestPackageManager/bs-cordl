...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SourceSwitch", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SourceSwitch(SourceSwitch&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SourceSwitch", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SourceSwitch(SourceSwitchconst&) = delete;
