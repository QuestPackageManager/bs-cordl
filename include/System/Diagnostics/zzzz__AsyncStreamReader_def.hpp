...
public:
  ...
  /// @brief Method CancelOperation, addr 0x6258728, size 0xc, virtual false, abstract: false, final false
  inline void CancelOperation();

  /// @brief Method Close, addr 0x6258394, size 0x10, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x62583a4, size 0x384, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method WaitUtilEOF, addr 0x6258734, size 0x44, virtual false, abstract: false, final false
