...
public:
  ...
  /// @brief Method .ctor, addr 0x5be2fd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DisallowNullAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DisallowNullAttribute(DisallowNullAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DisallowNullAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DisallowNullAttribute(DisallowNullAttributeconst&) = delete;
