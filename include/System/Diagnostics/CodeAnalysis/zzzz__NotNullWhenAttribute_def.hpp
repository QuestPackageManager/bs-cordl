...
/// @brief Method .ctor, addr 0x5b985f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(bool  returnValue) ;

/// @brief Method get_ReturnValue, addr 0x5b985fc, size 0x8, virtual false, abstract: false, final false
