...
public:
  ...
  /// @brief Method .ctor, addr 0x3e77198, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool returnValue);

  /// @brief Method get_ReturnValue, addr 0x3e771c0, size 0x8, virtual false, abstract: false, final false
