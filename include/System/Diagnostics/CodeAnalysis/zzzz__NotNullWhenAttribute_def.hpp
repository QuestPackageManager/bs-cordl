...
public:
  ...
  /// [CompilerGenerated]
  /// @brief Method get_ReturnValue, addr 0x5cd2a4c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Diagnostics::CodeAnalysis::NotNullWhenAttribute) == 0x18, "Size mismatch!");
