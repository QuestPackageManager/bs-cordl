...
public:
  ...
  /// @brief Method .ctor, addr 0x29f2b54, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool returnValue);

  /// @brief Method get_ReturnValue, addr 0x29f2b7c, size 0x8, virtual false, abstract: false, final false
