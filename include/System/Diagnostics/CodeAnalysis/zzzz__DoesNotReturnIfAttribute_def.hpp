...
public:
  ...
  /// @brief Method .ctor, addr 0x3e7bb88, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool parameterValue);

  /// @brief Method get_ParameterValue, addr 0x3e7bbb0, size 0x8, virtual false, abstract: false, final false
