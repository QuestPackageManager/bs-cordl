...
public:
  ...
  /// @brief Method .ctor, addr 0x5abdac0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool parameterValue);

  /// @brief Method get_ParameterValue, addr 0x5abdac8, size 0x8, virtual false, abstract: false, final false
