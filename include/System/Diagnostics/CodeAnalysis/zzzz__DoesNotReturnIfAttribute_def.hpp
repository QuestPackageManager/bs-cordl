...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DoesNotReturnIfAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DoesNotReturnIfAttribute(DoesNotReturnIfAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DoesNotReturnIfAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DoesNotReturnIfAttribute(DoesNotReturnIfAttributeconst&) = delete;
