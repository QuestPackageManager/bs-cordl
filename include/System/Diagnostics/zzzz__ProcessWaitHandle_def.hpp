...
public:
  ...
  /// @brief Method .ctor, addr 0x639c480, size 0x58, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProcessWaitHandle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProcessWaitHandle(ProcessWaitHandle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProcessWaitHandle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProcessWaitHandle(ProcessWaitHandleconst&) = delete;
