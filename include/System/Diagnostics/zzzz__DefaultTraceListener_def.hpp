...
public:
  ...
  /// @brief Method GetPrefix, addr 0x29736d0, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW GetPrefix(::StringW var, ::StringW target);

  static inline ::System::Diagnostics::DefaultTraceListener* New_ctor();

  /// @brief Method .ctor, addr 0x296d128, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LogFileName, addr 0x297374c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LogFileName();

  /// @brief Method WriteWindowsDebugString, addr 0x2973754, size 0x4, virtual false, abstract: false, final false
  static inline void WriteWindowsDebugString(::cordl_internals::Ptr<char16_t> message);

  /// @brief Method WriteDebugString, addr 0x2973758, size 0xb0, virtual false, abstract: false, final false
  inline void WriteDebugString(::StringW message);

  /// @brief Method WriteMonoTrace, addr 0x2973808, size 0x1ac, virtual false, abstract: false, final false
  inline void WriteMonoTrace(::StringW message);

  /// @brief Method WritePrefix, addr 0x2973c30, size 0x88, virtual false, abstract: false, final false
  inline void WritePrefix();

  /// @brief Method WriteImpl, addr 0x2973cb8, size 0xbc, virtual false, abstract: false, final false
  inline void WriteImpl(::StringW message);

  /// @brief Method WriteLogFile, addr 0x29739b4, size 0x27c, virtual false, abstract: false, final false
  inline void WriteLogFile(::StringW message, ::StringW logFile);

  /// @brief Method Write, addr 0x2973d74, size 0x4, virtual true, abstract: false, final false
  inline void Write(::StringW message);

  /// @brief Method WriteLine, addr 0x2973d78, size 0x48, virtual true, abstract: false, final false
