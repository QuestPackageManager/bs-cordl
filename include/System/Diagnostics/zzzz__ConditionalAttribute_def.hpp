...
// Write type traits
MARK_REF_T(::System::Diagnostics::ConditionalAttribute*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::ConditionalAttribute*, "System.Diagnostics", "ConditionalAttribute");
// [AttributeUsage((System.AttributeTargets)68, AllowMultiple = true)]
...
public:
  ...
  /// @brief Method .ctor, addr 0x5be0aa4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConditionalAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConditionalAttribute(ConditionalAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConditionalAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConditionalAttribute(ConditionalAttributeconst&) = delete;
...
static_assert(sizeof(::System::Diagnostics::ConditionalAttribute) == 0x18, "Size mismatch!");
