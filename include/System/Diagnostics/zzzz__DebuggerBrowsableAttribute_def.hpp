...
// Write type traits
MARK_REF_T(::System::Diagnostics::DebuggerBrowsableAttribute*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::DebuggerBrowsableAttribute*, "System.Diagnostics", "DebuggerBrowsableAttribute");
// [ComVisible(true)]
...
public:
  ...
  /// @brief Method .ctor, addr 0x5be0ac4, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebuggerBrowsableAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebuggerBrowsableAttribute(DebuggerBrowsableAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebuggerBrowsableAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebuggerBrowsableAttribute(DebuggerBrowsableAttributeconst&) = delete;
...
static_assert(sizeof(::System::Diagnostics::DebuggerBrowsableAttribute) == 0x18, "Size mismatch!");
