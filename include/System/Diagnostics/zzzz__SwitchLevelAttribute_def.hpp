...
public:
  ...
  /// @brief Method .ctor, addr 0x442b6b4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* switchLevelType);

  /// @brief Method set_SwitchLevelType, addr 0x442b6e0, size 0xbc, virtual false, abstract: false, final false
