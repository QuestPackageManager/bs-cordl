...
public:
  ...
  /// @brief Method .ctor, addr 0x442ba1c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* switchLevelType);

  /// @brief Method set_SwitchLevelType, addr 0x442ba48, size 0xbc, virtual false, abstract: false, final false
