...
public:
  ...
  /// @brief Method .ctor, addr 0x442f0ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TotalProcessorTime, addr 0x442f4d4, size 0xc, virtual false, abstract: false, final false
