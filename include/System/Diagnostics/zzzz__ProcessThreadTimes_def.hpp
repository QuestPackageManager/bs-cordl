...
public:
  ...
  /// @brief Method .ctor, addr 0x442d6cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TotalProcessorTime, addr 0x442dab4, size 0xc, virtual false, abstract: false, final false
