...
public:
  ...
  /// @brief Method .ctor, addr 0x639c84c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TotalProcessorTime, addr 0x639cc30, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProcessThreadTimes", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProcessThreadTimes(ProcessThreadTimes&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProcessThreadTimes", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProcessThreadTimes(ProcessThreadTimesconst&) = delete;
