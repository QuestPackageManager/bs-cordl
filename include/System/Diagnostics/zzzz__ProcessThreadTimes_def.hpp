...
public:
  ...
  /// @brief Method .ctor, addr 0x617f1c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TotalProcessorTime, addr 0x617f5ac, size 0xc, virtual false, abstract: false, final false
