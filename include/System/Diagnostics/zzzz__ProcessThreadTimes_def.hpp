...
public:
  ...
  /// @brief Method .ctor, addr 0x61e6d54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TotalProcessorTime, addr 0x61e7138, size 0xc, virtual false, abstract: false, final false
