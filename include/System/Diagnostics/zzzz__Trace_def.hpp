...
public:
  ...
  /// @brief Method get_Listeners addr 0x296c608 size 0x4c virtual false final false
  static inline ::System::Diagnostics::TraceListenerCollection* get_Listeners();

  /// @brief Method get_AutoFlush addr 0x296c8a8 size 0x4c virtual false final false
  static inline bool get_AutoFlush();

  /// @brief Method get_CorrelationManager addr 0x296c954 size 0xa4 virtual false final false
