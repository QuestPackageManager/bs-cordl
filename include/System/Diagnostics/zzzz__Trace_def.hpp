...
public:
  ...
  /// @brief Method get_Listeners, addr 0x2970528, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::TraceListenerCollection* get_Listeners();

  /// @brief Method get_AutoFlush, addr 0x29707c8, size 0x4c, virtual false, abstract: false, final false
  static inline bool get_AutoFlush();

  /// @brief Method get_CorrelationManager, addr 0x2970874, size 0xa4, virtual false, abstract: false, final false
