...
public:
  ...
  /// @brief Method .ctor, addr 0x5aa3068, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::StringW value);

  /// @brief Method set_Name, addr 0x5aa30cc, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Type, addr 0x5aa30d4, size 0x8, virtual false, abstract: false, final false
