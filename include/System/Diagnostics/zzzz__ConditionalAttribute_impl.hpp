...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Diagnostics::ConditionalAttribute::*)(::StringW)>(
  ...
  constexpr static std::size_t addrs = 0x2579bd8;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Diagnostics::ConditionalAttribute*>::get(), ".ctor", std::vector<Il2CppClass*>{},
                                                 ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get() })));
    return ___internal_method;
  }
};
constexpr ::StringW& System::Diagnostics::ConditionalAttribute::__get__ConditionString_k__BackingField() {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->____ConditionString_k__BackingField;
}
constexpr ::StringW const& System::Diagnostics::ConditionalAttribute::__get__ConditionString_k__BackingField() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->____ConditionString_k__BackingField;
}
...
inline ::System::Diagnostics::ConditionalAttribute* System::Diagnostics::ConditionalAttribute::New_ctor(::StringW conditionString) {
  return THROW_UNLESS(::il2cpp_utils::New<::System::Diagnostics::ConditionalAttribute*>(conditionString));
}
