...
public:
  ...
  /// @brief Method InitializeSettings, addr 0x625544c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AutoFlush, addr 0x6254c74, size 0x60, virtual false, abstract: false, final false
  static inline bool get_AutoFlush();

  /// @brief Method get_IndentLevel, addr 0x6255750, size 0x80, virtual false, abstract: false, final false
  static inline int32_t get_IndentLevel();

  /// @brief Method get_IndentSize, addr 0x62557d0, size 0x60, virtual false, abstract: false, final false
  static inline int32_t get_IndentSize();

  /// @brief Method get_Listeners, addr 0x6254984, size 0x2a0, virtual false, abstract: false, final false
  static inline ::System::Diagnostics::TraceListenerCollection* get_Listeners();

  /// @brief Method get_UseGlobalLock, addr 0x62556f0, size 0x60, virtual false, abstract: false, final false
