...
public:
  ...
  /// @brief Method get_Listeners addr 0x296c654 size 0x254 virtual false final false
  static inline ::System::Diagnostics::TraceListenerCollection* get_Listeners();

  /// @brief Method get_AutoFlush addr 0x296c8f4 size 0x60 virtual false final false
  static inline bool get_AutoFlush();

  /// @brief Method get_IndentLevel addr 0x296d38c size 0x58 virtual false final false
  static inline int32_t get_IndentLevel();

  /// @brief Method get_IndentSize addr 0x296d3e4 size 0x60 virtual false final false
  static inline int32_t get_IndentSize();

  /// @brief Method InitializeSettings addr 0x296d0b4 size 0x4 virtual false final false
