...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TraceInternal", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TraceInternal(TraceInternal&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TraceInternal", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TraceInternal(TraceInternalconst&) = delete;
