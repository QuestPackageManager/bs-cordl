...
public:
  ...
  /// @brief Method AddFrames, addr 0x5be16f0, size 0x564, virtual false, abstract: false, final false
  inline bool AddFrames(::System::Text::StringBuilder* sb, bool separator, ::by_ref<bool> isAsync);

  /// @brief Method ConvertAsyncStateMachineMethod, addr 0x5be22b0, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAotId, addr 0x5be1624, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFullNameForStackTrace, addr 0x5be1c54, size 0x65c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5be26b8, size 0x168, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x5be2820, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5be10a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5be12e0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* e, bool fNeedFileInfo);

  /// @brief Method .ctor, addr 0x5be12ec, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::System::Exception* e, int32_t skipFrames, bool fNeedFileInfo);

  /// @brief Method .ctor, addr 0x5be12c4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool fNeedFileInfo);

  /// @brief Method .ctor, addr 0x5be12d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t skipFrames);

  /// @brief Method .ctor, addr 0x5be12d8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FrameCount, addr 0x5be13bc, size 0x18, virtual true, abstract: false, final false
  inline int32_t get_FrameCount();

  /// @brief Method get_trace, addr 0x5be12dc, size 0x4, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Diagnostics::StackFrame*> get_trace(::System::Exception* e, int32_t skipFrames, bool fNeedFileInfo);

  /// @brief Method init_frames, addr 0x5be10b0, size 0x214, virtual false, abstract: false, final false
