...
/// @brief Field captured_traces, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_captured_traces, put=__cordl_internal_set_captured_traces)) ::ArrayW<::System::Diagnostics::StackTrace*,::Array<::System::Diagnostics::StackTrace*>*>  captured_traces;
...
/// @brief Method AddFrames, addr 0x5a31bb8, size 0x564, virtual false, abstract: false, final false
inline bool AddFrames(::System::Text::StringBuilder*  sb, bool  separator, ::ByRef<bool>  isAsync) ;

/// @brief Method ConvertAsyncStateMachineMethod, addr 0x5a32778, size 0x408, virtual false, abstract: false, final false
...
/// @brief Method GetAotId, addr 0x5a31aec, size 0xcc, virtual false, abstract: false, final false
static inline ::StringW GetAotId() ;

/// @brief Method GetFrame, addr 0x5a3189c, size 0x60, virtual true, abstract: false, final false
inline ::System::Diagnostics::StackFrame* GetFrame(int32_t  index) ;

/// @brief Method GetFrames, addr 0x5a318fc, size 0x1f0, virtual true, abstract: false, final false
inline ::ArrayW<::System::Diagnostics::StackFrame*,::Array<::System::Diagnostics::StackFrame*>*> GetFrames() ;

/// @brief Method GetFullNameForStackTrace, addr 0x5a3211c, size 0x65c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x5a32b80, size 0x168, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x5a32ce8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5a3156c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5a317a8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x5a317b4, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, int32_t  skipFrames, bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x5a3178c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x5a31798, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  skipFrames) ;

/// @brief Method .ctor, addr 0x5a317a0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_FrameCount, addr 0x5a31884, size 0x18, virtual true, abstract: false, final false
inline int32_t get_FrameCount() ;

/// @brief Method get_trace, addr 0x5a317a4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method init_frames, addr 0x5a31578, size 0x214, virtual false, abstract: false, final false
