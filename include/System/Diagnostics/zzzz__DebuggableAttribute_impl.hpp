...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Diagnostics::DebuggableAttribute::*)(::System::Diagnostics::DebuggableAttribute_DebuggingModes)>(
    &::System::Diagnostics::DebuggableAttribute::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5be0abc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::System::Diagnostics::DebuggableAttribute*>(),
                                                                                           { ".ctor", {}, { ::i2c::type_of<::System::Diagnostics::DebuggableAttribute_DebuggingModes>() } })));
