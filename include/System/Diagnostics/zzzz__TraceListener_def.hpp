...
namespace System::Diagnostics {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2605)), TypeDefinitionIndex(TypeDefinitionIndex(6955))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x29713ec, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_IsThreadSafe, addr 0x2971424, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsThreadSafe();

  /// @brief Method Dispose, addr 0x297142c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2971498, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Flush, addr 0x297149c, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method set_IndentLevel, addr 0x29710ac, size 0x1c, virtual false, abstract: false, final false
  inline void set_IndentLevel(int32_t value);

  /// @brief Method set_IndentSize, addr 0x29710c8, size 0xac, virtual false, abstract: false, final false
  inline void set_IndentSize(int32_t value);

  /// @brief Method get_Filter, addr 0x29714a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Diagnostics::TraceFilter* get_Filter();

  /// @brief Method get_NeedIndent, addr 0x29714a8, size 0x8, virtual false, abstract: false, final false
  inline bool get_NeedIndent();

  /// @brief Method set_NeedIndent, addr 0x29714b0, size 0xc, virtual false, abstract: false, final false
  inline void set_NeedIndent(bool value);

  /// @brief Method get_TraceOutputOptions, addr 0x29714bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteIndent, addr 0x29714c4, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method TraceEvent, addr 0x2971598, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteHeader, addr 0x297165c, size 0x110, virtual false, abstract: false, final false
  inline void WriteHeader(::StringW source, ::System::Diagnostics::TraceEventType eventType, int32_t id);

  /// @brief Method WriteFooter, addr 0x297176c, size 0x5a0, virtual false, abstract: false, final false
  inline void WriteFooter(::System::Diagnostics::TraceEventCache* eventCache);

  /// @brief Method IsEnabled, addr 0x2971d0c, size 0x10, virtual false, abstract: false, final false
