...
public:
  ...
  /// @brief Method Dispose, addr 0x6393534, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x63935a4, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Flush, addr 0x63935a8, size 0x4, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method IsEnabled, addr 0x6393e64, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method TraceEvent, addr 0x63936a8, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteFooter, addr 0x63938a4, size 0x5c0, virtual false, abstract: false, final false
  inline void WriteFooter(::System::Diagnostics::TraceEventCache* eventCache);

  /// @brief Method WriteHeader, addr 0x6393770, size 0x134, virtual false, abstract: false, final false
  inline void WriteHeader(::StringW source, ::System::Diagnostics::TraceEventType eventType, int32_t id);

  /// @brief Method WriteIndent, addr 0x63935cc, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63934c0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Filter, addr 0x63935ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Diagnostics::TraceFilter* get_Filter();

  /// @brief Method get_IsThreadSafe, addr 0x639352c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsThreadSafe();

  /// @brief Method get_Name, addr 0x63934d8, size 0x54, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NeedIndent, addr 0x63935b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_NeedIndent();

  /// @brief Method get_TraceOutputOptions, addr 0x63935c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Diagnostics::TraceOptions get_TraceOutputOptions();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_IndentLevel, addr 0x6393120, size 0x18, virtual false, abstract: false, final false
  inline void set_IndentLevel(int32_t value);

  /// @brief Method set_IndentSize, addr 0x6393138, size 0x90, virtual false, abstract: false, final false
  inline void set_IndentSize(int32_t value);

  /// @brief Method set_NeedIndent, addr 0x63935bc, size 0x8, virtual false, abstract: false, final false
