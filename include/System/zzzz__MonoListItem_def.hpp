...
// Write type traits
MARK_REF_T(::System::MonoListItem*);
DEFINE_IL2CPP_CLASS(::System::MonoListItem*, "System", "MonoListItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5c94ba0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::System::MonoListItem) == 0x20, "Size mismatch!");
