...
public:
  ...
  /// @brief Method .ctor, addr 0x5a94064, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a940c4, size 0x8, virtual false, abstract: false, final false
