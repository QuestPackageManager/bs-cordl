...
public:
  ...
  /// @brief Method .ctor, addr 0x3de63d8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3de6434, size 0x8, virtual false, abstract: false, final false
