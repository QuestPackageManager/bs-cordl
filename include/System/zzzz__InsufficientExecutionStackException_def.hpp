...
public:
  ...
  /// @brief Method .ctor, addr 0x3de7b90, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3de7bec, size 0x8, virtual false, abstract: false, final false
