...
public:
  ...
  /// @brief Method .ctor, addr 0x3de7c08, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3de7c64, size 0x8, virtual false, abstract: false, final false
