...
public:
  ...
  /// @brief Method .ctor, addr 0x5c43fd0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5c44030, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InsufficientExecutionStackException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InsufficientExecutionStackException(InsufficientExecutionStackException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InsufficientExecutionStackException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InsufficientExecutionStackException(InsufficientExecutionStackExceptionconst&) = delete;
