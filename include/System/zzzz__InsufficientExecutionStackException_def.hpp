...
public:
  ...
  /// @brief Method .ctor, addr 0x295dbc8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x295dc24, size 0x8, virtual false, abstract: false, final false
