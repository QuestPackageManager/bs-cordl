...
public:
  ...
  /// @brief Method .ctor, addr 0x5a2d718, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5a2d778, size 0x8, virtual false, abstract: false, final false
