...
public:
  ...
  /// @brief Method .ctor, addr 0x5c5d828, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5c5d8a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x5c5d884, size 0x20, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StackOverflowException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StackOverflowException(StackOverflowException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StackOverflowException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StackOverflowException(StackOverflowExceptionconst&) = delete;
