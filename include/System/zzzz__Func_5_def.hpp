...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Func_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Func_5, "System", "Func`5");
...
public:
  ...
  static inline ::System::Func_5<T1, T2, T3, T4, TResult>* New_ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Func_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Func_5(Func_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Func_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Func_5(Func_5const&) = delete;
