...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Func_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Func_4(Func_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Func_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Func_4(Func_4const&) = delete;
