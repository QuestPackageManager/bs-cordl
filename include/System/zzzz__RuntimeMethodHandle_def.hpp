...
public:
  ...
  /// @brief Method ConstructInstantiation, addr 0x3e40644, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x3e40540, size 0xfc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x3e4063c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetObjectData, addr 0x3e403b0, size 0x190, virtual true, abstract: false, final true
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method IsNullHandle, addr 0x3e4079c, size 0x10, virtual false, abstract: false, final false
  inline bool IsNullHandle();

  /// @brief Method .ctor, addr 0x3e40220, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x3e40218, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr v);

  /// @brief Method get_Value, addr 0x3e403a8, size 0x8, virtual false, abstract: false, final false
