...
public:
  ...
  /// @brief Method ConstructInstantiation, addr 0x2881cf4, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2881bf0, size 0xfc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2881cec, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetObjectData, addr 0x2881a34, size 0x1bc, virtual true, abstract: false, final true
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method IsNullHandle, addr 0x2881e4c, size 0x58, virtual false, abstract: false, final false
  inline bool IsNullHandle();

  /// @brief Method .ctor, addr 0x2881878, size 0x1b4, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x2881870, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(void* v);

  /// @brief Method get_Value, addr 0x2881a2c, size 0x8, virtual false, abstract: false, final false
