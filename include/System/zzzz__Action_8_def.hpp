...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Action_8);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Action_8, "System", "Action`8");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Action_8", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Action_8(Action_8&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Action_8", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Action_8(Action_8const&) = delete;
