...
public:
  ...
  /// @brief Method .ctor, addr 0x25a8924, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW value);

  /// @brief Method get_Name, addr 0x25a992c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Value, addr 0x25a9934, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAttribute, addr 0x25a6200, size 0x1ac, virtual false, abstract: false, final false
  inline void AddAttribute(::StringW name, ::StringW value);

  /// @brief Method AddChild, addr 0x25a63ac, size 0xd0, virtual false, abstract: false, final false
  inline void AddChild(::System::Security::SecurityElement* child);

  /// @brief Method Escape, addr 0x25a8a88, size 0x1ec, virtual false, abstract: false, final false
  static inline ::StringW Escape(::StringW str);

  /// @brief Method GetAttribute, addr 0x25a8614, size 0x310, virtual false, abstract: false, final false
  inline ::System::Security::__SecurityElement__SecurityAttribute* GetAttribute(::StringW name);

  /// @brief Method IsValidAttributeName, addr 0x25a8c74, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsValidAttributeName(::StringW name);

  /// @brief Method IsValidAttributeValue, addr 0x25a8cf0, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsValidAttributeValue(::StringW value);

  /// @brief Method IsValidTag, addr 0x25a8234, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsValidTag(::StringW tag);

  /// @brief Method IsValidText, addr 0x25a83bc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method SearchForChildByTag, addr 0x25a8d6c, size 0x128, virtual false, abstract: false, final false
  inline ::System::Security::SecurityElement* SearchForChildByTag(::StringW tag);

  /// @brief Method SearchForTextOfLocalName, addr 0x25a9570, size 0x23c, virtual false, abstract: false, final false
  inline ::StringW SearchForTextOfLocalName(::StringW strLocalName);

  /// @brief Method ToString, addr 0x25a8e94, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToXml, addr 0x25a8f1c, size 0x64c, virtual false, abstract: false, final false
  inline void ToXml(ByRef<::System::Text::StringBuilder*> s, int32_t level);

  /// @brief Method Unescape, addr 0x25a8438, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25a61f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW tag);

  /// @brief Method .ctor, addr 0x25a80e4, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Children, addr 0x25a83ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* get_Children();

  /// @brief Method get_Tag, addr 0x25a83b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Text, addr 0x25a82b0, size 0xfc, virtual false, abstract: false, final false
  inline void set_Text(::StringW value);

  /// @brief Method set_m_strText, addr 0x25a9568, size 0x8, virtual false, abstract: false, final false
