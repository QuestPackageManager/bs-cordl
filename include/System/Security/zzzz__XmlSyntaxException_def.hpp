...
public:
  ...
  /// @brief Method .ctor, addr 0x3c95098, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3c950b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x3c950a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t lineNumber);

  /// @brief Method .ctor, addr 0x3c950a8, size 0x8, virtual false, abstract: false, final false
