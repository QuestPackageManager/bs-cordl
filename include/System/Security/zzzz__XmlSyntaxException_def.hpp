...
public:
  ...
  /// @brief Method .ctor, addr 0x59b06cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59b06e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x59b06d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t lineNumber);

  /// @brief Method .ctor, addr 0x59b06dc, size 0x8, virtual false, abstract: false, final false
