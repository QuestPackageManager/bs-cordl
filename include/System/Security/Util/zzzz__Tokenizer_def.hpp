...
public:
  ...
  /// @brief Method CompareStringAndChars, addr 0x59b6340, size 0x94, virtual false, abstract: false, final false
  inline bool CompareStringAndChars(::StringW str, ::ArrayW<char16_t, ::Array<char16_t>*> a, int32_t l);

  /// @brief Method HashCharArray, addr 0x59b6260, size 0x54, virtual false, abstract: false, final false
  static inline uint32_t HashCharArray(::ArrayW<char16_t, ::Array<char16_t>*> a, int32_t l);

  /// @brief Method HashString, addr 0x59b621c, size 0x44, virtual false, abstract: false, final false
  static inline uint32_t HashString(::StringW str);

  /// @brief Method MakeString, addr 0x59b0cd8, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59b62b4, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Read, addr 0x59b63d4, size 0x3c, virtual true, abstract: false, final false
  inline int32_t Read();
  ...
  /// @brief Method .ctor, addr 0x59b6034, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::StreamReader* input);

  /// @brief Method get_NumCharEncountered, addr 0x59b6410, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BasicInitialization, addr 0x59b5f5c, size 0x7c, virtual false, abstract: false, final false
  inline void BasicInitialization();

  /// @brief Method ChangeFormat, addr 0x59b57e8, size 0x210, virtual false, abstract: false, final false
  inline void ChangeFormat(::System::Text::Encoding* encoding);

  /// @brief Method GetStringToken, addr 0x59b6130, size 0x14, virtual false, abstract: false, final false
  inline ::StringW GetStringToken();

  /// @brief Method GetTokens, addr 0x59b4fb0, size 0x7d8, virtual false, abstract: false, final false
  ...
  /// @brief Method Recycle, addr 0x59b5fd8, size 0x5c, virtual false, abstract: false, final false
  inline void Recycle();
  ...
  /// @brief Method .ctor, addr 0x59b5f20, size 0x3c, virtual false, abstract: false, final false
