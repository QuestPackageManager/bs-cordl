...
public:
  ...
  /// @brief Method .ctor, addr 0x5af3f60, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TokenizerShortBlock", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TokenizerShortBlock(TokenizerShortBlock&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TokenizerShortBlock", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TokenizerShortBlock(TokenizerShortBlockconst&) = delete;
