...
public:
  ...
  /// @brief Method DetermineFormat, addr 0x26d1cf8, size 0x1b0, virtual false, abstract: false, final false
  inline int32_t DetermineFormat(::System::Security::Util::TokenizerStream* stream);

  /// @brief Method GetRequiredSizes, addr 0x26d17a0, size 0x460, virtual false, abstract: false, final false
  inline void GetRequiredSizes(::System::Security::Util::TokenizerStream* stream, ByRef<int32_t> index);

  /// @brief Method GetTopElement, addr 0x26d1778, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseContents, addr 0x26d290c, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d2dec, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW input);

  /// @brief Method .ctor, addr 0x26d2d48, size 0xa4, virtual false, abstract: false, final false
