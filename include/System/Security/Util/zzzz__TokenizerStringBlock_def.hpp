...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TokenizerStringBlock", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TokenizerStringBlock(TokenizerStringBlock&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TokenizerStringBlock", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TokenizerStringBlock(TokenizerStringBlockconst&) = delete;
