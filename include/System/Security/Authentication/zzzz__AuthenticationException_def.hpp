...
public:
  ...
  /// @brief Method .ctor addr 0x27f64fc size 0x58 virtual false final false
  inline void _ctor();

  static inline ::System::Security::Authentication::AuthenticationException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x27f6554 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x27f655c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x27f6564 size 0x8 virtual false final false
