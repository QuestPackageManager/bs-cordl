...
public:
  ...
  /// @brief Method .ctor, addr 0x639afec, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x639b03c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x639b044, size 0x8, virtual false, abstract: false, final false
