...
public:
  ...
  /// @brief Method .ctor, addr 0x61ead0c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x61ead5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x61ead64, size 0x8, virtual false, abstract: false, final false
