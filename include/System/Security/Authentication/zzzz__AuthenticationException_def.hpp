...
public:
  ...
  /// @brief Method .ctor, addr 0x625d3d8, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x625d428, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x625d430, size 0x8, virtual false, abstract: false, final false
