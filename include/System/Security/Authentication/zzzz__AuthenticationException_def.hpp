...
// Write type traits
MARK_REF_T(::System::Security::Authentication::AuthenticationException*);
DEFINE_IL2CPP_CLASS(::System::Security::Authentication::AuthenticationException*, "System.Security.Authentication", "AuthenticationException");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AuthenticationException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AuthenticationException(AuthenticationException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AuthenticationException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AuthenticationException(AuthenticationExceptionconst&) = delete;
...
static_assert(sizeof(::System::Security::Authentication::AuthenticationException) == 0x90, "Size mismatch!");
