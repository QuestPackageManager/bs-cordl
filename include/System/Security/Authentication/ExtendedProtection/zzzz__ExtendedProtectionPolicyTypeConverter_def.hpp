...
public:
  // Declarations
  /// @brief Method CanConvertTo, addr 0x4437870, size 0x38, virtual true, abstract: false, final false
  inline bool CanConvertTo(::System::ComponentModel::ITypeDescriptorContext* context, ::System::Type* destinationType);

  /// @brief Method ConvertTo, addr 0x44378a8, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44378e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
