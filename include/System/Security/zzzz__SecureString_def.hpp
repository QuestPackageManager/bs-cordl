...
public:
  ...
  /// @brief Method Alloc, addr 0x3c90a3c, size 0x180, virtual false, abstract: false, final false
  inline void Alloc(int32_t length, bool realloc);

  /// @brief Method Decrypt, addr 0x3c90d98, size 0x4, virtual false, abstract: false, final false
  inline void Decrypt();

  /// @brief Method Dispose, addr 0x3c90d60, size 0x38, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Encrypt, addr 0x3c90cfc, size 0x4, virtual false, abstract: false, final false
  inline void Encrypt();

  /// @brief Method GetBuffer, addr 0x3c90d9c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c90a18, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3c90bbc, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::cordl_internals::Ptr<char16_t> value, int32_t length);

  /// @brief Method get_Length, addr 0x3c90d00, size 0x60, virtual false, abstract: false, final false
