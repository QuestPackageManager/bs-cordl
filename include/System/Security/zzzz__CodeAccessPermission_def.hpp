...
public:
  ...
  /// @brief Method CheckPermissionState, addr 0x59b163c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method Demand, addr 0x59b13e8, size 0x3c, virtual true, abstract: false, final true
  inline void Demand();

  /// @brief Method Equals, addr 0x59b14f4, size 0x10c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x59b1600, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Security.IPermission.Demand, addr 0x59b16e0, size 0x4, virtual true, abstract: false, final true
  inline void System_Security_IPermission_Demand();

  /// @brief Method ToString, addr 0x59b1614, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59b13e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
