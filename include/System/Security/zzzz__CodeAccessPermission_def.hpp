...
public:
  ...
  /// @brief Method CheckPermissionState, addr 0x3ca1b80, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Demand, addr 0x3ca1934, size 0x2c, virtual true, abstract: false, final true
  inline void Demand();

  /// @brief Method Equals, addr 0x3ca1a2c, size 0x124, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x3ca1b50, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Security.IPermission.Demand, addr 0x3ca1c2c, size 0x4, virtual true, abstract: false, final true
  inline void System_Security_IPermission_Demand();

  /// @brief Method ToString, addr 0x3ca1b58, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ca192c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
