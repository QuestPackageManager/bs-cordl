...
public:
  ...
  /// @brief Method CheckPermissionState, addr 0x26d444c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Demand, addr 0x26d4200, size 0x2c, virtual true, abstract: false, final true
  inline void Demand();

  /// @brief Method Equals, addr 0x26d42f8, size 0x124, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x26d441c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method System.Security.IPermission.Demand, addr 0x26d44fc, size 0x4, virtual true, abstract: false, final true
  inline void System_Security_IPermission_Demand();

  /// @brief Method ToString, addr 0x26d4424, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d41f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
