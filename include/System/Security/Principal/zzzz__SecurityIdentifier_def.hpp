...
public:
  ...
  /// @brief Method CompareTo, addr 0x59d6bec, size 0x140, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Security::Principal::SecurityIdentifier* sid);

  /// @brief Method CreateFromBinaryForm, addr 0x59d6770, size 0x148, virtual false, abstract: false, final false
  inline void CreateFromBinaryForm(::System::IntPtr binaryForm, int32_t length);

  /// @brief Method Equals, addr 0x59d6d90, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x59d6e00, size 0xa8, virtual false, abstract: false, final false
  inline bool Equals(::System::Security::Principal::SecurityIdentifier* sid);

  /// @brief Method GetBinaryForm, addr 0x59d6ea8, size 0xc0, virtual false, abstract: false, final false
  inline void GetBinaryForm(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method GetHashCode, addr 0x59d6f68, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSidAuthority, addr 0x59d6ac4, size 0x80, virtual false, abstract: false, final false
  inline uint64_t GetSidAuthority();

  /// @brief Method GetSidSubAuthority, addr 0x59d6b44, size 0x7c, virtual false, abstract: false, final false
  inline uint32_t GetSidSubAuthority(uint8_t index);

  /// @brief Method GetSidSubAuthorityCount, addr 0x59d6bc0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseSddlForm, addr 0x59d6270, size 0x444, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ParseSddlForm(::StringW sddlForm);

  /// @brief Method ToString, addr 0x59d6f90, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Translate, addr 0x59d6f9c, size 0x200, virtual true, abstract: false, final false
  inline ::System::Security::Principal::IdentityReference* Translate(::System::Type* targetType);

  /// @brief Method TryParseAuthority, addr 0x59d7304, size 0xf8, virtual false, abstract: false, final false
  static inline bool TryParseAuthority(::StringW s, ::ByRef<uint64_t> result);

  /// @brief Method TryParseSubAuthority, addr 0x59d73fc, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59d66b4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x59d61b8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BinaryLength, addr 0x59d68b8, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_BinaryLength();

  /// @brief Method get_Value, addr 0x59d68d0, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x59d6d2c, size 0x64, virtual false, abstract: false, final false
