...
public:
  ...
  /// @brief Method CompareTo, addr 0x25ce37c, size 0x170, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Security::Principal::SecurityIdentifier* sid);

  /// @brief Method CreateFromBinaryForm, addr 0x25cdf14, size 0x168, virtual false, abstract: false, final false
  inline void CreateFromBinaryForm(void* binaryForm, int32_t length);

  /// @brief Method Equals, addr 0x25ce554, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x25ce5b8, size 0xa8, virtual false, abstract: false, final false
  inline bool Equals(::System::Security::Principal::SecurityIdentifier* sid);

  /// @brief Method GetBinaryForm, addr 0x25ce660, size 0xc8, virtual false, abstract: false, final false
  inline void GetBinaryForm(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method GetHashCode, addr 0x25ce728, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSidAuthority, addr 0x25ce254, size 0x80, virtual false, abstract: false, final false
  inline uint64_t GetSidAuthority();

  /// @brief Method GetSidSubAuthority, addr 0x25ce2d4, size 0x7c, virtual false, abstract: false, final false
  inline uint32_t GetSidSubAuthority(uint8_t index);

  /// @brief Method GetSidSubAuthorityCount, addr 0x25ce350, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseSddlForm, addr 0x25cd9c8, size 0x460, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ParseSddlForm(::StringW sddlForm);

  /// @brief Method ToString, addr 0x25ce750, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Translate, addr 0x25ce75c, size 0x22c, virtual true, abstract: false, final false
  inline ::System::Security::Principal::IdentityReference* Translate(::System::Type* targetType);

  /// @brief Method TryParseAuthority, addr 0x25ceb08, size 0xd8, virtual false, abstract: false, final false
  static inline bool TryParseAuthority(::StringW s, ByRef<uint64_t> result);

  /// @brief Method TryParseSubAuthority, addr 0x25cebe0, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25cde28, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x25cd90c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BinaryLength, addr 0x25ce07c, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_BinaryLength();

  /// @brief Method get_Value, addr 0x25ce098, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x25ce4ec, size 0x68, virtual false, abstract: false, final false
