...
public:
  ...
  /// @brief Method LookupByName, addr 0x5963c8c, size 0xb4, virtual false, abstract: false, final false
  static inline ::System::Security::Principal::WellKnownAccount* LookupByName(::StringW s);

  /// @brief Method LookupBySddlForm, addr 0x5964dd8, size 0xb4, virtual false, abstract: false, final false
  static inline ::System::Security::Principal::WellKnownAccount* LookupBySddlForm(::StringW s);

  /// @brief Method LookupBySid, addr 0x5964d24, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5965120, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsAbsolute, addr 0x59650d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAbsolute();

  /// @brief Method get_Name, addr 0x5965100, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_SddlForm, addr 0x5965110, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SddlForm();

  /// @brief Method get_Sid, addr 0x59650e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsAbsolute, addr 0x59650e0, size 0x8, virtual false, abstract: false, final false
  inline void set_IsAbsolute(bool value);

  /// @brief Method set_Name, addr 0x5965108, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_Rid, addr 0x59650f8, size 0x8, virtual false, abstract: false, final false
  inline void set_Rid(::StringW value);

  /// @brief Method set_SddlForm, addr 0x5965118, size 0x8, virtual false, abstract: false, final false
  inline void set_SddlForm(::StringW value);

  /// @brief Method set_Sid, addr 0x59650f0, size 0x8, virtual false, abstract: false, final false
  inline void set_Sid(::StringW value);

  /// @brief Method set_WellKnownValue, addr 0x59650d0, size 0x8, virtual false, abstract: false, final false
