...
public:
  ...
  /// @brief Method CloneAsBase, addr 0x59d9f54, size 0x4, virtual false, abstract: false, final false
  inline ::System::Security::Claims::ClaimsIdentity* CloneAsBase();

  /// @brief Method Dispose, addr 0x59d99a0, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetCurrent, addr 0x59d99a8, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Security::Principal::WindowsIdentity* GetCurrent();

  /// @brief Method GetCurrentToken, addr 0x59d9a1c, size 0x8, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetCurrentToken();

  /// @brief Method GetTokenInternal, addr 0x59da0a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::IntPtr GetTokenInternal();

  /// @brief Method GetTokenName, addr 0x59d9aec, size 0xc, virtual false, abstract: false, final false
  static inline ::StringW GetTokenName(::System::IntPtr token);

  /// @brief Method Impersonate, addr 0x59d9a24, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method SetToken, addr 0x59d9888, size 0xa0, virtual false, abstract: false, final false
  inline void SetToken(::System::IntPtr token);

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x59d9b30, size 0x2c0, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x59d9df0, size 0x164, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59d9964, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Claims::ClaimsIdentity* claimsIdentity, ::System::IntPtr userToken);

  /// @brief Method .ctor, addr 0x59d9928, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x59d9824, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AuthenticationType, addr 0x59d9a7c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_AuthenticationType();

  /// @brief Method get_Name, addr 0x59d9a84, size 0x68, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_User, addr 0x59d9af8, size 0x38, virtual false, abstract: false, final false
