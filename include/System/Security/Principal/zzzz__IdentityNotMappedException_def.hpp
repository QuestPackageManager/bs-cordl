...
public:
  // Declarations
  /// @brief Method GetObjectData, addr 0x3cbdc10, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cbdbb0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cbdc08, size 0x8, virtual false, abstract: false, final false
