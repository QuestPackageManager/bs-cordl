...
public:
  // Declarations
  /// @brief Method GetObjectData, addr 0x3cb7d54, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cb7cf4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cb7d4c, size 0x8, virtual false, abstract: false, final false
