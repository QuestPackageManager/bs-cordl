...
// Write type traits
MARK_REF_T(::System::Security::Principal::IIdentity*);
DEFINE_IL2CPP_CLASS(::System::Security::Principal::IIdentity*, "System.Security.Principal", "IIdentity");
// Dependencies
namespace System::Security::Principal {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IIdentity", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IIdentity(IIdentityconst&) = delete;
