...
namespace System::Security::Principal {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3009))}
...
public:
  ...
  /// @brief Method .ctor addr 0x231ea54 size 0xbc virtual false final false
  inline void _ctor(::StringW name, ::StringW type);

  static inline ::System::Security::Principal::GenericIdentity* New_ctor();

  /// @brief Method .ctor addr 0x231ec04 size 0x1c virtual false final false
  inline void _ctor();

  static inline ::System::Security::Principal::GenericIdentity* New_ctor(::System::Security::Principal::GenericIdentity* identity);

  /// @brief Method .ctor addr 0x231ec20 size 0x30 virtual false final false
  inline void _ctor(::System::Security::Principal::GenericIdentity* identity);

  /// @brief Method Clone addr 0x231ee40 size 0x60 virtual true final false
  inline ::System::Security::Claims::ClaimsIdentity* Clone();

  /// @brief Method get_Claims addr 0x231eea0 size 0x4 virtual true final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Security::Claims::Claim*>* get_Claims();

  /// @brief Method get_Name addr 0x231ef1c size 0x8 virtual true final false
  inline ::StringW get_Name();

  /// @brief Method get_AuthenticationType addr 0x231ef24 size 0x8 virtual true final false
  inline ::StringW get_AuthenticationType();

  /// @brief Method AddNameClaim addr 0x231eb2c size 0xd8 virtual false final false
