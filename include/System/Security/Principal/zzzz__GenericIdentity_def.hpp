...
public:
  ...
  /// @brief Method AddNameClaim, addr 0x3cb89f4, size 0xd0, virtual false, abstract: false, final false
  inline void AddNameClaim();

  /// @brief Method Clone, addr 0x3cb8d04, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cb8ac4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cb8ae0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Principal::GenericIdentity* identity);

  /// @brief Method .ctor, addr 0x3cb8924, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW type);

  /// @brief Method get_AuthenticationType, addr 0x3cb8dd8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_AuthenticationType();

  /// @brief Method get_Claims, addr 0x3cb8d5c, size 0x4, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Security::Claims::Claim*>* get_Claims();

  /// @brief Method get_Name, addr 0x3cb8dd0, size 0x8, virtual true, abstract: false, final false
