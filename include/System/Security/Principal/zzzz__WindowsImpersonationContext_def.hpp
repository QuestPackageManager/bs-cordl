...
/// @brief Method CloseToken, addr 0x59681e8, size 0x8, virtual false, abstract: false, final false
static inline bool CloseToken(::System::IntPtr  token) ;

/// @brief Method Dispose, addr 0x5968198, size 0x14, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DuplicateToken, addr 0x5968188, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method RevertToSelf, addr 0x59681e0, size 0x8, virtual false, abstract: false, final false
static inline bool RevertToSelf() ;

/// @brief Method SetCurrentToken, addr 0x5968190, size 0x8, virtual false, abstract: false, final false
static inline bool SetCurrentToken(::System::IntPtr  token) ;

/// @brief Method Undo, addr 0x59681ac, size 0x34, virtual false, abstract: false, final false
inline void Undo() ;
...
/// @brief Method .ctor, addr 0x5967b04, size 0xc, virtual false, abstract: false, final false
