...
public:
  ...
  /// @brief Method CloseToken, addr 0x26fa07c, size 0x4, virtual false, abstract: false, final false
  static inline bool CloseToken(void* token);

  /// @brief Method Dispose, addr 0x26f9fa4, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DuplicateToken, addr 0x26f9f9c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RevertToSelf, addr 0x26fa078, size 0x4, virtual false, abstract: false, final false
  static inline bool RevertToSelf();

  /// @brief Method SetCurrentToken, addr 0x26f9fa0, size 0x4, virtual false, abstract: false, final false
  static inline bool SetCurrentToken(void* token);

  /// @brief Method Undo, addr 0x26f9fb4, size 0xc4, virtual false, abstract: false, final false
  inline void Undo();
  ...
  /// @brief Method .ctor, addr 0x26f9898, size 0x8c, virtual false, abstract: false, final false
