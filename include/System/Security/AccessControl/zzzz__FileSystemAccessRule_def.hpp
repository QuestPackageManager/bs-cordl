...
public:
  ...
  /// @brief Method .ctor, addr 0x25d9b14, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x25d9b1c, size 0x8, virtual false, abstract: false, final false
