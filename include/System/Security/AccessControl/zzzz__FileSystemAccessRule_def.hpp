...
public:
  ...
  /// @brief Method .ctor, addr 0x3cc59e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x3cc59e8, size 0x8, virtual false, abstract: false, final false
