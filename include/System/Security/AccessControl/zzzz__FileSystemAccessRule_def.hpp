...
public:
  ...
  /// @brief Method .ctor, addr 0x3cc0a6c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x3cc0a74, size 0x8, virtual false, abstract: false, final false
