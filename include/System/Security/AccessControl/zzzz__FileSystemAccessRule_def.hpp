...
public:
  ...
  /// @brief Method .ctor, addr 0x2706eb4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x2706ebc, size 0x8, virtual false, abstract: false, final false
