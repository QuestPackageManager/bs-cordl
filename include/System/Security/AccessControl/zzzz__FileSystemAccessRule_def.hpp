...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::FileSystemAccessRule*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::FileSystemAccessRule*, "System.Security.AccessControl", "FileSystemAccessRule");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5b1f68c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x5b1f690, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FileSystemAccessRule", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FileSystemAccessRule(FileSystemAccessRule&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FileSystemAccessRule", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FileSystemAccessRule(FileSystemAccessRuleconst&) = delete;
...
static_assert(sizeof(::System::Security::AccessControl::FileSystemAccessRule) == 0x30, "Size mismatch!");
