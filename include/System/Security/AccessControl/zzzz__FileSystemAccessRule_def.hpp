...
public:
  ...
  /// @brief Method .ctor, addr 0x3cca06c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x3cca074, size 0x8, virtual false, abstract: false, final false
