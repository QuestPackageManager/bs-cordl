...
public:
  ...
  /// @brief Method .ctor, addr 0x5b1d38c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x5b1d390, size 0x8, virtual false, abstract: false, final false
