...
public:
  ...
  /// @brief Method .ctor, addr 0x3cd2f70, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x3cd2f78, size 0x8, virtual false, abstract: false, final false
