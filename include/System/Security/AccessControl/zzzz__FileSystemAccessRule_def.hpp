...
public:
  ...
  /// @brief Method .ctor, addr 0x3cc7414, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x3cc741c, size 0x8, virtual false, abstract: false, final false
