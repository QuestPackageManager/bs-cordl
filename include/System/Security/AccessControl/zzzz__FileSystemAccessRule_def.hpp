...
public:
  ...
  /// @brief Method .ctor, addr 0x2701eb8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FileSystemRights, addr 0x2701ec0, size 0x8, virtual false, abstract: false, final false
