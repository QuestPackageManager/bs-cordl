...
public:
  ...
  /// @brief Method .ctor, addr 0x3cbdd44, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessMask, addr 0x3cbdf9c, size 0x8, virtual false, abstract: false, final false
