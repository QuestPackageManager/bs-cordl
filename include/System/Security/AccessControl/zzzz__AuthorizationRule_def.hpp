...
public:
  ...
  /// @brief Method .ctor, addr 0x25d6cd8, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessMask, addr 0x25d6f48, size 0x8, virtual false, abstract: false, final false
