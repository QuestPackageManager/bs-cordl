...
public:
  ...
  /// @brief Method .ctor, addr 0x26ff07c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessMask, addr 0x26ff2ec, size 0x8, virtual false, abstract: false, final false
