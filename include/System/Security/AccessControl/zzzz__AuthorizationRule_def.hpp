...
public:
  ...
  /// @brief Method .ctor, addr 0x59dee28, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessMask, addr 0x59df05c, size 0x8, virtual false, abstract: false, final false
