...
public:
  ...
  /// @brief Method .ctor, addr 0x3cc2cb8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessMask, addr 0x3cc2f10, size 0x8, virtual false, abstract: false, final false
