...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3cc2ad8, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc2a04, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cc2a50, size 0x88, virtual false, abstract: false, final false
