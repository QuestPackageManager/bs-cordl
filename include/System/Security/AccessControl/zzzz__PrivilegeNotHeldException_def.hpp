...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3cbdbdc, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cbdb08, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cbdb54, size 0x88, virtual false, abstract: false, final false
