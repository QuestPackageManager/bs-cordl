...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::PrivilegeNotHeldException*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::PrivilegeNotHeldException*, "System.Security.AccessControl", "PrivilegeNotHeldException");
// Dependencies System.UnauthorizedAccessException
namespace System::Security::AccessControl {
// Is value type: false
...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b1c828, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1c73c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b1c798, size 0x90, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrivilegeNotHeldException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrivilegeNotHeldException(PrivilegeNotHeldException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrivilegeNotHeldException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrivilegeNotHeldException(PrivilegeNotHeldExceptionconst&) = delete;
...
static_assert(sizeof(::System::Security::AccessControl::PrivilegeNotHeldException) == 0x98, "Size mismatch!");
