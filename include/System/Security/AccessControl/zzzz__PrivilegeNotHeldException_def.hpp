...
public:
  ...
  /// @brief Method GetObjectData, addr 0x59dece0, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59debf4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59dec50, size 0x90, virtual false, abstract: false, final false
