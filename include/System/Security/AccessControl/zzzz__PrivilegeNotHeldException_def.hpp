...
public:
  ...
  /// @brief Method GetObjectData, addr 0x5b1a528, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1a43c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b1a498, size 0x90, virtual false, abstract: false, final false
