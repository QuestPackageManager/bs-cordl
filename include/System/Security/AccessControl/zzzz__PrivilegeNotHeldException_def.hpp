...
public:
  ...
  /// @brief Method GetObjectData, addr 0x25d6b6c, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d6a98, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25d6ae4, size 0x88, virtual false, abstract: false, final false
