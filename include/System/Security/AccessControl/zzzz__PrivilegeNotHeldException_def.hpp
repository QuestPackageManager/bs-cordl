...
public:
  ...
  /// @brief Method GetObjectData, addr 0x3cd00e0, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cd000c, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cd0058, size 0x88, virtual false, abstract: false, final false
