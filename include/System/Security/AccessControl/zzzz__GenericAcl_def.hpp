...
public:
  ...
  /// @brief Method CopyTo, addr 0x5b1da30, size 0x184, virtual false, abstract: false, final false
  inline void CopyTo(::ArrayW<::System::Security::AccessControl::GenericAce*> array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x5b1b9f0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x5b1dbb4, size 0x88, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5b1dc3c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x5b1b0e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsSynchronized, addr 0x5b1da24, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_SyncRoot, addr 0x5b1da2c, size 0x4, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::AccessControl::GenericAcl) == 0x10, "Size mismatch!");
