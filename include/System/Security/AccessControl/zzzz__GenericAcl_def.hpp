...
public:
  ...
  /// @brief Method .ctor addr 0x2481250 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method get_Count addr 0x0 size 0xffffffffffffffff virtual true final false
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized addr 0x2483cb0 size 0x8 virtual true final true
  ...
  /// @brief Method get_SyncRoot addr 0x2483cb8 size 0x4 virtual true final false
  inline ::System::Object* get_SyncRoot();

  /// @brief Method CopyTo addr 0x2483cbc size 0x18c virtual false final false
  ...
  /// @brief Method System.Collections.ICollection.CopyTo addr 0x2483e48 size 0x84 virtual true final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator addr 0x2481b3c size 0x6c virtual false final false
  inline ::System::Security::AccessControl::AceEnumerator* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2483ecc size 0x4 virtual true final true
