...
public:
  // Declarations
  /// @brief Method GetAccessRules, addr 0x28039e0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28038d8, size 0xc, virtual false, abstract: false, final false
