...
public:
  // Declarations
  /// @brief Method GetAccessRules, addr 0x3cc6b60, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc6a64, size 0xc, virtual false, abstract: false, final false
