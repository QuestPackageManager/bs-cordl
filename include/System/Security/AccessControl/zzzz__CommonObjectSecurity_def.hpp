...
public:
  // Declarations
  /// @brief Method GetAccessRules, addr 0x281e06c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x281df64, size 0xc, virtual false, abstract: false, final false
