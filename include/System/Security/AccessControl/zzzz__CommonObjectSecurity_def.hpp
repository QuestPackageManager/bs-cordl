...
public:
  // Declarations
  /// @brief Method GetAccessRules, addr 0x59e12e4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59e11f8, size 0x8, virtual false, abstract: false, final false
