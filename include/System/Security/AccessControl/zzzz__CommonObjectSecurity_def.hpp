...
public:
  // Declarations
  /// @brief Method GetAccessRules, addr 0x3cc01b8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc00bc, size 0xc, virtual false, abstract: false, final false
