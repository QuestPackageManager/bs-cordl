...
public:
  // Declarations
  /// @brief Method GetAccessRules, addr 0x3cc50b4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc4fb8, size 0xc, virtual false, abstract: false, final false
