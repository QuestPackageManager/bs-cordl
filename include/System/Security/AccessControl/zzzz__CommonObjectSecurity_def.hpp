...
public:
  // Declarations
  /// @brief Method GetAccessRules, addr 0x25d9244, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d913c, size 0xc, virtual false, abstract: false, final false
