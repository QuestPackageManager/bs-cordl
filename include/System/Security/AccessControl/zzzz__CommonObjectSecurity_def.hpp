...
public:
  // Declarations
  /// @brief Method GetAccessRules, addr 0x27015e8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27014e0, size 0xc, virtual false, abstract: false, final false
