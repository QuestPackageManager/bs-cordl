...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::ObjectAce*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::ObjectAce*, "System.Security.AccessControl", "ObjectAce");
...
public:
  ...
  /// @brief Method ConvertType, addr 0x5b203d4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBinaryForm, addr 0x5b2061c, size 0x16c, virtual true, abstract: false, final false
  ...
  static inline ::System::Security::AccessControl::ObjectAce* New_ctor(::ArrayW<uint8_t> binaryForm, int32_t offset);

  /// @brief Method ReadGuid, addr 0x5b204f8, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Guid ReadGuid(::ArrayW<uint8_t> buffer, int32_t offset);

  /// @brief Method WriteGuid, addr 0x5b20788, size 0x4c, virtual false, abstract: false, final false
  inline void WriteGuid(::System::Guid val, ::ArrayW<uint8_t> buffer, int32_t offset);
  ...
  /// @brief Method .ctor, addr 0x5b1e64c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1f914, size 0x260, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> binaryForm, int32_t offset);

  /// @brief Method get_BinaryLength, addr 0x5b20594, size 0x50, virtual true, abstract: false, final false
  inline int32_t get_BinaryLength();

  /// @brief Method get_InheritedObjectAceType, addr 0x5b205e4, size 0xc, virtual false, abstract: false, final false
  inline ::System::Guid get_InheritedObjectAceType();

  /// @brief Method get_InheritedObjectAceTypePresent, addr 0x5b204ec, size 0xc, virtual false, abstract: false, final false
  inline bool get_InheritedObjectAceTypePresent();

  /// @brief Method get_ObjectAceFlags, addr 0x5b205f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::ObjectAceFlags get_ObjectAceFlags();

  /// @brief Method get_ObjectAceType, addr 0x5b20608, size 0xc, virtual false, abstract: false, final false
  inline ::System::Guid get_ObjectAceType();

  /// @brief Method get_ObjectAceTypePresent, addr 0x5b204e0, size 0xc, virtual false, abstract: false, final false
  inline bool get_ObjectAceTypePresent();

  /// @brief Method set_InheritedObjectAceType, addr 0x5b205f0, size 0x8, virtual false, abstract: false, final false
  inline void set_InheritedObjectAceType(::System::Guid value);

  /// @brief Method set_ObjectAceFlags, addr 0x5b20600, size 0x8, virtual false, abstract: false, final false
  inline void set_ObjectAceFlags(::System::Security::AccessControl::ObjectAceFlags value);

  /// @brief Method set_ObjectAceType, addr 0x5b20614, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectAce", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectAce(ObjectAce&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectAce", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectAce(ObjectAceconst&) = delete;
...
static_assert(sizeof(::System::Security::AccessControl::ObjectAce) == 0x50, "Size mismatch!");
