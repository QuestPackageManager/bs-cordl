...
/// @brief Method ConvertType, addr 0x59e4404, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method GetBinaryForm, addr 0x59e464c, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method ReadGuid, addr 0x59e4528, size 0x9c, virtual false, abstract: false, final false
inline ::System::Guid ReadGuid(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method WriteGuid, addr 0x59e47b8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59e267c, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::System::Security::AccessControl::AceFlags  aceFlags, ::System::Security::AccessControl::AceQualifier  qualifier, int32_t  accessMask, ::System::Security::Principal::SecurityIdentifier*  sid, ::System::Security::AccessControl::ObjectAceFlags  flags, ::System::Guid  type, ::System::Guid  inheritedType, bool  isCallback, ::ArrayW<uint8_t,::Array<uint8_t>*>  opaque) ;

/// @brief Method .ctor, addr 0x59e3944, size 0x260, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  binaryForm, int32_t  offset) ;

/// @brief Method get_BinaryLength, addr 0x59e45c4, size 0x50, virtual true, abstract: false, final false
inline int32_t get_BinaryLength() ;

/// @brief Method get_InheritedObjectAceType, addr 0x59e4614, size 0xc, virtual false, abstract: false, final false
inline ::System::Guid get_InheritedObjectAceType() ;

/// @brief Method get_InheritedObjectAceTypePresent, addr 0x59e451c, size 0xc, virtual false, abstract: false, final false
inline bool get_InheritedObjectAceTypePresent() ;

/// @brief Method get_ObjectAceFlags, addr 0x59e4628, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::AccessControl::ObjectAceFlags get_ObjectAceFlags() ;

/// @brief Method get_ObjectAceType, addr 0x59e4638, size 0xc, virtual false, abstract: false, final false
inline ::System::Guid get_ObjectAceType() ;

/// @brief Method get_ObjectAceTypePresent, addr 0x59e4510, size 0xc, virtual false, abstract: false, final false
inline bool get_ObjectAceTypePresent() ;

/// @brief Method set_InheritedObjectAceType, addr 0x59e4620, size 0x8, virtual false, abstract: false, final false
inline void set_InheritedObjectAceType(::System::Guid  value) ;

/// @brief Method set_ObjectAceFlags, addr 0x59e4630, size 0x8, virtual false, abstract: false, final false
inline void set_ObjectAceFlags(::System::Security::AccessControl::ObjectAceFlags  value) ;

/// @brief Method set_ObjectAceType, addr 0x59e4644, size 0x8, virtual false, abstract: false, final false
