...
public:
  ...
  /// @brief Method .ctor, addr 0x24824ac, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24838ac, size 0x264, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method get_BinaryLength, addr 0x2484584, size 0x54, virtual true, abstract: false, final false
  inline int32_t get_BinaryLength();

  /// @brief Method get_InheritedObjectAceType, addr 0x24845d8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Guid get_InheritedObjectAceType();

  /// @brief Method set_InheritedObjectAceType, addr 0x24845e4, size 0x8, virtual false, abstract: false, final false
  inline void set_InheritedObjectAceType(::System::Guid value);

  /// @brief Method get_InheritedObjectAceTypePresent, addr 0x24844e0, size 0xc, virtual false, abstract: false, final false
  inline bool get_InheritedObjectAceTypePresent();

  /// @brief Method get_ObjectAceFlags, addr 0x24845ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::ObjectAceFlags get_ObjectAceFlags();

  /// @brief Method set_ObjectAceFlags, addr 0x24845f4, size 0x8, virtual false, abstract: false, final false
  inline void set_ObjectAceFlags(::System::Security::AccessControl::ObjectAceFlags value);

  /// @brief Method get_ObjectAceType, addr 0x24845fc, size 0xc, virtual false, abstract: false, final false
  inline ::System::Guid get_ObjectAceType();

  /// @brief Method set_ObjectAceType, addr 0x2484608, size 0x8, virtual false, abstract: false, final false
  inline void set_ObjectAceType(::System::Guid value);

  /// @brief Method get_ObjectAceTypePresent, addr 0x24844d4, size 0xc, virtual false, abstract: false, final false
  inline bool get_ObjectAceTypePresent();

  /// @brief Method GetBinaryForm, addr 0x2484610, size 0x16c, virtual true, abstract: false, final false
  inline void GetBinaryForm(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method ConvertType, addr 0x24843c4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteGuid, addr 0x248477c, size 0x4c, virtual false, abstract: false, final false
  inline void WriteGuid(::System::Guid val, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method ReadGuid, addr 0x24844ec, size 0x98, virtual false, abstract: false, final false
