...
public:
  ...
  /// @brief Method .ctor, addr 0x24a2aa4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24a2c3c, size 0x1f0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method get_BinaryLength, addr 0x24a2f8c, size 0x38, virtual true, abstract: false, final false
  inline int32_t get_BinaryLength();

  /// @brief Method GetBinaryForm, addr 0x24a2fdc, size 0xe4, virtual true, abstract: false, final false
  inline void GetBinaryForm(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method ConvertType, addr 0x24a2b04, size 0x110, virtual false, abstract: false, final false
