...
public:
  ...
  /// @brief Method ConvertType, addr 0x3cc49f4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBinaryForm, addr 0x3cc4ec0, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc4b28, size 0x1e8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x3cc4994, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BinaryLength, addr 0x3cc4e70, size 0x38, virtual true, abstract: false, final false
