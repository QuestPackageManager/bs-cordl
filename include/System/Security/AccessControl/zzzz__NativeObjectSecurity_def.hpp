...
public:
// Declarations
/// @brief Method Invoke, addr 0x59e43f0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59e434c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Field exception_from_error_code, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_exception_from_error_code, put=__cordl_internal_set_exception_from_error_code)) ::System::Security::AccessControl::NativeObjectSecurity_ExceptionFromErrorCode*  exception_from_error_code;

/// @brief Method ClearAccessControlSectionsModified, addr 0x59e40cc, size 0xa4, virtual false, abstract: false, final false
inline void ClearAccessControlSectionsModified() ;

/// @brief Method DefaultExceptionFromErrorCode, addr 0x59e41b0, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method InternalGet, addr 0x59e43b8, size 0x38, virtual true, abstract: false, final false
inline int32_t InternalGet(::StringW  name, ::System::Security::AccessControl::AccessControlSections  includeSections) ;

static inline ::System::Security::AccessControl::NativeObjectSecurity* New_ctor(bool  isContainer, ::System::Security::AccessControl::ResourceType  resourceType, ::System::Security::AccessControl::NativeObjectSecurity_ExceptionFromErrorCode*  exceptionFromErrorCode, ::System::Object*  exceptionContext) ;
...
/// @brief Method RaiseExceptionOnFailure, addr 0x59e4030, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59e3f98, size 0x28, virtual false, abstract: false, final false
inline void _ctor(bool  isContainer, ::System::Security::AccessControl::ResourceType  resourceType, ::System::Security::AccessControl::NativeObjectSecurity_ExceptionFromErrorCode*  exceptionFromErrorCode, ::System::Object*  exceptionContext) ;

/// @brief Method .ctor, addr 0x59e36c8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59e3fc0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(bool  isContainer, ::System::Security::AccessControl::ResourceType  resourceType, ::StringW  name, ::System::Security::AccessControl::AccessControlSections  includeSections, ::System::Security::AccessControl::NativeObjectSecurity_ExceptionFromErrorCode*  exceptionFromErrorCode, ::System::Object*  exceptionContext) ;
