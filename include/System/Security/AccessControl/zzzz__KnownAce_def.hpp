...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KnownAce", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KnownAce(KnownAce&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KnownAce", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KnownAce(KnownAceconst&) = delete;
