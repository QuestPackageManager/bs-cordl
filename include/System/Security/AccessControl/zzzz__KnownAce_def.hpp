...
public:
  ...
  /// @brief Method .ctor addr 0x2483ed0 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2483ed4 size 0x4 virtual false final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method get_AccessMask addr 0x2483ed8 size 0x8 virtual false final false
  inline int32_t get_AccessMask();

  /// @brief Method set_AccessMask addr 0x2483ee0 size 0x8 virtual false final false
  inline void set_AccessMask(int32_t value);

  /// @brief Method get_SecurityIdentifier addr 0x2483ee8 size 0x8 virtual false final false
  inline ::System::Security::Principal::SecurityIdentifier* get_SecurityIdentifier();

  /// @brief Method set_SecurityIdentifier addr 0x2483ef0 size 0x8 virtual false final false
