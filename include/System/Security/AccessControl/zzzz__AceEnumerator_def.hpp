...
public:
  ...
  /// @brief Method MoveNext, addr 0x2801680, size 0x58, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Security::AccessControl::AceEnumerator* New_ctor(::System::Security::AccessControl::GenericAcl* owner);

  /// @brief Method Reset, addr 0x28016d8, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x280167c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2801618, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::AccessControl::GenericAcl* owner);

  /// @brief Method get_Current, addr 0x2801648, size 0x34, virtual false, abstract: false, final false
