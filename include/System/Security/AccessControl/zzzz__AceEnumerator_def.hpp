...
public:
  ...
  /// @brief Method .ctor addr 0x2480914 size 0x30 virtual false final false
  inline void _ctor(::System::Security::AccessControl::GenericAcl* owner);

  /// @brief Method get_Current addr 0x2480944 size 0x34 virtual false final false
  inline ::System::Security::AccessControl::GenericAce* get_Current();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x2480978 size 0x4 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method MoveNext addr 0x248097c size 0x58 virtual true final true
  inline bool MoveNext();

  /// @brief Method Reset addr 0x24809d4 size 0xc virtual true final true
  inline void Reset();
