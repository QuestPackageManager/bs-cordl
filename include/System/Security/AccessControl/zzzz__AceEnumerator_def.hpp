...
public:
  ...
  /// @brief Method MoveNext, addr 0x2704284, size 0x58, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Security::AccessControl::AceEnumerator* New_ctor(::System::Security::AccessControl::GenericAcl* owner);

  /// @brief Method Reset, addr 0x27042dc, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2704280, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x270421c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::AccessControl::GenericAcl* owner);

  /// @brief Method get_Current, addr 0x270424c, size 0x34, virtual false, abstract: false, final false
