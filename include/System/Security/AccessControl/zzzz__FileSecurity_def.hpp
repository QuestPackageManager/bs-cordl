...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::FileSecurity*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::FileSecurity*, "System.Security.AccessControl", "FileSecurity");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5b1f674, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::AccessControl::FileSecurity) == 0x30, "Size mismatch!");
