...
public:
  ...
  /// @brief Method .ctor, addr 0x3cc72b8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x3cc74cc, size 0x8, virtual false, abstract: false, final false
