...
public:
  ...
  /// @brief Method .ctor, addr 0x5b1a5e8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x5b1a7fc, size 0x8, virtual false, abstract: false, final false
