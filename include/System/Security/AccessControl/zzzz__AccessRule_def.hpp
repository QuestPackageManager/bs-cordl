...
public:
  ...
  /// @brief Method .ctor, addr 0x3cc2c2c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x3cc2e40, size 0x8, virtual false, abstract: false, final false
