...
public:
  ...
  /// @brief Method .ctor, addr 0x59deda0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x59defb4, size 0x8, virtual false, abstract: false, final false
