...
public:
  ...
  /// @brief Method .ctor, addr 0x25d6c48, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x25d6e74, size 0x8, virtual false, abstract: false, final false
