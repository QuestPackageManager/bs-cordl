...
public:
  ...
  /// @brief Method .ctor, addr 0x3cc4660, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x3cc4874, size 0x8, virtual false, abstract: false, final false
