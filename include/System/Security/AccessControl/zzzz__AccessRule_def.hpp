...
public:
  ...
  /// @brief Method .ctor, addr 0x281ba70, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x281bc9c, size 0x8, virtual false, abstract: false, final false
