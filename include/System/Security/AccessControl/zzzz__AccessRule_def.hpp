...
public:
  ...
  /// @brief Method .ctor, addr 0x257444c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x2574678, size 0x8, virtual false, abstract: false, final false
