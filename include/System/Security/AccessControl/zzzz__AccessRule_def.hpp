...
public:
  ...
  /// @brief Method .ctor, addr 0x596c928, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x596cb3c, size 0x8, virtual false, abstract: false, final false
