...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::AccessRule*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::AccessRule*, "System.Security.AccessControl", "AccessRule");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AccessRule", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AccessRule(AccessRule&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AccessRule", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AccessRule(AccessRuleconst&) = delete;
...
static_assert(sizeof(::System::Security::AccessControl::AccessRule) == 0x30, "Size mismatch!");
