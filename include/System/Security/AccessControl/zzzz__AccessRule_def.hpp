...
public:
  ...
  /// @brief Method .ctor, addr 0x26fefec, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccessControlType, addr 0x26ff218, size 0x8, virtual false, abstract: false, final false
