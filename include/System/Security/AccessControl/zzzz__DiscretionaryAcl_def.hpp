...
public:
  // Declarations
  /// @brief Method AddAccess, addr 0x3cc561c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x3cc57e4, size 0x48, virtual true, abstract: false, final false
  inline void ApplyCanonicalSortToExplicitAces();

  /// @brief Method GetAceInsertPosition, addr 0x3cc582c, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetAceInsertPosition(::System::Security::AccessControl::AceQualifier aceQualifier);

  /// @brief Method GetAceQualifier, addr 0x3cc5788, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAceMeaningless, addr 0x3cc583c, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc5610, size 0xc, virtual false, abstract: false, final false
