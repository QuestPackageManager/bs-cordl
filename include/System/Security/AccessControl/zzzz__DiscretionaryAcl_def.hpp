...
public:
  // Declarations
  /// @brief Method AddAccess, addr 0x25d97bc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x25d9990, size 0x48, virtual true, abstract: false, final false
  inline void ApplyCanonicalSortToExplicitAces();

  /// @brief Method GetAceInsertPosition, addr 0x25d99d8, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetAceInsertPosition(::System::Security::AccessControl::AceQualifier aceQualifier);

  /// @brief Method GetAceQualifier, addr 0x25d9930, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAceMeaningless, addr 0x25d99e8, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d97b0, size 0xc, virtual false, abstract: false, final false
