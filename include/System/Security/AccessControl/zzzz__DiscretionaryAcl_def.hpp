...
public:
// Declarations
/// @brief Method AddAccess, addr 0x59e3368, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x59e3534, size 0x48, virtual true, abstract: false, final false
inline void ApplyCanonicalSortToExplicitAces() ;

/// @brief Method GetAceInsertPosition, addr 0x59e357c, size 0x10, virtual true, abstract: false, final false
inline int32_t GetAceInsertPosition(::System::Security::AccessControl::AceQualifier  aceQualifier) ;

/// @brief Method GetAceQualifier, addr 0x59e34dc, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method IsAceMeaningless, addr 0x59e358c, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59e3364, size 0x4, virtual false, abstract: false, final false
