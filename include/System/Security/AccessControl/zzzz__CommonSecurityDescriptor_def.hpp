...
public:
  ...
  /// @brief Method CheckAclConsistency, addr 0x3cc0780, size 0xbc, virtual false, abstract: false, final false
  inline void CheckAclConsistency(::System::Security::AccessControl::CommonAcl* acl);

  /// @brief Method Init, addr 0x3cc0560, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc04e4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DiscretionaryAcl, addr 0x3cc070c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::DiscretionaryAcl* get_DiscretionaryAcl();

  /// @brief Method get_IsContainer, addr 0x3cc0844, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsContainer();

  /// @brief Method get_IsDS, addr 0x3cc084c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDS();

  /// @brief Method set_DiscretionaryAcl, addr 0x3cc0614, size 0xf8, virtual false, abstract: false, final false
  inline void set_DiscretionaryAcl(::System::Security::AccessControl::DiscretionaryAcl* value);

  /// @brief Method set_Group, addr 0x3cc083c, size 0x8, virtual true, abstract: false, final false
  inline void set_Group(::System::Security::Principal::SecurityIdentifier* value);

  /// @brief Method set_Owner, addr 0x3cc0854, size 0x8, virtual true, abstract: false, final false
  inline void set_Owner(::System::Security::Principal::SecurityIdentifier* value);

  /// @brief Method set_SystemAcl, addr 0x3cc05e4, size 0x30, virtual false, abstract: false, final false
