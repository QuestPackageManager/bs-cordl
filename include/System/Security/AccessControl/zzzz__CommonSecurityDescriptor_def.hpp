...
public:
  ...
  /// @brief Method CheckAclConsistency, addr 0x3cd2c84, size 0xbc, virtual false, abstract: false, final false
  inline void CheckAclConsistency(::System::Security::AccessControl::CommonAcl* acl);

  /// @brief Method Init, addr 0x3cd2a64, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cd29e8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DiscretionaryAcl, addr 0x3cd2c10, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::DiscretionaryAcl* get_DiscretionaryAcl();

  /// @brief Method get_IsContainer, addr 0x3cd2d48, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsContainer();

  /// @brief Method get_IsDS, addr 0x3cd2d50, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDS();

  /// @brief Method set_DiscretionaryAcl, addr 0x3cd2b18, size 0xf8, virtual false, abstract: false, final false
  inline void set_DiscretionaryAcl(::System::Security::AccessControl::DiscretionaryAcl* value);

  /// @brief Method set_Group, addr 0x3cd2d40, size 0x8, virtual true, abstract: false, final false
  inline void set_Group(::System::Security::Principal::SecurityIdentifier* value);

  /// @brief Method set_Owner, addr 0x3cd2d58, size 0x8, virtual true, abstract: false, final false
  inline void set_Owner(::System::Security::Principal::SecurityIdentifier* value);

  /// @brief Method set_SystemAcl, addr 0x3cd2ae8, size 0x30, virtual false, abstract: false, final false
