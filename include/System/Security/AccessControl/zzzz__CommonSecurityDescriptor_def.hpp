...
public:
  ...
  /// @brief Method CheckAclConsistency, addr 0x5b1d0a4, size 0xbc, virtual false, abstract: false, final false
  inline void CheckAclConsistency(::System::Security::AccessControl::CommonAcl* acl);

  /// @brief Method Init, addr 0x5b1ce78, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1ce70, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DiscretionaryAcl, addr 0x5b1d02c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::DiscretionaryAcl* get_DiscretionaryAcl();

  /// @brief Method get_IsContainer, addr 0x5b1d168, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsContainer();

  /// @brief Method get_IsDS, addr 0x5b1d170, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDS();

  /// @brief Method set_DiscretionaryAcl, addr 0x5b1cf28, size 0x104, virtual false, abstract: false, final false
  inline void set_DiscretionaryAcl(::System::Security::AccessControl::DiscretionaryAcl* value);

  /// @brief Method set_Group, addr 0x5b1d160, size 0x8, virtual true, abstract: false, final false
  inline void set_Group(::System::Security::Principal::SecurityIdentifier* value);

  /// @brief Method set_Owner, addr 0x5b1d178, size 0x8, virtual true, abstract: false, final false
  inline void set_Owner(::System::Security::Principal::SecurityIdentifier* value);

  /// @brief Method set_SystemAcl, addr 0x5b1cef8, size 0x30, virtual false, abstract: false, final false
