...
public:
  ...
  /// @brief Method GetOpaque, addr 0x596d2f0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOpaque, addr 0x596d058, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x596cfa4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x596cd88, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AceQualifier, addr 0x596dd94, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceQualifier get_AceQualifier();

  /// @brief Method get_IsCallback, addr 0x596e5e0, size 0x14, virtual false, abstract: false, final false
  inline bool get_IsCallback();

  /// @brief Method get_OpaqueLength, addr 0x596d12c, size 0x18, virtual false, abstract: false, final false
