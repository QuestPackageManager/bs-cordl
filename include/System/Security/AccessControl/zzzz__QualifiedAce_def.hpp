...
public:
  ...
  /// @brief Method GetOpaque, addr 0x3cc35c0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOpaque, addr 0x3cc331c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc3264, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x3cc3054, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AceQualifier, addr 0x3cc403c, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceQualifier get_AceQualifier();

  /// @brief Method get_IsCallback, addr 0x3cc4818, size 0x14, virtual false, abstract: false, final false
  inline bool get_IsCallback();

  /// @brief Method get_OpaqueLength, addr 0x3cc33fc, size 0x18, virtual false, abstract: false, final false
