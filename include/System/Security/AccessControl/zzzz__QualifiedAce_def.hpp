...
public:
  ...
  /// @brief Method GetOpaque, addr 0x3cbe6c4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOpaque, addr 0x3cbe420, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cbe368, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x3cbe158, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AceQualifier, addr 0x3cbf140, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceQualifier get_AceQualifier();

  /// @brief Method get_IsCallback, addr 0x3cbf91c, size 0x14, virtual false, abstract: false, final false
  inline bool get_IsCallback();

  /// @brief Method get_OpaqueLength, addr 0x3cbe500, size 0x18, virtual false, abstract: false, final false
