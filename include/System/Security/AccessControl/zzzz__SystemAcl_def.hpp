...
public:
  // Declarations
  /// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x3cd43d4, size 0x20, virtual true, abstract: false, final false
  inline void ApplyCanonicalSortToExplicitAces();

  /// @brief Method GetAceInsertPosition, addr 0x3cd43f4, size 0x8, virtual true, abstract: false, final false
