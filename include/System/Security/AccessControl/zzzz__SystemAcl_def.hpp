...
public:
  // Declarations
  /// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x3cc6e44, size 0x20, virtual true, abstract: false, final false
  inline void ApplyCanonicalSortToExplicitAces();

  /// @brief Method GetAceInsertPosition, addr 0x3cc6e64, size 0x8, virtual true, abstract: false, final false
