...
public:
  // Declarations
  /// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x3cc6dcc, size 0x20, virtual true, abstract: false, final false
  inline void ApplyCanonicalSortToExplicitAces();

  /// @brief Method GetAceInsertPosition, addr 0x3cc6dec, size 0x8, virtual true, abstract: false, final false
