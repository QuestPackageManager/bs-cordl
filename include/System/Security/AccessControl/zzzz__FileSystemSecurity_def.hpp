...
public:
  // Declarations
  /// @brief Method AccessRuleFactory, addr 0x3c4f9cc, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c4f7b4, size 0x18, virtual false, abstract: false, final false
