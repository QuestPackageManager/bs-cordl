...
public:
  // Declarations
  /// @brief Method AccessRuleFactory, addr 0x3cca08c, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3cc9e74, size 0x18, virtual false, abstract: false, final false
