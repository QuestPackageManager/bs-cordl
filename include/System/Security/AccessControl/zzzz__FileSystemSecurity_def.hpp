...
public:
  // Declarations
  /// @brief Method AccessRuleFactory, addr 0x59e1b5c, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59e1950, size 0x14, virtual false, abstract: false, final false
