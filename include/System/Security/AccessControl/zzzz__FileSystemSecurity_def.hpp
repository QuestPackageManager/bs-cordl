...
public:
  // Declarations
  /// @brief Method AccessRuleFactory, addr 0x5b1d3a4, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5b1d198, size 0x14, virtual false, abstract: false, final false
