...
public:
  // Declarations
  /// @brief Method AccessRuleFactory, addr 0x2706ed4, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2706cb8, size 0x18, virtual false, abstract: false, final false
