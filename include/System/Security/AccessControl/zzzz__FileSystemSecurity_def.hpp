...
public:
  // Declarations
  /// @brief Method AccessRuleFactory, addr 0x281e95c, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x281e740, size 0x18, virtual false, abstract: false, final false
