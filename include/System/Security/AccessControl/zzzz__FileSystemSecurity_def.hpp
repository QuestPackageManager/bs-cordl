...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::FileSystemSecurity*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::FileSystemSecurity*, "System.Security.AccessControl", "FileSystemSecurity");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FileSystemSecurity", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FileSystemSecurity(FileSystemSecurity&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FileSystemSecurity", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FileSystemSecurity(FileSystemSecurityconst&) = delete;
...
static_assert(sizeof(::System::Security::AccessControl::FileSystemSecurity) == 0x30, "Size mismatch!");
