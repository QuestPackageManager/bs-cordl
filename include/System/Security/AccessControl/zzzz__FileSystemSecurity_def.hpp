...
public:
// Declarations
/// @brief Method AccessRuleFactory, addr 0x59e36d4, size 0x9c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x59e34c8, size 0x14, virtual false, abstract: false, final false
