...
public:
  ...
  /// @brief Method .ctor, addr 0x5b1a8ac, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::AccessControl::AuthorizationRuleCollection) == 0x18, "Size mismatch!");
