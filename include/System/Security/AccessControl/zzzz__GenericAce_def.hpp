...
public:
  ...
  /// @brief Method CreateFromBinaryForm, addr 0x281dd9c, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x281eea0, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x281ef20, size 0xcc, virtual true, abstract: false, final true
  inline int32_t GetHashCode();

  /// @brief Method IsObjectType, addr 0x281ebfc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadInt, addr 0x281c18c, size 0x74, virtual false, abstract: false, final false
  static inline int32_t ReadInt(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method ReadUShort, addr 0x281c14c, size 0x40, virtual false, abstract: false, final false
  static inline uint16_t ReadUShort(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method WriteInt, addr 0x281c424, size 0x80, virtual false, abstract: false, final false
  static inline void WriteInt(int32_t val, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method WriteUShort, addr 0x281c3dc, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x281ea8c, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x281e9fc, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::AccessControl::AceType type, ::System::Security::AccessControl::AceFlags flags);

  /// @brief Method get_AceFlags, addr 0x281ebd0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceFlags get_AceFlags();

  /// @brief Method get_AceType, addr 0x281ebd8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceType get_AceType();

  /// @brief Method get_AuditFlags, addr 0x281e908, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InheritanceFlags, addr 0x281ebe0, size 0x10, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::InheritanceFlags get_InheritanceFlags();

  /// @brief Method get_IsInherited, addr 0x281cf38, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsInherited();

  /// @brief Method get_PropagationFlags, addr 0x281ebf0, size 0xc, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::PropagationFlags get_PropagationFlags();

  /// @brief Method op_Equality, addr 0x281d144, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x281cd84, size 0x148, virtual false, abstract: false, final false
