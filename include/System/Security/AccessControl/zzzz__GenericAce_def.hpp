...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::GenericAce*);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::GenericAce*, "System.Security.AccessControl", "GenericAce");
...
public:
  ...
  /// @brief Method CreateFromBinaryForm, addr 0x5b1c894, size 0x1ac, virtual false, abstract: false, final false
  static inline ::System::Security::AccessControl::GenericAce* CreateFromBinaryForm(::ArrayW<uint8_t> binaryForm, int32_t offset);

  /// @brief Method Equals, addr 0x5b1d874, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x5b1d900, size 0xcc, virtual true, abstract: false, final true
  inline int32_t GetHashCode();

  /// @brief Method IsObjectType, addr 0x5b1d5f4, size 0x20, virtual false, abstract: false, final false
  static inline bool IsObjectType(::System::Security::AccessControl::AceType type);

  static inline ::System::Security::AccessControl::GenericAce* New_ctor(::ArrayW<uint8_t> binaryForm, int32_t offset);
  ...
  /// @brief Method ReadInt, addr 0x5b1aca8, size 0x70, virtual false, abstract: false, final false
  static inline int32_t ReadInt(::ArrayW<uint8_t> buffer, int32_t offset);

  /// @brief Method ReadUShort, addr 0x5b1ac68, size 0x40, virtual false, abstract: false, final false
  static inline uint16_t ReadUShort(::ArrayW<uint8_t> buffer, int32_t offset);

  /// @brief Method WriteInt, addr 0x5b1af30, size 0x80, virtual false, abstract: false, final false
  static inline void WriteInt(int32_t val, ::ArrayW<uint8_t> buffer, int32_t offset);

  /// @brief Method WriteUShort, addr 0x5b1aee8, size 0x48, virtual false, abstract: false, final false
  static inline void WriteUShort(uint16_t val, ::ArrayW<uint8_t> buffer, int32_t offset);
  ...
  /// @brief Method .ctor, addr 0x5b1d4a4, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x5b1d440, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::AccessControl::AceType type, ::System::Security::AccessControl::AceFlags flags);

  /// @brief Method get_AceFlags, addr 0x5b1d5c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceFlags get_AceFlags();

  /// @brief Method get_AceType, addr 0x5b1d5d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceType get_AceType();

  /// @brief Method get_AuditFlags, addr 0x5b1d358, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InheritanceFlags, addr 0x5b1d5d8, size 0x10, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::InheritanceFlags get_InheritanceFlags();

  /// @brief Method get_IsInherited, addr 0x5b1ba48, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsInherited();

  /// @brief Method get_PropagationFlags, addr 0x5b1d5e8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::PropagationFlags get_PropagationFlags();

  /// @brief Method op_Equality, addr 0x5b1bc54, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x5b1b890, size 0x160, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::AccessControl::GenericAce) == 0x18, "Size mismatch!");
