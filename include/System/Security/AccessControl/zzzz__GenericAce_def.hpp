...
public:
  ...
  /// @brief Method CreateFromBinaryForm, addr 0x28307b0, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x28318b4, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x2831934, size 0xcc, virtual true, abstract: false, final true
  inline int32_t GetHashCode();

  /// @brief Method IsObjectType, addr 0x2831610, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadInt, addr 0x282eba0, size 0x74, virtual false, abstract: false, final false
  static inline int32_t ReadInt(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method ReadUShort, addr 0x282eb60, size 0x40, virtual false, abstract: false, final false
  static inline uint16_t ReadUShort(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method WriteInt, addr 0x282ee38, size 0x80, virtual false, abstract: false, final false
  static inline void WriteInt(int32_t val, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method WriteUShort, addr 0x282edf0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28314a0, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x2831410, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::AccessControl::AceType type, ::System::Security::AccessControl::AceFlags flags);

  /// @brief Method get_AceFlags, addr 0x28315e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceFlags get_AceFlags();

  /// @brief Method get_AceType, addr 0x28315ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceType get_AceType();

  /// @brief Method get_AuditFlags, addr 0x283131c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InheritanceFlags, addr 0x28315f4, size 0x10, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::InheritanceFlags get_InheritanceFlags();

  /// @brief Method get_IsInherited, addr 0x282f94c, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsInherited();

  /// @brief Method get_PropagationFlags, addr 0x2831604, size 0xc, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::PropagationFlags get_PropagationFlags();

  /// @brief Method op_Equality, addr 0x282fb58, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x282f798, size 0x148, virtual false, abstract: false, final false
