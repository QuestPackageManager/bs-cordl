...
public:
  ...
  /// @brief Method CreateFromBinaryForm, addr 0x5908288, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x5909268, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x59092f4, size 0xcc, virtual true, abstract: false, final true
  inline int32_t GetHashCode();

  /// @brief Method IsObjectType, addr 0x5908fe8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadInt, addr 0x590669c, size 0x70, virtual false, abstract: false, final false
  static inline int32_t ReadInt(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method ReadUShort, addr 0x590665c, size 0x40, virtual false, abstract: false, final false
  static inline uint16_t ReadUShort(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method WriteInt, addr 0x5906924, size 0x80, virtual false, abstract: false, final false
  static inline void WriteInt(int32_t val, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset);

  /// @brief Method WriteUShort, addr 0x59068dc, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5908e98, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> binaryForm, int32_t offset);

  /// @brief Method .ctor, addr 0x5908e34, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::AccessControl::AceType type, ::System::Security::AccessControl::AceFlags flags);

  /// @brief Method get_AceFlags, addr 0x5908fbc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceFlags get_AceFlags();

  /// @brief Method get_AceType, addr 0x5908fc4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::AceType get_AceType();

  /// @brief Method get_AuditFlags, addr 0x5908d4c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InheritanceFlags, addr 0x5908fcc, size 0x10, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::InheritanceFlags get_InheritanceFlags();

  /// @brief Method get_IsInherited, addr 0x590743c, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsInherited();

  /// @brief Method get_PropagationFlags, addr 0x5908fdc, size 0xc, virtual false, abstract: false, final false
  inline ::System::Security::AccessControl::PropagationFlags get_PropagationFlags();

  /// @brief Method op_Equality, addr 0x5907648, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x5907284, size 0x160, virtual false, abstract: false, final false
