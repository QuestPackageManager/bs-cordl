...
namespace System::Security::AccessControl {
template<typename T>
class CommonAcl_RemoveAcesCallback_1;
}
namespace System::Security::AccessControl {
class GenericAce;
}
...
// Declarations
template<typename T>
using RemoveAcesCallback_1 = ::System::Security::AccessControl::CommonAcl_RemoveAcesCallback_1<T>;
...
/// @brief Method AddAce, addr 0x59e28d4, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method AddAce, addr 0x59e29ac, size 0x78, virtual false, abstract: false, final false
inline void AddAce(::System::Security::AccessControl::QualifiedAce*  newAce) ;

/// @brief Method AddAceGetQualifiedAce, addr 0x59e28f0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x59e2710, size 0x1c4, virtual false, abstract: false, final false
inline void ApplyCanonicalSortToExplicitAces(int32_t  start, int32_t  count) ;

/// @brief Method CanonicalizeAndClearAefa, addr 0x59e1580, size 0xc8, virtual false, abstract: false, final false
inline void CanonicalizeAndClearAefa() ;

/// @brief Method CopyAce, addr 0x59e16a8, size 0x90, virtual false, abstract: false, final false
static inline ::System::Security::AccessControl::GenericAce* CopyAce(::System::Security::AccessControl::GenericAce*  ace) ;

/// @brief Method GetAceFlags, addr 0x59e2a24, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method GetCanonicalExplicitAceCount, addr 0x59e20e4, size 0x80, virtual false, abstract: false, final false
inline int32_t GetCanonicalExplicitAceCount() ;

/// @brief Method GetCanonicalExplicitDenyAceCount, addr 0x59e1e34, size 0x150, virtual false, abstract: false, final false
inline int32_t GetCanonicalExplicitDenyAceCount() ;

/// @brief Method GetObjectAceTypeGuids, addr 0x59e25e4, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x59e14c8, size 0x10, virtual false, abstract: false, final false
inline void Init(bool  isContainer, bool  isDS, ::System::Security::AccessControl::RawAcl*  rawAcl) ;

/// @brief Method IsAceMeaningless, addr 0x59e1ab0, size 0x110, virtual true, abstract: false, final false
inline bool IsAceMeaningless(::System::Security::AccessControl::GenericAce*  ace) ;

/// @brief Method MergeExplicitAcePair, addr 0x59e2164, size 0x408, virtual false, abstract: false, final false
...
/// @brief Method MergeExplicitAces, addr 0x59e1990, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method RequireCanonicity, addr 0x59e1770, size 0x58, virtual false, abstract: false, final false
inline void RequireCanonicity() ;

/// @brief Method TestCanonicity, addr 0x59e17c8, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59e14d8, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(bool  isContainer, bool  isDS, int32_t  capacity) ;

/// @brief Method .ctor, addr 0x59e1354, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(bool  isContainer, bool  isDS, uint8_t  revision, int32_t  capacity) ;

/// @brief Method get_Count, addr 0x59e1648, size 0x1c, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsCanonical, addr 0x59e1664, size 0x8, virtual false, abstract: false, final false
inline bool get_IsCanonical() ;

/// @brief Method get_IsContainer, addr 0x59e166c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsContainer() ;

/// @brief Method get_IsDS, addr 0x59e1674, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDS() ;

/// @brief Method get_Item, addr 0x59e1684, size 0x24, virtual true, abstract: false, final true
inline ::System::Security::AccessControl::GenericAce* get_Item(int32_t  index) ;

/// @brief Method set_IsAefa, addr 0x59e167c, size 0x8, virtual false, abstract: false, final false
inline void set_IsAefa(bool  value) ;

/// @brief Method set_Item, addr 0x59e1738, size 0x38, virtual true, abstract: false, final true
