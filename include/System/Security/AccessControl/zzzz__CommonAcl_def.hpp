...
// Write type traits
MARK_REF_T(::System::Security::AccessControl::CommonAcl*);
MARK_GEN_REF_T_PTR(::System::Security::AccessControl::CommonAcl_RemoveAcesCallback_1);
DEFINE_IL2CPP_CLASS(::System::Security::AccessControl::CommonAcl*, "System.Security.AccessControl", "CommonAcl");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Security::AccessControl::CommonAcl_RemoveAcesCallback_1, "System.Security.AccessControl", "CommonAcl/RemoveAcesCallback`1");
...
public:
  ...
  /// @brief Method AddAce, addr 0x5b1c5a4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAce, addr 0x5b1c67c, size 0x78, virtual false, abstract: false, final false
  inline void AddAce(::System::Security::AccessControl::QualifiedAce* newAce);

  /// @brief Method AddAceGetQualifiedAce, addr 0x5b1c5c0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyCanonicalSortToExplicitAces, addr 0x5b1c3e0, size 0x1c4, virtual false, abstract: false, final false
  inline void ApplyCanonicalSortToExplicitAces(int32_t start, int32_t count);

  /// @brief Method CanonicalizeAndClearAefa, addr 0x5b1b250, size 0xc8, virtual false, abstract: false, final false
  inline void CanonicalizeAndClearAefa();

  /// @brief Method CopyAce, addr 0x5b1b378, size 0x90, virtual false, abstract: false, final false
  static inline ::System::Security::AccessControl::GenericAce* CopyAce(::System::Security::AccessControl::GenericAce* ace);

  /// @brief Method GetAceFlags, addr 0x5b1c6f4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCanonicalExplicitAceCount, addr 0x5b1bdb4, size 0x80, virtual false, abstract: false, final false
  inline int32_t GetCanonicalExplicitAceCount();

  /// @brief Method GetCanonicalExplicitDenyAceCount, addr 0x5b1bb04, size 0x150, virtual false, abstract: false, final false
  inline int32_t GetCanonicalExplicitDenyAceCount();

  /// @brief Method GetObjectAceTypeGuids, addr 0x5b1c2b4, size 0x98, virtual false, abstract: false, final false
  static inline void GetObjectAceTypeGuids(::System::Security::AccessControl::ObjectAce* ace, ::by_ref<::System::Guid> type, ::by_ref<::System::Guid> inheritedType);

  /// @brief Method Init, addr 0x5b1b198, size 0x10, virtual false, abstract: false, final false
  inline void Init(bool isContainer, bool isDS, ::System::Security::AccessControl::RawAcl* rawAcl);

  /// @brief Method IsAceMeaningless, addr 0x5b1b780, size 0x110, virtual true, abstract: false, final false
  inline bool IsAceMeaningless(::System::Security::AccessControl::GenericAce* ace);

  /// @brief Method MergeExplicitAcePair, addr 0x5b1be34, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeExplicitAces, addr 0x5b1b660, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method RequireCanonicity, addr 0x5b1b440, size 0x58, virtual false, abstract: false, final false
  inline void RequireCanonicity();

  /// @brief Method TestCanonicity, addr 0x5b1b498, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1b1a8, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(bool isContainer, bool isDS, int32_t capacity);

  /// @brief Method .ctor, addr 0x5b1b024, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(bool isContainer, bool isDS, uint8_t revision, int32_t capacity);

  /// @brief Method get_Count, addr 0x5b1b318, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsCanonical, addr 0x5b1b334, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCanonical();

  /// @brief Method get_IsContainer, addr 0x5b1b33c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsContainer();

  /// @brief Method get_IsDS, addr 0x5b1b344, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDS();

  /// @brief Method get_Item, addr 0x5b1b354, size 0x24, virtual true, abstract: false, final true
  inline ::System::Security::AccessControl::GenericAce* get_Item(int32_t index);

  /// @brief Method set_IsAefa, addr 0x5b1b34c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsAefa(bool value);

  /// @brief Method set_Item, addr 0x5b1b408, size 0x38, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Security::AccessControl::CommonAcl) == 0x20, "Size mismatch!");
