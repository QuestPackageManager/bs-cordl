...
DEFINE_IL2CPP_CLASS(::System::Security::SecurityElementType, "System.Security", "SecurityElementType");
// Dependencies
namespace System::Security {
// Is value type: true
...
static_assert(sizeof(::System::Security::SecurityElementType) == 0x4, "Size mismatch!");
