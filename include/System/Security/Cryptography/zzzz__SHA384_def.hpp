...
public:
  // Declarations
  /// @brief Method Create, addr 0x5954ef0, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::SHA384* Create();

  static inline ::System::Security::Cryptography::SHA384* New_ctor();

  /// @brief Method .ctor, addr 0x5954ee4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
