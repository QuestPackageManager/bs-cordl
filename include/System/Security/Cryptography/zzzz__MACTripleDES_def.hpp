...
public:
  ...
  /// @brief Method Dispose, addr 0x27f9b1c, size 0x104, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method HashCore, addr 0x27f9758, size 0x170, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbData, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x27f9958, size 0x14c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x27f9750, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27f9620, size 0x130, virtual false, abstract: false, final false
  inline void _ctor();
