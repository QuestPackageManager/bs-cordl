...
public:
  ...
  /// @brief Method Dispose, addr 0x26e3094, size 0x104, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method HashCore, addr 0x26e2cd0, size 0x170, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbData, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x26e2ed0, size 0x14c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x26e2cc8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e2b98, size 0x130, virtual false, abstract: false, final false
  inline void _ctor();
