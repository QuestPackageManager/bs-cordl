...
public:
  ...
  /// @brief Method CreateDecryptor, addr 0x3ca2ebc, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x3ca2df4, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x3ca3000, size 0x6c, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x3ca2f84, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ca2c8c, size 0x160, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_EffectiveKeySize, addr 0x3ca2dec, size 0x8, virtual true, abstract: false, final false
