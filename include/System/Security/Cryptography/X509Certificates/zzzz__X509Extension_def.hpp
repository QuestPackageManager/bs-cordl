...
public:
  ...
  /// @brief Method CopyFrom, addr 0x4450984, size 0x124, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method FormatUnkownData, addr 0x4450aa8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4450940, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4450948, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::ArrayW<uint8_t, ::Array<uint8_t>*> rawData, bool critical);

  /// @brief Method get_Critical, addr 0x4450970, size 0x8, virtual false, abstract: false, final false
  inline bool get_Critical();

  /// @brief Method set_Critical, addr 0x4450978, size 0xc, virtual false, abstract: false, final false
