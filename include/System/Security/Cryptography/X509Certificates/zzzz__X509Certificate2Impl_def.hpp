...
public:
  ...
  /// @brief Method CopyWithPrivateKey, addr 0x2eaea88, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2eaeb34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
