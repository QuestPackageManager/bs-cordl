...
public:
  ...
  /// @brief Method CopyWithPrivateKey, addr 0x63a3b58, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a3c10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
