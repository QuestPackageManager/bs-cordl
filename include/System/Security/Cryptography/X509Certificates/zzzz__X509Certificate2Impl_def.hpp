...
public:
  ...
  /// @brief Method CopyWithPrivateKey, addr 0x63a9370, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a9428, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509Certificate2Impl", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509Certificate2Impl(X509Certificate2Impl&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509Certificate2Impl", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509Certificate2Impl(X509Certificate2Implconst&) = delete;
