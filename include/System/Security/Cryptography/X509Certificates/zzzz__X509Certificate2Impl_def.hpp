...
public:
  ...
  /// @brief Method CopyWithPrivateKey, addr 0x2ac85d8, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2ac8684, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
