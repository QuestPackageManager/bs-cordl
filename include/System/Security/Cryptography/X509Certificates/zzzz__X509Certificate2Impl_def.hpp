...
/// @brief Method CopyWithPrivateKey, addr 0x6267abc, size 0xb8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6267b74, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
