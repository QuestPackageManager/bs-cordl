...
public:
  ...
  /// @brief Method DecodeDSA, addr 0x4431f50, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeRSA, addr 0x4431bb4, size 0x39c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* DecodeRSA(::ArrayW<uint8_t, ::Array<uint8_t>*> rawPublicKey);

  /// @brief Method GetUnsignedBigInteger, addr 0x44323d8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4431898, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EncodedKeyValue, addr 0x4431a00, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnEncodedData* get_EncodedKeyValue();

  /// @brief Method get_EncodedParameters, addr 0x4431a08, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnEncodedData* get_EncodedParameters();

  /// @brief Method get_Key, addr 0x4431a10, size 0x1a4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsymmetricAlgorithm* get_Key();

  /// @brief Method get_Oid, addr 0x44323d0, size 0x8, virtual false, abstract: false, final false
