...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PublicKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PublicKey(PublicKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PublicKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PublicKey(PublicKeyconst&) = delete;
