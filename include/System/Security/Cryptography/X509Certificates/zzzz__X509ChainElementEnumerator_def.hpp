...
public:
  ...
  /// @brief Method MoveNext, addr 0x444cabc, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x444cb5c, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x444ca18, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x444c66c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* enumerable);

  /// @brief Method get_Current, addr 0x444c928, size 0xf0, virtual false, abstract: false, final false
