...
public:
  ...
  /// @brief Method MoveNext, addr 0x63a6ce8, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x63a6d8c, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63a6c40, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a688c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* enumerable);

  /// @brief Method get_Current, addr 0x63a6b48, size 0xf8, virtual false, abstract: false, final false
