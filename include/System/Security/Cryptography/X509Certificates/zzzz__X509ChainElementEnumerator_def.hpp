...
/// @brief Method MoveNext, addr 0x626ac4c, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x626acf0, size 0xa8, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x626aba4, size 0xa8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x626a7f0, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::IEnumerable*  enumerable) ;

/// @brief Method get_Current, addr 0x626aaac, size 0xf8, virtual false, abstract: false, final false
