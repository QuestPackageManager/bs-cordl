...
public:
  ...
  /// @brief Method MoveNext, addr 0x63ac500, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x63ac5a4, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63ac458, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63ac0a4, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* enumerable);

  /// @brief Method get_Current, addr 0x63ac360, size 0xf8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509ChainElementEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509ChainElementEnumerator(X509ChainElementEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509ChainElementEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509ChainElementEnumerator(X509ChainElementEnumeratorconst&) = delete;
