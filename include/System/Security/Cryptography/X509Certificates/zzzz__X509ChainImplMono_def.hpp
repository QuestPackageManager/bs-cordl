...
public:
  ...
  /// @brief Method AddStatus, addr 0x2eb2380, size 0x4, virtual true, abstract: false, final false
  inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags error);

  /// @brief Method Build, addr 0x2eb2384, size 0x5bc, virtual true, abstract: false, final false
  inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method BuildChainFrom, addr 0x2eb2940, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCrls, addr 0x2eb4e5c, size 0x394, virtual false, abstract: false, final false
  static inline ::Mono::Security::X509::X509Crl* CheckCrls(::StringW subject, ::StringW ski, ::Mono::Security::X509::X509Store* store);

  /// @brief Method CheckRevocation, addr 0x2eb43ec, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckRevocation, addr 0x2eb44b8, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckRevocationOnChain, addr 0x2eb3e54, size 0x1f0, virtual false, abstract: false, final false
  inline void CheckRevocationOnChain(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags flag);

  /// @brief Method FindCrl, addr 0x2eb4690, size 0x174, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Crl* FindCrl(::System::Security::Cryptography::X509Certificates::X509Certificate2* caCertificate);

  /// @brief Method FindParent, addr 0x2eb34ac, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAuthorityKeyIdentifier, addr 0x2eb3814, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAuthorityKeyIdentifier, addr 0x2eb4360, size 0x8c, virtual false, abstract: false, final false
  static inline ::StringW GetAuthorityKeyIdentifier(::Mono::Security::X509::X509Crl* crl);

  /// @brief Method GetAuthorityKeyIdentifier, addr 0x2eb4204, size 0x15c, virtual false, abstract: false, final false
  static inline ::StringW GetAuthorityKeyIdentifier(::Mono::Security::X509::X509Extension* ext);

  /// @brief Method GetSubjectKeyIdentifier, addr 0x2eb38ac, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW GetSubjectKeyIdentifier(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method IsChainComplete, addr 0x2eb35c0, size 0xc8, virtual false, abstract: false, final false
  inline bool IsChainComplete(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method IsSelfIssued, addr 0x2eb3964, size 0x48, virtual false, abstract: false, final false
  inline bool IsSelfIssued(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method IsSignedWith, addr 0x2eb40d0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareForNextCertificate, addr 0x2eb3c54, size 0x200, virtual false, abstract: false, final false
  inline void PrepareForNextCertificate(int32_t n);

  /// @brief Method Process, addr 0x2eb39ac, size 0x2a8, virtual false, abstract: false, final false
  inline void Process(int32_t n);

  /// @brief Method ProcessCertificateExtensions, addr 0x2eb410c, size 0xf8, virtual false, abstract: false, final false
  inline void ProcessCertificateExtensions(::System::Security::Cryptography::X509Certificates::X509ChainElement* element);

  /// @brief Method ProcessCrlEntryExtensions, addr 0x2eb4804, size 0x310, virtual false, abstract: false, final false
  inline bool ProcessCrlEntryExtensions(::Mono::Security::X509::__X509Crl__X509CrlEntry* entry);

  /// @brief Method ProcessCrlExtensions, addr 0x2eb4b14, size 0x348, virtual false, abstract: false, final false
  inline bool ProcessCrlExtensions(::Mono::Security::X509::X509Crl* crl);

  /// @brief Method Reset, addr 0x2eb2b5c, size 0xcc, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method SelectBestFromCollection, addr 0x2eb3688, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateChain, addr 0x2eb2a28, size 0x114, virtual false, abstract: false, final false
  inline void ValidateChain(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags flag);

  /// @brief Method WrapUp, addr 0x2eb4044, size 0x8c, virtual false, abstract: false, final false
  inline void WrapUp();
  ...
  /// @brief Method .ctor, addr 0x2eb2230, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CertificateAuthorities, addr 0x2eb2ed0, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_CertificateAuthorities();

  /// @brief Method get_CertificateCollection, addr 0x2eb3178, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_CertificateCollection();

  /// @brief Method get_ChainElements, addr 0x2eb230c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements();

  /// @brief Method get_ChainPolicy, addr 0x2eb2314, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy();

  /// @brief Method get_ChainStatus, addr 0x2eb231c, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method get_IsValid, addr 0x2eb2304, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_LMCAStore, addr 0x2eb2f90, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Store* get_LMCAStore();

  /// @brief Method get_LMRootStore, addr 0x2eb2ce8, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Store* get_LMRootStore();

  /// @brief Method get_Roots, addr 0x2eb2c28, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_Roots();

  /// @brief Method get_UserCAStore, addr 0x2eb3084, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Store* get_UserCAStore();

  /// @brief Method get_UserRootStore, addr 0x2eb2ddc, size 0xf4, virtual false, abstract: false, final false
