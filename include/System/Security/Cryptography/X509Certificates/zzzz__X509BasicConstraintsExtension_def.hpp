...
public:
  ...
  /// @brief Method CopyFrom, addr 0x2a62e3c, size 0x1dc, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method Decode, addr 0x2a6289c, size 0x1c4, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> extension);

  /// @brief Method Encode, addr 0x2a62ba0, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2a63018, size 0x298, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a627f4, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2a62a60, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(bool certificateAuthority, bool hasPathLengthConstraint, int32_t pathLengthConstraint, bool critical);

  /// @brief Method .ctor, addr 0x2a611bc, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::AsnEncodedData* encodedBasicConstraints, bool critical);

  /// @brief Method get_CertificateAuthority, addr 0x2a62cf8, size 0x6c, virtual false, abstract: false, final false
  inline bool get_CertificateAuthority();

  /// @brief Method get_HasPathLengthConstraint, addr 0x2a62d64, size 0x6c, virtual false, abstract: false, final false
  inline bool get_HasPathLengthConstraint();

  /// @brief Method get_PathLengthConstraint, addr 0x2a62dd0, size 0x6c, virtual false, abstract: false, final false
