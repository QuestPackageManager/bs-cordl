...
public:
  ...
  /// @brief Method .ctor addr 0x2808f04 size 0x9c virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x2808fa0 size 0xcc virtual false final false
  ...
  /// @brief Method .ctor addr 0x28091d0 size 0x1b8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x28093fc size 0x168 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2809654 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2809660 size 0x3cc virtual false final false
  ...
  /// @brief Method get_SubjectKeyIdentifier addr 0x2809a2c size 0x88 virtual false final false
  inline ::StringW get_SubjectKeyIdentifier();

  /// @brief Method CopyFrom addr 0x2809ab4 size 0x1e0 virtual true final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method FromHexChar addr 0x2809c94 size 0x48 virtual false final false
  static inline uint8_t FromHexChar(char16_t c);

  /// @brief Method FromHexChars addr 0x2809cdc size 0x9c virtual false final false
  static inline uint8_t FromHexChars(char16_t c1, char16_t c2);

  /// @brief Method FromHex addr 0x2809564 size 0xf0 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> FromHex(::StringW hex);

  /// @brief Method Decode addr 0x280906c size 0x164 virtual false final false
  inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> extension);

  /// @brief Method Encode addr 0x2809388 size 0x74 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encode();

  /// @brief Method ToString addr 0x2809d78 size 0x22c virtual true final false
