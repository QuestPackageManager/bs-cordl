...
/// @brief Method CopyFrom, addr 0x61fac68, size 0x1c4, virtual true, abstract: false, final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method Decode, addr 0x61fa6a8, size 0x270, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  extension) ;

/// @brief Method Encode, addr 0x61faaa0, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x61fae2c, size 0x318, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61fa558, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x61fa5e8, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::AsnEncodedData*  encodedEnhancedKeyUsages, bool  critical) ;

/// @brief Method .ctor, addr 0x61fa918, size 0x188, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::OidCollection*  enhancedKeyUsages, bool  critical) ;

/// @brief Method get_EnhancedKeyUsages, addr 0x61fab64, size 0x104, virtual false, abstract: false, final false
