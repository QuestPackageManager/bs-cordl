...
namespace System::Security::Cryptography::X509Certificates {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7848)), TypeDefinitionIndex(TypeDefinitionIndex(7813))}
...
public:
  ...
  /// @brief Method .ctor addr 0x27fd6f0 size 0xa8 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x27f99a4 size 0xd8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2806650 size 0x188 virtual false final false
  inline void _ctor(::System::Security::Cryptography::OidCollection* enhancedKeyUsages, bool critical);

  /// @brief Method CopyFrom addr 0x2806890 size 0x1dc virtual true final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method Decode addr 0x28063f0 size 0x260 virtual false final false
  inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> extension);

  /// @brief Method Encode addr 0x28067d8 size 0xb8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encode();

  /// @brief Method ToString addr 0x2806a6c size 0x2d4 virtual true final false
