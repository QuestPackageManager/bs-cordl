...
public:
  ...
  /// @brief Method CreateCustomExtensionIfAny, addr 0x4438ce4, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCertContentType, addr 0x4439394, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNameInfo, addr 0x443942c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x4438608, size 0x58, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x4439468, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x4439474, size 0xe90, virtual true, abstract: false, final false
  inline ::StringW ToString(bool verbose);

  /// @brief Method Verify, addr 0x443a304, size 0x2c, virtual false, abstract: false, final false
  inline bool Verify();
  ...
  /// @brief Method .ctor, addr 0x4438660, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4438840, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate* certificate);

  /// @brief Method .ctor, addr 0x4438838, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW fileName);

  /// @brief Method .ctor, addr 0x4438830, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* impl);

  /// @brief Method .ctor, addr 0x4438848, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x4438668, size 0x1c8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> rawData);

  /// @brief Method get_Extensions, addr 0x4438888, size 0x3d0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ExtensionCollection* get_Extensions();

  /// @brief Method get_HasPrivateKey, addr 0x4438eb0, size 0x34, virtual false, abstract: false, final false
  inline bool get_HasPrivateKey();

  /// @brief Method get_Impl, addr 0x4438c58, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* get_Impl();

  /// @brief Method get_IssuerName, addr 0x443903c, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName();

  /// @brief Method get_NotAfter, addr 0x4439098, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x44390a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_NotBefore();

  /// @brief Method get_PrivateKey, addr 0x4438ee4, size 0x158, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsymmetricAlgorithm* get_PrivateKey();

  /// @brief Method get_PublicKey, addr 0x44390a8, size 0x148, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::PublicKey* get_PublicKey();

  /// @brief Method get_RawData, addr 0x44391f0, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_RawData();

  /// @brief Method get_SerialNumber, addr 0x443924c, size 0x10, virtual false, abstract: false, final false
  inline ::StringW get_SerialNumber();

  /// @brief Method get_SignatureAlgorithm, addr 0x443925c, size 0x64, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::Oid* get_SignatureAlgorithm();

  /// @brief Method get_SubjectName, addr 0x44392c0, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName();

  /// @brief Method get_Thumbprint, addr 0x443931c, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Thumbprint();

  /// @brief Method get_Version, addr 0x4439338, size 0x5c, virtual false, abstract: false, final false
