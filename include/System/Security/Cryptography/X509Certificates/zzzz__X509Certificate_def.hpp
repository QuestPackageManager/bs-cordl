...
public:
  ...
  /// @brief Method Dispose, addr 0x3cc5320, size 0x10, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x3cc5330, size 0x14, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Equals, addr 0x3cc5344, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3cc53d8, size 0xf8, virtual true, abstract: false, final false
  inline bool Equals(::System::Security::Cryptography::X509Certificates::X509Certificate* other);

  /// @brief Method FormatDate, addr 0x3cc5bd8, size 0x148, virtual false, abstract: false, final false
  static inline ::StringW FormatDate(::System::DateTime date);

  /// @brief Method GetCertHash, addr 0x3cc5520, size 0x24, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetCertHash();

  /// @brief Method GetCertHashString, addr 0x3cc5590, size 0x24, virtual true, abstract: false, final false
  inline ::StringW GetCertHashString();

  /// @brief Method GetHashCode, addr 0x3cc55e8, size 0x70, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetKeyAlgorithm, addr 0x3cc5658, size 0x58, virtual true, abstract: false, final false
  inline ::StringW GetKeyAlgorithm();

  /// @brief Method GetKeyAlgorithmParameters, addr 0x3cc56b0, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetKeyAlgorithmParameters();

  /// @brief Method GetNotAfter, addr 0x3cc5d20, size 0x9c, virtual false, abstract: false, final false
  inline ::System::DateTime GetNotAfter();

  /// @brief Method GetNotBefore, addr 0x3cc5b3c, size 0x9c, virtual false, abstract: false, final false
  inline ::System::DateTime GetNotBefore();

  /// @brief Method GetPublicKey, addr 0x3cc570c, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPublicKey();

  /// @brief Method GetRawCertData, addr 0x3cc55b4, size 0x34, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetRawCertData();

  /// @brief Method GetRawCertHash, addr 0x3cc5544, size 0x4c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetRawCertHash();

  /// @brief Method GetRawSerialNumber, addr 0x3cc54d0, size 0x50, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetRawSerialNumber();

  /// @brief Method GetSerialNumber, addr 0x3cc5768, size 0x68, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSerialNumber();

  /// @brief Method GetSerialNumberString, addr 0x3cc57d0, size 0x24, virtual true, abstract: false, final false
  inline ::StringW GetSerialNumberString();

  /// @brief Method ImportHandle, addr 0x3cc5dbc, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3cc4864, size 0xb4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x3cc5238, size 0x38, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object* sender);

  /// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x3cc5200, size 0x38, virtual true, abstract: false, final true
  inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ThrowIfInvalid, addr 0x3cc52c4, size 0x8, virtual false, abstract: false, final false
  inline void ThrowIfInvalid();

  /// @brief Method ToString, addr 0x3cc57f4, size 0x14, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x3cc5808, size 0x320, virtual true, abstract: false, final false
  inline ::StringW ToString(bool fVerbose);

  /// @brief Method ValidateKeyStorageFlags, addr 0x3cc4e64, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc4988, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3cc5038, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x3cc49fc, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x3cc4bfc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW fileName);

  /// @brief Method .ctor, addr 0x3cc4c08, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cc4b44, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509CertificateImpl* impl);

  /// @brief Method .ctor, addr 0x3cc51c4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_Impl, addr 0x3cc5dec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* get_Impl();

  /// @brief Method get_IsValid, addr 0x3cc5df4, size 0x18, virtual false, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_Issuer, addr 0x3cc5270, size 0x54, virtual false, abstract: false, final false
  inline ::StringW get_Issuer();

  /// @brief Method get_Subject, addr 0x3cc52cc, size 0x54, virtual false, abstract: false, final false
