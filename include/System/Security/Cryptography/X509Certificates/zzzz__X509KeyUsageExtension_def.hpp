...
namespace System::Security::Cryptography::X509Certificates {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8976)), TypeDefinitionIndex(TypeDefinitionIndex(9011)), TypeDefinitionIndex(TypeDefinitionIndex(8984))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2985474 size 0x9c virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x2985510 size 0xcc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2985790 size 0xd8 virtual false final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509KeyUsageFlags keyUsages, bool critical);

  /// @brief Method get_KeyUsages addr 0x29859e0 size 0x6c virtual false final false
  inline ::System::Security::Cryptography::X509Certificates::X509KeyUsageFlags get_KeyUsages();

  /// @brief Method CopyFrom addr 0x2985a4c size 0x1e0 virtual true final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method GetValidFlags addr 0x2985868 size 0x10 virtual false final false
  ...
  /// @brief Method Decode addr 0x29855dc size 0x1b4 virtual false final false
  inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> extension);

  /// @brief Method Encode addr 0x2985878 size 0x168 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Encode();

  /// @brief Method ToString addr 0x2985c2c size 0x530 virtual true final false
