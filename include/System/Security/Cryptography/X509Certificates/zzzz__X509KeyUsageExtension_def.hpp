...
/// @brief Method CopyFrom, addr 0x62700f8, size 0x1c4, virtual true, abstract: false, final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method Decode, addr 0x626fcb8, size 0x1b0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  extension) ;

/// @brief Method Encode, addr 0x626ff40, size 0x154, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode() ;

/// @brief Method GetValidFlags, addr 0x626ff30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x62702bc, size 0x59c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x626fb6c, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x626fbf8, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::AsnEncodedData*  encodedKeyUsage, bool  critical) ;

/// @brief Method .ctor, addr 0x626fe68, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509KeyUsageFlags  keyUsages, bool  critical) ;

/// @brief Method get_KeyUsages, addr 0x6270094, size 0x64, virtual false, abstract: false, final false
