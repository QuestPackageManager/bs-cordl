...
public:
  ...
  /// @brief Method CopyFrom, addr 0x63b19ac, size 0x1c4, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method Decode, addr 0x63b156c, size 0x1b0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t> extension);

  /// @brief Method Encode, addr 0x63b17f4, size 0x154, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> Encode();

  /// @brief Method GetValidFlags, addr 0x63b17e4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x63b1b70, size 0x59c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63b1420, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63b14ac, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::AsnEncodedData* encodedKeyUsage, bool critical);

  /// @brief Method .ctor, addr 0x63b171c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509KeyUsageFlags keyUsages, bool critical);

  /// @brief Method get_KeyUsages, addr 0x63b1948, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509KeyUsageExtension", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509KeyUsageExtension(X509KeyUsageExtension&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509KeyUsageExtension", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509KeyUsageExtension(X509KeyUsageExtensionconst&) = delete;
