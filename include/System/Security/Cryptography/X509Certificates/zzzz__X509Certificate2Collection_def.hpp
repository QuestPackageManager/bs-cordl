...
public:
  ...
  /// @brief Method Add, addr 0x63a21c0, size 0x70, virtual false, abstract: false, final false
  inline int32_t Add(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method AddRange, addr 0x63a2020, size 0x70, virtual false, abstract: false, final false
  inline void AddRange(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* certificates);

  /// @brief Method Contains, addr 0x63a2230, size 0x314, virtual false, abstract: false, final false
  inline bool Contains(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method Find, addr 0x63a2614, size 0x1010, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x63a3624, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Enumerator* GetEnumerator();

  /// @brief Method GetKeyIdentifier, addr 0x63a2544, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63a1fe4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63a1ff4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x63a2090, size 0x130, virtual false, abstract: false, final false
