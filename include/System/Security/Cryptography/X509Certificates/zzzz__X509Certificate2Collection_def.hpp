...
public:
  ...
  /// @brief Method .ctor, addr 0x297efb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method .ctor, addr 0x297efc4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* certificates);

  /// @brief Method get_Item, addr 0x297f064, size 0x12c, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2* get_Item(int32_t index);

  /// @brief Method Add, addr 0x297f190, size 0x74, virtual false, abstract: false, final false
  inline int32_t Add(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method AddRange, addr 0x297eff0, size 0x74, virtual false, abstract: false, final false
  inline void AddRange(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* certificates);

  /// @brief Method Contains, addr 0x297f204, size 0x384, virtual false, abstract: false, final false
  inline bool Contains(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method GetKeyIdentifier, addr 0x297f588, size 0xcc, virtual false, abstract: false, final false
  inline ::StringW GetKeyIdentifier(::System::Security::Cryptography::X509Certificates::X509Certificate2* x);

  /// @brief Method Find, addr 0x297f654, size 0x1138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x298078c, size 0x60, virtual false, abstract: false, final false
