...
public:
  ...
  /// @brief Method Dispose, addr 0x61f5fd4, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x61f6b94, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x61f6b98, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method ThrowIfContextInvalid, addr 0x61f6b54, size 0x40, virtual false, abstract: false, final false
  inline void ThrowIfContextInvalid();

  /// @brief Method .ctor, addr 0x61f6be8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
