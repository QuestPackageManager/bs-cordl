...
public:
  ...
  /// @brief Method Close, addr 0x61fc7e4, size 0x1c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x61fc800, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method Open, addr 0x61fc81c, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61fc614, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificates, addr 0x61fc73c, size 0x84, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_Certificates();

  /// @brief Method get_Factory, addr 0x61fc7c0, size 0x1c, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Stores* get_Factory();

  /// @brief Method get_Store, addr 0x61fc7dc, size 0x8, virtual false, abstract: false, final false
