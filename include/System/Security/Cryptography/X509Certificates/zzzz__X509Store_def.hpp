...
public:
  ...
  /// @brief Method Close, addr 0x4452670, size 0x1c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method Dispose, addr 0x445268c, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method Open, addr 0x44526a8, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44524a0, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certificates, addr 0x44525cc, size 0x80, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_Certificates();

  /// @brief Method get_Factory, addr 0x445264c, size 0x1c, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Stores* get_Factory();

  /// @brief Method get_Store, addr 0x4452668, size 0x8, virtual false, abstract: false, final false
