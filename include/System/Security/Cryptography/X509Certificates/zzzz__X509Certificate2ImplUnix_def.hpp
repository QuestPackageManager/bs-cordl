...
public:
  ...
  /// @brief Method AppendPrivateKeyInfo, addr 0x63aaca4, size 0xb0, virtual true, abstract: false, final true
  inline void AppendPrivateKeyInfo(::System::Text::StringBuilder* sb);

  /// @brief Method EnsureCertData, addr 0x63aa8a0, size 0x84, virtual false, abstract: false, final false
  inline void EnsureCertData();

  /// @brief Method GetNameInfo, addr 0x63aab90, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63a9444, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Extensions, addr 0x63aabc4, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Issuer, addr 0x63aaa10, size 0x28, virtual true, abstract: false, final true
  inline ::StringW get_Issuer();

  /// @brief Method get_IssuerName, addr 0x63aa9d0, size 0x18, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName();

  /// @brief Method get_KeyAlgorithm, addr 0x63aa924, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_KeyAlgorithm();

  /// @brief Method get_KeyAlgorithmParameters, addr 0x63aa93c, size 0x18, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_KeyAlgorithmParameters();

  /// @brief Method get_NotAfter, addr 0x63aabdc, size 0x64, virtual true, abstract: false, final true
  inline ::System::DateTime get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x63aac40, size 0x64, virtual true, abstract: false, final true
  inline ::System::DateTime get_NotBefore();

  /// @brief Method get_PublicKeyValue, addr 0x63aa954, size 0x18, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_PublicKeyValue();

  /// @brief Method get_RawData, addr 0x63aaa38, size 0x18, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_RawData();

  /// @brief Method get_SerialNumber, addr 0x63aa96c, size 0x18, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_SerialNumber();

  /// @brief Method get_SignatureAlgorithm, addr 0x63aa984, size 0x18, virtual true, abstract: false, final true
  inline ::StringW get_SignatureAlgorithm();

  /// @brief Method get_Subject, addr 0x63aa9e8, size 0x28, virtual true, abstract: false, final true
  inline ::StringW get_Subject();

  /// @brief Method get_SubjectName, addr 0x63aa9b8, size 0x18, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName();

  /// @brief Method get_Thumbprint, addr 0x63aaa50, size 0x140, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> get_Thumbprint();

  /// @brief Method get_Version, addr 0x63aa99c, size 0x1c, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509Certificate2ImplUnix", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509Certificate2ImplUnix(X509Certificate2ImplUnix&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509Certificate2ImplUnix", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509Certificate2ImplUnix(X509Certificate2ImplUnixconst&) = delete;
