...
public:
  ...
  /// @brief Method MoveNext, addr 0x626dc98, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x626dd3c, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x626dbf0, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x626d9d8, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x626daf8, size 0xf8, virtual false, abstract: false, final false
