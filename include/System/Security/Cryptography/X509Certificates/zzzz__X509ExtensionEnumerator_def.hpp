...
public:
  ...
  /// @brief Method MoveNext, addr 0x63ab8ac, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x63ab950, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63ab804, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63ab5ec, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x63ab70c, size 0xf8, virtual false, abstract: false, final false
