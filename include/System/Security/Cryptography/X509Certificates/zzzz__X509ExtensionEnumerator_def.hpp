...
public:
  ...
  /// @brief Method MoveNext, addr 0x44457e0, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x4445880, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x444573c, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4445544, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x444564c, size 0xf0, virtual false, abstract: false, final false
