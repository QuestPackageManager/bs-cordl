...
public:
  ...
  /// @brief Method MoveNext, addr 0x4443bbc, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x4443c5c, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x4443b18, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4443920, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x4443a28, size 0xf0, virtual false, abstract: false, final false
