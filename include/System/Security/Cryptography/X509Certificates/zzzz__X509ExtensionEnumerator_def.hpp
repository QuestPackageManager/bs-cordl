...
public:
  ...
  /// @brief Method MoveNext, addr 0x6193a40, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x6193ae4, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6193998, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6193780, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x61938a0, size 0xf8, virtual false, abstract: false, final false
