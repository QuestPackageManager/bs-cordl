...
public:
  ...
  /// @brief Method MoveNext, addr 0x43e1268, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x43e1308, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x43e11c4, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x43e0fcc, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x43e10d4, size 0xf0, virtual false, abstract: false, final false
