...
public:
  ...
  /// @brief Method MoveNext, addr 0x63b10c4, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x63b1168, size 0xa8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63b101c, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63b0e04, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x63b0f24, size 0xf8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509ExtensionEnumerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509ExtensionEnumerator(X509ExtensionEnumerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509ExtensionEnumerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509ExtensionEnumerator(X509ExtensionEnumeratorconst&) = delete;
