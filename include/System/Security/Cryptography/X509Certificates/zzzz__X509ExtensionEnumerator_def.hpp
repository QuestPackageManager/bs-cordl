...
public:
  ...
  /// @brief Method MoveNext, addr 0x443f028, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x443f0c8, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x443ef84, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x443ed8c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* list);

  /// @brief Method get_Current, addr 0x443ee94, size 0xf0, virtual false, abstract: false, final false
