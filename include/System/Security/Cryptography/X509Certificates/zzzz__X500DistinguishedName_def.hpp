...
public:
  ...
  /// @brief Method .ctor addr 0x27fa70c size 0x110 virtual false final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> encodedDistinguishedName);

  /// @brief Method get_Name addr 0x27fa914 size 0x8 virtual false final false
  inline ::StringW get_Name();

  /// @brief Method Decode addr 0x27fa91c size 0x158 virtual false final false
  inline ::StringW Decode(::System::Security::Cryptography::X509Certificates::X500DistinguishedNameFlags flag);

  /// @brief Method Format addr 0x27faae8 size 0x5c virtual true final false
  inline ::StringW Format(bool multiLine);

  /// @brief Method GetSeparator addr 0x27faa74 size 0x74 virtual false final false
  static inline ::StringW GetSeparator(::System::Security::Cryptography::X509Certificates::X500DistinguishedNameFlags flag);

  /// @brief Method DecodeRawData addr 0x27fa81c size 0xf8 virtual false final false
  inline void DecodeRawData();

  /// @brief Method Canonize addr 0x27fab44 size 0x1cc virtual false final false
  static inline ::StringW Canonize(::StringW s);

  /// @brief Method AreEqual addr 0x27fad10 size 0x1f4 virtual false final false
