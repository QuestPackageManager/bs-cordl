...
public:
  ...
  /// @brief Method Add, addr 0x2a680ec, size 0xd4, virtual false, abstract: false, final false
  inline void Add(::System::Security::Cryptography::X509Certificates::X509CertificateImpl* impl, bool takeOwnership);

  /// @brief Method Clone, addr 0x2a66ed8, size 0x60, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* Clone();

  /// @brief Method Dispose, addr 0x2a6913c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2a691a8, size 0x220, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x2a693c8, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a6806c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2a68e6c, size 0x230, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* other);

  /// @brief Method get_Count, addr 0x2a6909c, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x2a690e4, size 0x58, virtual false, abstract: false, final false
