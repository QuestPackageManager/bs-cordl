...
public:
  ...
  /// @brief Method Reset, addr 0x4446cbc, size 0xe8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x4443d6c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ExtraStore, addr 0x4444ccc, size 0x260, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_ExtraStore();

  /// @brief Method get_RevocationFlag, addr 0x4446da4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509RevocationFlag get_RevocationFlag();

  /// @brief Method get_RevocationMode, addr 0x4446e0c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509RevocationMode get_RevocationMode();

  /// @brief Method get_VerificationFlags, addr 0x4446e7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509VerificationFlags get_VerificationFlags();

  /// @brief Method get_VerificationTime, addr 0x4446ee4, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_VerificationTime();

  /// @brief Method set_RevocationFlag, addr 0x4446dac, size 0x60, virtual false, abstract: false, final false
  inline void set_RevocationFlag(::System::Security::Cryptography::X509Certificates::X509RevocationFlag value);

  /// @brief Method set_RevocationMode, addr 0x4446e14, size 0x60, virtual false, abstract: false, final false
  inline void set_RevocationMode(::System::Security::Cryptography::X509Certificates::X509RevocationMode value);

  /// @brief Method set_UrlRetrievalTimeout, addr 0x4446e74, size 0x8, virtual false, abstract: false, final false
  inline void set_UrlRetrievalTimeout(::System::TimeSpan value);

  /// @brief Method set_VerificationFlags, addr 0x4446e84, size 0x60, virtual false, abstract: false, final false
  inline void set_VerificationFlags(::System::Security::Cryptography::X509Certificates::X509VerificationFlags value);

  /// @brief Method set_VerificationTime, addr 0x4446eec, size 0x8, virtual false, abstract: false, final false
