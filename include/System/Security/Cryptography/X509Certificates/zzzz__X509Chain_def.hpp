...
public:
  ...
  /// @brief Method Build, addr 0x2eaffa8, size 0x40, virtual false, abstract: false, final false
  inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method Create, addr 0x2eaff3c, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::X509Certificates::X509Chain* Create();

  /// @brief Method Dispose, addr 0x2eb1308, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2eb1374, size 0x20, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x2eb1400, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x2eb12d8, size 0x30, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2eb1170, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2eb1200, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(void* chainContext);

  /// @brief Method .ctor, addr 0x2eb11cc, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509ChainImpl* impl);

  /// @brief Method .ctor, addr 0x2eb1198, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(bool useMachineContext);

  /// @brief Method get_ChainElements, addr 0x2eb1248, size 0x30, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements();

  /// @brief Method get_ChainPolicy, addr 0x2eb1278, size 0x30, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy();

  /// @brief Method get_ChainStatus, addr 0x2eb12a8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Impl, addr 0x2eb1150, size 0x20, virtual false, abstract: false, final false
