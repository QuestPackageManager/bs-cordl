...
/// @brief Method Clone, addr 0x6267dbc, size 0x68, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Clone() ;

/// @brief Method GetDSAPrivateKey, addr 0x62684dc, size 0x90, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::DSA* GetDSAPrivateKey() ;

/// @brief Method GetRSAPrivateKey, addr 0x626844c, size 0x90, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSA* GetRSAPrivateKey() ;

/// @brief Method GetRawCertData, addr 0x6267e40, size 0x38, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetRawCertData() ;

/// @brief Method ImportPkcs12, addr 0x6267d64, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method ImportPkcs12, addr 0x626856c, size 0x738, virtual false, abstract: false, final false
...
static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono* New_ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  rawData, ::Microsoft::Win32::SafeHandles::SafePasswordHandle*  password, ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags  keyStorageFlags) ;

/// @brief Method Verify, addr 0x6268dec, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6267b88, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method .ctor, addr 0x6267b94, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono*  other) ;

/// @brief Method .ctor, addr 0x6267c1c, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  rawData, ::Microsoft::Win32::SafeHandles::SafePasswordHandle*  password, ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags  keyStorageFlags) ;

static inline ::StringW getStaticF_empty_error() ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_signedData() ;

/// @brief Method get_Cert, addr 0x6267e24, size 0x1c, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_Cert() ;

/// @brief Method get_HasPrivateKey, addr 0x6267e78, size 0x24, virtual true, abstract: false, final false
inline bool get_HasPrivateKey() ;

/// @brief Method get_IntermediateCertificates, addr 0x6268f1c, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* get_IntermediateCertificates() ;

/// @brief Method get_IsValid, addr 0x6267b78, size 0x10, virtual true, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_MonoCertificate, addr 0x6268f24, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_MonoCertificate() ;

/// @brief Method get_PrivateKey, addr 0x6267e9c, size 0x418, virtual true, abstract: false, final false
...
/// @brief Method set_PrivateKey, addr 0x62682b4, size 0x198, virtual true, abstract: false, final false
