...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono*, "System.Security.Cryptography.X509Certificates", "X509Certificate2ImplMono");
...
public:
  ...
  /// @brief Method Clone, addr 0x63a3e58, size 0x68, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Clone();

  /// @brief Method GetDSAPrivateKey, addr 0x63a4578, size 0x90, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::DSA* GetDSAPrivateKey();

  /// @brief Method GetRSAPrivateKey, addr 0x63a44e8, size 0x90, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSA* GetRSAPrivateKey();

  /// @brief Method GetRawCertData, addr 0x63a3edc, size 0x38, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetRawCertData();

  /// @brief Method ImportPkcs12, addr 0x63a3e00, size 0x58, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* ImportPkcs12(::ArrayW<uint8_t> rawData, ::Microsoft::Win32::SafeHandles::SafePasswordHandle* password);

  /// @brief Method ImportPkcs12, addr 0x63a4608, size 0x738, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* ImportPkcs12(::ArrayW<uint8_t> rawData, ::StringW password);
  ...
  /// @brief Method Verify, addr 0x63a4e88, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63a3c24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x63a3c30, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono* other);

  /// @brief Method .ctor, addr 0x63a3cb8, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> rawData, ::Microsoft::Win32::SafeHandles::SafePasswordHandle* password, ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags keyStorageFlags);

  static inline ::StringW getStaticF_empty_error();

  static inline ::ArrayW<uint8_t> getStaticF_signedData();

  /// @brief Method get_Cert, addr 0x63a3ec0, size 0x1c, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_Cert();

  /// @brief Method get_HasPrivateKey, addr 0x63a3f14, size 0x24, virtual true, abstract: false, final false
  inline bool get_HasPrivateKey();

  /// @brief Method get_IntermediateCertificates, addr 0x63a4fb8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* get_IntermediateCertificates();

  /// @brief Method get_IsValid, addr 0x63a3c14, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_MonoCertificate, addr 0x63a4fc0, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_MonoCertificate();

  /// @brief Method get_PrivateKey, addr 0x63a3f38, size 0x418, virtual true, abstract: false, final false
  ...
  /// @brief Method set_PrivateKey, addr 0x63a4350, size 0x198, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono) == 0xc0, "Size mismatch!");
