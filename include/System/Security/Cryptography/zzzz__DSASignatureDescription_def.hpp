...
public:
  ...
  /// @brief Method .ctor, addr 0x5b06f3c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DSASignatureDescription", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DSASignatureDescription(DSASignatureDescription&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DSASignatureDescription", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DSASignatureDescription(DSASignatureDescriptionconst&) = delete;
