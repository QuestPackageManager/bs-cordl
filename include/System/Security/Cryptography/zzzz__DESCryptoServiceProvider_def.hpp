...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x2550cbc, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x2550b74, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x2550eec, size 0x6c, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x2550e04, size 0xe8, virtual true, abstract: false, final false
  inline void GenerateKey();

  static inline ::System::Security::Cryptography::DESCryptoServiceProvider* New_ctor();

  /// @brief Method .ctor, addr 0x2550aa4, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
