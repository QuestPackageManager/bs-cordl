...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x59bc488, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x59bc358, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x59bc6a4, size 0x70, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x59bc5b8, size 0xec, virtual true, abstract: false, final false
  inline void GenerateKey();

  static inline ::System::Security::Cryptography::DESCryptoServiceProvider* New_ctor();

  /// @brief Method .ctor, addr 0x59bc134, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
