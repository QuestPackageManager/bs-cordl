...
public:
  ...
  /// @brief Method .ctor, addr 0x247edac, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method CreateEncryptor, addr 0x247ee7c, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateDecryptor, addr 0x247efc4, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateKey, addr 0x247f10c, size 0xe8, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method GenerateIV, addr 0x247f1f4, size 0x6c, virtual true, abstract: false, final false
