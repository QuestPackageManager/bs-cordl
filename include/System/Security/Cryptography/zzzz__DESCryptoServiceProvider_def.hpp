...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x280adac, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x280ac70, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x280afc8, size 0x6c, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x280aee8, size 0xe0, virtual true, abstract: false, final false
  inline void GenerateKey();

  static inline ::System::Security::Cryptography::DESCryptoServiceProvider* New_ctor();

  /// @brief Method .ctor, addr 0x280a9a0, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();
