...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x3cad2f4, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x3cad1c4, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x3cad504, size 0x6c, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x3cad424, size 0xe0, virtual true, abstract: false, final false
  inline void GenerateKey();

  static inline ::System::Security::Cryptography::DESCryptoServiceProvider* New_ctor();

  /// @brief Method .ctor, addr 0x3cacf38, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
