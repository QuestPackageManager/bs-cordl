...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DESCryptoServiceProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DESCryptoServiceProvider(DESCryptoServiceProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DESCryptoServiceProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DESCryptoServiceProvider(DESCryptoServiceProviderconst&) = delete;
