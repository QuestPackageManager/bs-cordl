...
public:
  ...
  /// @brief Method .ctor, addr 0x245cd38, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method CreateEncryptor, addr 0x245ce08, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateDecryptor, addr 0x245cf50, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateKey, addr 0x245d098, size 0xe8, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method GenerateIV, addr 0x245d180, size 0x6c, virtual true, abstract: false, final false
