...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x27fad44, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x27fac34, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x27fad88, size 0x30, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x27fad58, size 0x30, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method NewEncryptor, addr 0x27fac48, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27fab54, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();
