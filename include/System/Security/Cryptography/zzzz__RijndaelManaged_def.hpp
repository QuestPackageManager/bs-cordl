...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x3cb0ab8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x3cb09b0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x3cb0afc, size 0x30, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x3cb0acc, size 0x30, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method NewEncryptor, addr 0x3cb09c4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cb08d8, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();
