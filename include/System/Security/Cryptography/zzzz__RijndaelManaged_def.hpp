...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x59bfb6c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x59bfa54, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x59bfbb0, size 0x30, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x59bfb80, size 0x30, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method NewEncryptor, addr 0x59bfa68, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bf9c8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
