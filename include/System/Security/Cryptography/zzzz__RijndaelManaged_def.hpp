...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x25b70ac, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x25b6f9c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x25b70f0, size 0x30, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x25b70c0, size 0x30, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method NewEncryptor, addr 0x25b6fb0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b6ebc, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();
