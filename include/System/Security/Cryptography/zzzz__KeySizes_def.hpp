...
public:
  ...
  /// @brief Method IsLegal, addr 0x59bb6c4, size 0x44, virtual false, abstract: false, final false
  inline bool IsLegal(int32_t keySize);

  /// @brief Method IsLegalKeySize, addr 0x59bb708, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bb4a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t minSize, int32_t maxSize, int32_t skipSize);

  /// @brief Method get_MaxSize, addr 0x59bb6b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxSize();

  /// @brief Method get_MinSize, addr 0x59bb6ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MinSize();

  /// @brief Method get_SkipSize, addr 0x59bb6bc, size 0x8, virtual false, abstract: false, final false
