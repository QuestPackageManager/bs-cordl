...
public:
  ...
  /// @brief Method IsLegal, addr 0x27f6478, size 0x4c, virtual false, abstract: false, final false
  inline bool IsLegal(int32_t keySize);

  /// @brief Method IsLegalKeySize, addr 0x27f64c4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27f620c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(int32_t minSize, int32_t maxSize, int32_t skipSize);

  /// @brief Method get_MaxSize, addr 0x27f6468, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxSize();

  /// @brief Method get_MinSize, addr 0x27f6460, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MinSize();

  /// @brief Method get_SkipSize, addr 0x27f6470, size 0x8, virtual false, abstract: false, final false
