...
/// @brief Method IsLegal, addr 0x5949758, size 0x44, virtual false, abstract: false, final false
inline bool IsLegal(int32_t  keySize) ;

/// @brief Method IsLegalKeySize, addr 0x594979c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5949538, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  minSize, int32_t  maxSize, int32_t  skipSize) ;

/// @brief Method get_MaxSize, addr 0x5949748, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxSize() ;

/// @brief Method get_MinSize, addr 0x5949740, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MinSize() ;

/// @brief Method get_SkipSize, addr 0x5949750, size 0x8, virtual false, abstract: false, final false
