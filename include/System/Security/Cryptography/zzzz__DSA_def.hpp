...
public:
  // Declarations
  /// @brief Method Create, addr 0x26e0ba0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method FromXmlString, addr 0x26e0bfc, size 0x6a8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXmlString, addr 0x26e12a4, size 0x468, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e0b98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
