...
public:
  // Declarations
  /// @brief Method Create, addr 0x27ddf9c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method FromXmlString, addr 0x27ddff8, size 0x6a8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXmlString, addr 0x27de6a0, size 0x468, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27ddf94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
