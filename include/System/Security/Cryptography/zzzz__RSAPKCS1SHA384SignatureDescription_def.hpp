...
public:
  ...
  /// @brief Method .ctor, addr 0x5b06e6c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RSAPKCS1SHA384SignatureDescription", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RSAPKCS1SHA384SignatureDescription(RSAPKCS1SHA384SignatureDescription&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RSAPKCS1SHA384SignatureDescription", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RSAPKCS1SHA384SignatureDescription(RSAPKCS1SHA384SignatureDescriptionconst&) = delete;
