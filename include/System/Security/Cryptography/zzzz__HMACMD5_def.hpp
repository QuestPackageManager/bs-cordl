...
public:
  ...
  /// @brief Method .ctor, addr 0x594baec, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x594bb10, size 0xb8, virtual false, abstract: false, final false
