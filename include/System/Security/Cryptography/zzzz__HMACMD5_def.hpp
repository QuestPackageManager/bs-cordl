...
public:
  ...
  /// @brief Method .ctor, addr 0x25b4ef8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25b4f1c, size 0xc8, virtual false, abstract: false, final false
