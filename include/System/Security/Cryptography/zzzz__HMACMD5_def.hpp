...
public:
  ...
  /// @brief Method .ctor, addr 0x3c9c7a0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3c9c7c4, size 0xbc, virtual false, abstract: false, final false
