...
public:
  ...
  /// @brief Method .ctor, addr 0x27f8d98, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27f8dbc, size 0xc8, virtual false, abstract: false, final false
