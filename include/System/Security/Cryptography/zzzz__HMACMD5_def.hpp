...
public:
  ...
  /// @brief Method .ctor, addr 0x3caeca4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3caecc8, size 0xbc, virtual false, abstract: false, final false
