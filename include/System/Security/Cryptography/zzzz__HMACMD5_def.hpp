...
public:
  ...
  /// @brief Method .ctor, addr 0x3ca169c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3ca16c0, size 0xbc, virtual false, abstract: false, final false
