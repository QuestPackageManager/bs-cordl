...
public:
  ...
  /// @brief Method .ctor, addr 0x59bdf64, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59bdf88, size 0xb8, virtual false, abstract: false, final false
