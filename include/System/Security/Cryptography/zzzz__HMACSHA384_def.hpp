...
public:
  ...
  /// @brief Method .ctor, addr 0x26dc7c4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26dc7e8, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method get_BlockSize, addr 0x26dc8d8, size 0x18, virtual false, abstract: false, final false
