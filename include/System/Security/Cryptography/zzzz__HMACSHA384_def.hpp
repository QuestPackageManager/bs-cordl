...
public:
  ...
  /// @brief Method .ctor, addr 0x3ca035c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3ca0380, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method get_BlockSize, addr 0x3ca0460, size 0x18, virtual false, abstract: false, final false
