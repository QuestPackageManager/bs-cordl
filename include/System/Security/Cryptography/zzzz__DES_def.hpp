...
public:
  ...
  /// @brief Method .ctor addr 0x245c428 size 0x7c virtual false final false
  inline void _ctor();

  /// @brief Method get_Key addr 0x245c4a4 size 0xe8 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method set_Key addr 0x245c8c8 size 0x20c virtual true final false
  inline void set_Key(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method Create addr 0x245cad4 size 0x5c virtual false final false
  static inline ::System::Security::Cryptography::DES* Create();

  /// @brief Method IsWeakKey addr 0x245c58c size 0x128 virtual false final false
  static inline bool IsWeakKey(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method IsSemiWeakKey addr 0x245c6b4 size 0x214 virtual false final false
  static inline bool IsSemiWeakKey(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method IsLegalKeySize addr 0x245cb30 size 0x20 virtual false final false
  static inline bool IsLegalKeySize(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method QuadWordFromBigEndian addr 0x245cb50 size 0x98 virtual false final false
