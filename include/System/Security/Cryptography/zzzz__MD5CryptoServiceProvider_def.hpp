...
namespace System::Security::Cryptography {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2944))}
...
public:
  ...
  /// @brief Method .ctor addr 0x23156a4 size 0xa8 virtual false final false
  inline void _ctor();

  /// @brief Method Finalize addr 0x2317d48 size 0xa0 virtual true final false
  inline void Finalize();

  /// @brief Method Dispose addr 0x2317de8 size 0x70 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method HashCore addr 0x2317e58 size 0x100 virtual true final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal addr 0x2318bd0 size 0xd8 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize addr 0x2318e54 size 0x74 virtual true final false
  inline void Initialize();

  /// @brief Method ProcessBlock addr 0x2317f58 size 0xc78 virtual false final false
  inline void ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inputBuffer, int32_t inputOffset);

  /// @brief Method ProcessFinalBlock addr 0x2318ca8 size 0x1ac virtual false final false
  inline void ProcessFinalBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inputBuffer, int32_t inputOffset, int32_t inputCount);

  /// @brief Method AddLength addr 0x2318ec8 size 0xf0 virtual false final false
