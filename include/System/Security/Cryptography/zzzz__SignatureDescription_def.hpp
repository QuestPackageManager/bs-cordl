...
public:
  ...
  /// @brief Method .ctor, addr 0x58f03d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_DeformatterAlgorithm, addr 0x58f03ec, size 0x8, virtual false, abstract: false, final false
  inline void set_DeformatterAlgorithm(::StringW value);

  /// @brief Method set_DigestAlgorithm, addr 0x58f03dc, size 0x8, virtual false, abstract: false, final false
  inline void set_DigestAlgorithm(::StringW value);

  /// @brief Method set_FormatterAlgorithm, addr 0x58f03e4, size 0x8, virtual false, abstract: false, final false
  inline void set_FormatterAlgorithm(::StringW value);

  /// @brief Method set_KeyAlgorithm, addr 0x58f03d4, size 0x8, virtual false, abstract: false, final false
