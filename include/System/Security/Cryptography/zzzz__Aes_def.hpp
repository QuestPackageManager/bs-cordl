...
public:
  ...
  /// @brief Method Create, addr 0x59bb22c, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::Aes* Create();

  /// @brief Method Create, addr 0x59bb298, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bb1a4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
