...
public:
  ...
  /// @brief Method Check, addr 0x3cb6cfc, size 0x78, virtual false, abstract: false, final false
  inline void Check();

  /// @brief Method Dispose, addr 0x3cb7084, size 0xc, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x3cb6f94, size 0xf0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetBytes, addr 0x3cb6d7c, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method RngClose, addr 0x3cb6d78, size 0x4, virtual false, abstract: false, final false
  static inline void RngClose(::System::IntPtr handle);

  /// @brief Method RngGetBytes, addr 0x3cb6d74, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr RngGetBytes(::System::IntPtr handle, ::cordl_internals::Ptr<uint8_t> data, ::System::IntPtr data_length);

  /// @brief Method RngInitialize, addr 0x3cb6cf8, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr RngInitialize(::cordl_internals::Ptr<uint8_t> seed, ::System::IntPtr seed_length);

  /// @brief Method RngOpen, addr 0x3cb6c84, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cb6c88, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
