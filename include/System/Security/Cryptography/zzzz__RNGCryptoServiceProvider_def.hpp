...
public:
  ...
  /// @brief Method Check, addr 0x3cb9954, size 0x78, virtual false, abstract: false, final false
  inline void Check();

  /// @brief Method Dispose, addr 0x3cb9cdc, size 0xc, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x3cb9bec, size 0xf0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetBytes, addr 0x3cb99d4, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method RngClose, addr 0x3cb99d0, size 0x4, virtual false, abstract: false, final false
  static inline void RngClose(::System::IntPtr handle);

  /// @brief Method RngGetBytes, addr 0x3cb99cc, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr RngGetBytes(::System::IntPtr handle, ::cordl_internals::Ptr<uint8_t> data, ::System::IntPtr data_length);

  /// @brief Method RngInitialize, addr 0x3cb9950, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr RngInitialize(::cordl_internals::Ptr<uint8_t> seed, ::System::IntPtr seed_length);

  /// @brief Method RngOpen, addr 0x3cb98dc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cb98e0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
