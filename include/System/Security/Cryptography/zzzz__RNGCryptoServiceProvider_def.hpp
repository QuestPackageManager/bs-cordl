...
public:
  ...
  /// @brief Method Check, addr 0x25c92bc, size 0xb4, virtual false, abstract: false, final false
  inline void Check();

  /// @brief Method Dispose, addr 0x25c96ac, size 0xc, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x25c9594, size 0x118, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetBytes, addr 0x25c9378, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method RngClose, addr 0x25c9374, size 0x4, virtual false, abstract: false, final false
  static inline void RngClose(void* handle);

  /// @brief Method RngGetBytes, addr 0x25c9370, size 0x4, virtual false, abstract: false, final false
  static inline void* RngGetBytes(void* handle, ::cordl_internals::Ptr<uint8_t> data, void* data_length);

  /// @brief Method RngInitialize, addr 0x25c92b8, size 0x4, virtual false, abstract: false, final false
  static inline void* RngInitialize(::cordl_internals::Ptr<uint8_t> seed, void* seed_length);

  /// @brief Method RngOpen, addr 0x25c92b4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c2388, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
