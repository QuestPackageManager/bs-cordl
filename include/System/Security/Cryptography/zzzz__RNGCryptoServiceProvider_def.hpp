...
public:
  ...
  /// @brief Method Check, addr 0x26f12a8, size 0xb4, virtual false, abstract: false, final false
  inline void Check();

  /// @brief Method Dispose, addr 0x26f1698, size 0xc, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x26f1580, size 0x118, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetBytes, addr 0x26f1364, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method RngClose, addr 0x26f1360, size 0x4, virtual false, abstract: false, final false
  static inline void RngClose(void* handle);

  /// @brief Method RngGetBytes, addr 0x26f135c, size 0x4, virtual false, abstract: false, final false
  static inline void* RngGetBytes(void* handle, ::cordl_internals::Ptr<uint8_t> data, void* data_length);

  /// @brief Method RngInitialize, addr 0x26f12a4, size 0x4, virtual false, abstract: false, final false
  static inline void* RngInitialize(::cordl_internals::Ptr<uint8_t> seed, void* seed_length);

  /// @brief Method RngOpen, addr 0x26f1208, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f120c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
