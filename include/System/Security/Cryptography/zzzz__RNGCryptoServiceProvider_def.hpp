...
public:
  ...
  /// @brief Method Check, addr 0x59d18c8, size 0x5c, virtual false, abstract: false, final false
  inline void Check();

  /// @brief Method Dispose, addr 0x59d1bc0, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x59d1b2c, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetBytes, addr 0x59d192c, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method RngClose, addr 0x59d1928, size 0x4, virtual false, abstract: false, final false
  static inline void RngClose(::System::IntPtr handle);

  /// @brief Method RngGetBytes, addr 0x59d1924, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr RngGetBytes(::System::IntPtr handle, uint8_t* data, ::System::IntPtr data_length);

  /// @brief Method RngInitialize, addr 0x59d18c4, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr RngInitialize(uint8_t* seed, ::System::IntPtr seed_length);

  /// @brief Method RngOpen, addr 0x59d1830, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59d185c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
