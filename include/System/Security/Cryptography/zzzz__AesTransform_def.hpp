...
public:
  ...
  /// @brief Method .ctor, addr 0x280d698, size 0x6f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ECB, addr 0x280e0a8, size 0x14, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method SubByte, addr 0x280dfe4, size 0xc4, virtual false, abstract: false, final false
  inline uint32_t SubByte(uint32_t a);

  /// @brief Method Encrypt128, addr 0x280e0bc, size 0x1e2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Decrypt128, addr 0x280fee8, size 0x1df0, virtual false, abstract: false, final false
