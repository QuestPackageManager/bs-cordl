...
public:
  ...
  /// @brief Method .ctor, addr 0x2811e80, size 0x6f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ECB, addr 0x2812890, size 0x14, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method SubByte, addr 0x28127cc, size 0xc4, virtual false, abstract: false, final false
  inline uint32_t SubByte(uint32_t a);

  /// @brief Method Encrypt128, addr 0x28128a4, size 0x1e2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Decrypt128, addr 0x28146d0, size 0x1df0, virtual false, abstract: false, final false
