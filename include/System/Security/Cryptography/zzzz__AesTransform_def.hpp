...
public:
  ...
  /// @brief Method Decrypt128, addr 0x5da6368, size 0x1dc8, virtual false, abstract: false, final false
  ...
  /// @brief Method ECB, addr 0x5da4570, size 0x14, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Encrypt128, addr 0x5da4584, size 0x1de4, virtual false, abstract: false, final false
  ...
  /// @brief Method SubByte, addr 0x5da44a8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5da3bb4, size 0x6ac, virtual false, abstract: false, final false
