...
public:
// Declarations
/// @brief Method Create, addr 0x5950c08, size 0x54, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RIPEMD160* Create() ;

static inline ::System::Security::Cryptography::RIPEMD160* New_ctor() ;

/// @brief Method .ctor, addr 0x5950bfc, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
