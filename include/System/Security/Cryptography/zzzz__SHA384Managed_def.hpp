...
namespace System::Security::Cryptography {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2961))}
...
public:
  ...
  __declspec(property(get = __get__stateSHA384, put = __set__stateSHA384))::ArrayW<uint64_t, ::Array<uint64_t>*> _stateSHA384;
  ...
  constexpr ::ArrayW<uint64_t, ::Array<uint64_t>*>& __get__stateSHA384();

  constexpr ::ArrayW<uint64_t, ::Array<uint64_t>*> const& __get__stateSHA384() const;

  constexpr void __set__stateSHA384(::ArrayW<uint64_t, ::Array<uint64_t>*> value);
  ...
  /// @brief Method .ctor addr 0x230f488 size 0xc8 virtual false final false
  inline void _ctor();

  /// @brief Method Initialize addr 0x230f658 size 0x44 virtual true final false
  inline void Initialize();

  /// @brief Method HashCore addr 0x230f69c size 0x4 virtual true final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal addr 0x230f86c size 0x4 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method InitializeState addr 0x230f558 size 0x100 virtual false final false
  inline void InitializeState();

  /// @brief Method _HashData addr 0x230f6a0 size 0x1cc virtual false final false
  inline void _HashData(::ArrayW<uint8_t, ::Array<uint8_t>*> partIn, int32_t ibStart, int32_t cbSize);

  /// @brief Method _EndHash addr 0x230f870 size 0x1a4 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> _EndHash();

  /// @brief Method SHATransform addr 0x230fa14 size 0x564 virtual false final false
  ...
  /// @brief Method RotateRight addr 0x2310338 size 0x8 virtual false final false
  static inline uint64_t RotateRight(uint64_t x, int32_t n);

  /// @brief Method Ch addr 0x23102b8 size 0x10 virtual false final false
  static inline uint64_t Ch(uint64_t x, uint64_t y, uint64_t z);

  /// @brief Method Maj addr 0x2310324 size 0x14 virtual false final false
  static inline uint64_t Maj(uint64_t x, uint64_t y, uint64_t z);

  /// @brief Method Sigma_0 addr 0x23102c8 size 0x5c virtual false final false
  static inline uint64_t Sigma_0(uint64_t x);

  /// @brief Method Sigma_1 addr 0x231025c size 0x5c virtual false final false
  static inline uint64_t Sigma_1(uint64_t x);

  /// @brief Method sigma_0 addr 0x2310340 size 0x5c virtual false final false
  static inline uint64_t sigma_0(uint64_t x);

  /// @brief Method sigma_1 addr 0x231039c size 0x5c virtual false final false
  static inline uint64_t sigma_1(uint64_t x);

  /// @brief Method SHA384Expand addr 0x23101b4 size 0xa8 virtual false final false
