...
public:
  ...
  /// @brief Method Dec, addr 0x27e4168, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptData, addr 0x27e31f0, size 0xa68, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x27e2290, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x27e2298, size 0xbc, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Enc, addr 0x27e3fa4, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptData, addr 0x27e2644, size 0xbac, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyExpansion, addr 0x27e1d38, size 0x558, virtual false, abstract: false, final false
  inline void GenerateKeyExpansion(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method MulX, addr 0x27e4414, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x27e3f3c, size 0x68, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SubWord, addr 0x27e4350, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t SubWord(int32_t a);

  /// @brief Method TransformBlock, addr 0x27e236c, size 0x2d8, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x27e3c58, size 0x2e4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27e172c, size 0x60c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanTransformMultipleBlocks, addr 0x27e2364, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x27e2354, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_OutputBlockSize, addr 0x27e235c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method rot1, addr 0x27e4440, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot1(int32_t val);

  /// @brief Method rot2, addr 0x27e4438, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot2(int32_t val);

  /// @brief Method rot3, addr 0x27e4348, size 0x8, virtual false, abstract: false, final false
