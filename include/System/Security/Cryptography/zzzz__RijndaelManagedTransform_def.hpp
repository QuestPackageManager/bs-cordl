...
public:
  ...
  /// @brief Method Dec, addr 0x25b9b70, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptData, addr 0x25b8bf0, size 0xa6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x25b7c8c, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x25b7c94, size 0xbc, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Enc, addr 0x25b99ac, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptData, addr 0x25b8040, size 0xbb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyExpansion, addr 0x25b7730, size 0x55c, virtual false, abstract: false, final false
  inline void GenerateKeyExpansion(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method MulX, addr 0x25b9e1c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x25b9944, size 0x68, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SubWord, addr 0x25b9d58, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t SubWord(int32_t a);

  /// @brief Method TransformBlock, addr 0x25b7d68, size 0x2d8, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x25b965c, size 0x2e8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25b7120, size 0x610, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanTransformMultipleBlocks, addr 0x25b7d60, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x25b7d50, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_OutputBlockSize, addr 0x25b7d58, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method rot1, addr 0x25b9e48, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot1(int32_t val);

  /// @brief Method rot2, addr 0x25b9e40, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot2(int32_t val);

  /// @brief Method rot3, addr 0x25b9d50, size 0x8, virtual false, abstract: false, final false
