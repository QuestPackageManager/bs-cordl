...
public:
  ...
  /// @brief Method Dec, addr 0x58e98d8, size 0x1d8, virtual false, abstract: false, final false
  inline void Dec(int32_t* decryptindex, int32_t* decryptKeyExpansion, int32_t* iT, int32_t* iTF, int32_t* work, int32_t* temp);

  /// @brief Method DecryptData, addr 0x58e8908, size 0xaec, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x58e7964, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x58e796c, size 0xbc, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Enc, addr 0x58e9708, size 0x1d0, virtual false, abstract: false, final false
  inline void Enc(int32_t* encryptindex, int32_t* encryptKeyExpansion, int32_t* T, int32_t* TF, int32_t* work, int32_t* temp);

  /// @brief Method EncryptData, addr 0x58e7cf0, size 0xc18, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyExpansion, addr 0x58e7414, size 0x550, virtual false, abstract: false, final false
  inline void GenerateKeyExpansion(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method MulX, addr 0x58e9b80, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x58e96a8, size 0x60, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SubWord, addr 0x58e9ab8, size 0xc8, virtual false, abstract: false, final false
  static inline int32_t SubWord(int32_t a);

  /// @brief Method TransformBlock, addr 0x58e7a40, size 0x2b0, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x58e93f4, size 0x2b4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x58e6e1c, size 0x5f8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanTransformMultipleBlocks, addr 0x58e7a38, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x58e7a28, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_OutputBlockSize, addr 0x58e7a30, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method rot1, addr 0x58e9bac, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot1(int32_t val);

  /// @brief Method rot2, addr 0x58e9ba4, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot2(int32_t val);

  /// @brief Method rot3, addr 0x58e9ab0, size 0x8, virtual false, abstract: false, final false
