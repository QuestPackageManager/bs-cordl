...
public:
  ...
  /// @brief Method Dec, addr 0x26e6d6c, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptData, addr 0x26e5df4, size 0xa68, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x26e4e94, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x26e4e9c, size 0xbc, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Enc, addr 0x26e6ba8, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptData, addr 0x26e5248, size 0xbac, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyExpansion, addr 0x26e493c, size 0x558, virtual false, abstract: false, final false
  inline void GenerateKeyExpansion(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method MulX, addr 0x26e7018, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x26e6b40, size 0x68, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SubWord, addr 0x26e6f54, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t SubWord(int32_t a);

  /// @brief Method TransformBlock, addr 0x26e4f70, size 0x2d8, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x26e685c, size 0x2e4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26e4330, size 0x60c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanTransformMultipleBlocks, addr 0x26e4f68, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x26e4f58, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_OutputBlockSize, addr 0x26e4f60, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method rot1, addr 0x26e7044, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot1(int32_t val);

  /// @brief Method rot2, addr 0x26e703c, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot2(int32_t val);

  /// @brief Method rot3, addr 0x26e6f4c, size 0x8, virtual false, abstract: false, final false
