...
public:
  ...
  /// @brief Method .ctor, addr 0x2460bb8, size 0x610, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x2461724, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x246172c, size 0xbc, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method get_InputBlockSize, addr 0x24617e8, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_OutputBlockSize, addr 0x24617f0, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_OutputBlockSize();

  /// @brief Method get_CanTransformMultipleBlocks, addr 0x24617f8, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method TransformBlock, addr 0x2461800, size 0x2d8, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x24630f4, size 0x2e8, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x24633dc, size 0x68, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method EncryptData, addr 0x2461ad8, size 0xbb0, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptData, addr 0x2462688, size 0xa6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Enc, addr 0x2463444, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dec, addr 0x2463608, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateKeyExpansion, addr 0x24611c8, size 0x55c, virtual false, abstract: false, final false
  inline void GenerateKeyExpansion(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method rot1, addr 0x24638e0, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot1(int32_t val);

  /// @brief Method rot2, addr 0x24638d8, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot2(int32_t val);

  /// @brief Method rot3, addr 0x24637e8, size 0x8, virtual false, abstract: false, final false
  static inline int32_t rot3(int32_t val);

  /// @brief Method SubWord, addr 0x24637f0, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t SubWord(int32_t a);

  /// @brief Method MulX, addr 0x24638b4, size 0x24, virtual false, abstract: false, final false
