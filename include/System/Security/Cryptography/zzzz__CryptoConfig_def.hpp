...
public:
  ...
  /// @brief Method CreateFromName, addr 0x5b05608, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Object* CreateFromName(::StringW name);

  /// @brief Method CreateFromName, addr 0x5b06838, size 0x20b4, virtual false, abstract: false, final false
  static inline ::System::Object* CreateFromName(::StringW name, ::ArrayW<::System::Object*> args);

  /// @brief Method EncodeLongNumber, addr 0x5b0964c, size 0x15c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeLongNumber(int64_t x);

  /// @brief Method EncodeOID, addr 0x5b0924c, size 0x400, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeOID(::StringW str);

  /// @brief Method MapNameToOID, addr 0x5b089b0, size 0x89c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AllowOnlyFipsAlgorithms, addr 0x5b01494, size 0x8, virtual false, abstract: false, final false
