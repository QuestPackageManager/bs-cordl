...
public:
  ...
  /// @brief Method CreateFromName, addr 0x3caf2fc, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Object* CreateFromName(::StringW name);

  /// @brief Method CreateFromName, addr 0x3cb0540, size 0x1ec4, virtual false, abstract: false, final false
  static inline ::System::Object* CreateFromName(::StringW name, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method EncodeLongNumber, addr 0x3cb30ac, size 0x168, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeLongNumber(int64_t x);

  /// @brief Method EncodeOID, addr 0x3cb2cac, size 0x400, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeOID(::StringW str);

  /// @brief Method MapNameToOID, addr 0x3cb24d8, size 0x7d4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AllowOnlyFipsAlgorithms, addr 0x3cab058, size 0x8, virtual false, abstract: false, final false
