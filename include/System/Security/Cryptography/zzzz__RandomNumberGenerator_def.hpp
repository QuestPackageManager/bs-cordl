...
public:
  ...
  /// @brief Method Create, addr 0x26dd6c8, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RandomNumberGenerator* Create();

  /// @brief Method Dispose, addr 0x26dd724, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x26dd790, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26dd6c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
