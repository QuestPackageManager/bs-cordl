...
public:
  ...
  /// @brief Method Create, addr 0x59bf138, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RandomNumberGenerator* Create();

  /// @brief Method Dispose, addr 0x59bf190, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x59bf200, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bf134, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
