...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::SHA512Managed*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::SHA512Managed*, "System.Security.Cryptography", "SHA512Managed");
...
public:
  ...
  __declspec(property(get = getStaticF__K, put = setStaticF__K)) ::ArrayW<uint64_t> _K;

  /// @brief Field _W, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__W, put = __cordl_internal_set__W)) ::ArrayW<uint64_t> _W;
  ...
  /// @brief Method Ch, addr 0x5b047f8, size 0x10, virtual false, abstract: false, final false
  static inline uint64_t Ch(uint64_t x, uint64_t y, uint64_t z);

  /// @brief Method HashCore, addr 0x5b03e4c, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x5b04008, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> HashFinal();

  /// @brief Method Initialize, addr 0x5b03e08, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x5b03d08, size 0x100, virtual false, abstract: false, final false
  inline void InitializeState();

  /// @brief Method Maj, addr 0x5b04868, size 0x14, virtual false, abstract: false, final false
  static inline uint64_t Maj(uint64_t x, uint64_t y, uint64_t z);

  static inline ::System::Security::Cryptography::SHA512Managed* New_ctor();

  /// @brief Method RotateRight, addr 0x5b0487c, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t RotateRight(uint64_t x, int32_t n);

  /// @brief Method SHA512Expand, addr 0x5b046ec, size 0xac, virtual false, abstract: false, final false
  static inline void SHA512Expand(uint64_t* x);

  /// @brief Method SHATransform, addr 0x5b04190, size 0x55c, virtual false, abstract: false, final false
  static inline void SHATransform(uint64_t* expandedBuffer, uint64_t* state, uint8_t* block);

  /// @brief Method Sigma_0, addr 0x5b04808, size 0x60, virtual false, abstract: false, final false
  static inline uint64_t Sigma_0(uint64_t x);

  /// @brief Method Sigma_1, addr 0x5b04798, size 0x60, virtual false, abstract: false, final false
  static inline uint64_t Sigma_1(uint64_t x);

  /// @brief Method _EndHash, addr 0x5b0400c, size 0x184, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> _EndHash();

  /// @brief Method _HashData, addr 0x5b03e50, size 0x1b8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint64_t>& __cordl_internal_get__W();
  ...
  constexpr ::ArrayW<uint64_t> const& __cordl_internal_get__stateSHA512() const;

  constexpr ::ArrayW<uint64_t>& __cordl_internal_get__stateSHA512();

  constexpr void __cordl_internal_set__W(::ArrayW<uint64_t> value);
  ...
  /// @brief Method .ctor, addr 0x5b03c3c, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method sigma_0, addr 0x5b04884, size 0x60, virtual false, abstract: false, final false
  static inline uint64_t sigma_0(uint64_t x);

  /// @brief Method sigma_1, addr 0x5b048e4, size 0x60, virtual false, abstract: false, final false
  static inline uint64_t sigma_1(uint64_t x);
...
public:
  ...
  ::ArrayW<uint64_t> ____stateSHA512;

  /// @brief Field _W, offset: 0x40, size: 0x8, def value: None
  ::ArrayW<uint64_t> ____W;
...
static_assert(sizeof(::System::Security::Cryptography::SHA512Managed) == 0x48, "Size mismatch!");
