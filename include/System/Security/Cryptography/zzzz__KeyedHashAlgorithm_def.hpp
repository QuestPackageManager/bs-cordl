...
public:
  ...
  /// @brief Method Dispose, addr 0x255269c, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25526f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Key, addr 0x255303c, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method set_Key, addr 0x25530b4, size 0x10c, virtual true, abstract: false, final false
