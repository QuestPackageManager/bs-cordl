...
public:
  ...
  /// @brief Method Dispose, addr 0x3ca5d50, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ca5d98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Key, addr 0x3ca6450, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method set_Key, addr 0x3ca64c8, size 0x100, virtual true, abstract: false, final false
