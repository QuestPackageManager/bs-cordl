...
public:
  ...
  /// @brief Method Dispose, addr 0x59bdf1c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bdf60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Key, addr 0x59be594, size 0x78, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method set_Key, addr 0x59be60c, size 0xec, virtual true, abstract: false, final false
