...
/// @brief Method HashCore, addr 0x5953db0, size 0x4, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x5953f28, size 0x4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method Initialize, addr 0x5953d6c, size 0x44, virtual true, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeState, addr 0x5953ce8, size 0x84, virtual false, abstract: false, final false
inline void InitializeState() ;

static inline ::System::Security::Cryptography::SHA1Managed* New_ctor() ;

/// @brief Method SHAExpand, addr 0x59545cc, size 0x3c, virtual false, abstract: false, final false
static inline void SHAExpand(uint32_t*  x) ;

/// @brief Method SHATransform, addr 0x59540b0, size 0x3dc, virtual false, abstract: false, final false
static inline void SHATransform(uint32_t*  expandedBuffer, uint32_t*  state, uint8_t*  block) ;

/// @brief Method _EndHash, addr 0x5953f2c, size 0x184, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> _EndHash() ;

/// @brief Method _HashData, addr 0x5953db4, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5953c14, size 0xcc, virtual false, abstract: false, final false
inline void _ctor() ;
