...
public:
  ...
  /// @brief Method HashCore, addr 0x5b03864, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x5b039dc, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> HashFinal();

  /// @brief Method Initialize, addr 0x5b03820, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x5b0379c, size 0x84, virtual false, abstract: false, final false
  inline void InitializeState();

  static inline ::System::Security::Cryptography::SHA1Managed* New_ctor();

  /// @brief Method SHAExpand, addr 0x5b04080, size 0x3c, virtual false, abstract: false, final false
  static inline void SHAExpand(uint32_t* x);

  /// @brief Method SHATransform, addr 0x5b03b64, size 0x3dc, virtual false, abstract: false, final false
  static inline void SHATransform(uint32_t* expandedBuffer, uint32_t* state, uint8_t* block);

  /// @brief Method _EndHash, addr 0x5b039e0, size 0x184, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> _EndHash();

  /// @brief Method _HashData, addr 0x5b03868, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b036c8, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SHA1Managed", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SHA1Managed(SHA1Managed&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SHA1Managed", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SHA1Managed(SHA1Managedconst&) = delete;
