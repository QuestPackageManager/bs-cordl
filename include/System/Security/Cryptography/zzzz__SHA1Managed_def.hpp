...
public:
  ...
  /// @brief Method HashCore, addr 0x25bd254, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x25bd3d4, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x25bd210, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x25bd18c, size 0x84, virtual false, abstract: false, final false
  inline void InitializeState();

  static inline ::System::Security::Cryptography::SHA1Managed* New_ctor();

  /// @brief Method SHAExpand, addr 0x25bd974, size 0x3c, virtual false, abstract: false, final false
  static inline void SHAExpand(::cordl_internals::Ptr<uint32_t> x);

  /// @brief Method SHATransform, addr 0x25bd580, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method _EndHash, addr 0x25bd3d8, size 0x1a8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> _EndHash();

  /// @brief Method _HashData, addr 0x25bd258, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b52b4, size 0x124, virtual false, abstract: false, final false
  inline void _ctor();
