...
public:
  ...
  /// @brief Method .ctor addr 0x2692890 size 0x64 virtual false final false
  inline void _ctor();

  /// @brief Method GenerateIV addr 0x26928f4 size 0x24 virtual true final false
  inline void GenerateIV();

  /// @brief Method GenerateKey addr 0x2692918 size 0x24 virtual true final false
  inline void GenerateKey();

  /// @brief Method CreateDecryptor addr 0x269293c size 0xfc virtual true final false
  ...
  /// @brief Method CreateEncryptor addr 0x269312c size 0xfc virtual true final false
  ...
  /// @brief Method get_IV addr 0x2693228 size 0x8 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_IV();

  /// @brief Method set_IV addr 0x2693230 size 0x8 virtual true final false
  inline void set_IV(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_Key addr 0x2693238 size 0x8 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method set_Key addr 0x2693240 size 0x8 virtual true final false
  inline void set_Key(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_KeySize addr 0x2693248 size 0x8 virtual true final false
  inline int32_t get_KeySize();

  /// @brief Method set_KeySize addr 0x2693250 size 0x8 virtual true final false
  inline void set_KeySize(int32_t value);

  /// @brief Method get_FeedbackSize addr 0x2693258 size 0x8 virtual true final false
  inline int32_t get_FeedbackSize();

  /// @brief Method get_Mode addr 0x2693260 size 0x8 virtual true final false
  inline ::System::Security::Cryptography::CipherMode get_Mode();

  /// @brief Method set_Mode addr 0x2693268 size 0x60 virtual true final false
  inline void set_Mode(::System::Security::Cryptography::CipherMode value);

  /// @brief Method get_Padding addr 0x26932c8 size 0x8 virtual true final false
  inline ::System::Security::Cryptography::PaddingMode get_Padding();

  /// @brief Method set_Padding addr 0x26932d0 size 0x8 virtual true final false
  inline void set_Padding(::System::Security::Cryptography::PaddingMode value);

  /// @brief Method CreateDecryptor addr 0x26932d8 size 0x50 virtual true final false
  inline ::System::Security::Cryptography::ICryptoTransform* CreateDecryptor();

  /// @brief Method CreateEncryptor addr 0x2693328 size 0x50 virtual true final false
  inline ::System::Security::Cryptography::ICryptoTransform* CreateEncryptor();

  /// @brief Method Dispose addr 0x2693378 size 0xc virtual true final false
