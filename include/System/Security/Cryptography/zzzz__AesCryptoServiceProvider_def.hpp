...
public:
  ...
  /// @brief Method .ctor, addr 0x280d4f0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method GenerateIV, addr 0x280d554, size 0x24, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x280d578, size 0x24, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method CreateDecryptor, addr 0x280d59c, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x280dd8c, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method get_IV, addr 0x280de88, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_IV();

  /// @brief Method set_IV, addr 0x280de90, size 0x8, virtual true, abstract: false, final false
  inline void set_IV(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_Key, addr 0x280de98, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method set_Key, addr 0x280dea0, size 0x8, virtual true, abstract: false, final false
  inline void set_Key(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_KeySize, addr 0x280dea8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method set_KeySize, addr 0x280deb0, size 0x8, virtual true, abstract: false, final false
  inline void set_KeySize(int32_t value);

  /// @brief Method get_FeedbackSize, addr 0x280deb8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FeedbackSize();

  /// @brief Method get_Mode, addr 0x280dec0, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::CipherMode get_Mode();

  /// @brief Method set_Mode, addr 0x280dec8, size 0x60, virtual true, abstract: false, final false
  inline void set_Mode(::System::Security::Cryptography::CipherMode value);

  /// @brief Method get_Padding, addr 0x280df28, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::PaddingMode get_Padding();

  /// @brief Method set_Padding, addr 0x280df30, size 0x8, virtual true, abstract: false, final false
  inline void set_Padding(::System::Security::Cryptography::PaddingMode value);

  /// @brief Method CreateDecryptor, addr 0x280df38, size 0x50, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::ICryptoTransform* CreateDecryptor();

  /// @brief Method CreateEncryptor, addr 0x280df88, size 0x50, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::ICryptoTransform* CreateEncryptor();

  /// @brief Method Dispose, addr 0x280dfd8, size 0xc, virtual true, abstract: false, final false
