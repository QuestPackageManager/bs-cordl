...
public:
  ...
  /// @brief Method .ctor addr 0x26920f8 size 0x164 virtual false final false
  inline void _ctor();

  /// @brief Method get_FeedbackSize addr 0x269225c size 0x20 virtual true final false
  inline int32_t get_FeedbackSize();

  /// @brief Method get_IV addr 0x269227c size 0x20 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_IV();

  /// @brief Method set_IV addr 0x269229c size 0x20 virtual true final false
  inline void set_IV(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_Key addr 0x26922bc size 0x20 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method set_Key addr 0x26922dc size 0x20 virtual true final false
  inline void set_Key(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method get_KeySize addr 0x26922fc size 0x24 virtual true final false
  inline int32_t get_KeySize();

  /// @brief Method set_KeySize addr 0x2692320 size 0x24 virtual true final false
  inline void set_KeySize(int32_t value);

  /// @brief Method get_Mode addr 0x2692344 size 0x24 virtual true final false
  inline ::System::Security::Cryptography::CipherMode get_Mode();

  /// @brief Method set_Mode addr 0x2692368 size 0x88 virtual true final false
  inline void set_Mode(::System::Security::Cryptography::CipherMode value);

  /// @brief Method get_Padding addr 0x26923f0 size 0x24 virtual true final false
  inline ::System::Security::Cryptography::PaddingMode get_Padding();

  /// @brief Method set_Padding addr 0x2692414 size 0x24 virtual true final false
  inline void set_Padding(::System::Security::Cryptography::PaddingMode value);

  /// @brief Method CreateDecryptor addr 0x2692438 size 0x24 virtual true final false
  inline ::System::Security::Cryptography::ICryptoTransform* CreateDecryptor();

  /// @brief Method CreateDecryptor addr 0x269245c size 0x14c virtual true final false
  ...
  /// @brief Method CreateEncryptor addr 0x26925a8 size 0x24 virtual true final false
  inline ::System::Security::Cryptography::ICryptoTransform* CreateEncryptor();

  /// @brief Method CreateEncryptor addr 0x26925cc size 0x14c virtual true final false
  ...
  /// @brief Method Dispose addr 0x2692718 size 0x130 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method GenerateIV addr 0x2692848 size 0x24 virtual true final false
  inline void GenerateIV();

  /// @brief Method GenerateKey addr 0x269286c size 0x24 virtual true final false
