...
public:
  // Declarations
  /// @brief Method Create, addr 0x3cab9e8, size 0x50, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::SHA256* Create();

  static inline ::System::Security::Cryptography::SHA256* New_ctor();

  /// @brief Method .ctor, addr 0x3cab9c8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
