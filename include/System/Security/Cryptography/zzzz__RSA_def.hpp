...
public:
  // Declarations
  /// @brief Method Create, addr 0x26e8dec, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* Create();

  /// @brief Method EncryptValue, addr 0x26e8e8c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method FromXmlString, addr 0x26e8eec, size 0x538, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXmlString, addr 0x26e9440, size 0x43c, virtual true, abstract: false, final false
  inline ::StringW ToXmlString(bool includePrivateParameters);

  /// @brief Method .ctor, addr 0x26e8de4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
