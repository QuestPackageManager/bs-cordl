...
public:
  // Declarations
  /// @brief Method Create, addr 0x59521e4, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* Create();

  /// @brief Method EncryptValue, addr 0x595225c, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method FromXmlString, addr 0x59522ac, size 0x584, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXmlString, addr 0x5952848, size 0x46c, virtual true, abstract: false, final false
  inline ::StringW ToXmlString(bool includePrivateParameters);

  /// @brief Method .ctor, addr 0x59521e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
