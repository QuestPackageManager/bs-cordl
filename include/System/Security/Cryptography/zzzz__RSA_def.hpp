...
public:
  ...
  /// @brief Method .ctor, addr 0x24876f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Create, addr 0x24876fc, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* Create();

  /// @brief Method EncryptValue, addr 0x248779c, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncryptValue(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb);

  /// @brief Method FromXmlString, addr 0x24877fc, size 0x558, virtual true, abstract: false, final false
  inline void FromXmlString(::StringW xmlString);

  /// @brief Method ToXmlString, addr 0x2487d54, size 0x43c, virtual true, abstract: false, final false
