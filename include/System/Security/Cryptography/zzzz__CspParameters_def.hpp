...
public:
  ...
  /// @brief Method .ctor, addr 0x59bb9f8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59bba24, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t dwTypeIn);

  /// @brief Method .ctor, addr 0x59bba10, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t dwTypeIn, ::StringW strProviderNameIn, ::StringW strContainerNameIn);

  /// @brief Method .ctor, addr 0x59bba38, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Flags, addr 0x59bb918, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::CspProviderFlags get_Flags();

  /// @brief Method set_Flags, addr 0x59bb920, size 0xd8, virtual false, abstract: false, final false
