...
public:
  ...
  /// @brief Method AddLength, addr 0x5b0ebd8, size 0xf0, virtual false, abstract: false, final false
  inline void AddLength(uint64_t length, ::ArrayW<uint8_t> buffer, int32_t position);

  /// @brief Method FillBuff, addr 0x5b0ea54, size 0x184, virtual false, abstract: false, final false
  static inline void FillBuff(::ArrayW<uint32_t> buff);

  /// @brief Method HashCore, addr 0x5b0d7e0, size 0x100, virtual false, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x5b0e108, size 0xe0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> HashFinal();

  /// @brief Method InitialiseBuff, addr 0x5b0e3b4, size 0x6a0, virtual false, abstract: false, final false
  static inline void InitialiseBuff(::ArrayW<uint32_t> buff, ::ArrayW<uint8_t> input, uint32_t inputOffset);

  /// @brief Method Initialize, addr 0x5b0d758, size 0x88, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::System::Security::Cryptography::SHA1Internal* New_ctor();

  /// @brief Method ProcessBlock, addr 0x5b0d8e0, size 0x828, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t> inputBuffer, uint32_t inputOffset);

  /// @brief Method ProcessFinalBlock, addr 0x5b0e1e8, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b0d6bc, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
