...
public:
  ...
  /// @brief Method AddLength, addr 0x27f5030, size 0xf0, virtual false, abstract: false, final false
  inline void AddLength(uint64_t length, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t position);

  /// @brief Method FillBuff, addr 0x27f4dfc, size 0x234, virtual false, abstract: false, final false
  static inline void FillBuff(::ArrayW<uint32_t, ::Array<uint32_t>*> buff);

  /// @brief Method HashCore, addr 0x27f3eb0, size 0x100, virtual false, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x27f44c8, size 0xd8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method InitialiseBuff, addr 0x27f475c, size 0x6a0, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x27f3e28, size 0x88, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::System::Security::Cryptography::SHA1Internal* New_ctor();

  /// @brief Method ProcessBlock, addr 0x27f3fb0, size 0x518, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> inputBuffer, uint32_t inputOffset);

  /// @brief Method ProcessFinalBlock, addr 0x27f45a0, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27f3d8c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
