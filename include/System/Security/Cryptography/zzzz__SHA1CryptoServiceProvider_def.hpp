...
public:
  ...
  /// @brief Method Dispose, addr 0x3cb8748, size 0xc, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x3cb86a8, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HashCore, addr 0x3cb8754, size 0x24, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x3cb8778, size 0x20, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x3cb8798, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cb8648, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
