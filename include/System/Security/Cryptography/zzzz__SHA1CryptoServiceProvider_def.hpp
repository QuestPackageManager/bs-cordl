...
public:
  ...
  /// @brief Method .ctor addr 0x246e4d0 size 0x68 virtual false final false
  inline void _ctor();

  /// @brief Method Finalize addr 0x24747c4 size 0xa0 virtual true final false
  inline void Finalize();

  /// @brief Method Dispose addr 0x2474864 size 0xc virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method HashCore addr 0x2474870 size 0x24 virtual true final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal addr 0x2474894 size 0x20 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize addr 0x24748b4 size 0x18 virtual true final false
