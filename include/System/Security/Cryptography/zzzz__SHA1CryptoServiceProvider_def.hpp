...
public:
  ...
  /// @brief Method Dispose, addr 0x59d3530, size 0x10, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x59d34e0, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HashCore, addr 0x59d3540, size 0x20, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x59d3560, size 0x1c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x59d357c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59d3480, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
