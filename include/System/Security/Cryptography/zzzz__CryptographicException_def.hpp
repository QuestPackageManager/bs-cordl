...
public:
  ...
  /// @brief Method .ctor addr 0x2302a08 size 0x6c virtual false final false
  inline void _ctor();

  static inline ::System::Security::Cryptography::CryptographicException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x230286c size 0x28 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::System::Security::Cryptography::CryptographicException* New_ctor(::StringW format, ::StringW insert);

  /// @brief Method .ctor addr 0x2302a74 size 0x98 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2302b0c size 0x28 virtual false final false
  inline void _ctor(::StringW message, ::System::Exception* inner);

  static inline ::System::Security::Cryptography::CryptographicException* New_ctor(int32_t hr);

  /// @brief Method .ctor addr 0x2302b34 size 0x64 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2302b98 size 0x8 virtual false final false
