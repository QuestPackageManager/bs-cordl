...
public:
// Declarations
/// @brief Method Create, addr 0x5956434, size 0x54, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA512* Create() ;

static inline ::System::Security::Cryptography::SHA512* New_ctor() ;

/// @brief Method .ctor, addr 0x5956428, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
