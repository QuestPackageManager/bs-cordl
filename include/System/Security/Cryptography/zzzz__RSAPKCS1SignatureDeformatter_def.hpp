...
public:
  ...
  /// @brief Method SetHashAlgorithm, addr 0x27f3ad8, size 0x60, virtual true, abstract: false, final false
  inline void SetHashAlgorithm(::StringW strName);

  /// @brief Method SetKey, addr 0x27f3b38, size 0xec, virtual true, abstract: false, final false
  inline void SetKey(::System::Security::Cryptography::AsymmetricAlgorithm* key);

  /// @brief Method VerifySignature, addr 0x27f3c24, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27f3a9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27f3aa4, size 0x34, virtual false, abstract: false, final false
