...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RSAPKCS1SignatureDeformatter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RSAPKCS1SignatureDeformatter(RSAPKCS1SignatureDeformatter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RSAPKCS1SignatureDeformatter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RSAPKCS1SignatureDeformatter(RSAPKCS1SignatureDeformatterconst&) = delete;
