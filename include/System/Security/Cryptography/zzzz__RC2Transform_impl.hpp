...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Security::Cryptography::RC2Transform::*)(::System::Security::Cryptography::RC2*, bool, ::ArrayW<uint8_t,::Array<uint8_t>*>, ::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::System::Security::Cryptography::RC2Transform::_ctor)> {
  constexpr static std::size_t size = 0x52c;
  constexpr static std::size_t addrs = 0x595ea0c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Security::Cryptography::RC2*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<uint8_t,::Array<uint8_t>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<uint8_t,::Array<uint8_t>*>>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Security::Cryptography::RC2Transform::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, ::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::System::Security::Cryptography::RC2Transform::ECB)> {
  constexpr static std::size_t size = 0x86c;
  constexpr static std::size_t addrs = 0x595ef38;
...
constexpr ::ArrayW<uint16_t,::Array<uint16_t>*>& System::Security::Cryptography::RC2Transform::__cordl_internal_get_K()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___K;
}
constexpr ::ArrayW<uint16_t,::Array<uint16_t>*> const& System::Security::Cryptography::RC2Transform::__cordl_internal_get_K() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___K;
}
constexpr void System::Security::Cryptography::RC2Transform::__cordl_internal_set_K(::ArrayW<uint16_t,::Array<uint16_t>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
::cordl_internals::setStaticField<::ArrayW<uint8_t,::Array<uint8_t>*>, "pitable", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Security::Cryptography::RC2Transform*>::get>(std::forward<::ArrayW<uint8_t,::Array<uint8_t>*>>(value));
}
inline ::ArrayW<uint8_t,::Array<uint8_t>*> System::Security::Cryptography::RC2Transform::getStaticF_pitable()  {
return ::cordl_internals::getStaticField<::ArrayW<uint8_t,::Array<uint8_t>*>, "pitable", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Security::Cryptography::RC2Transform*>::get>();
}
inline void System::Security::Cryptography::RC2Transform::_ctor(::System::Security::Cryptography::RC2*  rc2Algo, bool  encryption, ::ArrayW<uint8_t,::Array<uint8_t>*>  key, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Security::Cryptography::RC2Transform*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
inline ::System::Security::Cryptography::RC2Transform* System::Security::Cryptography::RC2Transform::New_ctor(::System::Security::Cryptography::RC2*  rc2Algo, bool  encryption, ::ArrayW<uint8_t,::Array<uint8_t>*>  key, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv)  {
