...
public:
  ...
  /// @brief Method Common, addr 0x280b4fc, size 0x224, virtual false, abstract: false, final false
  inline void Common(int32_t dwKeySize, bool parameters);

  /// @brief Method Dispose, addr 0x280b924, size 0x54, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExportParameters, addr 0x280b7fc, size 0xb4, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::DSAParameters ExportParameters(bool includePrivateParameters);

  /// @brief Method Finalize, addr 0x280b720, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method ImportParameters, addr 0x280b8b0, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method OnKeyGenerated, addr 0x280b978, size 0x84, virtual false, abstract: false, final false
  inline void OnKeyGenerated(::System::Object* sender, ::System::EventArgs* e);

  /// @brief Method VerifySignature, addr 0x280b904, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28093a4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x280b4c4, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(int32_t dwKeySize);

  static inline bool getStaticF_useMachineKeyStore();

  /// @brief Method get_KeySize, addr 0x280b7c0, size 0x20, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_PublicOnly, addr 0x280b7e0, size 0x1c, virtual false, abstract: false, final false
