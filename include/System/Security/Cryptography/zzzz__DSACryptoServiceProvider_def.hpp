...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::DSACryptoServiceProvider*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::DSACryptoServiceProvider*, "System.Security.Cryptography", "DSACryptoServiceProvider");
...
public:
  ...
  /// @brief Method Common, addr 0x5b0aa8c, size 0x20c, virtual false, abstract: false, final false
  inline void Common(int32_t dwKeySize, bool parameters);

  /// @brief Method Dispose, addr 0x5b0ae20, size 0x58, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExportParameters, addr 0x5b0ad1c, size 0xa4, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::DSAParameters ExportParameters(bool includePrivateParameters);

  /// @brief Method Finalize, addr 0x5b0ac98, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method ImportParameters, addr 0x5b0adc0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method OnKeyGenerated, addr 0x5b0ae78, size 0x80, virtual false, abstract: false, final false
  inline void OnKeyGenerated(::System::Object* sender, ::System::EventArgs* e);

  /// @brief Method VerifySignature, addr 0x5b0ae04, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b088ec, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5b0aa7c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(int32_t dwKeySize);

  static inline bool getStaticF_useMachineKeyStore();

  /// @brief Method get_KeySize, addr 0x5b0ace8, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_PublicOnly, addr 0x5b0ad04, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::DSACryptoServiceProvider) == 0x38, "Size mismatch!");
