...
public:
  ...
  /// @brief Method .ctor, addr 0x26dc6d8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26dc6fc, size 0xc8, virtual false, abstract: false, final false
