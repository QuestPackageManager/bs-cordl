...
public:
  ...
  /// @brief Method .ctor, addr 0x5af9ae8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5af9b0c, size 0xb8, virtual false, abstract: false, final false
