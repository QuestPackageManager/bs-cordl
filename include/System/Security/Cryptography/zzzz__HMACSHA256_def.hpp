...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HMACSHA256", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HMACSHA256(HMACSHA256&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HMACSHA256", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HMACSHA256(HMACSHA256const&) = delete;
