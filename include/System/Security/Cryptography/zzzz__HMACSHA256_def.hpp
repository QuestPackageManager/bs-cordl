...
public:
  ...
  /// @brief Method .ctor, addr 0x594be28, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x594be4c, size 0xb8, virtual false, abstract: false, final false
