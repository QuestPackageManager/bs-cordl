...
public:
  ...
  /// @brief Method .ctor, addr 0x59be2a0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59be2c4, size 0xb8, virtual false, abstract: false, final false
