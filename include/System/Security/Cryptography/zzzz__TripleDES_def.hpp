...
public:
  ...
  /// @brief Method Create, addr 0x3cbb3a8, size 0x50, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::TripleDES* Create();

  /// @brief Method EqualBytes, addr 0x3cbb544, size 0x198, virtual false, abstract: false, final false
  static inline bool EqualBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey, int32_t start1, int32_t start2, int32_t count);

  /// @brief Method IsLegalKeySize, addr 0x3cbb458, size 0x24, virtual false, abstract: false, final false
  static inline bool IsLegalKeySize(::ArrayW<uint8_t, ::Array<uint8_t>*> rgbKey);

  /// @brief Method IsWeakKey, addr 0x3cbb0a0, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cbaf50, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Key, addr 0x3cbafd8, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Key, addr 0x3cbb1d4, size 0x1d4, virtual true, abstract: false, final false
