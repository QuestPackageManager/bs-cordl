...
public:
  ...
  /// @brief Method Create, addr 0x5b05b4c, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::TripleDES* Create();

  /// @brief Method EqualBytes, addr 0x5b05cf0, size 0x17c, virtual false, abstract: false, final false
  static inline bool EqualBytes(::ArrayW<uint8_t> rgbKey, int32_t start1, int32_t start2, int32_t count);

  /// @brief Method IsLegalKeySize, addr 0x5b05c04, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsLegalKeySize(::ArrayW<uint8_t> rgbKey);

  /// @brief Method IsWeakKey, addr 0x5b05850, size 0x134, virtual false, abstract: false, final false
  static inline bool IsWeakKey(::ArrayW<uint8_t> rgbKey);

  static inline ::System::Security::Cryptography::TripleDES* New_ctor();

  /// @brief Method .ctor, addr 0x5b05704, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Key, addr 0x5b05784, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Key, addr 0x5b05984, size 0x1c8, virtual true, abstract: false, final false
