...
public:
  ...
  /// @brief Method BSwap, addr 0x3cbf960, size 0x78, virtual false, abstract: false, final false
  static inline void BSwap(::ArrayW<uint8_t, ::Array<uint8_t>*> byteBuff);

  /// @brief Method CipherFunct, addr 0x3cbf458, size 0x230, virtual false, abstract: false, final false
  inline uint32_t CipherFunct(uint32_t r, int32_t n);

  /// @brief Method ECB, addr 0x3cbfd60, size 0xa4, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method GetStrongKey, addr 0x3cbf000, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method Permutation, addr 0x3cbf688, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x3cbf9d8, size 0x388, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method SetKey, addr 0x3cbf0d8, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cbede0, size 0x220, virtual false, abstract: false, final false
