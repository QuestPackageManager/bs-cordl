...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::DESTransform*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::DESTransform*, "System.Security.Cryptography", "DESTransform");
...
public:
  ...
  __declspec(property(get = getStaticF_PC1, put = setStaticF_PC1)) ::ArrayW<uint8_t> PC1;

  /// @brief Field PC2, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_PC2, put = setStaticF_PC2)) ::ArrayW<uint8_t> PC2;

  /// @brief Field byteBuff, offset 0x60, size 0x8
  __declspec(property(get = __cordl_internal_get_byteBuff, put = __cordl_internal_set_byteBuff)) ::ArrayW<uint8_t> byteBuff;

  /// @brief Field dwordBuff, offset 0x68, size 0x8
  __declspec(property(get = __cordl_internal_get_dwordBuff, put = __cordl_internal_set_dwordBuff)) ::ArrayW<uint32_t> dwordBuff;

  /// @brief Field fpTab, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_fpTab, put = setStaticF_fpTab)) ::ArrayW<uint32_t> fpTab;

  /// @brief Field ipTab, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_ipTab, put = setStaticF_ipTab)) ::ArrayW<uint32_t> ipTab;

  /// @brief Field keySchedule, offset 0x58, size 0x8
  __declspec(property(get = __cordl_internal_get_keySchedule, put = __cordl_internal_set_keySchedule)) ::ArrayW<uint8_t> keySchedule;

  /// @brief Field leftRotTotal, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_leftRotTotal, put = setStaticF_leftRotTotal)) ::ArrayW<uint8_t> leftRotTotal;
  ...
  /// @brief Method BSwap, addr 0x5b0c6c8, size 0x60, virtual false, abstract: false, final false
  static inline void BSwap(::ArrayW<uint8_t> byteBuff);

  /// @brief Method CipherFunct, addr 0x5b0c1cc, size 0x230, virtual false, abstract: false, final false
  inline uint32_t CipherFunct(uint32_t r, int32_t n);

  /// @brief Method ECB, addr 0x5b0cac8, size 0xa8, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output);

  /// @brief Method GetStrongKey, addr 0x5b0bd44, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Permutation, addr 0x5b0c3fc, size 0x2cc, virtual false, abstract: false, final false
  static inline void Permutation(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output, ::ArrayW<uint32_t> permTab, bool preSwap);

  /// @brief Method ProcessBlock, addr 0x5b0c728, size 0x3a0, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output);

  /// @brief Method SetKey, addr 0x5b0be20, size 0x3ac, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t> key);

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_byteBuff() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_byteBuff();

  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_dwordBuff() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_dwordBuff();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_keySchedule() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_keySchedule();

  constexpr void __cordl_internal_set_byteBuff(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_dwordBuff(::ArrayW<uint32_t> value);

  constexpr void __cordl_internal_set_keySchedule(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x5b0bb14, size 0x230, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<uint8_t> getStaticF_PC1();

  static inline ::ArrayW<uint8_t> getStaticF_PC2();

  static inline ::ArrayW<uint32_t> getStaticF_fpTab();

  static inline ::ArrayW<uint32_t> getStaticF_ipTab();

  static inline ::ArrayW<uint8_t> getStaticF_leftRotTotal();

  static inline ::ArrayW<uint32_t> getStaticF_spBoxes();
  ...
  static inline void setStaticF_PC1(::ArrayW<uint8_t> value);

  static inline void setStaticF_PC2(::ArrayW<uint8_t> value);

  static inline void setStaticF_fpTab(::ArrayW<uint32_t> value);

  static inline void setStaticF_ipTab(::ArrayW<uint32_t> value);

  static inline void setStaticF_leftRotTotal(::ArrayW<uint8_t> value);

  static inline void setStaticF_spBoxes(::ArrayW<uint32_t> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DESTransform", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DESTransform(DESTransform&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DESTransform", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DESTransform(DESTransformconst&) = delete;
...
static_assert(sizeof(::System::Security::Cryptography::DESTransform) == 0x70, "Size mismatch!");
