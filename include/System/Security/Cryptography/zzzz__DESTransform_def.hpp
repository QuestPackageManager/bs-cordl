...
public:
  ...
  /// @brief Method BSwap, addr 0x59ceb80, size 0x60, virtual false, abstract: false, final false
  static inline void BSwap(::ArrayW<uint8_t, ::Array<uint8_t>*> byteBuff);

  /// @brief Method CipherFunct, addr 0x59ce684, size 0x230, virtual false, abstract: false, final false
  inline uint32_t CipherFunct(uint32_t r, int32_t n);

  /// @brief Method ECB, addr 0x59cef80, size 0xa8, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method GetStrongKey, addr 0x59ce1fc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Permutation, addr 0x59ce8b4, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessBlock, addr 0x59cebe0, size 0x3a0, virtual false, abstract: false, final false
  inline void ProcessBlock(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method SetKey, addr 0x59ce2d8, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59cdfcc, size 0x230, virtual false, abstract: false, final false
