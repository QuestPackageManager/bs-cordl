...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x26e9248, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x26e9130, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x26e94cc, size 0x68, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x26e9360, size 0xc8, virtual true, abstract: false, final false
  inline void GenerateKey();

  static inline ::System::Security::Cryptography::TripleDESCryptoServiceProvider* New_ctor();

  /// @brief Method .ctor, addr 0x26e8cec, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
