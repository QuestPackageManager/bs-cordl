...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x3cafda8, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x3cafc9c, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x3cb0018, size 0x68, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x3cafeb4, size 0xc8, virtual true, abstract: false, final false
  inline void GenerateKey();

  static inline ::System::Security::Cryptography::TripleDESCryptoServiceProvider* New_ctor();

  /// @brief Method .ctor, addr 0x3caf89c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
