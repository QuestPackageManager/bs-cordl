...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x3ca9400, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x3ca92f4, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x3ca9670, size 0x68, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x3ca950c, size 0xc8, virtual true, abstract: false, final false
  inline void GenerateKey();

  static inline ::System::Security::Cryptography::TripleDESCryptoServiceProvider* New_ctor();

  /// @brief Method .ctor, addr 0x3ca8ef4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
