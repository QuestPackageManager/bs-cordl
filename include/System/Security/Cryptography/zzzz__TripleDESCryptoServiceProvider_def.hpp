...
public:
  ...
  /// @brief Method .ctor, addr 0x246b2c4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method CreateEncryptor, addr 0x246b708, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateDecryptor, addr 0x246bb3c, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateKey, addr 0x246bc50, size 0xc8, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method GenerateIV, addr 0x246bdb8, size 0x68, virtual true, abstract: false, final false
