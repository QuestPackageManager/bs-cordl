...
public:
  // Declarations
  /// @brief Method CreateDecryptor, addr 0x3cadf94, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x3cade88, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateIV, addr 0x3cae204, size 0x68, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x3cae0a0, size 0xc8, virtual true, abstract: false, final false
  inline void GenerateKey();

  static inline ::System::Security::Cryptography::TripleDESCryptoServiceProvider* New_ctor();

  /// @brief Method .ctor, addr 0x3cada88, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
