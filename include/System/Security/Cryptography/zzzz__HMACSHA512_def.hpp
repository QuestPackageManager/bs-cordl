...
public:
  ...
  /// @brief Method .ctor addr 0x245f1a4 size 0x24 virtual false final false
  inline void _ctor();

  static inline ::System::Security::Cryptography::HMACSHA512* New_ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method .ctor addr 0x245f1c8 size 0xf0 virtual false final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method get_BlockSize addr 0x245f2b8 size 0x18 virtual false final false
