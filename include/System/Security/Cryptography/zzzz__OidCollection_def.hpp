...
public:
  ...
  /// @brief Method Add, addr 0x625efac, size 0xc4, virtual false, abstract: false, final false
  inline int32_t Add(::System::Security::Cryptography::Oid* oid);

  /// @brief Method GetEnumerator, addr 0x625f124, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.ICollection.CopyTo, addr 0x625f190, size 0x1a4, virtual true, abstract: false, final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x625f18c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x625ef38, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x625f0d4, size 0x50, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsSynchronized, addr 0x625f334, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x625f070, size 0x64, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::Oid* get_Item(int32_t index);

  /// @brief Method get_SyncRoot, addr 0x625f33c, size 0x4, virtual true, abstract: false, final true
