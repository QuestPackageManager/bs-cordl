...
public:
  ...
  /// @brief Method .ctor addr 0x27f8118 size 0x80 virtual false final false
  inline void _ctor();

  /// @brief Method Add addr 0x27f8198 size 0xb4 virtual false final false
  inline int32_t Add(::System::Security::Cryptography::Oid* oid);

  /// @brief Method get_Item addr 0x27f824c size 0x58 virtual false final false
  inline ::System::Security::Cryptography::Oid* get_Item(int32_t index);

  /// @brief Method get_Count addr 0x27f82a4 size 0x48 virtual true final true
  inline int32_t get_Count();

  /// @brief Method GetEnumerator addr 0x27f82ec size 0x6c virtual false final false
  inline ::System::Security::Cryptography::OidEnumerator* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x27f8388 size 0x4 virtual true final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.ICollection.CopyTo addr 0x27f838c size 0x1bc virtual true final true
  inline void System_Collections_ICollection_CopyTo(::System::Array* array, int32_t index);

  /// @brief Method get_IsSynchronized addr 0x27f8548 size 0x8 virtual true final true
  inline bool get_IsSynchronized();

  /// @brief Method get_SyncRoot addr 0x27f8550 size 0x4 virtual true final true
