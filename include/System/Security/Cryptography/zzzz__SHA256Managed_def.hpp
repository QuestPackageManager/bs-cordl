...
public:
  ...
  /// @brief Method Ch, addr 0x3caabb8, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t Ch(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method HashCore, addr 0x3caa1d0, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x3caa39c, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x3caa18c, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x3caa0cc, size 0xc0, virtual false, abstract: false, final false
  inline void InitializeState();

  /// @brief Method Maj, addr 0x3caac24, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t Maj(uint32_t x, uint32_t y, uint32_t z);

  static inline ::System::Security::Cryptography::SHA256Managed* New_ctor();

  /// @brief Method RotateRight, addr 0x3caac38, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t RotateRight(uint32_t x, int32_t n);

  /// @brief Method SHA256Expand, addr 0x3caaab4, size 0xa8, virtual false, abstract: false, final false
  static inline void SHA256Expand(::cordl_internals::Ptr<uint32_t> x);

  /// @brief Method SHATransform, addr 0x3caa548, size 0x56c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sigma_1, addr 0x3caab5c, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t Sigma_1(uint32_t x);

  /// @brief Method _EndHash, addr 0x3caa3a0, size 0x1a8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> _EndHash();

  /// @brief Method _HashData, addr 0x3caa1d4, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3caa004, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method sigma_0, addr 0x3caac40, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t sigma_0(uint32_t x);

  /// @brief Method sigma_1, addr 0x3caac9c, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t sigma_1(uint32_t x);
