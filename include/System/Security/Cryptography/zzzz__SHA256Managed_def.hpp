...
public:
  ...
  /// @brief Method Ch, addr 0x5b029c0, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t Ch(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method HashCore, addr 0x5b01fec, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x5b021ac, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> HashFinal();

  /// @brief Method Initialize, addr 0x5b01fa8, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x5b01ee8, size 0xc0, virtual false, abstract: false, final false
  inline void InitializeState();

  /// @brief Method Maj, addr 0x5b02a30, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t Maj(uint32_t x, uint32_t y, uint32_t z);

  static inline ::System::Security::Cryptography::SHA256Managed* New_ctor();

  /// @brief Method RotateRight, addr 0x5b02a44, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t RotateRight(uint32_t x, int32_t n);

  /// @brief Method SHA256Expand, addr 0x5b028b4, size 0xac, virtual false, abstract: false, final false
  static inline void SHA256Expand(uint32_t* x);

  /// @brief Method SHATransform, addr 0x5b02334, size 0x580, virtual false, abstract: false, final false
  static inline void SHATransform(uint32_t* expandedBuffer, uint32_t* state, uint8_t* block);

  /// @brief Method Sigma_0, addr 0x5b029d0, size 0x60, virtual false, abstract: false, final false
  static inline uint32_t Sigma_0(uint32_t x);

  /// @brief Method Sigma_1, addr 0x5b02960, size 0x60, virtual false, abstract: false, final false
  static inline uint32_t Sigma_1(uint32_t x);

  /// @brief Method _EndHash, addr 0x5b021b0, size 0x184, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> _EndHash();

  /// @brief Method _HashData, addr 0x5b01ff0, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b01e1c, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method sigma_0, addr 0x5b02a4c, size 0x60, virtual false, abstract: false, final false
  static inline uint32_t sigma_0(uint32_t x);

  /// @brief Method sigma_1, addr 0x5b02aac, size 0x60, virtual false, abstract: false, final false
  static inline uint32_t sigma_1(uint32_t x);
