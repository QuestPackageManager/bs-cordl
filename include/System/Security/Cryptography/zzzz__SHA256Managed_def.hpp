...
public:
  ...
  /// @brief Method Ch, addr 0x3cac5ec, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t Ch(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method HashCore, addr 0x3cabc04, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x3cabdd0, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x3cabbc0, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x3cabb00, size 0xc0, virtual false, abstract: false, final false
  inline void InitializeState();

  /// @brief Method Maj, addr 0x3cac658, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t Maj(uint32_t x, uint32_t y, uint32_t z);

  static inline ::System::Security::Cryptography::SHA256Managed* New_ctor();

  /// @brief Method RotateRight, addr 0x3cac66c, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t RotateRight(uint32_t x, int32_t n);

  /// @brief Method SHA256Expand, addr 0x3cac4e8, size 0xa8, virtual false, abstract: false, final false
  static inline void SHA256Expand(::cordl_internals::Ptr<uint32_t> x);

  /// @brief Method SHATransform, addr 0x3cabf7c, size 0x56c, virtual false, abstract: false, final false
  ...
  /// @brief Method Sigma_0, addr 0x3cac5fc, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t Sigma_0(uint32_t x);

  /// @brief Method Sigma_1, addr 0x3cac590, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t Sigma_1(uint32_t x);

  /// @brief Method _EndHash, addr 0x3cabdd4, size 0x1a8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> _EndHash();

  /// @brief Method _HashData, addr 0x3cabc08, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3caba38, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method sigma_0, addr 0x3cac674, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t sigma_0(uint32_t x);

  /// @brief Method sigma_1, addr 0x3cac6d0, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t sigma_1(uint32_t x);
