...
/// @brief Method ECB, addr 0x59619f0, size 0x140, virtual true, abstract: false, final false
inline void ECB(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method GetStrongKey, addr 0x5961940, size 0xb0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetStrongKey() ;

static inline ::System::Security::Cryptography::TripleDESTransform* New_ctor(::System::Security::Cryptography::TripleDES*  algo, bool  encryption, ::ArrayW<uint8_t,::Array<uint8_t>*>  key, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv) ;
...
/// @brief Method .ctor, addr 0x5961624, size 0x31c, virtual false, abstract: false, final false
