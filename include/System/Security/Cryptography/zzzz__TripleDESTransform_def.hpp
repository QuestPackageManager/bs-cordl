...
public:
  ...
  /// @brief Method ECB, addr 0x3cb21cc, size 0x13c, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method GetStrongKey, addr 0x3cb2124, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cb1e08, size 0x31c, virtual false, abstract: false, final false
