...
public:
  ...
  /// @brief Method ECB, addr 0x25caed8, size 0x120, virtual true, abstract: false, final false
  inline void ECB(::ArrayW<uint8_t, ::Array<uint8_t>*> input, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method GetStrongKey, addr 0x25cae34, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c1d84, size 0x320, virtual false, abstract: false, final false
