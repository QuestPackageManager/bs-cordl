...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::TripleDESTransform*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::TripleDESTransform*, "System.Security.Cryptography", "TripleDESTransform");
...
static_assert(sizeof(::System::Security::Cryptography::TripleDESTransform) == 0x88, "Size mismatch!");
