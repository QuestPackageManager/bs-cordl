...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Oid", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Oid(Oid&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Oid", modifiers: "const&", def_value: None, comment: None }]
