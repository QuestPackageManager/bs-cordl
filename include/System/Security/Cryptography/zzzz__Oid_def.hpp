...
/// @brief Method FromOidValue, addr 0x61ecd64, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x61ecc70, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x61ecc74, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid) ;

/// @brief Method .ctor, addr 0x61ecd00, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::Oid*  oid) ;

/// @brief Method .ctor, addr 0x61eccf8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, ::StringW  friendlyName) ;

/// @brief Method .ctor, addr 0x61ece88, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, ::StringW  friendlyName, ::System::Security::Cryptography::OidGroup  group) ;

/// @brief Method get_FriendlyName, addr 0x61ecea4, size 0x88, virtual false, abstract: false, final false
inline ::StringW get_FriendlyName() ;

/// @brief Method get_Value, addr 0x61ece94, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x61ece9c, size 0x8, virtual false, abstract: false, final false
