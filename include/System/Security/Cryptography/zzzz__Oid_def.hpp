...
public:
  ...
  /// @brief Method FromOidValue, addr 0x4434ca0, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4434b60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4434b68, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method .ctor, addr 0x4434c20, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::Oid* oid);

  /// @brief Method .ctor, addr 0x4434bf4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW value, ::StringW friendlyName);

  /// @brief Method .ctor, addr 0x4434dcc, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW value, ::StringW friendlyName, ::System::Security::Cryptography::OidGroup group);

  /// @brief Method get_FriendlyName, addr 0x4434e18, size 0x84, virtual false, abstract: false, final false
  inline ::StringW get_FriendlyName();

  /// @brief Method get_Value, addr 0x4434e08, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x4434e10, size 0x8, virtual false, abstract: false, final false
