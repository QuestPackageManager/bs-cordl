...
public:
  ...
  /// @brief Method .ctor, addr 0x3ca17f4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3ca1818, size 0xb4, virtual false, abstract: false, final false
