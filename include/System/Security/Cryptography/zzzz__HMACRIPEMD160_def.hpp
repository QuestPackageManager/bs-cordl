...
public:
  ...
  /// @brief Method .ctor, addr 0x280c898, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x280c8bc, size 0xc0, virtual false, abstract: false, final false
