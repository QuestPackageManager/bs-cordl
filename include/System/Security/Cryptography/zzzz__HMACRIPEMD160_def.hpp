...
public:
  ...
  /// @brief Method .ctor, addr 0x25b4fe4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25b5008, size 0xc0, virtual false, abstract: false, final false
