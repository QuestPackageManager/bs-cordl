...
public:
  ...
  /// @brief Method .ctor, addr 0x594bbc8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x594bbec, size 0xb0, virtual false, abstract: false, final false
