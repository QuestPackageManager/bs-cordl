...
public:
  ...
  /// @brief Method .ctor, addr 0x59be040, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59be064, size 0xb0, virtual false, abstract: false, final false
