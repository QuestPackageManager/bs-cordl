...
public:
  ...
  /// @brief Method .ctor, addr 0x3caed84, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3caeda8, size 0xb4, virtual false, abstract: false, final false
