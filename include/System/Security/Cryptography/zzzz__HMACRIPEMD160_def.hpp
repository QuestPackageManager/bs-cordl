...
public:
  ...
  /// @brief Method .ctor, addr 0x27f8e84, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27f8ea8, size 0xc0, virtual false, abstract: false, final false
