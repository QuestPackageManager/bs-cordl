...
public:
  ...
  /// @brief Method SetHashAlgorithm, addr 0x3ca5414, size 0xc4, virtual true, abstract: false, final false
  inline void SetHashAlgorithm(::StringW strName);

  /// @brief Method SetKey, addr 0x3ca532c, size 0xe8, virtual true, abstract: false, final false
  inline void SetKey(::System::Security::Cryptography::AsymmetricAlgorithm* key);

  /// @brief Method VerifySignature, addr 0x3ca54d8, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ca51bc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3ca523c, size 0xf0, virtual false, abstract: false, final false
