...
public:
  ...
  /// @brief Method SetHashAlgorithm, addr 0x26e196c, size 0xcc, virtual true, abstract: false, final false
  inline void SetHashAlgorithm(::StringW strName);

  /// @brief Method SetKey, addr 0x26e1880, size 0xec, virtual true, abstract: false, final false
  inline void SetKey(::System::Security::Cryptography::AsymmetricAlgorithm* key);

  /// @brief Method VerifySignature, addr 0x26e1a38, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e170c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26e178c, size 0xf4, virtual false, abstract: false, final false
