...
public:
  ...
  /// @brief Method SetHashAlgorithm, addr 0x59bd538, size 0xbc, virtual true, abstract: false, final false
  inline void SetHashAlgorithm(::StringW strName);

  /// @brief Method SetKey, addr 0x59bd440, size 0xf8, virtual true, abstract: false, final false
  inline void SetKey(::System::Security::Cryptography::AsymmetricAlgorithm* key);

  /// @brief Method VerifySignature, addr 0x59bd5f4, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bd2c4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59bd340, size 0x100, virtual false, abstract: false, final false
