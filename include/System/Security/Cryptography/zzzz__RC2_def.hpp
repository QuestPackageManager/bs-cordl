...
public:
  ...
  /// @brief Method .ctor, addr 0x59bf204, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_EffectiveKeySize, addr 0x59bf284, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_EffectiveKeySize();

  /// @brief Method get_KeySize, addr 0x59bf2a0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_KeySize, addr 0x59bf2a8, size 0x60, virtual true, abstract: false, final false
