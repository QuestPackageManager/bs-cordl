...
public:
  ...
  /// @brief Method F, addr 0x27ff828, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t F(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method G, addr 0x27ff834, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t G(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method H, addr 0x27ff844, size 0xc, virtual false, abstract: false, final false
  static inline uint32_t H(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method HashCore, addr 0x27fde00, size 0x4, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x27fdf80, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method I, addr 0x27ff850, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t I(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method Initialize, addr 0x27fddbc, size 0x44, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeState, addr 0x27fdd38, size 0x84, virtual false, abstract: false, final false
  inline void InitializeState();

  /// @brief Method J, addr 0x27ff860, size 0x100c, virtual false, abstract: false, final false
  static inline uint32_t J(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method MDTransform, addr 0x27fe12c, size 0x16fc, virtual false, abstract: false, final false
  ...
  /// @brief Method _EndHash, addr 0x27fdf84, size 0x1a8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> _EndHash();

  /// @brief Method _HashData, addr 0x27fde04, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27f8f68, size 0x124, virtual false, abstract: false, final false
  inline void _ctor();
