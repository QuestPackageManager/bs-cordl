...
public:
  ...
  /// @brief Method CaptureHashCodeAndReinitialize, addr 0x26d8d38, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CaptureHashCodeAndReinitialize();

  /// @brief Method Clear, addr 0x26d91d4, size 0x94, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeHash, addr 0x26d8c88, size 0xb0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ComputeHash(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method ComputeHash, addr 0x26d8de0, size 0x178, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ComputeHash(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ComputeHash, addr 0x26d8f58, size 0x210, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ComputeHash(::System::IO::Stream* inputStream);

  /// @brief Method Create, addr 0x26d8ac0, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::HashAlgorithm* Create(::StringW hashName);

  /// @brief Method Dispose, addr 0x26d9168, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x26d9268, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method TransformBlock, addr 0x26d9290, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x26d9488, size 0x124, virtual true, abstract: false, final true
  ...
  /// @brief Method ValidateTransformBlock, addr 0x26d932c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d8ab8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CanTransformMultipleBlocks, addr 0x26d9288, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_Hash, addr 0x26d8b48, size 0xf8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Hash();

  /// @brief Method get_HashSize, addr 0x26d8b40, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_HashSize();

  /// @brief Method get_InputBlockSize, addr 0x26d9278, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_InputBlockSize();

  /// @brief Method get_OutputBlockSize, addr 0x26d9280, size 0x8, virtual true, abstract: false, final false
