...
public:
  // Declarations
  /// @brief Method Create, addr 0x25bd130, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::SHA1* Create();

  static inline ::System::Security::Cryptography::SHA1* New_ctor();

  /// @brief Method .ctor, addr 0x25bd110, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
