...
public:
// Declarations
/// @brief Method Create, addr 0x59c76a0, size 0x58, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA1* Create() ;

static inline ::System::Security::Cryptography::SHA1* New_ctor() ;

/// @brief Method .ctor, addr 0x59c7694, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
