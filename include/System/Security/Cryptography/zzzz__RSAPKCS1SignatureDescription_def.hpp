...
public:
  ...
  /// @brief Method .ctor, addr 0x5b06d00, size 0x9c, virtual false, abstract: false, final false
...
public:
  ...
  RSAPKCS1SignatureDescription(RSAPKCS1SignatureDescriptionconst&) = delete;
