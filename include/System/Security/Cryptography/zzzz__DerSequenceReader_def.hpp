...
public:
  ...
  /// @brief Method .ctor, addr 0x2979468, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <ReadT61String>b__45_0, addr 0x2979470, size 0x64, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* _ReadT61String_b__45_0();

  /// @brief Method <ReadT61String>b__45_1, addr 0x29794d4, size 0x44, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* _ReadT61String_b__45_1();

  /// @brief Method <ReadTime>b__51_0, addr 0x2979518, size 0xcc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method set_ContentLength, addr 0x2977ea8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2977eb0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2977ed4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2977ee8, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HasData, addr 0x2978098, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasData();

  /// @brief Method PeekTag, addr 0x29780a8, size 0x98, virtual false, abstract: false, final false
  inline uint8_t PeekTag();

  /// @brief Method SkipValue, addr 0x2978140, size 0x50, virtual false, abstract: false, final false
  inline void SkipValue();

  /// @brief Method ReadNextEncodedValue, addr 0x2978190, size 0xb8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadNextEncodedValue();

  /// @brief Method ReadBoolean, addr 0x2978368, size 0xcc, virtual false, abstract: false, final false
  inline bool ReadBoolean();

  /// @brief Method ReadInteger, addr 0x2978434, size 0xb4, virtual false, abstract: false, final false
  inline int32_t ReadInteger();

  /// @brief Method ReadIntegerBytes, addr 0x29784e8, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadIntegerBytes();

  /// @brief Method ReadBitString, addr 0x29785b8, size 0x148, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBitString();

  /// @brief Method ReadOctetString, addr 0x2978700, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadOctetString();

  /// @brief Method ReadOidAsString, addr 0x297871c, size 0x2bc, virtual false, abstract: false, final false
  inline ::StringW ReadOidAsString();

  /// @brief Method ReadUtf8String, addr 0x29789d8, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadUtf8String();

  /// @brief Method ReadCollectionWithTag, addr 0x2978ad0, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadSequence, addr 0x2978c40, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DerSequenceReader* ReadSequence();

  /// @brief Method ReadSet, addr 0x2978c48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DerSequenceReader* ReadSet();

  /// @brief Method ReadPrintableString, addr 0x2978c50, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadPrintableString();

  /// @brief Method ReadIA5String, addr 0x2978cd0, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadIA5String();

  /// @brief Method ReadT61String, addr 0x2978d50, size 0x2d8, virtual false, abstract: false, final false
  inline ::StringW ReadT61String();

  /// @brief Method ReadX509Date, addr 0x2979028, size 0x84, virtual false, abstract: false, final false
  inline ::System::DateTime ReadX509Date();

  /// @brief Method ReadUtcTime, addr 0x29790ac, size 0x4c, virtual false, abstract: false, final false
  inline ::System::DateTime ReadUtcTime();

  /// @brief Method ReadGeneralizedTime, addr 0x29790f8, size 0x4c, virtual false, abstract: false, final false
  inline ::System::DateTime ReadGeneralizedTime();

  /// @brief Method ReadBMPString, addr 0x2979384, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadBMPString();

  /// @brief Method TrimTrailingNulls, addr 0x2978a58, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW TrimTrailingNulls(::StringW value);

  /// @brief Method ReadTime, addr 0x2979144, size 0x240, virtual false, abstract: false, final false
  inline ::System::DateTime ReadTime(::System::Security::Cryptography::__DerSequenceReader__DerTag timeTag, ::StringW formatString);

  /// @brief Method ReadContentAsBytes, addr 0x2978504, size 0xb4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadContentAsBytes();

  /// @brief Method EatTag, addr 0x2977fdc, size 0x80, virtual false, abstract: false, final false
  inline void EatTag(::System::Security::Cryptography::__DerSequenceReader__DerTag expected);

  /// @brief Method CheckTag, addr 0x2978ba8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method EatLength, addr 0x297805c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t EatLength();

  /// @brief Method ScanContentLength, addr 0x2978248, size 0x120, virtual false, abstract: false, final false
