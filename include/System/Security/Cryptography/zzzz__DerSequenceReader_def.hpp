...
public:
  ...
  /// @brief Method <ReadT61String>b__45_0, addr 0x6184884, size 0x84, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* _ReadT61String_b__45_0();

  /// @brief Method <ReadT61String>b__45_1, addr 0x6184908, size 0x48, virtual false, abstract: false, final false
  inline ::System::Text::Encoding* _ReadT61String_b__45_1();

  /// @brief Method <ReadTime>b__51_0, addr 0x6184950, size 0xd4, virtual false, abstract: false, final false
  inline ::System::Globalization::DateTimeFormatInfo* _ReadTime_b__51_0();

  /// @brief Method .ctor, addr 0x6184880, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckTag, addr 0x6183fbc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method EatLength, addr 0x618344c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t EatLength();

  /// @brief Method EatTag, addr 0x61833cc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method PeekTag, addr 0x6183498, size 0x94, virtual false, abstract: false, final false
  inline uint8_t PeekTag();

  /// @brief Method ReadBMPString, addr 0x61847ac, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadBMPString();

  /// @brief Method ReadBitString, addr 0x618399c, size 0x148, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBitString();

  /// @brief Method ReadBoolean, addr 0x6183754, size 0xc8, virtual false, abstract: false, final false
  inline bool ReadBoolean();

  /// @brief Method ReadCollectionWithTag, addr 0x6183ef8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadContentAsBytes, addr 0x61838e8, size 0xb4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadContentAsBytes();

  /// @brief Method ReadGeneralizedTime, addr 0x6184514, size 0x50, virtual false, abstract: false, final false
  inline ::System::DateTime ReadGeneralizedTime();

  /// @brief Method ReadIA5String, addr 0x61840e4, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadIA5String();

  /// @brief Method ReadInteger, addr 0x618381c, size 0xb0, virtual false, abstract: false, final false
  inline int32_t ReadInteger();

  /// @brief Method ReadIntegerBytes, addr 0x61838cc, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadIntegerBytes();

  /// @brief Method ReadNextEncodedValue, addr 0x618357c, size 0xb8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadNextEncodedValue();

  /// @brief Method ReadOctetString, addr 0x6183ae4, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadOctetString();

  /// @brief Method ReadOidAsString, addr 0x6183b00, size 0x324, virtual false, abstract: false, final false
  inline ::StringW ReadOidAsString();

  /// @brief Method ReadPrintableString, addr 0x6184064, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadPrintableString();

  /// @brief Method ReadSequence, addr 0x6184054, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DerSequenceReader* ReadSequence();

  /// @brief Method ReadSet, addr 0x618405c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DerSequenceReader* ReadSet();

  /// @brief Method ReadT61String, addr 0x6184164, size 0x2e0, virtual false, abstract: false, final false
  inline ::StringW ReadT61String();

  /// @brief Method ReadTime, addr 0x6184564, size 0x248, virtual false, abstract: false, final false
  inline ::System::DateTime ReadTime(::System::Security::Cryptography::DerSequenceReader_DerTag timeTag, ::StringW formatString);

  /// @brief Method ReadUtcTime, addr 0x61844c4, size 0x50, virtual false, abstract: false, final false
  inline ::System::DateTime ReadUtcTime();

  /// @brief Method ReadUtf8String, addr 0x6183e24, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ReadUtf8String();

  /// @brief Method ReadX509Date, addr 0x6184444, size 0x80, virtual false, abstract: false, final false
  inline ::System::DateTime ReadX509Date();

  /// @brief Method ScanContentLength, addr 0x6183634, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method SkipValue, addr 0x618352c, size 0x50, virtual false, abstract: false, final false
  inline void SkipValue();

  /// @brief Method TrimTrailingNulls, addr 0x6183ea4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61832d8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x61832f8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset, int32_t length);

  /// @brief Method .ctor, addr 0x618330c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HasData, addr 0x6183488, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ContentLength, addr 0x61832d0, size 0x8, virtual false, abstract: false, final false
