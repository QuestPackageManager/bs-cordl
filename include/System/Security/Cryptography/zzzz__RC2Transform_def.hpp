...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RC2Transform", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RC2Transform(RC2Transform&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RC2Transform", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RC2Transform(RC2Transformconst&) = delete;
