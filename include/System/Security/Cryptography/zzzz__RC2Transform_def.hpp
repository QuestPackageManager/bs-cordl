...
public:
  ...
  /// @brief Method ECB, addr 0x3cb6208, size 0x970, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3cb5cb0, size 0x558, virtual false, abstract: false, final false
