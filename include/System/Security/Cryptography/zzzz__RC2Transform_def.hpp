...
public:
  ...
  /// @brief Method ECB, addr 0x280d248, size 0x930, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x280cd00, size 0x548, virtual false, abstract: false, final false
