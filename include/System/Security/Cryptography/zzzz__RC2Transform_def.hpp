...
public:
  ...
  /// @brief Method ECB, addr 0x27f2bbc, size 0x930, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27f2674, size 0x548, virtual false, abstract: false, final false
