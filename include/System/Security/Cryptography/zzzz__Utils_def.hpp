...
public:
  ...
  /// @brief Method get_StaticRandomNumberGenerator addr 0x2312fa4 size 0xa0 virtual false final false
  static inline ::System::Security::Cryptography::RNGCryptoServiceProvider* get_StaticRandomNumberGenerator();

  /// @brief Method GenerateRandom addr 0x2313144 size 0x70 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateRandom(int32_t keySize);

  /// @brief Method HasAlgorithm addr 0x231298c size 0x8 virtual false final false
  static inline bool HasAlgorithm(int32_t dwCalg, int32_t dwKeySize);

  /// @brief Method DiscardWhiteSpaces addr 0x23131b4 size 0x1c virtual false final false
  static inline ::StringW DiscardWhiteSpaces(::StringW inputBuffer);

  /// @brief Method DiscardWhiteSpaces addr 0x23131d0 size 0x188 virtual false final false
  static inline ::StringW DiscardWhiteSpaces(::StringW inputBuffer, int32_t inputOffset, int32_t inputCount);

  /// @brief Method ConvertByteArrayToInt addr 0x2313358 size 0x60 virtual false final false
  static inline int32_t ConvertByteArrayToInt(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method ConvertIntToByteArray addr 0x23133b8 size 0x120 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertIntToByteArray(int32_t dwInput);

  /// @brief Method FixupKeyParity addr 0x23125d4 size 0xc8 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> FixupKeyParity(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method DWORDFromLittleEndian addr 0x23134d8 size 0x4c virtual false final false
  static inline void DWORDFromLittleEndian(::cordl_internals::Ptr<uint32_t> x, int32_t digits, ::cordl_internals::Ptr<uint8_t> block);

  /// @brief Method DWORDToLittleEndian addr 0x2313524 size 0xf4 virtual false final false
  ...
  /// @brief Method _ProduceLegacyHmacValues addr 0x231375c size 0x8 virtual false final false
