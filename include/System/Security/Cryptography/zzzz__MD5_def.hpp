...
public:
  // Declarations
  /// @brief Method Create, addr 0x59bf0dc, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::MD5* Create();

  static inline ::System::Security::Cryptography::MD5* New_ctor();

  /// @brief Method .ctor, addr 0x59bf0d0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
