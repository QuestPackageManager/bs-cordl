...
public:
  ...
  /// @brief Method BasicConstraintsExtension, addr 0x63a2ef0, size 0x108, virtual false, abstract: false, final false
  inline ::StringW BasicConstraintsExtension(bool multiLine);

  /// @brief Method CopyFrom, addr 0x63a2ac0, size 0x100, virtual true, abstract: false, final false
  inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method Default, addr 0x63a2bfc, size 0x124, virtual false, abstract: false, final false
  inline ::StringW Default(bool multiLine);

  /// @brief Method EnhancedKeyUsageExtension, addr 0x63a2ff8, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW EnhancedKeyUsageExtension(bool multiLine);

  /// @brief Method Format, addr 0x63a2bc0, size 0x3c, virtual true, abstract: false, final false
  inline ::StringW Format(bool multiLine);

  /// @brief Method KeyUsageExtension, addr 0x63a3104, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW KeyUsageExtension(bool multiLine);

  /// @brief Method NetscapeCertType, addr 0x63a3728, size 0x3fc, virtual false, abstract: false, final false
  ...
  /// @brief Method SubjectAltName, addr 0x63a331c, size 0x40c, virtual false, abstract: false, final false
  inline ::StringW SubjectAltName(bool multiLine);

  /// @brief Method SubjectKeyIdentifierExtension, addr 0x63a3210, size 0x10c, virtual false, abstract: false, final false
  inline ::StringW SubjectKeyIdentifierExtension(bool multiLine);

  /// @brief Method ToString, addr 0x63a2d20, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63a27e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63a29e0, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::AsnEncodedData* asnEncodedData);

  /// @brief Method .ctor, addr 0x63a27e8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid, ::ArrayW<uint8_t> rawData);

  /// @brief Method .ctor, addr 0x63a2940, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::Oid* oid, ::ArrayW<uint8_t> rawData);

  /// @brief Method get_Oid, addr 0x63a2ab0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::Oid* get_Oid();

  /// @brief Method get_RawData, addr 0x63a2ab8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_RawData();

  /// @brief Method set_Oid, addr 0x63a2968, size 0x78, virtual false, abstract: false, final false
  inline void set_Oid(::System::Security::Cryptography::Oid* value);

  /// @brief Method set_RawData, addr 0x63a285c, size 0xe4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsnEncodedData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsnEncodedData(AsnEncodedData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsnEncodedData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsnEncodedData(AsnEncodedDataconst&) = delete;
