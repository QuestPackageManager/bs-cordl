...
public:
  ...
  /// @brief Method Equals, addr 0x27d3030, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x27d325c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXml, addr 0x27d2b3c, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27d28fc, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27d2b2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x27d29bc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Security::Permissions::PermissionState state);

  /// @brief Method get_Name, addr 0x27d2b34, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x27d2a6c, size 0xc0, virtual false, abstract: false, final false
