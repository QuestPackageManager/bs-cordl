...
public:
  ...
  /// @brief Method Equals, addr 0x5aed600, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5aed828, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXml, addr 0x5aed12c, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5aecf2c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5aed11c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x5aecfe0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::System::Security::Permissions::PermissionState state);

  /// @brief Method get_Name, addr 0x5aed124, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x5aed094, size 0x88, virtual false, abstract: false, final false
