...
public:
  // Declarations
  /// @brief Method EnsureElevatedPermissions, addr 0x3c992fc, size 0x4, virtual false, abstract: false, final false
  static inline void EnsureElevatedPermissions();

  /// @brief Method get_SecurityEnabled, addr 0x3c95e04, size 0x8, virtual false, abstract: false, final false
