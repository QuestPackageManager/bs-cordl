...
public:
  // Declarations
  /// @brief Method EnsureElevatedPermissions, addr 0x5af011c, size 0x4, virtual false, abstract: false, final false
  static inline void EnsureElevatedPermissions();

  /// @brief Method get_SecurityEnabled, addr 0x5aecc6c, size 0x8, virtual false, abstract: false, final false
