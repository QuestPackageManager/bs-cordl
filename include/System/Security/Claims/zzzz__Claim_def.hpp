...
public:
  ...
  /// @brief Method Clone, addr 0x59da848, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDeserializedMethod, addr 0x59da7d8, size 0x50, virtual false, abstract: false, final false
  inline void OnDeserializedMethod(::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method ToString, addr 0x59da8b4, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59da4c8, size 0x310, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Claims::Claim* other, ::System::Security::Claims::ClaimsIdentity* subject);

  /// @brief Method .ctor, addr 0x59d58d8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59da15c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Properties, addr 0x59da37c, size 0x14c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* get_Properties();

  /// @brief Method get_Subject, addr 0x59da828, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Claims::ClaimsIdentity* get_Subject();

  /// @brief Method get_Type, addr 0x59da838, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Type();

  /// @brief Method get_Value, addr 0x59da840, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Subject, addr 0x59da830, size 0x8, virtual false, abstract: false, final false
