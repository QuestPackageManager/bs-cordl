...
public:
  ...
  /// @brief Method MoveNext, addr 0x596aae8, size 0x3f4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::System::Security::Claims::ClaimsIdentity__get_Claims_d__51* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Security.Claims.Claim>.GetEnumerator, addr 0x596afd8, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Security.Claims.Claim>.get_Current, addr 0x596af90, size 0x8, virtual true, abstract: false, final true
  inline ::System::Security::Claims::Claim* System_Collections_Generic_IEnumerator_System_Security_Claims_Claim__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x596b070, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x596af98, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x596afd0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x596aacc, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x596aedc, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x5969a3c, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddClaim, addr 0x5963480, size 0x178, virtual true, abstract: false, final false
  inline void AddClaim(::System::Security::Claims::Claim* claim);

  /// @brief Method Clone, addr 0x5967ae0, size 0x148, virtual true, abstract: false, final false
  inline ::System::Security::Claims::ClaimsIdentity* Clone();

  /// @brief Method Deserialize, addr 0x5969234, size 0x778, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeClaims, addr 0x596a128, size 0x31c, virtual false, abstract: false, final false
  inline void DeserializeClaims(::StringW serializedClaims);

  /// @brief Method FindFirst, addr 0x5969a88, size 0x338, virtual true, abstract: false, final false
  inline ::System::Security::Claims::Claim* FindFirst(::StringW type);

  /// @brief Method GetObjectData, addr 0x596a528, size 0x5a4, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method IsCircular, addr 0x5968b88, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeserializedMethod, addr 0x596a058, size 0xd0, virtual false, abstract: false, final false
  inline void OnDeserializedMethod(::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method OnDeserializingMethod, addr 0x596a444, size 0xe4, virtual false, abstract: false, final false
  inline void OnDeserializingMethod(::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method OnSerializingMethod, addr 0x5969dc0, size 0x68, virtual false, abstract: false, final false
  inline void OnSerializingMethod(::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method SafeAddClaim, addr 0x5968f74, size 0x130, virtual false, abstract: false, final false
  inline void SafeAddClaim(::System::Security::Claims::Claim* claim);

  /// @brief Method SafeAddClaims, addr 0x5968bc8, size 0x3ac, virtual false, abstract: false, final false
  inline void SafeAddClaims(::System::Collections::Generic::IEnumerable_1<::System::Security::Claims::Claim*>* claims);

  /// @brief Method SerializeClaims, addr 0x5969e28, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5963058, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x59684f0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::System::Security::Claims::Claim*>* claims);

  /// @brief Method .ctor, addr 0x596850c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5968514, size 0x674, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Principal::IIdentity* identity, ::System::Collections::Generic::IEnumerable_1<::System::Security::Claims::Claim*>* claims, ::StringW authenticationType,
                    ::StringW nameType, ::StringW roleType, bool checkAuthType);

  /// @brief Method .ctor, addr 0x59690a4, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method .ctor, addr 0x596319c, size 0x1e4, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Claims::ClaimsIdentity* other);

  /// @brief Method get_Actor, addr 0x59699b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Claims::ClaimsIdentity* get_Actor();

  /// @brief Method get_AuthenticationType, addr 0x59699ac, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_AuthenticationType();

  /// @brief Method get_Claims, addr 0x59633e0, size 0x70, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Security::Claims::Claim*>* get_Claims();

  /// @brief Method get_Name, addr 0x5969a5c, size 0x24, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameClaimType, addr 0x5969a80, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Actor, addr 0x59699bc, size 0x80, virtual false, abstract: false, final false
