...
public:
  ...
  /// @brief Method .ctor addr 0x2470f74 size 0x58 virtual false final false
  inline void _ctor();

  static inline ::System::UnauthorizedAccessException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x2470fcc size 0x20 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::System::UnauthorizedAccessException* New_ctor(::StringW message, ::System::Exception* inner);

  /// @brief Method .ctor addr 0x2470fec size 0x20 virtual false final false
  ...
  /// @brief Method .ctor addr 0x247100c size 0x4 virtual false final false
