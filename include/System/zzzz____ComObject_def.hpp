...
public:
  // Ctor Parameters [CppParam { name: "", ty: "__ComObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __ComObject(__ComObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__ComObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __ComObject(__ComObjectconst&) = delete;
