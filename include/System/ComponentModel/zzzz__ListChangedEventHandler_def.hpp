...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2a5c9a0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a5c870, size 0x130, virtual false, abstract: false, final false
