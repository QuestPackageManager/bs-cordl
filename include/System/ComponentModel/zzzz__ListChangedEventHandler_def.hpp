...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x63c2f8c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63c2e44, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  ListChangedEventHandler(ListChangedEventHandlerconst&) = delete;
