...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x61a5908, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a57c0, size 0x148, virtual false, abstract: false, final false
