...
public:
  ...
  /// @brief Method CreateInstance, addr 0x44560dc, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCache, addr 0x445612c, size 0x28, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* GetCache(::System::Object* instance);

  /// @brief Method GetExtendedTypeDescriptor, addr 0x4456154, size 0x28, virtual true, abstract: false, final false
  inline ::System::ComponentModel::ICustomTypeDescriptor* GetExtendedTypeDescriptor(::System::Object* instance);

  /// @brief Method GetExtenderProviders, addr 0x445617c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method GetReflectionType, addr 0x44561a4, size 0x38, virtual true, abstract: false, final false
  inline ::System::Type* GetReflectionType(::System::Type* objectType, ::System::Object* instance);

  /// @brief Method GetTypeDescriptor, addr 0x44561dc, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4456050, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_Provider, addr 0x4456080, size 0x5c, virtual false, abstract: false, final false
