...
public:
  ...
  /// @brief Method CreateInstance, addr 0x620a2e4, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCache, addr 0x620a334, size 0x28, virtual true, abstract: false, final false
  inline ::System::Collections::IDictionary* GetCache(::System::Object* instance);

  /// @brief Method GetExtendedTypeDescriptor, addr 0x620a35c, size 0x28, virtual true, abstract: false, final false
  inline ::System::ComponentModel::ICustomTypeDescriptor* GetExtendedTypeDescriptor(::System::Object* instance);

  /// @brief Method GetExtenderProviders, addr 0x620a384, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method GetReflectionType, addr 0x620a3ac, size 0x38, virtual true, abstract: false, final false
  inline ::System::Type* GetReflectionType(::System::Type* objectType, ::System::Object* instance);

  /// @brief Method GetTypeDescriptor, addr 0x620a3e4, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x620a278, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_Provider, addr 0x620a284, size 0x60, virtual false, abstract: false, final false
