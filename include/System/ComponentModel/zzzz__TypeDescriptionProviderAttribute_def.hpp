...
/// @brief Method .ctor, addr 0x62143b4, size 0x58, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName) ;

/// @brief Method get_TypeName, addr 0x621440c, size 0x8, virtual false, abstract: false, final false
