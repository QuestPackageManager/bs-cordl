...
// Write type traits
MARK_REF_T(::System::ComponentModel::TypeDescriptionProviderAttribute*);
DEFINE_IL2CPP_CLASS(::System::ComponentModel::TypeDescriptionProviderAttribute*, "System.ComponentModel", "TypeDescriptionProviderAttribute");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TypeDescriptionProviderAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TypeDescriptionProviderAttribute(TypeDescriptionProviderAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TypeDescriptionProviderAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TypeDescriptionProviderAttribute(TypeDescriptionProviderAttributeconst&) = delete;
...
static_assert(sizeof(::System::ComponentModel::TypeDescriptionProviderAttribute) == 0x18, "Size mismatch!");
