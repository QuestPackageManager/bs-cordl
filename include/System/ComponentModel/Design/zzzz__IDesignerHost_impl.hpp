...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::ComponentModel::IComponent* (::System::ComponentModel::Design::IDesignerHost::*)()>(&::System::ComponentModel::Design::IDesignerHost::get_RootComponent)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::ComponentModel::Design::IDesigner* (::System::ComponentModel::Design::IDesignerHost::*)(::System::ComponentModel::IComponent*)>(&::System::ComponentModel::Design::IDesignerHost::GetDesigner)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
