...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CheckoutException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CheckoutException(CheckoutException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CheckoutException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CheckoutException(CheckoutExceptionconst&) = delete;
