...
/// @brief Method .ctor, addr 0x6237834, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  serializerTypeName, ::StringW  baseSerializerTypeName, bool  reloadable) ;

/// @brief Method get_SerializerBaseTypeName, addr 0x6237840, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SerializerBaseTypeName() ;

/// @brief Method get_TypeId, addr 0x6237848, size 0x90, virtual true, abstract: false, final false
