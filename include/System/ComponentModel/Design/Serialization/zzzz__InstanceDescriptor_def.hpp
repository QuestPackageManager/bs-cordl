...
public:
  ...
  /// @brief Method Invoke, addr 0x62a94a8, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62a8f5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* member, ::System::Collections::ICollection* arguments);

  /// @brief Method .ctor, addr 0x62a8f64, size 0x534, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* member, ::System::Collections::ICollection* arguments, bool isComplete);

  /// @brief Method get_Arguments, addr 0x62a9498, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Arguments();

  /// @brief Method get_MemberInfo, addr 0x62a94a0, size 0x8, virtual false, abstract: false, final false
