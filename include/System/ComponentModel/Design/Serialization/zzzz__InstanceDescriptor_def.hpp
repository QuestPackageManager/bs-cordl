...
public:
  ...
  /// @brief Method Invoke, addr 0x446f7a0, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x447f834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* member, ::System::Collections::ICollection* arguments);

  /// @brief Method .ctor, addr 0x447f83c, size 0x508, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* member, ::System::Collections::ICollection* arguments, bool isComplete);

  /// @brief Method get_Arguments, addr 0x447fd44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::ICollection* get_Arguments();

  /// @brief Method get_MemberInfo, addr 0x447fd4c, size 0x8, virtual false, abstract: false, final false
