...
// Write type traits
MARK_REF_T(::System::ComponentModel::Design::IDesignerHost*);
DEFINE_IL2CPP_CLASS(::System::ComponentModel::Design::IDesignerHost*, "System.ComponentModel.Design", "IDesignerHost");
// Dependencies
namespace System::ComponentModel::Design {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDesignerHost", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDesignerHost(IDesignerHostconst&) = delete;
