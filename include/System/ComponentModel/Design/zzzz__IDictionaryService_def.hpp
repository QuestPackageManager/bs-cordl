...
// Write type traits
MARK_REF_T(::System::ComponentModel::Design::IDictionaryService*);
DEFINE_IL2CPP_CLASS(::System::ComponentModel::Design::IDictionaryService*, "System.ComponentModel.Design", "IDictionaryService");
// Dependencies
namespace System::ComponentModel::Design {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDictionaryService", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDictionaryService(IDictionaryServiceconst&) = delete;
