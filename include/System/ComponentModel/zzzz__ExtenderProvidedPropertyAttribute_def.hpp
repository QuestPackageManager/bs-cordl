...
public:
  ...
  /// @brief Method Create addr 0x27922ac size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x279270c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method get_ExtenderProperty addr 0x2792714 size 0x8 virtual false final false
  inline ::System::ComponentModel::PropertyDescriptor* get_ExtenderProperty();

  /// @brief Method set_ExtenderProperty addr 0x279271c size 0x8 virtual false final false
  inline void set_ExtenderProperty(::System::ComponentModel::PropertyDescriptor* value);

  /// @brief Method get_Provider addr 0x2792724 size 0x8 virtual false final false
  inline ::System::ComponentModel::IExtenderProvider* get_Provider();

  /// @brief Method set_Provider addr 0x279272c size 0x8 virtual false final false
  inline void set_Provider(::System::ComponentModel::IExtenderProvider* value);

  /// @brief Method get_ReceiverType addr 0x2792734 size 0x8 virtual false final false
  inline ::System::Type* get_ReceiverType();

  /// @brief Method set_ReceiverType addr 0x279273c size 0x8 virtual false final false
  inline void set_ReceiverType(::System::Type* value);

  /// @brief Method Equals addr 0x2792744 size 0xd4 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2792818 size 0x8 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute addr 0x2792820 size 0x60 virtual true final false
