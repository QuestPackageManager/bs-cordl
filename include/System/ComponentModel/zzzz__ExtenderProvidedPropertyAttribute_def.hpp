...
public:
  ...
  /// @brief Method Create, addr 0x627e7f4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x627ec78, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x627ed54, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x627ed5c, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x627ec44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ExtenderProperty, addr 0x627ec48, size 0x8, virtual false, abstract: false, final false
  inline ::System::ComponentModel::PropertyDescriptor* get_ExtenderProperty();

  /// @brief Method get_Provider, addr 0x627ec58, size 0x8, virtual false, abstract: false, final false
  inline ::System::ComponentModel::IExtenderProvider* get_Provider();

  /// @brief Method get_ReceiverType, addr 0x627ec68, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_ReceiverType();

  /// @brief Method set_ExtenderProperty, addr 0x627ec50, size 0x8, virtual false, abstract: false, final false
  inline void set_ExtenderProperty(::System::ComponentModel::PropertyDescriptor* value);

  /// @brief Method set_Provider, addr 0x627ec60, size 0x8, virtual false, abstract: false, final false
  inline void set_Provider(::System::ComponentModel::IExtenderProvider* value);

  /// @brief Method set_ReceiverType, addr 0x627ec70, size 0x8, virtual false, abstract: false, final false
