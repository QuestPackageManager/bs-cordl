...
public:
  ...
  /// @brief Method Equals, addr 0x444cfa8, size 0xfc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x444d0a4, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x444ce04, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x444ce6c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(bool defaultType);

  /// @brief Method .ctor, addr 0x444cec8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ToolboxItemTypeName, addr 0x444cf54, size 0x54, virtual false, abstract: false, final false
