...
public:
  ...
  /// @brief Method Equals, addr 0x2e3e8a4, size 0xf4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2e3e998, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x2e3e700, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e3e768, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(bool defaultType);

  /// @brief Method .ctor, addr 0x2e3e7c4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ToolboxItemTypeName, addr 0x2e3e850, size 0x54, virtual false, abstract: false, final false
