...
public:
  ...
  /// @brief Method .ctor, addr 0x44431f0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NewObject, addr 0x4443248, size 0x8, virtual false, abstract: false, final false
