...
public:
  ...
  /// @brief Method Equals, addr 0x63eacb0, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x63ead3c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x63ead44, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63eaca0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NotifyParent, addr 0x63eaca8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotifyParentPropertyAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotifyParentPropertyAttribute(NotifyParentPropertyAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotifyParentPropertyAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotifyParentPropertyAttribute(NotifyParentPropertyAttributeconst&) = delete;
