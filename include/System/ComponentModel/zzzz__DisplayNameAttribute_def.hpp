...
public:
  ...
  /// @brief Method Equals, addr 0x2f53728, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2f537f4, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x2f5381c, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f5368c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f536e8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName);

  static inline ::System::ComponentModel::DisplayNameAttribute* getStaticF_Default();

  /// @brief Method get_DisplayName, addr 0x2f53710, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_DisplayNameValue, addr 0x2f53718, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DisplayNameValue, addr 0x2f53720, size 0x8, virtual false, abstract: false, final false
