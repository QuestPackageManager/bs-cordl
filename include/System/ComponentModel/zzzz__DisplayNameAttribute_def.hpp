...
public:
  ...
  /// @brief Method Equals, addr 0x2f33038, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2f33104, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x2f3312c, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f32f9c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f32ff8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName);

  static inline ::System::ComponentModel::DisplayNameAttribute* getStaticF_Default();

  /// @brief Method get_DisplayName, addr 0x2f33020, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_DisplayNameValue, addr 0x2f33028, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DisplayNameValue, addr 0x2f33030, size 0x8, virtual false, abstract: false, final false
