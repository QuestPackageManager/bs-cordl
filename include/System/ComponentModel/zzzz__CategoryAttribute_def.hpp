...
/// @brief Method Equals, addr 0x62151f0, size 0x144, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x6215334, size 0x50, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetLocalizedString, addr 0x6215384, size 0x40c, virtual true, abstract: false, final false
inline ::StringW GetLocalizedString(::StringW  value) ;

/// @brief Method IsDefaultAttribute, addr 0x6215790, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6215154, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x62151a4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  category) ;

static inline ::System::ComponentModel::CategoryAttribute* getStaticF_defAttr() ;

/// @brief Method get_Category, addr 0x62151b0, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_Category() ;

/// @brief Method get_Default, addr 0x6215094, size 0xc0, virtual false, abstract: false, final false
