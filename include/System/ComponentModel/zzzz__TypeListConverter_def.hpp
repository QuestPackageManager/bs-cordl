...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TypeListConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TypeListConverter(TypeListConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TypeListConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TypeListConverter(TypeListConverterconst&) = delete;
