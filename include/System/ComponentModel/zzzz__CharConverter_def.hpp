...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CharConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CharConverter(CharConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CharConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CharConverter(CharConverterconst&) = delete;
