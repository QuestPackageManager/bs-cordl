...
public:
  ...
  /// @brief Method GetErrorMessage, addr 0x2e69f9c, size 0x8f4, virtual false, abstract: false, final false
  static inline ::StringW GetErrorMessage(int32_t error);

  /// @brief Method GetObjectData, addr 0x2e6a94c, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e69ef0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2e69f64, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(int32_t error);

  /// @brief Method .ctor, addr 0x2e6a890, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t error, ::StringW message);

  /// @brief Method .ctor, addr 0x2e6a8bc, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_NativeErrorCode, addr 0x2e6a944, size 0x8, virtual false, abstract: false, final false
