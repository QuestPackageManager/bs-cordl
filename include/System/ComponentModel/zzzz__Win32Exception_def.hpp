...
public:
  ...
  /// @brief Method GetErrorMessage, addr 0x447868c, size 0x8f4, virtual false, abstract: false, final false
  static inline ::StringW GetErrorMessage(int32_t error);

  /// @brief Method GetObjectData, addr 0x447903c, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44785e0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4478654, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(int32_t error);

  /// @brief Method .ctor, addr 0x4478f80, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t error, ::StringW message);

  /// @brief Method .ctor, addr 0x4478fac, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_NativeErrorCode, addr 0x4479034, size 0x8, virtual false, abstract: false, final false
