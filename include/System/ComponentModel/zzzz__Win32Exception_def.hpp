...
public:
  ...
  /// @brief Method GetErrorMessage, addr 0x63e4744, size 0xb9c, virtual false, abstract: false, final false
  static inline ::StringW GetErrorMessage(int32_t error);

  /// @brief Method GetObjectData, addr 0x63e53b4, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63e4680, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63e4700, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(int32_t error);

  /// @brief Method .ctor, addr 0x63e52e0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(int32_t error, ::StringW message);

  /// @brief Method .ctor, addr 0x63e5318, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method get_NativeErrorCode, addr 0x63e53ac, size 0x8, virtual false, abstract: false, final false
