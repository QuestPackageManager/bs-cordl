...
public:
  ...
  /// @brief Method GetValue, addr 0x63b5608, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x63b5688, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63b544c, size 0xc0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArrayConverter_ArrayPropertyDescriptor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArrayConverter_ArrayPropertyDescriptor(ArrayConverter_ArrayPropertyDescriptor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArrayConverter_ArrayPropertyDescriptor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArrayConverter_ArrayPropertyDescriptor(ArrayConverter_ArrayPropertyDescriptorconst&) = delete;
...
public:
  ...
  /// @brief Method ConvertTo, addr 0x63b50fc, size 0x180, virtual true, abstract: false, final false
  inline ::System::Object* ConvertTo(::System::ComponentModel::ITypeDescriptorContext* context, ::System::Globalization::CultureInfo* culture, ::System::Object* value,
                                     ::System::Type* destinationType);

  /// @brief Method GetProperties, addr 0x63b527c, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesSupported, addr 0x63b55fc, size 0x8, virtual true, abstract: false, final false
  inline bool GetPropertiesSupported(::System::ComponentModel::ITypeDescriptorContext* context);

  static inline ::System::ComponentModel::ArrayConverter* New_ctor();

  /// @brief Method .ctor, addr 0x63b5604, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArrayConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArrayConverter(ArrayConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArrayConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArrayConverter(ArrayConverterconst&) = delete;
