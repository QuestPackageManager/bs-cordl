...
public:
  ...
  /// @brief Method CheckAttributesValid, addr 0x4460a2c, size 0xb0, virtual false, abstract: false, final false
  inline void CheckAttributesValid();

  /// @brief Method CreateAttributeCollection, addr 0x4461568, size 0x74, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* CreateAttributeCollection();

  /// @brief Method Equals, addr 0x44615dc, size 0x274, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method FillAttributes, addr 0x4461850, size 0xf4, virtual true, abstract: false, final false
  inline void FillAttributes(::System::Collections::IList* attributeList);

  /// @brief Method FilterAttributesIfNeeded, addr 0x4460adc, size 0x764, virtual false, abstract: false, final false
  inline void FilterAttributesIfNeeded();

  /// @brief Method FindMethod, addr 0x4461944, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindMethod, addr 0x446194c, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodInfo* FindMethod(::System::Type* componentClass, ::StringW name, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> args, ::System::Type* returnType,
                                                             bool publicOnly);

  /// @brief Method GetHashCode, addr 0x44619f0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetInvocationTarget, addr 0x44619f8, size 0x108, virtual true, abstract: false, final false
  inline ::System::Object* GetInvocationTarget(::System::Type* type, ::System::Object* instance);

  /// @brief Method GetSite, addr 0x446219c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4460444, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> attributes);

  /// @brief Method .ctor, addr 0x44605d4, size 0x438, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AttributeArray, addr 0x4460a0c, size 0x20, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> get_AttributeArray();

  /// @brief Method get_Attributes, addr 0x4461304, size 0xe4, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* get_Attributes();

  /// @brief Method get_DisplayName, addr 0x4461440, size 0x128, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_Name, addr 0x44613e8, size 0x50, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameHashCode, addr 0x4461438, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_NameHashCode();

  /// @brief Method set_AttributeArray, addr 0x4461240, size 0xc4, virtual true, abstract: false, final false
