...
public:
  ...
  /// @brief Method .ctor addr 0x291d06c size 0x1a4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x291d210 size 0x428 virtual false final false
  ...
  /// @brief Method get_AttributeArray addr 0x291d638 size 0x20 virtual true final false
  inline ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> get_AttributeArray();

  /// @brief Method set_AttributeArray addr 0x291de50 size 0xc4 virtual true final false
  inline void set_AttributeArray(::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> value);

  /// @brief Method get_Attributes addr 0x291df14 size 0xe8 virtual true final false
  inline ::System::ComponentModel::AttributeCollection* get_Attributes();

  /// @brief Method get_Name addr 0x291dffc size 0x50 virtual true final false
  inline ::StringW get_Name();

  /// @brief Method get_NameHashCode addr 0x291e04c size 0x8 virtual true final false
  inline int32_t get_NameHashCode();

  /// @brief Method get_DisplayName addr 0x291e054 size 0x128 virtual true final false
  inline ::StringW get_DisplayName();

  /// @brief Method CheckAttributesValid addr 0x291d658 size 0xb0 virtual false final false
  inline void CheckAttributesValid();

  /// @brief Method CreateAttributeCollection addr 0x291e17c size 0x7c virtual true final false
  inline ::System::ComponentModel::AttributeCollection* CreateAttributeCollection();

  /// @brief Method Equals addr 0x291e1f8 size 0x264 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method FillAttributes addr 0x29178e8 size 0xf4 virtual true final false
  inline void FillAttributes(::System::Collections::IList* attributeList);

  /// @brief Method FilterAttributesIfNeeded addr 0x291d708 size 0x748 virtual false final false
  inline void FilterAttributesIfNeeded();

  /// @brief Method FindMethod addr 0x2917e2c size 0x8 virtual false final false
  ...
  /// @brief Method FindMethod addr 0x291e45c size 0xa4 virtual false final false
  static inline ::System::Reflection::MethodInfo* FindMethod(::System::Type* componentClass, ::StringW name, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> args, ::System::Type* returnType,
                                                             bool publicOnly);

  /// @brief Method GetHashCode addr 0x291e500 size 0x8 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method GetInvocationTarget addr 0x291e508 size 0x110 virtual true final false
  inline ::System::Object* GetInvocationTarget(::System::Type* type, ::System::Object* instance);

  /// @brief Method GetSite addr 0x291ecec size 0xfc virtual false final false
