...
public:
  ...
  /// @brief Method CheckAttributesValid, addr 0x61b12b4, size 0xbc, virtual false, abstract: false, final false
  inline void CheckAttributesValid();

  /// @brief Method CreateAttributeCollection, addr 0x61b1dd4, size 0x78, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* CreateAttributeCollection();

  /// @brief Method Equals, addr 0x61b1e4c, size 0x280, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method FillAttributes, addr 0x61b20cc, size 0xf8, virtual true, abstract: false, final false
  inline void FillAttributes(::System::Collections::IList* attributeList);

  /// @brief Method FilterAttributesIfNeeded, addr 0x61b1370, size 0x754, virtual false, abstract: false, final false
  inline void FilterAttributesIfNeeded();

  /// @brief Method FindMethod, addr 0x61b21c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindMethod, addr 0x61b21cc, size 0x80, virtual false, abstract: false, final false
  static inline ::System::Reflection::MethodInfo* FindMethod(::System::Type* componentClass, ::StringW name, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> args, ::System::Type* returnType,
                                                             bool publicOnly);

  /// @brief Method GetHashCode, addr 0x61b224c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetInvocationTarget, addr 0x61b2254, size 0xec, virtual true, abstract: false, final false
  inline ::System::Object* GetInvocationTarget(::System::Type* type, ::System::Object* instance);

  /// @brief Method GetSite, addr 0x61b29e0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61b0cf4, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> attributes);

  /// @brief Method .ctor, addr 0x61b0e84, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AttributeArray, addr 0x61b1294, size 0x20, virtual true, abstract: false, final false
  inline ::ArrayW<::System::Attribute*, ::Array<::System::Attribute*>*> get_AttributeArray();

  /// @brief Method get_Attributes, addr 0x61b1b84, size 0xe0, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* get_Attributes();

  /// @brief Method get_DisplayName, addr 0x61b1cc0, size 0x114, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_Name, addr 0x61b1c64, size 0x54, virtual true, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NameHashCode, addr 0x61b1cb8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_NameHashCode();

  /// @brief Method set_AttributeArray, addr 0x61b1ac4, size 0xc0, virtual true, abstract: false, final false
