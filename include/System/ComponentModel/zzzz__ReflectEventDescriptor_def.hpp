...
public:
  ...
  /// @brief Method FillAttributes, addr 0x63c237c, size 0x58, virtual true, abstract: false, final false
  inline void FillAttributes(::System::Collections::IList* attributes);

  /// @brief Method FillEventInfoAttribute, addr 0x63c27a4, size 0x2f0, virtual false, abstract: false, final false
  inline void FillEventInfoAttribute(::System::Reflection::EventInfo* realEventInfo, ::System::Collections::IList* attributes);

  /// @brief Method FillMethods, addr 0x63c23d4, size 0x3d0, virtual false, abstract: false, final false
  inline void FillMethods();

  /// @brief Method FillSingleMethodAttribute, addr 0x63c2a94, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63c221c, size 0x160, virtual false, abstract: false, final false
