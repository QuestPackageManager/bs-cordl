...
public:
  ...
  /// @brief Method FillAttributes, addr 0x2a00890, size 0x64, virtual true, abstract: false, final false
  inline void FillAttributes(::System::Collections::IList* attributes);

  /// @brief Method FillEventInfoAttribute, addr 0x2a00d3c, size 0x328, virtual false, abstract: false, final false
  inline void FillEventInfoAttribute(::System::Reflection::EventInfo* realEventInfo, ::System::Collections::IList* attributes);

  /// @brief Method FillMethods, addr 0x2a008f4, size 0x448, virtual false, abstract: false, final false
  inline void FillMethods();

  /// @brief Method FillSingleMethodAttribute, addr 0x2a01064, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a00718, size 0x178, virtual false, abstract: false, final false
