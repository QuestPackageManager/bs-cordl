...
public:
  ...
  /// @brief Method FillAttributes, addr 0x621209c, size 0x58, virtual true, abstract: false, final false
  inline void FillAttributes(::System::Collections::IList* attributes);

  /// @brief Method FillEventInfoAttribute, addr 0x62124c4, size 0x2f0, virtual false, abstract: false, final false
  inline void FillEventInfoAttribute(::System::Reflection::EventInfo* realEventInfo, ::System::Collections::IList* attributes);

  /// @brief Method FillMethods, addr 0x62120f4, size 0x3d0, virtual false, abstract: false, final false
  inline void FillMethods();

  /// @brief Method FillSingleMethodAttribute, addr 0x62127b4, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6211f3c, size 0x160, virtual false, abstract: false, final false
