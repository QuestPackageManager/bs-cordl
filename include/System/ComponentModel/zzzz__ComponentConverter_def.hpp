...
public:
  // Declarations
  /// @brief Method GetProperties, addr 0x445d520, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesSupported, addr 0x445d588, size 0x8, virtual true, abstract: false, final false
  inline bool GetPropertiesSupported(::System::ComponentModel::ITypeDescriptorContext* context);

  static inline ::System::ComponentModel::ComponentConverter* New_ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x445d4b4, size 0x6c, virtual false, abstract: false, final false
