...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ComponentConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ComponentConverter(ComponentConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ComponentConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ComponentConverter(ComponentConverterconst&) = delete;
