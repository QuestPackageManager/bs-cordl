...
public:
  // Declarations
  /// @brief Method GetProperties, addr 0x2f77950, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesSupported, addr 0x2f77a1c, size 0x8, virtual true, abstract: false, final false
  inline bool GetPropertiesSupported(::System::ComponentModel::ITypeDescriptorContext* context);

  static inline ::System::ComponentModel::ComponentConverter* New_ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x2f778e4, size 0x6c, virtual false, abstract: false, final false
