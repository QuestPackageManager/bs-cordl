...
public:
  ...
  /// @brief Method GetAttributes, addr 0x44500ec, size 0xd8, virtual true, abstract: false, final false
  inline ::System::ComponentModel::AttributeCollection* GetAttributes();

  /// @brief Method GetClassName, addr 0x44501c4, size 0xb0, virtual true, abstract: false, final false
  inline ::StringW GetClassName();

  /// @brief Method GetComponentName, addr 0x4450274, size 0xb0, virtual true, abstract: false, final false
  inline ::StringW GetComponentName();

  /// @brief Method GetConverter, addr 0x4450324, size 0xd8, virtual true, abstract: false, final false
  inline ::System::ComponentModel::TypeConverter* GetConverter();

  /// @brief Method GetDefaultEvent, addr 0x44503fc, size 0xb0, virtual true, abstract: false, final false
  inline ::System::ComponentModel::EventDescriptor* GetDefaultEvent();

  /// @brief Method GetDefaultProperty, addr 0x44504ac, size 0xb0, virtual true, abstract: false, final false
  inline ::System::ComponentModel::PropertyDescriptor* GetDefaultProperty();

  /// @brief Method GetEditor, addr 0x445055c, size 0xb8, virtual true, abstract: false, final false
  inline ::System::Object* GetEditor(::System::Type* editorBaseType);

  /// @brief Method GetEvents, addr 0x4450614, size 0xdc, virtual true, abstract: false, final false
  inline ::System::ComponentModel::EventDescriptorCollection* GetEvents();

  /// @brief Method GetEvents, addr 0x44506f0, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetProperties, addr 0x44507d4, size 0xdc, virtual true, abstract: false, final false
  inline ::System::ComponentModel::PropertyDescriptorCollection* GetProperties();

  /// @brief Method GetProperties, addr 0x44508b0, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertyOwner, addr 0x4450994, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44500e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
