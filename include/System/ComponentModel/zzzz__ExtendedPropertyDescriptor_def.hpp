...
public:
  ...
  /// @brief Method CanResetValue, addr 0x61a4608, size 0x24, virtual true, abstract: false, final false
  inline bool CanResetValue(::System::Object* comp);

  /// @brief Method GetValue, addr 0x61a4954, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetValue, addr 0x61a4978, size 0x24, virtual true, abstract: false, final false
  inline void ResetValue(::System::Object* comp);

  /// @brief Method SetValue, addr 0x61a499c, size 0x2c, virtual true, abstract: false, final false
  inline void SetValue(::System::Object* component, ::System::Object* value);

  /// @brief Method ShouldSerializeValue, addr 0x61a49c8, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a4328, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ComponentType, addr 0x61a462c, size 0x20, virtual true, abstract: false, final false
  inline ::System::Type* get_ComponentType();

  /// @brief Method get_DisplayName, addr 0x61a4754, size 0x200, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_IsReadOnly, addr 0x61a464c, size 0xe8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_PropertyType, addr 0x61a4734, size 0x20, virtual true, abstract: false, final false
