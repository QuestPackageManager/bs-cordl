...
public:
  ...
  /// @brief Method CanResetValue, addr 0x620c194, size 0x24, virtual true, abstract: false, final false
  inline bool CanResetValue(::System::Object* comp);

  /// @brief Method GetValue, addr 0x620c4e0, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetValue, addr 0x620c504, size 0x24, virtual true, abstract: false, final false
  inline void ResetValue(::System::Object* comp);

  /// @brief Method SetValue, addr 0x620c528, size 0x2c, virtual true, abstract: false, final false
  inline void SetValue(::System::Object* component, ::System::Object* value);

  /// @brief Method ShouldSerializeValue, addr 0x620c554, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x620beb4, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ComponentType, addr 0x620c1b8, size 0x20, virtual true, abstract: false, final false
  inline ::System::Type* get_ComponentType();

  /// @brief Method get_DisplayName, addr 0x620c2e0, size 0x200, virtual true, abstract: false, final false
  inline ::StringW get_DisplayName();

  /// @brief Method get_IsReadOnly, addr 0x620c1d8, size 0xe8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_PropertyType, addr 0x620c2c0, size 0x20, virtual true, abstract: false, final false
