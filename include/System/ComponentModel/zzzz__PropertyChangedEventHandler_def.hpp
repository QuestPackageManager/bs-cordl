...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6286ecc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6286d84, size 0x148, virtual false, abstract: false, final false
