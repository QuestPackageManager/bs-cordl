...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x63c4ae0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63c4998, size 0x148, virtual false, abstract: false, final false
