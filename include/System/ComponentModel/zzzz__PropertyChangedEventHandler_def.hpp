...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x43fa294, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x43fa190, size 0x104, virtual false, abstract: false, final false
