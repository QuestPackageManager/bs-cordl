...
public:
  ...
  /// @brief Method Equals, addr 0x63aed10, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x63aeda0, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x63aedbc, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63aece8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x63aed00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Category, addr 0x63aed08, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Category();

  /// @brief Method get_TypeId, addr 0x63aee38, size 0x3c, virtual true, abstract: false, final false
