...
public:
  ...
  /// @brief Method Equals, addr 0x444bb7c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x444bc0c, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x444bc2c, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x444baf0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x444bb4c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Category, addr 0x444bb74, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Category();

  /// @brief Method get_TypeId, addr 0x444bca4, size 0x38, virtual true, abstract: false, final false
