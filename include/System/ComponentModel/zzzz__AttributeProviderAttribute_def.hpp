...
public:
  ...
  /// @brief Method get_PropertyName, addr 0x62009bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PropertyName();

  /// @brief Method get_TypeName, addr 0x62009b4, size 0x8, virtual false, abstract: false, final false
