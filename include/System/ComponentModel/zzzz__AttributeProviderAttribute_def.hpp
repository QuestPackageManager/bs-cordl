...
public:
  ...
  /// @brief Method get_PropertyName, addr 0x44498e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_PropertyName();

  /// @brief Method get_TypeName, addr 0x44498d8, size 0x8, virtual false, abstract: false, final false
