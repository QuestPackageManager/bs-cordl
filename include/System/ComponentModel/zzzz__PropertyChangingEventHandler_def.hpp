...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2f6a5ec, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f6a4bc, size 0x130, virtual false, abstract: false, final false
