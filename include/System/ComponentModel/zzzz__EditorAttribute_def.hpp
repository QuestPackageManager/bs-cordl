...
public:
  ...
  /// @brief Method Equals, addr 0x620ac68, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x620ad08, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x620ab40, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW baseTypeName);

  /// @brief Method get_EditorBaseTypeName, addr 0x620abc8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EditorBaseTypeName();

  /// @brief Method get_EditorTypeName, addr 0x620abd0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EditorTypeName();

  /// @brief Method get_TypeId, addr 0x620abd8, size 0x90, virtual true, abstract: false, final false
