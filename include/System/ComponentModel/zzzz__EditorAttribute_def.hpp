...
public:
  ...
  /// @brief Method Equals, addr 0x61a30dc, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x61a317c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x61a2fb4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::StringW typeName, ::StringW baseTypeName);

  /// @brief Method get_EditorBaseTypeName, addr 0x61a303c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EditorBaseTypeName();

  /// @brief Method get_EditorTypeName, addr 0x61a3044, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_EditorTypeName();

  /// @brief Method get_TypeId, addr 0x61a304c, size 0x90, virtual true, abstract: false, final false
