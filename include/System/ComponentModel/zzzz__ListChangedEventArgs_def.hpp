...
public:
  ...
  /// @brief Method .ctor, addr 0x63bd4f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::ComponentModel::ListChangedType listChangedType, int32_t newIndex);

  /// @brief Method .ctor, addr 0x63bd500, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::ComponentModel::ListChangedType listChangedType, int32_t newIndex, int32_t oldIndex);

  /// @brief Method .ctor, addr 0x63bd578, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63bd5a8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ListChangedType, addr 0x63bd614, size 0x8, virtual false, abstract: false, final false
  inline ::System::ComponentModel::ListChangedType get_ListChangedType();

  /// @brief Method get_NewIndex, addr 0x63bd61c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NewIndex();

  /// @brief Method get_OldIndex, addr 0x63bd624, size 0x8, virtual false, abstract: false, final false
