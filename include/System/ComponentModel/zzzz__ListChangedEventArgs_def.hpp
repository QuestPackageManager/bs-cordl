...
public:
  ...
  /// @brief Method .ctor, addr 0x627f8e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::ComponentModel::ListChangedType listChangedType, int32_t newIndex);

  /// @brief Method .ctor, addr 0x627f8ec, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::ComponentModel::ListChangedType listChangedType, int32_t newIndex, int32_t oldIndex);

  /// @brief Method .ctor, addr 0x627f964, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x627f994, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ListChangedType, addr 0x627fa00, size 0x8, virtual false, abstract: false, final false
  inline ::System::ComponentModel::ListChangedType get_ListChangedType();

  /// @brief Method get_NewIndex, addr 0x627fa08, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NewIndex();

  /// @brief Method get_OldIndex, addr 0x627fa10, size 0x8, virtual false, abstract: false, final false
