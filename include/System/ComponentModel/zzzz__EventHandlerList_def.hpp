...
public:
  ...
  /// @brief Method Find, addr 0x61ff0e8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x61ff08c, size 0x5c, virtual false, abstract: false, final false
