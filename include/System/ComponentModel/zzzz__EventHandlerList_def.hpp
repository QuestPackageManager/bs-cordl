...
public:
  ...
  /// @brief Method Find, addr 0x444c2c4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x444c25c, size 0x5c, virtual false, abstract: false, final false
