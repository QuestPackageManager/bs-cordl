...
public:
  ...
  /// @brief Method .ctor, addr 0x63ca14c, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PropertyChangedEventArgs", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PropertyChangedEventArgs(PropertyChangedEventArgs&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PropertyChangedEventArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PropertyChangedEventArgs(PropertyChangedEventArgsconst&) = delete;
