...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvalidEnumArgumentException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvalidEnumArgumentException(InvalidEnumArgumentException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvalidEnumArgumentException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvalidEnumArgumentException(InvalidEnumArgumentExceptionconst&) = delete;
