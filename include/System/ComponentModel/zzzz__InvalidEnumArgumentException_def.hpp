...
public:
  ...
  /// @brief Method .ctor, addr 0x290949c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::ComponentModel::InvalidEnumArgumentException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x29094a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29094b0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2909594, size 0x8, virtual false, abstract: false, final false
