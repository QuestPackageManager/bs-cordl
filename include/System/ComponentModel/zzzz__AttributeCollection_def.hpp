...
public:
  ...
  __declspec(property(get = __cordl_internal_get__foundAttributeTypes, put = __cordl_internal_set__foundAttributeTypes)) ::ArrayW<::System::ComponentModel::AttributeCollection_AttributeEntry>
