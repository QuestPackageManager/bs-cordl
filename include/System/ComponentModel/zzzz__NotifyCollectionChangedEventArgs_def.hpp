...
public:
  ...
  /// @brief Method get_Action addr 0x263dc04 size 0x8 virtual false final false
  inline ::System::ComponentModel::NotifyCollectionChangedAction get_Action();

  /// @brief Method set_Action addr 0x263dc0c size 0x8 virtual false final false
  inline void set_Action(::System::ComponentModel::NotifyCollectionChangedAction value);

  /// @brief Method get_NewItems addr 0x263dc14 size 0x8 virtual false final false
  inline ::System::Collections::IList* get_NewItems();

  /// @brief Method set_NewItems addr 0x263dc1c size 0x8 virtual false final false
  inline void set_NewItems(::System::Collections::IList* value);

  /// @brief Method get_NewStartingIndex addr 0x263dc24 size 0x8 virtual false final false
  inline int32_t get_NewStartingIndex();

  /// @brief Method set_NewStartingIndex addr 0x263dc2c size 0x8 virtual false final false
  inline void set_NewStartingIndex(int32_t value);

  /// @brief Method get_OldItems addr 0x263dc34 size 0x8 virtual false final false
  inline ::System::Collections::IList* get_OldItems();

  /// @brief Method set_OldItems addr 0x263dc3c size 0x8 virtual false final false
  inline void set_OldItems(::System::Collections::IList* value);

  /// @brief Method get_OldStartingIndex addr 0x263dc44 size 0x8 virtual false final false
  inline int32_t get_OldStartingIndex();

  /// @brief Method set_OldStartingIndex addr 0x263dc4c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263dc54 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263dc7c size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263dcac size 0x100 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263ddac size 0x40 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263ddec size 0x40 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263de2c size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263de50 size 0x10c virtual false final false
  ...
  /// @brief Method .ctor addr 0x263df5c size 0x48 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263dfa4 size 0x48 virtual false final false
  ...
  /// @brief Method .ctor addr 0x263dfec size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x263e018 size 0x24 virtual false final false
