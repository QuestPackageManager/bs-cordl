...
// Write type traits
MARK_REF_T(::System::ComponentModel::IRevertibleChangeTracking*);
DEFINE_IL2CPP_CLASS(::System::ComponentModel::IRevertibleChangeTracking*, "System.ComponentModel", "IRevertibleChangeTracking");
// Dependencies
namespace System::ComponentModel {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IRevertibleChangeTracking", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IRevertibleChangeTracking(IRevertibleChangeTrackingconst&) = delete;
