...
public:
  // Declarations
  /// @brief Method GetProperties, addr 0x627e50c, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesSupported, addr 0x627e578, size 0x8, virtual true, abstract: false, final false
  inline bool GetPropertiesSupported(::System::ComponentModel::ITypeDescriptorContext* context);

  static inline ::System::ComponentModel::ExpandableObjectConverter* New_ctor();

  /// @brief Method .ctor, addr 0x627e508, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
