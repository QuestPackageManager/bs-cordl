...
public:
  ...
  /// @brief Method .ctor addr 0x2791fdc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method GetProperties addr 0x2791fe4 size 0x68 virtual true final false
  ...
  /// @brief Method GetPropertiesSupported addr 0x279204c size 0x8 virtual true final false
