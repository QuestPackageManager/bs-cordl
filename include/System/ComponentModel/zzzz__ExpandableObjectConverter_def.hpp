...
public:
  // Declarations
  /// @brief Method GetProperties, addr 0x620be40, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPropertiesSupported, addr 0x620beac, size 0x8, virtual true, abstract: false, final false
  inline bool GetPropertiesSupported(::System::ComponentModel::ITypeDescriptorContext* context);

  static inline ::System::ComponentModel::ExpandableObjectConverter* New_ctor();

  /// @brief Method .ctor, addr 0x620be3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
