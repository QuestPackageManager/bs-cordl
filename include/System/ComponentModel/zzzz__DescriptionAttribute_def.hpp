...
public:
  ...
  /// @brief Method .ctor, addr 0x29087f4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::ComponentModel::DescriptionAttribute* New_ctor(::StringW description);

  /// @brief Method .ctor, addr 0x2908850, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW description);

  /// @brief Method get_Description, addr 0x2908878, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_DescriptionValue, addr 0x2908880, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DescriptionValue();

  /// @brief Method set_DescriptionValue, addr 0x2908888, size 0x8, virtual false, abstract: false, final false
  inline void set_DescriptionValue(::StringW value);

  /// @brief Method Equals, addr 0x2908890, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x290895c, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsDefaultAttribute, addr 0x2908984, size 0x68, virtual true, abstract: false, final false
