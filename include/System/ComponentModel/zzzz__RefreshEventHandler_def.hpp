...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x63c2f48, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63c2e04, size 0x144, virtual false, abstract: false, final false
