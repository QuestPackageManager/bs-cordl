...
public:
  ...
  /// @brief Method Append, addr 0x3e3e0e0, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x3e3e078, size 0x68, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x3e3e180, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e3e068, size 0x10, virtual false, abstract: false, final false
