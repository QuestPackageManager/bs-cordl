...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArraySpec", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArraySpec(ArraySpec&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArraySpec", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArraySpec(ArraySpecconst&) = delete;
