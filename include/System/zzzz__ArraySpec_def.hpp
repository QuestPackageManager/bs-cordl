...
public:
  ...
  /// @brief Method Append, addr 0x2888fb8, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x2888f54, size 0x64, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x2889058, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2888f44, size 0x10, virtual false, abstract: false, final false
