...
public:
  ...
  /// @brief Method Append, addr 0x3e43054, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Resolve, addr 0x3e42fec, size 0x68, virtual true, abstract: false, final true
  inline ::System::Type* Resolve(::System::Type* type);

  /// @brief Method ToString, addr 0x3e430f4, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3e42fdc, size 0x10, virtual false, abstract: false, final false
