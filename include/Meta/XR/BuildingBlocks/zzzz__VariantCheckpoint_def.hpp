...
/// @brief Method .ctor, addr 0x588d124, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::StringW  memberName, ::StringW  value) ;

/// @brief Method get_MemberName, addr 0x588d114, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_MemberName() ;

/// @brief Method get_Value, addr 0x588d11c, size 0x8, virtual false, abstract: false, final false
