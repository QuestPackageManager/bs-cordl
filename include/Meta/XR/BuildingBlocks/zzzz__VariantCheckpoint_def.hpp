...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VariantCheckpoint", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VariantCheckpoint(VariantCheckpoint&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VariantCheckpoint", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VariantCheckpoint(VariantCheckpointconst&) = delete;
