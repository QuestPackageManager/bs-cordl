...
// Write type traits
MARK_REF_T(::Meta::XR::BuildingBlocks::RoomMeshController*);
MARK_REF_T(::Meta::XR::BuildingBlocks::RoomMeshController__LoadRoomMesh_d__6*);
MARK_REF_T(::Meta::XR::BuildingBlocks::RoomMeshController__Start_d__4*);
MARK_REF_T(::Meta::XR::BuildingBlocks::RoomMeshController__UpdateVolume_d__5*);
DEFINE_IL2CPP_CLASS(::Meta::XR::BuildingBlocks::RoomMeshController*, "Meta.XR.BuildingBlocks", "RoomMeshController");
...
public:
  ...
  /// @brief Method <>m__Finally1, addr 0x5a34eb8, size 0x54, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::BuildingBlocks::RoomMeshController__UpdateVolume_d__5) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method Awake, addr 0x5a344bc, size 0xa4, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x5a34854, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::BuildingBlocks::RoomMeshController) == 0x38, "Size mismatch!");
