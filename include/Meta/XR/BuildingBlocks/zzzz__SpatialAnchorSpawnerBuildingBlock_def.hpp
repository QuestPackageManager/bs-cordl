...
public:
  ...
  /// @brief Method Awake, addr 0x58f9220, size 0x98, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::Meta::XR::BuildingBlocks::SpatialAnchorSpawnerBuildingBlock* New_ctor();

  /// @brief Method SpawnSpatialAnchor, addr 0x58f944c, size 0xc8, virtual false, abstract: false, final false
  inline void SpawnSpatialAnchor();

  /// @brief Method SpawnSpatialAnchor, addr 0x58f92b8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f9514, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AnchorPrefab, addr 0x58f8fbc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_AnchorPrefab();

  /// @brief Method get_FollowHand, addr 0x58f9218, size 0x8, virtual false, abstract: false, final false
  inline bool get_FollowHand();

  /// @brief Method set_AnchorPrefab, addr 0x58f8fc4, size 0x104, virtual false, abstract: false, final false
  inline void set_AnchorPrefab(::UnityEngine::GameObject* value);

  /// @brief Method set_FollowHand, addr 0x58f90c8, size 0x150, virtual false, abstract: false, final false
