...
/// @brief Field OnRoomMeshLoadCompleted, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_OnRoomMeshLoadCompleted, put=__cordl_internal_set_OnRoomMeshLoadCompleted)) ::UnityEngine::Events::UnityEvent_1<::UnityW<::UnityEngine::MeshFilter>>*  OnRoomMeshLoadCompleted;
...
/// @brief Method .ctor, addr 0x58863f8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
