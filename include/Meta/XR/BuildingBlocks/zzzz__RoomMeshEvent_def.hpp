...
public:
  ...
  /// @brief Method .ctor, addr 0x5a35738, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RoomMeshEvent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RoomMeshEvent(RoomMeshEvent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RoomMeshEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RoomMeshEvent(RoomMeshEventconst&) = delete;
