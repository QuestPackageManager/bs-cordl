...
// Write type traits
MARK_REF_T(::Meta::XR::BuildingBlocks::InstallationRoutineCheckpoint*);
DEFINE_IL2CPP_CLASS(::Meta::XR::BuildingBlocks::InstallationRoutineCheckpoint*, "Meta.XR.BuildingBlocks", "InstallationRoutineCheckpoint");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a3c44c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstallationRoutineId, addr 0x5a3c43c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InstallationRoutineId();

  /// @brief Method get_InstallationVariants, addr 0x5a3c444, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InstallationRoutineCheckpoint", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InstallationRoutineCheckpoint(InstallationRoutineCheckpoint&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InstallationRoutineCheckpoint", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InstallationRoutineCheckpoint(InstallationRoutineCheckpointconst&) = delete;
...
static_assert(sizeof(::Meta::XR::BuildingBlocks::InstallationRoutineCheckpoint) == 0x20, "Size mismatch!");
