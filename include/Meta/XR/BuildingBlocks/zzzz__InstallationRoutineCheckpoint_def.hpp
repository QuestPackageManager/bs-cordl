...
public:
  ...
  /// @brief Method .ctor, addr 0x58ff078, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstallationRoutineId, addr 0x58ff068, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InstallationRoutineId();

  /// @brief Method get_InstallationVariants, addr 0x58ff070, size 0x8, virtual false, abstract: false, final false
