...
public:
  ...
  /// @brief Method Awake, addr 0x5a3363c, size 0x5c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LoadAnchorsFromDefaultLocalStorage, addr 0x5a33820, size 0x210, virtual true, abstract: false, final false
  inline void LoadAnchorsFromDefaultLocalStorage();

  /// @brief Method LoadAndInstantiateAnchors, addr 0x5a337f0, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a33c2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
