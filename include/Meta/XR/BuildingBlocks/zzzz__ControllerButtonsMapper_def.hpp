...
/// @brief Method OnCallbackWithContext, addr 0x5884f0c, size 0x78, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Title", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "Button", ty: "::GlobalNamespace::OVRInput_Button", modifiers: "", def_value: None }, CppParam { name: "ButtonMode", ty: "::Meta::XR::BuildingBlocks::ButtonClickAction_ControllerButtonsMapper_ButtonClickMode", modifiers: "", def_value: None }, CppParam { name: "InputActionReference", ty: "::UnityW<::UnityEngine::InputSystem::InputActionReference>", modifiers: "", def_value: None }, CppParam { name: "CallbackWithContext", ty: "::UnityEngine::Events::UnityEvent_1<::UnityEngine::InputSystem::InputAction_CallbackContext>*", modifiers: "", def_value: None }, CppParam { name: "Callback", ty: "::UnityEngine::Events::UnityEvent*", modifiers: "", def_value: None }]
...
using ButtonClickAction = ::Meta::XR::BuildingBlocks::ControllerButtonsMapper_ButtonClickAction;
 ...
 __declspec(property(get=get_ButtonClickActions, put=set_ButtonClickActions)) ::System::Collections::Generic::List_1<::Meta::XR::BuildingBlocks::ControllerButtonsMapper_ButtonClickAction>*  ButtonClickActions;

/// @brief Field _buttonClickActions, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__buttonClickActions, put=__cordl_internal_set__buttonClickActions)) ::System::Collections::Generic::List_1<::Meta::XR::BuildingBlocks::ControllerButtonsMapper_ButtonClickAction>*  _buttonClickActions;

/// @brief Method IsActionTriggered, addr 0x5884d30, size 0x4c, virtual false, abstract: false, final false
static inline bool IsActionTriggered(::Meta::XR::BuildingBlocks::ControllerButtonsMapper_ButtonClickAction  buttonClickAction) ;

/// @brief Method IsLegacyInputActionTriggered, addr 0x5884d7c, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method IsNewInputSystemActionTriggered, addr 0x5884e74, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x58849a0, size 0x258, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5884748, size 0x258, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x5884bf8, size 0x138, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5884f08, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ButtonClickActions, addr 0x5884738, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_ButtonClickActions, addr 0x5884740, size 0x8, virtual false, abstract: false, final false
