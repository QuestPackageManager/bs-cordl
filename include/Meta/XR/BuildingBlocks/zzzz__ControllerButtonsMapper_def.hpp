...
public:
  ...
  /// @brief Method OnCallbackWithContext, addr 0x58f6e78, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IsActionTriggered, addr 0x58f6c9c, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsActionTriggered(::Meta::XR::BuildingBlocks::ControllerButtonsMapper_ButtonClickAction buttonClickAction);

  /// @brief Method IsLegacyInputActionTriggered, addr 0x58f6ce8, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNewInputSystemActionTriggered, addr 0x58f6de0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x58f690c, size 0x258, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58f66b4, size 0x258, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x58f6b64, size 0x138, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58f6e74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ButtonClickActions, addr 0x58f66a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ButtonClickActions, addr 0x58f66ac, size 0x8, virtual false, abstract: false, final false
