...
public:
  ...
  /// @brief Method Start, addr 0x5a31fc4, size 0x1f4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5a321b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
