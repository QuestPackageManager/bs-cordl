...
/// @brief Method Start, addr 0x5884f84, size 0x1f4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x5885178, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
