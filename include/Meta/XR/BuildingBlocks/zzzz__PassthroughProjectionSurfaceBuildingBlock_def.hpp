...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PassthroughProjectionSurfaceBuildingBlock", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PassthroughProjectionSurfaceBuildingBlock(PassthroughProjectionSurfaceBuildingBlock&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PassthroughProjectionSurfaceBuildingBlock", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PassthroughProjectionSurfaceBuildingBlock(PassthroughProjectionSurfaceBuildingBlockconst&) = delete;
