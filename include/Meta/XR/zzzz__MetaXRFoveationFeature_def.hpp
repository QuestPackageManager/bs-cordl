...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetaXRFoveationFeature", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MetaXRFoveationFeature(MetaXRFoveationFeature&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MetaXRFoveationFeature", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetaXRFoveationFeature(MetaXRFoveationFeatureconst&) = delete;
