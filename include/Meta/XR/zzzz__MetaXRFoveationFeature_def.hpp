...
public:
  ...
  /// @brief Method FBGetFoveationDynamic, addr 0x5d14648, size 0x7c, virtual false, abstract: false, final false
  static inline void FBGetFoveationDynamic(::ByRef<uint32_t> dynamic);

  /// @brief Method FBGetFoveationLevel, addr 0x5d1443c, size 0x7c, virtual false, abstract: false, final false
  static inline void FBGetFoveationLevel(::ByRef<uint32_t> level);

  /// @brief Method FBSetFoveationLevel, addr 0x5d14520, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSessionCreate, addr 0x5d143d0, size 0x50, virtual true, abstract: false, final false
  inline void OnSessionCreate(uint64_t xrSession);

  /// @brief Method .ctor, addr 0x5d146c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_foveatedRenderingLevel, addr 0x5d14420, size 0x1c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRManager_FoveatedRenderingLevel get_foveatedRenderingLevel();

  /// @brief Method get_useDynamicFoveatedRendering, addr 0x5d145c4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method set_foveatedRenderingLevel, addr 0x5d144b8, size 0x68, virtual false, abstract: false, final false
  static inline void set_foveatedRenderingLevel(::GlobalNamespace::OVRManager_FoveatedRenderingLevel value);

  /// @brief Method set_useDynamicFoveatedRendering, addr 0x5d145e8, size 0x60, virtual false, abstract: false, final false
