...
public:
  ...
  /// @brief Method .ctor, addr 0x5a56f10, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Meta::XR::ImmersiveDebugger::DebugColor color);

  /// @brief Method .ctor, addr 0x5a56fc4, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::DebugMember) == 0x50, "Size mismatch!");
