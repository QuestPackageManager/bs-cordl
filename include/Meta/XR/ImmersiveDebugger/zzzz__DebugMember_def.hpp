...
/// @brief Method .ctor, addr 0x58a9ed0, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::Meta::XR::ImmersiveDebugger::DebugColor  color) ;

/// @brief Method .ctor, addr 0x58a9f84, size 0xa4, virtual false, abstract: false, final false
