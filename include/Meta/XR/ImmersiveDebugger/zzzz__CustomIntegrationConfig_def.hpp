...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x591bcb8, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x591bcd4, size 0xc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x591bca4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591bac8, size 0x68, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x591bd5c, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x591bd78, size 0xc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x591bd48, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591bce0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x591be00, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x591be1c, size 0xc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x591bdec, size 0x14, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> Invoke();
  ...
  /// @brief Method .ctor, addr 0x591bd84, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method ClearAllConfig, addr 0x591bb30, size 0x108, virtual false, abstract: false, final false
  static inline void ClearAllConfig(::Meta::XR::ImmersiveDebugger::ICustomIntegrationConfig* customConfig);

  /// @brief Method GetCamera, addr 0x591bc38, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Camera> GetCamera();

  /// @brief Method SetupAllConfig, addr 0x591b9c0, size 0x108, virtual false, abstract: false, final false
  static inline void SetupAllConfig(::Meta::XR::ImmersiveDebugger::ICustomIntegrationConfig* customConfig);

  /// @brief Method add_GetCameraHandler, addr 0x591b828, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_GetCameraHandler, addr 0x591b8f4, size 0xcc, virtual false, abstract: false, final false
