...
public:
  ...
  /// @brief Method Awake, addr 0x591be28, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetCamera, addr 0x591be30, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> GetCamera();

  static inline ::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase* New_ctor();

  /// @brief Method OnDestroy, addr 0x591be2c, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method .ctor, addr 0x591be38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
