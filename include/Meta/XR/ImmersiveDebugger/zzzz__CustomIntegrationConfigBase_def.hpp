...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CustomIntegrationConfigBase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CustomIntegrationConfigBase(CustomIntegrationConfigBase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CustomIntegrationConfigBase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CustomIntegrationConfigBase(CustomIntegrationConfigBaseconst&) = delete;
