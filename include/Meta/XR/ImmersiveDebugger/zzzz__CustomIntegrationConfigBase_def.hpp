...
/// @brief Method Awake, addr 0x58a9ebc, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetCamera, addr 0x58a9ec4, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> GetCamera() ;

static inline ::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase* New_ctor() ;

/// @brief Method OnDestroy, addr 0x58a9ec0, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method .ctor, addr 0x58a9ecc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
