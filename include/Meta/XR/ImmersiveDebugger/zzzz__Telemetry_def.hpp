...
/// @brief Method Init, addr 0x5894808, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x5895534, size 0x8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnFocusLost, addr 0x589552c, size 0x8, virtual false, abstract: false, final false
inline void OnFocusLost() ;

/// @brief Method OnStart, addr 0x5894ae4, size 0x30, virtual false, abstract: false, final false
inline void OnStart() ;

/// @brief Method SendComponentTracked, addr 0x5894b38, size 0x9f4, virtual false, abstract: false, final false
inline void SendComponentTracked(::Meta::XR::ImmersiveDebugger::Telemetry_State  state) ;

/// @brief Method SendStart, addr 0x5894b14, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5894930, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method FetchPanel, addr 0x5894574, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method GetTypeHash, addr 0x5893f00, size 0x68, virtual false, abstract: false, final false
static inline ::StringW GetTypeHash(::System::Type*  type) ;

/// @brief Method IsTypeCustom, addr 0x5893f68, size 0x18c, virtual false, abstract: false, final false
static inline bool IsTypeCustom(::System::Type*  type) ;

/// @brief Method OnButtonClicked, addr 0x58942c0, size 0x2b4, virtual false, abstract: false, final false
static inline void OnButtonClicked(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button*  button) ;

/// @brief Method OnPanelActiveStateChanged, addr 0x58940f4, size 0x1cc, virtual false, abstract: false, final false
