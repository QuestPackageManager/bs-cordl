...
/// @brief Method Init, addr 0x5908144, size 0x128, virtual false, abstract: false, final false
static inline ::Meta::XR::ImmersiveDebugger::Telemetry_TelemetryTracker* Init(::Meta::XR::ImmersiveDebugger::Telemetry_Method  method, ::System::Collections::Generic::IEnumerable_1<::Meta::XR::ImmersiveDebugger::Manager::IDebugManager*>*  managers, ::Meta::XR::ImmersiveDebugger::Utils::InstanceCache*  cache, ::Meta::XR::ImmersiveDebugger::Manager::DebugManager*  debugManager) ;

static inline ::Meta::XR::ImmersiveDebugger::Telemetry_TelemetryTracker* New_ctor(::Meta::XR::ImmersiveDebugger::Telemetry_Method  method, ::System::Collections::Generic::IEnumerable_1<::Meta::XR::ImmersiveDebugger::Manager::IDebugManager*>*  managers, ::Meta::XR::ImmersiveDebugger::Utils::InstanceCache*  cache) ;

/// @brief Method OnDisable, addr 0x5908e70, size 0x8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnFocusLost, addr 0x5908e68, size 0x8, virtual false, abstract: false, final false
inline void OnFocusLost() ;

/// @brief Method OnStart, addr 0x5908420, size 0x30, virtual false, abstract: false, final false
inline void OnStart() ;

/// @brief Method SendComponentTracked, addr 0x5908474, size 0x9f4, virtual false, abstract: false, final false
inline void SendComponentTracked(::Meta::XR::ImmersiveDebugger::Telemetry_State  state) ;

/// @brief Method SendStart, addr 0x5908450, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x590826c, size 0x1b4, virtual false, abstract: false, final false
inline void _ctor(::Meta::XR::ImmersiveDebugger::Telemetry_Method  method, ::System::Collections::Generic::IEnumerable_1<::Meta::XR::ImmersiveDebugger::Manager::IDebugManager*>*  managers, ::Meta::XR::ImmersiveDebugger::Utils::InstanceCache*  cache) ;
...
/// @brief Method FetchPanel, addr 0x5907eb0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method GetTypeHash, addr 0x590783c, size 0x68, virtual false, abstract: false, final false
static inline ::StringW GetTypeHash(::System::Type*  type) ;

/// @brief Method IsTypeCustom, addr 0x59078a4, size 0x18c, virtual false, abstract: false, final false
static inline bool IsTypeCustom(::System::Type*  type) ;

/// @brief Method OnButtonClicked, addr 0x5907bfc, size 0x2b4, virtual false, abstract: false, final false
static inline void OnButtonClicked(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button*  button) ;

/// @brief Method OnPanelActiveStateChanged, addr 0x5907a30, size 0x1cc, virtual false, abstract: false, final false
