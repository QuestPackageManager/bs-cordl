...
public:
  ...
  /// @brief Method Init, addr 0x5906774, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x59074a0, size 0x8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnFocusLost, addr 0x5907498, size 0x8, virtual false, abstract: false, final false
  inline void OnFocusLost();

  /// @brief Method OnStart, addr 0x5906a50, size 0x30, virtual false, abstract: false, final false
  inline void OnStart();

  /// @brief Method SendComponentTracked, addr 0x5906aa4, size 0x9f4, virtual false, abstract: false, final false
  inline void SendComponentTracked(::Meta::XR::ImmersiveDebugger::Telemetry_State state);

  /// @brief Method SendStart, addr 0x5906a80, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590689c, size 0x1b4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FetchPanel, addr 0x59064e0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeHash, addr 0x5905e6c, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW GetTypeHash(::System::Type* type);

  /// @brief Method IsTypeCustom, addr 0x5905ed4, size 0x18c, virtual false, abstract: false, final false
  static inline bool IsTypeCustom(::System::Type* type);

  /// @brief Method OnButtonClicked, addr 0x590622c, size 0x2b4, virtual false, abstract: false, final false
  static inline void OnButtonClicked(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button* button);

  /// @brief Method OnPanelActiveStateChanged, addr 0x5906060, size 0x1cc, virtual false, abstract: false, final false
