...
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Telemetry_Method, "Meta.XR.ImmersiveDebugger", "Telemetry/Method");
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Telemetry_State, "Meta.XR.ImmersiveDebugger", "Telemetry/State");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Telemetry_State) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Telemetry_Method) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x5a41848, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x5a42574, size 0x8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnFocusLost, addr 0x5a4256c, size 0x8, virtual false, abstract: false, final false
  inline void OnFocusLost();

  /// @brief Method OnStart, addr 0x5a41b24, size 0x30, virtual false, abstract: false, final false
  inline void OnStart();

  /// @brief Method SendComponentTracked, addr 0x5a41b78, size 0x9f4, virtual false, abstract: false, final false
  inline void SendComponentTracked(::Meta::XR::ImmersiveDebugger::Telemetry_State state);

  /// @brief Method SendStart, addr 0x5a41b54, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a41970, size 0x1b4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FetchPanel, addr 0x5a415b4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTypeHash, addr 0x5a40f40, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW GetTypeHash(::System::Type* type);

  /// @brief Method IsTypeCustom, addr 0x5a40fa8, size 0x18c, virtual false, abstract: false, final false
  static inline bool IsTypeCustom(::System::Type* type);

  /// @brief Method OnButtonClicked, addr 0x5a41300, size 0x2b4, virtual false, abstract: false, final false
  static inline void OnButtonClicked(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button* button);

  /// @brief Method OnPanelActiveStateChanged, addr 0x5a41134, size 0x1cc, virtual false, abstract: false, final false
