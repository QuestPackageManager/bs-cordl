...
public:
  ...
  /// @brief Method <EnqueueLogEntry>b__0, addr 0x590947c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59093e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConsumeStartupLogs, addr 0x5909134, size 0x1ac, virtual false, abstract: false, final false
  static inline void ConsumeStartupLogs(::System::Action_3<::StringW, ::StringW, ::UnityEngine::LogType>* logProcessor);

  /// @brief Method EnqueueLogEntry, addr 0x59092e0, size 0x108, virtual false, abstract: false, final false
  static inline void EnqueueLogEntry(::StringW logString, ::StringW stackTrace, ::UnityEngine::LogType type);

  /// @brief Method OnApplicationQuitting, addr 0x5908d7c, size 0xa4, virtual false, abstract: false, final false
  static inline void OnApplicationQuitting();

  /// @brief Method OnLoad, addr 0x5908e20, size 0x18c, virtual false, abstract: false, final false
  static inline void OnLoad();

  /// @brief Method StartCachingLogs, addr 0x5908fac, size 0x188, virtual false, abstract: false, final false
