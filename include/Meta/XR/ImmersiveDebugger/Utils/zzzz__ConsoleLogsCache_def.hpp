...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Utils::ConsoleLogsCache*);
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Utils::ConsoleLogsCache___c__DisplayClass7_0) == 0x28, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Utils::ConsoleLogsCache) == 0x10, "Size mismatch!");
