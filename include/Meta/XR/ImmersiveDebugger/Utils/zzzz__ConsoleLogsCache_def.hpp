...
/// @brief Method <EnqueueLogEntry>b__0, addr 0x5897510, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x589747c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field StartupLogs, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_StartupLogs, put=setStaticF_StartupLogs)) ::System::Collections::Generic::List_1<::System::ValueTuple_3<::StringW,::StringW,::UnityEngine::LogType>>*  StartupLogs;
...
/// @brief Method ConsumeStartupLogs, addr 0x58971c8, size 0x1ac, virtual false, abstract: false, final false
static inline void ConsumeStartupLogs(::System::Action_3<::StringW,::StringW,::UnityEngine::LogType>*  logProcessor) ;

/// @brief Method EnqueueLogEntry, addr 0x5897374, size 0x108, virtual false, abstract: false, final false
static inline void EnqueueLogEntry(::StringW  logString, ::StringW  stackTrace, ::UnityEngine::LogType  type) ;

/// @brief Method OnApplicationQuitting, addr 0x5896e10, size 0xa4, virtual false, abstract: false, final false
static inline void OnApplicationQuitting() ;

/// @brief Method OnLoad, addr 0x5896eb4, size 0x18c, virtual false, abstract: false, final false
static inline void OnLoad() ;

/// @brief Method StartCachingLogs, addr 0x5897040, size 0x188, virtual false, abstract: false, final false
