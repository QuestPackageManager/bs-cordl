...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::Utils::IntegerContainer::*)()>(
    &::Meta::XR::ImmersiveDebugger::Utils::IntegerContainer::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x58995f4;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::Utils::IntegerContainer*>::get(),
...
inline ::Meta::XR::ImmersiveDebugger::Utils::IntegerContainer* Meta::XR::ImmersiveDebugger::Utils::IntegerContainer::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Meta::XR::ImmersiveDebugger::Utils::IntegerContainer*>());
}
// Ctor Parameters []
