...
public:
  ...
  /// @brief Method .ctor, addr 0x5a48e88, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Vector2Container", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Vector2Container(Vector2Container&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Vector2Container", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Vector2Container(Vector2Containerconst&) = delete;
