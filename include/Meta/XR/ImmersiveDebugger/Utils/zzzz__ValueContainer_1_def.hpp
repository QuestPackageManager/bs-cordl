...
/// @brief Field Values, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_Values, put=__cordl_internal_set_Values)) ::ArrayW<::Meta::XR::ImmersiveDebugger::Utils::ValueStruct_1<T>,::Array<::Meta::XR::ImmersiveDebugger::Utils::ValueStruct_1<T>>*>  Values;
