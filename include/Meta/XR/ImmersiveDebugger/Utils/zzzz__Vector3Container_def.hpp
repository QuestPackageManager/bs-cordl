...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Utils::Vector3Container*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Utils::Vector3Container*, "Meta.XR.ImmersiveDebugger.Utils", "Vector3Container");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a48ed0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Vector3Container", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Vector3Container(Vector3Container&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Vector3Container", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Vector3Container(Vector3Containerconst&) = delete;
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Utils::Vector3Container) == 0x20, "Size mismatch!");
