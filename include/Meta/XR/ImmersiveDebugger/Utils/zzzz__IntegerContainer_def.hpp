...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Utils::IntegerContainer*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Utils::IntegerContainer*, "Meta.XR.ImmersiveDebugger.Utils", "IntegerContainer");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IntegerContainer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IntegerContainer(IntegerContainer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IntegerContainer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IntegerContainer(IntegerContainerconst&) = delete;
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Utils::IntegerContainer) == 0x20, "Size mismatch!");
