...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Utils::InstanceCache*);
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Utils::InstanceCache___c__DisplayClass12_0) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Utils::InstanceCache) == 0x38, "Size mismatch!");
