...
public:
  ...
  /// @brief Method <FetchObjectsHandlesOfType>b__0, addr 0x590a7a8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5909c10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FetchObjectsHandlesOfType, addr 0x5909ae4, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCacheDataForClass, addr 0x5909a68, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterClassType, addr 0x5909c14, size 0x10c, virtual false, abstract: false, final false
  inline void RegisterClassType(::System::Type* classType);

  /// @brief Method RegisterClassTypes, addr 0x5909d20, size 0x2ac, virtual false, abstract: false, final false
  inline void RegisterClassTypes(::System::Collections::Generic::IEnumerable_1<::System::Type*>* types);

  /// @brief Method RegisterHandle, addr 0x59039cc, size 0x12c, virtual false, abstract: false, final false
  inline void RegisterHandle(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle handle);

  /// @brief Method RetrieveInstances, addr 0x5909fcc, size 0x614, virtual false, abstract: false, final false
  inline void RetrieveInstances();

  /// @brief Method UnregisterHandle, addr 0x5903b40, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590a6c8, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnCacheChangedForTypeEvent, addr 0x59095e8, size 0xc0, virtual false, abstract: false, final false
  inline void add_OnCacheChangedForTypeEvent(::System::Action_1<::System::Type*>* value);

  /// @brief Method add_OnInstanceAdded, addr 0x5909768, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_OnInstanceRemoved, addr 0x59098e8, size 0xc0, virtual false, abstract: false, final false
  inline void add_OnInstanceRemoved(::System::Action_1<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle>* value);

  /// @brief Method remove_OnCacheChangedForTypeEvent, addr 0x59096a8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_OnCacheChangedForTypeEvent(::System::Action_1<::System::Type*>* value);

  /// @brief Method remove_OnInstanceAdded, addr 0x5909828, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_OnInstanceRemoved, addr 0x59099a8, size 0xc0, virtual false, abstract: false, final false
