...
/// @brief Method <FetchObjectsHandlesOfType>b__0, addr 0x589883c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5897ca4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field CacheData, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_CacheData, put=__cordl_internal_set_CacheData)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle>*>*  CacheData;
...
/// @brief Field OnInstanceAdded, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_OnInstanceAdded, put=__cordl_internal_set_OnInstanceAdded)) ::System::Func_2<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle,::Meta::XR::ImmersiveDebugger::UserInterface::IInspector*>*  OnInstanceAdded;

/// @brief Field OnInstanceRemoved, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_OnInstanceRemoved, put=__cordl_internal_set_OnInstanceRemoved)) ::System::Action_1<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle>*  OnInstanceRemoved;

/// @brief Field _emptyCache, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__emptyCache, put=__cordl_internal_set__emptyCache)) ::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle>*  _emptyCache;

/// @brief Method FetchObjectsHandlesOfType, addr 0x5897b78, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method GetCacheDataForClass, addr 0x5897afc, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method RegisterClassType, addr 0x5897ca8, size 0x10c, virtual false, abstract: false, final false
inline void RegisterClassType(::System::Type*  classType) ;

/// @brief Method RegisterClassTypes, addr 0x5897db4, size 0x2ac, virtual false, abstract: false, final false
inline void RegisterClassTypes(::System::Collections::Generic::IEnumerable_1<::System::Type*>*  types) ;

/// @brief Method RegisterHandle, addr 0x5891a60, size 0x12c, virtual false, abstract: false, final false
inline void RegisterHandle(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  handle) ;

/// @brief Method RetrieveInstances, addr 0x5898060, size 0x614, virtual false, abstract: false, final false
inline void RetrieveInstances() ;

/// @brief Method UnregisterHandle, addr 0x5891bd4, size 0xb8, virtual false, abstract: false, final false
inline void UnregisterHandle(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  handle) ;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle>*>* const& __cordl_internal_get_CacheData() const;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle>*>*& __cordl_internal_get_CacheData() ;
...
constexpr void __cordl_internal_set_CacheData(::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle>*>*  value) ;
...
/// @brief Method .ctor, addr 0x589875c, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_OnCacheChangedForTypeEvent, addr 0x589767c, size 0xc0, virtual false, abstract: false, final false
inline void add_OnCacheChangedForTypeEvent(::System::Action_1<::System::Type*>*  value) ;

/// @brief Method add_OnInstanceAdded, addr 0x58977fc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method add_OnInstanceRemoved, addr 0x589797c, size 0xc0, virtual false, abstract: false, final false
inline void add_OnInstanceRemoved(::System::Action_1<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle>*  value) ;

/// @brief Method remove_OnCacheChangedForTypeEvent, addr 0x589773c, size 0xc0, virtual false, abstract: false, final false
inline void remove_OnCacheChangedForTypeEvent(::System::Action_1<::System::Type*>*  value) ;

/// @brief Method remove_OnInstanceAdded, addr 0x58978bc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_OnInstanceRemoved, addr 0x5897a3c, size 0xc0, virtual false, abstract: false, final false
