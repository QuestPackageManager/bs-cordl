...
/// @brief Method Equals, addr 0x5898964, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x5898910, size 0x54, virtual true, abstract: false, final true
inline bool Equals(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  other) ;

/// @brief Method GetHashCode, addr 0x5898a04, size 0x8c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Static, addr 0x58988f8, size 0x18, virtual false, abstract: false, final false
static inline ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle Static(::System::Type*  type) ;

/// @brief Method .ctor, addr 0x589887c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::SceneManagement::Scene  scene) ;

/// @brief Method .ctor, addr 0x5892430, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  type, ::UnityEngine::Object*  instance) ;

/// @brief Method get_Instance, addr 0x5898854, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> get_Instance() ;

/// @brief Method get_InstanceId, addr 0x5898864, size 0x8, virtual false, abstract: false, final false
inline int32_t get_InstanceId() ;

/// @brief Method get_IsStatic, addr 0x589886c, size 0x10, virtual false, abstract: false, final false
inline bool get_IsStatic() ;

/// @brief Method get_Type, addr 0x589885c, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_Type() ;

/// @brief Method get_Valid, addr 0x5898674, size 0xe8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_Instance_k__BackingField", ty: "::UnityW<::UnityEngine::Object>", modifiers: "", def_value: None }, CppParam { name: "_Type_k__BackingField", ty: "::System::Type*", modifiers: "", def_value: None }, CppParam { name: "_InstanceId_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }]
