...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::Utils::Vector3Container::*)()>(
    &::Meta::XR::ImmersiveDebugger::Utils::Vector3Container::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x5899684;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::Utils::Vector3Container*>::get(),
...
inline ::Meta::XR::ImmersiveDebugger::Utils::Vector3Container* Meta::XR::ImmersiveDebugger::Utils::Vector3Container::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Meta::XR::ImmersiveDebugger::Utils::Vector3Container*>());
}
// Ctor Parameters []
