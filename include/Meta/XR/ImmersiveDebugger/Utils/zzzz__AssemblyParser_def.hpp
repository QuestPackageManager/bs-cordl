...
/// @brief Method <LoadAssembliesAsync>b__19_0, addr 0x5896888, size 0x12c, virtual false, abstract: false, final false
inline bool _LoadAssembliesAsync_b__19_0(::System::Type*  t) ;

/// @brief Method <LoadAssembliesAsync>b__19_1, addr 0x58969b4, size 0x58, virtual false, abstract: false, final false
inline bool _LoadAssembliesAsync_b__19_1(::System::Reflection::MemberInfo*  m) ;

/// @brief Method .ctor, addr 0x5896884, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x5896a0c, size 0x398, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5896da4, size 0x6c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "ignorePrebakedAsset", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
...
/// @brief Field _assembliesDelegate, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__assembliesDelegate, put=setStaticF__assembliesDelegate)) ::System::Func_1<::ArrayW<::System::Reflection::Assembly*,::Array<::System::Reflection::Assembly*>*>>*  _assembliesDelegate;
...
/// @brief Method GetAllAssemblies, addr 0x58959a4, size 0x1c, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Reflection::Assembly*,::Array<::System::Reflection::Assembly*>*> GetAllAssemblies() ;

/// @brief Method GetImmersiveDebuggerEnabled, addr 0x58958d4, size 0x60, virtual false, abstract: false, final false
static inline bool GetImmersiveDebuggerEnabled() ;

/// @brief Method Init, addr 0x58955b0, size 0xb8, virtual false, abstract: false, final false
static inline void Init() ;

/// @brief Method LoadAssembliesAsync, addr 0x5895b9c, size 0xa04, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* LoadAssembliesAsync() ;

/// @brief Method LoadAssembliesMainThread, addr 0x5895ae4, size 0xb8, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* LoadAssembliesMainThread(bool  ignorePrebakedAsset) ;

/// @brief Method OnLoad, addr 0x58959c0, size 0x54, virtual false, abstract: false, final false
static inline void OnLoad() ;

/// @brief Method Refresh, addr 0x5895a14, size 0x7c, virtual false, abstract: false, final false
static inline void Refresh(bool  ignorePrebakedAsset) ;

/// @brief Method RefreshWhenPlaying, addr 0x5895a90, size 0x54, virtual false, abstract: false, final false
static inline void RefreshWhenPlaying() ;

/// @brief Method RegisterAssemblyTypes, addr 0x58965a0, size 0xec, virtual false, abstract: false, final false
static inline void RegisterAssemblyTypes(::System::Action_1<::System::Collections::Generic::List_1<::System::Type*>*>*  del) ;

/// @brief Method Unregister, addr 0x589668c, size 0x58, virtual false, abstract: false, final false
static inline void Unregister(::System::Action_1<::System::Collections::Generic::List_1<::System::Type*>*>*  del) ;

/// @brief Method add_OnAssemblyParsed, addr 0x5895668, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method get_Enabled, addr 0x5895934, size 0x70, virtual false, abstract: false, final false
static inline bool get_Enabled() ;

/// @brief Method get_Ready, addr 0x5895878, size 0x5c, virtual false, abstract: false, final false
static inline bool get_Ready() ;

/// @brief Method remove_OnAssemblyParsed, addr 0x5895770, size 0x108, virtual false, abstract: false, final false
