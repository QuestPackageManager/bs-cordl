...
public:
  ...
  /// @brief Method <LoadAssembliesAsync>b__19_0, addr 0x59087f4, size 0x12c, virtual false, abstract: false, final false
  inline bool _LoadAssembliesAsync_b__19_0(::System::Type* t);

  /// @brief Method <LoadAssembliesAsync>b__19_1, addr 0x5908920, size 0x58, virtual false, abstract: false, final false
  inline bool _LoadAssembliesAsync_b__19_1(::System::Reflection::MemberInfo* m);

  /// @brief Method .ctor, addr 0x59087f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5908978, size 0x398, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5908d10, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetAllAssemblies, addr 0x5907910, size 0x1c, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Reflection::Assembly*, ::Array<::System::Reflection::Assembly*>*> GetAllAssemblies();

  /// @brief Method GetImmersiveDebuggerEnabled, addr 0x5907840, size 0x60, virtual false, abstract: false, final false
  static inline bool GetImmersiveDebuggerEnabled();

  /// @brief Method Init, addr 0x590751c, size 0xb8, virtual false, abstract: false, final false
  static inline void Init();

  /// @brief Method LoadAssembliesAsync, addr 0x5907b08, size 0xa04, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* LoadAssembliesAsync();

  /// @brief Method LoadAssembliesMainThread, addr 0x5907a50, size 0xb8, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task* LoadAssembliesMainThread(bool ignorePrebakedAsset);

  /// @brief Method OnLoad, addr 0x590792c, size 0x54, virtual false, abstract: false, final false
  static inline void OnLoad();

  /// @brief Method Refresh, addr 0x5907980, size 0x7c, virtual false, abstract: false, final false
  static inline void Refresh(bool ignorePrebakedAsset);

  /// @brief Method RefreshWhenPlaying, addr 0x59079fc, size 0x54, virtual false, abstract: false, final false
  static inline void RefreshWhenPlaying();

  /// @brief Method RegisterAssemblyTypes, addr 0x590850c, size 0xec, virtual false, abstract: false, final false
  static inline void RegisterAssemblyTypes(::System::Action_1<::System::Collections::Generic::List_1<::System::Type*>*>* del);

  /// @brief Method Unregister, addr 0x59085f8, size 0x58, virtual false, abstract: false, final false
  static inline void Unregister(::System::Action_1<::System::Collections::Generic::List_1<::System::Type*>*>* del);

  /// @brief Method add_OnAssemblyParsed, addr 0x59075d4, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Enabled, addr 0x59078a0, size 0x70, virtual false, abstract: false, final false
  static inline bool get_Enabled();

  /// @brief Method get_Ready, addr 0x59077e4, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_Ready();

  /// @brief Method remove_OnAssemblyParsed, addr 0x59076dc, size 0x108, virtual false, abstract: false, final false
