...
template<typename T>
constexpr ::Meta::XR::ImmersiveDebugger::Utils::ValueStruct_1<T>::ValueStruct_1(::StringW  ValueName, T  Value) noexcept  {
this->ValueName = ValueName;
this->Value = Value;
}
// Ctor Parameters []
template<typename T>
constexpr ::Meta::XR::ImmersiveDebugger::Utils::ValueStruct_1<T>::ValueStruct_1()   {
}
