...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase::*)()>(&::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase::Awake)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x58a9ebc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase*>::get(),
                        "Awake",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase::*)()>(&::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase::OnDestroy)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x58a9ec0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::Camera> (::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase::*)()>(&::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase::GetCamera)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x58a9ec4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase::*)()>(&::Meta::XR::ImmersiveDebugger::CustomIntegrationConfigBase::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x58a9ecc;
