...
/// @brief Field InspectedMembersRegistry, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_InspectedMembersRegistry, put=setStaticF_InspectedMembersRegistry)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::InspectedMember*>*>*  InspectedMembersRegistry;

/// @brief Method Add, addr 0x589206c, size 0x1c0, virtual false, abstract: false, final false
...
template<typename T>
static inline ::System::Collections::Generic::List_1<::System::ValueTuple_2<T,::Meta::XR::ImmersiveDebugger::DebugMember*>>* GetMembersForType(::System::Type*  type, ::System::Func_3<T,::Meta::XR::ImmersiveDebugger::DebugMember*,bool>*  filterCallback) ;

/// @brief Method Reset, addr 0x58922a8, size 0x88, virtual false, abstract: false, final false
static inline void Reset() ;

static inline ::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::InspectedMember*>*>* getStaticF_InspectedMembersRegistry() ;

static inline void setStaticF_InspectedMembersRegistry(::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::InspectedMember*>*>*  value) ;
