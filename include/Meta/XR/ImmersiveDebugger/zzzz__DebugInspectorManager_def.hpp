...
public:
  ...
  /// @brief Method FetchCategory, addr 0x5a40efc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnReadyInternal, addr 0x5a40c84, size 0xfc, virtual true, abstract: false, final false
  inline void OnReadyInternal();

  /// @brief Method ProcessInspector, addr 0x5a40494, size 0x4d0, virtual false, abstract: false, final false
  inline void ProcessInspector(::Meta::XR::ImmersiveDebugger::DebugInspector* inspector);

  /// @brief Method RegisterInspector, addr 0x5a3fc34, size 0xb4, virtual false, abstract: false, final false
  inline void RegisterInspector(::Meta::XR::ImmersiveDebugger::DebugInspector* inspector);

  /// @brief Method UnprocessInspector, addr 0x5a40964, size 0x318, virtual false, abstract: false, final false
  inline void UnprocessInspector(::Meta::XR::ImmersiveDebugger::DebugInspector* inspector);

  /// @brief Method UnregisterInspector, addr 0x5a3fd40, size 0x70, virtual false, abstract: false, final false
  inline void UnregisterInspector(::Meta::XR::ImmersiveDebugger::DebugInspector* inspector);

  /// @brief Method UpdateCategory, addr 0x5a40ecc, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a40fcc, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Method, addr 0x5a40c7c, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  DebugInspectorManager(DebugInspectorManagerconst&) = delete;
