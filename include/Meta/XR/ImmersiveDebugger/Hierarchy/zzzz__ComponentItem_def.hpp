...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ComponentItem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ComponentItem(ComponentItem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ComponentItem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ComponentItem(ComponentItemconst&) = delete;
