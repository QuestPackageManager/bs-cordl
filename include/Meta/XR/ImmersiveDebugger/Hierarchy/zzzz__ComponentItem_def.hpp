...
public:
  ...
  /// @brief Method BuildHandle, addr 0x592d2f0, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592d00c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Category, addr 0x592d2e0, size 0x10, virtual true, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Manager::Category get_Category();

  /// @brief Method get_Label, addr 0x592d260, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Label();

  /// @brief Method get_Valid, addr 0x592d27c, size 0x64, virtual true, abstract: false, final false
