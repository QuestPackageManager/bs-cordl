...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SceneItem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SceneItem(SceneItem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SceneItem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SceneItem(SceneItemconst&) = delete;
