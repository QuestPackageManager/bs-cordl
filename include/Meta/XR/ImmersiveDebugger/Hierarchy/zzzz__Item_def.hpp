...
public:
  ...
  /// @brief Method BuildChildren, addr 0x592cb7c, size 0x4, virtual true, abstract: false, final false
  inline void BuildChildren();

  /// @brief Method BuildContent, addr 0x592cb74, size 0x4, virtual true, abstract: false, final false
  inline void BuildContent();

  /// @brief Method Clear, addr 0x592c514, size 0x40, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ClearChildren, addr 0x592cb80, size 0x4, virtual true, abstract: false, final false
  inline void ClearChildren();

  /// @brief Method ClearContent, addr 0x592cb78, size 0x4, virtual true, abstract: false, final false
  inline void ClearContent();

  /// @brief Method ComputeNeedsRefresh, addr 0x592cb6c, size 0x8, virtual true, abstract: false, final false
  inline bool ComputeNeedsRefresh();

  /// @brief Method ComputeNumberOfChildren, addr 0x592cb64, size 0x8, virtual true, abstract: false, final false
  inline int32_t ComputeNumberOfChildren();

  static inline ::Meta::XR::ImmersiveDebugger::Hierarchy::Item* New_ctor();

  /// @brief Method Register, addr 0x592c71c, size 0x80, virtual true, abstract: false, final false
  inline void Register(::Meta::XR::ImmersiveDebugger::Hierarchy::Item* parent);

  /// @brief Method Unregister, addr 0x592c554, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592cb84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Category, addr 0x592c4f8, size 0xc, virtual true, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Manager::Category get_Category();

  /// @brief Method get_Depth, addr 0x592c4dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Depth();

  /// @brief Method get_Dirty, addr 0x592c504, size 0x8, virtual false, abstract: false, final false
  inline bool get_Dirty();

  /// @brief Method get_Handle, addr 0x592c4e4, size 0x14, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle get_Handle();

  /// @brief Method get_Id, addr 0x59245f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Parent, addr 0x592c4d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Dirty, addr 0x592c50c, size 0x8, virtual false, abstract: false, final false
