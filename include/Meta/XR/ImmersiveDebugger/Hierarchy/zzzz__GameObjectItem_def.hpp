...
public:
  ...
  /// @brief Method BuildContent, addr 0x592cdd4, size 0x60, virtual true, abstract: false, final false
  inline void BuildContent();

  /// @brief Method BuildContentInternal, addr 0x592ce34, size 0x1d8, virtual false, abstract: false, final false
  inline void BuildContentInternal();

  /// @brief Method BuildHandle, addr 0x592cc00, size 0x8c, virtual true, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle BuildHandle();

  /// @brief Method ClearContent, addr 0x592d048, size 0x184, virtual true, abstract: false, final false
  inline void ClearContent();

  /// @brief Method CompareChildren, addr 0x592cc8c, size 0x6c, virtual true, abstract: false, final false
  inline bool CompareChildren(::UnityEngine::GameObject* lhs, ::UnityEngine::GameObject* rhs);

  /// @brief Method FetchExpectedChildren, addr 0x592ccf8, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592d1cc, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Label, addr 0x592cb88, size 0x14, virtual true, abstract: false, final false
  inline ::StringW get_Label();

  /// @brief Method get_Valid, addr 0x592cb9c, size 0x64, virtual true, abstract: false, final false
