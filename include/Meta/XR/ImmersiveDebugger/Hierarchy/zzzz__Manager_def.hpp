...
public:
  ...
  /// @brief Method ProcessItem, addr 0x5a67870, size 0x3c8, virtual false, abstract: false, final false
  inline void ProcessItem(::Meta::XR::ImmersiveDebugger::Hierarchy::Item* item);

  /// @brief Method Refresh, addr 0x5a68740, size 0x48, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method UnprocessItem, addr 0x5a67688, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a68788, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Method, addr 0x5a68738, size 0x8, virtual true, abstract: false, final false
