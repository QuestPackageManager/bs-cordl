...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Manager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Manager(Manager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Manager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Manager(Managerconst&) = delete;
