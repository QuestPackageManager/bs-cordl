...
// Write type traits
MARK_GEN_REF_T_PTR(::Meta::XR::ImmersiveDebugger::Hierarchy::Item_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Meta::XR::ImmersiveDebugger::Hierarchy::Item_1, "Meta.XR.ImmersiveDebugger.Hierarchy", "Item`1");
