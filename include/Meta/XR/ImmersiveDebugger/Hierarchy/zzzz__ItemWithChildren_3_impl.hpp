...
template<typename TargetType,typename ChildType,typename ChildTargetType>
constexpr ::System::Collections::Generic::List_1<ChildType>* const& Meta::XR::ImmersiveDebugger::Hierarchy::ItemWithChildren_3<TargetType,ChildType,ChildTargetType>::__cordl_internal_get__children() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____children;
}
template<typename TargetType,typename ChildType,typename ChildTargetType>
constexpr void Meta::XR::ImmersiveDebugger::Hierarchy::ItemWithChildren_3<TargetType,ChildType,ChildTargetType>::__cordl_internal_set__children(::System::Collections::Generic::List_1<ChildType>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                            ...
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::Hierarchy::ItemWithChildren_3<TargetType,ChildType,ChildTargetType>*>::get(),
                            17
                        )));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "GetChild",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ChildTargetType>::get()}
                    )));
...
template<typename TargetType,typename ChildType,typename ChildTargetType>
inline void Meta::XR::ImmersiveDebugger::Hierarchy::ItemWithChildren_3<TargetType,ChildType,ChildTargetType>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::Hierarchy::ItemWithChildren_3<TargetType,ChildType,ChildTargetType>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TargetType,typename ChildType,typename ChildTargetType>
inline ::Meta::XR::ImmersiveDebugger::Hierarchy::ItemWithChildren_3<TargetType,ChildType,ChildTargetType>* Meta::XR::ImmersiveDebugger::Hierarchy::ItemWithChildren_3<TargetType,ChildType,ChildTargetType>::New_ctor()  {
