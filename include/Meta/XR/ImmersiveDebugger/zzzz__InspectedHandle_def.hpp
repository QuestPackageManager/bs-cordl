...
/// @brief Field <InstanceHandle>k__BackingField, offset 0x30, size 0x18 
 __declspec(property(get=__cordl_internal_get__InstanceHandle_k__BackingField, put=__cordl_internal_set__InstanceHandle_k__BackingField)) ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  _InstanceHandle_k__BackingField;
...
/// @brief Field inspectedMembers, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_inspectedMembers, put=__cordl_internal_set_inspectedMembers)) ::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::InspectedMember*>*  inspectedMembers;

/// @brief Method Initialize, addr 0x5890b48, size 0x3ec, virtual false, abstract: false, final false
...
/// @brief Method TryGetMember, addr 0x58924d0, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58910a0, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::Meta::XR::ImmersiveDebugger::DebugInspector*  owner, ::System::Type*  type) ;

/// @brief Method get_InstanceHandle, addr 0x58923f8, size 0x14, virtual false, abstract: false, final false
inline ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle get_InstanceHandle() ;

/// @brief Method get_Type, addr 0x5892420, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_Type() ;

/// @brief Method set_InstanceHandle, addr 0x589240c, size 0x14, virtual false, abstract: false, final false
inline void set_InstanceHandle(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  value) ;

/// @brief Method set_Type, addr 0x5892428, size 0x8, virtual false, abstract: false, final false
