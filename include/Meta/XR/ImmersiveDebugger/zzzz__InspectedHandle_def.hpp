...
public:
  ...
  /// @brief Method Initialize, addr 0x5902ab4, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetMember, addr 0x590443c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590300c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Meta::XR::ImmersiveDebugger::DebugInspector* owner, ::System::Type* type);

  /// @brief Method get_InstanceHandle, addr 0x5904364, size 0x14, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle get_InstanceHandle();

  /// @brief Method get_Type, addr 0x590438c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_Type();

  /// @brief Method set_InstanceHandle, addr 0x5904378, size 0x14, virtual false, abstract: false, final false
  inline void set_InstanceHandle(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle value);

  /// @brief Method set_Type, addr 0x5904394, size 0x8, virtual false, abstract: false, final false
