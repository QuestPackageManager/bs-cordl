...
public:
  ...
  /// @brief Method <.ctor>b__0, addr 0x59296cc, size 0x78, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> __ctor_b__0();

  /// @brief Method .ctor, addr 0x5929614, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x59294f4, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NumberOfValues, addr 0x59296c4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_NumberOfValues();

  /// @brief Method get_Texture, addr 0x591f478, size 0x20, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_Texture();

  /// @brief Method get_Value, addr 0x5929618, size 0x14, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_Values, addr 0x592962c, size 0x98, virtual true, abstract: false, final false
