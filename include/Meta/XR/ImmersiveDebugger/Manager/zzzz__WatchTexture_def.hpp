...
/// @brief Method <.ctor>b__0, addr 0x592b09c, size 0x78, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> __ctor_b__0() ;

/// @brief Method .ctor, addr 0x592afe4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x592aec4, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method get_NumberOfValues, addr 0x592b094, size 0x8, virtual true, abstract: false, final false
inline int32_t get_NumberOfValues() ;

/// @brief Method get_Texture, addr 0x5920e48, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> get_Texture() ;

/// @brief Method get_Value, addr 0x592afe8, size 0x14, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_Values, addr 0x592affc, size 0x98, virtual true, abstract: false, final false
