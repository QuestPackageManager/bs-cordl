...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Manager::WatchTexture*);
...
public:
  ...
  /// @brief Method <.ctor>b__0, addr 0x5a647a0, size 0x78, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> __ctor_b__0();

  /// @brief Method .ctor, addr 0x5a646e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::WatchTexture___c__DisplayClass0_0) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a645c8, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NumberOfValues, addr 0x5a64798, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_NumberOfValues();

  /// @brief Method get_Texture, addr 0x5a5a54c, size 0x20, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_Texture();

  /// @brief Method get_Value, addr 0x5a646ec, size 0x14, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method get_Values, addr 0x5a64700, size 0x98, virtual true, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::WatchTexture) == 0x48, "Size mismatch!");
