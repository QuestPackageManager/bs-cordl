...
public:
  ...
  /// @brief Method <.ctor>b__0, addr 0x592723c, size 0xac, virtual false, abstract: false, final false
  inline void __ctor_b__0();

  /// @brief Method .ctor, addr 0x5927218, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x5924408, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Delegate, addr 0x5927208, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action* get_Delegate();

  /// @brief Method set_Delegate, addr 0x5927210, size 0x8, virtual false, abstract: false, final false
