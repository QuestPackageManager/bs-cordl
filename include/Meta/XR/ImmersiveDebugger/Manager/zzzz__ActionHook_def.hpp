...
/// @brief Method <.ctor>b__0, addr 0x58b52d0, size 0xac, virtual false, abstract: false, final false
inline void __ctor_b__0() ;

/// @brief Method .ctor, addr 0x58b52ac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::Meta::XR::ImmersiveDebugger::Manager::ActionHook* New_ctor(::System::Reflection::MemberInfo*  memberInfo, ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  instanceHandle, ::Meta::XR::ImmersiveDebugger::DebugMember*  attribute) ;
...
/// @brief Method .ctor, addr 0x58b249c, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method get_Delegate, addr 0x58b529c, size 0x8, virtual false, abstract: false, final false
inline ::System::Action* get_Delegate() ;

/// @brief Method set_Delegate, addr 0x58b52a4, size 0x8, virtual false, abstract: false, final false
