...
namespace Meta::XR::ImmersiveDebugger::Manager {
template<typename T>
class Watch_1___c__DisplayClass20_0;
}
...
/// @brief Field <ToDisplayStringsDelegate>k__BackingField, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__ToDisplayStringsDelegate_k__BackingField, put=setStaticF__ToDisplayStringsDelegate_k__BackingField)) ::Meta::XR::ImmersiveDebugger::Manager::Watch_1_ToDisplayStringSignature<T>*  _ToDisplayStringsDelegate_k__BackingField;
...
static inline ::Meta::XR::ImmersiveDebugger::Manager::Watch_1<T>* New_ctor(::System::Reflection::MemberInfo*  memberInfo, ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  instanceHandle, ::Meta::XR::ImmersiveDebugger::DebugMember*  attribute) ;
