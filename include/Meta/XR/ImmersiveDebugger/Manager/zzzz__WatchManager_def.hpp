...
public:
  ...
  /// @brief Method <ProcessType>b__4_0, addr 0x5a672d8, size 0x8, virtual false, abstract: false, final false
  inline bool _ProcessType_b__4_0(::System::Reflection::MemberInfo* info, ::Meta::XR::ImmersiveDebugger::DebugMember* _);

  /// @brief Method <ProcessType>b__4_1, addr 0x5a672e0, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a672d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetCountPerType, addr 0x5a67150, size 0x98, virtual true, abstract: false, final true
  inline int32_t GetCountPerType(::System::Type* type);

  /// @brief Method IsMemberValidForWatch, addr 0x5a65878, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessType, addr 0x5a66c84, size 0x418, virtual true, abstract: false, final true
  inline void ProcessType(::System::Type* type);

  /// @brief Method ProcessTypeFromHierarchy, addr 0x5a670d4, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessTypeFromInspector, addr 0x5a6709c, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method Setup, addr 0x5a66c7c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a671e8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x5a6710c, size 0x44, virtual true, abstract: false, final true
