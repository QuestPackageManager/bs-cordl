...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::*)(::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*, ::Meta::XR::ImmersiveDebugger::Utils::InstanceCache*)>(&::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::Setup)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x58b77d8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon*>::get(),
                        "Setup",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::*)(::System::Type*)>(&::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::ProcessType)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::*)(::Meta::XR::ImmersiveDebugger::Hierarchy::Item*, ::System::Reflection::MemberInfo*)>(&::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::ProcessTypeFromHierarchy)> {
  constexpr static std::size_t size = 0x350;
  constexpr static std::size_t addrs = 0x58b7b38;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::*)()>(&::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::get_TelemetryAnnotation)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::*)(::System::Type*)>(&::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::GetCountPerType)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x58b7e88;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::*)()>(&::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::_ctor)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x58b7f20;
...
constexpr ::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::System::Reflection::MemberInfo*>*>*& Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::__cordl_internal_get__dictionary()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____dictionary;
}
constexpr ::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::System::Reflection::MemberInfo*>*>* const& Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::__cordl_internal_get__dictionary() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____dictionary;
}
constexpr void Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::__cordl_internal_set__dictionary(::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::List_1<::System::Reflection::MemberInfo*>*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::Setup(::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*  panel, ::Meta::XR::ImmersiveDebugger::Utils::InstanceCache*  cache)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon*>::get(),
                        "Setup",
                        std::span<const Il2CppClass* const, 0>(),
...
inline void Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::ProcessTypeFromInspector(::System::Type*  type, ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  handle, ::System::Reflection::MemberInfo*  memberInfo, ::Meta::XR::ImmersiveDebugger::DebugMember*  memberAttribute)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon*>::get(),
                        "ProcessTypeFromInspector",
                        std::span<const Il2CppClass* const, 0>(),
...
inline bool Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon::RegisterSpecialisedWidget(::Meta::XR::ImmersiveDebugger::UserInterface::IMember*  member, ::System::Reflection::MemberInfo*  memberInfo, ::Meta::XR::ImmersiveDebugger::DebugMember*  memberAttribute, ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  handle)  {
