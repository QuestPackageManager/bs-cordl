...
public:
  ...
  /// @brief Method RegisterSpecialisedWidget, addr 0x592a22c, size 0x268, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592a4d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x592a494, size 0x44, virtual true, abstract: false, final false
