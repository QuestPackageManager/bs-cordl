...
public:
  ...
  /// @brief Method RegisterSpecialisedWidget, addr 0x5a67600, size 0x268, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a678ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x5a67868, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ActionManagerForAddon", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ActionManagerForAddon(ActionManagerForAddon&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ActionManagerForAddon", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ActionManagerForAddon(ActionManagerForAddonconst&) = delete;
