...
/// @brief Method RegisterSpecialisedWidget, addr 0x58b82c0, size 0x268, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58b856c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TelemetryAnnotation, addr 0x58b8528, size 0x44, virtual true, abstract: false, final false
