...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WatchManagerForAddon", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WatchManagerForAddon(WatchManagerForAddon&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WatchManagerForAddon", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WatchManagerForAddon(WatchManagerForAddonconst&) = delete;
