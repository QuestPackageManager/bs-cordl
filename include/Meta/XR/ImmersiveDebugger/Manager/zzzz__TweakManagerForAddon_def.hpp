...
public:
  ...
  /// @brief Method RegisterSpecialisedWidget, addr 0x5851348, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x585164c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x5851608, size 0x44, virtual true, abstract: false, final false
