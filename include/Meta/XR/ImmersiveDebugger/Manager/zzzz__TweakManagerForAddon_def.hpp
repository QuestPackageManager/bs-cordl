...
/// @brief Method RegisterSpecialisedWidget, addr 0x58b7fb8, size 0x2c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58b82bc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TelemetryAnnotation, addr 0x58b8278, size 0x44, virtual true, abstract: false, final false
