...
public:
  ...
  /// @brief Method RegisterSpecialisedWidget, addr 0x5a672f8, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a675fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x5a675b8, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TweakManagerForAddon", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TweakManagerForAddon(TweakManagerForAddon&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TweakManagerForAddon", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TweakManagerForAddon(TweakManagerForAddonconst&) = delete;
