...
public:
  ...
  /// @brief Method .ctor, addr 0x5926f0c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_GetState, addr 0x59272f0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_1<bool>* get_GetState();

  /// @brief Method get_SetState, addr 0x59272e8, size 0x8, virtual false, abstract: false, final false
