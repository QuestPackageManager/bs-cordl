...
public:
  ...
  /// @brief Method <RegisterSpecialisedWidget>g__GetState|1, addr 0x592b188, size 0x6c, virtual false, abstract: false, final false
  inline bool _RegisterSpecialisedWidget_g__GetState_1();

  /// @brief Method <RegisterSpecialisedWidget>g__OnStateChanged|0, addr 0x592b10c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592b028, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method RegisterSpecialisedWidget, addr 0x592a930, size 0x6f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592b070, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x592b02c, size 0x44, virtual true, abstract: false, final false
