...
/// @brief Method <RegisterSpecialisedWidget>g__GetState|1, addr 0x58b921c, size 0x6c, virtual false, abstract: false, final false
inline bool _RegisterSpecialisedWidget_g__GetState_1() ;

/// @brief Method <RegisterSpecialisedWidget>g__OnStateChanged|0, addr 0x58b91a0, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58b90bc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _memberToGizmoRendererManagerDict, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__memberToGizmoRendererManagerDict, put=__cordl_internal_set__memberToGizmoRendererManagerDict)) ::System::Collections::Generic::Dictionary_2<::System::Reflection::MemberInfo*,::UnityW<::Meta::XR::ImmersiveDebugger::Gizmo::GizmoRendererManager>>*  _memberToGizmoRendererManagerDict;

static inline ::Meta::XR::ImmersiveDebugger::Manager::GizmoManagerForAddon* New_ctor() ;

/// @brief Method RegisterSpecialisedWidget, addr 0x58b89c4, size 0x6f8, virtual true, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::System::Reflection::MemberInfo*,::UnityW<::Meta::XR::ImmersiveDebugger::Gizmo::GizmoRendererManager>>* const& __cordl_internal_get__memberToGizmoRendererManagerDict() const;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Reflection::MemberInfo*,::UnityW<::Meta::XR::ImmersiveDebugger::Gizmo::GizmoRendererManager>>*& __cordl_internal_get__memberToGizmoRendererManagerDict() ;

constexpr void __cordl_internal_set__memberToGizmoRendererManagerDict(::System::Collections::Generic::Dictionary_2<::System::Reflection::MemberInfo*,::UnityW<::Meta::XR::ImmersiveDebugger::Gizmo::GizmoRendererManager>>*  value) ;

/// @brief Method .ctor, addr 0x58b9104, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TelemetryAnnotation, addr 0x58b90c0, size 0x44, virtual true, abstract: false, final false
