...
public:
  ...
  /// @brief Method <ProcessType>b__4_0, addr 0x59241f8, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59241f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetCountPerType, addr 0x5924070, size 0x98, virtual true, abstract: false, final true
  inline int32_t GetCountPerType(::System::Type* type);

  static inline ::Meta::XR::ImmersiveDebugger::Manager::ActionManager* New_ctor();

  /// @brief Method ProcessType, addr 0x5923c4c, size 0x370, virtual true, abstract: false, final true
  inline void ProcessType(::System::Type* type);

  /// @brief Method ProcessTypeFromHierarchy, addr 0x5923ff4, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessTypeFromInspector, addr 0x5923fbc, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method Setup, addr 0x5923c44, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5924108, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x592402c, size 0x44, virtual true, abstract: false, final true
