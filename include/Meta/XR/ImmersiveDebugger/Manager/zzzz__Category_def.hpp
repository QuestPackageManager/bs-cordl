...
public:
  ...
  /// @brief Method Equals, addr 0x5a5f748, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5a5f6cc, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::Meta::XR::ImmersiveDebugger::Manager::Category other);

  /// @brief Method GetHashCode, addr 0x5a5f7dc, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::Meta::XR::ImmersiveDebugger::Manager::Category getStaticF_Default();

  /// @brief Method get_Label, addr 0x5a5f604, size 0x70, virtual false, abstract: false, final false
  inline ::StringW get_Label();

  /// @brief Method get_Uid, addr 0x5a5f674, size 0x50, virtual false, abstract: false, final false
