...
/// @brief Field _subDebugManagers, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__subDebugManagers, put=__cordl_internal_set__subDebugManagers)) ::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::Manager::IDebugManager*>*  _subDebugManagers;
