...
public:
  ...
  /// @brief Method <.cctor>b__4_0, addr 0x5928610, size 0x4, virtual false, abstract: false, final false
  inline float_t __cctor_b__4_0(float_t f);

  /// @brief Method <.cctor>b__4_1, addr 0x5928614, size 0x44, virtual false, abstract: false, final false
  inline float_t __cctor_b__4_1(int32_t start, int32_t end, int32_t value);

  /// @brief Method <.cctor>b__4_2, addr 0x5928658, size 0x108, virtual false, abstract: false, final false
  inline int32_t __cctor_b__4_2(int32_t start, int32_t end, float_t tween);

  /// @brief Method <.cctor>b__4_3, addr 0x5928760, size 0x1c, virtual false, abstract: false, final false
  inline int32_t __cctor_b__4_3(float_t f);

  /// @brief Method <.cctor>b__4_4, addr 0x592877c, size 0x14, virtual false, abstract: false, final false
  inline float_t __cctor_b__4_4(bool _, bool __param_1, bool value);

  /// @brief Method <.cctor>b__4_5, addr 0x5928790, size 0xc, virtual false, abstract: false, final false
  inline bool __cctor_b__4_5(bool _, bool __param_1, float_t tween);

  /// @brief Method <.cctor>b__4_6, addr 0x592879c, size 0xc, virtual false, abstract: false, final false
  inline bool __cctor_b__4_6(float_t f);

  /// @brief Method .ctor, addr 0x592860c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Create, addr 0x5927b88, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x5927da4, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMemberValidForTweak, addr 0x5928028, size 0x184, virtual false, abstract: false, final false
  static inline bool IsMemberValidForTweak(::System::Reflection::MemberInfo* member);

  /// @brief Method IsTypeSupported, addr 0x59279c8, size 0x10c, virtual false, abstract: false, final false
  static inline bool IsTypeSupported(::System::Type* type);

  /// @brief Method IsTypeSupportsValueRange, addr 0x5927ad4, size 0xb4, virtual false, abstract: false, final false
  static inline bool IsTypeSupportsValueRange(::System::Type* t);

  /// @brief Method ProcessMinMaxRange, addr 0x59281ac, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method RoundToNearest, addr 0x592840c, size 0x1ac, virtual false, abstract: false, final false
