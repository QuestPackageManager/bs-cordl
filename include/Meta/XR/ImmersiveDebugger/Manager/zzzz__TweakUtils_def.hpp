...
/// @brief Method <.cctor>b__4_0, addr 0x58b66a4, size 0x4, virtual false, abstract: false, final false
inline float_t __cctor_b__4_0(float_t  f) ;

/// @brief Method <.cctor>b__4_1, addr 0x58b66a8, size 0x44, virtual false, abstract: false, final false
inline float_t __cctor_b__4_1(int32_t  start, int32_t  end, int32_t  value) ;

/// @brief Method <.cctor>b__4_2, addr 0x58b66ec, size 0x108, virtual false, abstract: false, final false
inline int32_t __cctor_b__4_2(int32_t  start, int32_t  end, float_t  tween) ;

/// @brief Method <.cctor>b__4_3, addr 0x58b67f4, size 0x1c, virtual false, abstract: false, final false
inline int32_t __cctor_b__4_3(float_t  f) ;

/// @brief Method <.cctor>b__4_4, addr 0x58b6810, size 0x14, virtual false, abstract: false, final false
inline float_t __cctor_b__4_4(bool  _, bool  __param_1, bool  value) ;

/// @brief Method <.cctor>b__4_5, addr 0x58b6824, size 0xc, virtual false, abstract: false, final false
inline bool __cctor_b__4_5(bool  _, bool  __param_1, float_t  tween) ;

/// @brief Method <.cctor>b__4_6, addr 0x58b6830, size 0xc, virtual false, abstract: false, final false
inline bool __cctor_b__4_6(float_t  f) ;

/// @brief Method .ctor, addr 0x58b66a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Create, addr 0x58b5c1c, size 0x21c, virtual false, abstract: false, final false
static inline ::Meta::XR::ImmersiveDebugger::Manager::Tweak* Create(::System::Reflection::MemberInfo*  memberInfo, ::Meta::XR::ImmersiveDebugger::DebugMember*  attribute, ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  instanceHandle) ;

/// @brief Method Create, addr 0x58b5e38, size 0x284, virtual false, abstract: false, final false
static inline ::Meta::XR::ImmersiveDebugger::Manager::TweakEnum* Create(::System::Reflection::MemberInfo*  memberInfo, ::Meta::XR::ImmersiveDebugger::DebugMember*  attribute, ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  instanceHandle, ::System::Type*  enumType) ;

/// @brief Method IsMemberValidForTweak, addr 0x58b60bc, size 0x184, virtual false, abstract: false, final false
static inline bool IsMemberValidForTweak(::System::Reflection::MemberInfo*  member) ;

/// @brief Method IsTypeSupported, addr 0x58b5a5c, size 0x10c, virtual false, abstract: false, final false
static inline bool IsTypeSupported(::System::Type*  type) ;

/// @brief Method IsTypeSupportsValueRange, addr 0x58b5b68, size 0xb4, virtual false, abstract: false, final false
static inline bool IsTypeSupportsValueRange(::System::Type*  t) ;

/// @brief Method ProcessMinMaxRange, addr 0x58b6240, size 0x260, virtual false, abstract: false, final false
...
template<typename T>
static inline void Register(::System::Func_4<T,T,T,float_t>*  inverseLerp, ::System::Func_4<T,T,float_t,T>*  lerp, ::System::Func_2<float_t,T>*  fromFloat) ;

/// @brief Method RoundToNearest, addr 0x58b64a0, size 0x1ac, virtual false, abstract: false, final false
