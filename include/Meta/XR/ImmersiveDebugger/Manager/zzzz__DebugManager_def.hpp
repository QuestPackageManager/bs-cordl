...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5925b98, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x5925bb4, size 0x24, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5925b84, size 0x14, virtual true, abstract: false, final false
  inline bool Invoke();
  ...
  /// @brief Method .ctor, addr 0x5925b1c, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__43_0, addr 0x5925c30, size 0x98, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker __ctor_b__43_0(::GlobalNamespace::OVRTelemetryMarker marker);

  /// @brief Method .ctor, addr 0x5925c2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x5924f98, size 0x164, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x5924778, size 0x4c, virtual false, abstract: false, final false
  static inline void Init();

  /// @brief Method InitSubManagers, addr 0x5925620, size 0xb8, virtual true, abstract: false, final false
  inline void InitSubManagers();

  static inline ::Meta::XR::ImmersiveDebugger::Manager::DebugManager* New_ctor();

  /// @brief Method OnApplicationFocus, addr 0x59254e0, size 0x20, virtual false, abstract: false, final false
  inline void OnApplicationFocus(bool hasFocus);

  /// @brief Method OnDestroy, addr 0x592551c, size 0xac, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5925500, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method ProcessLoadedTypeBySubManagers, addr 0x59256d8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterTypesFromInspectedData, addr 0x59252a4, size 0x16c, virtual false, abstract: false, final false
  inline void RegisterTypesFromInspectedData();

  /// @brief Method RetrieveInstancesIfNeeded, addr 0x5925410, size 0xd0, virtual false, abstract: false, final false
  inline void RetrieveInstancesIfNeeded();

  /// @brief Method Start, addr 0x59250fc, size 0x1a8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterInspector, addr 0x592585c, size 0x128, virtual false, abstract: false, final false
  inline void UnregisterInspector(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle handle);

  /// @brief Method Update, addr 0x59255c8, size 0x58, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5925984, size 0x198, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_CustomShouldRetrieveInstanceCondition, addr 0x5924e30, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method add_OnDisableAction, addr 0x5924b80, size 0xac, virtual false, abstract: false, final false
  inline void add_OnDisableAction(::System::Action* value);

  /// @brief Method add_OnFocusLostAction, addr 0x5924a28, size 0xac, virtual false, abstract: false, final false
  inline void add_OnFocusLostAction(::System::Action* value);

  /// @brief Method add_OnReady, addr 0x5924860, size 0xe4, virtual false, abstract: false, final false
  static inline void add_OnReady(::System::Action_1<::UnityW<::Meta::XR::ImmersiveDebugger::Manager::DebugManager>>* value);

  /// @brief Method add_OnUpdateAction, addr 0x5924cd8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Instance, addr 0x59247c4, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::Meta::XR::ImmersiveDebugger::Manager::DebugManager> get_Instance();

  /// @brief Method get_UiPanel, addr 0x5924f88, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel* get_UiPanel();

  /// @brief Method remove_CustomShouldRetrieveInstanceCondition, addr 0x5924edc, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_OnDisableAction, addr 0x5924c2c, size 0xac, virtual false, abstract: false, final false
  inline void remove_OnDisableAction(::System::Action* value);

  /// @brief Method remove_OnFocusLostAction, addr 0x5924ad4, size 0xac, virtual false, abstract: false, final false
  inline void remove_OnFocusLostAction(::System::Action* value);

  /// @brief Method remove_OnReady, addr 0x5924944, size 0xe4, virtual false, abstract: false, final false
  static inline void remove_OnReady(::System::Action_1<::UnityW<::Meta::XR::ImmersiveDebugger::Manager::DebugManager>>* value);

  /// @brief Method remove_OnUpdateAction, addr 0x5924d84, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Instance, addr 0x5924810, size 0x50, virtual false, abstract: false, final false
  static inline void set_Instance(::Meta::XR::ImmersiveDebugger::Manager::DebugManager* value);

  /// @brief Method set_UiPanel, addr 0x5924f90, size 0x8, virtual false, abstract: false, final false
