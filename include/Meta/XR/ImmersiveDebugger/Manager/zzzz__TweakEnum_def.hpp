...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Manager::TweakEnum*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Manager::TweakEnum*, "Meta.XR.ImmersiveDebugger.Manager", "TweakEnum");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::Manager::TweakEnum) == 0x50, "Size mismatch!");
