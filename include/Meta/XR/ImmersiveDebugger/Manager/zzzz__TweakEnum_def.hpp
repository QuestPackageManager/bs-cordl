...
public:
  ...
  /// @brief Method .ctor, addr 0x59287d8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Member, addr 0x59287d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_Member();

  /// @brief Method get_Tween, addr 0x5928800, size 0x8, virtual true, abstract: false, final false
  inline float_t get_Tween();

  /// @brief Method get_Value, addr 0x591d42c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Tween, addr 0x5928808, size 0x8, virtual true, abstract: false, final false
  inline void set_Tween(float_t value);

  /// @brief Method set_Value, addr 0x591d304, size 0x54, virtual false, abstract: false, final false
