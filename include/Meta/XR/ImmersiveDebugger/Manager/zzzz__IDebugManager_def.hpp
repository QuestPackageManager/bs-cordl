...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::Manager::IDebugManager*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::Manager::IDebugManager*, "Meta.XR.ImmersiveDebugger.Manager", "IDebugManager");
// Dependencies
namespace Meta::XR::ImmersiveDebugger::Manager {
// Is value type: false
