...
public:
  ...
  /// @brief Method <ProcessType>b__4_0, addr 0x5852ca0, size 0x88, virtual false, abstract: false, final false
  inline bool _ProcessType_b__4_0(::System::Reflection::MemberInfo* info, ::Meta::XR::ImmersiveDebugger::DebugMember* attribute);

  /// @brief Method <ProcessType>b__4_1, addr 0x5852d28, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5852c9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetCountPerType, addr 0x5852b18, size 0x98, virtual true, abstract: false, final true
  inline int32_t GetCountPerType(::System::Type* type);

  static inline ::Meta::XR::ImmersiveDebugger::Manager::TweakManager* New_ctor();

  /// @brief Method ProcessType, addr 0x5852620, size 0x444, virtual true, abstract: false, final true
  inline void ProcessType(::System::Type* type);

  /// @brief Method ProcessTypeFromHierarchy, addr 0x5852a9c, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessTypeFromInspector, addr 0x5852a64, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method Setup, addr 0x5852618, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5852bb0, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_TelemetryAnnotation, addr 0x5852ad4, size 0x44, virtual true, abstract: false, final true
