...
/// @brief Method Matches, addr 0x5925d70, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5928bec, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_Attribute, addr 0x5928cc8, size 0x8, virtual false, abstract: false, final false
inline ::Meta::XR::ImmersiveDebugger::DebugMember* get_Attribute() ;

/// @brief Method get_MemberInfo, addr 0x5928cd0, size 0x8, virtual false, abstract: false, final false
inline ::System::Reflection::MemberInfo* get_MemberInfo() ;

/// @brief Method get_Valid, addr 0x5920f50, size 0xc, virtual false, abstract: false, final false
