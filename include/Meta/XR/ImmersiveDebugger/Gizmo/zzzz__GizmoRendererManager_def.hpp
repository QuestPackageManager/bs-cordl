...
/// @brief Field _renderers, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__renderers, put=__cordl_internal_set__renderers)) ::System::Collections::Generic::List_1<::UnityW<::Meta::XR::ImmersiveDebugger::Gizmo::GizmoRenderer>>*  _renderers;

/// @brief Method AddGizmoRenderer, addr 0x58c037c, size 0xf8, virtual false, abstract: false, final false
inline void AddGizmoRenderer() ;

/// @brief Method GetState, addr 0x58b51e4, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method SetState, addr 0x58b507c, size 0xfc, virtual false, abstract: false, final false
inline void SetState(::UnityEngine::Object*  instance, bool  state) ;

/// @brief Method Setup, addr 0x58b48ec, size 0x68, virtual false, abstract: false, final false
inline void Setup(::System::Type*  classType, ::System::Reflection::MemberInfo*  memberInfo, ::Meta::XR::ImmersiveDebugger::DebugGizmoType  gizmoType, ::UnityEngine::Color  gizmoColor, ::Meta::XR::ImmersiveDebugger::Utils::InstanceCache*  instanceCache) ;

/// @brief Method Start, addr 0x58c0378, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x58c0474, size 0x2f8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x58c076c, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;
