...
public:
  ...
  /// @brief Method AddGizmoRenderer, addr 0x59322e8, size 0xf8, virtual false, abstract: false, final false
  inline void AddGizmoRenderer();

  /// @brief Method GetState, addr 0x5927150, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetState, addr 0x5926fe8, size 0xfc, virtual false, abstract: false, final false
  inline void SetState(::UnityEngine::Object* instance, bool state);

  /// @brief Method Setup, addr 0x5926858, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x59322e4, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x59323e0, size 0x2f8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x59326d8, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
