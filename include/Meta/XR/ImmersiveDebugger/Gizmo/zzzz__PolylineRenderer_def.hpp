...
public:
  ...
  /// @brief Method Cleanup, addr 0x592e0f8, size 0xf4, virtual false, abstract: false, final false
  inline void Cleanup();
  ...
  /// @brief Method PrepareColorBuffer, addr 0x5931f34, size 0x110, virtual false, abstract: false, final false
  inline void PrepareColorBuffer(int32_t count);

  /// @brief Method RenderLines, addr 0x592e2c4, size 0x1d0, virtual false, abstract: false, final false
  inline void RenderLines();

  /// @brief Method SetColor, addr 0x5931d40, size 0xd4, virtual false, abstract: false, final false
  inline void SetColor(int32_t count, ::UnityEngine::Color color);

  /// @brief Method SetColors, addr 0x5931e14, size 0x120, virtual false, abstract: false, final false
  inline void SetColors(int32_t count, ::System::Collections::Generic::List_1<::UnityEngine::Color>* colors);

  /// @brief Method SetDrawCount, addr 0x5931cfc, size 0x44, virtual false, abstract: false, final false
  inline void SetDrawCount(int32_t c);

  /// @brief Method SetLines, addr 0x5931908, size 0xb4, virtual false, abstract: false, final false
  inline void SetLines(::System::Collections::Generic::List_1<::UnityEngine::Vector4>* positions, ::UnityEngine::Color color);

  /// @brief Method SetLines, addr 0x592e228, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPositions, addr 0x59319bc, size 0x340, virtual false, abstract: false, final false
  inline void SetPositions(int32_t count, ::System::Collections::Generic::List_1<::UnityEngine::Vector4>* positions);

  /// @brief Method SetTransform, addr 0x5932044, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592dc18, size 0x460, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Material* material, bool renderSinglePass);

  /// @brief Method get_BufferSize, addr 0x59318e4, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_BufferSize();

  /// @brief Method get_Copies, addr 0x59318d0, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_Copies();

  /// @brief Method get_LineScaleFactor, addr 0x59318f8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_LineScaleFactor();

  /// @brief Method set_LineScaleFactor, addr 0x5931900, size 0x8, virtual false, abstract: false, final false
