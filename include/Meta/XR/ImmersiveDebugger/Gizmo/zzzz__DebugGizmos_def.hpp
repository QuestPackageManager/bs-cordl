...
public:
  ...
  /// @brief Method Dispose, addr 0x593185c, size 0x74, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x592f1d0, size 0x90, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddSegment, addr 0x592e518, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearSegments, addr 0x592e1ec, size 0x8, virtual false, abstract: false, final false
  inline void ClearSegments();

  /// @brief Method DrawAxis, addr 0x592f260, size 0xa8, virtual false, abstract: false, final false
  static inline void DrawAxis(::UnityEngine::Pose pose, float_t size);

  /// @brief Method DrawAxis, addr 0x592eeec, size 0x2e4, virtual false, abstract: false, final false
  static inline void DrawAxis(::UnityEngine::Vector3 position, ::UnityEngine::Quaternion rotation, float_t size);

  /// @brief Method DrawAxis, addr 0x592f308, size 0xd8, virtual false, abstract: false, final false
  static inline void DrawAxis(::UnityEngine::Transform* t, float_t size);

  /// @brief Method DrawBox, addr 0x5930388, size 0xf0, virtual false, abstract: false, final false
  static inline void DrawBox(::UnityEngine::Pose pose, float_t width, float_t height, float_t depth, bool isPivotTopSurface);

  /// @brief Method DrawBox, addr 0x592fb10, size 0x878, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawLine, addr 0x592ea20, size 0x160, virtual false, abstract: false, final false
  static inline void DrawLine(::UnityEngine::Vector3 p0, ::UnityEngine::Vector3 p1, ::UnityEngine::Transform* t);

  /// @brief Method DrawPlane, addr 0x592fa3c, size 0xd4, virtual false, abstract: false, final false
  static inline void DrawPlane(::UnityEngine::Pose pose, float_t width, float_t height);

  /// @brief Method DrawPlane, addr 0x592f3e0, size 0x65c, virtual false, abstract: false, final false
  static inline void DrawPlane(::UnityEngine::Vector3 position, ::UnityEngine::Quaternion rotation, float_t width, float_t height);

  /// @brief Method DrawPoint, addr 0x592e8f8, size 0x128, virtual false, abstract: false, final false
  static inline void DrawPoint(::UnityEngine::Vector3 p0, ::UnityEngine::Transform* t);

  /// @brief Method DrawWireCube, addr 0x592eb80, size 0x36c, virtual false, abstract: false, final false
  static inline void DrawWireCube(::UnityEngine::Vector3 center, float_t size, ::UnityEngine::Transform* t);

  /// @brief Method Init, addr 0x592d72c, size 0x88, virtual false, abstract: false, final false
  static inline void Init();

  /// @brief Method LateUpdate, addr 0x592e494, size 0x84, virtual true, abstract: false, final false
  inline void LateUpdate();

  static inline ::Meta::XR::ImmersiveDebugger::Gizmo::DebugGizmos* New_ctor();

  /// @brief Method OnDisable, addr 0x592e078, size 0x80, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x592da64, size 0x114, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RenderSegments, addr 0x592e1f4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5930478, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_RenderSinglePass, addr 0x592e790, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_RenderSinglePass();

  /// @brief Method get_Renderer, addr 0x592db78, size 0xa0, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Gizmo::PolylineRenderer* get_Renderer();

  /// @brief Method get_Root, addr 0x592d7b4, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_RenderSinglePass, addr 0x592e7ec, size 0x10c, virtual false, abstract: false, final false
