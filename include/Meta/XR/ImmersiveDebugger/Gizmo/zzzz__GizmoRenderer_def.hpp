...
/// @brief Method SetUpGizmo, addr 0x58c0120, size 0x10, virtual false, abstract: false, final false
inline void SetUpGizmo(::Meta::XR::ImmersiveDebugger::DebugGizmoType  gizmoType, ::UnityEngine::Color  gizmoColor) ;

/// @brief Method Start, addr 0x58c0138, size 0x64, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x58c019c, size 0xe0, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateDataSource, addr 0x58c0130, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58c0374, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
