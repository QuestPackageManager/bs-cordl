...
public:
  ...
  /// @brief Method Compare, addr 0x5a549cc, size 0x234, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a549c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x5a53a24, size 0xac, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ChooseBestController, addr 0x5a54528, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeControllerState, addr 0x5a54380, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMouseStateFromRaycast, addr 0x5a53e38, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method IsModuleSupported, addr 0x5a53ad8, size 0x8, virtual true, abstract: false, final false
  inline bool IsModuleSupported();

  static inline ::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule* New_ctor();

  /// @brief Method Process, addr 0x5a54450, size 0xd8, virtual true, abstract: false, final false
  inline void Process();

  /// @brief Method Raycast, addr 0x5a53b78, size 0x244, virtual false, abstract: false, final false
  inline bool Raycast(::UnityEngine::EventSystems::PointerEventData* data, ::by_ref<::UnityEngine::EventSystems::RaycastResult> raycast);

  /// @brief Method RegisterRaycaster, addr 0x5a53824, size 0x11c, virtual false, abstract: false, final false
  static inline void RegisterRaycaster(::Meta::XR::ImmersiveDebugger::UserInterface::PanelRaycaster* raycaster);

  /// @brief Method SetDebugInterface, addr 0x5a53a1c, size 0x8, virtual false, abstract: false, final false
  inline void SetDebugInterface(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Interface* debugInterface);

  /// @brief Method ShouldActivateModule, addr 0x5a53ad0, size 0x8, virtual true, abstract: false, final false
  inline bool ShouldActivateModule();

  /// @brief Method UnregisterRaycaster, addr 0x5a53940, size 0xdc, virtual false, abstract: false, final false
  static inline void UnregisterRaycaster(::Meta::XR::ImmersiveDebugger::UserInterface::PanelRaycaster* raycaster);

  /// @brief Method Update, addr 0x5a53ae0, size 0x98, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateRayTransform, addr 0x5a54650, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a54884, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
