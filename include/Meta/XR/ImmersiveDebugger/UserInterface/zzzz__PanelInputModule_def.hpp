...
/// @brief Method Compare, addr 0x58a798c, size 0x234, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x58a7988, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Convert to "::System::Collections::Generic::IComparer_1<::UnityEngine::EventSystems::RaycastResult>"
constexpr ::System::Collections::Generic::IComparer_1<::UnityEngine::EventSystems::RaycastResult>* i___System__Collections__Generic__IComparer_1___UnityEngine__EventSystems__RaycastResult_() noexcept;
...
/// @brief Field _debugInterface, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get__debugInterface, put=__cordl_internal_set__debugInterface)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Interface>  _debugInterface;
...
/// @brief Field _raycasters, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__raycasters, put=setStaticF__raycasters)) ::System::Collections::Generic::List_1<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::PanelRaycaster>>*  _raycasters;

/// @brief Method Awake, addr 0x58a69e4, size 0xac, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method ChooseBestController, addr 0x58a74e8, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method ComputeControllerState, addr 0x58a7340, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method GetMouseStateFromRaycast, addr 0x58a6df8, size 0x548, virtual false, abstract: false, final false
...
/// @brief Method IsModuleSupported, addr 0x58a6a98, size 0x8, virtual true, abstract: false, final false
inline bool IsModuleSupported() ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule* New_ctor() ;

/// @brief Method Process, addr 0x58a7410, size 0xd8, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method Raycast, addr 0x58a6b38, size 0x244, virtual false, abstract: false, final false
inline bool Raycast(::UnityEngine::EventSystems::PointerEventData*  data, ::ByRef<::UnityEngine::EventSystems::RaycastResult>  raycast) ;

/// @brief Method RegisterRaycaster, addr 0x58a67e4, size 0x11c, virtual false, abstract: false, final false
static inline void RegisterRaycaster(::Meta::XR::ImmersiveDebugger::UserInterface::PanelRaycaster*  raycaster) ;

/// @brief Method SetDebugInterface, addr 0x58a69dc, size 0x8, virtual false, abstract: false, final false
inline void SetDebugInterface(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Interface*  debugInterface) ;

/// @brief Method ShouldActivateModule, addr 0x58a6a90, size 0x8, virtual true, abstract: false, final false
inline bool ShouldActivateModule() ;

/// @brief Method UnregisterRaycaster, addr 0x58a6900, size 0xdc, virtual false, abstract: false, final false
static inline void UnregisterRaycaster(::Meta::XR::ImmersiveDebugger::UserInterface::PanelRaycaster*  raycaster) ;

/// @brief Method Update, addr 0x58a6aa0, size 0x98, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateRayTransform, addr 0x58a7610, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58a7844, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
