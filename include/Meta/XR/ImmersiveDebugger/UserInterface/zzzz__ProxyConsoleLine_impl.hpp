...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry* (::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine::get_Entry)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x589e220;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*>::get(),
                        "get_Entry",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine::*)(::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*)>(&::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine::set_Entry)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x589e228;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine::Fill)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine::_ctor)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x589e280;
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____Entry_k__BackingField)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*>());
}
// Ctor Parameters []
