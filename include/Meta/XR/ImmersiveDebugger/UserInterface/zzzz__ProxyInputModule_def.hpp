...
/// @brief Method Refresh, addr 0x58a81e8, size 0xb8, virtual false, abstract: false, final false
inline bool Refresh() ;

/// @brief Method SearchForEventSystem, addr 0x58a82a0, size 0xf4, virtual false, abstract: false, final false
inline void SearchForEventSystem() ;

/// @brief Method SetupEventSystem, addr 0x58a8394, size 0xdc, virtual false, abstract: false, final false
inline void SetupEventSystem(::UnityEngine::EventSystems::EventSystem*  eventSystem) ;

/// @brief Method SetupInputModule, addr 0x58a8470, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58a81e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::GameObject*  owner, ::GlobalNamespace::OVRCursor*  cursor) ;

/// @brief Method get_InputModule, addr 0x58a81d0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::PanelInputModule> get_InputModule() ;

/// @brief Method set_InputModule, addr 0x58a81d8, size 0x8, virtual false, abstract: false, final false
