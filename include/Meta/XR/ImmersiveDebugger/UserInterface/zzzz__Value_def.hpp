...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Value*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Value*, "Meta.XR.ImmersiveDebugger.UserInterface", "Value");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Value) == 0x88, "Size mismatch!");
