...
/// @brief Method OnTransparencyChanged, addr 0x58a87d0, size 0xc, virtual true, abstract: false, final false
inline void OnTransparencyChanged() ;

/// @brief Method RefreshStyle, addr 0x58a8544, size 0xc, virtual false, abstract: false, final false
inline void RefreshStyle() ;

/// @brief Method Setup, addr 0x58a8568, size 0x13c, virtual true, abstract: false, final false
inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  owner) ;

/// @brief Method UpdateBackground, addr 0x58a86a4, size 0x12c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58a8834, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Background, addr 0x58a8534, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Background> get_Background() ;

/// @brief Method get_Content, addr 0x58a87dc, size 0x2c, virtual true, abstract: false, final false
inline ::StringW get_Content() ;

/// @brief Method get_Label, addr 0x58a853c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Label> get_Label() ;

/// @brief Method get_TextStyle, addr 0x58a8550, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::TextStyle> get_TextStyle() ;

/// @brief Method set_BackgroundStyle, addr 0x58a5450, size 0x88, virtual false, abstract: false, final false
inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  value) ;

/// @brief Method set_Content, addr 0x58a8808, size 0x2c, virtual true, abstract: false, final false
inline void set_Content(::StringW  value) ;

/// @brief Method set_TextStyle, addr 0x58a5438, size 0x18, virtual false, abstract: false, final false
