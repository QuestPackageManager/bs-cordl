...
/// @brief Method <RemoveLogEntry>b__0, addr 0x589d600, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x589c900, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <MaximumNumberOfLogEntries>k__BackingField, offset 0x194, size 0x4 
 __declspec(property(get=__cordl_internal_get__MaximumNumberOfLogEntries_k__BackingField, put=__cordl_internal_set__MaximumNumberOfLogEntries_k__BackingField)) int32_t  _MaximumNumberOfLogEntries_k__BackingField;

/// @brief Field _allEntries, offset 0x128, size 0x8 
 __declspec(property(get=__cordl_internal_get__allEntries, put=__cordl_internal_set__allEntries)) ::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*>*  _allEntries;
...
/// @brief Field _entries, offset 0x120, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*>*  _entries;

/// @brief Field _entryMap, offset 0x130, size 0x8 
 __declspec(property(get=__cordl_internal_get__entryMap, put=__cordl_internal_set__entryMap)) ::System::Collections::Generic::Dictionary_2<int32_t,::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*>*  _entryMap;
...
/// @brief Field _logDetailPaneBackground, offset 0x180, size 0x8 
 __declspec(property(get=__cordl_internal_get__logDetailPaneBackground, put=__cordl_internal_set__logDetailPaneBackground)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Background>  _logDetailPaneBackground;

/// @brief Field _logDetailPaneBackgroundImageStyle, offset 0x188, size 0x8 
 __declspec(property(get=__cordl_internal_get__logDetailPaneBackgroundImageStyle, put=__cordl_internal_set__logDetailPaneBackgroundImageStyle)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle>  _logDetailPaneBackgroundImageStyle;

/// @brief Field _logDetailPaneCloseBtn, offset 0x158, size 0x8 
 __declspec(property(get=__cordl_internal_get__logDetailPaneCloseBtn, put=__cordl_internal_set__logDetailPaneCloseBtn)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonWithIcon>  _logDetailPaneCloseBtn;

/// @brief Field _proxyFlex, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get__proxyFlex, put=__cordl_internal_set__proxyFlex)) ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyFlex_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::ConsoleLine>,::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*>*  _proxyFlex;
...
/// @brief Field _scrollViewLogDetails, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get__scrollViewLogDetails, put=__cordl_internal_set__scrollViewLogDetails)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollView>  _scrollViewLogDetails;

/// @brief Field _severities, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get__severities, put=__cordl_internal_set__severities)) ::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry*>*  _severities;

/// @brief Field _severitiesPerType, offset 0x118, size 0x8 
 __declspec(property(get=__cordl_internal_get__severitiesPerType, put=__cordl_internal_set__severitiesPerType)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::LogType,::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry*>*  _severitiesPerType;
...
/// @brief Method AppendToProxyFlex, addr 0x589c874, size 0x8c, virtual false, abstract: false, final false
inline void AppendToProxyFlex(::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*  entry) ;

/// @brief Method Clear, addr 0x589cce0, size 0x2a4, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeLogHash, addr 0x589c5d4, size 0xe8, virtual false, abstract: false, final false
static inline int32_t ComputeLogHash(::StringW  content, ::StringW  stackTrace) ;

/// @brief Method EnqueueLogEntry, addr 0x589c2b8, size 0x31c, virtual false, abstract: false, final false
inline void EnqueueLogEntry(::StringW  logString, ::StringW  stackTrace, ::UnityEngine::LogType  type) ;

/// @brief Method FlattenEntries, addr 0x589c0c4, size 0x1f4, virtual false, abstract: false, final false
inline void FlattenEntries() ;

/// @brief Method GetSeverity, addr 0x589a19c, size 0x7c, virtual false, abstract: false, final false
inline ::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry* GetSeverity(::UnityEngine::LogType  logType) ;

/// @brief Method HideLogDetailsPanel, addr 0x589b880, size 0x84, virtual false, abstract: false, final false
inline void HideLogDetailsPanel() ;

/// @brief Method MergeEntries, addr 0x589bdd0, size 0x2f4, virtual false, abstract: false, final false
inline void MergeEntries() ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Console* New_ctor() ;

/// @brief Method OnConsoleLineClicked, addr 0x589d0b4, size 0x100, virtual false, abstract: false, final false
inline void OnConsoleLineClicked(::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*  entry) ;

/// @brief Method OnDisable, addr 0x589bacc, size 0x11c, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x589b904, size 0x1c8, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransparencyChanged, addr 0x589bbe8, size 0x80, virtual true, abstract: false, final false
inline void OnTransparencyChanged() ;

/// @brief Method RefreshAllEntries, addr 0x589c9f8, size 0x1bc, virtual false, abstract: false, final false
inline void RefreshAllEntries() ;

/// @brief Method RegisterControl, addr 0x589b4ac, size 0x224, virtual false, abstract: false, final false
...
/// @brief Method RegisterCount, addr 0x589bc68, size 0x100, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Label> RegisterCount() ;

/// @brief Method RemoveLogEntry, addr 0x589c6bc, size 0x14c, virtual false, abstract: false, final false
inline void RemoveLogEntry(::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*  logEntry) ;

/// @brief Method ResetLogCount, addr 0x589cfb4, size 0x100, virtual false, abstract: false, final false
inline void ResetLogCount() ;

/// @brief Method SetPanelPosition, addr 0x589d2c4, size 0x144, virtual false, abstract: false, final false
inline void SetPanelPosition(::Meta::XR::ImmersiveDebugger::RuntimeSettings_DistanceOption  distanceOption, bool  skipAnimation) ;

/// @brief Method Setup, addr 0x589a2d4, size 0xe8c, virtual true, abstract: false, final false
inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  owner) ;

/// @brief Method ShowLogDetailsPanel, addr 0x589d1b4, size 0x90, virtual false, abstract: false, final false
inline void ShowLogDetailsPanel() ;

/// @brief Method ToggleCollapseMode, addr 0x589bd68, size 0x68, virtual false, abstract: false, final false
inline void ToggleCollapseMode() ;

/// @brief Method Update, addr 0x589c904, size 0xf4, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyFlex_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::ConsoleLine>,::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*>* const& __cordl_internal_get__proxyFlex() const;

constexpr ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyFlex_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::ConsoleLine>,::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*>*& __cordl_internal_get__proxyFlex() ;
...
constexpr void __cordl_internal_set__proxyFlex(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyFlex_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::ConsoleLine>,::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*>*  value) ;
...
/// @brief Method .ctor, addr 0x589d408, size 0x1dc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Dirty, addr 0x589a18c, size 0x8, virtual false, abstract: false, final false
inline bool get_Dirty() ;

/// @brief Method get_LogCollapseMode, addr 0x589a218, size 0x8, virtual false, abstract: false, final false
inline bool get_LogCollapseMode() ;

/// @brief Method get_MaximumNumberOfLogEntries, addr 0x589a228, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaximumNumberOfLogEntries() ;

/// @brief Method set_Dirty, addr 0x589a194, size 0x8, virtual false, abstract: false, final false
inline void set_Dirty(bool  value) ;

/// @brief Method set_LogCollapseMode, addr 0x589a220, size 0x8, virtual false, abstract: false, final false
inline void set_LogCollapseMode(bool  value) ;

/// @brief Method set_LogDetailBackgroundStyle, addr 0x589a238, size 0x9c, virtual false, abstract: false, final false
inline void set_LogDetailBackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  value) ;

/// @brief Method set_MaximumNumberOfLogEntries, addr 0x589a230, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _proxyFlex, offset: 0xf8, size: 0x8, def value: None
 ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyFlex_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::ConsoleLine>,::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*>*  ____proxyFlex;
