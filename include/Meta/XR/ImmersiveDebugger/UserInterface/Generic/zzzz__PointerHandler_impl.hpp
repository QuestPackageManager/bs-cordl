...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::InteractableController> (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::get_Controller)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5925134;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler*>::get(),
                        "get_Controller",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::*)(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::InteractableController*)>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::set_Controller)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x592513c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "set_Controller",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::InteractableController*>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::*)(::UnityEngine::EventSystems::PointerEventData*)>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::OnPointerClick)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x5925144;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::*)(::UnityEngine::EventSystems::PointerEventData*)>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::OnPointerEnter)> {
  constexpr static std::size_t size = 0xd4;
  constexpr static std::size_t addrs = 0x5925208;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::*)(::UnityEngine::EventSystems::PointerEventData*)>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::OnPointerExit)> {
  constexpr static std::size_t size = 0xd0;
  constexpr static std::size_t addrs = 0x59252dc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x59253ac;
...
constexpr ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::InteractableController>& Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::__cordl_internal_get__Controller_k__BackingField()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____Controller_k__BackingField;
}
constexpr ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::InteractableController> const& Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::__cordl_internal_get__Controller_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____Controller_k__BackingField;
}
constexpr void Meta::XR::ImmersiveDebugger::UserInterface::Generic::PointerHandler::__cordl_internal_set__Controller_k__BackingField(::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::InteractableController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
