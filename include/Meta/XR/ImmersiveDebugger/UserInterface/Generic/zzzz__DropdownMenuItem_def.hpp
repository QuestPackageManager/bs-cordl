...
public:
  ...
  /// @brief Method OnPointerClick, addr 0x591e494, size 0x28, virtual true, abstract: false, final false
  inline void OnPointerClick();

  /// @brief Method RegisterDropdownSourceMenu, addr 0x591e48c, size 0x8, virtual false, abstract: false, final false
  inline void RegisterDropdownSourceMenu(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Dropdown* dropdown);

  /// @brief Method Setup, addr 0x591e364, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591e4bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
