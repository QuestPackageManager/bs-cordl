...
public:
  ...
  /// @brief Method Setup, addr 0x58acdd4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58ace60, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_RawImage, addr 0x58acd48, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::RawImage> get_RawImage();

  /// @brief Method get_Texture, addr 0x58acd50, size 0x6c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_Texture();

  /// @brief Method set_Color, addr 0x58aa788, size 0x20, virtual false, abstract: false, final false
  inline void set_Color(::UnityEngine::Color value);

  /// @brief Method set_RaycastTarget, addr 0x58aa7a8, size 0x24, virtual false, abstract: false, final false
  inline void set_RaycastTarget(bool value);

  /// @brief Method set_Texture, addr 0x58acdbc, size 0x18, virtual true, abstract: false, final false
