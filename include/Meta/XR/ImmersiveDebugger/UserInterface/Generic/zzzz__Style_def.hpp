...
public:
  ...
  /// @brief Method .ctor, addr 0x584ae28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Instantiated, addr 0x584af30, size 0x8, virtual false, abstract: false, final false
