...
/// @brief Method .ctor, addr 0x58b1a98, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Instantiated, addr 0x58b1ba0, size 0x8, virtual false, abstract: false, final false
