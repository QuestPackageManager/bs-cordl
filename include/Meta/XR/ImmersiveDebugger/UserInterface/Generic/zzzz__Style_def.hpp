...
public:
  ...
  /// @brief Method .ctor, addr 0x5923a04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Instantiated, addr 0x5923b0c, size 0x8, virtual false, abstract: false, final false
