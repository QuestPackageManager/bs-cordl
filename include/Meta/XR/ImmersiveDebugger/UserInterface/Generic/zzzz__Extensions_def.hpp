...
public:
  // Declarations
  /// @brief Method SetSizeOptimized, addr 0x5a55cdc, size 0x124, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Extensions) == 0x10, "Size mismatch!");
