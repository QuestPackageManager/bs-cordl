...
public:
  ...
  /// @brief Method OnHoverChanged, addr 0x58aabc8, size 0x20, virtual true, abstract: false, final false
  inline void OnHoverChanged();

  /// @brief Method OnTransparencyChanged, addr 0x58aabe8, size 0x8c, virtual true, abstract: false, final false
  inline void OnTransparencyChanged();

  /// @brief Method RefreshStyle, addr 0x58aa934, size 0xc, virtual false, abstract: false, final false
  inline void RefreshStyle();

  /// @brief Method Setup, addr 0x58aaa84, size 0x144, virtual true, abstract: false, final false
  inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller* owner);

  /// @brief Method UpdateBackground, addr 0x58aac74, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58aadf0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Background, addr 0x58aa8a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Background> get_Background();

  /// @brief Method get_Label, addr 0x58aa9ec, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Label();

  /// @brief Method set_BackgroundStyle, addr 0x58aa8ac, size 0x88, virtual false, abstract: false, final false
  inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle* value);

  /// @brief Method set_Label, addr 0x58aaa38, size 0x2c, virtual false, abstract: false, final false
  inline void set_Label(::StringW value);

  /// @brief Method set_LabelLayoutStyle, addr 0x58aa9d4, size 0x18, virtual false, abstract: false, final false
  inline void set_LabelLayoutStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle* value);

  /// @brief Method set_TextStyle, addr 0x58aa940, size 0x14, virtual false, abstract: false, final false
