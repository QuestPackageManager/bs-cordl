...
/// @brief Field _childrenLayoutStyle, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__childrenLayoutStyle, put=__cordl_internal_set__childrenLayoutStyle)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle>  _childrenLayoutStyle;
...
/// @brief Field _targetsDictionary, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__targetsDictionary, put=__cordl_internal_set__targetsDictionary)) ::System::Collections::Generic::Dictionary_2<ControllerType,::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyController_1<ControllerType>*>*  _targetsDictionary;
...
static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyFlex_2<ControllerType,ProxyControllerType>* New_ctor(int32_t  numberOfInstantiatedControllers, int32_t  maximumNumberOfProxies, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle*  layoutStyle, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollView*  scrollView) ;
...
constexpr ::System::Collections::Generic::Dictionary_2<ControllerType,::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyController_1<ControllerType>*>* const& __cordl_internal_get__targetsDictionary() const;

constexpr ::System::Collections::Generic::Dictionary_2<ControllerType,::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyController_1<ControllerType>*>*& __cordl_internal_get__targetsDictionary() ;
...
constexpr void __cordl_internal_set__targetsDictionary(::System::Collections::Generic::Dictionary_2<ControllerType,::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ProxyController_1<ControllerType>*>*  value) ;

/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(int32_t  numberOfInstantiatedControllers, int32_t  maximumNumberOfProxies, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle*  layoutStyle, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollView*  scrollView) ;
