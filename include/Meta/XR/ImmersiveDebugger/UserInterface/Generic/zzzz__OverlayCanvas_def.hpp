...
public:
  ...
  /// @brief Method Init, addr 0x5a5d3b0, size 0x88, virtual false, abstract: false, final false
  static inline void Init();

  static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvas* New_ctor();

  /// @brief Method OnDestroy, addr 0x5a5df04, size 0x78, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5a5e074, size 0xf8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5a5df7c, size 0xf8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ShouldRender, addr 0x5a5e16c, size 0x194, virtual false, abstract: false, final false
  inline bool ShouldRender(::UnityEngine::Camera* baseCamera);

  /// @brief Method Start, addr 0x5a5d448, size 0xabc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5a5e300, size 0x45c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5a5e75c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::UnityEngine::Plane> getStaticF_FrustumPlanes();

  /// @brief Method get_Panel, addr 0x5a5d438, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Panel, addr 0x5a5d440, size 0x8, virtual false, abstract: false, final false
