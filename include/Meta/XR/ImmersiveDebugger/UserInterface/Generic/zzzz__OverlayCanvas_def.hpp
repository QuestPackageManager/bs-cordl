...
/// @brief Field <Panel>k__BackingField, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__Panel_k__BackingField, put=__cordl_internal_set__Panel_k__BackingField)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvasPanel>  _Panel_k__BackingField;
...
/// @brief Method Init, addr 0x58b0370, size 0x88, virtual false, abstract: false, final false
static inline void Init() ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvas* New_ctor() ;

/// @brief Method OnDestroy, addr 0x58b0ec4, size 0x78, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x58b1034, size 0xf8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x58b0f3c, size 0xf8, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ShouldRender, addr 0x58b112c, size 0x194, virtual false, abstract: false, final false
inline bool ShouldRender(::UnityEngine::Camera*  baseCamera) ;

/// @brief Method Start, addr 0x58b0408, size 0xabc, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x58b12c0, size 0x45c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x58b171c, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<::UnityEngine::Plane,::Array<::UnityEngine::Plane>*> getStaticF_FrustumPlanes() ;

/// @brief Method get_Panel, addr 0x58b03f8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Panel, addr 0x58b0400, size 0x8, virtual false, abstract: false, final false
