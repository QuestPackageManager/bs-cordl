...
public:
  ...
  /// @brief Method Init, addr 0x59222dc, size 0x88, virtual false, abstract: false, final false
  static inline void Init();

  static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvas* New_ctor();

  /// @brief Method OnDestroy, addr 0x5922e30, size 0x78, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5922fa0, size 0xf8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5922ea8, size 0xf8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ShouldRender, addr 0x5923098, size 0x194, virtual false, abstract: false, final false
  inline bool ShouldRender(::UnityEngine::Camera* baseCamera);

  /// @brief Method Start, addr 0x5922374, size 0xabc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x592322c, size 0x45c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5923688, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::UnityEngine::Plane, ::Array<::UnityEngine::Plane>*> getStaticF_FrustumPlanes();

  /// @brief Method get_Panel, addr 0x5922364, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Panel, addr 0x592236c, size 0x8, virtual false, abstract: false, final false
