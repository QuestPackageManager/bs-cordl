...
/// @brief Method Init, addr 0x58ad970, size 0x4c, virtual false, abstract: false, final false
static inline void Init() ;

/// @brief Method LateUpdate, addr 0x58ae1e8, size 0x18, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Panel* New_ctor() ;

/// @brief Method OnDisable, addr 0x58ae25c, size 0x84, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x58ae200, size 0x5c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnHoverChanged, addr 0x58adeec, size 0x48, virtual true, abstract: false, final false
inline void OnHoverChanged() ;

/// @brief Method OnTransparencyChanged, addr 0x58ade78, size 0x74, virtual true, abstract: false, final false
inline void OnTransparencyChanged() ;

/// @brief Method RefreshCanvas, addr 0x58ae010, size 0xcc, virtual false, abstract: false, final false
inline void RefreshCanvas() ;

/// @brief Method RefreshRaycaster, addr 0x58ae0f4, size 0xf4, virtual false, abstract: false, final false
inline void RefreshRaycaster() ;

/// @brief Method SetExpectedPixelsPerUnit, addr 0x58adde4, size 0x94, virtual false, abstract: false, final false
inline void SetExpectedPixelsPerUnit(float_t  pixelsPerUnit, float_t  dynamicPixelsPerUnit, float_t  referencePixelsPerUnit) ;

/// @brief Method SetPosition, addr 0x58adc1c, size 0xe0, virtual false, abstract: false, final false
inline void SetPosition(::UnityEngine::Vector3  position) ;

/// @brief Method Setup, addr 0x58ad7dc, size 0x15c, virtual true, abstract: false, final false
inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  owner) ;

/// @brief Method SphericalToCartesian, addr 0x58adbac, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58ad954, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::GlobalNamespace::OVRHapticsClip* getStaticF__hapticsClip() ;

/// @brief Method get_HapticsClip, addr 0x58ad9bc, size 0x158, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRHapticsClip* get_HapticsClip() ;

/// @brief Method get_Interface, addr 0x58adcfc, size 0x80, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Interface> get_Interface() ;

/// @brief Method get_PixelsPerUnit, addr 0x58adb14, size 0x8, virtual false, abstract: false, final false
inline float_t get_PixelsPerUnit() ;

/// @brief Method get_SphericalCoordinates, addr 0x58adb24, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_BackgroundStyle, addr 0x58add7c, size 0x68, virtual false, abstract: false, final false
inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  value) ;

/// @brief Method set_PixelsPerUnit, addr 0x58adb1c, size 0x8, virtual false, abstract: false, final false
inline void set_PixelsPerUnit(float_t  value) ;

/// @brief Method set_SphericalCoordinates, addr 0x58adb30, size 0x7c, virtual false, abstract: false, final false
