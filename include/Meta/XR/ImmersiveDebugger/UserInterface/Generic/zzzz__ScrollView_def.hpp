...
public:
  ...
  /// @brief Method RefreshLayoutPostChildren, addr 0x59203f8, size 0x3c, virtual true, abstract: false, final false
  inline void RefreshLayoutPostChildren();

  /// @brief Method RefreshLayoutPreChildren, addr 0x59203c8, size 0x30, virtual true, abstract: false, final false
  inline void RefreshLayoutPreChildren();

  /// @brief Method Setup, addr 0x5920288, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5920434, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Flex, addr 0x5920270, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> get_Flex();

  /// @brief Method get_Progress, addr 0x591e304, size 0x18, virtual false, abstract: false, final false
  inline float_t get_Progress();

  /// @brief Method get_ScrollRect, addr 0x5920268, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::ScrollRect> get_ScrollRect();

  /// @brief Method set_Progress, addr 0x591e2e0, size 0x24, virtual false, abstract: false, final false
