...
/// @brief Method RefreshLayoutPostChildren, addr 0x58ae48c, size 0x3c, virtual true, abstract: false, final false
inline void RefreshLayoutPostChildren() ;

/// @brief Method RefreshLayoutPreChildren, addr 0x58ae45c, size 0x30, virtual true, abstract: false, final false
inline void RefreshLayoutPreChildren() ;

/// @brief Method Setup, addr 0x58ae31c, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58ae4c8, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Flex, addr 0x58ae304, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> get_Flex() ;

/// @brief Method get_Progress, addr 0x58ac398, size 0x18, virtual false, abstract: false, final false
inline float_t get_Progress() ;

/// @brief Method get_ScrollRect, addr 0x58ae2fc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::ScrollRect> get_ScrollRect() ;

/// @brief Method set_Progress, addr 0x58ac374, size 0x24, virtual false, abstract: false, final false
