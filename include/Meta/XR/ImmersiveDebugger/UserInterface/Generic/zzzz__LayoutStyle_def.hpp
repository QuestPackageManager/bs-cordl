...
public:
  ...
  /// @brief Method SetHeight, addr 0x5923a5c, size 0x28, virtual false, abstract: false, final false
  inline bool SetHeight(float_t height);

  /// @brief Method SetIndent, addr 0x5923aac, size 0x40, virtual false, abstract: false, final false
  inline bool SetIndent(float_t value);

  /// @brief Method SetWidth, addr 0x5923a84, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5923aec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BottomMargin, addr 0x5923a38, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_BottomMargin();

  /// @brief Method get_BottomRightMargin, addr 0x591e524, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_BottomRightMargin();

  /// @brief Method get_LeftMargin, addr 0x5923a0c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_LeftMargin();

  /// @brief Method get_RightMargin, addr 0x5923a1c, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_RightMargin();

  /// @brief Method get_TopLeftMargin, addr 0x5923a54, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_TopLeftMargin();

  /// @brief Method get_TopMargin, addr 0x5923a14, size 0x8, virtual false, abstract: false, final false
