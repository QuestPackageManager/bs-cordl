...
public:
  ...
  /// @brief Method Attach, addr 0x5a5af74, size 0xdc, virtual false, abstract: false, final false
  inline void Attach(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Panel* panel);

  /// @brief Method Awake, addr 0x5a5cf98, size 0x1f4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LateUpdate, addr 0x5a5d210, size 0x194, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Cursor* New_ctor();

  /// @brief Method SetClickState, addr 0x5a5d1f0, size 0x20, virtual false, abstract: false, final false
  inline void SetClickState(::UnityEngine::EventSystems::PointerEventData_FramePressState state);

  /// @brief Method SetCursorRay, addr 0x5a5d1b0, size 0x40, virtual true, abstract: false, final false
  inline void SetCursorRay(::UnityEngine::Transform* t);

  /// @brief Method SetCursorStartDest, addr 0x5a5d18c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a5d3a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GameObject, addr 0x5a5cf78, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_GameObject();

  /// @brief Method get_Transform, addr 0x5a5cf88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_Transform();

  /// @brief Method set_GameObject, addr 0x5a5cf80, size 0x8, virtual false, abstract: false, final false
  inline void set_GameObject(::UnityEngine::GameObject* value);

  /// @brief Method set_Transform, addr 0x5a5cf90, size 0x8, virtual false, abstract: false, final false
