...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "ImageStyle");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ImageStyle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ImageStyle(ImageStyle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ImageStyle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ImageStyle(ImageStyleconst&) = delete;
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle) == 0x68, "Size mismatch!");
