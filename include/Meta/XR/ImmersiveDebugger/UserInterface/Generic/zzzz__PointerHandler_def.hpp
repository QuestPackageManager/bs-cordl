...
/// @brief Field <Controller>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__Controller_k__BackingField, put=__cordl_internal_set__Controller_k__BackingField)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::InteractableController>  _Controller_k__BackingField;
...
/// @brief Method OnPointerClick, addr 0x58b1808, size 0xc4, virtual true, abstract: false, final true
inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnPointerEnter, addr 0x58b18cc, size 0xd4, virtual true, abstract: false, final true
inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnPointerExit, addr 0x58b19a0, size 0xd0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x58b1a70, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Controller, addr 0x58b17f8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Controller, addr 0x58b1800, size 0x8, virtual false, abstract: false, final false
