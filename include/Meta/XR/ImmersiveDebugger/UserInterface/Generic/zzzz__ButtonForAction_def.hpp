...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ButtonForAction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ButtonForAction(ButtonForAction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ButtonForAction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ButtonForAction(ButtonForActionconst&) = delete;
