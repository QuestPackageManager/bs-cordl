...
public:
  ...
  /// @brief Method .ctor, addr 0x591abfc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Action, addr 0x591abf4, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Manager::ActionHook* get_Action();

  /// @brief Method set_Action, addr 0x591779c, size 0x1c, virtual false, abstract: false, final false
