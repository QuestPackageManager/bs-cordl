...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonForAction*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonForAction*, "Meta.XR.ImmersiveDebugger.UserInterface.Generic", "ButtonForAction");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a55cd0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Action, addr 0x5a55cc8, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Manager::ActionHook* get_Action();

  /// @brief Method set_Action, addr 0x5a52870, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonForAction) == 0xa8, "Size mismatch!");
