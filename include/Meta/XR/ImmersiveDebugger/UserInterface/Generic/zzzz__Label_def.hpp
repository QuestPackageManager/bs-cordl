...
public:
  ...
  /// @brief Method Setup, addr 0x591f5a8, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591f698, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Content, addr 0x591ce90, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_Content();

  /// @brief Method get_Text, addr 0x591f598, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Text> get_Text();

  /// @brief Method get_TextStyle, addr 0x591f690, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::TextStyle> get_TextStyle();

  /// @brief Method set_Content, addr 0x591cedc, size 0x20, virtual false, abstract: false, final false
  inline void set_Content(::StringW value);

  /// @brief Method set_Text, addr 0x591f5a0, size 0x8, virtual false, abstract: false, final false
  inline void set_Text(::UnityEngine::UI::Text* value);

  /// @brief Method set_TextStyle, addr 0x591cdcc, size 0x80, virtual false, abstract: false, final false
