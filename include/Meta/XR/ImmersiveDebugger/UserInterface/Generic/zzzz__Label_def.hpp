...
/// @brief Method Setup, addr 0x58ad63c, size 0xe8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58ad72c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Content, addr 0x58aaf24, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_Content() ;

/// @brief Method get_Text, addr 0x58ad62c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Text> get_Text() ;

/// @brief Method get_TextStyle, addr 0x58ad724, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::TextStyle> get_TextStyle() ;

/// @brief Method set_Content, addr 0x58aaf70, size 0x20, virtual false, abstract: false, final false
inline void set_Content(::StringW  value) ;

/// @brief Method set_Text, addr 0x58ad634, size 0x8, virtual false, abstract: false, final false
inline void set_Text(::UnityEngine::UI::Text*  value) ;

/// @brief Method set_TextStyle, addr 0x58aae60, size 0x80, virtual false, abstract: false, final false
