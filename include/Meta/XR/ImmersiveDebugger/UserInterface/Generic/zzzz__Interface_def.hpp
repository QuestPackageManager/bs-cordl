...
/// @brief Field <Cursor>k__BackingField, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__Cursor_k__BackingField, put=__cordl_internal_set__Cursor_k__BackingField)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Cursor>  _Cursor_k__BackingField;
...
/// @brief Method Awake, addr 0x58afb44, size 0x130, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method LateUpdate, addr 0x58afed0, size 0x58, virtual true, abstract: false, final false
inline void LateUpdate() ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Interface* New_ctor() ;

/// @brief Method RefreshLayoutPreChildren, addr 0x58aff28, size 0x4, virtual true, abstract: false, final false
inline void RefreshLayoutPreChildren() ;

/// @brief Method SetBits, addr 0x58afeac, size 0x24, virtual false, abstract: false, final false
static inline int32_t SetBits(int32_t  cullingMask, int32_t  bitPosition1, int32_t  bitPosition2, bool  state) ;

/// @brief Method UpdateCulling, addr 0x58afdd8, size 0xd4, virtual false, abstract: false, final false
inline void UpdateCulling() ;

/// @brief Method UpdateTransform, addr 0x58afc74, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58aff2c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Camera, addr 0x58ae0dc, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_Camera() ;

/// @brief Method get_Cursor, addr 0x58afb14, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Cursor> get_Cursor() ;

/// @brief Method get_FollowOverride, addr 0x58afb24, size 0x8, virtual true, abstract: false, final false
inline bool get_FollowOverride() ;

/// @brief Method get_RotateOverride, addr 0x58afb34, size 0x8, virtual true, abstract: false, final false
inline bool get_RotateOverride() ;

/// @brief Method set_Cursor, addr 0x58afb1c, size 0x8, virtual false, abstract: false, final false
inline void set_Cursor(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Cursor*  value) ;

/// @brief Method set_FollowOverride, addr 0x58afb2c, size 0x8, virtual true, abstract: false, final false
inline void set_FollowOverride(bool  value) ;

/// @brief Method set_RotateOverride, addr 0x58afb3c, size 0x8, virtual true, abstract: false, final false
