...
/// @brief Method Setup, addr 0x58ae4dc, size 0x1b8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58ae694, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Flex, addr 0x58ae4d4, size 0x8, virtual false, abstract: false, final false
