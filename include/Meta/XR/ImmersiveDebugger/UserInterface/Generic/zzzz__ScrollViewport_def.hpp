...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScrollViewport", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScrollViewport(ScrollViewport&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScrollViewport", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScrollViewport(ScrollViewportconst&) = delete;
