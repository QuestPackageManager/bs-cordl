...
public:
  ...
  /// @brief Method Setup, addr 0x5920448, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5920600, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Flex, addr 0x5920440, size 0x8, virtual false, abstract: false, final false
