...
public:
  ...
  /// @brief Method OnStateChanged, addr 0x5920db8, size 0x5c, virtual false, abstract: false, final false
  inline void OnStateChanged();

  /// @brief Method SetToggleIcons, addr 0x5920e68, size 0x8, virtual false, abstract: false, final false
  inline void SetToggleIcons(::UnityEngine::Texture2D* onState, ::UnityEngine::Texture2D* offState);

  /// @brief Method Start, addr 0x5920e24, size 0x44, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateIcon, addr 0x5920e70, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5920fdc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_State, addr 0x5920cd0, size 0xac, virtual false, abstract: false, final false
  inline bool get_State();

  /// @brief Method get_StateChanged, addr 0x5920e14, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<bool>* get_StateChanged();

  /// @brief Method get_Tweak, addr 0x5920cc0, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Manager::Tweak* get_Tweak();

  /// @brief Method set_State, addr 0x5920d7c, size 0x3c, virtual false, abstract: false, final false
  inline void set_State(bool value);

  /// @brief Method set_StateChanged, addr 0x5920e1c, size 0x8, virtual false, abstract: false, final false
  inline void set_StateChanged(::System::Action_1<bool>* value);

  /// @brief Method set_Tweak, addr 0x5920cc8, size 0x8, virtual false, abstract: false, final false
