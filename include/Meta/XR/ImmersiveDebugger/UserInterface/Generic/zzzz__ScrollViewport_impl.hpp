...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport::get_Flex)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x58ae4d4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport*>::get(),
                        "get_Flex",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport::*)(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*)>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport::Setup)> {
  constexpr static std::size_t size = 0x1b8;
  constexpr static std::size_t addrs = 0x58ae4dc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollViewport::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x58ae694;
