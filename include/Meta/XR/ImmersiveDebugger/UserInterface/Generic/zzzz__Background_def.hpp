...
public:
  ...
  /// @brief Method Setup, addr 0x5a57230, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a572d0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Color, addr 0x5a571b8, size 0x20, virtual false, abstract: false, final false
  inline void set_Color(::UnityEngine::Color value);

  /// @brief Method set_PixelDensityMultiplier, addr 0x5a571d8, size 0x34, virtual false, abstract: false, final false
  inline void set_PixelDensityMultiplier(float_t value);

  /// @brief Method set_RaycastTarget, addr 0x5a5720c, size 0x24, virtual false, abstract: false, final false
  inline void set_RaycastTarget(bool value);

  /// @brief Method set_Sprite, addr 0x5a571a0, size 0x18, virtual false, abstract: false, final false
