...
public:
  ...
  /// @brief Method Setup, addr 0x5a59530, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a595d0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Color, addr 0x5a594b8, size 0x20, virtual false, abstract: false, final false
  inline void set_Color(::UnityEngine::Color value);

  /// @brief Method set_PixelDensityMultiplier, addr 0x5a594d8, size 0x34, virtual false, abstract: false, final false
  inline void set_PixelDensityMultiplier(float_t value);

  /// @brief Method set_RaycastTarget, addr 0x5a5950c, size 0x24, virtual false, abstract: false, final false
  inline void set_RaycastTarget(bool value);

  /// @brief Method set_Sprite, addr 0x5a594a0, size 0x18, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Background", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Background(Background&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Background", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Background(Backgroundconst&) = delete;
