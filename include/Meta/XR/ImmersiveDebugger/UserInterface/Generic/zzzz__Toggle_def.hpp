...
public:
  ...
  /// @brief Method OnStateChanged, addr 0x5a5c578, size 0x48, virtual false, abstract: false, final false
  inline void OnStateChanged();

  /// @brief Method ToggleState, addr 0x5a5c5c0, size 0x10, virtual false, abstract: false, final false
  inline void ToggleState();

  /// @brief Method UpdateBackground, addr 0x5a5c5e0, size 0x164, virtual true, abstract: false, final false
  inline void UpdateBackground();

  /// @brief Method UpdateIcon, addr 0x5a5c744, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a5c900, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_State, addr 0x5a5c554, size 0x8, virtual false, abstract: false, final false
  inline bool get_State();

  /// @brief Method get_StateChanged, addr 0x5a5c5d0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<bool>* get_StateChanged();

  /// @brief Method set_State, addr 0x5a5c55c, size 0x1c, virtual false, abstract: false, final false
  inline void set_State(bool value);

  /// @brief Method set_StateChanged, addr 0x5a5c5d8, size 0x8, virtual false, abstract: false, final false
