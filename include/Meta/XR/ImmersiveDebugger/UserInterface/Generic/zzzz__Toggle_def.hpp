...
// Write type traits
MARK_REF_PTR_T(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle);
...
public:
  ...
  /// @brief Method OnStateChanged, addr 0x58af02c, size 0x48, virtual false, abstract: false, final false
  inline void OnStateChanged();

  /// @brief Method ToggleState, addr 0x58af074, size 0x10, virtual false, abstract: false, final false
  inline void ToggleState();

  /// @brief Method UpdateBackground, addr 0x58af094, size 0x164, virtual true, abstract: false, final false
  inline void UpdateBackground();

  /// @brief Method UpdateIcon, addr 0x58af1f8, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58af3b4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_State, addr 0x58af008, size 0x8, virtual false, abstract: false, final false
  inline bool get_State();

  /// @brief Method get_StateChanged, addr 0x58af084, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<bool>* get_StateChanged();

  /// @brief Method set_State, addr 0x58af010, size 0x1c, virtual false, abstract: false, final false
  inline void set_State(bool value);

  /// @brief Method set_StateChanged, addr 0x58af08c, size 0x8, virtual false, abstract: false, final false
