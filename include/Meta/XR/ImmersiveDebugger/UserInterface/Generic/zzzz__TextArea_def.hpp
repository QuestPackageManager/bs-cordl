...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextArea", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextArea(TextArea&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextArea", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextArea(TextAreaconst&) = delete;
