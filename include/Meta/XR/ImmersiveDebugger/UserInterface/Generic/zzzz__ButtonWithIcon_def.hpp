...
public:
  ...
  /// @brief Method OnHoverChanged, addr 0x591c8ec, size 0x30, virtual true, abstract: false, final false
  inline void OnHoverChanged();

  /// @brief Method OnTransparencyChanged, addr 0x591cc44, size 0xcc, virtual true, abstract: false, final false
  inline void OnTransparencyChanged();

  /// @brief Method RefreshStyle, addr 0x591c6b4, size 0x28, virtual false, abstract: false, final false
  inline void RefreshStyle();

  /// @brief Method Setup, addr 0x591c728, size 0x144, virtual true, abstract: false, final false
  inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller* owner);

  /// @brief Method UpdateBackground, addr 0x591c91c, size 0x150, virtual true, abstract: false, final false
  inline void UpdateBackground();

  /// @brief Method UpdateIcon, addr 0x591ca6c, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591cd10, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BackgroundStyle, addr 0x591c5a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle> get_BackgroundStyle();

  /// @brief Method set_BackgroundStyle, addr 0x591c5a8, size 0x10c, virtual false, abstract: false, final false
  inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle* value);

  /// @brief Method set_Icon, addr 0x591c70c, size 0x1c, virtual false, abstract: false, final false
  inline void set_Icon(::UnityEngine::Texture2D* value);

  /// @brief Method set_IconStyle, addr 0x591c6dc, size 0x30, virtual false, abstract: false, final false
