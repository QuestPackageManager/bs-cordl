...
/// @brief Method OnHoverChanged, addr 0x58aa980, size 0x30, virtual true, abstract: false, final false
inline void OnHoverChanged() ;

/// @brief Method OnTransparencyChanged, addr 0x58aacd8, size 0xcc, virtual true, abstract: false, final false
inline void OnTransparencyChanged() ;

/// @brief Method RefreshStyle, addr 0x58aa748, size 0x28, virtual false, abstract: false, final false
inline void RefreshStyle() ;

/// @brief Method Setup, addr 0x58aa7bc, size 0x144, virtual true, abstract: false, final false
inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  owner) ;

/// @brief Method UpdateBackground, addr 0x58aa9b0, size 0x150, virtual true, abstract: false, final false
inline void UpdateBackground() ;

/// @brief Method UpdateIcon, addr 0x58aab00, size 0x194, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58aada4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BackgroundStyle, addr 0x58aa634, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle> get_BackgroundStyle() ;

/// @brief Method set_BackgroundStyle, addr 0x58aa63c, size 0x10c, virtual false, abstract: false, final false
inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  value) ;

/// @brief Method set_Icon, addr 0x58aa7a0, size 0x1c, virtual false, abstract: false, final false
inline void set_Icon(::UnityEngine::Texture2D*  value) ;

/// @brief Method set_IconStyle, addr 0x58aa770, size 0x30, virtual false, abstract: false, final false
