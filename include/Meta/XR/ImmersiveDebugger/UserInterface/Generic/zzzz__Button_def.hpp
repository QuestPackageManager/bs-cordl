...
public:
  ...
  /// @brief Method Init, addr 0x591c208, size 0x4c, virtual false, abstract: false, final false
  static inline void Init();

  static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button* New_ctor();

  /// @brief Method OnHoverChanged, addr 0x591c430, size 0x20, virtual true, abstract: false, final false
  inline void OnHoverChanged();

  /// @brief Method OnPointerClick, addr 0x591c3bc, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591c588, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::GlobalNamespace::OVRHapticsClip* getStaticF__hapticsClip();

  /// @brief Method get_Callback, addr 0x591c3ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action* get_Callback();

  /// @brief Method get_HapticsClip, addr 0x591c254, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Callback, addr 0x591c3b4, size 0x8, virtual false, abstract: false, final false
