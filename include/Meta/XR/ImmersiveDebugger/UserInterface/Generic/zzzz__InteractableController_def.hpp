...
public:
  ...
  /// @brief Method OnDisable, addr 0x592024c, size 0x1c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnHoverChanged, addr 0x591c450, size 0x4, virtual true, abstract: false, final false
  inline void OnHoverChanged();

  /// @brief Method OnPointerClick, addr 0x5921a7c, size 0x4, virtual true, abstract: false, final false
  inline void OnPointerClick();

  /// @brief Method OnPointerEnter, addr 0x5921a40, size 0x20, virtual false, abstract: false, final false
  inline void OnPointerEnter();

  /// @brief Method OnPointerExit, addr 0x5921a60, size 0x1c, virtual false, abstract: false, final false
  inline void OnPointerExit();

  /// @brief Method PlayHaptics, addr 0x591c454, size 0x134, virtual false, abstract: false, final false
  inline void PlayHaptics(::GlobalNamespace::OVRHapticsClip* hapticsClip);

  /// @brief Method Setup, addr 0x591c86c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591c594, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Hover, addr 0x5921a14, size 0x8, virtual false, abstract: false, final false
  inline bool get_Hover();

  /// @brief Method set_Hover, addr 0x5921a1c, size 0x24, virtual false, abstract: false, final false
