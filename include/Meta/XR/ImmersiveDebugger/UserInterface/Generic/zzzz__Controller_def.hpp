...
/// @brief Field OnVisibilityChangedEvent, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_OnVisibilityChangedEvent, put=__cordl_internal_set_OnVisibilityChangedEvent)) ::System::Action_1<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller>>*  OnVisibilityChangedEvent;
...
/// @brief Field <Owner>k__BackingField, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__Owner_k__BackingField, put=__cordl_internal_set__Owner_k__BackingField)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller>  _Owner_k__BackingField;

/// @brief Field <RectTransform>k__BackingField, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__RectTransform_k__BackingField, put=__cordl_internal_set__RectTransform_k__BackingField)) ::UnityW<::UnityEngine::RectTransform>  _RectTransform_k__BackingField;
...
/// @brief Field _children, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__children, put=__cordl_internal_set__children)) ::System::Collections::Generic::List_1<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller>>*  _children;
...
/// @brief Method Append, addr 0x58a9050, size 0xf0, virtual false, abstract: false, final false
inline void Append(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  controller) ;

/// @brief Method Clear, addr 0x58a9140, size 0xa0, virtual false, abstract: false, final false
inline void Clear(bool  destroy) ;

/// @brief Method GetVec2FromLayout, addr 0x58a924c, size 0x34, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 GetVec2FromLayout(::UnityEngine::TextAnchor  anchor) ;

/// @brief Method Hide, addr 0x589d2b0, size 0x14, virtual false, abstract: false, final false
inline void Hide() ;
...
/// @brief Method OnDestroy, addr 0x58a972c, size 0x8c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnTransparencyChanged, addr 0x589dffc, size 0x4, virtual true, abstract: false, final false
inline void OnTransparencyChanged() ;

/// @brief Method OnVisibilityChanged, addr 0x58a9204, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method RefreshLayout, addr 0x589d284, size 0x14, virtual false, abstract: false, final false
inline void RefreshLayout() ;

/// @brief Method RefreshLayoutPostChildren, addr 0x58a9584, size 0x1a8, virtual true, abstract: false, final false
inline void RefreshLayoutPostChildren() ;

/// @brief Method RefreshLayoutPreChildren, addr 0x58a9280, size 0x304, virtual true, abstract: false, final false
inline void RefreshLayoutPreChildren() ;

/// @brief Method Remove, addr 0x58a3dc8, size 0x154, virtual false, abstract: false, final false
inline void Remove(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  controller, bool  destroy) ;

/// @brief Method SetHeight, addr 0x589d244, size 0x40, virtual false, abstract: false, final false
inline void SetHeight(float_t  height) ;

/// @brief Method SetWidth, addr 0x58a97b8, size 0x40, virtual false, abstract: false, final false
inline void SetWidth(float_t  width) ;

/// @brief Method Setup, addr 0x58a0728, size 0x21c, virtual true, abstract: false, final false
...
/// @brief Method Show, addr 0x589d298, size 0x18, virtual false, abstract: false, final false
inline void Show() ;

/// @brief Method ToggleVisibility, addr 0x589fecc, size 0x48, virtual false, abstract: false, final false
inline void ToggleVisibility() ;

/// @brief Method UpdateRefreshLayout, addr 0x58a8e10, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58a1dac, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_OnVisibilityChangedEvent, addr 0x589e898, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_Children, addr 0x58a8e00, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller>>* get_Children() ;

/// @brief Method get_GameObject, addr 0x58a8df0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_GameObject() ;

/// @brief Method get_LayoutStyle, addr 0x58a8e08, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle> get_LayoutStyle() ;

/// @brief Method get_Owner, addr 0x58a8dc0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller> get_Owner() ;

/// @brief Method get_RectTransform, addr 0x58a8de0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_RectTransform() ;

/// @brief Method get_Transform, addr 0x58a8dd0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_Transform() ;

/// @brief Method get_Transparent, addr 0x58a9048, size 0x8, virtual false, abstract: false, final false
inline bool get_Transparent() ;

/// @brief Method get_Visibility, addr 0x58a91e0, size 0x8, virtual false, abstract: false, final false
inline bool get_Visibility() ;

/// @brief Method remove_OnVisibilityChangedEvent, addr 0x58a8f88, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_GameObject, addr 0x58a8df8, size 0x8, virtual false, abstract: false, final false
inline void set_GameObject(::UnityEngine::GameObject*  value) ;

/// @brief Method set_LayoutStyle, addr 0x589a0a4, size 0xdc, virtual false, abstract: false, final false
inline void set_LayoutStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::LayoutStyle*  value) ;

/// @brief Method set_Owner, addr 0x58a8dc8, size 0x8, virtual false, abstract: false, final false
inline void set_Owner(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  value) ;

/// @brief Method set_RectTransform, addr 0x58a8de8, size 0x8, virtual false, abstract: false, final false
inline void set_RectTransform(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_Transform, addr 0x58a8dd8, size 0x8, virtual false, abstract: false, final false
inline void set_Transform(::UnityEngine::Transform*  value) ;

/// @brief Method set_Transparent, addr 0x589f1f0, size 0x24, virtual false, abstract: false, final false
inline void set_Transparent(bool  value) ;

/// @brief Method set_Visibility, addr 0x58a91e8, size 0x1c, virtual false, abstract: false, final false
