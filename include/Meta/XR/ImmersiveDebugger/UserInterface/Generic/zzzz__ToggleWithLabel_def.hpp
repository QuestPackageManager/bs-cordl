...
public:
  ...
  /// @brief Method OnStateChanged, addr 0x592185c, size 0x38, virtual false, abstract: false, final false
  inline void OnStateChanged();

  /// @brief Method UpdateBackground, addr 0x59218a4, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5921a08, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_State, addr 0x5921838, size 0x8, virtual false, abstract: false, final false
  inline bool get_State();

  /// @brief Method get_StateChanged, addr 0x5921894, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<bool>* get_StateChanged();

  /// @brief Method set_State, addr 0x5921840, size 0x1c, virtual false, abstract: false, final false
  inline void set_State(bool value);

  /// @brief Method set_StateChanged, addr 0x592189c, size 0x8, virtual false, abstract: false, final false
