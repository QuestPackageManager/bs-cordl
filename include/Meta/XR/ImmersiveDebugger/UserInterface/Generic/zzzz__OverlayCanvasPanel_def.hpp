...
public:
  ...
  /// @brief Method Setup, addr 0x591f6a4, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591f8a4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
