...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OverlayCanvasPanel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OverlayCanvasPanel(OverlayCanvasPanel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OverlayCanvasPanel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OverlayCanvasPanel(OverlayCanvasPanelconst&) = delete;
