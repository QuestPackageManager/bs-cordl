...
public:
  ...
  /// @brief Method Setup, addr 0x5a5a778, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a5a978, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
