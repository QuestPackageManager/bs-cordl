...
/// @brief Field _overlayCanvas, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__overlayCanvas, put=__cordl_internal_set__overlayCanvas)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvas>  _overlayCanvas;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvasPanel* New_ctor() ;

/// @brief Method Setup, addr 0x58ad738, size 0xa4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58ad938, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
