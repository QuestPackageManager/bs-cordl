...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Meta::XR::ImmersiveDebugger::Manager::Category (::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::get_Category)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x5899bd8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton*>::get(),
                        "get_Category",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::*)(::Meta::XR::ImmersiveDebugger::Manager::Category)>(&::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::set_Category)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x5899be4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::get_Counter)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5899c7c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::*)(int32_t)>(&::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::set_Counter)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::*)(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*)>(&::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::Setup)> {
  constexpr static std::size_t size = 0x2d8;
  constexpr static std::size_t addrs = 0x5899dcc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::*)()>(&::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x589a180;
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____subLabel)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton*>());
}
// Ctor Parameters []
