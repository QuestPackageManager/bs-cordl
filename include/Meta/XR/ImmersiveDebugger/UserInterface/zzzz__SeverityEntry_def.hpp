...
public:
  ...
  /// @brief Method <.ctor>b__0, addr 0x5916d80, size 0x44, virtual false, abstract: false, final false
  inline void __ctor_b__0();

  /// @brief Method .ctor, addr 0x5916d74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Reset, addr 0x590eef0, size 0x8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x590d63c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x5916d78, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Owner, addr 0x5916d64, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Console> get_Owner();

  /// @brief Method get_PillStyle, addr 0x5916d6c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle> get_PillStyle();

  /// @brief Method get_ShouldShow, addr 0x590eef8, size 0x18, virtual false, abstract: false, final false
  inline bool get_ShouldShow();

  /// @brief Method set_Count, addr 0x590e78c, size 0x54, virtual false, abstract: false, final false
  inline void set_Count(int32_t value);

  /// @brief Method set_ShouldShow, addr 0x590d798, size 0x54, virtual false, abstract: false, final false
