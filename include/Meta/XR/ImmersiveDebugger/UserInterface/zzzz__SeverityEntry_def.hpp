...
/// @brief Method <.ctor>b__0, addr 0x58a4e14, size 0x44, virtual false, abstract: false, final false
inline void __ctor_b__0() ;

/// @brief Method .ctor, addr 0x58a4e08, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <PillStyle>k__BackingField, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__PillStyle_k__BackingField, put=__cordl_internal_set__PillStyle_k__BackingField)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle>  _PillStyle_k__BackingField;
...
static inline ::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry* New_ctor(::Meta::XR::ImmersiveDebugger::UserInterface::Console*  owner, ::StringW  label, ::UnityEngine::Texture2D*  icon, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  imageStyle, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  pillStyle) ;

/// @brief Method Reset, addr 0x589cf84, size 0x8, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x589b6d0, size 0x15c, virtual false, abstract: false, final false
inline void _ctor(::Meta::XR::ImmersiveDebugger::UserInterface::Console*  owner, ::StringW  label, ::UnityEngine::Texture2D*  icon, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  imageStyle, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  pillStyle) ;

/// @brief Method get_Count, addr 0x58a4e0c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Owner, addr 0x58a4df8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Console> get_Owner() ;

/// @brief Method get_PillStyle, addr 0x58a4e00, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle> get_PillStyle() ;

/// @brief Method get_ShouldShow, addr 0x589cf8c, size 0x18, virtual false, abstract: false, final false
inline bool get_ShouldShow() ;

/// @brief Method set_Count, addr 0x589c820, size 0x54, virtual false, abstract: false, final false
inline void set_Count(int32_t  value) ;

/// @brief Method set_ShouldShow, addr 0x589b82c, size 0x54, virtual false, abstract: false, final false
