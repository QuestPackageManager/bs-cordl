...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry*);
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry___c__DisplayClass9_0) == 0x20, "Size mismatch!");
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry) == 0x38, "Size mismatch!");
