...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::Texture2D> (::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::*)()>(
    &::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::get_Icon)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x59120a8;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::*)(::UnityEngine::Texture2D*)>(
    &::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::set_Icon)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x59120b0;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel*>::get(), "set_Icon", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::*)()>(
    &::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::get_Title)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x59120b8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::*)(::StringW)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel*>::get(), "set_Title",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::*)(
    ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*)>(&::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::Setup)> {
  constexpr static std::size_t size = 0x34c;
  constexpr static std::size_t addrs = 0x590d0cc;

  inline static ::MethodInfo const* methodInfo() {

    static auto* ___internal_method =
        THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel*>::get(),
                                                       ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel*>::get(), 5));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::*)()>(
    &::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::_ctor)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x590f550;
...
constexpr void Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::__cordl_internal_set__closeIcon(::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonWithIcon> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____closeIcon)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
inline ::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel* Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel*>());
}
// Ctor Parameters []
