...
/// @brief Field _counterBackground, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__counterBackground, put=__cordl_internal_set__counterBackground)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Background>  _counterBackground;
...
/// @brief Method OnHoverChanged, addr 0x589e100, size 0xa0, virtual true, abstract: false, final false
inline void OnHoverChanged() ;

/// @brief Method OnPointerClick, addr 0x589e080, size 0x10, virtual true, abstract: false, final false
inline void OnPointerClick() ;

/// @brief Method OnTransparencyChanged, addr 0x589df70, size 0x8c, virtual true, abstract: false, final false
inline void OnTransparencyChanged() ;

/// @brief Method RefreshLogCounter, addr 0x589d7f4, size 0x1a4, virtual false, abstract: false, final false
inline void RefreshLogCounter() ;

/// @brief Method Setup, addr 0x589da60, size 0x510, virtual true, abstract: false, final false
inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  owner) ;

/// @brief Method ShowCounter, addr 0x589e000, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x589e1a0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Entry, addr 0x589d670, size 0x8, virtual false, abstract: false, final false
inline ::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry* get_Entry() ;

/// @brief Method get_Label, addr 0x589d998, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_Label() ;

/// @brief Method set_BackgroundStyle, addr 0x589d9c4, size 0x9c, virtual false, abstract: false, final false
inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  value) ;

/// @brief Method set_Entry, addr 0x589d678, size 0x88, virtual false, abstract: false, final false
inline void set_Entry(::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*  value) ;

/// @brief Method set_Label, addr 0x589d72c, size 0x2c, virtual false, abstract: false, final false
inline void set_Label(::StringW  value) ;

/// @brief Method set_PillStyle, addr 0x589d758, size 0x9c, virtual false, abstract: false, final false
