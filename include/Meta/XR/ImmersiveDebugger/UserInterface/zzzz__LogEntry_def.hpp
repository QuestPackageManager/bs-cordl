...
/// @brief Field <Line>k__BackingField, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__Line_k__BackingField, put=__cordl_internal_set__Line_k__BackingField)) ::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*  _Line_k__BackingField;

/// @brief Field <OnDisplayDetails>k__BackingField, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__OnDisplayDetails_k__BackingField, put=setStaticF__OnDisplayDetails_k__BackingField)) ::System::Action_1<::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*>*  _OnDisplayDetails_k__BackingField;

/// @brief Field <Severity>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__Severity_k__BackingField, put=__cordl_internal_set__Severity_k__BackingField)) ::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry*  _Severity_k__BackingField;

/// @brief Method DisplayDetails, addr 0x589e090, size 0x70, virtual false, abstract: false, final false
inline void DisplayDetails() ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry* New_ctor() ;

/// @brief Method Setup, addr 0x589c808, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58a4df4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Callstack, addr 0x58a4db4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Callstack() ;

/// @brief Method get_Count, addr 0x58a4dd4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Label, addr 0x58a4da4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Label() ;

/// @brief Method get_Line, addr 0x58a4de4, size 0x8, virtual false, abstract: false, final false
inline ::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine* get_Line() ;

/// @brief Method get_OnDisplayDetails, addr 0x58a4d08, size 0x4c, virtual false, abstract: false, final false
static inline ::System::Action_1<::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*>* get_OnDisplayDetails() ;

/// @brief Method get_Severity, addr 0x58a4dc4, size 0x8, virtual false, abstract: false, final false
inline ::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry* get_Severity() ;

/// @brief Method get_Shown, addr 0x589cfa4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Callstack, addr 0x58a4dbc, size 0x8, virtual false, abstract: false, final false
inline void set_Callstack(::StringW  value) ;

/// @brief Method set_Count, addr 0x58a4ddc, size 0x8, virtual false, abstract: false, final false
inline void set_Count(int32_t  value) ;

/// @brief Method set_Label, addr 0x58a4dac, size 0x8, virtual false, abstract: false, final false
inline void set_Label(::StringW  value) ;

/// @brief Method set_Line, addr 0x58a4dec, size 0x8, virtual false, abstract: false, final false
inline void set_Line(::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine*  value) ;

/// @brief Method set_OnDisplayDetails, addr 0x58a4d54, size 0x50, virtual false, abstract: false, final false
static inline void set_OnDisplayDetails(::System::Action_1<::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*>*  value) ;

/// @brief Method set_Severity, addr 0x58a4dcc, size 0x8, virtual false, abstract: false, final false
