...
public:
  ...
  /// @brief Method DisplayDetails, addr 0x590fffc, size 0x70, virtual false, abstract: false, final false
  inline void DisplayDetails();

  static inline ::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry* New_ctor();

  /// @brief Method Setup, addr 0x590e774, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5916d60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Callstack, addr 0x5916d20, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Callstack();

  /// @brief Method get_Count, addr 0x5916d40, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Label, addr 0x5916d10, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Label();

  /// @brief Method get_Line, addr 0x5916d50, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine* get_Line();

  /// @brief Method get_OnDisplayDetails, addr 0x5916c74, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Action_1<::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*>* get_OnDisplayDetails();

  /// @brief Method get_Severity, addr 0x5916d30, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry* get_Severity();

  /// @brief Method get_Shown, addr 0x590ef10, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Callstack, addr 0x5916d28, size 0x8, virtual false, abstract: false, final false
  inline void set_Callstack(::StringW value);

  /// @brief Method set_Count, addr 0x5916d48, size 0x8, virtual false, abstract: false, final false
  inline void set_Count(int32_t value);

  /// @brief Method set_Label, addr 0x5916d18, size 0x8, virtual false, abstract: false, final false
  inline void set_Label(::StringW value);

  /// @brief Method set_Line, addr 0x5916d58, size 0x8, virtual false, abstract: false, final false
  inline void set_Line(::Meta::XR::ImmersiveDebugger::UserInterface::ProxyConsoleLine* value);

  /// @brief Method set_OnDisplayDetails, addr 0x5916cc0, size 0x50, virtual false, abstract: false, final false
  static inline void set_OnDisplayDetails(::System::Action_1<::Meta::XR::ImmersiveDebugger::UserInterface::LogEntry*>* value);

  /// @brief Method set_Severity, addr 0x5916d38, size 0x8, virtual false, abstract: false, final false
