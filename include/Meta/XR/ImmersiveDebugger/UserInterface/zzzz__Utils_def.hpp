...
public:
  // Declarations
  /// @brief Method ClampText, addr 0x590f66c, size 0x2c, virtual false, abstract: false, final false
  static inline ::StringW ClampText(::StringW text, int32_t limit);

  /// @brief Method LerpPosition, addr 0x590eb20, size 0x12c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 LerpPosition(::UnityEngine::Vector3 current, ::UnityEngine::Vector3 target, float_t lerpSpeed);

  /// @brief Method ToDisplayText, addr 0x5916df0, size 0x1b8, virtual false, abstract: false, final false
