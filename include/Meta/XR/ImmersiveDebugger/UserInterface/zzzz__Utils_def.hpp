...
public:
// Declarations
/// @brief Method ClampText, addr 0x589d700, size 0x2c, virtual false, abstract: false, final false
static inline ::StringW ClampText(::StringW  text, int32_t  limit) ;

/// @brief Method LerpPosition, addr 0x589cbb4, size 0x12c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 LerpPosition(::UnityEngine::Vector3  current, ::UnityEngine::Vector3  target, float_t  lerpSpeed) ;

/// @brief Method ToDisplayText, addr 0x58a4e84, size 0x1b8, virtual false, abstract: false, final false
