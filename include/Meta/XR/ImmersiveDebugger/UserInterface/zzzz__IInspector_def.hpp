...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::IInspector*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::IInspector*, "Meta.XR.ImmersiveDebugger.UserInterface", "IInspector");
// Dependencies
namespace Meta::XR::ImmersiveDebugger::UserInterface {
// Is value type: false
