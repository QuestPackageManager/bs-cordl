...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Meta::XR::ImmersiveDebugger::UserInterface::IInspector* (
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(),
                                                                                          { ::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel::*)(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(),
                                                                                          { ::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(), 1 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Meta::XR::ImmersiveDebugger::UserInterface::IInspector* (
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(),
                                                                                          { ::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(), 2 }));
    return ___internal_method;
  }
};
...
Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel::RegisterInspector(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle instance, ::Meta::XR::ImmersiveDebugger::Manager::Category category) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(), 0 })));
  return ::cordl_internals::RunMethodRethrow<::Meta::XR::ImmersiveDebugger::UserInterface::IInspector*>(this, ___internal_method, instance, category);
}
inline void Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel::UnregisterInspector(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle instance,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(), 1 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, instance, category, allCategories);
}
inline ::Meta::XR::ImmersiveDebugger::UserInterface::IInspector* Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel::GetInspector(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle instance,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel*>(), 2 })));
  return ::cordl_internals::RunMethodRethrow<::Meta::XR::ImmersiveDebugger::UserInterface::IInspector*>(this, ___internal_method, instance, category);
}
