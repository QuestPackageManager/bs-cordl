...
/// @brief Method <GetCategoryButton>b__0, addr 0x58a4cb8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58a3f50, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetHierarchyItemButton>b__0, addr 0x58a4cd4, size 0x1c, virtual false, abstract: false, final false
inline void _GetHierarchyItemButton_b__0() ;

/// @brief Method <GetHierarchyItemButton>b__1, addr 0x58a4cf0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58a4328, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _categories, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get__categories, put=__cordl_internal_set__categories)) ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton>>*  _categories;
...
/// @brief Field _categoryBackground, offset 0x120, size 0x8 
 __declspec(property(get=__cordl_internal_get__categoryBackground, put=__cordl_internal_set__categoryBackground)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Background>  _categoryBackground;

/// @brief Field _categoryBackgroundImageStyle, offset 0x148, size 0x8 
 __declspec(property(get=__cordl_internal_get__categoryBackgroundImageStyle, put=__cordl_internal_set__categoryBackgroundImageStyle)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle>  _categoryBackgroundImageStyle;
...
/// @brief Field _categoryScrollView, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get__categoryScrollView, put=__cordl_internal_set__categoryScrollView)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollView>  _categoryScrollView;
...
/// @brief Field _hierarchyScrollView, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get__hierarchyScrollView, put=__cordl_internal_set__hierarchyScrollView)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ScrollView>  _hierarchyScrollView;

/// @brief Field _items, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get__items, put=__cordl_internal_set__items)) ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Hierarchy::Item*,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton>>*  _items;
...
/// @brief Field _registries, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get__registries, put=__cordl_internal_set__registries)) ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Inspector>>*>*>*  _registries;
...
/// @brief Field _selectedCategory, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get__selectedCategory, put=__cordl_internal_set__selectedCategory)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton>  _selectedCategory;
...
/// @brief Field _selectedModeTitle, offset 0x160, size 0x8 
 __declspec(property(get=__cordl_internal_get__selectedModeTitle, put=__cordl_internal_set__selectedModeTitle)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Label>  _selectedModeTitle;
...
/// @brief Method ComputeIdealPreviousItem, addr 0x58a40c4, size 0x264, virtual false, abstract: false, final false
...
/// @brief Method FoldItem, addr 0x58a4970, size 0x30, virtual false, abstract: false, final false
inline void FoldItem(::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton*  button) ;

/// @brief Method GetCategoryButton, addr 0x58a34b4, size 0x27c, virtual false, abstract: false, final false
...
/// @brief Method GetHierarchyItemButton, addr 0x58a2e60, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method GetInspector, addr 0x58a3f1c, size 0x34, virtual true, abstract: false, final true
inline ::Meta::XR::ImmersiveDebugger::UserInterface::IInspector* GetInspector(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  instanceHandle, ::Meta::XR::ImmersiveDebugger::Manager::Category  category) ;

/// @brief Method GetInspectorInternal, addr 0x58a3220, size 0x294, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Inspector> GetInspectorInternal(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  instanceHandle, ::Meta::XR::ImmersiveDebugger::Manager::Category  category, bool  createRegistries, ::ByRef<::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Inspector>>*>  registry) ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::InspectorPanel* New_ctor() ;

/// @brief Method OnTransparencyChanged, addr 0x58a2a00, size 0x84, virtual true, abstract: false, final false
inline void OnTransparencyChanged() ;

/// @brief Method RegisterControl, addr 0x58a263c, size 0x224, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle> RegisterControl(::StringW  buttonName, ::UnityEngine::Texture2D*  icon, ::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  style, ::System::Action*  callback) ;

/// @brief Method RegisterInspector, addr 0x58a2a84, size 0x3dc, virtual true, abstract: false, final true
inline ::Meta::XR::ImmersiveDebugger::UserInterface::IInspector* RegisterInspector(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  instanceHandle, ::Meta::XR::ImmersiveDebugger::Manager::Category  category) ;

/// @brief Method RemoveInspector, addr 0x58a3b64, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method SelectCategory, addr 0x58a44dc, size 0x3f4, virtual false, abstract: false, final false
inline void SelectCategory(::Meta::XR::ImmersiveDebugger::Manager::Category  category) ;

/// @brief Method SelectCategoryButton, addr 0x58a3f54, size 0x170, virtual false, abstract: false, final false
inline void SelectCategoryButton(::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton*  categoryButton) ;

/// @brief Method SelectCategoryMode, addr 0x58a2860, size 0xd0, virtual false, abstract: false, final false
inline void SelectCategoryMode() ;

/// @brief Method SelectHierarchyItemButton, addr 0x58a432c, size 0x1b0, virtual false, abstract: false, final false
inline void SelectHierarchyItemButton(::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton*  button) ;

/// @brief Method SelectHierarchyMode, addr 0x58a2930, size 0xd0, virtual false, abstract: false, final false
inline void SelectHierarchyMode() ;

/// @brief Method SelectItem, addr 0x58a49d4, size 0x58, virtual false, abstract: false, final false
inline void SelectItem(::Meta::XR::ImmersiveDebugger::Hierarchy::Item*  item) ;

/// @brief Method SetPanelPosition, addr 0x589fc2c, size 0x144, virtual false, abstract: false, final false
inline void SetPanelPosition(::Meta::XR::ImmersiveDebugger::RuntimeSettings_DistanceOption  distanceOption, bool  skipAnimation) ;

/// @brief Method Setup, addr 0x58a1ec8, size 0x774, virtual true, abstract: false, final false
inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  owner) ;

/// @brief Method ToggleFoldItem, addr 0x58a48d0, size 0xa0, virtual false, abstract: false, final false
inline void ToggleFoldItem(::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton*  button) ;

/// @brief Method TryRemoveHierarchyItemButton, addr 0x58a3cc0, size 0x108, virtual false, abstract: false, final false
inline void TryRemoveHierarchyItemButton(::Meta::XR::ImmersiveDebugger::Hierarchy::Item*  item) ;

/// @brief Method UnfoldItem, addr 0x58a49a0, size 0x34, virtual false, abstract: false, final false
inline void UnfoldItem(::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton*  button) ;

/// @brief Method UnregisterInspector, addr 0x58a3730, size 0x434, virtual true, abstract: false, final true
...
/// @brief Method Update, addr 0x58a4a2c, size 0xf4, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton>>* const& __cordl_internal_get__categories() const;

constexpr ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton>>*& __cordl_internal_get__categories() ;
...
constexpr ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Hierarchy::Item*,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton>>* const& __cordl_internal_get__items() const;

constexpr ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Hierarchy::Item*,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton>>*& __cordl_internal_get__items() ;
...
constexpr ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Inspector>>*>*>* const& __cordl_internal_get__registries() const;

constexpr ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Inspector>>*>*>*& __cordl_internal_get__registries() ;
...
constexpr void __cordl_internal_set__categories(::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton>>*  value) ;
...
constexpr void __cordl_internal_set__items(::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Hierarchy::Item*,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton>>*  value) ;
...
constexpr void __cordl_internal_set__registries(::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Inspector>>*>*>*  value) ;
...
/// @brief Method .ctor, addr 0x58a4b20, size 0x198, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CategoryFlex, addr 0x58a1de4, size 0x24, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> get_CategoryFlex() ;

/// @brief Method get_Flex, addr 0x58a1db8, size 0x24, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> get_Flex() ;

/// @brief Method get_HierarchyFlex, addr 0x58a1e08, size 0x24, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> get_HierarchyFlex() ;

/// @brief Method get_ScrollView, addr 0x58a1ddc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_CategoryBackgroundStyle, addr 0x58a1e2c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Field _registries, offset: 0xf8, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Manager::Category,::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Collections::Generic::Dictionary_2<::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Inspector>>*>*>*  ____registries;
