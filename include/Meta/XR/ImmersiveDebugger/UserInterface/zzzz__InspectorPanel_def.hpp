...
public:
  ...
  /// @brief Method <GetCategoryButton>b__0, addr 0x5916c24, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5915ebc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetHierarchyItemButton>b__0, addr 0x5916c40, size 0x1c, virtual false, abstract: false, final false
  inline void _GetHierarchyItemButton_b__0();

  /// @brief Method <GetHierarchyItemButton>b__1, addr 0x5916c5c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5916294, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ComputeIdealPreviousItem, addr 0x5916030, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method FoldItem, addr 0x59168dc, size 0x30, virtual false, abstract: false, final false
  inline void FoldItem(::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton* button);

  /// @brief Method GetCategoryButton, addr 0x5915420, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHierarchyItemButton, addr 0x5914dcc, size 0x3c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInspector, addr 0x5915e88, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method GetInspectorInternal, addr 0x591518c, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method OnTransparencyChanged, addr 0x591496c, size 0x84, virtual true, abstract: false, final false
  inline void OnTransparencyChanged();

  /// @brief Method RegisterControl, addr 0x59145a8, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterInspector, addr 0x59149f0, size 0x3dc, virtual true, abstract: false, final true
  ...
  /// @brief Method RemoveInspector, addr 0x5915ad0, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectCategory, addr 0x5916448, size 0x3f4, virtual false, abstract: false, final false
  inline void SelectCategory(::Meta::XR::ImmersiveDebugger::Manager::Category category);

  /// @brief Method SelectCategoryButton, addr 0x5915ec0, size 0x170, virtual false, abstract: false, final false
  inline void SelectCategoryButton(::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton* categoryButton);

  /// @brief Method SelectCategoryMode, addr 0x59147cc, size 0xd0, virtual false, abstract: false, final false
  inline void SelectCategoryMode();

  /// @brief Method SelectHierarchyItemButton, addr 0x5916298, size 0x1b0, virtual false, abstract: false, final false
  inline void SelectHierarchyItemButton(::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton* button);

  /// @brief Method SelectHierarchyMode, addr 0x591489c, size 0xd0, virtual false, abstract: false, final false
  inline void SelectHierarchyMode();

  /// @brief Method SelectItem, addr 0x5916940, size 0x58, virtual false, abstract: false, final false
  inline void SelectItem(::Meta::XR::ImmersiveDebugger::Hierarchy::Item* item);

  /// @brief Method SetPanelPosition, addr 0x5911b98, size 0x144, virtual false, abstract: false, final false
  inline void SetPanelPosition(::Meta::XR::ImmersiveDebugger::RuntimeSettings_DistanceOption distanceOption, bool skipAnimation);

  /// @brief Method Setup, addr 0x5913e34, size 0x774, virtual true, abstract: false, final false
  inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller* owner);

  /// @brief Method ToggleFoldItem, addr 0x591683c, size 0xa0, virtual false, abstract: false, final false
  inline void ToggleFoldItem(::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton* button);

  /// @brief Method TryRemoveHierarchyItemButton, addr 0x5915c2c, size 0x108, virtual false, abstract: false, final false
  inline void TryRemoveHierarchyItemButton(::Meta::XR::ImmersiveDebugger::Hierarchy::Item* item);

  /// @brief Method UnfoldItem, addr 0x591690c, size 0x34, virtual false, abstract: false, final false
  inline void UnfoldItem(::Meta::XR::ImmersiveDebugger::UserInterface::HierarchyItemButton* button);

  /// @brief Method UnregisterInspector, addr 0x591569c, size 0x434, virtual true, abstract: false, final true
  ...
  /// @brief Method Update, addr 0x5916998, size 0xf4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5916a8c, size 0x198, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CategoryFlex, addr 0x5913d50, size 0x24, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> get_CategoryFlex();

  /// @brief Method get_Flex, addr 0x5913d24, size 0x24, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> get_Flex();

  /// @brief Method get_HierarchyFlex, addr 0x5913d74, size 0x24, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex> get_HierarchyFlex();

  /// @brief Method get_ScrollView, addr 0x5913d48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CategoryBackgroundStyle, addr 0x5913d98, size 0x9c, virtual false, abstract: false, final false
