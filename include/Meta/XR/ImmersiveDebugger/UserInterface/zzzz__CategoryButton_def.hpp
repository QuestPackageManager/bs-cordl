...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton*, "Meta.XR.ImmersiveDebugger.UserInterface", "CategoryButton");
...
public:
  ...
  /// @brief Method Setup, addr 0x5a46e0c, size 0x2d8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a471c0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Category, addr 0x5a46c18, size 0xc, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Manager::Category get_Category();

  /// @brief Method get_Counter, addr 0x5a46cbc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Counter();

  /// @brief Method set_Category, addr 0x5a46c24, size 0x98, virtual false, abstract: false, final false
  inline void set_Category(::Meta::XR::ImmersiveDebugger::Manager::Category value);

  /// @brief Method set_Counter, addr 0x5a46cc4, size 0x148, virtual false, abstract: false, final false
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::CategoryButton) == 0xe8, "Size mismatch!");
