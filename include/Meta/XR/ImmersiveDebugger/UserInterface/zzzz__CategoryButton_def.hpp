...
/// @brief Method Setup, addr 0x5899dcc, size 0x2d8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x589a180, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Category, addr 0x5899bd8, size 0xc, virtual false, abstract: false, final false
inline ::Meta::XR::ImmersiveDebugger::Manager::Category get_Category() ;

/// @brief Method get_Counter, addr 0x5899c7c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Counter() ;

/// @brief Method set_Category, addr 0x5899be4, size 0x98, virtual false, abstract: false, final false
inline void set_Category(::Meta::XR::ImmersiveDebugger::Manager::Category  value) ;

/// @brief Method set_Counter, addr 0x5899c84, size 0x148, virtual false, abstract: false, final false
