...
public:
  ...
  /// @brief Method Setup, addr 0x5a4a4a0, size 0x34c, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Title, addr 0x5a4ef40, size 0x2c, virtual false, abstract: false, final false
