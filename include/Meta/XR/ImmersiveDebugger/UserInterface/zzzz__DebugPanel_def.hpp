...
public:
  ...
  /// @brief Method Setup, addr 0x590d0cc, size 0x34c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590f550, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Icon, addr 0x59120a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_Icon();

  /// @brief Method get_Title, addr 0x59120b8, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_Title();

  /// @brief Method set_Icon, addr 0x59120b0, size 0x8, virtual false, abstract: false, final false
  inline void set_Icon(::UnityEngine::Texture2D* value);

  /// @brief Method set_Title, addr 0x5911b6c, size 0x2c, virtual false, abstract: false, final false
