...
/// @brief Method Setup, addr 0x589b160, size 0x34c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x589d5e4, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Icon, addr 0x58a013c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> get_Icon() ;

/// @brief Method get_Title, addr 0x58a014c, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_Title() ;

/// @brief Method set_Icon, addr 0x58a0144, size 0x8, virtual false, abstract: false, final false
inline void set_Icon(::UnityEngine::Texture2D*  value) ;

/// @brief Method set_Title, addr 0x589fc00, size 0x2c, virtual false, abstract: false, final false
