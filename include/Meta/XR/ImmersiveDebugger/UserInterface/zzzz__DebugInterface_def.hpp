...
/// @brief Method Awake, addr 0x5912b50, size 0x9ec, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method IsInspectorPanelVisible, addr 0x5913980, size 0x28, virtual false, abstract: false, final false
inline bool IsInspectorPanelVisible() ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::DebugInterface* New_ctor() ;

/// @brief Method SetTransparencyRecursive, addr 0x59129f4, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method ToggleDistances, addr 0x59136ac, size 0x48, virtual false, abstract: false, final false
inline void ToggleDistances() ;

/// @brief Method ToggleFollowRotation, addr 0x5913724, size 0x30, virtual false, abstract: false, final false
inline void ToggleFollowRotation() ;

/// @brief Method ToggleFollowTranslation, addr 0x59136f4, size 0x30, virtual false, abstract: false, final false
inline void ToggleFollowTranslation() ;

/// @brief Method Update, addr 0x5913850, size 0x130, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateVisibility, addr 0x5913754, size 0xb4, virtual false, abstract: false, final false
inline void UpdateVisibility() ;

/// @brief Method <Awake>b__20_0, addr 0x5913a58, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59139a8, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_FollowOverride, addr 0x59127c8, size 0x18, virtual true, abstract: false, final false
inline bool get_FollowOverride() ;

/// @brief Method get_OpacityOverride, addr 0x5912850, size 0x18, virtual false, abstract: false, final false
inline bool get_OpacityOverride() ;

/// @brief Method get_RotateOverride, addr 0x591280c, size 0x18, virtual true, abstract: false, final false
inline bool get_RotateOverride() ;

/// @brief Method set_FollowOverride, addr 0x59127e0, size 0x2c, virtual true, abstract: false, final false
inline void set_FollowOverride(bool  value) ;

/// @brief Method set_OpacityOverride, addr 0x5912868, size 0x18c, virtual false, abstract: false, final false
inline void set_OpacityOverride(bool  value) ;

/// @brief Method set_RotateOverride, addr 0x5912824, size 0x2c, virtual true, abstract: false, final false
