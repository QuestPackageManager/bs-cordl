...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PanelScrollRect", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PanelScrollRect(PanelScrollRect&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PanelScrollRect", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PanelScrollRect(PanelScrollRectconst&) = delete;
