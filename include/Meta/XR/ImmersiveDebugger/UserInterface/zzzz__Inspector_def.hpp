...
public:
  ...
  /// @brief Method GetMember, addr 0x59138cc, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method OnStateChanged, addr 0x5913940, size 0x250, virtual false, abstract: false, final false
  inline void OnStateChanged(bool state);

  /// @brief Method OnTransparencyChanged, addr 0x5913350, size 0x78, virtual true, abstract: false, final false
  inline void OnTransparencyChanged();

  /// @brief Method RegisterMember, addr 0x5913408, size 0x218, virtual true, abstract: false, final true
  ...
  /// @brief Method Setup, addr 0x5912e58, size 0x4f8, virtual true, abstract: false, final false
  inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller* owner);

  /// @brief Method Update, addr 0x5913b90, size 0x8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateBackground, addr 0x59133c8, size 0x40, virtual false, abstract: false, final false
  inline void UpdateBackground(bool transparent);

  /// @brief Method UpdateInstanceState, addr 0x5912d68, size 0xe8, virtual false, abstract: false, final false
  inline void UpdateInstanceState(bool force);

  /// @brief Method UpdateInstanceState, addr 0x5913b98, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5913c74, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Foldout, addr 0x5912e50, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle> get_Foldout();

  /// @brief Method get_InstanceHandle, addr 0x5912c1c, size 0x14, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle get_InstanceHandle();

  /// @brief Method get_Title, addr 0x5912bec, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_BackgroundStyle, addr 0x5912b50, size 0x9c, virtual false, abstract: false, final false
  inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle* value);

  /// @brief Method set_InstanceHandle, addr 0x5912c30, size 0x138, virtual false, abstract: false, final false
  inline void set_InstanceHandle(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle value);

  /// @brief Method set_Title, addr 0x5912c04, size 0x18, virtual false, abstract: false, final false
