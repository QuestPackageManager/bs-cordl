...
/// @brief Field _registry, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__registry, put=__cordl_internal_set__registry)) ::System::Collections::Generic::Dictionary_2<::System::Reflection::MemberInfo*,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Member>>*  _registry;
...
/// @brief Method GetMember, addr 0x58a1960, size 0x74, virtual true, abstract: false, final true
...
/// @brief Method OnStateChanged, addr 0x58a19d4, size 0x250, virtual false, abstract: false, final false
inline void OnStateChanged(bool  state) ;

/// @brief Method OnTransparencyChanged, addr 0x58a13e4, size 0x78, virtual true, abstract: false, final false
inline void OnTransparencyChanged() ;

/// @brief Method RegisterMember, addr 0x58a149c, size 0x218, virtual true, abstract: false, final true
...
/// @brief Method Setup, addr 0x58a0eec, size 0x4f8, virtual true, abstract: false, final false
inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  owner) ;

/// @brief Method Update, addr 0x58a1c24, size 0x8, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateBackground, addr 0x58a145c, size 0x40, virtual false, abstract: false, final false
inline void UpdateBackground(bool  transparent) ;

/// @brief Method UpdateInstanceState, addr 0x58a0dfc, size 0xe8, virtual false, abstract: false, final false
inline void UpdateInstanceState(bool  force) ;

/// @brief Method UpdateInstanceState, addr 0x58a1c2c, size 0xdc, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::System::Reflection::MemberInfo*,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Member>>* const& __cordl_internal_get__registry() const;
...
/// @brief Method .ctor, addr 0x58a1d08, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Foldout, addr 0x58a0ee4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle> get_Foldout() ;

/// @brief Method get_InstanceHandle, addr 0x58a0cb0, size 0x14, virtual false, abstract: false, final false
inline ::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle get_InstanceHandle() ;

/// @brief Method get_Title, addr 0x58a0c80, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method set_BackgroundStyle, addr 0x58a0be4, size 0x9c, virtual false, abstract: false, final false
inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle*  value) ;

/// @brief Method set_InstanceHandle, addr 0x58a0cc4, size 0x138, virtual false, abstract: false, final false
inline void set_InstanceHandle(::Meta::XR::ImmersiveDebugger::Utils::InstanceHandle  value) ;

/// @brief Method set_Title, addr 0x58a0c98, size 0x18, virtual false, abstract: false, final false
