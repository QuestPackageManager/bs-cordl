...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::UserInterface::Inspector*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::UserInterface::Inspector*, "Meta.XR.ImmersiveDebugger.UserInterface", "Inspector");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Inspector", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Inspector(Inspector&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Inspector", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Inspector(Inspectorconst&) = delete;
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::UserInterface::Inspector) == 0xc0, "Size mismatch!");
