...
/// @brief Method IsFocussed, addr 0x58a7bc4, size 0x8, virtual true, abstract: false, final false
inline bool IsFocussed() ;

static inline ::Meta::XR::ImmersiveDebugger::UserInterface::PanelRaycaster* New_ctor() ;

/// @brief Method OnDisable, addr 0x58a7c24, size 0x58, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x58a7bcc, size 0x58, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPointerEnter, addr 0x58a7bc0, size 0x4, virtual true, abstract: false, final false
inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData*  e) ;

/// @brief Method .ctor, addr 0x58a7c7c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsValid, addr 0x58a6d7c, size 0x7c, virtual false, abstract: false, final false
