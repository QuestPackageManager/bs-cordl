...
public:
  ...
  /// @brief Method Setup, addr 0x5917b7c, size 0x3d8, virtual false, abstract: false, final false
  inline void Setup(::Meta::XR::ImmersiveDebugger::Manager::Watch* watch);

  /// @brief Method Update, addr 0x591a9f8, size 0x17c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x591ab74, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GetValues, addr 0x591a7ac, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Value>>* get_GetValues();

  /// @brief Method get_Watch, addr 0x591a7b4, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::ImmersiveDebugger::Manager::Watch* get_Watch();

  /// @brief Method set_BackgroundStyle, addr 0x591a7c4, size 0x114, virtual false, abstract: false, final false
  inline void set_BackgroundStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle* value);

  /// @brief Method set_TextStyle, addr 0x591a8d8, size 0x120, virtual false, abstract: false, final false
  inline void set_TextStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::TextStyle* value);

  /// @brief Method set_Watch, addr 0x591a7bc, size 0x8, virtual false, abstract: false, final false
