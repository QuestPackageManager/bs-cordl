...
public:
  ...
  /// @brief Method AddSlider, addr 0x59182d4, size 0x1b0, virtual false, abstract: false, final false
  inline void AddSlider(::Meta::XR::ImmersiveDebugger::Manager::Tweak* tweak);

  /// @brief Method AddToggle, addr 0x5918484, size 0x28c, virtual false, abstract: false, final false
  inline void AddToggle(::Meta::XR::ImmersiveDebugger::Manager::Tweak* tweak);

  /// @brief Method GetAction, addr 0x59174b8, size 0x84, virtual true, abstract: false, final true
  inline ::Meta::XR::ImmersiveDebugger::Manager::ActionHook* GetAction();

  /// @brief Method GetGizmo, addr 0x59177b8, size 0x84, virtual true, abstract: false, final true
  inline ::Meta::XR::ImmersiveDebugger::Manager::GizmoHook* GetGizmo();

  /// @brief Method GetTweak, addr 0x5918128, size 0x84, virtual true, abstract: false, final true
  inline ::Meta::XR::ImmersiveDebugger::Manager::Tweak* GetTweak();

  /// @brief Method GetWatch, addr 0x5917a24, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method OnTransparencyChanged, addr 0x5917444, size 0x74, virtual true, abstract: false, final false
  inline void OnTransparencyChanged();

  /// @brief Method RegisterAction, addr 0x591753c, size 0x260, virtual true, abstract: false, final true
  inline void RegisterAction(::Meta::XR::ImmersiveDebugger::Manager::ActionHook* action);

  /// @brief Method RegisterDescriptor, addr 0x591365c, size 0x1b8, virtual false, abstract: false, final false
  inline void RegisterDescriptor();

  /// @brief Method RegisterEnum, addr 0x5917f54, size 0xe0, virtual true, abstract: false, final true
  inline void RegisterEnum(::Meta::XR::ImmersiveDebugger::Manager::TweakEnum* tweak);

  /// @brief Method RegisterGizmo, addr 0x591783c, size 0x1e8, virtual true, abstract: false, final true
  inline void RegisterGizmo(::Meta::XR::ImmersiveDebugger::Manager::GizmoHook* gizmo);

  /// @brief Method RegisterTexture, addr 0x5918034, size 0xf4, virtual true, abstract: false, final true
  inline void RegisterTexture(::Meta::XR::ImmersiveDebugger::Manager::WatchTexture* watchTexture);

  /// @brief Method RegisterTweak, addr 0x59181ac, size 0x128, virtual true, abstract: false, final true
  inline void RegisterTweak(::Meta::XR::ImmersiveDebugger::Manager::Tweak* tweak);

  /// @brief Method RegisterWatch, addr 0x5917aa8, size 0xd4, virtual true, abstract: false, final true
  inline void RegisterWatch(::Meta::XR::ImmersiveDebugger::Manager::Watch* watch);

  /// @brief Method Setup, addr 0x5917060, size 0x344, virtual true, abstract: false, final false
  inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller* owner);

  /// @brief Method <AddToggle>b__37_0, addr 0x591871c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5918710, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Description, addr 0x5916fa8, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_Title, addr 0x5916dc4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Description, addr 0x5913814, size 0x1c, virtual false, abstract: false, final false
  inline void set_Description(::StringW value);

  /// @brief Method set_PillColor, addr 0x5913830, size 0x9c, virtual false, abstract: false, final false
  inline void set_PillColor(::UnityEngine::Color value);

  /// @brief Method set_PillStyle, addr 0x5916fc4, size 0x9c, virtual false, abstract: false, final false
  inline void set_PillStyle(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle* value);

  /// @brief Method set_Title, addr 0x5913620, size 0x3c, virtual false, abstract: false, final false
