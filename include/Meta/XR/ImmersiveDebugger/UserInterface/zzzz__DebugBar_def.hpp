...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugBar", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugBar(DebugBar&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugBar", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugBar(DebugBarconst&) = delete;
