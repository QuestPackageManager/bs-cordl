...
/// @brief Field _miniButtonsAnchor, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__miniButtonsAnchor, put=__cordl_internal_set__miniButtonsAnchor)) ::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Flex>  _miniButtonsAnchor;

/// @brief Field _panelToggles, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get__panelToggles, put=__cordl_internal_set__panelToggles)) ::System::Collections::Generic::Dictionary_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel>,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle>>*  _panelToggles;

/// @brief Field _panels, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__panels, put=__cordl_internal_set__panels)) ::System::Collections::Generic::List_1<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel>>*  _panels;
...
/// @brief Method OnPanelVisibilityChanged, addr 0x589eb70, size 0xe8, virtual false, abstract: false, final false
inline void OnPanelVisibilityChanged(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  controller) ;

/// @brief Method RegisterControl, addr 0x589e958, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method RegisterPanel, addr 0x589e558, size 0x340, virtual false, abstract: false, final false
inline void RegisterPanel(::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel*  panel) ;

/// @brief Method Setup, addr 0x589e2bc, size 0x29c, virtual true, abstract: false, final false
inline void Setup(::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Controller*  owner) ;

/// @brief Method Update, addr 0x589ec58, size 0x138, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel>,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle>>* const& __cordl_internal_get__panelToggles() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel>,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle>>*& __cordl_internal_get__panelToggles() ;
...
constexpr void __cordl_internal_set__panelToggles(::System::Collections::Generic::Dictionary_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel>,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle>>*  value) ;
...
/// @brief Method .ctor, addr 0x589ed90, size 0xfc, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _panelToggles, offset: 0xd0, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::DebugPanel>,::UnityW<::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Toggle>>*  ____panelToggles;
