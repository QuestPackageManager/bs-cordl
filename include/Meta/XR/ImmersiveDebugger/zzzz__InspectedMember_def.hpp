...
public:
  ...
  /// @brief Method Initialize, addr 0x5903eb0, size 0x128, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::Meta::XR::ImmersiveDebugger::InspectedMember* New_ctor(::System::Reflection::MemberInfo* member);

  /// @brief Method PopulateSupportedGizmos, addr 0x5904868, size 0x5ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590478c, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::System::Reflection::MemberInfo* member);

  /// @brief Method get_MemberInfo, addr 0x5904858, size 0x8, virtual false, abstract: false, final false
  inline ::System::Reflection::MemberInfo* get_MemberInfo();

  /// @brief Method get_SupportedGizmos, addr 0x5904848, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Meta::XR::ImmersiveDebugger::DebugGizmoType>* get_SupportedGizmos();

  /// @brief Method set_MemberInfo, addr 0x5904860, size 0x8, virtual false, abstract: false, final false
  inline void set_MemberInfo(::System::Reflection::MemberInfo* value);

  /// @brief Method set_SupportedGizmos, addr 0x5904850, size 0x8, virtual false, abstract: false, final false
