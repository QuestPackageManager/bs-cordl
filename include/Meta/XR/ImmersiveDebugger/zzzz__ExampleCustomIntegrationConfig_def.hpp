...
// Write type traits
MARK_REF_T(::Meta::XR::ImmersiveDebugger::ExampleCustomIntegrationConfig*);
DEFINE_IL2CPP_CLASS(::Meta::XR::ImmersiveDebugger::ExampleCustomIntegrationConfig*, "Meta.XR.ImmersiveDebugger", "ExampleCustomIntegrationConfig");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExampleCustomIntegrationConfig", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExampleCustomIntegrationConfig(ExampleCustomIntegrationConfig&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExampleCustomIntegrationConfig", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExampleCustomIntegrationConfig(ExampleCustomIntegrationConfigconst&) = delete;
...
static_assert(sizeof(::Meta::XR::ImmersiveDebugger::ExampleCustomIntegrationConfig) == 0x20, "Size mismatch!");
