...
public:
  ...
  /// @brief Method Initialize, addr 0x59024c0, size 0x2e8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetHandle, addr 0x5902ea0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5902a38, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Handles, addr 0x5902aac, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Initialize, addr 0x59024a8, size 0x18, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::Meta::XR::ImmersiveDebugger::DebugInspector* New_ctor();

  /// @brief Method OnDisable, addr 0x5902914, size 0x58, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x59027a8, size 0xb8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x59024a4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59029dc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Category, addr 0x5902494, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Category();

  /// @brief Method get_Registry, addr 0x590249c, size 0x8, virtual false, abstract: false, final false
