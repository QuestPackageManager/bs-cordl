...
/// @brief Method HookGetInstanceProcAddr, addr 0x5ca18a8, size 0x130, virtual true, abstract: false, final false
inline ::System::IntPtr HookGetInstanceProcAddr(::System::IntPtr  func) ;

static inline ::Meta::XR::MetaXRFeature* New_ctor() ;

/// @brief Method OnAppSpaceChange, addr 0x5ca1e88, size 0xe4, virtual true, abstract: false, final false
inline void OnAppSpaceChange(uint64_t  xrSpace) ;

/// @brief Method OnInstanceCreate, addr 0x5ca19d8, size 0x2f8, virtual true, abstract: false, final false
inline bool OnInstanceCreate(uint64_t  xrInstance) ;

/// @brief Method OnInstanceDestroy, addr 0x5ca1cd0, size 0xdc, virtual true, abstract: false, final false
inline void OnInstanceDestroy(uint64_t  xrInstance) ;

/// @brief Method OnSessionBegin, addr 0x5ca2070, size 0xdc, virtual true, abstract: false, final false
inline void OnSessionBegin(uint64_t  xrSession) ;

/// @brief Method OnSessionCreate, addr 0x5ca1dac, size 0xdc, virtual true, abstract: false, final false
inline void OnSessionCreate(uint64_t  xrSession) ;

/// @brief Method OnSessionDestroy, addr 0x5ca2304, size 0xdc, virtual true, abstract: false, final false
inline void OnSessionDestroy(uint64_t  xrSession) ;

/// @brief Method OnSessionEnd, addr 0x5ca214c, size 0xdc, virtual true, abstract: false, final false
inline void OnSessionEnd(uint64_t  xrSession) ;

/// @brief Method OnSessionExiting, addr 0x5ca2228, size 0xdc, virtual true, abstract: false, final false
inline void OnSessionExiting(uint64_t  xrSession) ;

/// @brief Method OnSessionStateChange, addr 0x5ca1f6c, size 0x104, virtual true, abstract: false, final false
inline void OnSessionStateChange(int32_t  oldState, int32_t  newState) ;

/// @brief Method .ctor, addr 0x5ca23e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_userPresent, addr 0x5ca181c, size 0x8c, virtual false, abstract: false, final false
