...
public:
  ...
  /// @brief Method HookGetInstanceProcAddr, addr 0x5e4d630, size 0x130, virtual true, abstract: false, final false
  inline ::System::IntPtr HookGetInstanceProcAddr(::System::IntPtr func);

  static inline ::Meta::XR::MetaXRFeature* New_ctor();

  /// @brief Method OnAppSpaceChange, addr 0x5e4dc10, size 0xe4, virtual true, abstract: false, final false
  inline void OnAppSpaceChange(uint64_t xrSpace);

  /// @brief Method OnInstanceCreate, addr 0x5e4d760, size 0x2f8, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t xrInstance);

  /// @brief Method OnInstanceDestroy, addr 0x5e4da58, size 0xdc, virtual true, abstract: false, final false
  inline void OnInstanceDestroy(uint64_t xrInstance);

  /// @brief Method OnSessionBegin, addr 0x5e4ddf8, size 0xdc, virtual true, abstract: false, final false
  inline void OnSessionBegin(uint64_t xrSession);

  /// @brief Method OnSessionCreate, addr 0x5e4db34, size 0xdc, virtual true, abstract: false, final false
  inline void OnSessionCreate(uint64_t xrSession);

  /// @brief Method OnSessionDestroy, addr 0x5e4e08c, size 0xdc, virtual true, abstract: false, final false
  inline void OnSessionDestroy(uint64_t xrSession);

  /// @brief Method OnSessionEnd, addr 0x5e4ded4, size 0xdc, virtual true, abstract: false, final false
  inline void OnSessionEnd(uint64_t xrSession);

  /// @brief Method OnSessionExiting, addr 0x5e4dfb0, size 0xdc, virtual true, abstract: false, final false
  inline void OnSessionExiting(uint64_t xrSession);

  /// @brief Method OnSessionStateChange, addr 0x5e4dcf4, size 0x104, virtual true, abstract: false, final false
  inline void OnSessionStateChange(int32_t oldState, int32_t newState);

  /// @brief Method .ctor, addr 0x5e4e168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_userPresent, addr 0x5e4d5a4, size 0x8c, virtual false, abstract: false, final false
