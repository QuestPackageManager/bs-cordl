...
public:
  ...
  /// @brief Method MetaGetEyeTrackedFoveationSupported, addr 0x5c3a798, size 0x90, virtual false, abstract: false, final false
  static inline void MetaGetEyeTrackedFoveationSupported(::ByRef<bool> supported);

  /// @brief Method MetaGetFoveationEyeTracked, addr 0x5c3a614, size 0x90, virtual false, abstract: false, final false
  static inline void MetaGetFoveationEyeTracked(::ByRef<bool> isEyeTracked);

  /// @brief Method MetaSetFoveationEyeTracked, addr 0x5c3a6f8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSessionCreate, addr 0x5c3a5a8, size 0x50, virtual true, abstract: false, final false
  inline void OnSessionCreate(uint64_t xrSession);

  /// @brief Method .ctor, addr 0x5c3a828, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline uint64_t getStaticF__xrSession();

  /// @brief Method get_eyeTrackedFoveatedRenderingEnabled, addr 0x5c3a5f8, size 0x1c, virtual false, abstract: false, final false
  static inline bool get_eyeTrackedFoveatedRenderingEnabled();

  /// @brief Method get_eyeTrackedFoveatedRenderingSupported, addr 0x5c3a77c, size 0x1c, virtual false, abstract: false, final false
  static inline bool get_eyeTrackedFoveatedRenderingSupported();

  static inline void setStaticF__xrSession(uint64_t value);

  /// @brief Method set_eyeTrackedFoveatedRenderingEnabled, addr 0x5c3a6a4, size 0x54, virtual false, abstract: false, final false
