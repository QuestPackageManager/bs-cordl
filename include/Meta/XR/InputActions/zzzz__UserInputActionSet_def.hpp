...
public:
  ...
  /// @brief Method ToString, addr 0x5c3c06c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c3c074, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
