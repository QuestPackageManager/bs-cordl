...
/// @brief Method ToString, addr 0x5ca3058, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ca3060, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
