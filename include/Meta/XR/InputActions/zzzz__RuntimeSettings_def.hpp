...
public:
  ...
  /// @brief Method .ctor, addr 0x5d14f14, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Instance, addr 0x5d14e04, size 0x110, virtual false, abstract: false, final false
