...
/// @brief Field InputActionDefinitions, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_InputActionDefinitions, put=__cordl_internal_set_InputActionDefinitions)) ::System::Collections::Generic::List_1<::Meta::XR::InputActions::UserInputActionSet*>*  InputActionDefinitions;

/// @brief Field InputActionSets, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_InputActionSets, put=__cordl_internal_set_InputActionSets)) ::System::Collections::Generic::List_1<::UnityW<::Meta::XR::InputActions::InputActionSet>>*  InputActionSets;
...
/// @brief Method .ctor, addr 0x5ca2f2c, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Instance, addr 0x5ca2e1c, size 0x110, virtual false, abstract: false, final false
