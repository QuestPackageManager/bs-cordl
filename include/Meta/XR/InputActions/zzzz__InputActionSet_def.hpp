...
/// @brief Method ToString, addr 0x5ca2d98, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ca2da0, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
