...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetaXRSpaceWarp", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MetaXRSpaceWarp(MetaXRSpaceWarp&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MetaXRSpaceWarp", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetaXRSpaceWarp(MetaXRSpaceWarpconst&) = delete;
