...
public:
  // Declarations
  /// @brief Method MetaSetAppSpacePosition, addr 0x5d14750, size 0x90, virtual false, abstract: false, final false
  static inline void MetaSetAppSpacePosition(float_t x, float_t y, float_t z);

  /// @brief Method MetaSetAppSpaceRotation, addr 0x5d147e4, size 0x98, virtual false, abstract: false, final false
  static inline void MetaSetAppSpaceRotation(float_t x, float_t y, float_t z, float_t w);

  /// @brief Method MetaSetSpaceWarp, addr 0x5d146d0, size 0x7c, virtual false, abstract: false, final false
  static inline void MetaSetSpaceWarp(bool enabled);

  static inline ::Meta::XR::MetaXRSpaceWarp* New_ctor();

  /// @brief Method SetAppSpacePosition, addr 0x5d1474c, size 0x4, virtual false, abstract: false, final false
  static inline void SetAppSpacePosition(float_t x, float_t y, float_t z);

  /// @brief Method SetAppSpaceRotation, addr 0x5d147e0, size 0x4, virtual false, abstract: false, final false
  static inline void SetAppSpaceRotation(float_t x, float_t y, float_t z, float_t w);

  /// @brief Method SetSpaceWarp, addr 0x5d146cc, size 0x4, virtual false, abstract: false, final false
  static inline void SetSpaceWarp(bool enabled);

  /// @brief Method .ctor, addr 0x5d1487c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
