...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetaXRSubsampledLayout", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MetaXRSubsampledLayout(MetaXRSubsampledLayout&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MetaXRSubsampledLayout", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetaXRSubsampledLayout(MetaXRSubsampledLayoutconst&) = delete;
