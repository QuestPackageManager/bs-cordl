...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::Samples::SampleMetadata::*)(int32_t)>(&::Meta::XR::Samples::SampleMetadata::SendEvent)> {
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::Samples::SampleMetadata*>::get(), "SendEvent", std::vector<Il2CppClass*>{},
...
inline ::Meta::XR::Samples::SampleMetadata* Meta::XR::Samples::SampleMetadata::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::Meta::XR::Samples::SampleMetadata*>());
}
