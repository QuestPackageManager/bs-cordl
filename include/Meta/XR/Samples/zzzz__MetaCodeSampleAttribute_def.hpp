...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetaCodeSampleAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MetaCodeSampleAttribute(MetaCodeSampleAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MetaCodeSampleAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetaCodeSampleAttribute(MetaCodeSampleAttributeconst&) = delete;
