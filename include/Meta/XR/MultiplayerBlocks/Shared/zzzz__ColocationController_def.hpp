...
public:
  ...
  /// @brief Method Awake, addr 0x5a71154, size 0xd8, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x5a7140c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
