...
/// @brief Method Awake, addr 0x58c1e14, size 0xd8, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x58c20cc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
