...
public:
  ...
  /// @brief Method get_IsSuccess, addr 0x59361b4, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59361d4, size 0x2cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x59364a0, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5936520, size 0x3c8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x59368e8, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5936968, size 0x3ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5936d14, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5936d94, size 0x3b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5937144, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method CreateRoom, addr 0x5935aa0, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmaking_RoomOperationResult>* CreateRoom();

  /// @brief Method CreateRoom, addr 0x5935b7c, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmaking_RoomOperationResult>*
  CreateRoom(::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmaking_RoomCreationOptions options);

  /// @brief Method GenerateRoomPassword, addr 0x593608c, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW GenerateRoomPassword();

  /// @brief Method JoinOpenRoom, addr 0x5935d68, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method JoinRoom, addr 0x5935c78, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmaking_RoomOperationResult>* JoinRoom(::StringW roomToken, ::StringW roomPassword);

  /// @brief Method LeaveRoom, addr 0x5935e58, size 0xc4, virtual false, abstract: false, final false
  inline void LeaveRoom();

  static inline ::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmaking* New_ctor();

  /// @brief Method OnEnable, addr 0x59359b4, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x593615c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConnectedRoomToken, addr 0x5935fd0, size 0xbc, virtual false, abstract: false, final false
  inline ::StringW get_ConnectedRoomToken();

  /// @brief Method get_IsConnected, addr 0x5935f1c, size 0xb4, virtual false, abstract: false, final false
  inline bool get_IsConnected();

  /// @brief Method get_IsPasswordProtected, addr 0x59359a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsPasswordProtected();

  /// @brief Method get_IsPrivate, addr 0x5935984, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsPrivate();

  /// @brief Method get_LobbyName, addr 0x5935974, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LobbyName();

  /// @brief Method get_MaxPlayersPerRoom, addr 0x5935994, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxPlayersPerRoom();

  /// @brief Method get_SupportsRoomPassword, addr 0x59360a8, size 0xb4, virtual false, abstract: false, final false
  inline bool get_SupportsRoomPassword();

  /// @brief Method set_IsPasswordProtected, addr 0x59359ac, size 0x8, virtual false, abstract: false, final false
  inline void set_IsPasswordProtected(bool value);

  /// @brief Method set_IsPrivate, addr 0x593598c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsPrivate(bool value);

  /// @brief Method set_LobbyName, addr 0x593597c, size 0x8, virtual false, abstract: false, final false
  inline void set_LobbyName(::StringW value);

  /// @brief Method set_MaxPlayersPerRoom, addr 0x593599c, size 0x8, virtual false, abstract: false, final false
