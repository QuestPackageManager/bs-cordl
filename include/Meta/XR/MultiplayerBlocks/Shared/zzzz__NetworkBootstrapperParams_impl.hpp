...
// Ctor Parameters [CppParam { name: "myPlayerId", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "myOculusId", ty: "uint64_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "ovrCameraRig", ty: "::UnityW<::GlobalNamespace::OVRCameraRig>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "sharedAnchorManager", ty: "::Meta::XR::MultiplayerBlocks::Colocation::SharedAnchorManager*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "colocationLauncher", ty:
// "::Meta::XR::MultiplayerBlocks::Colocation::AutomaticColocationLauncher*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "colocationController", ty:
// "::UnityW<::Meta::XR::MultiplayerBlocks::Shared::ColocationController>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "setupColocationReadyEvents", ty:
// "::System::Action*", modifiers: "", def_value: Some("{}"), comment: None }]
