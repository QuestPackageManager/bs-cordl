...
public:
  ...
  /// @brief Method MoveNext, addr 0x593470c, size 0x32c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5934cfc, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5934d04, size 0x38c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x59351b0, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Awake, addr 0x593403c, size 0xa0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::Meta::XR::MultiplayerBlocks::Shared::ColocationSessionEventHandler* New_ctor();

  /// @brief Method OnDestroy, addr 0x59345cc, size 0x13c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnSessionCreated, addr 0x593445c, size 0xb8, virtual false, abstract: false, final false
  inline void OnSessionCreated(::System::Guid groupUuid);

  /// @brief Method OnSessionDiscovered, addr 0x5934514, size 0xb8, virtual false, abstract: false, final false
  inline void OnSessionDiscovered(::System::Guid groupUuid);

  /// @brief Method Start, addr 0x59340dc, size 0x29c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5934708, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
