...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::ColocationSessionEventHandler__OnSessionCreated_d__7, "Meta.XR.MultiplayerBlocks.Shared",
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::ColocationSessionEventHandler__OnSessionDiscovered_d__8) == 0x48, "Size mismatch!");
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::ColocationSessionEventHandler) == 0x48, "Size mismatch!");
