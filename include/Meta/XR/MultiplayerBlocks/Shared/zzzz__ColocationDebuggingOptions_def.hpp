...
// Write type traits
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Shared::ColocationDebuggingOptions*);
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::ColocationDebuggingOptions*, "Meta.XR.MultiplayerBlocks.Shared", "ColocationDebuggingOptions");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a71148, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::ColocationDebuggingOptions) == 0x18, "Size mismatch!");
