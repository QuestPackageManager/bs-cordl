...
// Ctor Parameters [CppParam { name: "IsEntitled", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "Token", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "OculusUser", ty: "::Oculus::Platform::Models::User*", modifiers: "", def_value: Some("{}") }]
