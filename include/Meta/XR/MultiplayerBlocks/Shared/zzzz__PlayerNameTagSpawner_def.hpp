...
public:
  ...
  /// @brief Method MoveNext, addr 0x593cf34, size 0x16c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Meta::XR::MultiplayerBlocks::Shared::PlayerNameTagSpawner__SpawnCoroutine_d__4* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x593d0a0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x593d0a8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x593d0e0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x593cf30, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x593ca98, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetRandomName, addr 0x593cc4c, size 0x124, virtual false, abstract: false, final false
  inline ::StringW GetRandomName();

  static inline ::Meta::XR::MultiplayerBlocks::Shared::PlayerNameTagSpawner* New_ctor();

  /// @brief Method OnEntitlementFinished, addr 0x593caa0, size 0x1ac, virtual false, abstract: false, final false
  inline void OnEntitlementFinished(::Meta::XR::MultiplayerBlocks::Shared::PlatformInfo info);

  /// @brief Method SpawnCoroutine, addr 0x593ca38, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* SpawnCoroutine(::StringW playerName);

  /// @brief Method Start, addr 0x593c990, size 0xa8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x593cd70, size 0x1c0, virtual false, abstract: false, final false
  inline void _ctor();
