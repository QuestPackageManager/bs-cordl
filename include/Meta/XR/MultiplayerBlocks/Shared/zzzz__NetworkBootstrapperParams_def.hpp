...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::NetworkBootstrapperParams, "Meta.XR.MultiplayerBlocks.Shared", "NetworkBootstrapperParams");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Shared {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::NetworkBootstrapperParams) == 0x38, "Size mismatch!");
