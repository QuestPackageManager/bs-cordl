...
public:
  // Declarations
  /// @brief Method DecodeMatchInfoWithStruct, addr 0x59371d0, size 0x1b0, virtual false, abstract: false, final false
  static inline ::Meta::XR::MultiplayerBlocks::Shared::MatchInfo DecodeMatchInfoWithStruct(::StringW matchInfoString);

  /// @brief Method EncodeMatchInfoToSessionId, addr 0x593759c, size 0xd4, virtual false, abstract: false, final false
  static inline ::StringW EncodeMatchInfoToSessionId(::StringW roomId, ::StringW roomPassword);

  /// @brief Method EncodeMatchInfoWithStruct, addr 0x5937380, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW EncodeMatchInfoWithStruct(::StringW roomId, ::StringW roomPassword, ::StringW extra);

  /// @brief Method ExtractMatchInfoFromSessionId, addr 0x5937444, size 0x158, virtual false, abstract: false, final false
