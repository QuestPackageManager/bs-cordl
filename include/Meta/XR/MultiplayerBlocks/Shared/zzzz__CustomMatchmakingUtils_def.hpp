...
public:
// Declarations
/// @brief Method DecodeMatchInfoWithStruct, addr 0x58c5264, size 0x1b0, virtual false, abstract: false, final false
static inline ::Meta::XR::MultiplayerBlocks::Shared::MatchInfo DecodeMatchInfoWithStruct(::StringW  matchInfoString) ;

/// @brief Method EncodeMatchInfoToSessionId, addr 0x58c5630, size 0xd4, virtual false, abstract: false, final false
static inline ::StringW EncodeMatchInfoToSessionId(::StringW  roomId, ::StringW  roomPassword) ;

/// @brief Method EncodeMatchInfoWithStruct, addr 0x58c5414, size 0xc4, virtual false, abstract: false, final false
static inline ::StringW EncodeMatchInfoWithStruct(::StringW  roomId, ::StringW  roomPassword, ::StringW  extra) ;

/// @brief Method ExtractMatchInfoFromSessionId, addr 0x58c54d8, size 0x158, virtual false, abstract: false, final false
