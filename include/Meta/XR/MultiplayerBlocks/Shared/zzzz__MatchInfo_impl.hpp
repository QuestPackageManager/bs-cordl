...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::MultiplayerBlocks::Shared::MatchInfo::*)(::StringW, ::StringW, ::StringW)>(&::Meta::XR::MultiplayerBlocks::Shared::MatchInfo::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x58c5258;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::MultiplayerBlocks::Shared::MatchInfo>::get(),
                        ".ctor",
...
// Ctor Parameters [CppParam { name: "RoomId", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "RoomPassword", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "Extra", ty: "::StringW", modifiers: "", def_value: Some("{}") }]
