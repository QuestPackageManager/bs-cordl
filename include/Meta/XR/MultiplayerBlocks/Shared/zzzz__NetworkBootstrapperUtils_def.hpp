...
public:
  // Declarations
  /// @brief Method OnColocationFailed, addr 0x59358c8, size 0xac, virtual false, abstract: false, final false
  static inline void OnColocationFailed(::Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason e);

  /// @brief Method SetEntitlementIds, addr 0x59351b8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUpAndStartAutomaticColocation, addr 0x59351f8, size 0x388, virtual false, abstract: false, final false
