...
// Write type traits
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Shared::IAvatarBehaviour*);
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::IAvatarBehaviour*, "Meta.XR.MultiplayerBlocks.Shared", "IAvatarBehaviour");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Shared {
// Is value type: false
