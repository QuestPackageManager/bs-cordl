...
public:
// Declarations
/// @brief Method .ctor, addr 0x58c5258, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "RoomId", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "RoomPassword", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "Extra", ty: "::StringW", modifiers: "", def_value: None }]
