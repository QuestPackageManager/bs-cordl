...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::PlatformInfo, "Meta.XR.MultiplayerBlocks.Shared", "PlatformInfo");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Shared {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::PlatformInfo) == 0x18, "Size mismatch!");
