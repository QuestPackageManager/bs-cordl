...
// Ctor Parameters [CppParam { name: "IsEntitled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "Token", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "OculusUser", ty: "::Oculus::Platform::Models::User*", modifiers: "", def_value: None }]
