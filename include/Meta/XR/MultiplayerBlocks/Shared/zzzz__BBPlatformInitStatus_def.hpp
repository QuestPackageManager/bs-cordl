...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Shared::BBPlatformInitStatus, "Meta.XR.MultiplayerBlocks.Shared", "BBPlatformInitStatus");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Shared {
// Is value type: true
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Shared::BBPlatformInitStatus) == 0x4, "Size mismatch!");
