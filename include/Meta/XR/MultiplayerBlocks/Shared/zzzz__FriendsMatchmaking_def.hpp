...
public:
  ...
  /// @brief Method <LaunchFriendsInvitePanelAsync>b__0, addr 0x5938adc, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59380a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <LaunchRosterPanelAsync>b__0, addr 0x5938bc4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5938218, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ClearGroupPresence>b__0, addr 0x5938cac, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5938598, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SetGroupPresence>b__0, addr 0x5938d94, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59386d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5938df8, size 0x28c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5939084, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59390f0, size 0x250, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5939340, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5939348, size 0x198, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x59394e0, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59394e8, size 0x314, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x59397fc, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Awake, addr 0x59376a0, size 0x154, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ClearGroupPresence, addr 0x59383a0, size 0x130, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task_1<::Oculus::Platform::Message*>* ClearGroupPresence();

  /// @brief Method ClearGroupPresenceCallback, addr 0x593839c, size 0x4, virtual true, abstract: false, final false
  inline void ClearGroupPresenceCallback();

  /// @brief Method GetGroupPresenceOptions, addr 0x5938988, size 0xe0, virtual true, abstract: false, final false
  inline ::Oculus::Platform::GroupPresenceOptions* GetGroupPresenceOptions(::StringW roomId, ::StringW roomPassword);

  /// @brief Method JoinRoom, addr 0x59382d8, size 0xc4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* JoinRoom(::StringW roomId, ::StringW roomPassword);

  /// @brief Method LaunchFriendsInvitePanel, addr 0x5937f1c, size 0x8, virtual false, abstract: false, final false
  inline void LaunchFriendsInvitePanel();

  /// @brief Method LaunchFriendsInvitePanelAsync, addr 0x5937f24, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method LaunchRosterPanel, addr 0x59380a8, size 0x8, virtual false, abstract: false, final false
  inline void LaunchRosterPanel();

  /// @brief Method LaunchRosterPanelAsync, addr 0x59380b0, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x5937d38, size 0x1e4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5937b54, size 0x1e4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnEntitlementFinished, addr 0x59386d8, size 0x124, virtual false, abstract: false, final false
  inline void OnEntitlementFinished(::Meta::XR::MultiplayerBlocks::Shared::PlatformInfo info);

  /// @brief Method OnInvitationsSent, addr 0x59388a8, size 0x70, virtual false, abstract: false, final false
  inline void OnInvitationsSent(::Oculus::Platform::Message_1<::Oculus::Platform::Models::LaunchInvitePanelFlowResult*>* message);

  /// @brief Method OnJoinIntentReceived, addr 0x59387fc, size 0xac, virtual true, abstract: false, final false
  inline void OnJoinIntentReceived(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceJoinIntent*>* message);

  /// @brief Method OnLeaveIntentNotification, addr 0x5938918, size 0x70, virtual false, abstract: false, final false
  inline void OnLeaveIntentNotification(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceLeaveIntent*>* message);

  /// @brief Method OnRoomOperationResult, addr 0x593821c, size 0xbc, virtual true, abstract: false, final false
  inline void OnRoomOperationResult(::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmaking_RoomOperationResult result);

  /// @brief Method RegisterGameRoom, addr 0x59384d0, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RegisterGameRoom(::StringW roomId, ::StringW roomPassword);

  /// @brief Method SetGroupPresence, addr 0x593859c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5938a68, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DestinationApi, addr 0x5937670, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DestinationApi();

  /// @brief Method get_InviteMessage, addr 0x5937680, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InviteMessage();

  /// @brief Method get_MaxRetries, addr 0x5937690, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_MaxRetries();

  /// @brief Method set_DestinationApi, addr 0x5937678, size 0x8, virtual false, abstract: false, final false
  inline void set_DestinationApi(::StringW value);

  /// @brief Method set_InviteMessage, addr 0x5937688, size 0x8, virtual false, abstract: false, final false
  inline void set_InviteMessage(::StringW value);

  /// @brief Method set_MaxRetries, addr 0x5937698, size 0x8, virtual false, abstract: false, final false
