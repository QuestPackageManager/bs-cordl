...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlatformInit_", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlatformInit_(PlatformInit_&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlatformInit_", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlatformInit_(PlatformInit_const&) = delete;
