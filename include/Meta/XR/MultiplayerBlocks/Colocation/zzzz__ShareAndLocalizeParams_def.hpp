...
public:
// Declarations
/// @brief Method ToString, addr 0x58ceee4, size 0x2cc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x58cc520, size 0x14, virtual false, abstract: false, final false
inline void _ctor(uint64_t  requestingPlayerId, uint64_t  requestingPlayerOculusId, ::System::Guid  anchorUUID) ;

/// @brief Method .ctor, addr 0x58ceed4, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "requestingPlayerId", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "requestingPlayerOculusId", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "anchorUUID", ty: "::System::Guid", modifiers: "", def_value: None }, CppParam { name: "anchorFlowSucceeded", ty: "bool", modifiers: "", def_value: None }]
