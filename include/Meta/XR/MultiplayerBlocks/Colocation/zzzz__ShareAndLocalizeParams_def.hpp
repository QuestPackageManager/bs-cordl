...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5940e50, size 0x2cc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x593e48c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(uint64_t requestingPlayerId, uint64_t requestingPlayerOculusId, ::System::Guid anchorUUID);

  /// @brief Method .ctor, addr 0x5940e40, size 0x10, virtual false, abstract: false, final false
