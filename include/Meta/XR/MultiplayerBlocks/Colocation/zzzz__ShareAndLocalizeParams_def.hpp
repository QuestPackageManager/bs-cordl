...
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Colocation::ShareAndLocalizeParams, "Meta.XR.MultiplayerBlocks.Colocation", "ShareAndLocalizeParams");
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Colocation::ShareAndLocalizeParams) == 0x28, "Size mismatch!");
