...
constexpr ::Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason  Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason::AutomaticFailedToSaveAnchorToCloud{static_cast<int32_t>(0x1)};
...
constexpr ::Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason  Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason::AutomaticFailedToLocalizeAnchor{static_cast<int32_t>(0x3)};
