...
/// @brief Method Equals, addr 0x58cee98, size 0x3c, virtual true, abstract: false, final true
inline bool Equals(::Meta::XR::MultiplayerBlocks::Colocation::Player  other) ;

/// @brief Method .ctor, addr 0x58ccddc, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "playerId", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "oculusId", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "colocationGroupId", ty: "uint32_t", modifiers: "", def_value: None }]
