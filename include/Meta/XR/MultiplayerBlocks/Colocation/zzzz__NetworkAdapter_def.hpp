...
public:
  ...
  /// @brief Method SetConfig, addr 0x5935580, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NetworkData, addr 0x59403b0, size 0x4c, virtual false, abstract: false, final false
  static inline ::Meta::XR::MultiplayerBlocks::Colocation::INetworkData* get_NetworkData();

  /// @brief Method get_NetworkMessenger, addr 0x594044c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_NetworkData, addr 0x59403fc, size 0x50, virtual false, abstract: false, final false
  static inline void set_NetworkData(::Meta::XR::MultiplayerBlocks::Colocation::INetworkData* value);

  /// @brief Method set_NetworkMessenger, addr 0x5940498, size 0x50, virtual false, abstract: false, final false
