...
public:
  // Declarations
  /// @brief Method GetAllPlayersColocatedWith, addr 0x5940978, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllPlayersFromColocationGroupId, addr 0x59406c8, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOculusIdOfColocatedGroupOwnerFromColocationGroupId, addr 0x59404e8, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPlayerFromOculusId, addr 0x5940d00, size 0x104, virtual false, abstract: false, final false
