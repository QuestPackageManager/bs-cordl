...
public:
// Declarations
/// @brief Method GetAllPlayersColocatedWith, addr 0x58cea0c, size 0x388, virtual false, abstract: false, final false
...
/// @brief Method GetAllPlayersFromColocationGroupId, addr 0x58ce75c, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method GetOculusIdOfColocatedGroupOwnerFromColocationGroupId, addr 0x58ce57c, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method GetPlayerFromOculusId, addr 0x58ced94, size 0x104, virtual false, abstract: false, final false
