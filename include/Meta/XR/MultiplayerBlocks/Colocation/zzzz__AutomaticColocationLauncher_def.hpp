...
/// @brief Method MoveNext, addr 0x58cc908, size 0x4d4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58ccde8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x58ccdf0, size 0x490, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58cd280, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method MoveNext, addr 0x58cd288, size 0x4e0, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58cd784, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method MoveNext, addr 0x58cd78c, size 0x4f8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58cdd70, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method MoveNext, addr 0x58cdd78, size 0x54c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58ce3b0, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method AlignPlayerToAnchor, addr 0x58cbc88, size 0x84, virtual false, abstract: false, final false
inline void AlignPlayerToAnchor() ;

/// @brief Method ColocateAutomatically, addr 0x58c3958, size 0x4, virtual false, abstract: false, final false
inline void ColocateAutomatically() ;

/// @brief Method ColocateAutomaticallyInternal, addr 0x58cb5ac, size 0xa4, virtual false, abstract: false, final false
inline void ColocateAutomaticallyInternal() ;

/// @brief Method ColocateByPlayerWithOculusId, addr 0x58cb650, size 0x4, virtual false, abstract: false, final false
inline void ColocateByPlayerWithOculusId(uint64_t  oculusId) ;

/// @brief Method ColocateByPlayerWithOculusIdInternal, addr 0x58cb654, size 0xb4, virtual false, abstract: false, final false
inline void ColocateByPlayerWithOculusIdInternal(uint64_t  oculusId) ;

/// @brief Method CreateColocatedSpace, addr 0x58cb708, size 0x4, virtual false, abstract: false, final false
inline void CreateColocatedSpace() ;

/// @brief Method CreateColocatedSpaceInternal, addr 0x58cb70c, size 0x4, virtual false, abstract: false, final false
inline void CreateColocatedSpaceInternal() ;

/// @brief Method CreateNewColocatedSpace, addr 0x58cbbe4, size 0xa4, virtual false, abstract: false, final false
inline void CreateNewColocatedSpace() ;

/// @brief Method FindAlignmentAnchorUsedByOculusId, addr 0x58cb710, size 0x4d4, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Meta::XR::MultiplayerBlocks::Colocation::Anchor> FindAlignmentAnchorUsedByOculusId(uint64_t  oculusId) ;

/// @brief Method GetAllAlignmentAnchors, addr 0x58cbd0c, size 0x294, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Meta::XR::MultiplayerBlocks::Colocation::Anchor>* GetAllAlignmentAnchors() ;

/// @brief Method Init, addr 0x58c36a8, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method LocalizeAnchor, addr 0x58cc850, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method OnAnchorShareRequestCompleted, addr 0x58cc5f4, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method OnAnchorShareRequestReceived, addr 0x58cc534, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method SendAnchorShareRequest, addr 0x58cc068, size 0x4b8, virtual false, abstract: false, final false
inline void SendAnchorShareRequest(::Meta::XR::MultiplayerBlocks::Colocation::Anchor  anchor) ;

/// @brief Method ShareAndLocalizeAnchor, addr 0x58cbfa0, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58c36a4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_ColocationFailed, addr 0x58c3898, size 0xc0, virtual false, abstract: false, final false
inline void add_ColocationFailed(::System::Action_1<::Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason>*  value) ;

/// @brief Method add_ColocationReady, addr 0x58cb394, size 0xac, virtual false, abstract: false, final false
inline void add_ColocationReady(::System::Action*  value) ;

/// @brief Method remove_ColocationFailed, addr 0x58cb4ec, size 0xc0, virtual false, abstract: false, final false
inline void remove_ColocationFailed(::System::Action_1<::Meta::XR::MultiplayerBlocks::Colocation::ColocationFailedReason>*  value) ;

/// @brief Method remove_ColocationReady, addr 0x58cb440, size 0xac, virtual false, abstract: false, final false
