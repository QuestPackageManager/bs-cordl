...
/// @brief Method Awake, addr 0x58d2ba4, size 0xac, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::Meta::XR::MultiplayerBlocks::Colocation::AnchorDebugVisual* New_ctor() ;

/// @brief Method OnDebugVisibilityChanged, addr 0x58d2c50, size 0x84, virtual false, abstract: false, final false
inline void OnDebugVisibilityChanged() ;

/// @brief Method .ctor, addr 0x58d2cd4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add__debugVisibilityChanged, addr 0x58d28c0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method get_DebugVisualsVisible, addr 0x58d2aa0, size 0x5c, virtual false, abstract: false, final false
static inline bool get_DebugVisualsVisible() ;

/// @brief Method remove__debugVisibilityChanged, addr 0x58d29b0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method set_DebugVisualsVisible, addr 0x58d2afc, size 0xa8, virtual false, abstract: false, final false
