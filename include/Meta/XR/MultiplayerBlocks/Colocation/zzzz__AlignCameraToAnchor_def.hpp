...
/// @brief Field <CameraAlignmentAnchor>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__CameraAlignmentAnchor_k__BackingField, put=__cordl_internal_set__CameraAlignmentAnchor_k__BackingField)) ::UnityW<::GlobalNamespace::OVRSpatialAnchor>  _CameraAlignmentAnchor_k__BackingField;

/// @brief Method Align, addr 0x58cb190, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method RealignToAnchor, addr 0x58c3218, size 0x2c, virtual false, abstract: false, final false
inline void RealignToAnchor() ;

/// @brief Method Update, addr 0x58cb18c, size 0x4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x58cb390, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CameraAlignmentAnchor, addr 0x58cb17c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRSpatialAnchor> get_CameraAlignmentAnchor() ;

/// @brief Method set_CameraAlignmentAnchor, addr 0x58cb184, size 0x8, virtual false, abstract: false, final false
