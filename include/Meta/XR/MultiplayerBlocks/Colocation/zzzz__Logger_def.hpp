...
public:
  ...
  /// @brief Method GetPrefixMessage, addr 0x5944ff0, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW GetPrefixMessage(::Meta::XR::MultiplayerBlocks::Colocation::LogLevel logLevel);

  /// @brief Method Log, addr 0x5934c08, size 0xf4, virtual false, abstract: false, final false
  static inline void Log(::StringW message, ::Meta::XR::MultiplayerBlocks::Colocation::LogLevel logLevel);

  /// @brief Method LogError, addr 0x5944e98, size 0xac, virtual false, abstract: false, final false
  static inline void LogError(::StringW message);

  /// @brief Method LogInfo, addr 0x5944d40, size 0xac, virtual false, abstract: false, final false
  static inline void LogInfo(::StringW message);

  /// @brief Method LogSharedSpatialAnchorsError, addr 0x5944f44, size 0xac, virtual false, abstract: false, final false
  static inline void LogSharedSpatialAnchorsError(::StringW message);

  /// @brief Method LogVerbose, addr 0x5944c94, size 0xac, virtual false, abstract: false, final false
  static inline void LogVerbose(::StringW message);

  /// @brief Method LogWarning, addr 0x5944dec, size 0xac, virtual false, abstract: false, final false
  static inline void LogWarning(::StringW message);

  /// @brief Method SetAllLogsVisibility, addr 0x5933e58, size 0x60, virtual false, abstract: false, final false
  static inline void SetAllLogsVisibility(bool value);

  /// @brief Method SetLogLevelVisibility, addr 0x5933eb8, size 0x180, virtual false, abstract: false, final false
