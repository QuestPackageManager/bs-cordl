...
// Write type traits
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Colocation::Logger*);
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Colocation::Logger*, "Meta.XR.MultiplayerBlocks.Colocation", "Logger");
...
static_assert(sizeof(::Meta::XR::MultiplayerBlocks::Colocation::Logger) == 0x10, "Size mismatch!");
