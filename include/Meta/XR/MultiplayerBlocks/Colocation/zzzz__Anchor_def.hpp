...
/// @brief Method Equals, addr 0x58ce3b8, size 0x8c, virtual true, abstract: false, final true
inline bool Equals(::Meta::XR::MultiplayerBlocks::Colocation::Anchor  other) ;

/// @brief Method .ctor, addr 0x58cd768, size 0x1c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "isAutomaticAnchor", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isAlignmentAnchor", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "ownerOculusId", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "colocationGroupId", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "automaticAnchorUuid", ty: "::System::Guid", modifiers: "", def_value: None }]
