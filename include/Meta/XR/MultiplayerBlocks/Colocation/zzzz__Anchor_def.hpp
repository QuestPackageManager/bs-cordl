...
public:
  ...
  /// @brief Method Equals, addr 0x5940324, size 0x8c, virtual true, abstract: false, final true
  inline bool Equals(::Meta::XR::MultiplayerBlocks::Colocation::Anchor other);

  /// @brief Method .ctor, addr 0x593f6d4, size 0x1c, virtual false, abstract: false, final false
