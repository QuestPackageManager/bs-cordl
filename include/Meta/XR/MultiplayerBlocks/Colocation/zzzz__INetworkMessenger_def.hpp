...
// Write type traits
MARK_REF_T(::Meta::XR::MultiplayerBlocks::Colocation::INetworkMessenger*);
DEFINE_IL2CPP_CLASS(::Meta::XR::MultiplayerBlocks::Colocation::INetworkMessenger*, "Meta.XR.MultiplayerBlocks.Colocation", "INetworkMessenger");
// Dependencies
namespace Meta::XR::MultiplayerBlocks::Colocation {
// Is value type: false
