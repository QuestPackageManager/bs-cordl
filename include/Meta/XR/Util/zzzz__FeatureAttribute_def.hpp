...
public:
  ...
  /// @brief Method .ctor, addr 0x5d14d70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Meta::XR::Util::Feature feature);

  /// @brief Method get_Feature, addr 0x5d14d78, size 0x8, virtual false, abstract: false, final false
