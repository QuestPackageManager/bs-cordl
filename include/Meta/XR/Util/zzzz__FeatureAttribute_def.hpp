...
/// @brief Method .ctor, addr 0x5ca2d88, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Meta::XR::Util::Feature  feature) ;

/// @brief Method get_Feature, addr 0x5ca2d90, size 0x8, virtual false, abstract: false, final false
...
} // namespace end def Meta::XR::Util
