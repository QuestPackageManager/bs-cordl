...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Meta::XR::EnvironmentDepth::DepthProviderNotSupported::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5901f58;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::EnvironmentDepth::DepthProviderNotSupported*>::get(),
                                                 "Meta.XR.EnvironmentDepth.IDepthProvider.get_IsSupported", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::EnvironmentDepth::DepthProviderNotSupported::*)(bool)>(
  ...
  constexpr static std::size_t addrs = 0x5901f60;
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::EnvironmentDepth::DepthProviderNotSupported*>::get(),
                                                                               "Meta.XR.EnvironmentDepth.IDepthProvider.set_RemoveHands", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::EnvironmentDepth::DepthProviderNotSupported::*)(bool, bool)>(
  ...
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5901f64;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::EnvironmentDepth::DepthProviderNotSupported*>::get(), "Meta.XR.EnvironmentDepth.IDepthProvider.SetDepthEnabled",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Meta::XR::EnvironmentDepth::DepthProviderNotSupported::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::EnvironmentDepth::DepthProviderNotSupported*>::get(), "Meta.XR.EnvironmentDepth.IDepthProvider.TryGetUpdatedDepthTexture",
        std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 2>{
            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::UnityEngine::RenderTexture*>>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Meta::XR::EnvironmentDepth::DepthProviderNotSupported::*)()>(
  ...
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x58ff6d0;
...
inline bool Meta::XR::EnvironmentDepth::DepthProviderNotSupported::Meta_XR_EnvironmentDepth_IDepthProvider_TryGetUpdatedDepthTexture(
    ::ByRef<::UnityEngine::RenderTexture*> depthTexture, ::ArrayW<::Meta::XR::EnvironmentDepth::DepthFrameDesc, ::Array<::Meta::XR::EnvironmentDepth::DepthFrameDesc>*> frameDescriptors) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Meta::XR::EnvironmentDepth::DepthProviderNotSupported*>::get(), "Meta.XR.EnvironmentDepth.IDepthProvider.TryGetUpdatedDepthTexture",
      std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 2>{
