...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnvironmentDepthUtils", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnvironmentDepthUtils(EnvironmentDepthUtils&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnvironmentDepthUtils", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnvironmentDepthUtils(EnvironmentDepthUtilsconst&) = delete;
