...
public:
  ...
  /// @brief Method ApplyMask, addr 0x5a3bebc, size 0x928, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5a3b290, size 0x8c, virtual false, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x5a3bc78, size 0x244, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x5a3aca4, size 0xbc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CacheCameraRig, addr 0x5a3bbd8, size 0xa0, virtual false, abstract: false, final false
  inline void CacheCameraRig();

  /// @brief Method CreateProvider, addr 0x5a3a4b8, size 0x2ec, virtual false, abstract: false, final false
  static inline ::Meta::XR::EnvironmentDepth::IDepthProvider* CreateProvider();

  /// @brief Method GetTrackingSpaceWorldToLocalMatrix, addr 0x5a3b66c, size 0x144, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 GetTrackingSpaceWorldToLocalMatrix();

  /// @brief Method Log, addr 0x5a3cac8, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeforeRender, addr 0x5a3b31c, size 0x350, virtual false, abstract: false, final false
  inline void OnBeforeRender();

  /// @brief Method OnDestroy, addr 0x5a3b1a8, size 0xe8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5a3b018, size 0x190, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5a3ad60, size 0x21c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PreprocessDepthTexture, addr 0x5a3c7e4, size 0x2e4, virtual false, abstract: false, final false
  inline void PreprocessDepthTexture(::UnityEngine::RenderTexture* depthTexture);

  /// @brief Method ResetDepthTextureIfAvailable, addr 0x5a3af7c, size 0x9c, virtual false, abstract: false, final false
  inline void ResetDepthTextureIfAvailable();

  /// @brief Method SetOcclusionShaderKeywords, addr 0x5a3a918, size 0x1b0, virtual false, abstract: false, final false
  static inline void SetOcclusionShaderKeywords(::Meta::XR::EnvironmentDepth::OcclusionShadersMode mode);

  /// @brief Method TryFetchDepthTexture, addr 0x5a3b7b0, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a3cbec, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onDepthTextureUpdate, addr 0x5a3a2b4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsDepthAvailable, addr 0x5a3a874, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDepthAvailable();

  /// @brief Method get_IsSupported, addr 0x5a3a7a8, size 0xcc, virtual false, abstract: false, final false
  static inline bool get_IsSupported();

  /// @brief Method get_MaskBias, addr 0x5a3ac00, size 0x8, virtual false, abstract: false, final false
  inline float_t get_MaskBias();

  /// @brief Method get_MaskMeshFilters, addr 0x5a3a2a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::MeshFilter>>* get_MaskMeshFilters();

  /// @brief Method get_OcclusionShadersMode, addr 0x5a3a884, size 0x8, virtual false, abstract: false, final false
  inline ::Meta::XR::EnvironmentDepth::OcclusionShadersMode get_OcclusionShadersMode();

  /// @brief Method get_RemoveHands, addr 0x5a3aac8, size 0x8, virtual false, abstract: false, final false
  inline bool get_RemoveHands();

  /// @brief Method get_provider, addr 0x5a3a434, size 0x84, virtual false, abstract: false, final false
  static inline ::Meta::XR::EnvironmentDepth::IDepthProvider* get_provider();

  /// @brief Method remove_onDepthTextureUpdate, addr 0x5a3a374, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDepthAvailable, addr 0x5a3a87c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsDepthAvailable(bool value);

  /// @brief Method set_MaskBias, addr 0x5a3ac08, size 0x9c, virtual false, abstract: false, final false
  inline void set_MaskBias(float_t value);

  /// @brief Method set_MaskMeshFilters, addr 0x5a3a2ac, size 0x8, virtual false, abstract: false, final false
  inline void set_MaskMeshFilters(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::MeshFilter>>* value);

  /// @brief Method set_OcclusionShadersMode, addr 0x5a3a88c, size 0x8c, virtual false, abstract: false, final false
  inline void set_OcclusionShadersMode(::Meta::XR::EnvironmentDepth::OcclusionShadersMode value);

  /// @brief Method set_RemoveHands, addr 0x5a3aad0, size 0x130, virtual false, abstract: false, final false
