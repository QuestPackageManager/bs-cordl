...
DEFINE_IL2CPP_CLASS(::Meta::XR::EnvironmentDepth::DepthFrameDesc, "Meta.XR.EnvironmentDepth", "DepthFrameDesc");
...
static_assert(sizeof(::Meta::XR::EnvironmentDepth::DepthFrameDesc) == 0x34, "Size mismatch!");
