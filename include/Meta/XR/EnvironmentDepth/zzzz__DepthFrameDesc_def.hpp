...
// Ctor Parameters [CppParam { name: "createPoseLocation", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "createPoseRotation", ty: "::UnityEngine::Quaternion", modifiers: "", def_value: None }, CppParam { name: "fovLeftAngleTangent", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "fovRightAngleTangent", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "fovTopAngleTangent", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "fovDownAngleTangent", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "nearZ", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "farZ", ty: "float_t", modifiers: "", def_value: None }]
constexpr DepthFrameDesc(::UnityEngine::Vector3  createPoseLocation, ::UnityEngine::Quaternion  createPoseRotation, float_t  fovLeftAngleTangent, float_t  fovRightAngleTangent, float_t  fovTopAngleTangent, float_t  fovDownAngleTangent, float_t  nearZ, float_t  farZ) noexcept;
