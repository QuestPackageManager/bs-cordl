...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DepthProviderNotSupported", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DepthProviderNotSupported(DepthProviderNotSupported&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DepthProviderNotSupported", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DepthProviderNotSupported(DepthProviderNotSupportedconst&) = delete;
