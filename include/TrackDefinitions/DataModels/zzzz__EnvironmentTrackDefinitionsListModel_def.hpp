...
public:
  ...
  /// @brief Method .ctor, addr 0x2a0cb4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2a0c8b8, size 0x18, virtual false, abstract: false, final false
...
static_assert(offsetof(::TrackDefinitions::DataModels::EnvironmentTrackDefinitionsListModel, ____environmentTracksTypeMap) == 0x10, "Offset mismatch!");
