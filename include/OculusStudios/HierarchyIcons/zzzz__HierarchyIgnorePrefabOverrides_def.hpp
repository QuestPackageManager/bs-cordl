...
// Write type traits
MARK_REF_PTR_T(::OculusStudios::HierarchyIcons::HierarchyIgnorePrefabOverrides);
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df1dec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::OculusStudios::HierarchyIcons::HierarchyIgnorePrefabOverrides, 0x20>, "Size mismatch!");

} // namespace OculusStudios::HierarchyIcons
NEED_NO_BOX(::OculusStudios::HierarchyIcons::HierarchyIgnorePrefabOverrides);
DEFINE_IL2CPP_ARG_TYPE(::OculusStudios::HierarchyIcons::HierarchyIgnorePrefabOverrides*, "OculusStudios.HierarchyIcons", "HierarchyIgnorePrefabOverrides");
