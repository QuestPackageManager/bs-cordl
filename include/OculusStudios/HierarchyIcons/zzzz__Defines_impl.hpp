...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::HierarchyIcons::Defines::*)()>(&::OculusStudios::HierarchyIcons::Defines::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5df3500;
...
::cordl_internals::setStaticField<::System::Collections::Generic::Dictionary_2<::OculusStudios::HierarchyIcons::Icon,::StringW>*, "iconDatabase", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::HierarchyIcons::Defines*>::get>(std::forward<::System::Collections::Generic::Dictionary_2<::OculusStudios::HierarchyIcons::Icon,::StringW>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::Dictionary_2<::OculusStudios::HierarchyIcons::Icon,::StringW>*, "iconDatabase", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::HierarchyIcons::Defines*>::get>();
}
