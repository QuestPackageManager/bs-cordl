...
DEFINE_IL2CPP_CLASS(::OculusStudios::HierarchyIcons::Icon, "OculusStudios.HierarchyIcons", "Icon");
// Dependencies
namespace OculusStudios::HierarchyIcons {
// Is value type: true
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23590 };
...
static_assert(sizeof(::OculusStudios::HierarchyIcons::Icon) == 0x4, "Size mismatch!");
