...
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::RequestState, "OculusStudios.GraphQL.ClientInterface", "RequestState");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::RequestState) == 0x4, "Size mismatch!");
