...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::IGraphQLInputObject*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::IGraphQLInputObject*, "OculusStudios.GraphQL.ClientInterface", "IGraphQLInputObject");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: false
