...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::IGraphQLModel*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::IGraphQLModel*, "OculusStudios.GraphQL.ClientInterface", "IGraphQLModel");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: false
