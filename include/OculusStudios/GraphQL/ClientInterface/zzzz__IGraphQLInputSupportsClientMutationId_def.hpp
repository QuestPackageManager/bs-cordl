...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IGraphQLInputSupportsClientMutationId", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IGraphQLInputSupportsClientMutationId(IGraphQLInputSupportsClientMutationIdconst&) = delete;
