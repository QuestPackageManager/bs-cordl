...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::Defines*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::Defines*, "OculusStudios.GraphQL.ClientInterface", "Defines");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f2a030, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::Defines) == 0x10, "Size mismatch!");
