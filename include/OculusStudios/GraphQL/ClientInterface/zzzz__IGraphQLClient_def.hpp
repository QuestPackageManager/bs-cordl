...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::IGraphQLClient*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::IGraphQLClient*, "OculusStudios.GraphQL.ClientInterface", "IGraphQLClient");
...
public:
  ...
  /// @brief Method OnApplicationResumed, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void OnApplicationResumed();

  /// @brief Method OnApplicationSuspended, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method ResetRequestForUserInitiatedRetryAsync, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method ResumeRequestQueue, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void ResumeRequestQueue();

  /// @brief Method SetApplicationOffline, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IGraphQLClient", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IGraphQLClient(IGraphQLClientconst&) = delete;
