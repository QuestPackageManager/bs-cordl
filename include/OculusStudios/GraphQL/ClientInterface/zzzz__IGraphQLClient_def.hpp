...
public:
  ...
  /// @brief Method Mutate, addr 0x5df07dc, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method Query, addr 0x5df071c, size 0xc0, virtual true, abstract: false, final false
