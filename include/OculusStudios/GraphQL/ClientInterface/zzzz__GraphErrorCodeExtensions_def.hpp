...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphErrorCodeExtensions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphErrorCodeExtensions(GraphErrorCodeExtensions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphErrorCodeExtensions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphErrorCodeExtensions(GraphErrorCodeExtensionsconst&) = delete;
