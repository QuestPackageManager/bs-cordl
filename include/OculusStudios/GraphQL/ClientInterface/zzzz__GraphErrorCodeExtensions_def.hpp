...
public:
  // Declarations
  /// @brief Method GetGraphQLErrorCode, addr 0x5df0660, size 0xbc, virtual false, abstract: false, final false
  static inline ::OculusStudios::GraphQL::ClientInterface::GraphErrorCode GetGraphQLErrorCode(int32_t code);

  /// @brief Method IsGraphQLErrorCode, addr 0x5df05b0, size 0xb0, virtual false, abstract: false, final false
