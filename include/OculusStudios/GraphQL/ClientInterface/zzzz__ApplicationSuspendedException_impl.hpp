...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException::*)()>(&::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x5d7e220;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException::*)(::StringW)>(&::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException::_ctor)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x5d7e278;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException::*)(::StringW, ::System::Exception*)>(&::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException::_ctor)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x5d7e2e4;
...
inline ::OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException* OculusStudios::GraphQL::ClientInterface::ApplicationSuspendedException::New_ctor(::StringW  message, ::System::Exception*  inner)  {
