...
constexpr ::OculusStudios::GraphQL::ClientInterface::GraphErrorCode  OculusStudios::GraphQL::ClientInterface::GraphErrorCode::GRAPH_QL__REJECTED_DUE_TO_PEAK_OPTIMIZATION{static_cast<int32_t>(0x198f19)};
...
constexpr ::OculusStudios::GraphQL::ClientInterface::GraphErrorCode  OculusStudios::GraphQL::ClientInterface::GraphErrorCode::GRAPH_QL__LEGACY_STRING_QUERY_NOT_ALLOWLISTED{static_cast<int32_t>(0x198f1f)};
constexpr ::OculusStudios::GraphQL::ClientInterface::GraphErrorCode  OculusStudios::GraphQL::ClientInterface::GraphErrorCode::GRAPH_QL__MODERN_STRING_QUERY_NOT_ALLOWLISTED{static_cast<int32_t>(0x198f20)};
