...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation*, "OculusStudios.GraphQL.ClientInterface", "IGraphQLOperation");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: false
