...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NotInitializedException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NotInitializedException(NotInitializedException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NotInitializedException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NotInitializedException(NotInitializedExceptionconst&) = delete;
