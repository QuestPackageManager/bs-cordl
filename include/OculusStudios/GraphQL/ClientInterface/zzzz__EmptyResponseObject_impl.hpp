...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::ClientInterface::EmptyResponseObject::*)()>(&::OculusStudios::GraphQL::ClientInterface::EmptyResponseObject::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5d7e21c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::ClientInterface::EmptyResponseObject*>::get(),
                        ".ctor",
...
constexpr ::OculusStudios::GraphQL::ClientInterface::IGraphQLModel* OculusStudios::GraphQL::ClientInterface::EmptyResponseObject::i___OculusStudios__GraphQL__ClientInterface__IGraphQLModel() noexcept {
return static_cast<::OculusStudios::GraphQL::ClientInterface::IGraphQLModel*>(static_cast<void*>(this));
}
// Ctor Parameters []
