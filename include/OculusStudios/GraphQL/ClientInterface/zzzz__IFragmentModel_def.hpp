...
public:
  ...
  /// @brief Method set_TypeName, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void set_TypeName(::StringW value);

  // Ctor Parameters [CppParam { name: "", ty: "IFragmentModel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFragmentModel(IFragmentModelconst&) = delete;
