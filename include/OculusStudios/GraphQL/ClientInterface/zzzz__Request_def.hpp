...
/// @brief Field _attempts, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__attempts, put=__cordl_internal_set__attempts)) ::System::Collections::Generic::List_1<::OculusStudios::GraphQL::ClientInterface::AttemptData*>*  _attempts;
...
/// @brief Field onRequestStateUpdated, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_onRequestStateUpdated, put=__cordl_internal_set_onRequestStateUpdated)) ::System::Action_2<::OculusStudios::GraphQL::ClientInterface::Request*,::OculusStudios::GraphQL::ClientInterface::RequestState>*  onRequestStateUpdated;
...
/// @brief Method Cancel, addr 0x5d7f728, size 0x28, virtual false, abstract: false, final false
inline void Cancel() ;
...
/// @brief Method GetFailureHandlingMethod, addr 0x5d7ee20, size 0x8, virtual true, abstract: false, final false
inline ::OculusStudios::GraphQL::ClientInterface::FailureHandlingMethod GetFailureHandlingMethod() ;

/// @brief Method GetLastException, addr 0x5d7ee28, size 0x90, virtual true, abstract: false, final false
inline ::System::Exception* GetLastException() ;

/// @brief Method GetTimeoutMs, addr 0x5d7ee18, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method OnRequestStateChanged, addr 0x5d7f404, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method RegisterException, addr 0x5d7f604, size 0xd4, virtual false, abstract: false, final false
inline void RegisterException(::System::Exception*  e) ;

/// @brief Method RegisterRawResponseData, addr 0x5d7f530, size 0xd4, virtual false, abstract: false, final false
inline void RegisterRawResponseData(::StringW  json) ;

/// @brief Method ResetStateForUserInitiatedRetry, addr 0x5d7eeb8, size 0x3dc, virtual false, abstract: false, final false
inline void ResetStateForUserInitiatedRetry() ;

/// @brief Method SetRequestId, addr 0x5d7f294, size 0x64, virtual false, abstract: false, final false
inline void SetRequestId(int64_t  newRequestId) ;

/// @brief Method SetRequestState, addr 0x5d7f2f8, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method System.IDisposable.Dispose, addr 0x5d7f6d8, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5d7ecd4, size 0x144, virtual false, abstract: false, final false
inline void _ctor(bool  forceRequestWhenOffline, ::OculusStudios::GraphQL::ClientInterface::RequestType  requestType) ;

/// @brief Method add_onRequestStateUpdated, addr 0x5d7eacc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_attempts, addr 0x5d7eccc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::OculusStudios::GraphQL::ClientInterface::AttemptData*>* get_attempts() ;

/// @brief Method get_attemptsPerformed, addr 0x5d7ec80, size 0x4c, virtual false, abstract: false, final false
inline int32_t get_attemptsPerformed() ;

/// @brief Method get_cancellationToken, addr 0x5d7ec4c, size 0x24, virtual false, abstract: false, final false
inline ::System::Threading::CancellationToken get_cancellationToken() ;

/// @brief Method get_requestId, addr 0x5d7ec70, size 0x8, virtual false, abstract: false, final false
inline int64_t get_requestId() ;

/// @brief Method get_requestState, addr 0x5d7ec78, size 0x8, virtual false, abstract: false, final false
inline ::OculusStudios::GraphQL::ClientInterface::RequestState get_requestState() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_onRequestStateUpdated, addr 0x5d7eb8c, size 0xc0, virtual false, abstract: false, final false
