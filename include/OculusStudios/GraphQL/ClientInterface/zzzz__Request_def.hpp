...
public:
  ...
  /// @brief Method GetLastException, addr 0x5f2ce6c, size 0x90, virtual true, abstract: false, final false
  inline ::System::Exception* GetLastException();

  /// @brief Method GetTimeoutMs, addr 0x5f2ce5c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method RegisterRawResponseData, addr 0x5f2d574, size 0xd4, virtual false, abstract: false, final false
  inline void RegisterRawResponseData(::StringW json);

  /// @brief Method ResetStateForUserInitiatedRetry, addr 0x5f2cefc, size 0x3dc, virtual false, abstract: false, final false
  inline void ResetStateForUserInitiatedRetry();

  /// @brief Method SetRequestId, addr 0x5f2d2d8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method get_attempts, addr 0x5f2cd10, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::OculusStudios::GraphQL::ClientInterface::AttemptData*>* get_attempts();

  /// @brief Method get_attemptsPerformed, addr 0x5f2ccc4, size 0x4c, virtual false, abstract: false, final false
  inline int32_t get_attemptsPerformed();

  /// @brief Method get_cancellationToken, addr 0x5f2cc90, size 0x24, virtual false, abstract: false, final false
  inline ::System::Threading::CancellationToken get_cancellationToken();

  /// @brief Method get_requestId, addr 0x5f2ccb4, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_requestId();

  /// @brief Method get_requestState, addr 0x5f2ccbc, size 0x8, virtual false, abstract: false, final false
