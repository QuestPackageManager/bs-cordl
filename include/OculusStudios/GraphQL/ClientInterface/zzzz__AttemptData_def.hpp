...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AttemptData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AttemptData(AttemptData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AttemptData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AttemptData(AttemptDataconst&) = delete;
