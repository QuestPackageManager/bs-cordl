...
/// @brief Method FinishAttempt, addr 0x5df249c, size 0x6c, virtual false, abstract: false, final false
inline void FinishAttempt() ;

/// @brief Method IsFinished, addr 0x5df2508, size 0x6c, virtual false, abstract: false, final false
inline bool IsFinished() ;

static inline ::OculusStudios::GraphQL::ClientInterface::AttemptData* New_ctor() ;

/// @brief Method RegisterException, addr 0x5df25d0, size 0x5c, virtual false, abstract: false, final false
inline void RegisterException(::System::Exception*  e) ;

/// @brief Method RegisterRawResponseData, addr 0x5df2574, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5df242c, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ended, addr 0x5df2414, size 0x8, virtual false, abstract: false, final false
inline ::System::DateTime get_ended() ;

/// @brief Method get_exception, addr 0x5df2424, size 0x8, virtual false, abstract: false, final false
inline ::System::Exception* get_exception() ;

/// @brief Method get_rawResponseData, addr 0x5df241c, size 0x8, virtual false, abstract: false, final false
