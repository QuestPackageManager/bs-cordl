...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::ClientInterface::AttemptData*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::AttemptData*, "OculusStudios.GraphQL.ClientInterface", "AttemptData");
...
public:
  ...
  /// @brief Method FinishAttempt, addr 0x5f2a754, size 0x6c, virtual false, abstract: false, final false
  inline void FinishAttempt();

  /// @brief Method IsFinished, addr 0x5f2a7c0, size 0x6c, virtual false, abstract: false, final false
  inline bool IsFinished();

  static inline ::OculusStudios::GraphQL::ClientInterface::AttemptData* New_ctor();

  /// @brief Method RegisterException, addr 0x5f2a888, size 0x5c, virtual false, abstract: false, final false
  inline void RegisterException(::System::Exception* e);

  /// @brief Method RegisterRawResponseData, addr 0x5f2a82c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f2a6e4, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ended, addr 0x5f2a6cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::DateTime get_ended();

  /// @brief Method get_exception, addr 0x5f2a6dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Exception* get_exception();

  /// @brief Method get_rawResponseData, addr 0x5f2a6d4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::AttemptData) == 0x30, "Size mismatch!");
