...
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::ClientInterface::RequestType, "OculusStudios.GraphQL.ClientInterface", "RequestType");
// Dependencies
namespace OculusStudios::GraphQL::ClientInterface {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::GraphQL::ClientInterface::RequestType) == 0x1, "Size mismatch!");
