...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<uint64_t (::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation::*)()>(
    &::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation::GetPersistedQueryID)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation*>(),
                                                                                          { ::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Collections::Generic::IDictionary_2<::StringW, ::System::Object*>* (
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation*>(),
                                                                                          { ::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation*>(), 1 }));
    return ___internal_method;
  }
};
inline uint64_t OculusStudios::GraphQL::ClientInterface::IGraphQLOperation::GetPersistedQueryID() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation*>(), 0 })));
...
inline ::System::Collections::Generic::IDictionary_2<::StringW, ::System::Object*>* OculusStudios::GraphQL::ClientInterface::IGraphQLOperation::GetParams() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::OculusStudios::GraphQL::ClientInterface::IGraphQLOperation*>(), 1 })));
