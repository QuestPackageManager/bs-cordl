...
// Write type traits
MARK_GEN_REF_PTR_T(::OculusStudios::GraphQL::Client::NestedFragmentConverter_1);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::OculusStudios::GraphQL::Client::NestedFragmentConverter_1, "OculusStudios.GraphQL.Client", "NestedFragmentConverter`1");
