...
public:
  ...
  /// @brief Method <ExecuteAsync>b__0, addr 0x5de4520, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5de451c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5de45dc, size 0x3b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5de498c, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5de49f8, size 0x480, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5de4e78, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5de4ef8, size 0x380, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5de5278, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5de52e4, size 0x330, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5de5614, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5de5680, size 0x27c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5de58fc, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method CleanupRequest, addr 0x5de39f0, size 0x78, virtual false, abstract: false, final false
  inline void CleanupRequest(int64_t requestId, ::OculusStudios::GraphQL::ClientInterface::Request* request);

  /// @brief Method CleanupRequestAsync, addr 0x5de3a68, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteAsync, addr 0x5de3900, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method LogRequestState, addr 0x5de413c, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method OculusStudios.GraphQL.ClientInterface.IGraphQLClient.Initialize, addr 0x5de2eb0, size 0x164, virtual true, abstract: false, final true
  ...
  /// @brief Method OnApplicationResumed, addr 0x5de3fec, size 0x150, virtual true, abstract: false, final true
  inline void OnApplicationResumed();

  /// @brief Method OnApplicationSuspended, addr 0x5de3eb8, size 0x134, virtual true, abstract: false, final true
  inline void OnApplicationSuspended();

  /// @brief Method PauseRequestQueue, addr 0x5de3cac, size 0x108, virtual true, abstract: false, final true
  inline void PauseRequestQueue();

  /// @brief Method ProcessRequest, addr 0x5de383c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetRequestForUserInitiatedRetryAsync, addr 0x5de3bec, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method ResumeRequestQueue, addr 0x5de3db4, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method SetApplicationOffline, addr 0x5de4308, size 0x8, virtual true, abstract: false, final true
  inline void SetApplicationOffline();

  /// @brief Method SetApplicationOnline, addr 0x5de42fc, size 0xc, virtual true, abstract: false, final true
  inline void SetApplicationOnline();

  /// @brief Method Update, addr 0x5de30d8, size 0x3ec, virtual true, abstract: false, final true
  inline void Update(float_t deltaTime);

  /// @brief Method WaitUntilRequestQueueIsResumed, addr 0x5de3b2c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5de4310, size 0x178, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onRequestCreated, addr 0x5de2cf0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onRequestCreated, addr 0x5de2dd0, size 0xe0, virtual false, abstract: false, final false
