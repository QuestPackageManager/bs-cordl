...
/// @brief Field <StackTrace>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__StackTrace_k__BackingField, put=__cordl_internal_set__StackTrace_k__BackingField)) ::System::Collections::Generic::List_1<::StringW>*  _StackTrace_k__BackingField;
...
/// @brief Method .ctor, addr 0x5d73aa4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Class, addr 0x5d73a74, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Class() ;

/// @brief Method get_Message, addr 0x5d73a84, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Message() ;

/// @brief Method get_StackTrace, addr 0x5d73a94, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::StringW>* get_StackTrace() ;

/// @brief Method set_Class, addr 0x5d73a7c, size 0x8, virtual false, abstract: false, final false
inline void set_Class(::StringW  value) ;

/// @brief Method set_Message, addr 0x5d73a8c, size 0x8, virtual false, abstract: false, final false
inline void set_Message(::StringW  value) ;

/// @brief Method set_StackTrace, addr 0x5d73a9c, size 0x8, virtual false, abstract: false, final false
