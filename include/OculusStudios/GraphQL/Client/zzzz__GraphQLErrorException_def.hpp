...
public:
  ...
  /// @brief Method .ctor, addr 0x5de5a8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Class, addr 0x5de5a5c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Class();

  /// @brief Method get_Message, addr 0x5de5a6c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_StackTrace, addr 0x5de5a7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_StackTrace();

  /// @brief Method set_Class, addr 0x5de5a64, size 0x8, virtual false, abstract: false, final false
  inline void set_Class(::StringW value);

  /// @brief Method set_Message, addr 0x5de5a74, size 0x8, virtual false, abstract: false, final false
  inline void set_Message(::StringW value);

  /// @brief Method set_StackTrace, addr 0x5de5a84, size 0x8, virtual false, abstract: false, final false
