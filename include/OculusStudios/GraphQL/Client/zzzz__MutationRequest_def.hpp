...
/// @brief Field performRequestCalled, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_performRequestCalled, put=__cordl_internal_set_performRequestCalled)) ::System::Action_1<::OculusStudios::GraphQL::Client::MutationRequest*>*  performRequestCalled;
...
/// @brief Method GetCodeGenInfo, addr 0x5d74c44, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method PerformRequest, addr 0x5d74c24, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d74ba8, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::OculusStudios::GraphQL::Client::GraphQLMutationOperation*  mutation, bool  forceRequestWhenOffline) ;

/// @brief Method add_performRequestCalled, addr 0x5d74a28, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_performRequestCalled, addr 0x5d74ae8, size 0xc0, virtual false, abstract: false, final false
