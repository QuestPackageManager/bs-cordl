...
public:
  ...
  /// @brief Method GetCodeGenInfo, addr 0x5f20a5c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method PerformRequest, addr 0x5f20a3c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f209c0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::OculusStudios::GraphQL::Client::GraphQLMutationOperation* mutation, bool forceRequestWhenOffline);

  /// @brief Method add_performRequestCalled, addr 0x5f20840, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_performRequestCalled, addr 0x5f20900, size 0xc0, virtual false, abstract: false, final false
