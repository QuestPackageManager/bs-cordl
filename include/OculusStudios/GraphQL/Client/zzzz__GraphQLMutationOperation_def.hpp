...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLMutationOperation*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLMutationOperation*, "OculusStudios.GraphQL.Client", "GraphQLMutationOperation");
...
public:
  ...
  /// @brief Method SetData, addr 0x5f21be4, size 0x80, virtual false, abstract: false, final false
  inline void SetData(::System::Object* o);

  /// @brief Method .ctor, addr 0x5f21c64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLMutationOperation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLMutationOperation(GraphQLMutationOperation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLMutationOperation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLMutationOperation(GraphQLMutationOperationconst&) = delete;
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLMutationOperation) == 0x18, "Size mismatch!");
