...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLUtils*);
MARK_GEN_REF_T_PTR(::OculusStudios::GraphQL::Client::GraphQLUtils___c__DisplayClass6_0_1);
...
public:
  ...
  /// @brief Method Convert4Json, addr 0x5f21cf4, size 0x824, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertObject2Json, addr 0x5f228b8, size 0x11c, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLUtils) == 0x10, "Size mismatch!");
