...
template<typename T>
struct GraphQLUtils__DeserializeAsync_d__6_1;
}
namespace OculusStudios::GraphQL::Client {
template<typename T>
class GraphQLUtils___c__DisplayClass6_0_1;
}
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<T>", modifiers: "", def_value: None }, CppParam { name: "data", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<T>", modifiers: "", def_value: None }]
constexpr GraphQLUtils__DeserializeAsync_d__6_1(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<T>  __t__builder, ::StringW  data, ::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<T>  __u__1) noexcept;
...
// Declarations
template<typename T>
using _DeserializeAsync_d__6_1 = ::OculusStudios::GraphQL::Client::GraphQLUtils__DeserializeAsync_d__6_1<T>;

template<typename T>
using __c__DisplayClass6_0_1 = ::OculusStudios::GraphQL::Client::GraphQLUtils___c__DisplayClass6_0_1<T>;

/// @brief Method Convert4Json, addr 0x5d73d40, size 0x824, virtual false, abstract: false, final false
...
/// @brief Method ConvertObject2Json, addr 0x5d74904, size 0x11c, virtual false, abstract: false, final false
...
template<typename T>
static inline ::System::Collections::Generic::List_1<T>* ConvertString2Enum(::System::Collections::Generic::List_1<::StringW>*  strList) ;

/// @brief Method ConvertString2Enum, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T ConvertString2Enum(::StringW  str) ;

/// @brief Method DeserializeAsync, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::Threading::Tasks::Task_1<T>* DeserializeAsync(::StringW  data) ;

/// @brief Method IsUnknown, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool IsUnknown(T  enumValue) ;
