...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLClientInfraException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLClientInfraException(GraphQLClientInfraException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLClientInfraException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLClientInfraException(GraphQLClientInfraExceptionconst&) = delete;
