...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor::*)(::System::Collections::IEnumerator*, bool)>(&::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor::StartOnMainThread)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x5de7608;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor*>::get(),
                        "StartOnMainThread",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::IEnumerator*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor::*)(::System::Action*)>(&::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor::RunOnMainThread)> {
  constexpr static std::size_t size = 0x14c;
  constexpr static std::size_t addrs = 0x5de7640;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor::*)()>(&::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor::RunPendingActions)> {
  constexpr static std::size_t size = 0x378;
  constexpr static std::size_t addrs = 0x5de503c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor::*)()>(&::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor::_ctor)> {
  constexpr static std::size_t size = 0x94;
  constexpr static std::size_t addrs = 0x5de6000;
