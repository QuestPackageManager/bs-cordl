...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::Client::GraphQLResponseParseException::*)()>(&::OculusStudios::GraphQL::Client::GraphQLResponseParseException::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5d70ce4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLResponseParseException*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::Client::GraphQLResponseParseException::*)(::StringW, ::System::Exception*)>(&::OculusStudios::GraphQL::Client::GraphQLResponseParseException::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5d7082c;
...
inline ::OculusStudios::GraphQL::Client::GraphQLResponseParseException* OculusStudios::GraphQL::Client::GraphQLResponseParseException::New_ctor(::StringW  message, ::System::Exception*  innerException)  {
