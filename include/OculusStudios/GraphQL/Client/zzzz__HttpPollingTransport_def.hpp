...
/// @brief Method <ExecuteAsync>b__0, addr 0x5d78834, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d78830, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x5d78850, size 0x424, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5d78e14, size 0x80, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::OculusStudios::GraphQL::Client::GraphQLResponseStream*>", modifiers: "", def_value: None }, CppParam { name: "graphQLRequest", ty: "::OculusStudios::GraphQL::Client::GraphQLRequest*", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::OculusStudios::GraphQL::Client::HttpPollingTransport*", modifiers: "", def_value: None }, CppParam { name: "executor", ty: "::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor*", modifiers: "", def_value: None }, CppParam { name: "__8__1", ty: "::OculusStudios::GraphQL::Client::HttpPollingTransport___c__DisplayClass12_0*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::OculusStudios::GraphQL::Client::GraphQLResponseStream*>", modifiers: "", def_value: None }]
...
/// @brief Method MoveNext, addr 0x5d78e94, size 0x45c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5d792f0, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "liveQuery", ty: "::OculusStudios::GraphQL::Client::GraphQLLiveQuery*", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::OculusStudios::GraphQL::Client::HttpPollingTransport*", modifiers: "", def_value: None }, CppParam { name: "operation", ty: "::OculusStudios::GraphQL::Client::GraphQLResponseStream*", modifiers: "", def_value: None }, CppParam { name: "executor", ty: "::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor*", modifiers: "", def_value: None }, CppParam { name: "_httpTransport_5__2", ty: "::OculusStudios::GraphQL::Client::HttpTransport*", modifiers: "", def_value: None }, CppParam { name: "_lastResponse_5__3", ty: "::OculusStudios::GraphQL::Client::GraphQLResponse*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::OculusStudios::GraphQL::Client::GraphQLResponseStream*>", modifiers: "", def_value: None }]
constexpr HttpPollingTransport__StartHttpPollingAsync_d__13(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::OculusStudios::GraphQL::Client::GraphQLLiveQuery*  liveQuery, ::OculusStudios::GraphQL::Client::HttpPollingTransport*  __4__this, ::OculusStudios::GraphQL::Client::GraphQLResponseStream*  operation, ::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor*  executor, ::OculusStudios::GraphQL::Client::HttpTransport*  _httpTransport_5__2, ::OculusStudios::GraphQL::Client::GraphQLResponse*  _lastResponse_5__3, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1, ::System::Runtime::CompilerServices::TaskAwaiter_1<::OculusStudios::GraphQL::Client::GraphQLResponseStream*>  __u__2) noexcept;
...
/// @brief Method Dispose, addr 0x5d78794, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method ExecuteAsync, addr 0x5d785d8, size 0xf4, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::OculusStudios::GraphQL::Client::GraphQLResponseStream*>* ExecuteAsync(::OculusStudios::GraphQL::Client::GraphQLRequest*  graphQLRequest, ::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor*  executor) ;

/// @brief Method GetHttpTransport, addr 0x5d78548, size 0x90, virtual false, abstract: false, final false
inline ::OculusStudios::GraphQL::Client::HttpTransport* GetHttpTransport(::StringW  endpoint, ::StringW  accessToken, ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>*  customAppHeaders) ;

static inline ::OculusStudios::GraphQL::Client::HttpPollingTransport* New_ctor() ;

/// @brief Method StartHttpPollingAsync, addr 0x5d786cc, size 0xc8, virtual false, abstract: false, final false
inline void StartHttpPollingAsync(::OculusStudios::GraphQL::Client::GraphQLLiveQuery*  liveQuery, ::OculusStudios::GraphQL::Client::GraphQLResponseStream*  operation, ::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor*  executor) ;
...
/// @brief Method .ctor, addr 0x5d78798, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF_TOTAL_NUM_POLL_REQUESTS() ;

/// @brief Method get_AccessToken, addr 0x5d78538, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AccessToken() ;

/// @brief Method get_Endpoint, addr 0x5d78528, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_AccessToken, addr 0x5d78540, size 0x8, virtual false, abstract: false, final false
inline void set_AccessToken(::StringW  value) ;

/// @brief Method set_Endpoint, addr 0x5d78530, size 0x8, virtual false, abstract: false, final false
