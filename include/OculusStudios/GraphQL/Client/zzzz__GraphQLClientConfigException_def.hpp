...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLClientConfigException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLClientConfigException(GraphQLClientConfigException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLClientConfigException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLClientConfigException(GraphQLClientConfigExceptionconst&) = delete;
