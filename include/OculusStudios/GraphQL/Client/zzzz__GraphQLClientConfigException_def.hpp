...
public:
  ...
  /// @brief Method .ctor, addr 0x5de2ce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5de2ce4, size 0x4, virtual false, abstract: false, final false
