...
public:
  ...
  /// @brief Method .ctor, addr 0x5f2bd08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLMutation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLMutation(GraphQLMutation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLMutation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLMutation(GraphQLMutationconst&) = delete;
