...
public:
  // Declarations
  /// @brief Method CreateGraphQLRequestExceptionFromError, addr 0x5de29e8, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractDataStringFromResponse, addr 0x5de2818, size 0x1d0, virtual false, abstract: false, final false
  static inline ::StringW ExtractDataStringFromResponse(::OculusStudios::GraphQL::Client::GraphQLResponse* response);

  /// @brief Method ProcessModel, addr 0x5de26f4, size 0x120, virtual false, abstract: false, final false
