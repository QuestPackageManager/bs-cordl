...
public:
  ...
  /// @brief Method .ctor, addr 0x5de5a58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_APIErrorCode, addr 0x5de59a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_APIErrorCode();

  /// @brief Method get_AllowUserRetry, addr 0x5de5a18, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowUserRetry();

  /// @brief Method get_Code, addr 0x5de5998, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int32_t> get_Code();

  /// @brief Method get_DebugInfo, addr 0x5de59d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DebugInfo();

  /// @brief Method get_Description, addr 0x5de59c8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_Exception, addr 0x5de5a48, size 0x8, virtual false, abstract: false, final false
  inline ::OculusStudios::GraphQL::Client::GraphQLErrorException* get_Exception();

  /// @brief Method get_FBTraceId, addr 0x5de5a38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FBTraceId();

  /// @brief Method get_IsSilent, addr 0x5de59e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsSilent();

  /// @brief Method get_IsTransient, addr 0x5de59f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsTransient();

  /// @brief Method get_Message, addr 0x5de5968, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_QueryPath, addr 0x5de5a28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_QueryPath();

  /// @brief Method get_RequiresReauth, addr 0x5de5a08, size 0x8, virtual false, abstract: false, final false
  inline bool get_RequiresReauth();

  /// @brief Method get_Severity, addr 0x5de5978, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Severity();

  /// @brief Method get_Summary, addr 0x5de59b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Summary();

  /// @brief Method get_Type, addr 0x5de5988, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Type();

  /// @brief Method set_APIErrorCode, addr 0x5de59b0, size 0x8, virtual false, abstract: false, final false
  inline void set_APIErrorCode(::System::Nullable_1<int32_t> value);

  /// @brief Method set_AllowUserRetry, addr 0x5de5a20, size 0x8, virtual false, abstract: false, final false
  inline void set_AllowUserRetry(bool value);

  /// @brief Method set_Code, addr 0x5de59a0, size 0x8, virtual false, abstract: false, final false
  inline void set_Code(::System::Nullable_1<int32_t> value);

  /// @brief Method set_DebugInfo, addr 0x5de59e0, size 0x8, virtual false, abstract: false, final false
  inline void set_DebugInfo(::StringW value);

  /// @brief Method set_Description, addr 0x5de59d0, size 0x8, virtual false, abstract: false, final false
  inline void set_Description(::StringW value);

  /// @brief Method set_Exception, addr 0x5de5a50, size 0x8, virtual false, abstract: false, final false
  inline void set_Exception(::OculusStudios::GraphQL::Client::GraphQLErrorException* value);

  /// @brief Method set_FBTraceId, addr 0x5de5a40, size 0x8, virtual false, abstract: false, final false
  inline void set_FBTraceId(::StringW value);

  /// @brief Method set_IsSilent, addr 0x5de59f0, size 0x8, virtual false, abstract: false, final false
  inline void set_IsSilent(bool value);

  /// @brief Method set_IsTransient, addr 0x5de5a00, size 0x8, virtual false, abstract: false, final false
  inline void set_IsTransient(bool value);

  /// @brief Method set_Message, addr 0x5de5970, size 0x8, virtual false, abstract: false, final false
  inline void set_Message(::StringW value);

  /// @brief Method set_QueryPath, addr 0x5de5a30, size 0x8, virtual false, abstract: false, final false
  inline void set_QueryPath(::StringW value);

  /// @brief Method set_RequiresReauth, addr 0x5de5a10, size 0x8, virtual false, abstract: false, final false
  inline void set_RequiresReauth(bool value);

  /// @brief Method set_Severity, addr 0x5de5980, size 0x8, virtual false, abstract: false, final false
  inline void set_Severity(::StringW value);

  /// @brief Method set_Summary, addr 0x5de59c0, size 0x8, virtual false, abstract: false, final false
  inline void set_Summary(::StringW value);

  /// @brief Method set_Type, addr 0x5de5990, size 0x8, virtual false, abstract: false, final false
