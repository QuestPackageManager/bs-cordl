...
template <typename T> inline void OculusStudios::GraphQL::Client::GraphQLUtils___c__DisplayClass6_0_1<T>::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils___c__DisplayClass6_0_1<T>*>::get(), ".ctor",
...
template <typename T> inline T OculusStudios::GraphQL::Client::GraphQLUtils___c__DisplayClass6_0_1<T>::_DeserializeAsync_b__0() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils___c__DisplayClass6_0_1<T>*>::get(),
                                               "<DeserializeAsync>b__0", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
...
template <typename T> inline void OculusStudios::GraphQL::Client::GraphQLUtils__DeserializeAsync_d__6_1<T>::MoveNext() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils__DeserializeAsync_d__6_1<T>>::get(), "MoveNext",
                                               std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
template <typename T> inline void OculusStudios::GraphQL::Client::GraphQLUtils__DeserializeAsync_d__6_1<T>::SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils__DeserializeAsync_d__6_1<T>>::get(), "SetStateMachine",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (*)(::System::Object*)>(&::OculusStudios::GraphQL::Client::GraphQLUtils::ConvertObject2Json)> {
  ...
  constexpr static std::size_t addrs = 0x5de68ec;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils*>::get(), "ConvertObject2Json",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
  ...
  constexpr static std::size_t addrs = 0x5de5d28;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils*>::get(), "Convert4Json", std::span<Il2CppClass const* const, 0>(),
...
template <typename T> inline T OculusStudios::GraphQL::Client::GraphQLUtils::ConvertString2Enum(::StringW str) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils*>::get(), "ConvertString2Enum",
...
template <typename T> inline ::System::Collections::Generic::List_1<T>* OculusStudios::GraphQL::Client::GraphQLUtils::ConvertString2Enum(::System::Collections::Generic::List_1<::StringW>* strList) {
  static auto* ___internal_method_base = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils*>::get(), "ConvertString2Enum",
                                  std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
...
template <typename T> inline bool OculusStudios::GraphQL::Client::GraphQLUtils::IsUnknown(T enumValue) {
  static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils*>::get(),
                                                                                  "IsUnknown", std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
...
template <typename T> inline ::System::Threading::Tasks::Task_1<T>* OculusStudios::GraphQL::Client::GraphQLUtils::DeserializeAsync(::StringW data) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLUtils*>::get(), "DeserializeAsync",
                                               std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
                                               ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get() })));
  static auto* ___internal_method =
      THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal_method_base, std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() }));
