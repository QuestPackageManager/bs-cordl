...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLResponseParseException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLResponseParseException(GraphQLResponseParseException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLResponseParseException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLResponseParseException(GraphQLResponseParseExceptionconst&) = delete;
