...
public:
  ...
  /// @brief Method .ctor, addr 0x5de2ccc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5de2814, size 0x4, virtual false, abstract: false, final false
