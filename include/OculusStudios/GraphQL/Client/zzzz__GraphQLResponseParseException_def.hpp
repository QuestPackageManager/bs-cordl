...
// Write type traits
MARK_REF_PTR_T(::OculusStudios::GraphQL::Client::GraphQLResponseParseException);
...
public:
  ...
  /// @brief Method .ctor, addr 0x5d707d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5d70320, size 0x4, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::OculusStudios::GraphQL::Client::GraphQLResponseParseException, 0x90>, "Size mismatch!");

} // namespace OculusStudios::GraphQL::Client
NEED_NO_BOX(::OculusStudios::GraphQL::Client::GraphQLResponseParseException);
DEFINE_IL2CPP_ARG_TYPE(::OculusStudios::GraphQL::Client::GraphQLResponseParseException*, "OculusStudios.GraphQL.Client", "GraphQLResponseParseException");
