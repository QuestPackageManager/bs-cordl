...
public:
  ...
  /// @brief Method GetParams, addr 0x5de5d20, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5de5c9c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
