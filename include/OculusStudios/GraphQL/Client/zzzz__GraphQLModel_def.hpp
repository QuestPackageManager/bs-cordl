...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLModel*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLModel*, "OculusStudios.GraphQL.Client", "GraphQLModel");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f21be0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLModel", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLModel) == 0x10, "Size mismatch!");
