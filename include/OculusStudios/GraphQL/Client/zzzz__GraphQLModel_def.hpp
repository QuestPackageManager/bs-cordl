...
template<typename T>
inline ::System::Collections::Generic::List_1<T>* ConvertString2Enum(::System::Collections::Generic::List_1<::StringW>*  strList) ;

/// @brief Method ConvertString2Enum, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline T ConvertString2Enum(::StringW  str) ;

static inline ::OculusStudios::GraphQL::Client::GraphQLModel* New_ctor() ;

/// @brief Method .ctor, addr 0x5d73c2c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
