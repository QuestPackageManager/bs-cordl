...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::GraphQL::Client::GraphQLRequestExceptionRateLimitExceeded::*)(int32_t, ::StringW)>(&::OculusStudios::GraphQL::Client::GraphQLRequestExceptionRateLimitExceeded::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5d70ba8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::GraphQL::Client::GraphQLRequestExceptionRateLimitExceeded*>::get(),
                        ".ctor",
...
inline ::OculusStudios::GraphQL::Client::GraphQLRequestExceptionRateLimitExceeded* OculusStudios::GraphQL::Client::GraphQLRequestExceptionRateLimitExceeded::New_ctor(int32_t  errorCode, ::StringW  message)  {
