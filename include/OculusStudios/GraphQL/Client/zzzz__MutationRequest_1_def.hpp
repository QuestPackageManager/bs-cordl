...
public:
// Declarations
static inline ::OculusStudios::GraphQL::Client::MutationRequest_1<TInputModel>* New_ctor(::OculusStudios::GraphQL::Client::GraphQLMutationOperation*  mutation, TInputModel  inputObject, bool  forceRequestWhenOffline) ;
