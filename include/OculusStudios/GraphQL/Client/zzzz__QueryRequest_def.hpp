...
public:
  ...
  /// @brief Method GetCodeGenInfo, addr 0x5de6e5c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method PerformRequest, addr 0x5de6e34, size 0x20, virtual true, abstract: false, final false
  inline void PerformRequest();

  /// @brief Method SupportsClientMutationId, addr 0x5de6e54, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5de6db8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::OculusStudios::GraphQL::Client::GraphQLQueryOperation* query, bool forceRequestWhenOffline);

  /// @brief Method add_performRequestCalled, addr 0x5de6c38, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_performRequestCalled, addr 0x5de6cf8, size 0xc0, virtual false, abstract: false, final false
