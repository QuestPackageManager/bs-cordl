...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLQuery", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLQuery(GraphQLQuery&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLQuery", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLQuery(GraphQLQueryconst&) = delete;
