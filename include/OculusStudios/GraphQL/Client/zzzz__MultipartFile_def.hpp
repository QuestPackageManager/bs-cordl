...
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::MultipartFile, "OculusStudios.GraphQL.Client", "MultipartFile");
// Dependencies
namespace OculusStudios::GraphQL::Client {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::MultipartFile) == 0x20, "Size mismatch!");
