...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnumConverter_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnumConverter_1(EnumConverter_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnumConverter_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnumConverter_1(EnumConverter_1const&) = delete;
