...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLQueryOperation*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLQueryOperation*, "OculusStudios.GraphQL.Client", "GraphQLQueryOperation");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f202ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLQueryOperation) == 0x18, "Size mismatch!");
