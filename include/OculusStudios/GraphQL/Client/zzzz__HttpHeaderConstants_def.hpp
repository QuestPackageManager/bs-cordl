...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HttpHeaderConstants", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HttpHeaderConstants(HttpHeaderConstants&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HttpHeaderConstants", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HttpHeaderConstants(HttpHeaderConstantsconst&) = delete;
