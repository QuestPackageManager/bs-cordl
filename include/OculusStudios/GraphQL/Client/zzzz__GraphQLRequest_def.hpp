...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLRequest*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLRequest*, "OculusStudios.GraphQL.Client", "GraphQLRequest");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f2bd00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLRequest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLRequest(GraphQLRequest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLRequest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLRequest(GraphQLRequestconst&) = delete;
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLRequest) == 0x48, "Size mismatch!");
