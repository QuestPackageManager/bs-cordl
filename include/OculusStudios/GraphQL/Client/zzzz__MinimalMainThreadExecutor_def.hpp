...
/// @brief Method RunOnMainThread, addr 0x5d73ae0, size 0x14c, virtual false, abstract: false, final false
inline void RunOnMainThread(::System::Action*  runnable) ;

/// @brief Method RunPendingActions, addr 0x5d714dc, size 0x378, virtual false, abstract: false, final false
inline void RunPendingActions() ;

/// @brief Method StartOnMainThread, addr 0x5d73aa8, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d724a0, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
