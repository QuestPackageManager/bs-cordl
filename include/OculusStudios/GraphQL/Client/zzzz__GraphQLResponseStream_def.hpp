...
/// @brief Method <.ctor>b__21_0, addr 0x5d7e150, size 0x4, virtual false, abstract: false, final false
inline void __ctor_b__21_0() ;

/// @brief Method .ctor, addr 0x5d7e14c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cancel, addr 0x5d7e04c, size 0x1c, virtual false, abstract: false, final false
inline void Cancel() ;

/// @brief Method Dispose, addr 0x5d7e01c, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x5d7e02c, size 0x20, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::OculusStudios::GraphQL::Client::GraphQLResponseStream* New_ctor() ;

/// @brief Method NoteConnectionClosed, addr 0x5d7e0d8, size 0x20, virtual false, abstract: false, final false
inline void NoteConnectionClosed() ;

/// @brief Method PostResponse, addr 0x5d76b88, size 0xbc, virtual false, abstract: false, final false
inline void PostResponse(::OculusStudios::GraphQL::Client::GraphQLResponse*  response) ;

/// @brief Method SetResponseCallback, addr 0x5d7e078, size 0x30, virtual false, abstract: false, final false
inline void SetResponseCallback(::System::Action_1<::OculusStudios::GraphQL::Client::GraphQLResponse*>*  callback) ;

/// @brief Method SetResponseCallback, addr 0x5d7e0a8, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d76fc8, size 0xe8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_OnCancelled, addr 0x5d78d68, size 0xac, virtual false, abstract: false, final false
inline void add_OnCancelled(::System::Action*  value) ;

/// @brief Method add_OnConnectionClosed, addr 0x5d7dec4, size 0xac, virtual false, abstract: false, final false
inline void add_OnConnectionClosed(::System::Action*  value) ;

/// @brief Method get_InitialResponse, addr 0x5d7e068, size 0x8, virtual false, abstract: false, final false
inline ::OculusStudios::GraphQL::Client::GraphQLResponse* get_InitialResponse() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_OnCancelled, addr 0x5d7de18, size 0xac, virtual false, abstract: false, final false
inline void remove_OnCancelled(::System::Action*  value) ;

/// @brief Method remove_OnConnectionClosed, addr 0x5d7df70, size 0xac, virtual false, abstract: false, final false
inline void remove_OnConnectionClosed(::System::Action*  value) ;

/// @brief Method set_InitialResponse, addr 0x5d7e070, size 0x8, virtual false, abstract: false, final false
