...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLException(GraphQLException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLException(GraphQLExceptionconst&) = delete;
