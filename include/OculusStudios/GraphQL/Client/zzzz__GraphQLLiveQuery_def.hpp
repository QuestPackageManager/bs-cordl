...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLLiveQuery*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLLiveQuery*, "OculusStudios.GraphQL.Client", "GraphQLLiveQuery");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f2bd0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLLiveQuery", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLLiveQuery(GraphQLLiveQuery&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLLiveQuery", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLLiveQuery(GraphQLLiveQueryconst&) = delete;
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLLiveQuery) == 0x58, "Size mismatch!");
