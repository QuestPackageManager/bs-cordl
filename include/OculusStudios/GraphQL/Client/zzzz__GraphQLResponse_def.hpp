...
// Write type traits
MARK_REF_T(::OculusStudios::GraphQL::Client::GraphQLResponse*);
DEFINE_IL2CPP_CLASS(::OculusStudios::GraphQL::Client::GraphQLResponse*, "OculusStudios.GraphQL.Client", "GraphQLResponse");
...
public:
  ...
  /// @brief Method Equals, addr 0x5f2bd10, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5f2bdbc, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f26560, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLResponse", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLResponse(GraphQLResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLResponse", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLResponse(GraphQLResponseconst&) = delete;
...
static_assert(sizeof(::OculusStudios::GraphQL::Client::GraphQLResponse) == 0x40, "Size mismatch!");
