...
public:
  ...
  /// @brief Method .ctor, addr 0x5f1ecb0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f1eb10, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(int32_t errorCode, ::StringW message);

  /// @brief Method .ctor, addr 0x5f1ecb4, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLRequestException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLRequestException(GraphQLRequestException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLRequestException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLRequestException(GraphQLRequestExceptionconst&) = delete;
