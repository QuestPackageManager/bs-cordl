...
public:
  ...
  /// @brief Method .ctor, addr 0x5d09cfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5d09d00, size 0x4, virtual false, abstract: false, final false
