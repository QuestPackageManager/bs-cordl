...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLConnectivityException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLConnectivityException(GraphQLConnectivityException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLConnectivityException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLConnectivityException(GraphQLConnectivityExceptionconst&) = delete;
