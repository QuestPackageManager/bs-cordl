...
public:
  ...
  /// @brief Method .ctor, addr 0x5f1eb58, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLRequestExceptionRateLimitExceeded", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLRequestExceptionRateLimitExceeded(GraphQLRequestExceptionRateLimitExceeded&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLRequestExceptionRateLimitExceeded", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLRequestExceptionRateLimitExceeded(GraphQLRequestExceptionRateLimitExceededconst&) = delete;
