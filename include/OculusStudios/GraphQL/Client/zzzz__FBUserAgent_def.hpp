...
public:
  ...
  /// @brief Method MoveNext, addr 0x5de7b9c, size 0x198, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::OculusStudios::GraphQL::Client::FBUserAgent__EncodedPropertyKeys_d__7* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator, addr 0x5de7d7c, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current, addr 0x5de7d34, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5de7e08, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5de7d3c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5de7d74, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5de7b98, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5de6f00, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddEncodedProperties, addr 0x5de76c8, size 0x43c, virtual false, abstract: false, final false
  inline void AddEncodedProperties();

  /// @brief Method AddFriendlyNames, addr 0x5de7614, size 0xb4, virtual false, abstract: false, final false
  inline void AddFriendlyNames();

  /// @brief Method EncodedPropertyKeys, addr 0x5de6e98, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* EncodedPropertyKeys();

  /// @brief Method GetPropertyOrNull, addr 0x5de6f6c, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW GetPropertyOrNull(::StringW key);

  static inline ::OculusStudios::GraphQL::Client::FBUserAgent* New_ctor();

  /// @brief Method Serialize, addr 0x5de7594, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5de7b04, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_appName, addr 0x5de6f20, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_appName();

  /// @brief Method get_appVersion, addr 0x5de709c, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_appVersion();

  /// @brief Method get_buildVersion, addr 0x5de7170, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_buildVersion();

  /// @brief Method get_device, addr 0x5de7244, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_device();

  /// @brief Method get_locale, addr 0x5de74c0, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_locale();

  /// @brief Method get_systemName, addr 0x5de7318, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_systemName();

  /// @brief Method get_systemVersion, addr 0x5de73ec, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_systemVersion();

  /// @brief Method set_appName, addr 0x5de7014, size 0x88, virtual false, abstract: false, final false
  inline void set_appName(::StringW value);

  /// @brief Method set_appVersion, addr 0x5de70e8, size 0x88, virtual false, abstract: false, final false
  inline void set_appVersion(::StringW value);

  /// @brief Method set_buildVersion, addr 0x5de71bc, size 0x88, virtual false, abstract: false, final false
  inline void set_buildVersion(::StringW value);

  /// @brief Method set_device, addr 0x5de7290, size 0x88, virtual false, abstract: false, final false
  inline void set_device(::StringW value);

  /// @brief Method set_locale, addr 0x5de750c, size 0x88, virtual false, abstract: false, final false
  inline void set_locale(::StringW value);

  /// @brief Method set_systemName, addr 0x5de7364, size 0x88, virtual false, abstract: false, final false
  inline void set_systemName(::StringW value);

  /// @brief Method set_systemVersion, addr 0x5de7438, size 0x88, virtual false, abstract: false, final false
