...
public:
  ...
  /// @brief Method .ctor, addr 0x5df235c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_owned>b__13_0, addr 0x5df2360, size 0x14, virtual false, abstract: false, final false
  inline bool _get_owned_b__13_0(::OculusStudios::Platform::Core::Product* x);

  /// @brief Method <get_owned>b__13_1, addr 0x5df2374, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SetChildren, addr 0x5df2300, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5df22ec, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_children, addr 0x5df2094, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::Product*>* get_children();

  /// @brief Method get_definition, addr 0x5df208c, size 0x8, virtual false, abstract: false, final false
  inline ::OculusStudios::Platform::Core::IProductDefinition* get_definition();

  /// @brief Method get_id, addr 0x5df1f40, size 0xa4, virtual false, abstract: false, final false
  inline ::StringW get_id();

  /// @brief Method get_owned, addr 0x5df209c, size 0x250, virtual false, abstract: false, final false
  inline bool get_owned();

  /// @brief Method get_ownershipRequirement, addr 0x5df1fe4, size 0xa8, virtual false, abstract: false, final false
