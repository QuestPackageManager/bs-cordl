...
/// @brief Method .ctor, addr 0x5d80374, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_owned>b__13_0, addr 0x5d80378, size 0x14, virtual false, abstract: false, final false
inline bool _get_owned_b__13_0(::OculusStudios::Platform::Core::Product*  x) ;

/// @brief Method <get_owned>b__13_1, addr 0x5d8038c, size 0x14, virtual false, abstract: false, final false
...
static inline ::OculusStudios::Platform::Core::Product* New_ctor(::OculusStudios::Platform::Core::IProductDefinition*  definition, ::StringW  idForVendor, ::OculusStudios::Platform::Core::InstallStatus  dlcInstallStatus, bool  selfOwned) ;

/// @brief Method SetChildren, addr 0x5d80318, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d80304, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_children, addr 0x5d800ac, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::Product*>* get_children() ;

/// @brief Method get_definition, addr 0x5d800a4, size 0x8, virtual false, abstract: false, final false
inline ::OculusStudios::Platform::Core::IProductDefinition* get_definition() ;

/// @brief Method get_id, addr 0x5d7ff58, size 0xa4, virtual false, abstract: false, final false
inline ::StringW get_id() ;

/// @brief Method get_owned, addr 0x5d800b4, size 0x250, virtual false, abstract: false, final false
inline bool get_owned() ;

/// @brief Method get_ownershipRequirement, addr 0x5d7fffc, size 0xa8, virtual false, abstract: false, final false
