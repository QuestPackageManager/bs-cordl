...
// Write type traits
MARK_REF_PTR_T(::OculusStudios::Platform::Core::PlatformRequiresAppRestartException);
...
public:
  ...
  /// @brief Method .ctor, addr 0x5d80354, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5d803ac, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5d80418, size 0x74, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::OculusStudios::Platform::Core::PlatformRequiresAppRestartException, 0x90>, "Size mismatch!");

} // namespace OculusStudios::Platform::Core
NEED_NO_BOX(::OculusStudios::Platform::Core::PlatformRequiresAppRestartException);
DEFINE_IL2CPP_ARG_TYPE(::OculusStudios::Platform::Core::PlatformRequiresAppRestartException*, "OculusStudios.Platform.Core", "PlatformRequiresAppRestartException");
