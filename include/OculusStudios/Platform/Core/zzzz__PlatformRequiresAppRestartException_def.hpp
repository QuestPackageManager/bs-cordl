...
public:
  ...
  /// @brief Method .ctor, addr 0x5d19874, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5d198cc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5d19938, size 0x74, virtual false, abstract: false, final false
