...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlatformMissingDependenciesException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlatformMissingDependenciesException(PlatformMissingDependenciesException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlatformMissingDependenciesException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlatformMissingDependenciesException(PlatformMissingDependenciesExceptionconst&) = delete;
