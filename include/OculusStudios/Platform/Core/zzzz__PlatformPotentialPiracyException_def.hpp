...
CORDL_MODULE_EXPORT(PlatformPotentialPiracyException)
namespace System {
class Exception;
}
// Forward declare root types
namespace OculusStudios::Platform::Core {
class PlatformPotentialPiracyException;
}
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Core::PlatformPotentialPiracyException*);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::PlatformPotentialPiracyException*, "OculusStudios.Platform.Core", "PlatformPotentialPiracyException");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlatformPotentialPiracyException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlatformPotentialPiracyException(PlatformPotentialPiracyException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlatformPotentialPiracyException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlatformPotentialPiracyException(PlatformPotentialPiracyExceptionconst&) = delete;
...
static_assert(sizeof(::OculusStudios::Platform::Core::PlatformPotentialPiracyException) == 0x90, "Size mismatch!");
