...
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::Vendor, "OculusStudios.Platform.Core", "Vendor");
// Dependencies
namespace OculusStudios::Platform::Core {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::Platform::Core::Vendor) == 0x1, "Size mismatch!");
