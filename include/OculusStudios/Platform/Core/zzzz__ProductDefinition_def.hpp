...
public:
  ...
  static inline ::OculusStudios::Platform::Core::ProductDefinition*
  New_ctor(::StringW id, ::AYellowpaper::SerializedCollections::SerializedDictionary_2<::OculusStudios::Platform::Core::Vendor, ::StringW>* idForVendor,
  ...
  /// @brief Method .ctor, addr 0x5df23d0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_children, addr 0x5df23c0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerable_1<::OculusStudios::Platform::Core::IProductDefinition*>* get_children();

  /// @brief Method get_id, addr 0x5df23b0, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_id();

  /// @brief Method get_idForVendor, addr 0x5df23b8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_ownershipRequirement, addr 0x5df23c8, size 0x8, virtual true, abstract: false, final true
