...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Core::ProductDefinition*);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::ProductDefinition*, "OculusStudios.Platform.Core", "ProductDefinition");
...
static_assert(sizeof(::OculusStudios::Platform::Core::ProductDefinition) == 0x30, "Size mismatch!");
