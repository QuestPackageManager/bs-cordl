...
CORDL_MODULE_EXPORT(ProductDefinition)
...
// Write type traits
MARK_REF_PTR_T(::OculusStudios::Platform::Core::ProductDefinition);
// Dependencies OculusStudios.Platform.Core.OwnershipRequirement, System.Object
namespace OculusStudios::Platform::Core {
// Is value type: false
// CS Name: OculusStudios.Platform.Core.ProductDefinition
class CORDL_TYPE ProductDefinition : public ::System::Object {
public:
// Declarations
/// @brief Field _children, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__children, put=__cordl_internal_set__children)) ::System::Collections::Generic::List_1<::OculusStudios::Platform::Core::ProductDefinition*>*  _children;
...
/// @brief Field _idForVendor, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__idForVendor, put=__cordl_internal_set__idForVendor)) ::AYellowpaper::SerializedCollections::SerializedDictionary_2<::OculusStudios::Platform::Core::Vendor,::StringW>*  _idForVendor;

/// @brief Field _ownershipRequirement, offset 0x28, size 0x4 
...
static inline ::OculusStudios::Platform::Core::ProductDefinition* New_ctor(::StringW  id, ::AYellowpaper::SerializedCollections::SerializedDictionary_2<::OculusStudios::Platform::Core::Vendor,::StringW>*  idForVendor, ::System::Collections::Generic::List_1<::OculusStudios::Platform::Core::ProductDefinition*>*  children, ::OculusStudios::Platform::Core::OwnershipRequirement  ownershipRequirement) ;

constexpr ::System::Collections::Generic::List_1<::OculusStudios::Platform::Core::ProductDefinition*>* const& __cordl_internal_get__children() const;

constexpr ::System::Collections::Generic::List_1<::OculusStudios::Platform::Core::ProductDefinition*>*& __cordl_internal_get__children() ;
...
constexpr void __cordl_internal_set__children(::System::Collections::Generic::List_1<::OculusStudios::Platform::Core::ProductDefinition*>*  value) ;
...
/// @brief Method .ctor, addr 0x5d803e8, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::StringW  id, ::AYellowpaper::SerializedCollections::SerializedDictionary_2<::OculusStudios::Platform::Core::Vendor,::StringW>*  idForVendor, ::System::Collections::Generic::List_1<::OculusStudios::Platform::Core::ProductDefinition*>*  children, ::OculusStudios::Platform::Core::OwnershipRequirement  ownershipRequirement) ;

/// @brief Method get_children, addr 0x5d803d8, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerable_1<::OculusStudios::Platform::Core::IProductDefinition*>* get_children() ;

/// @brief Method get_id, addr 0x5d803c8, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_id() ;

/// @brief Method get_idForVendor, addr 0x5d803d0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method get_ownershipRequirement, addr 0x5d803e0, size 0x8, virtual true, abstract: false, final true
...
static_assert(::cordl_internals::size_check_v<::OculusStudios::Platform::Core::ProductDefinition, 0x30>, "Size mismatch!");

} // namespace end def OculusStudios::Platform::Core
NEED_NO_BOX(::OculusStudios::Platform::Core::ProductDefinition);
DEFINE_IL2CPP_ARG_TYPE(::OculusStudios::Platform::Core::ProductDefinition*, "OculusStudios.Platform.Core", "ProductDefinition");
