...
/// @brief Method .ctor, addr 0x5d8045c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(uint32_t  currentUsers, uint32_t  maxUsers, ::StringW  groupId, ::StringW  joinKey) ;

/// @brief Method get_currentUsers, addr 0x5d8043c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_currentUsers() ;

/// @brief Method get_groupId, addr 0x5d8044c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_groupId() ;

/// @brief Method get_joinKey, addr 0x5d80454, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_joinKey() ;

/// @brief Method get_maxUsers, addr 0x5d80444, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_currentUsers_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_maxUsers_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_groupId_k__BackingField", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_joinKey_k__BackingField", ty: "::StringW", modifiers: "", def_value: None }]
