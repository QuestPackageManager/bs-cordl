...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2444, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint32_t currentUsers, uint32_t maxUsers, ::StringW groupId, ::StringW joinKey);

  /// @brief Method get_currentUsers, addr 0x5df2424, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_currentUsers();

  /// @brief Method get_groupId, addr 0x5df2434, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_groupId();

  /// @brief Method get_joinKey, addr 0x5df243c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_joinKey();

  /// @brief Method get_maxUsers, addr 0x5df242c, size 0x8, virtual false, abstract: false, final false
