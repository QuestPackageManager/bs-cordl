...
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::OwnershipRequirement, "OculusStudios.Platform.Core", "OwnershipRequirement");
// Dependencies
namespace OculusStudios::Platform::Core {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::Platform::Core::OwnershipRequirement) == 0x4, "Size mismatch!");
