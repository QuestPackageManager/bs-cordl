...
public:
  ...
  /// @brief Method .ctor, addr 0x5df23a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_children, addr 0x5df2398, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerable_1<::OculusStudios::Platform::Core::IProductDefinition*>* get_children();

  /// @brief Method get_id, addr 0x5df2388, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_id();

  /// @brief Method get_idForVendor, addr 0x5df2390, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_ownershipRequirement, addr 0x5df23a0, size 0x8, virtual true, abstract: false, final true
