...
/// @brief Field _children, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__children, put=__cordl_internal_set__children)) ::System::Collections::Generic::List_1<::UnityW<::OculusStudios::Platform::Core::ProductDefinitionSO>>*  _children;
...
/// @brief Method .ctor, addr 0x5d803c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_children, addr 0x5d803b0, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerable_1<::OculusStudios::Platform::Core::IProductDefinition*>* get_children() ;

/// @brief Method get_id, addr 0x5d803a0, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_id() ;

/// @brief Method get_idForVendor, addr 0x5d803a8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method get_ownershipRequirement, addr 0x5d803b8, size 0x8, virtual true, abstract: false, final true
