...
/// @brief Method .ctor, addr 0x5d80430, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  timestamp, ::OculusStudios::Platform::Core::RichPresenceTimestampType  type) ;

/// @brief Method get_timestamp, addr 0x5d80420, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_timestamp() ;

/// @brief Method get_type, addr 0x5d80428, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_timestamp_k__BackingField", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_type_k__BackingField", ty: "::OculusStudios::Platform::Core::RichPresenceTimestampType", modifiers: "", def_value: None }]
