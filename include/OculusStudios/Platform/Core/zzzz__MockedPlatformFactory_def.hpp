...
public:
  ...
  /// @brief Method MoveNext, addr 0x5d1b68c, size 0x2b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5d1b93c, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateAsync, addr 0x5d1b5a0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method OculusStudios.Platform.Core.IPlatformFactory.CreateAsync, addr 0x5d1b680, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5d1b688, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
