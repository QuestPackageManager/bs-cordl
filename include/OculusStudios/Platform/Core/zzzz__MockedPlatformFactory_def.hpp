...
public:
  ...
  /// @brief Method MoveNext, addr 0x5df4660, size 0x2b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5df4910, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateAsync, addr 0x5df4574, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method OculusStudios.Platform.Core.IPlatformFactory.CreateAsync, addr 0x5df4654, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5df465c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
