...
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::RichPresenceTimestampType, "OculusStudios.Platform.Core", "RichPresenceTimestampType");
// Dependencies
namespace OculusStudios::Platform::Core {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::Platform::Core::RichPresenceTimestampType) == 0x4, "Size mismatch!");
