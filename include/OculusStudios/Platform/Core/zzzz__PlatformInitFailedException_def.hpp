...
public:
  ...
  /// @brief Method .ctor, addr 0x5f2e4fc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5f2e554, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x5f2e5c0, size 0x74, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlatformInitFailedException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlatformInitFailedException(PlatformInitFailedException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlatformInitFailedException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlatformInitFailedException(PlatformInitFailedExceptionconst&) = delete;
