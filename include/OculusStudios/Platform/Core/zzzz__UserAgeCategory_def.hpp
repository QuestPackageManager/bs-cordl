...
static_assert(::cordl_internals::size_check_v<::OculusStudios::Platform::Core::UserAgeCategory, 0x4>, "Size mismatch!");

} // namespace OculusStudios::Platform::Core
DEFINE_IL2CPP_ARG_TYPE(::OculusStudios::Platform::Core::UserAgeCategory, "OculusStudios.Platform.Core", "UserAgeCategory");
