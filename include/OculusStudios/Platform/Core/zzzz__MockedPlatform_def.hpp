...
public:
  ...
  /// @brief Method ClearRichPresenceStatus, addr 0x5df4528, size 0x4, virtual true, abstract: false, final true
  inline void ClearRichPresenceStatus();

  /// @brief Method Dispose, addr 0x5df4508, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetAppVersion, addr 0x5df4510, size 0x14, virtual true, abstract: false, final true
  inline ::StringW GetAppVersion();

  /// @brief Method GetDestination, addr 0x5df452c, size 0x44, virtual true, abstract: false, final true
  ...
  /// @brief Method OculusStudios.Platform.Core.IPlatformInternal.InitializeAsync, addr 0x5df434c, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method SetRichPresenceStatus, addr 0x5df4524, size 0x4, virtual true, abstract: false, final true
  inline void SetRichPresenceStatus(::OculusStudios::Platform::Core::RichPresenceRuntimeInstance status);

  /// @brief Method Tick, addr 0x5df450c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5df4570, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_destinationRequestedEvent, addr 0x5df41cc, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_displayName, addr 0x5df412c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_entitlements, addr 0x5df41c4, size 0x8, virtual true, abstract: false, final false
  inline ::OculusStudios::Platform::Core::IPlatformEntitlements* get_entitlements();

  /// @brief Method get_key, addr 0x5df4170, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_key();

  /// @brief Method get_user, addr 0x5df41bc, size 0x8, virtual true, abstract: false, final false
  inline ::OculusStudios::Platform::Core::IPlatformUser* get_user();

  /// @brief Method get_vendor, addr 0x5df41b4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method remove_destinationRequestedEvent, addr 0x5df428c, size 0xc0, virtual true, abstract: false, final true
