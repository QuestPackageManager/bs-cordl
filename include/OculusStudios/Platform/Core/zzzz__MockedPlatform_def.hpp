...
/// @brief Field destinationRequestedEvent, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_destinationRequestedEvent, put=__cordl_internal_set_destinationRequestedEvent)) ::System::Action_2<::OculusStudios::Platform::Core::IRichPresenceDefinition*,::StringW>*  destinationRequestedEvent;
...
/// @brief Method ClearRichPresenceStatus, addr 0x5d82540, size 0x4, virtual true, abstract: false, final true
inline void ClearRichPresenceStatus() ;

/// @brief Method Dispose, addr 0x5d82520, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetAppVersion, addr 0x5d82528, size 0x14, virtual true, abstract: false, final true
inline ::StringW GetAppVersion() ;

/// @brief Method GetDestination, addr 0x5d82544, size 0x44, virtual true, abstract: false, final true
...
/// @brief Method OculusStudios.Platform.Core.IPlatformInternal.InitializeAsync, addr 0x5d82364, size 0x104, virtual true, abstract: false, final true
...
/// @brief Method SetRichPresenceStatus, addr 0x5d8253c, size 0x4, virtual true, abstract: false, final true
inline void SetRichPresenceStatus(::OculusStudios::Platform::Core::RichPresenceRuntimeInstance  status) ;

/// @brief Method Tick, addr 0x5d82524, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5d82588, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_destinationRequestedEvent, addr 0x5d821e4, size 0xc0, virtual true, abstract: false, final true
...
/// @brief Method get_displayName, addr 0x5d82144, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_displayName() ;

/// @brief Method get_entitlements, addr 0x5d821dc, size 0x8, virtual true, abstract: false, final false
inline ::OculusStudios::Platform::Core::IPlatformEntitlements* get_entitlements() ;

/// @brief Method get_key, addr 0x5d82188, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_key() ;

/// @brief Method get_user, addr 0x5d821d4, size 0x8, virtual true, abstract: false, final false
inline ::OculusStudios::Platform::Core::IPlatformUser* get_user() ;

/// @brief Method get_vendor, addr 0x5d821cc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method remove_destinationRequestedEvent, addr 0x5d822a4, size 0xc0, virtual true, abstract: false, final true
