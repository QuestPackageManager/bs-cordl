...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::OculusStudios::Platform::Core::ProductDefinitionSO::*)()>(&::OculusStudios::Platform::Core::ProductDefinitionSO::get_id)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5df3f00;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Core::ProductDefinitionSO*>::get(),
                        "get_id",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::AYellowpaper::SerializedCollections::SerializedDictionary_2<::OculusStudios::Platform::Core::Vendor,::StringW>* (::OculusStudios::Platform::Core::ProductDefinitionSO::*)()>(&::OculusStudios::Platform::Core::ProductDefinitionSO::get_idForVendor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5df3f08;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::OculusStudios::Platform::Core::IProductDefinition*>* (::OculusStudios::Platform::Core::ProductDefinitionSO::*)()>(&::OculusStudios::Platform::Core::ProductDefinitionSO::get_children)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5df3f10;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::OculusStudios::Platform::Core::OwnershipRequirement (::OculusStudios::Platform::Core::ProductDefinitionSO::*)()>(&::OculusStudios::Platform::Core::ProductDefinitionSO::get_ownershipRequirement)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5df3f18;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::Platform::Core::ProductDefinitionSO::*)()>(&::OculusStudios::Platform::Core::ProductDefinitionSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5df3f20;
...
constexpr ::AYellowpaper::SerializedCollections::SerializedDictionary_2<::OculusStudios::Platform::Core::Vendor,::StringW>*& OculusStudios::Platform::Core::ProductDefinitionSO::__cordl_internal_get__idForVendor()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____idForVendor;
}
constexpr ::AYellowpaper::SerializedCollections::SerializedDictionary_2<::OculusStudios::Platform::Core::Vendor,::StringW>* const& OculusStudios::Platform::Core::ProductDefinitionSO::__cordl_internal_get__idForVendor() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____idForVendor;
}
constexpr void OculusStudios::Platform::Core::ProductDefinitionSO::__cordl_internal_set__idForVendor(::AYellowpaper::SerializedCollections::SerializedDictionary_2<::OculusStudios::Platform::Core::Vendor,::StringW>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::System::Collections::Generic::List_1<::UnityW<::OculusStudios::Platform::Core::ProductDefinitionSO>>*& OculusStudios::Platform::Core::ProductDefinitionSO::__cordl_internal_get__children()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____children;
}
constexpr ::System::Collections::Generic::List_1<::UnityW<::OculusStudios::Platform::Core::ProductDefinitionSO>>* const& OculusStudios::Platform::Core::ProductDefinitionSO::__cordl_internal_get__children() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____children;
}
constexpr void OculusStudios::Platform::Core::ProductDefinitionSO::__cordl_internal_set__children(::System::Collections::Generic::List_1<::UnityW<::OculusStudios::Platform::Core::ProductDefinitionSO>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
