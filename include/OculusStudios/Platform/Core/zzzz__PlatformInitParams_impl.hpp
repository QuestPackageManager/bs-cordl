...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OculusStudios::Platform::Core::PlatformInitParams::*)()>(&::OculusStudios::Platform::Core::PlatformInitParams::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5d80da0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Core::PlatformInitParams*>::get(),
                        ".ctor",
...
constexpr ::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::IRichPresenceDefinition*>*& OculusStudios::Platform::Core::PlatformInitParams::__cordl_internal_get_destinationDefinitions()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___destinationDefinitions;
}
constexpr ::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::IRichPresenceDefinition*>* const& OculusStudios::Platform::Core::PlatformInitParams::__cordl_internal_get_destinationDefinitions() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___destinationDefinitions;
}
constexpr void OculusStudios::Platform::Core::PlatformInitParams::__cordl_internal_set_destinationDefinitions(::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::IRichPresenceDefinition*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::IProductDefinition*>*& OculusStudios::Platform::Core::PlatformInitParams::__cordl_internal_get_productDefinitions()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___productDefinitions;
}
constexpr ::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::IProductDefinition*>* const& OculusStudios::Platform::Core::PlatformInitParams::__cordl_internal_get_productDefinitions() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___productDefinitions;
}
constexpr void OculusStudios::Platform::Core::PlatformInitParams::__cordl_internal_set_productDefinitions(::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::IProductDefinition*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
