...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Core::IPlatformUser*);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::IPlatformUser*, "OculusStudios.Platform.Core", "IPlatformUser");
// Dependencies
namespace OculusStudios::Platform::Core {
// Is value type: false
