...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Core::IPlatformFactory*);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::IPlatformFactory*, "OculusStudios.Platform.Core", "IPlatformFactory");
// Dependencies
namespace OculusStudios::Platform::Core {
// Is value type: false
...
public:
  // Declarations
  /// @brief Method CreateAsync, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IPlatformFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPlatformFactory(IPlatformFactoryconst&) = delete;
