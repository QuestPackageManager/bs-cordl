...
// Write type traits
MARK_GEN_REF_T_PTR(::OculusStudios::Platform::Core::AssignableOf_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::OculusStudios::Platform::Core::AssignableOf_1, "OculusStudios.Platform.Core", "AssignableOf`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssignableOf_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssignableOf_1(AssignableOf_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssignableOf_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssignableOf_1(AssignableOf_1const&) = delete;
