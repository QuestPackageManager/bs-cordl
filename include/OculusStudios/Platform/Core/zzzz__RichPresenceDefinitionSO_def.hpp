...
/// @brief Method .ctor, addr 0x5d80418, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_activity, addr 0x5d80400, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_activity() ;

/// @brief Method get_id, addr 0x5d803f8, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_id() ;

/// @brief Method get_imageIdLarge, addr 0x5d80410, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_imageIdLarge() ;

/// @brief Method get_imageIdSmall, addr 0x5d80408, size 0x8, virtual true, abstract: false, final true
