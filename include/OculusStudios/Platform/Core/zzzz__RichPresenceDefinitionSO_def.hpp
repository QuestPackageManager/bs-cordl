...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2400, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activity, addr 0x5df23e8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_activity();

  /// @brief Method get_id, addr 0x5df23e0, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_id();

  /// @brief Method get_imageIdLarge, addr 0x5df23f8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_imageIdLarge();

  /// @brief Method get_imageIdSmall, addr 0x5df23f0, size 0x8, virtual true, abstract: false, final true
