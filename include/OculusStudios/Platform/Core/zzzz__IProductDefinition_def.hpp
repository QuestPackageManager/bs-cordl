...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Core::IProductDefinition*);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::IProductDefinition*, "OculusStudios.Platform.Core", "IProductDefinition");
// Dependencies
namespace OculusStudios::Platform::Core {
// Is value type: false
