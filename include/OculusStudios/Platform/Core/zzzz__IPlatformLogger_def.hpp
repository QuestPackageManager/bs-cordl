...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Core::IPlatformLogger*);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Core::IPlatformLogger*, "OculusStudios.Platform.Core", "IPlatformLogger");
// Dependencies
namespace OculusStudios::Platform::Core {
// Is value type: false
