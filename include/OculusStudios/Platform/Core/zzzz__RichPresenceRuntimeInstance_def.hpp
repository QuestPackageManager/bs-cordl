...
/// @brief Method .ctor, addr 0x5df3ff8, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::OculusStudios::Platform::Core::IRichPresenceDefinition*  definition, ::StringW  state, ::System::Nullable_1<::OculusStudios::Platform::Core::PartyInfo>  partyInfo, ::System::Nullable_1<::OculusStudios::Platform::Core::RichPresenceTimestamp>  timestamp) ;

/// @brief Method get_definition, addr 0x5df3fc8, size 0x8, virtual false, abstract: false, final false
inline ::OculusStudios::Platform::Core::IRichPresenceDefinition* get_definition() ;

/// @brief Method get_partyInfo, addr 0x5df3fd8, size 0xc, virtual false, abstract: false, final false
inline ::System::Nullable_1<::OculusStudios::Platform::Core::PartyInfo> get_partyInfo() ;

/// @brief Method get_state, addr 0x5df3fd0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_state() ;

/// @brief Method get_timestamp, addr 0x5df3fe4, size 0x14, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_definition_k__BackingField", ty: "::OculusStudios::Platform::Core::IRichPresenceDefinition*", modifiers: "", def_value: None }, CppParam { name: "_state_k__BackingField", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_partyInfo_k__BackingField", ty: "::System::Nullable_1<::OculusStudios::Platform::Core::PartyInfo>", modifiers: "", def_value: None }, CppParam { name: "_timestamp_k__BackingField", ty: "::System::Nullable_1<::OculusStudios::Platform::Core::RichPresenceTimestamp>", modifiers: "", def_value: None }]
constexpr RichPresenceRuntimeInstance(::OculusStudios::Platform::Core::IRichPresenceDefinition*  _definition_k__BackingField, ::StringW  _state_k__BackingField, ::System::Nullable_1<::OculusStudios::Platform::Core::PartyInfo>  _partyInfo_k__BackingField, ::System::Nullable_1<::OculusStudios::Platform::Core::RichPresenceTimestamp>  _timestamp_k__BackingField) noexcept;
