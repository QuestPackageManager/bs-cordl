...
/// @brief Method .ctor, addr 0x5d80498, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_definition, addr 0x5d80468, size 0x8, virtual false, abstract: false, final false
inline ::OculusStudios::Platform::Core::IRichPresenceDefinition* get_definition() ;

/// @brief Method get_partyInfo, addr 0x5d80478, size 0xc, virtual false, abstract: false, final false
inline ::System::Nullable_1<::OculusStudios::Platform::Core::PartyInfo> get_partyInfo() ;

/// @brief Method get_state, addr 0x5d80470, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_state() ;

/// @brief Method get_timestamp, addr 0x5d80484, size 0x14, virtual false, abstract: false, final false
