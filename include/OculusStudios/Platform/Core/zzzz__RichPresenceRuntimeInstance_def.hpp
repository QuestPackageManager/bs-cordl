...
public:
  ...
  /// @brief Method .ctor, addr 0x5f2c2b0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_definition, addr 0x5f2c280, size 0x8, virtual false, abstract: false, final false
  inline ::OculusStudios::Platform::Core::IRichPresenceDefinition* get_definition();

  /// @brief Method get_partyInfo, addr 0x5f2c290, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::OculusStudios::Platform::Core::PartyInfo> get_partyInfo();

  /// @brief Method get_state, addr 0x5f2c288, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_state();

  /// @brief Method get_timestamp, addr 0x5f2c29c, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::Platform::Core::RichPresenceRuntimeInstance) == 0x48, "Size mismatch!");
