...
public:
  ...
  /// @brief Method OculusStudios.Platform.Core.IPlatformInternal.InitializeAsync, addr 0x5df6328, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5df6510, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_displayName, addr 0x5df6290, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_key, addr 0x5df62d4, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_key();

  /// @brief Method get_user, addr 0x5df6320, size 0x8, virtual true, abstract: false, final false
  inline ::OculusStudios::Platform::Core::IPlatformUser* get_user();

  /// @brief Method get_vendor, addr 0x5df6318, size 0x8, virtual true, abstract: false, final false
