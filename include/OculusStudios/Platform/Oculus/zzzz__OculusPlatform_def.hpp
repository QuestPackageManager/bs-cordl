...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Oculus::OculusPlatform*);
...
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Oculus::OculusPlatform*, "OculusStudios.Platform.Oculus", "OculusPlatform");
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::OculusPlatform__OculusStudios_Platform_Core_IPlatformInternal_InitializeAsync_d__19) == 0x48, "Size mismatch!");
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::OculusPlatform) == 0x48, "Size mismatch!");
