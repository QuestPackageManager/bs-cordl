...
/// @brief Method MoveNext, addr 0x5d85450, size 0x430, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5d85940, size 0x6c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::OculusStudios::Platform::Oculus::OculusPlatform*", modifiers: "", def_value: None }, CppParam { name: "initParams", ty: "::OculusStudios::Platform::Core::PlatformInitParams*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>*>", modifiers: "", def_value: None }]
constexpr OculusPlatform__InitializeUserAsync_d__26(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::OculusStudios::Platform::Oculus::OculusPlatform*  __4__this, ::OculusStudios::Platform::Core::PlatformInitParams*  initParams, ::System::Runtime::CompilerServices::TaskAwaiter_1<::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>*>  __u__1) noexcept;
...
/// @brief Method MoveNext, addr 0x5d859ac, size 0x94c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5d862f8, size 0x6c, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::OculusStudios::Platform::Oculus::OculusPlatform*", modifiers: "", def_value: None }, CppParam { name: "initParams", ty: "::OculusStudios::Platform::Core::PlatformInitParams*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::Oculus::Platform::Message_1<::Oculus::Platform::Models::PlatformInitialize*>*>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }, CppParam { name: "__u__3", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::Oculus::Platform::Message*>", modifiers: "", def_value: None }]
...
/// @brief Field destinations, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_destinations, put=__cordl_internal_set_destinations)) ::System::Collections::Generic::IReadOnlyList_1<::OculusStudios::Platform::Core::IRichPresenceDefinition*>*  destinations;
...
/// @brief Method ClearRichPresenceStatus, addr 0x5d84dd0, size 0x8, virtual true, abstract: false, final true
inline void ClearRichPresenceStatus() ;

/// @brief Method Dispose, addr 0x5d84dc8, size 0x8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetAppVersion, addr 0x5d84ddc, size 0x14, virtual true, abstract: false, final true
inline ::StringW GetAppVersion() ;

/// @brief Method GetDestination, addr 0x5d85088, size 0xe4, virtual true, abstract: false, final true
inline ::System::ValueTuple_2<::OculusStudios::Platform::Core::IRichPresenceDefinition*,::StringW> GetDestination() ;

/// @brief Method InitializeUserAsync, addr 0x5d8516c, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method OculusStudios.Platform.Core.IPlatformInternal.InitializeAsync, addr 0x5d84d04, size 0xc4, virtual true, abstract: false, final true
...
/// @brief Method OnJoinIntent, addr 0x5d85230, size 0x154, virtual false, abstract: false, final false
inline void OnJoinIntent(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceJoinIntent*>*  message) ;

/// @brief Method SetRichPresenceStatus, addr 0x5d84df0, size 0x298, virtual true, abstract: false, final true
inline void SetRichPresenceStatus(::OculusStudios::Platform::Core::RichPresenceRuntimeInstance  status) ;

/// @brief Method Tick, addr 0x5d84dd8, size 0x4, virtual true, abstract: false, final true
inline void Tick(float_t  deltaTime) ;

/// @brief Method <GetDestination>b__25_0, addr 0x5d8539c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d85384, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_destinationRequestedEvent, addr 0x5d84b84, size 0xc0, virtual true, abstract: false, final true
...
/// @brief Method get_displayName, addr 0x5d84ae4, size 0x44, virtual true, abstract: false, final true
inline ::StringW get_displayName() ;

/// @brief Method get_entitlements, addr 0x5d84b7c, size 0x8, virtual true, abstract: false, final true
inline ::OculusStudios::Platform::Core::IPlatformEntitlements* get_entitlements() ;

/// @brief Method get_key, addr 0x5d84b28, size 0x44, virtual true, abstract: false, final true
inline ::StringW get_key() ;

/// @brief Method get_user, addr 0x5d84b74, size 0x8, virtual true, abstract: false, final true
inline ::OculusStudios::Platform::Core::IPlatformUser* get_user() ;

/// @brief Method get_vendor, addr 0x5d84b6c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_destinationRequestedEvent, addr 0x5d84c44, size 0xc0, virtual true, abstract: false, final true
...
DEFINE_IL2CPP_ARG_TYPE(::OculusStudios::Platform::Oculus::OculusPlatform__OculusStudios_Platform_Core_IPlatformInternal_InitializeAsync_d__19, "OculusStudios.Platform.Oculus", "OculusPlatform/<OculusStudios-Platform-Core-IPlatformInternal-InitializeAsync>d__19");
