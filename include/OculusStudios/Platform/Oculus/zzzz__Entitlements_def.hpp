...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Oculus::Entitlements*);
MARK_REF_T(::OculusStudios::Platform::Oculus::Entitlements___c*);
MARK_REF_T(::OculusStudios::Platform::Oculus::Entitlements___c__DisplayClass5_0*);
MARK_REF_T(::OculusStudios::Platform::Oculus::Entitlements___c__DisplayClass5_1*);
MARK_VAL_T(::OculusStudios::Platform::Oculus::Entitlements__GetAllProductsAsync_d__5);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Oculus::Entitlements*, "OculusStudios.Platform.Oculus", "Entitlements");
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Oculus::Entitlements___c*, "OculusStudios.Platform.Oculus", "Entitlements/<>c");
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Oculus::Entitlements___c__DisplayClass5_0*, "OculusStudios.Platform.Oculus", "Entitlements/<>c__DisplayClass5_0");
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Oculus::Entitlements___c__DisplayClass5_1*, "OculusStudios.Platform.Oculus", "Entitlements/<>c__DisplayClass5_1");
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Oculus::Entitlements__GetAllProductsAsync_d__5, "OculusStudios.Platform.Oculus", "Entitlements/<GetAllProductsAsync>d__5");
...
public:
  ...
  /// @brief Method <GetAllProductsAsync>b__5_0, addr 0x5f2ee38, size 0x14, virtual false, abstract: false, final false
  inline ::StringW _GetAllProductsAsync_b__5_0(::Oculus::Platform::Models::Purchase* x);

  /// @brief Method <GetAllProductsAsync>b__5_1, addr 0x5f2ee4c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _GetAllProductsAsync_b__5_1(::OculusStudios::Platform::Core::Product* product);

  /// @brief Method .ctor, addr 0x5f2ee34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::Entitlements___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method <GetAllProductsAsync>b__3, addr 0x5f2ee68, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f2ee64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::Entitlements___c__DisplayClass5_0) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method <GetAllProductsAsync>b__2, addr 0x5f2ef48, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f2ef44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::Entitlements___c__DisplayClass5_1) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5f2efa8, size 0xff4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f30040, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::Entitlements__GetAllProductsAsync_d__5) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetAllProductsAsync, addr 0x5f2ec88, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method RegisterNewProducts, addr 0x5f2ed68, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5f2ebcc, size 0xbc, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::Entitlements) == 0x28, "Size mismatch!");
