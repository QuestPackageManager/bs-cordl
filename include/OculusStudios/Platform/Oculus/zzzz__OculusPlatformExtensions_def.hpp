...
// Declarations
template<typename T>
using _WaitAsync_d__0_1 = ::OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitAsync_d__0_1<T>;

template<typename T>
using _WaitWithTimeoutAsync_d__1_1 = ::OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitWithTimeoutAsync_d__1_1<T>;

template<typename T>
using __c__DisplayClass0_0_1 = ::OculusStudios::Platform::Oculus::OculusPlatformExtensions___c__DisplayClass0_0_1<T>;

/// @brief Method GetAwaiter, addr 0x5df853c, size 0x108, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::OculusStudios::Platform::Oculus::OculusPlatformExtensions___c__DisplayClass0_0_1, "OculusStudios.Platform.Oculus", "OculusPlatformExtensions/<>c__DisplayClass0_0`1");
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitWithTimeoutAsync_d__1_1, "OculusStudios.Platform.Oculus", "OculusPlatformExtensions/<WaitWithTimeoutAsync>d__1`1");
