...
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Oculus::OculusPlatformResponseErrorCode, "OculusStudios.Platform.Oculus", "OculusPlatformResponseErrorCode");
// Dependencies
namespace OculusStudios::Platform::Oculus {
// Is value type: true
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::OculusPlatformResponseErrorCode) == 0x4, "Size mismatch!");
