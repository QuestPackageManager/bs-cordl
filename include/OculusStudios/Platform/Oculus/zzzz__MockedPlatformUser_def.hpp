...
public:
  ...
  /// @brief Method GetAccessTokenAsync, addr 0x5df6534, size 0x120, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::StringW>* GetAccessTokenAsync();

  /// @brief Method GetAgeCategoryAsync, addr 0x5df67f4, size 0x70, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::OculusStudios::Platform::Core::UserAgeCategory>* GetAgeCategoryAsync();

  /// @brief Method GetAllAchievementIds, addr 0x5df6864, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IReadOnlyCollection_1<::StringW>* GetAllAchievementIds();

  /// @brief Method GetLocale, addr 0x5df67ec, size 0x8, virtual true, abstract: false, final true
  inline ::StringW GetLocale();

  /// @brief Method GetUnlockedAchievementIdsAsync, addr 0x5df68e0, size 0xe4, virtual true, abstract: false, final true
  ...
  /// @brief Method GetXPlatformAccessTokenAsync, addr 0x5df6654, size 0x198, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::StringW>* GetXPlatformAccessTokenAsync(bool skipCache);

  /// @brief Method IsAchievementUnlockedAsync, addr 0x5df6870, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method UnlockAchievement, addr 0x5df686c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5df63fc, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::OculusStudios::Platform::Core::PlatformInitParams* initParams);

  /// @brief Method get_displayName, addr 0x5df6524, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_displayName();

  /// @brief Method get_userId, addr 0x5df6514, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_displayName, addr 0x5df652c, size 0x8, virtual false, abstract: false, final false
  inline void set_displayName(::StringW value);

  /// @brief Method set_userId, addr 0x5df651c, size 0x8, virtual false, abstract: false, final false
