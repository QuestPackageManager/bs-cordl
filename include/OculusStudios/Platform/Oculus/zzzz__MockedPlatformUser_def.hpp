...
/// @brief Field achievementIdDefinitions, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_achievementIdDefinitions, put=__cordl_internal_set_achievementIdDefinitions)) ::System::Collections::Generic::IReadOnlyCollection_1<::StringW>*  achievementIdDefinitions;
...
/// @brief Method GetAccessTokenAsync, addr 0x5d8454c, size 0x120, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::StringW>* GetAccessTokenAsync() ;

/// @brief Method GetAgeCategoryAsync, addr 0x5d8480c, size 0x70, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::OculusStudios::Platform::Core::UserAgeCategory>* GetAgeCategoryAsync() ;

/// @brief Method GetAllAchievementIds, addr 0x5d8487c, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IReadOnlyCollection_1<::StringW>* GetAllAchievementIds() ;

/// @brief Method GetLocale, addr 0x5d84804, size 0x8, virtual true, abstract: false, final true
inline ::StringW GetLocale() ;

/// @brief Method GetUnlockedAchievementIdsAsync, addr 0x5d848f8, size 0xe4, virtual true, abstract: false, final true
...
/// @brief Method GetXPlatformAccessTokenAsync, addr 0x5d8466c, size 0x198, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::StringW>* GetXPlatformAccessTokenAsync(bool  skipCache) ;

/// @brief Method IsAchievementUnlockedAsync, addr 0x5d84888, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method UnlockAchievement, addr 0x5d84884, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5d84414, size 0x114, virtual false, abstract: false, final false
inline void _ctor(::OculusStudios::Platform::Core::PlatformInitParams*  initParams) ;

/// @brief Method get_displayName, addr 0x5d8453c, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_displayName() ;

/// @brief Method get_userId, addr 0x5d8452c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_displayName, addr 0x5d84544, size 0x8, virtual false, abstract: false, final false
inline void set_displayName(::StringW  value) ;

/// @brief Method set_userId, addr 0x5d84534, size 0x8, virtual false, abstract: false, final false
