...
template <typename T> inline void OculusStudios::Platform::Oculus::OculusPlatformExtensions___c__DisplayClass0_0_1<T>::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions___c__DisplayClass0_0_1<T>*>::get(),
...
template <typename T> inline void OculusStudios::Platform::Oculus::OculusPlatformExtensions___c__DisplayClass0_0_1<T>::_WaitAsync_b__0(::Oculus::Platform::Message_1<T>* result) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions___c__DisplayClass0_0_1<T>*>::get(), "<WaitAsync>b__0",
...
template <typename T> inline void OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitAsync_d__0_1<T>::MoveNext() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitAsync_d__0_1<T>>::get(),
...
inline void OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitAsync_d__0_1<T>::SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitAsync_d__0_1<T>>::get(), "SetStateMachine",
...
template <typename T> inline void OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitWithTimeoutAsync_d__1_1<T>::MoveNext() {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions__WaitWithTimeoutAsync_d__1_1<T>>::get(),
                                  "MoveNext", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
template <typename T>
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Runtime::CompilerServices::TaskAwaiter_1<::Oculus::Platform::Message*> (*)(::Oculus::Platform::Request*)>(
  ...
  constexpr static std::size_t addrs = 0x5d1d9f0;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions*>::get(), "GetAwaiter", std::span<Il2CppClass const* const, 0>(),
...
OculusStudios::Platform::Oculus::OculusPlatformExtensions::WaitAsync(::Oculus::Platform::Request_1<T>* oculusRequest, ::System::Threading::CancellationToken cancellationToken) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions*>::get(), "WaitAsync",
...
OculusStudios::Platform::Oculus::OculusPlatformExtensions::WaitWithTimeoutAsync(::Oculus::Platform::Request_1<T>* oculusRequest, ::System::TimeSpan timeout,
  ...
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions*>::get(), "WaitWithTimeoutAsync",
                                               std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
...
OculusStudios::Platform::Oculus::OculusPlatformExtensions::GetAwaiter(::Oculus::Platform::Request_1<T>* oculusRequest) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OculusStudios::Platform::Oculus::OculusPlatformExtensions*>::get(), "GetAwaiter",
                                               std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
