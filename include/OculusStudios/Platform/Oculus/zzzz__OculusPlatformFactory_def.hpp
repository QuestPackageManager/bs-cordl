...
public:
  ...
  /// @brief Method MoveNext, addr 0x5df8438, size 0x2b8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5df86f0, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateAsync, addr 0x5df834c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method OculusStudios.Platform.Core.IPlatformFactory.CreateAsync, addr 0x5df842c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5df8434, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
