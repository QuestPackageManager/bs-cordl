...
public:
  ...
  /// @brief Method MoveNext, addr 0x5f32268, size 0x2b8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5f32520, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateAsync, addr 0x5f3217c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method OculusStudios.Platform.Core.IPlatformFactory.CreateAsync, addr 0x5f3225c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5f32264, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
