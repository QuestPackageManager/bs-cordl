...
/// @brief Method ParseMessage, addr 0x5d86838, size 0x2b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d867a0, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::Oculus::Platform::Models::Error*  error) ;

/// @brief Method .ctor, addr 0x5d84184, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::Oculus::Platform::Models::Error*  error) ;

/// @brief Method get_message, addr 0x5d86788, size 0x18, virtual false, abstract: false, final false
