...
// Write type traits
MARK_REF_T(::OculusStudios::Platform::Oculus::OculusPlatformResponseException*);
DEFINE_IL2CPP_CLASS(::OculusStudios::Platform::Oculus::OculusPlatformResponseException*, "OculusStudios.Platform.Oculus", "OculusPlatformResponseException");
...
public:
  ...
  /// @brief Method ParseMessage, addr 0x5f32650, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f325b8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Oculus::Platform::Models::Error* error);

  /// @brief Method .ctor, addr 0x5f2ff9c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::Oculus::Platform::Models::Error* error);

  /// @brief Method get_message, addr 0x5f325a0, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::OculusStudios::Platform::Oculus::OculusPlatformResponseException) == 0xa0, "Size mismatch!");
