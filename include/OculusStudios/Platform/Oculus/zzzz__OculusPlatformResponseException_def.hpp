...
/// @brief Method ParseMessage, addr 0x5dfa398, size 0x2b8, virtual false, abstract: false, final false
static inline ::StringW ParseMessage(::StringW  message, ::Oculus::Platform::Models::Error*  error, ::ByRef<::OculusStudios::Platform::Oculus::OculusPlatformResponseErrorCode>  errorCode, ::ByRef<::System::Net::HttpStatusCode>  httpCode) ;
...
/// @brief Method .ctor, addr 0x5dfa300, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::Oculus::Platform::Models::Error*  error) ;

/// @brief Method .ctor, addr 0x5df7ce4, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::Oculus::Platform::Models::Error*  error) ;

/// @brief Method get_message, addr 0x5dfa2e8, size 0x18, virtual false, abstract: false, final false
