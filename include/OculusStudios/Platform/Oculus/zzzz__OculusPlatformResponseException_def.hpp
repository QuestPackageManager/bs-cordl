...
public:
  ...
  /// @brief Method ParseMessage, addr 0x5df8820, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5df8788, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Oculus::Platform::Models::Error* error);

  /// @brief Method .ctor, addr 0x5df616c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::Oculus::Platform::Models::Error* error);

  /// @brief Method get_message, addr 0x5df8770, size 0x18, virtual false, abstract: false, final false
