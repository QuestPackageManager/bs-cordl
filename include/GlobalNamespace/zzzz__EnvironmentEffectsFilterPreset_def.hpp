...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentEffectsFilterPreset, "", "EnvironmentEffectsFilterPreset");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::EnvironmentEffectsFilterPreset) == 0x4, "Size mismatch!");
