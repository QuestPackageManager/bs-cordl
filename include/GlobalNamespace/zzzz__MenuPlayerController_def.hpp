...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MenuPlayerController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MenuPlayerController(MenuPlayerController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MenuPlayerController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MenuPlayerController(MenuPlayerControllerconst&) = delete;
