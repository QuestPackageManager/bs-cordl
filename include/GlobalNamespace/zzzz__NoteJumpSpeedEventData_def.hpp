...
/// @brief Field <relativeNoteJumpSpeed>k__BackingField, offset 0x30, size 0x4 
 __declspec(property(get=__cordl_internal_get__relativeNoteJumpSpeed_k__BackingField, put=__cordl_internal_set__relativeNoteJumpSpeed_k__BackingField)) float_t  _relativeNoteJumpSpeed_k__BackingField;
...
/// @brief Method ChangeRelativeNoteJumpSpeed, addr 0x31945b0, size 0x8, virtual false, abstract: false, final false
inline void ChangeRelativeNoteJumpSpeed(float_t  value) ;

/// @brief Method GetCopy, addr 0x31945b8, size 0x88, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDataItem* GetCopy() ;

/// @brief Method GetDefault, addr 0x3194640, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3194588, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_nextSameTypeEventData, addr 0x31944fc, size 0x7c, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteJumpSpeedEventData* get_nextSameTypeEventData() ;

/// @brief Method get_previousSameTypeEventData, addr 0x3194480, size 0x7c, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteJumpSpeedEventData* get_previousSameTypeEventData() ;

/// @brief Method get_relativeNoteJumpSpeed, addr 0x3194578, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_relativeNoteJumpSpeed, addr 0x3194580, size 0x8, virtual false, abstract: false, final false
