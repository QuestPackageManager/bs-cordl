...
public:
  ...
  /// @brief Method Start, addr 0x3a054fc, size 0x270, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateGravity, addr 0x3a0576c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a05850, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
