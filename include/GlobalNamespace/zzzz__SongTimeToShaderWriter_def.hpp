...
// Write type traits
MARK_REF_T(::GlobalNamespace::SongTimeToShaderWriter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SongTimeToShaderWriter*, "", "SongTimeToShaderWriter");
...
public:
  ...
  /// @brief Method Update, addr 0x5904b20, size 0x244, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5904d64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SongTimeToShaderWriter) == 0x28, "Size mismatch!");
