...
public:
  ...
  /// @brief Method Update, addr 0x3ad266c, size 0x240, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ad28ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
