...
public:
  ...
  /// @brief Method Update, addr 0x3b2e2ec, size 0x240, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b2e52c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
