...
public:
  ...
  /// @brief Method Update, addr 0x57e2cc8, size 0x244, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57e2f0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
