...
public:
  ...
  /// @brief Method Update, addr 0x3b35cb0, size 0x240, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b35ef0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
