...
public:
  ...
  /// @brief Method Update, addr 0x2598db4, size 0x240, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2598ff4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
