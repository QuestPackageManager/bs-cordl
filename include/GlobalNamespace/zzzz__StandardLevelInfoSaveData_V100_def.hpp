...
static inline ::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap* New_ctor(::StringW  difficultyName, int32_t  difficultyRank, ::StringW  beatmapFilename, float_t  noteJumpMovementSpeed, int32_t  noteJumpStartBeatOffset) ;
...
/// @brief Method .ctor, addr 0x36573d4, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapFilename, addr 0x36573bc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_beatmapFilename() ;

/// @brief Method get_difficulty, addr 0x36573ac, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_difficulty() ;

/// @brief Method get_difficultyRank, addr 0x36573b4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_difficultyRank() ;

/// @brief Method get_noteJumpMovementSpeed, addr 0x36573c4, size 0x8, virtual false, abstract: false, final false
inline float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteJumpStartBeatOffset, addr 0x36573cc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _difficultyBeatmaps, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__difficultyBeatmaps, put=__cordl_internal_set__difficultyBeatmaps)) ::ArrayW<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*,::Array<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*>*>  _difficultyBeatmaps;
...
/// @brief Field _version, offset 0x10, size 0x8 
 ...
 __declspec(property(get=get_difficultyBeatmaps)) ::ArrayW<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*,::Array<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*>*>  difficultyBeatmaps;
...
constexpr ::ArrayW<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*,::Array<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*>*> const& __cordl_internal_get__difficultyBeatmaps() const;

constexpr ::ArrayW<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*,::Array<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*>*>& __cordl_internal_get__difficultyBeatmaps() ;
...
constexpr void __cordl_internal_set__difficultyBeatmaps(::ArrayW<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*,::Array<::GlobalNamespace::StandardLevelInfoSaveData_V100_DifficultyBeatmap*>*>  value) ;
...
/// @brief Method .ctor, addr 0x36573a8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beatsPerMinute, addr 0x3657358, size 0x8, virtual false, abstract: false, final false
inline float_t get_beatsPerMinute() ;

/// @brief Method get_coverImageFilename, addr 0x3657390, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_coverImageFilename() ;

/// @brief Method get_difficultyBeatmaps, addr 0x36573a0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_environmentName, addr 0x3657398, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_environmentName() ;

/// @brief Method get_levelAuthorName, addr 0x3657350, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_levelAuthorName() ;

/// @brief Method get_previewDuration, addr 0x3657380, size 0x8, virtual false, abstract: false, final false
inline float_t get_previewDuration() ;

/// @brief Method get_previewStartTime, addr 0x3657378, size 0x8, virtual false, abstract: false, final false
inline float_t get_previewStartTime() ;

/// @brief Method get_shuffle, addr 0x3657368, size 0x8, virtual false, abstract: false, final false
inline float_t get_shuffle() ;

/// @brief Method get_shufflePeriod, addr 0x3657370, size 0x8, virtual false, abstract: false, final false
inline float_t get_shufflePeriod() ;

/// @brief Method get_songAuthorName, addr 0x3657348, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_songAuthorName() ;

/// @brief Method get_songFilename, addr 0x3657388, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_songFilename() ;

/// @brief Method get_songName, addr 0x3657338, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_songName() ;

/// @brief Method get_songSubName, addr 0x3657340, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_songSubName() ;

/// @brief Method get_songTimeOffset, addr 0x3657360, size 0x8, virtual false, abstract: false, final false
inline float_t get_songTimeOffset() ;

/// @brief Method get_version, addr 0x3657330, size 0x8, virtual false, abstract: false, final false
