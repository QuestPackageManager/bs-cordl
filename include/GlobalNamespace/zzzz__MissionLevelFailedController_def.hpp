...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionLevelFailedController*);
MARK_REF_T(::GlobalNamespace::MissionLevelFailedController_InitData*);
MARK_REF_T(::GlobalNamespace::MissionLevelFailedController__LevelFailedCoroutine_d__13*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionLevelFailedController*, "", "MissionLevelFailedController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionLevelFailedController_InitData*, "", "MissionLevelFailedController/InitData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionLevelFailedController__LevelFailedCoroutine_d__13*, "", "MissionLevelFailedController/<LevelFailedCoroutine>d__13");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5918b68, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissionLevelFailedController_InitData", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::GlobalNamespace::MissionLevelFailedController_InitData) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5918b74, size 0x178, virtual true, abstract: false, final true
  ...
  /// [DebuggerHidden]
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5918cec, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// [DebuggerHidden]
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5918cf4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// [DebuggerHidden]
  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5918d2c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// [DebuggerHidden]
  /// @brief Method System.IDisposable.Dispose, addr 0x5918b70, size 0x4, virtual true, abstract: false, final true
  ...
  /// [DebuggerHidden]
  /// @brief Method .ctor, addr 0x5918b5c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissionLevelFailedController__LevelFailedCoroutine_d__13", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
static_assert(sizeof(::GlobalNamespace::MissionLevelFailedController__LevelFailedCoroutine_d__13) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Field _missionLevelSceneSetupData, offset 0x60, size 0x8
  ...
  /// @brief Method HandleLevelFailed, addr 0x5918ae8, size 0x20, virtual false, abstract: false, final false
  inline void HandleLevelFailed();

  /// [IteratorStateMachine(typeof(MissionLevelFailedController::<LevelFailedCoroutine>d__13))]
  /// @brief Method LevelFailedCoroutine, addr 0x5918b08, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59189b0, size 0x138, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59188b8, size 0xf8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5918b64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissionLevelFailedController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ...
  /// [Inject]
  /// @brief Field _missionLevelSceneSetupData, offset: 0x60, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::MissionLevelFailedController, ____prepareLevelCompletionResults) == 0x28, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::MissionLevelFailedController, ____missionLevelSceneSetupData) == 0x60, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::MissionLevelFailedController) == 0x68, "Size mismatch!");
