...
public:
  ...
  /// @brief Method <InitializeAsync>b__15_1, addr 0x3245b60, size 0x28, virtual false, abstract: false, final false
  inline bool _InitializeAsync_b__15_1();

  /// @brief Method .ctor, addr 0x3245b5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3245b88, size 0x244, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3245dcc, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3245dd4, size 0x608, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x324650c, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3246578, size 0x33c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3246964, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Awake, addr 0x32454f0, size 0xa4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetAppStartType, addr 0x32459c4, size 0xb0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AppInit_AppStartType GetAppStartType();

  /// @brief Method HandleBeforeDismissingScenes, addr 0x3245924, size 0xa0, virtual false, abstract: false, final false
  inline void HandleBeforeDismissingScenes(::System::Collections::Generic::IReadOnlyList_1<::StringW>* scenes);

  /// @brief Method InitializeAsync, addr 0x32456d8, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* InitializeAsync();

  static inline ::GlobalNamespace::AppInit* New_ctor();

  /// @brief Method OnDestroy, addr 0x324578c, size 0xd8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PreloadAsync, addr 0x3245644, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method StartGameAsync, addr 0x3245594, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method <InitializeAsync>b__15_0, addr 0x3245ad8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3245a74, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_asyncSceneContext, addr 0x32454c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::BGLib::AppFlow::Initialization::AsyncSceneContext> get_asyncSceneContext();

  /// @brief Method get_gameScenesManager, addr 0x32454c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::GameScenesManager> get_gameScenesManager();

  /// @brief Method get_isTestContext, addr 0x32454d0, size 0x20, virtual false, abstract: false, final false
