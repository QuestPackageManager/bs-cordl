...
public:
  ...
  /// @brief Method <SortPlayers>b__4_0, addr 0x3be39c8, size 0x128, virtual false, abstract: false, final false
  inline int32_t _SortPlayers_b__4_0(::GlobalNamespace::IConnectedPlayer* p1, ::GlobalNamespace::IConnectedPlayer* p2);

  /// @brief Method .ctor, addr 0x3be39c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetAngleBetweenPlayersWithEvenAdjustment, addr 0x3bdd954, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLocalPlayerIndex, addr 0x3be36dc, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOuterCirclePositionAngleForPlayer, addr 0x3bdd9c4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOuterCircleRadius, addr 0x3bdd980, size 0x44, virtual false, abstract: false, final false
  static inline float_t GetOuterCircleRadius(float_t angleBetweenPlayers, float_t innerCircleRadius);

  /// @brief Method GetPlayerWorldPosition, addr 0x3bdd9d8, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method SortPlayers, addr 0x3be35e4, size 0xf8, virtual false, abstract: false, final false
