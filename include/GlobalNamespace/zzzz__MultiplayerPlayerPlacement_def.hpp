...
public:
  ...
  /// @brief Method .ctor addr 0x22568c8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SortPlayers>b__4_0 addr 0x22568d0 size 0x128 virtual false final false
...
public:
  ...
  /// @brief Method GetPlayerWorldPosition addr 0x22518d4 size 0x148 virtual false final false
  ...
  /// @brief Method GetOuterCirclePositionAngleForPlayer addr 0x22518c4 size 0x10 virtual false final false
  ...
  /// @brief Method GetOuterCircleRadius addr 0x2251880 size 0x44 virtual false final false
  static inline float_t GetOuterCircleRadius(float_t angleBetweenPlayers, float_t innerCircleRadius);

  /// @brief Method GetAngleBetweenPlayersWithEvenAdjustment addr 0x2251860 size 0x20 virtual false final false
  ...
  /// @brief Method SortPlayers addr 0x22564e0 size 0xfc virtual false final false
  static inline void SortPlayers(::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>* players);

  /// @brief Method GetLocalPlayerIndex addr 0x22565dc size 0x288 virtual false final false
