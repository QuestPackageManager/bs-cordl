...
public:
  ...
  /// @brief Method Deserialize, addr 0x332ba1c, size 0x2c, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x332b9ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x332ba48, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x332b9f4, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x332baa0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x332b9a8, size 0x44, virtual false, abstract: false, final false
