...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::PlayerDisconnectedPacket);
...
public:
  ...
  /// @brief Method Deserialize, addr 0x32323a0, size 0x2c, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x3232370, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x32323cc, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x3232378, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3232424, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x323232c, size 0x44, virtual false, abstract: false, final false
