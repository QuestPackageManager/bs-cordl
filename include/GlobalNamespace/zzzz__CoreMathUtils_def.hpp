...
public:
  // Declarations
  /// @brief Method CalculateHalfJumpDurationInBeats, addr 0x26a1394, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV1, addr 0x26a1408, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV2, addr 0x26a13d4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a1450, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
