...
public:
  // Declarations
  /// @brief Method CalculateHalfJumpDurationInBeats, addr 0x14921c4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV1, addr 0x1492238, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV2, addr 0x1492204, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1492280, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
