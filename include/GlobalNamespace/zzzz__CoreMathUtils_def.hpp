...
public:
  // Declarations
  /// @brief Method CalculateHalfJumpDurationInBeats, addr 0x269ec58, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV1, addr 0x269eccc, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV2, addr 0x269ec98, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x269ed14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
