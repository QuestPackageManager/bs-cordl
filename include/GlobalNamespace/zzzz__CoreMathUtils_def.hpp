...
public:
  // Declarations
  /// @brief Method CalculateHalfJumpDurationInBeats, addr 0x36f6144, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36f6188, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
