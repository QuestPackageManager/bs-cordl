...
public:
  // Declarations
  /// @brief Method CalculateHalfJumpDurationInBeats, addr 0x3638ef0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV1, addr 0x3638f6c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV2, addr 0x3638f34, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3638fb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
