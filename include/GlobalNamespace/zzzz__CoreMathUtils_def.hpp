...
public:
  // Declarations
  /// @brief Method CalculateHalfJumpDurationInBeats addr 0x11bd694 size 0x40 virtual false final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV2 addr 0x11bd6d4 size 0x34 virtual false final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV1 addr 0x11bd708 size 0x48 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11bd750 size 0x8 virtual false final false
  inline void _ctor();
