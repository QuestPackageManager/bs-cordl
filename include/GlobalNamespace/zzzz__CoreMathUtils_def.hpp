...
public:
// Declarations
/// @brief Method CalculateHalfJumpDurationInBeats, addr 0x35fc8ac, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method __CalculateHalfJumpDurationInBeatsV1, addr 0x35fc928, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method __CalculateHalfJumpDurationInBeatsV2, addr 0x35fc8f0, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35fc970, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
