...
public:
  // Declarations
  /// @brief Method CalculateHalfJumpDurationInBeats, addr 0x35fc95c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV1, addr 0x35fc9d8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV2, addr 0x35fc9a0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35fca20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
