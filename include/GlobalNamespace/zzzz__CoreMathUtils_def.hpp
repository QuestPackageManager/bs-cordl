...
public:
  // Declarations
  /// @brief Method CalculateHalfJumpDurationInBeats, addr 0x139caa0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV1, addr 0x139cb14, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method __CalculateHalfJumpDurationInBeatsV2, addr 0x139cae0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x139cb5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
