...
public:
  ...
  /// @brief Method Start, addr 0x570dc70, size 0x2ac, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x570df1c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
