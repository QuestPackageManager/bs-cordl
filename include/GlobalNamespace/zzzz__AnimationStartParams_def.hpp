...
// Write type traits
MARK_REF_T(::GlobalNamespace::AnimationStartParams*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AnimationStartParams*, "", "AnimationStartParams");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AnimationStartParams", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AnimationStartParams(AnimationStartParams&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AnimationStartParams", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AnimationStartParams(AnimationStartParamsconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::AnimationStartParams) == 0x30, "Size mismatch!");
