...
public:
  ...
  /// @brief Method Run, addr 0x5769bb0, size 0x2d4, virtual false, abstract: false, final false
  inline void Run();

  /// @brief Method SetupNextSettings, addr 0x5769e84, size 0x360, virtual false, abstract: false, final false
  inline ::GlobalNamespace::RecordingSettings* SetupNextSettings();

  /// @brief Method <Run>b__15_0, addr 0x576a1e4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5769ad0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_showRecordingToolScene, addr 0x5769abc, size 0x14, virtual false, abstract: false, final false
