...
/// @brief Field _configurationProcessor, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__configurationProcessor, put=__cordl_internal_set__configurationProcessor)) ::GlobalNamespace::RecordingToolConfigurationProcessor*  _configurationProcessor;
...
static inline ::GlobalNamespace::RecordingToolManager* New_ctor(::GlobalNamespace::RecordingToolConfigurationProcessor*  processor, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection, ::Zenject::DiContainer*  diContainer, ::GlobalNamespace::MenuTransitionsHelper*  menuTransitionsHelper, ::GlobalNamespace::EnvironmentsListModel*  environmentsListModel, ::GlobalNamespace::PlayerDataModel*  playerDataModel) ;

/// @brief Method Run, addr 0x576a4e0, size 0x2d4, virtual false, abstract: false, final false
inline void Run() ;

/// @brief Method SetupNextSettings, addr 0x576a7b4, size 0x360, virtual false, abstract: false, final false
inline ::GlobalNamespace::RecordingSettings* SetupNextSettings() ;

/// @brief Method <Run>b__15_0, addr 0x576ab14, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x576a400, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::RecordingToolConfigurationProcessor*  processor, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection, ::Zenject::DiContainer*  diContainer, ::GlobalNamespace::MenuTransitionsHelper*  menuTransitionsHelper, ::GlobalNamespace::EnvironmentsListModel*  environmentsListModel, ::GlobalNamespace::PlayerDataModel*  playerDataModel) ;

/// @brief Method get_showRecordingToolScene, addr 0x576a3ec, size 0x14, virtual false, abstract: false, final false
