...
public:
  ...
  /// @brief Method .ctor, addr 0x26cb844, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DespawnInternal, addr 0x26cb6dc, size 0x104, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::NoteController* noteController);

  /// @brief Method DespawnInternal, addr 0x26cb7e0, size 0x58, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method DespawnInternal, addr 0x26cb838, size 0x4, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::SliderController* sliderNoteController);

  /// @brief Method Init, addr 0x26cb330, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessNoteData, addr 0x26cb554, size 0x184, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessObstacleData, addr 0x26cb45c, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x26cb6d8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26cb83c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeObstacleControllers, addr 0x26cb2e0, size 0x50, virtual true, abstract: false, final false
