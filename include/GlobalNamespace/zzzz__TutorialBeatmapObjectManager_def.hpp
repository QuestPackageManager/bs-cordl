...
public:
  ...
  /// @brief Method .ctor, addr 0x2396150, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_activeObstacleControllers, addr 0x2395bf0, size 0x50, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::ObstacleController*>* get_activeObstacleControllers();

  /// @brief Method Init, addr 0x2395c40, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessObstacleData, addr 0x2395d6c, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNoteData, addr 0x2395e64, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x2395fe4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method DespawnInternal, addr 0x2395fe8, size 0x104, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::NoteController* noteController);

  /// @brief Method DespawnInternal, addr 0x23960ec, size 0x58, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method DespawnInternal, addr 0x2396144, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2396148, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
