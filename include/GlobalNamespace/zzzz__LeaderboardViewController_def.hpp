...
/// @brief Method RefreshLevelStats, addr 0x5819c90, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5819c94, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
