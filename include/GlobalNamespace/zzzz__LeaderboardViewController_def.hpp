...
/// @brief Method RefreshLevelStats, addr 0x57a7f0c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a7f10, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
