...
public:
  ...
  /// @brief Method RefreshLevelStats, addr 0x265605c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2656060, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
