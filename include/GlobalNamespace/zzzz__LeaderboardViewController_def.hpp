...
public:
  ...
  /// @brief Method RefreshLevelStats, addr 0x58183e4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58183e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
