...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13946), inst: 112 }), TypeDefinitionIndex(TypeDefinitionIndex(13946))}
...
public:
  ...
  /// @brief Method .ctor addr 0x1fa18a4 size 0x48 virtual false final false
  inline void _ctor();
