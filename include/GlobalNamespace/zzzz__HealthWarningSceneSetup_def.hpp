...
public:
  ...
  /// @brief Method InstallBindings, addr 0x24791c8, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2479324, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
