...
// Ctor Parameters [CppParam { name: "category", ty: "::Unity::Profiling::ProfilerCategory", modifiers: "", def_value: None }, CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
...
/// @brief Field _metrics, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__metrics, put=__cordl_internal_set__metrics)) ::ArrayW<::GlobalNamespace::ProfilerMetrics_ProfilerMetric,::Array<::GlobalNamespace::ProfilerMetrics_ProfilerMetric>*>  _metrics;

/// @brief Field _profilerRecorders, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__profilerRecorders, put=__cordl_internal_set__profilerRecorders)) ::ArrayW<::Unity::Profiling::ProfilerRecorder,::Array<::Unity::Profiling::ProfilerRecorder>*>  _profilerRecorders;
...
/// @brief Field kFrameTimeMetrics, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_kFrameTimeMetrics, put=setStaticF_kFrameTimeMetrics)) ::ArrayW<::GlobalNamespace::ProfilerMetrics_ProfilerMetric,::Array<::GlobalNamespace::ProfilerMetrics_ProfilerMetric>*>  kFrameTimeMetrics;

/// @brief Field kMemoryMetrics, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_kMemoryMetrics, put=setStaticF_kMemoryMetrics)) ::ArrayW<::GlobalNamespace::ProfilerMetrics_ProfilerMetric,::Array<::GlobalNamespace::ProfilerMetrics_ProfilerMetric>*>  kMemoryMetrics;

/// @brief Field kRenderingMetrics, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_kRenderingMetrics, put=setStaticF_kRenderingMetrics)) ::ArrayW<::GlobalNamespace::ProfilerMetrics_ProfilerMetric,::Array<::GlobalNamespace::ProfilerMetrics_ProfilerMetric>*>  kRenderingMetrics;

/// @brief Convert operator to "::System::IDisposable"
constexpr operator  ::System::IDisposable*() noexcept;

/// @brief Method AddExposedMetrics, addr 0x57d658c, size 0x474, virtual false, abstract: false, final false
...
/// @brief Method CaptureFrame, addr 0x57d5030, size 0x104, virtual false, abstract: false, final false
inline void CaptureFrame() ;

/// @brief Method Dispose, addr 0x57d5134, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GenerateListReport, addr 0x57d5aa8, size 0x268, virtual false, abstract: false, final false
inline ::StringW GenerateListReport(bool  units) ;

/// @brief Method GenerateTableReport, addr 0x57d57f4, size 0x2b4, virtual false, abstract: false, final false
inline ::StringW GenerateTableReport(bool  units) ;

static inline ::GlobalNamespace::ProfilerMetrics* New_ctor(::ArrayW<::GlobalNamespace::ProfilerMetrics_ProfilerMetric,::Array<::GlobalNamespace::ProfilerMetrics_ProfilerMetric>*>  metrics, ::ArrayW<::Unity::Profiling::ProfilerRecorder,::Array<::Unity::Profiling::ProfilerRecorder>*>  profilerRecorders, int32_t  initialFrameCapacity) ;

/// @brief Method Record, addr 0x57d6110, size 0x2e4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* Record(::ArrayW<::GlobalNamespace::ProfilerMetrics_ProfilerMetric,::Array<::GlobalNamespace::ProfilerMetrics_ProfilerMetric>*>  metrics, int32_t  initialFrameCapacity) ;

/// @brief Method RecordAllMetrics, addr 0x57d6a00, size 0x1f0, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* RecordAllMetrics(int32_t  initialFrameCapacity, bool  listed) ;

/// @brief Method RecordFrameTimingMetrics, addr 0x57d51a4, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* RecordFrameTimingMetrics(int32_t  initialFrameCapacity) ;

/// @brief Method RecordListedMetrics, addr 0x57d64bc, size 0xd0, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* RecordListedMetrics(int32_t  initialFrameCapacity) ;

/// @brief Method RecordMemoryMetrics, addr 0x57d6458, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* RecordMemoryMetrics(int32_t  initialFrameCapacity) ;

/// @brief Method RecordRenderingMetrics, addr 0x57d63f4, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57d6bf0, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::GlobalNamespace::ProfilerMetrics_ProfilerMetric,::Array<::GlobalNamespace::ProfilerMetrics_ProfilerMetric>*>  metrics, ::ArrayW<::Unity::Profiling::ProfilerRecorder,::Array<::Unity::Profiling::ProfilerRecorder>*>  profilerRecorders, int32_t  initialFrameCapacity) ;
