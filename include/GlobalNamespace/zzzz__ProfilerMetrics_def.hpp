...
public:
  ...
  /// @brief Method AddExposedMetrics, addr 0x57d4d24, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method CaptureFrame, addr 0x57d37c8, size 0x104, virtual false, abstract: false, final false
  inline void CaptureFrame();

  /// @brief Method Dispose, addr 0x57d38cc, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GenerateListReport, addr 0x57d4240, size 0x268, virtual false, abstract: false, final false
  inline ::StringW GenerateListReport(bool units);

  /// @brief Method GenerateTableReport, addr 0x57d3f8c, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method Record, addr 0x57d48a8, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordAllMetrics, addr 0x57d5198, size 0x1f0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ProfilerMetrics* RecordAllMetrics(int32_t initialFrameCapacity, bool listed);

  /// @brief Method RecordFrameTimingMetrics, addr 0x57d393c, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ProfilerMetrics* RecordFrameTimingMetrics(int32_t initialFrameCapacity);

  /// @brief Method RecordListedMetrics, addr 0x57d4c54, size 0xd0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ProfilerMetrics* RecordListedMetrics(int32_t initialFrameCapacity);

  /// @brief Method RecordMemoryMetrics, addr 0x57d4bf0, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ProfilerMetrics* RecordMemoryMetrics(int32_t initialFrameCapacity);

  /// @brief Method RecordRenderingMetrics, addr 0x57d4b8c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57d5388, size 0xa4, virtual false, abstract: false, final false
