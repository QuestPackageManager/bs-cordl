...
/// @brief Method AddExposedMetrics, addr 0x5764c14, size 0x474, virtual false, abstract: false, final false
...
/// @brief Method CaptureFrame, addr 0x57636b8, size 0x104, virtual false, abstract: false, final false
inline void CaptureFrame() ;

/// @brief Method Dispose, addr 0x57637bc, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GenerateListReport, addr 0x5764130, size 0x268, virtual false, abstract: false, final false
inline ::StringW GenerateListReport(bool  units) ;

/// @brief Method GenerateTableReport, addr 0x5763e7c, size 0x2b4, virtual false, abstract: false, final false
...
/// @brief Method Record, addr 0x5764798, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method RecordAllMetrics, addr 0x5765088, size 0x1f0, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* RecordAllMetrics(int32_t  initialFrameCapacity, bool  listed) ;

/// @brief Method RecordFrameTimingMetrics, addr 0x576382c, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* RecordFrameTimingMetrics(int32_t  initialFrameCapacity) ;

/// @brief Method RecordListedMetrics, addr 0x5764b44, size 0xd0, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* RecordListedMetrics(int32_t  initialFrameCapacity) ;

/// @brief Method RecordMemoryMetrics, addr 0x5764ae0, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ProfilerMetrics* RecordMemoryMetrics(int32_t  initialFrameCapacity) ;

/// @brief Method RecordRenderingMetrics, addr 0x5764a7c, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5765278, size 0xa4, virtual false, abstract: false, final false
