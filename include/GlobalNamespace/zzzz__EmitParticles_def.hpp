...
public:
  ...
  /// @brief Method Emit, addr 0x2357ee8, size 0x1c, virtual false, abstract: false, final false
  inline void Emit(int32_t count);

  static inline ::GlobalNamespace::EmitParticles* New_ctor();

  /// @brief Method .ctor, addr 0x2357f04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
