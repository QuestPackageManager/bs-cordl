...
public:
  ...
  /// @brief Method Emit, addr 0x248cdec, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x248ce08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
