...
public:
  ...
  /// @brief Method Emit, addr 0x597ea2c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x597ea40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
