...
public:
  ...
  /// @brief Method OnEnable, addr 0x59003f4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59004cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
