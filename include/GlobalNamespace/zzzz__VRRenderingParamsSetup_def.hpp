...
public:
  ...
  /// @brief Method OnEnable, addr 0x3b3cf54, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3d028, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
