...
public:
  ...
  /// @brief Method OnEnable, addr 0x240fc48, size 0xf0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetupOculus, addr 0x240fd38, size 0x210, virtual false, abstract: false, final false
  inline void SetupOculus();

  /// @brief Method Start, addr 0x240ff48, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x240ff4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
