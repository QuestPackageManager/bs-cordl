...
public:
  ...
  /// @brief Method OnEnable, addr 0x24751e4, size 0xf0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetupOculus, addr 0x24752d4, size 0x210, virtual false, abstract: false, final false
  inline void SetupOculus();

  /// @brief Method Start, addr 0x24754e4, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x24754e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
