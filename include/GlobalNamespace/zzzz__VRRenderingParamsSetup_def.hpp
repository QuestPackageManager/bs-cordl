...
public:
  ...
  /// @brief Method OnEnable, addr 0x3b344a4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b34578, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
