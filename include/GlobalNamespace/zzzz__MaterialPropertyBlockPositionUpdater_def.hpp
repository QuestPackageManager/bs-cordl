...
public:
  ...
  /// @brief Method SetProperty, addr 0x23f7414, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f74c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
