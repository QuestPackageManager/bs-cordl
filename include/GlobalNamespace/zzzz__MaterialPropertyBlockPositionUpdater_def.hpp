...
public:
  ...
  /// @brief Method SetProperty, addr 0x565d918, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x565d9cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
