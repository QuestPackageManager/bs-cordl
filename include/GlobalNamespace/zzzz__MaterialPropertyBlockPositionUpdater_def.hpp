...
public:
  ...
  /// @brief Method SetProperty, addr 0x21a9a2c, size 0xb4, virtual true, abstract: false, final false
  inline void SetProperty();

  static inline ::GlobalNamespace::MaterialPropertyBlockPositionUpdater* New_ctor();

  /// @brief Method .ctor, addr 0x21a9ae0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
