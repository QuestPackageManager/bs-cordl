...
public:
  ...
  /// @brief Method SetProperty, addr 0x397c86c, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x397c920, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
