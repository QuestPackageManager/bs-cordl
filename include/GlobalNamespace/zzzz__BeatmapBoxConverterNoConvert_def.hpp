...
public:
  ...
  /// @brief Method ConvertBoxEventGroupId, addr 0x372ff48, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method ConvertRotationEvent, addr 0x3730010, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x37300ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapBoxConverterNoConvert", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapBoxConverterNoConvert(BeatmapBoxConverterNoConvert&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapBoxConverterNoConvert", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapBoxConverterNoConvert(BeatmapBoxConverterNoConvertconst&) = delete;
