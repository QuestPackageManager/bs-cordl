...
public:
  ...
  /// @brief Method ConvertBoxEventGroupId, addr 0x3631194, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method ConvertRotationEvent, addr 0x363125c, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36312f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
