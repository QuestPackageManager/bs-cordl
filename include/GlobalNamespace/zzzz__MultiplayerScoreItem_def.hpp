...
public:
  ...
  /// @brief Method AnimateColors, addr 0x58396e4, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Awake, addr 0x583942c, size 0x1b4, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::MultiplayerScoreItem* New_ctor();

  /// @brief Method OnDestroy, addr 0x58395e0, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetName, addr 0x5839800, size 0x20, virtual false, abstract: false, final false
  inline void SetName(::StringW text);

  /// @brief Method SetPositionAndRotation, addr 0x583966c, size 0x78, virtual false, abstract: false, final false
  inline void SetPositionAndRotation(::UnityEngine::Vector3 position, ::UnityEngine::Quaternion rotation);

  /// @brief Method SetScore, addr 0x5839820, size 0x20, virtual false, abstract: false, final false
  inline void SetScore(::StringW text);

  /// @brief Method <Awake>b__5_0, addr 0x5839844, size 0x20, virtual false, abstract: false, final false
  inline void _Awake_b__5_0(::UnityEngine::Color val);

  /// @brief Method <Awake>b__5_1, addr 0x5839864, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5839840, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
