...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VisualEffectActivationClip", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VisualEffectActivationClip(VisualEffectActivationClip&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VisualEffectActivationClip", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VisualEffectActivationClip(VisualEffectActivationClipconst&) = delete;
