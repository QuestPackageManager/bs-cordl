...
public:
  ...
  /// @brief Method .ctor, addr 0x3638d30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorStyle, addr 0x3638d28, size 0x8, virtual false, abstract: false, final false
