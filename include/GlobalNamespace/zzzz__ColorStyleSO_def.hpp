...
public:
  ...
  /// @brief Method .ctor, addr 0x35d1f58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorStyle, addr 0x35d1f50, size 0x8, virtual false, abstract: false, final false
