...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorStyleSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorStyleSO*, "", "ColorStyleSO");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ColorStyleSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ColorStyleSO(ColorStyleSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ColorStyleSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ColorStyleSO(ColorStyleSOconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::ColorStyleSO) == 0x20, "Size mismatch!");
