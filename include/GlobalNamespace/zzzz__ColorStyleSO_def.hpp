...
public:
  ...
  /// @brief Method .ctor, addr 0x35fc79c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorStyle, addr 0x35fc794, size 0x8, virtual false, abstract: false, final false
