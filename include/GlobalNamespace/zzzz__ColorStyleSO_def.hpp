...
public:
  ...
  /// @brief Method .ctor, addr 0x26a68f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorStyle, addr 0x26a68f0, size 0x8, virtual false, abstract: false, final false
