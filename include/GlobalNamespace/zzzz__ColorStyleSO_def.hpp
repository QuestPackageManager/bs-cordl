...
public:
  ...
  /// @brief Method .ctor, addr 0x26a2144, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorStyle, addr 0x26a213c, size 0x8, virtual false, abstract: false, final false
