...
public:
  ...
  /// @brief Method LoadBuildInfo, addr 0x5cdd040, size 0xb4, virtual false, abstract: false, final false
  inline void LoadBuildInfo();

  static inline ::GlobalNamespace::OVRBuildInfo* New_ctor();

  /// @brief Method OnEnable, addr 0x5cdd03c, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x5cdd0f4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cdd0f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
