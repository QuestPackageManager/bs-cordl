...
public:
  ...
  /// @brief Method Awake, addr 0x576cd50, size 0x84, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x576cdd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
