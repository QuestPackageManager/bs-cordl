...
public:
  ...
  /// @brief Method Awake, addr 0x26af28c, size 0x80, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x26af30c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
