...
public:
  ...
  /// @brief Method Awake, addr 0x5900fec, size 0x84, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x5901070, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
