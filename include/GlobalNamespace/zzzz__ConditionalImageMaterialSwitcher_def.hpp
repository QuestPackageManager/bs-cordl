...
// Write type traits
MARK_REF_T(::GlobalNamespace::ConditionalImageMaterialSwitcher*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ConditionalImageMaterialSwitcher*, "", "ConditionalImageMaterialSwitcher");
...
public:
  ...
  /// @brief Method Awake, addr 0x58ff4b4, size 0x84, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x58ff538, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ConditionalImageMaterialSwitcher) == 0x40, "Size mismatch!");
