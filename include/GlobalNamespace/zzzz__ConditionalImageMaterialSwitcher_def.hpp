...
public:
  ...
  /// @brief Method Awake, addr 0x22b0b84, size 0x80, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x22b0c04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
