...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompletableViewController_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompletableViewController_1(CompletableViewController_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompletableViewController_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompletableViewController_1(CompletableViewController_1const&) = delete;
