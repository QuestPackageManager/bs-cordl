...
public:
  // Declarations
  /// @brief Method InstancerCallback addr 0x1ff5124 size 0x3ac virtual false final false
  ...
  /// @brief Method LogAttr addr 0x1ff54d0 size 0x154 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1ff5624 size 0x8 virtual false final false
  inline void _ctor();
