...
public:
  // Declarations
  /// @brief Method InstancerCallback, addr 0x39ff6a0, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method LogAttr, addr 0x39ffa48, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39ffb9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
