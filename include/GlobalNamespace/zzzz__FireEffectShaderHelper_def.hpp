...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FireEffectShaderHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FireEffectShaderHelper(FireEffectShaderHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FireEffectShaderHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FireEffectShaderHelper(FireEffectShaderHelperconst&) = delete;
