...
/// @brief Method <ToString>b__8_0, addr 0x367c0a4, size 0x1c, virtual false, abstract: false, final false
inline ::StringW _ToString_b__8_0(uint32_t  i) ;

/// @brief Method .ctor, addr 0x367c0a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Deserialize, addr 0x367a9fc, size 0x9c, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x367bd68, size 0x7c, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::BitMaskSparse*  other) ;

/// @brief Method GetBits, addr 0x367be84, size 0x98, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x367a810, size 0x1d8, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetBits, addr 0x367bde4, size 0xa0, virtual true, abstract: false, final true
inline ::GlobalNamespace::BitMaskSparse* SetBits(int32_t  offset, uint64_t  bits) ;

/// @brief Method ToString, addr 0x367bf1c, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x367a4b0, size 0x98, virtual false, abstract: false, final false
inline void _ctor(int32_t  bitCount) ;

/// @brief Method get_bitCount, addr 0x367bd60, size 0x8, virtual true, abstract: false, final true
