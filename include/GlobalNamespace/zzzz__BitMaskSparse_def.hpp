...
// Write type traits
MARK_REF_T(::GlobalNamespace::BitMaskSparse*);
...
public:
  ...
  /// @brief Method <ToString>b__8_0, addr 0x37783cc, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW _ToString_b__8_0(uint32_t i);

  /// @brief Method .ctor, addr 0x37783c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BitMaskSparse___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x3776d24, size 0x9c, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x3778090, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BitMaskSparse* other);

  /// @brief Method GetBits, addr 0x37781ac, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x3776b38, size 0x1d8, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method SetBits, addr 0x377810c, size 0xa0, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BitMaskSparse* SetBits(int32_t offset, uint64_t bits);

  /// @brief Method ToString, addr 0x3778244, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37767d8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(int32_t bitCount);

  /// @brief Method get_bitCount, addr 0x3778088, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::BitMaskSparse) == 0x20, "Size mismatch!");
