...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x58d0e34, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectionDidChange, addr 0x58d0d9c, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58d0e74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x58d0d7c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x58d0d5c, size 0x20, virtual false, abstract: false, final false
