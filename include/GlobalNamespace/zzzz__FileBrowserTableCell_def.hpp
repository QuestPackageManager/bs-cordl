...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x275abfc, size 0x40, virtual true, abstract: false, final false
  inline void HighlightDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  static inline ::GlobalNamespace::FileBrowserTableCell* New_ctor();

  /// @brief Method SelectionDidChange, addr 0x275ab58, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x275ac3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x275ab34, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x275ab10, size 0x24, virtual false, abstract: false, final false
