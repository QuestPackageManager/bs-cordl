...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x5923fec, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectionDidChange, addr 0x5923f54, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x592402c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x5923f34, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x5923f14, size 0x20, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FileBrowserTableCell", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FileBrowserTableCell(FileBrowserTableCell&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FileBrowserTableCell", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FileBrowserTableCell(FileBrowserTableCellconst&) = delete;
