...
public:
  ...
  /// @brief Method .ctor, addr 0x3b7fa04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_canBeActive, addr 0x3b7f82c, size 0x20, virtual false, abstract: false, final false
  inline bool get_canBeActive();

  /// @brief Method get_isActive, addr 0x3b7f75c, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetState, addr 0x3b7f900, size 0x30, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState* GetState(::GlobalNamespace::ColorType colorType);

  /// @brief Method GetState, addr 0x3b7f7e0, size 0x4c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState* GetState(::GlobalNamespace::SaberType saberType);

  /// @brief Method HandleSliderInteractionManagerAllSliderWereRemovedFromActiveSliders, addr 0x3b7f8c0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderInteractionManagerSliderWasAddedToActiveSliders, addr 0x3b7f930, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSparkleEffectDidEnd, addr 0x3b7f84c, size 0x24, virtual false, abstract: false, final false
  inline void HandleSparkleEffectDidEnd(::GlobalNamespace::SaberType saberType);

  /// @brief Method HandleSparkleEffectDidStart, addr 0x3b7f7a0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b7f3bc, size 0x314, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3b7f06c, size 0x350, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryDisableThis, addr 0x3b7f870, size 0x50, virtual false, abstract: false, final false
  inline void TryDisableThis();

  /// @brief Method Update, addr 0x3b7f6d0, size 0x28, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateHaptic, addr 0x3b7f6f8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7f98c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
