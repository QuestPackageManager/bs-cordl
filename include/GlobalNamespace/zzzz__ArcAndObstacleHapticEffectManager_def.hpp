...
public:
  ...
  /// @brief Method .ctor, addr 0x3b7ae20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_canBeActive, addr 0x3b7ac48, size 0x20, virtual false, abstract: false, final false
  inline bool get_canBeActive();

  /// @brief Method get_isActive, addr 0x3b7ab78, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetState, addr 0x3b7ad1c, size 0x30, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState* GetState(::GlobalNamespace::ColorType colorType);

  /// @brief Method GetState, addr 0x3b7abfc, size 0x4c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState* GetState(::GlobalNamespace::SaberType saberType);

  /// @brief Method HandleSliderInteractionManagerAllSliderWereRemovedFromActiveSliders, addr 0x3b7acdc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderInteractionManagerSliderWasAddedToActiveSliders, addr 0x3b7ad4c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSparkleEffectDidEnd, addr 0x3b7ac68, size 0x24, virtual false, abstract: false, final false
  inline void HandleSparkleEffectDidEnd(::GlobalNamespace::SaberType saberType);

  /// @brief Method HandleSparkleEffectDidStart, addr 0x3b7abbc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b7a7d8, size 0x314, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3b7a488, size 0x350, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryDisableThis, addr 0x3b7ac8c, size 0x50, virtual false, abstract: false, final false
  inline void TryDisableThis();

  /// @brief Method Update, addr 0x3b7aaec, size 0x28, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateHaptic, addr 0x3b7ab14, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7ada8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
