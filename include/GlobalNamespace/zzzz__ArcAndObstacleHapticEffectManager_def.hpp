...
public:
  ...
  /// @brief Method .ctor, addr 0x3b8d3ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_canBeActive, addr 0x3b8d214, size 0x20, virtual false, abstract: false, final false
  inline bool get_canBeActive();

  /// @brief Method get_isActive, addr 0x3b8d144, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetState, addr 0x3b8d2e8, size 0x30, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState* GetState(::GlobalNamespace::ColorType colorType);

  /// @brief Method GetState, addr 0x3b8d1c8, size 0x4c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState* GetState(::GlobalNamespace::SaberType saberType);

  /// @brief Method HandleSliderInteractionManagerAllSliderWereRemovedFromActiveSliders, addr 0x3b8d2a8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderInteractionManagerSliderWasAddedToActiveSliders, addr 0x3b8d318, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSparkleEffectDidEnd, addr 0x3b8d234, size 0x24, virtual false, abstract: false, final false
  inline void HandleSparkleEffectDidEnd(::GlobalNamespace::SaberType saberType);

  /// @brief Method HandleSparkleEffectDidStart, addr 0x3b8d188, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b8cda4, size 0x314, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3b8ca54, size 0x350, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryDisableThis, addr 0x3b8d258, size 0x50, virtual false, abstract: false, final false
  inline void TryDisableThis();

  /// @brief Method Update, addr 0x3b8d0b8, size 0x28, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateHaptic, addr 0x3b8d0e0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b8d374, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
