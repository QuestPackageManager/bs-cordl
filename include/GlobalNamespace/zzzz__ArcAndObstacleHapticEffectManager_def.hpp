...
/// @brief Method .ctor, addr 0x57d261c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_canBeActive, addr 0x57d2454, size 0x20, virtual false, abstract: false, final false
inline bool get_canBeActive() ;

/// @brief Method get_isActive, addr 0x57d2394, size 0x40, virtual false, abstract: false, final false
...
/// @brief Field _leftHandEffectState, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__leftHandEffectState, put=__cordl_internal_set__leftHandEffectState)) ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState*  _leftHandEffectState;
...
/// @brief Field _rightHandEffectState, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__rightHandEffectState, put=__cordl_internal_set__rightHandEffectState)) ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState*  _rightHandEffectState;
...
/// @brief Method GetState, addr 0x57d252c, size 0x2c, virtual false, abstract: false, final false
inline ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState* GetState(::GlobalNamespace::ColorType  colorType) ;

/// @brief Method GetState, addr 0x57d2414, size 0x40, virtual false, abstract: false, final false
inline ::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState* GetState(::GlobalNamespace::SaberType  saberType) ;

/// @brief Method HandleSliderInteractionManagerAllSliderWereRemovedFromActiveSliders, addr 0x57d24ec, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method HandleSliderInteractionManagerSliderWasAddedToActiveSliders, addr 0x57d2558, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method HandleSparkleEffectDidEnd, addr 0x57d2474, size 0x28, virtual false, abstract: false, final false
inline void HandleSparkleEffectDidEnd(::GlobalNamespace::SaberType  saberType) ;

/// @brief Method HandleSparkleEffectDidStart, addr 0x57d23d4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x57d1fb8, size 0x350, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57d1c14, size 0x3a4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TryDisableThis, addr 0x57d249c, size 0x50, virtual false, abstract: false, final false
inline void TryDisableThis() ;

/// @brief Method Update, addr 0x57d2308, size 0x28, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateHaptic, addr 0x57d2330, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57d25b4, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
