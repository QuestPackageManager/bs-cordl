...
public:
  ...
  /// @brief Method .ctor, addr 0x58e44ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IgnoreForReflectionProbeBaking", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IgnoreForReflectionProbeBaking(IgnoreForReflectionProbeBaking&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IgnoreForReflectionProbeBaking", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IgnoreForReflectionProbeBaking(IgnoreForReflectionProbeBakingconst&) = delete;
