...
/// @brief Method <ProcessLevelCompletionResultsAfterLevelDidFinish>b__0, addr 0x57a07d8, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a0228, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleResultsViewControllerRestartButtonPressed>b__0, addr 0x57a08b8, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a053c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _enterNameViewController, offset 0x158, size 0x8 
 __declspec(property(get=__cordl_internal_get__enterNameViewController, put=__cordl_internal_set__enterNameViewController)) ::UnityW<::GlobalNamespace::EnterPlayerGuestNameViewController>  _enterNameViewController;
...
/// @brief Field _localLeaderboardViewController, offset 0x150, size 0x8 
 __declspec(property(get=__cordl_internal_get__localLeaderboardViewController, put=__cordl_internal_set__localLeaderboardViewController)) ::UnityW<::GlobalNamespace::LocalLeaderboardViewController>  _localLeaderboardViewController;
...
/// @brief Field _resultsClearedLightsPreset, offset 0x130, size 0x8 
 __declspec(property(get=__cordl_internal_get__resultsClearedLightsPreset, put=__cordl_internal_set__resultsClearedLightsPreset)) ::UnityW<::GlobalNamespace::MenuLightsPresetSO>  _resultsClearedLightsPreset;

/// @brief Field _resultsFailedLightsPreset, offset 0x138, size 0x8 
 __declspec(property(get=__cordl_internal_get__resultsFailedLightsPreset, put=__cordl_internal_set__resultsFailedLightsPreset)) ::UnityW<::GlobalNamespace::MenuLightsPresetSO>  _resultsFailedLightsPreset;
...
/// @brief Method HandleResultsViewControllerContinueButtonPressed, addr 0x57a0400, size 0x40, virtual false, abstract: false, final false
inline void HandleResultsViewControllerContinueButtonPressed(::GlobalNamespace::ResultsViewController*  resultsViewController) ;

/// @brief Method HandleResultsViewControllerRestartButtonPressed, addr 0x57a0440, size 0xfc, virtual false, abstract: false, final false
inline void HandleResultsViewControllerRestartButtonPressed(::GlobalNamespace::ResultsViewController*  resultsViewController) ;

/// @brief Method IsNewHighScore, addr 0x57a029c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish, addr 0x579ff68, size 0x2c0, virtual true, abstract: false, final false
inline void ProcessLevelCompletionResultsAfterLevelDidFinish(::GlobalNamespace::LevelCompletionResults*  levelCompletionResults, ::GlobalNamespace::IReadonlyBeatmapData*  transformedBeatmapData, ::GlobalNamespace::BeatmapKey  beatmapKey, ::GlobalNamespace::BeatmapLevel*  beatmapLevel, ::GlobalNamespace::GameplayModifiers*  modifiers, bool  practice) ;

/// @brief Method ProcessScore, addr 0x57a02e0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate, addr 0x579fbfc, size 0x1ec, virtual true, abstract: false, final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate, addr 0x579fe14, size 0x154, virtual true, abstract: false, final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method WillScoreGoToLeaderboard, addr 0x57a024c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a07c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameMode, addr 0x579fb60, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_gameMode() ;

/// @brief Method get_leaderboardViewController, addr 0x579fba4, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::GlobalNamespace::LeaderboardViewController> get_leaderboardViewController() ;

/// @brief Method get_mainTitle, addr 0x579fbb4, size 0x48, virtual true, abstract: false, final false
inline ::StringW get_mainTitle() ;

/// @brief Method get_showBackButtonForMainViewController, addr 0x579fbac, size 0x8, virtual true, abstract: false, final false
