...
public:
  ...
  /// @brief Method HandleMainMenuViewControllerDidFinish, addr 0x3acfe00, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMainMenuViewControllerPromoButtonWasPressed, addr 0x3acfe24, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3acfcd4, size 0x12c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3acfbc0, size 0xf4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartFireworks, addr 0x3acfcb4, size 0x20, virtual false, abstract: false, final false
  inline void StartFireworks();

  /// @brief Method StopFireworks, addr 0x3acfe04, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3acfe28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
