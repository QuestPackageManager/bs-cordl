...
public:
  ...
  /// @brief Method Start, addr 0x22ac9ac, size 0xfc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnDestroy, addr 0x22acac8, size 0x140, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleMainMenuViewControllerDidFinish, addr 0x22acc08, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMainMenuViewControllerPromoButtonWasPressed, addr 0x22acc2c, size 0x4, virtual false, abstract: false, final false
  inline void HandleMainMenuViewControllerPromoButtonWasPressed(::GlobalNamespace::__DlcPromoPanelModel__PromoInfo* promoInfo);

  /// @brief Method StartFireworks, addr 0x22acaa8, size 0x20, virtual false, abstract: false, final false
  inline void StartFireworks();

  /// @brief Method StopFireworks, addr 0x22acc0c, size 0x20, virtual false, abstract: false, final false
  inline void StopFireworks();

  static inline ::GlobalNamespace::AnniversaryManager* New_ctor();

  /// @brief Method .ctor, addr 0x22acc30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
