...
public:
  ...
  /// @brief Method HandleMainMenuViewControllerDidFinish, addr 0x24fd594, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMainMenuViewControllerPromoButtonWasPressed, addr 0x24fd5b8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x24fd454, size 0x140, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x24fd338, size 0xfc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartFireworks, addr 0x24fd434, size 0x20, virtual false, abstract: false, final false
  inline void StartFireworks();

  /// @brief Method StopFireworks, addr 0x24fd598, size 0x20, virtual false, abstract: false, final false
