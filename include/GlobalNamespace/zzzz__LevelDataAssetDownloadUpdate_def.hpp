...
/// @brief Method .ctor, addr 0x3630970, size 0x10, virtual false, abstract: false, final false
...
constexpr LevelDataAssetDownloadUpdate(::StringW  levelID, uint32_t  bytesTotal, uint32_t  bytesTransferred, ::GlobalNamespace::LevelDataAssetDownloadUpdate_AssetDownloadingState  assetDownloadingState) noexcept;
