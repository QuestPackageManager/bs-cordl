...
public:
  ...
  /// @brief Method .ctor, addr 0x3641764, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customSongPackMaskItems, addr 0x364175c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_defaultSongPackMaskItems, addr 0x3641754, size 0x8, virtual false, abstract: false, final false
