...
public:
  ...
  /// @brief Method .ctor, addr 0x373ac18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customSongPackMaskItems, addr 0x373ac10, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::SongPackMasksModelItem*> get_customSongPackMaskItems();

  /// @brief Method get_defaultSongPackMaskItems, addr 0x373ac08, size 0x8, virtual false, abstract: false, final false
