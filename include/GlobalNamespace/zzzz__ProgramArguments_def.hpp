...
public:
  ...
  /// @brief Method Empty, addr 0x2401e94, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2401e6c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::StringW>* arguments);

  /// @brief Method get_arguments, addr 0x2401e64, size 0x8, virtual false, abstract: false, final false
