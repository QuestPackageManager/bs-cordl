...
public:
  ...
  /// @brief Method get_arguments addr 0x21baba8 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21babb0 size 0x28 virtual false final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::StringW>* arguments);

  /// @brief Method Empty addr 0x21babd8 size 0xb4 virtual false final false
