...
public:
  ...
  /// @brief Method .ctor, addr 0x5a33080, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SharedSpatialAnchorCoreBuildingBlock", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SharedSpatialAnchorCoreBuildingBlock(SharedSpatialAnchorCoreBuildingBlock&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SharedSpatialAnchorCoreBuildingBlock", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SharedSpatialAnchorCoreBuildingBlock(SharedSpatialAnchorCoreBuildingBlockconst&) = delete;
