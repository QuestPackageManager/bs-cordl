...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SelectableStateController_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SelectableStateController_1(SelectableStateController_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SelectableStateController_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SelectableStateController_1(SelectableStateController_1const&) = delete;
