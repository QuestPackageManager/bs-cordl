...
public:
  ...
  /// @brief Method Awake, addr 0x57eb9f8, size 0x88, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method IsEmitting, addr 0x57de9e4, size 0x3c, virtual false, abstract: false, final false
  inline bool IsEmitting();

  static inline ::GlobalNamespace::ObstacleSaberSparkleEffect* New_ctor();

  /// @brief Method SetPositionAndRotation, addr 0x57ded3c, size 0x78, virtual false, abstract: false, final false
  inline void SetPositionAndRotation(::UnityEngine::Vector3 pos, ::UnityEngine::Quaternion rot);

  /// @brief Method StartEmission, addr 0x57dedb4, size 0xa0, virtual false, abstract: false, final false
  inline void StartEmission();

  /// @brief Method StopEmission, addr 0x57dee54, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57eba80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_color, addr 0x57de6c4, size 0xa8, virtual false, abstract: false, final false
