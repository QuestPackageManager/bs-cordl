...
public:
  ...
  /// @brief Method Awake, addr 0x3b91e94, size 0x5c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method IsEmitting, addr 0x3b86d2c, size 0xc, virtual false, abstract: false, final false
  inline bool IsEmitting();

  static inline ::GlobalNamespace::ObstacleSaberSparkleEffect* New_ctor();

  /// @brief Method SetPositionAndRotation, addr 0x3b87094, size 0x78, virtual false, abstract: false, final false
  inline void SetPositionAndRotation(::UnityEngine::Vector3 pos, ::UnityEngine::Quaternion rot);

  /// @brief Method StartEmission, addr 0x3b8710c, size 0x54, virtual false, abstract: false, final false
  inline void StartEmission();

  /// @brief Method StopEmission, addr 0x3b87160, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b91ef0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_color, addr 0x3b86974, size 0xfc, virtual false, abstract: false, final false
