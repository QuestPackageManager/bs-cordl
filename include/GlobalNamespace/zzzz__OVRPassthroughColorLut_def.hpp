...
public:
  ...
  /// @brief Method Execute, addr 0x404cf68, size 0xa0, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x404d2a0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t resolution, int32_t slicesPerRow, int32_t channelCount, bool flipY);

  /// @brief Method get_ChannelCount, addr 0x404d378, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ChannelCount();

  /// @brief Method get_FlipY, addr 0x404d380, size 0x8, virtual false, abstract: false, final false
  inline bool get_FlipY();

  /// @brief Method get_Height, addr 0x404d360, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Height();

  /// @brief Method get_Resolution, addr 0x404d368, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Resolution();

  /// @brief Method get_SlicesPerRow, addr 0x404d370, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_SlicesPerRow();

  /// @brief Method get_Width, addr 0x404d358, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x404d2b8, size 0xa0, virtual true, abstract: false, final true
  inline void Execute(int32_t index);
...
public:
  ...
  /// @brief Method GetTextureSettings, addr 0x404d008, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method MapColorValues, addr 0x404d104, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method TextureToColorByteMap, addr 0x404c6c0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetTextureLayout, addr 0x404ca74, size 0x224, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ChannelsToCount, addr 0x404ce10, size 0x10, virtual false, abstract: false, final false
  static inline int32_t ChannelsToCount(::GlobalNamespace::OVRPassthroughColorLut_ColorChannels channels);

  /// @brief Method Create, addr 0x404bb10, size 0xf0, virtual false, abstract: false, final false
  inline void Create(::GlobalNamespace::OVRPlugin_PassthroughColorLutData lutData);

  /// @brief Method CreateLutData, addr 0x404ce40, size 0x94, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_PassthroughColorLutData CreateLutData(::ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> colorBytes);

  /// @brief Method CreateLutDataFromArray, addr 0x404bc9c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLutDataFromArray, addr 0x404bd84, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLutDataFromArray, addr 0x404bf3c, size 0x58, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_PassthroughColorLutData CreateLutDataFromArray(::ArrayW<uint8_t, ::Array<uint8_t>*> colors);

  /// @brief Method CreateLutDataFromTexture, addr 0x404bab8, size 0x58, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_PassthroughColorLutData CreateLutDataFromTexture(::UnityEngine::Texture2D* lut, bool flipY);

  /// @brief Method Destroy, addr 0x404c7b8, size 0x110, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Dispose, addr 0x404c774, size 0x44, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Finalize, addr 0x404ced4, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method GetChannelsForTextureFormat, addr 0x404b7d8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResolutionFromSize, addr 0x404cc98, size 0xb4, virtual false, abstract: false, final false
  static inline uint32_t GetResolutionFromSize(int32_t size);

  /// @brief Method GetTextureSize, addr 0x404b6fc, size 0xdc, virtual false, abstract: false, final false
  static inline int32_t GetTextureSize(::UnityEngine::Texture2D* texture);

  /// @brief Method GetTextureSizeFromByteArray, addr 0x404be2c, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPowerOfTwo, addr 0x404ce20, size 0x20, virtual false, abstract: false, final false
  static inline bool IsPowerOfTwo(uint32_t x);

  /// @brief Method IsResolutionAccepted, addr 0x404cd4c, size 0xc4, virtual false, abstract: false, final false
  static inline bool IsResolutionAccepted(uint32_t resolution, int32_t size, ::ByRef<::StringW> errorMessage);

  /// @brief Method IsTextureSupported, addr 0x404c8c8, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidUpdateResolution, addr 0x404c59c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateFrom, addr 0x404bf94, size 0xc0, virtual false, abstract: false, final false
  inline void UpdateFrom(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> colors);

  /// @brief Method UpdateFrom, addr 0x404c28c, size 0xc0, virtual false, abstract: false, final false
  inline void UpdateFrom(::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> colors);

  /// @brief Method UpdateFrom, addr 0x404c418, size 0xcc, virtual false, abstract: false, final false
  inline void UpdateFrom(::ArrayW<uint8_t, ::Array<uint8_t>*> colors);

  /// @brief Method UpdateFrom, addr 0x404c4e4, size 0xb8, virtual false, abstract: false, final false
  inline void UpdateFrom(::UnityEngine::Texture2D* lutTexture, bool flipY);

  /// @brief Method WriteColorsAsBytes, addr 0x404c054, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteColorsAsBytes, addr 0x404c34c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x404bc00, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x404bce8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x404bdd0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x404b668, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture2D* initialLutTexture, bool flipY);

  /// @brief Method .ctor, addr 0x404b870, size 0x248, virtual false, abstract: false, final false
  inline void _ctor(int32_t size, ::GlobalNamespace::OVRPassthroughColorLut_ColorChannels channels);

  /// @brief Method get_Channels, addr 0x404b644, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPassthroughColorLut_ColorChannels get_Channels();

  /// @brief Method get_IsInitialized, addr 0x404b654, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_Resolution, addr 0x404b634, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_Resolution();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_Channels, addr 0x404b64c, size 0x8, virtual false, abstract: false, final false
  inline void set_Channels(::GlobalNamespace::OVRPassthroughColorLut_ColorChannels value);

  /// @brief Method set_IsInitialized, addr 0x404b65c, size 0xc, virtual false, abstract: false, final false
  inline void set_IsInitialized(bool value);

  /// @brief Method set_Resolution, addr 0x404b63c, size 0x8, virtual false, abstract: false, final false
