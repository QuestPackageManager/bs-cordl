...
public:
  ...
  /// @brief Method CreateFromSerializedData, addr 0x13a3148, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BitMask128 CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Deserialize, addr 0x13a3150, size 0x40, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::BitMask128 Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x13a3240, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x13a321c, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BitMask128 other);

  /// @brief Method GetBits, addr 0x13a2f44, size 0xbc, virtual true, abstract: false, final true
  inline uint64_t GetBits(int32_t offset, int32_t count);

  /// @brief Method GetHashCode, addr 0x13a32c8, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Serialize, addr 0x13a3108, size 0x40, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method SetBits, addr 0x13a2edc, size 0x68, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BitMask128 SetBits(int32_t offset, uint64_t bits);

  /// @brief Method ToString, addr 0x13a3190, size 0x8c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x13a2ecc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint64_t d0, uint64_t d1);

  /// @brief Method .ctor, addr 0x13a2ed4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint64_t value);

  /// @brief Method get_bitCount, addr 0x13a2eb8, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_bitCount();

  /// @brief Method get_maxValue, addr 0x13a2ec0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseAnd, addr 0x13a3014, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseOr, addr 0x13a3000, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x13a30a4, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Equality(ByRef<::GlobalNamespace::BitMask128> a, ByRef<::GlobalNamespace::BitMask128> b);

  /// @brief Method op_ExclusiveOr, addr 0x13a3028, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x13a30fc, size 0xc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::BitMask128 op_Implicit___GlobalNamespace__BitMask128(uint64_t value);

  /// @brief Method op_Inequality, addr 0x13a30d0, size 0x2c, virtual false, abstract: false, final false
  static inline bool op_Inequality(ByRef<::GlobalNamespace::BitMask128> a, ByRef<::GlobalNamespace::BitMask128> b);

  /// @brief Method op_LeftShift, addr 0x13a303c, size 0x34, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::BitMask128 op_LeftShift(ByRef<::GlobalNamespace::BitMask128> a, int32_t bits);

  /// @brief Method op_RightShift, addr 0x13a3070, size 0x34, virtual false, abstract: false, final false
