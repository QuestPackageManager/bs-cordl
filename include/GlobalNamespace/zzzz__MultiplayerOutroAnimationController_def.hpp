...
/// @brief Field _badgeTimelinePropertyNames, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__badgeTimelinePropertyNames, put=__cordl_internal_set__badgeTimelinePropertyNames)) ::ArrayW<::UnityEngine::PropertyName,::Array<::UnityEngine::PropertyName>*>  _badgeTimelinePropertyNames;
...
/// @brief Field _localPlayerTimelinePropertyName, offset 0x40, size 0x4 
 __declspec(property(get=__cordl_internal_get__localPlayerTimelinePropertyName, put=__cordl_internal_set__localPlayerTimelinePropertyName)) ::UnityEngine::PropertyName  _localPlayerTimelinePropertyName;
...
/// @brief Field _multiplayerResultsPyramidView, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerResultsPyramidView, put=__cordl_internal_set__multiplayerResultsPyramidView)) ::UnityW<::GlobalNamespace::MultiplayerResultsPyramidView>  _multiplayerResultsPyramidView;

/// @brief Field _multiplayerScoreRingManager, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerScoreRingManager, put=__cordl_internal_set__multiplayerScoreRingManager)) ::UnityW<::GlobalNamespace::MultiplayerScoreRingManager>  _multiplayerScoreRingManager;
...
/// @brief Field _playerTimelinePropertyNames, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__playerTimelinePropertyNames, put=__cordl_internal_set__playerTimelinePropertyNames)) ::ArrayW<::UnityEngine::PropertyName,::Array<::UnityEngine::PropertyName>*>  _playerTimelinePropertyNames;
...
/// @brief Field _resultsTimelinePropertyNames, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__resultsTimelinePropertyNames, put=__cordl_internal_set__resultsTimelinePropertyNames)) ::ArrayW<::UnityEngine::PropertyName,::Array<::UnityEngine::PropertyName>*>  _resultsTimelinePropertyNames;
...
/// @brief Method AnimateOutro, addr 0x582a030, size 0x1c4, virtual false, abstract: false, final false
inline void AnimateOutro(::GlobalNamespace::MultiplayerResultsData*  multiplayerResultsData, ::System::Action*  onCompleted) ;

/// @brief Method BindOutroTimeline, addr 0x5835fe8, size 0x67c, virtual false, abstract: false, final false
inline void BindOutroTimeline() ;

/// @brief Method BindRingsAndAudio, addr 0x5836664, size 0x6f0, virtual false, abstract: false, final false
...
/// @brief Method Completed, addr 0x5837348, size 0x20, virtual false, abstract: false, final false
inline void Completed() ;

/// @brief Method HandlePlayerSpawningDidFinish, addr 0x5835d60, size 0x24, virtual false, abstract: false, final false
inline void HandlePlayerSpawningDidFinish() ;

static inline ::GlobalNamespace::MultiplayerOutroAnimationController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5835e30, size 0x10c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5835c88, size 0xd8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x583775c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
