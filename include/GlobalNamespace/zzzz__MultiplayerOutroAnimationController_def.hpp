...
public:
  ...
  __declspec(property(get = __cordl_internal_get__badgeTimelinePropertyNames, put = __cordl_internal_set__badgeTimelinePropertyNames)) ::ArrayW<::UnityEngine::PropertyName>
      _badgeTimelinePropertyNames;

  /// @brief Field _badgeTimelineTrackNames, offset 0x70, size 0x8
  __declspec(property(get = __cordl_internal_get__badgeTimelineTrackNames, put = __cordl_internal_set__badgeTimelineTrackNames)) ::ArrayW<::StringW> _badgeTimelineTrackNames;
  ...
  __declspec(property(get = __cordl_internal_get__playerTimelinePropertyNames, put = __cordl_internal_set__playerTimelinePropertyNames)) ::ArrayW<::UnityEngine::PropertyName>
      _playerTimelinePropertyNames;

  /// @brief Field _playerTimelineTrackNames, offset 0x30, size 0x8
  __declspec(property(get = __cordl_internal_get__playerTimelineTrackNames, put = __cordl_internal_set__playerTimelineTrackNames)) ::ArrayW<::StringW> _playerTimelineTrackNames;
  ...
  __declspec(property(get = __cordl_internal_get__resultsTimelinePropertyNames, put = __cordl_internal_set__resultsTimelinePropertyNames)) ::ArrayW<::UnityEngine::PropertyName>
      _resultsTimelinePropertyNames;

  /// @brief Field _resultsTimelineTrackNames, offset 0x50, size 0x8
  __declspec(property(get = __cordl_internal_get__resultsTimelineTrackNames, put = __cordl_internal_set__resultsTimelineTrackNames)) ::ArrayW<::StringW> _resultsTimelineTrackNames;

  /// @brief Field _ringTimelineTrackNames, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get__ringTimelineTrackNames, put = __cordl_internal_set__ringTimelineTrackNames)) ::ArrayW<::StringW> _ringTimelineTrackNames;
  ...
  /// @brief Method AnimateOutro, addr 0x59ce0e8, size 0x1c0, virtual false, abstract: false, final false
  inline void AnimateOutro(::GlobalNamespace::MultiplayerResultsData* multiplayerResultsData, ::System::Action* onCompleted);

  /// @brief Method BindOutroTimeline, addr 0x59da67c, size 0x67c, virtual false, abstract: false, final false
  inline void BindOutroTimeline();

  /// @brief Method BindRingsAndAudio, addr 0x59daea8, size 0x6f0, virtual false, abstract: false, final false
  ...
  /// @brief Method Completed, addr 0x59dbb8c, size 0x20, virtual false, abstract: false, final false
  inline void Completed();

  /// @brief Method HandlePlayerSpawningDidFinish, addr 0x59da3f4, size 0x24, virtual false, abstract: false, final false
  inline void HandlePlayerSpawningDidFinish();

  static inline ::GlobalNamespace::MultiplayerOutroAnimationController* New_ctor();

  /// @brief Method OnDestroy, addr 0x59da4c4, size 0x10c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59da31c, size 0xd8, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::UnityEngine::PropertyName> const& __cordl_internal_get__badgeTimelinePropertyNames() const;

  constexpr ::ArrayW<::UnityEngine::PropertyName>& __cordl_internal_get__badgeTimelinePropertyNames();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__badgeTimelineTrackNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__badgeTimelineTrackNames();
  ...
  constexpr ::ArrayW<::UnityEngine::PropertyName> const& __cordl_internal_get__playerTimelinePropertyNames() const;

  constexpr ::ArrayW<::UnityEngine::PropertyName>& __cordl_internal_get__playerTimelinePropertyNames();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__playerTimelineTrackNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__playerTimelineTrackNames();
  ...
  constexpr ::ArrayW<::UnityEngine::PropertyName> const& __cordl_internal_get__resultsTimelinePropertyNames() const;

  constexpr ::ArrayW<::UnityEngine::PropertyName>& __cordl_internal_get__resultsTimelinePropertyNames();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__resultsTimelineTrackNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__resultsTimelineTrackNames();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get__ringTimelineTrackNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get__ringTimelineTrackNames();
  ...
  constexpr void __cordl_internal_set__badgeTimelinePropertyNames(::ArrayW<::UnityEngine::PropertyName> value);

  constexpr void __cordl_internal_set__badgeTimelineTrackNames(::ArrayW<::StringW> value);
  ...
  constexpr void __cordl_internal_set__playerTimelinePropertyNames(::ArrayW<::UnityEngine::PropertyName> value);

  constexpr void __cordl_internal_set__playerTimelineTrackNames(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set__resultsMocksActivationTrack(::StringW value);

  constexpr void __cordl_internal_set__resultsTimelinePropertyNames(::ArrayW<::UnityEngine::PropertyName> value);

  constexpr void __cordl_internal_set__resultsTimelineTrackNames(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set__ringTimelineTrackNames(::ArrayW<::StringW> value);
  ...
  /// @brief Method .ctor, addr 0x59dbfa0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerOutroAnimationController) == 0xc8, "Size mismatch!");
