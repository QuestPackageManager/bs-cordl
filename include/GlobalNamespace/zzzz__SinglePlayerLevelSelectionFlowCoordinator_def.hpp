...
public:
  ...
  /// @brief Method .ctor addr 0x229c818 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <StartLevelOrShow360Prompt>b__0 addr 0x229c9f0 size 0x98 virtual false final false
  inline void _StartLevelOrShow360Prompt_b__0(int32_t _);

  /// @brief Method <StartLevelOrShow360Prompt>b__1 addr 0x229ca88 size 0x50 virtual false final false
...
public:
  ...
  /// @brief Method get_isInPracticeView addr 0x229bc98 size 0x74 virtual false final false
  inline bool get_isInPracticeView();

  /// @brief Method get_playerSettings addr 0x229bd0c size 0x1c virtual false final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSettings();

  /// @brief Method get_enableCustomLevels addr 0x229bd28 size 0x1c virtual true final false
  inline bool get_enableCustomLevels();

  /// @brief Method get_gameplayModifiers addr 0x229bd44 size 0x1c virtual false final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_hideGameplaySetup addr 0x229bd60 size 0x8 virtual true final false
  inline bool get_hideGameplaySetup();

  /// @brief Method get_leaderboardViewController addr 0x229bd68 size 0x8 virtual true final false
  inline ::GlobalNamespace::LeaderboardViewController* get_leaderboardViewController();

  /// @brief Method get_initialTopScreenViewController addr 0x229bd70 size 0x8 virtual true final false
  inline ::HMUI::ViewController* get_initialTopScreenViewController();

  /// @brief Method get_initialLeftScreenViewController addr 0x229bd78 size 0x30 virtual true final false
  inline ::HMUI::ViewController* get_initialLeftScreenViewController();

  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate addr 0x229bda8 size 0x4 virtual true final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate addr 0x229bdac size 0x4 virtual true final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish addr 0x229bdb0 size 0x4 virtual true final false
  ...
  /// @brief Method add_didFinishEvent addr 0x228b904 size 0xb4 virtual false final false
  inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator*>* value);

  /// @brief Method remove_didFinishEvent addr 0x228c288 size 0xb4 virtual false final false
  inline void remove_didFinishEvent(::System::Action_1<::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator*>* value);

  /// @brief Method LevelSelectionFlowCoordinatorDidActivate addr 0x229bdb4 size 0xbc virtual true final true
  inline void LevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorDidDeactivate addr 0x229be70 size 0xb4 virtual true final true
  inline void LevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange addr 0x229bf24 size 0x258 virtual true final false
  ...
  /// @brief Method ActionButtonWasPressed addr 0x229c17c size 0xc virtual true final false
  inline void ActionButtonWasPressed();

  /// @brief Method PracticeButtonWasPressed addr 0x229c530 size 0x268 virtual true final false
  inline void PracticeButtonWasPressed();

  /// @brief Method SelectionDidChange addr 0x229c798 size 0x80 virtual true final false
  inline void SelectionDidChange(::GlobalNamespace::IBeatmapLevelPack* pack, ::GlobalNamespace::IDifficultyBeatmap* beatmap);

  /// @brief Method StartLevelOrShow360Prompt addr 0x229c188 size 0x3a8 virtual false final false
  inline void StartLevelOrShow360Prompt(::System::Action* beforeSceneSwitchCallback, bool practice);

  /// @brief Method StartLevel addr 0x228e0d0 size 0x2b0 virtual false final false
  inline void StartLevel(::System::Action* beforeSceneSwitchCallback, bool practice);

  /// @brief Method HandlePracticeViewControllerDidPressPlayButton addr 0x229c820 size 0xc virtual false final false
  inline void HandlePracticeViewControllerDidPressPlayButton();

  /// @brief Method HandleStandardLevelDidFinish addr 0x229c82c size 0x80 virtual false final false
  ...
  /// @brief Method BackButtonWasPressed addr 0x229c8ac size 0x90 virtual true final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method SetupGameplaySetupViewController addr 0x229ad58 size 0x30 virtual false final false
  ...
  /// @brief Method HandleBasicLevelCompletionResults addr 0x229b120 size 0x24 virtual false final false
  ...
  /// @brief Method DismissPracticeViewController addr 0x229c93c size 0xb4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x229b380 size 0x8 virtual false final false
  inline void _ctor();
