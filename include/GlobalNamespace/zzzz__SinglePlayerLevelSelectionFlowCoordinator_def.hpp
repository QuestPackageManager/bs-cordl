...
public:
  ...
  /// @brief Method <StartLevelOrShow360Prompt>b__0, addr 0x3b536d0, size 0x94, virtual false, abstract: false, final false
  inline void _StartLevelOrShow360Prompt_b__0(int32_t _);

  /// @brief Method <StartLevelOrShow360Prompt>b__1, addr 0x3b53764, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b534c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ActionButtonWasPressed, addr 0x3b53044, size 0xc, virtual true, abstract: false, final false
  inline void ActionButtonWasPressed();

  /// @brief Method BackButtonWasPressed, addr 0x3b53588, size 0x94, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DismissPracticeViewController, addr 0x3b5361c, size 0xb4, virtual false, abstract: false, final false
  inline void DismissPracticeViewController(::System::Action* finishedCallback, bool immediately);

  /// @brief Method HandleBasicLevelCompletionResults, addr 0x3b52358, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandlePracticeViewControllerDidPressPlayButton, addr 0x3b534cc, size 0xc, virtual false, abstract: false, final false
  inline void HandlePracticeViewControllerDidPressPlayButton();

  /// @brief Method HandleStandardLevelDidFinish, addr 0x3b534d8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x3b52c38, size 0xb8, virtual true, abstract: false, final true
  inline void LevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x3b52cf0, size 0xb0, virtual true, abstract: false, final true
  inline void LevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x3b52da0, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method PracticeButtonWasPressed, addr 0x3b53384, size 0x8c, virtual true, abstract: false, final false
  inline void PracticeButtonWasPressed();

  /// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish, addr 0x3b52acc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectionDidChange, addr 0x3b53410, size 0xb4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack* pack, ::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method SetupGameplaySetupViewController, addr 0x3b51f20, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate, addr 0x3b52ac4, size 0x4, virtual true, abstract: false, final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate, addr 0x3b52ac8, size 0x4, virtual true, abstract: false, final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method StartLevel, addr 0x3b5260c, size 0x270, virtual false, abstract: false, final false
  inline void StartLevel(::System::Action* beforeSceneSwitchCallback, bool practice);

  /// @brief Method StartLevelOrShow360Prompt, addr 0x3b53050, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b52884, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b52ad0, size 0xb4, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator>>* value);

  /// @brief Method get_enableCustomLevels, addr 0x3b52a44, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method get_gameplayModifiers, addr 0x3b52a60, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_hideGameplaySetup, addr 0x3b52a7c, size 0x8, virtual true, abstract: false, final false
  inline bool get_hideGameplaySetup();

  /// @brief Method get_initialLeftScreenViewController, addr 0x3b52a94, size 0x30, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController();

  /// @brief Method get_initialTopScreenViewController, addr 0x3b52a8c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController();

  /// @brief Method get_isInPracticeView, addr 0x3b529b4, size 0x74, virtual false, abstract: false, final false
  inline bool get_isInPracticeView();

  /// @brief Method get_leaderboardViewController, addr 0x3b52a84, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::LeaderboardViewController> get_leaderboardViewController();

  /// @brief Method get_playerSettings, addr 0x3b52a28, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSettings();

  /// @brief Method remove_didFinishEvent, addr 0x3b52b84, size 0xb4, virtual false, abstract: false, final false
