...
/// @brief Method <StartLevelOrShow360Prompt>b__0, addr 0x58133e8, size 0xd0, virtual false, abstract: false, final false
inline void _StartLevelOrShow360Prompt_b__0(int32_t  _) ;

/// @brief Method <StartLevelOrShow360Prompt>b__1, addr 0x58134b8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5813240, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ActionButtonWasPressed, addr 0x5812d9c, size 0xc, virtual true, abstract: false, final false
inline void ActionButtonWasPressed() ;

/// @brief Method BackButtonWasPressed, addr 0x58132c8, size 0x68, virtual true, abstract: false, final false
inline void BackButtonWasPressed(::HMUI::ViewController*  topViewController) ;

/// @brief Method DismissPracticeViewController, addr 0x5813330, size 0xb8, virtual false, abstract: false, final false
inline void DismissPracticeViewController(::System::Action*  finishedCallback, bool  immediately) ;

/// @brief Method HandleBasicLevelCompletionResults, addr 0x5812008, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method HandlePracticeViewControllerDidPressPlayButton, addr 0x5813244, size 0xc, virtual false, abstract: false, final false
inline void HandlePracticeViewControllerDidPressPlayButton() ;

/// @brief Method HandleStandardLevelDidFinish, addr 0x5813250, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method HandleStandardLevelWasRestarted, addr 0x58132c4, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x5812990, size 0xc0, virtual true, abstract: false, final true
inline void LevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x5812a50, size 0xb8, virtual true, abstract: false, final true
inline void LevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x5812b08, size 0x294, virtual true, abstract: false, final false
...
/// @brief Method PracticeButtonWasPressed, addr 0x5813128, size 0x74, virtual true, abstract: false, final false
inline void PracticeButtonWasPressed() ;

/// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish, addr 0x581280c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method SelectionDidChange, addr 0x581319c, size 0xa4, virtual true, abstract: false, final false
inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack*  pack, ::ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method SetupGameplaySetupViewController, addr 0x5811bc4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate, addr 0x5812804, size 0x4, virtual true, abstract: false, final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate, addr 0x5812808, size 0x4, virtual true, abstract: false, final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method StartLevel, addr 0x581231c, size 0x288, virtual false, abstract: false, final false
inline void StartLevel(::System::Action*  beforeSceneSwitchCallback, bool  practice) ;

/// @brief Method StartLevelOrShow360Prompt, addr 0x5812da8, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58125ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x5812810, size 0xc0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator>>*  value) ;

/// @brief Method get_enableCustomLevels, addr 0x5812780, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method get_gameplayModifiers, addr 0x5812798, size 0x24, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers() ;

/// @brief Method get_hideGameplaySetup, addr 0x58127bc, size 0x8, virtual true, abstract: false, final false
inline bool get_hideGameplaySetup() ;

/// @brief Method get_initialLeftScreenViewController, addr 0x58127d4, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController() ;

/// @brief Method get_initialTopScreenViewController, addr 0x58127cc, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController() ;

/// @brief Method get_isInPracticeView, addr 0x58126e8, size 0x78, virtual false, abstract: false, final false
inline bool get_isInPracticeView() ;

/// @brief Method get_leaderboardViewController, addr 0x58127c4, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::GlobalNamespace::LeaderboardViewController> get_leaderboardViewController() ;

/// @brief Method get_playerSettings, addr 0x5812760, size 0x20, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSettings() ;

/// @brief Method remove_didFinishEvent, addr 0x58128d0, size 0xc0, virtual false, abstract: false, final false
