...
public:
  ...
  /// @brief Method .ctor, addr 0x23f7fdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <StartLevelOrShow360Prompt>b__0, addr 0x23f81f0, size 0x98, virtual false, abstract: false, final false
  inline void _StartLevelOrShow360Prompt_b__0(int32_t _);

  /// @brief Method <StartLevelOrShow360Prompt>b__1, addr 0x23f8288, size 0x50, virtual false, abstract: false, final false
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(4805))]
...
public:
  ...
  /// @brief Method get_isInPracticeView, addr 0x23f74b4, size 0x74, virtual false, abstract: false, final false
  inline bool get_isInPracticeView();

  /// @brief Method get_playerSettings, addr 0x23f7528, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSettings();

  /// @brief Method get_enableCustomLevels, addr 0x23f7544, size 0x1c, virtual true, abstract: false, final false
  inline bool get_enableCustomLevels();

  /// @brief Method get_gameplayModifiers, addr 0x23f7560, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_hideGameplaySetup, addr 0x23f757c, size 0x8, virtual true, abstract: false, final false
  inline bool get_hideGameplaySetup();

  /// @brief Method get_leaderboardViewController, addr 0x23f7584, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::LeaderboardViewController> get_leaderboardViewController();

  /// @brief Method get_initialTopScreenViewController, addr 0x23f758c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController();

  /// @brief Method get_initialLeftScreenViewController, addr 0x23f7594, size 0x30, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController();

  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate, addr 0x23f75c4, size 0x4, virtual true, abstract: false, final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate, addr 0x23f75c8, size 0x4, virtual true, abstract: false, final false
  inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish, addr 0x23f75cc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method add_didFinishEvent, addr 0x23f75d0, size 0xb4, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x23f7684, size 0xb4, virtual false, abstract: false, final false
  inline void remove_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator>>* value);

  /// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x23f7738, size 0xbc, virtual true, abstract: false, final true
  inline void LevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x23f77f4, size 0xb4, virtual true, abstract: false, final true
  inline void LevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x23f78a8, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method ActionButtonWasPressed, addr 0x23f7b4c, size 0xc, virtual true, abstract: false, final false
  inline void ActionButtonWasPressed();

  /// @brief Method PracticeButtonWasPressed, addr 0x23f7e9c, size 0x8c, virtual true, abstract: false, final false
  inline void PracticeButtonWasPressed();

  /// @brief Method SelectionDidChange, addr 0x23f7f28, size 0xb4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack* pack, ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method StartLevelOrShow360Prompt, addr 0x23f7b58, size 0x344, virtual false, abstract: false, final false
  inline void StartLevelOrShow360Prompt(::System::Action* beforeSceneSwitchCallback, bool practice);

  /// @brief Method StartLevel, addr 0x23e8e64, size 0x250, virtual false, abstract: false, final false
  inline void StartLevel(::System::Action* beforeSceneSwitchCallback, bool practice);

  /// @brief Method HandlePracticeViewControllerDidPressPlayButton, addr 0x23f7fe4, size 0xc, virtual false, abstract: false, final false
  inline void HandlePracticeViewControllerDidPressPlayButton();

  /// @brief Method HandleStandardLevelDidFinish, addr 0x23f7ff0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method BackButtonWasPressed, addr 0x23f80a8, size 0x94, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method SetupGameplaySetupViewController, addr 0x23f5c0c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleBasicLevelCompletionResults, addr 0x23f6048, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method DismissPracticeViewController, addr 0x23f813c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f6300, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
