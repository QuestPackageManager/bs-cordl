...
public:
  ...
  /// @brief Method GetCopy, addr 0x223f4c8, size 0x84, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x223f54c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x223f47c, size 0x4c, virtual false, abstract: false, final false
