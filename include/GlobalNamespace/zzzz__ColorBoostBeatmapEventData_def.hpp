...
public:
  ...
  /// @brief Method GetCopy, addr 0xe6df64, size 0x8c, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0xe6dff0, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6df18, size 0x4c, virtual false, abstract: false, final false
