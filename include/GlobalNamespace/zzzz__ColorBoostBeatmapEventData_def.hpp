...
public:
  ...
  /// @brief Method GetCopy, addr 0x31c56b8, size 0x78, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x31c5730, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c5698, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nextSameTypeEventData, addr 0x31c561c, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorBoostBeatmapEventData* get_nextSameTypeEventData();

  /// @brief Method get_previousSameTypeEventData, addr 0x31c55a0, size 0x7c, virtual false, abstract: false, final false
