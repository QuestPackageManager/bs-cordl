...
/// @brief Method .ctor, addr 0x56bf8a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_icon, addr 0x56bf858, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Image> get_icon() ;

/// @brief Method get_text, addr 0x56bf880, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method set_icon, addr 0x56bf850, size 0x8, virtual false, abstract: false, final false
inline void set_icon(::UnityEngine::UI::Image*  value) ;

/// @brief Method set_text, addr 0x56bf860, size 0x20, virtual false, abstract: false, final false
