...
public:
  ...
  /// @brief Method Start, addr 0x5dcfbc0, size 0xe0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdatePointerRay, addr 0x5dcfca0, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dcffb0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
