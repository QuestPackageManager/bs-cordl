...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRRayHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRRayHelper(OVRRayHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRRayHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OVRRayHelper(OVRRayHelperconst&) = delete;
