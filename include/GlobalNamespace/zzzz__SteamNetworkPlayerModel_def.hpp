...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4599))}
...
public:
  ...
  /// @brief Method .ctor addr 0x222627c size 0x8 virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::SteamNetworkPlayerModel, 0x90>, "Size mismatch!");
