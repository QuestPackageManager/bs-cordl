...
public:
  ...
  /// @brief Method DidActivate, addr 0x265aa60, size 0x120, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::RecordingToolSettingsViewController* New_ctor();

  /// @brief Method <DidActivate>b__6_0, addr 0x265ab88, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265ab80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x265a928, size 0x9c, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action* value);

  /// @brief Method remove_didFinishEvent, addr 0x265a9c4, size 0x9c, virtual false, abstract: false, final false
