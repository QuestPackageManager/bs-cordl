...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ColorSchemeColorToggleController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ColorSchemeColorToggleController(ColorSchemeColorToggleController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ColorSchemeColorToggleController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ColorSchemeColorToggleController(ColorSchemeColorToggleControllerconst&) = delete;
