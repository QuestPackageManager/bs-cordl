...
public:
  ...
  /// @brief Method .ctor, addr 0x57faa68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x57fa1a4, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_toggle, addr 0x57faa60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Toggle> get_toggle();

  /// @brief Method set_color, addr 0x57fa1f0, size 0x8c, virtual false, abstract: false, final false
