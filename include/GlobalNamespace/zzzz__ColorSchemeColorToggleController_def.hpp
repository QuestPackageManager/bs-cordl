...
public:
  ...
  /// @brief Method get_toggle, addr 0x23d0af4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Toggle> get_toggle();

  /// @brief Method get_color, addr 0x23d0368, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method set_color, addr 0x23d03b8, size 0x98, virtual false, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  static inline ::GlobalNamespace::ColorSchemeColorToggleController* New_ctor();

  /// @brief Method .ctor, addr 0x23d0afc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
