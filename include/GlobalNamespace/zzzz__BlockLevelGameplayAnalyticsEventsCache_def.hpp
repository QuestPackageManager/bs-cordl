...
public:
  // Declarations
  /// @brief Method WriteFieldsToJson, addr 0x58ba04c, size 0xa0, virtual false, abstract: false, final false
  inline void WriteFieldsToJson(::Newtonsoft::Json::JsonWriter* jsonWriter);

  /// @brief Method .ctor, addr 0x58b8e1c, size 0x18, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method WriteFieldsToJson, addr 0x58b9fac, size 0xa0, virtual false, abstract: false, final false
  inline void WriteFieldsToJson(::Newtonsoft::Json::JsonWriter* jsonWriter);

  /// @brief Method .ctor, addr 0x58b8fe4, size 0x1c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method WriteFieldsToJson, addr 0x58b9e3c, size 0x20, virtual false, abstract: false, final false
  inline void WriteFieldsToJson(::Newtonsoft::Json::JsonWriter* jsonWriter);

  /// @brief Method .ctor, addr 0x58b9188, size 0x18, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method WriteFieldsToJson, addr 0x58b9e5c, size 0x84, virtual false, abstract: false, final false
  inline void WriteFieldsToJson(::Newtonsoft::Json::JsonWriter* jsonWriter);

  /// @brief Method .ctor, addr 0x58ba318, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method WriteFieldsToJson, addr 0x58b9ee0, size 0xcc, virtual false, abstract: false, final false
  inline void WriteFieldsToJson(::Newtonsoft::Json::JsonWriter* jsonWriter);

  /// @brief Method .ctor, addr 0x58b9310, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddBadCut, addr 0x58b8e34, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method AddBlockMiss, addr 0x58b9000, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method AddBombCut, addr 0x58b91a0, size 0xb4, virtual true, abstract: false, final true
  inline void AddBombCut(float_t beat);

  /// @brief Method AddGoodCut, addr 0x58b8c98, size 0x184, virtual true, abstract: false, final true
  ...
  /// @brief Method AddObstacleHit, addr 0x58b9254, size 0xbc, virtual true, abstract: false, final true
  inline void AddObstacleHit(float_t beat, float_t duration);

  /// @brief Method IsEmpty, addr 0x58b9d40, size 0xfc, virtual true, abstract: false, final true
  inline bool IsEmpty();
  ...
  /// @brief Method SerializeJSON, addr 0x58b9318, size 0x224, virtual true, abstract: false, final true
  inline ::StringW SerializeJSON();

  /// @brief Method WriteBadHitBlocksArray, addr 0x58b96d0, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteBombsHitArray, addr 0x58b9a18, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteCommonBlockFieldsToJson, addr 0x58ba0ec, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteGoodCutsArray, addr 0x58b953c, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteMissedBlocksArray, addr 0x58b9870, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteObstaclesHitArray, addr 0x58b9bac, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58b8ac8, size 0x1d0, virtual false, abstract: false, final false
