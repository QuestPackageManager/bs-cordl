...
/// @brief Method .ctor, addr 0x579a468, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _didFinishEvent, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__didFinishEvent, put=__cordl_internal_set__didFinishEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteDebrisDidFinishEvent*>*  _didFinishEvent;
...
/// @brief Method Awake, addr 0x57999f4, size 0x9c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x5799cf4, size 0x5b8, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::ColorType  colorType, ::UnityEngine::Vector3  notePos, ::UnityEngine::Quaternion  noteRot, ::UnityEngine::Vector3  noteMoveVec, ::UnityEngine::Vector3  noteScale, ::UnityEngine::Vector3  positionOffset, ::UnityEngine::Quaternion  rotationOffset, ::UnityEngine::Vector3  cutPoint, ::UnityEngine::Vector3  cutNormal, ::UnityEngine::Vector3  force, ::UnityEngine::Vector3  torque, float_t  lifeTime, ::UnityEngine::Vector3  cutoutOffset, bool  forceOnlySimplePhysics) ;

static inline ::GlobalNamespace::NoteDebris* New_ctor() ;

/// @brief Method Update, addr 0x5799a90, size 0x264, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x579a2ac, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_didFinishEvent, addr 0x57999ec, size 0x8, virtual false, abstract: false, final false
