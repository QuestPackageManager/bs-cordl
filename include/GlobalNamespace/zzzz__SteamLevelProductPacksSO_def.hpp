...
/// @brief Method ILevelPackProductDataContainer<SteamLevelProductCollectionModel.LevelPackProductData,SteamLevelProductCollectionModel.LevelProductData>.SetLevelPackProductData, addr 0x364813c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3648144, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_levelPackProductData, addr 0x364812c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::SteamLevelProductCollectionModel_LevelPackProductData* get_levelPackProductData() ;

/// @brief Method get_levelPackRedirectionData, addr 0x3648134, size 0x8, virtual false, abstract: false, final false
