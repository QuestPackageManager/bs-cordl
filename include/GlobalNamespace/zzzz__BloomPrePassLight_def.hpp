...
static inline ::GlobalNamespace::BloomPrePassLight_LightsDataItem* New_ctor(::GlobalNamespace::BloomPrePassLightTypeSO*  lightType, ::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::BloomPrePassLight>>*  lights) ;
...
/// @brief Method .ctor, addr 0x56b0a64, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _bloomLightsDict, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__bloomLightsDict, put=setStaticF__bloomLightsDict)) ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::BloomPrePassLight>>*>*  _bloomLightsDict;
...
/// @brief Field _lightsDataItems, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__lightsDataItems, put=setStaticF__lightsDataItems)) ::System::Collections::Generic::List_1<::GlobalNamespace::BloomPrePassLight_LightsDataItem*>*  _lightsDataItems;

/// @brief Field _registeredWithLightType, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__registeredWithLightType, put=__cordl_internal_set__registeredWithLightType)) ::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>  _registeredWithLightType;
...
/// @brief Method OnDestroy, addr 0x56b0a58, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x56b0970, size 0x4, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x56b0680, size 0x4, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Refresh, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void Refresh() ;

/// @brief Method RegisterLight, addr 0x56b0684, size 0x2ec, virtual false, abstract: false, final false
inline void RegisterLight() ;

/// @brief Method UnregisterLight, addr 0x56b0974, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b0a6c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::BloomPrePassLight>>*>* getStaticF__bloomLightsDict() ;
...
/// @brief Method get_bloomLightsDict, addr 0x56b05c8, size 0x5c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::BloomPrePassLight>>*>* get_bloomLightsDict() ;

/// @brief Method get_lightsDataItems, addr 0x56b0624, size 0x5c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::GlobalNamespace::BloomPrePassLight_LightsDataItem*>* get_lightsDataItems() ;

static inline void setStaticF__bloomLightsDict(::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::BloomPrePassLight>>*>*  value) ;
