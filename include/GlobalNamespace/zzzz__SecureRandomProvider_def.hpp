...
public:
  ...
  /// @brief Method GetBytes, addr 0xe81600, size 0xb8, virtual false, abstract: false, final false
  inline void GetBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t length);

  /// @brief Method GetByte, addr 0xe81718, size 0xa8, virtual false, abstract: false, final false
  inline uint8_t GetByte();

  /// @brief Method FillBuffer, addr 0xe819cc, size 0x114, virtual false, abstract: false, final false
  inline void FillBuffer();

  static inline ::GlobalNamespace::__SecureRandomProvider__SecureRandomState* New_ctor();

  /// @brief Method .ctor, addr 0xe81928, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetBytes, addr 0xe81558, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytes(int32_t length);

  /// @brief Method GetByte, addr 0xe816b8, size 0x60, virtual false, abstract: false, final false
  static inline uint8_t GetByte();

  /// @brief Method GetBytes, addr 0xe817c0, size 0x80, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t length);

  /// @brief Method GetBytes, addr 0xe81840, size 0x74, virtual false, abstract: false, final false
