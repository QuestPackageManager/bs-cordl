...
public:
  ...
  /// @brief Method FillBuffer, addr 0x3340c34, size 0x104, virtual false, abstract: false, final false
  inline void FillBuffer();

  /// @brief Method GetByte, addr 0x3340a34, size 0x94, virtual false, abstract: false, final false
  inline uint8_t GetByte();

  /// @brief Method GetBytes, addr 0x3340920, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3340bb4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetByte, addr 0x33409d0, size 0x64, virtual false, abstract: false, final false
  static inline uint8_t GetByte();

  /// @brief Method GetBytes, addr 0x3340878, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> GetBytes(int32_t length);

  /// @brief Method GetBytes, addr 0x3340ac8, size 0x78, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t> buffer);

  /// @brief Method GetBytes, addr 0x3330d1c, size 0x84, virtual false, abstract: false, final false
