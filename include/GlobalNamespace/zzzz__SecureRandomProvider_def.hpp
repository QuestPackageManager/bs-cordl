...
public:
  ...
  /// @brief Method FillBuffer, addr 0x22e6e28, size 0x114, virtual false, abstract: false, final false
  inline void FillBuffer();

  /// @brief Method GetByte, addr 0x22e6b7c, size 0xa8, virtual false, abstract: false, final false
  inline uint8_t GetByte();

  /// @brief Method GetBytes, addr 0x22e6a64, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22e6d84, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetByte, addr 0x22e6b1c, size 0x60, virtual false, abstract: false, final false
  static inline uint8_t GetByte();

  /// @brief Method GetBytes, addr 0x22e69bc, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytes(int32_t length);

  /// @brief Method GetBytes, addr 0x22e6ca4, size 0x74, virtual false, abstract: false, final false
  static inline void GetBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method GetBytes, addr 0x22e6c24, size 0x80, virtual false, abstract: false, final false
