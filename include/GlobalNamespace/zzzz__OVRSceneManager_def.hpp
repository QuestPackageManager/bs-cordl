...
public:
  ...
  /// @brief Method get_List, addr 0x4008064, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x400739c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method Log, addr 0x40057c8, size 0xbc, virtual false, abstract: false, final false
  inline void Log(::StringW context, ::StringW message, ::UnityEngine::GameObject* gameObject);

  /// @brief Method LogError, addr 0x4004adc, size 0xbc, virtual false, abstract: false, final false
  inline void LogError(::StringW context, ::StringW message, ::UnityEngine::GameObject* gameObject);

  /// @brief Method LogWarning, addr 0x40079dc, size 0xbc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Log, addr 0x4008394, size 0xbc, virtual false, abstract: false, final false
  static inline void Log(::StringW context, ::StringW message, ::UnityEngine::GameObject* gameObject);

  /// @brief Method LogError, addr 0x400850c, size 0xbc, virtual false, abstract: false, final false
  static inline void LogError(::StringW context, ::StringW message, ::UnityEngine::GameObject* gameObject);

  /// @brief Method LogWarning, addr 0x4008450, size 0xbc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <DoesRoomSetupExist>b__0, addr 0x40085c8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x400606c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CheckClassificationsInRooms>b__0, addr 0x40085e0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4006644, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x40085f4, size 0x648, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x4008c3c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x4008c48, size 0x61c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x4009264, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Awake, addr 0x4004970, size 0x16c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CheckClassificationsInRooms, addr 0x40061a0, size 0x4a4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckIfAnchorsContainClassifications, addr 0x400664c, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckIfClassificationsAreValid, addr 0x40059f8, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method CollectLabelsFromAnchors, addr 0x4006b20, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyExistingAnchors, addr 0x4004e00, size 0x1e0, virtual false, abstract: false, final false
  inline void DestroyExistingAnchors();

  /// @brief Method DoesRoomSetupExist, addr 0x4005e00, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRoomLayoutInformation, addr 0x4005684, size 0x144, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSceneManager_RoomLayoutInformation* GetRoomLayoutInformation();

  /// @brief Method GetUuidsToQuery, addr 0x4006074, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateSceneAnchor, addr 0x4007a98, size 0x540, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateSceneRooms, addr 0x4005088, size 0x424, virtual false, abstract: false, final false
  inline void InstantiateSceneRooms(::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>* roomLayoutAnchors);

  /// @brief Method LoadSceneModel, addr 0x4004cc8, size 0x138, virtual false, abstract: false, final false
  inline bool LoadSceneModel();

  static inline ::GlobalNamespace::OVRSceneManager* New_ctor();

  /// @brief Method OVRManager_SceneCaptureComplete, addr 0x40078c4, size 0x118, virtual false, abstract: false, final false
  inline void OVRManager_SceneCaptureComplete(uint64_t requestId, bool result);

  /// @brief Method OnAnchorsFetchCompleted, addr 0x4004fe0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnApplicationPause, addr 0x4004b98, size 0xa8, virtual false, abstract: false, final false
  inline void OnApplicationPause(bool isPaused);

  /// @brief Method OnDisable, addr 0x400769c, size 0x228, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x4007418, size 0x284, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnSceneRoomLoadCompleted, addr 0x40055bc, size 0xc8, virtual false, abstract: false, final false
  inline void OnSceneRoomLoadCompleted();

  /// @brief Method OnTrackingSpaceChanged, addr 0x4006ca0, size 0x4, virtual false, abstract: false, final false
  static inline void OnTrackingSpaceChanged(::UnityEngine::Transform* trackingSpace);

  /// @brief Method QueryForExistingAnchorsTransform, addr 0x4004c40, size 0x88, virtual false, abstract: false, final false
  inline void QueryForExistingAnchorsTransform();

  /// @brief Method RequestSceneCapture, addr 0x4005884, size 0x48, virtual false, abstract: false, final false
  inline bool RequestSceneCapture();

  /// @brief Method RequestSceneCapture, addr 0x40058cc, size 0x98, virtual false, abstract: false, final false
  inline bool RequestSceneCapture(::StringW requestString);

  /// @brief Method RequestSceneCapture, addr 0x4005964, size 0x94, virtual false, abstract: false, final false
  inline bool RequestSceneCapture(::System::Collections::Generic::IEnumerable_1<::StringW>* requestedAnchorClassifications);

  /// @brief Method Update, addr 0x4006ee4, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateAllSceneAnchors, addr 0x4006ca4, size 0x240, virtual false, abstract: false, final false
  static inline void UpdateAllSceneAnchors();

  /// @brief Method UpdateSomeSceneAnchors, addr 0x4006ee8, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4007fd8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InitialAnchorParent, addr 0x40048f8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_InitialAnchorParent();

  /// @brief Method get_Verbose, addr 0x4004908, size 0x68, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::GlobalNamespace::OVRSceneManager_LogForwarder> get_Verbose();

  /// @brief Method set_InitialAnchorParent, addr 0x4004900, size 0x8, virtual false, abstract: false, final false
