...
public:
  ...
  /// @brief Method CompareTo, addr 0x13a51cc, size 0x124, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* obj);

  /// @brief Method CreateFromSerializedData, addr 0x13a54dc, size 0x340, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::LevelCompletionResults* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method LiteNetLib.Utils.INetImmutableSerializable<LevelCompletionResults>.CreateFromSerializedData, addr 0x13a54d4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x13a52f0, size 0x1d4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x13a5098, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13a50a0, size 0x12c, virtual false, abstract: false, final false
