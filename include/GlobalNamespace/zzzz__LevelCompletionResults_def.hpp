...
public:
  ...
  /// @brief Method CompareTo, addr 0x36b9a30, size 0x118, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* obj);

  /// @brief Method CreateFromSerializedData, addr 0x36b9f8c, size 0x390, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::LevelCompletionResults* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method LiteNetLib.Utils.INetImmutableSerializable<LevelCompletionResults>.CreateFromSerializedData, addr 0x36b9f84, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x36b9b48, size 0x41c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36b99b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36b99b8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cumulativeScore, addr 0x36b99ac, size 0x8, virtual false, abstract: false, final false
