...
template <typename T> constexpr bool const& GlobalNamespace::OptionalArgument_1<T>::__cordl_internal_get__hasValue() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____hasValue;
}
template <typename T> constexpr void GlobalNamespace::OptionalArgument_1<T>::__cordl_internal_set__hasValue(bool value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
