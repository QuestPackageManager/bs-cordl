...
constexpr T& GlobalNamespace::OptionalArgument_1<T>::__cordl_internal_get__defaultValue() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____defaultValue;
}
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
constexpr T const& GlobalNamespace::OptionalArgument_1<T>::__cordl_internal_get__defaultValue() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____defaultValue;
}
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
constexpr void GlobalNamespace::OptionalArgument_1<T>::__cordl_internal_set__defaultValue(T value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____defaultValue = value;
}
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline bool GlobalNamespace::OptionalArgument_1<T>::get_isOptional() {
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline void GlobalNamespace::OptionalArgument_1<T>::_ctor(::StringW name, ::StringW description, T defaultValue, ::ArrayW<::StringW> autocompleteValues) {
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline T GlobalNamespace::OptionalArgument_1<T>::GetValueOrDefault() {
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
constexpr ::GlobalNamespace::OptionalArgument_1<T>::OptionalArgument_1() {}
