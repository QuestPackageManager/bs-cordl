...
// Write type traits
MARK_REF_T(::GlobalNamespace::TriggerFloatFxGroupEffectManager*);
MARK_REF_T(::GlobalNamespace::TriggerFloatFxGroupEffectManager___c*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TriggerFloatFxGroupEffectManager*, "", "TriggerFloatFxGroupEffectManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TriggerFloatFxGroupEffectManager___c*, "", "TriggerFloatFxGroupEffectManager/<>c");
// [CompilerGenerated]
...
public:
  ...
  /// @brief Method <Start>b__3_0, addr 0x59987b4, size 0x14, virtual false, abstract: false, final false
  inline bool _Start_b__3_0(::GlobalNamespace::FloatFxGroup* group);

  /// @brief Method .ctor, addr 0x59987b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TriggerFloatFxGroupEffectManager___c", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TriggerFloatFxGroupEffectManager___c(TriggerFloatFxGroupEffectManager___c&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TriggerFloatFxGroupEffectManager___c", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TriggerFloatFxGroupEffectManager___c(TriggerFloatFxGroupEffectManager___cconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::TriggerFloatFxGroupEffectManager___c) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies FloatFxGroup, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__floatFxGroups, put = __cordl_internal_set__floatFxGroups)) ::ArrayW<::UnityW<::GlobalNamespace::FloatFxGroup>> _floatFxGroups;

  static inline ::GlobalNamespace::TriggerFloatFxGroupEffectManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x59985b4, size 0x114, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59980cc, size 0x4e8, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::FloatFxGroup>> const& __cordl_internal_get__floatFxGroups() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::FloatFxGroup>>& __cordl_internal_get__floatFxGroups();
  ...
  /// @brief Method .ctor, addr 0x59986e4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TriggerFloatFxGroupEffectManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TriggerFloatFxGroupEffectManager(TriggerFloatFxGroupEffectManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TriggerFloatFxGroupEffectManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TriggerFloatFxGroupEffectManager(TriggerFloatFxGroupEffectManagerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::TriggerFloatFxGroupEffectManager) == 0x38, "Size mismatch!");
