...
public:
  ...
  /// @brief Method <Start>b__3_0, addr 0x3b9cb08, size 0x18, virtual false, abstract: false, final false
  inline bool _Start_b__3_0(::GlobalNamespace::FloatFxGroup* group);

  /// @brief Method .ctor, addr 0x3b9cb00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnDestroy, addr 0x3b9c8b4, size 0x158, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3b9c3c8, size 0x4ec, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b9ca28, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
