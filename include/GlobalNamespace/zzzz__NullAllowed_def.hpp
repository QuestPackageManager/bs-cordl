...
public:
  ...
  /// @brief Method IsNullAllowedFor, addr 0x32503bc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32503b0, size 0xc, virtual false, abstract: false, final false
