...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(16251)), TypeDefinitionIndex(TypeDefinitionIndex(10170))}
...
public:
  ...
  /// @brief Method .ctor addr 0x21010b8 size 0x28 virtual false final false
  inline void _ctor(::GlobalNamespace::__NullAllowed__Context context);

  /// @brief Method IsNullAllowedFor addr 0x21010e0 size 0x1c virtual false final false
