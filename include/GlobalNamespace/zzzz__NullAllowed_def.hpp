...
public:
  ...
  /// @brief Method IsNullAllowedFor, addr 0x321473c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3214730, size 0xc, virtual false, abstract: false, final false
