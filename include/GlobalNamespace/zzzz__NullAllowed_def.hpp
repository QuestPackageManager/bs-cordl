...
public:
  ...
  /// @brief Method IsNullAllowedFor, addr 0x229c17c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229c154, size 0x28, virtual false, abstract: false, final false
