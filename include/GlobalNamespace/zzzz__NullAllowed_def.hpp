...
public:
  ...
  /// @brief Method IsNullAllowedFor, addr 0x229e804, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229e7dc, size 0x28, virtual false, abstract: false, final false
