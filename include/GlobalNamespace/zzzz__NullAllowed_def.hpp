...
public:
  ...
  /// @brief Method IsNullAllowedFor, addr 0x229a6cc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229a6a4, size 0x28, virtual false, abstract: false, final false
