...
public:
  ...
  /// @brief Method .ctor, addr 0x5783fe4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddHighlight, addr 0x5783cdc, size 0xb4, virtual false, abstract: false, final false
  inline void AddHighlight(float_t noteTime);

  /// @brief Method ColorWasSet, addr 0x5783cd0, size 0xc, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  /// @brief Method Init, addr 0x5783c04, size 0xcc, virtual false, abstract: false, final false
  inline void Init(::UnityEngine::Vector3 position, float_t rotation);

  /// @brief Method ManualUpdate, addr 0x5783d90, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5783f20, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isFinished, addr 0x5783ba4, size 0x58, virtual false, abstract: false, final false
  inline bool get_isFinished();

  /// @brief Method get_rotation, addr 0x5783bfc, size 0x8, virtual false, abstract: false, final false
