...
public:
  ...
  /// @brief Method .ctor, addr 0x3ad8ccc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddHighlight, addr 0x3ad8980, size 0xb0, virtual false, abstract: false, final false
  inline void AddHighlight(float_t noteTime);

  /// @brief Method ColorWasSet, addr 0x3ad8974, size 0xc, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  /// @brief Method Init, addr 0x3ad88a8, size 0xcc, virtual false, abstract: false, final false
  inline void Init(::UnityEngine::Vector3 position, float_t rotation);

  /// @brief Method ManualUpdate, addr 0x3ad8a30, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ad8c0c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isFinished, addr 0x3ad8850, size 0x50, virtual false, abstract: false, final false
  inline bool get_isFinished();

  /// @brief Method get_rotation, addr 0x3ad88a0, size 0x8, virtual false, abstract: false, final false
