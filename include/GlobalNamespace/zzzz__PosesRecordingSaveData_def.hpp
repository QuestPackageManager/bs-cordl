...
/// @brief Method .ctor, addr 0x5757ae4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Field poses, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_poses, put=__cordl_internal_set_poses)) ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*,::Array<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*>*>  poses;
...
static inline ::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe* New_ctor(::ArrayW<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*,::Array<::GlobalNamespace::PosesRecordingSaveData_PoseSaveData*>*>  poses, float_t  time) ;
...
/// @brief Method .ctor, addr 0x5757af8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5757b04, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field externalCameraCalibration, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_externalCameraCalibration, put=__cordl_internal_set_externalCameraCalibration)) ::GlobalNamespace::PosesRecordingSaveData_ExternalCameraCalibrationSaveData*  externalCameraCalibration;

/// @brief Field keyframes, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_keyframes, put=__cordl_internal_set_keyframes)) ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*,::Array<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*>*>  keyframes;
...
static inline ::GlobalNamespace::PosesRecordingSaveData* New_ctor(::ArrayW<::StringW,::Array<::StringW>*>  objectIds, ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*,::Array<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*>*>  keyframes, ::GlobalNamespace::PosesRecordingSaveData_ExternalCameraCalibrationSaveData*  externalCameraCalibration) ;
...
constexpr ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*,::Array<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*>*> const& __cordl_internal_get_keyframes() const;
...
constexpr void __cordl_internal_set_keyframes(::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*,::Array<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*>*>  value) ;

constexpr void __cordl_internal_set_objectIds(::ArrayW<::StringW,::Array<::StringW>*>  value) ;

/// @brief Method .ctor, addr 0x5757ad8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::StringW,::Array<::StringW>*>  objectIds, ::ArrayW<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*,::Array<::GlobalNamespace::PosesRecordingSaveData_TransformsSaveKeyframe*>*>  keyframes, ::GlobalNamespace::PosesRecordingSaveData_ExternalCameraCalibrationSaveData*  externalCameraCalibration) ;
