...
public:
  ...
  /// @brief Method get_levelId, addr 0x12b88d4, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_levelId();

  /// @brief Method get_relativeSfxVolume, addr 0x12b88f0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_relativeSfxVolume();

  static inline ::GlobalNamespace::__RelativeSfxVolumeSO__RelativeSfxVolumePair* New_ctor();

  /// @brief Method .ctor, addr 0x12b88f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_relativeSfxVolumePerPack, addr 0x12b88bc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_relativeSfxVolumePerPack();

  /// @brief Method get_relativeSfxVolumePerLevel, addr 0x12b88c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12b88cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
