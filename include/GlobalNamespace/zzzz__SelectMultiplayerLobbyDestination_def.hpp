...
public:
  ...
  /// @brief Method .ctor, addr 0x26b36c4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW lobbyCode);

  /// @brief Method .ctor, addr 0x26b3698, size 0x2c, virtual false, abstract: false, final false
