...
public:
  ...
  /// @brief Method .ctor, addr 0x3647978, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW lobbyCode);

  /// @brief Method .ctor, addr 0x3647970, size 0x8, virtual false, abstract: false, final false
