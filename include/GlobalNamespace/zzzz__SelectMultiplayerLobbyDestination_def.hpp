...
public:
  ...
  /// @brief Method .ctor, addr 0x26af5d8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW lobbyCode);

  /// @brief Method .ctor, addr 0x26af5ac, size 0x2c, virtual false, abstract: false, final false
