...
public:
  ...
  /// @brief Method .ctor, addr 0x35e04c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW lobbyCode);

  /// @brief Method .ctor, addr 0x35e04bc, size 0x8, virtual false, abstract: false, final false
