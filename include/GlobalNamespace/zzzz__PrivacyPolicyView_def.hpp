...
public:
  ...
  /// @brief Method Activate, addr 0x57a5b7c, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method OnApplicationFocus, addr 0x57b4cfc, size 0x5c, virtual false, abstract: false, final false
  inline void OnApplicationFocus(bool focus);

  /// @brief Method OpenLink, addr 0x57b4c8c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b4d58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
