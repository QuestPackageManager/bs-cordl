...
/// @brief Method <LoadResourcesBeforeInstall>b__5_0, addr 0x362e0dc, size 0x14, virtual false, abstract: false, final false
inline int32_t _LoadResourcesBeforeInstall_b__5_0(::GlobalNamespace::PackDefinitionSO*  asset) ;

/// @brief Method .ctor, addr 0x362e0d8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _packDefinitions, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__packDefinitions, put=__cordl_internal_set__packDefinitions)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*  _packDefinitions;
...
/// @brief Method InstallBindings, addr 0x362df04, size 0x78, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method LoadPackDefinitionListAsync, addr 0x362df7c, size 0x7c, virtual false, abstract: false, final false
static inline ::System::Nullable_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::IList_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*>> LoadPackDefinitionListAsync() ;

/// @brief Method LoadResourcesBeforeInstall, addr 0x362dd7c, size 0x188, virtual true, abstract: false, final false
inline void LoadResourcesBeforeInstall(::System::Collections::Generic::IList_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*  assets, ::BGLib::AppFlow::Initialization::AsyncInstaller_IInstallerRegistry*  registry) ;
...
/// @brief Method .ctor, addr 0x362dff8, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_assetLabelRuntimeKey, addr 0x362dcf4, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_assetLabelRuntimeKey() ;

/// @brief Method get_telemetryEventName, addr 0x362dd38, size 0x44, virtual true, abstract: false, final false
