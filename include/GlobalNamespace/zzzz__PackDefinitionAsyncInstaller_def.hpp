...
public:
  ...
  /// @brief Method <LoadResourcesBeforeInstall>b__3_0, addr 0x12f5070, size 0x18, virtual false, abstract: false, final false
  inline int32_t _LoadResourcesBeforeInstall_b__3_0(::GlobalNamespace::PackDefinitionSO* asset);

  /// @brief Method .ctor, addr 0x12f5068, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x12f4e7c, size 0x74, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadPackDefinitionListAsync, addr 0x12f4ef0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadResourcesBeforeInstall, addr 0x12f4d1c, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12f4f74, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x12f4cdc, size 0x40, virtual true, abstract: false, final false
