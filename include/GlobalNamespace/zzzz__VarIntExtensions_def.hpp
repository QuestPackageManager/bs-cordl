...
public:
  // Declarations
  /// @brief Method PutVarInt addr 0x1230ef4 size 0x10 virtual false final false
  static inline void PutVarInt(::LiteNetLib::Utils::NetDataWriter* writer, int32_t val);

  /// @brief Method GetVarInt addr 0x123124c size 0x1c virtual false final false
  static inline int32_t GetVarInt(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method PutVarUInt addr 0x122de70 size 0x8 virtual false final false
  static inline void PutVarUInt(::LiteNetLib::Utils::NetDataWriter* writer, uint32_t val);

  /// @brief Method GetVarUInt addr 0x122de14 size 0x10 virtual false final false
  static inline uint32_t GetVarUInt(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method PutVarLong addr 0x1237da4 size 0xc virtual false final false
  static inline void PutVarLong(::LiteNetLib::Utils::NetDataWriter* writer, int64_t val);

  /// @brief Method GetVarLong addr 0x1237db0 size 0x18 virtual false final false
  static inline int64_t GetVarLong(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method PutVarULong addr 0x1237dc8 size 0x48 virtual false final false
  static inline void PutVarULong(::LiteNetLib::Utils::NetDataWriter* writer, uint64_t val);

  /// @brief Method GetVarULong addr 0x1237e10 size 0x74 virtual false final false
  static inline uint64_t GetVarULong(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method TryGetVarUInt addr 0x1237e84 size 0x4c virtual false final false
  static inline bool TryGetVarUInt(::LiteNetLib::Utils::NetDataReader* reader, ByRef<uint32_t> value);

  /// @brief Method TryGetVarULong addr 0x1237ed0 size 0x88 virtual false final false
  static inline bool TryGetVarULong(::LiteNetLib::Utils::NetDataReader* reader, ByRef<uint64_t> value);

  /// @brief Method GetSize addr 0x1234d50 size 0x24 virtual false final false
  static inline int32_t GetSize(int32_t val);

  /// @brief Method GetSize addr 0x1237f78 size 0x1c virtual false final false
  static inline int32_t GetSize(uint32_t val);

  /// @brief Method GetSize addr 0x1237f58 size 0x20 virtual false final false
  static inline int32_t GetSize(int64_t val);

  /// @brief Method GetSize addr 0x1237f94 size 0xd56bbc virtual false final false
