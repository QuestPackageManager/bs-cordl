...
public:
  ...
  /// @brief Method MoveNext, addr 0x3650bd4, size 0x6c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3651298, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3651318, size 0xcb0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3651fc8, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method ClearLastUsedBeatmapCache, addr 0x3650bc0, size 0x10, virtual false, abstract: false, final false
  inline void ClearLastUsedBeatmapCache();

  /// @brief Method LoadBasicBeatmapData, addr 0x365047c, size 0xf4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataBasicInfo* LoadBasicBeatmapData(::StringW beatmapJson);

  /// @brief Method LoadBasicBeatmapData, addr 0x36503a0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadBasicBeatmapDataAsync, addr 0x36502a4, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadBeatmapData, addr 0x36506d4, size 0x4ec, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadBeatmapDataAsync, addr 0x3650570, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3650bd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
