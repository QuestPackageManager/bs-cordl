...
public:
  ...
  /// @brief Method .ctor, addr 0x3bef1d0, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MarkCut, addr 0x3beeb80, size 0x50, virtual false, abstract: false, final false
  inline void MarkCut(::ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method MarkMiss, addr 0x3beedd4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3beeed4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(int32_t cuttableObjectsCount, ::GlobalNamespace::SequenceCutInfo_TutorialSongController_NoteType noteType);

  /// @brief Method get_allIsOK, addr 0x3beec50, size 0x3c, virtual false, abstract: false, final false
  inline bool get_allIsOK();

  /// @brief Method get_isFinished, addr 0x3beec38, size 0x18, virtual false, abstract: false, final false
  inline bool get_isFinished();

  /// @brief Method get_missedAny, addr 0x3beedfc, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3bef208, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3bef24c, size 0x50, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3bee150, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::Signal* signal, int32_t firstTimeBeatOffset, int32_t beatOffset, int32_t lineIndex, ::GlobalNamespace::NoteLineLayer noteLineLayer,
...
public:
  ...
  /// @brief Method .ctor, addr 0x3bef2a4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_headLineIndex, addr 0x3bef29c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3bef338, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3bee1b4, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::Signal* signal, int32_t firstTimeBeatOffset, int32_t beatOffset, int32_t lineIndex, ::GlobalNamespace::NoteLineLayer noteLineLayer);
...
public:
  ...
  /// @brief Method .ctor, addr 0x3bee204, size 0x64, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x3bedc6c, size 0x4e4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateArcData, addr 0x3bef13c, size 0x74, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderData* CreateArcData(::GlobalNamespace::NoteData* headData, ::GlobalNamespace::NoteData* tailData);

  /// @brief Method CreateBasicNoteData, addr 0x3beeea4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBombNoteData, addr 0x3beef10, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateChainData, addr 0x3bef018, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObstacleData, addr 0x3beef38, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextBeatmapObjectBeat, addr 0x3beee0c, size 0x70, virtual false, abstract: false, final false
  inline int32_t GetNextBeatmapObjectBeat(int32_t beatOffset);

  /// @brief Method GetTimeFromBeat, addr 0x3beee7c, size 0x28, virtual false, abstract: false, final false
  inline float_t GetTimeFromBeat(int32_t beatNumber);

  /// @brief Method HandleNoteWasCut, addr 0x3beea4c, size 0x134, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ::ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method HandleNoteWasMissed, addr 0x3beed34, size 0xa0, virtual false, abstract: false, final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleObstacleDidPassThreeQuartersOfMove2, addr 0x3beede4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bee3c8, size 0x148, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PauseSong, addr 0x3beea08, size 0x28, virtual true, abstract: false, final false
  inline void PauseSong();

  /// @brief Method RaiseSignalForIncorrectCutSequence, addr 0x3beec8c, size 0xa8, virtual false, abstract: false, final false
  inline void RaiseSignalForIncorrectCutSequence();

  /// @brief Method RaiseSignalsForIndividualCut, addr 0x3beebd0, size 0x68, virtual false, abstract: false, final false
  inline void RaiseSignalsForIndividualCut(::GlobalNamespace::NoteCutInfo noteCutInfo);

  /// @brief Method ResumeSong, addr 0x3beea30, size 0x1c, virtual true, abstract: false, final false
  inline void ResumeSong();

  /// @brief Method Start, addr 0x3bee268, size 0x160, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartSong, addr 0x3bed154, size 0x80, virtual false, abstract: false, final false
  inline void StartSong(float_t startTimeOffset);

  /// @brief Method StopSong, addr 0x3bee9e0, size 0x28, virtual true, abstract: false, final false
  inline void StopSong();

  /// @brief Method UpdateBeatmapData, addr 0x3bee510, size 0x4d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bef1b0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
