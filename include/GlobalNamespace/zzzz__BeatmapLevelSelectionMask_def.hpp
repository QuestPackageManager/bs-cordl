...
public:
  ...
  /// @brief Method Deserialize, addr 0x32a6bd8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x32a6990, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x32a6a24, size 0x12c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BeatmapLevelSelectionMask other);

  /// @brief Method GetHashCode, addr 0x32a6b50, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x32a6c5c, size 0x74, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::BeatmapLevelSelectionMask l, ::GlobalNamespace::BeatmapLevelSelectionMask r);

  /// @brief Method op_Inequality, addr 0x32a6cd0, size 0x74, virtual false, abstract: false, final false
