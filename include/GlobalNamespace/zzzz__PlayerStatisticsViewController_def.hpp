...
public:
  ...
  /// @brief Method .ctor, addr 0x57a4640, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_playerOverallStatsDataFunc, addr 0x57a4ca4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_1<::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData*>* get_playerOverallStatsDataFunc();

  /// @brief Method get_text, addr 0x57a4c94, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_playerOverallStatsDataFunc, addr 0x57a4cac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_text, addr 0x57a4c9c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DidActivate, addr 0x57a4068, size 0x5d8, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57a4ab4, size 0xb0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleStatsScopeSegmentedControlDidSelectCell, addr 0x57a4b64, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateView, addr 0x57a4648, size 0x46c, virtual false, abstract: false, final false
  inline void UpdateView(::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* playerOverallStatsData);

  /// @brief Method <DidActivate>b__14_0, addr 0x57a4c68, size 0x2c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* _DidActivate_b__14_0();

  /// @brief Method <DidActivate>b__14_1, addr 0x57a4bb8, size 0x2c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* _DidActivate_b__14_1();

  /// @brief Method <DidActivate>b__14_2, addr 0x57a4be4, size 0x2c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* _DidActivate_b__14_2();

  /// @brief Method <DidActivate>b__14_3, addr 0x57a4c10, size 0x2c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* _DidActivate_b__14_3();

  /// @brief Method <DidActivate>b__14_4, addr 0x57a4c3c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a4bb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
