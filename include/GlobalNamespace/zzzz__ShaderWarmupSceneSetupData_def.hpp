...
// Write type traits
MARK_REF_T(::GlobalNamespace::ShaderWarmupSceneSetupData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ShaderWarmupSceneSetupData*, "", "ShaderWarmupSceneSetupData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x590dd18, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ShaderWarmupSceneSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ShaderWarmupSceneSetupData(ShaderWarmupSceneSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ShaderWarmupSceneSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ShaderWarmupSceneSetupData(ShaderWarmupSceneSetupDataconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::ShaderWarmupSceneSetupData) == 0x18, "Size mismatch!");
