...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsFlowCoordinator::*)(bool, bool, bool)>(&::GlobalNamespace::RecordingToolSettingsFlowCoordinator::DidActivate)> {
  constexpr static std::size_t size = 0x128;
  constexpr static std::size_t addrs = 0x5863cac;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsFlowCoordinator::*)(bool, bool)>(&::GlobalNamespace::RecordingToolSettingsFlowCoordinator::DidDeactivate)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x5863dd4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsFlowCoordinator::*)()>(&::GlobalNamespace::RecordingToolSettingsFlowCoordinator::Update)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x5863e84;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsFlowCoordinator::*)()>(&::GlobalNamespace::RecordingToolSettingsFlowCoordinator::HandleRecordingToolSettingsViewControllerDidFinish)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x5863ed8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsFlowCoordinator::*)()>(&::GlobalNamespace::RecordingToolSettingsFlowCoordinator::_ctor)> {
...
constexpr ::UnityW<::GlobalNamespace::RecordingToolSettingsViewController> const& GlobalNamespace::RecordingToolSettingsFlowCoordinator::__cordl_internal_get__recordingToolSettingsViewController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____recordingToolSettingsViewController;
}
constexpr void GlobalNamespace::RecordingToolSettingsFlowCoordinator::__cordl_internal_set__recordingToolSettingsViewController(::UnityW<::GlobalNamespace::RecordingToolSettingsViewController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____recordingToolSettingsViewController)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr ::UnityW<::GlobalNamespace::RecordingToolLoggingViewController> const& GlobalNamespace::RecordingToolSettingsFlowCoordinator::__cordl_internal_get__recordingToolLoggingViewController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____recordingToolLoggingViewController;
}
