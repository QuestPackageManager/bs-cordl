...
/// @brief Method .ctor, addr 0x5b1f52c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method DestroyPartyConnection, addr 0x5b1f514, size 0x18, virtual true, abstract: false, final false
inline void DestroyPartyConnection() ;

static inline ::GlobalNamespace::PlatformNetworkPlayerModel* New_ctor() ;

/// @brief Method .ctor, addr 0x5b1f4fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_friends, addr 0x5b1f504, size 0x10, virtual false, abstract: false, final false
