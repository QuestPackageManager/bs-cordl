...
public:
  ...
  /// @brief Method .ctor, addr 0x26b7894, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_bombsCount, addr 0x26b788c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bombsCount();

  /// @brief Method get_cuttableNotesCount, addr 0x26b7874, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cuttableNotesCount();

  /// @brief Method get_cuttableScoringObjectsCount, addr 0x26b787c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cuttableScoringObjectsCount();

  /// @brief Method get_numberOfLines, addr 0x26b786c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_numberOfLines();

  /// @brief Method get_obstaclesCount, addr 0x26b7884, size 0x8, virtual false, abstract: false, final false
