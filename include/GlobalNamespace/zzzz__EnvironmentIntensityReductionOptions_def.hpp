...
MARK_REF_T(::GlobalNamespace::EnvironmentIntensityReductionOptions*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType, "", "EnvironmentIntensityReductionOptions/CompressExpandReductionType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType, "", "EnvironmentIntensityReductionOptions/RotateRingsReductionType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentIntensityReductionOptions*, "", "EnvironmentIntensityReductionOptions");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x37087f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_compressExpand, addr 0x37087e4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType get_compressExpand();

  /// @brief Method get_rotateRings, addr 0x37087ec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EnvironmentIntensityReductionOptions) == 0x18, "Size mismatch!");
