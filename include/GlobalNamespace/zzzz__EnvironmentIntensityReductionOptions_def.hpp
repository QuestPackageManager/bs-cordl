...
public:
  ...
  /// @brief Method .ctor, addr 0x26b3f2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_compressExpand, addr 0x26b3f1c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType get_compressExpand();

  /// @brief Method get_rotateRings, addr 0x26b3f24, size 0x8, virtual false, abstract: false, final false
