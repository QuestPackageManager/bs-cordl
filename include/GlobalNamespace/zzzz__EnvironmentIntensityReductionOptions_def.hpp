...
/// @brief Field _compressExpand, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__compressExpand, put=__cordl_internal_set__compressExpand)) ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType  _compressExpand;
...
/// @brief Method .ctor, addr 0x360ba88, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_compressExpand, addr 0x360ba78, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType get_compressExpand() ;

/// @brief Method get_rotateRings, addr 0x360ba80, size 0x8, virtual false, abstract: false, final false
