...
public:
  ...
  /// @brief Method .ctor, addr 0x3648188, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_compressExpand, addr 0x3648178, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType get_compressExpand();

  /// @brief Method get_rotateRings, addr 0x3648180, size 0x8, virtual false, abstract: false, final false
