...
public:
  ...
  /// @brief Method .ctor, addr 0x5844924, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x5844524, size 0xc4, virtual false, abstract: false, final false
  inline void Init(::UnityEngine::Color color, float_t animationDuration, ::UnityEngine::Quaternion rotation);

  /// @brief Method ManualUpdate, addr 0x58445e8, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584489c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_didFinishEvent, addr 0x584451c, size 0x8, virtual false, abstract: false, final false
