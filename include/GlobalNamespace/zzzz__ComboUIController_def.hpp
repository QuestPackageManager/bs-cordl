...
public:
  ...
  /// @brief Method Start, addr 0x237d0a0, size 0x88, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnEnable, addr 0x237d3f8, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnDisable, addr 0x237d3fc, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method RegisterForEvents, addr 0x237d128, size 0x2d0, virtual false, abstract: false, final false
  inline void RegisterForEvents();

  /// @brief Method UnregisterFromEvents, addr 0x237d400, size 0x1b8, virtual false, abstract: false, final false
  inline void UnregisterFromEvents();

  /// @brief Method HandleComboDidChange, addr 0x237d5b8, size 0x48, virtual false, abstract: false, final false
  inline void HandleComboDidChange(int32_t combo);

  /// @brief Method HandleComboBreakingEventHappened, addr 0x237d600, size 0x3c, virtual false, abstract: false, final false
  inline void HandleComboBreakingEventHappened();

  static inline ::GlobalNamespace::ComboUIController* New_ctor();

  /// @brief Method .ctor, addr 0x237d63c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
