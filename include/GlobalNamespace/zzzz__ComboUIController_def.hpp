...
public:
  ...
  /// @brief Method Start addr 0x23bf9f0 size 0x88 virtual false final false
  inline void Start();

  /// @brief Method OnEnable addr 0x23bfd48 size 0x4 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x23bfd4c size 0x4 virtual false final false
  inline void OnDisable();

  /// @brief Method RegisterForEvents addr 0x23bfa78 size 0x2d0 virtual false final false
  inline void RegisterForEvents();

  /// @brief Method UnregisterFromEvents addr 0x23bfd50 size 0x1b8 virtual false final false
  inline void UnregisterFromEvents();

  /// @brief Method HandleComboDidChange addr 0x23bff08 size 0x48 virtual false final false
  inline void HandleComboDidChange(int32_t combo);

  /// @brief Method HandleComboBreakingEventHappened addr 0x23bff50 size 0x3c virtual false final false
  inline void HandleComboBreakingEventHappened();

  static inline ::GlobalNamespace::ComboUIController* New_ctor();

  /// @brief Method .ctor addr 0x23bff8c size 0x8 virtual false final false
  inline void _ctor();
