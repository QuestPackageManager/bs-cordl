...
/// @brief Method BackButtonWasPressed, addr 0x5863c1c, size 0x20, virtual true, abstract: false, final false
inline void BackButtonWasPressed(::HMUI::ViewController*  topViewController) ;

/// @brief Method DidActivate, addr 0x586367c, size 0x200, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x586393c, size 0x110, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleDidSelectHelpSubMenu, addr 0x5863b0c, size 0x4, virtual false, abstract: false, final false
inline void HandleDidSelectHelpSubMenu(::HMUI::ViewController*  viewController) ;

/// @brief Method HandleHowToPlayViewControllerDidFinish, addr 0x5863c3c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method ReplaceViewController, addr 0x5863b10, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5863ca4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x58634fc, size 0xc0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::HelpFlowCoordinator>>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x58635bc, size 0xc0, virtual false, abstract: false, final false
