...
public:
  ...
  /// @brief Method BackButtonWasPressed, addr 0x2776100, size 0x20, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DidActivate, addr 0x2775908, size 0x50c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x2775e14, size 0x10c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleDidSelectHelpSubMenu, addr 0x2775f20, size 0x64, virtual false, abstract: false, final false
  inline void HandleDidSelectHelpSubMenu(int32_t idx);

  /// @brief Method HandleHowToPlayViewControllerDidFinish, addr 0x2776088, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceViewController, addr 0x2775f84, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2776120, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x27757a8, size 0xb0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::HelpFlowCoordinator>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x2775858, size 0xb0, virtual false, abstract: false, final false
