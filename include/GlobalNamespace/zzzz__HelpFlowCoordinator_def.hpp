...
public:
  ...
  /// @brief Method BackButtonWasPressed, addr 0x251ebdc, size 0x20, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DidActivate, addr 0x251e3e4, size 0x50c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x251e8f0, size 0x10c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleDidSelectHelpSubMenu, addr 0x251e9fc, size 0x64, virtual false, abstract: false, final false
  inline void HandleDidSelectHelpSubMenu(int32_t idx);

  /// @brief Method HandleHowToPlayViewControllerDidFinish, addr 0x251eb64, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceViewController, addr 0x251ea60, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x251ebfc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x251e284, size 0xb0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::HelpFlowCoordinator>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x251e334, size 0xb0, virtual false, abstract: false, final false
