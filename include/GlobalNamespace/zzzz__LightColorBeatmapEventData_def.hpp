...
public:
  ...
  /// @brief Method CopyColorDataFrom, addr 0x22479c8, size 0x3c, virtual false, abstract: false, final false
  inline void CopyColorDataFrom(::GlobalNamespace::LightColorBeatmapEventData* lightColorBeatmapEventData);

  /// @brief Method DisableStrobe, addr 0x2247a04, size 0x8, virtual false, abstract: false, final false
  inline void DisableStrobe();

  /// @brief Method GetCopy, addr 0x2247a0c, size 0xcc, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x2247ad8, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0x22479bc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22478c8, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_brightness, addr 0x2247884, size 0x8, virtual false, abstract: false, final false
  inline float_t get_brightness();

  /// @brief Method get_colorType, addr 0x2247874, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentColorType get_colorType();

  /// @brief Method get_easeType, addr 0x2247864, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EaseType get_easeType();

  /// @brief Method get_elementId, addr 0x2247840, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_elementId();

  /// @brief Method get_groupId, addr 0x2247830, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_groupId();

  /// @brief Method get_strobeBeatFrequency, addr 0x2247894, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_strobeBeatFrequency();

  /// @brief Method get_strobeBrightness, addr 0x22478a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_strobeBrightness();

  /// @brief Method get_strobeFade, addr 0x22478b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_strobeFade();

  /// @brief Method get_usePreviousValue, addr 0x2247850, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_brightness, addr 0x224788c, size 0x8, virtual false, abstract: false, final false
  inline void set_brightness(float_t value);

  /// @brief Method set_colorType, addr 0x224787c, size 0x8, virtual false, abstract: false, final false
  inline void set_colorType(::GlobalNamespace::EnvironmentColorType value);

  /// @brief Method set_easeType, addr 0x224786c, size 0x8, virtual false, abstract: false, final false
  inline void set_easeType(::GlobalNamespace::EaseType value);

  /// @brief Method set_elementId, addr 0x2247848, size 0x8, virtual false, abstract: false, final false
  inline void set_elementId(int32_t value);

  /// @brief Method set_groupId, addr 0x2247838, size 0x8, virtual false, abstract: false, final false
  inline void set_groupId(int32_t value);

  /// @brief Method set_strobeBeatFrequency, addr 0x224789c, size 0x8, virtual false, abstract: false, final false
  inline void set_strobeBeatFrequency(int32_t value);

  /// @brief Method set_strobeBrightness, addr 0x22478ac, size 0x8, virtual false, abstract: false, final false
  inline void set_strobeBrightness(float_t value);

  /// @brief Method set_strobeFade, addr 0x22478bc, size 0xc, virtual false, abstract: false, final false
  inline void set_strobeFade(bool value);

  /// @brief Method set_usePreviousValue, addr 0x2247858, size 0xc, virtual false, abstract: false, final false
