...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(14727)), TypeDefinitionIndex(TypeDefinitionIndex(14728)), TypeDefinitionIndex(TypeDefinitionIndex(14754))]
...
public:
  ...
  /// @brief Method get_colorType, addr 0xdfe6e0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentColorType get_colorType();

  /// @brief Method set_colorType, addr 0xdfe6e8, size 0x8, virtual false, abstract: false, final false
  inline void set_colorType(::GlobalNamespace::EnvironmentColorType value);

  /// @brief Method get_brightness, addr 0xdfe6f0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_brightness();

  /// @brief Method set_brightness, addr 0xdfe6f8, size 0x8, virtual false, abstract: false, final false
  inline void set_brightness(float_t value);

  /// @brief Method get_strobeBeatFrequency, addr 0xdfe700, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_strobeBeatFrequency();

  /// @brief Method set_strobeBeatFrequency, addr 0xdfe708, size 0x8, virtual false, abstract: false, final false
  inline void set_strobeBeatFrequency(int32_t value);

  /// @brief Method get_strobeBrightness, addr 0xdfe710, size 0x8, virtual false, abstract: false, final false
  inline float_t get_strobeBrightness();

  /// @brief Method set_strobeBrightness, addr 0xdfe718, size 0x8, virtual false, abstract: false, final false
  inline void set_strobeBrightness(float_t value);

  /// @brief Method get_strobeFade, addr 0xdfe720, size 0x8, virtual false, abstract: false, final false
  inline bool get_strobeFade();

  /// @brief Method set_strobeFade, addr 0xdfe728, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xdfe734, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyColorDataFrom, addr 0xdfe820, size 0x24, virtual false, abstract: false, final false
  inline void CopyColorDataFrom(::GlobalNamespace::LightColorBeatmapEventData* lightColorBeatmapEventData);

  /// @brief Method DisableStrobe, addr 0xdfe844, size 0x8, virtual false, abstract: false, final false
  inline void DisableStrobe();

  /// @brief Method GetCopy, addr 0xdfe84c, size 0xc8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method SubtypeIdentifier, addr 0xdfe814, size 0xc, virtual false, abstract: false, final false
  static inline int32_t SubtypeIdentifier(int32_t groupId, int32_t elementId);

  /// @brief Method GetDefault, addr 0xdfe914, size 0x130, virtual true, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::LightColorBeatmapEventData, ____strobeBrightness_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightColorBeatmapEventData, ____strobeFade_k__BackingField) == 0x4c, "Offset mismatch!");
