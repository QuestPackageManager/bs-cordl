...
public:
  ...
  /// @brief Method CopyColorDataFrom, addr 0x31c5f08, size 0x38, virtual false, abstract: false, final false
  inline void CopyColorDataFrom(::GlobalNamespace::LightColorBeatmapEventData* lightColorBeatmapEventData);

  /// @brief Method DisableStrobe, addr 0x31c5f40, size 0x8, virtual false, abstract: false, final false
  inline void DisableStrobe();

  /// @brief Method GetCopy, addr 0x31c5f48, size 0xd0, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x31c6018, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0x31c5ef4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c5e00, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_brightness, addr 0x31c5dc0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_brightness();

  /// @brief Method get_colorType, addr 0x31c5db0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentColorType get_colorType();

  /// @brief Method get_easeType, addr 0x31c5da0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EaseType get_easeType();

  /// @brief Method get_elementId, addr 0x31c5d80, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_elementId();

  /// @brief Method get_groupId, addr 0x31c5d70, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_groupId();

  /// @brief Method get_nextSameTypeEventData, addr 0x31c5cf4, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightColorBeatmapEventData* get_nextSameTypeEventData();

  /// @brief Method get_previousSameTypeEventData, addr 0x31c5c78, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightColorBeatmapEventData* get_previousSameTypeEventData();

  /// @brief Method get_strobeBeatFrequency, addr 0x31c5dd0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_strobeBeatFrequency();

  /// @brief Method get_strobeBrightness, addr 0x31c5de0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_strobeBrightness();

  /// @brief Method get_strobeFade, addr 0x31c5df0, size 0x8, virtual false, abstract: false, final false
  inline bool get_strobeFade();

  /// @brief Method get_usePreviousValue, addr 0x31c5d90, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_brightness, addr 0x31c5dc8, size 0x8, virtual false, abstract: false, final false
  inline void set_brightness(float_t value);

  /// @brief Method set_colorType, addr 0x31c5db8, size 0x8, virtual false, abstract: false, final false
  inline void set_colorType(::GlobalNamespace::EnvironmentColorType value);

  /// @brief Method set_easeType, addr 0x31c5da8, size 0x8, virtual false, abstract: false, final false
  inline void set_easeType(::GlobalNamespace::EaseType value);

  /// @brief Method set_elementId, addr 0x31c5d88, size 0x8, virtual false, abstract: false, final false
  inline void set_elementId(int32_t value);

  /// @brief Method set_groupId, addr 0x31c5d78, size 0x8, virtual false, abstract: false, final false
  inline void set_groupId(int32_t value);

  /// @brief Method set_strobeBeatFrequency, addr 0x31c5dd8, size 0x8, virtual false, abstract: false, final false
  inline void set_strobeBeatFrequency(int32_t value);

  /// @brief Method set_strobeBrightness, addr 0x31c5de8, size 0x8, virtual false, abstract: false, final false
  inline void set_strobeBrightness(float_t value);

  /// @brief Method set_strobeFade, addr 0x31c5df8, size 0x8, virtual false, abstract: false, final false
  inline void set_strobeFade(bool value);

  /// @brief Method set_usePreviousValue, addr 0x31c5d98, size 0x8, virtual false, abstract: false, final false
