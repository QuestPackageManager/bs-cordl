...
public:
  ...
  /// @brief Method FromJson, addr 0x36478fc, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3647948, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
