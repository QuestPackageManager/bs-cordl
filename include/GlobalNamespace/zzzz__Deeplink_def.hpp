...
// Write type traits
MARK_REF_T(::GlobalNamespace::Deeplink*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Deeplink*, "", "Deeplink");
...
public:
  ...
  /// @brief Method FromJson, addr 0x370511c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3705168, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::Deeplink) == 0x48, "Size mismatch!");
