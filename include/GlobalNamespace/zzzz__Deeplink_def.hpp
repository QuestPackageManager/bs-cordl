...
public:
  ...
  /// @brief Method FromJson, addr 0x360b2ac, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x360b2f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
