...
public:
  ...
  /// @brief Method FromJson, addr 0x26af4c0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26af508, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
