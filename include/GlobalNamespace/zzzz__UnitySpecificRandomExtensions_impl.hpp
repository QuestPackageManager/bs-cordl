...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (*)(::GlobalNamespace::IRandom*)>(&::GlobalNamespace::UnitySpecificRandomExtensions::InsideUnitSphere)> {
  constexpr static std::size_t size = 0x94;
  constexpr static std::size_t addrs = 0x322d9d8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::UnitySpecificRandomExtensions*>::get(),
                        "InsideUnitSphere",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (*)(::GlobalNamespace::IRandom*)>(&::GlobalNamespace::UnitySpecificRandomExtensions::OnUnitSphere)> {
  constexpr static std::size_t size = 0x15c;
  constexpr static std::size_t addrs = 0x322da6c;
