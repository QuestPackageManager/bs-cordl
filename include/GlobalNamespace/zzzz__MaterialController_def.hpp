...
public:
  ...
  /// @brief Method OnValidate, addr 0x24f66d4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f6700, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_material, addr 0x24f66cc, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::MaterialController, ____material) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MaterialController, ____renderers) == 0x20, "Offset mismatch!");
