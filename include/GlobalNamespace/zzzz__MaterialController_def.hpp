...
public:
  ...
  /// @brief Method OnValidate, addr 0x23feae4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23feb10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_material, addr 0x23feadc, size 0x8, virtual false, abstract: false, final false
