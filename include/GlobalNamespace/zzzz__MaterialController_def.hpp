...
// Write type traits
MARK_REF_T(::GlobalNamespace::MaterialController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MaterialController*, "", "MaterialController");
...
public:
  ...
  /// @brief Method OnValidate, addr 0x5871948, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5871980, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_material, addr 0x5871940, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MaterialController) == 0x30, "Size mismatch!");
