...
public:
  ...
  /// @brief Method OnValidate, addr 0x56bda8c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56bdac4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_material, addr 0x56bda84, size 0x8, virtual false, abstract: false, final false
