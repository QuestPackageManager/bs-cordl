...
public:
  ...
  /// @brief Method HandleBeatmapObjectEventManagerConnectedPlayerBeatmapObjectWasCut, addr 0x59ba8b0, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59ba7b0, size 0x100, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59ba6b8, size 0xf8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59baa84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
