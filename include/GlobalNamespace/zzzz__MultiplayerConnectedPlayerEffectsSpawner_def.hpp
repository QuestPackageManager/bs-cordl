...
public:
  ...
  /// @brief Method HandleBeatmapObjectEventManagerConnectedPlayerBeatmapObjectWasCut, addr 0x25ea820, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25ea718, size 0x108, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x25ea628, size 0xf0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x25eaa18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
