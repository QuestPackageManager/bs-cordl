...
public:
  ...
  /// @brief Method HandleBeatmapObjectEventManagerConnectedPlayerBeatmapObjectWasCut, addr 0x3bba3d4, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bba2d4, size 0x100, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3bba1e0, size 0xf4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bba5a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
