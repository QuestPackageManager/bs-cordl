...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XRRenderScaleRenderingFeature", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XRRenderScaleRenderingFeature(XRRenderScaleRenderingFeature&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XRRenderScaleRenderingFeature", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XRRenderScaleRenderingFeature(XRRenderScaleRenderingFeatureconst&) = delete;
