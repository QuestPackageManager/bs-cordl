...
public:
  ...
  /// @brief Method PlayHapticFeedback, addr 0x5713d18, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5713f68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
