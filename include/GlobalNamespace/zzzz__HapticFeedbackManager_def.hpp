...
public:
  ...
  /// @brief Method PlayHapticFeedback, addr 0x23d9238, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d9480, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
