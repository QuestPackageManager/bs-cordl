...
public:
  ...
  /// @brief Method get_continuousRumblePreset, addr 0x218a7b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO> get_continuousRumblePreset();

  /// @brief Method PlayHapticFeedback, addr 0x218a7b8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x218a9fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
