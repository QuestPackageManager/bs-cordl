...
public:
  ...
  /// @brief Method PlayHapticFeedback, addr 0x39cba0c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39cbc40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
