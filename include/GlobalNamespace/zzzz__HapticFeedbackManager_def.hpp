...
/// @brief Method PlayHapticFeedback, addr 0x56a5e34, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56a6084, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
