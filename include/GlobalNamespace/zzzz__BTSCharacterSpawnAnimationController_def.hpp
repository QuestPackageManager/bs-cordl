...
/// @brief Method EndEarlyAnimation, addr 0x31b5654, size 0x74, virtual false, abstract: false, final false
inline void EndEarlyAnimation() ;

/// @brief Method HandleSpawnCharacterPlayableDirectorStopped, addr 0x31b58b8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x31b54b4, size 0xdc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method PauseAnimation, addr 0x31b5838, size 0x80, virtual false, abstract: false, final false
inline void PauseAnimation() ;

/// @brief Method PlayAnimation, addr 0x31b5590, size 0xc4, virtual false, abstract: false, final false
inline void PlayAnimation() ;

/// @brief Method ResumeAnimation, addr 0x31b57f4, size 0x44, virtual false, abstract: false, final false
inline void ResumeAnimation() ;

/// @brief Method SetCharacter, addr 0x31b56e0, size 0x90, virtual false, abstract: false, final false
inline void SetCharacter(::GlobalNamespace::BTSCharacter*  btsCharacter) ;

/// @brief Method Start, addr 0x31b5424, size 0x90, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StopAnimation, addr 0x31b56c8, size 0x18, virtual false, abstract: false, final false
inline void StopAnimation() ;

/// @brief Method WillResumeAnimation, addr 0x31b5770, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31b58d4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_animationFinishedEvent, addr 0x31b4e84, size 0xac, virtual false, abstract: false, final false
inline void add_animationFinishedEvent(::System::Action*  value) ;

/// @brief Method get_characterActivationTrack, addr 0x31b5014, size 0x410, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Timeline::ActivationTrack> get_characterActivationTrack() ;

/// @brief Method get_duration, addr 0x31b4fdc, size 0x38, virtual false, abstract: false, final false
inline float_t get_duration() ;

/// @brief Method get_isCharacterVisible, addr 0x31b4e5c, size 0x28, virtual false, abstract: false, final false
inline bool get_isCharacterVisible() ;

/// @brief Method remove_animationFinishedEvent, addr 0x31b4f30, size 0xac, virtual false, abstract: false, final false
