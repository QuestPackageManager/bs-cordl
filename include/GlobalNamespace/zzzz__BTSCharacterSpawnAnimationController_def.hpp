...
// Write type traits
MARK_REF_T(::GlobalNamespace::BTSCharacterSpawnAnimationController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BTSCharacterSpawnAnimationController*, "", "BTSCharacterSpawnAnimationController");
...
public:
  // Declarations
  /// @brief Field _animatorNormalizedTimeBeforePause, offset 0x80, size 0x4
  ...
  /// @brief Field _appearAnimationEndTime, offset 0x30, size 0x4
  ...
  /// @brief Field _characterActivationTrack, offset 0x60, size 0x8
  __declspec(property(get = __cordl_internal_get__characterActivationTrack, put = __cordl_internal_set__characterActivationTrack)) ::UnityW<::UnityEngine::Timeline::ActivationTrack>
      _characterActivationTrack;

  /// @brief Field _currentBtsCharacter, offset 0x68, size 0x8
  ...
  /// @brief Field _defaultSpawnCharacterDuration, offset 0x70, size 0x4
  ...
  /// @brief Field _disappearAnimationStartTime, offset 0x34, size 0x4
  ...
  /// @brief Field _jumpReceiver, offset 0x28, size 0x8
  ...
  /// @brief Field _playableDirectorTimeBeforePause, offset 0x78, size 0x8
  ...
  /// @brief Field _rimLightColorSetter, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get__rimLightColorSetter, put = __cordl_internal_set__rimLightColorSetter)) ::UnityW<::GlobalNamespace::MaterialPropertyBlockColorSetter>
      _rimLightColorSetter;

  /// @brief Field _rimLightEdgeStartAnimator, offset 0x48, size 0x8
  __declspec(property(get = __cordl_internal_get__rimLightEdgeStartAnimator, put = __cordl_internal_set__rimLightEdgeStartAnimator)) ::UnityW<::GlobalNamespace::MaterialPropertyBlockFloatAnimator>
      _rimLightEdgeStartAnimator;

  /// @brief Field _rimLightIntensityAnimator, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__rimLightIntensityAnimator, put = __cordl_internal_set__rimLightIntensityAnimator)) ::UnityW<::GlobalNamespace::MaterialPropertyBlockFloatAnimator>
      _rimLightIntensityAnimator;

  /// @brief Field _songSpeedData, offset 0x50, size 0x8
  ...
  /// @brief Field _spawnCharacterPlayableDirector, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__spawnCharacterPlayableDirector, put = __cordl_internal_set__spawnCharacterPlayableDirector)) ::UnityW<::UnityEngine::Playables::PlayableDirector>
      _spawnCharacterPlayableDirector;

  /// @brief Field animationFinishedEvent, offset 0x58, size 0x8
  ...
  /// @brief Method EndEarlyAnimation, addr 0x3284054, size 0x74, virtual false, abstract: false, final false
  inline void EndEarlyAnimation();

  /// @brief Method HandleSpawnCharacterPlayableDirectorStopped, addr 0x32842b8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3283eb4, size 0xdc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PauseAnimation, addr 0x3284238, size 0x80, virtual false, abstract: false, final false
  inline void PauseAnimation();

  /// @brief Method PlayAnimation, addr 0x3283f90, size 0xc4, virtual false, abstract: false, final false
  inline void PlayAnimation();

  /// @brief Method ResumeAnimation, addr 0x32841f4, size 0x44, virtual false, abstract: false, final false
  inline void ResumeAnimation();

  /// @brief Method SetCharacter, addr 0x32840e0, size 0x90, virtual false, abstract: false, final false
  inline void SetCharacter(::GlobalNamespace::BTSCharacter* btsCharacter);

  /// @brief Method Start, addr 0x3283e24, size 0x90, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopAnimation, addr 0x32840c8, size 0x18, virtual false, abstract: false, final false
  inline void StopAnimation();

  /// @brief Method WillResumeAnimation, addr 0x3284170, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32842d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_animationFinishedEvent, addr 0x3283884, size 0xac, virtual false, abstract: false, final false
  inline void add_animationFinishedEvent(::System::Action* value);

  /// @brief Method get_characterActivationTrack, addr 0x3283a14, size 0x410, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::ActivationTrack> get_characterActivationTrack();

  /// @brief Method get_duration, addr 0x32839dc, size 0x38, virtual false, abstract: false, final false
  inline float_t get_duration();

  /// @brief Method get_isCharacterVisible, addr 0x328385c, size 0x28, virtual false, abstract: false, final false
  inline bool get_isCharacterVisible();

  /// @brief Method remove_animationFinishedEvent, addr 0x3283930, size 0xac, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _characterActivationTrack, offset: 0x60, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Timeline::ActivationTrack> ____characterActivationTrack;

  /// @brief Field _currentBtsCharacter, offset: 0x68, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::BTSCharacter> ____currentBtsCharacter;

  /// @brief Field _defaultSpawnCharacterDuration, offset: 0x70, size: 0x4, def value: None
  float_t ____defaultSpawnCharacterDuration;

  /// @brief Field _playableDirectorTimeBeforePause, offset: 0x78, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____appearAnimationEndTime) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____disappearAnimationStartTime) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____rimLightColorSetter) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____rimLightIntensityAnimator) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____rimLightEdgeStartAnimator) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____songSpeedData) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ___animationFinishedEvent) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____characterActivationTrack) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____currentBtsCharacter) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BTSCharacterSpawnAnimationController, ____defaultSpawnCharacterDuration) == 0x70, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::BTSCharacterSpawnAnimationController) == 0x88, "Size mismatch!");
