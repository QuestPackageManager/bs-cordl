...
public:
  ...
  /// @brief Method EndEarlyAnimation, addr 0x31ec15c, size 0x74, virtual false, abstract: false, final false
  inline void EndEarlyAnimation();

  /// @brief Method HandleSpawnCharacterPlayableDirectorStopped, addr 0x31ec3c0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x31ebfbc, size 0xdc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PauseAnimation, addr 0x31ec340, size 0x80, virtual false, abstract: false, final false
  inline void PauseAnimation();

  /// @brief Method PlayAnimation, addr 0x31ec098, size 0xc4, virtual false, abstract: false, final false
  inline void PlayAnimation();

  /// @brief Method ResumeAnimation, addr 0x31ec2fc, size 0x44, virtual false, abstract: false, final false
  inline void ResumeAnimation();

  /// @brief Method SetCharacter, addr 0x31ec1e8, size 0x90, virtual false, abstract: false, final false
  inline void SetCharacter(::GlobalNamespace::BTSCharacter* btsCharacter);

  /// @brief Method Start, addr 0x31ebf2c, size 0x90, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopAnimation, addr 0x31ec1d0, size 0x18, virtual false, abstract: false, final false
  inline void StopAnimation();

  /// @brief Method WillResumeAnimation, addr 0x31ec278, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31ec3dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_animationFinishedEvent, addr 0x31eb98c, size 0xac, virtual false, abstract: false, final false
  inline void add_animationFinishedEvent(::System::Action* value);

  /// @brief Method get_characterActivationTrack, addr 0x31ebb1c, size 0x410, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::ActivationTrack> get_characterActivationTrack();

  /// @brief Method get_duration, addr 0x31ebae4, size 0x38, virtual false, abstract: false, final false
  inline float_t get_duration();

  /// @brief Method get_isCharacterVisible, addr 0x31eb964, size 0x28, virtual false, abstract: false, final false
  inline bool get_isCharacterVisible();

  /// @brief Method remove_animationFinishedEvent, addr 0x31eba38, size 0xac, virtual false, abstract: false, final false
