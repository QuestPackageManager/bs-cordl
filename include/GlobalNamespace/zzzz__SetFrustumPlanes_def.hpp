...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SetFrustumPlanes", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SetFrustumPlanes(SetFrustumPlanes&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SetFrustumPlanes", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SetFrustumPlanes(SetFrustumPlanesconst&) = delete;
