...
public:
  ...
  /// @brief Method .ctor, addr 0x3c1eb68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x3c1ea98, size 0xa8, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::MissionHelpViewController* New_ctor();

  /// @brief Method OkButtonPressed, addr 0x3c1eb40, size 0x20, virtual false, abstract: false, final false
  inline void OkButtonPressed();

  /// @brief Method RefreshContent, addr 0x3c1e9c8, size 0xd0, virtual false, abstract: false, final false
  inline void RefreshContent();

  /// @brief Method Setup, addr 0x3c1e99c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c1eb60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3c1e83c, size 0xb0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionHelpViewController>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x3c1e8ec, size 0xb0, virtual false, abstract: false, final false
