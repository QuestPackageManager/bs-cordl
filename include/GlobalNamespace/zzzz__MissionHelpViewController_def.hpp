...
public:
  ...
  /// @brief Method .ctor, addr 0x3c189b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OkButtonPressed, addr 0x3c18988, size 0x20, virtual false, abstract: false, final false
  inline void OkButtonPressed();

  /// @brief Method RefreshContent, addr 0x3c18810, size 0xd0, virtual false, abstract: false, final false
  inline void RefreshContent();

  /// @brief Method Setup, addr 0x3c187e4, size 0x2c, virtual false, abstract: false, final false
