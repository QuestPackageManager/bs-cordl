...
public:
  ...
  /// @brief Method .ctor, addr 0x586cb7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_levelFailedEvent, addr 0x586ca24, size 0xac, virtual true, abstract: false, final true
  inline void add_levelFailedEvent(::System::Action* value);

  /// @brief Method add_levelFinishedEvent, addr 0x586c8cc, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_levelFailedEvent, addr 0x586cad0, size 0xac, virtual true, abstract: false, final true
  inline void remove_levelFailedEvent(::System::Action* value);

  /// @brief Method remove_levelFinishedEvent, addr 0x586c978, size 0xac, virtual true, abstract: false, final true
