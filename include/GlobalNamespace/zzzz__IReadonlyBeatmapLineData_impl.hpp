...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapObjectData*>* (::GlobalNamespace::IReadonlyBeatmapLineData::*)()>(&::GlobalNamespace::IReadonlyBeatmapLineData::get_beatmapObjectsData)> {
