...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SyncTimePacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SyncTimePacket(SyncTimePacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SyncTimePacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SyncTimePacket(SyncTimePacketconst&) = delete;
