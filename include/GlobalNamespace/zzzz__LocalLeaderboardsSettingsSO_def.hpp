...
public:
  ...
  /// @brief Method .ctor, addr 0x365dba8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxNumberOfScoresInLeaderboard, addr 0x365db98, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxNumberOfScoresInLeaderboard();

  /// @brief Method set_maxNumberOfScoresInLeaderboard, addr 0x365dba0, size 0x8, virtual false, abstract: false, final false
