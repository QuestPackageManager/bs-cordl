...
public:
  ...
  /// @brief Method add_playerDidFailEvent addr 0x23d5680 size 0x9c virtual false final false
  inline void add_playerDidFailEvent(::System::Action* value);

  /// @brief Method remove_playerDidFailEvent addr 0x23d519c size 0x9c virtual false final false
  inline void remove_playerDidFailEvent(::System::Action* value);

  /// @brief Method Start addr 0x23d6500 size 0x1a8 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x23d66a8 size 0x1a4 virtual false final false
  inline void OnDestroy();

  /// @brief Method CheckIfPlayerFailed addr 0x23d684c size 0x1ec virtual false final false
  inline void CheckIfPlayerFailed(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerDisconnected addr 0x23d6a38 size 0x4 virtual false final false
  inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerStateChanged addr 0x23d6a3c size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x23d6a40 size 0x8 virtual false final false
  inline void _ctor();
