...
public:
  ...
  /// @brief Method CheckIfPlayerFailed, addr 0x245f34c, size 0x1ec, virtual false, abstract: false, final false
  inline void CheckIfPlayerFailed(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerDisconnected, addr 0x245f538, size 0x4, virtual false, abstract: false, final false
  inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerStateChanged, addr 0x245f53c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x245f1a8, size 0x1a4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x245f000, size 0x1a8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x245f540, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playerDidFailEvent, addr 0x245e3cc, size 0x9c, virtual false, abstract: false, final false
  inline void add_playerDidFailEvent(::System::Action* value);

  /// @brief Method remove_playerDidFailEvent, addr 0x245def0, size 0x9c, virtual false, abstract: false, final false
