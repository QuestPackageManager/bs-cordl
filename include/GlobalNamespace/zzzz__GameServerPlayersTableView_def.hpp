...
public:
  ...
  /// @brief Method CellForIdx, addr 0x3afbc04, size 0x4f0, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x3afba90, size 0xc, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method GetCurrentPrefab, addr 0x3afbb68, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::GameServerPlayerTableCell> GetCurrentPrefab();

  /// @brief Method HandleCellKickPlayer, addr 0x3afc7e8, size 0xfc, virtual false, abstract: false, final false
  inline void HandleCellKickPlayer(int32_t idx);

  /// @brief Method HandleCellUseBeatmap, addr 0x3afc25c, size 0x338, virtual false, abstract: false, final false
  inline void HandleCellUseBeatmap(int32_t idx);

  /// @brief Method HandleCellUseModifiers, addr 0x3afc594, size 0x254, virtual false, abstract: false, final false
  inline void HandleCellUseModifiers(int32_t idx);

  /// @brief Method Init, addr 0x3afc9a0, size 0x44, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::GameServerPlayersTableView* New_ctor();

  /// @brief Method NumberOfCells, addr 0x3afba9c, size 0x48, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetData, addr 0x3afc8e4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetLobbyPlayerData, addr 0x3afc0f4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3afc9e4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_kickPlayerEvent, addr 0x3afb930, size 0xb0, virtual false, abstract: false, final false
  inline void add_kickPlayerEvent(::System::Action_1<::StringW>* value);

  /// @brief Method add_selectSuggestedGameplayModifiersEvent, addr 0x3afb7d0, size 0xb0, virtual false, abstract: false, final false
  inline void add_selectSuggestedGameplayModifiersEvent(::System::Action_1<::GlobalNamespace::GameplayModifiers*>* value);

  /// @brief Method add_selectSuggestedLevelEvent, addr 0x3afb670, size 0xb0, virtual false, abstract: false, final false
  inline void add_selectSuggestedLevelEvent(::System::Action_1<::GlobalNamespace::BeatmapKey>* value);

  /// @brief Method get_currentCellId, addr 0x3afbae4, size 0x84, virtual false, abstract: false, final false
  inline ::StringW get_currentCellId();

  /// @brief Convert to "::HMUI::TableView_IDataSource"
  constexpr ::HMUI::TableView_IDataSource* i___HMUI__TableView_IDataSource() noexcept;

  /// @brief Method remove_kickPlayerEvent, addr 0x3afb9e0, size 0xb0, virtual false, abstract: false, final false
  inline void remove_kickPlayerEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_selectSuggestedGameplayModifiersEvent, addr 0x3afb880, size 0xb0, virtual false, abstract: false, final false
  inline void remove_selectSuggestedGameplayModifiersEvent(::System::Action_1<::GlobalNamespace::GameplayModifiers*>* value);

  /// @brief Method remove_selectSuggestedLevelEvent, addr 0x3afb720, size 0xb0, virtual false, abstract: false, final false
