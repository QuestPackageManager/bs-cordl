...
public:
  ...
  /// @brief Method CellForIdx, addr 0x3b035e0, size 0x4f0, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x3b0346c, size 0xc, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method GetCurrentPrefab, addr 0x3b03544, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::GameServerPlayerTableCell> GetCurrentPrefab();

  /// @brief Method HandleCellKickPlayer, addr 0x3b041c4, size 0xfc, virtual false, abstract: false, final false
  inline void HandleCellKickPlayer(int32_t idx);

  /// @brief Method HandleCellUseBeatmap, addr 0x3b03c38, size 0x338, virtual false, abstract: false, final false
  inline void HandleCellUseBeatmap(int32_t idx);

  /// @brief Method HandleCellUseModifiers, addr 0x3b03f70, size 0x254, virtual false, abstract: false, final false
  inline void HandleCellUseModifiers(int32_t idx);

  /// @brief Method Init, addr 0x3b0437c, size 0x44, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::GameServerPlayersTableView* New_ctor();

  /// @brief Method NumberOfCells, addr 0x3b03478, size 0x48, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetData, addr 0x3b042c0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetLobbyPlayerData, addr 0x3b03ad0, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b043c0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_kickPlayerEvent, addr 0x3b0330c, size 0xb0, virtual false, abstract: false, final false
  inline void add_kickPlayerEvent(::System::Action_1<::StringW>* value);

  /// @brief Method add_selectSuggestedGameplayModifiersEvent, addr 0x3b031ac, size 0xb0, virtual false, abstract: false, final false
  inline void add_selectSuggestedGameplayModifiersEvent(::System::Action_1<::GlobalNamespace::GameplayModifiers*>* value);

  /// @brief Method add_selectSuggestedLevelEvent, addr 0x3b0304c, size 0xb0, virtual false, abstract: false, final false
  inline void add_selectSuggestedLevelEvent(::System::Action_1<::GlobalNamespace::BeatmapKey>* value);

  /// @brief Method get_currentCellId, addr 0x3b034c0, size 0x84, virtual false, abstract: false, final false
  inline ::StringW get_currentCellId();

  /// @brief Convert to "::HMUI::TableView_IDataSource"
  constexpr ::HMUI::TableView_IDataSource* i___HMUI__TableView_IDataSource() noexcept;

  /// @brief Method remove_kickPlayerEvent, addr 0x3b033bc, size 0xb0, virtual false, abstract: false, final false
  inline void remove_kickPlayerEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_selectSuggestedGameplayModifiersEvent, addr 0x3b0325c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_selectSuggestedGameplayModifiersEvent(::System::Action_1<::GlobalNamespace::GameplayModifiers*>* value);

  /// @brief Method remove_selectSuggestedLevelEvent, addr 0x3b030fc, size 0xb0, virtual false, abstract: false, final false
