...
public:
  ...
  /// @brief Method get_normalSprite, addr 0x23db8fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_normalSprite();

  /// @brief Method get_highlightedSprite, addr 0x23db904, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_highlightedSprite();

  /// @brief Method get_pressedSprite, addr 0x23db90c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_pressedSprite();

  /// @brief Method get_disabledSprite, addr 0x23db914, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_disabledSprite();

  /// @brief Method get_selectedSprite, addr 0x23db91c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_selectedSprite();

  /// @brief Method get_selectedAndHighlightedSprite, addr 0x23db924, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23db92c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
