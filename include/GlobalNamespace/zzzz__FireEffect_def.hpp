...
public:
  ...
  /// @brief Method NotifyAlphaWasChanged, addr 0x3ad76ac, size 0xc0, virtual false, abstract: false, final false
  inline void NotifyAlphaWasChanged(float_t currentAlpha);

  /// @brief Method OnDestroy, addr 0x3ad718c, size 0x28, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetRenderersEnabled, addr 0x3ad7400, size 0x8c, virtual false, abstract: false, final false
  inline void SetRenderersEnabled(bool enabled);

  /// @brief Method Start, addr 0x3ad6f30, size 0x11c, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ad77e4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
