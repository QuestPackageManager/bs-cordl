...
/// @brief Method LogError, addr 0x36789f8, size 0xb8, virtual true, abstract: false, final true
inline void LogError(::StringW  message) ;

/// @brief Method LogInfo, addr 0x3678ab0, size 0xb8, virtual true, abstract: false, final true
inline void LogInfo(::StringW  message) ;

/// @brief Method LogSensitive, addr 0x3678b6c, size 0x4, virtual true, abstract: false, final true
inline void LogSensitive(::StringW  message) ;

/// @brief Method LogVerbose, addr 0x3678b68, size 0x4, virtual true, abstract: false, final true
inline void LogVerbose(::StringW  message) ;

/// @brief Method LogWarning, addr 0x3678b70, size 0xb8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3677e8c, size 0x8, virtual false, abstract: false, final false
