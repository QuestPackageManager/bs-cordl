...
/// @brief Method AnimateColorsForAllPlayers, addr 0x583c618, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method AnimateColorsForPlayer, addr 0x583c188, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method GetScoreRingItem, addr 0x583c354, size 0x114, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MultiplayerScoreRingItem> GetScoreRingItem(::StringW  userId) ;

/// @brief Method GetScoreRingItems, addr 0x583c468, size 0x1b0, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::GameObject>,::Array<::UnityW<::UnityEngine::GameObject>>*> GetScoreRingItems() ;

/// @brief Method HandlePlayerDisconnected, addr 0x583cefc, size 0x4, virtual false, abstract: false, final false
inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerSpawningDidFinish, addr 0x583b5a0, size 0x18, virtual false, abstract: false, final false
inline void HandlePlayerSpawningDidFinish() ;

/// @brief Method HandlePlayerStateChanged, addr 0x583cebc, size 0x40, virtual false, abstract: false, final false
inline void HandlePlayerStateChanged(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x583b588, size 0x18, virtual false, abstract: false, final false
inline void HandleSpawnCenterDistanceWasFound(float_t  spawnCenterDistance) ;

/// @brief Method HandleStateChanged, addr 0x583b5b8, size 0x4b4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x583ba6c, size 0x418, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetPlayerToFailedState, addr 0x583c7b8, size 0x138, virtual false, abstract: false, final false
inline void SetPlayerToFailedState(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method SpawnTexts, addr 0x583c908, size 0x5b4, virtual false, abstract: false, final false
inline void SpawnTexts() ;

/// @brief Method Start, addr 0x583b320, size 0x268, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TrySpawnTexts, addr 0x583c8f0, size 0x18, virtual false, abstract: false, final false
inline void TrySpawnTexts() ;

/// @brief Method Update, addr 0x583be84, size 0xf8, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateScore, addr 0x583bf7c, size 0x20c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x583cf00, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
