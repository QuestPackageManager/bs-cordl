...
/// @brief Field _allActivePlayers, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__allActivePlayers, put=__cordl_internal_set__allActivePlayers)) ::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>*  _allActivePlayers;
...
/// @brief Field _scoreRingItems, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__scoreRingItems, put=__cordl_internal_set__scoreRingItems)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityW<::GlobalNamespace::MultiplayerScoreRingItem>>*  _scoreRingItems;
...
/// @brief Method AnimateColorsForAllPlayers, addr 0x58aff34, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method AnimateColorsForPlayer, addr 0x58afaa4, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method GetScoreRingItem, addr 0x58afc70, size 0x114, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MultiplayerScoreRingItem> GetScoreRingItem(::StringW  userId) ;

/// @brief Method GetScoreRingItems, addr 0x58afd84, size 0x1b0, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::GameObject>,::Array<::UnityW<::UnityEngine::GameObject>>*> GetScoreRingItems() ;

/// @brief Method HandlePlayerDisconnected, addr 0x58b0818, size 0x4, virtual false, abstract: false, final false
inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerSpawningDidFinish, addr 0x58aeebc, size 0x18, virtual false, abstract: false, final false
inline void HandlePlayerSpawningDidFinish() ;

/// @brief Method HandlePlayerStateChanged, addr 0x58b07d8, size 0x40, virtual false, abstract: false, final false
inline void HandlePlayerStateChanged(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x58aeea4, size 0x18, virtual false, abstract: false, final false
inline void HandleSpawnCenterDistanceWasFound(float_t  spawnCenterDistance) ;

/// @brief Method HandleStateChanged, addr 0x58aeed4, size 0x4b4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x58af388, size 0x418, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetPlayerToFailedState, addr 0x58b00d4, size 0x138, virtual false, abstract: false, final false
inline void SetPlayerToFailedState(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method SpawnTexts, addr 0x58b0224, size 0x5b4, virtual false, abstract: false, final false
inline void SpawnTexts() ;

/// @brief Method Start, addr 0x58aec3c, size 0x268, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TrySpawnTexts, addr 0x58b020c, size 0x18, virtual false, abstract: false, final false
inline void TrySpawnTexts() ;

/// @brief Method Update, addr 0x58af7a0, size 0xf8, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateScore, addr 0x58af898, size 0x20c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58b081c, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
