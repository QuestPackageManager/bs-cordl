...
public:
  // Declarations
  /// @brief Method Swap addr 0xe25978 size 0x228 virtual false final false
  static inline void Swap(::System::Text::StringBuilder* sb, int32_t startIndex, int32_t endIndex);

  /// @brief Method AppendNumber addr 0xe25ba0 size 0x14 virtual false final false
  static inline void AppendNumber(::System::Text::StringBuilder* sb, int32_t number);

  /// @brief Method AppendNumber addr 0xe25bcc size 0xa4 virtual false final false
