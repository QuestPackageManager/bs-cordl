...
public:
  // Declarations
  /// @brief Method AppendNumber, addr 0x22a03b4, size 0x14, virtual false, abstract: false, final false
  static inline void AppendNumber(::System::Text::StringBuilder* sb, int32_t number);

  /// @brief Method AppendNumber, addr 0x22a03e0, size 0xa4, virtual false, abstract: false, final false
  static inline void AppendNumber(::System::Text::StringBuilder* sb, uint32_t uNumber, bool isNegative);

  /// @brief Method Swap, addr 0x22a0194, size 0x220, virtual false, abstract: false, final false
