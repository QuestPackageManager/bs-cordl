...
public:
// Declarations
/// @brief Method AppendNumber, addr 0x3216450, size 0x10, virtual false, abstract: false, final false
static inline void AppendNumber(::System::Text::StringBuilder*  sb, int32_t  number) ;

/// @brief Method AppendNumber, addr 0x3216478, size 0x88, virtual false, abstract: false, final false
static inline void AppendNumber(::System::Text::StringBuilder*  sb, uint32_t  uNumber, bool  isNegative) ;

/// @brief Method Swap, addr 0x3216258, size 0x1f8, virtual false, abstract: false, final false
