...
public:
  ...
  /// @brief Method <IntegrateCommand>b__0, addr 0x32caba0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ca380, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <FindAutocompleteArgumentNames>b__0, addr 0x32cabc8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ca530, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <FindAutocompleteArgumentValues>b__0, addr 0x32cabe8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ca730, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <FindAutocompleteNodes>b__0, addr 0x32cac70, size 0x64, virtual false, abstract: false, final false
  inline bool _FindAutocompleteNodes_b__0(::GlobalNamespace::CommandNode* node);

  /// @brief Method <FindAutocompleteNodes>b__1, addr 0x32cacd4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32caa5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FindAutocompleteArgumentNames, addr 0x32ca384, size 0x1ac, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW> FindAutocompleteArgumentNames(::StringW inputArgumentName);

  /// @brief Method FindAutocompleteArgumentValues, addr 0x32ca534, size 0x1fc, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW> FindAutocompleteArgumentValues(::StringW inputArgumentName, ::StringW inputArgumentValue);

  /// @brief Method FindAutocompleteNodes, addr 0x32ca754, size 0x308, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::CommandNode*> FindAutocompleteNodes(::StringW input, bool exact);

  /// @brief Method IntegrateCommand, addr 0x32c9fd0, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x32c9fc8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32caa60, size 0x140, virtual false, abstract: false, final false
  inline void _ctor();
