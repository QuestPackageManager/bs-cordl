...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::DirectionalLight>>* (*)()>(&::GlobalNamespace::DirectionalLight::get_lights)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x56b4f88;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DirectionalLight::*)()>(&::GlobalNamespace::DirectionalLight::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x56b4fe4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DirectionalLight::*)()>(&::GlobalNamespace::DirectionalLight::OnDisable)> {
  ...
  constexpr static std::size_t addrs = 0x56b50b8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DirectionalLight::*)()>(&::GlobalNamespace::DirectionalLight::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x56b5140;
...
::cordl_internals::setStaticField<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::DirectionalLight>>*, "_lights", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DirectionalLight*>::get>(std::forward<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::DirectionalLight>>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::DirectionalLight>>*, "_lights", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DirectionalLight*>::get>();
}
inline void GlobalNamespace::DirectionalLight::setStaticF__mainLight(::UnityW<::GlobalNamespace::DirectionalLight>  value)  {
::cordl_internals::setStaticField<::UnityW<::GlobalNamespace::DirectionalLight>, "_mainLight", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DirectionalLight*>::get>(std::forward<::UnityW<::GlobalNamespace::DirectionalLight>>(value));
}
inline ::UnityW<::GlobalNamespace::DirectionalLight> GlobalNamespace::DirectionalLight::getStaticF__mainLight()  {
return ::cordl_internals::getStaticField<::UnityW<::GlobalNamespace::DirectionalLight>, "_mainLight", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DirectionalLight*>::get>();
}
