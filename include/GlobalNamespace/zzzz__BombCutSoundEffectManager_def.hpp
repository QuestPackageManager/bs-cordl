...
public:
  ...
  /// @brief Method HandleBombCutSoundEffectDidFinish, addr 0x570b520, size 0xc0, virtual false, abstract: false, final false
  inline void HandleBombCutSoundEffectDidFinish(::GlobalNamespace::BombCutSoundEffect* bombCutSoundEffect);

  /// @brief Method HandleNoteWasCut, addr 0x570b248, size 0x240, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ::ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  static inline ::GlobalNamespace::BombCutSoundEffectManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x570b488, size 0x98, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x570b164, size 0xe4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x570b5e0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
