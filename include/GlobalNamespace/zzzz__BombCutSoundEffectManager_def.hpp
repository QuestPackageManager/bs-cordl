...
// Write type traits
MARK_REF_T(::GlobalNamespace::BombCutSoundEffectManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BombCutSoundEffectManager*, "", "BombCutSoundEffectManager");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__bombExplosionAudioClips, put = __cordl_internal_set__bombExplosionAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>> _bombExplosionAudioClips;
  ...
  /// @brief Method HandleBombCutSoundEffectDidFinish, addr 0x58b8ad4, size 0xc0, virtual false, abstract: false, final false
  inline void HandleBombCutSoundEffectDidFinish(::GlobalNamespace::BombCutSoundEffect* bombCutSoundEffect);

  /// @brief Method HandleNoteWasCut, addr 0x58b87fc, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58b8a3c, size 0x98, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x58b8718, size 0xe4, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& __cordl_internal_get__bombExplosionAudioClips() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& __cordl_internal_get__bombExplosionAudioClips();
  ...
  constexpr void __cordl_internal_set__bombExplosionAudioClips(::ArrayW<::UnityW<::UnityEngine::AudioClip>> value);
  ...
  /// @brief Method .ctor, addr 0x58b8b94, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BombCutSoundEffectManager) == 0x50, "Size mismatch!");
