...
/// @brief Method SetFloat, addr 0x57e39c8, size 0x130, virtual false, abstract: false, final false
inline void SetFloat(float_t  value) ;

/// @brief Method SetValue, addr 0x57e39c4, size 0x4, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x57e3af8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57e3afc, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
