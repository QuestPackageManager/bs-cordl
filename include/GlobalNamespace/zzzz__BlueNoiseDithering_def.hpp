...
public:
  ...
  /// @brief Method SetBlueNoiseShaderParams, addr 0x58681f0, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58682d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BlueNoiseDithering", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BlueNoiseDithering(BlueNoiseDithering&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BlueNoiseDithering", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BlueNoiseDithering(BlueNoiseDitheringconst&) = delete;
