...
/// @brief Field activateKeyActions, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_activateKeyActions, put=__cordl_internal_set_activateKeyActions)) ::ArrayW<::UnityEngine::InputSystem::InputAction*,::Array<::UnityEngine::InputSystem::InputAction*>*>  activateKeyActions;
...
/// @brief Field pitchKeyActions, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_pitchKeyActions, put=__cordl_internal_set_pitchKeyActions)) ::ArrayW<::UnityEngine::InputSystem::InputAction*,::Array<::UnityEngine::InputSystem::InputAction*>*>  pitchKeyActions;
...
/// @brief Method IsEmulationActivated, addr 0x5cac0b0, size 0xf8, virtual false, abstract: false, final false
inline bool IsEmulationActivated() ;

/// @brief Method IsTweakingPitch, addr 0x5cac1a8, size 0xb0, virtual false, abstract: false, final false
inline bool IsTweakingPitch() ;

static inline ::GlobalNamespace::OVRHeadsetEmulator* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5cac258, size 0xf4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5cab8ac, size 0x2dc, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x5cabb88, size 0x528, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5cac34c, size 0x210, virtual false, abstract: false, final false
inline void _ctor() ;
