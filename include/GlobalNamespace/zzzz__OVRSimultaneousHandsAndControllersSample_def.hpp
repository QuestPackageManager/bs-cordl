...
public:
  ...
  /// @brief Method DisableSimultaneousHandsAndControllers, addr 0x5d956b0, size 0x84, virtual false, abstract: false, final false
  inline void DisableSimultaneousHandsAndControllers();

  /// @brief Method EnableSimultaneousHandsAndControllers, addr 0x5d9562c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5d9552c, size 0x100, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5d95734, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
