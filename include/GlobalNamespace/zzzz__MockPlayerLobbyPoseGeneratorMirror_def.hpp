...
public:
  ...
  /// @brief Method .ctor addr 0x22439b8 size 0x184 virtual false final false
  ...
  /// @brief Method Init addr 0x2243b3c size 0x4 virtual true final false
  inline void Init();

  /// @brief Method Dispose addr 0x2243b40 size 0xd0 virtual true final false
  inline void Dispose();

  /// @brief Method Tick addr 0x2243c10 size 0x168 virtual true final false
  inline void Tick();

  /// @brief Method FindPlayerToMirror addr 0x2243d78 size 0x3a4 virtual false final false
  inline void FindPlayerToMirror();

  /// @brief Method HandleOptionalAvatarDataReceived addr 0x224411c size 0x1d8 virtual false final false
