...
public:
  ...
  /// @brief Method Dispose, addr 0x3b66388, size 0xd0, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method FindPlayerToMirror, addr 0x3b665a8, size 0x39c, virtual false, abstract: false, final false
  inline void FindPlayerToMirror();

  /// @brief Method HandleOptionalAvatarDataReceived, addr 0x3b66944, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x3b66384, size 0x4, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method Tick, addr 0x3b66458, size 0x150, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x3b64198, size 0x178, virtual false, abstract: false, final false
