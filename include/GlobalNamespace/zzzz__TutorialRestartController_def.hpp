...
public:
  ...
  /// @brief Method RestartLevel, addr 0x3bb6fd8, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3bb6ff8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
