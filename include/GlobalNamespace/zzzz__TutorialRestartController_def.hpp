...
public:
  ...
  /// @brief Method RestartLevel, addr 0x3badb90, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3badbb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
