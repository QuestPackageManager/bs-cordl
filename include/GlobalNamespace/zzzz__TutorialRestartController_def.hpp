...
public:
  ...
  /// @brief Method RestartLevel, addr 0x26ea690, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26ea6b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::TutorialRestartController, ____tutorialSceneSetupData) == 0x18, "Offset mismatch!");
