...
public:
  ...
  /// @brief Method RestartLevel, addr 0x25e46e8, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25e4708, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
