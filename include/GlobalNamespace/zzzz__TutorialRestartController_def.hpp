...
public:
  ...
  /// @brief Method RestartLevel, addr 0x2388920, size 0x20, virtual true, abstract: false, final true
  inline void RestartLevel();

  static inline ::GlobalNamespace::TutorialRestartController* New_ctor();

  /// @brief Method .ctor, addr 0x2388940, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
