...
/// @brief Method RestartLevel, addr 0x5809db8, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5809de8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
