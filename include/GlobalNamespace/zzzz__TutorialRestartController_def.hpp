...
public:
  ...
  /// @brief Method RestartLevel, addr 0x587bd04, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x587bd34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
