...
public:
  ...
  /// @brief Method Create2DTextureFromCubemap, addr 0x3b238c4, size 0x154, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> Create2DTextureFromCubemap(::UnityEngine::RenderTexture* src);

  /// @brief Method CreateDownsampledCubemap, addr 0x3b236ec, size 0x1d8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> CreateDownsampledCubemap(::UnityEngine::RenderTexture* src, int32_t count);

  /// @brief Method Downsample, addr 0x3b2341c, size 0x12c, virtual false, abstract: false, final false
  static inline void Downsample(::UnityEngine::Texture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method DrawCubemapFace, addr 0x3b23548, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cubemapHelpersMaterial, addr 0x3b232fc, size 0x120, virtual false, abstract: false, final false
