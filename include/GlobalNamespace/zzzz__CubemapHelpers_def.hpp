...
public:
  ...
  /// @brief Method Create2DTextureFromCubemap, addr 0x3b182b4, size 0x154, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> Create2DTextureFromCubemap(::UnityEngine::RenderTexture* src);

  /// @brief Method CreateDownsampledCubemap, addr 0x3b180dc, size 0x1d8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> CreateDownsampledCubemap(::UnityEngine::RenderTexture* src, int32_t count);

  /// @brief Method Downsample, addr 0x3b17e0c, size 0x12c, virtual false, abstract: false, final false
  static inline void Downsample(::UnityEngine::Texture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method DrawCubemapFace, addr 0x3b17f38, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cubemapHelpersMaterial, addr 0x3b17cec, size 0x120, virtual false, abstract: false, final false
