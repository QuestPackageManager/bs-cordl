...
public:
  ...
  /// @brief Method InstallBindings, addr 0x26a0d64, size 0x30c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a1388, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_standardLevelNoTransitionInstallerData, addr 0x26a0d5c, size 0x8, virtual false, abstract: false, final false
