...
public:
  ...
  /// @brief Method InstallBindings, addr 0x57eb1b0, size 0x328, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57eba84, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_standardLevelNoTransitionInstallerData, addr 0x57eb1a8, size 0x8, virtual false, abstract: false, final false
