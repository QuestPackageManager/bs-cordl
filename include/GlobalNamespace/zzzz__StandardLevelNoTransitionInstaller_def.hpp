...
/// @brief Method InstallBindings, addr 0x57eca18, size 0x328, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ed2ec, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_standardLevelNoTransitionInstallerData, addr 0x57eca10, size 0x8, virtual false, abstract: false, final false
