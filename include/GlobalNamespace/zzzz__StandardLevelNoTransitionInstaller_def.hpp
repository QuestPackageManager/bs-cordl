...
public:
  ...
  /// @brief Method InstallBindings, addr 0x25a6d8c, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25a72a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_standardLevelNoTransitionInstallerData, addr 0x25a6d84, size 0x8, virtual false, abstract: false, final false
