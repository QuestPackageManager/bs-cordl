...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionLevelModifiersViewController*);
...
public:
  ...
  /// @brief Method <RefreshContent>b__0, addr 0x595c830, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x595c828, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissionLevelModifiersViewController___c__DisplayClass7_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x595c824, size 0x4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::MissionLevelModifiersViewController* New_ctor();

  /// @brief Method RefreshContent, addr 0x595c640, size 0x1e4, virtual false, abstract: false, final false
  inline void RefreshContent();

  /// @brief Method Setup, addr 0x595c614, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x595c82c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissionLevelModifiersViewController) == 0xa0, "Size mismatch!");
