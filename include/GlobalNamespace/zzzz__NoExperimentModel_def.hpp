...
/// @brief Method IsEmployee, addr 0x364a8dc, size 0x70, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<bool>* IsEmployee() ;

/// @brief Method IsInTest, addr 0x364a94c, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x364a9bc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
