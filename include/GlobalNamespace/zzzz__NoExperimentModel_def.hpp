...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoExperimentModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoExperimentModel*, "", "NoExperimentModel");
...
public:
  ...
  /// @brief Method IsEmployee, addr 0x370a040, size 0x70, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<bool>* IsEmployee();

  /// @brief Method IsInTest, addr 0x370a0b0, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x370a120, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoExperimentModel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoExperimentModel(NoExperimentModel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoExperimentModel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoExperimentModel(NoExperimentModelconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NoExperimentModel) == 0x10, "Size mismatch!");
