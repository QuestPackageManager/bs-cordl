...
public:
  ...
  /// @brief Method SendSongDidFinishEvent, addr 0x272a5bc, size 0x1c, virtual false, abstract: false, final false
  inline void SendSongDidFinishEvent();

  /// @brief Method SendSongDidStartEvent, addr 0x272a61c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x272a804, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_songDidFinishEvent, addr 0x272a960, size 0x9c, virtual false, abstract: false, final false
  inline void add_songDidFinishEvent(::System::Action* value);

  /// @brief Method add_songDidStartEvent, addr 0x272a828, size 0x9c, virtual false, abstract: false, final false
  inline void add_songDidStartEvent(::System::Action* value);

  /// @brief Method remove_songDidFinishEvent, addr 0x272a9fc, size 0x9c, virtual false, abstract: false, final false
  inline void remove_songDidFinishEvent(::System::Action* value);

  /// @brief Method remove_songDidStartEvent, addr 0x272a8c4, size 0x9c, virtual false, abstract: false, final false
