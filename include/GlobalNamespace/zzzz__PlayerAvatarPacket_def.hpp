...
public:
  ...
  /// @brief Method Deserialize, addr 0x332b6cc, size 0x38, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x332b75c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x332b704, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x332b6a0, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x332b770, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x332b65c, size 0x44, virtual false, abstract: false, final false
