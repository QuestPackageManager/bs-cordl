...
/// @brief Field _ambientSettingsList, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__ambientSettingsList, put=__cordl_internal_set__ambientSettingsList)) ::UnityW<::GlobalNamespace::FormattedFloatListSettingsController>  _ambientSettingsList;
...
/// @brief Field _volumeSettingsList, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__volumeSettingsList, put=__cordl_internal_set__volumeSettingsList)) ::UnityW<::GlobalNamespace::FormattedFloatListSettingsController>  _volumeSettingsList;

/// @brief Method DidActivate, addr 0x5738010, size 0x334, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x57383f8, size 0xfc, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleAmbientVolumeChanged, addr 0x5738614, size 0x18, virtual false, abstract: false, final false
inline void HandleAmbientVolumeChanged(::GlobalNamespace::FormattedFloatListSettingsController*  _, float_t  newValue) ;

/// @brief Method HandleOverrideAudioLatencyToggleValueChanged, addr 0x573865c, size 0x50, virtual false, abstract: false, final false
inline void HandleOverrideAudioLatencyToggleValueChanged(bool  isOn) ;

/// @brief Method HandleVolumeChanged, addr 0x57385e0, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x57384f4, size 0xec, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RefreshVisuals, addr 0x5738344, size 0xb4, virtual false, abstract: false, final false
inline void RefreshVisuals(bool  overrideAudioLatencyIsEnabled) ;

/// @brief Method SliderValueDidChange, addr 0x573862c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57386ac, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
