...
public:
  ...
  /// @brief Method DidActivate, addr 0x3af362c, size 0x284, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3af394c, size 0xf0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleAmbientVolumeChanged, addr 0x3af3b50, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAmbientVolumeChanged(::GlobalNamespace::FormattedFloatListSettingsController* _, float_t newValue);

  /// @brief Method HandleOverrideAudioLatencyToggleValueChanged, addr 0x3af3b94, size 0x50, virtual false, abstract: false, final false
  inline void HandleOverrideAudioLatencyToggleValueChanged(bool isOn);

  /// @brief Method HandleVolumeChanged, addr 0x3af3b1c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3af3a3c, size 0xe0, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshVisuals, addr 0x3af38b0, size 0x9c, virtual false, abstract: false, final false
  inline void RefreshVisuals(bool overrideAudioLatencyIsEnabled);

  /// @brief Method SliderValueDidChange, addr 0x3af3b6c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af3be4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
