...
#include "GlobalNamespace/zzzz__FloatFxBeatmapEventDataBox_impl.hpp"
#include "GlobalNamespace/zzzz__ILightGroup_impl.hpp"
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor__BpmChangeData::*)(float_t, float_t, float_t)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor__BpmChangeData>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::*)(float_t)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get(), "ConvertBeatToTime",
...
constexpr ::GlobalNamespace::IBeatToTimeConvertor* GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::i___GlobalNamespace__IBeatToTimeConvertor() noexcept {
  return static_cast<::GlobalNamespace::IBeatToTimeConvertor*>(static_cast<void*>(this));
}
constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor__BpmChangeData>*&
GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::__cordl_internal_get__bpmChangeDataList() {
...
GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::__cordl_internal_get__bpmChangeDataList() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____bpmChangeDataList;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::__cordl_internal_set__bpmChangeDataList(
...
constexpr int32_t& GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::__cordl_internal_get_currentBpmChangesDataIdx() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___currentBpmChangesDataIdx;
}
constexpr int32_t const& GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::__cordl_internal_get_currentBpmChangesDataIdx() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___currentBpmChangesDataIdx;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::__cordl_internal_set_currentBpmChangesDataIdx(int32_t value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor::New_ctor(float_t startBpm,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>(startBpm, bpmEventsSaveData));
}
inline void
...
constexpr ::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*& GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>::__cordl_internal_get__bpmTimeProcessor() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>::__cordl_internal_get__bpmTimeProcessor() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____bpmTimeProcessor;
}
template <typename TBase, typename TIn, typename TOut>
constexpr void
GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>::__cordl_internal_set__bpmTimeProcessor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>*>(bpmTimeProcessor));
}
template <typename TBase, typename TIn, typename TOut>
inline void GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>::_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>*>::get(), ".ctor",
                                  std::span<Il2CppClass const* const, 0>(),
                                  ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
...
template <typename TBase, typename TIn, typename TOut> inline float_t GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>::BeatToTime(float_t beat) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BeatmapDataItemConvertor_3<TBase, TIn, TOut>*>::get(), "BeatToTime",
                                  std::span<Il2CppClass const* const, 0>(), ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get() })));
  return ::cordl_internals::RunMethodRethrow<float_t, false>(this, ___internal_method, beat);
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__BasicEventConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BasicEventConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BasicBeatmapEventType (*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ...
        std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion2_6_0AndEarlier::__BeatmapSaveData__BeatmapEventType>::get() })));
    return ___internal_method;
  }
};
constexpr ::GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter*& GlobalNamespace::__BeatmapDataLoader__BasicEventConvertor::__cordl_internal_get__specialEventsFilter() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__BasicEventConvertor::__cordl_internal_get__specialEventsFilter() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____specialEventsFilter;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__BasicEventConvertor::__cordl_internal_set__specialEventsFilter(::GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__BasicEventConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__BasicEventConvertor*>(bpmTimeProcessor, specialEventsFilter));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__BombNoteConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BombNoteConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__BombNoteConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__BombNoteConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__BpmEventConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BpmEventConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__BpmEventConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__BpmEventConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__ColorBoostEventConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__ColorBoostEventConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__ColorBoostEventConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__ColorBoostEventConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__ColorNoteConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__ColorNoteConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__ColorNoteConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__ColorNoteConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType (*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ...
        std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapSaveData__EventBox__DistributionParamType>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::*)(
    ::GlobalNamespace::IEnvironmentLightGroups*)>(&::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::_ctor)> {
  constexpr static std::size_t size = 0x158;
  constexpr static std::size_t addrs = 0x2332a50;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::IEnvironmentLightGroups*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
    static_cast<::GlobalNamespace::BeatmapEventDataBoxGroup* (::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__EventBoxGroup*)>(
        &::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::Convert)> {
  constexpr static std::size_t size = 0x55c;
  constexpr static std::size_t addrs = 0x2332ba8;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__EventBoxGroup*>::get() })));
    return ___internal_method;
  }
};
constexpr ::GlobalNamespace::DataConvertor_2<::GlobalNamespace::BeatmapEventDataBox*, ::GlobalNamespace::ILightGroup*>*&
GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::__cordl_internal_get__convertors() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::__cordl_internal_get__convertors() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____convertors;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::__cordl_internal_set__convertors(
...
constexpr ::GlobalNamespace::IEnvironmentLightGroups*& GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::__cordl_internal_get__lightGroups() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____lightGroups;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IEnvironmentLightGroups*> const&
GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::__cordl_internal_get__lightGroups() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____lightGroups;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::__cordl_internal_set__lightGroups(::GlobalNamespace::IEnvironmentLightGroups* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::New_ctor(::GlobalNamespace::IEnvironmentLightGroups* lightGroups) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor*>(lightGroups));
}
...
GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::Convert(::BeatmapSaveDataVersion3::__BeatmapSaveData__EventBoxGroup* eventBoxGroupSaveData) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__EventBoxGroup*>::get() })));
...
// Ctor Parameters []
constexpr ::GlobalNamespace::__BeatmapDataLoader__LightEventBoxGroupConvertor::__BeatmapDataLoader__LightEventBoxGroupConvertor() {}
//  Writing Method size for method: ::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor._ctor
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::*)(
    ::GlobalNamespace::IEnvironmentLightGroups*, ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*)>(&::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::_ctor)> {
  constexpr static std::size_t size = 0x134;
  constexpr static std::size_t addrs = 0x2333200;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::IEnvironmentLightGroups*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
    static_cast<::GlobalNamespace::BeatmapEventDataBoxGroup* (::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventBoxGroup*)>(
        &::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::Convert)> {
  constexpr static std::size_t size = 0x560;
  constexpr static std::size_t addrs = 0x2333334;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventBoxGroup*>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::__cordl_internal_get__convertors() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____convertors;
}
...
GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::__cordl_internal_get__convertors() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____convertors;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::__cordl_internal_set__convertors(
...
constexpr ::GlobalNamespace::IEnvironmentLightGroups*& GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::__cordl_internal_get__lightGroups() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____lightGroups;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IEnvironmentLightGroups*> const&
GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::__cordl_internal_get__lightGroups() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____lightGroups;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::__cordl_internal_set__lightGroups(::GlobalNamespace::IEnvironmentLightGroups* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____lightGroups)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
inline ::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor*
GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::New_ctor(::GlobalNamespace::IEnvironmentLightGroups* lightGroups,
                                                                          ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection* fxEventsCollection) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor*>(lightGroups, fxEventsCollection));
}
inline void GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::_ctor(::GlobalNamespace::IEnvironmentLightGroups* lightGroups,
                                                                                   ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection* fxEventsCollection) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::IEnvironmentLightGroups*>::get(),
...
inline ::GlobalNamespace::BeatmapEventDataBoxGroup*
GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::Convert(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventBoxGroup* eventBoxGroupSaveData) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventBoxGroup*>::get() })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::BeatmapEventDataBoxGroup*, false>(this, ___internal_method, eventBoxGroupSaveData);
...
// Ctor Parameters []
constexpr ::GlobalNamespace::__BeatmapDataLoader__VfxEventBoxGroupConvertor::__BeatmapDataLoader__VfxEventBoxGroupConvertor() {}
//  Writing Method size for method: ::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor._ctor
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::*)(
    ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*)>(&::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::_ctor)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x2334ca4;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IntVfxBeatmapEventDataBox* (
    ::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventBox*, ::GlobalNamespace::ILightGroup*)>(
    &::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::Convert)> {
  ...
  inline static ::MethodInfo const* methodInfo() {
    ...
    static auto* ___internal_method =
        THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor*>::get(),
                                                       ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor*>::get(), 6));
    return ___internal_method;
  }
};
constexpr ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*& GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::__cordl_internal_get__fxEventsCollection() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::__cordl_internal_get__fxEventsCollection() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____fxEventsCollection;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::__cordl_internal_set__fxEventsCollection(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::New_ctor(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection* fxEventsCollection) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor*>(fxEventsCollection));
}
...
inline ::GlobalNamespace::IntVfxBeatmapEventDataBox* GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::Convert(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventBox* saveData,
...
// Ctor Parameters []
constexpr ::GlobalNamespace::__BeatmapDataLoader__IntVfxEventBoxConvertor::__BeatmapDataLoader__IntVfxEventBoxConvertor() {}
//  Writing Method size for method: ::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor._ctor
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::*)(
    ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*)>(&::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::_ctor)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x2334c48;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::FloatFxBeatmapEventDataBox* (
    ::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventBox*, ::GlobalNamespace::ILightGroup*)>(
    &::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::Convert)> {
  constexpr static std::size_t size = 0x540;
  ...
  inline static ::MethodInfo const* methodInfo() {
    ...
    static auto* ___internal_method =
        THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor*>::get(),
                                                       ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor*>::get(), 6));
    return ___internal_method;
  }
};
constexpr ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*& GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::__cordl_internal_get__fxEventsCollection() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____fxEventsCollection;
}
constexpr ::cordl_internals::to_const_pointer<::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*> const&
GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::__cordl_internal_get__fxEventsCollection() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____fxEventsCollection;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::__cordl_internal_set__fxEventsCollection(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____fxEventsCollection)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
inline ::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor*
GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::New_ctor(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection* fxEventsCollection) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor*>(fxEventsCollection));
}
...
inline ::GlobalNamespace::FloatFxBeatmapEventDataBox* GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::Convert(::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventBox* saveData,
                                                                                                                               ::GlobalNamespace::ILightGroup* lightGroup) {
  auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                                                      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor*>::get(), 6)));
...
// Ctor Parameters []
constexpr ::GlobalNamespace::__BeatmapDataLoader__FloatVfxEventBoxConvertor::__BeatmapDataLoader__FloatVfxEventBoxConvertor() {}
//  Writing Method size for method: ::GlobalNamespace::__BeatmapDataLoader__IntVfxBaseDataConvertor.Convert
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IntFxBaseData* (*)(int32_t, ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*)>(
    &::GlobalNamespace::__BeatmapDataLoader__IntVfxBaseDataConvertor::Convert)> {
  constexpr static std::size_t size = 0x118;
  constexpr static std::size_t addrs = 0x23355bc;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__IntVfxBaseDataConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(),
                                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*>::get() })));
    return ___internal_method;
  }
};
inline ::GlobalNamespace::IntFxBaseData* GlobalNamespace::__BeatmapDataLoader__IntVfxBaseDataConvertor::Convert(int32_t vfxEventBaseData,
                                                                                                                ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection* collection) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__IntVfxBaseDataConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(),
                                          ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*>::get() })));
...
// Ctor Parameters []
constexpr ::GlobalNamespace::__BeatmapDataLoader__IntVfxBaseDataConvertor::__BeatmapDataLoader__IntVfxBaseDataConvertor() {}
//  Writing Method size for method: ::GlobalNamespace::__BeatmapDataLoader__FloatVfxBaseDataConvertor.Convert
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::FloatFxBaseData* (*)(int32_t, ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*)>(
    &::GlobalNamespace::__BeatmapDataLoader__FloatVfxBaseDataConvertor::Convert)> {
  constexpr static std::size_t size = 0x128;
  constexpr static std::size_t addrs = 0x2335e1c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__FloatVfxBaseDataConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(),
                                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection*>::get() })));
    return ___internal_method;
  }
};
inline ::GlobalNamespace::FloatFxBaseData* GlobalNamespace::__BeatmapDataLoader__FloatVfxBaseDataConvertor::Convert(int32_t vfxEventBaseData,
                                                                                                                    ::BeatmapSaveDataVersion3::__BeatmapSaveData__FxEventsCollection* collection) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__FloatVfxBaseDataConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(),
...
// Ctor Parameters []
constexpr ::GlobalNamespace::__BeatmapDataLoader__FloatVfxBaseDataConvertor::__BeatmapDataLoader__FloatVfxBaseDataConvertor() {}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IndexFilter* (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__IndexFilter*, int32_t)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__IndexFilterConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__IndexFilter*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__IndexFilter*, int32_t)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__IndexFilterConvertor*>::get(), "IsIndexFilterValid", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__IndexFilter*>::get(),
                                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get() })));
    return ___internal_method;
  }
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::LightColorBeatmapEventDataBox* (
    ::GlobalNamespace::__BeatmapDataLoader__LightColorEventBoxConvertor::*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__LightColorEventBox*, ::GlobalNamespace::ILightGroup*)>(
...
GlobalNamespace::__BeatmapDataLoader__LightColorEventBoxConvertor::Convert(::BeatmapSaveDataVersion3::__BeatmapSaveData__LightColorEventBox* saveData, ::GlobalNamespace::ILightGroup* lightGroupData) {
  auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                                                      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__LightColorEventBoxConvertor*>::get(), 6)));
...
inline ::GlobalNamespace::__BeatmapDataLoader__LightColorEventBoxConvertor* GlobalNamespace::__BeatmapDataLoader__LightColorEventBoxConvertor::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__LightColorEventBoxConvertor*>());
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::LightColorBaseData* (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__LightColorBaseData*)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__LightColoBaseDataConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__LightColorBaseData*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::LightRotationBeatmapEventDataBox* (
    ::GlobalNamespace::__BeatmapDataLoader__LightRotationEventBoxConvertor::*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__LightRotationEventBox*, ::GlobalNamespace::ILightGroup*)>(
...
inline ::GlobalNamespace::__BeatmapDataLoader__LightRotationEventBoxConvertor* GlobalNamespace::__BeatmapDataLoader__LightRotationEventBoxConvertor::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__LightRotationEventBoxConvertor*>());
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::LightRotationBaseData* (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__LightRotationBaseData*)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__LightRotationBaseDataConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__LightRotationBaseData*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::LightTranslationBeatmapEventDataBox* (
    ::GlobalNamespace::__BeatmapDataLoader__LightTranslationEventBoxConvertor::*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__LightTranslationEventBox*, ::GlobalNamespace::ILightGroup*)>(
...
inline ::GlobalNamespace::__BeatmapDataLoader__LightTranslationEventBoxConvertor* GlobalNamespace::__BeatmapDataLoader__LightTranslationEventBoxConvertor::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__LightTranslationEventBoxConvertor*>());
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__LightTranslationBaseDataConvertor*>::get(), "Convert", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__LightTranslationBaseData*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__ObstacleConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__ObstacleConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::NoteLineLayer (*)(int32_t)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__ObstacleConvertor*>::get(), "GetNoteLineLayer",
...
GlobalNamespace::__BeatmapDataLoader__ObstacleConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__ObstacleConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__RotationEventConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__RotationEventConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType (*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__RotationEventConvertor*>::get(), "SpawnRotationEventType",
                                    std::span<Il2CppClass const* const, 0>(),
                                    ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__ExecutionTime>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__RotationEventConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__RotationEventConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__SliderConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__SliderConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__SliderConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__SliderConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__BurstSliderConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__BurstSliderConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__BurstSliderConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__BurstSliderConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__WaypointConvertor::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__WaypointConvertor*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor*>::get() })));
    return ___internal_method;
  }
};
...
GlobalNamespace::__BeatmapDataLoader__WaypointConvertor::New_ctor(::GlobalNamespace::__BeatmapDataLoader__BpmTimeProcessor* bpmTimeProcessor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__WaypointConvertor*>(bpmTimeProcessor));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__BasicEventTypesWithKeywords*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter*>::get(), "IsEventValid", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion2_6_0AndEarlier::__BeatmapSaveData__BeatmapEventType>::get() })));
    return ___internal_method;
  }
};
constexpr ::System::Collections::Generic::HashSet_1<::BeatmapSaveDataVersion2_6_0AndEarlier::__BeatmapSaveData__BeatmapEventType>*&
GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter::__cordl_internal_get__eventTypesToFilter() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter::__cordl_internal_get__eventTypesToFilter() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____eventTypesToFilter;
}
constexpr void GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter::__cordl_internal_set__eventTypesToFilter(
...
GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter::New_ctor(::BeatmapSaveDataVersion3::__BeatmapSaveData__BasicEventTypesWithKeywords* basicEventTypesWithKeywords,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataLoader__SpecialEventsFilter*>(basicEventTypesWithKeywords, environmentKeywords));
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<
    ::GlobalNamespace::BeatmapData* (*)(::BeatmapSaveDataVersion3::BeatmapSaveData*, ::GlobalNamespace::BeatmapDifficulty, float_t, bool, ::GlobalNamespace::EnvironmentKeywords*,
                                        ::GlobalNamespace::IEnvironmentLightGroups*, ::GlobalNamespace::DefaultEnvironmentEvents*, ::BeatmapSaveDataVersion3::BeatmapLightshowSaveData*,
                                        ::GlobalNamespace::PlayerSpecificSettings*, ::System::Diagnostics::Stopwatch*)>(&::GlobalNamespace::BeatmapDataLoader::GetBeatmapDataFromBeatmapSaveData)> {
  constexpr static std::size_t size = 0x1460;
  constexpr static std::size_t addrs = 0x2330c34;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "GetBeatmapDataFromBeatmapSaveData", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 10>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::BeatmapSaveData*>::get(),
                                             ...
                                             ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::BeatmapLightshowSaveData*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapDataBasicInfo* (*)(::BeatmapSaveDataVersion3::BeatmapSaveData*)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "GetBeatmapDataBasicInfoFromSaveData", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::BeatmapSaveData*>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "GetBeatmapDataFromSaveData", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 6>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::BeatmapSaveData*>::get(),
                                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::BeatmapDifficulty>::get(),
                                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::ColorType (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__NoteColorType)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "ConvertColorType", std::span<Il2CppClass const* const, 0>(),
                                    ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__NoteColorType>::get() })));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::GlobalNamespace::BeatmapDataLoader.ConvertColorType
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::EnvironmentColorType (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__EnvironmentColorType)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "ConvertColorType", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__EnvironmentColorType>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapEventTransitionType (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__TransitionType)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "ConvertBeatmapEventTransitionType", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__TransitionType>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::LightAxis (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__Axis)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "ConvertAxis", std::span<Il2CppClass const* const, 0>(),
                                    ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__Axis>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::EaseType (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__EaseType)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "ConvertEaseType", std::span<Il2CppClass const* const, 0>(),
                                    ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__EaseType>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::NoteLineLayer (*)(int32_t)>(&::GlobalNamespace::BeatmapDataLoader::ConvertNoteLineLayer)> {
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "ConvertNoteLineLayer",
                                    std::span<Il2CppClass const* const, 0>(), ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__SliderData__Type (*)(::BeatmapSaveDataVersion3::__BeatmapSaveData__SliderType)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "ConvertSliderType", std::span<Il2CppClass const* const, 0>(),
                                    ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatmapSaveDataVersion3::__BeatmapSaveData__SliderType>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::LightRotationDirection (*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataLoader*>::get(), "ConvertRotationOrientation", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapSaveData__LightRotationBaseData__RotationDirection>::get() })));
    return ___internal_method;
  }
};
...
inline ::GlobalNamespace::BeatmapData* GlobalNamespace::BeatmapDataLoader::GetBeatmapDataFromBeatmapSaveData(
    ...
    ::GlobalNamespace::DefaultEnvironmentEvents* defaultEnvironmentEvents, ::BeatmapSaveDataVersion3::BeatmapLightshowSaveData* defaultLightshowEventsSaveData,
  ...
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::BeatmapData*, false>(nullptr, ___internal_method, beatmapSaveData, beatmapDifficulty, startBpm, loadingForDesignatedEnvironment,
                                                                                     environmentKeywords, environmentLightGroups, defaultEnvironmentEvents, defaultLightshowEventsSaveData,
                                                                                     playerSpecificSettings, stopwatch);
}
