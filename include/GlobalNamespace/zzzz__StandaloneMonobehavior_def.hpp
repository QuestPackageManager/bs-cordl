...
public:
  ...
  /// @brief Method MoveNext, addr 0x22e96a0, size 0x1b0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::StandaloneMonobehavior__RunAsyncCoroutine_d__25* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x22e9850, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x22e9858, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x22e9890, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x22e969c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22e9674, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22e9898, size 0x200, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22e9a98, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22e9aa4, size 0x308, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22e9dac, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Awake, addr 0x22e9328, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Create, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline T Create();

  /// @brief Method GetLastFrameTime, addr 0x22e9268, size 0x70, virtual false, abstract: false, final false
  inline float_t GetLastFrameTime();

  static inline ::GlobalNamespace::StandaloneMonobehavior* New_ctor();

  /// @brief Method OnApplicationPause, addr 0x22e9350, size 0x4, virtual true, abstract: false, final false
  inline void OnApplicationPause(bool pauseStatus);

  /// @brief Method OnDestroy, addr 0x22e934c, size 0x4, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RunAsync, addr 0x22e94bc, size 0x13c, virtual true, abstract: false, final true
  ...
  /// @brief Method RunAsyncCoroutine, addr 0x22e95f8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x22e9344, size 0x4, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method Stop, addr 0x22e966c, size 0x8, virtual true, abstract: false, final true
  inline void Stop();

  /// @brief Method Update, addr 0x22e9348, size 0x4, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method WhenReady, addr 0x22e9354, size 0x98, virtual true, abstract: false, final true
  inline void WhenReady(::System::Action* action);

  /// @brief Method WhenReadyAsync, addr 0x22e93ec, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22dd4bc, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_deltaTime, addr 0x22e925c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_deltaTime();

  /// @brief Method get_frameCount, addr 0x22db5ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_frameCount();

  /// @brief Method get_isReady, addr 0x22e92d8, size 0x50, virtual false, abstract: false, final false
  inline bool get_isReady();

  /// @brief Method get_lastFrameTime, addr 0x22e9264, size 0x4, virtual false, abstract: false, final false
  inline float_t get_lastFrameTime();

  /// @brief Method get_objectLifeTime, addr 0x22e923c, size 0x20, virtual false, abstract: false, final false
