...
public:
  // Declarations
  /// @brief Method SetUpPacket, addr 0xebec60, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUpPacket, addr 0xebec64, size 0x4c, virtual false, abstract: false, final false
