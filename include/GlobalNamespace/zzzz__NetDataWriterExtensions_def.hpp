...
public:
  // Declarations
  /// @brief Method SetUpPacket, addr 0x22dbd9c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUpPacket, addr 0x22dbda0, size 0x4c, virtual false, abstract: false, final false
