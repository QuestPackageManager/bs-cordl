...
public:
  // Declarations
  /// @brief Method SetUpPacket, addr 0xedf368, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUpPacket, addr 0xedf36c, size 0x4c, virtual false, abstract: false, final false
