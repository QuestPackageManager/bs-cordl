...
public:
  // Declarations
  /// @brief Method SetUpPacket, addr 0x22dd798, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUpPacket, addr 0x22dd79c, size 0x4c, virtual false, abstract: false, final false
