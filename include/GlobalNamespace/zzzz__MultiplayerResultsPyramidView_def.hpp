...
public:
  ...
  /// @brief Method PrespawnAvatars, addr 0x3be0680, size 0x3fc, virtual false, abstract: false, final false
  inline void PrespawnAvatars(::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IConnectedPlayer*>* activePlayers);

  /// @brief Method SetupResults, addr 0x3be008c, size 0x5d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3be2ba4, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_badgeTimelines, addr 0x3be2194, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::GameObject>, ::Array<::UnityW<::UnityEngine::GameObject>>*> get_badgeTimelines();

  /// @brief Method get_resultAvatarDirectors, addr 0x3be218c, size 0x8, virtual false, abstract: false, final false
