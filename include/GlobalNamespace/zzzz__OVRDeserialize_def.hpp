...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColocationSessionDiscoveryResultData_OVRDeserialize__AdvertisementMetadata_e__FixedBuffer, "",
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRDeserialize_ColocationSessionAdvertisementCompleteData, "", "OVRDeserialize/ColocationSessionAdvertisementCompleteData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRDeserialize_ColocationSessionDiscoveryCompleteData, "", "OVRDeserialize/ColocationSessionDiscoveryCompleteData");
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRDeserialize_ShareSpacesToGroupsCompleteData, "", "OVRDeserialize/ShareSpacesToGroupsCompleteData");
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRDeserialize_SpaceListSaveResultData, "", "OVRDeserialize/SpaceListSaveResultData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRDeserialize_SpaceQueryCompleteData, "", "OVRDeserialize/SpaceQueryCompleteData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRDeserialize_SpaceQueryResultsData, "", "OVRDeserialize/SpaceQueryResultsData");
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRDeserialize_StartColocationSessionDiscoveryCompleteData, "", "OVRDeserialize/StartColocationSessionDiscoveryCompleteData");
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRDeserialize_StopColocationSessionDiscoveryCompleteData, "", "OVRDeserialize/StopColocationSessionDiscoveryCompleteData");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::OVRDeserialize_SpaceQueryResultsData) == 0x8, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::OVRDeserialize_SpaceListSaveResultData) == 0x10, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::OVRDeserialize_StartColocationSessionDiscoveryCompleteData) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::OVRDeserialize_ColocationSessionAdvertisementCompleteData) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::OVRDeserialize_ColocationSessionDiscoveryCompleteData) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::OVRDeserialize_ShareSpacesToGroupsCompleteData) == 0x18, "Size mismatch!");
