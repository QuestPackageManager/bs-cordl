...
/// @brief Method BeginOperation, addr 0x3230e50, size 0x78, virtual true, abstract: false, final true
inline void BeginOperation(::GlobalNamespace::AsyncComputeOperation*  operation) ;

/// @brief Method ComputeThreadRun, addr 0x3230ec8, size 0x170, virtual false, abstract: false, final false
inline void ComputeThreadRun() ;

/// @brief Method Dispose, addr 0x3230de4, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x3230c94, size 0x150, virtual false, abstract: false, final false
inline void _ctor() ;
