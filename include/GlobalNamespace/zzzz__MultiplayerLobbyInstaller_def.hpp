...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59fe694, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fe7a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerLobbyInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerLobbyInstaller(MultiplayerLobbyInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerLobbyInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerLobbyInstaller(MultiplayerLobbyInstallerconst&) = delete;
