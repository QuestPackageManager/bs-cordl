...
// Write type traits
MARK_REF_T(::GlobalNamespace::IGameNoteMirrorable*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IGameNoteMirrorable*, "", "IGameNoteMirrorable");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IGameNoteMirrorable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IGameNoteMirrorable(IGameNoteMirrorableconst&) = delete;
