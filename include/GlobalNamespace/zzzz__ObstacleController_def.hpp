...
public:
  ...
  /// @brief Method OnCreated, addr 0x3af1578, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af1618, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3af1664, size 0xe4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::ObstacleController__DissolveCoroutine_d__64* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3af1748, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3af1750, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3af1788, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3af1660, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3af148c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dissolve, addr 0x3af14b4, size 0x38, virtual true, abstract: false, final true
  inline void Dissolve(float_t duration);

  /// @brief Method DissolveCoroutine, addr 0x3af141c, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* DissolveCoroutine(float_t duration);

  /// @brief Method GetObstacleLength, addr 0x3af12e8, size 0x134, virtual false, abstract: false, final false
  inline float_t GetObstacleLength();

  /// @brief Method GetPosForTime, addr 0x3af1058, size 0x290, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPosForTime(float_t time);

  /// @brief Method Hide, addr 0x3af14ec, size 0x6c, virtual true, abstract: false, final true
  inline void Hide(bool hide);

  /// @brief Method Init, addr 0x3af0324, size 0x4a4, virtual true, abstract: false, final false
  inline void Init(::GlobalNamespace::ObstacleData* obstacleData, ::ByRef<::GlobalNamespace::ObstacleSpawnData> obstacleSpawnData);

  /// @brief Method InitGraphics, addr 0x3af07c8, size 0x48, virtual false, abstract: false, final false
  inline void InitGraphics(::BeatSaber::Settings::Settings settings);

  /// @brief Method ManualUpdate, addr 0x3af0850, size 0x808, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::GlobalNamespace::ObstacleController* New_ctor();

  /// @brief Method Pause, addr 0x3af1558, size 0x10, virtual true, abstract: false, final true
  inline void Pause(bool pause);

  /// @brief Method Update, addr 0x3af084c, size 0x4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method get_color, addr 0x3af0318, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_hasPassedAvoidedMark, addr 0x3af02f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasPassedAvoidedMark();

  /// @brief Method get_height, addr 0x3af0308, size 0x8, virtual false, abstract: false, final false
  inline float_t get_height();

  /// @brief Method get_length, addr 0x3af0310, size 0x8, virtual false, abstract: false, final false
  inline float_t get_length();

  /// @brief Method get_manualUvOffset, addr 0x3aef2f0, size 0xa0, virtual false, abstract: false, final false
  inline float_t get_manualUvOffset();

  /// @brief Method get_obstacleData, addr 0x3af02f0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ObstacleData* get_obstacleData();

  /// @brief Method get_width, addr 0x3af0300, size 0x8, virtual false, abstract: false, final false
