...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14394), inst: 293 }), TypeDefinitionIndex(TypeDefinitionIndex(14394)),
// TypeDefinitionIndex(TypeDefinitionIndex(10251))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14391)) CS Name: ::ColorSignal*
