...
public:
  ...
  /// @brief Method .ctor, addr 0x3afe5b0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x3afdd68, size 0xe0, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBeforeNoteWasCutBySaber, addr 0x3afdfe4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCoreWasCutBySaber, addr 0x3afe0f0, size 0x488, virtual false, abstract: false, final false
  ...
  /// @brief Method HiddenStateDidChange, addr 0x3afe578, size 0x24, virtual true, abstract: false, final false
  inline void HiddenStateDidChange(bool hide);

  /// @brief Method Init, addr 0x3afdcd0, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method NoteDidPassMissedMarker, addr 0x3afdf9c, size 0x48, virtual true, abstract: false, final false
  inline void NoteDidPassMissedMarker();

  /// @brief Method OnDestroy, addr 0x3afde48, size 0x154, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x3afe59c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3afe5ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameplayType, addr 0x3afdcc8, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::NoteData_GameplayType get_gameplayType();

  /// @brief Method get_noteMovement, addr 0x3afdcb8, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement();

  /// @brief Method get_noteVisualModifierType, addr 0x3afdcc0, size 0x8, virtual true, abstract: false, final true
