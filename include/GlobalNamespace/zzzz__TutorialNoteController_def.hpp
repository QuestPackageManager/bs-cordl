...
public:
  ...
  /// @brief Method .ctor, addr 0x263bf18, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x263b754, size 0xe8, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBeforeNoteWasCutBySaber, addr 0x263b9e0, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCoreWasCutBySaber, addr 0x263baec, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method HiddenStateDidChange, addr 0x263bee0, size 0x24, virtual true, abstract: false, final false
  inline void HiddenStateDidChange(bool hide);

  /// @brief Method Init, addr 0x263b654, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method NoteDidPassMissedMarker, addr 0x263b998, size 0x48, virtual true, abstract: false, final false
  inline void NoteDidPassMissedMarker();

  /// @brief Method OnDestroy, addr 0x263b83c, size 0x15c, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x263bf04, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263bf14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameplayType, addr 0x263b64c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__NoteData__GameplayType get_gameplayType();

  /// @brief Method get_noteMovement, addr 0x263b63c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement();

  /// @brief Method get_noteVisualModifierType, addr 0x263b644, size 0x8, virtual true, abstract: false, final true
