...
/// @brief Method CalculateBadgeData, addr 0x36370d8, size 0x560, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x363774c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
