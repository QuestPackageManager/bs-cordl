...
public:
  ...
  /// @brief Method Deserialize, addr 0x14140fc, size 0x1b4, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x1413dc0, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x1413d5c, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::NoteSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x1413f58, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1413f00, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
