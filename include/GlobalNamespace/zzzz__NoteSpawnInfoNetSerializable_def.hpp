...
/// @brief Method Deserialize, addr 0x367f410, size 0x210, virtual true, abstract: false, final false
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x367ef6c, size 0x118, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteSpawnInfoNetSerializable* Init(float_t  time, float_t  beat, int32_t  lineIndex, ::GlobalNamespace::NoteLineLayer  noteLineLayer, ::GlobalNamespace::NoteLineLayer  beforeJumpNoteLineLayer, ::GlobalNamespace::NoteData_GameplayType  gameplayType, ::GlobalNamespace::NoteData_ScoringType  scoringType, ::GlobalNamespace::ColorType  colorType, ::GlobalNamespace::NoteCutDirection  cutDirection, float_t  timeToNextColorNote, float_t  timeToPrevColorNote, int32_t  flipLineIndex, float_t  flipYSide, ::UnityEngine::Vector3  moveStartOffset, ::UnityEngine::Vector3  moveEndOffset, ::UnityEngine::Vector3  jumpEndOffset, float_t  gravityBase, float_t  rotation, float_t  cutDirectionAngleOffset, float_t  cutSfxVolumeMultiplier) ;

static inline ::GlobalNamespace::NoteSpawnInfoNetSerializable* New_ctor() ;

/// @brief Method Obtain, addr 0x367ef00, size 0x6c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::NoteSpawnInfoNetSerializable* Obtain() ;

/// @brief Method Serialize, addr 0x367f0dc, size 0x334, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x367f084, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
