...
public:
  ...
  /// @brief Method Deserialize, addr 0x36bc158, size 0x210, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x36bbcb4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x36bbc48, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::NoteSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x36bbe24, size 0x334, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36bbdcc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
