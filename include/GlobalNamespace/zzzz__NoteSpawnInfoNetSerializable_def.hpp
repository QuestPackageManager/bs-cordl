...
public:
  ...
  /// @brief Method Deserialize, addr 0x150bb8c, size 0x1b4, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x150b850, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x150b7ec, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::NoteSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x150b9e8, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x150b990, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
