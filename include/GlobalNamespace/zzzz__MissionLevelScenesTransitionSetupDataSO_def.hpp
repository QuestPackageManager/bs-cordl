...
public:
  ...
  /// @brief Method Finish, addr 0x57f0b08, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::MissionCompletionResults* levelCompletionResults);

  /// @brief Method Init, addr 0x57ea77c, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57f0b30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x57edb34, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapKey, addr 0x57f0af0, size 0xc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_missionId, addr 0x57f0ae0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_missionId();

  /// @brief Method remove_didFinishEvent, addr 0x57ee030, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_beatmapKey, addr 0x57f0afc, size 0xc, virtual false, abstract: false, final false
  inline void set_beatmapKey(::GlobalNamespace::BeatmapKey value);

  /// @brief Method set_missionId, addr 0x57f0ae8, size 0x8, virtual false, abstract: false, final false
