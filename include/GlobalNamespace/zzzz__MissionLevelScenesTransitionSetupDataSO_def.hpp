...
public:
  ...
  /// @brief Method Finish, addr 0x3b3ea04, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::MissionCompletionResults* levelCompletionResults);

  /// @brief Method Init, addr 0x3b3d174, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x3b38f34, size 0x3c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3ea2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b3c0a0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_missionId, addr 0x3b3e9f4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_missionId();

  /// @brief Method remove_didFinishEvent, addr 0x3b3c580, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_missionId, addr 0x3b3e9fc, size 0x8, virtual false, abstract: false, final false
