...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x3c2a230, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c2a17c, size 0xb4, virtual false, abstract: false, final false
