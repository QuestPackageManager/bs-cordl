...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x5a80210, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a8016c, size 0xa4, virtual false, abstract: false, final false
