...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x3c2bc64, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c2bbb0, size 0xb4, virtual false, abstract: false, final false
