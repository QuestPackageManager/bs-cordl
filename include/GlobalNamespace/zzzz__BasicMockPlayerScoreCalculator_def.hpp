...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x5945e20, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5945d7c, size 0xa4, virtual false, abstract: false, final false
