...
/// @brief Method GetScoreForNote, addr 0x58d3eb4, size 0x74, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x58d3e10, size 0xa4, virtual false, abstract: false, final false
