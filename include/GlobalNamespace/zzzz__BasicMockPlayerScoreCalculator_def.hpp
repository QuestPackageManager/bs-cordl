...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x3c252bc, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c25208, size 0xb4, virtual false, abstract: false, final false
