...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x3c2a1b8, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c2a104, size 0xb4, virtual false, abstract: false, final false
