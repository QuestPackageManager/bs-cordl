...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x5a82510, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a8246c, size 0xa4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BasicMockPlayerScoreCalculator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BasicMockPlayerScoreCalculator(BasicMockPlayerScoreCalculator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BasicMockPlayerScoreCalculator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BasicMockPlayerScoreCalculator(BasicMockPlayerScoreCalculatorconst&) = delete;
