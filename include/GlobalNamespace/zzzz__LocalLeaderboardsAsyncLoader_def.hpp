...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x3775f14, size 0x4, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstallAsync, addr 0x3775eb4, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3775f18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocalLeaderboardsAsyncLoader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocalLeaderboardsAsyncLoader(LocalLeaderboardsAsyncLoader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocalLeaderboardsAsyncLoader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocalLeaderboardsAsyncLoader(LocalLeaderboardsAsyncLoaderconst&) = delete;
