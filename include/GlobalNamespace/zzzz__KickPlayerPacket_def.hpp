...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KickPlayerPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KickPlayerPacket(KickPlayerPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KickPlayerPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KickPlayerPacket(KickPlayerPacketconst&) = delete;
