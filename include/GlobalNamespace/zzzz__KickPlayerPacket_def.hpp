...
// Write type traits
MARK_REF_T(::GlobalNamespace::KickPlayerPacket*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::KickPlayerPacket*, "", "KickPlayerPacket");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x332bb20, size 0x2c, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x332baf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x332bb4c, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x332baf8, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x332bba4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x332baac, size 0x44, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::KickPlayerPacket) == 0x18, "Size mismatch!");
