...
public:
  ...
  /// @brief Method .ctor, addr 0x2731d80, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x2731d34, size 0x20, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::MultiplayerResultsPyramidViewAvatar* New_ctor();

  /// @brief Method Setup, addr 0x273181c, size 0x48c, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::MultiplayerPlayerResultsData* resultData, int32_t position, int32_t playerCount);

  /// @brief Method SetupBadgeTimeline, addr 0x27312a0, size 0x57c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2731d54, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_badgeDirector, addr 0x2731d2c, size 0x8, virtual false, abstract: false, final false
