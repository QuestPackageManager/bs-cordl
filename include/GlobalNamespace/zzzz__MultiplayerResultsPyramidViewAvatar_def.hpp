...
class CORDL_TYPE MultiplayerResultsPyramidViewAvatar_Factory : public ::Zenject::PlaceholderFactory_2<::GlobalNamespace::IBeatSaberConnectedPlayer*,::UnityW<::GlobalNamespace::MultiplayerResultsPyramidViewAvatar>> {
public:
// Declarations
static inline ::GlobalNamespace::MultiplayerResultsPyramidViewAvatar_Factory* New_ctor() ;

/// @brief Method .ctor, addr 0x5839a18, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x58399d8, size 0x1c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::MultiplayerResultsPyramidViewAvatar* New_ctor() ;

/// @brief Method Setup, addr 0x583943c, size 0x4f0, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::MultiplayerPlayerResultsData*  resultData, int32_t  position, int32_t  playerCount) ;

/// @brief Method SetupBadgeTimeline, addr 0x5838ef4, size 0x548, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58399f4, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_badgeDirector, addr 0x58399d0, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MultiplayerResultsPyramidViewAvatar, 0x1e8>, "Size mismatch!");
