...
// Write type traits
MARK_REF_T(::GlobalNamespace::IGameplayColorScheme*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IGameplayColorScheme*, "", "IGameplayColorScheme");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method get_obstaclesColor, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::UnityEngine::Color get_obstaclesColor();

  /// @brief Method get_overrideNotes, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline bool get_overrideNotes();

  /// @brief Method get_saberAColor, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::UnityEngine::Color get_saberAColor();

  /// @brief Method get_saberBColor, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::UnityEngine::Color get_saberBColor();

  // Ctor Parameters [CppParam { name: "", ty: "IGameplayColorScheme", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IGameplayColorScheme(IGameplayColorSchemeconst&) = delete;
