...
/// @brief Method Load, addr 0x5ca92b8, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method get_MaximumBufferSamplesCount, addr 0x5caa580, size 0x5c, virtual false, abstract: false, final false
static inline int32_t get_MaximumBufferSamplesCount() ;

/// @brief Method get_MinimumBufferSamplesCount, addr 0x5caa408, size 0x5c, virtual false, abstract: false, final false
static inline int32_t get_MinimumBufferSamplesCount() ;

/// @brief Method get_MinimumSafeSamplesQueued, addr 0x5caa34c, size 0x5c, virtual false, abstract: false, final false
static inline int32_t get_MinimumSafeSamplesQueued() ;

/// @brief Method get_OptimalBufferSamplesCount, addr 0x5caa4c4, size 0x5c, virtual false, abstract: false, final false
static inline int32_t get_OptimalBufferSamplesCount() ;

/// @brief Method get_SampleRateHz, addr 0x5caa1d4, size 0x5c, virtual false, abstract: false, final false
static inline int32_t get_SampleRateHz() ;

/// @brief Method get_SampleSizeInBytes, addr 0x5caa290, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method set_MaximumBufferSamplesCount, addr 0x5caa5dc, size 0x60, virtual false, abstract: false, final false
static inline void set_MaximumBufferSamplesCount(int32_t  value) ;

/// @brief Method set_MinimumBufferSamplesCount, addr 0x5caa464, size 0x60, virtual false, abstract: false, final false
static inline void set_MinimumBufferSamplesCount(int32_t  value) ;

/// @brief Method set_MinimumSafeSamplesQueued, addr 0x5caa3a8, size 0x60, virtual false, abstract: false, final false
static inline void set_MinimumSafeSamplesQueued(int32_t  value) ;

/// @brief Method set_OptimalBufferSamplesCount, addr 0x5caa520, size 0x60, virtual false, abstract: false, final false
static inline void set_OptimalBufferSamplesCount(int32_t  value) ;

/// @brief Method set_SampleRateHz, addr 0x5caa230, size 0x60, virtual false, abstract: false, final false
static inline void set_SampleRateHz(int32_t  value) ;

/// @brief Method set_SampleSizeInBytes, addr 0x5caa2ec, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x5caad50, size 0x14, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Mix, addr 0x5caa860, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Preempt, addr 0x5caa640, size 0x14, virtual false, abstract: false, final false
inline void Preempt(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method Queue, addr 0x5caa770, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5ca967c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5caaddc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method get_Clip, addr 0x5cab014, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRHapticsClip* get_Clip() ;

/// @brief Method get_ReadCount, addr 0x5cab004, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ReadCount() ;

/// @brief Method set_Clip, addr 0x5cab01c, size 0x8, virtual false, abstract: false, final false
inline void set_Clip(::GlobalNamespace::OVRHapticsClip*  value) ;

/// @brief Method set_ReadCount, addr 0x5cab00c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field m_pendingClips, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_pendingClips, put=__cordl_internal_set_m_pendingClips)) ::System::Collections::Generic::List_1<::GlobalNamespace::OVRHapticsOutput_OVRHaptics_ClipPlaybackTracker*>*  m_pendingClips;
...
/// @brief Method Clear, addr 0x5caad64, size 0x78, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Mix, addr 0x5caa874, size 0x4dc, virtual false, abstract: false, final false
inline void Mix(::GlobalNamespace::OVRHapticsClip*  clip) ;

static inline ::GlobalNamespace::OVRHaptics_OVRHapticsOutput* New_ctor(uint32_t  controller) ;

/// @brief Method Preempt, addr 0x5caa654, size 0x11c, virtual false, abstract: false, final false
inline void Preempt(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method Process, addr 0x5ca97f0, size 0x9e4, virtual false, abstract: false, final false
inline void Process() ;

/// @brief Method Queue, addr 0x5caa784, size 0xdc, virtual false, abstract: false, final false
inline void Queue(::GlobalNamespace::OVRHapticsClip*  clip) ;
...
/// @brief Method .ctor, addr 0x5ca94f8, size 0x184, virtual false, abstract: false, final false
...
/// @brief Field Channels, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Channels, put=setStaticF_Channels)) ::ArrayW<::GlobalNamespace::OVRHaptics_OVRHapticsChannel*,::Array<::GlobalNamespace::OVRHaptics_OVRHapticsChannel*>*>  Channels;
...
/// @brief Field m_outputs, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_outputs, put=setStaticF_m_outputs)) ::ArrayW<::GlobalNamespace::OVRHaptics_OVRHapticsOutput*,::Array<::GlobalNamespace::OVRHaptics_OVRHapticsOutput*>*>  m_outputs;

/// @brief Method Process, addr 0x5ca970c, size 0xe4, virtual false, abstract: false, final false
