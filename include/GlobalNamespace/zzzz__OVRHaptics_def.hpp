...
public:
  ...
  /// @brief Method Load, addr 0x5d1b2a0, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MaximumBufferSamplesCount, addr 0x5d1c568, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_MaximumBufferSamplesCount();

  /// @brief Method get_MinimumBufferSamplesCount, addr 0x5d1c3f0, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_MinimumBufferSamplesCount();

  /// @brief Method get_MinimumSafeSamplesQueued, addr 0x5d1c334, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_MinimumSafeSamplesQueued();

  /// @brief Method get_OptimalBufferSamplesCount, addr 0x5d1c4ac, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_OptimalBufferSamplesCount();

  /// @brief Method get_SampleRateHz, addr 0x5d1c1bc, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_SampleRateHz();

  /// @brief Method get_SampleSizeInBytes, addr 0x5d1c278, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_MaximumBufferSamplesCount, addr 0x5d1c5c4, size 0x60, virtual false, abstract: false, final false
  static inline void set_MaximumBufferSamplesCount(int32_t value);

  /// @brief Method set_MinimumBufferSamplesCount, addr 0x5d1c44c, size 0x60, virtual false, abstract: false, final false
  static inline void set_MinimumBufferSamplesCount(int32_t value);

  /// @brief Method set_MinimumSafeSamplesQueued, addr 0x5d1c390, size 0x60, virtual false, abstract: false, final false
  static inline void set_MinimumSafeSamplesQueued(int32_t value);

  /// @brief Method set_OptimalBufferSamplesCount, addr 0x5d1c508, size 0x60, virtual false, abstract: false, final false
  static inline void set_OptimalBufferSamplesCount(int32_t value);

  /// @brief Method set_SampleRateHz, addr 0x5d1c218, size 0x60, virtual false, abstract: false, final false
  static inline void set_SampleRateHz(int32_t value);

  /// @brief Method set_SampleSizeInBytes, addr 0x5d1c2d4, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x5d1cd38, size 0x14, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Mix, addr 0x5d1c848, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Preempt, addr 0x5d1c628, size 0x14, virtual false, abstract: false, final false
  inline void Preempt(::GlobalNamespace::OVRHapticsClip* clip);

  /// @brief Method Queue, addr 0x5d1c758, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d1b664, size 0x90, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x5d1cdc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRHapticsClip* clip);

  /// @brief Method get_Clip, addr 0x5d1cffc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRHapticsClip* get_Clip();

  /// @brief Method get_ReadCount, addr 0x5d1cfec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ReadCount();

  /// @brief Method set_Clip, addr 0x5d1d004, size 0x8, virtual false, abstract: false, final false
  inline void set_Clip(::GlobalNamespace::OVRHapticsClip* value);

  /// @brief Method set_ReadCount, addr 0x5d1cff4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x5d1cd4c, size 0x78, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Mix, addr 0x5d1c85c, size 0x4dc, virtual false, abstract: false, final false
  inline void Mix(::GlobalNamespace::OVRHapticsClip* clip);

  static inline ::GlobalNamespace::OVRHaptics_OVRHapticsOutput* New_ctor(uint32_t controller);

  /// @brief Method Preempt, addr 0x5d1c63c, size 0x11c, virtual false, abstract: false, final false
  inline void Preempt(::GlobalNamespace::OVRHapticsClip* clip);

  /// @brief Method Process, addr 0x5d1b7d8, size 0x9e4, virtual false, abstract: false, final false
  inline void Process();

  /// @brief Method Queue, addr 0x5d1c76c, size 0xdc, virtual false, abstract: false, final false
  inline void Queue(::GlobalNamespace::OVRHapticsClip* clip);
  ...
  /// @brief Method .ctor, addr 0x5d1b4e0, size 0x184, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Process, addr 0x5d1b6f4, size 0xe4, virtual false, abstract: false, final false
