...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UIExtensionMethods", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UIExtensionMethods(UIExtensionMethods&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UIExtensionMethods", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UIExtensionMethods(UIExtensionMethodsconst&) = delete;
