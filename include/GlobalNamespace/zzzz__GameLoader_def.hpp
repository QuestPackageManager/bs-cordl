...
public:
  ...
  /// @brief Method MoveNext, addr 0x2508460, size 0x33c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x250879c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method HandleSceneContextPostInstall, addr 0x250832c, size 0x12c, virtual false, abstract: false, final false
  inline void HandleSceneContextPostInstall();

  static inline ::GlobalNamespace::GameLoader* New_ctor();

  /// @brief Method Start, addr 0x2508294, size 0x98, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2508458, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
