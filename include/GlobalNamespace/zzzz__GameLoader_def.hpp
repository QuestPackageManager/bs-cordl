...
// Dependencies System.Runtime.CompilerServices.AsyncVoidMethodBuilder, System.Runtime.CompilerServices.TaskAwaiter`1<TResult>, UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle`1<TObject>, UnityEngine.ResourceManagement.ResourceProviders.SceneInstance
namespace GlobalNamespace {
// Is value type: true
...
/// @brief Method MoveNext, addr 0x3671898, size 0x398, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3671c30, size 0x8, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::GameLoader>", modifiers: "", def_value: None }, CppParam { name: "_handle_5__2", ty: "::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>", modifiers: "", def_value: None }]
constexpr GameLoader__Start_d__3(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::GameLoader>  __4__this, ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>  _handle_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>  __u__1) noexcept;
...
/// @brief Field <handle>5__2, offset: 0x30, size: 0x18, def value: None
...
static_assert(offsetof(::GlobalNamespace::GameLoader__Start_d__3, __u__1) == 0x48, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::GameLoader__Start_d__3, 0x50>, "Size mismatch!");
...
/// @brief Field _handle, offset 0x28, size 0x18 
 __declspec(property(get=__cordl_internal_get__handle, put=__cordl_internal_set__handle)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>  _handle;

/// @brief Method HandleSceneContextPostInstall, addr 0x367176c, size 0x128, virtual false, abstract: false, final false
inline void HandleSceneContextPostInstall() ;

static inline ::GlobalNamespace::GameLoader* New_ctor() ;

/// @brief Method Start, addr 0x36716c8, size 0xa4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3671894, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
