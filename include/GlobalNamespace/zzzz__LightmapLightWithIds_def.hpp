...
/// @brief Method .ctor, addr 0x56ba624, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  lightId, float_t  lightIntensity, float_t  probeMultiplier) ;

/// @brief Method get_intensity, addr 0x56ba614, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_probeHighlightsIntensityMultiplier, addr 0x56ba61c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _lightIntensityData, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightIntensityData, put=__cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::LightmapLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::LightmapLightWithIds_LightIntensitiesWithId*>*>  _lightIntensityData;
...
/// @brief Method Awake, addr 0x56ba014, size 0x50, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method GetBakedLightsNormalizer, addr 0x56ba09c, size 0x94, virtual false, abstract: false, final false
inline void GetBakedLightsNormalizer() ;

/// @brief Method GetLightWithIds, addr 0x56ba5f8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessNewColorData, addr 0x56ba200, size 0x3f8, virtual true, abstract: false, final false
inline void ProcessNewColorData() ;

/// @brief Method SetChannelColorDirect, addr 0x56ba1f8, size 0x8, virtual false, abstract: false, final false
inline void SetChannelColorDirect(::UnityEngine::Color  channelColor) ;

/// @brief Method SetDataToShaders, addr 0x56ba1ac, size 0x4c, virtual false, abstract: false, final false
inline void SetDataToShaders(::UnityEngine::Color  lightmapColor, ::UnityEngine::Color  probeColor) ;

/// @brief Method SetShaderProperties, addr 0x56ba130, size 0x7c, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::LightmapLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::LightmapLightWithIds_LightIntensitiesWithId*>*> const& __cordl_internal_get__lightIntensityData() const;

constexpr ::ArrayW<::GlobalNamespace::LightmapLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::LightmapLightWithIds_LightIntensitiesWithId*>*>& __cordl_internal_get__lightIntensityData() ;
...
constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::LightmapLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::LightmapLightWithIds_LightIntensitiesWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x56ba600, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakeId, addr 0x56ba00c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::LightConstants_BakeId get_bakeId() ;

/// @brief Method get_calculatedColorPreNormalization, addr 0x56ba000, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_calculatedColorPreNormalization() ;

/// @brief Method get_intensity, addr 0x56b9fe0, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_mixType, addr 0x56b9fd8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorMixAndWeightingApproach get_mixType() ;

/// @brief Method get_normalizerWeight, addr 0x56b9ff0, size 0x8, virtual false, abstract: false, final false
inline float_t get_normalizerWeight() ;

/// @brief Method set_intensity, addr 0x56b9fe8, size 0x8, virtual false, abstract: false, final false
inline void set_intensity(float_t  value) ;

/// @brief Method set_normalizerWeight, addr 0x56b9ff8, size 0x8, virtual false, abstract: false, final false
