...
public:
  ...
  /// @brief Method <Awake>b__0, addr 0x5817a6c, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58175a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x58173d8, size 0x1c8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetToggleValueWithGameplayModifierParams, addr 0x581765c, size 0x90, virtual false, abstract: false, final false
  inline bool GetToggleValueWithGameplayModifierParams(::GlobalNamespace::GameplayModifierParamsSO* gameplayModifierParams);

  /// @brief Method IRefreshable.Refresh, addr 0x58178d4, size 0x10c, virtual true, abstract: false, final true
  inline void IRefreshable_Refresh();

  static inline ::GlobalNamespace::GameplayModifiersPanelController* New_ctor();

  /// @brief Method OnDestroy, addr 0x58175a4, size 0x14, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshTotalMultiplierAndRankUI, addr 0x58176ec, size 0x1e8, virtual false, abstract: false, final false
  inline void RefreshTotalMultiplierAndRankUI();

  /// @brief Method SetData, addr 0x58173d0, size 0x8, virtual false, abstract: false, final false
  inline void SetData(::GlobalNamespace::GameplayModifiers* newGameplayModifiers);

  /// @brief Method SetToggleValueWithGameplayModifierParams, addr 0x58175b8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58179e0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeGameplayModifiersEvent, addr 0x5817270, size 0xac, virtual false, abstract: false, final false
  inline void add_didChangeGameplayModifiersEvent(::System::Action* value);

  /// @brief Method get_gameplayModifiers, addr 0x58173c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangeGameplayModifiersEvent, addr 0x581731c, size 0xac, virtual false, abstract: false, final false
