...
public:
  ...
  /// @brief Method Init, addr 0x3bed748, size 0x18c, virtual false, abstract: false, final false
  inline void Init(::UnityEngine::Transform* parent, ::GlobalNamespace::Saber* saber, ::UnityEngine::Color trailTintColor);

  /// @brief Method InitColor, addr 0x3bed99c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bedb28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
