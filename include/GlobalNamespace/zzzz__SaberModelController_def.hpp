...
public:
  ...
  /// @brief Method Init, addr 0x3bf02ac, size 0x18c, virtual false, abstract: false, final false
  inline void Init(::UnityEngine::Transform* parent, ::GlobalNamespace::Saber* saber, ::UnityEngine::Color trailTintColor);

  /// @brief Method InitColor, addr 0x3bf0500, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bf068c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
