...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ResizablePanel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ResizablePanel(ResizablePanel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ResizablePanel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ResizablePanel(ResizablePanelconst&) = delete;
