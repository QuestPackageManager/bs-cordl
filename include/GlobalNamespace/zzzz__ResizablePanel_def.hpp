...
/// @brief Method OnDestroy, addr 0x56bf540, size 0x8c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Resize, addr 0x56bf5cc, size 0x220, virtual false, abstract: false, final false
inline void Resize(::UnityEngine::Vector2  size, float_t  duration) ;

/// @brief Method SetSize, addr 0x56bf7ec, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56bf804, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
