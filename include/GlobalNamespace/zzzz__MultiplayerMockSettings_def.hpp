...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerMockSettings*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerMockSettings*, "", "MultiplayerMockSettings");
...
public:
  ...
  /// @brief Method SharedSettings, addr 0x59c8dc8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59c8dd0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localPlayer, addr 0x59c8cf8, size 0xa8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MockPlayerSettings* get_localPlayer();

  /// @brief Method get_multiplayerStatusData, addr 0x59c8db0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerStatusData* get_multiplayerStatusData();

  /// @brief Method get_otherPlayers, addr 0x59c8dc0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::MockPlayerSettings*>* get_otherPlayers();

  /// @brief Method get_quickPlaySetupData, addr 0x59c8da0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::QuickPlaySetupData* get_quickPlaySetupData();

  /// @brief Method get_quickplayServer, addr 0x59c8cf0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MockServerSettings* get_quickplayServer();

  /// @brief Method set_multiplayerStatusData, addr 0x59c8db8, size 0x8, virtual false, abstract: false, final false
  inline void set_multiplayerStatusData(::GlobalNamespace::MultiplayerStatusData* value);

  /// @brief Method set_quickPlaySetupData, addr 0x59c8da8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerMockSettings) == 0x40, "Size mismatch!");
