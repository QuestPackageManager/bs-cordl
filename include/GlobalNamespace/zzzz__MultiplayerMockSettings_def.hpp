...
public:
  ...
  /// @brief Method SharedSettings, addr 0x3bd0cf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bd0cf8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localPlayer, addr 0x3bd0c1c, size 0xac, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MockPlayerSettings* get_localPlayer();

  /// @brief Method get_multiplayerStatusData, addr 0x3bd0cd8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerStatusData* get_multiplayerStatusData();

  /// @brief Method get_otherPlayers, addr 0x3bd0ce8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::MockPlayerSettings*>* get_otherPlayers();

  /// @brief Method get_quickPlaySetupData, addr 0x3bd0cc8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::QuickPlaySetupData* get_quickPlaySetupData();

  /// @brief Method get_quickplayServer, addr 0x3bd0c14, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MockServerSettings* get_quickplayServer();

  /// @brief Method set_multiplayerStatusData, addr 0x3bd0ce0, size 0x8, virtual false, abstract: false, final false
  inline void set_multiplayerStatusData(::GlobalNamespace::MultiplayerStatusData* value);

  /// @brief Method set_quickPlaySetupData, addr 0x3bd0cd0, size 0x8, virtual false, abstract: false, final false
