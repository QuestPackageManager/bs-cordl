...
public:
  ...
  /// @brief Method get_quickplayServer addr 0x2244570 size 0x8 virtual false final false
  inline ::GlobalNamespace::MockServerSettings* get_quickplayServer();

  /// @brief Method get_localPlayer addr 0x2244578 size 0xac virtual false final false
  inline ::GlobalNamespace::MockPlayerSettings* get_localPlayer();

  /// @brief Method get_quickPlaySetupData addr 0x2244624 size 0x8 virtual false final false
  inline ::GlobalNamespace::QuickPlaySetupData* get_quickPlaySetupData();

  /// @brief Method set_quickPlaySetupData addr 0x224462c size 0x8 virtual false final false
  inline void set_quickPlaySetupData(::GlobalNamespace::QuickPlaySetupData* value);

  /// @brief Method get_multiplayerStatusData addr 0x2244634 size 0x8 virtual false final false
  inline ::GlobalNamespace::MultiplayerStatusData* get_multiplayerStatusData();

  /// @brief Method set_multiplayerStatusData addr 0x224463c size 0x8 virtual false final false
  inline void set_multiplayerStatusData(::GlobalNamespace::MultiplayerStatusData* value);

  /// @brief Method get_otherPlayers addr 0x2244644 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::MockPlayerSettings*>* get_otherPlayers();

  /// @brief Method get_isEnabled addr 0x224464c size 0x8 virtual false final false
  inline bool get_isEnabled();

  /// @brief Method set_isEnabled addr 0x2244654 size 0xc virtual false final false
  inline void set_isEnabled(bool value);

  /// @brief Method SharedSettings addr 0x2244660 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2244668 size 0x7c virtual false final false
  inline void _ctor();
