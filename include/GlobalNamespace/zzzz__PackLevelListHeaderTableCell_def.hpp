...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x2739e78, size 0x4, virtual true, abstract: false, final false
  inline void HighlightDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  static inline ::GlobalNamespace::PackLevelListHeaderTableCell* New_ctor();

  /// @brief Method RefreshVisuals, addr 0x2739df0, size 0x88, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method SelectionDidChange, addr 0x2739dec, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2739e7c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x2739dc8, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x2739da4, size 0x24, virtual false, abstract: false, final false
