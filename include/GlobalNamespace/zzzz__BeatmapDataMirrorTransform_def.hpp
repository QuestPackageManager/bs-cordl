...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapDataMirrorTransform*);
...
public:
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0, addr 0x3705760, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x370575c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataMirrorTransform___c__DisplayClass0_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreateTransformedData, addr 0x37055d4, size 0x188, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::BeatmapDataMirrorTransform) == 0x10, "Size mismatch!");
