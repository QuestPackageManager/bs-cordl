...
public:
  ...
  /// @brief Method get_scenes, addr 0xe45290, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::SceneInfo>, ::Array<::UnityW<::GlobalNamespace::SceneInfo>>*> get_scenes();

  /// @brief Method set_scenes, addr 0xe45298, size 0x8, virtual false, abstract: false, final false
  inline void set_scenes(::ArrayW<::GlobalNamespace::SceneInfo*, ::Array<::GlobalNamespace::SceneInfo*>*> value);

  /// @brief Method Init, addr 0xe45260, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method BeforeScenesWillBeActivatedAsync, addr 0xe452a0, size 0x88, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BeforeScenesWillBeActivatedAsync();

  /// @brief Method InstallBindings, addr 0xe433cc, size 0x12c, virtual false, abstract: false, final false
  inline void InstallBindings(::Zenject::DiContainer* container);

  static inline ::GlobalNamespace::ScenesTransitionSetupDataSO* New_ctor();

  /// @brief Method .ctor, addr 0xe45270, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
