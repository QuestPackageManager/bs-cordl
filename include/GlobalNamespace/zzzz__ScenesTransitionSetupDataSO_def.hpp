...
public:
  ...
  /// @brief Method BeforeScenesWillBeActivated, addr 0x324df04, size 0x4, virtual true, abstract: false, final false
  inline void BeforeScenesWillBeActivated();

  /// @brief Method BeforeScenesWillBeActivatedAsync, addr 0x324df08, size 0x94, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BeforeScenesWillBeActivatedAsync();

  /// @brief Method Init, addr 0x324dee4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x324de40, size 0x7c, virtual false, abstract: false, final false
  inline void Init(::StringW scene, ::ArrayW<::GlobalNamespace::SceneSetupData*, ::Array<::GlobalNamespace::SceneSetupData*>*> sceneSetupData);

  /// @brief Method InstallBindings, addr 0x324b1cc, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x324dec4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_scenes, addr 0x324def4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_scenes();

  /// @brief Method set_scenes, addr 0x324defc, size 0x8, virtual false, abstract: false, final false
