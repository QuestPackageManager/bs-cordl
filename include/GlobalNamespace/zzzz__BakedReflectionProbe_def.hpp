...
public:
  ...
  /// @brief Method SendDataToShaders, addr 0x3b1797c, size 0x22c, virtual false, abstract: false, final false
  inline void SendDataToShaders();

  /// @brief Method Start, addr 0x3b178c4, size 0xb8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b17ba8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_downsampleByHalfCount, addr 0x3b178bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_downsampleByHalfCount();

  /// @brief Method get_position, addr 0x3b17894, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_reflectionProbeData, addr 0x3b17884, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::ReflectionProbeDataSO> get_reflectionProbeData();

  /// @brief Method get_resolutionBeforeDownsample, addr 0x3b178b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_reflectionProbeData, addr 0x3b1788c, size 0x8, virtual false, abstract: false, final false
