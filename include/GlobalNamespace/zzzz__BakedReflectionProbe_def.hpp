...
public:
  ...
  /// @brief Method get_reflectionProbeData, addr 0x2323064, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::ReflectionProbeDataSO> get_reflectionProbeData();

  /// @brief Method set_reflectionProbeData, addr 0x232306c, size 0x8, virtual false, abstract: false, final false
  inline void set_reflectionProbeData(::GlobalNamespace::ReflectionProbeDataSO* value);

  /// @brief Method get_position, addr 0x2323074, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_resolutionBeforeDownsample, addr 0x2323094, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_resolutionBeforeDownsample();

  /// @brief Method get_downsampleByHalfCount, addr 0x232309c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_downsampleByHalfCount();

  /// @brief Method Start, addr 0x23230a4, size 0xb8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method SendDataToShaders, addr 0x232315c, size 0x22c, virtual false, abstract: false, final false
  inline void SendDataToShaders();

  static inline ::GlobalNamespace::BakedReflectionProbe* New_ctor();

  /// @brief Method .ctor, addr 0x2323388, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
