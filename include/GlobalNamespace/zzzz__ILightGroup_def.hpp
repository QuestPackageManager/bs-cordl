...
public:
  ...
  /// @brief Method get_startLightId, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method get_sameIdElements, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline int32_t get_sameIdElements();

  /// @brief Method get_ignoreLightGroupEffectManager, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
