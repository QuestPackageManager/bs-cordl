...
public:
  ...
  /// @brief Method .ctor, addr 0xeba9e4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(int32_t timeoutMs);

  /// @brief Method get_elapsedTime, addr 0xeba930, size 0x84, virtual false, abstract: false, final false
  inline double_t get_elapsedTime();

  /// @brief Method get_hasTimedOut, addr 0xeba9b4, size 0x30, virtual false, abstract: false, final false
