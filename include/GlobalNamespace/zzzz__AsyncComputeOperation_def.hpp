...
// Write type traits
MARK_REF_T(::GlobalNamespace::AsyncComputeOperation*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AsyncComputeOperation*, "", "AsyncComputeOperation");
...
public:
  ...
  /// @brief Method .ctor, addr 0x332a81c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t timeoutMs);

  /// @brief Method get_elapsedTime, addr 0x332a764, size 0x88, virtual false, abstract: false, final false
  inline double_t get_elapsedTime();

  /// @brief Method get_hasTimedOut, addr 0x332a7ec, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AsyncComputeOperation) == 0x20, "Size mismatch!");
