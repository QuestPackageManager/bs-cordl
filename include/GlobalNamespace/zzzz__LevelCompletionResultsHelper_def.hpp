...
public:
  // Declarations
  /// @brief Method Create, addr 0x35e6450, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessScore, addr 0x35e6894, size 0x148, virtual false, abstract: false, final false
