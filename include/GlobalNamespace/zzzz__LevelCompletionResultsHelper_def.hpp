...
public:
  // Declarations
  /// @brief Method Create, addr 0x26b15b0, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessScore, addr 0x26b1a14, size 0x114, virtual false, abstract: false, final false
