...
public:
  // Declarations
  /// @brief Method Create, addr 0x13b5a24, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessScore, addr 0x13b5e80, size 0x110, virtual false, abstract: false, final false
