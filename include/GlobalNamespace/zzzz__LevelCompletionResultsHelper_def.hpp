...
public:
  // Declarations
  /// @brief Method Create, addr 0x12ddb14, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessScore, addr 0x12ddf70, size 0x110, virtual false, abstract: false, final false
