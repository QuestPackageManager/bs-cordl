...
public:
  // Declarations
  /// @brief Method Create, addr 0x364d9d8, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessScore, addr 0x364de1c, size 0x148, virtual false, abstract: false, final false
