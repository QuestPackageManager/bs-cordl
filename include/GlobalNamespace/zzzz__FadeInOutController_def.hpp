...
public:
  ...
  /// @brief Method MoveNext, addr 0x39d0cb0, size 0x1a0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::FadeInOutController__Fade_d__19* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x39d0e50, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x39d0e58, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x39d0e90, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x39d0cac, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39d0c68, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Fade, addr 0x39d0bc4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method FadeIn, addr 0x39d0ad0, size 0xc, virtual false, abstract: false, final false
  inline void FadeIn();

  /// @brief Method FadeIn, addr 0x39d0ba4, size 0x8, virtual false, abstract: false, final false
  inline void FadeIn(float_t duration);

  /// @brief Method FadeIn, addr 0x39d0adc, size 0xbc, virtual false, abstract: false, final false
  inline void FadeIn(float_t duration, ::System::Action* fadeInFinishedCallback);

  /// @brief Method FadeIn, addr 0x39d0bb4, size 0x8, virtual false, abstract: false, final false
  inline void FadeIn(::System::Action* fadeInCallback);

  /// @brief Method FadeOut, addr 0x39d0b98, size 0xc, virtual false, abstract: false, final false
  inline void FadeOut();

  /// @brief Method FadeOut, addr 0x39d0bac, size 0x8, virtual false, abstract: false, final false
  inline void FadeOut(float_t duration);

  /// @brief Method FadeOut, addr 0x39d0a10, size 0xc0, virtual false, abstract: false, final false
  inline void FadeOut(float_t duration, ::System::Action* fadeOutFinishedCallback);

  /// @brief Method FadeOut, addr 0x39d0bbc, size 0x8, virtual false, abstract: false, final false
  inline void FadeOut(::System::Action* fadeOutCallback);

  /// @brief Method FadeOutInstant, addr 0x39d0a04, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39d0c90, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_inTransition, addr 0x39d09f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_inTransition();

  /// @brief Method set_inTransition, addr 0x39d09f8, size 0xc, virtual false, abstract: false, final false
