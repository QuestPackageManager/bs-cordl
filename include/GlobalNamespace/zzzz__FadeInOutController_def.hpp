...
public:
  ...
  /// @brief Method MoveNext, addr 0x22b6664, size 0x190, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__FadeInOutController___Fade_d__15* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x22b67f4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x22b67fc, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x22b683c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x22b6660, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22b661c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Fade, addr 0x22b6570, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method FadeIn, addr 0x22b647c, size 0xc, virtual false, abstract: false, final false
  inline void FadeIn();

  /// @brief Method FadeIn, addr 0x22b6550, size 0x8, virtual false, abstract: false, final false
  inline void FadeIn(float_t duration);

  /// @brief Method FadeIn, addr 0x22b6488, size 0xbc, virtual false, abstract: false, final false
  inline void FadeIn(float_t duration, ::System::Action* fadeInFinishedCallback);

  /// @brief Method FadeIn, addr 0x22b6560, size 0x8, virtual false, abstract: false, final false
  inline void FadeIn(::System::Action* fadeInCallback);

  /// @brief Method FadeOut, addr 0x22b6544, size 0xc, virtual false, abstract: false, final false
  inline void FadeOut();

  /// @brief Method FadeOut, addr 0x22b6558, size 0x8, virtual false, abstract: false, final false
  inline void FadeOut(float_t duration);

  /// @brief Method FadeOut, addr 0x22b63bc, size 0xc0, virtual false, abstract: false, final false
  inline void FadeOut(float_t duration, ::System::Action* fadeOutFinishedCallback);

  /// @brief Method FadeOut, addr 0x22b6568, size 0x8, virtual false, abstract: false, final false
  inline void FadeOut(::System::Action* fadeOutCallback);

  /// @brief Method FadeOutInstant, addr 0x22b63b0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22b6644, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
