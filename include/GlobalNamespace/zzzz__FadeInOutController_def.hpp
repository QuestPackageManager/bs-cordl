...
public:
  ...
  /// @brief Method MoveNext, addr 0x570fba0, size 0x1b8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::FadeInOutController__Fade_d__19* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x570fd58, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x570fd60, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x570fd98, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x570fb9c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x570fb7c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Fade, addr 0x570fae4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method FadeIn, addr 0x570f9d4, size 0xc, virtual false, abstract: false, final false
  inline void FadeIn();

  /// @brief Method FadeIn, addr 0x570fac4, size 0x8, virtual false, abstract: false, final false
  inline void FadeIn(float_t duration);

  /// @brief Method FadeIn, addr 0x570f9e0, size 0xd8, virtual false, abstract: false, final false
  inline void FadeIn(float_t duration, ::System::Action* fadeInFinishedCallback);

  /// @brief Method FadeIn, addr 0x570fad4, size 0x8, virtual false, abstract: false, final false
  inline void FadeIn(::System::Action* fadeInCallback);

  /// @brief Method FadeOut, addr 0x570fab8, size 0xc, virtual false, abstract: false, final false
  inline void FadeOut();

  /// @brief Method FadeOut, addr 0x570facc, size 0x8, virtual false, abstract: false, final false
  inline void FadeOut(float_t duration);

  /// @brief Method FadeOut, addr 0x570f8f8, size 0xdc, virtual false, abstract: false, final false
  inline void FadeOut(float_t duration, ::System::Action* fadeOutFinishedCallback);

  /// @brief Method FadeOut, addr 0x570fadc, size 0x8, virtual false, abstract: false, final false
  inline void FadeOut(::System::Action* fadeOutCallback);

  /// @brief Method FadeOutInstant, addr 0x570f8ec, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x570fb84, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_inTransition, addr 0x570f8dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_inTransition();

  /// @brief Method set_inTransition, addr 0x570f8e4, size 0x8, virtual false, abstract: false, final false
