...
public:
  ...
  /// @brief Method Unpack, addr 0x3656804, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36565dc, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x36565d4, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x36565cc, size 0x8, virtual true, abstract: false, final false
