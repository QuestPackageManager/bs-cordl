...
// Write type traits
MARK_REF_T(::GlobalNamespace::IntVfxBeatmapEventDataBox*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IntVfxBeatmapEventDataBox*, "", "IntVfxBeatmapEventDataBox");
...
public:
  ...
  /// @brief Method Unpack, addr 0x3719288, size 0x98, virtual true, abstract: false, final false
  ...
  constexpr ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IntFxBaseData*>* const& __cordl_internal_get__vfxBaseDataList() const;
  ...
  /// @brief Method .ctor, addr 0x3719060, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x3719058, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x3719050, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IntVfxBeatmapEventDataBox", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IntVfxBeatmapEventDataBox(IntVfxBeatmapEventDataBox&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IntVfxBeatmapEventDataBox", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IntVfxBeatmapEventDataBox(IntVfxBeatmapEventDataBoxconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::IntVfxBeatmapEventDataBox) == 0x48, "Size mismatch!");
