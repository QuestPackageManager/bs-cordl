...
public:
  ...
  /// @brief Method Unpack, addr 0x13bde70, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13bdc68, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x13bdc60, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x13bdc58, size 0x8, virtual true, abstract: false, final false
