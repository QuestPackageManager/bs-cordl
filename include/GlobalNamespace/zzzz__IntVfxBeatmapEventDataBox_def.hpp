...
public:
  ...
  /// @brief Method Unpack, addr 0x26ba634, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ba42c, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x26ba424, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x26ba41c, size 0x8, virtual true, abstract: false, final false
