...
public:
  ...
  /// @brief Method Unpack, addr 0x26be3b8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26be1b0, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x26be1a8, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x26be1a0, size 0x8, virtual true, abstract: false, final false
