...
public:
  ...
  /// @brief Method Unpack, addr 0x26bdd10, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26bdb08, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x26bdb00, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x26bdaf8, size 0x8, virtual true, abstract: false, final false
