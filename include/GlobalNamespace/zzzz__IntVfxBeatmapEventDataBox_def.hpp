...
public:
  ...
  /// @brief Method Unpack, addr 0x26bc9bc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26bc7b4, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x26bc7ac, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x26bc7a4, size 0x8, virtual true, abstract: false, final false
