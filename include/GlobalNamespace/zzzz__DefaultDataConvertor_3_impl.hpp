...
template <typename TBase, typename TIn, typename TOut> inline TOut GlobalNamespace::DefaultDataConvertor_3<TBase, TIn, TOut>::Convert(TIn item) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DefaultDataConvertor_3<TBase, TIn, TOut>*>::get(), "Convert",
