...
public:
  ...
  /// @brief Method .ctor, addr 0x3bedd9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_comboBreakingEventHappenedEvent, addr 0x3bedc64, size 0x9c, virtual true, abstract: false, final true
  inline void add_comboBreakingEventHappenedEvent(::System::Action* value);

  /// @brief Method add_comboDidChangeEvent, addr 0x3bedb04, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_comboBreakingEventHappenedEvent, addr 0x3bedd00, size 0x9c, virtual true, abstract: false, final true
  inline void remove_comboBreakingEventHappenedEvent(::System::Action* value);

  /// @brief Method remove_comboDidChangeEvent, addr 0x3bedbb4, size 0xb0, virtual true, abstract: false, final true
