...
public:
  ...
  /// @brief Method Create, addr 0x12ece48, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ecee4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beatmapLevels, addr 0x12ece40, size 0x8, virtual false, abstract: false, final false
