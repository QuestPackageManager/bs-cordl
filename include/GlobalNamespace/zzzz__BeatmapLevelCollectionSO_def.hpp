...
public:
  ...
  /// @brief Method AddBeatmapLevel, addr 0x365fb00, size 0xb4, virtual false, abstract: false, final false
  inline void AddBeatmapLevel(::GlobalNamespace::BeatmapLevelSO* beatmapLevel);

  /// @brief Method Create, addr 0x365fa5c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method SortLevels, addr 0x365fbb4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365fc5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beatmapLevels, addr 0x365fa54, size 0x8, virtual false, abstract: false, final false
