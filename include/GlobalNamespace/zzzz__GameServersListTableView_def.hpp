...
public:
  ...
  /// @brief Method add_joinButtonPressedEvent, addr 0x2312db4, size 0xb0, virtual false, abstract: false, final false
  inline void add_joinButtonPressedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayer*>* value);

  /// @brief Method remove_joinButtonPressedEvent, addr 0x2312e64, size 0xb0, virtual false, abstract: false, final false
  inline void remove_joinButtonPressedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayer*>* value);

  /// @brief Method CellSize, addr 0x2312f14, size 0xc, virtual true, abstract: false, final true
  inline float_t CellSize();

  /// @brief Method NumberOfCells, addr 0x2312f20, size 0x18, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method Init, addr 0x2312f38, size 0x114, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method CellForContent, addr 0x231304c, size 0x164, virtual true, abstract: false, final true
  ...
  /// @brief Method CellForDetail, addr 0x23131b0, size 0x1bc, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForDetail(::GlobalNamespace::TableViewWithDetailCell* tableView, int32_t contentIdx);

  /// @brief Method SetData, addr 0x231336c, size 0x124, virtual false, abstract: false, final false
  inline void SetData(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::INetworkPlayer*>* servers, bool clearSelection);

  /// @brief Method HandleGameServerListDetailTableCellJoinServerButtonWasPressed, addr 0x2313490, size 0x24, virtual false, abstract: false, final false
  inline void HandleGameServerListDetailTableCellJoinServerButtonWasPressed();

  /// @brief Method HandleTableViewDidSelectCellWithIdx, addr 0x23134b4, size 0x34, virtual false, abstract: false, final false
  inline void HandleTableViewDidSelectCellWithIdx(::HMUI::TableView* tableView, int32_t id);

  /// @brief Method HandleTableViewDidDeselectCellWithIdx, addr 0x23134e8, size 0x8, virtual false, abstract: false, final false
  inline void HandleTableViewDidDeselectCellWithIdx(::GlobalNamespace::TableViewWithDetailCell* arg1, int32_t arg2);

  /// @brief Method OnDestroy, addr 0x23134f0, size 0xf4, virtual false, abstract: false, final false
  inline void OnDestroy();

  static inline ::GlobalNamespace::GameServersListTableView* New_ctor();

  /// @brief Method .ctor, addr 0x23135e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
