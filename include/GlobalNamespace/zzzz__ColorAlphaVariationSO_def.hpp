...
/// @brief Method .ctor, addr 0x35fb0ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_alpha, addr 0x35fb0a4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::AlphaSO> get_alpha() ;

/// @brief Method get_baseColor, addr 0x35fb09c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::NoAlphaColorSO> get_baseColor() ;

/// @brief Method get_color, addr 0x35fb068, size 0x34, virtual true, abstract: false, final false
