...
public:
  ...
  /// @brief Method .ctor, addr 0x269fcb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alpha, addr 0x269fcb0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::AlphaSO> get_alpha();

  /// @brief Method get_baseColor, addr 0x269fca8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::NoAlphaColorSO> get_baseColor();

  /// @brief Method get_color, addr 0x269fc74, size 0x34, virtual true, abstract: false, final false
