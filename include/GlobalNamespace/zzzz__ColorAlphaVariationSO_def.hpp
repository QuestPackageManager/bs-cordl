...
public:
  ...
  /// @brief Method .ctor, addr 0x36376f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alpha, addr 0x36376e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::AlphaSO> get_alpha();

  /// @brief Method get_baseColor, addr 0x36376e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::NoAlphaColorSO> get_baseColor();

  /// @brief Method get_color, addr 0x36376ac, size 0x34, virtual true, abstract: false, final false
