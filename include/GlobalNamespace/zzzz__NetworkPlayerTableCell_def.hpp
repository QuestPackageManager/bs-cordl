...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x26318f0, size 0x4, virtual true, abstract: false, final false
  inline void HighlightDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  static inline ::GlobalNamespace::NetworkPlayerTableCell* New_ctor();

  /// @brief Method RefreshVisuals, addr 0x26316d8, size 0x214, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method SelectionDidChange, addr 0x26318ec, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method SetData, addr 0x2630a18, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2631950, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeColor, addr 0x26318f4, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_activeColor();

  /// @brief Method get_showSeparator, addr 0x26316bc, size 0x1c, virtual false, abstract: false, final false
  inline bool get_showSeparator();

  /// @brief Method set_showSeparator, addr 0x2630ab4, size 0x2c, virtual false, abstract: false, final false
