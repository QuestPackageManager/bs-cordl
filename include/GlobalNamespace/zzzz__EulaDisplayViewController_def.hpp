...
// Write type traits
MARK_REF_T(::GlobalNamespace::EulaDisplayViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EulaDisplayViewController*, "", "EulaDisplayViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a1939c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a193e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EulaDisplayViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EulaDisplayViewController(EulaDisplayViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EulaDisplayViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EulaDisplayViewController(EulaDisplayViewControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::EulaDisplayViewController) == 0x88, "Size mismatch!");
