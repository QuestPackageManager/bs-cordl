...
public:
  ...
  /// @brief Method DidActivate, addr 0x3c12e68, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c12eac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
