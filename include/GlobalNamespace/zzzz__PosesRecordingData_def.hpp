...
public:
  ...
  /// @brief Method .ctor, addr 0x5756fdc, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x5754a5c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Camera* camera);

  /// @brief Method .ctor, addr 0x5757194, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddKeyframe, addr 0x5756fe8, size 0xb4, virtual false, abstract: false, final false
  inline void AddKeyframe(::GlobalNamespace::PosesRecordingData_TransformsKeyframe* keyframe);

  /// @brief Method Contains, addr 0x57549f8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ObjectIndex, addr 0x5757138, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5756f54, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x575712c, size 0xc, virtual false, abstract: false, final false
