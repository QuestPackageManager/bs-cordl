...
public:
  ...
  /// @brief Method .ctor, addr 0x2585024, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2582b5c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Camera* camera);

  /// @brief Method .ctor, addr 0x2585244, size 0x50, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddKeyframe, addr 0x258505c, size 0xa8, virtual false, abstract: false, final false
  inline void AddKeyframe(::GlobalNamespace::__PosesRecordingData__TransformsKeyframe* keyframe);

  /// @brief Method Contains, addr 0x2582ad8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ObjectIndex, addr 0x25851ec, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2584f90, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25851b0, size 0x3c, virtual false, abstract: false, final false
