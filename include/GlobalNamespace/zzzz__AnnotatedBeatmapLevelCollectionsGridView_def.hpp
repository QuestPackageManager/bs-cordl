...
public:
  ...
  /// @brief Method add_didOpenAnnotatedBeatmapLevelCollectionEvent addr 0x2196978 size 0x9c virtual false final false
  inline void add_didOpenAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method remove_didOpenAnnotatedBeatmapLevelCollectionEvent addr 0x2196a14 size 0x9c virtual false final false
  inline void remove_didOpenAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method add_didCloseAnnotatedBeatmapLevelCollectionEvent addr 0x2196ab0 size 0x9c virtual false final false
  inline void add_didCloseAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method remove_didCloseAnnotatedBeatmapLevelCollectionEvent addr 0x2196b4c size 0x9c virtual false final false
  inline void remove_didCloseAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method add_didSelectAnnotatedBeatmapLevelCollectionEvent addr 0x2196be8 size 0xb0 virtual false final false
  ...
  /// @brief Method remove_didSelectAnnotatedBeatmapLevelCollectionEvent addr 0x2196c98 size 0xb0 virtual false final false
  ...
  /// @brief Method SetData addr 0x2196d48 size 0x8c virtual false final false
  ...
  /// @brief Method OnEnable addr 0x2196e84 size 0x140 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x2196fc4 size 0x144 virtual false final false
  inline void OnDisable();

  /// @brief Method Show addr 0x2197108 size 0x24 virtual false final false
  inline void Show();

  /// @brief Method Hide addr 0x219712c size 0x24 virtual false final false
  inline void Hide();

  /// @brief Method CancelAsyncOperations addr 0x2197150 size 0x188 virtual false final false
  inline void CancelAsyncOperations();

  /// @brief Method RefreshAvailability addr 0x21972d8 size 0x2cc virtual false final false
  inline void RefreshAvailability();

  /// @brief Method SelectAndScrollToCellWithIdx addr 0x21975a4 size 0x324 virtual false final false
  inline void SelectAndScrollToCellWithIdx(int32_t idx);

  /// @brief Method OnPointerEnter addr 0x2197924 size 0x54 virtual true final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit addr 0x2197cac size 0x68 virtual true final true
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x219801c size 0x60 virtual false final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  /// @brief Method HandleVRPlatformHelperInputFocusCaptured addr 0x2198128 size 0x4c virtual false final false
  inline void HandleVRPlatformHelperInputFocusCaptured();

  /// @brief Method HandleCellSelectionDidChange addr 0x2198174 size 0x4c4 virtual false final false
  ...
  /// @brief Method GetNumberOfCells addr 0x219807c size 0xac virtual true final true
  inline int32_t GetNumberOfCells();

  /// @brief Method GetCellWidth addr 0x2198638 size 0x8 virtual true final true
  inline float_t GetCellWidth();

  /// @brief Method GetCellHeight addr 0x2198640 size 0x8 virtual true final true
  inline float_t GetCellHeight();

  /// @brief Method CellForIdx addr 0x2198648 size 0x294 virtual true final true
  ...
  /// @brief Method .ctor addr 0x21988dc size 0x8 virtual false final false
  inline void _ctor();
