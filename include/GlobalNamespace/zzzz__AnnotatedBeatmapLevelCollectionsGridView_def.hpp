...
public:
  ...
  /// @brief Method add_didOpenAnnotatedBeatmapLevelCollectionEvent addr 0x22dc480 size 0x9c virtual false final false
  inline void add_didOpenAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method remove_didOpenAnnotatedBeatmapLevelCollectionEvent addr 0x22dc51c size 0x9c virtual false final false
  inline void remove_didOpenAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method add_didCloseAnnotatedBeatmapLevelCollectionEvent addr 0x22dc5b8 size 0x9c virtual false final false
  inline void add_didCloseAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method remove_didCloseAnnotatedBeatmapLevelCollectionEvent addr 0x22dc654 size 0x9c virtual false final false
  inline void remove_didCloseAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method add_didSelectAnnotatedBeatmapLevelCollectionEvent addr 0x22dc6f0 size 0xb0 virtual false final false
  ...
  /// @brief Method remove_didSelectAnnotatedBeatmapLevelCollectionEvent addr 0x22dc7a0 size 0xb0 virtual false final false
  ...
  /// @brief Method SetData addr 0x22dc850 size 0x88 virtual false final false
  ...
  /// @brief Method OnEnable addr 0x22dca20 size 0x1a0 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x22dcbc0 size 0x1a8 virtual false final false
  inline void OnDisable();

  /// @brief Method Show addr 0x22dcd68 size 0x24 virtual false final false
  inline void Show();

  /// @brief Method Hide addr 0x22dcd8c size 0x24 virtual false final false
  inline void Hide();

  /// @brief Method CancelAsyncOperations addr 0x22dcdb0 size 0x184 virtual false final false
  inline void CancelAsyncOperations();

  /// @brief Method RefreshAvailability addr 0x22dd01c size 0x2c8 virtual false final false
  inline void RefreshAvailability();

  /// @brief Method SelectAndScrollToCellWithIdx addr 0x22dd34c size 0x320 virtual false final false
  inline void SelectAndScrollToCellWithIdx(int32_t idx);

  /// @brief Method OnPointerEnter addr 0x22dd6c8 size 0x54 virtual true final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit addr 0x22dda50 size 0x68 virtual true final true
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x22dddc0 size 0x5c virtual false final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  /// @brief Method HandleVRPlatformHelperInputFocusCaptured addr 0x22de63c size 0x4c virtual false final false
  inline void HandleVRPlatformHelperInputFocusCaptured();

  /// @brief Method HandleCellSelectionDidChange addr 0x22de688 size 0x4c0 virtual false final false
  ...
  /// @brief Method GetNumberOfCells addr 0x22dde1c size 0xac virtual true final true
  inline int32_t GetNumberOfCells();

  /// @brief Method GetCellWidth addr 0x22deb48 size 0x8 virtual true final true
  inline float_t GetCellWidth();

  /// @brief Method GetCellHeight addr 0x22deb50 size 0x8 virtual true final true
  inline float_t GetCellHeight();

  /// @brief Method CellForIdx addr 0x22deb58 size 0x294 virtual true final true
  ...
  /// @brief Method .ctor addr 0x22dedec size 0x8 virtual false final false
  inline void _ctor();
