...
public:
  ...
  /// @brief Method CancelAsyncOperations, addr 0x573c9ec, size 0x154, virtual false, abstract: false, final false
  inline void CancelAsyncOperations();

  /// @brief Method CellForIdx, addr 0x573d638, size 0x230, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Component> CellForIdx(::GlobalNamespace::GridView* gridView, int32_t idx);

  /// @brief Method CloseLevelCollection, addr 0x573c944, size 0x60, virtual false, abstract: false, final false
  inline void CloseLevelCollection(bool animated);

  /// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x573d184, size 0x5c, virtual false, abstract: false, final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  /// @brief Method HandleCellSelectionDidChange, addr 0x573d1e8, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleVRPlatformHelperInputFocusCaptured, addr 0x573d1e0, size 0x8, virtual false, abstract: false, final false
  inline void HandleVRPlatformHelperInputFocusCaptured();

  /// @brief Method Hide, addr 0x573c9c8, size 0x24, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridView* New_ctor();

  /// @brief Method OnDisable, addr 0x573c784, size 0x1c0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x573c5d8, size 0x1ac, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPointerEnter, addr 0x573d0e4, size 0x4c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x573d15c, size 0x28, virtual true, abstract: false, final true
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method RefreshAvailability, addr 0x573cb40, size 0x2a0, virtual false, abstract: false, final false
  inline void RefreshAvailability();

  /// @brief Method SelectAndScrollToCellWithIdx, addr 0x573cde0, size 0x304, virtual false, abstract: false, final false
  inline void SelectAndScrollToCellWithIdx(int32_t idx);

  /// @brief Method SetData, addr 0x573c090, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldExpandCollection, addr 0x573d130, size 0x2c, virtual false, abstract: false, final false
  inline bool ShouldExpandCollection();

  /// @brief Method Show, addr 0x573c9a4, size 0x24, virtual false, abstract: false, final false
  inline void Show();
  ...
  /// @brief Method .ctor, addr 0x573d868, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didCloseAnnotatedBeatmapLevelCollectionEvent, addr 0x573bdb8, size 0xac, virtual false, abstract: false, final false
  inline void add_didCloseAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method add_didOpenAnnotatedBeatmapLevelCollectionEvent, addr 0x573bc60, size 0xac, virtual false, abstract: false, final false
  inline void add_didOpenAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method add_didSelectAnnotatedBeatmapLevelCollectionEvent, addr 0x573bf10, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectAnnotatedBeatmapLevelCollectionEvent(::System::Action_1<::GlobalNamespace::BeatmapLevelPack*>* value);

  /// @brief Method get_cellHeight, addr 0x573bc58, size 0x8, virtual true, abstract: false, final true
  inline float_t get_cellHeight();

  /// @brief Method get_cellWidth, addr 0x573bc50, size 0x8, virtual true, abstract: false, final true
  inline float_t get_cellWidth();

  /// @brief Method get_numberOfCells, addr 0x573bba0, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_didCloseAnnotatedBeatmapLevelCollectionEvent, addr 0x573be64, size 0xac, virtual false, abstract: false, final false
  inline void remove_didCloseAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method remove_didOpenAnnotatedBeatmapLevelCollectionEvent, addr 0x573bd0c, size 0xac, virtual false, abstract: false, final false
  inline void remove_didOpenAnnotatedBeatmapLevelCollectionEvent(::System::Action* value);

  /// @brief Method remove_didSelectAnnotatedBeatmapLevelCollectionEvent, addr 0x573bfd0, size 0xc0, virtual false, abstract: false, final false
