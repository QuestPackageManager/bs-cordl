...
public:
  ...
  /// @brief Method DidActivate, addr 0x2305f2c, size 0x44, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::PrivacyPolicyDisplayViewController* New_ctor();

  /// @brief Method .ctor, addr 0x2305f70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
