...
// Write type traits
MARK_REF_T(::GlobalNamespace::PrivacyPolicyDisplayViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PrivacyPolicyDisplayViewController*, "", "PrivacyPolicyDisplayViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a1d20c, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1d3a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrivacyPolicyDisplayViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrivacyPolicyDisplayViewController(PrivacyPolicyDisplayViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrivacyPolicyDisplayViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrivacyPolicyDisplayViewController(PrivacyPolicyDisplayViewControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::PrivacyPolicyDisplayViewController) == 0x80, "Size mismatch!");
