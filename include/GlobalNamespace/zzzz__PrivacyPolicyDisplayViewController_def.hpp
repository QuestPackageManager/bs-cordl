...
public:
  ...
  /// @brief Method DidActivate, addr 0x5735180, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57351c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
