...
public:
  ...
  /// @brief Method Awake, addr 0x3aeaed8, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FixedUpdate, addr 0x3aeaf20, size 0x12c, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method Init, addr 0x3aeb1c4, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3aeb30c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
