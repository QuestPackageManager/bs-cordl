...
public:
  ...
  /// @brief Method AddVelocity, addr 0x252a620, size 0x60, virtual true, abstract: false, final false
  inline void AddVelocity(::UnityEngine::Vector3 force);

  /// @brief Method FixedUpdate, addr 0x252a514, size 0x48, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method Init, addr 0x252a55c, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252a680, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_position, addr 0x252a4f8, size 0x1c, virtual true, abstract: false, final false
