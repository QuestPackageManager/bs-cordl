...
public:
  ...
  /// @brief Method Awake, addr 0x56c8868, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FixedUpdate, addr 0x56c88b0, size 0x138, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method Init, addr 0x56c8b74, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56c8cbc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
