...
public:
  ...
  /// @brief Method ValidateCertificateChain addr 0xda45a8 size 0x4 virtual true final true
  ...
  /// @brief Method ValidateCertificateChainInternal addr 0xda45ac size 0x1c8 virtual false final false
