...
public:
  ...
  /// @brief Method ValidateCertificateChain, addr 0x22ba960, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method ValidateCertificateChainInternal, addr 0x22ba964, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22bab20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
