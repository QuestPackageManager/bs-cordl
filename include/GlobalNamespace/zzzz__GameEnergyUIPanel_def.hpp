...
public:
  ...
  /// @brief Method CreateUIForBatteryEnergyType, addr 0x3ba71c4, size 0x2a0, virtual false, abstract: false, final false
  inline void CreateUIForBatteryEnergyType(int32_t batteryLives);

  /// @brief Method HandleGameEnergyCounterDidInit, addr 0x3ba78f4, size 0x4, virtual false, abstract: false, final false
  inline void HandleGameEnergyCounterDidInit();

  /// @brief Method HandleGameEnergyDidChange, addr 0x3ba78f8, size 0x4, virtual false, abstract: false, final false
  inline void HandleGameEnergyDidChange(float_t energy);

  /// @brief Method Init, addr 0x3ba6e2c, size 0x398, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::GameEnergyUIPanel* New_ctor();

  /// @brief Method OnDestroy, addr 0x3ba7738, size 0x1bc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshEnergyUI, addr 0x3ba7464, size 0x2d4, virtual false, abstract: false, final false
  inline void RefreshEnergyUI(float_t energy);

  /// @brief Method Start, addr 0x3ba6cac, size 0x180, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ba78fc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
