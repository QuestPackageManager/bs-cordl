...
public:
  ...
  /// @brief Method Start, addr 0x237d758, size 0x184, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Init, addr 0x237d8dc, size 0x3a0, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method OnDestroy, addr 0x237e230, size 0x1b8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method CreateUIForBatteryEnergyType, addr 0x237dc7c, size 0x2e4, virtual false, abstract: false, final false
  inline void CreateUIForBatteryEnergyType(int32_t batteryLives);

  /// @brief Method RefreshEnergyUI, addr 0x237df60, size 0x2d0, virtual false, abstract: false, final false
  inline void RefreshEnergyUI(float_t energy);

  /// @brief Method HandleGameEnergyCounterDidInit, addr 0x237e3e8, size 0x4, virtual false, abstract: false, final false
  inline void HandleGameEnergyCounterDidInit();

  /// @brief Method HandleGameEnergyDidChange, addr 0x237e3ec, size 0x4, virtual false, abstract: false, final false
  inline void HandleGameEnergyDidChange(float_t energy);

  static inline ::GlobalNamespace::GameEnergyUIPanel* New_ctor();

  /// @brief Method .ctor, addr 0x237e3f0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
