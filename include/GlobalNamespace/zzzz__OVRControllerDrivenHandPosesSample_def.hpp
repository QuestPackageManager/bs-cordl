...
/// @brief Method Awake, addr 0x5c70490, size 0xfc, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRControllerDrivenHandPosesSample* New_ctor() ;

/// @brief Method SetControllerDrivenHandPosesTypeToControllerConforming, addr 0x5c70670, size 0xe8, virtual false, abstract: false, final false
inline void SetControllerDrivenHandPosesTypeToControllerConforming() ;

/// @brief Method SetControllerDrivenHandPosesTypeToNatural, addr 0x5c70758, size 0xe8, virtual false, abstract: false, final false
inline void SetControllerDrivenHandPosesTypeToNatural() ;

/// @brief Method SetControllerDrivenHandPosesTypeToNone, addr 0x5c7058c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c70840, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
