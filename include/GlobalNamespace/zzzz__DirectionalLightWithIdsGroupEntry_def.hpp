...
struct __DirectionalLightWithIdsGroupEntry__GroupLightsWeighting;
}
namespace GlobalNamespace {
...
// Write type traits
MARK_VAL_T(::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting);
...
struct CORDL_TYPE __DirectionalLightWithIdsGroupEntry__GroupLightsWeighting {
public:
  // Declarations
  using __CORDL_BACKING_ENUM_TYPE = int32_t;

  /// @brief Nested struct ____DirectionalLightWithIdsGroupEntry__GroupLightsWeighting_Unwrapped
  enum struct ____DirectionalLightWithIdsGroupEntry__GroupLightsWeighting_Unwrapped : int32_t {
    __E_Maximum = static_cast<int32_t>(0x0),
    __E_LinearFraction = static_cast<int32_t>(0x1),
  };

  /// @brief Conversion into unwrapped enum value
  constexpr operator ____DirectionalLightWithIdsGroupEntry__GroupLightsWeighting_Unwrapped() const noexcept {
    return static_cast<____DirectionalLightWithIdsGroupEntry__GroupLightsWeighting_Unwrapped>(this->value__);
  }

  // Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
  constexpr __DirectionalLightWithIdsGroupEntry__GroupLightsWeighting(int32_t value__) noexcept;

  // Ctor Parameters []
  // @brief default ctor
  constexpr __DirectionalLightWithIdsGroupEntry__GroupLightsWeighting();
  ...
  static ::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting const Maximum;

  /// @brief Field LinearFraction value: static_cast<int32_t>(0x1)
  static ::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting const LinearFraction;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting, 0x4>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting, value__) == 0x0, "Offset mismatch!");
...
public:
  ...
  /// @brief Method get_lightGroup addr 0x1fb9b30 size 0x8 virtual false final false
  inline ::GlobalNamespace::LightGroupSO* get_lightGroup();

  /// @brief Method get_groupIntensity addr 0x1fb9b38 size 0x8 virtual false final false
  inline float_t get_groupIntensity();

  static inline ::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData* New_ctor();

  /// @brief Method .ctor addr 0x1fb9b40 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_lightId addr 0x1fb9b48 size 0x8 virtual false final false
  inline int32_t get_lightId();

  /// @brief Method get_intensity addr 0x1fb9b50 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1fb9b58 size 0x38 virtual false final false
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14740)), TypeDefinitionIndex(TypeDefinitionIndex(10152))}
...
public:
  ...
  using GroupLightsWeighting = ::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting;
  ...
  __declspec(property(get = __get__groupLightData, put = __set__groupLightData))::ArrayW<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData*,
                                                                                         ::Array<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData*>*> _groupLightData;

  /// @brief Field _individualLightData, offset 0x28, size 0x8
  __declspec(property(get = __get__individualLightData,
                      put = __set__individualLightData))::ArrayW<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__LightIntensitiesWithId*,
                                                                 ::Array<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__LightIntensitiesWithId*>*> _individualLightData;
  ...
  __declspec(property(get = __get__groupLightsWeighting, put = __set__groupLightsWeighting))::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting _groupLightsWeighting;
  ...
  constexpr void
  __set__groupLightData(::ArrayW<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData*, ::Array<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData*>*> value);
  ...
  constexpr ::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting& __get__groupLightsWeighting();

  constexpr ::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting const& __get__groupLightsWeighting() const;

  constexpr void __set__groupLightsWeighting(::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting value);

  static inline ::GlobalNamespace::DirectionalLightWithIdsGroupEntry* New_ctor();

  /// @brief Method .ctor addr 0x1fb9b28 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData*, ::Array<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData*>*> ____groupLightData;

  /// @brief Field _individualLightData, offset: 0x28, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__LightIntensitiesWithId*, ::Array<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__LightIntensitiesWithId*>*>
  ...
  ::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting ____groupLightsWeighting;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightsWeighting, "", "DirectionalLightWithIdsGroupEntry/GroupLightsWeighting");
