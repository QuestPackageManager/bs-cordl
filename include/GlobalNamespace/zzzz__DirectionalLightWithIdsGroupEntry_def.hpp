...
/// @brief Method .ctor, addr 0x56b9484, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::LightGroupSO*  lightGroup) ;

/// @brief Method get_groupIntensity, addr 0x56b947c, size 0x8, virtual false, abstract: false, final false
inline float_t get_groupIntensity() ;

/// @brief Method get_lightGroup, addr 0x56b9474, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b94a4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  lightId, float_t  lightIntensity) ;

/// @brief Method get_intensity, addr 0x56b949c, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_lightId, addr 0x56b9494, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _groupLightData, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__groupLightData, put=__cordl_internal_set__groupLightData)) ::System::Collections::Generic::List_1<::GlobalNamespace::DirectionalLightWithIdsGroupEntry_GroupLightData*>*  _groupLightData;
...
/// @brief Field _individualLightData, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__individualLightData, put=__cordl_internal_set__individualLightData)) ::System::Collections::Generic::List_1<::GlobalNamespace::DirectionalLightWithIdsGroupEntry_LightIntensitiesWithId*>*  _individualLightData;
...
/// @brief Method .ctor, addr 0x56b9470, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_groupLightData, addr 0x56b9458, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_groupLightsWeighting, addr 0x56b9468, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorMixAndWeightingApproach get_groupLightsWeighting() ;

/// @brief Method get_individualLightData, addr 0x56b9460, size 0x8, virtual false, abstract: false, final false
