...
public:
  ...
  /// @brief Method AddPlayerSpecificSettingsToDictionary, addr 0x10ba560, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePlayersSpecificSettingsAtGameStartData, addr 0x10ba5cc, size 0x308, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable* CreatePlayersSpecificSettingsAtGameStartData();

  /// @brief Method Dispose, addr 0x10b9b18, size 0x364, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method ForceStart, addr 0x10ba8d4, size 0x6f0, virtual false, abstract: false, final false
  inline void ForceStart();

  /// @brief Method GetSceneLoadStatus, addr 0x10b9e7c, size 0x6e4, virtual false, abstract: false, final false
  inline void GetSceneLoadStatus();

  /// @brief Method HandleGetGameplaySceneReady, addr 0x10bb38c, size 0xb4, virtual false, abstract: false, final false
  inline void HandleGetGameplaySceneReady(::StringW userId);

  /// @brief Method HandleSetGameplaySceneReady, addr 0x10bafc4, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSetGameplaySceneSyncFinished, addr 0x10bb440, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSetPlayerDidConnectLate, addr 0x10bb4a8, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10b9a30, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method add_sceneSetupDidFinishEvent, addr 0x10b9770, size 0xb0, virtual false, abstract: false, final false
  inline void add_sceneSetupDidFinishEvent(::System::Action_1<::StringW>* value);

  /// @brief Method add_sceneSetupDidReceiveTooLateEvent, addr 0x10b98d0, size 0xb0, virtual false, abstract: false, final false
  inline void add_sceneSetupDidReceiveTooLateEvent(::System::Action_1<::StringW>* value);

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method remove_sceneSetupDidFinishEvent, addr 0x10b9820, size 0xb0, virtual false, abstract: false, final false
  inline void remove_sceneSetupDidFinishEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_sceneSetupDidReceiveTooLateEvent, addr 0x10b9980, size 0xb0, virtual false, abstract: false, final false
