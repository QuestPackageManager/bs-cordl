...
public:
// Declarations
/// @brief Method CreateJobReflectionData, addr 0x638dc48, size 0x30c, virtual false, abstract: false, final false
static inline void CreateJobReflectionData() ;

/// @brief Method EarlyInit, addr 0x638df54, size 0x4, virtual false, abstract: false, final false
