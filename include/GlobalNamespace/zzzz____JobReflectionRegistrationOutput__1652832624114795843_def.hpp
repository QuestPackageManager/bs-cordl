...
public:
  // Declarations
  /// @brief Method CreateJobReflectionData, addr 0x638c0d0, size 0x30c, virtual false, abstract: false, final false
  static inline void CreateJobReflectionData();

  /// @brief Method EarlyInit, addr 0x638c3dc, size 0x4, virtual false, abstract: false, final false
