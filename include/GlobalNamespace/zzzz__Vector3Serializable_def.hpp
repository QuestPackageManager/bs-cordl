...
public:
  ...
  /// @brief Method Approximately, addr 0x2720af4, size 0x60, virtual false, abstract: false, final false
  inline bool Approximately(::GlobalNamespace::Vector3Serializable other);

  /// @brief Method Deserialize, addr 0x271e3a8, size 0x64, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x2720b54, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2720ac0, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::Vector3Serializable other);

  /// @brief Method GetHashCode, addr 0x2720bec, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSize, addr 0x2720d3c, size 0x84, virtual false, abstract: false, final false
  inline int32_t GetSize();

  /// @brief Method Serialize, addr 0x271e5b4, size 0x84, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToString, addr 0x2720c14, size 0x128, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x272107c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method .ctor, addr 0x2720df4, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x27210b0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x271ea04, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2721088, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 op_Implicit___UnityEngine__Vector3(::GlobalNamespace::Vector3Serializable v);

  /// @brief Method op_Subtraction, addr 0x27210cc, size 0x1c, virtual false, abstract: false, final false
