...
/// @brief Method ColorWasSet, addr 0x56b94b0, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b94cc, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
