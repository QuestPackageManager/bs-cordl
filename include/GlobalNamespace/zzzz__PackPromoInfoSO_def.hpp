...
public:
  ...
  /// @brief Method .ctor, addr 0x366cbb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW levelID, ::GlobalNamespace::PromoBannerInfoSO* promoBannerInfo);

  /// @brief Method get_levelID, addr 0x366cba0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelID();

  /// @brief Method get_promoBannerInfo, addr 0x366cba8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::PromoBannerInfoSO> get_promoBannerInfo();

  /// @brief Method set_promoBannerInfo, addr 0x366cbb0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddLevelPromoInfo, addr 0x366caa0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x366cb98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_hasLevelPromos, addr 0x366ca80, size 0x20, virtual false, abstract: false, final false
  inline bool get_hasLevelPromos();

  /// @brief Method get_levelPromoInfos, addr 0x366c9dc, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_promoBannerInfo, addr 0x366c9cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::PromoBannerInfoSO> get_promoBannerInfo();

  /// @brief Method set_promoBannerInfo, addr 0x366c9d4, size 0x8, virtual false, abstract: false, final false
  inline void set_promoBannerInfo(::GlobalNamespace::PromoBannerInfoSO* value);
