...
public:
  ...
  /// @brief Method PackTextures, addr 0x58e1fa4, size 0x378, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BakedLightTexturePacking", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BakedLightTexturePacking(BakedLightTexturePacking&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BakedLightTexturePacking", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BakedLightTexturePacking(BakedLightTexturePackingconst&) = delete;
