...
// Write type traits
MARK_REF_T(::GlobalNamespace::SimpleTemporalFiltering*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SimpleTemporalFiltering*, "", "SimpleTemporalFiltering");
// Dependencies System.Object, UnityEngine.RenderTexture
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method CreateRenderTexturesIfNeeded, addr 0x5f4f07c, size 0x298, virtual false, abstract: false, final false
  inline void CreateRenderTexturesIfNeeded(int32_t width, int32_t height);

  /// @brief Method FilterTexture, addr 0x5f4ef08, size 0x174, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> const& __cordl_internal_get__temporalFilteringTextures() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>>& __cordl_internal_get__temporalFilteringTextures();
  ...
  /// @brief Method .ctor, addr 0x5f4ee4c, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SimpleTemporalFiltering", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SimpleTemporalFiltering(SimpleTemporalFiltering&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SimpleTemporalFiltering", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SimpleTemporalFiltering(SimpleTemporalFilteringconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::SimpleTemporalFiltering) == 0x30, "Size mismatch!");
