...
public:
  ...
  /// @brief Method CreateRenderTexturesIfNeeded, addr 0x5d9a798, size 0x298, virtual false, abstract: false, final false
  inline void CreateRenderTexturesIfNeeded(int32_t width, int32_t height);

  /// @brief Method FilterTexture, addr 0x5d9a624, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d9a568, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
