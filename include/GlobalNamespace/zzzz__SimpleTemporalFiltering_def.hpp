...
public:
  ...
  /// @brief Method CreateRenderTexturesIfNeeded, addr 0x2adba28, size 0x28c, virtual false, abstract: false, final false
  inline void CreateRenderTexturesIfNeeded(int32_t width, int32_t height);

  /// @brief Method FilterTexture, addr 0x2adb8a8, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2adb7dc, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
