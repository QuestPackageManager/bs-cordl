...
public:
  ...
  /// @brief Method CreateRenderTexturesIfNeeded, addr 0x2ad9a2c, size 0x28c, virtual false, abstract: false, final false
  inline void CreateRenderTexturesIfNeeded(int32_t width, int32_t height);

  /// @brief Method FilterTexture, addr 0x2ad98ac, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ad97e0, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
