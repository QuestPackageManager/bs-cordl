...
public:
  ...
  /// @brief Method CreateRenderTexturesIfNeeded, addr 0x408af78, size 0x28c, virtual false, abstract: false, final false
  inline void CreateRenderTexturesIfNeeded(int32_t width, int32_t height);

  /// @brief Method FilterTexture, addr 0x408adf8, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408ad34, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
