...
public:
  // Declarations
  /// @brief Method CreateReportDescriptor, addr 0x26bba3c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTimestamp, addr 0x26bb9ec, size 0x50, virtual false, abstract: false, final false
  static inline ::StringW CreateTimestamp(::System::DateTime timestamp);

  /// @brief Method ListAggregatedFps, addr 0x26bb6c8, size 0x324, virtual false, abstract: false, final false
  static inline ::StringW ListAggregatedFps(::ArrayW<float_t, ::Array<float_t>*> frameDurations, float_t minWindowSize);

  /// @brief Method ListFrameDurations, addr 0x26bb5b4, size 0x114, virtual false, abstract: false, final false
