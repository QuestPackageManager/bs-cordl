...
public:
// Declarations
/// @brief Method CreateReportDescriptor, addr 0x5763d40, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method CreateTimestamp, addr 0x5763cc4, size 0x7c, virtual false, abstract: false, final false
static inline ::StringW CreateTimestamp(::System::DateTime  timestamp) ;

/// @brief Method ListAggregatedFps, addr 0x57639ac, size 0x318, virtual false, abstract: false, final false
static inline ::StringW ListAggregatedFps(::ArrayW<float_t,::Array<float_t>*>  frameDurations, float_t  minWindowSize) ;

/// @brief Method ListFrameTimes, addr 0x5763890, size 0x11c, virtual false, abstract: false, final false
static inline ::StringW ListFrameTimes(::ArrayW<float_t,::Array<float_t>*>  frameTimes) ;

/// @brief Method ListStat, addr 0x5764498, size 0x11c, virtual false, abstract: false, final false
static inline ::StringW ListStat(::ArrayW<float_t,::Array<float_t>*>  statList) ;

/// @brief Method ListStat, addr 0x57645b4, size 0x104, virtual false, abstract: false, final false
