...
public:
  // Declarations
  /// @brief Method CreateReportDescriptor, addr 0x3b1fb64, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTimestamp, addr 0x3b1faf0, size 0x74, virtual false, abstract: false, final false
  static inline ::StringW CreateTimestamp(::System::DateTime timestamp);

  /// @brief Method ListAggregatedFps, addr 0x3b1f7dc, size 0x314, virtual false, abstract: false, final false
  static inline ::StringW ListAggregatedFps(::ArrayW<float_t, ::Array<float_t>*> frameDurations, float_t minWindowSize);

  /// @brief Method ListFrameDurations, addr 0x3b1f6c0, size 0x11c, virtual false, abstract: false, final false
  static inline ::StringW ListFrameDurations(::ArrayW<float_t, ::Array<float_t>*> frameDurations);

  /// @brief Method ListStat, addr 0x3b20228, size 0x11c, virtual false, abstract: false, final false
  static inline ::StringW ListStat(::ArrayW<float_t, ::Array<float_t>*> statList);

  /// @brief Method ListStat, addr 0x3b20344, size 0x104, virtual false, abstract: false, final false
