...
public:
  ...
  /// @brief Method OnEnable, addr 0x28f0770, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x28f0774, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetGlobalParameters, addr 0x28f0660, size 0x110, virtual false, abstract: false, final false
  inline void SetGlobalParameters();

  /// @brief Method Start, addr 0x28f065c, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x28f0778, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_fakeMirrorTransparency, addr 0x28f064c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_fakeMirrorTransparency, addr 0x28f0654, size 0x8, virtual false, abstract: false, final false
