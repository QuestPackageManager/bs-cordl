...
inline void GlobalNamespace::__AsyncCachedLoader_2__ScheduledTask<TKey, TValue>::_ctor(TKey keyId, ::System::Threading::Tasks::TaskCompletionSource_1<TValue>* taskCompletionSource,
  ...
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__AsyncCachedLoader_2__ScheduledTask<TKey, TValue>>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
inline void GlobalNamespace::__AsyncCachedLoader_2___LoadAsync_d__7<TKey, TValue>::SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__AsyncCachedLoader_2___LoadAsync_d__7<TKey, TValue>>::get(), "SetStateMachine",
...
inline void GlobalNamespace::__AsyncCachedLoader_2___LoadAllAsync_d__8<TKey, TValue>::SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__AsyncCachedLoader_2___LoadAllAsync_d__8<TKey, TValue>>::get(), "SetStateMachine",
                                  std::span<Il2CppClass const* const, 0>(),
                                  ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Runtime::CompilerServices::IAsyncStateMachine*>::get() })));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, stateMachine);
}
...
GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_get__scheduledTaskList() {
...
GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_get__scheduledTaskList() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____scheduledTaskList;
}
template <typename TKey, typename TValue>
constexpr void GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_set__scheduledTaskList(
    ::System::Collections::Generic::List_1<::GlobalNamespace::__AsyncCachedLoader_2__ScheduledTask<TKey, TValue>>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template <typename TKey, typename TValue>
constexpr ::System::Func_3<TKey, ::System::Threading::CancellationToken, ::System::Threading::Tasks::Task_1<TValue>*>*&
GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_get__resultValueFunc() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_get__resultValueFunc() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____resultValueFunc;
}
template <typename TKey, typename TValue>
constexpr void GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_set__resultValueFunc(
    ::System::Func_3<TKey, ::System::Threading::CancellationToken, ::System::Threading::Tasks::Task_1<TValue>*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template <typename TKey, typename TValue> constexpr bool& GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_get__isLoading() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____isLoading;
}
template <typename TKey, typename TValue> constexpr bool const& GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_get__isLoading() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____isLoading;
}
template <typename TKey, typename TValue> constexpr void GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::__cordl_internal_set__isLoading(bool value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template <typename TKey, typename TValue> inline void GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::ClearCache() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>*>::get(),
                                                                             "ClearCache", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
template <typename TKey, typename TValue>
...
GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::New_ctor(int32_t maxNumberCachedElements,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>*>(maxNumberCachedElements, resultValueFunc));
}
template <typename TKey, typename TValue>
inline void GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::_ctor(int32_t maxNumberCachedElements,
                                                                      ::System::Func_3<TKey, ::System::Threading::CancellationToken, ::System::Threading::Tasks::Task_1<TValue>*>* resultValueFunc) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
inline ::System::Threading::Tasks::Task_1<TValue>* GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::LoadAsync(TKey keyId, ::System::Threading::CancellationToken cancellationToken) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>*>::get(), "LoadAsync", std::span<Il2CppClass const* const, 0>(),
...
template <typename TKey, typename TValue> inline void GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>::LoadAllAsync() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::AsyncCachedLoader_2<TKey, TValue>*>::get(),
                                                                             "LoadAllAsync", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
// Ctor Parameters []
