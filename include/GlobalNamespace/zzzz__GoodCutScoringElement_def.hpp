...
public:
  ...
  /// @brief Method .ctor, addr 0x58bde3c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method HandleCutScoreBufferDidFinish, addr 0x58bddc4, size 0x20, virtual true, abstract: false, final true
  inline void HandleCutScoreBufferDidFinish(::GlobalNamespace::CutScoreBuffer* cutScoreBuffer);

  /// @brief Method Init, addr 0x58bd5a4, size 0x70, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::NoteCutInfo noteCutInfo);

  static inline ::GlobalNamespace::GoodCutScoringElement* New_ctor();

  /// @brief Method Reinitialize, addr 0x58bddac, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58bdde4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cutScore, addr 0x58bdd20, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_cutScore();

  /// @brief Method get_cutScoreBuffer, addr 0x58bdd6c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IReadonlyCutScoreBuffer* get_cutScoreBuffer();

  /// @brief Method get_executionOrder, addr 0x58bdd74, size 0x38, virtual true, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_multiplierEventType, addr 0x58bdd64, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::ScoreMultiplierCounter_MultiplierEventType get_multiplierEventType();

  /// @brief Method get_wouldBeCorrectCutBestPossibleMultiplierEventType, addr 0x58bdd5c, size 0x8, virtual true, abstract: false, final false
