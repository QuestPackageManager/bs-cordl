...
public:
  ...
  /// @brief Method get_cutScore, addr 0x23c6bdc, size 0x40, virtual true, abstract: false, final false
  inline int32_t get_cutScore();

  /// @brief Method get_wouldBeCorrectCutBestPossibleMultiplierEventType, addr 0x23c6c1c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_multiplierEventType, addr 0x23c6c24, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType get_multiplierEventType();

  /// @brief Method get_cutScoreBuffer, addr 0x23c6c2c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IReadonlyCutScoreBuffer* get_cutScoreBuffer();

  /// @brief Method get_executionOrder, addr 0x23c6c34, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method Reinitialize, addr 0x23c6c58, size 0x18, virtual true, abstract: false, final false
  inline void Reinitialize();

  /// @brief Method Init, addr 0x23c6728, size 0x70, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::NoteCutInfo noteCutInfo);

  /// @brief Method HandleCutScoreBufferDidFinish, addr 0x23c6c70, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23c6c94, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(4660)), TypeDefinitionIndex(TypeDefinitionIndex(4663)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4660), inst: 2784
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(4662)) CS Name: ::GoodCutScoringElement::Pool*
...
public:
  ...
  /// @brief Method .ctor, addr 0x23c6cf8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
