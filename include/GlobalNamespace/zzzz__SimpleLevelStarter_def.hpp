...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b3adfc, size 0x610, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::SimpleLevelStarter__StartLevel_d__17* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b3b40c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b3b414, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b3b44c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3b3adf8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b3aa3c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x3b3a8c8, size 0xc0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ButtonPressed, addr 0x3b3ab8c, size 0x20, virtual false, abstract: false, final false
  inline void ButtonPressed();

  /// @brief Method HandleLevelDidFinish, addr 0x3b3abac, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method InstallEarlyBindings, addr 0x3b3aa64, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b3a988, size 0x54, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method StartLevel, addr 0x3b3a9dc, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* StartLevel();

  /// @brief Method <StartLevel>g__AfterSceneSwitchCallback|17_0, addr 0x3b3acc0, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3abe8, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();
