...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(10802)), TypeDefinitionIndex(TypeDefinitionIndex(14046)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14046), inst: 777 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5359)) CS Name: ::SimpleLevelStarter::<StartLevel>d__17*
...
public:
  ...
  /// @brief Method .ctor, addr 0x234d154, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x234d514, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x234d518, size 0x6d0, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x234dbe8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x234dbf0, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x234dc30, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Awake, addr 0x234cfd4, size 0xc4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method OnDestroy, addr 0x234d098, size 0x54, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method StartLevel, addr 0x234d0ec, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* StartLevel();

  /// @brief Method InstallEarlyBindings, addr 0x234d17c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ButtonPressed, addr 0x234d2a4, size 0x20, virtual false, abstract: false, final false
  inline void ButtonPressed();

  /// @brief Method HandleLevelDidFinish, addr 0x234d2c4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x234d300, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <StartLevel>g__AfterSceneSwitchCallback|17_0, addr 0x234d3d8, size 0x13c, virtual false, abstract: false, final false
