...
public:
  ...
  /// @brief Method .ctor addr 0x235958c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetGameStateAndConfigurationAsync>g__HandleSetMultiplayerGameState|0 addr 0x235ae3c size 0x264 virtual false final false
  ...
  /// @brief Method <GetGameStateAndConfigurationAsync>g__HandleSetPlayerPermissionConfiguration|1 addr 0x235b0a0 size 0x1ec virtual false final false
  inline void
  ...
  /// @brief Method <GetGameStateAndConfigurationAsync>b__2 addr 0x235b2d0 size 0xc8 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x235b3fc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <PredictCountdownEndTime>b__99_0 addr 0x235b404 size 0x118 virtual false final false
...
public:
  ...
  /// @brief Method add_selectedLevelGameplaySetupDataChangedEvent addr 0x23564d4 size 0xb0 virtual true final true
  inline void add_selectedLevelGameplaySetupDataChangedEvent(::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>* value);

  /// @brief Method remove_selectedLevelGameplaySetupDataChangedEvent addr 0x2356584 size 0xb0 virtual true final true
  ...
  /// @brief Method add_gameStartedEvent addr 0x2356634 size 0xb0 virtual true final true
  inline void add_gameStartedEvent(::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>* value);

  /// @brief Method remove_gameStartedEvent addr 0x23566e4 size 0xb0 virtual true final true
  inline void remove_gameStartedEvent(::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>* value);

  /// @brief Method add_gameStartCancelledEvent addr 0x2356794 size 0x9c virtual true final true
  inline void add_gameStartCancelledEvent(::System::Action* value);

  /// @brief Method remove_gameStartCancelledEvent addr 0x2356830 size 0x9c virtual true final true
  inline void remove_gameStartCancelledEvent(::System::Action* value);

  /// @brief Method add_countdownStartedEvent addr 0x23568cc size 0x9c virtual true final true
  inline void add_countdownStartedEvent(::System::Action* value);

  /// @brief Method remove_countdownStartedEvent addr 0x2356968 size 0x9c virtual true final true
  inline void remove_countdownStartedEvent(::System::Action* value);

  /// @brief Method add_countdownCancelledEvent addr 0x2356a04 size 0x9c virtual true final true
  inline void add_countdownCancelledEvent(::System::Action* value);

  /// @brief Method remove_countdownCancelledEvent addr 0x2356aa0 size 0x9c virtual true final true
  inline void remove_countdownCancelledEvent(::System::Action* value);

  /// @brief Method add_songStillDownloadingEvent addr 0x2356b3c size 0x9c virtual true final true
  inline void add_songStillDownloadingEvent(::System::Action* value);

  /// @brief Method remove_songStillDownloadingEvent addr 0x2356bd8 size 0x9c virtual true final true
  inline void remove_songStillDownloadingEvent(::System::Action* value);

  /// @brief Method add_startTimeChangedEvent addr 0x2356c74 size 0x9c virtual true final true
  inline void add_startTimeChangedEvent(::System::Action* value);

  /// @brief Method remove_startTimeChangedEvent addr 0x2356d10 size 0x9c virtual true final true
  inline void remove_startTimeChangedEvent(::System::Action* value);

  /// @brief Method add_levelFinishedEvent addr 0x2356dac size 0xb0 virtual true final true
  ...
  /// @brief Method remove_levelFinishedEvent addr 0x2356e5c size 0xb0 virtual true final true
  ...
  /// @brief Method add_levelDidGetDisconnectedEvent addr 0x2356f0c size 0xb0 virtual true final true
  inline void add_levelDidGetDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_levelDidGetDisconnectedEvent addr 0x2356fbc size 0xb0 virtual true final true
  inline void remove_levelDidGetDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_lobbyDisconnectedEvent addr 0x235706c size 0x9c virtual true final true
  inline void add_lobbyDisconnectedEvent(::System::Action* value);

  /// @brief Method remove_lobbyDisconnectedEvent addr 0x2357108 size 0x9c virtual true final true
  inline void remove_lobbyDisconnectedEvent(::System::Action* value);

  /// @brief Method add_beforeSceneSwitchCallbackEvent addr 0x23571a4 size 0x9c virtual true final true
  inline void add_beforeSceneSwitchCallbackEvent(::System::Action* value);

  /// @brief Method remove_beforeSceneSwitchCallbackEvent addr 0x2357240 size 0x9c virtual true final true
  inline void remove_beforeSceneSwitchCallbackEvent(::System::Action* value);

  /// @brief Method add_lobbyStateChangedEvent addr 0x23572dc size 0xb0 virtual true final true
  inline void add_lobbyStateChangedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLobbyState>* value);

  /// @brief Method remove_lobbyStateChangedEvent addr 0x235738c size 0xb0 virtual true final true
  inline void remove_lobbyStateChangedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLobbyState>* value);

  /// @brief Method add_startButtonEnabledEvent addr 0x235743c size 0xb0 virtual true final true
  inline void add_startButtonEnabledEvent(::System::Action_1<::GlobalNamespace::CannotStartGameReason>* value);

  /// @brief Method remove_startButtonEnabledEvent addr 0x23574ec size 0xb0 virtual true final true
  inline void remove_startButtonEnabledEvent(::System::Action_1<::GlobalNamespace::CannotStartGameReason>* value);

  /// @brief Method add_playerMissingEntitlementsChangedEvent addr 0x235759c size 0xb0 virtual true final true
  ...
  /// @brief Method remove_playerMissingEntitlementsChangedEvent addr 0x235764c size 0xb0 virtual true final true
  ...
  /// @brief Method get_predictedCountdownEndTime addr 0x23576fc size 0x8 virtual true final true
  inline int64_t get_predictedCountdownEndTime();

  /// @brief Method get_startTime addr 0x2357704 size 0x8 virtual true final true
  inline int64_t get_startTime();

  /// @brief Method set_startTime addr 0x235770c size 0x20 virtual false final false
  inline void set_startTime(int64_t value);

  /// @brief Method get_levelStartInitiated addr 0x235772c size 0x8 virtual true final true
  inline bool get_levelStartInitiated();

  /// @brief Method set_levelStartInitiated addr 0x2357734 size 0xc virtual false final false
  inline void set_levelStartInitiated(bool value);

  /// @brief Method get_selectedLevelGameplaySetupData addr 0x2357740 size 0x8 virtual true final true
  inline ::GlobalNamespace::ILevelGameplaySetupData* get_selectedLevelGameplaySetupData();

  /// @brief Method get_countdownStarted addr 0x2357748 size 0x8 virtual true final true
  inline bool get_countdownStarted();

  /// @brief Method set_countdownStarted addr 0x2357750 size 0xc virtual false final false
  inline void set_countdownStarted(bool value);

  /// @brief Method get_countdownEndTime addr 0x235775c size 0x8 virtual true final true
  inline int64_t get_countdownEndTime();

  /// @brief Method set_countdownEndTime addr 0x2357764 size 0x8 virtual false final false
  inline void set_countdownEndTime(int64_t value);

  /// @brief Method get_state addr 0x235776c size 0x8 virtual true final true
  inline ::GlobalNamespace::MultiplayerLobbyState get_state();

  /// @brief Method set_state addr 0x2357774 size 0x2c virtual true final true
  inline void set_state(::GlobalNamespace::MultiplayerLobbyState value);

  /// @brief Method get_cannotStartGameReason addr 0x23577a0 size 0x8 virtual true final true
  inline ::GlobalNamespace::CannotStartGameReason get_cannotStartGameReason();

  /// @brief Method get_isDisconnected addr 0x23577a8 size 0x8 virtual true final true
  inline bool get_isDisconnected();

  /// @brief Method set_isDisconnected addr 0x23577b0 size 0xc virtual false final false
  inline void set_isDisconnected(bool value);

  /// @brief Method get_disconnectedReason addr 0x23577bc size 0x8 virtual true final true
  inline ::GlobalNamespace::DisconnectedReason get_disconnectedReason();

  /// @brief Method set_disconnectedReason addr 0x23577c4 size 0x8 virtual false final false
  inline void set_disconnectedReason(::GlobalNamespace::DisconnectedReason value);

  /// @brief Method Activate addr 0x23577cc size 0x898 virtual true final true
  inline void Activate();

  /// @brief Method Deactivate addr 0x2358064 size 0x94c virtual true final true
  inline void Deactivate();

  /// @brief Method Dispose addr 0x23589ec size 0x4 virtual true final true
  inline void Dispose();

  /// @brief Method StartListeningToGameStart addr 0x23589f0 size 0x6cc virtual true final true
  inline void StartListeningToGameStart();

  /// @brief Method GetCurrentLevelIfGameStarted addr 0x23590bc size 0xa4 virtual true final true
  inline void GetCurrentLevelIfGameStarted();

  /// @brief Method ClearDisconnectedState addr 0x23589dc size 0x10 virtual true final true
  inline void ClearDisconnectedState();

  /// @brief Method GetGameStateAndConfigurationAsync addr 0x2359160 size 0x42c virtual true final true
  ...
  /// @brief Method PredictCountdownEndTime addr 0x2359594 size 0x198 virtual true final true
  inline void PredictCountdownEndTime();

  /// @brief Method IsCloseToStartGame addr 0x235972c size 0xc8 virtual true final true
  inline bool IsCloseToStartGame();

  /// @brief Method HandleMultiplayerSessionManagerDisconnected addr 0x23597f4 size 0x28 virtual false final false
  inline void HandleMultiplayerSessionManagerDisconnected(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method HandleMultiplayerSessionManagerConnectionOwnerStateChanged addr 0x235981c size 0xf8 virtual false final false
  inline void HandleMultiplayerSessionManagerConnectionOwnerStateChanged(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method StopListeningToGameStart addr 0x2359914 size 0x26c virtual false final false
  inline void StopListeningToGameStart();

  /// @brief Method HandleMenuRpcManagerStartedLevel addr 0x2359b80 size 0x28c virtual false final false
  ...
  /// @brief Method HandleMenuRpcManagerCancelledLevelStart addr 0x2359e0c size 0x88 virtual false final false
  inline void HandleMenuRpcManagerCancelledLevelStart(::StringW userId);

  /// @brief Method HandleMenuRpcManagerSetCountdownEndTime addr 0x2359f98 size 0x238 virtual false final false
  inline void HandleMenuRpcManagerSetCountdownEndTime(::StringW userId, int64_t countdownTime);

  /// @brief Method HandleMenuRpcManagerCancelCountdown addr 0x235a1d0 size 0x228 virtual false final false
  inline void HandleMenuRpcManagerCancelCountdown(::StringW userId);

  /// @brief Method HandleMenuRpcManagerSetStartGameTime addr 0x235a3f8 size 0x48 virtual false final false
  inline void HandleMenuRpcManagerSetStartGameTime(::StringW userId, int64_t startTime);

  /// @brief Method HandleSetIsStartButtonEnabled addr 0x235a440 size 0x28 virtual false final false
  inline void HandleSetIsStartButtonEnabled(::StringW userId, ::GlobalNamespace::CannotStartGameReason cannotStartGameReason);

  /// @brief Method HandleMenuRpcManagerSetPlayersMissingEntitlementsToLevel addr 0x235a468 size 0x24 virtual false final false
  ...
  /// @brief Method HandleStartTimeChanged addr 0x235a48c size 0x20 virtual false final false
  inline void HandleStartTimeChanged();

  /// @brief Method HandleMultiplayerLevelLoaderStillDownloadingSong addr 0x235a4ac size 0x1c virtual false final false
  inline void HandleMultiplayerLevelLoaderStillDownloadingSong();

  /// @brief Method HandleMenuRpcManagerSetSelectedBeatmap addr 0x235a4c8 size 0x60 virtual false final false
  ...
  /// @brief Method HandleMenuRpcManagerSetSelectedGameplayModifiers addr 0x235a528 size 0x44 virtual false final false
  inline void HandleMenuRpcManagerSetSelectedGameplayModifiers(::StringW userId, ::GlobalNamespace::GameplayModifiers* modifiers);

  /// @brief Method HandleMenuRpcManagerClearSelectedBeatmap addr 0x235a56c size 0x38 virtual false final false
  inline void HandleMenuRpcManagerClearSelectedBeatmap(::StringW userId);

  /// @brief Method HandleMenuRpcManagerClearSelectedGameplayModifiers addr 0x235a5a4 size 0x44 virtual false final false
  inline void HandleMenuRpcManagerClearSelectedGameplayModifiers(::StringW userId);

  /// @brief Method HandleMultiplayerLevelLoaderCountdownFinished addr 0x235a5e8 size 0x33c virtual false final false
  ...
  /// @brief Method StartMultiplayerLevel addr 0x235a92c size 0x368 virtual false final false
  ...
  /// @brief Method HandleMultiplayerLevelDidFinish addr 0x235aca8 size 0x94 virtual false final false
  ...
  /// @brief Method HandleMultiplayerLevelDidDisconnect addr 0x235ad3c size 0x8c virtual false final false
  inline void HandleMultiplayerLevelDidDisconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method StopLoading addr 0x2359e94 size 0x104 virtual false final false
  inline void StopLoading();

  static inline ::GlobalNamespace::LobbyGameStateController* New_ctor();

  /// @brief Method .ctor addr 0x235adc8 size 0x74 virtual false final false
  inline void _ctor();
