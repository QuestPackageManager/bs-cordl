...
public:
  ...
  /// @brief Method .ctor, addr 0x363d9ec, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelPacksEntitlements, addr 0x363d9dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MockPlatformEntitlement*>* get_levelPacksEntitlements();

  /// @brief Method get_levelsEntitlements, addr 0x363d9d4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MockPlatformEntitlement*>* get_levelsEntitlements();

  /// @brief Method get_packBetterBuyThanLevel, addr 0x363d9e4, size 0x8, virtual false, abstract: false, final false
