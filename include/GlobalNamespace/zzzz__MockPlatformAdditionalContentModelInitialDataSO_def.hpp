...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockPlatformAdditionalContentModelInitialDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockPlatformAdditionalContentModelInitialDataSO*, "", "MockPlatformAdditionalContentModelInitialDataSO");
// Dependencies MockPlatformEntitlement, PersistentScriptableObject
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  constexpr ::ArrayW<::GlobalNamespace::MockPlatformEntitlement*> const& __cordl_internal_get__levelPacksEntitlements() const;

  constexpr ::ArrayW<::GlobalNamespace::MockPlatformEntitlement*>& __cordl_internal_get__levelPacksEntitlements();

  constexpr ::ArrayW<::GlobalNamespace::MockPlatformEntitlement*> const& __cordl_internal_get__levelsEntitlements() const;

  constexpr ::ArrayW<::GlobalNamespace::MockPlatformEntitlement*>& __cordl_internal_get__levelsEntitlements();
