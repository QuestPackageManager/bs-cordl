...
public:
  ...
  /// @brief Method get_levelsEntitlements addr 0x2235244 size 0x8 virtual false final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MockPlatformEntitlement*>* get_levelsEntitlements();

  /// @brief Method get_levelPacksEntitlements addr 0x223524c size 0x8 virtual false final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MockPlatformEntitlement*>* get_levelPacksEntitlements();

  /// @brief Method get_packBetterBuyThanLevel addr 0x2235254 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x223525c size 0x10 virtual false final false
  inline void _ctor();
