...
public:
  ...
  /// @brief Method .ctor, addr 0x35d6c14, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelPacksEntitlements, addr 0x35d6c04, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MockPlatformEntitlement*>* get_levelPacksEntitlements();

  /// @brief Method get_levelsEntitlements, addr 0x35d6bfc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MockPlatformEntitlement*>* get_levelsEntitlements();

  /// @brief Method get_packBetterBuyThanLevel, addr 0x35d6c0c, size 0x8, virtual false, abstract: false, final false
