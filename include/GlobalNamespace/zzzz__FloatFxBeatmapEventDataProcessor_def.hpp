...
/// @brief Method UpdateByOther, addr 0x3194b5c, size 0x28, virtual true, abstract: false, final false
inline void UpdateByOther(::GlobalNamespace::FloatFxBeatmapEventData*  current, ::GlobalNamespace::FloatFxBeatmapEventData*  other) ;

/// @brief Method .ctor, addr 0x3194b84, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
