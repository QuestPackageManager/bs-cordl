...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14732)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14743), inst: 2548 }),
// TypeDefinitionIndex(TypeDefinitionIndex(14743))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14744)) CS Name: ::FloatFxBeatmapEventDataProcessor*
