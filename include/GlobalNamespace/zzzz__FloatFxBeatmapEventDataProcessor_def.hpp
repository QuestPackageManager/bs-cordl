...
public:
  ...
  /// @brief Method UpdateByOther, addr 0x31c7380, size 0x28, virtual true, abstract: false, final false
  inline void UpdateByOther(::GlobalNamespace::FloatFxBeatmapEventData* current, ::GlobalNamespace::FloatFxBeatmapEventData* other);

  /// @brief Method .ctor, addr 0x31c73a8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
