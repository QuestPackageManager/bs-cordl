...
public:
  ...
  /// @brief Method .ctor, addr 0x26a844c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_achievementId, addr 0x26a8444, size 0x8, virtual false, abstract: false, final false
