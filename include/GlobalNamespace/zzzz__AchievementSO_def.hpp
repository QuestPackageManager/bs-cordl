...
/// @brief Method .ctor, addr 0x363c3ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_achievementId, addr 0x363c3a4, size 0x8, virtual false, abstract: false, final false
