...
// Write type traits
MARK_REF_T(::GlobalNamespace::AchievementSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AchievementSO*, "", "AchievementSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36fb348, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_achievementId, addr 0x36fb340, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AchievementSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AchievementSO(AchievementSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AchievementSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AchievementSO(AchievementSOconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::AchievementSO) == 0x20, "Size mismatch!");
