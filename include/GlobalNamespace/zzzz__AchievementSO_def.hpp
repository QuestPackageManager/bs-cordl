...
public:
  ...
  /// @brief Method .ctor, addr 0x26a05dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_achievementId, addr 0x26a05d4, size 0x8, virtual false, abstract: false, final false
