...
public:
  ...
  /// @brief Method .ctor, addr 0x26a404c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_achievementId, addr 0x26a4044, size 0x8, virtual false, abstract: false, final false
