...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14741), inst: 949 }), TypeDefinitionIndex(TypeDefinitionIndex(14741)),
// TypeDefinitionIndex(TypeDefinitionIndex(14721))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14740)) CS Name: ::BasicBeatmapEventDataProcessor*
