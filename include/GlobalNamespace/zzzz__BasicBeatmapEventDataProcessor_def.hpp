...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15105)), TypeDefinitionIndex(TypeDefinitionIndex(15125)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15125), inst:
// 945 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(15124)) CS Name: ::BasicBeatmapEventDataProcessor*
...
public:
  // Declarations
  /// @brief Method ProcessInsertedEventDataInternal, addr 0xe0f97c, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBeforeDeleteEventDataInternal, addr 0xe0fb64, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe0fd98, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
