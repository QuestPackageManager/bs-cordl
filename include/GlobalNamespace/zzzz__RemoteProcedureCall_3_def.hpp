...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RemoteProcedureCall_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RemoteProcedureCall_3(RemoteProcedureCall_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RemoteProcedureCall_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RemoteProcedureCall_3(RemoteProcedureCall_3const&) = delete;
