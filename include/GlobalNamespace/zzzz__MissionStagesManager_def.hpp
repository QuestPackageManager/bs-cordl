...
public:
  ...
  /// @brief Method <InitStages>b__6_0, addr 0x262a2d4, size 0x18, virtual false, abstract: false, final false
  inline int32_t _InitStages_b__6_0(::GlobalNamespace::MissionStage* stage);

  /// @brief Method .ctor, addr 0x262a2cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InitStages, addr 0x262a11c, size 0x144, virtual false, abstract: false, final false
  inline void InitStages();

  static inline ::GlobalNamespace::MissionStagesManager* New_ctor();

  /// @brief Method UpdateFirtsLockedMissionStage, addr 0x2629844, size 0x7c, virtual false, abstract: false, final false
  inline void UpdateFirtsLockedMissionStage(int32_t numberOfClearedMissions);

  /// @brief Method UpdateStageLockPosition, addr 0x2629ac0, size 0xc, virtual false, abstract: false, final false
  inline void UpdateStageLockPosition();

  /// @brief Method UpdateStageLockPositionAnimated, addr 0x2627a68, size 0xf0, virtual false, abstract: false, final false
  inline void UpdateStageLockPositionAnimated(bool animated, float_t animationDuration);

  /// @brief Method UpdateStageLockText, addr 0x26298c0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262a260, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_firstLockedMissionStage, addr 0x262a114, size 0x8, virtual false, abstract: false, final false
