...
public:
  ...
  /// @brief Method <InitStages>b__6_0, addr 0x3c0eb74, size 0x18, virtual false, abstract: false, final false
  inline int32_t _InitStages_b__6_0(::GlobalNamespace::MissionStage* stage);

  /// @brief Method .ctor, addr 0x3c0eb6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InitStages, addr 0x3c0e900, size 0x144, virtual false, abstract: false, final false
  inline void InitStages();

  static inline ::GlobalNamespace::MissionStagesManager* New_ctor();

  /// @brief Method UpdateFirtsLockedMissionStage, addr 0x3c0e870, size 0x90, virtual false, abstract: false, final false
  inline void UpdateFirtsLockedMissionStage(int32_t numberOfClearedMissions);

  /// @brief Method UpdateStageLockPosition, addr 0x3c0ea44, size 0xc, virtual false, abstract: false, final false
  inline void UpdateStageLockPosition();

  /// @brief Method UpdateStageLockPositionAnimated, addr 0x3c0d444, size 0xf0, virtual false, abstract: false, final false
  inline void UpdateStageLockPositionAnimated(bool animated, float_t animationDuration);

  /// @brief Method UpdateStageLockText, addr 0x3c0ea50, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c0eb08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_firstLockedMissionStage, addr 0x3c0e868, size 0x8, virtual false, abstract: false, final false
