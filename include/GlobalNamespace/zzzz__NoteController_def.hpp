...
/// @brief Method MoveNext, addr 0x572845c, size 0x36c, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::NoteController__DissolveCoroutine_d__69* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x57287c8, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x57287d0, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5728808, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x5728458, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x57283f4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Awake, addr 0x5722e9c, size 0x1e4, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method Dissolve, addr 0x57283fc, size 0x58, virtual true, abstract: false, final true
inline void Dissolve(float_t  duration) ;

/// @brief Method DissolveCoroutine, addr 0x5728390, size 0x64, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* DissolveCoroutine(float_t  duration) ;

/// @brief Method HandleNoteDidFinishJump, addr 0x5727e58, size 0x1bc, virtual false, abstract: false, final false
inline void HandleNoteDidFinishJump() ;

/// @brief Method HandleNoteDidPassJumpThreeQuarters, addr 0x5728014, size 0x1c4, virtual false, abstract: false, final false
inline void HandleNoteDidPassJumpThreeQuarters(::GlobalNamespace::NoteMovement*  noteMovement) ;

/// @brief Method HandleNoteDidPassMissedMarkerEvent, addr 0x57281d8, size 0x1c, virtual false, abstract: false, final false
inline void HandleNoteDidPassMissedMarkerEvent() ;

/// @brief Method HandleNoteDidStartJump, addr 0x5727ca4, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method Hide, addr 0x571c220, size 0x14, virtual true, abstract: false, final true
inline void Hide(bool  hide) ;

/// @brief Method Init, addr 0x5722b04, size 0x26c, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::NoteData*  noteData, ::ByRef<::GlobalNamespace::NoteSpawnData>  noteSpawnData, float_t  endRotation, float_t  uniformScale, bool  rotateTowardsPlayer, bool  useRandomRotation) ;

/// @brief Method ManualUpdate, addr 0x5724964, size 0x14, virtual true, abstract: false, final false
inline void ManualUpdate() ;

static inline ::GlobalNamespace::NoteController* New_ctor() ;

/// @brief Method NoteDidFinishJump, addr 0x57281f8, size 0x4, virtual true, abstract: false, final false
inline void NoteDidFinishJump() ;

/// @brief Method NoteDidPassJumpThreeQuarters, addr 0x57281fc, size 0x4, virtual true, abstract: false, final false
inline void NoteDidPassJumpThreeQuarters(::GlobalNamespace::NoteMovement*  noteMovement) ;

/// @brief Method NoteDidPassMissedMarker, addr 0x5728200, size 0x4, virtual true, abstract: false, final false
inline void NoteDidPassMissedMarker() ;

/// @brief Method NoteDidStartDissolving, addr 0x5728204, size 0x4, virtual true, abstract: false, final false
inline void NoteDidStartDissolving() ;

/// @brief Method NoteDidStartJump, addr 0x57281f4, size 0x4, virtual true, abstract: false, final false
inline void NoteDidStartJump() ;

/// @brief Method OnDestroy, addr 0x5723210, size 0x260, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Pause, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void Pause(bool  pause) ;

/// @brief Method SendNoteWasCutEvent, addr 0x5723908, size 0x1a8, virtual false, abstract: false, final false
inline void SendNoteWasCutEvent(::ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

/// @brief Method SendNoteWasMissedEvent, addr 0x57234a0, size 0x1a0, virtual false, abstract: false, final false
inline void SendNoteWasMissedEvent() ;

/// @brief Method Update, addr 0x5727ba8, size 0x10, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5723b04, size 0x2f0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beatPos, addr 0x57274cc, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_beatPos() ;

/// @brief Method get_didInitEvent, addr 0x5727410, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteControllerDidInitEvent*>* get_didInitEvent() ;

/// @brief Method get_dissolving, addr 0x5727618, size 0x8, virtual false, abstract: false, final false
inline bool get_dissolving() ;

/// @brief Method get_hidden, addr 0x5727608, size 0x8, virtual false, abstract: false, final false
inline bool get_hidden() ;

/// @brief Method get_inverseWorldRotation, addr 0x57238e0, size 0x28, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_inverseWorldRotation() ;

/// @brief Method get_jumpStartPos, addr 0x5727520, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_jumpStartPos() ;

/// @brief Method get_moveVec, addr 0x572755c, size 0x64, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_moveVec() ;

/// @brief Method get_noteData, addr 0x5727554, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::NoteData* get_noteData() ;

/// @brief Method get_noteDidDissolveEvent, addr 0x5727448, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteControllerNoteDidDissolveEvent*>* get_noteDidDissolveEvent() ;

/// @brief Method get_noteDidFinishJumpEvent, addr 0x5727420, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_noteDidPassJumpThreeQuartersEvent, addr 0x5727428, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_noteDidStartDissolvingEvent, addr 0x5727440, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_noteDidStartJumpEvent, addr 0x5727418, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteControllerNoteDidStartJumpEvent*>* get_noteDidStartJumpEvent() ;

/// @brief Method get_noteTime, addr 0x5727490, size 0x24, virtual false, abstract: false, final false
inline float_t get_noteTime() ;

/// @brief Method get_noteTransform, addr 0x5727450, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Transform> get_noteTransform() ;

/// @brief Method get_noteWasCutEvent, addr 0x5727430, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteControllerNoteWasCutEvent*>* get_noteWasCutEvent() ;

/// @brief Method get_noteWasMissedEvent, addr 0x5727438, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteControllerNoteWasMissedEvent*>* get_noteWasMissedEvent() ;

/// @brief Method get_uniformScale, addr 0x5727600, size 0x8, virtual false, abstract: false, final false
inline float_t get_uniformScale() ;

/// @brief Method get_worldRotation, addr 0x57238b8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method set_hidden, addr 0x5727610, size 0x8, virtual false, abstract: false, final false
