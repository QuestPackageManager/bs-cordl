...
public:
  ...
  /// @brief Method .ctor, addr 0x2577e40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t value, float_t time);

  /// @brief Method get_time, addr 0x2577e70, size 0x8, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_value, addr 0x2577e60, size 0x8, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method set_time, addr 0x2577e78, size 0x8, virtual false, abstract: false, final false
  inline void set_time(float_t value);

  /// @brief Method set_value, addr 0x2577e68, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetAverageValue, addr 0x2577e48, size 0x8, virtual false, abstract: false, final false
  inline float_t GetAverageValue();

  /// @brief Method GetHistoryValues, addr 0x2577e58, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Queue_1<float_t>* GetHistoryValues();

  /// @brief Method GetLastValue, addr 0x2577e50, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x2577b80, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2577a2c, size 0x154, virtual false, abstract: false, final false
