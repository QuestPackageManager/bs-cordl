...
/// @brief Method .ctor, addr 0x574a8ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor(float_t  value, float_t  time) ;

/// @brief Method get_time, addr 0x574a8dc, size 0x8, virtual false, abstract: false, final false
inline float_t get_time() ;

/// @brief Method get_value, addr 0x574a8cc, size 0x8, virtual false, abstract: false, final false
inline float_t get_value() ;

/// @brief Method set_time, addr 0x574a8e4, size 0x8, virtual false, abstract: false, final false
inline void set_time(float_t  value) ;

/// @brief Method set_value, addr 0x574a8d4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _averageWindowValues, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__averageWindowValues, put=__cordl_internal_set__averageWindowValues)) ::System::Collections::Generic::Queue_1<::GlobalNamespace::AveragingValueRecorder_AverageValueData>*  _averageWindowValues;
...
/// @brief Method GetAverageValue, addr 0x574a8b4, size 0x8, virtual false, abstract: false, final false
inline float_t GetAverageValue() ;

/// @brief Method GetHistoryValues, addr 0x574a8c4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Queue_1<float_t>* GetHistoryValues() ;

/// @brief Method GetLastValue, addr 0x574a8bc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x574a624, size 0x288, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x574a4fc, size 0x128, virtual false, abstract: false, final false
