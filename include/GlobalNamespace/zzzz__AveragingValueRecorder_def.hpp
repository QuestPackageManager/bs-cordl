...
public:
  ...
  /// @brief Method .ctor, addr 0x57ba948, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t value, float_t time);

  /// @brief Method get_time, addr 0x57ba978, size 0x8, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_value, addr 0x57ba968, size 0x8, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method set_time, addr 0x57ba980, size 0x8, virtual false, abstract: false, final false
  inline void set_time(float_t value);

  /// @brief Method set_value, addr 0x57ba970, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetAverageValue, addr 0x57ba950, size 0x8, virtual false, abstract: false, final false
  inline float_t GetAverageValue();

  /// @brief Method GetHistoryValues, addr 0x57ba960, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Queue_1<float_t>* GetHistoryValues();

  /// @brief Method GetLastValue, addr 0x57ba958, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x57ba6c0, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ba598, size 0x128, virtual false, abstract: false, final false
