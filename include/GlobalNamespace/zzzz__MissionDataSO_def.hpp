...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15101)), TypeDefinitionIndex(TypeDefinitionIndex(15602))]
...
public:
  ...
  /// @brief Method get_songName, addr 0x129413c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songName();

  /// @brief Method get_missionObjectives, addr 0x1294144, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::MissionObjective*, ::Array<::GlobalNamespace::MissionObjective*>*> get_missionObjectives();

  /// @brief Method get_beatmapKey, addr 0x129414c, size 0x20, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_beatmapCharacteristic, addr 0x129416c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic();

  /// @brief Method get_beatmapDifficulty, addr 0x1294174, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty();

  /// @brief Method get_gameplayModifiers, addr 0x129417c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_missionHelp, addr 0x1294184, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionHelpSO> get_missionHelp();

  static inline ::GlobalNamespace::MissionDataSO* New_ctor();

  /// @brief Method .ctor, addr 0x129418c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
