...
public:
  ...
  /// @brief Method get_gameplayModifiers, addr 0x2352a34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2352ad0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
