...
public:
  ...
  /// @brief Method get_numberOfClearedMissions, addr 0x1293ccc, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_numberOfClearedMissions();

  /// @brief Method Awake, addr 0x1293e8c, size 0x74, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method IsMissionRegistered, addr 0x1293f00, size 0x58, virtual false, abstract: false, final false
  inline bool IsMissionRegistered(::StringW missionId);

  /// @brief Method RegisterMissionId, addr 0x1293f58, size 0x64, virtual false, abstract: false, final false
  inline void RegisterMissionId(::StringW missionId);

  /// @brief Method IsMissionCleared, addr 0x1293fbc, size 0x30, virtual false, abstract: false, final false
  inline bool IsMissionCleared(::StringW missionId);

  /// @brief Method IsMissionFinal, addr 0x1293fec, size 0xc, virtual false, abstract: false, final false
  inline bool IsMissionFinal(::StringW missionId);

  /// @brief Method SetFinalMissionId, addr 0x1293ff8, size 0x8, virtual false, abstract: false, final false
  inline void SetFinalMissionId(::StringW missionId);

  /// @brief Method WillFinishGameAfterThisMission, addr 0x1294000, size 0x48, virtual false, abstract: false, final false
  inline bool WillFinishGameAfterThisMission(::StringW missionId);

  /// @brief Method SetMissionCleared, addr 0x1294048, size 0x8, virtual false, abstract: false, final false
  inline void SetMissionCleared(::StringW missionId);

  /// @brief Method __SetMissionCleared, addr 0x1294050, size 0x4c, virtual false, abstract: false, final false
  inline void __SetMissionCleared(::StringW missionId, bool cleared);

  /// @brief Method UpdateNumberOfClearedMissions, addr 0x1293cf4, size 0x198, virtual false, abstract: false, final false
  inline int32_t UpdateNumberOfClearedMissions();

  static inline ::GlobalNamespace::CampaignProgressModel* New_ctor();

  /// @brief Method .ctor, addr 0x129409c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
