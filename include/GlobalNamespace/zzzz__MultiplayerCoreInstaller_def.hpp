...
public:
  ...
  /// @brief Method InstallBindings, addr 0x25049d4, size 0x700, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25050d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
