...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerCoreInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerCoreInstaller*, "", "MultiplayerCoreInstaller");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerCoreInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerCoreInstaller(MultiplayerCoreInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerCoreInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerCoreInstaller(MultiplayerCoreInstallerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MultiplayerCoreInstaller) == 0x48, "Size mismatch!");
