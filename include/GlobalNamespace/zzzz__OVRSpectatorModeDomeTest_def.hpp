...
public:
  ...
  /// @brief Method MoveNext, addr 0x2a97ae0, size 0xb4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__OVRSpectatorModeDomeTest___TimerCoroutine_d__20* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2a97b94, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2a97b9c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2a97bdc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2a97adc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a97910, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x2a96d74, size 0x3c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Initialize, addr 0x2a96e60, size 0x228, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRSpectatorModeDomeTest* New_ctor();

  /// @brief Method OnApplicationPause, addr 0x2a97a78, size 0x20, virtual false, abstract: false, final false
  inline void OnApplicationPause();

  /// @brief Method OnApplicationQuit, addr 0x2a97a98, size 0x20, virtual false, abstract: false, final false
  inline void OnApplicationQuit();

  /// @brief Method SpectatorCameraDomePosition, addr 0x2a9787c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x2a96db0, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TimerCoroutine, addr 0x2a97814, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* TimerCoroutine();

  /// @brief Method Update, addr 0x2a97938, size 0x140, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateDefaultExternalCamera, addr 0x2a97088, size 0x428, virtual false, abstract: false, final false
  inline void UpdateDefaultExternalCamera();

  /// @brief Method UpdateSpectatorCameraStatus, addr 0x2a974b0, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a97ab8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
