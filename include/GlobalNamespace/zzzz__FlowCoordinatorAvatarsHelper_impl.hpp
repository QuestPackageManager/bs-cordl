...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0::*)()>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0*>(), { ".ctor", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0::*)(::BeatSaber::AvatarCore::IAvatarSystemMetadata*)>(
    &::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0::_HasUserSelectedAvatarSystemWithCreatedAvatar_b__0)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x5a08bd4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0*>(),
                                                             { "<HasUserSelectedAvatarSystemWithCreatedAvatar>b__0", {}, { ::i2c::type_of<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>() } })));
    return ___internal_method;
  }
};
...
inline bool GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0::_HasUserSelectedAvatarSystemWithCreatedAvatar_b__0(::BeatSaber::AvatarCore::IAvatarSystemMetadata* system) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0*>(),
                                                           { "<HasUserSelectedAvatarSystemWithCreatedAvatar>b__0", {}, { ::i2c::type_of<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>() } })));
  return ::cordl_internals::RunMethodRethrow<bool>(this, ___internal_method, system);
}
inline ::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0* GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FlowCoordinatorAvatarsHelper__HasUserSelectedAvatarSystemWithCreatedAvatar_d__0::*)()>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlowCoordinatorAvatarsHelper__HasUserSelectedAvatarSystemWithCreatedAvatar_d__0>(), { "MoveNext", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FlowCoordinatorAvatarsHelper__HasUserSelectedAvatarSystemWithCreatedAvatar_d__0::*)(
  ...
  constexpr static std::size_t addrs = 0x5a090b0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlowCoordinatorAvatarsHelper__HasUserSelectedAvatarSystemWithCreatedAvatar_d__0>(),
...
// "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "playerDataModel", ty:
// "::UnityW<::GlobalNamespace::PlayerDataModel>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "avatarSystemCollection", ty:
// "::BeatSaber::AvatarCore::AvatarSystemCollection*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<bool>",
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Threading::Tasks::Task_1<bool>* (*)(::BeatSaber::AvatarCore::AvatarSystemCollection*, ::GlobalNamespace::PlayerDataModel*)>(
    &::GlobalNamespace::FlowCoordinatorAvatarsHelper::HasUserSelectedAvatarSystemWithCreatedAvatar)> {
  constexpr static std::size_t size = 0xf0;
  constexpr static std::size_t addrs = 0x5a08ad4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(
            ::i2c::class_of<::GlobalNamespace::FlowCoordinatorAvatarsHelper*>(),
            { "HasUserSelectedAvatarSystemWithCreatedAvatar", {}, { ::i2c::type_of<::BeatSaber::AvatarCore::AvatarSystemCollection*>(), ::i2c::type_of<::GlobalNamespace::PlayerDataModel*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::FlowCoordinatorAvatarsHelper::*)()>(&::GlobalNamespace::FlowCoordinatorAvatarsHelper::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5a08bcc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::FlowCoordinatorAvatarsHelper*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
GlobalNamespace::FlowCoordinatorAvatarsHelper::HasUserSelectedAvatarSystemWithCreatedAvatar(::BeatSaber::AvatarCore::AvatarSystemCollection* avatarSystemCollection,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ...
      (::i2c::find_method(
          ::i2c::class_of<::GlobalNamespace::FlowCoordinatorAvatarsHelper*>(),
          { "HasUserSelectedAvatarSystemWithCreatedAvatar", {}, { ::i2c::type_of<::BeatSaber::AvatarCore::AvatarSystemCollection*>(), ::i2c::type_of<::GlobalNamespace::PlayerDataModel*>() } })));
  return ::cordl_internals::RunMethodRethrow<::System::Threading::Tasks::Task_1<bool>*>(nullptr, ___internal_method, avatarSystemCollection, playerDataModel);
}
...
inline ::GlobalNamespace::FlowCoordinatorAvatarsHelper* GlobalNamespace::FlowCoordinatorAvatarsHelper::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::FlowCoordinatorAvatarsHelper*>());
}
// Ctor Parameters []
