...
public:
  ...
  /// @brief Method BindAdditionalContentModel, addr 0x36b5570, size 0x8c, virtual false, abstract: false, final false
  inline void BindAdditionalContentModel();

  /// @brief Method BindAnalyticsModel, addr 0x36b549c, size 0xd4, virtual false, abstract: false, final false
  inline void BindAnalyticsModel();

  /// @brief Method BindBeatmapDataAssetFileModel, addr 0x36b55fc, size 0xa0, virtual false, abstract: false, final false
  inline void BindBeatmapDataAssetFileModel();

  /// @brief Method BindMockPlatformAdditionalContentModel, addr 0x36b569c, size 0xc8, virtual false, abstract: false, final false
  inline void BindMockPlatformAdditionalContentModel();

  /// @brief Method InstallBindings, addr 0x36b547c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36b5410, size 0x6c, virtual false, abstract: false, final false
