...
public:
  ...
  /// @brief Method .ctor, addr 0x39eef1c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x39eee50, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39eeefc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
