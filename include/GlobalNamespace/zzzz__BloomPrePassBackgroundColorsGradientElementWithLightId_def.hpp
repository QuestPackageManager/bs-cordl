...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId*);
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId*, "", "BloomPrePassBackgroundColorsGradientElementWithLightId");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements*, "", "BloomPrePassBackgroundColorsGradientElementWithLightId/Elements");
...
public:
  ...
  /// @brief Method .ctor, addr 0x586c328, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BloomPrePassBackgroundColorsGradientElementWithLightId_Elements", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "BloomPrePassBackgroundColorsGradientElementWithLightId_Elements", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BloomPrePassBackgroundColorsGradientElementWithLightId_Elements(BloomPrePassBackgroundColorsGradientElementWithLightId_Elementsconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BloomPrePassBackgroundColorsGradientElementWithLightId::Elements, LightWithIdMonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Field _bloomPrePassBackgroundColorsGradient, offset 0x40, size 0x8
  ...
  __declspec(property(get = __cordl_internal_get__elements, put = __cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements*>
      _elements;

  /// @brief Method ColorWasSet, addr 0x586c260, size 0xa0, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements*> const& __cordl_internal_get__elements() const;

  constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements*>& __cordl_internal_get__elements();
  ...
  constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements*> value);

  /// @brief Method .ctor, addr 0x586c300, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BloomPrePassBackgroundColorsGradientElementWithLightId", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BloomPrePassBackgroundColorsGradientElementWithLightId(BloomPrePassBackgroundColorsGradientElementWithLightId&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BloomPrePassBackgroundColorsGradientElementWithLightId", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BloomPrePassBackgroundColorsGradientElementWithLightId(BloomPrePassBackgroundColorsGradientElementWithLightIdconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 19511 };

  /// [SerializeField]
  /// @brief Field _bloomPrePassBackgroundColorsGradient, offset: 0x40, size: 0x8, def value: None
  ...
  ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements*> ____elements;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId, ____bloomPrePassBackgroundColorsGradient) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId, ____elements) == 0x48, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId) == 0x50, "Size mismatch!");
