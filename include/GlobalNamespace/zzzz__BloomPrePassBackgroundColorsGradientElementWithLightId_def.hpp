...
public:
  ...
  /// @brief Method .ctor, addr 0x23f9a24, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x23f9958, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f9a04, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
