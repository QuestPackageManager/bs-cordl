...
public:
  ...
  /// @brief Method .ctor, addr 0x56b8e0c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x56b8d54, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56b8df4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
