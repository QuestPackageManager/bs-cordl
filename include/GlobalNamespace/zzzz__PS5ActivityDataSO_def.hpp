...
public:
  ...
  /// @brief Method .ctor, addr 0x26eb4f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activityId, addr 0x26eb514, size 0x8, virtual false, abstract: false, final false
