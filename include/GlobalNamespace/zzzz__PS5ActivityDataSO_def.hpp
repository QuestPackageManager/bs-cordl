...
public:
  ...
  /// @brief Method .ctor, addr 0x26eb8a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activityId, addr 0x26eb8c8, size 0x8, virtual false, abstract: false, final false
