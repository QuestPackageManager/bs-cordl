...
public:
  ...
  /// @brief Method .ctor, addr 0x26e7df8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activityId, addr 0x26e7e18, size 0x8, virtual false, abstract: false, final false
