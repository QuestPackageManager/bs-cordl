...
public:
  ...
  /// @brief Method .ctor, addr 0x1311f48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activityId, addr 0x1311f68, size 0x8, virtual false, abstract: false, final false
