...
public:
  ...
  /// @brief Method .ctor, addr 0x14e3668, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activityId, addr 0x14e3688, size 0x8, virtual false, abstract: false, final false
