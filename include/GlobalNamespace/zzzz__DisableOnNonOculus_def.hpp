...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DisableOnNonOculus", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DisableOnNonOculus(DisableOnNonOculus&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DisableOnNonOculus", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DisableOnNonOculus(DisableOnNonOculusconst&) = delete;
