...
public:
  ...
  /// @brief Method .ctor, addr 0x579a288, size 0x10, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::LocalPlayerInGameMenuInitData, ___hasSong) == 0x30, "Offset mismatch!");
