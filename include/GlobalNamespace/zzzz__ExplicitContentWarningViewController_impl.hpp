...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::ExplicitContentWarningViewController::*)(bool, bool, bool)>(
    &::GlobalNamespace::ExplicitContentWarningViewController::DidActivate)> {
  constexpr static std::size_t size = 0xec;
  constexpr static std::size_t addrs = 0x5a136ac;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::ExplicitContentWarningViewController*>(),
                                                                                          { ::i2c::class_of<::GlobalNamespace::ExplicitContentWarningViewController*>(), 5 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::ExplicitContentWarningViewController::*)(bool, bool)>(
    &::GlobalNamespace::ExplicitContentWarningViewController::DidDeactivate)> {
  constexpr static std::size_t size = 0x34;
  constexpr static std::size_t addrs = 0x5a13798;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::ExplicitContentWarningViewController*>(),
                                                                                          { ::i2c::class_of<::GlobalNamespace::ExplicitContentWarningViewController*>(), 6 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::ExplicitContentWarningViewController::*)()>(
    &::GlobalNamespace::ExplicitContentWarningViewController::HandleClickedEvent)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x5a137cc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ExplicitContentWarningViewController*>(), { "HandleClickedEvent", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::ExplicitContentWarningViewController::*)()>(&::GlobalNamespace::ExplicitContentWarningViewController::_ctor)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x5a13834;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ExplicitContentWarningViewController*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
inline void GlobalNamespace::ExplicitContentWarningViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::ExplicitContentWarningViewController*>(), 5 })));
...
inline void GlobalNamespace::ExplicitContentWarningViewController::DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::ExplicitContentWarningViewController*>(), 6 })));
...
inline ::GlobalNamespace::ExplicitContentWarningViewController* GlobalNamespace::ExplicitContentWarningViewController::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::ExplicitContentWarningViewController*>());
}
// Ctor Parameters []
