...
public:
  ...
  /// @brief Method Start, addr 0x3b15b74, size 0x7c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3b15bf0, size 0x210, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b15e00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
