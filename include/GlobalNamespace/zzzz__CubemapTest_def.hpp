...
public:
  ...
  /// @brief Method Start, addr 0x58e23dc, size 0x80, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58e245c, size 0x25c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58e26b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
