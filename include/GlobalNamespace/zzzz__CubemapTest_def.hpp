...
public:
  ...
  /// @brief Method Start, addr 0x57c1ed4, size 0x80, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x57c1f54, size 0x25c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57c21b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
