...
/// @brief Method .ctor, addr 0x6291038, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledState, addr 0x6291014, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_disabledState() ;

/// @brief Method get_highlightedState, addr 0x6290ffc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_highlightedState() ;

/// @brief Method get_normalState, addr 0x6290ff0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_normalState() ;

/// @brief Method get_pressedState, addr 0x6291008, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_pressedState() ;

/// @brief Method get_selectedAndHighlightedState, addr 0x629102c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_selectedAndHighlightedState() ;

/// @brief Method get_selectedState, addr 0x6291020, size 0xc, virtual false, abstract: false, final false
...
static constexpr uint32_t  __IL2CPP_TYPE_DEFINITION_INDEX{22139};
