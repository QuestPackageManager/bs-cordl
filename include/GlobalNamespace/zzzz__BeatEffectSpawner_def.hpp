...
public:
  ...
  /// @brief Method .ctor, addr 0x584e2f8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleBeatEffectDidFinish, addr 0x584e1f8, size 0xe8, virtual true, abstract: false, final true
  inline void HandleBeatEffectDidFinish(::GlobalNamespace::BeatEffect* beatEffect);

  /// @brief Method HandleNoteDidStartJump, addr 0x584df20, size 0x2d8, virtual false, abstract: false, final false
  inline void HandleNoteDidStartJump(::GlobalNamespace::NoteController* noteController);

  /// @brief Method Init, addr 0x584dc18, size 0x84, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::BeatEffect_Pool* beatEffectPool);

  static inline ::GlobalNamespace::BeatEffectSpawner* New_ctor();

  /// @brief Method OnDestroy, addr 0x584dd2c, size 0x98, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x584dc9c, size 0x90, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x584ddc4, size 0x15c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x584e2e0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
