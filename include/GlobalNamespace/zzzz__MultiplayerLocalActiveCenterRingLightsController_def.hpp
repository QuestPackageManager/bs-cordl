...
public:
  ...
  /// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x59bd538, size 0x18, virtual false, abstract: false, final false
  inline void HandleEdgeDistanceFromCenterWasCalculated(float_t constructEdgeDistanceFromCenter);

  /// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x59bd610, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59bd628, size 0x1c0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Resize, addr 0x59bd8c0, size 0x2ac, virtual false, abstract: false, final false
  inline void Resize();

  /// @brief Method Start, addr 0x59bd338, size 0x200, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryResize, addr 0x59bd8a8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bdb6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
