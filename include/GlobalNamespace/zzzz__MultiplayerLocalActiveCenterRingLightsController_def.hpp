...
public:
  ...
  /// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x25f30c0, size 0x18, virtual false, abstract: false, final false
  inline void HandleEdgeDistanceFromCenterWasCalculated(float_t constructEdgeDistanceFromCenter);

  /// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x25f30d8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25f30f0, size 0x154, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Resize, addr 0x25f325c, size 0x2bc, virtual false, abstract: false, final false
  inline void Resize();

  /// @brief Method Start, addr 0x25f2f28, size 0x198, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryResize, addr 0x25f3244, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f3518, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
