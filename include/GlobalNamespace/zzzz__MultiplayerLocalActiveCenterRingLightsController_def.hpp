...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController*, "", "MultiplayerLocalActiveCenterRingLightsController");
...
public:
  // Declarations
  /// @brief Field _beatmapObjectSpawnCenter, offset 0x40, size 0x8
  ...
  /// @brief Field _edgeDistanceFromCenterCalculated, offset 0x48, size 0x1
  ...
  /// @brief Field _horizontalLines, offset 0x28, size 0x8
  __declspec(property(get = __cordl_internal_get__horizontalLines, put = __cordl_internal_set__horizontalLines)) ::ArrayW<::UnityW<::UnityEngine::Transform>> _horizontalLines;
  ...
  /// @brief Field _spawnCenterDistanceFound, offset 0x49, size 0x1
  ...
  __declspec(property(get = __cordl_internal_get__verticalLinePositions, put = __cordl_internal_set__verticalLinePositions)) ::ArrayW<float_t> _verticalLinePositions;

  /// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x59c38a0, size 0x18, virtual false, abstract: false, final false
  inline void HandleEdgeDistanceFromCenterWasCalculated(float_t constructEdgeDistanceFromCenter);

  /// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x59c38b8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59c38d0, size 0x1c4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Resize, addr 0x59c3aac, size 0x2ac, virtual false, abstract: false, final false
  inline void Resize();

  /// @brief Method Start, addr 0x59c369c, size 0x204, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryResize, addr 0x59c3a94, size 0x18, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>> const& __cordl_internal_get__horizontalLines() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>>& __cordl_internal_get__horizontalLines();
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get__verticalLinePositions() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__verticalLinePositions();
  ...
  constexpr void __cordl_internal_set__horizontalLines(::ArrayW<::UnityW<::UnityEngine::Transform>> value);
  ...
  constexpr void __cordl_internal_set__verticalLinePositions(::ArrayW<float_t> value);

  /// @brief Method .ctor, addr 0x59c3d58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _edgeDistanceFromCenterCalculated, offset: 0x48, size: 0x1, def value: None
...
static_assert(offsetof(::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController, ____centerResizeController) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController, ____layoutProvider) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController, ____beatmapObjectSpawnCenter) == 0x40, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController) == 0x50, "Size mismatch!");
