...
/// @brief Field _centerResizeController, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__centerResizeController, put=__cordl_internal_set__centerResizeController)) ::UnityW<::GlobalNamespace::MultiplayerCenterResizeController>  _centerResizeController;
...
/// @brief Field _horizontalLines, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__horizontalLines, put=__cordl_internal_set__horizontalLines)) ::ArrayW<::UnityW<::UnityEngine::Transform>,::Array<::UnityW<::UnityEngine::Transform>>*>  _horizontalLines;
...
/// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x5818fa0, size 0x18, virtual false, abstract: false, final false
inline void HandleEdgeDistanceFromCenterWasCalculated(float_t  constructEdgeDistanceFromCenter) ;

/// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x5818fb8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5818fd0, size 0x1c4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Resize, addr 0x58191ac, size 0x2ac, virtual false, abstract: false, final false
inline void Resize() ;

/// @brief Method Start, addr 0x5818d9c, size 0x204, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TryResize, addr 0x5819194, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5819458, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
