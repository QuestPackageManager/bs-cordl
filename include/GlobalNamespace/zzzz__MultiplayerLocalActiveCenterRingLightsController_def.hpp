...
public:
  ...
  /// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x57b1dc8, size 0x18, virtual false, abstract: false, final false
  inline void HandleEdgeDistanceFromCenterWasCalculated(float_t constructEdgeDistanceFromCenter);

  /// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x57b1de0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x57b1df8, size 0x1c4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Resize, addr 0x57b1fd4, size 0x2ac, virtual false, abstract: false, final false
  inline void Resize();

  /// @brief Method Start, addr 0x57b1bc4, size 0x204, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryResize, addr 0x57b1fbc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b2280, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
