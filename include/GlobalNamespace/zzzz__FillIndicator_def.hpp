...
public:
  ...
  /// @brief Method .ctor, addr 0x5853f14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_fillAmount, addr 0x5853efc, size 0x18, virtual false, abstract: false, final false
  inline float_t get_fillAmount();

  /// @brief Method set_fillAmount, addr 0x5853dd8, size 0x44, virtual false, abstract: false, final false
