...
public:
  ...
  /// @brief Method Awake, addr 0x5d4df24, size 0x150, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method CheckForGrabOrRelease, addr 0x5d4e540, size 0x3c, virtual false, abstract: false, final false
  inline void CheckForGrabOrRelease(float_t prevFlex);

  /// @brief Method ForceRelease, addr 0x5d4dbf0, size 0xb4, virtual false, abstract: false, final false
  inline void ForceRelease(::GlobalNamespace::OVRGrabbable* grabbable);

  /// @brief Method GrabBegin, addr 0x5d4e8e0, size 0x6a0, virtual true, abstract: false, final false
  inline void GrabBegin();

  /// @brief Method GrabEnd, addr 0x5d4dcb8, size 0x26c, virtual false, abstract: false, final false
  inline void GrabEnd();

  /// @brief Method GrabVolumeEnable, addr 0x5d4f1fc, size 0xc4, virtual true, abstract: false, final false
  inline void GrabVolumeEnable(bool enabled);

  /// @brief Method GrabbableRelease, addr 0x5d4f1a8, size 0x54, virtual false, abstract: false, final false
  inline void GrabbableRelease(::UnityEngine::Vector3 linearVelocity, ::UnityEngine::Vector3 angularVelocity);

  /// @brief Method MoveGrabbedObject, addr 0x5d4ef80, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method OffhandGrabbed, addr 0x5d4f2c0, size 0xd4, virtual true, abstract: false, final false
  inline void OffhandGrabbed(::GlobalNamespace::OVRGrabbable* grabbable);

  /// @brief Method OnDestroy, addr 0x5d4e57c, size 0x7c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnTriggerEnter, addr 0x5d4e5f8, size 0x154, virtual false, abstract: false, final false
  inline void OnTriggerEnter(::UnityEngine::Collider* otherCollider);

  /// @brief Method OnTriggerExit, addr 0x5d4e74c, size 0x194, virtual false, abstract: false, final false
  inline void OnTriggerExit(::UnityEngine::Collider* otherCollider);

  /// @brief Method OnUpdatedAnchors, addr 0x5d4e314, size 0x22c, virtual false, abstract: false, final false
  inline void OnUpdatedAnchors();

  /// @brief Method SetPlayerIgnoreCollision, addr 0x5d4e158, size 0x1ac, virtual false, abstract: false, final false
  inline void SetPlayerIgnoreCollision(::UnityEngine::GameObject* grabbable, bool ignore);

  /// @brief Method Start, addr 0x5d4e074, size 0xe4, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5d4e304, size 0x10, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method <Awake>b__23_0, addr 0x5d4f448, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d4f394, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_grabbedObject, addr 0x5d4dcb0, size 0x8, virtual false, abstract: false, final false
