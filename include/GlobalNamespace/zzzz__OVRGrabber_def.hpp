...
// TypeDefinitionIndex(TypeDefinitionIndex(7598))} Self: TypeDefinitionIndex(TypeDefinitionIndex(8111)) CS Name: ::OVRGrabber*
...
public:
  ...
  /// @brief Method Awake, addr 0x27acf60, size 0x144, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method Start, addr 0x27ad0a4, size 0xe0, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x27ad2fc, size 0x10, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method OnUpdatedAnchors, addr 0x27ad30c, size 0x224, virtual false, abstract: false, final false
  inline void OnUpdatedAnchors();

  /// @brief Method OnDestroy, addr 0x27ad570, size 0x78, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnTriggerEnter, addr 0x27ad5e8, size 0x128, virtual false, abstract: false, final false
  inline void OnTriggerEnter(::UnityEngine::Collider* otherCollider);

  /// @brief Method OnTriggerExit, addr 0x27ad710, size 0x15c, virtual false, abstract: false, final false
  inline void OnTriggerExit(::UnityEngine::Collider* otherCollider);

  /// @brief Method CheckForGrabOrRelease, addr 0x27ad530, size 0x40, virtual false, abstract: false, final false
  inline void CheckForGrabOrRelease(float_t prevFlex);

  /// @brief Method GrabBegin, addr 0x27ad86c, size 0x6b0, virtual true, abstract: false, final false
  ...
  /// @brief Method GrabbableRelease, addr 0x27ae150, size 0x54, virtual false, abstract: false, final false
  inline void GrabbableRelease(::UnityEngine::Vector3 linearVelocity, ::UnityEngine::Vector3 angularVelocity);

  /// @brief Method GrabVolumeEnable, addr 0x27ae1a4, size 0xc0, virtual true, abstract: false, final false
  inline void GrabVolumeEnable(bool enabled);

  /// @brief Method OffhandGrabbed, addr 0x27ae264, size 0xcc, virtual true, abstract: false, final false
  inline void OffhandGrabbed(::GlobalNamespace::OVRGrabbable* grabbable);

  /// @brief Method SetPlayerIgnoreCollision, addr 0x27ad184, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27ae330, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <Awake>b__23_0, addr 0x27ae3c4, size 0x4, virtual false, abstract: false, final false
