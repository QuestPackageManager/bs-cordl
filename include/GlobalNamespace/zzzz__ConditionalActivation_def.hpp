...
public:
  ...
  /// @brief Method Awake, addr 0x3b2e22c, size 0x84, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x3b2e2b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
