...
public:
  ...
  /// @brief Method Awake, addr 0x3acd660, size 0x84, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x3acd6e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
