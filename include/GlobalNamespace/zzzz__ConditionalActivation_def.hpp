...
public:
  ...
  /// @brief Method Awake, addr 0x576ccc4, size 0x88, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x576cd4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
