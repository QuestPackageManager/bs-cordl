...
public:
  ...
  /// @brief Method Awake, addr 0x23d05a4, size 0x84, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x23d0628, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
