...
public:
  ...
  /// @brief Method Awake, addr 0x22b0af8, size 0x84, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x22b0b7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
