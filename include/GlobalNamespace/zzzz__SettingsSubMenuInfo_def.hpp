...
public:
  ...
  /// @brief Method .ctor, addr 0x26664e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localizedMenuName, addr 0x26664d4, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_localizedMenuName();

  /// @brief Method get_viewController, addr 0x26664cc, size 0x8, virtual false, abstract: false, final false
