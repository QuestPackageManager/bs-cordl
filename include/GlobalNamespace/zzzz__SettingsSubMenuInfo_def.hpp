...
/// @brief Method .ctor, addr 0x58788e4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_localizedMenuName, addr 0x58788d8, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_localizedMenuName() ;

/// @brief Method get_viewController, addr 0x58788d0, size 0x8, virtual false, abstract: false, final false
