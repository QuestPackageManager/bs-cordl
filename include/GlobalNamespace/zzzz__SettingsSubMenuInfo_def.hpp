...
public:
  ...
  /// @brief Method get_localizedMenuName, addr 0x3c17a7c, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_localizedMenuName();

  /// @brief Method get_viewController, addr 0x3c17a74, size 0x8, virtual false, abstract: false, final false
