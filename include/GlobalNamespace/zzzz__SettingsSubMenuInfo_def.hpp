...
public:
  ...
  /// @brief Method .ctor, addr 0x5a1aa2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localizedMenuName, addr 0x5a1aa20, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_localizedMenuName();

  /// @brief Method get_viewController, addr 0x5a1aa18, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SettingsSubMenuInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SettingsSubMenuInfo(SettingsSubMenuInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SettingsSubMenuInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SettingsSubMenuInfo(SettingsSubMenuInfoconst&) = delete;
