...
public:
  ...
  /// @brief Method AddMovement, addr 0x24f89c4, size 0x24, virtual false, abstract: false, final false
  inline void AddMovement(float_t distance);

  /// @brief Method ManualUpdate, addr 0x24f89e8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f8928, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_averagingValueRecorer, addr 0x24f8920, size 0x8, virtual false, abstract: false, final false
