...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MovementHistoryRecorder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MovementHistoryRecorder(MovementHistoryRecorder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MovementHistoryRecorder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MovementHistoryRecorder(MovementHistoryRecorderconst&) = delete;
