...
public:
  ...
  /// @brief Method AddMovement, addr 0x3beee10, size 0x24, virtual false, abstract: false, final false
  inline void AddMovement(float_t distance);

  /// @brief Method ManualUpdate, addr 0x3beee34, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3beed7c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_averagingValueRecorer, addr 0x3beed74, size 0x8, virtual false, abstract: false, final false
