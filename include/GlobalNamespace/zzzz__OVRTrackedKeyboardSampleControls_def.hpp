...
public:
  ...
  /// @brief Method MoveNext, addr 0x2a6e9c0, size 0x134, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2a6eaf4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2a6eafc, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2a6eb3c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2a6e9bc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a6e908, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_ShaderButtons,
                      put = __cordl_internal_set_ShaderButtons))::ArrayW<::UnityW<::UnityEngine::UI::Button>, ::Array<::UnityW<::UnityEngine::UI::Button>>*> ShaderButtons;
  ...
  /// @brief Method LaunchKeyboardSelection, addr 0x2a6e930, size 0x2c, virtual false, abstract: false, final false
  inline void LaunchKeyboardSelection();

  static inline ::GlobalNamespace::OVRTrackedKeyboardSampleControls* New_ctor();

  /// @brief Method SetDiffuseShader, addr 0x2a6e8b0, size 0x58, virtual false, abstract: false, final false
  inline void SetDiffuseShader();

  /// @brief Method SetPresentationKeyLabels, addr 0x2a6e7c8, size 0x1c, virtual false, abstract: false, final false
  inline void SetPresentationKeyLabels();

  /// @brief Method SetPresentationOpaque, addr 0x2a6e7ac, size 0x1c, virtual false, abstract: false, final false
  inline void SetPresentationOpaque();

  /// @brief Method SetShaderCoroutine, addr 0x2a6e83c, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* SetShaderCoroutine(::StringW shaderName);

  /// @brief Method SetTrackingEnabled, addr 0x2a6e95c, size 0x20, virtual false, abstract: false, final false
  inline void SetTrackingEnabled(bool value);

  /// @brief Method SetUnlitShader, addr 0x2a6e7e4, size 0x58, virtual false, abstract: false, final false
  inline void SetUnlitShader();

  /// @brief Method Start, addr 0x2a6e464, size 0x100, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x2a6e564, size 0x248, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method <SetShaderCoroutine>b__19_0, addr 0x2a6e998, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a6e97c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
