...
public:
  ...
  /// @brief Method Contains, addr 0x272ba64, size 0x54, virtual false, abstract: false, final false
  inline bool Contains(::GlobalNamespace::SongPackMask other);

  /// @brief Method CreateFromSerializedData, addr 0x272bb30, size 0x2c, virtual true, abstract: false, final true
  inline ::GlobalNamespace::SongPackMask CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Deserialize, addr 0x272bb5c, size 0x28, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SongPackMask Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method DifferenceFrom, addr 0x272bab8, size 0x74, virtual false, abstract: false, final false
  inline int32_t DifferenceFrom(::GlobalNamespace::SongPackMask other);

  /// @brief Method Equals, addr 0x272bd0c, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x272bcc0, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::SongPackMask other);

  /// @brief Method FromBytes, addr 0x272bf80, size 0x74, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SongPackMask FromBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t offset);

  /// @brief Method GetHashCode, addr 0x272bcbc, size 0x4, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Parse, addr 0x272beec, size 0x94, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SongPackMask Parse(::StringW stringSerializedMask);

  /// @brief Method Serialize, addr 0x272bb2c, size 0x4, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToBytes, addr 0x272bc5c, size 0x60, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ToBytes();

  /// @brief Method ToShortString, addr 0x272bbfc, size 0x60, virtual false, abstract: false, final false
  inline ::StringW ToShortString();

  /// @brief Method ToString, addr 0x272bb84, size 0x78, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryParse, addr 0x272bdbc, size 0x130, virtual false, abstract: false, final false
  static inline bool TryParse(::StringW stringSerializedMask, ::ByRef<::GlobalNamespace::SongPackMask> songPackMask);

  /// @brief Method .ctor, addr 0x272b8f8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BitMask256 bloomFilter);

  /// @brief Method .ctor, addr 0x272b880, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::StringW packId);

  /// @brief Method .ctor, addr 0x272b904, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::StringW>* packs);

  /// @brief Method get_all, addr 0x272b97c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseAnd, addr 0x272b9a0, size 0x18, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SongPackMask op_BitwiseAnd(::GlobalNamespace::SongPackMask a, ::GlobalNamespace::SongPackMask b);

  /// @brief Method op_BitwiseOr, addr 0x272b988, size 0x18, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SongPackMask op_BitwiseOr(::GlobalNamespace::SongPackMask a, ::GlobalNamespace::SongPackMask b);

  /// @brief Method op_Equality, addr 0x272b9b8, size 0x4c, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::SongPackMask a, ::GlobalNamespace::SongPackMask b);

  /// @brief Method op_Implicit, addr 0x272ba50, size 0x14, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SongPackMask op_Implicit___GlobalNamespace__SongPackMask(::StringW id);

  /// @brief Method op_Inequality, addr 0x272ba04, size 0x4c, virtual false, abstract: false, final false
