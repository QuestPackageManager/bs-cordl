...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2507)), TypeDefinitionIndex(TypeDefinitionIndex(3389)), TypeDefinitionIndex(TypeDefinitionIndex(3390)),
// TypeDefinitionIndex(TypeDefinitionIndex(3397)), TypeDefinitionIndex(TypeDefinitionIndex(16238)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2507), inst: 5298 }),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3390), inst: 873 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(3976)) CS Name:
// ::MainSettingsAsyncLoader::<LoadResourcesBeforeInstallAsync>d__2
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22b02fc, size 0x2c8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22b05c4, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method LoadResourcesBeforeInstall, addr 0x22b0180, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method LoadResourcesBeforeInstallAsync, addr 0x22b0214, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method InstallBindings, addr 0x22b02f0, size 0x4, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::MainSettingsAsyncLoader* New_ctor();

  /// @brief Method .ctor, addr 0x22b02f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
