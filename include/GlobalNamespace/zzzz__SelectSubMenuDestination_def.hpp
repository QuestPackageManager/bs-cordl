...
public:
  ...
  /// @brief Method .ctor, addr 0x3707fb8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SelectSubMenuDestination", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SelectSubMenuDestination(SelectSubMenuDestination&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SelectSubMenuDestination", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SelectSubMenuDestination(SelectSubMenuDestinationconst&) = delete;
