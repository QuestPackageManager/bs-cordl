...
public:
  ...
  /// @brief Method GetCoverSpriteAsync, addr 0x362bc88, size 0x78, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>* GetCoverSpriteAsync();

  /// @brief Method GetPreviewAudioClip, addr 0x362bd00, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method UnloadCoverSprite, addr 0x362bd7c, size 0x4, virtual true, abstract: false, final true
  inline void UnloadCoverSprite();

  /// @brief Method UnloadPreviewAudioClip, addr 0x362bd78, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x362695c, size 0x8, virtual false, abstract: false, final false
