...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnvironmentIdAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentIdAttribute*, "", "EnvironmentIdAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x372f63c, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EnvironmentIdAttribute) == 0x28, "Size mismatch!");
