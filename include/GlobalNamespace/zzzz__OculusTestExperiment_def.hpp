...
public:
  ...
  /// @brief Method .ctor, addr 0x26ae6d0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW experimentPlatformKey);

  /// @brief Method get_experimentPlatformKey, addr 0x26ae6c8, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26ae6f8, size 0x474, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26aeb6c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Init, addr 0x26ae630, size 0x90, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x26ae6c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
