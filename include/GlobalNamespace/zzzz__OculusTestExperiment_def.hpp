...
// Write type traits
MARK_REF_T(::GlobalNamespace::OculusTestExperiment*);
MARK_REF_T(::GlobalNamespace::OculusTestExperiment_ExperimentData*);
MARK_VAL_T(::GlobalNamespace::OculusTestExperiment__Init_d__3);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusTestExperiment*, "", "OculusTestExperiment");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusTestExperiment_ExperimentData*, "", "OculusTestExperiment/ExperimentData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusTestExperiment__Init_d__3, "", "OculusTestExperiment/<Init>d__3");
...
public:
  ...
  /// @brief Method .ctor, addr 0x370738c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW experimentPlatformKey);

  /// @brief Method get_experimentPlatformKey, addr 0x3707384, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3707394, size 0x470, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3707804, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::OculusTestExperiment__Init_d__3) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x37072dc, size 0xa4, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x3707380, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OculusTestExperiment) == 0x18, "Size mismatch!");
