...
/// @brief Method .ctor, addr 0x364aa70, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  experimentPlatformKey) ;

/// @brief Method get_experimentPlatformKey, addr 0x364aa68, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x364aa78, size 0x470, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x364aee8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method Init, addr 0x364a9c0, size 0xa4, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method .ctor, addr 0x364aa64, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
