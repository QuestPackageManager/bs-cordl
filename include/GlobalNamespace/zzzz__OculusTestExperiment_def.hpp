...
public:
  ...
  /// @brief Method .ctor, addr 0x26b1044, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW experimentPlatformKey);

  /// @brief Method get_experimentPlatformKey, addr 0x26b103c, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26b106c, size 0x474, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26b14e0, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Init, addr 0x26b0fa4, size 0x90, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x26b1034, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
