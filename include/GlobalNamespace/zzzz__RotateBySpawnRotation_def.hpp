...
// [AddComponentMenu("Beat Saber/Gameplay/RotateBySpawnRotation")]
...
public:
  ...
  /// @brief Method FixedUpdate, addr 0x59a6170, size 0x54, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method HandleSpawnRotationBeatmapEvent, addr 0x59a60d0, size 0xa0, virtual false, abstract: false, final false
  inline void HandleSpawnRotationBeatmapEvent(::GlobalNamespace::BeatmapObjectData* data);

  /// @brief Method LateUpdate, addr 0x59a61c4, size 0x90, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::RotateBySpawnRotation* New_ctor();

  /// @brief Method OnDestroy, addr 0x59a60b4, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59a5f64, size 0x150, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59a6254, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RotateBySpawnRotation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RotateBySpawnRotation(RotateBySpawnRotation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RotateBySpawnRotation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RotateBySpawnRotation(RotateBySpawnRotationconst&) = delete;
