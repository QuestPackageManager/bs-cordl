...
public:
  ...
  /// @brief Method Start addr 0x227c464 size 0x138 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x227c59c size 0x1c virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleSpawnRotationBeatmapEvent addr 0x227c5b8 size 0x9c virtual false final false
  inline void HandleSpawnRotationBeatmapEvent(::GlobalNamespace::SpawnRotationBeatmapEventData* beatmapEventData);

  /// @brief Method FixedUpdate addr 0x227c654 size 0x90 virtual false final false
  inline void FixedUpdate();

  /// @brief Method LateUpdate addr 0x227c6e4 size 0xc0 virtual false final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::RotateBySpawnRotation* New_ctor();

  /// @brief Method .ctor addr 0x227c7a4 size 0x8 virtual false final false
  inline void _ctor();
