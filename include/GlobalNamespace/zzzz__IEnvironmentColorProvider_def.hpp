...
// Write type traits
MARK_REF_T(::GlobalNamespace::IEnvironmentColorProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IEnvironmentColorProvider*, "", "IEnvironmentColorProvider");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IEnvironmentColorProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IEnvironmentColorProvider(IEnvironmentColorProviderconst&) = delete;
