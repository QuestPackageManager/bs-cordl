...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10178)), TypeDefinitionIndex(TypeDefinitionIndex(10152)), TypeDefinitionIndex(TypeDefinitionIndex(10170))}
...
public:
  ...
  /// @brief Method set_color addr 0x227c018 size 0xc4 virtual false final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method get_color addr 0x227c0dc size 0xc virtual false final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method Awake addr 0x227c0e8 size 0x6c virtual false final false
  inline void Awake();

  /// @brief Method OnEnable addr 0x227c154 size 0x74 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x227c2dc size 0x6c virtual false final false
  inline void OnDisable();

  /// @brief Method Refresh addr 0x227c1c8 size 0x114 virtual false final false
  inline void Refresh();

  static inline ::GlobalNamespace::RectangleFakeGlow* New_ctor();

  /// @brief Method .ctor addr 0x227c348 size 0x24 virtual false final false
  inline void _ctor();
