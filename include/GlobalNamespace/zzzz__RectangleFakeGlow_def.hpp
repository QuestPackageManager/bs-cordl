...
public:
  ...
  /// @brief Method Awake, addr 0x5864794, size 0x60, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::RectangleFakeGlow* New_ctor();

  /// @brief Method OnDisable, addr 0x586496c, size 0x60, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58647f4, size 0x68, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x586485c, size 0x110, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x58649cc, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_color, addr 0x5864788, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x58646c4, size 0xc4, virtual false, abstract: false, final false
