...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8969)), TypeDefinitionIndex(TypeDefinitionIndex(8987)), TypeDefinitionIndex(TypeDefinitionIndex(8995))]
...
public:
  ...
  /// @brief Method set_color, addr 0x2373f70, size 0xc4, virtual false, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method get_color, addr 0x2374034, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method Awake, addr 0x2374040, size 0x6c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method OnEnable, addr 0x23740ac, size 0x74, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnDisable, addr 0x2374234, size 0x6c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Refresh, addr 0x2374120, size 0x114, virtual false, abstract: false, final false
  inline void Refresh();

  static inline ::GlobalNamespace::RectangleFakeGlow* New_ctor();

  /// @brief Method .ctor, addr 0x23742a0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
