...
public:
  ...
  /// @brief Method GetPoint, addr 0x3b7ce8c, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPoint(float_t time);

  static inline ::GlobalNamespace::FloatingTransformEffect* New_ctor();

  /// @brief Method Refresh, addr 0x3b7cc64, size 0xd8, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method Start, addr 0x3b7cc2c, size 0x38, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Tick, addr 0x3b7cd3c, size 0x150, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x3b7cf18, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
