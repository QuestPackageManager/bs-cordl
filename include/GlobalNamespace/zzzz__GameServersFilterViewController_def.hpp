...
public:
  ...
  /// @brief Method DidActivate, addr 0x57bd16c, size 0x1c8, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::GameServersFilterViewController* New_ctor();

  /// @brief Method OnDestroy, addr 0x57bd334, size 0x28, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x57bd050, size 0x11c, virtual false, abstract: false, final false
  inline void Refresh(::GlobalNamespace::GameServersFilter* currentFilter);

  /// @brief Method SetupGameServersFilter, addr 0x57bd04c, size 0x4, virtual false, abstract: false, final false
  inline void SetupGameServersFilter(::GlobalNamespace::GameServersFilter* gameServersFilter);

  /// @brief Method <DidActivate>b__16_0, addr 0x57bd3c0, size 0x1c, virtual false, abstract: false, final false
  inline void _DidActivate_b__16_0(bool isOn);

  /// @brief Method <DidActivate>b__16_1, addr 0x57bd3dc, size 0x1c, virtual false, abstract: false, final false
  inline void _DidActivate_b__16_1(bool isOn);

  /// @brief Method <DidActivate>b__16_2, addr 0x57bd3f8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57bd35c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameServersFilter, addr 0x57bcf1c, size 0x130, virtual false, abstract: false, final false
