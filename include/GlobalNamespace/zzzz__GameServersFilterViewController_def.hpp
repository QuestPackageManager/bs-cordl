...
public:
  ...
  /// @brief Method DidActivate, addr 0x3af6ccc, size 0x150, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::GameServersFilterViewController* New_ctor();

  /// @brief Method OnDestroy, addr 0x3af6e1c, size 0x28, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x3af6ba8, size 0x124, virtual false, abstract: false, final false
  inline void Refresh(::GlobalNamespace::GameServersFilter* currentFilter);

  /// @brief Method SetupGameServersFilter, addr 0x3af6ba4, size 0x4, virtual false, abstract: false, final false
  inline void SetupGameServersFilter(::GlobalNamespace::GameServersFilter* gameServersFilter);

  /// @brief Method <DidActivate>b__16_0, addr 0x3af6ea4, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__16_0(bool isOn);

  /// @brief Method <DidActivate>b__16_1, addr 0x3af6ec4, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__16_1(bool isOn);

  /// @brief Method <DidActivate>b__16_2, addr 0x3af6ee4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af6e44, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameServersFilter, addr 0x3af6a98, size 0x10c, virtual false, abstract: false, final false
