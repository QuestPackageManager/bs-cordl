...
public:
  ...
  /// @brief Method DidActivate, addr 0x255c514, size 0x15c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::GameServersFilterViewController* New_ctor();

  /// @brief Method OnDestroy, addr 0x255c670, size 0x28, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x255c3f0, size 0x124, virtual false, abstract: false, final false
  inline void Refresh(::GlobalNamespace::GameServersFilter* currentFilter);

  /// @brief Method SetupGameServersFilter, addr 0x255c3ec, size 0x4, virtual false, abstract: false, final false
  inline void SetupGameServersFilter(::GlobalNamespace::GameServersFilter* gameServersFilter);

  /// @brief Method <DidActivate>b__16_0, addr 0x255c700, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__16_0(bool isOn);

  /// @brief Method <DidActivate>b__16_1, addr 0x255c720, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__16_1(bool isOn);

  /// @brief Method <DidActivate>b__16_2, addr 0x255c740, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x255c698, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameServersFilter, addr 0x255c2e0, size 0x10c, virtual false, abstract: false, final false
