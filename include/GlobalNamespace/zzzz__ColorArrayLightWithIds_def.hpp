...
/// @brief Method ColorWasSet, addr 0x56b9340, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b932c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, int32_t  lightId) ;

/// @brief Method add_didSetColorEvent, addr 0x56b913c, size 0xc0, virtual false, abstract: false, final false
inline void add_didSetColorEvent(::System::Action_2<int32_t,::UnityEngine::Color>*  value) ;

/// @brief Method remove_didSetColorEvent, addr 0x56b91fc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Field _colorArrayLightWithIds, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorArrayLightWithIds, put=__cordl_internal_set__colorArrayLightWithIds)) ::ArrayW<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*,::Array<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*>*>  _colorArrayLightWithIds;
...
/// @brief Method GetLightWithIds, addr 0x56b8fb0, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::LightWithIds_LightWithId*>* GetLightWithIds() ;

/// @brief Method HandleColorLightWithIdDidSetColor, addr 0x56b8fb8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x56b8ea4, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnEnable, addr 0x56b8ca8, size 0x18, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ProcessNewColorData, addr 0x56b8f7c, size 0x4, virtual true, abstract: false, final false
inline void ProcessNewColorData() ;

/// @brief Method RegisterArrayForColorChanges, addr 0x56b8cc4, size 0x1e0, virtual false, abstract: false, final false
inline void RegisterArrayForColorChanges() ;

/// @brief Method SetColorArrayOffsetToMaterialPropertyBlocks, addr 0x56b908c, size 0xb0, virtual false, abstract: false, final false
inline void SetColorArrayOffsetToMaterialPropertyBlocks() ;

/// @brief Method SetColorDataToMaterial, addr 0x56b8f80, size 0x30, virtual false, abstract: false, final false
inline void SetColorDataToMaterial() ;

/// @brief Method UnregisterArrayFromColorChanges, addr 0x56b8ea8, size 0xd4, virtual false, abstract: false, final false
inline void UnregisterArrayFromColorChanges() ;

constexpr ::ArrayW<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*,::Array<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*>*> const& __cordl_internal_get__colorArrayLightWithIds() const;

constexpr ::ArrayW<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*,::Array<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*>*>& __cordl_internal_get__colorArrayLightWithIds() ;
...
constexpr void __cordl_internal_set__colorArrayLightWithIds(::ArrayW<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*,::Array<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x56b92bc, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;
