...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x572722c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5727218, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t index, int32_t lightId);

  /// @brief Method add_didSetColorEvent, addr 0x5727028, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSetColorEvent(::System::Action_2<int32_t, ::UnityEngine::Color>* value);

  /// @brief Method remove_didSetColorEvent, addr 0x57270e8, size 0xc0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLightWithIds, addr 0x5726e9c, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::LightWithIds_LightWithId*>* GetLightWithIds();

  /// @brief Method HandleColorLightWithIdDidSetColor, addr 0x5726ea4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5726d90, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x5726b94, size 0x18, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ProcessNewColorData, addr 0x5726e68, size 0x4, virtual true, abstract: false, final false
  inline void ProcessNewColorData();

  /// @brief Method RegisterArrayForColorChanges, addr 0x5726bb0, size 0x1e0, virtual false, abstract: false, final false
  inline void RegisterArrayForColorChanges();

  /// @brief Method SetColorArrayOffsetToMaterialPropertyBlocks, addr 0x5726f78, size 0xb0, virtual false, abstract: false, final false
  inline void SetColorArrayOffsetToMaterialPropertyBlocks();

  /// @brief Method SetColorDataToMaterial, addr 0x5726e6c, size 0x30, virtual false, abstract: false, final false
  inline void SetColorDataToMaterial();

  /// @brief Method UnregisterArrayFromColorChanges, addr 0x5726d94, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57271a8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
