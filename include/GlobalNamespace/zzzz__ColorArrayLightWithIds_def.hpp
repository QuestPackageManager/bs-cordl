...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorArrayLightWithIds*);
MARK_REF_T(::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorArrayLightWithIds*, "", "ColorArrayLightWithIds");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*, "", "ColorArrayLightWithIds/ColorArrayLightWithId");
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x586cad0, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId) == 0x40, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies ColorArrayLightWithIds::ColorArrayLightWithId, LightWithIds, MaterialPropertyBlockController, UnityEngine.Vector4
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__colorsArray, put = __cordl_internal_set__colorsArray)) ::ArrayW<::UnityEngine::Vector4> _colorsArray;
  ...
  /// @brief Method GetLightWithIds, addr 0x586c740, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::LightWithIds_LightWithId*>* GetLightWithIds();

  /// @brief Method HandleColorLightWithIdDidSetColor, addr 0x586c748, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x586c634, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x586c438, size 0x18, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ProcessNewColorData, addr 0x586c70c, size 0x4, virtual true, abstract: false, final false
  inline void ProcessNewColorData();

  /// @brief Method RegisterArrayForColorChanges, addr 0x586c454, size 0x1e0, virtual false, abstract: false, final false
  inline void RegisterArrayForColorChanges();

  /// @brief Method SetColorArrayOffsetToMaterialPropertyBlocks, addr 0x586c81c, size 0xb0, virtual false, abstract: false, final false
  inline void SetColorArrayOffsetToMaterialPropertyBlocks();

  /// @brief Method SetColorDataToMaterial, addr 0x586c710, size 0x30, virtual false, abstract: false, final false
  inline void SetColorDataToMaterial();

  /// @brief Method UnregisterArrayFromColorChanges, addr 0x586c638, size 0xd4, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*>& __cordl_internal_get__colorArrayLightWithIds();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__colorsArray() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__colorsArray();
  ...
  constexpr void __cordl_internal_set__colorArrayLightWithIds(::ArrayW<::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId*> value);

  constexpr void __cordl_internal_set__colorsArray(::ArrayW<::UnityEngine::Vector4> value);
  ...
  /// @brief Method .ctor, addr 0x586ca4c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector4> ____colorsArray;
...
static_assert(sizeof(::GlobalNamespace::ColorArrayLightWithIds) == 0x70, "Size mismatch!");
