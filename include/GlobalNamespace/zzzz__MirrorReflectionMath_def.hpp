...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MirrorReflectionMath", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MirrorReflectionMath(MirrorReflectionMath&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MirrorReflectionMath", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MirrorReflectionMath(MirrorReflectionMathconst&) = delete;
