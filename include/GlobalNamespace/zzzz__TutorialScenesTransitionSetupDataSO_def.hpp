...
public:
  ...
  /// @brief Method Finish, addr 0x57f1418, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::TutorialScenesTransitionSetupDataSO_TutorialEndStateType endState);

  /// @brief Method Init, addr 0x57efb50, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57f1440, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x57efa90, size 0xc0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method remove_didFinishEvent, addr 0x57eeb48, size 0xc0, virtual false, abstract: false, final false
  inline void
