...
public:
  ...
  /// @brief Method add_didFinishEvent, addr 0x234b28c, size 0xb0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method remove_didFinishEvent, addr 0x234a1dc, size 0xb0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method get_playerSpecificSettings, addr 0x234cd58, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings();

  /// @brief Method set_playerSpecificSettings, addr 0x234cd60, size 0x8, virtual false, abstract: false, final false
  inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* value);

  /// @brief Method Init, addr 0x2347a9c, size 0x3e0, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::PlayerSpecificSettings* playerSpecificSettings);

  /// @brief Method Finish, addr 0x234cd68, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x234cd90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
