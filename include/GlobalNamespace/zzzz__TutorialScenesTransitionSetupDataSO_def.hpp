...
public:
  ...
  /// @brief Method Finish, addr 0x3b3f5b8, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::TutorialScenesTransitionSetupDataSO_TutorialEndStateType endState);

  /// @brief Method Init, addr 0x3b39a68, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3f5e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b3da6c, size 0xb0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method get_playerSpecificSettings, addr 0x3b3f5a8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings();

  /// @brief Method remove_didFinishEvent, addr 0x3b3ca60, size 0xb0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method set_playerSpecificSettings, addr 0x3b3f5b0, size 0x8, virtual false, abstract: false, final false
