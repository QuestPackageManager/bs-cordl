...
public:
  ...
  /// @brief Method Update, addr 0x1500988, size 0xb8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x1500a40, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
