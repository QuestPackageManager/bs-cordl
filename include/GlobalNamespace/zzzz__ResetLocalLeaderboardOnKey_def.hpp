...
public:
  ...
  /// @brief Method Update, addr 0x2707fdc, size 0xb0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x270808c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
