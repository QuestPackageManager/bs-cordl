...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x590a9b0, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590aa64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x590a9a8, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TubeLightAsset", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TubeLightAsset(TubeLightAsset&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TubeLightAsset", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TubeLightAsset(TubeLightAssetconst&) = delete;
