...
public:
  ...
  /// @brief Method HandleTutorialFinished, addr 0x12c68e0, size 0x20, virtual false, abstract: false, final false
  inline void HandleTutorialFinished();

  static inline ::GlobalNamespace::FinishTutorialAchievementHandler* New_ctor();

  /// @brief Method OnDestroy, addr 0x12c6854, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x12c67c8, size 0x8c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x12c6900, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
