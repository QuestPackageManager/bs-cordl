...
public:
  ...
  /// @brief Method MoveNext, addr 0x226bec0, size 0xf8c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x226ce4c, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x226cec8, size 0x788, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x226d650, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x226d6b8, size 0x1024, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x226e6dc, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Decode, addr 0x226ba90, size 0x118, virtual false, abstract: false, final false
  static inline bool Decode(::ByRef<::BeatSaber::Settings::Settings> settings, ::StringW text);

  /// @brief Method Encode, addr 0x226bcf0, size 0x158, virtual false, abstract: false, final false
  static inline ::StringW Encode(::ByRef<::BeatSaber::Settings::Settings> settings);

  /// @brief Method Load, addr 0x226b4bc, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x226b3ac, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveAsync, addr 0x226b2c0, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method WipeAsync, addr 0x226b1fc, size 0xc4, virtual false, abstract: false, final false
