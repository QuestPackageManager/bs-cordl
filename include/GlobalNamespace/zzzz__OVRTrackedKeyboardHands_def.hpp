...
public:
  ...
  /// @brief Method Awake, addr 0x2b8e4e0, size 0x1e4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ComputeOpacity, addr 0x2b8f9ec, size 0x24, virtual false, abstract: false, final false
  inline float_t ComputeOpacity(float_t distance, float_t innerThreshold, float_t outerThreshold);

  /// @brief Method DisableHandObjects, addr 0x2b8f350, size 0xec, virtual false, abstract: false, final false
  inline void DisableHandObjects();

  /// @brief Method GetHandDistanceToKeyboard, addr 0x2b8f43c, size 0x2d0, virtual false, abstract: false, final false
  inline float_t GetHandDistanceToKeyboard(::GlobalNamespace::OVRSkeleton* handSkeleton);

  /// @brief Method LateUpdate, addr 0x2b8eb74, size 0x7dc, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::OVRTrackedKeyboardHands* New_ctor();

  /// @brief Method RetargetHandTrackingToHandPresence, addr 0x2b8e9c8, size 0x170, virtual false, abstract: false, final false
  inline void RetargetHandTrackingToHandPresence();

  /// @brief Method SetHandModelsEnabled, addr 0x2b8f7e4, size 0x208, virtual false, abstract: false, final false
  inline void SetHandModelsEnabled(bool enableLeftModel, bool enableRightModel);

  /// @brief Method ShouldEnableModel, addr 0x2b8f778, size 0x6c, virtual false, abstract: false, final false
  inline bool ShouldEnableModel(float_t distance);

  /// @brief Method ShouldEnablePassthrough, addr 0x2b8f70c, size 0x6c, virtual false, abstract: false, final false
  inline bool ShouldEnablePassthrough(float_t distance);

  /// @brief Method Start, addr 0x2b8e6c4, size 0x304, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopHandPresence, addr 0x2b8fa10, size 0x30, virtual false, abstract: false, final false
  inline void StopHandPresence();

  /// @brief Method TrackedKeyboardActiveUpdated, addr 0x2b8fa40, size 0xc, virtual false, abstract: false, final false
  inline void TrackedKeyboardActiveUpdated(::GlobalNamespace::__OVRTrackedKeyboard__TrackedKeyboardSetActiveEvent e);

  /// @brief Method TrackedKeyboardVisibilityChanged, addr 0x2b8fa4c, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b8fbfc, size 0x750, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AreControllersActive, addr 0x2b8eb38, size 0x3c, virtual false, abstract: false, final false
  inline bool get_AreControllersActive();

  /// @brief Method get_LeftHandOverKeyboard, addr 0x2b8e4cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_LeftHandOverKeyboard();

  /// @brief Method get_RightHandOverKeyboard, addr 0x2b8e4b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LeftHandOverKeyboard, addr 0x2b8e4d4, size 0xc, virtual false, abstract: false, final false
  inline void set_LeftHandOverKeyboard(bool value);

  /// @brief Method set_RightHandOverKeyboard, addr 0x2b8e4c0, size 0xc, virtual false, abstract: false, final false
