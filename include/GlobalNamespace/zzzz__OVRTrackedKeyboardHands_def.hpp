...
// Ctor Parameters [CppParam { name: "LeftHandTransform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "LeftPresenceTransform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "RightHandTransform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "RightPresenceTransform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "BoneName", ty: "::GlobalNamespace::OVRSkeleton_BoneId", modifiers: "", def_value: None }, CppParam { name: "HandPresenceLeftBoneName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "HandPresenceRightBoneName", ty: "::StringW", modifiers: "", def_value: None }]
constexpr OVRTrackedKeyboardHands_HandBoneMapping(::UnityW<::UnityEngine::Transform>  LeftHandTransform, ::UnityW<::UnityEngine::Transform>  LeftPresenceTransform, ::UnityW<::UnityEngine::Transform>  RightHandTransform, ::UnityW<::UnityEngine::Transform>  RightPresenceTransform, ::GlobalNamespace::OVRSkeleton_BoneId  BoneName, ::StringW  HandPresenceLeftBoneName, ::StringW  HandPresenceRightBoneName) noexcept;
...
/// @brief Field <RightHandOverKeyboard>k__BackingField, offset 0xb8, size 0x1 
 __declspec(property(get=__cordl_internal_get__RightHandOverKeyboard_k__BackingField, put=__cordl_internal_set__RightHandOverKeyboard_k__BackingField)) bool  _RightHandOverKeyboard_k__BackingField;

/// @brief Field boneMappings_, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_boneMappings_, put=__cordl_internal_set_boneMappings_)) ::ArrayW<::GlobalNamespace::OVRTrackedKeyboardHands_HandBoneMapping,::Array<::GlobalNamespace::OVRTrackedKeyboardHands_HandBoneMapping>*>  boneMappings_;
...
/// @brief Field lastVisibilityEvent_, offset 0xba, size 0x3 
 __declspec(property(get=__cordl_internal_get_lastVisibilityEvent_, put=__cordl_internal_set_lastVisibilityEvent_)) ::System::Nullable_1<::GlobalNamespace::OVRTrackedKeyboardHands_TrackedKeyboardHandsVisibilityChangedEvent>  lastVisibilityEvent_;
...
/// @brief Field leftHandSkeletonRenderer_, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_leftHandSkeletonRenderer_, put=__cordl_internal_set_leftHandSkeletonRenderer_)) ::UnityW<::GlobalNamespace::OVRSkeletonRenderer>  leftHandSkeletonRenderer_;
...
/// @brief Field leftHandSkinnedMeshRenderer_, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_leftHandSkinnedMeshRenderer_, put=__cordl_internal_set_leftHandSkinnedMeshRenderer_)) ::UnityW<::UnityEngine::SkinnedMeshRenderer>  leftHandSkinnedMeshRenderer_;
...
/// @brief Field rightHandSkeletonRendererGO_, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_rightHandSkeletonRendererGO_, put=__cordl_internal_set_rightHandSkeletonRendererGO_)) ::UnityW<::UnityEngine::GameObject>  rightHandSkeletonRendererGO_;

/// @brief Field rightHandSkeletonRenderer_, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_rightHandSkeletonRenderer_, put=__cordl_internal_set_rightHandSkeletonRenderer_)) ::UnityW<::GlobalNamespace::OVRSkeletonRenderer>  rightHandSkeletonRenderer_;
...
/// @brief Field rightHandSkinnedMeshRenderer_, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_rightHandSkinnedMeshRenderer_, put=__cordl_internal_set_rightHandSkinnedMeshRenderer_)) ::UnityW<::UnityEngine::SkinnedMeshRenderer>  rightHandSkinnedMeshRenderer_;
...
/// @brief Method Awake, addr 0x5da89dc, size 0x270, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ComputeOpacity, addr 0x5da9ffc, size 0x28, virtual false, abstract: false, final false
inline float_t ComputeOpacity(float_t  distance, float_t  innerThreshold, float_t  outerThreshold) ;

/// @brief Method DisableHandObjects, addr 0x5da9944, size 0xf0, virtual false, abstract: false, final false
inline void DisableHandObjects() ;

/// @brief Method GetHandDistanceToKeyboard, addr 0x5da9a34, size 0x2d8, virtual false, abstract: false, final false
inline float_t GetHandDistanceToKeyboard(::GlobalNamespace::OVRSkeleton*  handSkeleton) ;

/// @brief Method LateUpdate, addr 0x5da9134, size 0x810, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::OVRTrackedKeyboardHands* New_ctor() ;

/// @brief Method RetargetHandTrackingToHandPresence, addr 0x5da8f78, size 0x180, virtual false, abstract: false, final false
inline void RetargetHandTrackingToHandPresence() ;

/// @brief Method SetHandModelsEnabled, addr 0x5da9dec, size 0x210, virtual false, abstract: false, final false
inline void SetHandModelsEnabled(bool  enableLeftModel, bool  enableRightModel) ;

/// @brief Method ShouldEnableModel, addr 0x5da9d7c, size 0x70, virtual false, abstract: false, final false
inline bool ShouldEnableModel(float_t  distance) ;

/// @brief Method ShouldEnablePassthrough, addr 0x5da9d0c, size 0x70, virtual false, abstract: false, final false
inline bool ShouldEnablePassthrough(float_t  distance) ;

/// @brief Method Start, addr 0x5da8c4c, size 0x32c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StopHandPresence, addr 0x5daa024, size 0x30, virtual false, abstract: false, final false
inline void StopHandPresence() ;

/// @brief Method TrackedKeyboardActiveUpdated, addr 0x5daa054, size 0xc, virtual false, abstract: false, final false
inline void TrackedKeyboardActiveUpdated(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent  e) ;

/// @brief Method TrackedKeyboardVisibilityChanged, addr 0x5daa060, size 0x1c8, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::OVRTrackedKeyboardHands_HandBoneMapping,::Array<::GlobalNamespace::OVRTrackedKeyboardHands_HandBoneMapping>*> const& __cordl_internal_get_boneMappings_() const;
...
/// @brief Method .ctor, addr 0x5daa228, size 0x698, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AreControllersActive, addr 0x5da90f8, size 0x3c, virtual false, abstract: false, final false
inline bool get_AreControllersActive() ;

/// @brief Method get_LeftHandOverKeyboard, addr 0x5da89cc, size 0x8, virtual false, abstract: false, final false
inline bool get_LeftHandOverKeyboard() ;

/// @brief Method get_RightHandOverKeyboard, addr 0x5da89bc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_LeftHandOverKeyboard, addr 0x5da89d4, size 0x8, virtual false, abstract: false, final false
inline void set_LeftHandOverKeyboard(bool  value) ;

/// @brief Method set_RightHandOverKeyboard, addr 0x5da89c4, size 0x8, virtual false, abstract: false, final false
