...
public:
  ...
  /// @brief Method .ctor, addr 0x32cadf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissionObjectiveStyleSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MissionObjectiveStyleSO(MissionObjectiveStyleSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MissionObjectiveStyleSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MissionObjectiveStyleSO(MissionObjectiveStyleSOconst&) = delete;
