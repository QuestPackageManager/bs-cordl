...
public:
  ...
  /// @brief Method BeatToTime, addr 0x14bfc34, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14bfc0c, size 0x28, virtual false, abstract: false, final false
