...
public:
  ...
  /// @brief Method Awake, addr 0x3b80bb4, size 0x20c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::NoteCutParticlesEffect* New_ctor();

  /// @brief Method SpawnParticles, addr 0x3b80dc0, size 0x4b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b81270, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
