...
public:
  ...
  /// @brief Method Awake, addr 0x5983538, size 0x1c8, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::NoteCutParticlesEffect* New_ctor();

  /// @brief Method SpawnParticles, addr 0x5983700, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5983ba8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
