...
public:
  ...
  /// @brief Method Awake, addr 0x26ba7bc, size 0x210, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::NoteCutParticlesEffect* New_ctor();

  /// @brief Method SpawnParticles, addr 0x26ba9cc, size 0x4b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26bae7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
