...
public:
  ...
  /// @brief Method Awake, addr 0x24909a8, size 0x148, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::NoteCutParticlesEffect* New_ctor();

  /// @brief Method SpawnParticles, addr 0x2490af0, size 0x4b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2490fa0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
