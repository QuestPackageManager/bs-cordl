...
public:
  // Declarations
  /// @brief Method GetAudioTypeFromPath, addr 0x3322090, size 0xa0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AudioTypeHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AudioTypeHelper(AudioTypeHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AudioTypeHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AudioTypeHelper(AudioTypeHelperconst&) = delete;
