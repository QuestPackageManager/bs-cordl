...
public:
  // Declarations
  /// @brief Method AskForBoost, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void AskForBoost();

  // Ctor Parameters [CppParam { name: "", ty: "IPerformanceBoostController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPerformanceBoostController(IPerformanceBoostControllerconst&) = delete;
