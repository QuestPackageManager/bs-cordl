...
public:
  ...
  /// @brief Method .ctor, addr 0x57275f4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t lightIntensity);

  /// @brief Method get_intensity, addr 0x57275e4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x57275ec, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLightWithIds, addr 0x5727560, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNewColorData, addr 0x5727434, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5727568, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
