...
/// @brief Method .ctor, addr 0x56b9708, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  lightId, float_t  lightIntensity) ;

/// @brief Method get_intensity, addr 0x56b96f8, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method set_intensity, addr 0x56b9700, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _lightIntensityData, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightIntensityData, put=__cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>*>  _lightIntensityData;
...
/// @brief Method GetLightWithIds, addr 0x56b9674, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessNewColorData, addr 0x56b9548, size 0x12c, virtual true, abstract: false, final false
inline void ProcessNewColorData() ;

constexpr ::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>*> const& __cordl_internal_get__lightIntensityData() const;

constexpr ::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>*>& __cordl_internal_get__lightIntensityData() ;
...
constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x56b967c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
