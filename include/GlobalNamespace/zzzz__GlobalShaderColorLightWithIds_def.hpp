...
// Write type traits
MARK_REF_T(::GlobalNamespace::GlobalShaderColorLightWithIds*);
MARK_REF_T(::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GlobalShaderColorLightWithIds*, "", "GlobalShaderColorLightWithIds");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*, "", "GlobalShaderColorLightWithIds/LightIntensitiesWithId");
...
public:
  ...
  /// @brief Method .ctor, addr 0x586f868, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t lightIntensity);

  /// @brief Method get_intensity, addr 0x586f858, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x586f860, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId) == 0x38, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies GlobalShaderColorLightWithIds::LightIntensitiesWithId, LightWithIds
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method GetLightWithIds, addr 0x586f7d4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNewColorData, addr 0x586f6a8, size 0x12c, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>& __cordl_internal_get__lightIntensityData();
  ...
  constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*> value);
  ...
  /// @brief Method .ctor, addr 0x586f7dc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GlobalShaderColorLightWithIds) == 0x48, "Size mismatch!");
