...
public:
  ...
  /// @brief Method CancelAsyncOperations, addr 0x57b37e0, size 0x358, virtual false, abstract: false, final false
  inline void CancelAsyncOperations();

  /// @brief Method CellForIdx, addr 0x57b32a0, size 0x358, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t index);

  /// @brief Method CellSize, addr 0x57b30d8, size 0xbc, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method ClearSelection, addr 0x57b4014, size 0x2c, virtual false, abstract: false, final false
  inline void ClearSelection();

  /// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x57b3744, size 0x9c, virtual false, abstract: false, final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  /// @brief Method HandleDidSelectCellWithIndex, addr 0x57b361c, size 0x128, virtual false, abstract: false, final false
  inline void HandleDidSelectCellWithIndex(::HMUI::TableView* tableView, int32_t index);

  /// @brief Method Init, addr 0x57b2a7c, size 0xcc, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method Init, addr 0x57b2a54, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberOfCells, addr 0x57b3194, size 0x10c, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method OnDestroy, addr 0x57b2ffc, size 0xdc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x57b2f04, size 0xf8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57b2e10, size 0xf4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshFavorites, addr 0x57b2cf0, size 0x120, virtual false, abstract: false, final false
  inline void RefreshFavorites(::System::Collections::Generic::HashSet_1<::StringW>* favoriteLevelIds);

  /// @brief Method RefreshLevelsAvailability, addr 0x57b3b58, size 0x494, virtual false, abstract: false, final false
  inline void RefreshLevelsAvailability();

  /// @brief Method ReloadCellsData, addr 0x57b3b38, size 0x20, virtual false, abstract: false, final false
  inline void ReloadCellsData();

  /// @brief Method SelectLevel, addr 0x57b4040, size 0x1bc, virtual false, abstract: false, final false
  inline void SelectLevel(::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method SelectLevelPackHeaderCell, addr 0x57b3fec, size 0x28, virtual false, abstract: false, final false
  inline void SelectLevelPackHeaderCell();

  /// @brief Method SetData, addr 0x57b2b48, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateScrollviewContentSize, addr 0x57b35f8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b41fc, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectHeaderEvent, addr 0x57b28d4, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectHeaderEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionTableView>>* value);

  /// @brief Method add_didSelectLevelEvent, addr 0x57b2754, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectHeaderEvent, addr 0x57b2994, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didSelectHeaderEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionTableView>>* value);

  /// @brief Method remove_didSelectLevelEvent, addr 0x57b2814, size 0xc0, virtual false, abstract: false, final false
