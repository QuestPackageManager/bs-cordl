...
/// @brief Method .ctor, addr 0x5dcaa34, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method WithSuggestedCapacityFrom, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::GlobalNamespace::OVRNativeList_CapacityHelper WithSuggestedCapacityFrom(::System::Collections::Generic::IEnumerable_1<T>*  collection, ::ByRef<::GlobalNamespace::OVREnumerable_1<T>>  nonAllocatingEnumerable) ;
