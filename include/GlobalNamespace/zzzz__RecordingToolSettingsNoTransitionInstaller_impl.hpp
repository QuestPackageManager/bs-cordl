...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3::*)()>(&::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3::MoveNext)> {
  constexpr static std::size_t size = 0x264;
  constexpr static std::size_t addrs = 0x577ae58;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3>::get(),
                        "MoveNext",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3::*)(::System::Runtime::CompilerServices::IAsyncStateMachine*)>(&::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3::SetStateMachine)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x577b0bc;
...
constexpr ::System::Runtime::CompilerServices::IAsyncStateMachine* GlobalNamespace::RecordingToolSettingsNoTransitionInstaller__WaitForTransition_d__3::i___System__Runtime__CompilerServices__IAsyncStateMachine()  {
return static_cast<::System::Runtime::CompilerServices::IAsyncStateMachine*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: Some("{}") }, CppParam { name: "setupData", ty: "::GlobalNamespace::RecordingToolSceneSetupData*", modifiers: "", def_value: Some("{}") }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller>", modifiers: "", def_value: Some("{}") }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<bool>", modifiers: "", def_value: Some("{}") }]
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller::*)(::Zenject::DiContainer*)>(&::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller::InstallBindings)> {
  ...
  constexpr static std::size_t addrs = 0x577ab60;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task* (::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller::*)(::GlobalNamespace::RecordingToolSceneSetupData*)>(&::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller::WaitForTransition)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x577ad90;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller::*)()>(&::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x577ae54;
