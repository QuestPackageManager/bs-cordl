...
public:
  ...
  /// @brief Method .ctor, addr 0x5845cc8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x5845cd4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5845d14, size 0x248, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::FireworkItemController__FireCoroutine_d__29* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5845f5c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5845f64, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5845f9c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5845d10, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5845890, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x5845638, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Fire, addr 0x584581c, size 0x20, virtual false, abstract: false, final false
  inline void Fire();

  /// @brief Method FireCoroutine, addr 0x584583c, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* FireCoroutine();

  /// @brief Method InitializeParticleSystem, addr 0x584599c, size 0x310, virtual false, abstract: false, final false
  inline void InitializeParticleSystem();

  static inline ::GlobalNamespace::FireworkItemController* New_ctor();

  /// @brief Method OnDisable, addr 0x58456bc, size 0x68, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method PlayExplosionSound, addr 0x5845898, size 0x104, virtual false, abstract: false, final false
  inline void PlayExplosionSound();

  /// @brief Method SetLightsColor, addr 0x5845724, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5845cac, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x58454b8, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::FireworkItemController>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x5845578, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::FireworkItemController>>* value);

  /// @brief Method set_directionalLight, addr 0x58454a8, size 0x8, virtual false, abstract: false, final false
  inline void set_directionalLight(::GlobalNamespace::DirectionalLight* value);

  /// @brief Method set_directionalLightIntensity, addr 0x58454b0, size 0x8, virtual false, abstract: false, final false
