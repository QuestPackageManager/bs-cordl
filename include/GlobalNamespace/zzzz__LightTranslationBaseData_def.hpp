...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightTranslationBaseData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightTranslationBaseData*, "", "LightTranslationBaseData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x371ca1c, size 0x14, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightTranslationBaseData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightTranslationBaseData(LightTranslationBaseData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightTranslationBaseData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightTranslationBaseData(LightTranslationBaseDataconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LightTranslationBaseData) == 0x20, "Size mismatch!");
