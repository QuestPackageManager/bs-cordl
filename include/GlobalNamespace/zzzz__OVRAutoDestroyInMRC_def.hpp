...
public:
  // Declarations
  /// @brief Method Start addr 0x262fcc0 size 0x118 virtual false final false
  inline void Start();

  /// @brief Method Update addr 0x262fdd8 size 0x4 virtual false final false
  inline void Update();

  static inline ::GlobalNamespace::OVRAutoDestroyInMRC* New_ctor();

  /// @brief Method .ctor addr 0x262fddc size 0x8 virtual false final false
  inline void _ctor();
