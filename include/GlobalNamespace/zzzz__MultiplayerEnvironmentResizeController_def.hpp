...
public:
  ...
  /// @brief Method .ctor, addr 0x27246bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lights, addr 0x27246ac, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>, ::Array<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>>*> get_lights();

  /// @brief Method get_offset, addr 0x27246a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_offset();

  /// @brief Method get_otherTransforms, addr 0x27246b4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Transform>, ::Array<::UnityW<::UnityEngine::Transform>>*> get_otherTransforms();

  /// @brief Method get_resizeType, addr 0x272469c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x2724314, size 0x18, virtual false, abstract: false, final false
  inline void HandleEdgeDistanceFromCenterWasCalculated(float_t edgeDistanceFromCenter);

  /// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x272432c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2724344, size 0x150, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Resize, addr 0x27244ac, size 0x1e8, virtual false, abstract: false, final false
  inline void Resize();

  /// @brief Method Start, addr 0x27241d8, size 0x13c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryResize, addr 0x2724494, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2724694, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_resizingDidFinishEvent, addr 0x27240a0, size 0x9c, virtual false, abstract: false, final false
  inline void add_resizingDidFinishEvent(::System::Action* value);

  /// @brief Method get_isResizingFinished, addr 0x2724098, size 0x8, virtual false, abstract: false, final false
  inline bool get_isResizingFinished();

  /// @brief Method remove_resizingDidFinishEvent, addr 0x272413c, size 0x9c, virtual false, abstract: false, final false
