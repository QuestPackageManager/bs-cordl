...
/// @brief Method .ctor, addr 0x582ce14, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_lights, addr 0x582ce04, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>,::Array<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>>*> get_lights() ;

/// @brief Method get_offset, addr 0x582cdfc, size 0x8, virtual false, abstract: false, final false
inline float_t get_offset() ;

/// @brief Method get_otherTransforms, addr 0x582ce0c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Transform>,::Array<::UnityW<::UnityEngine::Transform>>*> get_otherTransforms() ;

/// @brief Method get_resizeType, addr 0x582cdf4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _resizeData, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__resizeData, put=__cordl_internal_set__resizeData)) ::ArrayW<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*,::Array<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*>*>  _resizeData;
...
/// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x582ca08, size 0x18, virtual false, abstract: false, final false
inline void HandleEdgeDistanceFromCenterWasCalculated(float_t  edgeDistanceFromCenter) ;

/// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x582ca20, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x582ca38, size 0x1c0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Resize, addr 0x582cc10, size 0x1e0, virtual false, abstract: false, final false
inline void Resize() ;

/// @brief Method Start, addr 0x582c864, size 0x1a4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TryResize, addr 0x582cbf8, size 0x18, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*,::Array<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*>*> const& __cordl_internal_get__resizeData() const;

constexpr ::ArrayW<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*,::Array<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*>*>& __cordl_internal_get__resizeData() ;
...
constexpr void __cordl_internal_set__resizeData(::ArrayW<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*,::Array<::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData*>*>  value) ;
...
/// @brief Method .ctor, addr 0x582cdf0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_resizingDidFinishEvent, addr 0x582c70c, size 0xac, virtual false, abstract: false, final false
inline void add_resizingDidFinishEvent(::System::Action*  value) ;

/// @brief Method get_isResizingFinished, addr 0x582c704, size 0x8, virtual false, abstract: false, final false
inline bool get_isResizingFinished() ;

/// @brief Method remove_resizingDidFinishEvent, addr 0x582c7b8, size 0xac, virtual false, abstract: false, final false
