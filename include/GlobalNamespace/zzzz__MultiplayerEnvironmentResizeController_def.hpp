...
public:
  ...
  /// @brief Method .ctor, addr 0x589ed58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lights, addr 0x589ed48, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>, ::Array<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>>*> get_lights();

  /// @brief Method get_offset, addr 0x589ed40, size 0x8, virtual false, abstract: false, final false
  inline float_t get_offset();

  /// @brief Method get_otherTransforms, addr 0x589ed50, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Transform>, ::Array<::UnityW<::UnityEngine::Transform>>*> get_otherTransforms();

  /// @brief Method get_resizeType, addr 0x589ed38, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x589e94c, size 0x18, virtual false, abstract: false, final false
  inline void HandleEdgeDistanceFromCenterWasCalculated(float_t edgeDistanceFromCenter);

  /// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x589e964, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x589e97c, size 0x1c0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Resize, addr 0x589eb54, size 0x1e0, virtual false, abstract: false, final false
  inline void Resize();

  /// @brief Method Start, addr 0x589e7a8, size 0x1a4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TryResize, addr 0x589eb3c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x589ed34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_resizingDidFinishEvent, addr 0x589e650, size 0xac, virtual false, abstract: false, final false
  inline void add_resizingDidFinishEvent(::System::Action* value);

  /// @brief Method get_isResizingFinished, addr 0x589e648, size 0x8, virtual false, abstract: false, final false
  inline bool get_isResizingFinished();

  /// @brief Method remove_resizingDidFinishEvent, addr 0x589e6fc, size 0xac, virtual false, abstract: false, final false
