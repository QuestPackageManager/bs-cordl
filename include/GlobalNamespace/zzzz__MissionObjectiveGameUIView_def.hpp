...
public:
  ...
  /// @brief Method HandleMissionObjectiveCheckedValueDidChange, addr 0x244cb60, size 0x4, virtual false, abstract: false, final false
  inline void HandleMissionObjectiveCheckedValueDidChange(::GlobalNamespace::MissionObjectiveChecker* missionObjectiveChecker);

  /// @brief Method HandleMissionObjectiveStatusDidChange, addr 0x244cb5c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshIcon, addr 0x244ca00, size 0x104, virtual false, abstract: false, final false
  inline void RefreshIcon();

  /// @brief Method RefreshValue, addr 0x244cb04, size 0x58, virtual false, abstract: false, final false
  inline void RefreshValue();

  /// @brief Method SetMissionObjectiveChecker, addr 0x244c62c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x244cb64, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
