...
public:
  ...
  /// @brief Method HandleMissionObjectiveCheckedValueDidChange, addr 0x26f7d90, size 0x4, virtual false, abstract: false, final false
  inline void HandleMissionObjectiveCheckedValueDidChange(::GlobalNamespace::MissionObjectiveChecker* missionObjectiveChecker);

  /// @brief Method HandleMissionObjectiveStatusDidChange, addr 0x26f7d8c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshIcon, addr 0x26f7c30, size 0x104, virtual false, abstract: false, final false
  inline void RefreshIcon();

  /// @brief Method RefreshValue, addr 0x26f7d34, size 0x58, virtual false, abstract: false, final false
  inline void RefreshValue();

  /// @brief Method SetMissionObjectiveChecker, addr 0x26f79b4, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f7d94, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
