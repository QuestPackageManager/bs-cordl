...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IConnectedPlayerBeatmapObjectEventManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IConnectedPlayerBeatmapObjectEventManager(IConnectedPlayerBeatmapObjectEventManagerconst&) = delete;
