...
public:
  ...
  /// @brief Method CreateMeshIfNonExisting, addr 0x26c9bf0, size 0xb8, virtual false, abstract: false, final false
  inline void CreateMeshIfNonExisting();

  /// @brief Method CreateSliderMesh, addr 0x26c9ca8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26c9e38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x26c9be8, size 0x8, virtual false, abstract: false, final false
