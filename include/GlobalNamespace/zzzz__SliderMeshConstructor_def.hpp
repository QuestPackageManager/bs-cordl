...
// Write type traits
MARK_REF_T(::GlobalNamespace::SliderMeshConstructor*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SliderMeshConstructor*, "", "SliderMeshConstructor");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_reusableNormals, put = __cordl_internal_set_reusableNormals)) ::ArrayW<::UnityEngine::Vector3> reusableNormals;

  /// @brief Field reusableTriangles, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get_reusableTriangles, put = __cordl_internal_set_reusableTriangles)) ::ArrayW<int32_t> reusableTriangles;

  /// @brief Field reusableUvs, offset 0x30, size 0x8
  __declspec(property(get = __cordl_internal_get_reusableUvs, put = __cordl_internal_set_reusableUvs)) ::ArrayW<::UnityEngine::Vector3> reusableUvs;
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get_reusableNormals() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get_reusableNormals();

  constexpr ::ArrayW<int32_t> const& __cordl_internal_get_reusableTriangles() const;

  constexpr ::ArrayW<int32_t>& __cordl_internal_get_reusableTriangles();

  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get_reusableUvs() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get_reusableUvs();

  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get_reusableVerts() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get_reusableVerts();
  ...
  constexpr void __cordl_internal_set_reusableNormals(::ArrayW<::UnityEngine::Vector3> value);

  constexpr void __cordl_internal_set_reusableTriangles(::ArrayW<int32_t> value);

  constexpr void __cordl_internal_set_reusableUvs(::ArrayW<::UnityEngine::Vector3> value);
...
static_assert(sizeof(::GlobalNamespace::SliderMeshConstructor) == 0x50, "Size mismatch!");
