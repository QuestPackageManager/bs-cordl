...
public:
  ...
  /// @brief Method CreateMeshIfNonExisting, addr 0x25ac888, size 0xb8, virtual false, abstract: false, final false
  inline void CreateMeshIfNonExisting();

  /// @brief Method CreateSliderMesh, addr 0x25ac940, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25acad0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x25ac880, size 0x8, virtual false, abstract: false, final false
