...
public:
  ...
  /// @brief Method CreateMeshIfNonExisting, addr 0x583ff34, size 0xbc, virtual false, abstract: false, final false
  inline void CreateMeshIfNonExisting();

  /// @brief Method CreateSliderMesh, addr 0x583fff0, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x583ff28, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58401cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x583ff20, size 0x8, virtual false, abstract: false, final false
