...
/// @brief Method Begin, addr 0x575b98c, size 0x4, virtual false, abstract: false, final false
inline void Begin(::GlobalNamespace::BeatmapObjectManager*  objectManager) ;

/// @brief Method CaptureFrame, addr 0x575bbd8, size 0xdc, virtual false, abstract: false, final false
inline void CaptureFrame() ;

/// @brief Method ChangeNoteTypeCount, addr 0x575c498, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method ChangeSliderTypeCount, addr 0x575c578, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method ClearCallbacks, addr 0x575bd50, size 0x24c, virtual false, abstract: false, final false
inline void ClearCallbacks() ;

/// @brief Method Finish, addr 0x575bcb4, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method GenerateTableReport, addr 0x575bf9c, size 0x4c4, virtual false, abstract: false, final false
...
/// @brief Method OnDepawnObstacle, addr 0x575c608, size 0x10, virtual false, abstract: false, final false
inline void OnDepawnObstacle(::GlobalNamespace::ObstacleController*  obstacle) ;

/// @brief Method OnDespawnNote, addr 0x575c4fc, size 0x38, virtual false, abstract: false, final false
inline void OnDespawnNote(::GlobalNamespace::NoteController*  note) ;

/// @brief Method OnDespawnSlider, addr 0x575c5b4, size 0x44, virtual false, abstract: false, final false
inline void OnDespawnSlider(::GlobalNamespace::SliderController*  slider) ;

/// @brief Method OnSpawnNote, addr 0x575c460, size 0x38, virtual false, abstract: false, final false
inline void OnSpawnNote(::GlobalNamespace::NoteController*  note) ;

/// @brief Method OnSpawnObstacle, addr 0x575c5f8, size 0x10, virtual false, abstract: false, final false
inline void OnSpawnObstacle(::GlobalNamespace::ObstacleController*  obstacle) ;

/// @brief Method OnSpawnSlider, addr 0x575c534, size 0x44, virtual false, abstract: false, final false
inline void OnSpawnSlider(::GlobalNamespace::SliderController*  slider) ;

/// @brief Method SetupCallbacks, addr 0x575b990, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x575b908, size 0x84, virtual false, abstract: false, final false
