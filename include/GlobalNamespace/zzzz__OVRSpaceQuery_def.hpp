...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8824)), TypeDefinitionIndex(TypeDefinitionIndex(8695)), TypeDefinitionIndex(TypeDefinitionIndex(8826)),
// TypeDefinitionIndex(TypeDefinitionIndex(8694))} Self: TypeDefinitionIndex(TypeDefinitionIndex(8827)) CS Name: ::OVRSpaceQuery::Options
...
public:
  ...
  /// @brief Method get_MaxResults addr 0x2622614 size 0x8 virtual false final false
  inline int32_t get_MaxResults();

  /// @brief Method set_MaxResults addr 0x262261c size 0x8 virtual false final false
  inline void set_MaxResults(int32_t value);

  /// @brief Method get_Timeout addr 0x2622624 size 0x8 virtual false final false
  inline double_t get_Timeout();

  /// @brief Method set_Timeout addr 0x262262c size 0x8 virtual false final false
  inline void set_Timeout(double_t value);

  /// @brief Method get_Location addr 0x2622634 size 0x8 virtual false final false
  inline ::GlobalNamespace::__OVRSpace__StorageLocation get_Location();

  /// @brief Method set_Location addr 0x262263c size 0x8 virtual false final false
  inline void set_Location(::GlobalNamespace::__OVRSpace__StorageLocation value);

  /// @brief Method get_QueryType addr 0x2622644 size 0x8 virtual false final false
  inline ::GlobalNamespace::__OVRPlugin__SpaceQueryType get_QueryType();

  /// @brief Method set_QueryType addr 0x262264c size 0x8 virtual false final false
  inline void set_QueryType(::GlobalNamespace::__OVRPlugin__SpaceQueryType value);

  /// @brief Method get_ActionType addr 0x2622654 size 0x8 virtual false final false
  inline ::GlobalNamespace::__OVRPlugin__SpaceQueryActionType get_ActionType();

  /// @brief Method set_ActionType addr 0x262265c size 0x8 virtual false final false
  inline void set_ActionType(::GlobalNamespace::__OVRPlugin__SpaceQueryActionType value);

  /// @brief Method get_ComponentFilter addr 0x2622664 size 0x8 virtual false final false
  inline ::GlobalNamespace::__OVRSpaceQuery__ComponentType get_ComponentFilter();

  /// @brief Method set_ComponentFilter addr 0x261bd00 size 0x104 virtual false final false
  inline void set_ComponentFilter(::GlobalNamespace::__OVRSpaceQuery__ComponentType value);

  /// @brief Method get_UuidFilter addr 0x262266c size 0x8 virtual false final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Guid>* get_UuidFilter();

  /// @brief Method set_UuidFilter addr 0x261bafc size 0x204 virtual false final false
  inline void set_UuidFilter(::System::Collections::Generic::IEnumerable_1<::System::Guid>* value);

  /// @brief Method .ctor addr 0x2622674 size 0x34 virtual false final false
  inline void _ctor(::GlobalNamespace::__OVRSpaceQuery__Options other);

  /// @brief Method TryQuerySpaces addr 0x261be04 size 0x968 virtual false final false
