...
public:
  ...
  /// @brief Method ToQueryInfo, addr 0x5d96e10, size 0x1cc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_SpaceQueryInfo ToQueryInfo();

  /// @brief Method ToQueryInfo2, addr 0x5d96fdc, size 0x228, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_SpaceQueryInfo2 ToQueryInfo2();

  /// @brief Method TryQuerySpaces, addr 0x5d97204, size 0x88, virtual false, abstract: false, final false
  inline bool TryQuerySpaces(::ByRef<uint64_t> requestId);

  /// @brief Method ValidateSingleFilter, addr 0x5d96b18, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ActionType, addr 0x5d96abc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_SpaceQueryActionType get_ActionType();

  /// @brief Method get_ComponentFilter, addr 0x5d96acc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_SpaceComponentType get_ComponentFilter();

  /// @brief Method get_GroupFilter, addr 0x5d96da8, size 0x14, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::System::Guid> get_GroupFilter();

  /// @brief Method get_Location, addr 0x5d96a9c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSpace_StorageLocation get_Location();

  /// @brief Method get_MaxResults, addr 0x5d96a7c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxResults();

  /// @brief Method get_QueryType, addr 0x5d96aac, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_SpaceQueryType get_QueryType();

  /// @brief Method get_Timeout, addr 0x5d96a8c, size 0x8, virtual false, abstract: false, final false
  inline double_t get_Timeout();

  /// @brief Method get_UuidFilter, addr 0x5d96bdc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Guid>* get_UuidFilter();

  /// @brief Method set_ActionType, addr 0x5d96ac4, size 0x8, virtual false, abstract: false, final false
  inline void set_ActionType(::GlobalNamespace::OVRPlugin_SpaceQueryActionType value);

  /// @brief Method set_ComponentFilter, addr 0x5d96ad4, size 0x44, virtual false, abstract: false, final false
  inline void set_ComponentFilter(::GlobalNamespace::OVRPlugin_SpaceComponentType value);

  /// @brief Method set_GroupFilter, addr 0x5d96dbc, size 0x54, virtual false, abstract: false, final false
  inline void set_GroupFilter(::System::Nullable_1<::System::Guid> value);

  /// @brief Method set_Location, addr 0x5d96aa4, size 0x8, virtual false, abstract: false, final false
  inline void set_Location(::GlobalNamespace::OVRSpace_StorageLocation value);

  /// @brief Method set_MaxResults, addr 0x5d96a84, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxResults(int32_t value);

  /// @brief Method set_QueryType, addr 0x5d96ab4, size 0x8, virtual false, abstract: false, final false
  inline void set_QueryType(::GlobalNamespace::OVRPlugin_SpaceQueryType value);

  /// @brief Method set_Timeout, addr 0x5d96a94, size 0x8, virtual false, abstract: false, final false
  inline void set_Timeout(double_t value);

  /// @brief Method set_UuidFilter, addr 0x5d96be4, size 0x1c4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AppendAnchors, addr 0x5d95990, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ForAnchors, addr 0x5d95900, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ForAnchorsThrow, addr 0x5d95f10, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ForAnchorsUnchecked, addr 0x5d95c30, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method ForComponent, addr 0x5d960c0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method ForComponentThrow, addr 0x5d9626c, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method ForComponentUnchecked, addr 0x5d96188, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method ForGroup, addr 0x5d96414, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ForGroupThrow, addr 0x5d9679c, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ForGroupUnchecked, addr 0x5d96564, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method PostProcessQuery, addr 0x5d95e60, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToV1, addr 0x5d96964, size 0x14, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRPlugin_SpaceQueryInfo ToV1(::ByRef<::GlobalNamespace::OVRPlugin_SpaceQueryInfo2> query2);

  /// @brief Method ToV2, addr 0x5d96978, size 0x38, virtual false, abstract: false, final false
