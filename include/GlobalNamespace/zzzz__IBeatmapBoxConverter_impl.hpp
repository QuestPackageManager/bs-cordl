...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::IBeatmapBoxConverter::*)(::System::Collections::Generic::List_1<::System::ValueTuple_2<int32_t, int32_t>>*, int32_t,
                                                                                                         int32_t)>(&::GlobalNamespace::IBeatmapBoxConverter::ConvertBoxEventGroupId)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::IBeatmapBoxConverter*>(), { ::i2c::class_of<::GlobalNamespace::IBeatmapBoxConverter*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::GlobalNamespace::LightRotationBaseData* (::GlobalNamespace::IBeatmapBoxConverter::*)(float_t, ::BeatmapSaveDataVersion4::LightRotationEvent,
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::IBeatmapBoxConverter*>(), { ::i2c::class_of<::GlobalNamespace::IBeatmapBoxConverter*>(), 1 }));
    return ___internal_method;
  }
};
inline void GlobalNamespace::IBeatmapBoxConverter::ConvertBoxEventGroupId(::System::Collections::Generic::List_1<::System::ValueTuple_2<int32_t, int32_t>>* output, int32_t groupId,
  ...
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::IBeatmapBoxConverter*>(), 0 })));
...
inline ::GlobalNamespace::LightRotationBaseData* GlobalNamespace::IBeatmapBoxConverter::ConvertRotationEvent(float_t beat, ::BeatmapSaveDataVersion4::LightRotationEvent lightRotationEvent,
  ...
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::IBeatmapBoxConverter*>(), 1 })));
