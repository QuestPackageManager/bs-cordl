...
public:
  ...
  /// @brief Method add_timelinePauseEvent, addr 0x218971c, size 0x9c, virtual false, abstract: false, final false
  inline void add_timelinePauseEvent(::System::Action* value);

  /// @brief Method remove_timelinePauseEvent, addr 0x21897b8, size 0x9c, virtual false, abstract: false, final false
  inline void remove_timelinePauseEvent(::System::Action* value);

  /// @brief Method OnNotify, addr 0x2189854, size 0x94, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x21898e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
