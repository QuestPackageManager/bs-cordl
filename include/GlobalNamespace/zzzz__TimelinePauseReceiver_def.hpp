...
public:
  ...
  /// @brief Method OnNotify, addr 0x22b8e24, size 0x94, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22b8eb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_timelinePauseEvent, addr 0x22b8cec, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_timelinePauseEvent, addr 0x22b8d88, size 0x9c, virtual false, abstract: false, final false
