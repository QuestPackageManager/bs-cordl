...
/// @brief Method .ctor, addr 0x56b6760, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _bloomKernels, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__bloomKernels, put=__cordl_internal_set__bloomKernels)) ::ArrayW<::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*,::Array<::GlobalNamespace::KawaseBlurRendererSO_BloomKernel*>*>  _bloomKernels;
...
/// @brief Field kBloomIterationWeights, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_kBloomIterationWeights, put=setStaticF_kBloomIterationWeights)) ::ArrayW<::ArrayW<float_t,::Array<float_t>*>,::Array<::ArrayW<float_t,::Array<float_t>*>>*>  kBloomIterationWeights;

/// @brief Method AlphaWeights, addr 0x56b7610, size 0xd4, virtual false, abstract: false, final false
inline void AlphaWeights(::UnityEngine::RenderTexture*  src, ::UnityEngine::RenderTexture*  dest) ;

/// @brief Method Bloom, addr 0x56b67a0, size 0x520, virtual false, abstract: false, final false
inline void Bloom(::UnityEngine::RenderTexture*  src, ::UnityEngine::RenderTexture*  dest, int32_t  iterationsStart, int32_t  iterations, float_t  boost, float_t  alphaWeights, ::GlobalNamespace::KawaseBlurRendererSO_WeightsType  blurStartWeightsType, ::ArrayW<float_t,::Array<float_t>*>  bloomIterationWeights) ;

/// @brief Method Blur, addr 0x56b74ac, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method Blur, addr 0x56b6cc0, size 0x558, virtual false, abstract: false, final false
...
/// @brief Method Blur, addr 0x56b7588, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method CreateBlurCommandBuffer, addr 0x56b76e4, size 0x344, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CommandBuffer* CreateBlurCommandBuffer(int32_t  width, int32_t  height, ::StringW  globalTextureName, ::GlobalNamespace::KawaseBlurRendererSO_KernelSize  kernelSize, float_t  boost) ;

/// @brief Method DoubleBlur, addr 0x56b7218, size 0x294, virtual false, abstract: false, final false
inline void DoubleBlur(::UnityEngine::RenderTexture*  src, ::UnityEngine::RenderTexture*  dest, ::GlobalNamespace::KawaseBlurRendererSO_KernelSize  kernelSize0, float_t  boost0, ::GlobalNamespace::KawaseBlurRendererSO_KernelSize  kernelSize1, float_t  boost1, float_t  secondBlurAlpha, int32_t  downsample, bool  gammaCorrection) ;

/// @brief Method GetBlurKernel, addr 0x56b61b0, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x56b6764, size 0x3c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x56b63e0, size 0x380, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b7a28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
