...
public:
// Declarations
/// @brief Method DefaultNoteJumpMovementSpeed, addr 0x3621c34, size 0x20, virtual false, abstract: false, final false
static inline float_t DefaultNoteJumpMovementSpeed(::GlobalNamespace::BeatmapDifficulty  difficulty) ;

/// @brief Method DefaultRating, addr 0x3621be4, size 0x18, virtual false, abstract: false, final false
static inline int32_t DefaultRating(::GlobalNamespace::BeatmapDifficulty  difficulty) ;

/// @brief Method Name, addr 0x3621a4c, size 0xcc, virtual false, abstract: false, final false
static inline ::StringW Name(::GlobalNamespace::BeatmapDifficulty  difficulty) ;

/// @brief Method NoteJumpMovementSpeed, addr 0x3621bfc, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method ShortName, addr 0x3621b18, size 0xcc, virtual false, abstract: false, final false
