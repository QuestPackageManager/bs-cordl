...
// Write type traits
MARK_REF_T(::GlobalNamespace::MoveAndRotateWithMainCamera*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MoveAndRotateWithMainCamera*, "", "MoveAndRotateWithMainCamera");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MoveAndRotateWithMainCamera", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MoveAndRotateWithMainCamera(MoveAndRotateWithMainCamera&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MoveAndRotateWithMainCamera", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MoveAndRotateWithMainCamera(MoveAndRotateWithMainCameraconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MoveAndRotateWithMainCamera) == 0x50, "Size mismatch!");
