...
public:
  ...
  /// @brief Method Awake, addr 0x3b18054, size 0x4c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LateUpdate, addr 0x3b180a0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b181a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
