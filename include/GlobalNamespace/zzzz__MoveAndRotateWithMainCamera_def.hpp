...
/// @brief Method Awake, addr 0x575455c, size 0x134, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::MoveAndRotateWithMainCamera* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5754690, size 0xf4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnPreCullCallback, addr 0x5754784, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5754910, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
