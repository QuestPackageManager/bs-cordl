...
public:
  ...
  /// @brief Method Awake, addr 0x57c4684, size 0x134, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::MoveAndRotateWithMainCamera* New_ctor();

  /// @brief Method OnDestroy, addr 0x57c47b8, size 0xf4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnPreCullCallback, addr 0x57c48ac, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57c4a38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
