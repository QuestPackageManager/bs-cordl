...
public:
  ...
  /// @brief Method .ctor, addr 0x5875cb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x5875c94, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x5875c74, size 0x20, virtual false, abstract: false, final false
