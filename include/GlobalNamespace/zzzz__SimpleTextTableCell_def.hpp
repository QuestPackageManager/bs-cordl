...
public:
  ...
  /// @brief Method .ctor, addr 0x39e7598, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x39e7574, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x39e7550, size 0x24, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::SimpleTextTableCell, 0x80>, "Size mismatch!");
