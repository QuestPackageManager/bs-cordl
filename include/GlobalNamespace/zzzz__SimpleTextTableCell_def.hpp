...
public:
  ...
  /// @brief Method .ctor, addr 0x565ee18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x565edf8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x565edd8, size 0x20, virtual false, abstract: false, final false
