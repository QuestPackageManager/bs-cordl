...
public:
  ...
  /// @brief Method CaptureFrame, addr 0x3b1db3c, size 0x290, virtual false, abstract: false, final false
  inline void CaptureFrame();

  /// @brief Method Dispose, addr 0x3b1db30, size 0xc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GenerateListReport, addr 0x3b1ddcc, size 0x18c, virtual false, abstract: false, final false
  inline ::StringW GenerateListReport();

  /// @brief Method GenerateTableReport, addr 0x3b1df58, size 0x1c8, virtual false, abstract: false, final false
  inline ::StringW GenerateTableReport();

  static inline ::GlobalNamespace::OculusMetrics* New_ctor(int32_t initialFrameCapacity);

  /// @brief Method RecordMetrics, addr 0x3b1d67c, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b1d900, size 0x230, virtual false, abstract: false, final false
