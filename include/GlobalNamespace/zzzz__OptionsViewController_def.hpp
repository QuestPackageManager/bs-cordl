...
public:
  ...
  /// @brief Method DidActivate, addr 0x3b085dc, size 0x150, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::OptionsViewController* New_ctor();

  /// @brief Method <DidActivate>b__7_0, addr 0x3b08734, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__7_0();

  /// @brief Method <DidActivate>b__7_1, addr 0x3b08754, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__7_1();

  /// @brief Method <DidActivate>b__7_2, addr 0x3b08774, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b0872c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b0847c, size 0xb0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::OptionsViewController_OptionsButton>* value);

  /// @brief Method remove_didFinishEvent, addr 0x3b0852c, size 0xb0, virtual false, abstract: false, final false
