...
MARK_REF_T(::GlobalNamespace::OptionsViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OptionsViewController_OptionsButton, "", "OptionsViewController/OptionsButton");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OptionsViewController*, "", "OptionsViewController");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::OptionsViewController_OptionsButton) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5963874, size 0x1c0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::OptionsViewController* New_ctor();

  /// @brief Method <DidActivate>b__7_0, addr 0x5963a38, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__7_0();

  /// @brief Method <DidActivate>b__7_1, addr 0x5963a58, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__7_1();

  /// @brief Method <DidActivate>b__7_2, addr 0x5963a78, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5963a34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x59636f4, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::OptionsViewController_OptionsButton>* value);

  /// @brief Method remove_didFinishEvent, addr 0x59637b4, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OptionsViewController) == 0x98, "Size mismatch!");
