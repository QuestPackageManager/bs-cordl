...
public:
  ...
  /// @brief Method DidActivate, addr 0x57a9a7c, size 0x1c0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::OptionsViewController* New_ctor();

  /// @brief Method <DidActivate>b__7_0, addr 0x57a9c40, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__7_0();

  /// @brief Method <DidActivate>b__7_1, addr 0x57a9c60, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__7_1();

  /// @brief Method <DidActivate>b__7_2, addr 0x57a9c80, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a9c3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x57a98fc, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::OptionsViewController_OptionsButton>* value);

  /// @brief Method remove_didFinishEvent, addr 0x57a99bc, size 0xc0, virtual false, abstract: false, final false
