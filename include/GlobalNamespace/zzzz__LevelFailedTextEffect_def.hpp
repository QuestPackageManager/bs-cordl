...
public:
  ...
  /// @brief Method ShowEffect, addr 0x57d655c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57d6598, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
