...
public:
  ...
  /// @brief Method ShowEffect, addr 0x3b7efc0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7effc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
