...
public:
  ...
  /// @brief Method ShowEffect, addr 0x5848d88, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5848dc4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
