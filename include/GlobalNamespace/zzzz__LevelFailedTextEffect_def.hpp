...
public:
  ...
  /// @brief Method ShowEffect, addr 0x3b83f0c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b83f48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
