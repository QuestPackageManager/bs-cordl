...
public:
  ...
  /// @brief Method DisableAutoplayForAllControllers, addr 0x58b4868, size 0x48, virtual false, abstract: false, final false
  inline void DisableAutoplayForAllControllers();

  static inline ::GlobalNamespace::PlayerVRControllersManager* New_ctor();

  /// @brief Method SetupAutoplayForAllControllers, addr 0x58b481c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58b48b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_leftHandVRController, addr 0x58b480c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::VRController> get_leftHandVRController();

  /// @brief Method get_rightHandVRController, addr 0x58b4814, size 0x8, virtual false, abstract: false, final false
