...
public:
  ...
  /// @brief Method DisableAllVRControllers, addr 0x3bf5e98, size 0x38, virtual false, abstract: false, final false
  inline void DisableAllVRControllers();

  /// @brief Method EnableAllVRControllers, addr 0x3bf5ed0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bf5f08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_leftHandVRController, addr 0x3bf5e88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::VRController> get_leftHandVRController();

  /// @brief Method get_rightHandVRController, addr 0x3bf5e90, size 0x8, virtual false, abstract: false, final false
