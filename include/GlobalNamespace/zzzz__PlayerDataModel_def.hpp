...
/// @brief Method MoveNext, addr 0x3650118, size 0x240, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3650358, size 0x6c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::PlayerDataModel>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::PlayerData*>", modifiers: "", def_value: None }]
constexpr PlayerDataModel__UndoUnsavedChangesAsync_d__12(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::PlayerDataModel>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::PlayerData*>  __u__1) noexcept;
...
/// @brief Method FireAsyncSaveAndForget, addr 0x365008c, size 0x80, virtual false, abstract: false, final false
inline void FireAsyncSaveAndForget() ;

/// @brief Method Inject, addr 0x364fe80, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method OnApplicationPause, addr 0x364fea8, size 0x14, virtual false, abstract: false, final false
inline void OnApplicationPause(bool  pauseStatus) ;

/// @brief Method OnDisable, addr 0x364fed8, size 0xc4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method ResetData, addr 0x364ff9c, size 0x24, virtual false, abstract: false, final false
inline void ResetData() ;

/// @brief Method Save, addr 0x364febc, size 0x1c, virtual false, abstract: false, final false
inline void Save() ;

/// @brief Method SaveAsync, addr 0x3650070, size 0x1c, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* SaveAsync() ;

/// @brief Method UndoUnsavedChangesAsync, addr 0x364ffc0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x365010c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_playerData, addr 0x364fe78, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::PlayerData* get_playerData() ;

/// @brief Method get_playerDataFileModel, addr 0x364fe70, size 0x8, virtual false, abstract: false, final false
