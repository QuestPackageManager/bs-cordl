...
public:
  ...
  /// @brief Method get_playerDataFileModel, addr 0x12b53d4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerDataFileModel* get_playerDataFileModel();

  /// @brief Method get_playerData, addr 0x12b53dc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerData* get_playerData();

  /// @brief Method Inject, addr 0x12b53e4, size 0x28, virtual false, abstract: false, final false
  inline void Inject(::StringW playerDataJsonString, ::GlobalNamespace::PlayerDataFileModel* playerDataFileModel);

  /// @brief Method OnApplicationPause, addr 0x12b540c, size 0xc, virtual false, abstract: false, final false
  inline void OnApplicationPause(bool pauseStatus);

  /// @brief Method OnDisable, addr 0x12b5438, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method ResetData, addr 0x12b54b8, size 0x24, virtual false, abstract: false, final false
  inline void ResetData();

  /// @brief Method Save, addr 0x12b5418, size 0x20, virtual false, abstract: false, final false
  inline void Save();

  /// @brief Method SaveAsync, addr 0x12b54dc, size 0x20, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SaveAsync();

  static inline ::GlobalNamespace::PlayerDataModel* New_ctor();

  /// @brief Method .ctor, addr 0x12b54fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
