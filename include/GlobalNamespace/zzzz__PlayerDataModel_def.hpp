...
public:
  ...
  /// @brief Method get_playerDataFileManager addr 0x2371e70 size 0x8 virtual false final false
  inline ::GlobalNamespace::PlayerDataFileManagerSO* get_playerDataFileManager();

  /// @brief Method get_playerData addr 0x2371e78 size 0x8 virtual false final false
  inline ::GlobalNamespace::PlayerData* get_playerData();

  /// @brief Method OnEnable addr 0x2371e80 size 0x4 virtual false final false
  inline void OnEnable();

  /// @brief Method OnApplicationPause addr 0x2371eb0 size 0xc virtual false final false
  inline void OnApplicationPause(bool pauseStatus);

  /// @brief Method OnDisable addr 0x2371ee0 size 0x4 virtual false final false
  inline void OnDisable();

  /// @brief Method ResetData addr 0x2371ee4 size 0x28 virtual false final false
  inline void ResetData();

  /// @brief Method Save addr 0x2371ebc size 0x24 virtual false final false
  inline void Save();

  /// @brief Method Load addr 0x2371e84 size 0x2c virtual false final false
  inline void Load();

  static inline ::GlobalNamespace::PlayerDataModel* New_ctor();

  /// @brief Method .ctor addr 0x2371f0c size 0x8 virtual false final false
  inline void _ctor();
