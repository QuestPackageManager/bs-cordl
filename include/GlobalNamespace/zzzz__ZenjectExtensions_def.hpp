...
template<typename T>
static inline T InstantiatePrefabForComponentAt(::Zenject::DiContainer*  container, ::UnityEngine::Object*  prefab, ::UnityEngine::Vector3  position, ::UnityEngine::Quaternion  rotation, ::UnityEngine::Transform*  parent) ;
