...
public:
  ...
  /// @brief Method AddVelocity, addr 0x263886c, size 0x20, virtual true, abstract: false, final false
  inline void AddVelocity(::UnityEngine::Vector3 force);

  /// @brief Method Init, addr 0x2638840, size 0x2c, virtual true, abstract: false, final false
  inline void Init(::UnityEngine::Vector3 force, ::UnityEngine::Vector3 torque);

  /// @brief Method LateUpdate, addr 0x26386a4, size 0x19c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::NoteDebrisSimplePhysics* New_ctor();

  /// @brief Method Start, addr 0x2638678, size 0x2c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x263888c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_position, addr 0x263865c, size 0x1c, virtual true, abstract: false, final false
