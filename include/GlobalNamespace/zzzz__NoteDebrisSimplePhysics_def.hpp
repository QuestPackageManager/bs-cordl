...
/// @brief Method Awake, addr 0x572973c, size 0x78, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x57297b4, size 0xb4, virtual true, abstract: false, final false
inline void Init(::UnityEngine::Vector3  linearVelocity, ::UnityEngine::Vector3  angularVelocity, bool  forceOnlySimplePhysics) ;

/// @brief Method LateUpdate, addr 0x572944c, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5729868, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_currentAngularVelocityDegrees, addr 0x5729730, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_currentAngularVelocityDegrees() ;

/// @brief Method get_currentLinearVelocity, addr 0x5729724, size 0xc, virtual false, abstract: false, final false
