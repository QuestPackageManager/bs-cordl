...
public:
  ...
  /// @brief Method EnableSaberAttraction, addr 0x25aa6c8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColor, addr 0x25ad790, size 0x9c, virtual false, abstract: false, final false
  static inline void SetColor(::UnityEngine::MaterialPropertyBlock* materialPropertyBlock, ::UnityEngine::Color color);

  /// @brief Method SetInitialProperties, addr 0x25ad82c, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method SetInitialProperties, addr 0x25a8b80, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSaberAttractionPoint, addr 0x25ad6f8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTailHeadNoteJumpOffsetDifference, addr 0x25ad67c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTimeSinceHeadNoteJump, addr 0x25ad600, size 0x7c, virtual false, abstract: false, final false
  static inline void SetTimeSinceHeadNoteJump(::UnityEngine::MaterialPropertyBlock* materialPropertyBlock, float_t time);

  /// @brief Method UpdateMaterialPropertyBlock, addr 0x25a9c44, size 0x160, virtual false, abstract: false, final false
