...
public:
  ...
  /// @brief Method SetTimeSinceHeadNoteJump addr 0x2260884 size 0x7c virtual false final false
  static inline void SetTimeSinceHeadNoteJump(::UnityEngine::MaterialPropertyBlock* materialPropertyBlock, float_t time);

  /// @brief Method SetTailHeadNoteJumpOffsetDifference addr 0x2260900 size 0x7c virtual false final false
  ...
  /// @brief Method SetSaberAttractionPoint addr 0x226097c size 0x98 virtual false final false
  ...
  /// @brief Method EnableSaberAttraction addr 0x22523ec size 0x88 virtual false final false
  ...
  /// @brief Method SetColor addr 0x2260a14 size 0x9c virtual false final false
  static inline void SetColor(::UnityEngine::MaterialPropertyBlock* materialPropertyBlock, ::UnityEngine::Color color);

  /// @brief Method SetInitialProperties addr 0x2260ab0 size 0x260 virtual false final false
  ...
  /// @brief Method SetInitialProperties addr 0x2252294 size 0x158 virtual false final false
  ...
  /// @brief Method UpdateMaterialPropertyBlock addr 0x2252474 size 0x160 virtual false final false
