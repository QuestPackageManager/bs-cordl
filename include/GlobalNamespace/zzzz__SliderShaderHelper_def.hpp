...
public:
  ...
  /// @brief Method EnableSaberAttraction, addr 0x25b26c4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColor, addr 0x25b578c, size 0x9c, virtual false, abstract: false, final false
  static inline void SetColor(::UnityEngine::MaterialPropertyBlock* materialPropertyBlock, ::UnityEngine::Color color);

  /// @brief Method SetInitialProperties, addr 0x25b5828, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method SetInitialProperties, addr 0x25b0b7c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSaberAttractionPoint, addr 0x25b56f4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTailHeadNoteJumpOffsetDifference, addr 0x25b5678, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTimeSinceHeadNoteJump, addr 0x25b55fc, size 0x7c, virtual false, abstract: false, final false
  static inline void SetTimeSinceHeadNoteJump(::UnityEngine::MaterialPropertyBlock* materialPropertyBlock, float_t time);

  /// @brief Method UpdateMaterialPropertyBlock, addr 0x25b1c40, size 0x160, virtual false, abstract: false, final false
