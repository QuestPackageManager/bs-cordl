...
public:
  ...
  /// @brief Method HandlePlayersLayoutWasCalculated, addr 0x25ff4a8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25ff5d0, size 0x94, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x25ff404, size 0xa4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x25ff714, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_edgeDistanceFromCenterWasCalculatedEvent, addr 0x25ff280, size 0xb0, virtual false, abstract: false, final false
  inline void add_edgeDistanceFromCenterWasCalculatedEvent(::System::Action_1<float_t>* value);

  /// @brief Method get_edgeDistanceFromCenter, addr 0x25ff3f4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_edgeDistanceFromCenter();

  /// @brief Method get_isEdgeDistanceFromCenterCalculated, addr 0x25ff3e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isEdgeDistanceFromCenterCalculated();

  /// @brief Method remove_edgeDistanceFromCenterWasCalculatedEvent, addr 0x25ff330, size 0xb0, virtual false, abstract: false, final false
  inline void remove_edgeDistanceFromCenterWasCalculatedEvent(::System::Action_1<float_t>* value);

  /// @brief Method set_edgeDistanceFromCenter, addr 0x25ff3fc, size 0x8, virtual false, abstract: false, final false
  inline void set_edgeDistanceFromCenter(float_t value);

  /// @brief Method set_isEdgeDistanceFromCenterCalculated, addr 0x25ff3e8, size 0xc, virtual false, abstract: false, final false
