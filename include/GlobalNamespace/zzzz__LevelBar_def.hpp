...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b08728, size 0x1ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b088d4, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b088e0, size 0x184, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b08a64, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b08a70, size 0x778, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b091e8, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method OnDestroy, addr 0x3b0870c, size 0x14, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Setup, addr 0x3afacb8, size 0xac, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::BeatmapKey beatmapKey);

  /// @brief Method Setup, addr 0x3b0856c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupData, addr 0x3b08620, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b08720, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_hide, addr 0x3b04ab0, size 0x2c, virtual false, abstract: false, final false
