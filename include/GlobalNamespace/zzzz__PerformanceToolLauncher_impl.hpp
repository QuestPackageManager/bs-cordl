...
// Ctor Parameters [CppParam { name: "enableRecording", ty: "::UnityW<::GlobalNamespace::BoolSO>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "enableFpsVisualization", ty:
// "::UnityW<::GlobalNamespace::BoolSO>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "enableMemoryVisualization", ty: "::UnityW<::GlobalNamespace::BoolSO>", modifiers: "",
// def_value: Some("nullptr") }]
constexpr ::GlobalNamespace::__PerformanceToolLauncher__Config::__PerformanceToolLauncher__Config(::UnityW<::GlobalNamespace::BoolSO> enableRecording,
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PerformanceToolLauncher::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ...
        ::std::array<Il2CppType const*, 4>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::MainCamera*>::get(),
...
constexpr ::GlobalNamespace::__PerformanceToolLauncher__Config& GlobalNamespace::PerformanceToolLauncher::__cordl_internal_get__config() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____config;
}
constexpr ::GlobalNamespace::__PerformanceToolLauncher__Config const& GlobalNamespace::PerformanceToolLauncher::__cordl_internal_get__config() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____config;
}
constexpr void GlobalNamespace::PerformanceToolLauncher::__cordl_internal_set__config(::GlobalNamespace::__PerformanceToolLauncher__Config value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
