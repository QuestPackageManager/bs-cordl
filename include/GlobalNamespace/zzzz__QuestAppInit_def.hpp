...
public:
  ...
  /// @brief Method AppStartAndMultiSceneEditorSetup, addr 0x27217a8, size 0x4, virtual true, abstract: false, final false
  inline void AppStartAndMultiSceneEditorSetup();

  /// @brief Method InstallBindings, addr 0x2721948, size 0x2a0, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::QuestAppInit* New_ctor();

  /// @brief Method RepeatableSetupAsync, addr 0x27217ac, size 0xa0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RepeatableSetupAsync();

  /// @brief Method TransitionToNextScene, addr 0x272184c, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2721be8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
