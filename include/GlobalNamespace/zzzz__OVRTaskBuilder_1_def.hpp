...
namespace GlobalNamespace {
template<typename T>
class OVRTaskBuilder_1_PooledStateMachine;
}
namespace GlobalNamespace {
...
// Ctor Parameters [CppParam { name: "_pooledStateMachine", ty: "::GlobalNamespace::OVRTaskBuilder_1_PooledStateMachine<T>*", modifiers: "", def_value: None }, CppParam { name: "_task", ty: "::System::Nullable_1<::GlobalNamespace::OVRTask_1<T>>", modifiers: "", def_value: None }]
