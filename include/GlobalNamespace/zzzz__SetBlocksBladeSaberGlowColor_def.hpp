...
public:
  ...
  /// @brief Method Start, addr 0x59ea5d0, size 0x40, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59ea610, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
