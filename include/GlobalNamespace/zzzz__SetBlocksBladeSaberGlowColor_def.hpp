...
public:
  ...
  /// @brief Method Start, addr 0x3bedd4c, size 0x40, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bedd8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
