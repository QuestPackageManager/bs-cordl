...
public:
  ...
  /// @brief Method Start, addr 0x58b84dc, size 0x40, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58b851c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
