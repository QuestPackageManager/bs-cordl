...
public:
  ...
  /// @brief Method Start, addr 0x27267f8, size 0x40, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2726838, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
