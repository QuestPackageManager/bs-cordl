...
public:
  // Declarations
  /// @brief Method CreateTransformedData, addr 0x14a9abc, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0_0, addr 0x14a9ba8, size 0xe4, virtual false, abstract: false, final false
