...
public:
  // Declarations
  /// @brief Method CreateTransformedData, addr 0x26acde4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0_0, addr 0x26aced4, size 0xe4, virtual false, abstract: false, final false
