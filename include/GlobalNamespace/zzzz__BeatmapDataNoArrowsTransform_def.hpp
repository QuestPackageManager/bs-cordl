...
public:
  // Declarations
  /// @brief Method CreateTransformedData, addr 0x3608dd0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0_0, addr 0x3608ec4, size 0xe4, virtual false, abstract: false, final false
