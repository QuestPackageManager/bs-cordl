...
public:
  // Declarations
  /// @brief Method CreateTransformedData, addr 0x35ddf6c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0_0, addr 0x35de060, size 0xe4, virtual false, abstract: false, final false
