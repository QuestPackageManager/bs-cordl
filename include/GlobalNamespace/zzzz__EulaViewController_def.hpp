...
MARK_REF_T(::GlobalNamespace::EulaViewController*);
MARK_REF_T(::GlobalNamespace::EulaViewController__EnableButtonsCoroutine_d__17*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EulaViewController_ButtonType, "", "EulaViewController/ButtonType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EulaViewController*, "", "EulaViewController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EulaViewController__EnableButtonsCoroutine_d__17*, "", "EulaViewController/<EnableButtonsCoroutine>d__17");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5a134f0, size 0x174, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::EulaViewController__EnableButtonsCoroutine_d__17* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5a13664, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5a1366c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5a136a4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5a134ec, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a133a8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EulaViewController__EnableButtonsCoroutine_d__17) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method Awake, addr 0x5a12eac, size 0x38, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DidActivate, addr 0x5a12ee4, size 0x388, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5a132d0, size 0xcc, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method EnableButtonsCoroutine, addr 0x5a1326c, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* EnableButtonsCoroutine(float_t delay);

  /// @brief Method Init, addr 0x5a1339c, size 0xc, virtual false, abstract: false, final false
  inline void Init(bool showUpdate, bool showOnlyContinueButton);

  static inline ::GlobalNamespace::EulaViewController* New_ctor();

  /// @brief Method <DidActivate>b__14_0, addr 0x5a133fc, size 0x50, virtual false, abstract: false, final false
  inline void _DidActivate_b__14_0();

  /// @brief Method <DidActivate>b__14_1, addr 0x5a1344c, size 0x50, virtual false, abstract: false, final false
  inline void _DidActivate_b__14_1();

  /// @brief Method <DidActivate>b__14_2, addr 0x5a1349c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a133b0, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EulaViewController) == 0xd8, "Size mismatch!");
