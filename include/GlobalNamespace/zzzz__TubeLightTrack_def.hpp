...
// [TrackClipType(typeof(TubeLightAsset))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x590b57c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TubeLightTrack", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TubeLightTrack(TubeLightTrack&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TubeLightTrack", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TubeLightTrack(TubeLightTrackconst&) = delete;
