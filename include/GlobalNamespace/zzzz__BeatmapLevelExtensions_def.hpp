...
public:
  ...
  /// @brief Method <ToRuntime>b__1_0, addr 0x26cac3c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _ToRuntime_b__1_0(::StringW l);

  /// @brief Method .ctor, addr 0x26cac34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateColorScheme, addr 0x26ca940, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method ToCensoredRuntime, addr 0x26c91b0, size 0x930, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRuntime, addr 0x26c9b0c, size 0xd04, virtual false, abstract: false, final false
