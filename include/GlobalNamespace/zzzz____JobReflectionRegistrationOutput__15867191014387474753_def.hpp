...
public:
// Declarations
/// @brief Method CreateJobReflectionData, addr 0x6682ae8, size 0x6cc, virtual false, abstract: false, final false
static inline void CreateJobReflectionData() ;

/// @brief Method EarlyInit, addr 0x66831b4, size 0x4, virtual false, abstract: false, final false
