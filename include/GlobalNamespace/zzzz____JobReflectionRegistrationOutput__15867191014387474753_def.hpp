...
public:
  // Declarations
  /// @brief Method CreateJobReflectionData, addr 0x66f4af4, size 0x6cc, virtual false, abstract: false, final false
  static inline void CreateJobReflectionData();

  /// @brief Method EarlyInit, addr 0x66f51c0, size 0x4, virtual false, abstract: false, final false
