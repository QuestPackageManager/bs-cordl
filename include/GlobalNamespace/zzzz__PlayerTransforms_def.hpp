...
public:
  ...
  /// @brief Field _headWorldPos, offset 0x64, size 0xc
  ...
  /// @brief Field _headWorldRot, offset 0x70, size 0x10
  ...
  /// @brief Field _leftHandPseudoLocalPos, offset 0xa8, size 0xc
  ...
  /// @brief Field _leftHandPseudoLocalRot, offset 0xb4, size 0x10
  ...
  /// @brief Field _originParentTransform, offset 0xe0, size 0x8
  ...
  /// @brief Field _overrideHeadPos, offset 0x60, size 0x1
  ...
  /// @brief Field _rightHandPseudoLocalPos, offset 0xc4, size 0xc
  ...
  /// @brief Field _rightHandPseudoLocalRot, offset 0xd0, size 0x10
  ...
  /// @brief Field _useOriginParentTransformForPseudoLocalCalculations, offset 0xe8, size 0x1
  ...
  /// @brief Method Awake, addr 0x3be865c, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ClearHeadPositionOverride, addr 0x3be8700, size 0x8, virtual false, abstract: false, final false
  inline void ClearHeadPositionOverride();

  static inline ::GlobalNamespace::PlayerTransforms* New_ctor();

  /// @brief Method OverrideHeadPos, addr 0x3be86e0, size 0x20, virtual false, abstract: false, final false
  inline void OverrideHeadPos(::UnityEngine::Vector3 pos);

  /// @brief Method Update, addr 0x3be8708, size 0x224, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3be892c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_headPseudoLocalPos, addr 0x3be8608, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headPseudoLocalPos();

  /// @brief Method get_headPseudoLocalRot, addr 0x3be8620, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_headPseudoLocalRot();

  /// @brief Method get_headPseudoLocalZOnlyPos, addr 0x3be8614, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headPseudoLocalZOnlyPos();

  /// @brief Method get_headWorldPos, addr 0x3be85f0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headWorldPos();

  /// @brief Method get_headWorldRot, addr 0x3be85fc, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_headWorldRot();

  /// @brief Method get_leftHandPseudoLocalPos, addr 0x3be862c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftHandPseudoLocalPos();

  /// @brief Method get_leftHandPseudoLocalRot, addr 0x3be8638, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_leftHandPseudoLocalRot();

  /// @brief Method get_rightHandPseudoLocalPos, addr 0x3be8644, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_rightHandPseudoLocalPos();

  /// @brief Method get_rightHandPseudoLocalRot, addr 0x3be8650, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _overrideHeadPos, offset: 0x60, size: 0x1, def value: None
  bool ____overrideHeadPos;

  /// @brief Field _headWorldPos, offset: 0x64, size: 0xc, def value: None
  ::UnityEngine::Vector3 ____headWorldPos;

  /// @brief Field _headWorldRot, offset: 0x70, size: 0x10, def value: None
  ::UnityEngine::Quaternion ____headWorldRot;

  /// @brief Field _headPseudoLocalPos, offset: 0x80, size: 0xc, def value: None
  ...
  /// @brief Field _leftHandPseudoLocalRot, offset: 0xb4, size: 0x10, def value: None
  ::UnityEngine::Quaternion ____leftHandPseudoLocalRot;

  /// @brief Field _rightHandPseudoLocalPos, offset: 0xc4, size: 0xc, def value: None
  ::UnityEngine::Vector3 ____rightHandPseudoLocalPos;

  /// @brief Field _rightHandPseudoLocalRot, offset: 0xd0, size: 0x10, def value: None
  ::UnityEngine::Quaternion ____rightHandPseudoLocalRot;

  /// @brief Field _originParentTransform, offset: 0xe0, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Transform> ____originParentTransform;

  /// @brief Field _useOriginParentTransformForPseudoLocalCalculations, offset: 0xe8, size: 0x1, def value: None
...
static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____overrideHeadPos) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____headWorldPos) == 0x64, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____headWorldRot) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____headPseudoLocalPos) == 0x80, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____leftHandPseudoLocalRot) == 0xb4, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____rightHandPseudoLocalPos) == 0xc4, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____rightHandPseudoLocalRot) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____originParentTransform) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PlayerTransforms, ____useOriginParentTransformForPseudoLocalCalculations) == 0xe8, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::PlayerTransforms, 0xf0>, "Size mismatch!");
