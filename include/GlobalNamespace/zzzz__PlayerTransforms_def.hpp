...
public:
  ...
  /// @brief Method Awake, addr 0x274fa7c, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ClearHeadPositionOverride, addr 0x274fb1c, size 0x8, virtual false, abstract: false, final false
  inline void ClearHeadPositionOverride();

  /// @brief Method GetZPos, addr 0x274fd90, size 0x28, virtual false, abstract: false, final false
  inline float_t GetZPos(float_t start, float_t end, float_t headOffsetZ, float_t t);

  /// @brief Method GetZPosOffsetByHeadPosAtTime, addr 0x274fdb8, size 0x2c, virtual false, abstract: false, final false
  inline float_t GetZPosOffsetByHeadPosAtTime(float_t start, float_t end, float_t t);

  /// @brief Method HeadOffsetZ, addr 0x274fd70, size 0x20, virtual false, abstract: false, final false
  inline float_t HeadOffsetZ(::UnityEngine::Quaternion noteInverseWorldRotation);

  /// @brief Method MoveTowardsHead, addr 0x274fcfc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method OverrideHeadPos, addr 0x274fb00, size 0x1c, virtual false, abstract: false, final false
  inline void OverrideHeadPos(::UnityEngine::Vector3 pos);

  /// @brief Method Update, addr 0x274fb24, size 0x1d8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x274fde4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_headPseudoLocalPos, addr 0x274fa34, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headPseudoLocalPos();

  /// @brief Method get_headPseudoLocalRot, addr 0x274fa40, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_headPseudoLocalRot();

  /// @brief Method get_headWorldPos, addr 0x274fa1c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headWorldPos();

  /// @brief Method get_headWorldRot, addr 0x274fa28, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_headWorldRot();

  /// @brief Method get_leftHandPseudoLocalPos, addr 0x274fa4c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftHandPseudoLocalPos();

  /// @brief Method get_leftHandPseudoLocalRot, addr 0x274fa58, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_leftHandPseudoLocalRot();

  /// @brief Method get_rightHandPseudoLocalPos, addr 0x274fa64, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_rightHandPseudoLocalPos();

  /// @brief Method get_rightHandPseudoLocalRot, addr 0x274fa70, size 0xc, virtual false, abstract: false, final false
