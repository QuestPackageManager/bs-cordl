...
/// @brief Method Awake, addr 0x5841f44, size 0x88, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ClearHeadPositionOverride, addr 0x5841fec, size 0x8, virtual false, abstract: false, final false
inline void ClearHeadPositionOverride() ;

static inline ::GlobalNamespace::PlayerTransforms* New_ctor() ;

/// @brief Method OverrideHeadPos, addr 0x5841fcc, size 0x20, virtual false, abstract: false, final false
inline void OverrideHeadPos(::UnityEngine::Vector3  pos) ;

/// @brief Method Update, addr 0x5841ff4, size 0x22c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5842220, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_headPseudoLocalPos, addr 0x5841ef0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_headPseudoLocalPos() ;

/// @brief Method get_headPseudoLocalRot, addr 0x5841f08, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_headPseudoLocalRot() ;

/// @brief Method get_headPseudoLocalZOnlyPos, addr 0x5841efc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_headPseudoLocalZOnlyPos() ;

/// @brief Method get_headWorldPos, addr 0x5841ed8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_headWorldPos() ;

/// @brief Method get_headWorldRot, addr 0x5841ee4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_headWorldRot() ;

/// @brief Method get_leftHandPseudoLocalPos, addr 0x5841f14, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_leftHandPseudoLocalPos() ;

/// @brief Method get_leftHandPseudoLocalRot, addr 0x5841f20, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_leftHandPseudoLocalRot() ;

/// @brief Method get_rightHandPseudoLocalPos, addr 0x5841f2c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_rightHandPseudoLocalPos() ;

/// @brief Method get_rightHandPseudoLocalRot, addr 0x5841f38, size 0xc, virtual false, abstract: false, final false
