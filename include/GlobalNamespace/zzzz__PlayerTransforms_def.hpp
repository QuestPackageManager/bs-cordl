...
public:
  ...
  /// @brief Method get_headWorldPos, addr 0x23bf734, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headWorldPos();

  /// @brief Method get_headWorldRot, addr 0x23bf740, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_headWorldRot();

  /// @brief Method get_headPseudoLocalPos, addr 0x23bf74c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_headPseudoLocalPos();

  /// @brief Method get_headPseudoLocalRot, addr 0x23bf758, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_headPseudoLocalRot();

  /// @brief Method get_leftHandPseudoLocalPos, addr 0x23bf764, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftHandPseudoLocalPos();

  /// @brief Method get_leftHandPseudoLocalRot, addr 0x23bf770, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_leftHandPseudoLocalRot();

  /// @brief Method get_rightHandPseudoLocalPos, addr 0x23bf77c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_rightHandPseudoLocalPos();

  /// @brief Method get_rightHandPseudoLocalRot, addr 0x23bf788, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rightHandPseudoLocalRot();

  /// @brief Method Awake, addr 0x23bf794, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method OverrideHeadPos, addr 0x23bf818, size 0x1c, virtual false, abstract: false, final false
  inline void OverrideHeadPos(::UnityEngine::Vector3 pos);

  /// @brief Method Update, addr 0x23bf834, size 0x1d8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method MoveTowardsHead, addr 0x23bfa0c, size 0x74, virtual false, abstract: false, final false
  inline float_t MoveTowardsHead(float_t start, float_t end, ::UnityEngine::Quaternion noteInverseWorldRotation, float_t t);

  /// @brief Method GetZPosOffsetByHeadPosAtTime, addr 0x23bfac8, size 0x2c, virtual false, abstract: false, final false
  inline float_t GetZPosOffsetByHeadPosAtTime(float_t start, float_t end, float_t t);

  /// @brief Method GetZPos, addr 0x23bfaa0, size 0x28, virtual false, abstract: false, final false
  inline float_t GetZPos(float_t start, float_t end, float_t headOffsetZ, float_t t);

  /// @brief Method HeadOffsetZ, addr 0x23bfa80, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bfaf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
