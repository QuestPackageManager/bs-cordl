...
/// @brief Field _disableVRTrackingInAutoplay, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__disableVRTrackingInAutoplay, put=__cordl_internal_set__disableVRTrackingInAutoplay)) ::UnityW<::UnityEngine::UI::Toggle>  _disableVRTrackingInAutoplay;
...
/// @brief Method DidActivate, addr 0x57386bc, size 0x37c, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x5738a38, size 0x9c, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleDisableVRTrackingInAutoplayChanged, addr 0x5738b44, size 0x1c, virtual false, abstract: false, final false
inline void HandleDisableVRTrackingInAutoplayChanged(bool  newValue) ;

/// @brief Method HandleFpsCounterChanged, addr 0x5738ad4, size 0x1c, virtual false, abstract: false, final false
inline void HandleFpsCounterChanged(bool  newValue) ;

/// @brief Method HandleFpsRecorderChanged, addr 0x5738af0, size 0x1c, virtual false, abstract: false, final false
inline void HandleFpsRecorderChanged(bool  newValue) ;

/// @brief Method HandleMemoryTrackerChanged, addr 0x5738b0c, size 0x1c, virtual false, abstract: false, final false
inline void HandleMemoryTrackerChanged(bool  newValue) ;

/// @brief Method HandleShowBeatmapLevelVersionsChanged, addr 0x5738b28, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5738b60, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
