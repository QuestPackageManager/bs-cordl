...
public:
  ...
  /// @brief Method OnDestroy, addr 0x39c4c90, size 0xe8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RaiseSignal, addr 0x39c4d78, size 0x20, virtual false, abstract: false, final false
  inline void RaiseSignal(bool newValue);

  /// @brief Method Start, addr 0x39c4bec, size 0xa4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x39c4d98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
