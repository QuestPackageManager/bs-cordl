...
public:
  ...
  /// @brief Method OnDestroy, addr 0x5712040, size 0x130, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RaiseSignal, addr 0x5712170, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseSignal(bool newValue);

  /// @brief Method Start, addr 0x5711f58, size 0xe8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x571218c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
