...
public:
// Declarations
/// @brief Method .ctor, addr 0x572123c, size 0x14, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "headNoteOffset", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "headGravityBase", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "tailNoteOffset", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "tailGravityBase", ty: "float_t", modifiers: "", def_value: None }]
