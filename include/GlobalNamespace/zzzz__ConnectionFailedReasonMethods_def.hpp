...
public:
  // Declarations
  /// @brief Method ErrorCode, addr 0x26dc384, size 0x80, virtual false, abstract: false, final false
  static inline ::StringW ErrorCode(::GlobalNamespace::ConnectionFailedReason connectionFailedReason);

  /// @brief Method LocalizedKey, addr 0x26dc2c4, size 0xc0, virtual false, abstract: false, final false
