...
public:
  ...
  /// @brief Method Awake, addr 0x56a2f18, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::Rotate* New_ctor();

  /// @brief Method OnBecameInvisible, addr 0x56a30d0, size 0xc, virtual false, abstract: false, final false
  inline void OnBecameInvisible();

  /// @brief Method OnBecameVisible, addr 0x56a2fe8, size 0x20, virtual false, abstract: false, final false
  inline void OnBecameVisible();

  /// @brief Method Randomize, addr 0x56a3008, size 0xc8, virtual false, abstract: false, final false
  inline void Randomize();

  /// @brief Method Update, addr 0x56a30dc, size 0xf8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x56a31d4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
