...
public:
  ...
  /// @brief Method Awake, addr 0x39c3a14, size 0xc8, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::Rotate* New_ctor();

  /// @brief Method OnBecameInvisible, addr 0x39c3b64, size 0xc, virtual false, abstract: false, final false
  inline void OnBecameInvisible();

  /// @brief Method OnBecameVisible, addr 0x39c3adc, size 0x20, virtual false, abstract: false, final false
  inline void OnBecameVisible();

  /// @brief Method Randomize, addr 0x39c3afc, size 0x68, virtual false, abstract: false, final false
  inline void Randomize();

  /// @brief Method Update, addr 0x39c3b70, size 0xc4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x39c3c34, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
