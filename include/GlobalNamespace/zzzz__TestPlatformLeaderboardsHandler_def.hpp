...
public:
// Declarations
/// @brief Method GetScores, addr 0x369bb80, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method UploadScore, addr 0x369bbd4, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x369bc28, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
