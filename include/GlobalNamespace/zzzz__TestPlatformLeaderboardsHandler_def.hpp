...
public:
  // Declarations
  /// @brief Method GetScores addr 0x232afb4 size 0x5c virtual true final false
  ...
  /// @brief Method UploadScore addr 0x232b010 size 0x5c virtual true final false
  ...
  /// @brief Method .ctor addr 0x232b06c size 0x8 virtual false final false
  inline void _ctor();
