...
public:
  ...
  /// @brief Method UploadScore, addr 0x375c3ec, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375c440, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
