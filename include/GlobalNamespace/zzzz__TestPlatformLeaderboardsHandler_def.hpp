...
// Write type traits
MARK_REF_T(::GlobalNamespace::TestPlatformLeaderboardsHandler*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TestPlatformLeaderboardsHandler*, "", "TestPlatformLeaderboardsHandler");
...
public:
  // Declarations
  /// @brief Method GetScores, addr 0x3757b8c, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method UploadScore, addr 0x3757be0, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3757c34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TestPlatformLeaderboardsHandler) == 0x10, "Size mismatch!");
