...
constexpr ::GlobalNamespace::Preset_MirrorRendererGraphicsSettingsPresets_MirrorType  GlobalNamespace::Preset_MirrorRendererGraphicsSettingsPresets_MirrorType::RenderedMirror{static_cast<int32_t>(0x2)};
//  Writing Method size for method: ::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset._ctor
template<>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset::*)()>(&::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset::_ctor)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x36330b0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*> (::GlobalNamespace::MirrorRendererGraphicsSettingsPresets::*)()>(&::GlobalNamespace::MirrorRendererGraphicsSettingsPresets::get_presets)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3633098;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::NamedPreset*,::Array<::GlobalNamespace::NamedPreset*>*> (::GlobalNamespace::MirrorRendererGraphicsSettingsPresets::*)()>(&::GlobalNamespace::MirrorRendererGraphicsSettingsPresets::get_namedPresets)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x36330a0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MirrorRendererGraphicsSettingsPresets::*)()>(&::GlobalNamespace::MirrorRendererGraphicsSettingsPresets::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x36330a8;
...
constexpr ::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*>& GlobalNamespace::MirrorRendererGraphicsSettingsPresets::__cordl_internal_get__presets()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____presets;
}
constexpr ::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*> const& GlobalNamespace::MirrorRendererGraphicsSettingsPresets::__cordl_internal_get__presets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____presets;
}
constexpr void GlobalNamespace::MirrorRendererGraphicsSettingsPresets::__cordl_internal_set__presets(::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*> GlobalNamespace::MirrorRendererGraphicsSettingsPresets::get_presets()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets*>::get(),
                        "get_presets",
                        std::span<const Il2CppClass* const, 0>(),
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*>, false>(this, ___internal_method);
}
