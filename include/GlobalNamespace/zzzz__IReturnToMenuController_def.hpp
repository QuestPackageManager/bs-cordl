...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IReturnToMenuController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IReturnToMenuController(IReturnToMenuControllerconst&) = delete;
