...
public:
  ...
  /// @brief Method Deserialize, addr 0x3653704, size 0x130, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x365350c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x36533fc, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::PlayersMissingEntitlementsNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x36535c8, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3653468, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playersWithoutEntitlements, addr 0x36533f4, size 0x8, virtual false, abstract: false, final false
