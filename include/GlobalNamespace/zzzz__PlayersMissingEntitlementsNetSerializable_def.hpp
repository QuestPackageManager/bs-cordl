...
public:
  ...
  /// @brief Method Deserialize, addr 0x272408c, size 0x114, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x2723e94, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x2723d90, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::PlayersMissingEntitlementsNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x2723f2c, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2723df4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playersWithoutEntitlements, addr 0x2723d88, size 0x8, virtual false, abstract: false, final false
