...
public:
  ...
  /// @brief Method Deserialize, addr 0x3680518, size 0x130, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x3680320, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x3680210, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::PlayersMissingEntitlementsNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x36803dc, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368027c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playersWithoutEntitlements, addr 0x3680208, size 0x8, virtual false, abstract: false, final false
