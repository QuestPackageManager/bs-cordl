...
public:
  ...
  /// @brief Method .ctor, addr 0x5858ee4, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_transformGroupType, addr 0x5858edc, size 0x8, virtual true, abstract: false, final false
