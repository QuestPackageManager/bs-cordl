...
public:
  ...
  /// @brief Method .ctor, addr 0x5862868, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_material, addr 0x5862860, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_renderingPriority, addr 0x5862858, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BloomPrePassLightTypeSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BloomPrePassLightTypeSO(BloomPrePassLightTypeSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BloomPrePassLightTypeSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BloomPrePassLightTypeSO(BloomPrePassLightTypeSOconst&) = delete;
