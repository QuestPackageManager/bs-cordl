...
public:
  ...
  /// @brief Method get_renderingPriority, addr 0x219b918, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_renderingPriority();

  /// @brief Method get_material, addr 0x219b920, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  static inline ::GlobalNamespace::BloomPrePassLightTypeSO* New_ctor();

  /// @brief Method .ctor, addr 0x219b928, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
