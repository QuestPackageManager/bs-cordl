...
public:
  ...
  /// @brief Method .ctor, addr 0x39e7388, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_material, addr 0x39e7380, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_renderingPriority, addr 0x39e7378, size 0x8, virtual false, abstract: false, final false
