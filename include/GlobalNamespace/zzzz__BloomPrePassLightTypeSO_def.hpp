...
public:
  ...
  /// @brief Method .ctor, addr 0x39dc074, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_material, addr 0x39dc06c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_renderingPriority, addr 0x39dc064, size 0x8, virtual false, abstract: false, final false
