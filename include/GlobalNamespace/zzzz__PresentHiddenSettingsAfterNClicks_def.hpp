...
public:
  ...
  /// @brief Method OnDisable, addr 0x3b5a798, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3b5a700, size 0x98, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method <OnEnable>b__6_0, addr 0x3b5a81c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b5a7b4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
