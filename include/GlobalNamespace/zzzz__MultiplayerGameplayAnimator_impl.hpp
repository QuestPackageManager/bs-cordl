...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerGameplayAnimator::*)()>(&::GlobalNamespace::MultiplayerGameplayAnimator::Start)> {
  ...
  constexpr static std::size_t addrs = 0x582ce18;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerGameplayAnimator::*)()>(&::GlobalNamespace::MultiplayerGameplayAnimator::OnDestroy)> {
  constexpr static std::size_t size = 0x1d0;
  constexpr static std::size_t addrs = 0x582cee8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerGameplayAnimator::*)(bool)>(&::GlobalNamespace::MultiplayerGameplayAnimator::AnimateNewLeaderSelected)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerGameplayAnimator::*)(::GlobalNamespace::MultiplayerController_State)>(&::GlobalNamespace::MultiplayerGameplayAnimator::HandleStateChanged)> {
  constexpr static std::size_t size = 0x150;
  constexpr static std::size_t addrs = 0x582d178;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerGameplayAnimator::*)(::StringW)>(&::GlobalNamespace::MultiplayerGameplayAnimator::HandleNewLeaderWasSelected)> {
  constexpr static std::size_t size = 0xf4;
  constexpr static std::size_t addrs = 0x582d388;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerGameplayAnimator::*)()>(&::GlobalNamespace::MultiplayerGameplayAnimator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x582d47c;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>,::Array<::UnityW<::GlobalNamespace::LightsAnimator>>*>& GlobalNamespace::MultiplayerGameplayAnimator::__cordl_internal_get__gameplayLightsAnimators()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameplayLightsAnimators;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>,::Array<::UnityW<::GlobalNamespace::LightsAnimator>>*> const& GlobalNamespace::MultiplayerGameplayAnimator::__cordl_internal_get__gameplayLightsAnimators() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameplayLightsAnimators;
}
constexpr void GlobalNamespace::MultiplayerGameplayAnimator::__cordl_internal_set__gameplayLightsAnimators(::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>,::Array<::UnityW<::GlobalNamespace::LightsAnimator>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>,::Array<::UnityW<::GlobalNamespace::LightsAnimator>>*>& GlobalNamespace::MultiplayerGameplayAnimator::__cordl_internal_get__allLightsAnimators()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____allLightsAnimators;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>,::Array<::UnityW<::GlobalNamespace::LightsAnimator>>*> const& GlobalNamespace::MultiplayerGameplayAnimator::__cordl_internal_get__allLightsAnimators() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____allLightsAnimators;
}
constexpr void GlobalNamespace::MultiplayerGameplayAnimator::__cordl_internal_set__allLightsAnimators(::ArrayW<::UnityW<::GlobalNamespace::LightsAnimator>,::Array<::UnityW<::GlobalNamespace::LightsAnimator>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
