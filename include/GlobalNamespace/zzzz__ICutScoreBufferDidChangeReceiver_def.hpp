...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ICutScoreBufferDidChangeReceiver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ICutScoreBufferDidChangeReceiver(ICutScoreBufferDidChangeReceiverconst&) = delete;
