...
public:
  ...
  /// @brief Method Init, addr 0xea7ed0, size 0xc, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0xea7ee4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
