...
public:
  ...
  /// @brief Method Init, addr 0x229fea8, size 0xc, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x229feb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
