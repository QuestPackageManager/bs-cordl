...
public:
  ...
  /// @brief Method Init, addr 0x229a8c4, size 0xc, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x229a8d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
