...
public:
  ...
  /// @brief Method Start, addr 0x23b7fac, size 0x124, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnDestroy, addr 0x23b80d0, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleBeatmapEvent, addr 0x23b80ec, size 0x78, virtual false, abstract: false, final false
  inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  static inline ::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner* New_ctor();

  /// @brief Method .ctor, addr 0x23b8164, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
