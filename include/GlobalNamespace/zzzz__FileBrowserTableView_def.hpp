...
public:
  ...
  /// @brief Method CellForIdx, addr 0x3bfeed8, size 0x178, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t row);

  /// @brief Method CellSize, addr 0x3bfeeb8, size 0x8, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method ClearSelection, addr 0x3bff0a0, size 0x5c, virtual false, abstract: false, final false
  inline void ClearSelection(bool animated, bool scrollToRow0);

  /// @brief Method HandleDidSelectRowEvent, addr 0x3bff050, size 0x50, virtual false, abstract: false, final false
  inline void HandleDidSelectRowEvent(::HMUI::TableView* tableView, int32_t row);

  /// @brief Method Init, addr 0x3bfec80, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberOfCells, addr 0x3bfeec0, size 0x18, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SelectAndScrollRow, addr 0x3bfee6c, size 0x4c, virtual false, abstract: false, final false
  inline void SelectAndScrollRow(int32_t row);

  /// @brief Method SelectAndScrollRowToItemWithPath, addr 0x3bfedd0, size 0x9c, virtual false, abstract: false, final false
  inline bool SelectAndScrollRowToItemWithPath(::StringW folderPath);

  /// @brief Method SetItems, addr 0x3bfed88, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bff0fc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectRow, addr 0x3bfeb20, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectRow, addr 0x3bfebd0, size 0xb0, virtual false, abstract: false, final false
