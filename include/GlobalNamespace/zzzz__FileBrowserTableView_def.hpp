...
public:
  ...
  __declspec(property(get = __cordl_internal_get_didSelectRow,
                      put = __cordl_internal_set_didSelectRow)) ::System::Action_2<::GlobalNamespace::FileBrowserTableView*, ::GlobalNamespace::FileBrowserItem*>* didSelectRow;

  /// @brief Convert operator to "::HMUI::TableView_IDataSource"
  constexpr operator ::HMUI::TableView_IDataSource*() noexcept;

  /// @brief Method CellForIdx, addr 0x3bffa18, size 0x178, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t row);

  /// @brief Method CellSize, addr 0x3bff9f8, size 0x8, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method ClearSelection, addr 0x3bffbe0, size 0x5c, virtual false, abstract: false, final false
  inline void ClearSelection(bool animated, bool scrollToRow0);

  /// @brief Method HandleDidSelectRowEvent, addr 0x3bffb90, size 0x50, virtual false, abstract: false, final false
  inline void HandleDidSelectRowEvent(::HMUI::TableView* tableView, int32_t row);

  /// @brief Method Init, addr 0x3bff7c0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberOfCells, addr 0x3bffa00, size 0x18, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SelectAndScrollRow, addr 0x3bff9ac, size 0x4c, virtual false, abstract: false, final false
  inline void SelectAndScrollRow(int32_t row);

  /// @brief Method SelectAndScrollRowToItemWithPath, addr 0x3bff910, size 0x9c, virtual false, abstract: false, final false
  inline bool SelectAndScrollRowToItemWithPath(::StringW folderPath);

  /// @brief Method SetItems, addr 0x3bff8c8, size 0x48, virtual false, abstract: false, final false
  ...
  constexpr ::System::Action_2<::GlobalNamespace::FileBrowserTableView*, ::GlobalNamespace::FileBrowserItem*>* const& __cordl_internal_get_didSelectRow() const;

  constexpr ::System::Action_2<::GlobalNamespace::FileBrowserTableView*, ::GlobalNamespace::FileBrowserItem*>*& __cordl_internal_get_didSelectRow();
  ...
  constexpr void __cordl_internal_set_didSelectRow(::System::Action_2<::GlobalNamespace::FileBrowserTableView*, ::GlobalNamespace::FileBrowserItem*>* value);

  /// @brief Method .ctor, addr 0x3bffc3c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectRow, addr 0x3bff660, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectRow, addr 0x3bff710, size 0xb0, virtual false, abstract: false, final false
