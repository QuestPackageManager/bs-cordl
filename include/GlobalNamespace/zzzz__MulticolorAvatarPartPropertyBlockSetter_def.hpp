...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter);
MARK_REF_PTR_T(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData);
MARK_REF_PTR_T(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c);
// Type: ::ColorData
...
public:
  ...
  /// @brief Method get_defaultColor addr 0x20d5e70 size 0xc virtual false final false
  inline ::UnityEngine::Color get_defaultColor();

  /// @brief Method get_darkerColorMultiplier addr 0x20d5e7c size 0x8 virtual false final false
  inline float_t get_darkerColorMultiplier();

  /// @brief Method get_whiteBoost addr 0x20d5e84 size 0x8 virtual false final false
  inline float_t get_whiteBoost();

  static inline ::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData* New_ctor();

  /// @brief Method .ctor addr 0x20d5e8c size 0x24 virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData, 0x28>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData, ____defaultColor) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData, ____darkerColorMultiplier) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData, ____whiteBoost) == 0x24, "Offset mismatch!");
...
public:
  ...
  static __declspec(property(get = getStaticF___9, put = setStaticF___9))::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c* __9;

  /// @brief Field <>9__10_0, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF___9__10_0,
                             put = setStaticF___9__10_0))::System::Func_2<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*, ::UnityEngine::Color>* __9__10_0;

  static inline void setStaticF___9(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c* value);

  static inline ::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c* getStaticF___9();

  static inline void setStaticF___9__10_0(::System::Func_2<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*, ::UnityEngine::Color>* value);

  static inline ::System::Func_2<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*, ::UnityEngine::Color>* getStaticF___9__10_0();

  static inline ::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c* New_ctor();

  /// @brief Method .ctor addr 0x20d5f14 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <OnValidate>b__10_0 addr 0x20d5f1c size 0x1c virtual false final false
  inline ::UnityEngine::Color _OnValidate_b__10_0(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData* x);
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c, 0x10>, "Size mismatch!");
...
public:
  // Declarations
  using __c = ::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c;

  using ColorData = ::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData;

  /// @brief Field _colorDataList, offset 0x18, size 0x8
  __declspec(property(get = __get__colorDataList, put = __set__colorDataList))::ArrayW<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*,
                                                                                       ::Array<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*> _colorDataList;
  ...
  constexpr ::ArrayW<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*, ::Array<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*>&
  __get__colorDataList();

  constexpr ::ArrayW<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*, ::Array<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*> const&
  __get__colorDataList() const;

  constexpr void
  __set__colorDataList(::ArrayW<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*, ::Array<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*> value);
  ...
  /// @brief Method OnValidate addr 0x20d5b08 size 0x188 virtual false final false
  inline void OnValidate();

  /// @brief Method SetColors addr 0x20d55d0 size 0x1d0 virtual false final false
  inline void SetColors(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> colors);

  /// @brief Method SetHighlight addr 0x20d58b8 size 0x10 virtual false final false
  inline void SetHighlight(bool highlighted, int32_t uvSegment);

  /// @brief Method UpdateRenderer addr 0x20d5c90 size 0x178 virtual false final false
  inline void UpdateRenderer();

  static inline ::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter* New_ctor();

  /// @brief Method .ctor addr 0x20d5e08 size 0x68 virtual false final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*, ::Array<::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*> ____colorDataList;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, 0x50>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, ____colorDataList) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, ____renderer) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, ____editInPlayMode) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, ____colors) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, ____rimLightColors) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, ____boostColors) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, ____highlighted) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MulticolorAvatarPartPropertyBlockSetter, ____uvSegment) == 0x4c, "Offset mismatch!");
...
NEED_NO_BOX(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter__ColorData*, "", "MulticolorAvatarPartPropertyBlockSetter/ColorData");
NEED_NO_BOX(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__MulticolorAvatarPartPropertyBlockSetter____c*, "", "MulticolorAvatarPartPropertyBlockSetter/<>c");
