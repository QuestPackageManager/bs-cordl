...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59fba48, size 0x1e14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fd85c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GameplayCoreInstaller) == 0xc0, "Size mismatch!");
