...
/// @brief Field _arcAndObstacleHapticManagerEffectPrefab, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__arcAndObstacleHapticManagerEffectPrefab, put=__cordl_internal_set__arcAndObstacleHapticManagerEffectPrefab)) ::UnityW<::GlobalNamespace::ArcAndObstacleHapticEffectManager>  _arcAndObstacleHapticManagerEffectPrefab;

/// @brief Field _audioManager, offset 0x70, size 0x8 
...
/// @brief Field _badNoteCutEffectSpawnerPrefab, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__badNoteCutEffectSpawnerPrefab, put=__cordl_internal_set__badNoteCutEffectSpawnerPrefab)) ::UnityW<::GlobalNamespace::BadNoteCutEffectSpawner>  _badNoteCutEffectSpawnerPrefab;
...
/// @brief Field _commandLineArguments, offset 0x88, size 0x18 
 __declspec(property(get=__cordl_internal_get__commandLineArguments, put=__cordl_internal_set__commandLineArguments)) ::BGLib::DotnetExtension::CommandLine::CommandLineParserResult  _commandLineArguments;

/// @brief Field _effectPoolsManualInstaller, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__effectPoolsManualInstaller, put=__cordl_internal_set__effectPoolsManualInstaller)) ::UnityW<::GlobalNamespace::EffectPoolsManualInstaller>  _effectPoolsManualInstaller;

/// @brief Field _featureFlagService, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__featureFlagService, put=__cordl_internal_set__featureFlagService)) ::BeatSaber::FeatureFlags::IFeatureFlagService*  _featureFlagService;

/// @brief Field _gameplayAdditionalInformationSetupData, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameplayAdditionalInformationSetupData, put=__cordl_internal_set__gameplayAdditionalInformationSetupData)) ::GlobalNamespace::GameplayAdditionalInformationSetupData*  _gameplayAdditionalInformationSetupData;

/// @brief Field _missedNoteEffectSpawnerPrefab, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__missedNoteEffectSpawnerPrefab, put=__cordl_internal_set__missedNoteEffectSpawnerPrefab)) ::UnityW<::GlobalNamespace::MissedNoteEffectSpawner>  _missedNoteEffectSpawnerPrefab;

/// @brief Field _noteCutScoreSpawnerPrefab, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteCutScoreSpawnerPrefab, put=__cordl_internal_set__noteCutScoreSpawnerPrefab)) ::UnityW<::GlobalNamespace::NoteCutScoreSpawner>  _noteCutScoreSpawnerPrefab;
...
/// @brief Field _performanceToolConfig, offset 0xb0, size 0x3 
 __declspec(property(get=__cordl_internal_get__performanceToolConfig, put=__cordl_internal_set__performanceToolConfig)) ::System::Nullable_1<::GlobalNamespace::PerformanceToolLauncher_OverrideConfig>  _performanceToolConfig;

/// @brief Field _playerHeightDetectorPrefab, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__playerHeightDetectorPrefab, put=__cordl_internal_set__playerHeightDetectorPrefab)) ::UnityW<::GlobalNamespace::PlayerHeightDetector>  _playerHeightDetectorPrefab;
...
/// @brief Field _songProfilingControllerPrefab, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__songProfilingControllerPrefab, put=__cordl_internal_set__songProfilingControllerPrefab)) ::UnityW<::GlobalNamespace::SongProfilingController>  _songProfilingControllerPrefab;
...
constexpr ::BeatSaber::FeatureFlags::IFeatureFlagService* const& __cordl_internal_get__featureFlagService() const;

constexpr ::BeatSaber::FeatureFlags::IFeatureFlagService*& __cordl_internal_get__featureFlagService() ;
...
constexpr ::GlobalNamespace::GameplayAdditionalInformationSetupData*& __cordl_internal_get__gameplayAdditionalInformationSetupData() ;
...
constexpr void __cordl_internal_set__featureFlagService(::BeatSaber::FeatureFlags::IFeatureFlagService*  value) ;
...
static_assert(offsetof(::GlobalNamespace::GameplayCoreInstaller, ____audioManager) == 0x70, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::GameplayCoreInstaller, ____settingsManager) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreInstaller, ____gameplayAdditionalInformationSetupData) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreInstaller, ____performanceToolConfig) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameplayCoreInstaller, ____featureFlagService) == 0xb8, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::GameplayCoreInstaller, 0xc0>, "Size mismatch!");
