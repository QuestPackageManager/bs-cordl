...
public:
  ...
  /// @brief Method InstallBindings, addr 0x584dc8c, size 0x1c08, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584f894, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
