...
public:
  ...
  /// @brief Method .ctor, addr 0x58582fc, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Cleanup, addr 0x5857a08, size 0xa0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method GetColor, addr 0x5858160, size 0x34, virtual true, abstract: false, final false
  inline ::UnityEngine::Color GetColor(::GlobalNamespace::EnvironmentColorType colorType, bool colorBoost, float_t brightness);

  /// @brief Method HandleColorChangeBeatmapEvent, addr 0x5857aa8, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColor, addr 0x5857ea8, size 0x158, virtual false, abstract: false, final false
  inline void SetColor(float_t t);

  /// @brief Method SetData, addr 0x5858194, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method UseBoostColors, addr 0x5858000, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x585764c, size 0x3bc, virtual false, abstract: false, final false
