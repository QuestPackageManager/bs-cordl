...
/// @brief Method .ctor, addr 0x57e6404, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x57e5b10, size 0xa0, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method GetColor, addr 0x57e6268, size 0x34, virtual true, abstract: false, final false
inline ::UnityEngine::Color GetColor(::GlobalNamespace::EnvironmentColorType  colorType, bool  colorBoost, float_t  brightness) ;

/// @brief Method HandleColorChangeBeatmapEvent, addr 0x57e5bb0, size 0x400, virtual false, abstract: false, final false
inline void HandleColorChangeBeatmapEvent(::GlobalNamespace::LightColorBeatmapEventData*  currentEventData) ;

static inline ::GlobalNamespace::LightColorGroupEffect* New_ctor(::GlobalNamespace::LightColorGroupEffect_InitData*  initData, ::GlobalNamespace::LightWithIdManager*  lightManager, ::Tweening::SongTimeTweeningManager*  tweeningManager, ::GlobalNamespace::ColorManager*  colorManager, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController, ::GlobalNamespace::IBpmController*  bpmController) ;

/// @brief Method SetColor, addr 0x57e5fb0, size 0x158, virtual false, abstract: false, final false
inline void SetColor(float_t  t) ;

/// @brief Method SetData, addr 0x57e629c, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method UseBoostColors, addr 0x57e6108, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57e5754, size 0x3bc, virtual false, abstract: false, final false
