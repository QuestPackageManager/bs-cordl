...
public:
  ...
  /// @brief Method Init, addr 0x26d6088, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x26d6354, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x26d64bc, size 0x84, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26d6438, size 0x84, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x26d6360, size 0xd8, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetTrailWidth, addr 0x26d6540, size 0x8, virtual false, abstract: false, final false
  inline void SetTrailWidth(float_t width);

  /// @brief Method UpdateIndices, addr 0x26d61fc, size 0x158, virtual false, abstract: false, final false
  inline void UpdateIndices();

  /// @brief Method UpdateMesh, addr 0x26d5b70, size 0x134, virtual false, abstract: false, final false
  inline void UpdateMesh(::GlobalNamespace::TrailElementCollection* trailElementCollection, ::UnityEngine::Color color);

  /// @brief Method UpdateVertices, addr 0x26d6548, size 0x478, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d69c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
