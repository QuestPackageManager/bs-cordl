...
public:
  ...
  /// @brief Method Init, addr 0x242db08, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x242ddd4, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x242df3c, size 0x84, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x242deb8, size 0x84, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x242dde0, size 0xd8, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetTrailWidth, addr 0x242dfc0, size 0x8, virtual false, abstract: false, final false
  inline void SetTrailWidth(float_t width);

  /// @brief Method UpdateIndices, addr 0x242dc7c, size 0x158, virtual false, abstract: false, final false
  inline void UpdateIndices();

  /// @brief Method UpdateMesh, addr 0x242d5f0, size 0x134, virtual false, abstract: false, final false
  inline void UpdateMesh(::GlobalNamespace::TrailElementCollection* trailElementCollection, ::UnityEngine::Color color);

  /// @brief Method UpdateVertices, addr 0x242dfc8, size 0x470, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x242e6cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
