...
class CORDL_TYPE PS4PlatformAdditionalContentModel : public ::GlobalNamespace::SonyPlatformAdditionalContentModel_1<::UnityW<::GlobalNamespace::PS4LevelProductsModelSO>> {
public:
  // Declarations
