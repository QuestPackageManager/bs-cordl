...
static inline ::GlobalNamespace::MultiplayerConnectedPlayerBeatmapObjectManager_InitData* New_ctor(bool  disappearingArrows, bool  ghostNotes, float_t  notesUniformScale, float_t  noteJumpMovementSpeed, float_t  bpm) ;
...
/// @brief Method .ctor, addr 0x5883580, size 0x14, virtual false, abstract: false, final false
...
/// @brief Field _beatmapObjectEventManager, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapObjectEventManager, put=__cordl_internal_set__beatmapObjectEventManager)) ::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*  _beatmapObjectEventManager;

/// @brief Field _bombNotePoolContainer, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__bombNotePoolContainer, put=__cordl_internal_set__bombNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerBombNoteController>>*  _bombNotePoolContainer;

/// @brief Field _burstSliderGameNotePoolContainer, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderGameNotePoolContainer, put=__cordl_internal_set__burstSliderGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>>*  _burstSliderGameNotePoolContainer;

/// @brief Field _burstSliderHeadGameNotePoolContainer, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderHeadGameNotePoolContainer, put=__cordl_internal_set__burstSliderHeadGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>>*  _burstSliderHeadGameNotePoolContainer;

/// @brief Field _defaultBeatmapObjectSpawnMovementData, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__defaultBeatmapObjectSpawnMovementData, put=__cordl_internal_set__defaultBeatmapObjectSpawnMovementData)) ::GlobalNamespace::BeatmapObjectSpawnMovementData*  _defaultBeatmapObjectSpawnMovementData;
...
/// @brief Field _gameNotePoolContainer, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameNotePoolContainer, put=__cordl_internal_set__gameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>>*  _gameNotePoolContainer;
...
/// @brief Field _obstaclePoolContainer, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__obstaclePoolContainer, put=__cordl_internal_set__obstaclePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_2<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController>,::UnityW<::GlobalNamespace::ObstacleController>>*  _obstaclePoolContainer;
...
/// @brief Method AreNotesSame, addr 0x5883498, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method DespawnInternal, addr 0x5882aa4, size 0x150, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::NoteController*  noteController) ;

/// @brief Method DespawnInternal, addr 0x5882bf4, size 0xbc, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::ObstacleController*  obstacleController) ;

/// @brief Method DespawnInternal, addr 0x5882cb0, size 0x4, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::SliderController*  sliderNoteController) ;

/// @brief Method Dispose, addr 0x58822fc, size 0x32c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandleMultiplayerBeatmapObjectEventManagerBeatmapObjectWasCut, addr 0x5883154, size 0x344, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerBeatmapObjectEventManagerBeatmapObjectWasSpawned, addr 0x5882cb4, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerBeatmapObjectEventManagerObstacleWasSpawned, addr 0x5882e30, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerBeatmapObjectEventManagerSliderWasSpawned, addr 0x5882f60, size 0x1f4, virtual false, abstract: false, final false
...
static inline ::GlobalNamespace::MultiplayerConnectedPlayerBeatmapObjectManager* New_ctor(::GlobalNamespace::MultiplayerConnectedPlayerBeatmapObjectManager_InitData*  initData, ::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*  beatmapObjectEventManager, ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController_Pool*  gameNotePool, ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController_Pool*  burstSliderHeadGameNotePool, ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController_Pool*  burstSliderGameNotePool, ::GlobalNamespace::MultiplayerConnectedPlayerBombNoteController_Pool*  bombNotePool, ::GlobalNamespace::MultiplayerConnectedPlayerObstacleController_Pool*  obstaclePool, ::GlobalNamespace::VariableMovementDataProvider*  variableMovementDataProvider) ;

/// @brief Method ProcessNoteData, addr 0x58826d8, size 0x300, virtual true, abstract: false, final false
...
/// @brief Method ProcessObstacleData, addr 0x5882628, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method ProcessSliderData, addr 0x5882aa0, size 0x4, virtual true, abstract: false, final false
...
constexpr ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>>* const& __cordl_internal_get__burstSliderHeadGameNotePoolContainer() const;
...
constexpr ::GlobalNamespace::MemoryPoolContainer_2<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController>,::UnityW<::GlobalNamespace::ObstacleController>>* const& __cordl_internal_get__obstaclePoolContainer() const;

constexpr ::GlobalNamespace::MemoryPoolContainer_2<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController>,::UnityW<::GlobalNamespace::ObstacleController>>*& __cordl_internal_get__obstaclePoolContainer() ;
...
constexpr void __cordl_internal_set__obstaclePoolContainer(::GlobalNamespace::MemoryPoolContainer_2<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController>,::UnityW<::GlobalNamespace::ObstacleController>>*  value) ;

/// @brief Method .ctor, addr 0x5881d74, size 0x588, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::MultiplayerConnectedPlayerBeatmapObjectManager_InitData*  initData, ::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*  beatmapObjectEventManager, ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController_Pool*  gameNotePool, ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController_Pool*  burstSliderHeadGameNotePool, ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController_Pool*  burstSliderGameNotePool, ::GlobalNamespace::MultiplayerConnectedPlayerBombNoteController_Pool*  bombNotePool, ::GlobalNamespace::MultiplayerConnectedPlayerObstacleController_Pool*  obstaclePool, ::GlobalNamespace::VariableMovementDataProvider*  variableMovementDataProvider) ;

/// @brief Method get_activeObstacleControllers, addr 0x5881d20, size 0x54, virtual true, abstract: false, final false
