...
public:
  ...
  /// @brief Method Init, addr 0x584cd38, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x584cec4, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDeterminismSet, addr 0x584cf94, size 0x20, virtual false, abstract: false, final false
  inline void OnDeterminismSet(bool isDeterministic);

  /// @brief Method OnValidate, addr 0x584cfb4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584d048, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
