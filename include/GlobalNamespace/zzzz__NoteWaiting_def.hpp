...
public:
  ...
  /// @brief Method Init, addr 0x3aee1e0, size 0x8, virtual false, abstract: false, final false
  inline void Init(float_t beatTime);

  /// @brief Method ManualUpdate, addr 0x3aee1a0, size 0x2c, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::GlobalNamespace::NoteWaiting* New_ctor();

  /// @brief Method ShouldWait, addr 0x3aedff4, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3aee1e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localPosition, addr 0x3aee1d4, size 0xc, virtual false, abstract: false, final false
