...
public:
  ...
  /// @brief Method Init, addr 0x3af00d4, size 0x8, virtual false, abstract: false, final false
  inline void Init(float_t beatTime);

  /// @brief Method ManualUpdate, addr 0x3af0094, size 0x2c, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::GlobalNamespace::NoteWaiting* New_ctor();

  /// @brief Method ShouldWait, addr 0x3aefee8, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af00dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localPosition, addr 0x3af00c8, size 0xc, virtual false, abstract: false, final false
