...
public:
  ...
  /// @brief Method Render, addr 0x4086a20, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4086a58, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
