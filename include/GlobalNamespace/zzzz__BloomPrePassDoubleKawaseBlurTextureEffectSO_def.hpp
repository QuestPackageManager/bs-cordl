...
public:
  ...
  /// @brief Method Render, addr 0x2957770, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29577a8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
