...
public:
  ...
  /// @brief Method Render, addr 0x408b2cc, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408b304, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
