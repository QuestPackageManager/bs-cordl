...
public:
  ...
  /// @brief Method Render, addr 0x5e0d1c0, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0d1f4, size 0x40, virtual false, abstract: false, final false
  inline void _ctor();
