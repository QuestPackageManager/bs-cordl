...
public:
  ...
  /// @brief Method MoveNext, addr 0x25e2ab4, size 0x4a0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x25e2f54, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x25e2f5c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x25e2f9c, size 0x1008, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x25e2ab0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25e279c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandlePlayerDidFinish, addr 0x25e27c4, size 0x20, virtual false, abstract: false, final false
  inline void HandlePlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method HandlePlayerNetworkDidFailed, addr 0x25e27e4, size 0x34, virtual false, abstract: false, final false
  inline void HandlePlayerNetworkDidFailed(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method HandleRpcLevelFinished, addr 0x25e2818, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25e24c0, size 0x268, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x25e2260, size 0x260, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartLevelFinished, addr 0x25e2728, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25e2a34, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allResultsCollectedEvent, addr 0x25e20e8, size 0xb0, virtual false, abstract: false, final false
  inline void add_allResultsCollectedEvent(::System::Action_2<::GlobalNamespace::MultiplayerLevelCompletionResults*,
                                                              ::System::Collections::Generic::Dictionary_2<::StringW, ::GlobalNamespace::MultiplayerLevelCompletionResults*>*>* value);

  /// @brief Method get_gameResultsReady, addr 0x25e2248, size 0x8, virtual false, abstract: false, final false
  inline bool get_gameResultsReady();

  /// @brief Method get_localPlayerResults, addr 0x25e2258, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerLevelCompletionResults* get_localPlayerResults();

  /// @brief Method get_otherPlayersCompletionResults, addr 0x25e2250, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_allResultsCollectedEvent, addr 0x25e2198, size 0xb0, virtual false, abstract: false, final false
