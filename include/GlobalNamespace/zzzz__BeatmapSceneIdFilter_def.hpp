...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(BeatmapSceneIdFilter)
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapSceneIdFilter, "", "BeatmapSceneIdFilter");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BeatmapSceneIdFilter) == 0x4, "Size mismatch!");
