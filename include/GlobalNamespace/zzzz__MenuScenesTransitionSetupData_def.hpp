...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MenuScenesTransitionSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MenuScenesTransitionSetupData(MenuScenesTransitionSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MenuScenesTransitionSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MenuScenesTransitionSetupData(MenuScenesTransitionSetupDataconst&) = delete;
