...
public:
  ...
  /// @brief Method OnValidate, addr 0x572d114, size 0x20, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Start, addr 0x572d0a8, size 0x20, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x572d0c8, size 0x4c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x572d134, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
