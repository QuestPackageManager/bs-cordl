...
public:
  ...
  /// @brief Method OnValidate, addr 0x5875570, size 0x20, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Start, addr 0x5875504, size 0x20, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5875524, size 0x4c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5875590, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
