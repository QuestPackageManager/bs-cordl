...
public:
  ...
  /// @brief Method Awake, addr 0x5866dd0, size 0x184, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::TransformSpectrogram* New_ctor();

  /// @brief Method Update, addr 0x5866f54, size 0x270, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58671c4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
