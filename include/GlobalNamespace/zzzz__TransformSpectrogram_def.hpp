...
public:
  ...
  /// @brief Method Awake, addr 0x25d1578, size 0x188, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::TransformSpectrogram* New_ctor();

  /// @brief Method Update, addr 0x25d1700, size 0x268, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x25d1968, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
