...
public:
  ...
  /// @brief Method Awake, addr 0x3bacc1c, size 0x188, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::TransformSpectrogram* New_ctor();

  /// @brief Method Update, addr 0x3bacda4, size 0x268, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3bad00c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
