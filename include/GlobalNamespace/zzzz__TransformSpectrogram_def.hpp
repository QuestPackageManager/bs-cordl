...
public:
  ...
  /// @brief Method Awake, addr 0x3ba1184, size 0x188, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::TransformSpectrogram* New_ctor();

  /// @brief Method Update, addr 0x3ba130c, size 0x268, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ba1574, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
