...
public:
  ...
  /// @brief Method Awake, addr 0x57f45a8, size 0x184, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::TransformSpectrogram* New_ctor();

  /// @brief Method Update, addr 0x57f472c, size 0x270, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57f499c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
