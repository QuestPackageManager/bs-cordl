...
public:
  ...
  /// @brief Method Start, addr 0x5cefbc0, size 0xa0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TestPowerStateMode, addr 0x5cefd14, size 0xb0, virtual false, abstract: false, final false
  inline void TestPowerStateMode();

  /// @brief Method Update, addr 0x5cefc60, size 0xb4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5cefdc4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
