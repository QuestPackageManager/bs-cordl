...
public:
  ...
  /// @brief Method Start, addr 0x5d566a0, size 0xa0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TestPowerStateMode, addr 0x5d567f4, size 0xb0, virtual false, abstract: false, final false
  inline void TestPowerStateMode();

  /// @brief Method Update, addr 0x5d56740, size 0xb4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5d568a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
