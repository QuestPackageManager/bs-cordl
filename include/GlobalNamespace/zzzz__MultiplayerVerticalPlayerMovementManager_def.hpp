...
public:
  ...
  /// @brief Method HandleStateChanged, addr 0x26161e0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x26161f0, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x2616138, size 0xa8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x26162c0, size 0x7e0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2616aa0, size 0x10e0, virtual false, abstract: false, final false
  inline void _ctor();
