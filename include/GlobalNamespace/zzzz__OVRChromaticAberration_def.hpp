...
public:
  ...
  /// @brief Method Start, addr 0x5d435f0, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5d436a0, size 0x10c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5d437ac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
