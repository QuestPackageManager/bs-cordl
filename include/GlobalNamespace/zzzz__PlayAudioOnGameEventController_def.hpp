...
/// @brief Method Deinit, addr 0x570e9a4, size 0x8c, virtual false, abstract: false, final false
inline void Deinit() ;

/// @brief Method HandleGameEvent, addr 0x570ea34, size 0xc8, virtual false, abstract: false, final false
inline void HandleGameEvent() ;

/// @brief Method Init, addr 0x570e854, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x570eafc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _eventAudioBindings, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__eventAudioBindings, put=__cordl_internal_set__eventAudioBindings)) ::ArrayW<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*,::Array<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*>*>  _eventAudioBindings;

/// @brief Method Awake, addr 0x570e7f4, size 0x60, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::PlayAudioOnGameEventController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x570e954, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*,::Array<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*>*> const& __cordl_internal_get__eventAudioBindings() const;

constexpr ::ArrayW<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*,::Array<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*>*>& __cordl_internal_get__eventAudioBindings() ;

constexpr void __cordl_internal_set__audioClipQueue(::UnityW<::GlobalNamespace::AudioClipQueue>  value) ;

constexpr void __cordl_internal_set__eventAudioBindings(::ArrayW<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*,::Array<::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding*>*>  value) ;

/// @brief Method .ctor, addr 0x570ea30, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
