...
public:
  ...
  /// @brief Method .ctor, addr 0x59ef34c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoteCutter_CuttableBySaberSortParams", modifiers: "&&", def_value: None, comment: None }]
...
public:
  ...
  /// @brief Method Compare, addr 0x59ef350, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59ef348, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoteCutter_CuttableBySaberSortParamsComparer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  ...
  /// @brief Method Cut, addr 0x59eeb9c, size 0x584, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59ef21c, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoteCutter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
