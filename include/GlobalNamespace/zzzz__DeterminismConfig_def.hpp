...
public:
  ...
  /// @brief Method SetDeterminism, addr 0x3324168, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3324160, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool initialDeterminism, ::GlobalNamespace::TimeHelper* timeHelper);

  /// @brief Method add_determinismSetEvent, addr 0x3323fe0, size 0xc0, virtual false, abstract: false, final false
  inline void add_determinismSetEvent(::System::Action_1<bool>* value);

  /// @brief Method get_isDeterministic, addr 0x3323fd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isDeterministic();

  /// @brief Method remove_determinismSetEvent, addr 0x33240a0, size 0xc0, virtual false, abstract: false, final false
  inline void remove_determinismSetEvent(::System::Action_1<bool>* value);

  /// @brief Method set_isDeterministic, addr 0x3323fd8, size 0x8, virtual false, abstract: false, final false
