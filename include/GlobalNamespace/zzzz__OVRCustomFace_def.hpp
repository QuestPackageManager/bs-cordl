...
public:
  ...
  /// @brief Method GetCustomBlendShapeNameAndExpressionPairs, addr 0x5df5ec8, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method GetFaceExpression, addr 0x5df5e98, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x5df5e04, size 0x4, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5df5fcc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AllowDuplicateMapping, addr 0x5df5df4, size 0x8, virtual false, abstract: false, final false
  inline bool get_AllowDuplicateMapping();

  /// @brief Method get_Mappings, addr 0x5df5dd4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::OVRFaceExpressions_FaceExpression> get_Mappings();

  /// @brief Method get_RetargetingValue, addr 0x5df5de4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRCustomFace_RetargetingType get_RetargetingValue();

  /// @brief Method set_AllowDuplicateMapping, addr 0x5df5dfc, size 0x8, virtual false, abstract: false, final false
  inline void set_AllowDuplicateMapping(bool value);

  /// @brief Method set_Mappings, addr 0x5df5ddc, size 0x8, virtual false, abstract: false, final false
  inline void set_Mappings(::ArrayW<::GlobalNamespace::OVRFaceExpressions_FaceExpression> value);

  /// @brief Method set_RetargetingValue, addr 0x5df5dec, size 0x8, virtual false, abstract: false, final false
