...
public:
  ...
  /// @brief Method ApplyValue, addr 0x2663000, size 0x58, virtual true, abstract: false, final false
  inline void ApplyValue(bool value);

  /// @brief Method GetInitValue, addr 0x2662fb8, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2663058, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
