...
// Write type traits
MARK_REF_T(::GlobalNamespace::SceneIdAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SceneIdAttribute*, "", "SceneIdAttribute");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SceneIdAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SceneIdAttribute(SceneIdAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SceneIdAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SceneIdAttribute(SceneIdAttributeconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::SceneIdAttribute) == 0x20, "Size mismatch!");
