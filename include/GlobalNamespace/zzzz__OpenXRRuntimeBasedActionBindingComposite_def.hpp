...
public:
  ...
  /// @brief Method EvaluateMagnitude, addr 0x39d13f4, size 0xc, virtual true, abstract: false, final false
  inline float_t EvaluateMagnitude(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method Init, addr 0x39d1468, size 0x4, virtual false, abstract: false, final false
  static inline void Init();

  static inline ::GlobalNamespace::OpenXRRuntimeBasedActionBindingComposite* New_ctor();

  /// @brief Method ReadValue, addr 0x39d13ec, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39d146c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
