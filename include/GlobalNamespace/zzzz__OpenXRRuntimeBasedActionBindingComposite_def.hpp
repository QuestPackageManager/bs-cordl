...
public:
  ...
  /// @brief Method EvaluateMagnitude, addr 0x5716bec, size 0xc, virtual true, abstract: false, final false
  inline float_t EvaluateMagnitude(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method Init, addr 0x5716c68, size 0x4, virtual false, abstract: false, final false
  static inline void Init();

  static inline ::GlobalNamespace::OpenXRRuntimeBasedActionBindingComposite* New_ctor();

  /// @brief Method ReadOculusRuntimeValue, addr 0x5716b34, size 0x5c, virtual false, abstract: false, final false
  inline float_t ReadOculusRuntimeValue(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method ReadOtherRuntimeValue, addr 0x5716b90, size 0x5c, virtual false, abstract: false, final false
  inline float_t ReadOtherRuntimeValue(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method ReadValue, addr 0x5716ab0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5716c6c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
