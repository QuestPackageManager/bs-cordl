...
/// @brief Method EvaluateMagnitude, addr 0x56a8d00, size 0xc, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method Init, addr 0x56a8d7c, size 0x4, virtual false, abstract: false, final false
static inline void Init() ;

static inline ::GlobalNamespace::OpenXRRuntimeBasedActionBindingComposite* New_ctor() ;

/// @brief Method ReadOculusRuntimeValue, addr 0x56a8c48, size 0x5c, virtual false, abstract: false, final false
inline float_t ReadOculusRuntimeValue(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method ReadOtherRuntimeValue, addr 0x56a8ca4, size 0x5c, virtual false, abstract: false, final false
inline float_t ReadOtherRuntimeValue(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method ReadValue, addr 0x56a8bc4, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56a8d80, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
