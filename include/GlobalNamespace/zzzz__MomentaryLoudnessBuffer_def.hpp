...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MomentaryLoudnessBuffer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MomentaryLoudnessBuffer(MomentaryLoudnessBuffer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MomentaryLoudnessBuffer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MomentaryLoudnessBuffer(MomentaryLoudnessBufferconst&) = delete;
