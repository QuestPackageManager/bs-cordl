...
static_assert(offsetof(::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException, ____environmentInfo) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException, ____exceptionNotes) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException, ____sceneHierarchies) == 0x20, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::GameObjectTestExceptionsSO, ___tubeBloomPrePassLightIgnores) == 0x18, "Offset mismatch!");
