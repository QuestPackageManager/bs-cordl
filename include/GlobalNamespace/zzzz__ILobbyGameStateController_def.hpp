...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ILobbyGameStateController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ILobbyGameStateController(ILobbyGameStateControllerconst&) = delete;
