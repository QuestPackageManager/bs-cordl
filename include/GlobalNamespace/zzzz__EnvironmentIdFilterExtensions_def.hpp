...
public:
// Declarations
/// @brief Method ShouldExcludeMultiplayer, addr 0x3630230, size 0x8, virtual false, abstract: false, final false
static inline bool ShouldExcludeMultiplayer(::GlobalNamespace::EnvironmentIdFilter  filter) ;

/// @brief Method ShouldExcludeTutorial, addr 0x3630228, size 0x8, virtual false, abstract: false, final false
