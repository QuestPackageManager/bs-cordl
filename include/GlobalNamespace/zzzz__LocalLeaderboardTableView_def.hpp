...
public:
  ...
  /// @brief Method SetScores, addr 0x23e40f0, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e437c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
