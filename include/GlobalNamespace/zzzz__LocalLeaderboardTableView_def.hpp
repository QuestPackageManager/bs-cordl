...
public:
  ...
  /// @brief Method SetScores, addr 0x3b0affc, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b0b2a8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
