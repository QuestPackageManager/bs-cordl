...
public:
  ...
  /// @brief Method SetScores, addr 0x5a1ed2c, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1efd4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
