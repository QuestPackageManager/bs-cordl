...
public:
  ...
  /// @brief Method SetScores, addr 0x596e9fc, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x596eca4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocalLeaderboardTableView", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocalLeaderboardTableView(LocalLeaderboardTableView&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocalLeaderboardTableView", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocalLeaderboardTableView(LocalLeaderboardTableViewconst&) = delete;
