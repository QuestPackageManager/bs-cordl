...
/// @brief Method .ctor, addr 0x3635a8c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_icon, addr 0x36377e4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_icon() ;

/// @brief Method get_subtitleLocalizationKey, addr 0x36377f4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_subtitleLocalizationKey() ;

/// @brief Method get_titleLocalizationKey, addr 0x36377ec, size 0x8, virtual false, abstract: false, final false
