...
public:
  ...
  /// @brief Method get_icon, addr 0x1298148, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_icon();

  /// @brief Method get_titleLocalizationKey, addr 0x1298150, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_titleLocalizationKey();

  /// @brief Method get_subtitleLocalizationKey, addr 0x1298158, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129643c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
