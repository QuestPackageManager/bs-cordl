...
public:
  ...
  /// @brief Method get_offsetSyncTime, addr 0x23b9218, size 0xb8, virtual false, abstract: false, final false
  inline int64_t get_offsetSyncTime();

  /// @brief Method get_lastScoreTime, addr 0x23b9398, size 0x50, virtual false, abstract: false, final false
  inline int64_t get_lastScoreTime();

  /// @brief Method get_score, addr 0x23aa584, size 0x30, virtual false, abstract: false, final false
  inline int32_t get_score();

  /// @brief Method get_isConnected, addr 0x23b910c, size 0xb8, virtual false, abstract: false, final false
  inline bool get_isConnected();

  /// @brief Method get_isActiveOrFinished, addr 0x23ae944, size 0x28, virtual false, abstract: false, final false
  inline bool get_isActiveOrFinished();

  /// @brief Method get_isFailed, addr 0x23ae96c, size 0x28, virtual false, abstract: false, final false
  inline bool get_isFailed();

  /// @brief Method get_wasActiveAtLevelStart, addr 0x23b91c4, size 0x28, virtual false, abstract: false, final false
  inline bool get_wasActiveAtLevelStart();

  /// @brief Method get_isMe, addr 0x23b2898, size 0xb4, virtual false, abstract: false, final false
  inline bool get_isMe();

  /// @brief Method get_userId, addr 0x23ae5c0, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x23b93e8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b91ec, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTo, addr 0x23b94a0, size 0x88, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x23b958c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <Update>b__16_0, addr 0x23b9594, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x23b92d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <GetPositionOfPlayer>b__0, addr 0x23b95b8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_scoresAvailable, addr 0x23b73f4, size 0x20, virtual false, abstract: false, final false
  inline bool get_scoresAvailable();

  /// @brief Method get_firstPlayer, addr 0x23b8a24, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer* get_firstPlayer();

  /// @brief Method set_firstPlayer, addr 0x23b8a2c, size 0x8, virtual false, abstract: false, final false
  inline void set_firstPlayer(::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer* value);

  /// @brief Method add_firstPlayerDidChangeEvent, addr 0x23ae894, size 0xb0, virtual false, abstract: false, final false
  inline void add_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>* value);

  /// @brief Method remove_firstPlayerDidChangeEvent, addr 0x23ae47c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_rankedPlayers, addr 0x23b8a34, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x23b8a3c, size 0x6d0, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method TryGetScore, addr 0x23aa51c, size 0x68, virtual false, abstract: false, final false
  inline bool TryGetScore(::StringW userId, ByRef<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*> data);

  /// @brief Method GetPositionOfPlayer, addr 0x23b77d8, size 0xe4, virtual false, abstract: false, final false
  inline int32_t GetPositionOfPlayer(::StringW userId);

  static inline ::GlobalNamespace::MultiplayerScoreProvider* New_ctor();

  /// @brief Method .ctor, addr 0x23b92d8, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
