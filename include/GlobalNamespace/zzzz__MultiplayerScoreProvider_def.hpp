...
public:
  ...
  __declspec(property(get = get_lastScoreTime)) float_t lastScoreTime;
  ...
  /// @brief Method get_offsetSyncTime addr 0x2115ea8 size 0xb8 virtual false final false
  inline float_t get_offsetSyncTime();

  /// @brief Method get_lastScoreTime addr 0x2116174 size 0x50 virtual false final false
  inline float_t get_lastScoreTime();

  /// @brief Method get_score addr 0x2115560 size 0x30 virtual false final false
  inline int32_t get_score();

  /// @brief Method get_isConnected addr 0x2115d9c size 0xb8 virtual false final false
  inline bool get_isConnected();

  /// @brief Method get_isActiveOrFinished addr 0x21161c4 size 0x28 virtual false final false
  inline bool get_isActiveOrFinished();

  /// @brief Method get_isFailed addr 0x21161ec size 0x28 virtual false final false
  inline bool get_isFailed();

  /// @brief Method get_wasActiveAtLevelStart addr 0x2115e54 size 0x28 virtual false final false
  inline bool get_wasActiveAtLevelStart();

  /// @brief Method get_isMe addr 0x2116214 size 0xb4 virtual false final false
  inline bool get_isMe();

  /// @brief Method get_userId addr 0x21162c8 size 0xb8 virtual false final false
  inline ::StringW get_userId();

  /// @brief Method get_userName addr 0x2116380 size 0xb8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2115e7c size 0x2c virtual false final false
  ...
  /// @brief Method CompareTo addr 0x2116438 size 0x88 virtual true final true
...
public:
  ...
  /// @brief Method .ctor addr 0x2116524 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Update>b__16_0 addr 0x211652c size 0x24 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x21160ac size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetPositionOfPlayer>b__0 addr 0x2116550 size 0x28 virtual false final false
...
public:
  ...
  /// @brief Field _sharedOffsetSyncTime, offset 0x30, size 0x4
  __declspec(property(get = __get__sharedOffsetSyncTime, put = __set__sharedOffsetSyncTime)) float_t _sharedOffsetSyncTime;
  ...
  constexpr float_t& __get__sharedOffsetSyncTime();

  constexpr float_t const& __get__sharedOffsetSyncTime() const;
  ...
  /// @brief Method get_scoresAvailable addr 0x2115540 size 0x20 virtual false final false
  inline bool get_scoresAvailable();

  /// @brief Method get_firstPlayer addr 0x2115590 size 0x8 virtual false final false
  inline ::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer* get_firstPlayer();

  /// @brief Method set_firstPlayer addr 0x2115598 size 0x8 virtual false final false
  inline void set_firstPlayer(::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer* value);

  /// @brief Method add_firstPlayerDidChangeEvent addr 0x21155a0 size 0xb0 virtual false final false
  inline void add_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>* value);

  /// @brief Method remove_firstPlayerDidChangeEvent addr 0x2115650 size 0xb0 virtual false final false
  ...
  /// @brief Method get_rankedPlayers addr 0x2115700 size 0x8 virtual false final false
  ...
  /// @brief Method Update addr 0x2115708 size 0x694 virtual false final false
  inline void Update();

  /// @brief Method TryGetScore addr 0x2115f60 size 0x68 virtual false final false
  inline bool TryGetScore(::StringW userId, ByRef<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*> data);

  /// @brief Method GetPositionOfPlayer addr 0x2115fc8 size 0xe4 virtual false final false
  inline int32_t GetPositionOfPlayer(::StringW userId);

  static inline ::GlobalNamespace::MultiplayerScoreProvider* New_ctor();

  /// @brief Method .ctor addr 0x21160b4 size 0xc0 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _sharedOffsetSyncTime, offset: 0x30, size: 0x4, def value: None
  float_t ____sharedOffsetSyncTime;
