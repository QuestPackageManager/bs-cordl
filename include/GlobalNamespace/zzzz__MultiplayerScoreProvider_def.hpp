...
public:
  ...
  /// @brief Method CompareTo, addr 0x3bdd208, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3bdcf50, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isActiveOrFinished, addr 0x3bd2f9c, size 0x28, virtual false, abstract: false, final false
  inline bool get_isActiveOrFinished();

  /// @brief Method get_isConnected, addr 0x3bdce70, size 0xb8, virtual false, abstract: false, final false
  inline bool get_isConnected();

  /// @brief Method get_isFailed, addr 0x3bd2fc4, size 0x28, virtual false, abstract: false, final false
  inline bool get_isFailed();

  /// @brief Method get_isMe, addr 0x3bd6e98, size 0xb4, virtual false, abstract: false, final false
  inline bool get_isMe();

  /// @brief Method get_lastScoreTime, addr 0x3bdd100, size 0x50, virtual false, abstract: false, final false
  inline int64_t get_lastScoreTime();

  /// @brief Method get_offsetSyncTime, addr 0x3bdcf7c, size 0xb8, virtual false, abstract: false, final false
  inline int64_t get_offsetSyncTime();

  /// @brief Method get_score, addr 0x3bced04, size 0x30, virtual false, abstract: false, final false
  inline int32_t get_score();

  /// @brief Method get_userId, addr 0x3bd2c10, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x3bdd150, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW get_userName();

  /// @brief Method get_wasActiveAtLevelStart, addr 0x3bdcf28, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Update>b__16_0, addr 0x3bdd2f0, size 0x24, virtual false, abstract: false, final false
  inline bool _Update_b__16_0(::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer* p);

  /// @brief Method .ctor, addr 0x3bdd2e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetPositionOfPlayer>b__0, addr 0x3bdd314, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bdd034, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPositionOfPlayer, addr 0x3bdb558, size 0xe0, virtual false, abstract: false, final false
  inline int32_t GetPositionOfPlayer(::StringW userId);

  static inline ::GlobalNamespace::MultiplayerScoreProvider* New_ctor();

  /// @brief Method TryGetScore, addr 0x3bcec9c, size 0x68, virtual false, abstract: false, final false
  inline bool TryGetScore(::StringW userId, ::ByRef<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*> data);

  /// @brief Method Update, addr 0x3bdc7b0, size 0x6c0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3bdd03c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_firstPlayerDidChangeEvent, addr 0x3bd2eec, size 0xb0, virtual false, abstract: false, final false
  inline void add_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>* value);

  /// @brief Method get_firstPlayer, addr 0x3bdc798, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer* get_firstPlayer();

  /// @brief Method get_rankedPlayers, addr 0x3bdc7a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_scoresAvailable, addr 0x3bdb174, size 0x20, virtual false, abstract: false, final false
  inline bool get_scoresAvailable();

  /// @brief Method remove_firstPlayerDidChangeEvent, addr 0x3bd2acc, size 0xb0, virtual false, abstract: false, final false
  inline void remove_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>* value);

  /// @brief Method set_firstPlayer, addr 0x3bdc7a0, size 0x8, virtual false, abstract: false, final false
