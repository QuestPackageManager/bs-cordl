...
public:
  ...
  /// @brief Method CompareTo, addr 0x583a88c, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x583a2a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isActiveOrFinished, addr 0x583a5f4, size 0x40, virtual false, abstract: false, final false
  inline bool get_isActiveOrFinished();

  /// @brief Method get_isConnected, addr 0x583a1bc, size 0xbc, virtual false, abstract: false, final false
  inline bool get_isConnected();

  /// @brief Method get_isFailed, addr 0x583a634, size 0x28, virtual false, abstract: false, final false
  inline bool get_isFailed();

  /// @brief Method get_isMe, addr 0x583a65c, size 0xb8, virtual false, abstract: false, final false
  inline bool get_isMe();

  /// @brief Method get_lastScoreTime, addr 0x583a5a0, size 0x54, virtual false, abstract: false, final false
  inline int64_t get_lastScoreTime();

  /// @brief Method get_offsetSyncTime, addr 0x583a2a8, size 0xbc, virtual false, abstract: false, final false
  inline int64_t get_offsetSyncTime();

  /// @brief Method get_score, addr 0x58398a4, size 0x30, virtual false, abstract: false, final false
  inline int32_t get_score();

  /// @brief Method get_userId, addr 0x583a714, size 0xbc, virtual false, abstract: false, final false
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x583a7d0, size 0xbc, virtual false, abstract: false, final false
  inline ::StringW get_userName();

  /// @brief Method get_wasActiveAtLevelStart, addr 0x583a278, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Update>b__16_0, addr 0x583a968, size 0x24, virtual false, abstract: false, final false
  inline bool _Update_b__16_0(::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer* p);

  /// @brief Method .ctor, addr 0x583a964, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetPositionOfPlayer>b__0, addr 0x583a98c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x583a4b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPositionOfPlayer, addr 0x583a3d0, size 0xe8, virtual false, abstract: false, final false
  inline int32_t GetPositionOfPlayer(::StringW userId);

  static inline ::GlobalNamespace::MultiplayerScoreProvider* New_ctor();

  /// @brief Method TryGetScore, addr 0x583a364, size 0x6c, virtual false, abstract: false, final false
  inline bool TryGetScore(::StringW userId, ::ByRef<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*> data);

  /// @brief Method Update, addr 0x5839a6c, size 0x750, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x583a4bc, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_firstPlayerDidChangeEvent, addr 0x58398e4, size 0xc0, virtual false, abstract: false, final false
  inline void add_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>* value);

  /// @brief Method get_firstPlayer, addr 0x58398d4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer* get_firstPlayer();

  /// @brief Method get_rankedPlayers, addr 0x5839a64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_scoresAvailable, addr 0x5839884, size 0x20, virtual false, abstract: false, final false
  inline bool get_scoresAvailable();

  /// @brief Method remove_firstPlayerDidChangeEvent, addr 0x58399a4, size 0xc0, virtual false, abstract: false, final false
  inline void remove_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>* value);

  /// @brief Method set_firstPlayer, addr 0x58398dc, size 0x8, virtual false, abstract: false, final false
