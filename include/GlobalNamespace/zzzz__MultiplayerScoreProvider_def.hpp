...
/// @brief Field _multiplayerSyncState, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerSyncState, put=__cordl_internal_set__multiplayerSyncState)) ::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::StandardScoreSyncState_Score,int32_t>*  _multiplayerSyncState;
...
/// @brief Method CompareTo, addr 0x583b1bc, size 0x84, virtual true, abstract: false, final true
inline int32_t CompareTo(::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*  other) ;

static inline ::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer* New_ctor(::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::StandardScoreSyncState_Score,int32_t>*  multiplayerSyncState, ::GlobalNamespace::MultiplayerScoreProvider*  scoreSyncManager) ;

constexpr ::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::StandardScoreSyncState_Score,int32_t>* const& __cordl_internal_get__multiplayerSyncState() const;

constexpr ::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::StandardScoreSyncState_Score,int32_t>*& __cordl_internal_get__multiplayerSyncState() ;
...
constexpr void __cordl_internal_set__multiplayerSyncState(::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::StandardScoreSyncState_Score,int32_t>*  value) ;

constexpr void __cordl_internal_set__scoreSyncManager(::UnityW<::GlobalNamespace::MultiplayerScoreProvider>  value) ;

/// @brief Method .ctor, addr 0x583abd0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::StandardScoreSyncState_Score,int32_t>*  multiplayerSyncState, ::GlobalNamespace::MultiplayerScoreProvider*  scoreSyncManager) ;

/// @brief Method get_isActiveOrFinished, addr 0x583af24, size 0x40, virtual false, abstract: false, final false
inline bool get_isActiveOrFinished() ;

/// @brief Method get_isConnected, addr 0x583aaec, size 0xbc, virtual false, abstract: false, final false
inline bool get_isConnected() ;

/// @brief Method get_isFailed, addr 0x583af64, size 0x28, virtual false, abstract: false, final false
inline bool get_isFailed() ;

/// @brief Method get_isMe, addr 0x583af8c, size 0xb8, virtual false, abstract: false, final false
inline bool get_isMe() ;

/// @brief Method get_lastScoreTime, addr 0x583aed0, size 0x54, virtual false, abstract: false, final false
inline int64_t get_lastScoreTime() ;

/// @brief Method get_offsetSyncTime, addr 0x583abd8, size 0xbc, virtual false, abstract: false, final false
inline int64_t get_offsetSyncTime() ;

/// @brief Method get_score, addr 0x583a1d4, size 0x30, virtual false, abstract: false, final false
inline int32_t get_score() ;

/// @brief Method get_userId, addr 0x583b044, size 0xbc, virtual false, abstract: false, final false
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x583b100, size 0xbc, virtual false, abstract: false, final false
inline ::StringW get_userName() ;

/// @brief Method get_wasActiveAtLevelStart, addr 0x583aba8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method <Update>b__16_0, addr 0x583b298, size 0x24, virtual false, abstract: false, final false
inline bool _Update_b__16_0(::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*  p) ;

/// @brief Method .ctor, addr 0x583b294, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetPositionOfPlayer>b__0, addr 0x583b2bc, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x583ade8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <firstPlayer>k__BackingField, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__firstPlayer_k__BackingField, put=__cordl_internal_set__firstPlayer_k__BackingField)) ::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*  _firstPlayer_k__BackingField;

/// @brief Field _players, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__players, put=__cordl_internal_set__players)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>*  _players;

/// @brief Field _rankedPlayers, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__rankedPlayers, put=__cordl_internal_set__rankedPlayers)) ::System::Collections::Generic::List_1<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>*  _rankedPlayers;
...
/// @brief Field firstPlayerDidChangeEvent, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_firstPlayerDidChangeEvent, put=__cordl_internal_set_firstPlayerDidChangeEvent)) ::System::Action_1<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>*  firstPlayerDidChangeEvent;
...
/// @brief Method GetPositionOfPlayer, addr 0x583ad00, size 0xe8, virtual false, abstract: false, final false
inline int32_t GetPositionOfPlayer(::StringW  userId) ;

static inline ::GlobalNamespace::MultiplayerScoreProvider* New_ctor() ;

/// @brief Method TryGetScore, addr 0x583ac94, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetScore(::StringW  userId, ::ByRef<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>  data) ;

/// @brief Method Update, addr 0x583a39c, size 0x750, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x583adec, size 0xe4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_firstPlayerDidChangeEvent, addr 0x583a214, size 0xc0, virtual false, abstract: false, final false
inline void add_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>*  value) ;

/// @brief Method get_firstPlayer, addr 0x583a204, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer* get_firstPlayer() ;

/// @brief Method get_rankedPlayers, addr 0x583a394, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_scoresAvailable, addr 0x583a1b4, size 0x20, virtual false, abstract: false, final false
inline bool get_scoresAvailable() ;

/// @brief Method remove_firstPlayerDidChangeEvent, addr 0x583a2d4, size 0xc0, virtual false, abstract: false, final false
inline void remove_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*>*  value) ;

/// @brief Method set_firstPlayer, addr 0x583a20c, size 0x8, virtual false, abstract: false, final false
