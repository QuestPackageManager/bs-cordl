...
public:
  ...
  /// @brief Field <time>k__BackingField, offset 0x28, size 0x4
  ...
  /// @brief Method get_pool addr 0xdd59f8 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::StandardScoreSyncStateNetSerializable*>* get_pool();

  /// @brief Method get_id addr 0xdd5a38 size 0x8 virtual true final true
  inline ::GlobalNamespace::SyncStateId get_id();

  /// @brief Method set_id addr 0xdd5a40 size 0x8 virtual true final true
  inline void set_id(::GlobalNamespace::SyncStateId value);

  /// @brief Method get_time addr 0xdd5a48 size 0x8 virtual true final true
  inline float_t get_time();

  /// @brief Method set_time addr 0xdd5a50 size 0x8 virtual true final true
  inline void set_time(float_t value);

  /// @brief Method get_state addr 0xdd5a58 size 0x14 virtual true final true
  inline ::GlobalNamespace::StandardScoreSyncState get_state();

  /// @brief Method set_state addr 0xdd5a6c size 0x14 virtual true final true
  inline void set_state(::GlobalNamespace::StandardScoreSyncState value);

  /// @brief Method Serialize addr 0xdd5a80 size 0x4c virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdd5acc size 0x4c virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xdd5b18 size 0x54 virtual true final true
  inline void Release();

  static inline ::GlobalNamespace::StandardScoreSyncStateNetSerializable* New_ctor();

  /// @brief Method .ctor addr 0xdd5b6c size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field <time>k__BackingField, offset: 0x28, size: 0x4, def value: None
