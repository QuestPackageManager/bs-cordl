...
/// @brief Method .ctor, addr 0x5824c98, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isFailed, addr 0x5824b4c, size 0x14c, virtual true, abstract: false, final true
inline bool get_isFailed() ;

/// @brief Method get_offsetSyncTime, addr 0x58248c0, size 0x28c, virtual true, abstract: false, final true
