...
public:
  ...
  /// @brief Method .ctor, addr 0x590ce0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GameCoreSceneSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GameCoreSceneSetupData(GameCoreSceneSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GameCoreSceneSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GameCoreSceneSetupData(GameCoreSceneSetupDataconst&) = delete;
