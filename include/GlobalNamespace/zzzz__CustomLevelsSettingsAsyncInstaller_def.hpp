...
/// @brief Method MoveNext, addr 0x3671478, size 0x16c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x36715e4, size 0x6c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "container", ty: "::Zenject::DiContainer*", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::CustomLevelsSettingsAsyncInstaller>", modifiers: "", def_value: None }]
constexpr CustomLevelsSettingsAsyncInstaller__LoadResourcesBeforeInstallAsync_d__2(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::Zenject::DiContainer*  container, ::UnityW<::GlobalNamespace::CustomLevelsSettingsAsyncInstaller>  __4__this) noexcept;
...
/// @brief Method InstallBindings, addr 0x36713a8, size 0xcc, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method LoadResourcesBeforeInstall, addr 0x3671280, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method LoadResourcesBeforeInstallAsync, addr 0x36712f0, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3671474, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
