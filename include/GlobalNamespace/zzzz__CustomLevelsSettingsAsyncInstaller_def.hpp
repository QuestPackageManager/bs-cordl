...
public:
  ...
  /// @brief Method MoveNext, addr 0x36adef8, size 0x16c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x36ae064, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x36ade28, size 0xcc, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x36add00, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method LoadResourcesBeforeInstallAsync, addr 0x36add70, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36adef4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
