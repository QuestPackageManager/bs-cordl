...
public:
  ...
  /// @brief Method MoveNext, addr 0x35f01ec, size 0x774, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::LightColorBeatmapEventDataBox__Unpack_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<BeatmapEventData>.GetEnumerator, addr 0x35f0a5c, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<BeatmapEventData>.get_Current, addr 0x35f0a14, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BeatmapEventData* System_Collections_Generic_IEnumerator_BeatmapEventData__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x35f0b34, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x35f0a1c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x35f0a54, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x35f01d0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x35f0960, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x35f01b0, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Unpack, addr 0x35f00e4, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35efebc, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x35efeb4, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x35efeac, size 0x8, virtual true, abstract: false, final false
