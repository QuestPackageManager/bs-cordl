...
public:
  ...
  /// @brief Method Unpack, addr 0x26bebfc, size 0x518, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26be9f4, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x26be9ec, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x26be9e4, size 0x8, virtual true, abstract: false, final false
