...
public:
  ...
  /// @brief Method HandleAllSliderWereRemovedFromActiveSliders, addr 0x25ac184, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderWasAddedToActiveSliders, addr 0x25ac178, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25abf2c, size 0xec, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x25aafcc, size 0xec, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x25ab260, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorType, addr 0x25ab0b8, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorType get_colorType();

  /// @brief Method get_saberInteractionParam, addr 0x25ab1a8, size 0x1c, virtual false, abstract: false, final false
