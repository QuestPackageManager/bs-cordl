...
public:
  ...
  /// @brief Method HandleAllSliderWereRemovedFromActiveSliders, addr 0x3b7b2d8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderWasAddedToActiveSliders, addr 0x3b7b2cc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b7b088, size 0xe4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3b7a274, size 0xe4, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b7a500, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorType, addr 0x3b7a358, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorType get_colorType();

  /// @brief Method get_saberInteractionParam, addr 0x3b7a448, size 0x1c, virtual false, abstract: false, final false
