...
public:
  ...
  /// @brief Method MoveNext, addr 0x3acbc48, size 0x2bc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3acbf04, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method LogSessionEventAfterPlatformInit, addr 0x3acb9d8, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* LogSessionEventAfterPlatformInit(bool hasFocus);

  /// @brief Method LogSessionEventOnFocus, addr 0x3acb9cc, size 0xc, virtual false, abstract: false, final false
  inline void LogSessionEventOnFocus(bool hasFocus);

  /// @brief Method LogSessionFinish, addr 0x3acbb68, size 0xd8, virtual false, abstract: false, final false
  inline void LogSessionFinish();

  /// @brief Method LogSessionStart, addr 0x3acbab0, size 0xb8, virtual false, abstract: false, final false
  inline void LogSessionStart();

  static inline ::GlobalNamespace::GameSessionAnalyticsManager* New_ctor();

  /// @brief Method OnApplicationFocus, addr 0x3acb97c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3acbc40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
