...
public:
  ...
  /// @brief Method LogSessionEventOnFocus, addr 0x5774274, size 0xc, virtual false, abstract: false, final false
  inline void LogSessionEventOnFocus(bool hasFocus);

  /// @brief Method LogSessionFinish, addr 0x5774354, size 0xf8, virtual false, abstract: false, final false
  inline void LogSessionFinish();

  /// @brief Method LogSessionStart, addr 0x5774280, size 0xd4, virtual false, abstract: false, final false
  inline void LogSessionStart();

  static inline ::GlobalNamespace::GameSessionAnalyticsManager* New_ctor();

  /// @brief Method OnApplicationFocus, addr 0x5774268, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x577444c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
