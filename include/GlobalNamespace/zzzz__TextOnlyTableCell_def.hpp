...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextOnlyTableCell*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextOnlyTableCell*, "", "TextOnlyTableCell");
...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x5a03cf0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method RefreshVisuals, addr 0x5a03c24, size 0xcc, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method SelectionDidChange, addr 0x5a03c20, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a03cf4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x5a03be0, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x5a03c00, size 0x20, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextOnlyTableCell", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextOnlyTableCell(TextOnlyTableCell&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextOnlyTableCell", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextOnlyTableCell(TextOnlyTableCellconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::TextOnlyTableCell) == 0xa0, "Size mismatch!");
