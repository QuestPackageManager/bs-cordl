...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x3b844d4, size 0x4, virtual true, abstract: false, final false
  inline void HighlightDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  static inline ::GlobalNamespace::TextOnlyTableCell* New_ctor();

  /// @brief Method RefreshVisuals, addr 0x3b84408, size 0xcc, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method SelectionDidChange, addr 0x3b84404, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b844d8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x3b843bc, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_text, addr 0x3b843e0, size 0x24, virtual false, abstract: false, final false
