...
/// @brief Method ClearGameplaySetupData, addr 0x3639340, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method SetBeatmapKey, addr 0x36393ac, size 0xc, virtual false, abstract: false, final false
inline void SetBeatmapKey(::ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method SetGameplayModifiers, addr 0x36393b8, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3639240, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x36392a4, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers) ;

/// @brief Method get_beatmapKey, addr 0x363922c, size 0xc, virtual true, abstract: false, final true
inline ::GlobalNamespace::BeatmapKey get_beatmapKey() ;

/// @brief Method get_gameplayModifiers, addr 0x3639238, size 0x8, virtual true, abstract: false, final true
