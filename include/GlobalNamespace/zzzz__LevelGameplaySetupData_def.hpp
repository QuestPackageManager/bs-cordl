...
public:
  ...
  /// @brief Method ClearGameplaySetupData, addr 0x3736d9c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3736c9c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_gameplayModifiers, addr 0x3736c94, size 0x8, virtual true, abstract: false, final true
