...
template<typename T>
constexpr ::GlobalNamespace::LazyCopyHashSet_1<T>* const& GlobalNamespace::MemoryPoolContainer_1<T>::__cordl_internal_get__activeItems() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____activeItems;
}
template<typename T>
...
template<typename T>
constexpr ::Zenject::IMemoryPool_1<T>* const& GlobalNamespace::MemoryPoolContainer_1<T>::__cordl_internal_get__memoryPool() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____memoryPool;
}
template<typename T>
