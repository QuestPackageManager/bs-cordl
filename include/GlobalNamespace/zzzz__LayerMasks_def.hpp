...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LayerMasks", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LayerMasks(LayerMasks&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LayerMasks", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LayerMasks(LayerMasksconst&) = delete;
