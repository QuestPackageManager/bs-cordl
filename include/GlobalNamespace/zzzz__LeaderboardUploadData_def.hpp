...
public:
  ...
  /// @brief Method .ctor, addr 0x3756a58, size 0x28, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeaderboardUploadData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeaderboardUploadData(LeaderboardUploadData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeaderboardUploadData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeaderboardUploadData(LeaderboardUploadDataconst&) = delete;
