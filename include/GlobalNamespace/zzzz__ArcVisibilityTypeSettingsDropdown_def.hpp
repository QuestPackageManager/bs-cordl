...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArcVisibilityTypeSettingsDropdown", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArcVisibilityTypeSettingsDropdown(ArcVisibilityTypeSettingsDropdown&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArcVisibilityTypeSettingsDropdown", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArcVisibilityTypeSettingsDropdown(ArcVisibilityTypeSettingsDropdownconst&) = delete;
