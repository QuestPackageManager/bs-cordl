...
// Write type traits
MARK_REF_T(::GlobalNamespace::ObjectiveValueFormatterSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObjectiveValueFormatterSO*, "", "ObjectiveValueFormatterSO");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectiveValueFormatterSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectiveValueFormatterSO(ObjectiveValueFormatterSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectiveValueFormatterSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectiveValueFormatterSO(ObjectiveValueFormatterSOconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::ObjectiveValueFormatterSO) == 0x18, "Size mismatch!");
