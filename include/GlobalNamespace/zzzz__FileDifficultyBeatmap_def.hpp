...
/// @brief Method GetBeatmapString, addr 0x362b818, size 0x78, virtual false, abstract: false, final false
inline ::StringW GetBeatmapString() ;

/// @brief Method GetBeatmapStringAsync, addr 0x362b698, size 0xc0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::StringW>* GetBeatmapStringAsync() ;

/// @brief Method GetLightshowString, addr 0x362b890, size 0x7c, virtual false, abstract: false, final false
inline ::StringW GetLightshowString() ;

/// @brief Method GetLightshowStringAsync, addr 0x362b758, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x362b690, size 0x8, virtual false, abstract: false, final false
