...
public:
  ...
  /// @brief Method GetBeatmapString, addr 0x3726310, size 0x78, virtual false, abstract: false, final false
  inline ::StringW GetBeatmapString();

  /// @brief Method GetBeatmapStringAsync, addr 0x3726190, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::StringW>* GetBeatmapStringAsync();

  /// @brief Method GetLightshowString, addr 0x3726388, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW GetLightshowString();

  /// @brief Method GetLightshowStringAsync, addr 0x3726250, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3726188, size 0x8, virtual false, abstract: false, final false
