...
public:
  ...
  /// @brief Method Awake, addr 0x31f2400, size 0xfc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleContractBeatmapEvent, addr 0x31f2744, size 0xb4, virtual false, abstract: false, final false
  inline void HandleContractBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method HandleExpandBeatmapEvent, addr 0x31f27f8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x31f2740, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x31f26f0, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x31f26ec, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnInject, addr 0x31f24fc, size 0x4, virtual false, abstract: false, final false
  inline void OnInject();

  /// @brief Method TrySubscribe, addr 0x31f2500, size 0x1ec, virtual false, abstract: false, final false
  inline void TrySubscribe();

  /// @brief Method TryUnsubscribe, addr 0x31f26f4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f28ac, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
