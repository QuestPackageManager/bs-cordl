...
// Write type traits
MARK_REF_T(::GlobalNamespace::UIEditorSetup*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UIEditorSetup*, "", "UIEditorSetup");
...
public:
  ...
  /// @brief Method Method, addr 0x5a3d430, size 0x4, virtual false, abstract: false, final false
  inline void Method();
  ...
  /// @brief Method .ctor, addr 0x5a3d434, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::UIEditorSetup) == 0x38, "Size mismatch!");
