...
public:
  ...
  /// @brief Method Method, addr 0x590235c, size 0x4, virtual false, abstract: false, final false
  inline void Method();
  ...
  /// @brief Method .ctor, addr 0x5902360, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
