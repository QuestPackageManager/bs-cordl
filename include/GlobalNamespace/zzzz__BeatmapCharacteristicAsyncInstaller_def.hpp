...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapCharacteristicAsyncInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapCharacteristicAsyncInstaller(BeatmapCharacteristicAsyncInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapCharacteristicAsyncInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapCharacteristicAsyncInstaller(BeatmapCharacteristicAsyncInstallerconst&) = delete;
