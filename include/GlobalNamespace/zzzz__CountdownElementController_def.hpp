...
public:
  ...
  /// @brief Method SetTextAndRunAnimation, addr 0x2408990, size 0x64, virtual false, abstract: false, final false
  inline void SetTextAndRunAnimation(::StringW text);

  /// @brief Method StopAndHide, addr 0x2408ae8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2408c70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
