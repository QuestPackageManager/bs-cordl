...
// Write type traits
MARK_REF_T(::GlobalNamespace::FloatFxGroupEffectTarget*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatFxGroupEffectTarget*, "", "FloatFxGroupEffectTarget");
...
public:
  ...
  /// @brief Method .ctor, addr 0x598c5a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::FloatFxGroupEffectTarget) == 0x20, "Size mismatch!");
