...
/// @brief Method <Finish>b__0, addr 0x5799b7c, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5796c14, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleServerPlayerListViewControllerKickPlayer>b__0, addr 0x5799bec, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5797f80, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _centerStageScreenController, offset 0x118, size 0x8 
 __declspec(property(get=__cordl_internal_get__centerStageScreenController, put=__cordl_internal_set__centerStageScreenController)) ::UnityW<::GlobalNamespace::CenterStageScreenController>  _centerStageScreenController;

/// @brief Field _connectionErrorDialogViewController, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectionErrorDialogViewController, put=__cordl_internal_set__connectionErrorDialogViewController)) ::UnityW<::GlobalNamespace::ConnectionErrorDialogViewController>  _connectionErrorDialogViewController;
...
/// @brief Field _gameplaySetupViewController, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameplaySetupViewController, put=__cordl_internal_set__gameplaySetupViewController)) ::UnityW<::GlobalNamespace::GameplaySetupViewController>  _gameplaySetupViewController;
...
/// @brief Field _lastSimpleLevelSelectionFlowCoordinatorState, offset 0x180, size 0x8 
 __declspec(property(get=__cordl_internal_get__lastSimpleLevelSelectionFlowCoordinatorState, put=__cordl_internal_set__lastSimpleLevelSelectionFlowCoordinatorState)) ::GlobalNamespace::LevelSelectionFlowCoordinator_State*  _lastSimpleLevelSelectionFlowCoordinatorState;
...
/// @brief Field _lobbySetupViewController, offset 0x148, size 0x8 
 __declspec(property(get=__cordl_internal_get__lobbySetupViewController, put=__cordl_internal_set__lobbySetupViewController)) ::UnityW<::GlobalNamespace::LobbySetupViewController>  _lobbySetupViewController;
...
/// @brief Field _missingEntitlementsStringBuilder, offset 0x190, size 0x8 
 __declspec(property(get=__cordl_internal_get__missingEntitlementsStringBuilder, put=__cordl_internal_set__missingEntitlementsStringBuilder)) ::System::Text::StringBuilder*  _missingEntitlementsStringBuilder;

/// @brief Field _multiplayerLevelSelectionFlowCoordinator, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLevelSelectionFlowCoordinator, put=__cordl_internal_set__multiplayerLevelSelectionFlowCoordinator)) ::UnityW<::GlobalNamespace::MultiplayerLevelSelectionFlowCoordinator>  _multiplayerLevelSelectionFlowCoordinator;

/// @brief Field _multiplayerLobbyController, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLobbyController, put=__cordl_internal_set__multiplayerLobbyController)) ::UnityW<::GlobalNamespace::MultiplayerLobbyController>  _multiplayerLobbyController;

/// @brief Field _multiplayerResultsViewController, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerResultsViewController, put=__cordl_internal_set__multiplayerResultsViewController)) ::UnityW<::GlobalNamespace::MultiplayerResultsViewController>  _multiplayerResultsViewController;

/// @brief Field _multiplayerSettingsPanelController, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerSettingsPanelController, put=__cordl_internal_set__multiplayerSettingsPanelController)) ::UnityW<::GlobalNamespace::MultiplayerSettingsPanelController>  _multiplayerSettingsPanelController;
...
/// @brief Field _playerIdsWithoutEntitlements, offset 0x198, size 0x8 
 __declspec(property(get=__cordl_internal_get__playerIdsWithoutEntitlements, put=__cordl_internal_set__playerIdsWithoutEntitlements)) ::System::Collections::Generic::List_1<::StringW>*  _playerIdsWithoutEntitlements;
...
/// @brief Field _selectModifiersViewController, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__selectModifiersViewController, put=__cordl_internal_set__selectModifiersViewController)) ::UnityW<::GlobalNamespace::SelectModifiersViewController>  _selectModifiersViewController;

/// @brief Field _serverPlayerListViewController, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__serverPlayerListViewController, put=__cordl_internal_set__serverPlayerListViewController)) ::UnityW<::GlobalNamespace::ServerPlayerListViewController>  _serverPlayerListViewController;

/// @brief Field _simpleDialogPromptViewController, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__simpleDialogPromptViewController, put=__cordl_internal_set__simpleDialogPromptViewController)) ::UnityW<::GlobalNamespace::SimpleDialogPromptViewController>  _simpleDialogPromptViewController;
...
/// @brief Method BackButtonWasPressed, addr 0x579656c, size 0x170, virtual true, abstract: false, final false
inline void BackButtonWasPressed(::HMUI::ViewController*  topViewController) ;

/// @brief Method DidActivate, addr 0x57927a0, size 0x1484, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x57943f4, size 0x1090, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method DismissViewControllersAndCoordinators, addr 0x5796c18, size 0xfc, virtual false, abstract: false, final false
inline void DismissViewControllersAndCoordinators() ;

/// @brief Method Finish, addr 0x57969e4, size 0x230, virtual false, abstract: false, final false
inline void Finish(::System::Action*  finishedCallback, bool  withFadeOut) ;

/// @brief Method GetInitialGameState, addr 0x5795564, size 0x150, virtual false, abstract: false, final false
inline void GetInitialGameState() ;

/// @brief Method GetLobbyType, addr 0x5792750, size 0x50, virtual true, abstract: false, final false
inline ::GlobalNamespace::GameServerLobbyFlowCoordinatorBase_LobbyType GetLobbyType() ;

/// @brief Method GetLocalizedTitle, addr 0x5799560, size 0xb8, virtual false, abstract: false, final false
inline ::StringW GetLocalizedTitle() ;

/// @brief Method HandleLobbyGameBeforeSceneSwitchCallback, addr 0x5799618, size 0x234, virtual false, abstract: false, final false
inline void HandleLobbyGameBeforeSceneSwitchCallback() ;

/// @brief Method HandleLobbyGameStateControllerCancelStartTime, addr 0x5798bc8, size 0x38, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerCancelStartTime() ;

/// @brief Method HandleLobbyGameStateControllerCountdownCancelled, addr 0x5798218, size 0x38, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerCountdownCancelled() ;

/// @brief Method HandleLobbyGameStateControllerCountdownStarted, addr 0x5797f84, size 0x294, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerCountdownStarted() ;

/// @brief Method HandleLobbyGameStateControllerGameStarted, addr 0x5798250, size 0x2d4, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerGameStarted(::GlobalNamespace::ILevelGameplaySetupData*  levelGameplaySetupData) ;

/// @brief Method HandleLobbyGameStateControllerGameStartedPresentView, addr 0x5798c00, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method HandleLobbyGameStateControllerGameStateChanged, addr 0x57978b8, size 0x160, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerGameStateChanged(::GlobalNamespace::MultiplayerLobbyState  state) ;

/// @brief Method HandleLobbyGameStateControllerLevelDidGetDisconnected, addr 0x5799128, size 0x4, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerLevelDidGetDisconnected(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method HandleLobbyGameStateControllerLevelFinished, addr 0x5798cb0, size 0x478, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerLevelFinished(::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO*  multiplayerLevelScenesTransitionSetupData, ::GlobalNamespace::MultiplayerResultsData*  multiplayerResultsData) ;

/// @brief Method HandleLobbyGameStateControllerLobbyDisconnected, addr 0x5797374, size 0xb4, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerLobbyDisconnected() ;

/// @brief Method HandleLobbyGameStateControllerSongStillDownloading, addr 0x5798718, size 0x4, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerSongStillDownloading() ;

/// @brief Method HandleLobbyGameStateControllerStartTimeChanged, addr 0x5798524, size 0x1f4, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerStartTimeChanged() ;

/// @brief Method HandleLobbyGameStateStartButtonEnabled, addr 0x579984c, size 0x34, virtual false, abstract: false, final false
inline void HandleLobbyGameStateStartButtonEnabled(::GlobalNamespace::CannotStartGameReason  cannotStartGameReason) ;

/// @brief Method HandleLobbyPlayerPermissionsModelPermissionsChanged, addr 0x5799960, size 0x4, virtual false, abstract: false, final false
inline void HandleLobbyPlayerPermissionsModelPermissionsChanged() ;

/// @brief Method HandleLobbyPlayersDataModelDidChange, addr 0x5796d14, size 0x4, virtual false, abstract: false, final false
inline void HandleLobbyPlayersDataModelDidChange(::StringW  userId) ;

/// @brief Method HandleLobbySetupViewControllerCancelGameOrUnready, addr 0x5798a4c, size 0x17c, virtual false, abstract: false, final false
inline void HandleLobbySetupViewControllerCancelGameOrUnready() ;

/// @brief Method HandleLobbySetupViewControllerClearSelectedBeatmap, addr 0x5797768, size 0xa8, virtual false, abstract: false, final false
inline void HandleLobbySetupViewControllerClearSelectedBeatmap() ;

/// @brief Method HandleLobbySetupViewControllerClearSelectedModifiers, addr 0x5797810, size 0xa8, virtual false, abstract: false, final false
inline void HandleLobbySetupViewControllerClearSelectedModifiers() ;

/// @brief Method HandleLobbySetupViewControllerSelectBeatmap, addr 0x5796d34, size 0x1d0, virtual false, abstract: false, final false
inline void HandleLobbySetupViewControllerSelectBeatmap() ;

/// @brief Method HandleLobbySetupViewControllerSelectModifiers, addr 0x5797560, size 0x208, virtual false, abstract: false, final false
inline void HandleLobbySetupViewControllerSelectModifiers() ;

/// @brief Method HandleLobbySetupViewControllerStartGameOrReady, addr 0x579871c, size 0x330, virtual false, abstract: false, final false
inline void HandleLobbySetupViewControllerStartGameOrReady() ;

/// @brief Method HandleMenuRpcManagerSetPlayersMissingEntitlementsToLevel, addr 0x5799880, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerLevelSelectionFlowCoordinatorCancelSelectLevel, addr 0x5797528, size 0x38, virtual false, abstract: false, final false
inline void HandleMultiplayerLevelSelectionFlowCoordinatorCancelSelectLevel() ;

/// @brief Method HandleMultiplayerLevelSelectionFlowCoordinatorDidSelectLevel, addr 0x5797428, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerResultsViewControllerBackToLobbyPressed, addr 0x579912c, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerResultsViewControllerBackToMenuPressed, addr 0x579927c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerSettingsPanelControllerPlayerActiveStateChanged, addr 0x5796f04, size 0x23c, virtual false, abstract: false, final false
inline void HandleMultiplayerSettingsPanelControllerPlayerActiveStateChanged(bool  isActive) ;

/// @brief Method HandleServerPlayerListViewControllerDidOpenInvitePanel, addr 0x5796d18, size 0x1c, virtual false, abstract: false, final false
inline void HandleServerPlayerListViewControllerDidOpenInvitePanel() ;

/// @brief Method HandleServerPlayerListViewControllerKickPlayer, addr 0x5797c18, size 0x368, virtual false, abstract: false, final false
inline void HandleServerPlayerListViewControllerKickPlayer(::StringW  userId) ;

/// @brief Method HandleServerPlayerListViewControllerSelectSuggestedBeatmap, addr 0x5797a18, size 0x148, virtual false, abstract: false, final false
inline void HandleServerPlayerListViewControllerSelectSuggestedBeatmap(::GlobalNamespace::BeatmapKey  beatmapKey) ;

/// @brief Method HandleServerPlayerListViewControllerSelectSuggestedGameplayModifiers, addr 0x5797b60, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method InitialViewControllerWasPresented, addr 0x5795484, size 0xe0, virtual true, abstract: false, final false
inline void InitialViewControllerWasPresented() ;

static inline ::GlobalNamespace::GameServerLobbyFlowCoordinator* New_ctor() ;

/// @brief Method PresentBackButtonConfirmationDialog, addr 0x57966dc, size 0x308, virtual false, abstract: false, final false
inline void PresentBackButtonConfirmationDialog() ;

/// @brief Method SetLobbyPlayerDataToViews, addr 0x5793c24, size 0x218, virtual false, abstract: false, final false
inline void SetLobbyPlayerDataToViews(::StringW  userId) ;

/// @brief Method SetLocalPlayerSelectedLevel, addr 0x5797468, size 0xc0, virtual false, abstract: false, final false
inline void SetLocalPlayerSelectedLevel(::GlobalNamespace::LevelSelectionFlowCoordinator_State*  state) ;

/// @brief Method SetPlayersMissingLevelText, addr 0x5799288, size 0x2d8, virtual false, abstract: false, final false
inline void SetPlayersMissingLevelText() ;

/// @brief Method SetTitle, addr 0x5796428, size 0x144, virtual false, abstract: false, final false
inline void SetTitle(::HMUI::ViewController*  newViewController, ::HMUI::ViewController_AnimationType  animationType) ;

/// @brief Method SetupLobbyWithPermissions, addr 0x5793e3c, size 0x5b8, virtual false, abstract: false, final false
inline void SetupLobbyWithPermissions() ;

/// @brief Method ShowBackButton, addr 0x5796420, size 0x8, virtual false, abstract: false, final false
inline void ShowBackButton(bool  show) ;

/// @brief Method ShowDisconnectDialogAndFinish, addr 0x5795e08, size 0x508, virtual false, abstract: false, final false
inline void ShowDisconnectDialogAndFinish(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method ShowSideViewControllers, addr 0x57963c0, size 0x60, virtual false, abstract: false, final false
inline void ShowSideViewControllers(bool  showSideViewControllers, ::HMUI::ViewController_AnimationType  animationType) ;

/// @brief Method TopViewControllerWillChange, addr 0x5796310, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method TransitionDidFinish, addr 0x5795894, size 0x574, virtual true, abstract: false, final false
inline void TransitionDidFinish() ;

/// @brief Method TransitionDidStart, addr 0x57956b4, size 0x1e0, virtual true, abstract: false, final false
inline void TransitionDidStart() ;

/// @brief Method UpdateLocalPlayerIsActiveState, addr 0x5797140, size 0x234, virtual false, abstract: false, final false
inline void UpdateLocalPlayerIsActiveState(bool  isActive) ;

/// @brief Method <PresentBackButtonConfirmationDialog>b__70_0, addr 0x5799a10, size 0x160, virtual false, abstract: false, final false
inline void _PresentBackButtonConfirmationDialog_b__70_0(int32_t  btnIndex) ;

/// @brief Method <ShowDisconnectDialogAndFinish>b__107_0, addr 0x5799b70, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5799964, size 0xac, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x57921e0, size 0xac, virtual true, abstract: false, final false
inline void add_didFinishEvent(::System::Action*  value) ;

/// @brief Method add_didOpenInvitePanelEvent, addr 0x57925e8, size 0xac, virtual true, abstract: false, final false
inline void add_didOpenInvitePanelEvent(::System::Action*  value) ;

/// @brief Method add_didSetupEvent, addr 0x5792490, size 0xac, virtual true, abstract: false, final false
inline void add_didSetupEvent(::System::Action*  value) ;

/// @brief Method add_startGameOrReadyEvent, addr 0x5792338, size 0xac, virtual true, abstract: false, final false
inline void add_startGameOrReadyEvent(::System::Action*  value) ;

/// @brief Method add_willFinishEvent, addr 0x5792088, size 0xac, virtual true, abstract: false, final false
inline void add_willFinishEvent(::System::Action*  value) ;

/// @brief Method get_isManaged, addr 0x5791e3c, size 0xc4, virtual false, abstract: false, final false
inline bool get_isManaged() ;

/// @brief Method get_isPartyOwner, addr 0x5791d60, size 0x18, virtual false, abstract: false, final false
inline bool get_isPartyOwner() ;

/// @brief Method get_isPublicGame, addr 0x5791d78, size 0xc4, virtual false, abstract: false, final false
inline bool get_isPublicGame() ;

/// @brief Method get_isQuickPlayServer, addr 0x5791fc4, size 0xc4, virtual false, abstract: false, final false
inline bool get_isQuickPlayServer() ;

/// @brief Method get_isQuickStartServer, addr 0x5791f00, size 0xc4, virtual false, abstract: false, final false
inline bool get_isQuickStartServer() ;

/// @brief Method get_rejoinQuickPlay, addr 0x5792740, size 0x8, virtual false, abstract: false, final false
inline bool get_rejoinQuickPlay() ;

/// @brief Method remove_didFinishEvent, addr 0x579228c, size 0xac, virtual true, abstract: false, final false
inline void remove_didFinishEvent(::System::Action*  value) ;

/// @brief Method remove_didOpenInvitePanelEvent, addr 0x5792694, size 0xac, virtual true, abstract: false, final false
inline void remove_didOpenInvitePanelEvent(::System::Action*  value) ;

/// @brief Method remove_didSetupEvent, addr 0x579253c, size 0xac, virtual true, abstract: false, final false
inline void remove_didSetupEvent(::System::Action*  value) ;

/// @brief Method remove_startGameOrReadyEvent, addr 0x57923e4, size 0xac, virtual true, abstract: false, final false
inline void remove_startGameOrReadyEvent(::System::Action*  value) ;

/// @brief Method remove_willFinishEvent, addr 0x5792134, size 0xac, virtual true, abstract: false, final false
inline void remove_willFinishEvent(::System::Action*  value) ;

/// @brief Method set_rejoinQuickPlay, addr 0x5792748, size 0x8, virtual false, abstract: false, final false
