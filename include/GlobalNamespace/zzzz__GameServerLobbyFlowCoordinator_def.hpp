...
public:
  ...
  /// @brief Method <Finish>b__0, addr 0x3b4c984, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b4c97c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <HandleServerPlayerListViewControllerKickPlayer>b__0, addr 0x3b4ca00, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b4c9f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BackButtonWasPressed, addr 0x3b496a4, size 0x168, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DidActivate, addr 0x3b45ea0, size 0x1218, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b47870, size 0xe20, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method DismissViewControllersAndCoordinators, addr 0x3b49ca8, size 0xf8, virtual false, abstract: false, final false
  inline void DismissViewControllersAndCoordinators();

  /// @brief Method Finish, addr 0x3b49ab8, size 0x1f0, virtual false, abstract: false, final false
  inline void Finish(::System::Action* finishedCallback, bool withFadeOut);

  /// @brief Method GetInitialGameState, addr 0x3b4876c, size 0x148, virtual false, abstract: false, final false
  inline void GetInitialGameState();

  /// @brief Method GetLobbyType, addr 0x3b45e50, size 0x50, virtual true, abstract: false, final false
  inline ::GlobalNamespace::GameServerLobbyFlowCoordinatorBase_LobbyType GetLobbyType();

  /// @brief Method GetLocalizedTitle, addr 0x3b4c40c, size 0x98, virtual false, abstract: false, final false
  inline ::StringW GetLocalizedTitle();

  /// @brief Method HandleLobbyGameBeforeSceneSwitchCallback, addr 0x3b4c4a4, size 0x1f0, virtual false, abstract: false, final false
  inline void HandleLobbyGameBeforeSceneSwitchCallback();

  /// @brief Method HandleLobbyGameStateControllerCancelStartTime, addr 0x3b4bb1c, size 0x38, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerCancelStartTime();

  /// @brief Method HandleLobbyGameStateControllerCountdownCancelled, addr 0x3b4b1a4, size 0x38, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerCountdownCancelled();

  /// @brief Method HandleLobbyGameStateControllerCountdownStarted, addr 0x3b4af98, size 0x20c, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerCountdownStarted();

  /// @brief Method HandleLobbyGameStateControllerGameStarted, addr 0x3b4b1dc, size 0x2c4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerGameStarted(::GlobalNamespace::ILevelGameplaySetupData* levelGameplaySetupData);

  /// @brief Method HandleLobbyGameStateControllerGameStartedPresentView, addr 0x3b4bb54, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLobbyGameStateControllerGameStateChanged, addr 0x3b4a920, size 0x15c, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerGameStateChanged(::GlobalNamespace::MultiplayerLobbyState state);

  /// @brief Method HandleLobbyGameStateControllerLevelDidGetDisconnected, addr 0x3b4c014, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerLevelDidGetDisconnected(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method HandleLobbyGameStateControllerLevelFinished, addr 0x3b4bc00, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLobbyGameStateControllerLobbyDisconnected, addr 0x3b4a404, size 0xb0, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerLobbyDisconnected();

  /// @brief Method HandleLobbyGameStateControllerSongStillDownloading, addr 0x3b4b68c, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerSongStillDownloading();

  /// @brief Method HandleLobbyGameStateControllerStartTimeChanged, addr 0x3b4b4a0, size 0x1ec, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerStartTimeChanged();

  /// @brief Method HandleLobbyGameStateStartButtonEnabled, addr 0x3b4c694, size 0x34, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateStartButtonEnabled(::GlobalNamespace::CannotStartGameReason cannotStartGameReason);

  /// @brief Method HandleLobbyPlayerPermissionsModelPermissionsChanged, addr 0x3b4c780, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyPlayerPermissionsModelPermissionsChanged();

  /// @brief Method HandleLobbyPlayersDataModelDidChange, addr 0x3b49da0, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyPlayersDataModelDidChange(::StringW userId);

  /// @brief Method HandleLobbySetupViewControllerCancelGameOrUnready, addr 0x3b4b9a8, size 0x174, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerCancelGameOrUnready();

  /// @brief Method HandleLobbySetupViewControllerClearSelectedBeatmap, addr 0x3b4a7d8, size 0xa4, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerClearSelectedBeatmap();

  /// @brief Method HandleLobbySetupViewControllerClearSelectedModifiers, addr 0x3b4a87c, size 0xa4, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerClearSelectedModifiers();

  /// @brief Method HandleLobbySetupViewControllerSelectBeatmap, addr 0x3b49dc0, size 0x1ec, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerSelectBeatmap();

  /// @brief Method HandleLobbySetupViewControllerSelectModifiers, addr 0x3b4a5e0, size 0x1f8, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerSelectModifiers();

  /// @brief Method HandleLobbySetupViewControllerStartGameOrReady, addr 0x3b4b690, size 0x318, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerStartGameOrReady();

  /// @brief Method HandleMenuRpcManagerSetPlayersMissingEntitlementsToLevel, addr 0x3b4c6c8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerLevelSelectionFlowCoordinatorCancelSelectLevel, addr 0x3b4a5a8, size 0x38, virtual false, abstract: false, final false
  inline void HandleMultiplayerLevelSelectionFlowCoordinatorCancelSelectLevel();

  /// @brief Method HandleMultiplayerLevelSelectionFlowCoordinatorDidSelectLevel, addr 0x3b4a4b4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerResultsViewControllerBackToLobbyPressed, addr 0x3b4c018, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerResultsViewControllerBackToMenuPressed, addr 0x3b4c164, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerSettingsPanelControllerPlayerActiveStateChanged, addr 0x3b49fac, size 0x230, virtual false, abstract: false, final false
  inline void HandleMultiplayerSettingsPanelControllerPlayerActiveStateChanged(bool isActive);

  /// @brief Method HandleServerPlayerListViewControllerDidOpenInvitePanel, addr 0x3b49da4, size 0x1c, virtual false, abstract: false, final false
  inline void HandleServerPlayerListViewControllerDidOpenInvitePanel();

  /// @brief Method HandleServerPlayerListViewControllerKickPlayer, addr 0x3b4ac70, size 0x328, virtual false, abstract: false, final false
  inline void HandleServerPlayerListViewControllerKickPlayer(::StringW userId);

  /// @brief Method HandleServerPlayerListViewControllerSelectSuggestedBeatmap, addr 0x3b4aa7c, size 0x148, virtual false, abstract: false, final false
  inline void HandleServerPlayerListViewControllerSelectSuggestedBeatmap(::GlobalNamespace::BeatmapKey beatmapKey);

  /// @brief Method HandleServerPlayerListViewControllerSelectSuggestedGameplayModifiers, addr 0x3b4abc4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method InitialViewControllerWasPresented, addr 0x3b48690, size 0xdc, virtual true, abstract: false, final false
  inline void InitialViewControllerWasPresented();

  static inline ::GlobalNamespace::GameServerLobbyFlowCoordinator* New_ctor();

  /// @brief Method PresentBackButtonConfirmationDialog, addr 0x3b4980c, size 0x2ac, virtual false, abstract: false, final false
  inline void PresentBackButtonConfirmationDialog();

  /// @brief Method SetLobbyPlayerDataToViews, addr 0x3b470b8, size 0x204, virtual false, abstract: false, final false
  inline void SetLobbyPlayerDataToViews(::StringW userId);

  /// @brief Method SetLocalPlayerSelectedLevel, addr 0x3b4a4f4, size 0xb4, virtual false, abstract: false, final false
  inline void SetLocalPlayerSelectedLevel(::GlobalNamespace::LevelSelectionFlowCoordinator_State* state);

  /// @brief Method SetPlayersMissingLevelText, addr 0x3b4c170, size 0x29c, virtual false, abstract: false, final false
  inline void SetPlayersMissingLevelText();

  /// @brief Method SetTitle, addr 0x3b49578, size 0x12c, virtual false, abstract: false, final false
  inline void SetTitle(::HMUI::ViewController* newViewController, ::HMUI::ViewController_AnimationType animationType);

  /// @brief Method SetupLobbyWithPermissions, addr 0x3b472bc, size 0x5b4, virtual false, abstract: false, final false
  inline void SetupLobbyWithPermissions();

  /// @brief Method ShowBackButton, addr 0x3b4956c, size 0xc, virtual false, abstract: false, final false
  inline void ShowBackButton(bool show);

  /// @brief Method ShowDisconnectDialogAndFinish, addr 0x3b49020, size 0x440, virtual false, abstract: false, final false
  inline void ShowDisconnectDialogAndFinish(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method ShowSideViewControllers, addr 0x3b49508, size 0x64, virtual false, abstract: false, final false
  inline void ShowSideViewControllers(bool showSideViewControllers, ::HMUI::ViewController_AnimationType animationType);

  /// @brief Method TopViewControllerWillChange, addr 0x3b49460, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method TransitionDidFinish, addr 0x3b48a84, size 0x59c, virtual true, abstract: false, final false
  inline void TransitionDidFinish();

  /// @brief Method TransitionDidStart, addr 0x3b488b4, size 0x1d0, virtual true, abstract: false, final false
  inline void TransitionDidStart();

  /// @brief Method UpdateLocalPlayerIsActiveState, addr 0x3b4a1dc, size 0x228, virtual false, abstract: false, final false
  inline void UpdateLocalPlayerIsActiveState(bool isActive);

  /// @brief Method <PresentBackButtonConfirmationDialog>b__70_0, addr 0x3b4c82c, size 0x144, virtual false, abstract: false, final false
  inline void _PresentBackButtonConfirmationDialog_b__70_0(int32_t btnIndex);

  /// @brief Method <ShowDisconnectDialogAndFinish>b__107_0, addr 0x3b4c970, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b4c784, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b4593c, size 0xa0, virtual true, abstract: false, final false
  inline void add_didFinishEvent(::System::Action* value);

  /// @brief Method add_didOpenInvitePanelEvent, addr 0x3b45cfc, size 0xa0, virtual true, abstract: false, final false
  inline void add_didOpenInvitePanelEvent(::System::Action* value);

  /// @brief Method add_didSetupEvent, addr 0x3b45bbc, size 0xa0, virtual true, abstract: false, final false
  inline void add_didSetupEvent(::System::Action* value);

  /// @brief Method add_startGameOrReadyEvent, addr 0x3b45a7c, size 0xa0, virtual true, abstract: false, final false
  inline void add_startGameOrReadyEvent(::System::Action* value);

  /// @brief Method add_willFinishEvent, addr 0x3b457fc, size 0xa0, virtual true, abstract: false, final false
  inline void add_willFinishEvent(::System::Action* value);

  /// @brief Method get_isManaged, addr 0x3b455bc, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isManaged();

  /// @brief Method get_isPartyOwner, addr 0x3b454e0, size 0x1c, virtual false, abstract: false, final false
  inline bool get_isPartyOwner();

  /// @brief Method get_isPublicGame, addr 0x3b454fc, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isPublicGame();

  /// @brief Method get_isQuickPlayServer, addr 0x3b4573c, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isQuickPlayServer();

  /// @brief Method get_isQuickStartServer, addr 0x3b4567c, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isQuickStartServer();

  /// @brief Method get_rejoinQuickPlay, addr 0x3b45e3c, size 0x8, virtual false, abstract: false, final false
  inline bool get_rejoinQuickPlay();

  /// @brief Method remove_didFinishEvent, addr 0x3b459dc, size 0xa0, virtual true, abstract: false, final false
  inline void remove_didFinishEvent(::System::Action* value);

  /// @brief Method remove_didOpenInvitePanelEvent, addr 0x3b45d9c, size 0xa0, virtual true, abstract: false, final false
  inline void remove_didOpenInvitePanelEvent(::System::Action* value);

  /// @brief Method remove_didSetupEvent, addr 0x3b45c5c, size 0xa0, virtual true, abstract: false, final false
  inline void remove_didSetupEvent(::System::Action* value);

  /// @brief Method remove_startGameOrReadyEvent, addr 0x3b45b1c, size 0xa0, virtual true, abstract: false, final false
  inline void remove_startGameOrReadyEvent(::System::Action* value);

  /// @brief Method remove_willFinishEvent, addr 0x3b4589c, size 0xa0, virtual true, abstract: false, final false
  inline void remove_willFinishEvent(::System::Action* value);

  /// @brief Method set_rejoinQuickPlay, addr 0x3b45e44, size 0xc, virtual false, abstract: false, final false
