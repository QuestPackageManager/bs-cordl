...
public:
  ...
  /// @brief Method <Finish>b__0, addr 0x3ad88c8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ad5c68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <HandleServerPlayerListViewControllerKickPlayer>b__0, addr 0x3ad8938, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ad6ed8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
// SizeInfo { instance_size: 464, native_size: -1, calculated_instance_size: 464, calculated_native_size: 457, minimum_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Field _analyticsModel, offset 0x170, size 0x8
  __declspec(property(get = __cordl_internal_get__analyticsModel, put = __cordl_internal_set__analyticsModel)) ::GlobalNamespace::IAnalyticsModel* _analyticsModel;

  /// @brief Field _canStartGameCts, offset 0x198, size 0x8
  ...
  /// @brief Field _centerStageScreenController, offset 0x110, size 0x8
  ...
  /// @brief Field _fadeInOutController, offset 0x108, size 0x8
  ...
  /// @brief Field _isAlreadyFinishing, offset 0x180, size 0x1
  ...
  /// @brief Field _lastSimpleLevelSelectionFlowCoordinatorState, offset 0x178, size 0x8
  __declspec(property(get = __cordl_internal_get__lastSimpleLevelSelectionFlowCoordinatorState,
                      put =
                          __cordl_internal_set__lastSimpleLevelSelectionFlowCoordinatorState)) ::GlobalNamespace::__LevelSelectionFlowCoordinator__State* _lastSimpleLevelSelectionFlowCoordinatorState;

  /// @brief Field _lobbyGameStateController, offset 0x130, size 0x8
  ...
  /// @brief Field _lobbyGameStateModel, offset 0x120, size 0x8
  ...
  /// @brief Field _lobbyPlayerPermissionsModel, offset 0x138, size 0x8
  ...
  /// @brief Field _lobbyPlayersDataModel, offset 0x128, size 0x8
  ...
  /// @brief Field _lobbySetupViewController, offset 0x140, size 0x8
  ...
  /// @brief Field _lobbyStateDataModel, offset 0x118, size 0x8
  ...
  /// @brief Field _missingEntitlementsStringBuilder, offset 0x188, size 0x8
  ...
  /// @brief Field _multiplayerLobbyController, offset 0x100, size 0x8
  ...
  /// @brief Field _playerDataModel, offset 0x158, size 0x8
  __declspec(property(get = __cordl_internal_get__playerDataModel, put = __cordl_internal_set__playerDataModel)) ::UnityW<::GlobalNamespace::PlayerDataModel> _playerDataModel;

  /// @brief Field _playerIdsWithoutEntitlements, offset 0x190, size 0x8
  ...
  /// @brief Field <rejoinQuickPlay>k__BackingField, offset 0x1c8, size 0x1
  ...
  /// @brief Field _screenModeController, offset 0x150, size 0x8
  ...
  /// @brief Field _songPreviewPlayer, offset 0x168, size 0x8
  ...
  /// @brief Field _unifiedNetworkPlayerModel, offset 0x148, size 0x8
  ...
  /// @brief Field didFinishEvent, offset 0x1a8, size 0x8
  ...
  /// @brief Field didOpenInvitePanelEvent, offset 0x1c0, size 0x8
  ...
  /// @brief Field didSetupEvent, offset 0x1b8, size 0x8
  ...
  /// @brief Field startGameOrReadyEvent, offset 0x1b0, size 0x8
  ...
  /// @brief Field willFinishEvent, offset 0x1a0, size 0x8
  ...
  /// @brief Method BackButtonWasPressed, addr 0x3ad5664, size 0x168, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DidActivate, addr 0x3ad1bd8, size 0x1210, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3ad36ec, size 0xe18, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method DismissViewControllersAndCoordinators, addr 0x3ad5c70, size 0xf8, virtual false, abstract: false, final false
  inline void DismissViewControllersAndCoordinators();

  /// @brief Method Finish, addr 0x3ad5a78, size 0x1f0, virtual false, abstract: false, final false
  inline void Finish(::System::Action* finishedCallback, bool withFadeOut);

  /// @brief Method GetInitialGameState, addr 0x3ad472c, size 0x148, virtual false, abstract: false, final false
  inline void GetInitialGameState();

  /// @brief Method GetLobbyType, addr 0x3ad1b88, size 0x50, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__GameServerLobbyFlowCoordinatorBase__LobbyType GetLobbyType();

  /// @brief Method GetLocalizedTitle, addr 0x3ad8358, size 0x98, virtual false, abstract: false, final false
  inline ::StringW GetLocalizedTitle();

  /// @brief Method HandleLobbyGameBeforeSceneSwitchCallback, addr 0x3ad83f0, size 0x1f0, virtual false, abstract: false, final false
  inline void HandleLobbyGameBeforeSceneSwitchCallback();

  /// @brief Method HandleLobbyGameStateControllerCancelStartTime, addr 0x3ad7a64, size 0x38, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerCancelStartTime();

  /// @brief Method HandleLobbyGameStateControllerCountdownCancelled, addr 0x3ad70ec, size 0x38, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerCountdownCancelled();

  /// @brief Method HandleLobbyGameStateControllerCountdownStarted, addr 0x3ad6ee0, size 0x20c, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerCountdownStarted();

  /// @brief Method HandleLobbyGameStateControllerGameStarted, addr 0x3ad7124, size 0x2c4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerGameStarted(::GlobalNamespace::ILevelGameplaySetupData* levelGameplaySetupData);

  /// @brief Method HandleLobbyGameStateControllerGameStartedPresentView, addr 0x3ad7a9c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLobbyGameStateControllerGameStateChanged, addr 0x3ad68fc, size 0x15c, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerGameStateChanged(::GlobalNamespace::MultiplayerLobbyState state);

  /// @brief Method HandleLobbyGameStateControllerLevelDidGetDisconnected, addr 0x3ad7f60, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerLevelDidGetDisconnected(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method HandleLobbyGameStateControllerLevelFinished, addr 0x3ad7b48, size 0x418, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLobbyGameStateControllerLobbyDisconnected, addr 0x3ad63f0, size 0xb0, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerLobbyDisconnected();

  /// @brief Method HandleLobbyGameStateControllerSongStillDownloading, addr 0x3ad75d4, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerSongStillDownloading();

  /// @brief Method HandleLobbyGameStateControllerStartTimeChanged, addr 0x3ad73e8, size 0x1ec, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerStartTimeChanged();

  /// @brief Method HandleLobbyGameStateStartButtonEnabled, addr 0x3ad85e0, size 0x34, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateStartButtonEnabled(::GlobalNamespace::CannotStartGameReason cannotStartGameReason);

  /// @brief Method HandleLobbyPlayerPermissionsModelPermissionsChanged, addr 0x3ad86cc, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyPlayerPermissionsModelPermissionsChanged();

  /// @brief Method HandleLobbyPlayersDataModelDidChange, addr 0x3ad5d68, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyPlayersDataModelDidChange(::StringW userId);

  /// @brief Method HandleLobbySetupViewControllerCancelGameOrUnready, addr 0x3ad78f0, size 0x174, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerCancelGameOrUnready();

  /// @brief Method HandleLobbySetupViewControllerClearSelectedBeatmap, addr 0x3ad67b4, size 0xa4, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerClearSelectedBeatmap();

  /// @brief Method HandleLobbySetupViewControllerClearSelectedModifiers, addr 0x3ad6858, size 0xa4, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerClearSelectedModifiers();

  /// @brief Method HandleLobbySetupViewControllerSelectBeatmap, addr 0x3ad5d88, size 0x1ec, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerSelectBeatmap();

  /// @brief Method HandleLobbySetupViewControllerSelectModifiers, addr 0x3ad65bc, size 0x1f8, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerSelectModifiers();

  /// @brief Method HandleLobbySetupViewControllerStartGameOrReady, addr 0x3ad75d8, size 0x318, virtual false, abstract: false, final false
  inline void HandleLobbySetupViewControllerStartGameOrReady();

  /// @brief Method HandleMenuRpcManagerSetPlayersMissingEntitlementsToLevel, addr 0x3ad8614, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerLevelSelectionFlowCoordinatorCancelSelectLevel, addr 0x3ad6584, size 0x38, virtual false, abstract: false, final false
  inline void HandleMultiplayerLevelSelectionFlowCoordinatorCancelSelectLevel();

  /// @brief Method HandleMultiplayerLevelSelectionFlowCoordinatorDidSelectLevel, addr 0x3ad64a0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerResultsViewControllerBackToLobbyPressed, addr 0x3ad7f64, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerResultsViewControllerBackToMenuPressed, addr 0x3ad80b0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerSettingsPanelControllerPlayerActiveStateChanged, addr 0x3ad5f98, size 0x230, virtual false, abstract: false, final false
  inline void HandleMultiplayerSettingsPanelControllerPlayerActiveStateChanged(bool isActive);

  /// @brief Method HandleServerPlayerListViewControllerDidOpenInvitePanel, addr 0x3ad5d6c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleServerPlayerListViewControllerDidOpenInvitePanel();

  /// @brief Method HandleServerPlayerListViewControllerKickPlayer, addr 0x3ad6bb0, size 0x328, virtual false, abstract: false, final false
  inline void HandleServerPlayerListViewControllerKickPlayer(::StringW userId);

  /// @brief Method HandleServerPlayerListViewControllerSelectSuggestedBeatmap, addr 0x3ad6a58, size 0xac, virtual false, abstract: false, final false
  inline void HandleServerPlayerListViewControllerSelectSuggestedBeatmap(::GlobalNamespace::BeatmapKey beatmapKey);

  /// @brief Method HandleServerPlayerListViewControllerSelectSuggestedGameplayModifiers, addr 0x3ad6b04, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method InitialViewControllerWasPresented, addr 0x3ad4650, size 0xdc, virtual true, abstract: false, final false
  inline void InitialViewControllerWasPresented();

  static inline ::GlobalNamespace::GameServerLobbyFlowCoordinator* New_ctor();

  /// @brief Method PresentBackButtonConfirmationDialog, addr 0x3ad57cc, size 0x2ac, virtual false, abstract: false, final false
  inline void PresentBackButtonConfirmationDialog();

  /// @brief Method SetLobbyPlayerDataToViews, addr 0x3ad2f34, size 0x204, virtual false, abstract: false, final false
  inline void SetLobbyPlayerDataToViews(::StringW userId);

  /// @brief Method SetPlayersMissingLevelText, addr 0x3ad80bc, size 0x29c, virtual false, abstract: false, final false
  inline void SetPlayersMissingLevelText();

  /// @brief Method SetTitle, addr 0x3ad5538, size 0x12c, virtual false, abstract: false, final false
  inline void SetTitle(::HMUI::ViewController* newViewController, ::HMUI::__ViewController__AnimationType animationType);

  /// @brief Method SetupLobbyWithPermissions, addr 0x3ad3138, size 0x5b4, virtual false, abstract: false, final false
  inline void SetupLobbyWithPermissions();

  /// @brief Method ShowBackButton, addr 0x3ad552c, size 0xc, virtual false, abstract: false, final false
  inline void ShowBackButton(bool show);

  /// @brief Method ShowDisconnectDialogAndFinish, addr 0x3ad4fe0, size 0x440, virtual false, abstract: false, final false
  inline void ShowDisconnectDialogAndFinish(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method ShowSideViewControllers, addr 0x3ad54c8, size 0x64, virtual false, abstract: false, final false
  inline void ShowSideViewControllers(bool showSideViewControllers, ::HMUI::__ViewController__AnimationType animationType);

  /// @brief Method TopViewControllerWillChange, addr 0x3ad5420, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method TransitionDidFinish, addr 0x3ad4a44, size 0x59c, virtual true, abstract: false, final false
  inline void TransitionDidFinish();

  /// @brief Method TransitionDidStart, addr 0x3ad4874, size 0x1d0, virtual true, abstract: false, final false
  inline void TransitionDidStart();

  /// @brief Method UpdateLocalPlayerIsActiveState, addr 0x3ad61c8, size 0x228, virtual false, abstract: false, final false
  inline void UpdateLocalPlayerIsActiveState(bool isActive);

  /// @brief Method <PresentBackButtonConfirmationDialog>b__69_0, addr 0x3ad8778, size 0x144, virtual false, abstract: false, final false
  inline void _PresentBackButtonConfirmationDialog_b__69_0(int32_t btnIndex);

  /// @brief Method <ShowDisconnectDialogAndFinish>b__105_0, addr 0x3ad88bc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ad86d0, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3ad1674, size 0xa0, virtual true, abstract: false, final false
  inline void add_didFinishEvent(::System::Action* value);

  /// @brief Method add_didOpenInvitePanelEvent, addr 0x3ad1a34, size 0xa0, virtual true, abstract: false, final false
  inline void add_didOpenInvitePanelEvent(::System::Action* value);

  /// @brief Method add_didSetupEvent, addr 0x3ad18f4, size 0xa0, virtual true, abstract: false, final false
  inline void add_didSetupEvent(::System::Action* value);

  /// @brief Method add_startGameOrReadyEvent, addr 0x3ad17b4, size 0xa0, virtual true, abstract: false, final false
  inline void add_startGameOrReadyEvent(::System::Action* value);

  /// @brief Method add_willFinishEvent, addr 0x3ad1534, size 0xa0, virtual true, abstract: false, final false
  inline void add_willFinishEvent(::System::Action* value);

  /// @brief Method get_isManaged, addr 0x3ad12f4, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isManaged();

  /// @brief Method get_isPartyOwner, addr 0x3ad1218, size 0x1c, virtual false, abstract: false, final false
  inline bool get_isPartyOwner();

  /// @brief Method get_isPublicGame, addr 0x3ad1234, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isPublicGame();

  /// @brief Method get_isQuickPlayServer, addr 0x3ad1474, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isQuickPlayServer();

  /// @brief Method get_isQuickStartServer, addr 0x3ad13b4, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isQuickStartServer();

  /// @brief Method get_rejoinQuickPlay, addr 0x3ad1b74, size 0x8, virtual false, abstract: false, final false
  inline bool get_rejoinQuickPlay();

  /// @brief Method remove_didFinishEvent, addr 0x3ad1714, size 0xa0, virtual true, abstract: false, final false
  inline void remove_didFinishEvent(::System::Action* value);

  /// @brief Method remove_didOpenInvitePanelEvent, addr 0x3ad1ad4, size 0xa0, virtual true, abstract: false, final false
  inline void remove_didOpenInvitePanelEvent(::System::Action* value);

  /// @brief Method remove_didSetupEvent, addr 0x3ad1994, size 0xa0, virtual true, abstract: false, final false
  inline void remove_didSetupEvent(::System::Action* value);

  /// @brief Method remove_startGameOrReadyEvent, addr 0x3ad1854, size 0xa0, virtual true, abstract: false, final false
  inline void remove_startGameOrReadyEvent(::System::Action* value);

  /// @brief Method remove_willFinishEvent, addr 0x3ad15d4, size 0xa0, virtual true, abstract: false, final false
  inline void remove_willFinishEvent(::System::Action* value);

  /// @brief Method set_rejoinQuickPlay, addr 0x3ad1b7c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _multiplayerLobbyController, offset: 0x100, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::MultiplayerLobbyController> ____multiplayerLobbyController;

  /// @brief Field _fadeInOutController, offset: 0x108, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::FadeInOutController> ____fadeInOutController;

  /// @brief Field _centerStageScreenController, offset: 0x110, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::CenterStageScreenController> ____centerStageScreenController;

  /// @brief Field _lobbyStateDataModel, offset: 0x118, size: 0x8, def value: None
  ::GlobalNamespace::ILobbyStateDataModel* ____lobbyStateDataModel;

  /// @brief Field _lobbyGameStateModel, offset: 0x120, size: 0x8, def value: None
  ::GlobalNamespace::LobbyGameStateModel* ____lobbyGameStateModel;

  /// @brief Field _lobbyPlayersDataModel, offset: 0x128, size: 0x8, def value: None
  ::GlobalNamespace::ILobbyPlayersDataModel* ____lobbyPlayersDataModel;

  /// @brief Field _lobbyGameStateController, offset: 0x130, size: 0x8, def value: None
  ::GlobalNamespace::ILobbyGameStateController* ____lobbyGameStateController;

  /// @brief Field _lobbyPlayerPermissionsModel, offset: 0x138, size: 0x8, def value: None
  ::GlobalNamespace::LobbyPlayerPermissionsModel* ____lobbyPlayerPermissionsModel;

  /// @brief Field _lobbySetupViewController, offset: 0x140, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::LobbySetupViewController> ____lobbySetupViewController;

  /// @brief Field _unifiedNetworkPlayerModel, offset: 0x148, size: 0x8, def value: None
  ::GlobalNamespace::IUnifiedNetworkPlayerModel* ____unifiedNetworkPlayerModel;

  /// @brief Field _screenModeController, offset: 0x150, size: 0x8, def value: None
  ::UnityW<::HMUI::ScreenModeController> ____screenModeController;

  /// @brief Field _playerDataModel, offset: 0x158, size: 0x8, def value: None
  ...
  /// @brief Field _songPreviewPlayer, offset: 0x168, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::SongPreviewPlayer> ____songPreviewPlayer;

  /// @brief Field _analyticsModel, offset: 0x170, size: 0x8, def value: None
  ::GlobalNamespace::IAnalyticsModel* ____analyticsModel;

  /// @brief Field _lastSimpleLevelSelectionFlowCoordinatorState, offset: 0x178, size: 0x8, def value: None
  ::GlobalNamespace::__LevelSelectionFlowCoordinator__State* ____lastSimpleLevelSelectionFlowCoordinatorState;

  /// @brief Field _isAlreadyFinishing, offset: 0x180, size: 0x1, def value: None
  bool ____isAlreadyFinishing;

  /// @brief Field _missingEntitlementsStringBuilder, offset: 0x188, size: 0x8, def value: None
  ::System::Text::StringBuilder* ____missingEntitlementsStringBuilder;

  /// @brief Field _playerIdsWithoutEntitlements, offset: 0x190, size: 0x8, def value: None
  ::System::Collections::Generic::List_1<::StringW>* ____playerIdsWithoutEntitlements;

  /// @brief Field _canStartGameCts, offset: 0x198, size: 0x8, def value: None
  ::System::Threading::CancellationTokenSource* ____canStartGameCts;

  /// @brief Field willFinishEvent, offset: 0x1a0, size: 0x8, def value: None
  ::System::Action* ___willFinishEvent;

  /// @brief Field didFinishEvent, offset: 0x1a8, size: 0x8, def value: None
  ::System::Action* ___didFinishEvent;

  /// @brief Field startGameOrReadyEvent, offset: 0x1b0, size: 0x8, def value: None
  ::System::Action* ___startGameOrReadyEvent;

  /// @brief Field didSetupEvent, offset: 0x1b8, size: 0x8, def value: None
  ::System::Action* ___didSetupEvent;

  /// @brief Field didOpenInvitePanelEvent, offset: 0x1c0, size: 0x8, def value: None
  ::System::Action* ___didOpenInvitePanelEvent;

  /// @brief Field <rejoinQuickPlay>k__BackingField, offset: 0x1c8, size: 0x1, def value: None
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::GameServerLobbyFlowCoordinator, 0x1d0>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____multiplayerLobbyController) == 0x100, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____fadeInOutController) == 0x108, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____centerStageScreenController) == 0x110, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____lobbyStateDataModel) == 0x118, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____lobbyGameStateModel) == 0x120, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____lobbyPlayersDataModel) == 0x128, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____lobbyGameStateController) == 0x130, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____lobbyPlayerPermissionsModel) == 0x138, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____lobbySetupViewController) == 0x140, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____unifiedNetworkPlayerModel) == 0x148, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____screenModeController) == 0x150, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____playerDataModel) == 0x158, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____platformLeaderboardsModel) == 0x160, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____songPreviewPlayer) == 0x168, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____analyticsModel) == 0x170, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____lastSimpleLevelSelectionFlowCoordinatorState) == 0x178, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____isAlreadyFinishing) == 0x180, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____missingEntitlementsStringBuilder) == 0x188, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____playerIdsWithoutEntitlements) == 0x190, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____canStartGameCts) == 0x198, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ___willFinishEvent) == 0x1a0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ___didFinishEvent) == 0x1a8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ___startGameOrReadyEvent) == 0x1b0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ___didSetupEvent) == 0x1b8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ___didOpenInvitePanelEvent) == 0x1c0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerLobbyFlowCoordinator, ____rejoinQuickPlay_k__BackingField) == 0x1c8, "Offset mismatch!");
