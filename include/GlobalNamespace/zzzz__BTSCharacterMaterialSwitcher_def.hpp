...
public:
  ...
  /// @brief Method .ctor, addr 0x3185058, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Renderer* renderer);

  /// @brief Method get_materialPairs, addr 0x3185050, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs*>* get_materialPairs();

  /// @brief Method get_renderer, addr 0x3185048, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x31850dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SwapMaterials, addr 0x3184df0, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3185044, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
