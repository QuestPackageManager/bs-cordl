...
public:
  ...
  /// @brief Method .ctor, addr 0x225ff9c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Renderer* renderer);

  /// @brief Method get_materialPairs, addr 0x225ff94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs*>* get_materialPairs();

  /// @brief Method get_renderer, addr 0x225ff8c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2260024, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SwapMaterials, addr 0x225fce0, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225ff84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
