...
public:
  ...
  /// @brief Method .ctor, addr 0x31b4e84, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Renderer* renderer);

  /// @brief Method get_materialPairs, addr 0x31b4e7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs*>* get_materialPairs();

  /// @brief Method get_renderer, addr 0x31b4e74, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x31b4f08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SwapMaterials, addr 0x31b4c1c, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31b4e70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
