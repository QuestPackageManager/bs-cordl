...
/// @brief Field _materialPairs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__materialPairs, put=__cordl_internal_set__materialPairs)) ::System::Collections::Generic::List_1<::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs*>*  _materialPairs;
...
/// @brief Method .ctor, addr 0x31b4dd4, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Renderer*  renderer) ;

/// @brief Method get_materialPairs, addr 0x31b4dcc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::GlobalNamespace::BTSCharacterMaterialSwitcher_MaterialPairs*>* get_materialPairs() ;

/// @brief Method get_renderer, addr 0x31b4dc4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _rendererMaterialsPairs, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__rendererMaterialsPairs, put=__cordl_internal_set__rendererMaterialsPairs)) ::ArrayW<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*,::Array<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*>*>  _rendererMaterialsPairs;

static inline ::GlobalNamespace::BTSCharacterMaterialSwitcher* New_ctor() ;

/// @brief Method SwapMaterials, addr 0x31b4b6c, size 0x214, virtual false, abstract: false, final false
inline void SwapMaterials(bool  alternative) ;

constexpr ::ArrayW<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*,::Array<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*>*> const& __cordl_internal_get__rendererMaterialsPairs() const;

constexpr ::ArrayW<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*,::Array<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*>*>& __cordl_internal_get__rendererMaterialsPairs() ;

constexpr void __cordl_internal_set__rendererMaterialsPairs(::ArrayW<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*,::Array<::GlobalNamespace::BTSCharacterMaterialSwitcher_RendererMaterialsPairs*>*>  value) ;

/// @brief Method .ctor, addr 0x31b4dc0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
