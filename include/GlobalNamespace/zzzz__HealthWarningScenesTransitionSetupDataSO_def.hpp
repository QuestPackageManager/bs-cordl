...
public:
  // Declarations
  /// @brief Method Init, addr 0x3b3e3a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b41c94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
