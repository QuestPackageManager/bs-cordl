...
public:
  // Declarations
  /// @brief Method Init, addr 0x259e7d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25a1884, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
