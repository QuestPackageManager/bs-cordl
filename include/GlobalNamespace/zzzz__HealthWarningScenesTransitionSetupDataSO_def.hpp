...
public:
  // Declarations
  /// @brief Method Init, addr 0x25a67d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25a9880, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
