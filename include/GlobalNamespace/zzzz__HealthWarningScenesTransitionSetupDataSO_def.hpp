...
public:
  // Declarations
  /// @brief Method Init, addr 0x231b0e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231dd3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
