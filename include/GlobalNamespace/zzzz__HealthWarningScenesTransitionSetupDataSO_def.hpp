...
public:
  // Declarations
  /// @brief Method Init, addr 0x57ee17c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ee240, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
