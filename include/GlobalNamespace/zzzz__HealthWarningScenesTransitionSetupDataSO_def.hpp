...
public:
  // Declarations
  /// @brief Method Init, addr 0x577d7cc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x577d890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO, 0x28>, "Size mismatch!");
