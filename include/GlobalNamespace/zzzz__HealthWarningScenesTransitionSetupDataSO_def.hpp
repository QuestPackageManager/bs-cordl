...
public:
  // Declarations
  /// @brief Method Init, addr 0x247a38c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x247d394, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
