...
public:
  ...
  /// @brief Method OpenDataPrivacyPage, addr 0x3255fb0, size 0x4, virtual true, abstract: false, final true
  inline void OpenDataPrivacyPage();

  /// @brief Method .ctor, addr 0x3255fcc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_supportsOpenDataPrivacyPage, addr 0x3255fa8, size 0x8, virtual true, abstract: false, final true
