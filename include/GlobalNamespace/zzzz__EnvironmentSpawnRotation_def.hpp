...
public:
  ...
  /// @brief Method get_targetRotation, addr 0x2372d4c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_targetRotation();

  /// @brief Method OnEnable, addr 0x2372d54, size 0x60, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnDisable, addr 0x2372db4, size 0x60, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Start, addr 0x2372e14, size 0x164, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnDestroy, addr 0x2372f78, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleSpawnRotationBeatmapEvent, addr 0x2372f94, size 0x104, virtual false, abstract: false, final false
  inline void HandleSpawnRotationBeatmapEvent(::GlobalNamespace::SpawnRotationBeatmapEventData* beatmapEventData);

  /// @brief Method FixedUpdate, addr 0x2373098, size 0x90, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method LateUpdate, addr 0x2373128, size 0x128, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::EnvironmentSpawnRotation* New_ctor();

  /// @brief Method .ctor, addr 0x2373250, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
