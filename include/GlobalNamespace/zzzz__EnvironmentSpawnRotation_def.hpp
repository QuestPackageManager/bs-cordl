...
public:
  ...
  /// @brief Method get_targetRotation addr 0x23b3c0c size 0x8 virtual false final false
  inline float_t get_targetRotation();

  /// @brief Method OnEnable addr 0x23b3c14 size 0x60 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x23b3c74 size 0x60 virtual false final false
  inline void OnDisable();

  /// @brief Method Start addr 0x23b3cd4 size 0x164 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x23b3e38 size 0x1c virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleSpawnRotationBeatmapEvent addr 0x23b3e54 size 0x104 virtual false final false
  inline void HandleSpawnRotationBeatmapEvent(::GlobalNamespace::SpawnRotationBeatmapEventData* beatmapEventData);

  /// @brief Method FixedUpdate addr 0x23b3f58 size 0x90 virtual false final false
  inline void FixedUpdate();

  /// @brief Method LateUpdate addr 0x23b3fe8 size 0x128 virtual false final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::EnvironmentSpawnRotation* New_ctor();

  /// @brief Method .ctor addr 0x23b4110 size 0x8 virtual false final false
  inline void _ctor();
