...
public:
  ...
  /// @brief Method get_targetRotation addr 0x227adf4 size 0x8 virtual false final false
  inline float_t get_targetRotation();

  /// @brief Method OnEnable addr 0x227adfc size 0x60 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x227ae5c size 0x60 virtual false final false
  inline void OnDisable();

  /// @brief Method Start addr 0x227aebc size 0x164 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x227b020 size 0x1c virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleSpawnRotationBeatmapEvent addr 0x227b03c size 0x104 virtual false final false
  inline void HandleSpawnRotationBeatmapEvent(::GlobalNamespace::SpawnRotationBeatmapEventData* beatmapEventData);

  /// @brief Method FixedUpdate addr 0x227b140 size 0x90 virtual false final false
  inline void FixedUpdate();

  /// @brief Method LateUpdate addr 0x227b1d0 size 0x128 virtual false final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::EnvironmentSpawnRotation* New_ctor();

  /// @brief Method .ctor addr 0x227b2f8 size 0x8 virtual false final false
  inline void _ctor();
