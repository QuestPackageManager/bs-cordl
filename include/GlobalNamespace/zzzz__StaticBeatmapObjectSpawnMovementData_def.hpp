...
// Write type traits
MARK_REF_T(::GlobalNamespace::StaticBeatmapObjectSpawnMovementData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StaticBeatmapObjectSpawnMovementData*, "", "StaticBeatmapObjectSpawnMovementData");
...
public:
  // Declarations
  /// @brief Method Get2DNoteOffset, addr 0x32614c8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method LineYPosForLineLayer, addr 0x3261774, size 0x1c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StaticBeatmapObjectSpawnMovementData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StaticBeatmapObjectSpawnMovementData(StaticBeatmapObjectSpawnMovementData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StaticBeatmapObjectSpawnMovementData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StaticBeatmapObjectSpawnMovementData(StaticBeatmapObjectSpawnMovementDataconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::StaticBeatmapObjectSpawnMovementData) == 0x10, "Size mismatch!");
