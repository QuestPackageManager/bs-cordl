...
public:
  // Declarations
  /// @brief Method Get2DNoteOffset, addr 0x3169f9c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method LineYPosForLineLayer, addr 0x316a248, size 0x1c, virtual false, abstract: false, final false
