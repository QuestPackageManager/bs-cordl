...
public:
  ...
  /// @brief Method .ctor, addr 0x58e2e84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_reflectionProbeCubemap1, addr 0x58e2e64, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Cubemap> get_reflectionProbeCubemap1();

  /// @brief Method get_reflectionProbeCubemap2, addr 0x58e2e74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Cubemap> get_reflectionProbeCubemap2();

  /// @brief Method set_reflectionProbeCubemap1, addr 0x58e2e6c, size 0x8, virtual false, abstract: false, final false
  inline void set_reflectionProbeCubemap1(::UnityEngine::Cubemap* value);

  /// @brief Method set_reflectionProbeCubemap2, addr 0x58e2e7c, size 0x8, virtual false, abstract: false, final false
