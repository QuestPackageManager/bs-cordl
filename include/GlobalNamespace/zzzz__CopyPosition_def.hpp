...
public:
  ...
  /// @brief Method Add, addr 0x39c19fc, size 0x1dc, virtual false, abstract: false, final false
  static inline void Add(::GlobalNamespace::CopyPosition* copyPosition);

  /// @brief Method LateUpdate, addr 0x39c1be0, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39c1d8c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x39c19f8, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::CopyPosition* New_ctor();

  /// @brief Method Refresh, addr 0x39c19b8, size 0x40, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x39c1bd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
