...
public:
  ...
  /// @brief Method Add, addr 0x570ea8c, size 0x210, virtual false, abstract: false, final false
  static inline void Add(::GlobalNamespace::CopyPosition* copyPosition);

  /// @brief Method LateUpdate, addr 0x570eca0, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x570ee60, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x570ea88, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::CopyPosition* New_ctor();

  /// @brief Method Refresh, addr 0x570ea48, size 0x40, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x570ec9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
