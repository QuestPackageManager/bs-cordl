...
public:
  ...
  /// @brief Method LateUpdate, addr 0x39c265c, size 0x1ac, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x39c2474, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::CopyPosition* New_ctor();

  /// @brief Method Refresh, addr 0x39c2434, size 0x40, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x39c2654, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
