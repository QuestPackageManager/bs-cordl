...
public:
  ...
  /// @brief Method DidActivate, addr 0x2438d60, size 0x1dc, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method Init, addr 0x2438f3c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method <DidActivate>b__11_0, addr 0x2438f58, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__11_0();

  /// @brief Method <DidActivate>b__11_1, addr 0x2438f78, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2438f50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x2438c00, size 0xb0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::__PrivacyPolicyViewController__ButtonType>* value);

  /// @brief Method remove_didFinishEvent, addr 0x2438cb0, size 0xb0, virtual false, abstract: false, final false
