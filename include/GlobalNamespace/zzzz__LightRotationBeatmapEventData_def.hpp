...
// TypeDefinitionIndex(TypeDefinitionIndex(14951))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14950)) CS Name: ::LightRotationBeatmapEventData*
...
public:
  ...
  /// @brief Method get_rotation addr 0xd99128 size 0x8 virtual false final false
  inline float_t get_rotation();

  /// @brief Method set_rotation addr 0xd99130 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xd99138 size 0xe4 virtual false final false
  ...
  /// @brief Method ChangeRotation addr 0xd99234 size 0x8 virtual false final false
  inline void ChangeRotation(float_t rotation);

  /// @brief Method GetCopy addr 0xd9923c size 0xc4 virtual true final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method SubtypeIdentifier addr 0xd9921c size 0x18 virtual false final false
  static inline int32_t SubtypeIdentifier(int32_t groupId, int32_t elementId, ::GlobalNamespace::LightAxis axis);

  /// @brief Method GetDefault addr 0xd99300 size 0x164 virtual true final false
