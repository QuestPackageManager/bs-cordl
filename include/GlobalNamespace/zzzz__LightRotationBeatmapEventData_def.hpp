...
public:
  ...
  /// @brief Method ChangeRotation, addr 0x223ffb0, size 0x8, virtual false, abstract: false, final false
  inline void ChangeRotation(float_t rotation);

  /// @brief Method GetCopy, addr 0x223ffb8, size 0xb8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x2240070, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0x223ff98, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x223feb0, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_axis, addr 0x223fe70, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightAxis get_axis();

  /// @brief Method get_easeType, addr 0x223fe60, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EaseType get_easeType();

  /// @brief Method get_elementId, addr 0x223fe3c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_elementId();

  /// @brief Method get_groupId, addr 0x223fe2c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_groupId();

  /// @brief Method get_loopCount, addr 0x223fe80, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_loopCount();

  /// @brief Method get_rotation, addr 0x223fea0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_rotation();

  /// @brief Method get_rotationDirection, addr 0x223fe90, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightRotationDirection get_rotationDirection();

  /// @brief Method get_usePreviousEventValue, addr 0x223fe4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_axis, addr 0x223fe78, size 0x8, virtual false, abstract: false, final false
  inline void set_axis(::GlobalNamespace::LightAxis value);

  /// @brief Method set_easeType, addr 0x223fe68, size 0x8, virtual false, abstract: false, final false
  inline void set_easeType(::GlobalNamespace::EaseType value);

  /// @brief Method set_elementId, addr 0x223fe44, size 0x8, virtual false, abstract: false, final false
  inline void set_elementId(int32_t value);

  /// @brief Method set_groupId, addr 0x223fe34, size 0x8, virtual false, abstract: false, final false
  inline void set_groupId(int32_t value);

  /// @brief Method set_loopCount, addr 0x223fe88, size 0x8, virtual false, abstract: false, final false
  inline void set_loopCount(int32_t value);

  /// @brief Method set_rotation, addr 0x223fea8, size 0x8, virtual false, abstract: false, final false
  inline void set_rotation(float_t value);

  /// @brief Method set_rotationDirection, addr 0x223fe98, size 0x8, virtual false, abstract: false, final false
  inline void set_rotationDirection(::GlobalNamespace::LightRotationDirection value);

  /// @brief Method set_usePreviousEventValue, addr 0x223fe54, size 0xc, virtual false, abstract: false, final false
