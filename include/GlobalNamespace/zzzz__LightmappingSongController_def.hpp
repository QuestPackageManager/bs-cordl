...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightmappingSongController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightmappingSongController*, "", "LightmappingSongController");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightmappingSongController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightmappingSongController(LightmappingSongController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightmappingSongController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightmappingSongController(LightmappingSongControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LightmappingSongController) == 0x30, "Size mismatch!");
