...
public:
  ...
  /// @brief Method PauseSong, addr 0x3b74ae0, size 0x4, virtual true, abstract: false, final false
  inline void PauseSong();

  /// @brief Method ResumeSong, addr 0x3b74ae4, size 0x4, virtual true, abstract: false, final false
  inline void ResumeSong();

  /// @brief Method StopSong, addr 0x3b74adc, size 0x4, virtual true, abstract: false, final false
  inline void StopSong();

  /// @brief Method .ctor, addr 0x3b74ae8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
