...
public:
  ...
  /// @brief Method PauseSong, addr 0x58be7c4, size 0x4, virtual true, abstract: false, final false
  inline void PauseSong();

  /// @brief Method ResumeSong, addr 0x58be7c8, size 0x4, virtual true, abstract: false, final false
  inline void ResumeSong();

  /// @brief Method StopSong, addr 0x58be7c0, size 0x4, virtual true, abstract: false, final false
  inline void StopSong();

  /// @brief Method .ctor, addr 0x58be7cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
