...
// Write type traits
MARK_REF_T(::GlobalNamespace::ILevelEndActions*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ILevelEndActions*, "", "ILevelEndActions");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ILevelEndActions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ILevelEndActions(ILevelEndActionsconst&) = delete;
