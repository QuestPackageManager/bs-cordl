...
public:
  ...
  /// @brief Method MoveNext, addr 0x26121b8, size 0x3cc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2612584, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x261258c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x26125cc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x26121b4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2612094, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BindPlayerFactories, addr 0x2611d6c, size 0x238, virtual false, abstract: false, final false
  inline void BindPlayerFactories(::GlobalNamespace::MultiplayerPlayerLayout layout);

  /// @brief Method HandlePlayerDidFinish, addr 0x26120bc, size 0x1c, virtual false, abstract: false, final false
  inline void HandlePlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method HandlePlayerNetworkDidFailed, addr 0x26120d8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReportLocalPlayerNetworkDidFailed, addr 0x2601a68, size 0x1c, virtual false, abstract: false, final false
  inline void ReportLocalPlayerNetworkDidFailed(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method SpawnPlayers, addr 0x260408c, size 0x948, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchLocalPlayerToInactive, addr 0x261200c, size 0x20, virtual false, abstract: false, final false
  inline void SwitchLocalPlayerToInactive();

  /// @brief Method SwitchLocalPlayerToInactiveCoroutine, addr 0x261202c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* SwitchLocalPlayerToInactiveCoroutine();

  /// @brief Method TryGetConnectedCenterFacingRotation, addr 0x2611fa4, size 0x68, virtual false, abstract: false, final false
  inline bool TryGetConnectedCenterFacingRotation(::StringW userId, ByRef<float_t> centerFacingRotation);

  /// @brief Method TryGetConnectedPlayerController, addr 0x2603364, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26120f4, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSwitchPlayerToInactiveEvent, addr 0x26049d4, size 0x9c, virtual false, abstract: false, final false
  inline void add_didSwitchPlayerToInactiveEvent(::System::Action* value);

  /// @brief Method add_playerDidFinishEvent, addr 0x2611aac, size 0xb0, virtual true, abstract: false, final true
  inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method add_playerNetworkDidFailedEvent, addr 0x2611c0c, size 0xb0, virtual true, abstract: false, final true
  inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method add_playerSpawningDidFinishEvent, addr 0x260f17c, size 0x9c, virtual false, abstract: false, final false
  inline void add_playerSpawningDidFinishEvent(::System::Action* value);

  /// @brief Method get_activeLocalPlayerFacade, addr 0x2611a9c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MultiplayerLocalActivePlayerFacade> get_activeLocalPlayerFacade();

  /// @brief Method get_allActiveAtGameStartPlayers, addr 0x2611a8c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IConnectedPlayer*>* get_allActiveAtGameStartPlayers();

  /// @brief Method get_inactivePlayerFacade, addr 0x2611aa4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MultiplayerLocalInactivePlayerFacade> get_inactivePlayerFacade();

  /// @brief Method get_localPlayerStartSeekSongController, addr 0x2611a94, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IStartSeekSongControllerProvider* get_localPlayerStartSeekSongController();

  /// @brief Method get_localPlayerTransform, addr 0x260e068, size 0x80, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_localPlayerTransform();

  /// @brief Method get_playerSpawningFinished, addr 0x2611a78, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSwitchPlayerToInactiveEvent, addr 0x26011f8, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didSwitchPlayerToInactiveEvent(::System::Action* value);

  /// @brief Method remove_playerDidFinishEvent, addr 0x2611b5c, size 0xb0, virtual true, abstract: false, final true
  inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method remove_playerNetworkDidFailedEvent, addr 0x2611cbc, size 0xb0, virtual true, abstract: false, final true
  inline void remove_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method remove_playerSpawningDidFinishEvent, addr 0x260fa8c, size 0x9c, virtual false, abstract: false, final false
  inline void remove_playerSpawningDidFinishEvent(::System::Action* value);

  /// @brief Method set_playerSpawningFinished, addr 0x2611a80, size 0xc, virtual false, abstract: false, final false
