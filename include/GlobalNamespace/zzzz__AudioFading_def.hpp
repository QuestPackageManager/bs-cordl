...
public:
  ...
  /// @brief Method FadeIn, addr 0x58b69fc, size 0x24, virtual false, abstract: false, final false
  inline void FadeIn();

  /// @brief Method FadeOut, addr 0x58b6b0c, size 0x20, virtual false, abstract: false, final false
  inline void FadeOut();

  static inline ::GlobalNamespace::AudioFading* New_ctor();

  /// @brief Method Start, addr 0x58b69a0, size 0x5c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58b6a20, size 0xec, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58b6b2c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
