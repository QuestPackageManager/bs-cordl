...
public:
  ...
  /// @brief Method AgreeToEndOfLifeNotice, addr 0x26f6560, size 0xc, virtual false, abstract: false, final false
  inline void AgreeToEndOfLifeNotice();

  /// @brief Method AgreeToEula, addr 0x26f6518, size 0x24, virtual false, abstract: false, final false
  inline void AgreeToEula();

  /// @brief Method AgreeToHealthAndSafety, addr 0x26f6548, size 0xc, virtual false, abstract: false, final false
  inline void AgreeToHealthAndSafety();

  /// @brief Method AgreeToPlayerSensitivityFlag, addr 0x26f6554, size 0xc, virtual false, abstract: false, final false
  inline void AgreeToPlayerSensitivityFlag();

  /// @brief Method AgreeToPrivacyPolicy, addr 0x26f653c, size 0xc, virtual false, abstract: false, final false
  inline void AgreeToPrivacyPolicy();

  /// @brief Method AgreedToAnyPreviousEula, addr 0x26f657c, size 0x1c, virtual false, abstract: false, final false
  inline bool AgreedToAnyPreviousEula();

  /// @brief Method AgreedToAnyPreviousHealthAndSafety, addr 0x26f65b4, size 0xc, virtual false, abstract: false, final false
  inline bool AgreedToAnyPreviousHealthAndSafety();

  /// @brief Method AgreedToAnyPreviousPlayerSensitivityFlag, addr 0x26f65c0, size 0x1c, virtual false, abstract: false, final false
  inline bool AgreedToAnyPreviousPlayerSensitivityFlag();

  /// @brief Method AgreedToAnyPreviousPrivacyPolicy, addr 0x26f6598, size 0x1c, virtual false, abstract: false, final false
  inline bool AgreedToAnyPreviousPrivacyPolicy();

  /// @brief Method AgreedToEndOfLifeNotice, addr 0x26f661c, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToEndOfLifeNotice();

  /// @brief Method AgreedToEula, addr 0x26f65dc, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToEula();

  /// @brief Method AgreedToHealthAndSafety, addr 0x26f65fc, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToHealthAndSafety();

  /// @brief Method AgreedToPlayerSenstivityFlag, addr 0x26f660c, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToPlayerSenstivityFlag();

  /// @brief Method AgreedToPreviousPrivacyPolicy, addr 0x26f656c, size 0x10, virtual false, abstract: false, final false
  inline bool AgreedToPreviousPrivacyPolicy();

  /// @brief Method AgreedToPrivacyPolicy, addr 0x26f65ec, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f64a8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26f64c8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method add_agreedToEulaEvent, addr 0x26f6370, size 0x9c, virtual false, abstract: false, final false
  inline void add_agreedToEulaEvent(::System::Action* value);

  /// @brief Method remove_agreedToEulaEvent, addr 0x26f640c, size 0x9c, virtual false, abstract: false, final false
