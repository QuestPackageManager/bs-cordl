...
public:
  ...
  /// @brief Method SetDataToShaders, addr 0x5727d90, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5727ebc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bakeId, addr 0x5727e94, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightConstants_BakeId get_bakeId();

  /// @brief Method get_intensity, addr 0x5727e9c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method get_weight, addr 0x5727eac, size 0x8, virtual false, abstract: false, final false
  inline float_t get_weight();

  /// @brief Method set_intensity, addr 0x5727ea4, size 0x8, virtual false, abstract: false, final false
  inline void set_intensity(float_t value);

  /// @brief Method set_weight, addr 0x5727eb4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLightWithIds, addr 0x5727e80, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNewColorData, addr 0x5727b08, size 0x288, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5727e88, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxTotalIntensity, addr 0x5727af8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxTotalIntensity();

  /// @brief Method set_maxTotalIntensity, addr 0x5727b00, size 0x8, virtual false, abstract: false, final false
