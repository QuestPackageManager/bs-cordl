...
public:
  ...
  /// @brief Method SetDataToShaders, addr 0x39e29b8, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e2aec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bakeId, addr 0x39e2ac4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightConstants_BakeId get_bakeId();

  /// @brief Method get_intensity, addr 0x39e2acc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method get_weight, addr 0x39e2adc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_weight();

  /// @brief Method set_intensity, addr 0x39e2ad4, size 0x8, virtual false, abstract: false, final false
  inline void set_intensity(float_t value);

  /// @brief Method set_weight, addr 0x39e2ae4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLightWithIds, addr 0x39e2aac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNewColorData, addr 0x39e27b8, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e2ab4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxTotalIntensity, addr 0x39e27a8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxTotalIntensity();

  /// @brief Method set_maxTotalIntensity, addr 0x39e27b0, size 0x8, virtual false, abstract: false, final false
