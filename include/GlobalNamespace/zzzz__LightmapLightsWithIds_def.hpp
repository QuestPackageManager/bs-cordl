...
/// @brief Method SetDataToShaders, addr 0x56b9ea4, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b9fd0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakeId, addr 0x56b9fa8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::LightConstants_BakeId get_bakeId() ;

/// @brief Method get_intensity, addr 0x56b9fb0, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_weight, addr 0x56b9fc0, size 0x8, virtual false, abstract: false, final false
inline float_t get_weight() ;

/// @brief Method set_intensity, addr 0x56b9fb8, size 0x8, virtual false, abstract: false, final false
inline void set_intensity(float_t  value) ;

/// @brief Method set_weight, addr 0x56b9fc8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _lightIntensityData, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightIntensityData, put=__cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::LightmapLightsWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::LightmapLightsWithIds_LightIntensitiesWithId*>*>  _lightIntensityData;
...
/// @brief Method GetLightWithIds, addr 0x56b9f94, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessNewColorData, addr 0x56b9c1c, size 0x288, virtual true, abstract: false, final false
inline void ProcessNewColorData() ;

constexpr ::ArrayW<::GlobalNamespace::LightmapLightsWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::LightmapLightsWithIds_LightIntensitiesWithId*>*> const& __cordl_internal_get__lightIntensityData() const;

constexpr ::ArrayW<::GlobalNamespace::LightmapLightsWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::LightmapLightsWithIds_LightIntensitiesWithId*>*>& __cordl_internal_get__lightIntensityData() ;
...
constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::LightmapLightsWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::LightmapLightsWithIds_LightIntensitiesWithId*>*>  value) ;

constexpr void __cordl_internal_set__maxTotalIntensity(float_t  value) ;

/// @brief Method .ctor, addr 0x56b9f9c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_maxTotalIntensity, addr 0x56b9c0c, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxTotalIntensity() ;

/// @brief Method set_maxTotalIntensity, addr 0x56b9c14, size 0x8, virtual false, abstract: false, final false
