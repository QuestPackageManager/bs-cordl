...
public:
  ...
  /// @brief Method SetDataToShaders, addr 0x39e76a8, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e77dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bakeId, addr 0x39e77b4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightConstants_BakeId get_bakeId();

  /// @brief Method get_intensity, addr 0x39e77bc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method get_weight, addr 0x39e77cc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_weight();

  /// @brief Method set_intensity, addr 0x39e77c4, size 0x8, virtual false, abstract: false, final false
  inline void set_intensity(float_t value);

  /// @brief Method set_weight, addr 0x39e77d4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLightWithIds, addr 0x39e779c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNewColorData, addr 0x39e74a8, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e77a4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxTotalIntensity, addr 0x39e7498, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxTotalIntensity();

  /// @brief Method set_maxTotalIntensity, addr 0x39e74a0, size 0x8, virtual false, abstract: false, final false
