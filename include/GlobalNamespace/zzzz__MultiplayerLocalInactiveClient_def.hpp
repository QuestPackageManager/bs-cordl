...
public:
  ...
  /// @brief Method LateUpdate, addr 0x3bc511c, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bc5464, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
