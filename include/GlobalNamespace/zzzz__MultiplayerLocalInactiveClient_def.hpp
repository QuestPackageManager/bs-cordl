...
public:
  ...
  /// @brief Method LateUpdate, addr 0x59c1704, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59c1a14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
