...
public:
  ...
  /// @brief Method LateUpdate, addr 0x25f714c, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f7494, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
