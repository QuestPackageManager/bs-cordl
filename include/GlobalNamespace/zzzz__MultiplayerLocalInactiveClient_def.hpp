...
public:
  ...
  /// @brief Method LateUpdate, addr 0x24d1c58, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24d1fa0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
