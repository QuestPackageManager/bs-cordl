...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalInactiveClient*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalInactiveClient*, "", "MultiplayerLocalInactiveClient");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerLocalInactiveClient", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerLocalInactiveClient(MultiplayerLocalInactiveClient&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerLocalInactiveClient", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerLocalInactiveClient(MultiplayerLocalInactiveClientconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalInactiveClient) == 0x30, "Size mismatch!");
