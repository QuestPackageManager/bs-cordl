...
public:
  ...
  /// @brief Method .ctor, addr 0x321ee40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x321ee3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x321ee38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localServerPort, addr 0x321ee08, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_localServerPort();

  /// @brief Method get_maintenanceEndTime, addr 0x321edc8, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_maintenanceEndTime();

  /// @brief Method get_maintenanceStartTime, addr 0x321edb8, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_maintenanceStartTime();

  /// @brief Method get_minimumAppVersion, addr 0x321eda8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_minimumAppVersion();

  /// @brief Method get_useGameLiftUdpPingBeacons, addr 0x321ee28, size 0x8, virtual false, abstract: false, final false
  inline bool get_useGameLiftUdpPingBeacons();

  /// @brief Method get_useGamelift, addr 0x321ede8, size 0x8, virtual false, abstract: false, final false
  inline bool get_useGamelift();

  /// @brief Method get_useLocalServer, addr 0x321edf8, size 0x8, virtual false, abstract: false, final false
  inline bool get_useLocalServer();

  /// @brief Method get_useXPlatformAuth, addr 0x321ee18, size 0x8, virtual false, abstract: false, final false
  inline bool get_useXPlatformAuth();

  /// @brief Method get_userMessage, addr 0x321edd8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerStatusData_UserMessage* get_userMessage();

  /// @brief Method set_localServerPort, addr 0x321ee10, size 0x8, virtual false, abstract: false, final false
  inline void set_localServerPort(int32_t value);

  /// @brief Method set_maintenanceEndTime, addr 0x321edd0, size 0x8, virtual false, abstract: false, final false
  inline void set_maintenanceEndTime(int64_t value);

  /// @brief Method set_maintenanceStartTime, addr 0x321edc0, size 0x8, virtual false, abstract: false, final false
  inline void set_maintenanceStartTime(int64_t value);

  /// @brief Method set_minimumAppVersion, addr 0x321edb0, size 0x8, virtual false, abstract: false, final false
  inline void set_minimumAppVersion(::StringW value);

  /// @brief Method set_useGameLiftUdpPingBeacons, addr 0x321ee30, size 0x8, virtual false, abstract: false, final false
  inline void set_useGameLiftUdpPingBeacons(bool value);

  /// @brief Method set_useGamelift, addr 0x321edf0, size 0x8, virtual false, abstract: false, final false
  inline void set_useGamelift(bool value);

  /// @brief Method set_useLocalServer, addr 0x321ee00, size 0x8, virtual false, abstract: false, final false
  inline void set_useLocalServer(bool value);

  /// @brief Method set_useXPlatformAuth, addr 0x321ee20, size 0x8, virtual false, abstract: false, final false
  inline void set_useXPlatformAuth(bool value);

  /// @brief Method set_userMessage, addr 0x321ede0, size 0x8, virtual false, abstract: false, final false
