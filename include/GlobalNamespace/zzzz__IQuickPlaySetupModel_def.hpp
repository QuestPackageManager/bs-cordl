...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IQuickPlaySetupModel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IQuickPlaySetupModel(IQuickPlaySetupModelconst&) = delete;
