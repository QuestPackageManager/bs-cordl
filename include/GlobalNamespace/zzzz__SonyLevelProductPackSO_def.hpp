...
public:
  ...
  /// @brief Method .ctor, addr 0x26e7bd4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelPackProductData, addr 0x26e9ad0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SonyLevelProductCollectionModel_LevelPackProductData* get_levelPackProductData();

  /// @brief Method get_levelPackRedirectionData, addr 0x26e9ae0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_levelPackProductData, addr 0x26e9ad8, size 0x8, virtual false, abstract: false, final false
  inline void set_levelPackProductData(::GlobalNamespace::SonyLevelProductCollectionModel_LevelPackProductData* value);

  /// @brief Method set_levelPackRedirectionData, addr 0x26e9ae8, size 0x5c, virtual false, abstract: false, final false
