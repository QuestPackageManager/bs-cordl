...
public:
// Declarations
/// @brief Method .ctor, addr 0x31b2cdc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _yJumpOffsetBuffer, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__yJumpOffsetBuffer, put=__cordl_internal_set__yJumpOffsetBuffer)) ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData,::Array<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>*>  _yJumpOffsetBuffer;

/// @brief Method GetJumpOffsetYAtJumpStartSongTime, addr 0x31b2e5c, size 0x304, virtual false, abstract: false, final false
inline float_t GetJumpOffsetYAtJumpStartSongTime(float_t  lastDeltaTime) ;

/// @brief Method ManualUpdate, addr 0x31b2ce4, size 0x178, virtual false, abstract: false, final false
inline void ManualUpdate() ;

static inline ::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator* New_ctor(::GlobalNamespace::IAudioTimeSource*  audioTimeSource, ::GlobalNamespace::IJumpOffsetYProvider*  jumpOffsetYProvider, ::GlobalNamespace::IVariableMovementDataProvider*  variableMovementDataProvider, float_t  moveToPlayerHeadTParam) ;
...
constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData,::Array<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>*> const& __cordl_internal_get__yJumpOffsetBuffer() const;

constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData,::Array<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>*>& __cordl_internal_get__yJumpOffsetBuffer() ;
...
constexpr void __cordl_internal_set__yJumpOffsetBuffer(::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData,::Array<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>*>  value) ;

/// @brief Method .ctor, addr 0x31b2b20, size 0x1bc, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IAudioTimeSource*  audioTimeSource, ::GlobalNamespace::IJumpOffsetYProvider*  jumpOffsetYProvider, ::GlobalNamespace::IVariableMovementDataProvider*  variableMovementDataProvider, float_t  moveToPlayerHeadTParam) ;
