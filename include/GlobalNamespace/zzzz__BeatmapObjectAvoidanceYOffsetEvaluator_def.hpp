...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x31e97e4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetJumpOffsetYAtJumpStartSongTime, addr 0x31e9964, size 0x304, virtual false, abstract: false, final false
  inline float_t GetJumpOffsetYAtJumpStartSongTime(float_t lastDeltaTime);

  /// @brief Method ManualUpdate, addr 0x31e97ec, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31e9628, size 0x1bc, virtual false, abstract: false, final false
