...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x226069c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetJumpOffsetYAtJumpStartSongTime, addr 0x2260818, size 0x314, virtual false, abstract: false, final false
  inline float_t GetJumpOffsetYAtJumpStartSongTime(float_t lastDeltaTime);

  /// @brief Method ManualUpdate, addr 0x22606a4, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22604e0, size 0x1bc, virtual false, abstract: false, final false
