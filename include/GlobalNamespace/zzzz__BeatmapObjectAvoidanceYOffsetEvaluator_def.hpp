...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x10511d8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetJumpOffsetYAtJumpStartSongTime, addr 0x1051358, size 0x310, virtual false, abstract: false, final false
  inline float_t GetJumpOffsetYAtJumpStartSongTime(float_t lastDeltaTime);

  /// @brief Method ManualUpdate, addr 0x10511e0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1051084, size 0x154, virtual false, abstract: false, final false
