...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x32816dc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetJumpOffsetYAtJumpStartSongTime, addr 0x328185c, size 0x304, virtual false, abstract: false, final false
  inline float_t GetJumpOffsetYAtJumpStartSongTime(float_t lastDeltaTime);

  /// @brief Method ManualUpdate, addr 0x32816e4, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3281520, size 0x1bc, virtual false, abstract: false, final false
