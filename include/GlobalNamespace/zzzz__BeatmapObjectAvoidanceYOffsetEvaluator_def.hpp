...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x31b2d8c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetJumpOffsetYAtJumpStartSongTime, addr 0x31b2f0c, size 0x304, virtual false, abstract: false, final false
  inline float_t GetJumpOffsetYAtJumpStartSongTime(float_t lastDeltaTime);

  /// @brief Method ManualUpdate, addr 0x31b2d94, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31b2bd0, size 0x1bc, virtual false, abstract: false, final false
