...
public:
  ...
  /// @brief Method .ctor, addr 0x565c0bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t intensity);

  /// @brief Method get_intensity, addr 0x565c0ac, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x565c0b4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x565bda8, size 0x1b0, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method GetLightWithIds, addr 0x565c0a4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessColor, addr 0x565c084, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Color ProcessColor(::UnityEngine::Color color, float_t intensity);

  /// @brief Method ProcessNewColorData, addr 0x565bf58, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5658ab0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
