...
public:
  ...
  /// @brief Method .ctor, addr 0x39e4858, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t intensity);

  /// @brief Method get_intensity, addr 0x39e49fc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x39e4a04, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x39e4694, size 0x1c4, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method GetLightWithIds, addr 0x39e49dc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessColor, addr 0x39e49bc, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Color ProcessColor(::UnityEngine::Color color, float_t intensity);

  /// @brief Method ProcessNewColorData, addr 0x39e4880, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e49e4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
