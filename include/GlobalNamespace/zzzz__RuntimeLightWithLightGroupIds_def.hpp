...
public:
  ...
  /// @brief Method .ctor, addr 0x23f5e88, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t intensity);

  /// @brief Method get_intensity, addr 0x23f602c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x23f6034, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x23f5cc8, size 0x1c0, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  /// @brief Method GetLightWithIds, addr 0x23f600c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessColor, addr 0x23f5fec, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Color ProcessColor(::UnityEngine::Color color, float_t intensity);

  /// @brief Method ProcessNewColorData, addr 0x23f5eb0, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f6014, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
