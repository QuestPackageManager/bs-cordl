...
public:
  ...
  /// @brief Method .ctor, addr 0x56bcd64, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t intensity);

  /// @brief Method get_intensity, addr 0x56bcd54, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x56bcd5c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x56bca50, size 0x1b0, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method GetLightWithIds, addr 0x56bcd4c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessColor, addr 0x56bcd2c, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Color ProcessColor(::UnityEngine::Color color, float_t intensity);

  /// @brief Method ProcessNewColorData, addr 0x56bcc00, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56b9758, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
