...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10173)), TypeDefinitionIndex(TypeDefinitionIndex(14780))}
...
public:
  ...
  /// @brief Method SetProperty addr 0x1fbf8e4 size 0x34 virtual true final false
  inline void SetProperty();

  static inline ::GlobalNamespace::MaterialPropertyBlockVectorAnimator* New_ctor();

  /// @brief Method .ctor addr 0x1fbf918 size 0x58 virtual false final false
  inline void _ctor();
