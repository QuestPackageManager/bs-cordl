...
public:
  ...
  /// @brief Method DidActivate, addr 0x57ab860, size 0x240, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleMenuButton, addr 0x57abaa0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method <DidActivate>b__8_0, addr 0x57abacc, size 0x24, virtual false, abstract: false, final false
  inline void _DidActivate_b__8_0();

  /// @brief Method <DidActivate>b__8_1, addr 0x57abaf0, size 0x24, virtual false, abstract: false, final false
  inline void _DidActivate_b__8_1();

  /// @brief Method <DidActivate>b__8_2, addr 0x57abb14, size 0x24, virtual false, abstract: false, final false
  inline void _DidActivate_b__8_2();

  /// @brief Method <DidActivate>b__8_3, addr 0x57abb38, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57abac8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x57ab6e0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x57ab7a0, size 0xc0, virtual false, abstract: false, final false
