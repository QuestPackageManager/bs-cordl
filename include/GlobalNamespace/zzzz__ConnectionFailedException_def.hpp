...
public:
  ...
  /// @brief Method .ctor, addr 0x22c24a4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::ConnectionFailedReason reason);

  /// @brief Method .ctor, addr 0x22c2510, size 0x74, virtual false, abstract: false, final false
