...
public:
  ...
  /// @brief Method .ctor, addr 0x22c6864, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::ConnectionFailedReason reason);

  /// @brief Method .ctor, addr 0x22c68d0, size 0x74, virtual false, abstract: false, final false
