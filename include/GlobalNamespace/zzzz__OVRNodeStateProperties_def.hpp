...
public:
  ...
  /// @brief Method GetNodeStatePropertyQuaternion, addr 0x5cd4a60, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNodeStatePropertyVector3, addr 0x5cd46e8, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnityXRNodeStateQuaternion, addr 0x5ce1afc, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnityXRNodeStateVector3, addr 0x5ce1964, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method IsHmdPresent, addr 0x5cdead0, size 0xe8, virtual false, abstract: false, final false
  static inline bool IsHmdPresent();

  /// @brief Method ValidateProperty, addr 0x5ce1c04, size 0x1c4, virtual false, abstract: false, final false
