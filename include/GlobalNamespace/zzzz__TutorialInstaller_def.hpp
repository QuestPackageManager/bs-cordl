...
/// @brief Field _environmentSceneSetupData, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentSceneSetupData, put=__cordl_internal_set__environmentSceneSetupData)) ::GlobalNamespace::EnvironmentSceneSetupData*  _environmentSceneSetupData;
...
/// @brief Method InstallBindings, addr 0x58521a8, size 0x1094, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x585323c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::TutorialInstaller, 0x60>, "Size mismatch!");
