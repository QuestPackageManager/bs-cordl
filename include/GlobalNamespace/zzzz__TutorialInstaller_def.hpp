...
public:
  ...
  /// @brief Method InstallBindings, addr 0x274961c, size 0xd34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x274a350, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
