...
public:
  ...
  /// @brief Method EnableObjects, addr 0x57e79c4, size 0xc0, virtual false, abstract: false, final false
  inline void EnableObjects(bool on);

  static inline ::GlobalNamespace::TubeLightIntensityBehaviour* New_ctor();

  /// @brief Method OnPlayableDestroy, addr 0x57e7a84, size 0xd0, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x57e7644, size 0x380, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e7b54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
