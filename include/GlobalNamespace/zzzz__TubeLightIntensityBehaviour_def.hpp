...
public:
  ...
  /// @brief Method EnableObjects, addr 0x259bfa4, size 0xd4, virtual false, abstract: false, final false
  inline void EnableObjects(bool on);

  static inline ::GlobalNamespace::TubeLightIntensityBehaviour* New_ctor();

  /// @brief Method OnPlayableDestroy, addr 0x259c078, size 0xcc, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x259bc34, size 0x370, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x259c144, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
