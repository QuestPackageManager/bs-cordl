...
public:
  ...
  /// @brief Method EnableObjects, addr 0x3b364fc, size 0xd4, virtual false, abstract: false, final false
  inline void EnableObjects(bool on);

  static inline ::GlobalNamespace::TubeLightIntensityBehaviour* New_ctor();

  /// @brief Method OnPlayableDestroy, addr 0x3b365d0, size 0xd4, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x3b36180, size 0x37c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b366a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
