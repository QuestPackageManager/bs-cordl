...
public:
  ...
  /// @brief Method Update, addr 0x5d568b0, size 0x10c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5d569bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
