...
public:
  ...
  /// @brief Method Update, addr 0x28a5fac, size 0xf0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x28a609c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
