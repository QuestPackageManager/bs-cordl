...
public:
  ...
  /// @brief Method Update, addr 0x403af54, size 0xf0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x403b044, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
