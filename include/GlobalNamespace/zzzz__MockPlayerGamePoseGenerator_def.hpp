...
public:
  ...
  /// @brief Method CreateEmptyLevelCompletionResults, addr 0x277ddcc, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x277dbe8, size 0x2c, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method SimulateFail, addr 0x277dcdc, size 0xf0, virtual true, abstract: false, final false
  inline void SimulateFail();

  /// @brief Method SimulateGiveUp, addr 0x277ded4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x277d9ac, size 0xc0, virtual false, abstract: false, final false
