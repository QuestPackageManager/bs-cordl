...
/// @brief Method .ctor, addr 0x58427a4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _beatmapObjectCallbackWrapper, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapObjectCallbackWrapper, put=__cordl_internal_set__beatmapObjectCallbackWrapper)) ::GlobalNamespace::BeatmapDataCallbackWrapper*  _beatmapObjectCallbackWrapper;
...
/// @brief Method BeatmapObjectSpawnCallback, addr 0x5842760, size 0x40, virtual false, abstract: false, final false
inline void BeatmapObjectSpawnCallback(::GlobalNamespace::ObstacleData*  obstacleData) ;

/// @brief Method LateUpdate, addr 0x584255c, size 0x204, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::PlayerHeightDetector* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5842540, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5842454, size 0xec, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x58427a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerHeightDidChangeEvent, addr 0x58422cc, size 0xc0, virtual false, abstract: false, final false
inline void add_playerHeightDidChangeEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_playerHeight, addr 0x584244c, size 0x8, virtual false, abstract: false, final false
inline float_t get_playerHeight() ;

/// @brief Method remove_playerHeightDidChangeEvent, addr 0x584238c, size 0xc0, virtual false, abstract: false, final false
