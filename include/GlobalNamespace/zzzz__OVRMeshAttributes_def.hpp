...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRMeshAttributes, "", "OVRMeshAttributes");
// Dependencies UnityEngine.BoneWeight, UnityEngine.Color, UnityEngine.Vector2, UnityEngine.Vector3, UnityEngine.Vector4
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::OVRMeshAttributes) == 0x30, "Size mismatch!");
