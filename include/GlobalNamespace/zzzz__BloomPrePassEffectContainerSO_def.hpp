...
public:
  ...
  /// @brief Method Init, addr 0x39de054, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39de05c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bloomPrePassEffect, addr 0x39de04c, size 0x8, virtual false, abstract: false, final false
