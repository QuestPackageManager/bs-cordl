...
public:
  ...
  /// @brief Method Init, addr 0x251745c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2517464, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bloomPrePassEffect, addr 0x2517454, size 0x8, virtual false, abstract: false, final false
