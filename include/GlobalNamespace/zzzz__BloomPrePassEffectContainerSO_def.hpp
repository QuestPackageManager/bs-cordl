...
public:
  ...
  /// @brief Method Init, addr 0x564fb9c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x564fba4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bloomPrePassEffect, addr 0x564fb94, size 0x8, virtual false, abstract: false, final false
