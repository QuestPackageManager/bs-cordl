...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassEffectContainerSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassEffectContainerSO*, "", "BloomPrePassEffectContainerSO");
...
public:
  ...
  /// @brief Method Init, addr 0x5861f54, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5861f5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bloomPrePassEffect, addr 0x5861f4c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassEffectContainerSO) == 0x20, "Size mismatch!");
