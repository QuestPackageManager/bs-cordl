...
public:
  ...
  /// @brief Method Init, addr 0x56b07e4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56b07ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bloomPrePassEffect, addr 0x56b07dc, size 0x8, virtual false, abstract: false, final false
