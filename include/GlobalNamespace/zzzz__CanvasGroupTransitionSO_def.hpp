...
public:
  ...
  /// @brief Method .ctor, addr 0x24a6ab4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disabledAlpha, addr 0x24a6a9c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_disabledAlpha();

  /// @brief Method get_highlightedAlpha, addr 0x24a6a8c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_highlightedAlpha();

  /// @brief Method get_normalAlpha, addr 0x24a6a84, size 0x8, virtual false, abstract: false, final false
  inline float_t get_normalAlpha();

  /// @brief Method get_pressedAlpha, addr 0x24a6a94, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pressedAlpha();

  /// @brief Method get_selectedAlpha, addr 0x24a6aa4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_selectedAlpha();

  /// @brief Method get_selectedAndHighlightedAlpha, addr 0x24a6aac, size 0x8, virtual false, abstract: false, final false
