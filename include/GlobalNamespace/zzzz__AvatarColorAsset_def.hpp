...
// Write type traits
MARK_REF_T(::GlobalNamespace::AvatarColorAsset*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AvatarColorAsset*, "", "AvatarColorAsset");
...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x5907178, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590722c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x5907170, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AvatarColorAsset", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AvatarColorAsset(AvatarColorAsset&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AvatarColorAsset", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AvatarColorAsset(AvatarColorAssetconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::AvatarColorAsset) == 0x20, "Size mismatch!");
