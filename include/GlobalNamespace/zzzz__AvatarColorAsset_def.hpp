...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x3b33c20, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_clipCaps, addr 0x3b33c18, size 0x8, virtual true, abstract: false, final true
