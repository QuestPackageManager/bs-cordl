...
// Write type traits
MARK_REF_T(::GlobalNamespace::CommandBufferOwners*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CommandBufferOwners*, "", "CommandBufferOwners");
...
public:
  ...
  /// @brief Method AddOwner, addr 0x5f420e0, size 0xc0, virtual false, abstract: false, final false
  inline void AddOwner(::UnityEngine::Object* owner);

  /// @brief Method ContainsOwner, addr 0x5f4207c, size 0x64, virtual false, abstract: false, final false
  inline bool ContainsOwner(::UnityEngine::Object* owner);

  static inline ::GlobalNamespace::CommandBufferOwners* New_ctor();

  /// @brief Method RemoveOwner, addr 0x5f41de8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f421a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NumberOfOwners, addr 0x5f41e58, size 0x50, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CommandBufferOwners", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CommandBufferOwners(CommandBufferOwners&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CommandBufferOwners", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CommandBufferOwners(CommandBufferOwnersconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::CommandBufferOwners) == 0x20, "Size mismatch!");
