...
public:
  ...
  /// @brief Method AddOwner, addr 0x407cfc0, size 0xa0, virtual false, abstract: false, final false
  inline void AddOwner(::UnityEngine::Object* owner);

  /// @brief Method ContainsOwner, addr 0x407cf68, size 0x58, virtual false, abstract: false, final false
  inline bool ContainsOwner(::UnityEngine::Object* owner);

  static inline ::GlobalNamespace::CommandBufferOwners* New_ctor();

  /// @brief Method RemoveOwner, addr 0x407cd10, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x407d060, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_NumberOfOwners, addr 0x407cd70, size 0x48, virtual false, abstract: false, final false
