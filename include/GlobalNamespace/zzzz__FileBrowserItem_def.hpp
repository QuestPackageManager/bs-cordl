...
// Write type traits
MARK_REF_T(::GlobalNamespace::FileBrowserItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FileBrowserItem*, "", "FileBrowserItem");
...
static_assert(sizeof(::GlobalNamespace::FileBrowserItem) == 0x28, "Size mismatch!");
