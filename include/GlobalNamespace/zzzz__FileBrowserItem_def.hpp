...
public:
  ...
  /// @brief Method get_displayName, addr 0x126781c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method set_displayName, addr 0x1267824, size 0x8, virtual false, abstract: false, final false
  inline void set_displayName(::StringW value);

  /// @brief Method get_fullPath, addr 0x126782c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_fullPath();

  /// @brief Method set_fullPath, addr 0x1267834, size 0x8, virtual false, abstract: false, final false
  inline void set_fullPath(::StringW value);

  /// @brief Method get_isDirectory, addr 0x126783c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isDirectory();

  /// @brief Method set_isDirectory, addr 0x1267844, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12657d0, size 0x40, virtual false, abstract: false, final false
