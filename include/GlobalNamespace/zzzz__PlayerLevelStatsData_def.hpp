...
public:
  ...
  /// @brief Method GetBeatmapKey, addr 0x3624ef4, size 0x3c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey GetBeatmapKey();

  /// @brief Method IncreaseNumberOfGameplays, addr 0x3624ee4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateScoreData, addr 0x3624ea8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3624e7c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method .ctor, addr 0x3624e98, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3623158, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapCharacteristic, addr 0x3624e44, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic();

  /// @brief Method get_difficulty, addr 0x3624e3c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_difficulty();

  /// @brief Method get_fullCombo, addr 0x3624e5c, size 0x8, virtual false, abstract: false, final false
  inline bool get_fullCombo();

  /// @brief Method get_highScore, addr 0x3624e4c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_highScore();

  /// @brief Method get_levelID, addr 0x3624e34, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelID();

  /// @brief Method get_maxCombo, addr 0x3624e54, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxCombo();

  /// @brief Method get_maxRank, addr 0x3624e64, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::RankModel_Rank get_maxRank();

  /// @brief Method get_playCount, addr 0x3624e74, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_playCount();

  /// @brief Method get_validScore, addr 0x3624e6c, size 0x8, virtual false, abstract: false, final false
