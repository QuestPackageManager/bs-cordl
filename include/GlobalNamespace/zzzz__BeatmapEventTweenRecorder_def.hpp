...
/// @brief Method Begin, addr 0x57cca3c, size 0x4, virtual false, abstract: false, final false
inline void Begin(::GlobalNamespace::BeatmapCallbacksController*  callbackController) ;

/// @brief Method CaptureFrame, addr 0x57ccafc, size 0xa4, virtual false, abstract: false, final false
inline void CaptureFrame() ;

/// @brief Method ClearCallbacks, addr 0x57ccc34, size 0x30, virtual false, abstract: false, final false
inline void ClearCallbacks() ;

/// @brief Method Finish, addr 0x57ccba0, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method GenerateTableReport, addr 0x57ccc64, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method HandleBeatmapEvent, addr 0x57ccfb4, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method SetupCallbacks, addr 0x57cca40, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57cc9b8, size 0x84, virtual false, abstract: false, final false
