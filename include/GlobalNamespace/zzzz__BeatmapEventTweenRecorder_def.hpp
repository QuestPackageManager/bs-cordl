...
// Ctor Parameters [CppParam { name: "color", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "rotation", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "translation", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "fx", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field _samples, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__samples, put=__cordl_internal_set__samples)) ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapEventTweenRecorder_EventTweens>*  _samples;

/// @brief Method Begin, addr 0x575b0ac, size 0x4, virtual false, abstract: false, final false
inline void Begin(::GlobalNamespace::BeatmapCallbacksController*  callbackController) ;

/// @brief Method CaptureFrame, addr 0x575b16c, size 0xa4, virtual false, abstract: false, final false
inline void CaptureFrame() ;

/// @brief Method ClearCallbacks, addr 0x575b2a4, size 0x30, virtual false, abstract: false, final false
inline void ClearCallbacks() ;

/// @brief Method Finish, addr 0x575b210, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method GenerateTableReport, addr 0x575b2d4, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method HandleBeatmapEvent, addr 0x575b624, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method SetupCallbacks, addr 0x575b0b0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x575b028, size 0x84, virtual false, abstract: false, final false
