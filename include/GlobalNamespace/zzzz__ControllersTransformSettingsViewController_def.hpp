...
public:
  ...
  /// @brief Method DidActivate, addr 0x253fc5c, size 0x570, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x25401cc, size 0xac, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandlePositionSliderValueDidChange, addr 0x25405b0, size 0x120, virtual false, abstract: false, final false
  inline void HandlePositionSliderValueDidChange(::HMUI::RangeValuesTextSlider* slider, float_t value);

  /// @brief Method HandleRotationSliderValueDidChange, addr 0x25406d0, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2540278, size 0x338, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25407e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
