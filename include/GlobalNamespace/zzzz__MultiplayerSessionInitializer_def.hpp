...
/// @brief Method InitializeLocalPlayerSessionState, addr 0x31e2ebc, size 0x284, virtual true, abstract: false, final true
inline void InitializeLocalPlayerSessionState() ;

/// @brief Method .ctor, addr 0x31e2eb0, size 0xc, virtual false, abstract: false, final false
...
constexpr ::GlobalNamespace::IMultiplayerSessionManager_1_IMultiplayerSessionInitializer<::GlobalNamespace::IBeatSaberConnectedPlayer*>* i___GlobalNamespace__IMultiplayerSessionManager_1_IMultiplayerSessionInitializer___GlobalNamespace__IBeatSaberConnectedPlayer__() ;

// Ctor Parameters []
// @brief default ctor
constexpr MultiplayerSessionInitializer() ;

// Ctor Parameters [CppParam { name: "_multiplayerSessionManager", ty: "::GlobalNamespace::IBeatSaberMultiplayerSessionManager*", modifiers: "", def_value: None }, CppParam { name: "_multiplayerSessionType", ty: "::GlobalNamespace::MultiplayerSessionType", modifiers: "", def_value: None }]
constexpr MultiplayerSessionInitializer(::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  _multiplayerSessionManager, ::GlobalNamespace::MultiplayerSessionType  _multiplayerSessionType) noexcept;
