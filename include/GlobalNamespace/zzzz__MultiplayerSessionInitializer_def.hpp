...
public:
  ...
  /// @brief Method InitializeLocalPlayerSessionState, addr 0x32b8a68, size 0x284, virtual true, abstract: false, final true
  inline void InitializeLocalPlayerSessionState();

  /// @brief Method .ctor, addr 0x32b8a5c, size 0xc, virtual false, abstract: false, final false
