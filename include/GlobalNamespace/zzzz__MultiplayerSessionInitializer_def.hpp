...
public:
  ...
  /// @brief Method InitializeLocalPlayerSessionState, addr 0x321eb24, size 0x284, virtual true, abstract: false, final true
  inline void InitializeLocalPlayerSessionState();

  /// @brief Method .ctor, addr 0x321eb18, size 0xc, virtual false, abstract: false, final false
