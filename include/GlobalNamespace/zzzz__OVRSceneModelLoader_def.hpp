...
public:
  ...
  /// @brief Method <RequestScenePermissionAsync>b__1, addr 0x5cb6844, size 0x50, virtual false, abstract: false, final false
  inline void _RequestScenePermissionAsync_b__1(::StringW _);

  /// @brief Method <RequestScenePermissionAsync>b__2, addr 0x5cb6894, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cb6840, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5cb68e8, size 0xb8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRSceneModelLoader__AttemptToLoadSceneModel_d__7* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5cb69a0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5cb69a8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5cb69e0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5cb68e4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5cb5fec, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5cb69e8, size 0x3dc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5cb6dc4, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AttemptToLoadSceneModel, addr 0x5cb5f98, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* AttemptToLoadSceneModel();

  /// @brief Method LoadSceneModel, addr 0x5cb5ff8, size 0x140, virtual false, abstract: false, final false
  inline void LoadSceneModel();

  static inline ::GlobalNamespace::OVRSceneModelLoader* New_ctor();

  /// @brief Method OnLoadSceneModelFailedPermissionNotGranted, addr 0x5cb62d4, size 0xa0, virtual true, abstract: false, final false
  inline void OnLoadSceneModelFailedPermissionNotGranted();

  /// @brief Method OnNewSceneModelAvailable, addr 0x5cb65ac, size 0xe0, virtual true, abstract: false, final false
  inline void OnNewSceneModelAvailable();

  /// @brief Method OnNoSceneModelToLoad, addr 0x5cb644c, size 0x160, virtual true, abstract: false, final false
  inline void OnNoSceneModelToLoad();

  /// @brief Method OnSceneCaptureReturnedWithoutError, addr 0x5cb668c, size 0xd8, virtual true, abstract: false, final false
  inline void OnSceneCaptureReturnedWithoutError();

  /// @brief Method OnSceneModelLoadedSuccessfully, addr 0x5cb6374, size 0xd8, virtual true, abstract: false, final false
  inline void OnSceneModelLoadedSuccessfully();

  /// @brief Method OnStart, addr 0x5cb5ff4, size 0x4, virtual true, abstract: false, final false
  inline void OnStart();

  /// @brief Method OnUnexpectedErrorWithSceneCapture, addr 0x5cb6764, size 0xd8, virtual true, abstract: false, final false
  inline void OnUnexpectedErrorWithSceneCapture();

  /// @brief Method RequestScenePermissionAsync, addr 0x5cb6138, size 0x4, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTask_1<bool> RequestScenePermissionAsync();

  /// @brief Method Start, addr 0x5cb5b74, size 0x424, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method <RequestScenePermissionAsync>g__RequestPermissionOnAndroid|9_0, addr 0x5cb613c, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cb683c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SceneManager, addr 0x5cb5b64, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRSceneManager> get_SceneManager();

  /// @brief Method set_SceneManager, addr 0x5cb5b6c, size 0x8, virtual false, abstract: false, final false
