...
public:
  ...
  /// @brief Method MoveNext, addr 0x400e95c, size 0x98, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRSceneModelLoader__AttemptToLoadSceneModel_d__7* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x400e9f4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x400e9fc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x400ea34, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x400e958, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x400e4d8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AttemptToLoadSceneModel, addr 0x400e478, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* AttemptToLoadSceneModel();

  /// @brief Method LoadSceneModel, addr 0x400e504, size 0xf4, virtual false, abstract: false, final false
  inline void LoadSceneModel();

  static inline ::GlobalNamespace::OVRSceneModelLoader* New_ctor();

  /// @brief Method OnNewSceneModelAvailable, addr 0x400e77c, size 0x9c, virtual true, abstract: false, final false
  inline void OnNewSceneModelAvailable();

  /// @brief Method OnNoSceneModelToLoad, addr 0x400e694, size 0xe8, virtual true, abstract: false, final false
  inline void OnNoSceneModelToLoad();

  /// @brief Method OnSceneCaptureReturnedWithoutError, addr 0x400e818, size 0x9c, virtual true, abstract: false, final false
  inline void OnSceneCaptureReturnedWithoutError();

  /// @brief Method OnSceneModelLoadedSuccessfully, addr 0x400e5f8, size 0x9c, virtual true, abstract: false, final false
  inline void OnSceneModelLoadedSuccessfully();

  /// @brief Method OnStart, addr 0x400e500, size 0x4, virtual true, abstract: false, final false
  inline void OnStart();

  /// @brief Method OnUnexpectedErrorWithSceneCapture, addr 0x400e8b4, size 0x9c, virtual true, abstract: false, final false
  inline void OnUnexpectedErrorWithSceneCapture();

  /// @brief Method Start, addr 0x400e1f4, size 0x284, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x400e950, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SceneManager, addr 0x400e1e4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRSceneManager> get_SceneManager();

  /// @brief Method set_SceneManager, addr 0x400e1ec, size 0x8, virtual false, abstract: false, final false
