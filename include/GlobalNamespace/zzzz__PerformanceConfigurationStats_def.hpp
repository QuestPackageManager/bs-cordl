...
public:
// Declarations
/// @brief Method CreateLogValue, addr 0x57600d8, size 0xb0, virtual false, abstract: false, final false
inline ::StringW CreateLogValue() ;

/// @brief Method Update, addr 0x57600bc, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method CreateLogValue, addr 0x5760188, size 0xdc, virtual false, abstract: false, final false
inline ::StringW CreateLogValue() ;

/// @brief Method Update, addr 0x575ff00, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method CreateLogValue, addr 0x57602b4, size 0xdc, virtual false, abstract: false, final false
inline ::StringW CreateLogValue() ;

/// @brief Method Update, addr 0x575ff7c, size 0x98, virtual false, abstract: false, final false
...
// Dependencies PerformanceConfigurationStats::BoolStats, PerformanceConfigurationStats::EnumStats`1<T>, PerformanceConfigurationStats::FloatStats, PerformanceConfigurationStats::IntStats, System.Object, UnityEngine.BatteryStatus, UnityEngine.NetworkReachability
namespace GlobalNamespace {
// Is value type: false
...
/// @brief Field batteryStatus, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get_batteryStatus, put=__cordl_internal_set_batteryStatus)) ::GlobalNamespace::PerformanceConfigurationStats_EnumStats_1<::UnityEngine::BatteryStatus>  batteryStatus;
...
/// @brief Field internetReachability, offset 0x24, size 0x4 
 __declspec(property(get=__cordl_internal_get_internetReachability, put=__cordl_internal_set_internetReachability)) ::GlobalNamespace::PerformanceConfigurationStats_EnumStats_1<::UnityEngine::NetworkReachability>  internetReachability;
...
/// @brief Method Update, addr 0x575fd5c, size 0x1a4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5760014, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
