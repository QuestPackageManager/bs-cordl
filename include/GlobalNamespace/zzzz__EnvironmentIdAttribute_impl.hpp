...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::EnvironmentIdAttribute::*)(::StringW, ::GlobalNamespace::EnvironmentIdFilter)>(
  ...
  constexpr static std::size_t addrs = 0x372af98;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::EnvironmentIdAttribute*>(),
                                                             { ".ctor", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::GlobalNamespace::EnvironmentIdFilter>() } })));
...
inline void GlobalNamespace::EnvironmentIdAttribute::_ctor(::StringW emptyExplanation, ::GlobalNamespace::EnvironmentIdFilter filter) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::EnvironmentIdAttribute*>(),
                                                                                         { ".ctor", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::GlobalNamespace::EnvironmentIdFilter>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, emptyExplanation, filter);
}
inline ::GlobalNamespace::EnvironmentIdAttribute* GlobalNamespace::EnvironmentIdAttribute::New_ctor(::StringW emptyExplanation, ::GlobalNamespace::EnvironmentIdFilter filter) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::EnvironmentIdAttribute*>(emptyExplanation, filter));
}
// Ctor Parameters []
