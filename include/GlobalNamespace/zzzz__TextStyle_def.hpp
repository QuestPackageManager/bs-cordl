...
public:
  ...
  /// @brief Method Update, addr 0x32c96e8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32c9700, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_autoSizing, addr 0x32c96c0, size 0x8, virtual true, abstract: false, final true
  inline bool get_autoSizing();

  /// @brief Method get_charWidthMaxAdj, addr 0x32c96d8, size 0x8, virtual true, abstract: false, final true
  inline float_t get_charWidthMaxAdj();

  /// @brief Method get_fontSize, addr 0x32c96b8, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSize();

  /// @brief Method get_fontSizeMax, addr 0x32c96d0, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSizeMax();

  /// @brief Method get_fontSizeMin, addr 0x32c96c8, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSizeMin();

  /// @brief Method get_fontStyle, addr 0x32c96b0, size 0x8, virtual true, abstract: false, final true
  inline ::TMPro::FontStyles get_fontStyle();

  /// @brief Method get_lineSpacingMax, addr 0x32c96e0, size 0x8, virtual true, abstract: false, final true
