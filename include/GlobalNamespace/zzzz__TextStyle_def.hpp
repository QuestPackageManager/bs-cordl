...
public:
  ...
  /// @brief Method Update, addr 0x2286a2c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2286a48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_autoSizing, addr 0x2286a04, size 0x8, virtual true, abstract: false, final true
  inline bool get_autoSizing();

  /// @brief Method get_charWidthMaxAdj, addr 0x2286a1c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_charWidthMaxAdj();

  /// @brief Method get_fontSize, addr 0x22869fc, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSize();

  /// @brief Method get_fontSizeMax, addr 0x2286a14, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSizeMax();

  /// @brief Method get_fontSizeMin, addr 0x2286a0c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSizeMin();

  /// @brief Method get_fontStyle, addr 0x22869f4, size 0x8, virtual true, abstract: false, final true
  inline ::TMPro::FontStyles get_fontStyle();

  /// @brief Method get_lineSpacingMax, addr 0x2286a24, size 0x8, virtual true, abstract: false, final true
