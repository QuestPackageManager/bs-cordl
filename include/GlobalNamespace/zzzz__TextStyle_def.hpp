...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextStyle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextStyle*, "", "TextStyle");
...
public:
  ...
  /// @brief Method Update, addr 0x32cae70, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32cae88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_autoSizing, addr 0x32cae48, size 0x8, virtual true, abstract: false, final true
  inline bool get_autoSizing();

  /// @brief Method get_charWidthMaxAdj, addr 0x32cae60, size 0x8, virtual true, abstract: false, final true
  inline float_t get_charWidthMaxAdj();

  /// @brief Method get_fontSize, addr 0x32cae40, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSize();

  /// @brief Method get_fontSizeMax, addr 0x32cae58, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSizeMax();

  /// @brief Method get_fontSizeMin, addr 0x32cae50, size 0x8, virtual true, abstract: false, final true
  inline float_t get_fontSizeMin();

  /// @brief Method get_fontStyle, addr 0x32cae38, size 0x8, virtual true, abstract: false, final true
  inline ::TMPro::FontStyles get_fontStyle();

  /// @brief Method get_lineSpacingMax, addr 0x32cae68, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::TextStyle) == 0x30, "Size mismatch!");
