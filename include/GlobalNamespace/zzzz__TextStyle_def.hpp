...
/// @brief Method Update, addr 0x31f613c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31f6154, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_autoSizing, addr 0x31f6114, size 0x8, virtual true, abstract: false, final true
inline bool get_autoSizing() ;

/// @brief Method get_charWidthMaxAdj, addr 0x31f612c, size 0x8, virtual true, abstract: false, final true
inline float_t get_charWidthMaxAdj() ;

/// @brief Method get_fontSize, addr 0x31f610c, size 0x8, virtual true, abstract: false, final true
inline float_t get_fontSize() ;

/// @brief Method get_fontSizeMax, addr 0x31f6124, size 0x8, virtual true, abstract: false, final true
inline float_t get_fontSizeMax() ;

/// @brief Method get_fontSizeMin, addr 0x31f611c, size 0x8, virtual true, abstract: false, final true
inline float_t get_fontSizeMin() ;

/// @brief Method get_fontStyle, addr 0x31f6104, size 0x8, virtual true, abstract: false, final true
inline ::TMPro::FontStyles get_fontStyle() ;

/// @brief Method get_lineSpacingMax, addr 0x31f6134, size 0x8, virtual true, abstract: false, final true
