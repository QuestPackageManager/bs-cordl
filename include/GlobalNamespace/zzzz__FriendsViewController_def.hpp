...
public:
  ...
  /// @brief Method DidDeactivate, addr 0x58e8804, size 0x44, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleOpenPartyToggleChanged, addr 0x58e8870, size 0x10, virtual false, abstract: false, final false
  inline void HandleOpenPartyToggleChanged(bool openParty);

  /// @brief Method NetworkPlayersViewControllerDidActivate, addr 0x58e858c, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58e8848, size 0x28, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshParty, addr 0x58e86a8, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e8880, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_myPartyTitle, addr 0x58e84fc, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_myPartyTitle();

  /// @brief Method get_networkPlayerModel, addr 0x58e8584, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::INetworkPlayerModel* get_networkPlayerModel();

  /// @brief Method get_otherPlayersTitle, addr 0x58e8540, size 0x44, virtual true, abstract: false, final false
