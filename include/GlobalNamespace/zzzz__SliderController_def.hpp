...
public:
  ...
  /// @brief Method .ctor, addr 0x25b2a1c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x25b2a64, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x25b2aac, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetLengthFromSliderData, addr 0x25b29c4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPool, addr 0x25b2924, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b28e8, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x25b2af8, size 0x3ec, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__SliderController___DissolveCoroutine_d__70* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x25b2ee4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x25b2eec, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x25b2f2c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x25b2af4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25b1e18, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x25b0ef0, size 0x160, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Dissolve, addr 0x25b1e40, size 0x60, virtual true, abstract: false, final true
  inline void Dissolve(float_t duration);

  /// @brief Method DissolveCoroutine, addr 0x25b1da0, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* DissolveCoroutine(float_t duration);

  /// @brief Method FixedUpdate, addr 0x25b19a0, size 0x58, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetSaberInteractionPoint, addr 0x25b0d5c, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetSaberInteractionPoint(::GlobalNamespace::Saber* saber);

  /// @brief Method HandleFadeInDidStart, addr 0x25b26bc, size 0x8, virtual false, abstract: false, final false
  inline void HandleFadeInDidStart();

  /// @brief Method HandleHeadDidMovePastCutMark, addr 0x25b21c0, size 0x1f0, virtual false, abstract: false, final false
  inline void HandleHeadDidMovePastCutMark();

  /// @brief Method HandleMovementDidFinish, addr 0x25b1fec, size 0x1d4, virtual false, abstract: false, final false
  inline void HandleMovementDidFinish();

  /// @brief Method HandleNoteWasCut, addr 0x25b263c, size 0x80, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method HandleNoteWasMissed, addr 0x25b25c0, size 0x4c, virtual false, abstract: false, final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleTailDidMovePastCutMark, addr 0x25b23e0, size 0x1e0, virtual false, abstract: false, final false
  inline void HandleTailDidMovePastCutMark();

  /// @brief Method Hide, addr 0x25b1ec8, size 0x2c, virtual true, abstract: false, final true
  inline void Hide(bool hide);

  /// @brief Method Init, addr 0x25afe44, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNoteStartOfThisSlider, addr 0x25b1f04, size 0xe8, virtual false, abstract: false, final false
  inline bool IsNoteStartOfThisSlider(::GlobalNamespace::NoteData* noteData);

  /// @brief Method ManualUpdate, addr 0x25b192c, size 0x74, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::GlobalNamespace::SliderController* New_ctor();

  /// @brief Method OnDestroy, addr 0x25b1410, size 0x2a8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x25b1ef4, size 0x10, virtual true, abstract: false, final true
  inline void Pause(bool pause);

  /// @brief Method SetSaberAttraction, addr 0x25b0cd4, size 0x88, virtual false, abstract: false, final false
  inline void SetSaberAttraction(bool saberAttraction);

  /// @brief Method Start, addr 0x25b1224, size 0x150, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x25b1928, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateMaterialPropertyBlock, addr 0x25b0db0, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b274c, size 0x194, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_closeSmoothedSaberInteractionPos, addr 0x25afe34, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::FixedUpdateVector3SmoothValue* get_closeSmoothedSaberInteractionPos();

  /// @brief Method get_headJumpOffsetY, addr 0x25afe24, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headJumpOffsetY();

  /// @brief Method get_initColor, addr 0x25afe00, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_initColor();

  /// @brief Method get_jumpDistance, addr 0x25afe1c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_jumpDistance();

  /// @brief Method get_lengthType, addr 0x25afd78, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__SliderController__LengthType get_lengthType();

  /// @brief Method get_randomValue, addr 0x25afe0c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_randomValue();

  /// @brief Method get_saberInteractionParam, addr 0x25afd88, size 0x40, virtual false, abstract: false, final false
  inline float_t get_saberInteractionParam();

  /// @brief Method get_sliderData, addr 0x25afd80, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderData* get_sliderData();

  /// @brief Method get_sliderDidDissolveEvent, addr 0x25afd60, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::ISliderDidDissolveEvent*>* get_sliderDidDissolveEvent();

  /// @brief Method get_sliderDidFinishJumpEvent, addr 0x25afd50, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::ISliderDidFinishJumpEvent*>* get_sliderDidFinishJumpEvent();

  /// @brief Method get_sliderDidStartDissolvingEvent, addr 0x25afd58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sliderDuration, addr 0x25afe2c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_sliderDuration();

  /// @brief Method get_sliderHeadDidMovePastCutMark, addr 0x25afd68, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sliderIntensityEffect, addr 0x25afe3c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::SliderIntensityEffect> get_sliderIntensityEffect();

  /// @brief Method get_sliderMeshController, addr 0x25afdf0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::SliderMeshController> get_sliderMeshController();

  /// @brief Method get_sliderMovement, addr 0x25afdf8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::SliderMovement> get_sliderMovement();

  /// @brief Method get_sliderTailDidMovePastCutMark, addr 0x25afd70, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_zDistanceBetweenNotes, addr 0x25afe14, size 0x8, virtual false, abstract: false, final false
