...
public:
  ...
  /// @brief Method DidActivate, addr 0x2637a38, size 0x108, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::FloorAdjustViewController* New_ctor();

  /// @brief Method Update, addr 0x2637b40, size 0x24c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method <DidActivate>b__9_0, addr 0x2637d94, size 0xa0, virtual false, abstract: false, final false
  inline void _DidActivate_b__9_0();

  /// @brief Method <DidActivate>b__9_1, addr 0x2637e34, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2637d8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
