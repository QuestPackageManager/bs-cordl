...
// Write type traits
MARK_REF_T(::GlobalNamespace::FloorAdjustViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloorAdjustViewController*, "", "FloorAdjustViewController");
...
static_assert(sizeof(::GlobalNamespace::FloorAdjustViewController) == 0xb0, "Size mismatch!");
