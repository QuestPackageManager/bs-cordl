...
public:
  ...
  /// @brief Method DidActivate, addr 0x2538dd0, size 0x108, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::FloorAdjustViewController* New_ctor();

  /// @brief Method Update, addr 0x2538ed8, size 0x240, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method <DidActivate>b__9_0, addr 0x2539120, size 0x7c, virtual false, abstract: false, final false
  inline void _DidActivate_b__9_0();

  /// @brief Method <DidActivate>b__9_1, addr 0x253919c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2539118, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
