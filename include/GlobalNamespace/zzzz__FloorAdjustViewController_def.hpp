...
public:
  ...
  /// @brief Method DidActivate, addr 0x3bb0abc, size 0x100, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::FloorAdjustViewController* New_ctor();

  /// @brief Method Update, addr 0x3bb0bbc, size 0x200, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method <DidActivate>b__10_0, addr 0x3bb0dc4, size 0xbc, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_0();

  /// @brief Method <DidActivate>b__10_1, addr 0x3bb0e80, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bb0dbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
