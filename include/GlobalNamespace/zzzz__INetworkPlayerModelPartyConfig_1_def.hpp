...
public:
  // Declarations
  // Ctor Parameters [CppParam { name: "", ty: "INetworkPlayerModelPartyConfig_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INetworkPlayerModelPartyConfig_1(INetworkPlayerModelPartyConfig_1const&) = delete;
