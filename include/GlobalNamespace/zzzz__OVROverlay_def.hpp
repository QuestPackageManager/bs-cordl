...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5d3c890, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x5d3c8ac, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5d3c87c, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::GlobalNamespace::OVROverlay_ExternalSurfaceObjectCreated* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x5d3c814, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x5d3a898, size 0x424, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method BlitSubImage, addr 0x5d39478, size 0x4ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputePoseAndScale, addr 0x5d3b474, size 0x3e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeSubmit, addr 0x5d3b854, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLayer, addr 0x5d37cdc, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLayerTextures, addr 0x5d38134, size 0x4e8, virtual false, abstract: false, final false
  inline bool CreateLayerTextures(bool useMipmaps, ::GlobalNamespace::OVRPlugin_Sizei size, bool isHdr);

  /// @brief Method DestroyLayer, addr 0x5d38748, size 0x250, virtual false, abstract: false, final false
  inline void DestroyLayer();

  /// @brief Method DestroyLayerTextures, addr 0x5d3861c, size 0x12c, virtual false, abstract: false, final false
  inline void DestroyLayerTextures();

  /// @brief Method DisableImmediately, addr 0x5d3b158, size 0x260, virtual false, abstract: false, final false
  inline void DisableImmediately();

  /// @brief Method GetBlitRect, addr 0x5d3939c, size 0xdc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetBlitRect(int32_t eyeId, int32_t width, int32_t height, bool invertRect);

  /// @brief Method GetCurrentLayerDesc, addr 0x5d38ec0, size 0x4dc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_LayerDesc GetCurrentLayerDesc();

  /// @brief Method HandleBeginCameraRendering, addr 0x5d3c4b8, size 0xb8, virtual false, abstract: false, final false
  inline void HandleBeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method HandlePreRender, addr 0x5d3be8c, size 0xb8, virtual false, abstract: false, final false
  inline void HandlePreRender(::UnityEngine::Camera* camera);

  /// @brief Method InitOVROverlay, addr 0x5d3af34, size 0x1a4, virtual false, abstract: false, final false
  inline void InitOVROverlay();

  /// @brief Method IsPassthroughShape, addr 0x5d37c74, size 0x68, virtual false, abstract: false, final false
  static inline bool IsPassthroughShape(::GlobalNamespace::OVROverlay_OverlayShape shape);

  /// @brief Method LatchLayerTextures, addr 0x5d38ad0, size 0x3f0, virtual false, abstract: false, final false
  inline bool LatchLayerTextures();

  /// @brief Method NeedsTexturesForShape, addr 0x5d37c10, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5d3b3b8, size 0xbc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5d3b0d8, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5d3ad68, size 0x1cc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OpenVROverlayUpdate, addr 0x5d3bb18, size 0x374, virtual false, abstract: false, final false
  inline bool OpenVROverlayUpdate(::UnityEngine::Vector3 scale, ::GlobalNamespace::OVRPose pose);

  /// @brief Method OverrideOverlayTextureInfo, addr 0x5d37a48, size 0xbc, virtual false, abstract: false, final false
  inline void OverrideOverlayTextureInfo(::UnityEngine::Texture* srcTexture, ::System::IntPtr nativePtr, ::UnityEngine::XR::XRNode node);

  /// @brief Method PopulateLayer, addr 0x5d39964, size 0xaa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetEditorPreview, addr 0x5d3a88c, size 0xc, virtual false, abstract: false, final false
  inline void ResetEditorPreview();

  /// @brief Method SetPerLayerColorScaleAndOffset, addr 0x5d38abc, size 0x14, virtual false, abstract: false, final false
  inline void SetPerLayerColorScaleAndOffset(::UnityEngine::Vector4 scale, ::UnityEngine::Vector4 offset);

  /// @brief Method SetSrcDestRects, addr 0x5d38998, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupEditorPreview, addr 0x5d37a44, size 0x4, virtual false, abstract: false, final false
  inline void SetupEditorPreview();

  /// @brief Method SubmitLayer, addr 0x5d3a404, size 0x488, virtual false, abstract: false, final false
  ...
  /// @brief Method TrySubmitLayer, addr 0x5d3bf44, size 0x574, virtual false, abstract: false, final false
  inline bool TrySubmitLayer();

  /// @brief Method UpdateTextureRectMatrix, addr 0x5d389c0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d3c570, size 0x1d0, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_OpenVROverlayKey, addr 0x5d3acbc, size 0xac, virtual false, abstract: false, final false
  static inline ::StringW get_OpenVROverlayKey();

  /// @brief Method get_isOverlayVisible, addr 0x5d37be4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isOverlayVisible();

  /// @brief Method get_layerId, addr 0x5d37b04, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layerId();

  /// @brief Method get_layout, addr 0x5d37b14, size 0xd0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_LayerLayout get_layout();

  /// @brief Method get_previewInEditor, addr 0x5d37a24, size 0x8, virtual false, abstract: false, final false
  inline bool get_previewInEditor();

  /// @brief Method get_texturesPerStage, addr 0x5d37bf4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isOverlayVisible, addr 0x5d37bec, size 0x8, virtual false, abstract: false, final false
  inline void set_isOverlayVisible(bool value);

  /// @brief Method set_layerId, addr 0x5d37b0c, size 0x8, virtual false, abstract: false, final false
  inline void set_layerId(int32_t value);

  /// @brief Method set_previewInEditor, addr 0x5d37a2c, size 0x18, virtual false, abstract: false, final false
