...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3fd91a4, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x3fd91c4, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3fd9190, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::GlobalNamespace::OVROverlay_ExternalSurfaceObjectCreated* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x3fd9108, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x3fd79d0, size 0x314, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method BlitSubImage, addr 0x3fd6c6c, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputePoseAndScale, addr 0x3fd809c, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeSubmit, addr 0x3fd8410, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLayer, addr 0x3fd5440, size 0x41c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLayerTextures, addr 0x3fd585c, size 0x518, virtual false, abstract: false, final false
  inline bool CreateLayerTextures(bool useMipmaps, ::GlobalNamespace::OVRPlugin_Sizei size, bool isHdr);

  /// @brief Method DestroyLayer, addr 0x3fd5e98, size 0x28c, virtual false, abstract: false, final false
  inline void DestroyLayer();

  /// @brief Method DestroyLayerTextures, addr 0x3fd5d74, size 0x124, virtual false, abstract: false, final false
  inline void DestroyLayerTextures();

  /// @brief Method GetBlitRect, addr 0x3fd6c04, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetBlitRect(int32_t eyeId);

  /// @brief Method GetCurrentLayerDesc, addr 0x3fd6734, size 0x4d0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_LayerDesc GetCurrentLayerDesc();

  /// @brief Method InitOVROverlay, addr 0x3fd7df4, size 0x16c, virtual false, abstract: false, final false
  inline void InitOVROverlay();

  /// @brief Method IsPassthroughShape, addr 0x3fd53e8, size 0x58, virtual false, abstract: false, final false
  static inline bool IsPassthroughShape(::GlobalNamespace::OVROverlay_OverlayShape shape);

  /// @brief Method LatchLayerTextures, addr 0x3fd6304, size 0x430, virtual false, abstract: false, final false
  inline bool LatchLayerTextures();

  /// @brief Method LateUpdate, addr 0x3fd89b4, size 0x564, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method NeedsTexturesForShape, addr 0x3fd5388, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3fd8084, size 0x18, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x3fd7f60, size 0x124, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3fd7d84, size 0x70, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OpenVROverlayUpdate, addr 0x3fd86c0, size 0x2f4, virtual false, abstract: false, final false
  inline void OpenVROverlayUpdate(::UnityEngine::Vector3 scale, ::GlobalNamespace::OVRPose pose);

  /// @brief Method OverrideOverlayTextureInfo, addr 0x3fd51d4, size 0xbc, virtual false, abstract: false, final false
  inline void OverrideOverlayTextureInfo(::UnityEngine::Texture* srcTexture, ::System::IntPtr nativePtr, ::UnityEngine::XR::XRNode node);

  /// @brief Method PopulateLayer, addr 0x3fd6ebc, size 0x6d4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPerLayerColorScaleAndOffset, addr 0x3fd62f0, size 0x14, virtual false, abstract: false, final false
  inline void SetPerLayerColorScaleAndOffset(::UnityEngine::Vector4 scale, ::UnityEngine::Vector4 offset);

  /// @brief Method SetSrcDestRects, addr 0x3fd6124, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupEditorPreview, addr 0x3fd51d0, size 0x4, virtual false, abstract: false, final false
  inline void SetupEditorPreview();

  /// @brief Method SubmitLayer, addr 0x3fd7590, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateTextureRectMatrix, addr 0x3fd6144, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3fd8f18, size 0x188, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_OpenVROverlayKey, addr 0x3fd7ce4, size 0xa0, virtual false, abstract: false, final false
  static inline ::StringW get_OpenVROverlayKey();

  /// @brief Method get_layerId, addr 0x3fd5290, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layerId();

  /// @brief Method get_layout, addr 0x3fd52a0, size 0xcc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_LayerLayout get_layout();

  /// @brief Method get_previewInEditor, addr 0x3fd51b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_previewInEditor();

  /// @brief Method get_texturesPerStage, addr 0x3fd536c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_layerId, addr 0x3fd5298, size 0x8, virtual false, abstract: false, final false
  inline void set_layerId(int32_t value);

  /// @brief Method set_previewInEditor, addr 0x3fd51b8, size 0x18, virtual false, abstract: false, final false
