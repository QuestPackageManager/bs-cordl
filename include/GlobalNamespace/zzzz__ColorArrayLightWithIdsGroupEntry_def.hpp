...
public:
  ...
  /// @brief Method .ctor, addr 0x39e6c20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x39e6c18, size 0x8, virtual false, abstract: false, final false
