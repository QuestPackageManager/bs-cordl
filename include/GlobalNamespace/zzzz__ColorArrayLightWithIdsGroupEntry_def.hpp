...
public:
  ...
  /// @brief Method .ctor, addr 0x5727298, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x5727290, size 0x8, virtual false, abstract: false, final false
