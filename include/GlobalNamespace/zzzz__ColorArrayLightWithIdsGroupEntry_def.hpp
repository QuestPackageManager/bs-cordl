...
public:
  ...
  /// @brief Method .ctor, addr 0x23fa1e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x23fa1dc, size 0x8, virtual false, abstract: false, final false
