...
public:
  ...
  /// @brief Method .ctor, addr 0x251ff58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x251ff50, size 0x8, virtual false, abstract: false, final false
