...
public:
  ...
  /// @brief Method .ctor, addr 0x565897c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x5658974, size 0x8, virtual false, abstract: false, final false
