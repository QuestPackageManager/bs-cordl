...
public:
  ...
  /// @brief Method .ctor, addr 0x23f21e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x23f21e0, size 0x8, virtual false, abstract: false, final false
