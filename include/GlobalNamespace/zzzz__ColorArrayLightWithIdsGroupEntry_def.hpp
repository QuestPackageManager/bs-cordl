...
public:
  ...
  /// @brief Method .ctor, addr 0x24f1dd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x24f1dcc, size 0x8, virtual false, abstract: false, final false
