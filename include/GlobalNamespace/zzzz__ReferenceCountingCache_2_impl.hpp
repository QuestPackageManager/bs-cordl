...
template<typename TKey,typename TValue>
inline ::System::Collections::Generic::IEnumerable_1<TValue>* GlobalNamespace::ReferenceCountingCache_2<TKey,TValue>::get_values()  {
...
// Ctor Parameters []
template<typename TKey,typename TValue>
constexpr ::GlobalNamespace::ReferenceCountingCache_2<TKey,TValue>::ReferenceCountingCache_2()   {
}
