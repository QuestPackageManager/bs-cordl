...
public:
  ...
  /// @brief Method Awake, addr 0x39dc16c, size 0x20, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::ParametricBoxFrameController* New_ctor();

  /// @brief Method OnDisable, addr 0x39dc2d0, size 0x20, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39dc18c, size 0x28, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x39dc1b4, size 0x11c, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x39dc2f0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_localPosition, addr 0x39dc104, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method set_localPosition, addr 0x39dc124, size 0x48, virtual false, abstract: false, final false
