...
public:
  ...
  /// @brief Method Awake, addr 0x5721878, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::ParametricBoxFrameController* New_ctor();

  /// @brief Method OnDisable, addr 0x57219cc, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5721894, size 0x28, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x57218bc, size 0x110, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x57219e8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_localPosition, addr 0x5721810, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method set_localPosition, addr 0x5721830, size 0x48, virtual false, abstract: false, final false
