...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "INoteControllerNoteDidStartJumpEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INoteControllerNoteDidStartJumpEvent(INoteControllerNoteDidStartJumpEventconst&) = delete;
