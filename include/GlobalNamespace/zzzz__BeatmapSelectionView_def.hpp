...
/// @brief Method SetBeatmap, addr 0x573e90c, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x573e9d8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
