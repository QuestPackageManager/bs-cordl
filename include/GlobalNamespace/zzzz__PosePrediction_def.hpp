...
public:
  // Declarations
  /// @brief Method InterpolatePose, addr 0x22a9d68, size 0x2fc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose InterpolatePose(::UnityEngine::Pose prev, ::UnityEngine::Pose curr, float_t t);

  /// @brief Method InterpolatePoseSerializable, addr 0x22aa144, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPose, addr 0x22a9c78, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPoseSerializable, addr 0x22aa064, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22aa234, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
