...
public:
  // Declarations
  /// @brief Method InterpolatePose, addr 0x3224a60, size 0x2d0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose InterpolatePose(::UnityEngine::Pose prev, ::UnityEngine::Pose curr, float_t t);

  /// @brief Method InterpolatePoseSerializable, addr 0x3224e60, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPose, addr 0x3224970, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPoseSerializable, addr 0x3224d30, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3224f80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
