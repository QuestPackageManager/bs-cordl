...
public:
  // Declarations
  /// @brief Method InterpolatePose, addr 0xecbee8, size 0x2cc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose InterpolatePose(::UnityEngine::Pose prev, ::UnityEngine::Pose curr, float_t t);

  /// @brief Method InterpolatePoseSerializable, addr 0xecc294, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPose, addr 0xecbdf8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPoseSerializable, addr 0xecc1b4, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xecc384, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
