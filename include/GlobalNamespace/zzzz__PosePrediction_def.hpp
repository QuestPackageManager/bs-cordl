...
public:
  // Declarations
  /// @brief Method InterpolatePose, addr 0xeec5f0, size 0x2cc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose InterpolatePose(::UnityEngine::Pose prev, ::UnityEngine::Pose curr, float_t t);

  /// @brief Method InterpolatePoseSerializable, addr 0xeec99c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPose, addr 0xeec500, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPoseSerializable, addr 0xeec8bc, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeeca8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
