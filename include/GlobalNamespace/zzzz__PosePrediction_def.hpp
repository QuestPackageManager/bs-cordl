...
public:
  // Declarations
  /// @brief Method InterpolatePose, addr 0x10bf108, size 0x2cc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose InterpolatePose(::UnityEngine::Pose prev, ::UnityEngine::Pose curr, float_t t);

  /// @brief Method InterpolatePoseSerializable, addr 0x10bf4b4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPose, addr 0x10bf018, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPoseSerializable, addr 0x10bf3d4, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10bf5a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
