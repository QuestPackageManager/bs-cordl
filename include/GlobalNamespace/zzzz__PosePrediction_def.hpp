...
public:
  // Declarations
  /// @brief Method InterpolatePose, addr 0x10cb400, size 0x2cc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose InterpolatePose(::UnityEngine::Pose prev, ::UnityEngine::Pose curr, float_t t);

  /// @brief Method InterpolatePoseSerializable, addr 0x10cb7ac, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPose, addr 0x10cb310, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PredictPoseSerializable, addr 0x10cb6cc, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cb89c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
