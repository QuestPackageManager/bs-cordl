...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WillNotBeUsedAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WillNotBeUsedAttribute(WillNotBeUsedAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WillNotBeUsedAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WillNotBeUsedAttribute(WillNotBeUsedAttributeconst&) = delete;
