...
public:
  ...
  /// @brief Method .ctor, addr 0x2701054, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alternativeHandling, addr 0x2700f7c, size 0x28, virtual true, abstract: false, final false
  inline bool get_alternativeHandling();

  /// @brief Method get_leftPositionOffset, addr 0x2700fa4, size 0x2c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftPositionOffset();

  /// @brief Method get_leftRotationOffset, addr 0x2700fd0, size 0x2c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftRotationOffset();

  /// @brief Method get_positionOffset, addr 0x2700f34, size 0x24, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_positionOffset();

  /// @brief Method get_rightPositionOffset, addr 0x2700ffc, size 0x2c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_rightPositionOffset();

  /// @brief Method get_rightRotationOffset, addr 0x2701028, size 0x2c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_rightRotationOffset();

  /// @brief Method get_rotationOffset, addr 0x2700f58, size 0x24, virtual true, abstract: false, final false
