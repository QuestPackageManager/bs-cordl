...
public:
  ...
  /// @brief Method .ctor, addr 0x3658e8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alternativeHandling, addr 0x3658db4, size 0x28, virtual true, abstract: false, final false
  inline bool get_alternativeHandling();

  /// @brief Method get_leftPositionOffset, addr 0x3658ddc, size 0x2c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftPositionOffset();

  /// @brief Method get_leftRotationOffset, addr 0x3658e08, size 0x2c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftRotationOffset();

  /// @brief Method get_rightPositionOffset, addr 0x3658e34, size 0x2c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_rightPositionOffset();

  /// @brief Method get_rightRotationOffset, addr 0x3658e60, size 0x2c, virtual true, abstract: false, final false
