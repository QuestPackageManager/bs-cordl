...
public:
  ...
  /// @brief Method Awake, addr 0x57205f4, size 0x16c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateMesh, addr 0x5720894, size 0x2d0, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> CreateMesh();

  /// @brief Method InitIfNeeded, addr 0x5720760, size 0x134, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::Parametric3SliceSpriteController* New_ctor();

  /// @brief Method OnDestroy, addr 0x5720c10, size 0xc8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5720bf4, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5720bd8, size 0x1c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x5720cd8, size 0x1f8, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method Start, addr 0x5720b64, size 0x74, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5720ed0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_collisionLength, addr 0x57205e4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_collisionLength();

  /// @brief Method get_useCollision, addr 0x57205d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_collisionLength, addr 0x57205ec, size 0x8, virtual false, abstract: false, final false
  inline void set_collisionLength(float_t value);

  /// @brief Method set_useCollision, addr 0x57205dc, size 0x8, virtual false, abstract: false, final false
