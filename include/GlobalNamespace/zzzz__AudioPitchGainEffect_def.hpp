...
public:
  ...
  /// @brief Method MoveNext, addr 0x3acef78, size 0x184, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::AudioPitchGainEffect__StartEffectCoroutine_d__8* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3acf0fc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3acf104, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3acf13c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3acef74, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3aceec8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InterruptEffect, addr 0x3acef18, size 0x40, virtual false, abstract: false, final false
  inline void InterruptEffect();

  static inline ::GlobalNamespace::AudioPitchGainEffect* New_ctor();

  /// @brief Method SetAudioSource, addr 0x3acef58, size 0x8, virtual false, abstract: false, final false
  inline void SetAudioSource(::UnityEngine::AudioSource* audioSource);

  /// @brief Method Start, addr 0x3acee20, size 0x28, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartEffect, addr 0x3aceef0, size 0x28, virtual false, abstract: false, final false
  inline void StartEffect(float_t volumeScale, ::System::Action* finishCallback);

  /// @brief Method StartEffectCoroutine, addr 0x3acee48, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3acef60, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
