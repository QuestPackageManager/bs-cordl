...
public:
  // Declarations
  /// @brief Method CanConvert, addr 0x272bff4, size 0x88, virtual true, abstract: false, final false
  inline bool CanConvert(::System::Type* objectType);

  static inline ::GlobalNamespace::SongPackMaskConverter* New_ctor();

  /// @brief Method ReadJson, addr 0x272c07c, size 0x94, virtual true, abstract: false, final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WriteJson, addr 0x272c110, size 0xa8, virtual true, abstract: false, final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method .ctor, addr 0x272c1b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
