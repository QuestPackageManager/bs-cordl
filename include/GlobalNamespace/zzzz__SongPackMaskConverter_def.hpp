...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SongPackMaskConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SongPackMaskConverter(SongPackMaskConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SongPackMaskConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SongPackMaskConverter(SongPackMaskConverterconst&) = delete;
