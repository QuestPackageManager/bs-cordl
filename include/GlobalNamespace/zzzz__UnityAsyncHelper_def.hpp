...
public:
  ...
  /// @brief Method MoveNext, addr 0xe52648, size 0x234, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0xe5287c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0xe52888, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0xe528b0, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0xe528b4, size 0xcc, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0xe52980, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0xe52988, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0xe529c8, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0xe525d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <WaitUntilAsync>g__WaitUntilPredicateTrue|0, addr 0xe525e0, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeSafe, addr 0xe52460, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitUntilAsync, addr 0xe524f4, size 0xe4, virtual false, abstract: false, final false
