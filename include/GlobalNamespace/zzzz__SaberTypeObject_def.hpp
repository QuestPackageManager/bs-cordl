...
public:
  ...
  /// @brief Method .ctor, addr 0x261f920, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_saberType, addr 0x261f918, size 0x8, virtual false, abstract: false, final false
