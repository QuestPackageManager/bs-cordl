...
public:
  ...
  /// @brief Method .ctor, addr 0x3b70a90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_saberType, addr 0x3b70a88, size 0x8, virtual false, abstract: false, final false
