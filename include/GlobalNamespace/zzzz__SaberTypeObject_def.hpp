...
public:
  ...
  /// @brief Method .ctor, addr 0x3be72d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_saberType, addr 0x3be72c8, size 0x8, virtual false, abstract: false, final false
