...
public:
  ...
  /// @brief Method .ctor, addr 0x2753794, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_saberType, addr 0x275378c, size 0x8, virtual false, abstract: false, final false
