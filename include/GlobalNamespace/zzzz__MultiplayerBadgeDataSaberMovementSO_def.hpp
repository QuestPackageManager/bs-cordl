...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerBadgeDataSaberMovementSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBadgeDataSaberMovementSO*, "", "MultiplayerBadgeDataSaberMovementSO");
...
public:
  // Declarations
  /// @brief Method GetValue, addr 0x37351ec, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3735218, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerBadgeDataSaberMovementSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerBadgeDataSaberMovementSO(MultiplayerBadgeDataSaberMovementSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerBadgeDataSaberMovementSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerBadgeDataSaberMovementSO(MultiplayerBadgeDataSaberMovementSOconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgeDataSaberMovementSO) == 0x38, "Size mismatch!");
