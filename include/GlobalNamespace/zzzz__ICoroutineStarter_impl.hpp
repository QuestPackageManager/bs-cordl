...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Coroutine* (::GlobalNamespace::ICoroutineStarter::*)(::System::Collections::IEnumerator*)>(&::GlobalNamespace::ICoroutineStarter::StartCoroutine)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ICoroutineStarter::*)(::UnityEngine::Coroutine*)>(&::GlobalNamespace::ICoroutineStarter::StopCoroutine)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
