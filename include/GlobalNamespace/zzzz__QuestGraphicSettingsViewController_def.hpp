...
public:
  ...
  /// @brief Method <ShouldShowStinsonEntries>b__7_0, addr 0x57a8e30, size 0x1c, virtual false, abstract: false, final false
  inline bool _ShouldShowStinsonEntries_b__7_0(float_t freq);

  /// @brief Method .ctor, addr 0x57a8e2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x57a887c, size 0x228, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57a8c30, size 0x14c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Handle120HzToggleValueChanged, addr 0x57a8d94, size 0x40, virtual false, abstract: false, final false
  inline void Handle120HzToggleValueChanged(bool newState);

  /// @brief Method HandleMirrorChanged, addr 0x57a8d7c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldShowStinsonEntries, addr 0x57a8aa4, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a8dd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
