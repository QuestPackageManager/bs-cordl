...
public:
  ...
  /// @brief Method SetColor, addr 0x57e2fac, size 0x38, virtual false, abstract: false, final false
  inline void SetColor(::UnityEngine::Color color);

  /// @brief Method Start, addr 0x57e2f80, size 0x2c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x57e2fe4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
