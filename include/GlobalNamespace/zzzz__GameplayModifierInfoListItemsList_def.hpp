...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(4722)), TypeDefinitionIndex(TypeDefinitionIndex(13627)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13627), inst:
// 5196 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(4723)) CS Name: ::GameplayModifierInfoListItemsList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x23d4830, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
