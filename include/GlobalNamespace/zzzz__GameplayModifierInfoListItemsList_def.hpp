...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5419)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13674), inst: 5216 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13674))} Self: TypeDefinitionIndex(TypeDefinitionIndex(5420)) CS Name: ::GameplayModifierInfoListItemsList*
