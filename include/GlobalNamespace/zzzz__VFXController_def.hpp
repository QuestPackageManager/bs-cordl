...
public:
  ...
  /// @brief Method MoveNext, addr 0x39c7514, size 0x180, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::VFXController__MainCoroutine_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x39c7694, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x39c769c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x39c76d4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x39c7510, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39c74e0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x39c7328, size 0x24, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method MainCoroutine, addr 0x39c745c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Play, addr 0x39c734c, size 0x110, virtual false, abstract: false, final false
  inline void Play();
  ...
  /// @brief Method .ctor, addr 0x39c7508, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animation, addr 0x39c7318, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animation> get_animation();

  /// @brief Method get_particleSystems, addr 0x39c7320, size 0x8, virtual false, abstract: false, final false
