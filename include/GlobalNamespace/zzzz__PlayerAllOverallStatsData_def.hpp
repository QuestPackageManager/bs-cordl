...
public:
  ...
  /// @brief Method UpdateWithLevelCompletionResults, addr 0x3685de4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3685d6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36860ac, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_badCutsCount, addr 0x368600c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_badCutsCount();

  /// @brief Method get_clearedLevelsCount, addr 0x368604c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_clearedLevelsCount();

  /// @brief Method get_failedLevelsCount, addr 0x368605c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_failedLevelsCount();

  /// @brief Method get_fullComboCount, addr 0x368606c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_fullComboCount();

  /// @brief Method get_goodCutsCount, addr 0x3685ffc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_goodCutsCount();

  /// @brief Method get_handDistanceTravelled, addr 0x368608c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_handDistanceTravelled();

  /// @brief Method get_missedCutsCount, addr 0x368601c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_missedCutsCount();

  /// @brief Method get_playedLevelsCount, addr 0x368603c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_playedLevelsCount();

  /// @brief Method get_timePlayed, addr 0x368607c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timePlayed();

  /// @brief Method get_totalCutScore, addr 0x368609c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_totalCutScore();

  /// @brief Method get_totalScore, addr 0x368602c, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_totalScore();

  /// @brief Method op_Addition, addr 0x3685760, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method set_badCutsCount, addr 0x3686014, size 0x8, virtual false, abstract: false, final false
  inline void set_badCutsCount(int32_t value);

  /// @brief Method set_clearedLevelsCount, addr 0x3686054, size 0x8, virtual false, abstract: false, final false
  inline void set_clearedLevelsCount(int32_t value);

  /// @brief Method set_failedLevelsCount, addr 0x3686064, size 0x8, virtual false, abstract: false, final false
  inline void set_failedLevelsCount(int32_t value);

  /// @brief Method set_fullComboCount, addr 0x3686074, size 0x8, virtual false, abstract: false, final false
  inline void set_fullComboCount(int32_t value);

  /// @brief Method set_goodCutsCount, addr 0x3686004, size 0x8, virtual false, abstract: false, final false
  inline void set_goodCutsCount(int32_t value);

  /// @brief Method set_handDistanceTravelled, addr 0x3686094, size 0x8, virtual false, abstract: false, final false
  inline void set_handDistanceTravelled(int32_t value);

  /// @brief Method set_missedCutsCount, addr 0x3686024, size 0x8, virtual false, abstract: false, final false
  inline void set_missedCutsCount(int32_t value);

  /// @brief Method set_playedLevelsCount, addr 0x3686044, size 0x8, virtual false, abstract: false, final false
  inline void set_playedLevelsCount(int32_t value);

  /// @brief Method set_timePlayed, addr 0x3686084, size 0x8, virtual false, abstract: false, final false
  inline void set_timePlayed(float_t value);

  /// @brief Method set_totalCutScore, addr 0x36860a4, size 0x8, virtual false, abstract: false, final false
  inline void set_totalCutScore(int64_t value);

  /// @brief Method set_totalScore, addr 0x3686034, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method UpdateCampaignOverallStatsData, addr 0x3685f64, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateOnlinePlayOverallStatsData, addr 0x3685fd0, size 0x2c, virtual false, abstract: false, final false
  inline void UpdateOnlinePlayOverallStatsData(::GlobalNamespace::LevelCompletionResults* levelCompletionResults);

  /// @brief Method UpdatePartyFreePlayOverallStatsData, addr 0x3685efc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateSoloFreePlayOverallStatsData, addr 0x3685d7c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3685cec, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3685d70, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* campaignOverallStatsData,
                    ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* soloFreePlayOverallStatsData,
                    ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* partyFreePlayOverallStatsData,
                    ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* onlinePlayOverallStatsData);

  /// @brief Method add_didUpdateCampaignOverallStatsDataEvent, addr 0x3685b6c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didUpdatePartyFreePlayOverallStatsDataEvent, addr 0x36859ec, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didUpdateSoloFreePlayOverallStatsDataEvent, addr 0x368586c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_allOverallStatsData, addr 0x3685738, size 0x28, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* get_allOverallStatsData();

  /// @brief Method get_campaignOverallStatsData, addr 0x368584c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* get_campaignOverallStatsData();

  /// @brief Method get_onlinePlayOverallStatsData, addr 0x3685864, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* get_onlinePlayOverallStatsData();

  /// @brief Method get_partyFreePlayOverallStatsData, addr 0x368585c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* get_partyFreePlayOverallStatsData();

  /// @brief Method get_soloFreePlayOverallStatsData, addr 0x3685854, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData_PlayerOverallStatsData* get_soloFreePlayOverallStatsData();

  /// @brief Method remove_didUpdateCampaignOverallStatsDataEvent, addr 0x3685c2c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didUpdatePartyFreePlayOverallStatsDataEvent, addr 0x3685aac, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didUpdateSoloFreePlayOverallStatsDataEvent, addr 0x368592c, size 0xc0, virtual false, abstract: false, final false
