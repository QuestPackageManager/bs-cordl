...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4681))}
...
public:
  ...
  /// @brief Method .ctor addr 0x222e078 size 0x4 virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::PS4LevelProductsModelSO, 0x30>, "Size mismatch!");
