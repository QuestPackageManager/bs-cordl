...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CvarBoolCommand", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CvarBoolCommand(CvarBoolCommand&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CvarBoolCommand", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CvarBoolCommand(CvarBoolCommandconst&) = delete;
