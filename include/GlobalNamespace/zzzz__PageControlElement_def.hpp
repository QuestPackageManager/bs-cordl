...
public:
  ...
  /// @brief Method SetSelected, addr 0x269b30c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x269b540, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x269b538, size 0x8, virtual false, abstract: false, final false
