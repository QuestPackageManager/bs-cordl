...
public:
  ...
  /// @brief Method SetSelected, addr 0x2687990, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2687bc4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x2687bbc, size 0x8, virtual false, abstract: false, final false
