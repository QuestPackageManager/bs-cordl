...
public:
  ...
  /// @brief Method SetSelected, addr 0x596edac, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x596ef1c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x596ef14, size 0x8, virtual false, abstract: false, final false
