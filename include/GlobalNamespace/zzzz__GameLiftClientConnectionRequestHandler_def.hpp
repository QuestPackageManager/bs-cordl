...
public:
  ...
  /// @brief Method GetConnectionMessage, addr 0xec8254, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method ValidateConnectionMessage, addr 0xec82c4, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xec82d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playerSessionId, addr 0xec8244, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_playerSessionId, addr 0xec824c, size 0x8, virtual false, abstract: false, final false
