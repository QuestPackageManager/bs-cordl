...
public:
  ...
  /// @brief Method GetConnectionMessage, addr 0x320f9c0, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method ValidateConnectionMessage, addr 0x320fa44, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x320fabc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playerSessionId, addr 0x320f9b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_playerSessionId, addr 0x320f9b8, size 0x8, virtual false, abstract: false, final false
