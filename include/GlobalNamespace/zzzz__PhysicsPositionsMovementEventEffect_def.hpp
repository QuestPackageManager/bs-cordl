...
/// @brief Field _songTimeFixedUpdateController, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__songTimeFixedUpdateController, put=__cordl_internal_set__songTimeFixedUpdateController)) ::UnityW<::GlobalNamespace::SongTimeFixedUpdateController>  _songTimeFixedUpdateController;
...
/// @brief Method HandleBeatmapEvent, addr 0x57ee648, size 0x7c, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

/// @brief Method HandleSongTimeFixedUpdate, addr 0x57ee4f8, size 0xdc, virtual false, abstract: false, final false
inline void HandleSongTimeFixedUpdate(float_t  fixedDeltaTime) ;

/// @brief Method HandleSongTimeUpdate, addr 0x57ee5d4, size 0x74, virtual false, abstract: false, final false
inline void HandleSongTimeUpdate() ;

static inline ::GlobalNamespace::PhysicsPositionsMovementEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57ee338, size 0x1c0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57ee068, size 0x2d0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57ee6c4, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
