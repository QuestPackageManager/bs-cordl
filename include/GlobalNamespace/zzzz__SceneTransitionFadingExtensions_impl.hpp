...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::GlobalNamespace::__GameScenesManager__SceneTransitionType)>(
    &::GlobalNamespace::SceneTransitionFadingExtensions::ShouldFadeOnSceneTransition)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x4023340;
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ...
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__GameScenesManager__SceneTransitionType>::get() })));
