...
public:
  ...
  /// @brief Method Tick, addr 0x244fa40, size 0xcc, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x244fb0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_menuButtonTriggeredEvent, addr 0x244f908, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_menuButtonTriggeredEvent, addr 0x244f9a4, size 0x9c, virtual true, abstract: false, final true
