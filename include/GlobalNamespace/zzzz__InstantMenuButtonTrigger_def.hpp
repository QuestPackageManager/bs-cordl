...
public:
  ...
  /// @brief Method Tick, addr 0x3bb0084, size 0xcc, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x3bb0150, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_menuButtonTriggeredEvent, addr 0x3baff4c, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_menuButtonTriggeredEvent, addr 0x3baffe8, size 0x9c, virtual true, abstract: false, final true
