...
public:
  ...
  /// @brief Method Tick, addr 0x3ba6ab8, size 0xcc, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x3ba6b84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_menuButtonTriggeredEvent, addr 0x3ba6980, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_menuButtonTriggeredEvent, addr 0x3ba6a1c, size 0x9c, virtual true, abstract: false, final true
