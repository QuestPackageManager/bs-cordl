...
public:
  ...
  /// @brief Method Tick, addr 0x5800f2c, size 0xd0, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x5800ffc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_menuButtonTriggeredEvent, addr 0x5800dd4, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_menuButtonTriggeredEvent, addr 0x5800e80, size 0xac, virtual true, abstract: false, final true
