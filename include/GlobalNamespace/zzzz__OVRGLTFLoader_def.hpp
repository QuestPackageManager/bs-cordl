...
public:
  ...
  /// @brief Method <ProcessMesh>b__0, addr 0x3fb3270, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3fb16a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyTextureQuality, addr 0x3faf99c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUnityMaterial, addr 0x3fb2b70, size 0x274, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> CreateUnityMaterial(::GlobalNamespace::OVRMaterialData matData, bool loadMips);

  /// @brief Method DetectTextureQuality, addr 0x3faf8dc, size 0xc0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTextureQualityFiltering DetectTextureQuality(::ByRef<::UnityEngine::Texture2D*> srcTexture);

  /// @brief Method FlipTraingleIndices, addr 0x3fb1f34, size 0x6c, virtual false, abstract: false, final false
  static inline void FlipTraingleIndices(::ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> indices);

  /// @brief Method GetInputNodeType, addr 0x3fb2e98, size 0x19c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRGLTFInputNode GetInputNodeType(::StringW name);

  /// @brief Method LoadGLB, addr 0x3faeadc, size 0x63c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRGLTFScene LoadGLB(bool supportAnimation, bool loadMips);

  /// @brief Method LoadGLTF, addr 0x3faf4b4, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAnimations, addr 0x3fb0454, size 0x518, virtual false, abstract: false, final false
  inline void ProcessAnimations();

  /// @brief Method ProcessMaterial, addr 0x3fb16ac, size 0x388, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRMaterialData ProcessMaterial(int32_t matId);

  /// @brief Method ProcessMesh, addr 0x3fb096c, size 0x91c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRMeshData ProcessMesh(::OVRSimpleJSON::JSONNode* meshNode, bool loadMips);

  /// @brief Method ProcessNode, addr 0x3fafb10, size 0x944, virtual false, abstract: false, final false
  inline void ProcessNode(::OVRSimpleJSON::JSONNode* node, int32_t nodeId, bool loadMips);

  /// @brief Method ProcessSkin, addr 0x3fb1288, size 0x41c, virtual false, abstract: false, final false
  inline void ProcessSkin(::OVRSimpleJSON::JSONNode* skinNode, ::UnityEngine::SkinnedMeshRenderer* renderer);

  /// @brief Method ProcessTexture, addr 0x3fb1a34, size 0x500, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTextureData ProcessTexture(int32_t textureId);

  /// @brief Method ReadChunk, addr 0x3faf2e4, size 0xac, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadChunk(::System::IO::Stream* glbStream, ::GlobalNamespace::OVRChunkType type);

  /// @brief Method ReadMeshAttributes, addr 0x3fb1fa0, size 0xbd0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMipMapBias, addr 0x3faf8c0, size 0x1c, virtual false, abstract: false, final false
  inline void SetMipMapBias(float_t loadedTexturesMipmapBiasing);

  /// @brief Method SetModelAlphaBlendShader, addr 0x3faf8b0, size 0x8, virtual false, abstract: false, final false
  inline void SetModelAlphaBlendShader(::UnityEngine::Shader* shader);

  /// @brief Method SetModelShader, addr 0x3faf8a8, size 0x8, virtual false, abstract: false, final false
  inline void SetModelShader(::UnityEngine::Shader* shader);

  /// @brief Method SetTextureQualityFiltering, addr 0x3faf8b8, size 0x8, virtual false, abstract: false, final false
  inline void SetTextureQualityFiltering(::GlobalNamespace::OVRTextureQualityFiltering loadedTexturesQuality);

  /// @brief Method TranscodeTexture, addr 0x3fb2de4, size 0xb4, virtual false, abstract: false, final false
  inline void TranscodeTexture(::ByRef<::GlobalNamespace::OVRTextureData> textureData);

  /// @brief Method ValidateChunk, addr 0x3faf390, size 0x124, virtual false, abstract: false, final false
  inline bool ValidateChunk(::System::IO::Stream* glbStream, ::GlobalNamespace::OVRChunkType type, ::ByRef<uint32_t> chunkLength);

  /// @brief Method ValidateGLB, addr 0x3faf118, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3faea58, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x3faea20, size 0x38, virtual false, abstract: false, final false
