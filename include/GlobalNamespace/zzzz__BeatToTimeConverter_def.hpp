...
public:
  ...
  /// @brief Method BeatToTime, addr 0x36530a0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3653098, size 0x8, virtual false, abstract: false, final false
