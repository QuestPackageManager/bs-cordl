...
public:
  ...
  /// @brief Method BeatToTime, addr 0x26b7e94, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b7e6c, size 0x28, virtual false, abstract: false, final false
