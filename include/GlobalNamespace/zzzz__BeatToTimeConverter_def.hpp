...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatToTimeConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatToTimeConverter(BeatToTimeConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatToTimeConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatToTimeConverter(BeatToTimeConverterconst&) = delete;
