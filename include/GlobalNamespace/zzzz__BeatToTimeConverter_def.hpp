...
public:
  ...
  /// @brief Method BeatToTime, addr 0x26baadc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26baab4, size 0x28, virtual false, abstract: false, final false
