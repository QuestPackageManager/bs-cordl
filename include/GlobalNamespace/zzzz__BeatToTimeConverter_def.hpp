...
public:
  ...
  /// @brief Method BeatToTime, addr 0x26ba7e8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ba7c0, size 0x28, virtual false, abstract: false, final false
