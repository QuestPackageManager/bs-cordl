...
/// @brief Method ConvertRect, addr 0x5c65218, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect ConvertRect(::GlobalNamespace::OVRPlugin_Rectf  openXrRect) ;

/// @brief Method Equals, addr 0x5c64f30, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x5c64de0, size 0x6c, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRBounded2D  other) ;

/// @brief Method GetHashCode, addr 0x5c64fc0, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IOVRAnchorComponent<OVRBounded2D>.FromAnchor, addr 0x5c64bb4, size 0x30, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRBounded2D IOVRAnchorComponent_OVRBounded2D__FromAnchor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method IOVRAnchorComponent<OVRBounded2D>.SetEnabledAsync, addr 0x5c64d94, size 0x4c, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRBounded2D__SetEnabledAsync(bool  enabled, double_t  timeout) ;

/// @brief Method IOVRAnchorComponent<OVRBounded2D>.get_Handle, addr 0x5c64b5c, size 0x58, virtual true, abstract: false, final true
inline uint64_t IOVRAnchorComponent_OVRBounded2D__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRBounded2D>.get_Type, addr 0x5c64b00, size 0x54, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRBounded2D__get_Type() ;

/// @brief Method ToString, addr 0x5c6502c, size 0xc0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetBoundaryPoints, addr 0x5c652c8, size 0x184, virtual false, abstract: false, final false
inline bool TryGetBoundaryPoints(::Unity::Collections::NativeArray_1<::UnityEngine::Vector2>  positions) ;

/// @brief Method TryGetBoundaryPointsCount, addr 0x5c65230, size 0x98, virtual false, abstract: false, final false
inline bool TryGetBoundaryPointsCount(::ByRef<int32_t>  count) ;

/// @brief Method .ctor, addr 0x5c64be4, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

static inline ::GlobalNamespace::OVRBounded2D getStaticF_Null() ;

/// @brief Method get_BoundingBox, addr 0x5c650f4, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_BoundingBox() ;

/// @brief Method get_Handle, addr 0x5c650ec, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_IsEnabled, addr 0x5c64cac, size 0xe8, virtual true, abstract: false, final true
inline bool get_IsEnabled() ;

/// @brief Method get_IsNull, addr 0x5c64c4c, size 0x60, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Type, addr 0x5c64b54, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x5c64e4c, size 0x70, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRBounded2D  lhs, ::GlobalNamespace::OVRBounded2D  rhs) ;

/// @brief Method op_Inequality, addr 0x5c64ebc, size 0x74, virtual false, abstract: false, final false
