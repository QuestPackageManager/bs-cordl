...
public:
// Declarations
/// @brief Method Awake, addr 0x57c41ec, size 0x24, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::UseOnlyForReflectionProbeBaking* New_ctor() ;

/// @brief Method .ctor, addr 0x57c4210, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
