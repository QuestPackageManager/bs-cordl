...
public:
  ...
  /// @brief Method <LogEvent>b__3_0, addr 0x3256edc, size 0xa4, virtual false, abstract: false, final false
  inline ::StringW _LogEvent_b__3_0(::System::Collections::Generic::KeyValuePair_2<::StringW, ::StringW> kvp);

  /// @brief Method .ctor, addr 0x3256ed8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OpenDataPrivacyPage, addr 0x3256598, size 0x4, virtual true, abstract: false, final true
  inline void OpenDataPrivacyPage();

  /// @brief Method .ctor, addr 0x3256e80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_supportsOpenDataPrivacyPage, addr 0x3256590, size 0x8, virtual true, abstract: false, final true
