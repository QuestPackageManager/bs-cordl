...
public:
  ...
  /// @brief Method .ctor, addr 0x37316a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NamedPresetsSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NamedPresetsSO(NamedPresetsSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NamedPresetsSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NamedPresetsSO(NamedPresetsSOconst&) = delete;
