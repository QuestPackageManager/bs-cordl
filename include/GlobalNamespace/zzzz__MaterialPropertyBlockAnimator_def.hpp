...
public:
  ...
  /// @brief Method Awake, addr 0x39e574c, size 0x90, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LazyInit, addr 0x39e57dc, size 0x30, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::GlobalNamespace::MaterialPropertyBlockAnimator* New_ctor();

  /// @brief Method RefreshProperty, addr 0x39e5898, size 0x20, virtual false, abstract: false, final false
  inline void RefreshProperty();

  /// @brief Method SetProperty, addr 0x39e5748, size 0x4, virtual true, abstract: false, final false
  inline void SetProperty();

  /// @brief Method Update, addr 0x39e580c, size 0x28, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x39e58b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_materialPropertyBlockController, addr 0x39e56c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MaterialPropertyBlockController> get_materialPropertyBlockController();

  /// @brief Method set_materialPropertyBlockController, addr 0x39e56cc, size 0x7c, virtual false, abstract: false, final false
