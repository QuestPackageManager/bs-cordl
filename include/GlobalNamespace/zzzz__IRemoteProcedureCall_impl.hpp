...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::IRemoteProcedureCall::*)()>(&::GlobalNamespace::IRemoteProcedureCall::get_syncTime)> {
...
inline float_t GlobalNamespace::IRemoteProcedureCall::get_syncTime() {
