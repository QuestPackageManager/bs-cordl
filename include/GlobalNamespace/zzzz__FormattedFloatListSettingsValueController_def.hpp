...
public:
  ...
  /// @brief Method ApplyValue, addr 0x240ffc8, size 0x74, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x240fee8, size 0xe0, virtual true, abstract: false, final false
  inline bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements);

  static inline ::GlobalNamespace::FormattedFloatListSettingsValueController* New_ctor();

  /// @brief Method TextForValue, addr 0x241003c, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2410118, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
