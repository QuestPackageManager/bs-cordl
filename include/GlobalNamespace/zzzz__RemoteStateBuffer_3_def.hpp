...
// Dependencies StateBuffer`3<TStateTable, TType, TState>
namespace GlobalNamespace {
// cpp template
template<typename TStateTable,typename TType,typename TState>
// Is value type: false
...
/// @brief Field _receivedDeltas, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__receivedDeltas, put=__cordl_internal_set__receivedDeltas)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>  _receivedDeltas;
...
/// @brief Field _receivedStates, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__receivedStates, put=__cordl_internal_set__receivedStates)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>  _receivedStates;

/// @brief Method Clear, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void Clear() ;

static inline ::GlobalNamespace::RemoteStateBuffer_3<TStateTable,TType,TState>* New_ctor(int32_t  size, ::GlobalNamespace::StateBuffer_3_InterpolationDelegate<TStateTable,TType,TState>*  interpolator, ::GlobalNamespace::StateBuffer_3_SmoothingDelegate<TStateTable,TType,TState>*  smoother) ;
...
constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*> const& __cordl_internal_get__receivedDeltas() const;

constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>& __cordl_internal_get__receivedDeltas() ;
...
constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*> const& __cordl_internal_get__receivedStates() const;

constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>& __cordl_internal_get__receivedStates() ;
...
constexpr void __cordl_internal_set__receivedDeltas(::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>  value) ;
...
constexpr void __cordl_internal_set__receivedStates(::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>  value) ;

/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(int32_t  size, ::GlobalNamespace::StateBuffer_3_InterpolationDelegate<TStateTable,TType,TState>*  interpolator, ::GlobalNamespace::StateBuffer_3_SmoothingDelegate<TStateTable,TType,TState>*  smoother) ;
...
/// @brief Field _receivedStates, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>  ____receivedStates;

/// @brief Field _receivedDeltas, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>  ____receivedDeltas;
