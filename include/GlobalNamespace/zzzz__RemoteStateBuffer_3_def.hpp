...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::RemoteStateBuffer_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::RemoteStateBuffer_3, "", "RemoteStateBuffer`3");
// Dependencies StateBuffer`3::TimestampedStateTable<TStateTable, TType, TState>, StateBuffer`3<TStateTable, TType, TState>
namespace GlobalNamespace {
// cpp template
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__receivedDeltas,
                      put = __cordl_internal_set__receivedDeltas)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>
      _receivedDeltas;
  ...
  __declspec(property(get = __cordl_internal_get__receivedStates,
                      put = __cordl_internal_set__receivedStates)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>
      _receivedStates;
  ...
  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> const& __cordl_internal_get__receivedDeltas() const;

  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>& __cordl_internal_get__receivedDeltas();
  ...
  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> const& __cordl_internal_get__receivedStates() const;

  constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>& __cordl_internal_get__receivedStates();
  ...
  constexpr void __cordl_internal_set__receivedDeltas(::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> value);
  ...
  constexpr void __cordl_internal_set__receivedStates(::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RemoteStateBuffer_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RemoteStateBuffer_3(RemoteStateBuffer_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RemoteStateBuffer_3", modifiers: "const&", def_value: None, comment: None }]
  ...
  ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> ____receivedStates;

  /// @brief Field _receivedDeltas, offset: 0x38, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>> ____receivedDeltas;
