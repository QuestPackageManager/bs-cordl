...
/// @brief Method .ctor, addr 0x5755c04, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::ObjectsMovementRecorder_Mode  mode, ::StringW  recordingPath, ::GlobalNamespace::ObjectsMovementRecorder_CameraView  cameraView, bool  addDateTimeSuffixToRecordingName, bool  screenshotRecording, int32_t  screenshotWidth, int32_t  screenshotHeight, int32_t  framerate, ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*,::Array<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>*>  playbackScreenshots, bool  saveToOldFormat, ::GlobalNamespace::IBeatSaberLogger*  logger, ::GlobalNamespace::IPosesSerializer*  posesSerializer) ;
...
/// @brief Field _playbackScreenshots, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__playbackScreenshots, put=__cordl_internal_set__playbackScreenshots)) ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*,::Array<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>*>  _playbackScreenshots;
...
/// @brief Method HandleGameStateChanged, addr 0x5755a88, size 0x74, virtual false, abstract: false, final false
inline void HandleGameStateChanged() ;

/// @brief Method Init, addr 0x5754a24, size 0x6b0, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::ObjectsMovementRecorder* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5755808, size 0x268, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*,::Array<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>*> const& __cordl_internal_get__playbackScreenshots() const;
...
/// @brief Method .ctor, addr 0x5755bf8, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
