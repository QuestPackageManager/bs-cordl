...
public:
  ...
  /// @brief Method .ctor, addr 0x23f6d78, size 0xa4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleGameStateChanged, addr 0x23f6c04, size 0x70, virtual false, abstract: false, final false
  inline void HandleGameStateChanged();

  /// @brief Method Init, addr 0x23f5bbc, size 0x704, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::ObjectsMovementRecorder* New_ctor();

  /// @brief Method OnDestroy, addr 0x23f69c4, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f6d68, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
