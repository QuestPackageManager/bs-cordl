...
public:
  ...
  /// @brief Method get_songPreviewAudioClipPath, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::StringW get_songPreviewAudioClipPath();

  // Ctor Parameters [CppParam { name: "", ty: "IFilePathSongPreviewAudioClipProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFilePathSongPreviewAudioClipProvider(IFilePathSongPreviewAudioClipProviderconst&) = delete;
