...
/// @brief Field didFinishEvent, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_1<::GlobalNamespace::SettingsNavigationController_FinishAction>*  didFinishEvent;

/// @brief Method DidActivate, addr 0x57ac6dc, size 0x1c0, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleFinishButton, addr 0x57ac89c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method <DidActivate>b__7_0, addr 0x57ac8c4, size 0x20, virtual false, abstract: false, final false
inline void _DidActivate_b__7_0() ;

/// @brief Method <DidActivate>b__7_1, addr 0x57ac8e4, size 0x20, virtual false, abstract: false, final false
inline void _DidActivate_b__7_1() ;

/// @brief Method <DidActivate>b__7_2, addr 0x57ac904, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ac8b8, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x57ac55c, size 0xc0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::SettingsNavigationController_FinishAction>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x57ac61c, size 0xc0, virtual false, abstract: false, final false
