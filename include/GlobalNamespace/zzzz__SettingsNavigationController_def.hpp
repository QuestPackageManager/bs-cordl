...
public:
  ...
  /// @brief Method add_didFinishEvent addr 0x2195a88 size 0xb0 virtual false final false
  inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::__SettingsNavigationController__FinishAction>* value);

  /// @brief Method remove_didFinishEvent addr 0x2195b38 size 0xb0 virtual false final false
  inline void remove_didFinishEvent(::System::Action_1<::GlobalNamespace::__SettingsNavigationController__FinishAction>* value);

  /// @brief Method DidActivate addr 0x2195be8 size 0x15c virtual true final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleFinishButton addr 0x2195d44 size 0x1c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2195d60 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <DidActivate>b__7_0 addr 0x2195d68 size 0x20 virtual false final false
  inline void _DidActivate_b__7_0();

  /// @brief Method <DidActivate>b__7_1 addr 0x2195d88 size 0x20 virtual false final false
  inline void _DidActivate_b__7_1();

  /// @brief Method <DidActivate>b__7_2 addr 0x2195da8 size 0x20 virtual false final false
