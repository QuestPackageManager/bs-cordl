...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::QueueSet_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::QueueSet_1, "", "QueueSet`1");
// [NullableContext(1)]
// [Nullable(0)]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QueueSet_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QueueSet_1(QueueSet_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QueueSet_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QueueSet_1(QueueSet_1const&) = delete;
