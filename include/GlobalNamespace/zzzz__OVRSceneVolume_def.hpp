...
public:
  ...
  /// @brief Method get_Width addr 0x278b194 size 0x8 virtual false final false
  inline float_t get_Width();

  /// @brief Method set_Width addr 0x278b19c size 0x8 virtual false final false
  inline void set_Width(float_t value);

  /// @brief Method get_Height addr 0x278b1a4 size 0x8 virtual false final false
  inline float_t get_Height();

  /// @brief Method set_Height addr 0x278b1ac size 0x8 virtual false final false
  inline void set_Height(float_t value);

  /// @brief Method get_Depth addr 0x278b1b4 size 0x8 virtual false final false
  inline float_t get_Depth();

  /// @brief Method set_Depth addr 0x278b1bc size 0x8 virtual false final false
  inline void set_Depth(float_t value);

  /// @brief Method get_Dimensions addr 0x278b1c4 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_Dimensions();

  /// @brief Method get_Offset addr 0x278b1d0 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_Offset();

  /// @brief Method set_Offset addr 0x278b1dc size 0xc virtual false final false
  inline void set_Offset(::UnityEngine::Vector3 value);

  /// @brief Method get_ScaleChildren addr 0x278b1e8 size 0x8 virtual false final false
  inline bool get_ScaleChildren();

  /// @brief Method set_ScaleChildren addr 0x278b1f0 size 0x34 virtual false final false
  inline void set_ScaleChildren(bool value);

  /// @brief Method get_OffsetChildren addr 0x278b304 size 0x8 virtual false final false
  inline bool get_OffsetChildren();

  /// @brief Method set_OffsetChildren addr 0x278b30c size 0x34 virtual false final false
  inline void set_OffsetChildren(bool value);

  /// @brief Method Awake addr 0x278b420 size 0xd4 virtual false final false
  inline void Awake();

  /// @brief Method IOVRSceneComponent.Initialize addr 0x278b4f4 size 0x4 virtual true final true
  inline void IOVRSceneComponent_Initialize();

  /// @brief Method SetChildScale addr 0x278b224 size 0xe0 virtual false final false
  inline void SetChildScale();

  /// @brief Method SetChildOffset addr 0x278b340 size 0xe0 virtual false final false
  inline void SetChildOffset();

  /// @brief Method UpdateTransform addr 0x278443c size 0x1d8 virtual false final false
  inline void UpdateTransform();

  static inline ::GlobalNamespace::OVRSceneVolume* New_ctor();

  /// @brief Method .ctor addr 0x278b4f8 size 0x10 virtual false final false
  inline void _ctor();
