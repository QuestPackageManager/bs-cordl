...
public:
  ...
  /// @brief Method get_Width, addr 0x27a74f4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Width();

  /// @brief Method set_Width, addr 0x27a74fc, size 0x8, virtual false, abstract: false, final false
  inline void set_Width(float_t value);

  /// @brief Method get_Height, addr 0x27a7504, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Height();

  /// @brief Method set_Height, addr 0x27a750c, size 0x8, virtual false, abstract: false, final false
  inline void set_Height(float_t value);

  /// @brief Method get_Depth, addr 0x27a7514, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Depth();

  /// @brief Method set_Depth, addr 0x27a751c, size 0x8, virtual false, abstract: false, final false
  inline void set_Depth(float_t value);

  /// @brief Method get_Dimensions, addr 0x27a7524, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Dimensions();

  /// @brief Method get_ScaleChildren, addr 0x27a7530, size 0x8, virtual false, abstract: false, final false
  inline bool get_ScaleChildren();

  /// @brief Method set_ScaleChildren, addr 0x27a7538, size 0x4c, virtual false, abstract: false, final false
  inline void set_ScaleChildren(bool value);

  /// @brief Method Awake, addr 0x27a7614, size 0xd4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method IOVRSceneComponent.Initialize, addr 0x27a76e8, size 0xc8, virtual true, abstract: false, final true
  inline void IOVRSceneComponent_Initialize();

  /// @brief Method SetChildScale, addr 0x27a7584, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27a77b0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
