...
public:
  // Declarations
  /// @brief Method Init, addr 0x59107a4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5910868, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
