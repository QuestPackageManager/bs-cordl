...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StartupErrorScenesTransitionSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StartupErrorScenesTransitionSetupData(StartupErrorScenesTransitionSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StartupErrorScenesTransitionSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StartupErrorScenesTransitionSetupData(StartupErrorScenesTransitionSetupDataconst&) = delete;
