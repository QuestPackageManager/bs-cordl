...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GradientLutBaker", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GradientLutBaker(GradientLutBaker&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GradientLutBaker", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GradientLutBaker(GradientLutBakerconst&) = delete;
