...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b62988, size 0x904, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b6328c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_didPressSearchButtonEvent,
                      put =
                          __cordl_internal_set_didPressSearchButtonEvent)) ::System::Action_2<::GlobalNamespace::LevelSearchViewController*, ::GlobalNamespace::LevelFilter>* didPressSearchButtonEvent;

  /// @brief Field didStartLoadingEvent, offset 0xd8, size 0x8
  __declspec(property(get = __cordl_internal_get_didStartLoadingEvent,
                      put = __cordl_internal_set_didStartLoadingEvent)) ::System::Action_1<::GlobalNamespace::LevelSearchViewController*>* didStartLoadingEvent;

  /// @brief Method DidActivate, addr 0x3b61f00, size 0x18c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b6208c, size 0xc8, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method IsFilteringPlayCounts, addr 0x3b61dbc, size 0x8, virtual false, abstract: false, final false
  inline bool IsFilteringPlayCounts();

  /// @brief Method LocalizedLevelFilterParamsDescription, addr 0x3b62224, size 0x650, virtual false, abstract: false, final false
  ...
  /// @brief Method Refresh, addr 0x3b61e4c, size 0x4, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method Refresh, addr 0x3b61ee0, size 0x20, virtual false, abstract: false, final false
  inline void Refresh(::ByRef<::GlobalNamespace::LevelFilter> filter);

  /// @brief Method RefreshAsync, addr 0x3b61e50, size 0x90, virtual false, abstract: false, final false
  inline void RefreshAsync();

  /// @brief Method ResetAllFilterSettings, addr 0x3b61de8, size 0x64, virtual false, abstract: false, final false
  inline void ResetAllFilterSettings(bool onlyFavorites);

  /// @brief Method ResetFilter, addr 0x3b61dcc, size 0x1c, virtual false, abstract: false, final false
  inline void ResetFilter(bool onlyFavorites);

  /// @brief Method ResetOptionFilterSettings, addr 0x3b6215c, size 0xac, virtual false, abstract: false, final false
  inline void ResetOptionFilterSettings(bool onlyFavorites);

  /// @brief Method ResetTextFilterSettings, addr 0x3b62154, size 0x8, virtual false, abstract: false, final false
  inline void ResetTextFilterSettings(::StringW text);

  /// @brief Method SearchTextInputFieldViewOnValueChanged, addr 0x3b62208, size 0x1c, virtual false, abstract: false, final false
  inline void SearchTextInputFieldViewOnValueChanged(::HMUI::InputFieldView* inputFieldView);

  /// @brief Method Setup, addr 0x3b61dc4, size 0x8, virtual false, abstract: false, final false
  inline void Setup(::ArrayW<::GlobalNamespace::BeatmapLevelPack*, ::Array<::GlobalNamespace::BeatmapLevelPack*>*> beatmapLevelPacks);

  /// @brief Method <DidActivate>b__30_0, addr 0x3b628f8, size 0x6c, virtual false, abstract: false, final false
  inline void _DidActivate_b__30_0();

  /// @brief Method <DidActivate>b__30_1, addr 0x3b62964, size 0x24, virtual false, abstract: false, final false
  inline void _DidActivate_b__30_1();

  /// @brief Method <LocalizedLevelFilterParamsDescription>g__Append|37_0, addr 0x3b62874, size 0x7c, virtual false, abstract: false, final false
  ...
  constexpr ::System::Action_2<::GlobalNamespace::LevelSearchViewController*, ::GlobalNamespace::LevelFilter>* const& __cordl_internal_get_didPressSearchButtonEvent() const;

  constexpr ::System::Action_2<::GlobalNamespace::LevelSearchViewController*, ::GlobalNamespace::LevelFilter>*& __cordl_internal_get_didPressSearchButtonEvent();

  constexpr ::System::Action_1<::GlobalNamespace::LevelSearchViewController*>* const& __cordl_internal_get_didStartLoadingEvent() const;

  constexpr ::System::Action_1<::GlobalNamespace::LevelSearchViewController*>*& __cordl_internal_get_didStartLoadingEvent();
  ...
  constexpr void __cordl_internal_set_didPressSearchButtonEvent(::System::Action_2<::GlobalNamespace::LevelSearchViewController*, ::GlobalNamespace::LevelFilter>* value);

  constexpr void __cordl_internal_set_didStartLoadingEvent(::System::Action_1<::GlobalNamespace::LevelSearchViewController*>* value);

  /// @brief Method .ctor, addr 0x3b628f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFilterBeatmapLevelCollectionEvent, addr 0x3b61afc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didPressSearchButtonEvent, addr 0x3b6199c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didStartLoadingEvent, addr 0x3b61c5c, size 0xb0, virtual false, abstract: false, final false
  inline void add_didStartLoadingEvent(::System::Action_1<::GlobalNamespace::LevelSearchViewController*>* value);

  /// @brief Method remove_didFilterBeatmapLevelCollectionEvent, addr 0x3b61bac, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didPressSearchButtonEvent, addr 0x3b61a4c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didStartLoadingEvent, addr 0x3b61d0c, size 0xb0, virtual false, abstract: false, final false
