...
/// @brief Method InstallDependencies, addr 0x574a09c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x574a14c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_flyingControllerEnabled, addr 0x574a068, size 0x18, virtual false, abstract: false, final false
inline bool get_flyingControllerEnabled() ;

/// @brief Method set_flyingControllerEnabled, addr 0x574a080, size 0x1c, virtual false, abstract: false, final false
