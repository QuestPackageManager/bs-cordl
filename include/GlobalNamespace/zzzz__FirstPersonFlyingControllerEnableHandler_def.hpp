...
public:
  ...
  /// @brief Method InstallDependencies, addr 0x245049c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x245054c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_flyingControllerEnabled, addr 0x2450460, size 0x1c, virtual false, abstract: false, final false
  inline bool get_flyingControllerEnabled();

  /// @brief Method set_flyingControllerEnabled, addr 0x245047c, size 0x20, virtual false, abstract: false, final false
