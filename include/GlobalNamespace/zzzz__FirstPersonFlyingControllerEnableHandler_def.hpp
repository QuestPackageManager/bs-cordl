...
public:
  ...
  /// @brief Method InstallDependencies, addr 0x3a9c280, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a9c330, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_flyingControllerEnabled, addr 0x3a9c244, size 0x1c, virtual false, abstract: false, final false
  inline bool get_flyingControllerEnabled();

  /// @brief Method set_flyingControllerEnabled, addr 0x3a9c260, size 0x20, virtual false, abstract: false, final false
