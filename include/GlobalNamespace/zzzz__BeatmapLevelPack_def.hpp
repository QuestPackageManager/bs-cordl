...
public:
  ...
  /// @brief Method CreateLevelPackForFiltering, addr 0x14be9d4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14be970, size 0x64, virtual false, abstract: false, final false
