...
public:
  ...
  /// @brief Method CreateLevelPackForFiltering, addr 0x14ce3fc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ce398, size 0x64, virtual false, abstract: false, final false
