...
public:
  ...
  /// @brief Method MoveNext, addr 0x39d4990, size 0xe0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::BloomFogParamsAnimator__AnimationCoroutine_d__2* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x39d4a70, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x39d4a78, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x39d4ab0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x39d498c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39d4844, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AnimateBloomFogParamsChange, addr 0x39d46b4, size 0x7c, virtual false, abstract: false, final false
  inline void AnimateBloomFogParamsChange(::GlobalNamespace::BloomFogEnvironmentParams* envFogParams, float_t duration);

  /// @brief Method AnimationCoroutine, addr 0x39d47c8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultBloomFogParams, addr 0x39d48b4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBloomFogParamsChange, addr 0x39d486c, size 0x48, virtual false, abstract: false, final false
  inline void SetBloomFogParamsChange(::GlobalNamespace::BloomFogEnvironmentParams* envFogParams, float_t transition);

  /// @brief Method SetDefaultBloomFogParams, addr 0x39d48d0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39d4984, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
