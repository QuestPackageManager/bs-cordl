...
public:
  ...
  /// @brief Method MoveNext, addr 0x23ed268, size 0xe0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__BloomFogParamsAnimator___AnimationCoroutine_d__2* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x23ed348, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x23ed350, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x23ed390, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x23ed264, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23ed11c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AnimateBloomFogParamsChange, addr 0x23ecf84, size 0x7c, virtual false, abstract: false, final false
  inline void AnimateBloomFogParamsChange(::GlobalNamespace::BloomFogEnvironmentParams* envFogParams, float_t duration);

  /// @brief Method AnimationCoroutine, addr 0x23ed098, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultBloomFogParams, addr 0x23ed18c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBloomFogParamsChange, addr 0x23ed144, size 0x48, virtual false, abstract: false, final false
  inline void SetBloomFogParamsChange(::GlobalNamespace::BloomFogEnvironmentParams* envFogParams, float_t transition);

  /// @brief Method SetDefaultBloomFogParams, addr 0x23ed1a8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ed25c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
