...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IMultiplayerLevelEndActionsPublisher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IMultiplayerLevelEndActionsPublisher(IMultiplayerLevelEndActionsPublisherconst&) = delete;
