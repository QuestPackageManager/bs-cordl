...
public:
  ...
  /// @brief Method SetModifier, addr 0x23d4698, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23d4828, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
