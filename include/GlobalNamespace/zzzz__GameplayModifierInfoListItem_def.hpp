...
public:
  ...
  /// @brief Method SetModifier, addr 0x5a2e7bc, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a2e948, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
