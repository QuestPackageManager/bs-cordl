...
public:
  ...
  /// @brief Method SetModifier, addr 0x250b54c, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x250b6dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
