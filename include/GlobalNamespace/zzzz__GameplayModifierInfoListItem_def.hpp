...
public:
  ...
  /// @brief Method SetModifier, addr 0x3c28df8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c28f88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
