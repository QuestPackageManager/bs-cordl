...
public:
  ...
  /// @brief Method SetModifier, addr 0x262fa40, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262fbd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
