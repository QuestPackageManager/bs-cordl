...
public:
  ...
  /// @brief Method SetModifier, addr 0x58f36e8, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f3874, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
