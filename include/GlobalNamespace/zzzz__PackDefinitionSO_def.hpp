...
/// @brief Field _tags, offset 0x38, size 0x4 
 ...
 __declspec(property(get=get_packPromoInfoReference, put=set_packPromoInfoReference)) ::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::PackPromoInfoSO>>*  packPromoInfoReference;
