...
// Ctor Parameters [CppParam { name: "precisionOpaqueMesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: Some("{}") }, CppParam { name: "lowPolyMesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: Some("{}") }, CppParam { name: "sizeModifier", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "bottomThreshold", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "weight", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "precisionVertexCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "lowPolyVertexCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "generatedCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::CloudsMeshGenerator_Cloud::CloudsMeshGenerator_Cloud(::UnityW<::UnityEngine::Mesh>  precisionOpaqueMesh, ::UnityW<::UnityEngine::Mesh>  lowPolyMesh, float_t  sizeModifier, float_t  bottomThreshold, int32_t  weight, int32_t  precisionVertexCount, int32_t  lowPolyVertexCount, int32_t  generatedCount) noexcept  {
...
// Ctor Parameters [CppParam { name: "radius", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "normalizedRadius", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "meshCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "cloudIDs", ty: "::ArrayW<int32_t,::Array<int32_t>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "sizeMultiplier", ty: "float_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::CloudsMeshGenerator_Ring::CloudsMeshGenerator_Ring(float_t  radius, float_t  normalizedRadius, int32_t  meshCount, ::ArrayW<int32_t,::Array<int32_t>*>  cloudIDs, float_t  sizeMultiplier) noexcept  {
this->radius = radius;
...
// Ctor Parameters [CppParam { name: "transform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: Some("{}") }, CppParam { name: "distance", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "radius", ty: "float_t", modifiers: "", def_value: Some("{}") }]
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::CloudsMeshGenerator::*)()>(&::GlobalNamespace::CloudsMeshGenerator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x31b78ec;
...
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*>& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__prohibitedRadii()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____prohibitedRadii;
}
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__prohibitedRadii() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____prohibitedRadii;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__prohibitedRadii(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Cloud,::Array<::GlobalNamespace::CloudsMeshGenerator_Cloud>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__clouds() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____clouds;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__clouds(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Cloud,::Array<::GlobalNamespace::CloudsMeshGenerator_Cloud>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk,::Array<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk>*>& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__radiusChunks()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____radiusChunks;
}
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk,::Array<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__radiusChunks() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____radiusChunks;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__radiusChunks(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk,::Array<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Ring,::Array<::GlobalNamespace::CloudsMeshGenerator_Ring>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__rings() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____rings;
}
...
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*>& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__sortedProhibitedRadii()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____sortedProhibitedRadii;
}
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__sortedProhibitedRadii() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____sortedProhibitedRadii;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__sortedProhibitedRadii(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
