...
namespace GlobalNamespace {
class MenuTransitionsHelper___c__DisplayClass50_0;
}
namespace GlobalNamespace {
...
namespace GlobalNamespace {
class MenuTransitionsHelper___c__DisplayClass61_0;
}
namespace GlobalNamespace {
...
MARK_REF_PTR_T(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0);
...
MARK_REF_PTR_T(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0);
...
/// @brief Field <>9__62_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__62_0, put=setStaticF___9__62_0)) ::System::Action_1<::Zenject::DiContainer*>*  __9__62_0;

static inline ::GlobalNamespace::MenuTransitionsHelper___c* New_ctor() ;

/// @brief Method <HandleTutorialSceneDidFinish>b__62_0, addr 0x57f219c, size 0x4, virtual false, abstract: false, final false
inline void _HandleTutorialSceneDidFinish_b__62_0(::Zenject::DiContainer*  _) ;

/// @brief Method .ctor, addr 0x57f2198, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::GlobalNamespace::MenuTransitionsHelper___c* getStaticF___9() ;

static inline ::System::Action_1<::Zenject::DiContainer*>* getStaticF___9__62_0() ;

static inline void setStaticF___9(::GlobalNamespace::MenuTransitionsHelper___c*  value) ;

static inline void setStaticF___9__62_0(::System::Action_1<::Zenject::DiContainer*>*  value) ;
...
namespace GlobalNamespace {
// Is value type: false
// CS Name: MenuTransitionsHelper/<>c__DisplayClass50_0
class CORDL_TYPE MenuTransitionsHelper___c__DisplayClass50_0 : public ::System::Object {
public:
// Declarations
...
/// @brief Field afterSceneSwitchToGameplayCallback, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_afterSceneSwitchToGameplayCallback, put=__cordl_internal_set_afterSceneSwitchToGameplayCallback)) ::System::Action_1<::Zenject::DiContainer*>*  afterSceneSwitchToGameplayCallback;
...
static inline ::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0* New_ctor() ;

/// @brief Method <StartStandardLevel>b__0, addr 0x57f21a0, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f085c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr MenuTransitionsHelper___c__DisplayClass50_0() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "MenuTransitionsHelper___c__DisplayClass50_0", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
MenuTransitionsHelper___c__DisplayClass50_0(MenuTransitionsHelper___c__DisplayClass50_0 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "MenuTransitionsHelper___c__DisplayClass50_0", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
MenuTransitionsHelper___c__DisplayClass50_0(MenuTransitionsHelper___c__DisplayClass50_0 const& ) = delete;
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0, ___stopwatch) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0, _____4__this) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0, ___serializedBeatmapKey) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0, ___gameplayModifiers) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0, ___afterSceneSwitchToGameplayCallback) == 0x30, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0, 0x38>, "Size mismatch!");
...
/// @brief Field standardLevelScenesTransitionSetupData, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_standardLevelScenesTransitionSetupData, put=__cordl_internal_set_standardLevelScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>  standardLevelScenesTransitionSetupData;

static inline ::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass58_0* New_ctor() ;

/// @brief Method <HandleMainGameSceneDidFinish>b__0, addr 0x57f227c, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f19bc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass58_0, ___standardLevelScenesTransitionSetupData) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass58_0, ___levelCompletionResults) == 0x20, "Offset mismatch!");
...
/// @brief Field multiplayerLevelScenesTransitionSetupData, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_multiplayerLevelScenesTransitionSetupData, put=__cordl_internal_set_multiplayerLevelScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>  multiplayerLevelScenesTransitionSetupData;
...
/// @brief Method <HandleMultiplayerLevelDidFinish>b__0, addr 0x57f22b0, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f1b80, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass59_0, ___multiplayerLevelScenesTransitionSetupData) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass59_0, ___multiplayerResultsData) == 0x20, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass59_0, 0x28>, "Size mismatch!");
...
/// @brief Method <HandleMultiplayerLevelDidDisconnect>b__0, addr 0x57f22e4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f1d14, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass60_0, ___disconnectedReason) == 0x18, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass60_0, 0x20>, "Size mismatch!");

} // namespace end def GlobalNamespace
// Dependencies System.Object
namespace GlobalNamespace {
// Is value type: false
// CS Name: MenuTransitionsHelper/<>c__DisplayClass61_0
class CORDL_TYPE MenuTransitionsHelper___c__DisplayClass61_0 : public ::System::Object {
public:
// Declarations
/// @brief Field <>4__this, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get___4__this, put=__cordl_internal_set___4__this)) ::UnityW<::GlobalNamespace::MenuTransitionsHelper>  __4__this;
...
/// @brief Field missionLevelScenesTransitionSetupData, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_missionLevelScenesTransitionSetupData, put=__cordl_internal_set_missionLevelScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>  missionLevelScenesTransitionSetupData;

static inline ::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0* New_ctor() ;

/// @brief Method <HandleMissionLevelSceneDidFinish>b__0, addr 0x57f2314, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f1edc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr MenuTransitionsHelper___c__DisplayClass61_0() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "MenuTransitionsHelper___c__DisplayClass61_0", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
MenuTransitionsHelper___c__DisplayClass61_0(MenuTransitionsHelper___c__DisplayClass61_0 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "MenuTransitionsHelper___c__DisplayClass61_0", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
MenuTransitionsHelper___c__DisplayClass61_0(MenuTransitionsHelper___c__DisplayClass61_0 const& ) = delete;
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0, _____4__this) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0, ___missionLevelScenesTransitionSetupData) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0, ___missionCompletionResults) == 0x20, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0, 0x28>, "Size mismatch!");
...
using __c__DisplayClass50_0 = ::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0;
...
using __c__DisplayClass61_0 = ::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0;

/// @brief Field _appInitScenesTransitionSetupData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__appInitScenesTransitionSetupData, put=__cordl_internal_set__appInitScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::AppInitScenesTransitionSetupDataSO>  _appInitScenesTransitionSetupData;
...
/// @brief Field _beatmapEditorFinishedCallback, offset 0xe8, size 0x8 
...
/// @brief Field _beatmapEditorGameplayLevelFinishedCallback, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapEditorGameplayLevelFinishedCallback, put=__cordl_internal_set__beatmapEditorGameplayLevelFinishedCallback)) ::System::Action_2<::UnityW<::BeatmapEditor3D::BeatmapEditorStandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*  _beatmapEditorGameplayLevelFinishedCallback;
...
/// @brief Field _creditsScenesTransitionSetupData, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__creditsScenesTransitionSetupData, put=__cordl_internal_set__creditsScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::CreditsScenesTransitionSetupDataSO>  _creditsScenesTransitionSetupData;

/// @brief Field _gameScenesManager, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameScenesManager, put=__cordl_internal_set__gameScenesManager)) ::UnityW<::GlobalNamespace::GameScenesManager>  _gameScenesManager;

/// @brief Field _gameplayEventsDispatcher, offset 0xb0, size 0x8 
...
/// @brief Field _healthWarningScenesTransitionSetupData, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__healthWarningScenesTransitionSetupData, put=__cordl_internal_set__healthWarningScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO>  _healthWarningScenesTransitionSetupData;
...
/// @brief Field _missionLevelFinishedCallback, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get__missionLevelFinishedCallback, put=__cordl_internal_set__missionLevelFinishedCallback)) ::System::Action_2<::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MissionCompletionResults*>*  _missionLevelFinishedCallback;

/// @brief Field _missionLevelRestartedCallback, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__missionLevelRestartedCallback, put=__cordl_internal_set__missionLevelRestartedCallback)) ::System::Action_2<::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MissionCompletionResults*>*  _missionLevelRestartedCallback;
...
/// @brief Field _multiplayerDidDisconnectCallback, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerDidDisconnectCallback, put=__cordl_internal_set__multiplayerDidDisconnectCallback)) ::System::Action_1<::GlobalNamespace::DisconnectedReason>*  _multiplayerDidDisconnectCallback;

/// @brief Field _multiplayerLevelFinishedCallback, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLevelFinishedCallback, put=__cordl_internal_set__multiplayerLevelFinishedCallback)) ::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MultiplayerResultsData*>*  _multiplayerLevelFinishedCallback;
...
/// @brief Field _recordingToolScenesTransitionSetupData, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__recordingToolScenesTransitionSetupData, put=__cordl_internal_set__recordingToolScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO>  _recordingToolScenesTransitionSetupData;
...
/// @brief Field _shaderWarmupSceneSetupData, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__shaderWarmupSceneSetupData, put=__cordl_internal_set__shaderWarmupSceneSetupData)) ::UnityW<::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO>  _shaderWarmupSceneSetupData;

/// @brief Field _standardLevelFinishedCallback, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__standardLevelFinishedCallback, put=__cordl_internal_set__standardLevelFinishedCallback)) ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*  _standardLevelFinishedCallback;

/// @brief Field _standardLevelRestartedCallback, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__standardLevelRestartedCallback, put=__cordl_internal_set__standardLevelRestartedCallback)) ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*  _standardLevelRestartedCallback;
...
/// @brief Field _startupErrorScenesTransitionSetupData, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__startupErrorScenesTransitionSetupData, put=__cordl_internal_set__startupErrorScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO>  _startupErrorScenesTransitionSetupData;
...
/// @brief Field _tutorialScenesTransitionSetupData, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__tutorialScenesTransitionSetupData, put=__cordl_internal_set__tutorialScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::TutorialScenesTransitionSetupDataSO>  _tutorialScenesTransitionSetupData;
...
/// @brief Method HandleCreditsSceneDidFinish, addr 0x57f208c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method HandleMainGameSceneDidFinish, addr 0x57f1804, size 0x1b8, virtual false, abstract: false, final false
inline void HandleMainGameSceneDidFinish(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO*  standardLevelScenesTransitionSetupData, ::GlobalNamespace::LevelCompletionResults*  levelCompletionResults) ;

/// @brief Method HandleMissionLevelSceneDidFinish, addr 0x57f1d18, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerLevelDidDisconnect, addr 0x57f1b84, size 0x190, virtual false, abstract: false, final false
inline void HandleMultiplayerLevelDidDisconnect(::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO*  multiplayerLevelScenesTransitionSetupData, ::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method HandleMultiplayerLevelDidFinish, addr 0x57f19c0, size 0x1c0, virtual false, abstract: false, final false
...
constexpr ::System::Action_2<::UnityW<::BeatmapEditor3D::BeatmapEditorStandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>* const& __cordl_internal_get__beatmapEditorGameplayLevelFinishedCallback() const;

constexpr ::System::Action_2<::UnityW<::BeatmapEditor3D::BeatmapEditorStandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*& __cordl_internal_get__beatmapEditorGameplayLevelFinishedCallback() ;
...
constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MissionCompletionResults*>* const& __cordl_internal_get__missionLevelFinishedCallback() const;

constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MissionCompletionResults*>*& __cordl_internal_get__missionLevelFinishedCallback() ;

constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MissionCompletionResults*>* const& __cordl_internal_get__missionLevelRestartedCallback() const;

constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MissionCompletionResults*>*& __cordl_internal_get__missionLevelRestartedCallback() ;
...
constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MultiplayerResultsData*>* const& __cordl_internal_get__multiplayerLevelFinishedCallback() const;

constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MultiplayerResultsData*>*& __cordl_internal_get__multiplayerLevelFinishedCallback() ;
...
constexpr ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>* const& __cordl_internal_get__standardLevelFinishedCallback() const;

constexpr ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*& __cordl_internal_get__standardLevelFinishedCallback() ;

constexpr ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>* const& __cordl_internal_get__standardLevelRestartedCallback() const;

constexpr ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*& __cordl_internal_get__standardLevelRestartedCallback() ;
...
constexpr void __cordl_internal_set__beatmapEditorGameplayLevelFinishedCallback(::System::Action_2<::UnityW<::BeatmapEditor3D::BeatmapEditorStandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*  value) ;
...
constexpr void __cordl_internal_set__missionLevelFinishedCallback(::System::Action_2<::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MissionCompletionResults*>*  value) ;

constexpr void __cordl_internal_set__missionLevelRestartedCallback(::System::Action_2<::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MissionCompletionResults*>*  value) ;
...
constexpr void __cordl_internal_set__multiplayerLevelFinishedCallback(::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MultiplayerResultsData*>*  value) ;
...
constexpr void __cordl_internal_set__standardLevelFinishedCallback(::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*  value) ;

constexpr void __cordl_internal_set__standardLevelRestartedCallback(::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*  value) ;
...
/// @brief Method .ctor, addr 0x57f2140, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_appInitScenesTransitionSetupData, addr 0x57f00ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::AppInitScenesTransitionSetupDataSO> get_appInitScenesTransitionSetupData() ;

/// @brief Method get_creditsScenesTransitionSetupData, addr 0x57f0114, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::CreditsScenesTransitionSetupDataSO> get_creditsScenesTransitionSetupData() ;

/// @brief Method get_healthWarningScenesTransitionSetupData, addr 0x57f011c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO> get_healthWarningScenesTransitionSetupData() ;

/// @brief Method get_menuScenesTransitionSetupData, addr 0x57f012c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MenuScenesTransitionSetupDataSO> get_menuScenesTransitionSetupData() ;

/// @brief Method get_missionLevelScenesTransitionSetupData, addr 0x57f0104, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO> get_missionLevelScenesTransitionSetupData() ;

/// @brief Method get_multiplayerLevelScenesTransitionSetupData, addr 0x57f00fc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO> get_multiplayerLevelScenesTransitionSetupData() ;

/// @brief Method get_recordingToolScenesTransitionSetupData, addr 0x57f013c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO> get_recordingToolScenesTransitionSetupData() ;

/// @brief Method get_shaderWarmupSceneSetupData, addr 0x57f0124, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO> get_shaderWarmupSceneSetupData() ;

/// @brief Method get_standardLevelScenesTransitionSetupData, addr 0x57f00f4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO> get_standardLevelScenesTransitionSetupData() ;

/// @brief Method get_startupErrorScenesTransitionSetupData, addr 0x57f0134, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO> get_startupErrorScenesTransitionSetupData() ;

/// @brief Method get_tutorialScenesTransitionSetupData, addr 0x57f010c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _gameplayEventsDispatcher, offset: 0xb0, size: 0x8, def value: None
 ::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher*  ____gameplayEventsDispatcher;

/// @brief Field _standardLevelFinishedCallback, offset: 0xb8, size: 0x8, def value: None
...
/// @brief Field _standardLevelRestartedCallback, offset: 0xc0, size: 0x8, def value: None
...
/// @brief Field _multiplayerLevelFinishedCallback, offset: 0xc8, size: 0x8, def value: None
...
/// @brief Field _multiplayerDidDisconnectCallback, offset: 0xd0, size: 0x8, def value: None
 ::System::Action_1<::GlobalNamespace::DisconnectedReason>*  ____multiplayerDidDisconnectCallback;

/// @brief Field _missionLevelFinishedCallback, offset: 0xd8, size: 0x8, def value: None
...
/// @brief Field _missionLevelRestartedCallback, offset: 0xe0, size: 0x8, def value: None
...
/// @brief Field _beatmapEditorFinishedCallback, offset: 0xe8, size: 0x8, def value: None
 ::System::Action*  ____beatmapEditorFinishedCallback;

/// @brief Field _beatmapEditorGameplayLevelFinishedCallback, offset: 0xf0, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____gameplayEventsDispatcher) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____standardLevelFinishedCallback) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____standardLevelRestartedCallback) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____multiplayerLevelFinishedCallback) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____multiplayerDidDisconnectCallback) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____missionLevelFinishedCallback) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____missionLevelRestartedCallback) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____beatmapEditorFinishedCallback) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MenuTransitionsHelper, ____beatmapEditorGameplayLevelFinishedCallback) == 0xf0, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MenuTransitionsHelper, 0xf8>, "Size mismatch!");
...
NEED_NO_BOX(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass50_0*, "", "MenuTransitionsHelper/<>c__DisplayClass50_0");
...
NEED_NO_BOX(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::MenuTransitionsHelper___c__DisplayClass61_0*, "", "MenuTransitionsHelper/<>c__DisplayClass61_0");
