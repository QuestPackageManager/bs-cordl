...
public:
  ...
  /// @brief Method .ctor, addr 0x3ba2ff4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3ba2fe8, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleBeatmapObjectCallback, addr 0x3ba2f34, size 0xb4, virtual false, abstract: false, final false
  inline void HandleBeatmapObjectCallback(::GlobalNamespace::BeatmapObjectData* beatmapObjectData);

  /// @brief Method HandleBeatmapObjectSpawnControllerDidInit, addr 0x3ba218c, size 0x148, virtual false, abstract: false, final false
  inline void HandleBeatmapObjectSpawnControllerDidInit();

  static inline ::GlobalNamespace::SpawnRotationChevronManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x3ba2e3c, size 0xf8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SpawnDirectionData, addr 0x3ba2ac4, size 0x378, virtual false, abstract: false, final false
  inline void SpawnDirectionData(float_t time, float_t duration, int32_t rotation);

  /// @brief Method Start, addr 0x3ba20ec, size 0xa0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3ba22d4, size 0x7f0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ba2ffc, size 0x160, virtual false, abstract: false, final false
  inline void _ctor();
