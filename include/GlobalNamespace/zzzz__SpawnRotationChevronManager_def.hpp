...
public:
  ...
  /// @brief Method .ctor, addr 0x3babf2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3babf20, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleBeatmapObjectCallback, addr 0x3babe6c, size 0xb4, virtual false, abstract: false, final false
  inline void HandleBeatmapObjectCallback(::GlobalNamespace::BeatmapObjectData* beatmapObjectData);

  /// @brief Method HandleBeatmapObjectSpawnControllerDidInit, addr 0x3bab0c4, size 0x148, virtual false, abstract: false, final false
  inline void HandleBeatmapObjectSpawnControllerDidInit();

  static inline ::GlobalNamespace::SpawnRotationChevronManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x3babd74, size 0xf8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SpawnDirectionData, addr 0x3bab9fc, size 0x378, virtual false, abstract: false, final false
  inline void SpawnDirectionData(float_t time, float_t duration, int32_t rotation);

  /// @brief Method Start, addr 0x3bab024, size 0xa0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3bab20c, size 0x7f0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3babf34, size 0x160, virtual false, abstract: false, final false
  inline void _ctor();
