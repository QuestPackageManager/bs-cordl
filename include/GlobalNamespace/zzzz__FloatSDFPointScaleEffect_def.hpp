...
public:
  ...
  /// @brief Method Awake, addr 0x5854068, size 0xc, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::FloatSDFPointScaleEffect* New_ctor();

  /// @brief Method Scale, addr 0x58540a8, size 0x34, virtual false, abstract: false, final false
  inline void Scale(float_t value);

  /// @brief Method SetValue, addr 0x5854074, size 0x34, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x58540dc, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5854110, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
