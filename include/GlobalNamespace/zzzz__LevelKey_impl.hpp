...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::LevelKey::*)(::GlobalNamespace::LevelKey)>(&::GlobalNamespace::LevelKey::Equals)> {
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::LevelKey>::get(), "Equals", std::span<Il2CppClass const* const, 0>(),
                                                 ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::LevelKey>::get() })));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::GlobalNamespace::LevelKey, ::GlobalNamespace::LevelKey)>(&::GlobalNamespace::LevelKey::op_Equality)> {
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::LevelKey>::get(), "op_Equality", std::span<Il2CppClass const* const, 0>(),
                                                 ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::LevelKey>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::GlobalNamespace::LevelKey, ::GlobalNamespace::LevelKey)>(&::GlobalNamespace::LevelKey::op_Inequality)> {
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::LevelKey>::get(), "op_Inequality", std::span<Il2CppClass const* const, 0>(),
                                                 ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::LevelKey>::get(),
                                                                                     ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::LevelKey>::get() })));
    return ___internal_method;
  }
...
constexpr GlobalNamespace::LevelKey::operator ::System::IEquatable_1<::GlobalNamespace::LevelKey>*() {
  return static_cast<::System::IEquatable_1<::GlobalNamespace::LevelKey>*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
/// @brief Convert to "::System::IEquatable_1<::GlobalNamespace::LevelKey>"
constexpr ::System::IEquatable_1<::GlobalNamespace::LevelKey>* GlobalNamespace::LevelKey::i___System__IEquatable_1___GlobalNamespace__LevelKey_() {
  return static_cast<::System::IEquatable_1<::GlobalNamespace::LevelKey>*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
...
// def_value: Some("{}") }, CppParam { name: "characteristic", ty: "::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>", modifiers: "", def_value: Some("nullptr") }]
constexpr ::GlobalNamespace::LevelKey::LevelKey(::StringW songId, ::GlobalNamespace::BeatmapDifficulty difficulty, ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> characteristic) noexcept {
  this->songId = songId;
