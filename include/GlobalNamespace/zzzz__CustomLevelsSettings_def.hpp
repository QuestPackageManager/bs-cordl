...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CustomLevelsSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CustomLevelsSettings(CustomLevelsSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CustomLevelsSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CustomLevelsSettings(CustomLevelsSettingsconst&) = delete;
