...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::OVRSimultaneousHandsAndControllersSample::*)()>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::OVRSimultaneousHandsAndControllersSample*>(), { "EnableSimultaneousHandsAndControllers", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::OVRSimultaneousHandsAndControllersSample::*)()>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::OVRSimultaneousHandsAndControllersSample*>(), { "DisableSimultaneousHandsAndControllers", {}, {} })));
    return ___internal_method;
  }
};
