...
// Write type traits
MARK_REF_T(::GlobalNamespace::QuantizedMathf*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::QuantizedMathf*, "", "QuantizedMathf");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QuantizedMathf", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QuantizedMathf(QuantizedMathf&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QuantizedMathf", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QuantizedMathf(QuantizedMathfconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::QuantizedMathf) == 0x10, "Size mismatch!");
