...
public:
// Declarations
/// @brief Method Check, addr 0x57c62a4, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57c638c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
