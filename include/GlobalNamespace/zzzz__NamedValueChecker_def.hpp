...
public:
  // Declarations
  /// @brief Method Check, addr 0x25820bc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x258216c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
