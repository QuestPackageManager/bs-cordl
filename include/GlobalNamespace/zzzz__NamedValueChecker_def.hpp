...
public:
  // Declarations
  /// @brief Method Check, addr 0x5753fe0, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57540c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
