...
public:
  // Declarations
  /// @brief Method Check, addr 0x58e5674, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e575c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
