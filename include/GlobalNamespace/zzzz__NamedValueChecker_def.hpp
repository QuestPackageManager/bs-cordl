...
public:
  // Declarations
  /// @brief Method Check, addr 0x3b18524, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b185d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
