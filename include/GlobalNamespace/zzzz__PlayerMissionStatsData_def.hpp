...
public:
  ...
  /// @brief Method .ctor, addr 0x14e5128, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW missionId, bool cleared);

  /// @brief Method get_cleared, addr 0x14ea718, size 0x8, virtual false, abstract: false, final false
  inline bool get_cleared();

  /// @brief Method get_missionId, addr 0x14ea710, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_missionId();

  /// @brief Method set_cleared, addr 0x14ea720, size 0xc, virtual false, abstract: false, final false
