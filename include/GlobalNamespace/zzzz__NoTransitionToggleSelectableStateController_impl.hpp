...
inline void GlobalNamespace::NoTransitionToggleSelectableStateController::ResolveSelectionState(::HMUI::UISelectionState state, bool animated) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NoTransitionToggleSelectableStateController*>::get(), "ResolveSelectionState", std::vector<Il2CppClass*>{},
      ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HMUI::UISelectionState>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get() })));
...
inline ::GlobalNamespace::NoTransitionToggleSelectableStateController* GlobalNamespace::NoTransitionToggleSelectableStateController::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::NoTransitionToggleSelectableStateController*>());
}
