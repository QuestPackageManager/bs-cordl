...
template <typename T> constexpr ::System::Func_2<T, int32_t>*& GlobalNamespace::__SortExtensions____c__DisplayClass1_0_1<T>::__cordl_internal_get_getSortIndex() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___getSortIndex;
}
template <typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<T, int32_t>*> const& GlobalNamespace::__SortExtensions____c__DisplayClass1_0_1<T>::__cordl_internal_get_getSortIndex() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___getSortIndex;
}
...
template <typename T> inline int32_t GlobalNamespace::__SortExtensions____c__DisplayClass1_0_1<T>::_Sort_b__0(T a, T b) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__SortExtensions____c__DisplayClass1_0_1<T>*>::get(), "<Sort>b__0", std::span<Il2CppClass const* const, 0>(),
