...
/// @brief Method Clear, addr 0x3231634, size 0x78, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CopyTo, addr 0x323174c, size 0x1c, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<uint8_t,::Array<uint8_t>*>  destination) ;

/// @brief Method CopyTo, addr 0x3231d54, size 0x3c, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<uint8_t,::Array<uint8_t>*>  destination, ::ByRef<int32_t>  length) ;

/// @brief Method Deserialize, addr 0x323184c, size 0x228, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method GetData, addr 0x32312f0, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method Resize, addr 0x32316ac, size 0xa0, virtual false, abstract: false, final false
inline void Resize(int32_t  length) ;

/// @brief Method Serialize, addr 0x3231768, size 0xe4, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetData, addr 0x32313f8, size 0x24, virtual false, abstract: false, final false
inline void SetData(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method SetData, addr 0x3231444, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x323141c, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, int32_t  minLength, int32_t  maxLength, bool  allowEmpty) ;

/// @brief Method .ctor, addr 0x3231430, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, int32_t  size, bool  allowEmpty) ;

/// @brief Method get_data, addr 0x32312e8, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_data() ;

/// @brief Method get_length, addr 0x32312e0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_length() ;

/// @brief Convert to "::LiteNetLib::Utils::INetSerializable"
constexpr ::LiteNetLib::Utils::INetSerializable* i___LiteNetLib__Utils__INetSerializable() noexcept;

/// @brief Method op_Implicit, addr 0x3231d40, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_data, addr 0x32313f4, size 0x4, virtual false, abstract: false, final false
