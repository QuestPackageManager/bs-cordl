...
public:
  ...
  /// @brief Method Awake, addr 0x5a2d48c, size 0xa0, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNormalizedValueDidChange, addr 0x5a2d980, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5a2d52c, size 0x84, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnPointerUp, addr 0x5a2d9dc, size 0x88, virtual true, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method SetColors, addr 0x5a2d5b0, size 0x30, virtual false, abstract: false, final false
  inline void SetColors(::UnityEngine::Color color0, ::UnityEngine::Color color1);

  /// @brief Method TextForNormalizedValue, addr 0x5a2d7e0, size 0x1a0, virtual true, abstract: false, final false
  inline ::StringW TextForNormalizedValue(float_t normalizedValue);

  /// @brief Method UpdateVisuals, addr 0x5a2d5e0, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a2da64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// [CompilerGenerated]
  /// @brief Method add_colorDidChangeEvent, addr 0x5a2d30c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// [CompilerGenerated]
  /// @brief Method remove_colorDidChangeEvent, addr 0x5a2d3cc, size 0xc0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoTransitionColorGradientSlider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoTransitionColorGradientSlider(NoTransitionColorGradientSlider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoTransitionColorGradientSlider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoTransitionColorGradientSlider(NoTransitionColorGradientSliderconst&) = delete;
