...
public:
  ...
  /// @brief Method Awake, addr 0x250e7b8, size 0xc4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Hide, addr 0x250ea80, size 0x24, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::GlobalNamespace::LoadingControl* New_ctor();

  /// @brief Method OnDestroy, addr 0x250e87c, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ShowDownloadingProgress, addr 0x250e9d4, size 0xac, virtual false, abstract: false, final false
  inline void ShowDownloadingProgress(::StringW text, float_t downloadingProgress);

  /// @brief Method ShowLoading, addr 0x250e898, size 0x8c, virtual false, abstract: false, final false
  inline void ShowLoading(::StringW text);

  /// @brief Method ShowText, addr 0x250e924, size 0xb0, virtual false, abstract: false, final false
  inline void ShowText(::StringW text, bool showRefreshButton);

  /// @brief Method <Awake>b__14_0, addr 0x250eaac, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x250eaa4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressRefreshButtonEvent, addr 0x250e664, size 0x9c, virtual false, abstract: false, final false
  inline void add_didPressRefreshButtonEvent(::System::Action* value);

  /// @brief Method get_isLoading, addr 0x250e79c, size 0x1c, virtual false, abstract: false, final false
  inline bool get_isLoading();

  /// @brief Method remove_didPressRefreshButtonEvent, addr 0x250e700, size 0x9c, virtual false, abstract: false, final false
