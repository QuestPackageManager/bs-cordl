...
/// @brief Method Awake, addr 0x5857fbc, size 0xc8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Hide, addr 0x5858284, size 0x24, virtual false, abstract: false, final false
inline void Hide() ;

static inline ::GlobalNamespace::LoadingControl* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5858084, size 0x18, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method ShowDownloadingProgress, addr 0x58581d8, size 0xac, virtual false, abstract: false, final false
inline void ShowDownloadingProgress(::StringW  text, float_t  downloadingProgress) ;

/// @brief Method ShowLoading, addr 0x585809c, size 0x8c, virtual false, abstract: false, final false
inline void ShowLoading(::StringW  text) ;

/// @brief Method ShowText, addr 0x5858128, size 0xb0, virtual false, abstract: false, final false
inline void ShowText(::StringW  text, bool  showRefreshButton) ;

/// @brief Method <Awake>b__14_0, addr 0x58582ac, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58582a8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPressRefreshButtonEvent, addr 0x5857e4c, size 0xac, virtual false, abstract: false, final false
inline void add_didPressRefreshButtonEvent(::System::Action*  value) ;

/// @brief Method get_isLoading, addr 0x5857fa4, size 0x18, virtual false, abstract: false, final false
inline bool get_isLoading() ;

/// @brief Method remove_didPressRefreshButtonEvent, addr 0x5857ef8, size 0xac, virtual false, abstract: false, final false
