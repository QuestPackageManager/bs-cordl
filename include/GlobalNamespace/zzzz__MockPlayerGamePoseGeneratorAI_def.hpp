...
/// @brief Field _obstacles, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__obstacles, put=__cordl_internal_set__obstacles)) ::ArrayW<::GlobalNamespace::MockObstacleData*,::Array<::GlobalNamespace::MockObstacleData*>*>  _obstacles;
...
/// @brief Field _rightNotes, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get__rightNotes, put=__cordl_internal_set__rightNotes)) ::ArrayW<::GlobalNamespace::MockNoteData*,::Array<::GlobalNamespace::MockNoteData*>*>  _rightNotes;
...
/// @brief Field <suppressLevelFinishedRpc>k__BackingField, offset 0x117, size 0x1 
 __declspec(property(get=__cordl_internal_get__suppressLevelFinishedRpc_k__BackingField, put=__cordl_internal_set__suppressLevelFinishedRpc_k__BackingField)) bool  _suppressLevelFinishedRpc_k__BackingField;
...
/// @brief Method Blerp, addr 0x594b518, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x5948a20, size 0x278, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetCutDirection, addr 0x594b1c4, size 0x2f8, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetCutDirection(::GlobalNamespace::NoteCutDirection  cutDirection) ;

/// @brief Method GetNotePosition, addr 0x594b4bc, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetNotePosition(int32_t  lineCount, ::GlobalNamespace::MockNoteData*  noteData) ;

/// @brief Method HandleNoteWasSpawned, addr 0x594b93c, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method HandleObstacleWasSpawned, addr 0x594bb20, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method HandleSliderWasSpawned, addr 0x594bd04, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x5948c98, size 0x32c, virtual true, abstract: false, final false
...
static inline ::GlobalNamespace::MockPlayerGamePoseGeneratorAI* New_ctor(::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  multiplayerSessionManager, ::GlobalNamespace::IGameplayRpcManager*  gameplayRpcManager, ::GlobalNamespace::IMockPlayerScoreCalculator*  scoreCalculator, bool  leftHanded) ;

/// @brief Method ProcessNotes, addr 0x59497c4, size 0x1080, virtual false, abstract: false, final false
inline ::UnityEngine::Pose ProcessNotes(::ArrayW<::GlobalNamespace::MockNoteData*,::Array<::GlobalNamespace::MockNoteData*>*>  notes, ::UnityEngine::Vector3  handDirection, ::ByRef<int32_t>  noteIndex, ::ByRef<int32_t>  prevHitScore, ::ByRef<int32_t>  nextHitScore, ::ArrayW<::GlobalNamespace::MockNoteData*,::Array<::GlobalNamespace::MockNoteData*>*>  bombs, ::ByRef<int32_t>  bombIndex, int32_t  lineCount, float_t  songTime, ::ByRef<bool>  wasHitOrMiss) ;

/// @brief Method ProcessObstacles, addr 0x594a844, size 0x2c4, virtual false, abstract: false, final false
inline ::UnityEngine::Pose ProcessObstacles(::ArrayW<::GlobalNamespace::MockObstacleData*,::Array<::GlobalNamespace::MockObstacleData*>*>  obstacles, ::ByRef<int32_t>  obstacleIndex, int32_t  lineCount, ::UnityEngine::Pose  prevHeadPose, ::UnityEngine::Pose  leftHandPose, ::UnityEngine::Pose  rightHandPose, float_t  songTime) ;

/// @brief Method SimulateFail, addr 0x594b788, size 0x1b4, virtual true, abstract: false, final false
inline void SimulateFail() ;

/// @brief Method Tick, addr 0x5948fc4, size 0x800, virtual true, abstract: false, final false
inline void Tick() ;

/// @brief Method UpdateScore, addr 0x594ab08, size 0x6bc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5948798, size 0x288, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  multiplayerSessionManager, ::GlobalNamespace::IGameplayRpcManager*  gameplayRpcManager, ::GlobalNamespace::IMockPlayerScoreCalculator*  scoreCalculator, bool  leftHanded) ;

/// @brief Method get_songTime, addr 0x59486bc, size 0xcc, virtual false, abstract: false, final false
inline float_t get_songTime() ;

/// @brief Method get_suppressLevelFinishedRpc, addr 0x5948788, size 0x8, virtual false, abstract: false, final false
inline bool get_suppressLevelFinishedRpc() ;

/// @brief Method set_suppressLevelFinishedRpc, addr 0x5948790, size 0x8, virtual false, abstract: false, final false
