...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockPlayerGamePoseGeneratorAI*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockPlayerGamePoseGeneratorAI*, "", "MockPlayerGamePoseGeneratorAI");
// Dependencies MockNoteData, MockObstacleData, MockPlayerGamePoseGenerator, UnityEngine.Pose
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__bombNotes, put = __cordl_internal_set__bombNotes)) ::ArrayW<::GlobalNamespace::MockNoteData*> _bombNotes;
  ...
  __declspec(property(get = __cordl_internal_get__leftNotes, put = __cordl_internal_set__leftNotes)) ::ArrayW<::GlobalNamespace::MockNoteData*> _leftNotes;
  ...
  __declspec(property(get = __cordl_internal_get__obstacles, put = __cordl_internal_set__obstacles)) ::ArrayW<::GlobalNamespace::MockObstacleData*> _obstacles;
  ...
  __declspec(property(get = __cordl_internal_get__rightNotes, put = __cordl_internal_set__rightNotes)) ::ArrayW<::GlobalNamespace::MockNoteData*> _rightNotes;
  ...
  /// @brief Field <suppressLevelFinishedRpc>k__BackingField, offset 0x117, size 0x1
  __declspec(property(get = __cordl_internal_get__suppressLevelFinishedRpc_k__BackingField,
                      put = __cordl_internal_set__suppressLevelFinishedRpc_k__BackingField)) bool _suppressLevelFinishedRpc_k__BackingField;
  ...
  __declspec(property(get = get_suppressLevelFinishedRpc, put = set_suppressLevelFinishedRpc)) bool suppressLevelFinishedRpc;

  /// @brief Method Blerp, addr 0x5a86184, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5a8368c, size 0x278, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetCutDirection, addr 0x5a85e30, size 0x2f8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetCutDirection(::GlobalNamespace::NoteCutDirection cutDirection);

  /// @brief Method GetNotePosition, addr 0x5a86128, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetNotePosition(int32_t lineCount, ::GlobalNamespace::MockNoteData* noteData);

  /// @brief Method HandleNoteWasSpawned, addr 0x5a865a8, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleObstacleWasSpawned, addr 0x5a8678c, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderWasSpawned, addr 0x5a86970, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x5a83904, size 0x32c, virtual true, abstract: false, final false
  ...
  static inline ::GlobalNamespace::MockPlayerGamePoseGeneratorAI* New_ctor(::GlobalNamespace::IBeatSaberMultiplayerSessionManager* multiplayerSessionManager,
                                                                           ::GlobalNamespace::IGameplayRpcManager* gameplayRpcManager, ::GlobalNamespace::IMockPlayerScoreCalculator* scoreCalculator,
                                                                           bool leftHanded);

  /// @brief Method ProcessNotes, addr 0x5a84430, size 0x1080, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose ProcessNotes(::ArrayW<::GlobalNamespace::MockNoteData*> notes, ::UnityEngine::Vector3 handDirection, ::by_ref<int32_t> noteIndex, ::by_ref<int32_t> prevHitScore,
                                          ::by_ref<int32_t> nextHitScore, ::ArrayW<::GlobalNamespace::MockNoteData*> bombs, ::by_ref<int32_t> bombIndex, int32_t lineCount, float_t songTime,
                                          ::by_ref<bool> wasHitOrMiss);

  /// @brief Method ProcessObstacles, addr 0x5a854b0, size 0x2c4, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose ProcessObstacles(::ArrayW<::GlobalNamespace::MockObstacleData*> obstacles, ::by_ref<int32_t> obstacleIndex, int32_t lineCount, ::UnityEngine::Pose prevHeadPose,
                                              ::UnityEngine::Pose leftHandPose, ::UnityEngine::Pose rightHandPose, float_t songTime);

  /// @brief Method SimulateFail, addr 0x5a863f4, size 0x1b4, virtual true, abstract: false, final false
  inline void SimulateFail();

  /// @brief Method Tick, addr 0x5a83c30, size 0x800, virtual true, abstract: false, final false
  inline void Tick();

  /// @brief Method UpdateScore, addr 0x5a85774, size 0x6bc, virtual false, abstract: false, final false
  inline void UpdateScore(::by_ref<int32_t> currentScore, ::by_ref<int32_t> currentCombo, ::by_ref<int32_t> currentMultiplier, int32_t hitScore, int32_t lineCount, ::UnityEngine::Pose lastPose,
  ...
  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*> const& __cordl_internal_get__bombNotes() const;

  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*>& __cordl_internal_get__bombNotes();
  ...
  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*> const& __cordl_internal_get__leftNotes() const;

  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*>& __cordl_internal_get__leftNotes();
  ...
  constexpr ::ArrayW<::GlobalNamespace::MockObstacleData*> const& __cordl_internal_get__obstacles() const;

  constexpr ::ArrayW<::GlobalNamespace::MockObstacleData*>& __cordl_internal_get__obstacles();
  ...
  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*> const& __cordl_internal_get__rightNotes() const;

  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*>& __cordl_internal_get__rightNotes();
  ...
  constexpr bool const& __cordl_internal_get__suppressLevelFinishedRpc_k__BackingField() const;

  constexpr bool& __cordl_internal_get__suppressLevelFinishedRpc_k__BackingField();
  ...
  constexpr void __cordl_internal_set__bombNotes(::ArrayW<::GlobalNamespace::MockNoteData*> value);
  ...
  constexpr void __cordl_internal_set__leftNotes(::ArrayW<::GlobalNamespace::MockNoteData*> value);
  ...
  constexpr void __cordl_internal_set__obstacles(::ArrayW<::GlobalNamespace::MockObstacleData*> value);
  ...
  constexpr void __cordl_internal_set__rightNotes(::ArrayW<::GlobalNamespace::MockNoteData*> value);
  ...
  constexpr void __cordl_internal_set__suppressLevelFinishedRpc_k__BackingField(bool value);

  constexpr void __cordl_internal_set__timeScale(float_t value);

  /// @brief Method .ctor, addr 0x5a83404, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method get_songTime, addr 0x5a83328, size 0xcc, virtual false, abstract: false, final false
  inline float_t get_songTime();

  /// [CompilerGenerated]
  /// @brief Method get_suppressLevelFinishedRpc, addr 0x5a833f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_suppressLevelFinishedRpc();

  /// [CompilerGenerated]
  /// @brief Method set_suppressLevelFinishedRpc, addr 0x5a833fc, size 0x8, virtual false, abstract: false, final false
  inline void set_suppressLevelFinishedRpc(bool value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MockPlayerGamePoseGeneratorAI", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MockPlayerGamePoseGeneratorAI(MockPlayerGamePoseGeneratorAI&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MockPlayerGamePoseGeneratorAI", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MockPlayerGamePoseGeneratorAI(MockPlayerGamePoseGeneratorAIconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 22231 };

  /// @brief Field kIntroLengthMs offset 0xffffffff size 0x4
  static constexpr int32_t kIntroLengthMs{ static_cast<int32_t>(0x2710) };
  ...
  ::ArrayW<::GlobalNamespace::MockNoteData*> ____leftNotes;

  /// @brief Field _rightNotes, offset: 0xd0, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::MockNoteData*> ____rightNotes;

  /// @brief Field _bombNotes, offset: 0xd8, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::MockNoteData*> ____bombNotes;

  /// @brief Field _obstacles, offset: 0xe0, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::MockObstacleData*> ____obstacles;
  ...
  /// [CompilerGenerated]
  /// @brief Field <suppressLevelFinishedRpc>k__BackingField, offset: 0x117, size: 0x1, def value: None
  bool ____suppressLevelFinishedRpc_k__BackingField;
...
static_assert(offsetof(::GlobalNamespace::MockPlayerGamePoseGeneratorAI, ____suppressLevelFinishedRpc_k__BackingField) == 0x117, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::MockPlayerGamePoseGeneratorAI) == 0x118, "Size mismatch!");
