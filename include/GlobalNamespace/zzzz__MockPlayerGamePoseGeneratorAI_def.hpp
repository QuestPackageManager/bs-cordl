...
public:
  ...
  /// @brief Method Blerp, addr 0x2669480, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x266689c, size 0x268, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetCutDirection, addr 0x2669174, size 0x2a4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetCutDirection(::GlobalNamespace::NoteCutDirection cutDirection);

  /// @brief Method GetNotePosition, addr 0x2669418, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetNotePosition(int32_t lineCount, ::GlobalNamespace::MockNoteData* noteData);

  /// @brief Method HandleNoteWasSpawned, addr 0x2669928, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleObstacleWasSpawned, addr 0x2669b00, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderWasSpawned, addr 0x2669cd8, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x2666b04, size 0x3f8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNotes, addr 0x2667894, size 0xfe4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessObstacles, addr 0x2668878, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method SimulateFail, addr 0x2669768, size 0x1c0, virtual true, abstract: false, final false
  inline void SimulateFail();

  /// @brief Method Tick, addr 0x2666efc, size 0x998, virtual true, abstract: false, final false
  inline void Tick();

  /// @brief Method UpdateScore, addr 0x2668b4c, size 0x628, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2666624, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method get_songTime, addr 0x266655c, size 0xc8, virtual false, abstract: false, final false
