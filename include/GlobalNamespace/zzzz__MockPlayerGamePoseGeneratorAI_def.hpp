...
public:
  ...
  /// @brief Method Blerp, addr 0x5870f7c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x586e48c, size 0x278, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetCutDirection, addr 0x5870c28, size 0x2f8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetCutDirection(::GlobalNamespace::NoteCutDirection cutDirection);

  /// @brief Method GetNotePosition, addr 0x5870f20, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetNotePosition(int32_t lineCount, ::GlobalNamespace::MockNoteData* noteData);

  /// @brief Method HandleNoteWasSpawned, addr 0x5871388, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleObstacleWasSpawned, addr 0x587156c, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderWasSpawned, addr 0x5871750, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x586e704, size 0x32c, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNotes, addr 0x586f228, size 0x1080, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessObstacles, addr 0x58702a8, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method SimulateFail, addr 0x58711ec, size 0x19c, virtual true, abstract: false, final false
  inline void SimulateFail();

  /// @brief Method Tick, addr 0x586ea30, size 0x7f8, virtual true, abstract: false, final false
  inline void Tick();

  /// @brief Method UpdateScore, addr 0x587056c, size 0x6bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586e204, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method get_songTime, addr 0x586e138, size 0xcc, virtual false, abstract: false, final false
