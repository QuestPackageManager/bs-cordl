...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LevelFailedText", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LevelFailedText(LevelFailedText&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LevelFailedText", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LevelFailedText(LevelFailedTextconst&) = delete;
