...
public:
  ...
  /// @brief Method OverrideText, addr 0x59827f0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x598283c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
