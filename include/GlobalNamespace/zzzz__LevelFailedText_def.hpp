...
public:
  ...
  /// @brief Method OverrideText, addr 0x2490228, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2490274, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
