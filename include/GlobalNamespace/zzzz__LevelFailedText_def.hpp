...
public:
  ...
  /// @brief Method OverrideText, addr 0x25bc4e8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25bc534, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
