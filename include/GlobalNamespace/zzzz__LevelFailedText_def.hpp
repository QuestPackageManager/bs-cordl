...
public:
  ...
  /// @brief Method OverrideText, addr 0x5848d38, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5848d84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
