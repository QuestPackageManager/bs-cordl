...
public:
  ...
  /// @brief Method OverrideText, addr 0x26ba03c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ba088, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
