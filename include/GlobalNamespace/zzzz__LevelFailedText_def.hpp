...
/// @brief Method OverrideText, addr 0x57d6e3c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57d6e88, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
