...
public:
  ...
  /// @brief Method OverrideText, addr 0x26d1a70, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d1abc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
