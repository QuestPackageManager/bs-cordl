...
public:
  ...
  /// @brief Method OnDestroy, addr 0x23a503c, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleBeatmapEvent, addr 0x23a5058, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23a50a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
