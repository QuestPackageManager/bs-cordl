...
public:
  ...
  /// @brief Method HandleBeatmapEvent, addr 0x3b8cb20, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b8cb04, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3b8ca58, size 0xac, virtual false, abstract: false, final false
  inline void Start();
