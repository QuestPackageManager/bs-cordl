...
public:
  ...
  /// @brief Method ClearDirtyData, addr 0x36551bc, size 0x54, virtual false, abstract: false, final false
  inline void ClearDirtyData();

  static inline ::GlobalNamespace::BeatmapEventDataBoxGroupProcessor* New_ctor();

  /// @brief Method ProcessBeforeDeleteData, addr 0x3656268, size 0x364, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessInsertedData, addr 0x3655c9c, size 0x5cc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3654df4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_dirtyBoxGroups, addr 0x3655c94, size 0x8, virtual false, abstract: false, final false
