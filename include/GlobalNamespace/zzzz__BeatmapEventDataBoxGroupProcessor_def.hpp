...
public:
  ...
  /// @brief Method get_dirtyBoxGroups addr 0x21efeb0 size 0x8 virtual false final false
  inline ::System::Collections::Generic::IReadOnlyCollection_1<::GlobalNamespace::BeatmapEventDataBoxGroup*>* get_dirtyBoxGroups();

  /// @brief Method ProcessInsertedData addr 0x21efeb8 size 0x5fc virtual true final true
  ...
  /// @brief Method ProcessBeforeDeleteData addr 0x21f04b4 size 0x374 virtual true final true
  ...
  /// @brief Method ClearDirtyData addr 0x21ef478 size 0x50 virtual false final false
  inline void ClearDirtyData();

  static inline ::GlobalNamespace::BeatmapEventDataBoxGroupProcessor* New_ctor();

  /// @brief Method .ctor addr 0x21ef038 size 0x7c virtual false final false
  inline void _ctor();
