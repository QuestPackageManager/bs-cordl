...
public:
  ...
  /// @brief Method ClearDirtyData, addr 0x3713394, size 0x54, virtual false, abstract: false, final false
  inline void ClearDirtyData();

  static inline ::GlobalNamespace::BeatmapEventDataBoxGroupProcessor* New_ctor();

  /// @brief Method ProcessBeforeDeleteData, addr 0x3714440, size 0x364, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessInsertedData, addr 0x3713e74, size 0x5cc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3712fcc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_dirtyBoxGroups, addr 0x3713e6c, size 0x8, virtual false, abstract: false, final false
