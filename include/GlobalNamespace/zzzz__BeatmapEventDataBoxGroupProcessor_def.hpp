...
/// @brief Method ClearDirtyData, addr 0x3618abc, size 0x54, virtual false, abstract: false, final false
inline void ClearDirtyData() ;

static inline ::GlobalNamespace::BeatmapEventDataBoxGroupProcessor* New_ctor() ;

/// @brief Method ProcessBeforeDeleteData, addr 0x3619b68, size 0x364, virtual true, abstract: false, final true
...
/// @brief Method ProcessInsertedData, addr 0x361959c, size 0x5cc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x36186f4, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_dirtyBoxGroups, addr 0x3619594, size 0x8, virtual false, abstract: false, final false
