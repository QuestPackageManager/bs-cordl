...
public:
  ...
  /// @brief Method BackToLobbyPressed, addr 0x243315c, size 0x20, virtual false, abstract: false, final false
  inline void BackToLobbyPressed();

  /// @brief Method BackToMenuPressed, addr 0x243317c, size 0x20, virtual false, abstract: false, final false
  inline void BackToMenuPressed();

  /// @brief Method DidActivate, addr 0x2433054, size 0x108, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method Init, addr 0x2432e1c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x243319c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_backToLobbyPressedEvent, addr 0x2432b5c, size 0xb0, virtual false, abstract: false, final false
  inline void add_backToLobbyPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MultiplayerResultsViewController>>* value);

  /// @brief Method add_backToMenuPressedEvent, addr 0x2432cbc, size 0xb0, virtual false, abstract: false, final false
  inline void add_backToMenuPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MultiplayerResultsViewController>>* value);

  /// @brief Method remove_backToLobbyPressedEvent, addr 0x2432c0c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_backToLobbyPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MultiplayerResultsViewController>>* value);

  /// @brief Method remove_backToMenuPressedEvent, addr 0x2432d6c, size 0xb0, virtual false, abstract: false, final false
