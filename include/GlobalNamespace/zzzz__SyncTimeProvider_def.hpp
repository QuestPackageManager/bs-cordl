...
// Write type traits
MARK_REF_T(::GlobalNamespace::SyncTimeProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SyncTimeProvider*, "", "SyncTimeProvider");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5852ef8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_time, addr 0x5852e50, size 0xa8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SyncTimeProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SyncTimeProvider(SyncTimeProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SyncTimeProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SyncTimeProvider(SyncTimeProviderconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::SyncTimeProvider) == 0x18, "Size mismatch!");
