...
/// @brief Method .ctor, addr 0x569ca9c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_time, addr 0x569c9f4, size 0xa8, virtual true, abstract: false, final true
