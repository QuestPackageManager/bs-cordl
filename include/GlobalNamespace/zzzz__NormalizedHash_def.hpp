...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NormalizedHash", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NormalizedHash(NormalizedHash&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NormalizedHash", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NormalizedHash(NormalizedHashconst&) = delete;
