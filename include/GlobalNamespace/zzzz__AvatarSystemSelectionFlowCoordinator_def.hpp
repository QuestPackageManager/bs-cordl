...
public:
  ...
  /// @brief Method MoveNext, addr 0x275befc, size 0x6d8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x275c5d4, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method BackButtonWasPressed, addr 0x275bda0, size 0x24, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DidActivate, addr 0x275b430, size 0x204, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x275b634, size 0x18c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleAvatarEditorFlowCoordinatorDidFinish, addr 0x275bc60, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectAvatarSystemViewControllerDidPressContinueButton, addr 0x275bd7c, size 0x24, virtual false, abstract: false, final false
  inline void HandleSelectAvatarSystemViewControllerDidPressContinueButton();

  /// @brief Method HandleSelectAvatarSystemViewControllerDidRequestCreationOfAvatar, addr 0x275baec, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectAvatarSystemViewControllerDidRequestEditOfAvatar, addr 0x275b978, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectAvatarSystemViewControllerDidSetAvatarSystemPreferred, addr 0x275b974, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x275b384, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAvatarSystemPreferred, addr 0x275b840, size 0x134, virtual false, abstract: false, final false
  inline void SetAvatarSystemPreferred(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method Setup, addr 0x275b424, size 0xc, virtual false, abstract: false, final false
  inline void Setup(bool continueButtonVisible);

  /// @brief Method TopViewControllerWillChange, addr 0x275b7c0, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method <Initialize>b__10_0, addr 0x275be40, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x275bdc4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x275b224, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x275b2d4, size 0xb0, virtual false, abstract: false, final false
  inline void
