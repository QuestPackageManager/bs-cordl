...
constexpr ::ArrayW<T>& GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_get__data() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____data;
}
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IComparable_1<T>*>)
constexpr ::ArrayW<T> const& GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_get__data() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____data;
}
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IComparable_1<T>*>)
constexpr void GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_set__data(::ArrayW<T> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____data = value;
}
template <typename T>
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IComparable_1<T>*>)
inline bool GlobalNamespace::BinaryHeap_1<T>::RemoveMin(/* [NotNullWhen(true)] */ ::by_ref<T> output) {
