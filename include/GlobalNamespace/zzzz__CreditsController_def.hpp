...
public:
  ...
  /// @brief Method <OnDestroy>b__16_0, addr 0x225d83c, size 0x18, virtual false, abstract: false, final false
  inline bool _OnDestroy_b__16_0(::GlobalNamespace::PackDefinitionSO* p);

  /// @brief Method <StartAsync>b__15_0, addr 0x225d774, size 0x18, virtual false, abstract: false, final false
  inline bool _StartAsync_b__15_0(::GlobalNamespace::PackDefinitionSO* p);

  /// @brief Method <StartAsync>b__15_1, addr 0x225d78c, size 0x20, virtual false, abstract: false, final false
  inline int32_t _StartAsync_b__15_1(::GlobalNamespace::PackDefinitionSO* p);

  /// @brief Method <StartAsync>b__15_2, addr 0x225d7ac, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225d76c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x225d858, size 0x220, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::CreditsController__ScrollCoroutine_d__18* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x225da78, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x225da80, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x225dab8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x225d854, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x225d08c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x225dac0, size 0x89c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x225e35c, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Finish, addr 0x225cd40, size 0x2ec, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method HandleHmdMounted, addr 0x225d16c, size 0x2c, virtual false, abstract: false, final false
  inline void HandleHmdMounted();

  /// @brief Method HandleHmdUnmounted, addr 0x225d198, size 0x30, virtual false, abstract: false, final false
  inline void HandleHmdUnmounted();

  /// @brief Method HandleInputFocusCaptured, addr 0x225d0b4, size 0x30, virtual false, abstract: false, final false
  inline void HandleInputFocusCaptured();

  /// @brief Method HandleInputFocusReleased, addr 0x225d114, size 0x2c, virtual false, abstract: false, final false
  inline void HandleInputFocusReleased();

  static inline ::GlobalNamespace::CreditsController* New_ctor();

  /// @brief Method OnDestroy, addr 0x225c6b8, size 0x688, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PauseCredits, addr 0x225d0e4, size 0x30, virtual false, abstract: false, final false
  inline void PauseCredits();

  /// @brief Method ScrollCoroutine, addr 0x225d02c, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* ScrollCoroutine();

  /// @brief Method SpawnAllCredits, addr 0x225d1c8, size 0x98, virtual false, abstract: false, final false
  inline void SpawnAllCredits(::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::GameObject>>* musicPackCredits);

  /// @brief Method SpawnCredits, addr 0x225d260, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x225c578, size 0x80, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartAsync, addr 0x225c5f8, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* StartAsync();

  /// @brief Method UnpauseCredits, addr 0x225d140, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225d6b0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
