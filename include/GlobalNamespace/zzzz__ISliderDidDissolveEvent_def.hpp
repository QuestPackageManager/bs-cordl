...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISliderDidDissolveEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISliderDidDissolveEvent(ISliderDidDissolveEventconst&) = delete;
