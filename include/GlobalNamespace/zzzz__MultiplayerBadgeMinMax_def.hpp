...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBadgeMinMax, "", "MultiplayerBadgeMinMax");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgeMinMax) == 0x4, "Size mismatch!");
