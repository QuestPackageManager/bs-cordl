...
// Write type traits
MARK_REF_T(::GlobalNamespace::CloudsMeshGenerator*);
...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CloudsMeshGenerator*, "", "CloudsMeshGenerator");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CloudsMeshGenerator_Cloud, "", "CloudsMeshGenerator/Cloud");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius, "", "CloudsMeshGenerator/ProhibitedRadius");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CloudsMeshGenerator_RadiusChunk, "", "CloudsMeshGenerator/RadiusChunk");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CloudsMeshGenerator_Ring, "", "CloudsMeshGenerator/Ring");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::CloudsMeshGenerator_Cloud) == 0x28, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::CloudsMeshGenerator_Ring) == 0x20, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius) == 0x10, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::CloudsMeshGenerator_RadiusChunk) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies CloudsMeshGenerator::Cloud, CloudsMeshGenerator::ProhibitedRadius, CloudsMeshGenerator::RadiusChunk, CloudsMeshGenerator::Ring, UnityEngine.Bounds, UnityEngine.MonoBehaviour,
// UnityEngine.Vector2
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__clouds, put = __cordl_internal_set__clouds)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Cloud> _clouds;
  ...
  __declspec(property(get = __cordl_internal_get__prohibitedRadii, put = __cordl_internal_set__prohibitedRadii)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius> _prohibitedRadii;

  /// @brief Field _radiusChunks, offset 0xd8, size 0x8
  __declspec(property(get = __cordl_internal_get__radiusChunks, put = __cordl_internal_set__radiusChunks)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk> _radiusChunks;
  ...
  __declspec(property(get = __cordl_internal_get__rings, put = __cordl_internal_set__rings)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Ring> _rings;
  ...
  __declspec(property(get = __cordl_internal_get__sortedProhibitedRadii, put = __cordl_internal_set__sortedProhibitedRadii)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>
  ...
  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Cloud> const& __cordl_internal_get__clouds() const;

  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Cloud>& __cordl_internal_get__clouds();
  ...
  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius> const& __cordl_internal_get__prohibitedRadii() const;

  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>& __cordl_internal_get__prohibitedRadii();

  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk> const& __cordl_internal_get__radiusChunks() const;

  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk>& __cordl_internal_get__radiusChunks();
  ...
  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Ring> const& __cordl_internal_get__rings() const;

  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Ring>& __cordl_internal_get__rings();
  ...
  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius> const& __cordl_internal_get__sortedProhibitedRadii() const;

  constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>& __cordl_internal_get__sortedProhibitedRadii();
  ...
  constexpr void __cordl_internal_set__clouds(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Cloud> value);
  ...
  constexpr void __cordl_internal_set__prohibitedRadii(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius> value);

  constexpr void __cordl_internal_set__radiusChunks(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk> value);
  ...
  constexpr void __cordl_internal_set__rings(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Ring> value);
  ...
  constexpr void __cordl_internal_set__sortedProhibitedRadii(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius> value);

  constexpr void __cordl_internal_set__vertexCount(int32_t value);

  /// @brief Method .ctor, addr 0x32862ec, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk> ____radiusChunks;

  /// @brief Field _rings, offset: 0xe0, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Ring> ____rings;

  /// @brief Field _sortedProhibitedRadii, offset: 0xe8, size: 0x8, def value: None
  ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius> ____sortedProhibitedRadii;
...
static_assert(sizeof(::GlobalNamespace::CloudsMeshGenerator) == 0xf0, "Size mismatch!");
