...
// Ctor Parameters [CppParam { name: "precisionOpaqueMesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: None }, CppParam { name: "lowPolyMesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: None }, CppParam { name: "sizeModifier", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "bottomThreshold", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "weight", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "precisionVertexCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lowPolyVertexCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "generatedCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr CloudsMeshGenerator_Cloud(::UnityW<::UnityEngine::Mesh>  precisionOpaqueMesh, ::UnityW<::UnityEngine::Mesh>  lowPolyMesh, float_t  sizeModifier, float_t  bottomThreshold, int32_t  weight, int32_t  precisionVertexCount, int32_t  lowPolyVertexCount, int32_t  generatedCount) noexcept;
...
// Ctor Parameters [CppParam { name: "transform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "distance", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "radius", ty: "float_t", modifiers: "", def_value: None }]
...
/// @brief Field _clouds, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__clouds, put=__cordl_internal_set__clouds)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Cloud,::Array<::GlobalNamespace::CloudsMeshGenerator_Cloud>*>  _clouds;
...
/// @brief Field _prohibitedRadii, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__prohibitedRadii, put=__cordl_internal_set__prohibitedRadii)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*>  _prohibitedRadii;

/// @brief Field _radiusChunks, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get__radiusChunks, put=__cordl_internal_set__radiusChunks)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk,::Array<::GlobalNamespace::CloudsMeshGenerator_RadiusChunk>*>  _radiusChunks;
...
/// @brief Field _rings, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__rings, put=__cordl_internal_set__rings)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_Ring,::Array<::GlobalNamespace::CloudsMeshGenerator_Ring>*>  _rings;
...
/// @brief Field _sortedProhibitedRadii, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get__sortedProhibitedRadii, put=__cordl_internal_set__sortedProhibitedRadii)) ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*>  _sortedProhibitedRadii;
...
constexpr ::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*> const& __cordl_internal_get__sortedProhibitedRadii() const;
...
constexpr void __cordl_internal_set__sortedProhibitedRadii(::ArrayW<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius,::Array<::GlobalNamespace::CloudsMeshGenerator_ProhibitedRadius>*>  value) ;

constexpr void __cordl_internal_set__vertexCount(int32_t  value) ;

/// @brief Method .ctor, addr 0x31b78ec, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;
