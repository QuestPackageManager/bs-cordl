...
public:
  ...
  /// @brief Method .ctor, addr 0x58de738, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <LazyInit>b__15_2, addr 0x58de84c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method <LazyInit>b__15_3, addr 0x58dea48, size 0x14, virtual false, abstract: false, final false
  inline ::StringW _LazyInit_b__15_3(::GlobalNamespace::QuickPlaySongPacksDropdown_SongPackMaskItem* item);

  /// @brief Method <LazyInit>b__15_4, addr 0x58dea04, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58de848, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SelectCellWithSerializedName>b__0, addr 0x58dea5c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58de660, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetSelectedSerializedName, addr 0x58de03c, size 0x74, virtual false, abstract: false, final false
  inline ::StringW GetSelectedSerializedName();

  /// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx, addr 0x58de664, size 0x24, virtual false, abstract: false, final false
  inline void HandleSimpleTextDropdownDidSelectCellWithIdx(::HMUI::DropdownWithTableView* dropdownWithTableView, int32_t idx);

  /// @brief Method LazyInit, addr 0x58de0b0, size 0x43c, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::GlobalNamespace::QuickPlaySongPacksDropdown* New_ctor();

  /// @brief Method OnDestroy, addr 0x58ddf58, size 0xdc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectCellWithSerializedName, addr 0x58de4ec, size 0x174, virtual false, abstract: false, final false
  inline void SelectCellWithSerializedName(::StringW serializedName);

  /// @brief Method SetOverrideSongPacks, addr 0x58de034, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x58ddec8, size 0x90, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method <LazyInit>b__15_0, addr 0x58de68c, size 0xac, virtual false, abstract: false, final false
  inline ::GlobalNamespace::QuickPlaySongPacksDropdown_SongPackMaskItem* _LazyInit_b__15_0(::StringW serializedName);

  /// @brief Method <LazyInit>b__15_1, addr 0x58de73c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58de688, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectCellWithIdxEvent, addr 0x58ddd48, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectCellWithIdxEvent(::System::Action_1<int32_t>* value);

  /// @brief Method remove_didSelectCellWithIdxEvent, addr 0x58dde08, size 0xc0, virtual false, abstract: false, final false
