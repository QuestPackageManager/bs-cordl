...
public:
  ...
  /// @brief Method .ctor, addr 0x265ae40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SelectCellWithSerializedName>b__0, addr 0x265af04, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265ad5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <LazyInit>b__15_2, addr 0x265af94, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method <LazyInit>b__15_3, addr 0x265b174, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _LazyInit_b__15_3(::GlobalNamespace::__QuickPlaySongPacksDropdown__SongPackMaskItem* item);

  /// @brief Method <LazyInit>b__15_4, addr 0x265b134, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265af8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetSelectedSerializedName, addr 0x265a7c0, size 0x70, virtual false, abstract: false, final false
  inline ::StringW GetSelectedSerializedName();

  /// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx, addr 0x265ad64, size 0x24, virtual false, abstract: false, final false
  inline void HandleSimpleTextDropdownDidSelectCellWithIdx(::HMUI::DropdownWithTableView* dropdownWithTableView, int32_t idx);

  /// @brief Method LazyInit, addr 0x265a830, size 0x3dc, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::GlobalNamespace::QuickPlaySongPacksDropdown* New_ctor();

  /// @brief Method OnDestroy, addr 0x265a6e4, size 0xd4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectCellWithSerializedName, addr 0x265ac0c, size 0x150, virtual false, abstract: false, final false
  inline void SelectCellWithSerializedName(::StringW serializedName);

  /// @brief Method SetOverrideSongPacks, addr 0x265a7b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x265a658, size 0x8c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method <LazyInit>b__15_0, addr 0x265ad90, size 0xb0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__QuickPlaySongPacksDropdown__SongPackMaskItem* _LazyInit_b__15_0(::StringW serializedName);

  /// @brief Method <LazyInit>b__15_1, addr 0x265ae48, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265ad88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectCellWithIdxEvent, addr 0x265a4f8, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectCellWithIdxEvent(::System::Action_1<int32_t>* value);

  /// @brief Method remove_didSelectCellWithIdxEvent, addr 0x265a5a8, size 0xb0, virtual false, abstract: false, final false
