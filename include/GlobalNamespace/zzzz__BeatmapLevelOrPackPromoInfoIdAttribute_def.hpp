...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute*, "", "BeatmapLevelOrPackPromoInfoIdAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x374e58c, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLevelOrPackPromoInfoIdAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapLevelOrPackPromoInfoIdAttribute(BeatmapLevelOrPackPromoInfoIdAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLevelOrPackPromoInfoIdAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapLevelOrPackPromoInfoIdAttribute(BeatmapLevelOrPackPromoInfoIdAttributeconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelOrPackPromoInfoIdAttribute) == 0x18, "Size mismatch!");
