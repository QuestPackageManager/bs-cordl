...
public:
// Declarations
/// @brief Method GetNamedValues, addr 0x5869a74, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5869ba4, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;
