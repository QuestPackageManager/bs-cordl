...
public:
  ...
  /// @brief Method <.ctor>b__10_0, addr 0x26e9dc8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e9dc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e9c18, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelPackSO* levelPack, int32_t packIndex);

  /// @brief Method get_levelPack, addr 0x26e9c00, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapLevelPackSO> get_levelPack();

  /// @brief Method get_levelProductsData, addr 0x26e9c08, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_packIndex, addr 0x26e9bf8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_packIndex();

  /// @brief Method set_levelProductsData, addr 0x26e9c10, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e9e38, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelSO* level, int32_t levelIndex);

  /// @brief Method get_level, addr 0x26e9eb0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapLevelSO> get_level();

  /// @brief Method get_levelIndex, addr 0x26e9e68, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_levelIndex();

  /// @brief Method get_ps4SieaAcCode, addr 0x26e9ea0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ps4SieaAcCode();

  /// @brief Method get_ps4SieeDcCode, addr 0x26e9e90, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ps4SieeDcCode();

  /// @brief Method get_ps5SieaAcCode, addr 0x26e9e80, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ps5SieaAcCode();

  /// @brief Method get_ps5SieeDcCode, addr 0x26e9e70, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ps5SieeDcCode();

  /// @brief Method set_ps4SieaAcCode, addr 0x26e9ea8, size 0x8, virtual false, abstract: false, final false
  inline void set_ps4SieaAcCode(::StringW value);

  /// @brief Method set_ps4SieeDcCode, addr 0x26e9e98, size 0x8, virtual false, abstract: false, final false
  inline void set_ps4SieeDcCode(::StringW value);

  /// @brief Method set_ps5SieaAcCode, addr 0x26e9e88, size 0x8, virtual false, abstract: false, final false
  inline void set_ps5SieaAcCode(::StringW value);

  /// @brief Method set_ps5SieeDcCode, addr 0x26e9e78, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e9ed0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_redirectedProductLabel, addr 0x26e9ec0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_redirectedProductLabel();

  /// @brief Method get_sourceLevelPackId, addr 0x26e9eb8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_sourceLevelPackId();

  /// @brief Method get_validUntilDate, addr 0x26e9ec8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e9b5c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelProductPackSource, addr 0x26e9b44, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SonyLevelProductPackSourceSO_LevelProductPackSource* get_levelProductPackSource();

  /// @brief Method get_redirectionSources, addr 0x26e9b54, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_levelProductPackSource, addr 0x26e9b4c, size 0x8, virtual false, abstract: false, final false
