...
public:
  ...
  /// @brief Method <.ctor>b__10_0, addr 0x26ed4c4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ed4bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ed314, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelPackSO* levelPack, int32_t packIndex);

  /// @brief Method get_levelPack, addr 0x26ed2fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapLevelPackSO> get_levelPack();

  /// @brief Method get_levelProductsData, addr 0x26ed304, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_packIndex, addr 0x26ed2f4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_packIndex();

  /// @brief Method set_levelProductsData, addr 0x26ed30c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ed534, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelSO* level, int32_t levelIndex);

  /// @brief Method get_level, addr 0x26ed5ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapLevelSO> get_level();

  /// @brief Method get_levelIndex, addr 0x26ed564, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_levelIndex();

  /// @brief Method get_ps4SieaAcCode, addr 0x26ed59c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ps4SieaAcCode();

  /// @brief Method get_ps4SieeDcCode, addr 0x26ed58c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ps4SieeDcCode();

  /// @brief Method get_ps5SieaAcCode, addr 0x26ed57c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ps5SieaAcCode();

  /// @brief Method get_ps5SieeDcCode, addr 0x26ed56c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ps5SieeDcCode();

  /// @brief Method set_ps4SieaAcCode, addr 0x26ed5a4, size 0x8, virtual false, abstract: false, final false
  inline void set_ps4SieaAcCode(::StringW value);

  /// @brief Method set_ps4SieeDcCode, addr 0x26ed594, size 0x8, virtual false, abstract: false, final false
  inline void set_ps4SieeDcCode(::StringW value);

  /// @brief Method set_ps5SieaAcCode, addr 0x26ed584, size 0x8, virtual false, abstract: false, final false
  inline void set_ps5SieaAcCode(::StringW value);

  /// @brief Method set_ps5SieeDcCode, addr 0x26ed574, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ed5cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_redirectedProductLabel, addr 0x26ed5bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_redirectedProductLabel();

  /// @brief Method get_sourceLevelPackId, addr 0x26ed5b4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_sourceLevelPackId();

  /// @brief Method get_validUntilDate, addr 0x26ed5c4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ed258, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelProductPackSource, addr 0x26ed240, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SonyLevelProductPackSourceSO_LevelProductPackSource* get_levelProductPackSource();

  /// @brief Method get_redirectionSources, addr 0x26ed250, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_levelProductPackSource, addr 0x26ed248, size 0x8, virtual false, abstract: false, final false
