...
public:
  ...
  /// @brief Method ApplyViewportScale, addr 0x5d3dddc, size 0xa0c, virtual false, abstract: false, final false
  inline void ApplyViewportScale();

  /// @brief Method CalculateCurveViewBillboardMatrix, addr 0x5d3eb4c, size 0x328, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 CalculateCurveViewBillboardMatrix(::UnityEngine::Camera* mainCamera);

  /// @brief Method InitializeRenderTexture, addr 0x5d3ce70, size 0x9a0, virtual false, abstract: false, final false
  inline void InitializeRenderTexture();

  /// @brief Method LateUpdate, addr 0x5d3eab0, size 0x98, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LineCircleIntersection, addr 0x5d3f160, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5d3d810, size 0xe4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5d3d9f0, size 0x9c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5d3d8f4, size 0xfc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x5d3eb48, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RenderCamera, addr 0x5d3e7e8, size 0x2c8, virtual false, abstract: false, final false
  inline void RenderCamera();

  /// @brief Method ShouldRender, addr 0x5d3da8c, size 0x314, virtual true, abstract: false, final false
  inline bool ShouldRender();

  /// @brief Method Start, addr 0x5d3c9cc, size 0x4a4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TransformRay, addr 0x5d3ee74, size 0x2ec, virtual true, abstract: false, final false
  inline ::UnityEngine::Ray TransformRay(::UnityEngine::Ray ray);

  /// @brief Method Update, addr 0x5d3dda0, size 0x3c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5d3f22c, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_overlayEnabled, addr 0x5d3c8b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_overlayEnabled, addr 0x5d3c8c0, size 0x10c, virtual false, abstract: false, final false
