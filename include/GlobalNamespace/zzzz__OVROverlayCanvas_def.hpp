...
/// @brief Method ApplyViewportScale, addr 0x5ccbdf4, size 0xa0c, virtual false, abstract: false, final false
inline void ApplyViewportScale() ;

/// @brief Method CalculateCurveViewBillboardMatrix, addr 0x5cccb64, size 0x328, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 CalculateCurveViewBillboardMatrix(::UnityEngine::Camera*  mainCamera) ;

/// @brief Method InitializeRenderTexture, addr 0x5ccae88, size 0x9a0, virtual false, abstract: false, final false
inline void InitializeRenderTexture() ;

/// @brief Method LateUpdate, addr 0x5cccac8, size 0x98, virtual false, abstract: false, final false
inline void LateUpdate() ;

/// @brief Method LineCircleIntersection, addr 0x5ccd178, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5ccb828, size 0xe4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x5ccba08, size 0x9c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5ccb90c, size 0xfc, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x5cccb60, size 0x4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method RenderCamera, addr 0x5ccc800, size 0x2c8, virtual false, abstract: false, final false
inline void RenderCamera() ;

/// @brief Method ShouldRender, addr 0x5ccbaa4, size 0x314, virtual true, abstract: false, final false
inline bool ShouldRender() ;

/// @brief Method Start, addr 0x5cca9e4, size 0x4a4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TransformRay, addr 0x5ccce8c, size 0x2ec, virtual true, abstract: false, final false
inline ::UnityEngine::Ray TransformRay(::UnityEngine::Ray  ray) ;

/// @brief Method Update, addr 0x5ccbdb8, size 0x3c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5ccd244, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_overlayEnabled, addr 0x5cca8d0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_overlayEnabled, addr 0x5cca8d8, size 0x10c, virtual false, abstract: false, final false
