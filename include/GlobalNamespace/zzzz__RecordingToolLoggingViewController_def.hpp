...
public:
  ...
  /// @brief Method DidActivate, addr 0x3af8e44, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af8ee0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
