...
public:
  ...
  /// @brief Method DidActivate, addr 0x57a5f6c, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a6014, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
