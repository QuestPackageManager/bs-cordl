...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingToolLoggingViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolLoggingViewController*, "", "RecordingToolLoggingViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a170c8, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a17170, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RecordingToolLoggingViewController) == 0x88, "Size mismatch!");
