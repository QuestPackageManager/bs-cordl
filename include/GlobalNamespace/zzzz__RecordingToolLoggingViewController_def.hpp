...
public:
  ...
  /// @brief Method DidActivate, addr 0x3af63b4, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af6450, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
