...
public:
  ...
  /// @brief Method DidActivate, addr 0x56d9140, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56d91e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
