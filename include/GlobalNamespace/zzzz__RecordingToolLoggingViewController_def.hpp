...
public:
  ...
  /// @brief Method DidActivate, addr 0x265a884, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265a920, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
