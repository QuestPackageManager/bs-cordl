...
/// @brief Method DidActivate, addr 0x57a77d4, size 0xa8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a787c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
