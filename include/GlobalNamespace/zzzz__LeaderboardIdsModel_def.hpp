...
public:
  ...
  /// @brief Method TryGetPlatformLeaderboardId, addr 0x369553c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3694f58, size 0x5e4, virtual false, abstract: false, final false
