...
public:
  ...
  /// @brief Method TryGetPlatformLeaderboardId, addr 0x27017d0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27011dc, size 0x5f4, virtual false, abstract: false, final false
