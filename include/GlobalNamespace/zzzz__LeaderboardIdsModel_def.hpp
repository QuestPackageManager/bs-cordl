...
public:
  ...
  /// @brief Method TryGetPlatformLeaderboardId, addr 0x26ff910, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ff31c, size 0x5f4, virtual false, abstract: false, final false
