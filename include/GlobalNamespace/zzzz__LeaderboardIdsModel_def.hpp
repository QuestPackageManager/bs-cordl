...
public:
  ...
  /// @brief Method TryGetPlatformLeaderboardId, addr 0x26cbb80, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26cb58c, size 0x5f4, virtual false, abstract: false, final false
