...
public:
  // Declarations
  /// @brief Method SerializedName addr 0x23001e8 size 0x74 virtual false final false
  static inline ::StringW SerializedName(::GlobalNamespace::__ObjectsMovementRecorder__Mode mode);

  /// @brief Method ModeFromSerializedName addr 0x230025c size 0xcc virtual false final false
  static inline bool ModeFromSerializedName(::StringW name, ByRef<::GlobalNamespace::__ObjectsMovementRecorder__Mode> mode);

  /// @brief Method SerializedName addr 0x2300328 size 0x70 virtual false final false
  static inline ::StringW SerializedName(::GlobalNamespace::__ObjectsMovementRecorder__CameraView cameraView);

  /// @brief Method CameraViewFromSerializedName addr 0x2300398 size 0x9c virtual false final false
  ...
  /// @brief Method SerializedName addr 0x2300434 size 0x68 virtual false final false
  static inline ::StringW SerializedName(::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot__Type type);

  /// @brief Method PlaybackScreenshotTypeFromSerializedName addr 0x230049c size 0xa4 virtual false final false
