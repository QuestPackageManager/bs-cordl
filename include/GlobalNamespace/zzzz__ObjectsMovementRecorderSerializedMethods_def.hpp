...
public:
  // Declarations
  /// @brief Method CameraViewFromSerializedName, addr 0x3b19698, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ModeFromSerializedName, addr 0x3b19564, size 0xcc, virtual false, abstract: false, final false
  static inline bool ModeFromSerializedName(::StringW name, ::ByRef<::GlobalNamespace::ObjectsMovementRecorder_Mode> mode);

  /// @brief Method PlaybackScreenshotTypeFromSerializedName, addr 0x3b1979c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method SerializedName, addr 0x3b19630, size 0x68, virtual false, abstract: false, final false
  static inline ::StringW SerializedName(::GlobalNamespace::ObjectsMovementRecorder_CameraView cameraView);

  /// @brief Method SerializedName, addr 0x3b194f0, size 0x74, virtual false, abstract: false, final false
  static inline ::StringW SerializedName(::GlobalNamespace::ObjectsMovementRecorder_Mode mode);

  /// @brief Method SerializedName, addr 0x3b19734, size 0x68, virtual false, abstract: false, final false
