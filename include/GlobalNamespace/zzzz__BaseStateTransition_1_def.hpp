...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BaseStateTransition_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BaseStateTransition_1(BaseStateTransition_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BaseStateTransition_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BaseStateTransition_1(BaseStateTransition_1const&) = delete;
