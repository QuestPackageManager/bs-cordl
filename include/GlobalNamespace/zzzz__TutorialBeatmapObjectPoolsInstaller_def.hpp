...
public:
  ...
  /// @brief Method InstallBindings, addr 0x262af38, size 0x18c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262b0c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
