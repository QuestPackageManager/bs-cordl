...
public:
  ...
  /// @brief Method SetColor, addr 0x26a12b8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a12c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x26a12ac, size 0xc, virtual true, abstract: false, final false
