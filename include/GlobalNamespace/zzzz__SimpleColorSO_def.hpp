...
public:
  ...
  /// @brief Method SetColor, addr 0x269eb7c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x269eb88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x269eb70, size 0xc, virtual true, abstract: false, final false
