...
public:
  ...
  /// @brief Method SetColor, addr 0x26a69ec, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a69f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x26a69e0, size 0xc, virtual true, abstract: false, final false
