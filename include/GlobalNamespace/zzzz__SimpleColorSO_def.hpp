...
public:
  ...
  /// @brief Method SetColor, addr 0x3638e1c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3638e28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x3638e10, size 0xc, virtual true, abstract: false, final false
