...
public:
  ...
  /// @brief Method LateUpdate, addr 0x5848dc8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5848df0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
