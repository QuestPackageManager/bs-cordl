...
public:
  ...
  /// @brief Method Cleanup, addr 0x3fd16f0, size 0xe8, virtual false, abstract: false, final false
  static inline void Cleanup();

  /// @brief Method RecenterPose, addr 0x3fd2098, size 0x94, virtual false, abstract: false, final false
  static inline void RecenterPose();

  /// @brief Method Update, addr 0x3fd1210, size 0x4e0, virtual false, abstract: false, final false
