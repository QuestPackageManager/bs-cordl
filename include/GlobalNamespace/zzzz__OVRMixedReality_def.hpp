...
public:
  ...
  /// @brief Method Cleanup, addr 0x5d36008, size 0xf0, virtual false, abstract: false, final false
  static inline void Cleanup();

  /// @brief Method RecenterPose, addr 0x5d3773c, size 0x98, virtual false, abstract: false, final false
  static inline void RecenterPose();

  /// @brief Method Update, addr 0x5d35b0c, size 0x4fc, virtual false, abstract: false, final false
