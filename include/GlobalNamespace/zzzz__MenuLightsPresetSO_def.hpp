...
public:
  ...
  /// @brief Method .ctor, addr 0x58f3580, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightIdColorPairs, addr 0x58f3570, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::LightIdColorPair*, ::Array<::GlobalNamespace::LightIdColorPair*>*> get_lightIdColorPairs();

  /// @brief Method set_lightIdColorPairs, addr 0x58f3578, size 0x8, virtual false, abstract: false, final false
