...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProModeTrailingCollidersController::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3af00e4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProModeTrailingCollidersController::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3af0180;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProModeTrailingCollidersController::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3af024c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ProModeTrailingCollidersController*>::get(),
                                                                               "HandleNoteDidMoveInJumpPhase", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProModeTrailingCollidersController::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3af03bc;
...
GlobalNamespace::ProModeTrailingCollidersController::__cordl_internal_get__trailingSmallCuttableBySaberList() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::ProModeTrailingCollidersController::__cordl_internal_get__trailingSmallCuttableBySaberList() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____trailingSmallCuttableBySaberList;
}
constexpr void GlobalNamespace::ProModeTrailingCollidersController::__cordl_internal_set__trailingSmallCuttableBySaberList(
