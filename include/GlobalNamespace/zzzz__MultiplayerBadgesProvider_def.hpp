...
public:
  ...
  /// @brief Method <SelectBadgesAndPutThemIntoResults>b__7_0, addr 0x3675674, size 0x28, virtual false, abstract: false, final false
  inline bool _SelectBadgesAndPutThemIntoResults_b__7_0(::GlobalNamespace::MultiplayerPlayerResultsData* result);

  /// @brief Method <SelectBadgesAndPutThemIntoResults>b__7_1, addr 0x367569c, size 0x28, virtual false, abstract: false, final false
  inline int32_t _SelectBadgesAndPutThemIntoResults_b__7_1(::GlobalNamespace::MultiplayerPlayerResultsData* p);

  /// @brief Method .ctor, addr 0x3675670, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SelectBadgesAndPutThemIntoResults, addr 0x367435c, size 0x12bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3675618, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
