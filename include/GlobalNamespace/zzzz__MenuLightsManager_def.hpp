...
public:
  ...
  /// @brief Method MoveNext, addr 0x25b4aa8, size 0xcc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__MenuLightsManager___Start_d__4* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x25b4b74, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x25b4b7c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x25b4bbc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x25b4aa4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25b4620, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CurrentColorForID, addr 0x25b484c, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Color CurrentColorForID(int32_t lightId);

  /// @brief Method IsColorVeryCloseToColor, addr 0x25b47ec, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshColors, addr 0x25b4a08, size 0x8c, virtual false, abstract: false, final false
  inline void RefreshColors();

  /// @brief Method RefreshLightsDictForPreset, addr 0x25b486c, size 0xe0, virtual false, abstract: false, final false
  inline void RefreshLightsDictForPreset(::GlobalNamespace::MenuLightsPresetSO* preset);

  /// @brief Method SetColor, addr 0x25b4830, size 0x1c, virtual false, abstract: false, final false
  inline void SetColor(int32_t lightId, ::UnityEngine::Color color);

  /// @brief Method SetColorPreset, addr 0x25b494c, size 0xbc, virtual false, abstract: false, final false
  inline void SetColorPreset(::GlobalNamespace::MenuLightsPresetSO* preset, bool animated);

  /// @brief Method SetColorsFromPreset, addr 0x25b4688, size 0x164, virtual false, abstract: false, final false
  inline bool SetColorsFromPreset(::GlobalNamespace::MenuLightsPresetSO* preset, float_t interpolationFactor);

  /// @brief Method Start, addr 0x25b45b8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Start();

  /// @brief Method Update, addr 0x25b4648, size 0x40, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x25b4a94, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
