...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b7f934, size 0x1e0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::MenuLightsManager__Start_d__8* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b7fb14, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b7fb1c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b7fb54, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3b7f930, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b7f098, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CurrentColorForID, addr 0x3b7f0dc, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Color CurrentColorForID(int32_t lightId);

  /// @brief Method GetLightForIndex, addr 0x3b7f244, size 0xa0, virtual false, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, ::UnityEngine::Color> GetLightForIndex(int32_t index);

  /// @brief Method GetLightsCount, addr 0x3b7f220, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetLightsCount();

  /// @brief Method HandleTweenFinished, addr 0x3b7f6d0, size 0x58, virtual false, abstract: false, final false
  inline void HandleTweenFinished();

  static inline ::GlobalNamespace::MenuLightsManager* New_ctor();

  /// @brief Method RefreshColors, addr 0x3b7f820, size 0x8c, virtual false, abstract: false, final false
  inline void RefreshColors();

  /// @brief Method ResetColorPresetToDefault, addr 0x3b7f5b0, size 0x98, virtual false, abstract: false, final false
  inline void ResetColorPresetToDefault(bool animated);

  /// @brief Method SaveOriginalColors, addr 0x3b7f35c, size 0xdc, virtual false, abstract: false, final false
  inline void SaveOriginalColors();

  /// @brief Method SetAlphaMultiplier, addr 0x3b7f728, size 0xf8, virtual false, abstract: false, final false
  inline void SetAlphaMultiplier(float_t alphaMultiplier, bool animated, float_t duration);

  /// @brief Method SetColor, addr 0x3b7f0c0, size 0x1c, virtual false, abstract: false, final false
  inline void SetColor(int32_t lightId, ::UnityEngine::Color color);

  /// @brief Method SetColorPreset, addr 0x3b7f4d8, size 0xd8, virtual false, abstract: false, final false
  inline void SetColorPreset(::GlobalNamespace::MenuLightsPresetSO* preset, bool animated, float_t duration);

  /// @brief Method SetDefaultPreset, addr 0x3b7f438, size 0xa0, virtual false, abstract: false, final false
  inline void SetDefaultPreset(::GlobalNamespace::MenuLightsPresetSO* preset, bool animated);

  /// @brief Method SetTargetColors, addr 0x3b7f2e4, size 0x78, virtual false, abstract: false, final false
  inline void SetTargetColors();

  /// @brief Method Start, addr 0x3b7f038, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Start();

  /// @brief Method StartLightAnimation, addr 0x3b7f648, size 0x88, virtual false, abstract: false, final false
  inline void StartLightAnimation(float_t duration);

  /// @brief Method UpdateColors, addr 0x3b7f0fc, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7f8ac, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
