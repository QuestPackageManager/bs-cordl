...
public:
  ...
  /// @brief Method CalculateDelayMsBeforeRetry, addr 0x22cbbd0, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22cbb5c, size 0x74, virtual false, abstract: false, final false
