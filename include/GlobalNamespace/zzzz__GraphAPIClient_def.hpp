...
public:
  ...
  /// @brief Method CalculateDelayMsBeforeRetry, addr 0x22ca89c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22ca828, size 0x74, virtual false, abstract: false, final false
