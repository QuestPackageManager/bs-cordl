...
public:
  ...
  /// @brief Method CalculateDelayMsBeforeRetry, addr 0x3273348, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32732d8, size 0x70, virtual false, abstract: false, final false
