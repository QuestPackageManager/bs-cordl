...
public:
  ...
  /// @brief Method CalculateDelayMsBeforeRetry, addr 0x22c9880, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22c980c, size 0x74, virtual false, abstract: false, final false
