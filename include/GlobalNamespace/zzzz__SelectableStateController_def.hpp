...
public:
  ...
  /// @brief Method SetState, addr 0x44da7f4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44da818, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_stateDidChangeEvent, addr 0x44d7908, size 0xb0, virtual false, abstract: false, final false
  inline void add_stateDidChangeEvent(::System::Action_2<::GlobalNamespace::SelectableStateController_ViewState, bool>* value);

  /// @brief Method get_currentViewState, addr 0x44da7e4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SelectableStateController_ViewState get_currentViewState();

  /// @brief Method get_tweeningManager, addr 0x44da7dc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Tweening::TimeTweeningManager> get_tweeningManager();

  /// @brief Method remove_stateDidChangeEvent, addr 0x44d7a44, size 0xb0, virtual false, abstract: false, final false
  inline void remove_stateDidChangeEvent(::System::Action_2<::GlobalNamespace::SelectableStateController_ViewState, bool>* value);

  /// @brief Method set_currentViewState, addr 0x44da7ec, size 0x8, virtual false, abstract: false, final false
