...
public:
  ...
  /// @brief Method Awake, addr 0x39e7480, size 0x84, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x39e7504, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e76e4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
