...
public:
  ...
  /// @brief Method Awake, addr 0x23f558c, size 0x84, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x23f5610, size 0x460, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f5a70, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
