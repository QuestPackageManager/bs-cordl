...
public:
  ...
  /// @brief Method Awake, addr 0x24f5178, size 0x84, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x24f51fc, size 0x460, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f565c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
