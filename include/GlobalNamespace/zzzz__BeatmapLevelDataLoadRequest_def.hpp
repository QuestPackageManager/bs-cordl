...
public:
  ...
  /// @brief Method MoveNext, addr 0x365b368, size 0x790, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x365baf8, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x365a690, size 0x74, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method LoadDataAsync, addr 0x365a704, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadDataAsyncInternal, addr 0x365b054, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ThrowIfExternalCancellationRequested, addr 0x365b144, size 0x19c, virtual false, abstract: false, final false
  inline void ThrowIfExternalCancellationRequested();

  /// @brief Method UnloadBundle, addr 0x365b2e0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365a7d8, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::StringW assetBundlePath, ::StringW levelDataAssetName);

  /// @brief Method get_HasFailed, addr 0x365a654, size 0x3c, virtual false, abstract: false, final false
  inline bool get_HasFailed();

  /// @brief Method get_HasValidResult, addr 0x365af28, size 0xac, virtual false, abstract: false, final false
