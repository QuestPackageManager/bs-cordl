...
/// @brief Method BindRingsAndSetTiming, addr 0x582e714, size 0x78c, virtual false, abstract: false, final false
...
/// @brief Method BindTimeline, addr 0x582d9dc, size 0x788, virtual false, abstract: false, final false
inline void BindTimeline() ;

/// @brief Method CalculatePlayerIndexSequence, addr 0x582e164, size 0x5b0, virtual false, abstract: false, final false
...
/// @brief Method Completed, addr 0x582eea0, size 0x38, virtual false, abstract: false, final false
inline void Completed() ;

/// @brief Method GetFullIntroAnimationTime, addr 0x5828c6c, size 0x3dc, virtual false, abstract: false, final false
inline int64_t GetFullIntroAnimationTime() ;

static inline ::GlobalNamespace::MultiplayerIntroAnimationController* New_ctor() ;

/// @brief Method OnValidate, addr 0x582d48c, size 0x550, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method PlayIntroAnimation, addr 0x5829048, size 0x114, virtual false, abstract: false, final false
inline void PlayIntroAnimation(float_t  maxDesiredIntroAnimationDuration, ::System::Action*  onCompleted) ;

/// @brief Method SetBeforeIntroValue, addr 0x582b910, size 0x474, virtual false, abstract: false, final false
inline void SetBeforeIntroValue() ;

/// @brief Method TransitionToAfterIntroAnimationState, addr 0x582915c, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x582eed8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
