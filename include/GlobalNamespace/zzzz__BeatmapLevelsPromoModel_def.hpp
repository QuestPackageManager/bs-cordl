...
public:
  ...
  /// @brief Method IsBeatmapLevelPackPromoted, addr 0x26f9398, size 0x5c, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPackPromoted(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack);

  /// @brief Method IsBeatmapLevelPackUpdated, addr 0x26f93f4, size 0x5c, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPackUpdated(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack);

  /// @brief Method IsBeatmapLevelPromoted, addr 0x26f9450, size 0x5c, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPromoted(::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method IsBeatmapLevelUpdated, addr 0x26f94ac, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f927c, size 0x11c, virtual false, abstract: false, final false
