...
public:
  ...
  /// @brief Method IsBeatmapLevelPackPromoted, addr 0x374a0c8, size 0x68, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPackPromoted(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack);

  /// @brief Method IsBeatmapLevelPackUpdated, addr 0x374a130, size 0x68, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPackUpdated(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack);

  /// @brief Method IsBeatmapLevelPromoted, addr 0x374a198, size 0x68, virtual false, abstract: false, final false
  inline bool IsBeatmapLevelPromoted(::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method IsBeatmapLevelUpdated, addr 0x374a200, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3749f10, size 0x1b8, virtual false, abstract: false, final false
