...
public:
  // Declarations
  /// @brief Method ApplyWindowSettings, addr 0x57de4e4, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57de640, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
