...
public:
  // Declarations
  /// @brief Method ApplyWindowSettings, addr 0x3b318e0, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3193c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
