...
public:
  ...
  /// @brief Method DidActivate, addr 0x3c1c2b8, size 0x100, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::HowToPlayViewController* New_ctor();

  /// @brief Method <DidActivate>b__6_0, addr 0x3c1c3c0, size 0x20, virtual false, abstract: false, final false
  inline void _DidActivate_b__6_0();

  /// @brief Method <DidActivate>b__6_1, addr 0x3c1c3e0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c1c3b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3c1c158, size 0xb0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::HowToPlayViewController_HowToPlayOptions>* value);

  /// @brief Method remove_didFinishEvent, addr 0x3c1c208, size 0xb0, virtual false, abstract: false, final false
