...
public:
  ...
  /// @brief Method OnDisable, addr 0x57e3520, size 0x10c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57e3414, size 0x10c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResetRoom, addr 0x57e3260, size 0xcc, virtual false, abstract: false, final false
  inline void ResetRoom();

  /// @brief Method SetRoomTransformOffset, addr 0x57e332c, size 0x94, virtual false, abstract: false, final false
  inline void SetRoomTransformOffset();

  /// @brief Method Start, addr 0x57e3200, size 0x60, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x57e33c0, size 0x54, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57e362c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
