...
public:
  ...
  /// @brief Method SetData, addr 0x2449b90, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2449f1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
