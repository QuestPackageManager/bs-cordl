...
public:
  ...
  /// @brief Method SetData, addr 0x56e7aa4, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56e7e2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
