...
public:
  ...
  /// @brief Method SetData, addr 0x3b06274, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b065fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
