...
public:
  ...
  /// @brief Method SetData, addr 0x57b4ec4, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b524c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
