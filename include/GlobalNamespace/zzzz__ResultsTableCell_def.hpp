...
public:
  ...
  /// @brief Method SetData, addr 0x596c9f8, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x596cd80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
