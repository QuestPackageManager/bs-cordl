...
public:
  // Declarations
  /// @brief Method HandleInputFieldDidChange, addr 0x23ad284, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ad314, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
