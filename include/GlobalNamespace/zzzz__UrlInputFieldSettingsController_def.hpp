...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(4900))]
...
public:
  // Declarations
  /// @brief Method HandleInputFieldDidChange, addr 0x22de5d0, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22de660, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
