...
public:
  ...
  /// @brief Method get_clip addr 0x222cd40 size 0x1c virtual false final false
  inline ::UnityEngine::AudioClip* get_clip();

  /// @brief Method set_clip addr 0x222cd5c size 0x40 virtual false final false
  inline void set_clip(::UnityEngine::AudioClip* value);

  /// @brief Method set_pitch addr 0x222cd9c size 0x40 virtual false final false
  inline void set_pitch(float_t value);

  /// @brief Method set_time addr 0x222cddc size 0x40 virtual false final false
  inline void set_time(float_t value);

  /// @brief Method get_isPlaying addr 0x222ce1c size 0x1c virtual false final false
  inline bool get_isPlaying();

  /// @brief Method Awake addr 0x222ce38 size 0x15c virtual false final false
  inline void Awake();

  /// @brief Method OnDestroy addr 0x222cf94 size 0x88 virtual false final false
  inline void OnDestroy();

  /// @brief Method PlayPitchGainEffect addr 0x222d01c size 0x20 virtual false final false
  inline void PlayPitchGainEffect(float_t volumeScale);

  /// @brief Method InterruptLastPitchGainEffect addr 0x222d03c size 0x1c virtual false final false
  inline void InterruptLastPitchGainEffect();

  /// @brief Method CrossFade addr 0x222d058 size 0x1c8 virtual false final false
  inline void CrossFade(float_t toSongTime, float_t toVolume);

  /// @brief Method Play addr 0x222d220 size 0x1c virtual false final false
  inline void Play();

  /// @brief Method Stop addr 0x222d23c size 0x50 virtual false final false
  inline void Stop();

  static inline ::GlobalNamespace::CrossFadeAudioSource* New_ctor();

  /// @brief Method .ctor addr 0x222d28c size 0x14 virtual false final false
  inline void _ctor();

  /// @brief Method <Awake>b__21_0 addr 0x222d2a0 size 0x1c virtual false final false
  inline void _Awake_b__21_0(float_t val);

  /// @brief Method <Awake>b__21_1 addr 0x222d2bc size 0x1c virtual false final false
  inline void _Awake_b__21_1(float_t val);

  /// @brief Method <CrossFade>b__25_0 addr 0x222d2d8 size 0x1c virtual false final false
  inline void _CrossFade_b__25_0(float_t val);

  /// @brief Method <CrossFade>b__25_1 addr 0x222d2f4 size 0x1c virtual false final false
  inline void _CrossFade_b__25_1(float_t val);

  /// @brief Method <CrossFade>b__25_2 addr 0x222d310 size 0x30 virtual false final false
