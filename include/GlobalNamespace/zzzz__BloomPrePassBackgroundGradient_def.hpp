...
public:
  ...
  /// @brief Method UpdatePixels, addr 0x39d6898, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39d690c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
