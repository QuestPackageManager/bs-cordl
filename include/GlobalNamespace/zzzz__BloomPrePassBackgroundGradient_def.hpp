...
public:
  ...
  /// @brief Method UpdatePixels, addr 0x586286c, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58628e0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
