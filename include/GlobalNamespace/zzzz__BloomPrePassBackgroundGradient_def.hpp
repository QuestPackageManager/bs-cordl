...
public:
  ...
  /// @brief Method UpdatePixels, addr 0x564d978, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x564d9ec, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
