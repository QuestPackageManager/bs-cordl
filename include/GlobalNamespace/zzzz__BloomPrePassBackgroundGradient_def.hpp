...
/// @brief Method UpdatePixels, addr 0x571da9c, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x571db10, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
