...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoPauseGamePause", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoPauseGamePause(NoPauseGamePause&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoPauseGamePause", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoPauseGamePause(NoPauseGamePauseconst&) = delete;
