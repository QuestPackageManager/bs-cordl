...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OverridableGradientDirection::*)()>(
    &::GlobalNamespace::OverridableGradientDirection::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x22813c8;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OverridableGradientDirection*>::get(), ".ctor",
...
inline ::GlobalNamespace::OverridableGradientDirection* GlobalNamespace::OverridableGradientDirection::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::OverridableGradientDirection*>());
}
// Ctor Parameters []
