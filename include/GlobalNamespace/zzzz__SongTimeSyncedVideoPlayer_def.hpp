...
public:
  ...
  /// @brief Field _environmentContext, offset 0x60, size 0x4
  ...
  /// @brief Field _waitForDependenciesAndPlayCoroutine, offset 0x78, size 0x8
...
public:
  ...
  /// @brief Field _waitForDependenciesAndPlayCoroutine, offset: 0x78, size: 0x8, def value: None
  ::UnityEngine::Coroutine* ____waitForDependenciesAndPlayCoroutine;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::SongTimeSyncedVideoPlayer, ____videoPlayer) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SongTimeSyncedVideoPlayer, ____materialPropertyBlockController) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SongTimeSyncedVideoPlayer, ____audioTimeSource) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SongTimeSyncedVideoPlayer, ____gamePause) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SongTimeSyncedVideoPlayer, ____environmentContext) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SongTimeSyncedVideoPlayer, ____color) == 0x64, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SongTimeSyncedVideoPlayer, ____waitForDependenciesAndPlayCoroutine) == 0x78, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::SongTimeSyncedVideoPlayer) == 0x80, "Size mismatch!");
