...
public:
  ...
  /// @brief Method MoveNext, addr 0x2598c68, size 0xfc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2598d64, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2598d6c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2598dac, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2598c64, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2598a60, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x25987dc, size 0x8, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  /// @brief Method LateUpdate, addr 0x2598678, size 0x164, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SongTimeSyncedVideoPlayer* New_ctor();

  /// @brief Method OnDestroy, addr 0x2598430, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetSpriteAndStopVideo, addr 0x2598800, size 0x260, virtual false, abstract: false, final false
  inline void SetSpriteAndStopVideo(::UnityEngine::Sprite* sprite);

  /// @brief Method SetVideoClip, addr 0x25987e4, size 0x1c, virtual false, abstract: false, final false
  inline void SetVideoClip(::UnityEngine::Video::VideoClip* videoClip);

  /// @brief Method Start, addr 0x2598368, size 0x60, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StopVideoPlayer, addr 0x2598434, size 0x4c, virtual false, abstract: false, final false
  inline void StopVideoPlayer();

  /// @brief Method Update, addr 0x2598480, size 0x1f8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method WaitForDependenciesAndPlay, addr 0x25983c8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* WaitForDependenciesAndPlay();

  /// @brief Method <WaitForDependenciesAndPlay>b__17_0, addr 0x2598b60, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2598a88, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
