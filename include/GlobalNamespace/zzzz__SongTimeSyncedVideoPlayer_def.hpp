...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b3300c, size 0x20c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b33218, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b33220, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b33258, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3b33008, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b32df0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x3b32a88, size 0x8, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  /// @brief Method HandleGamePauseDidPause, addr 0x3b32db8, size 0x1c, virtual false, abstract: false, final false
  inline void HandleGamePauseDidPause();

  /// @brief Method HandleGamePauseDidResume, addr 0x3b32dd4, size 0x1c, virtual false, abstract: false, final false
  inline void HandleGamePauseDidResume();

  /// @brief Method LateUpdate, addr 0x3b329ec, size 0x9c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SongTimeSyncedVideoPlayer* New_ctor();

  /// @brief Method OnDestroy, addr 0x3b32580, size 0x19c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetSpriteAndStopVideo, addr 0x3b32bb8, size 0x200, virtual false, abstract: false, final false
  inline void SetSpriteAndStopVideo(::UnityEngine::Sprite* sprite);

  /// @brief Method SetVideoClip, addr 0x3b32a90, size 0x128, virtual false, abstract: false, final false
  inline void SetVideoClip(::UnityEngine::Video::VideoClip* videoClip);

  /// @brief Method Start, addr 0x3b32350, size 0x1d0, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StopVideoPlayer, addr 0x3b3271c, size 0xd0, virtual false, abstract: false, final false
  inline void StopVideoPlayer();

  /// @brief Method Update, addr 0x3b327ec, size 0x200, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method WaitForDependenciesAndPlay, addr 0x3b32520, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* WaitForDependenciesAndPlay();

  /// @brief Method <WaitForDependenciesAndPlay>b__20_0, addr 0x3b32ef0, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b32e18, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
