...
public:
  ...
  /// @brief Method Start, addr 0x58b4484, size 0x38, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58b44bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_worldToPlayerSpaceRotation, addr 0x58b4478, size 0xc, virtual false, abstract: false, final false
