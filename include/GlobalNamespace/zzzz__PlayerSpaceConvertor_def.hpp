...
public:
  ...
  /// @brief Method Start, addr 0x57dac88, size 0x38, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x57dacc0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_worldToPlayerSpaceRotation, addr 0x57dac7c, size 0xc, virtual false, abstract: false, final false
