...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerSpaceConvertor*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerSpaceConvertor*, "", "PlayerSpaceConvertor");
...
public:
  ...
  /// @brief Method Start, addr 0x59e63b0, size 0x38, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59e63e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_worldToPlayerSpaceRotation, addr 0x59e63a4, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PlayerSpaceConvertor) == 0x30, "Size mismatch!");
