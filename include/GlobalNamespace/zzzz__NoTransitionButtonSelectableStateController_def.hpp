...
public:
  // Declarations
  /// @brief Method HandleNoTransitionButtonSelectionStateDidChange, addr 0x44d44cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x44d443c, size 0x90, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x44d42dc, size 0xa8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResolveSelectionState, addr 0x44d4384, size 0xb8, virtual false, abstract: false, final false
  inline void ResolveSelectionState(::HMUI::NoTransitionsButton_SelectionState state, bool animated);

  /// @brief Method .ctor, addr 0x44d44d4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
