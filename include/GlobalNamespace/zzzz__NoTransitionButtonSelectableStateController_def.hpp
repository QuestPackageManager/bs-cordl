...
public:
// Declarations
/// @brief Method HandleNoTransitionButtonSelectionStateDidChange, addr 0x62907e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x6290754, size 0x90, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x629065c, size 0xa8, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ResolveSelectionState, addr 0x6290704, size 0x50, virtual false, abstract: false, final false
inline void ResolveSelectionState(::HMUI::NoTransitionsButton_SelectionState  state, bool  animated) ;

/// @brief Method .ctor, addr 0x62907ec, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;
