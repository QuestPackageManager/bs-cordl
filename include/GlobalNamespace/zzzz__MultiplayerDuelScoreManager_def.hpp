...
public:
  ...
  /// @brief Method EnsureOpponentAssigned, addr 0x3bce878, size 0x2c, virtual false, abstract: false, final false
  inline bool EnsureOpponentAssigned();

  /// @brief Method GetOpponentPlayer, addr 0x3bce8a4, size 0x3d4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IConnectedPlayer* GetOpponentPlayer();

  /// @brief Method HandleStateChanged, addr 0x3bced58, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bce744, size 0xcc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3bce3a0, size 0xd0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3bce810, size 0x68, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateScoreAndName, addr 0x3bce58c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bcee4c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
