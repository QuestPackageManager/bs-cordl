...
public:
  ...
  /// @brief Method EnsureOpponentAssigned, addr 0x273923c, size 0x2c, virtual false, abstract: false, final false
  inline bool EnsureOpponentAssigned();

  /// @brief Method GetOpponentPlayer, addr 0x2739268, size 0x3f0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IConnectedPlayer* GetOpponentPlayer();

  /// @brief Method HandleStateChanged, addr 0x2739738, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2739104, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x2738d64, size 0xcc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x27391d4, size 0x68, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateScoreAndName, addr 0x2738f4c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2739828, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
