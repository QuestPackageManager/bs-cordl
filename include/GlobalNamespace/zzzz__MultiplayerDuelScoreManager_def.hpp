...
public:
  ...
  /// @brief Method EnsureOpponentAssigned, addr 0x59d6c00, size 0x30, virtual false, abstract: false, final false
  inline bool EnsureOpponentAssigned();

  /// @brief Method GetOpponentPlayer, addr 0x59d6c30, size 0x3b4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IConnectedPlayer* GetOpponentPlayer();

  /// @brief Method HandleStateChanged, addr 0x59d70c0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x59d6a68, size 0x110, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59d66bc, size 0xd0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x59d6b78, size 0x88, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateScoreAndName, addr 0x59d68a0, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59d71b4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
