...
/// @brief Method EnsureOpponentAssigned, addr 0x582c218, size 0x30, virtual false, abstract: false, final false
inline bool EnsureOpponentAssigned() ;

/// @brief Method GetOpponentPlayer, addr 0x582c248, size 0x3b4, virtual false, abstract: false, final false
inline ::GlobalNamespace::IConnectedPlayer* GetOpponentPlayer() ;

/// @brief Method HandleStateChanged, addr 0x582c5fc, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x582c080, size 0x110, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x582bdec, size 0xd4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x582c190, size 0x88, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateScoreAndName, addr 0x582bec0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x582c6f4, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
