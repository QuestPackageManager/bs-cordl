...
public:
  // Declarations
  /// @brief Method GetNamedValues, addr 0x3c13f44, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c140dc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
