...
public:
  // Declarations
  /// @brief Method GetNamedValues, addr 0x586efd8, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586f178, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();
