...
public:
  // Declarations
  /// @brief Method GetNamedValues, addr 0x580b2fc, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x580b49c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();
