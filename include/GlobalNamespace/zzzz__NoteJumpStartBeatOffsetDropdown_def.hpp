...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5698)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5698), inst: 387 })}
...
public:
  // Declarations
  /// @brief Method GetNamedValues addr 0x2166894 size 0x198 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2166a2c size 0x48 virtual false final false
  inline void _ctor();
