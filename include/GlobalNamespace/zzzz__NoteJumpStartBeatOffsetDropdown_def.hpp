...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoteJumpStartBeatOffsetDropdown", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoteJumpStartBeatOffsetDropdown(NoteJumpStartBeatOffsetDropdown&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoteJumpStartBeatOffsetDropdown", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoteJumpStartBeatOffsetDropdown(NoteJumpStartBeatOffsetDropdownconst&) = delete;
