...
public:
  ...
  /// @brief Method Finalize, addr 0x3ad405c, size 0x104, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleAnyGameplayLevelDidFinish, addr 0x3ad4160, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ad3fb0, size 0xac, virtual false, abstract: false, final false
