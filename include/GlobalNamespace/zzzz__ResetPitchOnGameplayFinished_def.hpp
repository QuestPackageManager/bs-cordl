...
public:
  ...
  /// @brief Method Finalize, addr 0x570ee18, size 0xc8, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleAnyGameplayLevelDidFinish, addr 0x570eee0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x570ed78, size 0xa0, virtual false, abstract: false, final false
