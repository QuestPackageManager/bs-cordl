...
public:
  ...
  /// @brief Method Finalize, addr 0x3ad3cc0, size 0x104, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleAnyGameplayLevelDidFinish, addr 0x3ad3dc4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ad3c14, size 0xac, virtual false, abstract: false, final false
