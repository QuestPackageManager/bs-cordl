...
public:
  ...
  /// @brief Method Finalize, addr 0x3acf0e8, size 0x104, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleAnyGameplayLevelDidFinish, addr 0x3acf1ec, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3acf03c, size 0xac, virtual false, abstract: false, final false
