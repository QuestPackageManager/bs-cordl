...
public:
  ...
  /// @brief Method Finalize, addr 0x3ae1764, size 0x104, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleAnyGameplayLevelDidFinish, addr 0x3ae1868, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ae16b8, size 0xac, virtual false, abstract: false, final false
