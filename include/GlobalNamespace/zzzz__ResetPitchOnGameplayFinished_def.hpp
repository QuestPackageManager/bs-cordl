...
public:
  ...
  /// @brief Method Finalize, addr 0x260a518, size 0x110, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleAnyGameplayLevelDidFinish, addr 0x260a628, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260a470, size 0xa8, virtual false, abstract: false, final false
