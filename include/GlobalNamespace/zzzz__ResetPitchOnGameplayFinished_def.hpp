...
/// @brief Method Finalize, addr 0x570eba0, size 0xc8, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method HandleAnyGameplayLevelDidFinish, addr 0x570ec68, size 0x1c, virtual false, abstract: false, final false
inline void HandleAnyGameplayLevelDidFinish() ;

static inline ::GlobalNamespace::ResetPitchOnGameplayFinished* New_ctor(::GlobalNamespace::GameplayLevelSceneTransitionEvents*  gameplayLevelSceneTransitionEvents, ::GlobalNamespace::AudioManager*  audioManager) ;
...
/// @brief Method .ctor, addr 0x570eb00, size 0xa0, virtual false, abstract: false, final false
