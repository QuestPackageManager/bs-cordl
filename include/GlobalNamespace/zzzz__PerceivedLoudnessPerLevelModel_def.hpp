...
/// @brief Method GetLoudnessByLevelId, addr 0x3632efc, size 0x80, virtual false, abstract: false, final false
inline float_t GetLoudnessByLevelId(::StringW  levelId) ;

/// @brief Method GetLoudnessByLevelIdOrNull, addr 0x3632f94, size 0x98, virtual false, abstract: false, final false
inline ::System::Nullable_1<float_t> GetLoudnessByLevelIdOrNull(::StringW  levelId) ;

/// @brief Method GetLoudnessCorrectionByLevelId, addr 0x3632ed8, size 0x24, virtual false, abstract: false, final false
inline float_t GetLoudnessCorrectionByLevelId(::StringW  levelId) ;

/// @brief Method GetMaxSfxVolumeByLevelId, addr 0x3632f7c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x36328f0, size 0x5e8, virtual false, abstract: false, final false
