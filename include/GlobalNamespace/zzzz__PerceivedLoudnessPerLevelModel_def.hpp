...
public:
  ...
  /// @brief Method GetLoudnessByLevelId, addr 0x26d28cc, size 0x7c, virtual false, abstract: false, final false
  inline float_t GetLoudnessByLevelId(::StringW levelId);

  /// @brief Method GetLoudnessByLevelIdOrNull, addr 0x26d2960, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<float_t> GetLoudnessByLevelIdOrNull(::StringW levelId);

  /// @brief Method GetLoudnessCorrectionByLevelId, addr 0x26d28ac, size 0x20, virtual false, abstract: false, final false
  inline float_t GetLoudnessCorrectionByLevelId(::StringW levelId);

  /// @brief Method GetMaxSfxVolumeByLevelId, addr 0x26d2948, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d22b4, size 0x5f8, virtual false, abstract: false, final false
