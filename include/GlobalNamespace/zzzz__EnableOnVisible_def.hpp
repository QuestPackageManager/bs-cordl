...
public:
  ...
  /// @brief Method add_VisibilityChangedEvent addr 0x20f22a8 size 0xb0 virtual false final false
  inline void add_VisibilityChangedEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_VisibilityChangedEvent addr 0x20f2358 size 0xb0 virtual false final false
  inline void remove_VisibilityChangedEvent(::System::Action_1<bool>* value);

  /// @brief Method Awake addr 0x20f2408 size 0x64 virtual false final false
  inline void Awake();

  /// @brief Method OnBecameVisible addr 0x20f246c size 0x88 virtual false final false
  inline void OnBecameVisible();

  /// @brief Method OnBecameInvisible addr 0x20f24f4 size 0x88 virtual false final false
  inline void OnBecameInvisible();

  static inline ::GlobalNamespace::EnableOnVisible* New_ctor();

  /// @brief Method .ctor addr 0x20f257c size 0x8 virtual false final false
  inline void _ctor();
