...
public:
  ...
  /// @brief Method Awake, addr 0x22b5f60, size 0x64, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::EnableOnVisible* New_ctor();

  /// @brief Method OnBecameInvisible, addr 0x22b604c, size 0x88, virtual false, abstract: false, final false
  inline void OnBecameInvisible();

  /// @brief Method OnBecameVisible, addr 0x22b5fc4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22b60d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_VisibilityChangedEvent, addr 0x22b5e00, size 0xb0, virtual false, abstract: false, final false
  inline void add_VisibilityChangedEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_VisibilityChangedEvent, addr 0x22b5eb0, size 0xb0, virtual false, abstract: false, final false
