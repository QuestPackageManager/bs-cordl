...
public:
  ...
  /// @brief Method OnDestroy, addr 0x58575e4, size 0x60, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x585742c, size 0x1b8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5857644, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
