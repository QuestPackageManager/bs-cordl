...
public:
  ...
  __declspec(property(get = __cordl_internal_get__data, put = __cordl_internal_set__data)) ::ArrayW<T> _data;
  ...
  constexpr ::ArrayW<T>& __cordl_internal_get__data();

  constexpr int32_t const& __cordl_internal_get__tail() const;

  constexpr int32_t& __cordl_internal_get__tail();

  constexpr void __cordl_internal_set__data(::ArrayW<T> value);
