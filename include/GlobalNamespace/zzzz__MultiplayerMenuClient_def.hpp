...
public:
  ...
  /// @brief Method LateUpdate, addr 0x265c554, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265c8cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
