...
public:
  ...
  /// @brief Method LateUpdate, addr 0x2648710, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2648a88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
