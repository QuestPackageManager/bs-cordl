...
public:
  ...
  /// @brief Method LateUpdate, addr 0x594385c, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5943b94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerMenuClient", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerMenuClient(MultiplayerMenuClient&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerMenuClient", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerMenuClient(MultiplayerMenuClientconst&) = delete;
