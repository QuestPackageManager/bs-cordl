...
public:
  ...
  /// @brief Method LateUpdate, addr 0x58df854, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58dfb94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
