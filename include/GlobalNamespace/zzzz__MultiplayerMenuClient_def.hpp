...
public:
  ...
  /// @brief Method LateUpdate, addr 0x253873c, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2538aa4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
