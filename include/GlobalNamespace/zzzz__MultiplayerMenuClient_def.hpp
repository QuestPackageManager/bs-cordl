...
public:
  ...
  /// @brief Method LateUpdate, addr 0x59415f0, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5941928, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
