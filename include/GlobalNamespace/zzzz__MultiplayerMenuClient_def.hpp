...
public:
  ...
  /// @brief Method LateUpdate, addr 0x262f0f0, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262f468, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
