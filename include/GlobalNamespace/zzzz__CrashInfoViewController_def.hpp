...
public:
  ...
  /// @brief Method Start, addr 0x3c160cc, size 0x78, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3c16144, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
