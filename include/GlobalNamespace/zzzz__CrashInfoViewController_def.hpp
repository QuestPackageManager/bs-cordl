...
public:
  ...
  /// @brief Method Start, addr 0x25407f0, size 0x78, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2540868, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
