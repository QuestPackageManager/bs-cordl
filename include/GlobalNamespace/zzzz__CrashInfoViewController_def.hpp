...
public:
  ...
  /// @brief Method Start, addr 0x23b1690, size 0x78, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x23b1708, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
