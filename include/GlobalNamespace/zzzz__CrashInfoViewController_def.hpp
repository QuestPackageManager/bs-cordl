...
// Write type traits
MARK_REF_T(::GlobalNamespace::CrashInfoViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CrashInfoViewController*, "", "CrashInfoViewController");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CrashInfoViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CrashInfoViewController(CrashInfoViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CrashInfoViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CrashInfoViewController(CrashInfoViewControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::CrashInfoViewController) == 0x30, "Size mismatch!");
