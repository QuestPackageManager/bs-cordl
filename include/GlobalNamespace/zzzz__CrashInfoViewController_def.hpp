...
public:
  ...
  /// @brief Method Start, addr 0x5a118e8, size 0x7c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5a11964, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
