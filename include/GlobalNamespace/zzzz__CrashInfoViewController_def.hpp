...
public:
  ...
  /// @brief Method Start, addr 0x3b990b8, size 0x78, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b99130, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
