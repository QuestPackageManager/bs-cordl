...
public:
  ...
  /// @brief Method ConvertRenderTexture, addr 0x56a36c0, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> ConvertRenderTexture(::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method LateUpdate, addr 0x56a34e0, size 0x140, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::ScreenshotRecorder* New_ctor();

  /// @brief Method OnApplicationFocus, addr 0x56a36a8, size 0x18, virtual false, abstract: false, final false
  inline void OnApplicationFocus(bool hasFocus);

  /// @brief Method OnDisable, addr 0x56a3418, size 0xc8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x56a3264, size 0x1b4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SaveCameraScreenshot, addr 0x56a3620, size 0x88, virtual false, abstract: false, final false
  inline void SaveCameraScreenshot();

  /// @brief Method SaveTextureScreenshot, addr 0x56a37bc, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56a3914, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_directory, addr 0x56a3254, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_directory();

  /// @brief Method set_directory, addr 0x56a325c, size 0x8, virtual false, abstract: false, final false
