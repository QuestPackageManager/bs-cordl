...
public:
  ...
  /// @brief Method CreateCaptureFolder, addr 0x58bc038, size 0x7c, virtual false, abstract: false, final false
  inline void CreateCaptureFolder(::StringW folderName);

  /// @brief Method CreateLogPath, addr 0x58bc1e0, size 0x178, virtual false, abstract: false, final false
  inline ::StringW CreateLogPath(::StringW folder, float_t startTime);

  /// @brief Method FinishProfiling, addr 0x58bbe2c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupProfiler, addr 0x58bc0b4, size 0x30, virtual false, abstract: false, final false
  inline void SetupProfiler();

  /// @brief Method Start, addr 0x58bbedc, size 0x15c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartProfilingToFile, addr 0x58bc358, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58bc464, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
