...
public:
  ...
  /// @brief Method MoveNext, addr 0x57114bc, size 0x308, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::SongProfilingController__ProfileCoroutine_d__8* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x57117c4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x57117cc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5711804, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x57114b8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x57111d0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateCaptureFolder, addr 0x57110c0, size 0x7c, virtual false, abstract: false, final false
  inline void CreateCaptureFolder(::StringW folderName);

  /// @brief Method CreateLogPath, addr 0x57111d8, size 0x178, virtual false, abstract: false, final false
  inline ::StringW CreateLogPath(::StringW folder, float_t startTime);

  /// @brief Method FinishProfiling, addr 0x5710f5c, size 0xb0, virtual false, abstract: false, final false
  inline void FinishProfiling();

  static inline ::GlobalNamespace::SongProfilingController* New_ctor();

  /// @brief Method OnDestroy, addr 0x57111cc, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ProfileCoroutine, addr 0x571116c, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* ProfileCoroutine(::StringW folderName);

  /// @brief Method SetupProfiler, addr 0x571113c, size 0x30, virtual false, abstract: false, final false
  inline void SetupProfiler();

  /// @brief Method Start, addr 0x571100c, size 0xb4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartProfilingToFile, addr 0x5711350, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x571145c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
