...
public:
  ...
  /// @brief Method MoveNext, addr 0x3ad64ac, size 0x2b0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::SongProfilingController__ProfileCoroutine_d__8* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3ad675c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3ad6764, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3ad679c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3ad64a8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ad621c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateCaptureFolder, addr 0x3ad6128, size 0x78, virtual false, abstract: false, final false
  inline void CreateCaptureFolder(::StringW folderName);

  /// @brief Method CreateLogPath, addr 0x3ad6244, size 0x150, virtual false, abstract: false, final false
  inline ::StringW CreateLogPath(::StringW folder, float_t startTime);

  /// @brief Method FinishProfiling, addr 0x3ad5ff8, size 0x9c, virtual false, abstract: false, final false
  inline void FinishProfiling();

  static inline ::GlobalNamespace::SongProfilingController* New_ctor();

  /// @brief Method OnDestroy, addr 0x3ad6218, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ProfileCoroutine, addr 0x3ad61ac, size 0x6c, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* ProfileCoroutine(::StringW folderName);

  /// @brief Method SetupProfiler, addr 0x3ad61a0, size 0xc, virtual false, abstract: false, final false
  inline void SetupProfiler();

  /// @brief Method Start, addr 0x3ad6094, size 0x94, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartProfilingToFile, addr 0x3ad6394, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ad6450, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
