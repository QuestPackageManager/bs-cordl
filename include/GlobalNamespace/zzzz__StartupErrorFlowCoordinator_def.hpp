...
public:
  ...
  /// @brief Method DidActivate, addr 0x265524c, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26552c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
