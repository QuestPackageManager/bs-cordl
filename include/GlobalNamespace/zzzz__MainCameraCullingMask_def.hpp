...
public:
  ...
  /// @brief Method .ctor, addr 0x408fd84, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Start, addr 0x408fc6c, size 0xb0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x408fd1c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
