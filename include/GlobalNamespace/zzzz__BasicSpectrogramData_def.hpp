...
public:
  ...
  /// @brief Method Awake, addr 0x5866424, size 0xb0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetFakeSamples, addr 0x58660ec, size 0x144, virtual false, abstract: false, final false
  inline void GetFakeSamples(::ArrayW<float_t, ::Array<float_t>*> samples);

  /// @brief Method LateUpdate, addr 0x58664d4, size 0x8, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::BasicSpectrogramData* New_ctor();

  /// @brief Method ProcessSamples, addr 0x586626c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58664dc, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ProcessedSamples, addr 0x5866230, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<float_t>* get_ProcessedSamples();

  /// @brief Method get_Samples, addr 0x5866034, size 0xb8, virtual false, abstract: false, final false
