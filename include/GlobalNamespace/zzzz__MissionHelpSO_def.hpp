...
public:
  ...
  /// @brief Method .ctor, addr 0x26daef0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_missionHelpId, addr 0x26daee8, size 0x8, virtual false, abstract: false, final false
