...
public:
  ...
  /// @brief Method .ctor, addr 0x26d6b50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_missionHelpId, addr 0x26d6b48, size 0x8, virtual false, abstract: false, final false
