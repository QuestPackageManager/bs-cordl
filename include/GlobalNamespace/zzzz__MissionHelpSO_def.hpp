...
public:
  ...
  /// @brief Method .ctor, addr 0x26d6e04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_missionHelpId, addr 0x26d6dfc, size 0x8, virtual false, abstract: false, final false
