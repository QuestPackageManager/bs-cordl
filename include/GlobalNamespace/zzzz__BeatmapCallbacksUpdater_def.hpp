...
public:
  ...
  /// @brief Method LateUpdate, addr 0x5788048, size 0x1f8, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::BeatmapCallbacksUpdater* New_ctor();

  /// @brief Method Pause, addr 0x5788240, size 0xc, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method Resume, addr 0x578824c, size 0xc, virtual false, abstract: false, final false
  inline void Resume();
  ...
  /// @brief Method .ctor, addr 0x5788258, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
