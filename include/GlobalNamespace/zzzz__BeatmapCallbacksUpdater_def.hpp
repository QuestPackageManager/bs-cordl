...
// [AddComponentMenu("Beat Saber/Gameplay/BeatmapCallbacksUpdater")]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapCallbacksUpdater", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapCallbacksUpdater(BeatmapCallbacksUpdater&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapCallbacksUpdater", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapCallbacksUpdater(BeatmapCallbacksUpdaterconst&) = delete;
