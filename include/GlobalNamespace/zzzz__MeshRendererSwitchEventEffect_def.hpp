...
public:
  ...
  __declspec(property(get = __cordl_internal_get__activateOnBoostRenderers, put = __cordl_internal_set__activateOnBoostRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>>
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>>& __cordl_internal_get__activateOnBoostRenderers();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> const& __cordl_internal_get__deactivateOnBoostRenderers() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>>& __cordl_internal_get__deactivateOnBoostRenderers();

  constexpr void __cordl_internal_set__activateOnBoostRenderers(::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> value);
...
static_assert(sizeof(::GlobalNamespace::MeshRendererSwitchEventEffect) == 0x48, "Size mismatch!");
