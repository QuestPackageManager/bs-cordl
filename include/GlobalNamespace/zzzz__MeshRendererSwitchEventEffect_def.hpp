...
/// @brief Field _activateOnBoostRenderers, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__activateOnBoostRenderers, put=__cordl_internal_set__activateOnBoostRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>,::Array<::UnityW<::UnityEngine::MeshRenderer>>*>  _activateOnBoostRenderers;
...
/// @brief Field _deactivateOnBoostRenderers, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__deactivateOnBoostRenderers, put=__cordl_internal_set__deactivateOnBoostRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>,::Array<::UnityW<::UnityEngine::MeshRenderer>>*>  _deactivateOnBoostRenderers;

/// @brief Method HandleBeatmapEvent, addr 0x57ebd58, size 0x1c, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::MeshRendererSwitchEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57ebd3c, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57ebc14, size 0x128, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method ToggleObjects, addr 0x57ebd74, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ebe28, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
