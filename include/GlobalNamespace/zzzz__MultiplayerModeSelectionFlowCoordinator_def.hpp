...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b52900, size 0x3d0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b52cd0, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b52cdc, size 0x420, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b530fc, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b53108, size 0xadc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b53be4, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method BackButtonWasPressed, addr 0x3b4ff94, size 0xcc, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DidActivate, addr 0x3b4f654, size 0x4c4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b4fbb4, size 0x3e0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleConnectedPlayerManagerCreated, addr 0x3b520d8, size 0x98, virtual false, abstract: false, final false
  inline void HandleConnectedPlayerManagerCreated(::GlobalNamespace::INetworkPlayerModel* networkPlayerModel);

  /// @brief Method HandleCreateServerViewControllerDidFinish, addr 0x3b519c8, size 0x3f8, virtual false, abstract: false, final false
  inline void HandleCreateServerViewControllerDidFinish(bool success, ::GlobalNamespace::CreateServerFormData data);

  /// @brief Method HandleGameServerBrowserFlowCoordinatorDidFinish, addr 0x3b51398, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleGameServerLobbyFlowCoordinatorDidFinish, addr 0x3b51dc0, size 0x274, virtual false, abstract: false, final false
  inline void HandleGameServerLobbyFlowCoordinatorDidFinish();

  /// @brief Method HandleGameServerLobbyFlowCoordinatorWillFinish, addr 0x3b52034, size 0xa4, virtual false, abstract: false, final false
  inline void HandleGameServerLobbyFlowCoordinatorWillFinish();

  /// @brief Method HandleJoinQuickPlayViewControllerDidFinish, addr 0x3b51470, size 0x438, virtual false, abstract: false, final false
  inline void HandleJoinQuickPlayViewControllerDidFinish(bool success);

  /// @brief Method HandleJoiningLobbyViewControllerDidCancel, addr 0x3b513ac, size 0xc4, virtual false, abstract: false, final false
  inline void HandleJoiningLobbyViewControllerDidCancel();

  /// @brief Method HandleMultiplayerLobbyConnectionControllerConnectionFailed, addr 0x3b50cf4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerLobbyConnectionControllerConnectionSuccess, addr 0x3b50cc8, size 0x2c, virtual false, abstract: false, final false
  inline void HandleMultiplayerLobbyConnectionControllerConnectionSuccess();

  /// @brief Method HandleMultiplayerLobbyConnectionControllerConnectionSuccessActivateModel, addr 0x3b50cac, size 0x1c, virtual false, abstract: false, final false
  inline void HandleMultiplayerLobbyConnectionControllerConnectionSuccessActivateModel();

  /// @brief Method HandleMultiplayerLobbyControllerDidFinish, addr 0x3b50db8, size 0x5e0, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleServerCodeEntryViewControllerDidFinish, addr 0x3b518a8, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method PresentConnectionErrorDialog, addr 0x3b5071c, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method PresentMasterServerUnavailableErrorDialog, addr 0x3b52170, size 0x4c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessDeeplinkingToLobby, addr 0x3b52630, size 0xf0, virtual false, abstract: false, final false
  inline void ProcessDeeplinkingToLobby();

  /// @brief Method ResolveAndPresentNextFlowCoordinator, addr 0x3b50680, size 0x9c, virtual false, abstract: false, final false
  inline void ResolveAndPresentNextFlowCoordinator(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Setup, addr 0x3b4f64c, size 0x8, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::SelectMultiplayerLobbyDestination* lobbyDestination);

  /// @brief Method TopViewControllerWillChange, addr 0x3b50060, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method TransitionDidFinish, addr 0x3b503f8, size 0x288, virtual true, abstract: false, final false
  inline void TransitionDidFinish();

  /// @brief Method TransitionDidStart, addr 0x3b502ac, size 0x14c, virtual true, abstract: false, final false
  inline void TransitionDidStart();

  /// @brief Method TryShowModeSelection, addr 0x3b4fb18, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method <PresentConnectionErrorDialog>b__53_0, addr 0x3b528b0, size 0x18, virtual false, abstract: false, final false
  inline void _PresentConnectionErrorDialog_b__53_0(int32_t btnId);

  /// @brief Method <PresentConnectionErrorDialog>b__53_1, addr 0x3b528c8, size 0x18, virtual false, abstract: false, final false
  inline void _PresentConnectionErrorDialog_b__53_1(int32_t btnId);

  /// @brief Method <PresentMasterServerUnavailableErrorDialog>b__54_0, addr 0x3b528e0, size 0x20, virtual false, abstract: false, final false
  inline void _PresentMasterServerUnavailableErrorDialog_b__54_0(int32_t btnId);

  /// @brief Method <ResolveAndPresentNextFlowCoordinator>b__52_0, addr 0x3b52728, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b52720, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b4f4e4, size 0xb4, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::MultiplayerModeSelectionFlowCoordinator>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x3b4f598, size 0xb4, virtual false, abstract: false, final false
