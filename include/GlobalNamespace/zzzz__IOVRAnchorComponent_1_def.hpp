...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IOVRAnchorComponent_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IOVRAnchorComponent_1(IOVRAnchorComponent_1const&) = delete;
