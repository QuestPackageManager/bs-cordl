...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "INoteControllerNoteDidStartDissolvingEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INoteControllerNoteDidStartDissolvingEvent(INoteControllerNoteDidStartDissolvingEventconst&) = delete;
