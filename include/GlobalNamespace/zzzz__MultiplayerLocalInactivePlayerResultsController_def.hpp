...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerLocalInactivePlayerResultsController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerLocalInactivePlayerResultsController(MultiplayerLocalInactivePlayerResultsController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerLocalInactivePlayerResultsController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerLocalInactivePlayerResultsController(MultiplayerLocalInactivePlayerResultsControllerconst&) = delete;
