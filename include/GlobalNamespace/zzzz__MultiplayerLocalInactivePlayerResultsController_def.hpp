...
public:
  ...
  /// @brief Method HandleMultiplayerStateChange, addr 0x272a8c0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x272a834, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetMultiplayerState, addr 0x272a7f8, size 0x3c, virtual false, abstract: false, final false
  inline void SetMultiplayerState(::GlobalNamespace::__MultiplayerController__State state);

  /// @brief Method Start, addr 0x272a740, size 0xb8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x272a8c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MultiplayerLocalInactivePlayerResultsController, 0x20>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLocalInactivePlayerResultsController, ____multiplayerController) == 0x18, "Offset mismatch!");
