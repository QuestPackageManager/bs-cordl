...
/// @brief Method HandleMultiplayerStateChange, addr 0x581de5c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x581ddcc, size 0x90, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetMultiplayerState, addr 0x581dd90, size 0x3c, virtual false, abstract: false, final false
inline void SetMultiplayerState(::GlobalNamespace::MultiplayerController_State  state) ;

/// @brief Method Start, addr 0x581dcd4, size 0xbc, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x581de60, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
