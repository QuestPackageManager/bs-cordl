...
public:
  ...
  /// @brief Method Execute, addr 0x2787ca0, size 0x84, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method HasBoundaryChanged, addr 0x2787d24, size 0xb0, virtual false, abstract: false, final false
  inline bool HasBoundaryChanged();

  /// @brief Method SetNaN, addr 0x2787dd4, size 0x14, virtual false, abstract: false, final false
  static inline void SetNaN(::Unity::Collections::NativeArray_1<::UnityEngine::Vector2> array);

  /// @brief Method Execute, addr 0x2787de8, size 0xa8, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method set_Width, addr 0x2786eb8, size 0x8, virtual false, abstract: false, final false
  inline void set_Width(float_t value);

  /// @brief Method get_Height, addr 0x2786ec0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Height();

  /// @brief Method set_Height, addr 0x2786ec8, size 0x8, virtual false, abstract: false, final false
  inline void set_Height(float_t value);

  /// @brief Method get_Offset, addr 0x2786ed0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_Offset();

  /// @brief Method set_Offset, addr 0x2786ed8, size 0x8, virtual false, abstract: false, final false
  inline void set_Offset(::UnityEngine::Vector2 value);

  /// @brief Method get_Dimensions, addr 0x2786ee0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_Dimensions();

  /// @brief Method get_Boundary, addr 0x2786ee8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::Vector2>* get_Boundary();

  /// @brief Method get_ScaleChildren, addr 0x2786ef0, size 0x8, virtual false, abstract: false, final false
  inline bool get_ScaleChildren();

  /// @brief Method set_ScaleChildren, addr 0x2786ef8, size 0x34, virtual false, abstract: false, final false
  inline void set_ScaleChildren(bool value);

  /// @brief Method get_OffsetChildren, addr 0x2787070, size 0x8, virtual false, abstract: false, final false
  inline bool get_OffsetChildren();

  /// @brief Method set_OffsetChildren, addr 0x2787078, size 0x34, virtual false, abstract: false, final false
  inline void set_OffsetChildren(bool value);

  /// @brief Method SetChildScale, addr 0x2786f2c, size 0x144, virtual false, abstract: false, final false
  inline void SetChildScale();

  /// @brief Method SetChildOffset, addr 0x27870ac, size 0x12c, virtual false, abstract: false, final false
  inline void SetChildOffset();

  /// @brief Method UpdateTransform, addr 0x2784290, size 0x17c, virtual false, abstract: false, final false
  inline void UpdateTransform();

  /// @brief Method Awake, addr 0x27871d8, size 0xd4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Start, addr 0x27872ac, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method IOVRSceneComponent.Initialize, addr 0x27872b0, size 0x4, virtual true, abstract: false, final true
  inline void IOVRSceneComponent_Initialize();

  /// @brief Method ScheduleGetLengthJob, addr 0x27872b4, size 0x188, virtual false, abstract: false, final false
  inline void ScheduleGetLengthJob();

  /// @brief Method RequestBoundary, addr 0x278440c, size 0x30, virtual false, abstract: false, final false
  inline void RequestBoundary();

  /// @brief Method Update, addr 0x278743c, size 0x6a4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method OnDisable, addr 0x2787b10, size 0x10c, virtual false, abstract: false, final false
  inline void OnDisable();

  static inline ::GlobalNamespace::OVRScenePlane* New_ctor();

  /// @brief Method .ctor, addr 0x2787c1c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
