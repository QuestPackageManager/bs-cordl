...
/// @brief Method .ctor, addr 0x56bf1b0, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_sqrtRadius, addr 0x56bf1a0, size 0x8, virtual false, abstract: false, final false
inline float_t get_sqrtRadius() ;

/// @brief Method set_sqrtRadius, addr 0x56bf1a8, size 0x8, virtual false, abstract: false, final false
