...
public:
  ...
  /// @brief Method .ctor, addr 0x572d09c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sqrtRadius, addr 0x572d08c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_sqrtRadius();

  /// @brief Method set_sqrtRadius, addr 0x572d094, size 0x8, virtual false, abstract: false, final false
