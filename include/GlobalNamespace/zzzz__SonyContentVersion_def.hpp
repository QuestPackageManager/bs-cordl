...
public:
  ...
  /// @brief Method Get, addr 0x26a6e78, size 0x1b4, virtual false, abstract: false, final false
  inline ::StringW Get(::GlobalNamespace::__SonyContentVersion__VersionFormat versionFormat);

  /// @brief Method GetFromString, addr 0x26a6ae8, size 0x300, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SonyContentVersion* GetFromString(::StringW versionString);

  /// @brief Method IsVersionFormatValid, addr 0x26a6de8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a6aac, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(uint32_t majorVersion, uint32_t minorVersion, uint32_t revision);

  /// @brief Method get_majorVersion, addr 0x26a6a94, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_majorVersion();

  /// @brief Method get_minorVersion, addr 0x26a6a9c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_minorVersion();

  /// @brief Method get_revision, addr 0x26a6aa4, size 0x8, virtual false, abstract: false, final false
