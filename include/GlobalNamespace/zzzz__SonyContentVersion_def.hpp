...
public:
  ...
  /// @brief Method CopyValueFrom, addr 0x26e9758, size 0x24, virtual false, abstract: false, final false
  inline void CopyValueFrom(::GlobalNamespace::SonyContentVersion* other);

  /// @brief Method Get, addr 0x26e9bc4, size 0x1b4, virtual false, abstract: false, final false
  inline ::StringW Get(::GlobalNamespace::SonyContentVersion_VersionFormat versionFormat);

  /// @brief Method GetFromString, addr 0x26e9834, size 0x300, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SonyContentVersion* GetFromString(::StringW versionString);

  /// @brief Method IncreaseMinorVersion, addr 0x26e97b4, size 0x24, virtual false, abstract: false, final false
  inline void IncreaseMinorVersion();

  /// @brief Method IsVersionFormatValid, addr 0x26e9b34, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x26e9d78, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e97f8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(uint32_t majorVersion, uint32_t minorVersion, uint32_t revision);

  /// @brief Method get_majorVersion, addr 0x26e97e0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_majorVersion();

  /// @brief Method get_minorVersion, addr 0x26e97e8, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_minorVersion();

  /// @brief Method get_revision, addr 0x26e97f0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_revision();

  /// @brief Method op_Implicit, addr 0x26e9d80, size 0x14, virtual false, abstract: false, final false
