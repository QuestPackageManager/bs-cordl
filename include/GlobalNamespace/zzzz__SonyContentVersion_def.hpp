...
public:
  ...
  /// @brief Method Get, addr 0x14ed970, size 0x1178, virtual false, abstract: false, final false
  inline ::StringW Get(::GlobalNamespace::__SonyContentVersion__VersionFormat versionFormat);

  /// @brief Method GetFromString, addr 0x14ed5a4, size 0x33c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SonyContentVersion* GetFromString(::StringW versionString);

  /// @brief Method IsVersionFormatValid, addr 0x14ed8e0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14ed568, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(uint32_t majorVersion, uint32_t minorVersion, uint32_t revision);

  /// @brief Method get_majorVersion, addr 0x14ed550, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_majorVersion();

  /// @brief Method get_minorVersion, addr 0x14ed558, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_minorVersion();

  /// @brief Method get_revision, addr 0x14ed560, size 0x8, virtual false, abstract: false, final false
