...
// Ctor Parameters [CppParam { name: "time", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "segmentAngle", ty: "float_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "topPos", ty: "::UnityEngine::Vector3", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "bottomPos", ty: "::UnityEngine::Vector3",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "segmentNormal", ty: "::UnityEngine::Vector3", modifiers: "", def_value: Some("{}"), comment: None }]
