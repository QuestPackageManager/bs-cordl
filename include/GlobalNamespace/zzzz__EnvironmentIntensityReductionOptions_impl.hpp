...
constexpr ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType  GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType::Keep{static_cast<int32_t>(0x0)};
constexpr ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType  GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType::RemoveWithStrobeFilter{static_cast<int32_t>(0x1)};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
...
constexpr ::GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType  GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType::Keep{static_cast<int32_t>(0x0)};
constexpr ::GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType  GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType::RemoveWithStrobeFilter{static_cast<int32_t>(0x1)};
//  Writing Method size for method: ::GlobalNamespace::EnvironmentIntensityReductionOptions.get_compressExpand
template<>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType (::GlobalNamespace::EnvironmentIntensityReductionOptions::*)()>(&::GlobalNamespace::EnvironmentIntensityReductionOptions::get_compressExpand)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x360ba78;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::EnvironmentIntensityReductionOptions_RotateRingsReductionType (::GlobalNamespace::EnvironmentIntensityReductionOptions::*)()>(&::GlobalNamespace::EnvironmentIntensityReductionOptions::get_rotateRings)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x360ba80;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnvironmentIntensityReductionOptions::*)()>(&::GlobalNamespace::EnvironmentIntensityReductionOptions::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x360ba88;
...
constexpr ::GlobalNamespace::EnvironmentIntensityReductionOptions_CompressExpandReductionType const& GlobalNamespace::EnvironmentIntensityReductionOptions::__cordl_internal_get__compressExpand() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____compressExpand;
}
