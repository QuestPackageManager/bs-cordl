...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::GameServerLobbyFlowCoordinatorBase_LobbyType (::GlobalNamespace::GameServerLobbyFlowCoordinatorBase::*)()>(&::GlobalNamespace::GameServerLobbyFlowCoordinatorBase::GetLobbyType)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GameServerLobbyFlowCoordinatorBase::*)()>(&::GlobalNamespace::GameServerLobbyFlowCoordinatorBase::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x585f45c;
