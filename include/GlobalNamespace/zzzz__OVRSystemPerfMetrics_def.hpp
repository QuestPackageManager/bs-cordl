...
public:
  ...
  /// @brief Method LoadFromJSON, addr 0x4048b70, size 0x954, virtual false, abstract: false, final false
  inline bool LoadFromJSON(::StringW json);

  static inline ::GlobalNamespace::OVRSystemPerfMetrics_PerfMetrics* New_ctor();

  /// @brief Method ToJSON, addr 0x404839c, size 0x730, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4049c78, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GatherPerfMetrics, addr 0x4049f9c, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x4049e78, size 0xa0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x4049d30, size 0x148, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x4049f18, size 0x84, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x404a29c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x4048394, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
