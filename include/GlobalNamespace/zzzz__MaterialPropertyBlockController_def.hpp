...
/// @brief Method ApplyChanges, addr 0x56bd9d4, size 0x54, virtual false, abstract: false, final false
inline void ApplyChanges() ;

static inline ::GlobalNamespace::MaterialPropertyBlockController* New_ctor() ;

/// @brief Method SetRendererState, addr 0x56bdc98, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56bdea4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_materialPropertyBlock, addr 0x56bda94, size 0x88, virtual false, abstract: false, final false
inline ::UnityEngine::MaterialPropertyBlock* get_materialPropertyBlock() ;

/// @brief Method get_renderers, addr 0x56bde9c, size 0x8, virtual false, abstract: false, final false
