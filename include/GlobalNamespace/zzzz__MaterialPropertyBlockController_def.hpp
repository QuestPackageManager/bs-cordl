...
public:
  ...
  /// @brief Method ApplyChanges, addr 0x39eb15c, size 0x64, virtual false, abstract: false, final false
  inline void ApplyChanges();

  static inline ::GlobalNamespace::MaterialPropertyBlockController* New_ctor();

  /// @brief Method SetRendererState, addr 0x39eb348, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39eb534, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_materialPropertyBlock, addr 0x39eb234, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::MaterialPropertyBlock* get_materialPropertyBlock();

  /// @brief Method get_renderers, addr 0x39eb52c, size 0x8, virtual false, abstract: false, final false
