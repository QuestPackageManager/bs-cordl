...
public:
  ...
  /// @brief Method DidActivate, addr 0x57a8e4c, size 0x598, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57a93e4, size 0x444, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleAntiAliasingLevelChanged, addr 0x57a9828, size 0x18, virtual false, abstract: false, final false
  inline void HandleAntiAliasingLevelChanged(int32_t newValue);

  /// @brief Method HandleFullscreenToggled, addr 0x57a9858, size 0x1c, virtual false, abstract: false, final false
  inline void HandleFullscreenToggled(bool newValue);

  /// @brief Method HandleMainEffectChanged, addr 0x57a98c4, size 0x18, virtual false, abstract: false, final false
  inline void HandleMainEffectChanged(int32_t newValue);

  /// @brief Method HandleMirrorChanged, addr 0x57a98dc, size 0x18, virtual false, abstract: false, final false
  inline void HandleMirrorChanged(int32_t newValue);

  /// @brief Method HandleScreenDisplacementToggled, addr 0x57a98a8, size 0x1c, virtual false, abstract: false, final false
  inline void HandleScreenDisplacementToggled(bool newValue);

  /// @brief Method HandleShockwaveMaxParticlesChanged, addr 0x57a9874, size 0x18, virtual false, abstract: false, final false
  inline void HandleShockwaveMaxParticlesChanged(int32_t newValue);

  /// @brief Method HandleSmokeToggled, addr 0x57a988c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleSmokeToggled(bool newValue);

  /// @brief Method HandleVrRenderingScaleChanged, addr 0x57a9840, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a98f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
