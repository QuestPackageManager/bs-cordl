...
public:
  ...
  /// @brief Method DidActivate, addr 0x5875140, size 0x124, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x587561c, size 0xf8, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  static inline ::GlobalNamespace::PlayerOptionsViewController* New_ctor();

  /// @brief Method <DidActivate>b__6_0, addr 0x5875718, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5875714, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x5874fc0, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_1<::UnityW<::HMUI::ViewController>>* value);

  /// @brief Method remove_didFinishEvent, addr 0x5875080, size 0xc0, virtual false, abstract: false, final false
