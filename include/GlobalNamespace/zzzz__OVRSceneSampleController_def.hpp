...
public:
  ...
  /// @brief Method Awake, addr 0x27cd1a4, size 0x194, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Start, addr 0x27cd338, size 0xe8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x27cd420, size 0xd4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateVisionMode, addr 0x27cd5a4, size 0xbc, virtual false, abstract: false, final false
  inline void UpdateVisionMode();

  /// @brief Method UpdateSpeedAndRotationScaleMultiplier, addr 0x27cd660, size 0xc4, virtual false, abstract: false, final false
  inline void UpdateSpeedAndRotationScaleMultiplier();

  /// @brief Method UpdateRecenterPose, addr 0x27cd4f4, size 0xb0, virtual false, abstract: false, final false
  inline void UpdateRecenterPose();

  static inline ::GlobalNamespace::OVRSceneSampleController* New_ctor();

  /// @brief Method .ctor, addr 0x27cd724, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
