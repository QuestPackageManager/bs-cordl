...
public:
  ...
  /// @brief Method Awake, addr 0x5dd0e10, size 0x1cc, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRSceneSampleController* New_ctor();

  /// @brief Method Start, addr 0x5dd0fdc, size 0x128, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5dd1104, size 0x174, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateRecenterPose, addr 0x5dd1278, size 0xd8, virtual false, abstract: false, final false
  inline void UpdateRecenterPose();

  /// @brief Method UpdateSpeedAndRotationScaleMultiplier, addr 0x5dd1440, size 0x118, virtual false, abstract: false, final false
  inline void UpdateSpeedAndRotationScaleMultiplier();

  /// @brief Method UpdateVisionMode, addr 0x5dd1350, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd1558, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
