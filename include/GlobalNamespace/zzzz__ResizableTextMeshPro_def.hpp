...
public:
  ...
  /// @brief Method Start, addr 0x2336b0c, size 0xcc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x2336bd8, size 0x80, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method OnDestroy, addr 0x2336c58, size 0xcc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleTextDidChange, addr 0x2336d24, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2336db4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
