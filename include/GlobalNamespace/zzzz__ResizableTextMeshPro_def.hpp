...
public:
  ...
  /// @brief Method HandleTextDidChange, addr 0x3b31d70, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b31ca0, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3b31b6c, size 0xd0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3b31c3c, size 0x64, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b31e00, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
