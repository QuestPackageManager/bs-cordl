...
public:
  ...
  /// @brief Method HandleTextDidChange, addr 0x3b2f210, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b2f140, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3b2f00c, size 0xd0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3b2f0dc, size 0x64, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b2f2a0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
