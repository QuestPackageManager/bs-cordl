...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataMirrorTransform____c__DisplayClass0_0::*)()>(
  ...
  constexpr static std::size_t addrs = 0x13a531c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
  ...
  constexpr static std::size_t addrs = 0x13a5324;
...
constexpr int32_t& GlobalNamespace::__BeatmapDataMirrorTransform____c__DisplayClass0_0::__cordl_internal_get_numberOfLines() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___numberOfLines;
}
constexpr int32_t const& GlobalNamespace::__BeatmapDataMirrorTransform____c__DisplayClass0_0::__cordl_internal_get_numberOfLines() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___numberOfLines;
}
constexpr void GlobalNamespace::__BeatmapDataMirrorTransform____c__DisplayClass0_0::__cordl_internal_set_numberOfLines(int32_t value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::GlobalNamespace::__BeatmapDataMirrorTransform____c__DisplayClass0_0* GlobalNamespace::__BeatmapDataMirrorTransform____c__DisplayClass0_0::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__BeatmapDataMirrorTransform____c__DisplayClass0_0*>());
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IReadonlyBeatmapData* (*)(::GlobalNamespace::IReadonlyBeatmapData*)>(
  ...
  constexpr static std::size_t addrs = 0x13a51a0;
