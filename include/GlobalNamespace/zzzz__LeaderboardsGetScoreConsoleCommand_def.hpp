...
public:
  ...
  /// @brief Method <ExecuteAsync>b__0, addr 0x25746ec, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25746e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2574740, size 0x600, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2574d40, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Execute, addr 0x25741f8, size 0x4, virtual true, abstract: false, final false
  inline void Execute(::System::Collections::Generic::List_1<::GlobalNamespace::__DebugConsoleController__ConsoleMessage>* messages);

  /// @brief Method ExecuteAsync, addr 0x25741fc, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCommandName, addr 0x25741b8, size 0x40, virtual true, abstract: false, final false
  inline ::StringW GetCommandName();

  /// @brief Method GetLongUsageHelp, addr 0x2574174, size 0x44, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__DebugConsoleController__ConsoleMessage GetLongUsageHelp();

  /// @brief Method GetShortHelpText, addr 0x2574130, size 0x44, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__DebugConsoleController__ConsoleMessage GetShortHelpText();

  /// @brief Method HandleLeaderboardsResultsReturned, addr 0x25742d8, size 0x1d8, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method .ctor, addr 0x25744b0, size 0x234, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isAsyncCommand, addr 0x2574128, size 0x8, virtual true, abstract: false, final false
