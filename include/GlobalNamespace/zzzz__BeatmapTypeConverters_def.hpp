...
public:
  // Declarations
  /// @brief Method ConvertBasicBeatmapEventType, addr 0x26b7dfc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertDistributionParamType, addr 0x26b7e00, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertEaseType, addr 0x26b7cd0, size 0xe0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::EaseType ConvertEaseType(::BeatmapSaveDataCommon::EaseType easeType);

  /// @brief Method ConvertEnvironmentColorType, addr 0x26b7ca8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertLightAxis, addr 0x26b7cbc, size 0x14, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::LightAxis ConvertLightAxis(::BeatmapSaveDataCommon::Axis axis);

  /// @brief Method ConvertLightRotationDirection, addr 0x26b7de8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertNoteColorType, addr 0x26b7c98, size 0x10, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ColorType ConvertNoteColorType(::BeatmapSaveDataCommon::NoteColorType noteType);

  /// @brief Method ConvertNoteColorType, addr 0x26b7c88, size 0x10, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ColorType ConvertNoteColorType(::BeatmapSaveDataVersion2_6_0AndEarlier::ColorType noteType);

  /// @brief Method ConvertNoteCutDirection, addr 0x26b7e10, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertNoteLineLayer, addr 0x26b7dc4, size 0x14, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::NoteLineLayer ConvertNoteLineLayer(::BeatmapSaveDataCommon::NoteLineLayer layer);

  /// @brief Method ConvertNoteLineLayer, addr 0x26b7db0, size 0x14, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::NoteLineLayer ConvertNoteLineLayer(int32_t layer);

  /// @brief Method ConvertOffsetDirection, addr 0x26b7e34, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertSliderDataType, addr 0x26b7dd8, size 0x10, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SliderData_Type ConvertSliderDataType(::BeatmapSaveDataVersion3::SliderType sliderType);

  /// @brief Method ConvertSliderMidAnchorMode, addr 0x26b7e20, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertTransitionTypeToEaseType, addr 0x26b7e60, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertTransitionTypeToExtension, addr 0x26b7e54, size 0xc, virtual false, abstract: false, final false
