...
public:
  ...
  /// @brief Method get_fogParams, addr 0x219661c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BloomFogEnvironmentParams> get_fogParams();

  /// @brief Method OnEnable, addr 0x2196624, size 0x40, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x2196684, size 0x60, virtual false, abstract: false, final false
  inline void OnValidate();

  static inline ::GlobalNamespace::BloomFogEnvironment* New_ctor();

  /// @brief Method .ctor, addr 0x2196904, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
