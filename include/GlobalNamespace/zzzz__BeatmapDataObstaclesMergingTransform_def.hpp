...
public:
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0, addr 0x3609468, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36093d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanBeMerged, addr 0x36093d8, size 0x90, virtual false, abstract: false, final false
  static inline bool CanBeMerged(::GlobalNamespace::ObstacleData* firstObstacle, ::GlobalNamespace::ObstacleData* secondObstacle);

  /// @brief Method CreateTransformedData, addr 0x3609218, size 0x1bc, virtual false, abstract: false, final false
