...
/// @brief Field _didInitEvent, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__didInitEvent, put=__cordl_internal_set__didInitEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteControllerDidInitEvent*>*  _didInitEvent;
...
/// @brief Field _noteDidPassJumpThreeQuartersEvent, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteDidPassJumpThreeQuartersEvent, put=__cordl_internal_set__noteDidPassJumpThreeQuartersEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteControllerNoteDidPassJumpThreeQuartersEvent*>*  _noteDidPassJumpThreeQuartersEvent;

/// @brief Field _noteDidStartDissolvingEvent, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteDidStartDissolvingEvent, put=__cordl_internal_set__noteDidStartDissolvingEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteControllerNoteDidStartDissolvingEvent*>*  _noteDidStartDissolvingEvent;
