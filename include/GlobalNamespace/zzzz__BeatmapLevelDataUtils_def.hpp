...
public:
  ...
  /// @brief Method .ctor, addr 0x1284388, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <ReadJsonStringFromPathAsync>b__0, addr 0x1284e08, size 0x58, virtual false, abstract: false, final false
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(8730)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8730), inst: 736
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(10784)) CS Name: ::BeatmapLevelDataUtils::<>c__DisplayClass8_0*
...
public:
  ...
  /// @brief Method .ctor, addr 0x1284390, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <ReadJsonStringFromDataAsync>b__0, addr 0x1284e60, size 0x64, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ReadJsonStringFromPath, addr 0x12837e8, size 0x9c, virtual false, abstract: false, final false
  static inline ::StringW ReadJsonStringFromPath(::StringW path);

  /// @brief Method ReadJsonStringFromData, addr 0x128318c, size 0xcc, virtual false, abstract: false, final false
  static inline ::StringW ReadJsonStringFromData(::Unity::Collections::NativeArray_1<uint8_t> inputData, ::StringW filename);

  /// @brief Method ReadJsonStringFromPathAsync, addr 0x1284298, size 0xf0, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task_1<::StringW>* ReadJsonStringFromPathAsync(::StringW path);

  /// @brief Method ReadJsonStringFromDataAsync, addr 0x12780ec, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateAndInjectContentChecksumIntoBeatmapJson, addr 0x1284398, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW CalculateAndInjectContentChecksumIntoBeatmapJson(::StringW beatmapJson);

  /// @brief Method InjectContentChecksumIntoBeatmapJson, addr 0x1284470, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW InjectContentChecksumIntoBeatmapJson(::StringW beatmapJson, ::StringW checksum);

  /// @brief Method CalculateBeatmapDataContentHash, addr 0x12843f8, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW CalculateBeatmapDataContentHash(::StringW beatmapJson);

  /// @brief Method CalculateAudioContentHash, addr 0x1284570, size 0x10c, virtual false, abstract: false, final false
  static inline ::StringW CalculateAudioContentHash(::UnityEngine::AudioClip* audioClip);

  /// @brief Method CalculateHashFromData, addr 0x12844cc, size 0xa4, virtual false, abstract: false, final false
  static inline ::StringW CalculateHashFromData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method CalculateHashFromPath, addr 0x128467c, size 0x200, virtual false, abstract: false, final false
  static inline ::StringW CalculateHashFromPath(::StringW path);

  /// @brief Method Compress, addr 0x128487c, size 0x464, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compress(::StringW data);

  /// @brief Method Decompress, addr 0x1283e68, size 0x430, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Decompress(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Decompress, addr 0x12838d8, size 0x434, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Decompress(::StringW path);

  /// @brief Method IsCompressed, addr 0x1283884, size 0x54, virtual false, abstract: false, final false
  static inline bool IsCompressed(::StringW path);

  /// @brief Method GetUtf8String, addr 0x1283d0c, size 0x15c, virtual false, abstract: false, final false
  static inline ::StringW GetUtf8String(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method GetBytesFromUtf8String, addr 0x1284ce0, size 0x74, virtual false, abstract: false, final false
