...
public:
  ...
  /// @brief Method .ctor, addr 0x22e14c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_characteristic, addr 0x22e14a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_characteristic();

  /// @brief Method get_difficulties, addr 0x22e14b8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficultyMask get_difficulties();

  /// @brief Method set_characteristic, addr 0x22e14b0, size 0x8, virtual false, abstract: false, final false
  inline void set_characteristic(::StringW value);

  /// @brief Method set_difficulties, addr 0x22e14c0, size 0x8, virtual false, abstract: false, final false
