...
/// @brief Method .ctor, addr 0x571da98, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__elements, put=__cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*>  _elements;

 __declspec(property(get=get_elements)) ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*>  elements;

/// @brief Method EvaluateColor, addr 0x571d914, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method UpdatePixels, addr 0x571d8ac, size 0x68, virtual true, abstract: false, final false
inline void UpdatePixels(::Unity::Collections::NativeArray_1<::UnityEngine::Color32>  pixels, int32_t  numberOfPixels) ;

constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*> const& __cordl_internal_get__elements() const;
...
constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*>  value) ;

/// @brief Method .ctor, addr 0x571d9e0, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_elements, addr 0x571d8a4, size 0x8, virtual false, abstract: false, final false
