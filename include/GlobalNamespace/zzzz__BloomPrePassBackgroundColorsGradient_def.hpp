...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundColorsGradient*);
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradient*, "", "BloomPrePassBackgroundColorsGradient");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*, "", "BloomPrePassBackgroundColorsGradient/Element");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5862868, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BloomPrePassBackgroundColorsGradient::Element, BloomPrePassBackgroundTextureGradient
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__elements, put = __cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*> _elements;

  __declspec(property(get = get_elements)) ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*> elements;

  /// @brief Method EvaluateColor, addr 0x58626e4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdatePixels, addr 0x586267c, size 0x68, virtual true, abstract: false, final false
  inline void UpdatePixels(::Unity::Collections::NativeArray_1<::UnityEngine::Color32> pixels, int32_t numberOfPixels);

  constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*> const& __cordl_internal_get__elements() const;

  constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>& __cordl_internal_get__elements();

  constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*> value);

  /// @brief Method .ctor, addr 0x58627b0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_elements, addr 0x5862674, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*> get_elements();
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradient) == 0x50, "Size mismatch!");
