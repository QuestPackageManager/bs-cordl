...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x5890fe4, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5890fdc, size 0x8, virtual false, abstract: false, final false
