...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x2716e74, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2716e4c, size 0x28, virtual false, abstract: false, final false
