...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x3bd41b8, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3bd4190, size 0x28, virtual false, abstract: false, final false
