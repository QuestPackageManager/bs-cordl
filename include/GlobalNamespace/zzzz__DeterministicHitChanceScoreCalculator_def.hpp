...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x3bc1ca4, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3bc1c7c, size 0x28, virtual false, abstract: false, final false
