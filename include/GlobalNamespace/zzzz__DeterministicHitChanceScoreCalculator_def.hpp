...
public:
  ...
  /// @brief Method GetScoreForNote, addr 0x581e5f0, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x581e5e8, size 0x8, virtual false, abstract: false, final false
