...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::RecordingToolConfigViewController::*)(bool, bool, bool)>(
    &::GlobalNamespace::RecordingToolConfigViewController::DidActivate)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x5a1d564;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::RecordingToolConfigViewController*>(),
                                                                                          { ::i2c::class_of<::GlobalNamespace::RecordingToolConfigViewController*>(), 5 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::RecordingToolConfigViewController::*)()>(&::GlobalNamespace::RecordingToolConfigViewController::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5a1d5fc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::RecordingToolConfigViewController*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
constexpr ::GlobalNamespace::RecordingToolManager* const& GlobalNamespace::RecordingToolConfigViewController::__cordl_internal_get__recordingToolManager() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____recordingToolManager;
}
...
inline void GlobalNamespace::RecordingToolConfigViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::RecordingToolConfigViewController*>(), 5 })));
...
inline ::GlobalNamespace::RecordingToolConfigViewController* GlobalNamespace::RecordingToolConfigViewController::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::RecordingToolConfigViewController*>());
}
// Ctor Parameters []
