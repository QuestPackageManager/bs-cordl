...
public:
  ...
  /// @brief Method Awake, addr 0x39d8194, size 0x64, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x39d81f8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x39d818c, size 0x8, virtual true, abstract: false, final false
