...
public:
  ...
  /// @brief Method Awake, addr 0x571dcc4, size 0x6c, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x571dd30, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x571dcbc, size 0x8, virtual true, abstract: false, final false
