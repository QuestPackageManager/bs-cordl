...
public:
// Declarations
/// @brief Method Awake, addr 0x5d41ed8, size 0x5c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRVirtualKeyboardSampleWPMPrompt* New_ctor() ;

/// @brief Method .ctor, addr 0x5d41f34, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
