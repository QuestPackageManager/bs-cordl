...
/// @brief Method Awake, addr 0x5d503b4, size 0xdc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FixedUpdate, addr 0x5d508fc, size 0xdc, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method GetFingerConfidence, addr 0x5d50aa8, size 0x40, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRHand_TrackingConfidence GetFingerConfidence(::GlobalNamespace::OVRHand_HandFinger  finger) ;

/// @brief Method GetFingerIsPinching, addr 0x5d508b0, size 0x20, virtual false, abstract: false, final false
inline bool GetFingerIsPinching(::GlobalNamespace::OVRHand_HandFinger  finger) ;

/// @brief Method GetFingerPinchStrength, addr 0x5d50a6c, size 0x3c, virtual false, abstract: false, final false
inline float_t GetFingerPinchStrength(::GlobalNamespace::OVRHand_HandFinger  finger) ;

/// @brief Method GetHand, addr 0x5d513dc, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_Hand GetHand() ;

/// @brief Method GetHandState, addr 0x5d50490, size 0x324, virtual false, abstract: false, final false
inline void GetHandState(::GlobalNamespace::OVRPlugin_Step  step) ;

/// @brief Method GetMicrogestureType, addr 0x5d50c40, size 0x7c, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRHand_MicrogestureType GetMicrogestureType() ;

/// @brief Method GetPointerRayTransform, addr 0x5d5133c, size 0x40, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Transform> GetPointerRayTransform() ;

/// @brief Method InitializePointerPose, addr 0x5d50204, size 0x180, virtual false, abstract: false, final false
inline void InitializePointerPose() ;

/// @brief Method IsActive, addr 0x5d508d0, size 0x2c, virtual true, abstract: false, final true
inline bool IsActive() ;

/// @brief Method IsPressed, addr 0x5d51318, size 0x1c, virtual true, abstract: false, final true
inline bool IsPressed() ;

/// @brief Method IsReleased, addr 0x5d51334, size 0x8, virtual true, abstract: false, final true
inline bool IsReleased() ;

/// @brief Method IsValid, addr 0x5d5137c, size 0x60, virtual true, abstract: false, final true
inline bool IsValid() ;

static inline ::GlobalNamespace::OVRHand* New_ctor() ;

/// @brief Method OVRMeshRenderer.IOVRMeshRendererDataProvider.GetMeshRendererData, addr 0x5d50d38, size 0x40, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRMeshRenderer_MeshRendererData OVRMeshRenderer_IOVRMeshRendererDataProvider_GetMeshRendererData() ;

/// @brief Method OVRMesh.IOVRMeshDataProvider.GetMeshType, addr 0x5d50cbc, size 0x7c, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRMesh_MeshType OVRMesh_IOVRMeshDataProvider_GetMeshType() ;

/// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData, addr 0x5d50bf0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData, addr 0x5d50b64, size 0x8c, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRSkeleton_SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType, addr 0x5d50ae8, size 0x7c, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRSkeleton_SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled, addr 0x5d514c4, size 0x8, virtual true, abstract: false, final true
inline bool OVRSkeleton_IOVRSkeletonDataProvider_get_enabled() ;

/// @brief Method OnDestroy, addr 0x5d509d8, size 0x94, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x5d50f40, size 0x148, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5d50d78, size 0x154, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSceneChanged, addr 0x5d51088, size 0x5c, virtual false, abstract: false, final false
inline void OnSceneChanged(::UnityEngine::SceneManagement::Scene  unloading, ::UnityEngine::SceneManagement::Scene  loading) ;

/// @brief Method OnValidate, addr 0x5d510e4, size 0x234, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method ShouldShowHandUIRay, addr 0x5d50ecc, size 0x74, virtual false, abstract: false, final false
inline bool ShouldShowHandUIRay() ;

/// @brief Method Update, addr 0x5d507b4, size 0xfc, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdatePointerRay, addr 0x5d513e4, size 0xcc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5d514b0, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_GlobalHandSkeletonVersion, addr 0x5d50110, size 0x20, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRHandSkeletonVersion get_GlobalHandSkeletonVersion() ;

/// @brief Method get_HandConfidence, addr 0x5d50394, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRHand_TrackingConfidence get_HandConfidence() ;

/// @brief Method get_HandScale, addr 0x5d50384, size 0x8, virtual false, abstract: false, final false
inline float_t get_HandScale() ;

/// @brief Method get_IsDataHighConfidence, addr 0x5d50140, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDataHighConfidence() ;

/// @brief Method get_IsDataValid, addr 0x5d50130, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDataValid() ;

/// @brief Method get_IsDominantHand, addr 0x5d503a4, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDominantHand() ;

/// @brief Method get_IsPointerPoseValid, addr 0x5d50170, size 0x8, virtual false, abstract: false, final false
inline bool get_IsPointerPoseValid() ;

/// @brief Method get_IsSystemGestureInProgress, addr 0x5d50160, size 0x8, virtual false, abstract: false, final false
inline bool get_IsSystemGestureInProgress() ;

/// @brief Method get_IsTracked, addr 0x5d50150, size 0x8, virtual false, abstract: false, final false
inline bool get_IsTracked() ;

/// @brief Method get_PointerPose, addr 0x5d50180, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method set_HandConfidence, addr 0x5d5039c, size 0x8, virtual false, abstract: false, final false
inline void set_HandConfidence(::GlobalNamespace::OVRHand_TrackingConfidence  value) ;

/// @brief Method set_HandScale, addr 0x5d5038c, size 0x8, virtual false, abstract: false, final false
inline void set_HandScale(float_t  value) ;

/// @brief Method set_IsDataHighConfidence, addr 0x5d50148, size 0x8, virtual false, abstract: false, final false
inline void set_IsDataHighConfidence(bool  value) ;

/// @brief Method set_IsDataValid, addr 0x5d50138, size 0x8, virtual false, abstract: false, final false
inline void set_IsDataValid(bool  value) ;

/// @brief Method set_IsDominantHand, addr 0x5d503ac, size 0x8, virtual false, abstract: false, final false
inline void set_IsDominantHand(bool  value) ;

/// @brief Method set_IsPointerPoseValid, addr 0x5d50178, size 0x8, virtual false, abstract: false, final false
inline void set_IsPointerPoseValid(bool  value) ;

/// @brief Method set_IsSystemGestureInProgress, addr 0x5d50168, size 0x8, virtual false, abstract: false, final false
inline void set_IsSystemGestureInProgress(bool  value) ;

/// @brief Method set_IsTracked, addr 0x5d50158, size 0x8, virtual false, abstract: false, final false
