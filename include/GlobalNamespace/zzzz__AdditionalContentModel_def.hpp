...
/// @brief Method Dispose, addr 0x35ff430, size 0xa8, virtual true, abstract: false, final false
inline void Dispose() ;
...
/// @brief Method IAdditionalContentEntitlementModel.GetExcludedLevelIdsAsync, addr 0x35ff584, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method IAdditionalContentEntitlementModel.GetLevelDataVersionAsync, addr 0x35ff574, size 0x10, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::BeatmapLevelDataVersion>* IAdditionalContentEntitlementModel_GetLevelDataVersionAsync(::StringW  levelId, ::System::Threading::CancellationToken  token) ;

/// @brief Method IAdditionalContentEntitlementModel.GetLevelEntitlementStatusAsync, addr 0x35ff554, size 0x10, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::EntitlementStatus>* IAdditionalContentEntitlementModel_GetLevelEntitlementStatusAsync(::StringW  levelId, ::System::Threading::CancellationToken  token) ;

/// @brief Method IAdditionalContentEntitlementModel.GetPackEntitlementStatusAsync, addr 0x35ff564, size 0x10, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::EntitlementStatus>* IAdditionalContentEntitlementModel_GetPackEntitlementStatusAsync(::StringW  levelPackId, ::System::Threading::CancellationToken  token) ;

/// @brief Method InvalidateData, addr 0x35ff518, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method OnApplicationFocusChanged, addr 0x35ff4d8, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35ff388, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didInvalidateDataEvent, addr 0x35ff230, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method remove_didInvalidateDataEvent, addr 0x35ff2dc, size 0xac, virtual true, abstract: false, final true
