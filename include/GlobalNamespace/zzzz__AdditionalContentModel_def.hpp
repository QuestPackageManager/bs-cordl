...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2677)), TypeDefinitionIndex(TypeDefinitionIndex(3394)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 880
// }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3402), inst: 880 }), TypeDefinitionIndex(TypeDefinitionIndex(3402)), TypeDefinitionIndex(TypeDefinitionIndex(16270))} Self:
...
public:
  ...
  /// @brief Method MoveNext addr 0x2233ed4 size 0x230 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x2234104 size 0x58 virtual true final true
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 880 }), TypeDefinitionIndex(TypeDefinitionIndex(2677)),
// TypeDefinitionIndex(TypeDefinitionIndex(3394)), TypeDefinitionIndex(TypeDefinitionIndex(3402)), TypeDefinitionIndex(TypeDefinitionIndex(16270)), GenericInstantiation(GenericInstantiation { tdi:
...
public:
  ...
  /// @brief Method MoveNext addr 0x223415c size 0x230 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x223438c size 0x58 virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method add_didInvalidateDataEvent addr 0x22334c4 size 0x9c virtual true final true
  inline void add_didInvalidateDataEvent(::System::Action* value);

  /// @brief Method remove_didInvalidateDataEvent addr 0x2233560 size 0x9c virtual true final true
  ...
  /// @brief Method .ctor addr 0x22335fc size 0x5dc virtual false final false
  inline void _ctor(::GlobalNamespace::AlwaysOwnedContentContainerSO* alwaysOwnedContentContainer);

  /// @brief Method Dispose addr 0x2233bd8 size 0x80 virtual true final true
  inline void Dispose();

  /// @brief Method OnApplicationFocusChanged addr 0x2233c58 size 0x3c virtual false final false
  inline void OnApplicationFocusChanged(bool hasFocus);

  /// @brief Method InvalidateData addr 0x2233c94 size 0x38 virtual false final false
  inline void InvalidateData();

  /// @brief Method GetLevelEntitlementStatusAsync addr 0x2233ccc size 0x104 virtual true final true
  ...
  /// @brief Method GetPackEntitlementStatusAsync addr 0x2233dd0 size 0x104 virtual true final true
