...
public:
  ...
  /// @brief Method Dispose, addr 0x26a21a8, size 0xa4, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method IAdditionalContentEntitlementModel.GetLevelDataVersionAsync, addr 0x26a22e8, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method IAdditionalContentEntitlementModel.GetLevelEntitlementStatusAsync, addr 0x26a22c8, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method IAdditionalContentEntitlementModel.GetPackEntitlementStatusAsync, addr 0x26a22d8, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method InvalidateData, addr 0x26a228c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnApplicationFocusChanged, addr 0x26a224c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a20f8, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didInvalidateDataEvent, addr 0x26a1fc0, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_didInvalidateDataEvent, addr 0x26a205c, size 0x9c, virtual true, abstract: false, final true
