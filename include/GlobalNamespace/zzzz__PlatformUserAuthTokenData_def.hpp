...
public:
  ...
  /// @brief Method get_token addr 0x22308ac size 0x8 virtual false final false
  inline ::StringW get_token();

  /// @brief Method set_token addr 0x22308b4 size 0x8 virtual false final false
  inline void set_token(::StringW value);

  /// @brief Method get_validPlatformEnvironment addr 0x22308bc size 0x8 virtual false final false
  inline ::GlobalNamespace::PlatformEnvironment get_validPlatformEnvironment();

  /// @brief Method set_validPlatformEnvironment addr 0x22308c4 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x22308cc size 0x30 virtual false final false
