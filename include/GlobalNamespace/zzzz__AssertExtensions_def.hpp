...
public:
  ...
  /// @brief Method GreaterOrEqual, addr 0x22ae74c, size 0x4, virtual false, abstract: false, final false
  static inline void GreaterOrEqual(float_t value, float_t expectedLessValue, ::StringW message);

  /// @brief Method LessThan, addr 0x22ae748, size 0x4, virtual false, abstract: false, final false
