...
public:
  ...
  /// @brief Method .ctor, addr 0x237f4b0, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke, addr 0x237f5e0, size 0x14, virtual true, abstract: false, final false
  inline void Invoke(::GlobalNamespace::NoteController* noteController, ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method BeginInvoke, addr 0x237f5f4, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x237f688, size 0xc, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method remove_noteWasAddedEvent, addr 0x237d11c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_noteWasCutEvent, addr 0x237d528, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_obstacleWasAddedEvent, addr 0x237d7d4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_sliderWasAddedEvent, addr 0x237dd54, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didHideAllBeatmapObjectsEvent, addr 0x237e174, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_spawnHidden, addr 0x237e224, size 0x8, virtual false, abstract: false, final false
  inline bool get_spawnHidden();

  /// @brief Method set_spawnHidden, addr 0x237e22c, size 0xc, virtual false, abstract: false, final false
  inline void set_spawnHidden(bool value);

  /// @brief Method AddSpawnedObstacleController, addr 0x2378068, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSpawnedNoteController, addr 0x2378900, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSpawnedSliderController, addr 0x237978c, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNoteControllerEventCallbacks, addr 0x237e398, size 0x28c, virtual false, abstract: false, final false
  inline void SetNoteControllerEventCallbacks(::GlobalNamespace::NoteController* noteController);

  /// @brief Method RemoveNoteControllerEventCallbacks, addr 0x237e760, size 0x2a0, virtual false, abstract: false, final false
  inline void RemoveNoteControllerEventCallbacks(::GlobalNamespace::NoteController* noteController);

  /// @brief Method SetSliderNoteControllerEventCallbacks, addr 0x237e63c, size 0x124, virtual false, abstract: false, final false
  inline void SetSliderNoteControllerEventCallbacks(::GlobalNamespace::SliderController* sliderNoteController);

  /// @brief Method RemoveSliderNoteControllerEventCallbacks, addr 0x237ea00, size 0x12c, virtual false, abstract: false, final false
  inline void RemoveSliderNoteControllerEventCallbacks(::GlobalNamespace::SliderController* sliderNoteController);

  /// @brief Method SetObstacleEventCallbacks, addr 0x237e238, size 0x160, virtual false, abstract: false, final false
  inline void SetObstacleEventCallbacks(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method RemoveObstacleEventCallbacks, addr 0x237eb2c, size 0x160, virtual false, abstract: false, final false
  inline void RemoveObstacleEventCallbacks(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method Despawn, addr 0x237ec8c, size 0xa4, virtual false, abstract: false, final false
  inline void Despawn(::GlobalNamespace::NoteController* noteController);

  /// @brief Method Despawn, addr 0x237ed30, size 0xa4, virtual false, abstract: false, final false
  inline void Despawn(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method Despawn, addr 0x237edd4, size 0xa4, virtual false, abstract: false, final false
  inline void Despawn(::GlobalNamespace::SliderController* sliderNoteController);

  /// @brief Method HandleNoteControllerNoteDidStartJump, addr 0x237ee78, size 0x1c, virtual true, abstract: false, final true
  inline void HandleNoteControllerNoteDidStartJump(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleNoteControllerNoteWasMissed, addr 0x237ee94, size 0x1c, virtual true, abstract: false, final true
  inline void HandleNoteControllerNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleNoteControllerNoteDidFinishJump, addr 0x237eeb0, size 0x4, virtual true, abstract: false, final true
  inline void HandleNoteControllerNoteDidFinishJump(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleNoteControllerNoteDidDissolve, addr 0x237eeb4, size 0x4, virtual true, abstract: false, final true
  inline void HandleNoteControllerNoteDidDissolve(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleNoteControllerNoteWasCut, addr 0x237eeb8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleObstaclePassedThreeQuartersOfMove2, addr 0x237eef8, size 0x1c, virtual false, abstract: false, final false
  inline void HandleObstaclePassedThreeQuartersOfMove2(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleObstaclePassedAvoidedMark, addr 0x237ef14, size 0x1c, virtual false, abstract: false, final false
  inline void HandleObstaclePassedAvoidedMark(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleObstacleFinishedMovement, addr 0x237ef30, size 0x4, virtual false, abstract: false, final false
  inline void HandleObstacleFinishedMovement(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleObstacleDidDissolve, addr 0x237ef34, size 0x4, virtual false, abstract: false, final false
  inline void HandleObstacleDidDissolve(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleSliderDidFinishJump, addr 0x237ef38, size 0x4, virtual true, abstract: false, final true
  inline void HandleSliderDidFinishJump(::GlobalNamespace::SliderController* sliderController);

  /// @brief Method HandleSliderDidDissolve, addr 0x237ef3c, size 0x4, virtual true, abstract: false, final true
  inline void HandleSliderDidDissolve(::GlobalNamespace::SliderController* sliderController);

  /// @brief Method DissolveAllObjects, addr 0x237ef40, size 0x1c4, virtual false, abstract: false, final false
  inline void DissolveAllObjects();

  /// @brief Method HideAllBeatmapObjects, addr 0x237f104, size 0x1f0, virtual false, abstract: false, final false
  inline void HideAllBeatmapObjects(bool hide);

  /// @brief Method PauseAllBeatmapObjects, addr 0x237f2f4, size 0x1b8, virtual false, abstract: false, final false
  inline void PauseAllBeatmapObjects(bool pause);

  static inline ::GlobalNamespace::BeatmapObjectManager* New_ctor();

  /// @brief Method .ctor, addr 0x23799cc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method INoteControllerNoteWasCutEvent.HandleNoteControllerNoteWasCut, addr 0x237f4ac, size 0x4, virtual true, abstract: false, final true
