...
public:
  ...
  /// @brief Method MoveNext, addr 0x29ee654, size 0x260, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x29ee8b4, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x29ee8c0, size 0x278, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x29eeb38, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method GetEntitlementStatus, addr 0x29ee550, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::EntitlementsStatus>* GetEntitlementStatus(::StringW levelId);

  /// @brief Method HandleDataInvalidated, addr 0x29ee410, size 0xa4, virtual false, abstract: false, final false
  inline void HandleDataInvalidated();

  /// @brief Method HandleGetIsEntitledToLevel, addr 0x29ee4b4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x29ee244, size 0x1cc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x29ee154, size 0xf0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x29ee64c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
