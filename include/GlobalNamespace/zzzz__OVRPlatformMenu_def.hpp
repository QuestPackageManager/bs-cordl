...
public:
  ...
  /// @brief Method Awake, addr 0x2b4b538, size 0x170, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBackButtonState, addr 0x2b4b4d0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method RetreatOneLevel, addr 0x2b4b77c, size 0xf8, virtual false, abstract: false, final false
  static inline bool RetreatOneLevel();

  /// @brief Method ShowConfirmQuitMenu, addr 0x2b4b6a8, size 0xd4, virtual false, abstract: false, final false
  inline void ShowConfirmQuitMenu();

  /// @brief Method Update, addr 0x2b4b874, size 0x40, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2b4b8b4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
