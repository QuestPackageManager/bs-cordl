...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8482)), TypeDefinitionIndex(TypeDefinitionIndex(8561)), TypeDefinitionIndex(TypeDefinitionIndex(10152))}
...
public:
  ...
  /// @brief Method HandleBackButtonState addr 0x25f2608 size 0x68 virtual false final false
  inline ::GlobalNamespace::__OVRPlatformMenu__eBackButtonAction HandleBackButtonState();

  /// @brief Method Awake addr 0x25f2670 size 0x170 virtual false final false
  inline void Awake();

  /// @brief Method ShowConfirmQuitMenu addr 0x25f27e0 size 0xd4 virtual false final false
  inline void ShowConfirmQuitMenu();

  /// @brief Method RetreatOneLevel addr 0x25f28b4 size 0xf8 virtual false final false
  static inline bool RetreatOneLevel();

  /// @brief Method Update addr 0x25f29ac size 0x40 virtual false final false
  inline void Update();

  static inline ::GlobalNamespace::OVRPlatformMenu* New_ctor();

  /// @brief Method .ctor addr 0x25f29ec size 0x10 virtual false final false
  inline void _ctor();
