...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::GlobalNamespace::ToneMapping)>(&::GlobalNamespace::ToneMappingExtensions::SetShaderKeyword)> {
  ...
  constexpr static std::size_t addrs = 0x56b1e54;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::GlobalNamespace::ToneMapping, ::UnityEngine::Rendering::CommandBuffer*)>(&::GlobalNamespace::ToneMappingExtensions::SetShaderKeyword)> {
  constexpr static std::size_t size = 0xac;
  constexpr static std::size_t addrs = 0x56b3bb4;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "SetShaderKeyword",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::ToneMapping>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Rendering::CommandBuffer*>::get()}
                    )));
    return ___internal_method;
  }
};
...
::cordl_internals::setStaticField<::UnityEngine::Rendering::GlobalKeyword, "_acesToneMappingKeyword", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ToneMappingExtensions*>::get>(std::forward<::UnityEngine::Rendering::GlobalKeyword>(value));
}
inline ::UnityEngine::Rendering::GlobalKeyword GlobalNamespace::ToneMappingExtensions::getStaticF__acesToneMappingKeyword()  {
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::GlobalKeyword, "_acesToneMappingKeyword", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ToneMappingExtensions*>::get>();
}
