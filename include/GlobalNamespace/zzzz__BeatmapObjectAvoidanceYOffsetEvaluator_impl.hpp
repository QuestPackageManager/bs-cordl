...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData::*)(float_t, float_t)>(&::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x31b2cdc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::*)(::GlobalNamespace::IAudioTimeSource*, ::GlobalNamespace::IJumpOffsetYProvider*, ::GlobalNamespace::IVariableMovementDataProvider*, float_t)>(&::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::IAudioTimeSource*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::IJumpOffsetYProvider*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::IVariableMovementDataProvider*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::*)()>(&::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::ManualUpdate)> {
  ...
  constexpr static std::size_t addrs = 0x31b2ce4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::*)(float_t)>(&::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::GetJumpOffsetYAtJumpStartSongTime)> {
  ...
  constexpr static std::size_t addrs = 0x31b2e5c;
...
constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData,::Array<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>*>& GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::__cordl_internal_get__yJumpOffsetBuffer()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____yJumpOffsetBuffer;
}
constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData,::Array<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>*> const& GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::__cordl_internal_get__yJumpOffsetBuffer() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____yJumpOffsetBuffer;
}
constexpr void GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::__cordl_internal_set__yJumpOffsetBuffer(::ArrayW<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData,::Array<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator_BufferData>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::_ctor(::GlobalNamespace::IAudioTimeSource*  audioTimeSource, ::GlobalNamespace::IJumpOffsetYProvider*  jumpOffsetYProvider, ::GlobalNamespace::IVariableMovementDataProvider*  variableMovementDataProvider, float_t  moveToPlayerHeadTParam)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
inline ::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator* GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::New_ctor(::GlobalNamespace::IAudioTimeSource*  audioTimeSource, ::GlobalNamespace::IJumpOffsetYProvider*  jumpOffsetYProvider, ::GlobalNamespace::IVariableMovementDataProvider*  variableMovementDataProvider, float_t  moveToPlayerHeadTParam)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*>(audioTimeSource, jumpOffsetYProvider, variableMovementDataProvider, moveToPlayerHeadTParam));
}
// Ctor Parameters []
