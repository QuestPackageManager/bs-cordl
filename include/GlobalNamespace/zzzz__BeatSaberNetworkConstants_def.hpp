...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatSaberNetworkConstants*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatSaberNetworkConstants*, "", "BeatSaberNetworkConstants");
...
static_assert(sizeof(::GlobalNamespace::BeatSaberNetworkConstants) == 0x10, "Size mismatch!");
