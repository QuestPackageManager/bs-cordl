...
/// @brief Method ToString, addr 0x5753f70, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5753c78, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Log, addr 0x5753b8c, size 0x8, virtual true, abstract: false, final true
inline void Log(::StringW  message) ;

/// @brief Method Log, addr 0x5753b94, size 0xe4, virtual true, abstract: false, final true
inline void Log(::StringW  message, ::System::Object*  context) ;

/// @brief Method LogError, addr 0x5753d74, size 0x8, virtual true, abstract: false, final true
inline void LogError(::StringW  message) ;

/// @brief Method LogError, addr 0x5753d7c, size 0xe8, virtual true, abstract: false, final true
inline void LogError(::StringW  message, ::System::Object*  context) ;

/// @brief Method LogException, addr 0x5753e64, size 0x8, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception) ;

/// @brief Method LogException, addr 0x5753e6c, size 0x104, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::System::Object*  context) ;

/// @brief Method LogWarning, addr 0x5753c84, size 0x8, virtual true, abstract: false, final true
inline void LogWarning(::StringW  message) ;

/// @brief Method LogWarning, addr 0x5753c8c, size 0xe8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5753b18, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_messages, addr 0x5753b10, size 0x8, virtual false, abstract: false, final false
