...
public:
  ...
  /// @brief Method get_cutScore addr 0x2268018 size 0x8 virtual true final false
  inline int32_t get_cutScore();

  /// @brief Method get_wouldBeCorrectCutBestPossibleMultiplierEventType addr 0x2268020 size 0x8 virtual true final false
  ...
  /// @brief Method get_multiplierEventType addr 0x2268028 size 0x8 virtual true final false
  inline ::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType get_multiplierEventType();

  /// @brief Method get_executionOrder addr 0x2268030 size 0xc virtual true final false
  inline int32_t get_executionOrder();

  /// @brief Method Init addr 0x2267a04 size 0x4c virtual false final false
  inline void Init(::GlobalNamespace::NoteData* noteData);

  static inline ::GlobalNamespace::BadCutScoringElement* New_ctor();

  /// @brief Method .ctor addr 0x226803c size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0x2268044 size 0x48 virtual false final false
  inline void _ctor();
