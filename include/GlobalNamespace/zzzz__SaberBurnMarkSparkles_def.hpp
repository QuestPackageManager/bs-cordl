...
public:
  ...
  /// @brief Method GetBurnMarkPos, addr 0x26d48f8, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x26d4b04, size 0x6a0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SaberBurnMarkSparkles* New_ctor();

  /// @brief Method OnDestroy, addr 0x26d4668, size 0xe8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x26d4824, size 0xd4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26d4750, size 0xd4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x26d41d4, size 0x494, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x26d51a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
