...
public:
  ...
  /// @brief Method GetBurnMarkPos, addr 0x584c478, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x584c8d4, size 0x450, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SaberBurnMarkSparkles* New_ctor();

  /// @brief Method OnDestroy, addr 0x584c088, size 0xf8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x584c394, size 0xe4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x584c180, size 0x214, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x584bc68, size 0x420, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x584cd24, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
