...
/// @brief Field _burnMarksEmissionModules, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__burnMarksEmissionModules, put=__cordl_internal_set__burnMarksEmissionModules)) ::ArrayW<::UnityEngine::ParticleSystem_EmissionModule,::Array<::UnityEngine::ParticleSystem_EmissionModule>*>  _burnMarksEmissionModules;
...
/// @brief Method GetBurnMarkPos, addr 0x57da57c, size 0x45c, virtual false, abstract: false, final false
...
/// @brief Method LateUpdate, addr 0x57da9d8, size 0x450, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::SaberBurnMarkSparkles* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57da18c, size 0xf8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x57da498, size 0xe4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x57da284, size 0x214, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Start, addr 0x57d9d6c, size 0x420, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57dae28, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
