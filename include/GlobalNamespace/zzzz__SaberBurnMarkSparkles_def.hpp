...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8907)), TypeDefinitionIndex(TypeDefinitionIndex(8969)), TypeDefinitionIndex(TypeDefinitionIndex(15068))]
...
public:
  ...
  /// @brief Method Start, addr 0x235d9bc, size 0x494, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnDestroy, addr 0x235de50, size 0xe8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x235df38, size 0xd4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnDisable, addr 0x235e00c, size 0xd4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method GetBurnMarkPos, addr 0x235e0e0, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x235e2ec, size 0x6a0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SaberBurnMarkSparkles* New_ctor();

  /// @brief Method .ctor, addr 0x235e98c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
