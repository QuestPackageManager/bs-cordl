...
// Write type traits
MARK_REF_T(::GlobalNamespace::LicensesDisplayViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LicensesDisplayViewController*, "", "LicensesDisplayViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a1a9d0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1aa14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LicensesDisplayViewController) == 0x88, "Size mismatch!");
