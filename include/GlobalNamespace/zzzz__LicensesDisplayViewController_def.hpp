...
public:
  ...
  /// @brief Method DidActivate, addr 0x2679768, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26797ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
