...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapLevelColorSchemeSaveData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelColorSchemeSaveData*, "", "BeatmapLevelColorSchemeSaveData");
...
public:
  ...
  /// @brief Method IsDefault, addr 0x3753740, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375387c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLevelColorSchemeSaveData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapLevelColorSchemeSaveData(BeatmapLevelColorSchemeSaveData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLevelColorSchemeSaveData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapLevelColorSchemeSaveData(BeatmapLevelColorSchemeSaveDataconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelColorSchemeSaveData) == 0x20, "Size mismatch!");
