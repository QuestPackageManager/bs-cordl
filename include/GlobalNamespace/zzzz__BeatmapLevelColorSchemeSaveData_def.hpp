...
public:
  ...
  /// @brief Method IsDefault, addr 0x36567b8, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36568f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
