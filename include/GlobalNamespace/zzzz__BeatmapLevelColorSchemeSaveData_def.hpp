...
public:
  ...
  /// @brief Method IsDefault, addr 0x12f9998, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12f9af4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
