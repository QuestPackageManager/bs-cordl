...
public:
  ...
  /// @brief Method IsDefault, addr 0x3692794, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36928d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
