...
public:
  ...
  /// @brief Method add_hasBeenRemovedEvent, addr 0x23bc8cc, size 0xb0, virtual true, abstract: false, final true
  inline void add_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>* value);

  /// @brief Method remove_hasBeenRemovedEvent, addr 0x23bc97c, size 0xb0, virtual true, abstract: false, final true
  inline void remove_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>* value);

  /// @brief Method get_observable, addr 0x23bca2c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IMultiplayerObservable* get_observable();

  /// @brief Method get_spotName, addr 0x23bca34, size 0xbc, virtual true, abstract: false, final true
  inline ::StringW get_spotName();

  /// @brief Method get_isMain, addr 0x23bcaf0, size 0x8, virtual true, abstract: false, final true
  inline bool get_isMain();

  /// @brief Method Start, addr 0x23bcaf8, size 0x1c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnDisable, addr 0x23bcb14, size 0x20, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method SetIsObserved, addr 0x23bcb34, size 0x4, virtual true, abstract: false, final true
  inline void SetIsObserved(bool isObserved);

  static inline ::GlobalNamespace::MultiplayerEnvironmentSpectatingSpot* New_ctor();

  /// @brief Method .ctor, addr 0x23bcb38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method IMultiplayerSpectatingSpot.get_transform, addr 0x23bcb40, size 0x8, virtual true, abstract: false, final true
