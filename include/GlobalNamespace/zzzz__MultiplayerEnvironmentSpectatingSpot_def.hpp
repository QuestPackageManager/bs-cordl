...
/// @brief Field _activePlayersTimeOffsetAverage, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__activePlayersTimeOffsetAverage, put=__cordl_internal_set__activePlayersTimeOffsetAverage)) ::GlobalNamespace::MultiplayerActivePlayersTimeOffsetAverage*  _activePlayersTimeOffsetAverage;
...
/// @brief Field hasBeenRemovedEvent, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_hasBeenRemovedEvent, put=__cordl_internal_set_hasBeenRemovedEvent)) ::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>*  hasBeenRemovedEvent;
...
/// @brief Method IMultiplayerSpectatingSpot.get_transform, addr 0x583ef60, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method OnDisable, addr 0x583ef38, size 0x20, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method SetIsObserved, addr 0x583ef58, size 0x4, virtual true, abstract: false, final true
inline void SetIsObserved(bool  isObserved) ;

/// @brief Method Start, addr 0x583ef20, size 0x18, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x583ef5c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_hasBeenRemovedEvent, addr 0x583ecbc, size 0xc0, virtual true, abstract: false, final true
inline void add_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>*  value) ;

/// @brief Method get_isMain, addr 0x583ef18, size 0x8, virtual true, abstract: false, final true
inline bool get_isMain() ;

/// @brief Method get_observable, addr 0x583ee3c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IMultiplayerObservable* get_observable() ;

/// @brief Method get_spotName, addr 0x583ee44, size 0xd4, virtual true, abstract: false, final true
...
/// @brief Method remove_hasBeenRemovedEvent, addr 0x583ed7c, size 0xc0, virtual true, abstract: false, final true
