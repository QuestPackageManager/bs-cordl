...
public:
  ...
  /// @brief Method IMultiplayerSpectatingSpot.get_transform, addr 0x59e2f80, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDisable, addr 0x59e2f58, size 0x20, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method SetIsObserved, addr 0x59e2f78, size 0x4, virtual true, abstract: false, final true
  inline void SetIsObserved(bool isObserved);

  /// @brief Method Start, addr 0x59e2f40, size 0x18, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59e2f7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_hasBeenRemovedEvent, addr 0x59e2cdc, size 0xc0, virtual true, abstract: false, final true
  inline void add_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>* value);

  /// @brief Method get_isMain, addr 0x59e2f38, size 0x8, virtual true, abstract: false, final true
  inline bool get_isMain();

  /// @brief Method get_observable, addr 0x59e2e5c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IMultiplayerObservable* get_observable();

  /// @brief Method get_spotName, addr 0x59e2e64, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_hasBeenRemovedEvent, addr 0x59e2d9c, size 0xc0, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerEnvironmentSpectatingSpot) == 0x40, "Size mismatch!");
