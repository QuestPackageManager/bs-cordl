...
public:
  ...
  /// @brief Method CopyValueFrom, addr 0x26e7234, size 0x4c, virtual false, abstract: false, final false
  inline void CopyValueFrom(::GlobalNamespace::PS5SharedPackageSKUsSO_PS5BuildVersion* newVersion);

  /// @brief Method IncreaseContentVersion, addr 0x26e72a4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e7300, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_contentVersion, addr 0x26e722c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SonyContentVersion* get_contentVersion();

  /// @brief Method get_masterVersion, addr 0x26e7224, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetPrimarySKU, addr 0x26e71f8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e721c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_availableSKUs, addr 0x26e71d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_buildType, addr 0x26e71e0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PS5SharedPackageSKUsSO_BuildType get_buildType();

  /// @brief Method get_buildVersion, addr 0x26e71e8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PS5SharedPackageSKUsSO_PS5BuildVersion* get_buildVersion();

  /// @brief Method get_conceptId, addr 0x26e71d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_conceptId();

  /// @brief Method get_latestBuildVersion, addr 0x26e71f0, size 0x8, virtual false, abstract: false, final false
