...
public:
  ...
  /// @brief Method Awake, addr 0x3ba9934, size 0x30, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method EnterPauseAnimationDidFinish, addr 0x3ba9a54, size 0x30, virtual false, abstract: false, final false
  inline void EnterPauseAnimationDidFinish();

  static inline ::GlobalNamespace::PauseAnimationController* New_ctor();

  /// @brief Method ResumeFromPauseAnimationDidFinish, addr 0x3ba9a84, size 0x50, virtual false, abstract: false, final false
  inline void ResumeFromPauseAnimationDidFinish();

  /// @brief Method StartEnterPauseAnimation, addr 0x3ba9964, size 0x78, virtual false, abstract: false, final false
  inline void StartEnterPauseAnimation();

  /// @brief Method StartResumeFromPauseAnimation, addr 0x3ba99dc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ba9ad4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_resumeFromPauseAnimationDidFinishEvent, addr 0x3ba97fc, size 0x9c, virtual false, abstract: false, final false
  inline void add_resumeFromPauseAnimationDidFinishEvent(::System::Action* value);

  /// @brief Method remove_resumeFromPauseAnimationDidFinishEvent, addr 0x3ba9898, size 0x9c, virtual false, abstract: false, final false
