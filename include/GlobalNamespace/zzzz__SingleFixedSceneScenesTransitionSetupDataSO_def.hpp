...
public:
  ...
  /// @brief Method Init, addr 0x107e570, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x107e744, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sceneInfo, addr 0x107e830, size 0x8, virtual false, abstract: false, final false
