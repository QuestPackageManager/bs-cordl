...
public:
  ...
  /// @brief Method Init, addr 0x229fcac, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229fe70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sceneInfo, addr 0x22a00f8, size 0x8, virtual false, abstract: false, final false
