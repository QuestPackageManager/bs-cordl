...
public:
  ...
  /// @brief Method Init, addr 0x229b8ec, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229bab0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sceneInfo, addr 0x229bd38, size 0x8, virtual false, abstract: false, final false
