...
public:
  ...
  /// @brief Method get_sceneInfo, addr 0xe45328, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::SceneInfo> get_sceneInfo();

  /// @brief Method Init, addr 0xe45068, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe4523c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
