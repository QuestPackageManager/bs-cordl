...
public:
  ...
  /// @brief Method Init, addr 0xe8b038, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe8b20c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sceneInfo, addr 0xe8b2f8, size 0x8, virtual false, abstract: false, final false
