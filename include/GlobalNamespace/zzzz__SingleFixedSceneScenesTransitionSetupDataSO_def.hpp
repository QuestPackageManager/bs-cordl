...
public:
  ...
  /// @brief Method Init, addr 0x10778d4, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1077aa8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sceneInfo, addr 0x1077b94, size 0x8, virtual false, abstract: false, final false
