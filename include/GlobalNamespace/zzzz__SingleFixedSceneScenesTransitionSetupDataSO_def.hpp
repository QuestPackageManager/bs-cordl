...
public:
  ...
  /// @brief Method Init, addr 0x2297e3c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2298000, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sceneInfo, addr 0x2298288, size 0x8, virtual false, abstract: false, final false
