...
public:
  ...
  /// @brief Method Init, addr 0x229b8ac, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229ba70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sceneInfo, addr 0x229bcf8, size 0x8, virtual false, abstract: false, final false
