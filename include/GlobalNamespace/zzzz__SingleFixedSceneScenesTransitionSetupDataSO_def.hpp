...
public:
  ...
  /// @brief Method Init, addr 0x229bf74, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229c138, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sceneInfo, addr 0x229c3c0, size 0x8, virtual false, abstract: false, final false
