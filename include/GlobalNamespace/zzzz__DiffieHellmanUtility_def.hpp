...
/// @brief Method <GetPreMasterSecretAsync>b__0, addr 0x3233aa0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3233a30, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPreMasterSecret, addr 0x3233a34, size 0x6c, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreMasterSecret(::ArrayW<uint8_t,::Array<uint8_t>*>  clientPublicKey) ;

/// @brief Method GetPreMasterSecretAsync, addr 0x32338b0, size 0x180, virtual true, abstract: false, final true
...
static inline ::GlobalNamespace::DiffieHellmanUtility_DiffieHellmanKeyPair* New_ctor(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*  privateKeyParameters, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicKey) ;
...
/// @brief Method .ctor, addr 0x32331a0, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method get_publicKey, addr 0x32338a8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method <GetPreMasterSecretAsync>b__0, addr 0x3233d08, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> _GetPreMasterSecretAsync_b__0() ;
...
/// @brief Method .ctor, addr 0x3233c98, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPreMasterSecret, addr 0x3233c9c, size 0x6c, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreMasterSecret(::ArrayW<uint8_t,::Array<uint8_t>*>  clientPublicKey) ;

/// @brief Method GetPreMasterSecretAsync, addr 0x3233b18, size 0x180, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::ArrayW<uint8_t,::Array<uint8_t>*>>* GetPreMasterSecretAsync(::BGNet::Core::ITaskUtility*  taskUtility, ::ArrayW<uint8_t,::Array<uint8_t>*>  clientPublicKey) ;

static inline ::GlobalNamespace::DiffieHellmanUtility_ElipticalCurveKeyPair* New_ctor(::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters*  privateKeyParameters, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicKey) ;
...
/// @brief Method .ctor, addr 0x323321c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method get_publicKey, addr 0x3233b10, size 0x8, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_publicKey() ;
...
/// @brief Method Dispose, addr 0x3233de4, size 0x100, virtual true, abstract: false, final true
inline void Dispose() ;

static inline ::GlobalNamespace::DiffieHellmanUtility_OperationTimer* New_ctor(::StringW  operationName) ;

/// @brief Method Time, addr 0x3233198, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3233d78, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method GenerateDiffieHellmanKeys, addr 0x3232f6c, size 0x22c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::DiffieHellmanUtility_DiffieHellmanKeyPair* GenerateDiffieHellmanKeys() ;

/// @brief Method GenerateElipticalCurveKeys, addr 0x3232d30, size 0x23c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::DiffieHellmanUtility_ElipticalCurveKeyPair* GenerateElipticalCurveKeys() ;

/// @brief Method GenerateKeys, addr 0x3232cc0, size 0x70, virtual false, abstract: false, final false
static inline ::GlobalNamespace::IDiffieHellmanKeyPair* GenerateKeys(::GlobalNamespace::DiffieHellmanUtility_KeyType  keyType) ;

/// @brief Method GenerateKeysAsync, addr 0x3232b28, size 0x198, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::IDiffieHellmanKeyPair*>* GenerateKeysAsync(::BGNet::Core::ITaskUtility*  taskUtility, ::System::Threading::CancellationToken  cancellationToken, ::GlobalNamespace::DiffieHellmanUtility_KeyType  keyType) ;

/// @brief Method GetPreMasterSecret, addr 0x3233298, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method GetPreMasterSecret, addr 0x32334ec, size 0x274, virtual false, abstract: false, final false
