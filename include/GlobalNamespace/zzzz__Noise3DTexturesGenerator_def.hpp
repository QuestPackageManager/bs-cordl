...
public:
  ...
  /// @brief Method Awake, addr 0x5e0a578, size 0x21c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateNoisePixels, addr 0x5e0a794, size 0x33c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0aad0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
