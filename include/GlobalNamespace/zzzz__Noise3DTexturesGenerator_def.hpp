...
public:
  ...
  /// @brief Method Awake, addr 0x5f45d3c, size 0x21c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateNoisePixels, addr 0x5f45f58, size 0x33c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f46294, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
