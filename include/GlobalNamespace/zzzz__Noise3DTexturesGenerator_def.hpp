...
public:
  ...
  /// @brief Method Awake, addr 0x2956448, size 0x210, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateNoisePixels, addr 0x2956658, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x295697c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
