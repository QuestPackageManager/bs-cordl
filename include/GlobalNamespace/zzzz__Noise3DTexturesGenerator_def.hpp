...
public:
  ...
  /// @brief Method Awake, addr 0x4092fe8, size 0x208, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateNoisePixels, addr 0x40931f0, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4093508, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
