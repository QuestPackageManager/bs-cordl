...
// Ctor Parameters [CppParam { name: "globalPropertyName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "materialPropertyNameCouples", ty: "::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple>*>", modifiers: "", def_value: None }]
constexpr Noise3DTexturesGenerator_MaterialTextureParamsCouple(::StringW  globalPropertyName, ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple>*>  materialPropertyNameCouples) noexcept;
...
/// @brief Field _data, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__data, put=__cordl_internal_set__data)) ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple>*>  _data;
...
/// @brief Method Awake, addr 0x5d9856c, size 0x21c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreateNoisePixels, addr 0x5d98788, size 0x33c, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple>*> const& __cordl_internal_get__data() const;

constexpr ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple>*>& __cordl_internal_get__data() ;

constexpr void __cordl_internal_set__data(::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple>*>  value) ;

/// @brief Method .ctor, addr 0x5d98ac4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
