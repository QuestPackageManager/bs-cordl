...
public:
  ...
  /// @brief Method Awake, addr 0x4089fe8, size 0x208, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateNoisePixels, addr 0x408a1f0, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408a508, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
