...
public:
  ...
  /// @brief Method RestartLevel, addr 0x587bc54, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x587bca8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
