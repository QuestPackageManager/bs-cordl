...
public:
  ...
  /// @brief Method RestartLevel, addr 0x2717248, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2717288, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
