...
public:
  ...
  /// @brief Method RestartLevel, addr 0x24567d8, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2456818, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
