...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapLevelsRepository*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelsRepository*, "", "BeatmapLevelsRepository");
// [NullableContext(1)]
// [Nullable(0)]
// Dependencies BeatmapLevelPack, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__beatmapLevelPacks, put = __cordl_internal_set__beatmapLevelPacks)) ::ArrayW<::GlobalNamespace::BeatmapLevelPack*> _beatmapLevelPacks;
  ...
  /// @brief Method AddBeatmapLevel, addr 0x37277a0, size 0xc0, virtual false, abstract: false, final false
  inline void AddBeatmapLevel(::GlobalNamespace::BeatmapLevel* beatmapLevel, ::StringW songPackId);

  /// @brief Method GetBeatmapLevelById, addr 0x3727600, size 0x1a0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* GetBeatmapLevelById(::StringW levelId, bool ignoreCase);

  /// @brief Method GetBeatmapLevelPackByBeatmapLevelId, addr 0x372756c, size 0x94, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* GetBeatmapLevelPackByBeatmapLevelId(::StringW levelId);

  /// @brief Method GetBeatmapLevelPackByPackId, addr 0x37273cc, size 0x1a0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* GetBeatmapLevelPackByPackId(::StringW packId, bool ignoreCase);
  ...
  /// @brief Method TryGetBeatmapLevelById, addr 0x3727860, size 0x6c, virtual false, abstract: false, final false
  inline bool TryGetBeatmapLevelById(::StringW levelId, ::by_ref<::GlobalNamespace::BeatmapLevel*> beatmapLevel);
  ...
  constexpr ::ArrayW<::GlobalNamespace::BeatmapLevelPack*> const& __cordl_internal_get__beatmapLevelPacks() const;

  constexpr ::ArrayW<::GlobalNamespace::BeatmapLevelPack*>& __cordl_internal_get__beatmapLevelPacks();
  ...
  constexpr void __cordl_internal_set__beatmapLevelPacks(::ArrayW<::GlobalNamespace::BeatmapLevelPack*> value);
  ...
  /// @brief Method .ctor, addr 0x372701c, size 0x3b0, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::BeatmapLevelPack*>* beatmapLevelPacks);

  /// @brief Method get_beatmapLevelPacks, addr 0x3727014, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLevelsRepository", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapLevelsRepository(BeatmapLevelsRepository&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLevelsRepository", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapLevelsRepository(BeatmapLevelsRepositoryconst&) = delete;
  ...
  ::ArrayW<::GlobalNamespace::BeatmapLevelPack*> ____beatmapLevelPacks;
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelsRepository) == 0x30, "Size mismatch!");
