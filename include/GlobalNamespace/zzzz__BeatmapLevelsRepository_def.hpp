...
public:
  ...
  /// @brief Method AddBeatmapLevel, addr 0x3664dc0, size 0xc0, virtual false, abstract: false, final false
  inline void AddBeatmapLevel(::GlobalNamespace::BeatmapLevel* beatmapLevel, ::StringW songPackId);

  /// @brief Method GetBeatmapLevelById, addr 0x3664c20, size 0x1a0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* GetBeatmapLevelById(::StringW levelId, bool ignoreCase);

  /// @brief Method GetBeatmapLevelPackByBeatmapLevelId, addr 0x3664b8c, size 0x94, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* GetBeatmapLevelPackByBeatmapLevelId(::StringW levelId);

  /// @brief Method GetBeatmapLevelPackByPackId, addr 0x36649ec, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetBeatmapLevelById, addr 0x3664e80, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x366463c, size 0x3b0, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::BeatmapLevelPack*>* beatmapLevelPacks);

  /// @brief Method get_beatmapLevelPacks, addr 0x3664634, size 0x8, virtual false, abstract: false, final false
