...
/// @brief Field _beatmapLevelIdToBeatmapLevelPackId, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapLevelIdToBeatmapLevelPackId, put=__cordl_internal_set__beatmapLevelIdToBeatmapLevelPackId)) ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>*  _beatmapLevelIdToBeatmapLevelPackId;

/// @brief Field _beatmapLevelPacks, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapLevelPacks, put=__cordl_internal_set__beatmapLevelPacks)) ::ArrayW<::GlobalNamespace::BeatmapLevelPack*,::Array<::GlobalNamespace::BeatmapLevelPack*>*>  _beatmapLevelPacks;

/// @brief Field _idToBeatmapLevel, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__idToBeatmapLevel, put=__cordl_internal_set__idToBeatmapLevel)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::BeatmapLevel*>*  _idToBeatmapLevel;

/// @brief Field _idToBeatmapLevelPack, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__idToBeatmapLevelPack, put=__cordl_internal_set__idToBeatmapLevelPack)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::BeatmapLevelPack*>*  _idToBeatmapLevelPack;
...
/// @brief Method AddBeatmapLevel, addr 0x3666154, size 0xc0, virtual false, abstract: false, final false
inline void AddBeatmapLevel(::GlobalNamespace::BeatmapLevel*  beatmapLevel, ::StringW  songPackId) ;

/// @brief Method GetBeatmapLevelById, addr 0x3665fb4, size 0x1a0, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevel* GetBeatmapLevelById(::StringW  levelId, bool  ignoreCase) ;

/// @brief Method GetBeatmapLevelPackByBeatmapLevelId, addr 0x3665f20, size 0x94, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevelPack* GetBeatmapLevelPackByBeatmapLevelId(::StringW  levelId) ;

/// @brief Method GetBeatmapLevelPackByPackId, addr 0x3665d80, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method TryGetBeatmapLevelById, addr 0x3666214, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x36659d0, size 0x3b0, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::BeatmapLevelPack*>*  beatmapLevelPacks) ;

/// @brief Method get_beatmapLevelPacks, addr 0x36659c8, size 0x8, virtual false, abstract: false, final false
