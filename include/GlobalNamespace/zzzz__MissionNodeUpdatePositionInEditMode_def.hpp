...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionNodeUpdatePositionInEditMode*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionNodeUpdatePositionInEditMode*, "", "MissionNodeUpdatePositionInEditMode");
// [ExecuteInEditMode]
...
public:
  ...
  /// @brief Method .ctor, addr 0x593d558, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissionNodeUpdatePositionInEditMode", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MissionNodeUpdatePositionInEditMode(MissionNodeUpdatePositionInEditMode&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MissionNodeUpdatePositionInEditMode", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MissionNodeUpdatePositionInEditMode(MissionNodeUpdatePositionInEditModeconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MissionNodeUpdatePositionInEditMode) == 0x28, "Size mismatch!");
