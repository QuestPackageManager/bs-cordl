...
public:
  ...
  /// @brief Method CamerasDict, addr 0x408e834, size 0x58, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Camera>, ::GlobalNamespace::CommandBufferOwners*>* CamerasDict();

  /// @brief Method CommandBufferCameraEvent, addr 0x408e88c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Rendering::CameraEvent CommandBufferCameraEvent();

  /// @brief Method CreateCommandBuffer, addr 0x408e648, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408e894, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
