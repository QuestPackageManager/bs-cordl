...
public:
  ...
  /// @brief Method get_localizedText addr 0x2166048 size 0xc virtual false final false
  inline ::StringW get_localizedText();

  static inline ::GlobalNamespace::__NamedIntListSettingsController__TextValuePair* New_ctor();

  /// @brief Method .ctor addr 0x216605c size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetInitValues addr 0x2165ec8 size 0xc8 virtual true final false
  inline bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements);

  /// @brief Method ApplyValue addr 0x2165f90 size 0x7c virtual true final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method TextForValue addr 0x216600c size 0x3c virtual true final false
  inline ::StringW TextForValue(int32_t idx);

  static inline ::GlobalNamespace::NamedIntListSettingsController* New_ctor();

  /// @brief Method .ctor addr 0x2166054 size 0x8 virtual false final false
  inline void _ctor();
