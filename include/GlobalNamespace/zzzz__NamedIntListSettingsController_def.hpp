...
public:
  ...
  /// @brief Method get_localizedText, addr 0x22de410, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_localizedText();

  static inline ::GlobalNamespace::__NamedIntListSettingsController__TextValuePair* New_ctor();

  /// @brief Method .ctor, addr 0x22de440, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetInitValues, addr 0x22de298, size 0xc8, virtual true, abstract: false, final false
  inline bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements);

  /// @brief Method ApplyValue, addr 0x22de360, size 0x7c, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method TextForValue, addr 0x22de3dc, size 0x34, virtual true, abstract: false, final false
  inline ::StringW TextForValue(int32_t idx);

  static inline ::GlobalNamespace::NamedIntListSettingsController* New_ctor();

  /// @brief Method .ctor, addr 0x22de438, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
