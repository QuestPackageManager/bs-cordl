...
// Write type traits
MARK_REF_T(::GlobalNamespace::FlickeringNeonSign*);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x599ebac, size 0x138, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::FlickeringNeonSign__FlickeringCoroutine_d__16* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x599ece4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x599ecec, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x599ed24, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x599eba8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x599ea6c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__sparksAudioClips, put = __cordl_internal_set__sparksAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>> _sparksAudioClips;
  ...
  /// @brief Method Awake, addr 0x599e938, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FlickeringCoroutine, addr 0x599ea18, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* FlickeringCoroutine();

  static inline ::GlobalNamespace::FlickeringNeonSign* New_ctor();

  /// @brief Method OnEnable, addr 0x599e9f8, size 0x20, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetOn, addr 0x599ea74, size 0x124, virtual false, abstract: false, final false
  inline void SetOn(bool on);

  /// @brief Method Start, addr 0x599e9bc, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& __cordl_internal_get__sparksAudioClips() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& __cordl_internal_get__sparksAudioClips();
  ...
  constexpr void __cordl_internal_set__sparksAudioClips(::ArrayW<::UnityW<::UnityEngine::AudioClip>> value);

  constexpr void __cordl_internal_set__spriteOnColor(::UnityEngine::Color value);

  /// @brief Method .ctor, addr 0x599eb98, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::FlickeringNeonSign) == 0x88, "Size mismatch!");
