...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b9c76c, size 0x104, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::FlickeringNeonSign__FlickeringCoroutine_d__16* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b9c870, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b9c878, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b9c8b0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3b9c768, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b9c624, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x3b9c4e4, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FlickeringCoroutine, addr 0x3b9c5c4, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* FlickeringCoroutine();

  static inline ::GlobalNamespace::FlickeringNeonSign* New_ctor();

  /// @brief Method OnEnable, addr 0x3b9c5a4, size 0x20, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetOn, addr 0x3b9c64c, size 0x108, virtual false, abstract: false, final false
  inline void SetOn(bool on);

  /// @brief Method Start, addr 0x3b9c568, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b9c754, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
